/*
 * XREFs of DrvDisplayConfigSetDeviceInfo @ 0x1C01508F0
 * Callers:
...
__int64 __fastcall DrvDisplayConfigSetDeviceInfo(int *a1, __int64 a2)
{
  ...
  bool v62; // zf
  int v63; // eax
  struct D3DKMT_GETPATHSMODALITY *v64; // [rsp+90h] [rbp+18h] BYREF

  if ( !(unsigned int)DrvIsWddmDriverPresent() )
    return 3221225659LL;
  v5 = (unsigned int *)(a1 + 4);
  v6 = (unsigned int *)(a1 + 2);
  result = ((__int64 (__fastcall *)(int *, _QWORD, int *, int *))qword_1C0252A70)(
             a1 + 2,
             (unsigned int)a1[4],
             a1 + 2,
             a1 + 4);
    ...
    else
    {
      switch ( v10 )
      {
        ...
        case -16:
          if ( a1[1] != 68 )
            return -1073741811LL;
          v61 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0252938)(0LL, a1);
          v11 = v61;
          if ( v61 < 0 )
            goto LABEL_58;
          if ( v61 != 259 )
          {
            if ( v61 == 255 && gpGdiSharedMemory )
        ...
        case -6:
          if ( a1[1] == 28 )
          {
            v60 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0252938)(0LL, a1);
            v11 = v60;
            if ( v60 >= 0 )
            {
              if ( !a1[6] )
        ...
        case 5:
          ...
          v27 = ((__int64 (*)(void))qword_1C0252950)();
          v11 = v27;
          if ( v27 < 0 )
          {
          ...
          if ( (v31 & 1) != 0 )
          {
            PathsModality = GetPathsModality(v29, &v64, 64LL, 0LL);
            v37 = PathsModality;
            if ( PathsModality < 0 )
            {
              ...
              {
                if ( (int)((__int64 (*)(void))qword_1C0252958)() < 0 )
                {
          ...
          v45 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64, _QWORD))qword_1C0252920)(*(_QWORD *)v6, *v5, v44, 0LL);
          v11 = v45;
          if ( v45 >= 0 )
          {
            if ( !v32 )
              goto LABEL_40;
            v50 = ((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *))qword_1C02528F0)(
                    0x40000000LL,
                    v32);
            v54 = v50;
            if ( v50 >= 0 )
              goto LABEL_40;
            v49 = (_QWORD *)WdLogNewEntry5_WdError(v52, v51, v53);
            v49[3] = v54;
          }
          else
          {
...
LABEL_40:
        ...
        case 8:
          if ( a1[1] != 24 )
            return -1073741811LL;
          v25 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0252938)(0LL, a1);
          v11 = v25;
          if ( v25 < 0 )
            goto LABEL_58;
LABEL_18:
...
LABEL_59:
        ...
        case 10:
          if ( a1[1] == 24 )
          {
            v14 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0252938)(0LL, a1);
            v11 = v14;
            if ( v14 >= 0 )
            {
              if ( v14 == 255 )
...
LABEL_14:
    ...
    v63 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0252938)(0LL, a1);
    v11 = v63;
    if ( v63 >= 0 )
      return (unsigned int)v11;
    goto LABEL_58;
