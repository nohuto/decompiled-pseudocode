/*
 * XREFs of ?ReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x1C017B838
 * Callers:
...
void __fastcall InputTraceLogging::RIM::ReadComplete(const struct RawInputManagerObject *a1, const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    ...
    {
      v5 = (unsigned __int8 *)&unk_1C021D8A2;
      goto LABEL_17;
    }
  }
  else if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 256LL) )
  {
    v5 = (unsigned __int8 *)&unk_1C021D869;
LABEL_17:
