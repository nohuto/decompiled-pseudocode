/*
 * XREFs of ?ProcessQFrameNode@CTouchProcessor@@QEAAXPEAUCPointerQFrame@@PEBUCPointerInputFrame@@PEAUCPointerInfoNode@@@Z @ 0x1C019E170
 * Callers:
        ...
        struct CPointerInfoNode *a4)
{
  ...
  v8 = &WPP_6cc13e1a12c13a444721acaa10d1d35b_Traceguids;
