/*
 * XREFs of HmgMarkUndeletable @ 0x1C00A9F30
 * Callers:
 *     GreMarkUndeletableBrush @ 0x1C0051540 (GreMarkUndeletableBrush.c)
 ...
 *     GreMarkUndeletableBitmap @ 0x1C00A9F10 (GreMarkUndeletableBitmap.c)
