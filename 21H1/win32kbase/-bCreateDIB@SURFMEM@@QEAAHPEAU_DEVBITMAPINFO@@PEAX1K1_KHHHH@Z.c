/*
 * XREFs of ?bCreateDIB@SURFMEM@@QEAAHPEAU_DEVBITMAPINFO@@PEAX1K1_KHHHH@Z @ 0x1C007B980
 * Callers:
        ...
        int a11)
{
  ...
  unsigned int v150[2]; // [rsp+60h] [rbp-A0h] BYREF
  __int64 v151; // [rsp+68h] [rbp-98h]
  PEPROCESS Process; // [rsp+70h] [rbp-90h] BYREF
  __int64 v153; // [rsp+78h] [rbp-88h]
  void *v154; // [rsp+80h] [rbp-80h] BYREF
  __int64 v155; // [rsp+88h] [rbp-78h] BYREF
  struct _KTHREAD *v156; // [rsp+90h] [rbp-70h]
  int v157; // [rsp+98h] [rbp-68h]
  int v158; // [rsp+9Ch] [rbp-64h]
  __int64 v159; // [rsp+A0h] [rbp-60h] BYREF
  __int128 v160; // [rsp+A8h] [rbp-58h] BYREF
  __int128 v161; // [rsp+B8h] [rbp-48h]
  __int128 v162; // [rsp+C8h] [rbp-38h]
  unsigned __int64 v163; // [rsp+D8h] [rbp-28h]
  unsigned __int16 *v164; // [rsp+E0h] [rbp-20h] BYREF
  ...
  *(_QWORD *)this = 0LL;
  ...
  if ( v12 )
  {
    if ( !a9 || (!v15 ? (v27 = v16 * v18) : (v27 = *((unsigned int *)a2 + 3)), v27 <= 0x7FFFFFFF) )
    {
      if ( (*((_DWORD *)a2 + 6) & 0x800) == 0 )
        goto LABEL_60;
      W32PIDLOCK::vInit((W32PIDLOCK *)&v160);
      if ( *((_QWORD *)&v162 + 1) )
      {
        v12 = pv;
        LOWORD(v168) = 2048;
  ...
  if ( (v22 & 8) != 0 )
  {
    if ( (v22 & 0x80u) == 0 )
      ...
      v23 = AllocateSharedSection(v21, v15, &Object, &v154, &pv);
    if ( v23 >= 0 )
    {
      v12 = pv;
LABEL_40:
  ...
  if ( (v22 & 0x810) != 0 )
  {
    if ( (v22 & 0x800) != 0 )
    {
      ...
      if ( !Object )
      {
        W32PIDLOCK::vCleanUp((REGION **)&v160);
        return 0LL;
      }
    }
    else
...
LABEL_42:
  ...
  v167 = 1;
  v26 = v21 - v150[0];
  if ( v26 && qword_1C0258BD0 && (int)qword_1C0258BD0() >= 0 )
  {
    if ( qword_1C0258BD8 )
      v12 = (PVOID)qword_1C0258BD8(33LL, v26, 1835167815LL);
    if ( v12 && !v25 )
      memset(v12, 0, v26);
  }
  pv = v12;
...
LABEL_222:
  ...
  if ( qword_1C024D3D8 )
  {
    v31 = NSInstrumentation::CReferenceTracker::CReferenceCountedType::BeginTrack(qword_1C024D3D8, v30);
    if ( !v31 )
    {
      v32 = 0;
...
LABEL_70:
  ...
  *(_QWORD *)this = v33;
  if ( v33 )
  {
    v153 = *(_QWORD *)((char *)a2 + 4);
    *((_QWORD *)&v33[3].Next + 1) = v153;
...
LABEL_165:
      ...
      *(_WORD *)(*(_QWORD *)this + 102LL) = v168 | *((_WORD *)a2 + 12) & 0x89;
      ...
      *(_QWORD *)(*(_QWORD *)this + 624LL) = 0LL;
      ...
      if ( *(char *)(*(_QWORD *)this + 102LL) < 0 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)this + 592LL) = v154;
        *(_QWORD *)(*(_QWORD *)this + 600LL) = (char *)v154
      ...
      *(_DWORD *)(*(_QWORD *)this + 92LL) = _InterlockedIncrement((volatile signed __int32 *)&_ulGlobalSurfaceUnique);
      ...
      {
        v120 = (__int64 *)PsGetThreadWin32Thread(v156);
        if ( v120 )
        {
          v121 = *v120;
          if ( v121 )
      ...
      {
        v150[0] = 0;
        if ( GdiHandleManager::AcquireEntryIndex(v118, v150) )
        {
          v127 = 11;
          if ( !v124 )
            v127 = 3;
          v106 = ENTRYOBJ::hSetup((struct OBJECT *)v107, 5u, v127, v150[0]);
      ...
      if ( v106 )
      {
        ...
        *(_QWORD *)(v135 + 32) = **(_QWORD **)this;
        ...
        if ( (*(_WORD *)(*(_QWORD *)this + 102LL) & 0x800) != 0 && *((_QWORD *)&v162 + 1) )
        {
          v137 = v160;
      ...
      {
        v155 = *(_QWORD *)(*(_QWORD *)this + 128LL);
        XEPALOBJ::vUnrefPalette((XEPALOBJ *)&v155);
        *(_QWORD *)(*(_QWORD *)this + 128LL) = 0LL;
      }
    ...
    v151 = 0LL;
    v159 = 0LL;
    CurrentThreadWin32ThreadAndEnterCriticalRegion = PsGetCurrentThreadWin32ThreadAndEnterCriticalRegion(&v159);
    ...
    {
      *(_QWORD *)v150 = *(_QWORD *)(*(_QWORD *)CurrentThreadWin32ThreadAndEnterCriticalRegion + 72LL);
    }
    else
    {
      *(_QWORD *)v150 = 0LL;
    ...
    {
      v155 = 16LL * (unsigned __int8)v46;
      v52 = *(_QWORD **)(v50 + 24);
      v163 = 8 * ((unsigned __int64)v46 >> 8);
      Process = (PEPROCESS)(v155 + *(_QWORD *)(*v52 + v163));
      KeEnterCriticalRegion();
      ExAcquirePushLockExclusiveEx(Process, 0LL);
      if ( v46 < *(_DWORD *)(v50 + 20) && *(_QWORD *)(*(_QWORD *)(**(_QWORD **)(v50 + 24) + v163) + v155 + 8) )
      {
        v53 = 24LL * v46;
    ...
    if ( v51 )
    {
      ...
      v166 = *((_DWORD *)v51 + 2);
      v54 = v166 & 0xFFFFFFFE;
      if ( (v166 & 0xFFFFFFFE) == (v159 & 0xFFFFFFFC)
        || !v54
        || *(_QWORD *)v150 && v54 == *(_DWORD *)(*(_QWORD *)v150 + 8LL) )
      {
        v55 = *((_BYTE *)v51 + 15);
        if ( (v55 & 0x20) == 0 )
        {
          ...
          {
LABEL_114:
            if ( *((_BYTE *)v51 + 14) == 8 && v51[6] == WORD1(v156) )
            {
...
LABEL_143:
            ...
            if ( v77 >= 0x10000 )
            {
              ...
              LODWORD(v151) = (unsigned __int16)*v76;
              if ( v78 )
              {
...
LABEL_109:
      ...
      HANDLELOCK::vUnlock((HANDLELOCK *)&v164);
      if ( v165 )
      {
LABEL_113:
        v51 = v164;
...
LABEL_223:
  if ( v12 || (v14 = 0, Object) )
  {
    ...
    if ( (v141 & 8) != 0 )
    {
      ...
      if ( !*(_QWORD *)(v144 + 72) )
        return 0LL;
      v145 = PsGetCurrentProcess(v143, v142);
      MmUnmapViewOfSection(v145);
      v146 = *(_QWORD *)(v144 + 72);
      Process = 0LL;
      if ( PsLookupProcessByProcessId((HANDLE)*(int *)(v146 + 8), &Process) >= 0 )
      {
