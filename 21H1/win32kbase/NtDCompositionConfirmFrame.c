/*
 * XREFs of NtDCompositionConfirmFrame @ 0x1C0007140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionConfirmFrame(__int64 a1, __int64 *a2)
{
  ...
  DirectComposition::CConnection *v28; // [rsp+70h] [rbp+18h]
  ...
  if ( a2 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( v12 )
        {
          v11 = (*(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v12 + 32LL))(v12, v27, &v29);
          v10 = v29;
        }
        v26 = v11;
        if ( v11 >= 0 )
        {
          ...
          *((_QWORD *)v3 + 16) = 0LL;
          ...
          KeLeaveCriticalRegion();
          v3 = v28;
          for ( i = (_QWORD *)*((_QWORD *)v28 + 24); i != (_QWORD *)((char *)v28 + 192); i = (_QWORD *)*i )
          {
            if ( i[6] )
            {
              if ( *(_QWORD *)(i[2] + 16LL) )
        ...
        {
          DirectComposition::CConnection::~CConnection(v28);
          Win32FreePool(v28);
        }
        v4 = v26;
      }
