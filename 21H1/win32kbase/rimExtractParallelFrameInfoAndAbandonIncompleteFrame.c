/*
 * XREFs of rimExtractParallelFrameInfoAndAbandonIncompleteFrame @ 0x1C018151C
 * Callers:
        ...
        _WORD *a10)
{
  ...
  struct _HIDP_PREPARSED_DATA *v25; // [rsp+98h] [rbp+10h]

  v10 = a2;
  v11 = *(_QWORD *)(a2 + 480);
  v12 = 0;
  v13 = *(unsigned int **)(v11 + 712);
  v25 = *(struct _HIDP_PREPARSED_DATA **)(*(_QWORD *)(a2 + 464) + 16LL);
  ...
  *a10 = 0;
  *a9 = 0;
  if ( rimHidP_GetUsageValue(HidP_Input, 0xDu, 0, 0x54u, a5, v25, a3, a4) < 0 )
  {
    if ( (v13[8] & 1) == 0 )
    {
      *a6 = *v13;
