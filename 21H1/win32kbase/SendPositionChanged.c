/*
 * XREFs of SendPositionChanged @ 0x1C0051250
 * Callers:
 *     _lambda_0106af77700bc4a134663e8cc2385985_::_lambda_invoker_cdecl_ @ 0x1C0051F00 (_lambda_0106af77700bc4a134663e8cc2385985_--_lambda_invoker_cdecl_.c)
 * Callees:
...
__int64 __fastcall SendPositionChanged(__int64 *a1)
{
  ...
  return InputExtensibilityCallout::CoreMsgSendMessage(v2, 1LL, &v4, 32LL, 1LL, v5);
}
