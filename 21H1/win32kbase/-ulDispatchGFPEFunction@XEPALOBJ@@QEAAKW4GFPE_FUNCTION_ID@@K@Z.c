/*
 * XREFs of ?ulDispatchGFPEFunction@XEPALOBJ@@QEAAKW4GFPE_FUNCTION_ID@@K@Z @ 0x1C0005DC0
 * Callers:
 ...
 * Callees:
 *     ?ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1C0005EC0 (-ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
