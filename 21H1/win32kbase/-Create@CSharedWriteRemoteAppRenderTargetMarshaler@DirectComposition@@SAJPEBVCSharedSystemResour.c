/*
 * XREFs of ?Create@CSharedWriteRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01FA7E4
 * Callers:
 *     CreateSharedWriteRemoteAppRenderTargetMarshaler @ 0x1C01FA950 (CreateSharedWriteRemoteAppRenderTargetMarshaler.c)
 * Callees:
