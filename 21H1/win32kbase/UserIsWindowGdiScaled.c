/*
 * XREFs of UserIsWindowGdiScaled @ 0x1C001DBD0
 * Callers:
 *     DxgkEngGetWindowGdiDpiScalingFactor @ 0x1C01544D0 (DxgkEngGetWindowGdiDpiScalingFactor.c)
 * Callees:
