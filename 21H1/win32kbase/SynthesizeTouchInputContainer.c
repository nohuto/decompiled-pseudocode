/*
 * XREFs of SynthesizeTouchInputContainer @ 0x1C01B65E0
 * Callers:
 *     ?OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ @ 0x1C01AD0A0 (-OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ.c)
 * Callees:
