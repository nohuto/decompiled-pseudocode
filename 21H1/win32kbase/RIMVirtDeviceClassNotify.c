/*
 * XREFs of RIMVirtDeviceClassNotify @ 0x1C0174BE8
 * Callers:
...
__int64 __fastcall RIMVirtDeviceClassNotify(char *Object, __int64 a2)
{
  ...
  {
    ApiSetEditionCrit::ApiSetEditionCrit((ApiSetEditionCrit *)v30, 1, 1u);
...
LABEL_19:
    ...
    if ( v10 )
    {
      ...
      *((_QWORD *)Object + 72) = 0LL;
      ...
      if ( v15 )
      {
        rimDoRimDevChange((__int64)Object, v6, 3u);
    ...
    if ( Dev >= 0 && !*(_DWORD *)(v3 + 20) )
    {
      ...
      if ( *((struct _KTHREAD **)Object + 5) == KeGetCurrentThread() )
      {
        *(_DWORD *)(v28 + 184) |= 1u;
        v7 = 0;
        Dev = RIMDoOnPnpNotification((__int64)Object, v6);
      }
      else
      {
        v7 = 1;
