/*
 * XREFs of ?AreTheseTwoContactsAZoom@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z @ 0x1C01C5D54
 * Callers:
 ...
 * Callees:
 *     ?ndotprod@@YA_NHHHHPEAN@Z @ 0x1C01CBDEC (-ndotprod@@YA_NHHHHPEAN@Z.c)
 */
