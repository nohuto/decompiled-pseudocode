/*
 * XREFs of ?SetReferenceProperty@CRemoteRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00CBB90
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  v11 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 12);
  if ( v11 )
  {
