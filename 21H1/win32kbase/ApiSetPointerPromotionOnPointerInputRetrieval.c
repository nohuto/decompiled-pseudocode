/*
 * XREFs of ApiSetPointerPromotionOnPointerInputRetrieval @ 0x1C01D240C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( qword_1C0259598 )
    result = qword_1C0259598();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02595A0;
    if ( qword_1C02595A0 )
      result = qword_1C02595A0(a1, v6, a3, a4);
  }
