/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector2Value@@UD2DVector2@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C0004CF4
 * Callers:
 *     ?EmitSetProperties@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00BC578 (-EmitSetProperties@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  *(_QWORD *)(v7 + 28) = *(_QWORD *)((*(_DWORD *)(*(_QWORD *)(a1 + 72) + 8 * v4 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 88));
