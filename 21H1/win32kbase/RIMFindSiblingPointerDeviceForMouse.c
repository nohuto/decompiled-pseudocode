/*
 * XREFs of RIMFindSiblingPointerDeviceForMouse @ 0x1C004E030
 * Callers:
...
__int64 __fastcall RIMFindSiblingPointerDeviceForMouse(__int64 a1, _QWORD *a2)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_q((_DWORD)gRimLog, (_DWORD)a2, 1, 66, (__int64)&WPP_b4bdd17c87fb31482968a882731fa2c6_Traceguids, a1);
  }
  if ( *(_BYTE *)(a1 + 48) )
