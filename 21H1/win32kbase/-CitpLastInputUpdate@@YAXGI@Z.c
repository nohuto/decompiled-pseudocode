/*
 * XREFs of ?CitpLastInputUpdate@@YAXGI@Z @ 0x1C005B4E4
 * Callers:
 ...
 *     CitLastInputUpdate @ 0x1C005B450 (CitLastInputUpdate.c)
...
void __fastcall CitpLastInputUpdate(unsigned __int16 a1, unsigned int a2)
{
  ...
  {
    if ( a2 < *((_DWORD *)&xmmword_1C0256430 + 2) )
      v3 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    v5 = xmmword_1C0256430;
    *((_DWORD *)&xmmword_1C0256430 + 2) = v3;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)xmmword_1C0256430 + 228), v3);
    if ( !v4 )
