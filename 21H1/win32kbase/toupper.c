 ...
 * Callees:
 *     RtlUpcaseUnicodeToMultiByteN_0 @ 0x1C00CDEF6 (RtlUpcaseUnicodeToMultiByteN_0.c)
 *     RtlAnsiCharToUnicodeChar_0 @ 0x1C00CDF08 (RtlAnsiCharToUnicodeChar_0.c)
 */
