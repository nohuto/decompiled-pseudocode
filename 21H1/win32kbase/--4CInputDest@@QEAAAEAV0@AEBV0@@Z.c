/*
 * XREFs of ??4CInputDest@@QEAAAEAV0@AEBV0@@Z @ 0x1C005D1E8
 * Callers:
 ...
 *     ?SetForeground@CForegroundInfo@@QEAAXAEBVCInputDest@@@Z @ 0x1C01A6460 (-SetForeground@CForegroundInfo@@QEAAXAEBVCInputDest@@@Z.c)
 * Callees:
...
__int64 __fastcall CInputDest::operator=(__int64 a1, __int64 a2)
{
  ...
  if ( a1 != a2 )
  {
    if ( !*(_BYTE *)(a1 + 112) || *(_QWORD *)(a2 + 80) != *(_QWORD *)(a1 + 80) )
    {
