/*
 * XREFs of ?LockExclusive@CInpLockGuard@@QEAAXAEAVCRefUnRefPointerMsgId@@@Z @ 0x1C00D0DC0
 * Callers:
...
void __fastcall CInpLockGuard::LockExclusive(PERESOURCE *this, struct CRefUnRefPointerMsgId *a2)
{
  __int64 v4; // rcx
  int v5; // ebx
  __int64 v6; // rcx
  ...
  _BYTE v26[32]; // [rsp+38h] [rbp-70h] BYREF
  _BYTE v27[32]; // [rsp+58h] [rbp-50h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)CInpLockGuard::isManipulationThreadInTermination(v20)
      || !*((_DWORD *)this + 10)
