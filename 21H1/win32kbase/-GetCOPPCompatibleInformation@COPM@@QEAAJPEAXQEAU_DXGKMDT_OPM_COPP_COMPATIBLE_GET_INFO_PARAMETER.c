/*
 * XREFs of ?GetCOPPCompatibleInformation@COPM@@QEAAJPEAXQEAU_DXGKMDT_OPM_COPP_COMPATIBLE_GET_INFO_PARAMETERS@@PEAU_DXGKMDT_OPM_REQUESTED_INFORMATION@@@Z @ 0x1C0149EA8
 * Callers:
        ...
        struct _DXGKMDT_OPM_REQUESTED_INFORMATION *a4)
{
  ...
  v11 = this;
  v4 = qword_1C0252BF0;
  v8 = (PRKMUTEX *)((char *)qword_1C0252BF0 + 48);
