/*
 * XREFs of ??0MouseInputDataEx@CMouseProcessor@@QEAA@PEBU_MOUSE_INPUT_DATA@@W4MouseInputDataProcessingPrivate@@W4MouseInputDataProcessingOptions@@@Z @ 0x1C0062C68
 * Callers:
...
__int64 __fastcall CMouseProcessor::MouseInputDataEx::MouseInputDataEx(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  v14 = *(_OWORD *)v8;
  v15 = v9;
  CMouseProcessor::MouseInputDataEx::MouseInputDataEx(a1, a2, &v14, a4, (__int64)&v11, 0LL);
  *(_DWORD *)(a1 + 88) = a3;
  return a1;
}
