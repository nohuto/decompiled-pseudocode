/*
 * XREFs of ?Thunk_Reply_UnregisterObject_0@?$IRegistrarClient_Receive@URegistrarClientThunk@CoreMessagingK@@@Registrar@CoreUI@Microsoft@@SAJPEAXPEAPEAX@Z @ 0x1C00C3B70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
