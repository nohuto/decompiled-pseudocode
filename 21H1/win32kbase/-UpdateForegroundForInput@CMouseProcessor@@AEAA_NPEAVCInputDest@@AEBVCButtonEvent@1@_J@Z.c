/*
 * XREFs of ?UpdateForegroundForInput@CMouseProcessor@@AEAA_NPEAVCInputDest@@AEBVCButtonEvent@1@_J@Z @ 0x1C005FB00
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( !(unsigned __int8)CInputDest::DoesBelongToForeground(a2, 1LL) )
  {
    ...
    else
    {
      v14 = *((_QWORD *)a3 + 1);
      if ( *(_DWORD *)(v14 + 108) != 1 )
        return anonymous_namespace_::ValidateUIPI(*(_QWORD *)(v14 + 132), a2) != 0;
    }
  }
  return v6;
}
