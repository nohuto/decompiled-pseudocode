/*
 * XREFs of ?GetMaxCount@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0164018
 * Callers:
...
void __fastcall InputTraceLogging::RIM::GetMaxCount(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 256LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C021BF9E, 0LL, 0LL, 3u, &v3);
  }
}
