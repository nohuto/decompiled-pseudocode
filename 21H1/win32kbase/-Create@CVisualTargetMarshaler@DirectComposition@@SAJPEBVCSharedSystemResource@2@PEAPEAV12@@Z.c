/*
 * XREFs of ?Create@CVisualTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C002F048
 * Callers:
 *     CreateVisualTargetMarshaler @ 0x1C002EFF0 (CreateVisualTargetMarshaler.c)
 * Callees:
