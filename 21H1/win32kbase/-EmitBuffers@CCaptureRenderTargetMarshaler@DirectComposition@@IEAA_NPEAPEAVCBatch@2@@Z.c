/*
 * XREFs of ?EmitBuffers@CCaptureRenderTargetMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01F63B8
 * Callers:
 *     ?EmitUpdateCommands@CCaptureRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01F65C0 (-EmitUpdateCommands@CCaptureRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( i = *((_DWORD *)this + 4); ; i = *((_DWORD *)this + 4) )
  {
    ...
    v16 = 0LL;
    DirectComposition::CBatch::EnsureBatchBuffer(a2, 8 * v9 + 16, &v16);
    v10 = (char *)v16;
    *(_DWORD *)v16 = 8 * v9 + 16;
    *(_QWORD *)(v10 + 4) = 0LL;
    *((_DWORD *)v10 + 3) = 0;
    ...
    *((_DWORD *)v10 + 2) = *((_DWORD *)this + 6);
    ...
    if ( v9 )
    {
      ...
      {
        v16 = (void *)-1LL;
        v13 = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C0252A28)();
        OpenDwmHandle(
