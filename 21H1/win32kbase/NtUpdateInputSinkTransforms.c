/*
 * XREFs of NtUpdateInputSinkTransforms @ 0x1C0001A50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (unsigned int)UserIsCurrentProcessDwm() )
  {
    ...
    for ( i = 0LL; ; i = (unsigned int)(i + 1) )
    {
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( (unsigned int)dword_1C024C960 > 5 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024C960, 4LL, v13, v14) )
          {
            v18 = HIDWORD(v35[5]);
            v20 = DWORD2(v35[5]);
            v21 = DWORD1(v35[5]);
