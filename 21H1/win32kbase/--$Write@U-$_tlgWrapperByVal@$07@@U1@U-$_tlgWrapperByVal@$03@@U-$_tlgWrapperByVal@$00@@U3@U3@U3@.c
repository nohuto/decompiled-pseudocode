        ...
        __int64 a12)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData.Ptr = (ULONGLONG)off_1C0247380;
  v43 = 1;
  v40 = 1;
  v37 = 1;
  v34 = 1;
  ...
  v21 = a4;
  v22 = 8;
  UserData.Size = *(unsigned __int16 *)off_1C0247380;
  ...
  if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_1C02473A0 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    ...
    {
      return EtwWriteTransfer(qword_1C0247398, &EventDescriptor, 0LL, 0LL, 0xBu, &UserData);
    }
  }
  return result;
}
