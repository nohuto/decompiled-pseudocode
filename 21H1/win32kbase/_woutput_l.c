/*
 * XREFs of _woutput_l @ 0x1C00CD1D0
 * Callers:
 ...
 *     write_char_0 @ 0x1C00CDABC (write_char_0.c)
 *     write_multi_char_0 @ 0x1C00CDB10 (write_multi_char_0.c)
 *     write_string_0 @ 0x1C00CDB68 (write_string_0.c)
 *     _get_printf_count_output @ 0x1C00CDBF4 (_get_printf_count_output.c)
...
LABEL_122:
                        v36 = v59 - v12 - v35;
                        if ( (v6 & 0xC) == 0 )
                          write_multi_char_0(32LL, v36, v61, &v51);
                        write_string_0(v58, v35, v61, &v51);
                        v37 = v61;
                        if ( (v6 & 0xC) == 8 )
                          write_multi_char_0(48LL, v36, v61, &v51);
                        if ( v55 || (int)v12 <= 0 )
                        {
                          write_string_0(v8, (unsigned int)v12, v37, &v51);
LABEL_136:
                          v11 = v51;
                        }
                        else
                        {
                          ...
                          {
                            --v39;
                            v40 = mbtowc(v54, v38, _mb_cur_max);
                            v41 = v40;
                            if ( v40 == 2 )
                              --v39;
                            if ( v40 <= 0 )
                              break;
                            write_char_0(v54[0], v61, &v51);
                            v38 += v41;
                            if ( v39 <= 0 )
                            {
                              a2 = v63;
                        ...
                        if ( v11 >= 0 && (v6 & 4) != 0 )
                        {
                          write_multi_char_0(32LL, v36, v37, &v51);
                          v7 = v53;
                          goto LABEL_140;
                        }
                        v7 = v53;
