/*
 * XREFs of ?CreateActivationObject@CActivationObjectManager@@QEAAJDPEAU_OBJECT_ATTRIBUTES@@KDPEAX_KAEAU_LUID@@@Z @ 0x1C0018014
 * Callers:
 *     NtUserCreateActivationObject @ 0x1C003F6A0 (NtUserCreateActivationObject.c)
 * Callees:
 *     ?Destroy@CActivationObject@@SAJPEAV1@@Z @ 0x1C0017F68 (-Destroy@CActivationObject@@SAJPEAV1@@Z.c)
 ...
 *     ?GetGroupFromGroupId@CActivationObjectManager@@AEBAPEAVCActivationGroup@@AEBUACTIVATION_GROUP_ID@@@Z @ 0x1C00182A8 (-GetGroupFromGroupId@CActivationObjectManager@@AEBAPEAVCActivationGroup@@AEBUACTIVATION_GROUP_ID.c)
        ...
        struct _LUID *a8)
{
  ...
  else if ( qword_1C0259A38 )
  {
    v10 = qword_1C0259A38(a6, &v19);
  }
  else
  {
    v10 = 0;
