/*
 * XREFs of bInitPALOBJ @ 0x1C02991B0
 * Callers:
...
__int64 bInitPALOBJ()
{
  ...
  v0 = 0;
  v1 = (int *)&unk_1C0255DAC;
  *(_QWORD *)&pArrayOfSquares.peRed = &unk_1C0255DAC;
  v2 = 0;
  v3 = (int *)&unk_1C0255DAC;
  LODWORD(v4) = 256;
  do
  {
    v5 = v2 * v2;
  ...
  if ( !ghsemPalette )
    return 0LL;
  if ( logDefaultPal != 768 || !word_1C024D362 )
    goto LABEL_8;
  v17 = 0;
  v16 = 0LL;
  if ( !(unsigned int)PALMEMOBJ::bCreatePalette(
                        (PALMEMOBJ *)&v16,
                        1,
                        (unsigned __int16)word_1C024D362,
                        dword_1C024D364,
                        0,
                        0,
                        0,
...
LABEL_9:
  ...
  if ( v10 )
  {
    ...
    do
    {
      *(_DWORD *)((char *)&v9[7].Next->Next + v11) = *(_DWORD *)(v11 + *(_QWORD *)(v7 + 112));
      v11 += 4LL;
      --v12;
    }
    while ( v12 );
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      *((_DWORD *)&v9[7].Next->Next + v4) = *(_DWORD *)(*(_QWORD *)(v7 + 112) + 4LL * (unsigned int)(v4 - 236));
      --v13;
    }
    while ( v13 );
  }
