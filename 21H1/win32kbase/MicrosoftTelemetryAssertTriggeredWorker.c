/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C020161C
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C02015EC (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C002874C (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     TakeTelemetryAssertsLock @ 0x1C004CEA0 (TakeTelemetryAssertsLock.c)
 *     _tlgKeywordOn @ 0x1C0069BE0 (_tlgKeywordOn.c)
 *     __security_check_cookie @ 0x1C00CC180 (__security_check_cookie.c)
 *     GetImageTuple @ 0x1C020159C (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C0201B50 (_tlgCreate1Sz_char.c)
 */
...
LABEL_37:
  ...
  v19 = "<unknown>";
  if ( (unsigned int)dword_1C027F040 > 5 && tlgKeywordOn((__int64)&dword_1C027F040, 0x400000000000LL) )
  {
    v34 = 10;
    v65 = &v34;
    v21 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C027F040,
      (unsigned __int8 *)dword_1C0223E7F,
      0LL,
      v25,
      0xBu,
      &v64);
  }
  if ( dword_1C027F078 && !v18 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C027F040 > 5 && tlgKeywordOn((__int64)&dword_1C027F040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C027F040,
        (unsigned __int8 *)dword_1C0223F96,
        v28,
        0LL,
        v29,
        &v48);
