/*
 * XREFs of ?DownlevelInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@AEBUtagPTP_DOWNLEVELED_INPUT@@_K@Z @ 0x1C01A8728
 * Callers:
 ...
 *     ?PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z @ 0x1C01A9C2C (-PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z.c)
 */
  ...
  if ( *(int *)a2 >= 0 )
  {
    if ( v3 <= 1 )
    {
      if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 128LL) )
      {
        ...
        v13 = &v25;
        v26 = v21;
        v15 = (unsigned __int8 *)&unk_1C0220236;
        v25 = v12;
        goto LABEL_26;
      }
    }
    else if ( v3 == 2 && (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 128LL) )
    {
      if ( v7 )
      ...
      v13 = &v28;
      v27 = v14;
      v15 = (unsigned __int8 *)&unk_1C02201CE;
      v28 = v12;
LABEL_26:
      LODWORD(v30) = v11;
