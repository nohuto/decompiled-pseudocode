/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x1C00972F4
 * Callers:
 *     DrvUpdateDisplayDriverParameters @ 0x1C0097074 (DrvUpdateDisplayDriverParameters.c)
 * Callees:
 *     ?DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z @ 0x1C0097228 (-DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z.c)
        ...
        int a5)
{
  ...
  if ( (unsigned __int16)(gProtocolType - 1) <= 0xFFFDu )
    return 0;
  result = DrvWriteAttachedSettings(65533, a3, a4, a5, &v17);
  v9 = result;
  if ( !a5 )
  {
    if ( a4 )
    {
      ...
      if ( v9 >= 0 )
      {
        do
        {
          if ( v15 >= v17 )
            break;
          v16 = RtlWriteRegistryValue(0x40000000u, a3, off_1C020C130[v15], 4u, &v21[v15], 4u);
          ++v15;
          v9 = v16;
        }
        while ( v16 >= 0 );
