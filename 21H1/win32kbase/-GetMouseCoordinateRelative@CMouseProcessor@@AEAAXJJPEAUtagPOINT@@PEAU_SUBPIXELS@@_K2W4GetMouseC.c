/*
 * XREFs of ?GetMouseCoordinateRelative@CMouseProcessor@@AEAAXJJPEAUtagPOINT@@PEAU_SUBPIXELS@@_K2W4GetMouseCoordinateOptions@@@Z @ 0x1C00A5AB4
 * Callers:
        ...
        char a8)
{
  ...
  switch ( *((_DWORD *)a1 + 698) )
  {
    ...
    case 4:
      ...
      break;
    default:
      MicrosoftTelemetryAssertTriggeredNoArgsKM((unsigned int)(*((_DWORD *)a1 + 698) - 3));
LABEL_2:
      a4->x += v17;
      result = v18;
LABEL_3:
