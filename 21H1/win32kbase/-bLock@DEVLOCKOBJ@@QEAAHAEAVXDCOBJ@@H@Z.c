/*
 * XREFs of ?bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C00779B0
 * Callers:
...
__int64 __fastcall DEVLOCKOBJ::bLock(DEVLOCKOBJ *this, DC **a2, int a3)
{
  ...
  *((_QWORD *)this + 9) = *(_QWORD *)*a2;
  ...
  {
    if ( !qword_1C0257740
      || (int)qword_1C0257740() < 0
      || !qword_1C0257748
      || (v7 = qword_1C0257748(a2, (char *)this + 64, (char *)this + 56, (char *)this + 28), v7 != 1) )
    {
      LOBYTE(v7) = 0;
    }
    if ( !(_BYTE)v7 )
  ...
  if ( qword_1C02571D0 && (int)((__int64 (*)(void))qword_1C02571D0)() >= 0 && qword_1C02571D8 )
    qword_1C02571D8(this, 0LL);
  if ( a3 == 1 )
    ...
    *((_DWORD *)this + 6) |= 8u;
    ...
    if ( (v42 & 0x1000) != 0 && (v42 & 0x4000) == 0 )
    {
      if ( (*((_DWORD *)this + 6) & 0x1000) != 0 )
      {
        ...
        v132 = (struct _ERESOURCE *)ghsemDCVisRgn;
        if ( ghsemDCVisRgn )
          goto LABEL_211;
      }
      goto LABEL_212;
...
LABEL_57:
  ...
  if ( (*((_DWORD *)this + 6) & 0x20000) != 0 )
    return 1LL;
  if ( qword_1C02571D0 && (int)qword_1C02571D0(v43) >= 0 && qword_1C02571D8 )
    v54 = qword_1C02571D8(this, a2);
  else
    v54 = 0;
  v55 = *((_DWORD *)this + 6);
  if ( v54 )
