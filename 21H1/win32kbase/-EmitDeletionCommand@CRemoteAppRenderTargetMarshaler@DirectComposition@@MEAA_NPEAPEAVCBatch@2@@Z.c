/*
 * XREFs of ?EmitDeletionCommand@CRemoteAppRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01EE020
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  v8 = 0LL;
  if ( DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch ***)a2, 0xCuLL, &v8) )
  {
    v6 = (char *)v8;
    *(_DWORD *)v8 = 12;
    *(_QWORD *)(v6 + 4) = 0LL;
