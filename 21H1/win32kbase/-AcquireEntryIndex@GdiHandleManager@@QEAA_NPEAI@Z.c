/*
 * XREFs of ?AcquireEntryIndex@GdiHandleManager@@QEAA_NPEAI@Z @ 0x1C007CE20
 * Callers:
...
char __fastcall GdiHandleManager::AcquireEntryIndex(GdiHandleManager *this, unsigned int *a2)
{
  ...
  while ( *((_DWORD *)v2 + 1) < *((_DWORD *)v2 + 2) )
  {
    ...
    if ( v7 < *(_DWORD *)(v6 + 8) )
    {
      ...
      if ( *(_QWORD *)(*v17 + v19) )
        goto LABEL_23;
      *(_QWORD *)(v19 + *v17) = Win32AllocPool(4096LL, 1668048199LL);
      v18 = *v17;
      if ( *(_QWORD *)(*v17 + v19) )
      {
        v5 = 0LL;
...
LABEL_20:
    ...
    if ( v25 )
      goto LABEL_42;
    v26 = (void *)Win32AllocPool(0x40000LL, 1668114503LL);
    *((_QWORD *)v2 + 3) = v26;
    if ( v26 )
    {
