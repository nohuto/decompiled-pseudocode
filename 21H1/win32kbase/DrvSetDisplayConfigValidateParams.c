/*
 * XREFs of DrvSetDisplayConfigValidateParams @ 0x1C00D31B0
 * Callers:
 ...
 *     ?DrvIsTemporarySettingChangeDisabled@@YAHXZ @ 0x1C009CB24 (-DrvIsTemporarySettingChangeDisabled@@YAHXZ.c)
 *     _stricmp @ 0x1C00CC6B8 (_stricmp.c)
        ...
        char a5)
{
  ...
  {
    if ( (v129 & 0xFFFFFEBF) == 1 && v128 == 128 && !v126 )
    {
      return 0LL;
    }
    else
  ...
  else
  {
    ...
    if ( (v129 & 8) != 0 && v126 != 1 )
    {
      v78 = (_QWORD *)WdLogNewEntry5_WdAssertion(a1, a2, a3, a4);
      v78[3] = v126;
      v78[4] = v128;
      v78[5] = -1073741581LL;
