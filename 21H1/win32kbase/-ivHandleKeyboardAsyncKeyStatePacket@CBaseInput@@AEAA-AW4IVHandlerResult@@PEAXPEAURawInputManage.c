/*
 * XREFs of ?ivHandleKeyboardAsyncKeyStatePacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C01BA440
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ApplyKeyStateUpdate@@YAXE_N@Z @ 0x1C01B67BC (-ApplyKeyStateUpdate@@YAXE_N@Z.c)
...
__int64 __fastcall CBaseInput::ivHandleKeyboardAsyncKeyStatePacket(__int64 a1, unsigned __int16 *a2)
{
  ...
  __int64 v36; // rcx
  PEVENT_DATA_DESCRIPTOR v38; // [rsp+28h] [rbp-D8h]
  ...
  struct _EVENT_DATA_DESCRIPTOR v46; // [rsp+78h] [rbp-88h] BYREF
  int *v47; // [rsp+98h] [rbp-68h]
  __int64 v48; // [rsp+A0h] [rbp-60h]
  struct _EVENT_DATA_DESCRIPTOR v49; // [rsp+A8h] [rbp-58h] BYREF
  int *v50; // [rsp+C8h] [rbp-38h]
  __int64 v51; // [rsp+D0h] [rbp-30h]
  struct _EVENT_DATA_DESCRIPTOR v52; // [rsp+D8h] [rbp-28h] BYREF
  ...
  v35 = CKeyboardProcessor::HandleLeftRightVKs(*(_BYTE *)v2);
  v36 = v35;
  if ( v35 != *v2 )
    ApplyKeyStateUpdate(v35, *((_DWORD *)v2 + 1) != 0);
