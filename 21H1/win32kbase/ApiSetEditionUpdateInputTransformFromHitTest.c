/*
 * XREFs of ApiSetEditionUpdateInputTransformFromHitTest @ 0x1C0002240
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( qword_1C0259288 )
    result = qword_1C0259288();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C0259290;
    if ( qword_1C0259290 )
      result = qword_1C0259290(a1, v8, a3, a4, a5, a6);
  }
