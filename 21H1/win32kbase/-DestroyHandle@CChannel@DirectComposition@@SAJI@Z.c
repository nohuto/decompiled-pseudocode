/*
 * XREFs of ?DestroyHandle@CChannel@DirectComposition@@SAJI@Z @ 0x1C00B3848
 * Callers:
 *     NtDCompositionCreateDwmChannel @ 0x1C004A140 (NtDCompositionCreateDwmChannel.c)
 *     NtDCompositionDestroyChannel @ 0x1C00B3830 (NtDCompositionDestroyChannel.c)
 ...
 *     ?RemoveObject@?$CGenericTable@IVCChannel@DirectComposition@@$0HEGDEDEE@$00@DirectComposition@@QEAAPEAVCChannel@2@I@Z @ 0x1C00B391C (-RemoveObject@-$CGenericTable@IVCChannel@DirectComposition@@$0HEGDEDEE@$00@DirectComposition@@QE.c)
