/*
 * XREFs of ?SendSettingsUpdateToContainer@Settings@IVRootDeliver@@YAXAEBUCONTAINER_ID@@@Z @ 0x1C01B237C
 * Callers:
        ...
        const struct CONTAINER_ID *a2)
{
  ...
  if ( v13 )
  {
    ...
    *(_DWORD *)(v4 + 32) = qword_1C0250FC0;
    *(_DWORD *)(v4 + 36) = WORD6(gTouchPadParameters) & 0x7FF | ((*(_BYTE *)(&qword_1C0250FC0 + 1) & 0x7F) << 11);
    *(_DWORD *)v4 = *((_DWORD *)gpsi + 497);
    *(_DWORD *)(v4 + 4) = CMouseAcceleration::MOUSE_SENSITIVITY_INFO::GetMouseSensitivity((CDeviceAcceleration *)((char *)qword_1C0247098 + 104));
    *(_DWORD *)(v4 + 8) = *((_DWORD *)gpsi + 1247);
    *(_DWORD *)(v4 + 12) = dword_1C024D2E0;
    *(_DWORD *)(v4 + 16) = dword_1C024D2B0;
