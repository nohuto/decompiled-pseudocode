/*
 * XREFs of ?SetBufferProperty@CAnimationLoggingManagerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C00C0810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchLengthW@@YAJPEBG_KPEA_K@Z @ 0x1C00C0AA4 (-StringCchLengthW@@YAJPEBG_KPEA_K@Z.c)
    ...
    if ( v10 )
    {
      ...
      if ( v11 )
      {
        ...
        if ( v23 )
        {
          if ( v23 == 2 && a5 == 16 )
          {
            ...
            if ( v29 )
            {
              ...
              p_Src = &v41;
              v20 = *((_QWORD *)this + 23);
              v21 = (void *)(*((_QWORD *)this + 19) + v20 * (*((_QWORD *)this + 22) - 1LL));
              goto LABEL_15;
            }
          }
        ...
        if ( a5 )
        {
          ...
          v26 = (unsigned __int16 *)Win32AllocPoolWithQuota(a5, 0x6D6C4344u);
          *((_QWORD *)this + 31) = v26;
          if ( !v26 )
      ...
      if ( v17 )
      {
        ...
        if ( v6 >= 0 )
        {
          v18 = Win32AllocPoolWithQuota(2 * v15 + 16, 0x6D6C4344u);
          Src = v18;
          if ( v18 )
          {
            ...
            *(_QWORD *)(v18 + 8) = v15;
            if ( (int)StringCchCopyW((unsigned __int16 *)(v18 + 16), v15, v12) >= 0 )
            {
              p_Src = (__m128i *)&Src;
              v20 = *((_QWORD *)this + 29);
              v21 = (void *)(*((_QWORD *)this + 25) + v20 * (*((_QWORD *)this + 28) - 1LL));
LABEL_15:
    ...
    else
    {
      ...
      if ( v31 )
      {
        ...
        if ( v6 >= 0 )
        {
          p_Src = (__m128i *)v39;
          v20 = *((_QWORD *)this + 17);
          v21 = (void *)(*((_QWORD *)this + 13) + v20 * (*((_QWORD *)this + 16) - 1LL));
          goto LABEL_15;
        }
      }
    }
  ...
  else
  {
    ...
    if ( v35 )
    {
      ...
      v40[2] = (*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v35 + 8LL))(v35);
      v6 = DirectComposition::CDCompDynamicArrayBase::Grow(
      ...
      if ( v6 >= 0 )
      {
        p_Src = (__m128i *)v40;
        v20 = *((_QWORD *)this + 11);
        v21 = (void *)(*((_QWORD *)this + 7) + v20 * (*((_QWORD *)this + 10) - 1LL));
        goto LABEL_15;
      }
    }
  }
