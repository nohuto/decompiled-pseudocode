/*
 * XREFs of ApiSetEditionIsGpqForegroundAccessibleExplicit @ 0x1C006211C
 * Callers:
 ...
 *     ProcessKeyboardInjectedInputViaRim @ 0x1C01B3420 (ProcessKeyboardInjectedInputViaRim.c)
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( qword_1C0259188 )
    ...
    v9 = -1073741637;
  if ( v9 >= 0 && qword_1C0259190 )
    v8 = qword_1C0259190(a1, v6, a3, a4);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(a2) = 5;
    WPP_RECORDER_SF_(
