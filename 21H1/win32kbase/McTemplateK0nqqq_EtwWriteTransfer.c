/*
 * XREFs of McTemplateK0nqqq_EtwWriteTransfer @ 0x1C0130774
 * Callers:
...
NTSTATUS __fastcall McTemplateK0nqqq_EtwWriteTransfer(
        __int64 a1,
        ...
        char a8)
{
  ...
  v15 = 4LL;
  v17 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, &W32kControlGuid, 5u, &v9);
}
