/*
 * XREFs of ?DispatchBufferedInputFrames@DelayZonePalmRejection@@QEAAXXZ @ 0x1C01AF830
 * Callers:
  ...
  if ( *((_DWORD *)this + 1) == 1 && !*((_BYTE *)this + 8) )
  {
    ...
    while ( Next && Next != v3 )
      Next = CTouchProcessor::DispatchFramePostDelayZoneProcessingAndGetNext(
               ...
               Next);
    if ( v3 )
      CTouchProcessor::DispatchFramePostDelayZoneProcessingAndGetNext((struct _LIST_ENTRY *)gpTouchProcessor, v3);
    *((_QWORD *)this + 7) = 0LL;
    *((_QWORD *)this + 8) = 0LL;
