/*
 * XREFs of ?CapturePointer@CApplicationChannel@DirectComposition@@QEAAJIW4CapturePointerType@@I_K@Z @ 0x1C01D6E08
 * Callers:
 ...
 *     ?OwnsPointerId@CInputManager@@SA_NII@Z @ 0x1C01FBD0C (-OwnsPointerId@CInputManager@@SA_NII@Z.c)
 */
