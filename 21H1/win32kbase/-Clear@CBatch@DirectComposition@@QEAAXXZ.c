/*
 * XREFs of ?Clear@CBatch@DirectComposition@@QEAAXXZ @ 0x1C00B9C14
 * Callers:
 ...
 *     ?RemoveFromSynchronizationTable@CSynchronizationManager@DirectComposition@@SAXPEAVCBatch@2@@Z @ 0x1C00BA324 (-RemoveFromSynchronizationTable@CSynchronizationManager@DirectComposition@@SAXPEAVCBatch@2@@Z.c)
  ...
  *((_QWORD *)this + 10) = 0LL;
  ...
  if ( v9 )
  {
    do
    {
      ...
      DirectComposition::CEvent::`scalar deleting destructor'(v9, v3, v4);
      *((_QWORD *)this + 13) = v15;
      v9 = v15;
    }
    while ( v15 );
