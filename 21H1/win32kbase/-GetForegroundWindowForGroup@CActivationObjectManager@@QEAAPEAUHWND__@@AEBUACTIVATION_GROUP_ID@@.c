/*
 * XREFs of ?GetForegroundWindowForGroup@CActivationObjectManager@@QEAAPEAUHWND__@@AEBUACTIVATION_GROUP_ID@@@Z @ 0x1C0132CE0
 * Callers:
 *     GetForegroundWindow @ 0x1C0133050 (GetForegroundWindow.c)
 * Callees:
