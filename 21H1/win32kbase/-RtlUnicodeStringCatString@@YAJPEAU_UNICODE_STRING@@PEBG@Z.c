/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C0188308
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0188400 (RtlWideCharArrayCopyStringWorker.c)
 */
