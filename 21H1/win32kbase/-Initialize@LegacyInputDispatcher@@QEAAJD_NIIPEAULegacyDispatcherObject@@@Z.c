/*
 * XREFs of ?Initialize@LegacyInputDispatcher@@QEAAJD_NIIPEAULegacyDispatcherObject@@@Z @ 0x1C004A740
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LegacyDispatcherObject *a6)
{
  ...
  if ( *((_QWORD *)this + 4) )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(this);
  *((_QWORD *)this + 1) = Win32AllocPoolNonPaged(8 * v7, 2037609301LL);
  *((_QWORD *)this + 3) = Win32AllocPoolNonPaged(48 * v7, 2001433429LL);
  v11 = Win32AllocPool(16 * v7, 1885947971LL);
  *((_QWORD *)this + 4) = v11;
  *((_DWORD *)this + 12) = 1;
  if ( !*((_QWORD *)this + 3) )
    return 3221225495LL;
