/*
 * XREFs of ?Wait@IOCPDispatcher@@QEAAJPEAT_LARGE_INTEGER@@EPEAU_FILE_IO_COMPLETION_INFORMATION@@@Z @ 0x1C01A7540
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _FILE_IO_COMPLETION_INFORMATION *a4)
{
  ...
  *(_OWORD *)&a4->IoStatusBlock.Status = 0LL;
  ...
  {
    v10 = a3;
    return ((__int64 (__fastcall *)(_QWORD, struct _FILE_IO_COMPLETION_INFORMATION *, __int64, _DWORD *, union _LARGE_INTEGER *, char))ZwRemoveIoCompletionEx)(
             *((_QWORD *)this + 343),
             a4,
             1LL,
             v11,
