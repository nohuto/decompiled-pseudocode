/*
 * XREFs of AlignRects @ 0x1C00B05D8
 * Callers:
 ...
 *     ?DxgkEngAdjustMonitorPosition@@YAHPEAUtagRECT@@II@Z @ 0x1C00B05C0 (-DxgkEngAdjustMonitorPosition@@YAHPEAUtagRECT@@II@Z.c)
 * Callees:
 *     ?RemoveGaps@@YAHPEAUtagRECT@@I@Z @ 0x1C01D3E44 (-RemoveGaps@@YAHPEAUtagRECT@@I@Z.c)
 *     ?RemoveOverlaps@@YAXPEAUtagRECT@@I@Z @ 0x1C01D41DC (-RemoveOverlaps@@YAXPEAUtagRECT@@I@Z.c)
 */
