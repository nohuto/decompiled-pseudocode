/*
 * XREFs of UnpackMouseSettings @ 0x1C01B2540
 * Callers:
...
void *__fastcall UnpackMouseSettings(int *a1, int a2)
{
  ...
  v5 = a1[1];
  if ( v5 != (unsigned int)CMouseAcceleration::MOUSE_SENSITIVITY_INFO::GetMouseSensitivity((CDeviceAcceleration *)((char *)qword_1C0247098 + 104)) )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v9) = v5;
    ...
    CDeviceAcceleration::ResetAccelerationCurves(qword_1C0247098);
  }
  result = gpsi;
  v8 = a1[2];
