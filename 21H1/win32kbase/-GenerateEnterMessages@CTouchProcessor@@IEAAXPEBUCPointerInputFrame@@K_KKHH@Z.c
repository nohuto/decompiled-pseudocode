/*
 * XREFs of ?GenerateEnterMessages@CTouchProcessor@@IEAAXPEBUCPointerInputFrame@@K_KKHH@Z @ 0x1C019495C
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)(v8 + 180) & 1) != 0 )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_LL(v10, v9, v11, 205, 585, *(_DWORD *)(v8 + 172), *(_WORD *)(v8 + 160));
    }
    ...
    if ( (*(_DWORD *)v8 & 4) == 0 && (v12 & 8) != 0 || (v12 & 0x40) != 0 )
    {
      ...
      if ( !(unsigned int)CTouchProcessor::GenerateMessage(this, v8, a4, v6) )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          return;
        LOBYTE(a2) = 2;
        WPP_RECORDER_SF_LL(v13, (_DWORD)a2, v14, 206, 585, *(_DWORD *)(v8 + 172), *(_WORD *)(v8 + 160));
      }
    }
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
