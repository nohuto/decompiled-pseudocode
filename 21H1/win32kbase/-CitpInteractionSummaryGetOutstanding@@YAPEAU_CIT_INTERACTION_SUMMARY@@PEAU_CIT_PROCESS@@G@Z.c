/*
 * XREFs of ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C01FF4B0
 * Callers:
...
struct _CIT_INTERACTION_SUMMARY *__fastcall CitpInteractionSummaryGetOutstanding(struct _CIT_PROCESS *a1)
{
  ...
  if ( (xmmword_1C0256414 & 2) != 0 )
  {
    ...
    if ( (unsigned int)v3 >= *((_DWORD *)xmmword_1C0256430 + 14) )
      return 0LL;
    v4 = *(_QWORD *)xmmword_1C0256430 + 96 * v3;
