/*
 * XREFs of EngLockSurface @ 0x1C0086390
 * Callers:
...
SURFOBJ *__stdcall EngLockSurface(HSURF hsurf)
{
  ...
  if ( v7 == 5 )
  {
    ...
    if ( v8 && qword_1C024D3D8 )
      NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C024D3D8, v8, 0);
  }
  else if ( v7 == 16 )
  {
