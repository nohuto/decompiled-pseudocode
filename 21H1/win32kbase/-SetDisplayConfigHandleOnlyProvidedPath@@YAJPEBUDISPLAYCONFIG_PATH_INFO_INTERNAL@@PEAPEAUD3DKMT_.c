/*
 * XREFs of ?SetDisplayConfigHandleOnlyProvidedPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@PEA_NPEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x1C014FECC
 * Callers:
 *     DrvSetDisplayConfig @ 0x1C0098260 (DrvSetDisplayConfig.c)
 * Callees:
 *     ??8@YA_NAEBU_LUID@@0@Z @ 0x1C000E578 (--8@YA_NAEBU_LUID@@0@Z.c)
        ...
        enum _DXGK_DIAG_SDC_STAGE *a4)
{
  ...
  int v21; // r13d
  __int64 v22; // rcx
  int v23; // [rsp+44h] [rbp-34h]

  v5 = a3;
  result = GetPathsModality((__int64)a1, a2, 64LL, 0LL);
  if ( (int)result < 0 )
  {
    *(_DWORD *)a4 = 32;
    return result;
  ...
  for ( i = *((unsigned __int16 *)*a2 + 10); v11 < *((unsigned __int16 *)*a2 + 10); ++v11 )
  {
      ...
      && *((_DWORD *)v13 + 19) == *((_DWORD *)a1 + 7) )
    {
      ...
      {
        v20 = WdLogNewEntry5_WdAssertion(0x4000000000000LL, v14, v16, v17);
  ...
  {
    v22 = 272LL * i;
    if ( (_DWORD)v10 == *(_DWORD *)((char *)v9 + v22 + 192) && v23 == *(_DWORD *)((char *)v9 + v22 + 196) )
      return 0LL;
  }
  *(_DWORD *)a4 = 33;
  return 3221225485LL;
