/*
 * XREFs of McTemplateK0cd_EtwWriteTransfer @ 0x1C012F690
 * Callers:
 *     EtwTraceEndAppMessageProcessing @ 0x1C0016E60 (EtwTraceEndAppMessageProcessing.c)
 *     EtwTraceBeginDispatchMessage @ 0x1C0031D80 (EtwTraceBeginDispatchMessage.c)
 *     EtwTraceEndDispatchMessage @ 0x1C0031DA0 (EtwTraceEndDispatchMessage.c)
 *     EtwTraceWakeDIT @ 0x1C0036060 (EtwTraceWakeDIT.c)
 *     EtwTraceEndTranslateMessage @ 0x1C0045980 (EtwTraceEndTranslateMessage.c)
 *     EtwTraceBeginTranslateMessage @ 0x1C00459A0 (EtwTraceBeginTranslateMessage.c)
