/*
 * XREFs of ?KernelCreateCompositionInputSink@CompositionInputObject@@SAJPEBUCOMPOSITION_INPUT_SINK_V2@@PEAPEAX@Z @ 0x1C002FB64
 * Callers:
 ...
 *     ?CompositionInputQueueTypeToString@InputTraceLogging@@CAPEBDW4CompositionInputQueueType@@@Z @ 0x1C01FC4A8 (-CompositionInputQueueTypeToString@InputTraceLogging@@CAPEBDW4CompositionInputQueueType@@@Z.c)
 */
    ...
    *((_QWORD *)v21 + 4) = v33;
    ...
    if ( v13 >= 0 )
    {
      ...
      *a2 = Handle;
      ...
      Object = 0LL;
      LOBYTE(v35) = 1;
      if ( (int)CompositionInputObject::ResolveHandle(v34, 1LL, v35, (struct CompositionInputObject **)&Object) >= 0 )
      {
        v39 = Object;
        if ( (unsigned int)dword_1C024C960 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C024C960, 4LL, v37, v38) )
        {
          v40 = L"FallbackInteraction";
          if ( (v127 & 2) == 0 )
            v40 = &word_1C0211C10;
          *(_QWORD *)&v54[1] = v40;
          v41 = L"Implicit";
