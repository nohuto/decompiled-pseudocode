/*
 * XREFs of RIMIDECreateDeviceInstancePath @ 0x1C016F970
 * Callers:
...
__int64 __fastcall RIMIDECreateDeviceInstancePath(__int64 a1, __int64 a2)
{
  ...
  if ( !isChildPartition(a1, a2) )
  {
    if ( v6 )
    {
      ...
      v11 = RtlUnicodeStringPrintf(v5, L"\\??\\Microsoft Keyboard RID\\%u", (unsigned int)dword_1C025A4C8);
    }
    else
    {
      v11 = RtlUnicodeStringPrintf(v5, L"\\??\\Microsoft Mouse RID\\%u", (unsigned int)dword_1C025A4C8);
    }
LABEL_20:
    v2 = v11;
    if ( v11 >= 0 )
  ...
  {
    case 0:
      v11 = RtlUnicodeStringPrintf(v5, L"\\??\\Microsoft Mouse RID\\c\\%u", (unsigned int)dword_1C025A4C8);
      goto LABEL_20;
    case 1:
      v11 = RtlUnicodeStringPrintf(v5, L"\\??\\Microsoft Keyboard RID\\c\\%u", (unsigned int)dword_1C025A4C8);
      goto LABEL_20;
    case 2:
      v8 = v4;
      v9 = (unsigned __int16)v3;
...
LABEL_9:
      v11 = RtlUnicodeStringPrintf(v5, v10, v9, v8, dword_1C025A4C8);
      goto LABEL_20;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
