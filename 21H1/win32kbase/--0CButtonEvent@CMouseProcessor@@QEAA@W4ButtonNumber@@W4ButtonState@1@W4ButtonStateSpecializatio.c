/*
 * XREFs of ??0CButtonEvent@CMouseProcessor@@QEAA@W4ButtonNumber@@W4ButtonState@1@W4ButtonStateSpecialization@1@PEBVCMouseEvent@1@@Z @ 0x1C005F154
 * Callers:
  ...
  *(_DWORD *)(a1 + 16) = 2;
  ...
  switch ( *(_DWORD *)(a1 + 24) )
  {
    ...
    case 0x10:
      ...
      break;
    default:
      MicrosoftTelemetryAssertTriggeredNoArgsKM((unsigned int)(*(_DWORD *)(a1 + 24) - 8));
      return a1;
  }
  *(_QWORD *)(a1 + 40) = v7;
  return a1;
