/*
 * XREFs of ?DrvUpdateDisplayModeInPdev@@YAHPEAUHDEV__@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C014EC64
 * Callers:
 ...
 *     ?DevmodeAutoRotateCompatible@@YA_NPEBU_devicemodeW@@0@Z @ 0x1C014D580 (-DevmodeAutoRotateCompatible@@YA_NPEBU_devicemodeW@@0@Z.c)
 *     ?DrvCheckGraphicsDeviceForSmoothRotation@@YAHPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C014DB18 (-DrvCheckGraphicsDeviceForSmoothRotation@@YAHPEAUtagGRAPHICS_DEVICE@@@Z.c)
 */
...
LABEL_13:
  ...
  v2 = v30;
LABEL_22:
  EtwTraceGreLockReleaseSemaphore((__int64)L"po.hsemDevLock()", (int)v2[6], v19);
  ...
  EtwTraceGreLockReleaseSemaphore((__int64)L"po.hsemPointer()", (int)v2[8], v24);
