/*
 * XREFs of ?RerouteWheel@Mouse@InputTraceLogging@@SAX_K@Z @ 0x1C01C4308
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::RerouteWheel()
{
  ...
  if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 64LL) )
  {
    ...
    v1 = v0;
    v4 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C0221354, 0LL, 0LL, 3u, &v2);
  }
}
