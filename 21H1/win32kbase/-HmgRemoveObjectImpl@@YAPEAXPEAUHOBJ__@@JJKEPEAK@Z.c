/*
 * XREFs of ?HmgRemoveObjectImpl@@YAPEAXPEAUHOBJ__@@JJKEPEAK@Z @ 0x1C00865B0
 * Callers:
...
__int64 __fastcall HmgRemoveObjectImpl(struct HOBJ__ *a1, __int16 a2, int a3, char a4, char a5, unsigned int *a6)
{
  ...
  int v78; // ecx
  int v79; // r8d
  struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer *v80; // rdx
  ...
  __int64 v101; // [rsp+40h] [rbp-78h] BYREF
  __int64 v102; // [rsp+48h] [rbp-70h]
  __int64 v103; // [rsp+50h] [rbp-68h]
  unsigned __int64 v104; // [rsp+58h] [rbp-60h]
  __int64 v105; // [rsp+60h] [rbp-58h]
  unsigned __int16 *v106; // [rsp+68h] [rbp-50h] BYREF
  int v107; // [rsp+70h] [rbp-48h]
  int v108; // [rsp+74h] [rbp-44h]
  PVOID Object; // [rsp+C0h] [rbp+8h] BYREF
  int v110; // [rsp+D0h] [rbp+18h]
  unsigned int v111; // [rsp+D8h] [rbp+20h]
  ...
  v101 = 0LL;
  CurrentThreadWin32ThreadAndEnterCriticalRegion = PsGetCurrentThreadWin32ThreadAndEnterCriticalRegion(&v101);
  ...
  {
    v102 = *(_QWORD *)(*(_QWORD *)CurrentThreadWin32ThreadAndEnterCriticalRegion + 72LL);
  }
  else
  {
    v102 = 0LL;
...
LABEL_164:
  ...
  {
    v105 = 16LL * (unsigned __int8)v17;
    v24 = *(_QWORD **)(v22 + 24);
    v104 = 8 * ((unsigned __int64)v17 >> 8);
    Object = (PVOID)(v105 + *(_QWORD *)(*v24 + v104));
    KeEnterCriticalRegion();
    ExAcquirePushLockExclusiveEx(Object, 0LL);
    v25 = (_QWORD *)v103;
    if ( v17 < *(_DWORD *)(v103 + 20) && *(_QWORD *)(*(_QWORD *)(**(_QWORD **)(v103 + 24) + v104) + v105 + 8) )
    {
      v26 = 24LL * v17;
      *(_DWORD *)(v26 + *(_QWORD *)v103 + 8) |= 1u;
  ...
  {
    v28 = v27 & 0xFFFFFFFE;
    if ( v28 != (v101 & 0xFFFFFFFC) && v28 && (!v102 || v28 != *(_DWORD *)(v102 + 8)) )
      goto LABEL_134;
  }
  v29 = *((_BYTE *)v23 + 15);
  if ( (v29 & 0x20) != 0 )
  ...
  if ( (v29 & 0x40) == 0 )
    goto LABEL_28;
  v87 = gpHandleManager;
  v88 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, *(_DWORD *)v23 & 0xFFFFFF);
  v89 = *((_QWORD *)v87 + 2);
  v90 = v88;
  v91 = *(_DWORD *)(v89 + 2056);
...
LABEL_131:
  ...
  {
LABEL_134:
    HANDLELOCK::vUnlock((HANDLELOCK *)&v106);
    if ( !v107 )
    {
LABEL_165:
      v35 = 0LL;
...
LABEL_139:
  ...
  if ( (a4 & 2) != 0 )
  {
    v82 = *((_DWORD *)v23 + 2) & 0xFFFFFFFE;
    if ( v82 != -2147483630 )
    {
      CurrentProcessId = (unsigned int)PsGetCurrentProcessId();
      if ( v82 != (CurrentProcessId & 0xFFFFFFFC) && v82 )
      {
        HANDLELOCK::vUnlock((HANDLELOCK *)&v106);
        goto LABEL_165;
      }
...
LABEL_153:
        ...
        if ( v49 == 5 )
        {
          v80 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v35 + 680);
          v81 = 0;
        }
        else
        {
          if ( v49 != 16 )
            goto LABEL_68;
          v80 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v35 + 136);
          v81 = 2;
        }
        TrackObjectReferenceDecrement(v81, v80);
LABEL_68:
        v50 = *((_DWORD *)v23 + 2);
        v51 = v50 & 0xFFFFFFFE;
        if ( (v50 & 0xFFFFFFFE) != 0 && v51 != -2147483630 )
        {
          ...
          if ( W32ProcessFromId )
          {
            GreAcquireHmgrSemaphore(v74, v73, v76);
            --*((_DWORD *)W32ProcessFromId + 15);
            GreReleaseHmgrSemaphore(v78, v77, v79);
          }
          if ( Object )
        ...
        if ( (Microsoft_Windows_Win32kEnableBits & 0x40000000000LL) != 0 )
        {
          ...
          McTemplateK0pqqq_EtwWriteTransfer(v98, (unsigned int)&GdiDestroyHandle, v99, *v97, EtwGdiHandleType);
        }
        *((_BYTE *)v23 + 14) = 0;
        *((_QWORD *)v23 + 2) = 0LL;
        *((_DWORD *)v23 + 2) = v50 & 1;
...
LABEL_155:
        ...
        if ( v61 )
        {
          v100 = *(_DWORD *)(4LL * (unsigned __int16)v60 + v61);
          Object = (PVOID)(4LL * (unsigned __int16)v60);
          if ( v100 )
          {
            if ( GdiHandleEntryDirectory::AcquireEntryLock(v62, v100, 1) )
              GdiHandleEntryDirectory::ReleaseLockAndEntry(*((GdiHandleEntryDirectory **)v52 + 2), v100, 1);
