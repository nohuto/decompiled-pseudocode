/*
 * XREFs of ValidateHwndEx @ 0x1C008BD80
 * Callers:
...
__int64 __fastcall ValidateHwndEx(__int64 a1, int a2, int a3)
{
  ...
  if ( (unsigned __int64)(unsigned __int16)a1 >= *((_QWORD *)gpsi + 1) )
    goto LABEL_25;
  v7 = (char *)qword_1C0250D48 + (unsigned int)(unsigned __int16)a1 * dword_1C0250D50;
  v8 = 3 * ((__int64)((unsigned int)(unsigned __int16)a1 * dword_1C0250D50) >> 5);
  v9 = (__int64 *)((char *)gpKernelHandleTable + 24 * ((__int64)(unsigned int)(v4 * dword_1C0250D50) >> 5));
  ...
  if ( *v9
    ...
    && (!a2
     ...
     && qword_1C0257C28
     && ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0257C28)(*(_QWORD *)(v11 + 416), *(_QWORD *)(v15 + 24))) )
  {
