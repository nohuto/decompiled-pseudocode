/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C002EF44
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C002EF00 (CreateSharedReadTransformMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadTransformMarshaler **a2)
{
  ...
  v4 = (struct DirectComposition::CSharedReadTransformMarshaler *)Win32AllocPoolWithQuotaZInit(0x48uLL);
  v5 = v4;
  if ( v4 )
  {
    memset(v4, 0, 0x48uLL);
