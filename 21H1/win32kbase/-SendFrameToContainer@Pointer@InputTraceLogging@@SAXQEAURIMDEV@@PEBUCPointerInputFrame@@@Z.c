/*
 * XREFs of ?SendFrameToContainer@Pointer@InputTraceLogging@@SAXQEAURIMDEV@@PEBUCPointerInputFrame@@@Z @ 0x1C01BDB44
 * Callers:
    ...
    if ( (unsigned int)(v2 - 5) > 1 )
    {
      if ( v2 == 7 )
      {
        if ( (unsigned int)dword_1C024C960 <= 4 || !tlgKeywordOn((__int64)&dword_1C024C960, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C0220E08;
      }
      else
      {
        if ( (unsigned int)dword_1C024C960 <= 4 || !tlgKeywordOn((__int64)&dword_1C024C960, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C0220ED4;
      }
    }
    else
    {
      if ( (unsigned int)dword_1C024C960 <= 4 || !tlgKeywordOn((__int64)&dword_1C024C960, 32LL) )
        return;
      v7 = (unsigned __int8 *)&unk_1C0220E6E;
    }
    v10 = *(_DWORD *)(v5 + 48);
    v11 = *(_DWORD *)(v5 + 40);
    v12 = *(_QWORD *)(v5 + 72);
