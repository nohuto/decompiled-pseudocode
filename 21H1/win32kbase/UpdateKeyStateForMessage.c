/*
 * XREFs of UpdateKeyStateForMessage @ 0x1C002E520
 * Callers:
 ...
 *     _anonymous_namespace_::UpdateKeyState @ 0x1C002E600 (_anonymous_namespace_--UpdateKeyState.c)
 */
...
LABEL_14:
      LOBYTE(a2) = v11;
      return anonymous_namespace_::UpdateKeyState(*(_QWORD *)(a1 + 424), a2, a3, a4);
    }
    return result;
  }
  result = v4 - 516;
