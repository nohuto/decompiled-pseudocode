/*
 * XREFs of ApiSetEditionxxxBroadcastSPIChange @ 0x1C01D0B98
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetEditionxxxBroadcastSPIChange(unsigned int a1))(_QWORD, _QWORD)
{
  ...
  if ( qword_1C02587C8 )
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02587C8();
  else
    result = 0LL;
  if ( (int)result >= 0 )
  {
    result = qword_1C02587D0;
    if ( qword_1C02587D0 )
      result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02587D0(a1, 0LL);
  }
