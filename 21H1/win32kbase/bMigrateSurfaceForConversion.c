/*
 * XREFs of bMigrateSurfaceForConversion @ 0x1C009B480
 * Callers:
 ...
 *     ?bUnMapImmediate@SURFREFVIEW@@QEAAHXZ @ 0x1C0019D40 (-bUnMapImmediate@SURFREFVIEW@@QEAAHXZ.c)
...
LABEL_4:
        ...
        v14) )
  {
    ...
    if ( qword_1C02571B0 )
      ...
      v28 = -1073741637;
    if ( v28 >= 0 && qword_1C02571B8 )
      v25 = (HLSURF)qword_1C02571B8(*((_QWORD *)a1 + 6), v27, 0LL, 1LL, 1);
      ...
      *((_DWORD *)a2 + 29) ^= (v39 ^ *((_DWORD *)a2 + 29)) & 0x390D;
      ...
      if ( v27 )
      {
        ...
        if ( v24 )
        {
          ...
          if ( v66 >= 0 && qword_1C0257158 )
            qword_1C0257158(*((_QWORD *)v12 + 6), v98, a2, v96);
        }
        else
        {
          v67 = -1073741637;
        ...
        while ( 1 )
        {
          ...
          if ( !v68 )
            break;
          if ( (int)IsvSpDwmMigrateLSurfShapeReferenceSupported() >= 0 && qword_1C0257168 )
            qword_1C0257168(*((_QWORD *)v12 + 6), v68, a2);
        }
      ...
      if ( (*((_DWORD *)a2 + 29) & 4) != 0 )
      {
        ...
        if ( v84 )
        {
          if ( *(_QWORD *)(v84 + 24) )
          {
            if ( qword_1C0257170 )
              v67 = qword_1C0257170();
            if ( v67 >= 0 && qword_1C0257178 )
              qword_1C0257178(*(_QWORD *)(v85 + 24), v101, v100);
          }
