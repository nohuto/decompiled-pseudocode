/*
 * XREFs of GreCreateBitmap @ 0x1C0090E80
 * Callers:
  ...
  else
  {
    ...
    if ( v13 )
    {
      *(_DWORD *)(v13 + 112) |= 0x4000000u;
      ...
      {
        v19 = 0;
        v12 = qword_1C0257790 ? qword_1C0257790() : -1073741637;
        if ( v12 >= 0 && qword_1C0257798 )
          qword_1C0257798(*(_QWORD *)(v13 + 32), (unsigned int)v7, a5, &v19);
      }
      if ( v8 != 1 )
      {
