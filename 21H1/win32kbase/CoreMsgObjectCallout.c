/*
 * XREFs of CoreMsgObjectCallout @ 0x1C005F05C
 * Callers:
...
__int64 __fastcall CoreMsgObjectCallout(unsigned int a1, _QWORD *a2)
{
  ...
  if ( (unsigned int)dword_1C024B450 > 5 )
  {
    ...
    v13 = a1;
    v16 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024B450, (unsigned __int8 *)dword_1C0223879, 0LL, 0LL, 3u, &v14);
  }
...
LABEL_9:
  if ( (unsigned int)dword_1C024B450 > 5 )
  {
    ...
    v13 = v7;
    v16 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024B450, (unsigned __int8 *)dword_1C0223820, 0LL, 0LL, 3u, &v14);
  }
  if ( v12[0] )
