/*
 * XREFs of McTemplateK0pqqqq_EtwWriteTransfer @ 0x1C01310D8
 * Callers:
 *     EtwTraceInternalSetTimer @ 0x1C0019CE0 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1C001A190 (EtwTraceTimerProc.c)
 *     EtwDirtyRectUpdate @ 0x1C001C7C0 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C01560C0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C0156100 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C0156490 (EtwTranslationUpdate.c)
 * Callees:
