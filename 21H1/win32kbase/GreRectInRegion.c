/*
 * XREFs of GreRectInRegion @ 0x1C0019130
 * Callers:
 *     NtGdiRectInRegion @ 0x1C00C5B10 (NtGdiRectInRegion.c)
 *     EngRectInRgn @ 0x1C0155720 (EngRectInRgn.c)
 * Callees:
 *     ?bInside@RGNOBJ@@QEAAHPEAU_RECTL@@@Z @ 0x1C0019190 (-bInside@RGNOBJ@@QEAAHPEAU_RECTL@@@Z.c)
