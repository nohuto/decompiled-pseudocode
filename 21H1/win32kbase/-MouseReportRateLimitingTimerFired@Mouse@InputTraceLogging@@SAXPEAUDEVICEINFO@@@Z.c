/*
 * XREFs of ?MouseReportRateLimitingTimerFired@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@@Z @ 0x1C01B4ED0
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::MouseReportRateLimitingTimerFired(struct DEVICEINFO *a1)
{
  ...
  if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 64LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C02208BD, 0LL, 0LL, 3u, &v3);
  }
}
