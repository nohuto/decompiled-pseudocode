/*
 * XREFs of xxxKeyEventEx @ 0x1C0060840
 * Callers:
 *     ?xxxNumpadCursor@@YAHPEAUtagKE@@@Z @ 0x1C003CC90 (-xxxNumpadCursor@@YAHPEAUtagKE@@@Z.c)
 *     ?xxxICO_00@@YAHPEAUtagKE@@@Z @ 0x1C0040520 (-xxxICO_00@@YAHPEAUtagKE@@@Z.c)
 *     ?xxxAdjustPushState@@YAXPEAUtagTHREADINFO@@EEPEAUtagKL@@1@Z @ 0x1C01ADA4C (-xxxAdjustPushState@@YAXPEAUtagTHREADINFO@@EEPEAUtagKL@@1@Z.c)
 ...
 *     xxxKeyEvent @ 0x1C01B3D10 (xxxKeyEvent.c)
 *     xxxProcessKeyEvent @ 0x1C01B3D60 (xxxProcessKeyEvent.c)
 *     ?xxxAltGr@@YAXPEAUtagKE@@@Z @ 0x1C01B40D4 (-xxxAltGr@@YAXPEAUtagKE@@@Z.c)
 *     ?xxxShiftLock@@YAHPEAUtagKE@@@Z @ 0x1C01B416C (-xxxShiftLock@@YAHPEAUtagKE@@@Z.c)
 * Callees:
 ...
 *     GetKeyEventInputSource @ 0x1C00615F0 (GetKeyEventInputSource.c)
 *     ?OnKeyEvent@CAsyncKeyEventMonitor@@QEAAXXZ @ 0x1C00621F4 (-OnKeyEvent@CAsyncKeyEventMonitor@@QEAAXXZ.c)
        ...
        struct _KEYBOARD_VIRTUAL_DEVICE_INFO *a10)
{
  ...
  *(_QWORD *)v29 = 0LL;
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C024C960, 0x4000LL, v21, v22) )
    {
      LODWORD(v40) = a8;
      v31 = v41;
      v35 = (__int64)a5;
