/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x1C016F050
 * Callers:
 ...
 *     ?InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z @ 0x1C016F284 (-InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z.c)
 */
  ...
  if ( (_BYTE)v1 != 2 )
  {
    if ( (_BYTE)v1 )
    {
      ...
      if ( (unsigned int)dword_1C024C960 <= 4 )
        return v1;
      LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1C024C960, 256LL);
      if ( !(_BYTE)v1 )
        return v1;
      LODWORD(v33) = v25;
      v34 = v26;
      v21 = InputTraceLogging::InjectionSourceToString(v27);
      v24 = (unsigned __int8 *)&unk_1C021C544;
    }
    else
    {
      if ( (unsigned int)dword_1C024C960 <= 4 )
      ...
      v24 = (unsigned __int8 *)&unk_1C021C4C1;
    }
    v32 = v21;
  ...
  else if ( (unsigned int)dword_1C024C960 > 4 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      LOBYTE(v1) = _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
                     (__int64)&dword_1C024C960,
                     (unsigned __int8 *)dword_1C021C453,
                     v11,
                     v10,
                     (__int64)&v32,
                     (void **)&v31,
