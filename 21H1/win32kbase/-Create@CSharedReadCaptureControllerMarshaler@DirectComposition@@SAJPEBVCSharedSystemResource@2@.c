/*
 * XREFs of ?Create@CSharedReadCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01FABD0
 * Callers:
 *     CreateSharedReadCaptureControllerMarshaler @ 0x1C01FAD90 (CreateSharedReadCaptureControllerMarshaler.c)
 * Callees:
