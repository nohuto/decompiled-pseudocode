/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C002F91C
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1C002F8E0 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x1C002F900 (NtCreateCompositionInputSink.c)
 * Callees:
