/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C0156604
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C001C890 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C0038DC0 (EtwDevLockEndTightUpdate.c)
 * Callees:
