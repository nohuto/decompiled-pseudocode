/*
 * XREFs of ?SubmitBuffer@SendHost@CoreMessagingK@@SAJPEAUIMessageCallSendHost@@PEA_KIPEAXI@Z @ 0x1C0040DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z @ 0x1C0040FB0 (-HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z.c)
 *     CoreUICallReceive @ 0x1C00464D8 (CoreUICallReceive.c)
 *     ?Free@BufferCache@CoreMessagingK@@SAXPEAX@Z @ 0x1C0061C2C (-Free@BufferCache@CoreMessagingK@@SAXPEAX@Z.c)
 *     ??$AllocUninitialized@UAlpcBufferK@@@BufferCache@CoreMessagingK@@SAJGPEAPEAUAlpcBufferK@@@Z @ 0x1C0061C9C (--$AllocUninitialized@UAlpcBufferK@@@BufferCache@CoreMessagingK@@SAJGPEAPEAUAlpcBufferK@@@Z.c)
        ...
        char *a4)
{
  ...
  v6 = CoreMessagingK::BufferCache::AllocUninitialized<AlpcBufferK>(v5, &v16);
  v7 = v16;
  v8 = v6;
  if ( v6 >= 0 )
  {
    ...
    v8 = ZwAlpcSendWaitReceivePort(CoreMessagingK::RegistrarClient::s_Port, 0x20000LL, v4, 0LL);
    if ( v8 >= 0 )
    {
