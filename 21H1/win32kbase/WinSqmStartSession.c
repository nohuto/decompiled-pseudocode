/*
 * XREFs of WinSqmStartSession @ 0x1C004B0E8
 * Callers:
...
__int64 WinSqmStartSession()
{
  ...
  Sid[1] = 83886080;
  Sid[2] = 18;
  if ( (dword_1C0252810 & 2) == 0 && (unsigned int)IsSessionDisabled(&Win32kSQMSession, 0x62004u) )
  {
    dword_1C0252810 |= 2u;
  }
  else
  {
    ...
    if ( v0 )
    {
      v2 = xmmword_1C024D338;
      *(_DWORD *)(v0 + 16) = 40;
      *(_OWORD *)v0 = v2;
      *(_DWORD *)(v0 + 20) = v5;
      *(GUID *)(v0 + 24) = Win32kSQMSession;
      if ( qword_1C0252818 || !RegisterWinSqmProvider() )
      {
