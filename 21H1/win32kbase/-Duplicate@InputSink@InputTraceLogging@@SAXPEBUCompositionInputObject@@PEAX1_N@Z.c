/*
 * XREFs of ?Duplicate@InputSink@InputTraceLogging@@SAXPEBUCompositionInputObject@@PEAX1_N@Z @ 0x1C00B80F8
 * Callers:
...
void __fastcall InputTraceLogging::InputSink::Duplicate(const struct CompositionInputObject *a1, void *a2, void *a3)
{
  ...
  if ( (unsigned int)dword_1C024C960 > 5 && tlgKeywordOn((__int64)&dword_1C024C960, 4LL) )
  {
    ...
    v10 = v6;
    v11 = v7;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C02220A6, 0LL, 0LL, 6u, &v12);
  }
}
