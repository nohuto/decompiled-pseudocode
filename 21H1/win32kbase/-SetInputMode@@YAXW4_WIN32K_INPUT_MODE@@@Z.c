/*
 * XREFs of ?SetInputMode@@YAXW4_WIN32K_INPUT_MODE@@@Z @ 0x1C0125714
 * Callers:
...
void __fastcall SetInputMode(__int64 a1)
{
  ...
  PERESOURCE *v32; // rdi
  __int64 v33; // rcx
  int v34; // [rsp+30h] [rbp-89h] BYREF
  int v35; // [rsp+34h] [rbp-85h] BYREF
  int v36; // [rsp+38h] [rbp-81h] BYREF
  unsigned int v37; // [rsp+3Ch] [rbp-7Dh]
  __int64 v38; // [rsp+40h] [rbp-79h]
  unsigned __int8 v39; // [rsp+48h] [rbp-71h]
  GUID ActivityId; // [rsp+4Ch] [rbp-6Dh] BYREF
  struct _EVENT_DATA_DESCRIPTOR v41; // [rsp+60h] [rbp-59h] BYREF
  int *v42; // [rsp+80h] [rbp-39h]
  int v43; // [rsp+88h] [rbp-31h]
  int v44; // [rsp+8Ch] [rbp-2Dh]
  struct _EVENT_DATA_DESCRIPTOR v45; // [rsp+90h] [rbp-29h] BYREF
  int *v46; // [rsp+B0h] [rbp-9h]
  int v47; // [rsp+B8h] [rbp-1h]
  int v48; // [rsp+BCh] [rbp+3h]
  struct _EVENT_DATA_DESCRIPTOR v49; // [rsp+C0h] [rbp+7h] BYREF
  int *v50; // [rsp+E0h] [rbp+27h]
  int v51; // [rsp+E8h] [rbp+2Fh]
  int v52; // [rsp+ECh] [rbp+33h]
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v38 = v4;
    if ( v4 && (*(int *)(v4 + 24) > 0 || *(_DWORD *)(v38 + 48)) )
    {
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    if ( v38 )
    {
      v11 = *(unsigned int *)(v38 + 24);
      if ( *(_DWORD *)(v38 + 48) || (int)v11 > 0 )
      {
        *(_DWORD *)(v38 + 44) = 1;
