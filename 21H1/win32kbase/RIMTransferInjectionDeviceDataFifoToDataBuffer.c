/*
 * XREFs of RIMTransferInjectionDeviceDataFifoToDataBuffer @ 0x1C0172AB0
 * Callers:
...
__int64 __fastcall RIMTransferInjectionDeviceDataFifoToDataBuffer(__int64 a1, __int64 a2)
{
  ...
  if ( !v4 )
  {
    ...
    if ( v6 )
    {
      ...
      {
        ++v7;
        v8 = 3LL * ((*(_BYTE *)(v3 + 924) - *(_BYTE *)(v3 + 920) + 1) & 0xF);
        v9 = 3LL * *(unsigned int *)(v3 + 916);
        *(_OWORD *)(v3 + 8 * v9 + 476) = *(_OWORD *)(v3
                                                   + 24LL * ((*(_BYTE *)(v3 + 924) - *(_BYTE *)(v3 + 920) + 1) & 0xF)
                                                   + 928);
        *(_QWORD *)(v3 + 8 * v9 + 492) = *(_QWORD *)(v3 + 8 * v8 + 944);
        LODWORD(v9) = *(_DWORD *)(v3 + 916);
        --*(_DWORD *)(v3 + 920);
        v10 = v9 + 1;
        *(_DWORD *)(v3 + 916) = v10;
      }
