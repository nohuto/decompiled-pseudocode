/*
 * XREFs of ?StopAndEndInertia@CTouchProcessor@@QEAAHIPEAX@Z @ 0x1C01A21C8
 * Callers:
...
LABEL_9:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v11) = 2;
LABEL_14:
    WPP_RECORDER_SF_((_DWORD)DeviceExtension, v11, 7, v13, (__int64)&WPP_6cc13e1a12c13a444721acaa10d1d35b_Traceguids);
  }
LABEL_15:
  v8 = 0;
LABEL_16:
