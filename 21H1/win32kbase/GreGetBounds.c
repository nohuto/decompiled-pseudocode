/*
 * XREFs of GreGetBounds @ 0x1C00811F0
 * Callers:
...
LABEL_64:
  ...
  if ( v48 == 5 )
  {
    v74 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v5 + 680);
    v75 = 0;
LABEL_133:
  ...
  if ( v48 == 16 )
  {
    v74 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v5 + 136);
    v75 = 2;
    goto LABEL_133;
  }
LABEL_70:
