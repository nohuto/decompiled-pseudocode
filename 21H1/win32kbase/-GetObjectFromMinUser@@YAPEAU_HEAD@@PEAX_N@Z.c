/*
 * XREFs of ?GetObjectFromMinUser@@YAPEAU_HEAD@@PEAX_N@Z @ 0x1C0122560
 * Callers:
 *     ValidateBaseHandleFromMinuserHandle @ 0x1C0122750 (ValidateBaseHandleFromMinuserHandle.c)
 *     ValidateHwndMinuser @ 0x1C0122850 (ValidateHwndMinuser.c)
 * Callees:
...
struct _HEAD *__fastcall GetObjectFromMinUser(void *a1, char a2)
{
  ...
  if ( v6 )
  {
    ...
    return (struct _HEAD *)*((_QWORD *)gpKernelHandleTable + 3 * (unsigned int)((v6 - (__int64)qword_1C0250D48) >> 5));
  }
