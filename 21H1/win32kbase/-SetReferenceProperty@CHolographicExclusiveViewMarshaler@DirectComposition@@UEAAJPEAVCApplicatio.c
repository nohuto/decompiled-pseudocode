/*
 * XREFs of ?SetReferenceProperty@CHolographicExclusiveViewMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01EF460
 * Callers:
 *     <none>
 * Callees:
