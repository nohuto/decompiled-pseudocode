/*
 * XREFs of ?SetResourceReferenceArrayProperty@CApplicationChannel@DirectComposition@@QEAAJIIPEBI_K@Z @ 0x1C0091158
 * Callers:
        ...
        const unsigned int *a5)
{
  ...
  *((_QWORD *)&v5 + 1) = a2;
  ...
  if ( v14 >= 0 )
  {
    v14 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, __int64, unsigned __int64, char *))(*(_QWORD *)v12 + 160LL))(
            v12,
            this,
            v10,
            v6,
...
LABEL_27:
  if ( v6 )
    Win32FreePool(v6, *((__int64 *)&v5 + 1), a3);
  return (unsigned int)v14;
}
