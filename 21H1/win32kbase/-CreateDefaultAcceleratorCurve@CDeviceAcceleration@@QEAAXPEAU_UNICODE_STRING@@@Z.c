/*
 * XREFs of ?CreateDefaultAcceleratorCurve@CDeviceAcceleration@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C0012AFC
 * Callers:
 *     ReadDefaultAccelerationCurves @ 0x1C0012820 (ReadDefaultAccelerationCurves.c)
 * Callees:
        ...
        struct _UNICODE_STRING *a2)
{
  ...
  else
  {
    if ( *((_BYTE *)this + 8) )
      goto LABEL_6;
    *((_OWORD *)this + 1) = xmmword_1C02509F0;
    *((_OWORD *)this + 2) = xmmword_1C0250A00;
    *((_QWORD *)this + 6) = qword_1C0250A10;
    *(_OWORD *)((char *)this + 56) = xmmword_1C02509C8;
    *(_OWORD *)((char *)this + 72) = xmmword_1C02509D8;
    v10 = qword_1C02509E8;
  }
  *((_QWORD *)this + 11) = v10;
LABEL_6:
