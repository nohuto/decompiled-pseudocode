/*
 * XREFs of ?CollectMousePacketPerfTelemetry@MousePerfSummary@@QEAAXAEBU_MousePacketPerf@@@Z @ 0x1C0069594
 * Callers:
        ...
        const struct _MousePacketPerf *a2)
{
  ...
  *(_QWORD *)(v11 + 448) = v10;
  ...
  if ( !this[66].QuadPart )
    this[66] = KeQueryPerformanceCounter(0LL);
  if ( !this[67].QuadPart )
    this[67] = KeQueryPerformanceCounter(0LL);
  if ( (unsigned int)dword_1C024B170 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C024B170, 16LL, v12, v13) )
  {
    v27 = *((_QWORD *)a2 + 5);
    v28 = *((_QWORD *)a2 + 4);
    v29 = *((_QWORD *)a2 + 3);
