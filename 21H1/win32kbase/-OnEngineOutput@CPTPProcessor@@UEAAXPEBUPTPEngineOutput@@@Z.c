/*
 * XREFs of ?OnEngineOutput@CPTPProcessor@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1C01A9100
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( HMValidateHandleNoSecure(*((_QWORD *)this + 30), 19) )
  {
    if ( *(_DWORD *)a2 )
    {
      switch ( *(_DWORD *)a2 )
      {
        case 1:
          ...
          else
          {
            ...
            *((_QWORD *)this + 262) = v19[9];
            ...
            if ( v22 )
            {
              *((_QWORD *)this + 267) = v22[283];
              *((_QWORD *)this + 268) = v22[285];
              *((_QWORD *)this + 263) = v22[282];
            }
          }
          v23 = *((_DWORD *)a2 + 1);
          if ( v23 == 5 )
        ...
        case 2:
          ...
          {
            CPTPProcessor::CleanupGestureState((CPTPProcessor *)((char *)this - 232));
          }
          else
          {
            v11 = *((_DWORD *)a2 + 1);
            if ( v11 )
            {
              ...
              if ( v12 )
              {
                if ( v12 == 1 )
                {
                  ...
                  *((_DWORD *)v13 + 30) ^= (*((_DWORD *)v13 + 30) ^ (*((_DWORD *)a2 + 2) << 9)) & 0x200;
              ...
              else
              {
                ...
                *((_DWORD *)v16 + 30) ^= (*((_DWORD *)v16 + 30) ^ (*((_DWORD *)a2 + 2) << 9)) & 0x200;
                CTouchProcessor::ProcessTouchpadInput(
                  v16,
    ...
    else
    {
      ...
      if ( (v24 & 1) != 0 || (v24 & 2) == 0 )
      {
        ...
        if ( v25 )
        {
          ...
          if ( (_DWORD)v26 )
          {
            if ( (unsigned int)((_DWORD)v26 - 1) <= 1 )
              CPTPProcessor::EndInertia((CPTPProcessor *)((char *)this - 232));
          }
          else
          {
            if ( *((_BYTE *)this + 232) )
        ...
        {
          CPTPProcessor::CacheInertia((CPTPProcessor *)((char *)this - 232));
        }
      }
      else
      {
        CPTPProcessor::SendPTPInertiaEndToContainer((CPTPProcessor *)((char *)this - 232), a2);
      }
    }
  }
}
