/*
 * XREFs of ?TransformPointWithUniformSpaceMapping@@YAHPEAU_MDEV@@PEAH1H@Z @ 0x1C00A7440
 * Callers:
 *     DrvPixelSpaceToUniformSpacePoint @ 0x1C0050AA0 (DrvPixelSpaceToUniformSpacePoint.c)
 *     DrvUniformSpaceToPixelSpacePoint @ 0x1C00A7410 (DrvUniformSpaceToPixelSpacePoint.c)
 * Callees:
