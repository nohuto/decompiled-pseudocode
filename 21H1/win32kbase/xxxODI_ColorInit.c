/*
 * XREFs of xxxODI_ColorInit @ 0x1C0013A50
 * Callers:
 *     InitUserScreen @ 0x1C00A7A88 (InitUserScreen.c)
 * Callees:
 *     ?CI_GetClrVal@@YAKPEAGK@Z @ 0x1C0013CC4 (-CI_GetClrVal@@YAKPEAGK@Z.c)
...
__int64 __fastcall xxxODI_ColorInit(__int64 a1)
{
  ...
  *(_OWORD *)(v1 + 4584) = xmmword_1C02130C0;
  *(_OWORD *)(v1 + 4600) = xmmword_1C02130D0;
  *(_OWORD *)(v1 + 4616) = xmmword_1C02130E0;
  *(_OWORD *)(v1 + 4632) = xmmword_1C02130F0;
  *(_OWORD *)(v1 + 4648) = xmmword_1C0213100;
  *(_OWORD *)(v1 + 4664) = xmmword_1C0213110;
