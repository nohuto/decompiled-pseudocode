/*
 * XREFs of ?Invoke@CAppStateChangedWorkItem@@UEAAXXZ @ 0x180032030
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CAppStateChangedWorkItem::Invoke(const wchar_t **this)
{
  ...
  CApplication *v13; // [rsp+A0h] [rbp+18h] BYREF
  ...
  if ( Application < 0 )
  {
    ...
    AudPolicyLogError("CAppStateChangedWorkItem::Invoke", 586, Application);
  }
  else if ( v2 )
  {
