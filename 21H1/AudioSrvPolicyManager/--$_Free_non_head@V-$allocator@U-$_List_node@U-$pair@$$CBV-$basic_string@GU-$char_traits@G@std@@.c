 ...
 *     ??1?$list@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$unique_ptr@VCEndpointVolumeState@@U?$default_delete@VCEndpointVolumeState@@@std@@@2@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$unique_ptr@VCEndpointVolumeState@@U?$default_delete@VCEndpointVolumeState@@@std@@@2@@std@@@2@@std@@QEAA@XZ @ 0x1800350D8 (--1-$list@U-$pair@$$CBV-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V-$unique_pt.c)
 * Callees:
...
void __fastcall std::_List_node<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>,void *>::_Free_non_head<std::allocator<std::_List_node<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>,void *>>>(
        __int64 a1,
        _QWORD **a2)
{
  _QWORD *v2; // rdi
  ...
  *a2[1] = 0LL;
  ...
  if ( *a2 )
  {
    do
    {
      ...
      {
        if ( *(_BYTE *)(v4 + 32) )
          (*(void (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(v4 + 24) + 240LL))(*(_QWORD *)(v4 + 24), v4 + 40);
        v5 = *(_QWORD *)(v4 + 24);
        if ( v5 )
          (*(void (__fastcall **)(__int64))(*(_QWORD *)v5 + 16LL))(v5);
        operator delete((void *)v4, (const struct std::nothrow_t *)0x38);
      }
      std::wstring::~wstring((__int64)(v2 + 2));
