/*
 * XREFs of ?Init@CDuckingNotification@@QEAAJKPEBG_K@Z @ 0x180010A5C
 * Callers:
...
LABEL_11:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_5deeced5c0273ddc6a386dd17acdfa68_Traceguids, v6);
    }
    AudPolicyLogError("CDuckingNotification::Init", 369, v6);
    return v6;
  }
  if ( !a3 )
    return v6;
