/*
 * XREFs of ??0AAManagerHelper@AssignedAccess@Internal@Windows@@QEAA@XZ @ 0x18003DC6C
 * Callers:
 *     GetAssignedAccessTypeForUser @ 0x18003CBF8 (GetAssignedAccessTypeForUser.c)
 * Callees:
 *     ?RaiseException@Details@WRL@Microsoft@@YAXJK@Z @ 0x18003E070 (-RaiseException@Details@WRL@Microsoft@@YAXJK@Z.c)
