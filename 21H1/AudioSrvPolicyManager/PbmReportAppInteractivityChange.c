/*
 * XREFs of PbmReportAppInteractivityChange @ 0x1800289D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PbmReportAppInteractivityChange(void *a1, const unsigned __int16 *a2, unsigned __int64 a3, int a4)
{
  __int64 result; // rax
  int v8; // ecx
