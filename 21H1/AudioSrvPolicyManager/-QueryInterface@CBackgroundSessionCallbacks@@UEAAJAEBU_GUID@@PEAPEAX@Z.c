/*
 * XREFs of ?QueryInterface@CBackgroundSessionCallbacks@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18001D070
 * Callers:
 *     ?QueryInterface@CBackgroundSessionCallbacks@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18001F100 (-QueryInterface@CBackgroundSessionCallbacks@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
