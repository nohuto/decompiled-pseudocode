/*
 * XREFs of ?HasDuckedStream@CApplication@@QEAAHXZ @ 0x180017834
 * Callers:
 ...
 * Callees:
 *     ?SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ @ 0x18001C200 (-SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ.c)
