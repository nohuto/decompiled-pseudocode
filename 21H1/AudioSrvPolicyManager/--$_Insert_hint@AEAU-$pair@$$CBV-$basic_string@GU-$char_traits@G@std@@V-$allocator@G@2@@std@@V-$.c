        ...
        void *a5)
{
  ...
  if ( a1[1] )
  {
    if ( a3 == (_QWORD *)*v9 )
    {
      if ( (unsigned __int8)std::less<std::wstring>::operator()((__int64)a1, a4, (__int64)(a3 + 4)) )
      {
        LOBYTE(v11) = 1;
    ...
    if ( a3 == v9 )
    {
      if ( (unsigned __int8)std::less<std::wstring>::operator()((__int64)a1, (char *)(v9[2] + 32LL), (__int64)a4) )
      {
        std::_Tree<std::_Tmap_traits<std::wstring,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>>>,0>>::_Insert_at<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>> &,std::_Tree_node<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>>,void *> *>(
          v8,
          (_DWORD)a2,
    ...
    if ( (unsigned __int8)std::less<std::wstring>::operator()(v14, (char *)i + 32, (__int64)a4) )
    {
    ...
    {
LABEL_51:
      if ( !(unsigned __int8)std::less<std::wstring>::operator()(v14, (char *)v6 + 32, (__int64)a4) )
        goto LABEL_42;
      v21 = (__int64)v6;
      k = v6[2];
      v23 = *(_BYTE *)(k + 25);
      ...
      if ( (_QWORD *)k != v9 && !(unsigned __int8)std::less<std::wstring>::operator()(m, a4, k + 32) )
      {
LABEL_42:
