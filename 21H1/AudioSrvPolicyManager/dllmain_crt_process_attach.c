/*
 * XREFs of dllmain_crt_process_attach @ 0x18003EC48
 * Callers:
 ...
 *     __scrt_dllmain_after_initialize_c @ 0x18003F27C (__scrt_dllmain_after_initialize_c.c)
 *     __scrt_dllmain_before_initialize_c @ 0x18003F2B8 (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x18003F3DC (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18003F4E4 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18003F584 (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18003FB44 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18003FB6C (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18003FB90 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18003FBB0 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18003FD04 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18003FF46 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18003FF52 (_initterm_e_0.c)
