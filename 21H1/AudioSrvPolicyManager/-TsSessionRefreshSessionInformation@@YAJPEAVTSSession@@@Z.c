/*
 * XREFs of ?TsSessionRefreshSessionInformation@@YAJPEAVTSSession@@@Z @ 0x18002D0B0
 * Callers:
...
__int64 __fastcall TsSessionRefreshSessionInformation(struct TSSession *a1)
{
  ...
  if ( *v3 > 4u )
  {
    ...
    v11 = 4;
    v10 = &v7;
    tlgWriteTransfer_EventWriteTransfer((__int64)v3, (unsigned __int8 *)dword_18004BBC4, 0LL, 0LL, 3u, &v9);
  }
