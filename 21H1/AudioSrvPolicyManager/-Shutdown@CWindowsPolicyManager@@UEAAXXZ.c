/*
 * XREFs of ?Shutdown@CWindowsPolicyManager@@UEAAXXZ @ 0x18000A990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Shutdown@CDuckingManager@@UEAAXXZ @ 0x1800104A0 (-Shutdown@CDuckingManager@@UEAAXXZ.c)
...
void __fastcall CWindowsPolicyManager::Shutdown(CWindowsPolicyManager *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( !qword_180056208 )
      break;
    v4 = *(_QWORD **)qword_180056208;
    v5 = (TSSession *)*((_QWORD *)qword_180056208 + 2);
    qword_180056208 = v4;
    if ( v4 )
      v4[1] = 0LL;
    else
