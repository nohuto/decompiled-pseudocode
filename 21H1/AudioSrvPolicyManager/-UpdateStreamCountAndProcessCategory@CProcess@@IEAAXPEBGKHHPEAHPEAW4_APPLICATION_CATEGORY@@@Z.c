/*
 * XREFs of ?UpdateStreamCountAndProcessCategory@CProcess@@IEAAXPEBGKHHPEAHPEAW4_APPLICATION_CATEGORY@@@Z @ 0x18001B194
 * Callers:
 ...
 * Callees:
 *     WPP_SF_dSS @ 0x1800155AC (WPP_SF_dSS.c)
