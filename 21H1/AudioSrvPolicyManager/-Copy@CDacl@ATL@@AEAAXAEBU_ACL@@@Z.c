/*
 * XREFs of ?Copy@CDacl@ATL@@AEAAXAEBU_ACL@@@Z @ 0x18003941C
 * Callers:
...
void __fastcall ATL::CDacl::Copy(ATL::CDacl *this, struct _ACL *a2)
{
  ...
  ATL::CDacl *v20; // [rsp+60h] [rbp-E8h]
  PACL pAcl; // [rsp+68h] [rbp-E0h]
  ATL::CDacl::CAccessObjectAce *v22; // [rsp+70h] [rbp-D8h]
  ATL::CDacl::CAccessAce *v23; // [rsp+78h] [rbp-D0h]
  DWORD pAclInformation[4]; // [rsp+80h] [rbp-C8h] BYREF
  _QWORD v25[9]; // [rsp+90h] [rbp-B8h] BYREF
  char v26; // [rsp+DCh] [rbp-6Ch]
  int v27; // [rsp+E0h] [rbp-68h]
...
LABEL_34:
    ...
    *((_DWORD *)v3 + 5) = v18;
    for ( i = 0; ; ++i )
    {
      ...
      if ( *(_BYTE *)pAce <= 1u )
      {
        ATL::CSid::operator=((__int64)v25, (char *)pAce + 8);
        try
        {
      ...
      else
      {
        ...
        if ( (*((_BYTE *)pAce + 8) & 2) != 0 )
          ...
          v9 -= 16;
        ATL::CSid::operator=((__int64)v25, v9);
        v10 = GetProcessHeap();
