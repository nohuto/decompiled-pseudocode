/*
 * XREFs of ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x180008A50
 * Callers:
        ...
        int a4)
{
  ...
  __int16 v14; // [rsp+24h] [rbp-24h]
  __int16 v15; // [rsp+26h] [rbp-22h]
