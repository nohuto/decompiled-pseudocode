/*
 * XREFs of ??0CProcess@@IEAA@XZ @ 0x180019494
 * Callers:
 ...
 *     ?UpdateRehashThresholds@?$CAtlMap@PEAUIUnknown@@V?$CComPtr@UIAudioProcessNotification@@@ATL@@V?$CElementTraits@PEAUIUnknown@@@3@V?$CElementTraits@V?$CComPtr@UIAudioProcessNotification@@@ATL@@@3@@ATL@@AEAAXXZ @ 0x18001E934 (-UpdateRehashThresholds@-$CAtlMap@PEAUIUnknown@@V-$CComPtr@UIAudioProcessNotification@@@ATL@@V-$.c)
 */
...
CProcess *__fastcall CProcess::CProcess(CProcess *this)
{
  ...
  *((_DWORD *)this + 173) = 1074790400;
  ATL::CAtlMap<IUnknown *,ATL::CComPtr<IAudioProcessNotification>,ATL::CElementTraits<IUnknown *>,ATL::CElementTraits<ATL::CComPtr<IAudioProcessNotification>>>::UpdateRehashThresholds();
  *((_QWORD *)this + 92) = 0LL;
