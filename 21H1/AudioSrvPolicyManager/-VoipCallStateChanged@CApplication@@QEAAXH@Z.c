/*
 * XREFs of ?VoipCallStateChanged@CApplication@@QEAAXH@Z @ 0x180018800
 * Callers:
...
void __fastcall CApplication::VoipCallStateChanged(CApplication *this, int a2)
{
  ...
  *((_DWORD *)this + 155) = v4;
  ...
  {
    v8 = v4;
    WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x25u, &WPP_8ab93343ef2e3d885d031f030701e2ed_Traceguids, a2, v8);
    v6 = *((_DWORD *)this + 155);
    v5 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  v7 = v6 <= 0;
  if ( v6 < 0 )
  {
    if ( v5 != &WPP_GLOBAL_Control && (*((_DWORD *)v5 + 7) & 0x40000000) != 0 && *((_BYTE *)v5 + 25) >= 2u )
      WPP_SF_((TRACEHANDLE)v5[2], 0x26u, &WPP_8ab93343ef2e3d885d031f030701e2ed_Traceguids);
    *((_DWORD *)this + 155) = 0;
    v7 = 1;
  }
  if ( v7 )
