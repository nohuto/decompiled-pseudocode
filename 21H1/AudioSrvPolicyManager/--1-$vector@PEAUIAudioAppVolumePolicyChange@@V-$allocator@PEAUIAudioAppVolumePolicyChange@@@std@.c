/*
 * XREFs of ??1?$vector@PEAUIAudioAppVolumePolicyChange@@V?$allocator@PEAUIAudioAppVolumePolicyChange@@@std@@@std@@QEAA@XZ @ 0x18001D128
 * Callers:
 *     _CApplication::NotifyVolumePolicyChange_::_1_::dtor$0 @ 0x180041394 (_CApplication--NotifyVolumePolicyChange_--_1_--dtor$0.c)
 * Callees:
