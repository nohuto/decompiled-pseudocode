/*
 * XREFs of ?OnSoftNonInteractiveAppsSwitchToHardNonInteractive@CApplicationManager@@QEAAJK@Z @ 0x180026210
 * Callers:
        ...
        unsigned int a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Cu, &WPP_386a857d2e283c5fe15986819513c374_Traceguids, a2);
  }
