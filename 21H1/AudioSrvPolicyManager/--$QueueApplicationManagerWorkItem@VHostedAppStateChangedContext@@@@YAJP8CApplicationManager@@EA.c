/*
 * XREFs of ??$QueueApplicationManagerWorkItem@VHostedAppStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAVHostedAppStateChangedContext@@@Z0@Z @ 0x180027C9C
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<HostedAppStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  if ( v5 )
  {
    ...
    v5[1] = CApplicationManager::OnHostedAppStateChanged;
    v5[2] = a2;
