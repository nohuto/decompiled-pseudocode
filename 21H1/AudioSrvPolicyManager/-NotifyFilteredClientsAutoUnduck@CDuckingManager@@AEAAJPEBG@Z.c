/*
 * XREFs of ?NotifyFilteredClientsAutoUnduck@CDuckingManager@@AEAAJPEBG@Z @ 0x1800116B0
 * Callers:
...
__int64 __fastcall CDuckingManager::NotifyFilteredClientsAutoUnduck(CDuckingManager *this, const unsigned __int16 *a2)
{
  ...
  if ( v5 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, &WPP_5deeced5c0273ddc6a386dd17acdfa68_Traceguids, a2);
    }
    v6 = -1LL;
    do
      ++v6;
    ...
    if ( v3 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Cu, &WPP_5deeced5c0273ddc6a386dd17acdfa68_Traceguids, v3);
      }
      AudPolicyLogError("CDuckingManager::NotifyFilteredClientsAutoUnduck", 761, v3);
    }
  }
  return 0LL;
}
