/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x18003F750
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_180055DD8, 0xFA0u);
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))ProcAddress)(&unk_180055E00);
    qword_180055E10 = __ROR8__(v2, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_180055E18 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    goto LABEL_7;
  }
