/*
 * XREFs of ?OnApplicationInteractivityChanged@CApplicationManager@@QEAAXPEAVCApplication@@@Z @ 0x180025364
 * Callers:
 ...
 *     std::_Func_impl_no_alloc__lambda_7d69d41627b1d936e688f09992cbd28e__void_::_Do_call @ 0x18000EE70 (std--_Func_impl_no_alloc__lambda_7d69d41627b1d936e688f09992cbd28e__void_--_Do_call.c)
 ...
 *     ?OnHostedAppStateChanged@CApplicationManager@@QEAAJPEAVHostedAppStateChangedContext@@@Z @ 0x1800251B0 (-OnHostedAppStateChanged@CApplicationManager@@QEAAJPEAVHostedAppStateChangedContext@@@Z.c)
 *     ?Invoke@CAppStateChangedWorkItem@@UEAAXXZ @ 0x180032030 (-Invoke@CAppStateChangedWorkItem@@UEAAXXZ.c)
 * Callees:
 *     WPP_SF_SS @ 0x18001546C (WPP_SF_SS.c)
  ...
  if ( !*((_DWORD *)a2 + 52) )
  {
    ...
    *((_DWORD *)a2 + 159) = 1;
    if ( !(unsigned int)CApplication::HasBackgroundAudioTask(a2) )
    {
      ...
      if ( dword_1800487F8[(int)CApplication::Category((__int64)a2)] )
      {
        if ( !dword_1800487F8[(int)CApplication::RawCategory((__int64)a2)] && *((_DWORD *)a2 + 54) )
