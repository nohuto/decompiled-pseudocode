/*
 * XREFs of ?OnScreenReaderStateChanged@CApplicationManager@@QEAAJPEAUScreenReaderStateChangedContext@@@Z @ 0x180025640
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_d @ 0x180005620 (WPP_SF_d.c)
 *     ?AudPolicyLogError@@YAXPEBDHJ@Z @ 0x18000A2B4 (-AudPolicyLogError@@YAXPEBDHJ@Z.c)
 *     WPP_SF_Sddd @ 0x18001FFB0 (WPP_SF_Sddd.c)
        ...
        struct ScreenReaderStateChangedContext *a2)
{
  ...
  *((_DWORD *)a2 + 3) = v7;
  ...
  if ( v9 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x33u, &WPP_386a857d2e283c5fe15986819513c374_Traceguids, v9);
    }
    AudPolicyLogError("CApplicationManager::OnScreenReaderStateChanged", 2975, v10);
  }
  else
  {
    v11 = *((_DWORD *)a2 + 2) == 0;
