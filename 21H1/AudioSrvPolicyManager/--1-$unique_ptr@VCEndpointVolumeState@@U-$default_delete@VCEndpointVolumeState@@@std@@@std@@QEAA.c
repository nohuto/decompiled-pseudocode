/*
 * XREFs of ??1?$unique_ptr@VCEndpointVolumeState@@U?$default_delete@VCEndpointVolumeState@@@std@@@std@@QEAA@XZ @ 0x180034C78
 * Callers:
 *     _CEndpointVolumeStateManager::AddEndpointVolumeReference_::_1_::dtor$3 @ 0x1800422A9 (_CEndpointVolumeStateManager--AddEndpointVolumeReference_--_1_--dtor$3.c)
 * Callees:
