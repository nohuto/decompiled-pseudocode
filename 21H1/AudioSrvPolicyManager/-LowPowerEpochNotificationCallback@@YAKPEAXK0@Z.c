/*
 * XREFs of ?LowPowerEpochNotificationCallback@@YAKPEAXK0@Z @ 0x18000A830
 * Callers:
 *     <none>
 * Callees:
    ...
    && *((_QWORD *)a3 + 1) == *(_QWORD *)GUID_LOW_POWER_EPOCH.Data4 )
  {
    ...
    if ( (v3 != 0) != g_bLowPowerEpoch )
    {
      ...
      if ( *v6 > 4u )
      {
        ...
        v15 = 4;
        v12 = 4;
        tlgWriteTransfer_EventWriteTransfer((__int64)v6, (unsigned __int8 *)dword_18004B243, 0LL, 0LL, 4u, &v10);
      }
