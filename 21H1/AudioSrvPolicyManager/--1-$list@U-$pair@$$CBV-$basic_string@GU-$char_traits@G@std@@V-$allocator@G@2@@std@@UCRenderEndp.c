/*
 * XREFs of ??1?$list@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@UCRenderEndpointDuckingManagerContext@@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@UCRenderEndpointDuckingManagerContext@@@std@@@2@@std@@QEAA@XZ @ 0x18000E6DC
 * Callers:
 *     _CDuckingManager::CDuckingManager_::_1_::dtor$13 @ 0x180040B83 (_CDuckingManager--CDuckingManager_--_1_--dtor$13.c)
 * Callees:
