/*
 * XREFs of ?FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAEPEAX_KI@Z @ 0x180007540
 * Callers:
...
LABEL_9:
    ...
    memcpy_s_0(*((void *const *)a2 + 2), v17, v15, v16);
    goto LABEL_9;
  }
  v24 = 0;
  if ( !*v6 )
  ...
  if ( *v6 != v24 )
  {
    ...
    *v6 = v24;
    if ( v27 == 1 )
    {
      ...
      v29 = 2LL;
LABEL_34:
      memcpy_s_0(*((void *const *)a2 + 2), v29, v28, v29);
      goto LABEL_35;
    }
    if ( v27 == 2 )
    {
...
LABEL_36:
  ...
  memcpy_s_0(Destination[0], v33, p_Source, v33);
LABEL_44:
