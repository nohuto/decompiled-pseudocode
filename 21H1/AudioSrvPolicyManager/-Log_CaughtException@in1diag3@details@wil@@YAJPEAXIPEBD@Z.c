/*
 * XREFs of ?Log_CaughtException@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x18001FB1C
 * Callers:
 *     _CApplication::NotifyVolumePolicyChange_::_1_::catch$3 @ 0x1800413B8 (_CApplication--NotifyVolumePolicyChange_--_1_--catch$3.c)
 * Callees:
