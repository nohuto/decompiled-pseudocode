        ...
        _QWORD *a5)
{
  ...
  while ( !*((_BYTE *)v10 + 25) )
  {
    v12 = std::less<std::wstring>::operator()(a1, a4, (__int64)(v10 + 4));
    v11 = v12;
    if ( v12 )
      v10 = (__int64 *)*v10;
    else
...
LABEL_21:
    if ( (unsigned __int8)std::less<std::wstring>::operator()(a1, (char *)(v14 + 32), (__int64)a4) )
    {
      *(_QWORD *)a2 = *std::_Tree<std::_Tmap_traits<std::wstring,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>>>,0>>::_Insert_at<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>> &,std::_Tree_node<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>>,void *> *>(
                         v7,
                         &v23,
    ...
    else
    {
      ...
      std::wstring::~wstring((__int64)v20 + 32);
      operator delete(v20, (const struct std::nothrow_t *)0x48);
      *(_QWORD *)a2 = v13;
      *(_BYTE *)(a2 + 8) = 0;
      result = a2;
    }
