/*
 * XREFs of ?ApplySessionMuteChanges@CApplicationManager@@QEAAJPEAU_SESSIONMUTECHANGES@@@Z @ 0x180023E70
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _SESSIONMUTECHANGES *a2)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_386a857d2e283c5fe15986819513c374_Traceguids);
    v5 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  v6 = *((_DWORD *)a2 + 1);
  if ( v5 != &WPP_GLOBAL_Control && (*((_DWORD *)v5 + 7) & 0x40000000) != 0 && *((_BYTE *)v5 + 25) >= 4u )
  {
    WPP_SF_d((TRACEHANDLE)v5[2], 0x29u, &WPP_386a857d2e283c5fe15986819513c374_Traceguids, v6);
    v5 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  ...
  v9 = *(_DWORD *)a2;
  if ( v5 != &WPP_GLOBAL_Control && (*((_DWORD *)v5 + 7) & 0x40000000) != 0 && *((_BYTE *)v5 + 25) >= 4u )
    WPP_SF_d((TRACEHANDLE)v5[2], 0x2Au, &WPP_386a857d2e283c5fe15986819513c374_Traceguids, v9);
