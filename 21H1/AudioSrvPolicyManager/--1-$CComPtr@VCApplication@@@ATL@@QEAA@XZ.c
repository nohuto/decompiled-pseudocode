/*
 * XREFs of ??1?$CComPtr@VCApplication@@@ATL@@QEAA@XZ @ 0x18000B280
 * Callers:
 *     _CApplicationManager::SendBackgroundStreamStateChangedNotifiction_::_1_::dtor$1 @ 0x180040A1B (_CApplicationManager--SendBackgroundStreamStateChangedNotifiction_--_1_--dtor$1.c)
 * Callees:
