/*
 * XREFs of ??_EDeactivatableDuckingDescriptor@@UEAAPEAXI@Z @ 0x1800144E0
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VDeactivatableDuckingDescriptor@@@std@@EEAAXXZ @ 0x180012DD0 (-_Destroy@-$_Ref_count_obj@VDeactivatableDuckingDescriptor@@@std@@EEAAXXZ.c)
 * Callees:
