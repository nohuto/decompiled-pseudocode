/*
 * XREFs of ?AddRelatedProcess@ApplicationSpecificEndpointInfo@@UEAAJK@Z @ 0x180036F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ApplicationSpecificEndpointInfo::AddRelatedProcess(ApplicationSpecificEndpointInfo *this, int a2)
{
  ...
  try
  {
    if ( a2 )
    {
      ...
      if ( *((char **)this + 9) == v6 )
      {
        std::vector<unsigned long>::_Emplace_reallocate<unsigned long const &>((_QWORD *)this + 7, v6, &v9);
      }
      else
      {
        *(_DWORD *)v6 = a2;
