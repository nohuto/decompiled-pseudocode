/*
 * XREFs of ?NotifyUnfilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBGK@Z @ 0x180011878
 * Callers:
        ...
        int a3)
{
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Du, &WPP_5deeced5c0273ddc6a386dd17acdfa68_Traceguids, a2);
    }
    v7 = -1LL;
    do
      ++v7;
