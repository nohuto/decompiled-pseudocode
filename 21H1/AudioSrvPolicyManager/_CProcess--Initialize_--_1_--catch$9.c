/*
 * XREFs of _CProcess::Initialize_::_1_::catch$9 @ 0x180041765
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcess::Initialize_::_1_::catch_9(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
