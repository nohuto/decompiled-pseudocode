/*
 * XREFs of _CDuckingManager::OnStateChanged_::_1_::catch$4 @ 0x180040C94
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDuckingManager::OnStateChanged_::_1_::catch_4(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
