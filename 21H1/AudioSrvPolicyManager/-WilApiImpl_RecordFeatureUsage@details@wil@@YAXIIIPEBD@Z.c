/*
 * XREFs of ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180009090
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall wil::details::WilApiImpl_RecordFeatureUsage(wil::details *this, int a2, unsigned int a3)
{
  ...
  int v12; // [rsp+30h] [rbp-168h] BYREF
  int v13; // [rsp+34h] [rbp-164h]
  _BYTE v14[56]; // [rsp+40h] [rbp-158h] BYREF
  LPVOID lpMem; // [rsp+78h] [rbp-120h]
  int v16; // [rsp+90h] [rbp-108h]
  _BYTE v17[208]; // [rsp+A0h] [rbp-F8h] BYREF
  ...
  if ( (_DWORD)this || a3 || v4 )
  {
    ...
    else
    {
      ...
      if ( ProcAddress )
LABEL_21:
        v10 = ((__int64 (__fastcall *)(int *))ProcAddress)(&v12);
      else
        v10 = -1073741511;
      if ( v10 )
      {
        if ( !(unsigned int)wil_details_StagingConfig_Load((__int64)v14, 0, v9, v17) )
        {
  ...
  else if ( !wil::details::g_processShutdownInProgress )
  {
    ...
    if ( !v6 && wil::details::FeatureStateManager::EnsureStateData((RTL_SRWLOCK *)&wil::details::g_featureStateManager) )
      wil::details_abi::SubscriptionList::OnSignaled((LPCRITICAL_SECTION)&qword_1800550F0[25], qword_1800550F0);
  }
}
