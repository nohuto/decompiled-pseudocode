/*
 * XREFs of ?TS_SessionIdStreamStarted@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x180030388
 * Callers:
...
__int64 __fastcall TS_SessionIdStreamStarted(DWORD a1, struct IAudioStreamInfo *a2, const unsigned __int16 *a3)
{
  ...
  int v6; // eax
  struct TSSession *v8; // [rsp+50h] [rbp+18h] BYREF
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, &WPP_e1a7a5e290533704050c869bb9bcb4b5_Traceguids, a1);
  }
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x27u, &WPP_e1a7a5e290533704050c869bb9bcb4b5_Traceguids, v4);
    }
    AudPolicyLogError("TS_SessionIdStreamStarted", 2767, v4);
  }
  if ( v5 )
