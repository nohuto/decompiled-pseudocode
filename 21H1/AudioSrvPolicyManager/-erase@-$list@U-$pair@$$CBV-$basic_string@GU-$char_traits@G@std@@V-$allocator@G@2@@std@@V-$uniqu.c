...
_QWORD *__fastcall std::list<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>::erase(
        __int64 a1,
        _QWORD *a2,
        _QWORD **a3)
{
