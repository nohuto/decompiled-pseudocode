/*
 * XREFs of ?GetProcessModuleNameAndAppId@@YAJPEAXPEAPEAG1@Z @ 0x18002065C
 * Callers:
...
LABEL_16:
  ...
  v11 = _AllocStringWorker<CTCoAllocPolicy>(v16, v15, word_180047B80, 0LL, (__int64)ReturnLength, &v23);
  if ( v11 >= 0 )
  {
    v17 = v23;
    goto LABEL_16;
