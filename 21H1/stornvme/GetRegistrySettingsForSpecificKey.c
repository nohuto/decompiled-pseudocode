/*
 * XREFs of GetRegistrySettingsForSpecificKey @ 0x1C001CDD0
 * Callers:
 *     NVMeControllerValidateFirmwareActivateCapability @ 0x1C0012BD0 (NVMeControllerValidateFirmwareActivateCapability.c)
 * Callees:
