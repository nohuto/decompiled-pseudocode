/*
 * XREFs of ScsiReadCapacityRequest @ 0x1C0003858
 * Callers:
        ...
        if ( (_DWORD)a4 == 16 && *a3 == 0x9E )
        {
          ...
          *v8 = HIBYTE(v20);
          ...
          if ( (unsigned int)*v7 >= 0x10 )
          {
            v8[12] &= 0xF0u;
            v17 = v8[13];
            if ( *(_DWORD *)(*(_QWORD *)(a1 + 8 * v10 + 1720) + 52LL) == 512 )
              v18 = v17 & 0xF0 | 3;
            else
              v18 = v17 & 0xF0;
            v8[14] &= 0xC0u;
            ...
            v19 = v8[14] & 0x3F;
            v8[15] = 0;
            v8[14] = v19 & 0xBF | (*(_BYTE *)(*(_QWORD *)(a1 + 8 * v10 + 1720) + 65LL) << 7);
