/*
 * XREFs of NVMeGetDeviceTelemetryHeader @ 0x1C00132FC
 * Callers:
 ...
 *     BuildGetLogPageCommandForTelemetryLog @ 0x1C000FA60 (BuildGetLogPageCommandForTelemetryLog.c)
 */
...
__int64 __fastcall NVMeGetDeviceTelemetryHeader(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  void *v14; // [rsp+78h] [rbp+38h] BYREF
  __int64 v15; // [rsp+80h] [rbp+40h] BYREF
  __int64 PhysicalAddress; // [rsp+88h] [rbp+48h] BYREF
  ...
  if ( v6 && *(_DWORD *)(a2 + v7) >= 0x28u )
  {
    ...
    {
      NVMeAllocateDmaBuffer(a1, 512LL, &v14, &PhysicalAddress);
      v6 = v14;
    }
    if ( v6 )
    {
