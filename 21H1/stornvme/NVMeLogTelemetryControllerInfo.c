/*
 * XREFs of NVMeLogTelemetryControllerInfo @ 0x1C000E0A8
 * Callers:
...
__int64 __fastcall NVMeLogTelemetryControllerInfo(__int64 a1)
{
  ...
  NVMeLogTelemetry(
    ...
    v20,
    "MQES",
    (unsigned __int16)*(_DWORD *)(a1 + 168),
    "MDTS",
    ...
    *(unsigned __int16 *)(a1 + 810),
    "MaxIoCompletionQueueCount",
    *(unsigned __int16 *)(a1 + 812),
    "MessageCount",
