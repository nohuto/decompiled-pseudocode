/*
 * XREFs of ?ReleaseSwapChain@CLocalAppRenderTarget@@IEAAXXZ @ 0x18018ED2C
 * Callers:
 *     ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x18018E91C (-EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ.c)
 *     ?NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z @ 0x18018EB30 (-NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
