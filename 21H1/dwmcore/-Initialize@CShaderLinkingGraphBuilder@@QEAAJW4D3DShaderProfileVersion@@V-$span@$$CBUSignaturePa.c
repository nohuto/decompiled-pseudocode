/*
 * XREFs of ?Initialize@CShaderLinkingGraphBuilder@@QEAAJW4D3DShaderProfileVersion@@V?$span@$$CBUSignatureParameter@CShaderLinkingGraphBuilder@@$0?0@gsl@@@Z @ 0x18009D9C8
 * Callers:
...
__int64 __fastcall CShaderLinkingGraphBuilder::Initialize(struct ID3D11Linker **ppLinker, char a2, _QWORD *a3)
{
  ...
  *((_BYTE *)ppLinker + 84) = a2;
  ...
  if ( *a3 )
  {
    ...
    std::vector<_D3D11_PARAMETER_DESC>::_Reallocate_exactly(&v32, *a3);
    v3 = v33;
  }
  v6 = a3[1];
  v7 = *((_QWORD *)&v32 + 1);
