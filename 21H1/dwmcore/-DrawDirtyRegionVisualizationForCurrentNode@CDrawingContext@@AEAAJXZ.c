/*
 * XREFs of ?DrawDirtyRegionVisualizationForCurrentNode@CDrawingContext@@AEAAJXZ @ 0x18017970C
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawDirtyRegionVisualizationForCurrentNode(CDrawingContext *this)
{
  ...
  __m128 v34[4]; // [rsp+98h] [rbp-70h] BYREF
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 741) + 200LL))(*((_QWORD *)this + 741)) )
  {
    ...
    *(_OWORD *)&v27[1] = 0LL;
    ...
    v35 = 0;
    CMILMatrix::SetToInverse(v34, (CDrawingContext *)((char *)this + 96));
