/*
 * XREFs of ?Dispose@CHolographicViewer@@UEAAJXZ @ 0x18025AE00
 * Callers:
 *     ??1CHolographicViewer@@MEAA@XZ @ 0x18025AC08 (--1CHolographicViewer@@MEAA@XZ.c)
 *     ?DetachFromChannel@CHolographicViewer@@UEAAXPEAVCChannelContext@@_N@Z @ 0x18025ADC0 (-DetachFromChannel@CHolographicViewer@@UEAAXPEAVCChannelContext@@_N@Z.c)
 * Callees:
