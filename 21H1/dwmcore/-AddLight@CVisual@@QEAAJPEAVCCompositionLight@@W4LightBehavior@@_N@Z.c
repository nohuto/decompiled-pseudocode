/*
 * XREFs of ?AddLight@CVisual@@QEAAJPEAVCCompositionLight@@W4LightBehavior@@_N@Z @ 0x1800B3188
 * Callers:
...
__int64 __fastcall CVisual::AddLight(_QWORD *a1, __int64 a2, int a3, char a4)
{
  ...
  if ( a3 )
  {
    *(_QWORD *)&v19[0] = a2;
    ...
    CPtrArrayBase::Remove((CPtrArrayBase *)(a2 + 24), (__int64)a1);
  }
  else
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x483u, 0LL);
      goto LABEL_10;
    }
    v7 = 1;
LABEL_6:
...
LABEL_10:
  if ( v5 < 0 && v7 )
    CPtrArrayBase::Remove(v12, (__int64)a1);
