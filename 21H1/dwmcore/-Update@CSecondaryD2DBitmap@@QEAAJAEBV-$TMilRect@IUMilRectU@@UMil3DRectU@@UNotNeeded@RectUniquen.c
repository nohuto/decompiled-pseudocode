/*
 * XREFs of ?Update@CSecondaryD2DBitmap@@QEAAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@@Z @ 0x180031184
 * Callers:
...
__int64 __fastcall CSecondaryD2DBitmap::Update(CSecondaryD2DBitmap *this, const struct MilRectU *a2, __int64 *a3)
{
  char *v3; // r15
  _DWORD *v7; // rdx
  __int64 v8; // rcx
...
LABEL_6:
  ...
  CD3DDevice::UpdateSubresource(
    ...
    v25,
    0);
  CSecondaryBitmap::AddValidRect((__int64)v3, a2);
LABEL_15:
