/*
 * XREFs of ?CreateD3D12Resource@CLegacySwapChain@@QEBAJIPEAPEAUID3D12Resource@@@Z @ 0x18024A740
 * Callers:
...
__int64 __fastcall CLegacySwapChain::CreateD3D12Resource(CLegacySwapChain *this, int a2, struct ID3D12Resource **a3)
{
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x48Bu, 0LL);
  }
  else
  {
    ...
    if ( v8 >= 0 )
      goto LABEL_7;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x487u, 0LL);
  }
  if ( v10 < 0 )
  {
