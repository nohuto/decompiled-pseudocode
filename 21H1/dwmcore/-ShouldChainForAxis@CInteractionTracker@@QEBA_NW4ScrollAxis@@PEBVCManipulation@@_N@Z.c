/*
 * XREFs of ?ShouldChainForAxis@CInteractionTracker@@QEBA_NW4ScrollAxis@@PEBVCManipulation@@_N@Z @ 0x1801D0ACC
 * Callers:
 ...
 *     _lambda_f7bd61b0100483a4d5791bc237b79594_::operator() @ 0x1801CB88C (_lambda_f7bd61b0100483a4d5791bc237b79594_--operator().c)
 */
