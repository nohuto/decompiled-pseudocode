/*
 * XREFs of ?FillRectanglesWithDrawListBrush@CDrawingContext@@AEAAJ$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@AEBV?$span@$$CBUMilRectF@@$0?0@gsl@@AEBU_D3DCOLORVALUE@@@Z @ 0x18004C834
 * Callers:
 ...
 *     ??0?$com_ptr_t@UID3D11RasterizerState@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800D39B0 (--0-$com_ptr_t@UID3D11RasterizerState@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
        ...
        __int128 *a4)
{
  ...
  *((_QWORD *)&v46 + 1) = 0x3F8000003F800000LL;
  ...
  v34 = 1065353216;
  DrawList = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)a1 + 808, &v34);
  v16 = DrawList;
  if ( DrawList < 0 )
  {
    v32 = 849;
