/*
 * XREFs of ?Render@COffScreenRenderTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800E6584
 * Callers:
 ...
 *     ?Render@COffScreenRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800ECF20 (-Render@COffScreenRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 *     ?Render@COffScreenRenderTarget@@$4PPPPPPPM@BAA@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800ED1D0 (-Render@COffScreenRenderTarget@@$4PPPPPPPM@BAA@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?GetResampleMode@CVisual@@QEBA?AW4Enum@CompositionResampleMode@@XZ @ 0x18017BACC (-GetResampleMode@CVisual@@QEBA-AW4Enum@CompositionResampleMode@@XZ.c)
        ...
        bool *a4)
{
  ...
  __m128 v53[4]; // [rsp+70h] [rbp-90h] BYREF
  ...
  *(_BYTE *)(*((_QWORD *)this - 239) + 1129LL) = 1;
  if ( *((_QWORD *)this - 228) )
  {
    ...
    *(_DWORD *)(v7 + 96) |= 0x400u;
    ...
    if ( CMILMatrix::SetToInverse(v53, (const struct CMILMatrix *)v55) )
    {
