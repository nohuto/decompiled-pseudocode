/*
 * XREFs of ?GetCasterShadowInputBrush@CProjectedShadow@@AEBAJPEAVCDrawingContext@@PEAPEAVCDrawListBrush@@@Z @ 0x180006FDC
 * Callers:
...
LABEL_39:
    if ( v7 )
      std::default_delete<CShape>::operator()(v25, v7);
    return (unsigned int)v13;
  }
  v27[0] = 0LL;
...
LABEL_19:
    ...
    *(_QWORD *)&v31.right = 0LL;
    ...
    if ( v13 >= 0 )
    {
      ...
      if ( v28 )
      {
        std::default_delete<CShape>::operator()(v21, v28);
        if ( v27[0] )
          CNineGridDrawListBrush::`scalar deleting destructor'(v27[0], 1u);
      }
      goto LABEL_19;
    }
