/*
 * XREFs of ??$AddLinkInternal@VCGdiSpriteBitmap@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCGdiSpriteBitmap@@_N@Z @ 0x1801F6E54
 * Callers:
 *     ?DebugDump@CWindowNode@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801F72A0 (-DebugDump@CWindowNode@@UEAAXPEAVCVisualTreeDumpContext@@@Z.c)
 * Callees:
...
void __fastcall CVisualTreeDumpContext::AddLinkInternal<CGdiSpriteBitmap>(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
    CDebugTreeDumper::RegisterNodeForVisit<CGdiSpriteBitmap>(a1[14], a3);
}
