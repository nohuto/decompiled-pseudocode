/*
 * XREFs of ?ProcessSetTransformParent@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETTRANSFORMPARENT@@@Z @ 0x1800CA3F8
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETTRANSFORMPARENT *a3)
{
  ...
  struct TransformParentData *v28; // [rsp+88h] [rbp+20h] BYREF
  ...
  else
  {
    ...
    v12 = 0LL;
    v28 = TransformParentDataInternal;
    v13 = 0LL;
    v14 = 0LL;
    ...
    else
    {
      ...
      {
        SAFE_DELETE<TransformParentData>(&v28);
        v23 = (_DWORD *)*((_QWORD *)this + 28);
        if ( (*v23 & 0x1000000) != 0 )
        {
          v24 = *((_QWORD *)this + 28);
          *v23 &= ~0x1000000u;
          Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v24, 8);
          if ( Slot < *(_DWORD *)(v26 + 4) )
            *(_BYTE *)(Slot + v26 + 8) = 0;
        }
        v15 = v28;
      }
      ...
      if ( v14 != v13 )
      {
        CVisual::ManageTransformParentChildList(this, v15, v20, v21);
        v6 = 1;
      }
    }
    if ( v15 )
