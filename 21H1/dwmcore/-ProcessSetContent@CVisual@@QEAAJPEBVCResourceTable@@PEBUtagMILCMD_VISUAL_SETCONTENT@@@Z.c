/*
 * XREFs of ?ProcessSetContent@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETCONTENT@@@Z @ 0x1800C32CC
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETCONTENT *a3)
{
  ...
  {
    v8 = (*(__int64 (__fastcall **)(CVisual *, __int64, const struct tagMILCMD_VISUAL_SETCONTENT *, const struct CResourceTable *))(*(_QWORD *)this + 320LL))(
           this,
           Resource,
           a3,
           v4);
