/*
 * XREFs of ?AnimateSingle@DirectionAnimator@Particles@@UEBAXAEAV?$span@M$0?0@gsl@@000@Z @ 0x1801DF150
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a5)
{
  ...
  float v17; // [rsp+38h] [rbp-18h]
  _QWORD v18[2]; // [rsp+40h] [rbp-10h] BYREF

  v5 = *(_QWORD *)(a1 + 8);
  v18[1] = &v16;
  v18[0] = 3LL;
  (*(void (__fastcall **)(__int64, __int64, __int64, _QWORD *))(*(_QWORD *)v5 + 8LL))(v5, a2, a3, v18);
  ...
  LODWORD(v16) = v10.m128_i32[0];
  HIDWORD(v16) = _mm_shuffle_ps(v10, v10, 85).m128_u32[0];
