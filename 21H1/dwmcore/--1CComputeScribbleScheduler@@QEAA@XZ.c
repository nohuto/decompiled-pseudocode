/*
 * XREFs of ??1CComputeScribbleScheduler@@QEAA@XZ @ 0x1801A7FD0
 * Callers:
 ...
 *     ?Log_GetLastError@in1diag3@details@wil@@YAKPEAXIPEBD@Z @ 0x1801A8D1C (-Log_GetLastError@in1diag3@details@wil@@YAKPEAXIPEBD@Z.c)
