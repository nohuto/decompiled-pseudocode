/*
 * XREFs of _anonymous_namespace_::TransformAndNormalize @ 0x18023080C
 * Callers:
 ...
 *     ?D2DMatrixIsIdentity@@YAHPEBUD2DMatrix@@@Z @ 0x18021E8DC (-D2DMatrixIsIdentity@@YAHPEBUD2DMatrix@@@Z.c)
