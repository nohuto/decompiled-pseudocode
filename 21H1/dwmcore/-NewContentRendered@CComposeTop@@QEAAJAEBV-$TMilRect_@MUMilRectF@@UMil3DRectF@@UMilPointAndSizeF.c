/*
 * XREFs of ?NewContentRendered@CComposeTop@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801FD494
 * Callers:
...
__int64 __fastcall CComposeTop::NewContentRendered(CComposeTop *this, __int64 a2)
{
  ...
  CRegionShape::BuildFromRects((__int64)v20, (__int64)v3, 1u);
  if ( !*((_QWORD *)this + 20) )
  {
