/*
 * XREFs of ??$uninitialized_copy@V?$move_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@std@@V?$checked_array_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@stdext@@V?$move_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@0@0V12@@Z @ 0x180269B60
 * Callers:
        ...
        __int64 *a4)
{
  ...
  v4 = a2;
  v5 = a3 - (_QWORD)a2;
  v8 = (__int64)((unsigned __int128)((a3 - (__int64)a2) * (__int128)0x2AAAAAAAAAAAAAABLL) >> 64) >> 1;
  v9 = (v8 >> 63) + v8;
  ...
  memmove_0(v11, v4, v5);
  result = a1;
  a4[2] = (__int64)((__int64)v11 + v5 - v10) / 12;
  v13 = a4[2];
  *(_OWORD *)a1 = *(_OWORD *)a4;
  *(_QWORD *)(a1 + 16) = v13;
  return result;
