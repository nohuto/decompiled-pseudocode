/*
 * XREFs of ?HrInit@CSystemMemoryBitmap@@QEAAJPEAVIBitmapSource@@PEAUWICRect@@_N@Z @ 0x180219468
 * Callers:
...
__int64 __fastcall CSystemMemoryBitmap::HrInit(CSystemMemoryBitmap *this, struct IBitmapSource *a2, struct WICRect *a3)
{
  ...
  if ( inited >= 0 )
  {
    ...
    if ( PixelFormatSize && (v9 = *((_DWORD *)this + 44), v9 <= 0x7FFFFFF8u / PixelFormatSize) )
    {
      v7 = 0;
    ...
    *((_DWORD *)this + 66) = v10;
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v7, 0x1E8u, 0LL);
      goto LABEL_18;
    }
    inited = HrMalloc(*((unsigned int *)this + 66), *((unsigned int *)this + 45), (void **)this + 32);
    v7 = inited;
    if ( inited < 0 )
    {
      v20 = 496;
    ...
    v15 = *(_QWORD *)a2;
    v21[3] = v12;
    v16 = (*(__int64 (__fastcall **)(struct IBitmapSource *, _DWORD *, __int64, _QWORD, __int64))(v15 + 24))(
            a2,
            v21,
            v14,
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x203u, 0LL);
LABEL_17:
    if ( v7 >= 0 )
      return (unsigned int)v7;
    goto LABEL_18;
