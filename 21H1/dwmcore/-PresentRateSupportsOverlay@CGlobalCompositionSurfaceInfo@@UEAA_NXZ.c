/*
 * XREFs of ?PresentRateSupportsOverlay@CGlobalCompositionSurfaceInfo@@UEAA_NXZ @ 0x1800EA1D0
 * Callers:
 *     <none>
 * Callees:
 *     ?CalcCurrentPresentCount@CPresentRate@@IEBAIPEBVCGlobalCompositionSurfaceInfo@@@Z @ 0x18020EC3C (-CalcCurrentPresentCount@CPresentRate@@IEBAIPEBVCGlobalCompositionSurfaceInfo@@@Z.c)
 *     ?IsSufficientIntervalForStats@CPresentRate@@IEBA_N_N@Z @ 0x18020ED08 (-IsSufficientIntervalForStats@CPresentRate@@IEBA_N_N@Z.c)
 *     ?IsSufficientPresentCount@CPresentRate@@IEAA_NI_N@Z @ 0x18020EE00 (-IsSufficientPresentCount@CPresentRate@@IEAA_NI_N@Z.c)
 */
