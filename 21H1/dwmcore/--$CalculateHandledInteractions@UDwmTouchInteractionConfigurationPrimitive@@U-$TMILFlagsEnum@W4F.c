 ...
 *     _anonymous_namespace_::AxisContainsMotion @ 0x18022C7D4 (_anonymous_namespace_--AxisContainsMotion.c)
 ...
 *     ?ConstructLocalToGlobalTransform@CInteractionProcessor@@AEAA?AUD2DMatrix@@PEAV?$DynArray@UAxisWithType@@$0A@@@@Z @ 0x18022DEFC (-ConstructLocalToGlobalTransform@CInteractionProcessor@@AEAA-AUD2DMatrix@@PEAV-$DynArray@UAxisWi.c)
