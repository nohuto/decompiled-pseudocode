/*
 * XREFs of ?CollectAdditionalDirtyRects@CVisual@@MEAAJPEBVCVisualTree@@PEAVCDirtyRegion@@AEBVCMILMatrix@@W4Enum@MilBitmapInterpolationMode@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18007D8D0
 * Callers:
      ...
      if ( v27 )
      {
        while ( 1 )
        {
          ...
          if ( *((float *)&v29 + 2) > *(float *)&v29 )
          {
            ...
            {
              if ( (*(unsigned __int8 (__fastcall **)(CVisual *))(*(_QWORD *)a1 + 344LL))(a1) )
                v17 = FLOAT_0_5;
              else
                v17 = 0.0;
              v18 = *((_QWORD *)a1 + 31);
