/*
 * XREFs of ?Render@CSpectreCallbackRenderer@@UEAAJXZ @ 0x1801A3090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpectreCallbackRenderer::Render(CSpectreCallbackRenderer *this)
{
  ...
  __m128 v41[4]; // [rsp+E0h] [rbp-20h] BYREF
...
LABEL_24:
  ...
  *(_OWORD *)v30 = 0LL;
  ...
  if ( *((_QWORD *)this + 15) != v11 )
  {
    ...
    v39[2] = v14;
    v39[3] = v15;
    if ( CMILMatrix::SetToInverse(v41, (const struct CMILMatrix *)v39) )
    {
      v16 = (char *)v30[1];
      v17 = v30[0];
...
LABEL_12:
      ...
      if ( (v16 - v17) >> 3 )
      {
        do
        {
          ...
          if ( (*(int (__fastcall **)(__int64, __m128 *, _BYTE *))(*(_QWORD *)v22 + 288LL))(v22, v41, &v17[8 * v21]) >= 0 )
          {
