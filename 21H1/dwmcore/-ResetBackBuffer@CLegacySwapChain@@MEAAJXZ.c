/*
 * XREFs of ?ResetBackBuffer@CLegacySwapChain@@MEAAJXZ @ 0x1800D65C0
 * Callers:
...
__int64 __fastcall CLegacySwapChain::ResetBackBuffer(CLegacySwapChain *this)
{
  ...
  *((_BYTE *)this + 268) = 0;
  if ( v5 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802ADB18, 2u, v7, 0x4BAu, 0LL);
    }
    else
    {
      v10 = *((_QWORD *)this + 11);
      *((_QWORD *)this + 11) = 0LL;
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802ADB18, 2u, v11, 0x4BCu, 0LL);
      }
      else
      {
        v13 = *v1;
        ...
        *v1 = 0LL;
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802ADB18, 2u, DeviceTextureTarget, 0x4C4u, 0LL);
        }
        else
        {
  ...
  {
    v9 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_1802ADB18, 2u, -2003304307, 0x4CCu, 0LL);
  }
  return v9;
}
