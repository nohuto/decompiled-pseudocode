  ...
  if ( v6 )
  {
    ...
    else
    {
      ...
      *((_QWORD *)&v75 + 1) = __PAIR64__(LODWORD(v21), LODWORD(v19));
      v24 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(this, a2, (__int64)a5, a6);
      v12 = v24;
      if ( v24 < 0 )
...
LABEL_69:
  ...
  else
  {
    ...
    if ( CLayerVisual::GetFlatteningToLocalSpace(this) )
    {
      ...
      v74 = 0;
      v72 = v59;
      v60 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(
              this,
    ...
    {
      v62 = CVisual::CalcInversedWorldInputBoundsFromVisibleWorldOutputBounds(this, a2, (__int64)a5, a6);
      v12 = v62;
      if ( v62 < 0 )
