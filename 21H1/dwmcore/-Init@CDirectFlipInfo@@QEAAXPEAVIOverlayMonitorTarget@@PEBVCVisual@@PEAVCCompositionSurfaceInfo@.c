/*
 * XREFs of ?Init@CDirectFlipInfo@@QEAAXPEAVIOverlayMonitorTarget@@PEBVCVisual@@PEAVCCompositionSurfaceInfo@@W4Enum@DirectFlipMode@@PEBVCRegion@@@Z @ 0x18018852C
 * Callers:
...
__int64 __fastcall CDirectFlipInfo::Init(
        ...
        __int64 a4,
        int a5,
        FastRegion::Internal::CRgnData **a6)
{
  __int64 *v8; // rax
  int v9; // eax
  __int64 result; // rax
  ...
  *(_DWORD *)(a1 + 52) = a5;
  ...
  if ( *(int *)(a1 + 52) >= 3 && a6 )
  {
    ...
    v9 = FastRegion::CRegion::Copy(*(FastRegion::Internal::CRgnData ***)(a1 + 32), a6);
    if ( v9 < 0 )
