/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::operator_ @ 0x1800DA530
 * Callers:
 ...
 *     ?_Move_assign@?$_Tree@V?$_Tset_traits@_KU?$less@_K@std@@V?$allocator@_K@2@$0A@@std@@@std@@AEAAXAEAV12@U_Equal_allocators@2@@Z @ 0x1800DA948 (-_Move_assign@-$_Tree@V-$_Tset_traits@_KU-$less@_K@std@@V-$allocator@_K@2@$0A@@std@@@std@@AEAAXA.c)
 */
