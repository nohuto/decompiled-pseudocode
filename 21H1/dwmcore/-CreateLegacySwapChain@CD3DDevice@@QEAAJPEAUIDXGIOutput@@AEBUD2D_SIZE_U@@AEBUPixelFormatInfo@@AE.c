/*
 * XREFs of ?CreateLegacySwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@I_NPEAPEAVILegacySwapChain@@@Z @ 0x1800D4E2C
 * Callers:
 ...
 *     ?UseSwapchainAsShaderInput@CD3DDevice@@QEBA_NXZ @ 0x1800D5924 (-UseSwapchainAsShaderInput@CD3DDevice@@QEBA_NXZ.c)
...
LABEL_30:
    v26 = v15;
LABEL_39:
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802DDC70, 3u, v26, v27, 0LL);
  }
  v24 = CD3DDevice::TranslateDXGIorD3DErrorInContext((__int64)this, v14, 2u);
