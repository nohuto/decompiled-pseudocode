/*
 * XREFs of ?GenerateDrawList@CPrimitiveGroupDrawListGenerator@@QEAAJPEAVCDrawingContext@@PEBUD2D_MATRIX_3X2_F@@PEAVCDrawListCache@@@Z @ 0x1800A67B0
 * Callers:
 ...
 *     ??8RenderTargetInfo@@QEBA_NAEBV0@@Z @ 0x180035894 (--8RenderTargetInfo@@QEBA_NAEBV0@@Z.c)
 ...
 *     ?FromD2D1ExtendMode@ExtendMode@@YA?AW4Enum@1@W4D2D1_EXTEND_MODE@@@Z @ 0x1800A6DB4 (-FromD2D1ExtendMode@ExtendMode@@YA-AW4Enum@1@W4D2D1_EXTEND_MODE@@@Z.c)
 ...
 *     ?IsWarpFastPathEnabled@CDrawingContext@@QEBA_NXZ @ 0x1800A71E8 (-IsWarpFastPathEnabled@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ @ 0x18026A0F4 (-CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ.c)
 */
        ...
        struct CDrawListCache *a4)
{
  ...
  {
    v11 = -2003304315;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, -2003304315, 0x109u, 0LL);
    goto LABEL_44;
  }
  ++dword_180349350;
...
LABEL_4:
  ...
  v9 = v62;
  CMatrixStack::Top((struct CDrawingContext *)((char *)a2 + 408), (struct CMILMatrix *)v91);
  v11 = 0;
  if ( !v8 )
  {
    ...
    if ( CpuClip < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, CpuClip, 0x142u, 0LL);
      goto LABEL_44;
    }
  }
  v14 = *((_DWORD *)a2 + 69) == 0;
  ...
  HIDWORD(v65) = !v14;
  *(_QWORD *)&v66 = &v73;
  CMILMatrix::Get2DScaleDimensionsWithPerspective((__int64)v91);
  v15 = *((_QWORD *)this + 2);
  v16 = 0;
  v63 = 0;
  if ( !*(_DWORD *)(v15 + 8) )
...
LABEL_43:
  ...
  while ( 1 )
  {
    ...
    if ( v50 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v51, 0LL, 0, v50, 0x16Bu, 0LL);
...
LABEL_11:
  ...
  if ( !v19 )
  {
    ...
    if ( (unsigned int)v20 < *((_DWORD *)this + 14) )
      CDrawListBitmap::operator=((__int64 *)&v78, (__int64 *)(*((_QWORD *)this + 13) + 48 * v20));
    v21 = *(unsigned int *)(v17 + 56);
    if ( (unsigned int)v21 < *((_DWORD *)this + 18) )
      CDrawListBitmap::operator=((__int64 *)&v67, (__int64 *)(*((_QWORD *)this + 14) + 48 * v21));
  }
  ...
  if ( v29 || (v29 = DefaultHeap::Alloc(0x78uLL)) != 0LL )
  {
    ...
    v60[2] = v24;
    v61[0] = v23;
    v31 = (struct CRenderingEffect *)CCommonRenderingEffect::CCommonRenderingEffect(
                                       (__int64)v29,
                                       (__int64 *)&v78,
                                       (__int64)v61,
                                       (__int64 *)&v67,
