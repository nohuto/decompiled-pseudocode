/*
 * XREFs of ?PrepareForDrawing@CMaskBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x1800B9D10
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct D2D_SIZE_F *a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 11) + 312LL))(*((_QWORD *)this + 11));
  v8 = v6;
  if ( v6 < 0 )
  {
