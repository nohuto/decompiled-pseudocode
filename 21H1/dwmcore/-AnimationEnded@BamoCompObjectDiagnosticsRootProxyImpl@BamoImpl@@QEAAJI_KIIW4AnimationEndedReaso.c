/*
 * XREFs of ?AnimationEnded@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4AnimationEndedReasonType@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180186394
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsRootProxyImpl::AnimationEnded(__int64 a1, int a2, __int64 a3)
{
  int v6; // ebx
  __int64 v7; // rdx
...
LABEL_3:
  ...
  LOWORD(v11) = 4;
  return CoreUICallSend(v9, v13, 2LL, 0LL, v11, &unk_1802DB07B, a2, a3);
}
