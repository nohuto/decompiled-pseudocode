/*
 * XREFs of ?DrawSolidRectangle@COcclusionContext@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x18001B5E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall COcclusionContext::DrawSolidRectangle(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !*(_DWORD *)(a1 + 1460) && *(float *)(a3 + 12) == 1.0 )
  {
    ...
    v3 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x3A8u, 0LL);
  }
  return v3;
}
