/*
 * XREFs of ?PostSubgraph@CPreComputeContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x180065300
 * Callers:
 ...
 *     ?AddRectangleToBounds@CWindowBackgroundTreatment@@QEAAJAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180015810 (-AddRectangleToBounds@CWindowBackgroundTreatment@@QEAAJAEBV-$TMil3DRect@MV-$TMilRect_@MUMilRectF.c)
 *     ??8?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEBA_NAEBV0@@Z @ 0x180016718 (--8-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniquen.c)
 ...
 *     ?GetTopLevelWindow@CVisual@@QEBA_KXZ @ 0x18001D9D4 (-GetTopLevelWindow@CVisual@@QEBA_KXZ.c)
 ...
 *     IsNotifyInputSinkParentedPresent @ 0x1800E2988 (IsNotifyInputSinkParentedPresent.c)
...
__int64 __fastcall CPreComputeContext::PostSubgraph(CPreComputeContext *this, const struct CVisualTree *a2, bool *a3)
{
  ...
  __m128 v199; // [rsp+190h] [rbp-E8h] BYREF
  __m128 v200; // [rsp+1A0h] [rbp-D8h] BYREF
  ...
  *a3 = 1;
    ...
    || (unsigned int)((__int64)(*(_QWORD *)(v7 + 304) - *(_QWORD *)(v7 + 296)) >> 4) )
  {
    ...
    do
    {
      ...
      v61 = (__m128 *)((char *)v61 + 4);
    }
    while ( v61 != (__m128 *)&v199.m128_u16[4] );
    v3 = v182;
  }
  v12 = *(_BYTE *)(v7 + 88);
  if ( (v12 & 1) != 0 )
  ...
  if ( (v12 & 0x10) == 0 )
    goto LABEL_8;
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v7 + 272LL))(v7) )
    *(_DWORD *)(v7 + 88) |= 0x100u;
  v27 = *(_DWORD **)(v7 + 224);
  if ( (*v27 & 0x400000) != 0 )
  {
...
LABEL_44:
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v7 + 336LL))(v7) )
    *(_DWORD *)(v7 + 88) |= 0x400u;
...
LABEL_8:
  ...
  v190 = _xmm;
  v191 = _xmm;
  v199 = (__m128)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcInfinite;
  LOWORD(v192) = 32085;
  v176 = 0;
...
LABEL_211:
      ...
      {
        CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)&v183, (__int64)&v199, v199.m128_f32);
        v104 = v199.m128_f32[3];
        v103 = v199.m128_f32[2];
        v102 = v199.m128_f32[1];
        v101 = v199.m128_f32[0];
      }
      v11 = *(_QWORD *)(v100 + 240);
      if ( !v11 )
        goto LABEL_215;
      ...
      else
      {
        ...
        if ( v180 )
        {
          ...
          else
          {
            if ( *(float *)&v206 > v101 )
            {
              v199.m128_i32[0] = v206;
              LODWORD(v101) = v206;
            }
            v112 = v102;
            if ( *((float *)&v206 + 1) > v102 )
            {
              v199.m128_i32[1] = DWORD1(v206);
              v102 = *((float *)&v206 + 1);
              v112 = *((float *)&v206 + 1);
            }
            v113 = v103;
...
LABEL_242:
    ...
    if ( v200.m128_f32[2] <= v200.m128_f32[0] )
      ++v117;
    if ( v200.m128_f32[3] <= v200.m128_f32[1] )
      ++v117;
    if ( v117 <= 1 )
    {
...
LABEL_15:
  ...
  if ( (*(_BYTE *)(v7 + 264) & 1) != 0 )
  {
    ...
    if ( v90 )
    {
      ...
      *((_DWORD *)this + 26) = v91;
      ...
      v202 = v93;
      v95 = v94
          ? (CMILMatrix *)(*((_QWORD *)this + 31) + 68LL * (unsigned int)(v94 - 1))
          : (CMILMatrix *)&CMILMatrix::Identity;
      v96 = v7 == *((_QWORD *)a2 + 7)
          ? (const struct CVisualTree *)((char *)a2 + 64)
          : (const struct CVisualTree *)(v7 + 140);
      CMILMatrix::Transform3DBoundsHelper<1>(v95, (__int64)v96, &v200);
      v97 = *((_DWORD *)this + 66);
      if ( v97 )
      {
        v127 = (__m128 *)(*((_QWORD *)this + 35) + 16LL * (unsigned int)(v97 - 1));
        v128 = *v127;
        v129 = v200.m128_f32[0] <= COERCE_FLOAT(*v127);
        v199 = *v127;
        if ( !v129 )
          v128.m128_i32[0] = v200.m128_i32[0];
        v130 = v199.m128_i32[1];
        v131 = v199.m128_f32[1];
        if ( v200.m128_f32[1] > v199.m128_f32[1] )
        {
          v130 = v200.m128_i32[1];
          v131 = v200.m128_f32[1];
        }
        v132 = v199.m128_i32[2];
        v133 = v199.m128_f32[2];
        if ( v199.m128_f32[2] > v200.m128_f32[2] )
        {
          v132 = v200.m128_i32[2];
          v133 = v200.m128_f32[2];
        }
        v134 = v199.m128_i32[3];
        v135 = v199.m128_f32[3];
        if ( v199.m128_f32[3] > v200.m128_f32[3] )
        {
          v134 = v200.m128_i32[3];
          v135 = v200.m128_f32[3];
        }
        ...
        v199.m128_u64[0] = __PAIR64__(v130, v128.m128_u32[0]);
        v199.m128_u64[1] = __PAIR64__(v134, v132);
      }
      else
      {
        v199 = v200;
  ...
  v122 = v121;
  v199.m128_u64[0] = (unsigned __int64)v121;
  if ( !(_DWORD)v11
    || (v123 = v11 - 1,
        *((_DWORD *)this + 26) = v123,
        v124 = v123,
        v11 = *((_QWORD *)this + 15),
        v200 = *(__m128 *)(v11 + 16 * v124),
        !*((_BYTE *)v121 + 356)) )
  {
LABEL_26:
    v18 = g_pComposition;
  ...
  if ( (unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesIntersectUnsafe(&v200, &v202) )
  {
    ...
    v122 = (struct CWindowBackgroundTreatment *)v199.m128_u64[0];
    v177 = 1;
  }
  v178 = *((_BYTE *)v122 + 360);
  v179 = *((_BYTE *)v122 + 359);
...
LABEL_27:
  if ( (*(_BYTE *)(v7 + 88) & 4) != 0 )
  {
    ...
    v45 = *((_DWORD *)this + 58);
    if ( v45 )
      v17 = (CMILMatrix *)(*((_QWORD *)this + 31) + 68LL * (unsigned int)(v45 - 1));
    ...
    v49 = v200.m128_f32[3];
    v50 = v200.m128_f32[1];
    if ( v200.m128_f32[2] > v200.m128_f32[0] && v200.m128_f32[3] > v200.m128_f32[1] )
    {
      v51 = *(_DWORD *)(v7 + 88);
      ...
      if ( v52 != 0.0 )
      {
        v48 = v200.m128_f32[0] - v52;
        v50 = v200.m128_f32[1] - v52;
        v47 = v200.m128_f32[2] + v52;
        v49 = v200.m128_f32[3] + v52;
      }
    }
    v53 = *((_DWORD *)this + 66);
    if ( v53 )
    {
      ...
      v199.m128_u64[0] = __PAIR64__(LODWORD(v55), LODWORD(v54));
      v48 = v54;
      v50 = v55;
      v199.m128_u64[1] = __PAIR64__(LODWORD(v59), LODWORD(v57));
      v47 = v57;
      v49 = v59;
    }
    else
    {
      v199.m128_u64[0] = __PAIR64__(LODWORD(v50), LODWORD(v48));
      v199.m128_u64[1] = __PAIR64__(LODWORD(v49), LODWORD(v47));
    }
    v11 = *((_QWORD *)this + 86);
    v23 = 0;
    if ( !*(_BYTE *)(v11 + 4456) && !*(_DWORD *)(v11 + 4432) )
    {
      ...
      {
        v89 = CDirtyRegion::_Add((CDirtyRegion *)v11, v7, 1, v199.m128_f32);
        v23 = v89;
        if ( v89 < 0 )
