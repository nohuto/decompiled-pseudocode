/*
 * XREFs of ?GenerateDrawList@CAtlasedRectsGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180035E30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InferAffineMatrix@MILMatrix3x2@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x180036870 (-InferAffineMatrix@MILMatrix3x2@@QEAAXAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF.c)
        ...
        struct CDrawListCache *a4)
{
  ...
  __int64 v41; // rcx
  __int64 v43; // rsi
  __int64 (__fastcall ***v44)(_QWORD, __int64 *); // rcx
  __int64 v45; // rdi
  ...
  __int64 v75; // [rsp+160h] [rbp+58h] BYREF
  ...
  _BYTE v82[2304]; // [rsp+1D8h] [rbp+D0h] BYREF
  ...
  if ( *((_DWORD *)a2 + 70) == 4 )
    goto LABEL_3;
  v43 = *((_QWORD *)this + 8);
  v44 = (__int64 (__fastcall ***)(_QWORD, __int64 *))(*((_QWORD *)a2 + 4)
                                                    + 8LL
...
LABEL_3:
  ...
  v81 = 0;
  v59 = 0LL;
  CMatrixStack::Top((struct CDrawingContext *)((char *)a2 + 408), (struct CMILMatrix *)v77);
...
LABEL_35:
  ...
  v14 = **(struct D2D_SIZE_U **)&CDrawListBitmap::GetSize((CDrawListBitmap *)v54);
  v76 = v14;
