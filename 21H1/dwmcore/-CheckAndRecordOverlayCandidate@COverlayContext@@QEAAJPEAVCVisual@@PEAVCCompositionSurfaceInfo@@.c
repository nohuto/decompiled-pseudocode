/*
 * XREFs of ?CheckAndRecordOverlayCandidate@COverlayContext@@QEAAJPEAVCVisual@@PEAVCCompositionSurfaceInfo@@PEAVISwapChainRealization@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@33W4DXGI_MODE_ROTATION@@I_N@Z @ 0x18017E6C0
 * Callers:
 ...
 *     ?IsIntelWorkaroundNeeded@COverlayContext@@AEBA_NAEBUtagRECT@@00@Z @ 0x180180D18 (-IsIntelWorkaroundNeeded@COverlayContext@@AEBA_NAEBUtagRECT@@00@Z.c)
        ...
        bool a10)
{
  ...
  int v39; // eax
  bool v40; // bl
  FastRegion::Internal::CRgnData **v41; // rsi
  ...
  *(_OWORD *)v115 = 0LL;
  ...
  if ( *(_DWORD *)((**(__int64 (__fastcall ***)(struct ISwapChainRealization *, _BYTE *))v14)(v14, v123) + 4) != 1 )
  {
    ...
    *(float *)&v29 = *(float *)&v29 + 6291456.25;
    ...
    v41 = (FastRegion::Internal::CRgnData **)((char *)v11 + 11304);
    ...
    if ( *v47 == *v45 && v47[1] == v45[1] )
    {
            ...
            !CD2DContext::IsHardwareProtectionDisabled((CD2DContext *)(v50 + 16))) )
      {
        ...
        if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
        {
          ...
          v11 = v117;
          v10 = v118;
          v41 = (FastRegion::Internal::CRgnData **)v116;
          v44 = v104;
          v40 = v108;
        }
        if ( v112
          ...
          if ( COverlayContext::OverlaysEnabled(v11) )
          {
              ...
              && !v105 )
            {
                     ...
                     a10) )
              {
                ...
                v89 = FastRegion::CRegion::Copy((FastRegion::Internal::CRgnData **)v115[0], v41);
                if ( v89 < 0 )
