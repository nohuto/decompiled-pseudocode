/*
 * XREFs of ?Draw@CGenericInk@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1801C65E8
 * Callers:
 *     ?Draw@CGenericInk@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1800EC3E0 (-Draw@CGenericInk@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 * Callees:
...
LABEL_32:
  ...
  if ( v10 )
  {
    ...
    v25 = 0LL;
    v28 = 0LL;
    CMatrixStack::Top((CDrawingContext *)((char *)v20 + 408), (struct CMILMatrix *)v23);
    CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)v23, (__int64)&v26, (float *)&v25);
    CDrawingContext::GetClipBoundsWorld((__int64)v20, (__int64)&v28);
    v13 = *(float *)&v25;
