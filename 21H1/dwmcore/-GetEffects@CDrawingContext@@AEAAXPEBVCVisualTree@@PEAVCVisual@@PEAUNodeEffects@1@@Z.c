/*
 * XREFs of ?GetEffects@CDrawingContext@@AEAAXPEBVCVisualTree@@PEAVCVisual@@PEAUNodeEffects@1@@Z @ 0x1800619F0
 * Callers:
...
LABEL_23:
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CVisual *, __int64))(*(_QWORD *)a3 + 56LL))(a3, 91LL)
    && ((*(unsigned __int8 (__fastcall **)(struct CVisual *))(*(_QWORD *)a3 + 224LL))(a3) || *((_QWORD *)a3 + 77)) )
  {
    *((_BYTE *)a4 + 167) = 1;
  }
  v19 = *((float *)a4 + 2);
