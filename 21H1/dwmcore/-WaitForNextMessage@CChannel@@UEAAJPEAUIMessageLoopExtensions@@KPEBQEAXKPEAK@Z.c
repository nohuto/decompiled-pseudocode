/*
 * XREFs of ?WaitForNextMessage@CChannel@@UEAAJPEAUIMessageLoopExtensions@@KPEBQEAXKPEAK@Z @ 0x1800D9130
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  if ( a3 && !a4 || a3 > 0x3F )
  {
    ...
    v24 = 615;
LABEL_25:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v12, v24, 0LL);
