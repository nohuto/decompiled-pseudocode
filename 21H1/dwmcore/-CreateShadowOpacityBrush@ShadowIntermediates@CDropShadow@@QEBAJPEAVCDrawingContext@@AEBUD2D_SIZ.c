/*
 * XREFs of ?CreateShadowOpacityBrush@ShadowIntermediates@CDropShadow@@QEBAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@MPEAPEAVCDrawListBrush@@@Z @ 0x18000F744
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)&v33.right = 0LL;
      ...
      if ( v18 >= 0 )
      {
        ...
        if ( *(_QWORD *)&v32.left )
        {
          std::default_delete<CShape>::operator()(v28, *(_QWORD *)&v32.left);
          if ( v45 )
