/*
 * XREFs of ??$SetProperty@UD2DVector4@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector4@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180183D74
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector4>(_QWORD *a1, int a2, _OWORD *a3)
{
  __int64 v6; // r11
  _QWORD *v7; // rax
  __int64 v8; // r10
