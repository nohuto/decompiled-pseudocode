/*
 * XREFs of ?LockForRead@CD2DBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x180028B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DBitmap::LockForRead(__int64 a1, int *a2, _QWORD *a3)
{
  ...
  v37 = 0LL;
  v39 = v4;
  if ( !(unsigned __int8)TMilRect<unsigned int,MilRectU,Mil3DRectU,RectUniqueness::NotNeeded>::DoesContain(&v37)
