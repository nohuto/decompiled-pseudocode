/*
 * XREFs of ?EnsureClientInfo@CDesktopTree@@MEAAXXZ @ 0x1800BC4E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?clear@?$vector_facade@PEAVCOverlayContext@@V?$buffer_impl@PEAVCOverlayContext@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXXZ @ 0x1800BC7A4 (-clear@-$vector_facade@PEAVCOverlayContext@@V-$buffer_impl@PEAVCOverlayContext@@$03$00Vliberal_e.c)
