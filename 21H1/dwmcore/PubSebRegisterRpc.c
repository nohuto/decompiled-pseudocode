/*
 * XREFs of PubSebRegisterRpc @ 0x1800B6EE0
 * Callers:
 *     ?EnsureWNFHandles@CLegacyRenderTarget@@IEAAJXZ @ 0x1800B6E48 (-EnsureWNFHandles@CLegacyRenderTarget@@IEAAJXZ.c)
 * Callees:
 *     ?Insert@ContextTable@@QEAAKPEAU_SEB_RPC_PUBLISH_DATA@@PEAX@Z @ 0x1800B6FEC (-Insert@ContextTable@@QEAAKPEAU_SEB_RPC_PUBLISH_DATA@@PEAX@Z.c)
