/*
 * XREFs of ?GenerateShaders@CD3DDevice@@AEAAJXZ @ 0x1800A02CC
 * Callers:
...
__int64 __fastcall CD3DDevice::GenerateShaders(CD3DDevice *this)
{
  ...
  __int64 v44; // r15
  __int64 (__fastcall *v45)(__int64, __int64, char *); // r12
  char *v46; // rbx
  __int64 v47; // rcx
...
LABEL_65:
  ...
  while ( 2 )
  {
    ...
    do
    {
      *(_QWORD *)v55 = 0LL;
      ...
      {
        v21 = *((_OWORD *)&unk_180285DF0 + v20);
        v56 = (struct ID3D11PixelShader *)*((_QWORD *)&unk_180285DF0 + 2 * v20);
        v58 = v21;
        if ( v56 )
        {
          *(_OWORD *)v55 = *((_OWORD *)&unk_1803471D0 + v18);
          *(_OWORD *)v65 = *((_OWORD *)&unk_180347210 + (int)v17);
          v22 = v65[0];
          if ( v65[0] )
          {
            v23 = *(_QWORD *)v55;
  ...
  do
  {
    ...
    *((_QWORD *)v32 + 202) = 0LL;
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v35(v31, &byte_1802EE6F0[264 * (int)v30], v32 + 1616);
    v9 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v53 = 595;
  ...
  do
  {
    ...
    *((_QWORD *)v38 + 274) = 0LL;
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v41(v37, &_ImageBase + 10 * (int)v36 + 795850, v38 + 2192);
    v9 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v53 = 601;
  ...
  {
    v44 = *((_QWORD *)this + 74);
    v45 = *(__int64 (__fastcall **)(__int64, __int64, char *))(*(_QWORD *)v44 + 168LL);
    v46 = (char *)this + 8 * v43;
    v47 = *((_QWORD *)v46 + 275);
    *((_QWORD *)v46 + 275) = 0LL;
    if ( v47 )
