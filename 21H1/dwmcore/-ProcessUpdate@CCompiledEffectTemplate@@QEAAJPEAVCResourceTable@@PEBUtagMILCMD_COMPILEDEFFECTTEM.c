/*
 * XREFs of ?ProcessUpdate@CCompiledEffectTemplate@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPILEDEFFECTTEMPLATE@@@Z @ 0x1800C0708
 * Callers:
...
LABEL_17:
  ...
  {
    v12 = -2147467259;
    v13 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v4 + 2) + 1080LL) + 48LL);
    v14 = 0LL;
    bstrString = 0LL;
    if ( v5 < 0 )
    {
    ...
    LOWORD(v20) = 1;
    v17 = CoreUICallSend(v13, v21, 2LL, 5LL, v20, &unk_1802CFADD, v12, v14);
    v8 = v17;
    if ( v17 < 0 )
