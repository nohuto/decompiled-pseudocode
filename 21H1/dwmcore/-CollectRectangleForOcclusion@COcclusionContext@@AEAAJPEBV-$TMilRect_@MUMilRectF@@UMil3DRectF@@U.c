/*
 * XREFs of ?CollectRectangleForOcclusion@COcclusionContext@@AEAAJPEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_NPEAV2@@Z @ 0x18004EAE0
 * Callers:
...
__int64 __fastcall COcclusionContext::CollectRectangleForOcclusion(__int64 a1, float *a2, __int64 a3, __m128 *a4)
{
  ...
  if ( v30 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x681u, 0LL);
