/*
 * XREFs of ?CreateRenderTargetForFrameBuffer@CCaptureRenderTarget@@IEAAJXZ @ 0x18018B7D0
 * Callers:
...
LABEL_7:
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x249u, 0LL);
    goto LABEL_30;
  }
  v31 = 0LL;
  ...
  if ( Device < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, Device, 0x24Cu, 0LL);
    v25 = v31;
    if ( !v31 )
      goto LABEL_30;
    goto LABEL_28;
...
LABEL_22:
  ...
  v10 = v23;
  if ( v23 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x266u, 0LL);
  else
    v30 = 0LL;
LABEL_30:
  if ( v10 < 0 )
