/*
 * XREFs of ?OnChanged@CEffectBrush@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18009CC60
 * Callers:
 *     <none>
 * Callees:
 *     ?OnChanged@CBrush@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18009CCC0 (-OnChanged@CBrush@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
 *     ?HasValidTemplate@CEffectBrush@@AEBA_NXZ @ 0x18009CCF8 (-HasValidTemplate@CEffectBrush@@AEBA_NXZ.c)
