/*
 * XREFs of ?ConvertSingleResource@CConversionSwapChain@@IEAAJPEAUID3D11ShaderResourceView@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@33@Z @ 0x18024FF5C
 * Callers:
...
{
  __int64 v9; // rdx
  CSurfaceShaderComposer **v11; // r14
  char v13; // si
  ...
  v9 = *(_QWORD *)(a1 + 80);
  v11 = *(CSurfaceShaderComposer ***)(a1 + 64);
  v13 = *(_BYTE *)(a1 + 164);
  v15 = *(_DWORD *)(a1 + 140);
  v25 = *(_QWORD *)a8;
  v26 = *(_DWORD *)(a8 + 8);
  ...
  v18 = (int *)(**v17)(v17, &a8);
  v19 = *(int *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 8LL) + 24LL) + *(_QWORD *)(a1 + 80) + 8LL;
  v20 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v19 + 56LL))(v19);
  v21 = CD3DDevice::HDRConvert(v11, a2, a3, a4, a5, (unsigned int)a6, a7, v20, v18, v15, v16, v13, (__int64)&v25);
  v23 = v21;
  if ( v21 < 0 )
