/*
 * XREFs of ?ProcessSetSourceOffset@CVisualSurface@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALSURFACE_SETSOURCEOFFSET@@@Z @ 0x1801F6500
 * Callers:
        ...
        const struct tagMILCMD_VISUALSURFACE_SETSOURCEOFFSET *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_180348558)(
         (char *)this + SDWORD2(xmmword_180348558),
