/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800E916C
 * Callers:
 *     ?PrepareForCalculation@CExpression@@MEAAXPEA_N@Z @ 0x180041B10 (-PrepareForCalculation@CExpression@@MEAAXPEA_N@Z.c)
 * Callees:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling>::ReportUsage(
