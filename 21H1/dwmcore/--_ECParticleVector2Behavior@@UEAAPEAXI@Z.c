/*
 * XREFs of ??_ECParticleVector2Behavior@@UEAAPEAXI@Z @ 0x180171CD0
 * Callers:
 *     ??_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z @ 0x1800EBF30 (--_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
