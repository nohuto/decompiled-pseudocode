/*
 * XREFs of ?WaitForNextFrameStart@CPartitionVerticalBlankScheduler@@AEAAJ_N@Z @ 0x18003E230
 * Callers:
 ...
 *     ?EstimateNextVSync@CPartitionVerticalBlankScheduler@@AEAA_KXZ @ 0x1800D10D8 (-EstimateNextVSync@CPartitionVerticalBlankScheduler@@AEAA_KXZ.c)
        ...
        __int64 a3)
{
  ...
  char v34[16]; // [rsp+98h] [rbp+17h] BYREF
...
LABEL_25:
  ...
  *((_BYTE *)this + 5373) = v19;
  ...
  {
    if ( v18 != -2003304307 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802ADB18, 2u, v18, 0x1CCu, 0LL);
  }
  else
  {
    v20 = 0LL;
