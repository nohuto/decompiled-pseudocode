/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DGenericInk@@VCGenericInk@@@@QEAAJPEAVCD3DDevice@@PEAPEAVCD2DGenericInk@@@Z @ 0x1801C6AA4
 * Callers:
        ...
        CRenderTargetBitmap **a3)
{
  ...
  int v20; // eax
  __int64 v21; // rcx
  CRenderTargetBitmap *v22; // rbx
  const void **v23; // rcx
  _BYTE *v24; // rdx
  CRenderTargetBitmap **v25; // rdx
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    ...
    v11 = *(CRenderTargetBitmap **)(v3 + 8 * v6);
    *a3 = v11;
    if ( v11 )
      return v4;
  }
...
LABEL_17:
  ...
  v25 = (CRenderTargetBitmap **)a1[3];
  if ( (CRenderTargetBitmap **)a1[4] == v25 )
  {
