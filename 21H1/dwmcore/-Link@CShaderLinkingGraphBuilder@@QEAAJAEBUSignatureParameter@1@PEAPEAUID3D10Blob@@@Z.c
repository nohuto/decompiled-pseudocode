/*
 * XREFs of ?Link@CShaderLinkingGraphBuilder@@QEAAJAEBUSignatureParameter@1@PEAPEAUID3D10Blob@@@Z @ 0x18009F46C
 * Callers:
        ...
        struct ID3D10Blob **a3)
{
  ...
  __int64 v26; // rcx
  const CHAR *v27; // rax
  __int64 v28[2]; // [rsp+40h] [rbp-59h] BYREF
  ...
  *(_DWORD *)&v30[20] = 2;
  ...
  v28[1] = (__int64)&unk_180274380;
  v28[0] = 1LL;
  v11 = CShaderLinkingGraphBuilder::FulfillInputs(this, (__int64)v34, v28);
  v10 = v11;
  if ( v11 < 0 )
  {
...
LABEL_22:
  ...
  else
  {
    ...
    {
      Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v34);
      Microsoft::WRL::ComPtr<IMessageCallSendHost>::InternalAddRef((__int64 *)&v33);
      *a3 = v33;
      goto LABEL_9;
    }
