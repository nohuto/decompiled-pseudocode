/*
 * XREFs of ?HrFindInterface@CLegacyStereoSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18024E9D0
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CLegacySwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003CBE0 (-HrFindInterface@CLegacySwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
