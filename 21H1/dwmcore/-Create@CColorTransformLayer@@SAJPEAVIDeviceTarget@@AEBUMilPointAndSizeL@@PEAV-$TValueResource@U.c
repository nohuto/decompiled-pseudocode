/*
 * XREFs of ?Create@CColorTransformLayer@@SAJPEAVIDeviceTarget@@AEBUMilPointAndSizeL@@PEAV?$TValueResource@UMilColorTransform@@UtagMILCMD_COLORTRANSFORMRESOURCE@@$0BI@@@PEAPEAV1@@Z @ 0x18019408C
 * Callers:
        ...
        CExternalLayer **a4)
{
  ...
  *a4 = 0LL;
  ...
  v11 = (const struct PixelFormatInfo *)(**v10)(v10, v23);
  v21 = 48;
  v20 = "DWM Scratch Rendertarget (color transform layer)";
  Bitmap = CExternalLayer::CreateBitmap((const struct CResourceTag *)&v20, a2, v11, v9, 1, (CD3DDevice *)&v19);
  v14 = Bitmap;
  if ( Bitmap < 0 )
  {
