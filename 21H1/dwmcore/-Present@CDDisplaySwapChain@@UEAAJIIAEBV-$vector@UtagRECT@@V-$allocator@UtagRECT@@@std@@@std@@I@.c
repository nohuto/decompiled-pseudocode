/*
 * XREFs of ?Present@CDDisplaySwapChain@@UEAAJIIAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I@Z @ 0x1800EA450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDDisplaySwapChain::Present(__int64 a1, int a2, char a3)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x284u, 0LL);
  }
  else
  {
    v10 = *(_QWORD *)(a1 + 88);
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x28Eu, 0LL);
    }
    else
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x290u, 0LL);
      }
      else
      {
        ...
        v9 = v17;
        if ( v17 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x292u, 0LL);
      }
    }
  }
