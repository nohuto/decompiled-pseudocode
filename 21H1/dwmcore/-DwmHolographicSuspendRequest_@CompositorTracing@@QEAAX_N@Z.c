/*
 * XREFs of ?DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z @ 0x1802541F4
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicSuspendRequest_(CompositorTracing *this, char a2)
{
    ...
    && (*(_QWORD *)(v3 + 24) & 0x400000000000LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v4 = a2;
    v7 = 1;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1802EE183, 0LL, 0LL, 3u, &v5);
  }
}
