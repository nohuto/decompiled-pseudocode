/*
 * XREFs of ?AlphaDivide_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x18021CC60
 * Callers:
 *     <none>
 * Callees:
 *     ??BCFloat16@@QEAAMXZ @ 0x18021C2DC (--BCFloat16@@QEAAMXZ.c)
 */
...
void __fastcall AlphaDivide_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( *((_DWORD *)a1 + 2) )
  {
    ...
    do
    {
      ...
      if ( v3 != CFloat16::operator float((unsigned __int16 *)&word_1803487A0) )
      {
        v5 = CFloat16::operator float(v2);
        if ( v5 != CFloat16::operator float(word_1803498B8) )
        {
