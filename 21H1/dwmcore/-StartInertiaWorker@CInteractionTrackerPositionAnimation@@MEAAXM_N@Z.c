/*
 * XREFs of ?StartInertiaWorker@CInteractionTrackerPositionAnimation@@MEAAXM_N@Z @ 0x1802077F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z @ 0x1802110D4 (-StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z.c)
