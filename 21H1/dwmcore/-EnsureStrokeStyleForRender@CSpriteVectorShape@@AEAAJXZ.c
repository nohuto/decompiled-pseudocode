/*
 * XREFs of ?EnsureStrokeStyleForRender@CSpriteVectorShape@@AEAAJXZ @ 0x1801F1098
 * Callers:
 ...
 *     ?reserve@?$vector@MV?$allocator@M@std@@@std@@QEAAX_K@Z @ 0x180178420 (-reserve@-$vector@MV-$allocator@M@std@@@std@@QEAAX_K@Z.c)
