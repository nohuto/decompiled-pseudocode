/*
 * XREFs of ?Present@CRemoteRenderTarget@@UEAAJ_N@Z @ 0x1800DFA94
 * Callers:
 *     ?Present@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EC840 (-Present@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
