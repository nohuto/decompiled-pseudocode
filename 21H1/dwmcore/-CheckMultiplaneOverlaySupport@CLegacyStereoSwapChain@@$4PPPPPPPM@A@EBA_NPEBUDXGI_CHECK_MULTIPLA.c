/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x1800EEF60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        bool *a4)
{
  return CLegacyStereoSwapChain::CheckMultiplaneOverlaySupport(
           (CLegacyStereoSwapChain *)(a1 - *(int *)(a1 - 4)),
           a2,
           a3,
           a4);
}
