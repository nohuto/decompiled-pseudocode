/*
 * XREFs of ?CreateDDASwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVIDDASwapChain@@@Z @ 0x18023F294
 * Callers:
...
LABEL_11:
    v18 = v15;
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802F1898, 2u, v18, v21, 0LL);
  }
