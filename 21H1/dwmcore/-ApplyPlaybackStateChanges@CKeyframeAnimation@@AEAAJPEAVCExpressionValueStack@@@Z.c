/*
 * XREFs of ?ApplyPlaybackStateChanges@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x180098D98
 * Callers:
 ...
 *     ?GetGlobalPlaybackRate@CExpressionManager@@QEAAMPEAVCChannelContext@@@Z @ 0x18009A5D4 (-GetGlobalPlaybackRate@CExpressionManager@@QEAAMPEAVCChannelContext@@@Z.c)
    ...
    if ( v5 )
    {
      if ( !v4 )
      {
        ...
        if ( v25 )
        {
          ...
          if ( v27 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x346u, 0LL);
            return v6;
          }
          v29 = *((_DWORD *)a2 + 4);
          if ( v29 == v26 + 1 )
          {
            ...
            if ( v30 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x354u, 0LL);
              return v6;
            }
            --*((_DWORD *)a2 + 4);
          }
        ...
        if ( v32 )
        {
          if ( (*(_BYTE *)(v32 + 112) & 4) != 0 )
          {
            ...
            if ( v33 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v33, 0x35Du, 0LL);
              return v6;
            }
          }
        }
...
LABEL_2:
  if ( v5 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x3A6u, 0LL);
        return v6;
      }
      *((_QWORD *)this + 58) = *(_QWORD *)(*((_QWORD *)this + 2) + 456LL);
    }
    else if ( v9 )
    {
      ...
      if ( v37 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, v37, 0x3AEu, 0LL);
        return v6;
      }
    }
  }
