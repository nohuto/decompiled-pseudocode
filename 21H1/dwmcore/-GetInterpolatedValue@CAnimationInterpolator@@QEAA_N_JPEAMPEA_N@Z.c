/*
 * XREFs of ?GetInterpolatedValue@CAnimationInterpolator@@QEAA_N_JPEAMPEA_N@Z @ 0x180221C10
 * Callers:
 ...
 *     ?EnsureHandoffCachedData@CAnimationInterpolator@@IEAA_NM_K@Z @ 0x1802218CC (-EnsureHandoffCachedData@CAnimationInterpolator@@IEAA_NM_K@Z.c)
