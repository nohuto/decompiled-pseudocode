/*
 * XREFs of ?DwmHolographicViewerUpdate_@CompositorTracing@@QEAAXI@Z @ 0x1802543BC
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicViewerUpdate_(CompositorTracing *this, int a2)
{
    ...
    && (*(_QWORD *)(v3 + 24) & 0x400000000000LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v4 = a2;
    v7 = 4;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1802EE2A6, 0LL, 0LL, 3u, &v5);
  }
}
