/*
 * XREFs of ?GetBoundsWithLayerEffect@CLayerVisual@@QEBAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000EC78
 * Callers:
...
__int64 __fastcall CLayerVisual::GetBoundsWithLayerEffect(CVisual *a1, _OWORD *a2)
{
  ...
  *a2 = *(_OWORD *)((char *)a1 + 164);
  if ( (CVisual::GetEffectiveSize(a1, &v17, &v19) || CLayerVisual::GetAutomaticBoundsExpansion(v6))
    && (*(unsigned __int8 (__fastcall **)(CVisual *))(*(_QWORD *)a1 + 224LL))(a1) )
  {
    v8 = *(__int64 (__fastcall **)(CVisual *))(*(_QWORD *)a1 + 232LL);
    v18 = v19;
    v10 = *(_QWORD *)v8(a1);
    if ( v10 )
    {
