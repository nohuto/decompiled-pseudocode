/*
 * XREFs of ?MilCompositionEngine_GetComposedEventId@@YAJPEAUHMIL_CONNECTION__@@PEAI@Z @ 0x1800D1270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MilCompositionEngine_GetComposedEventId(struct HMIL_CONNECTION__ *a1, unsigned int *a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( ComposedEventId < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_1802D13E0, 2u, ComposedEventId, 0x8Cu, 0LL);
  }
  else
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, &dword_1802D13E0, 2u, -2147024809, 0x88u, 0LL);
  }
  return v4;
}
