/*
 * XREFs of ?InsertInOrder@CBaseExpression@@QEAAX_K@Z @ 0x180097758
 * Callers:
 ...
 *     ?InsertDependenciesInOrder@CConditionalExpression@@UEAAX_K@Z @ 0x1801C1B90 (-InsertDependenciesInOrder@CConditionalExpression@@UEAAX_K@Z.c)
 * Callees:
...
void __fastcall CBaseExpression::InsertInOrder(CBaseExpression *this, unsigned __int64 a2)
{
  ...
  if ( (int)++*((_DWORD *)this + 37) <= 1 && *((_QWORD *)this + 19) != a2 )
  {
    ...
    if ( (*((_BYTE *)this + 208) & 2) != 0 )
    {
      ...
      {
        v12 = DynArrayImpl<1>::AddMultipleAndSet(v9 + 168, 8LL, v9, &v15);
        if ( v12 < 0 )
