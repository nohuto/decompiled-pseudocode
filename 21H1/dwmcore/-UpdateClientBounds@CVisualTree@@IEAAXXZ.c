/*
 * XREFs of ?UpdateClientBounds@CVisualTree@@IEAAXXZ @ 0x1800BC600
 * Callers:
 *     ?EnsureClientInfo@CDesktopTree@@MEAAXXZ @ 0x1800BC4E0 (-EnsureClientInfo@CDesktopTree@@MEAAXXZ.c)
 *     ?EnsureClientInfo@CVisualTree@@MEAAXXZ @ 0x1800BC5D0 (-EnsureClientInfo@CVisualTree@@MEAAXXZ.c)
 * Callees:
...
void __fastcall CVisualTree::UpdateClientBounds(CVisualTree *this)
{
  ...
  v2 = 0;
  *((_DWORD *)this + 1449) = 0;
  v3 = (const struct FastRegion::Internal::CRgnData **)((char *)this + 5800);
  *((_DWORD *)this + 1448) = 0;
  *((_DWORD *)this + 1447) = 0;
  *((_DWORD *)this + 1446) = 0;
  **((_DWORD **)this + 725) = 0;
  ...
  if ( v4 - v5 )
  {
    while ( v5 != v4 )
    {
      ...
      {
        v16 = v17;
        if ( (int)v15 >= SDWORD2(v15) || SDWORD1(v15) >= SHIDWORD(v15) )
        {
          v17[0] = 0;
        }
        else
