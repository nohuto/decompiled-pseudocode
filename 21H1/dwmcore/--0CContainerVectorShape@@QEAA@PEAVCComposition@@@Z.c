/*
 * XREFs of ??0CContainerVectorShape@@QEAA@PEAVCComposition@@@Z @ 0x18016EA74
 * Callers:
 ...
 * Callees:
 *     ??0CVectorShape@@IEAA@PEAVCComposition@@@Z @ 0x18016FA64 (--0CVectorShape@@IEAA@PEAVCComposition@@@Z.c)
 */
