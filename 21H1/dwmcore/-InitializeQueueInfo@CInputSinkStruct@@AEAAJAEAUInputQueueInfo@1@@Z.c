/*
 * XREFs of ?InitializeQueueInfo@CInputSinkStruct@@AEAAJAEAUInputQueueInfo@1@@Z @ 0x1800DBB1C
 * Callers:
 *     ?InitializeQueues@CInputSinkStruct@@AEAAXXZ @ 0x1800DBAAC (-InitializeQueues@CInputSinkStruct@@AEAAXXZ.c)
 * Callees:
