/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x18026C884
 * Callers:
 ...
 *     GetInverse @ 0x18026BC64 (GetInverse.c)
 *     IsEqualMatrix @ 0x18026BE00 (IsEqualMatrix.c)
 */
