/*
 * XREFs of ?GammaConvert_64bppABGR_128bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x18021CAC0
 * Callers:
 *     <none>
 * Callees:
 *     ?Convert_sRGB_UINT16_To_scRGB_float@@YAMG@Z @ 0x180220B04 (-Convert_sRGB_UINT16_To_scRGB_float@@YAMG@Z.c)
 */
