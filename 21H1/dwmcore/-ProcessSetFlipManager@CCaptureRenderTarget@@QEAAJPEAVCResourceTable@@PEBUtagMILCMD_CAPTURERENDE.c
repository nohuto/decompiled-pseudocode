/*
 * XREFs of ?ProcessSetFlipManager@CCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CAPTURERENDERTARGET_SETFLIPMANAGER@@@Z @ 0x18018BE78
 * Callers:
        ...
        void **a3)
{
  ...
  v5 = OpenFlipProducer(a3[1], (char *)this + 1976, (char *)this + 1992);
  if ( v5 >= 0 )
  {
    v8 = *((_QWORD *)this + 247);
    ...
    v10 = v9(v8, 0LL, 0LL, (char *)this + 1984);
    v7 = v10;
    if ( v10 < 0 )
