/*
 * XREFs of ?RenderContentWorker@CVisual@@KAJPEAV1@PEAVCContent@@IIPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x180017540
 * Callers:
        ...
        const struct D2D_SIZE_F *a6)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180347AD0, 3u, v11, 0x104Du, 0LL);
  }
  else
  {
LABEL_8:
