/*
 * XREFs of ?MilPfToWic@@YAJW4Enum@MilPixelFormat@@PEAU_GUID@@@Z @ 0x180219F18
 * Callers:
 *     ?GetPixelFormat@CBitmap@@UEAAJPEAU_GUID@@@Z @ 0x180219860 (-GetPixelFormat@CBitmap@@UEAAJPEAU_GUID@@@Z.c)
