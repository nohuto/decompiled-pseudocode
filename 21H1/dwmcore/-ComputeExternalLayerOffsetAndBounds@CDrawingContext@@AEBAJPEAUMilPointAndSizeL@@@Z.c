/*
 * XREFs of ?ComputeExternalLayerOffsetAndBounds@CDrawingContext@@AEBAJPEAUMilPointAndSizeL@@@Z @ 0x180178F30
 * Callers:
        ...
        struct MilPointAndSizeL *a2)
{
  ...
  v7 = 0LL;
  CDrawingContext::GetClipBoundsWorld((__int64)this, (__int64)&v7);
