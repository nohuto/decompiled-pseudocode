/*
 * XREFs of ?MagnifierRenderTargetSetColorTransform@CChannel@@UEAAJII@Z @ 0x180153870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetColorTransform(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
