/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801867E8
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsRootProxyImpl::DebuggingStarted(__int64 a1, int a2, __int64 a3)
{
  int v6; // ebx
  __int64 v7; // rdx
  ...
  struct IMessageCallSendHost *v13[3]; // [rsp+68h] [rbp-30h] BYREF
...
LABEL_3:
  ...
  LOWORD(v11) = 1;
  return CoreUICallSend(v9, v13, 2LL, 0LL, v11, &unk_1802DB06A, a2, a3);
}
