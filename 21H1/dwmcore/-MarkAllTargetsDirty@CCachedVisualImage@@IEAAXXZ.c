/*
 * XREFs of ?MarkAllTargetsDirty@CCachedVisualImage@@IEAAXXZ @ 0x1800C8CF8
 * Callers:
 ...
 *     ?OnChanged@CCachedVisualImage@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800C8CC0 (-OnChanged@CCachedVisualImage@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
