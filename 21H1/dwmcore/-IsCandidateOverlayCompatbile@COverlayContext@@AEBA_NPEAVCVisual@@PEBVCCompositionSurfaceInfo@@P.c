/*
 * XREFs of ?IsCandidateOverlayCompatbile@COverlayContext@@AEBA_NPEAVCVisual@@PEBVCCompositionSurfaceInfo@@PEAVISwapChainRealization@@AEBUDXGI_MULTIPLANE_OVERLAY_ATTRIBUTES@@W4DXGI_MODE_ROTATION@@I_N@Z @ 0x18018079C
 * Callers:
        ...
        bool a8)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct ISwapChainRealization *))(*(_QWORD *)a4 + 56LL))(a4)
    ...
    && (a8 && *((_BYTE *)this + 11427) || *((_BYTE *)this + 11417) || a7 > 2) )
  {
    return 1;
  }
  return v12;
