/*
 * XREFs of ?GetControlPointCount@CPathData@@QEBAIXZ @ 0x180222904
 * Callers:
 *     ?IsEmpty@CPathSegmentsShape@@UEBA_NXZ @ 0x1802604C0 (-IsEmpty@CPathSegmentsShape@@UEBA_NXZ.c)
 * Callees:
 *     ??9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z @ 0x1802223A8 (--9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z.c)
