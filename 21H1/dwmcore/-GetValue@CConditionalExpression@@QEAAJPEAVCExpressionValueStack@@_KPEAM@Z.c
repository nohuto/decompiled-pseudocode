/*
 * XREFs of ?GetValue@CConditionalExpression@@QEAAJPEAVCExpressionValueStack@@_KPEAM@Z @ 0x1801C1A94
 * Callers:
 ...
 *     ?Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z @ 0x180216B40 (-Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z.c)
 * Callees:
 ...
 *     ?GetDebugTargetInfo@CConditionalExpression@@AEBA?AUDebugTargetInfo@1@XZ @ 0x1801C19C4 (-GetDebugTargetInfo@CConditionalExpression@@AEBA-AUDebugTargetInfo@1@XZ.c)
        ...
        float *a4)
{
  ...
  v4 = *(_QWORD *)this;
  *a4 = 0.0;
  v9 = (*(__int64 (__fastcall **)(CConditionalExpression *, struct CExpressionValueStack *, wchar_t *, __int64 *))(v4 + 248))(
         this,
         a2,
         a3,
         &v19);
  ...
  else
  {
    ...
    *a4 = *v13;
    if ( (*(_DWORD *)(v14 + 4) & 0x40000000) != 0 )
    {
      ...
      AnimationLoggingManagerNoRef = (wchar_t *)CBaseExpression::GetAnimationLoggingManagerNoRef(this);
