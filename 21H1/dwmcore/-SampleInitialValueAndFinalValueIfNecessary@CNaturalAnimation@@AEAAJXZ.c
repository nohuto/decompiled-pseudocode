/*
 * XREFs of ?SampleInitialValueAndFinalValueIfNecessary@CNaturalAnimation@@AEAAJXZ @ 0x1801DC970
 * Callers:
 ...
 *     ?ResolveTargetNoRef@CBaseExpression@@IEAAPEAVCResource@@XZ @ 0x1800CA1F0 (-ResolveTargetNoRef@CBaseExpression@@IEAAPEAVCResource@@XZ.c)
