/*
 * XREFs of ?CreateWithContentRect@CSurfaceDrawListBrush@@SAJAEBVCDrawListBitmap@@USamplerMode@@AEBUD2D_RECT_F@@PEAPEAV1@@Z @ 0x180036350
 * Callers:
        ...
        __int64 *a4)
{
  ...
  if ( v13 || (v15 = DefaultHeap::Alloc(0xB0uLL), (v13 = v15) != 0LL) )
  {
    v22 = *a2;
    v23 = *((_BYTE *)a2 + 2);
    v15 = (_QWORD *)CSurfaceDrawListBrush::CSurfaceDrawListBrush(v13, a1, &v22, v25);
  }
  *a4 = (__int64)v15;
  if ( v15 )
  {
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v13, 0LL, 0, -2147024882, 0x1Eu, 0LL);
  }
  return v8;
}
