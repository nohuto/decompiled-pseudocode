/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x18026C1B8
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x18026CB80 (s_TransformPointByMatrix.c)
 */
