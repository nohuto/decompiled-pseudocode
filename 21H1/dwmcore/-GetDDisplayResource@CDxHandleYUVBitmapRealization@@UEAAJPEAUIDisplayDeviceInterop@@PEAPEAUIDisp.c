/*
 * XREFs of ?GetDDisplayResource@CDxHandleYUVBitmapRealization@@UEAAJPEAUIDisplayDeviceInterop@@PEAPEAUIDisplaySurface@Core@Display@Devices@Windows@@PEAI@Z @ 0x1802668A0
 * Callers:
 *     ?GetDDisplayResource@CDxHandleYUVBitmapRealization@@$4PPPPPPPM@A@EAAJPEAUIDisplayDeviceInterop@@PEAPEAUIDisplaySurface@Core@Display@Devices@Windows@@PEAI@Z @ 0x1800F0770 (-GetDDisplayResource@CDxHandleYUVBitmapRealization@@$4PPPPPPPM@A@EAAJPEAUIDisplayDeviceInterop@@.c)
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  v9 = 0;
  if ( *((_QWORD *)this - 16) && *((_DWORD *)this - 30) == dword_18034D640 )
  {
LABEL_9:
    if ( a4 )
  ...
  else
  {
    ...
    else
    {
      ...
      {
        v19 = (char *)hObject;
        *((_DWORD *)this - 30) = dword_18034D640;
