/*
 * XREFs of ?ResolveSourceReference@CExpression@@UEAAJIPEAPEAVCResource@@@Z @ 0x18002D4D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CExpression::ResolveSourceReference(CExpression *this, unsigned int a2, struct CResource **a3)
{
  ...
  *a3 = v3;
  ...
  {
    v4 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0, &dword_18028C560, 2u, -2147467259, 0x14Cu, 0LL);
  }
  return v4;
}
