/*
 * XREFs of ?RealizeBitmaps@CPrimitiveGroupDrawListGenerator@@QEAAJPEBVCDrawingContext@@@Z @ 0x1800356C8
 * Callers:
        ...
        const struct CDrawingContext *a2)
{
  ...
  v4 = 0;
  if ( !(unsigned __int8)RenderTargetInfo::operator==((char *)this + 32, (char *)a2 + 56) )
  {
