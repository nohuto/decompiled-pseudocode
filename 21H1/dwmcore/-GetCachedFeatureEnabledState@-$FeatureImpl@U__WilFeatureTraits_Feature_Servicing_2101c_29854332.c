/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_2101c_29854332@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800E4918
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_2101c_29854332>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_2101c_29854332>::GetCurrentFeatureEnabledState(
      v6,
      &v15,
      &v14);
    v7 = *a2;
    ...
    if ( (v9 & 2) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_180349614
        || (v12 = 3, v13 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_180349648, &v12, 0x10uLL)) )
      {
