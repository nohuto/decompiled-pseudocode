/*
 * XREFs of ??1CChannelContext@@UEAA@XZ @ 0x180090404
 * Callers:
...
void __fastcall CChannelContext::~CChannelContext(CChannelContext *this)
{
  ...
  *(_QWORD *)this = &CChannelContext::`vftable';
  ...
  ReleaseInterface<CProcessAttribution>((CDrawListEntry **)this + 5);
  v9 = *((_QWORD *)this + 4);
  if ( v9 )
  {
