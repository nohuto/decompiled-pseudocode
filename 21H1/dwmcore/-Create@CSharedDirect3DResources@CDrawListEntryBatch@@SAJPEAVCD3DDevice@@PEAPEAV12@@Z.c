/*
 * XREFs of ?Create@CSharedDirect3DResources@CDrawListEntryBatch@@SAJPEAVCD3DDevice@@PEAPEAV12@@Z @ 0x1800A2128
 * Callers:
 ...
 *     ??0CSharedDirect3DResources@CDrawListEntryBatch@@AEAA@XZ @ 0x1800A2F9C (--0CSharedDirect3DResources@CDrawListEntryBatch@@AEAA@XZ.c)
 */
