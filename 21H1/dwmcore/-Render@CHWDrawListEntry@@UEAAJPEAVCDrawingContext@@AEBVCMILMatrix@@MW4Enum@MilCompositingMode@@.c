/*
 * XREFs of ?Render@CHWDrawListEntry@@UEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@MW4Enum@MilCompositingMode@@@Z @ 0x180055CD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ApplyState@CD2DTarget@@QEAAXPEAVCD2DContext@@@Z @ 0x1800A3640 (-ApplyState@CD2DTarget@@QEAAXPEAVCD2DContext@@@Z.c)
 ...
 *     ??$move_backward@V?$move_iterator@PEAUFrameData@CDrawListEntry@@@std@@V?$checked_array_iterator@PEAUFrameData@CDrawListEntry@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAUFrameData@CDrawListEntry@@@stdext@@V?$move_iterator@PEAUFrameData@CDrawListEntry@@@0@0V12@@Z @ 0x1801A5840 (--$move_backward@V-$move_iterator@PEAUFrameData@CDrawListEntry@@@std@@V-$checked_array_iterator@.c)
 ...
 *     ?UpdatePremultipliedColor@CDrawListPrimitive@@QEAAXAEBU_D3DCOLORVALUE@@@Z @ 0x1801A7894 (-UpdatePremultipliedColor@CDrawListPrimitive@@QEAAXAEBU_D3DCOLORVALUE@@@Z.c)
...
LABEL_53:
    ...
    if ( (unsigned __int8)CMILMatrix::Is2DAxisAlignedPreserving<1>(*(_QWORD *)(a1 + 64) + 8LL) )
    {
      ...
      std::deque<CMegaRect>::emplace_back<CHWDrawListEntry * &>(v48 + 88, &v102);
      v28 = 0;
    }
    goto LABEL_53;
  }
