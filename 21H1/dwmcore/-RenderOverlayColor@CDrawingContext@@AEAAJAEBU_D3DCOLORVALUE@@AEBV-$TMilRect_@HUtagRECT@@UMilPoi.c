/*
 * XREFs of ?RenderOverlayColor@CDrawingContext@@AEAAJAEBU_D3DCOLORVALUE@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18017C81C
 * Callers:
...
__int64 __fastcall CDrawingContext::RenderOverlayColor(struct CDrawingContext *a1, __int64 a2, __int64 a3)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x1312u, 0LL);
  }
  else
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x1317u, 0LL);
    }
    else
    {
      *(_QWORD *)&v16 = 1LL;
      *((_QWORD *)&v16 + 1) = v19;
      v12 = CDrawingContext::FillRectanglesWithSolidColor(a1, &v16, a2);
      v9 = v12;
      if ( v12 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x131Au, 0LL);
    }
