/*
 * XREFs of ?GetUnOccludedWorldShape@CRegionShape@@UEBAJV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@PEAPEAVCShape@@@Z @ 0x1802604E0
 * Callers:
 *     <none>
 * Callees:
        ...
        CRectanglesShape **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    if ( v33 == (__int128 *)v4
      || (v29 = CRectanglesShape::BuildFromRectFs(v26, (__int64)v33, (v4 - (char *)v33) >> 4), v5 = v29, v29 >= 0) )
    {
      v28 = 0LL;
      *v36 = v26;
      v26 = 0LL;
  ...
  if ( v27 )
    std::_Deallocate<16,0>(v27, (v8 - (char *)v27) & 0xFFFFFFFFFFFFFFF0uLL);
  return v5;
}
