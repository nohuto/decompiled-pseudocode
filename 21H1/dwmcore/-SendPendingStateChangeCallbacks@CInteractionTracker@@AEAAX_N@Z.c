/*
 * XREFs of ?SendPendingStateChangeCallbacks@CInteractionTracker@@AEAAX_N@Z @ 0x1801CF5F8
 * Callers:
...
void __fastcall CInteractionTracker::SendPendingStateChangeCallbacks(CInteractionTracker *this, char a2)
{
  ...
  _BYTE v51[64]; // [rsp+168h] [rbp+50h] BYREF
      ...
      if ( v11 )
      {
        ...
        if ( v12 )
        {
          ...
          if ( !v13 )
          {
            ...
            {
              v23 = (__int128 *)CInteractionTracker::CalculateInertiaCallbackValues((__int64)this, (__int64)v51);
              v35 = *v23;
              v22 = v23[2];
              v36 = v23[1];
            }
            ...
            LOWORD(v33) = 1;
            CoreUICallSend(v5, v48, 2LL, 8LL, v33, &unk_1802CFAEB, (unsigned int)&v43, *((float *)&v35 + 3));
            if ( *((_BYTE *)this + 626) )
              *((_BYTE *)this + 626) = 0;
            goto LABEL_21;
          }
