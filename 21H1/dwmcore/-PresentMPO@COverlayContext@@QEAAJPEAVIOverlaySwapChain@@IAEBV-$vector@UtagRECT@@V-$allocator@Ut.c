/*
 * XREFs of ?PresentMPO@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x1800E54C4
 * Callers:
          ...
          do
          {
            ...
            else
            {
              ...
              *(_DWORD *)&v21[*((_QWORD *)this + 914) + 212] = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v23
              ...
              if ( v24 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xA1Eu, 0LL);
                goto LABEL_68;
              }
              v26 = *((_QWORD *)this + 914);
              v21 = v57;
...
LABEL_53:
        ...
        {
          v16 = -2003304309;
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2003304309, 0xAA9u, v12);
          goto LABEL_67;
        }
...
LABEL_64:
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v42, 0LL, 0, v16, 0xA9Eu, 0LL);
          goto LABEL_68;
        }
LABEL_67:
