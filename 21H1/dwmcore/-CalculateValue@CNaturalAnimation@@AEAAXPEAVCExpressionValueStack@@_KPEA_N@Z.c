/*
 * XREFs of ?CalculateValue@CNaturalAnimation@@AEAAXPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801DB1CC
 * Callers:
 ...
 * Callees:
 *     ?GetTracingCookie@CBaseExpression@@QEBAIXZ @ 0x1800C1AC4 (-GetTracingCookie@CBaseExpression@@QEBAIXZ.c)
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U?$_tlgWrapperByVal@$00@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3333333AEBU?$_tlgWrapperByVal@$00@@@Z @ 0x1801DAE00 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U-$_tlgWrapperByVal@$00@@@-$_tlgWriteTemp.c)
 ...
 *     ?GenerateVector3Basis@CNaturalAnimation@@AEAA_NXZ @ 0x1801DB888 (-GenerateVector3Basis@CNaturalAnimation@@AEAA_NXZ.c)
 ...
 *     ?IsInMotion@CScalarForceEvaluator@@QEBA_NXZ @ 0x180217658 (-IsInMotion@CScalarForceEvaluator@@QEBA_NXZ.c)
 *     ?Update@CVector3Force@@QEAA?AUD2DVector3@@MPEAVCExpressionValueStack@@_K@Z @ 0x1802177C8 (-Update@CVector3Force@@QEAA-AUD2DVector3@@MPEAVCExpressionValueStack@@_K@Z.c)
 *     ?ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z @ 0x1802179AC (-ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z.c)
    ...
    if ( v8 == 18 || v8 == 35 || v8 == 52 )
    {
      ...
      *a4 = v14;
      ...
      if ( *(int *)(*((_QWORD *)this + 38) + 4LL) < 0 )
      {
        ...
        if ( (unsigned int)dword_180346EF0 > 4 && (qword_180346F00 & 4) != 0 && (qword_180346F08 & 4) == qword_180346F08 )
        {
          v26[0] = *a4;
          v30 = v22[2];
          v31 = v22[1];
