/*
 * XREFs of ?DrawImage@COcclusionContext@@QEAAJPEAVCResource@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x1800C5F6C
 * Callers:
...
__int64 __fastcall COcclusionContext::DrawImage(COcclusionContext *a1, struct IUnknown *a2, float *a3, char a4)
{
  ...
  if ( !*((_DWORD *)a1 + 365) && COcclusionContext::DoesImageOcclude(a1, a2, a4 & 1) )
  {
    ...
    v4 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x49Bu, 0LL);
  }
  return v4;
}
