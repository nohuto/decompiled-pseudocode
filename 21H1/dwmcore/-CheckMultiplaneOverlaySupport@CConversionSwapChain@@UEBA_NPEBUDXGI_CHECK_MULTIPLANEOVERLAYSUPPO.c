/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CConversionSwapChain@@UEBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x18024F2A0
 * Callers:
 *     ?CheckMultiplaneOverlaySupport@CConversionSwapChain@@$4PPPPPPPM@A@EBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x1800EF240 (-CheckMultiplaneOverlaySupport@CConversionSwapChain@@$4PPPPPPPM@A@EBA_NPEBUDXGI_CHECK_MULTIPLANE.c)
 * Callees:
 *     ??8@YA_NAEBU_LUID@@0@Z @ 0x1800358E8 (--8@YA_NAEBU_LUID@@0@Z.c)
