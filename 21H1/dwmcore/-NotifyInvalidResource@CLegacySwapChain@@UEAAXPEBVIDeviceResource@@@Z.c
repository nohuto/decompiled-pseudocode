/*
 * XREFs of ?NotifyInvalidResource@CLegacySwapChain@@UEAAXPEBVIDeviceResource@@@Z @ 0x18024AD60
 * Callers:
 ...
 *     ?ReleaseD3D12Resources@CLegacySwapChain@@IEAAXXZ @ 0x18024B148 (-ReleaseD3D12Resources@CLegacySwapChain@@IEAAXXZ.c)
 */
