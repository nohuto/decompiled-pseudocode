/*
 * XREFs of ?Present@CDDARenderTarget@@UEAAJ_N@Z @ 0x18019D1EC
 * Callers:
 *     ?Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800ED420 (-Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
