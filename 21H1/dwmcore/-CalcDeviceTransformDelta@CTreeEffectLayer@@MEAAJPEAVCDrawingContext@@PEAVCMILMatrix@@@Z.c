/*
 * XREFs of ?CalcDeviceTransformDelta@CTreeEffectLayer@@MEAAJPEAVCDrawingContext@@PEAVCMILMatrix@@@Z @ 0x18000DF50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILMatrix *a3)
{
  ...
  v3 = (char *)this + 128;
  v7 = 0;
  CMatrixStack::Top((struct CDrawingContext *)((char *)a2 + 408), (CTreeEffectLayer *)((char *)this + 128));
  ...
  else
  {
    ...
    *(_QWORD *)&v34 = 0LL;
    *((_QWORD *)&v34 + 1) = *(_QWORD *)v28;
    CMILMatrix::Transform2DBoundsHelper<1>(v3, &v34, (char *)this + 196);
