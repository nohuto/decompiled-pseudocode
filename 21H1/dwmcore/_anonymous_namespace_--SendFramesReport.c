/*
 * XREFs of _anonymous_namespace_::SendFramesReport @ 0x180071CC8
 * Callers:
 ...
 *     _anonymous_namespace_::PackedStringArrayBuilder::Append @ 0x180072660 (_anonymous_namespace_--PackedStringArrayBuilder--Append.c)
 ...
 *     ?EncodeBlock@Base853Encoder@@AEAAXXZ @ 0x1800734B0 (-EncodeBlock@Base853Encoder@@AEAAXXZ.c)
 *     ?EnsureZeroesAreSerialized@Base853Encoder@@AEAAXXZ @ 0x1800736EC (-EnsureZeroesAreSerialized@Base853Encoder@@AEAAXXZ.c)
 *     ??$_Lbound@_K@?$_Tree@V?$_Tmap_traits@_KIU?$less@_K@std@@V?$allocator@U?$pair@$$CB_KI@std@@@2@$0A@@std@@@std@@IEBAPEAU?$_Tree_node@U?$pair@$$CB_KI@std@@PEAX@1@AEB_K@Z @ 0x180073780 (--$_Lbound@_K@-$_Tree@V-$_Tmap_traits@_KIU-$less@_K@std@@V-$allocator@U-$pair@$$CB_KI@std@@@2@$0.c)
 *     _anonymous_namespace_::QpcToFileTimeAndGetCurrentFileTime @ 0x180088CD0 (_anonymous_namespace_--QpcToFileTimeAndGetCurrentFileTime.c)
 ...
 *     ??$_Try_emplace@AEB_K$$V@?$map@_KIU?$less@_K@std@@V?$allocator@U?$pair@$$CB_KI@std@@@2@@std@@QEAA?AU?$pair@V?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KI@std@@@std@@@std@@@std@@_N@1@AEB_K@Z @ 0x1800B108C (--$_Try_emplace@AEB_K$$V@-$map@_KIU-$less@_K@std@@V-$allocator@U-$pair@$$CB_KI@std@@@2@@std@@QEA.c)
 *     ??$emplace_hint@AEBUpiecewise_construct_t@std@@V?$tuple@AEB_K@2@V?$tuple@$$V@2@@?$_Tree@V?$_Tmap_traits@_KIU?$less@_K@std@@V?$allocator@U?$pair@$$CB_KI@std@@@2@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KI@std@@@std@@@std@@@1@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KI@std@@@std@@@std@@@1@AEBUpiecewise_construct_t@1@$$QEAV?$tuple@AEB_K@1@$$QEAV?$tuple@$$V@1@@Z @ 0x1800B10F4 (--$emplace_hint@AEBUpiecewise_construct_t@std@@V-$tuple@AEB_K@2@V-$tuple@$$V@2@@-$_Tree@V-$_Tmap.c)
 ...
 *     ??$_Insert_range@PEAD@?$vector@DV?$allocator@D@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@D@std@@@std@@@1@PEAD1Uforward_iterator_tag@1@@Z @ 0x1800C1540 (--$_Insert_range@PEAD@-$vector@DV-$allocator@D@std@@@std@@AEAAXV-$_Vector_const_iterator@V-$_Vec.c)
 *     ??$_Emplace_reallocate@D@?$vector@DV?$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z @ 0x1800C1680 (--$_Emplace_reallocate@D@-$vector@DV-$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z.c)
 *     std::map__anonymous_namespace_::AnimationId_unsigned_int_A0xd209ef2d::AnimationId::LessThan_std::allocator_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int_____::_Try_emplace__anonymous_namespace_::AnimationId_const_&_ @ 0x1800C4EE4 (std--map__anonymous_namespace_--AnimationId_unsigned_int_A0xd209ef2d--AnimationId--LessThan_std-.c)
 ...
 *     ??$_Erase_tree@V?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@std@@@std@@@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@@std@@@std@@QEAAXAEAV?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@1@@Z @ 0x1800C9478 (--$_Erase_tree@V-$allocator@U-$_Tree_node@U-$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@st.c)
 *     ??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x1800CA5F4 (--E-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@V-$basic_string@GU-$char_.c)
 *     ??$_Erase_tree@V?$allocator@U?$_Tree_node@U?$pair@QEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@I@std@@PEAX@std@@@std@@@?$_Tree_val@U?$_Tree_simple_types@U?$pair@QEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@I@std@@@std@@@std@@QEAAXAEAV?$allocator@U?$_Tree_node@U?$pair@QEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@I@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@QEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@I@std@@PEAX@1@@Z @ 0x1800CB494 (--$_Erase_tree@V-$allocator@U-$_Tree_node@U-$pair@QEBV-$basic_string@GU-$char_traits@G@std@@V-$a.c)
 ...
 *     _anonymous_namespace_::PackedStringArrayBuilder::PackedStringArrayBuilder @ 0x1800CEB78 (_anonymous_namespace_--PackedStringArrayBuilder--PackedStringArrayBuilder.c)
...
__int64 __fastcall anonymous_namespace_::SendFramesReport(_QWORD *a1)
{
  ...
  *(_WORD *)(v7 + 24) = 257;
  ...
  while ( v10 != v9 )
  {
    ...
    while ( !*((_BYTE *)v13 + 25) );
    if ( v12 == (_QWORD *)v7 || (unsigned __int64)v11 < v12[4] )
    {
LABEL_9:
  ...
  if ( v18 != *(_QWORD ***)(*v84 + 120LL) )
  {
    ...
    do
    {
      ...
      {
        v79 = &v76;
        v22 = *(_QWORD *)std::_Tree<std::_Tmap_traits<unsigned __int64,unsigned int,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,unsigned int>>,0>>::emplace_hint<std::piecewise_construct_t const &,std::tuple<unsigned __int64 const &>,std::tuple<>>(
                           (unsigned int)&v81,
                           (unsigned int)&v92,
                           v22,
                           v23,
      ...
      *(_DWORD *)(v22 + 40) = v16++;
      ...
      if ( v5 == v4 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v4, v72);
        v5 = v75;
        v24 = v74;
      }
      else
      ...
      if ( v5 == v29 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v29, v72);
        v5 = v75;
        v30 = v74;
      }
      else
      ...
      if ( v5 == v31 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v31, v72);
        v5 = v75;
        v32 = v74;
      }
      else
      ...
      if ( v5 == v32 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v32, v72);
        v5 = v75;
        v33 = v74;
      }
      else
      ...
      if ( v5 == v33 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v33, v72);
        v5 = v75;
        v34 = v74;
      }
      else
      ...
      if ( v5 == v34 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v34, v72);
        v5 = v75;
        v35 = v74;
      }
      else
      ...
      if ( v5 == v35 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v35, v72);
        v5 = v75;
        v36 = v74;
      }
      else
      ...
      if ( v77 )
      {
        v54 = v83[0];
        v55 = v83[0];
        v56 = *(__int64 **)(v83[0] + 8LL);
        if ( *((_BYTE *)v56 + 25) )
          goto LABEL_81;
        do
        {
          if ( v56[4] < (unsigned __int64)v77 )
          {
            v56 = (__int64 *)v56[2];
          }
          else
        ...
        while ( !*((_BYTE *)v56 + 25) );
        if ( v55 == v83[0] || (unsigned __int64)v77 < *(_QWORD *)(v55 + 32) )
        {
LABEL_81:
      ...
      if ( v5 == v36 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v36, v72);
        v5 = v75;
        v38 = v74;
      }
      else
      ...
      if ( v5 == v38 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v38, v72);
        v40 = v74;
      }
      else
      {
      ...
      *v41 = 0;
      ...
      if ( v102 >= 0x10 )
        v43 = (_QWORD *)v100[0];
      std::vector<char>::_Insert_range<char *>(&v73, v40, v43, v44);
      v5 = v75;
      v45 = v74;
      v72[0] = 0;
      if ( v75 == v74 )
      {
        std::vector<char>::_Emplace_reallocate<char>(&v73, v74, v72);
        v5 = v75;
        v4 = v74;
      }
      else
  ...
  while ( j != v49 )
  {
    std::map<unsigned __int64,unsigned int>::_Try_emplace<unsigned __int64 const &,>(&v81, &v73, j + 4);
    Base853Encoder::AppendVarInt((Base853Encoder *)&v86, *((_DWORD *)v73 + 10));
    Base853Encoder::AppendVarInt((Base853Encoder *)&v86, *((_DWORD *)j + 10));
    v80 = j[6];
    if ( v80 )
    {
      std::map<std::wstring const *,unsigned int>::_Try_emplace<std::wstring const * const &,>(v83, &v97, &v80);
      v61 = *((_DWORD *)v97 + 10) + 1;
    }
    else
    {
  ...
  *v57 = 0;
  ...
  if ( (unsigned int)dword_180346E80 > 5 && (unsigned __int8)tlgKeywordOn(&dword_180346E80, 0x400000000000LL) )
  {
    v66 = v103;
