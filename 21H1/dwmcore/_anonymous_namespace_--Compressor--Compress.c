/*
 * XREFs of _anonymous_namespace_::Compressor::Compress @ 0x1800CB110
 * Callers:
 ...
 *     ?_Buy_raw@?$vector@EV?$allocator@E@std@@@std@@AEAAX_K@Z @ 0x1800CB32C (-_Buy_raw@-$vector@EV-$allocator@E@std@@@std@@AEAAX_K@Z.c)
...
__int64 __fastcall anonymous_namespace_::Compressor::Compress(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 16) = 0LL;
  ...
  v11 = *(void **)(a1 + 8);
  v12 = *(_BYTE **)a1;
  v13 = (unsigned __int64)v11 - *(_QWORD *)a1;
  if ( input_used < v13 )
  {
    LODWORD(v11) = (_DWORD)v12 + input_used;
    *(_QWORD *)(a1 + 8) = &v12[input_used];
  }
  else if ( input_used > v13 )
  {
    if ( input_used <= *(_QWORD *)(a1 + 16) - (_QWORD)v12 )
    {
      v17 = &v12[input_used];
      memset_0(v11, 0, &v12[input_used] - (_BYTE *)v11);
...
LABEL_22:
  ...
  {
    if ( v6 <= *(_QWORD *)(a1 + 16) - (_QWORD)v14 )
    {
      v18 = &v14[v6];
      memset_0(*(void **)(a1 + 8), 0, (size_t)&v14[v6 - *(_QWORD *)(a1 + 8)]);
      *(_QWORD *)(a1 + 8) = v18;
    }
    else
    {
      std::vector<unsigned char>::_Resize_reallocate<std::_Value_init_tag>(a1, v6);
    }
  }
