/*
 * XREFs of ?ProcessKernelTokens@CGlobalSurfaceManager@@AEAAJXZ @ 0x18008CC18
 * Callers:
 *     ?s_TokenThreadMain@CGlobalSurfaceManager@@CAKPEAX@Z @ 0x1800D43E0 (-s_TokenThreadMain@CGlobalSurfaceManager@@CAKPEAX@Z.c)
 * Callees:
  ...
  if ( !*((_BYTE *)this + 496) )
  {
    while ( 1 )
    {
      ...
      if ( !*((_BYTE *)this + 496) )
      {
        ...
        v18 = (struct _RTL_CRITICAL_SECTION *)((char *)g_pComposition + 184);
