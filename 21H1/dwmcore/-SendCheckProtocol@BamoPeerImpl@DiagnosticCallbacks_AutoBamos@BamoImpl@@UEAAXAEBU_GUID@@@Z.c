/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x18016B1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  LOWORD(v6) = 0;
  v9 = v2;
  v5 = CoreUICallSend(v4, v8, 2LL, 1LL, v6, &unk_1802DB085, (unsigned int)&v9, v7);
  if ( v5 < 0 )
  {
