/*
 * XREFs of ?TelemetryRecordInputActivity@CPartitionVerticalBlankScheduler@@UEAAXI_K@Z @ 0x18001B950
 * Callers:
 *     <none>
 * Callees:
 *     ?Update@CMouseKeyboardInfo@CTelemetryTouchLatencyAnalysis@@QEAAXI_K0@Z @ 0x18001B9EC (-Update@CMouseKeyboardInfo@CTelemetryTouchLatencyAnalysis@@QEAAXI_K0@Z.c)
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_180346E48 > 5 && (qword_180346E58 & 8) != 0 && (qword_180346E60 & 8) == qword_180346E60 )
  {
    ...
    v16 = 8LL;
    v14 = 4LL;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_180346E48, (int)&dword_1802E57A6, 0, 0, 5u, &v12);
  }
