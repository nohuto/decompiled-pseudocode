/*
 * XREFs of ??$_Emplace_reallocate@AEAUtagRECT@@@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@QEAAPEAUtagRECT@@QEAU2@AEAU2@@Z @ 0x1800E77F8
 * Callers:
 ...
 *     ?push_back@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@QEAAXAEBUtagRECT@@@Z @ 0x1800EB678 (-push_back@-$vector@UtagRECT@@V-$allocator@UtagRECT@@@std@@@std@@QEAAXAEBUtagRECT@@@Z.c)
 * Callees:
