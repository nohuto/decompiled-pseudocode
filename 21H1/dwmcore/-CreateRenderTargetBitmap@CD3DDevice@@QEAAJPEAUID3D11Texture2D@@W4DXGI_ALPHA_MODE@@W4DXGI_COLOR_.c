/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x18023F978
 * Callers:
        ...
        struct IRenderTargetBitmap **a7)
{
  ...
  unsigned __int64 v23; // [rsp+60h] [rbp-51h] BYREF
  int v24; // [rsp+68h] [rbp-49h]
  int v25; // [rsp+6Ch] [rbp-45h]
  int v26; // [rsp+70h] [rbp-41h]
  __int64 v27; // [rsp+74h] [rbp-3Dh]
  int v28; // [rsp+7Ch] [rbp-35h]
  _BYTE v29[16]; // [rsp+80h] [rbp-31h] BYREF
  unsigned int v30; // [rsp+90h] [rbp-21h]
  char v31; // [rsp+A0h] [rbp-11h]

  v22[0] = 0LL;
  v27 = 0LL;
  v28 = 0;
  *a7 = 0LL;
  (*(void (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)a2 + 80LL))(a2, v29);
  if ( (v31 & 0x20) == 0 )
  {
    v12 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802F1898, 2u, -2147024809, 0x60Du, 0LL);
    goto LABEL_13;
  }
  v22[1] = __PAIR64__(a3, v30);
  v23 = __PAIR64__(a3, v30);
  v13 = 1;
  v24 = 1119879168;
  v25 = 1119879168;
  if ( (v31 & 8) == 0 )
  ...
  v26 = v13;
  LODWORD(v20) = a4;
  v15 = CDeviceTextureTarget::Create(v14, a2, (__int64)v29, (__int64)&v23, v20, a5, a6, 0, v22);
  v12 = v15;
  if ( v15 < 0 )
  {
    v21 = 1572;
  ...
  if ( v15 < 0 )
  {
    v21 = 1576;
LABEL_12:
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802F1898, 2u, v15, v21, 0LL);
  }
LABEL_13:
