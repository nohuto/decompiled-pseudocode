/*
 * XREFs of ?RegisterSourcesForOwner@CExpression@@UEAAJXZ @ 0x1800968B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CExpression::RegisterSourcesForOwner(CExpression *this)
{
  ...
  if ( *((_DWORD *)this + 104) )
  {
    while ( 1 )
    {
      ...
      if ( v6 >= 0 )
        break;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0, v6, 0x196u, 0LL);
LABEL_9:
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0, v7, 0x16Du, 0LL);
