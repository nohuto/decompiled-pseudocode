/*
 * XREFs of ?NotifyRenderedRect@CDDARenderTarget@@IEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18019D11C
 * Callers:
...
__int64 __fastcall CDDARenderTarget::NotifyRenderedRect(__int64 a1, __int64 a2)
{
  ...
  v6 = 0LL;
  CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)(a1 + 200), a2, (float *)&v6);
  v3 = PixelAlign(v8, &v6);
  v4 = *(_QWORD *)(a1 + 152);
  v7 = *(_OWORD *)v3;
