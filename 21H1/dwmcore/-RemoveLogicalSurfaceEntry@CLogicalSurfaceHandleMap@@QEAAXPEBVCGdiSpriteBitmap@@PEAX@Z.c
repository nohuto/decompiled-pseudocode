/*
 * XREFs of ?RemoveLogicalSurfaceEntry@CLogicalSurfaceHandleMap@@QEAAXPEBVCGdiSpriteBitmap@@PEAX@Z @ 0x1800C6C50
 * Callers:
 *     ??1CRedirectedGDISurface@@MEAA@XZ @ 0x1800C6AA4 (--1CRedirectedGDISurface@@MEAA@XZ.c)
 * Callees:
 *     <none>
 */
