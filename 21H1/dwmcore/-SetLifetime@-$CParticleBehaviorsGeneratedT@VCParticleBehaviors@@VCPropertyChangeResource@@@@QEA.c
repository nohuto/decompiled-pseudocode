/*
 * XREFs of ?SetLifetime@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleScalarBehavior@@@Z @ 0x18017558C
 * Callers:
...
__int64 __fastcall CParticleBehaviorsGeneratedT<CParticleBehaviors,CPropertyChangeResource>::SetLifetime(
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[19] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x30Cu, 0LL);
    }
    else
    {
