/*
 * XREFs of _anonymous_namespace_::CanAddThisColumnVectorToMatrix @ 0x18022D440
 * Callers:
 ...
 *     _anonymous_namespace_::VectorInsideAngleThreshold @ 0x1802309F4 (_anonymous_namespace_--VectorInsideAngleThreshold.c)
 */
