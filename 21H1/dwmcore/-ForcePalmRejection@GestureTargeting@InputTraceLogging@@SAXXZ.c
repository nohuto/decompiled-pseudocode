/*
 * XREFs of ?ForcePalmRejection@GestureTargeting@InputTraceLogging@@SAXXZ @ 0x18022A02C
 * Callers:
...
void __fastcall InputTraceLogging::GestureTargeting::ForcePalmRejection(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802EC1DF, 0LL, 0LL, 2u, &v2);
  }
}
