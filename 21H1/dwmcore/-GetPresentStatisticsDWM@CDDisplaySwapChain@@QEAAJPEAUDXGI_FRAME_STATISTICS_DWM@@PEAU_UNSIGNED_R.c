/*
 * XREFs of ?GetPresentStatisticsDWM@CDDisplaySwapChain@@QEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@PEAU_UNSIGNED_RATIO@@@Z @ 0x18023AE20
 * Callers:
        ...
        struct _UNSIGNED_RATIO *a3)
{
  ...
  if ( wil::operator!=<IDXGISwapChainDWM1,wil::err_returncode_policy>((_QWORD *)this + 23) )
  {
    ...
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x30Eu, 0LL);
      }
      else
      {
        ...
        if ( v13 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x30Fu, 0LL);
        }
        else
        {
          v15 = v17;
  ...
  {
    v10 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0, -2003304442, 0x31Du, 0LL);
  }
  return v10;
}
