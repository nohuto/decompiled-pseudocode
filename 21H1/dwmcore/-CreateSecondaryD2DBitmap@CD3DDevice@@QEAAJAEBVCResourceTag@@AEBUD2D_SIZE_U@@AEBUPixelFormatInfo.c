/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD3DDevice@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x18002B328
 * Callers:
 ...
 *     ?GetCompatibleTextureFormat@CD3DDevice@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x18002B99C (-GetCompatibleTextureFormat@CD3DDevice@@QEBA-AW4DXGI_FORMAT@@W42@@Z.c)
...
LABEL_16:
    v24 = v20;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_1802ADB18, 2u, v24, v25, 0LL);
  }
