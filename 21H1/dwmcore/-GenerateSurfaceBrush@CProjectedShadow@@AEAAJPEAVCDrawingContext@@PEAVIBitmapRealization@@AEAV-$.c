/*
 * XREFs of ?GenerateSurfaceBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVIBitmapRealization@@AEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAVCSurfaceBrush@@@Z @ 0x18000663C
 * Callers:
        ...
        struct CBitmapResource *a5)
{
  ...
  *(_QWORD *)v5 = 0LL;
  ...
  wil::com_ptr_t<CColorBrush,wil::err_returncode_policy>::operator=(&v17, v11);
  v13 = v17;
  if ( !v17 )
  {
    v10 = -2147024882;
...
LABEL_11:
  ...
  *((_DWORD *)v13 + 22) = 0;
  ...
  LODWORD(v17) = 0;
  ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_1803483D0)(
    (char *)v13 + SDWORD2(xmmword_1803483D0),
    &CSurfaceBrush::sc_HorizontalAlignment,
    &v17);
  LODWORD(v17) = 0;
  ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_180348408)(
    (char *)v13 + SDWORD2(xmmword_180348408),
