/*
 * XREFs of ?CleanTree@CHolographicInteropTarget@@AEAAJXZ @ 0x1802586F8
 * Callers:
 *     ?PreRender@CHolographicInteropTarget@@UEAAJXZ @ 0x180258AA0 (-PreRender@CHolographicInteropTarget@@UEAAJXZ.c)
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18002E8BC (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1800EBD90 (_guard_dispatch_icall_nop.c)
 *     ?GetTextureAtIndex@CHolographicManager@@QEAAPEAVCHolographicInteropTexture@@I@Z @ 0x180254850 (-GetTextureAtIndex@CHolographicManager@@QEAAPEAVCHolographicInteropTexture@@I@Z.c)
 */
    ...
    while ( 1 )
    {
      ...
      if ( TextureAtIndex )
      {
        ...
        if ( v6 )
        {
          ...
          v2 = v7;
          if ( v7 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v7, 0x298u, 0LL);
        }
        if ( v2 < 0 )
          break;
      }
