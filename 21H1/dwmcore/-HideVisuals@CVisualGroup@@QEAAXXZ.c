/*
 * XREFs of ?HideVisuals@CVisualGroup@@QEAAXXZ @ 0x1801AFFE0
 * Callers:
 *     ?HideDDAVisuals@CComposition@@QEBAXXZ @ 0x180159A90 (-HideDDAVisuals@CComposition@@QEBAXXZ.c)
 *     ?HideVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x18018F570 (-HideVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
