/*
 * XREFs of ?AddDirtyRegion@CGdiSpriteBitmap@@AEAAXAEAVCRegion@@_N@Z @ 0x180077A6C
 * Callers:
 ...
 *     ?Contains@CRegion@FastRegion@@QEBA_NAEBV12@@Z @ 0x180076864 (-Contains@CRegion@FastRegion@@QEBA_NAEBV12@@Z.c)
        ...
        for ( i = 0; i < *((_DWORD *)this + 52); ++i )
        {
          ...
          if ( !v16 && (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
            McTemplateU0xxxxx_EventWriteTransfer(
              ...
              *((_QWORD *)v18 + 10),
              *((_QWORD *)this + 10));
          CWindowNode::NotifyDirtySurface(v18, a2, v11, *((_BYTE *)this + 131));
        }
      }
    }
    if ( ho )
