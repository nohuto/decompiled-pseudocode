/*
 * XREFs of ?SendReportToE3@CEnergyReporter@@AEAAXXZ @ 0x1800C2AB8
 * Callers:
...
void __fastcall CEnergyReporter::SendReportToE3(RTL_SRWLOCK *this, __int64 a2, __int64 a3)
{
  ...
  if ( LODWORD(this[5].Ptr) )
  {
    ...
    if ( LOBYTE(this[10].Ptr) )
    {
      ...
      {
        if ( (unsigned int)dword_180346E3C < MEMORY[0x7FFE037C] && !(unsigned __int8)EtwCheckCoverage(&off_180346E30) )
          NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_180346E30, 0x18u);
      }
    ...
    if ( v6 < 0
      && (unsigned int)dword_180346E24 < MEMORY[0x7FFE037C]
      && !(unsigned __int8)EtwCheckCoverage(&off_180346E18) )
    {
      NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_180346E18, 0x18u);
    }
