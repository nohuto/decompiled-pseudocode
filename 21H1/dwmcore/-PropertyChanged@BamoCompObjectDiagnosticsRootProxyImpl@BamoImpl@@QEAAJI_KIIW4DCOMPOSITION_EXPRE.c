/*
 * XREFs of ?PropertyChanged@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180186A84
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsRootProxyImpl::PropertyChanged(__int64 a1, int a2, __int64 a3)
{
  int v6; // ebx
  __int64 v7; // rdx
