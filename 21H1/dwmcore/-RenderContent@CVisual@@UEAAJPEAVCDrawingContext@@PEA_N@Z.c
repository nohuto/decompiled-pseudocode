/*
 * XREFs of ?RenderContent@CVisual@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x180048770
 * Callers:
...
__int64 __fastcall CVisual::RenderContent(CVisual *this, struct CDrawingContext *a2, bool *a3)
{
  ...
  {
    v7 = 4LL;
    if ( dword_18034D314 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                     + 4LL) )
    {
      Init_thread_header(&dword_18034D314);
      if ( dword_18034D314 == -1 )
      {
        dword_180347AD8 = -2147022876;
        Init_thread_footer(&dword_18034D314);
      }
    }
    v8 = 0LL;
    v28 = 0LL;
...
LABEL_10:
        ...
        v16 = (*(__int64 (__fastcall **)(__int64, struct CDrawingContext *, char *, struct CDrawListCache *))(*(_QWORD *)v15 + 16LL))(
                ...
                v8);
        if ( v16 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180347AD0, 3u, v16, 0x1052u, 0LL);
        goto LABEL_12;
      }
...
LABEL_28:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v12, &dword_180347AD0, 3u, v10, 0x104Du, 0LL);
LABEL_12:
...
LABEL_15:
  ...
  v21 = (const char *)&word_1802CFB96;
  v22 = (const char *)&word_1802CFB96;
  v23 = 1;
