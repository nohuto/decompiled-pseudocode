/*
 * XREFs of ?UpdateIntermediates@ShadowIntermediates@CDropShadow@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@M@Z @ 0x18000F484
 * Callers:
...
LABEL_25:
    ...
    v23 = CDropShadow::ShadowIntermediates::GenerateBlurIntermediate(
            ...
            &v34,
            v22,
            COERCE_DOUBLE((unsigned __int64)(unsigned int)FLOAT_16_0),
