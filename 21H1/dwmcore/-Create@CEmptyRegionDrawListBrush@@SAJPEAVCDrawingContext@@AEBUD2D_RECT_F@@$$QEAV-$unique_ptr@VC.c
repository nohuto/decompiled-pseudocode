/*
 * XREFs of ?Create@CEmptyRegionDrawListBrush@@SAJPEAVCDrawingContext@@AEBUD2D_RECT_F@@$$QEAV?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@PEAPEAV1@@Z @ 0x180013754
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( v10 )
  {
    ...
    if ( v13 < 0 )
    {
      ...
      CEmptyRegionDrawListBrush::`scalar deleting destructor'((CEmptyRegionDrawListBrush *)v10, 1);
    }
    else
    {
      *a4 = v10;
