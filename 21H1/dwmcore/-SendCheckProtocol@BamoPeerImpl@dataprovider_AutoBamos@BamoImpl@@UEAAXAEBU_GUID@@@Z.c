/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x1800CFD20
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  LOWORD(v6) = 0;
  v10 = v2;
  v5 = CoreUICallSend(v4, v9, 2LL, 6LL, v6, &unk_1802D1393, (unsigned int)&v10, v8);
  if ( v5 < 0 )
  {
