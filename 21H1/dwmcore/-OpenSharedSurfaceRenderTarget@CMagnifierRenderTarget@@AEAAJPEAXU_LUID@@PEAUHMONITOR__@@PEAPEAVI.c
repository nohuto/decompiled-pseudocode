/*
 * XREFs of ?OpenSharedSurfaceRenderTarget@CMagnifierRenderTarget@@AEAAJPEAXU_LUID@@PEAUHMONITOR__@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x18018F5E8
 * Callers:
        ...
        struct IRenderTargetBitmap **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( Device < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802F1898, 2u, Device, 0x1DDu, 0LL);
  }
  else
  {
    ...
    if ( RenderTargetBitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802F1898, 2u, RenderTargetBitmap, 0x1E5u, 0LL);
  }
  if ( v13 )
