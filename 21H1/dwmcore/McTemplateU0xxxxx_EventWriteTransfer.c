/*
 * XREFs of McTemplateU0xxxxx_EventWriteTransfer @ 0x180157978
 * Callers:
 ...
 *     ?TraceTime@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800D2A0C (-TraceTime@CPartitionVerticalBlankScheduler@@AEAAXXZ.c)
 * Callees:
