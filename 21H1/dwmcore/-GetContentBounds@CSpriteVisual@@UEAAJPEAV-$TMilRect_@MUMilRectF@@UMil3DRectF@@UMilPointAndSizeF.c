/*
 * XREFs of ?GetContentBounds@CSpriteVisual@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800AA0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVisual::GetContentBounds(CSpriteVisual *this, _QWORD *a2)
{
  int v4; // esi
  __int64 v5; // rdx
  __int64 (__fastcall ***v6)(_QWORD, char *, _QWORD *); // rcx
  int v7; // eax
  __int64 v8; // rcx
  __int64 v9; // rcx
  __int64 v10; // rax
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    v6 = (__int64 (__fastcall ***)(_QWORD, char *, _QWORD *))(v5 + 56 + *(int *)(*(_QWORD *)(v5 + 56) + 8LL));
  ...
  if ( (*(unsigned __int8 (__fastcall **)(CSpriteVisual *))(*(_QWORD *)this + 288LL))(this) )
  {
    ...
    *(_QWORD *)&v22 = __PAIR64__(LODWORD(v12), v11.m128_u32[0]);
    if ( v13 > v11.m128_f32[0] && v14 > v12 )
      TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(a2, &v22);
  }
  if ( v4 < 0 )
  {
