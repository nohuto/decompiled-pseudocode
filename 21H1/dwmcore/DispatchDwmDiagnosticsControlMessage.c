/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x180214114
 * Callers:
 *     McGenControlCallbackV2 @ 0x1800CAEC0 (McGenControlCallbackV2.c)
 * Callees:
 ...
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x1802141F4 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
