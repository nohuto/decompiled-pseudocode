/*
 * XREFs of ??_GCCheckMPOCache@@QEAAPEAXI@Z @ 0x1800EA3DC
 * Callers:
 *     ??4?$unique_ptr@VCCheckMPOCache@@U?$default_delete@VCCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800EAD20 (--4-$unique_ptr@VCCheckMPOCache@@U-$default_delete@VCCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEA.c)
