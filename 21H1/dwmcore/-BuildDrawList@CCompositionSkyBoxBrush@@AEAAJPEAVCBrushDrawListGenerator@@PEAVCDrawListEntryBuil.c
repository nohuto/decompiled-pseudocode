/*
 * XREFs of ?BuildDrawList@CCompositionSkyBoxBrush@@AEAAJPEAVCBrushDrawListGenerator@@PEAVCDrawListEntryBuilder@@@Z @ 0x1801BF640
 * Callers:
...
LABEL_24:
  ...
  v9 = CCompositionCubeMap::GetOrCreateD3DCubeMap(
         v8,
         (struct ID2DContextOwner *)((unsigned __int64)(v3 + 6) & -(__int64)(v3 != 0LL)),
         &v54);
  SkyBoxPrimitive = v9;
  if ( v9 < 0 )
  {
...
LABEL_25:
  ...
  v14 = CDrawListBitmap::Initialize((CDrawListBitmap *)&v36, v13, (const struct CDrawingContext *)v3);
  SkyBoxPrimitive = v14;
  if ( v14 < 0 )
  {
  ...
  if ( v45 )
  {
    ...
    {
      v51 = 0;
      CMatrixStack::Top((CMatrixStack *)(v3 + 102), (struct CMILMatrix *)v50);
      v22 = v3[69] != 0;
      v42 = 0LL;
      HIDWORD(v42) = v22;
      v44 = 0x100000000LL;
        ...
        else
        {
          ...
          *((_QWORD *)&v42 + 1) = 0LL;
          ...
          if ( SkyBoxPrimitive >= 0 )
          {
            ...
            if ( v31 )
              v32 = 0LL;
            CHWDrawListEntry::ReplacePrimitive(v32, (__int64 *)&v52, (__int64 *)&v53, (__int64)&CMILMatrix::Identity);
            if ( v52 )
