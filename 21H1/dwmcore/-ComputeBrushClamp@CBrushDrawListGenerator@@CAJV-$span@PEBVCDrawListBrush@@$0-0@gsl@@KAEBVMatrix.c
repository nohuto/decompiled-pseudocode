/*
 * XREFs of ?ComputeBrushClamp@CBrushDrawListGenerator@@CAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@KAEBVMatrix3x3@@PEAPEAVCShape@@@Z @ 0x180052DF0
 * Callers:
...
__int64 __fastcall CBrushDrawListGenerator::ComputeBrushClamp(__int64 *a1, int a2, float *a3, _QWORD *a4)
{
  __int64 v4; // r14
  float *v6; // r15
  signed int v8; // esi
  ...
  int v13; // xmm8_4
  int v14; // xmm9_4
  __int64 (__fastcall ***v15)(_QWORD, __int64); // r9
  ...
  void (__fastcall ***v34)(__int64 (__fastcall ***)(_QWORD, __int64), __int64); // rcx
  ...
  __int64 v50; // rcx
  __int64 v51; // rcx
  __int64 (__fastcall ***v52)(_QWORD, __int64); // [rsp+38h] [rbp-D0h] BYREF
  __int64 (__fastcall ***v53)(_QWORD, __int64); // [rsp+40h] [rbp-C8h] BYREF
  __m128 v54; // [rsp+48h] [rbp-C0h] BYREF
  struct CShape *v55[2]; // [rsp+58h] [rbp-B0h]
  int v56; // [rsp+68h] [rbp-A0h]
  __m128 v57; // [rsp+78h] [rbp-90h]
  float *v58; // [rsp+90h] [rbp-78h]
  ...
  while ( 1 )
  {
    ...
    if ( v16 )
    {
      ...
      *(unsigned __int64 *)((char *)v54.m128_u64 + 4) = v17;
      ...
      v56 = 1065353216;
      Matrix3x3::operator*(v54.m128_f32, v64, v6);
    ...
    if ( !v52 )
    {
      ...
      if ( v24 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v24, 0x60u, 0LL);
        goto LABEL_45;
      }
      goto LABEL_14;
    }
    ...
    v30 = CShape::TryOptimizedCombinePaths(v52, 0LL);
    v24 = v30;
    if ( v30 < 0 )
    {
    ...
    if ( v24 < 0 )
      break;
    v34 = (void (__fastcall ***)(__int64 (__fastcall ***)(_QWORD, __int64), __int64))v52;
    v35 = v53;
    v53 = 0LL;
    v52 = v35;
    if ( v34 )
    {
      (**v34)((__int64 (__fastcall ***)(_QWORD, __int64))v34, 1LL);
      if ( v53 )
        std::default_delete<CShape>::operator()(v36, v53);
    }
LABEL_14:
    v26 = lpMem;
    v27 = v69;
...
LABEL_23:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, v24, 0x6Bu, 0LL);
  if ( v53 )
    std::default_delete<CShape>::operator()(v50, v53);
LABEL_45:
  CRectanglesShape::~CRectanglesShape((CRectanglesShape *)&v66);
  if ( v52 )
    std::default_delete<CShape>::operator()(v51, v52);
  return (unsigned int)v24;
}
