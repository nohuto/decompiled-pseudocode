/*
 * XREFs of ?GetTextureMemoryLayoutData@CSurfaceBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801F23C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?swap@?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@QEAAXAEAV12@@Z @ 0x1801F28C8 (-swap@-$vector@ULayoutData@CContent@@V-$allocator@ULayoutData@CContent@@@std@@@std@@QEAAXAEAV12@.c)
 */
  ...
  *(_QWORD *)(a3 + 8) = *(_QWORD *)a3;
  ...
  if ( v5 && !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 56LL))(v5, 200LL) )
  {
            ...
            40LL) )
    {
      ...
      v32 = 0LL;
      v31 = 0LL;
      v15 = (*(__int64 (__fastcall **)(__int64, struct D2D_SIZE_F *, __int128 *))(*(_QWORD *)v14 + 272LL))(
              v14,
              a2,
              &v31);
      v4 = v15;
