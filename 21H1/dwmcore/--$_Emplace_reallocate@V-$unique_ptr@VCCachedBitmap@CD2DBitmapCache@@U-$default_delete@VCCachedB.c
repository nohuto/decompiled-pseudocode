...
unsigned __int64 __fastcall std::vector<std::unique_ptr<CD2DBitmapCache::CCachedBitmap>>::_Emplace_reallocate<std::unique_ptr<CD2DBitmapCache::CCachedBitmap>>(
        __int64 **a1,
        char *a2,
        __int64 *a3)
{
  ...
  *(_QWORD *)(v13 + v15) = v14;
  ...
  std::vector<std::unique_ptr<CD2DBitmapCache::CCachedBitmap>>::_Change_array((__int64)a1, v16, v8, v11);
