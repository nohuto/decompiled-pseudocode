/*
 * XREFs of ?GenerateDrawList@CBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18003A6C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  if ( dword_18034D2EC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18034D2EC);
    if ( dword_18034D2EC == -1 )
    {
      dword_180347AB8 = -2147022876;
      Init_thread_footer(&dword_18034D2EC);
    }
  }
  v8 = *this;
  v25 = &v24;
  ...
  *(_QWORD *)v26 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180347AB0, 3u, v11, 0xB2u, 0LL);
    goto LABEL_11;
  }
  v13 = this[8];
  if ( !v13 )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_180347AB0, 3u, v14, 0xB7u, 0LL);
    }
    else
    {
      v28[0] = v24;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180347AB0, 3u, DrawList, 0xBEu, 0LL);
      CDrawListEntryBuilder::~CDrawListEntryBuilder((CDrawListEntryBuilder *)v34);
    }
  ...
  if ( *(int *)(v21 + 624) >= 37632 && !*(_BYTE *)(v21 + 1433) )
  {
    ...
    v11 = v22;
    if ( v22 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_180347AB0, 3u, v22, 0xC9u, 0LL);
  }
LABEL_11:
  if ( v24 )
