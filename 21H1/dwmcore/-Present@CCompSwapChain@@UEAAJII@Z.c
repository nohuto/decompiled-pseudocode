/*
 * XREFs of ?Present@CCompSwapChain@@UEAAJII@Z @ 0x1802524C0
 * Callers:
 *     <none>
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18002E8BC (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ??0?$DynArrayIA@V?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@$07$0A@@@QEAA@XZ @ 0x180035904 (--0-$DynArrayIA@V-$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_ea_180035904.c)
...
__int64 __fastcall CCompSwapChain::Present(CCompSwapChain *this, unsigned int a2, unsigned int a3)
{
  ...
  if ( !v7 )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_180307538, 2u, v8, 0x13Du, 0LL);
      goto LABEL_20;
    }
    if ( **((_DWORD **)this + 13) )
    {
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_180307538, 2u, v17, 0x14Cu, 0LL);
  }
  else if ( !v7 )
  {
    if ( *((_DWORD *)this + 25) == 3 )
    {
      v19 = FastRegion::CRegion::Copy(
              (FastRegion::Internal::CRgnData **)this + 31,
              (FastRegion::Internal::CRgnData **)this + 22);
      if ( v19 < 0 )
