/*
 * XREFs of ?SetSyncRefreshCountWaitTarget@CDDisplaySwapChain@@QEAAJ_KPEAPEAX@Z @ 0x18023BAA8
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::SetSyncRefreshCountWaitTarget(CDDisplaySwapChain *this, void *a2, void **a3)
{
  ...
  {
    v8 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2003304442, 0x365u, 0LL);
  }
  return v8;
}
