/*
 * XREFs of ?RenderTargetRectToDesktopRect@CDDisplayRenderTarget@@IEAAX_NAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180191304
 * Callers:
...
char __fastcall CDDisplayRenderTarget::RenderTargetRectToDesktopRect(__int64 a1, __int64 a2, __int64 a3, _OWORD *a4)
{
  ...
  __m128i v7; // xmm0
  char result; // al
  __m128 v9[4]; // [rsp+20h] [rbp-88h] BYREF
  ...
  *(float *)v5.m128i_i32 = (float)*(int *)(a3 + 12);
  ...
  CMILMatrix::SetToInverse(v9, (const struct CMILMatrix *)(a1 + 18312 + (v4 != 0 ? 0x44 : 0)));
