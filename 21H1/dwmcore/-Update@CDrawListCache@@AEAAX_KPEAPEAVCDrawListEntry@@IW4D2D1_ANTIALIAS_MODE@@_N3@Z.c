/*
 * XREFs of ?Update@CDrawListCache@@AEAAX_KPEAPEAVCDrawListEntry@@IW4D2D1_ANTIALIAS_MODE@@_N3@Z @ 0x18004CBC8
 * Callers:
    ...
    *((_DWORD *)v11 + 22) = 0;
    do
    {
      ...
      *((_DWORD *)v11 + 23) &= v24;
      ...
      TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v31, &v30);
      v7 += 8LL;
      --v9;
    }
    while ( v9 );
