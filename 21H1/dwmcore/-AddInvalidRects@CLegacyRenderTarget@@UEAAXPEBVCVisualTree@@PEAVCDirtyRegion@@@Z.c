/*
 * XREFs of ?AddInvalidRects@CLegacyRenderTarget@@UEAAXPEBVCVisualTree@@PEAVCDirtyRegion@@@Z @ 0x18006BA60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HasVirtualModeScale@CLegacyRenderTarget@@AEBA_NXZ @ 0x18006C6F4 (-HasVirtualModeScale@CLegacyRenderTarget@@AEBA_NXZ.c)
        ...
        struct CDirtyRegion *a3)
{
  ...
  if ( *((_QWORD *)this + 12) )
  {
    ...
    *(_QWORD *)&v27 = v6;
    ...
    for ( i = qword_18034D608; i != (_QWORD)xmmword_18034D610; i += 16LL )
    {
      v9 = *(_QWORD *)i;
      if ( __PAIR64__(DWORD1(v27), v6) == *(_QWORD *)(*(_QWORD *)i + 936LL) )
      {
        if ( !*(_BYTE *)(v9 + 500) && !byte_18034D620 && *(_DWORD *)(v9 + 496) )
          v7 = 1;
        break;
      }
    }
