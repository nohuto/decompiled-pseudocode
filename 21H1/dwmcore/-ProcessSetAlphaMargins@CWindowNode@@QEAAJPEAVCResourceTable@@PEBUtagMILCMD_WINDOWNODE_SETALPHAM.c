/*
 * XREFs of ?ProcessSetAlphaMargins@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_WINDOWNODE_SETALPHAMARGINS@@@Z @ 0x18008D6F4
 * Callers:
        ...
        const struct tagMILCMD_WINDOWNODE_SETALPHAMARGINS *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x2F4u, 0LL);
  }
  else
  {
