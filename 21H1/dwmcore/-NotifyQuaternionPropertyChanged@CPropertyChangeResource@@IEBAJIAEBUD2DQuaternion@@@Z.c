/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x1801B5CEC
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this) )
  {
    ...
    v15[1] = v7;
    LOWORD(v14) = 6;
    v3 = CoreUICallSend(v10, v15, 2LL, 13LL, v14, &unk_1802CFB57, v6, &v16);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v3, 0x1CEu, 0LL);
  }
