/*
 * XREFs of ?CurrentInertiaVelocity@CScaleMotion@@MEBAMXZ @ 0x180211010
 * Callers:
 *     ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x180211090 (-CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ.c)
 * Callees:
