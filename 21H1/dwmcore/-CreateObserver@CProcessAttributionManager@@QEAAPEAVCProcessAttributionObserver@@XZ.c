/*
 * XREFs of ?CreateObserver@CProcessAttributionManager@@QEAAPEAVCProcessAttributionObserver@@XZ @ 0x1800DAD98
 * Callers:
        ...
        CProcessAttributionManager *this)
{
  ...
  v2 = (__int64 *)DefaultHeap::AllocClear(0x28uLL);
  v3 = v2;
  if ( !v2 )
    ModuleFailFastForHRESULT(2147942414LL, retaddr);
  v2[1] = (__int64)this;
  v2[2] = 0LL;
  *v2 = (__int64)&CProcessAttributionManager::Observer::`vftable';
  v2[3] = 0LL;
  v2[4] = 0LL;
