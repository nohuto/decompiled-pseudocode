/*
 * XREFs of ?CalcMode@CCpuClippingData@@CA?AW4Enum@CpuClippingMode@@PEAVCVisual@@W423@_N@Z @ 0x1800B6674
 * Callers:
...
LABEL_5:
  ...
  if ( !(unsigned __int8)CMILMatrix::Is2DAffine<0>((__int64)Matrix) )
    return 4LL;
...
LABEL_8:
  ...
  if ( v11 )
  {
    ...
    if ( !(unsigned __int8)CMILMatrix::Is2DAffine<0>((__int64)v12) )
      return v9;
