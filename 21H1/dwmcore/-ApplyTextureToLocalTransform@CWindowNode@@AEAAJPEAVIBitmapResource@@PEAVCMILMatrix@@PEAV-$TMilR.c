/*
 * XREFs of ?ApplyTextureToLocalTransform@CWindowNode@@AEAAJPEAVIBitmapResource@@PEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180048958
 * Callers:
...
__int64 __fastcall CWindowNode::ApplyTextureToLocalTransform(__int64 a1, __int64 *a2, CMILMatrix *a3, _OWORD *a4)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x608u, 0LL);
  }
  else
  {
    ...
    if ( a2 == (__int64 *)((*(_QWORD *)(a1 + 864) + 64LL) & -(__int64)(*(_QWORD *)(a1 + 864) != 0LL)) )
    {
      ...
      CMILMatrix::Transform2DBoundsHelper<0>(v16);
