/*
 * XREFs of ?NotifyRenderedRect@CHolographicInteropTexture@@QEAAXIIAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18025A0B0
 * Callers:
...
void __fastcall CHolographicInteropTexture::NotifyRenderedRect(__int64 a1, __int64 a2, unsigned int a3, float *a4)
{
  ...
  v4 = (RTL_SRWLOCK *)(a1 + 392);
  v5 = a3;
  AcquireSRWLockExclusive((PSRWLOCK)(a1 + 392));
  v8 = *(_DWORD *)(a1 + 244);
  v9 = *(_DWORD *)(a1 + 248);
  v10.left = (int)*a4 - v8;
  ...
  if ( *(_DWORD *)(a1 + 228) && (unsigned int)v5 < *(_DWORD *)(a1 + 232) )
  {
    if ( v5 >= 2 )
    {
    ...
    FastRegion::CRegion::Union(
      (const struct FastRegion::Internal::CRgnData **)(*(_QWORD *)(a1 + 8 * v5 + 192) + 16LL),
