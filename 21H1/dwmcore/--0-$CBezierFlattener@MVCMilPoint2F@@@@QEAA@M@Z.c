/*
 * XREFs of ??0?$CBezierFlattener@MVCMilPoint2F@@@@QEAA@M@Z @ 0x1801B9B98
 * Callers:
 *     ??0CTrimPathOperation@@QEAA@XZ @ 0x1801B9C24 (--0CTrimPathOperation@@QEAA@XZ.c)
 *     ??0CPathLengthOperation@@QEAA@XZ @ 0x18025F03C (--0CPathLengthOperation@@QEAA@XZ.c)
 * Callees:
