/*
 * XREFs of ?UpdateHolographicViewer@CHolographicManager@@QEAAXPEAVCHolographicViewer@@@Z @ 0x180255464
 * Callers:
 ...
 *     ?DwmHolographicViewerUpdate_@CompositorTracing@@QEAAXI@Z @ 0x1802543BC (-DwmHolographicViewerUpdate_@CompositorTracing@@QEAAXI@Z.c)
