/*
 * XREFs of ?OnVisualPropertyChange@CManipulationContext@@SAXPEAVCVisual@@PEAVCDesktopTree@@@Z @ 0x180235E10
 * Callers:
 ...
 *     _lambda_9a9771997357178f95a5eaf72b6b0000_::operator() @ 0x1802345C8 (_lambda_9a9771997357178f95a5eaf72b6b0000_--operator().c)
 */
