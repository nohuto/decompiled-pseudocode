/*
 * XREFs of ?RestoreCursors@CComposition@@QEAAXXZ @ 0x18008BBEC
 * Callers:
 ...
 *     ?RestoreVisuals@COffScreenRenderTarget@@MEAAXXZ @ 0x180189D90 (-RestoreVisuals@COffScreenRenderTarget@@MEAAXXZ.c)
 *     ?RestoreVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x18018FE90 (-RestoreVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
