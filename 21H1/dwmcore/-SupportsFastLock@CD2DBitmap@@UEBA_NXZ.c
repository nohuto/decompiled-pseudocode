/*
 * XREFs of ?SupportsFastLock@CD2DBitmap@@UEBA_NXZ @ 0x180028D70
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall CD2DBitmap::SupportsFastLock(CD2DBitmap *this)
{
  ...
  if ( !*((_BYTE *)this + 149) )
  {
    ...
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v5);
  }
