/*
 * XREFs of ?StopAnalyzingAnimationScenario@CAnimationTracking@@AEAAXIAEBUTelFrameInfo@1@@Z @ 0x180088DA0
 * Callers:
 ...
 *     ?TimeoutOverdueScenarios@CAnimationTracking@@QEAAXAEBUTelFrameInfo@1@@Z @ 0x180088B98 (-TimeoutOverdueScenarios@CAnimationTracking@@QEAAXAEBUTelFrameInfo@1@@Z.c)
 ...
 *     ?GetScenarioName@CAnimationTracking@@AEAAPEBGPEAUAnimationScenarioRunningStatistics@1@PEAGK@Z @ 0x18008A2A8 (-GetScenarioName@CAnimationTracking@@AEAAPEBGPEAUAnimationScenarioRunningStatistics@1@PEAGK@Z.c)
 *     ?GetScenarioDetails@CAnimationTracking@@AEAAPEBGPEAUAnimationScenarioRunningStatistics@1@PEAGK@Z @ 0x18008A464 (-GetScenarioDetails@CAnimationTracking@@AEAAPEBGPEAUAnimationScenarioRunningStatistics@1@PEAGK@Z.c)
 *     ?GetScenarioDetails@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@QEBAPEBGXZ @ 0x18008A4B8 (-GetScenarioDetails@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@QEBAPEBGXZ.c)
    ...
    *(_QWORD *)v63 = v10 * (unsigned __int64)v7 / 0x2710;
    ...
    if ( ScenarioName )
    {
      ...
      if ( wcsncmp(ScenarioName, String2, v23)
        && (unsigned int)dword_180346EB8 > 5
        && (qword_180346EC8 & 0x200000000004LL) != 0
        && (qword_180346ED0 & 0x200000000004LL) == qword_180346ED0 )
      {
        v50 = *(wchar_t **)(v5 + 136);
        v51 = word_1802CE738;
        v62 = ScenarioName;
