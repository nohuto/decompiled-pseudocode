/*
 * XREFs of ?RunCompositionThread@CConnection@@AEAAJXZ @ 0x1800D7C0C
 * Callers:
 *     ?CompositionThreadEntryPoint@CConnection@@CAKPEAX@Z @ 0x1800D7C00 (-CompositionThreadEntryPoint@CConnection@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ??0CProcessAttributionReporter@@AEAA@XZ @ 0x1800DAD30 (--0CProcessAttributionReporter@@AEAA@XZ.c)
...
__int64 __fastcall CConnection::RunCompositionThread(CConnection *this)
{
  ...
  *((_QWORD *)v2 + 5) = 0LL;
  ...
  if ( v9 )
    ...
    v10 = 0LL;
  qword_180349468 = (CProcessResourceAttributionReporter *)v10;
  if ( !v10 )
    ModuleFailFastForHRESULT(2147942414LL, retaddr);
...
LABEL_34:
  ...
  if ( qword_180349460 )
  {
    CProcessAttributionReporter::~CProcessAttributionReporter(qword_180349460);
    operator delete(v25);
  }
  v26 = qword_180349468;
  qword_180349460 = 0LL;
  if ( qword_180349468 )
  {
    CProcessResourceAttributionReporter::~CProcessResourceAttributionReporter(qword_180349468);
    operator delete(v26);
  }
  v27 = qword_180349458;
  qword_180349468 = 0LL;
  if ( qword_180349458 )
  {
    WaitForThreadpoolWorkCallbacks(*((PTP_WORK *)qword_180349458 + 9), 1);
    CloseThreadpoolWork(*((PTP_WORK *)v27 + 9));
    v28 = (void (__fastcall ***)(_QWORD, __int64))*((_QWORD *)v27 + 6);
    if ( v28 )
      (**v28)(v28, 1LL);
    DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v27 + 88);
    DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v27 + 16);
    operator delete(v27);
  }
  v29 = qword_180349450;
  qword_180349458 = 0LL;
  if ( qword_180349450 )
  {
    anonymous_namespace_::State::_State(qword_180349450);
    operator delete(v29);
  }
  v30 = lpMem;
  qword_180349450 = 0LL;
