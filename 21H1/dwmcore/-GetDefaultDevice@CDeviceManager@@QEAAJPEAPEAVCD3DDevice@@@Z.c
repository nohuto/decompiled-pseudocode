/*
 * XREFs of ?GetDefaultDevice@CDeviceManager@@QEAAJPEAPEAVCD3DDevice@@@Z @ 0x180239888
 * Callers:
 ...
 *     ?GetDevice@CRemoteAppRenderTarget@@UEAAJPEAPEAVCD3DDevice@@@Z @ 0x18018A3B0 (-GetDevice@CRemoteAppRenderTarget@@UEAAJPEAPEAVCD3DDevice@@@Z.c)
...
__int64 __fastcall CDeviceManager::GetDefaultDevice(CDeviceManager *this, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v4 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v3, &dword_1802F18B0, 3u, -2003304442, 0x8Eu, 0LL);
  }
  else
  {
    ...
    v4 = Device;
    if ( Device < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802F18B0, 3u, Device, 0x8Au, 0LL);
  }
  return v4;
}
