/*
 * XREFs of ?ProcessSetVisualReference@CCursorVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CURSORVISUAL_SETVISUALREFERENCE@@@Z @ 0x1801C29A8
 * Callers:
 ...
 *     ?GetDesktopId@CCursorVisual@@AEAAIPEAVCVisual@@@Z @ 0x1801C287C (-GetDesktopId@CCursorVisual@@AEAAIPEAVCVisual@@@Z.c)
 */
        ...
        const struct tagMILCMD_CURSORVISUAL_SETVISUALREFERENCE *a3)
{
  ...
  if ( v7 )
  {
    ...
    {
      v6 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2003303421, 0x5Cu, 0LL);
    }
  }
  return v6;
}
