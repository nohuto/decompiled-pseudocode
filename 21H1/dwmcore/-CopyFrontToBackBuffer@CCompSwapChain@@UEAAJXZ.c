/*
 * XREFs of ?CopyFrontToBackBuffer@CCompSwapChain@@UEAAJXZ @ 0x180251C90
 * Callers:
...
__int64 __fastcall CCompSwapChain::CopyFrontToBackBuffer(CCompSwapChain *this)
{
  ...
  if ( **((_DWORD **)this + 22) || *((_DWORD *)this + 25) == 3 && **((_DWORD **)this + 31) )
  {
    ...
    v2 = FastRegion::CRegion::Copy(&v20, (FastRegion::Internal::CRgnData **)this + 22);
    if ( v2 < 0 )
      ModuleFailFastForHRESULT(v2, retaddr);
    if ( *((_DWORD *)this + 25) == 3 )
    {
      v3 = FastRegion::CRegion::Union(&v20, (const struct FastRegion::Internal::CRgnData **)this + 31);
      if ( v3 < 0 )
