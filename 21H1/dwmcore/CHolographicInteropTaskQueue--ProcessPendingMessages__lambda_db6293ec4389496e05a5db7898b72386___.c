/*
 * XREFs of CHolographicInteropTaskQueue::ProcessPendingMessages__lambda_db6293ec4389496e05a5db7898b72386___ @ 0x18025327C
 * Callers:
 *     ?PreRender@CHolographicManager@@UEAAXXZ @ 0x1800C1BD0 (-PreRender@CHolographicManager@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?ReleaseInteropTextures@CHolographicManager@@QEAAXXZ @ 0x180254DA0 (-ReleaseInteropTextures@CHolographicManager@@QEAAXXZ.c)
 ...
 *     ?ReverseList@CHolographicInteropTaskQueue@@AEAAPEAU_SLIST_ENTRY@@PEAU2@@Z @ 0x18025B5F0 (-ReverseList@CHolographicInteropTaskQueue@@AEAAPEAU_SLIST_ENTRY@@PEAU2@@Z.c)
 */
