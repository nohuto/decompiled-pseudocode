/*
 * XREFs of ??$_Free_non_head@V?$allocator@U?$_List_node@U?$pair@QEAVCChannelContext@@M@std@@PEAX@std@@@std@@@?$_List_node@U?$pair@QEAVCChannelContext@@M@std@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@U?$pair@QEAVCChannelContext@@M@std@@PEAX@std@@@1@PEAU01@@Z @ 0x1801AED60
 * Callers:
