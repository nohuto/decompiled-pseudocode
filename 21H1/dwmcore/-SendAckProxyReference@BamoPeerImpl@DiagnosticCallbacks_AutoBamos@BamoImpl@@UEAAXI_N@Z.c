/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x18016AFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  LODWORD(v7) = a3;
  LOWORD(v6) = 4;
  v5 = CoreUICallSend(v4, v8, 2LL, 1LL, v6, &unk_1802DB08D, a2, v7);
  if ( v5 < 0 )
  {
