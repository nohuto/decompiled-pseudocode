        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)(v13 + 8 * v4) = v14;
  ...
  if ( a2 != v17 )
  {
    std::_Uninitialized_move<std::unique_ptr<CSwapChainBuffer> *,std::unique_ptr<CSwapChainBuffer> *,std::allocator<std::unique_ptr<CSwapChainBuffer>>>(
      v18,
      a2,
      v13);
    v17 = a1[1];
  ...
  std::_Uninitialized_move<std::unique_ptr<CSwapChainBuffer> *,std::unique_ptr<CSwapChainBuffer> *,std::allocator<std::unique_ptr<CSwapChainBuffer>>>(
    ...
    v17,
    v16);
  std::vector<std::unique_ptr<CSwapChainBuffer>>::_Change_array(a1, v15, v8, v11);
  return *a1 + 8 * v4;
}
