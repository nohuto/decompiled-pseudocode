/*
 * XREFs of ?Unregister@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180183420
 * Callers:
 *     ?Thunk_Unregister_5@?$IDataProviderRegistrarPrincipal_Receive@VBamoDataProviderRegistrarPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180183410 (-Thunk_Unregister_5@-$IDataProviderRegistrarPrincipal_Receive@VBamoDataProviderRegistrarPrincipa.c)
 * Callees:
