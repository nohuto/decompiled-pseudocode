/*
 * XREFs of ?UpdateLastTelemetryInfo@CTelemetryTouchLatencyAnalysis@@QEAAXPEBUTOUCH_TELEMETRY_UPDATE_INFO@@PEAUTouchUpdateInfo@1@_K@Z @ 0x180165B94
 * Callers:
 ...
 *     ?ForceRetireScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@@Z @ 0x1801624AC (-ForceRetireScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAn.c)
 *     ?TelemetryProcessingErrorDetected@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@AEBUTOUCH_TELEMETRY_UPDATE_INFO@@_K@Z @ 0x180165550 (-TelemetryProcessingErrorDetected@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryT.c)
