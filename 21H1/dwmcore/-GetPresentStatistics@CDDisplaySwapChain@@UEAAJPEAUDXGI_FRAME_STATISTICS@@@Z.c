/*
 * XREFs of ?GetPresentStatistics@CDDisplaySwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS@@@Z @ 0x18023AD00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDDisplaySwapChain::GetPresentStatistics(CDDisplaySwapChain *this, struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x21Fu, 0LL);
  }
  else
  {
    if ( v16 )
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x220u, 0LL);
    }
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x221u, 0LL);
      }
      else
      {
