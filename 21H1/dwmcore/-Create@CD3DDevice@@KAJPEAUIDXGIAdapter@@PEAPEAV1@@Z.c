/*
 * XREFs of ?Create@CD3DDevice@@KAJPEAUIDXGIAdapter@@PEAPEAV1@@Z @ 0x1800A42F8
 * Callers:
 ...
 *     ??0CD3DDevice@@AEAA@W4D3D_FEATURE_LEVEL@@W4_QAI_DRIVERVERSION@@T_LARGE_INTEGER@@@Z @ 0x1800A440C (--0CD3DDevice@@AEAA@W4D3D_FEATURE_LEVEL@@W4_QAI_DRIVERVERSION@@T_LARGE_INTEGER@@@Z.c)
 */
...
__int64 __fastcall CD3DDevice::Create(struct IDXGIAdapter *a1, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802ADB18, 2u, v5, 0x188u, 0LL);
    goto LABEL_7;
  }
  v8 = DefaultHeap::AllocClear(0x8C0uLL);
  if ( v8 )
    v8 = (LPVOID)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))CD3DDevice::CD3DDevice)(
                   v8,
                   (unsigned int)v17,
                   v16,
  ...
  if ( v14 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802ADB18, 2u, v10, 0x18Fu, 0LL);
    }
    else
    {
      v12 = v2;
...
LABEL_7:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802ADB18, 2u, -2147024882, 0x18Du, 0LL);
LABEL_11:
  v7 = -2003304307;
LABEL_8:
  if ( v2 )
