/*
 * XREFs of TransformPoint @ 0x180230850
 * Callers:
 *     _anonymous_namespace_::DecomposeMatrix @ 0x18022E5EC (_anonymous_namespace_--DecomposeMatrix.c)
 *     ?TransformCoordinateSpace@CInteractionContextTransformHelper@@SAJPEBUtagRECT@@0PEAUINTERACTION_UPDATE@@1@Z @ 0x18026BE5C (-TransformCoordinateSpace@CInteractionContextTransformHelper@@SAJPEBUtagRECT@@0PEAUINTERACTION_U.c)
 * Callees:
 *     <none>
 */
