/*
 * XREFs of ?PopulateEffectTable@CD2DContext@@AEAAJXZ @ 0x1800A3820
 * Callers:
 ...
 *     ?ReleaseEffectTable@CD2DContext@@AEAAXXZ @ 0x1800A3C8C (-ReleaseEffectTable@CD2DContext@@AEAAXXZ.c)
