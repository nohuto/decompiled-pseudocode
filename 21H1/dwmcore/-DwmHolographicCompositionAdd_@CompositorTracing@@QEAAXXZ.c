/*
 * XREFs of ?DwmHolographicCompositionAdd_@CompositorTracing@@QEAAXXZ @ 0x180253D58
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicCompositionAdd_(CompositorTracing *this)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802EE1E1, 0LL, 0LL, 2u, &v2);
  }
}
