/*
 * XREFs of ??$_Uninitialized_move@PEAVCShapeRenderTask@@PEAV1@V?$allocator@VCShapeRenderTask@@@std@@@std@@YAPEAVCShapeRenderTask@@QEAV1@0PEAV1@AEAV?$allocator@VCShapeRenderTask@@@0@@Z @ 0x180261D4C
 * Callers:
