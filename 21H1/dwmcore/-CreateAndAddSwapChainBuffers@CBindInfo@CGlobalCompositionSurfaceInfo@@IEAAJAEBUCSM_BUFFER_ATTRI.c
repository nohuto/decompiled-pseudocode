/*
 * XREFs of ?CreateAndAddSwapChainBuffers@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SWAPCHAIN_REALIZATION_INFO@@@Z @ 0x18002D09C
 * Callers:
 ...
 * Callees:
 *     ??0CDecodeBitmap@@QEAA@XZ @ 0x18001FAF4 (--0CDecodeBitmap@@QEAA@XZ.c)
        ...
        const struct CSM_SWAPCHAIN_REALIZATION_INFO *a3)
{
  ...
  {
    v6 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802DCD78, 4u, -2147024809, 0x405u, 0LL);
  ...
  {
    v6 = v9 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802DCD78, 4u, v9 | 0x10000000, 0x40Cu, 0LL);
    return (unsigned int)v6;
  }
...
LABEL_6:
      ...
      if ( v11 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1802DCD78, 4u, v16, 0x42Du, 0LL);
        wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>((__int64)&v33);
      }
      else
      {
LABEL_9:
  ...
  if ( v6 >= 0 )
    goto LABEL_6;
  MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802DCD78, 4u, v6, 0x415u, 0LL);
LABEL_11:
