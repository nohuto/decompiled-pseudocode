/*
 * XREFs of ?NotifyRequestIgnored@CInteractionTracker@@AEAAXH@Z @ 0x1801CDEB0
 * Callers:
...
void __fastcall CInteractionTracker::NotifyRequestIgnored(CInteractionTracker *this)
{
  ...
  {
    v5 = *(_QWORD *)(v2 + 48);
    v6 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 16) + 1080LL) + 48LL);
    if ( v5 )
      v4 = *(_DWORD *)(v5 + 68);
    v9[0] = v4;
    v9[1] = *(unsigned int *)(v2 + 56);
    LOWORD(v7) = 2;
    CoreUICallSend(v6, v9, 2LL, 8LL, v7, &unk_1802CFAFE, v3, v8);
  }
}
