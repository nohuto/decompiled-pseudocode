/*
 * XREFs of ?AreInteractionAnimationsAlive@CInteractionTracker@@QEBA_NXZ @ 0x1801CBF78
 * Callers:
 ...
 *     ?IsInMotion@CInteractionTrackerPositionAnimation@@UEBA_NXZ @ 0x1802076B0 (-IsInMotion@CInteractionTrackerPositionAnimation@@UEBA_NXZ.c)
