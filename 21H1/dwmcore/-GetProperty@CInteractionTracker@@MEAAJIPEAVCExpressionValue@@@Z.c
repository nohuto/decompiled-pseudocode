/*
 * XREFs of ?GetProperty@CInteractionTracker@@MEAAJIPEAVCExpressionValue@@@Z @ 0x1801CD6A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_30:
  v22 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x4F7u, 0LL);
  return v22;
}
