/*
 * XREFs of ?GetPixelFormatInfo@CHwndBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x1801C84F0
 * Callers:
 *     ?IsOpaque@CHwndBitmap@@UEBA_NXZ @ 0x1801C8720 (-IsOpaque@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
