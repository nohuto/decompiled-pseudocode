/*
 * XREFs of ?RetireFrame@CPartitionVerticalBlankScheduler@@AEAAJPEAVCFrameInfo@@IPEA_N_N@Z @ 0x18003B5A0
 * Callers:
 ...
 *     ?RecordRenderGlitch@CTelemetryTouchLatencyAnalysis@@QEAAX_KI@Z @ 0x1800C3B5C (-RecordRenderGlitch@CTelemetryTouchLatencyAnalysis@@QEAAX_KI@Z.c)
...
LABEL_6:
  ...
  if ( *((_BYTE *)a2 + 142) || a5 )
  {
    ...
    *((_QWORD *)a2 + 11) = v15;
    ...
    v24 = 0;
    v25 = _InterlockedExchange64(&qword_1803493F8, 0LL);
    dword_18034926C += v25;
    dword_180349270 += HIDWORD(v25);
    if ( *((_DWORD *)a2 + 50) )
    {
      do
      {
