/*
 * XREFs of ?GdiSpriteBitmapUpdateMargins@CChannel@@UEAAJIAEBU_MARGINS@@@Z @ 0x1800CA8B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapUpdateMargins(CChannel *this, unsigned int a2, const struct _MARGINS *a3)
{
  __int128 v6; // xmm0
  unsigned int v7; // ebx
