/*
 * XREFs of ?PreRender@CLegacyRenderTarget@@UEAAJXZ @ 0x18006A40C
 * Callers:
 *     ?PreRender@CLegacyRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EC760 (-PreRender@CLegacyRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 *     ?PreRender@CLegacyRenderTarget@@$4PPPPPPPM@BA@EAAJXZ @ 0x1800EC770 (-PreRender@CLegacyRenderTarget@@$4PPPPPPPM@BA@EAAJXZ.c)
 * Callees:
