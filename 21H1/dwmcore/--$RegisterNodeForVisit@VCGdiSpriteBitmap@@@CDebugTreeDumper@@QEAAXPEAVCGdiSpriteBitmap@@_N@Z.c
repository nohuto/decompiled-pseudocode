/*
 * XREFs of ??$RegisterNodeForVisit@VCGdiSpriteBitmap@@@CDebugTreeDumper@@QEAAXPEAVCGdiSpriteBitmap@@_N@Z @ 0x1801F6F60
 * Callers:
 ...
 *     ??$?4V_lambda_d7a2e9ce7dbc93133989b34b2e12210d_@@X@?$function@$$A6AXPEAXPEAVCDebugTreeDumper@@@Z@std@@QEAAAEAV01@$$QEAV_lambda_d7a2e9ce7dbc93133989b34b2e12210d_@@@Z @ 0x1801F6DB8 (--$-4V_lambda_d7a2e9ce7dbc93133989b34b2e12210d_@@X@-$function@$$A6AXPEAXPEAVCDebugTreeDumper@@@Z.c)
 */

__int64 __fastcall CDebugTreeDumper::RegisterNodeForVisit<CGdiSpriteBitmap>(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v5; // r10
  ...
  {
    v23 = 0LL;
    std::function<void (void *,CDebugTreeDumper *)>::operator=<_lambda_d7a2e9ce7dbc93133989b34b2e12210d_,void>((__int64)v22);
