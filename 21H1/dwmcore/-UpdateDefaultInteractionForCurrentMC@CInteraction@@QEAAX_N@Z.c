/*
 * XREFs of ?UpdateDefaultInteractionForCurrentMC@CInteraction@@QEAAX_N@Z @ 0x1801CAFB0
 * Callers:
 ...
 * Callees:
 *     ?IsDefaultInteractionStateLocked@CInteraction@@AEAA_NXZ @ 0x1800DB8B8 (-IsDefaultInteractionStateLocked@CInteraction@@AEAA_NXZ.c)
