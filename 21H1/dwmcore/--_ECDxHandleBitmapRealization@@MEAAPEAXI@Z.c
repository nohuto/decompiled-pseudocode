/*
 * XREFs of ??_ECDxHandleBitmapRealization@@MEAAPEAXI@Z @ 0x1800C1E20
 * Callers:
 *     ??_ECDxHandleBitmapRealization@@OBCA@EAAPEAXI@Z @ 0x1800F0000 (--_ECDxHandleBitmapRealization@@OBCA@EAAPEAXI@Z.c)
 * Callees:
