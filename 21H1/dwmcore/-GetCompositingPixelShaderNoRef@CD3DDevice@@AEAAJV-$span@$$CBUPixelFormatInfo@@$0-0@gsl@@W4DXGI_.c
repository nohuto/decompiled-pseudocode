/*
 * XREFs of ?GetCompositingPixelShaderNoRef@CD3DDevice@@AEAAJV?$span@$$CBUPixelFormatInfo@@$0?0@gsl@@W4DXGI_COLOR_SPACE_TYPE@@PEAPEAUID3D11PixelShader@@@Z @ 0x1802403E8
 * Callers:
...
LABEL_5:
  ...
  if ( !v14 )
  {
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x1011u, 0LL);
      goto LABEL_21;
    }
    v19 = v29;
    v30 = 0LL;
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x1017u, 0LL);
      goto LABEL_19;
    }
    ...
    {
      v8 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, -2147024882, 0x101Du, 0LL);
LABEL_19:
