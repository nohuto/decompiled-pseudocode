/*
 * XREFs of ?PreRender@CDDisplayRenderTarget@@UEAAJXZ @ 0x1801905E4
 * Callers:
 *     ?PreRender@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EC750 (-PreRender@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
