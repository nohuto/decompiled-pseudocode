/*
 * XREFs of ?HrInit@CBitmapLockUnaligned@@QEAAJPEAVCBitmap@@IIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@II@Z @ 0x18021A4EC
 * Callers:
 ...
 *     ?ReadUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x18021A72C (-ReadUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
