/*
 * XREFs of ?RemoveAllLights@CVisual@@AEAAXXZ @ 0x18007D134
 * Callers:
...
void __fastcall CVisual::RemoveAllLights(CVisual *this)
{
  ...
  if ( v4 )
  {
    while ( v3 != v1 )
    {
      (*(void (__fastcall **)(_QWORD, CVisual *))(**(_QWORD **)v3 + 280LL))(*(_QWORD *)v3, this);
      CPtrArrayBase::Remove((CPtrArrayBase *)(*(_QWORD *)v3 + 24LL), (__int64)this);
      v3 += 16;
    }
