/*
 * XREFs of ?UpdateLightInfo@CHwLightCollectionBuffer@@AEAAXPEBULightInfo@@I_N@Z @ 0x1800144A4
 * Callers:
 ...
 * Callees:
 *     ?Transpose@CMILMatrix@@QEAAXXZ @ 0x180021EC0 (-Transpose@CMILMatrix@@QEAAXXZ.c)
