/*
 * XREFs of ?AddKeyframeData@CKeyframeAnimation@@AEAAJHMPEAUKeyframeData@@W4KeyframeAnimationCoordinateSpace@@@Z @ 0x1800981D8
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v8 = *(_OWORD *)(a4 + 16);
  v56 = 0LL;
  xmmword_1803491E0 = v8;
  xmmword_1803491F0 = *(_OWORD *)(a4 + 32);
  v9 = *(_DWORD *)(a4 + 4);
  if ( v9 > 65539 )
  {
    v29 = v9 - 65540;
