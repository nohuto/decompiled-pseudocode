/*
 * XREFs of ?CreateDeviceTextureTarget@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@M_NPEAPEAVIDeviceTextureTarget@@@Z @ 0x1800D6740
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( (v28 & 0x20) == 0 )
  {
    ...
    v18 = 1708;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802ADB18, 2u, v11, v18, 0LL);
  ...
  v11 = v15;
  if ( v15 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802ADB18, 2u, v15, 0x6C2u, 0LL);
  return (unsigned int)v11;
}
