/*
 * XREFs of ?HrLockUnaligned@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIIIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180219BF8
 * Callers:
 ...
 *     ??0CBitmapLockUnaligned@@QEAA@XZ @ 0x18021A3B4 (--0CBitmapLockUnaligned@@QEAA@XZ.c)
