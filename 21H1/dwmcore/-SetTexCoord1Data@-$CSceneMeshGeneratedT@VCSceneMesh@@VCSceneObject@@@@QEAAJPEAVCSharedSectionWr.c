/*
 * XREFs of ?SetTexCoord1Data@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180177A8C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[15] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xA66u, 0LL);
    }
    else
    {
