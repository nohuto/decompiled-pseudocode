/*
 * XREFs of ??2CVirtualMonitorCaptureRenderTarget@@KAPEAX_K@Z @ 0x180170AF0
 * Callers:
...
LPVOID __fastcall CVirtualMonitorCaptureRenderTarget::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0x8B0uLL);
  if ( !result )
