/*
 * XREFs of ?IsSameGeometry@CRectangleGeometry@@UEBA_NPEBVCGeometry@@@Z @ 0x1800CB960
 * Callers:
 *     <none>
 * Callees:
 *     ??8CRoundedRectangleGeometryData@@QEBA_NAEBU0@@Z @ 0x18001B614 (--8CRoundedRectangleGeometryData@@QEBA_NAEBU0@@Z.c)
