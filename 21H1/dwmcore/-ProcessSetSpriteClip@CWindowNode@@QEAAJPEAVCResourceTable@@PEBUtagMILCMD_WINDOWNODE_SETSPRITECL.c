/*
 * XREFs of ?ProcessSetSpriteClip@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_WINDOWNODE_SETSPRITECLIP@@@Z @ 0x1800C64F0
 * Callers:
...
LABEL_8:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x253u, 0LL);
    }
  }
  else
  {
    v3 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2003303421, 0x24Du, 0LL);
  }
  if ( v9 )
    goto LABEL_8;
  return v3;
