/*
 * XREFs of ?DwmHolographicDisplayUpdate_@CompositorTracing@@QEAAXI@Z @ 0x180253FD4
 * Callers:
 *     ?UpdateHolographicDisplay@CHolographicManager@@QEAAXPEAVCHolographicDisplay@@@Z @ 0x1802553E0 (-UpdateHolographicDisplay@CHolographicManager@@QEAAXPEAVCHolographicDisplay@@@Z.c)
 * Callees:
...
void __fastcall CompositorTracing::DwmHolographicDisplayUpdate_(CompositorTracing *this, int a2)
{
    ...
    && (*(_QWORD *)(v3 + 24) & 0x400000000000LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v4 = a2;
    v7 = 4;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1802EE2D4, 0LL, 0LL, 3u, &v5);
  }
}
