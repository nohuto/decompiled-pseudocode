/*
 * XREFs of ?GetTextureMemoryLayoutData@CEffectBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801C3D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEffectBrush::GetTextureMemoryLayoutData(__int64 a1, __int64 a2, char **a3)
{
  ...
  for ( i = 0LL; (unsigned int)v5 < *(_DWORD *)(a1 + 136); v5 = (unsigned int)(v5 + 1) )
  {
    ...
    if ( v9 )
    {
      v17 = 0LL;
      v16 = 0LL;
      v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int128 *))(*(_QWORD *)v9 + 272LL))(v9, a2, &v16);
      v4 = v10;
      if ( v10 < 0 )
      {
