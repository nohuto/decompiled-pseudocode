/*
 * XREFs of ?Create@CResampleLayer@@SAJPEAVIDeviceTarget@@AEBUMilPointAndSizeL@@MMW4Enum@CompositionResampleMode@@PEAPEAV1@@Z @ 0x180196128
 * Callers:
...
__int64 __fastcall CResampleLayer::Create(__int64 a1, __int64 a2, float a3, float a4, int a5, __int64 *a6)
{
  ...
  *(_QWORD *)&v27 = "DWM Scratch Rendertarget (ResampleLayer)";
  v15 = CExternalLayer::CreateBitmap(
          (const struct CResourceTag *)&v27,
          &v29,
          (const struct PixelFormatInfo *)v33,
          v14,
          2,
          (CD3DDevice *)v28);
  v17 = v15;
