/*
 * XREFs of ?Present@CCaptureRenderTarget@@UEAAJ_N@Z @ 0x18018BB2C
 * Callers:
 *     ?Present@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EC7E0 (-Present@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 *     ?Present@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJ_N@Z @ 0x1800EC7F0 (-Present@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJ_N@Z.c)
 * Callees:
  ...
  if ( D3DDeviceNoRef && CCaptureRenderTarget::GetCurrentFrameBuffer(v1) )
  {
    ...
    else
    {
      ...
      *((_BYTE *)D3DDeviceNoRef + 1435) = 0;
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x20Du, 0LL);
      }
      else
      {
        v18 = 0;
        ...
        v3 = v14;
        if ( v14 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x218u, 0LL);
      }
    }
  }
