/*
 * XREFs of ?CheckPresentDurationSupport@CLegacySwapChain@@UEBAII@Z @ 0x18024A59C
 * Callers:
 *     ?CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@A@EBAII@Z @ 0x1800EEAC0 (-CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@A@EBAII@Z.c)
 * Callees:
