/*
 * XREFs of ??$_Emplace_reallocate@ULink@CTreeDumpNodeData@@@?$vector@ULink@CTreeDumpNodeData@@V?$allocator@ULink@CTreeDumpNodeData@@@std@@@std@@QEAAPEAULink@CTreeDumpNodeData@@QEAU23@$$QEAU23@@Z @ 0x18019ABAC
 * Callers:
 ...
 *     ??$_Uninitialized_move@PEAULink@CTreeDumpNodeData@@PEAU12@V?$allocator@ULink@CTreeDumpNodeData@@@std@@@std@@YAPEAULink@CTreeDumpNodeData@@QEAU12@0PEAU12@AEAV?$allocator@ULink@CTreeDumpNodeData@@@0@@Z @ 0x18019B5D4 (--$_Uninitialized_move@PEAULink@CTreeDumpNodeData@@PEAU12@V-$allocator@ULink@CTreeDumpNodeData@@.c)
 *     ?_Change_array@?$vector@ULink@CTreeDumpNodeData@@V?$allocator@ULink@CTreeDumpNodeData@@@std@@@std@@AEAAXQEAULink@CTreeDumpNodeData@@_K1@Z @ 0x18019C024 (-_Change_array@-$vector@ULink@CTreeDumpNodeData@@V-$allocator@ULink@CTreeDumpNodeData@@@std@@@st.c)
 */
