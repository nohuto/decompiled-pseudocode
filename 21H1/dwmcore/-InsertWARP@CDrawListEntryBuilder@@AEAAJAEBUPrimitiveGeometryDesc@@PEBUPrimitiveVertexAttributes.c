/*
 * XREFs of ?InsertWARP@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1801A0CFC
 * Callers:
 ...
 * Callees:
 *     ?TransformEdgeFlags_AxisAlignedPreserving@D2DMatrixHelper@@YAIIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x180012928 (-TransformEdgeFlags_AxisAlignedPreserving@D2DMatrixHelper@@YAIIAEBUD2D_MATRIX_3X2_F@@@Z.c)
 *     ?TransformRect_AxisAlignedPreserving@D2DMatrixHelper@@YAXAEBUD2D_RECT_F@@AEBUD2D_MATRIX_3X2_F@@PEAU2@@Z @ 0x1800132EC (-TransformRect_AxisAlignedPreserving@D2DMatrixHelper@@YAXAEBUD2D_RECT_F@@AEBUD2D_MATRIX_3X2_F@@P.c)
 ...
 *     ??0WARPDrawListEntryParams@@QEAA@XZ @ 0x1801A0984 (--0WARPDrawListEntryParams@@QEAA@XZ.c)
 ...
 *     ?ToD2D1ExtendMode@ExtendMode@@YA?AW4D2D1_EXTEND_MODE@@W4Enum@1@@Z @ 0x1801A1D98 (-ToD2D1ExtendMode@ExtendMode@@YA-AW4D2D1_EXTEND_MODE@@W4Enum@1@@Z.c)
 *     ?ToD2D1InterpolationMode@InterpolationMode@@YA?AW4D2D1_INTERPOLATION_MODE@@W4Enum@1@@Z @ 0x1801A1DBC (-ToD2D1InterpolationMode@InterpolationMode@@YA-AW4D2D1_INTERPOLATION_MODE@@W4Enum@1@@Z.c)
            ...
            do
            {
              ...
              if ( _bittest(&v29, v27) )
              {
                *(_QWORD *)&v54.left = gsl::span<PrimitiveUVDesc,-1>::operator[]((unsigned __int64 *)v53, v10);
                if ( memcmp_0(*(const void **)&v54.left, &unk_180348850, 0x24uLL) )
                {
                  v30 = 104 * v10;
                  v31 = (char *)v25 + 2 * v27;
                  v32 = v31[v27 + 114];
                  v51 = *(_WORD *)&v31[v27 + 112];
                  CDrawListBitmap::operator=((__int64 *)&v62[v30], (__int64 *)v50 + 6 * v27 + 2);
