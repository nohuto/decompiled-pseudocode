/*
 * XREFs of dllmain_crt_process_attach @ 0x1800E1858
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x1800E1688 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800E1728 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x1800E1F60 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800E2320 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800E2348 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800E236C (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x1800E237C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800E2496 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800E24A2 (_initterm_e_0.c)
