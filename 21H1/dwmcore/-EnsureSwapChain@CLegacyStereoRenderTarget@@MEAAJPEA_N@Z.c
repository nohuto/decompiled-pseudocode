/*
 * XREFs of ?EnsureSwapChain@CLegacyStereoRenderTarget@@MEAAJPEA_N@Z @ 0x180191C60
 * Callers:
 *     <none>
 * Callees:
      ...
      else
      {
        ...
        *((_BYTE *)this + 18591) = 0;
        ...
        if ( v13 >= 0 )
        {
          ...
          if ( Device < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802F18B0, 3u, Device, 0x6Bu, 0LL);
            v28 = v36;
            if ( !v36 )
              goto LABEL_31;
          }
          else
          {
            ...
            *((_QWORD *)this + 2327) = 0LL;
            ...
            {
              MilInstrumentationCheckHR_MaybeFailFast(v24, &dword_1802F18B0, 3u, LegacyStereoSwapChain, 0x72u, 0LL);
            }
            else
            {
              ...
              if ( v25 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_1802F18B0, 3u, v25, 0x76u, 0LL);
              }
              else
              {
...
LABEL_31:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802F18B0, 3u, v29, v34, 0LL);
    goto LABEL_31;
  }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802F18B0, 3u, v7, 0x4Fu, 0LL);
LABEL_32:
  if ( DXGIOutput < 0 )
  {
