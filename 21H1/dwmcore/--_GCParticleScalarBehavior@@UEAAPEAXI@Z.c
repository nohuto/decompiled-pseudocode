/*
 * XREFs of ??_GCParticleScalarBehavior@@UEAAPEAXI@Z @ 0x180171C00
 * Callers:
 *     ??_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z @ 0x1800EBF20 (--_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
