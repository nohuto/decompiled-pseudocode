/*
 * XREFs of ?BuildInteractionChainAndUpdateTree@CManipulationContext@@SAXPEAVCDesktopTree@@PEAVCInteraction@@IW4InputType@@_NPEAVCInteractionChain@@PEA_N@Z @ 0x1802347D8
 * Callers:
 ...
 *     ?IsStrictlyHoverPointerSource@CInteraction@@QEBA_NXZ @ 0x180235790 (-IsStrictlyHoverPointerSource@CInteraction@@QEBA_NXZ.c)
