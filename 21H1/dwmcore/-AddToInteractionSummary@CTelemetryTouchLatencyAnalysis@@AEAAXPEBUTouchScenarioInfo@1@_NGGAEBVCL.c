/*
 * XREFs of ?AddToInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAXPEBUTouchScenarioInfo@1@_NGGAEBVCLatencyInfo@1@I@Z @ 0x180161100
 * Callers:
 ...
 *     ?UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_NI@Z @ 0x180165B08 (-UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLate.c)
 */
...
LABEL_17:
  ...
  if ( (unsigned int)((PerformanceCount.QuadPart - *((_QWORD *)v10 + 526)) / (qword_180349400 / 0x3E8uLL)) >= 0xEA60
    || *((_BYTE *)v10 + 4216) == 5 )
  {
    CTelemetryTouchLatencyAnalysis::SendInteractionSummary(v10);
