/*
 * XREFs of ?ProcessSetColorTransform@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETCOLORTRANSFORM@@@Z @ 0x1801B2544
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETCOLORTRANSFORM *a3)
{
  ...
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x18u)) != 0LL )
  {
    ...
    if ( Resource != ColorTransform )
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0xCDAu, 0LL);
      }
      else
      {
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0xCD2u, 0LL);
  }
  return v4;
}
