/*
 * XREFs of ?MagnifierRenderTargetSetTransform@CChannel@@UEAAJII@Z @ 0x180153A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetTransform(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
