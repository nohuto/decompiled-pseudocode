/*
 * XREFs of ?Calculate@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x1800994BC
 * Callers:
 ...
 *     ?GetIsComplete@Timer@@QEBA_NXZ @ 0x18009968C (-GetIsComplete@Timer@@QEBA_NXZ.c)
