/*
 * XREFs of ?ScheduleCompositionPass@CPartitionVerticalBlankScheduler@@UEAAXKW4CompositionReason@@@Z @ 0x1800B9500
 * Callers:
...
LABEL_2:
  ...
  v7 = a3 | dword_180349730;
  result = (unsigned int)~_InterlockedOr(&dword_180349730, a3);
