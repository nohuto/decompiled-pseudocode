/*
 * XREFs of ??$RenderLoop@$0A@@CDrawListEntryBatch@@AEAAJAEAVCD3DBatchExecutionContext@@@Z @ 0x1801AE6E0
 * Callers:
...
LABEL_11:
    if ( a2[10] < 0 )
    {
      ...
      if ( v17 >= 0 )
        goto LABEL_15;
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x164u, 0LL);
    }
    if ( v4 < 0 )
    {
      v19 = 0LL;
