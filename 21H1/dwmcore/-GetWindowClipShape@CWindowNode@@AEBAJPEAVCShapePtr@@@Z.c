/*
 * XREFs of ?GetWindowClipShape@CWindowNode@@AEBAJPEAVCShapePtr@@@Z @ 0x180095B40
 * Callers:
 ...
 *     ?Offset@CRegionShape@@QEAAJJJ@Z @ 0x1800EB950 (-Offset@CRegionShape@@QEAAJJJ@Z.c)
...
__int64 __fastcall CWindowNode::GetWindowClipShape(CWindowNode *this, struct CShapePtr *a2)
{
  ...
  const struct FastRegion::Internal::CRgnData *v27; // [rsp+70h] [rbp-19h] BYREF
  ...
  else
  {
    ...
    v27 = (const struct FastRegion::Internal::CRgnData *)&v28;
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, ShapeData, 0x90Eu, 0LL);
    }
    else
    {
      v13 = CShape::Combine(v21, v11, (__int64)v26, 0LL, 1, &v20);
      v5 = v13;
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x914u, 0LL);
      }
      else if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_OffsetFixSetWindowRgn_31015038>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_Servicing_OffsetFixSetWindowRgn_31015038>::GetImpl'::`2'::impl)
             && ((v15 = *((_DWORD *)this + 161) - *((_DWORD *)this + 173),
                  *((_DWORD *)this + 160) != *((_DWORD *)this + 172))
              || v15)
             && (v16 = CRegionShape::Offset(v20, *((_DWORD *)this + 160) - *((_DWORD *)this + 172), v15),
                 v5 = v16,
                 v16 < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x922u, 0LL);
      }
      else
      {
        v18 = v20;
