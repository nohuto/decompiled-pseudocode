/*
 * XREFs of ?GenerateGridAntialiasBorder@Mesh@@AEBAX_NAEBV?$StridedSpan@UVertexXYW_ColorDW@@@@AEBV?$StridedSpan@UVertexAAFixupBase@@@@PEAHPEAGH3@Z @ 0x1800B4F74
 * Callers:
 ...
 * Callees:
 *     OffsetBaseVertices @ 0x1800B551C (OffsetBaseVertices.c)
 *     CopyBaseVertices @ 0x1800B55D4 (CopyBaseVertices.c)
