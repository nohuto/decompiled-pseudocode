/*
 * XREFs of ??0CCompositionTextLine@@QEAA@PEAVCComposition@@@Z @ 0x18016E9B4
 * Callers:
 ...
 * Callees:
 *     ??0CTextObject@@QEAA@PEAVCComposition@@@Z @ 0x18016F964 (--0CTextObject@@QEAA@PEAVCComposition@@@Z.c)
 */
