/*
 * XREFs of ?AddOverdrawToDirtyRegion@CDirectFlipInfo@@QEAAJPEAVCDirtyRegion@@AEBVCMILMatrix@@@Z @ 0x1801880B0
 * Callers:
        ...
        const struct CMILMatrix *a3)
{
  ...
  __int128 v21; // [rsp+C0h] [rbp+17h] BYREF
  _DWORD v22[4]; // [rsp+D0h] [rbp+27h] BYREF

  v3 = 0;
  if ( (*((_DWORD *)this + 13) == 3 || *((_DWORD *)this + 13) == 4 && CDirectFlipInfo::RenderingRealizationChanged(this))
    && *((_QWORD *)this + 4) )
  {
    v20 = 0;
    ...
    while ( (unsigned __int64)v16 < v15 )
    {
      ...
      for ( i = 0LL; i < 4; ++i )
        *(float *)&v22[i] = (float)(int)v13[i];
      v21 = 0LL;
      CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)v19, (__int64)v22, (float *)&v21);
      v10 = CDirtyRegion::Add(a2);
      v3 = v10;
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v11, 0LL, 0, v10, 0x1D2u, 0LL);
        return v3;
      }
