/*
 * XREFs of ?MagnifierRenderTargetSetFilterList@CChannel@@UEAAJII@Z @ 0x180153910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetFilterList(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
