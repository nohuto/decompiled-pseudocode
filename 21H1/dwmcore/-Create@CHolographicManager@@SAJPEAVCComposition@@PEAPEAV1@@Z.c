/*
 * XREFs of ?Create@CHolographicManager@@SAJPEAVCComposition@@PEAPEAV1@@Z @ 0x1800AFE5C
 * Callers:
 ...
 *     ??0CHolographicManager@@AEAA@PEAVCComposition@@@Z @ 0x1800AFEFC (--0CHolographicManager@@AEAA@PEAVCComposition@@@Z.c)
