/*
 * XREFs of ?UnpinResources@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_N@Z @ 0x1801FCC70
 * Callers:
 ...
 *     ?UnpinResources@CGlobalCompositionSurfaceInfo@@UEAAJ_N@Z @ 0x1801FCD60 (-UnpinResources@CGlobalCompositionSurfaceInfo@@UEAAJ_N@Z.c)
 * Callees:
