/*
 * XREFs of ?BeginFrame@CDrawingContext@@QEAAJPEAVIDeviceTarget@@PEBVCMILMatrix@@PEBU_D3DCOLORVALUE@@PEAVCOverlayContext@@@Z @ 0x18004EDE4
 * Callers:
        ...
        struct COverlayContext *a5)
{
  ...
  *((_QWORD *)this + 435) = 0LL;
  if ( dword_18034D258 > *(_DWORD *)(v23 + 4) )
  {
    Init_thread_header(&dword_18034D258);
    if ( dword_18034D258 == -1 )
    {
      v33 = CProcessAttributionManager::CreateProcessAttribution(
              v22,
              0xFFFFFFFF,
              (const struct CProcessAttributionManager::ProcessAttributionRecord *)&unk_1803496C0,
              0,
              &v45);
      if ( v33 < 0 )
        ModuleFailFastForHRESULT((unsigned int)v33, retaddr);
      qword_180349668 = (__int64)v45;
      Init_thread_footer(&dword_18034D258);
    }
  }
  v24 = (struct CProcessAttribution *)qword_180349668;
  LODWORD(v42) = 11;
  v43 = 0LL;
