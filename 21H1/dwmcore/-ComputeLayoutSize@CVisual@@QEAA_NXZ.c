/*
 * XREFs of ?ComputeLayoutSize@CVisual@@QEAA_NXZ @ 0x1800C7098
 * Callers:
 *     ?EnsureRootLayoutSize@CPreComputeContext@@AEAAJXZ @ 0x1800695B4 (-EnsureRootLayoutSize@CPreComputeContext@@AEAAJXZ.c)
 *     ?UpdateRelativeLayout@CPreComputeHelper@@IEAAXPEAVCVisual@@@Z @ 0x18019ECF0 (-UpdateRelativeLayout@CPreComputeHelper@@IEAAXPEAVCVisual@@@Z.c)
 * Callees:
