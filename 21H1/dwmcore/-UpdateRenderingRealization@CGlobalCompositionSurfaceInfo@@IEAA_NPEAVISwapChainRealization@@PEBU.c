/*
 * XREFs of ?UpdateRenderingRealization@CGlobalCompositionSurfaceInfo@@IEAA_NPEAVISwapChainRealization@@PEBUCSM_BUFFER_ATTRIBUTES@@PEAUHRGN__@@PEBUScrollOptimization@@@Z @ 0x180076B30
 * Callers:
...
LABEL_6:
  ...
  if ( (unsigned __int8)operator!=(&v49, &v48) || !(unsigned __int8)CMILMatrix::IsEqualTo<0>(v44, v42) )
    v9 = 1;
  v16 = v37;
  if ( v37
