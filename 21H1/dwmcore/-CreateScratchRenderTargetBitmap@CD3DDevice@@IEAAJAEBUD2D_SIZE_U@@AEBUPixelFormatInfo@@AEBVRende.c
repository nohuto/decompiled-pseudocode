/*
 * XREFs of ?CreateScratchRenderTargetBitmap@CD3DDevice@@IEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x1800D69BC
 * Callers:
...
LABEL_11:
    v19 = v12;
LABEL_14:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802ADB18, 2u, v19, v21, 0LL);
  }
  v17 = CD3DDevice::TranslateDXGIorD3DErrorInContext((__int64)this, v8, 0);
