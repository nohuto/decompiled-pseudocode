/*
 * XREFs of ?UpdateBoundTrackerScale@CInteractionTrackerBindingManager@@QEAAXPEAVCInteractionTracker@@M_N@Z @ 0x1801D44C8
 * Callers:
    ...
    *(_WORD *)(v7 + 24) = 257;
    ...
    while ( v9 != v8 )
    {
      ...
      if ( (struct CInteractionTracker *)v10 != a2 )
      {
        ...
        CInteractionTracker::SetScale(v10, a3 * *(float *)(v10 + 128), 1);
      }
      *(_BYTE *)(v10 + 532) &= ~4u;
      *(_BYTE *)(v10 + 532) |= 4 * a4;
