/*
 * XREFs of ?RetireScenario@CTelemetryTouchLatencyAnalysis@@AEAAXPEAUTouchScenarioInfo@1@_N1@Z @ 0x18002467C
 * Callers:
 *     ?TimeoutOverdueScenarios@CTelemetryTouchLatencyAnalysis@@QEAAX_K@Z @ 0x18001C800 (-TimeoutOverdueScenarios@CTelemetryTouchLatencyAnalysis@@QEAAX_K@Z.c)
        ...
        bool a4)
{
  ...
  if ( a2[4].QuadPart || a2[12].LowPart == 2 )
  {
    ...
    else if ( v23 > 5 && (qword_180346E58 & 8) != 0 && (v24 & 8) == v24 )
    {
      v30 = a2[25];
