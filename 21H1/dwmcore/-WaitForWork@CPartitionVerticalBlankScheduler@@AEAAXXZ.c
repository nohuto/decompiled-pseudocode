/*
 * XREFs of ?WaitForWork@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18003E62C
 * Callers:
 ...
 *     ?UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z @ 0x18016733C (-UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z.c)
  ...
  if ( (char *)hObject - 1 > (char *)0xFFFFFFFFFFFFFFFDLL )
  {
    if ( qword_18034D5B8 )
    {
      ...
      else
      {
        ...
        {
          if ( EventW != (char *)-1LL
            && (*(int (__fastcall **)(CDisplayManager *, char *, int *))(*(_QWORD *)qword_18034D5B8 + 176LL))(
                 qword_18034D5B8,
                 EventW,
                 &dword_18034D5C8) >= 0 )
          {
