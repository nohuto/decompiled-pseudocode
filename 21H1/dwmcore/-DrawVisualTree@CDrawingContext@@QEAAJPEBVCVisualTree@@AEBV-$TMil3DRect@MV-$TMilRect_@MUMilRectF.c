/*
 * XREFs of ?DrawVisualTree@CDrawingContext@@QEAAJPEBVCVisualTree@@AEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@PEBVCOcclusionContext@@W4Enum@ClearMode@@_N@Z @ 0x18004D8A0
 * Callers:
        ...
        char a6)
{
  ...
  *(float *)&v86[12] = (float)v28;
  if ( (float)v27 > (float)v25 && (float)v28 > (float)v26 )
  {
    ...
    if ( v29 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0x1282u, 0LL);
    }
    else
    {
      v8 = 1;
      v31 = CDrawingContext::PushGpuClipRectInternal((__int64)this, 0LL, (float *)v86, 1, 0);
      v7 = v31;
      if ( v31 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, v31, 0x1285u, 0LL);
      }
      else
      {
        v10 = 1;
        ...
        else if ( a5 == 2 )
        {
          ...
          if ( v61 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v62, 0LL, 0, v61, 0x128Fu, 0LL);
            goto LABEL_67;
          }
        }
        v47 = *((_QWORD *)this + 741);
        ...
        if ( v51 <= 1 )
        {
          *((_DWORD *)this + 1486) = 0;
          if ( a6 )
          {
            ...
            *(_DWORD *)&v86[16] = 1;
            ...
            if ( v63 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v64, 0LL, 0, v63, 0x12A9u, 0LL);
              goto LABEL_67;
            }
            v47 = *((_QWORD *)this + 741);
            v11 = 1;
          ...
          *((_QWORD *)this + 420) = v47;
          ...
          if ( v52 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v53, 0LL, 0, v52, 0x12B2u, 0LL);
          }
          else
          {
...
LABEL_68:
              ...
              MilInstrumentationCheckHR_MaybeFailFast(v78, 0LL, 0, v77, 0x12B9u, 0LL);
            }
          }
        }
      }
