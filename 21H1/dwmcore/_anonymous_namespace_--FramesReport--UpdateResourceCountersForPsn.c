/*
 * XREFs of _anonymous_namespace_::FramesReport::UpdateResourceCountersForPsn @ 0x18002AB64
 * Callers:
 *     _lambda_5fcd38f73916aa9cc2ab190da74b00ea_::operator() @ 0x18002AA34 (_lambda_5fcd38f73916aa9cc2ab190da74b00ea_--operator().c)
 * Callees:
 ...
 *     ?IsLessThan@ResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@SA_NAEBV?$unique_ptr@UResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@U?$default_delete@UResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@@std@@@std@@_K@Z @ 0x1800C30D8 (-IsLessThan@ResourceThresholdForProcessSequenceNumber@CProcessResourceAttributionReporter@@SA_NA.c)
        ...
        __int64 a5)
{
  ...
  _BYTE v34[32]; // [rsp+50h] [rbp-68h] BYREF
