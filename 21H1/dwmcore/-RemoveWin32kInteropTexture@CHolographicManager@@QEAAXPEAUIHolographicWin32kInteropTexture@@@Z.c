/*
 * XREFs of ?RemoveWin32kInteropTexture@CHolographicManager@@QEAAXPEAUIHolographicWin32kInteropTexture@@@Z @ 0x1802552E8
 * Callers:
 *     ?Remove@CHolographicFrameProcessor@@UEAAXXZ @ 0x18025DC00 (-Remove@CHolographicFrameProcessor@@UEAAXXZ.c)
 * Callees:
