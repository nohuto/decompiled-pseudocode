/*
 * XREFs of ?CollectOcclusion@CWindowNode@@UEAAJPEAVCOcclusionContext@@PEAVCOcclusionInfo@@@Z @ 0x18004E030
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  if ( v5 )
  {
    ...
    v8 = v62;
    if ( v62 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v62, 0xF4Cu, 0LL);
  }
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v8, 0x428u, 0LL);
  ...
  if ( (_DWORD)v9 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v67, 0LL, 0, v10, 0x2FCu, 0LL);
  }
LABEL_4:
  v13 = *v11;
  *((_DWORD *)a2 + 214) = 0;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v13, 0LL, 0, v10, 0x429u, 0LL);
  ...
  *((_DWORD *)a3 + 8) = v14;
    ...
    && (int)CCompositionSurfaceBitmap::GetCurrentRenderingRealization((CCompositionSurfaceBitmap *)(v15 + 64), &v111) >= 0 )
  {
    ...
    if ( *((_BYTE *)a2 + 1245) )
    {
      ...
      v118 = _xmm;
      v119 = 32085;
      v73 = CWindowNode::ApplyTextureToLocalTransform((__int64)this, v72, (CMILMatrix *)&v115, 0LL);
      EffectiveBounds = v73;
      if ( v73 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v74, 0LL, 0, v73, 0x448u, 0LL);
        goto LABEL_75;
      }
      v75 = *((_DWORD *)this + 209);
...
LABEL_152:
  ...
  if ( (_DWORD)v19 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v80, 0LL, 0, EffectiveBounds, 0x2FCu, 0LL);
  }
LABEL_10:
  v20 = (__int64)*v11;
  *((_DWORD *)a2 + 214) = 0;
  ...
  *((_DWORD *)a3 + 6) = *((_DWORD *)a2 + 364);
  if ( *((_QWORD *)this + 90) && !*((_BYTE *)this + 914) && (*((_BYTE *)this + 836) & 2) == 0 )
  {
    ...
    *(_QWORD *)&v113.right = __PAIR64__(v22, v21);
    ...
    if ( EffectiveBounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, EffectiveBounds, 0x3A7u, 0LL);
      v20 = 0LL;
    }
    else
    {
    ...
    *(float *)&v112.bottom = (float)bottom;
    if ( !v16 )
    {
      if ( v106 )
      {
        ...
        EffectiveBounds = v59;
        if ( v59 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v59, 0x497u, 0LL);
      }
LABEL_74:
      if ( EffectiveBounds < 0 )
      {
...
LABEL_81:
        if ( EffectiveBounds < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, EffectiveBounds, 0x490u, 0LL);
        goto LABEL_74;
      }
    }
    if ( (float)right > v37 && (float)bottom > v38 )
    {
      ...
      *(_QWORD *)&v115 = __PAIR64__(LODWORD(v45), v44.left);
      ...
      if ( v51 )
      {
        ...
        if ( EffectiveBounds >= 0 )
          goto LABEL_74;
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, EffectiveBounds, 0x681u, 0LL);
      }
    }
LABEL_73:
    if ( EffectiveBounds >= 0 )
      goto LABEL_74;
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, EffectiveBounds, 0x49Bu, 0LL);
    goto LABEL_81;
  }
LABEL_75:
  if ( v111 )
