/*
 * XREFs of ?ProcessSetRoot@CHolographicInteropTexture@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_HOLOGRAPHICINTEROPTEXTURE_SETROOT@@@Z @ 0x18025A4A0
 * Callers:
        ...
        const struct tagMILCMD_HOLOGRAPHICINTEROPTEXTURE_SETROOT *a3)
{
  ...
  if ( v5 )
  {
    ...
    {
      v4 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0xC9u, 0LL);
    }
  }
  return v4;
}
