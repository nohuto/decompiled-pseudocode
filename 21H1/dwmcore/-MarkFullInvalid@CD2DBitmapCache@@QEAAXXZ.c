/*
 * XREFs of ?MarkFullInvalid@CD2DBitmapCache@@QEAAXXZ @ 0x1800C12E4
 * Callers:
 ...
 *     ?MarkFullDirty@CWICBitmapRealization@@UEAAXXZ @ 0x1802641F0 (-MarkFullDirty@CWICBitmapRealization@@UEAAXXZ.c)
 *     ?MarkFullDirty@CDxHandleStereoBitmapRealization@@UEAAXXZ @ 0x180265CD8 (-MarkFullDirty@CDxHandleStereoBitmapRealization@@UEAAXXZ.c)
 * Callees:
 *     <none>
 */
