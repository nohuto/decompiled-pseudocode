/*
 * XREFs of ?CalcCpuClippingTransform@CVisual@@QEAAXW4Enum@CpuClippingMode@@PEBVCVisualTree@@PEBVCMILMatrix@@PEA_NPEAV5@4@Z @ 0x1800591F0
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3AEBU?$_tlgWrapperByVal@$03@@444444444444444@Z @ 0x1801B0BB8 (--$Write@U-$_tlgWrapperByVal@$07@@U1@U-$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U.c)
...
LABEL_11:
  ...
  if ( !v11 || *(_DWORD *)(a1 + 100) == 2 )
  {
    ...
    v24 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)a1 + 224LL))(a1, v19);
    if ( !v21 )
      goto LABEL_98;
    if ( !v22 )
    {
...
LABEL_29:
  if ( (*(_BYTE *)(a1 + 264) & 4) != 0 )
  {
    ...
    if ( a4 && v92 > 4 && (qword_180346F00 & 2) != 0 && (v93 & 2) == v93 )
    {
      v112 = *((_DWORD *)a4 + 14);
