/*
 * XREFs of ?RenderComposeTop@CDDisplayRenderTarget@@IEAAJPEAVCDrawingContext@@PEAVCComposeTop@@_N@Z @ 0x1801909C0
 * Callers:
 ...
 *     ?GetDeviceClipBox@CDDisplayRenderTarget@@UEBA?AV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@XZ @ 0x180172D10 (-GetDeviceClipBox@CDDisplayRenderTarget@@UEBA-AV-$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@R.c)
        ...
        char a4)
{
  ...
  if ( !a4 )
  {
    if ( !CComposeTop::HasNewContent(a3) )
      goto LABEL_25;
    CDDisplayRenderTarget::GetDeviceClipBox((__int64)this + 136, (__int64)&v28);
    v5 = 1;
    ...
    *((float *)&v29 + 3) = v15;
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x3D1u, 0LL);
      return v4;
    }
    v18 = CComposeTop::Render(a3, a2, (char *)this + (*((_BYTE *)this + 11209) != 0 ? 18380LL : 18312LL), &v28);
    v4 = v18;
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x3DCu, 0LL);
    }
    else
    {
      v20 = *(float *)&v28;
      ...
      PixelAlign(v30, &v28);
      v29 = 0LL;
      CDDisplayRenderTarget::NotifyRenderedRect((__int64)this, &v28, 0);
      CDDisplayRenderTarget::RenderTargetRectToDesktopRect(this, v24, v30, &v29);
      v25 = CComposeTop::NewContentRendered(a3);
      v4 = v25;
      if ( v25 >= 0 )
        goto LABEL_25;
      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x3F0u, 0LL);
    }
LABEL_28:
