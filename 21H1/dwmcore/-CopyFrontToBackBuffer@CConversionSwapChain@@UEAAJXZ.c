/*
 * XREFs of ?CopyFrontToBackBuffer@CConversionSwapChain@@UEAAJXZ @ 0x1802500BC
 * Callers:
 *     ?CopyFrontToBackBuffer@CConversionSwapChain@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EF290 (-CopyFrontToBackBuffer@CConversionSwapChain@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
