/*
 * XREFs of ?TransitionDisconnectedTrackersToIdle@CInteractionTrackerBindingManager@@AEAAXPEAVCInteractionTracker@@0@Z @ 0x1801D3F58
 * Callers:
  ...
  *(_WORD *)(v7 + 24) = 257;
  ...
  while ( v10 != v9 )
  {
    ...
    if ( *(_DWORD *)(v11 + 168) == 1 )
    {
      ...
      CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v11, 1u, v13, 1);
      v14 = CInteractionTracker::GetCurrentValue(v11, 2);
      CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v11, 2u, v14, 1);
    }
