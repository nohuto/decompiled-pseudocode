/*
 * XREFs of ?EnsureRenderTarget@CDxHandleAdvancedDirectFlipBitmapRealization@@IEAAJXZ @ 0x180264708
 * Callers:
  ...
  else
  {
    ...
    if ( !*((_QWORD *)this + 48) )
    {
      ...
      *v6 = 0LL;
      ...
      v17 = (**v16)(v16);
      DeviceTextureTarget = CD3DDevice::CreateDeviceTextureTarget(v10, v17, 3u, v14, v15, 0, 0, (_QWORD *)this + 48);
