/*
 * XREFs of ?GetPresentStatisticsDWM@CRemoteRenderTarget@@UEBAJPEAUDXGI_FRAME_STATISTICS_DWM@@PEAU_UNSIGNED_RATIO@@@Z @ 0x1800DF940
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _UNSIGNED_RATIO *a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x17Du, 0LL);
    }
    else
    {
      v10 = DWORD2(v13);
  ...
  {
    v9 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2003304442, 0x189u, 0LL);
  }
  return v9;
}
