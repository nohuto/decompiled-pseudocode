/*
 * XREFs of ?QueryInterface@BamoDataProviderProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180185D50
 * Callers:
 *     ?QueryInterface@BamoDataProviderProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800ECE40 (-QueryInterface@BamoDataProviderProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
