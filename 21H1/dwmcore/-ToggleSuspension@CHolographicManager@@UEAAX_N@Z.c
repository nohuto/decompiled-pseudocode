/*
 * XREFs of ?ToggleSuspension@CHolographicManager@@UEAAX_N@Z @ 0x1800CED20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z @ 0x1802541F4 (-DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z.c)
