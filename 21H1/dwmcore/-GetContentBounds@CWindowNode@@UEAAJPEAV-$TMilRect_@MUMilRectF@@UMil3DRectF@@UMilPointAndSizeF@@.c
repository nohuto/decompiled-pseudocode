/*
 * XREFs of ?GetContentBounds@CWindowNode@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180095750
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HasContent@CCompositionSurfaceBitmap@@QEAA_NXZ @ 0x1801F2678 (-HasContent@CCompositionSurfaceBitmap@@QEAA_NXZ.c)
...
LABEL_4:
  ...
  if ( v7 && CCompositionSurfaceBitmap::HasContent(v7) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, EffectiveBounds, 0x3EDu, 0LL);
      return EffectiveBounds;
    }
...
LABEL_9:
    ...
    *(_QWORD *)&v26 = 0LL;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, WindowClipShape, 0x409u, 0LL);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, TightBounds, 0x40Bu, 0LL);
    }
    CShapePtr::Release((CShapePtr *)&v26);
  }
  return EffectiveBounds;
