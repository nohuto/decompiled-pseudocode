/*
 * XREFs of ?BuildFromRectFs@CShape@@SAJPEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@IPEAPEAV1@@Z @ 0x18025E09C
 * Callers:
  ...
  while ( IsPixelAligned((const struct MilRectF *)(a1 + 16LL * v5)) )
  {
    ...
    if ( v5 )
    {
      ...
      *(_OWORD *)v21 = *(_OWORD *)CMilRectLFromMilRectF(v20, a1);
      ...
      if ( v12 )
      {
        CRegionShape::BuildFromRects(v12, (__int64)v21, 1u);
        *a3 = v12;
      }
      else
      {
