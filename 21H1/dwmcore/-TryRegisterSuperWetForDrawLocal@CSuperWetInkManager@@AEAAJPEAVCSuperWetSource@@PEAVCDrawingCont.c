/*
 * XREFs of ?TryRegisterSuperWetForDrawLocal@CSuperWetInkManager@@AEAAJPEAVCSuperWetSource@@PEAVCDrawingContext@@_NPEA_N@Z @ 0x180199F60
 * Callers:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  wil::com_ptr_t<IMonitorTarget,wil::err_returncode_policy>::com_ptr_t<IMonitorTarget,wil::err_returncode_policy>(
    ...
    v12);
  v13 = v27;
  if ( !v27 || !TryFillRenderState((__int64)a3, a4, (__int64)v30) )
    goto LABEL_22;
  v28 = a2;
  wil::com_ptr_t<IMonitorTarget,wil::err_returncode_policy>::com_ptr_t<IMonitorTarget,wil::err_returncode_policy>(
    &v29,
