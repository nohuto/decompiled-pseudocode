/*
 * XREFs of ?TemporaryInteractionConfigurationUpdate@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x180228E90
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapSz@D@@U?$_tlgWrapperByVal@$07@@U2@U1@U1@U?$_tlgWrapperByVal@$03@@U2@U3@U3@U3@U3@U1@U?$_tlgWrapperByVal@$00@@U1@U1@U1@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@AEBU?$_tlgWrapperByVal@$07@@433AEBU?$_tlgWrapperByVal@$03@@455553AEBU?$_tlgWrapperByVal@$00@@3333333@Z @ 0x180224928 (--$Write@U-$_tlgWrapSz@D@@U-$_tlgWrapperByVal@$07@@U2@U1@U1@U-$_tlgWrapperByVal@$03_ea_180224928.c)
 *     ?InteractionConfigurationUpdateTypeToString@InputTraceLogging@@CAPEBDW4Enum@InteractionConfigurationUpdateType@@@Z @ 0x18022601C (-InteractionConfigurationUpdateTypeToString@InputTraceLogging@@CAPEBDW4Enum@InteractionConfigura.c)
        ...
        const struct CManipulationManager::InteractionUpdate *a1)
{
    ...
    && (*(_QWORD *)(v3 + 24) & 0x800LL) == *(_QWORD *)(v3 + 24) )
  {
    v4 = "Zoom-";
    if ( (v2 & 0x20) == 0 )
      v4 = (const char *)&word_1802CFB96;
    v31 = (__int64)v4;
    v5 = "Zoom+";
    if ( (v2 & 0x10) == 0 )
      v5 = (const char *)&word_1802CFB96;
    v32 = (__int64)v5;
    v6 = "PanY-";
    if ( (v2 & 8) == 0 )
      v6 = (const char *)&word_1802CFB96;
    v33 = (__int64)v6;
    v7 = "PanY+";
    if ( (v2 & 4) == 0 )
      v7 = (const char *)&word_1802CFB96;
    v34 = (__int64)v7;
    v8 = "PanX-";
    if ( (v2 & 2) == 0 )
      v8 = (const char *)&word_1802CFB96;
    v35 = (__int64)v8;
    v9 = "PanX+";
    if ( (v2 & 1) == 0 )
      v9 = (const char *)&word_1802CFB96;
    v10 = *((_DWORD *)a1 + 11);
    v36 = (__int64)v9;
    if ( v10 )
    {
    ...
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapSz<char>,_tlgWrapperByVal<1>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapSz<char>>(
      v28,
      (unsigned __int8 *)dword_1802EB83C,
      v27,
      v28,
