/*
 * XREFs of ?QueryInterface@CLegacySwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003CB60
 * Callers:
 *     ?QueryInterface@CLegacySwapChain@@$4PPPPPPPM@BCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EEC60 (-QueryInterface@CLegacySwapChain@@$4PPPPPPPM@BCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
