/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800A3F68
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(const char *a1, unsigned __int16 a2)
{
  ...
  {
    v2 = (const struct CCommonRegistryData::GpuId *)&unk_18030643C;
    CCommonRegistryData::m_cShaderLinkingBlacklistedGpuIds = 0;
    CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_18030643C;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
