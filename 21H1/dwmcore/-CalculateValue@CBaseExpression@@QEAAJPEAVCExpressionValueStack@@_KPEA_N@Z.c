/*
 * XREFs of ?CalculateValue@CBaseExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1800423A0
 * Callers:
 ...
 *     ?IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z @ 0x1800432A0 (-IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z.c)
        ...
        bool *a4)
{
  ...
  *(_DWORD *)v54 = *((_DWORD *)a2 + 4);
  if ( !*((_QWORD *)this + 34) )
    *((_QWORD *)this + 34) = a3;
  (*(void (__fastcall **)(CBaseExpression *, bool *))(*(_QWORD *)this + 272LL))(this, &v54[4]);
...
LABEL_16:
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_18028C560, 2u, v13, 0x401u, 0LL);
    goto LABEL_46;
  }
  if ( !v11 )
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, &dword_18028C560, 2u, v13, 0x408u, 0LL);
    goto LABEL_46;
  }
  if ( v5.QuadPart )
  {
  ...
  {
    v13 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v37, &dword_18028C560, 2u, -2147024890, 0x422u, 0LL);
    v42 = v62;
    if ( !v62 )
      goto LABEL_46;
    goto LABEL_80;
...
LABEL_76:
  ...
  if ( v63 != *((_DWORD *)this + 36) )
  {
    ...
    v53 = 1071;
LABEL_78:
    MilInstrumentationCheckHR_MaybeFailFast(v39, &dword_18028C560, 2u, v41, v53, 0LL);
    v42 = v62;
    if ( v62 )
    {
      v62 = 0LL;
...
LABEL_24:
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_18028C560, 2u, -2147467259, 0x448u, 0LL);
    goto LABEL_47;
  }
  if ( v17 )
  {
...
LABEL_30:
  ...
  if ( v21 )
  {
    ...
    v45 = StringCchPrintfW(Name, 0x3CuLL, L"DwmExpression_SetValue_%d", TracingCookie);
    v27 = v45;
    if ( v45 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v46, 0LL, 0, v45, 0x201u, 0LL);
      goto LABEL_37;
    }
...
LABEL_36:
  ...
  if ( v24 )
  {
    ...
    if ( v25 )
    {
      ...
      if ( v26 >= 0 )
        goto LABEL_36;
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v26, 0x213u, 0LL);
LABEL_37:
      v13 = v27;
      if ( v27 >= 0 )
      {
  ...
  v13 = -2147024890;
  v27 = -2147024890;
  MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, -2147024890, 0x212u, 0LL);
LABEL_104:
  MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_18028C560, 2u, v27, 0x455u, 0LL);
LABEL_47:
  v28 = *((_DWORD *)a2 + 4);
  if ( v28 > v20 )
  {
