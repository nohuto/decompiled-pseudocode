/*
 * XREFs of ?DwmHolographicViewerRemove_@CompositorTracing@@QEAAXI@Z @ 0x180254318
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicViewerRemove_(CompositorTracing *this, int a2)
{
    ...
    && (*(_QWORD *)(v3 + 24) & 0x400000000000LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v4 = a2;
    v7 = 4;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1802EE20D, 0LL, 0LL, 3u, &v5);
  }
}
