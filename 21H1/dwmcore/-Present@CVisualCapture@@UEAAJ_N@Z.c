/*
 * XREFs of ?Present@CVisualCapture@@UEAAJ_N@Z @ 0x1801F5BE0
 * Callers:
 *     ?Present@CVisualCapture@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EE1C0 (-Present@CVisualCapture@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
