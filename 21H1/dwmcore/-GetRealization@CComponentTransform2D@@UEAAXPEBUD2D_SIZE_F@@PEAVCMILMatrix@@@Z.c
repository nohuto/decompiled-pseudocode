/*
 * XREFs of ?GetRealization@CComponentTransform2D@@UEAAXPEBUD2D_SIZE_F@@PEAVCMILMatrix@@@Z @ 0x1801BC880
 * Callers:
 *     <none>
 * Callees:
 *     ?Set2DAffineMatrix@CMILMatrix@@QEAAXMMMMMM@Z @ 0x1800C29FC (-Set2DAffineMatrix@CMILMatrix@@QEAAXMMMMMM@Z.c)
