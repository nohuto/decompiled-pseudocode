/*
 * XREFs of ??_ECHolographicFrameProcessor@@MEAAPEAXI@Z @ 0x18025D3C8
 * Callers:
 *     ??_ECHolographicFrameProcessor@@O7EAAPEAXI@Z @ 0x1800EFBA0 (--_ECHolographicFrameProcessor@@O7EAAPEAXI@Z.c)
 * Callees:
