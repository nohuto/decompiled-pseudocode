/*
 * XREFs of ?IsEnabled@CompositorTracing@@SA_NE_K@Z @ 0x1800CED6C
 * Callers:
 *     ?ToggleSuspension@CHolographicManager@@UEAAX_N@Z @ 0x1800CED20 (-ToggleSuspension@CHolographicManager@@UEAAX_N@Z.c)
