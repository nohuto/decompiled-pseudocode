/*
 * XREFs of ?ResetBackBuffer@CLegacyStereoSwapChain@@MEAAJXZ @ 0x18024EAD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLegacyStereoSwapChain::ResetBackBuffer(CLegacyStereoSwapChain *this)
{
  ...
  *v1 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802F1898, 2u, v5, 0xC0u, 0LL);
  }
  else
  {
    v8 = *((_QWORD *)this + 10);
    if ( v8 )
    {
      ...
      *v1 = 0LL;
      ...
      v7 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_1802F1898, 2u, v14, 0xC8u, 0LL);
      else
