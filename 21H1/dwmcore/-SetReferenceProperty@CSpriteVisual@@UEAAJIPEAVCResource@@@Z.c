/*
 * XREFs of ?SetReferenceProperty@CSpriteVisual@@UEAAJIPEAVCResource@@@Z @ 0x1801F1B00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v6 = (*(__int64 (__fastcall **)(CSpriteVisual *, struct CResource *))(*(_QWORD *)this + 320LL))(this, a3);
  if ( v6 < 0 )
  {
    v5 = 37LL;
    goto LABEL_6;
