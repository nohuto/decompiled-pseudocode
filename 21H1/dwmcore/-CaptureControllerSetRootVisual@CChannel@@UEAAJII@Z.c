/*
 * XREFs of ?CaptureControllerSetRootVisual@CChannel@@UEAAJII@Z @ 0x180152CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetRootVisual(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
