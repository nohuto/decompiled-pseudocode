/*
 * XREFs of ??0CComputeScribbleScheduler@@AEAA@PEAUID3D12CommandQueue@@@Z @ 0x1801A7F0C
 * Callers:
 ...
 *     ??$_Alloc_proxy@V?$allocator@U_Container_proxy@std@@@std@@@_Container_base12@std@@QEAAX$$QEAV?$allocator@U_Container_proxy@std@@@1@@Z @ 0x18016C134 (--$_Alloc_proxy@V-$allocator@U_Container_proxy@std@@@std@@@_Container_base12@std@@QEAAX$$QEAV-$a.c)
 */
