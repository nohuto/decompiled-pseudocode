/*
 * XREFs of ?PreCompute@CPreComputeContext@@IEAAJPEAVCDirtyRegion@@@Z @ 0x180068790
 * Callers:
...
__int64 __fastcall CPreComputeContext::PreCompute(CPreComputeContext *this, struct CDirtyRegion *a2)
{
  ...
  *((_DWORD *)this + 2) = 0;
  LODWORD(v125) = 1;
  v6 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 2, &v125);
  v8 = v6;
  if ( v6 < 0 )
  {
  ...
  *((_DWORD *)this + 10) = 0;
  LODWORD(v125) = 1;
  v9 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 10, &v125);
  v8 = v9;
  if ( v9 < 0 )
  {
  ...
  *((_DWORD *)this + 18) = 0;
  LODWORD(v125) = 0;
  v11 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 18, &v125);
  v8 = v11;
  if ( v11 < 0 )
  {
  ...
  *((_DWORD *)this + 50) = 0;
  v125 = 0LL;
  CWatermarkStack<void *,2,2,10>::Push((char *)this + 200, &v125);
  *((_DWORD *)this + 58) = 0;
  *((_DWORD *)this + 66) = 0;
    ...
    for ( j = (const struct CVisual **)*((_QWORD *)v18 + 117); v26 != j; ++v26 )
    {
      ...
      if ( CVisualTree::_IsInTree(*(CVisualTree **)this, *v26, 1) )
      {
        ...
        if ( (**((_DWORD **)v89 + 28) & 0x40000) != 0 )
        {
          ...
          v95 = *(const struct CVisual ****)ProjectedShadowCasters;
