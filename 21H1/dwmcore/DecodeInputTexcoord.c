/*
 * XREFs of DecodeInputTexcoord @ 0x18009ED98
 * Callers:
...
__int64 __fastcall DecodeInputTexcoord(_QWORD *a1, __int64 a2, __int16 a3, __int64 a4)
{
  ...
  __int16 v16; // [rsp+60h] [rbp+20h] BYREF
  ...
  else
  {
    ...
    *((_QWORD *)&v14 + 1) = &v15;
    v15 = 16843008;
    v12 = CShaderLinkingGraphBuilder::AppendNode(a1, v4, (__int64)&word_1802CFB96, a4, (__int64)"GetCubeTexcoord", &v14);
    v8 = v12;
    if ( v12 < 0 )
