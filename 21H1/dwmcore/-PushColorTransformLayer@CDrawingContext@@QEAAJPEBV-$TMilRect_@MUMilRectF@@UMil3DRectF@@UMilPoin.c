/*
 * XREFs of ?PushColorTransformLayer@CDrawingContext@@QEAAJPEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV?$TValueResource@UMilColorTransform@@UtagMILCMD_COLORTRANSFORMRESOURCE@@$0BI@@@@Z @ 0x18017C3FC
 * Callers:
...
__int64 __fastcall CDrawingContext::PushColorTransformLayer(CDrawingContext *this, __int64 a2, __int64 a3)
{
  ...
  v14 = 0LL;
  v16 = 0LL;
  CDrawingContext::GetClipBoundsWorld((__int64)this, (__int64)&v16);
  v6 = AlignRectFToPointAndSizeL(&v16, v15);
  v8 = v6;
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0xD80u, 0LL);
  }
  else
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xD85u, 0LL);
      v3 = v14;
    }
    else
    {
      ...
      if ( v11 >= 0 )
        return v8;
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0xD8Bu, 0LL);
    }
  }
  if ( v3 )
