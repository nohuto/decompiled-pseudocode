/*
 * XREFs of ?CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z @ 0x180210F20
 * Callers:
 ...
 * Callees:
 *     ?AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ @ 0x180210DE4 (-AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ.c)
 */
