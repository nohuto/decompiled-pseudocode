/*
 * XREFs of ?GetBoundsWithEffects@CVisual@@UEBAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x18007D360
 * Callers:
...
__int64 __fastcall CVisual::GetBoundsWithEffects(CLayerVisual *this, __int128 *a2, __int128 *a3)
{
  ...
  *a3 = *a2;
  ...
  else if ( (*(unsigned __int8 (__fastcall **)(CLayerVisual *))(*(_QWORD *)this + 224LL))(this) )
  {
    CLayerVisual::GetAutomaticBoundsExpansion(this);
    if ( !CVisual::GetEffectiveSize(this, &v14, &v16) && !v11 )
      goto LABEL_18;
    v12 = *(__int64 (**)(void))(*(_QWORD *)this + 232LL);
    v15 = v16;
    v13 = *(_QWORD *)v12();
    if ( v13 )
