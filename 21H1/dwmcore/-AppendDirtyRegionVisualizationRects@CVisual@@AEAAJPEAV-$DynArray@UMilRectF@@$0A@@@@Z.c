/*
 * XREFs of ?AppendDirtyRegionVisualizationRects@CVisual@@AEAAJPEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x1801B10E4
 * Callers:
 ...
 *     ??0?$deque@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x1800B0198 (--0-$deque@V-$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@V-$com_pt.c)
 *     __security_check_cookie @ 0x1800E1200 (__security_check_cookie.c)
 *     memmove_0 @ 0x1800EBD77 (memmove_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800EBD90 (_guard_dispatch_icall_nop.c)
 *     ??1?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@QEAA@XZ @ 0x180170054 (--1-$vector@UtagRECT@@V-$allocator@UtagRECT@@@std@@@std@@QEAA@XZ.c)
 *     ?GetDirtyRegionVisualizationData@CVisual@@QEBAPEAV?$deque@V?$tuple@V?$com_ptr_t@VCKeyframeAnimation@@Uerr_returncode_policy@wil@@@wil@@V?$com_ptr_t@VCColorBrush@@Uerr_returncode_policy@wil@@@2@V?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@@std@@V?$allocator@V?$tuple@V?$com_ptr_t@VCKeyframeAnimation@@Uerr_returncode_policy@wil@@@wil@@V?$com_ptr_t@VCColorBrush@@Uerr_returncode_policy@wil@@@2@V?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@@std@@@2@@std@@XZ @ 0x18017BA0C (-GetDirtyRegionVisualizationData@CVisual@@QEBAPEAV-$deque@V-$tuple@V-$com_ptr_t@VCKeyframeAnimat.c)
 *     ?_Buy_raw@?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@AEAAX_K@Z @ 0x18017CE90 (-_Buy_raw@-$vector@UMilRectF@@V-$allocator@UMilRectF@@@std@@@std@@AEAAX_K@Z.c)
...
__int64 __fastcall CVisual::AppendDirtyRegionVisualizationRects(__int64 a1, __int64 a2)
{
  ...
  _QWORD v38[3]; // [rsp+C0h] [rbp-48h] BYREF
  __int64 v39; // [rsp+D8h] [rbp-30h] BYREF
  _QWORD *v40; // [rsp+E0h] [rbp-28h] BYREF
...
LABEL_7:
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x1539u, 0LL);
  }
  else
  {
    ...
    *((_OWORD *)v12 + 5) = v37;
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, -2147024882, 0x1549u, 0LL);
      goto LABEL_29;
    }
    ...
    if ( v18 >= 0 )
    {
      if ( (**(_DWORD **)(a1 + 224) & 0x80000) == 0 )
      {
        ...
        {
          v4 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, -2147024882, 0x155Eu, 0LL);
          goto LABEL_29;
        }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x1559u, 0LL);
  }
LABEL_29:
  if ( v5 )
    operator delete(v5);
