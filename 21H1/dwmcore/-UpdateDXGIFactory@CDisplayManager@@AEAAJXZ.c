/*
 * XREFs of ?UpdateDXGIFactory@CDisplayManager@@AEAAJXZ @ 0x18008AB00
 * Callers:
...
__int64 __fastcall CDisplayManager::UpdateDXGIFactory(CDisplayManager *this)
{
  ...
  else
  {
    ...
    if ( qword_18034D5B8 && !byte_18034D5CD && (char *)hObject - 1 <= (char *)0xFFFFFFFFFFFFFFFDLL )
    {
      (*(void (__fastcall **)(CDisplayManager *, _QWORD))(*(_QWORD *)qword_18034D5B8 + 184LL))(
        qword_18034D5B8,
        (unsigned int)dword_18034D5C8);
      dword_18034D5C8 = 0;
    }
    ...
    byte_18034D5CD = GetSystemMetrics(4096) != 0;
