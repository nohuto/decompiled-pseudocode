/*
 * XREFs of ??$WalkSubtree@VCPreComputeContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@PEAVCPreComputeContext@@W4WalkReason@@@Z @ 0x180064D30
 * Callers:
...
LABEL_88:
    ...
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v50, 0LL, 0, -2147024882, 0x133Eu, 0LL);
LABEL_10:
    if ( v9 < 0 )
      break;
LABEL_11:
