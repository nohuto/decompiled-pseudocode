/*
 * XREFs of ?Initialize@CRenderTargetBitmap@@IEAAXPEAVIDeviceTarget@@@Z @ 0x1800325C8
 * Callers:
...
void __fastcall CRenderTargetBitmap::Initialize(CRenderTargetBitmap *this, struct IDeviceTarget *a2)
{
  ...
  v2 = (char *)this + 136;
  wil::com_ptr_t<IBitmapResource,wil::err_returncode_policy>::operator=((__int64 *)this + 17, (__int64)a2);
