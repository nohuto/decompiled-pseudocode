/*
 * XREFs of ?GetWindowBackgroundTreatmentEffectInput@CDrawingContext@@QEAAJAEBUD2D_SIZE_F@@PEAUEffectInput@@@Z @ 0x180004FF0
 * Callers:
        ...
        struct EffectInput *a3)
{
  ...
  bool v58; // [rsp+4Bh] [rbp-BDh] BYREF
  bool v59[16]; // [rsp+50h] [rbp-B8h] BYREF
  __m256i v60; // [rsp+68h] [rbp-A0h] BYREF
  __int128 v61; // [rsp+88h] [rbp-80h]
  __int128 v62; // [rsp+98h] [rbp-70h]
  int v63; // [rsp+A8h] [rbp-60h]
  _QWORD v64[2]; // [rsp+B8h] [rbp-50h] BYREF
  __int32 v65; // [rsp+C8h] [rbp-40h]
  __int32 v66; // [rsp+CCh] [rbp-3Ch]
  __int64 v67; // [rsp+D0h] [rbp-38h]
  int v68; // [rsp+D8h] [rbp-30h]
  const struct D2D_SIZE_F *v69; // [rsp+E0h] [rbp-28h]
  _OWORD v70[4]; // [rsp+E8h] [rbp-20h] BYREF
  int v71; // [rsp+128h] [rbp+20h]
  _BYTE v72[24]; // [rsp+138h] [rbp+30h] BYREF
  struct CCachedWindowBackgroundTreatment *v73[2]; // [rsp+150h] [rbp+48h] BYREF
  __int128 v74; // [rsp+160h] [rbp+58h] BYREF
  __int128 v75; // [rsp+170h] [rbp+68h] BYREF
  ...
  v71 = 0;
  v8 = 0LL;
  *(_OWORD *)v60.m256i_i8 = _xmm;
  v61 = _xmm;
  v69 = a2;
  *(_OWORD *)&v60.m256i_u64[2] = _xmm;
  *(_OWORD *)&v72[8] = *(__int128 *)((char *)&TMil3DRect<float,TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcEmpty
                                   + 8);
  *(_QWORD *)v72 = TMil3DRect<float,TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcEmpty;
  *(_OWORD *)v59 = 0LL;
  LOWORD(v63) = 32085;
  v62 = _xmm;
  ...
  *((FLOAT *)&v75 + 3) = height;
  ...
  if ( *(float *)&v74 < 0.0 )
    v12 = *(float *)v73;
  v13 = *((float *)&v74 + 1);
  if ( *((float *)v73 + 1) > *((float *)&v74 + 1) )
    v13 = *((float *)v73 + 1);
  v14 = *((float *)&v74 + 2);
  if ( *((float *)&v74 + 2) > *(float *)&v73[1] )
    v14 = *(float *)&v73[1];
  v15 = *((float *)&v74 + 3);
  if ( *((float *)&v74 + 3) > *((float *)&v73[1] + 1) )
    v15 = *((float *)&v73[1] + 1);
  if ( v14 <= v12 || v15 <= v13 )
    goto LABEL_56;
  v16 = 0;
  ...
  do
  {
    if ( (**((_DWORD **)CurrentVisual + 28) & 0x200000) != 0 )
      break;
    CVisual::CalcCpuClippingTransform(CurrentVisual, 5LL, this[741]);
    CMILMatrix::Multiply((const struct CMILMatrix *)&v60, (const struct CMILMatrix *)v70, (struct CMILMatrix *)&v60);
    TreeData = CVisual::FindTreeData(CurrentVisual, this[741]);
    if ( TreeData && CVisual::GetParentTreeData(CurrentVisual, this[741], TreeData, &v58) && v58 )
      v16 = 1;
...
LABEL_62:
    ...
    if ( CachedWindowBackgroundTreatment )
    {
      if ( !*((_BYTE *)CachedWindowBackgroundTreatment + 140) )
      {
        ...
        {
          *(_OWORD *)v59 = *(_OWORD *)((char *)CachedWindowBackgroundTreatment + 124);
        }
        goto LABEL_25;
      }
    }
  ...
  RealizationForEffectInput = CWindowBackgroundTreatment::GetRealizationForEffectInput(
                                ...
                                this[4]);
  v73[0] = RealizationForEffectInput;
  if ( !RealizationForEffectInput )
  {
    *(_OWORD *)v59 = *(_OWORD *)(*((_QWORD *)WindowBackgroundTreatmentInternal + 8) + 80LL);
LABEL_50:
    v9 = 0;
    goto LABEL_25;
  }
...
LABEL_25:
    if ( v8 )
    {
      ...
      v26 = *((float *)&v74 + 1) - v6;
      v27 = *((float *)&v74 + 2) - v4;
      *((float *)a3 + 27) = *(float *)&v74 - v4;
      *((float *)a3 + 28) = v26;
      *((float *)a3 + 29) = v27;
      *((float *)a3 + 30) = v25;
      v64[0] = v60.m256i_i64[0];
      v64[1] = *(__int64 *)((char *)&v60.m256i_i64[1] + 4);
      v65 = v60.m256i_i32[5];
      v66 = v60.m256i_i32[7];
      v67 = v62;
      v68 = HIDWORD(v62);
      v75 = _xmm;
      LODWORD(v76) = LODWORD(v4) ^ _xmm;
      LODWORD(v77) = LODWORD(v6) ^ _xmm;
      v28 = Matrix3x3::operator*(v64, v70, &v75);
      *(_QWORD *)((char *)&v75 + 4) = 0LL;
      *(float *)&v75 = 1.0 / v23;
      *((float *)&v75 + 3) = 1.0 / v24;
      v76 = 0.0 - (float)((float)(1.0 / v23) * 0.0);
      v77 = 0.0 - (float)((float)(1.0 / v24) * 0.0);
      v29 = Matrix3x3::operator*(v28, v64, &v75);
  ...
  if ( CMILMatrix::Invert((CMILMatrix *)v70) )
  {
    ...
    CMILMatrix::Multiply(v43, (const struct CMILMatrix *)v70, (struct CMILMatrix *)&v60);
    RealizationForEffectInput = v73[0];
    goto LABEL_24;
  }
  v30 = 1;
  v9 = 0;
LABEL_28:
    ...
    && !v9 )
  {
    ...
    v73[0] = CVisual::GetCachedWindowBackgroundTreatment(v31);
    if ( v73[0] )
    {
      CVisual::GetWindowBackgroundTreatmentInternal(CurrentVisual);
      v33 = CCachedWindowBackgroundTreatment::Update(v32, (__int64)v72, (__int64)v59);
      v35 = v33;
      if ( v33 < 0 )
      {
    ...
    else
    {
      ...
      v45 = CCachedWindowBackgroundTreatment::Create((__int64)v44, (__int64)v8, (int)&v60, (float *)v72, v59, v73);
      v35 = v45;
      if ( v45 < 0 )
      {
      ...
      CVisual::SetCachedWindowBackgroundTreatment(v47, v73[0]);
    }
  }
  if ( v8 )
  {
