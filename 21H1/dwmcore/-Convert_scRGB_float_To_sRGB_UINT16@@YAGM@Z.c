/*
 * XREFs of ?Convert_scRGB_float_To_sRGB_UINT16@@YAGM@Z @ 0x180220B6C
 * Callers:
 *     ?GammaConvert_128bppABGR_64bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x18021C950 (-GammaConvert_128bppABGR_64bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z.c)
 * Callees:
