/*
 * XREFs of ?SetStateOnDevice@CBrushRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x180046C80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v33, 0LL, 0, v27, 0x73u, 0LL);
        goto LABEL_41;
      }
      v36 = v64;
      if ( v29 > 1 )
