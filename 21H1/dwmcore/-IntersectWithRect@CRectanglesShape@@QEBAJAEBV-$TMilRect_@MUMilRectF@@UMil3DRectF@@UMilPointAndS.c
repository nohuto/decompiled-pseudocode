/*
 * XREFs of ?IntersectWithRect@CRectanglesShape@@QEBAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAVCShape@@@Z @ 0x18025DE70
 * Callers:
...
__int64 __fastcall CRectanglesShape::IntersectWithRect(struct CRectanglesShape *a1, float *a2, CRectanglesShape **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    if ( v4 == (__int128 *)v3
      || (v25 = CRectanglesShape::BuildFromRectFs(v23, (__int64)v4, (v3 - (char *)v4) >> 4), v6 = v25, v25 >= 0) )
    {
      v24 = 0LL;
      *v31 = v23;
      v23 = 0LL;
  ...
  if ( v4 )
    std::_Deallocate<16,0>(v4, (v5 - (char *)v4) & 0xFFFFFFFFFFFFFFF0uLL);
  return v6;
}
