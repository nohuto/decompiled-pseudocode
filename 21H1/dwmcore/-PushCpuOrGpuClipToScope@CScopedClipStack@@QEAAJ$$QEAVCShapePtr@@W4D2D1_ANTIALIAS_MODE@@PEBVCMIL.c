/*
 * XREFs of ?PushCpuOrGpuClipToScope@CScopedClipStack@@QEAAJ$$QEAVCShapePtr@@W4D2D1_ANTIALIAS_MODE@@PEBVCMILMatrix@@PEA_N3@Z @ 0x180059AF0
 * Callers:
        ...
        *(_OWORD *)lpMem = 0LL;
        ...
        else
        {
          *(_OWORD *)v87 = v101;
          ...
          v90 = v104;
          v91 = v105;
          if ( !(unsigned __int8)CMILMatrix::IsIdentity<1>(v87, v23) )
          {
