/*
 * XREFs of ?DrawGenericInk@CD2DContext@@UEAAJPEBVID2DContextOwner@@PEAUIDCompositionDirectInkWetStrokePartner@@W4D2D1_ANTIALIAS_MODE@@W4D2D1_PRIMITIVE_BLEND@@M_N@Z @ 0x18023C600
 * Callers:
        ...
        bool a7)
{
  ...
  v13 = 0LL;
  if ( v12 )
    v13 = *(_QWORD *)(*((_QWORD *)this + 47) + 8LL * (unsigned int)(v12 - 1));
  v14 = *(_QWORD *)(v13 + 24);
  if ( v14 )
  {
