/*
 * XREFs of ?GetDirectInkWetStroke@CGenericInk@@QEAAJPEAVCD3DDevice@@PEAPEAUIDCompositionDirectInkWetStrokePartner@@@Z @ 0x1801C6D74
 * Callers:
        ...
        struct IDCompositionDirectInkWetStrokePartner **a3)
{
  ...
  CRenderTargetBitmap *v9; // [rsp+40h] [rbp+8h] BYREF
