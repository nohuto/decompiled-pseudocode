/*
 * XREFs of ?ProcessSetReferenceInfo@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETREFERENCEINFO@@PEBXI@Z @ 0x1800BFE48
 * Callers:
        ...
        _QWORD *a4)
{
    ...
    && (int)v6 + *((_DWORD *)this + 104) <= (unsigned int)v8 )
  {
    ...
    if ( ((*((_BYTE *)this + 208) & 2) != 0 || *((_QWORD *)this + 53))
      && (v14 = (*(__int64 (__fastcall **)(CExpression *, __int64))(*(_QWORD *)this + 240LL))(this, v10),
          v16 = v14,
          v14 < 0) )
    {
  ...
  {
    v16 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, -2003303421, 0x91u, 0LL);
  }
  return v16;
}
