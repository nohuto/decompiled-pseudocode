/*
 * XREFs of ?PushRenderTarget@CDrawingContext@@QEAAJPEAVIDeviceTarget@@@Z @ 0x18004F430
 * Callers:
...
__int64 __fastcall CDrawingContext::PushRenderTarget(CDrawingContext *this, struct IDeviceTarget *a2)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x73u, 0LL);
LABEL_91:
  ...
  *((_BYTE *)this + 5954) = 1;
  ...
  if ( *((_DWORD *)this + 140) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v47, 0LL, 0, v46, 0xFC7u, 0LL);
  }
  else
  {
LABEL_5:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v11, 0xFB2u, 0LL);
  }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v11, 0xB47u, 0LL);
  }
  else
  {
    *(_QWORD *)&v61 = 0LL;
    ...
    *(_QWORD *)&v65 = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v52, 0LL, 0, v11, 0xB52u, 0LL);
  }
LABEL_17:
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v11, 0x7Eu, 0LL);
    v2 = (__int64 *)((char *)this + 32);
    goto LABEL_91;
  }
LABEL_18:
...
LABEL_26:
  ...
  *((_QWORD *)this + 9) = *(_QWORD *)(v31 + 16);
  ...
  if ( v34 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v35, 0LL, 0, v34, 0x96u, 0LL);
    --*((_DWORD *)this + 240);
    goto LABEL_91;
  }
LABEL_27:
