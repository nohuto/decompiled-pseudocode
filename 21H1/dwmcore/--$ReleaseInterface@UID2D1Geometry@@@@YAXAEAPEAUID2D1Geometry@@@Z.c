/*
 * XREFs of ??$ReleaseInterface@UID2D1Geometry@@@@YAXAEAPEAUID2D1Geometry@@@Z @ 0x180019CB0
 * Callers:
 ...
 *     ?ReleaseD2DResources@CD2DEffect@@UEAAXXZ @ 0x18024E4B0 (-ReleaseD2DResources@CD2DEffect@@UEAAXXZ.c)
