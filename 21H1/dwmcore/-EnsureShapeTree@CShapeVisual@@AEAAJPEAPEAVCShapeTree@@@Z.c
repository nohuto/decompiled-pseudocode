/*
 * XREFs of ?EnsureShapeTree@CShapeVisual@@AEAAJPEAPEAVCShapeTree@@@Z @ 0x1801F01B0
 * Callers:
 ...
 *     ??0CShapeTree@@QEAA@PEAVCComposition@@@Z @ 0x1801F00FC (--0CShapeTree@@QEAA@PEAVCComposition@@@Z.c)
 */
