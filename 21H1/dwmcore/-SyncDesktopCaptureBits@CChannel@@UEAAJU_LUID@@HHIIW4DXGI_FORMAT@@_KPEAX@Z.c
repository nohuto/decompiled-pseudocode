/*
 * XREFs of ?SyncDesktopCaptureBits@CChannel@@UEAAJU_LUID@@HHIIW4DXGI_FORMAT@@_KPEAX@Z @ 0x1800D8DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        HANDLE hSourceHandle)
{
  ...
  struct _RTL_CRITICAL_SECTION *v26; // [rsp+40h] [rbp-40h] BYREF
  ...
  v26 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 168);
