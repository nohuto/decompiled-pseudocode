/*
 * XREFs of ?SetSpeed@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleScalarBehavior@@@Z @ 0x1801777B8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[11] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1FCu, 0LL);
    }
    else
    {
