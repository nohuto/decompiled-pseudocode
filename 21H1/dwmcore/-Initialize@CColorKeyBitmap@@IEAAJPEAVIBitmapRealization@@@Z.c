/*
 * XREFs of ?Initialize@CColorKeyBitmap@@IEAAJPEAVIBitmapRealization@@@Z @ 0x180269130
 * Callers:
  ...
  *((_QWORD *)this + 6) = 0LL;
  ...
  else
  {
    ...
    if ( inited < 0 )
      ...
      wil::com_ptr_t<IBitmapResource,wil::err_returncode_policy>::operator=((__int64 *)this + 5, (__int64)a2);
  }
  return v14;
}
