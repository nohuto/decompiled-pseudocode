/*
 * XREFs of ?DoTextureUpdates@CHolographicClient@@AEAAXXZ @ 0x18025BAEC
 * Callers:
...
LABEL_16:
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
    McTemplateU0xxxx_EventWriteTransfer(v3 - qword_18034DD78, &EVTDESC_HOLOGRAPHICCLIENT_TEXTUREUPDATECOUNT);
}
