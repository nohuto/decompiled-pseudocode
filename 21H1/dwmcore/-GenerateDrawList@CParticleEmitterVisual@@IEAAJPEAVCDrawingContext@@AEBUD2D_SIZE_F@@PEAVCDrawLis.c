/*
 * XREFs of ?GenerateDrawList@CParticleEmitterVisual@@IEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1801E4074
 * Callers:
 *     ?GenerateDrawList@CParticleEmitter@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1801E03F0 (-GenerateDrawList@CParticleEmitter@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache.c)
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  *(_WORD *)v37 = 1;
  ...
  DrawList = (*(__int64 (__fastcall **)(_QWORD, struct CDrawingContext *, const struct D2D_SIZE_F *))(**((_QWORD **)this + 90) + 312LL))(
               *((_QWORD *)this + 90),
               a2,
               a3);
  ...
  DrawList = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**((_QWORD **)this + 90) + 320LL))(
               *((_QWORD *)this + 90),
               v38);
  ParticlesPrimitive = DrawList;
  if ( DrawList < 0 )
  ...
  for ( i = 0; i < v39; ++i )
  {
    ...
    if ( v13 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)v13 + 8LL))(*(_QWORD *)&v38[8 * i + 40], 3LL) )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147467259, 0x103u, 0LL);
        goto LABEL_41;
      }
      v11 = v11 || v13[52];
    }
...
LABEL_39:
  ...
  {
    ParticlesPrimitive = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v41, 0LL, 0, -2147467259, 0x11Du, 0LL);
    goto LABEL_41;
  }
  ...
  CHWDrawListEntry::ReplacePrimitive((_QWORD *)v22, (__int64 *)v31, (__int64 *)v34, *(_QWORD *)(v22 + 64) + 8LL);
  if ( v31[0] )
