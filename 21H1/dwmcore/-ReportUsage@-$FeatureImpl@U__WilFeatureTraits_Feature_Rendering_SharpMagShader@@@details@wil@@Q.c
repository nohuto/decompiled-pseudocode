/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Rendering_SharpMagShader@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801975DC
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_Rendering_SharpMagShader>::ReportUsage(
