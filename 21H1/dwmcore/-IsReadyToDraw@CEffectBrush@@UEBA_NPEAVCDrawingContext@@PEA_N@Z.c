/*
 * XREFs of ?IsReadyToDraw@CEffectBrush@@UEBA_NPEAVCDrawingContext@@PEA_N@Z @ 0x1800B5E70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 && (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v4 + 64LL))(v4) )
  {
    ...
    if ( a2 && *((_BYTE *)a2 + 5920) )
    {
      ...
      if ( v10 ? *((_QWORD *)a2 + 413) : *(_QWORD *)(*((_QWORD *)a2 + 741) + 56LL) )
      {
        ...
        if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v12 + 224LL))(v12)
          && *(_QWORD *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v12 + 232LL))(v12) + 8) )
        {
          v6 = 1;
        }
      }
