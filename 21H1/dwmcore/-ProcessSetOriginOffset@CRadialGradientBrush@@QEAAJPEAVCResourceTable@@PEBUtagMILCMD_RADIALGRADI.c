/*
 * XREFs of ?ProcessSetOriginOffset@CRadialGradientBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_RADIALGRADIENTBRUSH_SETORIGINOFFSET@@@Z @ 0x1801EBEE4
 * Callers:
        ...
        const struct tagMILCMD_RADIALGRADIENTBRUSH_SETORIGINOFFSET *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_1803482F0)(
         (char *)this + SDWORD2(xmmword_1803482F0),
