/*
 * XREFs of ?FirstFrameInputGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@II_K1111111@Z @ 0x180161E70
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U1@U?$_tlgWrapSz@G@@U3@U2@U?$_tlgWrapperByRef@$0BA@@@U2@U2@U2@U2@U?$_tlgWrapperByVal@$07@@U2@U?$_tlgWrapperByVal@$01@@U6@U5@U1@U1@U5@U1@U1@U1@U1@U1@U1@U1@U5@U5@U5@U5@U5@U5@U5@U5@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@3AEBU?$_tlgWrapSz@G@@54AEBU?$_tlgWrapperByRef@$0BA@@@4444AEBU?$_tlgWrapperByVal@$07@@4AEBU?$_tlgWrapperByVal@$01@@87337333333377777777@Z @ 0x18015E17C (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@U1@U-$_tlgWrapSz@G_ea_18015E17C.c)
 */
        ...
        unsigned __int64 a11)
{
  ...
  if ( (unsigned int)dword_180346E48 > 4 && (qword_180346E58 & 2) != 0 && (qword_180346E60 & 2) == qword_180346E60 )
  {
    ...
    if ( IsVailContainer() )
      v13 = (a5 - a9) / (qword_180349400 / 0xF4240uLL);
    else
      LODWORD(v13) = 0;
    v27 = v13;
    if ( IsVailContainer() )
      v14 = (a9 - a8) / (qword_180349400 / 0xF4240uLL);
    else
      LODWORD(v14) = 0;
    v28 = v14;
    if ( IsVailContainer() )
      v15 = (a8 - a4) / (qword_180349400 / 0xF4240uLL);
    else
      LODWORD(v15) = 0;
    v29 = v15;
    v30 = (a7 - a6) / (qword_180349400 / 0x3E8uLL);
    v31 = (a6 - a5) / (qword_180349400 / 0xF4240uLL);
    v32 = (a5 - a4) / (qword_180349400 / 0xF4240uLL);
    v33 = (a7 - a4) / (qword_180349400 / 0x3E8uLL);
    v48 = *((_QWORD *)a1 + 25);
    v34 = a3;
    v35 = a2;
    v49 = *((_QWORD *)a1 + 1);
