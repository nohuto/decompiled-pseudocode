/*
 * XREFs of ?Initialize@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_K@Z @ 0x18002CA74
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    v26 = 635;
LABEL_36:
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1802DCD78, 4u, v3, v26, 0LL);
    goto LABEL_10;
  }
  v6 = v29[0];
  *((_QWORD *)this + 3) = v28;
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( v8 )
      {
        ...
        {
          v3 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802DCD78, 4u, -2147024809, 0x2C0u, 0LL);
          goto LABEL_18;
        }
        v16 = (char *)hObject;
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802DCD78, 4u, v18, 0x2AFu, 0LL);
        }
        else
        {
          v20 = v27;
          ...
          *((_QWORD *)this + 2) = ((unsigned __int64)v20 + 16) & -(__int64)(v20 != 0LL);
          ...
          v3 = v22;
          if ( v22 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_1802DCD78, 4u, v22, 0x2B3u, 0LL);
          else
...
LABEL_8:
          ...
          v3 = v9;
          if ( v9 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802DCD78, 4u, v9, 0x29Du, 0LL);
          else
            CGlobalCompositionSurfaceInfo::CBindInfo::EnsureSwapChainTelemetryInitialized(this, v35);
          goto LABEL_10;
        }
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802DCD78, 4u, v13, 0x297u, 0LL);
        if ( v27 )
...
LABEL_18:
    ...
    v3 = v24;
    if ( v24 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_180306028, 3u, v24, 0x3E9u, 0LL);
    else
