/*
 * XREFs of ?SendSetBootstrapProxy@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x1800CFC30
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  LOWORD(v5) = 8;
  v4 = CoreUICallSend(v3, v8, 2LL, 6LL, v5, &unk_1802D1365, a2, v7);
  if ( v4 < 0 )
  {
