/*
 * XREFs of ?ScheduleAndProcessFrame@CPartitionVerticalBlankScheduler@@UEAAJXZ @ 0x18003C860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindFirstOutstandingFrameIndex@CPartitionVerticalBlankScheduler@@AEAAIXZ @ 0x18003C318 (-FindFirstOutstandingFrameIndex@CPartitionVerticalBlankScheduler@@AEAAIXZ.c)
...
LABEL_23:
  *((_DWORD *)this + 2799) = 0;
LABEL_24:
  _m_prefetchw(&dword_180349730);
  v19 = dword_180349730;
  do
  {
    v20 = v19 | 1u;
    v21 = v19;
    v19 = _InterlockedCompareExchange(&dword_180349730, v20, v19);
  }
  while ( v21 != v19 );
