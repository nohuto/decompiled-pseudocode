/*
 * XREFs of ?GenerateWhiteColorIntermediate@ShadowHelpers@@YAJAEBVCResourceTag@@PEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVIBitmapRealization@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x18026A2C0
 * Callers:
        ...
        struct IBitmapRealization *a5)
{
  ...
  int v24; // eax
  __int64 v25; // rcx
  __int64 v27; // [rsp+30h] [rbp-61h] BYREF
  struct ID2D1Effect *v28; // [rsp+38h] [rbp-59h] BYREF
  _QWORD v29[2]; // [rsp+40h] [rbp-51h] BYREF
  _OWORD v30[3]; // [rsp+50h] [rbp-41h] BYREF
  ...
  v7 = CDrawingContext::PushOffScreenRenderingLayer(a2, (__int64)this, (float *)a3, DisplayId::None, 0, v29);
  v9 = v7;
  if ( v7 < 0 )
  {
  ...
  else
  {
    ...
    else
    {
      ...
      v28 = 0LL;
      CachedEffectNoRef = CD2DContext::GetCachedEffectNoRef(v14, 0, &v28);
      ...
      {
        v17 = v28;
        (*(void (__fastcall **)(struct ID2D1Effect *, _QWORD, __int64, __int64))(*(_QWORD *)v28 + 112LL))(
          v28,
          0LL,
          v27,
          1LL);
