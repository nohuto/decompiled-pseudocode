/*
 * XREFs of ?CheckForFullScreenVideoNotifications@CLegacyRenderTarget@@AEAAXXZ @ 0x1800B6CD4
 * Callers:
 ...
 * Callees:
 *     ?SignalSEB@CLegacyRenderTarget@@AEAAX_NI@Z @ 0x1800B6DB0 (-SignalSEB@CLegacyRenderTarget@@AEAAX_NI@Z.c)
