/*
 * XREFs of ?GetTextureMemoryLayoutData@CPrimitiveGroup@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801E71F0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 8) = *(_QWORD *)a3;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x234u, 0LL);
  }
  else
  {
