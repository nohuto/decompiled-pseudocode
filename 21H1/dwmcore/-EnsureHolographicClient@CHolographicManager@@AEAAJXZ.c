/*
 * XREFs of ?EnsureHolographicClient@CHolographicManager@@AEAAJXZ @ 0x180254460
 * Callers:
 *     ?AddHolographicComposition@CHolographicManager@@QEAA_NPEAVCHolographicComposition@@@Z @ 0x1802537C8 (-AddHolographicComposition@CHolographicManager@@QEAA_NPEAVCHolographicComposition@@@Z.c)
 * Callees:
 ...
 *     ?HolographicClientCreated_@CompositorTracing@@QEAAXXZ @ 0x1802548C8 (-HolographicClientCreated_@CompositorTracing@@QEAAXXZ.c)
