/*
 * XREFs of ?TimeoutOverdueScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_K1@Z @ 0x180165878
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (unsigned int)dword_180346E48 > 5 && (qword_180346E58 & 8) != 0 && (qword_180346E60 & 8) == qword_180346E60 )
  {
    v26 = a3;
    v5 = a2 - *((_QWORD *)a1 + 20);
    v25 = (a2 - *((_QWORD *)a1 + 48)) / (qword_180349400 / 0x3E8uLL);
    v36 = *(_BYTE *)a1;
    v6 = a3 - *((_QWORD *)a1 + 25);
    v27 = *((_QWORD *)a1 + 25);
    v28 = v6;
    v7 = *((_QWORD *)a1 + 1);
    v19 = v5 / (qword_180349400 / 0x3E8uLL);
    v29 = *((_QWORD *)a1 + 15);
    v11 = *((_BYTE *)a1 + 96);
    v12 = *((_BYTE *)a1 + 92);
    v13 = *((_BYTE *)a1 + 88);
