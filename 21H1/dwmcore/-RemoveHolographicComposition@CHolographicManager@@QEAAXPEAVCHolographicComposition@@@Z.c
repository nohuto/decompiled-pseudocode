/*
 * XREFs of ?RemoveHolographicComposition@CHolographicManager@@QEAAXPEAVCHolographicComposition@@@Z @ 0x180254F10
 * Callers:
 *     ?DetachFromChannel@CHolographicComposition@@UEAAXPEAVCChannelContext@@_N@Z @ 0x180256E50 (-DetachFromChannel@CHolographicComposition@@UEAAXPEAVCChannelContext@@_N@Z.c)
 * Callees:
 ...
 *     ?DwmHolographicCompositionRemove_@CompositorTracing@@QEAAXXZ @ 0x180253DDC (-DwmHolographicCompositionRemove_@CompositorTracing@@QEAAXXZ.c)
