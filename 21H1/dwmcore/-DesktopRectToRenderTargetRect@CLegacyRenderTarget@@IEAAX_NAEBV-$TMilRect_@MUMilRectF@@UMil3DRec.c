/*
 * XREFs of ?DesktopRectToRenderTargetRect@CLegacyRenderTarget@@IEAAX_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180188878
 * Callers:
...
_DWORD *__fastcall CLegacyRenderTarget::DesktopRectToRenderTargetRect(__int64 a1, __int64 a2, __int64 a3, _OWORD *a4)
{
  CMILMatrix *v5; // rcx
  _DWORD *result; // rax
