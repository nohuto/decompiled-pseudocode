/*
 * XREFs of ?ProcessSetDesktopTree@CLegacyRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_LEGACYRENDERTARGET_SETDESKTOPTREE@@@Z @ 0x1800D7A08
 * Callers:
        ...
        const struct tagMILCMD_LEGACYRENDERTARGET_SETDESKTOPTREE *a3)
{
  ...
  Resource = 0LL;
  v5 = *((_DWORD *)a3 + 2);
  if ( v5 && (Resource = (CMILCOMBase *)CResourceTable::GetResource((__int64)a2, v5, 0x33u)) == 0LL )
  {
    v10 = -2003303421;
  ...
  {
    wil::com_ptr_t<CDeviceTextureTarget,wil::err_returncode_policy>::operator=(this + 22, Resource);
    v8 = CRenderTarget::SetVisualTree((CRenderTarget *)this, Resource);
    v10 = v8;
    if ( v8 < 0 )
