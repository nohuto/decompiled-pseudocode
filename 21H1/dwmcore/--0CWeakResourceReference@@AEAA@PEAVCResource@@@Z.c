/*
 * XREFs of ??0CWeakResourceReference@@AEAA@PEAVCResource@@@Z @ 0x1800976F4
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  *(_QWORD *)this = &CWeakResourceReference::`vftable';
  v5 = *((_QWORD *)this + 2);
  *((_DWORD *)this + 2) = 0;
  std::unordered_map<CResource const *,CWeakResourceReference *>::_Try_emplace<CResource const * const &,>(0LL, v4, &v5);
