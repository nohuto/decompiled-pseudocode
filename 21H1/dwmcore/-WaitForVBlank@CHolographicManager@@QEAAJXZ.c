/*
 * XREFs of ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x1802554E8
 * Callers:
 *     ?WaitForVBlank@CHolographicInteropTarget@@UEBAJPEAX@Z @ 0x180258FB0 (-WaitForVBlank@CHolographicInteropTarget@@UEBAJPEAX@Z.c)
 * Callees:
