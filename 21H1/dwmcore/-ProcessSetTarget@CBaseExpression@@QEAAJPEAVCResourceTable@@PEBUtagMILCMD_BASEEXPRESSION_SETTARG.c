/*
 * XREFs of ?ProcessSetTarget@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEEXPRESSION_SETTARGET@@@Z @ 0x180096DA0
 * Callers:
        ...
        const struct tagMILCMD_BASEEXPRESSION_SETTARGET *a3)
{
  ...
  *((_BYTE *)v7 + 208) = v8;
  ...
  {
    v11 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, -2003303421, 0x56u, 0LL);
  }
  return v11;
}
