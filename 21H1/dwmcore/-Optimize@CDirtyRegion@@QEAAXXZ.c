/*
 * XREFs of ?Optimize@CDirtyRegion@@QEAAXXZ @ 0x180067630
 * Callers:
 ...
 *     ?CalcOvehead@@YAMAEBUMilRectF@@0@Z @ 0x1800BDD04 (-CalcOvehead@@YAMAEBUMilRectF@@0@Z.c)
 *     ?SetFullDirty@CDirtyRegion@@QEAAXXZ @ 0x1800CA790 (-SetFullDirty@CDirtyRegion@@QEAAXXZ.c)
 *     ?CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z @ 0x1800CC008 (-CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z.c)
 ...
 *     ?SetRedrawRects@CDirtyRegion@@AEAAXXZ @ 0x18018D344 (-SetRedrawRects@CDirtyRegion@@AEAAXXZ.c)
 */
...
LABEL_28:
    v81 = this[v3 + 100];
    TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v81, v14);
    v18 = v81.m128_f32[0];
    v19 = v81.m128_f32[3];
    v20 = v81.m128_f32[1];
...
LABEL_33:
    ...
    TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&this[v4 + 108], &this[v28 + 108]);
    v38 = v85 + 108;
    v39 = &this[v85 + 116];
