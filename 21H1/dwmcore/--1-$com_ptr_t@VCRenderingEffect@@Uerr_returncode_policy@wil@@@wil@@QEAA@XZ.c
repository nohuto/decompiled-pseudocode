/*
 * XREFs of ??1?$com_ptr_t@VCRenderingEffect@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18006D89C
 * Callers:
 ...
 *     ??1SharedStateLayer@@QEAA@XZ @ 0x1800D4100 (--1SharedStateLayer@@QEAA@XZ.c)
