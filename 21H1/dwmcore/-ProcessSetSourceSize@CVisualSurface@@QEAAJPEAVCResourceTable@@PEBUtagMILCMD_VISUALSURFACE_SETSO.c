/*
 * XREFs of ?ProcessSetSourceSize@CVisualSurface@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALSURFACE_SETSOURCESIZE@@@Z @ 0x1801F655C
 * Callers:
        ...
        const struct tagMILCMD_VISUALSURFACE_SETSOURCESIZE *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_180348590)(
         (char *)this + SDWORD2(xmmword_180348590),
