/*
 * XREFs of _anonymous_namespace_::State::State @ 0x1800D96FC
 * Callers:
 ...
 *     _anonymous_namespace_::FramesReport::FramesReport @ 0x1800DAB78 (_anonymous_namespace_--FramesReport--FramesReport.c)
