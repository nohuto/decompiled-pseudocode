/*
 * XREFs of ?GetMultiplaneOverlayCaps@CDDisplaySwapChain@@UEBAJPEAUDXGI_MULTIPLANE_OVERLAY_CAPS@@@Z @ 0x18023A990
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_MULTIPLANE_OVERLAY_CAPS *a2)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1ABu, 0LL);
  }
  else
  {
    ...
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x1ADu, 0LL);
      }
      else
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x1AEu, 0LL);
        }
        else
        {
          v14 = v37;
          *((float *)a2 + 4) = v40;
          ...
          if ( v15 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x1B0u, 0LL);
          }
          else
          {
            v17 = v37;
            ...
            *((float *)a2 + 5) = v18;
            ...
            if ( v19 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x1B9u, 0LL);
            }
            else
            {
              ...
              else
              {
                ...
                if ( v23 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x1BBu, 0LL);
                }
                else
                {
                  ...
                  if ( v25 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x1BCu, 0LL);
                  }
                  else
                  {
                    ...
                    if ( v27 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x1BEu, 0LL);
                    }
                    else
                    {
                      ...
                      if ( v29 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0x1BFu, 0LL);
                      }
                      else
                      {
                        v31 = (v45 != 0 ? 0x40000 : 0) | (v44 != 0 ? 4 : 0) | (v43 != 0 ? 2 : 0) | (v42 != 0) | *((_DWORD *)a2 + 3);
                        v32 = *((_DWORD *)a2 + 1) <= 1u;
                        *((_DWORD *)a2 + 3) = v31;
                        if ( !v32 )
                        {
                        ...
                        if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_2101c_27737997>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_Servicing_2101c_27737997>::GetImpl'::`2'::impl)
                          && wil::operator!=<IDXGISwapChainDWM1,wil::err_returncode_policy>((_QWORD *)this + 3) )
                        {
