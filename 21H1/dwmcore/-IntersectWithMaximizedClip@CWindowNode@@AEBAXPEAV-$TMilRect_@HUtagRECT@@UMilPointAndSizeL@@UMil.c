/*
 * XREFs of ?IntersectWithMaximizedClip@CWindowNode@@AEBAXPEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180047CB8
 * Callers:
...
void __fastcall CWindowNode::IntersectWithMaximizedClip(const RECT *a1, _DWORD *a2)
{
  LONG right; // ecx
  LONG v5; // ecx
  LONG v6; // eax
