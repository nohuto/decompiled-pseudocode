/*
 * XREFs of ??1CCompositionSurfaceInfo@@MEAA@XZ @ 0x18002BE60
 * Callers:
 ...
 *     ?RemoveFromSurfaceMap@CCompositionSurfaceManager@@IEAA_NU_LUID@@@Z @ 0x18002C660 (-RemoveFromSurfaceMap@CCompositionSurfaceManager@@IEAA_NU_LUID@@@Z.c)
