/*
 * XREFs of ?ClipToPolygon@ClipPlaneIterator@@QEAAJPEAVCPolygon@@AEBVCMILMatrix@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@UNotNeeded@4@@@@Z @ 0x180192E10
 * Callers:
 ...
 *     ?ResetToStart@ClipPlaneIterator@@AEAAXXZ @ 0x1801933D4 (-ResetToStart@ClipPlaneIterator@@AEAAXXZ.c)
