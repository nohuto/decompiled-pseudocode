/*
 * XREFs of ??0CWARPDrawListEntry@@AEAA@AEBUWARPDrawListEntryParams@@@Z @ 0x1801A5990
 * Callers:
 ...
 *     ??0CDrawListEntry@@IEAA@AEBUDrawListEntryParams@@@Z @ 0x1801A7A94 (--0CDrawListEntry@@IEAA@AEBUDrawListEntryParams@@@Z.c)
 */
