/*
 * XREFs of McTemplateU0xxxtxxxxxxxxqN16_EventWriteTransfer @ 0x1801675BC
 * Callers:
 *     ?TraceGlitch@CScheduleStatistics@@CAXIPEBVCFrameInfo@@AEB_K1@Z @ 0x1800C6308 (-TraceGlitch@CScheduleStatistics@@CAXIPEBVCFrameInfo@@AEB_K1@Z.c)
 * Callees:
