/*
 * XREFs of ?TryOptimizedCombinePaths@CShape@@CAJPEAV1@PEBVCMILMatrix@@01W4Enum@MilCombineMode@@PEAPEAV1@@Z @ 0x180053160
 * Callers:
 ...
 *     ?Is2DAxisAlignedIntegerPreserving@CMILMatrix@@QEBA_N_N@Z @ 0x18001DC84 (-Is2DAxisAlignedIntegerPreserving@CMILMatrix@@QEBA_N_N@Z.c)
 ...
 *     ?DoesIntersectInclusive@?$TMilRect@MUMilRectF@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEBA_NAEBV1@@Z @ 0x18006D6A4 (-DoesIntersectInclusive@-$TMilRect@MUMilRectF@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEBA_NA.c)
     ...
     || COERCE_FLOAT(COERCE_UNSIGNED_INT(a4[5] - 0.0) & _xmm) >= 0.000081380211) )
  {
    ...
    else
    {
      ...
      if ( v34 >= 0 )
      {
        ...
        v106 = v107;
        v107[0] = 0;
        v37 = FastRegion::CRegion::Copy((FastRegion::CRegion *)&v106, (CRegionShape *)((char *)v103[0] + 16));
        v9 = v37;
        if ( v37 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, v37, 0x2D1u, 0LL);
          FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v106);
          v46 = v104[0];
          if ( !v104[0] )
            goto LABEL_62;
        }
        else
        {
          ...
          if ( a5 == 1 )
          {
            v40 = FastRegion::CRegion::Intersect((FastRegion::CRegion *)&v106, (CRegionShape *)((char *)v104[0] + 16));
            if ( v40 < 0 )
          ...
          else if ( a5 )
          {
            if ( a5 == 2 )
            {
              v84 = FastRegion::CRegion::Subtract((FastRegion::CRegion *)&v106, (CRegionShape *)((char *)v104[0] + 16));
              if ( v84 < 0 )
          ...
          {
            v85 = FastRegion::CRegion::Union((FastRegion::CRegion *)&v106, (CRegionShape *)((char *)v104[0] + 16));
            if ( v85 < 0 )
          ...
          if ( v43 )
          {
            ...
            *((_QWORD *)v43 + 11) = 0LL;
            ...
            v45 = FastRegion::CRegion::Copy((FastRegion::CRegion *)(v43 + 16), (const struct CRegion *)&v106);
            if ( v45 < 0 )
...
LABEL_62:
        ...
        v47 = v36;
LABEL_64:
        CRegionShape::`vector deleting destructor'(v47, 1u);
        return v9;
      }
      MilInstrumentationCheckHR_MaybeFailFast(v35, 0LL, 0, v34, 0x2CEu, 0LL);
      if ( v104[0] )
        CRegionShape::`vector deleting destructor'(v104[0], 1u);
    }
    v47 = v103[0];
    if ( !v103[0] )
      return v9;
  ...
  *(_OWORD *)v104 = 0LL;
  ...
  if ( a5 != 1 )
  {
    if ( a5 )
    {
      if ( a5 != 2 )
        return v9;
      if ( TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesContain((float *)v104, (float *)v103)
      ...
      v109[0] = 0;
      v106 = v107;
      CRegion::AppendRects<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>>((FastRegion::CRegion *)&v108);
      *v106 = 0;
      CRegion::AppendRects<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>>((FastRegion::CRegion *)&v106);
      v59 = FastRegion::CRegion::Subtract((FastRegion::CRegion *)&v108, (const struct CRegion *)&v106);
      if ( v59 < 0 )
      ...
      if ( v62 )
      {
        ...
        *((_QWORD *)v62 + 11) = 0LL;
        ...
        v65 = FastRegion::CRegion::Copy((FastRegion::CRegion *)(v62 + 16), (const struct CRegion *)&v108);
        if ( v65 < 0 )
      ...
      FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v106);
      v63 = (FastRegion::CRegion *)&v108;
    }
    else
    {
      if ( TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesContain((float *)v103, (float *)v104)
      ...
      *v108 = 0;
      CRegion::AppendRects<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>>((FastRegion::CRegion *)&v108);
      v71 = FastRegion::CRegion::Union((FastRegion::CRegion *)&v106, (const struct CRegion *)&v108);
      if ( v71 < 0 )
      ...
      if ( !v74 )
      {
        ...
        FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v108);
        FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v106);
        return v9;
      }
      **((_DWORD **)v74 + 2) = 0;
      ...
      *((_QWORD *)v74 + 11) = 0LL;
      ...
      v76 = FastRegion::CRegion::Copy((FastRegion::CRegion *)(v74 + 16), (const struct CRegion *)&v106);
      if ( v76 < 0 )
        ModuleFailFastForHRESULT((unsigned int)v76, retaddr);
      *a6 = (struct CShape *)v74;
      FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v108);
      v63 = (FastRegion::CRegion *)&v106;
    }
    ...
    if ( v29 )
    {
      ...
      *((_QWORD *)v29 + 11) = 0LL;
      ...
      CRegion::AppendRects<TMilRect_<int,tagRECT,MilPointAndSizeL,Mil3DRectL,RectUniqueness::_CMilRectL_>>(
        (const struct FastRegion::Internal::CRgnData **)v29 + 2,
        (__int64)v30,
        1u);
