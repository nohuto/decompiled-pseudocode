/*
 * XREFs of ?GetProperty@CKeyframeAnimation@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801D5230
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v6 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x879u, 0LL);
  return v6;
}
