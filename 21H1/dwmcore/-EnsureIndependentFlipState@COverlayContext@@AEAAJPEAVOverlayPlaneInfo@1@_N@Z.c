/*
 * XREFs of ?EnsureIndependentFlipState@COverlayContext@@AEAAJPEAVOverlayPlaneInfo@1@_N@Z @ 0x180180180
 * Callers:
        ...
        char a3)
{
               ...
               0LL) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0xB3Du, 0LL);
    }
  }
  return v4;
}
