/*
 * XREFs of ??_GCParticleVector4Behavior@@UEAAPEAXI@Z @ 0x180171DC0
 * Callers:
 *     ??_ECParticleVector4Behavior@@WGI@EAAPEAXI@Z @ 0x1800EBF40 (--_ECParticleVector4Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
