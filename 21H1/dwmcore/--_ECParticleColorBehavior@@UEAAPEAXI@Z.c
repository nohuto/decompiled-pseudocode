/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x180171AB0
 * Callers:
 *     ??_ECParticleColorBehavior@@WGI@EAAPEAXI@Z @ 0x1800EBF10 (--_ECParticleColorBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
