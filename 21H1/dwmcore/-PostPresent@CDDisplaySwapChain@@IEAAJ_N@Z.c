/*
 * XREFs of ?PostPresent@CDDisplaySwapChain@@IEAAJ_N@Z @ 0x18023B4EC
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::PostPresent(CDDisplaySwapChain *this, char a2)
{
  ...
  if ( !a2 )
  {
    ...
    if ( (unsigned int)((__int64)(*((_QWORD *)this + 47) - *((_QWORD *)this + 46)) >> 3) != 1 )
    {
      do
      {
        ...
        v6 = FastRegion::CRegion::Copy(
               *(FastRegion::Internal::CRgnData ***)(*((_QWORD *)this + 46) + 8LL * v4),
               *(FastRegion::Internal::CRgnData ***)(*((_QWORD *)this + 46) + 8 * v5));
        if ( v6 < 0 )
    ...
    v7 = FastRegion::CRegion::Copy(
           **((FastRegion::Internal::CRgnData ****)this + 46),
           (FastRegion::Internal::CRgnData **)this + 37);
    if ( v7 < 0 )
