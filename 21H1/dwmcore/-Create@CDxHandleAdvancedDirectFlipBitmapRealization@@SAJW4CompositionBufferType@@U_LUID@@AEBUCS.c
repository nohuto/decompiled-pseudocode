/*
 * XREFs of ?Create@CDxHandleAdvancedDirectFlipBitmapRealization@@SAJW4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAVCDecodeBitmap@@PEAPEAVISwapChainRealization@@@Z @ 0x18002D3B0
 * Callers:
        ...
        __int64 *a6)
{
  ...
  {
    v11 = -2003292287;
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802CE500, 3u, -2003292287, 0x24u, 0LL);
LABEL_3:
    v12 = 0LL;
    goto LABEL_4;
  }
  ...
  {
    v11 = -2003292288;
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802CE500, 3u, -2003292288, 0x2Au, 0LL);
LABEL_18:
    if ( v11 >= 0 )
      goto LABEL_19;
LABEL_15:
  ...
  {
    v11 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v14, &dword_1802CE500, 3u, -2147024882, 0x32u, 0LL);
    goto LABEL_15;
  }
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802CE500, 3u, v15, 0x33u, 0LL);
    goto LABEL_18;
  }
LABEL_19:
  v17 = v6;
