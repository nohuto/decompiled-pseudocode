/*
 * XREFs of ??_GCInteractionContextWrapper@@UEAAPEAXI@Z @ 0x1800AF510
 * Callers:
 *     ??_ECInteractionContextWrapper@@W7EAAPEAXI@Z @ 0x1800EE4D0 (--_ECInteractionContextWrapper@@W7EAAPEAXI@Z.c)
 * Callees:
