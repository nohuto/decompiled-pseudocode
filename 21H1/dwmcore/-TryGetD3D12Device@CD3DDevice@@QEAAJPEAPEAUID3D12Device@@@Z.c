/*
 * XREFs of ?TryGetD3D12Device@CD3DDevice@@QEAAJPEAPEAUID3D12Device@@@Z @ 0x180241454
 * Callers:
 ...
 *     ?WaitForResult@?$CAsyncTask@UD3D12Resources@CD3DDevice@@@@QEAAJPEAPEAUD3D12Resources@CD3DDevice@@@Z @ 0x180241A20 (-WaitForResult@-$CAsyncTask@UD3D12Resources@CD3DDevice@@@@QEAAJPEAPEAUD3D12Resources@CD3DDevice@.c)
 */
...
__int64 __fastcall CD3DDevice::TryGetD3D12Device(CD3DDevice *this, struct ID3D12Device **a2)
{
  ...
  if ( D3D12Resources >= 0 )
  {
    ...
    if ( *(_BYTE *)(v6 + 92) )
    {
      v7 = CAsyncTask<CD3DDevice::D3D12Resources>::WaitForResult(*((_QWORD *)this + 134), &v12);
      v5 = v7;
      if ( v7 < 0 )
      {
