/*
 * XREFs of ?GetAccumShape@CGdiSpriteBitmap@@UEAAJPEAVCShapePtr@@_N@Z @ 0x1800D02B0
 * Callers:
 *     <none>
 * Callees:
...
{
  unsigned int v3; // esi
  FastRegion::Internal::CRgnData **v7; // r14
  __int64 v8; // rcx
  int v9; // eax
  int v11; // eax
  __int64 v12; // rcx
  ...
  if ( *((_BYTE *)this + 75) )
  {
    v7 = (FastRegion::Internal::CRgnData **)((char *)this + 256);
    **((_DWORD **)this + 32) = 0;
    v8 = *((_QWORD *)this + 41);
    *((_QWORD *)this + 41) = 0LL;
    if ( v8 )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)v8 + 16LL))(v8);
    v9 = FastRegion::CRegion::Copy(v7, (FastRegion::Internal::CRgnData **)this + 21);
    if ( v9 < 0 )
