/*
 * XREFs of ?ProcessSetAdapterLUID@CCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CAPTURERENDERTARGET_SETADAPTERLUID@@@Z @ 0x18018BD28
 * Callers:
 ...
 *     ??9@YA_NAEBU_LUID@@0@Z @ 0x180160F78 (--9@YA_NAEBU_LUID@@0@Z.c)
