/*
 * XREFs of ?GetSurfacePlaneResource@CDDisplaySwapChain@@UEBAJPEAVCCompositionSurfaceInfo@@PEAPEAUIUnknown@@PEAI@Z @ 0x18023AF90
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x252u, 0LL);
    }
    else
    {
