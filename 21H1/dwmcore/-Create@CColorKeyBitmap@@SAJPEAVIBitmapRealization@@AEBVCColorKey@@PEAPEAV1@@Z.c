/*
 * XREFs of ?Create@CColorKeyBitmap@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV1@@Z @ 0x180268748
 * Callers:
 ...
 *     ??0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z @ 0x1802682C8 (--0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z.c)
