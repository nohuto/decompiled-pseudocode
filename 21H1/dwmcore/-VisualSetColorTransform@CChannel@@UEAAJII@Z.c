/*
 * XREFs of ?VisualSetColorTransform@CChannel@@UEAAJII@Z @ 0x180154AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetColorTransform(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
