/*
 * XREFs of ?PreRender@CRemoteAppRenderTarget@@UEAAJXZ @ 0x18018A5C4
 * Callers:
 *     ?PreRender@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800ECFB0 (-PreRender@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
