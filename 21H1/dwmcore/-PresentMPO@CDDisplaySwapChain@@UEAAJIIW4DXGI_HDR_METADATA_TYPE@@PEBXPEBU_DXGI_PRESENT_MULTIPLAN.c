/*
 * XREFs of ?PresentMPO@CDDisplaySwapChain@@UEAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x18023B630
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetDesktopPrimary@CDDisplaySwapChain@@IEAAPEAUIDisplaySurface@Core@Display@Devices@Windows@@_N@Z @ 0x18023A95C (-GetDesktopPrimary@CDDisplaySwapChain@@IEAAPEAUIDisplaySurface@Core@Display@Devices@Windows@@_N@.c)
        ...
        unsigned int a7)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x2C4u, 0LL);
  }
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x2C9u, 0LL);
    }
    else
    {
      if ( v63 )
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x2CAu, 0LL);
      }
      else
      {
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x2CDu, 0LL);
        }
        else if ( *((_QWORD *)this + 46)
               && (v20 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v63 + 112LL))(v63), v13 = v20, v20 < 0) )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x2D0u, 0LL);
        }
        else
        {
          v22 = a7;
          ...
          if ( a7 )
          {
            ...
            while ( 1 )
            {
              ...
              *(_QWORD *)&v53 = *(_QWORD *)&v55[12];
              ...
              if ( v39 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v40, 0LL, 0, v39, 0x2F2u, 0LL);
                goto LABEL_31;
              }
              ...
              if ( v41 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v42, 0LL, 0, v41, 0x2F5u, 0LL);
                goto LABEL_31;
              }
              ++v23;
            ...
            MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, v37, 0x2EEu, 0LL);
          }
          else
          {
LABEL_18:
            ...
            if ( v43 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, v43, 0x2F8u, 0LL);
            }
            else
            {
              ...
              if ( v45 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v46, 0LL, 0, v45, 0x2F9u, 0LL);
              }
              else
              {
                ...
                v13 = v47;
                if ( v47 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, v47, 0x2FAu, 0LL);
              }
            }
          }
        }
