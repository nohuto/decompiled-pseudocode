/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_2103c_31359196@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800E4D34
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_2103c_31359196>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_2103c_31359196>::GetCurrentFeatureEnabledState(
      v6,
      &v16,
      &v15);
    v7 = *a2;
