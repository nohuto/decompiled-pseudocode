/*
 * XREFs of _anonymous_namespace_::SealCurrentFrameSequence @ 0x1800D99AC
 * Callers:
...
void __fastcall anonymous_namespace_::SealCurrentFrameSequence(char a1)
{
  ...
  if ( dword_180349298 )
  {
    ...
    xmmword_180349170 = *(_OWORD *)&ppsmemCounters[16];
    xmmword_180349180 = *(_OWORD *)&ppsmemCounters[32];
    xmmword_180349190 = *(_OWORD *)&ppsmemCounters[48];
    xmmword_1803491A0 = *(_OWORD *)&ppsmemCounters[64];
    qword_1803491B0 = v33;
    v5 = std::function_void___cdecl_void___unsigned_long_unsigned___int64_unsigned_short_const___enum_ProcessAttributionFlags_ProcessAttributionResourceCounters_const____::function_void___cdecl_void___unsigned_long_unsigned___int64_unsigned_short_const___enum_ProcessAttributionFlags_ProcessAttributionResourceCounters_const______lambda_5fcd38f73916aa9cc2ab190da74b00ea__void_(
           ...
           v3,
           v4,
           *(_QWORD *)qword_180349450);
    CProcessAttributionObserver::ForEachChangedProcessAttribution(v6, 0LL, v5);
    v7 = g_qpcFrequency;
    v8 = *((_QWORD *)&xmmword_1803493E0 + 1);
    v9 = xmmword_1803493E0;
    dword_1803492B0 = 1000
                    * ((*((_QWORD *)&xmmword_1803493E0 + 1) - (_QWORD)xmmword_1803493E0)
                     / g_qpcFrequency.QuadPart)
                    + (unsigned __int64)(1000
                                       * ((*((_QWORD *)&xmmword_1803493E0 + 1) - (_QWORD)xmmword_1803493E0)
                                        % g_qpcFrequency.QuadPart))
                    / g_qpcFrequency.QuadPart;
    if ( xmmword_180349148 == *(_OWORD *)&GUID_NULL )
    {
      v10 = dword_1803492A0;
      if ( (unsigned int)dword_1803492A0 > 0x37
        && (dword_180349110 & 0x100000) != 0
    ...
    v12 = (__int64 *)*((_QWORD *)qword_180349450 + 5);
    if ( v12[4] == v12[3] )
    {
      std::vector__anonymous_namespace_::FrameSequenceInfo_std::allocator__anonymous_namespace_::FrameSequenceInfo___::_Emplace_reallocate__anonymous_namespace_::FrameSequenceInfo_const___(
        v12 + 2,
        v12[3],
        (__int64)&unk_180349210);
    }
    else
    {
      anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo(v12[3], &unk_180349210);
      v12[3] += 480LL;
    }
    v31 = 0LL;
    ...
    anonymous_namespace_::FrameSequenceInfo::operator_(&unk_180349210, v24);
      ...
      || g_fTelemetry_FramesReportFast && v13 >= 0x3E8 )
    {
      *(_DWORD *)ppsmemCounters = 80;
      ...
      {
        HIDWORD(qword_180349100) = *(_QWORD *)&ppsmemCounters[16] >> 10;
        LODWORD(qword_180349100) = *(_QWORD *)&ppsmemCounters[56] >> 10;
      }
      v15 = qword_180349450;
      v16 = xmmword_1803490D0;
      *(_OWORD *)(*((_QWORD *)qword_180349450 + 5) + 176LL) = xmmword_180349148;
      v17 = v15[5];
      *(_OWORD *)(v17 + 40) = xmmword_1803490C0;
      v18 = unk_1803490E0;
      *(_OWORD *)(v17 + 56) = v16;
      v19 = xmmword_1803490F0;
      *(_OWORD *)(v17 + 72) = v18;
      *(_QWORD *)&v18 = qword_180349100;
      *(_OWORD *)(v17 + 88) = v19;
      *(_QWORD *)(v17 + 104) = v18;
      ...
      v22 = (union _SLIST_HEADER *)qword_180349450;
      v23 = (struct _SLIST_ENTRY *)*((_QWORD *)qword_180349450 + 5);
      *((_QWORD *)qword_180349450 + 5) = v1;
      InterlockedPushEntrySList(v22 + 3, v23);
      SubmitThreadpoolWork(*((PTP_WORK *)qword_180349450 + 1));
    }
  }
}
