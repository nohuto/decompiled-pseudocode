/*
 * XREFs of ??1CLegacyRenderTarget@@MEAA@XZ @ 0x1800D71D8
 * Callers:
 ...
 *     ?PubSebiUpdateLevelEventRpc@@YAJPEAXE@Z @ 0x180218800 (-PubSebiUpdateLevelEventRpc@@YAJPEAXE@Z.c)
 */
...
void __fastcall CLegacyRenderTarget::~CLegacyRenderTarget(CLegacyRenderTarget *this)
{
  ...
  *(_DWORD *)((char *)this + v4 + 68) = v4 - 18592;
  ...
  if ( (unsigned __int64)(v7 - 1) <= 0xFFFFFFFFFFFFFFFDuLL )
    CloseHandle(v7);
  COverlayContext::~COverlayContext((void **)this + 59);
