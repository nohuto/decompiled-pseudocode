/*
 * XREFs of ?SetIterationInfo@CKeyframeAnimation@@AEAAJMW4Enum@KeyframeAnimationDirection@@MW42KeyframeAnimationStopBehavior@@@Z @ 0x18009A320
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    v11 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2147418113, 0x3D2u, 0LL);
    return v11;
  }
  if ( a2 != 1.0 )
  {
