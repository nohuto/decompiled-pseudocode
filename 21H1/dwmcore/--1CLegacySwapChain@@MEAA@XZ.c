/*
 * XREFs of ??1CLegacySwapChain@@MEAA@XZ @ 0x1800D49FC
 * Callers:
...
void __fastcall CLegacySwapChain::~CLegacySwapChain(CLegacySwapChain *this)
{
  ...
  *((_QWORD *)this + 34) = 0LL;
  ...
  FastRegion::CRegion::FreeMemory((void **)this + 24);
  ...
  if ( v10 )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CSwapChainBuffer>>>(
      *((_QWORD *)this + 13),
      *((_QWORD *)this + 14));
    std::_Deallocate<16,0>(v10, (*((_QWORD *)this + 15) - (_QWORD)v10) & 0xFFFFFFFFFFFFFFF8uLL);
    *((_QWORD *)this + 13) = 0LL;
    *((_QWORD *)this + 14) = 0LL;
    *((_QWORD *)this + 15) = 0LL;
  }
