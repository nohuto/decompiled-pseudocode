/*
 * XREFs of ?SetMinPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x1801CFDAC
 * Callers:
 *     ?ProcessSetMinPosition@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMINPOSITION@@@Z @ 0x1801CE878 (-ProcessSetMinPosition@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTR.c)
...
void __fastcall CInteractionTracker::SetMinPosition(CInteractionTracker *this, const struct D2DVector3 *a2)
{
  ...
  if ( v4 )
  {
    LODWORD(v5) = COERCE_UNSIGNED_INT(*((float *)this + 21) - *(float *)a2) & _xmm;
    LODWORD(v6) = COERCE_UNSIGNED_INT(*((float *)this + 22) - *((float *)a2 + 1)) & _xmm;
    ...
    *((_DWORD *)this + 23) = *((_DWORD *)a2 + 2);
    ...
    v8 = fmaxf(*((float *)this + 22), *((float *)this + 25));
    v10[0] = fmaxf(*((float *)this + 21), *((float *)this + 24));
    v9 = fmaxf(*((float *)this + 23), *((float *)this + 26));
    *(float *)&v10[1] = v8;
    *(float *)&v10[2] = v9;
    CInteractionTracker::SetMaxPosition(this, (const struct D2DVector3 *)v10);
    if ( !*((_DWORD *)this + 42) )
