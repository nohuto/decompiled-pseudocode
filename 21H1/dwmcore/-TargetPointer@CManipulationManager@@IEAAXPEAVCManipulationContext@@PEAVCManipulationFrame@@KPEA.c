/*
 * XREFs of ?TargetPointer@CManipulationManager@@IEAAXPEAVCManipulationContext@@PEAVCManipulationFrame@@KPEAPEAX@Z @ 0x180228AC8
 * Callers:
 ...
 *     ?IsRoute@TargetingInfo@@QEBA_NXZ @ 0x1802261E0 (-IsRoute@TargetingInfo@@QEBA_NXZ.c)
