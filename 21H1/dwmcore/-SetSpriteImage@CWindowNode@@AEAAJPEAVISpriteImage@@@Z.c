/*
 * XREFs of ?SetSpriteImage@CWindowNode@@AEAAJPEAVISpriteImage@@@Z @ 0x18008C848
 * Callers:
...
LABEL_45:
      ...
      v30 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 728, 8LL, 1LL, &v34);
      v3 = v30;
      if ( v30 < 0 )
    ...
    if ( (v3 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v3, 0x1E9u, 0LL);
      return v3;
    }
    goto LABEL_12;
  }
