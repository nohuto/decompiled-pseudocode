/*
 * XREFs of ?AtlasedRectsMeshSetConstantOpacity@CChannel@@UEAAJIH@Z @ 0x18001F410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::AtlasedRectsMeshSetConstantOpacity(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
