/*
 * XREFs of ?ProcessSource@CBitmapResource@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_BITMAPRESOURCE_SOURCE@@@Z @ 0x180027438
 * Callers:
  ...
  *((_QWORD *)this + 8) = 0LL;
  ...
  else
  {
    ...
    else
    {
      ...
      wil::com_ptr_t<IBitmapResource,wil::err_returncode_policy>::operator=(v3, StockTransparentBitmap);
      if ( !v20 )
        goto LABEL_8;
      v19 = v20;
    }
