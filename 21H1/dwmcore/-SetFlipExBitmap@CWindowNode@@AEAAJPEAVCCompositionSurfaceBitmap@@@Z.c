/*
 * XREFs of ?SetFlipExBitmap@CWindowNode@@AEAAJPEAVCCompositionSurfaceBitmap@@@Z @ 0x1801F7900
 * Callers:
...
LABEL_6:
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x346u, 0LL);
        return v2;
      }
      v9 = *((_DWORD *)v4 + 6);
      v10 = v9 + 1;
...
LABEL_14:
        if ( (v2 & 0x80000000) != 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v2, 0x347u, 0LL);
          return v2;
        }
        goto LABEL_11;
      }
