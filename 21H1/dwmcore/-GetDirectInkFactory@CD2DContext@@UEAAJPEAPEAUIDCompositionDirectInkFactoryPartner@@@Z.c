/*
 * XREFs of ?GetDirectInkFactory@CD2DContext@@UEAAJPEAPEAUIDCompositionDirectInkFactoryPartner@@@Z @ 0x18023D7B0
 * Callers:
 ...
 *     ?LazyInitDirectInkFactory@CD2DContext@@AEAAJXZ @ 0x18023DCBC (-LazyInitDirectInkFactory@CD2DContext@@AEAAJXZ.c)
 */
