/*
 * XREFs of ?ProcessSetAnchorPoint@CComponentTransform3D@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPONENTTRANSFORM3D_SETANCHORPOINT@@@Z @ 0x1800C7FDC
 * Callers:
        ...
        const struct tagMILCMD_COMPONENTTRANSFORM3D_SETANCHORPOINT *a3)
{
  ...
  HIDWORD(v5) = v3;
  return ((__int64 (__fastcall *)(char *, void *, struct CResourceTable **))xmmword_1803461A0)(
