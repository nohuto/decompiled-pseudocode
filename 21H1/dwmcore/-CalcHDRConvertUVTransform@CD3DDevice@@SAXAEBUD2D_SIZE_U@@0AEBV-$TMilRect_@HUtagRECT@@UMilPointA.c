/*
 * XREFs of ?CalcHDRConvertUVTransform@CD3DDevice@@SAXAEBUD2D_SIZE_U@@0AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@1PEAVCMILMatrix@@@Z @ 0x18023E70C
 * Callers:
        ...
        CMILMatrix *a6)
{
  ...
  __m128 v32[4]; // [rsp+C8h] [rbp-40h] BYREF
  ...
  *((_QWORD *)&v34 + 1) = __PAIR64__((float)a1[1], v13);
  ...
  else
  {
    ...
    CMILMatrix::SetToInverse(v32, (const struct CMILMatrix *)v30);
