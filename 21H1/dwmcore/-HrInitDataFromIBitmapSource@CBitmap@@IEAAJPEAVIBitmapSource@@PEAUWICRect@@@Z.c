/*
 * XREFs of ?HrInitDataFromIBitmapSource@CBitmap@@IEAAJPEAVIBitmapSource@@PEAUWICRect@@@Z @ 0x1802199BC
 * Callers:
...
__int64 __fastcall CBitmap::HrInitDataFromIBitmapSource(CBitmap *this, struct IBitmapSource *a2, struct WICRect *a3)
{
  ...
  *((_QWORD *)this + 24) = *(_QWORD *)v11;
  *((_DWORD *)this + 50) = *(_DWORD *)(v11 + 8);
  if ( v10 >= 0 )
  {
    ...
    if ( PixelFormatSize )
    {
      ...
      {
        v10 = -2147024362;
        MilInstrumentationCheckHR_MaybeFailFast(PixelFormatSize, 0LL, 0, -2147024362, 0x369u, 0LL);
      }
      if ( v10 >= 0 )
      {
        v13 = GetPixelFormatSize(*((_DWORD *)this + 48));
        if ( v13 && *v5 <= 0x7FFFFFF8u / v13 )
        {
          ...
          {
            v10 = -2147024362;
            MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147024362, 0x37Cu, 0LL);
          }
          if ( v10 >= 0 )
          {
            v15 = *(_QWORD *)a2;
        ...
        {
          v10 = -2147024362;
          MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, -2147024362, 0x376u, 0LL);
        }
      }
    }
    else
    {
      v10 = -2003292409;
      MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2003292409, 0x365u, 0LL);
    }
  }
