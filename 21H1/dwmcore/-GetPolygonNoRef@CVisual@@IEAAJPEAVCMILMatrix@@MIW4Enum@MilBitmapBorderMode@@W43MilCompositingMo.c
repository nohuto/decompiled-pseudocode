/*
 * XREFs of ?GetPolygonNoRef@CVisual@@IEAAJPEAVCMILMatrix@@MIW4Enum@MilBitmapBorderMode@@W43MilCompositingMode@@W43MilBitmapInterpolationMode@@_N44PEAPEAVCPolygon@@@Z @ 0x1801B1AC0
 * Callers:
        ...
        __int64 *a11)
{
  ...
  {
    v16 = (*(__int64 (__fastcall **)(__int64, __int128 *))(*(_QWORD *)a1 + 240LL))(a1, &v40);
    v15 = v16;
    if ( v16 < 0 )
    {
      v33 = 5679;
...
LABEL_48:
  ...
  (*(void (__fastcall **)(__int64, __int128 *, __int128 *))(*(_QWORD *)a1 + 312LL))(a1, &v40, &v40);
