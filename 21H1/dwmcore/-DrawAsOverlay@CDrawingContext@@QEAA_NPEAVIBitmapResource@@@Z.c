/*
 * XREFs of ?DrawAsOverlay@CDrawingContext@@QEAA_NPEAVIBitmapResource@@@Z @ 0x1800BAB48
 * Callers:
 ...
 * Callees:
 *     ?IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ @ 0x18001C674 (-IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?IsInLayer@CDrawingContext@@QEBA_NXZ @ 0x18017BD14 (-IsInLayer@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@U_LUID@@PEA_NPEAUtagRECT@@3@Z @ 0x180180E80 (-IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@U_LUID@@PEA_NPEAUtagRECT@@3@Z.c)
