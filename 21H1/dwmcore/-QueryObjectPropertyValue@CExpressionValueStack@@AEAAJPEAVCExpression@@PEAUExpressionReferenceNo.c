/*
 * XREFs of ?QueryObjectPropertyValue@CExpressionValueStack@@AEAAJPEAVCExpression@@PEAUExpressionReferenceNode@@_KPEAVCExpressionValue@@PEAVSubchannelMaskInfo@@@Z @ 0x180202FE4
 * Callers:
 ...
 *     ?Start@QpcStopwatch@@QEAAXXZ @ 0x1801AF2EC (-Start@QpcStopwatch@@QEAAXXZ.c)
 ...
 *     ?ShouldLogPerfStats@CBaseExpression@@IEAA_NXZ @ 0x1801DE570 (-ShouldLogPerfStats@CBaseExpression@@IEAA_NXZ.c)
 *     ?GetReferenceInfoFromNode@CExpression@@QEAAPEAUExpressionReferenceInfo@@PEAUExpressionReferenceNode@@@Z @ 0x1801FFE70 (-GetReferenceInfoFromNode@CExpression@@QEAAPEAUExpressionReferenceInfo@@PEAUExpressionReferenceN.c)
 */
        ...
        struct SubchannelMaskInfo *a6)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_18028C560, 2u, v10, 0xF4u, 0LL);
  }
  else
  {
    if ( v7 )
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_18028C560, 2u, v14, 0xFBu, 0LL);
    }
    else if ( a6 && *((_BYTE *)a6 + 4) && (v16 = CExpressionValue::ApplyMaskToValue(a5, a6), v12 = v16, v16 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_18028C560, 2u, v16, 0x10Bu, 0LL);
    }
    else
    {
      v18 = *((_QWORD *)a2 + 22);
