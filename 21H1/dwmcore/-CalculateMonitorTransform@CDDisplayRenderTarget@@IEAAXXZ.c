/*
 * XREFs of ?CalculateMonitorTransform@CDDisplayRenderTarget@@IEAAXXZ @ 0x18018FFC4
 * Callers:
...
LABEL_15:
  ...
  CMILMatrix::SetToInverse((__m128 *)this + 1153, (CDDisplayRenderTarget *)((char *)this + 18312));
}
