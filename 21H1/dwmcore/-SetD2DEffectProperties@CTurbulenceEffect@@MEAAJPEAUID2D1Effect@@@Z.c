/*
 * XREFs of ?SetD2DEffectProperties@CTurbulenceEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801F4E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTurbulenceEffect::SetD2DEffectProperties(CTurbulenceEffect *this, struct ID2D1Effect *a2)
{
  ...
  int v9; // eax
  __int64 v10; // rcx
  __int64 (__fastcall *v11)(struct ID2D1Effect *, __int64, _QWORD, unsigned __int64 *, int); // rax
  int v12; // eax
  __int64 v13; // rcx
  int v14; // eax
  __int64 v15; // rcx
  ...
  v23 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 38), (__m128)*((unsigned int *)this + 39)).m128_u64[0];
  v5 = v4(a2, 0LL, 0LL, &v23, 8);
  v7 = v5;
  if ( v5 < 0 )
  {
  ...
  else
  {
    ...
    {
      v11 = *(__int64 (__fastcall **)(struct ID2D1Effect *, __int64, _QWORD, unsigned __int64 *, int))(*(_QWORD *)a2 + 72LL);
      v23 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 42), (__m128)*((unsigned int *)this + 43)).m128_u64[0];
      v12 = v11(a2, 1LL, 0LL, &v23, 8);
      v7 = v12;
      if ( v12 < 0 )
      {
