/*
 * XREFs of ??$AppendAllRectangles@V?$DynArrayIA@UtagRECT@@$0BA@$0A@@@@CRegion@@QEBAXPEAV?$DynArrayIA@UtagRECT@@$0BA@$0A@@@@Z @ 0x180017058
 * Callers:
...
void __fastcall CRegion::AppendAllRectangles<DynArrayIA<tagRECT,16,0>>(FastRegion::CRegion *a1, __int64 a2)
{
