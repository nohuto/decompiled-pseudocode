/*
 * XREFs of ?PresentMPO@CConversionSwapChain@@UEAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x180250958
 * Callers:
 *     ?PresentMPO@CConversionSwapChain@@$4PPPPPPPM@A@EAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x1800EF520 (-PresentMPO@CConversionSwapChain@@$4PPPPPPPM@A@EAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRE.c)
 * Callees:
 ...
 *     ??1CRegion@@QEAA@XZ @ 0x180095DD4 (--1CRegion@@QEAA@XZ.c)
 ...
 *     ??0CRegion@@QEAA@XZ @ 0x18016F638 (--0CRegion@@QEAA@XZ.c)
 ...
 *     ??0CRegion@@QEAA@AEBUtagRECT@@@Z @ 0x180178AFC (--0CRegion@@QEAA@AEBUtagRECT@@@Z.c)
        ...
        unsigned int a7)
{
  ...
  int *v35[10]; // [rsp+90h] [rbp-70h] BYREF
  _BYTE v36[80]; // [rsp+E0h] [rbp-20h] BYREF
...
LABEL_31:
  ...
  if ( (_DWORD)v20 == 1 )
  {
    ...
    if ( *((_BYTE *)this - 80) )
    {
      ...
      CRegion::~CRegion((CRegion *)v36);
    }
    CRegion::GetRectangles(v35, &v29);
