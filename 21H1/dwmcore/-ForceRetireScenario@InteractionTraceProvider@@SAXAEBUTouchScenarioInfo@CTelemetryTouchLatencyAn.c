/*
 * XREFs of ?ForceRetireScenario@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@@Z @ 0x1801624AC
 * Callers:
        ...
        const struct CTelemetryTouchLatencyAnalysis::TouchScenarioInfo *a1)
{
  ...
  if ( (unsigned int)dword_180346E48 > 5 && (qword_180346E58 & 8) != 0 && (qword_180346E60 & 8) == qword_180346E60 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1802E66AC,
      0LL,
      0LL,
      6u,
      &v5);
