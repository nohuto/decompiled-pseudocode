/*
 * XREFs of SmpStartCsr @ 0x1400020F0
 * Callers:
 ...
 *     SmpAllocateControlBlock @ 0x140002960 (SmpAllocateControlBlock.c)
 ...
 *     SmpRecordControlBlock @ 0x140003E78 (SmpRecordControlBlock.c)
    ...
    if ( CoreProcessIds >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        *((_DWORD *)v4 + 2) = ProcessInformation;
        v8 = _InterlockedIncrement(&dword_140024B10);
