/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x140011AE0
 * Callers:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_140024308 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_140024308
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_140024308 - 1)
                                                   + 8256LL);
