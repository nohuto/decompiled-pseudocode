/*
 * XREFs of SmpComputeDesiredPfSizeBasedOnHistory @ 0x140011828
 * Callers:
 *     SmpInitializeManagedPagefileSupport @ 0x140011F2C (SmpInitializeManagedPagefileSupport.c)
 * Callees:
...
__int64 SmpComputeDesiredPfSizeBasedOnHistory()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (unsigned int)Data < 0xF0 )
    v18 = Data;
  if ( v18 )
    memcpy_0(Base, &unk_140024654, 4LL * v18);
  qsort(Base, v18, 4uLL, SmpPagefileUsageSampleCompare);
  v19 = (unsigned int)dword_140024308 * (unsigned __int64)(unsigned int)Base[9 * v18 / 0xA];
  return v19 + (v19 >> 4);
}
