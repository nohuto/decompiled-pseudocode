/*
 * XREFs of SmpApiCallback @ 0x140002A60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SmpMarkThreadFree @ 0x1400036C4 (SmpMarkThreadFree.c)
 *     SmpMarkThreadBusy @ 0x140003730 (SmpMarkThreadBusy.c)
 *     SmpStopCsr @ 0x1400059C0 (SmpStopCsr.c)
 *     SmpSessionComplete @ 0x140005A20 (SmpSessionComplete.c)
 ...
 *     _guard_dispatch_icall_nop @ 0x14000EE30 (_guard_dispatch_icall_nop.c)
...
NTSTATUS __fastcall SmpApiCallback(__int64 a1, __int64 a2)
{
  ...
  if ( v8 != 5 )
  {
    if ( (unsigned int)v8 <= 2 )
    {
      ...
      v11 = (__int64 (__fastcall *)(__int64, __int64))*(&SmpApiDispatch + 2 * v8);
      v12 = v4;
      v13 = v7;
      if ( (char *)v11 == (char *)SmpSessionComplete )
      {
        v14 = SmpSessionComplete(v21, v7, v4);
        goto LABEL_30;
      }
      goto LABEL_52;
    }
