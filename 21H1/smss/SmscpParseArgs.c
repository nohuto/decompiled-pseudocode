/*
 * XREFs of SmscpParseArgs @ 0x140005378
 * Callers:
 *     SmscMain @ 0x140003F4C (SmscMain.c)
 * Callees:
 *     SmpGetFirstSessionId @ 0x140005630 (SmpGetFirstSessionId.c)
 *     SmscpSetupSharedSpace @ 0x140005664 (SmscpSetupSharedSpace.c)
 *     SmscpIsDebuggerPresent @ 0x140015A20 (SmscpIsDebuggerPresent.c)
 */
...
LABEL_16:
              ...
              && (SystemInformation[0] & 0x4000004) != 0 )
            {
              ...
              {
                RtlAppendUnicodeStringToString(a4, &stru_140016CA0);
                v32 = SystemInformation[0];
                if ( (SystemInformation[0] & 0x20000) != 0 )
                {
                  RtlAppendUnicodeStringToString(a4, &stru_140016C90);
                  v32 = SystemInformation[0];
                }
                if ( (v32 & 0x4000000) != 0 )
                  RtlAppendUnicodeStringToString(a4, &stru_140016C80);
              }
            }
LABEL_17:
            v20 = v4;
