/*
 * XREFs of SmpInitializeManagedPagefileSupport @ 0x140011F2C
 * Callers:
 *     SmpMakeSystemManagedPagingFileDescriptor @ 0x14001219C (SmpMakeSystemManagedPagingFileDescriptor.c)
 * Callees:
 *     SmpComputeDesiredPfSizeBasedOnHistory @ 0x140011828 (SmpComputeDesiredPfSizeBasedOnHistory.c)
 *     SmpComputeDesiredPfSizeForCrashDump @ 0x140011AE0 (SmpComputeDesiredPfSizeForCrashDump.c)
 */
