/*
 * XREFs of SmpSendPlatformBinaryStatus @ 0x140014C2C
 * Callers:
...
char __fastcall SmpSendPlatformBinaryStatus(int a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  if ( a4 )
  {
    if ( (unsigned int)dword_140023018 > 5 )
    {
      ...
      if ( (_BYTE)Heap )
      {
        ...
        v37 = 2LL;
        v39[1] = 0;
        LOBYTE(Heap) = tlgWriteTransfer_EtwEventWriteTransfer(v14, byte_14001E73F, v15, v16, 6, (__int64)v31);
      }
    }
  }
  else if ( (unsigned int)dword_140023018 > 5 )
  {
    LOBYTE(Heap) = tlgKeywordOn();
    if ( (_BYTE)Heap )
    {
      ...
      v27 = a3;
      v44 = 8LL;
      LOBYTE(Heap) = tlgWriteTransfer_EtwEventWriteTransfer(v17, byte_14001E70E, v18, v19, 4, (__int64)v40);
    }
  }
  return (char)Heap;
}
