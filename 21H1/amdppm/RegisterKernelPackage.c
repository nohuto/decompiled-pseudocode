/*
 * XREFs of RegisterKernelPackage @ 0x1C002ECE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C0013700)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C0013430;
  if ( (__int64 *)qword_1C0013430 != &qword_1C0013430 )
  {
    ...
    while ( (__int64 *)v4 != &qword_1C0013430 );
    if ( v5 )
      goto LABEL_12;
  }
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)PoolWithTag + 9) = ((__int64 (__fastcall *)(_QWORD))qword_1C0013708)(v3);
    *(_DWORD *)(v5 + 36) += HalPrivateDispatchTable[145](v3);
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v8 = (__int64 *)qword_1C0013438;
    if ( *(__int64 **)qword_1C0013438 != &qword_1C0013430 )
      goto LABEL_15;
    *(_QWORD *)v5 = &qword_1C0013430;
    *(_QWORD *)(v5 + 8) = v8;
    *v8 = v5;
    qword_1C0013438 = v5;
LABEL_12:
