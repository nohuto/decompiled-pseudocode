/*
 * XREFs of RegisterKernelCoordinatedLpiStates @ 0x1C002E5A4
 * Callers:
...
__int64 __fastcall RegisterKernelCoordinatedLpiStates(__int64 a1)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  CoordinatedLpiStates = AcpiGetCoordinatedLpiStates(a1, &qword_1C00139B8);
  if ( CoordinatedLpiStates >= 0 )
  {
    v4 = qword_1C00139B8;
    if ( !*(_DWORD *)qword_1C00139B8 )
      return 0;
    ...
    *(_QWORD *)(v5 + 24) = v6;
    ...
    qword_1C00139A0 = v5;
    qword_1C00139A8 = v7;
    CoordinatedLpiStates = ((__int64 (__fastcall *)(__int64))qword_1C0013640)(v5);
    if ( CoordinatedLpiStates >= 0 )
      return 0;
