/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C002FC74
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C001398C;
  v2 = a1;
  v3 = dword_1C00133F4;
  if ( dword_1C001398C )
  {
    v5 = (48 * dword_1C001398C + 59) & 0xFFFFFFFC;
    PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v5 + 8 * dword_1C001398C * dword_1C00133F4, 0x72637250u);
    v7 = PoolWithTag;
    if ( PoolWithTag )
    {
      ...
      if ( v9 )
      {
        ...
        while ( (unsigned int)v10 < (unsigned int)v1 )
        {
          ...
          *v9 = v10;
          v9[8] = v3;
          ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C00136A8)(
                                       *(_QWORD *)(v2 + 1104),
                                       v9,
                                       0LL);
        ...
        *(_DWORD *)v7 = 62;
        *((_DWORD *)v7 + 1) = dword_1C001398C;
        *((_DWORD *)v7 + 2) = dword_1C001398C;
        ...
        *((_QWORD *)v7 + 4) = PepIdleComplete;
        ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C0013638)(v7);
        if ( ProcessorNumberFromIndex >= 0 )
        {
          Src = v7;
          v7 = 0LL;
