/*
 * XREFs of ProcLibDeviceStart @ 0x1C0027B70
 * Callers:
 ...
 *     AcquireBiosPpmControl @ 0x1C00081F0 (AcquireBiosPpmControl.c)
 ...
 *     AcpiEval_PDC @ 0x1C00249A4 (AcpiEval_PDC.c)
...
__int64 __fastcall ProcLibDeviceStart(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 48) = v4;
  *(_DWORD *)(a1 + 52) = v65;
  v6 = ((__int64 (__fastcall *)(__int64))qword_1C00137F0)(a1);
  v7 = v6;
  if ( v6 < 0 )
  {
    *(_QWORD *)(a1 + 272) = 0LL;
...
LABEL_133:
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      *(_QWORD *)(a1 + 208),
      0LL);
    v40 = ((__int64 (__fastcall *)(__int64))qword_1C00137B8)(a1);
    ...
    else
    {
      if ( byte_1C0013828 )
      {
        if ( !(unsigned int)((__int64 (__fastcall *)(__int64))qword_1C00137F8)(a1) )
        {
LABEL_168:
          if ( (int)ValidatePerfDomainSymmetry(a1) >= 0 )
          {
            ...
            {
              ((void (__fastcall *)(__int64))qword_1C00137D8)(a1);
            }
            else
            {
              v49 = (void (__fastcall *)(__int64))qword_1C00137C0;
              if ( (*(_QWORD *)(a1 + 272) & 0x73300000LL) == 0 )
                v49 = (void (__fastcall *)(__int64))qword_1C00137D0;
              v49(a1);
            }
          }
        }
LABEL_178:
        if ( (*(_QWORD *)(a1 + 272) & 0x2000000000LL) != 0 && ++dword_1C0013BE0 == dword_1C00133F4 )
...
LABEL_184:
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C0013808, (__int64)&PPM_ETW_IDLE_STATES_ERROR_HV, 0, 0LL);
    v50 = *(_DWORD *)(a1 + 264);
    v51 = *(_QWORD *)(a1 + 272);
  }
  v52 = v50 & 0x40000000;
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C0013810, (__int64)&PPM_ETW_PERF_STATES_ERROR_HV, 0, 0LL);
    v50 = *(_DWORD *)(a1 + 264);
    v51 = *(_QWORD *)(a1 + 272);
  }
  if ( ((unsigned int)v51 & v50 & 0x3300000) != (unsigned __int64)(v50 & 0x3300000) )
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C0013818, (__int64)&PPM_ETW_THROTTLE_STATES_ERROR_HV, 0, 0LL);
    v50 = *(_DWORD *)(a1 + 264);
    v51 = *(_QWORD *)(a1 + 272);
  }
