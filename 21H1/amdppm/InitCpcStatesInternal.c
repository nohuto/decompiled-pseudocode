/*
 * XREFs of InitCpcStatesInternal @ 0x1C002BE58
 * Callers:
 *     RegisterHvCpcCounters @ 0x1C0021740 (RegisterHvCpcCounters.c)
 *     RegisterKernelCpc @ 0x1C002E820 (RegisterKernelCpc.c)
 * Callees:
 ...
 *     GetPackageAffinity @ 0x1C002BC3C (GetPackageAffinity.c)
...
LABEL_71:
    if ( qword_1C00135B0 )
    {
      ...
      if ( (int)qword_1C00135B0(v18 - 92, &v158, &v162, &v163, &v159, &v135, &v151) < 0 )
        v17 = 0;
    }
    LOBYTE(v43) = v143;
