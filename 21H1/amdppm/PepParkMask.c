/*
 * XREFs of PepParkMask @ 0x1C000DC90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification )
  {
    ...
    if ( dword_1C0013968 >= (unsigned int)dword_1C00133F4 )
    {
      ...
      v5 = 0;
      KeInitializeEnumerationContext(&v8, &unk_1C0013710);
      ...
      if ( !(_DWORD)result )
      {
        ...
        if ( v5 )
        {
          ...
          v10[0] = v5;
          v12 = &PepParkLists;
          result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C0013698)(*(_QWORD *)(v7 + 1104), v10);
          if ( (int)result < 0 )
          {
