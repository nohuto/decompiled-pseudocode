/*
 * XREFs of MiLogProcessWorkingSetsStart @ 0x1402D5E84
 * Callers:
...
void __fastcall MiLogProcessWorkingSetsStart(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(*(_QWORD *)&qword_140C4EE20, 1LL, a3, a2) )
    {
      v9 = *(_BYTE *)(v6 + 2);
      v24 = 0;
      v27 = 0;
      ...
      v44 = 8;
      v29 = 4;
      tlgWriteEx_EtwWriteEx(v7, (int)&byte_140024CA7, v5, v4, v12, v13, 0xAu, (__int64)v22);
    }
  }
}
