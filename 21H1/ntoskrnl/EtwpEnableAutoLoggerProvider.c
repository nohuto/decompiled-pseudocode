/*
 * XREFs of EtwpEnableAutoLoggerProvider @ 0x14077D4C0
 * Callers:
        ...
        int a6)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  LODWORD(v73[25]) = 4;
  v67 = 4;
  RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v73, 0LL);
  if ( RegistryValues < 0 )
    goto LABEL_73;
  ...
  if ( Handle && !a6 )
  {
    ...
    LODWORD(v73[34]) = 8;
    LODWORD(v73[41]) = 8;
    RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)Handle, (__int64)v73, 0LL);
    v19 = (const WCHAR *)Handle;
  }
  if ( RegistryValues < 0 )
    goto LABEL_73;
