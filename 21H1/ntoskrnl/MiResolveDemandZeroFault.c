/*
 * XREFs of MiResolveDemandZeroFault @ 0x14020F020
 * Callers:
...
LABEL_19:
  ...
  {
    v21 = *(_QWORD *)(qword_140C4E588 + 8LL * Process[1].IdealProcessorPadding[5]);
    if ( *(_DWORD *)(v21 + 1160) )
    {
  ...
  if ( !v73 )
  {
    ...
    v65 = v25;
    v63 = 0LL;
    return MiResolvePrivateZeroFault(v61, v24, 0LL, v14);
  }
  v27 = v61[0];
  v28 = 0;
  v63 = v6;
