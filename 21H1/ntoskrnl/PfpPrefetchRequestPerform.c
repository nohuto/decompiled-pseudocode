/*
 * XREFs of PfpPrefetchRequestPerform @ 0x1405D2440
 * Callers:
 ...
 *     PfpPrefetchRequestPatchOffsets @ 0x1405D3328 (PfpPrefetchRequestPatchOffsets.c)
...
__int64 __fastcall PfpPrefetchRequestPerform(__int64 a1)
{
  ...
  *(_QWORD *)(v30[5] + 24LL) = v30;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_BYTE *)(v30[0] + 81LL) )
    {
      _InterlockedAdd(&dword_140CEC0D8, 1u);
      v4 = PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140C50220, 0);
      if ( v4 < 0 )
        goto LABEL_26;
...
LABEL_26:
        if ( v5 )
        {
          _InterlockedDecrement(&dword_140CEC0D8);
          PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140C50220, 0);
        }
        goto LABEL_28;
      }
