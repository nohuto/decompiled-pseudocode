/*
 * XREFs of IopGetBootDiskInformationLite @ 0x140A477C0
 * Callers:
 *     IoGetBootDiskInformationLite @ 0x140788C10 (IoGetBootDiskInformationLite.c)
 * Callees:
 ...
 *     IopAddBootDiskInformation @ 0x1403B24B4 (IopAddBootDiskInformation.c)
