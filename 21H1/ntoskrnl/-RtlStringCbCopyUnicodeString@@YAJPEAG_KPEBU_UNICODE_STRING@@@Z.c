/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x140597B7C
 * Callers:
 *     SmKmKeyGenStart @ 0x1409273C8 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x140597C38 (RtlUnicodeStringValidateSrcWorker.c)
 */
