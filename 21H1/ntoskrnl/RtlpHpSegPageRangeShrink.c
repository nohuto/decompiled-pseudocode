/*
 * XREFs of RtlpHpSegPageRangeShrink @ 0x1402B27B0
 * Callers:
...
__int64 __fastcall RtlpHpSegPageRangeShrink(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 SchedulerAssist)
{
  int v4; // ebp
  int v5; // r12d
  ...
  if ( (v5 & 1) == 0 )
  {
    if ( (*(_DWORD *)(a1 + 40) & 1) != 0 )
    {
      ...
      if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
        ...
        ExpAcquireSpinLockExclusive(v9, CurrentIrql, a3, (_DWORD *)SchedulerAssist);
    }
    else
    {
...
LABEL_66:
      ...
      result = KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread(), v32, v34, v35);
    }
  }
  if ( v19 )
