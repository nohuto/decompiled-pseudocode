/*
 * XREFs of DbgkCaptureLiveDump @ 0x14088390C
 * Callers:
 ...
 *     DbgkpLkmdSnapThread @ 0x1404E8DA4 (DbgkpLkmdSnapThread.c)
 ...
 *     DbgkpLkmdSqmStatus @ 0x1408844E4 (DbgkpLkmdSqmStatus.c)
...
__int64 __fastcall DbgkCaptureLiveDump(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  {
    EtwRegister(&stru_140010068, 0LL, 0LL, &RegHandle);
    v7 = RegHandle;
    if ( RegHandle )
