/*
 * XREFs of RtlCompareUnicodeStrings @ 0x1406B5F00
 * Callers:
 *     ApiSetpSearchForApiSet @ 0x14039FE10 (ApiSetpSearchForApiSet.c)
 *     EtwpAvlCompareKeyNames @ 0x1403B8A90 (EtwpAvlCompareKeyNames.c)
 *     ApiSetpSearchForApiSetHost @ 0x1405B87FC (ApiSetpSearchForApiSetHost.c)
 *     AsiSortValueList @ 0x1405B91A0 (AsiSortValueList.c)
 ...
 *     PopDirectedDripsUmTestDeviceCompare @ 0x1408F4390 (PopDirectedDripsUmTestDeviceCompare.c)
