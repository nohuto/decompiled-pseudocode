/*
 * XREFs of IopStoreArcInformation @ 0x140A56308
 * Callers:
...
__int64 __fastcall IopStoreArcInformation(__int64 a1)
{
  ...
  v2 = dword_140C19730;
  v3 = 0;
  qword_140D2D860 = (__int64)&IoArcTableListHead;
  ...
  for ( i = *v1; ; i = (__int64 *)*i )
  {
    ...
    *((_OWORD *)Pool + 3) = *((_OWORD *)i + 3);
    ...
    if ( v2 == 1 && v7 >= 9 && !strnicmp(&v8[v7 - 9], "rdisk(0)", 8uLL) )
      *((_BYTE *)Pool + 76) = 1;
    v10 = (PVOID **)qword_140D2D860;
    if ( *(PVOID **)qword_140D2D860 != &IoArcTableListHead )
LABEL_30:
      __fastfail(3u);
    *Pool = &IoArcTableListHead;
    Pool[1] = v10;
    *v10 = Pool;
    qword_140D2D860 = (__int64)Pool;
  }
  while ( 1 )
  {
