/*
 * XREFs of MiDereferenceIoPages @ 0x1402FA7E8
 * Callers:
...
void __fastcall MiDereferenceIoPages(int a1, __int64 a2, ULONG_PTR a3)
{
  ...
  v7 = a3;
  i = (unsigned __int64 *)&xmmword_140C4EB88 + a1;
  v43 = i;
  v9 = &qword_140C4EB98;
  if ( a1 != 1 )
    v9 = 0LL;
  v44 = v9;
  v10 = ExAcquireSpinLockExclusive(&dword_140C4EB80);
  v45 = v10;
LABEL_4:
    ...
    if ( v44 )
    {
      ...
      *((_DWORD *)v17 + 14) = KiCacheFlushTimeStamp;
      if ( (__int64 *)qword_140C4EBA0 == &qword_140C4EBA0 )
        dword_140C4EBB0 = v31;
      v32 = (_QWORD *)qword_140C4EBA8;
      v33 = v17 + 3;
      if ( *(__int64 **)qword_140C4EBA8 != &qword_140C4EBA0 )
        __fastfail(3u);
      *v33 = &qword_140C4EBA0;
      v34 = 0;
      v17[4] = (unsigned __int64)v32;
      *v32 = v33;
      qword_140C4EBA8 = (__int64)(v17 + 3);
      v35 = (_QWORD *)*v25;
      if ( *v25 )
      {
        while ( 1 )
