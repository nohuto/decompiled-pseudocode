/*
 * XREFs of DownLevelGetParentLanguageName @ 0x1405B8558
 * Callers:
...
__int64 __fastcall DownLevelGetParentLanguageName(const void *a1, char *a2)
{
  ...
  if ( !a2 )
    return 0LL;
  v3 = bsearch(a1, &off_140002F80, 0x1B4uLL, 8uLL, (int (__cdecl *)(const void *, const void *))CompareLangName);
  if ( !v3 )
    return 0LL;
  v4 = -1LL;
  v5 = (char *)(&off_140003D20)[2 * dword_140003D2C[4 * word_14001F560[(v3 - (_BYTE *)&off_140002F80) >> 3]]];
  do
    ++v4;
  while ( *(_WORD *)&v5[2 * v4] );
