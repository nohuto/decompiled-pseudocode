/*
 * XREFs of CmpDoFileRead @ 0x14031861C
 * Callers:
 *     CmpFileRead @ 0x1406E0830 (CmpFileRead.c)
 * Callees:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( IoStatusBlock.Information != Length )
    {
      ...
      CmRegistryIODebug = 1;
      dword_140D2DAB0 = Information - Length;
      result = 3221225489LL;
      qword_140D2DAA8 = (__int64)FileHandle;
      return result;
    }
LABEL_11:
    v7 = v21;
