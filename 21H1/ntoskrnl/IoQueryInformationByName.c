/*
 * XREFs of IoQueryInformationByName @ 0x1405CE2F0
 * Callers:
 *     NtQueryInformationByName @ 0x140890420 (NtQueryInformationByName.c)
 * Callees:
 ...
 *     IopCleanupExtraCreateParameters @ 0x1406EDC64 (IopCleanupExtraCreateParameters.c)
        ...
        _QWORD *Src)
{
  ...
  v11 = 0;
  v12 = 0LL;
  v13 = (unsigned __int8)KeGetCurrentThread()->$6A88714AB977AAA8032D9F5E2A96BA31::gap0[10];
  if ( (a6 & 0x100) == 0 )
    v12 = v13;
  v24 = v12;
  v14 = a5;
