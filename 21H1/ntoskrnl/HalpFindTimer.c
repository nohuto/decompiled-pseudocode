/*
 * XREFs of HalpFindTimer @ 0x140399F38
 * Callers:
 ...
 *     HalpTimerSaveProcessorFrequency @ 0x1403A52A0 (HalpTimerSaveProcessorFrequency.c)
 ...
 *     HalpTimerFindBestAlwaysOnTimer @ 0x1403A6A6C (HalpTimerFindBestAlwaysOnTimer.c)
 *     HalpTimerFindIdealPerformanceCounterSource @ 0x1403A6B0C (HalpTimerFindIdealPerformanceCounterSource.c)
 *     HalpTimerNoteHpetMaskingBehavior @ 0x1403A6BFC (HalpTimerNoteHpetMaskingBehavior.c)
 *     HalpTimerFindIdealClockSource @ 0x1403A6DC4 (HalpTimerFindIdealClockSource.c)
 *     HalpTimerFindIdealWatchdog @ 0x1403A6EAC (HalpTimerFindIdealWatchdog.c)
