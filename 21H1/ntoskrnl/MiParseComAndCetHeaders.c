/*
 * XREFs of MiParseComAndCetHeaders @ 0x140645060
 * Callers:
...
__int64 __fastcall MiParseComAndCetHeaders(__int64 *a1, unsigned int *a2, _BYTE *a3)
{
  ...
  ULONG_PTR v26; // [rsp+28h] [rbp-140h]
  ...
  *a3 = 0;
  ...
  if ( !v6 )
    return 0LL;
  HIDWORD(v25) = MiMapImageInSystemSpace(a1, 3, (__int64)v30);
  if ( v25 >= 0 )
  {
    ...
    if ( (v6 & 2) != 0 )
    {
      ...
      for ( i = 0; ; i = v27 + 1 )
      {
        ...
        if ( i >= (v21 + (((unsigned __int64)a2[27] - v21) >> 1)) >> 4 )
          break;
        MiLogRelocationRva(a2[26] + 28 * i, 28LL, v26, a1, v25);
        v29 = *(_QWORD *)(v19 + 16);
        if ( HIDWORD(*(_OWORD *)v19) == 20 )
        {
          ...
          if ( (unsigned int)v29 >= v22 || HIDWORD(v29) >= v22 || HIDWORD(v29) + (int)v29 >= v22 )
            break;
          MiLogRelocationRva(HIDWORD(v29), 4LL, v26, a1, v25);
...
LABEL_49:
  ...
  if ( v6 >= 8 )
    MiDereferenceControlAreaFile((__int64)a1, v24);
  return HIDWORD(v25);
}
