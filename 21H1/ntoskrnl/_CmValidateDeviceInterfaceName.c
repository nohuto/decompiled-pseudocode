/*
 * XREFs of _CmValidateDeviceInterfaceName @ 0x1406AA728
 * Callers:
...
__int64 __fastcall CmValidateDeviceInterfaceName(__int64 a1, const WCHAR *a2)
{
  ...
  if ( inited >= 0
    ...
    && (RtlPrefixUnicodeString(&stru_140001BE8, &DestinationString, 0)
     || RtlPrefixUnicodeString(&stru_140001BF8, &DestinationString, 0)) )
  {
    for ( i = a2 + 4; *i; ++i )
    {
      if ( *i == 92 )
