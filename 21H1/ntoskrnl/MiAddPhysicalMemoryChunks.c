/*
 * XREFs of MiAddPhysicalMemoryChunks @ 0x1408C0ADC
 * Callers:
 *     MiActOnPartitionNodePages @ 0x14055ADB0 (MiActOnPartitionNodePages.c)
 *     MmAddPhysicalMemory @ 0x1408C19D0 (MmAddPhysicalMemory.c)
 ...
 *     MiNodeLargeFreeZeroPages2 @ 0x140551270 (MiNodeLargeFreeZeroPages2.c)
...
__int64 __fastcall MiAddPhysicalMemoryChunks(ULONG_PTR *a1, unsigned __int64 *a2, _QWORD *a3, int a4)
{
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v31 = qword_140C50C90 + 4544LL * ((unsigned int)MiGetClosestImplicitNode(v15 + 1) - 1);
      if ( v11 < 0 )
      {
        v14 = v32;
        if ( v32 > 0x200 )
