/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x1408AD420
 * Callers:
...
void PnpTraceDeviceRemovalForResetComplete()
{
  ...
  if ( dword_140C02D80 && tlgKeywordOn((__int64)&dword_140C02D80, 0x400000000000LL) && v1 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02D80, v0) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_1400241F6,
        0LL,
        0LL,
        0xDu,
        &v9);
