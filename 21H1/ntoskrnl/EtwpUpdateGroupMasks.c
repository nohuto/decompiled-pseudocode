/*
 * XREFs of EtwpUpdateGroupMasks @ 0x14077FE0C
 * Callers:
 ...
 *     EtwpCheckSiloGroupMasks @ 0x1405A4AB4 (EtwpCheckSiloGroupMasks.c)
...
__int64 __fastcall EtwpUpdateGroupMasks(int *a1, __int64 a2)
{
  ...
  if ( *((_QWORD *)a1 + 139) == EtwpHostSiloState || (result = EtwpCheckSiloGroupMasks((char *)a2), (int)result >= 0) )
  {
    if ( a2
      && (*(_DWORD *)(a2 + 4) & 0x402) != 0
