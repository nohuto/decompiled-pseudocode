/*
 * XREFs of KiTrackSystemCallEntry @ 0x1408B88B0
 * Callers:
 ...
 *     KiSystemServiceTraceTableCompareFunction @ 0x1408B8890 (KiSystemServiceTraceTableCompareFunction.c)
 */
...
__int64 __fastcall KiTrackSystemCallEntry(unsigned __int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( KeIsTraceCallbackAllowed(KeGetCurrentThread()->PreviousMode) )
  {
    ...
    if ( v8 && *(_BYTE *)(v8 + 40) && KiDynamicTraceEnabled )
    {
      ...
      if ( *(_BYTE *)(v8 + 40) )
        ((void (__fastcall *)(_QWORD, _QWORD, _QWORD, __int64, int, __int64))qword_140CFCB70)(
          *(_QWORD *)(v8 + 24),
          *(_QWORD *)(v8 + 48),
          *(unsigned int *)(v8 + 32),
          a2,
