/*
 * XREFs of KeInitSystem @ 0x140A3F138
 * Callers:
 ...
 *     KeInitializeCatRegisters @ 0x1403A46D8 (KeInitializeCatRegisters.c)
 ...
 *     KeInitializeSchedulerAssist @ 0x140A3EEEC (KeInitializeSchedulerAssist.c)
 ...
 *     KiInitDynamicTraceSupport @ 0x140A4030C (KiInitDynamicTraceSupport.c)
 */
    ...
    else
    {
      ...
      if ( (HvlpFlags & 0x100000) != 0 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          qword_140C2B078 = (__int64)KiEpfCompletionDpcRoutine;
          qword_140C2B080 = 0LL;
          qword_140C2B098 = 0LL;
          qword_140C2B070 = 0LL;
