/*
 * XREFs of BgpFwAllocateMemory @ 0x140399064
 * Callers:
 ...
 *     BgpFwReserveAllocate @ 0x1403991EC (BgpFwReserveAllocate.c)
...
__int64 __fastcall BgpFwAllocateMemory(unsigned __int64 a1)
{
  ...
  if ( !a1 )
    return 0LL;
  if ( (dword_140C132D0 & 0x800) == 0 )
  {
    v1 = dword_140C132D0 & 0x8000;
    v2 = 0LL;
    v3 = 0LL;
...
LABEL_7:
        ...
        if ( v1 )
        {
          v8 = qword_140C133A0;
          v9 = v2 - 40;
          if ( *(__int64 **)(qword_140C133A0 + 8) != &qword_140C133A0 )
            __fastfail(3u);
          *(_QWORD *)v9 = qword_140C133A0;
          *((_QWORD *)v9 + 1) = &qword_140C133A0;
          *(_QWORD *)(v8 + 8) = v9;
          qword_140C133A0 = (__int64)(v2 - 40);
        }
        *((_DWORD *)v2 - 6) = v4;
        *((_QWORD *)v2 - 2) = v6;
        *((_QWORD *)v2 - 1) = v3;
