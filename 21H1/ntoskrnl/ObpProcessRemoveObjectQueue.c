/*
 * XREFs of ObpProcessRemoveObjectQueue @ 0x1405EF5A0
 * Callers:
 *     <none>
 * Callees:
...
int ObpProcessRemoveObjectQueue()
{
  ...
  if ( !qword_140C13110 )
  {
    ...
    if ( !v18 )
      qword_140C13110 = 1LL;
    v19 = __rdtsc();
    qword_140C13118 = (41929663 * (unsigned int)((((unsigned __int64)HIDWORD(v19) << 32) | (unsigned int)v19) >> 4)) ^ 0xC24LL;
    qword_140C13120 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  if ( KiQueryUnbiasedInterruptTime() >= (unsigned __int64)qword_140C13120 )
  {
    v22 = &xmmword_140CFCBE0;
    ...
    if ( NextSession )
    {
      ...
      {
        if ( !qword_140C13128 )
          qword_140C13128 = (unsigned int)KiTableInformation;
        if ( (_DWORD)xmmword_140CFCA70 && (_BYTE)KdDebuggerNotPresent )
        {
          ...
          while ( v4 );
          if ( v2 != qword_140C13128 && !qword_140C130E0 )
          {
            v21[8] = -2071986176;
            qword_140C130E0 = (unsigned int)__ROL4__(-2071986176, 233);
            xmmword_140C130E8 = 0LL;
            qword_140C130F8 = 266LL;
            qword_140C13100 = v6;
          }
        }
