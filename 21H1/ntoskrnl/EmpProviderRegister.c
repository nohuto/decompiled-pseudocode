/*
 * XREFs of EmpProviderRegister @ 0x140788C40
 * Callers:
 *     EmProviderRegister @ 0x140788BD0 (EmProviderRegister.c)
 *     PoInitSystem @ 0x140A3BEEC (PoInitSystem.c)
 *     EmInitSystem @ 0x140A4710C (EmInitSystem.c)
 *     HalRegisterErrataCallbacks @ 0x140A47430 (HalRegisterErrataCallbacks.c)
 * Callees:
 ...
 *     EmpSearchCallbackDatabase @ 0x1403B2444 (EmpSearchCallbackDatabase.c)
