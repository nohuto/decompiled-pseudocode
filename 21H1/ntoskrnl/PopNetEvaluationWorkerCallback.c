/*
 * XREFs of PopNetEvaluationWorkerCallback @ 0x1403C7230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopNetEvaluateStateMask @ 0x1407B769C (PopNetEvaluateStateMask.c)
...
__int64 __fastcall PopNetEvaluationWorkerCallback(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    v5 = 1;
    if ( PopNetResiliencyEngaged && qword_140C54300 )
    {
      LOBYTE(v8) = 1;
      v18 = 1;
...
LABEL_6:
  ...
  _InterlockedExchange(&dword_140C20AA8, 0);
