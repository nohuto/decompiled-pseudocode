/*
 * XREFs of ?StDmStart@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@PEAU_ST_DATA_MGR@1@PEAU_STDM_PARAMETERS@@PEAU_RTL_BITMAP@@PEAKK@Z @ 0x1402CA9F0
 * Callers:
...
NTSTATUS __fastcall ST_STORE<SM_TRAITS>::StDmStart(__int64 a1, __int64 a2, int *a3, __int64 a4, __int64 a5, int a6)
{
  ...
  *(_DWORD *)(a2 + 856) = a6;
  ...
  v23 = ST_STORE<SM_TRAITS>::StNpEnumBTreeNodes;
  v24 = ST_STORE<SM_TRAITS>::StNpLeafPageOut;
