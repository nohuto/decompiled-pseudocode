/*
 * XREFs of KiSchedulerApc @ 0x1403564C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiRemoveQueueApc @ 0x14033EC78 (KiRemoveQueueApc.c)
 ...
 *     KiResumeUmsThread @ 0x1408B9030 (KiResumeUmsThread.c)
...
char __fastcall KiSchedulerApc(ULONG_PTR a1)
{
  ...
  result = (unsigned __int8)memset(v82, 0, 0x98uLL);
  v6 = *(_DWORD *)(a1 + 120);
  v77 = 0;
  v7 = v6 & 0x8000;
  v76 = 0;
  ...
  if ( !*(_DWORD *)(a1 + 740) && !v7 )
  {
    ...
    if ( (*(_DWORD *)(a1 + 116) & 0x40000) == 0 )
    {
      ...
      if ( v31 )
      {
        --*(_WORD *)(a1 + 486);
        v32 = *(_WORD *)(v31 + 368);
        KiLeaveGuardedRegionUnsafe(a1, v3, v4, (__int64)v5);
        v30 = v32 & 1;
      }
    }
  ...
  *(_DWORD *)(a1 + 116) &= ~0x40000u;
  if ( v7 )
  {
    if ( KiIsProcessTerminationRequested(a1, &v77) )
    {
    ...
    if ( (*(_DWORD *)(a1 + 116) & 0x4000) != 0 )
    {
      ...
      *(_BYTE *)(a1 + 730) = 1;
      KiInsertQueueApc(a1 + 648, v19, v20, v21);
      LOBYTE(v26) = v22;
      KiSignalThreadForApc(v23, a1 + 648, v26);
    }
    KiReleaseThreadLockSafe(a1);
    return KiExitDispatcher((__int64)v23, 0LL, 1LL, 0LL, v22);
  }
  return result;
}
