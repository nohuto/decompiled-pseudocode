/*
 * XREFs of PopWriteHiberPages @ 0x14098D6B4
 * Callers:
 *     PopWriteSecurePages @ 0x140569928 (PopWriteSecurePages.c)
 *     PopWriteSecurePagesCallback @ 0x1405699D0 (PopWriteSecurePagesCallback.c)
  ...
  if ( *(int *)(v6 + 188) >= 0 )
  {
    if ( (a4 + a3) << 12 > qword_140C235F0 )
    {
      ...
      *(_QWORD *)MaxDataSize = MmGetNumberOfPhysicalPages(0);
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_140C235F0, *(unsigned int *)(v6 + 184), BugCheckParameter4);
    }
    if ( a3 > 0xFFFFFFFFFFFFFLL )
      PopInternalError(0xA20F3uLL);
    ...
    while ( v11 )
    {
      ...
      v19 = __rdtsc();
      dword_140C23B30 += v14;
      qword_140C23958 += (((unsigned __int64)HIDWORD(v19) << 32) | (unsigned int)v19) - v17;
      result = v25;
      v11 -= v25;
      v10 += v25;
      a2 += v25;
