/*
 * XREFs of SepSecureBootUpdateBcdDataForRule @ 0x14091FDB4
 * Callers:
 ...
 *     SepSecureBootGetPolicyDefaultValue @ 0x14091FC24 (SepSecureBootGetPolicyDefaultValue.c)
...
__int64 __fastcall SepSecureBootUpdateBcdDataForRule(__int64 a1, void *a2, BCD_FLAGS a3)
{
  ...
  v3 = (_WORD *)(qword_140CF9F80 + *(unsigned int *)(a1 + 8));
  Buffer = 0LL;
  PoolWithTag = 0LL;
  v15[0] = 0LL;
  v17 = 0;
