/*
 * XREFs of EtwpSetCompressionSettings @ 0x1405A7C14
 * Callers:
...
LABEL_22:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v6, &v22);
    v12 = CurrentThread->SpecialApcDisable++ == -1;
    if ( v12 )
    {
      v20 = &CurrentThread->152;
      if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v20->ApcState.ApcListHead[0].Flink != v20 )
        KiCheckForKernelApcDelivery((__int64)v20, v17, v18, v19);
    }
