/*
 * XREFs of SbpStartLanman @ 0x140A935E8
 * Callers:
...
__int64 SbpStartLanman()
{
  ...
  *(_QWORD *)(PoolWithTag + 132) = 1LL;
  ...
  v7 = IopBuildDeviceIoControlRequest(-2146172527, v6, v22, 0x24u, PoolWithTag, 0x8Cu, 0, &Object, &v21);
  v8 = v7;
  if ( !v7 )
    goto LABEL_3;
  ...
  if ( Status >= 0 )
  {
    ...
    if ( v11 )
    {
      ...
      *(_WORD *)(v0 + 112) = aDeviceVmsmb[12];
      ...
      Object.Header.Size = 6;
      Object.Header.SignalState = 0;
      v13 = IopBuildDeviceIoControlRequest(1311648, v12, (const void *)v0, 0x76u, 0LL, 0, 0, &Object, &v21);
      v14 = v13;
      if ( v13 )
      {
