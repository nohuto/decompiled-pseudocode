/*
 * XREFs of PspInitializeProtectedProcessParameters @ 0x1407AF278
 * Callers:
...
__int64 __fastcall PspInitializeProtectedProcessParameters(__int64 a1)
{
  ...
  *(_OWORD *)(a1 + 1000) = *(_OWORD *)(a1 + 1056);
  v2 = *(_OWORD *)(a1 + 1056);
  v3 = 2 * (*(_WORD *)(a1 + 1056) + 42);
  *(_WORD *)(a1 + 1016) = v3;
  v3 += 2;
  *(_WORD *)(a1 + 1018) = v3;
  ...
  *(_QWORD *)PoolWithTag = *(_QWORD *)L"Path=";
  ...
  memmove(PoolWithTag + 5, *(const void **)(a1 + 1064), *(unsigned __int16 *)(a1 + 1056));
  v6 = *(unsigned __int16 *)(a1 + 1056);
  ...
  *(_WORD *)&v5[v6 + 70] = aSystemroot_9[10];
  v7 = &v5[v6];
  memmove(v7 + 72, *(const void **)(a1 + 1064), *(unsigned __int16 *)(a1 + 1056));
  *(_DWORD *)&v7[*(unsigned __int16 *)(a1 + 1056) + 72] = 0;
  return 0LL;
}
