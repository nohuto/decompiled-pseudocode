/*
 * XREFs of MiChangePageAttributeLargeFreeZeroPage @ 0x1403EEA3C
 * Callers:
...
__int64 __fastcall MiChangePageAttributeLargeFreeZeroPage(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  v8 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL));
  v24 = v8;
  v9 = 0;
...
LABEL_4:
  ...
  *(_QWORD *)(a1 + 16) = v24;
  ...
  v21 = 5;
  v22 = v7;
  MiInsertLargePageInNodeList((__int64)&v19, v16, v18, v17);
  return 1LL;
}
