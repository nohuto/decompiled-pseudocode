/*
 * XREFs of MiZeroLargePageThread @ 0x1403B1C70
 * Callers:
 *     <none>
 * Callees:
  ...
  while ( 1 )
  {
    ...
    if ( *((_BYTE *)P + 80) )
    {
      ...
      if ( v11 )
      {
        KeAcquireInStackQueuedSpinLock(
          (PKSPIN_LOCK)(qword_140C50C90 + 4544LL * *(unsigned int *)(v11 + 184) + 4304),
          &LockHandle);
    ...
    *((_QWORD *)&v49 + 1) = v1 + 24;
    ...
    else
    {
      ...
      if ( v15 )
        KxWaitForLockOwnerShip((__int64)&v49, v15);
    }
    if ( v5 && !*(_BYTE *)(v1 + 132) )
    {
      *(_BYTE *)(v1 + 132) = 1;
...
LABEL_19:
    ...
    if ( v17 )
    {
      ...
      if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
        ...
        ExpAcquireSpinLockExclusive(v25, v24, v9, SchedulerAssist);
      ...
      if ( (ULONG_PTR *)v21 != &MiSystemPartition )
      {
        ...
        __writecr8(v24);
        v42 = ExAcquireSpinLockExclusive(&dword_140C50D48);
        v9 = v53;
        v24 = v42;
      }
      if ( !--qword_140C50CA8 )
      {
        v23 = (_QWORD *)qword_140C50CD8;
        qword_140C50CD8 = 0LL;
      }
      if ( (BYTE6(PerfGlobalGroupMask) & 1) != 0 )
      {
