/*
 * XREFs of MiAllocateVirtualMemoryPrepare @ 0x14064E030
 * Callers:
        ...
        PVOID *a13)
{
  ...
  *(_QWORD *)(a12 + 96) = p_Lock;
  if ( a1 != -1LL )
  {
    ...
    v23 = ObpReferenceObjectByHandleWithTag(a1, 8LL, PsProcessType, a8, Tag, &Object, 0LL, 0LL);
    if ( v23 < 0 )
      goto LABEL_88;
    p_Lock = Object;
    v51 = Object;
...
LABEL_14:
          ...
          if ( v55 )
          {
            v23 = MiValidateZeroBits((ULONGLONG *)&v55);
            if ( v23 < 0 )
              goto LABEL_88;
            v29 = v51;
            if ( (v17 & 0x2000) != 0 && !v13 )
              *(_QWORD *)(v24 + 8) = MiGetUserReservationHighestAddress((__int64)v51, v55);
            v27 = v17 & 0x20400000;
            v28 = a12;
          }
          else
