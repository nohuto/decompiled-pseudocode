/*
 * XREFs of MiPurgeBadFileOnlyPages @ 0x14053BDD0
 * Callers:
...
__int64 MiPurgeBadFileOnlyPages()
{
  ...
  do
  {
    while ( 1 )
    {
      ...
      LockHandle.LockQueue.Lock = qword_140C51CA0;
      LockHandle.LockQueue.Next = 0LL;
      KxAcquireQueuedSpinLock((__int64)&LockHandle, (volatile __int64 *)qword_140C51CA0);
      v2 = qword_140C4CA10;
      byte_140C4CA72 = 0;
      if ( qword_140C4CA10 == 0xFFFFFFFFFLL )
      {
      ...
      v3 = 48 * qword_140C4CA10 - 0x58000000000LL;
