/*
 * XREFs of MmAccessFault @ 0x14020C560
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( FileExtents == -1073741802 )
    {
      ...
      if ( v40[0] < 0xFFFF800000000000uLL
        && *((_QWORD *)&P + 1) != qword_140C4DD78
        && (!qword_140C4DD80 || *((_QWORD *)&P + 1) != qword_140C4DD80) )
      {
        Address = P;
        if ( !(_QWORD)P )
        {
...
LABEL_19:
    ...
    if ( (_QWORD)v50 )
    {
      ...
      MiReplenishSlabAllocator(
        v50,
        *(_QWORD *)(qword_140C4E588 + 8LL * (*(_WORD *)(*(_QWORD *)BugCheckParameter2a + 60LL) & 0x3FF)),
        *((_QWORD *)&v50 + 1),
        v31);
      *(_QWORD *)&v50 = 0LL;
    }
    else if ( (v41 & 1) != 0 && *(_BYTE *)(v41 & 0xFFFFFFFFFFFFFFFEuLL) == 5 )
    {
      ...
      if ( v34 )
        MiReplenishSlabAllocator(v34, *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(v46 + 174)), 1LL, 0LL);
    }
    v15 = v46;
    ...
    v24 = *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(v15 + 174));
...
LABEL_41:
    ...
    else
    {
      ...
      v20 = *(_QWORD *)(qword_140C4E588 + 8 * v19);
      if ( SBYTE8(v47) < 0
        || !(unsigned int)MiSufficientAvailablePages(*(_QWORD *)(qword_140C4E588 + 8 * v19), 1056LL)
