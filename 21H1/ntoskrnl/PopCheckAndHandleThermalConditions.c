/*
 * XREFs of PopCheckAndHandleThermalConditions @ 0x1403C1368
 * Callers:
 ...
 *     PopSqmThermalCriticalShutdown @ 0x1408F56A0 (PopSqmThermalCriticalShutdown.c)
 *     PopSqmThermalHibernate @ 0x1408F56C4 (PopSqmThermalHibernate.c)
...
LABEL_4:
  ...
  if ( *(_BYTE *)(a1 + 72) != *(_BYTE *)(a1 + 211) )
  {
    ...
    *(_BYTE *)(a1 + 72) = v17;
    if ( v17 )
    {
      if ( ++dword_140C22DF4 == 1 )
      {
        byte_140C22DFC = 1;
        ++dword_140C22DF8;
        PopTraceCr3Tripped();
      }
      PopTraceZoneCr3Tripped((unsigned int)dword_140C22DF8, a1);
    }
    else
    {
      PopTraceZoneCr3Mitigated((unsigned int)dword_140C22DF8, a1);
      --dword_140C22DF4;
    }
    if ( dword_140C22DF4 )
    {
    ...
    else
    {
      ...
      PopTraceCr3Mitigated((unsigned int)dword_140C22DF8);
      if ( HIBYTE(word_140C22DF0) )
      {
...
LABEL_39:
    ...
    if ( !v5 && v21 && (_BYTE)word_140C22DF0 && !HIBYTE(word_140C22DF0) )
    {
      LOBYTE(v19) = 1;
