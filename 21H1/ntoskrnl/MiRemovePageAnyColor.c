/*
 * XREFs of MiRemovePageAnyColor @ 0x1402E9CFC
 * Callers:
...
__int64 __fastcall MiRemovePageAnyColor(__int64 a1, unsigned int a2, int a3)
{
  ...
  v5 = a2;
  v6 = (a3 & 2) == 0;
  v7 = *(_QWORD *)(a1 + 16) + 4544 * ((unsigned __int64)a2 >> byte_140C4DDCC);
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v8 = (_QWORD *)(v7 + 8 * (v6 + 2LL * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & (v5 >> byte_140C4DDCD)) + 527));
  else
