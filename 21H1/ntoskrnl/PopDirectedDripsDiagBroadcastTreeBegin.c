/*
 * XREFs of PopDirectedDripsDiagBroadcastTreeBegin @ 0x1408F2458
 * Callers:
...
char __fastcall PopDirectedDripsDiagBroadcastTreeBegin(__int64 a1, char a2, __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( DeviceDiagnostic || (DeviceDiagnostic = PopDirectedDripsDiagCreateDeviceDiagnostic(a1)) != 0 )
  {
    ...
    if ( v7 == -1 )
    {
      *(_DWORD *)(DeviceDiagnostic + 148) = dword_140C1EBA4++;
      v7 = *(_DWORD *)(DeviceDiagnostic + 148);
    }
...
LABEL_9:
      ...
      *(_QWORD *)(v9 + 16) = DeviceDiagnostic;
      v11 = (__int64 *)qword_140C1E9A8;
      if ( *(PVOID **)qword_140C1E9A8 != &PopDirectedDripsDiagSessionContext )
        __fastfail(3u);
