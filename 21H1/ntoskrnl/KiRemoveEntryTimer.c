/*
 * XREFs of KiRemoveEntryTimer @ 0x1402EDC60
 * Callers:
...
unsigned __int64 __fastcall KiRemoveEntryTimer(__int64 a1, __int64 a2, unsigned int a3, volatile signed __int64 **a4)
{
  ...
  v7 = *(_QWORD *)(a2 + 32);
  v8 = a2 + 32;
  v9 = 32 * (((unsigned __int64)(unsigned int)v6 << 8) + v4 + 16);
  result = *(_QWORD *)(v8 + 8);
  v11 = 32 * ((((unsigned int)v6 ^ 1LL) << 8) + v4 + 16);
...
LABEL_38:
      ...
      while ( _interlockedbittestandset64(v12, 0LL) )
      {
        ...
        do
        {
          KeYieldProcessorEx(&v48, v8, v6, (__int64)a4);
          result = *(_QWORD *)v12;
        }
        while ( *(_QWORD *)v12 );
...
LABEL_58:
          ...
          while ( _interlockedbittestandset64(v12, 0LL) )
          {
            ...
            do
              KeYieldProcessorEx(&v46, v23, v6, (__int64)a4);
            while ( *(_QWORD *)v12 );
...
LABEL_67:
          ...
          while ( _interlockedbittestandset64(v27, 0LL) )
          {
            ...
            do
              KeYieldProcessorEx(&v47, v23, v6, (__int64)a4);
            while ( *(_QWORD *)v27 );
...
LABEL_9:
        if ( *(_DWORD *)(v9 + a1 + 28) == -1 && *(_DWORD *)(v11 + a1 + 28) == -1 )
        {
          ...
          _interlockedbittestandreset64(
            (volatile signed __int32 *)(qword_140CFD748[2 * *(unsigned __int8 *)(a1 - 14448)] + v15),
            result);
        }
