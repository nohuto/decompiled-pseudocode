/*
 * XREFs of PnpTraceSecureDeviceEnumeration @ 0x1408ADD30
 * Callers:
...
void PnpTraceSecureDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140C02D80 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02D80, 0x400000000000LL) )
    {
      ...
      v4 = v1;
      v13 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02D80, (unsigned __int8 *)byte_140024289, 0LL, 0LL, 6u, &v5);
    }
  }
}
