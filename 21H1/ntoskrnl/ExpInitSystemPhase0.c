/*
 * XREFs of ExpInitSystemPhase0 @ 0x140A64F2C
 * Callers:
...
char ExpInitSystemPhase0()
{
  ...
  qword_140C168E8 = (__int64)&ExpSystemResourcesList;
  ...
  qword_140C168A8 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_140C16888 = (__int64)&ExPagedLookasideListHead;
