/*
 * XREFs of MmRelocatePfnList @ 0x1408CD18C
 * Callers:
...
__int64 __fastcall MmRelocatePfnList(unsigned __int64 a1, _QWORD *a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( a4 >= MmNumberOfChannels )
    return 3221225713LL;
  v7 = (a3 << byte_140C4DDCC) | (a4 << byte_140C4DDCD);
  MiCreatePteCopyList(a1, 0x100uLL, (__int64)&v18);
  ...
  while ( a2 < v9 )
  {
    ...
    *((_QWORD *)&v16 + 1) = v10;
    if ( (unsigned int)MiIsPfn(v10) )
    {
      ...
      {
        if ( !MiPfnsWorthTrying((unsigned __int16 *)&MiSystemPartition, 48 * v10 - 0x58000000000LL, 1LL, 0, &v20) )
        {
          if ( v20 == 1 )
