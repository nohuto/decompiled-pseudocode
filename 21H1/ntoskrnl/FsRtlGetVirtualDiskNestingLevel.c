/*
 * XREFs of FsRtlGetVirtualDiskNestingLevel @ 0x14031C300
 * Callers:
 *     <none>
 * Callees:
 ...
 *     FsRtlQueryMaximumVirtualDiskNestingLevel @ 0x140397690 (FsRtlQueryMaximumVirtualDiskNestingLevel.c)
        ...
        PULONG NestingFlags)
{
  ...
  v19 = 0;
  v18 = 0LL;
  v11 = IopBuildDeviceIoControlRequest(2953616, (int)DeviceObject, &v16, 8u, &v18, 0x14u, 0, &Object, &v17);
  if ( v11 )
  {
