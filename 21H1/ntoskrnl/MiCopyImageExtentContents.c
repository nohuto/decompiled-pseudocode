/*
 * XREFs of MiCopyImageExtentContents @ 0x14053A614
 * Callers:
        ...
        __int64 a7)
{
  ...
  *(_DWORD *)(a1 + 184) = 4096;
  ...
  LOBYTE(v22) = 2;
  *(_QWORD *)(a1 + 160) = v21;
  MiUnlockProtoPoolPage(v21, v22, v23, v24);
  MiFillPageWithImageExtentContents(*(_QWORD *)(*(_QWORD *)(v26 + 96) + 48LL) & 0xFFFFFFFFFFFFFFF0uLL, 1);
