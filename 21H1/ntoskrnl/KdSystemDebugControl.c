/*
 * XREFs of KdSystemDebugControl @ 0x1408B5740
 * Callers:
 *     <none>
 * Callees:
 *     ExUnlockUserBuffer @ 0x1402F85E0 (ExUnlockUserBuffer.c)
 *     KdpSysReadIoSpace @ 0x14050C254 (KdpSysReadIoSpace.c)
 *     KdpSysReadMsr @ 0x14050C314 (KdpSysReadMsr.c)
 *     KdpSysWriteIoSpace @ 0x14050C348 (KdpSysWriteIoSpace.c)
 *     KdpSysWriteMsr @ 0x14050C400 (KdpSysWriteMsr.c)
 *     ExLockUserBuffer @ 0x1406BD108 (ExLockUserBuffer.c)
 *     KdpSysCheckLowMemory @ 0x1409B5E48 (KdpSysCheckLowMemory.c)
 *     KdpSysGetVersion @ 0x1409B5E6C (KdpSysGetVersion.c)
