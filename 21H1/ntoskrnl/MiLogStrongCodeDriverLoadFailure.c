/*
 * XREFs of MiLogStrongCodeDriverLoadFailure @ 0x1408C367C
 * Callers:
...
void __fastcall MiLogStrongCodeDriverLoadFailure(const CHAR *Src, __int64 a2)
{
  ...
  if ( *(_QWORD *)&qword_140C4EE20 )
  {
    ...
    {
      if ( tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 0x400000000000LL) )
      {
        ...
        v30 = 8;
        v19 = 2;
        tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&word_140024AF6, v4, 1u, v11, v12, 8u, &v16);
      }
    }
  }
  else
  {
    ...
    if ( Pool )
    {
      ...
      *(_DWORD *)(v8 + 44) = *(_DWORD *)(a2 + 156);
      v10 = (__int64 *)qword_140C4CC50;
      if ( *(PVOID **)qword_140C4CC50 != &qword_140C4CC48 )
        __fastfail(3u);
      *(_QWORD *)v8 = &qword_140C4CC48;
      *(_QWORD *)(v8 + 8) = v10;
      *v10 = v8;
      qword_140C4CC50 = v8;
    }
