/*
 * XREFs of BgpRasGetGlyphAdvanceWidth @ 0x1405BFEBC
 * Callers:
 *     BgpFoGetAdvanceWidth @ 0x1405BE9E0 (BgpFoGetAdvanceWidth.c)
 *     BgpFoGetStringAdvanceWidth @ 0x1405BEA00 (BgpFoGetStringAdvanceWidth.c)
