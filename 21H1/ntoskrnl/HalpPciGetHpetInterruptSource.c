/*
 * XREFs of HalpPciGetHpetInterruptSource @ 0x140A8C020
 * Callers:
 *     HalpTimerRegister @ 0x1403A85A0 (HalpTimerRegister.c)
 * Callees:
 *     HalSocGetAcpiTable @ 0x1403A8AE4 (HalSocGetAcpiTable.c)
 *     HalpPciGetHpetInterruptSourceAmd @ 0x140A8C0EC (HalpPciGetHpetInterruptSourceAmd.c)
 *     HalpPciGetHpetInterruptSourceIntel @ 0x140A8C1D4 (HalpPciGetHpetInterruptSourceIntel.c)
 */
