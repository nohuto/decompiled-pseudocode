/*
 * XREFs of ExAcquireSharedWaitForExclusive @ 0x1405AF0F0
 * Callers:
...
BOOLEAN __stdcall ExAcquireSharedWaitForExclusive(PERESOURCE Resource, BOOLEAN Wait)
{
  ...
  int v6; // r13d
  ERESOURCE_THREAD *v7; // r8
  __int16 v8; // ax
  unsigned int ThreadResourceHint; // eax
  ERESOURCE_THREAD *v10; // rax
  int v11; // ecx
  int v12; // eax
  __int64 v13; // r8
  ...
  {
    v8 = Resource->Flag & 0x80;
    if ( v8 && Resource->OwnerEntry.OwnerThread == CurrentThread )
    {
    ...
    if ( v8 || Resource->NumberOfExclusiveWaiters )
    {
      if ( !Wait )
      {
        KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
      ...
      EmptyEntry = ExpFindEmptyEntry((__int64)Resource, (__int64)&LockHandle, v7);
      v16 = EmptyEntry;
      if ( EmptyEntry )
      {
...
LABEL_40:
        ...
        if ( !v16 )
        {
          KeAcquireInStackQueuedSpinLock(&Resource->SpinLock, &LockHandle);
          do
            v40 = ExpFindCurrentThread((__int64)Resource, CurrentThread, (__int64)&LockHandle, 1, 1, 0);
          while ( !v40 );
          v41 = v40[1] & 7;
          *v40 = CurrentThread;
          *((_DWORD *)v40 + 2) = v41 | 8;
        ...
        if ( (CurrentThread & 3) == 0 )
          v47 = *(unsigned __int8 *)(CurrentThread + 649);
...
LABEL_25:
    ...
    else
    {
      ...
      v10 = ExpFindCurrentThread((__int64)Resource, CurrentThread, (__int64)&LockHandle, 1, 1, ThreadResourceHint);
      v7 = v10;
      if ( v10 )
      {
        v11 = *((_DWORD *)v10 + 2);
