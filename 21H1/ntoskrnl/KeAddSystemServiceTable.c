/*
 * XREFs of KeAddSystemServiceTable @ 0x14079FAD0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_12:
      ...
      *((_QWORD *)&KeServiceDescriptorTableFilter[v13 + 1] + 1) = a4;
      if ( a5 == 2 )
      {
        v14 = (unsigned int)&xmmword_140CFCBE0 + xmmword_140CFCBE0 + KiTableInformation;
        if ( (_DWORD)xmmword_140CFCBF0 )
        {
          v15 = (int *)xmmword_140CFCBE0;
          do
          {
            v16 = *v15;
            v17 = *v15++;
            v14 = ++v7 * ((v16 + *(_DWORD *)((v17 >> 4) + xmmword_140CFCBE0)) ^ v14);
          }
          while ( v7 < (unsigned int)xmmword_140CFCBF0 );
        }
