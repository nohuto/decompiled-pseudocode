 ...
 *     FsRtlCheckNoSharedConflict @ 0x1403698B0 (FsRtlCheckNoSharedConflict.c)
 *     RtlEnumerateGenericTable @ 0x14037F370 (RtlEnumerateGenericTable.c)
 *     RtlLookupElementGenericTableFull @ 0x1405861F0 (RtlLookupElementGenericTableFull.c)
 *     RtlInsertUnicodePrefix @ 0x1406C2F10 (RtlInsertUnicodePrefix.c)
 *     RtlFindUnicodePrefix @ 0x1406C3070 (RtlFindUnicodePrefix.c)
 *     PfxFindPrefix @ 0x14090D650 (PfxFindPrefix.c)
 *     PfxInsertPrefix @ 0x14090D750 (PfxInsertPrefix.c)
 * Callees:
 *     <none>
 */
