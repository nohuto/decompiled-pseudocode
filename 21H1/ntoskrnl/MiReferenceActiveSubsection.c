/*
 * XREFs of MiReferenceActiveSubsection @ 0x1402A23D0
 * Callers:
    ...
    if ( v12 >= 2 )
    {
      if ( v12 == 2 && (a2 & 0x20) != 0 && v43 )
      {
        ...
        MiReturnCrossPartitionSectionCharges(
          *(_QWORD *)(qword_140C4E588 + 8LL * (*(_WORD *)(v40 + 60) & 0x3FF)),
          v9,
          v43);
        if ( !v5 )
...
LABEL_19:
    if ( (a2 & 0x20) != 0 )
    {
      ...
      __writecr8(v6);
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C4E588 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)), v9, v4);
      if ( !v5 )
