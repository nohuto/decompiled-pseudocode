/*
 * XREFs of MiBuildForkPte @ 0x1405527CC
 * Callers:
 ...
 *     MiFindZeroCloneBlock @ 0x140554B74 (MiFindZeroCloneBlock.c)
 ...
 *     MiIncrementCombinedPte @ 0x140557554 (MiIncrementCombinedPte.c)
 */
  ...
  for ( i = a12; ; v29 = i )
  {
    ...
    if ( (v19 & 1) != 0 )
    {
        ...
        || (unsigned int)MI_IS_SOFTWARE_PTE_SHADOW_STACK((_QWORD *)(v34 + 16)) )
      {
        ...
        v46 = *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(v27 + 174));
        v120 = v46;
...
LABEL_32:
      ...
      if ( !MI_PFN_IS_PROTO(v34) )
      {
        ...
        v42 = ZeroPte;
        v120 = v40;
        v43 = *(_QWORD *)(qword_140C4E588 + 8 * ((v41 >> 39) & 0x3FF));
        v121 = v43;
        if ( *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(v122 + 174)) != v43 )
        {
          if ( (i & 1) != 0 )
          {
        ...
        if ( (WsleContents & 0xF) != 8 || (unsigned int)MiLockPageTablePage(v40, 3uLL, v40) )
        {
          v127 = 0;
          v59 = v120;
          ...
          *(_QWORD *)(v59 + 24) ^= (*(_QWORD *)(v59 + 24) ^ (*(_QWORD *)(v59 + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
          ...
          {
            v65 = *(_QWORD *)(v34 + 16);
            if ( qword_140C4DE80 && (v64 & 0x10) == 0 )
              v65 = ~qword_140C4DE80 & v64;
...
LABEL_181:
  ...
  v116 = 0;
  v119 = 0;
  v93 = *(_QWORD *)(qword_140C4E588 + 8 * v91);
  if ( *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(v122 + 174)) == v93 )
  {
LABEL_132:
...
LABEL_141:
    ...
    *(_QWORD *)(v30 + 24) = 2LL;
    ...
    if ( MiPteInShadowRange(a3) )
    {
      ...
      {
        v98 = 1;
        if ( !HIBYTE(word_140C4DF48) && (v96 & 1) != 0 )
