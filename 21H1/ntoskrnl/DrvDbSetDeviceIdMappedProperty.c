/*
 * XREFs of DrvDbSetDeviceIdMappedProperty @ 0x140712464
 * Callers:
...
LABEL_38:
      if ( a3 )
        v8 = a3;
      v23 = DrvDbSetRegValueMappedProperty(v17, v8, v18, v19, a6, a7);
      goto LABEL_21;
    }
    if ( v19 == 8210 )
    {
