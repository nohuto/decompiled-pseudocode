/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x1408BE314
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x1408BE0D0 (AlpcpAllocateSnapshotMessageLog.c)
