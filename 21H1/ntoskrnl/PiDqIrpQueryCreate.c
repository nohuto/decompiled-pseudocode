/*
 * XREFs of PiDqIrpQueryCreate @ 0x1406A0E7C
 * Callers:
 ...
 *     IoClearActivityIdThread @ 0x1402E5400 (IoClearActivityIdThread.c)
 ...
 *     PiDqQueryGetNextIoctlInfo @ 0x1406A0460 (PiDqQueryGetNextIoctlInfo.c)
 *     PiDqQueryValidateQueryData @ 0x1406A0CB0 (PiDqQueryValidateQueryData.c)
 ...
 *     PnpConvertDevpropcompkeyArrayToString @ 0x14089D880 (PnpConvertDevpropcompkeyArrayToString.c)
 *     PiDqConvertObjectTypeToString @ 0x1408A0220 (PiDqConvertObjectTypeToString.c)
 *     PiDqConvertQueryFlagsToString @ 0x1408A02E8 (PiDqConvertQueryFlagsToString.c)
 *     FilterConvertToString @ 0x14097B380 (FilterConvertToString.c)
  ...
  else
  {
    if ( CurrentStackLocation->Parameters.Read.Length >= 0x10 )
    {
      ...
      if ( ValidateQueryData < 0 )
        goto LABEL_14;
      v10 = (void **)(v3 + 24);
      NdrMesTypeDecode3(*(_QWORD *)(v3 + 16), "TP 3\a", &off_140001790, &off_140C01A50, 0, v3 + 24);
