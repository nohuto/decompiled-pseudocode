/*
 * XREFs of TtmiLogDeviceAssignedTerminalEvent @ 0x1408FD600
 * Callers:
...
void __fastcall TtmiLogDeviceAssignedTerminalEvent(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL) )
    {
      ...
      v6 = a1;
      v7 = a2;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2C8E8, (unsigned __int8 *)byte_140029993, 0LL, 0LL, 5u, &v8);
    }
  }
}
