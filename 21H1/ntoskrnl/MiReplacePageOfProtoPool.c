/*
 * XREFs of MiReplacePageOfProtoPool @ 0x14035032C
 * Callers:
...
LABEL_44:
    ...
    if ( (unsigned int)v18 < 0x200 )
    {
      ...
      if ( (signed __int32 *)v17 != &v63[15] && (*(_DWORD *)v17 | *((_DWORD *)qword_140011AC0 + (v18 & 0x1F))) == -1 )
      {
        v19 = v18 - (v18 & 0x1F) + 32;
      ...
      if ( (signed __int32 *)v17 == &v63[15] )
        goto LABEL_27;
      v11 = v19 & 0x1F;
      if ( (*(_DWORD *)v17 & ~*((_DWORD *)qword_140011AC0 + v11)) != 0 )
        goto LABEL_27;
...
LABEL_33:
  ...
  if ( v6 )
  {
    MiLockNestedPageAtDpcInline(48 * v59 - 0x58000000000LL, v17, j, v11);
  }
  else
  {
    v52 = 0;
  ...
  {
    MiLockNestedPageAtDpcInline(v28, v17, j, v11);
