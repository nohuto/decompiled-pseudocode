/*
 * XREFs of PopCalculateCsSummary @ 0x14056A410
 * Callers:
 ...
 *     PopCalculateTotalHwDripsResidency @ 0x14056AA94 (PopCalculateTotalHwDripsResidency.c)
 *     PopBatteryCapacityToRate @ 0x14056E328 (PopBatteryCapacityToRate.c)
 *     PopBatteryGetEnergyDrainFromDischage @ 0x14056E34C (PopBatteryGetEnergyDrainFromDischage.c)
...
__int64 __fastcall PopCalculateCsSummary(__int64 a1, int a2)
{
  ...
  v5 = (InterruptTimePrecise.QuadPart - qword_140C4FE48) / 0xAuLL;
  PopGetModernStandbyTransitionReason(0LL, &v37);
  if ( v37 <= qword_140C4FE48 )
    v6 = 0LL;
  else
  ...
  v52 = HIDWORD(xmmword_140C23714);
  if ( HIDWORD(xmmword_140C23714) )
    LODWORD(v8) = (unsigned int)(100 * xmmword_140C23724) / HIDWORD(xmmword_140C23714);
  else
    LOBYTE(v8) = 0;
  v9 = 0;
  if ( (xmmword_140C23714 & 0x40000000) == 0 )
    v9 = xmmword_140C23724;
  v51 = v8;
  v40 = *((_QWORD *)&v45 + 1) - qword_140C4FE50;
  v31 = v9;
  v32 = DWORD2(v46) - dword_140C4FE60;
  v10 = PopCalculateTotalHwDripsResidency(qword_140C4FED8, v46, v5);
  v11 = v5 + qword_140C4FE58 - v45;
  v44 = v10;
  v12 = _InterlockedExchangeAdd64(&qword_140C4FF80, 0LL);
  if ( v12 )
    v12 = (v12 - qword_140C4FE48) / 0xA;
  v36 = qword_140C4FE90;
  v36 -= PpmConvertTime(qword_140C4FE80, PopQpcFrequency, 0xF4240uLL);
  v13 = qword_140C4FEA0;
  v43 = v5 - qword_140C4FE90;
  if ( qword_140C4FE98 )
  {
    if ( qword_140C4FE48 <= (unsigned __int64)qword_140C4FE98 )
      v14 = InterruptTimePrecise.QuadPart - qword_140C4FE98;
    else
      v14 = InterruptTimePrecise.QuadPart - qword_140C4FE48;
    v13 = v14 + qword_140C4FEA0;
  }
  v15 = v13 / 0xA;
  v41 = PpmConvertTime(qword_140C4FEB0, PopQpcFrequency, 0xF4240uLL);
  v42 = PpmConvertTime(qword_140C4FEC0, PopQpcFrequency, 0xF4240uLL);
  v34 = 0LL;
  v35 = 0LL;
  ModernStandbyTransitionReason = PopGetModernStandbyTransitionReason(0LL, 0LL);
  PpmGetPlatformSelectionVetoCounts(dword_140C4FFC0, &v34, &v35);
  v34 -= qword_140C4FEE0;
  v35 -= qword_140C4FEE8;
  if ( qword_140C4FE68 )
  {
    v16 = 100 * qword_140C4FE70 % (unsigned __int64)qword_140C4FE68;
    v38 = 100 * qword_140C4FE70 / (unsigned __int64)qword_140C4FE68;
  }
  v50 = 0;
  PopQueryInputSuppressionCount(&v50, v16);
  v18 = v50 - dword_140C4FF38;
  v19 = v52;
  v20 = v47;
  *(_DWORD *)a1 = v49;
  *(_QWORD *)(a1 + 40) = v40;
  ...
  *(_QWORD *)(a1 + 152) = v6;
  v50 = v18;
  *(_BYTE *)(a1 + 125) ^= (byte_140C4FF01 ^ v22) & 1;
  LOBYTE(v19) = *(_BYTE *)(a1 + 125) ^ (byte_140C4FF01 ^ *(_BYTE *)(a1 + 125)) & 2;
  *(_BYTE *)(a1 + 125) = v19;
  *(_BYTE *)(a1 + 125) = v19 ^ (byte_140C4FF01 ^ v19) & 4;
  *(_DWORD *)(a1 + 164) = dword_140C4FEF0;
  *(_DWORD *)(a1 + 168) = dword_140C4FEF4;
  *(_BYTE *)(a1 + 172) = byte_140C4FEF8;
  *(_DWORD *)(a1 + 176) = dword_140C4FEFC;
  *(_DWORD *)(a1 + 180) = dword_140C4FF04;
  *(_DWORD *)(a1 + 184) = dword_140C4FF08;
  *(_BYTE *)(a1 + 188) = byte_140C4FF0C;
  *(_DWORD *)(a1 + 192) = HIDWORD(v48[0]);
  *(_DWORD *)(a1 + 196) = DWORD2(v48[0]);
  *(_BYTE *)(a1 + 204) = byte_140C4FF14;
  *(_BYTE *)(a1 + 205) = byte_140C4FF15;
  *(_DWORD *)(a1 + 208) = dword_140C4FF18;
  *(_DWORD *)(a1 + 212) = dword_140C4FF1C;
  *(_DWORD *)(a1 + 216) = v18;
  *(_QWORD *)(a1 + 224) = qword_140C4FEC8;
  *(_QWORD *)(a1 + 232) = qword_140C4FED0;
  *(_DWORD *)(a1 + 264) = dword_140C4FF3C;
  *(_DWORD *)(a1 + 268) = dword_140C4FF40;
  v25 = KeAcquireSpinLockRaiseToDpc(&qword_140C22FB8);
  *(_QWORD *)(a1 + 248) = qword_140C22FA8;
  *(_QWORD *)(a1 + 240) = qword_140C22FB0;
