        ...
        unsigned __int64 a7)
{
  ...
  signed __int64 **v88; // [rsp+D8h] [rbp-950h]
  _DWORD *v89; // [rsp+E0h] [rbp-948h]
...
LABEL_27:
    ...
    v30 = (a3 >> 12) - (*((unsigned int *)v26 + 6) | ((unsigned __int64)*((unsigned __int8 *)v26 + 32) << 32));
    v31 = v76;
    v32 = v30 / v76;
    v33 = (__int64)v74;
...
LABEL_58:
  ...
  if ( !v56 )
  {
    ...
    if ( v87 )
    {
      memmove(v87, Src, 8LL * (_QWORD)v20);
      *v88 = v20;
    }
    *v89 = v19 << 12;
    goto LABEL_68;
