/*
 * XREFs of sub_14065CF98 @ 0x14065CF98
 * Callers:
...
__int64 __fastcall sub_14065CF98(PVOID BaseAddress, unsigned int a2, int a3)
{
  __int64 v3; // rsi
  __int64 v6; // rdx
  NTSTATUS v7; // r8d
  ...
  if ( v7 >= 0 )
  {
    ...
    LOBYTE(v8) = v8 & 0xF;
    if ( qword_140C1DAA0 && (LOBYTE(v6) = 12, (unsigned int)qword_140C1DAA0(v8, v6)) )
    {
      v7 = 0;
      if ( a3 )
      {
