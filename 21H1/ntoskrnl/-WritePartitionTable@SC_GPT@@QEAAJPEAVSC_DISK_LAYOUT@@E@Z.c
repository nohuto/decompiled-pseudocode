/*
 * XREFs of ?WritePartitionTable@SC_GPT@@QEAAJPEAVSC_DISK_LAYOUT@@E@Z @ 0x1405C2938
 * Callers:
 ...
 *     ?ComputeChs@MBR_ENTRY@@QEAAXPEAU_DISK_GEOMETRY@@@Z @ 0x1405C1820 (-ComputeChs@MBR_ENTRY@@QEAAXPEAU_DISK_GEOMETRY@@@Z.c)
...
LABEL_52:
    ...
    *(_OWORD *)(v22 + 56) = v41;
    *((_DWORD *)v22 + 21) = v50;
    *((_DWORD *)v22 + 22) = RtlComputeCrc32(0, v54, v9 << *((_DWORD *)*this + 58));
...
LABEL_68:
    ...
    if ( Header >= 0 )
    {
      ...
      *((_DWORD *)v25 + 4) = RtlComputeCrc32(0, v25, v47);
      Header = SC_DISK::WriteSectors(*this, v43, v48, v54);
      if ( Header >= 0 )
      {
LABEL_66:
        *((_DWORD *)*this + 48) &= ~2u;
