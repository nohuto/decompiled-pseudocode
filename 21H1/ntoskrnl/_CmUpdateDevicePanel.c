/*
 * XREFs of _CmUpdateDevicePanel @ 0x14072CD38
 * Callers:
 ...
 *     _CmGetDevicePanelGroup @ 0x1407BE24C (_CmGetDevicePanelGroup.c)
...
LABEL_16:
                  ...
                  while ( 2 )
                  {
                    ...
                    if ( v34 < 7 )
                      v33 = (unsigned int)dword_14001FAB0[v34];
                    v60 = v33;
                    if ( !v5 )
                    {
...
LABEL_172:
                    ...
                    if ( v68 || (v68 = ExAllocatePoolWithTag(PagedPool, 0x72uLL, 0x52504E50u), (v42 = v68) != 0LL) )
                    {
                      v43 = 0LL;
                      if ( ((*v15 >> 20) & 7) != 7 )
                        v43 = (unsigned int)dword_14001FAB0[(*v15 >> 20) & 7];
                      v50 = v43;
                      ...
                      if ( ParentDeviceContainerId >= 0 )
                      {
                        ...
                        if ( ParentDeviceContainerId >= 0 )
                        {
                          ...
                          if ( ParentDeviceContainerId >= 0 )
                          {
                            ...
                            if ( ParentDeviceContainerId >= 0 )
                            {
                              v50 = dword_14003FF90[(unsigned __int64)(unsigned int)*v15 >> 31];
                              ParentDeviceContainerId = PnpSetObjectProperty(
                                                          v3,
                                                          (__int64)v5,
                                                          6u,
