/*
 * XREFs of PiDrvDbResolveFilePathKeyValues @ 0x1408B2D98
 * Callers:
...
LABEL_17:
    if ( (int)PnpCtxRegQueryInfoKey(v14, (int)v47, 0, 0, (__int64)v10, (__int64)&v39, (__int64)&NumberOfBytes) >= 0 )
    {
...
LABEL_25:
    ...
    LODWORD(v39) = v8;
    v17 = PnpCtxRegEnumValue(v15, v47, v16, v7, (__int64)&NumberOfBytes, (__int64)&v43, v9, (__int64)&v39);
    if ( v17 == -2147483622 )
      goto LABEL_84;
    if ( v17 == -1073741789 )
    {
