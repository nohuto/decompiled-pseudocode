/*
 * XREFs of PopPolicyWorkerAction @ 0x1407619D0
 * Callers:
...
__int64 __fastcall PopPolicyWorkerAction(int a1)
{
  ...
  qword_140C235B0 = (__int64)KeGetCurrentThread();
  if ( byte_140C23401 == 1 )
  {
    v4 = (int)qword_140C23404;
    v5 = HIDWORD(qword_140C23404);
    v6 = dword_140C2340C;
    ...
    if ( (PopAction & 2) != 0 )
    {
      if ( HIDWORD(qword_140C23404) == 5 )
        v7 = 6;
      dword_140C23414 = v7;
      dword_140C2340C = dword_140C2340C & 0x7FFFFFDC | 0x80000020;
