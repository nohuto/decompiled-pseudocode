/*
 * XREFs of KiWaitForAllObjects @ 0x1402CD0F4
 * Callers:
 ...
 *     KiUnlockKobjectArray @ 0x1402CDA5C (KiUnlockKobjectArray.c)
        ...
        __int64 a7)
{
  ...
  _DWORD *v75; // [rsp+50h] [rbp-B0h] BYREF
...
LABEL_23:
          ...
          else if ( (unsigned int)KiCheckDueTimeExpired((__int64)CurrentThread, v69, (unsigned __int64)v75) )
          {
            KiUnlockKobjectArray(&v77, v9);
            LOBYTE(v65) = v19;
