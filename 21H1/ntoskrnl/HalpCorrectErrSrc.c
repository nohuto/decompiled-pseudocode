/*
 * XREFs of HalpCorrectErrSrc @ 0x14099C6F0
 * Callers:
 *     <none>
 * Callees:
 *     HalpCorrectGenericErrSrc @ 0x1403C8874 (HalpCorrectGenericErrSrc.c)
 *     HalpCorrectNMIErrSrc @ 0x1403C8898 (HalpCorrectNMIErrSrc.c)
