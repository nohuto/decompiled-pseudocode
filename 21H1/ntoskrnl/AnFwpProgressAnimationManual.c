...
LONGLONG AnFwpProgressAnimationManual()
{
  ...
  result = qword_140CDB068;
  if ( v0.QuadPart + v2 >= qword_140CDB068 + v7.QuadPart / 33 )
  {
    v4 = word_140C10DC8;
    if ( word_140C10DC8 != -7989 && (qword_140CDB068 - v0.QuadPart - v2) / v1 >= 2 )
      v4 = ++word_140C10DC8;
