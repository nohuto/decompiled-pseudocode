/*
 * XREFs of __C_specific_handler @ 0x1403CC050
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1403F1A48 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     KeCheckStackAndTargetAddress @ 0x140303870 (KeCheckStackAndTargetAddress.c)
 *     RtlUnwindEx @ 0x14032C220 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x1403CD520 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1403CD550 (__NLG_Return2.c)
 */
