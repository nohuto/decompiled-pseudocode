        ...
        unsigned int *a5)
{
  ...
  unsigned int v101; // [rsp+68h] [rbp-8B0h]
  struct _KTHREAD *v102; // [rsp+70h] [rbp-8A8h]
  unsigned int v103; // [rsp+78h] [rbp-8A0h]
  ...
  unsigned __int64 v115; // [rsp+B8h] [rbp-860h]
  unsigned int *v116; // [rsp+C0h] [rbp-858h]
      ...
      if ( v54 )
      {
        ...
        if ( v55 )
        {
          ...
          if ( !v56 )
          {
            ...
            v18 = (void *)a3;
            memmove((void *)a3, ServerSiloGlobals[139], v89);
            v93 = 1;
            v17 = a5;
            goto LABEL_39;
          }
...
LABEL_93:
      ...
      *(_OWORD *)&v129[11] = 0LL;
      ...
      if ( (PerfGlobalGroupMask & 0x80000) != 0 )
        EtwTraceJobSetQuery((_DWORD)v14, a2, (unsigned int)v129, (unsigned int)&v114, 0, 1830);
      goto LABEL_37;
    }
LABEL_124:
    PspLockJobShared(v14, CurrentThread);
...
LABEL_78:
        ...
        LODWORD(v148[2]) = (PspGetJobLimitInformationValidFlags((unsigned int)a2, v101) | 0x7FFF) & *((_DWORD *)v14 + 64);
        if ( a2 == 9 )
        {
          ExAcquirePushLockSharedEx((ULONG_PTR)(v14 + 1032), 0LL);
