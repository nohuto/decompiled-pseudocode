/*
 * XREFs of MiObtainDynamicVa @ 0x140301274
 * Callers:
 ...
 *     MiFindNextAlignedForwardRunClearEx @ 0x1403C1C94 (MiFindNextAlignedForwardRunClearEx.c)
...
LABEL_87:
  ...
  if ( v5 == &qword_140C4E0F8 )
  {
    qword_140C4DF88 -= v9 << 21;
    MiReclaimSystemVa(0LL);
  }
  _InterlockedExchangeAdd64(&qword_140C4F888[v32], v9);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
