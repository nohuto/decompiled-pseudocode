/*
 * XREFs of ViKeAcquireSpinLockAtDpcLevelCommon @ 0x1409D8E80
 * Callers:
 *     VerifierKeAcquireSpinLockAtDpcLevel @ 0x1409D7920 (VerifierKeAcquireSpinLockAtDpcLevel.c)
 *     VerifierKeAcquireSpinLockAtDpcLevelNoReboot @ 0x1409D7970 (VerifierKeAcquireSpinLockAtDpcLevelNoReboot.c)
 * Callees:
