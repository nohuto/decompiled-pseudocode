/*
 * XREFs of TtmiLogCalloutStop @ 0x1408FCD40
 * Callers:
...
char __fastcall TtmiLogCalloutStop(int a1, int a2, __int64 a3, int a4, int a5, unsigned __int64 a6)
{
  ...
  if ( a6 > 0x1312D00 )
  {
    ...
    {
      LOBYTE(v6) = tlgKeywordOn((__int64)&dword_140D2C8B0, 0x400000000001LL);
      if ( (_BYTE)v6 )
      {
        ProcessSessionId = PsGetProcessSessionIdEx((__int64)KeGetCurrentThread()->ApcState.Process);
        v11 = (unsigned __int8 *)qword_14002A6C0;
        v42 = 4LL;
  ...
  else if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    LOBYTE(v6) = tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL);
    if ( (_BYTE)v6 )
    {
      v15 = PsGetProcessSessionIdEx((__int64)KeGetCurrentThread()->ApcState.Process);
      v11 = (unsigned __int8 *)&word_14002AC4E;
      v29 = 4LL;
      v28 = &v15;
      v12 = &dword_140D2C8E8;
      v16 = a1;
      ...
      v39[4] = 8LL;
LABEL_8:
      LOBYTE(v6) = tlgWriteTransfer_EtwWriteTransfer((__int64)v12, v11, 0LL, 0LL, 0xAu, v13);
    }
  }
  return (char)v6;
}
