/*
 * XREFs of MiMapMemoryDumpMdl @ 0x140380EF4
 * Callers:
 *     MmMapMemoryDumpMdlEx @ 0x140380A70 (MmMapMemoryDumpMdlEx.c)
 *     MmMapMemoryDumpMdlEx2 @ 0x140380EC0 (MmMapMemoryDumpMdlEx2.c)
 *     MmMapMemoryDumpMdl @ 0x140533030 (MmMapMemoryDumpMdl.c)
 * Callees:
...
char __fastcall MiMapMemoryDumpMdl(unsigned __int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  *(_QWORD *)(a3 + 24) = a1 + v14;
  ...
  do
  {
    ...
    ValidPte = MiMakeValidPte((unsigned __int64)v13, v19, ProtectionPfnCompatible | 0xA0000000, v19);
    v22 = 0;
