/*
 * XREFs of MiAllowImageMap @ 0x140636DF0
 * Callers:
 ...
 *     PsBlockNonCetBinaries @ 0x1405C71E8 (PsBlockNonCetBinaries.c)
...
LABEL_18:
  ...
  if ( v18 || v17 )
  {
    ...
    else
    {
      ...
      if ( (unsigned int)SeQueryMandatoryLabel(SecurityDescriptor) <= 0x1000 && !SeGetTrustLabelAce((__int64)v20) )
        ObjectSecurity = -1073741790;
