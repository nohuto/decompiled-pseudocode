/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockForDpcCommon @ 0x1409D8040
 * Callers:
 *     VerifierKeReleaseInStackQueuedSpinLockForDpc @ 0x1409D8000 (VerifierKeReleaseInStackQueuedSpinLockForDpc.c)
 *     VerifierKeReleaseInStackQueuedSpinLockForDpcNoReboot @ 0x1409D80B0 (VerifierKeReleaseInStackQueuedSpinLockForDpcNoReboot.c)
 * Callees:
