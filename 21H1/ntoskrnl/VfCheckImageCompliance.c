/*
 * XREFs of VfCheckImageCompliance @ 0x1409C48FC
 * Callers:
 ...
 *     _stricmp @ 0x1403CD990 (_stricmp.c)
              ...
              && (*(_DWORD *)(v5 + 36) & 0x20000000) != 0 )
            {
              *(_QWORD *)Str1 = *(_QWORD *)v5;
              ...
              ViCiPreprocessOptions(
                ...
                v6,
                Str1);
              VfReportIssueWithOptions(0xC4u, 0x2005uLL, a1 + 88, (ULONG_PTR)v6, (ULONG_PTR)Str1, byte_140C12C6C);
              if ( (MmVerifierData & 0x1000) != 0 )
          ...
          if ( !SectionAlignment || (SectionAlignment & 0xFFF) != 0 )
          {
            *(_QWORD *)Str1 = *(_QWORD *)v5;
            ...
            ViCiPreprocessOptions(
              ...
              v5,
              Str1);
            VfReportIssueWithOptions(0xC4u, 0x2004uLL, a1 + 88, v5, (ULONG_PTR)Str1, byte_140C12C5C);
            if ( (MmVerifierData & 0x1000) != 0 )
