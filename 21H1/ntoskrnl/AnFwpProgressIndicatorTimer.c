/*
 * XREFs of AnFwpProgressIndicatorTimer @ 0x1409F14C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140CDB060 )
  {
    ...
    if ( word_140C10DC8 != -7989
      && (qword_140CDB068 + 10 * (v8[0].QuadPart / 33) / 100 - PerformanceCounter.QuadPart) / (v8[0].QuadPart / 33) >= 2 )
    {
      v5 = ++word_140C10DC8;
    }
    ...
    {
      LogFwStat(1, 0, v8);
      BgpTxtDisplayCharacter(qword_140C13390, word_140C10DC8, 0, 0LL, 0LL);
      LogFwStat(0, 0, v8);
      v5 = word_140C10DC8;
    }
    v7 = -8118;
