/*
 * XREFs of MiUnmapFrameBuffer @ 0x1402F8088
 * Callers:
...
__int64 __fastcall MiUnmapFrameBuffer(__int64 *BugCheckParameter2, int a2, unsigned int a3, _QWORD *a4)
{
  ...
  *a4 = -1LL;
  v21 = MI_READ_PTE_LOCK_FREE((unsigned __int64)BugCheckParameter2);
  v8 = v21;
  MI_READ_PTE_LOCK_FREE((unsigned __int64)&v21);
...
LABEL_27:
  *BugCheckParameter2 = v14;
  if ( v19 )
    MiWritePteShadow((__int64)BugCheckParameter2, v14);
  return a3;
}
