/*
 * XREFs of MmLoadSystemImageEx @ 0x1407444BC
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x14077A250 (IopLoadCrashdmpImage.c)
 ...
 *     IoIsDeviceEjectable @ 0x14031A370 (IoIsDeviceEjectable.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x14052FD04 (MiValidateStrongCodeDriverImage.c)
 ...
 *     MiRelocateAmount @ 0x1407BF314 (MiRelocateAmount.c)
...
LABEL_51:
  ...
  if ( (a4 & 1) == 0 )
  {
    _InterlockedExchangeAdd(&dword_140C4EF10, v18);
    v15 = P;
    v48 = v50;
  }
  ...
  {
    _InterlockedExchangeAdd((_DWORD *)&xmmword_140C4CC88 + 3, -v18);
    v30 = v50;
    v27 = (void *)v29;
    v15 = P;
