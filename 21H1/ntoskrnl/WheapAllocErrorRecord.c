/*
 * XREFs of WheapAllocErrorRecord @ 0x1405B5984
 * Callers:
 *     WheapReportBootError @ 0x1405B51E8 (WheapReportBootError.c)
 *     WheaReportHwError @ 0x1405B5450 (WheaReportHwError.c)
 * Callees:
 *     WheapInitializeErrorRecordWrapper @ 0x1403B6BF8 (WheapInitializeErrorRecordWrapper.c)
 *     memset @ 0x140408F80 (memset.c)
 *     WheapGetPreallocatedErrorRecord @ 0x1405B5E44 (WheapGetPreallocatedErrorRecord.c)
