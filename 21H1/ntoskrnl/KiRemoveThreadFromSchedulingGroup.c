/*
 * XREFs of KiRemoveThreadFromSchedulingGroup @ 0x140311544
 * Callers:
...
__int64 __fastcall KiRemoveThreadFromSchedulingGroup(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  volatile signed __int32 *v29; // [rsp+78h] [rbp+48h] BYREF
  ...
  else
  {
    ...
    v17 = KiAcquireThreadStateLock(a1, (__int64)&v28, &v29);
    if ( (*(_DWORD *)(a1 + 116) & 0x2000) != 0 )
    {
      KiRemoveThreadFromScbQueue(v28, *(_QWORD *)(a1 + 944), a1, (unsigned int)*(char *)(a1 + 195));
      v14 = 1;
    }
    _interlockedbittestandreset((volatile signed __int32 *)a1, 0x12u);
    *(_QWORD *)(a1 + 104) = 0LL;
    ...
    if ( v14 )
      KiAddThreadToPrcbQueue((_DWORD)v18, a1, *(char *)(a1 + 195), 0, 0);
