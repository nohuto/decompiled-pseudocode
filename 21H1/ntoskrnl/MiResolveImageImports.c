/*
 * XREFs of MiResolveImageImports @ 0x1407459B0
 * Callers:
...
__int64 __fastcall MiResolveImageImports(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _BYTE *a5)
{
  ...
  if ( !v10 || (v13 = v28) == 0 )
  {
    ...
    do
    {
      ...
      v13 = 8 * i;
      v28 = v13;
      if ( !(unsigned int)MiSetImageProtection(a1, v19, v13, 4u) )
      {
  ...
  if ( (unsigned int)MiSetImageProtection(a1, (unsigned __int64)v10, v28, 4u) )
  {
    v9 = 1;
LABEL_5:
    v14 = v29;
    *(_DWORD *)(a1 + 104) |= 0x1000u;
    ...
    if ( *(_QWORD *)(MiSectionControlArea(*(_QWORD *)(a1 + 112)) + 144) )
    {
      if ( v12 )
      {
        MiSetImageProtection(a1, v12, v13, 0x100u);
      }
      else
      {
        for ( j = &v11[-5 * v9]; j; j += 5 )
        {
          ...
          MiSetImageProtection(a1, (unsigned __int64)&v5[j[4]], 8 * v26, 0x100u);
        }
      }
    }
    *(_DWORD *)(a1 + 104) &= ~0x1000u;
