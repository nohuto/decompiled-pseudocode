/*
 * XREFs of BootApplicationPersistentDataInitialize @ 0x140A68B9C
 * Callers:
...
void __fastcall BootApplicationPersistentDataInitialize(__int64 a1)
{
  ...
  qword_140CF2778 = &qword_140CF2770;
  qword_140CF2770 = (__int64)&qword_140CF2770;
    ...
    if ( *((_DWORD *)v3 + 6) )
    {
      ...
      *((_DWORD *)PoolWithTag + 6) = *((_DWORD *)v3 + 6);
      ...
      if ( *(__int64 **)qword_140CF2778 != &qword_140CF2770 )
        __fastfail(3u);
      *PoolWithTag = &qword_140CF2770;
      PoolWithTag[1] = v6;
      *v6 = PoolWithTag;
      qword_140CF2778 = PoolWithTag;
    }
  }
}
