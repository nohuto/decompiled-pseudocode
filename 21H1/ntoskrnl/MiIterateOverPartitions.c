/*
 * XREFs of MiIterateOverPartitions @ 0x14037F6CC
 * Callers:
...
__int64 __fastcall MiIterateOverPartitions(void (__fastcall *a1)(__int64, __int64), __int64 a2)
{
  ...
  while ( 1 )
  {
    v5 = v2 < qword_140C4E568->SizeOfBitMap ? v2 : 0;
...
LABEL_17:
      ...
      if ( !v5 )
        break;
      SizeOfBitMap = v2 + 1;
      if ( v2 + 1 > qword_140C4E568->SizeOfBitMap )
    ...
    if ( (unsigned int)result < v2 || (_DWORD)result == -1 )
      return result;
    v2 = result + 1;
    v16 = *(_QWORD *)(qword_140C4E588 + 8LL * (unsigned int)result);
    if ( (*(_DWORD *)(v16 + 4) & 2) != 0 )
      a1(v16, a2);
  }
}
