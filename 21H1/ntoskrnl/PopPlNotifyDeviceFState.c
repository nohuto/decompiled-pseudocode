/*
 * XREFs of PopPlNotifyDeviceFState @ 0x1403A1558
 * Callers:
 *     PopPepStartComponentIdleStateChangeActivity @ 0x1403A1390 (PopPepStartComponentIdleStateChangeActivity.c)
      ...
      *(_DWORD *)(v9 + 32) = v12;
      ...
      if ( (unsigned int)dword_140C021E8 > 5 )
      {
        ...
        tlgWriteEx_EtwWriteEx(
          ...
          (unsigned __int8 *)&byte_140029180,
          v19,
          v20,
          v25,
          v26,
