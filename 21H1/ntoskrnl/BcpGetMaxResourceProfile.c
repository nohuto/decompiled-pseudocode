/*
 * XREFs of BcpGetMaxResourceProfile @ 0x1403B88EC
 * Callers:
 *     BgpBcInitializeCriticalMode @ 0x140A94798 (BgpBcInitializeCriticalMode.c)
 * Callees:
 *     BcpGetCharacterMaxResourceProfile @ 0x1403B89B0 (BcpGetCharacterMaxResourceProfile.c)
 */
...
__int64 __fastcall BcpGetMaxResourceProfile(__int64 a1, _OWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v7 = (__int64 *)*(v3 - 1);
    if ( v7 != &qword_140005910 || (dword_140C132D0 & 0x20000) == 0 )
    {
      CharacterMaxResourceProfile = 0;
