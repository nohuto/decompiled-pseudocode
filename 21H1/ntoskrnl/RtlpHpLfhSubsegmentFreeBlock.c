...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  int v100; // [rsp+30h] [rbp-78h]
  unsigned int v101; // [rsp+4Ch] [rbp-5Ch]
  __int64 v102; // [rsp+58h] [rbp-50h]
  unsigned __int8 v104; // [rsp+B8h] [rbp+10h]
  unsigned __int8 AbAllocationRegionCount; // [rsp+C0h] [rbp+18h]

  v104 = -1;
  v4 = 0LL;
  v7 = a4;
  v101 = DWORD2(RtlpHpHeapGlobals) ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
      ...
      do
      {
        while ( 1 )
        {
          ...
          if ( v100 )
          {
            ...
            {
              v31 = v104;
              if ( v104 <= 0xFu && CurrentIrql >= 2u )
              {
                CurrentPrcb = KeGetCurrentPrcb();
                SchedulerAssist = CurrentPrcb->SchedulerAssist;
                v98 = ~(unsigned __int16)(-1LL << (v104 + 1));
...
LABEL_160:
        ...
        v99 = _InterlockedCompareExchange64(v9 + 2, v35 & 1 | (v35 + 2) & 0xFFFFFFFFFFFFFFFEuLL, v35);
        v55 = v35 == v99;
        v35 = v99;
      }
      while ( !v55 );
...
LABEL_46:
      *((_BYTE *)v9 + 38) = v38;
      ...
      if ( (*(_BYTE *)v4 & 1) == 0 && *(_QWORD *)(v4 + 8) > 8uLL )
      {
        ...
        v67 = **(_QWORD **)v42;
        if ( *(_QWORD *)(*(_QWORD *)v42 + 8LL) != v42 || *(signed __int64 **)(v67 + 8) != v9 )
          goto LABEL_177;
        *(_QWORD *)v42 = v67;
        *(_QWORD *)(v67 + 8) = v42;
        --*v43;
...
LABEL_77:
  ...
  if ( v9 )
    RtlpHpLfhBucketAddSubsegment(
      v47,
      *(_QWORD *)(v47
                + 8LL * *((unsigned __int8 *)RtlpLfhBucketIndexMap + (((unsigned int)(unsigned __int16)v101 + 15) >> 4))
                + 128),
      v9,
      a4);
LABEL_25:
  if ( v4 )
  {
    ...
    if ( *(_BYTE *)(a1 + 57) )
    {
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v75 <= 0xFu && v104 <= 0xFu && v75 >= 2u )
          {
            v76 = KeGetCurrentPrcb();
            v77 = ~(unsigned __int16)(-1LL << (v104 + 1));
    ...
    else
    {
      ...
      if ( (unsigned int)MiGetSystemRegionType(v68) == 1 )
        v33 = MmGetSessionIdEx(v69->ApcState.Process);
...
LABEL_112:
        if ( (*((_DWORD *)&v69->0 + 1) & 0x10000) == 0 )
          KeBugCheckEx(0x162u, (ULONG_PTR)v69, v68, v33, 0LL);
      }
      else
      {
        *(_BYTE *)(v74 + 32) |= 2u;
