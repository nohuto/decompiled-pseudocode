/*
 * XREFs of ExpProfileCreate @ 0x14095584C
 * Callers:
 *     NtCreateProfile @ 0x140955F00 (NtCreateProfile.c)
 *     NtCreateProfileEx @ 0x140955FE0 (NtCreateProfileEx.c)
 * Callees:
        ...
        char a11)
{
  ...
  *(_QWORD *)&v33 = 0LL;
  v34 = 0LL;
  inserted = ObCreateObject(0, ExProfileObjectType, (__int64)&v32, PreviousMode, 0, 240, 0, 488, &v26);
  if ( inserted < 0 )
  {
    if ( Object )
