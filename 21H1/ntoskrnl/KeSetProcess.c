/*
 * XREFs of KeSetProcess @ 0x1402D4298
 * Callers:
  ...
  while ( v11 != v10 )
  {
    ...
    if ( v14 == 2 )
    {
      ...
      *(_QWORD *)v13 = 0LL;
      ...
      {
        LOBYTE(v22) = KeIsThreadRunning(v19->CurrentThread, v7);
      ...
      if ( (_QWORD *)*v17 == v17
        ...
        || !KiWakeQueueWaiter((__int64)v19, v16, v13) )
      {
        v21 = *(_DWORD *)(v16 + 4);
        *(_DWORD *)(v16 + 4) = v21 + 1;
        v7 = *(_QWORD **)(v16 + 32);
        ...
        *(_QWORD *)(v16 + 32) = v13;
        if ( !v21 && (_QWORD *)*v17 != v17 )
          KiWakeOtherQueueWaiters((__int64)v19, v16, v8, (__int64)v9);
      }
...
LABEL_7:
  ...
  *v10 = v10;
  ...
  KiExitDispatcher((__int64)CurrentPrcb, 0LL, 1LL, 0LL, v25);
  return v23;
}
