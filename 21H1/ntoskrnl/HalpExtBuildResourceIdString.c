/*
 * XREFs of HalpExtBuildResourceIdString @ 0x1403A8908
 * Callers:
 *     HalpInterruptBuildKnownResourceIdString @ 0x1403A854C (HalpInterruptBuildKnownResourceIdString.c)
 *     HalpTimerBuildKnownResourceIdString @ 0x1403A88B4 (HalpTimerBuildKnownResourceIdString.c)
 *     HalpExtGetRegisteredResourceIdString @ 0x1404BED2C (HalpExtGetRegisteredResourceIdString.c)
