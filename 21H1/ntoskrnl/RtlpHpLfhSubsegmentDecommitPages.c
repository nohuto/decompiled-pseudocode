/*
 * XREFs of RtlpHpLfhSubsegmentDecommitPages @ 0x1402390D0
 * Callers:
  ...
  if ( v6 < (unsigned int)result )
  {
    do
    {
      ...
      else
      {
        ...
        v9 = 2;
        v45 = RtlpHpAcquireLockExclusive(a2 + 24);
      }
      result = *(unsigned __int8 *)(a2 + 45);
    }
    ...
    if ( v9 )
    {
      ...
      else
      {
        ...
        LODWORD(v30) = ((char)CurrentThread->AbEntrySummary | (char)CurrentThread->AbOrphanedEntrySummary) ^ 0x3F;
...
LABEL_54:
          if ( (*((_DWORD *)&CurrentThread->0 + 1) & 0x10000) == 0 )
            KeBugCheckEx(0x162u, (ULONG_PTR)CurrentThread, v16, (unsigned int)SessionId, 0LL);
        }
        else
        {
          *(_BYTE *)(v32 + 32) |= 2u;
