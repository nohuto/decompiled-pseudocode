/*
 * XREFs of MiInitializeInPageSupport @ 0x140224D70
 * Callers:
...
__int64 __fastcall MiInitializeInPageSupport(ULONG_PTR BugCheckParameter2, char a2)
{
  ...
  *(_QWORD *)(BugCheckParameter2 + 152) = CurrentThread;
  ...
  if ( (Queue & 0x100) != 0 )
    ...
    PagePriorityThread = PsGetPagePriorityThread(CurrentThread, v4);
  v9 = *(_DWORD *)(BugCheckParameter2 + 192);
  ...
  else
  {
    ...
    if ( PagePriorityThread )
      v5 = PagePriorityThread - 1;
  }
  result = PagePriorityThread & 7;
  *(_DWORD *)(BugCheckParameter2 + 192) = v9 & 0xFFFF81FF | (((unsigned int)result | (8 * (v5 & 7))) << 9);
  if ( (a2 & 2) != 0 )
  {
