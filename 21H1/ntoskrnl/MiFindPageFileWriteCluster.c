/*
 * XREFs of MiFindPageFileWriteCluster @ 0x14032145C
 * Callers:
 ...
 *     RtlFindLongestRunClearCapped @ 0x1405816B0 (RtlFindLongestRunClearCapped.c)
...
unsigned int *__fastcall MiFindPageFileWriteCluster(__int64 a1, ULONG *a2, unsigned int *a3, int a4)
{
  ...
  FreePageFileSpace = MiFindFreePageFileSpace(v10, &v28, v4, v11 != 0 ? 38 : 32);
  if ( FreePageFileSpace )
  {
    v13 = v28;
    if ( qword_140C4DE80 && (v28 & 0x10) == 0 )
      v13 = v28 & ~qword_140C4DE80;
    v14 = HIDWORD(v13);
  }
  else
  {
