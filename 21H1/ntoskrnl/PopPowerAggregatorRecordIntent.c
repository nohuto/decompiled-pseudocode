/*
 * XREFs of PopPowerAggregatorRecordIntent @ 0x1407620C0
 * Callers:
 ...
 *     PopPowerAggregatorAreTargetStatesEqual @ 0x1408E9944 (PopPowerAggregatorAreTargetStatesEqual.c)
 */
        ...
        int a7)
{
  ...
  v13 = (char *)&unk_140C218A0 + 144 * (((unsigned __int8)dword_140C21898 - 1) & 0x1F);
  if ( *(_DWORD *)v13 != 1
    || *((_DWORD *)v13 + 6) != a2
    || *((_DWORD *)v13 + 8) != a4
    || *((_DWORD *)v13 + 34) != v9
