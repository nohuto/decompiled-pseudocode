/*
 * XREFs of RtlpHpVaMgrCtxFree @ 0x140360210
 * Callers:
...
LABEL_51:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v10, &v35);
    ...
    result = KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread(), v29, v31, (__int64)v32);
  }
  if ( v19 )
  {
    v11 = (_BYTE *)v19;
