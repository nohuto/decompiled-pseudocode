/*
 * XREFs of PfQuerySuperfetchInformation @ 0x1405E94F0
 * Callers:
...
__int64 __fastcall PfQuerySuperfetchInformation(__int64 a1, __int128 *a2, int a3, unsigned __int8 a4, _DWORD *a5)
{
  ...
  int v50[2]; // [rsp+D0h] [rbp-68h] BYREF
...
LABEL_20:
  if ( a4 )
  {
    ...
    if ( !RtlEqualSid(SeLocalSystemSid, v23) )
    {
      ...
      {
        SepAdtPrivilegedServiceAuditAlarm((int)&DmaAdapter, &SeSubsystemName, 0LL, (__int64)v14, (__int64)v19, v50, v21);
        v19 = v42;
        v14 = DmaAdapter;
      }
    }
  ...
  else
  {
    switch ( v8 )
    {
      ...
      case 9:
        ...
        *(_DWORD *)Address[0] = dword_140CEC0D0;
        *v6 = 4;
        break;
      case 12:
...
LABEL_107:
      ...
      case 28:
        return (unsigned int)PfpQueryGpuUtilization(&v38, a4, v6);
      default:
        v7 = -1073741821;
        break;
    }
