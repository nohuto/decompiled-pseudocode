/*
 * XREFs of KiQuantumEnd @ 0x1403312E0
 * Callers:
...
void __fastcall KiQuantumEnd(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v144; // r9
  __int64 v145; // rdx
  __int64 v146; // [rsp+20h] [rbp-79h] BYREF
  _KSHARED_READY_QUEUE *v147; // [rsp+28h] [rbp-71h]
  __int64 *v148; // [rsp+30h] [rbp-69h]
  ...
  __int64 *v163; // [rsp+90h] [rbp-9h] BYREF
  _QWORD *v164; // [rsp+98h] [rbp-1h] BYREF
  __int64 v165; // [rsp+A0h] [rbp+7h] BYREF
  __int64 v166[9]; // [rsp+A8h] [rbp+Fh] BYREF
...
LABEL_195:
        ...
        while ( _interlockedbittestandset64((volatile signed __int32 *)(v86 + 64), 0LL) )
        {
        ...
        v90 = *(char *)(v86 + 195);
        if ( (int)(v85 - *(_DWORD *)(v86 + 436)) > 0 && v90 < 15 )
        {
          v172 = 1;
          KiSetPriorityBoost(0LL, (_KTHREAD *)v86, 15, v152);
        }
...
LABEL_207:
  ...
  if ( v164 )
  {
    ...
    do
    {
      ...
      v177 = *(char *)(v74 + 195);
      if ( v171 - *(_DWORD *)(v74 + 436) > 0 && *(char *)(v74 + 195) < 15 )
      {
        v168 = 1;
        KiSetPriorityBoost(0LL, (_KTHREAD *)v74, 15, (__int64)v148);
      }
