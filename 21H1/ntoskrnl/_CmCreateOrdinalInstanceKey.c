/*
 * XREFs of _CmCreateOrdinalInstanceKey @ 0x1407548A8
 * Callers:
...
__int64 __fastcall CmCreateOrdinalInstanceKey(__int64 a1, char *a2, wchar_t *a3, __int64 a4, __int64 a5, HANDLE *a6)
{
  unsigned int v9; // ebx
