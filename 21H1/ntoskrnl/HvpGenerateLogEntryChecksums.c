/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x140689DC0
 * Callers:
 ...
 *     SymCryptMarvin32Init @ 0x1403E7B0C (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1403E7B28 (SymCryptMarvin32Result.c)
