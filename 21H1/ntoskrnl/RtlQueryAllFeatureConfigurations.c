/*
 * XREFs of RtlQueryAllFeatureConfigurations @ 0x140914930
 * Callers:
 *     <none>
 * Callees:
        ...
        PSIZE_T ConfigurationCount)
{
  ...
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C48130, (__int64)v13, &v12);
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48130, v9);
