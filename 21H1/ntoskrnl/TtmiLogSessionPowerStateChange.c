/*
 * XREFs of TtmiLogSessionPowerStateChange @ 0x1408FFAD0
 * Callers:
...
void __fastcall TtmiLogSessionPowerStateChange(char a1)
{
  ...
  if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL) )
    {
      ...
      v9 = &v3;
      v10 = 1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2C8E8, (unsigned __int8 *)byte_14002AEAD, 0LL, 0LL, 4u, &v5);
    }
  }
}
