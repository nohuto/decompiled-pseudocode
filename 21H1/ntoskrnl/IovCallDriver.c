/*
 * XREFs of IovCallDriver @ 0x1409C1C94
 * Callers:
 ...
 *     IovpValidateDeviceObject @ 0x1409C2B04 (IovpValidateDeviceObject.c)
        ...
        if ( !*(_BYTE *)(v9 - 72) )
        {
          ...
          if ( v10 )
          {
            if ( (*(_DWORD *)(v10 + 80) & 0x204000) == 0x204000 && (MmVerifierData & 0x400000) == 0 )
            {
              v8[157] = KeAcquireSpinLockRaiseToDpc(&VfBugcheckTmpDataLock);
              qword_140D47038 = *((_QWORD *)v8 + 20);
              xmmword_140D47040 = *((_QWORD *)v8 + 21);
              *(&xmmword_140D47040 + 1) = *(_QWORD *)(v9 - 24);
              *(_QWORD *)&VfBugcheckTmpData = 201LL;
