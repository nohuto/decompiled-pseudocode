/*
 * XREFs of CmpQueryKeyDataFromNode @ 0x1405F8180
 * Callers:
 ...
 *     CmGetVisibleValueCount @ 0x140658CF8 (CmGetVisibleValueCount.c)
 ...
 *     CmListGetPrevElement @ 0x140658EF0 (CmListGetPrevElement.c)
...
LABEL_4:
    ...
    if ( a8 )
    {
      while ( 1 )
      {
        PrevElement = CmListGetPrevElement(a7 + 208, &v27);
        v22 = PrevElement;
        if ( !PrevElement )
          break;
  ...
  if ( v23 )
  {
    if ( v23 == 1 )
    {
      *(_QWORD *)&v28 = CmGetKeyLastWriteTime(a7, a2, a8);
      DWORD2(v28) = 0;
      ...
      if ( VisibleMaxNameLenAndClassLen >= 0 )
      {
        ...
        if ( VisibleMaxNameLenAndClassLen >= 0 )
        {
          ...
          if ( *(_WORD *)(a2 + 74) )
            v11 = (*(__int64 (__fastcall **)(__int64, _QWORD, int *))(v10 + 8))(v10, *(unsigned int *)(a2 + 48), &v24);
