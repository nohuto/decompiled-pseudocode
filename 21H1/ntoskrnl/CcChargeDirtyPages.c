/*
 * XREFs of CcChargeDirtyPages @ 0x14027BA20
 * Callers:
...
__int64 __fastcall CcChargeDirtyPages(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  if ( a1 )
  {
    v8 = *(_QWORD *)(a1 + 528);
    if ( *(_QWORD *)(a1 + 168)
      && v8 != *(_QWORD *)(MmGetControlAreaPartition(*(_QWORD *)((*(_QWORD *)(a1 + 96) & 0xFFFFFFFFFFFFFFF0uLL) + 0x28))
                         + 8) )
    {
  ...
  *(_QWORD *)(v8 + 640) += v4;
  ...
  return CcAdjustWriteBehindThreadPoolIfNeeded(v8, 0LL, a3);
}
