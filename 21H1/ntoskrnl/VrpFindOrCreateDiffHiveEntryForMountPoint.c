/*
 * XREFs of VrpFindOrCreateDiffHiveEntryForMountPoint @ 0x1405CBCD4
 * Callers:
...
LABEL_8:
  ...
  {
    DiffHiveEntry = 0LL;
    v21 = v13[1] & (-1LL << (dword_140C47944 & 0x1F));
    v15 = qword_140C47948;
    v16 = (37
         * (BYTE6(v21)
          + 37
         ...
         + HIBYTE(v21)) & (((unsigned int)dword_140C47944 >> 5) - 1);
    *v13 = *(_QWORD *)(qword_140C47948 + 8 * v16);
