/*
 * XREFs of PfSnCheckActionsNeeded @ 0x140650B2C
 * Callers:
  ...
  *(_QWORD *)&v38[1] = a1;
  ...
  else
  {
    ...
    else
    {
      ...
      v27 = PfSnPrefetchCacheEntryGet(&unk_140C503F8, *(_QWORD *)&v38[1], v16, &v37);
      v28 = (_DWORD *)v27;
      if ( v27 )
      {
        if ( v37 )
