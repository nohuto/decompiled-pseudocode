/*
 * XREFs of MiMapViewOfImageSection @ 0x1406362B0
 * Callers:
        ...
        char a8)
{
  ...
  v104 = v13;
  if ( dword_140C4CBD0
    && dword_140C4CBD4 == *(_DWORD *)(v13 + 60)
    && dword_140C4CBD8 == *(_DWORD *)(*(_QWORD *)(v10 + 56) + 68LL) )
  {
    __debugbreak();
  }
...
LABEL_96:
                ...
                if ( (v54 & 0x10) == 0 || (PerSessionProtos = MiCommitVadCfgBits(v23, 0LL, 0LL), PerSessionProtos >= 0) )
                {
                  if ( *(_QWORD *)(a2 + 80) )
                  {
                    ...
                    if ( PerSessionProtos < 0 )
                      goto LABEL_241;
                    **(_QWORD **)(a2 + 80) = v103 ^ qword_140C4DD90 ^ v11;
                    v59 = 0LL;
                  }
                  else
                  {
                    ...
                    || (v59 = (unsigned __int64)MiAddSecureEntry(v23, v99 << 12, (v41 << 12) | 0xFFF, -2147483647, 0)) != 0 )
                  {
                    ...
                    if ( v59 )
                      MmUnsecureVirtualMemory((HANDLE)(v59 ^ qword_140C4DD90 ^ v11));
                    goto LABEL_96;
                  }
                  PerSessionProtos = -1073741670;
                }
