/*
 * XREFs of HalpNumaInitializeStaticConfiguration @ 0x140A5C4C0
 * Callers:
 ...
 *     HalpGetAvailableProximityId @ 0x140A8AD20 (HalpGetAvailableProximityId.c)
 *     HalpGetNumaProcMemoryCount @ 0x140A8ADAC (HalpGetNumaProcMemoryCount.c)
 *     HalpUpdateConfigurationFromMsct @ 0x140A8B1CC (HalpUpdateConfigurationFromMsct.c)
 *     HalpVerifySratEntryLengthAndFlag @ 0x140A8B590 (HalpVerifySratEntryLengthAndFlag.c)
 */
