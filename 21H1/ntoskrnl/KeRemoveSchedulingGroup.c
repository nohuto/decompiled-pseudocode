/*
 * XREFs of KeRemoveSchedulingGroup @ 0x1402DBAE8
 * Callers:
 ...
 *     KiAssignSchedulingGroupWeights @ 0x1402DBE84 (KiAssignSchedulingGroupWeights.c)
 *     KiUpdateMinimumWeight @ 0x1402DC0F4 (KiUpdateMinimumWeight.c)
  ...
  if ( (_DWORD)KeNumberProcessors_0 )
  {
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        do
          KeYieldProcessorEx(&v32, v4, v2, v3);
        while ( *(_QWORD *)(v11 + 48) );
      }
      v14 = &a1[v12 + 100];
      v15 = *(_QWORD *)v14;
