/*
 * XREFs of MiAppendWsleCluster @ 0x14021DFD0
 * Callers:
...
__int64 __fastcall MiAppendWsleCluster(__int64 a1, __int64 a2, unsigned __int64 *a3)
{
  ...
  if ( Flink >= 0xFFFFF6FB7DBED000uLL
    ...
    && (unsigned int)MiPteHasShadow(0xFFFFF68000000000uLL, v9)
    && (v9 & 1) != 0
    && ((v9 & 0x20) == 0 || (v9 & 0x42) == 0) )
  {
  ...
  if ( (unsigned __int64)&v23 >= v8
    && (unsigned __int64)&v23 <= v10
    && (unsigned int)MiPteHasShadow(&v23, v14)
    && (v14 & 1) != 0
    && ((v14 & 0x20) == 0 || (v14 & 0x42) == 0) )
  {
    Flink = (unsigned __int64)KeGetCurrentThread()->ApcState.Process[1].ProcessListEntry.Flink;
    if ( Flink )
    {
      v16 = *(_QWORD *)(Flink + 8 * (((unsigned __int64)&v23 >> 3) & 0x1FF));
      Flink = v14 | 0x20;
      if ( (v16 & 0x20) == 0 )
        Flink = v14;
      v14 = Flink;
  ...
  v17 = (unsigned int)MI_PFN_IS_PROTO(
                        48 * ((v14 >> 12) & 0xFFFFFFFFFLL) - 0x58000000000LL,
                        (v14 >> 12) & 0xFFFFFFFFFLL,
                        Flink) == 0;
  v18 = *(_QWORD *)(a1 + 8);
  v19 = v17;
  if ( !v18 )
  {
LABEL_42:
    v22 = *(_DWORD *)(a1 + 24) & 0xFFFFFFFE;
    *(_QWORD *)a1 = a2;
    *(_QWORD *)(a1 + 8) = a3;
    *(_DWORD *)(a1 + 24) = v19 | v22;
    *(_QWORD *)(a1 + 16) = 1LL;
    *(_BYTE *)(a1 + 28) = v13;
    return 1LL;
  }
  v20 = *(_QWORD *)(a1 + 16);
  if ( a3 != (unsigned __int64 *)(v18 + 8 * v20) || v13 != *(_BYTE *)(a1 + 28) || v17 != (*(_DWORD *)(a1 + 24) & 1) )
  {
    if ( (*(_DWORD *)(a1 + 24) & 2) != 0 )
      return 0LL;
