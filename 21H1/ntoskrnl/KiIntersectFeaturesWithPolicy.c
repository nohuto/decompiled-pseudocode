/*
 * XREFs of KiIntersectFeaturesWithPolicy @ 0x14099BA70
 * Callers:
 ...
 *     KiIsXSaveFeatureAllowed @ 0x14099BBD0 (KiIsXSaveFeatureAllowed.c)
 *     KiLoadPolicyFromImage @ 0x14099BC60 (KiLoadPolicyFromImage.c)
 */
