/*
 * XREFs of PpmCheckMakeupSkippedChecks @ 0x1402FE920
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140276C20 (KeGetPrcb.c)
 *     KeEnumerateNextProcessor @ 0x1402771F0 (KeEnumerateNextProcessor.c)
 *     PpmPerfCompleteMakeup @ 0x1402FEA44 (PpmPerfCompleteMakeup.c)
 *     PpmPerfMinimumPerfReached @ 0x1402FEA64 (PpmPerfMinimumPerfReached.c)
 *     PpmParkMaximumCoresParked @ 0x1402FEACC (PpmParkMaximumCoresParked.c)
...
char PpmCheckMakeupSkippedChecks()
{
  ...
  if ( PpmCheckMakeupCount )
  {
    ...
    {
      v9[1] = (unsigned __int16 *)qword_140C11248[0];
