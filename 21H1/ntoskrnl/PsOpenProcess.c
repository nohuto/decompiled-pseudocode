/*
 * XREFs of PsOpenProcess @ 0x140602740
 * Callers:
 *     NtOpenProcess @ 0x1405D42D0 (NtOpenProcess.c)
        ...
        KPROCESSOR_MODE a6)
{
  ...
  *(_OWORD *)ProcessId = 0LL;
  ...
  if ( ProcessId[1] )
  {
    v16 = PsLookupProcessThreadByCid((__int64)ProcessId, &Process, &DmaAdapter);
    if ( v16 >= 0 )
    {
...
LABEL_38:
  ...
  if ( v17 && (unsigned int)dword_140C01AB0 > 5 && tlgKeywordOn((__int64)&dword_140C01AB0, 0x400000000000LL) )
  {
    ...
    v68 = &v45;
    v69 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C01AB0, (unsigned __int8 *)&word_14002B09E, 0LL, 0LL, 8u, &v57);
  }
  *v46 = Handle;
  v26 = v30;
LABEL_46:
