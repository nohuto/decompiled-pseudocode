/*
 * XREFs of RtlpHpSegMgrVaCtxFree @ 0x14058F050
 * Callers:
...
unsigned __int64 __fastcall RtlpHpSegMgrVaCtxFree(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  __int128 v36[4]; // [rsp+30h] [rbp-48h] BYREF
  int v37; // [rsp+88h] [rbp+10h] BYREF
  unsigned __int16 *v38; // [rsp+90h] [rbp+18h] BYREF
  ...
  v8 = 0LL;
  v36[0] = v3;
  RtlpHpQueryVA(a2 & 0xFFFFFFFFFFE00000uLL, v36, &v38, 0LL);
  v9 = a1 + 112;
  v10 = (a2 - v7) / *a3;
  v11 = RtlpHpAcquireLockExclusive((volatile LONG *)(a1 + 112), *(_DWORD *)(a1 + 40) & 1);
  v12 = v38;
  v13 = v11;
  v14 = (unsigned __int16)(v38[1] ^ (1 << v10));
  v15 = 0x200000uLL / *a3;
  v38[1] = v14;
