/*
 * XREFs of MiLogTrimWs @ 0x14030C994
 * Callers:
...
void __fastcall MiLogTrimWs(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  {
    MiFillLogProcessInfo(a1, &v18, &v19, *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(a1 + 174)));
    if ( *v9 > 5u )
    {
      if ( tlgKeywordOn((__int64)v9, 1LL) )
      {
        ...
        v42 = 4LL;
        v44 = 4LL;
        tlgWriteEx_EtwWriteEx(v16, (int)&byte_140024DA7, 0, v15, 0, 0, 0xCu, (__int64)v27);
      }
    }
  }
}
