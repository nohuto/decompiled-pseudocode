/*
 * XREFs of SPCallServerHandleQueryPolicy @ 0x1405F66A0
 * Callers:
...
LABEL_118:
  ...
  v101 = ((__int64 (__fastcall *)(UNICODE_STRING *, char *, _QWORD, _QWORD, unsigned int *))qword_140D2C4B0)(
           &DestinationString,
...
LABEL_121:
  ...
  v57 = ((__int64 (__fastcall *)(UNICODE_STRING *, char *, PVOID, _QWORD, unsigned int *))qword_140D2C4B0)(
          &DestinationString,
          (char *)&NumberOfBytes + 4,
          v7,
          v6,
...
LABEL_141:
  ...
  {
    v125 = 0;
    if ( DestinationString.Length == stru_140D2C248.Length
      && !memcmp(DestinationString.Buffer, stru_140D2C248.Buffer, stru_140D2C248.Length) )
    {
      v125 = dword_140D2C138;
      v122 = 1;
    }
    else
    {
    ...
    v75 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, int *, __int64, int *))qword_140D2C4B0)(
            &v143,
            &v128,
            &v129,
            4LL,
...
LABEL_156:
    ...
    {
      v103 = KeWaitForSingleObject(&Mutex, UserRequest, 1, 0, &Timeout);
      if ( v103 >= 0 && v103 != 192 && v103 != 258 )
      {
        if ( g_ulOldGenuineState != v73 )
        {
          ...
          else
          {
            ...
            v73 = v126;
            qword_140D2C170 = v111 / 10000;
          }
        }
        v104 = v74 - qword_140D2C170;
        g_ulOldGenuineState = v73;
        if ( v73 || v104 < 0xADF4FC && !v122 || !dword_140D2C1DC )
          goto LABEL_279;
        KeSetEvent(&stru_140C13C60, 1, 0);
        v112 = dword_140D2C0C4;
        if ( !dword_140D2C0C4 )
        {
          v130 = 4;
          v124 = 0;
          LODWORD(v137) = 0;
          Size = 0LL;
          v113 = ZwOpenKey((PHANDLE)&Size, 1u, &stru_140D2C880);
          if ( v113 < 0 )
          {
            v113 = ((__int64 (__fastcall *)(wchar_t *, int *, int *, __int64, __int64 *, int, int))qword_140D2C4B0)(
                     aBd,
                     &v130,
                     &v124,
                     4LL,
        ...
        v145 = 0;
        v132 = 0;
        if ( (int)((__int64 (__fastcall *)(wchar_t *, int *, __int64 *, __int64, int *))qword_140D2C4B0)(
                    aLn,
                    &v131,
                    &v144,
                    12LL,
        ...
        {
LABEL_276:
          v116 = dword_140D2C06C & 0xFFFF0000 | 0x3211;
        }
        dword_140D2C06C = v116;
        if ( v133 || v125 )
          v8 = v116;
        else
LABEL_279:
