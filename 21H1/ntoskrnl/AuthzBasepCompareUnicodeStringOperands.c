/*
 * XREFs of AuthzBasepCompareUnicodeStringOperands @ 0x1403584C0
 * Callers:
 ...
 *     AuthzBasepGetOperandStringCaseForEvaluation @ 0x140358660 (AuthzBasepGetOperandStringCaseForEvaluation.c)
 *     AuthzBasepCompareUnicodeStringCaseSensitive @ 0x1405BC210 (AuthzBasepCompareUnicodeStringCaseSensitive.c)
...
LABEL_43:
  ...
  {
    if ( v28 )
      v20 = AuthzBasepEqualUnicodeStringCaseSensitive((const void **)&Name, (__int64)&Expression);
    else
