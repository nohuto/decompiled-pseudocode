/*
 * XREFs of MiCreateEnclaveRegions @ 0x140A4D550
 * Callers:
...
_BOOL8 __fastcall MiCreateEnclaveRegions(__int64 a1)
{
  ...
  qword_140C4EDF0 = (__int64)&qword_140C4EDE8;
  qword_140C4EDE8 = (__int64)&qword_140C4EDE8;
  v2 = 0LL;
  qword_140C4EDF8 = 0LL;
  ExInitializePushLock(&stru_140C4EE00);
  v3 = (__int64 *)(a1 + 32);
...
LABEL_20:
    ...
    v11 = 1;
LABEL_15:
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4EDC0, (unsigned __int64)v12, v11, v2);
LABEL_16:
  ...
  return !qword_140C4EDC0 || (unsigned int)MiInitializeEnclaveMetadataPage();
}
