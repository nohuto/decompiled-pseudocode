/*
 * XREFs of PopInitializePreSleepNotifications @ 0x1407BE518
 * Callers:
...
__int64 PopInitializePreSleepNotifications()
{
  ...
  dword_140C2050C = v0;
  result = (unsigned int)_InterlockedExchange(&dword_140C20500, 0);
  qword_140C204F8 = 0LL;
  PopPreSleepNotifyWorkItem = 0LL;
  qword_140C204F0 = (__int64)PopPreSleepNotifyWorker;
  return result;
}
