/*
 * XREFs of PspWow64InitThread @ 0x1406FC5CC
 * Callers:
...
__int64 __fastcall PspWow64InitThread(_KPROCESS *BugCheckParameter1, __int64 a2, _QWORD *a3, __int64 a4)
{
  ...
  _DWORD *v18; // r9
  _DWORD *v19; // rdx
  _DWORD *v21; // [rsp+30h] [rbp-98h] BYREF
  int v22; // [rsp+38h] [rbp-90h]
  _DWORD *v23; // [rsp+40h] [rbp-88h]
  ...
  if ( !v10 )
    return 3221225485LL;
  RtlpGetLegacyContextLength(v10, 0LL, &v21);
  v23 = *(_DWORD **)(a2 + 16);
  v12 = ~((unsigned int)v21 - 1LL) & ((unsigned __int64)v23 + (unsigned int)v21 + 3);
  v21 = *(_DWORD **)(a2 + 40);
  v13 = a3[31];
  ...
  v15 = a3[16];
  v16 = a3[17];
  KiStackAttachProcess(BugCheckParameter1, 0LL, (__int64)v25, v11);
  v19 = v23;
  *(_QWORD *)(v24 + 5256) = v23;
  *v19 = v9 << 16;
  switch ( v9 )
  {
    case 0x14Cu:
      PspWow64InitThreadGuestx86(BugCheckParameter1, v12, v13, v21, v15, v16);
      break;
    case 0x1C4u:
      PspWow64InitThreadGuestArm(BugCheckParameter1, v12, v13, v21, v15, v16);
      break;
    case 0x8664u:
  ...
  KiUnstackDetachProcess((__int64)v25, 0LL, v17, v18);
  return v7;
}
