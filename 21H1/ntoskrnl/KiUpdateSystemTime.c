/*
 * XREFs of KiUpdateSystemTime @ 0x1403949A8
 * Callers:
 *     KeSetTimeAdjustment @ 0x14038F2B4 (KeSetTimeAdjustment.c)
 *     KiSetSystemTimeDpc @ 0x14039AA90 (KiSetSystemTimeDpc.c)
 *     KiCalibrateTimeAdjustment @ 0x140990BE0 (KiCalibrateTimeAdjustment.c)
 * Callees:
 *     KiComputeNewSystemTime @ 0x140240BC0 (KiComputeNewSystemTime.c)
