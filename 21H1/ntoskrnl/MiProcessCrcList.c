/*
 * XREFs of MiProcessCrcList @ 0x140712D40
 * Callers:
 ...
 *     MiValidCombineProtection @ 0x140365190 (MiValidCombineProtection.c)
 *     MiAllocateCombineProto @ 0x1403651C0 (MiAllocateCombineProto.c)
 *     MiCompareActiveCrcEntries @ 0x140365448 (MiCompareActiveCrcEntries.c)
 *     MiCapturePfnVm @ 0x1403654B0 (MiCapturePfnVm.c)
 *     MiSharePages @ 0x140365710 (MiSharePages.c)
 *     MiPushCombineBlock @ 0x140368238 (MiPushCombineBlock.c)
...
LABEL_55:
        ...
        DmaAdapter = 0LL;
        v21 = MiCapturePfnVm(v63, v13, v64, v20, (unsigned __int64 *)&DmaAdapter, &v66, &v59, &v62);
...
LABEL_79:
      ...
      v42 = v63;
      MiPopulateCombineMdls((__int64)v63, v4, (__int64)&v69);
    }
    else
    {
      v42 = v63;
