/*
 * XREFs of LdrpSearchResourceSection_U @ 0x1406F8B20
 * Callers:
 *     LdrpLoadResourceFromAlternativeModule @ 0x14033A6C4 (LdrpLoadResourceFromAlternativeModule.c)
 ...
 *     LdrFindResourceDirectory_U @ 0x14090C370 (LdrFindResourceDirectory_U.c)
 *     LdrFindResourceEx_U @ 0x14090C390 (LdrFindResourceEx_U.c)
...
__int64 __fastcall LdrpSearchResourceSection_U(__int64 a1, __int64 *a2, unsigned int a3, int a4, __int64 *a5)
{
  int v5; // r15d
  int v6; // esi
  int v8; // edx
