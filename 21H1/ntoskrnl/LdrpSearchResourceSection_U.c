...
NTSTATUS __fastcall LdrpSearchResourceSection_U(char *a1, __int64 *a2, unsigned int a3, ULONG a4, _QWORD *a5)
{
  ULONG v5; // r15d
  int v6; // esi
  __int64 *v7; // r13
  ...
  _QWORD *v60; // [rsp+58h] [rbp-F0h]
  __int64 v61; // [rsp+60h] [rbp-E8h] BYREF
  char *v62; // [rsp+68h] [rbp-E0h]
