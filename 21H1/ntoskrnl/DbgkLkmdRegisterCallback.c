/*
 * XREFs of DbgkLkmdRegisterCallback @ 0x140787CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DbgkLkmdRegisterCallback(__int64 a1, __int64 a2, int a3)
{
  ...
  for ( j = 0; j < 8; ++j )
  {
    if ( ExCompareExchangeCallBack((signed __int64 *)&stru_140C53E30 + 2 * j, v9, 0LL) )
    {
      result = 0LL;
      *((_DWORD *)&stru_140C53E30 + 4 * j + 2) = a3;
      return result;
    }
  }
