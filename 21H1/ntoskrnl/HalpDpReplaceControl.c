/*
 * XREFs of HalpDpReplaceControl @ 0x1409A4B10
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a1 )
  {
        ...
        if ( v7 == 1 )
        {
          *(_BYTE *)(a2 + 68) = 1;
          if ( v3 )
          {
            ...
            while ( v9 < v10 )
            {
              if ( (++v8 & dword_140C4A35C) != 0 || !qword_140C4A360 )
                _mm_pause();
              else
                qword_140C4A360(v8, a2, a3);
              v9 = *(_DWORD *)(a2 + 48);
            }
            v11 = 0;
    ...
    else if ( v3 )
    {
      *(LARGE_INTEGER *)(a2 + 80) = KeQueryPerformanceCounter((PLARGE_INTEGER)(a2 + 72));
      ...
      {
        if ( (++v14 & dword_140C4A35C) != 0 || !qword_140C4A360 )
          _mm_pause();
        else
          ((void (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140C4A360)(
            v14,
      ...
      *(LARGE_INTEGER *)(a2 + 112) = KeQueryPerformanceCounter(0LL);
      ...
      {
        if ( (++v19 & dword_140C4A35C) != 0 || !qword_140C4A360 )
          _mm_pause();
        else
          ((void (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140C4A360)(
            v19,
