/*
 * XREFs of PfVerifyScenarioBuffer @ 0x140652E90
 * Callers:
 ...
 *     PfVerifyScenarioId @ 0x140653E54 (PfVerifyScenarioId.c)
 *     PfMetadataRecordIsEqual @ 0x140672E6C (PfMetadataRecordIsEqual.c)
 */
...
LABEL_128:
                                        ...
                                        while ( !(unsigned __int8)PfMetadataRecordIsEqual(v50 + 96LL * v52, &v95, v53) )
                                        {
                                          v52 = v79 + 1;
                                          if ( v52 >= v80 )
                                            goto LABEL_86;
