/*
 * XREFs of ExpSetTimer2 @ 0x1402424F4
 * Callers:
 *     NtSetTimer2 @ 0x1402424D0 (NtSetTimer2.c)
 *     NtCancelTimer2 @ 0x140321D60 (NtCancelTimer2.c)
 *     NtSetIRTimer @ 0x140322420 (NtSetIRTimer.c)
 * Callees:
