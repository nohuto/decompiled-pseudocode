/*
 * XREFs of PopInitSIdle @ 0x1407782B8
 * Callers:
...
__int64 __fastcall PopInitSIdle(unsigned int a1)
{
  ...
  v12[28] = 2;
  if ( (PopFullWake & 3) == 0 && dword_140C23EE0 && (PopSimulate & 0x1000000) == 0 )
  {
    v3 = 4;
    if ( (unsigned int)(qword_140C23404 - 2) <= 1 )
    {
      v12[28] = HIDWORD(qword_140C23404);
      v12[25] = qword_140C23404;
    }
    else
    {
      v12[25] = 2;
...
LABEL_35:
  v12[23] = v9;
LABEL_5:
  if ( RtlCompareMemory(&qword_140C23354, &v12[25], 0xCuLL) == 12
    && (v4 = dword_140C23360, dword_140C23360 == v12[28])
    && (v5 = dword_140C2334C, dword_140C2334C == v12[23]) )
  {
    v2 = 0;
  }
  else
  {
    ...
    v4 = v12[28];
    v5 = v12[23];
    dword_140C2335C = v12[27];
    qword_140C23354 = *(_QWORD *)&v12[25];
    byte_140C23374 = 1;
    dword_140C23360 = v12[28];
    dword_140C2334C = v12[23];
    if ( dword_140C002E0 )
      v7 = dword_140C23364 | 1;
    else
      v7 = dword_140C23364 & 0xFFFFFFFE;
    dword_140C23364 = v7;
    if ( !byte_140C24014 )
    {
      if ( dword_140C00300 )
  ...
  v11 = v5;
  LOBYTE(v5) = v2;
  return PopTraceSystemIdleTimeoutInitialization(v5, v3, qword_140C23354, v4, v11, SBYTE4(qword_140C23354), a1);
}
