/*
 * XREFs of DrvDbDeleteObjectSubKey @ 0x14097851C
 * Callers:
...
LABEL_7:
  ...
  if ( !wcschr(a3, 0x5Cu) )
  {
    ...
    if ( v35 != -1073741535 )
      goto LABEL_84;
    InfoKey = PnpCtxRegQueryInfoKey(v36, (int)Handle, 0, 0, (__int64)&v49, (__int64)&v45, 0LL);
    if ( InfoKey < 0 )
      goto LABEL_84;
    v37 = v45 + 1;
    if ( !v49 )
    ...
    if ( v39 )
    {
      ...
      {
        v49 = v37;
        InfoKey = PnpCtxRegEnumValue(v38, Handle, 0, v39, (__int64)&v49, 0LL, 0LL, 0LL);
        if ( InfoKey < 0 )
          break;
        v40 = Handle;
        DestinationString = 0LL;
        InfoKey = RtlInitUnicodeStringEx(&DestinationString, (PCWSTR)v39);
        if ( InfoKey >= 0 )
...
LABEL_40:
  ...
  for ( j = (char *)Handle; ; j = 0LL )
  {
    if ( !j )
    {
      ...
      InfoKey = PnpCtxRegQueryInfoKey(v27, (int)Handle, (int)&v44, 0, (__int64)&v49, 0LL, 0LL);
      if ( InfoKey < 0 || v44 || v49 )
        goto LABEL_82;
      j = (char *)Handle;
    }
