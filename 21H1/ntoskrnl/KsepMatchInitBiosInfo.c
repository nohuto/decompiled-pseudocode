/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140A6613C
 * Callers:
 ...
 *     KsepRegistryQueryMULTISZ @ 0x1407A96E0 (KsepRegistryQueryMULTISZ.c)
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  v12 = 0LL;
  KeyHandle = 0LL;
  xmmword_140C54130 = 0LL;
  qword_140C54160 = 0LL;
  v0 = -1;
  xmmword_140C54140 = 0LL;
  xmmword_140C54150 = 0LL;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_140C53EF0, 520LL, (__int64)&v12);
      word_140C540F6 = 0;
      v4 = 0LL;
      v5 = &unk_140C53EF0;
      while ( *v5 != 32 )
...
LABEL_11:
  ...
  if ( MULTISZ < 0 )
  {
    DWORD2(xmmword_140C54150) = -1;
    *(_QWORD *)&xmmword_140C54130 = 0LL;
  }
  else
  {
    *(_QWORD *)&xmmword_140C54130 = &unk_140C53EF0;
    DWORD2(xmmword_140C54150) = v0;
  }
