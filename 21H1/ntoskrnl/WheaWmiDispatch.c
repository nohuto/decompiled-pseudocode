/*
 * XREFs of WheaWmiDispatch @ 0x1403C8660
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiRegisterInfo @ 0x1403C86BC (WheapWmiRegisterInfo.c)
 *     WheapWmiExecuteMethod @ 0x1405B80E0 (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x1405B8308 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x1405B836C (WheapWmiGetSingleInstance.c)
 */
