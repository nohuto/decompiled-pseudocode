/*
 * XREFs of MiGetLargePagesForSystemMapping @ 0x1408C40F4
 * Callers:
 ...
 *     MiThreadIdealNode @ 0x1405420AC (MiThreadIdealNode.c)
...
__int64 __fastcall MiGetLargePagesForSystemMapping(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( v16 )
    v15 = 1LL;
  v18 = 0;
  v19 = (unsigned int *)(qword_140C4DDD8 + 4LL * v14 * (unsigned __int16)KeNumberNodes);
  v20 = &v19[v15];
  while ( 1 )
  {
