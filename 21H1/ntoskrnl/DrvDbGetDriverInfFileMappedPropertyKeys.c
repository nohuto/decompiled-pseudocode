/*
 * XREFs of DrvDbGetDriverInfFileMappedPropertyKeys @ 0x140979114
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(_DWORD *)a6 = 0;
  ...
  if ( CompositeMappedPropertyKeys >= 0 )
  {
    ...
    if ( a3 )
      goto LABEL_9;
    CompositeMappedPropertyKeys = DrvDbOpenDriverInfFileRegKey(a1, a2, v13, 0, (__int64)Handle, 0LL);
    if ( CompositeMappedPropertyKeys >= 0 )
    {
      a3 = Handle[0];
LABEL_9:
