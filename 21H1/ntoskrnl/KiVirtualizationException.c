/*
 * XREFs of KiVirtualizationException @ 0x140405800
 * Callers:
 *     KiVirtualizationExceptionShadow @ 0x140A11B40 (KiVirtualizationExceptionShadow.c)
 * Callees:
 *     KzRaiseIrql @ 0x140281580 (KzRaiseIrql.c)
...
__int64 __fastcall KiVirtualizationException(int a1, __int64 a2, int a3, int a4, char a5)
{
  ...
  *((_DWORD *)v9 + 17) = 0;
  ...
  while ( (KeGetCurrentThread()->ApcState.UserApcPendingAll & 3) != 0 )
  {
    __writecr8(1uLL);
    _enable();
    KiInitiateUserApc(1LL, v11, v12, v13);
    _disable();
    __writecr8(0LL);
  }
  ...
  if ( (v14->Header.LockNV & 0x8000000) != 0 )
    KiRestoreSetContextState((__int64)v14, v11, v12, (__int64)v13, NewIrql);
