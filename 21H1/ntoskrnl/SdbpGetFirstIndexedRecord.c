/*
 * XREFs of SdbpGetFirstIndexedRecord @ 0x14074277C
 * Callers:
 ...
 *     SdbpBinarySearchFirst @ 0x1407431A0 (SdbpBinarySearchFirst.c)
 *     SdbpBinarySearchUnique @ 0x140769C08 (SdbpBinarySearchUnique.c)
 */
