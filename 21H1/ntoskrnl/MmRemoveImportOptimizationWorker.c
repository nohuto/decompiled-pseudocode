/*
 * XREFs of MmRemoveImportOptimizationWorker @ 0x14053ECF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeIsNmiCallbackRegistered @ 0x14050E780 (KeIsNmiCallbackRegistered.c)
 */
        ...
        _DWORD *SchedulerAssist)
{
  ...
  else
  {
    *(_DWORD *)Argument = v10 | *(_DWORD *)(Argument + 4);
    v28 = *(_QWORD *)(v7 + 24);
    v11 = 8 * ((KiSpeculationFeatures & 0x2000000) == 0);
