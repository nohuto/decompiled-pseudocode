/*
 * XREFs of XmEmulateInterrupt @ 0x140392F3C
 * Callers:
...
__int64 __fastcall XmEmulateInterrupt(unsigned __int8 a1, __int64 a2)
{
  ...
  if ( !XmEmulatorInitialized )
    return 4LL;
  XmStatus = 0;
  word_140CED35C = dword_140CED4C0;
  dword_140CED348 = HIWORD(dword_140CED4C0);
  v4 = x86BiosTranslateAddress((unsigned __int16)dword_140CED4C0, HIWORD(dword_140CED4C0));
  *(_WORD *)(v4 - 6) = -1;
  *(_DWORD *)(v4 - 4) = 0xFFFF;
  LOWORD(dword_140CED348) = dword_140CED348 - 6;
