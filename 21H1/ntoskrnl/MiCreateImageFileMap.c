/*
 * XREFs of MiCreateImageFileMap @ 0x1406415A4
 * Callers:
 ...
 *     PsIsCurrentThreadPrefetching @ 0x1402F6E10 (PsIsCurrentThreadPrefetching.c)
        ...
        __int128 *a8)
{
  ...
  ULONG_PTR Next; // [rsp+F0h] [rbp-10h]
  ...
  if ( result >= 0 )
  {
    ...
    if ( (a4 & 0x10000) != 0 )
      goto LABEL_15;
    if ( (unsigned int)MiCopyHeaderIfResident((__int64)FileObject, Next) == 1 )
    {
      v19 = 4096LL;
      *((_QWORD *)&v92 + 1) = 4096LL;
    }
...
LABEL_172:
        ...
        *(_WORD *)(v14 + 60) ^= (*(_WORD *)(v14 + 60) ^ *(_WORD *)a2) & 0x3FF;
        ...
        if ( v42 == 1 )
        {
          MiInitializeImageHeaderPage(Next, *(unsigned int *)(v86 + 24), v41, v45);
          v51 = 1LL;
        }
        if ( *(_WORD *)(v86 + 48) == 267 )
          *(_BYTE *)(v80 + 14) |= 0x40u;
