/*
 * XREFs of PopEndMirroring @ 0x140991AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopEndMirroring(ULONG_PTR BugCheckParameter3)
{
  ...
  if ( !(_DWORD)v1 )
  {
    ...
    v2 = PopBuildMemoryImageHeader((PVOID)qword_140C23440);
    if ( v2 >= 0 )
    {
      ...
      *(_DWORD *)&Affinity.Group = (unsigned __int16)((unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6);
      ...
      dword_140C505D0 = KeNumberProcessors_0;
      HIDWORD(qword_140C505D8) = KeNumberProcessors_0;
      LODWORD(qword_140C505D8) = 1;
      if ( ((unsigned __int8)&stru_140C505E0 & 0xF) != 0 )
        RtlRaiseStatus(-2147483646);
      stru_140C505E0 = 0LL;
      KeInitializeDpc(&Dpc, (PKDEFERRED_ROUTINE)PopInvokeStateHandlerTargetProcessor, &PopHibernateSystemContext);
      v13[1] = (unsigned __int16 *)qword_140CFC838[0];
  ...
  v2 = *(_DWORD *)(qword_140C23440 + 188);
  if ( v2 < 0 || (v2 = PopInvokeSystemStateHandler(PopHibernatePowerStateHandlerType, qword_140C23440), v2 < 0) )
  {
LABEL_24:
    ...
    if ( qword_140C23440 )
    {
      ...
      v9 = *(_QWORD *)(qword_140C23440 + 168);
      if ( v9 )
        IoAddTriageDumpDataBlock(v9, (PVOID)0x178);
      v10 = *(_QWORD *)(qword_140C23440 + 200);
      if ( v10 )
