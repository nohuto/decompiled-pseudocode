/*
 * XREFs of MiCreateInitialLargeLeafPfns @ 0x1403EF3C4
 * Callers:
...
char __fastcall MiCreateInitialLargeLeafPfns(__int64 a1, __int64 a2, int a3, char a4, unsigned __int16 a5, int a6)
{
  ...
  v6 = (__m128i)xmmword_140C4E4C0;
  v8 = a1;
  v9 = (__m128i)xmmword_140C4E4D0;
  v19 = (__m128i)xmmword_140C4E4E0;
  v10 = _mm_srli_si128((__m128i)xmmword_140C4E4E0, 8).m128i_u64[0];
  v11 = MiLargePageSizes[a3];
  v19.m128i_i64[1] = (v10 ^ ((unsigned __int64)a5 << 39)) & 0x1FF8000000000LL ^ v10;
  v18 = xmmword_140C4E4D0;
