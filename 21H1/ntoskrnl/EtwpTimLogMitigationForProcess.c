/*
 * XREFs of EtwpTimLogMitigationForProcess @ 0x140937DA4
 * Callers:
 *     MiAllowImageMap @ 0x140636DF0 (MiAllowImageMap.c)
 *     EtwTimLogProhibitDynamicCode @ 0x1409374D8 (EtwTimLogProhibitDynamicCode.c)
 *     EtwTimLogProhibitWin32kSystemCalls @ 0x140937B90 (EtwTimLogProhibitWin32kSystemCalls.c)
 * Callees:
 ...
 *     EtwpTiFillProcessIdentity @ 0x1403577E0 (EtwpTiFillProcessIdentity.c)
 *     EtwpTiFillThreadIdentity @ 0x140357A64 (EtwpTiFillThreadIdentity.c)
...
void __fastcall EtwpTimLogMitigationForProcess(int a1, int a2, const EVENT_DESCRIPTOR *a3, __int64 a4)
{
  ...
  *(_QWORD *)&UserData.Size = 2LL;
  ...
  if ( (unsigned int)dword_140C02BB0 > 5 && tlgKeywordOn((__int64)&dword_140C02BB0, 0x200000000000LL) )
  {
    ...
    v39[1] = 0;
    v41 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BB0, (unsigned __int8 *)word_14002C412, 0LL, 0LL, 9u, &v27);
  }
  if ( v19 )
