/*
 * XREFs of PfSnGetCompletedTrace @ 0x1406DA95C
 * Callers:
...
__int64 __fastcall PfSnGetCompletedTrace(void *a1, SIZE_T Length, unsigned int *a3)
{
  ...
  dword_140C503E4 = 2;
  v7 = (unsigned int *)qword_140C50398;
  ...
  else
  {
    ...
    {
      v9 = *(_QWORD *)qword_140C50398;
      if ( *((PVOID **)qword_140C50398 + 1) != &qword_140C50398 || *(PVOID *)(v9 + 8) != qword_140C50398 )
        __fastfail(3u);
      qword_140C50398 = *(PVOID *)qword_140C50398;
      *(_QWORD *)(v9 + 8) = &qword_140C50398;
      --dword_140C503E0;
