/*
 * XREFs of HalpDmaAcquireBufferMappings @ 0x1404C1248
 * Callers:
...
unsigned __int64 __fastcall HalpDmaAcquireBufferMappings(__int64 a1, _QWORD *a2, unsigned int a3, __int64 a4)
{
  ...
  v12 = *(struct _MDL **)(qword_140C53E20 + 8 * Number);
  v13 = 0;
  v14 = v12 + 1;
  if ( (_DWORD)v5 )
  {
  ...
  v17 = 1;
  v12->ByteOffset = 0;
  v18 = byte_140C53E18 == 0;
  v12->ByteCount = v13 << 12;
  if ( !v18 )
  {
    v16 = *(PSLIST_ENTRY *)(qword_140C53E28 + 8 * v11);
    goto LABEL_32;
  }
  v19 = RtlpInterlockedPopEntrySList(&stru_140CF6420);
  if ( v19 )
  {
...
LABEL_32:
  ...
  if ( !result )
  {
    ...
    LockHandle.LockQueue.Lock = (unsigned __int64 *volatile)&qword_140CF2510;
    KxAcquireQueuedSpinLock((__int64)&LockHandle, &qword_140CF2510);
    v23 = 1;
    v24 = *(_DWORD *)(*(_QWORD *)qword_140C53E28 + 24LL);
    if ( (unsigned int)dword_140CF6438 > 1 )
    {
      v25 = (__int64 *)(qword_140C53E28 + 8);
      do
      {
        v26 = *v25;
        v27 = v24;
      ...
      while ( v23 < dword_140CF6438 );
    }
    KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
    v16 = *(PSLIST_ENTRY *)(qword_140C53E28 + 8LL * (unsigned int)v16);
    goto LABEL_31;
  }
  v17 = 0;
LABEL_16:
