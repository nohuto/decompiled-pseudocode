/*
 * XREFs of IopInitializeDeviceInstanceKey @ 0x140737704
 * Callers:
...
LABEL_6:
  ...
  if ( DeviceInstancePath >= 0 )
  {
    ...
    *(_DWORD *)(v12[39] + 32LL) |= 0x10u;
    if ( (unsigned int)PipAllocateDeviceNode(v12, &v31) == -1073740946 || (v13 = v31) == 0LL )
    {
      IoDeleteDevice(v11);
      DeviceInstancePath = -1073741670;
    }
...
LABEL_19:
              ...
              PnpClearDeviceTemporaryProperties(v13[6], KeyHandle);
