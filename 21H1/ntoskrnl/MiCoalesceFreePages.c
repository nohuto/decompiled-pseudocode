/*
 * XREFs of MiCoalesceFreePages @ 0x140297E40
 * Callers:
...
__int64 __fastcall MiCoalesceFreePages(__int64 a1)
{
  ...
  v4 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v1 + 40) >> 39) & 0x3FFLL));
  v57 = v4;
  ...
  if ( dword_140C4DDC4 > (unsigned int)dword_140C4DDC8
    || (v11 = (char *)qword_140C4DE08 + 16 * dword_140C4DDC4, v10 < *(_QWORD *)v11)
    || dword_140C4DDC4 != dword_140C4DDC8 && v10 >= *((_QWORD *)v11 + 2) )
  {
    v12 = 0;
...
LABEL_101:
    ...
    {
      v13 = (v12 + v9) >> 1;
      v11 = (char *)qword_140C4DE08 + 16 * v13;
      if ( v10 >= *(_QWORD *)v11 )
      {
        if ( v13 == dword_140C4DDC8 || v10 < *((_QWORD *)v11 + 2) )
        {
          dword_140C4DDC4 = (v12 + v9) >> 1;
          break;
        }
        v12 = v13 + 1;
      }
  ...
  if ( v5 != v7 )
  {
    ...
    do
    {
      ...
      if ( ((*v15 >> 50) & 1) == 0 )
        return 0LL;
      v16 = *(_QWORD *)(v14 + 6);
      if ( *(_QWORD *)(qword_140C4E588 + 8 * ((v16 >> 39) & 0x3FF)) != v4
        || (*(_BYTE *)v14 & 7u) > 1
  ...
  while ( 1 )
  {
    ...
    if ( v17 > 0xFFFFFFFFFLL
      || ((*v21 >> 50) & 1) == 0
      || *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v20 + 40) >> 39) & 0x3FFLL)) != v57
      || (*(_BYTE *)(v20 + 34) & 7u) > 1
    ...
    if ( (*(_BYTE *)(v20 + 34) & 7u) > 1 )
      goto LABEL_72;
    v23 = *(_QWORD *)(v20 + 40);
    if ( *(_QWORD *)(qword_140C4E588 + 8 * ((v23 >> 39) & 0x3FF)) != v57
      || (*(_BYTE *)(v20 + 35) & 0x40) != 0
