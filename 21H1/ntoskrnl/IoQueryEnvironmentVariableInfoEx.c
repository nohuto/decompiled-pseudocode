/*
 * XREFs of IoQueryEnvironmentVariableInfoEx @ 0x140895634
 * Callers:
...
__int64 __fastcall IoQueryEnvironmentVariableInfoEx(unsigned int a1, PDEVICE_OBJECT *a2, __int64 *a3, __int64 *a4)
{
  ...
  if ( (unsigned int)dword_140C04490 > 5 && tlgKeywordOn((__int64)&dword_140C04490, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04490, (unsigned __int8 *)byte_140023CF9, 0LL, 0LL, 7u, &v15);
  }
