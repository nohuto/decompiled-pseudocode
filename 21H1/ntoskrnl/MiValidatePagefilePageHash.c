/*
 * XREFs of MiValidatePagefilePageHash @ 0x140557C2C
 * Callers:
...
LABEL_20:
    ...
    v16 = MiComputePageHash(48 * v12 - 0x58000000000LL, v10, a3, SchedulerAssist);
    v17 = v31;
    v18 = v16;
    if ( !v31 )
    {
      v17 = *(_QWORD *)(*(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v14 + 40) >> 39) & 0x3FFLL))
