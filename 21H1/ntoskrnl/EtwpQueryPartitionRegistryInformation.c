/*
 * XREFs of EtwpQueryPartitionRegistryInformation @ 0x1403BC388
 * Callers:
 *     EtwpContainerResumeWnfCallback @ 0x1405A4B10 (EtwpContainerResumeWnfCallback.c)
 *     EtwInitializeSiloState @ 0x14079FC30 (EtwInitializeSiloState.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x140206450 (RtlInitUnicodeString.c)
 *     StringToGuidNoBrackets @ 0x1403BC5C8 (StringToGuidNoBrackets.c)
