/*
 * XREFs of CmCheckRegistry @ 0x140689A00
 * Callers:
  ...
  *(_QWORD *)&BitMapHeader.SizeOfBitMap = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( v13 == -2147483606 )
    {
      v8 = 1;
LABEL_15:
      v13 = CmpCheckRegistry2(a1, v24, *(_DWORD *)(*(_QWORD *)(a1 + 64) + 36LL), v14, 0, p_BitMapHeader, a3, &v18);
      v3 = v13;
      if ( v13 >= 0 )
        goto LABEL_16;
      if ( v13 == -2147483606 )
...
LABEL_25:
  ...
  v16 = -1073741492;
LABEL_33:
  SetFailureLocation(a3, 0, 11, v16, v17);
LABEL_17:
  if ( v6 )
