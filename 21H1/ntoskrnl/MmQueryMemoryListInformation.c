/*
 * XREFs of MmQueryMemoryListInformation @ 0x1402BCDA0
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  *a5 = 0;
  ...
  if ( BugCheckParameter2 )
  {
    ...
    {
      v9 = *(ULONG_PTR **)(qword_140C4E588 + 8LL * KeGetCurrentThread()->ApcState.Process[1].IdealProcessorPadding[5]);
    }
    else
    {
...
LABEL_57:
  ...
  if ( !(unsigned __int8)PsReferencePartitionSafe(BugCheckParameter2, v8, 0LL) )
    return 3221226656LL;
  v34 = 1;
LABEL_7:
  v10 = v9[866];
  ...
  *a5 = 176;
  if ( v34 )
    PsDereferencePartition(v35[22], v8, v12);
  return 0LL;
}
