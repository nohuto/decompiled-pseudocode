/*
 * XREFs of PspSetupUserProcessAddressSpace @ 0x1406F98FC
 * Callers:
 ...
 *     PspWow64SetupUserProcessAddressSpace @ 0x14033ACB0 (PspWow64SetupUserProcessAddressSpace.c)
...
__int64 __fastcall PspSetupUserProcessAddressSpace(__int64 a1, _KPROCESS *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v5 = &v24;
    result = PspGetStandardHandleList(a1, (__int64)&v24);
    if ( (int)result < 0 )
      return result;
  }
  v12 = v8[2];
      ...
      if ( inited >= 0 )
      {
        ...
        if ( inited >= 0 )
        {
          ...
          if ( inited >= 0 )
          {
            ...
            if ( inited >= 0 )
            {
              PspWritePebAffinityInfo((__int64)CurrentThread, (__int64)a2, v17, v18);
  ...
  KiUnstackDetachProcess(a3, 0LL, v17, v18);
