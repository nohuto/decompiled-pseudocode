/*
 * XREFs of KiCancelTimer @ 0x140266F50
 * Callers:
 ...
 *     KeCancelTimerInternal @ 0x140318814 (KeCancelTimerInternal.c)
...
LABEL_22:
            if ( *(_DWORD *)(v15 + v11 + 28) == -1 && *(_DWORD *)(v17 + v11 + 28) == -1 )
            {
              ...
              _interlockedbittestandreset64(
                (volatile signed __int32 *)(qword_140CFD748[2 * *(unsigned __int8 *)(v11 - 14448)] + v27),
                v26);
            }
