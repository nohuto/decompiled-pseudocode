/*
 * XREFs of VfInitVerifierComponents @ 0x1409C3E50
 * Callers:
 ...
 *     VfAvlInitializeTree @ 0x14059CA2C (VfAvlInitializeTree.c)
 ...
 *     VfMajorRegisterHandlers @ 0x1409D4AEC (VfMajorRegisterHandlers.c)
