/*
 * XREFs of _RegRtlOpenKeyTransacted @ 0x140617E68
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( a6 )
  {
    ...
    if ( inited == -1073741702 )
    {
      if ( byte_140CFA071 )
      {
        v14 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, HANDLE))qword_140CFA088;
      }
      else
      {
        v14 = ZwOpenKeyTransacted;
        byte_140CFA071 = 1;
        qword_140CFA088 = (__int64)ZwOpenKeyTransacted;
      }
      if ( !v14
