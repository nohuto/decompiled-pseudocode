/*
 * XREFs of MiLockStealSystemVm @ 0x1402E96FC
 * Callers:
...
__int64 __fastcall MiLockStealSystemVm(__int64 a1, unsigned __int8 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  v52 = a3;
  v6 = a2;
  v7 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL));
  v53 = v7;
  v8 = (__int64)(a3 << 25) >> 16;
...
LABEL_58:
    ...
    if ( ((unsigned int)(*(_DWORD *)(a4 + 48) - 2) <= 1
      ...
      && *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL)) == v53
      && !(unsigned int)MI_PFN_IS_PROTO(a1, v53, 1LL) )
    {
