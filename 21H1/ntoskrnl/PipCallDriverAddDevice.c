/*
 * XREFs of PipCallDriverAddDevice @ 0x140727018
 * Callers:
 ...
 *     IovUtilMarkStack @ 0x14036AF24 (IovUtilMarkStack.c)
 ...
 *     PiDmaGuardProcessPreAddDevice @ 0x140723C34 (PiDmaGuardProcessPreAddDevice.c)
 ...
 *     PipDmgEnforceEnumerationPolicy @ 0x1408ACFC4 (PipDmgEnforceEnumerationPolicy.c)
...
__int64 __fastcall PipCallDriverAddDevice(__int64 BugCheckParameter2, __int64 a2)
{
  ...
  *(_BYTE *)(BugCheckParameter2 + 688) = 0;
     ...
     || !v55) )
  {
    v39 = 53LL;
LABEL_120:
    PnpRequestDeviceRemoval(BugCheckParameter2, 0LL, v39, 0LL);
LABEL_112:
    v9 = -1073741106;
    goto LABEL_29;
  }
...
LABEL_65:
    ...
    v38 = 50LL;
LABEL_111:
    PnpRequestDeviceRemoval(BugCheckParameter2, 0LL, v38, v37);
    v7 = v61;
    goto LABEL_112;
  }
LABEL_29:
