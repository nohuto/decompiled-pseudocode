/*
 * XREFs of CmpFlushHive @ 0x140664FA8
 * Callers:
 ...
 *     HvUnCOWReconciledPages @ 0x1402E2188 (HvUnCOWReconciledPages.c)
...
__int64 __fastcall CmpFlushHive(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  ...
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_140022215,
      0LL,
      0LL,
      7u,
      UserData);
...
LABEL_119:
  ...
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C02130,
      (unsigned __int8 *)word_1400221CA,
      0LL,
      0LL,
      4u,
      UserData);
...
LABEL_71:
  ...
  if ( (unsigned int)dword_140C02130 > 4 )
  {
    *(_DWORD *)&EventDescriptor_8.Id = valid;
    ...
    v59 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)word_140022152, 0LL, 0LL, 3u, &v55);
  }
