/*
 * XREFs of KiSystemCall64 @ 0x1404072C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiConvertToGuiThread @ 0x1403F9AE0 (KiConvertToGuiThread.c)
        ...
        __int64 a49)
{
  ...
  _DWORD *v102; // [rsp+40h] [rbp-1A8h]
  __int64 (__fastcall *v103)(void *, __int64, __int64, _DWORD *); // [rsp+48h] [rbp-1A0h]
  ...
  else
  {
    if ( (a2 & 2) != 0 && (KeGetPcr()->Prcb.BpbFeatures & 4) == 0 )
    {
      ...
      v126 = 0x1404074D5LL;
      v125 = 0x1404074CCLL;
      *((_QWORD *)&v124 + 1) = 0x1404074C3LL;
      *(_QWORD *)&v124 = 0x1404074BALL;
      *((_QWORD *)&v123 + 1) = 0x1404074B1LL;
      *(_QWORD *)&v123 = 0x1404074A8LL;
      *((_QWORD *)&v122 + 1) = 0x14040749FLL;
      *(_QWORD *)&v122 = 0x140407496LL;
      *((_QWORD *)&v121 + 1) = 0x14040748DLL;
      *(_QWORD *)&v121 = 0x140407484LL;
      *((_QWORD *)&v120 + 1) = 0x14040747BLL;
      *(_QWORD *)&v120 = 0x140407472LL;
      *((_QWORD *)&v119 + 1) = 0x140407469LL;
      *(_QWORD *)&v119 = 0x140407460LL;
      v118 = 0x140407457LL;
      v117 = 0x14040744ELL;
      v116 = 0x140407445LL;
      v115 = 0x14040743CLL;
    ...
    do
    {
      ...
      if ( (unsigned int)v72 < *(_DWORD *)((char *)v73 + v71 + 16) )
      {
        ...
        if ( (KiDynamicTraceMask & 1) != 0 )
        {
          ...
          v101 = a3;
          v102 = a4;
          v103 = (__int64 (__fastcall *)(void *, __int64, __int64, _DWORD *))v77;
  ...
  if ( (CurrentThread->Header.Reserved1 & 4) != 0 )
  {
    ...
    if ( !(v82->WaitBlock[3].SpareLong | (unsigned __int8)(v82->ApcStateIndex | KeGetCurrentIrql())) )
    {
      ...
      while ( (KeGetCurrentThread()->ApcState.UserApcPendingAll & 3) != 0 )
      {
        __writecr8(1uLL);
        _enable();
        KiInitiateUserApc(1LL, v64, a3, a4);
        __writecr8(0LL);
        _disable();
      }
      ...
      if ( (v89->Header.LockNV & 0x8000000) != 0 )
        KiRestoreSetContextState((__int64)v89, v64, a3, (__int64)a4, v109);
...
KiSystemServiceExit:
  ...
  if ( (v83->Header.LockNV & 0x8000000) != 0 )
  {
    ...
    v123 = 0LL;
    v124 = 0LL;
    result = KiRestoreSetContextState((__int64)v83, v64, a3, (__int64)a4, v109);
  }
