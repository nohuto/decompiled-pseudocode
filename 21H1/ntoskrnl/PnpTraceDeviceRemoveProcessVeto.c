/*
 * XREFs of PnpTraceDeviceRemoveProcessVeto @ 0x1408AD5F4
 * Callers:
...
void PnpTraceDeviceRemoveProcessVeto()
{
  ...
  if ( (unsigned int)dword_140C02D80 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02D80, 0x400000000000LL) )
    {
      ...
      v13 = 2LL;
      v15[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02D80, (unsigned __int8 *)byte_140024451, 0LL, 0LL, 8u, &v3);
    }
  }
}
