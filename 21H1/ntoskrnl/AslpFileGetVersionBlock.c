/*
 * XREFs of AslpFileGetVersionBlock @ 0x14079AF08
 * Callers:
 ...
 *     VerSetConditionMask @ 0x14037C830 (VerSetConditionMask.c)
  ...
  if ( !v6 )
  {
    ...
    if ( v9 < 0 )
    {
      ...
      *(_QWORD *)&v28 = v19;
      ...
      v8 = *((_QWORD *)&v29 + 1);
      v7 = LdrResSearchResource(*((__int64 *)&v29 + 1), v27, 3u, 0, &Src, (__int64 *)&Size, 0LL, 0LL);
