/*
 * XREFs of MiDecrementSubsectionViewCount @ 0x1402A33A0
 * Callers:
...
__int64 __fastcall MiDecrementSubsectionViewCount(__int64 *BugCheckParameter2, char a2)
{
  ...
  if ( (a2 & 4) == 0 && (a2 & 8) != 0 && !MiControlAreaExemptFromCrossPartitionCharges(*BugCheckParameter2) )
  {
    ...
    else
    {
      ...
      v9 = (v7 & 0x100) != 0
         ? *(ULONG_PTR **)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(Process[1].AffinityPadding[5] + 430))
         : *(ULONG_PTR **)(qword_140C4E588 + 8LL * Process[1].IdealProcessorPadding[5]);
    }
    if ( v9 != *(ULONG_PTR **)(qword_140C4E588 + 8LL * (*(_WORD *)(v2 + 60) & 0x3FF)) )
    {
