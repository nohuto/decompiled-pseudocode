/*
 * XREFs of ?StDmCombineRegion@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x1402C53BC
 * Callers:
  ...
  **(_DWORD **)(a1 + 760) = v5;
  ...
  while ( 1 )
  {
    ...
    if ( (v10[1] & 0xFFFFF000) <= 0x1000
      && (unsigned int)((__int64 (__fastcall *)(__int64, _QWORD *, __int64 *, _DWORD *))ST_STORE<SM_TRAITS>::StDmCombineBufferAddEntry)(
                         a1,
                         v2,
                         &v13,
                         v10) == -2147483643 )
    {
      result = ST_STORE<SM_TRAITS>::StDmCombineBufferProcess(a1, (__int64 *)&PoolWithTag);
      if ( (int)result < 0 )
        goto LABEL_26;
      v12 = *(_DWORD *)(a1 + 120);
      if ( (v12 & 1) == 0 )
