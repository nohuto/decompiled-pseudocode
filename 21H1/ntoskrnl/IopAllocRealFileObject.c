/*
 * XREFs of IopAllocRealFileObject @ 0x140600890
 * Callers:
...
LABEL_56:
  ...
  v20 = ObpCaptureObjectCreateInformation(0, v19, (__int64)v50, &v49, (__int64)v16, 0);
  if ( v20 < 0 )
  {
  ...
  *((_DWORD *)&v16[1].Next + 2) = v21;
  v20 = ObpAllocateObject((int *)v16, v18, (__int64)v10, &v49, 216, &v48, &v56);
  if ( v20 < 0 )
  {
LABEL_65:
    if ( *((_QWORD *)&v49 + 1) )
...
LABEL_9:
  ...
  else
  {
    ...
    else
    {
      v37 = v26;
      v28 = a2;
      TransactionParameters = IopAllocateFoExtensionsOnCreate((_DWORD)v15, a2, v24, v37, v25);
    }
