/*
 * XREFs of RtlpSetSecurityObject @ 0x140614910
 * Callers:
 ...
 *     SeSetSecurityDescriptorInfoEx @ 0x1406DEAF0 (SeSetSecurityDescriptorInfoEx.c)
 * Callees:
        ...
        __int64 *a8)
{
  ...
  unsigned __int8 *v110; // [rsp+80h] [rbp-88h]
  ...
  unsigned __int8 *v130; // [rsp+118h] [rbp+10h]
  int v131; // [rsp+120h] [rbp+18h] BYREF
...
LABEL_191:
  ...
  if ( (a2 & 0x10) != 0 )
  {
    ...
    do
    {
      AceByType = RtlFindAceByType((__int64)Src, 17, (unsigned int *)&v94);
      v52 = AceByType;
      if ( AceByType )
      {
        v73 = AceByType[1];
...
LABEL_192:
  ...
  TokenTrustLevel = SepLocateTokenTrustLevel(v124);
        ...
        if ( PoolWithTag )
        {
          ...
          *((_WORD *)v37 + 1) = v41;
          ...
          if ( Src )
          {
            ...
            RtlpApplyAclToObject((__int64)(v37 + 5), (_DWORD *)v118);
          ...
          if ( v30 )
          {
            ...
            RtlpApplyAclToObject((__int64)v38, (_DWORD *)v118);
          ...
          *(_WORD *)&PoolType.Value[4] = 768;
          ...
          if ( valid >= 0 )
          {
            ...
            while ( 1 )
            {
              ...
              AceBySid = RtlFindAceBySid(v71, &Sid, (unsigned int *)&v94);
              if ( !AceBySid )
                break;
...
LABEL_65:
  ...
  if ( TokenTrustLevel )
  {
    ...
    while ( 1 )
    {
      v78 = RtlFindAceByType((__int64)Src, 20, (unsigned int *)&v94);
      v111 = v78;
      if ( v78 )
      {
        if ( (v78[1] & 0xFF000000) != 0 )
          goto LABEL_192;
        if ( !RtlpValidTrustSubjectContext(TokenTrustLevel, (__int64)(v78 + 2), v79, &v131) )
          break;
        v78 = v111;
      }
      ++v94;
