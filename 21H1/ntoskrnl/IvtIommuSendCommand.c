/*
 * XREFs of IvtIommuSendCommand @ 0x1404DB380
 * Callers:
 *     IvtFlushTbInternal @ 0x1404DA5F4 (IvtFlushTbInternal.c)
 *     IvtInvalidateAllContextEntries @ 0x1404DB1B0 (IvtInvalidateAllContextEntries.c)
 *     IvtInvalidateContextEntry @ 0x1404DB1F0 (IvtInvalidateContextEntry.c)
 *     IvtInvalidateExtendedContextEntry @ 0x1404DB24C (IvtInvalidateExtendedContextEntry.c)
 *     IvtInvalidateRemappingTableEntries @ 0x1404DB30C (IvtInvalidateRemappingTableEntries.c)
...
__int64 __fastcall IvtIommuSendCommand(_QWORD *a1, _QWORD *a2, int a3)
{
  ...
  if ( v12 == ((*(_QWORD *)(v7 + 128) >> 4) & 0x7FFFLL) )
  {
    do
    {
      if ( (++v11 & dword_140C4A35C) != 0 || !qword_140C4A360 )
        _mm_pause();
      else
        qword_140C4A360(v11, v10, v13);
    }
