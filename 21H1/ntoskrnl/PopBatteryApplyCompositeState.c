...
__int64 __fastcall PopBatteryApplyCompositeState(_DWORD *a1, int a2)
{
  ...
  if ( byte_140C236D8 )
  {
    ...
    v25 = 0LL;
    v6 = 0LL;
    while ( (__int64 *)v24 != &qword_140C236E0 )
    {
      v26 = *(_DWORD *)(v24 + 104);
      if ( v26 == 2 )
      {
    ...
    if ( PopCachedValidBatteryCount == -1 || PopCachedValidBatteryCount != dword_140C236D4 )
    {
      ...
      PopDiagTraceBatteryCountChange((unsigned int)dword_140C236D4, v6, v25, &qword_140C236E0);
    }
    v37 = 1;
  }
  ...
  do
  {
    ...
    if ( (unsigned __int8)PopBatteryCheckTrigger(v18) )
    {
      if ( PopBatteryCachedFlags[v15] != v17 )
      {
        ...
        v12 = v38;
        if ( dword_140C237EC[6 * v38] == 128 )
        {
          PopDiagTraceBatteryTriggerMet(0x140000000LL + 24LL * v38 + 12728296, (char *)PopPolicy + 24 * v38 + 96, &v38);
          v12 = v38;
        }
      }
      if ( !byte_140C237E0 )
  ...
  if ( dword_140C236D4 )
  {
    ...
    *((_QWORD *)&xmmword_140C238B0 + 1) = unk_140C23728;
    BYTE3(xmmword_140C238A0) = byte_140C23848 != 0 || (unk_140C23700 & 2) != 0;
  }
  PopAccountCbEnergyChange();
  PopReleaseRwLock((ULONG_PTR)&xmmword_140C23890);
  if ( v40 )
  {
    v39 = (dword_140C2384C + 500) / 0x3E8u;
    ...
    if ( dword_140C2384C == -1 )
      v32 = (MEMORY[0xFFFFF78000000008] - qword_140C23850 + 5000) / 0x2710uLL;
    if ( PopPlatformAoAc )
    {
