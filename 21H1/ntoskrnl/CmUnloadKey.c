/*
 * XREFs of CmUnloadKey @ 0x140659A98
 * Callers:
 *     NtUnloadKey @ 0x140656500 (NtUnloadKey.c)
 *     NtUnloadKeyEx @ 0x140659380 (NtUnloadKeyEx.c)
 *     NtUnloadKey2 @ 0x14075EF70 (NtUnloadKey2.c)
 * Callees:
  ...
  if ( SeSinglePrivilegeCheck(SeRestorePrivilege, PreviousMode) )
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v39 = &DestinationString;
      ...
      DWORD2(v43[1]) = 0;
      LODWORD(v43[0]) = 4;
      v21 = ObReferenceObjectByNameEx((__int64)&v38, v14, 0, (__int64)CmKeyObjectType, 0, (__int64)v43, &v27);
      if ( v21 == -1073741772 )
        v21 = -1073741811;
      v20 = v21;
      if ( v21 >= 0 )
      {
        ...
        *((_QWORD *)&v41[0] + 1) = DmaAdapter;
        v23 = CmpCallCallBacks(34, (int)v41, v22, 35, (__int64)v27, (__int64)v35);
        v20 = v23;
        if ( v23 >= 0 )
        {
          v9 = 1;
...
LABEL_36:
  if ( v9 )
    v20 = CmPostCallbackNotification(35, (__int64)v27, v20, (__int64)v41, v35);
  if ( DmaAdapter )
