/*
 * XREFs of KdPowerTransitionEx @ 0x14050B510
 * Callers:
 ...
 *     PpmCancelExitLatencyTrace @ 0x14055FBE0 (PpmCancelExitLatencyTrace.c)
 */
  ...
  if ( !KdPitchDebugger )
  {
    ...
    if ( (_BYTE)KdDebuggerEnabled || (a1 & 0x40000000) != 0 )
    {
      ...
      if ( v7 == 1 )
      {
        ...
        v3 = KdPower(v6 | 1, (char *)&KdDebuggerNotPresent + 5);
        if ( v10 >= 2u )
      ...
      {
        v3 = KdPower(v6 | 4, (char *)&KdDebuggerNotPresent + 5);
      }
      if ( a2 )
      {
