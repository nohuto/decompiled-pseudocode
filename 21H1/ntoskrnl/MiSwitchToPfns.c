/*
 * XREFs of MiSwitchToPfns @ 0x140A44AE0
 * Callers:
...
__int64 __fastcall MiSwitchToPfns(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  v30 = 0LL;
  v31 = 0LL;
  v5 = MmPfnDatabase + 48 * qword_140C52780;
  if ( !qword_140C52780 && !*(_WORD *)(v5 + 32) )
  {
    v20 = (unsigned __int8)MiLockPageInline(MmPfnDatabase + 48 * qword_140C52780, a2, a3, a4);
