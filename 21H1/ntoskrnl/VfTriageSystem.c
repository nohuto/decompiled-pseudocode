/*
 * XREFs of VfTriageSystem @ 0x140A6C1F4
 * Callers:
 *     ViInitSystemPhase0 @ 0x140A6BFC8 (ViInitSystemPhase0.c)
 * Callees:
 *     DbgPrintEx @ 0x14037C640 (DbgPrintEx.c)
 *     MmTriageActiveInLastCrash @ 0x140A9013C (MmTriageActiveInLastCrash.c)
 ...
 *     TriageGetBugcheckData @ 0x140A93A78 (TriageGetBugcheckData.c)
 */
...
__int64 __fastcall VfTriageSystem(__int64 a1)
{
  ...
  qword_140C1D020 = *(_QWORD *)&v12[32];
  xmmword_140C1D010 = *(_OWORD *)&v12[16];
  if ( v8 )
  {
