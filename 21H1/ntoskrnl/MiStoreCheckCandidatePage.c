/*
 * XREFs of MiStoreCheckCandidatePage @ 0x14034F880
 * Callers:
        ...
        __int64 *a5)
{
  ...
  v5 = 0;
  *(_QWORD *)&v23 = 0LL;
  v9 = (unsigned int)a2 | ((unsigned __int64)*(unsigned int *)(*(_QWORD *)(qword_140C4E588
                                                                         + 8
                                                                         * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 39) & 0x3FFLL))
                                                             + 1156LL) << 60);
  if ( (unsigned int)MI_PFN_IS_PROTO(BugCheckParameter2, a2, a3) )
  {
...
LABEL_22:
  ...
  if ( (unsigned int)MiGetSystemRegionType(v11) != 1
    ...
    && (v11 < qword_140C4FA78 || v11 > qword_140C4E2A8)
