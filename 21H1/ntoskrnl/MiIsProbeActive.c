/*
 * XREFs of MiIsProbeActive @ 0x1402F8260
 * Callers:
 *     MiReplaceRotateWithDemandZero @ 0x1402F7C80 (MiReplaceRotateWithDemandZero.c)
 *     MmIsIoSpaceActive @ 0x140531430 (MmIsIoSpaceActive.c)
...
__int64 __fastcall MiIsProbeActive(unsigned __int64 a1, __int64 a2, char a3)
{
  ...
  v4 = 0;
  v5 = 0;
  v8 = ExAcquireSpinLockShared(&dword_140C4EB80);
  v9 = (_QWORD *)xmmword_140C4EB88;
  v10 = v8;
  if ( (_QWORD)xmmword_140C4EB88 )
  {
    if ( (a3 & 1) != 0 )
    {
      v41 = 0LL;
      ...
      for ( i = a1 + 8 * a2; a1 < i; a1 += 8LL )
      {
        ...
        else
        {
          ...
          if ( v42 == -1LL || v42 != v36 )
          {
            ...
            if ( !v41 || v41[5] != v36 )
            {
              for ( j = (_QWORD *)xmmword_140C4EB88; ; j = (_QWORD *)j[1] )
              {
                while ( 1 )
                {
                  if ( !j )
