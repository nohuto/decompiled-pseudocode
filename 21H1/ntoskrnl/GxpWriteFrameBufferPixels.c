/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x140398A08
 * Callers:
 *     BgpGxDrawRectangle @ 0x140398978 (BgpGxDrawRectangle.c)
 * Callees:
 *     GxpAdjustRectangleToFrameBuffer @ 0x140398C34 (GxpAdjustRectangleToFrameBuffer.c)
 ...
 *     GxpGetRotatedPixelOffset @ 0x1405BE948 (GxpGetRotatedPixelOffset.c)
...
LABEL_45:
            ...
            while ( 1 )
            {
              ...
              if ( RotatedPixelOffset < 0 )
                goto LABEL_19;
              memmove((char *)qword_140C13280 + v9 * v29, v27, v9);
              ++v4;
              v27 += v9;
              LODWORD(v28) = v4;
              if ( v4 >= *(_DWORD *)(v3 + 4) )
...
LABEL_19:
    ...
    v41[1] = *(_DWORD *)(v3 + 4);
    v28 = 0LL;
    if ( (dword_140C132D0 & 8) == 0 )
    {
      v43 = *(_DWORD *)(v3 + 12);
      v44 = *(_QWORD *)(v3 + 24);
      v42 = xmmword_140C13270;
      goto LABEL_29;
    }
    ...
    if ( (int)result >= 0 )
    {
      ...
      v42 = 1;
LABEL_29:
      RotatedPixelOffset = ((__int64 (__fastcall *)(_DWORD *, _DWORD *, _QWORD))qword_140C13280)(v41, v2, 0LL);
      if ( v24 && v24 != v48 )
