/*
 * XREFs of MiKernelStackVaToStackNode @ 0x140388834
 * Callers:
...
_QWORD *__fastcall MiKernelStackVaToStackNode(unsigned __int64 a1)
{
  ...
  v2 = 0LL;
  v3 = ExAcquireSpinLockShared(&dword_140C4EB20);
  v4 = (_QWORD *)qword_140C4EB18;
  while ( v4 )
  {
    if ( a1 > v4[3] )
    {
  ...
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C4EB20);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
