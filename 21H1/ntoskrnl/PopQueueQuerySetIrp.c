/*
 * XREFs of PopQueueQuerySetIrp @ 0x140394E44
 * Callers:
...
LABEL_24:
  ...
  if ( v2 )
  {
    ...
    qword_140C23B98 = (__int64)&v3->Tail.Overlay.ListEntry;
  }
  v11 = v10[1];
  if ( v11 )
  {
