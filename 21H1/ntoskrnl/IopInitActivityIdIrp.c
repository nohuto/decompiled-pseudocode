/*
 * XREFs of IopInitActivityIdIrp @ 0x1404FB1F4
 * Callers:
...
LABEL_17:
    ...
    {
      v10 = 0;
      if ( KeGetPcr()->NtTib.$1CC13EA220102F7150542D4DBFF67C6A::$4027F68EF0E7CC3497C55FD2100A3F4B::Self )
      {
        v12 = *(__m128i *)&KeGetPcr()->NtTib.$1CC13EA220102F7150542D4DBFF67C6A::$4027F68EF0E7CC3497C55FD2100A3F4B::Self[105].SubSystemTib;
        v10 = 1;
      }
      if ( v10 )
      {
