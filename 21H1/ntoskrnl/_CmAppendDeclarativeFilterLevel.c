/*
 * XREFs of _CmAppendDeclarativeFilterLevel @ 0x140974CB0
 * Callers:
 *     _CmAppendDeclarativeDefaultFilters @ 0x140974BC8 (_CmAppendDeclarativeDefaultFilters.c)
  ...
  *a6 = 0;
             ...
             (PoolWithTag = ExAllocatePoolWithTag(PagedPool, 2LL * (unsigned int)(v21 + 1), 0x52504E50u)) != 0LL) )
  {
    if ( v22 )
    {
      ...
      {
        v21 = v11;
        v16 = PnpCtxRegEnumValue(v15, Handle, v6, PoolWithTag, (__int64)&v21, 0LL, 0LL, 0LL);
        v15 = 3221225507LL;
        if ( v16 == -1073741789 )
        {
          v8 = -1073741789;
