/*
 * XREFs of HalpApicInitializeLocalUnit @ 0x14039E5C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpApicDescribeLocalLines @ 0x1403A7844 (HalpApicDescribeLocalLines.c)
        ...
        unsigned int *a6)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    v11 = a4 | 0x10000;
    if ( (_DWORD)v10 )
      HalpApicWrite(v10, v11);
    v12 = *(unsigned int *)(a1 + 36);
    if ( (_DWORD)v12 )
      HalpApicWrite(v12, v11);
    ...
    HalpApicWrite(240LL, v13);
    HalpApicWrite(800LL, a4 | 0x30000u);
    HalpApicWrite(992LL, 11LL);
    HalpApicWrite(880LL, a5);
    HalpApicWrite(832LL, v11);
    v14 = ((__int64 (__fastcall *)(__int64))HalpApicRead)(848LL);
    v15 = v14;
    LODWORD(v15) = v14 | 0x10000;
    HalpApicWrite(848LL, v15);
    HalpApicWrite(848LL, v11);
    HalpApicWrite(864LL, a4 | 0x18400u);
