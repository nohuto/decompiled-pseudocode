 ...
 *     KeInitializeTimer @ 0x1402C26D0 (KeInitializeTimer.c)
 ...
 *     KiGetLoadOptions @ 0x140A703D8 (KiGetLoadOptions.c)
 */
          ...
          *(_QWORD *)&Dpc[2].Header.Lock = v43;
          ...
          if ( v7 >= 0x32 )
          {
            *(_QWORD *)&Dpc[2].Processor = 0LL;
            Dpc[3].Header.WaitListHead.Flink = (struct _LIST_ENTRY *)sub_1405C6010;
