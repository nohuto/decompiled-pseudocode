/*
 * XREFs of WheaAddErrorSourceDeviceDriver @ 0x140797260
 * Callers:
 *     WheaAddErrorSourceDeviceDriverV1 @ 0x1403B6A00 (WheaAddErrorSourceDeviceDriverV1.c)
 * Callees:
 *     WheapDeviceDriverGetPacketLength @ 0x1403B6DF0 (WheapDeviceDriverGetPacketLength.c)
