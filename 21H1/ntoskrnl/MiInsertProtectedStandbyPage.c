/*
 * XREFs of MiInsertProtectedStandbyPage @ 0x1402D9CF0
 * Callers:
...
__int64 __fastcall MiInsertProtectedStandbyPage(__int64 a1, __int64 a2)
{
  ...
  if ( (v4 & 0x2000000000000LL) != 0 || byte_140C51F5E && _bittest64((const signed __int64 *)qword_140C52488, v6 >> 9) )
  ...
  if ( (v7 & 0x40) != 0 )
    return MiPfnReferenceCountIsZero(a2, v6);
  v8 = *(_QWORD *)(qword_140C4E588 + 8 * ((v4 >> 39) & 0x3FF));
  if ( *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL)) != v8 || (v7 & 7u) >= 5 )
    return MiPfnReferenceCountIsZero(a2, v6);
  ...
  *(_BYTE *)(a2 + 35) |= 8u;
  v15 = MI_PFN_IS_PROTO(a2, v13, SchedulerAssist);
  v16 = 4352LL;
  if ( !v15 )
    v16 = 5056LL;
...
LABEL_30:
        ...
        KxAcquireQueuedSpinLock((__int64)&v31, (volatile __int64 *)(v8 + 4928));
        KeSetEvent(v19, 0, 0);
        ++v19[1].Header.LockNV;
  ...
  if ( (BYTE6(PerfGlobalGroupMask) & 1) == 0 )
  {
    ...
    if ( !LockHandle.LockQueue.Next )
    {
      ...
      if ( (struct _KLOCK_QUEUE_HANDLE *)result == &LockHandle )
        goto LABEL_46;
      result = KxWaitForLockChainValid(&LockHandle, v26);
    }
    LockHandle.LockQueue.Next = 0LL;
