/*
 * XREFs of MmGetControlAreaPartition @ 0x14027CB20
 * Callers:
...
ULONG_PTR __fastcall MmGetControlAreaPartition(__int64 a1, __int64 a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  else
  {
    ...
    if ( _interlockedbittestandset(&dword_140C4C8C0, 0x1Fu) )
    {
      ...
      v24 = ExpWaitForSpinLockExclusiveAndAcquire((unsigned __int64)&dword_140C4C8C0, CurrentIrql, a3, SchedulerAssist);
    }
    v8 = (unsigned int)dword_140C4C8C0;
    if ( (dword_140C4C8C0 & 0xBFFFFFFF) != 0x80000000 )
    {
      do
      {
        if ( (v8 & 0x40000000) == 0 )
        {
          v17 = _InterlockedCompareExchange(&dword_140C4C8C0, v8 | 0x40000000, v8);
          v16 = (_DWORD)v8 == v17;
          v8 = v17;
          if ( !v16 )
            continue;
  ...
  if ( *(_QWORD *)a1 )
    v9 = *(ULONG_PTR **)(qword_140C4E588 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
  else
