/*
 * XREFs of CmpDoAccessCheckOnLayeredSubtree @ 0x140715950
 * Callers:
        ...
        char a6)
{
  ...
  if ( (a6 & 1) == 0
    || (a1
      ? (v18 = CmpGetSecurityCacheEntryForKcbStack(a1, a2),
        ...
        v13 >= 0) )
  {
    ...
    if ( v15 >= 0 )
    {
      for ( i = CmpSubtreeEnumeratorAdvance(v25); i != -2147483622; i = CmpSubtreeEnumeratorAdvance(v25) )
      {
        ...
        if ( v23 )
        {
          SecurityCacheEntryForKcbStack = CmpGetSecurityCacheEntryForKcbStack(v23, a2);
