/*
 * XREFs of MiFlushControlArea @ 0x140523C94
 * Callers:
 ...
 *     MiRemoveWakeListEntry @ 0x140524DDC (MiRemoveWakeListEntry.c)
...
__int64 __fastcall MiFlushControlArea(char *P, unsigned __int8 a2, __int64 *a3, struct _FILE_OBJECT **a4)
{
  ...
  *(_QWORD *)(*(_QWORD *)(qword_140C4E588 + 8LL * (*((_WORD *)P + 30) & 0x3FF)) + 1688LL) = 0LL;
...
LABEL_34:
    ...
    v25 = *(_QWORD *)(qword_140C4E588 + 8LL * (*((_WORD *)P + 30) & 0x3FF));
