/*
 * XREFs of PopFxCreateEmergencyWorkerThread @ 0x1407B5830
 * Callers:
...
__int64 __fastcall PopFxCreateEmergencyWorkerThread(__int64 a1)
{
  ...
  v4 = 0LL;
  v7 = 0LL;
  v1 = PsCreateSystemThreadEx((__int64)&Handle, 0x1FFFFFu, &v3, 0LL, 0LL, (__int64)PopFxEmergencyWorker, a1, 0LL, 0LL);
  if ( v1 >= 0 )
    ZwClose(Handle);
