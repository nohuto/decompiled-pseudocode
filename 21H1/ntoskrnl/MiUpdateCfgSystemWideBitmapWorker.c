...
__int64 __fastcall MiUpdateCfgSystemWideBitmapWorker(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    v33[0] = v8 >> 12;
    PagefileSubsection = MiLocatePagefileSubsection((unsigned int *)(v12 + 128), v33);
    v14 = v34;
    if ( (unsigned int)MiChargeSegmentCommit(PagefileSubsection, *((_QWORD *)PagefileSubsection + 1) + 8 * v33[0]) )
    {
      v15 = v36;
      if ( v36 && (*v36 & 1) != 0 && v7 )
      {
