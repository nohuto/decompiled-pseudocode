/*
 * XREFs of EtwStartAutoLogger @ 0x1407A05CC
 * Callers:
 ...
 *     EtwpParsePoolTagFilter @ 0x14093B7D8 (EtwpParsePoolTagFilter.c)
    ...
    if ( PoolWithTag )
    {
      ...
      if ( v9 )
      {
        ...
        *(_DWORD *)(v7 + 176) = 1;
        ...
        LODWORD(v112[11]) = 4;
        v74 = 4;
        RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v112, 0LL);
        if ( RegistryValues < 0 )
          goto LABEL_10;
        if ( !a3 )
        {
...
LABEL_7:
          if ( !v13 )
          {
            if ( Handle )
            {
              v112[5] = &v51;
              memset(&v112[7], 0, 56);
              RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)Handle, (__int64)v112, 0LL);
              if ( RegistryValues < 0 )
                RegistryValues = 0;
            }
          }
            ...
            *((_QWORD *)&v61 + 1) = v7 + 1276;
            ...
            if ( RegistryValues >= 0 )
            {
              if ( Handle )
              {
                ...
                RtlpQueryRegistryValues(0x40000000, (const WCHAR *)Handle, (__int64)v112, 0LL);
                RegistryValues = 0;
              }
              v17 = 1LL;
              v18 = *(_DWORD *)(v7 + 112) | 2;
