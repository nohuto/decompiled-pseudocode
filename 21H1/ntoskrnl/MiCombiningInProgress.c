/*
 * XREFs of MiCombiningInProgress @ 0x140364068
 * Callers:
...
__int64 __fastcall MiCombiningInProgress(__int64 *a1, unsigned __int64 *a2, int a3)
{
  ...
  v3 = *a1;
  v7 = ExAcquireSpinLockExclusive(&dword_140C4E480);
  if ( a3 != 1 )
  {
    v14 = *a2;
    ...
    if ( *(unsigned __int64 **)(*a2 + 8) == a2 && *v15 == a2 )
    {
      ...
      *(_QWORD *)(v14 + 8) = v15;
      RtlAvlRemoveNode((unsigned __int64 *)&qword_140C4E488, a2 + 2);
      --*((_DWORD *)a1 + 16);
      if ( dword_140C4E484 == 1 )
...
LABEL_26:
  ...
  {
    dword_140C4E498 = 1;
    qword_140C4E490 = _InterlockedIncrement64(&PsNextSecurityDomain);
  }
...
LABEL_8:
  ...
  v11 = 1;
LABEL_19:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4E488, (unsigned __int64)v12, v11, a2 + 2);
LABEL_16:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C4E480);
