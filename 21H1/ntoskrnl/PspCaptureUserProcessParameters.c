/*
 * XREFs of PspCaptureUserProcessParameters @ 0x1406B6660
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x1406B6D1C (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x1406B6D90 (PspValidateEnvironmentBlock.c)
