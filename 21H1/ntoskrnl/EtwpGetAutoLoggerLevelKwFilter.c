/*
 * XREFs of EtwpGetAutoLoggerLevelKwFilter @ 0x1407B5418
 * Callers:
...
void __fastcall EtwpGetAutoLoggerLevelKwFilter(__int64 a1, __int64 a2, PVOID *a3)
{
  ...
  *a3 = v16;
  ...
  if ( v16 )
  {
    ...
    v28 = 4;
    v29 = v17 + 17;
    RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v30, 0LL);
    if ( RegistryValues >= 0 )
    {
      if ( Handle )
      {
        ...
        v30[19] = v30[5] + 16LL;
        v30[26] = v30[5] + 17LL;
        RtlpQueryRegistryValues(0x40000000, (const WCHAR *)Handle, (__int64)v30, 0LL);
      }
LABEL_10:
      if ( RegistryValues >= 0 )
        goto LABEL_13;
