 ...
 *     KdpGetContextEx @ 0x14050B848 (KdpGetContextEx.c)
 *     KdpSetContextEx @ 0x14050BA3C (KdpSetContextEx.c)
 *     KdpWriteCustomBreakpoint @ 0x14050BB74 (KdpWriteCustomBreakpoint.c)
  ...
  *(_OWORD *)BaseAddress = 0LL;
  ...
  while ( !(_BYTE)KdDebuggerNotPresent )
  {
    while ( 1 )
    {
      ...
      v7 = KdReceivePacket(2LL, v20, v16, &v17, (char *)&KdDebuggerNotPresent + 5);
      if ( v7 == 2 )
        break;
      if ( v7 != 1 )
      {
        switch ( (int)v38 )
        {
          ...
          case 12604:
            ...
            return 1LL;
          case 12605:
            KdpReadPhysicalMemory((__int64)&v38, (__int64)v16, v8, (__int64)&KdDebuggerNotPresent + 5);
            continue;
          case 12606:
