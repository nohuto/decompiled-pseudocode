/*
 * XREFs of MmMarkHiberPhase @ 0x1409AC94C
 * Callers:
...
__int64 MmMarkHiberPhase()
{
  ...
  PoSetHiberRange(0LL, 0x14000u, qword_140C4ED08, 1uLL, 0x61676D4Du);
  ...
  if ( MiIsRetpolineEnabled() )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      qword_140C4CBA0,
      8 * (((unsigned __int64)qword_140C4CB98 >> 6) + ((qword_140C4CB98 & 0x3F) != 0)),
      0x62706D4Du);
    PoSetHiberRange(0LL, 0x10000u, Base, (unsigned int)(dword_140C4CBC8 << 12), 0x62706D4Du);
  }
  MiMarkNonPagedHiberPhasePages(qword_140C4E188, qword_140C4E188 + qword_140C4E190 - 1, 0);
