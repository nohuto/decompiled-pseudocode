/*
 * XREFs of HvlAddSecurePagesCallbackRoutine @ 0x1404F2E70
 * Callers:
 *     HvlAddSecureHvPagesCallbackRoutine @ 0x1404F2E50 (HvlAddSecureHvPagesCallbackRoutine.c)
 *     HvlAddSecureSkPagesCallbackRoutine @ 0x1404F30A0 (HvlAddSecureSkPagesCallbackRoutine.c)
 * Callees:
 *     HvlpAddCrashdumpAreaPages @ 0x1404F35CC (HvlpAddCrashdumpAreaPages.c)
...
LABEL_5:
    ...
    xmmword_140C47570 = 0LL;
    xmmword_140C47580 = 0LL;
    result = HvlpStartSecurePageListIteration(1LL, v4, 0LL, 0LL, 0, &v14);
    if ( (int)result < 0 )
      return result;
    *((_QWORD *)&xmmword_140C47580 + 1) = v14;
  ...
  if ( (_BYTE)HvlpCrashdumpIterationState )
  {
      ...
      || (LOBYTE(v8) = 1, result = HvlpAddCrashdumpAreaPages(a4, v8), !(_BYTE)result) )
    {
      if ( BYTE2(HvlpCrashdumpIterationState) || (result = HvlpAddCrashdumpAreaPages(a4, 0LL), !(_BYTE)result) )
      {
        ...
        {
          while ( (_DWORD)xmmword_140C47580 )
          {
LABEL_22:
            *(_QWORD *)(a4 + 24) = (**((_QWORD **)&xmmword_140C47570 + 1) >> 40) + 1LL;
            result = 0xFFFFFFFFFFLL;
            *(_QWORD *)(a4 + 16) = **((_QWORD **)&xmmword_140C47570 + 1) & 0xFFFFFFFFFFLL;
            *((_QWORD *)&xmmword_140C47570 + 1) += 8LL;
            LODWORD(xmmword_140C47580) = xmmword_140C47580 - 1;
            if ( *(_QWORD *)(a4 + 24) )
            {
          ...
          while ( 1 )
          {
            ...
            if ( (int)VslGetSecurePageList(0LL, 0LL, 0LL, &v13) < 0 )
              break;
            LODWORD(xmmword_140C47580) = *(unsigned __int16 *)(*((_QWORD *)&xmmword_140C47580 + 1) + 8LL);
            *((_QWORD *)&xmmword_140C47570 + 1) = *((_QWORD *)&xmmword_140C47580 + 1) + 16LL;
            if ( (_DWORD)xmmword_140C47580 )
              goto LABEL_22;
          }
        }
        result = HvlpEndSecurePageListIteration(1LL, 0LL, 0LL);
