/*
 * XREFs of MiDemoteCombinedPte @ 0x140368610
 * Callers:
...
__int64 __fastcall MiDemoteCombinedPte(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v38 = *(_QWORD *)(qword_140C4E588 + 8 * v12);
  Process = 0LL;
  if ( (*(_BYTE *)(a1 + 184) & 7) == 0 )
  {
  ...
  if ( (v22 == 1 || v22 == 2 && (v11[2].m128i_i8[2] & 8) != 0)
    && *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(a1 + 174)) == v38
    && _InterlockedCompareExchange64((volatile signed __int64 *)(v10 + 32), 0LL, 1LL) == 1 )
  {
    ...
    MiLockAndDecrementShareCount(48 * v36 - 0x58000000000LL, 0LL, SchedulerAssist, CurrentPrcb);
