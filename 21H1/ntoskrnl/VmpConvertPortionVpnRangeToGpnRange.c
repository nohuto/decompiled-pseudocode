/*
 * XREFs of VmpConvertPortionVpnRangeToGpnRange @ 0x14059D2C0
 * Callers:
 *     VmpFillGpnRanges @ 0x14059D7E0 (VmpFillGpnRanges.c)
 *     VmpFlushTbVaRange @ 0x14059DBF0 (VmpFlushTbVaRange.c)
 *     VmpQueryAccessedState @ 0x14059F02C (VmpQueryAccessedState.c)
 * Callees:
 *     VmpVaMemoryRangeGetNext @ 0x14059F9A0 (VmpVaMemoryRangeGetNext.c)
 */
