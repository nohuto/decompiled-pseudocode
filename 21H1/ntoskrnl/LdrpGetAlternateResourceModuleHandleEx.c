/*
 * XREFs of LdrpGetAlternateResourceModuleHandleEx @ 0x14033B550
 * Callers:
...
__int64 __fastcall LdrpGetAlternateResourceModuleHandleEx(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  int v7; // ebx
  int i; // ecx
  __int64 v9; // rdx
