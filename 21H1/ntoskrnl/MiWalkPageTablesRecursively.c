/*
 * XREFs of MiWalkPageTablesRecursively @ 0x14020B270
 * Callers:
...
LABEL_26:
          ...
          while ( 1 )
          {
            ...
            v20 += 8;
            if ( (unsigned int)v9 >= dword_140C4DE3C )
              goto LABEL_26;
          }
        }
      }
...
LABEL_75:
      if ( (*a1 & 0x400) != 0 && (SpinLock & 0x40000000) != 0 )
        goto LABEL_99;
      if ( *((_BYTE *)a1 + 6) < 2u )
      {
...
LABEL_112:
        ...
        if ( !v52 && !v6 )
        {
          ...
          if ( DpcRequestSummary >= 0xFFFFF6FB7DBED000uLL
            ...
            && (unsigned int)MiPteHasShadow(v47, v53)
            && (v53 & 1) != 0
          ...
          v9 = HIBYTE(v53);
          LOBYTE(v9) = v9 & 0xF;
          if ( (_BYTE)v9 == 10 || (_BYTE)v9 == 9 || (_BYTE)v9 == 8 && v51 >= 0 )
            goto LABEL_190;
        }
        v56 = *((_QWORD *)a1 + 8);
        if ( v56 && v56 == *v50 )
