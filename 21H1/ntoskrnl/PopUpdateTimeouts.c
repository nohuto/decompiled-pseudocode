/*
 * XREFs of PopUpdateTimeouts @ 0x1406FE9F8
 * Callers:
...
__int64 __fastcall PopUpdateTimeouts(int a1, unsigned int *a2, unsigned int *a3)
{
  ...
  if ( a3 )
  {
    v10 = "Computed";
    if ( !*((_BYTE *)a3 + 4) )
      v10 = (const char *)qword_1407C7830;
  }
  else
  {
    v10 = "NULL";
  ...
  if ( !*((_BYTE *)a2 + 5) )
    v7 = (const char *)qword_1407C7830;
  if ( !*((_BYTE *)a2 + 4) )
    v9 = (const char *)qword_1407C7830;
  PopPrintEx(
    3u,
  ...
  *(_QWORD *)((char *)&PopConsoleContext + 12) = *(_QWORD *)a2;
  ...
  if ( *((_BYTE *)a2 + 4) )
  {
    ...
    HIDWORD(xmmword_140C205F0) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  }
  return result;
}
