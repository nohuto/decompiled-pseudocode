/*
 * XREFs of _CmGetDeviceRegPropWorker @ 0x1406AFDF0
 * Callers:
 ...
 *     _MapCmDevicePropertyToNtProperty @ 0x1402E692C (_MapCmDevicePropertyToNtProperty.c)
 ...
 *     RtlStringCbCopyNExW @ 0x1402E6BEC (RtlStringCbCopyNExW.c)
        ...
        __int16 a8)
{
  ...
  *a5 = 0;
  ...
  if ( !v14 )
  {
    v17 = CmOpenDeviceRegKey(v13, (__int64)a2, 16, 0, 33554433, (char)v16, (__int64)&Handle, v16);
    v16 = 0LL;
    inited = v17;
    if ( v17 < 0 )
      goto LABEL_26;
