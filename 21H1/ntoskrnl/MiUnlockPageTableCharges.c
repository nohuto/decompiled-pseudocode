/*
 * XREFs of MiUnlockPageTableCharges @ 0x1402B713C
 * Callers:
 ...
 *     MiIsLowestPageTablePage @ 0x1402B94F4 (MiIsLowestPageTablePage.c)
...
LABEL_38:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(BugCheckParameter2 + 24) = v13;
    ...
    if ( !a2 )
    {
      IsZero = MiPfnShareCountIsZero(BugCheckParameter2, 0LL, 0x7FFFFFFFFFFFFFFFLL);
      v10 = 0x7FFFFFFFFFFFFFFFLL;
      if ( IsZero != 3 )
        ++v9;
    }
