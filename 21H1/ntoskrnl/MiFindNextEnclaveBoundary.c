/*
 * XREFs of MiFindNextEnclaveBoundary @ 0x1406207C0
 * Callers:
...
__int64 __fastcall MiFindNextEnclaveBoundary(__int64 a1, unsigned __int64 a2, __int64 a3, _DWORD *a4)
{
  __int64 v5; // rsi
...
LABEL_13:
            if ( i )
            {
              ...
              {
                if ( (*(unsigned int *)(i + 28) | ((unsigned __int64)*(unsigned __int8 *)(i + 33) << 32)) < (a2 + v5 - 1) >> 12 )
                {
                  v17 = *(_QWORD ***)(i + 8);
                  v18 = i;
                  if ( v17 )
              ...
              v5 = ((*(unsigned int *)(i + 24) | ((unsigned __int64)*(unsigned __int8 *)(i + 32) << 32)) << 12) - a2;
            }
LABEL_37:
            *(_QWORD *)a4 = v5;
            goto LABEL_38;
...
LABEL_38:
  ...
  if ( Process != (_KPROCESS *)a1 )
    KiUnstackDetachProcess((__int64)v20, 0LL, a3, a4);
  return v10;
}
