/*
 * XREFs of KiUpdateProcessorCount @ 0x14099A414
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x1409AB960 (KiUpdateNumberProcessorsIpi.c)
 *     KeStartAllProcessors @ 0x140A404CC (KeStartAllProcessors.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x140277170 (KeAddProcessorAffinityEx.c)
 *     KiGetCurrentGroupCount @ 0x140323438 (KiGetCurrentGroupCount.c)
 */
