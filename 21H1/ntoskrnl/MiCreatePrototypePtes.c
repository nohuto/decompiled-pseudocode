...
LABEL_22:
          ...
          if ( v75 != 2 )
            v39 = v20;
          v40 = MiDecrementSubsectionViewCount((__int64 *)BugCheckParameter2, v39);
          ExReleaseSpinLockExclusiveFromDpcLevel(v16);
          if ( KiIrqlFlags
            && (KiIrqlFlags & 1) != 0
...
LABEL_107:
        ...
        KiLeaveGuardedRegionUnsafe((__int64)CurrentThread, v59, v61, v62);
        v12 = v78;
        v51 = 0LL;
        v83 = 0;
      }
...
LABEL_49:
    ...
    KiLeaveGuardedRegionUnsafe((__int64)CurrentThread, v35, v37, v38);
    v24 = 0LL;
  }
  if ( CommittedPages )
    MiReturnCrossPartitionSectionCharges(
      *(_QWORD *)(qword_140C4E588 + 8LL * (*(_WORD *)(v78 + 60) & 0x3FF)),
      v24,
      CommittedPages);
  if ( P )
