/*
 * XREFs of PopSetDevicesSystemState @ 0x14098D3EC
 * Callers:
...
__int64 PopSetDevicesSystemState()
{
  ...
  v3 = byte_140C23402;
  v5 = byte_140C2341C;
  v2[0] = dword_140C2342C;
  v2[1] = dword_140C23428;
  v0 = dword_140C23420;
  if ( (dword_140C2340C & 8) != 0 )
    v0 = 6;
  v2[5] = dword_140C2340C;
  v2[2] = v0;
  v2[3] = dword_140C23424;
  v2[4] = qword_140C23404;
  v6 = 0;
