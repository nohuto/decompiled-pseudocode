/*
 * XREFs of VfMajorTestStartedPdoStack @ 0x1409D4B84
 * Callers:
...
__int64 (__fastcall *__fastcall VfMajorTestStartedPdoStack(__int64 a1))(_QWORD)
{
  ...
  if ( (_DWORD)result && VfVerifyMode > 2 )
  {
    for ( i = 0; i <= 0x1B; ++i )
    {
      v4 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140D49110 + 12 * i);
      if ( v4 )
        v4(a1);
    }
    result = qword_140D49B90;
    if ( qword_140D49B90 )
      return (__int64 (__fastcall *)(_QWORD))qword_140D49B90(a1);
  }
  return result;
}
