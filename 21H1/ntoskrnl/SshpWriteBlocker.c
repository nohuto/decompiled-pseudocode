/*
 * XREFs of SshpWriteBlocker @ 0x14057A74C
 * Callers:
  ...
  if ( !v27 )
  {
    ...
    if ( a2 >= SshpSessionThresholdHns )
    {
      ...
      if ( v29 >= (unsigned int)SshpActiveThresholdPercent )
      {
        ...
        {
          if ( (unsigned int)dword_140C046A0 > 5 )
          {
            LOBYTE(v27) = tlgKeywordOn((__int64)&dword_140C046A0, 0x400000000000LL);
            if ( (_BYTE)v27 )
            {
              v35 = SshpSessionId;
              v36 = v30;
              ...
              LOBYTE(v27) = tlgWriteTransfer_EtwWriteTransfer(
                              (__int64)&dword_140C046A0,
                              (unsigned __int8 *)word_1400297DA,
                              0LL,
                              0LL,
                              0x13u,
                              &v61);
