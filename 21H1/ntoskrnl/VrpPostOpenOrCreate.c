/*
 * XREFs of VrpPostOpenOrCreate @ 0x1405C9FF0
 * Callers:
 ...
 *     CmpFindExtraParameterInBlock @ 0x1405CAFAC (CmpFindExtraParameterInBlock.c)
    ...
    *(_QWORD *)&v10->Length = 0LL;
    ...
    if ( v27 == 872 || v27 == 260 )
    {
      if ( (unsigned int)dword_140C02168 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C02168,
          (unsigned __int8 *)word_1400231B2,
          &ActivityId,
          0LL,
          5u,
          v44);
