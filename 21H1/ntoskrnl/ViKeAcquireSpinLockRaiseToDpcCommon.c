/*
 * XREFs of ViKeAcquireSpinLockRaiseToDpcCommon @ 0x1409D8F20
 * Callers:
 *     VerifierKeAcquireSpinLockRaiseToDpc @ 0x1409D7990 (VerifierKeAcquireSpinLockRaiseToDpc.c)
 *     VerifierKeAcquireSpinLockRaiseToDpcNoReboot @ 0x1409D79E0 (VerifierKeAcquireSpinLockRaiseToDpcNoReboot.c)
 * Callees:
