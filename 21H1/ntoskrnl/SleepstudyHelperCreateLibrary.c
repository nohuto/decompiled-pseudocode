/*
 * XREFs of SleepstudyHelperCreateLibrary @ 0x1407B7310
 * Callers:
 *     SleepstudyHelper_Initialize @ 0x1408F6D60 (SleepstudyHelper_Initialize.c)
 * Callees:
    ...
    if ( SshpInitialized )
    {
      ...
      if ( NonPaged )
      {
        ...
        *(_QWORD *)(v6 + 56) = v6 + 56;
        ...
        v7 = (__int64 *)qword_140C1E2B8;
        if ( *(__int64 **)qword_140C1E2B8 != &SshpLibraryList )
          __fastfail(3u);
