...
__int64 __fastcall RtlpHpVaMgrAlloc(ULONG_PTR BugCheckParameter2, unsigned __int64 *a2, unsigned __int64 a3)
{
  ...
  if ( v4 <= (unsigned __int64)(*(unsigned __int16 *)(BugCheckParameter2 + 40) << 20) >> 1 )
  {
    ...
    v11 = RtlpHpVaMgrRangeFind(BugCheckParameter2, (unsigned __int16)v9, (unsigned __int16)(v3 >> 20), &v52);
    v12 = -1;
    v13 = v11;
    if ( v11 )
    {
    ...
    else
    {
      ...
      else
      {
        ...
        while ( 1 )
        {
          v41 = (unsigned __int64)&CurrentThread->LockEntries[v40];
          v39 &= ~(1 << v40);
          if ( (*(_BYTE *)(v41 + 26) & 1) != 0
            && (*(_DWORD *)(v41 + 32) & 1) == 0
...
LABEL_66:
        ...
        else
        {
          ...
          *(_BYTE *)(v41 + 25) &= ~1u;
          *(_QWORD *)(v41 + 32) = 0LL;
          v42 = 1 << ((__int64)(v41 - (unsigned __int64)CurrentThread->LockEntries) / 96);
          if ( v38 == 1 )
