/*
 * XREFs of TtmiLogDeviceFromTerminalRemoved @ 0x1408FDA18
 * Callers:
 *     TtmiEvacuateDevices @ 0x1408F7BF8 (TtmiEvacuateDevices.c)
 * Callees:
...
char __fastcall TtmiLogDeviceFromTerminalRemoved(int a1, int a2, __int64 a3, int a4)
{
  ...
  {
    LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL);
    if ( (_BYTE)v4 )
    {
      ...
      LOBYTE(v4) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)&dword_14002A27C,
                     0LL,
                     0LL,
                     7u,
                     &v16);
