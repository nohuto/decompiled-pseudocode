/*
 * XREFs of MiRemoveLargeFreeLoaderDescriptors @ 0x140A4560C
 * Callers:
...
void __fastcall MiRemoveLargeFreeLoaderDescriptors(__int64 a1)
{
  ...
  qword_140D55758 = (__int64)&MxDeferredBootFreeDescriptorHead;
