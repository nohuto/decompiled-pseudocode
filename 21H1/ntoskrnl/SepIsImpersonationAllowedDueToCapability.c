/*
 * XREFs of SepIsImpersonationAllowedDueToCapability @ 0x1406CCA20
 * Callers:
...
BOOLEAN __fastcall SepIsImpersonationAllowedDueToCapability(__int64 Token, __int64 a2)
{
  ...
  v12 = SepSidInToken(Token, 0LL, (__int64)SeConstrainedImpersonationCapabilityGroupSid, 0LL, 0);
  if ( v12 )
  {
    if ( SeTokenIsRestricted((PACCESS_TOKEN)Token) )
      v12 = SepSidInToken(Token, 0LL, (__int64)v11, 0LL, 1);
    if ( v12 )
      goto LABEL_28;
  }
  v13 = v12;
