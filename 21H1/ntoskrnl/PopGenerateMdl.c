/*
 * XREFs of PopGenerateMdl @ 0x1403849F8
 * Callers:
...
PMDL __fastcall PopGenerateMdl(__int64 a1)
{
  ...
  if ( PagesForMdl )
  {
    PagesForMdl->Next = *(struct _MDL **)(qword_140C23440 + 128);
    *(_QWORD *)(qword_140C23440 + 128) = PagesForMdl;
    *(_QWORD *)(qword_140C23440 + 136) += a1;
  }
  v5 = __rdtsc();
  qword_140C23968 += (((unsigned __int64)HIDWORD(v5) << 32) | (unsigned int)v5) - v2;
  return v4;
}
