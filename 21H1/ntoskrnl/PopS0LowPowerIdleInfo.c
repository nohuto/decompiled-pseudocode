/*
 * XREFs of PopS0LowPowerIdleInfo @ 0x1408DF7CC
 * Callers:
...
__int64 __fastcall PopS0LowPowerIdleInfo(__int64 a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  else
  {
    ...
    *(_BYTE *)(a1 + 4) = v6;
    LOBYTE(v6) = (dword_140CF9EBC != 1 ? 0 : 2) | v6 & 0xFD;
    *(_BYTE *)(a1 + 4) = v6;
    LOBYTE(v6) = (dword_140CF9EC0 != 1 ? 0 : 4) | v6 & 0xFB;
    *(_BYTE *)(a1 + 4) = v6;
    *(_BYTE *)(a1 + 4) = (dword_140CF9EC8 != 1 ? 0 : 8) | v6 & 0xF7;
