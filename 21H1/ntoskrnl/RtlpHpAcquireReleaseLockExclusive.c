/*
 * XREFs of RtlpHpAcquireReleaseLockExclusive @ 0x14031DDF4
 * Callers:
...
__int64 __fastcall RtlpHpAcquireReleaseLockExclusive(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
  ...
  if ( (_DWORD)a2 )
  {
    v20 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)BugCheckParameter2);
...
LABEL_17:
    ...
    if ( v9 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v5->ApcState.ApcListHead[0].Flink != &v5->152 )
      KiCheckForKernelApcDelivery(v16);
    return KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread(), v15, v17, v18);
  }
  return result;
}
