/*
 * XREFs of MiGetTransitionPageHeatList @ 0x140559B38
 * Callers:
...
PSLIST_ENTRY MiGetTransitionPageHeatList()
{
  ...
  result = RtlpInterlockedPopEntrySList(&stru_140C4E950);
  v1 = result;
  if ( result )
  {
  ...
  else
  {
    ...
    {
      v3 = v2;
      v2 = _InterlockedCompareExchange(&dword_140C4E960, v2 - 1, v2);
      if ( v3 == v2 )
        return v1;
    }
