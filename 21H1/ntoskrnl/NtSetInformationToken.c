/*
 * XREFs of NtSetInformationToken @ 0x1406F7D00
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG TokenInformationLength)
{
  ...
  int v125; // [rsp+9Ch] [rbp-6Ch]
  int v126; // [rsp+A0h] [rbp-68h] BYREF
  int v127; // [rsp+A4h] [rbp-64h]
  ...
  int v133; // [rsp+CCh] [rbp-3Ch]
  int v134; // [rsp+D0h] [rbp-38h]
  int v135; // [rsp+D4h] [rbp-34h]
  int v136; // [rsp+D8h] [rbp-30h]
...
LABEL_89:
      ...
      SeSetVirtualizationToken((__int64)Token, v136);
LABEL_41:
      v28 = 0;
      goto LABEL_42;
    }
...
LABEL_170:
        ...
        {
          v113 = SepExpandDynamic((__int64)Token, v69);
          if ( v113 >= 0 )
          {
            ...
            if ( !v72
              || (v113 = SeCaptureAcl(v72, 0, v70, v71, PagedPool, (int)HandleInformation, (PVOID *)&v129, &v124),
                  v113 >= 0) )
            {
              SepFreeDefaultDacl((__int64)v68);
              v74 = (ACL *)v118;
              if ( v118 )
                SepAppendDefaultDacl((__int64)v68, (unsigned __int16 *)v118);
              SeTokenDefaultDaclChangedAuditAlarm(v73, (__int64)v68, (__int64)TokenHandle, (ACL *)v129, v74);
      ...
      else
      {
        ...
        if ( (unsigned __int8)SepIdAssignableAsGroup(v15, v119) )
        {
          ...
          {
            v113 = SepExpandDynamic((__int64)Token, v116);
            if ( v113 >= 0 )
            {
    ...
    else
    {
      ...
      if ( SepIdAssignableAsOwner((__int64)v84, v82) )
      {
