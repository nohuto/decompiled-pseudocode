...
__int64 __fastcall NtReplyPort(HANDLE Handle, __m256i *a2)
{
  ...
  Object = 0LL;
  v6 = ObReferenceObjectByHandle(Handle, 1u, AlpcPortObjectType, KeGetCurrentThread()->PreviousMode, &Object, 0LL);
  if ( v6 >= 0 )
  {
    LODWORD(v10[6]) = 0;
    v10[0] = Object;
    ...
    {
      v6 = AlpcpReplyLegacySynchronousRequest((__int64)v10, (unsigned __int64)a2, KeGetCurrentThread()->PreviousMode);
    }
    else
    {
      LODWORD(v10[6]) = 65537;
      v6 = AlpcpSendMessage((__int64)v10, a2, 0LL, KeGetCurrentThread()->PreviousMode);
      if ( v6 == -1073740029 )
        v6 = -1073741769;
    }
