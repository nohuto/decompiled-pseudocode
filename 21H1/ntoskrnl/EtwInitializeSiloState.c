/*
 * XREFs of EtwInitializeSiloState @ 0x14079FC30
 * Callers:
...
LABEL_14:
  ...
  *((_QWORD *)PsGetServerSiloGlobals((__int64)a1) + 108) = v4;
  ...
  EtwpQueryPartitionRegistryInformation(
    ...
    (GUID *)(v4 + 4168));
  if ( IsHostSilo )
    qword_140D557C8 = KeQueryPerformanceCounter(0LL).QuadPart;
  EtwpInitializeAutoLoggers();
  if ( IsHostSilo )
    qword_140D557D0 = KeQueryPerformanceCounter(0LL).QuadPart;
