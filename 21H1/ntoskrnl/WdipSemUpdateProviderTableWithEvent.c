/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x14078618C
 * Callers:
 *     WdipSemUpdateProviderTableWithScenario @ 0x140786118 (WdipSemUpdateProviderTableWithScenario.c)
 * Callees:
 *     EtwEventEnabled @ 0x14026B690 (EtwEventEnabled.c)
 *     memset @ 0x140408F80 (memset.c)
 *     WdipSemFastAllocate @ 0x1407741D0 (WdipSemFastAllocate.c)
 *     WdipSemQueryProviderTable @ 0x140786230 (WdipSemQueryProviderTable.c)
...
__int64 __fastcall WdipSemUpdateProviderTableWithEvent(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    else if ( (unsigned int)dword_140C1C540 >= 0x400 )
    {
    ...
    else
    {
      ...
      if ( v5 )
      {
        memset(v5, 0, 0x50uLL);
        *v6 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140C1C540++] = v6;
        *(_QWORD *)(a1 + 40) = v6;
      }
      else
      {
