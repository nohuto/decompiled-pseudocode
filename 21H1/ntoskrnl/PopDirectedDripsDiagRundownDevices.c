/*
 * XREFs of PopDirectedDripsDiagRundownDevices @ 0x1408F30E4
 * Callers:
...
void PopDirectedDripsDiagRundownDevices()
{
  ...
  while ( 1 )
  {
    v0 = (char *)qword_140C1E9B0;
    if ( qword_140C1E9B0 == &qword_140C1E9B0 )
      break;
    if ( *((PVOID **)qword_140C1E9B0 + 1) != &qword_140C1E9B0
      || (v1 = *(_QWORD *)qword_140C1E9B0, *(PVOID *)(*(_QWORD *)qword_140C1E9B0 + 8LL) != qword_140C1E9B0) )
    {
      __fastfail(3u);
    }
    qword_140C1E9B0 = *(PVOID *)qword_140C1E9B0;
    v2 = 0;
    *(_QWORD *)(v1 + 8) = &qword_140C1E9B0;
    v3 = 0;
    v36 = 0;
    v4 = *((_DWORD *)v0 + 39);
    if ( v4 )
    ...
    if ( (v8 & 0x40000) != 0 )
    {
      ...
      if ( (unsigned int)dword_140D2C920 > 5 && tlgKeywordOn((__int64)&dword_140D2C920, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_140028C21,
          0LL,
          0LL,
          0x16u,
          &v51);
      ...
      if ( PopDiagHandleRegistered != v11 )
      {
        ...
        if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DIRECTED_DRIPS_DEVICE_STATS) )
        {
          ...
          *(_QWORD *)&PopDirectedDripsDiagEventData.Size = 1LL;
          qword_140C1EBF0 = (__int64)(v0 + 16);
          qword_140C1EBF8 = 8LL;
          v38 = v10->Length >> 1;
          qword_140C1EC00 = (__int64)&v38;
          qword_140C1EC08 = 4LL;
          Length = v10->Length;
          qword_140C1EC10 = (__int64)v10->Buffer;
          dword_140C1EC18 = Length;
          dword_140C1EC1C = 0;
          v39 = v48->Length >> 1;
          qword_140C1EC20 = (__int64)&v39;
          qword_140C1EC28 = 4LL;
          v19 = v48->Length;
          qword_140C1EC30 = (__int64)v48->Buffer;
          dword_140C1EC38 = v19;
          dword_140C1EC3C = 0;
          v40 = v12->Length >> 1;
          qword_140C1EC40 = (__int64)&v40;
          qword_140C1EC48 = 4LL;
          v20 = v12->Length;
          qword_140C1EC50 = (__int64)v12->Buffer;
          dword_140C1EC58 = v20;
          dword_140C1EC5C = 0;
          LODWORD(v41) = v13->Length >> 1;
          qword_140C1EC60 = (__int64)&v41;
          qword_140C1EC68 = 4LL;
          v21 = v13->Length;
          qword_140C1EC70 = (__int64)v13->Buffer;
          qword_140C1EC80 = (__int64)(v0 + 148);
          qword_140C1EC90 = (__int64)(v0 + 156);
          qword_140C1ECB0 = (__int64)(v0 + 152);
          dword_140C1EC78 = v21;
          qword_140C1ECA0 = (__int64)(v0 + 160);
          dword_140C1EC7C = 0;
          qword_140C1EC88 = 4LL;
          qword_140C1EC98 = 4LL;
          qword_140C1ECA8 = 4LL;
