/*
 * XREFs of CmpLoadHiveVolatile @ 0x140878768
 * Callers:
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v8 == CmpMasterHive )
      {
        ...
        if ( Hive >= 0 )
        {
          v7 = CmpCreateHive((ULONG_PTR *)&P, 0, 1u, 0, 0LL, 0LL, 0LL, 0x1000000, &Uuid, &v32, 0LL, (__int64)v34);
          if ( v7 >= 0 )
          {
