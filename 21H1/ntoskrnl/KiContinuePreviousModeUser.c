/*
 * XREFs of KiContinuePreviousModeUser @ 0x14032F2E0
 * Callers:
 ...
 *     KiVerifyContextRecord @ 0x14032FA50 (KiVerifyContextRecord.c)
 ...
 *     RtlGuardIsValidStackPointer @ 0x1406F2D20 (RtlGuardIsValidStackPointer.c)
