/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x1405B8210
 * Callers:
 *     WheapWmiExecuteMethod @ 0x1405B80E0 (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapCommitPolicy @ 0x140959370 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyBufferSize @ 0x140959460 (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x140959470 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x1409594B4 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x140959658 (WheapSetPolicyValue.c)
 */
