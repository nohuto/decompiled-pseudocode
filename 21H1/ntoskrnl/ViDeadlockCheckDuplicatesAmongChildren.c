/*
 * XREFs of ViDeadlockCheckDuplicatesAmongChildren @ 0x1409DC030
 * Callers:
 *     VfDeadlockAcquireResource @ 0x1409DA558 (VfDeadlockAcquireResource.c)
 * Callees:
 *     ViDeadlockMergeNodes @ 0x1409DC5A4 (ViDeadlockMergeNodes.c)
 *     ViDeadlockSimilarNodes @ 0x1409DCE20 (ViDeadlockSimilarNodes.c)
 */
