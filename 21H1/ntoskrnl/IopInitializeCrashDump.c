/*
 * XREFs of IopInitializeCrashDump @ 0x14079F868
 * Callers:
 ...
 *     SecureDump_GetSecureDumpSettings @ 0x1403BBF30 (SecureDump_GetSecureDumpSettings.c)
  ...
  if ( !ForceDumpDisabled )
  {
      ...
      && (int)SecureDump_GetSecureDumpSettings((__int64)&v7) >= 0 )
    {
      ...
      if ( qword_140C50BF8 )
      {
        ...
        v11 = 0;
        v12 = 0;
        if ( (int)qword_140C50BF8(v8) >= 0 )
        {
LABEL_9:
          v7 = *a2;
          if ( (int)((__int64 (__fastcall *)(__int64, __int64 *, __int128 *))qword_140C50B98)(
                      Handle,
                      &CrashdmpDumpBlock,
                      &v7) >= 0 )
          {
