/*
 * XREFs of KiComputeGroupSchedulingRank @ 0x140332BC0
 * Callers:
...
LABEL_5:
  ...
  {
    _InterlockedOr64(
      &qword_140C11168[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[*(unsigned int *)(a2 + 36)] >> 6],
