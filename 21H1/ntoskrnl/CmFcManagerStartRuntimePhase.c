/*
 * XREFs of CmFcManagerStartRuntimePhase @ 0x140A357B8
 * Callers:
 ...
 *     RtlpFcWriteHighLowHigh @ 0x1403CA088 (RtlpFcWriteHighLowHigh.c)
 ...
 *     RtlGetSwapReferenceIndex @ 0x1407BEFD4 (RtlGetSwapReferenceIndex.c)
 ...
 *     CmFcpSwapSectionState @ 0x14087A164 (CmFcpSwapSectionState.c)
  ...
  if ( SectionFromBuffer >= 0 )
  {
    ...
    if ( !QuadPart
      || (SectionFromBuffer = CmFcpManagerCreateSectionFromBuffer(
          ...
          SectionFromBuffer >= 0) )
    {
      RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48130, (__int64)v9);
      v9 = 0LL;
      v12 = 0;
      while ( 1 )
      {
        ...
        if ( ++v12 >= 3 )
        {
          ...
          if ( SectionFromBuffer >= 0 )
          {
            for ( i = 0; i < 2; ++i )
            {
              v18 = ((unsigned __int8)RtlGetSwapReferenceIndex(qword_140C481F0) - 1) & 1;
              ...
              RtlUpdateSwapReference(qword_140C481F0, v18);
            }
            qword_140C482A8 = ExAllocateTimer(
...
LABEL_30:
    if ( v9 )
      RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48130, (__int64)v9);
LABEL_33:
    CmSiRWLockReleaseExclusive((volatile signed __int64 *)&stru_140C480D0);
