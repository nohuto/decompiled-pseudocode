/*
 * XREFs of MiRemoveMappingNode @ 0x140377740
 * Callers:
...
unsigned __int64 *__fastcall MiRemoveMappingNode(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  v4 = ExAcquireSpinLockExclusive(&dword_140C4EB00);
  v5 = (unsigned __int64 *)qword_140C4EB08;
  ...
  RtlAvlRemoveNode((unsigned __int64 *)&qword_140C4EB08, v5);
