/*
 * XREFs of MmCreatePartition @ 0x1403C6584
 * Callers:
...
__int64 __fastcall MmCreatePartition(_QWORD *a1, char a2)
{
  ...
  Pool = MiAllocatePool(
         ...
         + 16 * (v8 + v6 * (unsigned int)dword_140C4DEC0[0])
         + v4
         + 8,
           0x6150694Du);
  v10 = Pool;
  ...
  Pool[272] = v11;
  v12 = v11 + 40LL * (unsigned int)dword_140C4DE3C;
  Pool[273] = v12;
  v13 = (v12 + 40LL * (unsigned int)dword_140C4DE3C + 15) & 0xFFFFFFFFFFFFFFF0uLL;
  Pool[525] = v13;
  v14 = v13 + 16LL * (unsigned int)dword_140C4DE3C;
  Pool[526] = v14;
  v15 = 16LL * (unsigned int)dword_140C4DE3C + v14;
  Pool[612] = 0LL;
  Pool[629] = v15;
  Pool[22] = a1;
  Pool[637] = v15 + v4;
