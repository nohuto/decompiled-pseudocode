/*
 * XREFs of ExpUnblockPushLock @ 0x1402EBE18
 * Callers:
 ...
 *     IopCheckHandleForRevocation @ 0x140501B20 (IopCheckHandleForRevocation.c)
 *     PspHandleTableWalker @ 0x14057BE00 (PspHandleTableWalker.c)
 * Callees:
