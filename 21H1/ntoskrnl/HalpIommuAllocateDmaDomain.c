  ...
  *(_BYTE *)(v7 + 44) = a2;
  if ( !v10 )
  {
    ...
    *(_BYTE *)(v7 + 40) = a2 == 0;
    v13 = v12;
    LOBYTE(v14) = a2 == 0;
    PageTableType = ((__int64 (__fastcall *)(signed __int32 *))qword_140C4A4D0)(&v13);
    goto LABEL_6;
  }
  if ( !a2 )
  {
