/*
 * XREFs of HvAnalyzeLogFiles @ 0x14087C40C
 * Callers:
 ...
 *     HvpDetermineLatestLogFile @ 0x14087D010 (HvpDetermineLatestLogFile.c)
...
LABEL_61:
    if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000008LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)qword_140022D08,
        0LL,
        0LL,
        3u,
        v84);
  ...
  if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 8LL) )
  {
    ...
    v73 = v47;
    v97 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)byte_140022CAB, 0LL, 0LL, 7u, &v87);
    v46 = dword_140C02130;
  }
  if ( v37 == 1 )
  {
  ...
  else
  {
    ...
    else
    {
      if ( v46 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C02130,
          (unsigned __int8 *)&dword_140022D3C,
          0LL,
          0LL,
          3u,
          v84);
