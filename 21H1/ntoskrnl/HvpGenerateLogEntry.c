/*
 * XREFs of HvpGenerateLogEntry @ 0x140689C18
 * Callers:
 *     HvStoreModifiedData @ 0x140689398 (HvStoreModifiedData.c)
 * Callees:
 *     HvpGenerateLogEntryMetadata @ 0x1402E0FF4 (HvpGenerateLogEntryMetadata.c)
 ...
 *     HvpGenerateLogMetadata @ 0x1407047C0 (HvpGenerateLogMetadata.c)
