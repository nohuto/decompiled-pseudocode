/*
 * XREFs of MiInitializeCommitment @ 0x1403BB634
 * Callers:
...
__int64 __fastcall MiInitializeCommitment(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 492) = 0;
  ...
  if ( dword_140C4DE3C )
  {
    ...
    v5 = (unsigned int)dword_140C4DE3C;
  ...
  *(_QWORD *)(a1 + 7168) = v3;
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
  {
    qword_140C4EEF0 = *(_QWORD *)(a1 + 7464);
    qword_140C4EEF0 -= qword_140C4EEF8;
    result = qword_140C4EF18;
    qword_140C4EEF0 -= qword_140C4EF18;
  }
  return result;
}
