/*
 * XREFs of EtwpCoverageEnsureUserModeView @ 0x14075CE64
 * Callers:
...
__int64 __fastcall EtwpCoverageEnsureUserModeView(__int64 a1)
{
  ...
  else
  {
    v13[0] = 0LL;
    v12 = 0LL;
    v11 = MmMapViewOfSection(*(_QWORD *)(a1 + 8), (__int64)Process, (__int64 *)&v14, 0LL, 0LL, v13, &v12, 1, 0, 2);
    if ( v11 >= 0 )
    {
  ...
  if ( v14 )
    MiUnmapViewOfSection(Process, v14, 0, 0LL);
