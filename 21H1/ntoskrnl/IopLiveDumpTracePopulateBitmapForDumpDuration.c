/*
 * XREFs of IopLiveDumpTracePopulateBitmapForDumpDuration @ 0x14050424C
 * Callers:
  ...
  if ( (_BYTE)v4 )
  {
    if ( !v5[104] )
    {
      ...
      if ( (v4 & 1) != 0 )
      {
        ...
        {
          LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140C04458, 0x200000000000LL);
          if ( (_BYTE)v4 )
          {
            v17 = 0;
            v20 = 0;
            ...
            LOBYTE(v4) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)&word_1400237DE,
                           a1 + 54,
                           a1 + 53,
                           4u,
                           &v14);
