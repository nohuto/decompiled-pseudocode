/*
 * XREFs of KiGetSavedIptState @ 0x140514710
 * Callers:
 *     <none>
 * Callees:
 *     KiGetSavedSupervisorState @ 0x1405147C0 (KiGetSavedSupervisorState.c)
 *     KiXSavesManagesIpt @ 0x140514B44 (KiXSavesManagesIpt.c)
