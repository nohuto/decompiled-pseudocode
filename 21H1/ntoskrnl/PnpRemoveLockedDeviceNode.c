/*
 * XREFs of PnpRemoveLockedDeviceNode @ 0x14036C538
 * Callers:
 ...
 *     PpHotSwapInitRemovalPolicy @ 0x1406EDD1C (PpHotSwapInitRemovalPolicy.c)
 *     PnpDeleteAllDependencyRelations @ 0x14071031C (PnpDeleteAllDependencyRelations.c)
 *     PipIsProblemReadonly @ 0x14071D934 (PipIsProblemReadonly.c)
