/*
 * XREFs of KeMarkHiberPhase @ 0x1409AB2B8
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( qword_140C2B338 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B338, 16 * (unsigned int)(unsigned __int8)qword_140C2B328, 0x7272744Du);
  if ( qword_140C2B340 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B340, 0x58uLL, 0x7272744Du);
  v13 = *(_QWORD **)(v1 + 8);
