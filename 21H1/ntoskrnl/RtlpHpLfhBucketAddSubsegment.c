/*
 * XREFs of RtlpHpLfhBucketAddSubsegment @ 0x140239674
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentSetOwner @ 0x140237DF8 (RtlpHpLfhSubsegmentSetOwner.c)
...
__int64 __fastcall RtlpHpLfhBucketAddSubsegment(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  if ( *(_WORD *)(a3 + 32) != (_WORD)result )
  {
    ...
    v10 = (unsigned __int8)RtlpHpAcquireLockExclusive(a2 + 16);
    RtlpHpLfhSubsegmentSetOwner((__int64)v6, a2);
          ...
          *(_BYTE *)(v19 + 26) &= ~1u;
          if ( *(_QWORD *)(v19 + 32) )
          {
            if ( v19 )
            {
              *(_BYTE *)(v19 + 32) |= 2u;
              if ( *(__int64 *)(v19 + 32) < 0 )
                KiAbEntryRemoveFromTree(v19, SessionId, v17);
...
LABEL_33:
  ...
  if ( v6 )
    return RtlpHpLfhSubsegmentFree(a1, (__int64)v6, a2, a4 & 1);
  return result;
}
