/*
 * XREFs of EtwpCompressPendingBuffers @ 0x1405A6E38
 * Callers:
...
char __fastcall EtwpCompressPendingBuffers(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( v14 )
      goto LABEL_24;
    v13 = (unsigned __int64)&CurrentThread->LockEntries[v15];
    v12 &= ~(1 << v15);
    if ( (*(_BYTE *)(v13 + 26) & 1) != 0
      && (*(_DWORD *)(v13 + 32) & 1) == 0
...
LABEL_24:
  ...
  *(_DWORD *)(v13 + 88) = v17;
  *(_QWORD *)(v13 + 32) = 0LL;
  v18 = (__int64)(v13 - (unsigned __int64)CurrentThread->LockEntries) / 96;
  if ( v11 == 1 )
...
LABEL_31:
  ...
  LOBYTE(v19) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v1, &v25);
  v14 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v14 )
  {
    v19 = &CurrentThread->152;
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v19->ApcState.ApcListHead[0].Flink != v19 )
      LOBYTE(v19) = KiCheckForKernelApcDelivery(v21, v20, v22, v23);
  }
  return (char)v19;
}
