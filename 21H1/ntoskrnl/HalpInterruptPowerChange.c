/*
 * XREFs of HalpInterruptPowerChange @ 0x1404CC554
 * Callers:
 *     HalpInterruptPowerComponentActiveCallback @ 0x1404CC5F0 (HalpInterruptPowerComponentActiveCallback.c)
 *     HalpInterruptPowerComponentIdleCallback @ 0x1404CC610 (HalpInterruptPowerComponentIdleCallback.c)
 *     HalpInterruptPowerCriticalTransitionCallback @ 0x1404CC650 (HalpInterruptPowerCriticalTransitionCallback.c)
 * Callees:
