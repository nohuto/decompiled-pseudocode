/*
 * XREFs of CmpMarkIndexDirty @ 0x140691EE8
 * Callers:
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    if ( *v17 != 26994 )
      break;
    if ( (int)CmpFindSubKeyInRoot(BugCheckParameter2, (__int64)v17, (int)&v22, &v23) < 0 )
    {
LABEL_24:
...
LABEL_15:
  ...
  v24 = 0;
  CmpFindSubKeyInLeafWithStatus(BugCheckParameter2, (__int64)v17, (unsigned __int16 *)&v22, &v23, &v24);
  if ( v24 < 0 )
    goto LABEL_24;
  (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter2 + 16))(BugCheckParameter2, v21);
  if ( v23 == -1 )
