/*
 * XREFs of ExpWorkerFactoryCompletionPacketRoutine @ 0x1402DA270
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  {
    v9 = KxWaitForLockChainValid(&v19, (_BYTE)v6);
LABEL_18:
    v19 = 0LL;
...
LABEL_13:
  ...
  if ( v7 )
  {
    if ( v7 == 1 )
    {
      return IoSetIoCompletionEx2(*(_QWORD *)(a2 + 8), 0LL, 0LL, 0LL, 0LL, 0, *(_QWORD *)(a2 + 16), 0);
    }
    else
    {
