/*
 * XREFs of CcCachemapUninitWorkerThread @ 0x1402344B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CcCachemapUninitWorkerThread(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (xmmword_140CFC490 & 0x20000) != 0 )
    {
      ...
      v23 = 8;
      v24 = 0;
      EtwTraceKernelEvent((unsigned int)&v22, 1, -2147352576, 5633, 4200706);
    }
    if ( *(_BYTE *)(NextWorkQueueEntry + 120) == 2 )
    {
      v19 = NextWorkQueueEntry;
      CcWriteBehind(*(_QWORD *)(NextWorkQueueEntry + 16), (__int64)v18);
    }
    if ( (xmmword_140CFC490 & 0x20000) != 0 )
    {
      ...
      v26 = 8;
      v27 = 0;
      EtwTraceKernelEvent((unsigned int)&v25, 1, -2147352576, 5634, 4200706);
    }
