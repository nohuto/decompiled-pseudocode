/*
 * XREFs of x86BiosReadIoSpace @ 0x1403961B0
 * Callers:
 *     XmInOp @ 0x1403930D0 (XmInOp.c)
 *     XmInsOp @ 0x1404E0C90 (XmInsOp.c)
 * Callees:
 *     x86BiosReadPciDataPort @ 0x1403C5FBC (x86BiosReadPciDataPort.c)
 *     x86BiosReadCmosPort @ 0x1404B9C80 (x86BiosReadCmosPort.c)
 *     x86BiosReadPciAddressPort @ 0x1404B9D4C (x86BiosReadPciAddressPort.c)
 */
