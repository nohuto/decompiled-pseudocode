/*
 * XREFs of HalpSetSystemInformation @ 0x14071F2E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpTimerGetProfilingHandler @ 0x1404BC268 (HalpTimerGetProfilingHandler.c)
 *     HalpTimerSetProfilingHandler @ 0x1404BC3D4 (HalpTimerSetProfilingHandler.c)
...
__int64 __fastcall HalpSetSystemInformation(int a1, int a2, __int64 (**a3)(void))
{
  ...
  switch ( a1 )
  {
    ...
    case 1:
      ...
      if ( qword_140CF5170 )
      {
        if ( qword_140CF5170 == PsGetCurrentThreadProcessId() )
        {
      ...
      else
      {
        HalpPerfInterruptHandler = (__int64 (__fastcall *)(_QWORD))*a3;
        if ( HalpPerfInterruptHandler )
          qword_140CF5170 = PsGetCurrentThreadProcessId();
      }
    ...
    case 10:
      ...
      if ( !qword_140CF5160 )
      {
        ...
        if ( HalpTimerGetProfilingHandler() )
          qword_140CF5160 = PsGetCurrentThreadProcessId();
        goto LABEL_34;
      }
      if ( qword_140CF5160 == PsGetCurrentThreadProcessId() )
      {
        HalpTimerSetProfilingHandler(*a3);
        if ( !HalpTimerGetProfilingHandler() )
          qword_140CF5160 = 0LL;
    ...
    case 19:
      ...
      if ( !qword_140CF5168 )
      {
        ...
        if ( HalpProcessorTraceInterruptHandler )
          qword_140CF5168 = PsGetCurrentThreadProcessId();
        goto LABEL_34;
      }
      if ( qword_140CF5168 == PsGetCurrentThreadProcessId() )
      {
        HalpProcessorTraceInterruptHandler = (__int64 (__fastcall *)(_QWORD))*a3;
        if ( !HalpProcessorTraceInterruptHandler )
          qword_140CF5168 = 0LL;
