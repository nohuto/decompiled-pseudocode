/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x1405A73A4
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x1405A7498 (EtwpDequeueBufferPendingCompressionFromQueue.c)
