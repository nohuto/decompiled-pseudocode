/*
 * XREFs of HalpVpptInitializePhysicalTimer @ 0x1404BB4D4
 * Callers:
 *     HalpTimerInitializeVpptClockTimer @ 0x140383190 (HalpTimerInitializeVpptClockTimer.c)
 * Callees:
...
__int64 HalpVpptInitializePhysicalTimer()
{
  ...
  byte_140C4A678 = HalpAcquireHighLevelLock(&qword_140C4A670);
  ...
  v4 = (unsigned __int8)byte_140C4A678;
  v5 = v3;
  KxReleaseSpinLock(&qword_140C4A670);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
