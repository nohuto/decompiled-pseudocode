/*
 * XREFs of HalpDmaInitSystem @ 0x14099B280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpDmaInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v5 )
  {
    ...
    qword_140C49D28 = (__int64)&HalpDmaControllers;
    HalpDmaControllers = (__int64)&HalpDmaControllers;
    qword_140C4BE48 = (__int64)&HalpDmaHibernateAdapters;
    HalpDmaHibernateAdapters = (__int64)&HalpDmaHibernateAdapters;
    qword_140C4BE28 = (__int64)&HalpDmaPdoList;
