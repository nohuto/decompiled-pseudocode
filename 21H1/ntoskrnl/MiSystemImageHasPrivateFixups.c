/*
 * XREFs of MiSystemImageHasPrivateFixups @ 0x1402FDDE4
 * Callers:
...
unsigned __int64 __fastcall MiSystemImageHasPrivateFixups(unsigned __int64 a1, _QWORD *a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  *a2 = 0LL;
  if ( (__int64 *)qword_140C4CC00 == &qword_140C4CC00 )
    return 0LL;
  SystemRegionType = MiGetSystemRegionType(a1);
  if ( SystemRegionType != 12 && SystemRegionType != 1 )
    return 0LL;
  v7 = 0LL;
  v8 = ExAcquireSpinLockShared(&dword_140C4CC24);
  v9 = (__int64 *)qword_140C4CC00;
  v10 = v8;
  while ( v9 != &qword_140C4CC00 )
  {
    v11 = v9[2];
    if ( a1 >= v11 && a1 <= v9[3] )
    {
  ...
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C4CC24);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
