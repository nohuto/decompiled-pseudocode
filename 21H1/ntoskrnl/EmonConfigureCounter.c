/*
 * XREFs of EmonConfigureCounter @ 0x1403879AC
 * Callers:
 *     EmonDisableMonitoring @ 0x1404CE010 (EmonDisableMonitoring.c)
 *     EmonEnableMonitoring @ 0x1404CE0D0 (EmonEnableMonitoring.c)
 *     EmonRestartProfiling @ 0x140993250 (EmonRestartProfiling.c)
 * Callees:
 *     <none>
 */
