/*
 * XREFs of CmLoadDifferencingKey @ 0x14068C83C
 * Callers:
 ...
 *     NtLoadKey2 @ 0x14076CFA0 (NtLoadKey2.c)
                ...
                if ( !v65 || (v17 = CmObReferenceObjectByHandle(v65, 0, v28, PreviousMode, &v46, 0LL), v17 >= 0) )
                {
                  ...
                  if ( v17 >= 0 )
                  {
                    ...
                    else
                    {
                      ...
                      v17 = CmPostCallbackNotificationEx(33, (__int64)v30, v31, (__int64)v68, (__int64)&v61, v57);
                    }
                    if ( v30 )
