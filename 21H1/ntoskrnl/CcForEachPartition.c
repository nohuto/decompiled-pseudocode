/*
 * XREFs of CcForEachPartition @ 0x140202D30
 * Callers:
 *     CcGetDirtyPages @ 0x140202CF0 (CcGetDirtyPages.c)
 ...
 *     CcCoalescingCallBack @ 0x1404E3FC0 (CcCoalescingCallBack.c)
 *     CcIsThereDirtyData @ 0x1404E5300 (CcIsThereDirtyData.c)
