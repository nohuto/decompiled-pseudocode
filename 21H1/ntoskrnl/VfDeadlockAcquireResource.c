/*
 * XREFs of VfDeadlockAcquireResource @ 0x1409DA558
 * Callers:
 ...
 *     VerifierKeAcquireInStackQueuedSpinLockForDpc @ 0x1409D76B0 (VerifierKeAcquireInStackQueuedSpinLockForDpc.c)
 *     VerifierKeAcquireInStackQueuedSpinLockRaiseToSynch @ 0x1409D77B0 (VerifierKeAcquireInStackQueuedSpinLockRaiseToSynch.c)
 *     VerifierKeAcquireSpinLockAtDpcLevel @ 0x1409D7920 (VerifierKeAcquireSpinLockAtDpcLevel.c)
 *     VerifierKeAcquireSpinLockRaiseToDpc @ 0x1409D7990 (VerifierKeAcquireSpinLockRaiseToDpc.c)
 ...
 *     ViKeObjectAcquired @ 0x1409D9194 (ViKeObjectAcquired.c)
 ...
 *     VerifierExTryToAcquireFastMutex @ 0x1409E19C0 (VerifierExTryToAcquireFastMutex.c)
 * Callees:
 ...
 *     ViDeadlockCheckDuplicatesAmongChildren @ 0x1409DC030 (ViDeadlockCheckDuplicatesAmongChildren.c)
 *     ViDeadlockCheckDuplicatesAmongRoots @ 0x1409DC0B0 (ViDeadlockCheckDuplicatesAmongRoots.c)
 ...
 *     ViDeadlockSearchResource @ 0x1409DCCC0 (ViDeadlockSearchResource.c)
 *     ViDeadlockSearchThread @ 0x1409DCD68 (ViDeadlockSearchThread.c)
 *     ViDeadlockSimilarNode @ 0x1409DCDF8 (ViDeadlockSimilarNode.c)
 *     ViDeadlockUpdateChildrenCount @ 0x1409DCEA4 (ViDeadlockUpdateChildrenCount.c)
    ...
    if ( *v19 != (_DWORD)v6 )
    {
      if ( ((unsigned int)(v6 - 3) > 1 || (unsigned int)(v21 - 3) > 1) && (v21 != 7 || (unsigned int)(v6 - 5) > 1) )
      {
        ViDeadlockPreprocessOptions(
          ...
          (const void *)0x1008);
        VfReportIssueWithOptions(0xC4u, 0x1008uLL, a1, *v19, v6, byte_140C12D68);
        goto LABEL_35;
      }
      *v19 = v6;
    }
    ...
    if ( v22 )
    {
      if ( v24 > 1u )
      {
        ...
        ViDeadlockPreprocessOptions(
          ...
          (const void *)0x1000);
        VfReportIssueWithOptions(0xC4u, 0x1000uLL, a1, (ULONG_PTR)v19, v10, &dword_140C12D6C);
LABEL_35:
        v15 = v46;
        v16 = 0;
        goto LABEL_52;
