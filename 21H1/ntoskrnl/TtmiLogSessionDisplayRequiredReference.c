/*
 * XREFs of TtmiLogSessionDisplayRequiredReference @ 0x1408FF4AC
 * Callers:
...
void TtmiLogSessionDisplayRequiredReference()
{
  ...
  if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL) )
    {
      ...
      v10 = 4LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2C8E8, (unsigned __int8 *)byte_14002A671, 0LL, 0LL, 5u, &v6);
    }
  }
}
