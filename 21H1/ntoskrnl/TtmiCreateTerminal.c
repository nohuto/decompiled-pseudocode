/*
 * XREFs of TtmiCreateTerminal @ 0x1408F8E7C
 * Callers:
 ...
 *     TtmiUpdateActiveTerminalCount @ 0x1408FADC8 (TtmiUpdateActiveTerminalCount.c)
...
LABEL_3:
  ...
  LODWORD(v25) = 48;
  v27 = 0LL;
  v16 = ObCreateObjectEx(0, TtmpTerminalObjectType, (__int64)&v25, a3, v24, 288, 0, 0, &DeferredContext, 0LL);
  v12 = v16;
  if ( v16 < 0 )
  {
