/*
 * XREFs of KiSetClockTickRate @ 0x14024089C
 * Callers:
...
__int64 __fastcall KiSetClockTickRate(unsigned int a1, char a2)
{
  ...
  if ( (unsigned int)v11 < dword_140C31594 )
    dword_140C31594 = v11;
  if ( (unsigned int)v11 > dword_140C31590 )
    dword_140C31590 = v11;
  if ( a1 < dword_140C3159C )
    dword_140C3159C = a1;
  if ( a1 > dword_140C31598 )
    dword_140C31598 = a1;
