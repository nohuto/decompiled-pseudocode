/*
 * XREFs of KiProcessControlProtection @ 0x14050CCA0
 * Callers:
 *     KiControlProtectionFault @ 0x140405D00 (KiControlProtectionFault.c)
 * Callees:
 *     KiFixupControlProtectionUserModeReturnMismatch @ 0x1403EC364 (KiFixupControlProtectionUserModeReturnMismatch.c)
