        ...
        unsigned int *a7)
{
  ...
  while ( 1 )
  {
    if ( v9 )
      goto LABEL_33;
    v14 = dword_140C02CA0[6 * v12];
    if ( a2 <= v14 )
      goto LABEL_13;
    if ( !wcsnicmp(pszSrc, off_140C02C90[3 * v12], v14) )
      break;
LABEL_12:
    pszSrc = v25;
LABEL_13:
...
LABEL_31:
  ...
  v11 = a2 + dword_140C02CA4[6 * v12] - dword_140C02CA0[6 * v12];
  ...
  if ( !v12 )
  {
    ...
    {
      if ( *(_WORD *)((char *)&unk_140C048F0 + i * 8) == v15 && *(_WORD *)((char *)&unk_140C048F2 + i * 8) == a6 )
      {
        v17 = 0;
        ...
        v17 = RtlStringCchCatW(a3, a4, (&off_140C048F8)[i]);
        if ( v17 < 0 )
        {
        ...
        v17 = RtlStringCchCatW(a3, a4, &v25[dword_140C02CA0[0]]);
        if ( v17 < 0 )
        {
          v23 = "RtlStringCchCatW failed [%x]";
          v24 = 952;
...
LABEL_11:
  ...
  v17 = RtlStringCchCopyW(a3, v7, (&off_140C02C98)[3 * v12]);
  if ( v17 >= 0 )
  {
    v17 = RtlStringCchCatW(a3, v7, &v25[dword_140C02CA0[6 * v12]]);
    if ( v17 < 0 )
    {
      v23 = "RtlStringCchCatW failed [%x]";
      v24 = 986;
