/*
 * XREFs of PopFxSetDeviceAccountingCsPlatformState @ 0x140566DF4
 * Callers:
...
LABEL_30:
    ...
    v29 = 1;
    return ZwUpdateWnfStateData((__int64)&WNF_PO_DRIPS_DEVICE_CONSTRAINTS_REGISTERED, (__int64)&v29);
  }
  return result;
}
