/*
 * XREFs of PopUpdateOverThrottledCount @ 0x1408E38D4
 * Callers:
 ...
 *     PopDiagTraceThermalOverthrottleState @ 0x14056D654 (PopDiagTraceThermalOverthrottleState.c)
