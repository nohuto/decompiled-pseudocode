/*
 * XREFs of NtQueryInformationThread @ 0x140610870
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PspQueryLastCallThread @ 0x140903918 (PspQueryLastCallThread.c)
 */

int __fastcall NtQueryInformationThread(__m128i *Handle, int a2, __m128i *a3, unsigned int a4, unsigned int *a5)
{
  __int64 v5; // rsi
  __m128i *v6; // r14
  int v8; // ebx
  ...
  int v66; // [rsp+4Ch] [rbp-23Ch]
  struct _PROCESSOR_NUMBER v67; // [rsp+54h] [rbp-234h] BYREF
  __int16 v68; // [rsp+58h] [rbp-230h]
  __m128i *v69; // [rsp+60h] [rbp-228h]
  ...
  unsigned int *v75; // [rsp+98h] [rbp-1F0h]
  ...
  __int32 v80; // [rsp+E8h] [rbp-1A0h]
  unsigned int v81; // [rsp+ECh] [rbp-19Ch]
  unsigned int v82; // [rsp+F0h] [rbp-198h]
  ...
  if ( a2 != 23 )
  {
    ...
    else if ( a2 == 1 )
    {
      if ( (_DWORD)v5 == 32 )
      {
        ...
        if ( result < 0 )
          return result;
        v87.m128i_i64[0] = (unsigned int)KeMaximumIncrement * (unsigned __int64)*((unsigned int *)Object + 163);
        v87.m128i_i64[1] = (unsigned int)KeMaximumIncrement * (unsigned __int64)*((unsigned int *)Object + 183);
      ...
      if ( a2 )
      {
        switch ( a2 )
        {
          ...
          case 21:
            ...
            if ( result < 0 )
              return result;
            v8 = PspQueryLastCallThread(Object, v6, (unsigned int)v5, a5);
            v15 = Object;
            goto LABEL_27;
          case 22:
            if ( (_DWORD)v5 != 4 )
          ...
          case 31:
            ...
            v80 = a3->m128i_i32[0];
            v72[0] = 0LL;
            result = ObReferenceObjectByHandle(Handle, 0x40u, (POBJECT_TYPE)PsThreadType, PreviousMode, v72, 0LL);
            v8 = result;
            if ( result < 0 )
              return result;
            if ( v39 == 3 )
          ...
          case 33:
            ...
            if ( result < 0 )
              return result;
            v67 = (struct _PROCESSOR_NUMBER)0x400000;
            KeSetIdealProcessorThreadByNumber((struct _KTHREAD *)Object, &v67, &v67);
            ObfDereferenceObjectWithTag(Object, 0x79517350u);
            *(struct _PROCESSOR_NUMBER *)v6->m128i_i8 = v67;
            if ( a5 )
              *a5 = 4;
            return 0;
          case 34:
          ...
          case 40:
            ...
            if ( result >= 0 )
            {
              ...
              v51 = (unsigned int)KeMaximumIncrement;
              v6->m128i_i64[0] = (unsigned int)KeMaximumIncrement * (unsigned __int64)v49[163];
