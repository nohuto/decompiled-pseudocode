/*
 * XREFs of CmpLightWeightPrepareSetValueKeyUoW @ 0x140656F34
 * Callers:
        ...
        struct _LOOKASIDE_LIST_EX *a4)
{
  ...
  if ( !v4 )
  {
    v9 = CmpLightWeightCreateSetValueData(a1, &v24, a3, a4);
    if ( v9 < 0 )
      return (unsigned int)v9;
    v4 = (_DWORD *)v24;
    CmpLightWeightUpdateSharedSetValueData(v24, *(_QWORD *)(a1 + 48));
    --*v4;
  }
...
LABEL_30:
    ...
    v24 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(v8 + 8))(
            v8,
...
LABEL_28:
    ...
    CmpInitializeValueNameString(v13, v31, PoolWithTag);
    v32 = v4 + 1;
    if ( !(unsigned __int8)CmpFindNameInList(v8, (int)v4 + 4, (unsigned int)v31, 0, (__int64)&v35, (__int64)&v23)
      || (LODWORD(v22) = v15, v17 = CmpAddValueKeyNew(v8, v22, *(_DWORD *)(a1 + 72)), v17 == -1) )
    {
      v9 = -1073741670;
LABEL_27:
    ...
    if ( v23 != -1 )
    {
      ...
      {
        v30 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(v8 + 8))(v8, v18, v26);
        if ( v30 )
        {
...
LABEL_23:
          ...
          v19 = CmpSwapValueInList(v8, v17, v35, (__int64)v32);
LABEL_21:
          v9 = v19;
          if ( v19 >= 0 )
          {
...
LABEL_25:
    ...
    v19 = CmpAddValueToList(v8, v17, v35, *(_DWORD *)(a1 + 72), (__int64)v32);
    goto LABEL_21;
  }
  v9 = -1073741670;
LABEL_35:
