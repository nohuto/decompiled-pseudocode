/*
 * XREFs of IopGetSetStreamIdentifier @ 0x140500D7C
 * Callers:
 *     IoAllocateSfioStreamIdentifier @ 0x1404FFE10 (IoAllocateSfioStreamIdentifier.c)
 *     IoGetSfioStreamIdentifier @ 0x140500170 (IoGetSfioStreamIdentifier.c)
 * Callees:
