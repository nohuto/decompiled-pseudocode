/*
 * XREFs of MiDbgTranslatePhysicalAddress @ 0x1405406D0
 * Callers:
...
unsigned __int64 __fastcall MiDbgTranslatePhysicalAddress(unsigned __int64 a1, char a2, __int64 a3)
{
  ...
  v3 = qword_140C4E7C8;
  v6 = a1;
  if ( !qword_140C4E7C8 || !(unsigned int)MiCheckPhysicalAddressRange(a1, 1LL) )
    return 0LL;
  v9 = 2LL;
  v10 = v3 << 25 >> 16;
  v11 = v7 >> 12;
  ...
  *(_BYTE *)(a3 + 4) = CurrentIrql;
  ...
  {
    *(_DWORD *)a3 = 8;
    if ( !(unsigned int)ExTryAcquireSpinLockExclusiveAtDpcLevel(&dword_140C4EB80) )
      return 0LL;
  }
  else
  {
    *(_DWORD *)a3 = 16;
    ExAcquireSpinLockExclusiveAtDpcLevel(&dword_140C4EB80);
  }
  v18 = (_QWORD *)*((_QWORD *)&xmmword_140C4EB88 + 1);
  v19 = 3;
  while ( v18 )
  {
    v20 = v18[5];
...
LABEL_67:
  v28 = v12 | 0xA0000000;
  v29 = (volatile signed __int64 *)qword_140C4E7C8;
  ValidPte = MiMakeValidPte(qword_140C4E7C8, v11, v28, v17);
  if ( (a2 & 0x41) != 0 )
    byte_140C4E7C0 = 1;
