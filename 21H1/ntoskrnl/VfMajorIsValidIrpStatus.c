/*
 * XREFs of VfMajorIsValidIrpStatus @ 0x1409D4A70
 * Callers:
...
__int64 __fastcall VfMajorIsValidIrpStatus(_BYTE *a1, unsigned int a2)
{
  ...
  v5 = (unsigned int (__fastcall *)(_BYTE *))*((_QWORD *)&unk_140D490F0 + 12 * v4);
  if ( (!v5 || v5(a1)) && qword_140D49B70 )
    return qword_140D49B70(a1, a2);
  else
    return 0LL;
}
