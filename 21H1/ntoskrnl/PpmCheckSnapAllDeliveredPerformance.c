/*
 * XREFs of PpmCheckSnapAllDeliveredPerformance @ 0x14026EAE0
 * Callers:
...
char PpmCheckSnapAllDeliveredPerformance()
{
  ...
  ULONGLONG v56; // [rsp+90h] [rbp-78h] BYREF
  ...
  ULONGLONG *v62; // [rsp+178h] [rbp+70h]
...
LABEL_30:
            ...
            else
            {
              ...
              if ( PpmEtwRegistered )
              {
                ...
                {
                  v56 = PpmConvertTime(v25, PopQpcFrequency, 0xF4240uLL);
                  v61 = 4LL;
                  v60 = &v51;
                  v62 = &v56;
                  v41 = &v52;
