/*
 * XREFs of PpmPerfApplyProcessorState @ 0x14039563C
 * Callers:
 *     PpmPerfAction @ 0x14026E680 (PpmPerfAction.c)
 *     PpmPerfApplyProcessorStates @ 0x140395450 (PpmPerfApplyProcessorStates.c)
 * Callees:
 *     PpmContinueActiveTimeAccumulation @ 0x14020511C (PpmContinueActiveTimeAccumulation.c)
 ...
 *     PpmGetIdleGenerationCounter @ 0x140560210 (PpmGetIdleGenerationCounter.c)
 */
...
char __fastcall PpmPerfApplyProcessorState(struct _KPRCB *a1, char a2)
{
  ...
  _PROC_PERF_CONSTRAINT *v26; // [rsp+70h] [rbp+8h]
  ...
  if ( KeGetCurrentPrcb() != a1 )
  {
    ...
    {
      LOBYTE(v23) = 1;
      updated = PpmUpdatePerformanceFeedback((__int64)a1, 0, v23, 0, 0LL);
      if ( !updated )
      {
LABEL_30:
        if ( !updated )
...
LABEL_9:
  ...
  {
    _disable();
    v24 = &Constraint->QosUpdateLock;
    v16 = (v25 & 0x200) != 0;
    KxAcquireSpinLock(v24);
  }
  else
  {
    v7 = 0;
