/*
 * XREFs of SeAccessCheckByType @ 0x1402582D0
 * Callers:
 *     NtAccessCheck @ 0x1402FCD00 (NtAccessCheck.c)
 *     NtAccessCheckByType @ 0x140307160 (NtAccessCheckByType.c)
 *     NtAccessCheckByTypeResultList @ 0x140590160 (NtAccessCheckByTypeResultList.c)
 * Callees:
