/*
 * XREFs of KiProcessSecondarySignalList @ 0x140513BF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( (__int64 *)KiSecondarySignalList != &KiSecondarySignalList )
  {
    ...
    if ( *(__int64 **)(v13 + 8) != &v13
      ...
      || *(__int64 **)qword_140C2B428 != &KiSecondarySignalList
      || (*v14 = &KiSecondarySignalList,
          v14 = (__int64 **)qword_140C2B428,
          *(_QWORD *)qword_140C2B428 = &v13,
          v5 = KiSecondarySignalList,
          qword_140C2B428 = (__int64)v4,
          *(__int64 **)(KiSecondarySignalList + 8) != &KiSecondarySignalList)
    ...
    *(_QWORD *)(v5 + 8) = v4;
    qword_140C2B428 = (__int64)&KiSecondarySignalList;
