/*
 * XREFs of RtlIpv6StringToAddressExA @ 0x140586D70
 * Callers:
 *     <none>
 * Callees:
 *     __isascii @ 0x1403CE270 (__isascii.c)
 *     isdigit @ 0x1403CE290 (isdigit.c)
 *     islower @ 0x1403CE2C0 (islower.c)
 *     isxdigit @ 0x1403CE380 (isxdigit.c)
