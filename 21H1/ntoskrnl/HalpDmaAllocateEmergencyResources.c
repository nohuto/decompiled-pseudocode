/*
 * XREFs of HalpDmaAllocateEmergencyResources @ 0x140A5E508
 * Callers:
...
__int64 __fastcall HalpDmaAllocateEmergencyResources(__int64 a1)
{
  ...
  if ( !MemoryDescriptorList )
    return 3221225626LL;
  qword_140C53DF8 = (PMDL)HalpMmAllocCtxAlloc(v1, 56LL);
  v2 = qword_140C53DF8;
  if ( !qword_140C53DF8 )
  {
...
LABEL_10:
  ...
  *(_QWORD *)&v2->ByteCount = 4096LL;
  ...
  qword_140C53E10 = MmAllocateMappingAddress(0x1000uLL, 0x206C6148u);
  if ( qword_140C53E10 )
  {
    qword_140CF2518 = 0LL;
    return 0LL;
  ...
  HalpMmAllocCtxFree(v7, (__int64)qword_140C53DF8);
