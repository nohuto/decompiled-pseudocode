/*
 * XREFs of HalpRegisterKdSupportFunctions @ 0x140A35FD4
 * Callers:
...
__int64 *HalpRegisterKdSupportFunctions()
{
  ...
  result = &qword_140C48CE8;
  qword_140C48CF0 = (__int64)&qword_140C48CE8;
  qword_140C48CE8 = (__int64)&qword_140C48CE8;
