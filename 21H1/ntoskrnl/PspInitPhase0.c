/*
 * XREFs of PspInitPhase0 @ 0x140A3A1E4
 * Callers:
...
char __fastcall PspInitPhase0(PVOID StartContext)
{
  ...
  if ( (unsigned int)PspSystemMitigationOptionsLength < 0x18 )
    memset(
      (void *)(0x140000000LL + (unsigned int)PspSystemMitigationOptionsLength + 13617600LL),
      0,
  ...
  qword_140C1E168 = (__int64)&PsActiveProcessHead;
          ...
          *(_OWORD *)((char *)&v30[1] + 4) = PspActivityReferenceMapping;
          ...
          if ( (int)ObCreateObjectType(&DestinationString, (__int64)v30, 0LL, (__int64)&PspActivityReferenceObjectType) >= 0 )
          {
            if ( (unsigned __int8)PspInitializeJobStructures() )
            {
              ...
              {
                qword_140C13070 = 0LL;
                qword_140C13068 = (__int64)&PspWorkingSetChangeHead;
                ...
                if ( PspCidTable )
                {
                  ...
                  *(_BYTE *)(PspCidTable + 44) |= 1u;
                  qword_140C1E190 = (__int64)PspReaper;
                  qword_140C1E1F0 = (__int64)PspProcessRundownWorker;
