/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1405B7CC8
 * Callers:
...
LABEL_28:
  ...
  else
  {
    ...
    if ( !dword_140CDB01C )
      goto LABEL_35;
    v10 = 972 * dword_140CDB01C + 12;
    if ( v10 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v34 = (__int64 *)qword_140CDB028;
    v35 = a3 + 3;
    v36 = 0;
    for ( i = 0; v34 != &qword_140CDB028; v34 = (__int64 *)*v34 )
    {
      if ( i >= dword_140CDB01C )
        break;
      v38 = v35;
      v39 = v34 + 12;
      v40 = 7LL;
