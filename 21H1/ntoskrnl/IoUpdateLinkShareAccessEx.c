/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x1405E4B30
 * Callers:
 *     IoUpdateShareAccess @ 0x14075EDE0 (IoUpdateShareAccess.c)
 *     IoUpdateLinkShareAccess @ 0x14088FAE0 (IoUpdateLinkShareAccess.c)
 * Callees:
 *     <none>
 */
