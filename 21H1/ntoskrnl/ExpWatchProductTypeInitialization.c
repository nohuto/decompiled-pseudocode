/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x140A3E1A4
 * Callers:
...
char __fastcall ExpWatchProductTypeInitialization(__int64 a1)
{
  ...
  qword_140C192D0 = (__int64)ExpWatchProductTypeWork;
  qword_140C192D8 = 0LL;
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        qword_140C541A0 = ExAllocatePoolWithTag(PagedPool, (unsigned int)BugCheckParameter2, 0x2079654Bu);
        if ( !qword_140C541A0 )
        ...
        if ( (int)NtQueryValueKey(
                    ...
                    (unsigned __int64)&v42,
                    2LL,
                    (unsigned __int64)qword_140C541A0,
                    (size_t)Objectd,
                    (unsigned __int64)&BugCheckParameter2) >= 0
          || (ExFreePoolWithTag(qword_140C541A0, 0), qword_140C541A0 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v11 = -1LL;
          do
