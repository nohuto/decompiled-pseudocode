/*
 * XREFs of AlpcpReceiveLegacyMessage @ 0x140611980
 * Callers:
...
__int64 __fastcall AlpcpReceiveLegacyMessage(struct _DMA_ADAPTER **a1, unsigned __int64 a2, __int64 *a3, _QWORD *a4)
{
  ...
  struct _DMA_ADAPTER *v18; // [rsp+30h] [rbp-68h]
        ...
        *(_QWORD *)(v19 + 200) = v23;
        if ( a2 )
        {
          ...
          *(_QWORD *)(a2 + 32) = *(_QWORD *)(v14 + 272);
          if ( (*(_DWORD *)&v18[16].Version & 0x1000) != 0 )
            *(_WORD *)(a2 + 4) &= 0xC00Fu;
          v15 = (char *)(a2 + 40);
          if ( *(_QWORD *)(v14 + 176) )
        ...
        {
          *(_QWORD *)(v14 + 200) = 0LL;
          AlpcpCancelMessage(v18, v14, 0x10000LL);
        }
        break;
      }
      if ( *(struct _DMA_ADAPTER **)(v19 + 64) == v18 )
      {
        *(_QWORD *)(v19 + 64) = 0LL;
        *(_QWORD *)(v14 + 56) = 0LL;
      }
