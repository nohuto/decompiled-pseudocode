/*
 * XREFs of MiMirrorPerformBrownWrites @ 0x14038A368
 * Callers:
...
__int64 __fastcall MiMirrorPerformBrownWrites(__int64 a1, unsigned __int64 a2, _QWORD *a3)
{
  ...
  while ( 1 )
  {
    SchedulerAssist = v4 & -(__int64)(v4 < qword_140C4E650);
    for ( i = qword_140C4E650 - 1; i - SchedulerAssist == -1LL; i = v20 - 1 )
    {
      v12 = -1LL;
LABEL_46:
      if ( !SchedulerAssist )
      ...
      v20 = v4 + 1;
      SchedulerAssist = 0LL;
      if ( v4 + 1 > qword_140C4E650 )
        v20 = qword_140C4E650;
    }
    a2 = (1LL << (SchedulerAssist & 0x3F)) - 1;
    v10 = (_QWORD *)(qword_140C4E658 + 8 * (SchedulerAssist >> 6));
    for ( j = a2 | ~*v10; j == -1LL; j = ~*v10 )
    {
      if ( (unsigned __int64)++v10 > qword_140C4E658 + 8 * (i >> 6) )
        goto LABEL_43;
    }
    _BitScanForward64(&j, ~j);
    v12 = j + (((__int64)v10 - qword_140C4E658) >> 3 << 6);
    if ( v12 > i )
    {
LABEL_43:
      v12 = -1LL;
...
LABEL_10:
    if ( v12 < v4 || v12 == -1LL )
      goto LABEL_32;
    if ( qword_140C4E650 > v12 )
    {
      v13 = v12;
      SchedulerAssist = qword_140C4E658 + 4 * ((unsigned __int64)(qword_140C4E650 - 1) >> 5);
      i = qword_140C4E658 + 4 * (v12 >> 5);
      if ( i != SchedulerAssist && (*(_DWORD *)i | *((_DWORD *)qword_140011AC0 + (v12 & 0x1F))) == -1 )
      {
        v13 = (v12 & 0xFFFFFFFFFFFFFFE0uLL) + 32;
        for ( i += 4LL; i < SchedulerAssist && *(_DWORD *)i == -1; i += 4LL )
          v13 += 32LL;
      }
      while ( v13 < qword_140C4E650 && _bittest64((const signed __int64 *)qword_140C4E658, v13) )
        ++v13;
      v14 = 0LL;
      if ( i != SchedulerAssist )
      {
        a2 = *(unsigned int *)i;
        if ( ((unsigned int)a2 & ~*((_DWORD *)qword_140011AC0 + (v13 & 0x1F))) == 0 )
        {
          v14 = 32 - (v13 & 0x1F);
          if ( v14 == -1 )
            goto LABEL_26;
      ...
      a2 = qword_140C4E650;
      v15 = v14 + v13;
      if ( v14 + v13 < qword_140C4E650 )
      {
        do
        {
          if ( _bittest64((const signed __int64 *)qword_140C4E658, v15) )
            break;
          if ( v14 == -1 )
            break;
          ++v15;
...
LABEL_27:
    ...
    v21 = v12 & 0x1F;
    a2 = v16;
    v22 = (volatile signed __int32 *)(qword_140C4E668 + 4 * (v12 >> 5));
    if ( v21 + v16 <= 0x20 )
    {
      if ( v16 == 32 )
      {
...
LABEL_100:
  ...
  MiDiscardTransitionPteEx(v27, 0);
LABEL_104:
