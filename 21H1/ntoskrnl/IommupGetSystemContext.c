/*
 * XREFs of IommupGetSystemContext @ 0x1403C7BF4
 * Callers:
 *     IommuGetLibraryContext @ 0x1404D39C0 (IommuGetLibraryContext.c)
 *     IommuGetConfiguration @ 0x140A6C2F0 (IommuGetConfiguration.c)
 *     IommuHvGetConfiguration @ 0x140A8B610 (IommuHvGetConfiguration.c)
 * Callees:
...
LABEL_9:
      if ( HalpHvIommu
        && (!IommupHvSvmEnabled
         || (int)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_140C4A448)(a1, (unsigned int)IommupHvMaximumAsids) < 0) )
      {
        KxReleaseSpinLock(&IommupSystemContextListLock);
        if ( KiIrqlFlags )
        {
