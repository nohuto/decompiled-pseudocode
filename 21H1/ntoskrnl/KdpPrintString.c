...
bool __fastcall KdpPrintString(unsigned __int16 *a1)
{
  ...
  *((_QWORD *)&v5 + 1) = KdpMessageBuffer;
  KdSendPacket(3LL, &v6, &v5, (char *)&KdDebuggerNotPresent + 5);
