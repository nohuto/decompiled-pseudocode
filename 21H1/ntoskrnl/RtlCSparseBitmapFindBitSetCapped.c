/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x1402B358C
 * Callers:
 *     RtlSparseArrayElementAllocated @ 0x1402B3530 (RtlSparseArrayElementAllocated.c)
 *     RtlSparseArrayElementFindCapped @ 0x14058F6F4 (RtlSparseArrayElementFindCapped.c)
 * Callees:
 *     RtlLengthCurrentClearRunBackwardEx @ 0x140582234 (RtlLengthCurrentClearRunBackwardEx.c)
 *     RtlLengthCurrentClearRunForwardEx @ 0x1405822D8 (RtlLengthCurrentClearRunForwardEx.c)
 */
