/*
 * XREFs of KeInsertSchedulingGroup @ 0x1402DC82C
 * Callers:
...
__int64 __fastcall KeInsertSchedulingGroup(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 48) = 0LL;
  ...
  {
    v18 = (_QWORD *)qword_140C31C68;
    if ( *(__int64 **)qword_140C31C68 != &KiSchedulingGroupList )
      goto LABEL_72;
    *v8 = &KiSchedulingGroupList;
    *(_QWORD *)(a1 + 64) = v18;
    *v18 = v8;
    qword_140C31C68 = a1 + 56;
  }
...
LABEL_31:
          KiUpdateCpuTargetByRate((unsigned __int16 *)a1, 0LL, v16, v17);
          goto LABEL_32;
        }
      }
      v33 = 0LL;
