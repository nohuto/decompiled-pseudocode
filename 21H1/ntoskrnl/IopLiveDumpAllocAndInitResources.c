/*
 * XREFs of IopLiveDumpAllocAndInitResources @ 0x14089261C
 * Callers:
 ...
 *     IopLiveDumpResetCorralContext @ 0x1409A9868 (IopLiveDumpResetCorralContext.c)
...
LABEL_44:
  if ( (unsigned int)dword_140C04458 > 5 && tlgKeywordOn((__int64)&dword_140C04458, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&word_1400239F6,
      (const GUID *)(a1 + 864),
      (const GUID *)(a1 + 848),
      7u,
      &v40);
