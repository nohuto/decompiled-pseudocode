/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x14073B0EC
 * Callers:
 *     PnpFindBestConfiguration @ 0x14073B094 (PnpFindBestConfiguration.c)
 * Callees:
 *     IopTestConfiguration @ 0x14073B204 (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x14073B35C (PnpSelectFirstConfiguration.c)
 *     IopAddRemoveReqDescs @ 0x14073B3F0 (IopAddRemoveReqDescs.c)
 *     IopSelectNextConfiguration @ 0x1407BA6C0 (IopSelectNextConfiguration.c)
 *     IopRetestConfiguration @ 0x14089C68C (IopRetestConfiguration.c)
 *     IopSaveRestoreConfiguration @ 0x14089C750 (IopSaveRestoreConfiguration.c)
 */
