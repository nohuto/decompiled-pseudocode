/*
 * XREFs of PiUEventNotifyUserMode @ 0x14068421C
 * Callers:
 *     PnpProcessCustomDeviceEvent @ 0x140683BA0 (PnpProcessCustomDeviceEvent.c)
 ...
 *     PiUEventShouldQueueEvent @ 0x1402DF49C (PiUEventShouldQueueEvent.c)
 ...
 *     PiUEventIsDeviceEventVetoable @ 0x140684BB8 (PiUEventIsDeviceEventVetoable.c)
...
LABEL_36:
    ...
    *(_DWORD *)(v7 + 64) = *(_DWORD *)(a1 + 148) + 8;
    ...
    v11 = (__int64 *)qword_140C45298;
    v12 = (PVOID *)PiUEventUsermodeEventQueue;
    if ( *(PVOID **)qword_140C45298 != &PiUEventUsermodeEventQueue )
      goto LABEL_42;
...
LABEL_17:
      if ( v3 )
      {
        ...
        LODWORD(Size) = 0;
        v18 = v17;
        ZwUpdateWnfStateData((__int64)&WNF_PNPB_AWAITING_RESPONSE, (__int64)&Size);
        if ( v18 )
        {
          if ( v18 == 1 )
          {
