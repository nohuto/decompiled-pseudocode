/*
 * XREFs of RtlpHpLfhSubsegmentFree @ 0x14023798C
 * Callers:
 *     RtlpHpLfhBucketAddSubsegment @ 0x140239674 (RtlpHpLfhBucketAddSubsegment.c)
 *     RtlpHpLfhOwnerCleanup @ 0x1403863D8 (RtlpHpLfhOwnerCleanup.c)
 * Callees:
 *     RtlpHpLfhSubsegmentFindEmptyUnits @ 0x1402395D0 (RtlpHpLfhSubsegmentFindEmptyUnits.c)
