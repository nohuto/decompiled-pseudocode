/*
 * XREFs of CmpInitCmRM @ 0x14065A51C
 * Callers:
...
__int64 __fastcall CmpInitCmRM(__int64 a1, char a2)
{
  ...
  void *v19; // r12
  __int64 v20; // rcx
  NTSTATUS FileSecurityDescriptor; // r14d
...
LABEL_70:
  ...
  *((_DWORD *)v10 + 17) = 0;
  ...
  while ( 1 )
  {
    ...
    v19 = *(void **)(v5 + 1536);
    FileSecurityDescriptor = RtlStringFromGUID((const GUID *const)(*(_QWORD *)(v5 + 64) + 148LL), &GuidString);
    ...
    if ( a1 )
    {
      FileSecurityDescriptor = CmpQueryNameString(*(void **)(a1 + 1536), &Source);
      if ( FileSecurityDescriptor < 0 )
      {
        *(_DWORD *)(v5 + 4200) = 4;
        goto LABEL_99;
...
LABEL_99:
      ...
      *(_DWORD *)(v5 + 4204) = FileSecurityDescriptor;
      return (unsigned int)FileSecurityDescriptor;
    }
    ...
    RtlFreeAnsiString(&Destination);
    CmpLogTxrInitEvent(v41, v5, (unsigned int)FileSecurityDescriptor);
LABEL_83:
    v4 = 1;
    v46 = 1;
  ...
  *(_OWORD *)&v24->Version = 0LL;
  ...
  FileSecurityDescriptor = ClfsMgmtInstallPolicy(pplfoLog, v25, v28);
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v30 >= 0 )
    FileSecurityDescriptor = ZwRecoverTransactionManager((HANDLE)v10[4]);
LABEL_39:
  RtlFreeAnsiString(&Destination);
  if ( FileSecurityDescriptor < 0 )
  {
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  FileSecurityDescriptor = ZwRecoverResourceManager(*v33);
  if ( FileSecurityDescriptor < 0 )
  {
    *(_DWORD *)(v5 + 4200) = 14;
    goto LABEL_99;
...
LABEL_52:
  v10[10] = a1;
  LOCK_CM_RM_LIST();
  v35 = (_QWORD *)qword_140C47AD8;
  if ( *(__int64 **)qword_140C47AD8 != &CmpRmListHead )
    __fastfail(3u);
  *v10 = &CmpRmListHead;
  v10[1] = v35;
  *v35 = v10;
  qword_140C47AD8 = (__int64)v10;
  UNLOCK_CM_RM_LIST();
  if ( v45 )
