/*
 * XREFs of ExpReleaseFastResourceExclusive @ 0x14038C690
 * Callers:
 ...
 *     ExpRotateFastOwnerEntrySublistHead @ 0x14038B5A8 (ExpRotateFastOwnerEntrySublistHead.c)
 *     ExpPrepareToWakeResourceExclusive @ 0x14038C868 (ExpPrepareToWakeResourceExclusive.c)
