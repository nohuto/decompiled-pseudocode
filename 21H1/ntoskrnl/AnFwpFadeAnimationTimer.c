/*
 * XREFs of AnFwpFadeAnimationTimer @ 0x1409EF4C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140CDB061 )
  {
    ...
    v56 = qword_140C10DD8;
    v55 = qword_140C10E50;
    v54 = (_BYTE *)qword_140C10E10;
    v57 = (_BYTE *)qword_140C10E20;
    v10 = 10 * (dword_140C10DD0 - dword_140C10DD0 / (unsigned int)(dword_140C132D4 - dword_140C10DD4));
    v13 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v9 )
      {
        ...
        v32 = 0LL;
        v33 = *(_QWORD *)(v6 + 24);
        for ( i = *(_QWORD *)(qword_140C10E18 + 24);
    ...
    else
    {
      if ( !v9 )
      {
        ...
        v15 = 0LL;
        v16 = *(_QWORD *)(v6 + 24);
        for ( m = *(_QWORD *)(qword_140C10E18 + 24);
    ...
    if ( !v7 )
    {
      if ( !v4 && !v22 || (BgpGxDrawRectangle(v54, (__int64)&xmmword_140C10DF0), !v22) )
        v7 = 1;
    }
    if ( !v8 )
    {
      if ( !v4 && !v30 || (BgpGxDrawRectangle((_BYTE *)v55, (__int64)&xmmword_140C10E28), !v30) )
        v8 = 1;
    }
    ...
    if ( v13 || v30 || v22 )
    {
      byte_140C10DE0 = v7;
      byte_140C10DE1 = v8;
      dword_140C10DD0 = v10 / 0xA;
      dword_140C10DD4 = v4 + 1;
      byte_140C10DE2 = v9;
    }
    else
    {
      byte_140CDB061 = 0;
      KeCancelTimer(&stru_140CF3040);
      KeSetEvent(&stru_140CF3080, 0, 0);
    }
  }
  BgpFwReleaseLock();
}
