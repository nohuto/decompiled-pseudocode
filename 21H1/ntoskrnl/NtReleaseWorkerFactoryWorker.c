/*
 * XREFs of NtReleaseWorkerFactoryWorker @ 0x140245B40
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __cdecl NtReleaseWorkerFactoryWorker(HANDLE WorkerFactoryHandle)
{
  ...
  *(_QWORD *)&v37 = 0LL;
  ...
  {
    v9 = (_QWORD *)_InterlockedExchange64(v5, (__int64)&v37);
    if ( v9 )
      KxWaitForLockOwnerShip((__int64)&v37, v9);
  }
  v10 = v4[2];
  v11 = 0;
  if ( *(_BYTE *)(v10 + 33) )
  ...
  else
  {
    ...
    if ( !(_QWORD)v37 )
    {
      if ( (__int128 *)_InterlockedCompareExchange64(*((volatile signed __int64 **)&v37 + 1), 0LL, (signed __int64)&v37) == &v37 )
        goto LABEL_17;
      v15 = KxWaitForLockChainValid(&v37, (_BYTE)v9);
    }
    *(_QWORD *)&v37 = 0LL;
