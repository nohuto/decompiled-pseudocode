...
__int64 __fastcall AnFwConfigureProgressResources(int *a1)
{
  ...
  v8 = 0LL;
  v5 = 0LL;
  KeInitializeEvent(&stru_140CF3080, NotificationEvent, 1u);
  if ( !a1 )
    return 0LL;
  if ( (a1[6] & 1) == 0 )
    return 0LL;
  if ( (int)BgpFoGetFontHandle(0LL) < 0 )
    return 0LL;
  v4[0] = HIDWORD(qword_140C13450);
  v4[1] = dword_140C13458;
  v6 = a1[5];
  v7 = 1;
  if ( (int)BgpTxtCreateRegion((_DWORD)a1, (int)a1 + 8, (unsigned int)v4, (unsigned int)&v8, 10) < 0 )
    return 0LL;
  BitsPerPixel = BgpGetBitsPerPixel();
  dword_140C132F4 = ((BgpGxRectangleSize(a1[3], a1[2], BitsPerPixel) + 15) & 0xFFFFFFF0) + 128;
  dword_140C132F0 = 122 * dword_140C132F4;
  dword_140C132F8 = BgpTxtRegionSize(v8);
  return v8;
}
