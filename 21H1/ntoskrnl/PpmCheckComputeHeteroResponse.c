/*
 * XREFs of PpmCheckComputeHeteroResponse @ 0x140572180
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140276C20 (KeGetPrcb.c)
 *     KeEnumerateNextProcessor @ 0x1402771F0 (KeEnumerateNextProcessor.c)
 *     PpmParkCalculateUnparkCount @ 0x140304780 (PpmParkCalculateUnparkCount.c)
 *     __security_check_cookie @ 0x1403CC020 (__security_check_cookie.c)
 *     qsort @ 0x1403CE680 (qsort.c)
 *     PpmHeteroUtilityGreaterThanOrEqualThreshold @ 0x14057292C (PpmHeteroUtilityGreaterThanOrEqualThreshold.c)
...
char PpmCheckComputeHeteroResponse()
{
  ...
  v32 = 0LL;
  v31 = 0LL;
  v0 = &PpmCurrentProfile[342 * dword_140C23ECC];
