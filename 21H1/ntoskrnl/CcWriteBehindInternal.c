/*
 * XREFs of CcWriteBehindInternal @ 0x14022CE40
 * Callers:
...
LONG __fastcall CcWriteBehindInternal(__int64 a1)
{
  ...
  unsigned int *v78; // [rsp+50h] [rbp-29h]
  ...
  if ( Partition != *(_QWORD *)(a1 + 128) )
    KeBugCheckEx(0x34u, 0x19C8uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  ...
  while ( 1 )
  {
    ...
    if ( *v19 != -2147483626 && (unsigned __int8)CcIsFatalWriteError(v1) )
    {
      v52 = CcReferenceSharedCacheMapFileObject(v1);
      CcMmLogLostDelayedWriteError(v52, *v19);
