/*
 * XREFs of KiCompleteKernelInit @ 0x1409992B4
 * Callers:
...
__int64 __fastcall KiCompleteKernelInit(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    qword_140C31EF8 = 0LL;
    qword_140C31EF0 = (__int64)&qword_140C31EE8;
    qword_140C31EE8 = (__int64)&qword_140C31EE8;
    KeInitializeTimer2((__int64)&KiForegroundState);
    KeInitializeDpc((PRKDPC)&stru_140C31E68, (PKDEFERRED_ROUTINE)KiProcessPendingForegroundBoosts, 0LL);
    KeInitializeDpc(&stru_140C31EA8, (PKDEFERRED_ROUTINE)KiTriggerForegroundBoostDpc, 0LL);
    ...
    qword_140C31F18 = (__int64)&KiUpdateVpThreadPriorityListHead;
