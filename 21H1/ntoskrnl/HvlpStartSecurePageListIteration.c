/*
 * XREFs of HvlpStartSecurePageListIteration @ 0x1404F5DF4
 * Callers:
 *     HvlDiscardSecurePagesFromHibernation @ 0x1404F2254 (HvlDiscardSecurePagesFromHibernation.c)
 *     HvlIterateSecurePagesForHibernation @ 0x1404F2380 (HvlIterateSecurePagesForHibernation.c)
 *     HvlAddSecurePagesCallbackRoutine @ 0x1404F2E70 (HvlAddSecurePagesCallbackRoutine.c)
 *     HvlpGetEncryptedDataFromSecureKernel @ 0x1404F3824 (HvlpGetEncryptedDataFromSecureKernel.c)
 * Callees:
