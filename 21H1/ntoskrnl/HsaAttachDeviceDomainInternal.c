/*
 * XREFs of HsaAttachDeviceDomainInternal @ 0x1404DCEE8
 * Callers:
 *     HsaAttachDeviceDomain @ 0x1404DCED0 (HsaAttachDeviceDomain.c)
 *     HsaDetachDeviceDomain @ 0x1404DD3E0 (HsaDetachDeviceDomain.c)
 * Callees:
