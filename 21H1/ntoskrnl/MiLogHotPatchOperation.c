/*
 * XREFs of MiLogHotPatchOperation @ 0x1408C6E08
 * Callers:
...
char __fastcall MiLogHotPatchOperation(__int64 a1, int a2, int a3, int a4, int *a5, unsigned __int16 *a6, int a7)
{
  ...
  if ( *(_QWORD *)&qword_140C4EE20 )
  {
    LOBYTE(v7) = MiFillLogProcessInfo(
                   ...
                   &v32,
                   &v31);
    v12 = *(_QWORD *)&qword_140C4EE20;
    if ( **(_DWORD **)&qword_140C4EE20 > 5u )
    {
      LOBYTE(v7) = tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 0x400000000020LL);
      if ( (_BYTE)v7 )
      {
        ...
        v34 = 2164260864LL;
        v71 = &v34;
        LOBYTE(v7) = tlgWriteEx_EtwWriteEx(v12, (unsigned __int8 *)&byte_140025467, v15, 1u, v17, v18, 0x15u, &v35);
      }
    }
  }
  return (char)v7;
