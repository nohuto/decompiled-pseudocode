/*
 * XREFs of MiFillNoReservationCluster @ 0x14030FC38
 * Callers:
...
__int64 __fastcall MiFillNoReservationCluster(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  do
  {
    ...
    if ( v7 != v5[2] )
      goto LABEL_7;
    if ( !a1[259]
      || !(unsigned int)MI_PFN_IS_PROTO(48 * v7 - 0x58000000000LL, a2, a3)
...
LABEL_7:
    ...
    {
LABEL_28:
      v22 = MiReferencePageForModifiedWrite(48 * v7 - 0x58000000000LL);
      _InterlockedAnd64((volatile signed __int64 *)(v8 + 24), 0x7FFFFFFFFFFFFFFFuLL);
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
