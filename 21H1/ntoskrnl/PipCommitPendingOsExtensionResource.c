/*
 * XREFs of PipCommitPendingOsExtensionResource @ 0x140A8E9F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PipCommitPendingOsExtensionResource(const WCHAR *a1, char *a2, void *a3)
{
  ...
  HANDLE v11; // [rsp+48h] [rbp-28h] BYREF
  ...
  if ( CachedContextBaseKey >= 0 )
  {
    ...
    if ( CachedContextBaseKey >= 0 )
    {
      CachedContextBaseKey = PnpCtxRegCreateKey(*(__int64 *)&PiPnpRtlCtx, v12, a1, 0, 0x20006u, 0LL, &v11, 0LL);
      if ( CachedContextBaseKey >= 0 )
      {
