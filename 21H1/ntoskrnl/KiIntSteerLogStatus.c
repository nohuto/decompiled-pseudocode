/*
 * XREFs of KiIntSteerLogStatus @ 0x14051CD1C
 * Callers:
 *     KiIntSteerEventTraceControlCallback @ 0x1407BF4D0 (KiIntSteerEventTraceControlCallback.c)
 * Callees:
...
char __fastcall KiIntSteerLogStatus(char a1)
{
  ...
  {
    v11[1] = (unsigned __int16 *)qword_140CFC838[0];
