/*
 * XREFs of IopCopyBootLogRegistryToFile @ 0x14077A748
 * Callers:
...
_QWORD *IopCopyBootLogRegistryToFile()
{
  ...
  if ( qword_140D2C038 )
  {
    ...
    IopBootLogToFile(&qword_140D2C038[3]);
    ...
    {
      for ( i = 0; i < LODWORD(qword_140D2C038[10].Buffer); ++i )
      {
        ...
        {
          P = 0LL;
          RegistryValue = IopGetRegistryValue(KeyHandle, &word_1407C1980, 256, &P);
          v4 = P;
          if ( RegistryValue >= 0 )
          {
      ...
      ZwClose(TimeFields);
      v5 = qword_140D2C038;
      BYTE4(qword_140D2C038[10].Buffer) = 1;
    }
