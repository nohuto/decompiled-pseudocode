/*
 * XREFs of MiCreateLargePfnList @ 0x14055840C
 * Callers:
...
__int64 __fastcall MiCreateLargePfnList(__int64 a1, unsigned __int64 a2, char a3, __int64 *a4, char *a5)
{
  ...
  v5 = a2;
  v7 = 0;
  v8 = *(_QWORD *)(qword_140C4E588 + 8LL * KeGetCurrentThread()->ApcState.Process[1].IdealProcessorPadding[5]);
  if ( a4 )
  {
    v9 = *a4;
    v8 = *a4;
  ...
  v13 = (unsigned int *)(qword_140C4DDD8 + 4LL * v11 * (unsigned __int16)KeNumberNodes);
  v14 = (v12 >> 18) & 3;
