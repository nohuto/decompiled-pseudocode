...
LABEL_39:
        ...
        v40 = Size + 6 + v24 - 12;
        v25 = ExAllocatePoolWithTag(NonPagedPoolNx, v40, 0x72766E45u);
        P = v25;
        if ( !v25 )
          goto LABEL_35;
        v26 = v25;
        ...
        if ( Size_4 )
        {
          for ( i = 0; i <= 0xFFFF; ++i )
          {
            ...
            v31 = 0;
            EnvironmentVariable = IoGetEnvironmentVariableEx(Dst, (__int64)&EfiDriverVariablesGuid, 0LL, &v31, 0LL);
...
LABEL_57:
        ...
        EnvironmentVariable = IoSetEnvironmentVariableEx(Dst, (__int64)&EfiDriverVariablesGuid, (__int64)P, v40, 1);
        goto LABEL_57;
      }
    }
LABEL_59:
