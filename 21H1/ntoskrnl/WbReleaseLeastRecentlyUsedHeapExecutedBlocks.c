/*
 * XREFs of WbReleaseLeastRecentlyUsedHeapExecutedBlocks @ 0x1406D56C8
 * Callers:
  ...
  if ( a2 > 0 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        v16 = *(_QWORD *)(v14 + 48);
        v21 = 0LL;
        if ( (int)sub_1406D5844((int)a1 + 8, v16, 8, -1, (__int64)&v21) >= 0 )
          sub_14065F4D0(a1, v21);
      }
