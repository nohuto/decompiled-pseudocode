/*
 * XREFs of KeRemovePriQueue @ 0x140225BC0
 * Callers:
 ...
 *     KiGetDueTimeWithThreadTimerDelay @ 0x14051CF70 (KiGetDueTimeWithThreadTimerDelay.c)
 */
        ...
        __int64 a4)
{
  ...
  $A4B5D2C1751CB7039976B0B68C9462E1 *v11; // r14
  int v12; // ebp
  ...
  unsigned int v71; // [rsp+98h] [rbp+20h] BYREF
      ...
      if ( v29 )
      {
        ...
        if ( (_DWORD)QueuePriority != v71 )
        {
          ...
          if ( !v37 )
          {
            ...
            _InterlockedIncrement((volatile signed __int32 *)&v38[22].WaitListHead + (int)v71);
            v30 = v71;
          }
...
LABEL_26:
      ...
      if ( v32->DeferredReadyListHead.Next )
        KiProcessThreadWaitList(v32, 1LL, 0LL);
      LOBYTE(Queue) = 1;
