/*
 * XREFs of HalpAcpiPreSleep @ 0x14099175C
 * Callers:
 *     HaliAcpiSleep @ 0x140382C30 (HaliAcpiSleep.c)
 * Callees:
 *     HalpAcpiPmRegisterWrite @ 0x140379A20 (HalpAcpiPmRegisterWrite.c)
 *     HalpAcpiPmRegisterAvailable @ 0x140379CE0 (HalpAcpiPmRegisterAvailable.c)
 *     HalpPreserveNvsArea @ 0x1403831D0 (HalpPreserveNvsArea.c)
 *     KeSynchronizeTimeToQpc @ 0x140383240 (KeSynchronizeTimeToQpc.c)
 ...
 *     HalpSaveDmaControllerState @ 0x1409918F0 (HalpSaveDmaControllerState.c)
 */
...
void *__fastcall HalpAcpiPreSleep(int a1)
{
  ...
  {
    HalpAcpiPmRegisterRead(0, (unsigned __int8)byte_140C49FF8 >> 1, (__int64)&v10, 2u, 0LL);
    v6 = v10;
    v9 = v10;
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
    {
      HalpAcpiPmRegisterRead(3, (unsigned __int8)byte_140C49FF8 >> 1, (__int64)&v10, 2u, 0LL);
      v6 = v10 | v9;
      v9 |= v10;
    }
    if ( (dword_140C4A010 & 0x40) == 0 )
    {
    ...
    HalpAcpiPmRegisterWrite(0, (unsigned __int8)byte_140C49FF8 >> 1, (__int64)&v9, 2u, 0LL);
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      HalpAcpiPmRegisterWrite(3, (unsigned __int8)byte_140C49FF8 >> 1, (__int64)&v9, 2u, 0LL);
