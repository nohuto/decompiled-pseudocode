/*
 * XREFs of VfAllocateCrashDumpRegisters @ 0x1409C7D70
 * Callers:
 *     <none>
 * Callees:
 *     HalAllocateCrashDumpRegisters @ 0x1404B3780 (HalAllocateCrashDumpRegisters.c)
 *     VfDisableHalVerifier @ 0x14059B3D8 (VfDisableHalVerifier.c)
