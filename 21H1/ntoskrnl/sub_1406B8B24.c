/*
 * XREFs of sub_1406B8B24 @ 0x1406B8B24
 * Callers:
...
__int64 __fastcall sub_1406B8B24(__int64 *a1)
{
  ...
  v1 = (unsigned __int8 *)&unk_140D2CB8E;
  v2 = (unsigned __int8 *)&unk_140D2CB6E;
  ...
  do
  {
    ...
    if ( (unsigned __int8)v8 < 0x1Fu )
      v7 ^= funcs_1405D6C33[v8](v4 + 1, *(v2 - 2), *(v2 - 1), *v2, v2[1], (__int64)&v17, v6);
    v9 = *v1;
    if ( (unsigned __int8)v9 < 0x1Fu )
      v6 ^= funcs_1405D6C33[v9](v4, *(v2 - 6), *(v2 - 5), *(v2 - 4), *(v2 - 3), (__int64)&v17, v7);
    v4 -= 2LL;
    v1 -= 2;
    v2 -= 8;
    --v5;
