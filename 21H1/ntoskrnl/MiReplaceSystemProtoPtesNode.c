/*
 * XREFs of MiReplaceSystemProtoPtesNode @ 0x1405523C0
 * Callers:
...
__int64 __fastcall MiReplaceSystemProtoPtesNode(unsigned __int64 *a1, _QWORD *a2)
{
  ...
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4CA78, (unsigned __int64)v7, v6, a2);
  a2[3] |= 8uLL;
