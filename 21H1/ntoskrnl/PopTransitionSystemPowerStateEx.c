...
__int64 __fastcall PopTransitionSystemPowerStateEx(unsigned int *a1)
{
  ...
  *((_QWORD *)a1 + 46) = 0LL;
  ...
  v6 = *a1;
  v75 = 6;
  if ( (unsigned int)(v6 - 1) > 6 || (a1[2] & 0xCFFFFC0) != 0 || dword_140C23414 >= 16 && v6 < 4 )
    return 3221225485LL;
...
LABEL_20:
      ...
      while ( 1 )
      {
        ...
        *((_BYTE *)a1 + 144) = PopAction;
        ...
        if ( v17 == -1073741536 )
        {
          if ( (a1[36] & 2) != 0 && (dword_140C2340C & 0x80000000) == 0 && (dword_140C2340C & 3) != 0 )
          {
            PopGetPolicyWorker(2);
            goto LABEL_81;
          }
          PopActionRetrieveInitialState((_DWORD *)&qword_140C23404 + 1, a1 + 7, &dword_140C23420, (_BYTE *)a1 + 88);
          if ( (unsigned int)(qword_140C23404 - 4) <= 2 )
          {
            byte_140C23402 = 1;
            dword_140C2340C = a1[2];
          }
          a1[26] = 0;
          v17 = 0;
        }
...
LABEL_44:
        ...
        if ( !*v14
          || (v23 = PopSetDevicesSystemState(), a1[26] = v23, (int)(v23 + 0x80000000) < 0)
          || v23 == -1073741536 )
        {
          if ( (a1[26] & 0x80000000) == 0 )
          {
            ...
            if ( HiberContext >= 0 )
            {
              ...
              if ( !byte_140C23402 )
              {
                PopDiagTracePreSleepNotification(a1[11], dword_140C23428, dword_140C23414, dword_140C23418, a1[29]);
              ...
              inited = PopInitSystemSleeperThread(v26, (struct _KEVENT *)a1 + 11);
              a1[26] = inited;
              if ( inited >= 0 )
              {
                if ( !byte_140C234B0 )
                ...
                *((_QWORD *)a1 + 28) = 0LL;
                ...
                else if ( !byte_140C23620 && dword_140C23414 != 14 )
                {
                  ...
                  if ( *((_QWORD *)a1 + 27) )
                  {
                    if ( *((_QWORD *)a1 + 28) == -2LL )
                    {
                      if ( *v53 )
                      {
                        qword_140C23468 = *((_QWORD *)a1 + 27);
                        qword_140C23478[0] = *((_QWORD *)a1 + 28);
                      }
                      if ( *v54 )
                      {
                        qword_140C23480 = *((_QWORD *)a1 + 27);
                        qword_140C23490 = *((_QWORD *)a1 + 28);
                      }
                    }
                    else
                    {
                  ...
                  v56 = qword_140C234B8;
                  *((_QWORD *)a1 + 10) = qword_140C234B8;
                  if ( v56 )
                  {
                    if ( v56 < *((_QWORD *)a1 + 24) + 20000000LL )
                      v56 = *((_QWORD *)a1 + 24) + 20000000LL;
                    *((_QWORD *)a1 + 10) = v56;
                  }
                  if ( *v53 )
                  {
                ...
                if ( qword_140C23468 && qword_140C23468 < *((_QWORD *)a1 + 24) + (unsigned __int64)a1[97] )
                  qword_140C23470[0] = *((_QWORD *)a1 + 24) + a1[97];
                qword_140C23488 = qword_140C23480;
                if ( qword_140C23480 && qword_140C23480 < *((_QWORD *)a1 + 24) + (unsigned __int64)a1[97] )
                  qword_140C23488 = *((_QWORD *)a1 + 24) + a1[97];
                ...
                *((_QWORD *)a1 + 43) = MEMORY[0xFFFFF78000000008];
                ...
                if ( (a1[26] & 0x80000000) != 0 && dword_140C23420 == 5 )
                {
