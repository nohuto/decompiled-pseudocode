/*
 * XREFs of HalpDmaAllocateMapRegisters @ 0x1404C159C
 * Callers:
 ...
 *     HalpDmaAllocateScatterPagesFromContiguousPool @ 0x1404B35B4 (HalpDmaAllocateScatterPagesFromContiguousPool.c)
 *     HalpDmaAllocateScatterPagesFromScatterPool @ 0x1404B360C (HalpDmaAllocateScatterPagesFromScatterPool.c)
 *     HalpDmaAllocateContiguousMemory @ 0x1404C1498 (HalpDmaAllocateContiguousMemory.c)
 *     HalpDmaPrependTranslations @ 0x1404C2A10 (HalpDmaPrependTranslations.c)
 *     HalpDmaReturnPageToOwner @ 0x1404C2BEC (HalpDmaReturnPageToOwner.c)
