/*
 * XREFs of Normalization__IsNormalized @ 0x140913694
 * Callers:
 ...
 *     Normalization__CanCombineWithStartBase @ 0x14091325C (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x1409132A8 (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x1409133DC (Normalization__GetLastChar.c)
 */
