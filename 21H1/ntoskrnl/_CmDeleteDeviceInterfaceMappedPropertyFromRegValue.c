/*
 * XREFs of _CmDeleteDeviceInterfaceMappedPropertyFromRegValue @ 0x140720CA0
 * Callers:
...
__int64 __fastcall CmDeleteDeviceInterfaceMappedPropertyFromRegValue(__int64 a1, const WCHAR *a2, void *a3, __int64 a4)
{
