/*
 * XREFs of KseQueryDeviceDataList @ 0x1408BABA0
 * Callers:
...
__int64 __fastcall KseQueryDeviceDataList(PCWSTR SourceString, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  v13 = 0LL;
  if ( dword_140C50514 != 2 || (KseEngine & 2) != 0 )
...
LABEL_11:
    ...
    KsepCacheLock(qword_140C50558);
    v9 = KsepCacheLookup(qword_140C50558, (__int64)v14);
    v13 = v9;
    v10 = v9;
    if ( v9 )
      RegistryDeviceDataList = KsepDbCacheQueryDeviceDataList(v9, a2, a3, a4);
    KsepCacheUnlock(qword_140C50558);
    if ( !v10 )
      goto LABEL_11;
  }
  return (unsigned int)RegistryDeviceDataList;
