/*
 * XREFs of HalpMceRecoveryMemoryErrorIntel @ 0x1404CB07C
 * Callers:
 *     HalpMceRecoveryRequired @ 0x1404CB378 (HalpMceRecoveryRequired.c)
 * Callees:
 *     HalpHvMceConsumedMemoryErrorRecovery @ 0x1404BCD1C (HalpHvMceConsumedMemoryErrorRecovery.c)
 *     HalpMceMemoryErrorRecovery @ 0x1404CAE78 (HalpMceMemoryErrorRecovery.c)
 */
