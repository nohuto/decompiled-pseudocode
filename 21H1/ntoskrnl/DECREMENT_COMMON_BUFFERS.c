/*
 * XREFs of DECREMENT_COMMON_BUFFERS @ 0x1409C6D4C
 * Callers:
...
void __fastcall DECREMENT_COMMON_BUFFERS(__int64 a1)
{
  ...
  if ( v4 > v3 )
  {
    ViHalPreprocessOptions(byte_140C12CA0, "Freed too many common buffers.", 3LL, v4 - v3, 0LL, 0LL);
    VfReportIssueWithOptions(0xE6u, 3uLL, v4 - *(_DWORD *)(a1 + 172), 0LL, 0LL, byte_140C12CA0);
  }
}
