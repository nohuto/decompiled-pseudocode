/*
 * XREFs of PoBroadcastSystemState @ 0x14098E5D0
 * Callers:
 ...
 *     PopMapInternalActionToIrpAction @ 0x140380804 (PopMapInternalActionToIrpAction.c)
 ...
 *     PopUpdateSmbiosData @ 0x140765AB0 (PopUpdateSmbiosData.c)
 *     PopDiagTraceDevicesWakeEnd @ 0x140765C5C (PopDiagTraceDevicesWakeEnd.c)
 *     IoNotifyPowerOperationVetoed @ 0x14089B640 (IoNotifyPowerOperationVetoed.c)
 ...
 *     PopSetupSleepNotifies @ 0x140990AB4 (PopSetupSleepNotifies.c)
 *     PopHandleWakeSources @ 0x140993A80 (PopHandleWakeSources.c)
 *     PopBootLoaderSiData @ 0x1409945A4 (PopBootLoaderSiData.c)
...
__int64 __fastcall PoBroadcastSystemState(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = (char *)qword_140C233B0;
  v32 = *(_BYTE *)(a1 + 25);
  v4 = v32;
  *(_BYTE *)qword_140C233B0 = *(_BYTE *)(a1 + 26);
...
LABEL_3:
  ...
  if ( (xmmword_140CFC490 & 0x8000) != 0 )
  {
    ...
    BYTE4(v33) = v32;
    v36[1] = 8LL;
    EtwTraceKernelEvent((__int64)v36, 1u, 0x80008000, 0x1224u, 0x401802u);
  }
...
LABEL_37:
    ...
    v15 = *(_DWORD *)(a1 + 16);
    if ( v15 == 4 && (PopShutdownPowerOffPolicy || *(_QWORD *)&qword_140C23430) )
    {
      v16 = 4LL;
    }
    else
...
LABEL_38:
    ...
    *((_DWORD *)v6 + 1) = 1;
    if ( *(_BYTE *)(a1 + 26) != 2
      || (PopDiagTraceEventNoPayload(&POP_ETW_EVENT_DEVICESWAKE),
          qword_140C23918 = KeQueryPerformanceCounter(0LL).QuadPart,
          *v6 == 2) )
    {
      if ( v11 )
        PopFxActivateDevicesForSx(1u);
    ...
    do
    {
      ...
      if ( v25 == 1 && *(_BYTE *)(a1 + 26) == 2 && !v11 )
      {
        ...
        {
          if ( qword_140C23440 && *(_QWORD *)(qword_140C23440 + 216) )
            PopBootLoaderSiData();
          PopUpdateSmbiosData(
            *(_BYTE *)(*(_QWORD *)(qword_140C23440 + 200) + 980LL),
            *(_BYTE *)(*(_QWORD *)(qword_140C23440 + 200) + 981LL),
            *(_DWORD *)(*(_QWORD *)(qword_140C23440 + 200) + 976LL),
            *(_QWORD *)(*(_QWORD *)(qword_140C23440 + 200) + 968LL));
        }
        if ( dword_140C23428 == 5 )
    ...
    {
      PopFxIdleDevicesFromSx();
      qword_140C23920 = KeQueryPerformanceCounter(0LL).QuadPart;
  ...
  if ( (xmmword_140CFC490 & 0x8000) != 0 )
  {
    ...
    v37[1] = 4LL;
    v37[0] = &v34;
    EtwTraceKernelEvent((__int64)v37, 1u, 0x80008000, 0x1225u, 0x401802u);
  }
  if ( v4 && *(_BYTE *)(a1 + 26) == 2 )
