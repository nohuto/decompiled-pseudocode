 ...
 *     CmpGetSectionLineIndexValueCount @ 0x140A483B4 (CmpGetSectionLineIndexValueCount.c)
 *     EmpInfParseGetGuidFromName @ 0x140A4885C (EmpInfParseGetGuidFromName.c)
 *     EmpInfParseGetSectionLineCount @ 0x140A48908 (EmpInfParseGetSectionLineCount.c)
 *     CmpGetSectionLineIndex @ 0x140A48E74 (CmpGetSectionLineIndex.c)
 *     CmpGetKeyName @ 0x140A48F94 (CmpGetKeyName.c)
 *     EmpInfParseSearchDependencyList @ 0x140A491CC (EmpInfParseSearchDependencyList.c)
 */
...
__int64 __fastcall EmpParseRules(__int64 a1)
{
  ...
  if ( SectionLineCount )
  {
    do
    {
      ...
      if ( !KeyName )
        return 0;
      PoolWithTag = ExAllocatePoolWithTag(PagedPool, 0x68uLL, 0x74694D45u);
          ...
          *(_QWORD *)(v7 + 56) = v18;
          ...
          if ( v14 > 2 )
          {
            while ( 1 )
            {
              ...
              GuidFromName = EmpInfParseGetGuidFromName(a1, "EntryTypeGuidDef", v20, &v33);
              if ( GuidFromName < 0 )
                break;
            ...
            if ( !v15 )
            {
              ...
              do
              {
                ...
                if ( *(v29 - 1) == v7 )
                {
                  if ( v29 )
                    *(_QWORD *)(v28 + 72) = *v29;
                  ExFreePoolWithTag(v29 - 1, 0x74694D45u);
                }
                v27 += 8LL;
                --v26;
              }
