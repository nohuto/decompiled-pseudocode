/*
 * XREFs of HsaUpdateDeviceTableEntry @ 0x1404DEDC8
 * Callers:
 ...
 *     HsaSetDevicePasidTable @ 0x1404DECE0 (HsaSetDevicePasidTable.c)
 * Callees:
 ...
 *     HsaInvalidateDTE @ 0x1404DE63C (HsaInvalidateDTE.c)
 */
