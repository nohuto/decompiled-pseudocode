/*
 * XREFs of CmpLoadKeyCommon @ 0x1402E1B78
 * Callers:
 ...
 *     CmpSetGlobalQuotaAllowed @ 0x1406EDDF0 (CmpSetGlobalQuotaAllowed.c)
...
LABEL_6:
  ...
  *((_QWORD *)P + 201) = v24;
  *v24 = v25;
  qword_140D2D920 = (__int64)(P + 1600);
  CmpUnlockHiveList();
  CmpUnlockRegistry();
  CmpAttachToRegistryProcess(v38);
