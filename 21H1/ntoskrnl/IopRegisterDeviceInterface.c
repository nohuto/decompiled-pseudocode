/*
 * XREFs of IopRegisterDeviceInterface @ 0x14072DB00
 * Callers:
...
LABEL_4:
    ...
    && (DeviceInterfaceName = PiDmAddCacheReferenceForObject(5LL, v47, &v36), DeviceInterfaceName >= 0) )
  {
          ...
          DeviceInterfaceName >= 0) )
    {
      ...
      {
LABEL_22:
        PiDmListAddObject(0LL, v38, v16, 0LL);
        v17 = v32;
        do
          ++v13;
        ...
        {
          PiDmListAddObject(1LL, v37, v16, 0LL);
          if ( v36 )
            PiDmListAddObject(2LL, v36, v16, 0LL);
        }
        goto LABEL_27;
      }
...
LABEL_27:
  ...
  {
    if ( !v33 )
      DeviceInterfaceName = CmSetDeviceInterfacePathFormat(v21, (WCHAR *)*a5, 1);
    v7 = (unsigned int *)v36;
    v8 = (unsigned int *)v37;
    v9 = (unsigned int *)v38;
    goto LABEL_31;
