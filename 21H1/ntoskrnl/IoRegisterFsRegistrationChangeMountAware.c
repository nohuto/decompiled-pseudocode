/*
 * XREFs of IoRegisterFsRegistrationChangeMountAware @ 0x1407B3FE0
 * Callers:
 *     IoRegisterFsRegistrationChange @ 0x14088F830 (IoRegisterFsRegistrationChange.c)
 * Callees:
...
LABEL_5:
  if ( (__int64 *)IopFsNotifyChangeQueueHead != &IopFsNotifyChangeQueueHead
    && *(PDRIVER_OBJECT *)(qword_140C45BC8 + 16) == DriverObject
    && *(PDRIVER_FS_NOTIFICATION *)(qword_140C45BC8 + 24) == DriverNotificationRoutine )
  {
...
LABEL_9:
  ...
  v13 = (_QWORD *)qword_140C45BC8;
  if ( *(__int64 **)qword_140C45BC8 != &IopFsNotifyChangeQueueHead )
    __fastfail(3u);
  *PoolWithTag = &IopFsNotifyChangeQueueHead;
  PoolWithTag[1] = v13;
  *v13 = PoolWithTag;
  qword_140C45BC8 = (__int64)PoolWithTag;
