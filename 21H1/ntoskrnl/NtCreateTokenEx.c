        ...
        __int64 a17)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( v33 || v21 != 2 )
    {
      ...
      if ( a10 && v24 >= 0 )
      {
        v24 = SepCaptureTokenSecurityAttributesInformation(a10, (_DWORD *)&v37 + 1, 1, PreviousMode, 0, &P);
        v36 = v24;
      }
      if ( v17 && v24 >= 0 )
      {
        v24 = SepCaptureTokenSecurityAttributesInformation(v17, (_DWORD *)&v37 + 1, 1, PreviousMode, 0, &v47);
        v36 = v24;
      }
      if ( v70 && v24 >= 0 )
      {
