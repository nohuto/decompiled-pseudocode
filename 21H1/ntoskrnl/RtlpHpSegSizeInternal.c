/*
 * XREFs of RtlpHpSegSizeInternal @ 0x14058F500
 * Callers:
 *     RtlpHpSizeHeapInternal @ 0x14058EF50 (RtlpHpSizeHeapInternal.c)
 * Callees:
 *     RtlpHpLfhSubsegmentSizeBlock @ 0x14058F590 (RtlpHpLfhSubsegmentSizeBlock.c)
 *     RtlpHpVsChunkSize @ 0x14058FB6C (RtlpHpVsChunkSize.c)
 */
