/*
 * XREFs of MiPfnsWorthTrying @ 0x14027F530
 * Callers:
 *     MiFindContiguousPages @ 0x14027EAE0 (MiFindContiguousPages.c)
 *     MiFindRebuildCandidate @ 0x14054C31C (MiFindRebuildCandidate.c)
...
__int64 __fastcall MiPfnsWorthTrying(unsigned __int16 *a1, unsigned __int64 a2, __int64 a3, int a4, _DWORD *a5)
{
  __int64 v6; // rdx
  ...
  unsigned __int16 v38; // [rsp+70h] [rbp+8h]
  ...
  *a5 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( (v11 & 0x1000000000LL) != 0 )
    {
      ...
      if ( v39 == 6 )
      {
        v34 = v7 - 48 * (v6 & -MiLargePageSizes[PfnPageSizeIndexUnsynchronized]) + 0x58000000000LL;
        return v34 / 48;
      }
      v9 = v37;
    }
...
LABEL_61:
    ...
    if ( v13 > 4 )
    {
      ...
      if ( (a4 & 0x800000) != 0 )
      {
        if ( (unsigned int)MI_PFN_IS_PROTO(a2, v29, v12) )
        {
...
LABEL_65:
  ...
  if ( (unsigned int)MiIsPageOnBadList(a2, v6, v12, v9) )
    goto LABEL_73;
  if ( (_DWORD)v12 != -1 )
  {
LABEL_21:
