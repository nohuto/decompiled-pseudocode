/*
 * XREFs of IoCheckFunctionAccess @ 0x14074B930
 * Callers:
 *     <none>
 * Callees:
 *     SeQuerySecurityAccessMask @ 0x1406BA8B8 (SeQuerySecurityAccessMask.c)
 *     SeSetSecurityAccessMask @ 0x1406C6208 (SeSetSecurityAccessMask.c)
 */
