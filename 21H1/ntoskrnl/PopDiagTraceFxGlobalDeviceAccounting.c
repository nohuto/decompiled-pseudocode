/*
 * XREFs of PopDiagTraceFxGlobalDeviceAccounting @ 0x14056CA9C
 * Callers:
...
void __fastcall PopDiagTraceFxGlobalDeviceAccounting(__int64 a1)
{
  ...
  if ( !PopDiagFxAccountingTelemetryDisabled && (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      v15 = v3;
      v7 = v4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)byte_14002771D, 0LL, 0LL, 7u, &v8);
    }
  }
}
