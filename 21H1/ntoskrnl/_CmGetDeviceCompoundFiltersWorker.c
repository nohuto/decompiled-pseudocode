/*
 * XREFs of _CmGetDeviceCompoundFiltersWorker @ 0x14097574C
 * Callers:
        ...
        __int64 a10)
{
  ...
  v30 = 0LL;
  NumberOfBytes = 0LL;
  if ( (int)PnpCtxRegQueryInfoKey(0LL, a4, (int)&v29, 0, 0LL, 0LL, 0LL) < 0 || !(_DWORD)v29 )
    goto LABEL_46;
  if ( *(_DWORD *)(a5 + 16) != 22 )
    goto LABEL_8;
...
LABEL_46:
  ...
  else if ( v24 == -1073741275 )
  {
    ...
    v14 = (wchar_t *)v13;
LABEL_28:
    ObjectProperty = CmGetDeclarativeFilterList(a1, a4, (wchar_t *)v30, v14, (__int64)v13, 0LL, 0, &NumberOfBytes);
    if ( !ObjectProperty )
