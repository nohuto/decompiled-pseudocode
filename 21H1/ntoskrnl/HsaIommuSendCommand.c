/*
 * XREFs of HsaIommuSendCommand @ 0x1404DE738
 * Callers:
 *     HsaDismissPageFault @ 0x1404DD400 (HsaDismissPageFault.c)
 *     HsaFlushDeviceTbOnly @ 0x1404DD680 (HsaFlushDeviceTbOnly.c)
...
unsigned __int64 __fastcall HsaIommuSendCommand(unsigned __int64 *a1, unsigned __int64 *a2, int a3)
{
  ...
  if ( v13 == ((*(_QWORD *)(v8 + 0x2000) >> 4) & 0x7FFFLL) )
  {
    do
    {
      if ( (++v12 & dword_140C4A35C) != 0 || !qword_140C4A360 )
      {
        _mm_pause();
      }
      else
      {
        qword_140C4A360(v12, v11, v14);
        v8 = v26;
      }
    }
  ...
  *(_QWORD *)(v8 + 8200) = ((unsigned int)v9 ^ (16 * (_DWORD)v15)) & 0x7FFF0 ^ v9;
  ...
  if ( (_BYTE)result == 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !result )
        break;
      if ( (++v18 & dword_140C4A35C) != 0 || !qword_140C4A360 )
        _mm_pause();
      else
        qword_140C4A360(v18, v11, v14);
    }
  }
  if ( !a3 )
  {
