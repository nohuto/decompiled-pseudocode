/*
 * XREFs of sub_14095B8B0 @ 0x14095B8B0
 * Callers:
...
__int64 __fastcall sub_14095B8B0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // esi
...
LABEL_46:
  if ( v10 >= 0 )
  {
    ...
    if ( qword_140D2C448 )
    {
      ...
      if ( !v4 )
        v38 = Src;
      v39 = qword_140D2C448(v24, v23, v30, v29, v38, v9, &v81);
    }
    else
    {
      v39 = -1073741637;
