/*
 * XREFs of ViThunkRecoverPristines @ 0x1409D6124
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1409D5844 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x1409D6618 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1409D6700 (ViThunkReplaceSpecialPristine.c)
 */
