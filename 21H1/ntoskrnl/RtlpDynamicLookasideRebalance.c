/*
 * XREFs of RtlpDynamicLookasideRebalance @ 0x1402EC260
 * Callers:
 *     ExpScanSystemLookasideList @ 0x1402EC010 (ExpScanSystemLookasideList.c)
 * Callees:
 *     RtlpLookasideAdjustDepth @ 0x1402EC3A8 (RtlpLookasideAdjustDepth.c)
