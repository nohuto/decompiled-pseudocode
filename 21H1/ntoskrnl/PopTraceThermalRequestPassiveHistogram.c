/*
 * XREFs of PopTraceThermalRequestPassiveHistogram @ 0x140387008
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x140387584 (PopDiagSnapPassiveHistogram.c)
      ...
      if ( (int)PoStoreDiagnosticContext(*(_QWORD *)(a1 + 24), PoolWithTag, NumberOfBytes) >= 0 )
      {
          ...
          && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_140026FAB,
            0LL,
            0LL,
            7u,
            &v9);
