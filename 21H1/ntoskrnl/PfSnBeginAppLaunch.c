/*
 * XREFs of PfSnBeginAppLaunch @ 0x14064E8A0
 * Callers:
 ...
 *     PfSnCheckScenario @ 0x14064EAAC (PfSnCheckScenario.c)
 ...
 *     PfSnFindImageFileName @ 0x140650AE0 (PfSnFindImageFileName.c)
...
LABEL_17:
  ...
  *(_DWORD *)&SubStr[30] = a3 + v14;
  if ( (dword_140C50490 & 0x20) != 0 || v21 == 2 )
    v7 |= 2u;
