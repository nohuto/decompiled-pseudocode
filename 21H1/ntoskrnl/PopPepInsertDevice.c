/*
 * XREFs of PopPepInsertDevice @ 0x1403BA568
 * Callers:
...
_QWORD *__fastcall PopPepInsertDevice(__int64 a1, __int64 *a2)
{
  ...
  v4 = (__int64 **)qword_140C21638;
  if ( *(__int64 **)qword_140C21638 != &PopPepDeviceList )
    __fastfail(3u);
  a2[1] = qword_140C21638;
  *a2 = (__int64)&PopPepDeviceList;
  *v4 = a2;
  qword_140C21638 = (__int64)a2;
...
LABEL_19:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v6, (__int64)&PopPepDeviceListLock, &v24);
