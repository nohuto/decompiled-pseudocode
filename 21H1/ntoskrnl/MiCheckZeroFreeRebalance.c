/*
 * XREFs of MiCheckZeroFreeRebalance @ 0x1402EAA00
 * Callers:
 ...
 *     MiGetNodeStandbyPageCount @ 0x14054AC68 (MiGetNodeStandbyPageCount.c)
 */
...
unsigned __int64 __fastcall MiCheckZeroFreeRebalance(__int64 a1, unsigned int a2)
{
  ...
  v19 = a2 >> byte_140C4DDCC;
  v3 = *(_QWORD *)(a1 + 16) + 4544LL * (a2 >> byte_140C4DDCC);
  v18 = 0;
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v18 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140C4DDCD);
  v4 = (__int64 *)(v3 + 4128);
  result = 0LL;
  v6 = 0;
  for ( i = 0LL; i <= 1; ++i )
