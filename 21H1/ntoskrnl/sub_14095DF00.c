/*
 * XREFs of sub_14095DF00 @ 0x14095DF00
 * Callers:
...
__int64 __fastcall sub_14095DF00(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // r12
  signed int v8; // ebx
  unsigned int *v9; // rcx
...
LABEL_39:
  ...
  if ( v23 + 1 >= v23 )
  {
    ...
    if ( (_DWORD)v33 )
      v34 = v23 + 1;
    v35 = qword_140D2C410 ? qword_140D2C410(v28, v34, v33, &v57) : -1073700223;
    v36 = *(_DWORD *)(a2 + 32);
