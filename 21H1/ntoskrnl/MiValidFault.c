/*
 * XREFs of MiValidFault @ 0x140334E00
 * Callers:
 ...
 *     MI_IS_PTE_SHADOW_STACK @ 0x140541EA0 (MI_IS_PTE_SHADOW_STACK.c)
    ...
    if ( (v3 & 0x10) != 0 )
    {
      if ( v11 < 0 )
      {
        if ( (unsigned int)MiCanGrantExecute(Process, v2) == 1
          && (*(_QWORD *)(48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v41) >> 12) & 0xFFFFFFFFFLL)
                        - 0x57FFFFFFFD8LL) & 0x4000000000000LL) != 0 )
        {
          ...
          v21 = v20;
          v16 = v42;
          MiWriteValidPteNewProtection((unsigned __int64)v42, v21);
          if ( (MiFlags & 0x100) == 0 && (MiFlags & 0x200) == 0 )
...
LABEL_115:
        if ( v36 && (MiFlags & 0x100) == 0 && (MiFlags & 0x200) == 0 )
        {
          ...
          KeFlushSingleTb(v2, v35, 0LL);
        }
        goto LABEL_32;
      }
      v29 = 48 * v27 - 0x58000000000LL;
      v30 = *(_QWORD *)(v29 + 16);
      if ( v29 + 16 >= v23 && v29 + 16 <= v24 && (unsigned int)MiPteHasShadow() )
      {
        if ( (v30 & 1) == 0 )
          goto LABEL_87;
      ...
      {
LABEL_93:
        if ( (unsigned int)MI_PFN_IS_PROTO(v29, v30, v28) && (*v34 & 0x400LL) != 0 )
          MiCheckAndUpdateIoAttribution(v33);
        goto LABEL_96;
      }
LABEL_87:
      if ( (!v30 || !qword_140C4DE80 || (v30 & qword_140C4DE80) != 0) && (v30 & 0x400) == 0 )
      {
        LOBYTE(v30) = (unsigned __int8)v30 >> 2;
        if ( (v30 & 1) != 0 )
          MiLockPageAndSetDirty(v29, 1LL, v28);
      }
      goto LABEL_93;
    }
  ...
  v15 = MiCopyOnWrite(v2, (ULONG_PTR *)v6, 0xFFFFFFFFFFFFFFFFuLL, 0);
  v13 = v15;
  if ( v15 >= 0 )
  {
    v16 = v42;
