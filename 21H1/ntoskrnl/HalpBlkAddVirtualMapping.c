/*
 * XREFs of HalpBlkAddVirtualMapping @ 0x140A8BA4C
 * Callers:
 *     HalpBlkAllocateAndShadowMemory @ 0x140A8BB88 (HalpBlkAllocateAndShadowMemory.c)
 *     HalpBlkAllocateShadowCode @ 0x140A8BD08 (HalpBlkAllocateShadowCode.c)
 *     HalpBlkShadowApic @ 0x140A8BF08 (HalpBlkShadowApic.c)
 *     HalpBlkShadowStartupBlock @ 0x140A8BF5C (HalpBlkShadowStartupBlock.c)
 * Callees:
 *     HalpRemapVirtualAddress64 @ 0x140303750 (HalpRemapVirtualAddress64.c)
