/*
 * XREFs of CmpLightWeightCommitDeleteKeyUoW @ 0x14087A91C
 * Callers:
...
void __fastcall CmpLightWeightCommitDeleteKeyUoW(__int64 a1, _QWORD *a2, __int64 a3)
{
    ...
    && tlgKeywordOn((__int64)&dword_140C02130, 0x200000000000LL) )
  {
    ...
    v18 = 0x1000000LL;
    v24 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)byte_140022C69, 0LL, 0LL, 4u, &v19);
  }
