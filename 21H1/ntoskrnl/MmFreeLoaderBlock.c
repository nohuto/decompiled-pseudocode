/*
 * XREFs of MmFreeLoaderBlock @ 0x140A3F76C
 * Callers:
...
void MmFreeLoaderBlock()
{
  ...
  bool v48; // zf
  unsigned __int8 v49; // [rsp+20h] [rbp-168h]
  unsigned int v50; // [rsp+24h] [rbp-164h]
  __int64 v51; // [rsp+28h] [rbp-160h]
  BOOL v52; // [rsp+30h] [rbp-158h]
  __int64 TransitionPte; // [rsp+38h] [rbp-150h] BYREF
  __int64 v54; // [rsp+40h] [rbp-148h]
  unsigned __int64 v55; // [rsp+48h] [rbp-140h]
  unsigned __int64 *v56; // [rsp+50h] [rbp-138h]
  __int64 v57; // [rsp+58h] [rbp-130h]
  char *AnyMultiplexedVm; // [rsp+60h] [rbp-128h]
  _QWORD *v59; // [rsp+68h] [rbp-120h]
  __int64 v60; // [rsp+70h] [rbp-118h]
  __int64 v61; // [rsp+78h] [rbp-110h]
  __int64 *v62; // [rsp+80h] [rbp-108h]
  _QWORD v63[24]; // [rsp+90h] [rbp-F8h] BYREF
...
LABEL_14:
          ...
          v27 = v61;
          v60 = 0LL;
          v52 = MiPteInShadowRange((unsigned __int64)&TransitionPte);
          v29 = v55;
          ...
          while ( 1 )
          {
            ...
            *v56 = v33;
            ...
            if ( v26 != v34 )
            {
              if ( v26 )
              {
                MiFlushTbList((__int64)v63, v28);
                MiFreeRegistryPageRange(v54, v51);
                MiUnlockPageTableInternal((__int64)v12, v26, v46);
              }
            ...
            v35 = TransitionPte;
            MiMarkPfnTradable(v30, 0LL, v36);
            WsleContents = MiGetWsleContents(v37, v33);
            MiWriteWsle(v39, v33, WsleContents & 0xF0 | 0xA);
            if ( v52
              && (MiFlags & 0xC00000) != 0
...
LABEL_41:
            *(_QWORD *)v31 = v42;
            ...
            v51 = v44;
            MiInsertTbFlushEntry((__int64)v63, v55, 1LL, 0);
            ++v29;
            v30 = v57 + 48;
            v57 += 48LL;
            if ( v29 >= v11[4] )
            {
              ...
              MiUnlockPageTableInternal((__int64)v12, v26, v45);
              goto LABEL_14;
            }
          }
        }
LABEL_16:
        ...
        if ( _InterlockedCompareExchange64(&qword_140C4EE10, v8, 0LL) )
        {
          qword_140C4EE10 = v8;
          MmFreeBootRegistry();
        }
