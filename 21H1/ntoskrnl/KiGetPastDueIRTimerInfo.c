/*
 * XREFs of KiGetPastDueIRTimerInfo @ 0x14051DF74
 * Callers:
...
__int64 __fastcall KiGetPastDueIRTimerInfo(unsigned __int64 a1, _BYTE *a2, _BYTE *a3)
{
  ...
  if ( a1 < qword_140C31D10 )
    return 0LL;
  if ( (qword_140C31D08 & 1) != 0 )
  {
    if ( qword_140C31D08 == 1 )
      v3 = 0LL;
    else
      v3 = qword_140C31D08 ^ ((unsigned __int64)&unk_140C31D00 + 1);
  }
  else
  {
    v3 = qword_140C31D08;
