/*
 * XREFs of KiMcheckAbort @ 0x140404940
 * Callers:
 *     KiMcheckAbortShadow @ 0x140A119C0 (KiMcheckAbortShadow.c)
 * Callees:
 ...
 *     KiSetSpecCtrlNmi @ 0x1403F9B00 (KiSetSpecCtrlNmi.c)
