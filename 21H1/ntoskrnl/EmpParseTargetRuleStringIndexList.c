/*
 * XREFs of EmpParseTargetRuleStringIndexList @ 0x140A48B9C
 * Callers:
 *     EmpParseTargetRules @ 0x140A4895C (EmpParseTargetRules.c)
 * Callees:
 *     RtlStringCbCopyNA @ 0x1403B23C4 (RtlStringCbCopyNA.c)
 *     strchr @ 0x1403CF2B0 (strchr.c)
 *     RtlCharToInteger @ 0x140788F10 (RtlCharToInteger.c)
