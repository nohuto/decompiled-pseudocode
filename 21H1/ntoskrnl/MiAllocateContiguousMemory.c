/*
 * XREFs of MiAllocateContiguousMemory @ 0x1402F8FFC
 * Callers:
 *     MmAllocateContiguousNodeMemory @ 0x1402F8F60 (MmAllocateContiguousNodeMemory.c)
 *     MmAllocateContiguousMemory @ 0x14052BBC0 (MmAllocateContiguousMemory.c)
 * Callees:
        ...
        unsigned int a6)
{
  ...
  if ( !a4 || (v15 = 0, v14 <= a4) )
  {
    ...
    if ( v8 <= v52 && v8 + v14 > v8 && v8 + v14 - 1 <= v52 )
    {
      ...
      v23 = (_DWORD *)(qword_140C4DDD8 + 4LL * v22 * (unsigned __int16)KeNumberNodes);
      if ( v21 == 0x80000000 )
...
LABEL_20:
      v49 = 135266304;
      v25 = (unsigned int *)(qword_140C4DDD8 + 4LL * v22 * (unsigned __int16)KeNumberNodes);
