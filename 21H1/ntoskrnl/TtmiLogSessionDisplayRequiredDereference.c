/*
 * XREFs of TtmiLogSessionDisplayRequiredDereference @ 0x1408FF320
 * Callers:
...
void TtmiLogSessionDisplayRequiredDereference()
{
  ...
  if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL) )
    {
      ...
      v10 = 4LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2C8E8, (unsigned __int8 *)word_14002AA6A, 0LL, 0LL, 5u, &v6);
    }
  }
}
