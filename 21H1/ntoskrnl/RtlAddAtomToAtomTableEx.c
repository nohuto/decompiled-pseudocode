/*
 * XREFs of RtlAddAtomToAtomTableEx @ 0x1402A8F50
 * Callers:
 *     NtAddAtomEx @ 0x1406CF0B0 (NtAddAtomEx.c)
 *     RtlAddAtomToAtomTable @ 0x1406E8960 (RtlAddAtomToAtomTable.c)
 * Callees:
 *     RtlpReferenceAtom @ 0x1402A9188 (RtlpReferenceAtom.c)
