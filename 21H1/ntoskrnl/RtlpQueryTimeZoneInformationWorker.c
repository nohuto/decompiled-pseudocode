/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x14067CC40
 * Callers:
 ...
 *     RtlQueryTimeZoneInformation @ 0x140910A40 (RtlQueryTimeZoneInformation.c)
 * Callees:
...
__int64 __fastcall RtlpQueryTimeZoneInformationWorker(char *a1, size_t Size)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_DWORD *)a1 + 38) = -16;
    ...
    RegistryValues = RtlpQueryRegistryValues(0x40000000LL, Handle, v13, 0LL);
