/*
 * XREFs of SepSecureBootSetRegistryKey @ 0x140A6CDF8
 * Callers:
...
__int64 __fastcall SepSecureBootSetRegistryKey(__int64 a1)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_1400097D0;
    ObjectAttributes.Length = 48;
    ObjectAttributes.Attributes = 576;
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v2 >= 0 )
    {
      if ( (dword_140C5453C & 8) != 0 )
      {
        Data = dword_140C5453C & 1;
        v2 = ZwSetValueKey(Handle, (PUNICODE_STRING)&stru_140009780, 0, 4u, &Data, 4u);
        if ( v2 < 0 )
          goto LABEL_4;
        if ( Data )
      ...
      if ( a1 )
      {
        ...
        if ( v2 >= 0 )
        {
          v2 = ZwSetValueKey(
                 Handle,
                 (PUNICODE_STRING)&stru_140009790,
                 0,
                 1u,
                 UnicodeString.Buffer,
                 UnicodeString.Length + 2);
          if ( v2 >= 0 )
            v2 = ZwSetValueKey(Handle, (PUNICODE_STRING)&stru_1400097A0, 0, 4u, (PVOID)(a1 + 20), 4u);
        }
      }
    }
  }
