/*
 * XREFs of MiComputeOptimalZeroPath @ 0x140A4CF20
 * Callers:
...
ULONG_PTR MiComputeOptimalZeroPath()
{
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( v1 >= 2 )
    {
      v43 = 2LL;
      v9 = &v48;
      v42 = (unsigned __int64 *)&unk_140C4DF28;
      v10 = 0LL;
      v52 = &v48;
      v51 = 0LL;
      do
      {
        ...
        do
        {
          ...
          MiZeroPhysicalPage(v11, 3, v13, SchedulerAssist);
          _InterlockedOr(v41, 0);
          v16 = __rdtsc();
        ...
        do
        {
          ...
          MiZeroPhysicalPage(v19, 3, v13, v22);
        ...
        if ( v28 / 3 < 9 * (v45 / 0xA) )
        {
          v30 = (unsigned __int64)dword_140C4DEDC;
          dword_140C4DEDC[4 * v13] = 1;
        }
        v10 = v26 + 8;
        *(v18 - 1) = v29;
        v9 = v27 + 1;
