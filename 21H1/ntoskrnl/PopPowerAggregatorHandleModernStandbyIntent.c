/*
 * XREFs of PopPowerAggregatorHandleModernStandbyIntent @ 0x1408E9CD0
 * Callers:
 *     PopPowerAggregatorHandleIntentUnsafe @ 0x140761F74 (PopPowerAggregatorHandleIntentUnsafe.c)
 * Callees:
 *     PopPowerAggregatorAllowModernStandbyPromotion @ 0x1408E98EC (PopPowerAggregatorAllowModernStandbyPromotion.c)
 *     PopPowerAggregatorGetModernStandbySessionType @ 0x1408E9BC8 (PopPowerAggregatorGetModernStandbySessionType.c)
 */
