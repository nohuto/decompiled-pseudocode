/*
 * XREFs of PopPublishAndPurgePowerRequestStats @ 0x1408F1D3C
 * Callers:
 ...
 *     PoQueryStopWatch @ 0x14033E9D0 (PoQueryStopWatch.c)
 *     __security_check_cookie @ 0x1403CC020 (__security_check_cookie.c)
 *     PopDiagTraceSleepStudyBlocker @ 0x14056D5E4 (PopDiagTraceSleepStudyBlocker.c)
 *     PoResetStopWatch @ 0x14057A0C4 (PoResetStopWatch.c)
    ...
    if ( StopWatchByRequestType )
    {
      ...
      if ( (unsigned int)dword_140C021E8 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&word_140028BB6,
          0LL,
          0LL,
          7u,
          &v36);
