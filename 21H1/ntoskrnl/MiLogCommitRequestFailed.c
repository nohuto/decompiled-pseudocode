/*
 * XREFs of MiLogCommitRequestFailed @ 0x1408D2A94
 * Callers:
 ...
 *     PsQueryJobMemoryUsageByProcess @ 0x140904208 (PsQueryJobMemoryUsageByProcess.c)
 */
...
char __fastcall MiLogCommitRequestFailed(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_QWORD *)&qword_140C4EE20 )
  {
    ...
    if ( (v3 & 0x400) == 0 )
    {
      ...
      {
        LOBYTE(v3) = tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 0x400000000000LL);
        if ( (_BYTE)v3 )
        {
          v31 = v13;
          v38 = &v33;
          ...
          v32 = v15;
          v63 = 8LL;
          LOBYTE(v3) = tlgWriteEx_EtwWriteEx(v14, (unsigned __int8 *)&word_140025622, 0LL, 1u, 0, 0, 0xFu, &v37);
        }
      }
    }
  }
