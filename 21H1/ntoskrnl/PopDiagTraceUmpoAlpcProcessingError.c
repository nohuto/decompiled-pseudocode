/*
 * XREFs of PopDiagTraceUmpoAlpcProcessingError @ 0x1408E75B4
 * Callers:
...
void PopDiagTraceUmpoAlpcProcessingError()
{
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      v1 = v0;
      v4 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)byte_1400261F1, 0LL, 0LL, 3u, &v2);
    }
  }
}
