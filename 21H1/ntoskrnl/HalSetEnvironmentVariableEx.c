/*
 * XREFs of HalSetEnvironmentVariableEx @ 0x1404B67D0
 * Callers:
 ...
 *     WheapPersistPageForMemoryError @ 0x1405B5E90 (WheapPersistPageForMemoryError.c)
 *     IopSetEnvironmentVariableHal @ 0x1408967F0 (IopSetEnvironmentVariableHal.c)
