/*
 * XREFs of PopMarkHiberPhase @ 0x1409AD8F8
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140C23630, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140C235F8, (unsigned int)dword_140C23600, 0);
