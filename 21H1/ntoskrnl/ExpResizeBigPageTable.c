/*
 * XREFs of ExpResizeBigPageTable @ 0x140371BE0
 * Callers:
...
__int64 __fastcall ExpResizeBigPageTable(char a1, __int64 a2, _QWORD *a3)
{
  ...
  _QWORD *v48; // [rsp+98h] [rbp+20h] BYREF
  ...
  *a3 = 0LL;
  ...
  if ( v5 )
  {
    v6 = *(_QWORD **)(qword_140C4DD20 + 992);
    v7 = (int *)(qword_140C4DD20 + 864);
    v8 = *(_QWORD *)(qword_140C4DD20 + 1000);
  ...
  {
    if ( ExpPoolBigEntriesInUse != PoolBigPageTableSize || (unsigned int)ExpResizeBigPageTable(512LL, 1LL, &v48) )
    {
      v18 = PoolBigPageTable;
      v17 = PoolBigPageTableSize - 1;
      goto LABEL_16;
    }
    HeapFromVA = (__int128 *)ExGetHeapFromVA(v13, v37, v38);
    RtlpHpFreeHeap(HeapFromVA, v13, 0, 0LL);
    return 0LL;
  }
  v18 = v13;
LABEL_16:
  ...
  *(_DWORD *)(v18 + 8 * v20 + 12) = v21;
  ...
  if ( v5 )
  {
    *(_QWORD *)(qword_140C4DD20 + 992) = v13;
    *(_QWORD *)(qword_140C4DD20 + 1000) = v9;
  }
  else
  {
