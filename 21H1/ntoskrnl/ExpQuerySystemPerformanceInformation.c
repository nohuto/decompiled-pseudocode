/*
 * XREFs of ExpQuerySystemPerformanceInformation @ 0x1405DA2D0
 * Callers:
 *     ExpQuerySystemInformation @ 0x1405E5DF0 (ExpQuerySystemInformation.c)
 * Callees:
 *     MiFreePoolPagesLeft @ 0x14020351C (MiFreePoolPagesLeft.c)
 *     MiMaximumCommitmentAvailable @ 0x14020354C (MiMaximumCommitmentAvailable.c)
 ...
 *     MmGetSystemPageCounts @ 0x140203FFC (MmGetSystemPageCounts.c)
 ...
 *     ExQueryPoolUsage @ 0x140204084 (ExQueryPoolUsage.c)
...
void *__fastcall ExpQuerySystemPerformanceInformation(unsigned int a1, void *a2, unsigned int a3)
{
  ...
  if ( v50 > v49 )
    LODWORD(v50) = v49;
  v101 = v50;
  Src[0] = (unsigned int)KeMaximumIncrement * (unsigned __int64)(unsigned int)PsQueryRuntimeProcess(PsIdleProcess, v113);
  ExQueryPoolUsage(
    (int)&v94,
    (int)&v94 + 4,
    (int)&v94 + 8,
