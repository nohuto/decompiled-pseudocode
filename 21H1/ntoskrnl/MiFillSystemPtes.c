/*
 * XREFs of MiFillSystemPtes @ 0x140274CE0
 * Callers:
 ...
 *     MiIoPagesInRun @ 0x140315434 (MiIoPagesInRun.c)
...
LABEL_9:
  ...
  else
  {
    ...
    if ( LeafVa >= 0xFFFF800000000000uLL )
    {
      ...
      {
        if ( LeafVa < qword_140C4FA78 || (v16 = HIBYTE(word_140C4DF48), LeafVa > qword_140C4E2A8) )
          v16 = (unsigned __int8)word_140C4DF48;
      }
      else
      {
        v16 = BugCheckParameter4;
  ...
  v23 = ((unsigned __int16)((unsigned __int8)word_140C4DF48 << 8) ^ v21) & 0x100;
  if ( (ProtectionPfnCompatible & 0x40000000) == 0 )
    v22 = v18;
  v24 = v22 ^ v23;
...
LABEL_103:
    ...
    if ( !*(_WORD *)(v32 + 32)
      && (!(_DWORD)v33 || (*(_BYTE *)(v32 + 34) & 7) != 5 || !MiIsPfnFileOnly(48 * v29 - 0x58000000000LL)) )
    {
      MiShowBadMapper(v29);
    }
    if ( (unsigned int)MI_PFN_IS_PROTO(48 * v29 - 0x58000000000LL, v33, v27) )
      goto LABEL_85;
    v36 = *(_QWORD *)(v32 + 40);
