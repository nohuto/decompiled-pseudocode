/*
 * XREFs of CmpTransSearchAddLightWeightTrans @ 0x140656A44
 * Callers:
 ...
 *     CmpBindHiveToTrans @ 0x140656CF4 (CmpBindHiveToTrans.c)
...
LABEL_20:
        ...
        *(_DWORD *)(v18 + 48) = 128;
        v19 = (__int64 *)qword_140C47D28;
        if ( *(__int64 **)qword_140C47D28 != &CmpLightTransactionList )
          __fastfail(3u);
