/*
 * XREFs of KdpCreateRemoteFile @ 0x1409B3BD0
 * Callers:
  ...
  if ( i < 0x10 )
  {
    while ( 1 )
    {
      ...
      *(_WORD *)((char *)&KdpMessageBuffer + (unsigned __int16)(v14 + 2) - 2) = 0;
      KdSendPacket(11LL, v16, &v15, (char *)&KdDebuggerNotPresent + 5);
      if ( (_BYTE)KdDebuggerNotPresent )
        break;
      WORD1(v15) = 4096;
      *((_QWORD *)&v15 + 1) = &KdpMessageBuffer;
      v11 = KdReceivePacket(11LL, v16, &v15, &v14, (char *)&KdDebuggerNotPresent + 5);
      v8 = &KdpMessageBuffer;
      if ( !v11 )
      {
        v12 = HIDWORD(v17[0]);
