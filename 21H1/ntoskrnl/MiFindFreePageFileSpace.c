/*
 * XREFs of MiFindFreePageFileSpace @ 0x14034CC50
 * Callers:
 ...
 *     MiFindFreePageFileSpaceForward @ 0x140305D08 (MiFindFreePageFileSpaceForward.c)
 ...
 *     RtlLengthCurrentClearRunForward @ 0x14034F54C (RtlLengthCurrentClearRunForward.c)
...
LABEL_17:
      ...
      {
        v34 = RtlLengthCurrentClearRunForward(a2 + 24, (unsigned int)v7, (unsigned int)a3);
        v21 = a3;
        v33 = v4 & 0x40;
        if ( v34 != (_DWORD)a3 && !v33
          || (v35 = RtlLengthCurrentClearRunForward(*(_QWORD *)(v8 + 112) + 8LL, (unsigned int)v7, v34),
              v21 = a3,
              v26 = v35,
              v35 != (_DWORD)a3)
          && !v33 )
...
LABEL_42:
          if ( v26 )
          {
            ...
            *v61 = MiTransferSoftwarePte(*v61, v8, (unsigned int)v7, v28);
            return v26;
          }
          goto LABEL_88;
        }
