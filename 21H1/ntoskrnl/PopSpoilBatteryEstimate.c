/*
 * XREFs of PopSpoilBatteryEstimate @ 0x14076D1D8
 * Callers:
 *     PopSpoilEstimatesOnPowerStateTransitionWorker @ 0x140765CA0 (PopSpoilEstimatesOnPowerStateTransitionWorker.c)
  ...
  if ( a1 < 2 )
  {
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)byte_140028671,
               0LL,
               0LL,
               4u,
               &v9);
