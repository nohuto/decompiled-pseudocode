/*
 * XREFs of PnpWatchdogEtwWrite @ 0x1408A7474
 * Callers:
 ...
 *     PnpWatchdogExtractTriageInformation @ 0x140509490 (PnpWatchdogExtractTriageInformation.c)
 *     PnpWatchdogGetElapsedTime @ 0x140509578 (PnpWatchdogGetElapsedTime.c)
 */
