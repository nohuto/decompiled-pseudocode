/*
 * XREFs of ExpNtUpdateWnfStateData @ 0x140667EEC
 * Callers:
...
LABEL_44:
    ...
    v11 = ExpCrossVmWnfPush(v16, 1, (unsigned int)&v44, -1, (__int64)v41, v32);
    if ( v11 != -1073741822 )
      goto LABEL_26;
  }
  ...
  v11 = ExpWnfWriteStateData((__int64)v33, v41, v22, a6, a7);
  if ( v11 >= 0 )
  {
    if ( (_DWORD)v10 == 5 )
    {
    ...
    ExpWnfNotifyNameSubscribers((__int64)v33, 1u, 1, PreviousMode != 0);
    v11 = 0;
  }
LABEL_26:
  if ( v33 )
