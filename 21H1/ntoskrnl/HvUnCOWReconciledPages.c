/*
 * XREFs of HvUnCOWReconciledPages @ 0x1402E2188
 * Callers:
 *     CmpFlushHive @ 0x140664FA8 (CmpFlushHive.c)
 * Callees:
 *     RtlMergeBitMaps @ 0x1402E1944 (RtlMergeBitMaps.c)
 *     HvpViewMapUnCOWAndSealRange @ 0x140691CB8 (HvpViewMapUnCOWAndSealRange.c)
 */
...
void __fastcall HvUnCOWReconciledPages(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 160) & 0x20000) != 0 )
  {
    ...
    if ( *(struct _KTHREAD **)(a1 + 4232) == KeGetCurrentThread() )
      RtlMergeBitMaps(a1 + 1728, (unsigned int *)(a1 + 1680));
    v3 = *v2;
    v4 = 0LL;
    while ( v3 )
    {
    ...
    if ( v8 && v8 != KeGetCurrentThread() )
      RtlMergeBitMaps((__int64)v2, (unsigned int *)(a1 + 1680));
    v9 = *v2;
    if ( (_DWORD)v9 )
    {
      ...
      {
        v9 = v11 & 0x1F;
        if ( (*v10 & ~*((_DWORD *)qword_140011AC0 + v9)) == 0 )
        {
          v13 = 32 - v9;
          if ( (_DWORD)v9 == 33 )
            goto LABEL_26;
...
LABEL_26:
          ...
          if ( v19 != (_DWORD *)v9 && (*v19 | *((_DWORD *)qword_140011AC0 + (v11 & 0x1F))) == -1 )
          {
            v11 = v11 - (v11 & 0x1F) + 32;
          ...
          {
            v21 = v11 & 0x1F;
            if ( (*v19 & ~*((_DWORD *)qword_140011AC0 + (v11 & 0x1F))) == 0 )
              break;
          }
LABEL_42:
