/*
 * XREFs of MiFlushStrongCodeDriverLoadFailures @ 0x140A4CADC
 * Callers:
...
_QWORD *MiFlushStrongCodeDriverLoadFailures()
{
  ...
  while ( 1 )
  {
    v1 = (const CHAR **)qword_140C4CC48;
    if ( qword_140C4CC48 == &qword_140C4CC48 )
      break;
    if ( *((PVOID **)qword_140C4CC48 + 1) != &qword_140C4CC48
      || (v3 = *(_QWORD *)qword_140C4CC48, *(PVOID *)(*(_QWORD *)qword_140C4CC48 + 8LL) != qword_140C4CC48) )
    {
      __fastfail(3u);
    }
    qword_140C4CC48 = *(PVOID *)qword_140C4CC48;
    *(_QWORD *)(v3 + 8) = &qword_140C4CC48;
    if ( **(_DWORD **)&qword_140C4EE20 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 0x400000000000LL) )
    {
      ...
      v10 = 0x1000000LL;
      v25 = 8;
      tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&byte_140024B57, v4, 1u, v6, v7, 8u, &v11);
    }
