/*
 * XREFs of MmSetPfnListInfo @ 0x14036FCF8
 * Callers:
...
__int64 __fastcall MmSetPfnListInfo(__int64 a1, _QWORD *a2, int a3)
{
  ...
  __int64 v35; // r8
  __int64 v36; // r9
  __int128 v37; // [rsp+30h] [rbp-91h] BYREF
  __int64 v38; // [rsp+40h] [rbp-81h]
  struct _KTHREAD *v39; // [rsp+48h] [rbp-79h]
  __int64 v40; // [rsp+58h] [rbp-69h] BYREF
  int v41; // [rsp+60h] [rbp-61h]
  _BYTE v42[132]; // [rsp+64h] [rbp-5Dh] BYREF
  ...
  ExAcquirePushLockSharedEx((ULONG_PTR)&qword_140C50D40, 0LL);
  if ( a2 >= v7 )
    goto LABEL_53;
  v12 = a3;
  do
  {
    ...
    *((_QWORD *)&v37 + 1) = v13;
    ...
    MiIdentifyPfn(v14, (unsigned __int64 *)&v37);
    if ( v38 != a2[2] )
      goto LABEL_42;
    if ( (((unsigned __int64)v37 ^ *a2) & 0x1FFFFFFFFFFFE00LL) != 0 )
      goto LABEL_42;
      ...
      && ((v23 = v14[1].m128i_u64[0], (v23 & 0x400) != 0) ? (v24 = v23 >> 11) : (v24 = v23 >> 3), (v24 & 1) == 0) )
    {
      ...
      __writecr8(v15);
      MiAddPageToHeatList(&v40, v13, 3LL);
    }
    else
    {
LABEL_42:
...
LABEL_53:
  ...
  KiLeaveGuardedRegionUnsafe((__int64)CurrentThread, v34, v35, v36);
  return v9;
}
