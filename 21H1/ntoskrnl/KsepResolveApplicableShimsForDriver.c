/*
 * XREFs of KsepResolveApplicableShimsForDriver @ 0x1408BBDF4
 * Callers:
...
LABEL_25:
    if ( v5 )
    {
      ...
      if ( a2 )
      {
        ...
        dword_140C2AA44[2 * v42] = LoadedModulesList;
...
LABEL_31:
  ...
  if ( a2 )
  {
    ...
    dword_140C2AA44[2 * v34] = LoadedModulesList;
...
LABEL_22:
  ...
  dword_140C2AA44[2 * v38] = -1073740782;
