/*
 * XREFs of PopBatteryInitialize @ 0x1408E8B50
 * Callers:
 ...
 *     PopPrepareIoctl @ 0x1407AB204 (PopPrepareIoctl.c)
 */
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v9 = (_QWORD *)(a1 + 64);
    v10 = (_QWORD *)qword_140C236F8;
    if ( *(__int64 **)qword_140C236F8 != &qword_140C236F0 )
      __fastfail(3u);
    v9[1] = qword_140C236F8;
    *v9 = &qword_140C236F0;
    *v10 = v9;
    ++dword_140C236D4;
    ++dword_140C23738;
    result = 0;
    qword_140C236F8 = (__int64)v9;
    byte_140C236D8 = 1;
  }
  return result;
}
