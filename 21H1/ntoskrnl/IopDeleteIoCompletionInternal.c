/*
 * XREFs of IopDeleteIoCompletionInternal @ 0x1402FB7D8
 * Callers:
 *     IopDeleteIoCompletion @ 0x1406BEE60 (IopDeleteIoCompletion.c)
 *     IopCloseIoCompletion @ 0x1406BEE80 (IopCloseIoCompletion.c)
 * Callees:
