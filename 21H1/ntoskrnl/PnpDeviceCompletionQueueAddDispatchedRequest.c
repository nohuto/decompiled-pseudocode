/*
 * XREFs of PnpDeviceCompletionQueueAddDispatchedRequest @ 0x14036B80C
 * Callers:
...
_BOOL8 __fastcall PnpDeviceCompletionQueueAddDispatchedRequest(__int64 a1, _QWORD *a2)
{
  ...
  v4 = (_QWORD *)qword_140C44B48;
  v5 = PnpDeviceCompletionQueue == (_QWORD)&PnpDeviceCompletionQueue;
  if ( *(__int64 **)qword_140C44B48 != &PnpDeviceCompletionQueue )
    __fastfail(3u);
  *a2 = &PnpDeviceCompletionQueue;
  a2[1] = v4;
  *v4 = a2;
  ++dword_140C44B50;
  qword_140C44B48 = (__int64)a2;
