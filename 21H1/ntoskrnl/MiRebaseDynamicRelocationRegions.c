/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x140A431FC
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v5 = qword_140C4FA98;
  v20 = qword_140C4FA58;
  if ( (MiFlags & 0x8000) == 0 && qword_140C4FA98 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v6 = ((unsigned __int64)qword_140C4FA98 >> 39) & 0x1FF;
  v7 = 0;
...
LABEL_12:
  ...
  for ( i = 39LL; ; i -= 9LL )
  {
    MiApplyDynamicRelocations(*(_QWORD *)(v2 + 48), *(unsigned int *)(v2 + 64), v3, v13);
    if ( i >= 0xC )
