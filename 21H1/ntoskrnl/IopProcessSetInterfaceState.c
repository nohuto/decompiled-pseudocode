/*
 * XREFs of IopProcessSetInterfaceState @ 0x14072FAFC
 * Callers:
...
__int64 __fastcall IopProcessSetInterfaceState(__int64 a1, unsigned __int8 a2, char a3)
{
  ...
  const WCHAR *v26; // [rsp+88h] [rbp-80h] BYREF
  ...
  if ( v10 < 0 )
    goto LABEL_44;
  DeviceInterfaceClassGuid = CmGetDeviceInterfaceClassGuid(v11, v26, &v32);
