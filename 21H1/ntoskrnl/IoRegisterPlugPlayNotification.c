/*
 * XREFs of IoRegisterPlugPlayNotification @ 0x1406B3480
 * Callers:
...
LABEL_38:
        ...
        if ( *v21 == v20 )
        {
          ...
          *((_QWORD *)v20 + 1) = PoolWithTag;
          ...
          if ( ((unsigned __int8)SourceString & 1) != 0 )
          {
            ...
            v34 = v22;
            restarted = IopGetDeviceInterfaces((int)PoolWithTag + 80, 0, 0, 0, (__int64)&SourceString, 0LL);
            if ( restarted < 0 )
              goto LABEL_33;
            ...
            for ( i = SourceString; *i; i += ((unsigned __int64)DestinationString.Length >> 1) + 1 )
            {
              ...
              if ( *((_DWORD *)PoolWithTag + 5) != (unsigned int)PsGetServerSiloServiceSessionId((__int64)CurrentServerSilo) )
              {
    ...
    else
    {
      ...
      if ( restarted >= 0 )
      {
        ...
        v27 = (_QWORD *)qword_140D2DB90;
        if ( *(PVOID **)qword_140D2DB90 == &PnpProfileNotifyList )
        {
          *PoolWithTag = &PnpProfileNotifyList;
          v18 = &PnpHwProfileNotifyLock;
          PoolWithTag[1] = v27;
          *v27 = PoolWithTag;
          qword_140D2DB90 = (__int64)PoolWithTag;
          goto LABEL_11;
        }
LABEL_47:
        __fastfail(3u);
