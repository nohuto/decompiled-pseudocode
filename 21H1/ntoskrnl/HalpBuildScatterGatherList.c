/*
 * XREFs of HalpBuildScatterGatherList @ 0x14039BF14
 * Callers:
 *     HalGetScatterGatherList @ 0x1403045E0 (HalGetScatterGatherList.c)
 *     HalBuildScatterGatherListV3 @ 0x14039BE90 (HalBuildScatterGatherListV3.c)
 *     HalBuildScatterGatherListEx @ 0x1404C0AA0 (HalBuildScatterGatherListEx.c)
 *     HalGetScatterGatherListEx @ 0x1404C0F50 (HalGetScatterGatherListEx.c)
 * Callees:
