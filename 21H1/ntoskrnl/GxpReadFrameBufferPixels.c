...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 a1, unsigned int *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !(_BYTE)BgInternal )
    {
      ...
      v30[1] = *(_DWORD *)(a1 + 4);
      v30[3] = *(_DWORD *)(a1 + 12);
      v30[2] = xmmword_140C13270;
      v31 = *(_QWORD *)(a1 + 24);
      v13 = ((__int64 (__fastcall *)(_DWORD *, unsigned int *, __int64))qword_140C13280)(v30, v3, v12);
      goto LABEL_19;
    }
    v14 = *(char **)(a1 + 24);
    v15 = *(_DWORD *)a1;
    v21 = (char *)qword_140C13280;
    if ( BYTE2(BgInternal) )
    {
      HIDWORD(v35) = 0;
      if ( !v15 )
...
LABEL_30:
    ...
    {
      v16 = (char *)qword_140C13280 + v5 * (*v3 + v23 * v3[1]);
      if ( !v15 )
      {
LABEL_19:
