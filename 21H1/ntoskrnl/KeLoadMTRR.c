/*
 * XREFs of KeLoadMTRR @ 0x140994DD0
 * Callers:
 *     HalpPostSleepMP @ 0x1409910C4 (HalpPostSleepMP.c)
 *     KiLoadMTRRTarget @ 0x14099CA10 (KiLoadMTRRTarget.c)
 * Callees:
 *     KeFlushCurrentTbImmediately @ 0x14039D560 (KeFlushCurrentTbImmediately.c)
 *     __security_check_cookie @ 0x1403CC020 (__security_check_cookie.c)
 *     KiLockStepExecution @ 0x140994FB4 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x140994FFC (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x140995108 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x140995214 (KiCompareVarMtrr.c)
 */
...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_140C2B330 )
  {
    ...
    if ( qword_140C2B340 )
    {
      ...
      {
        v2 = 0LL;
        v3 = (PVOID)((_BYTE *)qword_140C2B340 - v18);
        v17 = v18;
...
LABEL_6:
    ...
    if ( (_BYTE)qword_140C2B328 )
    {
      ...
      do
      {
        v12 = qword_140C2B338;
        v13 = 2 * v10;
        __writemsr(v11 - 1, *((_QWORD *)qword_140C2B338 + v13));
        v8 = HIDWORD(v12[v13 + 1]);
        __writemsr(v11, v12[v13 + 1]);
        v10 = ++v9;
        v11 += 2;
      }
      while ( v9 < (unsigned __int64)(unsigned __int8)qword_140C2B328 );
    }
    if ( qword_140C2B340 )
      KiWriteFixedMtrr(qword_140C2B340, v8);
