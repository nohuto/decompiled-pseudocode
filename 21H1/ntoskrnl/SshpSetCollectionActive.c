/*
 * XREFs of SshpSetCollectionActive @ 0x14057A3BC
 * Callers:
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x1407BF120 (PdcPoSleepStudyHelperSetPhaseActive.c)
 *     SshpPowerSettingCallback @ 0x1408F7440 (SshpPowerSettingCallback.c)
 * Callees:
...
LABEL_37:
  ...
  LOBYTE(v25) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, BugCheckParameter2, &v31);
  v15 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v15 )
  {
    v25 = &CurrentThread->152;
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v25->ApcState.ApcListHead[0].Flink != v25 )
      LOBYTE(v25) = KiCheckForKernelApcDelivery(v27, v26, v28, v29);
  }
  return (char)v25;
}
