/*
 * XREFs of PfpProcessScenarioPhase @ 0x1407787A8
 * Callers:
        ...
        if ( v6 == 1 )
        {
          ...
          if ( (unsigned int)PsGetCurrentProcessSessionId() == ActiveConsoleId )
          {
            ...
            if ( dword_140C4FD18 < (unsigned int)dword_140C4FD1C )
              PfpLogScenarioEvent(5, 2, 3, dword_140C50254, 1);
          }
        }
        return v4;
      }
...
LABEL_4:
  ...
  if ( v8 )
  {
    if ( v8 != 1 || dword_140C50250 != 3 )
      return v4;
    PfpScenCtxPrefetchWait((ULONG_PTR)&qword_140C50220);
    PfpLogScenarioEvent(3, 0, 0, dword_140C50254, 0);
    goto LABEL_29;
  }
  v9 = RtlGetActiveConsoleId();
  if ( (unsigned int)PsGetCurrentProcessSessionId() == v9 && dword_140C4FD18 < (unsigned int)dword_140C4FD1C )
  {
    v10 = 0;
