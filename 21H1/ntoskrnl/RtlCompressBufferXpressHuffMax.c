/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x14058B614
 * Callers:
 *     RtlCompressBufferXpressHuff @ 0x140363140 (RtlCompressBufferXpressHuff.c)
 *     RtlCompressBufferProgress @ 0x140380AA0 (RtlCompressBufferProgress.c)
 * Callees:
 *     XpressBuildHuffmanEncodings @ 0x1403639D0 (XpressBuildHuffmanEncodings.c)
 *     XpressDoHuffmanPass @ 0x140363D80 (XpressDoHuffmanPass.c)
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      v19 = v15 + 4;
      if ( (unsigned __int64)(v13 + 0x10000) <= v59 )
        v18 = v13 + 0x10000;
      v20 = 1;
      v21 = (unsigned __int64)&v13[v17];
      v65 = v18;
      v22 = (unsigned __int64)(v18 - 5);
      v60 = (unsigned __int64)(v18 - 5);
      ...
      do
      {
        v26 = (unsigned __int16)XpressHashFunction[*v24] ^ (unsigned __int16)word_14003A070[v24[2]] ^ (unsigned __int64)(unsigned __int16)word_140039E70[v24[1]];
        v27 = *(_QWORD *)&a6[8 * v26];
        *(_QWORD *)&a6[8 * v26] = v24++;
...
LABEL_70:
                    ...
                    if ( v46 < 0x100 )
                      v47 = *((unsigned __int8 *)XpressHighBitIndexTable + v46);
                    else
                      v47 = *((unsigned __int8 *)XpressHighBitIndexTable + (v46 >> 8)) + 8LL;
                    v62 += v47;
                    v48 = v19 + 1;
                    v49 = v46 - (1LL << v47);
                    v50 = 16 * v47;
...
LABEL_91:
      ...
      *(_DWORD *)v15 = 2 * v20 + 1;
      ...
      if ( &v14[4 * ((unsigned __int64)(XpressBuildHuffmanEncodings((_QWORD *)a6 + 163840) + v62 + 31) >> 5) + 258 + v63] >= v66 )
        return 3221225507LL;
      v15 = a6 + 1342240;
      v58 = XpressDoHuffmanPass((__int64)(a6 + 1310720), a6 + 1342240, (unsigned __int64)v19, v14, v57);
      v10 = a9;
      v14 = v58;
      v64 = v58;
      if ( v57 )
    ...
    XpressCallback = RtlpMakeXpressCallback((__int64)v67, v22, (__int64)v13);
    v22 = v60;
    v21 = XpressCallback;
    v16 = v59;
    v61 = XpressCallback;
