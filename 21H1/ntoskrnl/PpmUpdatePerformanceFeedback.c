/*
 * XREFs of PpmUpdatePerformanceFeedback @ 0x140271E60
 * Callers:
...
char __fastcall PpmUpdatePerformanceFeedback(__int64 a1, unsigned __int8 a2, __int64 a3, char a4, __int64 *a5)
{
  ...
  {
    v11 = 1;
    v12 = *(_QWORD *)(*(_QWORD *)(a1 + 33616) + 8LL * DWORD2(xmmword_140CED2E0)) >> 1;
  }
  else
  {
    v11 = 0;
  ...
  if ( a2
    ...
    || (_BYTE)a3 && v12 != *(_QWORD *)(a1 + 32944) )
  {
    v14 = 2;
    v15 = (__int64 *)(a1 + 32864);
    LOBYTE(a3) = 0;
    for ( i = 0; i < 2; ++i )
    {
      v17 = *v15;
    ...
    if ( (_BYTE)a3 || a2 || !a4 )
    {
      ...
      {
        KiAcquireSpinLockInstrumented(a1 + 32840, v17, a3);
      }
      else
      {
        ...
        if ( _interlockedbittestandset64(v13, 0LL) )
        {
          ...
          KxWaitForSpinLockAndAcquire(a1 + 32840, v17, a3);
        }
      }
