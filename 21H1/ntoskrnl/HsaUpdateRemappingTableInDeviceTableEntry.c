/*
 * XREFs of HsaUpdateRemappingTableInDeviceTableEntry @ 0x1404DF414
 * Callers:
 ...
 *     HsaBuildInterruptRemappingEntry @ 0x1404DD228 (HsaBuildInterruptRemappingEntry.c)
 *     HsaInvalidateRemappingTableEntries @ 0x1404DE6A8 (HsaInvalidateRemappingTableEntries.c)
 */
