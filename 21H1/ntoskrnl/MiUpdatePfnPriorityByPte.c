/*
 * XREFs of MiUpdatePfnPriorityByPte @ 0x14028F5D0
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( (result & 1) != 0 )
      {
        if ( (unsigned __int64)&v33 >= 0xFFFFF6FB7DBED000uLL
          ...
          && (unsigned int)MiPteHasShadow(&v33, result)
          && ((v6 & 0x20) == 0 || (v6 & 0x42) == 0) )
        {
...
LABEL_22:
      ...
      if ( (*(_QWORD *)(v11 + 8) | 0x8000000000000000uLL) != a1
        && (!(unsigned int)MI_PFN_IS_PROTO(v11, v9, v10) || a1 < 0xFFFFF68000000000uLL || a1 > 0xFFFFF6FFFFFFFFFFuLL) )
      {
        goto LABEL_71;
      }
      v13 = *(_BYTE *)(v11 + 34);
    ...
    if ( (v13 & 7) == 2 )
    {
      if ( v27
        ...
        || !(unsigned int)MiIsPteInStore(
                            *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v11 + 40) >> 39) & 0x3FFLL)),
                            *(_QWORD *)(v11 + 16)) )
      {
