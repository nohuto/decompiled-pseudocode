/*
 * XREFs of _CmGetDeviceInterfaceMappedPropertyFromRegValue @ 0x1406B26CC
 * Callers:
...
LABEL_11:
  ...
  if ( a3 )
    goto LABEL_15;
  v21 = CmOpenDeviceInterfaceRegKey(a1, a2, 0x30u, (__int64)v19, 1, (char)v10, (__int64)v34, v10);
  v10 = 0LL;
