/*
 * XREFs of IommupHvInitializeLibrary @ 0x140A8B664
 * Callers:
 *     IommuInitializeLibrary @ 0x1403A90C8 (IommuInitializeLibrary.c)
 * Callees:
  ...
  if ( (_DWORD)v2 )
  {
    ...
    while ( 1 )
    {
      ...
      *v8 = ContiguousNodeMemory + 4096;
      ...
      v0 = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD))qword_140C4A488)(
             v7,
             102LL,
...
LABEL_20:
    for ( i = 0; i < v15; ++i )
      ((void (__fastcall *)(_QWORD))qword_140C4A490)(i);
    v14 = (PVOID *)(v4 + 8);
    do
    {
      if ( *v14 )
