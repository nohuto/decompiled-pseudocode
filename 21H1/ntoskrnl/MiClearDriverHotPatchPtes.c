/*
 * XREFs of MiClearDriverHotPatchPtes @ 0x140538908
 * Callers:
...
char __fastcall MiClearDriverHotPatchPtes(__int64 a1)
{
  ...
  unsigned __int64 v40; // [rsp+40h] [rbp-108h] BYREF
  _QWORD v41[24]; // [rsp+50h] [rbp-F8h] BYREF
  ...
  v4 = (_QWORD *)v3;
  v5 = ((unsigned int)dword_140C4CBF0 >> 12) + ((dword_140C4CBF0 & 0xFFF) != 0);
  ...
  if ( v5 )
  {
    do
    {
      ...
      {
        MiInsertTbFlushEntry((__int64)v41, v8, 1LL, 0);
        v10 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v40) >> 12) & 0xFFFFFFFFFLL;
        ...
        if ( KiIrqlFlags )
        {
          if ( (KiIrqlFlags & 1) != 0 )
          {
              ...
              && (unsigned __int8)CurrentThread >= 2u )
            {
              ...
              v37 = ((unsigned int)CurrentThread & SchedulerAssist[5]) == 0;
...
LABEL_40:
        *(_QWORD *)v3 = v35;
        if ( v36 )
          LOBYTE(CurrentThread) = MiWritePteShadow(v3, v35);
        v3 += 8LL;
        --v7;
      }
      while ( v7 );
