/*
 * XREFs of PopPowerRequestCallbackWorker @ 0x14033D8B0
 * Callers:
...
__int64 PopPowerRequestCallbackWorker()
{
  ...
  while ( 1 )
  {
    ...
    {
      v0 = *(_QWORD **)(qword_140C25028 + 8);
      if ( *(__int64 **)qword_140C25028 != &PopPowerRequestCallbacks || *v0 != qword_140C25028 )
        __fastfail(3u);
      v1 = qword_140C25028 - 56;
      qword_140C25028 = *(_QWORD *)(qword_140C25028 + 8);
      v2 = 0;
