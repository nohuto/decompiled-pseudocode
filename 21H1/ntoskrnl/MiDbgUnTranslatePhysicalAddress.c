/*
 * XREFs of MiDbgUnTranslatePhysicalAddress @ 0x140540AA4
 * Callers:
...
void __fastcall MiDbgUnTranslatePhysicalAddress(int *a1)
{
  ...
  if ( (*a1 & 0x20) != 0 )
  {
    v2 = qword_140C4E7C8 << 25;
    _InterlockedExchange64((volatile __int64 *)qword_140C4E7C8, ZeroPte);
    v3 = v2 >> 16;
    if ( (*a1 & 0x12) != 0 )
  ...
  if ( (*a1 & 4) == 0 )
  {
    ...
    {
      ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C4EB80);
    }
  }
