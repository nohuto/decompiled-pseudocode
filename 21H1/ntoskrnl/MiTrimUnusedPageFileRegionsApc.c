/*
 * XREFs of MiTrimUnusedPageFileRegionsApc @ 0x140322F60
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall MiTrimUnusedPageFileRegionsApc(PRKEVENT Event)
{
  ...
  v3 = *(__int64 **)(v1 + 8LL * LODWORD(Event[1].Header.WaitListHead.Flink) + 6944);
  ...
  v13 = ((unsigned __int64)(*((_WORD *)v3 + 102) & 0xF) << 12) | v4 & 0xFFFFFFFFFFFF0FFFuLL;
  FreePageFileSpace = MiFindFreePageFileSpace(v1, &v13, Flink_high, 171LL);
  v7 = FreePageFileSpace;
  if ( FreePageFileSpace >= HIDWORD(Event[1].Header.WaitListHead.Flink) )
  {
    v8 = v13;
    if ( qword_140C4DE80 && (v13 & 0x10) == 0 )
      v8 = v13 & ~qword_140C4DE80;
    v9 = HIDWORD(v8);
    ...
    v11 = *v3;
    v13 = ((unsigned __int64)(*((_WORD *)v3 + 102) & 0xF) << 12) | v10 & 0xFFFFFFFFFFFF0FFFuLL;
    HIDWORD(Event[1].Header.WaitListHead.Blink) = v7 + MiFindFreePageFileSpace(v1, &v13, v11, 107LL);
  }
