/*
 * XREFs of MiGetUltraMdlContext @ 0x140559878
 * Callers:
...
PSLIST_ENTRY MiGetUltraMdlContext()
{
  ...
  {
    LODWORD(v1) = v1 & 7;
    result = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(qword_140C4EB78 + ((v2 + (unsigned int)v1) << 6)));
    if ( result )
      return result;
    LOBYTE(v1) = v1 + 1;
    ++v0;
  ...
  while ( v0 < 8 );
  if ( (unsigned int)dword_140C4EB70 >= 0x80 )
    return 0LL;
