/*
 * XREFs of MiZeroCfgSystemWideBitmapWorker @ 0x1403524CC
 * Callers:
...
void __fastcall MiZeroCfgSystemWideBitmapWorker(unsigned int *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  bool v71; // zf
  unsigned __int64 v72; // [rsp+20h] [rbp-69h]
  ...
  char v85; // [rsp+F0h] [rbp+67h] BYREF
  ...
  v88 = (a2 >> 3) & 0xFFF;
  v74 = *(_QWORD *)(qword_140C4E588 + 8 * v8);
  v86 = ((a2 >> 3) + v3) & 0xFFF;
  v81 = ((a2 >> 3) + v3 - 1) >> 12;
...
LABEL_7:
    ...
    {
      LOBYTE(v18) = v85;
      MiUnlockProtoPoolPage(v21, v18, v22, v19);
      v21 = 0LL;
      v73 = 0LL;
      v75 = 0LL;
    }
...
LABEL_9:
      ...
      if ( (v25 & 1) != 0 )
      {
        ...
        v47 = MiMapPageInHyperSpaceWorker((v26 >> 12) & 0xFFFFFFFFFLL, 0LL, 0x80000000LL, v46);
        v48 = v47;
        if ( v17 == v20 )
        {
          v60 = 4096 - v88;
...
LABEL_52:
            LOBYTE(v50) = 17;
            MiUnmapPageInHyperSpaceWorker(v48, v50, 0x80000000);
            v51 = MiCaptureDirtyBitToPfn(v24);
            _InterlockedAnd64((volatile signed __int64 *)(v24 + 24), 0x7FFFFFFFFFFFFFFFuLL);
            if ( !v51 )
              goto LABEL_29;
            v63 = v51;
            v64 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v24 + 40) >> 39) & 0x3FFLL));
            goto LABEL_100;
          }
          v60 = v86;
        }
      ...
      if ( (v25 & 0x800) == 0 )
      {
        ...
        if ( v25 && v17 != v20 && v17 != v23 )
        {
          ...
          MiReleasePageFileSpace(v74, v26);
          v43 = 0;
          ...
          if ( v44 )
          {
            ...
            {
              v43 = 1;
              if ( HIBYTE(word_140C4DF48) != (_BYTE)v13 )
                goto LABEL_42;
              v71 = (v42 & 1) == 0;
            }
            else
...
LABEL_30:
      ...
      if ( v17 == v76 || v17 == v23 )
      {
        ...
        if ( (unsigned int)MiUnlinkPageFromList(v24, 0) )
        {
          ...
          v53 = 0LL;
LABEL_60:
          v55 = MiMapPageInHyperSpaceWorker(v27, 0LL, 0x80000000LL, v54);
          v56 = v55;
          if ( v17 == v76 )
          {
            v57 = 4096 - v88;
          ...
          memset(v58, 0, v57);
          LOBYTE(v59) = 17;
          MiUnmapPageInHyperSpaceWorker(v56, v59, 0x80000000);
          if ( dword_140C4E60C == 1 )
          {
            v65 = v27 & 0x1F;
            LOBYTE(v66) = 1;
            v67 = (volatile signed __int32 *)(qword_140C4E668 + 4 * (v27 >> 5));
            if ( v65 + 1 > 0x20 )
            {
              if ( (v27 & 0x1F) != 0 )
              {
...
LABEL_100:
      ...
      else if ( (unsigned int)MiUnlinkPageFromList(v24, 0) )
      {
        ...
        if ( v35 )
        {
          ...
          v39 = 1;
          if ( HIBYTE(word_140C4DF48) == (_BYTE)v38 && (v32 & 1) != 0 )
            v32 |= 0x8000000000000000uLL;
        }
        else
        {
LABEL_23:
    ...
    {
      v45 = MiLockProtoPoolPage(v17, (__int64)&v85);
      v13 = 0LL;
      v75 = v45;
      v21 = v45;
      if ( v45 )
