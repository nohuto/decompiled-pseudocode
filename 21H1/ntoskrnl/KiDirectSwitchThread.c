/*
 * XREFs of KiDirectSwitchThread @ 0x140333A80
 * Callers:
 ...
 *     KiGetComparisonRanks @ 0x1403158A0 (KiGetComparisonRanks.c)
...
bool __fastcall KiDirectSwitchThread(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 *v126; // [rsp+60h] [rbp-58h] BYREF
...
LABEL_224:
  ...
  while ( _interlockedbittestandset64((volatile signed __int32 *)v4 - 38, 0LL) )
  {
    ...
    do
      KeYieldProcessorEx(&v121, v33, p_DpcData, v34);
    while ( *(v4 - 19) );
...
LABEL_262:
      ...
      while ( _interlockedbittestandset64((volatile signed __int32 *)(a1 + 48), 0LL) )
      {
        ...
        do
          KeYieldProcessorEx(&v123, v33, p_DpcData, v34);
        while ( *(_QWORD *)(a1 + 48) );
        ...
        if ( v125 + (unsigned int)KiDirectQuantumTarget <= v41 && !v130 )
        {
          ...
          *(_QWORD *)(v8 + 32) = v60;
          if ( v129 )
          {
            ...
            if ( v44 != v59 )
            {
              KiAbProcessThreadPriorityModification((__int64)(v4 - 27), v59, 1);
              v43 = (*(_DWORD *)(v4 - 12) & 0x400000) == 0;
              *((_BYTE *)v4 - 21) = v59;
              if ( !v43 )
              {
...
LABEL_126:
    ...
    if ( v45 >= 4u || *((char *)v4 + 347) >= 14 || v46 >= 2 && !*((_BYTE *)v4 + 348) )
    {
      ...
      if ( v47 < 16 )
      {
        ...
        if ( v50 )
        {
          _BitScanReverse((unsigned int *)&p_DpcData, v50);
      ...
      if ( !(_BYTE)v34 )
      {
        ...
        if ( v47 > v48 )
        {
          if ( *((_BYTE *)v4 + 577) )
          {
            ...
            if ( v4[74] == 1 )
            {
              p_DpcData = (__int64)&v51[541].DpcData;
              if ( v51 != (struct _KDPC *)-34680LL )
              {
...
LABEL_78:
          ...
          if ( v53 >= 16 )
            v53 = 15;
          if ( v53 > (int)p_DpcData )
          {
            v54 = 0;
            if ( v53 > v52 + v128 )
              v54 = v53 - v52 - v128;
            *((_BYTE *)v4 + 348) = v34 ^ (v54 ^ v34) & 0xF;
            v55 = (struct _KDPC *)KeGetCurrentPrcb();
            if ( (char)v53 > (char)p_DpcData )
            {
              if ( *((_BYTE *)v4 + 577) )
              {
                ...
                if ( v4[74] == 1 )
                {
                  v33 = (__int64)&v55[541].DpcData;
                  if ( v55 != (struct _KDPC *)-34680LL )
                  {
            ...
            *((_BYTE *)v4 - 21) = v53;
            ...
            {
              LOBYTE(p_DpcData) = 1;
              KiSetSchedulerAssistPriority(v4[94], (unsigned int)(char)v53, p_DpcData);
            }
          }
LABEL_97:
          v44 = *((_BYTE *)v4 - 21);
...
LABEL_127:
  *(v4 - 19) = 0LL;
  ...
  if ( !v10 )
  {
    ...
    *v4 = 0LL;
    v126 = v4;
    KiReadyDeferredReadyList(a1, &v126, p_DpcData, v34);
  }
  return v127;
}
