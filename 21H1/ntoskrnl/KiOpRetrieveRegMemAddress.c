/*
 * XREFs of KiOpRetrieveRegMemAddress @ 0x1403C8FD0
 * Callers:
 *     KiOp_Div @ 0x1403C8ED0 (KiOp_Div.c)
 *     KiOp_SGDTSIDT @ 0x14051EF40 (KiOp_SGDTSIDT.c)
 *     KiOp_SLDTSTRSMSW @ 0x14051F100 (KiOp_SLDTSTRSMSW.c)
 * Callees:
 *     KiOpComputeLinearAddress @ 0x14051EAAC (KiOpComputeLinearAddress.c)
 */
