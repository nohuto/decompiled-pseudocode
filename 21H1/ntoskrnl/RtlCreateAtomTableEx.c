/*
 * XREFs of RtlCreateAtomTableEx @ 0x1402E50E0
 * Callers:
 *     RtlCreateAtomTable @ 0x14069F7A0 (RtlCreateAtomTable.c)
 * Callees:
 *     RtlULongLongMult @ 0x1402C1CCC (RtlULongLongMult.c)
 *     memset @ 0x140408F80 (memset.c)
 *     RtlpFreeAtom @ 0x1405D5D5C (RtlpFreeAtom.c)
 *     RtlpInitializeLockAtomTable @ 0x14069F7BC (RtlpInitializeLockAtomTable.c)
