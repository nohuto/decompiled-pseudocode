/*
 * XREFs of HvlGetStatsUpdateCounter @ 0x1404F2330
 * Callers:
...
char __fastcall HvlGetStatsUpdateCounter(unsigned int a1)
{
  ...
  if ( LpcbByLpIndex )
  {
    ...
    LpcbByLpIndex = *(int **)(v4 + 8LL * (unsigned int)dword_140CED308);
    v5 = (unsigned int)dword_140CED30C;
    *v2 = *(_QWORD *)(v4 + 8LL * DWORD2(xmmword_140CED2E0)) & 1;
