/*
 * XREFs of MmGetCacheAttributeEx @ 0x14052C500
 * Callers:
 *     MmGetCacheAttribute @ 0x14052C4E0 (MmGetCacheAttribute.c)
 * Callees:
...
__int64 __fastcall MmGetCacheAttributeEx(unsigned __int64 a1, int a2, _DWORD *a3)
{
  ...
  {
    if ( !*(_WORD *)(48 * v5 - 0x57FFFFFFFE0LL) && (struct _KTHREAD *)qword_140C4E648 != KeGetCurrentThread() )
