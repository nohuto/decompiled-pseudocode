/*
 * XREFs of HalpInterruptInitializeLocalUnit @ 0x1403A07EC
 * Callers:
 ...
 *     HalpInterruptMarkProcessorStarted @ 0x1403A0B8C (HalpInterruptMarkProcessorStarted.c)
...
__int64 __fastcall HalpInterruptInitializeLocalUnit(ULONG_PTR BugCheckParameter3)
{
  ...
  if ( v4 < 0 )
  {
    ...
    *(_DWORD *)(BugCheckParameter3 + 312) = 570;
    goto LABEL_13;
  }
...
LABEL_8:
  ...
  if ( v5 < 0 )
  {
    ...
    *(_QWORD *)(BugCheckParameter3 + 304) = "minkernel\\hals\\lib\\interrupts\\common\\intsup.c";
    *(_DWORD *)(BugCheckParameter3 + 312) = 802;
  }
  else
  {
    ...
    if ( v5 < 0 )
    {
      ...
      *(_QWORD *)(BugCheckParameter3 + 304) = "minkernel\\hals\\lib\\interrupts\\common\\intsup.c";
      *(_DWORD *)(BugCheckParameter3 + 312) = 815;
    }
    else
    {
