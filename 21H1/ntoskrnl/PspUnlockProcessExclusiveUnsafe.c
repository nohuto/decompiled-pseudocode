/*
 * XREFs of PspUnlockProcessExclusiveUnsafe @ 0x14057CDC0
 * Callers:
...
LABEL_13:
  ...
  *(_BYTE *)(v6 + 32) |= 2u;
  ...
  v16 = *(_DWORD *)(v6 + 88) & 0x1FFFF;
  *(_DWORD *)(v6 + 88) &= 0xFFFE0000;
  *(_BYTE *)(v6 + 25) &= ~1u;
  *(_QWORD *)(v6 + 32) = 0LL;
  v9 = (__int64)(v6 - (unsigned __int64)CurrentThread->LockEntries) / 96;
  if ( v4 == 1 )
...
LABEL_20:
  ...
  LOBYTE(v10) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v1, &v16);
  v7 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v7 )
  {
    v10 = &CurrentThread->152;
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v10->ApcState.ApcListHead[0].Flink != v10 )
      LOBYTE(v10) = KiCheckForKernelApcDelivery(v12, v11, v13, v14);
  }
  return (char)v10;
}
