/*
 * XREFs of HalGetAdapterV3 @ 0x1407ADF10
 * Callers:
 ...
 *     HalpDmaIsAutomaticDomain @ 0x1404BF680 (HalpDmaIsAutomaticDomain.c)
 ...
 *     HalpFindDmaControllerByRequestLine @ 0x1404C9DF4 (HalpFindDmaControllerByRequestLine.c)
