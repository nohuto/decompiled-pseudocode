/*
 * XREFs of MiPurgeImageSection @ 0x1403A1EA4
 * Callers:
...
void __fastcall MiPurgeImageSection(__int64 a1)
{
  ...
  v4 = a1;
  v29 = 0LL;
  v5 = *(_QWORD *)(qword_140C4E588 + 8 * v2);
  v30 = v5;
  while ( 1 )
  {
    v31 = v1;
    ...
    if ( v11 < v34 )
    {
      while ( 1 )
      {
        if ( (v11 & 0xFFF) == 0 || v36 == 17 )
        {
          LOBYTE(v6) = v36;
          if ( v36 != 17 )
            MiUnlockProtoPoolPage(v9, v6, v8, v9);
          while ( 1 )
          {
...
LABEL_20:
        ...
        if ( (*(_BYTE *)(v12 + 34) & 0x10) != 0 || (*(_DWORD *)(v12 + 16) & 0x400LL) == 0 )
        {
          ...
          if ( (*(_DWORD *)(v12 + 16) & 0x400LL) != 0 )
            MiDereferenceControlAreaPfnList(v4, 0LL, v8, (_DWORD *)2);
          v16 = 0LL;
          ...
          if ( MiPteInShadowRange(v11) )
          {
            ...
            {
              v17 = v22 + 1;
              if ( HIBYTE(word_140C4DF48) == (_BYTE)v22 )
              {
