/*
 * XREFs of HalpTimerClockInterrupt @ 0x140278110
 * Callers:
 *     <none>
 * Callees:
  ...
  else if ( (KeGetCurrentPrcb()->PendingTickFlags & 1) != 0 )
  {
    ...
    if ( KeGetCurrentPrcb()->ClockOwner )
    {
      ...
      if ( HalpClockWorkUnion && (_WORD)HalpClockWorkUnion )
      {
        ...
        HalpMcaQueueDpc((unsigned __int8)v9, v9 >> 8);
      }
      ...
      v11 = (_QWORD *)(HalpCounterSetInfo + 24 * CurrentPrcb);
      if ( (_QWORD *)*v11 != v11 && MEMORY[0xFFFFF78000000008] - v11[2] >= 0x4C4B40uLL )
      {
