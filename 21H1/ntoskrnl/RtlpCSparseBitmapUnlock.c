/*
 * XREFs of RtlpCSparseBitmapUnlock @ 0x1403615BC
 * Callers:
  ...
  else
  {
    if ( v2 == 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (*(_BYTE *)(v16 + 26) & 1) != 0
          && (*(_DWORD *)(v16 + 32) & 1) == 0
          && (*(_QWORD *)(v16 + 32) & 0x7FFFFFFFFFFFFFFCLL) == (v3 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_28:
    ...
    return KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread(), v7, v8, (__int64)v9);
  }
  return result;
}
