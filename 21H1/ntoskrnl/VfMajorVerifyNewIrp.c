/*
 * XREFs of VfMajorVerifyNewIrp @ 0x1409D4E14
 * Callers:
        ...
        __int64 a5))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  v10 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140D49100 + 12 * v9);
  if ( v10 )
    v10(a1);
  result = qword_140D49B80;
  if ( qword_140D49B80 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))qword_140D49B80(a1, a2, a3, a4, a5);
  return result;
}
