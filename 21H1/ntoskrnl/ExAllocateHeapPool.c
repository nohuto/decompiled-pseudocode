/*
 * XREFs of ExAllocateHeapPool @ 0x14024FF10
 * Callers:
...
LABEL_201:
      ...
      if ( (unsigned int)v6 >= dword_140C57F90 )
        LODWORD(v6) = 0;
      v15 = &qword_140C57FC0[1048 * (unsigned int)v6];
      if ( v12 < NonPagedPool )
      {
        v17 = v15[3];
      }
      ...
      if ( v9 <= 0xFE0 )
      {
        ...
        if ( (v12 & 4) != 0 )
        {
          v18 += *(unsigned int *)((char *)&Mm64BitPhysicalAddress + 2);
          if ( v18 > 0xFE0 )
          {
            v18 -= *(unsigned int *)((char *)&Mm64BitPhysicalAddress + 2);
...
LABEL_27:
            ...
            if ( (v20 || (v21 = qword_140C1DDA8) != 0) && v19 > v21 )
            {
              v103 = *(_QWORD *)(v17 + 56);
              if ( v103 )
...
LABEL_31:
              ...
              else
              {
                ...
                v119 = (__int64 *)(v17
                                 + 832
                                 + 8
                                 * (*((unsigned __int8 *)RtlpLfhBucketIndexMap + ((unsigned int)(v27 + 15) >> 4)) + 16LL));
                if ( (*v119 & 1) == 0
                  || (updated = RtlpHpLfhBucketUpdateStats(v17 + 832, v27, v11), v26 = v22 & 0x13000003, updated) )
                {
                  v28 = 128LL;
                    ...
                    *(_BYTE *)(v106 + 2) ^= (*(_BYTE *)(v106 + 2) ^ v113) & 0xF;
                    if ( (_WORD)v113 != 1
                      || (int)((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))RtlpInterceptorRoutines)(
                                ...
                                v106 + 16) < 0 )
                    {
                      RtlpHpFreeHeap(v17, v35, v22, 0LL, 0LL);
                      goto LABEL_181;
                    }
                  }
                }
...
LABEL_65:
                  ...
                  {
                    *(_BYTE *)(v35 + 3) &= ~4u;
                    v54 = (*(_DWORD *)((char *)&Mm64BitPhysicalAddress + 2) - 1) & (-16 - v35);
                    if ( v54 )
                    {
                      v55 = v35 + v54;
                      v56 = (__int64)v54 >> 4;
...
LABEL_151:
      ...
      if ( (v57 & 0xFFF) == 0 && v57 <= *(unsigned int *)(v17 + 464) )
      {
        ...
        if ( v57 > *(unsigned int *)(v17 + 272) )
          v80 = v17 + 448;
        v67 = (char *)RtlpHpSegAlloc(v80, v57, v57, v57, ((unsigned int)v12 >> 9) & 2);
        v111 = (__int64)v67;
        goto LABEL_114;
      }
      v58 = *(_QWORD *)(v17 + 48);
      ...
      v124 = 0LL;
      v62 = v61 & 0x93000F0B;
      if ( (v58 || (v60 = qword_140C1DDA8) != 0) && v57 > v60 )
      {
        v96 = *(_QWORD *)(v17 + 56);
        if ( v96 )
...
LABEL_114:
            if ( !v67 )
              goto LABEL_247;
            if ( !(unsigned int)ExpAddTagForBigPages((_DWORD)v67, v14, v57, v12, 0, 0) )
              goto LABEL_181;
...
LABEL_112:
          ...
          {
            v98 = RtlpHpExtrasAppend(v17, (_DWORD)v67, v57, v68, v124, v62, 0);
            if ( v115 )
            {
      ...
      else
      {
        ...
        v131 = 0LL;
        v130 = 0LL;
        v67 = RtlpHpVsContextAllocateInternal(v17 + 640, v57, v66, v65, (__int64)&v130, &v122);
        v111 = (__int64)v67;
        if ( v122 && (v62 & 1) == 0 )
        {
