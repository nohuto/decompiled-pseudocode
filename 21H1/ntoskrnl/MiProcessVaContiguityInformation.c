/*
 * XREFs of MiProcessVaContiguityInformation @ 0x14054C7D0
 * Callers:
 ...
 *     MiVadSupportsPhysicalContiguityQuery @ 0x1408CCE7C (MiVadSupportsPhysicalContiguityQuery.c)
 */
...
__int64 __fastcall MiProcessVaContiguityInformation(unsigned __int64 a1, __int64 a2)
{
  ...
  v31 = 0LL;
  v7 = 0;
  v8 = *(_QWORD *)(qword_140C4E588 + 8LL * *((unsigned __int16 *)v6 + 87));
  if ( (int)MiAcquireNonPagedResources(v8, 0x200uLL, 1024LL, 6u) < 0 )
    return 3221225626LL;
  v10 = a1 + 16 * a2;
  if ( a1 >= v10 )
  {
...
LABEL_35:
  ...
  while ( (unsigned int)MiQueryVaPhysicalContiguity((__int64)v33, v13, 1, 1) )
  {
LABEL_34:
    v13 += 0x200000LL;
    if ( v13 >= v30 )
