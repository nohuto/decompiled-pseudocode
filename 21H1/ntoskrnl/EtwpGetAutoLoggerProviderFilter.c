/*
 * XREFs of EtwpGetAutoLoggerProviderFilter @ 0x14077DAE0
 * Callers:
      ...
      *v61 = v28;
      if ( v28 )
      {
        *((_QWORD *)&v56 + 1) = v28;
        ...
        RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v86, 0LL);
        if ( RegistryValues < 0 )
          goto LABEL_10;
        ...
        if ( Handle )
        {
          ...
          RegistryValues = RtlpQueryRegistryValues(0x40000000, v38, (__int64)v86, 0LL);
          if ( RegistryValues < 0 )
            RegistryValues = 0;
        }
        if ( v30 )
