/*
 * XREFs of PpmPerfApplyDomainState @ 0x1402F4180
 * Callers:
 ...
 *     PpmPerfApplyCapsAndFloors @ 0x1402F473C (PpmPerfApplyCapsAndFloors.c)
...
__int64 __fastcall PpmPerfApplyDomainState(__int64 a1)
{
  ...
  v53 = 0;
  v4 = *(_QWORD *)(a1 + 16);
  v65 = &PpmCurrentProfile[342 * dword_140C23ECC + 5];
