/*
 * XREFs of MiReserveUserMemory @ 0x1406343A0
 * Callers:
 ...
 *     MiStoreGraphicsProtectionInVad @ 0x1408C2504 (MiStoreGraphicsProtectionInVad.c)
        ...
        _WORD *a6)
{
  ...
  __int64 v55; // [rsp+68h] [rbp-60h] BYREF
  _QWORD *v56; // [rsp+70h] [rbp-58h] BYREF
  _DWORD *v57; // [rsp+78h] [rbp-50h] BYREF
    ...
    || (result = MiArbitraryCodeBlocked(a1[12]), UserPhysicalView = result, (int)result >= 0) )
  {
    ...
    *((_DWORD *)PoolMm + 12) ^= (*((_DWORD *)PoolMm + 12) ^ (v16 << 12)) & 0x3F000;
    v17 = (_DWORD *)*((unsigned int *)PoolMm + 12);
    if ( v16 )
    {
    ...
    v20 = *((_DWORD *)a1 + 15);
    *((_DWORD *)PoolMm + 12) = (unsigned int)v17 ^ ((unsigned __int16)v17 ^ (unsigned __int16)((_WORD)v7 << 7)) & 0xF80 | 0x100000;
    if ( (v20 & 0x40000000) != 0 )
      *((_DWORD *)PoolMm + 12) = (unsigned int)v17 ^ ((unsigned __int16)v17 ^ (unsigned __int16)((_WORD)v7 << 7)) & 0xF80 | 0x4100000;
    if ( (v20 & 1) != 0 )
    {
      v19 = 0x7FFFFFFFELL;
    }
...
LABEL_21:
        ...
        *(_DWORD *)(v15 + 48) = v24;
        if ( !v25 )
        {
          UserPhysicalView = MiCreateWriteWatchView(a1[11], v15, v12);
...
LABEL_29:
                ...
                *(_BYTE *)(v15 + 33) = BYTE4(v34);
                if ( v25 )
                {
                  UserPhysicalView = MiInsertVadCharges(v15, (struct _KPROCESS *)a1[11]);
                  v32 = UserPhysicalView;
                  if ( UserPhysicalView >= 0 )
                  {
                    if ( P )
...
LABEL_145:
                    ...
                    if ( v25 )
                    {
                      ...
                      v32 = MiSecureVad(v15, v26, a1[3], v43, 0, (__int64)&v57);
                      if ( v32 >= 0 )
                      {
                        v44 = (unsigned __int64)v57;
LABEL_67:
                        *(_QWORD *)a1[10] = qword_140C4DD90 ^ a1[11] ^ v44;
                        goto LABEL_56;
                      }
                    }
                    else
                    {
                      v44 = (unsigned __int64)MiAddSecureEntry(
                                                v15,
...
LABEL_143:
              ...
              v33 = a1[1];
              if ( (unsigned int)MiIsVaRangeAvailable(v30, *a1, a1[3], *a1, v33) )
                goto LABEL_62;
              v32 = -1073741800;
LABEL_73:
              v27 = (__int64)v53;
...
LABEL_77:
        ...
        MiReleaseVadEventBlocks(v15, 0, v18, v17);
