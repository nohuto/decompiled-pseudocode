        ...
        __int64 a10)
{
  ...
  _DWORD *v28; // r9
  NTSTATUS result; // eax
  HANDLE v30; // [rsp+58h] [rbp-60h] BYREF
...
LABEL_25:
  ...
  v18 = ObOpenObjectByPointer(v32, 0x200u, 0LL, 0x2Au, (POBJECT_TYPE)PsProcessType, 0, &v30);
  if ( v18 < 0 )
  {
LABEL_24:
...
LABEL_23:
  ...
  v18 = ObCreateObject(v23, (_DWORD)ExpWorkerFactoryObjectType, a3, v22, 0, 576, 0, 0, (__int64)&v33);
  if ( v18 < 0 )
  {
  ...
  *((_DWORD *)v24 + 128) = 1;
  ...
  v35[0] = 0LL;
  v35[1] = -1LL;
  KeSetTimer2((__int64)(v24 + 41), v24[14], -v24[14], v35);
  result = ObInsertObject(v24, 0LL, a2, 0, 0LL, &v34);
  if ( result >= 0 )
    *a1 = v34;
  return result;
}
