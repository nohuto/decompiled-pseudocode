/*
 * XREFs of ?StRegionFindCompact@?$ST_STORE@USM_TRAITS@@@@SAPEAT_ST_REGION_STATE@1@PEAU_ST_DATA_MGR@1@K@Z @ 0x1402C9058
 * Callers:
...
LABEL_29:
      ...
      {
        v27 = v21 & 0x1F;
        if ( (*v26 | *((_DWORD *)qword_140011AC0 + v27)) == -1 )
        {
          v24 = v21 - v27 + 32;
      ...
      {
        v29 = v24 & 0x1F;
        if ( (*v26 & ~*((_DWORD *)qword_140011AC0 + v29)) != 0 )
        {
          v3 = 0;
        }
        else
