/*
 * XREFs of HalpNumaQueryMemorySideCacheInfo @ 0x1407BF370
 * Callers:
 *     <none>
 * Callees:
 *     HalpNumaCompareMemorySideCacheNodeAndLevel @ 0x1408616A4 (HalpNumaCompareMemorySideCacheNodeAndLevel.c)
 */
