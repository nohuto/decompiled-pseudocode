/*
 * XREFs of PopSaveHiberContext @ 0x14098F9E0
 * Callers:
 ...
 *     PopResetRangeEnum @ 0x140323464 (PopResetRangeEnum.c)
 ...
 *     KeActiveTracepointsPresent @ 0x14038A2F0 (KeActiveTracepointsPresent.c)
 ...
 *     HvlDisableEnlightenment @ 0x1404EBDBC (HvlDisableEnlightenment.c)
 ...
 *     PopWriteChecksumPages @ 0x1409ADFB8 (PopWriteChecksumPages.c)
...
LABEL_13:
    ...
    if ( !v5 )
    {
      ...
      if ( (HvlpFlags & 2) != 0 )
      {
        ...
        while ( *(_DWORD *)(BugCheckParameter3 + 20) != (_DWORD)KeNumberProcessors_0 )
          _mm_pause();
        *(_QWORD *)&v48 = qword_140CECEB8;
        *((_QWORD *)&v48 + 1) = qword_140CECE58;
        *(_QWORD *)&v49 = qword_140CECE60;
        *((_QWORD *)&v49 + 1) = qword_140CECE50;
        *(_QWORD *)&v50 = qword_140CECE70;
        *((_QWORD *)&v50 + 1) = qword_140CECE68;
        if ( *(_BYTE *)(BugCheckParameter3 + 452) )
        {
          v53[0] = v48;
          v53[2] = v50;
          v53[1] = v49;
          v53[4] = xmmword_140CECEA8;
          v53[3] = xmmword_140CECE98;
        ...
        else
        {
          ...
          v54[2] = v50;
          v54[1] = v49;
          v54[4] = xmmword_140CECEA8;
          v54[3] = xmmword_140CECE98;
    ...
    *(_DWORD *)(BugCheckParameter3 + 184) = 8;
    ...
    v17 = __rdtsc();
    qword_140C23968 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v15;
    ...
    if ( v25 >= 0 )
    {
      ...
      if ( *(_BYTE *)(BugCheckParameter3 + 452) )
      {
        ...
        *(_QWORD *)(v6 + 96) = v37 + ((unsigned __int64)(4 * v36 + 4095) >> 12);
        ...
        qword_140C23AF0 = *(unsigned int *)(BugCheckParameter3 + 252);
      }
      ...
      *(_BYTE *)(BugCheckParameter3 + 4) = 1;
      ...
      if ( i )
      {
        do
        {
          v39 = v38++;
          v39 <<= 7;
          qword_140C23AF8 += *(_QWORD *)(v39 + *(_QWORD *)(BugCheckParameter3 + 264) + 56);
          *(_QWORD *)(v39 + *(_QWORD *)(BugCheckParameter3 + 264) + 56) = 0LL;
        }
        while ( v38 < *(_DWORD *)(BugCheckParameter3 + 256) );
      }
      qword_140C23B08 = qword_140C23B28;
      qword_140C23B18 = (unsigned int)dword_140C23B30;
      qword_140C23B28 = 0LL;
      dword_140C23B30 = 0;
      ...
      *(_DWORD *)(BugCheckParameter3 + 184) = 6;
      ...
      if ( v25 >= 0 )
      {
        if ( dword_140C23420 == dword_140C23428 )
        {
