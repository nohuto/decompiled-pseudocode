/*
 * XREFs of EtwTraceLeapSecondDataParseFailure @ 0x140931C94
 * Callers:
...
void __fastcall EtwTraceLeapSecondDataParseFailure(int a1)
{
  ...
  if ( (unsigned int)dword_140C02BB0 > 5 && tlgKeywordOn((__int64)&dword_140C02BB0, 0x400000000000LL) )
  {
    ...
    v2 = v1;
    v6 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BB0, (unsigned __int8 *)byte_14002BD2B, 0LL, 0LL, 3u, &v4);
  }
