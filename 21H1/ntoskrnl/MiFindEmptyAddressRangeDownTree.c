/*
 * XREFs of MiFindEmptyAddressRangeDownTree @ 0x1406BC9AC
 * Callers:
 *     MiFinishCreateSection @ 0x1406304C0 (MiFinishCreateSection.c)
 *     MiFindEmptyAddressRangeDown @ 0x1406BC898 (MiFindEmptyAddressRangeDown.c)
 * Callees:
 *     MiHonorRangeStraddleRequirement @ 0x1402FD638 (MiHonorRangeStraddleRequirement.c)
