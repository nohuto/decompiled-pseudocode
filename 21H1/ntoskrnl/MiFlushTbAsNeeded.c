/*
 * XREFs of MiFlushTbAsNeeded @ 0x140220080
 * Callers:
...
__int64 __fastcall MiFlushTbAsNeeded(ULONG_PTR BugCheckParameter2, unsigned __int64 a2, int a3, int a4)
{
  ...
  __int64 v15; // rcx
  __int64 v17; // rax
  int v18; // [rsp+30h] [rbp-108h] BYREF
  __int16 v19; // [rsp+34h] [rbp-104h]
  __int16 v20; // [rsp+36h] [rbp-102h]
  __int64 v21; // [rsp+38h] [rbp-100h]
  __int64 v22; // [rsp+40h] [rbp-F8h]
  __int64 v23; // [rsp+48h] [rbp-F0h]
  _BYTE v24[152]; // [rsp+50h] [rbp-E8h] BYREF
  ...
  if ( a2 )
  {
    while ( 1 )
    {
        ...
        && ((BugCheckParameter4 & 0x20) == 0 || (BugCheckParameter4 & 0x42) == 0) )
      {
        ...
        if ( Flink )
        {
          v17 = *(_QWORD *)(Flink + 8 * ((BugCheckParameter2 >> 3) & 0x1FF));
...
LABEL_13:
    ...
    if ( qword_140C4DE80 && (BugCheckParameter4 & 0x10) == 0 )
      BugCheckParameter4 &= ~qword_140C4DE80;
    v13 = ZeroPte;
    v14 = HIDWORD(BugCheckParameter4);
    if ( (unsigned int)MiPteInShadowRange(BugCheckParameter2, Flink) )
    {
      if ( (unsigned int)MiPteHasShadow(v15, Flink) )
      {
...
LABEL_11:
    if ( (_DWORD)v14 )
    {
      ...
      {
        if ( v10 == 1 )
          MiInsertTbFlushEntry((__int64)&v18, (__int64)(BugCheckParameter2 << 25) >> 16, 1LL, 0);
      }
      else
      {
