/*
 * XREFs of HalpInterruptRegisterController @ 0x1403A81E4
 * Callers:
...
__int64 __fastcall HalpInterruptRegisterController(__int64 a1)
{
  ...
  if ( HalpInterruptRegistrationAllowed )
  {
      ...
      && ((v6 & 0x400) == 0 || *(_QWORD *)(a1 + 176)) )
    {
      ...
      if ( (*(_DWORD *)(a1 + 212) & 0x100) != 0 && HalpIsPartitionCpuManager(v7) && qword_140C4A388 )
        *(_DWORD *)(a1 + 212) ^= v18;
      ...
      if ( MemoryInternal )
      {
        ...
        *(_WORD *)(v11 + 330) = Length + 2;
        ...
        v16 = (__int64 *)qword_140C4BA58;
        if ( *(ULONG_PTR **)qword_140C4BA58 != &HalpRegisteredInterruptControllers )
          __fastfail(3u);
