/*
 * XREFs of PsOpenThread @ 0x1405E14B4
 * Callers:
 *     NtOpenThread @ 0x1405E0490 (NtOpenThread.c)
...
LABEL_11:
  ...
  else
  {
    while ( 1 )
    {
      ...
      if ( ThreadId[0] )
      {
        v16 = PsLookupProcessThreadByCid((__int64)ThreadId, 0LL, (PADAPTER_OBJECT *)&Thread);
        if ( v16 < 0 )
        {
LABEL_27:
        ...
        *v33 = Handle;
        if ( v10 && (unsigned int)dword_140C01AB0 > 5 && tlgKeywordOn((__int64)&dword_140C01AB0, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14002B000,
            0LL,
            0LL,
            9u,
            &v44);
