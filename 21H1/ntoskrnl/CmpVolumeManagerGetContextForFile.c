/*
 * XREFs of CmpVolumeManagerGetContextForFile @ 0x140687D20
 * Callers:
 ...
 *     CmpVolumeManagerGetContextForGuidUnsafe @ 0x140687EE8 (CmpVolumeManagerGetContextForGuidUnsafe.c)
...
LABEL_20:
      v16 = (PPRIVILEGE_SET *)qword_140D2DFA0;
      if ( *(__int64 **)qword_140D2DFA0 != &qword_140D2DF98 )
        __fastfail(3u);
      ContextForGuidUnsafe = Privileges;
      v13 = 0LL;
      *(_QWORD *)&Privileges->PrivilegeCount = &qword_140D2DF98;
      ContextForGuidUnsafe->Privilege[0].Luid = (LUID)v16;
      *v16 = ContextForGuidUnsafe;
      qword_140D2DFA0 = (__int64)ContextForGuidUnsafe;
      goto LABEL_22;
    }
    goto LABEL_24;
  }
