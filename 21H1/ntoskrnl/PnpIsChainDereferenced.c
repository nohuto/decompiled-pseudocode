/*
 * XREFs of PnpIsChainDereferenced @ 0x14036D7FC
 * Callers:
 ...
 *     PnpUpdateExtensionFlags @ 0x14036D934 (PnpUpdateExtensionFlags.c)
 *     PnpIsAnyDeviceInUse @ 0x14036D964 (PnpIsAnyDeviceInUse.c)
