/*
 * XREFs of Normalization__NormalizeCharacter @ 0x140913F10
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x140912FEC (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x140913D54 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x140587EE0 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x140587F10 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x140587F44 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x140587F7C (NormBuffer__Append.c)
 ...
 *     NormBuffer__LastStartBase @ 0x1405882D4 (NormBuffer__LastStartBase.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x14058858C (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x140912FEC (Normalization__AppendDecomposedChar.c)
