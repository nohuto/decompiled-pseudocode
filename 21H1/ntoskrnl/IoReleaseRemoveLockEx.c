/*
 * XREFs of IoReleaseRemoveLockEx @ 0x1402FD130
 * Callers:
 *     ViFilterDeviceUsageNotificationCompletion @ 0x1409E2050 (ViFilterDeviceUsageNotificationCompletion.c)
 *     ViFilterGenericCompletionRoutine @ 0x1409E2640 (ViFilterGenericCompletionRoutine.c)
 *     ViFilterStartCompletionRoutine @ 0x1409E26B0 (ViFilterStartCompletionRoutine.c)
 * Callees:
