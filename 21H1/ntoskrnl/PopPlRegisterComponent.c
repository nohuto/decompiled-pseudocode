/*
 * XREFs of PopPlRegisterComponent @ 0x1403BA258
 * Callers:
 ...
 *     PopPlLookupComponentPowerProfile @ 0x140578A54 (PopPlLookupComponentPowerProfile.c)
 */
...
void __fastcall PopPlRegisterComponent(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    ...
    v30[0] = v4;
    v27 = 2;
    tlgWriteEx_EtwWriteEx((__int64)&dword_140C021E8, (unsigned __int8 *)&byte_140029411, 2LL, 1u, v8, v9, 8u, &v13);
  }
}
