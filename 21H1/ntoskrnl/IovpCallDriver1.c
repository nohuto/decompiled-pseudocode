/*
 * XREFs of IovpCallDriver1 @ 0x1409CCC2C
 * Callers:
 ...
 *     VfPendingStartLogging @ 0x1409D2A60 (VfPendingStartLogging.c)
 ...
 *     IovpSessionDataReference @ 0x1409DE928 (IovpSessionDataReference.c)
