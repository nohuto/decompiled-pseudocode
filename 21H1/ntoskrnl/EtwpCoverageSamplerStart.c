/*
 * XREFs of EtwpCoverageSamplerStart @ 0x140942988
 * Callers:
 ...
 *     ExReInitializeRundownProtection @ 0x14037BBE0 (ExReInitializeRundownProtection.c)
 ...
 *     PsSetLoadImageNotifyRoutine @ 0x140787E50 (PsSetLoadImageNotifyRoutine.c)
...
LABEL_16:
  ...
  else
  {
    ...
    if ( ImageNotifyRoutine >= 0 )
    {
      ...
      qword_140C19858 = (__int64)Object;
      ExReInitializeRundownProtection((PEX_RUNDOWN_REF)&stru_140C19860);
      Object[287] |= 1u;
