/*
 * XREFs of HvpApplyLegacyLogFile @ 0x14087CD2C
 * Callers:
 *     HvApplyLogFile @ 0x14087CA04 (HvApplyLogFile.c)
 * Callees:
 ...
 *     HvpIsMetadataArrayCoherent @ 0x14087D0C4 (HvpIsMetadataArrayCoherent.c)
