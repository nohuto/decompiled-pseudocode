/*
 * XREFs of MiDecayPfnFullyInitialized @ 0x1402FCDFC
 * Callers:
...
__int64 __fastcall MiDecayPfnFullyInitialized(ULONG_PTR BugCheckParameter2)
{
  ...
  KeAcquireInStackQueuedSpinLock(
    (PKSPIN_LOCK)(*(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 39) & 0x3FFLL)) + 2664LL),
    &LockHandle);
...
LABEL_10:
  ...
  *(_BYTE *)(BugCheckParameter2 + 35) = v6 & 0xF7;
  ...
  __writecr8(OldIrql);
  if ( v2 == 1 )
    return (__int64)RtlpInterlockedPushEntrySList(&stru_140C4E8F0, (PSLIST_ENTRY)BugCheckParameter2);
  return result;
}
