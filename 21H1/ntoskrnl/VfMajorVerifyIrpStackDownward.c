/*
 * XREFs of VfMajorVerifyIrpStackDownward @ 0x1409D4C84
 * Callers:
        ...
        __int64 a6))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  v11 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140D490D0 + 12 * v10);
  if ( v11 )
    v11(a1);
  result = qword_140D49B50;
  if ( qword_140D49B50 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))qword_140D49B50(
                                                                                             a1,
                                                                                             a2,
                                                                                             a3,
                                                                                             a4,
