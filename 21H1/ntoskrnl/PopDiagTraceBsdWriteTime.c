/*
 * XREFs of PopDiagTraceBsdWriteTime @ 0x1403F1008
 * Callers:
...
void __fastcall PopDiagTraceBsdWriteTime(__int64 a1, int a2, int a3)
{
  ...
  if ( (a3 < 0 || a2) && (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x200000000000LL) )
    {
      v13 = 0;
      v16 = 0;
      v19 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140025F11,
        0LL,
        0LL,
        6u,
        &v10);
