/*
 * XREFs of PipCommitPendingService @ 0x140A8EC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PipCommitPendingService(const WCHAR *a1, char *a2, void *a3)
{
  ...
  HANDLE v14; // [rsp+50h] [rbp-30h] BYREF
  HANDLE v15; // [rsp+58h] [rbp-28h] BYREF
  char *v16; // [rsp+60h] [rbp-20h] BYREF
  void *v17; // [rsp+68h] [rbp-18h] BYREF
  __int64 v18; // [rsp+70h] [rbp-10h] BYREF
  char *v19; // [rsp+A8h] [rbp+28h] BYREF
  ...
  if ( v8 == -1073741772 || v8 == -1073741444 || v8 >= 0 )
  {
    ...
    if ( v9 == -1073741772 || v9 == -1073741444 || v9 >= 0 )
    {
      ...
      if ( CachedContextBaseKey >= 0 )
      {
        CachedContextBaseKey = PnpCtxRegCreateKey(*(__int64 *)&PiPnpRtlCtx, v19, a1, 0, 0x20006u, 0LL, &v14, 0LL);
        if ( CachedContextBaseKey >= 0 )
        {
          if ( !v13
