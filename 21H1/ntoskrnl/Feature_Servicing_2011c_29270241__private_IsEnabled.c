/*
 * XREFs of Feature_Servicing_2011c_29270241__private_IsEnabled @ 0x1403F1658
 * Callers:
...
__int64 Feature_Servicing_2011c_29270241__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_2011c_29270241__private_featureState,
                                (__int64)&wil_details_featureDescriptors_a);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (int)&Feature_Servicing_2011c_29270241__private_reporting,
    0x1BEA0E1u,
