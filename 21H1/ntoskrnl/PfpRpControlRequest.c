/*
 * XREFs of PfpRpControlRequest @ 0x1405D175C
 * Callers:
 *     PfSetSuperfetchInformation @ 0x1405D0D98 (PfSetSuperfetchInformation.c)
 * Callees:
 *     PfpRpControlRequestVerify @ 0x140202BEC (PfpRpControlRequestVerify.c)
    ...
    else
    {
      ...
      if ( v2 >= 0 )
      {
        if ( (unsigned int)PfpRpControlRequestVerify(0LL) )
          ...
          return (unsigned int)PfpRpControlRequestPerform(&unk_140C50298, 0LL);
      }
    }
  }
  else
