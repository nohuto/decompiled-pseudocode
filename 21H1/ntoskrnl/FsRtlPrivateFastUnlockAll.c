/*
 * XREFs of FsRtlPrivateFastUnlockAll @ 0x1402F3524
 * Callers:
 *     FsRtlFastUnlockAll @ 0x1402F3500 (FsRtlFastUnlockAll.c)
 *     FsRtlFastUnlockAllByKey @ 0x1404E9F30 (FsRtlFastUnlockAllByKey.c)
 ...
 *     FsRtlPrivateResetLowestLockOffset @ 0x1402E4E20 (FsRtlPrivateResetLowestLockOffset.c)
    ...
    do
    {
        ...
        && (!a5 || HIDWORD(v23[1].RightChild) == a4) )
      {
        ...
        if ( v6[2] )
        {
          ...
          __writecr8(v12);
          ((void (__fastcall *)(__int64, RTL_SPLAY_LINKS *))v6[2])(a6, &v23[1]);
