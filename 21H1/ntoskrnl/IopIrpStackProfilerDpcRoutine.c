/*
 * XREFs of IopIrpStackProfilerDpcRoutine @ 0x140323940
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140276C20 (KeGetPrcb.c)
 *     IopProcessIrpStackProfiler @ 0x140323B8C (IopProcessIrpStackProfiler.c)
 *     __security_check_cookie @ 0x1403CC020 (__security_check_cookie.c)
 *     _local_unwind @ 0x1403CD750 (_local_unwind.c)
 *     _guard_dispatch_icall @ 0x1403FE9E0 (_guard_dispatch_icall.c)
 *     KiCustomAccessRoutine2 @ 0x1404000A0 (KiCustomAccessRoutine2.c)
