/*
 * XREFs of KiCheckForKernelApcDelivery @ 0x1403599E0
 * Callers:
 ...
 *     KeLeaveGuardedRegion @ 0x1403599A0 (KeLeaveGuardedRegion.c)
...
char __fastcall KiCheckForKernelApcDelivery(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  unsigned int v4; // eax
    ...
    if ( KiIrqlFlags )
    {
      if ( (KiIrqlFlags & 1) != 0 )
      {
        ...
        if ( (unsigned __int8)v4 <= 0xDu )
        {
          ...
          v7 = (SchedulerAssist[5] & 0xFFFF0001) == 0;
          v4 = SchedulerAssist[5] & 0xFFFF0001;
