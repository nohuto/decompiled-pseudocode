/*
 * XREFs of PopEtEnergyContextSetState @ 0x14065D724
 * Callers:
 ...
 * Callees:
 *     RtlStateDurationUpdate @ 0x1402D3138 (RtlStateDurationUpdate.c)
 *     PopEtStringSet @ 0x1405F15B0 (PopEtStringSet.c)
 ...
 *     PopEtStringIntern @ 0x1406C6948 (PopEtStringIntern.c)
 */
...
__int64 __fastcall PopEtEnergyContextSetState(_QWORD *a1, _DWORD *a2)
{
  ...
  if ( (v2 & 1) != 0 )
  {
    ...
    if ( *(_QWORD *)(v3 + 456) != v4 )
    {
      PopEtStringSet((_QWORD *)(v3 + 456), v4);
      v7 = 1;
    }
  }
  v8 = *(_DWORD *)(v3 + 464);
