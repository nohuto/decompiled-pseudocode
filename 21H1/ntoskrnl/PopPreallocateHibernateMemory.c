/*
 * XREFs of PopPreallocateHibernateMemory @ 0x14077B96C
 * Callers:
...
__int64 PopPreallocateHibernateMemory()
{
        ...
        (int)result >= 0) )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        qword_140C23648 = (__int64)(v12 + 4096);
        Length = v10;
        qword_140C23630 = v12;
        qword_140C23640 = (__int64)v12;
        if ( dword_140C19730 == 2 )
          qword_140C23698 = (__int64)&v12[v0];
        else
          qword_140C23698 = 0LL;
        LODWORD(xmmword_140C23660) = v4;
        *((_QWORD *)&xmmword_140C23660 + 1) = &v12[v16];
        LODWORD(xmmword_140C23650) = v4;
        *((_QWORD *)&xmmword_140C23650 + 1) = &v12[v17];
        qword_140C23670 = (__int64)&v12[v18];
        if ( dword_140C19730 == 2 )
          qword_140C236A0 = (__int64)&v12[v7];
        else
          qword_140C236A0 = 0LL;
        qword_140C23678 = &v12[v9];
        Address = &v12[((_DWORD)v9 + 4159) & 0xFFFFF000];
        qword_140C23688 = &v12[v8];
        qword_140C23690 = (__int64)&v12[v19];
        return 0LL;
      }
