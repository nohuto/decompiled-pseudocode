/*
 * XREFs of MiUnlockDynamicMemoryNestedParentExclusive @ 0x140529AE4
 * Callers:
...
LABEL_20:
  ...
  LOBYTE(v12) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v1, &v18);
  v7 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v7 )
  {
    v12 = &CurrentThread->152;
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v12->ApcState.ApcListHead[0].Flink != v12 )
      LOBYTE(v12) = KiCheckForKernelApcDelivery(v14, v13, v15, v16);
  }
  return (char)v12;
}
