/*
 * XREFs of MiAllocateAccessLog @ 0x1402A0E70
 * Callers:
 *     MiLogPageAccess @ 0x14029E790 (MiLogPageAccess.c)
 * Callees:
 *     ExAllocatePoolMm @ 0x1402A1070 (ExAllocatePoolMm.c)
 *     MiInitializePageAccessLogging @ 0x1402A12A8 (MiInitializePageAccessLogging.c)
...
_QWORD *__fastcall MiAllocateAccessLog(__int64 a1)
{
  ...
  v2 = *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(a1 + 174));
  if ( (unsigned int)MiSufficientAvailablePages(v2, 1056LL)
    && *(__int64 *)(v2 + 7168) >= 1056
    && (unsigned __int64)(MiState[0] - qword_140C4C808) >= 0x800 )
  {
    v3 = 4096LL;
  }
  else
