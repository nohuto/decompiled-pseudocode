/*
 * XREFs of MiUnloadSystemImage @ 0x1406EF978
 * Callers:
 ...
 *     MiVaToSoftwareWsle @ 0x140556988 (MiVaToSoftwareWsle.c)
 *     MiDereferencePerSessionProtos @ 0x1406E678C (MiDereferencePerSessionProtos.c)
 *     MiBytesToMapSystemImage @ 0x1406F0020 (MiBytesToMapSystemImage.c)
...
void __fastcall MiUnloadSystemImage(__int64 BugCheckParameter2, char a2)
{
  ...
  if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)v5) == 1 )
  {
    ...
    if ( v12 )
    {
      v14 = (dword_140C4CBF0 & 0xFFF) != 0;
      if ( v14 + ((unsigned int)dword_140C4CBF0 >> 12) )
        MiUnmapPatchTable(PteAddress + 8 * (v41 - (v14 + ((unsigned int)dword_140C4CBF0 >> 12))));
  ...
  *(_QWORD *)(BugCheckParameter2 + 136) = 1LL;
  ...
  qword_140C4CC60 = BugCheckParameter2;
  MiDeleteSystemPagableVm((__int64)AnyMultiplexedVm, v23, PteAddress, v39, 5, &v46);
  v26 = DWORD2(v47);
  v27 = v46;
  if ( v23 )
    MiWalkEntireImage(v23, (__int64)&v43, 4, 0xFFFFFFFFLL);
  qword_140C4CC60 = 0LL;
  _InterlockedExchangeAdd((_DWORD *)&xmmword_140C4CC88 + 3, v27 - v26);
  v28 = Object;
  if ( !Object )
  {
    MiReleasePrivilegedPtes(PteAddress, (unsigned int)v41);
