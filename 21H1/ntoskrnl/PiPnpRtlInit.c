/*
 * XREFs of PiPnpRtlInit @ 0x14078A820
 * Callers:
 ...
 *     _PnpCtxSetNtPlugPlayRoutine @ 0x14078A9AC (_PnpCtxSetNtPlugPlayRoutine.c)
...
__int64 __fastcall PiPnpRtlInit(unsigned int a1)
{
  ...
  qword_140C44218 = (__int64)&PiPnpRtlActiveOperations;
