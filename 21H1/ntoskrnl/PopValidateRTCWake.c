/*
 * XREFs of PopValidateRTCWake @ 0x140993C6C
 * Callers:
...
unsigned __int8 __fastcall PopValidateRTCWake(_BYTE *a1)
{
  ...
  *a1 = 0;
  ...
  if ( v2 )
  {
    ...
    dword_140C23460 = dword_140C23ECC;
  }
  v8 = dword_140C23460;
  if ( dword_140C23460 >= 0 )
  {
LABEL_6:
  ...
  if ( (PopFixedWakeSourceMask & 4) == 0 )
    *a1 = 1;
  if ( qword_140C23488 && qword_140C23470[0] > (unsigned __int64)qword_140C23488 )
  {
    v8 = 1;
    dword_140C23460 = 1;
  }
