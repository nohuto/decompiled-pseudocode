/*
 * XREFs of HalpDmaInitMemory @ 0x140A5CEB4
 * Callers:
 *     HalpDmaInitDiscard @ 0x140A5C0A0 (HalpDmaInitDiscard.c)
 * Callees:
...
__int64 __fastcall HalpDmaInitMemory(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  qword_140C4BEA8 = (__int64)&HalpDmaAdapterList;
  ...
  v14 = 0x1000000LL;
  qword_140C4BB20 = HalpAllocPhysicalMemory(a1, &v14, 16LL, a4);
  LOBYTE(v5) = 1;
  dword_140C4BB18 = qword_140C4BB20 != 0 ? 0x10000 : 0;
  qword_140C4BCE0 = HalpAllocPhysicalMemory(a1, &v14, 16LL, v5);
  v7 = 32;
  dword_140C4BCD8 = qword_140C4BCE0 != 0 ? 0x10000 : 0;
  ...
  while ( v7 <= 0x20 );
  qword_140C4BC00 = v10;
  dword_140C4BBF8 = v10 != 0 ? v8 : 0;
  if ( v7 >= 0x40 )
    qword_140C4BBC8 = -1LL;
  else
    qword_140C4BBC8 = (1LL << v7) - 1;
  for ( i = 32; i <= 0x20; ++i )
  {
    LOBYTE(v6) = 1;
    v14 = (1LL << i) - 1;
