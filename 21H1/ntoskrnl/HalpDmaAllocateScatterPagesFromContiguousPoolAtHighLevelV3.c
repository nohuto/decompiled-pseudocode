/*
 * XREFs of HalpDmaAllocateScatterPagesFromContiguousPoolAtHighLevelV3 @ 0x1404B1AE8
 * Callers:
 ...
 *     HalpDmaIndexToTranslationEntry @ 0x1404C2938 (HalpDmaIndexToTranslationEntry.c)
 */
