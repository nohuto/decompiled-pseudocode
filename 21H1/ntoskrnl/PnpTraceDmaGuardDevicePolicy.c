/*
 * XREFs of PnpTraceDmaGuardDevicePolicy @ 0x14075CB54
 * Callers:
...
void __fastcall PnpTraceDmaGuardDevicePolicy(__int64 a1, int a2)
{
  ...
  if ( a2 && (unsigned int)dword_140C02D80 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02D80, 0x400000000000LL) )
    {
      ...
      v8 = 0x1000000LL;
      v19 = 8LL;
      tlgWriteAgg((__int64)&dword_140C02D80, (unsigned __int8 *)&byte_140024028, v2, v5 + 7, &v9);
    }
  }
}
