/*
 * XREFs of MiGetPagePrivilege @ 0x140221650
 * Callers:
...
__int64 __fastcall MiGetPagePrivilege(ULONG_PTR BugCheckParameter2, int a2, unsigned __int64 *a3)
{
  ...
  if ( (unsigned int)MI_PFN_IS_PROTO(BugCheckParameter2, *(_QWORD *)(BugCheckParameter2 + 8), 0LL) )
  {
      ...
      if ( v15 < 0xFFFF800000000000uLL )
      {
        ...
        if ( a3 )
        {
          if ( a2 )
            ...
            v16 = MiLockPageInline(v9, v8, v10);
