/*
 * XREFs of KiInsertSecondarySignalList @ 0x140513918
 * Callers:
 *     KeDispatchSecondaryInterrupt @ 0x1405133F0 (KeDispatchSecondaryInterrupt.c)
 * Callees:
...
void __fastcall KiInsertSecondarySignalList(_QWORD **a1)
{
  ...
  if ( *a1 != a1 )
  {
    ...
    *(_QWORD *)qword_140C2B428 = a1;
    qword_140C2B428 = (__int64)a1[1];
