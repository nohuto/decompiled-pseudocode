/*
 * XREFs of MiTransientPageListWriter @ 0x140552190
 * Callers:
...
__int64 __fastcall MiTransientPageListWriter(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  v4 = ExAcquireSpinLockShared(&dword_140C4E4A0);
  v5 = (_QWORD *)qword_140C4E4A8;
  v6 = 0;
  v7 = v4;
  while ( v5 )
  {
  ...
  if ( v5 && (!v5[4] || a2 < v5[5] || a2 > v5[6]) )
    v5 = 0LL;
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C4E4A0);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
