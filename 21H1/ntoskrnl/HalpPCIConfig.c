/*
 * XREFs of HalpPCIConfig @ 0x140303330
 * Callers:
 *     HaliPciInterfaceReadConfig @ 0x1403032C0 (HaliPciInterfaceReadConfig.c)
 *     HaliPciInterfaceWriteConfig @ 0x14037A4D0 (HaliPciInterfaceWriteConfig.c)
 *     HalpWritePCIConfig @ 0x14039B2BC (HalpWritePCIConfig.c)
 *     HalpReadPCIConfig @ 0x14039B5D4 (HalpReadPCIConfig.c)
 *     HalpPciHandleSecureAccess @ 0x1404CD2FC (HalpPciHandleSecureAccess.c)
 *     HaliHandlePCIConfigSpaceAccess @ 0x1404D1570 (HaliHandlePCIConfigSpaceAccess.c)
 *     HalpKdWritePCIConfig @ 0x1404D9E60 (HalpKdWritePCIConfig.c)
 * Callees:
 ...
 *     HalpPciAccessIoConfigSpace @ 0x1403B80C8 (HalpPciAccessIoConfigSpace.c)
