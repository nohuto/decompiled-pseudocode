/*
 * XREFs of PopPepTryPowerUpComponent @ 0x140308BF8
 * Callers:
 *     PopPepTriggerComponentActivatingActivity @ 0x140308980 (PopPepTriggerComponentActivatingActivity.c)
 *     PopPepTriggerComponentIdleStateChangeActivity @ 0x1403A3310 (PopPepTriggerComponentIdleStateChangeActivity.c)
 * Callees:
