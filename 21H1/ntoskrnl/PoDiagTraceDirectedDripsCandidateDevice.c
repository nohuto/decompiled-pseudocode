/*
 * XREFs of PoDiagTraceDirectedDripsCandidateDevice @ 0x1408E3954
 * Callers:
...
void PoDiagTraceDirectedDripsCandidateDevice()
{
  ...
  if ( PopTriggerDiagHandleRegistered && (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      v13[1] = v1;
      v15 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)byte_1400265B1, 0LL, 0LL, 7u, &v5);
    }
  }
}
