/*
 * XREFs of PopFxUpdateGlobalDeviceAccountingInfo @ 0x140567BC0
 * Callers:
...
__int64 __fastcall PopFxUpdateGlobalDeviceAccountingInfo(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  result = qword_140C24A28;
  if ( qword_140C24A28 < a1 )
  {
    v3 = a1 - qword_140C24A28;
    qword_140C24A30 += a1 - qword_140C24A28;
    if ( a1 - qword_140C24A28 < a2 )
    {
      qword_140C24A38 += v3;
    }
    else
