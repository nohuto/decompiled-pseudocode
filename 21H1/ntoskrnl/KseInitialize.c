/*
 * XREFs of KseInitialize @ 0x140A38EBC
 * Callers:
 ...
 *     KsepMatchInitialize @ 0x140A900FC (KsepMatchInitialize.c)
 */
...
LABEL_29:
  ...
  v5 = _InterlockedCompareExchange(&dword_140C50514, 1, 0);
  if ( v5 == 2 )
    return 0LL;
  if ( v5 == 1 )
    return 259LL;
  ...
  else
  {
    if ( ViVerifierEnabled )
      dword_140C50518 |= 0x40u;
    if ( InitSafeBootMode )
      dword_140C50518 |= 0x100u;
    v8 = *(_QWORD *)(a1 + 240);
...
LABEL_34:
  ...
  {
    dword_140C2AA44[2 * v11] = -1073741637;
