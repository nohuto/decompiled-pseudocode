/*
 * XREFs of VfBuildScatterGatherList @ 0x1409C7FE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ViCheckMdlLength @ 0x1409CAC34 (ViCheckMdlLength.c)
  ...
  if ( *(_DWORD *)(AdapterInformationInternal + 192) == 3 )
  {
    ...
    if ( v9 )
    {
      ...
      ViHalPreprocessOptions(
        ...
        0LL,
        0LL);
      VfReportIssueWithOptions(0xE6u, 0x24uLL, v10, 0LL, 0LL, byte_140C12CF8);
    }
  }
