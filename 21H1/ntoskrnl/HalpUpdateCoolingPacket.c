/*
 * XREFs of HalpUpdateCoolingPacket @ 0x1404D7550
 * Callers:
...
char __fastcall HalpUpdateCoolingPacket(__int64 a1)
{
  ...
  if ( a1 && !HalpAcquiredInterface )
  {
    ...
    xmmword_140C48BD0 = *(_OWORD *)(a1 + 16);
    xmmword_140C48BE0 = *(_OWORD *)(a1 + 32);
    xmmword_140C48BF0 = *(_OWORD *)(a1 + 48);
    xmmword_140C48C00 = *(_OWORD *)(a1 + 64);
    xmmword_140C48C10 = *(_OWORD *)(a1 + 80);
    xmmword_140C48C20 = *(_OWORD *)(a1 + 96);
    xmmword_140C48C30 = *(_OWORD *)(a1 + 112);
    qword_140C48C40 = *(_QWORD *)(a1 + 72);
  }
