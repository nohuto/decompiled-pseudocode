/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x14070DA40
 * Callers:
 ...
 *     ObpCompareEntryLevel1 @ 0x14070D950 (ObpCompareEntryLevel1.c)
 *     ObpCheckDuplicateEntries @ 0x14070DCC8 (ObpCheckDuplicateEntries.c)
