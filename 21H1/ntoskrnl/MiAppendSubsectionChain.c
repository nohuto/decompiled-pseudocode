/*
 * XREFs of MiAppendSubsectionChain @ 0x1402BF084
 * Callers:
...
LABEL_20:
    ...
    do
    {
      v28 = MiDecrementSubsectionViewCount((__int64 *)v4, 24);
      v4 = *(_QWORD *)(v4 + 16);
      v7 += v28;
    }
    while ( v4 );
...
LABEL_4:
  ...
  *(_QWORD *)(a1 + 16) = v13;
  ...
  __writecr8(v11);
  if ( v7 )
    MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C4E588 + 8LL * (*(_WORD *)(v35 + 60) & 0x3FF)), 1LL, v7);
  return 0LL;
}
