/*
 * XREFs of DrvDbGetDriverPackageMappedPropertyKeys @ 0x1409792A0
 * Callers:
 ...
 *     DrvDbOpenDriverPackageRegKey @ 0x1406ADA14 (DrvDbOpenDriverPackageRegKey.c)
 *     DrvDbGetDriverPackageMappedProperty @ 0x1406AE73C (DrvDbGetDriverPackageMappedProperty.c)
 *     DrvDbGetDriverPackageSignerScore @ 0x14071A774 (DrvDbGetDriverPackageSignerScore.c)
...
LABEL_23:
      ...
      do
      {
        ...
        if ( Value == -1073741772 )
        {
          ...
          if ( a3 )
            v31 = a3;
          if ( (int)DrvDbGetDriverPackageSignerScore(a1, a2, (__int64)v31, (wchar_t *)&v40) < 0 || v40 != 218103811 )
          {
LABEL_35:
            CompositeMappedPropertyKeys = 0;
            goto LABEL_44;
