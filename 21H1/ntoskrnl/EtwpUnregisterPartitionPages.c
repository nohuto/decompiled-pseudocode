/*
 * XREFs of EtwpUnregisterPartitionPages @ 0x1405AAEE0
 * Callers:
...
__int64 __fastcall EtwpUnregisterPartitionPages(_QWORD *a1, __int64 a2)
{
  ...
  v3 = 0LL;
  v4 = 0LL;
  v6 = ExAcquireSpinLockExclusive(&dword_140C19830);
  v7 = (unsigned int)dword_140C19824 >> 5;
  v8 = -1LL << (dword_140C19824 & 0x1F);
  v9 = a2 & v8;
  if ( (unsigned int)dword_140C19824 >> 5 )
  {
    v10 = v7 - 1;
    v19 = a2 & v8;
    v11 = qword_140C19828
