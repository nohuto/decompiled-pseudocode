/*
 * XREFs of HalpInterruptUnmap @ 0x14074A048
 * Callers:
 *     HalpTimerUnmapInterrupt @ 0x1404BAFB8 (HalpTimerUnmapInterrupt.c)
 *     HaliRemoveInterruptRemapping @ 0x14074A020 (HaliRemoveInterruptRemapping.c)
 * Callees:
 *     HalpInterruptIsHvLineBasedIntRemappingSupported @ 0x14036A7A0 (HalpInterruptIsHvLineBasedIntRemappingSupported.c)
 *     xHalUnmaskInterrupt @ 0x14036A7C0 (xHalUnmaskInterrupt.c)
