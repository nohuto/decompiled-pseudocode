/*
 * XREFs of CmpInitializeTransactions @ 0x140A502F8
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140C47AD8 = (__int64)&CmpRmListHead;
  ...
  qword_140C47DE8 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_140C4C710 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_140C4C728 = v1;
    qword_140C4C720 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140C47DB8 = (__int64)CmpLazyCommitDpcRoutine;
  CmpLazyCommitDpc = 275;
  qword_140C47D70 = (__int64)&qword_140C47D68;
  qword_140C47D68 = (__int64)&qword_140C47D68;
  qword_140C47B48 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140C47BF8 = (__int64)CmpDelayFreeRMDpcRoutine;
  qword_140C47DC0 = 0LL;
  qword_140C47DD8 = 0LL;
  qword_140C47DB0 = 0LL;
  qword_140C47D78 = 0LL;
  ...
  qword_140C47D28 = (__int64)&CmpLightTransactionList;
