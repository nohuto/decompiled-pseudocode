/*
 * XREFs of PoEnergyContextUpdateComponentPower @ 0x14065D1C8
 * Callers:
 ...
 *     RtlTimelineBitmapUpdateRange @ 0x1402D2D68 (RtlTimelineBitmapUpdateRange.c)
 *     RtlStateDurationUpdate @ 0x1402D3138 (RtlStateDurationUpdate.c)
 *     RtlTimelineBitmapUpdate @ 0x1402D4170 (RtlTimelineBitmapUpdate.c)
...
void __fastcall PoEnergyContextUpdateComponentPower(_QWORD *a1, int a2, __int64 a3)
{
  __int64 v3; // rdi
  int v4; // ebp
  int v7; // esi
