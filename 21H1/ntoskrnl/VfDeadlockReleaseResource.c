/*
 * XREFs of VfDeadlockReleaseResource @ 0x1409DB2C8
 * Callers:
 *     VerifierKeReleaseInStackQueuedSpinLock @ 0x1409D7F40 (VerifierKeReleaseInStackQueuedSpinLock.c)
 *     VerifierKeReleaseInStackQueuedSpinLockForDpc @ 0x1409D8000 (VerifierKeReleaseInStackQueuedSpinLockForDpc.c)
 *     VerifierKeReleaseInStackQueuedSpinLockFromDpcLevel @ 0x1409D80D0 (VerifierKeReleaseInStackQueuedSpinLockFromDpcLevel.c)
...
LABEL_42:
      ...
      else if ( !*((_DWORD *)ViDeadlockGlobals + 8196) && *((int *)ViDeadlockGlobals + 8282) <= 1024 )
      {
        ...
        VfReportIssueWithOptions(0xC4u, 0x1007uLL, (ULONG_PTR)a1, (ULONG_PTR)v18, v21, &dword_140C12D58);
      }
      goto LABEL_57;
    }
    ViDeadlockPreprocessOptions(
      ...
      (const void *)0x1009);
    VfReportIssueWithOptions(0xC4u, 0x1009uLL, (ULONG_PTR)a1, *v18, v6, byte_140C12D54);
LABEL_57:
