/*
 * XREFs of EtwpSetCoverageSamplerInformation @ 0x140943138
 * Callers:
 ...
 *     EtwpCovSampApplyBounds @ 0x14093D6D4 (EtwpCovSampApplyBounds.c)
...
LABEL_4:
    ...
    if ( (_DWORD)v4 == 40 )
    {
      ...
      *(_QWORD *)&v51 = *((_QWORD *)v5 + 4);
      Object = 0LL;
      inserted = ObReferenceObjectByHandle(Handle[1], 1u, qword_140C19850, AccessMode, &Object, 0LL);
      v6 = (char *)Object;
      if ( inserted >= 0 )
      {
...
LABEL_2:
  ...
  *(_QWORD *)&v50 = 0LL;
  v51 = 0LL;
  inserted = ObCreateObject(0, qword_140C19850, (__int64)&v49, AccessMode, 0, 1224, 0, 0, &Object);
  v6 = (char *)Object;
  if ( inserted >= 0 )
  {
