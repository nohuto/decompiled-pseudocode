/*
 * XREFs of PpmSnapDripsAccountingSnapshot @ 0x140561E40
 * Callers:
...
__int64 __fastcall PpmSnapDripsAccountingSnapshot(__int64 a1, int a2, int a3)
{
  ...
  result = (unsigned int)dword_140C4FFC0;
  v5 = 0LL;
  v6 = PopWnfCsEnterScenarioId;
  if ( PpmPlatformStates && dword_140C4FFC0 != -1 )
  {
    v8 = 26LL;
    v9 = (_QWORD *)(1008LL * (unsigned int)dword_140C4FFC0 + *(_QWORD *)(PpmPlatformStates + 48) + 200LL);
    do
    {
