/*
 * XREFs of MiAllocateEntireImageFileExtents @ 0x1408CA954
 * Callers:
 ...
 *     MiNewPfnsSuitable @ 0x1408C15D0 (MiNewPfnsSuitable.c)
  ...
  *v17 = v12[1];
  ...
  if ( a3 )
  {
    for ( j = 0LL; (unsigned int)j < *a3; j = (unsigned int)(j + 1) )
      RtlAvlRemoveNode(&qword_140C4CBE0, (unsigned __int64 *)&a3[12 * j + 2]);
  }
  v19 = 0;
  v20 = v17 + 2;
  if ( !*v17 )
  ...
  do
  {
    ...
    *((_QWORD *)v20 + 5) = *(_QWORD *)&v12[4 * v19 + 4];
    v23 = 0;
    v20[6] = v8;
    BugCheckParameter4 = (_QWORD *)qword_140C4CBE0;
    if ( !qword_140C4CBE0 )
      goto LABEL_29;
    while ( 1 )
    {
...
LABEL_30:
    RtlAvlInsertNodeEx(&qword_140C4CBE0, (unsigned __int64)BugCheckParameter4, v21, v20);
    v8 += *((_QWORD *)v20 + 5);
    ++v19;
    v20 += 12;
  }
