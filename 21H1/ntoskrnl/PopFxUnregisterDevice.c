/*
 * XREFs of PopFxUnregisterDevice @ 0x14079C1FC
 * Callers:
 ...
 *     PopPlCalculateDevicePowerDraw @ 0x1405788E4 (PopPlCalculateDevicePowerDraw.c)
...
__int64 __fastcall PopFxUnregisterDevice(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( (unsigned int)Feature_Servicing_27169067__private_IsEnabled() || (*(_DWORD *)(BugCheckParameter2 + 824) & 4) == 0 )
    ...
    *(_DWORD *)(v9 + 32) = v12;
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&byte_14002922F,
        0LL,
        0LL,
        9u,
        &v28);
