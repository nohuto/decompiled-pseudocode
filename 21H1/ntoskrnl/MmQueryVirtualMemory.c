/*
 * XREFs of MmQueryVirtualMemory @ 0x140634A10
 * Callers:
 *     ?SmStCheckResident@?$SMKM_STORE@USM_TRAITS@@@@SA?AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z @ 0x140317D74 (-SmStCheckResident@-$SMKM_STORE@USM_TRAITS@@@@SA-AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z.c)
 *     NtQueryVirtualMemory @ 0x1406349D0 (NtQueryVirtualMemory.c)
 ...
 *     MiIsSoftwareEnclave @ 0x1402A4910 (MiIsSoftwareEnclave.c)
...
LABEL_16:
  ...
  if ( a3 == 8 && v17[124] && VslQueryVirtualMemory((__int64)v17, v84, &v89) >= 0 )
  {
    if ( (_DWORD)v90 == 4096 )
      v89.m256i_i16[10] = *(_WORD *)MiGetProcessPartition((__int64)v17);
    else
      v89.m256i_i16[10] = 0;
    if ( (v13 & 1) != 0 )
    {
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      LOCK_ADDRESS_SPACE_SHARED(v18, (__int64)v17);
      if ( (*((_DWORD *)v17 + 281) & 0x20) != 0 )
      {
        UNLOCK_ADDRESS_SPACE_SHARED(v18, (__int64)v17);
        if ( (v13 & 1) != 0 )
        {
          KeUnstackDetachProcess(&ApcState);
          ObfDereferenceObjectWithTag(v17, 0x6D566D4Du);
...
LABEL_150:
            v84 = v69;
            v71 = v70 - v69;
            UNLOCK_ADDRESS_SPACE_SHARED((__int64)v85, (__int64)v17);
            if ( (v13 & 1) != 0 )
            {
              KeUnstackDetachProcess(&ApcState);
              ObfDereferenceObjectWithTag(v17, 0x6D566D4Du);
      ...
      UNLOCK_ADDRESS_SPACE_SHARED(v22, (__int64)v17);
...
LABEL_47:
  if ( ((a3 - 3) & 0xFFFFFFFB) != 0 )
  {
    if ( a3 == 6 )
    {
      ...
      if ( (v31 & 0x100000) == 0 && (v31 & 0x70) == 0x20 )
      {
        ...
        *((_QWORD *)&v91 + 1) = _InterlockedCompareExchange64((volatile signed __int64 *)(v32 + 24), -1LL, -1LL);
        ...
        {
          VadEvent = MiLocateVadEvent(v34, 16LL);
    ...
    v82 = 0;
    MemoryPhysicalContiguity = ObQueryNameStringMode((char *)v30, (__int64)a4, v10, &v82, v81);
    HalPutDmaAdapter((PADAPTER_OBJECT)v30);
    if ( v83 )
      *v83 = v82;
    return MemoryPhysicalContiguity;
