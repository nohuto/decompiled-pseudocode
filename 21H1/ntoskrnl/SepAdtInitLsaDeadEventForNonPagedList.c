/*
 * XREFs of SepAdtInitLsaDeadEventForNonPagedList @ 0x14058FD00
 * Callers:
...
bool __fastcall SepAdtInitLsaDeadEventForNonPagedList(__int64 a1)
{
  ...
  KeAcquireInStackQueuedSpinLock(&qword_140C545D8, &LockHandle);
  qword_140C54618 = a1;
  v2 = qword_140C54560 != (_QWORD)&qword_140C54560;
