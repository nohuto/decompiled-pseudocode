/*
 * XREFs of MiDeletePartitionResources @ 0x14055BE28
 * Callers:
    ...
    while ( 1 )
    {
      if ( (v34[3] & 0x7FFFFFFFFFFFFFFFLL) < (v36[3] & 0x7FFFFFFFFFFFFFFFuLL) )
      {
        ...
        if ( !*v36 )
        {
          v37 = 0;
LABEL_58:
          RtlAvlInsertNodeEx((unsigned __int64 *)&v73, (unsigned __int64)v36, v37, v34);
LABEL_59:
          if ( !v31 )
          {
            v22 = a1 + 192;
...
LABEL_69:
  ...
  while ( 1 )
  {
    ...
    if ( v7 )
      goto LABEL_80;
    v46 = (unsigned __int64)&v43->LockEntries[v47];
    v45 &= ~(1 << v47);
    if ( (*(_BYTE *)(v46 + 26) & 1) != 0
      && (*(_DWORD *)(v46 + 32) & 1) == 0
...
LABEL_80:
  ...
  *(_DWORD *)(v46 + 88) = v49;
  *(_QWORD *)(v46 + 32) = 0LL;
  v50 = (__int64)(v46 - (unsigned __int64)v43->LockEntries) / 96;
  if ( v44 == 1 )
...
LABEL_87:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v43, v22, &v71);
  v7 = v43->SpecialApcDisable++ == -1;
  if ( v7 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v43->ApcState.ApcListHead[0].Flink != &v43->152 )
    KiCheckForKernelApcDelivery(v52, v51, v53, v54);
  KiLeaveGuardedRegionUnsafe((__int64)CurrentThread, v51, v53, (__int64)v54);
  v55 = v73;
  v56 = 0LL;
  while ( v55 )
  {
  ...
  while ( v56 )
  {
    ...
    else
    {
      while ( 1 )
      {
        v56 = (unsigned __int64 *)(v56[2] & 0xFFFFFFFFFFFFFFFCuLL);
        if ( !v56 || (unsigned __int64 *)*v56 == v59 )
          break;
        v59 = v56;
      }
    }
    RtlAvlRemoveNode((unsigned __int64 *)&v73, v58);
  ...
  v61 = *(_QWORD *)(a1 + 96);
  if ( v61 )
    MiDereferencePageRunsEx(v61, 0);
  v62 = *(_QWORD *)(a1 + 32);
  if ( v62 )
    MiDereferencePageRunsEx(v62, 0);
  ...
  do
  {
    ...
    if ( v65 )
      ObCloseHandle(v65, 0);
    if ( *(_QWORD *)v64 != a1 + 208 )
      ObfDereferenceObjectWithTag(*(PVOID *)v64, 0x746C6644u);
    v64 += 8LL;
    --v63;
  }
  while ( v63 );
  v66 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(a1 + 2144);
  if ( v66 )
    ExFreeCacheAwareRundownProtection(v66);
  v67 = *(void **)(a1 + 240);
  if ( v67 )
    ObCloseHandle(v67, 0);
  v68 = *(void **)(a1 + 232);
