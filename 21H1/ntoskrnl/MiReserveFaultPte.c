/*
 * XREFs of MiReserveFaultPte @ 0x140534FBC
 * Callers:
...
__int64 MiReserveFaultPte()
{
  ...
  *(&BitMapHeader.SizeOfBitMap + 1) = 0;
  ...
  BitMapHeader.Buffer = (unsigned int *)&dword_140C4EC88;
  KeAcquireInStackQueuedSpinLock(&qword_140C4EC80, &LockHandle);
  ...
  if ( (_DWORD)ClearBitsAndSet == -1 )
    ...
    return qword_140C4EC78 + 8 * ClearBitsAndSet;
}
