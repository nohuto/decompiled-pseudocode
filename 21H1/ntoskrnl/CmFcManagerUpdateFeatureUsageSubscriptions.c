/*
 * XREFs of CmFcManagerUpdateFeatureUsageSubscriptions @ 0x140879860
 * Callers:
...
__int64 __fastcall CmFcManagerUpdateFeatureUsageSubscriptions(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&stru_140C480D0, 0LL);
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C48130, (__int64)&v27, &v23);
  v7 = v23;
  v8 = v27 + 1;
  v28 = 0LL;
  if ( v27 == -1 )
  ...
  if ( updated < 0 )
  {
    ...
    {
LABEL_13:
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&stru_140C480D0, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock(&stru_140C480D0);
      KeAbPostRelease((ULONG_PTR)&stru_140C480D0);
      v17 = v23;
      if ( v23 )
        RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48130, v23);
      goto LABEL_23;
    }
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C48130, v7);
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&RunOnce, 0LL);
  v18 = (struct _DMA_ADAPTER *)qword_140C48120;
  qword_140C48120 = (__int64)DmaAdapter;
  DmaAdapter = v18;
  qword_140C48128 = v26;
  qword_140C48118 = v10;
  RtlpFcBufferManagerUpdateBuffers(qword_140C48130, v8, (__int64)v31);
  RtlpFcWriteHighLowHigh((__int64)&qword_140C480D8, v8);
