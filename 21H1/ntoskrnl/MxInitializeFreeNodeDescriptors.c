/*
 * XREFs of MxInitializeFreeNodeDescriptors @ 0x140A45508
 * Callers:
 ...
 *     MxPageAlwaysHot @ 0x140A45FC8 (MxPageAlwaysHot.c)
 *     MiInitializeBootMemoryDescriptor @ 0x140A45FE8 (MiInitializeBootMemoryDescriptor.c)
 */
