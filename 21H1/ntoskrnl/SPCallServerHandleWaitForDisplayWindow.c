/*
 * XREFs of SPCallServerHandleWaitForDisplayWindow @ 0x14077858C
 * Callers:
...
LABEL_9:
  if ( (v8 & 0x80000000) == 0 )
  {
    ...
    v10 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, int *, __int64, LARGE_INTEGER *))qword_140D2C4B0)(
            &DestinationString,
            &v44,
            &v43,
            4LL,
    ...
    do
    {
      v11 = KeWaitForSingleObject(&stru_140C13C60, UserRequest, 1, 1u, 0LL);
      v12 = v11;
    }
    while ( v11 == 257 );
    if ( v11 >= 0 && v11 != 192 )
