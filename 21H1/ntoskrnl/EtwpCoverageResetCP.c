/*
 * XREFs of EtwpCoverageResetCP @ 0x140930BA4
 * Callers:
 ...
 *     TelemetryCoverageTableLocateInternal @ 0x140318DCC (TelemetryCoverageTableLocateInternal.c)
...
__int64 __fastcall EtwpCoverageResetCP(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 12) = 0;
  ...
  {
    if ( !dword_140C0EF38 )
      dword_140C0EF38 = TelemetryCoverageStringHashInternal(off_140C0EF30, &v29);
    EtwTelemetryCoverageReport((__int64 *)&off_140C0EF30);
  }
