/*
 * XREFs of HsaFlushTbInternal @ 0x1404DD7BC
 * Callers:
 *     HsaAttachDeviceDomainInternal @ 0x1404DCEE8 (HsaAttachDeviceDomainInternal.c)
 *     HsaFlushDomainTb @ 0x1404DD710 (HsaFlushDomainTb.c)
 *     HsaFlushTb @ 0x1404DD770 (HsaFlushTb.c)
 * Callees:
 ...
 *     HalpIommuGetNextFlushDevice @ 0x1404C6B9C (HalpIommuGetNextFlushDevice.c)
