/*
 * XREFs of BcpDisplayCriticalCharacter @ 0x1405BECB0
 * Callers:
...
__int64 __fastcall BcpDisplayCriticalCharacter(__int16 a1, int a2)
{
  ...
  v12 = 0;
  v6 = *(_QWORD *)(qword_140C53DF0 + 24);
  v11 = 0;
  v7 = dword_140C4C518;
  *(_DWORD *)(v6 + 56) = a2;
  *(_DWORD *)(qword_140C53DF0 + 8) = a2;
  result = BgpDisplayCharacterEx(0x20u, (__int64 *)qword_140C53DF0, v3, v5, *(_DWORD *)(v6 + 40), -1, &v12, &v11, v10);
  if ( (int)result >= 0 )
  {
    v9 = v4 + v11;
