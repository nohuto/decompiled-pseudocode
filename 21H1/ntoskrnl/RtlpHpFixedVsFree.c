/*
 * XREFs of RtlpHpFixedVsFree @ 0x14037D8D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RtlpHpFixedVsFree(unsigned __int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  int v34; // eax
  unsigned __int64 v35; // [rsp+30h] [rbp-18h] BYREF
  const signed __int64 *v36; // [rsp+38h] [rbp-10h]
  ...
  v11 = *(__m128i *)(a1 + 48);
  v35 = *(_QWORD *)(a1 + 48);
  v36 = (const signed __int64 *)(a1 ^ _mm_srli_si128(v11, 8).m128i_u64[0]);
  if ( v6 >= v35 )
    goto LABEL_20;
  if ( v4 <= 1 )
  {
...
LABEL_8:
  RtlClearBitsEx((__int64)&v35, v6, v4);
  if ( !v9 )
  {
    v18 = *(_DWORD *)(a1 + 32);
    v19 = a1 + 24;
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( i )
          goto LABEL_29;
        v25 = (unsigned __int64)&CurrentThread->LockEntries[v24];
        v23 &= ~(1 << v24);
        if ( (*(_BYTE *)(v25 + 26) & 1) != 0
          && (*(_DWORD *)(v25 + 32) & 1) == 0
...
LABEL_29:
      ...
      *(_BYTE *)(v25 + 32) |= 2u;
      ...
      v39 = *(_DWORD *)(v25 + 88) & 0x1FFFF;
      *(_DWORD *)(v25 + 88) &= 0xFFFE0000;
      *(_BYTE *)(v25 + 25) &= ~1u;
      *(_QWORD *)(v25 + 32) = 0LL;
      v26 = (__int64)(v25 - (unsigned __int64)CurrentThread->LockEntries) / 96;
      if ( v22 == 1 )
...
LABEL_41:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v19, &v39);
      i = CurrentThread->SpecialApcDisable++ == -1;
      if ( i && ($C774EFD68449142D8271B1EC1EB7FB26 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
        KiCheckForKernelApcDelivery(v28, v27, v29, v30);
      KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread(), v27, v29, (__int64)v30);
    }
  }
}
