/*
 * XREFs of PopFxRegisterPluginEx @ 0x140566468
 * Callers:
 *     PoFxRegisterPluginEx @ 0x1405636E0 (PoFxRegisterPluginEx.c)
 *     PoFxRegisterPlugin @ 0x1408DFB30 (PoFxRegisterPlugin.c)
 * Callees:
...
LABEL_50:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)v16, (__int64)&PopFxPluginLock, &v30);
      ...
      KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread(), v26, v28, (__int64)v29);
