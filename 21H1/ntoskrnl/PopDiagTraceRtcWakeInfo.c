/*
 * XREFs of PopDiagTraceRtcWakeInfo @ 0x140388408
 * Callers:
 ...
 *     PopDiagInterruptTimeToSystemTime @ 0x140993D74 (PopDiagInterruptTimeToSystemTime.c)
 */
...
char __fastcall PopDiagTraceRtcWakeInfo(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  ...
  PopDiagInterruptTimeToSystemTime(qword_140C23470, &v26);
  PopDiagInterruptTimeToSystemTime(qword_140C23488, &v27);
  PopDiagInterruptTimeToSystemTime(qword_140C23448, &v28);
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    ...
    if ( result )
    {
      ...
      result = tlgWriteTransfer_EtwWriteTransfer(
                 ...
                 (unsigned __int8 *)byte_140026913,
                 0LL,
                 0LL,
                 0x10u,
                 &v57);
