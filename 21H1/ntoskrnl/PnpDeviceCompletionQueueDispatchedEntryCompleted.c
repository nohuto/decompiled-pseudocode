/*
 * XREFs of PnpDeviceCompletionQueueDispatchedEntryCompleted @ 0x14036B2B8
 * Callers:
...
__int64 __fastcall PnpDeviceCompletionQueueDispatchedEntryCompleted(__int64 a1, _QWORD *a2)
{
  ...
  v3 = KeAcquireSpinLockRaiseToDpc(&qword_140C44B88);
  v5 = *a2;
  v6 = v3;
  v7 = (_QWORD *)a2[1];
  if ( *(_QWORD **)(*a2 + 8LL) != a2
    ...
    || (*v7 = v5,
        *(_QWORD *)(v5 + 8) = v7,
        v8 = (_QWORD *)qword_140C44B60,
        --dword_140C44B50,
        *(__int64 **)qword_140C44B60 != &qword_140C44B58) )
  {
    __fastfail(3u);
  }
  *a2 = &qword_140C44B58;
  a2[1] = v8;
  *v8 = a2;
  qword_140C44B60 = (__int64)a2;
  KeReleaseSemaphoreEx((__int64)&byte_140C44B68, 0LL, 1LL, v4, 0);
