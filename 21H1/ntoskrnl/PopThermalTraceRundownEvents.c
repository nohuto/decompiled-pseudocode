/*
 * XREFs of PopThermalTraceRundownEvents @ 0x14033C340
 * Callers:
    ...
    do
    {
      ...
      if ( (v1 & 2) != 0 )
      {
        ...
        if ( PopDiagHandleRegistered )
        {
          ...
          {
            DeviceAttachmentBaseRefWithTag = IoGetDeviceAttachmentBaseRefWithTag(v2, 1732538192LL);
            v6 = (void *)DeviceAttachmentBaseRefWithTag;
            if ( DeviceAttachmentBaseRefWithTag )
              v7 = *(_QWORD *)(*(_QWORD *)(DeviceAttachmentBaseRefWithTag + 312) + 40LL);
            else
              v7 = 0LL;
            if ( v7 )
            {
