/*
 * XREFs of OpenGlobalizationUserSettingsKey_ForSingleUserModel @ 0x1405B4ECC
 * Callers:
...
__int64 __fastcall OpenGlobalizationUserSettingsKey_ForSingleUserModel(ULONG a1, HANDLE *a2)
{
  ...
  if ( dword_140CF9FF4 )
  {
    ...
    RtlInitUnicodeString(&DestinationString, &word_140CF74F0);
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( !ResultLength || v4 != -1073741789 && v4 != -2147483643 )
    {
      *(_QWORD *)&DestinationString.Length = 11141120LL;
      DestinationString.Buffer = &word_140CF74F0;
      if ( v9.Length <= 0xAAu )
      {
