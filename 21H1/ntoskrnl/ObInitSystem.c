/*
 * XREFs of ObInitSystem @ 0x140A3AAB4
 * Callers:
 ...
 *     ObpLookupDirectoryEntry @ 0x14077EE4C (ObpLookupDirectoryEntry.c)
 ...
 *     ObpInitInfoBlockOffsets @ 0x140A64794 (ObpInitInfoBlockOffsets.c)
...
char ObInitSystem()
{
  ...
  if ( !(_DWORD)InitializationPhase )
  {
    ...
    while ( v3 );
    ObpDefaultObject = 0;
    qword_140C25B10 = (__int64)&qword_140C25B08;
    qword_140C25B08 = (__int64)&qword_140C25B08;
    byte_140C25B02 = 6;
    dword_140C25B04 = 1;
    ...
    qword_140C25AD8 = (__int64)ObpProcessRemoveObjectDpcWorker;
    ...
    qword_140CFCE28 = (__int64)MmBadPointer;
    LODWORD(v25[1]) = 256;
    LOWORD(v25[0]) = 120;
    HIDWORD(v25[4]) = 512;
