/*
 * XREFs of KeWaitForAlertByThreadId @ 0x1402FC418
 * Callers:
 *     PsDispatchIumService @ 0x14057D274 (PsDispatchIumService.c)
 *     NtWaitForAlertByThreadId @ 0x1406BF3C0 (NtWaitForAlertByThreadId.c)
...
__int64 __fastcall KeWaitForAlertByThreadId(char a1, _QWORD *a2, void *a3)
{
  ...
  if ( !a2 || *a2 )
  {
    v6 = KiCheckWaitNext((__int64)CurrentThread, (__int64)a2, 0, v15, &v16);
    while ( 1 )
    {
      ...
      if ( _interlockedbittestandreset((volatile signed __int32 *)&CurrentThread->116 + 1, 4u) )
        break;
      if ( (unsigned int)KiCheckDueTimeExpired((__int64)CurrentThread, v16, v15[0]) )
      {
        v13 = 258;
        goto LABEL_14;
      }
