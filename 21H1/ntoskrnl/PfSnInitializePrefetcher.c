/*
 * XREFs of PfSnInitializePrefetcher @ 0x140A66910
 * Callers:
...
__int64 PfSnInitializePrefetcher()
{
  ...
  FastMutex.Count = 1;
  qword_140C50390 = 0LL;
  qword_140C50388 = (__int64)&PfSnGlobals;
  PfSnGlobals = (__int64)&PfSnGlobals;
  FastMutex.Owner = 0LL;
  qword_140C503A0 = &qword_140C50398;
  qword_140C50398 = &qword_140C50398;
  ...
  PfpCreateEvent(&DestinationString, SynchronizationEvent, (PVOID *)&qword_140C503E8);
  PfSnPrefetchCacheCtxInitialize((__int64)&unk_140C503F8);
  RegHandle = 0LL;
