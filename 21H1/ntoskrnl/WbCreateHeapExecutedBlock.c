/*
 * XREFs of WbCreateHeapExecutedBlock @ 0x14065CA04
 * Callers:
...
__int64 __fastcall WbCreateHeapExecutedBlock(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  v35 = 0LL;
  v39 = 0;
  v37 = (unsigned int)dword_140C53CC0;
  v5 = WbAlloc(0x58uLL);
  if ( v5 >= 0 )
  {
    ...
    v5 = sub_14065C2B0((UCHAR *)(a2 + 16), v10);
    if ( v5 >= 0 )
    {
      v5 = sub_14065CF98(*(PVOID *)(a2 + 328));
      if ( v5 >= 0 )
      {
