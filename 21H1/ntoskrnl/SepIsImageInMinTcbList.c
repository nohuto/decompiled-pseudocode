/*
 * XREFs of SepIsImageInMinTcbList @ 0x1406D50C8
 * Callers:
...
LABEL_9:
    ...
    *a8 = v23;
    if ( !qword_140C1DAA0 || (LOBYTE(v20) = *v22, LOBYTE(v17) = a6, !(unsigned int)qword_140C1DAA0(v20, v17)) )
      *v22 = a6;
    if ( !qword_140C1DAA0 || (LOBYTE(v20) = *a8, LOBYTE(v17) = a6, !(unsigned int)qword_140C1DAA0(v20, v17)) )
      *a8 = a6;
