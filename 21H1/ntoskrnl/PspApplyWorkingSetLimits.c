/*
 * XREFs of PspApplyWorkingSetLimits @ 0x1409043D4
 * Callers:
 *     NtSetInformationJobObject @ 0x140660620 (NtSetInformationJobObject.c)
 *     PspSetJobLimitsJobPostCallback @ 0x1406EA8A0 (PspSetJobLimitsJobPostCallback.c)
 * Callees:
...
LABEL_12:
    ...
    *v4 = v2;
    ...
    MmEnforceWorkingSetLimit(*(_KPROCESS **)(v2 + 16), 1, v5, v6);
