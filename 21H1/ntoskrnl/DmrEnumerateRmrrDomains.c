/*
 * XREFs of DmrEnumerateRmrrDomains @ 0x1404E30A0
 * Callers:
 *     HalpIvtProcessDrhdEntry @ 0x1404E1D7C (HalpIvtProcessDrhdEntry.c)
 * Callees:
 *     DmrFindDrhdForDeviceScope @ 0x1404E2CAC (DmrFindDrhdForDeviceScope.c)
 *     DmrCheckPathMatch @ 0x1404E2D88 (DmrCheckPathMatch.c)
