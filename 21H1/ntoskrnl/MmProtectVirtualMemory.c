/*
 * XREFs of MmProtectVirtualMemory @ 0x14062CEF0
 * Callers:
...
LABEL_14:
      ...
      if ( (v23 & 0x100000) != 0 )
      {
        if ( (v11 & 0x88) == 0 && v21 != 1 )
        {
          ...
          v26 = MiProtectPrivateMemory(v16, v14, v13, v17, v11, v38, &v40, (__int64)&v43);
          if ( v26 < 0 )
            goto LABEL_117;
          if ( v22 )
          {
...
LABEL_34:
        ...
        {
          if ( !(unsigned int)MiIsRangeFullyCommitted((__int64)v25, v14, v13) )
          {
            v26 = -1073741779;
            goto LABEL_117;
          }
...
LABEL_80:
  ...
  v26 = MiAllowProtectionChange(v60, a1, (ULONG_PTR)v15, v39, v14, v13);
  if ( v26 < 0 )
    goto LABEL_117;
