/*
 * XREFs of MiZeroLargePages @ 0x1402946C0
 * Callers:
...
LABEL_40:
      ...
      while ( *(_DWORD *)(v18 + 6340) || dword_140C4EE18 )
      {
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v21 <= 0xFu && LockHandle.OldIrql <= 0xFu && v21 >= 2u )
          {
            ...
            v14 = (__int64)v22->SchedulerAssist;
...
LABEL_46:
    ...
    v14 = (unsigned int)(*(_DWORD *)(v4 + 260) >> byte_140C4DDCC);
    *(_QWORD *)(v4 + 32) = 0LL;
    *(_BYTE *)(v4 + 69) = 0;
    if ( v8 < 3 )
    {
...
LABEL_64:
          v44 = 0LL;
LABEL_65:
          v48 = dword_140C4DDC0 & (*(_DWORD *)(a1 + 260) + 1) | *(_DWORD *)(a1 + 260) & (unsigned int)~dword_140C4DDC0;
          *(_DWORD *)(a1 + 260) = v48;
          goto LABEL_66;
        }
      }
      ...
      if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (unsigned __int8)v7 <= 0xFu )
      {
        ...
        v14 = (__int64)KeGetCurrentPrcb()->SchedulerAssist;
            ...
            if ( KiIrqlFlags )
            {
              if ( (KiIrqlFlags & 1) != 0 )
              {
                ...
                if ( v54 <= 0xFu && (unsigned __int8)v7 <= 0xFu && v54 >= 2u )
                {
                  ...
                  v14 = (__int64)v55->SchedulerAssist;
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v57 <= 0xFu && (unsigned __int8)v7 <= 0xFu && v57 >= 2u )
          {
            ...
            v14 = (__int64)v58->SchedulerAssist;
      ...
      *(_WORD *)(a1 + 69) = 0;
      ...
      else
      {
        ...
        if ( _interlockedbittestandset(v60, 0x1Fu) )
        {
          ...
          LOBYTE(v48) = -1;
          v105 = ExpWaitForSpinLockExclusiveAndAcquire((unsigned __int64)v60, v48, v15, (_DWORD *)v14);
        }
        ...
        if ( (*v60 & 0xBFFFFFFF) != 0x80000000 )
        {
          do
          {
            ...
            KeYieldProcessorEx(&v105, v68, v15, v14);
            v68 = *(unsigned int *)v60;
          }
...
LABEL_168:
        RtlAvlInsertNodeEx(&qword_140C4E4A8, v81, v15, a1);
        goto LABEL_169;
      }
      v70 = qword_140C4E4B8;
      v71 = 0;
      ...
      *(_QWORD *)(a1 + 16) = v70;
      if ( v70 )
      {
        ...
        *(_QWORD *)(v70 + 8LL * v71) = a1;
        ...
        if ( (*(_BYTE *)(v72 + 16) & 3) != i )
        {
          v79 = RtlpTreeDoubleRotateNodes(&qword_140C4E4B8, v70, v72, v71);
          *(_BYTE *)(v80 + 16) &= 0xFCu;
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v85 <= 0xFu && (unsigned __int8)v7 <= 0xFu && v85 >= 2u )
          {
            ...
            v14 = (__int64)v86->SchedulerAssist;
