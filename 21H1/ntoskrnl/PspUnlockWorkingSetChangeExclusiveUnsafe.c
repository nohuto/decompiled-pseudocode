/*
 * XREFs of PspUnlockWorkingSetChangeExclusiveUnsafe @ 0x14057C154
 * Callers:
...
char PspUnlockWorkingSetChangeExclusiveUnsafe()
{
  ...
  if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)&qword_140C13070) == 1 )
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(v4 + 26) & 1) != 0
      && (*(_DWORD *)(v4 + 32) & 1) == 0
      && (*(_QWORD *)(v4 + 32) & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_140C13070 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_13:
    if ( (*((_DWORD *)&CurrentThread->0 + 1) & 0x10000) == 0 )
      KeBugCheckEx(0x162u, (ULONG_PTR)CurrentThread, (ULONG_PTR)&qword_140C13070, SessionId, 0LL);
    goto LABEL_20;
  }
  *(_BYTE *)(v4 + 32) |= 2u;
  if ( *(__int64 *)(v4 + 32) < 0 )
    KiAbEntryRemoveFromTree((PRTL_BALANCED_NODE)v4);
  v14 = *(_DWORD *)(v4 + 88) & 0x1FFFF;
...
LABEL_20:
  ...
  LOBYTE(v8) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, (__int64)&qword_140C13070, &v14);
  ...
  if ( v5 )
  {
    ...
    if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v8->ApcState.ApcListHead[0].Flink != v8 )
      LOBYTE(v8) = KiCheckForKernelApcDelivery(v10, v9, v11, v12);
  }
  return (char)v8;
}
