/*
 * XREFs of TtmiLogCleanupCurrentSessionStop @ 0x1408FD204
 * Callers:
...
void TtmiLogCleanupCurrentSessionStop()
{
  ...
  if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL) )
    {
      ...
      v4 = 4;
      v3 = &v1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2C8E8, (unsigned __int8 *)word_14002ACFA, 0LL, 0LL, 3u, &v2);
    }
  }
}
