/*
 * XREFs of AlpcpConnectPort @ 0x140647DB4
 * Callers:
 *     NtAlpcConnectPort @ 0x1406466E0 (NtAlpcConnectPort.c)
 *     NtAlpcConnectPortEx @ 0x140646760 (NtAlpcConnectPortEx.c)
 * Callees:
