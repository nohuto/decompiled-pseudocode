/*
 * XREFs of AuthzBasepCompareLegacySecurityAttributesInformation @ 0x1406C8380
 * Callers:
 ...
 *     AuthzBasepCompareSecurityAttribute @ 0x1406C8480 (AuthzBasepCompareSecurityAttribute.c)
 */
