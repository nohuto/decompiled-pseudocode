/*
 * XREFs of CmpBounceContextStart @ 0x14061E2E0
 * Callers:
...
LABEL_10:
  ...
  if ( (unsigned int)dword_140C02130 > 5 && (byte_140C02140 & 4) != 0 && (qword_140C02148 & 4) == qword_140C02148 )
  {
    ...
    v20 = 8LL;
    v19 = &v13;
    tlgWriteAgg((__int64)&dword_140C02130, (unsigned __int8 *)&byte_14002238B, a3, 5u, &v14);
  }
  if ( a3 <= 0x40 )
  {
...
LABEL_13:
  ...
  if ( a3 <= 0x1000 )
  {
    ...
    if ( TransientPoolWithQuotaTag
      || (++dword_140CDB698,
          (TransientPoolWithQuotaTag = (void *)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_140CDB6B0)(
