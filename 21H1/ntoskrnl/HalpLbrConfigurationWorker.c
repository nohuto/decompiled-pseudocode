/*
 * XREFs of HalpLbrConfigurationWorker @ 0x14086246C
 * Callers:
 *     HalpLbrConfigureRecording @ 0x1408624E0 (HalpLbrConfigureRecording.c)
 *     HalpLbrStartRecording @ 0x140862520 (HalpLbrStartRecording.c)
 *     HalpLbrStopRecording @ 0x1408625D0 (HalpLbrStopRecording.c)
 * Callees:
