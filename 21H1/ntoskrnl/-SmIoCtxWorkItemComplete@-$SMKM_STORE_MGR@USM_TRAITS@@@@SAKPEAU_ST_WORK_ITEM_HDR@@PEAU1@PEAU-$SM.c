/*
 * XREFs of ?SmIoCtxWorkItemComplete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAKPEAU_ST_WORK_ITEM_HDR@@PEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@J@Z @ 0x14023D888
 * Callers:
 ...
 * Callees:
 *     ?SmProcessAddCompletion@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAU_SM_WORK_ITEM@1@KPEAU?$SMKM_STORE@USM_TRAITS@@@@J@Z @ 0x14023B1F4 (-SmProcessAddCompletion@-$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAU_SM_WORK_ITEM@1@KPEAU-$SMKM_.c)
...
LABEL_29:
    ...
    {
      SMKM_STORE_MGR<SM_TRAITS>::SmFeEvictComplete(&SmGlobals, a1 + 8, *(unsigned int *)(a1 + 12), v11);
      *(_DWORD *)v4 = 0;
      goto LABEL_8;
    }
    return 0;
...
LABEL_8:
  if ( v12 )
  {
    ...
    if ( (dword_140D240F0 & 2) != 0 )
      SmFpFree((__int64)&dword_140D23FC0, 5, (__int64)v4, (struct _MDL *)v12);
  }
  if ( v8 )
