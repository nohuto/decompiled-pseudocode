/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x14058B0DC
 * Callers:
 *     RtlScrubMemory @ 0x14058AA38 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14058AB6C (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x14058B5C8 (RtlpTestMemoryRandomUp.c)
 */
