/*
 * XREFs of MiInitializeAllResidentPageBasePfns @ 0x1403EFBB8
 * Callers:
        ...
        int a7)
{
  ...
  v7 = *a1;
  v23 = xmmword_140C4E510;
  v9 = _mm_srli_si128((__m128i)xmmword_140C4E510, 8).m128i_u64[0];
  v10 = MiLargePageSizes[a4];
  v11 = xmmword_140C4E4F0;
  *((_QWORD *)&v23 + 1) = (v9 ^ (v7 << 39)) & 0x1FF8000000000LL ^ v9;
  BYTE7(v23) = (BYTE7(xmmword_140C4E510) ^ ~(_BYTE)a4) & 3 ^ BYTE7(xmmword_140C4E510);
  v22 = xmmword_140C4E500;
