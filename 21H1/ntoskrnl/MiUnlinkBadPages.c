/*
 * XREFs of MiUnlinkBadPages @ 0x1405295D8
 * Callers:
 *     MmMarkPhysicalMemoryAsGood @ 0x14052A940 (MmMarkPhysicalMemoryAsGood.c)
 * Callees:
...
__int64 __fastcall MiUnlinkBadPages(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
  ...
  if ( BugCheckParameter2 < a2 )
  {
    ...
    do
    {
      ...
      v20 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v4 + 40) >> 39) & 0x3FFLL));
