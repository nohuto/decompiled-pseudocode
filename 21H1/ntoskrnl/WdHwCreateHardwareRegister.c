/*
 * XREFs of WdHwCreateHardwareRegister @ 0x1404D8F18
 * Callers:
 ...
 *     WdHwpGetReadMethod @ 0x1404D904C (WdHwpGetReadMethod.c)
 *     WdHwpGetWriteMethod @ 0x1404D90BC (WdHwpGetWriteMethod.c)
 */
