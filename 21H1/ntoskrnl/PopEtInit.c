/*
 * XREFs of PopEtInit @ 0x140A69EB8
 * Callers:
 ...
 *     PopEtInitializeBuiltinAppId @ 0x1407B5BFC (PopEtInitializeBuiltinAppId.c)
 *     RtlInternTableInitialize @ 0x1407B5C64 (RtlInternTableInitialize.c)
