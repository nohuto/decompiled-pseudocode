/*
 * XREFs of MiDeleteNonPagedPoolPte @ 0x1402F2060
 * Callers:
...
__int64 __fastcall MiDeleteNonPagedPoolPte(_QWORD *BugCheckParameter2, unsigned __int64 a2, int a3)
{
  ...
  __int64 v28; // rax
  __int64 v29[7]; // [rsp+30h] [rbp-38h] BYREF
  int v30; // [rsp+88h] [rbp+20h] BYREF

  v29[0] = MI_READ_PTE_LOCK_FREE(a2);
  v6 = v29[0];
  if ( (v29[0] & 1) == 0 || a3 > 1 )
    return 0LL;
  v7 = 1LL;
  ...
  if ( SLOBYTE(v29[0]) >= 0 )
  {
      ...
      && ((v6 & 0x20) == 0 || (v6 & 0x42) == 0) )
    {
      ...
      {
        v6 |= 0x20uLL;
        v28 = *((_QWORD *)&Flink->Flink + (((unsigned __int64)v29 >> 3) & 0x1FF));
        if ( (v28 & 0x20) == 0 )
          v6 = v10;
        if ( (v28 & 0x42) != 0 )
          v6 |= 0x42uLL;
    ...
    if ( a3 == 1 )
    {
      if ( (*(_QWORD *)(v12 + 24) & 0x3FFFFFFFFFFFFFFFLL) != 1
        || !(unsigned int)MiEvictPageTableLock(&unk_140C4F580, a2, ZeroPte, 2LL) )
      {
        return 0LL;
      }
LABEL_12:
      ...
      *(_DWORD *)(v9 + 208) = v18 + 1;
      ...
      {
        do
          KeYieldProcessorEx(&v30, v14, v16, v17);
      ...
      if ( !v19 )
        goto LABEL_24;
      MiInitializeTbFlushStamps(v29, v14);
      v20 = v29[0];
...
LABEL_24:
      v23 = v29[0];
      if ( qword_140C4DE80 && (v29[0] & 0x10) == 0 )
        v23 = v29[0] & ~qword_140C4DE80;
      if ( (v23 & 0xFFFFFFFF00000000uLL) == 0 )
