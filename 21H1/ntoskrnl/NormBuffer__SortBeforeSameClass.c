/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x1405885D4
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x140587FE8 (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x1405880A0 (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x140914728 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x140914740 (Normalization__TableLookup.c)
 */
