/*
 * XREFs of ExpScanSystemLookasideList @ 0x1402EC010
 * Callers:
 *     KeBalanceSetManager @ 0x1403B4E10 (KeBalanceSetManager.c)
 * Callees:
 *     ExpComputeLookasideDepth @ 0x1402EC1D4 (ExpComputeLookasideDepth.c)
...
__int64 ExpScanSystemLookasideList()
{
  ...
  for ( i = 0; i < dword_140C57F90; ++i )
  {
    v12 = 2LL;
    v13 = (char *)&unk_140C58000 + 8384 * i;
    do
    {
