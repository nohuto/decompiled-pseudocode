/*
 * XREFs of MiAddPhysicalMemory @ 0x1408C0540
 * Callers:
...
__int64 __fastcall MiAddPhysicalMemory(ULONG_PTR *a1, _DWORD *a2, _DWORD *a3, int a4, __int64 a5)
{
  ...
  *((_QWORD *)&v6 + 1) = *(_QWORD *)a3 >> 12;
  ...
  if ( (unsigned __int64)v6 >= (_QWORD)v6 + *((_QWORD *)&v6 + 1) )
    return 3221225711LL;
  v8 = 0xFFFFFFFFFLL;
  if ( ((unsigned __int64)qword_140C4DE80 >> 12) - 1 < 0xFFFFFFFFFLL )
    v8 = ((unsigned __int64)qword_140C4DE80 >> 12) - 1;
  if ( v7 - 1 > v8 )
  {
    if ( (a4 & 2) == 0 )
    {
...
LABEL_9:
  ...
  if ( (unsigned __int64)v6 >= v7 )
    return 3221225711LL;
  if ( (_QWORD)v6 + *((_QWORD *)&v6 + 1) >= qword_140C4E8E0 && (unsigned __int64)v6 < qword_140C4E8E0 + 2048
...
LABEL_72:
  ...
  v23 = qword_140C52790 + *((_QWORD *)&v6 + 1);
  if ( qword_140C52790 + *((_QWORD *)&v6 + 1) > qword_140C4DE30 )
    v7 = v6 + qword_140C4DE30 - qword_140C52790;
  *((_QWORD *)&v6 + 1) = qword_140C4DE30 - qword_140C52790;
  if ( v23 <= qword_140C4DE30 )
    *((_QWORD *)&v6 + 1) = v9;
      ...
      *(_QWORD *)&v38 = 0LL;
      ...
      if ( (unsigned int)MiSplitPfnBitMaps(&MiSystemPartition, v6, *((__int64 *)&v6 + 1)) )
      {
        ...
        while ( (unsigned int)MiSplitMirrorBitMap(
                                (unsigned __int64 *)&qword_140C4E650[2 * v25],
                                v6,
                                *((__int64 *)&v6 + 1)) )
        {
          if ( ++v25 >= 2 )
