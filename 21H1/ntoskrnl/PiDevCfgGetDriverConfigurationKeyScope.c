/*
 * XREFs of PiDevCfgGetDriverConfigurationKeyScope @ 0x140508628
 * Callers:
...
__int64 __fastcall PiDevCfgGetDriverConfigurationKeyScope(wchar_t *Str2)
{
  ...
  v1 = 0;
  v2 = 0;
  for ( i = (const wchar_t **)&off_1409804D0; wcsicmp(*i, Str2); i += 2 )
  {
    if ( ++v2 >= 7 )
      return v1;
  }
  return *((unsigned int *)&off_1409804D0 + 4 * v2 + 2);
}
