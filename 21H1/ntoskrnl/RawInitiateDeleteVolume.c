/*
 * XREFs of RawInitiateDeleteVolume @ 0x1402C27AC
 * Callers:
 ...
 *     IoAcquireVpbSpinLock @ 0x1402C2A50 (IoAcquireVpbSpinLock.c)
      ...
      if ( *(char **)(*(_QWORD *)p_FilterContexts + 8LL) == p_FilterContexts )
      {
        ...
        if ( (char *)v17->Flink == p_FilterContexts )
        {
          ...
          *(_DWORD *)&AdvancedHeader[1].NodeTypeCode |= 6u;
          v18 = (struct _LIST_ENTRY *)qword_140C1DE78;
          if ( *(__int64 **)qword_140C1DE78 == &RawDismountedQueue )
          {
            *(_QWORD *)p_FilterContexts = &RawDismountedQueue;
            ...
            qword_140C1DE78 = (__int64)&AdvancedHeader[1].FilterContexts;
            KeReleaseGuardedMutex(&RawGlobalLock);
            return v3;
          }
        }
