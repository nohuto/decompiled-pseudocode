/*
 * XREFs of IopCreateSecurityDescriptorPerType @ 0x140702E88
 * Callers:
...
LABEL_4:
  ...
  if ( v4 == 1 )
  {
    ...
    RtlAddMandatoryAce(v16, v17, 0, (__int64)SeLowMandatorySid, v20, 1);
    LOBYTE(v18) = 1;
    RtlSetSaclSecurityDescriptor(SecurityDescriptor, v18, v16, 0LL);
    *a3 = v16;
  }
