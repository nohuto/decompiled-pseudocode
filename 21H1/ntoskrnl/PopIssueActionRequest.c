/*
 * XREFs of PopIssueActionRequest @ 0x140761B68
 * Callers:
...
__int64 __fastcall PopIssueActionRequest(char a1, POWER_ACTION a2, SYSTEM_POWER_STATE a3, int a4)
{
    ...
    || dword_140C23414 == 1 )
  {
    ...
    if ( dword_140C23414 )
    {
      if ( dword_140C23414 > 5 && (dword_140C23414 <= 7 || dword_140C23414 == 11) )
        v14 = 21;
      else
        v14 = 20;
    }
    ...
    if ( !a1 )
    {
      ...
      PopDiagTracePowerTransitionStart(dword_140C23414, dword_140C23418);
      qword_140C238E8 = KeQueryPerformanceCounter(0LL).QuadPart;
...
LABEL_38:
      if ( !a1 && !v42 )
      {
        if ( v21 >= 0 )
        {
          qword_140C23910 = KeQueryPerformanceCounter(0LL).QuadPart;
  ...
  if ( !dword_140C23ED8 )
  {
    if ( byte_140C23ED1 )
    {
      if ( (PopSimulate & 0x4000000) != 0 )
        PopSetSystemState(dword_140C23ED8 + 4, dword_140C23ED8 + 7);
    }
    else
    {
