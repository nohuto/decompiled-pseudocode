/*
 * XREFs of MiGenerateAccessViolation @ 0x140542A40
 * Callers:
...
_BOOL8 __fastcall MiGenerateAccessViolation(unsigned __int64 *a1)
{
  ...
  if ( (unsigned int)MiDeterminePoolType(*a1) == 32 )
    return 0LL;
  v2 = (_QWORD **)&unk_140C4C840;
  v3 = ExAcquireSpinLockShared(&dword_140C4C838);
  while ( 1 )
  {
    v4 = *v2;
    while ( v4 )
...
LABEL_14:
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C4C838);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
