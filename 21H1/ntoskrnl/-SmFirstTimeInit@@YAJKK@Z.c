/*
 * XREFs of ?SmFirstTimeInit@@YAJKK@Z @ 0x1402CAF84
 * Callers:
 ...
 *     ?SmStorePrepare@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@@Z @ 0x1403C4A00 (-SmStorePrepare@-$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@@Z.c)
 *     SmFpPreAllocate @ 0x1403C4A94 (SmFpPreAllocate.c)
 *     __security_check_cookie @ 0x1403CC020 (__security_check_cookie.c)
 *     ZwClose @ 0x1403F2510 (ZwClose.c)
 *     KeBugCheckEx @ 0x1403F5E40 (KeBugCheckEx.c)
 *     memset @ 0x140408F80 (memset.c)
 *     ?SmReInitialize@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@@Z @ 0x1405938B0 (-SmReInitialize@-$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@@Z.c)
 *     ObReferenceObjectByHandle @ 0x14062B200 (ObReferenceObjectByHandle.c)
 *     PsCreateMinimalProcess @ 0x14078748C (PsCreateMinimalProcess.c)
 *     MmStoreRegister @ 0x14079E3F0 (MmStoreRegister.c)
 *     MmStoreCheckPagefiles @ 0x14079F780 (MmStoreCheckPagefiles.c)
 *     ExAllocatePrivateWorkerPool @ 0x1407ACDC4 (ExAllocatePrivateWorkerPool.c)
...
__int64 __fastcall SmFirstTimeInit(int a1, int a2)
{
  ...
  if ( !::Handle )
  {
    ...
    KiStackAttachProcess(PsInitialSystemProcess, 0LL, (__int64)v27, v19);
    MinimalProcess = PsCreateMinimalProcess(PsInitialSystemProcess, 0LL, 0, 0, 0LL, 0LL, (__int64)&Handle);
    KiUnstackDetachProcess((__int64)v27, 0LL, v20, v21);
    if ( MinimalProcess < 0 )
      goto LABEL_12;
    Object = 0LL;
  ...
  if ( (v6 & 0x10) != 0
    || (v6 = ((unsigned __int8)dword_140D24140 ^ (unsigned __int8)(16 * MmStoreChargeResidentAvailableForRead(1LL))) & 0x10 ^ (unsigned int)dword_140D24140,
        dword_140D24140 = v6,
        (v6 & 0x10) != 0) )
  {
    if ( dword_140D24144 )
...
LABEL_12:
      ...
      *(_BYTE *)(v15 + 26) &= ~1u;
      if ( *(_QWORD *)(v15 + 32) )
      {
        if ( v15 )
        {
          *(_BYTE *)(v15 + 32) |= 2u;
          if ( *(__int64 *)(v15 + 32) < 0 )
            KiAbEntryRemoveFromTree(v15, SessionId, v12);
          v24 = *(_DWORD *)(v15 + 88) & 0x1FFFF;
  ...
  if ( (*((_DWORD *)&v9->0 + 1) & 0x10000) == 0 )
    KeBugCheckEx(0x162u, (ULONG_PTR)v9, (ULONG_PTR)&BugCheckParameter2, (unsigned int)SessionId, 0LL);
LABEL_28:
  --v9->AbAllocationRegionCount;
  KiAbThreadRemoveBoosts((ULONG_PTR)v9, (__int64)&BugCheckParameter2, &v24);
