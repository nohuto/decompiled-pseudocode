/*
 * XREFs of HalpIommuPopulateExceptionList @ 0x1403CB560
 * Callers:
  ...
  if ( KdDebugDevice && !*(_DWORD *)(KdDebugDevice + 220) )
  {
    ...
    if ( MemoryInternal )
    {
      ...
      *((_DWORD *)MemoryInternal + 4) = *((unsigned __int16 *)v0 + 4);
      ...
      v4[3] = v6;
      v4[3] = v6 | (v0[1] >> 5) & 7;
      v7 = (_QWORD *)qword_140C49D58;
      if ( *(__int64 **)qword_140C49D58 != &HalpIommuExceptionList )
        __fastfail(3u);
      *v4 = &HalpIommuExceptionList;
      v4[1] = v7;
      *v7 = v4;
      qword_140C49D58 = (__int64)v4;
    }
    else
    {
