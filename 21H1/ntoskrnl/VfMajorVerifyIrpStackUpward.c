/*
 * XREFs of VfMajorVerifyIrpStackUpward @ 0x1409D4D58
 * Callers:
        ...
        int a5))(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD)
{
  ...
  v10 = (void (__fastcall *)(__int64, _BYTE *, _QWORD, __int64, int, int))*((_QWORD *)&unk_140D490D8 + 12 * v9);
  if ( v10 )
    v10(a1, a2, *(_QWORD *)(a3 + 8), a3, a4, a5);
  result = qword_140D49B58;
  if ( qword_140D49B58 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD))qword_140D49B58(
                                                                                     a1,
                                                                                     a2,
                                                                                     *(_QWORD *)(a3 + 8),
                                                                                     a3,
