/*
 * XREFs of MiResolvePrivateZeroFault @ 0x14020F5F0
 * Callers:
...
LABEL_4:
  ...
  v8 = *(_QWORD *)(v7 + 56);
  v45 = v8;
  v48 = *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(v8 + 174));
  if ( (v1 & 0x40) != 0 )
  {
...
LABEL_91:
  v41 = *((_QWORD *)v2 + 9);
  if ( v41 )
    v42 = *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(v41 + 544) + 1838LL));
  else
    LODWORD(v42) = v48;
  if ( !PageChain )
  {
