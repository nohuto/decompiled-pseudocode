/*
 * XREFs of KiMcheckFastForward @ 0x140520BC0
 * Callers:
...
unsigned __int64 __fastcall KiMcheckFastForward(ULONG_PTR BugCheckParameter4, char a2)
{
  ...
  if ( (*(_BYTE *)(BugCheckParameter4 + 368) & 1) == 0 )
  {
    ...
    if ( KiKvaShadow )
    {
      ...
      {
        v4 |= 4u;
        _InterlockedAdd(&dword_140C2AF4C, 1u);
      }
      if ( KiKvaShadow
  ...
  if ( a2 || (v4 & 1) != 0 )
  {
    _InterlockedAdd(&dword_140C2AF58, 1u);
    if ( (v4 & 1) != 0 )
      _InterlockedAdd(&dword_140C2AF60, 1u);
    v9 = 1;
  }
  else
  {
    _InterlockedAdd(&dword_140C2AF5C, 1u);
    v9 = 0;
  }
  v10 = 0LL;
  if ( KiKvaShadow )
...
LABEL_31:
  if ( (v4 & 4) != 0 )
  {
    _InterlockedAdd(&dword_140C2AF64, 1u);
    ...
    if ( KiKvaShadow )
    {
      ...
      *(_QWORD *)(v10 + 24) = CurrentPrcb->HalReserved[(unsigned __int64)v12 / 8];
      ...
      {
        _InterlockedAdd(&dword_140C2AF68, 1u);
    ...
    *(_QWORD *)(v3 + 64) = result;
    _InterlockedAdd(&dword_140C2AF54, 1u);
    *(_WORD *)((char *)&CurrentPrcb->CurrentThread + v12) = 0;
  }
  if ( !a2 )
  {
    _InterlockedAdd(&dword_140C2AF50, 1u);
