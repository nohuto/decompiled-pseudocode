/*
 * XREFs of IopInitializeBootDrivers @ 0x140A56C1C
 * Callers:
 ...
 *     _memicmp @ 0x1403EB8BC (_memicmp.c)
...
__int64 __fastcall IopInitializeBootDrivers(__int64 a1)
{
  ...
  HANDLE v68; // [rsp+78h] [rbp-88h] BYREF
  char *v69; // [rsp+80h] [rbp-80h] BYREF
  ...
  *(_DWORD *)&v70.Length = 8388734;
  ...
  Destination.Buffer = (wchar_t *)&word_140A72170;
...
LABEL_122:
      ...
      if ( (v30 < 0 || PnpWaitForDevicesToStart()) && ((int)VhdInitialize(v1) < 0 || PnpWaitForDevicesToStart()) )
      {
        if ( (int)IopCreateArcNames(v1) < 0 )
          return 0LL;
        PnpBootDeviceWait(v1, 1, IopMarkBootPartition, 0LL);
        v31 = *(_QWORD *)(v1 + 240);
                ...
                && IopGetRegistryValue(*((HANDLE *)v39 + 4), L"Start", 0, &P) >= 0 )
              {
                ...
                if ( *((_DWORD *)P + 1) == 4 && *((_DWORD *)P + 3) >= 4u )
                {
                  ...
                  if ( !v64 )
                  {
                    ...
                    {
                      v52 = (char *)*((_QWORD *)v39 + 4);
                      v69 = v52;
                    }
                    if ( (int)PnpCtxRegCreateKey(*(__int64 *)&PiPnpRtlCtx, v52, L"StartOverride", 0, 2u, 0LL, &v68, 0LL) >= 0 )
                    {
                      PnpCtxRegSetValue(4LL, v68, pszDest, 4u, &v64, 4u);
                      PnpCtxRegCloseKey(v53, v68);
                      v68 = 0LL;
                      if ( (byte_140C1307B & 1) != 0 )
                      {
