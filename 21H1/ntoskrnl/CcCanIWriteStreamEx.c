/*
 * XREFs of CcCanIWriteStreamEx @ 0x14022E440
 * Callers:
    ...
    else
    {
      ...
      if ( !LockHandle.LockQueue.Next )
      {
        if ( (struct _KLOCK_QUEUE_HANDLE *)_InterlockedCompareExchange64(
          ...
          goto LABEL_19;
        Next = KxWaitForLockChainValid(&LockHandle, a2);
        v11 = a1;
        v7 = 0;
      }
      LockHandle.LockQueue.Next = 0LL;
...
LABEL_27:
      ...
      if ( (_BYTE)dword_140CFB19C )
        v26 = 0x4000LL;
      if ( qword_140C52840 < v26 )
      {
        v30 = (unsigned __int16 **)&unk_140C51CE8;
        while ( 1 )
        {
          v45 = *v30;
          if ( dword_140C4DE3C )
...
LABEL_96:
          ++v30;
          v7 = 0;
          if ( (__int64)v30 > (__int64)&qword_140C51CF0 )
          {
            if ( qword_140C529C0 < (unsigned __int64)(qword_140C52A30 + 800) )
              v8 = (unsigned int)MiSufficientAvailablePages(&MiSystemPartition, 80LL) != 0;
            return v8 != 0;
          }
        }
        while ( 1 )
