/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x1405D27B4
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x1405D2440 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x140202C54 (PfVolumeSupportedForPrefetch.c)
...
__int64 __fastcall PfpVolumeOpenAndVerify(__int64 a1, _OWORD *a2, __int64 a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    if ( v7 == 259 )
      KeBugCheckEx(0x191u, 0x132FuLL, 0LL, 0LL, 0LL);
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x133FuLL, 0LL, 0LL, 0LL);
...
LABEL_7:
        ...
        if ( (DevicePowerState & 0xC0000000) == 0xC0000000 )
          goto LABEL_16;
        if ( DevicePowerState == 259 )
          KeBugCheckEx(0x191u, 0x1388uLL, 0LL, 0LL, 0LL);
