/*
 * XREFs of IopCreateArcNamesCd @ 0x140A53AE0
 * Callers:
 ...
 *     IopFetchConfigurationInformation @ 0x140A53C48 (IopFetchConfigurationInformation.c)
 */
  ...
  while ( 1 )
  {
    if ( v7 && *v7 )
    {
      ...
      if ( DeviceObjectPointer < 0 )
        goto LABEL_40;
      v22 = DeviceObject;
      v23 = IopBuildDeviceIoControlRequest(2953344, (int)DeviceObject, 0LL, 0, &v43, 0xCu, 0, &Object_8, &IoStatusBlock);
      if ( !v23 )
        goto LABEL_52;
...
LABEL_43:
    ...
    v24 = IoBuildSynchronousFsdRequest(3u, v22, Pool, 0x800u, StartingOffset, &Object_8, &IoStatusBlock);
    if ( v24 )
    {
      LOWORD(Object_8.Header.Lock) = 0;
      Object_8.Header.SignalState = 0;
      ...
      if ( Status >= 0 )
      {
        ...
        do
        {
          v28 = _mm_loadu_si128((const __m128i *)&Pool[4 * v26]);
          v26 += 4LL;
