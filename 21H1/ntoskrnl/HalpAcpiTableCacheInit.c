/*
 * XREFs of HalpAcpiTableCacheInit @ 0x140A5CC70
 * Callers:
 ...
 *     HalpAcpiCalculateCacheSizeForOverrideTables @ 0x140A8A7A0 (HalpAcpiCalculateCacheSizeForOverrideTables.c)
 */
...
__int64 __fastcall HalpAcpiTableCacheInit(__int64 a1)
{
  ...
  qword_140CDB488 = (__int64)&HalpAcpiTableCacheList;
