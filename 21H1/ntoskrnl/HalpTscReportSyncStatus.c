/*
 * XREFs of HalpTscReportSyncStatus @ 0x1407BCCA0
 * Callers:
...
void HalpTscReportSyncStatus()
{
  ...
  if ( HalpTscWaves )
  {
    ...
    if ( (unsigned int)dword_140C02DB8 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140C02DB8, 0x400000000000LL) )
      {
        v12 = 0;
        v15 = 0;
        v18 = 0;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C02DB8,
          (unsigned __int8 *)byte_140021753,
          0LL,
          0LL,
          5u,
          &v9);
