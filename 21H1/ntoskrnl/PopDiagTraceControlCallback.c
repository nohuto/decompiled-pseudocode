/*
 * XREFs of PopDiagTraceControlCallback @ 0x1406FF180
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)ControlCode == 2 )
  {
    ...
    if ( CallbackContext == &dword_140C021E8 )
    {
      if ( (MatchAnyKeyword & 0x800000000000LL) != 0 )
      {
        ...
        if ( dword_140C021E8 )
        {
          if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) && byte_140C22D8C )
          {
            PopAcquireRwLockExclusive((ULONG_PTR)&PopTelemetryOsState);
            if ( dword_140C22D50 == 1 || (unsigned int)(dword_140C22D50 - 4) <= 1 )
            {
              v27 = (KiQueryUnbiasedInterruptTime() - qword_140C22D68) / 0x2710uLL;
              v28 = v27 - qword_140C22D78;
              v29 = (MEMORY[0xFFFFF78000000008] - qword_140C22D60) / 0x2710uLL;
              qword_140C22D78 = v27;
              v30 = v29 - qword_140C22D70;
              qword_140C22D70 = v29;
              v31 = v30;
              if ( v28 <= v30 )
                v31 = v28;
    ...
    else
    {
      ...
      {
        LOBYTE(v8) = 1;
        PopDiagTracePowerRequestCreate(v8, i);
      }
      PopReleaseRwLock((ULONG_PTR)&PopPowerRequestLock);
      *(_QWORD *)&UserData.Size = 4LL;
      v55 = dword_140C23ECC == 0;
      ...
      if ( PopPowerSettings != &PopPowerSettings )
      {
        ...
        do
        {
          v12 = v10[v11 + 8];
          if ( v12 )
            PopDiagTracePowerSetting(1, (ULONGLONG)(v10 + 4), v12[1], (__int64)(v12 + 3));
          v10 = (PVOID *)*v10;
        }
      ...
      v14 = PopLoggingInformation(&P, (unsigned int *)&v37);
