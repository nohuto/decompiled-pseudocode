/*
 * XREFs of PfSnActivateTrace @ 0x1402C2550
 * Callers:
 *     PfSnBeginTrace @ 0x140651FEC (PfSnBeginTrace.c)
 * Callees:
 *     ExAcquireRundownProtection_0 @ 0x1402068E0 (ExAcquireRundownProtection_0.c)
 *     KxReleaseSpinLock @ 0x140277410 (KxReleaseSpinLock.c)
 *     PfSnAddProcessTrace @ 0x1402C2610 (PfSnAddProcessTrace.c)
...
__int64 __fastcall PfSnActivateTrace(__int64 a1)
{
  ...
  if ( ExAcquireRundownProtection_0((PEX_RUNDOWN_REF)&stru_140C50340) )
  {
    *(_WORD *)(a1 + 486) |= 2u;
    ...
    if ( v3 >= 0 )
    {
      v4 = (_QWORD *)qword_140C50388;
      v5 = (_QWORD *)(a1 + 8);
      if ( *(__int64 **)qword_140C50388 != &PfSnGlobals )
        __fastfail(3u);
      ++PfSnNumActiveTraces;
      *v5 = &PfSnGlobals;
      v3 = 0;
