/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x14033A8FC
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x14033A8A0 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x14033A9AC (wil_details_FeatureReporting_RecordUsageInCache.c)
