/*
 * XREFs of HalpIommuInitSystem @ 0x140997040
 * Callers:
 *     <none>
 * Callees:
 *     HalpIommuGetRootIommuFaultPolicy @ 0x14032349C (HalpIommuGetRootIommuFaultPolicy.c)
 ...
 *     HalpIommuInitializeDmar @ 0x1403A8FC8 (HalpIommuInitializeDmar.c)
 ...
 *     HalpInterruptSetX2ApicPolicy @ 0x1404B7318 (HalpInterruptSetX2ApicPolicy.c)
...
__int64 __fastcall HalpIommuInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( !a1 || HalIommuDispatch && (*(unsigned __int8 (**)(void))HalIommuDispatch)() )
  {
    ...
    if ( !a1 )
    {
      qword_140C49D78 = (__int64)&HalpIommuList;
      HalpIommuList = (__int64)&HalpIommuList;
      qword_140C49D58 = (__int64)&HalpIommuExceptionList;
