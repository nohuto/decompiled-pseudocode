/*
 * XREFs of MiMakeSystemRangeAvailable @ 0x140301AE8
 * Callers:
...
LABEL_11:
  ...
  _InterlockedExchangeAdd64(&qword_140C4F888[(int)BugCheckParameter4], -(__int64)v5);
  if ( (_DWORD)BugCheckParameter4 == 8 )
    qword_140C4DF88 += BugCheckParameter3;
