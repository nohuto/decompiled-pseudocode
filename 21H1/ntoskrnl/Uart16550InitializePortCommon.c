/*
 * XREFs of Uart16550InitializePortCommon @ 0x1405C51A4
 * Callers:
 *     Uart16550InitializePort @ 0x1405C5180 (Uart16550InitializePort.c)
 *     Uart16550LegacyInitializePort @ 0x1405C5260 (Uart16550LegacyInitializePort.c)
 *     Uart16550MmInitializePort @ 0x1405C52D0 (Uart16550MmInitializePort.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1403FE9E0 (_guard_dispatch_icall.c)
 *     Uart16550SetBaud @ 0x1405C5470 (Uart16550SetBaud.c)
 *     UartpSetAccess @ 0x1405C5D4C (UartpSetAccess.c)
 */
