/*
 * XREFs of CcCopyReadEx @ 0x140287C10
 * Callers:
 *     CcCopyRead @ 0x1406EB560 (CcCopyRead.c)
 *     CcFastCopyRead @ 0x140862E40 (CcFastCopyRead.c)
        ...
        struct _KTHREAD *a7)
{
  ...
  if ( v16 )
  {
    ...
    if ( v16 != v25 )
    {
      IoReferenceIoAttributionFromThread((__int64)v16, (__int64)&v22);
      Next = v23;
      a3 = v29;
    }
  }
  v27 = CcMapAndCopyFromCache((int)Object, *a2, a3, v13, v15, (__int64)&v28, (LODWORD(Next->Next) >> 18) & 7, v22);
  if ( v27 )
  {
