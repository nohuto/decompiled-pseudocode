/*
 * XREFs of IopDisassociateThreadIrp @ 0x1404FAC84
 * Callers:
 ...
 *     IoAllocateErrorLogEntry @ 0x14037D580 (IoAllocateErrorLogEntry.c)
  ...
  if ( *(unsigned int **)(*(_QWORD *)p_SystemCallNumber + 8LL) != p_SystemCallNumber
    ...
    || (*(_QWORD *)p_SystemCallNumber = v11,
        *(_QWORD *)(v11 + 8) = p_SystemCallNumber,
        v3[1] = v3,
        *v3 = v3,
        v12 = (_QWORD *)qword_140C45E68,
        *(__int64 **)qword_140C45E68 != &IopDeadIrps) )
  {
    __fastfail(3u);
  }
  *v10 = &IopDeadIrps;
