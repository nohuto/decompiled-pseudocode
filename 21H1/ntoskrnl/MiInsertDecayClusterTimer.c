/*
 * XREFs of MiInsertDecayClusterTimer @ 0x14030009C
 * Callers:
...
unsigned __int64 __fastcall MiInsertDecayClusterTimer(__int64 a1)
{
  ...
  v1 = (a1 + 0x58000000000LL) / 48 - qword_140C4E8E0;
  ...
  *(_QWORD *)(a1 + 8) = 2 * (((unsigned int)result >> 1) | 0xFFFFFFFF00000000uLL);
  if ( v6 == 0x7FFFFFFF )
    ...
    *(_QWORD *)(48 * (qword_140C4E8E0 + v6) - 0x58000000000LL + 8) = v7 | *(_QWORD *)(48 * (qword_140C4E8E0 + v6)
                                                                                    - 0x58000000000LL
                                                                                    + 8) & 0x1FFFFFFFFLL;
