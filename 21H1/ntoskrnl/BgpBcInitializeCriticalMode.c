/*
 * XREFs of BgpBcInitializeCriticalMode @ 0x140A94798
 * Callers:
...
LABEL_10:
                         ...
                         (__int64)&v34) >= 0 )
          {
            ...
            *v25++ = DWORD2(v34);
            ...
            {
              v23 += 18;
              if ( (__int64)v23 < (__int64)&qword_140C10FC8 )
                goto LABEL_10;
              HIDWORD(v34) = 0;
              if ( (int)BcpGetMaxResourceProfile((__int64)v33, &v32) >= 0 )
              {
                ...
                if ( Memory )
                {
                  ...
                  qword_140C13228 = v26;
                  qword_140C53DF0 = BgpDisplayCharacterGetContext((__int64)v33, &v30, 3);
                  if ( qword_140C53DF0 )
                  {
                    dword_140C132D0 |= 0x10u;
                    return 0LL;
                  }
                }
              }
      ...
      if ( qword_140C53DF0 )
        BgpDisplayCharacterDestroyContext(qword_140C53DF0);
    }
  }
  return 0LL;
}
