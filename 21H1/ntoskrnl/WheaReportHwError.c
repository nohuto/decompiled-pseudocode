/*
 * XREFs of WheaReportHwError @ 0x1405B5450
 * Callers:
 ...
 *     WheapApplyThresholdChecks @ 0x1405B5A18 (WheapApplyThresholdChecks.c)
 *     WheapAttemptErrorRecovery @ 0x1405B5BB0 (WheapAttemptErrorRecovery.c)
