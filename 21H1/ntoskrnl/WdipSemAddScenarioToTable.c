  ...
  if ( a1 )
  {
    ...
    if ( dword_140C1A4E0 )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)v3 >= dword_140C1A4E0 )
          goto LABEL_7;
      }
    ...
    {
LABEL_7:
      if ( (unsigned int)dword_140C1A4E0 >= 0x40 )
        return (unsigned int)-1073741823;
      else
        WdipSemScenarioTable[dword_140C1A4E0++] = a1;
    }
  }
  else
  {
