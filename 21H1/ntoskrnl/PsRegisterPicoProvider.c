/*
 * XREFs of PsRegisterPicoProvider @ 0x140907560
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140C1DFD0 = *(_OWORD *)(a1 + 16);
  xmmword_140C1DFE0 = *(_OWORD *)(a1 + 32);
  xmmword_140C1DFF0 = *(_OWORD *)(a1 + 48);
  xmmword_140C1E000 = *(_OWORD *)(a1 + 64);
  qword_140C1E010 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140C1DFF0, 8).m128i_u64[0];
