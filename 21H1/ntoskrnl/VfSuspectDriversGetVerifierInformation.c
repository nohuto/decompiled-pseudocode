/*
 * XREFs of VfSuspectDriversGetVerifierInformation @ 0x1409D6870
 * Callers:
 ...
 *     VfTargetDriversGetZeroCounters @ 0x1409D3E24 (VfTargetDriversGetZeroCounters.c)
  ...
  *a3 = 0;
  ...
  if ( (__int64 *)VfSuspectDriversList != &VfSuspectDriversList )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v6 + 40) = dword_140C2A804;
      *(_DWORD *)(v6 + 44) = dword_140C2A808;
      *(_DWORD *)(v6 + 92) = dword_140C2A838;
      *(_DWORD *)(v6 + 48) = dword_140C2A80C;
      *(_DWORD *)(v6 + 52) = dword_140C2A810;
      *(_DWORD *)(v6 + 56) = dword_140C2A814;
      *(_DWORD *)(v6 + 60) = dword_140C2A818;
      *(_DWORD *)(v6 + 64) = dword_140C2A81C;
      *(_DWORD *)(v6 + 68) = dword_140C2A820;
      *(_DWORD *)(v6 + 72) = dword_140C2A824;
      *(_DWORD *)(v6 + 76) = dword_140C2A828;
      *(_DWORD *)(v6 + 80) = dword_140C2A82C;
