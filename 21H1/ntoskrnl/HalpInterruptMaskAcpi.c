/*
 * XREFs of HalpInterruptMaskAcpi @ 0x1409938AC
 * Callers:
 ...
 *     HalpInterruptPicLine @ 0x1403A4654 (HalpInterruptPicLine.c)
 *     HalpInterruptSetProblemEx @ 0x1404CC668 (HalpInterruptSetProblemEx.c)
 */
...
__int64 __fastcall HalpInterruptMaskAcpi(char a1)
{
  ...
  v8 = 0LL;
  HalpInterruptPicLine(&v8, (unsigned __int16)word_140C49FCE);
  HalpInterruptApplyOverrides((unsigned int *)&v8, 0LL, 0LL);
  Lines = HalpInterruptFindLines((unsigned int *)&v8);
  if ( !Lines )
    return HalpInterruptSetProblemEx(0LL, 18, 0, (__int64)"minkernel\\hals\\lib\\interrupts\\common\\intrupt.c", 0x8DCu);
  v3 = Lines[5];
  if ( a1 )
    *(_DWORD *)(v3 + 12) |= 0x10u;
  else
  ...
  if ( v4 )
    ...
    return HalpInterruptSetProblemEx(0LL, 17, 0, (__int64)"minkernel\\hals\\lib\\interrupts\\common\\intrupt.c", 0x8ECu);
}
