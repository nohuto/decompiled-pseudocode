/*
 * XREFs of PopDecompressHiberBlocks @ 0x14098D8EC
 * Callers:
 ...
 *     RtlDecompressBufferProgress @ 0x14058C380 (RtlDecompressBufferProgress.c)
 ...
 *     PopReadProducerConsumerBuffer @ 0x1409ADA20 (PopReadProducerConsumerBuffer.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  LODWORD(v8) = (_DWORD)qword_140C23678;
  v9 = 0;
  v43 = 0;
  v47 = 0LL;
  v41 = 0;
  v45 = (char *)qword_140C23678;
  while ( 1 )
  {
    PopHiberCheckForDebugBreak();
    if ( !qword_140C23AD8 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_140C23620 )
      qword_140C23AD8 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_140C23621
      && (!byte_140C23620 || (unsigned int)dword_140C23604 > 0x640) )
    {
      v15 = __rdtsc();
      if ( byte_140C50580 )
      {
      ...
      v16 = __rdtsc();
      qword_140C23AC0 += (((unsigned __int64)HIDWORD(v16) << 32) | (unsigned int)v16) - v15;
    }
    v40 = 4;
