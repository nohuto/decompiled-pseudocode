/*
 * XREFs of _CmSetDeviceInterfaceMappedProperty @ 0x140751E34
 * Callers:
        ...
        ULONG a8)
{
  ...
  if ( !a4 )
  {
    ...
    if ( a6 < 2 )
      ...
      v20 = CmSetDeviceInterfaceMappedPropertyFromRegValue(a1, (int)a2, (int)a3, a5, a6, a7, a8);
    v11 = v20;
    if ( v20 >= 0 )
      PnpObjectRaisePropertyChangeEvent(a1, (__int64)a2, 3LL, (__int64)a3, 0LL, a5);
    if ( v11 != -1073741802 )
      return v11;
LABEL_6:
    v15 = &off_14097F660;
