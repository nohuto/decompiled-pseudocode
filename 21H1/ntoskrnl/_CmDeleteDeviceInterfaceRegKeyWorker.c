/*
 * XREFs of _CmDeleteDeviceInterfaceRegKeyWorker @ 0x140718B44
 * Callers:
...
__int64 __fastcall CmDeleteDeviceInterfaceRegKeyWorker(__int64 a1, const WCHAR *a2, int a3, int a4, char a5)
{
  const WCHAR *v7; // rbx
  int v8; // r12d
