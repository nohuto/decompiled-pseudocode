/*
 * XREFs of KiInitializeKernel @ 0x140998980
 * Callers:
 ...
 *     KeGetXSaveFeatureFlags @ 0x1403A9D90 (KeGetXSaveFeatureFlags.c)
 *     KiConfigureInitialNodes @ 0x1403ABDCC (KiConfigureInitialNodes.c)
 ...
 *     KiDetectFpuLeakage @ 0x14098B2A0 (KiDetectFpuLeakage.c)
 ...
 *     HalpInitSystemPhase1 @ 0x1409976CC (HalpInitSystemPhase1.c)
 *     KiCompleteKernelInit @ 0x1409992B4 (KiCompleteKernelInit.c)
 *     KiInitializeIdleThread @ 0x1409995F8 (KiInitializeIdleThread.c)
...
__int64 __fastcall KiInitializeKernel(__int64 a1, __int64 a2, __int64 a3, ULONG_PTR a4, int a5, __int64 a6)
{
  ...
  *(_QWORD *)(a4 + 33952) = a4 + 33952;
  ...
  else
  {
    ...
    KiInitSystem();
    qword_140C31C48 = (__int64)&KiProcessListHead;
