/*
 * XREFs of MiBuildReservationCluster @ 0x140383580
 * Callers:
...
LABEL_24:
  ...
  if ( (unsigned int)v19 < DWORD2(v99) )
  {
    ...
    *v106 = v11;
    ...
    v35 = v98;
    v36 = *(_QWORD *)(v98 + 24);
    *(_QWORD *)(v98 + 24) = v36 ^ ((v36 + 1) ^ v36) & 0x3FFFFFFFFFFFFFFFLL;
    ...
    if ( KiIrqlFlags )
    {
      if ( (KiIrqlFlags & 1) != 0 )
      {
        ...
        if ( v37 <= 0xFu && (unsigned __int8)v13 <= 0xFu && v37 >= 2u )
        {
          ...
          v36 = -1LL << ((unsigned __int8)v13 + 1);
          v39 = v38->SchedulerAssist;
          v40 = ~(unsigned __int16)v36;
          v17 = (v40 & v39[5]) == 0;
          v35 = (unsigned int)v40 & v39[5];
          v39[5] = v35;
          if ( v17 )
    ...
    __writecr8(v13);
    if ( (unsigned int)MI_PFN_IS_PROTO(v12, v36, v35)
      && (!(unsigned int)MiGetPageFileSectionForReservation(v34, &v103, 0LL)
       || (v44 = *(_QWORD *)(v12 + 24) >> 62, v93 = 1, (v44 & 1) != 0))
      || (v45 = (_QWORD *)MiReservePtes((__int64)&qword_140C4EE80, 1LL), v102 = v45, (v46 = (unsigned __int64)v45) == 0) )
    {
      v71 = Src;
LABEL_99:
      v74 = v98;
      v75 = (unsigned __int8)MiLockPageInline(v98, v41, v42, v43);
    ...
    ValidPte = MiMakeValidPte((unsigned __int64)v45, v96, 536870913LL, (__int64)v43);
    v48 = 0;
...
LABEL_51:
    ...
    *(_QWORD *)v46 = ValidPte;
    ...
    if ( qword_140C4DE80 && (v73 & 0x10) == 0 )
      v73 &= ~qword_140C4DE80;
    v19 = HIDWORD(v73);
    MiReleasePtes((__int64)&qword_140C4EE80, v102, 1u);
    goto LABEL_99;
  }
  _InterlockedAnd64((volatile signed __int64 *)(v12 + 24), 0x7FFFFFFFFFFFFFFFuLL);
  if ( KiIrqlFlags )
