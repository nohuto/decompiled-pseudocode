/*
 * XREFs of VmpRemoveMemoryRange @ 0x14059F294
 * Callers:
 *     VmDeleteMemoryRange @ 0x14092A6F0 (VmDeleteMemoryRange.c)
 * Callees:
 ...
 *     VmpVaRangeNumberOfGpaRanges @ 0x14059FA10 (VmpVaRangeNumberOfGpaRanges.c)
...
LABEL_16:
  ...
  v23 = (_QWORD *)v22[2];
  if ( v14 != a3 || v13 != v36 || v23[3] != a2 || v23[4] != v9 )
  {
    if ( (unsigned __int64)VmpVaRangeNumberOfGpaRanges(v22[2]) > 1 )
    {
LABEL_47:
      v10 = -1073741637;
      goto LABEL_17;
    ...
    if ( a3 == v27 && a2 == v23[3] )
    {
      ...
      {
LABEL_54:
        if ( v30 && v9 == v23[4] && a3 > v27 && a2 > v23[3] )
        {
          v22[7] = a3 - 1;
          v23[4] = a2 - 1;
          goto LABEL_59;
  ...
  RtlRbRemoveNode((unsigned __int64 *)SpinLock + 1, v12);
  v22[5] = -1LL;
  v24 = *v22;
  v25 = (_QWORD *)v22[1];
  ...
  *(_QWORD *)(v24 + 8) = v25;
  P = v22;
  if ( (_QWORD *)v23[5] == v23 + 5 )
  {
    RtlRbRemoveNode((unsigned __int64 *)SpinLock + 3, (unsigned __int64)v23);
    v23[2] = -1LL;
    v26 = *(_QWORD *)v11;
    v34 = v23;
    if ( (SpinLock[4] & 1) == 0 )
