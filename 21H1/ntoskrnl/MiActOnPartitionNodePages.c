/*
 * XREFs of MiActOnPartitionNodePages @ 0x14055ADB0
 * Callers:
...
LABEL_44:
    ...
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 | *((_DWORD *)qword_140011AC0 + (v11 & 0x1F))) == -1 )
    {
    ...
    while ( v17 < v15 && _bittest64(v8, v17) )
      ++v17;
    SchedulerAssist = 0LL;
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 & ~*((_DWORD *)qword_140011AC0 + (v17 & 0x1F))) == 0 )
    {
