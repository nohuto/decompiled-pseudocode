/*
 * XREFs of HalpInterruptBuildStartupStub @ 0x14039E060
 * Callers:
 ...
 *     HalpInterruptCreateGdtEntry32 @ 0x14039E2A8 (HalpInterruptCreateGdtEntry32.c)
 *     memmove @ 0x140408CC0 (memmove.c)
 *     KeForceEnableNx @ 0x1409957B0 (KeForceEnableNx.c)
 */
...
_QWORD *__fastcall HalpInterruptBuildStartupStub(PVOID *a1, PHYSICAL_ADDRESS *a2, const void *a3, __int64 a4)
{
  ...
  *((_OWORD *)v11 + 1) = xmmword_14001EBF0;
  *((_OWORD *)v11 + 2) = xmmword_14001EC00;
  *((_OWORD *)v11 + 3) = xmmword_14001EC10;
  *((_OWORD *)v11 + 4) = xmmword_14001EC20;
