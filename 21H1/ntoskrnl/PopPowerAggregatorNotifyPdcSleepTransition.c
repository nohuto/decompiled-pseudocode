/*
 * XREFs of PopPowerAggregatorNotifyPdcSleepTransition @ 0x1408E9FE8
 * Callers:
...
__int64 __fastcall PopPowerAggregatorNotifyPdcSleepTransition(char a1, int a2)
{
  ...
  if ( (_DWORD)xmmword_140C217A8 == 1 )
  {
    ...
    if ( a1 )
    {
      BYTE8(xmmword_140C217B8) = 0;
      HIDWORD(xmmword_140C217B8) = 0;
      goto LABEL_13;
    }
    BYTE8(xmmword_140C217B8) = 1;
    v5 = 259;
    HIDWORD(xmmword_140C217B8) = a2;
  }
  else
  {
    if ( (_DWORD)xmmword_140C217A8 != 4 )
    {
      v5 = -1073741811;
      goto LABEL_13;
    }
...
LABEL_13:
  ...
  PopPowerAggregatorDiagTracePdcSleepTransition(
    v4,
    a2,
    (unsigned int)&xmmword_140C21778,
    (unsigned int)&xmmword_140C217A8,
    v5);
