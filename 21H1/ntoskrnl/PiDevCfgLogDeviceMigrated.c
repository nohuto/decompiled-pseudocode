/*
 * XREFs of PiDevCfgLogDeviceMigrated @ 0x1408A28F4
 * Callers:
...
char __fastcall PiDevCfgLogDeviceMigrated(__int64 a1, __int64 a2, int a3)
{
  ...
  result = byte_140C1307A;
  if ( (byte_140C1307A & 8) != 0 && (byte_140C1307A & 0x20) != 0 && (byte_140C1307A & 0x10) != 0 )
  {
    v6 = (const wchar_t *)&dword_140987614;
    if ( a3 < 0 )
    {
      v7 = *(_QWORD *)(a2 + 152);
      v12 = *(_DWORD *)(a2 + 176);
