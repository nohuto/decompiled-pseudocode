/*
 * XREFs of HalpDmaFindDeviceObjectByToken @ 0x140376830
 * Callers:
 *     HaliGetDmaAdapter @ 0x140376690 (HaliGetDmaAdapter.c)
 *     HalpDmaCheckAdapterToken @ 0x1404B3950 (HalpDmaCheckAdapterToken.c)
 *     HalpDmaLinkDeviceObjectByToken @ 0x14074E2A0 (HalpDmaLinkDeviceObjectByToken.c)
 * Callees:
