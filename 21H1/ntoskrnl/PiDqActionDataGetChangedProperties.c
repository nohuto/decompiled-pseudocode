/*
 * XREFs of PiDqActionDataGetChangedProperties @ 0x14075C394
 * Callers:
...
LABEL_32:
  ...
  v11 = PiDqPnPGetObjectPropertyInBestLocale(v45[0], v20, (int)v14, (int)v15 + 80, *(_DWORD *)(v15 + 100), v47, &v50);
  if ( v11 >= 0 )
  {
    ...
    while ( 1 )
    {
      v23 = (const wchar_t *)(v21 & -(__int64)(*(_WORD *)v21 != 0));
      ...
      do
        ++v25;
      while ( v23[v25] );
      v21 = (unsigned __int64)&v23[v25 + 1];
    }
    v26 = *a10;
    v27 = 0;
    v28 = v44;
    if ( *a10 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v37 = v50 - *(_QWORD *)(v36 + v35);
          if ( (_QWORD)v50 == *(_QWORD *)(v36 + v35) )
            v37 = *((_QWORD *)&v50 + 1) - *(_QWORD *)(v36 + v35 + 8);
