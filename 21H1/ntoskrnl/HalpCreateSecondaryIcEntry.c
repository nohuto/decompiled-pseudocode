/*
 * XREFs of HalpCreateSecondaryIcEntry @ 0x1404CB5C0
 * Callers:
 *     HalpRegisterSecondaryIcInterface @ 0x1404CC014 (HalpRegisterSecondaryIcInterface.c)
 * Callees:
...
__int64 __fastcall HalpCreateSecondaryIcEntry(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *(_DWORD *)(v5 + 124) = 1;
    ...
    v7 = (__int64 *)qword_140C49B68;
    if ( *(__int64 **)qword_140C49B68 != &SecondaryIcList )
      __fastfail(3u);
