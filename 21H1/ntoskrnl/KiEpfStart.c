/*
 * XREFs of KiEpfStart @ 0x14051E754
 * Callers:
...
LABEL_6:
  ...
  if ( v5 )
  {
    _InterlockedIncrement(&dword_140C2B030);
    v6 = _InterlockedIncrement(&dword_140C2B034);
    do
      v9 = dword_140C2B038;
    while ( dword_140C2B038 < v6 && v9 != _InterlockedCompareExchange(&dword_140C2B038, v6, dword_140C2B038) );
    v10 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v14, 39);
    KeSetKernelStackSwapEnable(v10);
    _InterlockedDecrement(&dword_140C2B034);
  }
}
