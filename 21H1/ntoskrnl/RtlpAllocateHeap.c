/*
 * XREFs of RtlpAllocateHeap @ 0x140583090
 * Callers:
 ...
 *     RtlpHeapRemoveListEntry @ 0x14058E4AC (RtlpHeapRemoveListEntry.c)
 *     RtlGetNtGlobalFlags @ 0x140910A10 (RtlGetNtGlobalFlags.c)
 */
