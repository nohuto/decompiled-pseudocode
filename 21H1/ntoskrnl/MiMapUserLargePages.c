/*
 * XREFs of MiMapUserLargePages @ 0x140558C40
 * Callers:
...
LABEL_8:
  ...
  v18 = v4;
  v34 = (_DWORD *)v4;
  v32 = *(_DWORD *)(v10 + 4 * ((v11 >> 7) & 0x1F) + 94768);
  ...
  do
  {
    ...
    {
      v21 = *(_QWORD *)(v10 + 8LL * v19 + 107904) << 12;
...
LABEL_48:
    MiInitializeLargeUserBasePfn((__int64)v37, BugCheckParameter1, (unsigned __int64)Process, (_DWORD *)v18);
    MiInsertLargeUserMapping(a1, BugCheckParameter1, (__int64)(v37 + 0xB000000000LL) / 48, v19, v32);
    v34 += 1024 * v38;
    BugCheckParameter1 += 8 * v38;
