/*
 * XREFs of KiEmulateAtlThunk @ 0x140520ED0
 * Callers:
 *     KiCheckForAtlThunk @ 0x14051EA44 (KiCheckForAtlThunk.c)
 * Callees:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$1CC13EA220102F7150542D4DBFF67C6A::$4027F68EF0E7CC3497C55FD2100A3F4B::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
