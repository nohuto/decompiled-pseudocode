/*
 * XREFs of HalpAllocateDmaResourcesInternal @ 0x1404C51FC
 * Callers:
 *     HalpDmaReturnEmergencyLogicalAddressResources @ 0x1404B2DA8 (HalpDmaReturnEmergencyLogicalAddressResources.c)
 *     HalpDmaProcessMapRegisterQueueV3 @ 0x1404C0FF8 (HalpDmaProcessMapRegisterQueueV3.c)
 ...
 *     HalpAllocateDmaResources @ 0x1404C51E0 (HalpAllocateDmaResources.c)
 * Callees:
