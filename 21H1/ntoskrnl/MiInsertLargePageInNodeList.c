/*
 * XREFs of MiInsertLargePageInNodeList @ 0x140345EC0
 * Callers:
 ...
 *     MiUpdateLargePageCandidates @ 0x140346470 (MiUpdateLargePageCandidates.c)
 ...
 *     MiAnyPagesRemovalPending @ 0x140550F10 (MiAnyPagesRemovalPending.c)
...
unsigned __int64 __fastcall MiInsertLargePageInNodeList(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v10 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v9 + 40) >> 39) & 0x3FFLL));
  v33 = v10;
  ...
  *(_QWORD *)(v9 + 40) = v12 & 0x7FFFFFFFFFFFFFFFLL;
  ...
  if ( v6 != 1 && (MiFlags & 0x80u) != 0 && (++dword_140C4E70C & MmPageValidationFrequency) == 0 )
    MiArePageContentsZero(v7);
  v13 = *((unsigned int *)MiSearchNumaNodeTable(v7) + 2);
  v14 = MiPageToChannel(v7);
  v15 = v6;
  v16 = (unsigned int)dword_140C4DEC0[PfnPageSizeIndex];
