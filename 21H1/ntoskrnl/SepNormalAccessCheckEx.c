/*
 * XREFs of SepNormalAccessCheckEx @ 0x140370DFC
 * Callers:
        ...
        _DWORD *a14)
{
  ...
  unsigned int v61; // [rsp+B8h] [rbp+10h] BYREF
...
LABEL_42:
              ...
              {
                v35 = v23 + 2;
                SepMatchCapability(a2, v63, (void *)(v26 + 8), *(_DWORD *)(v26 + 4), (_BYTE *)v23 + 22, v23 + 2);
                goto LABEL_41;
              }
              v19 = a8;
            }
...
LABEL_21:
            v32 = a2;
LABEL_22:
            if ( (unsigned __int8)SepSidInToken(v32, 0LL, v31, 0LL, v24) )
              AuthzBasepAddAccessTypeList(v21, v19, 0, v25, *(_DWORD *)(v26 + 4), 0);
            goto LABEL_24;
          }
          if ( *(_BYTE *)v26 != 9 )
            goto LABEL_24;
        ...
        switch ( v29 )
        {
          case 5:
            ...
            {
              if ( a10
                && (unsigned __int8)SepSidInToken(a2, 0LL, v26 + ((8LL * (v37 & 2)) | 0xC) + 16 * v38, 0LL, a11)
                && (unsigned __int8)AuthzBasepObjectInTypeList(v39, v21, v19, &v61) )
              {
                AuthzBasepAddAccessTypeList(v21, v19, v61, v25, *(_DWORD *)(v26 + 4), 0);
              }
              goto LABEL_42;
            }
            v24 = a11;
            ...
            goto LABEL_21;
          case 4:
            if ( !(unsigned __int8)SepSidInToken(a2, 0LL, v26 + 4 * (*(unsigned __int8 *)(v26 + 13) + 5LL), 0LL, v24) )
              break;
            v32 = v62;
            v31 = v26 + 12;
            goto LABEL_22;
...
LABEL_60:
            LOBYTE(a4) = 1;
            if ( (unsigned __int8)SepSidInToken(a2, 0LL, v26 + 8, a4, v24)
              && (*(_DWORD *)(v21 + 24) & *(_DWORD *)(v26 + 4)) != 0 )
            {
              result = AuthzBasepSetAccessReasons(
                         *(_DWORD *)(v21 + 24) & *(_DWORD *)(v26 + 4),
                         0x20000,
                         v25,
                         *(_QWORD *)(v21 + 40),
                         0);
          ...
          case 6:
            ...
            if ( v40 && a10 )
            {
              if ( !(unsigned __int8)AuthzBasepObjectInTypeList(v40, v21, v19, &v61) )
                break;
              result = *(unsigned int *)(v21 + 48LL * v61 + 24);
              v41 = ((unsigned int)result & *(_DWORD *)(v26 + 4)) == 0;
            }
            else
            {
              result = *(unsigned int *)(v26 + 4);
              v41 = ((unsigned int)result & *(_DWORD *)(v21 + 24)) == 0;
            }
            if ( !v41 )
              goto LABEL_27;
            break;
  ...
  if ( v27 )
  {
    ...
    if ( *(_DWORD *)(v21 + 24) )
    {
      if ( v19 )
      {
        ...
        do
        {
          result = AuthzBasepSetAccessReasons(*(_DWORD *)v33, 0x800000, 0, *(_QWORD *)(v33 + 16), 0);
          v33 += 48LL;
          --v34;
        }
        while ( v34 );
