/*
 * XREFs of MiComputePxeWalkAction @ 0x14020BF20
 * Callers:
    ...
    if ( (v8 & 1) == 0 )
    {
      ...
      if ( a3 == 1 )
      {
        ...
        if ( (*(_BYTE *)(v13 + 184) & 7) == 2
          && (unsigned __int16)*(_DWORD *)(MiGetSystemCacheReverseMap(
                                             (__int64)(a2 << 25) >> 16 << 25 >> 16,
                                             0xFFFFFFFFFLL,
                                             MiState)
                                         + 32) >> 6 != (unsigned __int64)*(unsigned __int16 *)(v13 + 174) )
        {
          return 1LL;
        }
      }
