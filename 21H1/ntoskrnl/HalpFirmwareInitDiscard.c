/*
 * XREFs of HalpFirmwareInitDiscard @ 0x140A6B074
 * Callers:
 *     HalpFirmwareInitSystem @ 0x14099C5C0 (HalpFirmwareInitSystem.c)
 * Callees:
...
__int64 __fastcall HalpFirmwareInitDiscard(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 264) & 1) != 0 )
  {
    ...
    xmmword_140C49EF0 = *(_OWORD *)(a1 + 280);
    xmmword_140C49F00 = *(_OWORD *)(a1 + 296);
    xmmword_140C49F10 = *(_OWORD *)(a1 + 312);
    HalpEfiTimeCalls = 0;
    HalpEfiTimeWrites = 0;
