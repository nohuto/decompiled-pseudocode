/*
 * XREFs of IopInitializeBootLogging @ 0x14088D370
 * Callers:
  ...
  if ( !qword_140D2C038 )
  {
    ...
    if ( Pool )
    {
      ...
      if ( RtlFindMessage(*(PVOID *)(v6 + 48), 0xBu, 0, 0xB5u, &MessageEntry) >= 0 )
      {
        ...
        if ( qword_140D2C038->Length > 4u )
        {
          v9 = (unsigned __int16)(qword_140D2C038->Length - 4);
          Buffer = qword_140D2C038->Buffer;
          qword_140D2C038->Length = v9;
          Buffer[v9 >> 1] = 0;
        }
      }
      ...
      else
      {
        ...
        v11 = qword_140D2C038;
        Length = qword_140D2C038[1].Length;
        if ( Length > 4u )
        {
          v13 = Length - 4;
          qword_140D2C038[1].Length = v13;
