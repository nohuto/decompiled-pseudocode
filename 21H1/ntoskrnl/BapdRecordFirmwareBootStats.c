/*
 * XREFs of BapdRecordFirmwareBootStats @ 0x1409948D0
 * Callers:
...
void BapdRecordFirmwareBootStats()
{
  ...
  Data = 0LL;
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((ULONGLONG *)&dword_140C02DF0, 0LL, 0LL);
  if ( !ExIsSoftBoot() )
  {
      ...
      *(_QWORD *)&UserData.Size = 8LL;
      ...
      if ( (unsigned int)dword_140C02DF0 > 4 && tlgKeywordOn((__int64)&dword_140C02DF0, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)word_14002C782,
          0LL,
          0LL,
          7u,
          &v24);
