/*
 * XREFs of ViKeWaitForSingleObjectCommon @ 0x1409D94E8
 * Callers:
 *     VerifierKeWaitForSingleObject @ 0x1409D89A0 (VerifierKeWaitForSingleObject.c)
 *     VerifierKeWaitForSingleObjectNoReboot @ 0x1409D8A10 (VerifierKeWaitForSingleObjectNoReboot.c)
 * Callees:
