/*
 * XREFs of MiClearPartitionPageBitMap @ 0x14055B964
 * Callers:
...
__int64 __fastcall MiClearPartitionPageBitMap(unsigned __int64 a1, _QWORD **a2)
{
  ...
  while ( v8 )
  {
    ...
    MiActOnPartitionNodePages(v11, 7u, (__int16 **)&v30);
  }
  ...
  __writecr8(v9);
  MiFreePartitionTree(a1, &v32, 0LL, 1LL);
...
LABEL_39:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v18, v5, &v35);
  ...
  return KiLeaveGuardedRegionUnsafe((__int64)CurrentThread, v25, v27, (__int64)v28);
}
