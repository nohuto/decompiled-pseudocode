/*
 * XREFs of ?SmPageWrite@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAT_SM_PAGE_KEY@@T_SM_PAGE_ADD_PARAM@@PEAU_MDL@@PEAXPEAU_IO_STATUS_BLOCK@@K@Z @ 0x14023AF48
 * Callers:
 ...
 *     ?StDmGetSpaceStats@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAK1@Z @ 0x140308224 (-StDmGetSpaceStats@-$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAK1@Z.c)
        ...
        int a7)
{
  ...
  *v7 = a5;
  ...
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, v24, v25);
  if ( !PoolWithTag )
  {
    v22 = -1073741670;
    goto LABEL_23;
...
LABEL_10:
  ...
  *((_DWORD *)PoolWithTag + 6) = *a2;
  v17 = *((_DWORD *)PoolWithTag + 2) & 0xFFFFFFF8;
  *((_QWORD *)PoolWithTag + 2) = a4;
  v18 = v15 | v17;
  *((_DWORD *)PoolWithTag + 2) = v18;
  if ( (a3 & 0x10000) != 0 )
  {
    v18 |= 0x40000000u;
    *((_DWORD *)PoolWithTag + 2) = v18;
  ...
  if ( (a3 & 0x20000) != 0 )
    *((_DWORD *)PoolWithTag + 2) = v18 | 0x40000000;
  *((_QWORD *)PoolWithTag + 4) = v7;
  ...
  if ( (*(_DWORD *)(a1 + 1840) & 2) != 0 )
  {
    ...
    {
      v20 = MmMapLockedPagesSpecifyCache((PMDL)a4, 0, MmCached, 0LL, 0, 0x40000020u);
      v16 = (int)a2;
      v9 = v20;
    }
    if ( !v9 )
  ...
  if ( (*(_DWORD *)(a1 + 1840) & 0x20) == 0 || (*v14 & 0x400) != 0 )
  {
    v22 = SMKM_STORE_MGR<SM_TRAITS>::SmFeAddInitiate(a1, v16, v32, v19, (__int64)PoolWithTag, (__int64)v7, 0);
    if ( v22 < 0 )
      goto LABEL_23;
    goto LABEL_22;
  }
  v21 = a7 != 0;
  a7 = -a7;
  v22 = SMKM_STORE_MGR<SM_TRAITS>::SmFeAddInitiate(a1, v16, v32, v19, 0LL, 0LL, (unsigned int)v21 + 2);
  if ( v22 >= 0 )
  {
...
LABEL_23:
  if ( v14 )
  {
    v29 = (struct _EX_RUNDOWN_REF *)SmKmStoreRefFromStoreIndex(a1, v14[1504] & 0x3FF);
