/*
 * XREFs of PfSnOpenVolumesForPrefetch @ 0x140670968
 * Callers:
...
__int64 __fastcall PfSnOpenVolumesForPrefetch(__int64 *a1, _DWORD *a2)
{
  ...
  if ( v2 && (v6 = *(_DWORD *)(v2 + 112), v6 < 0x4000) )
  {
    ...
    v55 = 0LL;
    v58 = 0LL;
    Event = NtCreateEvent((unsigned __int64)&Handle, 2031619LL, (int)v53, NotificationEvent, 0);
    if ( Event < 0 )
      goto LABEL_40;
    ...
    while ( !v12 )
    {
      ...
      IsVolumeMounted = PfSnIsVolumeMounted(v14, &j, (int *)&v62);
      v17 = j;
