/*
 * XREFs of MiLargePageFreeToZero @ 0x1403493F0
 * Callers:
...
void __fastcall MiLargePageFreeToZero(ULONG_PTR BugCheckParameter2, unsigned int a2, int a3, char a4)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v36 = *(_QWORD *)(qword_140C4E588 + 8 * ((*(_QWORD *)(v7 + 40) >> 39) & 0x3FFLL));
  ...
  *(_QWORD *)(v7 + 16) = MiSwizzleInvalidPte(128LL);
  if ( !a4 )
  {
    ...
    *(_QWORD *)(v19 + 8) = v20;
    ...
    v35 = 24 * (BugCheckParameter2 / *v34 % (unsigned int)dword_140C4DEC0[v22]);
    ...
    if ( dword_140C4E60C == 1 )
    {
      ...
      v27 = v9;
      v28 = (volatile signed __int32 *)(qword_140C4E668 + 4 * (BugCheckParameter2 >> 5));
      if ( v26 + v9 <= 0x20 )
      {
        if ( v9 == 32 )
        {
...
LABEL_39:
  ...
  if ( dword_140C4E60C == 1 )
  {
    ...
    v16 = (volatile signed __int32 *)(qword_140C4E668 + 4 * (BugCheckParameter2 >> 5));
    if ( v15 + v9 > 0x20 )
    {
      if ( (BugCheckParameter2 & 0x1F) != 0 )
      {
