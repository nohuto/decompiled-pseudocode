/*
 * XREFs of ExpGetSystemEmulationBasicInformation @ 0x14030CBF0
 * Callers:
...
__int64 __fastcall ExpGetSystemEmulationBasicInformation(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 12) = v10;
  v11 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140C4E588 + 8 * v3) + 6912LL) <= 0xFFFFFFFFuLL )
    v11 = *(_QWORD *)(*(_QWORD *)(qword_140C4E588 + 8 * v3) + 6912LL);
  *(_DWORD *)(a1 + 16) = v11;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140C4E588 + 8 * v3) + 6920LL) <= 0xFFFFFFFFuLL )
    v9 = *(_QWORD *)(*(_QWORD *)(qword_140C4E588 + 8 * v3) + 6920LL);
  *(_DWORD *)(a1 + 20) = v9;
  return 0LL;
}
