/*
 * XREFs of CcGetVirtualAddress @ 0x140288400
 * Callers:
...
__int64 __fastcall CcGetVirtualAddress(__int64 a1, __int64 a2, __int64 **a3, _DWORD *SchedulerAssist, int a5, int a6)
{
  __int64 v6; // r15
  __int64 v7; // r8
  ...
  if ( *(_QWORD *)(a1 + 168) )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140C4C8C0, 0x1Fu) )
      {
        ...
        v55 = ExpWaitForSpinLockExclusiveAndAcquire(
                (unsigned __int64)&dword_140C4C8C0,
                CurrentIrql,
                v7,
                SchedulerAssist);
        v7 = 0LL;
      }
      v16 = (unsigned int)dword_140C4C8C0;
      if ( (dword_140C4C8C0 & 0xBFFFFFFF) != 0x80000000 )
      {
        do
        {
          if ( (v16 & 0x40000000) == 0 )
          {
            v43 = _InterlockedCompareExchange(&dword_140C4C8C0, v16 | 0x40000000, v16);
            v42 = (_DWORD)v16 == v43;
            v16 = v43;
            if ( !v42 )
              continue;
    ...
    if ( *(_QWORD *)v12 )
      v17 = *(ULONG_PTR **)(qword_140C4E588 + 8LL * (*(_WORD *)(*(_QWORD *)v12 + 60LL) & 0x3FF));
    else
...
LABEL_17:
  ...
  if ( v23 > 0x2000000 )
  {
    ...
    do
    {
      ...
      v29 &= v33 - 1;
      --v30;
      VacbMiss = (__int64 *)VacbMiss[v29 >> v32];
    }
    while ( VacbMiss );
  }
  else
  {
    VacbMiss = *(__int64 **)(v24 + 8 * ((unsigned __int64)(unsigned int)a2 >> 18));
  }
  if ( VacbMiss )
  {
    v26 = VacbMiss[1];
    v27 = _InterlockedIncrement((volatile signed __int32 *)VacbMiss + 4);
    if ( !v27 )
...
LABEL_44:
  ExReleasePushLockEx(a1 + 104, 0LL);
  VacbMiss = CcGetVacbMiss((_QWORD *)a1, a2, v21, v49);
