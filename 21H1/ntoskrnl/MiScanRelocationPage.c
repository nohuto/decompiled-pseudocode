/*
 * XREFs of MiScanRelocationPage @ 0x140644AB0
 * Callers:
...
__int64 __fastcall MiScanRelocationPage(int a1, unsigned int a2, int a3, _WORD *a4, __int64 a5, __int64 a6)
{
  ...
  for ( i = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)a5 + 56LL) + 64LL); v13; ++a4 )
  {
    ...
    if ( v11 == 1 )
    {
      if ( v12 == 1 )
        return 3221225595LL;
      result = MiCreateFixupRecord(v6, v14, v18, v9, v10, (__int64)a4, a6);
      if ( (int)result < 0 )
        return result;
      if ( (MiFlags & 0x40000) != 0 && (*(_DWORD *)(v6 + 92) & 0xC0000) != 0 )
      {
        a5 = 0LL;
        if ( (*(_BYTE *)(MiOffsetToProtos(v6, v8 + v17 + (unsigned __int64)v10, (unsigned __int64 *)&a5) + 32) & 4) != 0 )
          return 3221225595LL;
      }
      v14 = a1;
      v11 = 0;
