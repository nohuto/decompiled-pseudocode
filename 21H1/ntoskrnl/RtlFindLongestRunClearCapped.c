/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x1405816B0
 * Callers:
...
LABEL_45:
    ...
    v16 = 8 * v14 - v15 + 8;
    for ( i = *((_BYTE *)&qword_14001A5B8 - v15) | byte_14001D830[v21] | v18; ; i |= v25 )
    {
