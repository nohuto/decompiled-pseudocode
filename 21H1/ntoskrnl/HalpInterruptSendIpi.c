/*
 * XREFs of HalpInterruptSendIpi @ 0x14026E120
 * Callers:
 ...
 *     HalRequestDeferredRecoveryServiceInterrupt @ 0x1404B8770 (HalRequestDeferredRecoveryServiceInterrupt.c)
 * Callees:
...
LABEL_7:
      ...
      if ( qword_140C4A408 )
      {
        return (unsigned int)qword_140C4A408(v5, a2);
      }
      else
      {
        ...
        if ( (unsigned __int16)HalpInterruptPhysicalTargets >= *(_WORD *)v5 )
          v11 = *(_WORD *)v5;
        v51 = v11;
        for ( i = 0; i < v51; *(_QWORD *)&v52[4 * v13 + 3] = qword_140C4B9A8[v13] & v5[v13 + 1] )
          v13 = i++;
        v52[0] = 20;
        *(_DWORD *)&v52[1] = 0;
        if ( i < 0x14u )
