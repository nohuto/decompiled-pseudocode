/*
 * XREFs of IoCaptureLiveDump @ 0x140891CF8
 * Callers:
 ...
 *     KeGetSupervisorStateExtensionHost @ 0x140514390 (KeGetSupervisorStateExtensionHost.c)
  ...
  *(_QWORD *)v12[51].Data4 = v10;
  ...
  if ( (unsigned int)dword_140C04458 > 5 && tlgKeywordOn((__int64)&dword_140C04458, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_1400237A3,
      v12 + 54,
      v12 + 53,
      3u,
      &v68);
...
LABEL_37:
      ...
      if ( inited >= 0 )
      {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_140C04458 > 5 && tlgKeywordOn((__int64)&dword_140C04458, 0x200000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C04458,
              (unsigned __int8 *)word_14002375A,
              v12 + 54,
              v12 + 53,
              4u,
              &v63);
  ...
  if ( (unsigned int)dword_140C04458 > 5 && tlgKeywordOn((__int64)&dword_140C04458, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04458, (unsigned __int8 *)&word_1400235BE, v36, v35, 6u, &v54);
  }
  if ( v12 )
  {
    if ( (*(_DWORD *)v12[2].Data4 & 8) == 0 )
