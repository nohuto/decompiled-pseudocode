/*
 * XREFs of PoFxInitPowerManagement @ 0x140A699D4
 * Callers:
...
__int64 PoFxInitPowerManagement()
{
  ...
  stru_140C24820.Header.Size = 6;
  *(_QWORD *)&PopFxResidentTimer.Header.Lock = 9LL;
  qword_140C24758 = (__int64)&PopFxDeviceList;
  PopFxDeviceList = (ULONG_PTR)&PopFxDeviceList;
  qword_140C24768 = (__int64)&PopFxAcpiDeviceList;
  PopFxAcpiDeviceList = (__int64)&PopFxAcpiDeviceList;
  qword_140C248B8 = (__int64)&PopWorkOrderList;
  PopWorkOrderList = (__int64)&PopWorkOrderList;
  qword_140C24890 = (__int64)PopFxResidentTimeoutRoutine;
  qword_140C24810 = (__int64)&qword_140C24808;
  qword_140C24808 = (__int64)&qword_140C24808;
  stru_140C24820.Header.WaitListHead.Blink = &stru_140C24820.Header.WaitListHead;
  stru_140C24820.Header.WaitListHead.Flink = &stru_140C24820.Header.WaitListHead;
  ...
  qword_140C247C8 = (__int64)&PopFxPluginList;
  ...
  LOWORD(stru_140C24820.Header.Lock) = 0;
  stru_140C24820.Header.SignalState = 1;
  ...
  memset(&byte_140C24A21, 0, 0x6FuLL);
  ...
  qword_140C247E8 = (__int64)&SocSubsystemsList;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_140C21638 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_140C21650 = (__int64)PopPepIdleTimeoutRoutine;
