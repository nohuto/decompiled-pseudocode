/*
 * XREFs of MiReduceMdl @ 0x1402BB31C
 * Callers:
...
__int64 __fastcall MiReduceMdl(__int64 a1)
{
  ...
  v10 = a1 + 8 * v9;
  if ( *(_QWORD *)(v10 + 40) == qword_140C4ECB8 )
  {
    v12 = *(_DWORD *)(a1 + 40);
    v13 = v12;
    *(_WORD *)(a1 + 8) -= 8;
  ...
  *(_WORD *)(a1 + 10) |= 0x4000u;
  if ( v9 )
  {
    while ( *(_QWORD *)v1 != qword_140C4ECB8 )
    {
      ++v2;
      v1 += 8;
      if ( v2 >= v9 )
