/*
 * XREFs of KiDisplayBlueScreen @ 0x140512600
 * Callers:
 ...
 *     KeGetBugMessageText @ 0x140512004 (KeGetBugMessageText.c)
 *     KiBugCheckConvertParameterValueToUnicodeString @ 0x1405121CC (KiBugCheckConvertParameterValueToUnicodeString.c)
