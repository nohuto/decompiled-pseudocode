/*
 * XREFs of EtwTraceSystemTimeChange @ 0x140994358
 * Callers:
...
char __fastcall EtwTraceSystemTimeChange(__int64 *a1, _QWORD *a2, int a3)
{
  ...
  {
    LOBYTE(ProcessId) = tlgKeywordOn((__int64)&dword_140C02BB0, 0x400000000000LL);
    if ( (_BYTE)ProcessId )
    {
      v15 = *a1;
      v12 = v9;
      ...
      LOBYTE(ProcessId) = tlgWriteTransfer_EtwWriteTransfer(
                            ...
                            (unsigned __int8 *)byte_14002BC89,
                            0LL,
                            0LL,
                            8u,
                            &v27);
