/*
 * XREFs of VhdiMountVhdFile @ 0x140A92A98
 * Callers:
...
LABEL_11:
  ...
  v12 = IopBuildDeviceIoControlRequest(2971948, (int)DeviceObject, v9, v7, v11, v10, 0, &Object_8, &IoStatusBlock);
  if ( !v12 )
    goto LABEL_14;
