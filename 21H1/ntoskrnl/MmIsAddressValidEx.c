/*
 * XREFs of MmIsAddressValidEx @ 0x1402B2510
 * Callers:
 ...
 *     IopGetMaxValidMemorySize @ 0x1404FE6AC (IopGetMaxValidMemorySize.c)
 *     IopGetMaxValidMemorySizeDown @ 0x1404FE724 (IopGetMaxValidMemorySizeDown.c)
 *     IopGetMaxValidSectionSize @ 0x1404FE798 (IopGetMaxValidSectionSize.c)
 *     IopGetMaxValidSectionSizeDown @ 0x1404FE7E0 (IopGetMaxValidSectionSizeDown.c)
 ...
 *     KiValidateComponentName @ 0x140513080 (KiValidateComponentName.c)
