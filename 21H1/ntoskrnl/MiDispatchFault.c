/*
 * XREFs of MiDispatchFault @ 0x14020E3D0
 * Callers:
 ...
 *     MiAdjustFaultList @ 0x14030BCC0 (MiAdjustFaultList.c)
...
LABEL_20:
          ...
          if ( v21 == 16 )
          {
            ...
            v35 = *(_QWORD *)(v17 + 360);
            v22 = KiDynamicTraceEnabled && v35 >= qword_140CFCBA8 && v35 < qword_140CFCBB0 && KeGetCurrentIrql() == 15;
          }
          else
          {
            if ( v21 != 51 )
