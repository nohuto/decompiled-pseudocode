/*
 * XREFs of KiInitiateUserApc @ 0x1403FA370
 * Callers:
...
void __fastcall KiInitiateUserApc(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  __int64 v4; // rbp
  __int64 v5; // [rsp+0h] [rbp-138h] BYREF

  KiDeliverApc(1, (__int64)&v5, (_KTRAP_FRAME *)(v4 - 128), a4);
}
