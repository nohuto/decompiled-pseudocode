/*
 * XREFs of MiSetProbePagesAhead @ 0x1403474A0
 * Callers:
...
char __fastcall MiSetProbePagesAhead(__int64 a1)
{
  ...
  if ( (_BYTE)v2 == 1 )
  {
    ...
    if ( v3 != 3 )
    {
      v4 = *(_QWORD *)(a1 + 40);
      v20 = v4;
      v5 = 6 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v20) >> 12) & 0xFFFFFFFFFLL);
      LOBYTE(v2) = 40;
      if ( ((*(_QWORD *)(8 * v5 - 0x57FFFFFFFD8LL) >> 50) & 1) != 0 )
      {
        ...
        while ( 1 )
        {
          ...
          LOBYTE(v2) = v20;
          if ( (v20 & 0xF0FF000000000FFFuLL) != v8 )
            break;
          v9 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v20) >> 12) & 0xFFFFFFFFFLL);
          LOBYTE(v2) = 40;
          if ( ((*(_QWORD *)(v9 - 0x57FFFFFFFD8LL) >> 50) & 1) == 0 )
            break;
          v10 = (_QWORD *)qword_140C4EDC0;
          v11 = v9 - 0x58000000000LL;
          if ( qword_140C4EDC0 && ((*(_QWORD *)(v11 + 40) >> 60) & 7) == 1 )
          {
          ...
          {
            v17 = *(_QWORD *)(v11 + 40);
            if ( ((v17 >> 60) & 7) != 1 && (v17 & 0x1000000000LL) == 0 )
            {
              v2 = *(_QWORD *)(v11 + 8);
              if ( v2 > 0 )
                break;
            }
            LODWORD(v2) = MI_PFN_IS_PROTO(v11, v15, v16);
            if ( (_DWORD)v2 )
            {
