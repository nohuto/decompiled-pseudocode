/*
 * XREFs of ViCreateProcessCallbackInternal @ 0x1409D9A34
 * Callers:
 *     ViCreateProcessCallback @ 0x14031C7A0 (ViCreateProcessCallback.c)
 * Callees:
 ...
 *     ViFaultsGetBaseImageName @ 0x1409D9F08 (ViFaultsGetBaseImageName.c)
