/*
 * XREFs of MiLockCode @ 0x14028AAA0
 * Callers:
...
__int64 __fastcall MiLockCode(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, char a4)
{
  ...
  else
  {
    ...
    {
      AnyMultiplexedVm = &unk_140C4F080;
...
LABEL_16:
    ...
    {
      v23 = v19;
      if ( (unsigned int)MiPteHasShadow(&v70, Flink) && ((v19 & 0x20) == 0 || (v19 & 0x42) == 0) )
      {
    ...
    if ( (v28 & v16) == 0 && *(__int64 *)(v27 + 8) > 0 )
    {
      ...
      else
      {
        MiUnlockPageTableInternal(AnyMultiplexedVm, v12);
        v14 = v61;
        MiUnlockWorkingSetShared((__int64)AnyMultiplexedVm, v61);
...
LABEL_132:
    ...
    if ( (unsigned int)MI_PFN_IS_PROTO(v15 + 48 * v26, v28, v15) && (!v71 || v65) )
    {
      v33 = a4;
      if ( (a4 & 1) != 0 )
      {
...
LABEL_50:
    ...
    v35 = 0LL;
    v36 = *(_QWORD *)(qword_140C4E588 + 8 * ((v30 >> 39) & 0x3FF));
    v74 = v36;
    v37 = ((v21 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    v38 = *(_QWORD *)v37;
    if ( v37 >= 0xFFFFF6FB7DBED000uLL
      && v37 <= v32
      && (unsigned int)MiPteHasShadow(Process, v38)
      && (v38 & 1) != 0
    ...
    if ( DriverPage != -1 )
    {
      ...
      if ( v36 == *(_QWORD *)(qword_140C4E588 + 8 * v42) )
        goto LABEL_71;
...
LABEL_71:
      ...
      if ( _interlockedbittestandset64((volatile signed __int32 *)(v27 + 24), 0x3FuLL) )
      {
        ...
        {
          do
            KeYieldProcessorEx(&v68, v42, v37, v36);
      ...
      if ( DriverPage != -1 && (v33 & 2) != 0 )
      {
        ...
        if ( (WsleContents & 0xF) != 9
          ...
          && (v26 & 0x1FF) < ((unsigned __int16)v45 & 0x1FFu) )
        {
          v46 = 48 * v45 - 0x58000000000LL;
          _InterlockedAnd64((volatile signed __int64 *)(v27 + 24), 0x7FFFFFFFFFFFFFFFuLL);
          if ( (unsigned int)MI_PFN_IS_PROTO(v27, v44, *(_QWORD *)(v27 + 8) | 0x8000000000000000uLL)
            && (*(_DWORD *)(v27 + 16) & 0x400LL) != 0 )
          {
            v49 = MiLockProtoPoolPage(v47, 0LL);
            if ( v49 )
              goto LABEL_90;
          }
          else
          {
            v49 = 1LL;
LABEL_90:
            if ( (unsigned int)MiTradeActivePage(v27, v46, v21, 0, 2, v59) == 1 )
            {
          ...
          {
            do
              KeYieldProcessorEx(&v69, v48, v50, v51);
            while ( *(__int64 *)(v27 + 24) < 0 );
          }
          AnyMultiplexedVm = SessionVm;
        }
...
LABEL_107:
      ...
      if ( v5 >= 0xFFFFF6FB7DBED000uLL
        && v5 <= 0xFFFFF6FB7DBED7F8uLL
        && (unsigned int)MiPteHasShadow(v53, Flink)
        && (Flink & 1) != 0
      ...
      if ( (Flink & 0x800) != 0 && (Flink & 0x42) == 0 )
      {
        ...
        MiInsertTbFlushEntry((__int64)&v77, v21, 1LL, 0);
      }
      _InterlockedAnd64((volatile signed __int64 *)(v27 + 24), 0x7FFFFFFFFFFFFFFFuLL);
      if ( v35 )
  ...
  if ( v52 != -1 )
    MiReleaseFreshPage(48 * v52 - 0x58000000000LL);
  if ( !v8 )
  {
