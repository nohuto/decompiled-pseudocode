/*
 * XREFs of RtlFindClearRunsEx @ 0x140398178
 * Callers:
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        ...
        v5 = v13 - v9 + 8;
        v17 = *((_BYTE *)&qword_14001A5B8 - v9) | byte_14001D830[v15] | v14;
        if ( v17 != 0xFF )
        {
          do
          {
            ...
            v29 = 0;
            for ( j = byte_14001D830[v28]; ((unsigned __int8)j & v17) != 0; j *= 2 )
              ++v29;
            v31 = v8 + 1;
