/*
 * XREFs of RtlpHpSegMgrCommitComplete @ 0x1403188F8
 * Callers:
        ...
        unsigned __int8 a6)
{
  ...
  int v28[14]; // [rsp+30h] [rbp-38h] BYREF
...
LABEL_38:
          ...
          KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, SpinLock, v28);
          ...
          LOWORD(v6) = KiLeaveGuardedRegionUnsafe((__int64)KeGetCurrentThread(), v21, v23, v24);
        }
      }
      return v6;
    }
