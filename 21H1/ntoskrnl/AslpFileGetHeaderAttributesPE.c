/*
 * XREFs of AslpFileGetHeaderAttributesPE @ 0x140966A28
 * Callers:
...
__int64 __fastcall AslpFileGetHeaderAttributesPE(__int64 a1, __int64 a2)
{
  ...
  int v15; // esi
  int v16; // r14d
  _WORD v18[2]; // [rsp+40h] [rbp-20h] BYREF
  unsigned int v19; // [rsp+44h] [rbp-1Ch] BYREF
  unsigned int v20; // [rsp+48h] [rbp-18h] BYREF
  unsigned int v21; // [rsp+4Ch] [rbp-14h] BYREF
  unsigned int v22; // [rsp+50h] [rbp-10h] BYREF
  unsigned __int16 v23; // [rsp+A0h] [rbp+40h] BYREF
  unsigned __int16 v24; // [rsp+A8h] [rbp+48h] BYREF
