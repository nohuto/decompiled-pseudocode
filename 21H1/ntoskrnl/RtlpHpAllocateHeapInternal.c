/*
 * XREFs of RtlpHpAllocateHeapInternal @ 0x14035FCB8
 * Callers:
...
__int64 __fastcall RtlpHpAllocateHeapInternal(__int64 a1, size_t a2, unsigned __int64 a3, __int64 a4, int *a5)
{
  ...
  if ( a3 > (unsigned int)*(unsigned __int16 *)(a1 + 892) - 16
    || (v10 = RtlpHpLfhContextAllocate(a1 + 832, a2, a3, a4), LODWORD(a3) = v6, LODWORD(a2) = v7, v10 == -1) )
  {
    if ( v6 > 0x20000 )
    {
    ...
    {
      v12 = (__int64)RtlpHpVsContextAllocate(a1 + 640, a2, a3, v5);
    }
    v10 = v12;
  }
  else
