/*
 * XREFs of sub_14095EE20 @ 0x14095EE20
 * Callers:
...
__int64 __fastcall sub_14095EE20(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbp
  unsigned int v7; // r8d
  unsigned int *v8; // rax
...
LABEL_19:
  if ( (v7 & 0x80000000) == 0 )
  {
    ...
    if ( v15 >= 0 && v15 != 192 )
    {
      ...
      do
      {
        v17 = KeWaitForSingleObject(&Mutex, UserRequest, 1, 1u, &Interval);
        v16 = v17;
      }
      while ( v17 == 257 );
