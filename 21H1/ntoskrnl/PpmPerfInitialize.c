/*
 * XREFs of PpmPerfInitialize @ 0x140A690CC
 * Callers:
...
__int64 PpmPerfInitialize()
{
  ...
  stru_140C245B0.WorkerRoutine = (void (__fastcall *)(void *))PpmMediaBufferingWorker;
  dword_140C1EEA0 = 2;
  ...
  stru_140C245B0.Parameter = 0LL;
  stru_140C245B0.List.Flink = 0LL;
