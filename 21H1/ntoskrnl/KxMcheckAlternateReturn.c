/*
 * XREFs of KxMcheckAlternateReturn @ 0x140404F80
 * Callers:
...
__int64 __fastcall KxMcheckAlternateReturn(__int64 a1, unsigned __int64 Object, __int64 a3, __int64 a4, char a5)
{
  ...
  if ( (v59 & 1) != 0 )
  {
    ...
    else
    {
      if ( (Object & 2) != 0 && (KeGetPcr()->Prcb.BpbFeatures & 4) == 0 )
      {
        ...
        v54 = 0x1404051A6LL;
        v53 = 0x14040519DLL;
        *((_QWORD *)&v52 + 1) = 0x140405194LL;
        *(_QWORD *)&v52 = 0x14040518BLL;
        *((_QWORD *)&v51 + 1) = 0x140405182LL;
        *(_QWORD *)&v51 = 0x140405179LL;
        *((_QWORD *)&v50 + 1) = 0x140405170LL;
        *(_QWORD *)&v50 = 0x140405167LL;
        *((_QWORD *)&v49 + 1) = 0x14040515ELL;
        *(_QWORD *)&v49 = 0x140405155LL;
        *((_QWORD *)&v48 + 1) = 0x14040514CLL;
        *(_QWORD *)&v48 = 0x140405143LL;
        *((_QWORD *)&v47 + 1) = 0x14040513ALL;
        *(_QWORD *)&v47 = 0x140405131LL;
        v46 = 0x140405128LL;
        v45 = 0x14040511FLL;
        v44 = 0x140405116LL;
        v43 = 0x14040510DLL;
  ...
  while ( (KeGetCurrentThread()->ApcState.UserApcPendingAll & 3) != 0 )
  {
    __writecr8(1uLL);
    _enable();
    KiInitiateUserApc(1LL, v20, v21, v22);
    _disable();
    __writecr8(0LL);
  }
  ...
  if ( (v23->Header.LockNV & 0x8000000) != 0 )
    KiRestoreSetContextState((__int64)v23, v20, v21, (__int64)v22, v31[0]);
