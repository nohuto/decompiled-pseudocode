/*
 * XREFs of KiInsertTimerTable @ 0x140266C80
 * Callers:
    ...
    *(_QWORD *)(v17 + 24) = v11;
    ...
    if ( v5 >= 4 )
    {
      ...
      _interlockedbittestandset64(
        (volatile signed __int32 *)(qword_140CFD748[2 * *(unsigned __int8 *)(v44 - 14448)] + v25),
        v24);
    }
    if ( v11 <= MEMORY[0xFFFFF78000000008] )
    {
      ...
      LOBYTE(v5) = 1;
      KiRemoveEntryTimer(v23, a2, (unsigned int)v6, &v43);
    }
  }
  v26 = 0;
LABEL_19:
