/*
 * XREFs of KeTryToFreezeThreadStack @ 0x14050D8C8
 * Callers:
 ...
 *     KiIsKernelStackSwappable @ 0x14051CFC8 (KiIsKernelStackSwappable.c)
 */
...
char __fastcall KeTryToFreezeThreadStack(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  v11 = KiAcquireThreadStateLock(a1, (__int64)&v15, (volatile signed __int32 **)&v16);
  if ( v11 <= 4u )
  {
LABEL_18:
