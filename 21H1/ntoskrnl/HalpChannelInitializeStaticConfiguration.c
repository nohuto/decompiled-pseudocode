/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140A5C820
 * Callers:
 ...
 *     HalpValidateMpns @ 0x140862370 (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140A8B978 (HalpSelectFeasibleLowPowerState.c)
 */
