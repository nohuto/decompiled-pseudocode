/*
 * XREFs of PopWriteImageHeader @ 0x1409AE050
 * Callers:
...
__int64 (*__fastcall PopWriteImageHeader(__int64 a1, __int64 a2, unsigned int a3, __int64 a4))(void)
{
  ...
  v8 = __rdtsc();
  qword_140C23970 = (((unsigned __int64)HIDWORD(v8) << 32) | (unsigned int)v8) - a4;
  dword_140C23B34 = ((unsigned int)dword_140C23600 >> 4) - 1;
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  v10 = 0;
  for ( qword_140C239A0 = PerformanceCounter.QuadPart;
        v10 < *(_DWORD *)(a1 + 256);
        qword_140C23980 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 80) )
  {
    v11 = v10++;
    v11 <<= 7;
    qword_140C23B00 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 56);
    qword_140C23978 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 40);
  }
  qword_140C23B10 = qword_140C23B28;
  qword_140C23B20 = (unsigned int)dword_140C23B30;
  qword_140C23B28 += qword_140C23B08;
  v12 = qword_140C23AF8;
  dword_140C23B30 += qword_140C23B18;
  *(_QWORD *)(a2 + 88) = qword_140C23AF8;
  if ( byte_140C23621 )
    *(_QWORD *)(a2 + 88) = qword_140C23B00 + v12;
  v13 = 3LL;
  v14 = a2 + 136;
  v15 = &qword_140C23958;
  do
