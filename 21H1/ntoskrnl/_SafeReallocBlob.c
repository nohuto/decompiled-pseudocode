/*
 * XREFs of _SafeReallocBlob @ 0x1405C4E6C
 * Callers:
 *     RtlpMuiRegResizeLanguageConfigList @ 0x14097D118 (RtlpMuiRegResizeLanguageConfigList.c)
 *     RtlpMuiRegResizeLanguages @ 0x14097D184 (RtlpMuiRegResizeLanguages.c)
 * Callees:
