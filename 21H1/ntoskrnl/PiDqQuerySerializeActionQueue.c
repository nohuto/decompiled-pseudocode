/*
 * XREFs of PiDqQuerySerializeActionQueue @ 0x1406A13AC
 * Callers:
 ...
 *     PiDqQueryGetObjectManager @ 0x1406A0518 (PiDqQueryGetObjectManager.c)
      ...
      if ( v7 >= 0 )
      {
        ...
        *(_QWORD *)(a1 + 184) = 0LL;
        ...
        do
        {
          if ( v40 )
          {
            NdrMesTypeEncode3(v34[0], "TP 3\a", &off_140001790, &off_140C01A50, 1, &v40);
            if ( BYTE5(v39) )
            {
              v7 = -1073741819;
              goto LABEL_30;
