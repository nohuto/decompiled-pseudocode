/*
 * XREFs of ExpReleaseResourceExclusiveForThreadLite @ 0x140263230
 * Callers:
...
LABEL_48:
              ...
              if ( v69 == v65 )
              {
                v36 = KiRemoveBoostThread(v66, *(_QWORD *)(v66 + 8));
                if ( v13 )
                {
                  v19 = 2;
                  if ( v36 > (char)v13 )
                ...
                if ( ((2 * (v70 != 0) + 1) & 2) != 0 && v19 == 1 )
                  v13 = 1;
                LOBYTE(v18) = KiExitDispatcher(v66, 0LL, v19, v13, v74);
LABEL_28:
                v20 = v67;
                v21 = 65570;
                v7 = 0;
...
LABEL_76:
            ...
            *(_QWORD *)v32 = 0LL;
            ...
            CurrentThread = (__int64)v71->CurrentThread;
            v72 = CurrentThread;
            ...
            KiAcquireKobjectLockSafe((volatile signed __int32 *)v63, v32, v33, CurrentThread);
            v58 = (_QWORD *)(v63 + 8);
            v59 = v63;
            if ( (_QWORD *)*v58 != v58
              && *(_DWORD *)(v63 + 40) < *(_DWORD *)(v63 + 44)
              && (*(_QWORD *)(v72 + 232) != v63 || *(_BYTE *)(v72 + 643) != 15) )
            {
              v60 = KiWakeQueueWaiter((__int64)v71, v63, (__int64)v68);
              v59 = v63;
              if ( v60 )
                goto LABEL_121;
              v58 = (_QWORD *)(v63 + 8);
            ...
            *(_QWORD *)a3 = v68;
            *(_QWORD *)(v59 + 32) = v68;
            if ( !(_DWORD)v61 && (_QWORD *)*v58 != v58 )
            {
              KiWakeOtherQueueWaiters((__int64)v71, v59, a3, v61);
              v59 = v63;
            }
LABEL_121:
          ...
          v14 = KxWaitForLockChainValid(v3, v12);
        }
        *v3 = 0LL;
  ...
  else
  {
    ...
    if ( !*(_QWORD *)a3 )
    {
      if ( a3 == _InterlockedCompareExchange64(*(volatile signed __int64 **)(a3 + 8), 0LL, a3) )
        goto LABEL_35;
      v22 = KxWaitForLockChainValid(a3, BugCheckParameter2);
    }
    *v3 = 0LL;
