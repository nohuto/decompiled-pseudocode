/*
 * XREFs of PopCompleteNotifyTransitionCommon @ 0x140384F48
 * Callers:
 ...
 *     PopPrepChildWake @ 0x140385284 (PopPrepChildWake.c)
 *     PopReadyParentSleep @ 0x1403852F0 (PopReadyParentSleep.c)
 *     PopReadyChildWake @ 0x140385370 (PopReadyChildWake.c)
...
LONG __fastcall PopCompleteNotifyTransitionCommon(__int64 a1, __int64 *a2, int a3, __int64 a4)
{
  ...
  v9 = 0;
  v10 = 0;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)qword_140C233B0 + 1, &LockHandle);
  v13 = v5 + 48;
  v14 = (__int64 *)*a2;
