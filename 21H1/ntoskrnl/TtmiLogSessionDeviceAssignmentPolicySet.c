/*
 * XREFs of TtmiLogSessionDeviceAssignmentPolicySet @ 0x1408FF24C
 * Callers:
...
void __fastcall TtmiLogSessionDeviceAssignmentPolicySet(char a1)
{
  ...
  if ( (unsigned int)dword_140D2C8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2C8E8, 1LL) )
    {
      ...
      v9 = &v3;
      v10 = 1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2C8E8, (unsigned __int8 *)byte_14002A5D3, 0LL, 0LL, 4u, &v5);
    }
  }
}
