/*
 * XREFs of RtlScrubMemory @ 0x14058AA38
 * Callers:
 *     MiScrubPage @ 0x14055E804 (MiScrubPage.c)
 * Callees:
 *     RtlCompareMemoryUlong @ 0x1403FE660 (RtlCompareMemoryUlong.c)
 *     RtlpGenericInverseCouplingWorker @ 0x14058AD00 (RtlpGenericInverseCouplingWorker.c)
 *     RtlpGenericMATSPlusWorker @ 0x14058AFD8 (RtlpGenericMATSPlusWorker.c)
 *     RtlpGenericRandomPatternWorker @ 0x14058B0DC (RtlpGenericRandomPatternWorker.c)
 *     RtlpGenericStrideWorker @ 0x14058B3FC (RtlpGenericStrideWorker.c)
 */
