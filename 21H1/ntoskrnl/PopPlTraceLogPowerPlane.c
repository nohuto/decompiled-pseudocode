/*
 * XREFs of PopPlTraceLogPowerPlane @ 0x140579154
 * Callers:
...
int __fastcall PopPlTraceLogPowerPlane(unsigned __int16 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    ...
    v68 = 4LL;
    v70 = 4LL;
    tlgWriteEx_EtwWriteEx((__int64)&dword_140C021E8, (unsigned __int8 *)&word_140029082, a3, 1u, v13, v14, 7u, &v60);
  }
  v4 = *((_QWORD *)a1 + 6);
  for ( i = 0LL; i < v4; ++i )
  {
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      v39 = 2LL;
      v41 = 32LL;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140C021E8, (unsigned __int8 *)&byte_140028F5D, a3, 1u, v13, v14, 0xBu, &v23);
    }
    v4 = *((_QWORD *)a1 + 6);
  }
  v7 = 0LL;
        ...
        do
        {
          ...
          if ( (unsigned int)dword_140C021E8 > 5 )
          {
            ...
            LODWORD(v4) = tlgWriteEx_EtwWriteEx(
                            ...
                            (unsigned __int8 *)&byte_140028FF5,
                            a3,
                            1u,
                            v13,
                            v14,
