/*
 * XREFs of MmSetAccessLogging @ 0x14037DB24
 * Callers:
...
char __fastcall MmSetAccessLogging(int a1, int a2)
{
  ...
  if ( a1 )
  {
    ...
    __writecr8(OldIrql);
    if ( !P )
      LOBYTE(v4) = KeInsertQueueDpc(&stru_140C4E908, 0LL, 0LL);
  }
  else
  {
    if ( stru_140C4E748.Parameter )
    {
      if ( stru_140C4E748.Parameter == (void *)2 )
        stru_140C4E748.Parameter = (void *)3;
    }
    else
    {
      stru_140C4E748.List.Flink = 0LL;
      stru_140C4E748.WorkerRoutine = (void (__fastcall *)(void *))MiEmptyAccessLogs;
      stru_140C4E748.Parameter = (void *)1;
      ExQueueWorkItem(&stru_140C4E748, DelayedWorkQueue);
    }
    KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
    LOBYTE(v4) = KiIrqlFlags;
