/*
 * XREFs of VmCreateMemoryRange @ 0x14092A550
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VmpDecodePreallocationRangeHandle @ 0x14092AD94 (VmpDecodePreallocationRangeHandle.c)
 *     VmpFreeMemoryRanges @ 0x14092ADE8 (VmpFreeMemoryRanges.c)
 *     VmpProcessContextCleanup @ 0x14092B20C (VmpProcessContextCleanup.c)
 *     VmpValidateMemoryRangeParameters @ 0x14092B220 (VmpValidateMemoryRangeParameters.c)
