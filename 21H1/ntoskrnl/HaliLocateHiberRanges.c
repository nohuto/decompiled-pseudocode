/*
 * XREFs of HaliLocateHiberRanges @ 0x140991DB0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( MemoryMap )
  {
    if ( dword_140C4BB18 )
      PoSetHiberRange(
        MemoryMap,
        0xC000u,
        (PVOID)((unsigned __int64)(unsigned int)qword_140C4BB20 >> 12),
        (unsigned __int64)(unsigned int)dword_140C4BB18 >> 12,
        0x6D6C6168u);
    if ( dword_140C4BCD8 )
      PoSetHiberRange(
        MemoryMap,
        0xC000u,
        (PVOID)((unsigned __int64)(unsigned int)qword_140C4BCE0 >> 12),
