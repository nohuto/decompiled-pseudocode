/*
 * XREFs of MfgInitSystem @ 0x140A6F9A4
 * Callers:
...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_140C19750, WORD5(ExpManufacturingInformation));
    if ( inited < 0 )
      goto LABEL_22;
