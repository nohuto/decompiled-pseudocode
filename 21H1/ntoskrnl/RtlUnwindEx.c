/*
 * XREFs of RtlUnwindEx @ 0x14032C220
 * Callers:
 *     RtlUnwind @ 0x140320530 (RtlUnwind.c)
 *     __C_specific_handler @ 0x1403CC050 (__C_specific_handler.c)
 *     __longjmp_internal @ 0x1403F1B30 (__longjmp_internal.c)
 *     KiSystemServiceHandler @ 0x140407140 (KiSystemServiceHandler.c)
 * Callees:
 ...
 *     RtlCaptureContext2 @ 0x1403FDFE0 (RtlCaptureContext2.c)
 *     _alloca_probe @ 0x1403FE8D0 (_alloca_probe.c)
 *     RtlpExecuteHandlerForUnwind @ 0x1403FED70 (RtlpExecuteHandlerForUnwind.c)
