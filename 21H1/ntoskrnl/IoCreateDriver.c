/*
 * XREFs of IoCreateDriver @ 0x14078C3D0
 * Callers:
 *     HaliInitPnpDriver @ 0x14078C720 (HaliInitPnpDriver.c)
...
LABEL_3:
    ...
    v31 = 592;
    v33 = 0LL;
    result = ObCreateObjectEx(0, IoDriverObjectType, (__int64)v28, 0, (__int64)Object, 416, 0, 0, &DmaAdapter, 0LL);
    if ( result < 0 )
      return result;
    v4 = DmaAdapter;
