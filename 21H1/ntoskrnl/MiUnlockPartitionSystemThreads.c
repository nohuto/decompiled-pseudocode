/*
 * XREFs of MiUnlockPartitionSystemThreads @ 0x1403CAF0C
 * Callers:
...
__int64 __fastcall MiUnlockPartitionSystemThreads(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
      break;
    v11 = (unsigned __int64)&CurrentThread->LockEntries[v10];
    v8 &= ~(1 << v10);
    if ( (*(_BYTE *)(v11 + 26) & 1) != 0
      && (*(_DWORD *)(v11 + 32) & 1) == 0
      ...
      *(_BYTE *)(v11 + 26) &= ~1u;
      if ( *(_QWORD *)(v11 + 32) )
      {
        if ( v11 )
        {
          ...
          *(_DWORD *)(v11 + 88) = v13;
          *(_QWORD *)(v11 + 32) = 0LL;
          v14 = (__int64)(v11 - (unsigned __int64)CurrentThread->LockEntries) / 96;
          if ( v7 == 1 )
...
LABEL_16:
  ...
  return KiLeaveGuardedRegionUnsafe(a2, v15, v17, (__int64)v18);
}
