/*
 * XREFs of LdrResGetRCConfig @ 0x14077748C
 * Callers:
 ...
 *     CheckOneBitValidFlag @ 0x140580AE4 (CheckOneBitValidFlag.c)
...
LABEL_16:
        if ( a5 )
        {
          if ( v15 )
            v10 = (__int64)v15;
          LdrpSetAlternateResourceModuleHandle(v13, 0LL, 0LL, (_DWORD *)v10, 0, 2, v11, 0LL);
        }
        return v11;
      }
      v11 = -1073020925;
