/*
 * XREFs of NtReplaceKey @ 0x1408647D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtReplaceKey(_OWORD *a1, void *a2, _OWORD *a3)
{
  ...
  *(_OWORD *)P = 0LL;
  ...
  if ( v12 )
  {
    ...
    if ( v16 >= 0 )
    {
      if ( SeSinglePrivilegeCheck(SeRestorePrivilege, PreviousMode) )
      {
        ...
        v3 = 1;
        v16 = CmpNameFromAttributes(a1, PreviousMode, (UNICODE_STRING *)v30, v15);
        if ( v16 >= 0 )
        {
          v16 = CmpNameFromAttributes(a3, PreviousMode, (UNICODE_STRING *)P, v15);
          if ( v16 >= 0 )
          {
            v18 = CmObReferenceObjectByHandle(a2, 0, v14, PreviousMode, &DmaAdapter, 0LL);
            v19 = DmaAdapter;
            v16 = v18;
            if ( v18 >= 0 )
            {
              if ( (LODWORD(DmaAdapter->DmaOperations->PutDmaAdapter) & 0x80u) == 0 )
              {
                      ...
                      v20 >= 0) )
                {
                  ...
                  v16 = CmPostCallbackNotificationEx(46, (__int64)v19, v21, (__int64)&v33, 0LL, v28);
                  if ( v16 == -1073740541 )
                    v16 = 0;
                }
  ...
  if ( v16 >= 0 )
  {
    if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140021898,
        0LL,
        0LL,
        3u,
        &v41);
  ...
  else if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000000LL) )
  {
    ...
    v38 = 4LL;
    v40 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)&word_1400218CE, 0LL, 0LL, 4u, &v36);
  }
