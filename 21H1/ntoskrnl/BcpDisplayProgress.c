/*
 * XREFs of BcpDisplayProgress @ 0x1405BF370
 * Callers:
 ...
 *     BgpDisplayCharacterEx @ 0x1405BE804 (BgpDisplayCharacterEx.c)
 *     BcpConvertProgressToString @ 0x1405BEBAC (BcpConvertProgressToString.c)
 *     BcpCursorLessThan @ 0x1405BEC88 (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, unsigned int a2, __int64 a3)
{
  ...
  BcpDisplayCriticalString((unsigned __int16 *)v28, dword_140C10E60[2 * v6 + 2], v10, a2);
  v12 = &stru_140C53D40;
  if ( a1 != 1 )
    v12 = &stru_140C53D60;
  BcpDisplayCriticalString(&v12->Length, dword_140C10E60[2 * v6 + 2], v11, a2);
  v13 = BcpCursor;
  v14 = dword_140C4C518;
  v26 = BcpCursor;
  v27 = dword_140C4C518;
  if ( BcpCursorLessThan(&v26) )
  {
    ...
    v16 = HIDWORD(v26);
    v24 = v26;
    v17 = *(_DWORD *)(*(_QWORD *)(qword_140C53DF0 + 24) + 40LL);
    if ( BcpTextBoxLeftEdgeOverride )
      v18 = *(_DWORD *)BcpTextBoxLeftEdgeOverride;
    else
      v18 = dword_140C10E60[2 * v6 + 8] + dword_140C10E60[2 * v6 + 4];
    if ( BcpTextBoxRightEdgeOverride )
      v19 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
    else
      v19 = dword_140C10E60[2 * v6 + 8] + dword_140C10E60[2 * v6 + 6] + dword_140C10E60[2 * v6 + 4];
    while ( BcpCursorLessThan(&v24) )
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_140C53DF0, v15, v16, v17, v17, &v22, &v23, v21) < 0 )
        return 0LL;
      v15 += v22;
      LODWORD(v24) = v15;
      if ( v15 > v19 )
  ...
  if ( (dword_140C132D0 & 0x1000000) == 0 )
  {
    BcpProgressEnd = v13;
    dword_140C13218 = v14;
  }
