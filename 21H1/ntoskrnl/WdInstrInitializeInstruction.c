/*
 * XREFs of WdInstrInitializeInstruction @ 0x1404D92D4
 * Callers:
 *     HalpWdatExecuteActionBeforeInitialize @ 0x1404CF814 (HalpWdatExecuteActionBeforeInitialize.c)
 *     HalpWdatInitializeWdat @ 0x1404CF9F8 (HalpWdatInitializeWdat.c)
 *     HalpWdatInitializeWdrt @ 0x1404CFA90 (HalpWdatInitializeWdrt.c)
 * Callees:
