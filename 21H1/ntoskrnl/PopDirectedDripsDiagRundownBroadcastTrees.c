/*
 * XREFs of PopDirectedDripsDiagRundownBroadcastTrees @ 0x1408F2CD0
 * Callers:
...
void PopDirectedDripsDiagRundownBroadcastTrees()
{
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v1 + 8) = &PopDirectedDripsDiagSessionContext;
    if ( (unsigned int)dword_140D2C920 > 5 && tlgKeywordOn((__int64)&dword_140D2C920, 0x400000000000LL) )
    {
      v2 = *((_QWORD *)v0 + 2);
      v21 = v20;
      v26 = 8LL;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140D2C920,
        (unsigned __int8 *)byte_140028D9B,
        0LL,
        0LL,
        0xDu,
        v24);
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)dword_140D2C920 > 5 && tlgKeywordOn((__int64)&dword_140D2C920, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140D2C920,
          (unsigned __int8 *)&word_140028D0E,
          0LL,
          0LL,
          0xAu,
          v24);
