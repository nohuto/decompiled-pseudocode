/*
 * XREFs of HalpDmaAllocateMappingResources @ 0x140A5E388
 * Callers:
...
__int64 HalpDmaAllocateMappingResources()
{
  ...
  qword_140C53E20 = HalpMmAllocCtxAlloc(v4, v1);
  if ( !qword_140C53E20 )
    return 3221225626LL;
...
LABEL_14:
  ...
  if ( v2 <= 4 )
  {
    qword_140C53E28 = HalpMmAllocCtxAlloc(v7, v1);
    if ( qword_140C53E28 )
    {
      v13 = 0;
      if ( !v2 )
...
LABEL_12:
      ...
      while ( 1 )
      {
        ...
        v17 = qword_140C53E28;
        *(_QWORD *)(v14 + qword_140C53E28) = ReservedMapping;
        if ( !ReservedMapping )
          break;
        ++v13;
        v14 += 8LL;
    ...
    HalpMmAllocCtxFree(v12, qword_140C53E20);
    v19 = v9;
    goto LABEL_14;
  }
LABEL_21:
  ...
  {
    HalpMmAllocCtxFree(v24, qword_140C53E20);
