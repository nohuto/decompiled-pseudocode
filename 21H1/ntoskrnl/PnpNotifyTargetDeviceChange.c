/*
 * XREFs of PnpNotifyTargetDeviceChange @ 0x140684748
 * Callers:
...
__int64 __fastcall PnpNotifyTargetDeviceChange(GUID *Source1, PVOID Object, __int64 a3, _QWORD *a4)
{
  ...
  while ( v9 != v10 )
  {
    ...
    if ( *((_DWORD *)v9 + 5) != (unsigned int)PsGetServerSiloServiceSessionId((__int64)CurrentServerSilo) )
         ...
         || RtlCompareMemory(Source1, &GUID_TARGET_DEVICE_QUERY_REMOVE, 0x10uLL) == 16) )
      {
        ...
        *(GUID *)((char *)v29 + 4) = GUID_TARGET_DEVICE_REMOVE_CANCELLED;
        ...
        do
        {
          ...
          if ( *((_DWORD *)v9 + 5) != (unsigned int)PsGetServerSiloServiceSessionId((__int64)v21) )
