/*
 * XREFs of MiDeleteBootRange @ 0x1403AB508
 * Callers:
      ...
      if ( (*(_QWORD *)(v28 + 24) & 0x3FFFFFFFFFFFFFFFLL) == 1 )
      {
        ...
        if ( v40 == i )
        {
          ...
          while ( 1 )
          {
            ...
            v46 = v45
                + (((unsigned int)dword_140C4CBF0 + 4095LL) & 0xFFFFFFFFFFFFF000uLL)
                + (unsigned int)(*((_DWORD *)v43 + 16) - 1);
            if ( v45 != PsNtosImageBase && v45 != PsHalImageBase )
              v46 += (unsigned __int64)(unsigned int)dword_140C4CB8C << 12;
...
LABEL_44:
  ...
  if ( v33 )
    _InterlockedExchangeAdd64(&qword_140C52880, v33);
LABEL_20:
  v37 = v4 - v54[1];
  MiReturnCommit((__int64)&MiSystemPartition, v37);
  result = qword_140C4EEF0 - v37;
  qword_140C4EEF0 -= v37;
  return result;
}
