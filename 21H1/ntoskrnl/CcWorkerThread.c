/*
 * XREFs of CcWorkerThread @ 0x140233E00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CcOkToAddWriteBehindThread @ 0x1404E46BC (CcOkToAddWriteBehindThread.c)
 */
      ...
      case 2:
        ...
        *((_DWORD *)&CurrentThread[1].SwapListEntry + 3) |= 2u;
        ...
        do
        {
          ...
          CcWriteBehind(*(_QWORD *)(NextWorkQueueEntry + 16), (__int64)&v39);
          if ( v12 >= 0xA )
            break;
          ++v12;
        }
