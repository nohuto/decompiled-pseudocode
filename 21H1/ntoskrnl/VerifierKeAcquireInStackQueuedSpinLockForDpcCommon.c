/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockForDpcCommon @ 0x1409D76F8
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLockForDpc @ 0x1409D76B0 (VerifierKeAcquireInStackQueuedSpinLockForDpc.c)
 *     VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot @ 0x1409D7770 (VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot.c)
 * Callees:
