/*
 * XREFs of PnpTraceRebalanceResult @ 0x1408AD9A4
 * Callers:
...
void PnpTraceRebalanceResult()
{
  ...
  if ( dword_140C02D80 && tlgKeywordOn((__int64)&dword_140C02D80, 0x400000000000LL) )
  {
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_140C02D80, v0) )
      {
        v16 = 2LL;
        v15 = v18;
        v6 = v2 - *((_QWORD *)v3 + 7);
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C02D80,
          (unsigned __int8 *)byte_1400244B0,
          0LL,
          0LL,
          0xFu,
          &v14);
