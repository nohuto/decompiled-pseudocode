/*
 * XREFs of NtCreateKeyTransacted_Stub @ 0x1409782E0
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( byte_140CFA070 )
  {
    v8 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, PUNICODE_STRING, ULONG, HANDLE, PULONG))qword_140CFA068;
  }
  else
  {
    v8 = ZwCreateKeyTransacted;
    byte_140CFA070 = 1;
    qword_140CFA068 = (__int64)ZwCreateKeyTransacted;
  }
  if ( v8 )
