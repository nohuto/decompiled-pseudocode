/*
 * XREFs of MmAdjustWorkingSetSizeEx @ 0x14030E744
 * Callers:
...
LABEL_3:
    ...
    v36 = *(ULONG_PTR **)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(CurrentMultiplexedVm + 174));
    SharedVm = MiGetSharedVm(CurrentMultiplexedVm);
    v41 = ExAcquireSpinLockExclusive(SharedVm);
    SharedVm[1] = 0;
    v40.LockQueue.Next = 0LL;
    v40.LockQueue.Lock = (unsigned __int64 *volatile)(MiGetSharedVm(CurrentMultiplexedVm) + 16);
    ...
    v37 = v14;
    v16 = MiCheckWsLimits(CurrentMultiplexedVm, (unsigned int)&v35, (unsigned int)&v37, a5, 0);
    if ( (v16 & 0xC0000000) == 0xC0000000 )
      goto LABEL_29;
    v17 = *(_QWORD *)(CurrentMultiplexedVm + 112);
    v18 = v35;
    v19 = *(_QWORD *)(CurrentMultiplexedVm + 16);
    v38 = v19;
    if ( v35 > v17 )
    {
      v20 = v35 - v17;
    ...
    if ( v37 < *(_QWORD *)(CurrentMultiplexedVm + 120) )
    {
...
LABEL_86:
    ...
    *(_QWORD *)(CurrentMultiplexedVm + 152) = v37;
    *(_QWORD *)(CurrentMultiplexedVm + 112) = v18;
    if ( !a5 )
    {
LABEL_29:
    ...
    v22 = *(_DWORD *)(CurrentMultiplexedVm + 184);
    v43 = v22;
    if ( (a5 & 4) != 0 )
    {
      LOBYTE(v22) = v22 | 0x80;
...
LABEL_28:
  ...
  else
  {
    ...
    if ( a3 == 3 )
    {
      v25 = 2;
LABEL_43:
      CurrentMultiplexedVm = (__int64)MiGetAnyMultiplexedVm(v25);
      goto LABEL_3;
    }
    if ( a3 == 4 )
      goto LABEL_43;
