/*
 * XREFs of ExtEnvAllocatePhysicalMemory @ 0x1404CFD20
 * Callers:
 ...
 *     MmAllocateContiguousMemorySpecifyCacheNode @ 0x1403CB450 (MmAllocateContiguousMemorySpecifyCacheNode.c)
...
LABEL_13:
  ...
  *(_DWORD *)(v22 + 48) = CacheType;
  ...
  v24 = (__int64 *)qword_140C48DA8;
  if ( *(__int64 **)qword_140C48DA8 != &ExtEnvAllocationList )
    __fastfail(3u);
