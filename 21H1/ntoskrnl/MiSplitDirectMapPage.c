/*
 * XREFs of MiSplitDirectMapPage @ 0x14053C61C
 * Callers:
...
ULONG_PTR __fastcall MiSplitDirectMapPage(unsigned __int16 *a1, __int64 a2, ULONG_PTR a3)
{
  ...
  __int128 v40; // [rsp+20h] [rbp-58h] BYREF
  __int128 v41; // [rsp+30h] [rbp-48h] BYREF
  __m128i v42; // [rsp+40h] [rbp-38h]
  ...
  v43 = *(_QWORD *)a1;
  v7 = v6 | *(_DWORD *)(a2 + 12);
  v8 = *(_QWORD *)(qword_140C4E588 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
  ...
  v42 = v20;
  v21 = (a1[16] >> 1) & 0x1F;
  v42.m128i_i64[1] = _mm_srli_si128(v20, 8).m128i_u64[0] & 0xFFFDFFFFFFFFFFFFuLL;
...
LABEL_13:
  ...
  if ( HIBYTE(word_140C4DF48) == v24 && (v22 & 1) != 0 )
    v22 |= v23;
  *(_QWORD *)&v41 = v22;
  MiWritePteShadow((__int64)&v41, v22);
LABEL_14:
  MiCopyPfnEntryEx(v14, (__int64)&v40);
  *(_BYTE *)(v14 + 34) |= 0x10u;
  *(_WORD *)(v14 + 32) = v25;
  MiAddLockedPageCharge(v26, 1);
  MiDereferenceControlAreaPfnList(v43, 0LL, v27, (_DWORD *)2);
  MiCopyPage(v13, a3, 0LL, 6);
  *(_BYTE *)(v5 + 34) = *(_BYTE *)(v5 + 34) & 0xF8 | 5;
  v29 = (__int64 *)(MiMapPageInHyperSpaceWorker(*(_QWORD *)(v5 + 40) & 0xFFFFFFFFFLL, 0LL, 0x80000000, v28)
