/*
 * XREFs of PopPowerAggregatorHandleIntentUnsafe @ 0x140761F74
 * Callers:
 ...
 *     PopPowerAggregatorHandleSystemTransitionStartIntent @ 0x140712050 (PopPowerAggregatorHandleSystemTransitionStartIntent.c)
 ...
 *     PopPowerAggregatorIsAtTargetState @ 0x140762524 (PopPowerAggregatorIsAtTargetState.c)
 *     PopPowerAggregatorHandleSystemTransitionEndIntent @ 0x140765C80 (PopPowerAggregatorHandleSystemTransitionEndIntent.c)
 *     PopPowerAggregatorCachePoPolicy @ 0x140779B9C (PopPowerAggregatorCachePoPolicy.c)
 *     PopPowerAggregatorHandleActiveIntent @ 0x1408E9C00 (PopPowerAggregatorHandleActiveIntent.c)
 *     PopPowerAggregatorHandleDirectedDripsIntent @ 0x1408E9C40 (PopPowerAggregatorHandleDirectedDripsIntent.c)
 *     PopPowerAggregatorHandleModernStandbyIntent @ 0x1408E9CD0 (PopPowerAggregatorHandleModernStandbyIntent.c)
 *     PopPowerAggregatorHandleModernStandbyResumeIntent @ 0x1408E9D90 (PopPowerAggregatorHandleModernStandbyResumeIntent.c)
 *     PopPowerAggregatorHandleModernStandbySuspendIntent @ 0x1408E9DF0 (PopPowerAggregatorHandleModernStandbySuspendIntent.c)
 */
...
__int64 __fastcall PopPowerAggregatorHandleIntentUnsafe(_QWORD *a1, unsigned int a2, unsigned int a3)
{
  ...
  *((_QWORD *)&v9 + 1) = a3;
        ...
        (v6 = (__int64 (__fastcall *)(__int64 *, __int128 *, _QWORD))PopPowerAggregatorIntentHandlers[v5]) != 0LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      xmmword_140C21778 = v9;
      ymmword_140C21788 = v10;
