/*
 * XREFs of HalpCreateMachineCheckErrorRecord @ 0x1404B4530
 * Callers:
 *     HalpCreateErrorRecord @ 0x1404B44F0 (HalpCreateErrorRecord.c)
 * Callees:
 ...
 *     HalpMcaAMDIsMemoryError @ 0x1404B7BD4 (HalpMcaAMDIsMemoryError.c)
 */
