/*
 * XREFs of PspUnlockQuotaListExclusive @ 0x1403CB8DC
 * Callers:
...
_QWORD *__fastcall PspUnlockQuotaListExclusive(__int64 a1, unsigned __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(v10 + 26) & 1) != 0
      && (*(_DWORD *)(v10 + 32) & 1) == 0
      && (*(_QWORD *)(v10 + 32) & 0x7FFFFFFFFFFFFFFCLL) == (a2 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_17:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, a2, &v17);
  ...
  return KeLeaveCriticalRegionThread(a1, v12, v14, (__int64)v15);
}
