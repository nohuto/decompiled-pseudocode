/*
 * XREFs of KeSetPriorityAndQuantumProcess @ 0x1403355DC
 * Callers:
...
LABEL_27:
        ...
        *(_QWORD *)(v20 + 32) = v28;
        ...
        v33 = *(volatile signed __int32 **)(v20 + 232);
        if ( v33 && (*(_BYTE *)v33 & 0x7F) == 0x15 )
...
LABEL_91:
      ...
      *(_QWORD *)(v39 + 32) = v52;
      ...
      v53 = *(volatile signed __int32 **)(v39 + 232);
      if ( v53 && (*(_BYTE *)v53 & 0x7F) == 0x15 )
