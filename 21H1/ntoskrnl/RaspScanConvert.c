        ...
        _QWORD *a8)
{
  ...
  if ( SegmentList >= 0 )
  {
    ...
    if ( v10 )
    {
      v32 = qword_140D6C000;
      v64 = qword_140D6C000;
      v14 = BgpGxInitializeRectangle(v65, 1LL, qword_140D6C000, 3140LL);
      if ( v14 < 0 )
        goto LABEL_32;
    }
    else
