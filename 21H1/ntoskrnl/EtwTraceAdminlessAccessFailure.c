  ...
  if ( !(_DWORD)a3 )
  {
    if ( a4 )
    {
      if ( (unsigned int)dword_140C02BB0 <= 5 )
        goto LABEL_15;
      LOBYTE(v7) = tlgKeywordOn((__int64)&dword_140C02BB0, 0x400000000000LL);
      if ( !(_BYTE)v7 )
        goto LABEL_15;
      v19 = v12;
      v47 = &v19;
    ...
    LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BB0, v10, 0LL, 0LL, 6u, v11);
    goto LABEL_15;
  }
  if ( (unsigned int)dword_140C02BB0 > 5 )
  {
