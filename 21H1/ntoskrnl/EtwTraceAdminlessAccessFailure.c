/*
 * XREFs of EtwTraceAdminlessAccessFailure @ 0x14093B424
 * Callers:
...
char __fastcall EtwTraceAdminlessAccessFailure(int a1, __int64 a2, int a3, char a4)
{
  ...
  v55 = a1;
  v22[0].QuadPart = 0LL;
  v22[2].QuadPart = (LONGLONG)&word_1407C1980;
  ...
  if ( !a3 )
  {
    if ( a4 )
    {
      if ( (unsigned int)dword_140C02BB0 <= 5 )
        goto LABEL_13;
      LOBYTE(v5) = tlgKeywordOn((__int64)&dword_140C02BB0, 0x400000000000LL);
      if ( !(_BYTE)v5 )
        goto LABEL_13;
      v20 = v13;
      v47 = &v20;
      v10 = (unsigned __int8 *)byte_14002C6FD;
      v48 = 4LL;
      v49 = v52;
      v51 = *((_QWORD *)v12 + 1);
      v52[0] = *v12;
    ...
    else
    {
      ...
      v18 = v9;
      v38 = &v18;
      v10 = (unsigned __int8 *)word_14002C6B2;
      v39 = 4LL;
      v40 = v43;
      v42 = *((_QWORD *)v8 + 1);
      v43[0] = *v8;
    ...
    LOBYTE(v5) = tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BB0, v10, 0LL, 0LL, 6u, v11);
    goto LABEL_13;
  }
  if ( (unsigned int)dword_140C02BB0 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      LOBYTE(v5) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)&word_14002C646,
                     0LL,
                     0LL,
                     7u,
                     &v26);
