/*
 * XREFs of MiLogOutswappedProcessCommitReacquire @ 0x140525BE4
 * Callers:
...
void __fastcall MiLogOutswappedProcessCommitReacquire(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( *(_QWORD *)&qword_140C4EE20 )
  {
    if ( a3 )
    {
      if ( a4 )
      {
        if ( **(_DWORD **)&qword_140C4EE20 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 4LL) )
        {
          tlgCreate1Sz_char((__int64)v19, (const CHAR *)(v11 + 1448));
          v10 = (unsigned __int8 *)byte_140024813;
          goto LABEL_13;
        }
      }
      else if ( **(_DWORD **)&qword_140C4EE20 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 4LL) )
      {
        tlgCreate1Sz_char((__int64)v19, (const CHAR *)(v12 + 1448));
        v10 = (unsigned __int8 *)&byte_140024867;
        goto LABEL_13;
      }
    }
    else if ( **(_DWORD **)&qword_140C4EE20 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 4LL) )
    {
      ...
      v10 = (unsigned __int8 *)&word_140024986;
LABEL_13:
      v13 = *(_DWORD *)(v9 + 1088);
      v22 = 0;
      v25 = 0;
      ...
      v17 = a2;
      v24 = 8;
      tlgWriteEx_EtwWriteEx(v8, v10, v6, 1u, v14, v15, 5u, &v18);
    }
  }
}
