/*
 * XREFs of PfpLogPageAccess @ 0x140654570
 * Callers:
...
unsigned __int64 __fastcall PfpLogPageAccess(__int64 a1, _DWORD *a2, _BYTE *a3, __int64 a4, int a5)
{
  ...
  {
    v14 = qword_140C4FB58;
    v15 = *(unsigned int *)(qword_140C4FB58 + 16);
    v16 = (qword_140C4FB58 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
      ...
      v15 = (HIBYTE(v54)
           ...
           * (BYTE6(v54)
            ...
            * (BYTE5(v54)
             + 37
             * (BYTE4(v54)
              + 37 * (BYTE3(v54) + 37 * (BYTE2(v54) + 37 * (BYTE1(v54) + 37 * ((unsigned __int8)v12 + 11623883)))))))) & (unsigned int)(*(_DWORD *)(qword_140C4FB58 + 32) - 1);
            ...
            v44 = (HIBYTE(v54)
                 ...
                 * (BYTE6(v54)
                  ...
                  * (BYTE5(v54)
                   + 37
                   * (BYTE4(v54)
                    + 37 * (BYTE3(v54) + 37 * (BYTE2(v54) + 37 * (BYTE1(v54) + 37 * ((unsigned __int8)v12 + 11623883)))))))) & (*(_DWORD *)(qword_140C4FB58 + 32) - 1);
            if ( v43 >= 2 )
            {
              v10 = -1;
              goto LABEL_55;
...
LABEL_55:
    ...
    if ( v51 < 3 * (*(_DWORD *)(v14 + 32) >> 2) )
      break;
    if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4FB40) == -1073741823 )
      return 0LL;
  }
  v13 = 1;
  *(_DWORD *)(v14 + 28) = v51 + 1;
...
LABEL_19:
      v27 = qword_140C4FB30;
      v28 = ((*a3 & 3) == 2) + 1;
      if ( (unsigned int)(v28 + *(_DWORD *)(qword_140C4FB30 + 16)) > *(_DWORD *)(qword_140C4FB30 + 20) )
      {
        while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4FB18) != -1073741823 )
        {
          v27 = qword_140C4FB30;
          if ( (unsigned int)(v28 + *(_DWORD *)(qword_140C4FB30 + 16)) <= *(_DWORD *)(qword_140C4FB30 + 20) )
            goto LABEL_20;
...
LABEL_20:
  ...
  {
    v18 = (a1 ^ *(_QWORD *)(a1 + 1128)) & 0x1FFFFFFFFFFFFFFFLL;
    goto LABEL_12;
  }
  v18 = a1;
LABEL_12:
  ...
  {
    v22 = qword_140C4FB58;
    v23 = *(unsigned int *)(v21 + qword_140C4FB58);
    v24 = (qword_140C4FB58 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
...
LABEL_14:
    ...
    else
    {
      ...
      if ( v41 == v19 )
      {
        *(_DWORD *)(v21 + qword_140C4FB58) = v40;
...
LABEL_52:
        ...
        while ( 1 )
        {
          ...
          if ( v50 == v19 )
          {
            *(_DWORD *)(v21 + qword_140C4FB58) = v48;
            LOWORD(v23) = v48;
            goto LABEL_14;
          }
          if ( !v50 )
...
LABEL_15:
  if ( v22 )
  {
    v5 = 2LL;
    v6 = v23 + *(_WORD *)(v22 + 36);
    v25 = 5LL * (unsigned __int16)v23;
    if ( v20 || (*(_BYTE *)(v24 + 8 * v25 + 8) & 4) != 0 )
    {
      v52 = *(_QWORD *)(v24 + 8 * v25 + 8);
      if ( v17 )
      {
        *(_QWORD *)(v24 + 8 * v25 + 8) = v52 & 0xFFFFFFFFFFFFFFF8uLL | 5;
      }
      else
      {
        v53 = v52 & 0xFFFFFFFFFFFFFFF8uLL | 1;
        *(_QWORD *)(v24 + 8 * v25 + 8) = v53;
        *(_QWORD *)(v24 + 8 * v25 + 8) = v53 & 7 | (8 * (a1 ^ *(_QWORD *)(a1 + 1128)));
        *(_DWORD *)(v24 + 8 * v25 + 28) = *(_DWORD *)(a1 + 1524);
        *(_DWORD *)(v24 + 8 * v25 + 24) = *(_DWORD *)(a1 + 1088);
        *(_QWORD *)(v24 + 8 * v25 + 16) = a1;
      }
    }
LABEL_18:
    v26 = 0;
