/*
 * XREFs of PopTransitionTelemetryOsState @ 0x140780F84
 * Callers:
...
__int64 __fastcall PopTransitionTelemetryOsState(int a1, int a2)
{
  ...
  v48 = 0LL;
  v47 = 0LL;
  if ( !dword_140C021E8 || !tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) || !byte_140C22D8C )
    return v4;
  switch ( a1 )
  {
    case 2:
      ...
      else if ( (unsigned int)dword_140C0EDAC < MEMORY[0xFFFFF7800000037C] )
      {
        if ( !dword_140C0EDA8 )
          dword_140C0EDA8 = TelemetryCoverageStringHashInternal(off_140C0EDA0, &v33);
        v6 = &off_140C0EDA0;
        goto LABEL_67;
      }
      break;
    case 3:
      switch ( a2 )
      {
        case 3:
          ...
          {
            if ( !dword_140C0ED90 )
              dword_140C0ED90 = TelemetryCoverageStringHashInternal(off_140C0ED88, &v37);
            v6 = &off_140C0ED88;
            goto LABEL_67;
          }
          break;
        case 4:
          ...
          {
            if ( !dword_140C0ED30 )
              dword_140C0ED30 = TelemetryCoverageStringHashInternal(off_140C0ED28, &v36);
            v6 = &off_140C0ED28;
            goto LABEL_67;
          }
          break;
        case 5:
          ...
          break;
        case 6:
          if ( (unsigned int)dword_140C0ED64 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ED60 )
              dword_140C0ED60 = TelemetryCoverageStringHashInternal(off_140C0ED58, &v40);
            v6 = &off_140C0ED58;
            goto LABEL_67;
          }
          break;
    ...
    case 4:
      ...
      {
        case 3:
          if ( (unsigned int)dword_140C0ECD4 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ECD0 )
              dword_140C0ECD0 = TelemetryCoverageStringHashInternal(off_140C0ECC8, &v38);
            v6 = &off_140C0ECC8;
            goto LABEL_67;
          }
          break;
        ...
        case 5:
          ...
          {
            if ( !dword_140C0ED00 )
              dword_140C0ED00 = TelemetryCoverageStringHashInternal(off_140C0ECF8, &v20);
            v6 = &off_140C0ECF8;
            goto LABEL_67;
          }
          break;
        case 6:
          ...
          break;
        default:
          if ( a2 == 8 && (unsigned int)dword_140C0ECA4 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ECA0 )
              dword_140C0ECA0 = TelemetryCoverageStringHashInternal(off_140C0EC98, &v22);
            v6 = &off_140C0EC98;
LABEL_67:
  ...
  v4 = dword_140C22D88;
  if ( a1 != 5 || dword_140C22D50 == 1 || (unsigned int)(dword_140C22D50 - 4) <= 1 )
  {
    v8 = (KiQueryUnbiasedInterruptTime() - qword_140C22D68) / 0x2710uLL;
    v9 = v8 - qword_140C22D78;
    v10 = (MEMORY[0xFFFFF78000000008] - qword_140C22D60) / 0x2710uLL;
    qword_140C22D78 = v8;
    v11 = v10 - qword_140C22D70;
    v33 = v10 - qword_140C22D70;
    v12 = v10 - qword_140C22D70;
    qword_140C22D70 = v10;
    if ( v9 <= v11 )
      v12 = v9;
    v32 = v12;
    v21 = v7 + dword_140C22D80;
    dword_140C22D80 += v7;
    v19 = dword_140C22D50;
    v20 = dword_140C22D54;
    if ( a1 != 5 )
    ...
    if ( (unsigned int)dword_140C021E8 > 5 && tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140026C0D,
        0LL,
        0LL,
        0x16u,
        &v49);
