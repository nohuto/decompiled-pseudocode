/*
 * XREFs of WheapWmiExecuteMethod @ 0x1405B80E0
 * Callers:
 *     WheaWmiDispatch @ 0x1403C8660 (WheaWmiDispatch.c)
 * Callees:
 *     WheapWmiExecuteErrorInjectionMethod @ 0x1405B7BDC (WheapWmiExecuteErrorInjectionMethod.c)
