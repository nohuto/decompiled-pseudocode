/*
 * XREFs of KiSaveDebugRegisterState @ 0x1403F6390
 * Callers:
 ...
 *     KiNpxNotAvailableFault @ 0x1404025C0 (KiNpxNotAvailableFault.c)
 *     KiDoubleFaultAbort @ 0x1404028C0 (KiDoubleFaultAbort.c)
 *     KiNpxSegmentOverrunAbort @ 0x140402BC0 (KiNpxSegmentOverrunAbort.c)
 *     KiInvalidTssFault @ 0x140402EC0 (KiInvalidTssFault.c)
 *     KiSegmentNotPresentFault @ 0x1404031C0 (KiSegmentNotPresentFault.c)
 ...
 *     KiFloatingErrorFault @ 0x140404240 (KiFloatingErrorFault.c)
 ...
 *     KiXmmException @ 0x140405440 (KiXmmException.c)
