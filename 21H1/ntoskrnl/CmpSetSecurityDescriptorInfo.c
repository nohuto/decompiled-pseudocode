/*
 * XREFs of CmpSetSecurityDescriptorInfo @ 0x14068B1C0
 * Callers:
...
__int64 CmpSetSecurityDescriptorInfo(ULONG_PTR a1, unsigned int *a2, ...)
{
  ...
  v18 = RtlpSetSecurityObject(0LL, *a2, v54, &SecurityDescriptor, 0, v58, v59, v17);
  if ( v18 >= 0 )
  {
...
LABEL_45:
      ...
      LODWORD(v54) = 0;
      if ( !CmpFindSecurityCellCacheIndex(v4, BugCheckParameter4, (unsigned int *)va) )
