/*
 * XREFs of MiRemoveLockedPageCharge @ 0x140285070
 * Callers:
...
LABEL_16:
      ...
      if ( (unsigned int)MI_PFN_IS_PROTO(a1, v9, 0LL) && (*(_DWORD *)(v12 + 16) & 0x400LL) != 0 )
      {
        v13 = 1;
      }
      ...
      v17 = *(_QWORD *)(qword_140C4E588 + 8 * ((v5 >> 39) & 0x3FF));
      if ( v13 == 1 )
      {
        v18 = 1LL;
