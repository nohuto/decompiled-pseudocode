/*
 * XREFs of PfpQueryFileExtentsRequest @ 0x1408DB39C
 * Callers:
        ...
        *((_WORD *)PoolWithTag + v15) = 92;
        ...
        if ( inited >= 0 )
        {
          ...
          if ( inited >= 0 )
          {
            ...
            inited = v18;
            if ( v18 == 259 )
              KeBugCheckEx(0x191u, 0xF6BuLL, 0LL, 0LL, 0LL);
            if ( (v18 & 0xC0000000) != 0xC0000000 )
            {
              ...
              while ( 1 )
              {
                ...
                inited = v21;
                if ( v21 == 259 )
                  KeBugCheckEx(0x191u, 0xFA9uLL, 0LL, 0LL, 0LL);
                if ( v21 >= 0 )
                  break;
                if ( v21 == -1073741807 )
                  goto LABEL_43;
...
LABEL_43:
              ...
              inited = v22;
              if ( v22 == 259 )
                KeBugCheckEx(0x191u, 0xFE4uLL, 0LL, 0LL, 0LL);
              if ( v22 >= 0 )
              {
