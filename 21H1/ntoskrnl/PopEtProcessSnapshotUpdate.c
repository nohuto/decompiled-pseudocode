/*
 * XREFs of PopEtProcessSnapshotUpdate @ 0x1405F0DC8
 * Callers:
 *     PopEtProcessEnumSnapshotCallback @ 0x1405F0CC0 (PopEtProcessEnumSnapshotCallback.c)
 *     PopEtEnergyTrackerEnumSnapshotCallback @ 0x1406E408C (PopEtEnergyTrackerEnumSnapshotCallback.c)
 * Callees:
 *     PopReleaseRwLock @ 0x140205C14 (PopReleaseRwLock.c)
 *     PopAcquireRwLockExclusive @ 0x14035D404 (PopAcquireRwLockExclusive.c)
 *     PopEtProcessSnapshotFind @ 0x1405F0F80 (PopEtProcessSnapshotFind.c)
 *     PopEtEnergyTrackerUpdateAggregate @ 0x1405F1094 (PopEtEnergyTrackerUpdateAggregate.c)
 *     PopEtProcessSnapshotUpdateFromSnapshotContext @ 0x1405F14CC (PopEtProcessSnapshotUpdateFromSnapshotContext.c)
