/*
 * XREFs of HalpCmosRangeHandler @ 0x1404D0C0C
 * Callers:
 *     HalpcGetCmosDataByType @ 0x1404D0F00 (HalpcGetCmosDataByType.c)
 *     HalpcSetCmosDataByType @ 0x1404D0F30 (HalpcSetCmosDataByType.c)
 * Callees:
...
LABEL_13:
      ...
      {
        v16 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD))funcs_1404D0C94[v12])(a3, a4 + v10, v15);
      }
      a4 = v17;
      goto LABEL_13;
    }
