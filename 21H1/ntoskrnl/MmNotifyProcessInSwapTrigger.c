/*
 * XREFs of MmNotifyProcessInSwapTrigger @ 0x1402EF5C4
 * Callers:
...
char __fastcall MmNotifyProcessInSwapTrigger(__int64 a1)
{
  ...
  if ( result == 64 && *(_QWORD *)&qword_140C4EE20 && **(_DWORD **)&qword_140C4EE20 > 5u )
  {
    result = tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 0x400000000008LL);
    if ( result )
    {
      ...
      v11 = 0x1000000LL;
      v18 = 8;
      return tlgWriteEx_EtwWriteEx(v7, (int)&byte_1400247BF, v6, 1, v8, v9, 5u, (__int64)v12);
    }
  }
  return result;
}
