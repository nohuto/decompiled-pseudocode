/*
 * XREFs of PopPepRegisterDevice @ 0x14079D490
 * Callers:
 ...
 *     PopPepComponentGetLatencyIdleState @ 0x1403BA7F4 (PopPepComponentGetLatencyIdleState.c)
      ...
      if ( v12 >= v9 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          *((_DWORD *)v18 + 35) = v9;
          ...
          while ( (__int64)v22 < (__int64)AlpcSecurityType );
          *((_QWORD *)v18 + 2) |= 1uLL;
          v24 = 0;
          v25 = (__int64 *)(a3 + 16);
          v47 = a3 + 16;
          ...
          while ( 1 )
          {
            ...
            *((_DWORD *)v26 - 7) = 3;
            ...
            while ( (__int64)v28 < (__int64)AlpcSecurityType );
