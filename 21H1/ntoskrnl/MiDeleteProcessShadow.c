/*
 * XREFs of MiDeleteProcessShadow @ 0x1402AD198
 * Callers:
...
void __fastcall MiDeleteProcessShadow(__int64 a1, int a2)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v3 = a1 + 1664;
  v4 = 1LL;
  v5 = *(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(a1 + 1838));
  if ( a2 )
  {
...
LABEL_11:
    ...
    v12 = (_QWORD *)(((*(_QWORD *)(a1 + 1928) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
    v27 = MI_READ_PTE_LOCK_FREE((unsigned __int64)v12);
    v13 = v27;
