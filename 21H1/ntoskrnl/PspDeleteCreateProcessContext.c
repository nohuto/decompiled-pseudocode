/*
 * XREFs of PspDeleteCreateProcessContext @ 0x140707894
 * Callers:
 ...
 *     PspDestroyProcessParameterOverrides @ 0x140707A30 (PspDestroyProcessParameterOverrides.c)
...
__int64 __fastcall PspDeleteCreateProcessContext(__int64 a1)
{
  ...
  return PspDestroyProcessParameterOverrides(*(_QWORD *)(a1 + 504));
}
