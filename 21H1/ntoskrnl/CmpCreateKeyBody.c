/*
 * XREFs of CmpCreateKeyBody @ 0x140622E40
 * Callers:
...
LABEL_47:
  ...
  v18 = ObpCaptureObjectCreateInformation(a2, a2, 0LL, &v47, (__int64)v17, 0);
  if ( v18 < 0 )
  {
  ...
  *((_DWORD *)&v17[1].Next + 2) = v19;
  v18 = ObpAllocateObject((int *)v17, a2, (__int64)v14, &v47, 104, &v45, &v44);
  if ( v18 < 0 )
  {
LABEL_58:
    if ( *((_QWORD *)&v47 + 1) )
