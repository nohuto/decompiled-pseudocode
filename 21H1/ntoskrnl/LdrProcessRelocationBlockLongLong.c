/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x140914C48
 * Callers:
 *     LdrRelocateImageWithBias @ 0x140914D04 (LdrRelocateImageWithBias.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1405886C0 (LdrpArmProcessRelocation.c)
 *     LdrpGenericProcessRelocation @ 0x140588794 (LdrpGenericProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x14058883C (LdrpThumbProcessRelocation.c)
 */
