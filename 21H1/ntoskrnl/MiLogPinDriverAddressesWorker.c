/*
 * XREFs of MiLogPinDriverAddressesWorker @ 0x14079E200
 * Callers:
 *     <none>
 * Callees:
...
char MiLogPinDriverAddressesWorker()
{
  ...
  do
  {
    ...
    if ( (v2 & 1) != 0 )
    {
      ...
      RtlInterlockedClearBitRun((__int64)&dword_140C2A080, v0, 1u);
    ...
    for ( i = 0; i < 2; ++i )
    {
      for ( j = 0; j < 2; ++j )
      {
        ...
        if ( v7 != *v4 )
        {
          ...
          {
            LOBYTE(v2) = tlgKeywordOn(*(__int64 *)&qword_140C4EE20, 0x400000000000LL);
            if ( (_BYTE)v2 )
            {
              v20 = 8LL;
              v13 = v3;
              ...
              v25 = &v15;
              v27 = &v17;
              LOBYTE(v2) = tlgWriteAgg(v10, (unsigned __int8 *)&word_14002577A, v8, 7u, &v18);
            }
          }
          *v4 = v7;
        }
