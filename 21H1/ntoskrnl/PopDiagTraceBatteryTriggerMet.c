/*
 * XREFs of PopDiagTraceBatteryTriggerMet @ 0x1408E401C
 * Callers:
...
char __fastcall PopDiagTraceBatteryTriggerMet(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned int)*a3 <= 1 )
  {
    ...
    v14 = !v13;
    v29 = v4;
    LOBYTE(v3) = -45 * (dword_140C2384C - 12);
    v30 = v11;
    v31 = v12;
    v15 = (dword_140C2384C + 500) / 0x3E8u;
    v32 = v14;
    v23 = v6;
    v33 = v6;
    v24 = v7;
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_14002661B,
                       0LL,
                       0LL,
                       0xEu,
                       &v65);
