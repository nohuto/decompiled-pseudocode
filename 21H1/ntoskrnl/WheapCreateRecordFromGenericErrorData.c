/*
 * XREFs of WheapCreateRecordFromGenericErrorData @ 0x1405B7020
 * Callers:
 *     WheapDeviceDriverCreateRecord @ 0x1405B6600 (WheapDeviceDriverCreateRecord.c)
 *     WheapDefaultErrSrcCreateRecord @ 0x1405B7330 (WheapDefaultErrSrcCreateRecord.c)
 * Callees:
