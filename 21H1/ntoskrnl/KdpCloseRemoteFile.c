/*
 * XREFs of KdpCloseRemoteFile @ 0x1409B3970
 * Callers:
...
__int64 __fastcall KdpCloseRemoteFile(int a1)
{
  ...
  if ( v4 )
  {
    for ( v11[1] = KdpRemoteFiles[v1]; ; v11[1] = v5 )
    {
      ...
      v9 = v11;
      v10 = 0LL;
      KdSendPacket(11LL, v8, 0LL, (char *)&KdDebuggerNotPresent + 5);
      ...
      *((_QWORD *)&v10 + 1) = &KdpMessageBuffer;
      if ( !(unsigned int)KdReceivePacket(11LL, v8, &v10, &v7, (char *)&KdDebuggerNotPresent + 5) )
        break;
