/*
 * XREFs of KseShimDatabaseBootInitialize @ 0x140A6E2DC
 * Callers:
...
__int64 __fastcall KseShimDatabaseBootInitialize(void *Src, size_t Size, void *a3, unsigned int a4)
{
  ...
  if ( Src && v6 )
  {
    ...
    if ( v8 >= 0 )
    {
      if ( a3 && a4 )
      {
        if ( (int)KsepSdbBootInitialize(a3, a4, (__int64)qword_140C2AEB8) < 0 )
        {
        ...
        else if ( dword_140C2AEB0 >= (unsigned int)dword_140C2AEE8 )
        {
