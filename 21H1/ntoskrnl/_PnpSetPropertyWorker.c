/*
 * XREFs of _PnpSetPropertyWorker @ 0x14072BE70
 * Callers:
        ...
        ULONG a7)
{
  ...
  ULONG v23; // [rsp+A0h] [rbp-70h] BYREF
  ULONG v24; // [rsp+A4h] [rbp-6Ch] BYREF
  ...
  v12 = PnpCtxRegCreateKey(a1, (char *)v22, pszDest, 0, 4u, 0LL, &v21, &v24);
  if ( v12 == -1073741444 )
    goto LABEL_26;
  if ( v12 < 0 )
  {
  ...
  v13 = PnpCtxRegCreateKey(a1, (char *)v21, Dst, 0, 0x10006u, 0LL, &Handle, &v23);
  if ( v13 == -1073741444 )
  {
LABEL_26:
    v11 = -1073741595;
