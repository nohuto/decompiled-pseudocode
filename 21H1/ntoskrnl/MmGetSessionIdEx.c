/*
 * XREFs of MmGetSessionIdEx @ 0x140260EB0
 * Callers:
 ...
 *     IoGetRequestorSessionId @ 0x140322390 (IoGetRequestorSessionId.c)
 ...
 *     KeRemoveSystemServiceTable @ 0x1408B6990 (KeRemoveSystemServiceTable.c)
