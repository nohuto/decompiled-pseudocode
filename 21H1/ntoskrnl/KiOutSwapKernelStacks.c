/*
 * XREFs of KiOutSwapKernelStacks @ 0x14032A2DC
 * Callers:
...
ULONG __fastcall KiOutSwapKernelStacks(__int64 a1, __int64 a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  _OWORD v34[2]; // [rsp+28h] [rbp-50h] BYREF
  ...
  if ( (_DWORD)v4 )
  {
    ...
    do
    {
      ...
      if ( (unsigned int)v20 != 1 )
        KiDecrementProcessStackCount(*(_QWORD *)(v19 + 184), v21, v22, v23);
