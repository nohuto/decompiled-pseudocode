/*
 * XREFs of MiInitializeBootLoadedDriverPfns @ 0x140A5E5DC
 * Callers:
...
LABEL_10:
    if ( (PVOID)v8 != PsHalImageBase && (PVOID)v8 != PsNtosImageBase )
    {
      _InterlockedExchangeAdd(&dword_140C4EF10, v9);
      qword_140C4EEF0 -= v7;
    }
    goto LABEL_13;
  }
...
LABEL_9:
  ...
  if ( (int)MiAcquireNonPagedResources((__int64)&MiSystemPartition, v14, 0LL, 0) >= 0 )
  {
    qword_140C4EEF0 += v14;
    goto LABEL_9;
  }
