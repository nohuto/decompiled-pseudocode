/*
 * XREFs of PopDirectedDripsDiagNotifySessionStop @ 0x1408F2AC4
 * Callers:
...
char __fastcall PopDirectedDripsDiagNotifySessionStop(__int64 a1, int a2, int a3)
{
  ...
  if ( (HandleAttributes & 1) != 0 )
  {
    ...
    if ( PopDirectedDripsDiagTraceHandleRegistered
      && (unsigned int)dword_140D2C920 > 5
      && tlgKeywordOn((__int64)&dword_140D2C920, 0x400000000000LL) )
    {
      v20 = 0;
      v23 = 0;
      v26 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140028EA3,
        0LL,
        0LL,
        0xAu,
        &v17);
