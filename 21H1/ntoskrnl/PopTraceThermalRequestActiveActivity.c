/*
 * XREFs of PopTraceThermalRequestActiveActivity @ 0x1403871F4
 * Callers:
 ...
 *     PopDiagSnapActiveActivity @ 0x1403874C4 (PopDiagSnapActiveActivity.c)
        ...
        if ( v11 )
        {
            ...
            && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)byte_140026F30,
              0LL,
              0LL,
              8u,
              &v15);
