/*
 * XREFs of HalpDmaAllocateDomain @ 0x1403C35A8
 * Callers:
 ...
 *     HalpDmaAddReservedRangesToDomain @ 0x1404BF440 (HalpDmaAddReservedRangesToDomain.c)
...
__int64 __fastcall HalpDmaAllocateDomain(unsigned __int64 *a1, _QWORD *a2, unsigned int a3, char a4, __int64 a5)
{
  ...
  v13 = (__int64 *)qword_140C49DF8;
  v14 = v12;
  if ( *(__int64 **)qword_140C49DF8 != &HalpDmaDomainList )
    __fastfail(3u);
  *(_QWORD *)(v11 + 8) = qword_140C49DF8;
