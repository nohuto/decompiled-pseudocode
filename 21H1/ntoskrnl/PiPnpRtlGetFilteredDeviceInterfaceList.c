/*
 * XREFs of PiPnpRtlGetFilteredDeviceInterfaceList @ 0x1406B31D0
 * Callers:
 ...
 *     PiDmGetCmObjectConstraintListFromCache @ 0x1406B32F0 (PiDmGetCmObjectConstraintListFromCache.c)
