/*
 * XREFs of MiReleaseCommitForResetPages @ 0x140526A34
 * Callers:
...
LONG __fastcall MiReleaseCommitForResetPages(ULONG_PTR a1)
{
  ...
  if ( v11 )
    MiReturnCommit(*(_QWORD *)(qword_140C4E588 + 8LL * *(unsigned __int16 *)(a1 + 1838)), v11);
  ...
  *((_QWORD *)v4 + 1) += v11;
  ...
  KeForceDetachProcess(0LL, 0, v17, v18);
