/*
 * XREFs of HUBDESC_ValidateMSOSContainerIDDescriptorHeader @ 0x1C00398E0
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSContainerIDDescriptorHeader(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 != 8 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(a4, 2u, 5u, 0x104u, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids, a2);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 117LL);
    v7 = 0;
LABEL_18:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(a4, 2u, 5u, 0x108u, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids);
    return v7;
  }
  if ( *(_WORD *)(a1 + 4) != 256 )
  {
  ...
  if ( *(_WORD *)(a1 + 6) != 6 )
  {
    ...
    {
      LODWORD(v10) = 6;
      LODWORD(v9) = *(unsigned __int16 *)(a1 + 6);
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x106u, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids, v9, v10);
    }
  ...
  if ( *(_DWORD *)a1 != 24 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x107u, (__int64)&WPP_aa79356b1e693837079f99291824f69e_Traceguids, v9, v10);
    }
