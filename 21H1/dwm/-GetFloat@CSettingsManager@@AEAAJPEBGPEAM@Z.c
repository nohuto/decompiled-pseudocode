/*
 * XREFs of ?GetFloat@CSettingsManager@@AEAAJPEBGPEAM@Z @ 0x140007E18
 * Callers:
 *     ?GetPreferenceFloat@CSettingsManager@@UEAAJPEBGPEAM@Z @ 0x140007F70 (-GetPreferenceFloat@CSettingsManager@@UEAAJPEBGPEAM@Z.c)
 * Callees:
