/*
 * XREFs of VidSchiProcessPeriodicNotificationCookie @ 0x1C0030554
 * Callers:
 ...
 *     VidSchiCalculatePeriodicTargetFrameNumber @ 0x1C002F160 (VidSchiCalculatePeriodicTargetFrameNumber.c)
 *     ?VidSchiSignalSyncObjectsFromCpu@@YAJPEAVHwQueueStagingList@@IPEAPEAU_VIDSCH_SYNC_OBJECT@@U_D3DDDICB_SIGNALFLAGS@@PEB_KPEAPEAUVIDSCH_HW_QUEUE@@@Z @ 0x1C0033308 (-VidSchiSignalSyncObjectsFromCpu@@YAJPEAVHwQueueStagingList@@IPEAPEAU_VIDSCH_SYNC_OBJECT@@U_D3DD.c)
 */
