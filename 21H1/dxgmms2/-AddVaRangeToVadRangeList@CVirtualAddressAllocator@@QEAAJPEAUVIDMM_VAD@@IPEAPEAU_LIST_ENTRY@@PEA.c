/*
 * XREFs of ?AddVaRangeToVadRangeList@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_VAD@@IPEAPEAU_LIST_ENTRY@@PEAUVIDMM_MAPPED_VA_RANGE@@@Z @ 0x1C006F928
 * Callers:
 ...
 *     ?AddVaRangeToVad@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_VAD@@PEAUVIDMM_MAPPED_VA_RANGE@@PEAU_LIST_ENTRY@@2@Z @ 0x1C006F9E8 (-AddVaRangeToVad@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_VAD@@PEAUVIDMM_MAPPED_VA_RANGE@@PEAU_L.c)
 ...
 *     ?VidMmiCalculateNewOwnerOffset@@YA_KPEAUVIDMM_MAPPED_VA_RANGE@@_J@Z @ 0x1C00C0B6C (-VidMmiCalculateNewOwnerOffset@@YA_KPEAUVIDMM_MAPPED_VA_RANGE@@_J@Z.c)
 *     ?VidMmiLogEndVaRangeMapping@@YAXPEAVCVirtualAddressAllocator@@PEAUVIDMM_MAPPED_VA_RANGE@@_K22@Z @ 0x1C00C0B98 (-VidMmiLogEndVaRangeMapping@@YAXPEAVCVirtualAddressAllocator@@PEAUVIDMM_MAPPED_VA_RANGE@@_K22@Z.c)
 */
        ...
        struct VIDMM_MAPPED_VA_RANGE *a5)
{
  ...
  unsigned __int64 v33; // [rsp+D8h] [rbp+20h]
...
LABEL_9:
      ...
      CVirtualAddressAllocator::RemoveVaRangeFromVad((CVirtualAddressAllocator *)this, v17, 0, 1u);
    }
    if ( v15 < v19 )
      break;
    VidMmiLogEndVaRangeMapping(
  ...
  if ( v13 < 0 )
    goto LABEL_36;
  v13 = CVirtualAddressAllocator::AddVaRangeToVad((CVirtualAddressAllocator *)this, a2, a5, v23, v17);
  if ( v13 < 0 )
    goto LABEL_13;
  v33 = VidMmiCalculateNewOwnerOffset(
          (struct VIDMM_MAPPED_VA_RANGE *)p_Blink,
          *((_QWORD *)a5 + 12) - (_QWORD)p_Blink[12]);
  v25 = VidMmiCalculateNewOwnerOffset((struct VIDMM_MAPPED_VA_RANGE *)p_Blink, *((_QWORD *)a5 + 13) - v24);
  v27 = operator new[](0x88uLL, 0x39346956u, PagedPool);
  v22 = v27
...
LABEL_35:
  ...
  v13 = CVirtualAddressAllocator::AddVaRangeToVad((CVirtualAddressAllocator *)this, a2, v22, v26, v17);
  if ( v13 >= 0 )
  {
    VidMmiLogEndVaRangeMapping(
      (struct CVirtualAddressAllocator *)this,
...
LABEL_36:
  VIDMM_MAPPED_VA_RANGE::ReleaseVaRangeReference(v22);
LABEL_13:
  if ( v31 )
  {
    this[8] = 0LL;
