/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C00B3718
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1C0022BA0 (VidMmPurgeAllSegments.c)
 * Callees:
 ...
 *     ?AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z @ 0x1C00C0C24 (-AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z.c)
