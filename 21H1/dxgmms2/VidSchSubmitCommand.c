/*
 * XREFs of VidSchSubmitCommand @ 0x1C007E500
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiConvertDeferredWaits @ 0x1C0014EC8 (VidSchiConvertDeferredWaits.c)
 ...
 *     VidSchiAllocateHistoryBufferStorage @ 0x1C00D0D40 (VidSchiAllocateHistoryBufferStorage.c)
 */
...
LABEL_22:
  ...
  if ( !*((_BYTE *)a1 + 901) )
    VidSchiAcquirePrivateDataReference(
      (struct _VIDSCH_GLOBAL *)v6,
      (struct VIDSCH_FLIP_MULTIPLANE_OVERLAY2 *)(PoolWithTag + 210));
