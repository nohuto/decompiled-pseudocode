/*
 * XREFs of ?VidSchiExecuteMmIoFlipMultiPlaneOverlay3@@YAXPEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@AEAU_VIDSCH_CALL_EXECUTE_FLIP@@PEAW4_VIDSCH_FLIP_STATUS@@K@Z @ 0x1C002ACCC
 * Callers:
 ...
 *     VidSchiComputeFlipEntryStatusAfterFlip @ 0x1C002F404 (VidSchiComputeFlipEntryStatusAfterFlip.c)
