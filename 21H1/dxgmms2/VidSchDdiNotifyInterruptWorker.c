/*
 * XREFs of VidSchDdiNotifyInterruptWorker @ 0x1C000D330
 * Callers:
 ...
 *     ?VidSchiVerifyDriverReportedFenceId@@YAHPEAU_VIDSCH_NODE@@KHPEAK@Z @ 0x1C000E504 (-VidSchiVerifyDriverReportedFenceId@@YAHPEAU_VIDSCH_NODE@@KHPEAK@Z.c)
 *     VidSchiProcessIsrPreemptedPacket @ 0x1C000E610 (VidSchiProcessIsrPreemptedPacket.c)
 *     ?MapVidPnTargetToVidPnSource@ADAPTER_DISPLAY@@QEAAII@Z @ 0x1C002A27C (-MapVidPnTargetToVidPnSource@ADAPTER_DISPLAY@@QEAAII@Z.c)
 ...
 *     VidSchiProcessIsrGpuEngineTimeout @ 0x1C003B4A0 (VidSchiProcessIsrGpuEngineTimeout.c)
 *     VidSchiProcessIsrHwQueuePageFaulted @ 0x1C003B524 (VidSchiProcessIsrHwQueuePageFaulted.c)
 *     VidSchiProcessIsrMonitoredFenceSignaled @ 0x1C003B6A8 (VidSchiProcessIsrMonitoredFenceSignaled.c)
 *     VidSchiProcessIsrSchedulingLogFull @ 0x1C003B72C (VidSchiProcessIsrSchedulingLogFull.c)
 *     VidSchiProcessIsrSuspendContextCompleted @ 0x1C003B7B0 (VidSchiProcessIsrSuspendContextCompleted.c)
 */
...
LABEL_115:
      ...
      case 0xE:
        v51 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(
                *(ADAPTER_DISPLAY **)(*(_QWORD *)(SubmissionFenceId + 16) + 2672LL),
                a2->DmaCompleted.SubmissionFenceId);
        v55 = v51;
        if ( v51 == -1
