/*
 * XREFs of VidSchCollectDbgInfo @ 0x1C00D4FA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?VidSchiGetVSyncState@@YA?AW4VIDSCH_VSYNC_STATE@@PEAU_VIDSCH_GLOBAL@@I@Z @ 0x1C003C898 (-VidSchiGetVSyncState@@YA-AW4VIDSCH_VSYNC_STATE@@PEAU_VIDSCH_GLOBAL@@I@Z.c)
 *     VidSchiCaptureProcessName @ 0x1C003C8E8 (VidSchiCaptureProcessName.c)
