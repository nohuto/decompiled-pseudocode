/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C00913DC
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v28;
  v5 = 10000 * v26;
  dword_1C0051418 = 10000 * v28;
  dword_1C005140C = 10000 * v3;
  dword_1C0051414 = 10000 * v26;
  dword_1C0051410 = 10000 * v1;
  if ( 10000 * v26 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
