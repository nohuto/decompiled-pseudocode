 ...
 *     VidSchSetAbsolutePriorityContext @ 0x1C00D3B10 (VidSchSetAbsolutePriorityContext.c)
 * Callees:
 ...
 *     ?VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C002CF5C (-VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z.c)
 */
