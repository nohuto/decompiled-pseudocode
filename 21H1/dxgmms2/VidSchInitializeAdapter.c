/*
 * XREFs of VidSchInitializeAdapter @ 0x1C008D4D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0_VIDSCH_GLOBAL@@QEAA@XZ @ 0x1C001567C (--0_VIDSCH_GLOBAL@@QEAA@XZ.c)
  ...
  if ( a1 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)v11 + 10) = v12;
      ...
      if ( *(_BYTE *)(v6 + 2511) )
        *((_BYTE *)v11 + 51) = 1;
      *((_BYTE *)v11 + 45) = (*(_DWORD *)(v6 + 2032) & 2) != 0;
      *((_BYTE *)v11 + 44) = *(_BYTE *)(v6 + 2506);
      *((_BYTE *)v11 + 46) = (*(_DWORD *)(v6 + 2032) & 0x10) != 0;
      *((_BYTE *)v11 + 47) = (*(_DWORD *)(v6 + 2028) & 0x10) != 0;
      *((_BYTE *)v11 + 48) = (*(_DWORD *)(v6 + 2032) & 0x20) == 0;
      *((_BYTE *)v11 + 49) = (*(_DWORD *)(v6 + 2032) & 0x40) != 0;
      v13 = 14;
      *((_BYTE *)v11 + 53) = (**(_DWORD **)(v6 + 2576) & 0x40) != 0;
      if ( ((*(_DWORD *)(v6 + 2032) >> 7) & 0xF) != 0 && ((*(_DWORD *)(v6 + 2032) >> 7) & 0xFu) < 0xE )
        v13 = (*(_DWORD *)(v6 + 2032) >> 7) & 0xF;
      *((_DWORD *)v11 + 55) = v13;
      v14 = 0LL;
      *((_DWORD *)v11 + 36) = *(_DWORD *)(v6 + 2512);
      *((_BYTE *)v11 + 148) = *(_BYTE *)(v6 + 2618) != 0;
      *((_DWORD *)v11 + 38) = *(_DWORD *)(v6 + 2540);
      *((_BYTE *)v11 + 6504) = *(_BYTE *)(v6 + 2640) != 0;
      *((_BYTE *)v11 + 2132) = (*(_DWORD *)(v6 + 2544) & 0x10) != 0;
      ...
      *(_QWORD *)((char *)v11 + 68) = (unsigned int)v15;
      if ( (_DWORD)v15 )
      {
        ...
        do
        {
          v18 = *(unsigned __int16 *)(*(_QWORD *)(v6 + 2560) + v16);
          v16 += 360LL;
      ...
      *((_DWORD *)v11 + 630) = v25;
        ...
        && NonPagedPoolZeroedArray<unsigned __int64,2,811690326>::AllocateElements((_DWORD *)v11 + 148, v20) )
      {
        ...
        if ( *(_DWORD *)(v6 + 2024) < 0x1Fu )
          v28 = *(_DWORD *)(v6 + 2024);
        *((_DWORD *)v11 + 632) = v28;
        v30 = 8 * v29;
        *((_DWORD *)v11 + 612) ^= (*(_DWORD *)(v6 + 2028) ^ *((_DWORD *)v11 + 612)) & 8;
            ...
            if ( v35 )
            {
              ...
              *((_QWORD *)v11 + 35) = v36;
              if ( v36 )
              {
                ...
                *((_DWORD *)v11 + 613) = v37;
                *((_DWORD *)v11 + 614) = 5;
                if ( !*((_DWORD *)v11 + 615) && (*(_DWORD *)(v6 + 2028) & 0x40) == 0 )
                  *((_DWORD *)v11 + 615) = 1;
                if ( !*((_DWORD *)v11 + 616) )
                  *((_DWORD *)v11 + 616) = (*(_DWORD *)(*((_QWORD *)v11 + 2) + 2572LL) >= 2400) + 1;
                if ( !*((_DWORD *)v11 + 617) )
                  *((_DWORD *)v11 + 617) = 1;
...
LABEL_109:
                ...
                *((_BYTE *)v11 + 960) = 1;
                ...
                if ( !NonPagedPoolZeroedArray<_VIDSCH_INDEPENDENT_FLIP_STATE,1,962685270>::AllocateElements(
                        ...
                        v68) )
                {
                  _InterlockedAdd(&dword_1C00517D0, 1u);
                ...
                *((_QWORD *)v11 + 425) = 0LL;
                if ( v74 )
                {
                  ...
                  {
                    v76 = 0;
                    v77 = *(unsigned __int16 *)(360LL * v75 + *(_QWORD *)(v6 + 2560));
                    v122 = v77;
