/*
 * XREFs of VidSchSetInProcessPriorityHwContext @ 0x1C00D48A0
 * Callers:
 *     <none>
 * Callees:
 *     VidSchiUpdateDdiHwContextPriority @ 0x1C00D4ECC (VidSchiUpdateDdiHwContextPriority.c)
 */
...
__int64 __fastcall VidSchSetInProcessPriorityHwContext(__int64 a1, __int64 a2)
{
  ...
  {
    v2 = WdLogNewEntry5_WdAssertion(0LL, a2, 0LL);
    v3 = -1073741811;
