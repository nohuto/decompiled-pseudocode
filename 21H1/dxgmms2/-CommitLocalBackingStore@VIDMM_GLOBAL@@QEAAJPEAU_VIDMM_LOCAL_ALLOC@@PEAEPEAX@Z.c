/*
 * XREFs of ?CommitLocalBackingStore@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_LOCAL_ALLOC@@PEAEPEAX@Z @ 0x1C006DB70
 * Callers:
...
LABEL_33:
    ...
    else
    {
      ...
      if ( (unsigned __int64)a4 >= MmUserProbeAddress )
      {
        ...
        v29 = WdLogNewEntry5_WdAssertion(v11, v13, v10);
        *(_QWORD *)(v29 + 24) = 28699LL;
      }
      else
      {
        v29 = WdLogNewEntry5_WdAssertion(v11, v13, v10);
        *(_QWORD *)(v29 + 24) = 28686LL;
      }
    }
