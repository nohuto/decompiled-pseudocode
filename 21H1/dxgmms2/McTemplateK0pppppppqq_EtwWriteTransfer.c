/*
 * XREFs of McTemplateK0pppppppqq_EtwWriteTransfer @ 0x1C0027F68
 * Callers:
 ...
 *     ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00C2F78 (-ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ.c)
 * Callees:
