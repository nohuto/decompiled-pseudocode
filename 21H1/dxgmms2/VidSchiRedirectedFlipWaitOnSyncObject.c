/*
 * XREFs of VidSchiRedirectedFlipWaitOnSyncObject @ 0x1C00309B0
 * Callers:
 *     VidSchSubmitCommandContextless @ 0x1C0035940 (VidSchSubmitCommandContextless.c)
 * Callees:
...
__int64 __fastcall VidSchiRedirectedFlipWaitOnSyncObject(struct _VIDSCH_GLOBAL *a1, char *Src, __int64 a3, _DWORD *a4)
{
  ...
  v7 = 0;
  v8 = *(_QWORD *)&Src[*((_DWORD *)Src + 143) * ((8 * *((_DWORD *)Src + 144) + 199) & 0xFFFFFFF8) + 616];
  if ( v8 )
...
LABEL_22:
      ...
      VidSchiAcquirePrivateDataReference(a1, (struct VIDSCH_FLIP_MULTIPLANE_OVERLAY2 *)(Src + 568));
      v19 = *((_QWORD *)Src + 4);
      if ( v19 )
  ...
  else
  {
          ...
          (v22 = (PSLIST_ENTRY)v24(v26, v23, v25, (char *)a1 + 864)) != 0LL) )
    {
      *((_QWORD *)&v22->Next + 1) = a3;
      ...
      VidSchiAcquirePrivateDataReference(a1, (struct VIDSCH_FLIP_MULTIPLANE_OVERLAY2 *)&v22[38]);
