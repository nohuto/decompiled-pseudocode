/*
 * XREFs of VidSchiCreateContextInternal @ 0x1C000FF50
 * Callers:
 ...
 *     VidSchSetPriorityContext @ 0x1C007FAD0 (VidSchSetPriorityContext.c)
 *     VidSchTerminateContext @ 0x1C0080250 (VidSchTerminateContext.c)
 */
      ...
      *((_QWORD *)v8 + 60) = v20;
      ...
      if ( (*a2 & 0x604) != 0 )
      {
        if ( (v21 & 1) != 0 )
        {
          ...
          v39 = *(_QWORD *)(a1 + 16);
          LODWORD(v56[1]) = v56[1] & 0xFFFFFFE2 | ((v21 & 4 | ((v21 & 0x200 | (v21 >> 1) & 0x400) >> 4)) >> 2) | (4 * (*(_BYTE *)(360LL * *(unsigned __int16 *)(v53 + 6) + *(_QWORD *)(*(_QWORD *)(v38 + 16) + 2560LL) + 48) & 1));
