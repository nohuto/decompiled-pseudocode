/*
 * XREFs of ?UpdateGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@IEAAJPEAUVIDSCH_DEVICE_COMMAND_UPDATEGPUVA@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00B61F0
 * Callers:
 ...
 *     VidSchGetPagingContext @ 0x1C0034F20 (VidSchGetPagingContext.c)
