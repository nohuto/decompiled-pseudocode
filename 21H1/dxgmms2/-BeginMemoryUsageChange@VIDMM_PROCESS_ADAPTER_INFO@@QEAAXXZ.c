/*
 * XREFs of ?BeginMemoryUsageChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C0064CA0
 * Callers:
...
void __fastcall VIDMM_PROCESS_ADAPTER_INFO::BeginMemoryUsageChange(VIDMM_PROCESS_ADAPTER_INFO *this)
{
  ...
  v1 = 0;
  if ( bTracingEnabled && *(_DWORD *)(*(_QWORD *)this + 7000LL) )
  {
    do
    {
      v3 = v1++;
    ...
    while ( v1 < *(_DWORD *)(*(_QWORD *)this + 7000LL) );
  }
}
