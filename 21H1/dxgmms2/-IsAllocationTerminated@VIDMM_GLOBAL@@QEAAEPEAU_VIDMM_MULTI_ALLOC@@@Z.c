/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00B1FB0
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0022AE0 (VidMmIsAllocationTerminated.c)
 * Callees:
