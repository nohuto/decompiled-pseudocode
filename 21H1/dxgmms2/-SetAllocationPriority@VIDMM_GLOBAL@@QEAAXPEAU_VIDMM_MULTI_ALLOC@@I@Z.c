/*
 * XREFs of ?SetAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00B4B88
 * Callers:
 *     VidMmSetAllocationPriority @ 0x1C0022D50 (VidMmSetAllocationPriority.c)
 * Callees:
