/*
 * XREFs of ?ReserveResource@VIDMM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EEEW4_VIDMM_PLACEMENT_RESTRICTION@@_K@Z @ 0x1C0064580
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  _QWORD *v41; // rax
  unsigned __int64 v42; // [rsp+20h] [rbp-98h]
  int v43; // [rsp+28h] [rbp-90h]
  int v44; // [rsp+30h] [rbp-88h]
  int v45; // [rsp+40h] [rbp-78h]
  unsigned __int64 v46; // [rsp+68h] [rbp-50h]
  unsigned __int64 v47; // [rsp+70h] [rbp-48h]
  unsigned int v48; // [rsp+C0h] [rbp+8h]
  __int64 v49; // [rsp+C8h] [rbp+10h]
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0qpxxtqqq_EtwWriteTransfer(a1, a2, a3, *(_DWORD *)(a1 + 16) + 1, a2, v43, v44, a4, v45, a6);
...
LABEL_15:
      ...
      *(_QWORD *)(a1 + 224) += *(_QWORD *)(a2 + 16);
      ...
      {
        v40 = *(_QWORD *)(a1 + 232);
        v14 = v40 + *(_QWORD *)(a2 + 16);
        *(_QWORD *)(a1 + 232) = v14;
        if ( v40 <= qword_1C0051498 && v14 > qword_1C0051498 )
...
LABEL_24:
      *(_QWORD *)(a2 + 216) = a1;
      if ( g_IsInternalReleaseOrDbg )
      {
        v41 = (_QWORD *)WdLogNewEntry5_WdTrace(v14);
        v41[3] = *(_QWORD *)(a2 + 200);
        v41[4] = *(int *)(a2 + 212);
...
LABEL_44:
  ...
  v25 = (*(_QWORD *)(a1 + 416) - v11) & ~((v49 - 1) | *(_QWORD *)(a1 + 400));
