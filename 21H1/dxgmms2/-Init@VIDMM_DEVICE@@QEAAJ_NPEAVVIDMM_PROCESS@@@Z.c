/*
 * XREFs of ?Init@VIDMM_DEVICE@@QEAAJ_NPEAVVIDMM_PROCESS@@@Z @ 0x1C00819A8
 * Callers:
 *     VidMmInitDevice @ 0x1C00117C0 (VidMmInitDevice.c)
...
LABEL_38:
    ...
    *((_QWORD *)this + 28) = qword_1C0051458 + v36 * KeQueryTimeIncrement();
    return 0LL;
  }
  return result;
}
