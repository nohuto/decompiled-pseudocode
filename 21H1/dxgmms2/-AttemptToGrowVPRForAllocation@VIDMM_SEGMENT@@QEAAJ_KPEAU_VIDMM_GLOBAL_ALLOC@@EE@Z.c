/*
 * XREFs of ?AttemptToGrowVPRForAllocation@VIDMM_SEGMENT@@QEAAJ_KPEAU_VIDMM_GLOBAL_ALLOC@@EE@Z @ 0x1C00C74F0
 * Callers:
        ...
        char a5)
{
  ...
  else
  {
    ...
    if ( v11 < 0 )
    {
      v19 = *((_QWORD *)this + 1);
      v20 = *(_QWORD *)(v19 + 24);
      if ( (*(_DWORD *)(360LL * *((unsigned int *)this + 95) + *(_QWORD *)(v20 + 2560) + 16) & 4) != 0 )
      {
