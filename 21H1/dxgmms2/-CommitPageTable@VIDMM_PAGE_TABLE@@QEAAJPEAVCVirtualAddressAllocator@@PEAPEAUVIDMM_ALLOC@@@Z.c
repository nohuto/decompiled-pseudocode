/*
 * XREFs of ?CommitPageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C005F758
 * Callers:
    ...
    *(_BYTE *)(*((_QWORD *)this + 1) + 89LL) = 0;
    ...
    else if ( v10 >= 0 )
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)(v11 + 128) + 80LL) & 0x1000) != 0 )
        *(_QWORD *)(*((_QWORD *)this + 1) + 136LL) = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(*(_QWORD *)(v11 + 96) + 8LL) + 24LL)
                                                                                               + 104LL))(
