/*
 * XREFs of VidSchiCheckNodeTimeout @ 0x1C007F400
 * Callers:
 ...
 *     VidSchiSchedulerNodeToDriverNode @ 0x1C00318F4 (VidSchiSchedulerNodeToDriverNode.c)
 */
...
__int64 __fastcall VidSchiCheckNodeTimeout(struct _VIDSCH_NODE *a1, _QWORD *a2)
{
  ...
  if ( (*((_DWORD *)a1 + 110) & 2) == 0 && !*((_DWORD *)a1 + 505) && !*((_DWORD *)a1 + 506) )
  {
    if ( (*((_DWORD *)a1 + 3) & 2) != 0 )
    {
      if ( !*((_DWORD *)a1 + 426) && !*(_DWORD *)(*((_QWORD *)a1 + 3) + 64LL) )
        goto LABEL_6;
    }
    else if ( !*((_DWORD *)a1 + 720) )
    {
LABEL_6:
      *((_DWORD *)a1 + 110) &= ~1u;
      return (*((_DWORD *)a1 + 110) >> 1) & 1;
    }
    v5 = _InterlockedExchange((volatile __int32 *)a1 + 120, 0);
    if ( (*((_DWORD *)a1 + 110) & 1) == 0 || v5 )
    {
      if ( (*((_DWORD *)a1 + 3) & 2) != 0 )
        v10 = *((_QWORD *)a1 + 215);
      else
    ...
    *((_QWORD *)a1 + 57) = MEMORY[0xFFFFF78000000320];
    ...
    if ( v8 * (unsigned __int64)KeQueryTimeIncrement() <= v9 )
      return (*((_DWORD *)a1 + 110) >> 1) & 1;
    v12 = *((_QWORD *)a1 + 3);
    if ( (*(_DWORD *)(*(_QWORD *)(v12 + 16) + 348LL) & 0x200) != 0 )
    {
      v13 = __rdtsc();
