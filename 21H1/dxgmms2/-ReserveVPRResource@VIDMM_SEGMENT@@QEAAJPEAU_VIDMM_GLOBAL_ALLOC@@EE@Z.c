/*
 * XREFs of ?ReserveVPRResource@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EE@Z @ 0x1C00CA304
 * Callers:
        ...
        char a4)
{
  ...
  if ( (int)v9 < 0 )
  {
    ...
    if ( (int)v9 < 0 )
    {
      if ( *((_QWORD *)this + 55) + v26 < (unsigned __int64)(unsigned int)dword_1C00514C8
                                        * *((_QWORD *)this + 54)
                                        / (unsigned int)dword_1C00514CC )
      {
        v17 = v4;
        v18 = (VIDMM_GLOBAL *)*((_QWORD *)this + 1);
        v28 = 0;
        if ( (*(_DWORD *)(360LL * *((unsigned int *)this + 95) + *(_QWORD *)(*((_QWORD *)v18 + 3) + 2560LL) + 16) & 4) != 0 )
        {
      ...
      else
      {
        ...
        if ( (int)v9 < 0 )
        {
          ...
          if ( (*(_DWORD *)(360LL * *((unsigned int *)this + 95) + *(_QWORD *)(*((_QWORD *)v10 + 3) + 2560LL) + 16) & 4) != 0 )
          {
