/*
 * XREFs of VidSchiReadNodeConfiguration @ 0x1C008F410
 * Callers:
...
__int64 __fastcall VidSchiReadNodeConfiguration(__int64 a1, __int64 a2)
{
  ...
  ResultLength = 0;
  ValueName = 0LL;
  v5 = DpiOpenPnpRegistryKey(*(_QWORD *)(v2 + 216));
  if ( v5 >= 0 )
  {
    v6 = 0x7FFFLL;
    ...
    if ( v9 == -2147483643 || v9 == -1073741789 )
    {
      ...
      if ( !is_mul_ok(ResultLength, 4uLL) )
        v11 = -1LL;
      v12 = operator new[](v11, 0x31616956u, PagedPool);
      if ( v12 )
      {
        ...
        if ( v5 >= 0 )
        {
          if ( v12[1] != 3
            ...
            || v13 > 4 * (unsigned __int64)*(unsigned int *)(a1 + 72) )
          {
            v5 = -1073741811;
          }
          else
