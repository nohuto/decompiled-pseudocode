/*
 * XREFs of ?PerformDefragmentationEscape@VIDMM_GLOBAL@@QEAAXW4_D3DKMT_DEFRAG_ESCAPE_OPERATION@@IPEA_K111@Z @ 0x1C00B31B4
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( a2 <= 2 )
  {
    ...
    while ( 1 )
    {
      if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 2560LL) + 360LL * v8 + 16) & 4) == 0 )
        goto LABEL_23;
...
LABEL_23:
  ...
  if ( a2 <= 4 )
  {
    ...
    {
      v7 = *((_QWORD *)this + 3);
      if ( (*(_DWORD *)(360LL * i + *(_QWORD *)(v7 + 2560) + 16) & 4) != 0 && (*(_DWORD *)(v7 + 2028) & 8) != 0 )
      {
        memset(v15, 0, 0x58uLL);
        LODWORD(v15[0]) = 126;
        HIDWORD(v15[0]) = i;
