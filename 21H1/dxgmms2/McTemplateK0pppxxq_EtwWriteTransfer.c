/*
 * XREFs of McTemplateK0pppxxq_EtwWriteTransfer @ 0x1C00244A0
 * Callers:
...
NTSTATUS McTemplateK0pppxxq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventMemoryTransfer, a3, 7u, &v4);
}
