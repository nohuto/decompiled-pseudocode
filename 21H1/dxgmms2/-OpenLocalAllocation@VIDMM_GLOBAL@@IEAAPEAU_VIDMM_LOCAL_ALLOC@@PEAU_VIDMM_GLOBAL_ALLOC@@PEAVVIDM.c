/*
 * XREFs of ?OpenLocalAllocation@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_PROCESS@@PEAXPEAE@Z @ 0x1C006B870
 * Callers:
...
LABEL_9:
    ...
    if ( !v12 )
    {
      _InterlockedIncrement(&dword_1C0051680);
