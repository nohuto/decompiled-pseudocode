/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x1C00B7D3C
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1C0022DF0 (VidMmTerminateCompanionContext.c)
 * Callees:
