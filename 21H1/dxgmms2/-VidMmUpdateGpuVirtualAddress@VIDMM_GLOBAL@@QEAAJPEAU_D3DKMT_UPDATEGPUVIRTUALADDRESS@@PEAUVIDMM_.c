/*
 * XREFs of ?VidMmUpdateGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAU_D3DKMT_UPDATEGPUVIRTUALADDRESS@@PEAUVIDMM_COMPANION_CONTEXT@@IPEAPEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDSCH_SYNC_OBJECT@@PEAPEAU_KSEMAPHORE@@@Z @ 0x1C00B80F4
 * Callers:
 *     VidMmUpdateGpuVirtualAddress @ 0x1C0022ED0 (VidMmUpdateGpuVirtualAddress.c)
 * Callees:
 ...
 *     ?IsRangeValid@@YAE_K00@Z @ 0x1C00B1FE0 (-IsRangeValid@@YAE_K00@Z.c)
 ...
 *     ?ReferenceReservedZeroVad@CVirtualAddressAllocator@@QEAAPEAUVIDMM_VAD@@_K0@Z @ 0x1C00C056C (-ReferenceReservedZeroVad@CVirtualAddressAllocator@@QEAAPEAUVIDMM_VAD@@_K0@Z.c)
 */
