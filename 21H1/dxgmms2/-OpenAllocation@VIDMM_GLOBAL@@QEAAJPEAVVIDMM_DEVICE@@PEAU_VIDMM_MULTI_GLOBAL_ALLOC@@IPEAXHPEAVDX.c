/*
 * XREFs of ?OpenAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@IPEAXHPEAVDXGALLOCATION@@PEAPEAU_VIDMM_MULTI_ALLOC@@PEAIPEAE@Z @ 0x1C006A314
 * Callers:
 *     VidMmOpenAllocation @ 0x1C0001930 (VidMmOpenAllocation.c)
 * Callees:
