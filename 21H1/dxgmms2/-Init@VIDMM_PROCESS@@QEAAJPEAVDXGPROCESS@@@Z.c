/*
 * XREFs of ?Init@VIDMM_PROCESS@@QEAAJPEAVDXGPROCESS@@@Z @ 0x1C0076974
 * Callers:
 ...
 *     ??0VIDMM_PROCESS_FENCE_STORAGE@@QEAA@PEAVVIDMM_PROCESS@@@Z @ 0x1C0077430 (--0VIDMM_PROCESS_FENCE_STORAGE@@QEAA@PEAVVIDMM_PROCESS@@@Z.c)
 *     ??0VIDMM_PROCESS_HEAP@@QEAA@XZ @ 0x1C00CCB8C (--0VIDMM_PROCESS_HEAP@@QEAA@XZ.c)
 */
...
__int64 __fastcall VIDMM_PROCESS::Init(struct _RTL_BALANCED_NODE **this, struct _RTL_BALANCED_NODE *a2)
{
  ...
  *this = v6;
  ...
  if ( !v9 )
  {
    _InterlockedIncrement(&dword_1C00516F8);
