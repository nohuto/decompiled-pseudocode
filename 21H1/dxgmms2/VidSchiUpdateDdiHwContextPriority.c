/*
 * XREFs of VidSchiUpdateDdiHwContextPriority @ 0x1C00D4ECC
 * Callers:
 ...
 *     VidSchSetAbsolutePriorityHwContext @ 0x1C00D4730 (VidSchSetAbsolutePriorityHwContext.c)
 *     VidSchSetInProcessPriorityHwContext @ 0x1C00D48A0 (VidSchSetInProcessPriorityHwContext.c)
 *     VidSchSetPriorityHwContext @ 0x1C00D4940 (VidSchSetPriorityHwContext.c)
 * Callees:
...
LABEL_15:
  ...
  return ADAPTER_RENDER::DdiSetContextSchedulingProperties(*(ADAPTER_RENDER **)(*(_QWORD *)(v3 + 16) + 2680LL), &v8);
}
