/*
 * XREFs of VidSchiProcessDpcCompletedPacket @ 0x1C0008B90
 * Callers:
 ...
 *     ?VidSchiAllowToDebugPageFault@@YAXPEAU_VIDSCH_DMA_PACKET@@@Z @ 0x1C002A56C (-VidSchiAllowToDebugPageFault@@YAXPEAU_VIDSCH_DMA_PACKET@@@Z.c)
 ...
 *     ?VidSchiQueueDeferredVisibilityWorkItem@@YAXPEAU_VIDSCH_PRESENT_INFO@@PEAU_VIDSCH_GLOBAL@@@Z @ 0x1C002BDCC (-VidSchiQueueDeferredVisibilityWorkItem@@YAXPEAU_VIDSCH_PRESENT_INFO@@PEAU_VIDSCH_GLOBAL@@@Z.c)
  ...
  *(_DWORD *)(v4 + 1552) = ((_BYTE)v13 + 1) & 0xF;
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 788), 0xFFFFFFFF) == 1 )
  {
    *(_DWORD *)(v1 + 184) &= ~2u;
    ...
    {
      VidSchiUpdateContextStatus(v1, 0LL, 11244LL);
    }
      ...
      if ( v63 >= *(_QWORD *)(v59 + 2688) )
      {
        ...
        if ( v63 >= *(_QWORD *)(v59 + 2672) && !*(_BYTE *)(*(_QWORD *)(v131 + 40) + 2624LL) )
        {
            ...
            && (*(_DWORD *)(v59 + 2448) & 0x200) != 0 )
          {
            ...
            VidSchiUpdateContextStatus(v1, 7uLL, 26664LL);
            if ( bTracingEnabled )
            {
              v79 = *(_QWORD *)(v1 + 56);
