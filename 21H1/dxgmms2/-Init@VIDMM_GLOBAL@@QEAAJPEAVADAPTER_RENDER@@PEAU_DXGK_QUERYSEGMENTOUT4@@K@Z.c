/*
 * XREFs of ?Init@VIDMM_GLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAU_DXGK_QUERYSEGMENTOUT4@@K@Z @ 0x1C0093CB8
 * Callers:
 ...
 *     ?InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBUDXGADAPTER_GPUMMUCAPS@@PEBUDXGK_PHYSICALADAPTERINFO@@I@Z @ 0x1C00B1548 (-InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBU.c)
...
LABEL_47:
            ...
            if ( (int)v45 >= 0 )
            {
              ...
              *((_QWORD *)this + 989) = MEMORY[0xFFFFF78000000014];
              ...
              v76 = (_QWORD *)qword_1C0051848;
              v77 = (_QWORD *)((char *)this + 44712);
              if ( *(struct _LIST_ENTRY **)qword_1C0051848 != &VIDMM_GLOBAL::_AdapterListHead )
                __fastfail(3u);
              *v77 = &VIDMM_GLOBAL::_AdapterListHead;
              v77[1] = v76;
              *v76 = v77;
              qword_1C0051848 = (__int64)v77;
...
LABEL_86:
  ...
  _InterlockedIncrement(&dword_1C00516CC);
