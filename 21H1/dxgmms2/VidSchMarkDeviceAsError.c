 ...
 *     VidSchInvalidateHwContext @ 0x1C0039FC0 (VidSchInvalidateHwContext.c)
 ...
 *     ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B70A0 (-ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z.c)
 ...
 *     VidSchiMarkDevicesInError @ 0x1C00D1340 (VidSchiMarkDevicesInError.c)
