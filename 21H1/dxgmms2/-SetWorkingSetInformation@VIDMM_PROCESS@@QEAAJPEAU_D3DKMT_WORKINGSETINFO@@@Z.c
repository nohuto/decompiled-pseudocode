/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00BBC0C
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C0022D90 (VidMmSetWorkingSetInformation.c)
 * Callees:
