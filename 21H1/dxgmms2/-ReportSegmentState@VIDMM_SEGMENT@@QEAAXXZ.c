/*
 * XREFs of ?ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00C9E54
 * Callers:
      ...
      do
      {
        ...
        if ( *v10 != v10 )
        {
          ...
          do
          {
            ...
            v11 = (_QWORD *)*v11;
            v14 = **v13;
            if ( *(VIDMM_SEGMENT **)(v14 + 128) == this )
            {
              a3 = *(_DWORD *)(*(_QWORD *)(v14 + 496) + 12LL) != 0;
              if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
              {
                LODWORD(v19) = *((_DWORD *)this + 4) + 1;
                LODWORD(v18) = 0;
                LODWORD(v17) = *(_DWORD *)(*(_QWORD *)(v14 + 496) + 12LL) != 0;
