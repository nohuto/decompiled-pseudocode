/*
 * XREFs of ?IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@PEAI@Z @ 0x1C00B1E1C
 * Callers:
 *     VidMmIsAllocationInPresentQueue @ 0x1C0022AC0 (VidMmIsAllocationInPresentQueue.c)
