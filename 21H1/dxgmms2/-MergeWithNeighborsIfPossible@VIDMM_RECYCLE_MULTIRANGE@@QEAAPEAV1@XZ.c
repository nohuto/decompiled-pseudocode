/*
 * XREFs of ?MergeWithNeighborsIfPossible@VIDMM_RECYCLE_MULTIRANGE@@QEAAPEAV1@XZ @ 0x1C007D5B0
 * Callers:
 ...
 *     ?Init@VIDMM_RECYCLE_MULTIRANGE@@QEAAXW4VIDMM_RECYCLE_MULTIRANGE_STATE@@PEAVVIDMM_RECYCLE_BLOCK@@_K2@Z @ 0x1C0085BB8 (-Init@VIDMM_RECYCLE_MULTIRANGE@@QEAAXW4VIDMM_RECYCLE_MULTIRANGE_STATE@@PEAVVIDMM_RECYCLE_BLOCK@@.c)
  ...
  if ( v7 )
  {
    if ( v12 )
    {
      ...
      *(_QWORD *)(v12 + 224) = 0LL;
      ...
      if ( v2 )
        VIDMM_RECYCLE_MULTIRANGE::Init(v2, v4, v3, v106, v104);
      v2[4].Next = v108;
