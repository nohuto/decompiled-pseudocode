/*
 * XREFs of ?AllocateVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAU_RTL_AVL_TREE@@_K111IPEAPEAUVIDMM_VAD@@E@Z @ 0x1C0070C40
 * Callers:
...
LABEL_33:
      ...
      _InterlockedAdd(&dword_1C005179C, 1u);
