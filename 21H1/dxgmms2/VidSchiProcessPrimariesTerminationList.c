/*
 * XREFs of VidSchiProcessPrimariesTerminationList @ 0x1C0030778
 * Callers:
 *     VidSchiDrainContextFromWorkerThread @ 0x1C002F634 (VidSchiDrainContextFromWorkerThread.c)
 *     VidSchiCleanupPacket_PriorityTable @ 0x1C00D5948 (VidSchiCleanupPacket_PriorityTable.c)
 * Callees:
 *     VidSchiCheckConditionDeviceCommand @ 0x1C00136F8 (VidSchiCheckConditionDeviceCommand.c)
 *     ?AddPendingTermination@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C002328C (-AddPendingTermination@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
 */
