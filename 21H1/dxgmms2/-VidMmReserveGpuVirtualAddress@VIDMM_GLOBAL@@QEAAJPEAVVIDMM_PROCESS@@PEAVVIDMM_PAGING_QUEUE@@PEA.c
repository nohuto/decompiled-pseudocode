/*
 * XREFs of ?VidMmReserveGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAVVIDMM_PAGING_QUEUE@@PEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x1C00B7AA0
 * Callers:
 *     VidMmReserveGpuVirtualAddress @ 0x1C0022CE0 (VidMmReserveGpuVirtualAddress.c)
 * Callees:
...
LABEL_7:
  ...
  if ( !VirtualAddressAllocator )
  {
    ...
    *(_QWORD *)(v10 + 24) = 20458LL;
    goto LABEL_7;
  }
  v19 = 0x10000;
  if ( *(int *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 2572LL) >= 2400
