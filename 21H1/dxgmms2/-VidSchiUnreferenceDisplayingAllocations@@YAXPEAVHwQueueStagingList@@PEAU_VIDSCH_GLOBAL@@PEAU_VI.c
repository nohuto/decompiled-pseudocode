/*
 * XREFs of ?VidSchiUnreferenceDisplayingAllocations@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@G@Z @ 0x1C0004200
 * Callers:
 ...
 *     VidSchiUnreferenceDisplayingAllocationsForThisEntry @ 0x1C003220C (VidSchiUnreferenceDisplayingAllocationsForThisEntry.c)
 * Callees:
    ...
    if ( v40 )
    {
      ...
      if ( v19 )
      {
        ...
        while ( v21 != (_QWORD *)(v19 + 72) )
        {
          ...
          {
            *((_DWORD *)v22 + 46) &= ~0x10u;
            v23 = (unsigned __int8)VidSchiUnwaitContext(v22, 21374LL, a3);
          }
          v21 = (_QWORD *)*v21;
          v20 |= v23;
        }
