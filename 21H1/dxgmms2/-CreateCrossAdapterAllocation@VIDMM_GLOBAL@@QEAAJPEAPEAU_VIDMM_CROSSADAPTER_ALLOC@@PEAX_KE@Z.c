/*
 * XREFs of ?CreateCrossAdapterAllocation@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAX_KE@Z @ 0x1C00AF898
 * Callers:
 *     VidMmCreateCrossAdapterAllocation @ 0x1C00229C0 (VidMmCreateCrossAdapterAllocation.c)
 * Callees:
        ...
        unsigned __int8 a5)
{
  ...
  if ( !a3 || a5 || (v6 = MmSecureVirtualMemory(a3, a4, 4u)) != 0LL )
  {
    ...
    *a2 = (struct _VIDMM_CROSSADAPTER_ALLOC *)v15;
    ...
    {
      _InterlockedIncrement(&dword_1C00517CC);
