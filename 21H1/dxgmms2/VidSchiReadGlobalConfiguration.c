/*
 * XREFs of VidSchiReadGlobalConfiguration @ 0x1C008E69C
 * Callers:
...
bool __fastcall VidSchiReadGlobalConfiguration(__int64 a1)
{
  ...
  v73 = 64;
  v106 = v2;
  v6 = __OFSUB__(*(_DWORD *)(v3 + 2572), 2000);
  v5 = *(_DWORD *)(v3 + 2572) - 2000 < 0;
  v56 = 0;
  v49 = 25000;
  v110 = v5 == v6;
  v81 = v110;
  ...
  v80 = 0;
  v48 = v2;
  if ( *(int *)(v3 + 2572) >= 1300 && *(_BYTE *)(v3 + 2509) )
  {
    v54 = 1;
    v53 = 1;
  }
