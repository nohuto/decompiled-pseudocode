/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C009387C
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_1C0051500 = v2;
  dword_1C0051504 = v8 << 20;
  dword_1C0051508 = v3;
  dword_1C005150C = v4;
  if ( !v1 )
    qword_1C00511F0 = (unsigned __int64)qword_1C00511D8 >> 3;
}
