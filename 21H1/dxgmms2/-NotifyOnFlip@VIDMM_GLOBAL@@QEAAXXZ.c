/*
 * XREFs of ?NotifyOnFlip@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C000E4B8
 * Callers:
...
void __fastcall VIDMM_GLOBAL::NotifyOnFlip(VIDMM_GLOBAL *this)
{
  ...
  v2 = *((_DWORD *)this + 1974);
  if ( *((_QWORD *)this + 986) > (unsigned __int64)qword_1C0051320 )
  {
    v3 = v2 + dword_1C005132C;
    *((_DWORD *)this + 1974) = v2 + dword_1C005132C;
    if ( v3 > dword_1C0051328
      && MEMORY[0xFFFFF78000000014] - *((_QWORD *)this + 988) > (unsigned __int64)qword_1C0051330 )
    {
