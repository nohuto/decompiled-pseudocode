/*
 * XREFs of VidSchiOpenProcessAdapterInfo @ 0x1C007F764
 * Callers:
 ...
 *     ??_GVIDSCH_PROCESS_ADAPTER_INFO@@QEAAPEAXI@Z @ 0x1C0014088 (--_GVIDSCH_PROCESS_ADAPTER_INFO@@QEAAPEAXI@Z.c)
    ...
    for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a2 + 72); i = (unsigned int)(i + 1) )
    {
      ...
      *v19 = ExAllocatePoolWithTag((POOL_TYPE)512, 0xE0uLL, 0x32616956u);
      ...
      if ( (unsigned int)i >= *(_DWORD *)(a2 + 696) )
        v24 = *(_QWORD *)(a2 + 624);
      v25 = (int *)(*(_QWORD *)(360LL * *(unsigned __int16 *)(*(_QWORD *)v24 + 6LL) + *(_QWORD *)(v23 + 2560) + 32)
