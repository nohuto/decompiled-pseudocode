/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00B8CA8
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C0022F30 (VidMmWaitOnAllocationPresentQueue.c)
