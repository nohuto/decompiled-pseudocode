/*
 * XREFs of ?Flush@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C00BA414
 * Callers:
 ...
 * Callees:
 *     ?TransitionToState@VIDMM_WORKER_THREAD@@QEAAXW4VIDMM_WORKER_THREAD_STATUS@@@Z @ 0x1C0087F44 (-TransitionToState@VIDMM_WORKER_THREAD@@QEAAXW4VIDMM_WORKER_THREAD_STATUS@@@Z.c)
 */
