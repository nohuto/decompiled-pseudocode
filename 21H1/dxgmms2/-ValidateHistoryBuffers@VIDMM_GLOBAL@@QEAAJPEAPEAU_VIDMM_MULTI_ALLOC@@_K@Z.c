/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B70A0
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C0022F10 (VidMmValidateHistoryBuffers.c)
 * Callees:
