/*
 * XREFs of ?VidSchiPostponePresentHistoryToken@@YAXPEAU_VIDSCH_CONTEXT@@PEAUVIDSCH_HW_QUEUE@@PEAU_VIDSCH_DEVICE@@PEAUVIDSCH_SUBMIT_DATA2@@T_ULARGE_INTEGER@@PEAU_VIDSCH_GLOBAL@@@Z @ 0x1C002B774
 * Callers:
        ...
        struct _VIDSCH_GLOBAL *a6)
{
  ...
  v6 = (struct VIDSCH_SUBMIT_DATA2 *)((char *)a4 + 568);
  v24 = *((_DWORD *)a4 + 29);
  v8 = 0LL;
  v13 = *((_DWORD *)a4 + 142) & 0x3FF;
  v11 = -1;
  ...
  *(_QWORD *)(v19 + 24) = *((_QWORD *)a4 + 13);
  ...
  if ( PoolWithTag )
  {
    ...
    VidSchiAcquirePrivateDataReference(a6, (struct VIDSCH_FLIP_MULTIPLANE_OVERLAY2 *)(PoolWithTag + 77));
