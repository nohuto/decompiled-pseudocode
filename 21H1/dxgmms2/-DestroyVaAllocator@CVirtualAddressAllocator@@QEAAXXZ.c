/*
 * XREFs of ?DestroyVaAllocator@CVirtualAddressAllocator@@QEAAXXZ @ 0x1C0084B98
 * Callers:
 ...
 *     ?FreeVadAvl@@YAXPEAU_RTL_BALANCED_NODE@@PEAX@Z @ 0x1C00882AC (-FreeVadAvl@@YAXPEAU_RTL_BALANCED_NODE@@PEAX@Z.c)
 */
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x80000) != 0 )
      McTemplateK0ppp_EtwWriteTransfer(
        ...
        *(_QWORD *)(*(_QWORD *)(v5 + 32) + 64LL),
        this,
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v5 + 32) + 64LL) + 72LL),
