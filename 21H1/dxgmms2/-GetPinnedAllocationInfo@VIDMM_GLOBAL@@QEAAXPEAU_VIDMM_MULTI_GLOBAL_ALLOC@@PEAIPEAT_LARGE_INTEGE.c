/*
 * XREFs of ?GetPinnedAllocationInfo@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAIPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1C00B144C
 * Callers:
 *     VidMmGetPinnedAllocationInfo @ 0x1C0022A60 (VidMmGetPinnedAllocationInfo.c)
 * Callees:
