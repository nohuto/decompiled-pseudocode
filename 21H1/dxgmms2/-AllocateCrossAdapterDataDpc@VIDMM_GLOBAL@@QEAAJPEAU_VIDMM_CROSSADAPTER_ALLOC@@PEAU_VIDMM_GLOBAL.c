/*
 * XREFs of ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0023374
 * Callers:
 ...
 *     VidSchGetRunEvent @ 0x1C0088820 (VidSchGetRunEvent.c)
 */
