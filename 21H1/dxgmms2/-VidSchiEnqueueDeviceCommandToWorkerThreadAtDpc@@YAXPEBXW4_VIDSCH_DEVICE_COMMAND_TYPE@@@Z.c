/*
 * XREFs of ?VidSchiEnqueueDeviceCommandToWorkerThreadAtDpc@@YAXPEBXW4_VIDSCH_DEVICE_COMMAND_TYPE@@@Z @ 0x1C002AB74
 * Callers:
 ...
 *     VidSchiUpdatePriorityTables @ 0x1C003277C (VidSchiUpdatePriorityTables.c)
 */
