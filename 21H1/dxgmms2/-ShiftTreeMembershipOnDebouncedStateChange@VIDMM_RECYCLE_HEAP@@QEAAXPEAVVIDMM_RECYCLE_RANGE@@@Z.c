/*
 * XREFs of ?ShiftTreeMembershipOnDebouncedStateChange@VIDMM_RECYCLE_HEAP@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C0078774
 * Callers:
...
LABEL_4:
  ...
  if ( v7 < v8 )
  {
    if ( v9 > v10 )
    {
      ...
      v14 = *(_QWORD *)(v6 + 72);
      Multirange = VIDMM_RECYCLE_HEAP_MGR::CreateMultirange(this[1], *(unsigned int *)(v6 + 216), *((_QWORD *)a2 + 9));
