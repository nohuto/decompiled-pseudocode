/*
 * XREFs of ?CloseAdapter@VIDMM_PROCESS@@QEAAXPEAVVIDMM_GLOBAL@@@Z @ 0x1C008278C
 * Callers:
 *     VidMmCloseAdapter @ 0x1C0011CD0 (VidMmCloseAdapter.c)
 ...
 *     ?ComputeNewWorkingSet@VIDMM_SEGMENT@@QEAAXK@Z @ 0x1C0082A08 (-ComputeNewWorkingSet@VIDMM_SEGMENT@@QEAAXK@Z.c)
