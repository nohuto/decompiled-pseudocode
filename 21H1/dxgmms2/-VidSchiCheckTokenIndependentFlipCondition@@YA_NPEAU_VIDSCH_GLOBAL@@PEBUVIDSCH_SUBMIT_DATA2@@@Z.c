/*
 * XREFs of ?VidSchiCheckTokenIndependentFlipCondition@@YA_NPEAU_VIDSCH_GLOBAL@@PEBUVIDSCH_SUBMIT_DATA2@@@Z @ 0x1C002A850
 * Callers:
        ...
        const struct VIDSCH_SUBMIT_DATA2 *a2)
{
  ...
  else
  {
    ...
    v5 = !_BitScanForward((unsigned int *)&v6, *((_DWORD *)a2 + 142) & 0x3FF);
    v7 = -1;
    if ( !v5 )
      v7 = v6;
    v8 = 0;
