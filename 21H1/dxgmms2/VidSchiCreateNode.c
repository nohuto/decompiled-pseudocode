/*
 * XREFs of VidSchiCreateNode @ 0x1C008E37C
 * Callers:
...
unsigned int *__fastcall VidSchiCreateNode(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  *((_QWORD *)v14 + 217) = 0LL;
  ...
  {
    v16 = *(_DWORD *)(a1 + 72) == 1
       || *(_WORD *)(360LL * (unsigned __int16)v8 + *(_QWORD *)(*(_QWORD *)(a1 + 16) + 2560LL) + 2) == (unsigned __int16)v7;
    v17 = 0;
    v18 = v16 | v14[3] & 0xFFFFFFFE;
    v14[3] = v18;
    v19 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 2560LL) + 360LL * (unsigned __int16)v8;
    if ( (*(_DWORD *)(v19 + 16) & 0x20) != 0 )
      LOBYTE(v17) = *(_DWORD *)(v19 + 24) == (unsigned __int16)v7;
    v20 = (4 * v17) | v18 & 0xFFFFFFFB;
    v14[3] = v20;
    v21 = 360 * v8;
    v22 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 2560LL) + 360 * v8 + 32);
    if ( v22 )
    ...
    if ( (v24 & 2) != 0 )
    {
      v34 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 2560LL) + v21 + 32);
      v35 = v34 ? 4 * (*(_BYTE *)(74 * v7 + v34 + 68) & 2) : 0;
      v24 = v35 | (unsigned int)v24 & 0xFFFFFFF7;
      v14[3] = v24;
      if ( (v24 & 2) != 0 )
      {
        v36 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 2560LL) + v21 + 32);
        if ( v36 )
