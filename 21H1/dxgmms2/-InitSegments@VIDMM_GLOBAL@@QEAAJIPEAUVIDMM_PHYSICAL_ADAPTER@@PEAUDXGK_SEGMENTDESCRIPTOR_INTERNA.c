/*
 * XREFs of ?InitSegments@VIDMM_GLOBAL@@QEAAJIPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@PEA_K@Z @ 0x1C0094708
 * Callers:
 ...
 *     ?InitializeSegmentGroupState@VIDMM_GLOBAL@@QEAAXIPEAUVIDMM_SEGMENT_GROUP_STATE@@_K@Z @ 0x1C0094334 (-InitializeSegmentGroupState@VIDMM_GLOBAL@@QEAAXIPEAUVIDMM_SEGMENT_GROUP_STATE@@_K@Z.c)
 *     ??0VIDMM_SEGMENT@@QEAA@PEAVVIDMM_GLOBAL@@IKKPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z @ 0x1C0094BB8 (--0VIDMM_SEGMENT@@QEAA@PEAVVIDMM_GLOBAL@@IKKPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z.c)
 *     ?SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z @ 0x1C00CA6A8 (-SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z.c)
 */
    ...
    while ( 1 )
    {
      ...
      if ( (v12 & 3) != 0 && v10 == *((unsigned __int16 *)a3 + 14) )
      {
        ...
        *((_QWORD *)this[464] + v10) = v33;
        ...
        {
          _InterlockedAdd(&dword_1C005172C, 1u);
          goto LABEL_88;
        }
      }
      else
        ...
        *(_QWORD *)&DestinationString.Length = v41;
        ...
        else
        {
          ...
          *(_QWORD *)((char *)this[464] + v44) = v51;
          ...
          {
            _InterlockedAdd(&dword_1C0051708, 1u);
LABEL_88:
