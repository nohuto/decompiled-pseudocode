/*
 * XREFs of ??1VIDMM_GLOBAL@@QEAA@XZ @ 0x1C00AEADC
 * Callers:
 *     ??_GVIDMM_GLOBAL@@QEAAPEAXI@Z @ 0x1C0022128 (--_GVIDMM_GLOBAL@@QEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ?RemoveFromAdapterList@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00B43A4 (-RemoveFromAdapterList@VIDMM_GLOBAL@@QEAAXXZ.c)
...
void __fastcall VIDMM_GLOBAL::~VIDMM_GLOBAL(VIDMM_GLOBAL *this)
{
  ...
  *((_BYTE *)this + 7080) = 1;
  ...
  if ( *(int *)(*(_QWORD *)(v2 + 16) + 2572LL) >= 2500 )
  {
