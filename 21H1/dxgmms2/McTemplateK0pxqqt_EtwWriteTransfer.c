/*
 * XREFs of McTemplateK0pxqqt_EtwWriteTransfer @ 0x1C002805C
 * Callers:
 ...
 *     ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C00C2DB0 (-ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ.c)
