/*
 * XREFs of McTemplateK0pqxx_EtwWriteTransfer @ 0x1C00262C8
 * Callers:
 ...
 *     ?RemoveVadFromFreeList@CVirtualAddressAllocator@@IEAAXPEAUVIDMM_VAD@@@Z @ 0x1C0070EF8 (-RemoveVadFromFreeList@CVirtualAddressAllocator@@IEAAXPEAUVIDMM_VAD@@@Z.c)
