/*
 * XREFs of ?VidSchiProcessHistoryBuffer@@YAXPEAU_VIDSCH_DMA_PACKET@@PEAU_VIDSCH_HISTORY_BUFFER_DATA@@@Z @ 0x1C002B944
 * Callers:
...
void __fastcall VidSchiProcessHistoryBuffer(struct _VIDSCH_DMA_PACKET *a1, __m128i **a2)
{
  ...
  if ( (qword_1C0051010 & 0x61C8ED7) != 0
    && (qword_1C0051018 & 0xFFFFFFFFF9E37128uLL) == 0
    && (qword_1C0051010 & 0x4000) != 0 )
  {
    v2 = *((_QWORD *)a1 + 6);
    v3 = *a2;
    v47 = v2;
...
LABEL_43:
    ...
    v13 = *(_QWORD *)(v5 + 8);
    v14 = 360 * v9;
    v15 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v13 + 16) + 2560LL) + v14 + 40)
