/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0068988
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C00016E0 (VidMmDestroyAllocation.c)
 * Callees:
