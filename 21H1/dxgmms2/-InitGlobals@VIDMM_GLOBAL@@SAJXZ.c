/*
 * XREFs of ?InitGlobals@VIDMM_GLOBAL@@SAJXZ @ 0x1C008FFFC
 * Callers:
...
LABEL_27:
  ...
  if ( !v10 )
  {
    _InterlockedAdd(&dword_1C00516CC, 1u);
  ...
  if ( v15 < 0 )
    goto LABEL_27;
  qword_1C0051800 = (__int64)&VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
  ...
  qword_1C0051848 = (__int64)&VIDMM_GLOBAL::_AdapterListHead;
