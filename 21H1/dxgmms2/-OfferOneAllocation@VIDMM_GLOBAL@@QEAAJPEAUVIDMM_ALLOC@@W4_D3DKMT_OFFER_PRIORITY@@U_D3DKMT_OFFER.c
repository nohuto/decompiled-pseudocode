/*
 * XREFs of ?OfferOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4_D3DKMT_OFFER_PRIORITY@@U_D3DKMT_OFFER_FLAGS@@@Z @ 0x1C007C610
 * Callers:
 *     ?OfferAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@W4_D3DKMT_OFFER_PRIORITY@@U_D3DKMT_OFFER_FLAGS@@@Z @ 0x1C007C388 (-OfferAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@W4_D3DKMT_OFFER_PRIORITY@@U_D3DKMT_O.c)
 * Callees:
        ...
        struct _D3DKMT_OFFER_FLAGS a4)
{
  ...
  ExAcquirePushLockExclusiveEx(v9 + 472, 0LL);
  if ( *(_DWORD *)(v9 + 336) )
  {
    if ( (*((_BYTE *)this + 40936) & 4) == 0 )
    {
      ...
      *(_QWORD *)(v49 + 24) = v6;
      ...
      {
        ExReleasePushLockExclusiveEx(v9 + 472, 0LL);
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)this + 39968, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v46 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q_EtwWriteTransfer(v24, &EventBlockThread, v25, v46);
    }
...
LABEL_26:
  *((_QWORD *)this + 4997) = 0LL;
  ...
  {
    if ( (**(_DWORD **)(v9 + 496) & 0x20000000) != 0 )
    {
      if ( (v4 & 2) != 0 || dword_1C00514BC )
      {
        v60 = *(_QWORD *)(v9 + 8);
        ++*((_DWORD *)this + 1962);
        *((_QWORD *)this + 982) += v60;
