/*
 * XREFs of ?AsyncUnpinAllocation@VIDMM_GLOBAL@@QEAAJPEAVDXGALLOCATION@@@Z @ 0x1C00AEF54
 * Callers:
 *     VidMmAsyncUnpinAllocation @ 0x1C0022960 (VidMmAsyncUnpinAllocation.c)
 * Callees:
 ...
 *     ?AcquireInverseSemaphore@DXGINVERSESEMAPHORE@@QEAAXXZ @ 0x1C0023208 (-AcquireInverseSemaphore@DXGINVERSESEMAPHORE@@QEAAXXZ.c)
