/*
 * XREFs of McTemplateK0pppppppppppp_EtwWriteTransfer @ 0x1C0024374
 * Callers:
 ...
 *     VidMmReportContextAllocList @ 0x1C00BD930 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiAlloc @ 0x1C00BDA40 (VidMmReportMultiAlloc.c)
...
NTSTATUS McTemplateK0pppppppppppp_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v26 = 8LL;
  v28 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, a3, 0xDu, &v4);
}
