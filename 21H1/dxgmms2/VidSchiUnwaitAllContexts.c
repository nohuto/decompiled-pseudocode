/*
 * XREFs of VidSchiUnwaitAllContexts @ 0x1C003225C
 * Callers:
 *     VidSchiReportHwHang @ 0x1C003D194 (VidSchiReportHwHang.c)
 *     VidSchFlushAdapter @ 0x1C00D2960 (VidSchFlushAdapter.c)
 * Callees:
 *     ?VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z @ 0x1C002CEE8 (-VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z.c)
 */
