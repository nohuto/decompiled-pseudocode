/*
 * XREFs of ?ResetBackingStore@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0061EBC
 * Callers:
 ...
 *     ?IsActive@VIDMM_POLICY@@QEAAHXZ @ 0x1C0061EA4 (-IsActive@VIDMM_POLICY@@QEAAHXZ.c)
