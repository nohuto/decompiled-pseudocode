/*
 * XREFs of ?HandlePromotionCandidates@VIDMM_GLOBAL@@QEAAXPEA_N@Z @ 0x1C0084D30
 * Callers:
 ...
 *     VidSchIsDeviceBusy @ 0x1C0013D58 (VidSchIsDeviceBusy.c)
 ...
 *     ?GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C00C82F0 (-GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z.c)
 */
  ...
  *a2 = 1;
  ...
  else
  {
    ...
    *((_QWORD *)this + 5576) = v17;
    if ( v17 > qword_1C0051470 )
      *((_QWORD *)this + 5576) = qword_1C0051470;
  }
  v65 = 0;
  v51 = 0LL;
...
LABEL_62:
                          ...
                          v42 = v51;
                          if ( v65
                            && (v51 + *(_QWORD *)(v39 + 16) > (unsigned __int64)qword_1C0051478 || v65 > dword_1C0051480) )
                          {
                            goto LABEL_90;
                          }
