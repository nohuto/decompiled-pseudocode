/*
 * XREFs of ?InitDmaPools@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C0095B44
 * Callers:
 ...
 *     ??_GVIDMM_DMA_POOL@@QEAAPEAXI@Z @ 0x1C0014B7C (--_GVIDMM_DMA_POOL@@QEAAPEAXI@Z.c)
 ...
 *     ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C008B590 (--0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z.c)
 */
  ...
  if ( *((_DWORD *)this + 1750) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)this + v2 + 79) = v6;
      ...
      if ( v8 < 0 )
      {
        _InterlockedAdd(&dword_1C0051714, 1u);
    ...
    _InterlockedAdd(&dword_1C0051710, 1u);
    v14 = WdLogNewEntry5_WdLowResource(v7);
    *(_QWORD *)(v14 + 24) = 1928LL;
