/*
 * XREFs of ?Rotate@VIDMM_PROCESS_HEAP@@UEAAJPEAVVIDMM_GLOBAL@@PEAXW4_MM_ROTATE_DIRECTION@@PEAU_MDL@@_KP6AJ331@Z1TVIDMM_ROTATE_FLAGS@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00CEF30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RecordRotation@VIDMM_GLOBAL@@SAXPEAU_EPROCESS@@PEAX_KPEAU_MDL@@W4_MM_ROTATE_DIRECTION@@J@Z @ 0x1C00C1CB4 (-RecordRotation@VIDMM_GLOBAL@@SAXPEAU_EPROCESS@@PEAX_KPEAU_MDL@@W4_MM_ROTATE_DIRECTION@@J@Z.c)
 */
    ...
    if ( (unsigned int)v12 <= 1 )
    {
      ...
      if ( (*(_DWORD *)v9 & 1) == 0 && !*(_QWORD *)(v21 + 56) && !*(_QWORD *)(v9 + 32) )
      {
        ...
        *(_QWORD *)(v9 + 32) = v29;
        if ( !v29 )
        {
          _InterlockedAdd(&dword_1C0051760, 1u);
