/*
 * XREFs of ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C00BBF78
 * Callers:
 *     VidMmGetNextBuffersContractedSize @ 0x1C0022A40 (VidMmGetNextBuffersContractedSize.c)
 * Callees:
 *     ?NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ @ 0x1C00BBFF0 (-NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ.c)
 *     ?TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z @ 0x1C00BC6B8 (-TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z.c)
 */
