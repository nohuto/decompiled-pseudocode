/*
 * XREFs of WPP_RECORDER_SF_qZD @ 0x1C0083CE8
 * Callers:
...
__int64 WPP_RECORDER_SF_qZD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x100) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    ndisWppFastTraceMessage(
      &WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids,
      0x2Fu,
      va,
      8LL,
      v8,
  ...
  LOWORD(v10) = 47;
  return WppAutoLogTrace(a1, 4LL, 9LL, &WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids, v10, (__int64 *)va);
}
