/*
 * XREFs of WPP_RECORDER_SF__guid_Dq @ 0x1C00264C4
 * Callers:
...
__int64 WPP_RECORDER_SF__guid_Dq(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, __int64 a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x8000000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(&WPP_3188c4384181338fe0d477b94428bcd6_Traceguids, a4, a6, 16LL, va, 4LL, va1, 8LL, 0LL);
  LOWORD(v9) = a4;
  return WppAutoLogTrace(a1, 4LL, 28LL, &WPP_3188c4384181338fe0d477b94428bcd6_Traceguids, v9, a6);
}
