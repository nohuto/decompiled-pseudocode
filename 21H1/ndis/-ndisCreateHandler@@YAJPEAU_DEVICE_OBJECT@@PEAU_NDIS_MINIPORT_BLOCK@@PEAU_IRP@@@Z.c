 ...
 *     NdisWdfCreateIrpHandler @ 0x1C0061440 (NdisWdfCreateIrpHandler.c)
 * Callees:
...
LABEL_19:
    ...
    {
      v19 = 0;
      v61 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E49C8);
      if ( ThreadSessionId < dword_1C00E6060 )
        v19 = *((_DWORD *)P + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00E49C8, v61);
      if ( !v19 )
        v19 = 1;
    }
    else
  ...
  if ( qword_1C00E49D8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E49D8 )
  {
    while ( *((_DWORD *)v26 + 4) != v20 )
    {
      if ( *((_DWORD *)v26 + 4) <= v20 )
      {
        ...
        if ( v26 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E49D8 )
          continue;
      }
      goto LABEL_27;
    }
