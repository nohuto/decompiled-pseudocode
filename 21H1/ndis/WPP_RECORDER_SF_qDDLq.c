/*
 * XREFs of WPP_RECORDER_SF_qDDLq @ 0x1C00B9628
 * Callers:
...
__int64 WPP_RECORDER_SF_qDDLq(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x80000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_efcd9713de433365d671794f7ef4fa0a_Traceguids,
      a4,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 20LL, &WPP_efcd9713de433365d671794f7ef4fa0a_Traceguids, v8, (__int64 *)va);
}
