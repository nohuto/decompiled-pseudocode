/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x1C011A660
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C003F3E0 (_guard_dispatch_icall_nop.c)
 *     ?ndisGetNextPDCounterId@@YAKXZ @ 0x1C007CD38 (-ndisGetNextPDCounterId@@YAKXZ.c)
 ...
 *     ??0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ @ 0x1C01190E4 (--0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ.c)
 *     ??_GNDIS_PD_COUNTER@@QEAAPEAXI@Z @ 0x1C01191B8 (--_GNDIS_PD_COUNTER@@QEAAPEAXI@Z.c)
        ...
        unsigned int *a7)
{
  ...
  v34.m_Lock = (KPushLockBase *)qword_1C00E43F8;
