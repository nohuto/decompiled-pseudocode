/*
 * XREFs of ndisKillReceiveWorkerThreadPool @ 0x1C00A2904
 * Callers:
...
void ndisKillReceiveWorkerThreadPool()
{
  ...
  for ( i = 0LL; (unsigned int)i < ndisMaxNumberOfProcessors; i = (unsigned int)(i + 1) )
  {
    ...
    ndisInsertInWorkQueue(
      (struct _NDIS_WORK_QUEUE *)((char *)qword_1C00E4000 + 64 * (unsigned __int64)(unsigned int)i),
      v2,
      0);
    v0 = ndisMaxNumberOfProcessors;
  }
  ...
  if ( v0 )
  {
    do
    {
      v4 = (void *)*((_QWORD *)qword_1C00E4008 + v3);
      if ( !v4 )
        break;
      ndisWaitForKernelObject(v4);
      ObfDereferenceObject(*((PVOID *)qword_1C00E4008 + v3));
      *((_QWORD *)qword_1C00E4008 + v3) = 0LL;
