/*
 * XREFs of ?ndisOidPreRcvFilterEnumFilters@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0085950
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumFilters(struct _NDIS_MINIPORT_BLOCK **a1)
{
  ...
  KIRQL v19; // dl
  $F149EA60A7B4EAEDD8FDAA71BF2E986F *v20; // rcx
...
LABEL_22:
      ...
      if ( v18 <= HIDWORD(a1[4]->Reserved28) )
      {
        *(_DWORD *)Buffer = 1835392;
        if ( v3 )
        {
          v20 = ($F149EA60A7B4EAEDD8FDAA71BF2E986F *)v3->WorkQueue[6].Next;
          *((_DWORD *)Buffer + 6) = v3->PnPFlags;
        }
        else
        {
          v20 = *($F149EA60A7B4EAEDD8FDAA71BF2E986F **)&ReceiveQueueByQueueId->Reserved4.Length;
        ...
        *((_DWORD *)Buffer + 3) = Next;
        for ( i = Buffer + 14; v21 < Next; v20 = *($F149EA60A7B4EAEDD8FDAA71BF2E986F **)&v20->Reserved4.Length )
        {
          if ( v3 )
          {
            if ( v20 == ($F149EA60A7B4EAEDD8FDAA71BF2E986F *)&v3->WorkQueue[6] )
              break;
            v23 = 104LL;
            v24 = 1LL;
            v25 = 108LL;
