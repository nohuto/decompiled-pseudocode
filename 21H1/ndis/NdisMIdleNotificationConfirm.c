/*
 * XREFs of NdisMIdleNotificationConfirm @ 0x1C00A8B70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAoAcIdleRequestConfirm@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0059F80 (-ndisAoAcIdleRequestConfirm@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
