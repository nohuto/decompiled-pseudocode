/*
 * XREFs of NdisMCancelTimer @ 0x1C00176B0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisMCancelTimer(PNDIS_MINIPORT_TIMER Timer, PBOOLEAN TimerCancelled)
{
  ...
  KIRQL v7; // r8
  $8530D79B89D94839139BAE05074814A2 *i; // rcx
  ...
  else
  {
    ...
    *TimerCancelled = v5;
    ...
    if ( (v6->DriverHandle->Flags & 2) != 0 && v5 )
    {
      ...
      for ( i = &Timer->Miniport->560; ; i = ($8530D79B89D94839139BAE05074814A2 *)&TimerQueue->NextTimer )
      {
