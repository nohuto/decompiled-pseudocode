/*
 * XREFs of WPP_RECORDER_SF_qq_guid_qd @ 0x1C00620BC
 * Callers:
...
__int64 WPP_RECORDER_SF_qq_guid_qd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 1) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_c1b31223335c304c22f5aac6e772b23d_Traceguids,
      0x95u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 149;
  return WppAutoLogTrace(a1, 4LL, 1LL, &WPP_c1b31223335c304c22f5aac6e772b23d_Traceguids, v7, (__int64 *)va);
}
