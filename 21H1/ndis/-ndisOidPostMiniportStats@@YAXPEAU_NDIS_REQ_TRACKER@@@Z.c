/*
 * XREFs of ?ndisOidPostMiniportStats@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C009B770
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisIsSatisfiedByOidGenStatistics@@YAKK@Z @ 0x1C0039A30 (-ndisIsSatisfiedByOidGenStatistics@@YAKK@Z.c)
