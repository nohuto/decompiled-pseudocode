/*
 * XREFs of ?ndisNsiEnumerateAllCompartments@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00B2930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllCompartments(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( qword_1C00E49D8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E49D8 )
  {
    ...
    while ( v3 != (const struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E49D8 );
    v4 = v17;
  }
  v9 = *((_DWORD *)a1 + 22);
  *((_DWORD *)a1 + 22) = v5;
  if ( v9 )
  {
    ...
    do
    {
      if ( v14 == (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E49D8 )
        break;
