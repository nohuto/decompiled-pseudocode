/*
 * XREFs of ?NdisTraceLoggingNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K1K11KPEAU_NDIS_NAPS_TELEMETRY_REASON_DATA@@KPEAU_NDIS_NAPS_TELEMETRY_OID_DATA@@@Z @ 0x1C008B1EC
 * Callers:
        ...
        struct _NDIS_NAPS_TELEMETRY_OID_DATA *a11)
{
  ...
  if ( (a1->PMHardwareCapabilities.Flags & 4) != 0 && a1->SelectiveSuspend && a3 >= 0x927C0 )
  {
    ...
    if ( (unsigned int)dword_1C00E30F8 > 5 && tlgKeywordOn((__int64)&dword_1C00E30F8, 0x400000000000LL) )
    {
