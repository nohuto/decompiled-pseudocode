/*
 * XREFs of NdisReadConfiguration @ 0x1C0028420
 * Callers:
 ...
 *     ?ndisReadPMAdminConfigState@@YA?AW4_NDIS_PM_ADMIN_CONFIG_STATE@@PEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_UNICODE_STRING@@@Z @ 0x1C0027660 (-ndisReadPMAdminConfigState@@YA-AW4_NDIS_PM_ADMIN_CONFIG_STATE@@PEAU_NDIS_CONFIGURATION_HANDLE@@.c)
 ...
 *     ?ndisReadSoftwareTimestampSettings@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0039B90 (-ndisReadSoftwareTimestampSettings@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@.c)
 *     NdisWdfReadConfiguration @ 0x1C005EB00 (NdisWdfReadConfiguration.c)
 ...
 *     ndisOpenProtocolSubkey @ 0x1C0028FCC (ndisOpenProtocolSubkey.c)
        ...
        NDIS_PARAMETER_TYPE ParameterType)
{
  ...
  for ( i = 0; i < 3; ++i )
  {
    ...
    {
      RegistryValues = 0;
      v25 = (struct _NDIS_CONFIGURATION_PARAMETER *)((char *)&unk_1C00D1B50 + 24 * i);
      goto LABEL_45;
    }
  }
  v10 = 0;
      ...
      if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
          ...
          (struct _GUID *)&WPP_b81edc0eee5937abc1ca6eb1073cfaac_Traceguids);
      RegistryValues = 0;
      *ParameterValue = (PNDIS_CONFIGURATION_PARAMETER)&unk_1C00D1B38;
      goto LABEL_24;
    }
...
LABEL_9:
    ...
    if ( v10 >= 9 )
    {
      if ( RtlEqualUnicodeString(Keyword, &stru_1C00C70E0, 1u) )
      {
        ...
        {
          RegistryValues = 0;
          v25 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C00D1B38;
LABEL_45:
          *ParameterValue = v25;
          goto LABEL_24;
        }
      ...
      if ( RtlEqualUnicodeString(Keyword, &stru_1C00C70D0, 1u) )
      {
        if ( ParameterType )
          goto LABEL_24;
        dword_1C00E3F30 = ndisReadNDKGlobalFlags();
        RegistryValues = 0;
        v25 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C00E3F28;
        goto LABEL_45;
      }
