/*
 * XREFs of ?ndisNsiGetCompartmentIdForGuid@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00136A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetCompartmentIdForGuid(struct _NM_REQUEST_GET_PARAMETER *a1)
{
    ...
    && !*((_DWORD *)a1 + 14) )
  {
    ...
    for ( i = qword_1C00E49D8;
          i != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E49D8;
