/*
 * XREFs of ?ndisPktMonFilterRegister@@YAJPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C0100928
 * Callers:
...
LABEL_5:
    ...
    {
      v2 = PktMonClientSetCompProperty(&a1->PktMonComp.CompHandle, 9, (__int64)v12, 1u);
      if ( v2 )
      {
        if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          goto LABEL_6;
      ...
      v2 = PktMonClientSetCompProperty(&a1->PktMonComp.CompHandle, 1, (__int64)&a1->IfIndex, 4u);
      if ( v2 )
      {
        if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          goto LABEL_6;
      ...
      v2 = PktMonClientSetCompProperty(&a1->PktMonComp.CompHandle, 2, (__int64)&a1->Miniport->IfIndex, 4u);
      if ( v2 )
      {
        if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
          goto LABEL_6;
      ...
      if ( LowerFilter )
      {
        v2 = PktMonClientSetCompProperty(&a1->PktMonComp.CompHandle, 3, (__int64)&LowerFilter->IfIndex, 4u);
        if ( v2 )
        {
          if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
            goto LABEL_6;
      ...
      {
        v2 = PktMonClientSetCompProperty(&a1->PktMonComp.CompHandle, 5, (__int64)&a1->MediaType, 4u);
        if ( v2 )
        {
          if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
            goto LABEL_6;
      ...
      {
        v11 = 1;
        v2 = PktMonClientSetCompProperty(&a1->PktMonComp.CompHandle, 8, (__int64)&v11, 1u);
        if ( v2 )
        {
          if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
            goto LABEL_6;
...
LABEL_6:
    PktMonClientComponentUnregister(&a1->PktMonComp.CompHandle);
LABEL_7:
