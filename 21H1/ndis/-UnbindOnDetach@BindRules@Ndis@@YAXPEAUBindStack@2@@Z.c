/*
 * XREFs of ?UnbindOnDetach@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00FC134
 * Callers:
 ...
 *     ?GetActualBindingState@BindState@Ndis@@QEAA?AW4BINDING_ENABLED_OR_DISABLED@@XZ @ 0x1C0122854 (-GetActualBindingState@BindState@Ndis@@QEAA-AW4BINDING_ENABLED_OR_DISABLED@@XZ.c)
  ...
  for ( j = 0LL; j != v10; ++j )
  {
    ...
    else
    {
      ...
      if ( (v14 != 0) != ((v14 & 0xFFFFFBFF) != 0) || !*(_QWORD *)v13 )
      {
        ...
        v18 = (unsigned __int8)byte_1C00E434B < 4u;
