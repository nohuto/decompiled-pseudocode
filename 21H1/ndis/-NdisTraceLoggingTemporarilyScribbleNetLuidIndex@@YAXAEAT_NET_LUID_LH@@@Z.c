/*
 * XREFs of ?NdisTraceLoggingTemporarilyScribbleNetLuidIndex@@YAXAEAT_NET_LUID_LH@@@Z @ 0x1C011EBA0
 * Callers:
...
void __fastcall NdisTraceLoggingTemporarilyScribbleNetLuidIndex(union _NET_LUID_LH *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C00E30F8, 0x200000000000LL) )
    {
      v2 = *v1;
      v7 = 0;
      v6 = 4;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C00CFCE2,
        0LL,
        0LL,
        3u,
        &v4);
