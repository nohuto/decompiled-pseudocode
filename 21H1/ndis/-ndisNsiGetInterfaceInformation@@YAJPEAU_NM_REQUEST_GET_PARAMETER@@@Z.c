 ...
 *     ?ndisIfFindNextInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C00B1504 (-ndisIfFindNextInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z.c)
...
LABEL_13:
    ...
    {
      v9 = 0;
      v110 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E49C8);
      if ( ThreadSessionId < dword_1C00E6060 )
        v9 = *((_DWORD *)P + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00E49C8, v110);
      if ( !v9 )
        v9 = 1;
    }
    else
