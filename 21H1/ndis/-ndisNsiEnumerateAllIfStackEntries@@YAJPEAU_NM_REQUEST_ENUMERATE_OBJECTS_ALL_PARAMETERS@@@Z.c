/*
 * XREFs of ?ndisNsiEnumerateAllIfStackEntries@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00B0C90
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( Interface )
    {
      *((_DWORD *)a1 + 22) = Interface[81].Flink;
      ...
      if ( Flink )
      {
        if ( v5 )
        {
          v12 = (PVOID *)qword_1C00E4A00;
          while ( v12 != &qword_1C00E4A00 && v2 < v5 )
          {
            v13 = v12;
            v12 = (PVOID *)*v12;
            if ( *((_DWORD *)v13 + 4) == v6 )
