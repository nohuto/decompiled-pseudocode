/*
 * XREFs of ?ndisEnableWppTracingCallback@@YAXPEBU_GUID@@_JEKE@Z @ 0x1C00AA814
 * Callers:
 *     WppClassicProviderCallback @ 0x1C00AB2B0 (WppClassicProviderCallback.c)
 ...
 *     ndisWppExtendedCallback @ 0x1C0038C90 (ndisWppExtendedCallback.c)
