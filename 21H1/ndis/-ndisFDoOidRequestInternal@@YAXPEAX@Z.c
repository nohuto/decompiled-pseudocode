...
LABEL_2:
    ...
    *((_DWORD *)v4 + 4) &= ~4u;
    ...
    if ( !v9->PortNumber || ((__int64)Miniport[2].OidRequestList.Flink & 0x200) == 0 )
    {
      Oid = v9->DATA.QUERY_INFORMATION.Oid;
      v15 = 146;
      while ( v12 >= v11 )
      {
        v16 = *((_DWORD *)&unk_1C00C7310 + 6 * v12);
        if ( v16 > Oid )
        {
          if ( !v12 )
            break;
        ...
        else
        {
          if ( v16 == Oid )
          {
            ...
            *(_QWORD *)&v42 = v4 - 9;
            ...
            if ( (v17 & 0x840080) != 0 )
              break;
            v18 = (__int64 (__fastcall *)(__int128 *))*((_QWORD *)&unk_1C00C7310 + 3 * *((unsigned int *)v4 + 5) + 1);
            if ( !v18 )
              break;
            v10 = v18(&v40);
            if ( v10 != 1 )
