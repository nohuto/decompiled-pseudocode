/*
 * XREFs of ?ndisMpHookNmrInitializeClient@@YAJXZ @ 0x1C01458D8
 * Callers:
 ...
 *     ??0MINIPORT_HOOK_DRIVER@@QEAA@XZ @ 0x1C010B5A4 (--0MINIPORT_HOOK_DRIVER@@QEAA@XZ.c)
 *     ??_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z @ 0x1C0125FFC (--_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z.c)
 */
