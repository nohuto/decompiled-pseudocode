/*
 * XREFs of ?ndisBuildDeviceAcl@@YAJPEAPEAU_ACL@@K@Z @ 0x1C003616C
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x1C0109730 (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 * Callees:
...
__int64 __fastcall ndisBuildDeviceAcl(struct _ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v15 = RtlLengthSid(&unk_1C00CB0C8);
    v16 = RtlLengthSid(&unk_1C00CB0A8) + v15;
    v17 = RtlLengthSid(&unk_1C00CB088) + v16;
    v6 += v17 + 32 + RtlLengthSid(&unk_1C00CB068);
  }
  v23 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
...
LABEL_14:
    v10 = a2 & 0x80;
    if ( v10 )
      v6 += RtlLengthSid(&unk_1C00CB048) + 8;
    ...
    if ( v11 )
    {
      ...
      else
      {
        ...
        if ( v22 )
        {
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00CB068);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00CB088);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00CB0A8);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00CB0C8);
        }
        if ( v23 )
        ...
        if ( v10 )
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00CB048);
        *v26 = v12;
      }
      goto LABEL_33;
    }
