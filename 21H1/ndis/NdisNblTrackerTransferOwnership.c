/*
 * XREFs of NdisNblTrackerTransferOwnership @ 0x1C0073E50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z @ 0x1C007366C (-ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z.c)
 */
