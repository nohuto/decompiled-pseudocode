/*
 * XREFs of NdisNblTrackerDeregisterComponent @ 0x1C00202F0
 * Callers:
 ...
 * Callees:
 *     ?ndisNblTrackerDeleteTracker@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C0073608 (-ndisNblTrackerDeleteTracker@@YAXPEAU_NDIS_NBL_TRACKER@@@Z.c)
