/*
 * XREFs of ?ndisPktMonMiniportRegister@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0106ABC
 * Callers:
...
__int64 __fastcall ndisPktMonMiniportRegister(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  _PKTMON_COMPONENT_CONTEXT *p_PktMonComp; // rsi
...
LABEL_4:
  ...
  {
    v7 = PktMonClientSetCompProperty(p_PktMonComp, 9, (__int64)v14, 1u);
    if ( v7 )
    {
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_5;
    ...
    v7 = PktMonClientSetCompProperty(p_PktMonComp, 1, (__int64)&a1->IfIndex, 4u);
    if ( v7 )
    {
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_5;
    ...
    v7 = PktMonClientSetCompProperty(p_PktMonComp, 4, (__int64)&a1->InterfaceGuid, 0x10u);
    if ( v7 )
    {
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_5;
    ...
    v7 = PktMonClientSetCompProperty(p_PktMonComp, 5, (__int64)p_MiniportMediaType, 4u);
    if ( v7 )
    {
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_5;
    ...
    if ( ndisMReferenceIfBlock(a1, 0x1Bu) )
    {
      ...
      if ( Length )
        v7 = PktMonClientSetCompProperty(p_PktMonComp, 6, (__int64)IfBlock->ifPhysAddress.Address, Length);
