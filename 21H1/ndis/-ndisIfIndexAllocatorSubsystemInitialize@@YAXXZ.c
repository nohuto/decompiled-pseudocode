...
void __fastcall ndisIfIndexAllocatorSubsystemInitialize(struct _DRIVER_OBJECT *a1)
{
  ...
  v3[1] = dword_1C00E48D4;
  ndisReadRegistryKnobs(a1, (const struct NDIS_REGISTRY_KNOB *)v3, 1uLL);
  v1 = *(_DWORD *)dword_1C00E48D4;
  if ( (unsigned int)(*(_DWORD *)dword_1C00E48D4 - 1) > 0x7FFE )
  {
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      *(_DWORD *)v2 = *(_DWORD *)dword_1C00E48D4;
      WPP_RECORDER_SF_d(
    ...
    v1 = 1;
    *(_DWORD *)dword_1C00E48D4 = 1;
  }
  dword_1C00E4300 = 1;
  xmmword_1C00E4308 = 0LL;
  dword_1C00E4304 = v1;
  xmmword_1C00E4320 = 0LL;
  dword_1C00E4318 = v1;
  dword_1C00E431C = 0xFFFF;
}
