/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00BD800
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00BDB40 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00BDB60 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00BDB80 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00BDBC0 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00BDBF0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00BDC20 (NdisImmediateWritePortUshort.c)
 * Callees:
 ...
 *     ndisStartMapping @ 0x1C00BDA60 (ndisStartMapping.c)
 */
