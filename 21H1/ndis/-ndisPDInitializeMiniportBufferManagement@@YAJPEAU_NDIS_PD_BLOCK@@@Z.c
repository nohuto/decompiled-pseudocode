/*
 * XREFs of ?ndisPDInitializeMiniportBufferManagement@@YAJPEAU_NDIS_PD_BLOCK@@@Z @ 0x1C00FF17C
 * Callers:
 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C011D1D0 (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x1C011D5B8 (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
 */
...
__int64 __fastcall ndisPDInitializeMiniportBufferManagement(struct _NDIS_PD_BLOCK *a1)
{
  ...
  *((_QWORD *)&v19 + 1) = v2;
  if ( *((_DWORD *)a1 + 4) )
  {
    v20.m_Lock = (KPushLockBase *)qword_1C00E43F8;
...
LABEL_13:
    ...
    v10 = qword_1C00E43F8 + 8240;
    v11 = *(__int64 ***)(qword_1C00E43F8 + 8248);
    if ( *v11 != (__int64 *)(qword_1C00E43F8 + 8240) )
      goto LABEL_42;
    *v9 = v10;
    *((_QWORD *)v4 + 2) = v11;
    *v11 = v9;
