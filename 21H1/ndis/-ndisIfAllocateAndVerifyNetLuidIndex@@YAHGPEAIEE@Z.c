/*
 * XREFs of ?ndisIfAllocateAndVerifyNetLuidIndex@@YAHGPEAIEE@Z @ 0x1C0105EBC
 * Callers:
 ...
 *     NdisIfAllocateNetLuidIndexEx @ 0x1C0126660 (NdisIfAllocateNetLuidIndexEx.c)
 * Callees:
...
LABEL_5:
    ...
    v11 = qword_1C00E5E28;
    if ( (__int64 *)qword_1C00E5E28 != &qword_1C00E5E28 )
    {
      while ( *(_WORD *)(v11 + 16) != a1 )
      {
        v11 = *(_QWORD *)v11;
        if ( (__int64 *)v11 == &qword_1C00E5E28 )
          goto LABEL_26;
      }
      v7 = (const void **)v11;
      v12 = *(_QWORD *)(v11 + 48);
      ...
      if ( !a3 )
      {
        ...
        {
          if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_dL(*((_QWORD *)WPP_GLOBAL_Control + 8), 3u, (__int64)&qword_1C00E5E28, 0xCu, v34);
          v10 = -1073741072;
        }
        goto LABEL_10;
      }
...
LABEL_30:
      ...
      if ( PoolWithTag )
      {
        ...
        *(_BYTE *)((unsigned int)v25 + v28 + 64) = 1;
        ...
        v31 = qword_1C00E5E28;
        if ( *(__int64 **)(qword_1C00E5E28 + 8) == &qword_1C00E5E28 )
        {
          *(_QWORD *)v28 = qword_1C00E5E28;
          v7 = (const void **)v28;
          *(_QWORD *)(v28 + 8) = &qword_1C00E5E28;
          *(_QWORD *)(v31 + 8) = v28;
          qword_1C00E5E28 = v28;
          goto LABEL_30;
        }
