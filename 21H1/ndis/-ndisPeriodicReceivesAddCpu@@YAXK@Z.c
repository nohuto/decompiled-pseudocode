/*
 * XREFs of ?ndisPeriodicReceivesAddCpu@@YAXK@Z @ 0x1C00A3274
 * Callers:
...
void __fastcall ndisPeriodicReceivesAddCpu(ULONG a1)
{
  ...
  NdisInitializeTimer((PNDIS_TIMER)((char *)qword_1C00E3FF0 + v2), ndisPeriodicReceivesTimer, 0LL);
  KeSetTargetProcessorDpcEx((PKDPC)((char *)qword_1C00E3FF0 + v2 + 64), &ProcNumber);
  ndisWaitForKernelObject(&ndisPeriodicReceivesMutex);
  if ( byte_1C00E3FC1
    && (int)ndisCreateThread(v3, (void *)(unsigned int)v1, dword_1C00E3FC8, (PVOID *)qword_1C00E4008 + v1) < 0
