/*
 * XREFs of ?ndisOpenAdapterLegacyProtocol@@YAXPEAH0PEAPEAXPEAIPEAW4_NDIS_MEDIUM@@IPEAX4PEAU_UNICODE_STRING@@IPEAU_STRING@@0@Z @ 0x1C0096DFC
 * Callers:
 ...
 *     NdisOpenAdapter @ 0x1C013AF20 (NdisOpenAdapter.c)
 * Callees:
