/*
 * XREFs of ?ndisSetReceiveFilter@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0086974
 * Callers:
 ...
 *     ?ndisAddReceiveFilterToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_FILTER_BLOCK@@@Z @ 0x1C00842C4 (-ndisAddReceiveFilterToList@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_FILTER_BLOCK@@@Z.c)
...
char __fastcall ndisSetReceiveFilter(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  int v43; // eax
  KIRQL v44; // dl
  $F149EA60A7B4EAEDD8FDAA71BF2E986F *v45; // rcx
  __int64 v46; // rdx
