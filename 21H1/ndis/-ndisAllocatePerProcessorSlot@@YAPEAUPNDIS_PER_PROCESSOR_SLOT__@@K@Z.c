/*
 * XREFs of ?ndisAllocatePerProcessorSlot@@YAPEAUPNDIS_PER_PROCESSOR_SLOT__@@K@Z @ 0x1C002CD94
 * Callers:
 ...
 * Callees:
 *     ndisAllocateFreeSlotFromDescriptor @ 0x1C002CF50 (ndisAllocateFreeSlotFromDescriptor.c)
