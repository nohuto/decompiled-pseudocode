 ...
 *     NdisWdfMiniportStarted @ 0x1C00617A0 (NdisWdfMiniportStarted.c)
 ...
 * Callees:
 *     ?ndisInitialBindCompleted@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0039984 (-ndisInitialBindCompleted@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
