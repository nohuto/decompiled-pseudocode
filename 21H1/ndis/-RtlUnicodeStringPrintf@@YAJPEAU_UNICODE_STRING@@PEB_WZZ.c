/*
 * XREFs of ?RtlUnicodeStringPrintf@@YAJPEAU_UNICODE_STRING@@PEB_WZZ @ 0x1C001DBE0
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker @ 0x1C001DD50 (RtlUnicodeStringValidateWorker.c)
 */
...
__int64 RtlUnicodeStringPrintf(struct _UNICODE_STRING *a1, const wchar_t *a2, ...)
{
  ...
  int v8; // eax
  __int64 Args; // [rsp+60h] [rbp+18h] BYREF
  va_list Argsa; // [rsp+60h] [rbp+18h]
