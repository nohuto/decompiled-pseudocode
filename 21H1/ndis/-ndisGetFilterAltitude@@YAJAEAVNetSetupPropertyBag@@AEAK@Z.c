/*
 * XREFs of ?ndisGetFilterAltitude@@YAJAEAVNetSetupPropertyBag@@AEAK@Z @ 0x1C0124A68
 * Callers:
...
__int64 __fastcall ndisGetFilterAltitude(struct NetSetupPropertyBag *a1, unsigned int *a2)
{
  ...
  P = 0LL;
  v3 = NetSetupPropertyBag::ReadString(a1, (const struct _NETSETUPPROPKEY *)&unk_1C00D34C0, &P);
  v4 = v3;
  if ( v3 == -1073741772 )
  {
    *a2 = 0;
LABEL_18:
  ...
  v6 = 0;
  if ( *((_DWORD *)qword_1C00E4498 + 19) )
  {
    v7 = *((unsigned int *)qword_1C00E4498 + 19);
    while ( 1 )
    {
      v8 = v6;
      if ( v6 >= v7 )
        __fastfail(5u);
      ++v6;
      if ( *(char **)(*((_QWORD *)qword_1C00E4498 + 10) + 8 * v8) == Atom )
        break;
