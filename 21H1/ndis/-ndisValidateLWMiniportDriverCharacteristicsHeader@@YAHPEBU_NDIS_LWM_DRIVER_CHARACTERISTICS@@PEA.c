/*
 * XREFs of ?ndisValidateLWMiniportDriverCharacteristicsHeader@@YAHPEBU_NDIS_LWM_DRIVER_CHARACTERISTICS@@PEAE@Z @ 0x1C0116338
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  v2 = (const struct _GUID *)&unk_1C00CA7D0;
