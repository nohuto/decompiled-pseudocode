/*
 * XREFs of ??1NdisBindBuilderGlobal@@QEAA@XZ @ 0x1C012395C
 * Callers:
 *     ?ndisBindBuilderCleanup@@YAXXZ @ 0x1C01245EC (-ndisBindBuilderCleanup@@YAXXZ.c)
 * Callees:
 *     ??1ProtocolBindProperties@@QEAA@XZ @ 0x1C00ABEA4 (--1ProtocolBindProperties@@QEAA@XZ.c)
 *     ??_GLwfBindProperties@@QEAAPEAXI@Z @ 0x1C00ABF28 (--_GLwfBindProperties@@QEAAPEAXI@Z.c)
 *     ??1?$KStringAtomTableBase@$00@Rtl@@QEAA@XZ @ 0x1C01237DC (--1-$KStringAtomTableBase@$00@Rtl@@QEAA@XZ.c)
 */
