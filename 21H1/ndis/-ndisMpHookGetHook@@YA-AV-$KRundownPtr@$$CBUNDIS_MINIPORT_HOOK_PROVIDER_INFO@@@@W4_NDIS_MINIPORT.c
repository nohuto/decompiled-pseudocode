/*
 * XREFs of ?ndisMpHookGetHook@@YA?AV?$KRundownPtr@$$CBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@@@W4_NDIS_MINIPORT_HOOK_DRIVER_TYPE@@@Z @ 0x1C0126238
 * Callers:
 *     NdisMRegisterWdiMiniportDriver @ 0x1C0125E40 (NdisMRegisterWdiMiniportDriver.c)
 * Callees:
 *     ?TryAcquire@KRundownBase@@QEAA_NXZ @ 0x1C00ABF90 (-TryAcquire@KRundownBase@@QEAA_NXZ.c)
