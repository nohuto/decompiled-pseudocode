/*
 * XREFs of ?ndisMInitializeScatterGatherDmaInternal@@YAHPEAXEKK@Z @ 0x1C0033744
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C0033600 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C00C0D20 (NdisMInitializeScatterGatherDma.c)
 * Callees:
