/*
 * XREFs of IopDevObjApplyPostCreationSettings @ 0x1C010C060
 * Callers:
 *     IoDevObjCreateDeviceSecure @ 0x1C010BF20 (IoDevObjCreateDeviceSecure.c)
 * Callees:
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C010C154 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 */
