/*
 * XREFs of ?moveElements@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@AEAAXKKK@Z @ 0x1C01035C4
 * Callers:
...
NDIS_BIND_LINK_BASE **__fastcall Rtl::KArray<wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>,1>::moveElements(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        int a4)
    ...
    if ( a4 )
    {
      if ( a2 >= a3 )
      {
        ...
        if ( v18 < v24 )
        {
          ...
          do
          {
            wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(*(_QWORD *)(a1 + 8) + 8LL * v18));
            v26 = *(_QWORD *)(a1 + 8);
            v27 = v18 + v19;
            v28 = v27;
            ++v18;
        ...
        if ( v18 < a2 + a4 )
        {
          ...
          do
          {
            result = wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(v30 + *(_QWORD *)(a1 + 8)));
            v30 += 8LL;
            --v31;
          }
          while ( v31 );
      ...
      else
      {
        ...
        if ( v9 > a3 )
        {
          ...
          {
            v15 = v9 - 1;
            wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(*(_QWORD *)(a1 + 8) + 8 * v15));
            v16 = *(_QWORD *)(a1 + 8);
            v17 = v9 - v10 - 1;
        ...
        while ( v9 > a2 )
          result = wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'((NDIS_BIND_LINK_BASE **)(*(_QWORD *)(a1 + 8) + 8LL * --v9));
      }
    }
  }
  return result;
