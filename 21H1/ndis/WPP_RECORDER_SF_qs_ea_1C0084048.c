/*
 * XREFs of WPP_RECORDER_SF_qs @ 0x1C0084048
 * Callers:
        ...
        const char *a7)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    if ( !a7 )
      v13 = "NULL";
    ndisWppFastTraceMessage(&WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids, a4, &a6, 8LL, v13, v12, 0LL);
  }
  if ( v7 )
  {
    do
  ...
  LOWORD(v15) = a4;
  return WppAutoLogTrace(a1, 4LL, 14LL, &WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids, v15, &a6);
}
