/*
 * XREFs of NdisSetSessionCompartmentId @ 0x1C00B09D0
 * Callers:
 *     ?ndisNsiSetAllSessionInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C00B0980 (-ndisNsiSetAllSessionInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z.c)
 * Callees:
 ...
 *     ?ndisCmLazyInitializeCleanup@@YAXXZ @ 0x1C00B083C (-ndisCmLazyInitializeCleanup@@YAXXZ.c)
 */
...
__int64 __fastcall NdisSetSessionCompartmentId(unsigned int a1, unsigned int a2)
{
  ...
  v7 = v6;
  v8 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E49C8);
  ...
  else
  {
    ...
    if ( !PoolWithTag )
    {
      KeReleaseSpinLock(&qword_1C00E49C8, v8);
      if ( v5 )
    ...
    if ( P )
    {
      memmove(PoolWithTag, P, 24LL * (unsigned int)dword_1C00E6060);
      ExFreePoolWithTag(v12, 0);
    }
    memset(&PoolWithTag[24 * dword_1C00E6060], 0, 24LL * (unsigned int)(v6 - dword_1C00E6060));
...
LABEL_21:
  ...
  _InterlockedExchangeAdd(&dword_1C00E6058, 2u);
  return 0LL;
}
