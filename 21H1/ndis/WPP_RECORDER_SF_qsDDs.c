/*
 * XREFs of WPP_RECORDER_SF_qsDDs @ 0x1C0072604
 * Callers:
 *     ndisRssPmObjectHeaderFixup @ 0x1C0023A1C (ndisRssPmObjectHeaderFixup.c)
 * Callees:
        ...
        const char *a10)
{
  ...
  LOWORD(v23) = a4;
  return WppAutoLogTrace(a1, 2LL, 1LL, &WPP_60844eb21a8f3cfcca037c14d27ddc90_Traceguids, v23, &a6);
}
