/*
 * XREFs of ndisDispatchRequest @ 0x1C001D380
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisCheckAccess@@YAEPEAU_IRP@@PEAU_IO_STACK_LOCATION@@PEAX@Z @ 0x1C001D52C (-ndisCheckAccess@@YAEPEAU_IRP@@PEAU_IO_STACK_LOCATION@@PEAX@Z.c)
...
LABEL_7:
      ...
      case 0x12u:
        ...
        _InterlockedDecrement(&dword_1C00E5FAC);
        goto LABEL_7;
      case 0x17u:
  ...
  else
  {
    ...
    *((_BYTE *)PoolWithTag + 1) = ndisCheckAccess(a2, CurrentStackLocation, &unk_1C00E5D18);
    CurrentStackLocation->FileObject->FsContext = PoolWithTag;
    _InterlockedIncrement(&dword_1C00E5FAC);
  }
  if ( v4 != 259 )
    goto LABEL_7;
LABEL_8:
