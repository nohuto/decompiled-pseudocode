/*
 * XREFs of NdisAllocateNetBufferListPool @ 0x1C0026CA0
 * Callers:
        ...
        PNET_BUFFER_LIST_POOL_PARAMETERS Parameters)
{
  ...
  if ( Pool )
  {
    ...
    *((_DWORD *)Pool + 24) = v12;
    ...
    v14 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5D48);
    v15 = qword_1C00E5FD8;
    v16 = v5 + 9;
    if ( *(__int64 **)(qword_1C00E5FD8 + 8) != &qword_1C00E5FD8 )
      __fastfail(3u);
    *v16 = qword_1C00E5FD8;
    v5[10] = (KSPIN_LOCK)&qword_1C00E5FD8;
    *(_QWORD *)(v15 + 8) = v16;
    qword_1C00E5FD8 = (__int64)(v5 + 9);
    KeReleaseSpinLock(&qword_1C00E5D48, v14);
    v5[6] = retaddr;
  }
LABEL_16:
