/*
 * XREFs of WPP_RECORDER_SF_sZZ @ 0x1C0075FA4
 * Callers:
        ...
        unsigned __int16 *a8)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x1000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    ndisWppFastTraceMessage(
      &WPP_8b0ab799cd8539b5ce5df5ce3671a55c_Traceguids,
      a4,
      v20,
      v19,
      v17,
  ...
  if ( !a6 )
    v8 = "NULL";
  LOWORD(v22) = a4;
  return WppAutoLogTrace(v10, 4LL, 13LL, &WPP_8b0ab799cd8539b5ce5df5ce3671a55c_Traceguids, v22, v8);
}
