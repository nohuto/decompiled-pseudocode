/*
 * XREFs of ?ndisWdfSelectiveSuspendResumeOperations@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C00A7DE4
 * Callers:
 ...
 *     NdisWdfAsyncPowerReferenceCompleteNotification @ 0x1C01215C0 (NdisWdfAsyncPowerReferenceCompleteNotification.c)
 * Callees:
...
void __fastcall ndisWdfSelectiveSuspendResumeOperations(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, char a3)
{
  ...
  *((_QWORD *)SelectiveSuspend + 71) = (char *)SelectiveSuspend + 560;
  ...
  if ( v8 )
  {
    if ( a3 )
    {
      if ( byte_1C00E3EA8 && (*((_DWORD *)&a1->PktMonComp + 3) & 2) != 0 )
