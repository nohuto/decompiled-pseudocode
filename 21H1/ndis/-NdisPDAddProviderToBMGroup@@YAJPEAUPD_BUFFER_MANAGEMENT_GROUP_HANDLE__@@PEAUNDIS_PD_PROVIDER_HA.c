/*
 * XREFs of ?NdisPDAddProviderToBMGroup@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@PEAUNDIS_PD_PROVIDER_HANDLE__@@@Z @ 0x1C0119400
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_PROVIDER_HANDLE__ *a2)
{
  ...
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qq(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      (char)a1,
      a2);
  v13.m_Lock = (KPushLockBase *)qword_1C00E43F8;
  ...
  {
    if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)i + 6) + 5472LL) + 72LL) != *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v8 + 32)
                                                                                               + 5472LL)
                                                                                   + 72LL) )
    {
      v2 = -1073740007;
