/*
 * XREFs of ?ndisXlateWakeUpPatternListToWolPatternList@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0095B3C
 * Callers:
 *     ?ndisOidPostWolPatternList@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0091010 (-ndisOidPostWolPatternList@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
