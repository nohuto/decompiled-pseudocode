/*
 * XREFs of ?ndisLoadNetworkInterfaceFromPersistedState@@YAJAEBU_GUID@@AEAVKRegKey@@1@Z @ 0x1C01056C4
 * Callers:
 ...
 *     ??1NdisNetworkInterfacePersistedState@@QEAA@XZ @ 0x1C0038D2C (--1NdisNetworkInterfacePersistedState@@QEAA@XZ.c)
