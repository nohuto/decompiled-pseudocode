/*
 * XREFs of NdisDllInitialize @ 0x1C0035ED0
 * Callers:
 *     DriverEntry @ 0x1C01438B0 (DriverEntry.c)
 * Callees:
 *     memset @ 0x1C003F6C0 (memset.c)
 *     ?NdispRegisterShim@@YAXXZ @ 0x1C0109388 (-NdispRegisterShim@@YAXXZ.c)
 *     ?ndisInitializePerProcessorSlotAllocator@@YAXXZ @ 0x1C0146208 (-ndisInitializePerProcessorSlotAllocator@@YAXXZ.c)
 *     ?ndisCpuInitializeSubsystemPhase1@@YAXXZ @ 0x1C0146270 (-ndisCpuInitializeSubsystemPhase1@@YAXXZ.c)
 */
...
__int64 NdisDllInitialize()
{
  ...
  if ( !ndisDllInitialized )
  {
    ...
    if ( ndisMaxNumberOfProcessors > 0x100 )
    {
      ...
      qword_1C00E61A0 = (__int64)PoolWithTag;
      if ( PoolWithTag )
