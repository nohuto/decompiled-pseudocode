/*
 * XREFs of ?ndisFdoInitializeSubsystem@@YAJXZ @ 0x1C01462BC
 * Callers:
 ...
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x1C014641C (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 */
