/*
 * XREFs of ndisIfCreateCompartmentBlock @ 0x1C00345B0
 * Callers:
 ...
 *     ndisIfFindAvailableCompartmentId @ 0x1C00B27EC (ndisIfFindAvailableCompartmentId.c)
 */
...
LABEL_8:
    ...
    if ( !v5 )
    {
      ...
      *(_QWORD *)(v17 + 8) = v12;
      *v16 = (__int64)v12;
      _InterlockedIncrement(&dword_1C00E5FE8);
    }
LABEL_14:
    KeReleaseSpinLock(&ndisIfListLock, v14);
    if ( v5 >= 0 )
