/*
 * XREFs of ?ndisCopyPacketInfoToNBL@@YAXPEAU_NDIS_PACKET@@PEAU_NET_BUFFER_LIST@@W4_NDIS_XLATE_TYPE@@@Z @ 0x1C0074998
 * Callers:
 ...
 * Callees:
 *     ndisIPsecPktInfoToNBLInfo @ 0x1C0074AFC (ndisIPsecPktInfoToNBLInfo.c)
 */
