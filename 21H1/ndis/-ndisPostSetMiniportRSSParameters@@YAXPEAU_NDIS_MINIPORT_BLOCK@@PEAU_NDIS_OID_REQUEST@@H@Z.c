/*
 * XREFs of ?ndisPostSetMiniportRSSParameters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1C0037B84
 * Callers:
 ...
 *     ?ndisPcwAddCyclesToCycleCounter@@YAXPEAUNDIS_PCW_CONTEXT@@K_K1@Z @ 0x1C008E9E8 (-ndisPcwAddCyclesToCycleCounter@@YAXPEAUNDIS_PCW_CONTEXT@@K_K1@Z.c)
 */
