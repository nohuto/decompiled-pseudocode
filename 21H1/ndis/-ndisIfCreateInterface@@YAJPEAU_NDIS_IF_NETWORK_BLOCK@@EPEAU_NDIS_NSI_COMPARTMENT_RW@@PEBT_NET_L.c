/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEBT_NET_LUID_LH@@PEBU_GUID@@PEBUNdisNetworkInterfacePersistedState@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C0105778
 * Callers:
 ...
 *     ?ndisIfNdisProviderGetHandle@@YAPEAX_N@Z @ 0x1C002BE7C (-ndisIfNdisProviderGetHandle@@YAPEAX_N@Z.c)
...
LABEL_71:
          ...
          *(_QWORD *)(v13 + 632) = 1LL;
          if ( v44 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E44C2);
            ...
            *(_WORD *)(v13 + 48) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E46D2);
            *(_DWORD *)&Destination.Length = 0x2000000;
