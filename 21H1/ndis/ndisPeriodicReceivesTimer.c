/*
 * XREFs of ndisPeriodicReceivesTimer @ 0x1C00A33D0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  v4 = 0LL;
  v5 = (char *)qword_1C00E4000 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
  ...
  *v4 = 0LL;
  ...
  {
LABEL_5:
    *((_DWORD *)qword_1C00E3FF8 + KeGetPcr()->Prcb.Number) = 0;
  }
  else
  {
    v8.QuadPart = qword_1C00E3FE8;
    if ( !qword_1C00E3FE8 )
      v8.QuadPart = -1LL;
    KeSetTimer(
...
LABEL_12:
  ...
  if ( v4 )
  {
    ...
    if ( (_BYTE)word_1C00E6054 )
    {
      ...
      v10 = 48;
      *(_QWORD *)v12 = 0LL;
      *(_QWORD *)((char *)&v11 + 6) = qword_1C00E6048;
