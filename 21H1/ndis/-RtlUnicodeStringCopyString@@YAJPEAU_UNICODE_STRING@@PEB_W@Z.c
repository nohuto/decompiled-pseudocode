/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEB_W@Z @ 0x1C001D884
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x1C001D8EC (RtlWideCharArrayCopyStringWorker.c)
