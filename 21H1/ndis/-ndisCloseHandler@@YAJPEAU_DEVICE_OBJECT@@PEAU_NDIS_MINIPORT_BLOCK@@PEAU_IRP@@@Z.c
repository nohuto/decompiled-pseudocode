/*
 * XREFs of ?ndisCloseHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C006A838
 * Callers:
 *     NdisWdfCloseIrpHandler @ 0x1C0061410 (NdisWdfCloseIrpHandler.c)
 * Callees:
