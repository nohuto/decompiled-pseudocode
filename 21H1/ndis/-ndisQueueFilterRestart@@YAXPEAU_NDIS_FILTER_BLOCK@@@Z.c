/*
 * XREFs of ?ndisQueueFilterRestart@@YAXPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C0116740
 * Callers:
 *     NdisFRestartFilter @ 0x1C006A490 (NdisFRestartFilter.c)
 *     ?ndisQueuedRestartFilter@@YAXPEAX@Z @ 0x1C0116870 (-ndisQueuedRestartFilter@@YAXPEAX@Z.c)
 * Callees:
