/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddresses@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00B39B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisNsiEnumerateAllIfRcvAddressesInOneInterface @ 0x1C00B3AFC (ndisNsiEnumerateAllIfRcvAddressesInOneInterface.c)
 */
...
__int64 __fastcall ndisNsiEnumerateAllIfRcvAddresses(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  {
    InterfaceByNetLuid = (struct _NDIS_IF_BLOCK *)ndisIfFindInterfaceByNetLuid((union _NET_LUID_LH)v4->Value);
