/*
 * XREFs of ?ndisFilterAttachCleanUp@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C0067D70
 * Callers:
 ...
 *     NdisIfDeregisterInterface @ 0x1C01268A0 (NdisIfDeregisterInterface.c)
 */
