/*
 * XREFs of ?ndisWmiChangeSingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@QEAUtagWNODE_SINGLE_INSTANCE@@@Z @ 0x1C008BF50
 * Callers:
 *     ndisWMIDispatch @ 0x1C0010B00 (ndisWMIDispatch.c)
 *     NdisWdfChangeSingleInstance @ 0x1C00613F0 (NdisWdfChangeSingleInstance.c)
 * Callees:
