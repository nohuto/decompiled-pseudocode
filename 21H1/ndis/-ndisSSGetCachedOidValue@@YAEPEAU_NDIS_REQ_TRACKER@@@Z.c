/*
 * XREFs of ?ndisSSGetCachedOidValue@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C00A6124
 * Callers:
 *     ?ndisOidPreGenStats@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0005D50 (-ndisOidPreGenStats@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
 *     ?ndisOidPreStatistics@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C009D970 (-ndisOidPreStatistics@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
 *     memmove @ 0x1C003F400 (memmove.c)
 *     ?ndisSSGetOidCacheEntry@@YAPEAU_NDIS_OID_CACHE_ENTRY@@PEAU_NDIS_SELECTIVE_SUSPEND@@K@Z @ 0x1C00A61BC (-ndisSSGetOidCacheEntry@@YAPEAU_NDIS_OID_CACHE_ENTRY@@PEAU_NDIS_SELECTIVE_SUSPEND@@K@Z.c)
 */
