/*
 * XREFs of ?ndisUpdateRcvFilterQueueParameters@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_QUEUE_PARAMETERS@@@Z @ 0x1C0086FC8
 * Callers:
 ...
 *     ?ndisOidPostRcvFilterQueueParameters@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0085450 (-ndisOidPostRcvFilterQueueParameters@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
