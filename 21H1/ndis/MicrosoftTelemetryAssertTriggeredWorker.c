/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00C5C5C
 * Callers:
 ...
 *     GetImageTuple @ 0x1C00C5BDC (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C00C61BC (_tlgCreate1Sz_char.c)
 */
...
LABEL_35:
  ...
  if ( (unsigned int)dword_1C00F7040 > 5 && tlgKeywordOn((__int64)&dword_1C00F7040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)dword_1C00CFDC3,
      0LL,
      v27,
      0xBu,
      &v66);
  ...
  if ( dword_1C00F7078 && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C00F7040 > 5 && tlgKeywordOn((__int64)&dword_1C00F7040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C00F7040,
        (unsigned __int8 *)dword_1C00CFE30,
        v30,
        0LL,
        v31,
        &v50);
