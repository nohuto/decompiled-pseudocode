/*
 * XREFs of ?ndisXlateSendNetBufferListsToPacketArray@@YAEPEAU_NDIS_NBLS_TO_PKT_ARRAY@@E@Z @ 0x1C00753F8
 * Callers:
 ...
 *     NdisGetNetBufferListProtocolId @ 0x1C00ACA50 (NdisGetNetBufferListProtocolId.c)
 */
...
char __fastcall ndisXlateSendNetBufferListsToPacketArray(struct _NDIS_NBLS_TO_PKT_ARRAY *a1, char a2)
{
  ...
  $F83BCD1696991B5C8018F054401D87EA *v27; // rax
