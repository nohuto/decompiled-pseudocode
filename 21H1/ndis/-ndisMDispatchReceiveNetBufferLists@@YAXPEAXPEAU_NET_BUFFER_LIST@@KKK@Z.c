/*
 * XREFs of ?ndisMDispatchReceiveNetBufferLists@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z @ 0x1C0098E20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  v17 = (struct _NDIS_OPEN_BLOCK *)v15[41];
  if ( v17 && v17->ProtocolHandle->MajorNdisVersion >= 6u )
  {
    ndisMIndicateNetBufferListsToOpen(v17, a2, (char *)a3, a4, a5);
    ...
    *((_DWORD *)PoolWithTag + 11) = a4;
    ...
    if ( *((_QWORD *)PoolWithTag + 8) || *((_DWORD *)PoolWithTag + 172) )
    {
      ...
      if ( !v17 )
      {
        ...
        v26 = (struct _NDIS_OPEN_BLOCK *)v15[2];
        if ( v26 )
        {
          if ( (a5 & 2) != 0 )
          {
...
LABEL_38:
    if ( a2 )
    {
      if ( byte_1C00E3EA8 && (*(_DWORD *)&a1[1455] & 2) != 0 )
        PktMonClientNblDropNdis((_DWORD)a1 + 5808, (_DWORD)a2, v18, 1, -1073676270, -536866809);
      if ( (v5 & 2) == 0 )
