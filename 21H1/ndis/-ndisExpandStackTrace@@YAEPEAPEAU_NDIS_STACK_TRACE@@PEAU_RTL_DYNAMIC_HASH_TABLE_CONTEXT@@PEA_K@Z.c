/*
 * XREFs of ?ndisExpandStackTrace@@YAEPEAPEAU_NDIS_STACK_TRACE@@PEAU_RTL_DYNAMIC_HASH_TABLE_CONTEXT@@PEA_K@Z @ 0x1C00BE63C
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  else
  {
    ...
    *((_OWORD *)PoolWithTag + 3) = *((_OWORD *)a3 + 1);
    ...
    RtlInsertEntryHashTable((PRTL_DYNAMIC_HASH_TABLE)&WPP_MAIN_CB.Dpc.DpcData, v9, v3->Signature, a2);
    *a1 = v9;
