/*
 * XREFs of ?ndisReadProtocolById@@YAJAEBU_GUID@@@Z @ 0x1C0125410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisReadProtocolById(const struct _GUID *a1)
{
  ...
  {
    m_ptr = (void **)&v5;
    v2 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3568, (__int64)v9);
    if ( !v2 )
    {
      v2 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3490, (__int64)v11);
      if ( !v2 )
      {
        v2 = NetSetupPropertyBag::ReadString(
               (NetSetupPropertyBag *)&m_ptr,
               (const struct _NETSETUPPROPKEY *)&unk_1C00D35C8,
               &v8);
        if ( !v2 )
        {
          v2 = NetSetupPropertyBag::ReadBoolean(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3550, &v13);
          if ( !v2 )
          {
            if ( Rtl::KArray<ProtocolBindProperties,1>::append((__int64)qword_1C00E4498 + 24, (__int64)&v7) )
              v2 = 0;
            else
              v2 = -1073741670;
          }
