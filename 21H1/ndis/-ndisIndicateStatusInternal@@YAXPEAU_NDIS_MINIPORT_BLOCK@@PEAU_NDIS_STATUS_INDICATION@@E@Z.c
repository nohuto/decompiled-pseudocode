/*
 * XREFs of ?ndisIndicateStatusInternal@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_STATUS_INDICATION@@E@Z @ 0x1C001C4F8
 * Callers:
...
LABEL_38:
      switch ( v8 )
      {
        ...
        case 1073807384:
          v72 = 1;
          if ( *(_DWORD *)v78 >= 4u && (byte_1C00E6085 & 1) != 0 )
