        ...
        ULONG ReceiveFlags)
{
  ...
  if ( *((_BYTE *)MiniportAdapterHandle + 2664) )
  {
    ...
    if ( byte_1C00E3EA8 )
    {
      v18 = *((_QWORD *)MiniportAdapterHandle + 729);
      if ( v18 )
      {
        if ( (*(_DWORD *)(v18 + 12) & 1) != 0 )
          PktMonClientNblLogNdis((char *)MiniportAdapterHandle + 5824, NetBufferList, *(_QWORD *)&PortNumber, 1LL);
      }
    }
    ...
    if ( v14 && *(_DWORD *)ndisNblTrackerMode )
      ndisNblTrackerTransferOwnershipInternal(
        ...
        *((_QWORD *)MiniportAdapterHandle + 510),
        0x8Eu,
        v13);
    if ( (Microsoft_Windows_Networking_CorrelationEnabled || byte_1C00E3EA8) && v14 )
      ndisMarkNetBufferListCorrelationIdsAsUsed(NetBufferList);
  }
  else
  {
    if ( byte_1C00E3EA8 && (*((_DWORD *)MiniportAdapterHandle + 1455) & 2) != 0 )
