/*
 * XREFs of ndisIfCreateNetworkBlock @ 0x1C0034A50
 * Callers:
 ...
 *     ndisCompareGuid @ 0x1C002BBA4 (ndisCompareGuid.c)
...
__int64 __fastcall ndisIfCreateNetworkBlock(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  *((_OWORD *)v13 + 2) = v14;
  ...
  while ( v11 );
  *v15 = *(_OWORD *)a3;
  for ( i = (__int64 *)qword_1C00E49E8; i != &qword_1C00E49E8; i = (__int64 *)*i )
  {
...
LABEL_41:
  ...
  if ( !byte_1C00E60D1 )
  {
    v20 = dword_1C00E36D8 ^ (dword_1C00E36D8 ^ (dword_1C00E36D8 + 1)) & 0xFFFFFFF;
    dword_1C00E36D8 = v20;
...
LABEL_32:
  ...
  {
    for ( j = qword_1C00E49E8; (__int64 *)j != &qword_1C00E49E8; j = *(_QWORD *)j )
    {
      if ( v21 == *(_DWORD *)(j + 88) )
        goto LABEL_32;
    }
