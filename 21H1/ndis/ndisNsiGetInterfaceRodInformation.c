/*
 * XREFs of ndisNsiGetInterfaceRodInformation @ 0x1C00F97E0
 * Callers:
 ...
 *     ?ndisNsiPostGetInterfaceRodInformation@@YAXPEAU_NDIS_IF_BLOCK@@IKPEAX@Z @ 0x1C01276B4 (-ndisNsiPostGetInterfaceRodInformation@@YAXPEAU_NDIS_IF_BLOCK@@IKPEAX@Z.c)
 */
