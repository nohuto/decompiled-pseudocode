/*
 * XREFs of CmRegUtilCreateWstrKey @ 0x1C0128D18
 * Callers:
 *     PiRegStateOpenClassKey @ 0x1C0128648 (PiRegStateOpenClassKey.c)
 *     PpRegStateUpdateStackCreationSettings @ 0x1C0128B3C (PpRegStateUpdateStackCreationSettings.c)
 * Callees:
 *     WdmlibRtlInitUnicodeStringEx @ 0x1C0035780 (WdmlibRtlInitUnicodeStringEx.c)
 *     CmRegUtilCreateUcKey @ 0x1C0128C70 (CmRegUtilCreateUcKey.c)
 */
