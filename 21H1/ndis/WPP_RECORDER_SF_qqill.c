/*
 * XREFs of WPP_RECORDER_SF_qqill @ 0x1C00BCF18
 * Callers:
 *     NdisSetCoalescableTimerObject @ 0x1C00BCB70 (NdisSetCoalescableTimerObject.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_qqill(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x800) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_3fc6b276cd8231b73bc2bba727581b13_Traceguids,
      0xBu,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 11;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_3fc6b276cd8231b73bc2bba727581b13_Traceguids, v7, (__int64 *)va);
}
