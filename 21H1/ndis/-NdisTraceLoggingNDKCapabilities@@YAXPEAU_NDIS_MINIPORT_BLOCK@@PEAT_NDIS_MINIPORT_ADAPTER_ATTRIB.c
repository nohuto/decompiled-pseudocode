/*
 * XREFs of ?NdisTraceLoggingNDKCapabilities@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAT_NDIS_MINIPORT_ADAPTER_ATTRIBUTES@@@Z @ 0x1C001F834
 * Callers:
        ...
        __int64 a4)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C00E30F8, 0x200000000000LL, a3, a4) )
    {
