/*
 * XREFs of ?Reload@BindRegistry@Ndis@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4Flags@ReadBindingsOptions@2@@Z @ 0x1C0107B78
 * Callers:
 ...
 *     ??0BindStack@Ndis@@QEAA@XZ @ 0x1C0108084 (--0BindStack@Ndis@@QEAA@XZ.c)
        ...
        enum Ndis::ReadBindingsOptions::Flags a3)
{
  ...
  v5 = 0;
  if ( *((_BYTE *)qword_1C00E4498 + 97) && !ndisBuildBindings((const struct _GUID *)((char *)this + 4008), &v9)
