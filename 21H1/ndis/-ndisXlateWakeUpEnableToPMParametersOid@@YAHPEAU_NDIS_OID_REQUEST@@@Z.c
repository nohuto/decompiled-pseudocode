/*
 * XREFs of ?ndisXlateWakeUpEnableToPMParametersOid@@YAHPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C0095AE4
 * Callers:
 *     ?ndisOidPostPMParameters@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C003B440 (-ndisOidPostPMParameters@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
