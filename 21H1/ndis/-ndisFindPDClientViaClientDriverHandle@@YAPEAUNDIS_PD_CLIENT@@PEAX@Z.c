/*
 * XREFs of ?ndisFindPDClientViaClientDriverHandle@@YAPEAUNDIS_PD_CLIENT@@PEAX@Z @ 0x1C011C4E4
 * Callers:
...
struct NDIS_PD_CLIENT *__fastcall ndisFindPDClientViaClientDriverHandle(void *a1)
{
  ...
  v2 = 0LL;
  v5.m_Lock = (KPushLockBase *)qword_1C00E43F8;
  v5.m_State = Unlocked;
  v5.m_Region.m_Entered = 0;
  KLockHolder::AcquireExclusive(&v5);
  v3 = *(__int64 **)(qword_1C00E43F8 + 8);
  while ( v3 != (__int64 *)(qword_1C00E43F8 + 8) )
  {
    v2 = v3;
    if ( (void *)v3[10] == a1 )
      break;
