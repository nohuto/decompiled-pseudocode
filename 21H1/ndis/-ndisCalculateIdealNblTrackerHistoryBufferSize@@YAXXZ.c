/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C011760C
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C0144F5C (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C003D4C0 (__security_check_cookie.c)
 *     memset @ 0x1C003F6C0 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C01472B0 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
