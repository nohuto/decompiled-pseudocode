/*
 * XREFs of WPP_RECORDER_SF_qsD @ 0x1C0084170
 * Callers:
...
__int64 WPP_RECORDER_SF_qsD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
  {
    ...
    if ( !v15 )
      v10 = "NULL";
    ndisWppFastTraceMessage(&WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids, 0x9Cu, va, 8LL, v10, v9, va1, 4LL, 0LL);
  }
  if ( v5 )
  {
    do
  ...
  LOWORD(v12) = 156;
  return WppAutoLogTrace(a1, 2LL, 14LL, &WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids, v12, (__int64 *)va);
}
