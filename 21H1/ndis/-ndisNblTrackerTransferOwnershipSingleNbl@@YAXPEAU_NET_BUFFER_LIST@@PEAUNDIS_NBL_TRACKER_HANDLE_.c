/*
 * XREFs of ?ndisNblTrackerTransferOwnershipSingleNbl@@YAXPEAU_NET_BUFFER_LIST@@PEAUNDIS_NBL_TRACKER_HANDLE__@@1E@Z @ 0x1C0073CAC
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  v7 = (void *)ndisSourceHandleFromOwner(v6);
  if ( (v6 & 1) != 0 )
    v6 |= 2LL * (v3 & 1);
