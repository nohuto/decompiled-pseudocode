/*
 * XREFs of ?ndisMSendCompletePacketToNetBufferLists@@YAXPEAXPEAU_NDIS_PACKET@@H@Z @ 0x1C00C2B5C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v5 )
  {
    ...
    ndisInvokeNextSendCompleteHandler(
      ...
      0,
      a1,
      (struct _NDIS_OBJECT_HEADER *)a1[3].FilterModuleContext,
      a1[3].NextFilter,
      (void (*)(void))a1[3].FilterFriendlyName);
  }
}
