/*
 * XREFs of NdisGetThreadObjectCompartmentScope @ 0x1C0005DD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    v14 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E49C8);
    if ( ThreadSessionId < dword_1C00E6060 )
      v8 = *((_DWORD *)P + 6 * ThreadSessionId);
    KeReleaseSpinLock(&qword_1C00E49C8, v14);
    if ( !v8 )
      v8 = 1;
    result = v8;
  }
