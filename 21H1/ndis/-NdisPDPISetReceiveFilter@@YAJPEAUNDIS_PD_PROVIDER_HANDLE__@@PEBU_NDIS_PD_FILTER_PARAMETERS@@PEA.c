/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C011BA30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_FILTER@@QEAAPEAXI@Z @ 0x1C0119250 (--_GNDIS_PD_FILTER@@QEAAPEAXI@Z.c)
 */
        ...
        if ( v13 <= 0xFFFFFFFF )
        {
          ...
          if ( (unsigned int)v13 <= HeaderGroupMatchArrayTotalSize )
          {
            ...
            *((_QWORD *)v4 + 12) = a2->RxFilterContext;
            v26.m_Lock = (KPushLockBase *)qword_1C00E43F8;
