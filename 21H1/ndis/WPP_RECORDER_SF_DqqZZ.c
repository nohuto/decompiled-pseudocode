/*
 * XREFs of WPP_RECORDER_SF_DqqZZ @ 0x1C003C9C4
 * Callers:
...
__int64 __fastcall WPP_RECORDER_SF_DqqZZ(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6, char a7)
{
  ...
  {
    v9 = &a7;
    ndisWppFastTraceMessage(&WPP_3188c4384181338fe0d477b94428bcd6_Traceguids, 0xBu, v10);
  }
  LOWORD(v9) = 11;
  return WppAutoLogTrace(a1, 4LL, 9LL, &WPP_3188c4384181338fe0d477b94428bcd6_Traceguids, (_DWORD)v9, v10);
}
