/*
 * XREFs of ?ndisMInitializeMiniportBlockFront@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1C0130E88
 * Callers:
 ...
 * Callees:
 *     ?ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x1C0031B4C (-ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
