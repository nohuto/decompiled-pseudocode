/*
 * XREFs of ?NdisTraceLoggingPacketDirectConfigChanged@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C001E358
 * Callers:
...
void __fastcall NdisTraceLoggingPacketDirectConfigChanged(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, __int64 a3)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C00E30F8, 0x200000000000LL, a3, (unsigned __int8)a3) )
    {
      v10 = v5;
      v9 = v7 + 4008;
      v8 = v6;
