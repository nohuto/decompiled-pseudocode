...
__int64 __fastcall ndisMInvokeOidRequest(struct _NDIS_FILTER_BLOCK *a1, struct _NDIS_OID_REQUEST *a2)
{
  ...
  v3 = *(_NDIS_M_DRIVER_BLOCK **)&a1[4].MediaType;
  ...
  if ( v6 )
    goto LABEL_25;
  v10 = *(_NDIS_M_DRIVER_BLOCK **)&a1[4].MediaType;
  if ( v35 )
    v4 = v35;
  ...
  if ( !value || value->OidRequestHandler == v10->MiniportDriverCharacteristics.OidRequestHandler )
    SpinLock = (NDISWATCHDOG__ *)a1[6].PnPRef.SpinLock;
  else
    SpinLock = *(NDISWATCHDOG__ **)&a1[6].PnPRef.ReferenceCount;
  if ( SpinLock != (NDISWATCHDOG__ *)-1LL )
  {
    v13 = WatchdogFromHandle(SpinLock);
    ndisWaitForKernelObject(v13 + 42);
  }
  OidRequestHandler = v3->MiniportDriverCharacteristics.OidRequestHandler;
  v15 = 35000;
  if ( SpinLock != (NDISWATCHDOG__ *)-1LL )
  {
    v16 = WatchdogFromHandle(SpinLock);
...
LABEL_16:
  v23 = *(_NDIS_M_DRIVER_BLOCK **)&a1[4].MediaType;
    ...
    if ( ndisIsMiniportVerified(v3) )
    {
      ...
      v26 = (*((__int64 (__fastcall **)(void *, struct _NDIS_OID_REQUEST *, struct _NDIS_FILTER_BLOCK *, void *, int (__fastcall *)(void *, _NDIS_OID_REQUEST *)))ndisVerifierNdisDispatch
             + 3))(
              ...
              v4,
              a1,
              *(void **)a1[5].InterfaceGuid.Data4,
              v3->MiniportDriverCharacteristics.OidRequestHandler);
      v9 = v26;
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_23;
      v29 = 231;
      ...
      if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_qDq(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
          ...
          v33,
          v4);
      v26 = v3->MiniportDriverCharacteristics.OidRequestHandler(a1->FilterModuleContext, v4);
      v9 = v26;
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_23;
      v29 = 233;
...
LABEL_23:
  if ( v9 == 259 )
    return v9;
  ndisDisarmWatchdogAsync(SpinLock);
LABEL_25:
  if ( v9 != 259 && v8 )
