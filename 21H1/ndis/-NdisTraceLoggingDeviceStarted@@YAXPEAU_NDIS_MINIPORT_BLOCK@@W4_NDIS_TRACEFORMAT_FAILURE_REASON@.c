/*
 * XREFs of ?NdisTraceLoggingDeviceStarted@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@J@Z @ 0x1C0021EDC
 * Callers:
...
void __fastcall NdisTraceLoggingDeviceStarted(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( (int)a3 < 0 )
  {
    if ( (unsigned int)dword_1C00E30F8 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C00E30F8, 0x200000000000LL, a3, 5LL) )
    {
      v26 = a2;
      v33 = 4;
      v35 = (char *)(v21 + 4008);
      ...
      goto LABEL_9;
         ...
         && (unsigned __int8)tlgKeywordOn(&dword_1C00E30F8, 0x200000000000LL, a3, 5LL) )
  {
    v6 = v4 - 1;
    v7 = *(_DWORD *)(v5 + 4064);
    v8 = v4 - 4;
...
LABEL_9:
    ...
    v34 = 0;
    v31 = 0;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C00E30F8, (int)v13, 0, 0, v23, &v28);
  }
}
