/*
 * XREFs of ?ndisAddWoLDirectedMAC@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C011F2F0
 * Callers:
...
__int64 __fastcall ndisAddWoLDirectedMAC(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  _NDIS_IF_BLOCK *ReturnNetBufferListsHandler; // rcx
  ...
  if ( ndisDirectedMacForNapsState )
  {
    ...
    ReturnNetBufferListsHandler = (_NDIS_IF_BLOCK *)a1[4].Characteristics.ReturnNetBufferListsHandler;
    v6 = BitMapHeader;
    *(_DWORD *)BitMapHeader = *(_DWORD *)ReturnNetBufferListsHandler->ifPhysAddress.Address;
    *((_WORD *)v6 + 2) = *(_WORD *)&ReturnNetBufferListsHandler->ifPhysAddress.Address[4];
    ...
    *(_QWORD *)&v11.NdisReserved[32] = &ndisIntReqGeneric;
    ...
    {
      *((_BYTE *)PendingOidRequest + 1104) = 1;
    }
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_qd(
        *((_QWORD *)WPP_GLOBAL_Control + 8),
