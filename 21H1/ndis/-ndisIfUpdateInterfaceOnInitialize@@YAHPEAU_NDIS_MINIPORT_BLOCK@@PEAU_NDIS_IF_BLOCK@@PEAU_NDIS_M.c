/*
 * XREFs of ?ndisIfUpdateInterfaceOnInitialize@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_IF_BLOCK@@PEAU_NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES@@@Z @ 0x1C002F9FC
 * Callers:
 ...
 *     ndisNsiSyncMiniportMediaConnectStateNotification @ 0x1C0106A3C (ndisNsiSyncMiniportMediaConnectStateNotification.c)
