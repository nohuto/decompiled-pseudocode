/*
 * XREFs of ?ndisIfLuidAllocatorSubsystemInitialize@@YAJXZ @ 0x1C0145124
 * Callers:
...
NTSTATUS ndisIfLuidAllocatorSubsystemInitialize(void)
{
  ...
  Status = 0;
  qword_1C00E5E30 = (__int64)&qword_1C00E5E28;
  qword_1C00E5E28 = (__int64)&qword_1C00E5E28;
        ...
        if ( !Status )
        {
          ...
          *((_WORD *)PoolWithTag + 8) = Length;
          ...
          if ( *(__int64 **)(qword_1C00E5E28 + 8) != &qword_1C00E5E28 )
            __fastfail(3u);
          *PoolWithTag = qword_1C00E5E28;
          PoolWithTag[1] = &qword_1C00E5E28;
          *(_QWORD *)(v5 + 8) = PoolWithTag;
          qword_1C00E5E28 = (__int64)PoolWithTag;
        }
      }
