/*
 * XREFs of ?ndisMIndicateOffloadChange@@YAEPEAU_NDIS_MINIPORT_BLOCK@@KPEAXK@Z @ 0x1C0020378
 * Callers:
...
char __fastcall ndisMIndicateOffloadChange(struct _NDIS_MINIPORT_BLOCK *a1, int a2, _WORD *a3, unsigned int a4)
{
  ...
  if ( Offload && a4 >= 0x70 && *(_BYTE *)a3 == 0xA7 && a3[1] >= 0x70u && *((_BYTE *)a3 + 1) )
  {
    ...
    {
      v13 = Offload->MiniportHardwareCapabilities.Flags & 1;
      ...
      v14 = a1->Offload;
      Flags = v14->MiniportHardwareCapabilities.Flags;
      if ( v13 )
        v16 = Flags | 1;
      else
        v16 = Flags & 0xFFFFFFFE;
      v14->MiniportHardwareCapabilities.Flags = v16;
