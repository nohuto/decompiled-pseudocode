/*
 * XREFs of WPP_RECORDER_SF_qqZddZD @ 0x1C0029BD0
 * Callers:
...
__int64 WPP_RECORDER_SF_qqZddZD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x100) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    ndisWppFastTraceMessage(
      &WPP_3188c4384181338fe0d477b94428bcd6_Traceguids,
      0x19u,
      va,
      8LL,
      va1,
  ...
  LOWORD(v13) = 25;
  return WppAutoLogTrace(a1, 4LL, 9LL, &WPP_3188c4384181338fe0d477b94428bcd6_Traceguids, v13, (__int64 *)va);
}
