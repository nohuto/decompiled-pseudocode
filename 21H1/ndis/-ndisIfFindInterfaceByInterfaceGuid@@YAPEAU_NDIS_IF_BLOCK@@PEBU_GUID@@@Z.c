/*
 * XREFs of ?ndisIfFindInterfaceByInterfaceGuid@@YAPEAU_NDIS_IF_BLOCK@@PEBU_GUID@@@Z @ 0x1C00212A0
 * Callers:
 *     ?IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z @ 0x1C005EEB0 (-IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z.c)
