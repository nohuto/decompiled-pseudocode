/*
 * XREFs of ?ndisValidateProtocolDriverCharacteristicsHeader@@YAHPEBU_NDIS_PROTOCOL_DRIVER_CHARACTERISTICS@@PEAK@Z @ 0x1C0106800
 * Callers:
        ...
        unsigned int *a2)
{
  ...
  v3 = (const struct _GUID *)&unk_1C00CA7D0;
