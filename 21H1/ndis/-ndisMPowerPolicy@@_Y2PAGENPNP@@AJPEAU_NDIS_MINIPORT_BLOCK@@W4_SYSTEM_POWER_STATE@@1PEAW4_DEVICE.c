 ...
 *     ?ndisGetTimeInterval@@YA_KPEAT_LARGE_INTEGER@@@Z @ 0x1C00154A8 (-ndisGetTimeInterval@@YA_KPEAT_LARGE_INTEGER@@@Z.c)
        ...
        unsigned __int8 a5)
{
  ...
  EnabledWoLPacketPatterns = (__int64)&WPP_dab0da38b1e3331efa7a05b6175d8ddc_Traceguids;
