/*
 * XREFs of NdisGetJobObjectCompartmentId @ 0x1C00B06B0
 * Callers:
 *     NdisGetProcessObjectCompartmentId @ 0x1C001DE40 (NdisGetProcessObjectCompartmentId.c)
 *     ?ndisNsiGetAllJobInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C00B0540 (-ndisNsiGetAllJobInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z.c)
