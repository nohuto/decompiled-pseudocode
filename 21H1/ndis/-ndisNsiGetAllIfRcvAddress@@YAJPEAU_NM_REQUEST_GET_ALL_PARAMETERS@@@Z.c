/*
 * XREFs of ?ndisNsiGetAllIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C00B3C10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisIfFindNextRcvAddress @ 0x1C0127794 (ndisIfFindNextRcvAddress.c)
 *     ndisIfFindRcvAddress @ 0x1C0127824 (ndisIfFindRcvAddress.c)
