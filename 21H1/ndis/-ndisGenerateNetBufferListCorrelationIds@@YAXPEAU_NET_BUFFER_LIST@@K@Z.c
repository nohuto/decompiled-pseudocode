/*
 * XREFs of ?ndisGenerateNetBufferListCorrelationIds@@YAXPEAU_NET_BUFFER_LIST@@K@Z @ 0x1C00ADBE0
 * Callers:
 ...
 * Callees:
 *     ndisGenerateCorrelationIds @ 0x1C00ADBBC (ndisGenerateCorrelationIds.c)
 */
