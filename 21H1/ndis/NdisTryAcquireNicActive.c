/*
 * XREFs of NdisTryAcquireNicActive @ 0x1C00012B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAoAcIsD0Required@@YAEPEAU_NDIS_MINIPORT_AOAC@@@Z @ 0x1C005A19C (-ndisAoAcIsD0Required@@YAEPEAU_NDIS_MINIPORT_AOAC@@@Z.c)
...
__int64 __fastcall NdisTryAcquireNicActive(__int64 a1, unsigned int a2)
{
  ...
  LOBYTE(v6) = 0;
  v7 = *(_QWORD *)(v2 + 4456);
  v8 = WPP_dafd92df180233d1e8f46c99921014e6_Traceguids;
  ...
  if ( !(unsigned __int8)ndisValidComponentId(a2, WPP_dafd92df180233d1e8f46c99921014e6_Traceguids) )
    return 3221225485LL;
  if ( *(_QWORD *)(v2 + 4456) )
  {
  ...
  else
  {
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      v18 = v9;
      LOBYTE(v9) = 3;
      WPP_RECORDER_SF_(*((_QWORD *)WPP_GLOBAL_Control + 8), (int)v9, 14, 56, v18);
    }
    return 3221225659LL;
  }
}
