/*
 * XREFs of USBD_CreateHandle @ 0x1C0011B24
 * Callers:
 ...
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C001123C (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
