/*
 * XREFs of USBParseCountOutputChannelsForUnit @ 0x1C002F0A8
 * Callers:
 *     USBParseCountOutputChannelsForUnit @ 0x1C002F0A8 (USBParseCountOutputChannelsForUnit.c)
 *     USBParseTerminalUnit @ 0x1C002F3C0 (USBParseTerminalUnit.c)
 *     USBParseMixerUnit @ 0x1C002F510 (USBParseMixerUnit.c)
 *     USBParseSelectorUnit @ 0x1C002F7B0 (USBParseSelectorUnit.c)
 *     USBParseFeatureUnit @ 0x1C002F8E0 (USBParseFeatureUnit.c)
 *     USBParseProcessUnit @ 0x1C002FB30 (USBParseProcessUnit.c)
 *     USBParseExtensionUnit @ 0x1C002FD70 (USBParseExtensionUnit.c)
 * Callees:
