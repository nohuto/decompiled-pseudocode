/*
 * XREFs of USBHwSelectStreamingAudioInterface @ 0x1C002D74C
 * Callers:
 *     USBType1StateChangePin @ 0x1C00061F0 (USBType1StateChangePin.c)
 *     USBType1ChangePowerState @ 0x1C0006580 (USBType1ChangePowerState.c)
 *     USBCaptureStateChangePin @ 0x1C0007060 (USBCaptureStateChangePin.c)
 *     USBCaptureChangePowerState @ 0x1C0007610 (USBCaptureChangePowerState.c)
 ...
 *     USBHwFreePipes @ 0x1C002DAD4 (USBHwFreePipes.c)
...
__int64 __fastcall USBHwSelectStreamingAudioInterface(__int64 a1, _BYTE *a2)
{
  ...
  v28 = v2;
  v5 = 0;
  v6 = &WPP_59cc21402c76383212e5dfc6e551f37f_Traceguids;
  v7 = -1073741808;
  v27 = *(_QWORD *)(v2 + 16);
  v8 = *(_QWORD *)(v27 + 16);
  v9 = *(_QWORD **)(v8 + 72);
