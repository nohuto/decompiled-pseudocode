/*
 * XREFs of USBParseGetMIDIJackStringFromDeviceID @ 0x1C002FEC4
 * Callers:
 *     USBParseMIDIInJack @ 0x1C0030000 (USBParseMIDIInJack.c)
 *     USBParseMIDIOutJack @ 0x1C0030100 (USBParseMIDIOutJack.c)
 * Callees:
