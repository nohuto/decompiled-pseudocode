/*
 * XREFs of PropertyGetMixerLevelCaps @ 0x1C0029D20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PropertyGetMixerLevelCaps(IRP *a1, __int64 a2, _DWORD *a3)
{
  ...
  if ( FilterFromIrp )
  {
    ...
    v11 = *(_DWORD *)Type->Data4;
    v12 = 16 * v11 * *(_DWORD *)&Type->Data4[4] + 8;
    if ( Length )
    {
      if ( Length >= 8 )
      {
        *a3 = v11;
        ...
        if ( Length == v12 )
        {
          v13 = *(unsigned __int8 **)&Type[1].Data1;
          v14 = 0;
          for ( a1->IoStatus.Information = v12; v14 < *(_DWORD *)Type->Data4; ++v14 )
          {
            for ( i = 0; i < *(_DWORD *)&Type->Data4[4]; v13 += 32 )
            {
              *v3 = *v13;
              if ( v13[1] )
              {
