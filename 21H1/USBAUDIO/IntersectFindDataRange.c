/*
 * XREFs of IntersectFindDataRange @ 0x1C002582C
 * Callers:
 *     PinDataFormatIntersection @ 0x1C0024AB0 (PinDataFormatIntersection.c)
 * Callees:
 *     IntersectFindBestMatch @ 0x1C002569C (IntersectFindBestMatch.c)
 */
