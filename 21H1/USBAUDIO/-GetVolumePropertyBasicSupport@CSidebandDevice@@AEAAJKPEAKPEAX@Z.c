/*
 * XREFs of ?GetVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000C510
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x1C00293DC (PropertyGetDbBasicSupportSideband.c)
 */
        ...
        void *a4)
{
  ...
  if ( PinFromEpIndex >= 0 )
  {
    ...
    if ( PinFromEpIndex >= 0 )
    {
      ...
      if ( NodeOfType >= 0 )
      {
        NodeOfType = PropertyGetDbBasicSupportSideband(
