/*
 * XREFs of USBParseConvertControlUnits @ 0x1C00303DC
 * Callers:
 *     USBParseConvertUnitsToFunctionUnits @ 0x1C00305D0 (USBParseConvertUnitsToFunctionUnits.c)
 * Callees:
...
__int64 __fastcall USBParseConvertControlUnits(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( AudioSpecificInterface )
  {
    ...
    while ( Descriptor )
    {
      if ( v4 < 0 )
        break;
      if ( (unsigned __int8)(Descriptor[1].bLength - 2) <= 6u )
      {
        v4 = USBParseUnitMap[Descriptor[1].bLength](a1, Descriptor);
        if ( v4 >= 0 )
          Descriptor = USBParseFindDescriptor(
                         (__int64)v6,
                         v8,
