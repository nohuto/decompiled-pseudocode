/*
 * XREFs of ?GetMutePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000C920
 * Callers:
 ...
 *     PropertyGetBooleanBasicSupportSideband @ 0x1C0028B4C (PropertyGetBooleanBasicSupportSideband.c)
 */
