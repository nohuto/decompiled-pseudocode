/*
 * XREFs of USBHwSelectStreamingAudioInterfaceSideband @ 0x1C002D22C
 * Callers:
 ...
 *     USBD_GetEndpointOffloadInformationForIndex @ 0x1C0011FF0 (USBD_GetEndpointOffloadInformationForIndex.c)
