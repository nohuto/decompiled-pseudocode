/*
 * XREFs of _handle_error @ 0x1C0012C5C
 * Callers:
 *     log10 @ 0x1C00127E8 (log10.c)
 *     _pow_special @ 0x1C0012DA0 (_pow_special.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0012700 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C0012B28 (_call_matherr.c)
 *     _exception_enabled @ 0x1C0012B98 (_exception_enabled.c)
 *     _raise_exc @ 0x1C0012F70 (_raise_exc.c)
 *     _set_errno_from_matherr @ 0x1C0013230 (_set_errno_from_matherr.c)
