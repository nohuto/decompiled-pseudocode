/*
 * XREFs of UsbhGetLocationIdString @ 0x1C0051020
 * Callers:
 *     UsbhCreatePdo @ 0x1C0053F94 (UsbhCreatePdo.c)
 * Callees:
 *     FdoExt @ 0x1C000F050 (FdoExt.c)
 *     PdoExt @ 0x1C0011220 (PdoExt.c)
 *     Short2Bcd @ 0x1C004EA58 (Short2Bcd.c)
 */
...
__int64 __fastcall UsbhGetLocationIdString(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *((_DWORD *)PoolWithTag + 4) = 0;
  v13 = PoolWithTag;
  *PoolWithTag = *(_OWORD *)L"Port_#nnnn";
  for ( *((_DWORD *)PoolWithTag + 4) = *(_DWORD *)L"nn"; *v13 != 110; ++v13 )
    ;
  v14 = 42;
  *v13 = (v9 >> 12) + 48;
