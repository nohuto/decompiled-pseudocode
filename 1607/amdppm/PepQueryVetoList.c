/*
 * XREFs of PepQueryVetoList @ 0x1C00155E4
 * Callers:
...
__int64 __fastcall PepQueryVetoList(__int64 a1)
{
  ...
  v11 = 0;
  if ( (int)PoFxProcessorNotification(*(_QWORD *)(a1 + 1064), 24LL, &v11) >= 0 && v11 )
  {
    v3 = 16 * v11 + 8;
    ...
    if ( PoolWithTag )
    {
      ...
      *v5 = v11;
      ...
      {
LABEL_9:
        Name = ((__int64 (__fastcall *)(unsigned int *))qword_1C00095E0)(v5);
        if ( !Name )
        {
          qword_1C00098E8 = (__int64)v5;
          v5 = 0LL;
        }
      }
      if ( v5 )
