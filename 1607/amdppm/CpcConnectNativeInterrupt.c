/*
 * XREFs of CpcConnectNativeInterrupt @ 0x1C0016708
 * Callers:
...
void __fastcall CpcConnectNativeInterrupt(_QWORD *DeferredContext)
{
  ...
  KeInitializeDpc((PRKDPC)(v1 + 264), (PKDEFERRED_ROUTINE)CpcNativeInterruptDpc, DeferredContext);
  KeGetCurrentProcessorNumberEx(&ProcNumber);
  KeSetTargetProcessorDpcEx((PKDPC)(v1 + 264), &ProcNumber);
  KeSetImportanceDpc((PRKDPC)(v1 + 264), MediumHighImportance);
  KeProcessorGroupAffinity(&Affinity, *((unsigned int *)DeferredContext + 14));
  KeSetSystemGroupAffinityThread(&Affinity, &PreviousAffinity);
  if ( (int)((__int64 (__fastcall *)(_QWORD *))qword_1C0009548)(DeferredContext) >= 0 )
  {
    *(_BYTE *)(v1 + 102) = 1;
