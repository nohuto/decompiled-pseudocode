/*
 * XREFs of RegisterKernelCStates @ 0x1C0017154
 * Callers:
...
__int64 __fastcall RegisterKernelCStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v26[2]; // [rsp+50h] [rbp-20h] BYREF
  ...
  if ( v3 && *(_DWORD *)v3 )
  {
    ...
    *(_DWORD *)(a3 + 56) = 0;
    ...
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      v26[1] = 0x100000000LL;
      v26[0] = 127LL;
      DecodeAcpi2CState(a1, v26, 0LL, v22, a3 + 64);
      v8 = 2;
      *(_DWORD *)(a2 + 112) = *(_DWORD *)(a2 + 112) & 0x7FFFFF80 | ((unsigned __int8)v22[0] << 31) | 0xF;
      *(_DWORD *)(a2 + 108) = 1;
      *(_DWORD *)(a3 + 56) = 1;
    }
    v9 = *(_DWORD *)v3;
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v11 == v8 )
      {
        ...
        *v21 = v3 + 4 * (i + 4LL * i + 1);
        v25 = (__int64 *)(v3 + 4 * (i + 4LL * i + 1));
        if ( (int)DecodeAcpi2CState(v7, v25, 0LL, v22, (__int64)v21) < 0 )
        {
          _InterlockedOr((volatile signed __int32 *)(v7 + 1056), 8u);
        }
        else
        {
          v15 = v24;
          v16 = v25;
          v17 = *(_DWORD *)(v24 + a2 + 112) ^ (*(_DWORD *)(v24 + a2 + 112) ^ (8 * v8)) & 0x78 | 7;
          *(_DWORD *)(v24 + a2 + 112) = v17;
          *(_DWORD *)(v15 + a2 + 112) = v17 & 0x7FFFFFFF | ((unsigned __int8)v22[0] << 31);
          *(_DWORD *)(v15 + a2 + 116) = 10 * *((unsigned __int16 *)v16 + 7);
          *(_DWORD *)(v15 + a2 + 124) = *((_DWORD *)v16 + 4);
          ++*(_DWORD *)(a2 + 108);
          ++*(_DWORD *)(a3 + 56);
        }
      }
