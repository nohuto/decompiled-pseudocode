/*
 * XREFs of PccInitiateExecuteCallback @ 0x1C0005810
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    if ( i )
    {
      LOBYTE(word_1C00098CC) = 1;
      if ( !HIBYTE(word_1C00098CC) )
      {
        HIBYTE(word_1C00098CC) = 1;
        v8 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C00098B8);
    if ( v8 )
      IoQueueWorkItem(qword_1C00098C0, PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
