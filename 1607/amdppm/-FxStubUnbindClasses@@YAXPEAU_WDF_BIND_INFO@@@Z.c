/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C0006630
 * Callers:
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0006350 (-FxStubDriverUnloadCommon@@YAXXZ.c)
 * Callees:
 *     WdfVersionUnbindClass_0 @ 0x1C00066E0 (WdfVersionUnbindClass_0.c)
 */
...
void __fastcall FxStubUnbindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  if ( off_1C0009108 != &__KMDF_CLASS_BIND_START && &__KMDF_CLASS_BIND_END <= (_QWORD *)off_1C0009108 )
  {
    do
    {
