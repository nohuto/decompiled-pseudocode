/*
 * XREFs of PepDevicePowerControlCallback @ 0x1C0005450
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepUpdatePerformanceConstraint @ 0x1C001C76C (PepUpdatePerformanceConstraint.c)
        ...
        _QWORD *a7)
{
  ...
  *a7 = 0LL;
    ...
    || *(_QWORD *)(a2 + 8) != *(_QWORD *)GUID_PROCESSOR_IDLE_VETO.Data4 )
  {
    ...
    if ( Src || qword_1C00098E0 )
    {
      *(_QWORD *)&ProcNumber[0].Group = 0LL;
      ...
      ProcNumber[0] = (struct _PROCESSOR_NUMBER)44;
      return ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1C00095F8)(ProcNumber);
    }
    return -1073741637;
  }
  if ( a4 < 0xC )
    return -1073741789;
  if ( !*(_QWORD *)(a1 + 1096) || !*(_QWORD *)(a1 + 656) )
    return -1073741637;
  v9 = *(_DWORD *)(a1 + 56);
  ProcNumber[1] = 0;
  ProcNumber[0] = (struct _PROCESSOR_NUMBER)44;
  ...
  if ( result >= 0 )
  {
    ...
    return ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1C00095F0)(ProcNumber);
  }
  return result;
}
