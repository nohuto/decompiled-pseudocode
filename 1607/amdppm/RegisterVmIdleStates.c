/*
 * XREFs of RegisterVmIdleStates @ 0x1C001DBF4
 * Callers:
 *     RegisterHvIdleStates @ 0x1C001CE60 (RegisterHvIdleStates.c)
 *     RegisterGuestIdleStates @ 0x1C001DBE0 (RegisterGuestIdleStates.c)
 * Callees:
...
__int64 __fastcall RegisterVmIdleStates(__int64 a1)
{
  ...
  if ( v2 && (v3 = *v2) != 0 )
  {
    ...
    if ( ProcessorNumberFromIndex >= 0 )
    {
      ...
      BYTE2(v8[2]) = 1;
      HIDWORD(v8[13]) = 1;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD *))qword_1C00095C0)(v8);
      if ( ProcessorNumberFromIndex >= 0 )
      {
        if ( !*(_BYTE *)(a1 + 664) )
        {
