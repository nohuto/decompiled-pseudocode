/*
 * XREFs of DeregisterKernelIdleDomains @ 0x1C0018124
 * Callers:
...
__int64 __fastcall DeregisterKernelIdleDomains(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *v2 )
    {
      do
      {
        v5 = (_QWORD *)(32LL * v4 + *(_QWORD *)(a1 + 672) + 8LL);
        v6 = v5[1];
        if ( v6 )
        {
    ...
    v23 = *(_DWORD *)(*(_QWORD *)(a1 + 656) + 56LL);
    v24 = 0LL;
    for ( j = 0; (unsigned int)v24 < v23; j = v24 )
    {
      *(_QWORD *)(*(_QWORD *)(a1 + 656) + 72 * v24 + 120) = 0LL;
      v24 = j + 1;
    }
