/*
 * XREFs of PopulateEnergyEstimationModel @ 0x1C001FBB4
 * Callers:
 *     ProcLibGlobalInit @ 0x1C001F33C (ProcLibGlobalInit.c)
 * Callees:
 *     RtlStringCchCatW @ 0x1C0004BCC (RtlStringCchCatW.c)
 *     RtlStringCchPrintfW @ 0x1C0004C50 (RtlStringCchPrintfW.c)
...
__int64 __fastcall PopulateEnergyEstimationModel(unsigned __int8 a1, _DWORD *a2)
{
  ...
  if ( RtlStringCchPrintfW(
    ...
    && (unsigned int)(v15 - 1) <= 0x3E7F )
  {
    *a2 = v15;
    if ( RtlStringCchCatW(pszDest, v4, L"\\EnergyEquation") >= 0
      && (int)GetRegistryDwordValueNoDefault((__int64)pszDest, (__int64)L"EquationIndex", (__int64)&v16) >= 0
      && RtlStringCchPrintfW(pszSrc, 0x10uLL, L"\\%d", v16) >= 0
