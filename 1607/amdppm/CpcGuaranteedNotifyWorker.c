/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x1C00167DC
 * Callers:
 *     AcpiCppcGuaranteedNotifyWorker @ 0x1C00119B0 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
    ...
    if ( v5 )
    {
      ...
      if ( *(_BYTE *)(v5 + 97) )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
          ...
          0LL);
        if ( !*(_BYTE *)(v5 + 99)
          || (*(int (__fastcall **)(_QWORD))(qword_1C00098A0 + 88))(*(_QWORD *)(qword_1C00098A0 + 56)) >= 0
          && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C00098A0 + 104))(*(_QWORD *)(qword_1C00098A0 + 56), 0LL) >= 0 )
        {
          GenAddrMaybeHidden = ReadGenAddrMaybeHidden(v3, v6 + 56);
          v8 = *(_QWORD *)(v5 + 16);
          ...
          *(_DWORD *)(v5 + 84) = v10;
          if ( (_DWORD)v10 != *(_DWORD *)(v3 + 684) )
          {
            ...
            ((void (__fastcall *)(__int64))qword_1C0009740)(v3);
          }
