/*
 * XREFs of ProcLibTracePepPerfCapabilities @ 0x1C00147C8
 * Callers:
...
void __fastcall ProcLibTracePepPerfCapabilities(__int64 a1, char a2)
{
  ...
  __int64 v10; // rdx
  __int64 v11; // rcx
  struct _PROCESSOR_NUMBER v12[4]; // [rsp+38h] [rbp-89h] BYREF
  ...
  _BYTE *v18; // [rsp+78h] [rbp-49h]
  unsigned int v19; // [rsp+80h] [rbp-41h]
  int v20; // [rsp+84h] [rbp-3Dh]
  ...
  if ( EtwEventEnabled(ProcLibEtwHandle, v3) )
  {
    ...
    if ( v4 )
    {
      if ( *(_QWORD *)(a1 + 1152) )
      {
        ...
        v6 = 10 * *(_DWORD *)(a1 + 1072);
        PoolWithTag = ExAllocatePoolWithTag(PagedPool, v6, 0x72637250u);
        if ( PoolWithTag )
        {
          for ( i = 0; i < *v5; *(_DWORD *)&PoolWithTag[2 * v10 + 6] = *(unsigned __int8 *)(v4 + 8 * v9 + 52) )
          {
            v9 = i++;
            v10 = 5 * v9;
            *(_DWORD *)&PoolWithTag[2 * v10] = *(_DWORD *)(v4 + 8 * v9 + 48) & 1;
            PoolWithTag[2 * v10 + 4] = (*(_DWORD *)(v4 + 8 * v9 + 48) >> 1) & 3;
            PoolWithTag[2 * v10 + 5] = (*(_DWORD *)(v4 + 8 * v9 + 48) >> 3) & 0xF;
          }
          if ( (int)ProcLibGetProcessorNumber(a1, v12) >= 0 )
          {
            ...
            *(_QWORD *)&UserData.Size = 2LL;
            ...
            v30 = 4LL;
            v32 = 4LL;
            EtwWrite(ProcLibEtwHandle, v3, 0LL, 0xAu, &UserData);
          }
