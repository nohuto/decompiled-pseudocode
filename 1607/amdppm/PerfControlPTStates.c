/*
 * XREFs of PerfControlPTStates @ 0x1C00047C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  {
    if ( *((_BYTE *)v16 + 25) == 1 )
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))v10)(*(_QWORD *)(v10 + 32), *v16, v16[1]);
    else
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(v10 + 8))(*(_QWORD *)(v10 + 40), *v16, v16[1]);
    goto LABEL_14;
  }
LABEL_18:
  *(_DWORD *)(a1 + 16) = a2;
