/*
 * XREFs of RegisterHvCStates @ 0x1C001CED0
 * Callers:
...
__int64 __fastcall RegisterHvCStates(__int64 a1)
{
  ...
  __int64 v17[2]; // [rsp+40h] [rbp-20h] BYREF
  ...
  if ( *(_BYTE *)(v1 + 16) != 1 )
  {
    ...
    *((_DWORD *)v3 + 4) = 1;
    ...
    v17[0] = 127LL;
    v18 = 0;
    DecodeAcpi2CState(a1, v17, v3 + 1, 0LL, 0LL);
    ++*(_DWORD *)v3;
  }
  v7 = *(_DWORD *)v1;
