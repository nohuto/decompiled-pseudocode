/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C001AC0C
 * Callers:
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( ((unsigned int)dword_1C00093A4 <= 1 || (*(_DWORD *)(a1 + 248) & 0x200000) != 0)
    ...
    && (unsigned __int8)(byte_1C0009B26 - 1) <= 3u
    && (unsigned __int8)byte_1C0009B26 + (unsigned __int8)byte_1C0009B27 <= 32 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1048), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1052), 4u);
    v7 = 1 << byte_1C0009B26;
    v8 = (unsigned int)(20 * ((1 << byte_1C0009B26) - 1) + 24);
      ...
      **(_DWORD **)(a1 + 456) = v7;
      if ( v7 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v12 + v11 - 4) = (v13 << byte_1C0009B27) | 0x10;
        }
        while ( v10 < v7 );
      }
