/*
 * XREFs of AcquirePccInterface @ 0x1C001E2A4
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  else
  {
    ...
    {
      v3 = -1073741811;
      if ( *(_DWORD *)qword_1C0009868 == 609239875
        && *(_WORD *)(qword_1C0009868 + 4) >= 0x28u
        && ((v4 = *(_BYTE *)(qword_1C0009868 + 6)) == 0 && *(_BYTE *)(qword_1C0009868 + 7) >= 6u
         || v4 == 1 && !*(_BYTE *)(qword_1C0009868 + 7)) )
      {
        v5 = *(_DWORD *)(qword_1C0009868 + 36);
        if ( v5 <= *(_DWORD *)(qword_1C0009868 + 28) )
          v3 = v5 < *(_DWORD *)(qword_1C0009868 + 32) ? 0xC000000D : 0;
      }
      if ( v3 < 0 )
        goto LABEL_15;
      ...
      {
LABEL_15:
        ((void (__fastcall *)(__int64))qword_1C0009838)(qword_1C0009828);
        memset(&unk_1C0009820, 0, 0x80uLL);
      }
    }
  }
