/*
 * XREFs of CpcCommitPerformance @ 0x1C0003060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CpcCommitPerformance(__int64 (*a1)(void), __int64 a2)
{
  ...
  LOBYTE(a2) = 1;
  result = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64 (__fastcall *)(__int64, __int64 (*)(void)), __int64 (*)(void)))(qword_1C00098A0 + 112))(
