/*
 * XREFs of InitAcpiThrottleStates @ 0x1C001AA7C
 * Callers:
...
__int64 __fastcall InitAcpiThrottleStates(__int64 a1)
{
  ...
  {
    inited = 0;
    v3 = AcpiEval_PCT_PTC(a1, 1129599071, (_BYTE *)(a1 + 432));
    if ( v3 < 0 )
      inited = v3;
    v4 = AcpiEval_TSS(a1, (_QWORD *)(a1 + 456));
    if ( v4 < 0 )
      inited = v4;
    if ( inited >= 0 )
      goto LABEL_11;
...
LABEL_30:
      ...
      inited = -1073741637;
      if ( !*(_QWORD *)(a1 + 448) || *v6 == *(_BYTE *)(a1 + 444) )
      {
        if ( *v6 == 1 )
        {
          inited = 0;
