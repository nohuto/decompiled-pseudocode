/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C001B770
 * Callers:
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  qword_1C0009900 = 0LL;
  InitializeEnumerationContext((__int64)&qword_1C00093B8, 32, (__int64)v10);
...
LABEL_15:
  ...
  {
    v2 = v13;
    if ( (*(_QWORD *)(v13 + 248) & 0x2000000000LL) != 0 )
      break;
LABEL_14:
    if ( (unsigned int)EnumerateNextDevice((__int64)v10, &v13) )
      goto LABEL_15;
...
LABEL_12:
  ...
  dword_1C00098FC = 1;
  qword_1C0009900 = 0LL;
  LODWORD(qword_1C0009900) = dword_1C00093A4;
