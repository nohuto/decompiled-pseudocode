/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C0003C3C
 * Callers:
...
LABEL_26:
    ...
    v3[48] = 1;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v28 + 2504))(v29, qword_1C00093A8, 0LL);
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_BYTE *))qword_1C00095D0)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v21;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C0009640)(*(_QWORD *)(a1 + 1064), v4, v23) >= 0 )
        {
