/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C001B26C
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(unsigned int a1)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    {
      v4 = v27;
      if ( (*(_QWORD *)(v27 + 248) & 0x2000000000LL) != 0 && *(unsigned __int8 *)(v27 + 336) == a1 )
      {
        if ( !qword_1C0009558 )
          goto LABEL_10;
        ...
        *(_QWORD *)(v4 + 328) = v6;
        ...
        v8 = ((__int64 (*)(void))qword_1C0009558)();
...
LABEL_41:
      ...
      else
      {
        ...
        {
          v14 = v27;
          if ( (*(_QWORD *)(v27 + 248) & 0x2000000000LL) != 0 )
          {
            v15 = *(unsigned __int8 *)(v27 + 336);
            if ( (_DWORD)v15 == a1 )
              break;
          }
LABEL_40:
        ...
        v16 = (char *)&unk_1C0009908 + 216 * v15;
        v17 = *((_DWORD *)v16 + 1);
        if ( v17 && v17 <= 4 )
        {
          v18 = 0;
