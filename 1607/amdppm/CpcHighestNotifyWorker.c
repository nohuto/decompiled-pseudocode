/*
 * XREFs of CpcHighestNotifyWorker @ 0x1C0016938
 * Callers:
 *     AcpiCppcHighestNotifyWorker @ 0x1C00119C0 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
  ...
  if ( (result & 0x8000000) != 0 )
  {
    ...
    if ( v5 )
    {
      ...
      if ( *(_BYTE *)(v6 + 8) != 126 )
      {
        ...
        {
          GenAddrMaybeHidden = ReadGenAddrMaybeHidden(v3, v6 + 8);
          v8 = *(_QWORD *)(v5 + 16);
          ...
          *(_DWORD *)(v5 + 68) = v9;
          ...
          ((void (__fastcall *)(_DWORD *))qword_1C00095A8)(v13);
