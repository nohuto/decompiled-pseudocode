/*
 * XREFs of __tailMerge_api_ms_win_service_management_l2_1_0_dll @ 0x140018D80
 * Callers:
 *     __imp_load_QueryServiceStatusEx @ 0x140018D60 (__imp_load_QueryServiceStatusEx.c)
 * Callees:
