/*
 * XREFs of ?GetOutputDataPointer@CCrossProcessClientOutputEndpoint@@UEAA_KIPEAUAE_CURRENT_POSITION@@@Z @ 0x14003A5B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct AE_CURRENT_POSITION *a3)
{
  ...
  *((_DWORD *)this + 4) = 2;
  ...
  v9 = *(_QWORD *)(v3 + 8);
  v10 = a2;
  AEWMILOG_DATA((unsigned int)this, (char *)this - 424, (unsigned __int8)a3, 0x11u, a2, v9, v8);
    ...
    && a2 )
  {
    ...
    else
    {
      ...
      v28 = 1;
      (**((void (__fastcall ***)(char *, __int64, int *))this - 18))((char *)this - 144, 2LL, &v28);
      v18 = *((_DWORD *)this - 74);
      v7 = v18;
    }
    v19 = *((_QWORD *)this - 44);
    ...
    else
    {
      ...
      if ( (Microsoft_Windows_AudioEnableBits & 0x100) != 0 )
      {
        LODWORD(v27) = *(_DWORD *)(*((_QWORD *)this - 44) + 144LL);
        LODWORD(v26) = v14;
        LODWORD(v25) = v22;
        Template_pqqqq(
          (unsigned int)v27,
      ...
      v28 = 1;
      (**((void (__fastcall ***)(char *, __int64, int *))this - 18))((char *)this - 144, 3LL, &v28);
    }
  }
  v23 = *((_QWORD *)this - 41);
LABEL_22:
