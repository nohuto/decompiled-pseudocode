/*
 * XREFs of pre_c_init @ 0x140017FA0
 * Callers:
 *     <none>
 * Callees:
 *     _get_image_app_type @ 0x140018628 (_get_image_app_type.c)
 *     ?UpdateRegistry@CSystemAudioDeviceOffloadGraph@@SAJH@Z @ 0x140018840 (-UpdateRegistry@CSystemAudioDeviceOffloadGraph@@SAJH@Z.c)
 */
