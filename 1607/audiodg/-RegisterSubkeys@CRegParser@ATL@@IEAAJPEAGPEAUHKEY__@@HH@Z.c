/*
 * XREFs of ?RegisterSubkeys@CRegParser@ATL@@IEAAJPEAGPEAUHKEY__@@HH@Z @ 0x140037764
 * Callers:
 ...
 *     ?CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z @ 0x140035EB4 (-CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z.c)
 ...
 *     ?HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z @ 0x140036B4C (-HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z.c)
...
LABEL_79:
        ...
        if ( v24 != 2 )
        {
          ...
          {
            if ( (unsigned int)ATL::CRegParser::CanForceRemoveKey(v19, Destination) && v29 )
...
LABEL_69:
    ...
    v8 = ATL::CRegParser::RegisterSubkeys(v6, v5, v32[0], v30, 0);
    if ( v8 < 0 )
      break;
    a2 = v5;
    this = v6;
