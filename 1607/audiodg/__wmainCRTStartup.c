/*
 * XREFs of __wmainCRTStartup @ 0x1400180D0
 * Callers:
 *     wWinMainCRTStartup @ 0x140018340 (wWinMainCRTStartup.c)
 * Callees:
 *     wWinMain @ 0x140015C78 (wWinMain.c)
 *     _XcptFilter_0 @ 0x1400185BE (_XcptFilter_0.c)
 *     _amsg_exit_0 @ 0x140018674 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1400186D0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x14001884A (_initterm_0.c)
...
LABEL_18:
    ...
    dword_140054590 = result;
    if ( !dword_1400545B0 )
      exit(result);
    if ( !dword_140054594 )
    {
      _cexit();
      return dword_140054590;
    }
    return result;
  }
