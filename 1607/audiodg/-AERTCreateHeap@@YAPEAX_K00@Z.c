/*
 * XREFs of ?AERTCreateHeap@@YAPEAX_K00@Z @ 0x1400159C4
 * Callers:
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x140015A70 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 * Callees:
 *     WPP_SF_PPPL @ 0x140033164 (WPP_SF_PPPL.c)
