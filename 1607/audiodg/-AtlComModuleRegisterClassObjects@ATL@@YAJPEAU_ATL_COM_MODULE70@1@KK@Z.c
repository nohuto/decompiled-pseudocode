/*
 * XREFs of ?AtlComModuleRegisterClassObjects@ATL@@YAJPEAU_ATL_COM_MODULE70@1@KK@Z @ 0x14000F628
 * Callers:
...
__int64 __fastcall ATL::AtlComModuleRegisterClassObjects(IUnknown *a1)
{
  ...
  while ( (unsigned __int64)v1 < v3 && v2 >= 0 )
  {
    ...
    {
      pUnk = 0LL;
      v5 = *(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(v4 + 16);
      if ( v5 )
      {
        v6 = *(_QWORD *)(v4 + 24);
        ...
        if ( pUnk )
        {
          ...
          if ( (char *)Release == (char *)ATL::CComObjectCached<ATL::CComClassFactory>::Release )
            ATL::CComObjectCached<ATL::CComClassFactory>::Release();
          else
            Release();
        }
        v3 = qword_140054D48;
