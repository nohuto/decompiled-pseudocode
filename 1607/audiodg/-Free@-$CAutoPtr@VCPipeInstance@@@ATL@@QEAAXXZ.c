/*
 * XREFs of ?Free@?$CAutoPtr@VCPipeInstance@@@ATL@@QEAAXXZ @ 0x140025460
 * Callers:
 *     ??_GCStreamInstance@@QEAAPEAXI@Z @ 0x1400253F8 (--_GCStreamInstance@@QEAAPEAXI@Z.c)
 *     ??1?$CAutoPtr@VCPipeInstance@@@ATL@@QEAA@XZ @ 0x140025488 (--1-$CAutoPtr@VCPipeInstance@@@ATL@@QEAA@XZ.c)
 *     ??1CFormatConverterPipe@@QEAA@XZ @ 0x140025494 (--1CFormatConverterPipe@@QEAA@XZ.c)
