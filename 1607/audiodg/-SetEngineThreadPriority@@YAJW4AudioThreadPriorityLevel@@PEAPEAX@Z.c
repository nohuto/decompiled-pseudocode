/*
 * XREFs of ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x1400336EC
 * Callers:
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x14002A8E8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
 * Callees:
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x14003369C (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 */
