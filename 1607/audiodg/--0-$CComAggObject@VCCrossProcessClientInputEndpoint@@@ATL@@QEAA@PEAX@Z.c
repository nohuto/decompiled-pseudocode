/*
 * XREFs of ??0?$CComAggObject@VCCrossProcessClientInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x1400343F8
 * Callers:
        ...
        __int64 a2)
{
  ...
  *v4 = &ATL::CComContainedObject<CCrossProcessClientInputEndpoint>::`vftable'{for `IAudioEndpoint'};
  ...
  v4[53] = &ATL::CComContainedObject<CCrossProcessClientInputEndpoint>::`vftable'{for `CCrossProcessInputEndpoint'};
  v4[56] = &ATL::CComContainedObject<CCrossProcessClientInputEndpoint>::`vftable'{for `CCrossProcessControl'};
  v4[58] = a2;
