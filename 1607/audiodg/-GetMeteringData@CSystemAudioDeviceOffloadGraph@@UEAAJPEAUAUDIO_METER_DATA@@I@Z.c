/*
 * XREFs of ?GetMeteringData@CSystemAudioDeviceOffloadGraph@@UEAAJPEAUAUDIO_METER_DATA@@I@Z @ 0x14002D650
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( v9 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffloadGraph::GetMeteringData", 390, v9);
  }
