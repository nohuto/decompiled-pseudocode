/*
 * XREFs of ?InitializeRateConverterInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@@Z @ 0x140008B90
 * Callers:
...
LABEL_16:
  ...
  AudDGTraceLoggingErrorHelper("CPipeInstance::InitializeRateConverterInterface", 0xBE8u, v6);
LABEL_3:
  if ( v22 )
  {
