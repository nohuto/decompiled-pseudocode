/*
 * XREFs of ?Initialize@CFormatConverterPipe@@QEAAJPEAUIDeviceGraphObjectCache@@PEBUtWAVEFORMATEX@@PEBUFORMAT_CONVERTER_PIPE_DESCRIPTOR@@@Z @ 0x14003191C
 * Callers:
 ...
 *     ?Reset@CFormatConverterPipe@@QEAAXXZ @ 0x1400254C0 (-Reset@CFormatConverterPipe@@QEAAXXZ.c)
