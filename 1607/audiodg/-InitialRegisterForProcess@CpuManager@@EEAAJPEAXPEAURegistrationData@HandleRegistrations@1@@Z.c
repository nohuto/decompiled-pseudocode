/*
 * XREFs of ?InitialRegisterForProcess@CpuManager@@EEAAJPEAXPEAURegistrationData@HandleRegistrations@1@@Z @ 0x140027630
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CpuManager::HandleRegistrations::RegistrationData *a3)
{
  ...
  if ( DuplicateHandle(v7, a2, CurrentProcess, &TargetHandle, 0x2000u, 0, 0) )
  {
    ...
    if ( v14 >= 0 )
    {
      v15 = RtlPublishWnfStateData(WNF_AUDC_CPUSET_ID, 0LL, (char *)this + 448, 16LL, TargetHandle);
      if ( v15 >= 0 )
      {
        v15 = RtlPublishWnfStateData(WNF_AUDC_CPUSET_ID_SYSTEM, 0LL, (char *)this + 464, 4LL, 0LL);
        if ( v15 >= 0 )
        {
          v9 = 0;
