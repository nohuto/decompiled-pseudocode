/*
 * XREFs of ?InnerInitializeAPO@CSystemAudioDeviceSharedBase@@MEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x140005D30
 * Callers:
        ...
        struct IAudioProcessingObject **a4)
{
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, struct IAudioProcessingObject **))(**((_QWORD **)this + 37)
                                                                                             + 24LL))(
         *((_QWORD *)this + 37),
         a2,
         a3,
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::InnerInitializeAPO", 0x32u, v6);
  }
  else
  {
    *((_QWORD *)this + 36) = a2;
