/*
 * XREFs of ?AddPipe@CSystemAudioDeviceSharedBase@@UEAAJPEAVCPipeInstance@@@Z @ 0x14002A7B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceSharedBase::AddPipe(CSystemAudioDeviceSharedBase *this, struct CPipeInstance *a2)
{
  ...
  if ( v5 )
  {
    v3 = (*(__int64 (__fastcall **)(__int64, struct CPipeInstance *))(*(_QWORD *)v5 + 40LL))(v5, a2);
    if ( v5 )
