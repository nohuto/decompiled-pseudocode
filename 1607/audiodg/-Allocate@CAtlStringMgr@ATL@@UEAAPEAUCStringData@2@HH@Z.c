/*
 * XREFs of ?Allocate@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@HH@Z @ 0x140016770
 * Callers:
 *     ?Fork@?$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z @ 0x140016554 (-Fork@-$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z.c)
 * Callees:
 *     ?Allocate@CWin32Heap@ATL@@UEAAPEAX_K@Z @ 0x140016850 (-Allocate@CWin32Heap@ATL@@UEAAPEAX_K@Z.c)
 *     ??$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z @ 0x140016868 (--$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z.c)
