/*
 * XREFs of ?GetProtectedOutputController@CSystemAudioDeviceOffload@@UEAAJIPEAPEAUIAudioProtectedOutputController@@@Z @ 0x14002C750
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProtectedOutputController **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v5 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffload::GetProtectedOutputController", 239, v5);
  }
  else
  {
