/*
 * XREFs of ?ApplyFxStateSettings@CSystemAudioDeviceBase@@IEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@H@Z @ 0x14000364C
 * Callers:
...
LABEL_19:
    ...
    {
      if ( !a3 && *v11 )
        v6 = (*(__int64 (__fastcall **)(_QWORD, bool))(*(_QWORD *)*v11 + 24LL))(*v11, *((_DWORD *)this + 59) == 0);
    }
    goto LABEL_19;
  }
LABEL_2:
