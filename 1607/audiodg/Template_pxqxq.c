/*
 * XREFs of Template_pxqxq @ 0x14003B1B4
 * Callers:
...
ULONG Template_pxqxq(__int64 a1, __int64 a2, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v9 = 8LL;
  v11 = 4LL;
  return EventWrite(Microsoft_Windows_AudioHandle, &EVT_GLITCH_CP_SERVER_OUTPUT_QUEUE_FULL_PACKET_DROP, 5u, &UserData);
}
