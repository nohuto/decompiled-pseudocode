/*
 * XREFs of ?Serialize@CDisplayNode@@QEAAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@AEAPEAEAEAI@Z @ 0x140031410
 * Callers:
 ...
 *     ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x140030D08 (-GetDisplayName@CDisplayNode@@QEAAPEBDXZ.c)
