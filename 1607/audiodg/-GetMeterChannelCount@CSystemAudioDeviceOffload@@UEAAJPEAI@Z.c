/*
 * XREFs of ?GetMeterChannelCount@CSystemAudioDeviceOffload@@UEAAJPEAI@Z @ 0x14002C540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceOffload::GetMeterChannelCount(CSystemAudioDeviceOffload *this, unsigned int *a2)
{
  ...
  if ( v2 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffload::GetMeterChannelCount", 853, v2);
  }
