/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x140011DDC
 * Callers:
...
LABEL_34:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_d545b8d0efab383e6caea6ac6e1be9b2_Traceguids, 12320LL);
  }
  ...
  if ( v7 < 0 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      v14 = 34LL;
LABEL_44:
      WPP_SF_D(v13[2], v14, &WPP_d545b8d0efab383e6caea6ac6e1be9b2_Traceguids, (unsigned int)v7);
    }
  }
  else
  {
...
LABEL_31:
  ...
  if ( v7 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDGModule::InitializeSecurity", 0x305u, v7);
  }
