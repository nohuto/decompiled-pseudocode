/*
 * XREFs of ?ReleaseInputDataPointer@CCrossProcessClientInputEndpoint@@UEAAXI_K@Z @ 0x14003A1F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  v3 = (char *)this - 424;
  v4 = a2;
  AEWMILOG_DATA((unsigned int)this, (char *)this - 424, a3, 0xFu, a2, 0LL, 0LL);
  v6 = *((_QWORD *)this - 45);
  *((_DWORD *)this + 5) = 0;
  if ( CCrossProcessBaseEndpoint::IsValidFlags((CCrossProcessBaseEndpoint *)v3, *(_DWORD *)(v6 + 156), v7) )
  {
    if ( !*((_DWORD *)this + 4) )
      v8 = _InterlockedExchangeAdd64(
             (volatile signed __int64 *)(*((_QWORD *)this - 45) + 16LL),
             (unsigned int)(v4 * *((_DWORD *)this - 86)));
  }
  else
  {
