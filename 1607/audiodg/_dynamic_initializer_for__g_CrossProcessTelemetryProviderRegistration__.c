/*
 * XREFs of _dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__ @ 0x140001190
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_140054020, a2, a3);
