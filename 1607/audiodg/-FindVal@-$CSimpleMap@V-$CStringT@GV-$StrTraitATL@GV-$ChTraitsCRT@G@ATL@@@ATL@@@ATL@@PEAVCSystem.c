/*
 * XREFs of ?FindVal@?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@@2@@ATL@@QEBAHAEBQEAVCSystemAudioDeviceBase@@@Z @ 0x14001626C
 * Callers:
        ...
        __int64 *a2)
{
  ...
  if ( dword_140054CD0 <= 0 )
    return 0xFFFFFFFFLL;
  v3 = *a2;
  for ( i = qword_140054CC8; *i != v3; ++i )
  {
    result = (unsigned int)(result + 1);
    if ( (int)result >= dword_140054CD0 )
      return 0xFFFFFFFFLL;
  }
  return result;
}
