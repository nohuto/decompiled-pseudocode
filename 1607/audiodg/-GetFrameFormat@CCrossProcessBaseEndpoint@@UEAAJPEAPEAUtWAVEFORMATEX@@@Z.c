/*
 * XREFs of ?GetFrameFormat@CCrossProcessBaseEndpoint@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x140013ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 17LL, &WPP_98f64ba30fd033af17de3dc3e532c096_Traceguids, v7);
  }
