/*
 * XREFs of ?GetVolumeChannelCount@CSystemAudioDeviceOffloadGraph@@UEAAJPEAI@Z @ 0x14002D7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( v2 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffloadGraph::GetVolumeChannelCount", 253, v2);
  }
