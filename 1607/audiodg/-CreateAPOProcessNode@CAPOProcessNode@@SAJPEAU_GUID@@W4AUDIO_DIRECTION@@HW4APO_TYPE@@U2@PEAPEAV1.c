/*
 * XREFs of ?CreateAPOProcessNode@CAPOProcessNode@@SAJPEAU_GUID@@W4AUDIO_DIRECTION@@HW4APO_TYPE@@U2@PEAPEAV1@@Z @ 0x14000CB50
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  {
    WPP_SF__guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_00124d7d191530a40c6a65552c411b8b_Traceguids, a1);
    v10 = WPP_GLOBAL_Control;
  }
  v11 = 0;
  if ( &v50 )
  ...
  if ( v10 != &WPP_GLOBAL_Control && (*((_DWORD *)v10 + 7) & 0x20000) != 0 && *((_BYTE *)v10 + 25) >= 2u )
    WPP_SF_D(v10[2], 19LL, &WPP_00124d7d191530a40c6a65552c411b8b_Traceguids, (unsigned int)Common);
