/*
 * XREFs of ?ActivateEndpoint@CSystemAudioDeviceBase@@IEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@@Z @ 0x140028DB0
 * Callers:
  ...
  if ( Instance >= 0 )
  {
    ...
    if ( Instance >= 0 )
    {
      ...
      if ( Instance >= 0 )
      {
        ...
        if ( v21 != v20 )
        {
          ATL::AtlComQIPtrAssign(&v21, v20, &GUID_eecca8a7_a629_4dba_9f23_20f6db42d990);
          v5 = v21;
        }
        if ( !v5 )
        {
...
LABEL_10:
        ...
        Instance = (**v12)(v12, &GUID_30a99515_1527_4451_af9f_00c5f0234daf, (char *)this + 224);
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_Ds(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        14,
        (unsigned int)&WPP_131fa8c07a4934e211f235ed1aafba72_Traceguids,
        Instance,
        (__int64)"CSystemAudioDeviceBase::ActivateEndpoint");
    }
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceBase::ActivateEndpoint", 534, Instance);
  }
  if ( v21 )
