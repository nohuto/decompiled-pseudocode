/*
 * XREFs of ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x140030D08
 * Callers:
...
const char *__fastcall CDisplayNode::GetDisplayName(CDisplayNode *this)
{
  ...
  if ( !v13 )
    return "Cleanup";
  v14 = *(_QWORD *)(v3 + 8) - *(_QWORD *)&GUID_693badea_1eb1_4013_b799_285f624a55bd.Data1;
  if ( !v14 )
    v14 = *(_QWORD *)(v3 + 16) - *(_QWORD *)GUID_693badea_1eb1_4013_b799_285f624a55bd.Data4;
  if ( !v14 )
    return "SilenceMonitor";
  v15 = *(_QWORD *)(v3 + 8) - *(_QWORD *)&GUID_3fd7f233_a716_472e_8f2f_c25954f34e96.Data1;
  if ( !v15 )
    v15 = *(_QWORD *)(v3 + 16) - *(_QWORD *)GUID_3fd7f233_a716_472e_8f2f_c25954f34e96.Data4;
