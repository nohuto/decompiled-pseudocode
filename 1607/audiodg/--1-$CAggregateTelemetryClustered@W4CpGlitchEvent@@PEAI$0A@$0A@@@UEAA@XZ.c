/*
 * XREFs of ??1?$CAggregateTelemetryClustered@W4CpGlitchEvent@@PEAI$0A@$0A@@@UEAA@XZ @ 0x140014A08
 * Callers:
 *     ??1CCrossProcessBaseEndpoint@@UEAA@XZ @ 0x140013F5C (--1CCrossProcessBaseEndpoint@@UEAA@XZ.c)
 *     ??1CCrossProcessEndpointTraceLogger@@UEAA@XZ @ 0x140025994 (--1CCrossProcessEndpointTraceLogger@@UEAA@XZ.c)
