/*
 * XREFs of ?GetFormat@CSystemAudioDeviceExclusive@@UEAAJ_KPEAPEAUtWAVEFORMATEX@@@Z @ 0x14002A270
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceExclusive::GetFormat", 468, v6);
  }
