/*
 * XREFs of ??0?$CComAggObject@VCCrossProcessServerInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x1400345E0
 * Callers:
        ...
        __int64 a2)
{
  ...
  *v4 = &ATL::CComContainedObject<CCrossProcessServerInputEndpoint>::`vftable'{for `IAudioEndpoint'};
  ...
  v4[47] = &ATL::CComContainedObject<CCrossProcessServerInputEndpoint>::`vftable'{for `CCrossProcessBaseServerEndpoint'};
