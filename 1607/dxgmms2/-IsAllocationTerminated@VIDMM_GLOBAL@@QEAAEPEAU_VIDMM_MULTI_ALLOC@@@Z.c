/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C0089774
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C001D580 (VidMmIsAllocationTerminated.c)
 * Callees:
