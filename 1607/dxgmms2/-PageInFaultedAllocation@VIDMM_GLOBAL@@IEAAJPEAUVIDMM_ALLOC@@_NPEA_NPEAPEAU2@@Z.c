/*
 * XREFs of ?PageInFaultedAllocation@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@_NPEA_NPEAPEAU2@@Z @ 0x1C004EE44
 * Callers:
        ...
        struct VIDMM_ALLOC **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( *(_WORD *)(*(_QWORD *)(v10 + 96) + 4LL) < 3u )
  {
    ...
    {
      v8 = VIDMM_GLOBAL::PageInOneAllocation(this, v10, (**(_DWORD **)(v9 + 504) & 0x20000) != 0 ? 5 : 0, v12, a4, a5);
      if ( v8 != -1071775466 )
        goto LABEL_4;
    }
    if ( (*(_DWORD *)(v9 + 76) & 0x8000000) == 0 )
      goto LABEL_10;
    inited = VIDMM_GLOBAL::InitContextAllocation(this, a2, 0, a4, a5);
