/*
 * XREFs of Template_txqqqtxtx @ 0x1C0026230
 * Callers:
 *     VidSchEnterIndependentFlip @ 0x1C00264B0 (VidSchEnterIndependentFlip.c)
 *     VidSchExitIndependentFlipInternal @ 0x1C00267C4 (VidSchExitIndependentFlipInternal.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0013750 (__security_check_cookie.c)
 */

NTSTATUS __fastcall Template_txqqqtxtx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v27 = 4LL;
  v29 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndependentFlipTransition, 0LL, 9u, &UserData);
}
