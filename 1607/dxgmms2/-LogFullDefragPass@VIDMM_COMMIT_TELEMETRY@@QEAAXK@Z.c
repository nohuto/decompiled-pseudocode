/*
 * XREFs of ?LogFullDefragPass@VIDMM_COMMIT_TELEMETRY@@QEAAXK@Z @ 0x1C009C2D8
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogFullDefragPass(GUID *pRelatedActivityId, int a2)
{
  const GUID *v4; // r9
  __int64 v5; // rax
  ...
  if ( pRelatedActivityId[1].Data4[0]
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)pRelatedActivityId->Data4 + 256LL)) <= 5 )
  {
    EtwActivityIdControl(3u, &ActivityId);
    if ( (unsigned int)hProvider > 5
      && (qword_1C0035010 & 0x200000000000LL) != 0
      && (qword_1C0035018 & 0x200000000000LL) == qword_1C0035018 )
    {
      v15 = 0;
      v13 = &v9;
      v5 = *(_QWORD *)&pRelatedActivityId->Data1;
      v9 = 1;
      v14 = 4;
      v6 = *(unsigned __int16 **)(*(_QWORD *)(v5 + 24) + 1072LL);
      v18 = 0;
      v16 = v20;
      v17 = 2;
      v7 = *v6;
      ...
      v10 = a2;
      v22 = 4;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C002AAB3, &ActivityId, v4, 6u, &pData);
    }
