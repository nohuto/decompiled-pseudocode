/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C0045914
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::InitializePagingQueue(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  *(_DWORD *)(a1 + 132) = dword_1C003538C;
  *(_DWORD *)(a1 + 116) = a5;
  v7 = *(_QWORD *)(a4 + 24);
  if ( *(int *)(v7 + 1792) < 0x2000 )
    v8 = 1;
  else
    v8 = *(_DWORD *)(v7 + 248);
  if ( v8 > 1 )
  ...
  if ( v9 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(a1 + 24) = v12;
      ...
      {
        v14 = *(_QWORD *)(a1 + 144);
        v15 = (*(_BYTE *)(*(_QWORD *)(v14 + 8) + 48LL) & 2) != 0;
        *(_BYTE *)(a1 + 129) = 0;
        *(_BYTE *)(a1 + 128) = v15;
        v16 = *(_QWORD *)(*(_QWORD *)(v14 + 8) + 32LL);
        if ( v16 )
        {
          if ( !*(_BYTE *)(v16 + 288) && !*(_BYTE *)(v16 + 290) )
            v6 = 0;
          *(_BYTE *)(a1 + 129) = v6;
        }
        ...
        *(_QWORD *)(v14 + 120) = 0LL;
        ...
        if ( *(_BYTE *)(v14 + 49) )
        {
          ...
          *(_QWORD *)(v20 + 8) = KeGetCurrentThread();
          VIDMM_PAGING_QUEUE::SetStatus((__int64 *)a1, 2LL, v21, v22);
          v23 = **(_QWORD **)v14 + 128LL;
          *(_QWORD *)(v23 + 8) = 0LL;
