/*
 * XREFs of ?OpenAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@IPEAXHPEAVDXGALLOCATION@@PEAPEAU_VIDMM_MULTI_ALLOC@@PEAIPEAE@Z @ 0x1C00575C0
 * Callers:
 *     VidMmOpenAllocation @ 0x1C0010CF0 (VidMmOpenAllocation.c)
 * Callees:
        ...
        unsigned __int8 *a10)
{
  ...
  v13 = a10;
  *a8 = 0LL;
  result = VIDMM_GLOBAL::OpenOneAllocation(this, a2, a3, (__int64)a5, a6, a7, (struct VIDMM_ALLOC **)&a8, v13);
  if ( (int)result >= 0 )
  {
