/*
 * XREFs of ?RollbackPlacementOfPendingResources@VIDMM_LINEAR_POOL@@QEAAX_K0W4VIDMM_DEFRAGMENT_DIRECTION@@P6A_NPEAU_VIDMM_GLOBAL_ALLOC@@PEA_K@Z@Z @ 0x1C009F8AC
 * Callers:
 ...
 *     ?RepairPendingResourceCB@VIDMM_SEGMENT@@SA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEA_K@Z @ 0x1C0099C28 (-RepairPendingResourceCB@VIDMM_SEGMENT@@SA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEA_K@Z.c)
 */
            ...
            *v10 = v21;
            if ( *((_BYTE *)v8 + 56) == 2 )
            {
              ...
              if ( !v8[1] )
              {
                v15 = v8 + 5;
                v16 = v8[5];
                v17 = (unsigned __int64 *)v8[6];
                if ( *(unsigned __int64 **)(v16 + 8) != v8 + 5 || (_QWORD *)*v17 != v15 )
                  __fastfail(3u);
                *v17 = v16;
                *(_QWORD *)(v16 + 8) = v17;
                *v15 = 0LL;
                ...
                if ( *(unsigned __int64 **)(v19 + 8) != v8 + 3 || (_QWORD *)*v20 != v18 )
                  __fastfail(3u);
                *v20 = v19;
                *(_QWORD *)(v19 + 8) = v20;
                *v18 = 0LL;
