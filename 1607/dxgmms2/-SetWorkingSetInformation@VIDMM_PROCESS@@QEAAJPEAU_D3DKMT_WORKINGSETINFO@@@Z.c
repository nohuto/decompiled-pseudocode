/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C0090A48
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C001D650 (VidMmSetWorkingSetInformation.c)
 * Callees:
