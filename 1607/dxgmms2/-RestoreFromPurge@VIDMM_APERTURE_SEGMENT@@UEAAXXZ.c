/*
 * XREFs of ?RestoreFromPurge@VIDMM_APERTURE_SEGMENT@@UEAAXXZ @ 0x1C006AB40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_APERTURE_SEGMENT::RestoreFromPurge(VIDMM_APERTURE_SEGMENT *this)
{
  ...
  while ( v3 != v1 )
  {
    v5 = (struct _VIDMM_GLOBAL_ALLOC *)(v3 - 400);
    v3 = *(char **)v3;
    v6 = **((_DWORD **)v5 + 63);
    if ( (v6 & 0x10000000) == 0 )
    {
