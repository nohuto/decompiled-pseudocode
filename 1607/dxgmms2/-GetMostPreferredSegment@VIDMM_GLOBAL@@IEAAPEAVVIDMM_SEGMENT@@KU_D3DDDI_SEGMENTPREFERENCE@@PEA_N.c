/*
 * XREFs of ?GetMostPreferredSegment@VIDMM_GLOBAL@@IEAAPEAVVIDMM_SEGMENT@@KU_D3DDDI_SEGMENTPREFERENCE@@PEA_N@Z @ 0x1C0087818
 * Callers:
  ...
  if ( a3.0 )
  {
    if ( (*(_BYTE *)&a3.0 & 0x1F) != 0 )
    {
      v4 = *(_QWORD *)(*((_QWORD *)this + 464)
                     + 8LL * ((*(_BYTE *)&a3.0 & 0x1Fu) + *(_DWORD *)(456LL * a2 + *((_QWORD *)this + 5017) + 4) - 1));
      *a4 = *(_BYTE *)(v4 + 56) & 1;
    }
    else
    {
      ...
      if ( v5 )
        return *(struct VIDMM_SEGMENT **)(*((_QWORD *)this + 464)
                                        + 8LL * (v5 + *(_DWORD *)(456LL * a2 + *((_QWORD *)this + 5017) + 4) - 1));
    }
  }
