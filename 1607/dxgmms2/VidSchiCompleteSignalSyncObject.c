/*
 * XREFs of VidSchiCompleteSignalSyncObject @ 0x1C000AA90
 * Callers:
...
void __fastcall VidSchiCompleteSignalSyncObject(__int64 a1, __int64 a2, _QWORD *a3, __int64 a4)
{
  __int64 v4; // rsi
  __int64 v6; // rcx
  char v7; // bp
  ...
  if ( (_DWORD)v6 == 4 )
  {
    if ( !*(_BYTE *)(a1 + 28) )
    {
      v14 = (_QWORD *)WdLogNewEntry5_WdEvent(v6, a2, a3, a4);
      v14[3] = a1;
      v14[4] = **(_QWORD **)(a1 + 56);
      v14[5] = *a3;
  ...
  if ( *(_BYTE *)(a1 + 27) && v7 && ((*(_DWORD *)(a1 + 40) - 2) & 0xFFFFFFFD) == 0 )
