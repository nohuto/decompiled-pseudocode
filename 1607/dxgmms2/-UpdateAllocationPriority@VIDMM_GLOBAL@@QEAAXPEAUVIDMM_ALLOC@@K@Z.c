/*
 * XREFs of ?UpdateAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@K@Z @ 0x1C008B3EC
 * Callers:
...
void __fastcall VIDMM_GLOBAL::UpdateAllocationPriority(VIDMM_GLOBAL *this, __int64 **a2, int a3)
{
  ...
  v6 = *(_DWORD *)(v4 + 392);
  *(_DWORD *)(v4 + 392) = a3;
  if ( v5 && (*(_DWORD *)(*(_QWORD *)(v4 + 136) + 56LL) & 0x1001) != 0 && (*(_DWORD *)(v4 + 76) & 0x400) == 0 )
  {
    ...
    if ( (_DWORD)PriorityClass != v9 )
    {
      ...
      if ( v14 != (_QWORD *)(v4 + 296) )
      {
        ...
        do
        {
          ...
          while ( v17 != v16 )
          {
            ...
            if ( (v18[7] & 3) == 2 )
            {
              ...
              *((_QWORD *)v19 + v15 + 28) -= *(_QWORD *)(v4 + 16);
              *((_QWORD *)v19 + v10 + 28) += *(_QWORD *)(v4 + 16);
        ...
        while ( v14 != (_QWORD *)(v4 + 296) );
      }
      DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v4 + 320), v11, v12, v13);
