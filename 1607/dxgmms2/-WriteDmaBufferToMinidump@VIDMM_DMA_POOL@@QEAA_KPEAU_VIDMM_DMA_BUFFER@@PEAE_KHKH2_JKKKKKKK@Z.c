/*
 * XREFs of ?WriteDmaBufferToMinidump@VIDMM_DMA_POOL@@QEAA_KPEAU_VIDMM_DMA_BUFFER@@PEAE_KHKH2_JKKKKKKK@Z @ 0x1C0091740
 * Callers:
        ...
        unsigned int a16)
{
  ...
  *((_QWORD *)&v53 + 1) = __PAIR64__(v23, v21);
  ...
  if ( v26 && v26 <= v16 )
  {
    memmove(v17, *(const void **)(*((_QWORD *)a2 + 7) + 376LL), v26);
    v17 += v26;
    v46 += v26;
    v16 -= v26;
  }
