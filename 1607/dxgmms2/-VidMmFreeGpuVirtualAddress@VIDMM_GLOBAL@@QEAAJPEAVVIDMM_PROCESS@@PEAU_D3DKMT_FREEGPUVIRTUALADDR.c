/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C0057F04
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C00123E0 (VidMmFreeGpuVirtualAddress.c)
