/*
 * XREFs of LookUpTableFlushComplete @ 0x1C001356C
 * Callers:
 *     TlgAggregateInternalProviderCallback @ 0x1C00134E0 (TlgAggregateInternalProviderCallback.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C0028580 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C0028A78 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(_DWORD *a1)
{
  ...
  if ( a1[64] )
  {
    ...
    if ( *(_QWORD *)(v4 + 344) )
    {
      if ( (unsigned int)dword_1C0035090 > 5
        && (qword_1C00350A0 & 0x400000000000LL) != 0
        && (qword_1C00350A8 & 0x400000000000LL) == qword_1C00350A8 )
      {
        v7 = *(_OWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 400) + 8LL) - 16LL);
        v18 = &v16;
        v20 = a1 + 88;
        v15[0] = (unsigned int)a1[90];
        v22 = v15;
        v10 = a1[91];
        v26 = &v10;
        v11 = a1[92];
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0035090, &unk_1C002B26F, 0LL, v5, 0xBu, &pData);
      }
