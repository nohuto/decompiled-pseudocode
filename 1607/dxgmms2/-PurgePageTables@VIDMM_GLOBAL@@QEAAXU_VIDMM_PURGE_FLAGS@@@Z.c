/*
 * XREFs of ?PurgePageTables@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@@Z @ 0x1C006A360
 * Callers:
...
void __fastcall VIDMM_GLOBAL::PurgePageTables(__int64 a1, char a2)
{
  ...
  if ( (*(_BYTE *)(a1 + 40872) & 1) != 0 )
  {
    ...
    if ( *(_DWORD *)(a1 + 6416) )
    {
      while ( 1 )
      {
        v4 = *(_QWORD *)(a1 + 40136) + 456LL * (unsigned int)v3;
        v5 = *(_BYTE *)(v4 + 420);
        if ( (v5 & 1) != 0 && ((a2 & 1) == 0 || v5 < 0) )
        {
          for ( i = *(_QWORD **)(a1 + 41008); i != (_QWORD *)(a1 + 41008); i = (_QWORD *)*i )
          {
            v7 = (CVirtualAddressAllocator *)i[55];
            if ( v7 )
            {
              if ( i[2] != *(_QWORD *)(a1 + 40320) )
              {
        ...
        v8 = *(CVirtualAddressAllocator **)(a1 + 8 * v3 + 40352);
