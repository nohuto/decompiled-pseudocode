/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C0073BB8
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  v10[3] = &qword_1C0035150;
  LODWORD(v10[13]) = 4;
  v10[5] = &v8;
  LODWORD(v10[15]) = 288;
  v10[9] = L"PinnedBackingStoreLimit";
  v10[10] = &qword_1C0035158;
  v10[12] = &v9;
  ...
  v0 = qword_1C0035150 << 20;
  v1 = qword_1C0035158 << 20;
  v2 = v6 << 20;
  v3 = v7 << 20;
  qword_1C0035150 <<= 20;
  qword_1C0035158 <<= 20;
  ...
  if ( v0 < v2 )
  {
    if ( qword_1C0035148 <= (unsigned __int64)v3 )
    {
      qword_1C0035150 = v2;
    }
    else
    {
      v5 = (qword_1C0035148 - (unsigned __int64)v3) >> 1;
      if ( v4 > v5 )
        v5 = v4;
      qword_1C0035150 = v5;
    }
  ...
  if ( !v1 )
    qword_1C0035158 = (unsigned __int64)qword_1C0035148 >> 3;
}
