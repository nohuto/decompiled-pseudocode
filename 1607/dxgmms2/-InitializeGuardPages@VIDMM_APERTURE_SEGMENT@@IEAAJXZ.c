/*
 * XREFs of ?InitializeGuardPages@VIDMM_APERTURE_SEGMENT@@IEAAJXZ @ 0x1C006D130
 * Callers:
...
__int64 __fastcall VIDMM_APERTURE_SEGMENT::InitializeGuardPages(PHYSICAL_ADDRESS *this)
{
  ...
  this[59].QuadPart = (LONGLONG)PagesForMdl;
  if ( !PagesForMdl )
  {
    _InterlockedIncrement(&dword_1C0035600);
  ...
  this[61].QuadPart = *(_QWORD *)(this[59].QuadPart + 48) << 12;
  v6 = v4;
  for ( i = 1024LL; i; --i )
    *v6++ = 1685217607;
  return 0LL;
