/*
 * XREFs of ?ReclaimRange@VIDMM_CPU_HOST_APERTURE@@QEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0012ED8
 * Callers:
...
char __fastcall VIDMM_CPU_HOST_APERTURE::ReclaimRange(VIDMM_CPU_HOST_APERTURE *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( *((_QWORD *)a2 + 58) )
  {
    v3 = (_QWORD *)((char *)a2 + 472);
    v4 = *((_QWORD *)a2 + 59);
    v5 = (_QWORD *)*((_QWORD *)a2 + 60);
    if ( *(_QWORD **)(v4 + 8) != v3 || (_QWORD *)*v5 != v3 )
      __fastfail(3u);
    *v5 = v4;
    *(_QWORD *)(v4 + 8) = v5;
    v6 = *(_QWORD *)this;
