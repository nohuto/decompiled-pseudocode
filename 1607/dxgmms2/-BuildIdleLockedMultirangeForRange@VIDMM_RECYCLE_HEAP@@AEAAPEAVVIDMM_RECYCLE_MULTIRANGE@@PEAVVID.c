/*
 * XREFs of ?BuildIdleLockedMultirangeForRange@VIDMM_RECYCLE_HEAP@@AEAAPEAVVIDMM_RECYCLE_MULTIRANGE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C00957F4
 * Callers:
        ...
        struct VIDMM_RECYCLE_RANGE *a2)
{
  ...
  if ( Multirange )
  {
    if ( v9 )
    {
      ...
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree((__int64)this, 0LL, (__int64)Multirange, v7);
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree((__int64)this, 0LL, v9, v12);
  ...
  {
    VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree((__int64)this, 0LL, v9, v7);
    *(_QWORD *)(v9 + 64) = a2;
  ...
  VIDMM_RECYCLE_HEAP::AddMultirangeToTree(this, 0LL, (__int64)Multirange, v13);
