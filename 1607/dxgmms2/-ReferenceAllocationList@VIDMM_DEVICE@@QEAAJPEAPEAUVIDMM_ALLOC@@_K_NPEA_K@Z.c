/*
 * XREFs of ?ReferenceAllocationList@VIDMM_DEVICE@@QEAAJPEAPEAUVIDMM_ALLOC@@_K_NPEA_K@Z @ 0x1C005C2C0
 * Callers:
 ...
 *     ?GetNumBytesToTrim@VIDMM_PROCESS_BUDGET_STATE@@QEAAXPEA_K_N1PEAVVIDMM_GLOBAL@@K@Z @ 0x1C005D38C (-GetNumBytesToTrim@VIDMM_PROCESS_BUDGET_STATE@@QEAAXPEA_K_N1PEAVVIDMM_GLOBAL@@K@Z.c)
        ...
        unsigned __int64 *a5)
{
  ...
  for ( j = v10; j != v17; ++j )
  {
    v19 = *j;
    v20 = **(_QWORD **)*j;
    if ( !(((*((_BYTE *)*j + 25) & 1) != 0) | *((_DWORD *)*j + 42)) && !*((_BYTE *)v19 + 27) )
    {
      v21 = **(_QWORD **)v19;
      ...
      v23 = *(_QWORD *)(*((_QWORD *)this + 2) + 48LL) + 264LL * (*(_DWORD *)(v20 + 76) & 0x3F) + 8 * v22;
  ...
  *a5 = 0LL;
  for ( k = *v24; v25 < *((_DWORD *)*v24 + 1604); k = *v24 )
  {
    VIDMM_PROCESS_BUDGET_STATE::GetNumBytesToTrim(
      (struct VIDMM_GLOBAL *)((char *)v24[6] + 264 * v25),
      &v51,
      a4,
      0,
      k,
  ...
  else
  {
    ...
    for ( ; v10 != v17; ++v10 )
    {
      v33 = *v10;
      v34 = **(_QWORD **)*v10;
      v35 = *(_QWORD *)(*((_QWORD *)this + 2) + 48LL) + 264LL * (*(_DWORD *)(v34 + 76) & 0x3F);
      if ( !(((*((_BYTE *)*v10 + 25) & 1) != 0) | *((_DWORD *)*v10 + 42)) )
      {
        ...
        *((_QWORD *)v36 + 1) = v38;
        ...
        if ( *v39 != (VIDMM_DEVICE *)((char *)this + 144) )
          __fastfail(3u);
