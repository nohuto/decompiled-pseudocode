/*
 * XREFs of Template_ppx @ 0x1C001E92C
 * Callers:
...
NTSTATUS Template_ppx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingQueueSelect, 0LL, 3u, &UserData);
}
