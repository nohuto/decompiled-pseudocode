/*
 * XREFs of VidSchiRecoverFromTDR @ 0x1C00A27F4
 * Callers:
...
void __fastcall VidSchiRecoverFromTDR(__int64 a1)
{
    ...
    && (qword_1C0035018 & 0x400000000010LL) == qword_1C0035018 )
  {
    ...
    v20 = 8LL;
    v22 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C002B17C, 0LL, (LPCGUID)8, 8u, &pData);
  }
  v5 = *(struct _TDR_RECOVERY_CONTEXT **)(a1 + 2808);
  *(_DWORD *)(a1 + 2800) = 2;
