/*
 * XREFs of ?MoveResourcesForAllocationPlacement@VIDMM_SEGMENT@@QEAAJPEAUVIDMM_ALLOC@@_K1W4VIDMM_DEFRAGMENT_DIRECTION@@PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00995F4
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  v8 = *MEMORY[0];
  VIDMM_LINEAR_POOL::FindBestDefragmentRegion(*(_QWORD *)(a1 + 144), v10);
  if ( v11 )
  {
