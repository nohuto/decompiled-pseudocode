/*
 * XREFs of VidSchSetQueuedPresentLimit @ 0x1C0040880
 * Callers:
...
__int64 __fastcall VidSchSetQueuedPresentLimit(__int64 a1, __int64 a2)
{
  ...
  v3 = *(_QWORD *)(a1 + 32);
  if ( *(_BYTE *)(a1 + 164) || _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 160), 0, 0) )
  {
    v7 = WdLogNewEntry5_WdWarning(v3);
    *(_QWORD *)(v7 + 24) = a1;
    v6 = -1071775232;
