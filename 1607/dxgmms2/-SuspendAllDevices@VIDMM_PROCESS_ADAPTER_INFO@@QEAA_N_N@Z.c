/*
 * XREFs of ?SuspendAllDevices@VIDMM_PROCESS_ADAPTER_INFO@@QEAA_N_N@Z @ 0x1C0090328
 * Callers:
...
LABEL_14:
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(v12 + 24) )
      {
        VIDMM_DEVICE::IndefinitelySuspend((__int64 **)v11[6], 1);
LABEL_12:
        VIDMM_DEVICE::FaultAllAllocations((VIDMM_DEVICE *)v12, v13, v14, v15);
        v6 = 1;
      }
LABEL_13:
    ...
    if ( !*(_QWORD *)(v12 + 24)
      || (*(_DWORD *)(v12 + 52) & 7) != 0
      || VIDMM_DEVICE::IsResumedRecently((VIDMM_DEVICE *)v12) )
    {
      goto LABEL_13;
    }
    VIDMM_DEVICE::FullySuspend(v16);
    goto LABEL_12;
  }
  return v6;
}
