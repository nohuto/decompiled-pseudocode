/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C008C27C
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C001D700 (VidMmValidateHistoryBuffers.c)
 * Callees:
