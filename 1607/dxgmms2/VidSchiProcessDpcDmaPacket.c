/*
 * XREFs of VidSchiProcessDpcDmaPacket @ 0x1C0024584
 * Callers:
...
void __fastcall VidSchiProcessDpcDmaPacket(struct _VIDSCH_DMA_PACKET *a1, __int64 a2)
{
  ...
  *(_DWORD *)(v4 + 496) = ((unsigned __int8)*(_DWORD *)(v4 + 496) + 1) & 0xF;
  KeAcquireInStackQueuedSpinLockAtDpcLevel(v6 + 232, &LockHandle);
  v8 = *((_DWORD *)a1 + 23);
  if ( (v8 & 0x400) != 0 )
  {
    *((_DWORD *)a1 + 23) = v8 & 0xFFFFFBFF;
    if ( *(_DWORD *)(v4 + 2788) != -1 )
    {
      v9 = (void (__fastcall *)(KSPIN_LOCK))v6[358];
      if ( v9 )
        v9(v6[362]);
    }
  }
  ...
  {
    if ( *(_DWORD *)(v6[*(unsigned int *)(*((_QWORD *)a1 + 7) + 380LL) + 371] + 18872) != -1 )
    {
      v10 = (void (__fastcall *)(KSPIN_LOCK))v6[356];
      if ( v10 )
        v10(v6[362]);
    }
    *((_DWORD *)a1 + 23) &= ~0x800u;
  ...
  VidSchiInterlockedInsertTailList((KSPIN_LOCK *)(*(_QWORD *)(v4 + 24) + 1864LL), v4 + 2800, (_QWORD *)a1 + 2, 0LL);
}
