/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C0058F80
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C0011C80 (VidMmDestroyContextAllocation.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::DestroyContextAllocation(VIDMM_GLOBAL *this, struct _VIDMM_CONTEXT_ALLOC *a2)
{
  ...
  if ( a2 )
  {
    ...
    VIDMM_GLOBAL::DestroyOneAllocation(this, Flink, v5, 0LL);
    return 0LL;
  }
  else
  {
