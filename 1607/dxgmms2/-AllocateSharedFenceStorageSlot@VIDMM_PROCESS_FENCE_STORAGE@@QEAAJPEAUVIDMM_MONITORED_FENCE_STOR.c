/*
 * XREFs of ?AllocateSharedFenceStorageSlot@VIDMM_PROCESS_FENCE_STORAGE@@QEAAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z @ 0x1C001F704
 * Callers:
        ...
        struct VIDMM_MONITORED_FENCE_STORAGE *a2)
{
  ...
  v4 = (VIDMM_FENCE_STORAGE_PAGE *)operator new(0x70uLL, 0x34346956u, (POOL_TYPE)512);
  if ( v4 )
