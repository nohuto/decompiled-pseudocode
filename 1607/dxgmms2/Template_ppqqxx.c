/*
 * XREFs of Template_ppqqxx @ 0x1C0022AA8
 * Callers:
...
NTSTATUS Template_ppqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventSelectContext, 0LL, 6u, &UserData);
}
