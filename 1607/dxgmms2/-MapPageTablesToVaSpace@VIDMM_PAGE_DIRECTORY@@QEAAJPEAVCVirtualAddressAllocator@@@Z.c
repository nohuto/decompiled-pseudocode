/*
 * XREFs of ?MapPageTablesToVaSpace@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@@Z @ 0x1C006D2A8
 * Callers:
        ...
        struct CVirtualAddressAllocator *a2)
{
  ...
  struct VIDMM_ALLOC *v24; // [rsp+80h] [rbp-38h] BYREF
  unsigned int v27; // [rsp+D0h] [rbp+18h]
  __int64 i; // [rsp+D8h] [rbp+20h]
...
LABEL_6:
  ...
  if ( !VIDMM_ALLOC::GetGpuVirtualAddress(*(VIDMM_ALLOC **)(v7 + 16), (*(_DWORD *)v2 >> 7) & 0x1F) )
  {
    ...
    if ( !CVirtualAddressAllocator::MapVirtualAddressRange(
            ...
            *(unsigned int *)(*(_QWORD *)(v7 + 8) + 16LL),
            0LL,
            *(_QWORD *)(*((_QWORD *)v10 + 8) + 40880LL),
            *(_QWORD *)(*((_QWORD *)v10 + 8) + 40888LL),
            4096,
            1LL,
            0LL,
            v9,
  ...
  v14 = *(_DWORD *)(32LL * ((*(_DWORD *)v2 >> 7) & 0x1F) + *((_QWORD *)v10 + 12) + 28);
