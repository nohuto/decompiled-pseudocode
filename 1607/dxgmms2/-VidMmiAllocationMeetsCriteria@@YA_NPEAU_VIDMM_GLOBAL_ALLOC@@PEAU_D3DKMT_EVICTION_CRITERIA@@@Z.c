/*
 * XREFs of ?VidMmiAllocationMeetsCriteria@@YA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C008D740
 * Callers:
...
bool __fastcall VidMmiAllocationMeetsCriteria(struct _VIDMM_GLOBAL_ALLOC *a1, struct _D3DKMT_EVICTION_CRITERIA *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v3 < a2->MinimumSize
      || v3 > a2->MaximumSize
      || (a2->Value & 1) != 0 && ((**((_DWORD **)a1 + 63) | (**((_DWORD **)a1 + 63) >> 1)) & 0x40000000) == 0 )
    {
      return 0;
    }
  }
