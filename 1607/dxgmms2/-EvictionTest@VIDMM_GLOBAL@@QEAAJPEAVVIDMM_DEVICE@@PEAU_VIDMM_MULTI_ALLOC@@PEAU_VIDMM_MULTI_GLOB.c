/*
 * XREFs of ?EvictionTest@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0088FC0
 * Callers:
 *     ?VidMmEvictionTest@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C001D2C0 (-VidMmEvictionTest@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MU.c)
 * Callees:
