/*
 * XREFs of Template_pqXR1qqqXR5 @ 0x1C0022D6C
 * Callers:
...
NTSTATUS Template_pqXR1qqqXR5(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  int v8; // [rsp+58h] [rbp-31h]
  int v9; // [rsp+5Ch] [rbp-2Dh]
  ...
  __int64 v19; // [rsp+D8h] [rbp+4Fh] BYREF
  va_list va; // [rsp+D8h] [rbp+4Fh]
  __int64 v21; // [rsp+E0h] [rbp+57h] BYREF
  va_list va1; // [rsp+E0h] [rbp+57h]
  __int64 v23; // [rsp+E8h] [rbp+5Fh]
  ...
  va_list va4; // [rsp+100h] [rbp+77h]
  __int64 v30; // [rsp+108h] [rbp+7Fh]
  va_list va5; // [rsp+110h] [rbp+87h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v15 = 4LL;
  v18 = 0;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventVSyncDPCMultiPlane, 0LL, 7u, &UserData);
}
