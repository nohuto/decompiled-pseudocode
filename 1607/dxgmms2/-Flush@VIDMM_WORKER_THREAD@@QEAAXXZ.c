/*
 * XREFs of ?Flush@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C008FC30
 * Callers:
 ...
 * Callees:
 *     ?TransitionToState@VIDMM_WORKER_THREAD@@QEAAXW4VIDMM_WORKER_THREAD_STATUS@@@Z @ 0x1C004B79C (-TransitionToState@VIDMM_WORKER_THREAD@@QEAAXW4VIDMM_WORKER_THREAD_STATUS@@@Z.c)
 */
