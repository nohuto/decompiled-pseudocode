/*
 * XREFs of ?ValidateApertureCoherency@VIDMM_GLOBAL@@QEAAJK_KKPEAU_MDL@@PEAK12E@Z @ 0x1C009AF28
 * Callers:
        ...
        unsigned __int8 a9)
{
  ...
  __int64 v31; // rcx
  __int64 v32; // rcx
  unsigned int v34; // [rsp+58h] [rbp-71h]
  unsigned int v35; // [rsp+58h] [rbp-71h]
  union _LARGE_INTEGER v36; // [rsp+70h] [rbp-59h] BYREF
  __int64 v37; // [rsp+78h] [rbp-51h]
  __int64 v38; // [rsp+80h] [rbp-49h] BYREF
  __int64 v39; // [rsp+88h] [rbp-41h] BYREF
  union _LARGE_INTEGER v40; // [rsp+90h] [rbp-39h] BYREF
  union _LARGE_INTEGER v41; // [rsp+98h] [rbp-31h] BYREF
  union _LARGE_INTEGER v42; // [rsp+A0h] [rbp-29h] BYREF
  unsigned int *v43; // [rsp+A8h] [rbp-21h] BYREF
  unsigned int v44; // [rsp+B0h] [rbp-19h]
  unsigned __int8 v45; // [rsp+B4h] [rbp-15h]
  __int64 v46; // [rsp+B8h] [rbp-11h]
  VIDMM_GLOBAL *v47; // [rsp+C0h] [rbp-9h]
  union _LARGE_INTEGER v48; // [rsp+110h] [rbp+47h] BYREF
  union _LARGE_INTEGER v49; // [rsp+120h] [rbp+57h]
        ...
        while ( 1 )
        {
          ...
          VIDMM_GLOBAL::MemoryTransferInternal(
            ...
            *(struct VIDMM_SEGMENT **)(v23 + 8 * v14),
            &v41,
            0LL,
            *(struct VIDMM_SEGMENT **)(v23 + 8 * v37),
            &v36,
            0LL,
            v34,
            0);
          ...
          VIDMM_GLOBAL::MemoryTransferInternal(
            ...
            0x1000uLL,
            0LL,
            *(struct VIDMM_SEGMENT **)(v24 + 8 * v37),
            &v36,
            0LL,
          ...
          v44 = v19 + 868941431;
          v43 = &a6[v22];
          VIDMM_GLOBAL::FlushPagingBuffer(this, 0, (void (*)(void *))VIDMM_DMA_POOL::EndCPUAccess, &v43);
