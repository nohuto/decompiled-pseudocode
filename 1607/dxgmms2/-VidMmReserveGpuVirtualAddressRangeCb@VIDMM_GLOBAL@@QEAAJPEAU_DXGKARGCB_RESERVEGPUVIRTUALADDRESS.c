/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C0057AA0
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C0011C90 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
...
LABEL_9:
  ...
  v10 = 1;
  if ( *(_BYTE *)(*((_QWORD *)v2->hDxgkProcess + 4) + 289LL) )
  {
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      else if ( (*(_BYTE *)(*((_QWORD *)this + 5017) + v12 + 420) & 1) != 0 )
      {
        return 3221225485LL;
      }
      ++v11;
