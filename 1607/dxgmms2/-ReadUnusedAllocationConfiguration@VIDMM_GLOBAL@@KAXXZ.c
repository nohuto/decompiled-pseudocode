/*
 * XREFs of ?ReadUnusedAllocationConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C007350C
 * Callers:
...
void VIDMM_GLOBAL::ReadUnusedAllocationConfiguration(void)
{
  ...
  xmmword_1C0035210 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C0035230 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C0035250 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v1 = 1;
  v8 = 1;
  xmmword_1C0035220 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v3 = 15;
  v6 = 1000000;
  v11 = 1000000;
  v12 = 15;
  v13 = 15;
  qword_1C0035260 = 1000000LL;
  qword_1C00352D8 = 15LL;
  xmmword_1C00352E0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v2 = 0;
  v4 = 45;
  v5 = 120;
  v7 = 0;
  ...
  v14 = 30;
  v15 = 30;
  xmmword_1C0035240 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  qword_1C00352F0 = 30LL;
  ...
  LODWORD(v16[6]) = 4;
  v16[3] = &xmmword_1C0035210;
  v16[5] = &v1;
  v16[9] = L"Unused.MinimumThreshold";
  v16[10] = (char *)&xmmword_1C0035210 + 8;
  v16[12] = &v2;
  v16[16] = L"Unused.LowThreshold";
  v16[17] = &xmmword_1C0035220;
  v16[19] = &v3;
  v16[23] = L"Unused.NormalThreshold";
  v16[24] = (char *)&xmmword_1C0035220 + 8;
  v16[26] = &v4;
  v16[7] = 0LL;
  LODWORD(v16[8]) = 288;
  ...
  *(_QWORD *)&xmmword_1C0035210 = 10000000 * xmmword_1C0035210;
  *((_QWORD *)&xmmword_1C0035210 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0035220 = 10000000 * xmmword_1C0035220;
  *((_QWORD *)&xmmword_1C0035220 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0035230 = 10000000 * xmmword_1C0035230;
  *((_QWORD *)&xmmword_1C0035230 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0035240 = 10000000 * xmmword_1C0035240;
  *((_QWORD *)&xmmword_1C0035240 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0035250 = 10000000 * xmmword_1C0035250;
  *((_QWORD *)&xmmword_1C0035250 + 1) *= 10000000LL;
  qword_1C0035260 *= 10000000LL;
  do
    *v0++ *= 10000000LL;
  while ( (__int64)v0 < (__int64)&qword_1C00352F8 );
}
