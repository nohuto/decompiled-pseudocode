/*
 * XREFs of ?CreatePageDirectory@@YAPEAVVIDMM_PAGE_DIRECTORY@@PEAVCVirtualAddressAllocator@@II@Z @ 0x1C00676D0
 * Callers:
        ...
        int a3)
{
  ...
  v4 = a2;
  v6 = *(_QWORD *)(*((_QWORD *)a1 + 8) + 40136LL) + 456LL * a2;
  v7 = (VIDMM_PAGE_DIRECTORY *)operator new(0x28uLL, 0x36356956u, PagedPool);
  if ( v7 )
    v10 = VIDMM_PAGE_DIRECTORY::VIDMM_PAGE_DIRECTORY(v7, v4, *(_DWORD *)(v6 + 412), a3);
  else
    v10 = 0LL;
  if ( v10 )
  {
