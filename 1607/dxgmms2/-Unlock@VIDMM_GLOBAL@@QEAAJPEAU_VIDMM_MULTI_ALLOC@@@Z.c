/*
 * XREFs of ?Unlock@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C0059790
 * Callers:
 *     ?VidMmUnlock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C000FD70 (-VidMmUnlock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@@Z.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::Unlock(VIDMM_GLOBAL *this, __int64 **a2)
{
  ...
  if ( v6 )
  {
    ...
    LODWORD(v15[0]) = 129;
    v15[5] = v5;
    VIDMM_GLOBAL::QueueSystemCommandAndWait(this, (struct _VIDMM_SYSTEM_COMMAND *)v15);
  }
  return 0LL;
}
