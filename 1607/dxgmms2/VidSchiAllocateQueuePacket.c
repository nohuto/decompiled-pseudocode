/*
 * XREFs of VidSchiAllocateQueuePacket @ 0x1C00432A0
 * Callers:
...
__int64 *__fastcall VidSchiAllocateQueuePacket(__int64 a1, int a2)
{
  ...
  if ( v5 <= 0x370 )
    v5 = 880;
  v6 = VidSchiInterlockedRemoveHeadListIfExist((KSPIN_LOCK *)(v4 + 1864), (__int64 **)(a1 + 712), (_DWORD *)(a1 + 728));
  if ( v6 )
  {
    v7 = v6 - 1;
  }
  else
  {
    ...
    if ( a2 )
    {
      ...
      while ( !v7 );
      VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v4 + 1872), v12, 0LL);
    }
  }
  if ( v7 )
  {
LABEL_6:
    ...
    *((_DWORD *)v7 + 13) = 1;
    VidSchiInterlockedInsertTailList((KSPIN_LOCK *)(v4 + 1864), a1 + 760, v7 + 1, (_DWORD *)(a1 + 776));
  }
  return v7;
}
