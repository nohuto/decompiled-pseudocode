/*
 * XREFs of ?GetLargestGap@VIDMM_LINEAR_POOL@@QEAA_K_KKE00@Z @ 0x1C009F2B0
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  while ( 1 )
  {
    ...
    if ( *v13 != v8 )
    {
      VIDMM_LINEAR_POOL::ApplyBlockRunRestrictions(this, (unsigned __int64)&v17, &v16, &v15, a2, a3, a4, a5, a6);
      if ( !v17 && v9 <= v15 - v16 )
        v9 = v15 - v16;
      v8 = *v13;
      v16 = *v13;
