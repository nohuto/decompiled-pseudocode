/*
 * XREFs of ?WriteSegmentInformationToMinidump@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MINIDUMP_HEADER@@PEAE_K@Z @ 0x1C008D9B4
 * Callers:
  ...
  if ( *((_DWORD *)this + 926) )
  {
    do
    {
      ...
      *(_QWORD *)&v24[2] = 0LL;
      v12 = *(_QWORD *)(v11 + 8 * v6);
      v24[0] = *(_OWORD *)(v12 + 24);
      *(_QWORD *)&v24[1] = *(_QWORD *)(v12 + 40);
      *((_QWORD *)&v24[2] + 1) = *(_QWORD *)(v12 + 200);
      LODWORD(v24[3]) = *(_DWORD *)(v12 + 56);
