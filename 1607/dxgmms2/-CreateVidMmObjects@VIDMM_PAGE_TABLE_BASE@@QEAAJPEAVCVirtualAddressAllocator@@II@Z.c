/*
 * XREFs of ?CreateVidMmObjects@VIDMM_PAGE_TABLE_BASE@@QEAAJPEAVCVirtualAddressAllocator@@II@Z @ 0x1C004B450
 * Callers:
        ...
        int a4)
{
  ...
  int v14; // edx
  int v15; // ecx
  struct _VIDMM_GLOBAL_ALLOC **v16; // rbx
  ...
  v9 = *(_DWORD *)this;
  v10 = 0;
  v11 = *(_QWORD *)(v4 + 40136) + 456LL * ((*(_DWORD *)this >> 7) & 0x1F);
  ...
  *(_QWORD *)&v27[0].0 = 0LL;
  ...
  if ( a4 )
    ...
    v15 = *(unsigned __int16 *)(v11 + 12) - *(_DWORD *)(v11 + 4);
  v16 = this + 1;
  v17 = *(_DWORD *)(v11 + 48LL * (v9 & 7) + 84);
  if ( !v17 )
    v17 = 4096;
  ...
  if ( OneAllocation < 0 )
  {
    _InterlockedIncrement(&dword_1C0035588);
    v23 = WdLogNewEntry5_WdLowResource(v18);
    *(_QWORD *)(v23 + 24) = 4383LL;
  ...
  else
  {
    *((_DWORD *)*v16 + 19) |= 0x100u;
    ...
    if ( v20 < 0 )
    {
      _InterlockedIncrement(&dword_1C003558C);
      v24 = WdLogNewEntry5_WdLowResource(v21);
      *(_QWORD *)(v24 + 24) = 4414LL;
