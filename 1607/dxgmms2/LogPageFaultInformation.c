/*
 * XREFs of LogPageFaultInformation @ 0x1C00224EC
 * Callers:
...
TLG_STATUS __fastcall LogPageFaultInformation(int a1, __int64 a2, __int64 a3)
{
  ...
  v4 = *(_QWORD *)(a3 + 64);
  if ( (unsigned int)hProvider > 5 && (qword_1C0035010 & 0x400000000010LL) != 0 )
  {
    result = qword_1C0035018 & 0x10;
    if ( (qword_1C0035018 & 0x400000000010LL) == qword_1C0035018 )
    {
      v6 = *(_QWORD *)(a2 + 16);
      v7 = 0LL;
      v16 = *(_QWORD *)(v6 + 268);
      ...
      return TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C002AE29, 0LL, v9, 0x13u, &pData);
    }
  }
  return result;
}
