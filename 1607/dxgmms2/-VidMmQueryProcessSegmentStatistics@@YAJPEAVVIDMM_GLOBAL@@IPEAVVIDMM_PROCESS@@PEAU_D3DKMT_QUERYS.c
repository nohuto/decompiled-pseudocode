/*
 * XREFs of ?VidMmQueryProcessSegmentStatistics@@YAJPEAVVIDMM_GLOBAL@@IPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_INFORMATION@@@Z @ 0x1C001D3A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
