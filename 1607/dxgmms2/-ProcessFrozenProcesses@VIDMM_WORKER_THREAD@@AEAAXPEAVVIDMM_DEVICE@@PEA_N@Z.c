/*
 * XREFs of ?ProcessFrozenProcesses@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_DEVICE@@PEA_N@Z @ 0x1C0090288
 * Callers:
  ...
  *a3 = 0;
  ...
  while ( v7 != v6 )
  {
    ...
    if ( *((_QWORD **)a2 + 2) != v7 - 3 )
    {
      ...
      if ( v9 )
      {
        if ( *(_BYTE *)(v9 + 364) && VIDMM_PROCESS_ADAPTER_INFO::SuspendAllDevices(v8, 1) )
          *a3 = 1;
      }
    }
    v7 = (_QWORD *)*v7;
