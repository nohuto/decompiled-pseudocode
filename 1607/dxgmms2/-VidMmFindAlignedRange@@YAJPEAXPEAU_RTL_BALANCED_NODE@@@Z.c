/*
 * XREFs of ?VidMmFindAlignedRange@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z @ 0x1C00617E0
 * Callers:
...
__int64 __fastcall VidMmFindAlignedRange(_BYTE *a1, struct _RTL_BALANCED_NODE *a2)
{
  ...
  {
    if ( !VIDMM_RECYCLE_MULTIRANGE::IsRotateVAD((struct VIDMM_RECYCLE_RANGE **)a2) && v6[16] )
      return 0xFFFFFFFFLL;
  }
  else if ( ((__int64)a2[3].Right & 0x800000) == 0 && a1[16] )
  {
    return 0xFFFFFFFFLL;
  }
