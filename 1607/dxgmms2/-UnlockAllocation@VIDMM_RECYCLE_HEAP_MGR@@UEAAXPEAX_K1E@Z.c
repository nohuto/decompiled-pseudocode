/*
 * XREFs of ?UnlockAllocation@VIDMM_RECYCLE_HEAP_MGR@@UEAAXPEAX_K1E@Z @ 0x1C005FE00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a5)
{
  ...
  v5 = (VIDMM_RECYCLE_HEAP_MGR *)((char *)this + 896) == 0LL;
  v6 = (char *)this + 896;
  v16 = 0;
  v15 = v6;
  if ( v5 )
  ...
  LOBYTE(v10) = a5;
  VIDMM_RECYCLE_MULTIRANGE::Unlock(a2, a3, a4, v10);
  if ( v16 )
