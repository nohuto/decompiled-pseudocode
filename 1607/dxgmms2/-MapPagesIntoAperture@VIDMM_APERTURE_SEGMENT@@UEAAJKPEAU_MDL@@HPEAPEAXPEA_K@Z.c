/*
 * XREFs of ?MapPagesIntoAperture@VIDMM_APERTURE_SEGMENT@@UEAAJKPEAU_MDL@@HPEAPEAXPEA_K@Z @ 0x1C0096B30
 * Callers:
 *     <none>
 * Callees:
        ...
        union _LARGE_INTEGER *a6)
{
  ...
  if ( v7 > 0xFFFFFFFF )
    return 3221225621LL;
  LOBYTE(a4) = 1;
  v10 = VIDMM_LINEAR_POOL::Allocate(this[18], (unsigned int)v7, 0LL, a4, 0LL, 0LL, 0, 0, 0LL, &v11, a5);
  if ( v10 >= 0 )
  {
    *a6 = v11;
