/*
 * XREFs of Template_ppqqx @ 0x1C00229EC
 * Callers:
 ...
 *     ?PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@@_N11@Z @ 0x1C00113C4 (-PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@.c)
 * Callees:
...
NTSTATUS Template_ppqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_list va1; // [rsp+E0h] [rbp+67h] BYREF
