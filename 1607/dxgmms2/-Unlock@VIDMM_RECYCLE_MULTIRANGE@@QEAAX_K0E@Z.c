/*
 * XREFs of ?Unlock@VIDMM_RECYCLE_MULTIRANGE@@QEAAX_K0E@Z @ 0x1C005EE54
 * Callers:
...
void __fastcall VIDMM_RECYCLE_MULTIRANGE::Unlock(VIDMM_RECYCLE_MULTIRANGE *this, __int64 a2, __int64 a3, __int64 a4)
{
  char v4; // r14
  _QWORD *v8; // rax
  struct _MDL *v9; // rcx
  ...
  v4 = a4;
  v8 = (_QWORD *)WdLogNewEntry5_WdEvent(this, a2, a3, a4);
  v8[3] = this;
  v8[4] = a2;
  v8[5] = a3;
