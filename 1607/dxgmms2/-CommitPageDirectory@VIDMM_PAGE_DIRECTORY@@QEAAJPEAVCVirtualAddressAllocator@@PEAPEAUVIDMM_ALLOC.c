/*
 * XREFs of ?CommitPageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C004933C
 * Callers:
        ...
        struct VIDMM_ALLOC **a3)
{
  ...
  *(_BYTE *)(v7 + 97) = 0;
  ...
  {
    v10 = *((_QWORD *)this + 1);
    if ( (*(_DWORD *)(*(_QWORD *)(v10 + 136) + 56LL) & 0x1000) != 0 )
