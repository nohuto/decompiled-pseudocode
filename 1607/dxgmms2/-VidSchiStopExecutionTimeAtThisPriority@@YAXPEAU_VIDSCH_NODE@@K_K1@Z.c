/*
 * XREFs of ?VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z @ 0x1C000CCBC
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  v7 = (int)gulPriorityToYieldPriorityBand[a2];
  if ( (_DWORD)v7 )
  {
    v8 = (unsigned __int64 *)((char *)a1 + 8 * v7 + 1888);
    do
    {
      if ( *(v8 - 8) )
      {
        ...
        *(v8 - 4) = 0LL;
        v10 = a3 + v9;
        *v8 = v10;
        LODWORD(v11) = Microsoft_Windows_DxgKrnlEnableBits;
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        {
          ...
          Template_pqxq(v11, v12, v13, *(_QWORD *)(*((_QWORD *)a1 + 3) + 16LL), v7, v13, *((_WORD *)a1 + 2));
        }
      }
      --v8;
      LODWORD(v7) = v7 - 1;
