/*
 * XREFs of Template_pqqpxqqqq @ 0x1C0023098
 * Callers:
...
NTSTATUS Template_pqqpxqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 4LL;
  v20 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventMMIOFlip, 0LL, 9u, &UserData);
}
