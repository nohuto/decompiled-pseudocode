/*
 * XREFs of Template_pptpxqqx @ 0x1C0014390
 * Callers:
...
NTSTATUS Template_pptpxqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v16 = 4LL;
  v18 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpFill, 0LL, 8u, &UserData);
}
