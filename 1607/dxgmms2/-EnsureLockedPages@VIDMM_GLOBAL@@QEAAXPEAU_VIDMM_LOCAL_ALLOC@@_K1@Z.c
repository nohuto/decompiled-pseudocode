/*
 * XREFs of ?EnsureLockedPages@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_LOCAL_ALLOC@@_K1@Z @ 0x1C0088A2C
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( !v9 )
  {
    _InterlockedIncrement(&dword_1C003568C);
    v10 = WdLogNewEntry5_WdLowResource(v8);
    *(_QWORD *)(v10 + 24) = 22536LL;
    WdLogEvent5_WdLowResource(v10);
LABEL_5:
    v19 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v12, v11, v13, v14);
    v19[5] = 0LL;
    v19[6] = 0LL;
    v19[7] = 0LL;
    v19[3] = 270LL;
