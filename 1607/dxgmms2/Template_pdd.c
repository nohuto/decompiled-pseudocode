/*
 * XREFs of Template_pdd @ 0x1C0022780
 * Callers:
...
NTSTATUS Template_pdd(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventChangeInProcessPriority, 0LL, 3u, &UserData);
}
