/*
 * XREFs of ?PageInDeviceInternal@VIDMM_GLOBAL@@IEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C004EC20
 * Callers:
 ...
 *     ?FaultCommitment@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C005C250 (-FaultCommitment@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
 */
  ...
  *a5 = 0LL;
  if ( *v6 != v6 )
  {
    ...
    if ( !v10 || !*(_BYTE *)(v10 + 164) && !_InterlockedCompareExchange((volatile signed __int32 *)(v10 + 160), 0, 0) )
    {
      ...
      if ( v11 )
      {
        DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(v11 + 576));
        a4 = v24;
        a3 = v23;
      }
        ...
        while ( 1 )
        {
          ...
          if ( *v6 != v6 )
          {
            while ( 1 )
            {
              ...
              if ( v15 )
              {
                if ( v15 != 1 || *(_DWORD *)(**(_QWORD **)v12 + 392LL) >= 0xA0000000 )
                {
LABEL_13:
                  v16 = **(_QWORD **)v12;
                  if ( *(_DWORD *)(v16 + 128) == 1 )
...
LABEL_23:
            if ( v11 )
            {
              ExReleasePushLockSharedEx(v11 + 576, 0LL);
