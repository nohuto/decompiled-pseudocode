/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1C006790C
 * Callers:
  ...
  if ( *((_BYTE *)this + 24) )
  {
    if ( a2 )
    {
      ...
      if ( *(_DWORD *)(v6 + 6416) )
      {
        ...
        do
        {
          v9 = (VIDMM_PROCESS_BUDGET_STATE *)(*((_QWORD *)a2 + 6) + 264LL * v7);
          if ( (unsigned int)hProvider > 5 )
          {
            if ( (qword_1C0035010 & 0x400000000008LL) == 0 || (v10 = 1, (v8 & 0x400000000008LL) != v8) )
              v10 = 0;
            if ( v10 )
            {
              v11 = *(unsigned __int16 **)(*(_QWORD *)(v6 + 24) + 1072LL);
              v26 = v29;
              v27 = 2LL;
              v12 = *v11;
              v28 = *((_QWORD *)v11 + 1);
              ...
              v51 = 8LL;
              v53 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C002ACC0, a3, v21, 0x11u, &pData);
              v8 = qword_1C0035018;
            }
          }
          v6 = *(_QWORD *)this;
