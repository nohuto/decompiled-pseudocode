/*
 * XREFs of VidSchCreateSystemDevices @ 0x1C006FC94
 * Callers:
...
__int64 __fastcall VidSchCreateSystemDevices(__int64 a1)
{
  ...
  v1 = (__int64 *)(a1 + 200);
  v33 = 1uLL;
  v5 = VidSchiCreateDeviceInternal(a1, &v33, 0LL, (char **)(a1 + 200));
  if ( v5 < 0
    || (v6 = (__int64 *)(a1 + 216),
        v33 = 0x11uLL,
        v5 = VidSchiCreateDeviceInternal(a1, &v33, 0LL, (char **)(a1 + 216)),
        v5 < 0) )
  {
      ...
      if ( *(_DWORD *)(a1 + 60) )
      {
        while ( 1 )
        {
          *((_QWORD *)&v33 + 1) = 0x700000000LL;
          ...
          v17 = *(_QWORD *)(a1 + 8 * v11 + 408);
          *(_QWORD *)(v17 + 32) = v15;
          if ( !*(_QWORD *)(*(_QWORD *)(a1 + 8 * v11 + 408) + 32LL) )
            break;
          v11 = (unsigned int)(v11 + 1);
          *(_QWORD *)(a1 + 392) |= 1LL << v14;
...
LABEL_7:
        ...
        while ( 1 )
        {
          v19 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 2040LL) + 48 * v18;
          v33 = 0x1DuLL;
          ...
          *(_QWORD *)((char *)&v33 + 4) = (unsigned int)(v21 + v20);
          v22 = *v6;
          DWORD2(v33) = v18;
          *(_QWORD *)(*(_QWORD *)(a1 + 224) + 8 * v18) = VidSchiCreateContextInternal(v22, (int *)&v33, 0LL);
          v24 = *(_QWORD *)(*(_QWORD *)(a1 + 224) + 8 * v18);
          if ( !v24 )
            break;
          *(_BYTE *)(v24 + 641) = 1;
          if ( (*(_BYTE *)(v19 + 16) & 0xC) == 0xC )
          {
            ...
            DWORD1(v33) = v29;
            *(_QWORD *)(*(_QWORD *)(a1 + 232) + 8 * v18) = VidSchiCreateContextInternal(v30, (int *)&v33, 0LL);
            v32 = *(_QWORD *)(*(_QWORD *)(a1 + 232) + 8 * v18);
            if ( !v32 )
            {
