/*
 * XREFs of ?SetupBudgetState@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@K@Z @ 0x1C009BE20
 * Callers:
  ...
  *((_DWORD *)a2 + 69) = a3;
  ...
  if ( v9 != (char *)this + 41008 )
  {
    ...
    do
    {
      ...
      DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v36, (struct DXGPUSHLOCK *const)(v9 + 304));
      v11[23] = v11[17];
      v11[24] = v11[18];
      ...
      if ( v14 && v13 != g_pVidMmSystemProcess )
      {
        ...
        *((_QWORD *)v20 + 1) = v19;
        v22 = 24LL;
        *((_DWORD *)a2 + *v15 + 66) += dword_1C002B700[*v16];
        v23 = v11 + 7;
        v24 = 2LL;
        do
        {
  ...
  v29 = 0;
  v30 = 264 * v3;
  v31 = (_QWORD *)(264 * v3 + *((_QWORD *)this + 5150) + 16LL);
  do
  {
    if ( *(_BYTE *)(*((_QWORD *)this + 5150) + v30 + 259) )
    {
      if ( v29 )
      {
        if ( v29 == 1 )
