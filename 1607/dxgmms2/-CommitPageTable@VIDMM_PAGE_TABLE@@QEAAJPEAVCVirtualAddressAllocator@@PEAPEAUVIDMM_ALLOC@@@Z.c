/*
 * XREFs of ?CommitPageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0046DC8
 * Callers:
  ...
  *a3 = 0LL;
  if ( !VIDMM_PAGE_TABLE_BASE::IsResident(this) )
  {
    ...
    *(_BYTE *)(*((_QWORD *)this + 1) + 97LL) = 0;
    ...
    {
      v9 = *((_QWORD *)this + 1);
      if ( (*(_DWORD *)(*(_QWORD *)(v9 + 136) + 56LL) & 0x1000) != 0 )
