/*
 * XREFs of VidSchQueryDmaData @ 0x1C00A2534
 * Callers:
...
__int64 __fastcall VidSchQueryDmaData(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  v6 = *(_QWORD *)(a1 + 8LL * a2 + 408);
  VidSchiBlockDriverCallback(a1);
  v7 = *(_DWORD *)(a1 + 2420);
  v8 = 0;
  if ( !v7 )
    return 3221225485LL;
  for ( i = v6 + 2924; *(_DWORD *)(i - 20) == 3 || a3 != *(_QWORD *)(i - 4); i += 224LL )
  {
    if ( ++v8 >= v7 )
      return 3221225485LL;
  }
  v11 = 224LL * v8;
  result = 0LL;
  v12 = *(_OWORD *)(v11 + v6 + 2944);
  *(_OWORD *)a4 = *(_OWORD *)(v11 + v6 + 2928);
  v13 = *(_OWORD *)(v11 + v6 + 2960);
  *(_OWORD *)(a4 + 16) = v12;
  v14 = *(_OWORD *)(v11 + v6 + 2976);
  *(_OWORD *)(a4 + 32) = v13;
  v15 = *(_OWORD *)(v11 + v6 + 2992);
  *(_OWORD *)(a4 + 48) = v14;
  *(_QWORD *)&v14 = *(_QWORD *)(v11 + v6 + 3008);
  *(_OWORD *)(a4 + 64) = v15;
  *(_QWORD *)(a4 + 80) = v14;
  return result;
}
