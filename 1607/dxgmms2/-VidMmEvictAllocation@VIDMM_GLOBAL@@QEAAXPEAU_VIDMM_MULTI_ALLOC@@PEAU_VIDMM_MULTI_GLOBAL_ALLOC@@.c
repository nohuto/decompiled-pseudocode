/*
 * XREFs of ?VidMmEvictAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C008C400
 * Callers:
 *     ?VidMmEvictAllocation@@YAXPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C001D2B0 (-VidMmEvictAllocation@@YAXPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLO.c)
 * Callees:
 ...
 *     ?VidMmiAllocationMeetsCriteria@@YA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C008D740 (-VidMmiAllocationMeetsCriteria@@YA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z.c)
 */
        ...
        struct _D3DKMT_EVICTION_CRITERIA *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( VidMmiAllocationMeetsCriteria(v7, a4) && *((int *)a2 + 42) > 0 )
    {
      v8 = (struct VIDMM_DEVICE *)*((_QWORD *)a2 + 1);
      v25 = a2;
      VIDMM_GLOBAL::Evict(this, v8, &v25, 1u, 0, &v22);
      v9 = *(_QWORD *)(*((_QWORD *)a2 + 1) + 80LL) + 168LL * (*((_DWORD *)v7 + 19) & 0x3F);
          ...
          if ( v13 != (int *)(v12 - 16) )
          {
            do
            {
              ...
              if ( v13[32] > 0 )
              {
                ...
                v16 = *(_QWORD *)(*((_QWORD *)v14 + 1) + 80LL) + 168LL * (*((_DWORD *)a3 + 19) & 0x3F);
