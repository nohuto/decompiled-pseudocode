/*
 * XREFs of ?Initialize@VIDMM_DEVICE_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IW4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C004521C
 * Callers:
...
LABEL_7:
  ...
  *(_QWORD *)&v17[2] = 4294962295LL;
  SyncObject = VidSchCreateSyncObject(*(_QWORD *)(v11 + 384), 0LL, (__int64)v17, 0LL, (__int64)a1, a1 + 20, 0LL);
  v9 = SyncObject;
  if ( SyncObject < 0 )
  {
