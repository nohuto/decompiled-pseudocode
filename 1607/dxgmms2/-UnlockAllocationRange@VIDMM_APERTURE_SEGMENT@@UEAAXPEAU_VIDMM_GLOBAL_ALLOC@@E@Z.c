/*
 * XREFs of ?UnlockAllocationRange@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C0097130
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( *((_BYTE *)a2 + 288) )
  {
    ...
    v9 = VidMmMapViewOfAllocation((struct _VIDMM_LOCAL_ALLOC *)v8, *((_QWORD *)a2 + 34), *((_QWORD *)a2 + 35), &v11, 0);
    if ( v9 )
    {
      memmove(v9, *((const void **)this + 31), *((_QWORD *)a2 + 35));
      VidMmUnmapViewOfAllocation((struct _VIDMM_LOCAL_ALLOC *)v8, v11, v10);
    }
    else
    {
