/*
 * XREFs of ?ReserveResource@VIDMM_MEMORY_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EEEW4_VIDMM_PLACEMENT_RESTRICTION@@@Z @ 0x1C0062160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_MEMORY_SEGMENT::ReserveResource(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a2 + 84) & 0x20) == 0 || (*(_DWORD *)(a1 + 56) & 4) != 0 || *(_QWORD *)(a1 + 472) )
  {
    LODWORD(v4) = VIDMM_SEGMENT::ReserveResource(a1, a2);
    if ( (int)v4 >= 0 && (*(_DWORD *)(a2 + 84) & 0x20) != 0 )
    {
      v6 = *(VIDMM_CPU_HOST_APERTURE **)(a1 + 472);
      if ( v6 )
      {
