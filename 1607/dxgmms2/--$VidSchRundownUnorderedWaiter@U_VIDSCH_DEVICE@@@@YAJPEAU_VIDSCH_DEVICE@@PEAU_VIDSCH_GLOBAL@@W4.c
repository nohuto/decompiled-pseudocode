/*
 * XREFs of ??$VidSchRundownUnorderedWaiter@U_VIDSCH_DEVICE@@@@YAJPEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_STAGE@@_NP6AX0@Z@Z @ 0x1C0001D68
 * Callers:
        ...
        union _LARGE_INTEGER Interval)
{
  ...
  if ( a3 != 5 && *(_DWORD *)(a1 + 1140) )
  {
    ...
    else
    {
      ...
      if ( *(_DWORD *)(a1 + 1140) )
      {
        KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a2 + 1856), &LockHandle);
        v9 = (_QWORD **)(a1 + 64);
