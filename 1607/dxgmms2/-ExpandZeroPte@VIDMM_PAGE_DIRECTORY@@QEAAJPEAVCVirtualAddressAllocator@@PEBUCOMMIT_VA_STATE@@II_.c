/*
 * XREFs of ?ExpandZeroPte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@II_K222PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0093948
 * Callers:
        ...
        struct VIDMM_ALLOC **a10)
{
  ...
  __int64 v26; // rcx
  int v27; // eax
  unsigned __int64 v28; // [rsp+20h] [rbp-91h]
  unsigned __int64 v29; // [rsp+20h] [rbp-91h]
  char *v30; // [rsp+28h] [rbp-89h]
        ...
        *(_QWORD *)(*((_QWORD *)this + 4) + 8 * v10)) )
  {
    ...
    if ( a7 < a9
      && ((v26 = *((_QWORD *)this + 4), v31 = (char *)(a9 - a7), v29 = a7 << 12, (*(_DWORD *)this & 0x20) == 0)
