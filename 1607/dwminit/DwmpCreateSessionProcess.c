/*
 * XREFs of DwmpCreateSessionProcess @ 0x180003010
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OneCoreSkipDwmLaunch@@YA_NXZ @ 0x180002F94 (-OneCoreSkipDwmLaunch@@YA_NXZ.c)
...
__int64 __fastcall DwmpCreateSessionProcess(int a1)
{
    ...
    && (qword_18000D018 & 0x400000000000LL) == qword_18000D018 )
  {
    ...
    v30 = &gSessionId;
    v31 = 2;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18000AB05, v5, v6, 9u, &pData);
  }
  if ( Thread )
    CloseHandle(Thread);
  return v9;
