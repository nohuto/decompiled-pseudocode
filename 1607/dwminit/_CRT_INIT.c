/*
 * XREFs of _CRT_INIT @ 0x180007A2C
 * Callers:
 *     __DllMainCRTStartup @ 0x180007CB0 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x180007F0E (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180007F70 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800080DA (_initterm_0.c)
