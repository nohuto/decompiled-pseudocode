/*
 * XREFs of ?PostEvent@SessionShutdownOnRestartFailureEventData@DwmInitAsimov@@UEAAXPEBU_TlgProvider_t@@@Z @ 0x180006110
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DwmInitAsimov::SessionShutdownOnRestartFailureEventData::PostEvent(
        DwmInitAsimov::SessionShutdownOnRestartFailureEventData *this,
        ...
        const GUID *a4)
{
    ...
    && (*((_QWORD *)a2 + 3) & 0x400000000000LL) == *((_QWORD *)a2 + 3) )
  {
    ...
    v14 = 2LL;
    v16 = 2LL;
    TlgWrite(a2, &unk_18000AC07, (LPCGUID)a2, a4, 8u, &pData);
  }
}
