/*
 * XREFs of ?PostEvent@SessionShutdownOnCreateFailureEventData@DwmInitAsimov@@UEAAXPEBU_TlgProvider_t@@@Z @ 0x180006040
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a4)
{
    ...
    && (*((_QWORD *)a2 + 3) & 0x400000000000LL) == *((_QWORD *)a2 + 3) )
  {
    ...
    v12 = 2LL;
    v14 = 2LL;
    TlgWrite(a2, &unk_18000AC8D, (LPCGUID)a2, a4, 7u, &pData);
  }
}
