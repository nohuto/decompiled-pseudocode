/*
 * XREFs of ?ReportSessionShutdownOnRestartFailure@CDwmInitEventManager@DwmInitAsimov@@QEAAXU_GUID@@JH0GG@Z @ 0x180006450
 * Callers:
...
void __fastcall DwmInitAsimov::CDwmInitEventManager::ReportSessionShutdownOnRestartFailure(
        ...
        struct _GUID *a5)
{
  ...
  {
    v6 = (__int128)*a2;
    v8 = &DwmInitAsimov::SessionShutdownOnRestartFailureEventData::`vftable';
