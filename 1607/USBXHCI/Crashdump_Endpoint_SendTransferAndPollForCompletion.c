/*
 * XREFs of Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C003807C
 * Callers:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x1C0037C28 (Crashdump_Endpoint_SendBulkTransfer.c)
