/*
 * XREFs of UsbDevice_EndpointsConfigureCompletion @ 0x1C00309B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall UsbDevice_EndpointsConfigureCompletion(__int64 a1, int a2, _QWORD *a3)
{
  ...
  _QWORD v45[5]; // [rsp+68h] [rbp-70h] BYREF
...
LABEL_34:
    ...
    *(_QWORD *)(v3 + 440) = 0LL;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v31 + 2104))(v32, v43, v19);
    return;
  }
