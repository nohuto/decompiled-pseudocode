/*
 * XREFs of WPP_RECORDER_SF_qLL @ 0x1C0004CC0
 * Callers:
...
__int64 WPP_RECORDER_SF_qLL(__int64 a1, unsigned __int8 a2, unsigned int a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( _bittest(&v11, v10 & 0x1F) )
  {
    ...
    if ( (unsigned __int8)v13[41] >= a2 )
      ((void (__fastcall *)(_QWORD, __int64, __int64, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
        *((_QWORD *)v13 + 3),
        43LL,
        a5,
        a4,
