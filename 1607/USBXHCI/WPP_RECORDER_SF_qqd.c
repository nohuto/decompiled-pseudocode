/*
 * XREFs of WPP_RECORDER_SF_qqd @ 0x1C001E08C
 * Callers:
...
__int64 WPP_RECORDER_SF_qqd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x40) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      ...
      43LL,
      &WPP_cd940d3c41c233e2944b46db56fe2ea3_Traceguids,
      25LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 25;
  return WppAutoLogTrace(a1, 5LL, 7LL, &WPP_cd940d3c41c233e2944b46db56fe2ea3_Traceguids, v7, (__int64 *)va);
}
