/*
 * XREFs of Controller_SetDeviceDescription @ 0x1C004DD90
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x1C0009350 (RtlUnalignedStringCbLengthW.c)
 *     RtlStringCbPrintfW @ 0x1C00093B4 (RtlStringCbPrintfW.c)
 *     RootHub_GetHighestUsbVersionSupported @ 0x1C0009470 (RootHub_GetHighestUsbVersionSupported.c)
...
LABEL_8:
    if ( RtlFindMessage(
           *(PVOID *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 24LL),
           ...
           &v38) < 0 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x8Fu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
      return;
    }
    v7 = v38->Length - 4;
    pcbLength = v7;
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x90u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
      return;
    }
...
LABEL_21:
            ...
            {
              v21 = (struct _DEVICE_OBJECT *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD))(WdfFunctions_01015 + 264))(
                                               WdfDriverGlobals,
                                               *(_QWORD *)a1);
        ...
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x92u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
      }
      else
      {
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 4u, 3u, 0x93u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
        if ( RtlFindMessage(
               *(PVOID *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 24LL),
               0xBu,
               0,
