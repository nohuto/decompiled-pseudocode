/*
 * XREFs of Controller_UpdateIdleTimeout @ 0x1C00523B8
 * Callers:
...
__int64 __fastcall Controller_UpdateIdleTimeout(__int64 *a1, int a2)
{
  ...
  if ( v6 >= 0 )
  {
    *((_DWORD *)a1 + 98) = a2;
    v9 = a2;
    return WPP_RECORDER_SF_d(a1[8], 4u, 3u, 0x1Eu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v9);
  }
  else
  {
    v8 = v6;
    result = WPP_RECORDER_SF_d(a1[8], 4u, 3u, 0x1Du, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v8);
    *((_DWORD *)a1 + 88) = 2;
  }
  return result;
}
