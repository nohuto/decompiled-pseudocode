/*
 * XREFs of Controller_ConfigureS0IdleSettings @ 0x1C004C8CC
 * Callers:
...
__int64 __fastcall Controller_ConfigureS0IdleSettings(__int64 *a1)
{
  ...
  {
    *((_DWORD *)a1 + 88) = 1;
    WPP_RECORDER_SF_(a1[8], 3u, 3u, 0x14u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
  }
  else
  {
    ...
    {
      LODWORD(v12) = v3;
      WPP_RECORDER_SF_d(a1[8], 4u, 3u, 0x15u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v12);
      *((_DWORD *)a1 + 88) = 2;
    }
    else
    {
      ...
      if ( v14[5] )
      {
        ...
        {
          LODWORD(v12) = v4;
          WPP_RECORDER_SF_d(a1[8], 3u, 3u, 0x16u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v12);
        }
      }
      ...
      if ( v16 > 1 )
      {
        *((_DWORD *)a1 + 88) = 0;
        ...
        LODWORD(v12) = 5000;
        WPP_RECORDER_SF_d(a1[8], 4u, 3u, 0x18u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v12);
        ...
        {
          LODWORD(v10) = v8;
          WPP_RECORDER_SF_d(a1[8], 2u, 3u, 0x19u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v10);
        }
      }
      else
      {
        *((_DWORD *)a1 + 88) = 2;
        LODWORD(v13) = 1;
        LODWORD(v12) = v5;
        WPP_RECORDER_SF_dd(a1[8], 4u, 3u, 0x17u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v12, v13);
      }
    }
  }
  LODWORD(v10) = *((_DWORD *)a1 + 88);
  return WPP_RECORDER_SF_L(a1[8], 4u, 3u, 0x1Au, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v10);
}
