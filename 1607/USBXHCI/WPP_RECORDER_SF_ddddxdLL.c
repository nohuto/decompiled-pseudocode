/*
 * XREFs of WPP_RECORDER_SF_ddddxdLL @ 0x1C000A130
 * Callers:
...
__int64 WPP_RECORDER_SF_ddddxdLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80u) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      WPP_GLOBAL_Control->AttachedDevice,
      43LL,
      &WPP_743231bee2de335fe7554effc40d8bb7_Traceguids,
      35LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 35;
  return WppAutoLogTrace(a1, 4LL, 8LL, &WPP_743231bee2de335fe7554effc40d8bb7_Traceguids, v7, (__int64 *)va);
}
