/*
 * XREFs of UsbDevice_UcxEvtDeviceAdd @ 0x1C0054560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbDevice_UcxEvtDeviceAdd(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v22[0]) = 80;
  ((void (__fastcall *)(void *, __int64, _QWORD *))qword_1C0044760)(WPP_MAIN_CB.Dpc.SystemArgument2, v24, v22);
  memset(v23, 0, 0x38uLL);
  LODWORD(v23[0]) = 56;
  v23[3] = 0x100000001LL;
  v23[6] = off_1C0043250;
  v23[1] = UsbDevice_EvtUsbDeviceCleanupCallback;
  v7 = ((__int64 (__fastcall *)(void *, __int64, __int64 *, _QWORD *, __int64 *))qword_1C0044758)(
