/*
 * XREFs of Command_InternalSendCommand @ 0x1C001BC70
 * Callers:
 *     Command_HandleCommandCompletionEvent @ 0x1C000F3C0 (Command_HandleCommandCompletionEvent.c)
 *     Command_ControllerResetPostResetSuccess @ 0x1C001B758 (Command_ControllerResetPostResetSuccess.c)
...
LABEL_34:
  ...
  if ( *(_DWORD *)(a1 + 68) == (_DWORD)v18 )
  {
    ...
    *(_DWORD *)(a1 + 76) = v19;
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    {
      ...
      WPP_RECORDER_SF_ddd(v21, 5u, 6u, 0x36u, (__int64)&WPP_d70eb0a3d0963e3ced97f288f7a4c0c9_Traceguids, v24, v25, v26);
    }
    *(_DWORD *)(a1 + 68) = 0;
  }
  result = *(_QWORD **)(a1 + 48);
  *(_DWORD *)result = 0;
  ...
  {
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 16), 5u, 6u, 0x37u, (__int64)&WPP_d70eb0a3d0963e3ced97f288f7a4c0c9_Traceguids);
    return (_QWORD *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64))(WdfFunctions_01015 + 2552))(
                       WdfDriverGlobals,
                       *(_QWORD *)(a1 + 24),
                       -10000000LL);
  }
