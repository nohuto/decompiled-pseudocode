/*
 * XREFs of Crashdump_Cleanup @ 0x1C0034BC0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_SaveStateForHybridSleep @ 0x1C0036948 (Crashdump_Register_SaveStateForHybridSleep.c)
 *     Crashdump_Register_StopController @ 0x1C0036AE8 (Crashdump_Register_StopController.c)
 *     Crashdump_Command_Stop @ 0x1C0037744 (Crashdump_Command_Stop.c)
...
__int64 __fastcall Crashdump_Cleanup(__int64 a1)
{
  ...
  v5 = *(_DWORD *)(a1 + 536) == 1;
  v6 = *(_DWORD *)(a1 + 536) - 1;
  for ( j = (unsigned int *)(a1 + 544 + 4LL * v6); ; --j )
  {
    v9 = *j;
    if ( v5 )
      break;
    v8 = Crashdump_UsbDevice_SuspendPort(*(_QWORD *)(a1 + 568) + 408LL * --v6, v9);
    if ( v8 < 0 )
  ...
  *v10 = *v10 & 0xE00C200 | 0x60;
  ...
  {
    v14 = **(_QWORD **)(*(_QWORD *)(*(_QWORD *)(a1 + 616) + 96LL) + 32LL);
    *(_QWORD *)(v14 + 144) = *(_QWORD *)(a1 + 272);
    *(_DWORD *)(v14 + 120) = *(_DWORD *)(a1 + 280);
    *(_DWORD *)(v14 + 124) = *(_DWORD *)(a1 + 284);
    *(_DWORD *)(v14 + 128) = *(_DWORD *)(a1 + 288);
    *(_DWORD *)(v14 + 132) = *(_DWORD *)(a1 + 292);
    *(_DWORD *)(v14 + 136) = *(_DWORD *)(a1 + 296);
    *(_QWORD *)(v14 + 152) = *(_QWORD *)(a1 + 304);
    *(_OWORD *)(v14 + 168) = *(_OWORD *)(a1 + 312);
