/*
 * XREFs of WPP_RECORDER_SF_DDDDL @ 0x1C002CBE8
 * Callers:
 *     Isoch_ProcessSegment @ 0x1C002BAA0 (Isoch_ProcessSegment.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_DDDDL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      ...
      0LL);
  LOWORD(v7) = 29;
  return WppAutoLogTrace(a1, 2LL, 13LL, &WPP_77eceb089022340440c9e177d02eadfb_Traceguids, v7, (__int64 *)va);
}
