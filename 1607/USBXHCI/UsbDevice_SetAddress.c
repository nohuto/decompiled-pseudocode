/*
 * XREFs of UsbDevice_SetAddress @ 0x1C000F87C
 * Callers:
...
__int64 __fastcall UsbDevice_SetAddress(__int64 a1, char a2)
{
  ...
  *(_DWORD *)(a1 + 152) = *(_DWORD *)(v8 + 4);
  ...
  v21 = *(_DWORD *)v9 ^ (v12 ^ *(_DWORD *)v9) & 0xFFFFF;
  *(_DWORD *)v9 = v21;
  v22 = *(_DWORD *)(a1 + 20);
  if ( v22 )
  {
  ...
  *(_DWORD *)v9 = v23;
  *(_DWORD *)v9 = v23 & 0x7FFFFFF | 0x8000000;
  *(_BYTE *)(v9 + 6) = *(_BYTE *)(a1 + 44);
  ...
  if ( v24 )
  {
    ...
    *(_BYTE *)(v9 + 8) = *(_BYTE *)(v19 + 135);
  }
  v20 = *(unsigned int *)(a1 + 40);
  if ( (_DWORD)v20 )
    *(_BYTE *)(v9 + 9) = *(_BYTE *)(a1 + 4 * v20 + 44);
  else
    *(_BYTE *)(v9 + 9) = 0;
