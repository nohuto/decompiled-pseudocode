/*
 * XREFs of Controller_WdfEvtDeviceD0EntryPostInterruptsEnabled @ 0x1C0005230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceD0EntryPostInterruptsEnabled(__int64 a1, int a2)
{
  ...
  LODWORD(v36) = v2;
  WPP_RECORDER_SF_qLL(v8, 4u, 3u, 0x4Bu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, a1, v36, v37);
  LOBYTE(v9) = 4;
  WPP_RECORDER_SF_qd(
    *(_QWORD *)(v4 + 64),
    v9,
  ...
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v4 + 64), v11, 3, 76, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v10);
    goto LABEL_14;
  }
  v13 = 1;
  v14 = *(_QWORD *)(v4 + 120);
...
LABEL_10:
  ...
  {
    LOBYTE(v21) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v4 + 64), v21, 3, 78, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v20);
  }
  else if ( (*(_BYTE *)(v4 + 232) & 0x10) != 0 )
  {
    v12 = -1073741637;
    WPP_RECORDER_SF_(*(_QWORD *)(v4 + 64), 2u, 3u, 0x4Fu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
  }
  else
  {
