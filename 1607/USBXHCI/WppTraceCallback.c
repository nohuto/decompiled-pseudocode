/*
 * XREFs of WppTraceCallback @ 0x1C0052B30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  {
    v21 = *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type == 2;
    v23 = *((_QWORD *)a4 + 1);
    *(_QWORD *)(v20 + 24) = v23;
    if ( v21 )
    {
      if ( !(*(unsigned int (__fastcall **)(__int64, char *, __int64, unsigned int **, unsigned int *))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
              3LL,
              &v24,
              4LL,
              &a6,
