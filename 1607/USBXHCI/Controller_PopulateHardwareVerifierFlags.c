/*
 * XREFs of Controller_PopulateHardwareVerifierFlags @ 0x1C004BFBC
 * Callers:
...
__int64 __fastcall Controller_PopulateHardwareVerifierFlags(__int64 a1)
{
  ...
  *(_DWORD *)&DestinationString.Length = 3407872;
  ...
  else
  {
    if ( v7 != 2 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0xCAu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
      goto LABEL_7;
    }
...
LABEL_25:
    LODWORD(v15) = v5;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 64), 2u, 3u, v9, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v15);
    goto LABEL_7;
  }
...
LABEL_60:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0xCCu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
LABEL_8:
  *(_QWORD *)(a1 + 336) = 0LL;
  if ( v5 != -1073741772 )
  {
