/*
 * XREFs of Controller_D0ExitSaveState @ 0x1C001E514
 * Callers:
...
__int64 __fastcall Controller_D0ExitSaveState(_QWORD *a1)
{
  ...
  WPP_RECORDER_SF_(a1[8], 4u, 3u, 0x7Au, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
  ...
  if ( (v5 & 0x200) != 0 )
  {
    v6 = 125;
LABEL_5:
    WPP_RECORDER_SF_(a1[8], 2u, 3u, v6, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
LABEL_16:
    v9 = -1073741630;
    goto LABEL_17;
  }
  WPP_RECORDER_SF_(a1[8], 4u, 3u, 0x7Eu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
