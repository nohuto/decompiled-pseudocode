/*
 * XREFs of WPP_RECORDER_SF_DDqDDD @ 0x1C002D164
 * Callers:
...
__int64 WPP_RECORDER_SF_DDqDDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      WPP_GLOBAL_Control->AttachedDevice,
      43LL,
      &WPP_77eceb089022340440c9e177d02eadfb_Traceguids,
      46LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 46;
  return WppAutoLogTrace(a1, 5LL, 13LL, &WPP_77eceb089022340440c9e177d02eadfb_Traceguids, v7, (__int64 *)va);
}
