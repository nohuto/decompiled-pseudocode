...
__int64 __fastcall Controller_CreateWdfDevice(__int64 a1, __int64 a2, _QWORD *a3, unsigned int *a4)
{
  ...
  _QWORD v40[8]; // [rsp+110h] [rbp+10h] BYREF
  _QWORD v41[18]; // [rsp+150h] [rbp+50h] BYREF
  GUID v42; // [rsp+1E0h] [rbp+E0h] BYREF
  __int64 v43; // [rsp+1F0h] [rbp+F0h]
  char v44; // [rsp+200h] [rbp+100h] BYREF
  char v45; // [rsp+250h] [rbp+150h] BYREF

  v34 = a1;
  DestinationString.Buffer = (wchar_t *)&v44;
  *(_DWORD *)&DestinationString.Length = 5242880;
  v36.Buffer = (wchar_t *)&v45;
  *(_DWORD *)&v36.Length = 5242880;
  ...
  v39[1] = Controller_WdfEvtDeviceArmWakeFromS0;
  v39[2] = Controller_WdfEvtDeviceDisarmWakeFromS0;
  v39[3] = Controller_WdfEvtDeviceWakeFromS0Triggered;
  v39[4] = Controller_WdfEvtDeviceArmWakeFromSx;
  v39[5] = Controller_WdfEvtDeviceDisarmWakeFromSx;
  LODWORD(v39[0]) = 64;
  ...
  if ( v10 < 0 )
  {
    ...
    v32 = v10;
LABEL_18:
    WPP_RECORDER_SF_d(a2, 2u, 3u, v29, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v32);
...
LABEL_17:
  ...
  while ( 1 )
  {
    ...
    if ( v16 != -1073741771 )
      break;
    WPP_RECORDER_SF_d(a2, 3u, 3u, 0x26u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
  ...
  *(_QWORD *)(v17 + 16) = a2;
  ...
  if ( v23 < 0 )
  {
    WPP_RECORDER_SF_d(a2, 2u, 3u, 0x28u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v23);
  }
  else
  {
    ...
    if ( v24 < 0 )
    {
      WPP_RECORDER_SF_d(a2, 2u, 3u, 0x29u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v24);
    }
    else
    {
      ...
      {
        LODWORD(v31) = v27;
        WPP_RECORDER_SF_d(a2, 2u, 3u, 0x2Bu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v31);
      }
    }
  }
LABEL_13:
