/*
 * XREFs of Endpoint_OnResetEndpointConfigureCompletion_EpDropped @ 0x1C00232F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Endpoint_InitializeTransferRing @ 0x1C00223B4 (Endpoint_InitializeTransferRing.c)
...
void __fastcall Endpoint_OnResetEndpointConfigureCompletion_EpDropped(__int64 a1, int a2)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v3[10], 4u, 0xCu, 0x31u, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v12, v15);
    goto LABEL_5;
  }
  v7 = *(_BYTE *)(a1 + 68);
  if ( v7 != 1 )
...
LABEL_5:
  ...
  WPP_RECORDER_SF_dd(v3[10], 4u, 0xCu, 0x33u, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v14, v17);
  for ( i = 1;
        i <= *(_DWORD *)(v3[17] + 8);
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3[17] + 32) + 16LL) + 16 * v10) = DequeuePointer )
  {
    Endpoint_InitializeTransferRing(v3, i);
