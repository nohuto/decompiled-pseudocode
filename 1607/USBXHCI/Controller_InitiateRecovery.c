/*
 * XREFs of Controller_InitiateRecovery @ 0x1C001EAFC
 * Callers:
...
char __fastcall Controller_InitiateRecovery(_QWORD *a1, __int64 a2, int a3)
{
  ...
  LOBYTE(v6) = WPP_RECORDER_SF_(a1[8], 4u, 3u, 0xDEu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
  if ( (a3 & 2) != 0 )
  {
    v6 = *((_DWORD *)a1 + 74);
    if ( v6 > 0xA )
  ...
  while ( a3 )
  {
    if ( (a3 & 0x18) != 0 )
    {
      if ( (*(_DWORD *)(a2 + 84) & 2) == 0 )
      {
        ...
        KeFlushQueuedDpcs();
        ((void (__fastcall *)(void *, _QWORD))qword_1C0044740)(WPP_MAIN_CB.Dpc.SystemArgument2, a1[1]);
        if ( (a3 & 8) != 0 )
      ...
      {
        WPP_RECORDER_SF_(a1[8], 4u, 3u, 0xE0u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
        v10 = *a1;
        v14 = 0x200000002LL;
        v15 = 0x200000002LL;
        v13 = 28;
    ...
    {
      LOBYTE(v6) = ((__int64 (__fastcall *)(void *, _QWORD))qword_1C0044730)(WPP_MAIN_CB.Dpc.SystemArgument2, a1[1]);
      a3 &= ~2u;
    }
    else
    {
