/*
 * XREFs of Interrupter_PrepareHardware @ 0x1C004A600
 * Callers:
...
__int64 __fastcall Interrupter_PrepareHardware(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !(_DWORD)v30 )
  {
    ...
    v16 = 14;
LABEL_11:
    WPP_RECORDER_SF_(*(_QWORD *)(v3 + 64), 2u, 8u, v16, (__int64)&WPP_743231bee2de335fe7554effc40d8bb7_Traceguids);
...
LABEL_30:
    LODWORD(v29) = v11;
    WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 64), 2u, 8u, v17, (__int64)&WPP_743231bee2de335fe7554effc40d8bb7_Traceguids, v29);
    return (unsigned int)Interrupter;
  }
  v13 = *(_QWORD **)(a1 + 32);
  v14 = *(_QWORD *)(a1 + 40);
