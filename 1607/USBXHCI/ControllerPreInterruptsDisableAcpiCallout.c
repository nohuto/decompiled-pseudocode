/*
 * XREFs of ControllerPreInterruptsDisableAcpiCallout @ 0x1C0003BC0
 * Callers:
...
__int64 __fastcall ControllerPreInterruptsDisableAcpiCallout(__int64 a1)
{
  ...
  {
    LOBYTE(v3) = 4;
    WPP_RECORDER_SF_q(*(_QWORD *)(v4 + 64), v3, 3, 80, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, a1);
