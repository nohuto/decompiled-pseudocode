/*
 * XREFs of Crashdump_InitializeDeviceContext @ 0x1C0035388
 * Callers:
 *     Crashdump_UcxEvtGetDumpData @ 0x1C0035EA0 (Crashdump_UcxEvtGetDumpData.c)
 * Callees:
 *     memset @ 0x1C0010200 (memset.c)
 *     DeviceSlot_LocateDeviceByPortPath @ 0x1C0020C60 (DeviceSlot_LocateDeviceByPortPath.c)
 *     Crashdump_Endpoint_Initialize @ 0x1C0037A10 (Crashdump_Endpoint_Initialize.c)
 *     Crashdump_UsbDevice_Initialize @ 0x1C0038EB0 (Crashdump_UsbDevice_Initialize.c)
 */
...
__int64 __fastcall Crashdump_InitializeDeviceContext(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( v8 < 0 )
    return (unsigned int)v8;
  PoolWithTag = ExAllocatePoolWithTag(*((POOL_TYPE *)&WPP_MAIN_CB.AlignmentRequirement + 1), 0xE8uLL, 0x43434858u);
  v13 = PoolWithTag;
  if ( !PoolWithTag )
...
LABEL_13:
  ...
  while ( 1 )
  {
    ...
    if ( v16 )
      break;
    v18 = ExAllocatePoolWithTag(*((POOL_TYPE *)&WPP_MAIN_CB.AlignmentRequirement + 1), 0xE8uLL, 0x43434858u);
    v13 = v18;
    if ( !v18 )
    {
      v8 = -1073741670;
