/*
 * XREFs of WPP_RECORDER_SF_ddqqq @ 0x1C00264B4
 * Callers:
...
__int64 WPP_RECORDER_SF_ddqqq(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      WPP_GLOBAL_Control->AttachedDevice,
      43LL,
      &WPP_069d2c2574d53496482fd2ef12d94007_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v8, (__int64 *)va);
}
