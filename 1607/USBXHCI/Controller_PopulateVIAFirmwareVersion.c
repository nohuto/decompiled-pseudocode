/*
 * XREFs of Controller_PopulateVIAFirmwareVersion @ 0x1C00516F8
 * Callers:
...
void __fastcall Controller_PopulateVIAFirmwareVersion(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 *a4)
{
  ...
  if ( *(_WORD *)(a3 + 2) == 13362 )
  {
    ...
    if ( v15 != 3 )
    {
      ...
      v16 = v15;
LABEL_9:
      WPP_RECORDER_SF_d(a1, 2u, 3u, v10, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v16);
      return;
    }
    WPP_RECORDER_SF_DDD(a1, 4u, 3u, 0xE8u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v20, v17, v18[0]);
  ...
  else if ( *(_WORD *)(a3 + 2) == 13443 || *(unsigned __int16 *)(a3 + 2) == 37377 )
  {
    ...
    if ( v9 == 4 )
    {
      WPP_RECORDER_SF_d(a1, 4u, 3u, 0xEAu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v19[0]);
      *a4 = v19[0];
      return;
    }
    v10 = 233;
