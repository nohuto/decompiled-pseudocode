/*
 * XREFs of Controller_InternalReset @ 0x1C001EDC0
 * Callers:
...
__int64 __fastcall Controller_InternalReset(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 4u, 3u, 0xADu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
...
LABEL_25:
  ...
  if ( v9 < 0 )
  {
    ...
    ((void (__fastcall *)(void *, _QWORD))qword_1C0044740)(WPP_MAIN_CB.Dpc.SystemArgument2, *(_QWORD *)(a1 + 8));
    LODWORD(v21) = v9;
    WPP_RECORDER_SF_d(
      *(_QWORD *)(a1 + 64),
      2u,
  ...
  else
  {
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 4u, 3u, 0xB3u, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids);
  }
