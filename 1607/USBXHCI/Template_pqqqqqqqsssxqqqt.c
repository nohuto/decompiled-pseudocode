/*
 * XREFs of Template_pqqqqqqqsssxqqqt @ 0x1C00348B0
 * Callers:
 *     Etw_ControllerCreate @ 0x1C0009500 (Etw_ControllerCreate.c)
 *     Etw_ControllerRundown @ 0x1C0009954 (Etw_ControllerRundown.c)
...
NTSTATUS Template_pqqqqqqqsssxqqqt(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  __int64 v56; // [rsp+198h] [rbp+98h] BYREF
  va_list va4; // [rsp+198h] [rbp+98h]
  __int64 v58; // [rsp+1A0h] [rbp+A0h] BYREF
  va_list va5; // [rsp+1A0h] [rbp+A0h]
  __int64 v60; // [rsp+1A8h] [rbp+A8h] BYREF
  ...
  const char *v65; // [rsp+1C0h] [rbp+C0h]
  const char *v66; // [rsp+1C8h] [rbp+C8h]
  __int64 v67; // [rsp+1D0h] [rbp+D0h] BYREF
  ...
  __int64 v73; // [rsp+1E8h] [rbp+E8h] BYREF
