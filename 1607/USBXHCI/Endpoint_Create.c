/*
 * XREFs of Endpoint_Create @ 0x1C0052D7C
 * Callers:
 ...
 *     TR_GetWdfQueue @ 0x1C00102FC (TR_GetWdfQueue.c)
 ...
 *     Etw_EndpointCreate @ 0x1C00340F0 (Etw_EndpointCreate.c)
 *     Endpoint_SetType @ 0x1C0053358 (Endpoint_SetType.c)
...
__int64 __fastcall Endpoint_Create(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, _QWORD *a6)
{
  ...
  ClearStallContext = ((__int64 (__fastcall *)(void *, __int64, __int64 *, _QWORD *, __int64 *))qword_1C0044770)(
...
LABEL_3:
    ...
    WPP_RECORDER_SF_ddd(v8[8], 2u, 0xCu, v13, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v35, v36, v37);
  ...
  *(_QWORD *)(v16 + 1256) = WorkItem;
  if ( !WorkItem )
  {
    ...
    WPP_RECORDER_SF_dd(v8[8], 2u, 0xCu, 0x11u, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v35, v36);
  ...
  *(_QWORD *)v16 = v8;
  *(_QWORD *)(v16 + 8) = a2;
  v24 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(v22 + 1616))(v23, a2, off_1C0043250);
  v25 = a5;
  *(_QWORD *)(v16 + 16) = v24;
  *(_QWORD *)(v16 + 136) = 0LL;
  *(_QWORD *)(v16 + 248) = 0LL;
...
LABEL_21:
  ...
  ((void (__fastcall *)(void *, __int64, __int64))qword_1C0044798)(WPP_MAIN_CB.Dpc.SystemArgument2, v41, WdfQueue);
  if ( *(_DWORD *)(v16 + 144) == 1 )
