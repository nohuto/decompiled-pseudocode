/*
 * XREFs of RootHub_D0Exit @ 0x1C00043E0
 * Callers:
...
void __fastcall RootHub_D0Exit(__int64 a1, int a2, int a3)
{
  ...
  __int128 v43; // [rsp+48h] [rbp-70h]
  unsigned int *v44; // [rsp+58h] [rbp-60h]
...
LABEL_11:
    ...
    if ( v11 < 0 && a3 == 7 )
      ((void (__fastcall *)(void *, _QWORD))qword_1C0044750)(WPP_MAIN_CB.Dpc.SystemArgument2, *(_QWORD *)a1);
