/*
 * XREFs of UsbDevice_UpdateUsbDevice @ 0x1C0032EEC
 * Callers:
 ...
 * Callees:
 *     RootHub_SetPortResumeTime @ 0x1C00277DC (RootHub_SetPortResumeTime.c)
...
__int64 __fastcall UsbDevice_UpdateUsbDevice(__int64 a1, __int64 a2)
{
  ...
  {
    RootHub_SetPortResumeTime(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 120LL), *(_DWORD *)(a1 + 44), *(_WORD *)(a2 + 64));
    *(_BYTE *)(a1 + 553) = 1;
  }
