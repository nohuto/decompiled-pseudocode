/*
 * XREFs of RootHub_UcxEvtClearPortFeature @ 0x1C0005DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RootHub_UcxEvtClearPortFeature(__int64 a1, __int64 a2)
{
  ...
  if ( !v6 || *(_BYTE *)(v4 + 293) )
  {
    ...
    LODWORD(v140) = v136;
    LODWORD(v139) = v6;
    WPP_RECORDER_SF_dd(v137, 2u, 3u, 0xDCu, (__int64)&WPP_30b8102214563469b125fcb27e814bad_Traceguids, v139, v140);
    WPP_RECORDER_SF_(
    ...
    if ( v9 == 22 || !v11 )
    {
      switch ( v9 )
      {
        case 1:
          ...
          v46 = *(_QWORD *)(v43 + 64);
          LODWORD(v139) = v44;
          WPP_RECORDER_SF_d(v46, 4u, 0xAu, v45, (__int64)&WPP_464e706a19a63e058fe2f12c3ff05faa_Traceguids, v139);
          *v147 = v44;
