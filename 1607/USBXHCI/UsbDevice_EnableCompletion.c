/*
 * XREFs of UsbDevice_EnableCompletion @ 0x1C0030630
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall UsbDevice_EnableCompletion(__int64 a1, int a2, _QWORD *a3)
{
  ...
  if ( a2 == 3 )
  {
    WPP_RECORDER_SF_q(v6[8], 4u, 0xBu, 0x11u, (__int64)&WPP_b259b106ca84381176d433aab66af5b0_Traceguids, *(_QWORD *)v3);
    v9 = 1;
  ...
  else
  {
    ...
    v21 = v11;
    WPP_RECORDER_SF_L(v6[8], 3u, 0xBu, 0x15u, (__int64)&WPP_b259b106ca84381176d433aab66af5b0_Traceguids, v21);
    if ( *(_BYTE *)(a1 + 68) == 9 )
    {
