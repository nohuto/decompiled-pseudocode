/*
 * XREFs of Crashdump_EventRing_AsyncPoll @ 0x1C0036C3C
 * Callers:
 *     Crashdump_PollForCompletion @ 0x1C00359C0 (Crashdump_PollForCompletion.c)
 * Callees:
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1C0037434 (Crashdump_EventRing_UpdateDequeuePointer.c)
 */
