/*
 * XREFs of WPP_RECORDER_SF_q @ 0x1C0008630
 * Callers:
 ...
 *     ESM_SimulatingEndpointHaltReceivedOnTimeout @ 0x1C003ADE0 (ESM_SimulatingEndpointHaltReceivedOnTimeout.c)
 *     ESM_SimulatingExpectedEventTRBsProcessedAfterHaltOnTimeout @ 0x1C003AE20 (ESM_SimulatingExpectedEventTRBsProcessedAfterHaltOnTimeout.c)
 *     ESM_SimulatingExpectedEventTRBsProcessedOnTimeout @ 0x1C003AE60 (ESM_SimulatingExpectedEventTRBsProcessedOnTimeout.c)
 *     ESM_SimulatingFSEReceivedOnTimeout @ 0x1C003AEA0 (ESM_SimulatingFSEReceivedOnTimeout.c)
