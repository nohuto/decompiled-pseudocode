/*
 * XREFs of Endpoint_OnCancelEndpointConfigureCompletion_EpDropped @ 0x1C00227B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Endpoint_OnCancelEndpointConfigureCompletion_EpDropped(__int64 a1, int a2)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v2[10], 4u, 0xCu, 0x44u, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v7, v10);
  }
  else
  {
    v5 = *(_BYTE *)(a1 + 68);
    if ( v5 == 1 )
    {
      ...
      WPP_RECORDER_SF_dd(v2[10], 4u, 0xCu, 0x46u, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v9, v12);
