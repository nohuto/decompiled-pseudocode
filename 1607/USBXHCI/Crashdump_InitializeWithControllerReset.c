/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C003557C
 * Callers:
 ...
 *     Crashdump_Register_ResetController @ 0x1C0036630 (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1C00366E4 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x1C0036A38 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C0036B94 (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_UsbDevice_GetPortType @ 0x1C0038E18 (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C0039068 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1C0039284 (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x1C003980C (Crashdump_UsbDevice_SetPortPower.c)
 */
          ...
          if ( *(_DWORD *)(a1 + 536) )
          {
            while ( 1 )
            {
              ...
              v3 = Crashdump_UsbDevice_ReConfigureOnControllerReset(
                     *(_QWORD *)(a1 + 568) + 408LL * (unsigned int)v9,
                     v12);
              if ( (v3 & 0x80000000) == 0 )
              {
