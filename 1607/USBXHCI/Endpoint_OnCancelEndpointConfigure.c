/*
 * XREFs of Endpoint_OnCancelEndpointConfigure @ 0x1C00224B0
 * Callers:
 *     ESM_ReconfiguringEndpointAfterStop @ 0x1C003ACC0 (ESM_ReconfiguringEndpointAfterStop.c)
 * Callees:
...
void __fastcall Endpoint_OnCancelEndpointConfigure(__int64 *a1)
{
  ...
  else
  {
    ...
    WPP_RECORDER_SF_dd(a1[10], 2u, 0xCu, 0x43u, (__int64)&WPP_069d2c2574d53496482fd2ef12d94007_Traceguids, v13, v14);
