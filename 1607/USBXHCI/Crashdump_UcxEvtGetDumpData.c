/*
 * XREFs of Crashdump_UcxEvtGetDumpData @ 0x1C0035EA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Crashdump_Register_Initialize @ 0x1C003649C (Crashdump_Register_Initialize.c)
...
__int64 __fastcall Crashdump_UcxEvtGetDumpData(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_BYTE *)(a4 + 84) = 0;
  ...
  v15 = v13 + 62;
  v13[63] = (__int64 *)(v13 + 62);
  v13[62] = (__int64 *)(v13 + 62);
  v13[61] = v11;
  ...
  if ( v14 >= 0 )
  {
    v13[25] = (__int64 *)v13;
    v13[26] = (__int64 *)v13;
    v13[27] = (__int64 *)((*v13)[5] + 32);
    v13[41] = (__int64 *)v13;
    v13[42] = (__int64 *)v13;
    v13[43] = (__int64 *)((*v13)[4] + 24);
...
LABEL_8:
        ...
        *((_DWORD *)v13 + 141) = *(_DWORD *)(v7 + 64);
        v17 = 30;
        if ( *(_BYTE *)(56LL * (unsigned int)(*((_DWORD *)v13 + 136) - 1) + *(_QWORD *)(v9[15] + 48) + 1) == 2 )
          v17 = 20;
        *((_DWORD *)v13 + 132) = v17;
        v18 = (__int64 *)ExAllocatePoolWithTag(
                           *((POOL_TYPE *)&WPP_MAIN_CB.AlignmentRequirement + 1),
                           408LL * *((unsigned int *)v13 + 134),
                           0x43434858u);
        v13[71] = v18;
        if ( v18 )
        {
          memset(v18, 0, 408LL * *((unsigned int *)v13 + 134));
          if ( *((_DWORD *)v13 + 134) )
          {
            v21 = 1;
            while ( 1 )
          ...
          {
LABEL_26:
            v13[72] = &v13[71][51 * (unsigned int)(*((_DWORD *)v13 + 134) - 1)];
  ...
  if ( v13[71] )
  {
    ...
    {
      do
        Crashdump_FreeDeviceContext((__int64)&v13[71][51 * v8++]);
      while ( v8 < *((_DWORD *)v13 + 134) );
    }
    ExFreePoolWithTag(v13[71], 0x43434858u);
  }
  while ( *v15 != (__int64 *)v15 )
  {
    ...
    *v15 = (__int64 *)v20;
    *(_QWORD *)(v20 + 8) = v15;
    CommonBuffer_ReleaseBuffer((__int64)v13[61], (__int64)v19);
  }
