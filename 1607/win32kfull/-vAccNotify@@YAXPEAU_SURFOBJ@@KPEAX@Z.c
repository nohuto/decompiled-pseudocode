/*
 * XREFs of ?vAccNotify@@YAXPEAU_SURFOBJ@@KPEAX@Z @ 0x1C0064F58
 * Callers:
...
void __fastcall vAccNotify(struct _SURFOBJ *a1, unsigned int a2, void *a3)
{
  ...
  if ( hdev )
  {
    ...
    if ( (v7 & 0x20000000) != 0 )
    {
      for ( i = (struct _DISPSURF *)**((_QWORD **)hdev + 228); i; i = *(struct _DISPSURF **)i )
      {
        v9 = *((_QWORD *)i + 6);
        if ( v9
          && (*(_DWORD *)(v9 + 1848) & 0x8000000) != 0
          && (*(_DWORD *)(v9 + 2152) & 0x8000) != 0
          && *(_QWORD *)(*(_QWORD *)(v9 + 1816) + 760LL) )
        {
          DevBitmap = GetDevBitmap(i, a1);
          (*(void (__fastcall **)(struct _SURFOBJ *, _QWORD, void *))(*(_QWORD *)(v9 + 1816) + 760LL))(
            DevBitmap,
            a2,
            a3);
        }
    ...
    else if ( (v7 & 0x20000) == 0 && ((_DWORD)hdev[462] & 0x8000000) != 0 && ((_DWORD)hdev[538] & 0x8000) != 0 )
    {
      v11 = *(void (__fastcall **)(struct _SURFOBJ *, _QWORD, void *))(*((_QWORD *)hdev + 227) + 760LL);
      if ( v11 )
        v11(a1, a2, a3);
    }
    if ( gbWndobjUpdate )
