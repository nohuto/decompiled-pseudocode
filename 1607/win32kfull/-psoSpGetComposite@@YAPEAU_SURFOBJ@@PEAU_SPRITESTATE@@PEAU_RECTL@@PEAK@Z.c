/*
 * XREFs of ?psoSpGetComposite@@YAPEAU_SURFOBJ@@PEAU_SPRITESTATE@@PEAU_RECTL@@PEAK@Z @ 0x1C0270DD4
 * Callers:
...
LABEL_19:
  ...
  while ( v9 )
  {
    v13 = *(_DWORD *)(v9 + 88) - *(_DWORD *)(v9 + 80);
    if ( v13 > v11 )
      v11 = *(_DWORD *)(v9 + 88) - *(_DWORD *)(v9 + 80);
    v14 = *(_DWORD *)(v9 + 92) - *(_DWORD *)(v9 + 84);
    v9 = *(_QWORD *)(v9 + 24);
    if ( v14 > v12 )
      v12 = v14;
    v15 = v13 * v14;
