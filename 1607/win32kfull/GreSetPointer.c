/*
 * XREFs of GreSetPointer @ 0x1C005DA90
 * Callers:
...
void __fastcall GreSetPointer(HDEV a1, struct _CURSINFO *a2, __int64 a3, __int64 a4, unsigned int a5)
{
  ...
  if ( a2 )
  {
    xmmword_1C0328468 = *(_OWORD *)a2;
    xmmword_1C0328478 = *((_OWORD *)a2 + 1);
    xmmword_1C0328488 = *((_OWORD *)a2 + 2);
    qword_1C0328498 = *((_QWORD *)a2 + 6);
  }
  else
  {
    memset(&xmmword_1C0328468, 0, 0x38uLL);
  }
  v13 = a5;
  dword_1C03284A8 = a5;
  dword_1C03284A0 = v7;
  ...
  if ( (v15 & 0x20000) != 0 )
  {
    ...
    do
    {
      ...
      if ( !v17 || (v22[269] & 0x2000) != 0 || (v22[7] & 4) != 0 || v20 )
      {
        ...
        vSetPointer((HDEV)v19[6], a2, v7, v21, v13);
