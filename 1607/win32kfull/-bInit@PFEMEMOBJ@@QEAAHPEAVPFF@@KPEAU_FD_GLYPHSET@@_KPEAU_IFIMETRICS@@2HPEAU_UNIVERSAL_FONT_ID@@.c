/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C0064060
 * Callers:
        ...
        int a10)
{
  ...
  _QWORD v35[4]; // [rsp+48h] [rbp-79h] BYREF
  WCHAR v36[32]; // [rsp+68h] [rbp-59h] BYREF
  ...
  *(_DWORD *)(*(_QWORD *)this + 88LL) = _InterlockedIncrement(&dword_1C032DBC0);
  v17 = IFIOBJ::lfOrientation((IFIOBJ *)&v34);
  v18 = v34;
  *(_DWORD *)(*(_QWORD *)this + 68LL) = v17;
  ...
  PushThreadGuardedObject(v35, v21, vDeletePFE);
  ...
  if ( v22 )
  {
    *(_DWORD *)(*(_QWORD *)this + 136LL) = 0;
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 32LL) + 40LL) )
    {
      ...
      cCapString(v36, (WCHAR *)(v18 + *v33), 32);
      if ( v23 < v24 )
      {
        v25 = v36[0];
        v26 = v23 + 195;
        do
        {
          if ( !(*v26 | *(v26 - 66)) )
          {
            ...
            if ( v25 == *(_WORD *)(v26 - 65) )
            {
              ...
              {
                v29 = *++v27;
                if ( *v27 != *(WCHAR *)((char *)v27 + v26 - &v37) )
                  goto LABEL_31;
              }
              *(_BYTE *)((unsigned int)(*(_DWORD *)(*(_QWORD *)this + 136LL))++ + *(_QWORD *)this + 144LL) = (char)((_BYTE)v26 - (_BYTE)gpfsTable + 61) / -60;
              v25 = v36[0];
            }
          }
LABEL_31:
