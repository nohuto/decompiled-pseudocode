/*
 * XREFs of SfnINPGESTURENOTIFYSTRUCT @ 0x1C0209470
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v10 = 0LL;
  result = AllocCallbackMessage(88, 1u, *(unsigned int *)a4, v36, 1, 0x200uLL);
  v13 = result;
  v27 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v13 + 12) = a2;
    *((_QWORD *)v13 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v13, a4, *(_DWORD *)a4, (void **)v13 + 8) < 0 )
      goto LABEL_26;
    *((_QWORD *)v13 + 9) = a5;
    *((_QWORD *)v13 + 10) = a6;
    ...
    *((_QWORD *)v13 + 2) = 0LL;
    v19 = KeUserModeCallback(114LL, v13, *(unsigned int *)v13, &v28, v26);
