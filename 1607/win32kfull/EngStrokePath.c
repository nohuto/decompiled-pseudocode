/*
 * XREFs of EngStrokePath @ 0x1C000F530
 * Callers:
 ...
 *     W32kCddStrokePath @ 0x1C014E4A0 (W32kCddStrokePath.c)
        ...
        MIX mix)
{
  ...
  if ( v19 )
  {
    ...
    else if ( (ppo->fl & 1) == 0 || EPATHOBJ::bFlatten((EPATHOBJ *)ppo) )
    {
      if ( *(_WORD *)(v12 + 100) )
      {
        v14 = *(__int64 (__fastcall **)(__int64, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, POINTL *, LINEATTRS *, MIX))(*(_QWORD *)(v12 + 48) + 2824LL);
        if ( !v14 )
          goto LABEL_23;
