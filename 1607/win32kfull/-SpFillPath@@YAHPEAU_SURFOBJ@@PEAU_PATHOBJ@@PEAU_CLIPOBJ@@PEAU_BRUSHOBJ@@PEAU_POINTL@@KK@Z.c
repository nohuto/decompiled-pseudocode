/*
 * XREFs of ?SpFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C026B310
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  __int64 *v58[9]; // [rsp+380h] [rbp+280h] BYREF
  int v59; // [rsp+3C8h] [rbp+2C8h]
  ...
  v53 = a5;
  v8 = 1;
  ENUMUNDERLAYS::ENUMUNDERLAYS((ENUMUNDERLAYS *)v58, a1, a3, &a3->rclBounds);
  if ( (unsigned int)ENUMUNDERLAYS::bEnum(v58, &v49, &v51, &v48) )
  {
    while ( 1 )
    {
      v9 = 0LL;
      ...
      if ( v57 )
      {
        if ( EPATHOBJ::bClone((EPATHOBJ *)&v56, (struct EPATHOBJ *)this) )
        {
          x = v51.x;
          y = v51.y;
...
LABEL_39:
      ...
      XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)&v56);
      if ( !(unsigned int)ENUMUNDERLAYS::bEnum(v58, &v49, &v51, &v48) )
        return v8;
    }
    v9 = this;
...
LABEL_35:
    ...
    {
      v34 = (BOOL (__stdcall *)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, BRUSHOBJ *, POINTL *, MIX, FLONG))*((_QWORD *)v10->hdev + 166);
LABEL_33:
