/*
 * XREFs of ?BRUSHOBJ_pvGetRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@@Z @ 0x1C0257D84
 * Callers:
  ...
  if ( !result )
  {
    ...
    if ( !(unsigned int)bGetRealizedBrush(
                          *(struct BRUSH **)&a1[5].iSolidColor,
                          (struct EBRUSHOBJ *)a1,
                          *(__int64 (__fastcall **)(struct _BRUSHOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _XLATEOBJ *, unsigned int))(*((_QWORD *)a1[3].pvRbrush + 6) + 2808LL)) )
    {
