/*
 * XREFs of ?bIFIMetricsToTextMetricWStrict@@YAHAEAVRFONTOBJ@@AEAVDCOBJ@@PEAUtagTEXTMETRICW@@PEAU_IFIMETRICS@@@Z @ 0x1C0012348
 * Callers:
        ...
        struct _IFIMETRICS *a4)
{
  ...
  v46 = a4;
  IFIOBJR::IFIOBJR((IFIOBJR *)v35, a4, a1, a2);
  v7 = 8;
  ...
  if ( (*(_DWORD *)(v35[0] + 48LL) & 0x3000010) != 0 )
  {
    ...
    if ( (_DWORD)v13 == 0x80000000 )
      v13 = (unsigned int)IFIOBJ::fwdExternalLeading((IFIOBJ *)v35);
    bFToL(v13, &v44, 0LL);
  ...
  {
    v27 = *(_DWORD *)(*(_QWORD *)a1 + 88LL) != 0 ? 8 : 0;
