/*
 * XREFs of _SetWindowWord @ 0x1C0227D60
 * Callers:
 *     NtUserSetWindowWord @ 0x1C021AFF0 (NtUserSetWindowWord.c)
 * Callees:
 *     UserSetLastError @ 0x1C00A6F5C (UserSetLastError.c)
 *     FCallerOk @ 0x1C0227C8C (FCallerOk.c)
 */
...
LABEL_39:
  ...
  if ( (v4 & 0x80000000) != 0LL )
    goto LABEL_38;
  if ( (int)v4 >= *(unsigned __int16 *)(gpsi + 2LL * ((*(_WORD *)(a1 + 66) & 0x3FFFu) - 666) + 328) - 360 )
  {
LABEL_26:
...
LABEL_27:
    if ( !v8 && (unsigned __int64)(unsigned int)v4 + 2 <= *(unsigned int *)(a1 + 232) )
    {
      ...
      {
LABEL_37:
        result = *(unsigned __int16 *)(v4 + a1 + 360);
        *(_WORD *)(v4 + a1 + 360) = a3;
        return result;
      }
      goto LABEL_2;
