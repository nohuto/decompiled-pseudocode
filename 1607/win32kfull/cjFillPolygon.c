/*
 * XREFs of cjFillPolygon @ 0x1C024220C
 * Callers:
...
__int64 __fastcall cjFillPolygon(__int64 a1, int a2, _QWORD *a3, unsigned int a4)
{
  ...
  __int16 v35; // [rsp+30h] [rbp-88h]
  unsigned int v36; // [rsp+34h] [rbp-84h]
  int v37; // [rsp+38h] [rbp-80h]
  unsigned __int16 v38; // [rsp+3Ch] [rbp-7Ch]
  __int64 v39; // [rsp+40h] [rbp-78h]
  __int64 v40; // [rsp+48h] [rbp-70h]
  void (__fastcall *v41)(char *, _QWORD, _QWORD, _QWORD, int); // [rsp+50h] [rbp-68h]
  _QWORD *v42; // [rsp+58h] [rbp-60h]
  unsigned __int64 v43; // [rsp+60h] [rbp-58h]
  __int64 v44; // [rsp+68h] [rbp-50h]
  _DWORD *v45; // [rsp+70h] [rbp-48h]
  ...
  v41 = (void (__fastcall *)(char *, _QWORD, _QWORD, _QWORD, int))v16;
  v35 = 0;
  v17 = (unsigned __int16)(*(_WORD *)(v11 + 2LL * (v10 - 1)) + 1);
  v18 = *(_DWORD *)(v12 + 4 * v17);
  v19 = v7;
  v36 = v18;
  v37 = *(_DWORD *)(v13 + 4 * v17);
  v39 = v7;
  if ( !v10 )
...
LABEL_49:
  ...
  else
  {
    ...
    {
      v30 = v22 - v21;
      v28 = (unsigned int)((*v25 + v25[v30]) >> 1);
      v29 = (unsigned int)((*v24 + v24[v30]) >> 1);
    }
...
LABEL_47:
  ...
  while ( v14 >= (unsigned __int64)v9 + 12 )
  {
    v31 = v40;
    v32 = (char *)v9 + 4;
    v33 = (*(_BYTE *)(v21 + v40) & 1) == 0;
    if ( !v19 )
    {
      *(_WORD *)v9 = ((*(_BYTE *)(v21 + v40) & 1) == 0) + 1;
      v31 = v40;
    }
    if ( v21 <= v22 )
    {
      v34 = (unsigned __int64)v9 + 12;
      do
      {
        if ( v33 == (*(_BYTE *)(v21 + v31) & 1) )
          break;
        if ( v43 < v34 )
          return 0xFFFFFFFFLL;
        v41(v32, (unsigned int)*v24, (unsigned int)*v25, v36, v37);
        v31 = v40;
        ++v21;
        v32 += 8;
        v34 += 8LL;
