/*
 * XREFs of ?bSpDwmUpdateDragRectShape@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAUtagPOINT@@PEAUtagSIZE@@PEAKPEAPEAV3@@Z @ 0x1C025D9EC
 * Callers:
  ...
  if ( LogicalSurface )
  {
    ...
    if ( v19[0] )
    {
      *((_DWORD *)a2 + 34) |= 4u;
      ...
      {
        v12 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, RECTL *, RECTL *, POINTL *, ULONG))*((_QWORD *)a1 + 359);
      }
      else
      {
        v12 = EngStretchBlt;
      ...
      **(_DWORD **)(v13 + 56) = -1;
      ...
      LogicalSurface = ((__int64 (__fastcall *)(__int64, __int64, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, struct tagRECT *, __m128i *, _QWORD, int))v12)(
                         ...
                         1);
      if ( LogicalSurface )
        vSpUpdateDirtyRgn((struct _POINTL *)a2, v10, 0LL, (struct _RECTL *)&v20, a6, 0);
    }
    else
    {
      LogicalSurface = 0;
