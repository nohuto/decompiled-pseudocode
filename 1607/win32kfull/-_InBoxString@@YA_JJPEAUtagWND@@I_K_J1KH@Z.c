/*
 * XREFs of ?_InBoxString@@YA_JJPEAUtagWND@@I_K_J1KH@Z @ 0x1C01479F0
 * Callers:
 *     NtUserfnINCBOXSTRING @ 0x1C0147970 (NtUserfnINCBOXSTRING.c)
 *     NtUserfnINLBOXSTRING @ 0x1C01479B0 (NtUserfnINLBOXSTRING.c)
 * Callees:
        ...
        int a8)
{
  ...
  v13 = *(_DWORD *)(gptiCurrent + 1268LL);
  if ( v10 || v11 )
  {
    *(_DWORD *)(gptiCurrent + 1268LL) = 2;
    if ( a3 == v12 )
  ...
  if ( v14 == xxxSendMessageFF || (char *)v14 == (char *)xxxWrapSendMessageBSM )
    return -1LL;
  *(_DWORD *)(gptiCurrent + 1268LL) = 1;
  result = v14((int)a2, a3, a4, a5, a6);
LABEL_9:
  *(_DWORD *)(gptiCurrent + 1268LL) = v13;
  return result;
}
