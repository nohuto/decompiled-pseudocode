/*
 * XREFs of ?vAttemptDeviceMatch@MAPPER@@QEAAXXZ @ 0x1C0285DE0
 * Callers:
 ...
 *     ?vSetBest@MAPPER@@QEAAXPEAVPFE@@HE@Z @ 0x1C01BF624 (-vSetBest@MAPPER@@QEAAXPEAVPFE@@HE@Z.c)
 *     ?ppfeFirst@ENUMFHOBJ@@QEAAPEAVPFE@@XZ @ 0x1C0285D74 (-ppfeFirst@ENUMFHOBJ@@QEAAPEAVPFE@@XZ.c)
 *     ?ppfeNext@ENUMFHOBJ@@QEAAPEAVPFE@@XZ @ 0x1C0285DA0 (-ppfeNext@ENUMFHOBJ@@QEAAPEAVPFE@@XZ.c)
 */
...
void __fastcall MAPPER::vAttemptDeviceMatch(MAPPER *this)
{
  ...
  struct PFT *v14; // [rsp+58h] [rbp+18h] BYREF
        ...
        *((_DWORD *)this + 45) = 3;
        ...
        for ( i = ENUMFHOBJ::ppfeFirst((ENUMFHOBJ *)v11); ; i = ENUMFHOBJ::ppfeNext((ENUMFHOBJ *)v11) )
        {
          ...
          if ( !i )
            break;
          v14 = i;
          if ( (unsigned int)MAPPER::bNearMatch(this, (struct PFEOBJ *)&v14, &v13, 0) )
          {
            if ( !*((_DWORD *)this + 46) )
            {
