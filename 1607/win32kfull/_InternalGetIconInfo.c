/*
 * XREFs of _InternalGetIconInfo @ 0x1C003C054
 * Callers:
        ...
        int a6)
{
  ...
  if ( v22 )
  {
    ...
    if ( !v17 || a6 )
      ...
      v19 = v9 / 2;
    GreStretchBltInternal(ghdcMem, 0, v19, ghdcMem2, 0, 0, *(_DWORD *)(v8 + 140), v18, 13369376, 0xFFFFFF, 0);
  }
  else
  {
    if ( a6 || !*(_QWORD *)(v8 + 96) )
      ...
      v13 = v9 / 2;
    NtGdiBitBltInternal(ghdcMem, v13, ghdcMem2, 0, 0, 13369376, 0xFFFFFF, 0);
  }
  if ( v11 )
  {
    ...
    if ( v22 )
      ...
      NtGdiBitBltInternal(ghdcMem, v9 / 2, ghdcMem2, 0, 0, 13369376, 0, 0);
  }
