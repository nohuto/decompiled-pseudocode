/*
 * XREFs of NtGdiXLATEOBJ_hGetColorTransform @ 0x1C02B1B90
 * Callers:
 *     <none>
 * Callees:
...
HANDLE __fastcall NtGdiXLATEOBJ_hGetColorTransform(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v10 )
  {
    v8 = (BRUSHOBJ *)UMPDOBJ::GetDDIOBJ<_XLATEOBJ>((__int64)ThreadCurrentObj, a1);
    if ( v8 )
      ColorTransform = BRUSHOBJ_hGetColorTransform(v8);
  }
