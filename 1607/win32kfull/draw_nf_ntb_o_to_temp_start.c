/*
 * XREFs of draw_nf_ntb_o_to_temp_start @ 0x1C0106300
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall draw_nf_ntb_o_to_temp_start(__int64 a1, int a2, __int64 a3, int a4, unsigned int a5, int a6, int a7)
{
  ...
  if ( a2 )
  {
    ...
    {
      --v9;
      v12 = **(_DWORD ***)(a1 + 24 * v11 + 8);
      v13 = v12[2];
      v14 = *v12 + *(_DWORD *)(a1 + 24 * v11 + 16) - a4;
      v15 = (*(_BYTE *)v12 + *(_BYTE *)(a1 + 24 * v11 + 16) - (_BYTE)a4) & 7;
      v16 = (v13 + 7) >> 3;
      v17 = (int)(v13 + v15 + 7) >> 3;
      v18 = a3 + (int)(a5 * (*(_DWORD *)(a1 + 24 * v11 + 20) + v12[1] - a7));
      if ( v17 > 4 )
