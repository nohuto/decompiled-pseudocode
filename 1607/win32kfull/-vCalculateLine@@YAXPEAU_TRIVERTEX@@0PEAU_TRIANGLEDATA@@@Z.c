/*
 * XREFs of ?vCalculateLine@@YAXPEAU_TRIVERTEX@@0PEAU_TRIANGLEDATA@@@Z @ 0x1C0143490
 * Callers:
 ...
 * Callees:
 *     ?vEdgeDDA@@YAXPEAU_TRIANGLEDATA@@PEAU_TRIDDA@@@Z @ 0x1C0143758 (-vEdgeDDA@@YAXPEAU_TRIANGLEDATA@@PEAU_TRIDDA@@@Z.c)
 *     ?vHorizontalLine@@YAXPEAU_TRIVERTEX@@0PEAU_TRIANGLEDATA@@PEAU_TRIDDA@@@Z @ 0x1C014389C (-vHorizontalLine@@YAXPEAU_TRIVERTEX@@0PEAU_TRIANGLEDATA@@PEAU_TRIDDA@@@Z.c)
 */
...
void __fastcall vCalculateLine(struct _TRIVERTEX *a1, struct _TRIVERTEX *a2, struct _TRIANGLEDATA *a3)
{
  ...
  v49 = *((_QWORD *)a3 + 4);
  v42 = v17;
  v18 = *((_QWORD *)a3 + 12) + v8 * v15 + v16 * v49;
  v50 = *((_QWORD *)a3 + 5);
  v43 = v18;
  v44 = *((_QWORD *)a3 + 13) + v51 * v15 + v16 * v50;
  if ( !v13 )
  {
