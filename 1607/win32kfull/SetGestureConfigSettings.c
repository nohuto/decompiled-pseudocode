/*
 * XREFs of SetGestureConfigSettings @ 0x1C012A53C
 * Callers:
 ...
 *     ?SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z @ 0x1C012A69C (-SortGestureConfigArray@@YAHPEAUtagGESTURECONFIG@@H@Z.c)
...
__int64 __fastcall SetGestureConfigSettings(struct tagWND *a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( !GetGCData(a1) )
  {
    ...
    *v9 = 0;
    v8[2] = 0LL;
    VWPLAddBase((struct VWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 376LL) + 816LL), (__int64)v8, a1, 5u);
  }
  GCData = GetGCData(a1);
  if ( *(_DWORD *)a4 )
