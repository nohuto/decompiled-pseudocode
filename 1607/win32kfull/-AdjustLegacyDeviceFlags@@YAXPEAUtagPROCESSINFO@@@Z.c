/*
 * XREFs of ?AdjustLegacyDeviceFlags@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C00E1C7C
 * Callers:
...
void __fastcall AdjustLegacyDeviceFlags(struct tagPROCESSINFO *a1)
{
  ...
  if ( v5 )
  {
    *(_DWORD *)(v1 + 100) |= 1u;
    ...
    v10 = v9;
    if ( v9 && (unsigned int)HasHidTable(v9) && *(_QWORD *)(*(_QWORD *)(v10 + 376) + 776LL) == v1 )
  ...
  else
  {
    ...
    *(_DWORD *)(v1 + 100) = v11 & 0xFFFFFFF3;
    ...
    v13 = v12;
    if ( v12 && (unsigned int)HasHidTable(v12) && *(_QWORD *)(*(_QWORD *)(v13 + 376) + 776LL) == v1 )
      UpdateRawMouseMode(gpqForeground);
