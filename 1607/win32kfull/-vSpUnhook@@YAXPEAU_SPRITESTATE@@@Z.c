/*
 * XREFs of ?vSpUnhook@@YAXPEAU_SPRITESTATE@@@Z @ 0x1C012BD50
 * Callers:
...
void __fastcall vSpUnhook(struct _SPRITESTATE *a1)
{
  ...
  *((_DWORD *)a1 + 27) = *((_DWORD *)a1 + 25);
  v1[355] = *((_QWORD *)a1 + 152);
  v1[353] = *((_QWORD *)a1 + 153);
  v1[354] = *((_QWORD *)a1 + 154);
  v1[357] = *((_QWORD *)a1 + 156);
  v1[358] = *((_QWORD *)a1 + 157);
  v1[359] = *((_QWORD *)a1 + 158);
  v1[362] = *((_QWORD *)a1 + 159);
  v1[370] = *((_QWORD *)a1 + 160);
  v1[413] = *((_QWORD *)a1 + 161);
  v1[410] = *((_QWORD *)a1 + 162);
  v1[409] = *((_QWORD *)a1 + 163);
  v1[407] = *((_QWORD *)a1 + 164);
  v1[408] = *((_QWORD *)a1 + 166);
  v1[379] = *((_QWORD *)a1 + 165);
  v1[429] = *((_QWORD *)a1 + 167);
  *((_DWORD *)a1 + 2) = 0;
}
