/*
 * XREFs of ReferenceWindowStation @ 0x1C00F91F0
 * Callers:
...
NTSTATUS __fastcall ReferenceWindowStation(struct _KTHREAD *a1, void *a2, ACCESS_MASK a3, _QWORD *a4, int a5)
{
  ...
  ThreadWin32Thread = (__int64 *)PsGetThreadWin32Thread(a1, v13, v14, v15);
  ...
  if ( ProcessWin32Process )
  {
    if ( !a5
      || !v11
      || (v17 = *(_QWORD *)(v11 + 408)) == 0
      || *(_QWORD *)(ProcessWin32Process + 632) == *(_QWORD *)(v17 + 24) )
    {
