/*
 * XREFs of NtGdiCreateDIBitmapInternal @ 0x1C003AB20
 * Callers:
 *     <none>
 * Callees:
        ...
        SIZE_T Size)
{
  ...
  if ( Src && (_DWORD)a8 )
  {
    if ( !(unsigned int)bCaptureBitmapInfo(Src, a7, (unsigned int)a8, &v18) )
      goto LABEL_15;
    if ( Address )
    {
      if ( (_DWORD)Size )
      ...
      v15 = (unsigned int)EvaluateCurrentState((const struct reg_FeatureDescriptor *)&g_Feature_2316776760_59890556_FeatureDescriptorDetails)
