/*
 * XREFs of _PostMessageCheckIL @ 0x1C01D8C8C
 * Callers:
...
__int64 __fastcall PostMessageCheckIL(struct tagWND *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v6 != 717 )
  {
      ...
      if ( gbEnforceUIPI )
      {
        if ( (unsigned int)v17 <= v15 )
        {
          if ( (_DWORD)v17 != v15 || (v18 = HIDWORD(v17), (_DWORD)v18 != v16) && (_DWORD)v18 != -1 && v16 != -1 )
          {
            ...
            MSGSQMAddMessage(v11, (struct tagPROCESSINFO *)v9, v6, a3, a4, 0, 0);
            goto LABEL_30;
          }
        }
      }
    ...
    MSGSQMAddMessage(v11, (struct tagPROCESSINFO *)v9, v6, a3, a4, 0, v13);
LABEL_30:
    if ( !v12 )
      return 0LL;
    return PostMessage((__int64)a1, v6, a3, a4);
