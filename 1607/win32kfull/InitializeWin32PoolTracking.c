/*
 * XREFs of InitializeWin32PoolTracking @ 0x1C0133C40
 * Callers:
 *     <none>
 * Callees:
 *     ?IsWin32kRefreshed@@YA_NXZ @ 0x1C01585E0 (-IsWin32kRefreshed@@YA_NXZ.c)
 *     ?StopWin32PoolTracking@@YAXXZ @ 0x1C015890C (-StopWin32PoolTracking@@YAXXZ.c)
 *     ?LoadWin32PoolTrackingSettings@@YAXXZ @ 0x1C01EDE30 (-LoadWin32PoolTrackingSettings@@YAXXZ.c)
 */
...
__int64 InitializeWin32PoolTracking()
{
  ...
  {
    gpLeakTrackingAllocator = &unk_1C02E7FD0;
    return 0LL;
  }
}
