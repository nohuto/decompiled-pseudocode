/*
 * XREFs of ?pxrlStrRead04@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C0110960
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_27:
      ...
      while ( 1 )
      {
        v37 = (v33 & (unsigned int)dword_1C02ED598[v11]) >> dword_1C02ED578[v11];
        if ( v35 )
        {
          LODWORD(v37) = v35->pulXlate[v37];
          v36 = v46;
        }
        if ( (dword_1C02EDCF0[v36] & v44) != 0 )
        {
          v38 = *v34;
          if ( *v34 )
          {
...
LABEL_5:
        ...
        while ( 1 )
        {
          ...
          {
            v19 = v18;
            v20 = a5->pulXlate[(unsigned __int64)(v17 & (unsigned int)dword_1C02ED598[v11]) >> LOBYTE(dword_1C02ED578[v11])];
            v21 = &v9[v15 + 2];
    ...
    {
      v24 = (unsigned int *)((char *)a1 + 32);
LABEL_17:
      v25 = *(_DWORD *)v13;
      while ( 1 )
      {
        v26 = (v25 & (unsigned int)dword_1C02ED598[v11]) >> dword_1C02ED578[v11];
        v27 = *v24++;
        if ( (_DWORD)v27 )
        {
          LODWORD(a4) = v27 + (_DWORD)a4;
          v28 = (unsigned int *)((char *)a2 + 4 * v15 + 16);
