/*
 * XREFs of ?pvFileUMPD@RFONTOBJ@@QEAAPEAXPEAKPEAPEAX@Z @ 0x1C029B090
 * Callers:
 ...
 * Callees:
 *     ?pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEADPEAPEAX@Z @ 0x1C029AE20 (-pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEADPEAPEAX@Z.c)
