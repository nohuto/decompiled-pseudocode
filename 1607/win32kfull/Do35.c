...
__int64 __fastcall Do35(_BYTE *a1, unsigned __int8 *a2, unsigned __int8 *a3, int a4)
{
  ...
  for ( i = a4 & 3; v5; --v5 )
  {
    *a1 = (*a3 + *a2 + 2 * (*a2 + 2 * (*a3 + 1))) >> 3;
    a1[1] = (a3[1] + a2[1] + 2 * (a2[1] + 2 * (a3[1] + 1))) >> 3;
    a1[2] = (a3[2] + a2[2] + 2 * (a2[2] + 2 * (a3[2] + 1))) >> 3;
    v9 = a3[3];
    a3 += 4;
    v10 = a2[3];
    a2 += 4;
    result = (unsigned int)(v10 + 2 * (v9 + 1));
    a1[3] = (v9 + v10 + 2 * (int)result) >> 3;
    a1 += 4;
  }
  if ( i )
  {
