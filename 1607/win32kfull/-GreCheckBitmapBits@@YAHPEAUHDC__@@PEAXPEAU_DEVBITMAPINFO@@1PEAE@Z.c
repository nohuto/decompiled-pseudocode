/*
 * XREFs of ?GreCheckBitmapBits@@YAHPEAUHDC__@@PEAXPEAU_DEVBITMAPINFO@@1PEAE@Z @ 0x1C02B1D1C
 * Callers:
      ...
      if ( v9 )
      {
        if ( *(_QWORD *)(v9 + 3240) )
        {
          ...
          if ( v16 )
          {
            ...
            if ( v11 )
              v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, unsigned __int8 *))(v9 + 3240))(
                     *(_QWORD *)(v9 + 1824),
                     *(_QWORD *)(v16 + 24),
                     v11 + 24,
                     a5);
