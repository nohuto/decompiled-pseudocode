/*
 * XREFs of BuildExpandAAInfo @ 0x1C0008630
 * Callers:
 *     <none>
 * Callees:
 *     RaisePower @ 0x1C00068F0 (RaisePower.c)
 *     BuildRepData @ 0x1C000892C (BuildRepData.c)
        ...
        unsigned int a10)
{
  ...
  unsigned int v106; // [rsp+2Ch] [rbp-BDh]
  unsigned int v107; // [rsp+30h] [rbp-B9h] BYREF
  int v108; // [rsp+38h] [rbp-B1h]
  ...
  __int64 v122; // [rsp+88h] [rbp-61h]
  int *v123; // [rsp+90h] [rbp-59h]
  unsigned int *v124; // [rsp+98h] [rbp-51h]
  _QWORD *v125; // [rsp+A0h] [rbp-49h]
  int *v126; // [rsp+A8h] [rbp-41h]
  int *v127; // [rsp+B0h] [rbp-39h]
  _DWORD *v128; // [rsp+B8h] [rbp-31h]
  _DWORD *v129; // [rsp+C0h] [rbp-29h]
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v106 - v76 == 1 )
          ...
          v86 = v125[v106 - v76 - 2];
        v69 = v133;
        v80 = v13 * (v125[v85 - 2 + v106 - v76] - v86) + v121;
        v78 -= v13 * v85;
        v76 += 1 - v85;
...
LABEL_91:
    v89 = v109;
    if ( v10 < v73 || v10 >= v109 || a6 < v115 || a6 >= v116 )
    {
      v91 = v110;
      if ( v110 == -1 )
        goto LABEL_104;
LABEL_106:
    ...
    HIWORD(v132) = (v80 << 13) / v122;
    WORD2(v132) = ((v80 << 13) % v122 + (v120 << 13)) / v122;
    if ( v114 )
    {
      ++v103;
      WORD1(v132) = (((v80 << 13) % v122 + (v120 << 13)) % v122 + ((_QWORD)v114 << 13)) / v122;
      if ( v123 )
      {
        ++v105;
        v90 = ((((v80 << 13) % v122 + (v120 << 13)) % v122 + ((_QWORD)v114 << 13)) % v122 + ((_QWORD)v123 << 13)) / v122;
        goto LABEL_100;
      }
    }
    else
