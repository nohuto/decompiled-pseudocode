/*
 * XREFs of HT_HalftoneBitmap @ 0x1C00F3410
 * Callers:
 *     EngHTBlt @ 0x1C00F2408 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C00F36A4 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C00F36D4 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C00F3FD4 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C0249948 (CheckABInfo.c)
 */
