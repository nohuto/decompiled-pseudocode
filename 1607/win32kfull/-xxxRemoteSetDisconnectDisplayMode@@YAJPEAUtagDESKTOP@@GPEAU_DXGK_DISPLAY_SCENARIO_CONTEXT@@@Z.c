/*
 * XREFs of ?xxxRemoteSetDisconnectDisplayMode@@YAJPEAUtagDESKTOP@@GPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00EC888
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  v6 = xxxUserSetDisplayConfig(0LL, 0LL, 0LL, 0LL, 2191, 2, 0, a1, 0, &v8, 0LL, a3);
  if ( v6 < 0 )
  {
