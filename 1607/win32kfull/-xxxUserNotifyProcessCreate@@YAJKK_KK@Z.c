/*
 * XREFs of ?xxxUserNotifyProcessCreate@@YAJKK_KK@Z @ 0x1C009A754
 * Callers:
 *     NtUserNotifyProcessCreate @ 0x1C009A6E0 (NtUserNotifyProcessCreate.c)
 * Callees:
 *     W32GetThreadWin32Thread @ 0x1C0044EEC (W32GetThreadWin32Thread.c)
 *     LockThreadByClientId @ 0x1C009A830 (LockThreadByClientId.c)
...
__int64 __fastcall xxxUserNotifyProcessCreate(int a1, int a2, __int64 a3, int a4)
{
  ...
  if ( (a4 & 0xB) != 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( (int)result >= 0 )
      {
        W32GetThreadWin32Thread((__int64)v17, v10, v11, v12);
LABEL_11:
