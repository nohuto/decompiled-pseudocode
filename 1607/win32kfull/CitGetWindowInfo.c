/*
 * XREFs of CitGetWindowInfo @ 0x1C00AED20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CitGetWindowInfo(__int64 a1, __int64 a2)
{
  ...
  if ( result )
  {
    ...
    MonitorFlagsFromWindow = GetMonitorFlagsFromWindow(v5);
    LogicalToPhysicalDPIRect(&v14, &v14, MonitorFlagsFromWindow, 0LL);
    *(_WORD *)a2 = WORD4(v14) - v14;
    *(_WORD *)(a2 + 2) = WORD6(v14) - WORD2(v14);
    v7 = MonitorFromRect(&v14, 33LL);
    if ( v7 )
    ...
    v11 = 0;
    if ( (*(_DWORD *)(v5 + 352) & 0xF) == 1 )
    {
      v11 = 1;
    }
    else if ( (*(_DWORD *)(v5 + 352) & 0xF) == 2 )
    {
      v11 = 2;
    }
    v12 = v10 | (8 * v11);
