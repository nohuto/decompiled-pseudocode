/*
 * XREFs of CheckEasPolicyChange @ 0x1C01CBAD0
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C0334630 != KeyInformation[0] )
  {
    qword_1C0334630 = KeyInformation[0];
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C0334628 != KeyInformation[0] )
  {
    qword_1C0334628 = KeyInformation[0];
    return 1;
  }
  return v0;
}
