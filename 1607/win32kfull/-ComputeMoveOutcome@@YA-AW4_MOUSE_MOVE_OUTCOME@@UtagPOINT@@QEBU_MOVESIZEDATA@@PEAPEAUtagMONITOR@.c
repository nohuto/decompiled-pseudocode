/*
 * XREFs of ?ComputeMoveOutcome@@YA?AW4_MOUSE_MOVE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01FC1F8
 * Callers:
  ...
  *a4 = v10;
  ...
  else if ( v8 == *(struct tagMONITOR **)(a2 + 208) && v10 == v11 )
  {
    ...
    if ( (*(_DWORD *)(a2 + 256) & 2) != 0
      && *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 24LL) + 320LL)
