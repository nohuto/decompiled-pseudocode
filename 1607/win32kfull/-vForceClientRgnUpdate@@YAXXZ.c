/*
 * XREFs of ?vForceClientRgnUpdate@@YAXXZ @ 0x1C0279A70
 * Callers:
...
void vForceClientRgnUpdate(void)
{
  ...
  _QWORD v17[2]; // [rsp+50h] [rbp-41h] BYREF
    ...
    for ( i = *((_QWORD *)v0 + 3); i; i = *(_QWORD *)(i + 160) )
    {
      ...
      if ( (v3 & 0x40000000) != 0 )
      {
        *(_DWORD *)(i + 184) = v3 & 0x3FFFFFFF | 0x80000000;
        ...
        if ( v4 )
        {
          ClientRgn = UserGetClientRgn(v4, (__int64)&v22, v3 & 0x20, 0x80000000LL);
        }
        else
        {
        ...
        if ( v20[0] )
        {
          if ( (*(_DWORD *)(i + 184) & 0x100) == 0 )
          {
            ...
            if ( v14[0] )
            {
              if ( v17[0] )
              {
                ...
                RGNOBJAPI::iCombine((RGNOBJAPI *)v20, (struct RGNOBJ *)v14, (struct RGNOBJ *)v17, 1);
                if ( RGNOBJ::iCombine((RGNOBJ *)v14, (struct RGNOBJ *)v20, (struct RGNOBJ *)v17, 1) )
          ...
          if ( v10 )
          {
            ...
            if ( v15 )
            {
              RGNOBJ::vSwap((RGNOBJ *)v18, (struct RGNOBJ *)&v15);
              *(_QWORD *)(i + 192) = v15;
            }
          }
