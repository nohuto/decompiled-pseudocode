/*
 * XREFs of ?MulCreateDeviceBitmap@@YAPEAUHBITMAP__@@PEAUDHPDEV__@@UtagSIZE@@K@Z @ 0x1C0294C70
 * Callers:
 *     <none>
 * Callees:
...
HBITMAP __fastcall MulCreateDeviceBitmap(struct DHPDEV__ *a1, SIZEL a2, ULONG a3)
{
  ...
  if ( *(_QWORD *)a1 )
  {
    do
    {
      v8 = v3[6];
      v17 = v8;
      if ( (v8[231] & 0x8000000) != 0 && v8[349] )
      {
        v9 = (HSURF)((__int64 (__fastcall *)(__int64, SIZEL, _QWORD))v8[349])(v8[228], sizl, a3);
        v10 = v9;
