/*
 * XREFs of ReadTiltCalibrationData @ 0x1C01C3364
 * Callers:
...
__int64 __fastcall ReadTiltCalibrationData(__int64 a1, struct _UNICODE_STRING *a2)
{
  ...
  *(_DWORD *)&v17.Length = 45875200;
  ...
  TiltKeyName = RtlUnicodeStringCopy(&v17, (const struct _UNICODE_STRING *)(grpWinStaList + 168LL));
  if ( TiltKeyName >= 0 )
  {
    v7 = 1;
    ...
    if ( TiltKeyName >= 0 )
    {
      ...
      for ( j = 0LL; j < 4; ++j )
      {
        ...
        *(_DWORD *)&v16.Length = 91750400;
        ...
        RtlCopyUnicodeString(&v16, &v17);
        TiltKeyName = RtlUnicodeStringCatString(&v16, off_1C02E5C88[j]);
        if ( TiltKeyName >= 0 )
        {
          v13 = v21[j];
          v14 = v22[j];
