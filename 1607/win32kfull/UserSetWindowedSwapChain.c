/*
 * XREFs of UserSetWindowedSwapChain @ 0x1C014B548
 * Callers:
 *     UserSetWindowedSwapChainApiExt @ 0x1C014B540 (UserSetWindowedSwapChainApiExt.c)
 * Callees:
...
__int64 __fastcall UserSetWindowedSwapChain(__int64 a1, int a2, struct CompositionSurfaceObject *a3)
{
  ...
  if ( !Prop )
  {
    if ( !(unsigned int)CSwapChainProp::CreateSwapChainProp(a3, &v16) )
      goto LABEL_11;
    v14 = v16;
    v5 = CWindowProp::SetProp(v16, (unsigned __int64)v10);
    if ( !v5 )
    {
