/*
 * XREFs of GrayShrinkDIB_CY @ 0x1C0255770
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v30 )
  {
    do
    {
      ...
      if ( (v35 & 0x4000) != 0 )
      {
        ...
        v37 = -v36;
        v38 = v16;
        v39 = *(_DWORD *)(v69 + 4) + ((v35 >> 15) & 1) - v36;
        v40 = v36 - (*(_DWORD *)(v69 + 4) + ((v35 >> 15) & 1));
        do
        {
          v37 += v36;
          v40 += v39;
      ...
      {
        v53 = v69 + (((unsigned __int64)(unsigned __int16)v35 >> 5) & 0x400);
        do
        {
          v54 = *v31++;
