/*
 * XREFs of SetAppImeCompatFlags @ 0x1C00DF488
 * Callers:
...
__int64 __fastcall SetAppImeCompatFlags(__int64 a1, const UNICODE_STRING *a2)
{
  ...
  if ( (unsigned int)FastGetProfileStringW(
                       0LL,
                       *(char *)(CurrentProcessWin32Process + 12) < 0 ? 44 : 30,
                       a2->Buffer,
                       0LL,
                       SourceString,
                       80,
  ...
  if ( (unsigned __int16)((DefaultLocaleId & 0x3FF) - 17) > 1u || *(_WORD *)(a1 + 552) > 0x30Au )
    *(_DWORD *)(*(_QWORD *)(a1 + 376) + 728LL) = Value & 0xC00000;
  else
    *(_DWORD *)(*(_QWORD *)(a1 + 376) + 728LL) = Value;
  if ( !gpastrSetupExe )
    return 0LL;
  String1[0] = a2;
  for ( i = 0LL; i < 1; ++i )
