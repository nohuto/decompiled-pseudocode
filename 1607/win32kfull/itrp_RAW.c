...
__int64 __fastcall itrp_RAW(__int64 a1)
{
  ...
  if ( *(_BYTE *)(qword_1C03294E0 + 333) == 2 )
  {
    ...
    {
      v3 = *(__int16 *)(*(_QWORD *)(qword_1C03294D8 + 176) + 2LL * (*(__int16 *)(qword_1C03294D8 + 192) - 1)) + 1;
      *(_DWORD *)qword_1C03294C8 = *(_DWORD *)(*(_QWORD *)(qword_1C03294D8 + 128) + 4LL * (v3 + 1))
                                 - *(_DWORD *)(*(_QWORD *)(qword_1C03294D8 + 128) + 4LL * v3);
      result = a1;
      qword_1C03294C8 += 4LL;
      return result;
    }
