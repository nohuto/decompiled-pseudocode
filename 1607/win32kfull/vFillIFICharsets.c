/*
 * XREFs of vFillIFICharsets @ 0x1C0155D1C
 * Callers:
...
char __fastcall vFillIFICharsets(__int64 a1, __int64 a2, _BYTE *a3, __int64 a4, __int64 OemCodePage, __int64 a6)
{
  ...
  if ( v13 == (char)0x80 || v13 == -127 || v13 == -120 || v13 == -122 )
  {
    ...
    if ( !__ROR2__(*(_WORD *)OemCodePage, 8)
      || (unsigned int)IsBogusSignature(_byteswap_ulong(*(_DWORD *)(OemCodePage + 78)), a1) )
    {
      v10 = 1;
      *a3 = *(_BYTE *)(a2 + 44);
      goto LABEL_92;
  ...
  if ( v6 && *(_WORD *)v6 )
  {
    ...
    do
    {
      v16 = *(_DWORD *)&ajPanoseFamilyForTtfd[v9 + 16];
    ...
    if ( v12 < 0x100u )
    {
      if ( v11 )
      {
        ...
        if ( (v23 & 0xFF00) != 0 )
        {
          v24 = HIBYTE(v23);
          LOBYTE(v17) = v24 + 78;
          if ( (unsigned __int8)(v24 + 78) <= 2u )
          {
            LODWORD(v17) = -*(_DWORD *)(gpGdiSharedMemory + 1573012LL);
            LOBYTE(v24) = *(_DWORD *)(gpGdiSharedMemory + 1573012LL) != 0 ? -78 : 2;
            *(_BYTE *)(a2 + 44) = v24;
          }
          *a3 = v24;
          v10 = 1;
        ...
        else
        {
          ...
          *a3 = 0;
          v10 = 1;
          if ( !(unsigned int)fs_GetGlyphIDs(v26, 65280LL, 8710LL) && (_WORD)OemCodePage )
          {
            a3[1] = 77;
            v10 = 2;
          }
          LOWORD(OemCodePage) = 0;
          fs_GetGlyphIDs(v25, v27, 971LL);
          if ( !(unsigned int)fs_GetGlyphIDs(v25, v28, 937LL) && ((_WORD)OemCodePage || AnsiCodePage) )
          {
            v30 = v10++;
            a3[v30] = -95;
          }
          if ( !(unsigned int)fs_GetGlyphIDs(v25, v29, 304LL) && (_WORD)OemCodePage )
          {
            v32 = v10++;
            a3[v32] = -94;
          }
          if ( !(unsigned int)fs_GetGlyphIDs(v25, v31, 1488LL) && (_WORD)OemCodePage )
          {
            v34 = v10++;
            a3[v34] = -79;
          }
          LOWORD(OemCodePage) = 0;
          fs_GetGlyphIDs(v25, v33, 1105LL);
          if ( !(unsigned int)fs_GetGlyphIDs(v25, v35, 1071LL) && ((_WORD)OemCodePage || AnsiCodePage) )
          {
            v37 = v10++;
            a3[v37] = -52;
          }
          LOWORD(OemCodePage) = 0;
          fs_GetGlyphIDs(v25, v36, 328LL);
          if ( !(unsigned int)fs_GetGlyphIDs(v25, v38, 268LL) && ((_WORD)OemCodePage || AnsiCodePage) )
          {
            v40 = v10++;
            a3[v40] = -18;
          }
          if ( !(unsigned int)fs_GetGlyphIDs(v25, v39, 371LL) && (_WORD)OemCodePage )
          {
            v42 = v10++;
            a3[v42] = -70;
          }
          LODWORD(v17) = fs_GetGlyphIDs(v25, v41, 9618LL);
