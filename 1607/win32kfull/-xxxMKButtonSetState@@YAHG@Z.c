/*
 * XREFs of ?xxxMKButtonSetState@@YAHG@Z @ 0x1C01E4A50
 * Callers:
 *     ?xxxMKButtonClick@@YAHG@Z @ 0x1C01E49F0 (-xxxMKButtonClick@@YAHG@Z.c)
...
__int64 __fastcall xxxMKButtonSetState(unsigned __int16 a1)
{
  ...
  if ( (((unsigned __int8)v5 ^ v2) & 2) != 0 )
    xxxButtonEvent(2LL, gptCursorAsync, 0LL, a1, v3, v4, 0LL, 0LL, 0LL, 0, 0, 0, 0, 0, 0LL, &v8);
  gwMKButtonState = v5;
