/*
 * XREFs of ?bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_FORMAT@@H@Z @ 0x1C003FF0C
 * Callers:
        ...
        struct _ALPHA_DISPATCH_FORMAT *a7)
{
  unsigned int v8; // edi
  char v9; // al
  void (__fastcall *v10)(unsigned int *, __int64, int, unsigned int); // rax
  ...
  *((_QWORD *)a7 + 4) = vAlphaPerPixelOnly;
  if ( (v9 & 1) != 0 )
  {
    ...
    if ( *((_BYTE *)a7 + 42) == 0xFF )
      v10 = (void (__fastcall *)(unsigned int *, __int64, int, unsigned int))vAlphaPerPixelOnly;
    *((_QWORD *)a7 + 4) = v10;
  }
  else
  {
...
LABEL_68:
  ...
  if ( !v16 )
  {
    ...
    if ( (v24 & 8) != 0
      || (v24 & 2) != 0
      && ((v25 = *(_QWORD *)(*(_QWORD *)a3 + 120LL), *(_QWORD *)v25 == 0xFF0000FF0000LL) && *(_DWORD *)(v25 + 8) == 255
  ...
  if ( v16 == 1 )
  {
    ...
    if ( (v17 & 8) != 0
      || (v17 & 2) != 0
      && ((v22 = *(_QWORD *)(*(_QWORD *)a3 + 120LL), *(_QWORD *)v22 == 0xFF0000FF0000LL) && *(_DWORD *)(v22 + 8) == 255
...
LABEL_95:
    ...
    case 5:
      ...
      if ( (v29 & 8) != 0
        || (v29 & 2) != 0
        && ((v30 = *(_QWORD *)(*(_QWORD *)a4 + 120LL), *(_QWORD *)v30 == 0xFF0000FF0000LL)
         && *(_DWORD *)(v30 + 8) == 255
    ...
    case 6:
      if ( !a5
        ...
        || (v18 & 2) != 0
        && ((v20 = *(_QWORD *)(*(_QWORD *)a4 + 120LL), *(_QWORD *)v20 == 0xFF0000FF0000LL)
         && *(_DWORD *)(v20 + 8) == 255
