/*
 * XREFs of _SetInputServiceState @ 0x1C01234D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SetInputServiceState(int a1)
{
  ...
  if ( !a1 )
  {
    *(_DWORD *)(gptiCurrent + 1096LL) &= ~0x800000u;
    return 1LL;
  }
  v1 = a1 - 1;
  if ( !v1 )
  ...
  if ( v2 )
  {
    if ( v2 == 1 && (*(_DWORD *)(gptiCurrent + 1096LL) & 0x800000) != 0 )
    {
      v3 = 0;
      goto LABEL_6;
    }
  }
  else if ( (*(_DWORD *)(gptiCurrent + 1096LL) & 0x800000) != 0 )
  {
    v3 = 1;
LABEL_6:
