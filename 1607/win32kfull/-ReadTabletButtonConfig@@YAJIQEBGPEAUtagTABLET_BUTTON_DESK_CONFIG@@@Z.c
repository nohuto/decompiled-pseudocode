/*
 * XREFs of ?ReadTabletButtonConfig@@YAJIQEBGPEAUtagTABLET_BUTTON_DESK_CONFIG@@@Z @ 0x1C01D0958
 * Callers:
        ...
        struct tagTABLET_BUTTON_DESK_CONFIG *a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v9 >= 0 )
  {
    ...
    v11 = 0LL;
    v22[0] = L"DEFACTION";
    v22[1] = L"DEFACTIONDATA";
    v22[2] = L"DEFHOLDACTION";
    v12 = 8LL;
    v22[3] = L"DEFHOLDACTIONDATA";
    v22[4] = L"WINLOGONACTION";
    v22[5] = L"WINLOGONACTIONDATA";
    v22[6] = L"WINLOGONHOLDACTION";
    v22[7] = L"WINLOGONHOLDACTIONDATA";
    do
    {
      RtlInitUnicodeString(&ValueName, v22[v11]);
