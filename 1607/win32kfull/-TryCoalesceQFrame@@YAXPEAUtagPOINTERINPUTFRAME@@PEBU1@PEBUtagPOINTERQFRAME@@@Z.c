/*
 * XREFs of ?TryCoalesceQFrame@@YAXPEAUtagPOINTERINPUTFRAME@@PEBU1@PEBUtagPOINTERQFRAME@@@Z @ 0x1C01C1BBC
 * Callers:
        ...
        const struct tagPOINTERQFRAME *a3)
{
  ...
  if ( *((_DWORD *)a1 + 10) )
  {
    ...
    if ( v5 )
    {
      EtwTraceBeginPointerFrameCoalesce(*((unsigned int *)a1 + 8), *((unsigned int *)a1 + 10), 0LL);
      v4 = 0;
    }
  }
  v14 = 1;
  v15 = 1;
  v16 = 0;
  for ( i = (_DWORD *)*((_QWORD *)a1 + 11); v16 < *((_DWORD *)a1 + 10); i += 54 )
  {
    if ( (unsigned int)IsPointerInfoNodeValid((const struct tagPOINTERINFONODE *)i) )
    {
      v19 = *((_QWORD *)a1 + 12) + 40LL * (unsigned int)i[2];
  ...
  if ( v27 != v4 )
  {
    EtwTraceEndPointerFrameCoalesce(*((unsigned int *)a1 + 8), *((unsigned int *)a1 + 10), 0LL);
    v14 = 1;
  }
  *((_DWORD *)a1 + 18) ^= (*((_DWORD *)a1 + 18) ^ (2 * v15)) & 2;
  if ( !a3 )
    *((_DWORD *)a1 + 18) = *((_DWORD *)a1 + 18) & 0xFFFFFFE3 | (4 * (v14 & v9 | (2 * (v14 & v8 | (2 * (v14 & v10))))));
}
