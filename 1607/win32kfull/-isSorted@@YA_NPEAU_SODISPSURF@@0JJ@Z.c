/*
 * XREFs of ?isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z @ 0x1C0298FB4
 * Callers:
 *     ?vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z @ 0x1C02993B0 (-vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z.c)
 * Callees:
 *     <none>
 */
