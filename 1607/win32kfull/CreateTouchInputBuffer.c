/*
 * XREFs of CreateTouchInputBuffer @ 0x1C01D64E8
 * Callers:
...
_BOOL8 __fastcall CreateTouchInputBuffer(__int64 a1, ULONG a2, __int64 a3, int a4, ULONG a5)
{
  ...
  ULONG UsageLength; // [rsp+4Ch] [rbp-7Dh] BYREF
  ULONG v29; // [rsp+50h] [rbp-79h] BYREF
  ULONG v30; // [rsp+54h] [rbp-75h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( (v23 & 2) != 0
      && !v24
      && HidP_SetUsages(HidP_Input, 0xDu, v5, (PUSAGE)&UsageList + 1, &v29, PreparsedData, (PCHAR)Report, ReportLength) < 0 )
    {
      return 0LL;
    }
    if ( v23 < 0 && HidP_SetUsages(HidP_Input, 0xFF00u, v5, &v40, &v30, PreparsedData, (PCHAR)Report, ReportLength) < 0 )
      return 0LL;
    v25 = BYTE4(v37);
    if ( (BYTE4(v37) & 4) != 0
