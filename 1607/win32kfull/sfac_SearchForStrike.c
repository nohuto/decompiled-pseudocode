/*
 * XREFs of sfac_SearchForStrike @ 0x1C001D694
 * Callers:
 ...
 *     FindBlocStrike @ 0x1C01258B4 (FindBlocStrike.c)
 *     FindBscaStrike @ 0x1C02DF370 (FindBscaStrike.c)
 */
        ...
        _DWORD *a9)
{
  ...
  *a8 = 0;
  ...
  if ( !(_DWORD)result )
  {
    if ( !a6 )
      return 0LL;
    if ( (unsigned int)FindBlocStrike((_DWORD)a6, v21, a2, a3, a4, a5, (__int64)v12) )
    {
      *v11 = 2;
LABEL_7:
    ...
    if ( !(_DWORD)result )
    {
      ...
      if ( a9 )
      {
        if ( (unsigned int)FindBscaStrike((_DWORD)a9, v20, a2, a3, (__int64)v12) )
        {
          ...
          *a8 = v19;
          if ( (unsigned int)FindBlocStrike((_DWORD)a6, v21, *v18, v19, a4, a5, (__int64)v12) )
            *v11 = 3;
        }
        InvokeReleaseSfntFrag(a1[3]);
      }
