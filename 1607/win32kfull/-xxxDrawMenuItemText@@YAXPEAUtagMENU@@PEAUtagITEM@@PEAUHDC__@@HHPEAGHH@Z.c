/*
 * XREFs of ?xxxDrawMenuItemText@@YAXPEAUtagMENU@@PEAUtagITEM@@PEAUHDC__@@HHPEAGHH@Z @ 0x1C0236810
 * Callers:
...
LABEL_10:
    if ( a8
      ...
      || (GetAppCompatFlags2(0x400u, v15, v16, v17) & 2) != 0 )
    {
      if ( (unsigned int)CALL_LPK(ThreadWin32Thread) )
        xxxPSMTextOut(a3, v8, a5, a6, a7, 0x200000);
      else
