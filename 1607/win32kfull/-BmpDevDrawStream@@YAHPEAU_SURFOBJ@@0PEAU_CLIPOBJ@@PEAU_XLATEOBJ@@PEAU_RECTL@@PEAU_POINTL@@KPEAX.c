/*
 * XREFs of ?BmpDevDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C028AFD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)(v15 + 48) + 3432LL) )
      v16 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, struct _POINTL *, unsigned int, __int64, struct _DSSTATE *))(*(_QWORD *)(v15 + 48) + 3432LL);
