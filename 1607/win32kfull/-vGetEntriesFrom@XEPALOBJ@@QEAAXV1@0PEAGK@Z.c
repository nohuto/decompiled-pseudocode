/*
 * XREFs of ?vGetEntriesFrom@XEPALOBJ@@QEAAXV1@0PEAGK@Z @ 0x1C02B77D0
 * Callers:
...
unsigned __int64 __fastcall XEPALOBJ::vGetEntriesFrom(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5)
{
  ...
  if ( a5 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v13 >= v7 )
        v13 %= v7;
      v14 = *(_DWORD *)(*(_QWORD *)(v8 + 120) + 4LL * v13);
      v17 = v14;
      if ( HIBYTE(v14) == 2 )
      {
        if ( v9 )
        {
          ...
          v17 = *(_DWORD *)(*(_QWORD *)(a3 + 120) + 4LL * v14);
        }
        else
        {
          v17 = apalVGA[v14 & 0xF];
      ...
      HIBYTE(v17) = 0;
      result = v17;
      *(_DWORD *)(v12 + *(_QWORD *)(*(_QWORD *)a1 + 120LL)) = v17;
      if ( !v10 )
        break;
      a3 = v16;
      v8 = a2;
