/*
 * XREFs of ?MulDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C02953A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
  ...
  __int64 (__fastcall *v49)(__int64, __int64, __int64, __int64, int, struct _POINTL *, unsigned int, __int64, _QWORD *); // r10
  ...
  if ( a2->iType != 1 || !v15 || (*(_DWORD *)(v15 + 56) & 0x20000) == 0 )
  {
    ...
    if ( v17 )
    {
      MULTISURF::MULTISURF((MULTISURF *)v74, v58);
      v51 = EngDrawStream(v75, *(__int64 *)v73, (__int64)a3, (__int64)v10, (int)a5, (struct _POINTL *)v62, a7, v61, a9);
      v16 = v51;
    ...
    while ( 1 )
    {
      ...
      if ( !v19 )
      {
        ...
        if ( !pulXlate )
        {
          ...
          {
            v27 = SURFOBJ_TO_SURFACE_NOT_NULL(v58);
            if ( !v10 || (v10->flXlate & 1) != 0 )
            {
              v28 = *(_QWORD *)v73 == (_QWORD)v59;
            }
            else
            {
...
LABEL_76:
                v49 = EngDrawStream;
                if ( *(_QWORD *)(*((_QWORD *)v22 + 7) + 3432LL) )
                  LODWORD(v49) = *(_QWORD *)(*((_QWORD *)v22 + 7) + 3432LL);
