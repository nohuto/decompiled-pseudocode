/*
 * XREFs of UmfdDispatchEscape @ 0x1C02A519C
 * Callers:
 ...
 *     ?UmfdEscEngFntCacheLookUp@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1C02A46A8 (-UmfdEscEngFntCacheLookUp@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z.c)
