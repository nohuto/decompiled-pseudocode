/*
 * XREFs of ?SpTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x1C0102000
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulReserved)
{
  ...
  if ( !hdev || *((struct _SURFOBJ **)hdev + 17) != a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)NEEDDDILOCK::bRender((NEEDDDILOCK *)&v47, &v48) )
        break;
LABEL_15:
      if ( v13 )
