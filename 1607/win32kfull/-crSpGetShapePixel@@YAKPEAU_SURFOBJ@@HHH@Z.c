/*
 * XREFs of ?crSpGetShapePixel@@YAKPEAU_SURFOBJ@@HHH@Z @ 0x1C025DEB4
 * Callers:
  ...
  if ( v18[0] )
  {
    ...
    if ( (*(_DWORD *)(v9 + 116) & 1) != 0 )
    {
      ...
      if ( hdev )
      {
        ...
        v13 = (unsigned int (__fastcall *)(__int64, struct _SURFOBJ *, _QWORD, _QWORD, __m128i *, _DWORD *))*((_QWORD *)hdev + 358);
        *v12 = 0;
        v14 = *((_QWORD *)hdev + 141);
        v19 = si128;
        v17[0] = a2;
