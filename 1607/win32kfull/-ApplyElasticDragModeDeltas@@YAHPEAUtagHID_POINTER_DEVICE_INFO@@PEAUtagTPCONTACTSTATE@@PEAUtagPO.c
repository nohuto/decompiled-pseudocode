/*
 * XREFs of ?ApplyElasticDragModeDeltas@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAUtagTPCONTACTSTATE@@PEAUtagPOINTER_INFO@@PEAUtagPOINT@@@Z @ 0x1C01E6968
 * Callers:
        ...
        struct tagPOINT *a4)
{
  ...
  v9 = dword_1C03280B4
     ...
     * ((unsigned __int64)(1000LL * (*((_QWORD *)a3 + 10) - *((_QWORD *)a2 + 8)))
      / gliQpcFreq.QuadPart);
  if ( (int)v4 <= dword_1C03280B8 )
  {
    v10 = *((_DWORD *)a2 + 30);
    if ( (v10 & 2) == 0 && *((_DWORD *)a2 + 2) > dword_1C03280B8 )
      *((_DWORD *)a2 + 30) = v10 | 2;
    if ( (*((_DWORD *)a2 + 30) & 2) != 0 )
    {
      a4->x -= v9;
  ...
  v13 = dword_1C03280BC;
  v14 = HIDWORD(v4);
  if ( (int)v14 <= dword_1C03280BC )
  {
    v15 = *((_DWORD *)a2 + 30);
    if ( (v15 & 4) == 0 && *((_DWORD *)a2 + 3) > dword_1C03280BC )
      *((_DWORD *)a2 + 30) = v15 | 4;
    if ( (*((_DWORD *)a2 + 30) & 4) != 0 )
    {
      a4->y -= v9;
