/*
 * XREFs of ?VWPLRemoveBase@@YAHPEAPEAUVWPL@@_KPEAUtagWND@@HPEA_K@Z @ 0x1C0108B9C
 * Callers:
...
__int64 __fastcall VWPLRemoveBase(struct VWPL **a1, __int64 a2, struct tagWND *a3, __int64 a4, unsigned __int64 *a5)
{
  ...
  {
    if ( a3 == *(struct tagWND **)&v5[4 * (unsigned int)i + 6] )
      break;
  }
  if ( (unsigned int)i >= v9 )
    return 0LL;
  v11 = 2LL * (unsigned int)i;
  v12 = *(_QWORD *)&v5[4 * (unsigned int)i + 4];
  ...
  *(_QWORD *)&v5[2 * v11 + 6] = 0LL;
  ...
  if ( *v5 )
  {
    for ( ; (unsigned int)i < *v5; *(_OWORD *)&v5[2 * v13] = *(_OWORD *)&v5[2 * v14] )
    {
      v13 = 2 * ((unsigned int)i + 1LL);
      v14 = 2 * ((unsigned int)(i + 1) + 1LL);
      LODWORD(i) = i + 1;
    }
