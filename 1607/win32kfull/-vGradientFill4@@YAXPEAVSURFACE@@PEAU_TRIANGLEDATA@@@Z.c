/*
 * XREFs of ?vGradientFill4@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02CFF60
 * Callers:
 *     <none>
 * Callees:
      ...
      do
      {
        ...
        if ( v15 < v16 )
        {
          ...
          do
          {
            ...
            v26 = v11[Xlate555[(DefaultSaturationTable[(int)(v25 + HIBYTE(v19))] >> 3) | (unsigned __int64)(4 * (DefaultSaturationTable[(int)(v25 + HIBYTE(v18))] & 0xF8 | (32 * (DefaultSaturationTable[(int)(v25 + HIBYTE(v17))] & 0xF8))))]];
            v27 = *v21;
            if ( v22 )
            {
              v22 = 0;
