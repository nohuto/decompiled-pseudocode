...
void __fastcall FKActivationTimer(struct tagWND *a1, __int64 a2, __int64 a3)
{
  ...
  if ( gFilterKeysState != 2 )
  {
    if ( gFilterKeysState != 3 )
    {
      ...
      {
        *(_QWORD *)((char *)&xmmword_1C0326F34 + 12) = 0LL;
        DWORD1(xmmword_1C0326F34) = 2000;
        if ( (xmmword_1C0326F34 & 0x10) != 0 )
          PostEventMessageEx(
            *(_QWORD *)(v6 + 16),
    ...
    HIDWORD(xmmword_1C0326F34) = 0;
    DWORD1(xmmword_1C0326F34) = 0;
    dword_1C0326F44 = 1000;
LABEL_20:
    gFilterKeysState = v5 + 1;
    gtmridFKActivation = SetRITTimer(a3, 0xFA0u, (__int64)FKActivationTimer, 1);
    return;
  }
  v7 = xmmword_1C0326F34;
