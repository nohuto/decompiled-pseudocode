/*
 * XREFs of NtUserCallHwndParamLock @ 0x1C011B260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserCallHwndParamLock(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (_DWORD)v4 == 113
    || (_DWORD)v4 == 118
    || (_DWORD)v4 == 122
    || (unsigned int)v4 > 0x7B && (unsigned int)v4 <= 0x7D )
  {
    gbValidateHandleForIL = 0;
  }
  v7 = ValidateHwnd(a1);
  if ( v7 && ((_DWORD)v4 != 120 && (_DWORD)v4 != 107 || (((*(_WORD *)(v7 + 66) & 0x3FFF) - 669) & 0xFFFFFFFD) != 0) )
  {
    v10 = gptiCurrent;
