/*
 * XREFs of ?TraceLoggingRimHidDeviceRemovedEvent@@YAXGIIKKHPEAU_UNICODE_STRING@@0@Z @ 0x1C00E5754
 * Callers:
        ...
        struct _UNICODE_STRING *a8)
{
  ...
  if ( dword_1C0320840 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0320840, 0x800000000000uLL) )
    {
      ...
      v28 = 2LL;
      v30[1] = 0;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320840, &unk_1C02EE80E, 0LL, v8, 0xCu, &pData);
    }
  }
}
