/*
 * XREFs of FindMonitorForDigitizerWithQDCData @ 0x1C01C77C0
 * Callers:
    ...
    if ( (int)DrvDisplayConfigGetDeviceInfo(v61) >= 0 && v64[0] )
    {
      ...
      do
      {
        v18 = *(unsigned __int16 *)((char *)v17
                                  + (struct tagHID_POINTER_DEVICE_INFO *)((char *)a1 + 1128)
      ...
      do
      {
        v21 = *(unsigned __int16 *)((char *)v20
                                  + (struct tagHID_POINTER_DEVICE_INFO *)((char *)a1 + 872)
                                  - (struct tagHID_POINTER_DEVICE_INFO *)v64);
        v22 = *v20 - v21;
        if ( v22 )
          break;
...
LABEL_26:
    ...
    v24 = v57 - *(_QWORD *)((char *)a1 + 260);
    if ( v57 == *(_QWORD *)((char *)a1 + 260) )
      v24 = v57 - *(_QWORD *)((char *)a1 + 268);
    v14 = v46;
    if ( !v24 )
      goto LABEL_26;
    v14 = ++v46;
...
LABEL_74:
  ...
  *(_OWORD *)((char *)a1 + 124) = *(_OWORD *)(v36 + 28);
  if ( (v41 & 0x20) == 0 )
  {
    ...
    v58[3] = v45;
    SetPointerDeviceDisplayConfig(a1, v52, (struct tagDISPLAY_PATH_INFO *)v58, v39);
  }
}
