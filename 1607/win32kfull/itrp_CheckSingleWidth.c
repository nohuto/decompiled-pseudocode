/*
 * XREFs of itrp_CheckSingleWidth @ 0x1C02E048C
 * Callers:
...
__int64 __fastcall itrp_CheckSingleWidth(int a1)
{
  ...
  v1 = qword_1C03294E0;
  if ( dword_1C0329520 == 2 )
  {
    fixed = *(_DWORD *)(qword_1C03294E0 + 112);
  }
  else if ( dword_1C0329520 == 3 )
  {
    CVTScale = itrp_GetCVTScale();
    fixed = FixMul(*(_DWORD *)(qword_1C03294E0 + 112), CVTScale);
  }
  else
  {
