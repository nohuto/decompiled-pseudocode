/*
 * XREFs of ?PanUnlockDisplayArea@@YAXPEAUDHPDEV__@@PEAU_RECTL@@@Z @ 0x1C0287C40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ShadowUnLock@@YAXPEAU_PANDEV@@@Z @ 0x1C0287D5C (-ShadowUnLock@@YAXPEAU_PANDEV@@@Z.c)
 */
