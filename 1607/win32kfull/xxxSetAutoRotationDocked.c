/*
 * XREFs of xxxSetAutoRotationDocked @ 0x1C0154F04
 * Callers:
...
void __fastcall xxxSetAutoRotationDocked(int a1)
{
  ...
  if ( dword_1C0320840 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0320840, 0x200000000001uLL) )
  {
    ...
    v5 = 4;
    v8 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0320840, &unk_1C02EE2C2, v2, v1, 4u, &pData);
    LODWORD(v1) = v10;
  }
  if ( dword_1C0329470 && !(_DWORD)v1 && !dword_1C0329474 )
  {
    xxxRestoreSlateAutorotationPreferences();
    LODWORD(v1) = v10;
  }
  dword_1C0329470 = (int)v1;
  if ( (_DWORD)v1 )
