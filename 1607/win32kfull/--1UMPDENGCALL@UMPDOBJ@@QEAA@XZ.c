/*
 * XREFs of ??1UMPDENGCALL@UMPDOBJ@@QEAA@XZ @ 0x1C02AB0C0
 * Callers:
...
void __fastcall UMPDOBJ::UMPDENGCALL::~UMPDENGCALL(UMPDOBJ::UMPDENGCALL *this)
{
  __int64 v1; // rbx
  ...
  if ( *(_QWORD *)this )
  {
    if ( EvaluateCurrentState((const struct reg_FeatureDescriptor *)&reg_FeatureDescriptors_a) )
      _InterlockedDecrement((volatile signed __int32 *)(v1 + 432));
    else
      --*(_DWORD *)(v1 + 432);
  }
}
