/*
 * XREFs of xxxEvaluateDestRectForMonitorMigration @ 0x1C0203C4C
 * Callers:
...
LABEL_19:
    ...
    v17 = xxxForceSizeRecToDockTarget((struct _MOVESIZEDATA *)a2, v18, (__int16 *)a4, (unsigned int *)&v31, &v32, &v30);
    goto LABEL_19;
  }
  if ( IsDockTargetActive(a2, a4, 0) || IsDockTargetActive(a2, v20, 3) )
  {
    v8 = MigrateRectMonitors((__int64)a3, a3 + 7, *(_QWORD *)(a2 + 208), &v32.left, a4, v21, (_DWORD *)a2, 1);
    if ( v8 )
    {
      *(_QWORD *)&v32.left = a4;
