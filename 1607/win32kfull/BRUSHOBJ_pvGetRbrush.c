/*
 * XREFs of BRUSHOBJ_pvGetRbrush @ 0x1C0257FF0
 * Callers:
...
PVOID __stdcall BRUSHOBJ_pvGetRbrush(BRUSHOBJ *pbo)
{
  ...
  if ( !result )
  {
    if ( (unsigned int)bGetRealizedBrush(
                         ...
                         *(__int64 (__fastcall **)(struct _BRUSHOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _XLATEOBJ *, unsigned int))(*((_QWORD *)pbo[3].pvRbrush + 6) + 2808LL)) )
    {
