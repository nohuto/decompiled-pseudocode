/*
 * XREFs of ?bDelete@COLORTRANSFORMOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C02856C4
 * Callers:
 ...
 *     ?bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z @ 0x1C0285804 (-bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z.c)
 */
      ...
      if ( v10 )
      {
        ...
        if ( v11 )
        {
          ...
          else
          {
            ...
            v12 = *(unsigned int (__fastcall **)(_QWORD, __int64))(v11 + 3232);
            if ( v12 )
            {
