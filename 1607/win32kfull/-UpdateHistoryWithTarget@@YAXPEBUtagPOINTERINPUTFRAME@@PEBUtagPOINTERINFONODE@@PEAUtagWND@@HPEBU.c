/*
 * XREFs of ?UpdateHistoryWithTarget@@YAXPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@PEAUtagWND@@HPEBUtagPOINT@@HHH@Z @ 0x1C01C1EAC
 * Callers:
  ...
  while ( v13 != &gFrameListHead )
  {
    ...
    if ( v14[3].Blink == a1[7] )
    {
      SetPointerInfoNodeTargetInt(
        (struct tagPOINTERINFONODE *)((char *)v14[5].Blink + 216 * v11),
        a3,
        a4,
        a5,
        a6,
