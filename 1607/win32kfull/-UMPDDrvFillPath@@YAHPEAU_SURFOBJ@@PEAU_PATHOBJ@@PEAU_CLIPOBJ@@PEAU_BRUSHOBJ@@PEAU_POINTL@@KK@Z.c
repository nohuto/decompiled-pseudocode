/*
 * XREFs of ?UMPDDrvFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C029E3F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  if ( v22 )
  {
    if ( !*((_DWORD *)v22 + 109)
      || (v17 = 168,
          v13 = UMPDOBJ::bThunkLargeBitmap(v22, a1, &v21, &v20, &v19, &v18, &v17),
          v9 = v18,
          v14 = v13,
          (v17 = v13) != 0) )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (struct _SURFOBJ **)&Src[3], v9)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v12, Src, 96LL, &v17, Size) == -1)
        || (v14 = 1, !v17) )
      {
        v14 = 0;
      }
    ...
    if ( v19 )
      UMPDOBJ::RestoreBitmap(v12, a1, v21, v20, Size, v9);
    v7 = v14;
  }
