/*
 * XREFs of AdjustGlyphIntenisty @ 0x1C02628D4
 * Callers:
 ...
 *     ?ScaleUpAlpha@@YAEEM@Z @ 0x1C0261F08 (-ScaleUpAlpha@@YAEEM@Z.c)
 *     CalcActualGlyphIntensity @ 0x1C0262A0C (CalcActualGlyphIntensity.c)
 */
