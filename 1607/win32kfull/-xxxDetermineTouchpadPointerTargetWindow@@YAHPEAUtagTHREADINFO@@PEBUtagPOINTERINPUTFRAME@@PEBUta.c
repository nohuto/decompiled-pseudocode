/*
 * XREFs of ?xxxDetermineTouchpadPointerTargetWindow@@YAHPEAUtagTHREADINFO@@PEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@PEAUtagQ@@KHPEAHPEAUtagPOINT@@PEAPEAUtagWND@@@Z @ 0x1C01F120C
 * Callers:
  ...
  else
  {
    ...
    else
    {
      if ( !*((_DWORD *)a4 + 100) )
        return 0LL;
      LOBYTE(v17) = 1;
      v21 = HMValidateHandleNoSecure(*((_QWORD *)a4 + 51), v17, (__int64)v18, v19);
      v15 = (struct tagWND *)v21;
      if ( !v21 )
        goto LABEL_18;
      if ( *(char *)(v21 + 44) < 0 || *(char *)(v21 + 43) < 0 )
        v15 = 0LL;
      if ( v15 )
      {
        *v16 = *((_DWORD *)a4 + 104);
