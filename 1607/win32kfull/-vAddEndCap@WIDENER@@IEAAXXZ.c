/*
 * XREFs of ?vAddEndCap@WIDENER@@IEAAXXZ @ 0x1C02CA928
 * Callers:
 ...
 *     ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C02CAB34 (-vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z.c)
...
void __fastcall WIDENER::vAddEndCap(WIDENER *this)
{
  ...
  if ( v2 )
  {
    ...
    if ( !v3 )
    {
      ...
      v13 = v12;
      v7 = WIDENER::vecInPerp(this, &v14);
      LODWORD(v12) = *v7 + v12;
      HIDWORD(v12) += v7[1];
      v8 = WIDENER::vecInPerp(this, &v14);
      v4 = (struct _POINTFIX *)((char *)this + 692);
      v5 = (WIDENER *)((char *)this + 1152);
      LODWORD(v13) = v13 - *v8;
      HIDWORD(v13) -= v8[1];
