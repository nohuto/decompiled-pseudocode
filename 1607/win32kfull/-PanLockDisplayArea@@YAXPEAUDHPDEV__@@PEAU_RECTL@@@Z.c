/*
 * XREFs of ?PanLockDisplayArea@@YAXPEAUDHPDEV__@@PEAU_RECTL@@@Z @ 0x1C0287070
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z @ 0x1C0287DC8 (-ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z.c)
 */
