/*
 * XREFs of ?ulClearTypeFilter_6x1@@YAKPEAU_GLYPHBITS@@PEAU_GLYPHDATA@@PEAVRFONT@@@Z @ 0x1C00FCDF8
 * Callers:
 ...
 * Callees:
 *     ?SelectStorageTable@RFONTOBJ@@SAPEBEPEAVRFONT@@PEBE1@Z @ 0x1C00FD054 (-SelectStorageTable@RFONTOBJ@@SAPEBEPEAVRFONT@@PEBE1@Z.c)
 */
