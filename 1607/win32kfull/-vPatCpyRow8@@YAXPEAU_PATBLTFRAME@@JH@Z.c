/*
 * XREFs of ?vPatCpyRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02C1D10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vPatCpyRow8(struct _PATBLTFRAME *a1, int a2, int a3)
{
  ...
  if ( a3 )
  {
    do
    {
      ...
      {
        v19 = v14;
        *(_DWORD *)(v11 + v6) = *(_DWORD *)(v11 + v6) & ~(v23 & v13) | v23 & v13 & *(_DWORD *)(v14 + v9);
      }
      else
      {
        ...
        {
          v19 = v14;
          *(_DWORD *)(v11 + v6) = *(_DWORD *)(v11 + v6) & ~v13 | v13 & *(_DWORD *)(v14 + v9);
          LODWORD(v11) = v11 + 4;
          v14 += 4;
        }
        ...
        if ( v15 )
        {
          ...
          {
            v22 = v16 >> 2;
            vFetchAndCopy((__int64)&v17);
          }
          v9 = v18;
          v15 = v21;
        }
        if ( v24 )
          *(_DWORD *)(v10 + v6) = *(_DWORD *)(v10 + v6) & ~v23 | v23 & *(_DWORD *)(((int)v14 + 4 * (unsigned __int64)v15)
                                                                                 % *((unsigned int *)a1 + 10)
                                                                                 + v9);
      }
      if ( ++v8 == *((_DWORD *)a1 + 11) )
