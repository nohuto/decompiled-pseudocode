/*
 * XREFs of FreeWindowGCData @ 0x1C005578C
 * Callers:
 ...
 *     ?FreeWindowGCList@@YAXPEAPEAUtagGESTURECONFIGLIST@@@Z @ 0x1C0133BEC (-FreeWindowGCList@@YAXPEAPEAUtagGESTURECONFIGLIST@@@Z.c)
 */
...
__int64 __fastcall FreeWindowGCData(struct tagWND *a1, unsigned __int64 a2, __int64 a3, int a4)
{
  ...
  result = VWPLRemoveBase(
             (struct VWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 376LL) + 816LL),
             a2,
             a1,
             a4,
  ...
  if ( (_DWORD)result )
  {
    ...
    if ( v14 )
    {
      ...
      return VWPLRemoveBase((struct VWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 376LL) + 816LL), v12, a1, v13, 0LL);
    }
  }
  return result;
}
