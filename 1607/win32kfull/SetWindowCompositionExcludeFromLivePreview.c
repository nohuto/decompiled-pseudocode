/*
 * XREFs of SetWindowCompositionExcludeFromLivePreview @ 0x1C01286F8
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludeFromLivePreview(struct tagWND *a1, __int128 *a2)
{
  ...
  if ( (unsigned int)GetWindowCompositionInfo((__int64)a1, (__int64)v12) )
  {
    if ( -__CFSHR__(v12[0], 5) == v5 )
      return 0;
    v12[0] ^= (LOBYTE(v12[0]) ^ (unsigned __int8)(16 * v5)) & 0x10;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 13, a2);
    }
  }
  return v4;
}
