/*
 * XREFs of DxgkEngAccumD3DPresentBounds @ 0x1C0260090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngAccumD3DPresentBounds(HDC a1, int *a2)
{
  ...
  return UnexpectedThreadTerminationHandler<DWMSPRITEREF>::~UnexpectedThreadTerminationHandler<DWMSPRITEREF>((__int64)v20);
}
