/*
 * XREFs of ?MulGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C0295DA0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulMode)
{
  ...
  for ( i = MSURF::bFindSurface((MSURF *)v31, a1, a2, a8); i; i = MSURF::bNextSurface((MSURF *)v31) )
  {
    ...
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v33) + 112) & 0x20000) != 0 )
      v25 = *(BOOL (__stdcall **)(SURFOBJ *, CLIPOBJ *, XLATEOBJ *, TRIVERTEX *, ULONG, PVOID, ULONG, RECTL *, POINTL *, ULONG))(*(_QWORD *)(v32 + 56) + 3256LL);
    else
      v25 = EngGradientFill;
    v26 = OffGradientFill(
