/*
 * XREFs of InitializeClientPfnArrays @ 0x1C012E088
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C012DFA0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1) == gpepCSRSS )
  {
    ...
    *(_QWORD *)(gpsi + 840LL) = *(_QWORD *)(a3 + 80);
    ...
    qword_1C0326E08 = *(_QWORD *)(gpsi + 608LL);
    qword_1C0326E10 = *(_QWORD *)(gpsi + 688LL);
    qword_1C0326E18 = *(_QWORD *)(gpsi + 672LL);
    qword_1C0326E28 = *(_QWORD *)(gpsi + 640LL);
    qword_1C0326E90 = *(_QWORD *)(gpsi + 656LL);
    qword_1C0326EA8 = *(_QWORD *)(gpsi + 584LL);
    qword_1C0326E30 = *(_QWORD *)(gpsi + 680LL);
    qword_1C0326E38 = *(_QWORD *)(gpsi + 648LL);
    qword_1C0326E88 = 1LL;
    qword_1C0326E98 = 3LL;
    qword_1C0326EA0 = 2LL;
    qword_1C0326EB0 = 5LL;
