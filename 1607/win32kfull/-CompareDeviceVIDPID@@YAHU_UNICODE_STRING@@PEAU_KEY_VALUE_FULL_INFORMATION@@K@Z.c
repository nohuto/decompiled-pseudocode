/*
 * XREFs of ?CompareDeviceVIDPID@@YAHU_UNICODE_STRING@@PEAU_KEY_VALUE_FULL_INFORMATION@@K@Z @ 0x1C01C8C40
 * Callers:
 *     ?IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z @ 0x1C00E361C (-IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z.c)
 * Callees:
 *     <none>
 */
