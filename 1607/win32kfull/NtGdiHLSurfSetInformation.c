/*
 * XREFs of NtGdiHLSurfSetInformation @ 0x1C0066980
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreSfmGenerateMoveData @ 0x1C029351C (GreSfmGenerateMoveData.c)
 */
        ...
        if ( v9 )
        {
          ...
          if ( v10 )
          {
            ...
            if ( v11 )
            {
              ...
              updated = GreSfmCloseCompositorRef(HDEV, a1);
            }
            else
            {
              UserGetHDEV();
          ...
          {
            v16 = UserGetHDEV();
            updated = GreSetRedirectionSurfaceSignaling(v16, a1, v22, *((_QWORD *)&v21 + 1), v21);
          }
          else
          {
            updated = GreSfmRegisterLogicalSurfaceForSignaling(a1, (unsigned int)v21);
          }
        }
        else
        {
