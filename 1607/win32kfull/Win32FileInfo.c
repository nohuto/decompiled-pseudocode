/*
 * XREFs of Win32FileInfo @ 0x1C00221BC
 * Callers:
...
__int64 __fastcall Win32FileInfo(PCWSTR SourceString, _QWORD *a2, _QWORD *a3)
{
  ...
  _IO_STATUS_BLOCK IoStatusBlock; // [rsp+78h] [rbp-51h] BYREF
  _UNICODE_STRING DestinationString; // [rsp+88h] [rbp-41h] BYREF
  _OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+98h] [rbp-31h] BYREF
