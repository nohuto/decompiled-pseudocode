/*
 * XREFs of ?bCalculateAndDrawTriangle@@YAHPEAVSURFACE@@PEAU_TRIVERTEX@@11PEAU_TRIANGLEDATA@@P6AX02@Z@Z @ 0x1C01432A8
 * Callers:
 ...
 *     ?vCalculateLine@@YAXPEAU_TRIVERTEX@@0PEAU_TRIANGLEDATA@@@Z @ 0x1C0143490 (-vCalculateLine@@YAXPEAU_TRIVERTEX@@0PEAU_TRIANGLEDATA@@@Z.c)
 *     ?lCalculateTriangleArea@@YAJPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1C014384C (-lCalculateTriangleArea@@YAJPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
 *     ?bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1C0143ACC (-bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z.c)
        ...
        void (*a6)(struct SURFACE *, struct _TRIANGLEDATA *))
{
  ...
  __int64 v18; // r8
  __int64 v19; // r9
  struct _TRIVERTEX *v21; // r8
  struct _TRIVERTEX *v22; // rax
  ...
  if ( v9 < 0 )
  {
    ...
    v7 = v6;
    v6 = v21;
    if ( (int)lCalculateTriangleArea(v8, v7, v21, v10) <= 0 )
      return 0LL;
  }
  y = *((_DWORD *)a5 + 1);
  if ( v8->y > y )
  ...
  *((_DWORD *)a5 + 29) = v13;
  ...
  if ( bUMPDSecurityGateEx(v17, v16, v18, v19)
    && !*((_QWORD *)a5 + 19)
