/*
 * XREFs of ?xxxMKToggleMouseKeys@@YAHG@Z @ 0x1C01E5140
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall xxxMKToggleMouseKeys()
{
  ...
  if ( (gdwPUDFlags & 0x2000) == 0 )
  {
    ...
    else
    {
      ...
      v2 = *(_QWORD *)(v1 + 384);
      if ( (((unsigned __int8)(1 << (2 * (gNumLockVk & 3) + 1)) & gafAsyncKeyState[(unsigned __int64)(unsigned __int8)gNumLockVk >> 2]) != 0) != (unsigned __int8)xmmword_1C0326F04 >> 7 )
      {
        gbMKMouseMode = 0;
