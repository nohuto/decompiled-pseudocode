/*
 * XREFs of ?CreateAndReferenceMsgData@PointerList@@YA_KGKKIH@Z @ 0x1C01F3670
 * Callers:
 ...
 * Callees:
 *     ?AssignPointerCaptureData@@YAXPEAUtagINPUTPOINTERNODE@@PEAUtagPOINTERMSGDATA@@@Z @ 0x1C01F353C (-AssignPointerCaptureData@@YAXPEAUtagINPUTPOINTERNODE@@PEAUtagPOINTERMSGDATA@@@Z.c)
...
_QWORD *__fastcall PointerList::CreateAndReferenceMsgData(PointerList *this, int a2, int a3, unsigned int a4, char a5)
{
  ...
  *(_DWORD *)(v12 + 36) = v14 ^ ((unsigned __int8)v14 ^ (unsigned __int8)(8 * ((a4 & 0x2000) != 0))) & 8;
  ...
  v15 = (_QWORD *)((char *)NodeById + 112);
  v16 = *((_QWORD *)NodeById + 14);
  if ( *(struct tagINPUTPOINTERNODE **)(v16 + 8) != (struct tagINPUTPOINTERNODE *)((char *)NodeById + 112) )
    __fastfail(3u);
  *v13 = v16;
  v13[1] = v15;
  *(_QWORD *)(v16 + 8) = v13;
