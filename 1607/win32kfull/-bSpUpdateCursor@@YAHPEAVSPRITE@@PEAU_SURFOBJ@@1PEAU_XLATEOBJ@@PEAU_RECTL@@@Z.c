/*
 * XREFs of ?bSpUpdateCursor@@YAHPEAVSPRITE@@PEAU_SURFOBJ@@1PEAU_XLATEOBJ@@PEAU_RECTL@@@Z @ 0x1C026E43C
 * Callers:
        ...
        struct _RECTL *a5)
{
  ...
  struct _SURFOBJ *v22; // [rsp+98h] [rbp-9h]
  struct _XLATEOBJ *v23; // [rsp+A0h] [rbp-1h]
...
LABEL_8:
    ...
    *((_QWORD *)a1 + 15) = v10;
    ...
    if ( v22 )
    {
      bSpCreateShape(a1, &gptlZero, v22, v23, v17, *(struct PALETTE **)(v9 + 1832), 0, 0, 0LL);
