/*
 * XREFs of vSrcTranCopyS1D8 @ 0x1C0281D90
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  *(_QWORD *)v50 = a5 & 7;
  ...
  if ( (a6 & 0xFFFFFFF8) != (a5 & 0xFFFFFFF8) )
  {
    ...
    do
    {
      ...
      {
        v22 = 0x101010101010101LL * a9;
        v27 = dword_1C02F2880[(unsigned __int64)(unsigned __int8)v21 >> 4] | ((unsigned __int64)dword_1C02F2880[(unsigned __int8)v49 & *v19 & 0xF] << 32);
      ...
      if ( v32 != *(_QWORD *)&v50[4] )
      {
        do
        {
          ...
          {
            v28 = v50[4];
            v33 = dword_1C02F2880[(unsigned __int64)(unsigned __int8)*v30 >> 4] | ((unsigned __int64)dword_1C02F2880[*v30 & 0xF] << 32);
