/*
 * XREFs of ?QueueInput@InteractiveControlDevice@@QEAAXPEAU_LIST_ENTRY@@PEAVInteractiveControlInput@@@Z @ 0x1C023DE60
 * Callers:
 ...
 * Callees:
 *     ?CleanQueue@InteractiveControlDevice@@QEAAXK@Z @ 0x1C023C940 (-CleanQueue@InteractiveControlDevice@@QEAAXK@Z.c)
 */
