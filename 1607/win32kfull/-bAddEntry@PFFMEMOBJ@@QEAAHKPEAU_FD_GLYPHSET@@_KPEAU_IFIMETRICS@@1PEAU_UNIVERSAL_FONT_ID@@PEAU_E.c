/*
 * XREFs of ?bAddEntry@PFFMEMOBJ@@QEAAHKPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@1PEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C0064B88
 * Callers:
 ...
 *     ?IsCHSBaseFont@@YAHPEBGI@Z @ 0x1C02B60E0 (-IsCHSBaseFont@@YAHPEBGI@Z.c)
 */
        ...
        struct _EUDCLOAD *a8)
{
  ...
  v9 = *(_QWORD *)this;
  v26 = *(_QWORD *)(*(_QWORD *)this + 224LL) + (unsigned int)(*(_DWORD *)(*(_QWORD *)this + 216LL) * (a2 - 1));
  if ( !v26 )
    return 0;
  v11 = a8;
  v12 = 1;
...
LABEL_16:
  ...
  if ( !(unsigned int)PFEOBJ::bCheckFamilyName((PFEOBJ *)&v26, v15, 1, 0LL) )
    goto LABEL_17;
  v13[v19] = v16;
  v18 = !v19;
LABEL_15:
