/*
 * XREFs of ?AppendMousePromotionQueue@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C02318B4
 * Callers:
        ...
        struct tagMOUSE_PROMOTION_ENTRY *a3)
{
  ...
  if ( *(_QWORD *)a1 )
    ...
    *(_QWORD *)a1 = a2;
  *((_QWORD *)a1 + 1) = a3;
  if ( a1 == (struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0328C30 )
  {
    xmmword_1C0328C40 = *(_OWORD *)qword_1C0328C38;
    xmmword_1C0328C50 = *(_OWORD *)(qword_1C0328C38 + 16);
    v3 = *(_OWORD *)(qword_1C0328C38 + 32);
    *(_QWORD *)&xmmword_1C0328C40 = 0LL;
    xmmword_1C0328C60 = v3;
  }
}
