/*
 * XREFs of ?vIntersectVertical@@YAXPEAVDDA_CLIPLINE@@JPEAU_POINTL@@1PEAJ@Z @ 0x1C02CC008
 * Callers:
 ...
 *     ?yCompute@DDA_CLIPLINE@@QEAAJJ@Z @ 0x1C02CC3CC (-yCompute@DDA_CLIPLINE@@QEAAJJ@Z.c)
 */
