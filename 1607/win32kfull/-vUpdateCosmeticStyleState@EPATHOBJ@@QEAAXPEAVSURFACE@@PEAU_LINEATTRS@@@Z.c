/*
 * XREFs of ?vUpdateCosmeticStyleState@EPATHOBJ@@QEAAXPEAVSURFACE@@PEAU_LINEATTRS@@@Z @ 0x1C02CC0B4
 * Callers:
...
void __fastcall EPATHOBJ::vUpdateCosmeticStyleState(EPATHOBJ *this, struct SURFACE *a2, struct _LINEATTRS *a3)
{
  ...
  while ( 2 )
  {
    ...
    while ( (unsigned __int64)v15 < v16 )
    {
      ...
      else if ( (unsigned __int64)v23 * v17 < v24 * (unsigned __int64)(unsigned int)v19 )
      {
LABEL_23:
        if ( (v27[0] & 5) != 0 )
          goto LABEL_24;
...
LABEL_32:
  ...
  a3->elStyleState.l = (unsigned __int16)((unsigned int)v13 % v25) | ((unsigned __int16)((unsigned int)v13 / v25) << 16);
}
