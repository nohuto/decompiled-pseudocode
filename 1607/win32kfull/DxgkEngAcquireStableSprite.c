/*
 * XREFs of DxgkEngAcquireStableSprite @ 0x1C0260140
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkEngAcquireStableSprite(__int64 a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( HDEV )
    {
      ...
      {
        do
          SPRITERANGELOCK::vLockExclusive((SPRITERANGELOCK *)(*(_QWORD *)(*(_QWORD *)(v5 + 168) + 8LL * v3++) + 224LL));
        while ( v3 < *(_DWORD *)(v5 + 164) );
      }
      else
      {
        SPRITERANGELOCK::vLockExclusive((SPRITERANGELOCK *)(HDEV + 224));
      }
    }
  }
}
