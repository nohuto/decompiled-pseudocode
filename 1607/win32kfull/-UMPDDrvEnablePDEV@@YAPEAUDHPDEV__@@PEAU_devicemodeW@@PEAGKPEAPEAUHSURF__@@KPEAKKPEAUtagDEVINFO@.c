/*
 * XREFs of ?UMPDDrvEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C029D7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a11)
{
  ...
  PVOID v35; // [rsp+50h] [rbp-138h]
  PVOID v36; // [rsp+58h] [rbp-130h]
  struct DHPDEV__ *v37; // [rsp+60h] [rbp-128h] BYREF
  void *v38; // [rsp+68h] [rbp-120h]
  void *v39; // [rsp+70h] [rbp-118h]
      ...
      if ( v17 )
      {
        ...
        if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v14, (const void **)&v43[4], v16) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkStringW(v14, (unsigned __int16 **)&v43[5]) )
          {
            ...
            {
              LODWORD(v32) = 8;
              if ( (unsigned int)UMPDOBJ::Thunk(v14, v43, 176LL, &v37, v32) != -1 )
              {
                if ( a4 )
                {
                  KernelPtr = UMPDOBJ::GetKernelPtr((char **)v14, (char *)v43[7]);
                  memmove(a4, KernelPtr, 8 * v12);
                }
                if ( a6 )
                {
                  v19 = UMPDOBJ::GetKernelPtr((char **)v14, (char *)v43[9]);
                  memmove(a6, v19, a5);
                  if ( a6[59] == 18 && a6[68] <= 0x100 && a6[69] <= 0x100 )
                  {
                    v42 = Src;
                    SETFLAG(1, (volatile unsigned int *)Src + 14, 0x400000);
                    ...
                    *((_QWORD *)a6 + 36) = 0LL;
                    *((_QWORD *)a6 + 37) = 0LL;
                    v20 = UMPDOBJ::GetKernelPtr((char **)v14, (char *)v43[17]);
                    Src = UMPDOBJ::GetKernelPtr((char **)v14, (char *)v43[18]);
                    v39 = UMPDOBJ::GetKernelPtr((char **)v14, (char *)v43[19]);
                    v21 = 0LL;
                    pv = 0LL;
                    v22 = 0LL;
                    v35 = 0LL;
                    ...
                    if ( v21 )
                    {
                      ...
                      else
                      {
                        ...
                        if ( v23 )
                        {
                          v27 = a6[68] * a6[69];
                          v28 = v39;
                          if ( (char *)v39 + v27 < v39 || (unsigned __int64)v39 + v27 > W32UserProbeAddress )
                            *W32UserProbeAddress = 0;
                          memmove(v23, v28, v27);
                        }
                      }
                ...
                if ( v38 )
                {
                  v30 = UMPDOBJ::GetKernelPtr((char **)v14, (char *)v43[11]);
                  if ( !*((_QWORD *)v30 + 37) )
                  {
                    if ( v37 )
                      UMPDDrvDisablePDEV(v37);
                    goto LABEL_59;
                  }
                  memmove(v29, v30, a7);
                }
