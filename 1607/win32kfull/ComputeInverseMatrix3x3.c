/*
 * XREFs of ComputeInverseMatrix3x3 @ 0x1C00F5584
 * Callers:
  ...
  *(_DWORD *)v58 = 1000000;
  ...
  do
  {
    ...
    if ( *((_DWORD *)v56 + 2 * v11 + v11 + v4) )
    {
      ...
      do
      {
        v20 = DivFD6(*(unsigned int *)((char *)v56 + v18), v17);
      ...
      do
      {
        if ( v22 != v4 )
        {
          ...
          if ( *v23 )
          {
            ...
            do
            {
              v29 = MulFD6(*(unsigned int *)((char *)v56 + (_QWORD)v56 + v27 + v25), v26);
              v30 = *(unsigned int *)&v58[v25 + (_QWORD)v56 + v27];
