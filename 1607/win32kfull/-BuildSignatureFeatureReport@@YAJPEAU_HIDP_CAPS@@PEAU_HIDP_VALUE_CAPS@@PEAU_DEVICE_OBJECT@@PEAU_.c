/*
 * XREFs of ?BuildSignatureFeatureReport@@YAJPEAU_HIDP_CAPS@@PEAU_HIDP_VALUE_CAPS@@PEAU_DEVICE_OBJECT@@PEAU_FILE_OBJECT@@PEAPEAD4@Z @ 0x1C01C4E18
 * Callers:
  ...
  if ( OutputBuffer )
  {
    if ( a2 && a3 && a4 )
    {
      *OutputBuffer = a2->ReportID;
      ...
      if ( !v14 )
        goto LABEL_6;
      v14->Tail.Overlay.CurrentStackLocation[-1].FileObject = a4;
      Status = IofCallDriver(a3, v14);
      if ( Status == 259 )
      {
...
LABEL_6:
    ...
    v16 = (char *)Win32AllocPoolZInit(256LL, 1768321877LL);
    *a6 = v16;
    if ( !v16 )
      Status = -1073741668;
    v10 = Status;
