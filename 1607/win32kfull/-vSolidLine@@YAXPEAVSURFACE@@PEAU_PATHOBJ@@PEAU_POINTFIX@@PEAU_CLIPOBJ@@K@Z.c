/*
 * XREFs of ?vSolidLine@@YAXPEAVSURFACE@@PEAU_PATHOBJ@@PEAU_POINTFIX@@PEAU_CLIPOBJ@@K@Z @ 0x1C00101CC
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v5 = *((_DWORD *)a1 + 24);
  v7 = (struct _W32KCDD_ENG_CALLBACKS *)*((_QWORD *)a1 + 72);
  v8 = 0LL;
        ...
        *(_QWORD *)(*(_QWORD *)&v19 + 80LL) = *(_QWORD *)(*(_QWORD *)&v19 + 32LL);
        do
        {
          ...
          if ( v22 )
          {
            ...
            do
            {
              vDrawLine(v26, v25, v27, v30, v13, v8, v18, v33);
              v26 = v25++;
              --v22;
            }
            while ( v22 );
          ...
          v35 = pptfx[count - 1];
          if ( (flags & 8) != 0 )
            vDrawLine(&v35, &v37, v34, v30, v13, v8, v18, v33);
        }
        while ( v20 );
      }
      else
