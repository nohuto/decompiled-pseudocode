/*
 * XREFs of ?xxxSendToTouchStack@@YAXPEAUDEVICEINFO@@IPEAUtagPOINTER_TOUCH_INFO@@K@Z @ 0x1C01D452C
 * Callers:
...
void __fastcall xxxSendToTouchStack(struct DEVICEINFO *a1, unsigned int a2, struct tagPOINTER_TOUCH_INFO *a3, ULONG a4)
{
  ...
  *((_DWORD *)a1 + 64) = 0;
  v4 = 0;
  v6 = (int)a3;
  for ( *((_QWORD *)a1 + 33) = *(unsigned __int16 *)(*((_QWORD *)a1 + 58) + 44LL); v4 < a2; v4 += 4 )
  {
    if ( v4 )
