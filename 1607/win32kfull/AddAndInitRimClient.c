/*
 * XREFs of AddAndInitRimClient @ 0x1C011A3F8
 * Callers:
    ...
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 128) = Object;
    v11 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 152),
            ...
            &v36,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 168) = v36;
    v12 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 192),
            ...
            &v26,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 208) = v26;
    v13 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 232),
            ...
            &v27,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 248) = v27;
    v32 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 296),
            ...
            &v28,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 312) = v28;
    v34 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 344),
            ...
            &v29,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 360) = v29;
    v14 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 392),
            ...
            &v30,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 408) = v30;
    if ( v10 < 0 )
      return 3221225473LL;
    if ( v11 < 0 )
      return 3221225473LL;
