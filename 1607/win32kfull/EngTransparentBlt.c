/*
 * XREFs of EngTransparentBlt @ 0x1C0103690
 * Callers:
        ...
        ULONG ulReserved)
{
  ...
  CLIPOBJ *v43; // [rsp+A8h] [rbp-2E0h]
  __int64 v44; // [rsp+B0h] [rbp-2D8h] BYREF
  char v45; // [rsp+B8h] [rbp-2D0h]
  int v46; // [rsp+BCh] [rbp-2CCh]
  HDEV hdev; // [rsp+C0h] [rbp-2C8h] BYREF
  HDEV v48; // [rsp+C8h] [rbp-2C0h] BYREF
  struct _RECTL *v49; // [rsp+D0h] [rbp-2B8h]
  RECTL *v50; // [rsp+D8h] [rbp-2B0h]
  char *v51; // [rsp+E0h] [rbp-2A8h]
  struct SURFACE *v52; // [rsp+E8h] [rbp-2A0h]
    ...
    || prclDst->bottom - prclDst->top != prclSrc->bottom - prclSrc->top )
  {
    ...
    v45 = 0;
    v46 = 0;
    v14 = psSetupTransparentSrcSurface(v13, v12, &v76, 0LL, &v77, (struct SURFMEM *)&v44, 1u, iTransColor);
    v34 = v14;
    if ( v14 )
    {
          ...
          for ( i = 0; i < v79; ++i )
          {
            ...
            if ( v25 < v36 )
            {
              ...
              if ( v26 < v27 )
              {
                ...
                v62 = v27 - v26;
                v63 = v36 - v25;
                v67 = v26 + v77.left - v76.left;
                v68 = v27 + v77.left - v76.left;
                v69 = v26;
                v70 = v25;
                v59 = *((_QWORD *)v51 + 7) + v28 * *((_DWORD *)v51 + 16);
                v60 = (char *)v10->pvScan0 + v25 * v10->lDelta;
                v18 = v41;
...
LABEL_54:
  ...
  v29 = *((_QWORD *)v30 + 357);
  if ( v29 )
    LODWORD(v29) = _guard_dispatch_icall_fptr();
  return v29;
}
