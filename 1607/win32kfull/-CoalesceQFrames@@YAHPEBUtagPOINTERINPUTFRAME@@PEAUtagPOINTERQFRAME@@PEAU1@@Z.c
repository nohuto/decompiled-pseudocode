/*
 * XREFs of ?CoalesceQFrames@@YAHPEBUtagPOINTERINPUTFRAME@@PEAUtagPOINTERQFRAME@@PEAU1@@Z @ 0x1C01BFB0C
 * Callers:
        ...
        struct tagPOINTERINPUTFRAME *a3)
{
  ...
  v4 = 0;
  result = qword_1C032DD18;
  dword_1C032DD14 = 0;
  if ( gPointerCoalesceInfo < (unsigned int)v3 )
  {
    if ( qword_1C032DD18 )
    {
      Win32FreePool(qword_1C032DD18, a2, a3);
      result = 0LL;
    ...
    if ( *(_DWORD *)(v11 + 8) == *(_DWORD *)a2 )
    {
      if ( (*(_DWORD *)v11 & 0x2000) == 0 && !(unsigned int)IsNodeFullyReleased((const struct tagPOINTERINFONODE *)v11) )
      {
        ...
        if ( NodeQueuedMessage )
        {
          ...
          {
            *(_QWORD *)(qword_1C032DD18 + 16LL * (unsigned int)dword_1C032DD14) = v22;
            *(_QWORD *)(qword_1C032DD18 + 16LL * (unsigned int)dword_1C032DD14++ + 8) = NodeQueuedMessage;
    ...
    if ( v10 )
    {
      ...
      if ( *((_DWORD *)a1 + 10) )
      {
        ...
        do
        {
          ...
          {
            v20 = *(_QWORD **)(qword_1C032DD18 + 16LL * v19);
            v21 = *(_QWORD *)(qword_1C032DD18 + 16LL * v19 + 8);
