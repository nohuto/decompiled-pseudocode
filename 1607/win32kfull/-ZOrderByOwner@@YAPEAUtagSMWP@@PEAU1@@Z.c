/*
 * XREFs of ?ZOrderByOwner@@YAPEAUtagSMWP@@PEAU1@@Z @ 0x1C00A4EF8
 * Callers:
...
LABEL_36:
        ...
        if ( v21 <= 0 )
          ...
          v23 = *(struct tagWND **)(LODWORD(gSharedInfo[2])
                                  * (unsigned int)(unsigned __int16)*(_DWORD *)(168LL * (v21 - 1) + *((_QWORD *)v1 + 5))
                                  + gSharedInfo[1]);
        if ( v4 != v21 )
        {
          v24 = 168LL * v4;
...
LABEL_24:
      v18 = 0;
LABEL_25:
      if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)&v34 + 1) + 376LL) + 768LL) & 2) != 0
