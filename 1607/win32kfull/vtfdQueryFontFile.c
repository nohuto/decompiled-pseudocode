/*
 * XREFs of vtfdQueryFontFile @ 0x1C012F7D0
 * Callers:
...
__int64 __fastcall vtfdQueryFontFile(__int64 a1, int a2, unsigned int a3, void *a4)
{
  ...
  unsigned int v22; // [rsp+30h] [rbp-138h] BYREF
...
LABEL_28:
  ...
  {
    if ( !(unsigned int)EngMapFontFileFDInternal(*(struct _FILEVIEW **)(a1 + 8), &pcchLength, &v22, 1) )
      return 0xFFFFFFFFLL;
    v10 = v22;
    v11 = pcchLength;
  }
