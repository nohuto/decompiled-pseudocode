/*
 * XREFs of ?GetPointerHistoryFrameData@@YAHPEBUtagPOINTERINPUTFRAME@@KIIPEAE1@Z @ 0x1C01EFB60
 * Callers:
 ...
 *     ?FindPointerInFrame@@YAHPEBUtagPOINTERINPUTFRAME@@IPEAK@Z @ 0x1C01EECBC (-FindPointerInFrame@@YAHPEBUtagPOINTERINPUTFRAME@@IPEAK@Z.c)
  ...
  for ( i = 0; v11 && i < v7; ++i )
  {
    ...
    if ( a4 >= v10 )
    {
      ...
      v11 = PointerInfoCopyOutHelper(
              ...
              *((struct tagHID_POINTER_DEVICE_INFO **)a1 + 13),
              v8,
              v10,
              a6);
      if ( v11 )
