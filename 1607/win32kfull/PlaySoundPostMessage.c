/*
 * XREFs of PlaySoundPostMessage @ 0x1C0368000
 * Callers:
 *     PostPlaySoundMessage @ 0x1C010F780 (PostPlaySoundMessage.c)
 * Callees:
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00D5240 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 *     I_PlaySoundkPostMessage @ 0x1C010F7A8 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C010F7F0 (PlaySndClient_midl_user_allocate.c)
 */
