...
__int64 __fastcall cjComputeGLYPHSET_HIGH_BYTE(_WORD *a1, ULONG **a2, __int64 a3)
{
  ...
  for ( i = 0; i < 0x100u; ++i )
  {
    ...
    if ( v18 )
    {
      ...
      v20 = __ROR2__(*v19, 8);
      v21 = v20;
      v22 = __ROR2__(v19[2], 8);
      v23 = (char *)v19 + (unsigned __int16)__ROR2__(v19[3], 8);
      v24 = v20 + (unsigned __int16)__ROR2__(v19[1], 8);
      if ( v20 < v24 )
      {
        v25 = v20;
        do
        {
          v26 = __ROR2__(*(_WORD *)&v23[2 * (v25 - v21) + 6], 8);
          v27 = v26;
          if ( v26 )
          {
            v28 = v11++;
