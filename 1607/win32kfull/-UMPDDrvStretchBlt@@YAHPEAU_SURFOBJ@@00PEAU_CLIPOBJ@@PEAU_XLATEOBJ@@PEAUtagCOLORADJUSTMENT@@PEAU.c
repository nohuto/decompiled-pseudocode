/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02A1220
 * Callers:
 *     <none>
 * Callees:
              ...
              if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[9], 8u) )
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[10], 0x10u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[11], 0x10u) )
                  {
                    ...
                    {
                      LODWORD(Size) = 4;
                      if ( (unsigned int)UMPDOBJ::Thunk(v16, Src, 128LL, &v23, Size) != -1 )
                      {
                        if ( v23 )
                          v20 = 1;
                      }
