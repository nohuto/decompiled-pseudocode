/*
 * XREFs of GreGetUFIPathname @ 0x1C026786C
 * Callers:
 *     NtGdiGetUFIPathname @ 0x1C02A8A20 (NtGdiGetUFIPathname.c)
 * Callees:
 *     memmove @ 0x1C015A040 (memmove.c)
 *     ?ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C0266D4C (-ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z.c)
 */
        ...
        unsigned int *a11)
{
  ...
  if ( !Address )
    goto LABEL_18;
  if ( MmMapViewInSessionSpace(*(PVOID *)(**(_QWORD **)(v17 + 152) + 32LL), &MappedBase, ViewSize) < 0 )
    return 0LL;
  ...
  if ( a10 )
  {
    if ( a11 )
    {
      ...
      *a11 = 0;
      ...
      if ( v22 == gppdevTrueType || v22 == (struct PDEV *)qword_1C0334780 && !*(_DWORD *)(*(_QWORD *)(v21 + 80) + 8LL) )
      {
        v23 = *(_DWORD *)(v21 + 144);
        if ( v23 >= 4 && (v23 & 1) == 0 )
        {
