/*
 * XREFs of ?TraceLoggingScreenOrientationArStateChangeEvent@@YAXKW4arInitiatedBy@@W4tagAR_STATE@@@Z @ 0x1C021EFEC
 * Callers:
...
void TraceLoggingScreenOrientationArStateChangeEvent()
{
  ...
  if ( dword_1C0320840 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0320840, 0x400000000000uLL) )
    {
      ...
      v5 = (int)v0;
      v14 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320840, &unk_1C02EF00D, 0LL, v0, 6u, &pData);
    }
  }
}
