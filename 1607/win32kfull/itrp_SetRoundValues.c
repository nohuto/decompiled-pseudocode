/*
 * XREFs of itrp_SetRoundValues @ 0x1C010CD18
 * Callers:
 *     itrp_SROUND @ 0x1C010CC40 (itrp_SROUND.c)
 *     itrp_S45ROUND @ 0x1C02E1120 (itrp_S45ROUND.c)
 * Callees:
 *     <none>
 */
...
__int16 __fastcall itrp_SetRoundValues(char a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v5 )
    {
      if ( v5 == 64 )
      {
        *(_WORD *)(qword_1C03294E0 + 142) = 128;
        goto LABEL_5;
      }
      v4 = 999;
    }
    *(_WORD *)(qword_1C03294E0 + 142) = v4;
LABEL_5:
    *(_DWORD *)(v2 + 136) = ~(*(__int16 *)(v2 + 142) - 1);
    goto LABEL_6;
  }
  *(_WORD *)(qword_1C03294E0 + 140) = 11591;
  if ( (a1 & 0xC0) == 0 )
  {
    v10 = 5795;
LABEL_24:
