/*
 * XREFs of _GetUserObjectInformation @ 0x1C00772AC
 * Callers:
...
__int64 __fastcall GetUserObjectInformation(HANDLE Handle, int a2, _DWORD *a3, unsigned int a4, int *a5)
{
  ...
  const void **v29; // [rsp+48h] [rbp-70h]
  PVOID v30; // [rsp+50h] [rbp-68h] BYREF
  PVOID v31; // [rsp+60h] [rbp-58h]
  struct _OBJECT_HANDLE_INFORMATION HandleInformation; // [rsp+68h] [rbp-50h] BYREF
  PVOID v33; // [rsp+70h] [rbp-48h]
  _DWORD *v34; // [rsp+78h] [rbp-40h]
  unsigned int v35; // [rsp+C0h] [rbp+8h]

  v35 = (unsigned int)Handle;
  v8 = 1;
  v9 = 0;
  v10 = 0;
...
LABEL_5:
    if ( (unsigned int)(a2 - 5) <= 1 && ObjectType != ExDesktopObjectType )
      goto LABEL_44;
    v11 = ObReferenceObjectByHandle(Handle, v13, (POBJECT_TYPE)ObjectType, 1, &v30, &HandleInformation);
    v14 = v30;
    v33 = v30;
    if ( v11 >= 0 )
    {
...
LABEL_11:
        ...
        if ( v21 )
        {
          ...
          if ( v22 )
          {
            ...
            if ( a4 >= 4 )
            {
              LOBYTE(v9) = v30 == (PVOID)grpdeskRitInput;
              *a3 = v9;
              goto LABEL_41;
            }
          }
      ...
      else
      {
        ...
        if ( a4 >= 0xC )
        {
          ...
          *(_QWORD *)(a3 + 1) = 0LL;
          if ( ObjectType == ExDesktopObjectType )
          {
            if ( (unsigned int)CheckHandleFlag(0LL, *v14, v35, 0) )
              a3[2] |= 1u;
          }
          else if ( (v14[8] & 4) == 0 )
          {
