/*
 * XREFs of ?TPAAPShouldAllowMoveNow@@YAHPEAUtagTPSTATE@@PEAUtagTPCONTACTSTATE@@PEAH@Z @ 0x1C01E88B0
 * Callers:
...
LABEL_6:
  ...
  if ( *((_DWORD *)a1 + 416) != 2 )
  {
    if ( v8 && (*((_DWORD *)a2 + 66) & 0x1000) != 0 )
      return 0LL;
    PerformanceCounter = KeQueryPerformanceCounter(0LL);
    if ( (__int64)((unsigned __int64)(1000 * (PerformanceCounter.QuadPart - *((_QWORD *)a2 + 7))) / gliQpcFreq.QuadPart) < (unsigned int)dword_1C03290F8 )
      return 0LL;
    v13 = (unsigned __int64)(1000 * (PerformanceCounter.QuadPart - *((_QWORD *)a1 + 261))) / gliQpcFreq.QuadPart;
    if ( v7 || (v14 = TPAAPGetLevel((__int64)a1), v15 < dword_1C03290DC[v14]) )
    {
      v16 = 0;
      if ( v7 )
      {
LABEL_20:
    ...
    if ( v13 <= (unsigned int)dword_1C03290F0 || v16 )
      return 1LL;
    goto LABEL_20;
  }
  if ( v8 && !v9 )
