/*
 * XREFs of NtGdiGetCharABCWidthsW @ 0x1C00FFA00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCharABCWidthsW(HDC a1, __int64 a2, __int64 a3, char *a4, int a5, char *a6)
{
  __int64 v6; // rsi
  ...
  if ( a4 )
  {
    ...
    if ( (unsigned int)(a3 - 1) <= 0x1387FFF )
      v9 = PALLOCMEM2((unsigned int)(2 * a3), 1886221383LL, 0);
  }
  if ( !v10 || v9 )
  {
