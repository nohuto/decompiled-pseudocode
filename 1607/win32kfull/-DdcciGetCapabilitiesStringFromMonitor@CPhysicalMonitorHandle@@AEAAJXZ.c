/*
 * XREFs of ?DdcciGetCapabilitiesStringFromMonitor@CPhysicalMonitorHandle@@AEAAJXZ @ 0x1C02589AC
 * Callers:
 ...
 *     ?RtlStringCbCopyA@@YAJPEAD_KPEBD@Z @ 0x1C025977C (-RtlStringCbCopyA@@YAJPEAD_KPEBD@Z.c)
 */
