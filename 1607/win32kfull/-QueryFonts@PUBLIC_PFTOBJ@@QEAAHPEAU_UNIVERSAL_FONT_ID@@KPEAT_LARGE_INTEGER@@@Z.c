/*
 * XREFs of ?QueryFonts@PUBLIC_PFTOBJ@@QEAAHPEAU_UNIVERSAL_FONT_ID@@KPEAT_LARGE_INTEGER@@@Z @ 0x1C025A194
 * Callers:
 *     GreQueryFonts @ 0x1C0267A50 (GreQueryFonts.c)
 * Callees:
