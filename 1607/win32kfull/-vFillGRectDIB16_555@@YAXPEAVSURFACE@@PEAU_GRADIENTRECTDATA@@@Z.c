/*
 * XREFs of ?vFillGRectDIB16_555@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02CD0D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vFillGRectDIB16_555(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
  ...
  unsigned __int64 v34; // [rsp+10h] [rbp-B8h]
  ...
  if ( v4 < v6 )
  {
    ...
    do
    {
      ...
      v17 = v9;
      v18 = v10;
      v40 = 0x1C0000000LL + 16LL * v16 + 3302752;
      v19 = v11;
      if ( (_DWORD)v15 )
      {
        v17 = v9 + v5 * v15;
