/*
 * XREFs of NtGdiEngAssociateSurface @ 0x1C02AC9F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidUmpdHdev@@YAHPEAUHDEV__@@@Z @ 0x1C02AB5B8 (-ValidUmpdHdev@@YAHPEAUHDEV__@@@Z.c)
 *     ?ValidUmpdHooks@@YAHPEAVPDEVOBJ@@K@Z @ 0x1C02AB674 (-ValidUmpdHooks@@YAHPEAVPDEVOBJ@@K@Z.c)
 */
