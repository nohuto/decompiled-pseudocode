/*
 * XREFs of ?bHookBmpDrv@@YAHAEAVXDCOBJ@@@Z @ 0x1C028C7A4
 * Callers:
        ...
        if ( ((v3[14] & 0x20000000) != 0 || (v3[538] & 0x8000) != 0) && (v3[538] & 0x1000) != 0 )
        {
            ...
            && (gpBmpDev = (struct PDEV *)PALLOCMEM2(v7, 1986348103LL, 1), (v6 = gpBmpDev) != 0LL) )
          {
            if ( *(struct PDEV **)(*(_QWORD *)a1 + 48LL) != v6 )
            {
              ...
              *((_QWORD *)v15 + 442) = v3;
              *((_QWORD *)v14 + 12) = v14;
              *((_QWORD *)gpBmpDev + 362) = BmpDevTextOut;
              *((_QWORD *)gpBmpDev + 353) = BmpDevStrokePath;
              *((_QWORD *)gpBmpDev + 358) = BmpDevCopyBits;
              *((_QWORD *)gpBmpDev + 357) = BmpDevBitBlt;
              *((_QWORD *)gpBmpDev + 370) = BmpDevLineTo;
              *((_QWORD *)gpBmpDev + 354) = BmpDevFillPath;
              *((_QWORD *)gpBmpDev + 355) = BmpDevStrokeAndFillPath;
              *((_QWORD *)gpBmpDev + 359) = BmpDevStretchBlt;
              *((_QWORD *)gpBmpDev + 410) = BmpDevAlphaBlend;
              *((_QWORD *)gpBmpDev + 413) = BmpDevTransparentBlt;
              *((_QWORD *)gpBmpDev + 407) = BmpDevGradientFill;
              *((_QWORD *)gpBmpDev + 429) = BmpDevDrawStream;
              *((_QWORD *)gpBmpDev + 430) = BmpDevNineGrid;
              *((_QWORD *)gpBmpDev + 409) = BmpDevPlgBlt;
