/*
 * XREFs of ?UMPDDrvLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C029F120
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  if ( v25 )
  {
    if ( !*((_DWORD *)v25 + 109)
      || (v19 = 152,
          v15 = UMPDOBJ::bThunkLargeBitmap(v25, a1, &v24, &v23, &v21, &v20, &v19),
          v11 = v20,
          v16 = v15,
          (v19 = v15) != 0) )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), (struct _SURFOBJ **)&Src[3], v11)
        ...
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v14, Src, 80LL, &v19, Size) == -1)
        || (v16 = 1, !v19) )
      {
        v16 = 0;
      }
    ...
    if ( v21 )
      UMPDOBJ::RestoreBitmap(v14, a1, v24, v23, Size, v11);
    v9 = v16;
  }
