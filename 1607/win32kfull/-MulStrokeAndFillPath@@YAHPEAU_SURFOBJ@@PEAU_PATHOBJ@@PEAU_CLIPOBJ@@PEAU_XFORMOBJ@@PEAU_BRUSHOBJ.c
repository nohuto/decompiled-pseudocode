/*
 * XREFs of ?MulStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C0296E80
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v29[0] )
    {
      ...
      for ( i = MSURF::bFindSurface((MSURF *)v24, a1, a3, &v32); i; i = MSURF::bNextSurface((MSURF *)v24) )
      {
        ...
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v26) + 112) & 0x80u) == 0 )
          ...
          v19 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, LINEATTRS *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*((_QWORD *)v25 + 7) + 2840LL);
