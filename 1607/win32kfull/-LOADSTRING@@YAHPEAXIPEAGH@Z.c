/*
 * XREFs of ?LOADSTRING@@YAHPEAXIPEAGH@Z @ 0x1C011F1F4
 * Callers:
 *     InitializeScripts @ 0x1C037D000 (InitializeScripts.c)
 * Callees:
 *     pvFindResource @ 0x1C0111FF4 (pvFindResource.c)
...
__int64 __fastcall LOADSTRING(__int64 a1, unsigned int a2, unsigned __int16 *a3, int a4)
{
  ...
  v14 = 0;
  v6 = a2;
  Resource = pvFindResource(a1, 0xFFFFFFFFFFFFFFFFuLL, (a2 >> 4) + 1, 6, (int *)&v14);
