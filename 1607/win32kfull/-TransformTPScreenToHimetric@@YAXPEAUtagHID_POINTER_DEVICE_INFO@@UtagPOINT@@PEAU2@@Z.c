/*
 * XREFs of ?TransformTPScreenToHimetric@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@PEAU2@@Z @ 0x1C01E8D18
 * Callers:
        ...
        __int64 a4)
{
  ...
  a3->x = EngMulDiv(a2.x - v19, *((_DWORD *)a1 + 37), _mm_cvtsi128_si32(_mm_srli_si128(v18, 8)) - v19);
  v20 = _mm_cvtsi128_si32(_mm_srli_si128(v18, 4));
  a3->y = EngMulDiv(a2.y - v20, *((_DWORD *)a1 + 38), _mm_cvtsi128_si32(_mm_srli_si128(v18, 12)) - v20);
}
