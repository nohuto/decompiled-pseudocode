/*
 * XREFs of ?GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z @ 0x1C01C2AC8
 * Callers:
 ...
 *     ?GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01C2A38 (-GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 */
...
__int64 __fastcall GetTiltKeyName(struct _UNICODE_STRING *a1, unsigned __int16 **a2)
{
  ...
  unsigned __int16 *v13; // [rsp+60h] [rbp+20h] BYREF
  ...
  *a2 = 0LL;
  ...
  v14 = 0LL;
  v12 = v2;
  DeviceId = GetDeviceId(&v12, &v13, &v15);
  if ( DeviceId < 0 )
    goto LABEL_11;
  v12 = *a1;
  ...
  *a2 = v9;
  if ( !v9 )
    return 3221225628LL;
  DeviceId = RtlStringCchCopyNW((char *)v9, v8 + 1, (char *)v13, v8);
  if ( DeviceId < 0 )
  {
LABEL_11:
    if ( *a2 )
