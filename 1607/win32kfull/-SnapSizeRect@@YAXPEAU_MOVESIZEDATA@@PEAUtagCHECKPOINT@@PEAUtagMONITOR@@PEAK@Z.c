/*
 * XREFs of ?SnapSizeRect@@YAXPEAU_MOVESIZEDATA@@PEAUtagCHECKPOINT@@PEAUtagMONITOR@@PEAK@Z @ 0x1C01FD52C
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  v8 = ComputeSizeOutcome(*(struct tagPOINT *)((char *)a1 + 276), (__int64)a1, &v12, &v13) - 2;
  if ( v8 )
  {
    v9 = v8 - 1;
    if ( v9 )
  ...
  {
    VerticalSizeRectFromHitTarget(a1, v12, v13, a3, *((_DWORD *)a1 + 69));
  }
}
