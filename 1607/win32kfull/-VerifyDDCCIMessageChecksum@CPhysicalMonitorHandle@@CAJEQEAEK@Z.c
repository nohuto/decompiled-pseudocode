/*
 * XREFs of ?VerifyDDCCIMessageChecksum@CPhysicalMonitorHandle@@CAJEQEAEK@Z @ 0x1C02597E4
 * Callers:
 ...
 * Callees:
 *     ?ComputeDDCCIMessageChecksum@CPhysicalMonitorHandle@@CAEEQEAEK@Z @ 0x1C02586E8 (-ComputeDDCCIMessageChecksum@CPhysicalMonitorHandle@@CAEEQEAEK@Z.c)
 */
...
LABEL_13:
  ...
  v7 = CPhysicalMonitorHandle::ComputeDDCCIMessageChecksum(0x6Fu, a2, v6 - 1);
