/*
 * XREFs of SetManifestWinVer @ 0x1C0101360
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C0101414 (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C0101464 (SbGetContextDetailsByGuid.c)
 */
