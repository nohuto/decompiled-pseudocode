/*
 * XREFs of ComputeRGBLUTAA @ 0x1C00F57F4
 * Callers:
...
__int64 __fastcall ComputeRGBLUTAA(_DWORD *a1, __int128 *a2, _DWORD *a3)
{
  ...
  unsigned int v110; // [rsp+6Ch] [rbp-94h]
  ...
  if ( *a3 != v31 )
  {
    ...
    *((_WORD *)v3 + 3528) = 256;
    ...
    while ( 1 )
    {
      ...
      v97 = *((_DWORD *)v44 - 4);
      v107 = *(&v138 + (unsigned __int8)*v117);
      v92 = v141[v45];
      DWORD1(v120) = v92;
      v109 = *((_BYTE *)&v119 + v45 + 1);
      v105 = *((_DWORD *)&v119 + v45 + 2);
      v115 = (&v142)[v45];
      v46 = 0;
      v93 = 0;
      do
...
LABEL_51:
        ...
        if ( v115 )
        {
          ...
          v51 = v92 + MulFD6(v71, 4095LL) + ((_DWORD)v69 << 12);
        }
        else
        {
          v51 = v92 + MulFD6((unsigned int)v49, v105);
        }
        v52 = ((v51 & v108) << v109) | MulFD6(v106 & v51, v107);
        if ( v49 > v40 )
        {
          v72 = DivFD6((unsigned int)(v49 - v40), v110);
