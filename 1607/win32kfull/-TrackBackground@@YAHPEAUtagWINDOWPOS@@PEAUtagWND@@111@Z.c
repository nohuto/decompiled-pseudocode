/*
 * XREFs of ?TrackBackground@@YAHPEAUtagWINDOWPOS@@PEAUtagWND@@111@Z @ 0x1C00A53E8
 * Callers:
 ...
 *     ?IsLastTopMostWindow@@YAHPEAUtagWND@@@Z @ 0x1C0130FEC (-IsLastTopMostWindow@@YAHPEAUtagWND@@@Z.c)
 */
  ...
  if ( v10 )
  {
    if ( !a5 || *(_QWORD *)(*((_QWORD *)a2 + 2) + 384LL) != gpqForeground || !(unsigned int)IsLastTopMostWindow(v10) )
    {
      if ( !(unsigned int)IsLastTopMostWindow(v10) && a4 == GetRootOwner(a2) )
      {
        ...
        if ( *(_QWORD *)(v13 + 1248) )
        {
          if ( *(_QWORD *)(v13 + 384) == *(_QWORD *)v12 && a4 == *(struct tagWND **)(*(_QWORD *)v12 + 88LL) )
