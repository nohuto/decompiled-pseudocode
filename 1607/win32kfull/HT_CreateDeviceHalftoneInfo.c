/*
 * XREFs of HT_CreateDeviceHalftoneInfo @ 0x1C00F4C14
 * Callers:
 ...
 *     GetCIEPrims @ 0x1C00F511C (GetCIEPrims.c)
 ...
 *     CleanUpDHI @ 0x1C012B810 (CleanUpDHI.c)
...
LABEL_14:
  ...
  *((_WORD *)v4 + 114) = WORD1(v79[6]);
  ...
  else
  {
    ...
    if ( v12 )
    {
      v33 = *((unsigned __int16 *)v4 + 115) * *((unsigned __int16 *)v4 + 115);
      v34 = (unsigned int)(2 * v12 * v12);
      v80[1] = v34;
      v35 = DivFD6((unsigned int)(v17 * v17 + v33), v34);
      v18 = RaisePower(v35, 2LL, 3LL);
      v10 = 1;
      goto LABEL_21;
    }
  }
