/*
 * XREFs of SetWindowCompositionVideoOverlayActive @ 0x1C0224B18
 * Callers:
...
__int64 __fastcall SetWindowCompositionVideoOverlayActive(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v12[0], 8) == v5 )
      return 0;
    v12[0] ^= (LOBYTE(v12[0]) ^ (unsigned __int8)((_BYTE)v5 << 7)) & 0x80;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 14, a2);
    }
  }
  return v4;
}
