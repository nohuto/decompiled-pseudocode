/*
 * XREFs of ?DrawWindowShadow@@YAHPEAUtagWND@@PEAUHDC__@@HHPEAH@Z @ 0x1C013933C
 * Callers:
...
__int64 __fastcall DrawWindowShadow(__m128i *a1, HDC a2, int a3, int a4, int *a5)
{
  ...
  if ( RectRgn && v11 )
  {
    if ( !a1[12].m128i_i64[1] || (a1[2].m128i_i8[13] & 8) != 0 )
    {
      GreSetRectRgn(
        RectRgn,
        0LL,
        0LL,
        (unsigned int)(_mm_cvtsi128_si32(_mm_srli_si128(a1[7], 8)) - _mm_cvtsi128_si32(a1[7])),
        HIDWORD(*(_OWORD *)&a1[7]) - HIDWORD(a1[7].m128i_i64[0]));
      v13 = a5;
      v9 = 1;
      *a5 = 1;
    }
    ...
    {
      SetRectRgnIndirect(RectRgn, &a1[7]);
      v9 = 1;
      GreCombineRgn(RectRgn, RectRgn, a1[12].m128i_i64[1], 1LL);
      GreOffsetRgn(RectRgn, (unsigned int)-a1[7].m128i_i32[0], (unsigned int)-a1[7].m128i_i32[1]);
      v13 = a5;
      *a5 = 0;
    }
    v14 = 5;
    ...
    if ( !*v13 || a4 )
    {
      v17 = (unsigned __int8 *)&unk_1C02EDED8;
      while ( 1 )
      {
        SolidBrush = GreCreateSolidBrush(*v17 | (*v17 << 16) | (*v17 << 8));
        if ( !SolidBrush )
          break;
        NtGdiFrameRgn(a2, v14);
