/*
 * XREFs of ?TPAAPShouldAllowNow@@YAHKHHPEAUtagTPSTATE@@@Z @ 0x1C01E8A00
 * Callers:
...
LABEL_6:
  ...
  v13 = _InterlockedCompareExchange64(&qword_1C0329110, v12, 0LL);
  v19 = _InterlockedCompareExchange64(&qword_1C0329118, v12, 0LL);
  v5 = v19;
  if ( v13 <= 0 )
    goto LABEL_6;
  if ( v19 <= v13 )
