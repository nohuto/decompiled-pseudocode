/*
 * XREFs of ?TooltipAnimate@@YAHPEAUtagTOOLTIPWND@@@Z @ 0x1C02277F8
 * Callers:
...
__int64 __fastcall TooltipAnimate(struct tagTOOLTIPWND *a1)
{
  ...
  v7 = (int)(v5
           * (((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24) - *((_DWORD *)a1 + 98))
           + 67)
     / 135;
  if ( (unsigned int)((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24)
    ...
    || v7 == v5 )
  {
    NtGdiBitBltInternal(TooltipDC, 0, 0, v6, v5, *((HDC *)a1 + 46), 0, 0, 0x80CC0020, 0, 0);
    v1 = 1;
  }
  else if ( *((_DWORD *)a1 + 99) != v7 )
  {
    if ( (*((_DWORD *)a1 + 96) & 1) != 0 )
    {
      v8 = 0;
