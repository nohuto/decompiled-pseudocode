/*
 * XREFs of ?WritePredictionSettings@@YAHPEAUtagDEVICECONFIG_SETTING@@KPEBGK@Z @ 0x1C0225A0C
 * Callers:
...
__int64 __fastcall WritePredictionSettings(
        ...
        const unsigned __int16 *a3)
{
  ...
  *(_DWORD *)&v9.Length = 45875200;
  v9.Buffer = (PWSTR)&v11;
  v3 = 0;
  if ( RtlUnicodeStringCopyString(&v9, a2) < 0 )
    return 0;
  if ( (int)RtlUnicodeStringCatString(&v9, L"\\Software\\Microsoft\\TouchPrediction") < 0 )
    return 0;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  do
  {
    v6 = WritePointerDeviceCfgSetting(KeyHandle, *v4, 4u, (unsigned __int8 *)&dword_1C0320BFC[4 * v3], 4u);
    if ( v6 < 0 )
      break;
    ++v3;
    v4 += 2;
