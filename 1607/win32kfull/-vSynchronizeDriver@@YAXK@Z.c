/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C00FA0AC
 * Callers:
 *     GreFlush @ 0x1C00FA0A0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C028F930 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
