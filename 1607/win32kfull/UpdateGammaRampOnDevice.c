/*
 * XREFs of UpdateGammaRampOnDevice @ 0x1C01074B0
 * Callers:
...
__int64 __fastcall UpdateGammaRampOnDevice(__int64 a1, int a2)
{
  ...
  if ( a1 )
  {
    ...
    {
      if ( *(_QWORD *)(a1 + 3248) && (*(_DWORD *)(a1 + 2152) & 0x10) != 0 )
      {
        if ( *(_QWORD *)(a1 + 1728) )
          return (*(unsigned int (__fastcall **)(_QWORD, __int64))(a1 + 3248))(*(_QWORD *)(a1 + 1824), 1LL);
      }
      else if ( v4 == 3 && (*(_DWORD *)(a1 + 2196) & 0x100) != 0 && (a2 || *(_QWORD *)(a1 + 1728)) )
      {
        ...
        *(_QWORD *)(v8 + 64) = a1;
        ...
        {
          v7 = *(__int64 (__fastcall **)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))(a1 + 2888);
          if ( v7 )
