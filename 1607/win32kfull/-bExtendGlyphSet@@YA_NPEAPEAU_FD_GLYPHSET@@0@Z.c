/*
 * XREFs of ?bExtendGlyphSet@@YA_NPEAPEAU_FD_GLYPHSET@@0@Z @ 0x1C02B62B8
 * Callers:
...
char __fastcall bExtendGlyphSet(struct _FD_GLYPHSET **a1, struct _FD_GLYPHSET **a2)
{
  ...
  if ( v10 )
  {
    ...
    if ( (unsigned int)ConvertToAndFromWideChar(v19, v43, 2 * v6, v42, 0x100u, 0) == -1 )
    {
    ...
    do
    {
      if ( *(_WORD *)v25 >= 0xF020u )
        break;
      *(_WORD *)&v26[v25] = *(_WORD *)v25;
      *(_WORD *)&v26[v25 + 2] = *(_WORD *)(v25 + 2);
      *(_QWORD *)&v26[v25 + 8] = v24;
      memmove(v24, *(const void **)(v25 + 8), 4LL * *(unsigned __int16 *)(v25 + 2));
    ...
    *(_DWORD *)&v10->awcrun[v28].wcLow = 14741536;
    ...
    do
    {
      for ( i = 0; i < *v30; ++i )
      {
        v33 = v42[v29];
        if ( v33 >= 0x20u )
          *(_DWORD *)&v24[4 * v33 - 128] = *(_DWORD *)(*(_QWORD *)(v30 + 3) + 4LL * i);
        ++v29;
      }
      v30 += 8;
      --v31;
    ...
    if ( v23 < (unsigned int)v4 )
    {
      ...
      v36 = (__int64)&v10[1].cjThis + 16 * v23 + 2;
      v37 = (unsigned int)v4 - v23;
      do
      {
        *(_WORD *)(v36 - 2) = *(v35 - 1);
        *(_WORD *)v36 = *v35;
