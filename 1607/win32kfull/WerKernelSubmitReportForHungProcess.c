/*
 * XREFs of WerKernelSubmitReportForHungProcess @ 0x1C0249348
 * Callers:
 *     ?WerSubmitReportWorker@@YAXPEAX@Z @ 0x1C0226600 (-WerSubmitReportWorker@@YAXPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0158CD0 (__security_check_cookie.c)
 *     memset @ 0x1C015A380 (memset.c)
 *     WerStartSystemErrorHandler @ 0x1C024966C (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C0249774 (WerWaitForSystemErrorHandler.c)
 *     WerpAllocateAndInitializeSid @ 0x1C024981C (WerpAllocateAndInitializeSid.c)
 *     WerpFreeMem @ 0x1C0249930 (WerpFreeMem.c)
 */
...
LABEL_4:
    ...
    v26 = 0LL;
    v28 = 0LL;
    started = ZwAlpcConnectPort(&Handle, &DestinationString, &v24, v30, 0x20000, v19, 0LL, 0LL, 0LL, 0LL, 0LL);
    v6 = started;
    if ( started < 0 )
    {
      v8 = 1432LL;
