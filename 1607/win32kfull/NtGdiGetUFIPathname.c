/*
 * XREFs of NtGdiGetUFIPathname @ 0x1C02A8A20
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a10)
{
  ...
  __int64 v26; // [rsp+80h] [rbp-298h] BYREF
  _DWORD *v27; // [rsp+88h] [rbp-290h] BYREF
  char *v28; // [rsp+90h] [rbp-288h]
  int v29[2]; // [rsp+98h] [rbp-280h] BYREF
  _DWORD *v30; // [rsp+A0h] [rbp-278h]
  ...
  *(_QWORD *)v29 = *v12;
  ...
  UFIPathname = GreGetUFIPathname(
                  ...
                  &v25,
                  Address,
                  (_DWORD *)((unsigned __int64)&v27 & -(__int64)(a9 != 0LL)),
