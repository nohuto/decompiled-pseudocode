/*
 * XREFs of NtUserMoveWindow @ 0x1C00A7900
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v10 )
  {
    ...
    if ( (v12 & 0xFFFFFFFD) != 0 )
    {
      ...
      *(_QWORD *)(gptiCurrent + 368LL) = v28;
      ...
      if ( (*(_BYTE *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), gptiCurrent, v13, v14) + 432)
                     + 224LL) & 1) == 0 )
      {
        v22 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v18, v19, v20) + 432);
        if ( (*(_BYTE *)(v22 + 224) & 0x20) == 0
          && (W32GetCurrentThreadDpiAwarenessContext(v22, v21, v23, v24) & 0xF) != (*(_DWORD *)(v16 + 352) & 0xF) )
        {
          v29 = a2;
          v31 = a4 + a2;
          v30 = a3;
      ...
      v15 = xxxMoveWindow((struct tagWND *)v16, (unsigned int)a2, (unsigned int)a3, (unsigned int)a4, v15, a6);
