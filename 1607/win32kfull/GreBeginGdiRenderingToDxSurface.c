/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x1C0005D58
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x1C0005D50 (NtGdiBeginGdiRendering.c)
 * Callees:
 *     ?bReset@DC@@QEAAHXZ @ 0x1C0005F10 (-bReset@DC@@QEAAHXZ.c)
      ...
      *(_WORD *)(v14 + 102) &= ~0x200u;
      if ( v10 )
      {
        ...
        if ( v8 )
        {
          ...
          {
            v11 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64))(v9 + 3504);
            v8 = 0;
            if ( v11 )
            {
              v12 = v11(v7 + 24, a2, a3);
