/*
 * XREFs of ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C026242C
 * Callers:
 *     draw_clrt_f_ntb_o_to_temp_start @ 0x1C0262A80 (draw_clrt_f_ntb_o_to_temp_start.c)
 * Callees:
 *     <none>
 */
...
LABEL_20:
    ...
    while ( 1 )
    {
      ...
      if ( v17 )
      {
        v18 = LOBYTE(v13[v15]) + LOBYTE(v13[v17]);
        v19 = BYTE1(v13[v15]) + BYTE1(v13[v17]);
        v20 = BYTE2(v13[v15]) + BYTE2(v13[v17]);
        if ( v18 > 6 )
          v18 = 6;
        if ( v19 > 6 )
          v19 = 6;
