/*
 * XREFs of NtUserfnOUTLBOXSTRING @ 0x1C014C860
 * Callers:
 *     <none>
 * Callees:
        ...
        int a7)
{
  ...
  if ( (unsigned __int64)(a1 - 2) > 0xFFFFFFFFFFFFFFFBuLL )
    return -1LL;
  v10 = NtUserfnGETDBCSTEXTLENGTHS(a1, 394LL, a3, (__int64)a4, a5, a6, a7);
  v11 = -1LL;
  if ( v10 != -1 )
  {
    v12 = v10 + 1;
...
LABEL_12:
    v11 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64, int *, __int64))mpFnidPfn[(a6 + 6) & 0x1F])(
            a1,
            a2,
            a3,
            &v21,
