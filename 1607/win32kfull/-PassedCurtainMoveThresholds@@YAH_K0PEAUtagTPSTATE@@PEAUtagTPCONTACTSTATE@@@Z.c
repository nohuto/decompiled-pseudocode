/*
 * XREFs of ?PassedCurtainMoveThresholds@@YAH_K0PEAUtagTPSTATE@@PEAUtagTPCONTACTSTATE@@@Z @ 0x1C01E81F0
 * Callers:
        ...
        struct tagTPCONTACTSTATE *a4)
{
  ...
  v4 = 0;
  if ( !gliQpcFreq.QuadPart || a2 - a1 > gliQpcFreq.QuadPart * (unsigned __int64)(unsigned int)dword_1C0328150 / 0x3E8 )
    return 0LL;
  v6 = *((_QWORD *)a3 + 216);
  LOBYTE(v4) = (int)((HIDWORD(v6) - HIDWORD(*((_QWORD *)a4 + 1))) * (HIDWORD(v6) - HIDWORD(*((_QWORD *)a4 + 1)))
                   + (v6 - *((_QWORD *)a4 + 1)) * (v6 - *((_QWORD *)a4 + 1))) > (unsigned __int64)(unsigned int)dword_1C0328154;
  return v4;
}
