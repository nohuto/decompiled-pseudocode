/*
 * XREFs of ?ptransMatchAPal@@YAPEAU_TRANSLATE@@PEAVDC@@VXEPALOBJ@@1HPEAK2@Z @ 0x1C02B7258
 * Callers:
 ...
 *     ?ColorMatch@@YAKVXEPALOBJ@@T_PAL_ULONG@@PEAK@Z @ 0x1C02B7124 (-ColorMatch@@YAKVXEPALOBJ@@T_PAL_ULONG@@PEAK@Z.c)
 */
...
_DWORD *__fastcall ptransMatchAPal(__int64 a1, __int64 a2, __int64 a3, int a4, _DWORD *a5, _DWORD *a6)
{
  ...
  if ( result )
  {
    ...
    if ( *(_DWORD *)(v14 + 28) )
    {
      ...
      {
        v20 = v34;
        v32 = *(_DWORD *)(*(_QWORD *)(v14 + 120) + 4 * v18);
