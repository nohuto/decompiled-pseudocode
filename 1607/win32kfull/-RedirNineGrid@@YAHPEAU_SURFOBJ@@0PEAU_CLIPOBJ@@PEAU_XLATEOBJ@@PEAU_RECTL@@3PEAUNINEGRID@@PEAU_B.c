/*
 * XREFs of ?RedirNineGrid@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAUNINEGRID@@PEAU_BLENDOBJ@@PEAX@Z @ 0x1C028DE20
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a9)
{
  ...
  struct SURFACE *v24[2]; // [rsp+68h] [rbp-71h] BYREF
