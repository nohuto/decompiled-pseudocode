/*
 * XREFs of ?RemoveProcRequest@@YAXPEAUtagPROCESSINFO@@PEAUtagPROCESS_HID_REQUEST@@KH@Z @ 0x1C01CC0E8
 * Callers:
...
void __fastcall RemoveProcRequest(
        struct tagPROCESS_HID_TABLE **a1,
        struct tagPROCESS_HID_REQUEST *a2,
        int a3,
        unsigned int a4)
{
  int v8; // edi
  ...
  if ( v8 )
  {
    ...
    {
      if ( v9 == 1 )
        DerefExcludeRequest(a2, a4, 0LL);
    }
    else
    {
      DerefPageOnlyRequest(a2, a1[97], 0);
    }
  }
  else
  {
    DerefIncludeRequest(a2, a1[97], a4, 0);
  }
  v10 = *(_QWORD *)a2;
