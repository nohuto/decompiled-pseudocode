/*
 * XREFs of GetFontResourceInfoInternalW @ 0x1C02D5A74
 * Callers:
    ...
    case 2:
      if ( (_DWORD)v8 )
      {
        ...
        if ( (_DWORD)v16 )
        {
          do
          {
            vIFIMetricsToLogFontW((__int64)a6 + v11, *(_QWORD *)(*((_QWORD *)v13 + v17 + 28) + 32LL));
            v11 += 92LL;
            ++v17;
          }
...
LABEL_33:
    ...
    case 3:
      if ( (_DWORD)v8 )
      {
        ...
        if ( v14 == gppdevTrueType || v14 == (struct PDEV *)qword_1C0334780 && !*(_DWORD *)(*((_QWORD *)v12 + 10) + 8LL) )
          LODWORD(v11) = 1;
        *a6 = v11;
      }
      goto LABEL_44;
