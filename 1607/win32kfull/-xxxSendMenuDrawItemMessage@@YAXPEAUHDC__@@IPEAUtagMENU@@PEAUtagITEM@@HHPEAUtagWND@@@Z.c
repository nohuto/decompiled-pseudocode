/*
 * XREFs of ?xxxSendMenuDrawItemMessage@@YAXPEAUHDC__@@IPEAUtagMENU@@PEAUtagITEM@@HHPEAUtagWND@@@Z @ 0x1C00B48AC
 * Callers:
 ...
 *     MNInitUAHMenuItem @ 0x1C00B4A14 (MNInitUAHMenuItem.c)
        ...
        struct tagWND *a7)
{
  ...
  if ( v14 && ((*(_DWORD *)a4 & 0x100) != 0 || *((_QWORD *)a4 + 13) == -1LL) )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = &v19;
    ...
    ++*(_DWORD *)(v14 + 8);
    xxxSendMessage(*((struct tagWND **)a3 + 9), 0x2Bu, 0LL, (__int64)v21);
    ThreadUnlock1(v18, v17);
    if ( (unsigned int)MNGetpItemIndex((__int64)a3, (__int64)a4) == -1 )
      v12 = 0;
  }
  if ( v13 )
  {
    if ( a7 || (v7 = (struct tagWND *)*((_QWORD *)a3 + 9)) != 0LL )
    {
      ...
      *(_QWORD *)(gptiCurrent + 368LL) = &v19;
      v20 = v7;
      ++*((_DWORD *)v7 + 2);
      xxxSendMessage(v7, 0x92u, 0LL, (__int64)v21);
