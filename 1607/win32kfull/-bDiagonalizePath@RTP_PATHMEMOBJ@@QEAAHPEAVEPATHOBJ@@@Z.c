/*
 * XREFs of ?bDiagonalizePath@RTP_PATHMEMOBJ@@QEAAHPEAVEPATHOBJ@@@Z @ 0x1C02BB550
 * Callers:
 ...
 *     ?bFetchSubPath@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C02BB8E8 (-bFetchSubPath@RTP_PATHMEMOBJ@@AEAAHXZ.c)
 */
