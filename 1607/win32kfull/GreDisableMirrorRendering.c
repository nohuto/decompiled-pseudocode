/*
 * XREFs of GreDisableMirrorRendering @ 0x1C0278780
 * Callers:
 *     NtUserSetMirrorRendering @ 0x1C021A0C0 (NtUserSetMirrorRendering.c)
 * Callees:
      ...
      if ( MetaSprite )
      {
        *(_DWORD *)MetaSprite |= 0x100u;
        if ( *(_DWORD *)(v4 + 164) )
        {
          ...
          {
            v8 = v3;
            vSpCreateExMirror(*(HDEV *)(*(_QWORD *)(v4 + 168) + 8LL * v3++));
