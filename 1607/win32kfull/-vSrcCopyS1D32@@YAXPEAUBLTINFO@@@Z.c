/*
 * XREFs of ?vSrcCopyS1D32@@YAXPEAUBLTINFO@@@Z @ 0x1C003D570
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        if ( !v10 )
        {
          ...
          if ( v9 >= 8 )
          {
            ...
            do
            {
              ...
              v9 -= 8;
              v12 = (unsigned __int64)(unsigned __int8)*v7 >> 7;
              v13 = *v7++ & 1;
              *v8 = *((_DWORD *)&v15 + v12);
              v8[1] = *((_DWORD *)&v15 + ((v1 >> 6) & 1));
              v8[2] = *((_DWORD *)&v15 + ((v1 >> 5) & 1));
              v8[3] = *((_DWORD *)&v15 + ((v1 >> 4) & 1));
              v8[4] = *((_DWORD *)&v15 + ((v1 >> 3) & 1));
              v8[5] = *((_DWORD *)&v15 + ((v1 >> 2) & 1));
              v8[6] = *((_DWORD *)&v15 + ((v1 >> 1) & 1));
              v8[7] = *((_DWORD *)&v15 + v13);
              v8 += 8;
              --v11;
            }
