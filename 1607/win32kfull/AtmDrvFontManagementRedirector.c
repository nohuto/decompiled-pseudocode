/*
 * XREFs of AtmDrvFontManagementRedirector @ 0x1C02A5040
 * Callers:
 *     AtmDrvEscapeRedirector @ 0x1C02A5010 (AtmDrvEscapeRedirector.c)
 * Callees:
...
LABEL_14:
  ...
  else if ( a3 != 9488 )
  {
    if ( a3 == 9489 )
    {
      UmfdHostLifeTimeManager::EnsureUmfdHost(0);
