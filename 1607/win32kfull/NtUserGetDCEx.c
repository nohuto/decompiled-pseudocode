/*
 * XREFs of NtUserGetDCEx @ 0x1C0116DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetDCEx(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( !a1 )
  {
    v11 = *(_QWORD **)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v6, v7, v8) + 408)
                                 + 8LL)
                     + 16LL);
    if ( (*(_DWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v13, v14, v15) + 440) & 0x20000000) != 0 )
