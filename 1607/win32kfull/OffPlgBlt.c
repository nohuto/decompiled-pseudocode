/*
 * XREFs of OffPlgBlt @ 0x1C02C359C
 * Callers:
        ...
        int a14)
{
  ...
  __int64 (__fastcall *v30)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, __int64, _DWORD *, _DWORD *, _DWORD *, __int64, int); // [rsp+98h] [rbp-31h]
