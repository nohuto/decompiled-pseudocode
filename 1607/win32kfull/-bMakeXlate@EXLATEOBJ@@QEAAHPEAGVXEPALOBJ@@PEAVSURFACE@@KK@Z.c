/*
 * XREFs of ?bMakeXlate@EXLATEOBJ@@QEAAHPEAGVXEPALOBJ@@PEAVSURFACE@@KK@Z @ 0x1C02B9FE8
 * Callers:
        ...
        if ( (struct PALETTE *)a3 != ppalDefault )
        {
          ...
          if ( (_DWORD)v12 )
          {
            while ( 1 )
            {
              ...
              if ( v28 >= v14 )
                v28 %= v14;
              v29 = *(unsigned int *)(*(_QWORD *)(v21 + 120) + 4LL * v28);
              if ( HIBYTE(*(_DWORD *)(*(_QWORD *)(v21 + 120) + 4LL * v28)) == 2 )
              {
