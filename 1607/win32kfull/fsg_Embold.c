/*
 * XREFs of fsg_Embold @ 0x1C02DF058
 * Callers:
...
__int64 __fastcall fsg_Embold(__int64 a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  v10 = *(_WORD *)(*(_QWORD *)(v5 + 64) + 2LL * (*(__int16 *)(v5 + 80) - 1));
  ...
  v13 = *(_WORD *)(*(_QWORD *)(v5 + 64) + 2LL * (*(__int16 *)(v5 + 80) - 1));
  v14 = *(_QWORD *)(v5 + 8);
        ...
        if ( v41 - (unsigned int)v26 >= 2 )
        {
          ...
          if ( (unsigned int)v26 <= v41 )
          {
            ...
            do
            {
              ...
              EmboldPoint(v26, v33, v39, v40, v32, v29, v42, v20, v22, v23, v21, *(_DWORD *)(v9 + 448), (_QWORD *)v5);
              v32 = v29;
              LODWORD(v26) = v50 + 1;
              v43 = HIDWORD(v42);
              v29 = v42;
