/*
 * XREFs of ?AllocatePagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_KIII@Z @ 0x1C012794C
 * Callers:
 *     Win32AllocPagedLookasideListImpl @ 0x1C0127830 (Win32AllocPagedLookasideListImpl.c)
 * Callees:
