/*
 * XREFs of ?vInitPageToDevice@EXFORMOBJ@@QEAAXAEAVXDCOBJ@@PEAVMATRIX@@@Z @ 0x1C02B34EC
 * Callers:
...
void __fastcall EXFORMOBJ::vInitPageToDevice(EXFORMOBJ *this, struct XDCOBJ *a2, struct MATRIX *a3)
{
  ...
  *(_DWORD *)(*(_QWORD *)this + 20LL) = *(_DWORD *)(*(_QWORD *)a2 + 456LL);
  bFToL(*(float *)(*(_QWORD *)this + 16LL), (_DWORD *)(*(_QWORD *)this + 24LL), 6);
  bFToL(*(float *)(*(_QWORD *)this + 20LL), (_DWORD *)(*(_QWORD *)this + 28LL), v6);
