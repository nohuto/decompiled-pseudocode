/*
 * XREFs of NtGdiGetPath @ 0x1C02A61B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetPath(HDC a1, struct _POINTL *Address, char *a3, unsigned int a4)
{
  ...
  char v14; // dl
  ULONG v15; // ecx
  struct _PATHDATA v17; // [rsp+28h] [rbp-100h] BYREF
  _QWORD v18[2]; // [rsp+38h] [rbp-F0h] BYREF
  DC *v19[7]; // [rsp+48h] [rbp-E0h] BYREF
  int v20; // [rsp+80h] [rbp-A8h] BYREF
  __int64 v21; // [rsp+88h] [rbp-A0h]
  ...
  if ( !v19[0] || (int)v4 < 0 )
    goto LABEL_29;
  if ( !(unsigned int)DC::bInactive(v19[0]) )
  {
    v15 = 1003;
LABEL_30:
    EngSetLastError(v15);
  ...
  EXFORMOBJ::vQuickInit((EXFORMOBJ *)v18, (struct XDCOBJ *)v19, 0x402u);
  if ( !v18[0] )
  {
LABEL_29:
    v15 = 87;
  ...
  XEPATHOBJ::XEPATHOBJ((XEPATHOBJ *)&v20, *((struct HPATH__ **)v19[0] + 21));
  if ( v21 )
  {
    ...
    if ( (int)v4 >= v8 && (unsigned __int64)(int)v4 <= 0x1FFFFFFF )
    {
      ...
      *(_QWORD *)(v21 + 80) = *(_QWORD *)(v21 + 32);
      ...
      while ( 1 )
      {
        ...
        if ( v17.count )
        {
          if ( !EXFORMOBJ::bXform((EXFORMOBJ *)v18, v17.pptfx, Address, v17.count) )
          {
