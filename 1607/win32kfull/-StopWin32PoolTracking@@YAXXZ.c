/*
 * XREFs of ?StopWin32PoolTracking@@YAXXZ @ 0x1C015890C
 * Callers:
 *     InitializeWin32PoolTracking @ 0x1C0133C40 (InitializeWin32PoolTracking.c)
 * Callees:
 *     <none>
 */
...
void StopWin32PoolTracking(void)
{
  ...
  {
    *((_DWORD *)gpLeakTrackingAllocator + 11) = 0;
    v0[10] = 0;
  }
  if ( gpxsGlobals )
  {
