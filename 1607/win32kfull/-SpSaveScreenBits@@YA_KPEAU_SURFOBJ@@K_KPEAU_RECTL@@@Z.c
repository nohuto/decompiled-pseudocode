/*
 * XREFs of ?SpSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C026BC70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
    ...
    v5 = (*((__int64 (__fastcall **)(struct _SURFOBJ *, _QWORD, __int64, struct _RECTL *))hdev + 177))(v6, a2, v8, a4);
  }
LABEL_20:
