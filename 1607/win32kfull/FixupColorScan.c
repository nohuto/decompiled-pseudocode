/*
 * XREFs of FixupColorScan @ 0x1C00F7488
 * Callers:
...
void *__fastcall FixupColorScan(__m128i *a1, void *a2)
{
  ...
  int v40; // [rsp+28h] [rbp-81h]
  int v41; // [rsp+2Ch] [rbp-7Dh]
  int v42; // [rsp+30h] [rbp-79h]
  int v43; // [rsp+34h] [rbp-75h]
  int v44; // [rsp+38h] [rbp-71h]
  int v45; // [rsp+3Ch] [rbp-6Dh]
  int v46; // [rsp+40h] [rbp-69h]
  ...
  unsigned int v63; // [rsp+128h] [rbp+7Fh]
      ...
      *(_QWORD *)&v56[40] = v47;
      ...
      if ( (_DWORD)v6 != 1 )
      {
        ...
        while ( 1 )
        {
          ...
          v40 = v15;
          v20 = *v17 & 0xFFFFFF;
          v53 = *((unsigned __int8 *)v17 + v22 - 1);
          v62 = v20;
          v23 = *((unsigned __int8 *)v17 + v22 - 3) + 4 * (v53 + 2 * *((unsigned __int8 *)v17 + v22 - 2));
          v63 = v23;
          if ( v19 != v13 )
            break;
LABEL_8:
...
LABEL_15:
        ...
        v49 = *(_DWORD *)((char *)v17 + v59 - 6) & 0xFFFFFF;
        v43 = *(_DWORD *)((char *)v17 + v59 - 3) & 0xFFFFFF;
        v42 = *(_DWORD *)((char *)v17 + v21 - 6) & 0xFFFFFF;
        v45 = *(_DWORD *)((char *)v17 + v21 - 3) & 0xFFFFFF;
        if ( v19 ^ v15 | v12 ^ v20 | v13 ^ v38 | v14 ^ v44
          && v19 ^ v42 | v12 ^ *(_DWORD *)((char *)v17 + v59 - 6) & 0xFFFFFF | v13 ^ v45 | v14 ^ v43 )
        {
          if ( v52 < v23 )
          {
            ...
            *((_BYTE *)v17 + v48 - 1) = ((v19 & 0xFF0000)
                                       ...
                                       + (v46 & 0xFF0000)
                                       + 0x80000) >> 20;
            v33 = *(_DWORD *)(v51 - 2) & 0xFFFFFF;
            v18 = v51;
            *(v51 - 2) = ((unsigned __int8)v19
                        + (unsigned __int8)v49
                        + 12 * (unsigned __int8)*(v51 - 2)
                        + (unsigned __int8)v20
                        + (unsigned __int8)v14
                        + 8) >> 4;
            v12 = v39;
            *(v51 - 1) = ((v19 & 0xFF00) + (v49 & 0xFF00) + 12 * (v33 & 0xFF00) + (v20 & 0xFF00) + (v46 & 0xFF00) + 2048) >> 12;
            v13 = v41;
            v24 = v7.m128i_i64[1] - *(_QWORD *)&v56[24];
            v34 = 3 * (v33 & 0xFF0000);
            v15 = v40;
            v14 = v46;
            *v51 = ((v19 & 0xFF0000) + (v49 & 0xFF0000) + 4 * v34 + (v20 & 0xFF0000) + (v46 & 0xFF0000) + 0x80000) >> 20;
            goto LABEL_15;
          }
          ...
          *((_BYTE *)v17 + v48 - 4) = ((v13 & 0xFF0000)
                                     ...
                                     + (v42 & 0xFF0000)
                                     + 12 * (v27 & 0xFF0000)) >> 20;
          v29 = *(_DWORD *)(v51 + 1) & 0xFFFFFF;
          v18 = v51;
          v51[1] = ((unsigned __int8)v12
                  + (unsigned __int8)v43
                  + 12 * (unsigned __int8)v51[1]
                  + (unsigned __int8)v44
                  + (unsigned __int8)v13
                  + 8) >> 4;
          v30 = (v13 & 0xFF00) + (v44 & 0xFF00) + 2048 + (v39 & 0xFF00) + (v43 & 0xFF00) + 12 * (v29 & 0xFF00);
          v12 = v39;
          v13 = v41;
          v51[2] = v30 >> 12;
          v31 = 3 * (v29 & 0xFF0000);
          ...
          v14 = v46;
          v24 = v7.m128i_i64[1] - *(_QWORD *)&v56[24];
          v51[3] = (v28 + (v44 & 0xFF0000) + 0x80000 + (v39 & 0xFF0000) + (v43 & 0xFF0000) + 4 * v31) >> 20;
        }
        else
        {
          v35 = (*((unsigned __int8 *)v17 + v22 - 4) + v53 + 1) >> 1;
          v18[3] = v35;
          *v18 = v35;
          *((_BYTE *)v17 + v24 - 1) = v35;
          *((_BYTE *)v17 + v24 - 4) = v35;
