/*
 * XREFs of cjIFIMetricsToOTMW @ 0x1C0011C6C
 * Callers:
...
LABEL_8:
  ...
  *(_WORD *)((char *)a2 + 73) = *(_WORD *)(v14 + 180);
  ...
  if ( a6 )
  {
    ...
    *((_QWORD *)a2 + 25) = 232LL;
    StringCchCopyW((unsigned __int16 *)a2 + 116, (unsigned int)v64, (const unsigned __int16 *)(v14 + *(int *)(v14 + 8)));
    v65 = -1LL;
    v66 = -1LL;
    do
      ++v66;
    ...
    v68 = v64 - v67;
    v69 = (unsigned __int16 *)v63 + v67;
    *((_QWORD *)a2 + 26) = (char *)v69 - (char *)a2;
    StringCchCopyW(v69, v68, (const unsigned __int16 *)(v14 + *(int *)(v14 + 16)));
    v70 = -1LL;
    do
      ++v70;
    while ( v69[v70] );
    ...
    v72 = v68 - v71;
    v73 = &v69[v71];
    *((_QWORD *)a2 + 27) = (char *)v73 - (char *)a2;
    StringCchCopyW(v73, v72, (const unsigned __int16 *)(v14 + *(int *)(v14 + 12)));
    do
      ++v65;
    while ( v73[v65] );
    v74 = (unsigned int)(v65 + 1);
    *((_QWORD *)a2 + 28) = (char *)&v73[v74] - (char *)a2;
    StringCchCopyW(&v73[v74], v72 - (unsigned int)v74, (const unsigned __int16 *)(v14 + *(int *)(v14 + 20)));
    return *a2;
  }
  *((_QWORD *)a2 + 25) = 0LL;
  result = 232LL;
