/*
 * XREFs of ?bBrushPath@@YAHPEAVSURFACE@@PEAU_PATHOBJ@@PEAU_RECTL@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C02CC5D8
 * Callers:
        ...
        unsigned int a7)
{
  ...
  if ( (unsigned int)(*((_DWORD *)a1 + 24) - 1) > 5
