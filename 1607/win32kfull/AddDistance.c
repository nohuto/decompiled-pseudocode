/*
 * XREFs of AddDistance @ 0x1C00CFBF4
 * Callers:
...
void __fastcall AddDistance(__int64 a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  v5 = a3;
  v7 = a4;
  v8 = *(__int16 *)(*(_QWORD *)(a2 + 64) + 2LL * (*(__int16 *)(a2 + 80) - 1)) + 5;
...
LABEL_10:
    ...
    if ( *(_WORD *)(12 * v7 + v9) == 0xFFFF )
    {
      ...
      {
        if ( *(_DWORD *)(*(_QWORD *)(a2 + 32) + 4LL * v5) != *(_DWORD *)(*(_QWORD *)(a2 + 32) + 4LL * i) )
          break;
        v5 = i;
      }
      *(_WORD *)(v14 + v9) = v5;
...
LABEL_14:
  ...
  {
    v16 = *(_QWORD *)(a2 + 104);
    if ( *(_WORD *)(v16 + 12LL * v5 + 4) == 0xFFFF && *(__int16 *)(v14 + v16 + 4) != v5 )
    {
      v17 = *(__int16 *)(v16 + 12LL * v5);
      if ( (_DWORD)v17 != -1 && *(__int16 *)(v16 + 12 * v17 + 4) == v5 )
        *(_WORD *)(v14 + v16 + 6) |= 1u;
      else
        *(_WORD *)(v16 + 12LL * v5 + 4) = v7;
    }
  }
}
