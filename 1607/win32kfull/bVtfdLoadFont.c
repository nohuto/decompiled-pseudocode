/*
 * XREFs of bVtfdLoadFont @ 0x1C0017264
 * Callers:
 *     vtfdLoadFontFile @ 0x1C0016F7C (vtfdLoadFontFile.c)
 * Callees:
 *     bVerifyVTFD @ 0x1C0016FD4 (bVerifyVTFD.c)
 *     vVtfdFill_IFIMetrics @ 0x1C00174B8 (vVtfdFill_IFIMetrics.c)
 *     iDefaultFace @ 0x1C0017AB8 (iDefaultFace.c)
      ...
      *((_DWORD *)*a5 + 9) = v9;
      ...
      if ( v9 )
      {
        while ( 1 )
        {
          if ( v17 == 2 )
          {
            if ( !(unsigned int)bGetFntResource(v30, v18, &v28) )
              break;
            v8 = (_BYTE *)v28;
            v9 = v31;
          }
          ...
          *(_OWORD *)&v21[v22 + 5] = v28;
          v21[v22 + 7] = v20;
          *((_DWORD *)*a5 + 12 * v18 + 16) = iDefaultFace(v8);
          *((_QWORD *)*a5 + 6 * v18 + 10) = v19;
          LOBYTE(v23) = v8[85];
          *((_QWORD *)*a5 + 6 * v18 + 9) = pcpComputeGlyphset(
                                             &gpcpVTFD,
                                             (unsigned __int8)v8[95],
                                             (unsigned __int8)v8[96],
                                             v23);
          v24 = *((_QWORD *)*a5 + 6 * v18 + 9);
          if ( !v24 )
            break;
