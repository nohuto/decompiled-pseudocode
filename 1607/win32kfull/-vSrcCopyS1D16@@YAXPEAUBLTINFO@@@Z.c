/*
 * XREFs of ?vSrcCopyS1D16@@YAXPEAUBLTINFO@@@Z @ 0x1C02C5980
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vSrcCopyS1D16(struct BLTINFO *a1)
{
  ...
  int v81; // [rsp+4h] [rbp-5Ch]
  _WORD v82[2]; // [rsp+8h] [rbp-58h]
  int v83; // [rsp+Ch] [rbp-54h]
  int v84; // [rsp+10h] [rbp-50h]
  int v85; // [rsp+14h] [rbp-4Ch]
  int v86; // [rsp+18h] [rbp-48h]
  int v87; // [rsp+1Ch] [rbp-44h]
  struct BLTINFO *v88; // [rsp+20h] [rbp-40h]
  __int64 v89; // [rsp+28h] [rbp-38h]
  __int64 v90; // [rsp+30h] [rbp-30h]
  __int64 v91; // [rsp+38h] [rbp-28h]
  _DWORD v92[4]; // [rsp+40h] [rbp-20h]
...
LABEL_53:
  ...
  {
    v60 = *((_DWORD *)v2 + 13) - 1;
    v61 = (_WORD *)(*((_QWORD *)v2 + 2) + (int)(2 * (v86 & 0xFFFFFFF8)));
    v62 = *((_DWORD *)v2 + 8);
    v63 = ((_BYTE)v86 - 1) & 7;
