/*
 * XREFs of ?MulTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x1C02976F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulReserved)
{
  ...
  struct _SURFOBJ *v41; // [rsp+78h] [rbp-88h]
...
LABEL_8:
    ...
    if ( v15 )
    {
      MULTISURF::MULTISURF((MULTISURF *)v55, v41, a5);
      ...
      *(_QWORD *)&v58.left = SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v49);
      ...
      if ( *((_DWORD *)v48 + 6) )
      {
        ...
        if ( !pulXlate )
        {
          ...
          {
            v24 = SURFOBJ_TO_SURFACE_NOT_NULL(v41);
...
LABEL_50:
      ...
      if ( !v18 )
      {
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v49) + 112) & 0x8000) != 0 )
          v37 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, RECTL *, ULONG, ULONG))(*((_QWORD *)v48 + 7) + 3304LL);
        else
...
LABEL_62:
  ...
  if ( (unsigned int)MulCopyDeviceToDIB(v13, (struct SURFMEM *)&v43, &v58) )
  {
    if ( !v43 )
    {
      v8 = 1;
