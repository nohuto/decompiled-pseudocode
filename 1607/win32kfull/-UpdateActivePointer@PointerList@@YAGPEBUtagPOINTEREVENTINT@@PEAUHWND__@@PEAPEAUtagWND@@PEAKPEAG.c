/*
 * XREFs of ?UpdateActivePointer@PointerList@@YAGPEBUtagPOINTEREVENTINT@@PEAUHWND__@@PEAPEAUtagWND@@PEAKPEAGPEAI@Z @ 0x1C01F4190
 * Callers:
  ...
  *a6 = 0;
  ...
  if ( NodeById )
  {
    if ( *((_DWORD *)NodeById + 10) != v10 )
      return 0LL;
    v15 = !SetNewValidState(v11, NodeById);
  }
  else
  {
