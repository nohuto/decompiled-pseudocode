/*
 * XREFs of AddBGRMapCache @ 0x1C024B048
 * Callers:
...
__int64 __fastcall AddBGRMapCache(__int64 a1, int a2)
{
  ...
  v6 = qword_1C032918C;
  if ( v5 < (int)qword_1C032918C )
    goto LABEL_12;
  v7 = qword_1C032918C + 10;
  if ( (int)qword_1C032918C + 10 < (unsigned int)qword_1C032918C )
    goto LABEL_12;
  v8 = 16LL * v7;
  if ( v8 > 0xFFFFFFFF )
    goto LABEL_12;
...
LABEL_12:
  ...
  if ( Src )
  {
    memmove(v9, Src, 16LL * dword_1C0329188);
    EngFreeMem(v11);
  }
  v5 = dword_1C0329188;
  v6 = v7;
  LODWORD(qword_1C032918C) = v7;
  Src = v10;
LABEL_13:
  if ( v10 && v5 < v6 )
  {
    v12 = 2LL * v5;
    dword_1C0329188 = v5 + 1;
    *((_QWORD *)v10 + v12) = a1;
