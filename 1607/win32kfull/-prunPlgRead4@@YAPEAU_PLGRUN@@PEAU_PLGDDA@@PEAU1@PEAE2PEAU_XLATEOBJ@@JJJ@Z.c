/*
 * XREFs of ?prunPlgRead4@@YAPEAU_PLGRUN@@PEAU_PLGDDA@@PEAU1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C02D3320
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( (v18 & dword_1C02F2B20[v19]) != 0 )
        {
          v20 = (v14 & (unsigned int)dword_1C02F2AF8[v11]) >> dword_1C02F2AD8[v11];
          if ( a5 )
  ...
  else if ( v8 < a7 )
  {
    while ( 1 )
    {
      v15 = (v14 & (unsigned int)dword_1C02F2AF8[v11]) >> dword_1C02F2AD8[v11];
