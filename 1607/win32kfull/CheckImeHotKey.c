/*
 * XREFs of CheckImeHotKey @ 0x1C010B788
 * Callers:
...
struct _tagIMEHOTKEYOBJ *__fastcall CheckImeHotKey(__int64 a1, unsigned int a2, int a3)
{
  ...
  v7 = ((*(_BYTE *)(a1 + 232) & 0x40) != 0 ? 0x4002 : 0) | ((*(_BYTE *)(a1 + 232) & 0x10) != 0 ? 0x8002 : 0) | ((*(_BYTE *)(a1 + 232) & 4) != 0 ? 0x4004 : 0) | ((*(_BYTE *)(a1 + 232) & 1) != 0 ? 0x8004 : 0);
  v8 = (*(_BYTE *)(a1 + 233) & 1) != 0 ? (struct _tagIMEHOTKEYOBJ *)0x8001 : 0LL;
  v9 = ((*(_BYTE *)(a1 + 233) & 4) != 0 ? 0x4001 : 0) | (unsigned int)v8 | v7;
  if ( a2 - 16 <= 2 )
  {
