/*
 * XREFs of ?ProcessQFrameNode@@YAXPEAUtagPOINTERQFRAME@@PEBUtagPOINTERINPUTFRAME@@PEAUtagPOINTERINFONODE@@@Z @ 0x1C01C13C0
 * Callers:
        ...
        struct tagPOINTERINFONODE *a3)
{
  ...
  v9 = (unsigned int)IsManipulationThreadNode(a3) && (*(_DWORD *)(v8 + 4) & 0x200) == 0;
  if ( ((*(_DWORD *)v8 & 4) == 0 && v6 || (unsigned int)IsManipulationThreadNode(v7)) && !v9 )
  ...
  v14 = *((_DWORD *)a1 + 5);
  if ( (v14 & 8) == 0 && (*(_DWORD *)a3 & 0x100000) != 0 && !v9 )
  {
    *((_DWORD *)a1 + 6) = 9;
    *((_DWORD *)a1 + 5) = v14 | 8;
  }
