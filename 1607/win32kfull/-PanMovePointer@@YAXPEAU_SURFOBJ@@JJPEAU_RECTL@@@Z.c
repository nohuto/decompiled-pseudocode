/*
 * XREFs of ?PanMovePointer@@YAXPEAU_SURFOBJ@@JJPEAU_RECTL@@@Z @ 0x1C0287270
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PanMovePointer(struct _SURFOBJ *a1, LONG a2, unsigned int a3, struct _RECTL *a4)
{
  ...
  dhpdev = a1->dhpdev;
  v15 = (HSEMAPHORE)*((_QWORD *)dhpdev + 15);
  EngAcquireSemaphore(v15);
  v9 = (void (__fastcall *)(_QWORD, _QWORD, _QWORD, struct _RECTL *))*((_QWORD *)dhpdev + 130);
