...
__int64 __fastcall SfnEMPTY(__int64 *a1, int a2, __int64 a3, __int64 a4, unsigned __int64 a5, __int64 a6)
{
  __int64 v10; // rdi
  __int64 v11; // rax
  __int64 v12; // rcx
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 80LL) = v13;
  ...
  v14 = KeUserModeCallback(117LL, v22, 48LL, &a5, &v24);
