/*
 * XREFs of ?vSqrt@EFLOAT@@QEAAXXZ @ 0x1C0014330
 * Callers:
 ...
 *     ?efWorldLength@STYLER@@IEAA?AVEFLOAT@@VEVECTORFX@@@Z @ 0x1C02CA7E8 (-efWorldLength@STYLER@@IEAA-AVEFLOAT@@VEVECTORFX@@@Z.c)
 * Callees:
 *     <none>
 */
