/*
 * XREFs of ??0RESETFCOBJ@@QEAA@AEAVDCOBJ@@AEAVRFONTOBJ@@PEAU_MAT2@@HK@Z @ 0x1C0124C98
 * Callers:
 ...
 *     ?vFixedToEf@@YAXPEAVEFLOAT@@AEAU_FIXED@@@Z @ 0x1C02B5808 (-vFixedToEf@@YAXPEAVEFLOAT@@AEAU_FIXED@@@Z.c)
 */
        ...
        unsigned int a6)
{
  ...
  *((_DWORD *)this + 1) = v6;
  ...
  if ( !*((_DWORD *)this + 1) )
  {
    ...
    vFixedToEf((struct EFLOAT *)&v26, &a4->eM11);
    vFixedToEf((struct EFLOAT *)&v23, &a4->eM22);
    vFixedToEf((struct EFLOAT *)&v24, &a4->eM12);
    vFixedToEf((struct EFLOAT *)&v25, &a4->eM21);
    v13 = v24 ^ _xmm;
    v14 = v25 ^ _xmm;
    *(_DWORD *)v27[0] = v26;
    x = v23.x;
