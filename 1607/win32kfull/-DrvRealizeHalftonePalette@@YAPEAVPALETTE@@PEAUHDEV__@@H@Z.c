/*
 * XREFs of ?DrvRealizeHalftonePalette@@YAPEAVPALETTE@@PEAUHDEV__@@H@Z @ 0x1C025B574
 * Callers:
 *     DrvRealizeHalftonePaletteWrap @ 0x1C025B880 (DrvRealizeHalftonePaletteWrap.c)
 ...
 *     GreCreateCompatibleHalftonePalette @ 0x1C0129508 (GreCreateCompatibleHalftonePalette.c)
...
struct PALETTE *__fastcall DrvRealizeHalftonePalette(_QWORD *a1, int a2)
{
  ...
  bDeleteDCInternal(DisplayDC, 1LL, 0LL, 0LL);
  if ( v4 )
LABEL_15:
