/*
 * XREFs of NtGdiGetGlyphIndicesWInternal @ 0x1C0117590
 * Callers:
 *     NtGdiGetGlyphIndicesW @ 0x1C0117570 (NtGdiGetGlyphIndicesW.c)
 * Callees:
...
__int64 __fastcall NtGdiGetGlyphIndicesWInternal(HDC a1, char *a2, int a3, char *a4, unsigned int a5, int a6)
{
  ...
  if ( v8 )
  {
    ...
    if ( (_DWORD)v7 != -1 )
    {
      ...
      {
        v11 = 2LL * (int)v7;
        if ( (unsigned __int64)&a4[v11] > W32UserProbeAddress || &a4[v11] <= a4 )
          *W32UserProbeAddress = 0;
        memmove(a4, v8, v11);
      }
    }
