/*
 * XREFs of ?BltLnkSrcCopyMsk1@@YAXPEAUBLTINFO@@PEAU_BLTLNK_MASKINFO@@PEAK2@Z @ 0x1C02D6BC0
 * Callers:
 *     <none>
 * Callees:
 *     ?BltLnkReadPat1@@YAXPEAEK0KKKK@Z @ 0x1C02D66A0 (-BltLnkReadPat1@@YAXPEAEK0KKKK@Z.c)
 */
