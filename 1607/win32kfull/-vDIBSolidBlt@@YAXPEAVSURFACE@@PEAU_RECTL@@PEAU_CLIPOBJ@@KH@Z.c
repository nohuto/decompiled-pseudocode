/*
 * XREFs of ?vDIBSolidBlt@@YAXPEAVSURFACE@@PEAU_RECTL@@PEAU_CLIPOBJ@@KH@Z @ 0x1C0047FD0
 * Callers:
...
void __fastcall vDIBSolidBlt(struct SURFACE *a1, struct _RECTL *a2, struct _CLIPOBJ *a3, int a4, int a5)
{
  ...
  _DWORD v28[84]; // [rsp+90h] [rbp-198h] BYREF

  v8 = 0;
  v9 = 0;
  memset(v28, 0, 0x144uLL);
...
LABEL_20:
  ...
  if ( *((_QWORD *)a1 + 72) )
  {
    ...
    v19 = (unsigned __int8 *)*((_QWORD *)a1 + 72);
  }
  else
  {
