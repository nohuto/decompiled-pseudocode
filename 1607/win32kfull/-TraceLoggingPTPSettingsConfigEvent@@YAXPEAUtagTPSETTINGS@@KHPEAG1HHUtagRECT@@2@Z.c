/*
 * XREFs of ?TraceLoggingPTPSettingsConfigEvent@@YAXPEAUtagTPSETTINGS@@KHPEAG1HHUtagRECT@@2@Z @ 0x1C021E994
 * Callers:
 ...
 *     _TlgCreateWsz @ 0x1C00E5DD0 (_TlgCreateWsz.c)
        ...
        struct tagRECT *a9)
{
  ...
  if ( dword_1C0320840 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0320840, 0x800000000000uLL) )
    {
      ...
      v52 = 4LL;
      v54 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320840, &unk_1C02EEEFB, v13, v14, 0x13u, &pData);
    }
  }
}
