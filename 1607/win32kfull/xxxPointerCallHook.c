/*
 * XREFs of xxxPointerCallHook @ 0x1C000D47C
 * Callers:
 ...
 *     ?AddThreadPointerHookData@@YAHPEAUtagTHREADINPUTPOINTERLIST@@GK_KIPEAUHWND__@@@Z @ 0x1C01EEA7C (-AddThreadPointerHookData@@YAHPEAUtagTHREADINPUTPOINTERLIST@@GK_KIPEAUHWND__@@@Z.c)
...
LABEL_25:
    ...
    if ( v13 )
    {
      ...
      v20 = xxxCallHook2(Valid, a1, a2, (_DWORD)v6, 0LL, 0);
      RemoveThreadPointerHookData((struct tagTHREADINPUTPOINTERLIST *)(gptiCurrent + 968LL));
    }
    return v20;
  }
  v17 = FindThreadPointerData((struct _LIST_ENTRY *)(gptiCurrent + 968LL), *v9);
  if ( v17 )
  {
