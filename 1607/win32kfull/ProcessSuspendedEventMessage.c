/*
 * XREFs of ProcessSuspendedEventMessage @ 0x1C0120610
 * Callers:
 *     PostEventMessageEx @ 0x1C0059A54 (PostEventMessageEx.c)
 *     xxxProcessNotifyWinEvent @ 0x1C0085350 (xxxProcessNotifyWinEvent.c)
 * Callees:
 *     ?FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z @ 0x1C01206EC (-FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z.c)
 *     ?ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z @ 0x1C0120720 (-ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z.c)
 */
        ...
        __int64 a6)
{
  ...
  if ( v9 != 1 )
  {
    ...
    while ( 1 )
    {
      QMsgForCoalesce = FindQMsgForCoalesce(*(struct tagMLIST **)(a1 + 384), a4, v10, v11);
      v11 = QMsgForCoalesce;
      if ( !QMsgForCoalesce )
        break;
