/*
 * XREFs of ?vComputeUncoveredSpriteRegion@RGNOBJ@@QEAAXAEAVPDEVOBJ@@@Z @ 0x1C004A7EC
 * Callers:
 ...
 *     ?bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z @ 0x1C01293A8 (-bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z.c)
 */
