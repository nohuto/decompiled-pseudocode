/*
 * XREFs of ?IsPointerQueuedMessageCoalescable@@YAHPEAUtagQ@@PEAUtagQMSG@@KK_KK@Z @ 0x1C01C100C
 * Callers:
        ...
        unsigned int a6)
{
  ...
  while ( 1 )
  {
    ...
    if ( (_DWORD)v8 == 512 )
    {
      ...
      if ( v9 == 4 && v7 == 2 )
        goto LABEL_18;
      if ( v9 == 8 && v7 == 3 || v9 == 16 && v7 == 5 || *(_DWORD *)(v6 + 124) == 4 )
        goto LABEL_18;
    }
    if ( !(unsigned int)IsPointerInputMessageWithState(v8, (__int64)a2) )
      return 0LL;
    v12 = *(_QWORD *)(v6 + 40);
    if ( v12 == a5 )
      return 1LL;
