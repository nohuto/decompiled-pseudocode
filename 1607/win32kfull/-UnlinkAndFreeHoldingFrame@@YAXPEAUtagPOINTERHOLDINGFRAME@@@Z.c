/*
 * XREFs of ?UnlinkAndFreeHoldingFrame@@YAXPEAUtagPOINTERHOLDINGFRAME@@@Z @ 0x1C01C1E24
 * Callers:
...
{
  __int64 v4; // rcx
  struct tagPOINTERHOLDINGFRAME **v5; // rax
  ...
  v4 = *(_QWORD *)a1;
  v5 = (struct tagPOINTERHOLDINGFRAME **)*((_QWORD *)a1 + 1);
  if ( *(struct tagPOINTERHOLDINGFRAME **)(*(_QWORD *)a1 + 8LL) != a1 || *v5 != a1 )
    __fastfail(3u);
