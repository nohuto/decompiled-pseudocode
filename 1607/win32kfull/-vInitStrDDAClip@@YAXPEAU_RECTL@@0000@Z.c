/*
 * XREFs of ?vInitStrDDAClip@@YAXPEAU_RECTL@@0000@Z @ 0x1C00FE5DC
 * Callers:
...
void __fastcall vInitStrDDAClip(struct _RECTL *a1, struct _RECTL *a2, struct _RECTL *a3, struct _RECTL *a4)
{
  ...
  if ( v8 || v10 )
  {
    ...
    v46.m128i_i32[1] -= v10;
    v46.m128i_i32[3] -= v10;
    v46.m128i_i32[0] = _mm_cvtsi128_si32(v40) - v8;
    v47 = *v42;
    v41 = (__m128i)v47;
    v47.right -= v8;
    v47.top -= v10;
    v47.bottom -= v10;
    v47.left = _mm_cvtsi128_si32(v41) - v8;
    a4 = &v47;
    v42 = &v47;
  }
