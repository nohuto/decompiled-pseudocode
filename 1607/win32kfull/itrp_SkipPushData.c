/*
 * XREFs of itrp_SkipPushData @ 0x1C02E17B8
 * Callers:
 *     itrp_IDEF @ 0x1C02E0A30 (itrp_IDEF.c)
 * Callees:
 *     <none>
 */
...
unsigned __int8 *__fastcall itrp_SkipPushData(unsigned __int8 *a1)
{
  ...
  v1 = qword_1C0329538;
  v2 = a1 - 1;
  if ( (unsigned __int64)(a1 - 1) < qword_1C0329540 || (unsigned __int64)a1 > qword_1C0329538 || a1 < v2 )
    goto LABEL_19;
  _mm_lfence();
  v3 = byte_1C02E9060[*v2];
  if ( !v3 )
    return a1;
  v1 = qword_1C0329538;
  if ( v3 == 21 )
