/*
 * XREFs of itrp_PUSHB @ 0x1C00CC750
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall itrp_PUSHB(unsigned __int64 a1, int a2)
{
  ...
  if ( (qword_1C03294E0 ^ v5 ^ *(_QWORD *)qword_1C03294E0 ^ MEMORY[0xFFFFF78000000330]) == *(_QWORD *)(qword_1C03294E0 + 432)
    && v2 <= (unsigned __int64)((v5 - qword_1C03294C8) >> 2) )
  {
    if ( a1 < qword_1C0329540 || (v6 = a1 + v2, v6 > qword_1C0329538) || v6 < (unsigned __int64)v4 )
    {
  ...
  {
    v4 = (unsigned __int8 *)qword_1C0329538;
