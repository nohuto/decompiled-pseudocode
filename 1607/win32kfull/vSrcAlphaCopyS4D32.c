/*
 * XREFs of vSrcAlphaCopyS4D32 @ 0x1C0262C00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  for ( i = (unsigned __int8 *)(a2 / 2 + a1); v8; --v8 )
  {
    ...
    if ( (int)((a6 & 0xFFFFFFFE) - v10) / 2 > 0 )
    {
      ...
      do
      {
        ...
        if ( (*v14 & 0xF0) != 0 )
        {
          v12 = dword_1C02F25E0[(unsigned __int64)v17 >> 4];
          *v15 = v12;
        }
        v18 = v15 + 1;
        if ( (v17 & 0xF) != 0 )
        {
          v12 = dword_1C02F25E0[v17 & 0xF];
          *v18 = v12;
        }
        v15 = v18 + 1;
        ++v14;
    ...
    if ( a6 != (a6 & 0xFFFFFFFE) )
    {
      ...
      if ( (*v14 & 0xF0) != 0 )
      {
        v12 = dword_1C02F25E0[(unsigned __int64)(unsigned __int8)v12 >> 4];
        *v15 = v12;
      }
    }
    i += v9;
