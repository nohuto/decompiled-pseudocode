/*
 * XREFs of ?TransformPTPLogicalUnitsToPhysical@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@PEAU2@@Z @ 0x1C01C8FD8
 * Callers:
 *     ApplyPTPTranslation @ 0x1C01C9040 (ApplyPTPTranslation.c)
 * Callees:
