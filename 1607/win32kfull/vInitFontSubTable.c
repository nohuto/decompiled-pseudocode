/*
 * XREFs of vInitFontSubTable @ 0x1C037E410
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  if ( v0 )
  {
    *v0 = xmmword_1C02E9710;
    v0[1] = xmmword_1C02E9720;
    *((_DWORD *)v0 + 8) = 6684777;
    *((_WORD *)v0 + 18) = 0;
    v2 = gpfsTable;
    *((_OWORD *)gpfsTable + 4) = xmmword_1C02E96E8;
    v2[5] = xmmword_1C02E96F8;
    *((_DWORD *)v2 + 24) = 4587593;
    *((_WORD *)v2 + 50) = 0;
    v3 = (char *)gpfsTable;
    *(_OWORD *)((char *)gpfsTable + 130) = xmmword_1C02E9738;
