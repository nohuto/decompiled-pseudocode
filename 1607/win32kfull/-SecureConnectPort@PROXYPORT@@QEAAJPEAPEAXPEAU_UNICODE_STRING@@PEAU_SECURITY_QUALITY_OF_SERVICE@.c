/*
 * XREFs of ?SecureConnectPort@PROXYPORT@@QEAAJPEAPEAXPEAU_UNICODE_STRING@@PEAU_SECURITY_QUALITY_OF_SERVICE@@PEAU_PORT_VIEW@@PEAXPEAU_REMOTE_PORT_VIEW@@PEAK46@Z @ 0x1C02A33E4
 * Callers:
 *     ??0PROXYPORT@@QEAA@_K@Z @ 0x1C02A2F38 (--0PROXYPORT@@QEAA@_K@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0158CD0 (__security_check_cookie.c)
 *     Win32DestroySection @ 0x1C01CBCA8 (Win32DestroySection.c)
 *     Win32OpenSectionByHandle @ 0x1C01CBCB0 (Win32OpenSectionByHandle.c)
 *     Win32MapViewInSessionSpace @ 0x1C01DF474 (Win32MapViewInSessionSpace.c)
 */
