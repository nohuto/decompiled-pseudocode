/*
 * XREFs of ?LoadFileContent@@YAJPEAXIIPEAPEAXPEAI@Z @ 0x1C00E9CF0
 * Callers:
...
__int64 __fastcall LoadFileContent(HANDLE FileHandle, __int64 a2, __int64 a3, void **a4, unsigned int *a5)
{
  ...
  if ( v7 >= 0 )
  {
    if ( v17 || v16 - 64 > 0x3FFC0 )
      Status = -1073741672;
    if ( Status >= 0 )
    {
      Buffer = (void *)Win32AllocPool(v16, 1953198933LL);
      if ( !Buffer )
        Status = -1073741801;
      if ( Status >= 0 )
      {
