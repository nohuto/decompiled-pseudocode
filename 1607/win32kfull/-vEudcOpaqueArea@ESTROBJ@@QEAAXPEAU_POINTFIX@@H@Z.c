/*
 * XREFs of ?vEudcOpaqueArea@ESTROBJ@@QEAAXPEAU_POINTFIX@@H@Z @ 0x1C003205C
 * Callers:
 ...
 * Callees:
 *     AdjustBoundingBox @ 0x1C000CE10 (AdjustBoundingBox.c)
...
LABEL_32:
                AdjustBoundingBox(v29, (__int64)&v32, &v36, &v35, (int *)&v34, &v33);
                goto LABEL_9;
              }
            }
          }
