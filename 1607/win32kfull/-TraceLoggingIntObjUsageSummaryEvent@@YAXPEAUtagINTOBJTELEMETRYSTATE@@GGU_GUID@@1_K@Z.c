/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1C021E008
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  __int16 v78; // [rsp+258h] [rbp+158h] BYREF
  __int16 v79; // [rsp+260h] [rbp+160h] BYREF
  ...
  if ( dword_1C0320840 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0320840, 0x800000000000uLL) )
    {
      ...
      v15 = dword_1C03346E4;
      v54 = &v15;
      v10 = (unsigned int)qword_1C03346F0 / 0x3E8;
      v17 = dword_1C03346EC;
      v18 = (unsigned int)qword_1C0334718 / 0x3E8;
      v28 = v6;
      v29 = 16LL;
      v33 = 16LL;
      v37 = 4LL;
      ...
      v75 = 4LL;
      v77 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320840, &unk_1C02EE471, (LPCGUID)0x10624DD3, v6, 0x1Bu, &pData);
    }
  }
}
