/*
 * XREFs of itrp_RCVT @ 0x1C00CC0F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_RCVT(__int64 a1)
{
  ...
  v3 = *v2;
  if ( (int)v3 >= *(unsigned __int16 *)(qword_1C03294E0 + 360) && (int)v3 > 255
    || (fixed = 0, (int)v3 < 0)
    || (v5 = *(_QWORD *)(qword_1C03294E0 + 16),
        (qword_1C03294E0 ^ v5 ^ MEMORY[0xFFFFF78000000330] ^ (unsigned __int64)*(unsigned __int16 *)(qword_1C03294E0 + 360)) != *(_QWORD *)(qword_1C03294E0 + 368)) )
  {
  ...
  else
  {
    if ( dword_1C032951C == 3 )
    {
      ...
      fixed = FixMul(*(_DWORD *)(*(_QWORD *)(qword_1C03294E0 + 16) + 4 * v3), CVTScale);
    }
    else
    {
