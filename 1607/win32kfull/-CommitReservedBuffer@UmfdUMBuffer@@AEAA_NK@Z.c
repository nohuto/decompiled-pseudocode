/*
 * XREFs of ?CommitReservedBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1C02DA258
 * Callers:
 *     ?CommitBuffer@UmfdUMBuffer@@QEAAPEAXK@Z @ 0x1C02DA1D0 (-CommitBuffer@UmfdUMBuffer@@QEAAPEAXK@Z.c)
 * Callees:
 *     ?AlignSizeTo@UmfdUMBuffer@@CA_NKKPEAK@Z @ 0x1C02DA0C0 (-AlignSizeTo@UmfdUMBuffer@@CA_NKKPEAK@Z.c)
 */
