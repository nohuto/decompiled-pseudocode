/*
 * XREFs of GreEndGdiRenderingToDxSurface @ 0x1C0006058
 * Callers:
 *     NtGdiEndGdiRendering @ 0x1C0006010 (NtGdiEndGdiRendering.c)
 * Callees:
    ...
    if ( ((unsigned int)a1 & 0x800000) == 0 )
    {
      if ( (unsigned int)GreGetObjectOwner(a1, 5LL) )
      {
        ...
        *(_WORD *)(v14 + 102) |= 0x200u;
        ...
        {
          v11 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64))(v10 + 3512);
          v9 = 0;
          if ( v11 )
