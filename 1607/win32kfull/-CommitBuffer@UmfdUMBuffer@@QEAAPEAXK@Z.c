/*
 * XREFs of ?CommitBuffer@UmfdUMBuffer@@QEAAPEAXK@Z @ 0x1C02DA1D0
 * Callers:
 *     ?CommitUMBuffer@UmfdTls@@QEAAPEAXK_N@Z @ 0x1C02D8E4C (-CommitUMBuffer@UmfdTls@@QEAAPEAXK_N@Z.c)
 * Callees:
 *     ?AllocTemporaryBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1C02DA0DC (-AllocTemporaryBuffer@UmfdUMBuffer@@AEAA_NK@Z.c)
 *     ?CommitReservedBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1C02DA258 (-CommitReservedBuffer@UmfdUMBuffer@@AEAA_NK@Z.c)
 */
