/*
 * XREFs of PrepareForLogoff @ 0x1C0133150
 * Callers:
 *     <none>
 * Callees:
 *     RegisterPerUserKeyboardIndicators @ 0x1C01331E4 (RegisterPerUserKeyboardIndicators.c)
 */
...
__int64 PrepareForLogoff()
{
  ...
  if ( (*(_DWORD *)(gptiCurrent + 440LL) & 0x20000000) != 0
    && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 720LL) + 24LL) & 0x80u) != 0 )
  {
    return 0LL;
  }
  if ( PsGetThreadProcessId((PETHREAD)*gptiCurrent) == (HANDLE)gpidLogon && !gProtocolType )
  {
    v0 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 632LL);
    if ( v0 )
    {
