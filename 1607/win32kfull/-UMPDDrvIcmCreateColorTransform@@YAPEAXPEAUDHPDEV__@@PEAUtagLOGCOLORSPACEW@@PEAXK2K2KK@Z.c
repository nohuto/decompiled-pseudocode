/*
 * XREFs of ?UMPDDrvIcmCreateColorTransform@@YAPEAXPEAUDHPDEV__@@PEAUtagLOGCOLORSPACEW@@PEAXK2K2KK@Z @ 0x1C029EF00
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&Src[4], 0x148u) )
    {
      if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v13, (const void **)&Src[5], a4) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v13, (const void **)&Src[7], a6) )
        {
          ...
          {
            LODWORD(Size) = 8;
            if ( (unsigned int)UMPDOBJ::Thunk(v13, Src, 88LL, &v17, Size) != -1 )
              v14 = v17;
          }
        }
      }
