/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01C6530
 * Callers:
 ...
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x1C01C50D4 (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
        ...
        struct tagPOINT *a6)
{
  ...
  v113 = a4;
  v6 = *((_DWORD *)a1 + 351) - *((_DWORD *)a1 + 352);
