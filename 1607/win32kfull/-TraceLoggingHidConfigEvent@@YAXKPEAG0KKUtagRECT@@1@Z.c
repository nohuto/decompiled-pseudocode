/*
 * XREFs of ?TraceLoggingHidConfigEvent@@YAXKPEAG0KKUtagRECT@@1@Z @ 0x1C00E5C7C
 * Callers:
        ...
        struct tagRECT *a7)
{
  ...
  if ( dword_1C0320840 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0320840, 0x800000000000uLL) )
    {
      ...
      v36 = 4;
      v39 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C0320840, &unk_1C02EE6B2, v10, v11, 0xBu, &pData);
    }
  }
}
