/*
 * XREFs of ?GreHidePointer@@YAXPEAUHDEV__@@@Z @ 0x1C010ABF0
 * Callers:
...
void __fastcall GreHidePointer(_QWORD *a1)
{
  ...
  if ( (a1[7] & 0x20000) != 0 )
  {
    ...
    do
    {
      v6 = (_DWORD *)v4[6];
      if ( (v6[538] & 0x2000) == 0 )
        vMovePointer(v6, 0xFFFFFFFFLL, 0xFFFFFFFFLL, dword_1C0331C98);
      v4 = (_QWORD *)*v4;
      --v5;
    }
    while ( v5 );
  ...
  {
    vMovePointer(a1, 0xFFFFFFFFLL, 0xFFFFFFFFLL, dword_1C0331C98);
  }
  v2 = a1[9];
  *((_DWORD *)a1 + 20) = -1;
  *((_DWORD *)a1 + 21) = -1;
