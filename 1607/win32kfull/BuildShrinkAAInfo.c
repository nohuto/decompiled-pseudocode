/*
 * XREFs of BuildShrinkAAInfo @ 0x1C024F700
 * Callers:
 *     <none>
 * Callees:
...
_DWORD *BuildShrinkAAInfo(__int64 a1, __int64 a2, int *a3, int *a4, int a5, int a6, int a7, int *a8, int *a9, ...)
{
  ...
  if ( v79 < v29 )
    return 0LL;
  v91 = (__int64)((unsigned __int64)v26 << 13) / v28;
  if ( (v27 & 0x4A80) != 0 )
  {
    v30 = v18 + 4;
    if ( (unsigned int)v30 < v18 )
      return 0LL;
    v31 = 2 * v30;
    if ( v31 > 0xFFFFFFFF || (int)ALIGN_MEM((unsigned int *)&v82, v31) < 0 )
      return 0LL;
    v33 = v82;
    if ( (v32 & 0x200) != 0 )
      v79 = 0;
...
LABEL_36:
    ...
    if ( v79 )
    {
      ...
      *((_QWORD *)v39 + 5) = v40 + 512;
      v92 = (unsigned __int64)v40 + 2 * v23 + 2048;
      v57 = -v54;
      v58 = -(v54 + 1);
      do
      {
        ...
        while ( 1 )
        {
          ...
          if ( v46 >= v61 - 1 && v46 <= v81 )
          {
            ...
            if ( (int)v69 > (int)v91 )
              v70 |= 0x8000u;
            LOWORD(v62) = v69 + v90;
            v90 = (unsigned int)(v69 + v90);
            if ( (v70 & 0x4000) != 0 )
            {
              v89 = ((__int64)v58 << 13) % v93;
              v62 = ((__int64)v58 << 13) / v93;
              v90 = v62;
              if ( (int)v62 + (int)v69 <= (int)v91 )
                v70 &= ~0x8000u;
              else
                v70 |= 0x8000u;
              v58 = 0;
