/*
 * XREFs of ?vSpRedrawAreaExMirror@@YAXPEAU_SPRITESTATE@@PEAU_RECTL@@@Z @ 0x1C0274E3C
 * Callers:
 ...
 *     ?bAdvanceToTopMostOpaqueLayer@ENUMAREAS@@QEAAHPEAPEAVSPRITE@@@Z @ 0x1C026C73C (-bAdvanceToTopMostOpaqueLayer@ENUMAREAS@@QEAAHPEAPEAVSPRITE@@@Z.c)
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(Composite) + 112) & 0x400) == 0 )
      {
        ...
        if ( v74->hdev )
        {
                          ...
                          + 20LL) & 0x400) == 0 )
          {
            ...
            {
              v103 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(*((_QWORD *)v71 + 20) + 24LL) + 1352LL);
LABEL_99:
              OffCopyBits(
...
LABEL_89:
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(Composite) + 112) & 0x400) != 0 )
      {
        v103 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)Composite->hdev + 169);
        goto LABEL_99;
      }
      goto LABEL_98;
    }
...
LABEL_47:
                         ...
                         + 20LL) & 0x400) == 0 )
    {
        ...
        && (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*((_QWORD *)a1 + 5)) + 112) & 0x400) != 0 )
      {
        v40 = *((_QWORD *)a1 + 5);
LABEL_46:
        v54 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(v40 + 24) + 1352LL);
        goto LABEL_48;
      }
      goto LABEL_47;
    }
