/*
 * XREFs of ?vPlgWriteOR@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02D4700
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( v39 )
          {
            do
            {
              ...
              if ( v23 >= si128.top && v23 < si128.bottom )
              {
                ...
                v37 = v27;
                v28 = (char *)(v25 + (v26 >> 3));
                v29 = byte_1C02ED6C0[*(_DWORD *)v24 & 7];
                if ( (int)v26 >= 0
      ...
      do
      {
        ...
        if ( *((_DWORD *)v8 + 2) )
        {
          do
          {
            v12 = *(_DWORD *)v9;
            v13 = *((_DWORD *)v9 + 1);
            v14 = byte_1C02ED6C0[*(_DWORD *)v9 & 7];
