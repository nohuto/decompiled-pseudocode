/*
 * XREFs of ?SpStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1C0149120
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a8)
{
  ...
  __int64 *v62[9]; // [rsp+390h] [rbp+290h] BYREF
  int v63; // [rsp+3D8h] [rbp+2D8h]
  ...
  v54 = a7;
  ENUMUNDERLAYS::ENUMUNDERLAYS((ENUMUNDERLAYS *)v62, a1, a3, &a3->rclBounds);
  while ( (unsigned int)ENUMUNDERLAYS::bEnum(v62, &v51, &v53, &v50) )
  {
    v11 = 0LL;
...
LABEL_17:
    ...
    XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)&v60);
  }
  return v9;
}
