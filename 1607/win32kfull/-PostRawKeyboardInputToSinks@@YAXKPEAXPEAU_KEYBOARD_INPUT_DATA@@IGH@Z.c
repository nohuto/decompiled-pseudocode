/*
 * XREFs of ?PostRawKeyboardInputToSinks@@YAXKPEAXPEAU_KEYBOARD_INPUT_DATA@@IGH@Z @ 0x1C0007730
 * Callers:
        ...
        int a6)
{
        ...
        i = (__int64 *)*i )
  {
    ...
    if ( (v13 & 0x40) != 0 )
    {
      ...
      if ( v14 )
      {
        if ( *(char *)(v14 + 44) >= 0 && *(char *)(v14 + 43) >= 0 && *(_QWORD *)(v14 + 24) == grpdeskRitInput )
        {
          if ( !v6
