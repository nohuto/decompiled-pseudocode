/*
 * XREFs of ClearKeyboardToggleStates @ 0x1C0095094
 * Callers:
...
__int64 ClearKeyboardToggleStates()
{
  ...
  {
    ++v1;
    v8[v2] = gafAsyncKeyState[(unsigned __int64)byte_1C02E8F00[v2] >> 2] & (1 << (2 * (byte_1C02E8F00[v2] & 3) + 1));
    ++v2;
  }
  ...
  {
    if ( v8[v6] )
      gafAsyncKeyState[(unsigned __int64)byte_1C02E8F00[v6] >> 2] |= 1 << (2 * (byte_1C02E8F00[v6] & 3) + 1);
    ++v5;
    ++v6;
    result = v5;
  }
