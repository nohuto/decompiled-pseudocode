/*
 * XREFs of ?bAddPreComputedFastStrokeRects@PRECOMPUTE@@QEAAHAEAVEPATHOBJ@@PEAU_RECTL@@K@Z @ 0x1C02CC4F0
 * Callers:
...
LABEL_14:
  ...
  if ( v12 )
    memmove(v10, v12, 16LL * *((unsigned int *)a2 + 16));
  memmove(&v11[16 * *((unsigned int *)a2 + 16)], a3, 16 * v6);
  v14 = *((_QWORD *)a2 + 9);
  if ( v14 )
