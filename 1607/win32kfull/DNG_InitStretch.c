/*
 * XREFs of DNG_InitStretch @ 0x1C00D4EF8
 * Callers:
...
unsigned __int64 __fastcall DNG_InitStretch(__int64 a1, unsigned int a2, unsigned int a3, int a4, int a5)
{
  ...
  *(_QWORD *)(a1 + 8) = v7;
  ...
  if ( (int)v6 > 5 )
  {
    v13 = (unsigned int)v11 + v6 * (unsigned int)v7;
    LODWORD(v11) = v11 + v6 * v9;
    result = HIDWORD(v13);
    LODWORD(v12) = HIDWORD(v13) + v6 * v10 + v12;
  }
  else if ( (int)v6 > 0 )
  {
    v14 = (unsigned int)v6;
    do
    {
      v15 = (int)v11 + v9 < (unsigned int)v11;
      LODWORD(v11) = v11 + v9;
      result = HIDWORD(v7) + (unsigned int)v15;
