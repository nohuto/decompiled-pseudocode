/*
 * XREFs of NtUserTransformPoint @ 0x1C0115580
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastError @ 0x1C00A6F5C (UserSetLastError.c)
 *     IsValidKernelDpiAwarenessContext @ 0x1C0115694 (IsValidKernelDpiAwarenessContext.c)
 */
...
__int64 __fastcall NtUserTransformPoint(_QWORD *a1, unsigned int a2, unsigned int a3)
{
  ...
  EnterCrit(0LL, 1LL);
  v14[0] = 0LL;
  if ( (unsigned int)IsValidKernelDpiAwarenessContext(a2)
    && (unsigned int)IsValidKernelDpiAwarenessContext(a3)
    ...
    && v8 )
  {
    ...
    *v10 = *v10;
    ...
    PhysicalToLogicalDPIPoint(&v15, &v15, v7);
    *a1 = v15;
  }
  else
  {
