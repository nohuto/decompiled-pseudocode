/*
 * XREFs of ?vFlushSpriteUpdates@DEVLOCKOBJ@@QEAAXH@Z @ 0x1C0048658
 * Callers:
  ...
  if ( v4 )
  {
    ...
    else
    {
      ...
      if ( (v5 & 0x4000) != 0 && (v5 & 0x40) != 0 && *(_QWORD *)(v4 + 488) )
      {
        if ( *(_DWORD *)(v4 + 504) )
        {
          W32PIDLOCK::vLockSingleThread((W32PIDLOCK *)(*(_QWORD *)(v4 + 512) + 272LL));
          W32PIDLOCK::vUnlockSingleThread((W32PIDLOCK *)(*(_QWORD *)(*(_QWORD *)v2 + 512LL) + 272LL));
        }
      }
    }
  }
