/*
 * XREFs of ?LookUpAndRemove@?$CSortedVector@PEAXPEAX@NSInstrumentation@@QEAA_NAEBQEAXPEAPEAX@Z @ 0x1C02D7DD4
 * Callers:
 ...
 *     ?LowerBound@?$CSortedVector@PEAXPEAX@NSInstrumentation@@QEBA_KAEBQEAX@Z @ 0x1C02D7EC0 (-LowerBound@-$CSortedVector@PEAXPEAX@NSInstrumentation@@QEBA_KAEBQEAX@Z.c)
  ...
  if ( v9 )
  {
    *a3 = v9[1];
    ...
    memmove(
      ...
      16 * (*(_QWORD *)(a1 + 40) - (((__int64)v9 - v10) >> 4) - 1));
    --*(_QWORD *)(a1 + 40);
  }
  else
  {
