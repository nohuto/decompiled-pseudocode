/*
 * XREFs of ?GetReportExtendedUsage@InteractiveControlManager@@QEAAJKKGGGPEAJ@Z @ 0x1C023AF78
 * Callers:
 ...
 *     ?ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z @ 0x1C0240314 (-ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAU_HIDP_PR.c)
 */
        ...
        int *a7)
{
  ...
  LPCGUID v17; // r8
  LPCGUID v18; // r9
  int Device; // [rsp+48h] [rbp-91h] BYREF
  int v21; // [rsp+4Ch] [rbp-8Dh] BYREF
  __int64 v22; // [rsp+50h] [rbp-89h] BYREF
  struct InteractiveControlDevice *v23; // [rsp+58h] [rbp-81h] BYREF
  struct InteractiveControlInput *v24; // [rsp+60h] [rbp-79h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+68h] [rbp-71h] BYREF
  struct _EVENT_DATA_DESCRIPTOR pDesc; // [rsp+88h] [rbp-51h] BYREF
  int *p_Device; // [rsp+98h] [rbp-41h]
  __int64 v28; // [rsp+A0h] [rbp-39h]
  int *v29; // [rsp+A8h] [rbp-31h]
  __int64 v30; // [rsp+B0h] [rbp-29h]
  unsigned __int16 *v31; // [rsp+B8h] [rbp-21h]
  __int64 v32; // [rsp+C0h] [rbp-19h]
  unsigned __int16 *v33; // [rsp+C8h] [rbp-11h]
  __int64 v34; // [rsp+D0h] [rbp-9h]
  unsigned __int16 *v35; // [rsp+D8h] [rbp-1h]
  __int64 v36; // [rsp+E0h] [rbp+7h]
  unsigned __int16 v37; // [rsp+140h] [rbp+67h] BYREF
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    ...
    v34 = 2LL;
    v36 = 2LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02EF638, v11, v12, 8u, &pData);
  }
...
LABEL_10:
  ...
  Device = InteractiveControlParser::ExtractCustomUsage(
             v14,
             *(struct _HIDP_PREPARSED_DATA **)(*((_QWORD *)v24 + 5) + 288LL),
...
LABEL_11:
  if ( (unsigned int)hProvider > 4 )
  {
    ...
    v28 = 4LL;
    v30 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02EF5F8, v17, v18, 5u, &pData);
