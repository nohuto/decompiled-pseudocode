/*
 * XREFs of vBmfdFill_IFIMETRICS @ 0x1C0019518
 * Callers:
 *     bConvertFontRes @ 0x1C00193B8 (bConvertFontRes.c)
 * Callees:
 *     StringCchLengthA @ 0x1C00194CC (StringCchLengthA.c)
 *     vComputeSpecialChars @ 0x1C0019AB8 (vComputeSpecialChars.c)
...
HRESULT __fastcall vBmfdFill_IFIMETRICS(__int64 a1, _QWORD *a2)
{
  ...
  *(_DWORD *)(v5 + 8) = 192;
  ...
  else
  {
    ...
    *(_WORD *)(v5 + 76) = v30;
    v31 = v24 + v26;
    if ( v30 > (int)*(unsigned __int16 *)(a1 + 46) )
      v30 = *(_WORD *)(a1 + 46);
    *(_QWORD *)(v5 + 84) = 0LL;
    *(_QWORD *)(v5 + 92) = 0LL;
    *(_WORD *)(v5 + 76) = v30;
    ...
    *(_WORD *)(v5 + 100) = v32;
    *(_WORD *)(v5 + 104) = v32;
    v33 = -1 - v32 / (int)pcchLength;
    *(_WORD *)(v5 + 102) = v33;
    if ( (__int16)(((v32 + 1) >> 1) - v33 - v26) > 0 )
      *(_WORD *)(v5 + 102) = ((v32 + 1) >> 1) - v26;
    ...
    *(_WORD *)(v5 + 112) = *(_WORD *)(v34 + 40);
    LOWORD(v35) = *(_WORD *)(v34 + 16 * (v35 + 1) + 24) + *(_WORD *)(v34 + 16 * (v35 + 1) + 26);
    *(_DWORD *)(v5 + 40) = 0;
    *(_QWORD *)(v5 + 120) = 1LL;
    *(_WORD *)(v5 + 114) = v35 - 1;
    LODWORD(v35) = *(__int16 *)(v5 + 56);
    *(_WORD *)(v5 + 80) = *(__int16 *)(v5 + 56) / 2;
    *(_WORD *)(v5 + 82) = (int)v35 / 4;
    v36 = *(unsigned __int8 *)(v3 + 70) | (unsigned __int16)(*(unsigned __int8 *)(v3 + 71) << 8);
    *(_DWORD *)(v5 + 132) = v36;
    if ( !v36 )
      v36 = 1;
    v37 = *(unsigned __int8 *)(v3 + 72) | (unsigned __int16)(*(unsigned __int8 *)(v3 + 73) << 8);
    *(_DWORD *)(v5 + 132) = v36;
    if ( !v37 )
      v37 = 1;
    *(_DWORD *)(v5 + 128) = v37;
    ...
    *(_BYTE *)(v5 + 172) = v39;
    ...
    if ( (*(_BYTE *)(v5 + 45) & 0xF0) == 0x20 )
      v40 = 11;
    *(_BYTE *)(v5 + 173) = v40;
    v41 = ((((1374389535 * (unsigned __int64)*(unsigned __int16 *)(v5 + 46)) >> 32) & 0x80000000) != 0LL)
        + *(_WORD *)(v5 + 46) / 0x64u
        + 1;
    *(_BYTE *)(v5 + 174) = v41;
    v42 = *(_WORD *)(v3 + 86);
    ...
    *(_WORD *)(v5 + 180) = 0;
    result = v43 != 0 ? 9 : 0;
    *(_BYTE *)(v5 + 175) = v43 != 0 ? 9 : 0;
    if ( *(_DWORD *)(v5 + 24) )
    {
      *(_WORD *)&v46[4] = *(_WORD *)(v5 + 46);
      *(_WORD *)&v46[6] = *(_WORD *)(v5 + 52);
      *(_DWORD *)&v46[8] = *(_DWORD *)(v5 + 76);
      *(_QWORD *)&v46[12] = *(_QWORD *)(v5 + 136);
