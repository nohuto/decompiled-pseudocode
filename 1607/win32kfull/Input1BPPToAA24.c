/*
 * XREFs of Input1BPPToAA24 @ 0x1C00083F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  else
  {
    ...
    if ( v24 )
    {
      ...
      for ( v4 -= v25; v25; --v25 )
      {
        v26 *= 2;
        v27 = HIBYTE(v26) & 1LL;
        *(_WORD *)v3 = *(__int16 *)((char *)&v48 + 2 * v27 + v27);
        v3[2] = *((_BYTE *)&v48 + 2 * v27 + v27 + 2);
        v3 += 3;
      }
    }
    v28 = v4 >> 3;
    ...
    if ( v45 )
    {
      ...
      do
      {
        v46 *= 2;
        v47 = HIBYTE(v46) & 1LL;
        *(_WORD *)v3 = *(__int16 *)((char *)&v48 + 2 * v47 + v47);
        v3 += 3;
        *(v3 - 1) = *((_BYTE *)&v48 + 2 * v47 + v47 + 2);
        --v45;
      }
      while ( v45 );
    }
