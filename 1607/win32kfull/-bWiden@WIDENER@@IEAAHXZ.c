/*
 * XREFs of ?bWiden@WIDENER@@IEAAHXZ @ 0x1C001346C
 * Callers:
 ...
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C00158BC (-vNextEvent@LINER@@QEAAXXZ.c)
 *     ?efNextStyleLength@STYLER@@IEAA?AVEFLOAT@@XZ @ 0x1C02CA7B0 (-efNextStyleLength@STYLER@@IEAA-AVEFLOAT@@XZ.c)
 ...
 *     ?vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02CB104 (-vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ.c)
 *     ?vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02CB168 (-vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ.c)
 */
