/*
 * XREFs of ??0UMPDSURFOBJ@@QEAA@PEAU_SURFOBJ@@PEAVUMPDOBJ@@@Z @ 0x1C02AAFF4
 * Callers:
 ...
 *     ?ValidateAndReferencePDEV@@YAPEAUHDEV__@@PEAU1@@Z @ 0x1C02AB848 (-ValidateAndReferencePDEV@@YAPEAUHDEV__@@PEAU1@@Z.c)
 */
