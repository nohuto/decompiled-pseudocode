/*
 * XREFs of TouchTargetingClipContact @ 0x1C0247A94
 * Callers:
...
__int64 __fastcall TouchTargetingClipContact(int *a1, int *a2, int a3, int *a4)
{
  ...
  unsigned int v19; // [rsp+24h] [rbp-14h]
  int v20; // [rsp+28h] [rbp-10h]
  unsigned int v21; // [rsp+2Ch] [rbp-Ch]
