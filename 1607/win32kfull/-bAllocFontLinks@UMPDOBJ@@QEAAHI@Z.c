/*
 * XREFs of ?bAllocFontLinks@UMPDOBJ@@QEAAHI@Z @ 0x1C02A3E38
 * Callers:
...
__int64 __fastcall UMPDOBJ::bAllocFontLinks(UMPDOBJ *this, __int64 a2)
{
  unsigned int v2; // ebx
  __int64 v3; // rsi
  __int64 v5; // rcx
  ...
  v2 = 0;
  v3 = (unsigned int)a2;
  if ( (unsigned int)a2 > *((_DWORD *)this + 104) )
  {
    v5 = *((_QWORD *)this + 53);
    if ( v5 )
    {
