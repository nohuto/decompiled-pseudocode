/*
 * XREFs of ?MulUpdateColors@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@@Z @ 0x1C0297B74
 * Callers:
    ...
    do
    {
        ...
        && bIntersect(&v17, (const struct _RECTL *)((char *)v8 + 28), (struct _RECTL *)v16) )
      {
        ...
        if ( (*(_DWORD *)(v11 + 112) & 0x400) != 0 )
          v13 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v9 + 2864);
        else
          v13 = EngCopyBits;
        v7 &= OffCopyBits(
