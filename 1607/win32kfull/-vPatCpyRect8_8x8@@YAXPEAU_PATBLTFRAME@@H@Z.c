/*
 * XREFs of ?vPatCpyRect8_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C02C16D0
 * Callers:
 *     ?vBrushPath8_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z @ 0x1C02CCAE0 (-vBrushPath8_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z.c)
 * Callees:
...
void __fastcall vPatCpyRect8_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  unsigned int *v49; // [rsp+48h] [rbp-B0h]
