/*
 * XREFs of xxxMNSwitchToAlternateMenu @ 0x1C0210154
 * Callers:
...
__int64 __fastcall xxxMNSwitchToAlternateMenu(unsigned __int8 *a1, __int64 a2)
{
  _QWORD *v4; // rsi
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  *(_DWORD *)a1 ^= (*(_DWORD *)a1 ^ (2 * *(_DWORD *)(a2 + 8))) & 4;
  ...
  xxxWindowEvent(4u, *((__int64 **)a1 + 1), (*a1 >> 1) & 2 | 0xFFFFFFFD, 0, 0);
