/*
 * XREFs of ?ChangeWindowTreeProtection@@YAHPEAUtagWND@@H@Z @ 0x1C02311C4
 * Callers:
 ...
 *     ?Add@?$CDynamicArray@PEAUtagWND@@$0HHHAHDFF@@@QEAAJAEBQEAUtagWND@@@Z @ 0x1C023118C (-Add@-$CDynamicArray@PEAUtagWND@@$0HHHAHDFF@@@QEAAJAEBQEAUtagWND@@@Z.c)
...
__int64 __fastcall ChangeWindowTreeProtection(struct tagWND *a1, int a2)
{
  ...
  struct tagWND *v26; // [rsp+60h] [rbp+30h] BYREF
  ...
  if ( v5 )
  {
    ...
    if ( (int)CDynamicArray<tagWND *,2003858261>::Add((__int64)&v23, &v26) >= 0 )
    {
      ...
      v10 = 0LL;
      v11 = *(_QWORD *)(v9 + 376);
      if ( a1 == *(struct tagWND **)(v9 + 1248) )
      {
        v12 = *(_QWORD *)(v9 + 1256);
        if ( v12 )
          v10 = *(_QWORD *)(*(_QWORD *)(v12 + 16) + 376LL);
      }
      for ( i = (unsigned __int64 *)((char *)v5 + 32); *i != 1; ++i )
      {
        ...
        v27 = v14;
        if ( v14 && (*(_BYTE *)(v14 + 51) & 0x20) != 0 )
        {
          v15 = *(_QWORD *)(*(_QWORD *)(v14 + 16) + 376LL);
          if ( a2 )
          {
            if ( v15 != v11 && v15 != v10 )
              goto LABEL_25;
