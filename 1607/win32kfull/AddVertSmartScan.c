/*
 * XREFs of AddVertSmartScan @ 0x1C00C0EA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AddVertSmartScan(int a1, int a2)
{
  ...
  v5 = *(_QWORD *)(qword_1C03293A8 + 8 * v3);
  *(_QWORD *)(qword_1C03293A8 + 8 * v3) = v5 + 4;
  if ( (unsigned __int64)(v5 + 4) > *(_QWORD *)(qword_1C03293B0 + 8 * v3) )
    return 4866LL;
