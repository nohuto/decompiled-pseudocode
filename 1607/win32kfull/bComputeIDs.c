/*
 * XREFs of bComputeIDs @ 0x1C0156C80
 * Callers:
 *     bVerifyTTF @ 0x1C0155F40 (bVerifyTTF.c)
 * Callees:
 *     bVerifyMsftTable @ 0x1C0156EF4 (bVerifyMsftTable.c)
 *     vDetectOldBiDiFonts @ 0x1C0157274 (vDetectOldBiDiFonts.c)
 *     bCvtUnToMac @ 0x1C02413EC (bCvtUnToMac.c)
 *     bVerifyMsftHighByteTable @ 0x1C0241498 (bVerifyMsftHighByteTable.c)
