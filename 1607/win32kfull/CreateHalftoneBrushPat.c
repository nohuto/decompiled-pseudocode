/*
 * XREFs of CreateHalftoneBrushPat @ 0x1C024C2FC
 * Callers:
          ...
          if ( v13 )
          {
            ...
            do
            {
              ...
              if ( v69 )
              {
                ...
                v191 = HIWORD(DWORD1(v182));
                v73 = HIWORD(DWORD1(v182));
                v192 = HIWORD(HIDWORD(v182));
                v74 = WORD1(v183);
                v185 = WORD1(v182);
                do
                {
                  v75 = v73 & ((v17 - v70[1]) >> 16) | v192 & ((v16 - v70[3]) >> 16) | v72 & ((v18 - v70[2]) >> 16) | v74 & ((v17 - v70[4]) >> 16);
                  v76 = *v70;
                  v77 = (v18 - v70[5]) >> 16;
                  v70 += 6;
