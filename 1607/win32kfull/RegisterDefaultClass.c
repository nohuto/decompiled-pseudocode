/*
 * XREFs of RegisterDefaultClass @ 0x1C009FA7C
 * Callers:
...
__int64 __fastcall RegisterDefaultClass(wchar_t *Str1)
{
  ...
  while ( 1 )
  {
    if ( v5 && (*(_DWORD *)v7 & 1) == 0 || ((*(_DWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 784LL) >> v6) & 1) != 0 )
      goto LABEL_10;
    v2 = 0;
    if ( v8 )
      break;
...
LABEL_9:
  ...
  v14 = *((unsigned __int16 *)&gDefaultServerClasses + 24 * v6 + 3) | 0x41;
  ...
  if ( result )
  {
    *(_DWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 784LL) |= 1 << v6;
LABEL_11:
    if ( v2 )
