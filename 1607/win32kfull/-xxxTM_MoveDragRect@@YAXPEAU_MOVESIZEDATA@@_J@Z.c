/*
 * XREFs of ?xxxTM_MoveDragRect@@YAXPEAU_MOVESIZEDATA@@_J@Z @ 0x1C0201E1C
 * Callers:
...
void __fastcall xxxTM_MoveDragRect(struct _MOVESIZEDATA *a1, unsigned int a2)
{
  ...
  __int64 v26[2]; // [rsp+78h] [rbp+Fh] BYREF
...
LABEL_10:
  ...
  if ( *((_DWORD *)a1 + 40) == 9 && ((*(_DWORD *)(*(_QWORD *)a1 + 352LL) & 0xF) == 2 || *((_QWORD *)a1 + 23) == v24) )
  {
    *((_DWORD *)a1 + 38) += LODWORD(v26[0]) - (__int16)a2;
    *((_DWORD *)a1 + 39) += HIDWORD(v26[0]) - SHIWORD(a2);
  }
}
