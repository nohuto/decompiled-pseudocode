/*
 * XREFs of xxxInsertMenuItem @ 0x1C006B448
 * Callers:
...
LABEL_34:
  ...
  *(_QWORD *)(gptiCurrent + 368LL) = &v38;
  ...
  if ( v14 )
  {
    ...
    if ( v5 )
    {
      ...
      v6 = v36;
      if ( v36[8] == *(_QWORD *)(v5 + 16) )
      {
        v26 = *((_DWORD *)v36 + 18);
        if ( v26 >= v7 )
          *((_DWORD *)v36 + 18) = v26 + 1;
      }
      if ( v6[10] == *(_QWORD *)(v5 + 16) )
      {
        v27 = *((unsigned int *)v6 + 22);
        if ( (int)v27 >= v7 )
        {
          *((_DWORD *)v6 + 22) = v27 + 1;
          if ( (_DWORD)v27 == v7 )
          {
            ...
            if ( (v28 & 1) != 0 )
              xxxMNSetGapState(v6[10], v27, v28, 0LL);
          }
        }
      }
      UserAtomicCheck::~UserAtomicCheck((UserAtomicCheck *)v37);
  ...
  *((_DWORD *)v14 + 12) = 0;
  ...
  else
  {
    ...
    MNFreeItem((struct tagMENU *)v30, (__int64)v14, 1);
