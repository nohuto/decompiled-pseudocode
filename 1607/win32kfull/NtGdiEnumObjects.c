/*
 * XREFs of NtGdiEnumObjects @ 0x1C02B5470
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
      ...
      else
      {
        ...
        v12 = (char *)&unk_1C0325E30 + 4 * v10;
        v13 = a2 - 1;
        if ( v13 )
        {
          if ( v13 == 1 )
          {
            for ( i = (char *)&unk_1C0325E30; i < v12; i += 4 )
            {
              *v4 = 0;
              v4[1] = *(_DWORD *)i;
              *((_QWORD *)v4 + 1) = 0LL;
            ...
            for ( j = (unsigned int *)&gaulHatchStyles; j < dword_1C0325E10; ++j )
            {
              for ( k = (char *)&unk_1C0325E30; k < v12; k += 4 )
              {
                *v4 = 2;
                v4[1] = *(_DWORD *)k;
                *((_QWORD *)v4 + 1) = *j;
        ...
        {
          for ( m = dword_1C0325E10; m < dword_1C0325E24; ++m )
          {
            for ( n = (char *)&unk_1C0325E30; n < v12; n += 4 )
            {
              *(_QWORD *)(v4 + 1) = 0LL;
              *v4 = *m;
              v4[3] = *(_DWORD *)n;
