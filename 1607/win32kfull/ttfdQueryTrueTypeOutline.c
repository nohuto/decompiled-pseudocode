/*
 * XREFs of ttfdQueryTrueTypeOutline @ 0x1C0242834
 * Callers:
  ...
  if ( (a3 & 2) != 0 )
  {
    ...
    if ( QuadTrueTypeOutline )
    {
      if ( QuadTrueTypeOutline != -1 )
      {
        ...
        if ( v13 )
        {
          v15 = ttfdQueryQuadTrueTypeOutline(a1, a2, v10, a4, v12, (__int64)v13);
          if ( v15 && v15 != -1 && (unsigned int)bGeneratePath(0LL, v14, v12, &v17, a6, a5) )
            v6 = v17;
          EngFreeMem(v14);
        }
      }
