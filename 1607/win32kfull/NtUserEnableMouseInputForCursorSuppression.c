/*
 * XREFs of NtUserEnableMouseInputForCursorSuppression @ 0x1C012F0D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
    if ( !a1 )
      goto LABEL_5;
    CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v4, v2);
    v7 = 2;
...
LABEL_4:
  if ( !a1 )
  {
    v8 = PsGetCurrentProcessWin32Process(v4, v2);
    v7 = 1;
    *(_DWORD *)(v8 + 768) |= 0x40000u;
    goto LABEL_14;
  }
LABEL_5:
  v3 = 1;
