/*
 * XREFs of InitClipboardILDef @ 0x1C0133D70
 * Callers:
 *     <none>
 * Callees:
 *     ?GetClipILIndexFromName@@YAIPEAGI@Z @ 0x1C01E5D58 (-GetClipILIndexFromName@@YAIPEAGI@Z.c)
 */
...
int InitClipboardILDef()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( !v2
    ...
    || (v5 = v0[9] + 16, (unsigned int)v0[9] >= 0xFFFFFFF0)
    || (v2 = (int *)Win32AllocPool(v5, 1650684757LL), (v1 = v2) == 0LL) )
  {
LABEL_2:
    dword_1C032007C = 0;
    dword_1C0320064 = 0;
  ...
  if ( v0[8] )
  {
    do
    {
      LODWORD(v2) = ZwEnumerateValueKey(KeyHandle, v6, KeyValueBasicInformation, v1, v5, &Length);
      if ( (int)v2 < 0 )
        goto LABEL_2;
      if ( v1[1] == 1 )
      {
        ...
        if ( (_DWORD)v2 != -1 )
        {
          v7 = 3LL * (unsigned int)v2;
          v2 = dword_1C0320034;
          dword_1C0320034[2 * v7] = 1;
        }
      }
    }
    while ( ++v6 < v0[8] );
...
LABEL_3:
  dword_1C03200AC = 1;
  if ( v1 )
    LODWORD(v2) = Win32FreePool(v1, v3, v4);
  if ( v0 )
    LODWORD(v2) = Win32FreePool(v0, v3, v4);
  if ( KeyHandle )
