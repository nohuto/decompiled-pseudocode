/*
 * XREFs of xxEngNineGrid @ 0x1C00D38DC
 * Callers:
        ...
        __int64 a8)
{
  ...
  struct _SURFOBJ *v56; // [rsp+B0h] [rbp-50h]
  ...
  if ( a3 && *(_BYTE *)(a3 + 20) )
    ERECTL::operator*=(&v62, (_DWORD *)(a3 + 4));
  bottom = v62.bottom;
  right = v62.right;
  IsRectEmptyInl(&v62);
  if ( !ERECTL::bEmpty((ERECTL *)&v62) && (v22 & v21) != 0 )
  {
    v25 = right - v24;
    v48 = 0LL;
    v26 = bottom - v23;
    ...
    if ( v27 )
    {
          ...
          do
          {
            ...
            if ( v62.left < v37 )
            {
              do
              {
                ...
                v65 = v39;
                RenderNineGrid(v56, (__int64)&v63, v54, (__int64)v46, v53, v52, v51, v47);
                v37 = v62.right;
                v43 = left;
                left += 256;
              }
      ...
      {
        RenderNineGrid(v56, (__int64)&v62, v54, (__int64)v46, v53, v52, v51, v15);
      }
    }
    KeEnterCriticalRegion();
    ExAcquirePushLockExclusiveEx(&nineGridPushLock, 0LL);
