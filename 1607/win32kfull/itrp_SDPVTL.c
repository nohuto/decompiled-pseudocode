/*
 * XREFs of itrp_SDPVTL @ 0x1C00D0FE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_SDPVTL(__int64 a1, char a2)
{
  ...
  {
    v12 = *(_WORD *)(v27 + 80);
    if ( v12 < 1 || v12 > v11 || (int)v4 < *(__int16 *)(*(_QWORD *)(v27 + 64) + 2LL * (v12 - 1)) + v26 + 1 )
    {
...
LABEL_25:
        ...
        {
          v16 = *(_WORD *)(v14 + 80);
          if ( v16 < 1 || v16 > v7 || (int)v6 < v15 + *(__int16 *)(*(_QWORD *)(v14 + 64) + 2LL * (v16 - 1)) + 1 )
          {
            word_1C0329556 = v4;
            word_1C0329558 = v6;
            itrp_Normalize(
              ...
              &dword_1C03294B8);
            itrp_Normalize(
              (unsigned int)(*(_DWORD *)(*(_QWORD *)(qword_1C03294A8 + 16) + 4 * v6)
                           - *(_DWORD *)(*(_QWORD *)(qword_1C03294B0 + 16) + 4 * v4)),
              (unsigned int)(*(_DWORD *)(*(_QWORD *)(qword_1C03294A8 + 24) + 4 * v6)
                           - *(_DWORD *)(*(_QWORD *)(qword_1C03294B0 + 24) + 4 * v4)),
              &dword_1C03294C0);
            if ( (a2 & 1) != 0 )
            {
              v17 = -HIWORD(dword_1C03294B8);
              HIWORD(dword_1C03294B8) = dword_1C03294B8;
              LOWORD(dword_1C03294B8) = v17;
              v18 = -HIWORD(dword_1C03294C0);
              HIWORD(dword_1C03294C0) = dword_1C03294C0;
              LOWORD(dword_1C03294C0) = v18;
            }
            itrp_ComputeAndCheck_PF_Proj();
            dword_1C032950C = 1;
            dword_1C0329510 = 1;
            v19 = *(_WORD *)(qword_1C03294E0 + 452);
            if ( (v19 & 1) == 0 )
              goto LABEL_32;
            if ( (v19 & 4) != 0 )
            {
              if ( (_WORD)dword_1C03294B8 != 0x4000 )
                goto LABEL_37;
              v21 = HIWORD(dword_1C03294B8) == 0;
            }
            else
            {
              if ( HIWORD(dword_1C03294B8) != 0x4000 )
                goto LABEL_37;
              v21 = (_WORD)dword_1C03294B8 == 0;
            }
            if ( v21 )
            {
LABEL_32:
