/*
 * XREFs of ?GdiUpdateSprite@@YAHPEAUHDEV__@@PEAUHWND__@@PEAXPEAUHDC__@@PEAUtagPOINT@@PEAUtagSIZE@@34KPEAU_BLENDFUNCTION@@KPEAUtagRECT@@@Z @ 0x1C026A840
 * Callers:
    ...
    if ( MetaSprite )
    {
      ...
      if ( v19 )
      {
        do
        {
          ...
          {
            v22 = &v28;
            v28.x = a5->x - *(_DWORD *)(v23 + 2608);
            v28.y = a5->y - *(_DWORD *)(v23 + 2612);
          }
