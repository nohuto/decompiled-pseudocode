/*
 * XREFs of ?vCharPos_H3@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJVEFLOAT@@PEAH@Z @ 0x1C0032270
 * Callers:
        ...
        int *a10)
{
  ...
  int v54; // ecx
  int v55; // eax
  int v56; // [rsp+40h] [rbp-78h] BYREF
  int v57; // [rsp+44h] [rbp-74h]
  struct _GLYPHPOS *v58; // [rsp+50h] [rbp-68h]
  unsigned __int16 *v59; // [rsp+58h] [rbp-60h]
  LONG *p_y; // [rsp+60h] [rbp-58h]
  int v65; // [rsp+D8h] [rbp+20h]
  unsigned int v66; // [rsp+E0h] [rbp+28h]
  ...
  {
    v51 = (__m128i)a9;
    *((_DWORD *)a1 + 1) |= *(_DWORD *)(v13 + 268) & 0x40 | 2;
    if ( v10 )
    {
      v56 = 0;
      bFToL((float)v10 * *(float *)v51.m128i_i32, &v56, 0);
      v52 = v56;
      *((_DWORD *)v15 + 31) = v56;
      if ( v52 > 0 )
        *((_DWORD *)v15 + 1) |= 0x800u;
    ...
    if ( (unsigned __int8)bCalcBreakExtra((unsigned int)_mm_cvtsi128_si32(v51), v12, a8, (char *)v15 + 128) )
    {
      ...
      if ( (int)(v54 + v53 + *((_DWORD *)v15 + 32)) < 0 )
        *((_DWORD *)v15 + 32) = -(v53 + v54);
      ...
      if ( v18 < (unsigned __int16 *)a10 )
      {
        while ( 1 )
        {
          ...
          if ( (unsigned int)v29 >= *((_DWORD *)v27 + 1) )
          {
            ...
            {
              result = (__int64)RFONTOBJ::wpgdGetLinkMetricsPlus(a3, a2, a1, v22, v59, v66, &a6, 1);
          ...
          if ( !*v32 )
          {
            result = RFONTOBJ::bInsertMetricsPlus(a3, v32);
            if ( !(_DWORD)result )
              return result;
...
LABEL_11:
          ...
          if ( !v33->gdf.pgb
            ...
            && !(unsigned int)RFONTOBJ::bInsertGlyphbits(a3, v33) )
          {
            v34 = 0;
            a6 = 0;
          }
    ...
    else if ( (_DWORD)v23 )
    {
      do
      {
        ...
        v24->pgdf = (GLYPHDEF *)RFONTOBJ::pgdDefault(a3, (struct RFONTOBJ *)v18);
        ++v24;
        LODWORD(v23) = v23 - 1;
      }
      while ( (_DWORD)v23 );
...
LABEL_16:
  ...
  v36 = a2;
  result = RFONTOBJ::bGetGlyphMetrics(a3, (struct RFONTOBJ *)(unsigned int)v23, v58, v18, a2, v15);
  if ( !(_DWORD)result )
    return result;
  v19 = v65;
  v21 = a7;
