/*
 * XREFs of ?vSpDeletePerPixelAlphaFromColorKey@@YAXPEAU_SURFOBJ@@KPEAU_RECTL@@PEAE@Z @ 0x1C0273138
 * Callers:
...
void __fastcall vSpDeletePerPixelAlphaFromColorKey(struct _SURFOBJ *a1, int a2, struct _RECTL *a3, unsigned __int8 *a4)
{
  ...
  LONG v20; // [rsp+50h] [rbp-28h]
  LONG v21; // [rsp+54h] [rbp-24h]
  ...
  if ( a1->iBitmapFormat == 6 )
  {
    ...
    if ( !a1->iType )
    {
      ...
      v14 = cy - v11;
      v15 = v6;
      v16 = (__int64)v5->pvScan0 + 4 * (int)v10 + lDelta * v11;
      while ( v14 )
      {
        v17 = v13;
        v10 = v16;
