/*
 * XREFs of ??0UMPDENGCALL@UMPDOBJ@@QEAA@PEAV1@@Z @ 0x1C02AAFAC
 * Callers:
 ...
 *     ?bIncrementEngCallRecursionCount@UMPDOBJ@@AEAAEXZ @ 0x1C02ABEE4 (-bIncrementEngCallRecursionCount@UMPDOBJ@@AEAAEXZ.c)
 */

UMPDOBJ **__fastcall UMPDOBJ::UMPDENGCALL::UMPDENGCALL(UMPDOBJ **this, struct UMPDOBJ *a2)
{
  *this = a2;
  if ( a2 )
  {
    ...
    {
      if ( !UMPDOBJ::bIncrementEngCallRecursionCount(*this) )
        *this = 0LL;
    }
    else
    {
