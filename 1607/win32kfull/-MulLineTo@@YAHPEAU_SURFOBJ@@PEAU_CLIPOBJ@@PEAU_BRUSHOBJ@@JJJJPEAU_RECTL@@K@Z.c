/*
 * XREFs of ?MulLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C02960A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v25[0] )
  {
    for ( i = MSURF::bFindSurface((MSURF *)v20, a1, a2, a8); i; i = MSURF::bNextSurface((MSURF *)v20) )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v22) + 112) & 0x100) != 0 )
        v17 = *(BOOL (__stdcall **)(SURFOBJ *, CLIPOBJ *, BRUSHOBJ *, LONG, LONG, LONG, LONG, RECTL *, MIX))(*((_QWORD *)v21 + 7) + 2960LL);
      else
        v17 = EngLineTo;
      v13 &= OffLineTo(
