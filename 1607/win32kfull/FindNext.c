...
LABEL_9:
    ...
    if ( a5 != (_BYTE *)v10 )
      v17 = a5 + 1;
    v18 = byte_1C02F2C38[(unsigned __int8)(v14 | (*v11 << (a6 + 1))) + 792];
...
LABEL_23:
  ...
  v21 = byte_1C02F2C38[((unsigned __int8)(*v8 << v13) | ((unsigned __int64)(unsigned __int8)*v11 >> v12)) + 536];
  if ( v21 < 8 && v21 >= 2 )
  {
    v22 = StartMask[v21 + 1];
    if ( (v22 & (unsigned __int8)((*v20 << v13) | (*a5 >> v12))) == v22 )
    {
      v23 = a6 - 7 + v21;
      if ( v23 >= 0 )
      {
