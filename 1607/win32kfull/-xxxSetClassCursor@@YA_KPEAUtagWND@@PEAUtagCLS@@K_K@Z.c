/*
 * XREFs of ?xxxSetClassCursor@@YA_KPEAUtagWND@@PEAUtagCLS@@K_K@Z @ 0x1C01DEDA8
 * Callers:
...
_QWORD *__fastcall xxxSetClassCursor(struct tagWND *a1, struct tagCLS *a2, __int64 a3, __int64 a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( !v9 )
    {
      if ( v5 == -14 || (v10 = 1402LL, v5 == -34) )
        v10 = 1414LL;
      UserSetLastError(v10);
    }
  }
  v11 = *((_QWORD *)v6 + 8);
  if ( !(unsigned int)ClassLock(v11, (__int64)v19) )
  {
