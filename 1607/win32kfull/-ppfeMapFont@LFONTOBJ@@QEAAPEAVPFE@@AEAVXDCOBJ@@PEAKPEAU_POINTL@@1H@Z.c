/*
 * XREFs of ?ppfeMapFont@LFONTOBJ@@QEAAPEAVPFE@@AEAVXDCOBJ@@PEAKPEAU_POINTL@@1H@Z @ 0x1C0023DC8
 * Callers:
...
LABEL_33:
        ...
        if ( v17 < v25 )
          memmove((void *)(v15 + 56LL * v7), (const void *)(v15 + 56LL * v17), (unsigned int)(56 * (v25 - v7) - 56));
        --v7;
        v13 = *(_QWORD *)v36;
        --v17;
          ...
          if ( (*(_DWORD *)(*(_QWORD *)a2 + 36LL) & 1) != 0 || *(_DWORD *)(v27 + 32) == 1 )
          {
            if ( *(_QWORD *)(v27 + 512) )
            {
              if ( (*(_DWORD *)(*((_QWORD *)AMatch + 4) + 48LL) & 1) != 0 )
              {
                ...
                if ( v29 != 4 && ((unsigned __int8)(v29 - 5) <= 1u || (gulFontInformation & 0x12) == 0x12) )
                {
                  if ( v29 == 6 )
                    v30 = v28 | 0x50000000;
                  else
