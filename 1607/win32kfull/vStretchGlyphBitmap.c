/*
 * XREFs of vStretchGlyphBitmap @ 0x1C0244B10
 * Callers:
 *     vStretchCvtToBitmap @ 0x1C0244A14 (vStretchCvtToBitmap.c)
 * Callees:
 *     memmove @ 0x1C015A040 (memmove.c)
 *     vEmboldenItalicizeLine @ 0x1C0244958 (vEmboldenItalicizeLine.c)
 */
          ...
          switch ( a7 )
          {
            ...
            case 4:
              *v22 = awStretch4[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[1] = byte_1C03256E9[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[2] = awStretch4[2 * (*a2 & 0xF)];
              v22[3] = byte_1C03256E9[2 * (*a2 & 0xF)];
              v22 += 4;
              break;
            case 5:
              *v22 = awStretch5W1[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[1] = byte_1C0325709[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[2] = awStretch5W2[2 * (((unsigned __int64)(unsigned __int8)*a2 >> 1) & 0xF)];
              v22[3] = byte_1C03256C9[2 * (((unsigned __int64)(unsigned __int8)*a2 >> 1) & 0xF)];
