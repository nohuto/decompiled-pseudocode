/*
 * XREFs of AAHalftoneBitmap @ 0x1C00F36D4
 * Callers:
 ...
 *     ValidateHTSI @ 0x1C00F3984 (ValidateHTSI.c)
...
__int64 __fastcall AAHalftoneBitmap(__int64 *a1)
{
  ...
  __int64 (__fastcall *v41[3])(_QWORD); // [rsp+30h] [rbp-18h] BYREF
