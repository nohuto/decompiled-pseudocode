/*
 * XREFs of ?Transfer@?$CVertexTransfer2@V?$CScale2DOperator@VCVertexXYWColorDUV2@@$00$0A@@@$00$0A@VCVertexXYWColorDUV2@@@@SAXPEBV?$CCommonTransferParameters@VCVertexXYWColorDUV2@@@@AEBVCMILMatrix@@PEBV3@2@Z @ 0x1801975A0
 * Callers:
...
__int64 __fastcall CVertexTransfer2<CScale2DOperator<CVertexXYWColorDUV2,1,0>,1,0,CVertexXYWColorDUV2>::Transfer(
        float *a1,
        const struct CMILMatrix *a2)
{
  ...
  if ( *((_DWORD *)a1 + 9) )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v3 + 12) = result | (((int)(float)((float)BYTE1(v8) * v6) | (((int)(float)((float)BYTE2(v8) * v6) | ((int)(float)((float)HIBYTE(v8) * v6) << 8)) << 8)) << 8);
      v3 += 32LL;
      --v7;
    }
    while ( v7 );
