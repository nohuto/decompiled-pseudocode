/*
 * XREFs of ?CalculateSurfaceSizeAndMapping@CDeviceAlignedIntermediateRealizer@@AEAAXPEAUMilRectF@@PEAI1PEAVCMILMatrix@@@Z @ 0x1801607C4
 * Callers:
 ...
 *     ?AdjustSurfaceSizeAndMappingForMaxIntermediateSize1D@CDeviceAlignedIntermediateRealizer@@CAXPEAIPEAM1@Z @ 0x1801606FC (-AdjustSurfaceSizeAndMappingForMaxIntermediateSize1D@CDeviceAlignedIntermediateRealizer@@CAXPEAI.c)
 *     ?CalculateSurfaceSizeAndMapping1D@CDeviceAlignedIntermediateRealizer@@AEAAXMMPEAIPEAM1@Z @ 0x18016073C (-CalculateSurfaceSizeAndMapping1D@CDeviceAlignedIntermediateRealizer@@AEAAXMMPEAIPEAM1@Z.c)
 */
        ...
        struct CMILMatrix *a5)
{
  ...
  *((_OWORD *)v5 + 3) = _xmm;
  ...
  CDeviceAlignedIntermediateRealizer::CalculateSurfaceSizeAndMapping1D(
    v9,
    *(float *)(v8 + 4),
    COERCE_DOUBLE((unsigned __int64)*(_DWORD *)(v8 + 12)),
    a4,
    &v14,
    &v12);
