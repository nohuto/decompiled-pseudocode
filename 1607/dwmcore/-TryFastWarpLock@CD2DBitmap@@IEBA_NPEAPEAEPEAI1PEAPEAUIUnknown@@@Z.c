/*
 * XREFs of ?TryFastWarpLock@CD2DBitmap@@IEBA_NPEAPEAEPEAI1PEAPEAUIUnknown@@@Z @ 0x180010868
 * Callers:
        ...
        struct IUnknown **a5)
{
  ...
  *v5 = 0LL;
  if ( !*((_BYTE *)this + 257) || *((_BYTE *)this + 256) )
  {
    ...
    v11 = *((_QWORD *)this + 3);
    a5 = 0LL;
    v12 = *(struct IWarpPrivateAPI **)(*(_QWORD *)(v11 + 24) + 552LL);
    *((_WORD *)this + 128) = 256;
    if ( v12 )
    {
      if ( (***((int (__fastcall ****)(_QWORD, GUID *, struct IDXGIResource **))this + 17))(
             *((_QWORD *)this + 17),
             ...
             &v18) >= 0 )
      {
        if ( (int)CWarpLockSubresource::Create(v12, v18, *((_DWORD *)this + 63), (struct CWarpLockSubresource **)&a5) < 0 )
        {
          v10 = (CMILCOMBase *)a5;
        }
        else
      ...
      if ( v18 )
        ((void (__fastcall *)(struct IDXGIResource *))v18->lpVtbl->Release)(v18);
      if ( v10 )
