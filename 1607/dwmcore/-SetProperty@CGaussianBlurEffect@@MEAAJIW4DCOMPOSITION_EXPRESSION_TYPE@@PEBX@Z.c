/*
 * XREFs of ?SetProperty@CGaussianBlurEffect@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180155C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGaussianBlurEffect::SetProperty(_DWORD *a1, int a2, int a3, float *a4)
{
  ...
  v4 = 0;
  if ( a3 != 18 || a2 || (v5 = fmaxf(*a4, 0.0), v6 = (float *)(a1 + 68), a1 == (_DWORD *)-272LL) )
  {
    v4 = -2147024809;
