/*
 * XREFs of ?D2DPresentMultiplaneOverlay@CD2DContext@@QEAAJPEAUIDXGISwapChainDWM1@@IIW4DXGI_HDR_METADATA_TYPE@@PEBXIPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@@Z @ 0x180175F30
 * Callers:
        ...
        const struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *a8)
{
  if ( (a4 & 1) != 0 )
    ...
    return (*(__int64 (__fastcall **)(_QWORD, struct IDXGISwapChainDWM1 *, __int64, _QWORD, enum DXGI_HDR_METADATA_TYPE, const void *, const struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *, unsigned int))(**((_QWORD **)this + 6) + 112LL))(
             *((_QWORD *)this + 6),
             a2,
             a3,
             a4,
