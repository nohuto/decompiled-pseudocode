/*
 * XREFs of ?SetSourceModifications@CMILBrushBitmap@@QEAAJU?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@PEBU_D3DCOLORVALUE@@1@Z @ 0x1800846E8
 * Callers:
...
__int64 __fastcall CMILBrushBitmap::SetSourceModifications(__int64 a1, int a2, _OWORD *a3, _OWORD *a4)
{
  ...
  *(_DWORD *)(a1 + 264) = a2;
  ...
  if ( !a3
    || !a4
    || (v5 = (CColorKey *)(a1 + 228), *(_OWORD *)v5 = *a3, *(_OWORD *)(v4 + 244) = *a4, !CColorKey::IsNonEmpty(v5))
    || *v6 > 1.0
    || v6[1] > 1.0
    || v6[2] > 1.0
    || v6[3] > 1.0
