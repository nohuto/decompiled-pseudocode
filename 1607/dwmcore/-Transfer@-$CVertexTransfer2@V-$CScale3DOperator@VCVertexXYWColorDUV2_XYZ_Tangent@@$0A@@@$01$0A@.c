/*
 * XREFs of ?Transfer@?$CVertexTransfer2@V?$CScale3DOperator@VCVertexXYWColorDUV2_XYZ_Tangent@@$0A@@@$01$0A@VCVertexXYWColorDUV2_XYZ_Tangent@@@@SAXPEBV?$CCommonTransferParameters@VCVertexXYWColorDUV2_XYZ_Tangent@@@@AEBVCMILMatrix@@PEBV3@2@Z @ 0x180198860
 * Callers:
...
__int64 __fastcall CVertexTransfer2<CScale3DOperator<CVertexXYWColorDUV2_XYZ_Tangent,0>,2,0,CVertexXYWColorDUV2_XYZ_Tangent>::Transfer(
        __int64 *a1,
        float *a2,
        CMILMatrix *a3)
{
  ...
  if ( (_DWORD)v12 )
  {
    do
    {
      ...
      *(_DWORD *)(v3 + 12) = (int)(float)(unsigned __int8)*(_DWORD *)(v6 + 12) | (((int)(float)(unsigned __int8)BYTE1(*(_DWORD *)(v6 + 12)) | (((int)(float)(unsigned __int8)BYTE2(*(_DWORD *)(v6 + 12)) | ((int)(float)((float)HIBYTE(*(_DWORD *)(v6 + 12)) * v11) << 8)) << 8)) << 8);
