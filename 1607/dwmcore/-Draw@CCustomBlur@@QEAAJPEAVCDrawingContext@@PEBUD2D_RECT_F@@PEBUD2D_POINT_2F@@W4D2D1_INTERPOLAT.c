/*
 * XREFs of ?Draw@CCustomBlur@@QEAAJPEAVCDrawingContext@@PEBUD2D_RECT_F@@PEBUD2D_POINT_2F@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_COMPOSITE_MODE@@@Z @ 0x180169E48
 * Callers:
        ...
        const struct D2D_POINT_2F *a4)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_QWORD, char *, _QWORD, const struct D2D_RECT_F *, _QWORD, int, int))(**((_QWORD **)a2 + 57) + 96LL))(
         *((_QWORD *)a2 + 57),
         (char *)a2 + 128,
         *((_QWORD *)this + 7),
         a3,
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0xD7u);
  return v5;
}
