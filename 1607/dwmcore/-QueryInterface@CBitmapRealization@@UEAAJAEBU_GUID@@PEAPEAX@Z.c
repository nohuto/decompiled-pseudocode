/*
 * XREFs of ?QueryInterface@CBitmapRealization@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180090050
 * Callers:
 ...
 *     ?QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C2820 (-QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C2830 (-QueryInterface@CBitmapRealization@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C2840 (-QueryInterface@CBitmapRealization@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
