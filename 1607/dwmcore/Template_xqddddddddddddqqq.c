/*
 * XREFs of Template_xqddddddddddddqqq @ 0x18012A548
 * Callers:
...
ULONG __fastcall Template_xqddddddddddddqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a19)
{
  ...
  int v54; // [rsp+168h] [rbp+68h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v50 = 4LL;
  v52 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_OVERLAY_CHECKSUPPORT, 0x11u, &UserData);
}
