/*
 * XREFs of ?HasSecondaryRepresentations@CVisual@@QEAA_NXZ @ 0x180138960
 * Callers:
...
char __fastcall CVisual::HasSecondaryRepresentations(CVisual *this)
{
  ...
  v1 = 0;
  for ( i = this; i; i = (CVisual *)*((_QWORD *)i + 18) )
  {
    v3 = *((_QWORD *)i + 3);
    if ( (v3 & 2) != 0 )
    ...
    if ( (_DWORD)v3 )
    {
      while ( 1 )
      {
        ...
        if ( (*(unsigned __int8 (__fastcall **)(unsigned __int64, __int64))(*(_QWORD *)v5 + 48LL))(v5, 57LL) )
          break;
