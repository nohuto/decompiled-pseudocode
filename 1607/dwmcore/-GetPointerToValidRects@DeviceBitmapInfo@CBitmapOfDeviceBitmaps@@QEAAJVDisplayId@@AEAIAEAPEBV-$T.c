/*
 * XREFs of ?GetPointerToValidRects@DeviceBitmapInfo@CBitmapOfDeviceBitmaps@@QEAAJVDisplayId@@AEAIAEAPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801796C4
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( !DisplayId::IsSpecific((CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)((char *)this + 4)) || *v9 == (_DWORD)v8 )
  {
    if ( *((_QWORD *)this + 5) )
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x8BEu);
      }
      else
      {
