/*
 * XREFs of ?MetaBitmapRenderTargetSetColorTransform@CChannel@@UEAAJII@Z @ 0x180115430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MetaBitmapRenderTargetSetColorTransform(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
