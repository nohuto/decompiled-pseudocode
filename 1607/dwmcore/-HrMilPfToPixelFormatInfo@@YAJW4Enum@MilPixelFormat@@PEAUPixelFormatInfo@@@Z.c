/*
 * XREFs of ?HrMilPfToPixelFormatInfo@@YAJW4Enum@MilPixelFormat@@PEAUPixelFormatInfo@@@Z @ 0x1800B3C3C
 * Callers:
...
LABEL_6:
  *a2 = v3;
  ...
  {
    v2 = -2003292288;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003292288, 0x338u);
    return v2;
  }
  if ( a1 > 21 )
  {
...
LABEL_45:
    v2 = -2003292344;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003292344, 0x34Cu);
    return v2;
  }
LABEL_17:
  a2[2] = 1;
