/*
 * XREFs of ?AddToPreviousFrameInvalidRegion@CHwFullScreenRenderTarget@@MEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180011A50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwFullScreenRenderTarget::AddToPreviousFrameInvalidRegion(__int64 a1, int *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 344) )
  {
    ...
    {
      SetLastError(0);
      if ( !CombineRgn(*(HRGN *)(a1 + 344), *(HRGN *)(a1 + 344), RectRgn, 2) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x474u);
      }
    ...
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x46Fu);
    }
  }
  else
  {
    ...
    *(_QWORD *)(a1 + 344) = v7;
    if ( !v7 )
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x468u);
    }
  }
