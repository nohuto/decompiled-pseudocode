/*
 * XREFs of ?FlipChainResetSourceFrameCounters@CChannel@@UEAAJI@Z @ 0x180114D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::FlipChainResetSourceFrameCounters(CChannel *this, int a2)
{
  unsigned int v4; // ebx
