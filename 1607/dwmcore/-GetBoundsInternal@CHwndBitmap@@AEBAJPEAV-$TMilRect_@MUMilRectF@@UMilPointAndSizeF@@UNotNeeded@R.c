/*
 * XREFs of ?GetBoundsInternal@CHwndBitmap@@AEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000A4F4
 * Callers:
...
__int64 __fastcall CHwndBitmap::GetBoundsInternal(__int64 a1, __int64 a2)
{
  ...
  v4 = 0;
  if ( CHwndBitmap::IsValidVisual((CHwndBitmap *)a1) && (v5 = *(_QWORD *)(a1 + 536)) != 0 )
  {
    ...
    {
      if ( *(_BYTE *)(a1 + 544) && CVisual::GetEffectiveOffset(*(CVisual **)(a1 + 528), &v9, &v8, &v10) )
      {
