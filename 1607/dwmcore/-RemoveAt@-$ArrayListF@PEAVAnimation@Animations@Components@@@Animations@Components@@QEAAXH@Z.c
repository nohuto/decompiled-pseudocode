/*
 * XREFs of ?RemoveAt@?$ArrayListF@PEAVAnimation@Animations@Components@@@Animations@Components@@QEAAXH@Z @ 0x18001D898
 * Callers:
...
void __fastcall Components::Animations::ArrayListF<Components::Animations::Animation *>::RemoveAt(__int64 a1, int a2)
{
  ...
  if ( a2 < v3 && a2 >= 0 )
  {
    ...
    v4 = *(_DWORD *)(a1 + 8);
    if ( v4 == 1 )
      Components::Animations::ArrayListF<Components::Animations::Animation *>::RemoveAll(a1);
    else
