/*
 * XREFs of ?HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ @ 0x18001236C
 * Callers:
 ...
 *     ?GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z @ 0x1800125E0 (-GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z.c)
 * Callees:
 *     <none>
 */
