/*
 * XREFs of ?RemoveHwndBitmap@CWindowManager@@QEAAJPEAVCHwndBitmap@@@Z @ 0x18011AF78
 * Callers:
...
__int64 __fastcall CWindowManager::RemoveHwndBitmap(CWindowManager *this, struct CHwndBitmap *a2)
{
  ...
  v11 = 0LL;
  Entry = CWindowManager::FindEntry(this, *((_QWORD *)a2 + 65), &v11);
  if ( Entry >= 0 )
  {
    v5 = v11;
    ...
    else if ( !*((_QWORD *)v5 + 1) && !*((_QWORD *)v5 + 2) )
    {
      v7 = *((_QWORD *)v5 + 3);
      if ( (v7 & 2) != 0 )
      ...
      if ( !v8 )
      {
        v9 = CWindowManager::RemoveEntry(this, *((_QWORD *)a2 + 65));
        Entry = v9;
        if ( v9 < 0 )
