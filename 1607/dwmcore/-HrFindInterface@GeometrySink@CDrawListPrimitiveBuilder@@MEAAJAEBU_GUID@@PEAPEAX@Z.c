/*
 * XREFs of ?HrFindInterface@GeometrySink@CDrawListPrimitiveBuilder@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801338B0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467262, 0xBDu);
  }
  else
  {
    v5 = (char *)this + 16;
