/*
 * XREFs of ?RegisterForSignaling@CGdiSpriteBitmap@@UEAAJXZ @ 0x18002AE70
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::RegisterForSignaling(CGdiSpriteBitmap *this)
{
  ...
  if ( *((char *)this + 372) >= 0 )
  {
    ...
    if ( v4 == 1 )
    {
      v9 = CRedirectedGDISurface::SetInformation(v3, 1LL, 4LL, &v14);
      v13 = v9;
      v1 = v9;
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_1801B0908, 1u, v9, 0x6ECu);
        goto LABEL_9;
      }
    }
    else if ( v4 == 2 )
      ...
      if ( *((_DWORD *)this + 92) )
      {
        while ( 1 )
        {
          ...
          *(_QWORD *)&v12[12] = *((_QWORD *)this + v5 + 14);
          v7 = CRedirectedGDISurface::SetInformation(v6, 4LL, 32LL, &v10);
          v13 = v7;
          v1 = v7;
          if ( v7 < 0 )
            break;
        ...
        MilInstrumentationCheckHR(0x14u, &dword_1801B0908, 1u, v7, 0x6FAu);
        goto LABEL_9;
      }
    }
LABEL_8:
...
LABEL_9:
  TranslateDXGIorD3DErrorInContext(v1, 11LL, &v13);
  return v13;
}
