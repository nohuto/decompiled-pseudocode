/*
 * XREFs of ?SetSize@?$ArrayListF@UKeyframe@Sequence@Animations@Components@@@Animations@Components@@QEAAJH@Z @ 0x1800AF69C
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 < *(_DWORD *)(a1 + 8) )
  {
    v6 = a2;
    do
      Components::Animations::Sequence::Keyframe::~Keyframe((Components::Animations::Sequence::Keyframe *)(*(_QWORD *)a1 + 24LL * v6++));
