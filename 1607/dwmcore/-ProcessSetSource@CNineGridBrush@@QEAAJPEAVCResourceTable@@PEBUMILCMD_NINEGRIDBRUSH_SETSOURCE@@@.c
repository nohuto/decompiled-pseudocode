/*
 * XREFs of ?ProcessSetSource@CNineGridBrush@@QEAAJPEAVCResourceTable@@PEBUMILCMD_NINEGRIDBRUSH_SETSOURCE@@@Z @ 0x18010D828
 * Callers:
        ...
        const struct MILCMD_NINEGRIDBRUSH_SETSOURCE *a3)
{
  ...
  {
    v6 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x110u);
    return v6;
  }
...
LABEL_9:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x113u);
  return v6;
}
