/*
 * XREFs of ?FlipChainUpdateMargins@CChannel@@UEAAJIAEBU_MARGINS@@@Z @ 0x180114DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::FlipChainUpdateMargins(CChannel *this, int a2, const struct _MARGINS *a3)
{
  __int128 v6; // xmm0
  unsigned int v7; // ebx
