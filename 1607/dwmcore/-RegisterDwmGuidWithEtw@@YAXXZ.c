/*
 * XREFs of ?RegisterDwmGuidWithEtw@@YAXXZ @ 0x1800A9220
 * Callers:
 ...
 *     McGenEventRegister @ 0x1800A9438 (McGenEventRegister.c)
...
void RegisterDwmGuidWithEtw(void)
{
  ...
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801EA780, v2, v3);
  ...
  if ( ProcessIdToSessionId(CurrentProcessId, &pSessionId) )
  {
    ...
    if ( (int)StringCchPrintfW(Value, 0x22uLL, (size_t *)L"%s_%08X", L"DwmInitSessionActivityId", pdwType) >= 0 )
    {
        ...
        && (qword_1801EA758 & 0x400000000000LL) == qword_1801EA758 )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1801C5110, v7, v8, 4u, &pData);
      }
    }
  }
}
