/*
 * XREFs of ?ProcessUpdate@CGeometry2DGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GEOMETRY2DGROUP@@PEBXI@Z @ 0x180106F3C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v8 = UnmarshalResourceArray(&v14, &a5, v5, 1LL, v13, (unsigned int *)this + 38, (__int64 **)&v15, (__int64)a2, 1);
  v9 = v15;
  v10 = v8;
  *((_QWORD *)this + 20) = v15;
  if ( v8 < 0 )
  ...
  v11 = CResource::RegisterNNotifiersInternal(this, v9, *((_DWORD *)this + 38));
  v10 = v11;
  if ( v11 < 0 )
