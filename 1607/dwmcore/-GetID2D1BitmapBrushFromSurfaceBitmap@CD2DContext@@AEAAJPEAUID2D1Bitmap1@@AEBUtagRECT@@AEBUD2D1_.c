/*
 * XREFs of ?GetID2D1BitmapBrushFromSurfaceBitmap@CD2DContext@@AEAAJPEAUID2D1Bitmap1@@AEBUtagRECT@@AEBUD2D1_BITMAP_BRUSH_PROPERTIES@@PEAPEAUID2D1BitmapBrush@@@Z @ 0x1801775D0
 * Callers:
        ...
        struct ID2D1BitmapBrush **a5)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, struct ID2D1Bitmap1 *, const struct D2D1_BITMAP_BRUSH_PROPERTIES *, float *, struct ID2D1BitmapBrush **))(**((_QWORD **)this + 5) + 56LL))(
           *((_QWORD *)this + 5),
           a2,
           a4,
           v10,
