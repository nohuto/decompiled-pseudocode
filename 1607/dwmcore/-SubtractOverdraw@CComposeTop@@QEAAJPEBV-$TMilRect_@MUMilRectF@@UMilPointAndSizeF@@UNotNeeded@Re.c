/*
 * XREFs of ?SubtractOverdraw@CComposeTop@@QEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800AA8B8
 * Callers:
...
__int64 __fastcall CComposeTop::SubtractOverdraw(__int64 a1, const struct MilRectF *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 160) )
  {
    ...
    v5 = CShape::Combine(*(_QWORD *)(a1 + 160), v4, (__int64)v11, a1 + 92, 2, &v10);
    v2 = v5;
    if ( v5 < 0 )
    {
    ...
    else
    {
      ...
      v8 = *(void (__fastcall ****)(_QWORD, __int64))(a1 + 160);
      if ( v7 )
      {
        if ( v8 )
          (**v8)(v8, 1LL);
