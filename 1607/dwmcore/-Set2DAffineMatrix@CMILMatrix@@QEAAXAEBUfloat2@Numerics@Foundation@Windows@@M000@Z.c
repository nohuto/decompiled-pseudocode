/*
 * XREFs of ?Set2DAffineMatrix@CMILMatrix@@QEAAXAEBUfloat2@Numerics@Foundation@Windows@@M000@Z @ 0x1801623E0
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::float2 *a6)
{
  ...
  __m128 v24[4]; // [rsp+88h] [rbp-80h] BYREF
  ...
  v19 = 1065353216;
  v23 = 1065353216;
  v8 = Windows::Foundation::Numerics::operator*((__int64)v26, (__int64)v25, v24);
  v9 = (_OWORD *)Windows::Foundation::Numerics::operator*((__int64)v27, v8, (__m128 *)((char *)v15 + 4));
  *(_OWORD *)this = *v9;
  *((_OWORD *)this + 1) = v9[1];
  *((_OWORD *)this + 2) = v9[2];
  v10 = v9[3];
