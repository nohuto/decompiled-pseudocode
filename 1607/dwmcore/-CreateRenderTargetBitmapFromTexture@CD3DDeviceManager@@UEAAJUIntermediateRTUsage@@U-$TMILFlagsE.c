/*
 * XREFs of ?CreateRenderTargetBitmapFromTexture@CD3DDeviceManager@@UEAAJUIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@AEBU_GUID@@U_LUID@@VDisplayId@@PEAUID3D11Texture2D@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x180112BF0
 * Callers:
        ...
        _QWORD *a9)
{
  ...
  *a9 = 0LL;
  v23 = 0LL;
  v16 = CD3DDeviceManager::ValidateAdapterLuidAndDisplayId(a1 - 8, v13, v11);
  v17 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x644u);
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_1801C7480, 1u, v17, 0x74Cu);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1801C7480, 1u, D3DDevice, 0x74Eu);
      v12 = v22;
      goto LABEL_13;
    }
    v12 = v22;
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1801C7480, 1u, v19, 0x757u);
      v14 = v23;
    }
    else
    {
      ...
      v17 = v20;
      if ( v20 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_1801C7480, 1u, v20, 0x75Au);
    }
  }
  if ( v14 )
