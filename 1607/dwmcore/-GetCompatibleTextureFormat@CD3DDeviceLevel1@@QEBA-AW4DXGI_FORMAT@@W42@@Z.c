/*
 * XREFs of ?GetCompatibleTextureFormat@CD3DDeviceLevel1@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x180016790
 * Callers:
...
__int64 __fastcall CD3DDeviceLevel1::GetCompatibleTextureFormat(CD3DDeviceLevel1 *this, enum DXGI_FORMAT a2)
{
  ...
  v5 = v4 - 4;
  if ( !v5 )
    return *((unsigned int *)this + 183);
  v6 = v5 - 33;
  if ( !v6 )
    return *((unsigned int *)this + 181);
  v7 = v6 - 4;
  if ( !v7 )
    return *((unsigned int *)this + 182);
  v8 = v7 - 22;
  if ( !v8 )
    return *((unsigned int *)this + 185);
  if ( v8 == 1 )
