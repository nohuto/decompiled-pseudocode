/*
 * XREFs of ?DrawAtlasedRects@CRenderDataBuilder@@UEAAJII@Z @ 0x1800AFF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRenderDataBuilder::DrawAtlasedRects(CRenderDataBuilder *this, int a2, int a3)
{
  int v6; // eax
  unsigned int v7; // ebx
  __int64 v8; // rcx
