/*
 * XREFs of ?ProcessCreate@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUMILCMD_WINDOWNODE_CREATE@@@Z @ 0x180025B70
 * Callers:
        ...
        const struct MILCMD_WINDOWNODE_CREATE *a3)
{
  ...
  *((_QWORD *)this + 79) = *((_QWORD *)a3 + 2);
  *((_QWORD *)this + 80) = *((_QWORD *)a3 + 1);
