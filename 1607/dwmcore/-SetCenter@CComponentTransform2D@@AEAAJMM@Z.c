/*
 * XREFs of ?SetCenter@CComponentTransform2D@@AEAAJMM@Z @ 0x1800206C8
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetCenter(CComponentTransform2D *this, double a2, double a3)
{
  ...
  v3 = 0;
  if ( *((float *)this + 36) != *(float *)&a2 || *((float *)this + 37) != *(float *)&a3 )
  {
    *((_DWORD *)this + 36) = LODWORD(a2);
    *((_DWORD *)this + 37) = LODWORD(a3);
    CResource::NotifyOnChanged(this, 0LL, 0LL);
    v7 = _mm_unpacklo_ps(*(__m128 *)&a2, *(__m128 *)&a3).m128_u64[0];
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 0x3E9u, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x106u);
    else
      CResource::InvalidateAnimationSources(this, 0x3E9u);
  }
  return v3;
}
