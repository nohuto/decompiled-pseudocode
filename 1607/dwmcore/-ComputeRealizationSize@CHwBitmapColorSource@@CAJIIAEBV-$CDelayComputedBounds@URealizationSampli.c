/*
 * XREFs of ?ComputeRealizationSize@CHwBitmapColorSource@@CAJIIAEBV?$CDelayComputedBounds@URealizationSampling@CoordinateSpace@@@@PEBV?$CMultiOutSpaceMatrix@URealizationSampling@CoordinateSpace@@@@W4Enum@MilBitmapWrapMode@@HMHAEAURealizationParameters@1@@Z @ 0x180080CBC
 * Callers:
 ...
 *     ?ComputePrefilteringDimensions@CMILMatrix@@QEBAXIIMAEAI0@Z @ 0x18005AFC4 (-ComputePrefilteringDimensions@CMILMatrix@@QEBAXIIMAEAI0@Z.c)
        ...
        __int64 a9)
{
  ...
  *(_DWORD *)(a9 + 40) = v18;
  ...
  {
    *(_BYTE *)(a9 + 88) = 1;
    if ( (unsigned __int8)CHwBitmapColorSource::ComputeMinimumRealizationBounds(v11, v13, a9 + 28) )
    {
    ...
    {
      v10 = -2147467263;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467263, 0x439u);
      return v10;
    }
