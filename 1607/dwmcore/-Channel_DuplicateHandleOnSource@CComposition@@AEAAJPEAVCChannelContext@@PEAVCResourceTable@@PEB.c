/*
 * XREFs of ?Channel_DuplicateHandleOnSource@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_CHANNEL_DUPLICATEHANDLEONSOURCE@@@Z @ 0x18003BBD0
 * Callers:
        ...
        const struct MILCMD_CHANNEL_DUPLICATEHANDLEONSOURCE *a4)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, AttachedChannel, 0x995u);
  }
  else
  {
    ...
    v8 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x99Du);
  }
  if ( v11 )
