/*
 * XREFs of ??0CHwBitmapCache@@AEAA@PEAVIMILResourceCache@@PEAVCD3DDeviceLevel1@@@Z @ 0x180081A60
 * Callers:
        ...
        struct CD3DDeviceLevel1 *a3)
{
  ...
  *v4 = &CHwBitmapCache::`vftable'{for `CMILPoolResource'};
  v4[3] = &CHwBitmapCache::`vftable'{for `IDeviceResource'};
