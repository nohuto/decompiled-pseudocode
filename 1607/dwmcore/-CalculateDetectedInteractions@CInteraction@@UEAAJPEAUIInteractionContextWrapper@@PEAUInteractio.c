/*
 * XREFs of ?CalculateDetectedInteractions@CInteraction@@UEAAJPEAUIInteractionContextWrapper@@PEAUInteractionAxisGroup@@PEAH12PEAV?$DynArray@PEAUInteractionConfigurationGroup@@$0A@@@2@Z @ 0x180145180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteraction::CalculateDetectedInteractions(
        ...
        __int64 a8)
{
  return CInteractionProcessor::CalculateDetectedInteractions(a1 + 408, a2, a3, a4, a5, a6, a7, a8);
}
