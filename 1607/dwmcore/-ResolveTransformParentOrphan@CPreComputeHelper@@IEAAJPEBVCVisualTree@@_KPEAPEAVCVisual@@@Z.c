/*
 * XREFs of ?ResolveTransformParentOrphan@CPreComputeHelper@@IEAAJPEBVCVisualTree@@_KPEAPEAVCVisual@@@Z @ 0x18018DCD0
 * Callers:
        ...
        struct CVisual **a4)
{
  ...
  *a4 = 0LL;
  while ( *v5 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x135u);
      return v4;
    }
    v10 = v15;
