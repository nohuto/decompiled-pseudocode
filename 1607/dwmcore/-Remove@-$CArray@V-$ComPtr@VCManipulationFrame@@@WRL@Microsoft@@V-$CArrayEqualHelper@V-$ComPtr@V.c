/*
 * XREFs of ?Remove@?$CArray@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@V?$CArrayEqualHelper@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@@@QEAAHAEBV?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@Z @ 0x180106A50
 * Callers:
...
LABEL_5:
  ...
  {
    Microsoft::WRL::ComPtr<IAccelerator>::InternalRelease((__int64 *)(*(_QWORD *)a1 + 8LL * v2));
    v8 = *(_DWORD *)(a1 + 8);
    if ( v2 + 1 != v8 )
