/*
 * XREFs of ?RemoveListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z @ 0x180194380
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Components::Animations::Dwm__IListener *a2)
{
  ...
  v3 = 0;
  v4 = (struct Components::Animations::Dwm__IListener **)*((_QWORD *)this + 2);
  if ( v4 )
    v6 = *((_DWORD *)v4 - 2);
  else
    v6 = 0;
