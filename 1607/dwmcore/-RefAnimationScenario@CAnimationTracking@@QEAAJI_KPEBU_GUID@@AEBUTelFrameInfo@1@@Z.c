/*
 * XREFs of ?RefAnimationScenario@CAnimationTracking@@QEAAJI_KPEBU_GUID@@AEBUTelFrameInfo@1@@Z @ 0x1800A12DC
 * Callers:
  ...
  if ( v25 )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        *(_QWORD *)(*((_QWORD *)v25 + 20) + 8LL * v12) = v24;
        *((_DWORD *)v10 + 46) = v13;
      }
    }
