/*
 * XREFs of ?SetBottomLeftRadiusY@CRectangleGeometry@@AEAAJM@Z @ 0x180095A28
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetBottomLeftRadiusY(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 53) != a2 )
  {
    *((float *)this + 53) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyFloatPropertyChanged(this, 10LL, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x253u);
    else
      CResource::InvalidateAnimationSources(this, 10);
  }
  return v2;
}
