/*
 * XREFs of ?GetBounds@CHwDisplayRenderTarget@@UEAAXPEAUMilRectF@@@Z @ 0x18008FB90
 * Callers:
 *     ?GetBounds@CHwDisplayRenderTarget@@WLA@EAAXPEAUMilRectF@@@Z @ 0x1800C15D0 (-GetBounds@CHwDisplayRenderTarget@@WLA@EAAXPEAUMilRectF@@@Z.c)
 * Callees:
