/*
 * XREFs of ?SetAutoReset_RenderThread@CManipulation@@QEAAJ_N@Z @ 0x180145D34
 * Callers:
...
__int64 __fastcall CManipulation::SetAutoReset_RenderThread(CManipulation *this, char a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, RenderToManipulationMsgInfo, 0x1EFu);
  }
  else
  {
    ...
    v10 = v8;
    v9 = this;
    v6 = CoreUICallSend(v4, &v10, 1LL, 4LL, 2, &unk_1801AD3BC, (unsigned int)&v9);
    v5 = v6;
    if ( v6 < 0 )
