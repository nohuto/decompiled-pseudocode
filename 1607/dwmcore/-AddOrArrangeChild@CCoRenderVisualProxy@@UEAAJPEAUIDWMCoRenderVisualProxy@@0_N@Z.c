/*
 * XREFs of ?AddOrArrangeChild@CCoRenderVisualProxy@@UEAAJPEAUIDWMCoRenderVisualProxy@@0_N@Z @ 0x1801254C0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  if ( a3 )
  {
    ...
    do
    {
      v12 = CPtrArrayBase::operator[]((__int64 *)(v4 + 136), (int)v11);
      if ( v12 == v14 )
        break;
      LODWORD(v11) = v11 + 1;
    }
...
LABEL_18:
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( (*v9 & 2) != 0 )
      ...
      LODWORD(v16) = v16 & 1;
    if ( v15 < (int)v16 && CPtrArrayBase::operator[]((__int64 *)(v4 + 136), v15) == *((_QWORD *)a2 + 3) )
      LODWORD(v11) = -1;
  }
  if ( (int)v11 >= 0 )
  {
    v17 = *((_QWORD *)a2 + 3);
    if ( *(_QWORD *)(v17 + 144) != v4 )
      goto LABEL_36;
    v18 = 0;
    if ( (int)v11 > 0 )
    {
      while ( 1 )
      {
        v19 = CPtrArrayBase::operator[]((__int64 *)(v4 + 136), v18);
        if ( v19 == v17 )
          break;
        v18 = v20 + 1;
        if ( v18 >= (int)v11 )
...
LABEL_33:
    if ( CPtrArrayBase::Remove((CPtrArrayBase *)(v4 + 136), v17) )
    {
      inserted = CPtrArrayBase::InsertAt((CPtrArrayBase *)(v4 + 136), *((_QWORD *)a2 + 3), (int)v11);
      v5 = inserted;
      if ( inserted < 0 )
      {
        v23 = 257;
LABEL_40:
    ...
    {
LABEL_36:
      inserted = CVisual::InsertChildAt(*((CComposition ***)this + 3), *((CVisual ***)a2 + 3), v11, 0);
      v5 = inserted;
      if ( inserted < 0 )
      {
        v23 = 261;
      ...
      if ( (*(unsigned int (__fastcall **)(_QWORD))(**((_QWORD **)a2 + 3) + 200LL))(*((_QWORD *)a2 + 3)) != 7 )
      {
        *(_BYTE *)(*((_QWORD *)a2 + 3) + 154LL) |= 8u;
        CVisual::PropagateFlags(*((struct CVisual **)a2 + 3), 1, 0, 0, 0, 0, 0);
      }
    }
  }
  return v5;
