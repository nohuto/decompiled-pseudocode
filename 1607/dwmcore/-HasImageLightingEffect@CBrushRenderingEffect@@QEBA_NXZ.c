/*
 * XREFs of ?HasImageLightingEffect@CBrushRenderingEffect@@QEBA_NXZ @ 0x18019542C
 * Callers:
...
char __fastcall CBrushRenderingEffect::HasImageLightingEffect(CBrushRenderingEffect *this)
{
  unsigned int v1; // edi
