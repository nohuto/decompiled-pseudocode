/*
 * XREFs of ?Draw@CSnapshot@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180143450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSnapshot::Draw(__int64 a1, CDrawingContext *a2)
{
  ...
  if ( v4 && !*(_BYTE *)(a1 + 136) )
  {
    *(_BYTE *)(a1 + 136) = 1;
    ...
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x6Au);
    *(_BYTE *)(a1 + 136) = 0;
  }
  return v3;
}
