/*
 * XREFs of ?ProcessUpdate@CGaussianBlurEffect@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GAUSSIANBLUREFFECT@@@Z @ 0x1800146E4
 * Callers:
...
__int64 __fastcall CGaussianBlurEffect::ProcessUpdate(CGaussianBlurEffect *this, struct CResourceTable *a2, __m128 *a3)
{
  ...
  *((_DWORD *)this + 70) = v4;
  *((_DWORD *)this + 69) = _mm_cvtsi128_si32(_mm_srli_si128((__m128i)v5, 12));
