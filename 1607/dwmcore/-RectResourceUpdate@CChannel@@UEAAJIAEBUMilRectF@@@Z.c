/*
 * XREFs of ?RectResourceUpdate@CChannel@@UEAAJIAEBUMilRectF@@@Z @ 0x18001E4C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::RectResourceUpdate(CChannel *this, int a2, const struct MilRectF *a3)
{
  __int128 v6; // xmm0
  unsigned int v7; // ebx
