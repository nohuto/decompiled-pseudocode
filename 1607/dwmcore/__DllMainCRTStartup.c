/*
 * XREFs of __DllMainCRTStartup @ 0x1800BE750
 * Callers:
 *     _DllMainCRTStartup @ 0x1800BE70C (_DllMainCRTStartup.c)
 * Callees:
 *     _CRT_INIT @ 0x1800BE4CC (_CRT_INIT.c)
 *     _XcptFilter_0 @ 0x1800BEA08 (_XcptFilter_0.c)
...
__int64 __fastcall _DllMainCRTStartup(HINSTANCE hinstDLL, __int64 fdwReason, void *a3)
{
  ...
  if ( (_DWORD)fdwReason || dword_1801ECF50 )
  {
