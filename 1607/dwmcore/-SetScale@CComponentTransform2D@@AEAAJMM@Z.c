/*
 * XREFs of ?SetScale@CComponentTransform2D@@AEAAJMM@Z @ 0x1800205F0
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetScale(CComponentTransform2D *this, double a2, double a3)
{
  ...
  v3 = 0;
  if ( *((float *)this + 40) != *(float *)&a2 || *((float *)this + 41) != *(float *)&a3 )
  {
    *((_DWORD *)this + 40) = LODWORD(a2);
    *((_DWORD *)this + 41) = LODWORD(a3);
    CResource::NotifyOnChanged(this, 0LL, 0LL);
    v7 = _mm_unpacklo_ps(*(__m128 *)&a2, *(__m128 *)&a3).m128_u64[0];
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 0x3EDu, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x13Eu);
    else
      CResource::InvalidateAnimationSources(this, 0x3EDu);
  }
  return v3;
}
