/*
 * XREFs of ?ResetOverlayPlanesList@COverlayContext@@AEAAXXZ @ 0x180078A74
 * Callers:
...
void __fastcall COverlayContext::ResetOverlayPlanesList(COverlayContext *this)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 66); ++i )
    COverlayContext::OverlayPlaneInfo::Reset((COverlayContext::OverlayPlaneInfo *)(*((_QWORD *)this + 30) + 232LL * i));
  *((_DWORD *)this + 66) = 0;
  DynArrayImpl<0>::ShrinkToSize((char *)this + 240, 232LL);
}
