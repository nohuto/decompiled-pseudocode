/*
 * XREFs of ?GetBoundsFromInputs@CAffineTransform2DEffect@@MEBAXAEBV?$DynArray@UInputBoundsPair@@$0A@@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180157100
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CAffineTransform2DEffect::GetBoundsFromInputs(__int64 a1, _DWORD *a2, float *a3)
{
  ...
  if ( a2[6] == 1 )
  {
    v4 = (__m128)*(unsigned int *)(a1 + 288);
    v5 = v4;
    v6 = *(float *)(a1 + 284);
    v7 = (__m128)*(unsigned int *)(a1 + 292);
    v8 = v7;
    v9 = *(float *)(*(_QWORD *)a2 + 4LL);
    v10 = *(float *)(*(_QWORD *)a2 + 8LL);
    v11 = *(float *)(*(_QWORD *)a2 + 16LL);
    v12 = (float)((float)(*(float *)(a1 + 288) * v10) + (float)(v9 * *(float *)(a1 + 280))) + *(float *)(a1 + 296);
    v13 = (float)((float)(v7.m128_f32[0] * v10) + (float)(v6 * v9)) + *(float *)(a1 + 300);
    v5.m128_f32[0] = (float)(v4.m128_f32[0] * v11) + (float)(v9 * *(float *)(a1 + 280));
    v14 = v6 * v9;
    v15 = *(float *)(*(_QWORD *)a2 + 12LL);
    v3 = (float *)v23 + 1;
    v5.m128_f32[0] = v5.m128_f32[0] + *(float *)(a1 + 296);
    v8.m128_f32[0] = (float)(v7.m128_f32[0] * v11) + v14;
    v16 = v5;
    v17 = v4;
    v8.m128_f32[0] = v8.m128_f32[0] + *(float *)(a1 + 300);
    v16.m128_u64[0] = _mm_unpacklo_ps(v16, v8).m128_u64[0];
    v18 = v7;
    v23[0] = v16.m128_u64[0];
    v17.m128_f32[0] = (float)((float)(v4.m128_f32[0] * v11) + (float)(v15 * *(float *)(a1 + 280)))
                    + *(float *)(a1 + 296);
    v18.m128_f32[0] = (float)(v7.m128_f32[0] * v11) + (float)(v6 * v15);
    v7.m128_f32[0] = (float)((float)(v7.m128_f32[0] * v10) + (float)(v6 * v15)) + *(float *)(a1 + 300);
    v18.m128_f32[0] = v18.m128_f32[0] + *(float *)(a1 + 300);
    v16.m128_u64[0] = _mm_unpacklo_ps(v17, v18).m128_u64[0];
    v19 = v13;
    v23[1] = v16.m128_u64[0];
    v4.m128_f32[0] = (float)((float)(v4.m128_f32[0] * v10) + (float)(v15 * *(float *)(a1 + 280))) + *(float *)(a1 + 296);
    *a3 = v12;
    v20 = 3LL;
    a3[1] = v13;
    a3[2] = v12;
