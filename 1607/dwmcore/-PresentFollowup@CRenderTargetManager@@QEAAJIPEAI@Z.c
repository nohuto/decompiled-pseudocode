/*
 * XREFs of ?PresentFollowup@CRenderTargetManager@@QEAAJIPEAI@Z @ 0x18011B1E0
 * Callers:
...
__int64 __fastcall CRenderTargetManager::PresentFollowup(CRenderTargetManager *this, unsigned int a2, unsigned int *a3)
{
  ...
  if ( v3 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (*(unsigned __int8 (__fastcall **)(_QWORD *))(*v10 + 160LL))(v10) )
      {
        v12 = (*(__int64 (__fastcall **)(_QWORD *, _QWORD, _QWORD))(v10[14] + 72LL))(v10 + 14, 0LL, v16);
        v13 = v12;
        if ( v12 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x1D3u);
        if ( v13 == 142213130 )
          v5 = 1;
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x1DAu);
LABEL_13:
    if ( v5 )
      return 142213130;
  }
