/*
 * XREFs of ?PushConstant@CExpressionValueStack@@QEAAJAEBUD2DVector2@@@Z @ 0x18015BAB4
 * Callers:
 ...
 *     ?SetVector2Value@CKeyframeAnimation@@UEAAJMM@Z @ 0x180148950 (-SetVector2Value@CKeyframeAnimation@@UEAAJMM@Z.c)
 * Callees:
...
__int64 __fastcall CExpressionValueStack::PushConstant(CExpressionValueStack *this, const struct D2DVector2 *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x1F3u);
  }
  else
  {
    ++*((_DWORD *)this + 4);
