/*
 * XREFs of ??$Transform3DBoundsHelper@$00@CMILMatrix@@AEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@AEAV1@@Z @ 0x180058F60
 * Callers:
...
float *__fastcall CMILMatrix::Transform3DBoundsHelper<1>(__int64 a1, __int64 a2, float *a3)
{
  ...
  {
    v39 = *(_OWORD *)v5;
    result = (float *)CMILMatrix::Transform2DBoundsHelper<1>(v4, &v39, &v40);
    v7 = v40;
    *(_OWORD *)a3 = v40;
  ...
  {
    if ( !CMILMatrix::IsTranslateAndScale<1>((__int64)v10) )
    {
