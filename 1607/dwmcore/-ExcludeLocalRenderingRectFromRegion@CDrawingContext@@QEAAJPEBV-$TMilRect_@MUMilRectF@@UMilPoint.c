/*
 * XREFs of ?ExcludeLocalRenderingRectFromRegion@CDrawingContext@@QEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV?$CMatrix@ULocalRenderingHPC@CoordinateSpace@@UDeviceHPC@2@@@PEAUHRGN__@@@Z @ 0x1801232EC
 * Callers:
...
__int64 __fastcall CDrawingContext::ExcludeLocalRenderingRectFromRegion(__int64 a1, __int64 a2, __int64 a3, HRGN a4)
{
  ...
  v5 = 0;
  if ( *(_BYTE *)(a1 + 6532) && qword_1801EFD28 && CDisplaySet::NeedsDesktopMoves(qword_1801EFD28) )
  {
    v31 = *v8;
    ...
    if ( RectRgn )
    {
      ...
      if ( !CombineRgn(a4, a4, RectRgn, 4) )
      {
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x1E5Eu);
      }
    ...
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x1E59u);
    }
  }
