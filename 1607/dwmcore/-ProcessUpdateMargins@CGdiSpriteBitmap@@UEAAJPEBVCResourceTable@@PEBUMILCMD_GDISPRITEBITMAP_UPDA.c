/*
 * XREFs of ?ProcessUpdateMargins@CGdiSpriteBitmap@@UEAAJPEBVCResourceTable@@PEBUMILCMD_GDISPRITEBITMAP_UPDATEMARGINS@@@Z @ 0x18002BD50
 * Callers:
        ...
        const struct MILCMD_GDISPRITEBITMAP_UPDATEMARGINS *a3)
{
  ...
  else if ( operator!=((_DWORD *)this + 50, (_DWORD *)a3 + 2) )
  {
    *v5 = *v4;
    if ( !*((_QWORD *)v6 + 30) )
    {
