/*
 * XREFs of ?ApplyMaskToValue@CExpressionValue@@QEAAJPEAVSubchannelMaskInfo@@@Z @ 0x18015CE30
 * Callers:
...
LABEL_10:
  ...
  while ( 1 )
  {
    if ( *(_DWORD *)a2 == 1 )
    {
      v11 = (*((unsigned __int8 *)a2 + 8) >> (2 * (*((_BYTE *)a2 + 4) - v9 - 1))) & 3;
      goto LABEL_7;
    }
    if ( *(_DWORD *)a2 != 2 )
      break;
...
LABEL_18:
  ...
  v10 = -2147467259;
LABEL_31:
  MilInstrumentationCheckHR(0x14u, 0LL, v9, v17, v26);
  return v10;
}
