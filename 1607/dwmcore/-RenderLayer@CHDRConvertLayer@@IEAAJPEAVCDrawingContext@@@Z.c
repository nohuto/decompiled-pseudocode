/*
 * XREFs of ?RenderLayer@CHDRConvertLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x18012F2F0
 * Callers:
...
__int64 __fastcall CHDRConvertLayer::RenderLayer(CHDRConvertLayer *this, struct CDrawingContext *a2)
{
  ...
  else
  {
    ...
    v8 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *))(**((_QWORD **)this + 14) + 480LL))(*((_QWORD *)this + 14), v10);
    v7 = v8;
    if ( v8 < 0 )
