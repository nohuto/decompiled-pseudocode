/*
 * XREFs of ?GetBufferedOutputTransformed@CInteractionContextWrapper@@UEAAI_K0AEBVCMILMatrix@@PEAUInteractionOutput@@@Z @ 0x18016FFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InteractionOutput *a5)
{
  ...
  v14[0] = v7;
  v10 = *((_OWORD *)a5 + 2);
  v11 = *(__int64 (__fastcall **)(CInteractionContextWrapper *, __int64, __int64, _OWORD *))(v9 + 104);
  v14[1] = v8;
