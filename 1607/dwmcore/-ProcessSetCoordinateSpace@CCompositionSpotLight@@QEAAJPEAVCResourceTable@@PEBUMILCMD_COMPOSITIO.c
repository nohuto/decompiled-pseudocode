/*
 * XREFs of ?ProcessSetCoordinateSpace@CCompositionSpotLight@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPOSITIONSPOTLIGHT_SETCOORDINATESPACE@@@Z @ 0x18010A500
 * Callers:
        ...
        const struct MILCMD_COMPOSITIONSPOTLIGHT_SETCOORDINATESPACE *a3)
{
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x15Du);
  }
  return v4;
}
