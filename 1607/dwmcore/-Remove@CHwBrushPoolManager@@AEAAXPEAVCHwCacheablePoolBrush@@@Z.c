/*
 * XREFs of ?Remove@CHwBrushPoolManager@@AEAAXPEAVCHwCacheablePoolBrush@@@Z @ 0x180018C74
 * Callers:
 ...
 *     ?UnusableNotification@CHwBrushPoolManager@@UEAAXPEAVCMILPoolResource@@@Z @ 0x1801819B0 (-UnusableNotification@CHwBrushPoolManager@@UEAAXPEAVCMILPoolResource@@@Z.c)
 * Callees:
 *     <none>
 */
