/*
 * XREFs of ?UpdateDirtyAccum@CGdiSpriteBitmap@@IEAAJPEBUtagRECT@@IPEA_N@Z @ 0x18002B1C0
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( *((_DWORD *)this + 150) == 2 )
    goto LABEL_2;
  if ( *((_QWORD *)this + 76) || (v12 = 0, !a3) )
  {
LABEL_14:
    if ( *((_QWORD *)this + 76) && v8 )
    {
      SetLastError(0);
...
LABEL_23:
      if ( CombineRgn(v6, RectRgn, *((HRGN *)this + 76), 4) != 1 )
      {
        v4 = 1;
        SetLastError(0);
        if ( CombineRgn(*((HRGN *)this + 76), *((HRGN *)this + 76), RectRgn, 2) )
        {
          if ( GetRgnBox(*((HRGN *)this + 76), (LPRECT)((char *)this + 616)) == 2 )
          {
            DeleteObject(*((HGDIOBJ *)this + 76));
            *((_QWORD *)this + 76) = 0LL;
          }
          goto LABEL_2;
        }
...
LABEL_12:
  ...
  *((_QWORD *)this + 76) = RectRgnIndirect;
  if ( RectRgnIndirect )
  {
    a2 += v12;
    v8 -= v12;
