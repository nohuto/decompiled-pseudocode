/*
 * XREFs of ?MetaBitmapRenderTargetSetFilterList@CChannel@@UEAAJII@Z @ 0x1801154B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MetaBitmapRenderTargetSetFilterList(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
