/*
 * XREFs of ?Transform3DGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x180115E50
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  v13 = (struct _RTL_CRITICAL_SECTION *)(this + 22);
  ...
  {
    v10 = -2147024362;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024362, 0xA8Bu);
  }
  else
  {
    si128.m128i_i32[3] = 0;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xA8Du);
    }
    else
    {
      CDataStreamWriter::AddItemData(this[21], a3, si128.m128i_u32[2]);
