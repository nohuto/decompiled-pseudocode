/*
 * XREFs of ?ProcessSetOffset@CComponentTransform2D@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPONENTTRANSFORM2D_SETOFFSET@@@Z @ 0x180020874
 * Callers:
        ...
        const struct MILCMD_COMPONENTTRANSFORM2D_SETOFFSET *a3)
{
  ...
  v3 = CComponentTransform2D::SetOffset(
         this,
