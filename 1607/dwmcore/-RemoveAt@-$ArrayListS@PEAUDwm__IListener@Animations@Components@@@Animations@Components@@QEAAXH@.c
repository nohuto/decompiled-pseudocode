/*
 * XREFs of ?RemoveAt@?$ArrayListS@PEAUDwm__IListener@Animations@Components@@@Animations@Components@@QEAAXH@Z @ 0x1801942C8
 * Callers:
 *     ?RemoveListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z @ 0x180194380 (-RemoveListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z.c)
 * Callees:
