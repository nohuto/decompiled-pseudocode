/*
 * XREFs of ?RealizeGradientPoints@CLinearGradientLegacyMilBrush@@QEAAXPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUMilPoint2F@@11@Z @ 0x180017AE4
 * Callers:
        ...
        struct MilPoint2F *a5)
{
  ...
  v5 = 0LL;
  v6 = (__m128d)*(unsigned __int64 *)(a1 + 208);
  v8 = _mm_cvtpd_ps((__m128d)*(unsigned __int64 *)(a1 + 200));
  v16 = 0;
  *(_QWORD *)a3 = _mm_unpacklo_ps(v8, _mm_cvtpd_ps(v6)).m128_u64[0];
  *(_QWORD *)a4 = _mm_unpacklo_ps(
                    _mm_cvtpd_ps((__m128d)*(unsigned __int64 *)(a1 + 216)),
                    _mm_cvtpd_ps((__m128d)*(unsigned __int64 *)(a1 + 224))).m128_u64[0];
  if ( *(_DWORD *)(a1 + 180) == 1 )
  {
  ...
  *((float *)a5 + 1) = (float)(*(float *)a4 - *(float *)a3) + *(float *)(a3 + 4);
  v13 = *(CTransform3D **)(a1 + 168);
  if ( v13 )
    Matrix = CTransform3D::GetMatrix(v13, 0LL);
  v14 = *(CTransform3D **)(a1 + 160);
  if ( v14 )
    v5 = CTransform3D::GetMatrix(v14, 0LL);
  CBrushTypeUtils::GetBrushTransform(Matrix, v5, a2, v15);
