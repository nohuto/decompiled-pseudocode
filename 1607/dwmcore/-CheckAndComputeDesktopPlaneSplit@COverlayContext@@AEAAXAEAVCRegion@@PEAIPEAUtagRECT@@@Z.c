/*
 * XREFs of ?CheckAndComputeDesktopPlaneSplit@COverlayContext@@AEAAXAEAVCRegion@@PEAIPEAUtagRECT@@@Z @ 0x1801266D4
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  v16 = 0.0;
  CMergedRectBase<2>::CMergedRectBase<2>((TemporaryConfiguration *)v26);
