/*
 * XREFs of ?GetPointerToValidRectsForSurface@CBitmapOfDeviceBitmaps@@QEAAJPEAXVDisplayId@@AEAIAEAPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180179770
 * Callers:
...
LABEL_5:
  ...
  if ( PointerToValidRects < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, PointerToValidRects, 0x4A0u);
  return v10;
}
