/*
 * XREFs of ?ProcessTrigger@CAnimationTrigger@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ANIMATIONTRIGGER_TRIGGER@@@Z @ 0x1800216E0
 * Callers:
        ...
        const struct MILCMD_ANIMATIONTRIGGER_TRIGGER *a3)
{
  ...
  while ( 1 )
  {
    if ( (unsigned int)v6 >= *((_DWORD *)this + 34) )
    {
LABEL_5:
      *((_QWORD *)this + 18) = v3;
      return (unsigned int)v4;
    }
    v8 = *(_QWORD **)(*((_QWORD *)this + 14) + 8 * v6);
    if ( v8[23] )
    {
      v8[25] = v3;
      v8[34] = v3;
      v9 = CBaseAnimation::RegisterAnimateResource(*(CBaseAnimation **)(*((_QWORD *)this + 14) + 8 * v6));
      v4 = v9;
      if ( v9 < 0 )
        break;
    }
