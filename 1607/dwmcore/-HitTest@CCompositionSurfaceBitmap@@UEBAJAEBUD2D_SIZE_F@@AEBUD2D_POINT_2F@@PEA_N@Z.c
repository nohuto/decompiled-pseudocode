/*
 * XREFs of ?HitTest@CCompositionSurfaceBitmap@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x180142810
 * Callers:
 *     ?HitTest@CYCbCrSurface@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x180145160 (-HitTest@CYCbCrSurface@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z.c)
 * Callees:
        ...
        bool *a4)
{
  ...
  *a4 = 0;
  ...
  v7 = BoundsInternal;
  if ( BoundsInternal < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, BoundsInternal, 0x413u);
