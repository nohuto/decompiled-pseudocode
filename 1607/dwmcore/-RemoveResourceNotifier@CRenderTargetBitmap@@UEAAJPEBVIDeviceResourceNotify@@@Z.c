/*
 * XREFs of ?RemoveResourceNotifier@CRenderTargetBitmap@@UEAAJPEBVIDeviceResourceNotify@@@Z @ 0x180132C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRenderTargetBitmap::RemoveResourceNotifier(
        ...
        const struct IDeviceResourceNotify *a2)
{
  ...
  v4 = a2;
  v2 = 0;
  if ( !(unsigned int)DynArray<IDeviceResourceNotify *,0>::Remove((__int64 *)this + 5, (__int64 *)&v4) )
  {
    v2 = -2147467259;
