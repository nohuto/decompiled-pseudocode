/*
 * XREFs of ?Transfer@?$CVertexTransfer2@V?$CNonScale2DOperator@VCVertexXYWColorDUV2_XYZ_Tangent@@$00$00@@$00$00VCVertexXYWColorDUV2_XYZ_Tangent@@@@SAXPEBV?$CCommonTransferParameters@VCVertexXYWColorDUV2_XYZ_Tangent@@@@AEBVCMILMatrix@@PEBV3@2@Z @ 0x1801968E0
 * Callers:
...
_UNKNOWN **__fastcall CVertexTransfer2<CNonScale2DOperator<CVertexXYWColorDUV2_XYZ_Tangent,1,1>,1,1,CVertexXYWColorDUV2_XYZ_Tangent>::Transfer(
        __int64 a1,
        unsigned int *a2,
        unsigned int *a3,
        CMILMatrix *a4)
