/*
 * XREFs of ?ApiSetXamlSine@Animation@Animations@Components@@QEAAJHW4KFAnim__InterpolationCoordinateSpace@23@W4Dwm__InterpolationMode@23@@Z @ 0x1801922E8
 * Callers:
  ...
  if ( a3 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( v9 )
      {
        *(_QWORD *)(v9 + 8) = 0LL;
        *(_QWORD *)(v9 + 16) = 0LL;
        v10 = &Components::Animations::XamlSineInterpolation<Components::Animations::HslCoordinateSpace>::`vftable';
LABEL_11:
        *(_DWORD *)(v9 + 8) = 1;
        *(_QWORD *)v9 = v10;
        goto LABEL_13;
    ...
    else
    {
      ...
      if ( v9 )
      {
        *(_QWORD *)(v9 + 8) = 0LL;
        *(_QWORD *)(v9 + 16) = 0LL;
        v10 = &Components::Animations::XamlSineInterpolation<Components::Animations::SphericalCoordinateSpace>::`vftable';
        goto LABEL_11;
      }
    }
  }
  else
  {
    ...
    if ( v9 )
    {
      *(_QWORD *)(v9 + 8) = 0LL;
      *(_QWORD *)(v9 + 16) = 0LL;
      v10 = &Components::Animations::XamlSineInterpolation<Components::Animations::CartesianCoordinateSpace>::`vftable';
      goto LABEL_11;
    }
  }
  v9 = 0LL;
