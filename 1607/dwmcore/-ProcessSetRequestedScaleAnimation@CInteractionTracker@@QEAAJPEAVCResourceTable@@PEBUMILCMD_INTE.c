/*
 * XREFs of ?ProcessSetRequestedScaleAnimation@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUMILCMD_INTERACTIONTRACKER_SETREQUESTEDSCALEANIMATION@@@Z @ 0x18010B460
 * Callers:
        ...
        const struct MILCMD_INTERACTIONTRACKER_SETREQUESTEDSCALEANIMATION *a3)
{
  ...
  {
    v9 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x222u);
    return v9;
  }
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x225u);
  }
  else
  {
LABEL_16:
