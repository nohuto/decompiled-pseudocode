/*
 * XREFs of ?HrInit@CClientMemoryBitmap@@QEAAJIIPEBUPixelFormatInfo@@IPEAXIPEAUIUnknown@@@Z @ 0x1800B1C14
 * Callers:
...
LABEL_15:
  ...
  v12 = HrCheckBufferSize((enum DXGI_FORMAT)*(_DWORD *)a4, a7, a2, a3, a5);
  v13 = v12;
  if ( v12 < 0 )
  {
