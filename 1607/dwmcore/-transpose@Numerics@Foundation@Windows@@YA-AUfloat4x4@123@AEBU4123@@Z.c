/*
 * XREFs of ?transpose@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBU4123@@Z @ 0x1801627CC
 * Callers:
 *     ?GetTranspose@CMILMatrix@@QEBA?AV1@XZ @ 0x180162134 (-GetTranspose@CMILMatrix@@QEBA-AV1@XZ.c)
 *     ?Transpose@CMILMatrix@@QEAAXXZ @ 0x180162788 (-Transpose@CMILMatrix@@QEAAXXZ.c)
 * Callees:
