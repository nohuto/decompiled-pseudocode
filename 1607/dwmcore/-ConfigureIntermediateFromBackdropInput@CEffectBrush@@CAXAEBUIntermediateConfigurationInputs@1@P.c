/*
 * XREFs of ?ConfigureIntermediateFromBackdropInput@CEffectBrush@@CAXAEBUIntermediateConfigurationInputs@1@PEAUIntermediateConfigurationOutputs@1@@Z @ 0x18013B2AC
 * Callers:
...
void __fastcall CEffectBrush::ConfigureIntermediateFromBackdropInput(
        const struct CEffectBrush::IntermediateConfigurationInputs *a1,
        struct CEffectBrush::IntermediateConfigurationOutputs *a2)
{
  __int64 v2; // rdi
  __int64 v4; // rsi
  ...
  float v19[9]; // [rsp+38h] [rbp-D0h] BYREF
  float v20[9]; // [rsp+5Ch] [rbp-ACh] BYREF
  float v21[3]; // [rsp+80h] [rbp-88h] BYREF
  float v22; // [rsp+8Ch] [rbp-7Ch]
  float v23; // [rsp+90h] [rbp-78h]
  float v24; // [rsp+94h] [rbp-74h]
  float v25[10]; // [rsp+98h] [rbp-70h] BYREF
  ...
  v2 = *((_QWORD *)a1 + 3);
  v4 = *(_QWORD *)a2;
  SurfaceSize = CEffectBrush::GetSurfaceSize(*(struct IImageSource **)v2);
  v7 = *(float *)(v2 + 56) - *(float *)(v2 + 48);
  v8 = *(unsigned int *)(v2 + 60);
  *(float *)&v8 = *(float *)&v8 - *(float *)(v2 + 52);
  v17 = SurfaceSize;
  ...
  *((_QWORD *)a2 + 2) = _mm_unpacklo_ps(v11, v12).m128_u64[0];
  ...
  v13 = *(_DWORD *)(v2 + 48) ^ _xmm;
  v22 = (float)(1.0 / *((float *)a2 + 3)) * *((float *)a1 + 5);
  v21[0] = v12.m128_f32[0];
  v27 = v13;
  v25[0] = v17.width;
  v23 = 0.0 - (float)(v12.m128_f32[0] * 0.0);
  v28 = *(_DWORD *)(v2 + 52) ^ _xmm;
  v25[3] = v17.height;
  v24 = 0.0 - (float)(v22 * 0.0);
  v26 = _xmm;
  v25[4] = 0.0 - (float)(v17.width * 0.0);
  v25[5] = 0.0 - (float)(v17.height * 0.0);
  v14 = Matrix3x3::operator*((float *)(v2 + 12), v19, v25);
  v15 = Matrix3x3::operator*(v14, v25, (float *)&v26);
  v16 = Matrix3x3::operator*(v15, v20, v21);
  *(_QWORD *)&v18 = 0LL;
  *(_OWORD *)(v4 + 12) = *(_OWORD *)v16;
  *(_OWORD *)(v4 + 28) = *((_OWORD *)v16 + 1);
  *(float *)(v4 + 44) = v16[8];
  *((_QWORD *)&v18 + 1) = *((_QWORD *)a2 + 1);
  *(_BYTE *)(v4 + 65) = 1;
  *(_OWORD *)(v4 + 48) = v18;
  *(_BYTE *)(v4 + 66) = *(_BYTE *)(v2 + 66);
}
