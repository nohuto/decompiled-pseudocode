/*
 * XREFs of ?CreateResource@CChannel@@UEAAJW4Enum@DwmResourceType@@PEAI@Z @ 0x18004A680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CreateResource(__int64 a1, unsigned int a2, _DWORD *a3)
{
  ...
  v3 = (struct _RTL_CRITICAL_SECTION *)(a1 + 176);
  v4 = a2;
  EnterCriticalSection((LPCRITICAL_SECTION)(a1 + 176));
  v10 = 0;
  if ( (unsigned int)v4 >= 0x26 )
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0xBA4u);
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x2ADu);
  }
  else
  {
    v7 = CHandleTable::CreateOrAddRefOnChannel(a1 + 16, a1, dword_1801C08C0[v4], &v10);
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x2AEu);
  }
  *a3 = v10;
  if ( v3 )
