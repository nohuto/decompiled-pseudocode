/*
 * XREFs of ?Draw@CMaskBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18013E870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMaskBrush::Draw(struct CSpriteVisualContent *a1, CDrawingContext *this, struct D2D_SIZE_F *a3)
{
  unsigned int v3; // ebx
    ...
    && (*(unsigned __int8 (__fastcall **)(struct CSpriteVisualContent *))(*(_QWORD *)a1 + 176LL))(a1) )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x6Cu);
    }
    else
    {
