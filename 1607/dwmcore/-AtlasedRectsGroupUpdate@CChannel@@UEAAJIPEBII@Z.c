/*
 * XREFs of ?AtlasedRectsGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x1800480F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  {
    v10 = -2147024362;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024362, 0xA5Au);
  }
  else
  {
    v13 = 4 * a4;
    v9 = CChannel::BeginCommand((CChannel *)this, v12, 0xCu, v8);
    v10 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xA5Bu);
    }
    else
    {
