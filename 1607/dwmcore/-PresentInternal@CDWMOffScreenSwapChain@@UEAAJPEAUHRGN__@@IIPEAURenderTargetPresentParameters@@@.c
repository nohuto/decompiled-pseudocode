/*
 * XREFs of ?PresentInternal@CDWMOffScreenSwapChain@@UEAAJPEAUHRGN__@@IIPEAURenderTargetPresentParameters@@@Z @ 0x1800B8E50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct RenderTargetPresentParameters *a5)
{
  ...
  *(_QWORD *)&rc.right = 0LL;
  ...
  (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*((_QWORD *)this + 37) + 576LL) + 888LL))(*(_QWORD *)(*((_QWORD *)this + 37) + 576LL));
  if ( !*((_BYTE *)a5 + 33) )
  {
    v11 = ho[1];
LABEL_5:
