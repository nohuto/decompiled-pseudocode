/*
 * XREFs of ?GetStockTransparentImageNoRef@CD3DDeviceLevel1@@QEAAJPEAPEAVIImageSource@@@Z @ 0x1801743D0
 * Callers:
...
__int64 __fastcall CD3DDeviceLevel1::GetStockTransparentImageNoRef(CD3DDeviceLevel1 *this, struct IImageSource **a2)
{
  ...
  v2 = 0;
  v3 = (struct CRenderTargetImageSource **)((char *)this + 816);
  *a2 = 0LL;
  if ( *((_QWORD *)this + 102) )
    goto LABEL_13;
  ...
  if ( v6 >= 0 )
  {
    SingleAdapter = CRenderTargetImageSource::CreateSingleAdapter(*((struct IRenderTarget **)this + 100), v3);
    v2 = SingleAdapter;
    if ( SingleAdapter < 0 )
    {
      if ( IsOOM(SingleAdapter) && IsCompBuild() )
        NtDCompositionDuplicateHandleToProcess(0LL, 2880220587LL, 0LL);
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x5FDu);
      return v2;
    }
LABEL_13:
    *a2 = *v3;
  ...
  if ( IsOOM(v6) && IsCompBuild() )
    NtDCompositionDuplicateHandleToProcess(0LL, 2880220587LL, 0LL);
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x5F9u);
  return v2;
}
