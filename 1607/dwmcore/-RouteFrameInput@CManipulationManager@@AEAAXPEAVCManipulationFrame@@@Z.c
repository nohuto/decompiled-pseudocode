/*
 * XREFs of ?RouteFrameInput@CManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x1800A70E0
 * Callers:
...
void __fastcall CManipulationManager::RouteFrameInput(CManipulationManager *this, struct CManipulationFrame *a2)
{
  ...
  CManipulationManager *v24; // [rsp+50h] [rbp-A8h]
  struct CManipulationFrame *v25; // [rsp+58h] [rbp-A0h]
  CReadWriteLock *v26[2]; // [rsp+60h] [rbp-98h] BYREF
  ...
  int v33; // [rsp+ACh] [rbp-4Ch]
  const GUID **v34; // [rsp+B0h] [rbp-48h]
  int v35; // [rsp+B8h] [rbp-40h]
  int v36; // [rsp+BCh] [rbp-3Ch]

  v26[1] = (CReadWriteLock *)-2LL;
  v2 = a2;
  v3 = this;
  v23 = this;
  v24 = this;
...
LABEL_6:
    ...
    while ( v9 )
    {
      ...
      {
        v26[0] = (CReadWriteLock *)&CManipulationManager::s_rwPointerBufferLock;
            ...
            if ( *(_DWORD *)((char *)v2 + v14 + 40) )
            {
              ...
              *(_DWORD *)((char *)v2 + v14 + 40) = 0;
                ...
                && (qword_1801EAA98 & 2) == qword_1801EAA98 )
              {
                ...
                v35 = 8;
                v36 = 0;
                TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1801C52DC, v15, v12, 5u, &pData);
                v12 = v22;
              }
            }
          }
        ...
        *((_DWORD *)v2 + 5) += v11;
        CWriteGuard<CReadWriteLock>::~CWriteGuard<CReadWriteLock>(v26);
      }
      v20 = ++v8;
      v9 = v8 < *((_DWORD *)v2 + 4);
      if ( v8 == *((_DWORD *)v2 + 4) )
