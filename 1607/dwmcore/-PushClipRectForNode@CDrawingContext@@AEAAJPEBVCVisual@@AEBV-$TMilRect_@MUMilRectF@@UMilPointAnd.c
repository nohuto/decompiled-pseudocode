/*
 * XREFs of ?PushClipRectForNode@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_N@Z @ 0x180005850
 * Callers:
...
{
  return CDrawingContext::PushGpuClipRectInternal(a1, a2, a3, *(_DWORD *)(a1 + 328) != 0, a4, 1);
}
