/*
 * XREFs of ?DrawBitmapWithCompositeMode@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap1@@PEBUD2D_RECT_F@@PEBUD2D_POINT_2F@@MW4D2D1_COMPOSITE_MODE@@W4D2D1_BORDER_MODE@@W4D2D1_INTERPOLATION_MODE@@@Z @ 0x180176390
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_INTERPOLATION_MODE a9)
{
  ...
  v13 = 0LL;
  v14 = 0;
  (*(void (__fastcall **)(const struct ID2DContextOwner *, struct _D3DMATRIX *))(v12 + 16))(a2, &v48);
  v39 = 0;
  v38 = v48;
  ...
  v19 = this[8];
  v40 = _xmm;
  (*(void (__fastcall **)(_QWORD, __int128 *))(**((_QWORD **)v37 + 5) + 240LL))(*((_QWORD *)v37 + 5), &v40);
  if ( a4 )
  {
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x631u);
      goto LABEL_46;
    }
...
LABEL_28:
  if ( v13 )
    ...
    (*(void (__fastcall **)(ID2D1Effect *, _QWORD, struct ID2D1Bitmap1 *, __int64))(*(_QWORD *)v19 + 112LL))(
      ...
      1LL);
  if ( a5 )
    CMILMatrix::PrependTranslate((CMILMatrix *)&v38, a5->x, a5->y, 0.0);
  v48 = *CMILMatrix::GetD3DMatrix(&v38, &v43);
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
  {
    v27 = (*(__int64 (__fastcall **)(const struct ID2DContextOwner *))(*(_QWORD *)a2 + 32LL))(a2);
  ...
  if ( v29 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v29, 0x698u);
    goto LABEL_46;
  }
  ...
  (*(void (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, _DWORD, enum D2D1_COMPOSITE_MODE))(**((_QWORD **)v30 + 5)
                                                                                            + 664LL))(
    *((_QWORD *)v30 + 5),
    v36,
    0LL,
