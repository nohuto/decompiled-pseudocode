/*
 * XREFs of ?CheckIndependentFlipSupport@CDirectFlipInfo@@IEAAJPEA_N@Z @ 0x18012CB24
 * Callers:
...
__int64 __fastcall CDirectFlipInfo::CheckIndependentFlipSupport(CDirectFlipInfo *this, bool *a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, bool *))(*(_QWORD *)v11 + 424LL))(v11, &v10);
  v2 = v6;
  if ( v6 < 0 )
  {
    v9 = 611;
...
LABEL_7:
  ...
  {
    v3 = *((_DWORD *)RenderingRealizationNoRef + 62) != 3;
    v10 = v3;
    goto LABEL_7;
  }
  v2 = -2147467259;
  MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x26Fu);
LABEL_8:
  if ( v11 )
