/*
 * XREFs of ?WaitForNextMessage@CChannel@@UEAAJKPEBQEAXHKPEAK@Z @ 0x18004A790
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  if ( a2 && !a3 || a2 > 0x3F )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x260u);
    return 2147942487LL;
  }
  else
  {
    ...
    if ( !*((_QWORD *)this + 21) )
      goto LABEL_5;
    v15 = NtDCompositionSubmitDWMBatch(*((unsigned int *)this + 14), *((_QWORD *)this + 21));
    if ( v15 >= 0
    ...
    if ( v11 < 0 )
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x1F8u);
    }
    else
    {
LABEL_5:
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x263u);
    ...
    *a6 = v13;
    ...
    if ( v19 >= 0 )
      v19 = -2003304445;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v19, 0x281u);
