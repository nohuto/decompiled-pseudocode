/*
 * XREFs of ?ProcessSetMatrix4x4Property@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETMATRIX4X4PROPERTY@@@Z @ 0x18008CB74
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETMATRIX4X4PROPERTY *a3)
{
  ...
  v10[0] = *((_OWORD *)a3 + 1);
  v6 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, _QWORD, __int64, _OWORD *))(v3 + 120);
  v10[1] = *((_OWORD *)a3 + 2);
  v10[2] = *((_OWORD *)a3 + 3);
  v10[3] = *((_OWORD *)a3 + 4);
