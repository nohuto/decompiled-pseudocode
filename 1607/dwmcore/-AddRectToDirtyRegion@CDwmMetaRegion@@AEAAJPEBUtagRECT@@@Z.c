/*
 * XREFs of ?AddRectToDirtyRegion@CDwmMetaRegion@@AEAAJPEBUtagRECT@@@Z @ 0x180130ACC
 * Callers:
...
__int64 __fastcall CDwmMetaRegion::AddRectToDirtyRegion(HRGN *this, const struct tagRECT *a2)
{
  ...
  if ( RectRgn )
  {
    if ( *this || (SetLastError(0), v10 = CreateRectRgn(0, 0, 0, 0), (*this = v10) != 0LL) )
    {
      ...
      if ( !CombineRgn(*this, *this, RectRgn, 2) )
      {
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x2Du);
      }
    }
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x27u);
    }
  ...
  else
  {
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x23u);
  }
