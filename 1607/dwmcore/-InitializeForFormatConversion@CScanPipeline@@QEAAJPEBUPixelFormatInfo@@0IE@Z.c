/*
 * XREFs of ?InitializeForFormatConversion@CScanPipeline@@QEAAJPEBUPixelFormatInfo@@0IE@Z @ 0x18018525C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  (*(void (__fastcall **)(WPF::ProcessHeapImpl *, _QWORD))(*(_QWORD *)WPF::g_pProcessHeap + 32LL))(
    ...
    *((_QWORD *)this + 80));
  *((_QWORD *)this + 80) = 0LL;
  Buffers = CSPIntermediateBuffers::AllocateBuffers((CScanPipeline *)((char *)this + 640), v8, a4);
  v10 = Buffers;
  if ( Buffers < 0 )
  {
    v15 = 70;
