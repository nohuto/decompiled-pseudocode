/*
 * XREFs of ?CalculateSurfaceSizeAndMapping1D@CViewportAlignedIntermediateRealizer@@AEAAXW4Enum@TileMode1D@@MMMMPEAHPEAIPEAM33@Z @ 0x180160D94
 * Callers:
 ...
 *     ?FloorSat@CFloatFPU@@SAHM@Z @ 0x180161284 (-FloorSat@CFloatFPU@@SAHM@Z.c)
 */
