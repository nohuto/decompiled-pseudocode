/*
 * XREFs of ?SetD2DEffectProperties@CBrightnessEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x180155CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBrightnessEffect::SetD2DEffectProperties(CBrightnessEffect *this, struct ID2D1Effect *a2)
{
  ...
  v10 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 68), (__m128)*((unsigned int *)this + 69)).m128_u64[0];
  ...
  else
  {
    ...
    v10 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 70), (__m128)*((unsigned int *)this + 71)).m128_u64[0];
