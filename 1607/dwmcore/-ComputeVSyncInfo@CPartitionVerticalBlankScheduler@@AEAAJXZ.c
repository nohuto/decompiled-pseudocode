/*
 * XREFs of ?ComputeVSyncInfo@CPartitionVerticalBlankScheduler@@AEAAJXZ @ 0x1801118EC
 * Callers:
...
__int64 __fastcall CPartitionVerticalBlankScheduler::ComputeVSyncInfo(CPartitionVerticalBlankScheduler *this)
{
  ...
  else
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 2741) + 100LL) = *(_DWORD *)(*((_QWORD *)this + 2741) + 680LL);
  }
  v4 = *((_QWORD *)this + 2741);
  ...
  *(_QWORD *)(v4 + 240) = v6 + *((_QWORD *)this + 3);
  ...
  v8 = *(_QWORD *)(v7 + 232);
  if ( v8 )
    *((_QWORD *)this + 2743) = ((v1 >> 4) + *(_QWORD *)(*((_QWORD *)this + 2741) + 232LL) - v8) / v1;
  else
    *((_QWORD *)this + 2743) = 1LL;
  v9 = *((_QWORD *)this + 2741);
  v10 = *(_QWORD *)(v9 + 248);
  ...
  {
    *(_QWORD *)(v9 + 232) = v10;
    *(_QWORD *)(*((_QWORD *)this + 2741) + 240LL) = *(_QWORD *)(*((_QWORD *)this + 2741) + 256LL);
  }
  *(_QWORD *)(*((_QWORD *)this + 2741) + 88LL) = *((_QWORD *)this + 2743) + *(_QWORD *)(*((_QWORD *)this + 2742) + 88LL);
  return 0LL;
}
