/*
 * XREFs of ?GetAlphaMarginsRects@CWindowNode@@AEAA_N_NPEAU_MARGINS@@AEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@3@Z @ 0x18010949C
 * Callers:
  ...
  if ( a3 && !AreAllMarginsZero(a3) )
  {
    ...
    *a6 = v12;
    ...
    if ( a2 )
    {
      *a6 = v12 - (int)*a4;
      a6[1] = v16 - (int)a4[1];
      a6[2] = v15 + a1[180] - a1[178] - (int)a4[2];
      a6[3] = v17 + a1[181] - a1[179] - (int)a4[3];
    }
    v18 = *a6;
    if ( a6[2] > *a6 )
      v18 = a6[2];
