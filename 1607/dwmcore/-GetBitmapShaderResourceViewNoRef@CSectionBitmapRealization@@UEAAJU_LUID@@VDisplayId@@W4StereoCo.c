/*
 * XREFs of ?GetBitmapShaderResourceViewNoRef@CSectionBitmapRealization@@UEAAJU_LUID@@VDisplayId@@W4StereoContext@@PEAPEAUID3D11ShaderResourceView@@@Z @ 0x18018EA10
 * Callers:
 *     <none>
 * Callees:
  ...
  *a5 = 0LL;
  ...
  else
  {
    ...
    if ( ShaderResourceViewNoRef < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, ShaderResourceViewNoRef, 0x58u);
  }
  return v7;
}
