/*
 * XREFs of ?GetContentAsCoRenderContentNoRef@CVisual@@QEBA_NPEAPEAVCCoRenderContent@@@Z @ 0x180109ED8
 * Callers:
...
char __fastcall CVisual::GetContentAsCoRenderContentNoRef(CVisual *this, struct CCoRenderContent **a2)
{
  ...
  v3 = 0;
  v4 = *((_QWORD *)this + 38);
  if ( v4 && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v4 + 48LL))(v4, 113LL) )
  {
    v3 = 1;
    *a2 = (struct CCoRenderContent *)*((_QWORD *)this + 38);
  }
  return v3;
}
