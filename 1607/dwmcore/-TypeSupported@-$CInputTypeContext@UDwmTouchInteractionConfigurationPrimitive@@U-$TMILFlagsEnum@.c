/*
 * XREFs of ?TypeSupported@?$CInputTypeContext@UDwmTouchInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@QEBAHW4SupportedTypeOption@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@1@Z @ 0x18001FF98
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( !v5 )
  {
    LOBYTE(v4) = ((a4 & (unsigned __int8)a3 | (unsigned __int8)(*(_BYTE *)(a1 + 16) & ~(_BYTE)a4)) & 0x3F) != 0;
    return v4;
  }
  if ( v5 == 1 )
