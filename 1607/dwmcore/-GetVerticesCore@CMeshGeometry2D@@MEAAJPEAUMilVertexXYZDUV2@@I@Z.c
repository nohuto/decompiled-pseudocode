/*
 * XREFs of ?GetVerticesCore@CMeshGeometry2D@@MEAAJPEAUMilVertexXYZDUV2@@I@Z @ 0x1801439D0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( VertexCount )
    {
      ...
      do
      {
        ...
        *(v11 - 2) = *(float *)(v12 + v13 - 4);
        v15 = *(_DWORD *)(v10 + *((_QWORD *)this + 26));
        v10 += 4LL;
        *((_DWORD *)v11 - 1) = v15;
        v16 = *(double *)(v8 + *((_QWORD *)this + 24));
        v8 += 16LL;
        *v11 = v16;
        v11 += 8;
        v17 = *(double *)(v8 + *((_QWORD *)this + 24) - 8);
        *((_QWORD *)v11 - 3) = 0LL;
        *(v11 - 7) = v17;
        --v9;
      }
