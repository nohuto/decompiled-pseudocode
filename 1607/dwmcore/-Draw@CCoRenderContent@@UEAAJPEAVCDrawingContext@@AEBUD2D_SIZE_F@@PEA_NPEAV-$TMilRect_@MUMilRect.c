/*
 * XREFs of ?Draw@CCoRenderContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180155450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCoRenderContent::Draw(__int64 a1)
{
  ...
  v1 = 0;
  if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)(a1 + 128)) )
  {
