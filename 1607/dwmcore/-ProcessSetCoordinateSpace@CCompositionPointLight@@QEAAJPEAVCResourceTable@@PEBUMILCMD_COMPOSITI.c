/*
 * XREFs of ?ProcessSetCoordinateSpace@CCompositionPointLight@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPOSITIONPOINTLIGHT_SETCOORDINATESPACE@@@Z @ 0x18010A448
 * Callers:
        ...
        const struct MILCMD_COMPOSITIONPOINTLIGHT_SETCOORDINATESPACE *a3)
{
  ...
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x20u)) != 0LL )
  {
    if ( Resource != this[26] )
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x147u);
      }
      else
      {
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x141u);
  }
  return v4;
}
