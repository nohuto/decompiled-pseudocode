/*
 * XREFs of _CRT_INIT @ 0x1800BE4CC
 * Callers:
 *     __DllMainCRTStartup @ 0x1800BE750 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800BEA14 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800BEA70 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800BEBDA (_initterm_0.c)
