/*
 * XREFs of ?GetBuffer@CAnalogSwapChain@@MEAAJIPEAIPEAPEAUID3D11Texture2D@@@Z @ 0x180168300
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID3D11Texture2D **a4)
{
  ...
  v12 = 0LL;
  v6 = a2;
  v7 = (*(__int64 (__fastcall **)(_QWORD, __int64, GUID *, struct ID3D11Texture2D **))(**((_QWORD **)this + 36) + 24LL))(
         *((_QWORD *)this + 36),
         a2,
  ...
  {
    v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, GUID *, __int64 *))(**((_QWORD **)this + 36) + 24LL))(
           *((_QWORD *)this + 36),
           v6,
