/*
 * XREFs of ?GenerateTriangles@Mesh@@AEBAJPEAGHPEAH@Z @ 0x1800915B0
 * Callers:
                  ...
                  *v20 = *(v20 - 2);
                  ...
                  for ( i = Mesh::PolygonPathIterator::GetNext(v32); ; i = (struct Mesh::MeshVertex *)v24 )
                  {
                    ...
                    if ( i != Next && v23 != (unsigned __int16 *)Next )
                    {
                      ...
                      {
                        v4 = -2147024882;
                        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0xCD8u);
                        return v4;
                      }
                      v30 += 3;
                      a2[v19] = *(_WORD *)Next;
