/*
 * XREFs of ?AddToVisibleRegion@CMoveRenderPassInfo@@QEAAJAEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x180130124
 * Callers:
    ...
    if ( RectRgn )
    {
      if ( *(_QWORD *)(a1 + 8) || (SetLastError(0), v15 = CreateRectRgn(0, 0, 0, 0), (*(_QWORD *)(a1 + 8) = v15) != 0LL) )
      {
        ...
        if ( !CombineRgn(*(HRGN *)(a1 + 8), *(HRGN *)(a1 + 8), RectRgn, 2) )
        {
          ...
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x9Au);
        }
      }
      else
      {
