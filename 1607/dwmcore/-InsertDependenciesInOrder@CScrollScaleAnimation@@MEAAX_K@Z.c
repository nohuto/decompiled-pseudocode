/*
 * XREFs of ?InsertDependenciesInOrder@CScrollScaleAnimation@@MEAAX_K@Z @ 0x18015F430
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CScrollScaleAnimation::InsertDependenciesInOrder(CScrollScaleAnimation *this, __int64 a2)
{
  __int64 *v2; // rax
  int v3; // ebx
  __int64 v6; // rax
