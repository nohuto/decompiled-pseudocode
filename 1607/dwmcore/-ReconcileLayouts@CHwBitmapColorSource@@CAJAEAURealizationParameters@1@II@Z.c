/*
 * XREFs of ?ReconcileLayouts@CHwBitmapColorSource@@CAJAEAURealizationParameters@1@II@Z @ 0x18017E6FC
 * Callers:
        ...
        unsigned int a3)
{
  ...
  else if ( *((_DWORD *)a1 + 15) )
  {
    ...
    v4 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x65Bu);
    return v4;
  }
  if ( v3 )
  {
    ...
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x664u);
  }
  return v4;
}
