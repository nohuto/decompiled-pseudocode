/*
 * XREFs of ?IsQualcommRotationWorkaroundNeeded@COverlayContext@@AEAA_NPEBVCMILMatrix@@@Z @ 0x180129354
 * Callers:
...
char __fastcall COverlayContext::IsQualcommRotationWorkaroundNeeded(COverlayContext *this, const struct CMILMatrix *a2)
{
  ...
  if ( *(_DWORD *)(v2 + 256) == 1297040209
    && (*(_DWORD *)(v2 + 260) <= 0x46363432u || *(_QWORD *)(*(_QWORD *)(v2 + 32) + 352LL) <= 0xB001204360026uLL) )
  {
    v4 = *(float *)a2;
