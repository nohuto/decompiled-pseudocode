/*
 * XREFs of ?ProcessSetVector4Property@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETVECTOR4PROPERTY@@@Z @ 0x18010E798
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETVECTOR4PROPERTY *a3)
{
  ...
  v12 = v3;
  v7 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, __int64, __int64, __int128 *))(v4 + 120);
