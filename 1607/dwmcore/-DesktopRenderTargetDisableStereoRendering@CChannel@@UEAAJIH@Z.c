/*
 * XREFs of ?DesktopRenderTargetDisableStereoRendering@CChannel@@UEAAJIH@Z @ 0x1801149C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::DesktopRenderTargetDisableStereoRendering(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
