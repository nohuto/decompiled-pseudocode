/*
 * XREFs of ?ProcessSetRectangle@CRectangleGeometry@@QEAAJPEAVCResourceTable@@PEBUMILCMD_RECTANGLEGEOMETRY_SETRECTANGLE@@@Z @ 0x1800957F8
 * Callers:
        ...
        const struct MILCMD_RECTANGLEGEOMETRY_SETRECTANGLE *a3)
{
  ...
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0xD2u);
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xD3u);
      }
      else
      {
        ...
        if ( v9 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xD4u);
        }
        else
        {
          ...
          if ( v10 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0xD5u);
          }
          else
          {
            ...
            else
            {
              ...
              if ( v12 < 0 )
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0xD7u);
              }
              else
              {
