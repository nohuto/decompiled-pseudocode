/*
 * XREFs of ?PinResources@CD3DDeviceManager@@QEAAJAEBU_GUID@@U_LUID@@PEAPEAUIDXGIResource@@I@Z @ 0x180172D4C
 * Callers:
...
__int64 __fastcall CD3DDeviceManager::PinResources(
        ...
        unsigned int a5)
{
  ...
  if ( ExistingDevice < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_1801C77A0, 2u, ExistingDevice, 0x51Cu);
  }
  else
  {
    v9 = CD3DDeviceLevel1::PinResources(v11, a4, a5);
    v8 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1801C77A0, 2u, v9, 0x51Eu);
  }
  if ( v7 )
