/*
 * XREFs of ?CheckSizeLayoutMatch@CacheEntryList@CHwBitmapCache@@CA?AW4Enum@SizeLayoutMatch@12@AEBUCacheSizeLayoutParameters@CHwBitmapColorSource@@0@Z @ 0x1800A3D78
 * Callers:
        ...
        if ( v6[2] > *v6 )
        {
          ...
          if ( v8 > v6[1] && v7[2] > *v7 )
          {
            ...
            if ( v9 > v7[1] && v6[2] > *v7 && v7[2] > *v6 && v8 > v7[1] && v9 > v6[1] )
              return (unsigned int)TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::DoesContain(v6, v7) + 2;
          }
        }
      }
      else
