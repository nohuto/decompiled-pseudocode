/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x18015B134
 * Callers:
    ...
    if ( v6 == *((_DWORD *)v3 + 16) )
    {
      switch ( v6 )
      {
        ...
        case 35:
          ...
          v12.m128_f32[0] = fmaxf(COERCE_FLOAT(*v4), COERCE_FLOAT(*(_QWORD *)v3));
          v13.m128_f32[0] = fmaxf(COERCE_FLOAT(HIDWORD(*v4)), COERCE_FLOAT(HIDWORD(*(_QWORD *)v3)));
          *((_DWORD *)v4 + 16) = 35;
        ...
        case 52:
          ...
          v9.m128_f32[0] = fmaxf(COERCE_FLOAT(*v4), COERCE_FLOAT(*(_QWORD *)v3));
          v10.m128_f32[0] = fmaxf(COERCE_FLOAT(HIDWORD(*v4)), COERCE_FLOAT(HIDWORD(*(_QWORD *)v3)));
          v11 = fmaxf(*((float *)v4 + 2), *((float *)v3 + 2));
          *((_DWORD *)v4 + 16) = 52;
        ...
        case 69:
          ...
          *(_QWORD *)&v17 = __PAIR64__(
                              COERCE_UNSIGNED_INT(fmaxf(_mm_shuffle_ps(v8, v8, 85).m128_f32[0], _mm_shuffle_ps(
                                                                                                  v7,
                                                                                                  v7,
                                                                                                  85).m128_f32[0])),
                              COERCE_UNSIGNED_INT(fmaxf(v8.m128_f32[0], v7.m128_f32[0])));
