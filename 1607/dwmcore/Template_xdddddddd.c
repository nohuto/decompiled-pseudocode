/*
 * XREFs of Template_xdddddddd @ 0x18012C54C
 * Callers:
        ...
        char a11)
{
  ...
  int *v13; // [rsp+30h] [rbp-71h]
  __int64 v14; // [rsp+38h] [rbp-69h]
  char *v15; // [rsp+40h] [rbp-61h]
  __int64 v16; // [rsp+48h] [rbp-59h]
  char *v17; // [rsp+50h] [rbp-51h]
  __int64 v18; // [rsp+58h] [rbp-49h]
  char *v19; // [rsp+60h] [rbp-41h]
  ...
  char *v25; // [rsp+90h] [rbp-11h]
  __int64 v26; // [rsp+98h] [rbp-9h]
  char *v27; // [rsp+A0h] [rbp-1h]
  __int64 v28; // [rsp+A8h] [rbp+7h]
  __int64 v29; // [rsp+E0h] [rbp+3Fh] BYREF
  int v30; // [rsp+E8h] [rbp+47h] BYREF
