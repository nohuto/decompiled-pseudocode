/*
 * XREFs of ?SetColors@CGradientColorData@@QEAAJPEBU_D3DCOLORVALUE@@I@Z @ 0x18018C610
 * Callers:
...
__int64 __fastcall CGradientColorData::SetColors(CGradientColorData *this, const struct _D3DCOLORVALUE *a2, __int64 a3)
{
  unsigned int v3; // ebx
  char *v4; // r14
  unsigned int v7; // ebp
  ...
  *((_DWORD *)this + 14) = 0;
  if ( (_DWORD)a3 )
  {
    ...
    if ( (_DWORD)a3 == 1 )
    {
      v8 = DynArray<_D3DCOLORVALUE,0>::AddMultipleAndSet((__int64)this, a2, 1LL);
      v3 = v8;
      if ( v8 < 0 )
      {
      ...
      v9 = DynArray<_D3DCOLORVALUE,0>::AddMultipleAndSet((__int64)this, a2, 1LL);
      v3 = v9;
      if ( v9 < 0 )
      {
