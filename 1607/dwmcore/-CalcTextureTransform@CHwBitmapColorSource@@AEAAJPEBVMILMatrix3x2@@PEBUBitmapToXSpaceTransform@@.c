/*
 * XREFs of ?CalcTextureTransform@CHwBitmapColorSource@@AEAAJPEBVMILMatrix3x2@@PEBUBitmapToXSpaceTransform@@@Z @ 0x180082D70
 * Callers:
        ...
        const struct BitmapToXSpaceTransform *a3)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003304441, 0x807u);
    return 2291662855LL;
  }
  else
  {
    ...
    *((float *)this + 21) = (float)((float)(v24 * *((float *)a2 + 2)) + (float)(v23 * *(float *)a2))
                          + *((float *)a2 + 4);
