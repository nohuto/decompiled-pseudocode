/*
 * XREFs of ?AlphaMultiply_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x180186BC0
 * Callers:
 *     <none>
 * Callees:
 *     ??BCFloat16@@QEAAMXZ @ 0x180180928 (--BCFloat16@@QEAAMXZ.c)
 */
...
void __fastcall AlphaMultiply_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      if ( v4 != CFloat16::operator float((unsigned __int16 *)&word_1801F0148) )
      {
        v5 = CFloat16::operator float(v3);
        if ( v5 != CFloat16::operator float((unsigned __int16 *)&word_1801F03E8) )
        {
          v52 = (float)*v6;
