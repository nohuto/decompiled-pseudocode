/*
 * XREFs of ?DesktopRenderTargetUpdateMonitorRotation@CChannel@@UEAAJIAEBUtagRECT@@0W4DXGI_MODE_ROTATION@@@Z @ 0x180114AA0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum DXGI_MODE_ROTATION a5)
{
  ...
  v18 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 176);
