/*
 * XREFs of ?ProcessToken@CLegacySurfaceManager@@IEAAJPEBU_D3DKMT_PRESENTHISTORYTOKEN@@PEAIPEA_N@Z @ 0x180037978
 * Callers:
 ...
 *     ?FindBitmapNoRef@CLogicalSurfaceHandleMap@@QEAAJPEAXPEAPEAVCGdiSpriteBitmap@@@Z @ 0x1800B16A8 (-FindBitmapNoRef@CLogicalSurfaceHandleMap@@QEAAJPEAXPEAPEAVCGdiSpriteBitmap@@@Z.c)
 *     ?FindGdiSpriteBitmapFromDxShared@CLogicalSurfaceHandleMap@@QEAAX_KPEAPEAVCGdiSpriteBitmap@@@Z @ 0x1800B16F4 (-FindGdiSpriteBitmapFromDxShared@CLogicalSurfaceHandleMap@@QEAAX_KPEAPEAVCGdiSpriteBitmap@@@Z.c)
      ...
      if ( v19 == 1 )
      {
        ...
        if ( v26 )
          CGdiSpriteBitmap::NotifyDirty(
            (struct CGdiSpriteBitmap *)((char *)v26 + 144),
            0LL,
            *((_DWORD *)a2 + 6),
            *((_QWORD *)a2 + 4));
LABEL_7:
