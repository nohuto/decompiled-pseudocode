/*
 * XREFs of ?CreateD2DBitmap@CD2DContext@@MEAAJPEAUID3D11Texture2D@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMAP_PROPERTIES1@@VDisplayId@@PEAPEAVCD2DBitmap@@@Z @ 0x1801735F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DContext::CreateD2DBitmap(
        ...
        _QWORD *a6)
{
  return CD2DContext::CreateD2DBitmapInternal(a1, a2, a3, a4, a5, 0, a6);
}
