/*
 * XREFs of ?Transfer@?$CVertexTransfer2@V?$CScale2DOperator@VCVertexXYWColorDUV2_XYZ_Tangent@@$01$0A@@@$01$0A@VCVertexXYWColorDUV2_XYZ_Tangent@@@@SAXPEBV?$CCommonTransferParameters@VCVertexXYWColorDUV2_XYZ_Tangent@@@@AEBVCMILMatrix@@PEBV3@2@Z @ 0x180198150
 * Callers:
...
__int128 *__fastcall CVertexTransfer2<CScale2DOperator<CVertexXYWColorDUV2_XYZ_Tangent,2,0>,2,0,CVertexXYWColorDUV2_XYZ_Tangent>::Transfer(
        float *a1,
        ...
        CMILMatrix *a4)
{
  ...
  if ( (_DWORD)v11 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v6 + 12) = (int)(float)(unsigned __int8)*(_DWORD *)(v9 + 12) | (((int)(float)(unsigned __int8)BYTE1(*(_DWORD *)(v9 + 12)) | (((int)(float)(unsigned __int8)BYTE2(*(_DWORD *)(v9 + 12)) | ((int)(float)((float)HIBYTE(*(_DWORD *)(v9 + 12)) * v12) << 8)) << 8)) << 8);
