/*
 * XREFs of ??$AddPropertyValue@UD2D_MATRIX_3X2_F@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x18008D034
 * Callers:
...
__int64 __fastcall CPropertyBag::AddPropertyValue<D2D_MATRIX_3X2_F>(CResource *this, __int64 a2, int a3, __int64 a4)
{
  unsigned int v4; // edi
...
LABEL_24:
  ...
  if ( v10 == WPF::ProcessHeapImpl::Alloc )
    v11 = WPF::ProcessHeapImpl::Alloc(WPF::g_pProcessHeap, 0x24uLL);
  else
    v11 = v10(WPF::g_pProcessHeap, 36LL);
  v12 = (__int64)v11;
  if ( v11 )
  {
