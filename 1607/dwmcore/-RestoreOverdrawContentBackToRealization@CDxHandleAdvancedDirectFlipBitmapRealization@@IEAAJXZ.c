/*
 * XREFs of ?RestoreOverdrawContentBackToRealization@CDxHandleAdvancedDirectFlipBitmapRealization@@IEAAJXZ @ 0x18018F6C8
 * Callers:
        ...
        CDxHandleAdvancedDirectFlipBitmapRealization *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x15Eu);
  }
  else
  {
    v4 = *((_QWORD *)this + 57);
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x161u);
    }
