/*
 * XREFs of Template_qqqqq @ 0x18011A64C
 * Callers:
...
ULONG __fastcall Template_qqqqq(__int64 a1, __int64 a2, int a3, int a4, char a5, char a6, char a7)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v14 = 4LL;
  v16 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_SCHEDULE_COMPOSITIONPASS, 5u, &UserData);
}
