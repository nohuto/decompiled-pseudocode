/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x18016FE90
 * Callers:
 *     <none>
 * Callees:
 *     ?QpcToMicroSec@QpcTimeConverter@@QEBAH_KPEA_K@Z @ 0x180020C40 (-QpcToMicroSec@QpcTimeConverter@@QEBAH_KPEA_K@Z.c)
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1800A5774 (_anonymous_namespace_--ResetInteractionOutput.c)
