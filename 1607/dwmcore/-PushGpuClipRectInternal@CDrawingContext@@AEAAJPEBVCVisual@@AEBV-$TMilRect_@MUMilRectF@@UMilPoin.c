/*
 * XREFs of ?PushGpuClipRectInternal@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4D2D1_ANTIALIAS_MODE@@_N3@Z @ 0x18006DE9C
 * Callers:
 ...
 * Callees:
 *     ?RoundWithHalvesDown@@YAXAEBUMilRectF@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180002DAC (-RoundWithHalvesDown@@YAXAEBUMilRectF@@PEAV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded.c)
        ...
        char a6)
{
  ...
  if ( a6 )
  {
    *((_QWORD *)&v29 + 1) = a2;
    LODWORD(v29) = 1;
    v27 = CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Push(a1 + 504, &v29);
    v24 = v27;
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v27, 0x133Fu);
      goto LABEL_23;
    }
    v6 = 1;
  }
    ...
    && *(_DWORD *)(*(_QWORD *)(a1 + 912) + 80LL * (unsigned int)(v10 - 1) + 4) )
  {
    if ( a4 == 1 )
      ...
      v29 = *(_OWORD *)a3;
    v28 = CBaseClipStack::Push((CBaseClipStack *)(a1 + 2976), (const struct MilRectF *)&v29);
    v24 = v28;
    if ( v28 >= 0 )
    {
LABEL_20:
      v25 = 10LL * (unsigned int)(*(_DWORD *)(a1 + 936) - 1);
      ++*(_DWORD *)(*(_QWORD *)(a1 + 912) + 8 * v25 + 4);
      goto LABEL_21;
    }
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v28, 0xF6u);
  }
  else
  {
    if ( a4 == 1 )
    ...
    *((_QWORD *)&v29 + 1) = __PAIR64__(LODWORD(v22), LODWORD(v21));
    ...
    if ( v23 >= 0 )
      goto LABEL_20;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v23, 0xF2u);
  }
LABEL_21:
  if ( v24 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v24, 0x1346u);
  else
    *(_BYTE *)(a1 + 6529) = 1;
LABEL_23:
  if ( v24 < 0 && v6 )
    CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop((int *)(a1 + 504), 0LL);
