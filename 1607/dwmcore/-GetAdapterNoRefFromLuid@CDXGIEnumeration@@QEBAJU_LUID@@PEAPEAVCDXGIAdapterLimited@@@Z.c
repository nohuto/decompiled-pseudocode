/*
 * XREFs of ?GetAdapterNoRefFromLuid@CDXGIEnumeration@@QEBAJU_LUID@@PEAPEAVCDXGIAdapterLimited@@@Z @ 0x1800365F8
 * Callers:
        ...
        struct CDXGIAdapterLimited **a3)
{
  ...
  v3 = -2003304307;
  MilInstrumentationCheckHR(0x14u, &dword_1801ACAC0, 1u, -2003304307, v8);
  return v3;
}
