/*
 * XREFs of ?ProcessSetScalarProperty@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETSCALARPROPERTY@@@Z @ 0x18008CA58
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETSCALARPROPERTY *a3)
{
  ...
  v6 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, _QWORD, __int64, struct CResourceTable **))(v3 + 120);
