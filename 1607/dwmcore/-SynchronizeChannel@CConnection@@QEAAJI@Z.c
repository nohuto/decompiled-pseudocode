/*
 * XREFs of ?SynchronizeChannel@CConnection@@QEAAJI@Z @ 0x1800A8624
 * Callers:
...
__int64 __fastcall CConnection::SynchronizeChannel(struct _RTL_CRITICAL_SECTION *this, unsigned int a2)
{
  ...
  v17 = 0LL;
  v5 = LOBYTE(this[4].LockCount) == 0;
  v16 = 1;
  if ( v5 )
  {
    v7 = -2003303402;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303402, 0x13Du);
LABEL_9:
    LeaveCriticalSection(v2);
    return v7;
  }
  MasterTableEntry = CChannelTable::GetMasterTableEntry((CChannelTable *)&this->OwningThread, a2, &v17);
  v7 = MasterTableEntry;
  if ( MasterTableEntry < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, MasterTableEntry, 0x141u);
    goto LABEL_9;
  }
  v14 = *(__m128i *)v17;
