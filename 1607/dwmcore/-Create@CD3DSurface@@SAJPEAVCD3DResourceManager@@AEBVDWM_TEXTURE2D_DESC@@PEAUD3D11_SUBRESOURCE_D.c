/*
 * XREFs of ?Create@CD3DSurface@@SAJPEAVCD3DResourceManager@@AEBVDWM_TEXTURE2D_DESC@@PEAUD3D11_SUBRESOURCE_DATA@@PEAPEAV1@@Z @ 0x180016FA4
 * Callers:
        ...
        struct CD3DSurface **a4)
{
  ...
  *a4 = 0LL;
  v11 = 0LL;
  v6 = CD3DDeviceLevel1::CreateTexture(a1[16], a2, a3, &v11);
  v7 = v11;
  v8 = v6;
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_1801ACAD0, 0xAu, v6, 0x67u);
  }
  else
  {
    ...
    v8 = ViewOfTexture;
    if ( ViewOfTexture < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1801ACAD0, 0xAu, ViewOfTexture, 0x6Du);
  }
  if ( v7 )
