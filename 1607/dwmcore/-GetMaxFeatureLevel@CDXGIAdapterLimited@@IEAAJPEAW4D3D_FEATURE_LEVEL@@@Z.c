/*
 * XREFs of ?GetMaxFeatureLevel@CDXGIAdapterLimited@@IEAAJPEAW4D3D_FEATURE_LEVEL@@@Z @ 0x1800B2F38
 * Callers:
         ...
         &v13) < 0 )
  {
    ...
    if ( v8 < 0 )
    {
      if ( v8 != -2005270524 )
      {
        v12 = v8;
        v5 = v8;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x196u);
        goto LABEL_6;
      }
      goto LABEL_7;
    }
...
LABEL_5:
  *a2 = v6;
LABEL_6:
  TranslateDXGIorD3DErrorInContext(v5, 0, (int *)&v12);
  return v12;
}
