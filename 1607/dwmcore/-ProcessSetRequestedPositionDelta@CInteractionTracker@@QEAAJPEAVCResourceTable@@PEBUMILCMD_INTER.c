/*
 * XREFs of ?ProcessSetRequestedPositionDelta@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUMILCMD_INTERACTIONTRACKER_SETREQUESTEDPOSITIONDELTA@@@Z @ 0x18010B234
 * Callers:
...
__int64 __fastcall CInteractionTracker::ProcessSetRequestedPositionDelta(
        CInteractionTracker *this,
        struct CResourceTable *a2,
        const struct MILCMD_INTERACTIONTRACKER_SETREQUESTEDPOSITIONDELTA *a3)
{
  float v4; // xmm0_4
  float v6; // xmm0_4
  int v7; // ecx
  ...
  v4 = *((float *)this + 32) + *((float *)a3 + 2);
  if ( v4 <= *((float *)this + 38) )
    v9 = fmaxf(v4, *((float *)this + 35));
  else
    v9 = *((float *)this + 38);
  v6 = *((float *)this + 33) + *((float *)a3 + 3);
  if ( v6 <= *((float *)this + 39) )
