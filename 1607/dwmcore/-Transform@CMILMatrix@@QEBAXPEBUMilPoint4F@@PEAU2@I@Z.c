/*
 * XREFs of ?Transform@CMILMatrix@@QEBAXPEBUMilPoint4F@@PEAU2@I@Z @ 0x180162698
 * Callers:
...
void __fastcall CMILMatrix::Transform(CMILMatrix *this, const struct MilPoint4F *a2, struct MilPoint4F *a3)
{
  float v3; // xmm4_4
  float v4; // xmm5_4
  float v5; // xmm6_4
