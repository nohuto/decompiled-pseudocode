/*
 * XREFs of ?GetSampledStartingValue@CKeyframeAnimation@@UEAAJPEAM@Z @ 0x180019420
 * Callers:
...
__int64 __fastcall CKeyframeAnimation::GetSampledStartingValue(CKeyframeAnimation *this, float *a2)
{
  ...
  v2 = *((_QWORD *)this + 5);
  if ( *(_DWORD *)v2
    || (v6 = CKeyframeAnimation::SampleStartingValue((CKeyframeAnimation *)((char *)this - 288)), v4 = v6, v6 >= 0) )
  {
    switch ( *(_DWORD *)v2 )
    {
      case 0x12:
      ...
      default:
        ...
        {
          v4 = -2147467259;
          MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x6A9u);
          return v4;
        }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x66Du);
  }
  return v4;
}
