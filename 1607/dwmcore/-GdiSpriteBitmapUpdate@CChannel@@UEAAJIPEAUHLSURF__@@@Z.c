/*
 * XREFs of ?GdiSpriteBitmapUpdate@CChannel@@UEAAJIPEAUHLSURF__@@@Z @ 0x180048930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapUpdate(CChannel *this, int a2, HLSURF a3)
{
  unsigned int v6; // ebx
