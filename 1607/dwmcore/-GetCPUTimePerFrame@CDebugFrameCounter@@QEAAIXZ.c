/*
 * XREFs of ?GetCPUTimePerFrame@CDebugFrameCounter@@QEAAIXZ @ 0x180119AE4
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x180119B34 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
