/*
 * XREFs of ?ProcessSetSpriteImage@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUMILCMD_WINDOWNODE_SETSPRITEIMAGE@@@Z @ 0x180025D4C
 * Callers:
        ...
        const struct MILCMD_WINDOWNODE_SETSPRITEIMAGE *a3)
{
  ...
  if ( (_DWORD)v5 != 93 )
    goto LABEL_15;
  Resource = CResourceTable::GetResource(a2, v3, 93LL);
  if ( Resource )
    v5 = (struct ISpriteImage *)(Resource - 16);
  else
    v5 = 0LL;
  if ( v5 )
    v5 = (struct ISpriteImage *)((char *)v5 + 144);
  if ( v5 )
  {
LABEL_10:
