/*
 * XREFs of ?DrawPencilStroke@CD2DContext@@UEAAJPEAVID2DContextOwner@@W4D2D1_ANTIALIAS_MODE@@W4D2D1_PRIMITIVE_BLEND@@PEAUID2D1PencilStroke@@PEBUD2D1_PENCIL_STYLE@@PEAVCCompositionSurfaceBitmap@@AEBUtagRECT@@56M@Z @ 0x180176A00
 * Callers:
 *     <none>
 * Callees:
        ...
        float a11)
{
  ...
  *(_QWORD *)v20 = 0LL;
  D2DBitmapRealizationForContextOwner = CCompositionSurfaceBitmap::GetD2DBitmapRealizationForContextOwner(
                                          (struct CCompositionSurfaceBitmap *)((char *)a7 + 144),
                                          a2,
                                          (struct ID2D1Bitmap1 **)v20);
  v14 = D2DBitmapRealizationForContextOwner;
  if ( D2DBitmapRealizationForContextOwner < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealizationForContextOwner, 0x277u);
    return v14;
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, ID2D1BitmapBrushFromSurfaceBitmap, 0x278u);
  }
  else
  {
LABEL_16:
    ...
    *(_QWORD *)v20 = 0LL;
    v17 = CCompositionSurfaceBitmap::GetD2DBitmapRealizationForContextOwner(
            (struct CCompositionSurfaceBitmap *)((char *)a9 + 144),
            a2,
            (struct ID2D1Bitmap1 **)v20);
    v14 = v17;
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v17, 0x27Eu);
      return v14;
    }
    ...
    {
LABEL_12:
      (*(void (__fastcall **)(_QWORD, struct ID2D1PencilStroke *, const struct D2D1_PENCIL_STYLE *, struct ID2D1BitmapBrush *, struct ID2D1BitmapBrush *, _DWORD))(**((_QWORD **)this + 7) + 32LL))(
        *((_QWORD *)this + 7),
        v25,
        v24,
        v22,
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0x27Fu);
  }
  return v14;
}
