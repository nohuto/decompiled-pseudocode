/*
 * XREFs of ?HrInitDataFromIBitmapSource@CBitmap@@IEAAJPEAVIBitmapSource@@PEAUWICRect@@@Z @ 0x1801828C4
 * Callers:
...
__int64 __fastcall CBitmap::HrInitDataFromIBitmapSource(CBitmap *this, struct IBitmapSource *a2, struct WICRect *a3)
{
  ...
  int v15; // eax
  float v16; // xmm1_4
  double v18; // [rsp+60h] [rbp+8h] BYREF
  double v19; // [rsp+68h] [rbp+10h] BYREF
