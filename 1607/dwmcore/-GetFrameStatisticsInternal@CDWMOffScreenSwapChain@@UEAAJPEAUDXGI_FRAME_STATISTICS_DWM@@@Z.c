/*
 * XREFs of ?GetFrameStatisticsInternal@CDWMOffScreenSwapChain@@UEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@@Z @ 0x1800B8F90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DXGI_FRAME_STATISTICS_DWM *a2)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, 0x3AAu);
  }
  else
  {
    v5 = v8[2];
