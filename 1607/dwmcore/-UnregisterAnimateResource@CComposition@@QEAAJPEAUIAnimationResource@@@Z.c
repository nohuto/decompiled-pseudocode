/*
 * XREFs of ?UnregisterAnimateResource@CComposition@@QEAAJPEAUIAnimationResource@@@Z @ 0x18003B6C0
 * Callers:
...
__int64 __fastcall CComposition::UnregisterAnimateResource(CComposition *this, unsigned __int64 a2)
{
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0xC60u);
  }
  else
  {
    if ( (unsigned int)v6 < v4 - 1 )
    {
      ...
      while ( (unsigned int)a2 < *((_DWORD *)this + 154) - 1 );
    }
    --*((_DWORD *)this + 154);
  }
