/*
 * XREFs of ?GetTextureBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@UBaseSampling@CoordinateSpace@@@@@Z @ 0x1801558D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v4 & 6) == 2 )
  {
    if ( (*(_BYTE *)(a1 + 208) & 1) != 0 )
    {
      ...
      for ( i = 0uLL; (unsigned int)v5 < *(_DWORD *)(a1 + 152); v5 = (unsigned int)(v5 + 1) )
      {
        ...
        if ( v6 )
        {
          (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v6 + 136LL))(v6, v10);
