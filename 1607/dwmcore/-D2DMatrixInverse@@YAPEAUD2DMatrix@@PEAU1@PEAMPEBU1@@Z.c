/*
 * XREFs of ?D2DMatrixInverse@@YAPEAUD2DMatrix@@PEAU1@PEAMPEBU1@@Z @ 0x180187C14
 * Callers:
...
struct D2DMatrix *__fastcall D2DMatrixInverse(struct D2DMatrix *a1, float *a2, const struct D2DMatrix *a3)
{
  ...
  v33 = (float)((float)(v25 * *((float *)a3 + 5)) - (float)(v30 * v11)) + (float)(v22 * v12);
  v34 = (float)((float)(v22 * *(float *)a3) - (float)(v20 * v24)) + (float)(v19 * v31);
  v35 = *((float *)a3 + 12);
  v36 = (float)((float)(v21 * v24) - (float)(v19 * v35)) - (float)(v29 * *(float *)a3);
  v37 = (float)((float)(v29 * v31) - (float)(v22 * v35)) - (float)(v25 * v24);
  v50 = (float)((float)(v25 * *(float *)a3) - (float)(v21 * v31)) + (float)(v20 * v35);
  v38 = (float)((float)((float)(v26 * v35) + (float)(v27 * v31)) + (float)(v32 * v24)) + (float)(v33 * *(float *)a3);
  if ( a2 )
    *a2 = v38;
  if ( v38 == 0.0 )
    return 0LL;
