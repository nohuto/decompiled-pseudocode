/*
 * XREFs of ?Partition_RegisterForNotifications@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_PARTITION_REGISTERFORNOTIFICATIONS@@@Z @ 0x18003C058
 * Callers:
...
LABEL_10:
          ...
          CComposition::NotifyHelper(this, (struct MIL_MESSAGE *)&v16, (__int64)v7);
          return 0LL;
        }
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x61Du);
        return 0LL;
      }
      goto LABEL_10;
    }
