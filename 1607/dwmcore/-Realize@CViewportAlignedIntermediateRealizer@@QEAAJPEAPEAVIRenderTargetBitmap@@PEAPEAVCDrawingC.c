/*
 * XREFs of ?Realize@CViewportAlignedIntermediateRealizer@@QEAAJPEAPEAVIRenderTargetBitmap@@PEAPEAVCDrawingContext@@PEAVCMILMatrix@@PEAH@Z @ 0x1801612C0
 * Callers:
         ...
         v15[0])) )
  {
    ...
    if ( !*a5 )
    {
      ...
      if ( !*a5 )
      {
        ...
        CMILMatrix::PrependTranslate((CMILMatrix *)v23, COERCE_FLOAT(v18[0] ^ _xmm), COERCE_FLOAT(v18[1] ^ _xmm), 0.0);
