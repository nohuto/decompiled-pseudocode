/*
 * XREFs of ?ClipAgainstMargins@CWindowNode@@QEAAXPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180026A00
 * Callers:
...
__int64 __fastcall CWindowNode::ClipAgainstMargins(__int64 a1, __int64 a2)
{
  ...
  if ( v2 > 0 )
  {
    v11 = _mm_loadu_si128((const __m128i *)(a1 + 200));
  ...
  if ( v3 > 0 )
  {
    v12 = (__m128)_mm_loadu_si128((const __m128i *)(a1 + 200));
  ...
  if ( v4 > 0 )
  {
    v10 = (__m128)_mm_loadu_si128((const __m128i *)(a1 + 200));
  ...
  result = *(unsigned int *)(a1 + 900);
  if ( (int)result > 0 )
  {
    v13 = (__m128)_mm_loadu_si128((const __m128i *)(a1 + 200));
