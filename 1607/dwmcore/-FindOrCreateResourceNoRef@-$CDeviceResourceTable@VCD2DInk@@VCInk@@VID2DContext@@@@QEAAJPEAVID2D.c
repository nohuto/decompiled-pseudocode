/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DInk@@VCInk@@VID2DContext@@@@QEAAJPEAVID2DContext@@PEAPEAVCD2DInk@@@Z @ 0x18014D43C
 * Callers:
        ...
        struct CD2DInk **a3)
{
  ...
  char v6; // r15
  __int64 v7; // rdx
  struct CD2DInk *v10; // rdx
  int DefaultDevice; // eax
  int v12; // eax
  unsigned int v13; // eax
  unsigned int v14; // edx
  struct CD2DInk *v15; // rcx
  int v16; // eax
  unsigned int v18; // [rsp+20h] [rbp-10h]
  struct CD2DInk *v19; // [rsp+60h] [rbp+30h] BYREF
  ...
  if ( *((_DWORD *)a1 + 10) )
  {
    ...
    v10 = *(struct CD2DInk **)(*((_QWORD *)a1 + 2) + 8 * v7);
    v19 = v10;
    if ( v10 )
      goto LABEL_18;
  }
...
LABEL_26:
  ...
  v12 = CInk::CreateResource(*((CInk **)a1 + 1), a2, &v19);
  v3 = v12;
  if ( v12 < 0 )
  {
    v18 = 90;
  ...
  v12 = CD2DResource::AddResourceNotifier((struct CD2DInk *)((char *)v19 + 16), a1);
  v3 = v12;
  if ( v12 < 0 )
  {
    v18 = 92;
  ...
  if ( v3 < 0 )
  {
    *a3 = 0LL;
    if ( v6 )
    {
      if ( !v15 )
        goto LABEL_33;
      CD2DResource::RemoveResourceNotifier((struct CD2DInk *)((char *)v15 + 16), a1);
      v15 = v19;
    }
  }
  if ( v15 )
    (*(void (__fastcall **)(struct CD2DInk *))(*(_QWORD *)v15 + 16LL))(v15);
LABEL_33:
  if ( v4 )
