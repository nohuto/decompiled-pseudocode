/*
 * XREFs of Template_xxxqf @ 0x1801415E0
 * Callers:
...
ULONG Template_xxxqf(__int64 a1, __int64 a2, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v9 = 4LL;
  v11 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_DCOMPEVENT_ANIMATION_UPDATE_VALUE, 5u, &UserData);
}
