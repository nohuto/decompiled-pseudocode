/*
 * XREFs of Template_xqqqddddddddddddqqq @ 0x18017CDF8
 * Callers:
...
ULONG __fastcall Template_xqqqddddddddddddqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a21)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v56 = 4LL;
  v58 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_OVERLAY_PRESENT, 0x13u, &UserData);
}
