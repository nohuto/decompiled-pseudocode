/*
 * XREFs of ?InitializeFromRegistry@CCommonRegistryData@@SAJXZ @ 0x1800A982C
 * Callers:
 ...
 *     ?RegReadDWORD@@YA_NPEAUHKEY__@@PEBGPEAK@Z @ 0x1800A9D28 (-RegReadDWORD@@YA_NPEAUHKEY__@@PEBGPEAK@Z.c)
 */
...
__int64 CCommonRegistryData::InitializeFromRegistry(void)
{
  ...
  if ( v0 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v0, 0xE6u);
  }
