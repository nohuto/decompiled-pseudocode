/*
 * XREFs of ?ProcessUpdate@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_METABITMAPRENDERTARGET@@@Z @ 0x180107C58
 * Callers:
        ...
        const struct MILCMD_METABITMAPRENDERTARGET *a3)
{
  ...
  if ( *((_DWORD *)this + 100) <= 6u )
  {
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x22Cu);
    }
    else
    {
      *((_DWORD *)this + 86) = *((_DWORD *)a3 + 4);
      *((_DWORD *)this + 87) = *((_DWORD *)a3 + 5);
      *v3 = *(_OWORD *)((char *)a3 + 8);
  ...
  {
    v6 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x229u);
  }
  return v6;
}
