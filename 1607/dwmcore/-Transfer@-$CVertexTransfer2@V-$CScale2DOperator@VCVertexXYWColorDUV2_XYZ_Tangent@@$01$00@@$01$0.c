/*
 * XREFs of ?Transfer@?$CVertexTransfer2@V?$CScale2DOperator@VCVertexXYWColorDUV2_XYZ_Tangent@@$01$00@@$01$00VCVertexXYWColorDUV2_XYZ_Tangent@@@@SAXPEBV?$CCommonTransferParameters@VCVertexXYWColorDUV2_XYZ_Tangent@@@@AEBVCMILMatrix@@PEBV3@2@Z @ 0x180197E00
 * Callers:
...
_UNKNOWN **__fastcall CVertexTransfer2<CScale2DOperator<CVertexXYWColorDUV2_XYZ_Tangent,2,1>,2,1,CVertexXYWColorDUV2_XYZ_Tangent>::Transfer(
        __int64 a1,
        unsigned int *a2,
        unsigned int *a3,
        CMILMatrix *a4)
