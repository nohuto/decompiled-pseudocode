/*
 * XREFs of ?Transfer@?$CVertexTransfer2@V?$CNonScale2DOperator@VCVertexXYWColorDUV2_XYZ_Tangent@@$00$0A@@@$00$0A@VCVertexXYWColorDUV2_XYZ_Tangent@@@@SAXPEBV?$CCommonTransferParameters@VCVertexXYWColorDUV2_XYZ_Tangent@@@@AEBVCMILMatrix@@PEBV3@2@Z @ 0x180196BCC
 * Callers:
...
__int128 *__fastcall CVertexTransfer2<CNonScale2DOperator<CVertexXYWColorDUV2_XYZ_Tangent,1,0>,1,0,CVertexXYWColorDUV2_XYZ_Tangent>::Transfer(
        __int64 a1,
        float *a2,
        CMILMatrix *a3,
        CMILMatrix *a4)
{
  ...
  if ( (_DWORD)v10 )
  {
    ...
    do
    {
      *(float *)(v12 - 8) = (float)((float)(*a2 * *(p_y - 1)) + (float)(a2[4] * *p_y)) + a2[12];
      v14 = (float)((float)(a2[5] * *p_y) + (float)(a2[1] * *(p_y - 1))) + a2[13];
      *(_DWORD *)v12 = 1065353216;
      *(float *)(v12 - 4) = v14;
      *(_QWORD *)(v12 + 8) = *(_QWORD *)(p_y + 3);
      *(_QWORD *)(v12 + 16) = *(_QWORD *)(p_y + 5);
      *(_DWORD *)(v12 + 4) = (int)(float)((float)(unsigned __int8)*((_DWORD *)p_y + 2) * v11) | (((int)(float)((float)(unsigned __int8)BYTE1(*((_DWORD *)p_y + 2)) * v11) | (((int)(float)((float)(unsigned __int8)BYTE2(*((_DWORD *)p_y + 2)) * v11) | ((int)(float)((float)HIBYTE(*((_DWORD *)p_y + 2)) * v11) << 8)) << 8)) << 8);
