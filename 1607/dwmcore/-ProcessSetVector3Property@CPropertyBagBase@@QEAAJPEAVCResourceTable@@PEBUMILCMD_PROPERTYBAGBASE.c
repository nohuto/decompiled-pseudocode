/*
 * XREFs of ?ProcessSetVector3Property@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETVECTOR3PROPERTY@@@Z @ 0x18010E6FC
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETVECTOR3PROPERTY *a3)
{
  ...
  v8 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, __int64, __int64, _DWORD *))(v5 + 120);
