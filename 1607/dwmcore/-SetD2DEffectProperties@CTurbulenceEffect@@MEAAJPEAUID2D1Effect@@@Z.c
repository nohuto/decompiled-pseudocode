/*
 * XREFs of ?SetD2DEffectProperties@CTurbulenceEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801563D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTurbulenceEffect::SetD2DEffectProperties(CTurbulenceEffect *this, struct ID2D1Effect *a2)
{
  ...
  v15 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 68), (__m128)*((unsigned int *)this + 69)).m128_u64[0];
  ...
  else
  {
    ...
    v15 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 70), (__m128)*((unsigned int *)this + 71)).m128_u64[0];
    ...
    else
    {
      ...
      v15 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 72), (__m128)*((unsigned int *)this + 73)).m128_u64[0];
