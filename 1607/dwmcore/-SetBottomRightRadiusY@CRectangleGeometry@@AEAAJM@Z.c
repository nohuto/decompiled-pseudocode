/*
 * XREFs of ?SetBottomRightRadiusY@CRectangleGeometry@@AEAAJM@Z @ 0x180095998
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetBottomRightRadiusY(CRectangleGeometry *this, float a2)
{
  unsigned int v2; // ebx
  int v5; // eax
  ...
  if ( *((float *)this + 55) != a2 )
  {
    *((float *)this + 55) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyFloatPropertyChanged(this, 12LL, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x27Fu);
    else
