/*
 * XREFs of ?MilCompositionEngine_Initialize@@YAJHPEAUIDWMCoRenderEngine@@PEAPEAUHMIL_CONNECTION__@@@Z @ 0x1800AA0A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct HMIL_CONNECTION__ **a3)
{
  ...
  if ( a3 )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1801AF8C0, 1u, v4, 0x2Fu);
    else
      *a3 = v7;
  }
  else
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR(0x14u, &dword_1801AF8C0, 1u, -2147024809, 0x2Bu);
  }
  return v5;
}
