/*
 * XREFs of ?EndBoundingFrame@CRenderData@@AEAAJPEAHPEAPEAVCRenderDataDrawFrame@@PEAPEAUIDrawingContext@@PEAU3@@Z @ 0x180137B64
 * Callers:
        ...
        struct IDrawingContext *a5)
{
  ...
  __int64 v12; // rdx
  int v13; // r12d
  struct CRenderDataDrawFrame *v14; // r14
  __int64 v15; // rbx
  ...
  int v20; // eax
  struct CSolidColorLegacyMilBrush *v21; // rdi
  struct _D3DCOLORVALUE v23; // [rsp+30h] [rbp-38h] BYREF
  struct CSolidColorLegacyMilBrush *v24; // [rsp+78h] [rbp+10h] BYREF
