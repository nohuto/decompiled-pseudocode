/*
 * XREFs of ?ProcessSetVector2Property@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETVECTOR2PROPERTY@@@Z @ 0x18010E688
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETVECTOR2PROPERTY *a3)
{
  ...
  v8 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, __int64, __int64, struct CResourceTable **))(*(_QWORD *)this + 120LL);
