/*
 * XREFs of ?GetWindowDirtyIndex@CDxAccumulationContext@@AEAAIXZ @ 0x1800B7950
 * Callers:
...
__int64 __fastcall CDxAccumulationContext::GetWindowDirtyIndex(const struct CWindowNode **this)
{
  ...
  v1 = 0;
  v3 = (struct CWindowNode *)*((_QWORD *)*this + 18);
  if ( v3 )
  {
    while ( 1 )
    {
      v4 = *((_QWORD *)v3 + 18);
      if ( !v4 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v4 + 48LL))(v4, 34LL) )
        break;
      v3 = (struct CWindowNode *)*((_QWORD *)v3 + 18);
    }
  }
  if ( this[3] != v3 || *((_DWORD *)this + 8) >= 0x20u )
  {
    if ( v3 && (*(unsigned __int8 (__fastcall **)(struct CWindowNode *, __int64))(*(_QWORD *)v3 + 48LL))(v3, 34LL) )
    {
