/*
 * XREFs of ?GetDestinationRectanglesCore@CAtlasedRectsMesh@@MEAAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@I@Z @ 0x18009CB90
 * Callers:
...
__int64 __fastcall CAtlasedRectsMesh::GetDestinationRectanglesCore(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  else if ( v3 )
  {
    ...
    do
    {
      *(_OWORD *)(v6 + a2) = *(_OWORD *)(v6 + *(_QWORD *)(a1 + 240));
      v6 += 16LL;
      --v7;
    }
    while ( v7 );
