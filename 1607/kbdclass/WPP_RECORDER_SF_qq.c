 ...
 *     KeyboardClassCancelPendingIrpLeds @ 0x1C0004600 (KeyboardClassCancelPendingIrpLeds.c)
 ...
 * 00000001C000370E: lea     rax, [rdi+rdi*4]
 * 00000001C0003712: shl     rax, 4
 * 00000001C0003716: add     rcx, rax
 * 00000001C0003719: cmp     [rcx+29h], sil
 * 00000001C000371D: jb      loc_1C00018D2
 * 00000001C0003723: mov     rax, cs:pfnWppTraceMessage
 * 00000001C000372A: lea     rdx, [rsp+58h+arg_30]
 * 00000001C0003732: mov     rcx, [rcx+18h]
 * 00000001C0003736: lea     r8, WPP_fecf80922958397349997befa54f38a2_Traceguids
 * 00000001C000373D: mov     [rsp+58h+var_18], 0
 * 00000001C0003746: mov     [rsp+58h+var_20], 8
 * 00000001C000374F: mov     [rsp+58h+var_28], rdx
 * 00000001C0003754: lea     rdx, [rsp+58h+arg_28]
 * 00000001C000375C: mov     [rsp+58h+var_30], 8
 * 00000001C0003765: mov     [rsp+58h+var_38], rdx
 * 00000001C000376A: mov     edx, 2Bh ; '+'
 * 00000001C000376F: movzx   r9d, bp
 * 00000001C0003773: call    cs:__guard_dispatch_icall_fptr
 * 00000001C0003779: nop
 * 00000001C000377A: jmp     loc_1C00018D2
 */
