/*
 * XREFs of KeyboardClassSystemControl @ 0x1C000D380
 * Callers:
 *     <none>
 * Callees:
 *     KeyboardClassPassThrough @ 0x1C000D450 (KeyboardClassPassThrough.c)
 */
...
__int64 __fastcall KeyboardClassSystemControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  v6 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)DeviceExtension + 1, Irp, &byte_1C000D5F0, 1u, 0x20u);
  v7 = v6;
  if ( v6 >= 0 )
  {
