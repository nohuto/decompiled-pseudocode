/*
 * XREFs of KeyboardPnP @ 0x1C0001A70
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqc @ 0x1C0001C80 (WPP_RECORDER_SF_qqc.c)
 ...
 *     KeyboardClassRemoveDevice @ 0x1C0004CC4 (KeyboardClassRemoveDevice.c)
