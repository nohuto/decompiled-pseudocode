/*
 * XREFs of KeyboardClassWaitWakeComplete @ 0x1C0004F20
 * Callers:
 *     <none>
 * Callees:
 *     KeyboardToggleWaitWake @ 0x1C00050DC (KeyboardToggleWaitWake.c)
 *     WPP_RECORDER_SF_qd @ 0x1C0005764 (WPP_RECORDER_SF_qd.c)
