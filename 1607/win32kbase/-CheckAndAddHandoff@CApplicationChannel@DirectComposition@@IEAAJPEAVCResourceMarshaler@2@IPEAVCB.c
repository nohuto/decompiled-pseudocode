/*
 * XREFs of ?CheckAndAddHandoff@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IPEAVCBaseAnimation@2@PEAVCAnimationBinding@2@@Z @ 0x1C003E96C
 * Callers:
 ...
 *     ?GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z @ 0x1C004D66C (-GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z.c)
        ...
        struct DirectComposition::CAnimationBinding *a5)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v10 + 112LL))(v10, 88LL) )
  {
    v11 = (**(__int64 (__fastcall ***)(struct DirectComposition::CBaseAnimation *))a4)(a4);
    v12 = v11 ? v11 - 16 : 0LL;
    if ( v12 && *(_DWORD *)(v12 + 164) )
    {
      ...
      if ( a5
        ...
        && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v15 + 112LL))(v15, 89LL) )
      {
        v17[0] = v14[10];
      }
      else
      ...
      if ( v14 && (*(unsigned __int8 (__fastcall **)(_DWORD *, __int64))(*(_QWORD *)v14 + 112LL))(v14, 88LL) )
      {
        v16 = v14 - 4;
        if ( *(_QWORD *)(v12 + 176) || (*(_DWORD *)(v12 + 32) & 0x1000) != 0 || v16 == (_DWORD *)v12 )
          return (unsigned int)-1073741811;
        if ( v16 )
        {
          *(_QWORD *)(v12 + 176) = v16;
          DirectComposition::CResourceMarshaler::AddRef((DirectComposition::CResourceMarshaler *)(v16 + 4));
          DirectComposition::CAnimationMarshaler::GetAnimationTimeState(
            (DirectComposition::CAnimationMarshaler *)v16,
            &v18,
            (__int64 *)(v12 + 192),
            (unsigned __int64 *)(v12 + 200));
          *(_BYTE *)(v12 + 208) ^= (*(_BYTE *)(v12 + 208) ^ v18) & 1;
          v16[8] |= 0x1000u;
        }
      }
      *(_DWORD *)(v12 + 184) = v17[0];
    }
  }
  return v9;
}
