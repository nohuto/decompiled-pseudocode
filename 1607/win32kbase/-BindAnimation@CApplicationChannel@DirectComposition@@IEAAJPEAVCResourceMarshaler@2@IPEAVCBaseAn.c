/*
 * XREFs of ?BindAnimation@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IPEAVCBaseAnimation@2@@Z @ 0x1C003FA20
 * Callers:
        ...
        struct DirectComposition::CBaseAnimation *a4)
{
  ...
  struct DirectComposition::CBaseAnimation **v9; // rsi
