/*
 * XREFs of ?GetSurfaceUpdate@CCompositionSurface@@QEBAJ_KPEAUCSM_SURFACE_UPDATE@@@Z @ 0x1C001B294
 * Callers:
    ...
    if ( RenderingBuffer )
    {
      if ( *((int *)this + 9) > 0 )
      {
        ...
        if ( v6 >= 0 )
        {
          ...
          *((_DWORD *)a3 + 7) = *((_DWORD *)v8 + 63);
          CRegion::GetRegionHandleAndReset(*((CRegion **)v8 + 32), (HRGN *)a3 + 4);
          *(_OWORD *)((char *)a3 + 40) = *(_OWORD *)((char *)v8 + 264);
          *((_QWORD *)a3 + 7) = *((_QWORD *)v8 + 35);
          *((_DWORD *)a3 + 16) = *((_DWORD *)v8 + 72);
          v9 = *((_OWORD *)v8 + 3);
          *((_DWORD *)v8 + 66) = 0;
          *((_BYTE *)v8 + 292) = 0;
