/*
 * XREFs of ?ReplacePreferredScaling@@YAJPEBU_D3DKMT_GETPATHSMODALITY@@PEAU1@@Z @ 0x1C00C7D4C
 * Callers:
...
__int64 __fastcall ReplacePreferredScaling(__int64 a1, unsigned __int64 a2, _DWORD *a3, __int64 a4)
{
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v11 + v5 + 176) = v13[32];
    v16 = v13[33];
    *(_DWORD *)(v11 + v5 + 48) |= 0x10400u;
    *(_DWORD *)(v11 + v5 + 180) = v16;
LABEL_22:
