/*
 * XREFs of GreSfmDxQuerySwapChainBindingStatus @ 0x1C0016FF0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall GreSfmDxQuerySwapChainBindingStatus(__int64 a1, struct _D3DKMT_PRESENTHISTORYTOKEN *a2)
{
  int result; // eax
