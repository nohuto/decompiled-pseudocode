/*
 * XREFs of CitDisplayPowerChange @ 0x1C00868F0
 * Callers:
...
void __fastcall CitDisplayPowerChange(__int64 a1, union _LARGE_INTEGER a2)
{
  ...
  {
    v4 = *(_DWORD *)(a1 + 64);
    if ( (*((_DWORD *)qword_1C011E5D0 + 134) == 0) == (v4 == 0) )
    {
      *((_DWORD *)qword_1C011E5D0 + 134) = v4;
    }
    else
    {
      ...
      {
        CitpBitmapUpdateForTimeRange(v2, *((_DWORD *)v2 + 132), v5);
        *((_DWORD *)v2 + 133) = (gPowerState & 1) != 0 ? dword_1C011BBDC : 0;
        CitpSetForegroundProcess(v2, v5, 0LL, 0LL, 0LL, 0LL);
        CitpInteractionSummariesFlush(v2);
        v29 = MEMORY[0xFFFFF78000000008] - qword_1C011E5F0 - MEMORY[0xFFFFF780000003B0];
        SystemTime.QuadPart = MEMORY[0xFFFFF78000000014];
        ExSystemTimeToLocalTime(&SystemTime, &LocalTime);
        if ( v29 > qword_1C011E570 && LocalTime.QuadPart - qword_1C011E5F8 > (unsigned __int64)qword_1C011E578 )
