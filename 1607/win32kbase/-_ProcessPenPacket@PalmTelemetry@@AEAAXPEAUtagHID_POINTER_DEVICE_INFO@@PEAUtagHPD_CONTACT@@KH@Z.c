/*
 * XREFs of ?_ProcessPenPacket@PalmTelemetry@@AEAAXPEAUtagHID_POINTER_DEVICE_INFO@@PEAUtagHPD_CONTACT@@KH@Z @ 0x1C00E1740
 * Callers:
 ...
 *     ?_DiscardOldTouchPackets@PalmTelemetry@@AEAAXK@Z @ 0x1C00E16B8 (-_DiscardOldTouchPackets@PalmTelemetry@@AEAAXK@Z.c)
 */
