/*
 * XREFs of ?SetReferenceProperty@CDesktopTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C007BE70
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( v9 )
  {
    if ( v9 == 1
      && (!a4
       || (*(unsigned int (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)a4 + 16LL))(a4) == 41) )
    {
