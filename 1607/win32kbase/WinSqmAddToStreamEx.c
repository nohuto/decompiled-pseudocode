/*
 * XREFs of WinSqmAddToStreamEx @ 0x1C0070640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WinSqmAddToStreamEx(struct _GUID *a1, int a2, unsigned int a3, __int64 a4, char a5)
{
  ...
  __int64 v19; // rdx
  int v20; // eax
  ULONG v21; // [rsp+20h] [rbp-81h] BYREF
            ...
            *(_DWORD *)v15 = *(_DWORD *)(a4 + 16LL * v16 + 4);
            switch ( *(_DWORD *)(a4 + 16LL * v16 + 4) )
            {
              ...
              case 2:
                ...
                if ( v15 + (unsigned __int64)v17 > v14 + v21 )
                  return Win32FreePool();
                v20 = RtlStringCchCopyW((unsigned __int16 *)(v15 + 8), (unsigned int)(v19 + 1), v18);
