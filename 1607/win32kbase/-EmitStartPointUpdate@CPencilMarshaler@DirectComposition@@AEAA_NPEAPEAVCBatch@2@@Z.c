/*
 * XREFs of ?EmitStartPointUpdate@CPencilMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00E5C3C
 * Callers:
...
char __fastcall DirectComposition::CPencilMarshaler::EmitStartPointUpdate(
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v5) )
  {
    ...
    *((_DWORD *)v3 + 4) = *((_DWORD *)this + 21);
    *((_DWORD *)v3 + 5) = *((_DWORD *)this + 22);
    *((_DWORD *)this + 4) |= 0x40u;
    return 1;
  }
  return 0;
