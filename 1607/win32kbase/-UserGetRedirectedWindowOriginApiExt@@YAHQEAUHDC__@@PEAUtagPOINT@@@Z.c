/*
 * XREFs of ?UserGetRedirectedWindowOriginApiExt@@YAHQEAUHDC__@@PEAUtagPOINT@@@Z @ 0x1C00C3A70
 * Callers:
 *     <none>
 * Callees:
 *     IsUserGetRedirectedWindowOriginSupported_0 @ 0x1C00015D8 (IsUserGetRedirectedWindowOriginSupported_0.c)
