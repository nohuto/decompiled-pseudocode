/*
 * XREFs of ?bCreatePalette@PALMEMOBJ@@QEAAHKKPEAKKKKKH@Z @ 0x1C00BF210
 * Callers:
 ...
 * Callees:
 *     ?vComputeCallTables@XEPALOBJ@@QEAAXXZ @ 0x1C0026F10 (-vComputeCallTables@XEPALOBJ@@QEAAXXZ.c)
 *     AllocateObject @ 0x1C0031800 (AllocateObject.c)
 *     FreeObject @ 0x1C00366E0 (FreeObject.c)
 *     ?ParseBits@@YAXKPEAK00K@Z @ 0x1C0073FC8 (-ParseBits@@YAXKPEAK00K@Z.c)
  ...
  if ( Object )
  {
    ...
    *(_QWORD *)(Object + 120) = Object + 136;
    ...
    else
    {
      ...
      {
        memset(*(void **)(*(_QWORD *)this + 120LL), 0, 4LL * v9);
      }
    }
    v24[0] = v15;
