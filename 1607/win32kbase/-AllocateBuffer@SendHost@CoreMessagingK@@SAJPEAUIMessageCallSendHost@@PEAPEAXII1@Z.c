/*
 * XREFs of ?AllocateBuffer@SendHost@CoreMessagingK@@SAJPEAUIMessageCallSendHost@@PEAPEAXII1@Z @ 0x1C00F86C0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a5)
{
  ...
  *a5 = 0LL;
  if ( a4 > v6 )
    CoreMessagingK::Runtime::BugCheck(17, a4, 0LL);
  if ( a4 > 0xFFAF )
    CoreMessagingK::Runtime::BugCheck(18, a4, 0LL);
  v8 = v6 + 80;
