/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0077F0C
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C0077EC0 (CreateSharedReadTransformMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadTransformMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadTransformMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 232LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
