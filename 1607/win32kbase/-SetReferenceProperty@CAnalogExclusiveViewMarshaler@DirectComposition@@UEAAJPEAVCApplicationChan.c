/*
 * XREFs of ?SetReferenceProperty@CAnalogExclusiveViewMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00E78E0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( a3 == 2
    && (!a4
     || (*(unsigned int (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)a4 + 16LL))(a4) == 92) )
  {
