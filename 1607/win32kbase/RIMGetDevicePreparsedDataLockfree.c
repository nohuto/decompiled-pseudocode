/*
 * XREFs of RIMGetDevicePreparsedDataLockfree @ 0x1C00CEC10
 * Callers:
 *     NtRIMGetDevicePreparsedDataLockfree @ 0x1C00CE190 (NtRIMGetDevicePreparsedDataLockfree.c)
    ...
    if ( v9[48] == 2 )
    {
      ...
      if ( a2 )
      {
        if ( a4 )
        {
          ...
          v16 = (ULONGLONG)a2 + v14;
          if ( v16 > W32UserProbeAddress || v16 <= (unsigned __int64)a2 )
            *(_BYTE *)W32UserProbeAddress = 0;
          memmove(a2, v12, v15);
        }
        else
