/*
 * XREFs of ?DrvCreatePathModalityFromAllPaths@@YAJPEAPEAU_D3DKMT_GETPATHSMODALITY@@I0@Z @ 0x1C00C6AE0
 * Callers:
        ...
        __int64 a4)
{
  ...
  {
    PathsModality = GetPathsModality(0LL, a3, (_DWORD)a2 != 0 ? 8 : 1, 0LL);
    v13 = PathsModality;
    if ( PathsModality < 0 )
    {
      v14 = WdLogNewEntry5_WdError(v10, v9, v11, v12);
      *(_QWORD *)(v14 + 24) = v13;
      *(_QWORD *)(v14 + 32) = 25121LL;
  ...
  if ( !*a1 )
  {
    ...
    v17 = GetPathsModality(0LL, a1, 16LL, 0LL);
    v18 = v17;
    if ( v17 < 0 )
    {
      v19 = WdLogNewEntry5_WdError(a1, a2, a3, a4);
      *(_QWORD *)(v19 + 24) = v18;
      *(_QWORD *)(v19 + 32) = 25141LL;
