/*
 * XREFs of ?EmitSetVector4Property@CPropertyBagMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@AEAUPropertyUpdate@@@Z @ 0x1C00E726C
 * Callers:
...
char __fastcall DirectComposition::CPropertyBagMarshaler::EmitSetVector4Property(
