/*
 * XREFs of ?RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z @ 0x1C00D4DE4
 * Callers:
 *     RIMIDEInjectDeviceInput @ 0x1C00D6304 (RIMIDEInjectDeviceInput.c)
 * Callees:
 *     RIMGetMaxContactCountNoButton @ 0x1C00D4A74 (RIMGetMaxContactCountNoButton.c)
 */
...
__int64 __fastcall RIMIDEInjectionIndexToLinkIndex(struct RIMDEV *a1, int a2, unsigned __int16 *a3, int a4)
{
  ...
  *a3 = 0;
  if ( *((_DWORD *)a1 + 79) )
  {
    v7 = RIMGetMaxContactCountNoButton(*((_QWORD *)a1 + 60));
    v12 = *(_QWORD *)(v11 + 680);
    v13 = v7;
    if ( v12 )
    {
