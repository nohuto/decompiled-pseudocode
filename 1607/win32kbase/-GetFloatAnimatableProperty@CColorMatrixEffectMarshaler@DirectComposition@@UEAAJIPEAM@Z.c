/*
 * XREFs of ?GetFloatAnimatableProperty@CColorMatrixEffectMarshaler@DirectComposition@@UEAAJIPEAM@Z @ 0x1C00EFEE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        float *a3)
{
  ...
  if ( (unsigned int)(a2 - 3) <= 0x13 )
    *a3 = *((float *)this + 4 * ((unsigned int)(a2 - 3) >> 2) + (((_BYTE)a2 + 1) & 3) + 24);
  else
