/*
 * XREFs of Template_ddxdddd @ 0x1C00B719C
 * Callers:
 *     EtwTraceTouchHWTimeStamp @ 0x1C00B5BC0 (EtwTraceTouchHWTimeStamp.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0089A80 (__security_check_cookie.c)
 */

NTSTATUS __fastcall Template_ddxdddd(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v21 = 4LL;
  v23 = 4LL;
  return EtwWrite(Microsoft_Windows_Win32kHandle, &TouchHWTimeStamp, &W32kControlGuid, 7u, &UserData);
}
