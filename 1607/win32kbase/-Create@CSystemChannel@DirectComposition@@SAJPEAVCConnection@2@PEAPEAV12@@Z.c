/*
 * XREFs of ?Create@CSystemChannel@DirectComposition@@SAJPEAVCConnection@2@PEAPEAV12@@Z @ 0x1C0079F60
 * Callers:
        ...
        struct DirectComposition::CSystemChannel **a2)
{
  ...
  v4 = (DirectComposition::CApplicationChannel *)Win32AllocPoolZInit(0x320uLL);
  v5 = v4;
  if ( v4 )
  {
