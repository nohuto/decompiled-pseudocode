/*
 * XREFs of rimPredictionPolicyUpdateStateAndApply @ 0x1C00DDF28
 * Callers:
 *     rimApplyPointerDevicePolicies @ 0x1C00DBD14 (rimApplyPointerDevicePolicies.c)
 * Callees:
 *     ApiSetDoPrediction @ 0x1C00DE7BC (ApiSetDoPrediction.c)
 */
...
__int64 __fastcall rimPredictionPolicyUpdateStateAndApply(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( a4 || (*(_DWORD *)(a1 + 252) & 0x20) != 0 || (unsigned int)(*(_DWORD *)(a1 + 24) - 1) > 3 )
  {
