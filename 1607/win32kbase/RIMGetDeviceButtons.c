/*
 * XREFs of RIMGetDeviceButtons @ 0x1C0007734
 * Callers:
 ...
 * Callees:
 *     RIMPbuttonToCursor @ 0x1C0006B10 (RIMPbuttonToCursor.c)
...
__int64 __fastcall RIMGetDeviceButtons(__int64 a1, __int64 a2, __int64 a3, _WORD *a4, unsigned int a5)
{
  ...
  {
    v14 = Win32AllocPoolZInit(12LL * *(unsigned int *)(a2 + 688));
    *(_QWORD *)(a2 + 1584) = v14;
    if ( v14 )
    {
      v27 = *(_DWORD *)(a2 + 24) == 7;
      *(_DWORD *)(a2 + 1596) = *(_DWORD *)(a2 + 688);
      if ( v27 )
        SpecificButtonCaps = RIMValidatePTPButtons(v12, a5);
      if ( SpecificButtonCaps >= 0 )
      {
        for ( i = 0; i < *(_DWORD *)(a2 + 1596); *(_DWORD *)(*(_QWORD *)(a2 + 1584) + 4 * v17) = 1 )
        {
          ++*(_DWORD *)(a1 + 656);
          v16 = i++;
          v17 = 3 * v16;
          *(_DWORD *)(*(_QWORD *)(a2 + 1584) + 4 * v17 + 4) = *(_DWORD *)(a1 + 656);
        }
      }
      goto LABEL_12;
    }
...
LABEL_29:
  ...
  if ( !v10 )
    goto LABEL_38;
  *(_DWORD *)(*(_QWORD *)(a2 + 1584) + 4LL) = v31;
  **(_DWORD **)(a2 + 1584) = RIMPbuttonToCursor(66);
  if ( v9 > v30 )
  {
    *(_DWORD *)(*(_QWORD *)(a2 + 1584) + 16LL) = v32;
    *(_DWORD *)(*(_QWORD *)(a2 + 1584) + 12LL) = RIMPbuttonToCursor(69);
  }
LABEL_12:
  v18 = a5;
  *(_DWORD *)(a2 + 304) += a5;
