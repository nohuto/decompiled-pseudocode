/*
 * XREFs of ?AddVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIHI@Z @ 0x1C003FE28
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v10 )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(*(_QWORD *)v10 + 112LL))(
            v10,
            32LL) )
      return (unsigned int)-1073741811;
    v11 = (unsigned int)(a3 - 1);
    if ( a3 && v11 < *((_QWORD *)this + 11) )
    {
      _mm_lfence();
      v12 = *(_QWORD *)(v11 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8));
    }
    else
    {
      v12 = 0LL;
    }
    if ( !v12 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v12 + 112LL))(v12, 32LL) )
      return (unsigned int)-1073741811;
    if ( !a5 )
      goto LABEL_16;
    v13 = a5 - 1;
    ...
    {
      _mm_lfence();
      v5 = *(_QWORD *)(v13 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8));
    }
    if ( v5 && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 112LL))(v5, 32LL) )
    {
LABEL_16:
      v14 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, __int64, _QWORD, __int64, char *))(*(_QWORD *)v10 + 232LL))(
              v10,
              this,
              v12,
              a4,
