/*
 * XREFs of rimFindOrCreateActiveContact @ 0x1C00DDA20
 * Callers:
 ...
 *     RIMCmActivateContact @ 0x1C00E103C (RIMCmActivateContact.c)
        ...
        _DWORD *a6)
{
  ...
  v8 = (_QWORD **)(*(_QWORD *)(a1 + 1552) + 16LL * (v19 % *(_DWORD *)(a1 + 1560)));
