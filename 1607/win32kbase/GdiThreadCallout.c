/*
 * XREFs of GdiThreadCallout @ 0x1C005C7B0
 * Callers:
 *     <none>
 * Callees:
 *     IsUMPDCachedResourceCleanupSupported_0 @ 0x1C0001810 (IsUMPDCachedResourceCleanupSupported_0.c)
 *     UMPDCachedResourceCleanupWrap_0 @ 0x1C0001818 (UMPDCachedResourceCleanupWrap_0.c)
...
__int64 __fastcall GdiThreadCallout(__int64 a1, int a2)
{
  ...
  if ( a2 )
  {
    if ( a2 == 1 )
    {
      ...
      if ( *(_QWORD *)(ThreadWin32Thread + 80) )
        ((void (__fastcall *)(__int64, _QWORD))qword_1C011B568)(ThreadWin32Thread + 80, 0LL);
  ...
  else
  {
    ...
    v3 += 10;
    *v3 = 0LL;
    return (unsigned int)((__int64 (__fastcall *)(_QWORD *, __int64))qword_1C011B568)(v3, v4);
  }
  return v2;
}
