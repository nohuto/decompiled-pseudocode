/*
 * XREFs of ?EmitSetMatrix3x2Property@CPropertyBagMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@AEAUPropertyUpdate@@@Z @ 0x1C003C378
 * Callers:
...
char __fastcall DirectComposition::CPropertyBagMarshaler::EmitSetMatrix3x2Property(
        ...
        struct PropertyUpdate *a3)
{
  ...
  v5 = 1;
  if ( !DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x2CuLL, (void **)&v11) )
    return 0;
  v6 = v11;
  *v11 = 44;
  v7 = v6 + 1;
  memset(v6 + 1, 0, 0x28uLL);
