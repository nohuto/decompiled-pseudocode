/*
 * XREFs of rimLoadImage @ 0x1C00523E8
 * Callers:
      ...
      if ( v6 != -1073741820 )
      {
        if ( v6 >= 0 )
        {
          ...
          if ( *v8 )
          {
            ...
            v10 = *(void **)&v8[74 * v9 + 6];
            qword_1C011BA28 = (__int64)RtlImageDirectoryEntryToData(v10, 1u, 0, &Size);
            AddressOfEntryPoint = RtlImageNtHeader(v10)->OptionalHeader.AddressOfEntryPoint;
            qword_1C011BA18 = 0LL;
            qword_1C011BA20 = (__int64)v10 + AddressOfEntryPoint;
            v1 = 1;
            qword_1C011BA10 = (__int64)v10;
          }
        }
LABEL_21:
        Win32FreePool();
