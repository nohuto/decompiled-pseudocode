/*
 * XREFs of ?CitpSavedDataPrune@@YAJPEAX@Z @ 0x1C00F78FC
 * Callers:
 ...
 *     ?CitpSaveKeyFromString@@YAXPEAU_CIT_SAVE_KEY@@PEAG@Z @ 0x1C00F6CE0 (-CitpSaveKeyFromString@@YAXPEAU_CIT_SAVE_KEY@@PEAG@Z.c)
 */
...
__int64 __fastcall CitpSavedDataPrune(HANDLE KeyHandle)
{
  ...
  v39 = (__int64)dword_1C011E59C << 10;
  v2 = 0;
  KeyHandlea = KeyHandle;
  v3 = 0LL;
  SystemTime.QuadPart = MEMORY[0xFFFFF78000000014];
  ExSystemTimeToLocalTime(&SystemTime, &LocalTime);
  v38 = LocalTime.QuadPart - 10000000LL * (unsigned int)dword_1C011E598;
...
LABEL_21:
        ...
        v5 = 0;
        v24 = 0;
        while ( v14 != (unsigned __int8 *)&v31 && (v2 > dword_1C011E594 || v3 > v39) )
        {
          v25 = *(_QWORD **)v14;
          ...
          if ( v26 < 0 )
          {
            CitpLogFailureWorker((unsigned int)v26, v27, 4815);
            ++v24;
            v5 = v28;
          }
...
LABEL_49:
  ...
  {
    CitpLogFailureWorker(v7, v6, 4680);
  }
