/*
 * XREFs of Template_hhq @ 0x1C00B72E0
 * Callers:
 *     EtwTracePointerCoalesce @ 0x1C00B55E0 (EtwTracePointerCoalesce.c)
 *     EtwTracePointerNoCoalesce @ 0x1C00B5860 (EtwTracePointerNoCoalesce.c)
 * Callees:
