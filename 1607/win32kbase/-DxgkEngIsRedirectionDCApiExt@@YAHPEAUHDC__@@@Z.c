/*
 * XREFs of ?DxgkEngIsRedirectionDCApiExt@@YAHPEAUHDC__@@@Z @ 0x1C00C36B0
 * Callers:
 *     <none>
 * Callees:
 *     IsDxgkEngIsRedirectionDCSupported_0 @ 0x1C0001510 (IsDxgkEngIsRedirectionDCSupported_0.c)
 *     DxgkEngIsRedirectionDC_0 @ 0x1C0001518 (DxgkEngIsRedirectionDC_0.c)
 */
