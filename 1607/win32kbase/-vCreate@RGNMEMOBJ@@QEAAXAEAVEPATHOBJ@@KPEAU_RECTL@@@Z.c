/*
 * XREFs of ?vCreate@RGNMEMOBJ@@QEAAXAEAVEPATHOBJ@@KPEAU_RECTL@@@Z @ 0x1C00310F0
 * Callers:
 ...
 *     ?bFlatten@EPATHOBJ@@QEAAHXZ @ 0x1C0046BC0 (-bFlatten@EPATHOBJ@@QEAAHXZ.c)
 *     ?vCloseAllFigures@EPATHOBJ@@QEAAXXZ @ 0x1C0046D30 (-vCloseAllFigures@EPATHOBJ@@QEAAXXZ.c)
 *     vAdvanceAETEdges @ 0x1C0076250 (vAdvanceAETEdges.c)
 *     bConstructGET @ 0x1C00763F0 (bConstructGET.c)
 *     vXSortAETEdges @ 0x1C00768C0 (vXSortAETEdges.c)
 *     vMoveNewEdges @ 0x1C0078B50 (vMoveNewEdges.c)
  ...
  *(_QWORD *)this = 0LL;
  ...
  if ( v7 >= 0x14 )
  {
    ...
    if ( (unsigned int)v12 < v7 )
      return;
    if ( (unsigned __int64)(48 * v12) > 0xFFFFFFFF )
      return;
    v10 = (char *)PALLOCMEM2(48 * v12);
    if ( !v10 )
      return;
    v11 = 1;
  }
