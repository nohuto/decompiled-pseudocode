/*
 * XREFs of ?UnregisterChannel@CConnection@DirectComposition@@QEAAXPEAVCBatch@2@_N@Z @ 0x1C00191A4
 * Callers:
 ...
 *     ?PostBatch@CConnection@DirectComposition@@QEAAXPEAVCBatch@2@0@Z @ 0x1C0019164 (-PostBatch@CConnection@DirectComposition@@QEAAXPEAVCBatch@2@0@Z.c)
        ...
        char a3)
{
  ...
  *((_DWORD *)a2 + 5) = 6;
  ...
  if ( a3 )
    DirectComposition::CConnection::Release(this, v6);
}
