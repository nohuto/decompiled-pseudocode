/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C00E1B50
 * Callers:
    ...
    *((_DWORD *)this + 1) = v6;
    if ( v6 )
    {
      ...
      do
      {
        ...
        {
          if ( dword_1C0118710 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0118710, 0x800000000000uLL) )
          {
            TlgCreateSz(&pDesc, v2);
            TlgWrite((TraceLoggingHProvider)&dword_1C0118710, &unk_1C0103EE0, 0LL, v15, 3u, &pData);
          }
          v8 = 0LL;
          pcchLength = 0LL;
          v4 = 1;
      ...
      if ( v8 )
      {
        ...
        {
          TlgCreateSz(&v23, v2);
          TlgWrite((TraceLoggingHProvider)&dword_1C0118710, &unk_1C0103EE0, 0LL, v17, 3u, &v22);
        }
        v4 = 1;
      }
      if ( v4 )
