/*
 * XREFs of ?EmitSegmentCountUpdate@CPencilMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00E5AFC
 * Callers:
...
char __fastcall DirectComposition::CPencilMarshaler::EmitSegmentCountUpdate(
