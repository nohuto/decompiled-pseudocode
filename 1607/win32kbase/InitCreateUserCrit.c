/*
 * XREFs of InitCreateUserCrit @ 0x1C0154458
 * Callers:
...
LABEL_35:
                  ...
                  v9 = (struct _KEVENT *)ExAllocatePoolWithTag((POOL_TYPE)512, 0x38uLL, 0x664B7355u);
