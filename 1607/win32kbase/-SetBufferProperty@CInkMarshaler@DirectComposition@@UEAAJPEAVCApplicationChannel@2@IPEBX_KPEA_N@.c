/*
 * XREFs of ?SetBufferProperty@CInkMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C00E5630
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v9 == 2 )
      {
        if ( a4 )
        {
          if ( a5 == 36 )
          {
            v10 = *((_QWORD *)this + 16);
            if ( v10 )
              return (unsigned int)DirectComposition::CInkMarshaler::SetSegments(this, v10 - 1, a4, 1u, a6);
          }
        }
      }
    }
