/*
 * XREFs of _TlgWriteAgg @ 0x1C00BC1D8
 * Callers:
 *     NtUserWin32kSysCallFilterStub @ 0x1C00BC100 (NtUserWin32kSysCallFilterStub.c)
 * Callees:
 *     ExtractAggregateFieldTypes @ 0x1C00F8D04 (ExtractAggregateFieldTypes.c)
        ...
        PEVENT_DATA_DESCRIPTOR UserData)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData->Ptr = (ULONGLONG)off_1C0118758;
  UserData->Size = *(unsigned __int16 *)off_1C0118758;
  UserData->Reserved = 2;
  UserData[1].Ptr = (ULONGLONG)v7;
  UserData[1].Size = *v7;
  result = -1073741811;
  UserData[1].Reserved = 1;
  if ( (void (__fastcall *)(LPCGUID, __int64, __int64, ULONGLONG, ULONGLONG, PEVENT_FILTER_DESCRIPTOR, _QWORD *))qword_1C0118778 == RegisteredProviderEtwCallback )
  {
    ...
    {
      return EtwWriteTransfer(qword_1C0118770, &EventDescriptor, 0LL, 0LL, 4u, UserData);
    }
  }
  return result;
}
