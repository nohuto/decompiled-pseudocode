/*
 * XREFs of ?SetRemarshalingFlags@CVisualMarshaler@DirectComposition@@MEAA_NXZ @ 0x1C00E6460
 * Callers:
 *     ?SetRemarshalingFlags@CSpriteVisualMarshaler@DirectComposition@@MEAA_NXZ @ 0x1C00EB120 (-SetRemarshalingFlags@CSpriteVisualMarshaler@DirectComposition@@MEAA_NXZ.c)
 *     ?SetRemarshalingFlags@CHostVisualMarshaler@DirectComposition@@UEAA_NXZ @ 0x1C00F19A0 (-SetRemarshalingFlags@CHostVisualMarshaler@DirectComposition@@UEAA_NXZ.c)
 * Callees:
...
char __fastcall DirectComposition::CVisualMarshaler::SetRemarshalingFlags(DirectComposition::CVisualMarshaler *this)
{
  ...
  v3 = *((_QWORD *)this + 13);
  if ( v3 && *(_QWORD *)(v3 + 16) || (*((_BYTE *)this + 232) & 0x20) != 0 )
  ...
  if ( *((_QWORD *)this + 24) != ((*(unsigned int (__fastcall **)(DirectComposition::CVisualMarshaler *))(*(_QWORD *)this + 280LL))(this) | 0xFFFFFFFF00000000uLL)
    || *((_DWORD *)this + 50) != -1
    || *((_DWORD *)this + 51) != -1
    || *((_DWORD *)this + 52) != -1
    || *((_DWORD *)this + 53) != -1 )
  ...
  if ( (*((_DWORD *)this + 4) & 0x1FFDF80) != 0 || v5 )
    return 1;
  return v1;
}
