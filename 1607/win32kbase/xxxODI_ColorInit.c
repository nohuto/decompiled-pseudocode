/*
 * XREFs of xxxODI_ColorInit @ 0x1C0055430
 * Callers:
...
__int64 __fastcall xxxODI_ColorInit(PCUNICODE_STRING Source)
{
  ...
  _DWORD v18[32]; // [rsp+D0h] [rbp-30h] BYREF
  unsigned __int16 v19[28]; // [rsp+150h] [rbp+50h] BYREF

  v2 = gpsi;
  v3 = 0;
  v4 = 0LL;
  *((_OWORD *)gpsi + 310) = gargbInitial;
  v2[311] = xmmword_1C01022C0;
  v2[312] = xmmword_1C01022D0;
  v2[313] = xmmword_1C01022E0;
  v2[314] = xmmword_1C01022F0;
  v2[315] = xmmword_1C0102300;
  v2[316] = xmmword_1C0102310;
  ...
  *((_DWORD *)v5 + 1239) = *((_DWORD *)v5 + 1270);
  do
  {
    ...
    v7 = &v17[v4 * 4];
    v8 = v19;
    v9 = *(_DWORD *)&v17[v4 * 4 + 4960LL - (_QWORD)v17 + (_QWORD)gpsi];
    if ( v6 )
    {
      v10 = &v15;
      v11 = 0;
  ...
  while ( v3 < 0x1F );
  return xxxSetSysColors((_DWORD)Source, v3, (unsigned int)v18, (unsigned int)v17, 6);
}
