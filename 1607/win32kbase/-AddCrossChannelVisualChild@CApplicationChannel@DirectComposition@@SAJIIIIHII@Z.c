/*
 * XREFs of ?AddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIIIHII@Z @ 0x1C007E2F8
 * Callers:
 *     NtDCompositionAddCrossDeviceVisualChild @ 0x1C007E2F0 (NtDCompositionAddCrossDeviceVisualChild.c)
 * Callees:
...
LABEL_16:
  ...
  if ( v8 )
  {
    ...
    {
      v18 = v21;
      DirectComposition::CApplicationChannel::ReleaseCrossChannelVisualChild(v21);
