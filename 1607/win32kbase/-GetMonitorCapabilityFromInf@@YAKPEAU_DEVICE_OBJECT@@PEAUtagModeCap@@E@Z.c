/*
 * XREFs of ?GetMonitorCapabilityFromInf@@YAKPEAU_DEVICE_OBJECT@@PEAUtagModeCap@@E@Z @ 0x1C005EFA0
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C00B1638 (__report_rangecheckfailure.c)
 */
