/*
 * XREFs of MarkThreadsObjects @ 0x1C0039070
 * Callers:
...
__int64 __fastcall MarkThreadsObjects(__int64 a1)
{
  ...
  v4 = qword_1C011A128 + 24LL * (unsigned int)giheLast;
  if ( qword_1C011A128 <= v4 )
  {
    do
    {
      ...
      if ( (_BYTE)result )
      {
        result = *((unsigned __int8 *)&unk_1C00FEE4C + 16 * (unsigned __int8)result);
