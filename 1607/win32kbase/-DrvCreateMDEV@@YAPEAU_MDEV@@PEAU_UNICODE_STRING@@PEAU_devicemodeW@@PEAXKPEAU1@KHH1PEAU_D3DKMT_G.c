/*
 * XREFs of ?DrvCreateMDEV@@YAPEAU_MDEV@@PEAU_UNICODE_STRING@@PEAU_devicemodeW@@PEAXKPEAU1@KHH1PEAU_D3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00671D4
 * Callers:
 ...
 * Callees:
 *     IsGetWin8StyleDpiSettingFromRegistrySupported_0 @ 0x1C0001778 (IsGetWin8StyleDpiSettingFromRegistrySupported_0.c)
 *     GetWin8StyleDpiSettingFromRegistry_0 @ 0x1C0001780 (GetWin8StyleDpiSettingFromRegistry_0.c)
 *     IsGetDpiSettingWithNoDefaultSupported_0 @ 0x1C0001788 (IsGetDpiSettingWithNoDefaultSupported_0.c)
 *     GetDpiSettingWithNoDefault_0 @ 0x1C0001790 (GetDpiSettingWithNoDefault_0.c)
 ...
 *     UserSetScaleFactorsFromRemoteMetric @ 0x1C0068644 (UserSetScaleFactorsFromRemoteMetric.c)
 ...
 *     ?IsPrimaryPathInCloneGroup@@YAEPEBU_D3DKMT_GETPATHSMODALITY@@I@Z @ 0x1C006992C (-IsPrimaryPathInCloneGroup@@YAEPEBU_D3DKMT_GETPATHSMODALITY@@I@Z.c)
 *     EtwTraceGreLockReleaseSemaphore @ 0x1C0073A30 (EtwTraceGreLockReleaseSemaphore.c)
 *     EtwTraceGreLockAcquireSemaphoreExclusive @ 0x1C00740D0 (EtwTraceGreLockAcquireSemaphoreExclusive.c)
 *     ?DxgkEngQueryWin32Info@@YAJPEAU_DXGK_QUERY_WIN32_INFO@@@Z @ 0x1C007EDE0 (-DxgkEngQueryWin32Info@@YAJPEAU_DXGK_QUERY_WIN32_INFO@@@Z.c)
        ...
        struct _D3DKMT_GETPATHSMODALITY *a10)
{
  ...
  unsigned int v177; // [rsp+A4h] [rbp-64h]
  int v178; // [rsp+A8h] [rbp-60h]
  struct _devicemodeW *v179; // [rsp+B0h] [rbp-58h]
  struct tagSIZE v180; // [rsp+B8h] [rbp-50h] BYREF
  unsigned int v181; // [rsp+C0h] [rbp-48h] BYREF
  int v182; // [rsp+C4h] [rbp-44h]
  unsigned __int64 v183; // [rsp+C8h] [rbp-40h]
  void *Buf2; // [rsp+D0h] [rbp-38h]
  _QWORD v185[2]; // [rsp+D8h] [rbp-30h] BYREF
  _BYTE v186[96]; // [rsp+E8h] [rbp-20h] BYREF
  HDEV v188; // [rsp+158h] [rbp+50h]
  int v189; // [rsp+158h] [rbp+50h]
  unsigned int v192; // [rsp+168h] [rbp+60h]
  unsigned __int8 v193; // [rsp+170h] [rbp+68h]
  int v194; // [rsp+170h] [rbp+68h]
  bool v195; // [rsp+170h] [rbp+68h]
  struct _MDEV *v196; // [rsp+178h] [rbp+70h]
  unsigned int v197; // [rsp+180h] [rbp+78h]
  int v198; // [rsp+198h] [rbp+90h]
  struct _D3DKMT_GETPATHSMODALITY *v199; // [rsp+1A0h] [rbp+98h]
  ...
  if ( v10 )
  {
    ...
    if ( DeviceFromName && (*((_DWORD *)DeviceFromName + 40) & 0x20000000) != 0 )
    {
      ...
      do
      {
        if ( (wchar_t *)Blink[162].Blink == DeviceFromName )
          break;
        Blink = Blink[1].Blink;
      }
      while ( Blink );
      ...
      {
LABEL_201:
        v128 = WdLogNewEntry5_WdTrace(Blink);
...
LABEL_137:
          ...
          if ( v178 == 2 && gProtocolType == (_WORD)v24 )
          {
                ...
                do
                {
                  ...
                  if ( (*(_DWORD *)(*(_QWORD *)(v60 + 2600) + 160LL) & 0x800000) != 0 )
                  {
                    *(_DWORD *)(v60 + 2572) ^= (*(_DWORD *)(v60 + 2572) ^ (32 * (v58 == v197))) & 0x20;
                    v194 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64, __int64, __int64))qword_1C011B6F8)(
                ...
                if ( (unsigned __int16)(gProtocolType - 1) <= 0xFFFDu )
                {
                  ...
                  if ( v12[5] )
                  {
                    ...
                    do
                    {
                      ...
                      v183 = __PAIR64__(v117, v119);
                      v180 = (struct tagSIZE)__PAIR64__(v117, v119);
                      if ( v114 )
                      {
                        FillPhysicalDpiOnly(&v173, &v180, (struct _DPI_INFORMATION *)(v113 + 2480));
                        v161 = HIWORD(v114);
                  ...
                  *(_QWORD *)(v70 + 2608) = *(_QWORD *)&v50->dmDeviceName[8 * i];
                  if ( *(_QWORD *)(v70 + 3408) )
                  {
                    ...
                    if ( v71 )
                      ...
                      v72 = 0LL;
                    (*(void (__fastcall **)(__int64, __int64))(v70 + 3408))(v72, 2LL);
                  }
...
LABEL_119:
      ...
      if ( gForceDisconnect != (_DWORD)v24 || v19 == 3 )
        ...
        v36 = gProtocolType;
      PrimaryAttachFlags = GetPrimaryAttachFlags((struct tagGRAPHICS_DEVICE *)j, v36, &v181, &v174);
      v24 = 0LL;
...
LABEL_138:
      ...
      if ( v94 )
      {
        ...
        {
          Src = v179;
          memset(v179, 0, sizeof(struct _devicemodeW));
          Src->dmSize = 220;
          v100 = DrvProbeAndCaptureDevmode(
                   (struct tagGRAPHICS_DEVICE *)j,
                   &v167,
...
LABEL_146:
          v101 = v167;
          v32 = hCreateHDEV((struct tagGRAPHICS_DEVICE *)j, v95, v167, a3, v97, v98, v176, (v193 >> 2) & 1, v96, &v172);
...
LABEL_276:
          ...
          {
            v151 = 2LL;
            dmPelsHeight = v179->dmPelsHeight;
            dmPelsWidth = v179->dmPelsWidth;
          }
