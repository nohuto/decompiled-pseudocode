/*
 * XREFs of ?EmitUpdateFlags@CInteractionMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C004B898
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x200) != 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x20uLL, &v6) )
    {
      ...
      *((_DWORD *)v4 + 1) = 201;
      *((_DWORD *)v4 + 3) = (*((unsigned __int8 *)this + 240) >> 1) & 1;
      *((_DWORD *)v4 + 4) = *((_BYTE *)this + 240) & 1;
      *((_DWORD *)v4 + 5) = (*((unsigned __int8 *)this + 240) >> 2) & 1;
      *((_DWORD *)v4 + 6) = (*((unsigned __int8 *)this + 240) >> 3) & 1;
      *((_DWORD *)v4 + 7) = (*((unsigned __int8 *)this + 240) >> 4) & 1;
