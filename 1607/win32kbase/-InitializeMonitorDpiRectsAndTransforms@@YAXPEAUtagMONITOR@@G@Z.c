/*
 * XREFs of ?InitializeMonitorDpiRectsAndTransforms@@YAXPEAUtagMONITOR@@G@Z @ 0x1C0058580
 * Callers:
 ...
 *     ?GetModel@CFlipToken@@UEBA?AW4TokenModel@CTokenBase@@XZ @ 0x1C007D080 (-GetModel@CFlipToken@@UEBA-AW4TokenModel@CTokenBase@@XZ.c)
...
void __fastcall InitializeMonitorDpiRectsAndTransforms(struct tagMONITOR *a1, unsigned __int16 a2)
{
  ...
  for ( i = 0; i < 2; ++i )
  {
    ...
    if ( *((_WORD *)a1 + 77) == v6 && v2->x == *v7 && *((_DWORD *)a1 + 8) == v7[1]
      || !(unsigned int)CFlipToken::GetModel() )
    {
      if ( *v9 )
      {
        Win32FreePool();
    ...
    else if ( *v9 || (v12 = Win32AllocPoolWithQuota(), (*v9 = (void *)v12) != 0LL) )
    {
      memset(*v9, 0, 0x40uLL);
      v13 = (float)v6;
      v14 = (float)*((unsigned __int16 *)a1 + 77) / v13;
      *(float *)*v9 = v14;
      *((float *)*v9 + 5) = v14;
      *((_DWORD *)*v9 + 10) = 1065353216;
      *((_DWORD *)*v9 + 15) = 1065353216;
      *((float *)*v9 + 12) = (float)v2->x - (float)((float)((float)*v7 * (float)*((unsigned __int16 *)a1 + 77)) / v13);
      *((float *)*v9 + 13) = (float)*((int *)a1 + 8)
                           - (float)((float)((float)v7[1] * (float)*((unsigned __int16 *)a1 + 77)) / v13);
    }
    a2 = v16;
  }
}
