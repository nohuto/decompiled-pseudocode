/*
 * XREFs of ?vComputeAccelFlags@EXFORMOBJ@@QEAAXK@Z @ 0x1C0045CD0
 * Callers:
 ...
 *     ?bIs1@EFLOAT@@QEAAHXZ @ 0x1C00455E0 (-bIs1@EFLOAT@@QEAAHXZ.c)
 *     ?bIs1Over16@EFLOAT@@QEAAHXZ @ 0x1C00BDB70 (-bIs1Over16@EFLOAT@@QEAAHXZ.c)
 */
...
void __fastcall EXFORMOBJ::vComputeAccelFlags(EXFORMOBJ *this, int a2)
{
  ...
  *(_DWORD *)(*(_QWORD *)this + 32LL) = a2;
  ...
  if ( !*(_DWORD *)(*(_QWORD *)this + 24LL) && !*(_DWORD *)(v2 + 28) )
    *(_DWORD *)(v2 + 32) |= 0x40u;
  if ( EFLOAT::bIsZero((EFLOAT *)(*(_QWORD *)this + 4LL)) && EFLOAT::bIsZero((EFLOAT *)(v3 + 8)) )
  {
    *(_DWORD *)(v5 + 32) |= 1u;
    v7 = *v4;
    if ( v6 == 8 )
    {
      if ( !EFLOAT::bIs16((EFLOAT *)v7) )
        return;
      v9 = EFLOAT::bIs16((EFLOAT *)(v8 + 12));
    }
    else if ( v6 == 32 )
    {
      if ( !EFLOAT::bIs1((EFLOAT *)v7) )
        return;
