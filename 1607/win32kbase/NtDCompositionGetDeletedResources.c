/*
 * XREFs of NtDCompositionGetDeletedResources @ 0x1C00465A0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v10 )
      {
        ...
        do
        {
          ...
          if ( v10 < v15 )
            v15 = v10;
          v16 = v15;
          memmove(v13, (const void *)(*((_QWORD *)v9 + 61) + v14 * *((_QWORD *)v9 + 65)), v15 * *((_QWORD *)v9 + 65));
          v12 = *((_QWORD *)v9 + 64);
          *((_DWORD *)v9 + 132) = (unsigned int)(v16 + *((_DWORD *)v9 + 132)) % v12;
          *((_DWORD *)v9 + 133) -= v16;
          v13 += 8 * v16;
          v10 -= v16;
        }
