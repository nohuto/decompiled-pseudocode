/*
 * XREFs of bDynamicModeChange @ 0x1C006A204
 * Callers:
 ...
 *     IsvDisableSynchronizeSupported_0 @ 0x1C0001708 (IsvDisableSynchronizeSupported_0.c)
 *     IsvSpDynamicModeChangeSupported_0 @ 0x1C0001710 (IsvSpDynamicModeChangeSupported_0.c)
 *     vSpDynamicModeChange_0 @ 0x1C0001718 (vSpDynamicModeChange_0.c)
...
__int64 __fastcall bDynamicModeChange(HDEV a1, HDEV a2)
{
  ...
  _OWORD *v112; // rax
  __int128 v113; // xmm1
  __int64 v115; // [rsp+30h] [rbp-89h]
  struct SURFACE *v116; // [rsp+40h] [rbp-79h]
  __int64 v117; // [rsp+48h] [rbp-71h]
  HDEV v118; // [rsp+50h] [rbp-69h] BYREF
  HDEV v119; // [rsp+58h] [rbp-61h] BYREF
  int v120; // [rsp+60h] [rbp-59h]
  int v121; // [rsp+64h] [rbp-55h]
  struct SURFACE *v122; // [rsp+68h] [rbp-51h]
  __int64 v123; // [rsp+70h] [rbp-49h]
  struct tagSIZE v124; // [rsp+78h] [rbp-41h]
  __int64 v125; // [rsp+80h] [rbp-39h]
  __int64 v126; // [rsp+88h] [rbp-31h]
  struct tagSIZE v127; // [rsp+90h] [rbp-29h]
  void *v128; // [rsp+98h] [rbp-21h]
  __int64 v129; // [rsp+A0h] [rbp-19h] BYREF
  __int64 v130; // [rsp+A8h] [rbp-11h] BYREF
  __int64 v131[12]; // [rsp+B0h] [rbp-9h] BYREF
  int v132; // [rsp+130h] [rbp+77h]
  __int64 v133; // [rsp+130h] [rbp+77h]
  BOOL v134; // [rsp+138h] [rbp+7Fh]

  v4 = 0;
  if ( (unsigned int)bDynamicMatchEnoughForModeChange(a1, a2) )
  {
    v128 = PALLOCMEM2(0x9F8uLL, 1886221383LL, 0);
    v5 = (__int64)v128;
    if ( v128 )
    {
      v6 = *((_DWORD *)a2 + 14);
      ...
      v134 = *((_DWORD *)a1 + 546) * *((_DWORD *)a1 + 547) != *((_DWORD *)a2 + 546) * *((_DWORD *)a2 + 547);
      if ( (unsigned int)bDynamicRemoveAllDriverRealizations(a1)
        && (unsigned int)bDynamicRemoveAllDriverRealizations(a2) )
      {
        v132 = 1;
        v8 = (struct tagSIZE *)PDEVOBJ::sizl((PDEVOBJ *)&v118, &v129);
        v122 = (struct SURFACE *)*((_QWORD *)a1 + 322);
        v9 = *v8;
        v125 = *((_QWORD *)a1 + 229);
        v123 = *((_QWORD *)a1 + 228);
        v124 = v9;
        v10 = (struct tagSIZE *)PDEVOBJ::sizl((PDEVOBJ *)&v119, &v130);
        ...
        v117 = *((_QWORD *)a2 + 228);
        v127 = v14;
        if ( v14.cx < v9.cx || (cy = (unsigned int)v124.cy, v14.cy < v124.cy) )
        {
          v16 = bDynamicIntersectVisRect(v12, v14);
          v13 = v116;
          cy = (unsigned int)v124.cy;
          v11 = v16 & 1;
          v132 = v11;
        }
        if ( v9.cx < v14.cx || (int)cy < v127.cy )
          v11 = bDynamicIntersectVisRect(v13, v9) & v132;
        v17 = *((_QWORD *)a2 + 346);
        if ( v17 && v17 == *((_QWORD *)a1 + 346) && *((_QWORD *)a2 + 227) == *((_QWORD *)a1 + 227) )
        {
          if ( !v11 )
            goto LABEL_116;
          v11 = (*((__int64 (__fastcall **)(__int64, __int64))a2 + 346))(v123, v117);
        }
        if ( v11 )
        {
          LOBYTE(cy) = 1;
...
LABEL_40:
              ...
              if ( v30 == a1 )
              {
                ...
                if ( (v31 & 0x4000000) != 0 )
                {
                  if ( v134 && *(_DWORD *)(v28 + 96) == *((_DWORD *)v29 + 24) )
                  {
                    v32 = a2;
                    v33 = a1;
                    goto LABEL_52;
              ...
              else if ( v30 == a2 )
              {
                ...
                if ( (v34 & 0x4000000) != 0 )
                {
                  if ( v134 && *(_DWORD *)(v28 + 96) == *((_DWORD *)v116 + 24) )
                  {
                    v32 = a1;
                    v33 = a2;
LABEL_52:
...
LABEL_64:
                ...
                {
                  v40 = v122;
                  vChangeWndObjs(v122, a1, v116, a2);
                  v41 = HmgShareLock((unsigned int)ghbrGrayPattern, 16);
                  HmgShareLockResult<BRUSH>::HmgShareLockResult<BRUSH>(v131, v41);
                  *(_QWORD *)(v5 + 80) = v5 + 536;
                  *(_DWORD *)(v5 + 576) = 0;
                  ...
                  *(_QWORD *)(v42 + 112) = 0LL;
                  ...
                  EBRUSHOBJ::vInitBrush(
                    ...
                    *(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1,
                    ...
                    v40,
                    v115);
                  HmgShareLockResult<BRUSH>::~HmgShareLockResult<BRUSH>(v131);
                  *((_QWORD *)a2 + 229) = v125;
                  *((_QWORD *)a2 + 228) = v123;
                  v43 = v126;
                  *((_QWORD *)a2 + 322) = v40;
...
LABEL_75:
                  ...
                  *(_DWORD *)(struct HDEV__ *)v5 = a2[886];
                  a2[886] = a1[886];
                  *(_DWORD *)(a1 + 886) = *(_DWORD *)(HDEV)v5;
                  *(_DWORD *)(struct HDEV__ *)v5 = a2[892];
                  v71 = a2 + 14;
                  a2[892] = a1[892];
                  *(_DWORD *)(a1 + 892) = *(_DWORD *)(HDEV)v5;
                  ...
                  *((_QWORD *)a1 + 336) = *(_QWORD *)v5;
                  (*((void (__fastcall **)(_QWORD, HDEV))a2 + 340))(*((_QWORD *)a2 + 228), a2);
                  (*((void (__fastcall **)(_QWORD, HDEV))a1 + 340))(*((_QWORD *)a1 + 228), a1);
                ...
                if ( v36 == a2 )
                {
                  ...
                  v38 = &v119;
LABEL_62:
                  PDEVOBJ::vUnreferencePdev((struct _LIST_ENTRY **)v38, 0);
                }
                v35 = v37;
                goto LABEL_64;
              }
