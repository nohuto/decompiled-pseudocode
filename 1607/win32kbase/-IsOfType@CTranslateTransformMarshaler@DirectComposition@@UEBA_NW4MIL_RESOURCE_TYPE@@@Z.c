/*
 * XREFs of ?IsOfType@CTranslateTransformMarshaler@DirectComposition@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1C0047D80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CTranslateTransformMarshaler::IsOfType(__int64 a1, unsigned __int64 a2)
{
  char v2; // al
  char v3; // cl
