/*
 * XREFs of ?HmgrStacksInit@@YAXXZ @ 0x1C0053914
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  if ( ZwOpenKey(&KeyHandle, 0x20019u, &ObjectAttributes) >= 0 )
  {
    ...
    if ( ZwQueryValueKey(
      ...
      && v5 == 4 )
    {
      LODWORD(WPP_MAIN_CB.Dpc.DpcData) = v6 != 0;
    }
    ...
    if ( ZwQueryValueKey(
      ...
      && v5 == 4 )
    {
      HIDWORD(WPP_MAIN_CB.Dpc.SystemArgument2) = v6 != 0;
    }
    ...
    if ( ZwQueryValueKey(
      ...
      && v5 == 4 )
    {
      LODWORD(WPP_MAIN_CB.Dpc.SystemArgument2) = v6;
    }
    ZwClose(KeyHandle);
  }
}
