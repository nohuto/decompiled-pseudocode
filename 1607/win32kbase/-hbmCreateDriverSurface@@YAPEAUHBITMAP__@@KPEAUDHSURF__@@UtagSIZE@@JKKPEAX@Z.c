/*
 * XREFs of ?hbmCreateDriverSurface@@YAPEAUHBITMAP__@@KPEAUDHSURF__@@UtagSIZE@@JKKPEAX@Z @ 0x1C007865C
 * Callers:
 *     EngCreateDeviceSurface @ 0x1C00785A0 (EngCreateDeviceSurface.c)
 *     EngCreateRedirectionDeviceBitmap @ 0x1C00785F0 (EngCreateRedirectionDeviceBitmap.c)
 *     EngCreateBitmap @ 0x1C0078630 (EngCreateBitmap.c)
 *     EngCreateDeviceBitmap @ 0x1C00CB240 (EngCreateDeviceBitmap.c)
 * Callees:
