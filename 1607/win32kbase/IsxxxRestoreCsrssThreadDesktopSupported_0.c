/*
 * XREFs of IsxxxRestoreCsrssThreadDesktopSupported_0 @ 0x1C0001DB8
 * Callers:
...
// attributes: thunk
__int64 IsxxxRestoreCsrssThreadDesktopSupported_0()
{
  return IsxxxRestoreCsrssThreadDesktopSupported();
}
