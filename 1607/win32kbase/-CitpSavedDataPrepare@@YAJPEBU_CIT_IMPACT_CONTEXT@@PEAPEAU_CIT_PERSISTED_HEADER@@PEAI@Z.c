/*
 * XREFs of ?CitpSavedDataPrepare@@YAJPEBU_CIT_IMPACT_CONTEXT@@PEAPEAU_CIT_PERSISTED_HEADER@@PEAI@Z @ 0x1C00F7360
 * Callers:
 ...
 *     ?AdvanceToNext@?$CIT_PERSISTED_SECTION@UCIT_PERSISTED_USE_DATA@@@@QEAAXXZ @ 0x1C00F5904 (-AdvanceToNext@-$CIT_PERSISTED_SECTION@UCIT_PERSISTED_USE_DATA@@@@QEAAXXZ.c)
        ...
        unsigned int *a3)
{
  ...
  union _LARGE_INTEGER *v59; // [rsp+90h] [rbp-70h]
  _QWORD v60[13]; // [rsp+A0h] [rbp-60h] BYREF
  int v61; // [rsp+10Ch] [rbp+Ch]
  union _LARGE_INTEGER *v62; // [rsp+110h] [rbp+10h]
  DWORD LowPart; // [rsp+124h] [rbp+24h]
  union _LARGE_INTEGER v64; // [rsp+128h] [rbp+28h]
  union _LARGE_INTEGER *v65; // [rsp+140h] [rbp+40h]
  union _LARGE_INTEGER SystemTime; // [rsp+1B8h] [rbp+B8h] BYREF

  v3 = a1;
  memset(v60, 0, 0x60uLL);
  v4 = 0;
  v5 = 0;
  v6 = 0;
  if ( dword_1C011E56C )
  {
    v7 = (unsigned int)dword_1C011E56C;
    v8 = *((_QWORD *)v3 + 38) + 35LL;
    do
    {
  ...
  v52 = 0LL;
  v57 = 16 * v6 + 112;
  SystemTime.QuadPart = (v57 + 3) & 0xFFFFFFFFFFFFFFFCuLL;
  ...
  HIDWORD(v60[0]) = (_DWORD)v12;
  HIDWORD(v60[9]) = dword_1C011E5C4 * (v6 + 7);
  v58 = 28 * v6 + LocalTime.LowPart;
  v49 = (v58 + 3) & 0xFFFFFFFFFFFFFFFCuLL;
  LODWORD(v60[0]) = (v58 + 3) & 0xFFFFFFFC;
  LODWORD(v60[1]) = (_DWORD)v12 + v49;
  v13 = ((_DWORD)v12 + v49 + 3) & 0xFFFFFFFC;
  HIDWORD(v60[3]) = 8 * (6 * (v6 + 1) + 11);
  LODWORD(v60[3]) = v13;
  LODWORD(v60[4]) = HIDWORD(v60[3]) + v13;
  v14 = (HIDWORD(v60[3]) + v13 + 1) & 0xFFFFFFFE;
  HIDWORD(v60[6]) = 2 * (12 * (v6 + 1) + 14);
  LODWORD(v60[6]) = v14;
  LODWORD(v60[7]) = HIDWORD(v60[6]) + v14;
  v44 = (HIDWORD(v60[6]) + v14 + 1) & 0xFFFFFFFE;
  v54 = v5 + v44;
  v48 = (_DWORD *)(v5 + v44);
  LODWORD(v60[9]) = v5 + v44;
  v15 = (_DWORD)v48 + HIDWORD(v60[9]);
  v53 = (_DWORD)v48 + HIDWORD(v60[9]);
  LODWORD(v60[10]) = (_DWORD)v48 + HIDWORD(v60[9]);
  if ( (unsigned int)((_DWORD)v48 + HIDWORD(v60[9])) >= 0x400000 )
  {
    v4 = -1073739516;
    v16 = 4933;
LABEL_14:
  ...
  v64.QuadPart = (LONGLONG)v17 + LocalTime.LowPart;
  HIDWORD(v60[1]) = v49;
  v60[2] = (char *)v17 + (unsigned int)v49;
  v55 = v44;
  v17->LowPart = 786442;
  v17->HighPart = v15;
  v61 = 112;
  ...
  v60[8] = (char *)v17 + v14;
  v56 = (char *)v17 + v44;
  HIDWORD(v60[10]) = (_DWORD)v48;
  v60[11] = (char *)v17 + (unsigned int)v48;
  HIDWORD(v60[7]) = v14;
  ...
  v18[1] = LocalTime;
  v18[10].LowPart = 88;
  v18[7].QuadPart = qword_1C011E5E8;
  v18[6] = *(union _LARGE_INTEGER *)((char *)v3 + 608);
  v20 = -1;
  if ( qword_1C011E580 / 0x989680uLL <= 0xFFFFFFFF )
    v20 = qword_1C011E580 / 0x989680uLL;
  v18[8].LowPart = v20;
  if ( qword_1C011E588 / 0x989680uLL <= 0xFFFFFFFF )
    v19 = qword_1C011E588 / 0x989680uLL;
  v21 = v65;
  v18[8].HighPart = v19;
  v18[9].LowPart = dword_1C011E5C4;
  v18[9].HighPart = dword_1C011E56C;
  v18[4].LowPart = 24;
  v18[4].HighPart = 88;
  CitpBaseDataOutput<CIT_PERSISTED_SYSTEM_DATA,_CIT_SYSTEM_DATA>((__int64)v60, v21, (unsigned int *)v3);
  v18[5].HighPart = v50[0];
  v18[5].LowPart = 24;
  CIT_PERSISTED_SECTION<CIT_PERSISTED_USE_DATA>::AdvanceToNext((__int64)v50);
  CitpBaseDataOutput<CIT_PERSISTED_USE_DATA,_CIT_USE_DATA>((__int64)v60, v22, (__int64)v3 + 216, (__int64)v22);
  v18[2].HighPart = 16;
  v18[3].LowPart = v6;
  v18[3].HighPart = 112;
  v23 = dword_1C011E56C;
  if ( dword_1C011E56C )
  {
    v24 = v62;
    v25 = 0;
    QuadPart = (unsigned int *)v64.QuadPart;
    v27 = v56;
    v28 = v61;
    v29 = LowPart;
    v30 = v55;
    v49 = (unsigned __int64)v62;
    LocalTime = v64;
    v45 = (char *)v56;
    v47 = v61;
    ...
    do
    {
      ...
      {
        v48 = v24;
        if ( (unsigned __int64)v28 + 16 <= v57 )
        {
        ...
        *v24 = v29;
        v24[2] = 28;
        if ( (unsigned __int64)v29 + 28 <= v58 )
        {
        ...
        *QuadPart = v30;
        ...
        v41[3] = 24;
        CIT_PERSISTED_SECTION<CIT_PERSISTED_USE_DATA>::AdvanceToNext((__int64)v50);
        CitpBaseDataOutput<CIT_PERSISTED_USE_DATA,_CIT_USE_DATA>((__int64)v60, v42, v31 + 88, (__int64)v42);
        v23 = dword_1C011E56C;
        v27 = v45;
