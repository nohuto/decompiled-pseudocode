/*
 * XREFs of ?PruneMode@@YAHPEAU_devicemodeW@@PEAUtagModeCap@@HPEAU_FREQUENCY_RAGE@@K@Z @ 0x1C005ECB4
 * Callers:
 ...
 * Callees:
 *     ?compModeCap@@YAHPEAUtagModeCap@@0@Z @ 0x1C005EEBC (-compModeCap@@YAHPEAUtagModeCap@@0@Z.c)
 */
