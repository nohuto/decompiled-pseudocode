/*
 * XREFs of NtBindCompositionSurface @ 0x1C004AAD0
 * Callers:
 *     <none>
 * Callees:
 *     UserSetWindowedSwapChainApiExt_0 @ 0x1C0002F60 (UserSetWindowedSwapChainApiExt_0.c)
...
LABEL_52:
        ...
        {
          v24 = 0LL;
          if ( (int)CompositionSurfaceObject::LockForWrite((char *)Object, &v24) >= 0 )
          {
