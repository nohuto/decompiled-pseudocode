/*
 * XREFs of Template_pppqqqqpppqqqq @ 0x1C00B73C0
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C0081620 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C00CC200 (EtwWindowRendering.c)
 * Callees:
