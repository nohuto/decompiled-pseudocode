...
__int64 bInitICM()
{
  ...
  *((_DWORD *)v4 + 18) = *(_DWORD *)&v6->lcsFilename[2];
  ...
  if ( !ColorSpace )
    return 0;
  HmgSetOwner((__int64)ColorSpace, 0, 9u);
  HmgMarkUndeletable(v19, 9);
  bSetStockObject(v19, 20, 0);
  ghStockColorSpace = (HCOLORSPACE)GreGetStockObject(20);
  gpStockColorSpace = (struct COLORSPACE *)HmgShareLock((unsigned int)ghStockColorSpace, 9);
  qword_1C0119208 = (__int64)ghStockColorSpace;
  qword_1C0118FE0 = (__int64)gpStockColorSpace;
