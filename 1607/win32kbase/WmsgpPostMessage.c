/*
 * XREFs of WmsgpPostMessage @ 0x1C0142404
 * Callers:
 *     PostWinlogonMessage @ 0x1C0071B40 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C0071BA4 (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C0071BE0 (WMsg_midl_user_allocate.c)
 *     WMsg_midl_user_free @ 0x1C00E2780 (WMsg_midl_user_free.c)
 */
