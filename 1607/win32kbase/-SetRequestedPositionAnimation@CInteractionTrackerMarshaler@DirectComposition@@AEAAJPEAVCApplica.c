/*
 * XREFs of ?SetRequestedPositionAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAAJPEAVCApplicationChannel@2@PEAVCBaseExpressionMarshaler@2@PEA_N@Z @ 0x1C00E977C
 * Callers:
        ...
        bool *a4)
{
  ...
  WeakReferenceBase = 0;
  v6 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 23);
  if ( v6 )
    v9 = (struct DirectComposition::CBaseExpressionMarshaler *)*((_QWORD *)v6 + 2);
  else
    v9 = 0LL;
  if ( a3 == v9 )
  {
