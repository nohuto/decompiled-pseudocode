/*
 * XREFs of LogicalToPhysicalDPIMonitorPoint @ 0x1C00B9420
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?LogicalDpiFromMonFlags@@YAGK@Z @ 0x1C00B92AC (-LogicalDpiFromMonFlags@@YAGK@Z.c)
...
__int64 __fastcall LogicalToPhysicalDPIMonitorPoint(_QWORD *a1, _QWORD *a2, unsigned int a3, __int64 *a4)
{
  ...
  if ( (unsigned int)ValidateMonFlags(&v11) && (int)Is_MonitorFromPointSupported_0() >= 0 )
  {
    ...
    ScaleDPIPt((_DWORD)a1, (_DWORD)a2, *(unsigned __int16 *)(v7 + 154), v8, v9);
    return 1LL;
  }
  else
  {
