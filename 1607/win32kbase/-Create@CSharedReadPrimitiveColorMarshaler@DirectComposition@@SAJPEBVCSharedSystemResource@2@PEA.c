/*
 * XREFs of ?Create@CSharedReadPrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00F1CF8
 * Callers:
 *     CreateSharedReadPrimitiveColorMarshaler @ 0x1C00F1EB0 (CreateSharedReadPrimitiveColorMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadPrimitiveColorMarshaler **a2)
{
  ...
  if ( v4 )
  {
    memset(v4, 0, 0x38uLL);
    *((_DWORD *)v5 + 6) = 0;
    *(_QWORD *)v5 = &DirectComposition::CSharedReadPrimitiveColorMarshaler::`vftable';
    *((_DWORD *)v5 + 5) = 1;
  }
  else
  {
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadPrimitiveColorMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 232LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
