/*
 * XREFs of ?vGetDeviceCaps@@YAXAEAVPDEVOBJ@@PEAU_DEVCAPS@@@Z @ 0x1C007C8FC
 * Callers:
...
void __fastcall vGetDeviceCaps(struct PDEVOBJ *this, struct _DEVCAPS *a2)
{
  ...
  int v6; // ecx
  int v7; // eax
  int ColorManagementCapsWrap_0; // esi
  int v9; // eax

  v3 = (_DWORD *)(*(_QWORD *)this + 2160LL);
  *(_DWORD *)a2 = *v3;
  *((_DWORD *)a2 + 1) = v3[1];
  ...
  *((_DWORD *)a2 + 29) = v3[63];
  if ( (int)IsGetColorManagementCapsSupported_0() >= 0 )
    ColorManagementCapsWrap_0 = GetColorManagementCapsWrap_0();
  *((_DWORD *)a2 + 35) = ColorManagementCapsWrap_0;
}
