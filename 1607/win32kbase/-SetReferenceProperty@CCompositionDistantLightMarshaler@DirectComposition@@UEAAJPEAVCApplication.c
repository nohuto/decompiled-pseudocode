/*
 * XREFs of ?SetReferenceProperty@CCompositionDistantLightMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00ECD50
 * Callers:
 *     <none>
 * Callees:
