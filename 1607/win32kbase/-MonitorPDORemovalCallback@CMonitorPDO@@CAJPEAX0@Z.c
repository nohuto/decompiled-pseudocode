/*
 * XREFs of ?MonitorPDORemovalCallback@CMonitorPDO@@CAJPEAX0@Z @ 0x1C00BD6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitorPDO::MonitorPDORemovalCallback(_QWORD *NotificationStructure, PVOID Context)
{
  __int64 v3; // rax
  __int64 v4; // r8
  __int64 v5; // rcx
