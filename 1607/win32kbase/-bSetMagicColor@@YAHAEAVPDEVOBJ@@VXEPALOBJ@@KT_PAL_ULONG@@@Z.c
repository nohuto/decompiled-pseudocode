/*
 * XREFs of ?bSetMagicColor@@YAHAEAVPDEVOBJ@@VXEPALOBJ@@KT_PAL_ULONG@@@Z @ 0x1C00CA398
 * Callers:
 *     GreSetMagicColors @ 0x1C00CA4B8 (GreSetMagicColors.c)
 * Callees:
 *     ?vUpdateTime@XEPALOBJ@@QEAAXXZ @ 0x1C00BF788 (-vUpdateTime@XEPALOBJ@@QEAAXXZ.c)
 */
...
__int64 __fastcall bSetMagicColor(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  {
    HIBYTE(v12) = 48;
    *(_DWORD *)(*(_QWORD *)(a2 + 120) + 4LL * a3) = v12;
    XEPALOBJ::vUpdateTime((XEPALOBJ *)&v11);
    v8 = *(_QWORD *)(*(_QWORD *)a1 + 1840LL);
    if ( v8 )
      *(_DWORD *)(*(_QWORD *)(v8 + 120) + 4 * v6) = v12;
    if ( (unsigned int)v6 > 0xA )
      v6 = (unsigned int)(v6 - 236);
    HIBYTE(v12) = v7;
    v9 = v12;
    v4 = 1;
    dword_1C0119764[v6] = v12;
    *(_DWORD *)(*(_QWORD *)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 120LL) + 4 * v6) = v9;
  }
  return v4;
}
