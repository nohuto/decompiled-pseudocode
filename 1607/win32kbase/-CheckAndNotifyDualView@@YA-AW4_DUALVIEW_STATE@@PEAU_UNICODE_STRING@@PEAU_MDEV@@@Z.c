/*
 * XREFs of ?CheckAndNotifyDualView@@YA?AW4_DUALVIEW_STATE@@PEAU_UNICODE_STRING@@PEAU_MDEV@@@Z @ 0x1C0066F10
 * Callers:
...
LABEL_36:
  ...
  else if ( !a1 )
  {
    ...
    do
    {
      GreDeviceIoControlEx(*(PDEVICE_OBJECT *)(*(_QWORD *)v26 + 136LL), 0x23048Cu, v28, 4u, 0LL, 0, v37, 0);
      v28 += 16;
      v26 += 16;
      --v27;
    }
