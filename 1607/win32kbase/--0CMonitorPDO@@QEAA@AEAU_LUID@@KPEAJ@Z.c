/*
 * XREFs of ??0CMonitorPDO@@QEAA@AEAU_LUID@@KPEAJ@Z @ 0x1C0084CE0
 * Callers:
...
CMonitorPDO *__fastcall CMonitorPDO::CMonitorPDO(CMonitorPDO *this, struct _LUID *a2, unsigned int a3, int *a4)
{
  ...
  *((struct _LUID *)this + 8) = *a2;
  ...
  LODWORD(v16) = 0;
  v10 = (CMutex *)OPMAllocateMemory(8uLL, PagedPool);
  if ( v10 )
  {
    v12 = CMutex::CMutex(v10, (int *)&v16);
  ...
  *((_QWORD *)this + 1) = v4;
  ...
  DeviceInterfaces = ((__int64 (__fastcall *)(struct _LUID *, _QWORD, PVOID *, PVOID *))qword_1C011B610)(
                       a2,
                       v17,
                       &EventCategoryData,
                       v5);
