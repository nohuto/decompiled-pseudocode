/*
 * XREFs of Template_hh @ 0x1C00B726C
 * Callers:
 *     EtwTraceBeginPointerMessageGeneration @ 0x1C00B4E90 (EtwTraceBeginPointerMessageGeneration.c)
 *     EtwTraceEndPointerMessageGeneration @ 0x1C00B5380 (EtwTraceEndPointerMessageGeneration.c)
 * Callees:
