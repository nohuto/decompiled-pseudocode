/*
 * XREFs of ?DesktopCaptureBits@CSystemChannel@DirectComposition@@QEAAJPEAUHMONITOR__@@HHIIW4DXGI_FORMAT@@PEAX2@Z @ 0x1C00E4DB8
 * Callers:
        ...
        __int64 a9)
{
  ...
  if ( !DirectComposition::CBatch::GetPayloadWritePointer(a1[23], 0x34uLL, &v16) )
    return 3221225473LL;
  v13 = (char *)v16;
  v14 = a5;
  *(_DWORD *)v16 = 52;
