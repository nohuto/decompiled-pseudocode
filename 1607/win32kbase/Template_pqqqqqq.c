/*
 * XREFs of Template_pqqqqqq @ 0x1C00CC2B0
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C0078BF0 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C007C5F0 (EtwDevLockEndTightUpdate.c)
 * Callees:
