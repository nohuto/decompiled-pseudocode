/*
 * XREFs of ?Grow@?$CDynamicArray@PEAUManipulationCaptureInfo@CInteractionMarshaler@DirectComposition@@$0HHHAHDFF@@@IEAAJI@Z @ 0x1C00F2420
 * Callers:
...
__int64 __fastcall CDynamicArray<DirectComposition::CInteractionMarshaler::ManipulationCaptureInfo *,2003858261>::Grow(
        __int64 a1)
{
  unsigned int v2; // esi
  unsigned int v3; // ebx
