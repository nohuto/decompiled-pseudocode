/*
 * XREFs of ?BuildReportDescriptor@@YAHGGPEAUtagUSAGE_PROPERTIES@@KKPEAU_HIDP_DEVICE_DESC@@@Z @ 0x1C00D78D0
 * Callers:
 ...
 *     ?BuildDeviceHeader@@YAHPEAEKPEAKGG@Z @ 0x1C00D7520 (-BuildDeviceHeader@@YAHPEAEKPEAKGG@Z.c)
