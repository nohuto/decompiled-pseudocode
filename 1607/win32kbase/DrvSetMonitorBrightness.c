/*
 * XREFs of DrvSetMonitorBrightness @ 0x1C005DCC0
 * Callers:
        ...
        char a6)
{
  ...
  if ( !gProtocolType )
  {
    ...
    *a5 = 0;
    ...
    {
      v13 = 0;
      v14 = *(_QWORD *)(*(_QWORD *)(32 * (v12 + 1LL) + v9) + 2600LL);
      if ( *(_DWORD *)(v14 + 224) )
      {
        do
        {
          ...
          if ( (*(_DWORD *)(v15 + 20LL * v13) & 1) != 0
            ...
            && (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, _DWORD *))qword_1C011B610)(
                      v15 + 4 * (5LL * v13 + 2),
              ...
              if ( *(_QWORD *)(v14 + 144) )
              {
                if ( (*(_DWORD *)(v14 + 160) & 0x800000) != 0 )
                {
                  ...
                  if ( a1 )
                  {
                    ...
                    {
                      LOBYTE(v19) = a4;
                      ((void (__fastcall *)(__int64, __int64))qword_1C011B680)(a1, v19);
                    }
                  }
                }
              }
