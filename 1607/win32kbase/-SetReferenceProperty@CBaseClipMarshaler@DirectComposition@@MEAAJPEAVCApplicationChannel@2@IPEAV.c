/*
 * XREFs of ?SetReferenceProperty@CBaseClipMarshaler@DirectComposition@@MEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00EA370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CBaseClipMarshaler::SetReferenceProperty(
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  if ( this == (DirectComposition::CBaseClipMarshaler *)-56LL
    || a4
