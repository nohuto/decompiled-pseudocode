/*
 * XREFs of rimObsObserveNextInput @ 0x1C00E0368
 * Callers:
 *     NtRIMObserveNextInput @ 0x1C00CE1A0 (NtRIMObserveNextInput.c)
 *     RIMObserveNextInput @ 0x1C00CF9A0 (RIMObserveNextInput.c)
 * Callees:
