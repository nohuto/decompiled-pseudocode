/*
 * XREFs of RIMIDE_InitializeDeviceInjection @ 0x1C00D7EB0
 * Callers:
        ...
        __int64 *a7)
{
  ...
  int v11; // edi
  __int64 v12; // rax
  _HIDP_DEVICE_DESC v14; // [rsp+40h] [rbp-91h] BYREF
  _HIDP_DEVICE_DESC Object; // [rsp+80h] [rbp-51h] BYREF
  ...
  *a7 = 0LL;
  ...
  {
    v14 = Object;
    v12 = RIMIDECreatePseudoHIDDevice(a1, a2, v11, a6, a5, &Object, &v14, 1);
    if ( v12 )
    {
      *a7 = v12;
      return 1;
