/*
 * XREFs of IsSetTimerCoalescingToleranceSupported_0 @ 0x1C0001C20
 * Callers:
...
// attributes: thunk
__int64 IsSetTimerCoalescingToleranceSupported_0()
{
  return IsSetTimerCoalescingToleranceSupported();
}
