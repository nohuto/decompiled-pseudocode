/*
 * XREFs of ?EmitSharedSectionUpdateCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0041388
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( *((_QWORD *)this + 53) )
  {
    do
    {
      if ( !(*(unsigned __int8 (__fastcall **)(_QWORD, struct DirectComposition::CBatch **))(**((_QWORD **)this + 53)
                                                                                           + 72LL))(
              *((_QWORD *)this + 53),
              a2) )
        break;
