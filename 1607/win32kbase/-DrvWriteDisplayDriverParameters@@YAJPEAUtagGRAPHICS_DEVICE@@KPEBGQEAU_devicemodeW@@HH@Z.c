/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x1C0064D94
 * Callers:
 *     DrvUpdateDisplayDriverParameters @ 0x1C0064CA0 (DrvUpdateDisplayDriverParameters.c)
 * Callees:
 *     ?DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z @ 0x1C0065218 (-DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z.c)
        ...
        int a6)
{
  ...
  _BYTE v90[40]; // [rsp+390h] [rbp+290h] BYREF
    ...
    if ( a4 )
    {
      ...
      if ( v10 >= 0 )
      {
        do
        {
          if ( v16 >= v19 )
            break;
          v17 = RtlWriteRegistryValue(0x40000000u, a3, off_1C00FF7B0[v16], 4u, &v23[v16], 4u);
          ++v16;
          v10 = v17;
        }
        while ( v17 >= 0 );
