/*
 * XREFs of ?SetReferenceArrayProperty@CTransform3DGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C00EA280
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      if ( *((_QWORD *)this + 7) )
        (*(void (__fastcall **)(DirectComposition::CTransform3DGroupMarshaler *, struct DirectComposition::CApplicationChannel *))(*(_QWORD *)this + 104LL))(
          this,
          a2);
      *((_QWORD *)this + 7) = a4;
      v11 = 0LL;
