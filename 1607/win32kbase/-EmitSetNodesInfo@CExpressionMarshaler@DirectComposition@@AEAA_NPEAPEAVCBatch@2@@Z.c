/*
 * XREFs of ?EmitSetNodesInfo@CExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C003CF98
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x400) == 0 && *((_QWORD *)this + 13) && *((_QWORD *)this + 15) )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x34uLL, &v8) )
    {
      ...
      *v5 = 208;
      v5[1] = *((_DWORD *)this + 6);
      v5[2] = *(_DWORD *)(*((_QWORD *)this + 13) + 24LL);
      v5[3] = *((_DWORD *)this + 30);
      v5[4] = *((_DWORD *)this + 28);
      v5[5] = *((_DWORD *)this + 32);
      v6 = *((_QWORD *)this + 17);
      ...
      v5[7] = *((_DWORD *)this + 38);
      v5[8] = *((_DWORD *)this + 36);
      v5[10] = *((_DWORD *)this + 40);
      v5[11] = *((_DWORD *)this + 41);
      v5[9] = *((_DWORD *)this + 42);
      *((_DWORD *)this + 42) = 0;
