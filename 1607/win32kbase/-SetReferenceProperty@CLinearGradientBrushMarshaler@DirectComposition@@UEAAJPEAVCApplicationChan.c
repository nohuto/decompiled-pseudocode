/*
 * XREFs of ?SetReferenceProperty@CLinearGradientBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00EBCF0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  if ( this == (DirectComposition::CLinearGradientBrushMarshaler *)-64LL
    || a4
