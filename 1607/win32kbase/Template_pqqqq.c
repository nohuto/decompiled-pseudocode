/*
 * XREFs of Template_pqqqq @ 0x1C00B76F4
 * Callers:
 *     EtwTraceTimerProc @ 0x1C0076CA0 (EtwTraceTimerProc.c)
 *     EtwTraceInternalSetTimer @ 0x1C0077220 (EtwTraceInternalSetTimer.c)
 *     EtwDirtyRectUpdate @ 0x1C0078370 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C00CBF60 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C00CBFA0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C00CC160 (EtwTranslationUpdate.c)
 * Callees:
