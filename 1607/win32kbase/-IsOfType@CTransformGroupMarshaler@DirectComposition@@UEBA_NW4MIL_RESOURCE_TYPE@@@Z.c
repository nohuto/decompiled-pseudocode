/*
 * XREFs of ?IsOfType@CTransformGroupMarshaler@DirectComposition@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1C0047EF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CTransformGroupMarshaler::IsOfType(__int64 a1, unsigned __int64 a2)
{
  char v2; // al
  char v3; // cl
