/*
 * XREFs of ??0CConnection@DirectComposition@@AEAA@XZ @ 0x1C001889C
 * Callers:
...
union _SLIST_HEADER *__fastcall DirectComposition::CConnection::CConnection(union _SLIST_HEADER *this)
{
  ...
  this[1].Region = (ULONGLONG)&DirectComposition::CLinearObjectTable<unsigned int,DirectComposition::CChannel,1751335748>::`vftable';
