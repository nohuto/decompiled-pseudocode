/*
 * XREFs of rimUpdatePointerDeviceFrameScanTime @ 0x1C00DE658
 * Callers:
 ...
 *     rimSimulatedPointerDeviceScanTime @ 0x1C00DE578 (rimSimulatedPointerDeviceScanTime.c)
 */
