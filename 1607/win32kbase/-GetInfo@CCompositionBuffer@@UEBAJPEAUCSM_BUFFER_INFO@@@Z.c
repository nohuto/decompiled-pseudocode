/*
 * XREFs of ?GetInfo@CCompositionBuffer@@UEBAJPEAUCSM_BUFFER_INFO@@@Z @ 0x1C00F3AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionBuffer::GetInfo(CCompositionBuffer *this, struct CSM_BUFFER_INFO *a2)
{
  ...
  *((_QWORD *)a2 + 16) = *((_QWORD *)this + 20);
  result = (*(__int64 (__fastcall **)(CCompositionBuffer *, __int64 *))(*(_QWORD *)this + 200LL))(this, &v5);
  if ( (int)result >= 0 )
  {
    v4 = v5;
