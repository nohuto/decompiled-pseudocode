/*
 * XREFs of NtDCompositionConfirmFrame @ 0x1C0017740
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v20 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *((_BYTE *)v3 + 208) = 0;
      ...
      {
        *((_DWORD *)v9 + 18) = 1;
        for ( j = (volatile signed __int32 *)*((_QWORD *)v9 + 17); j != v9 + 34; j = *(volatile signed __int32 **)j )
          _guard_dispatch_icall_fptr();
        v15 = (__int64 **)(v9 + 38);
        v16 = (__int64 *)*((_QWORD *)v9 + 19);
        v17 = *v16;
        if ( (volatile signed __int32 *)v16[1] != v9 + 38 || *(__int64 **)(v17 + 8) != v16 )
          __fastfail(3u);
        while ( 1 )
        {
          *v15 = (__int64 *)v17;
