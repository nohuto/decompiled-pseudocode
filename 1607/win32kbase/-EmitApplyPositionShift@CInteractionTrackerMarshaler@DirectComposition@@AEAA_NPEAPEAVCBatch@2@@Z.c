/*
 * XREFs of ?EmitApplyPositionShift@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00E7FA0
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 75) < *((_DWORD *)this + 74); *((_DWORD *)this + 75) += v5 )
  {
    ...
    v5 = (v4 - 16) / 0xC;
    if ( (unsigned int)(*((_DWORD *)this + 74) - *((_DWORD *)this + 75)) < v5 )
      LODWORD(v5) = *((_DWORD *)this + 74) - *((_DWORD *)this + 75);
  ...
  if ( *((_DWORD *)this + 75) == *((_DWORD *)this + 74) )
  {
    v14 = (void (__fastcall ***)(_QWORD, __int64))*((_QWORD *)this + 36);
    *((_QWORD *)this + 37) = 0LL;
    if ( v14 )
      (**v14)(v14, 1LL);
    *((_QWORD *)this + 36) = 0LL;
  }
  return *((_DWORD *)this + 75) == *((_DWORD *)this + 74);
}
