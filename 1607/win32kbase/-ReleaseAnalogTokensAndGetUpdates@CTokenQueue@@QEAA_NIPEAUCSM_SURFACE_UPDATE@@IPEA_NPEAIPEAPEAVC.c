/*
 * XREFs of ?ReleaseAnalogTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEA_NPEAIPEAPEAVCToken@@@Z @ 0x1C00F4C00
 * Callers:
        ...
        struct CToken **a7)
{
  ...
  *v13 = (CTokenQueue **)this;
  ...
  {
    v14 = v12 - 1;
    if ( (*((int (__fastcall **)(CTokenQueue **, __int64, unsigned int **))*(v12 - 1) + 19))(v12 - 1, a2, &a6) < 0 )
    {
LABEL_10:
