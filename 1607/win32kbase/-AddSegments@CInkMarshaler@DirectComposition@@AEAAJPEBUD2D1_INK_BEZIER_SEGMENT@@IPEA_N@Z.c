/*
 * XREFs of ?AddSegments@CInkMarshaler@DirectComposition@@AEAAJPEBUD2D1_INK_BEZIER_SEGMENT@@IPEA_N@Z @ 0x1C00E5168
 * Callers:
        ...
        bool *a4)
{
  ...
  v6 = a3;
  v9 = 0LL;
  v10 = DirectComposition::CDCompDynamicArrayBase::Grow((DirectComposition::CInkMarshaler *)((char *)this + 96), a3);
  if ( v10 >= 0 )
  {
    if ( v6 )
    {
