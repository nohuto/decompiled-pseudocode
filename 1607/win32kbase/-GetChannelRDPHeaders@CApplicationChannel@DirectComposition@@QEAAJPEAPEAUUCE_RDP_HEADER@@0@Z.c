/*
 * XREFs of ?GetChannelRDPHeaders@CApplicationChannel@DirectComposition@@QEAAJPEAPEAUUCE_RDP_HEADER@@0@Z @ 0x1C0042484
 * Callers:
        ...
        struct UCE_RDP_HEADER **a3)
{
  ...
  v5 = *((_QWORD *)this + *((unsigned int *)this + 168) + 82);
  result = DirectComposition::CBatchSharedMemoryPool::GetUserModeViewAtOffset(
             *((DirectComposition::CBatchSharedMemoryPool **)this + 81),
             v5,
             (void **)a3);
  if ( (int)result >= 0 )
  {
    v7 = *(_QWORD *)(*((_QWORD *)this + 81) + 56LL);
    ++*((_DWORD *)this + 168);
