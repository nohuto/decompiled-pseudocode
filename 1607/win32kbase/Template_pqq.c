/*
 * XREFs of Template_pqq @ 0x1C00B7674
 * Callers:
 *     EtwTraceBeginPointerMessageRetrieve @ 0x1C00B4EC0 (EtwTraceBeginPointerMessageRetrieve.c)
 *     EtwTraceEndPointerMessageRetrieve @ 0x1C00B53B0 (EtwTraceEndPointerMessageRetrieve.c)
 *     EtwTranslationUpdateOffset @ 0x1C00CC1A0 (EtwTranslationUpdateOffset.c)
 *     EtwTranslationUpdateOffsetDWM @ 0x1C00CC1D0 (EtwTranslationUpdateOffsetDWM.c)
 * Callees:
