/*
 * XREFs of ?AddSegments@CPencilMarshaler@DirectComposition@@AEAAJPEBUD2D1_PENCIL_SEGMENT@@IPEA_N@Z @ 0x1C00E598C
 * Callers:
        ...
        bool *a4)
{
  ...
  v6 = a3;
  v10 = 0LL;
  v11 = DirectComposition::CDCompDynamicArrayBase::Grow((DirectComposition::CPencilMarshaler *)((char *)this + 144), a3);
  if ( v11 >= 0 )
  {
    if ( v6 )
    {
