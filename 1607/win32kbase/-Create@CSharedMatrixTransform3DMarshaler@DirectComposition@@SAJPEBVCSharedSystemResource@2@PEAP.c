/*
 * XREFs of ?Create@CSharedMatrixTransform3DMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00F1A18
 * Callers:
 *     CreateSharedMatrixTransform3DMarshaler @ 0x1C00F1C50 (CreateSharedMatrixTransform3DMarshaler.c)
 * Callees:
