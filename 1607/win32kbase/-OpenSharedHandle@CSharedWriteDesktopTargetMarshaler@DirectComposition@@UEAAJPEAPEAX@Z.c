/*
 * XREFs of ?OpenSharedHandle@CSharedWriteDesktopTargetMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C007BC70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
NTSTATUS __fastcall DirectComposition::CSharedWriteDesktopTargetMarshaler::OpenSharedHandle(
