/*
 * XREFs of ?CitpProcessGetProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z @ 0x1C00F636C
 * Callers:
...
struct _CIT_PROG_DATA *__fastcall CitpProcessGetProgData(struct tagPROCESSINFO *a1)
{
  ...
  if ( v4 )
  {
    ...
    if ( (unsigned int)v5 < *((_DWORD *)qword_1C011E5D0 + 90) )
    {
      v6 = *((_QWORD *)qword_1C011E5D0 + 38) + 176 * v5;
      if ( *(_WORD *)(v6 + 32) == v4 )
      {
