/*
 * XREFs of ?MulEnableDriver@@YAHKKPEAUtagDRVENABLEDATA@@@Z @ 0x1C00C2690
 * Callers:
 *     <none>
 * Callees:
 *     IsMulGetAdditionalFunctionTableSupported_0 @ 0x1C0001408 (IsMulGetAdditionalFunctionTableSupported_0.c)
 *     MulGetAdditionalFunctionTable_0 @ 0x1C0001410 (MulGetAdditionalFunctionTable_0.c)
 */
  ...
  if ( RtlRunOnceBeginInitialize(&gMulEnableDriverInit, 0, 0LL) == 259 )
  {
    if ( (int)IsMulGetAdditionalFunctionTableSupported_0() >= 0 )
    {
      ...
      if ( v7 )
      {
        ...
        do
        {
          *(_OWORD *)((char *)v4 + &unk_1C0118E00 - (_UNKNOWN *)v8) = *v4;
          ++v4;
          --v5;
        }
        while ( v5 );
