/*
 * XREFs of NtDCompositionCreateAndBindSharedSection @ 0x1C007AAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionCreateAndBindSharedSection(__int64 a1, int a2, union _LARGE_INTEGER a3, _QWORD *a4)
{
  HANDLE v7; // rbx
  int v8; // edi
