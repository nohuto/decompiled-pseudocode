/*
 * XREFs of ?ConvertDisplayConfigToPathModality@@YAJIPEAUDISPLAYCONFIG_PATH_INFO@@IPEAUDISPLAYCONFIG_MODE_INFO@@IPEAU_D3DKMT_GETPATHSMODALITY@@PEAH@Z @ 0x1C00C60C8
 * Callers:
...
LABEL_20:
    ...
    while ( 1 )
    {
      ...
      if ( (v19 & 0x40000) == 0 )
      {
        if ( a5 < 0 )
        {
          if ( *(_DWORD *)((char *)a6 + v16 + 184) != *(_DWORD *)((char *)a6 + v18 + 184)
            || *(_DWORD *)((char *)a6 + v16 + 188) != *(_DWORD *)((char *)a6 + v18 + 188) )
          {
            goto LABEL_19;
          }
        }
