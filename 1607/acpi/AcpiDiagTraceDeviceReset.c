/*
 * XREFs of AcpiDiagTraceDeviceReset @ 0x1C0042918
 * Callers:
...
void __fastcall AcpiDiagTraceDeviceReset(__int64 a1, int a2, int a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( (int)AMLIGetNameSpaceObjectPath(v3, psz, &pcchLength) >= 0 )
    {
      ...
      DestinationString.Buffer = (wchar_t *)ExAllocatePoolWithTag(NonPagedPoolNx, 2LL * (v4 + 1), 0x53706341u);
      ...
      if ( DestinationString.Buffer )
      {
        ...
        *(_QWORD *)&UserData.Size = 2LL;
        ...
        v15 = 0;
        v19 = 4LL;
        EtwWrite(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_DEVICE_RESET, 0LL, 4u, &UserData);
        if ( DestinationString.Buffer )
