/*
 * XREFs of AcpiDiagTraceThermalNotification @ 0x1C0009E70
 * Callers:
...
void __fastcall AcpiDiagTraceThermalNotification(_DWORD *a1, __int64 a2, __int16 a3)
{
  ...
  v6 = *((_QWORD *)&WPP_MAIN_CB.Reserved + 1);
  if ( !*((_QWORD *)&WPP_MAIN_CB.Reserved + 1) )
    goto LABEL_4;
  if ( a3 == 128 )
  {
    if ( !EtwEventEnabled(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_TEMPERATURE_NOTIFICATION) )
      goto LABEL_4;
    v6 = *((_QWORD *)&WPP_MAIN_CB.Reserved + 1);
  }
    ...
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a2 + 712), (__int64)&DestinationString) >= 0 )
  {
    ...
    EtwWrite(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), v15, 0LL, 0x10u, &UserData);
  }
LABEL_4:
