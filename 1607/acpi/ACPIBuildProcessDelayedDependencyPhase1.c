/*
 * XREFs of ACPIBuildProcessDelayedDependencyPhase1 @ 0x1C0026230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessDelayedDependencyPhase1(__int64 a1)
{
  ...
  *(_DWORD *)(v3 + 20) &= ~0x20u;
  ...
  _InterlockedAnd64((volatile signed __int64 *)(v1 + 912), 0xFFFFFFFFFFDFFFFFuLL);
  ...
  *(_DWORD *)(a1 + 32) = 0;
  ...
  WPP_RECORDER_SF_Lqss(
    ...
    v6,
    v8);
  ACPIBuildCompleteGeneric(*(_QWORD *)(a1 + 56), 0LL, 0LL, a1);
  return 0LL;
}
