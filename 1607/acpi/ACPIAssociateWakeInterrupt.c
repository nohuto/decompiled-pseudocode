/*
 * XREFs of ACPIAssociateWakeInterrupt @ 0x1C0057EE0
 * Callers:
...
__int64 __fastcall ACPIAssociateWakeInterrupt(__int64 a1)
{
  ...
  if ( (int)ACPIFindWakeInterruptForVector(v8, v7, &v19) < 0 )
  {
    ...
    *v15 = a1;
    *(_QWORD *)(v9 + 24) = a1;
    v16 = (__int64 *)qword_1C0073848;
    if ( *(__int64 **)qword_1C0073848 != &AcpiPowerWaitWakeInterruptList )
      __fastfail(3u);
    *(_QWORD *)(v9 + 8) = qword_1C0073848;
