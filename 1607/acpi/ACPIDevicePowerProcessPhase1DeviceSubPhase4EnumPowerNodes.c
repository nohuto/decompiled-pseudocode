/*
 * XREFs of ACPIDevicePowerProcessPhase1DeviceSubPhase4EnumPowerNodes @ 0x1C0049D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase1DeviceSubPhase4EnumPowerNodes(__int64 a1, int a2, __int64 a3, int a4)
{
  ...
  if ( a2
    || *(_DWORD *)(a1 + 64)
    || (a4 = (*(_DWORD *)(a1 + 24) != 0) ^ (*(_DWORD *)(*(_QWORD *)(a3 + 40) + 504LL) != 0)) != 0 )
  {
