/*
 * XREFs of AcpiDiagTraceUnexpectedGpe @ 0x1C0003C80
 * Callers:
...
void __fastcall AcpiDiagTraceUnexpectedGpe(int a1, char a2)
{
  ...
  {
    if ( EtwEventEnabled(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_UNEXPECTED_GPE) )
    {
      UserData.Reserved = 0;
      v5 = 0;
      ...
      v3 = &v7;
      v4 = 1;
      EtwWrite(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_UNEXPECTED_GPE, 0LL, 2u, &UserData);
    }
  }
}
