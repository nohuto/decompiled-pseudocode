/*
 * XREFs of PnpDeviceBiosResourcesToNtResources @ 0x1C000BC48
 * Callers:
...
__int64 __fastcall PnpDeviceBiosResourcesToNtResources(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  __int64 result; // rax
  unsigned int v7; // edi
  ...
  v4 = a1;
  result = PnpBiosResourcesToNtResources(*(_QWORD *)(a1 + 720));
  v7 = result;
  if ( (int)result >= 0 && *(_QWORD *)a4 )
  {
    v8 = 0;
    v9 = KeAcquireSpinLockRaiseToDpc(&AcpiDeviceTreeLock);
    while ( (*(_QWORD *)(v4 + 8) & 0x2000000000LL) == 0 )
    {
      v4 = *(_QWORD *)(v4 + 744);
      if ( !v4 )
        goto LABEL_6;
