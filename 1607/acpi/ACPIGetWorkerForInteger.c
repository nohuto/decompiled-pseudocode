/*
 * XREFs of ACPIGetWorkerForInteger @ 0x1C001C030
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ACPIGetWorkerForInteger(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( (*(_DWORD *)a4 & 0x400) != 0 )
  {
    v23 = (_DWORD *)a4[8];
    v24 = a4[3];
    if ( (v10 & 0x4000000) != 0 || (*(_QWORD *)(v24 + 8) & 0x2000000000000000LL) == 0 )
    {
      if ( v8 < 0 )
        goto LABEL_28;
      if ( *(_WORD *)(a3 + 2) != 1 )
...
LABEL_7:
      ...
      if ( v8 != -1073741772 )
      {
        ...
        else
        {
          if ( *(_WORD *)(a3 + 2) != 1 )
          {
            v27 = AMLIGetNamedChild(*(__int64 **)(v12 + 712), 1096045407);
            KeBugCheckEx(0xA5u, 8uLL, v12, (ULONG_PTR)v27, *(unsigned __int16 *)(a3 + 2));
          }
          v11 = *(_DWORD *)(a3 + 16);
        }
        v32 = v11;
    ...
    if ( (v11 & 8) != 0 )
      _InterlockedAnd64((volatile signed __int64 *)(v12 + 8), 0xFF7FFFFFFFFFFFFFuLL);
    else
      _InterlockedOr64((volatile signed __int64 *)(v12 + 8), 0x80000000000000uLL);
    if ( (v32 & 4) != 0 )
      _InterlockedAnd64((volatile signed __int64 *)(v12 + 8), 0xFFFFFFFFDFFFFFFFuLL);
    else
      _InterlockedOr64((volatile signed __int64 *)(v12 + 8), 0x20000000uLL);
    if ( (v32 & 2) != 0 )
      _InterlockedOr64((volatile signed __int64 *)(v12 + 8), 0x40000000000000uLL);
    else
      _InterlockedAnd64((volatile signed __int64 *)(v12 + 8), 0xFFBFFFFFFFFFFFFFuLL);
    if ( (v32 & 1) != 0 )
      _InterlockedAnd64((volatile signed __int64 *)(v12 + 8), 0xFFFFFFFFFFFFFFFDuLL);
    else
      _InterlockedOr64((volatile signed __int64 *)(v12 + 8), 2uLL);
    v11 = v32;
    if ( (v14 & 2) == 0 && (v32 & 1) == 0 )
    {
