/*
 * XREFs of AcpiDiagTraceDeviceCoolingRundown @ 0x1C00426E8
 * Callers:
...
void __fastcall AcpiDiagTraceDeviceCoolingRundown(__int64 a1, char a2, char a3)
{
  ...
  if ( *((_QWORD *)&WPP_MAIN_CB.Reserved + 1)
    && EtwEventEnabled(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_DEVICE_COOLING_RUNDOWN)
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 712), (__int64)&DestinationString) >= 0 )
  {
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v14 = &v16;
    v15 = 1LL;
    EtwWrite(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_DEVICE_COOLING_RUNDOWN, 0LL, 4u, &UserData);
  }
