/*
 * XREFs of ACPIBusIrpQueryHardwareId @ 0x1C0080000
 * Callers:
...
LABEL_26:
    if ( v10 < v34 )
      goto LABEL_29;
    v24 = RtlStringCbPrintfExW(&v11[v34 >> 1], v10 - v34, &ppszDestEnd, &pcbRemaining, 0, &word_1C0090E20);
    goto LABEL_28;
  }
  v13 = *(_QWORD *)(a3 + 8);
...
LABEL_28:
  ...
  memmove(P, v17, v16);
  if ( !(unsigned __int8)ACPIValidateStringVendorDeviceIdFormat(P, Size) && (*(_BYTE *)(a3 + 912) & 0x1C) == 0 )
  {
LABEL_24:
    v7 = v34;
    if ( v10 > v34 )
