/*
 * XREFs of AccessBaseField @ 0x1C001CA40
 * Callers:
...
__int64 __fastcall AccessBaseField(__int64 a1, __int64 a2, unsigned int *a3, __int64 *a4, int a5)
{
  ...
  __int64 v25; // rcx
  char v26; // al
  int (__fastcall *v27)(_QWORD, unsigned __int64, __int64 *, _QWORD, int *); // rax
  ...
  *a4 &= v14;
  ...
  if ( !*(_BYTE *)(v7 + 12) )
  {
    ...
    if ( !BYTE1(WPP_MAIN_CB.Queue.ListEntry.Flink)
      || (v27 = *(int (__fastcall **)(_QWORD, unsigned __int64, __int64 *, _QWORD, int *))(PmHalDispatchTable + 144)) == 0LL
      || v27(0LL, v11, &v30, v10, &a5) < 0 )
    {
      if ( v10 != 1LL )
        v6 = v11 % v10;
      if ( !v6 )
      ...
      memmove(&v30, (const void *)v11, v10);
    }
    v22 = v30;
LABEL_32:
    v23 = v14 & v22;
  ...
  else
  {
    ...
    if ( v19 && *(_QWORD *)(v19 + 16) )
    {
      if ( v17 )
      {
        ...
        v21 = (*(__int64 (__fastcall **)(_QWORD, __int64, unsigned __int64, _QWORD, __int64 *, _QWORD, __int64 (__fastcall *)(), __int64))(v19 + 16))(
                0LL,
                a2 + 120,
                v11,
                v10,
      ...
      {
        v9 = PushFrame(a1, 1094931031, 96, (unsigned int)WriteCookAccess, (__int64)&v31);
        if ( !v9 )
        {
          v25 = v31;
          *(_QWORD *)(v31 + 32) = a2;
