/*
 * XREFs of SleepQueueRequest @ 0x1C005D1FC
 * Callers:
...
__int64 __fastcall SleepQueueRequest(__int64 a1, unsigned int a2)
{
  ...
  if ( v4 >= 0 )
  {
    byte_1C0074F90 = KeAcquireSpinLockRaiseToDpc(&gmutSleep);
    v5 = &SleepQueue;
    ...
    v15[6] = v8;
    v7[7] = a1;
    for ( i = (__int64 *)qword_1C0074F80; i != &SleepQueue; i = (__int64 *)i[1] )
    {
      if ( v8 >= i[2] )
      {
        v10 = *i;
    ...
    KeReleaseSpinLock(&gmutSleep, byte_1C0074F90);
  }
