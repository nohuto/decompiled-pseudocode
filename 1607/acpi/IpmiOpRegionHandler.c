/*
 * XREFs of IpmiOpRegionHandler @ 0x1C0050E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IpmiOpRegionHandler(__int64 a1, _BYTE *a2, _BYTE *a3)
{
  ...
  if ( *(_BYTE *)(a1 + 8) == 1 )
  {
    ...
    if ( v13 )
    {
      ...
      if ( v9 > OutBufferSize )
        v16 = v9;
      InOutBufferSize = v16;
      v17 = (char *)ExAllocatePoolWithTag(PagedPool, v16, 0x4D706341u);
      v7 = v17;
      if ( v17 )
      {
        memmove(v17, InOutBuffer, v9);
        v11 = IoWMIExecuteMethod(DataBlockObject, &InstanceName, 1u, v9, &OutBufferSize, (PUCHAR)v7);
        if ( v11 >= 0 )
        {
          *a2 = *v7;
          v18 = *((_DWORD *)v7 + 1);
          if ( v18 > *(_DWORD *)v24 - 2 )
            LOBYTE(v18) = *v24 - 2;
          a2[1] = v18;
          memmove(a2 + 2, v7 + 8, (unsigned __int8)v18);
        }
        goto LABEL_23;
      }
    }
