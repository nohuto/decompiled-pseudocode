/*
 * XREFs of AcpiDiagTraceTemperatureChange @ 0x1C0009F48
 * Callers:
...
void __fastcall AcpiDiagTraceTemperatureChange(__int64 a1, __int64 a2)
{
  ...
  if ( *((_QWORD *)&WPP_MAIN_CB.Reserved + 1)
    && EtwEventEnabled(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_TEMPERATURE_CHANGE)
    && (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a2 + 712), (__int64)&DestinationString) >= 0 )
  {
    ...
    UserData.Size = 2;
    v12 = 4;
    EtwWrite(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_TEMPERATURE_CHANGE, 0LL, 3u, &UserData);
  }
