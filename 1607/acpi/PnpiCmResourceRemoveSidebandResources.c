/*
 * XREFs of PnpiCmResourceRemoveSidebandResources @ 0x1C00A001C
 * Callers:
 *     PnpCmResourcesExcludeSidebandResources @ 0x1C009FEF0 (PnpCmResourcesExcludeSidebandResources.c)
 * Callees:
 *     PnpiCmResourceSidebandConnection @ 0x1C00A01F0 (PnpiCmResourceSidebandConnection.c)
 */
