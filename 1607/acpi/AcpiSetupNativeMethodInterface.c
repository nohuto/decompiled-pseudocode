/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1C008341C
 * Callers:
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *((_QWORD *)&OutputBuffer[5] + 1) = AcpiTranslatePepDeviceControlResources;
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_1C0073A10 = OutputBuffer[1];
        unk_1C0073A20 = OutputBuffer[2];
        xmmword_1C0073A30 = OutputBuffer[3];
        xmmword_1C0073A40 = OutputBuffer[4];
        xmmword_1C0073A50 = OutputBuffer[5];
