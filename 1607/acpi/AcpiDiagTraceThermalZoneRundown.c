/*
 * XREFs of AcpiDiagTraceThermalZoneRundown @ 0x1C0042D2C
 * Callers:
 *     AcpiDiagTraceControlCallback @ 0x1C00424E0 (AcpiDiagTraceControlCallback.c)
 * Callees:
 *     ACPIAmliBuildObjectPathnameUnicode @ 0x1C0009D04 (ACPIAmliBuildObjectPathnameUnicode.c)
 *     __security_check_cookie @ 0x1C002BC20 (__security_check_cookie.c)
 *     AcpiDiagEnumCoolingDevices @ 0x1C0041E84 (AcpiDiagEnumCoolingDevices.c)
...
void __fastcall AcpiDiagTraceThermalZoneRundown(__int64 a1)
{
  ...
  {
    if ( EtwEventEnabled(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_THERMAL_ZONE_RUNDOWN) )
    {
      if ( (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 712), (__int64)&DestinationString) >= 0 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          *(_QWORD *)&PoolWithTag[10].Size = 4LL;
          PoolWithTag[11].Ptr = (unsigned __int64)&v31;
          *(_QWORD *)&PoolWithTag[11].Size = 4LL;
          v31 = AcpiDiagEnumCoolingDevices(v1, 1, 1, (__int64)PoolWithTag, &v27);
          v13 = v27++;
          UserData[v13].Ptr = (unsigned __int64)&v32;
          *(_QWORD *)&UserData[v13].Size = 4LL;
          v15 = 0;
          v32 = AcpiDiagEnumCoolingDevices(v1, 1, 0, v14, &v27);
          v16 = v34;
          v17 = v34;
          do
          {
          ...
          *((_QWORD *)&UserData->Size + v25) = 2LL;
          ...
          EtwWrite(*((REGHANDLE *)&WPP_MAIN_CB.Reserved + 1), &ACPI_ETW_EVENT_THERMAL_ZONE_RUNDOWN, 0LL, v9, UserData);
        }
      }
    }
  }
