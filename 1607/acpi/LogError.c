...
void __fastcall LogError(int a1)
{
  ...
  if ( off_1C0072988 )
  {
    v3 = 0LL;
    v4 = 0LL;
    while ( a1 != *(_DWORD *)((char *)&unk_1C0072980 + v4) )
    {
      ++v3;
      ++v1;
      v4 = 16 * v3;
      if ( !*((_QWORD *)&unk_1C0072980 + 2 * v3 + 1) )
        return;
    }
    v5 = 2LL * v1;
    RtlStringCchPrintfA(
      ...
      "AMLI_ERROR(%08x): %s",
      a1,
      *((const char **)&unk_1C0072980 + 2 * v1 + 1));
    WPP_RECORDER_SF_Ds(WPP_GLOBAL_Control->DeviceExtension, v6, v7, v8, v9, a1, *((_QWORD *)&unk_1C0072980 + v5 + 1));
  }
}
