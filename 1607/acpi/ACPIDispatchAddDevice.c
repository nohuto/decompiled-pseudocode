/*
 * XREFs of ACPIDispatchAddDevice @ 0x1C00A7150
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPICreateRootSymbolicLink @ 0x1C0083340 (ACPICreateRootSymbolicLink.c)
 *     AcpiSetupNativeMethodInterface @ 0x1C008341C (AcpiSetupNativeMethodInterface.c)
 *     ACPIGetPortRangeInterfaces @ 0x1C00A706C (ACPIGetPortRangeInterfaces.c)
 */
...
LABEL_10:
  v21 = (const char *)qword_1C00A9CD0;
  v22 = (const char *)qword_1C00A9CD0;
  if ( v4 )
  {
    v23 = v4[1];
    v2 = (char)v4;
