/*
 * XREFs of ACPIBuildProcessPowerResourcePhaseSetupOnOff @ 0x1C0044CA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessPowerResourcePhaseSetupOnOff(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 32) = 6;
  ...
  memset(v2, 0, 0x28uLL);
  v5 = AMLIGetNamedChild(*(__int64 **)(v1 + 32), 1179012959);
  if ( !v5 )
  ...
  *(_QWORD *)(v1 + 72) = v7;
  ...
  v10 = *(__int64 **)(v1 + 32);
  *(_QWORD *)(v1 + 88) = v9;
  v11 = AMLIGetNamedChild(v10, 1096045407);
  if ( !v11 )
  ...
  *(_QWORD *)(a1 + 56) = v11;
  ...
  v3 = AMLIAsyncEvalObject(v14, v2, 0, 0LL, ACPIBuildCompleteGeneric, a1);
  if ( v3 != 259 )
LABEL_13:
    ACPIBuildCompleteGeneric((__int64)v11, v3, (__int64)v2, a1);
  AMLIDereferenceHandleEx((volatile signed __int32 *)v11, v15);
  return v3;
}
