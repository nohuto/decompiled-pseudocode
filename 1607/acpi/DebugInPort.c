/*
 * XREFs of DebugInPort @ 0x1C005AC30
 * Callers:
 *     DebugI @ 0x1C005AC00 (DebugI.c)
 *     DebugID @ 0x1C005AC10 (DebugID.c)
 *     DebugIW @ 0x1C005AC20 (DebugIW.c)
 * Callees:
...
LABEL_13:
  ...
  if ( byte_1C0075208 || !(unsigned __int8)IsNumber(a1, 16LL) )
    goto LABEL_13;
