/*
 * XREFs of ACPIIoctlAsyncEvalControlMethodEx @ 0x1C00506A8
 * Callers:
...
__int64 __fastcall ACPIIoctlAsyncEvalControlMethodEx(ULONG_PTR a1, IRP *a2, __int64 a3)
{
  ...
  v10 = 0LL;
  v13 = 0;
  v4 = ACPIIoctlEvalPreProcessingEx(a1, (__int64)a2, a3, NonPagedPoolNx, &v12, &v10, (unsigned int **)&P, &v13);
  if ( v4 < 0 )
  {
LABEL_9:
    if ( v10 )
  ...
  v4 = AMLIAsyncEvalObject(v12, (_SLIST_ENTRY *)v10, v13, P, &ACPIIoctlAsyncEvalControlMethodExCompletion, a2);
  if ( P )
  {
  ...
  if ( v4 != 259 )
  {
    if ( v4 >= 0 )
    {
      v9 = ACPIIoctlEvalPostProcessingEx(a2, (__int64)v10, v6, v7);
      dword_1C0074698 = 0;
      v4 = v9;
      byte_1C007469C = 0;
