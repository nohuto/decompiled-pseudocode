/*
 * XREFs of WPP_RECORDER_SF_qDqqss @ 0x1C004B420
 * Callers:
 *     ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum @ 0x1C004AEA0 (ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum.c)
 * Callees:
