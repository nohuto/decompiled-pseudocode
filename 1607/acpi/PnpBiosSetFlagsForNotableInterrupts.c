/*
 * XREFs of PnpBiosSetFlagsForNotableInterrupts @ 0x1C0026494
 * Callers:
 ...
 * Callees:
 *     PnpBiosScanForWakeInterrupt @ 0x1C0026524 (PnpBiosScanForWakeInterrupt.c)
 */
...
char __fastcall PnpBiosSetFlagsForNotableInterrupts(__int64 a1, char *a2, unsigned int a3)
{
  ...
  {
    result = 0;
    _InterlockedOr64((volatile signed __int64 *)(a1 + 912), 0x100000000uLL);
    _InterlockedOr64((volatile signed __int64 *)(a1 + 8), 0x10000uLL);
    _InterlockedOr64((volatile signed __int64 *)(a1 + 912), 0x100000uLL);
  }
  if ( (unsigned int)v4 >= 0x18 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        result = 0;
        _InterlockedOr64((volatile signed __int64 *)(a1 + 912), 0x800000000uLL);
        return result;
      }
      v8 = v10;
      if ( v10 >= &a2[v4] )
