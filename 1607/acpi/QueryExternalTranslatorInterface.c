/*
 * XREFs of QueryExternalTranslatorInterface @ 0x1C0083794
 * Callers:
 ...
 *     RegisterExternalTranslatorInterface @ 0x1C0083A10 (RegisterExternalTranslatorInterface.c)
 */
...
LABEL_28:
    ...
    if ( Driver < 0 )
    {
      ...
      WPP_RECORDER_SF_D(
        ...
        21,
        14,
        (__int64)&WPP_a4223b8e9b7938dd681ac13229df622e_Traceguids,
        Driver);
    }
    Status = ZwOpenFile(&FileHandle, 0x100003u, &ObjectAttributes, &IoStatusBlock, 3u, 0x10u);
  }
