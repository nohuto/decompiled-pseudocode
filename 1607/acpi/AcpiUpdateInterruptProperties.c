/*
 * XREFs of AcpiUpdateInterruptProperties @ 0x1C009B820
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ProcessorUpdateInterruptProperties @ 0x1C00A2008 (ProcessorUpdateInterruptProperties.c)
 *     IrqArbUpdateInterruptProperties @ 0x1C00A23AC (IrqArbUpdateInterruptProperties.c)
 *     IcUpdateInterruptProperties @ 0x1C00A2824 (IcUpdateInterruptProperties.c)
 */
