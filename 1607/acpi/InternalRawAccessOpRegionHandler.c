/*
 * XREFs of InternalRawAccessOpRegionHandler @ 0x1C0054EC0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v7 = 0LL;
  byte_1C007469C = 0;
  FieldUnitRegionObj = GetFieldUnitRegionObj((__int64 *)a3, (__int64 *)Object, a3);
  if ( FieldUnitRegionObj >= 0 && Object[0] )
  {
    v7 = (volatile signed __int32 *)((char *)Object[0] + 120);
    AMLIReferenceHandleEx((__int64)Object[0] + 120);
