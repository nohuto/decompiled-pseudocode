/*
 * XREFs of ACPIDevicePowerProcessPhase5SystemSubPhase5 @ 0x1C004A720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase5SystemSubPhase5(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 212) = 8;
  ...
  {
    qword_1C0073ED8 = a1;
    qword_1C0073EC8 = (__int64)&AcpiPauseInterpreterEntry;
    qword_1C0073ED0 = (__int64)ACPIDeviceCompleteInterpreterRequest;
