/*
 * XREFs of ACPIBusAndFilterIrpQueryPnpDeviceState @ 0x1C008E800
 * Callers:
 *     <none>
 * Callees:
 ...
 *     AcpiDeviceResetMarkDeviceRemoved @ 0x1C004BE74 (AcpiDeviceResetMarkDeviceRemoved.c)
 */
...
__int64 __fastcall ACPIBusAndFilterIrpQueryPnpDeviceState(ULONG_PTR a1, __int64 a2, __int64 a3, char a4)
{
  ...
  v9 = ACPIGet((__int64 *)DeviceExtension, 1096045407, -1878783998, 0LL, 0, 0LL, 0LL, (__int64)&v29, 0LL);
  if ( v9 < 0 )
    goto LABEL_26;
  ...
  {
    v11 = 1;
    if ( (*(_DWORD *)(DeviceExtension + 912) & 0x40000) == 0
...
LABEL_26:
  ...
  v23 = " Disabled";
  if ( v12 )
    v23 = (const char *)qword_1C0090C20;
