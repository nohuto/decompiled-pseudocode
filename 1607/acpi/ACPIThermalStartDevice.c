/*
 * XREFs of ACPIThermalStartDevice @ 0x1C0081910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIThermalStartDevice(PDEVICE_OBJECT PhysicalDeviceObject, PIRP Irp)
{
  ...
  *(_DWORD *)(*(_QWORD *)(DeviceExtension + 200) + 92LL) = 100;
  ...
  *(_DWORD *)(DeviceExtension + 192) |= 0x8000000u;
  ...
  WPP_RECORDER_SF_qqss(
    ...
    5u,
    0x14u,
    (__int64)&WPP_e71e3bd19733322e69664c086501e10c_Traceguids,
    (char)Irp,
    DeviceExtension,
    v6,
    v7);
    ...
    if ( SensorDevice >= 0 )
    {
      ...
      if ( SensorDevice >= 0 )
      {
        *(_DWORD *)(DeviceExtension + 320) = 2;
        SensorDevice = ACPIDeviceInternalDeviceRequest((_QWORD *)DeviceExtension, 1, 0, 0, 0);
        if ( SensorDevice == 259 )
          SensorDevice = 0;
