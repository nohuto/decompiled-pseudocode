/*
 * XREFs of ACPIBusIrpDeviceUsageNotification @ 0x1C0090000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBusIrpDeviceUsageNotification(PDEVICE_OBJECT PhysicalDeviceObject, PIRP Irp)
{
  ...
  {
    if ( !CurrentStackLocation->Parameters.SetLock.Lock && (*(_DWORD *)(DeviceExtension + 912) & 0x40000) != 0 )
    {
      v4 = -1073741811;
      goto LABEL_15;
    }
...
LABEL_5:
    ...
    if ( CurrentStackLocation->Parameters.Create.Options == 5 )
    {
      *(_QWORD *)(v8 + 912) ^= (*(_DWORD *)(v8 + 912) ^ ((CurrentStackLocation->Parameters.SetLock.Lock != 0) << 18)) & 0x40000;
      Lock = 0;
    }
    if ( Lock )
