/*
 * XREFs of ReadFieldObj @ 0x1C001C410
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( *(_WORD *)(*v10 + 66) == 132 )
        {
          BuffField = PushAccFieldObj(
                        ...
                        *(_QWORD *)(*(_QWORD *)(v11 + 96) + 8LL) + 64LL,
                        (_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v11 + 96) + 8LL) + 96LL) + 8LL),
                        a2 + 88,
                        4u);
          goto LABEL_19;
        }
          ...
          if ( (gdwfAMLI & 4) != 0 && _InterlockedExchangeAdd((volatile signed __int32 *)(v13 + 112), 0xFFFFFFFF) == 1 )
          {
            ...
            *(_WORD *)(v86 + 64) |= 4u;
            if ( (*(_WORD *)(v69 + 64) & 0x40) == 0 )
              FreeNameSpaceObjects((_QWORD *)v69);
          }
          goto LABEL_19;
        }
LABEL_20:
...
LABEL_117:
        ...
        if ( v53 )
        {
          if ( !v50 )
          {
            memmove(&Src, (const void *)v49, v47);
            v52 = Src;
          }
          Src = v48 | v52 & ~v51;
          memmove((void *)v49, &Src, v47);
LABEL_123:
          v5 = v83;
          goto LABEL_64;
        }
...
LABEL_142:
        ...
        if ( v24 )
        {
          if ( !v23 )
          {
            memmove(&v85, (const void *)v20, v18);
            v22 = v85;
            a3 = v87;
          }
          v85 = a3 | v22 & ~v21;
          memmove((void *)v20, &v85, v18);
          v5 = v83;
        }
        else
        {
...
LABEL_38:
    ...
    *((_QWORD *)v32 + 1) = v35;
    ...
    {
      v58 = v30[1];
      if ( (unsigned int *)v36 == (unsigned int *)((char *)v30 + v58) )
      {
        v59 = *(_DWORD *)(v36 + 4) + v58;
        v60 = (_QWORD *)*v35;
        v30[1] = v59;
        v61 = *v60;
        v62 = (_QWORD *)v60[1];
    ...
    {
      v57 = v38[1];
      if ( v30 == (unsigned int *)((char *)v38 + v57) )
      {
        v38[1] = v30[1] + v57;
        v78 = (__int64 *)*v35;
