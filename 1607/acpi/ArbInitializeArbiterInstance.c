/*
 * XREFs of ArbInitializeArbiterInstance @ 0x1C008E278
 * Callers:
 ...
 * Callees:
 *     RtlInitializeRangeList_0 @ 0x1C002BC56 (RtlInitializeRangeList_0.c)
 *     ArbBuildAssignmentOrdering @ 0x1C008868C (ArbBuildAssignmentOrdering.c)
 */

__int64 __fastcall ArbInitializeArbiterInstance(__int64 a1, __int64 a2, int a3, __int64 a4, _DWORD *a5)
{
  ...
  *(_QWORD *)(a1 + 48) = v11;
        ...
        (*(_QWORD *)(a1 + 296) = v12) != 0LL) )
  {
    ...
    *(_DWORD *)(a1 + 32) = a3;
    ...
    v13 = ArbBuildAssignmentOrdering(a1, (__int64)a5, a5);
    if ( v13 >= 0 )
      return 0LL;
  }
  else
