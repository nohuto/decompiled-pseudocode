/*
 * XREFs of PnpiBiosExtendedIrqToIoDescriptor @ 0x1C009F7C8
 * Callers:
...
__int64 __fastcall PnpiBiosExtendedIrqToIoDescriptor(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5)
{
  ...
  if ( (unsigned __int8)a3 >= *(_BYTE *)(a2 + 4) )
    return 3221225485LL;
  v10 = *(_DWORD *)(a2 + 4LL * (unsigned __int8)a3 + 5);
  if ( !v10 )
    return 0LL;
  v11 = 0;
  v12 = (*(_BYTE *)(a2 + 3) & 2) != 0;
...
LABEL_14:
  result = PnpiUpdateResourceList((const void **)(a4 + 8LL * a5), &v18, (unsigned __int8)a3);
  v15 = result;
  if ( (int)result >= 0 )
  {
    v16 = v18;
