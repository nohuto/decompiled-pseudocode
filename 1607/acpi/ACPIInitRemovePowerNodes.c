/*
 * XREFs of ACPIInitRemovePowerNodes @ 0x1C004FAA8
 * Callers:
...
_QWORD *__fastcall ACPIInitRemovePowerNodes(__int64 a1)
{
  ...
  do
  {
    if ( *v11 )
    {
      result = (_QWORD *)AMLIDereferenceHandleEx(*v11, 0LL);
      *v11 = 0LL;
    }
    ++v11;
    --v12;
  ...
  while ( v12 );
  v13 = *(volatile signed __int32 **)(a1 + 448);
  if ( v13 )
  {
    result = (_QWORD *)AMLIDereferenceHandleEx(v13, 0LL);
    *(_QWORD *)(a1 + 448) = 0LL;
  }
  return result;
}
