/*
 * XREFs of ACPIBuildFilter @ 0x1C0021A84
 * Callers:
 ...
 *     ACPIIsFilterDebuggingDevice @ 0x1C0088330 (ACPIIsFilterDebuggingDevice.c)
 */
      ...
      *(_QWORD *)(a2 + 24) = AcpiFilterIrpDispatch;
      ...
      if ( (unsigned __int8)ACPIIsFilterDebuggingDevice(a2) && AcpiRetainDebugDeviceInD0 )
      {
        do
        {
          ...
          _InterlockedOr64((volatile signed __int64 *)(a2 + 912), 0x1000000000uLL);
