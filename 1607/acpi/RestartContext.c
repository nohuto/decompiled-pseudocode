/*
 * XREFs of RestartContext @ 0x1C001DA80
 * Callers:
 ...
 *     RestartCtxtCallback @ 0x1C001D990 (RestartCtxtCallback.c)
 *     SleepQueueDpc @ 0x1C002BB30 (SleepQueueDpc.c)
 *     AMLIRestartContext @ 0x1C0059878 (AMLIRestartContext.c)
 *     AsyncCallBack @ 0x1C005DEF4 (AsyncCallBack.c)
 *     TimeoutCallback @ 0x1C005E390 (TimeoutCallback.c)
...
__int64 __fastcall RestartContext(PSLIST_ENTRY ListEntry, char a2)
{
  ...
  {
    v10 = _InterlockedExchangeAdd((_DWORD *)&qword_1C0074668 + 1, 1u);
    if ( (_DWORD)qword_1C0074668 == 204 )
      v11 = v10 % 0xCC;
    else
      v11 = v10 % (unsigned int)qword_1C0074668;
    v12 = 72LL * v11;
