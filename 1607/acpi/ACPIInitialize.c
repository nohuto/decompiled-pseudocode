/*
 * XREFs of ACPIInitialize @ 0x1C00A90EC
 * Callers:
 *     ACPIInitStartACPI @ 0x1C00A9A78 (ACPIInitStartACPI.c)
 * Callees:
 *     KsrGetFirmwareInformation_0 @ 0x1C0001000 (KsrGetFirmwareInformation_0.c)
 *     KsrEnumeratePersistedMemory_0 @ 0x1C0001008 (KsrEnumeratePersistedMemory_0.c)
 *     WPP_RECORDER_SF_D @ 0x1C0004BB0 (WPP_RECORDER_SF_D.c)
 *     WPP_RECORDER_SF_ @ 0x1C000E748 (WPP_RECORDER_SF_.c)
 *     ACPIGetTableVersion @ 0x1C0018620 (ACPIGetTableVersion.c)
 ...
 *     AcpiKsrRestorePersistentContext @ 0x1C009D4A0 (AcpiKsrRestorePersistentContext.c)
...
char __fastcall ACPIInitialize(__int64 a1)
{
  ...
  qword_1C0074E70 = (__int64)&AcpiDynamicDataBlockTableList;
  ...
  *((_DWORD *)AcpiInformation + 20) = 0;
  ...
  v15 = AcpiIrqLibConfigureLibrary(v22);
  if ( v15 < 0 )
