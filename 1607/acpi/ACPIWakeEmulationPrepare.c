/*
 * XREFs of ACPIWakeEmulationPrepare @ 0x1C00A16D4
 * Callers:
 *     ACPIDeviceInitializePowerRequest @ 0x1C000E7E0 (ACPIDeviceInitializePowerRequest.c)
 * Callees:
 *     ACPICreateWakeInterruptRegistrationEntries @ 0x1C00A1620 (ACPICreateWakeInterruptRegistrationEntries.c)
 */
