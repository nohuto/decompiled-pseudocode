/*
 * XREFs of ndisPnPQuerySriovInterface @ 0x1C00DB334
 * Callers:
...
__int64 __fastcall ndisPnPQuerySriovInterface(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x55u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1);
  v5 = *(_QWORD *)(a2 + 184);
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qD(0x56u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1, v4);
  return v4;
}
