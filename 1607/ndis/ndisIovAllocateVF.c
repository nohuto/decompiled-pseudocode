/*
 * XREFs of ndisIovAllocateVF @ 0x1C00D8BA8
 * Callers:
...
char __fastcall ndisIovAllocateVF(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x1Fu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3);
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 32) + 60LL) = 0;
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qD(0x20u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, *(_DWORD *)(a1 + 40));
  return v4;
}
