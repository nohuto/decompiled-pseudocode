/*
 * XREFs of ndisSriovInterfaceQueryProbedBars @ 0x1C00DB820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceQueryProbedBars(void *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x5Fu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qD(0x60u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
