/*
 * XREFs of ndisOidPreRcvFilterEnumFilters @ 0x1C003D580
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumFilters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E0 >= 4u )
    WPP_SF_q(0x1Eu, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, a1);
  v6 = *(_DWORD **)(a1 + 32);
  v7 = 20;
  if ( v6[1] == 12 )
  {
...
LABEL_22:
      ...
      else
      {
        ...
        if ( v14 )
          ...
          ReceiveQueueByQueueId = *(__int64 **)(v1 + 4432);
...
LABEL_43:
  if ( (unsigned __int8)byte_1C00895E0 >= 4u )
    WPP_SF_qD(31LL, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v1, *(unsigned int *)(a1 + 40));
  return v5;
}
