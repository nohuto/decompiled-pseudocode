/*
 * XREFs of ?ndisFindAdjacentFilters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_FILTER_LINK@@PEAPEAU_NDIS_FILTER_BLOCK@@2@Z @ 0x1C00A3894
 * Callers:
  ...
  if ( a1->Bindings.Filters.m_numElements )
  {
    while ( 1 )
    {
      ...
      if ( Ndis::BindState::GetBindContext(&p->BindState) )
        BindContext = (struct _NDIS_FILTER_BLOCK *)Ndis::BindState::GetBindContext((Ndis::BindState *)(*(_QWORD *)(v14 + 8 * v15) + 8LL));
      v10 = v15 + 1;
      if ( v10 >= a1->Bindings.Filters.m_numElements )
        goto LABEL_11;
    }
    *a4 = BindContext;
    ...
    {
      v12 = v10 + 1;
      if ( v12 >= a1->Bindings.Filters.m_numElements )
        break;
      if ( Ndis::BindState::GetBindContext(&a1->Bindings.Filters._p[v12]._p->BindState) )
      {
        *a3 = (struct _NDIS_FILTER_BLOCK *)Ndis::BindState::GetBindContext((Ndis::BindState *)(*(_QWORD *)(v13 + 8 * v10)
                                                                                             + 8LL));
        break;
      }
    }
