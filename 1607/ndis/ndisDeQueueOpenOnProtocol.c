/*
 * XREFs of ndisDeQueueOpenOnProtocol @ 0x1C00EB574
 * Callers:
...
void __fastcall ndisDeQueueOpenOnProtocol(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_qq(0x2Cu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, a1, a2);
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_qq(0x2Du, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, a1, a2);
}
