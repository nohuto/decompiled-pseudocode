/*
 * XREFs of WPP_SF_Zq @ 0x1C004EAC4
 * Callers:
...
void WPP_SF_Zq(unsigned __int16 a1, const struct _GUID *a2, unsigned __int16 *a3, ...)
{
  int v6; // r9d
  ...
  if ( a3 )
    v8 = a3;
  ndisWppFastTraceMessage(a2, a1, v8, 2LL, v7, v6, va, 8LL, 0LL);
}
