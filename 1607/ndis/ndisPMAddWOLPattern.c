/*
 * XREFs of ndisPMAddWOLPattern @ 0x1C0025394
 * Callers:
...
__int64 __fastcall ndisPMAddWOLPattern(_DWORD *MiniportAdapterHandle, __int64 a2, PNDIS_OID_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(78LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, MiniportAdapterHandle, a2, Request);
  ...
  while ( 1 )
  {
    *(_DWORD *)&Request->NdisReserved[16] |= 0x2000000u;
    ...
    if ( !v7 )
    {
      ...
      *((_QWORD *)MiniportAdapterHandle + 65) = KeGetCurrentThread();
      ...
      NewIrql = v12;
      MiniportAdapterHandle[464] = 2758025;
    ...
    *(_DWORD *)&Requesta.NdisReserved[16] |= 0x1800000u;
    ...
    SetMiniport = ndisQuerySetMiniportEx(MiniportAdapterHandle, 0LL, &Requesta, 0, 0LL, a2);
    if ( SetMiniport )
    {
      if ( (unsigned __int8)byte_1C00895D5 < 2u )
        goto LABEL_7;
...
LABEL_27:
      v20 = SetMiniport;
LABEL_32:
      WPP_SF_d(v19, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v20);
      goto LABEL_7;
    }
  }
...
LABEL_7:
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqqL(83LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, MiniportAdapterHandle, a2, Request, v9);
  return v9;
}
