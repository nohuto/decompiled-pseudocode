/*
 * XREFs of NdisMCoRequestComplete @ 0x1C00F9620
 * Callers:
...
void __stdcall NdisMCoRequestComplete(NDIS_STATUS Status, NDIS_HANDLE MiniportAdapterHandle, PNDIS_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqd(0x36u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, MiniportAdapterHandle, Request, Status);
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_(0x37u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
}
