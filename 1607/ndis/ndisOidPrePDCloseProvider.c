/*
 * XREFs of ndisOidPrePDCloseProvider @ 0x1C00E1260
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPrePDCloseProvider(__int64 a1)
{
  ...
  KLockThisExclusive v24; // [rsp+40h] [rbp-C0h] BYREF
        ...
        && *(_DWORD *)(v10 + 72) == *(_DWORD *)(v3 + 240) )
      {
        ...
        *(_QWORD *)(v5 + 8) = v10;
        if ( !*(_DWORD *)(a1 + 40) )
        {
          ...
          v13 = (struct KPushLockBase *)(qword_1C0089668 + 8);
          *(_QWORD *)(v10 + 80) = 0LL;
          *(_QWORD *)(v10 + 64) = 0LL;
          KLockThisExclusive::KLockThisExclusive(&v24, v13);
          v14 = (_QWORD *)(v10 + 8);
          v15 = *(_QWORD *)(v10 + 8);
          v16 = *(_QWORD **)(v10 + 16);
          ...
          *v17 = 0LL;
          ...
          ndisDereferenceMiniport(*(_QWORD *)(v10 + 56));
          *(_QWORD *)(v10 + 56) = 0LL;
