/*
 * XREFs of ndisFillOffloadCapsInTasks @ 0x1C00454D0
 * Callers:
...
void __fastcall ndisFillOffloadCapsInTasks(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_q(0xCFu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1);
    v8 = byte_1C00895D2;
  }
  v9 = *(_QWORD *)(a2 + 40);
  v10 = 28;
  v11 = (_DWORD *)(*(_QWORD *)(a1 + 4152) + 188LL);
  v12 = *(_DWORD *)(v9 + 16);
  v13 = v9 + 28;
  *(_DWORD *)(v9 + 12) = 28;
  if ( v11[9] )
  ...
  *(_DWORD *)(a2 + 52) = v10;
  if ( (unsigned __int8)v8 >= 4u )
    WPP_SF_q(0xD0u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1);
}
