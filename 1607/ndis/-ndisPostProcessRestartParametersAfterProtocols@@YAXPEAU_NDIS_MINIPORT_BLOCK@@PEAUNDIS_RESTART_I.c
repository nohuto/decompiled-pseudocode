/*
 * XREFs of ?ndisPostProcessRestartParametersAfterProtocols@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x1C00154DC
 * Callers:
    ...
    else
    {
      ...
      if ( IoWMIRegistrationControl(a1->DeviceObject, 4u) )
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 3u )
          WPP_SF_q(37LL, &WPP_9d58b71ad31e34326812744187916088_Traceguids, a1);
      }
    }
  }
}
