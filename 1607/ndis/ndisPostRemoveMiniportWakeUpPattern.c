/*
 * XREFs of ndisPostRemoveMiniportWakeUpPattern @ 0x1C004A5FC
 * Callers:
...
void __fastcall ndisPostRemoveMiniportWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqd(39LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = 0;
...
LABEL_31:
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqd(40LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1, a2, a3);
}
