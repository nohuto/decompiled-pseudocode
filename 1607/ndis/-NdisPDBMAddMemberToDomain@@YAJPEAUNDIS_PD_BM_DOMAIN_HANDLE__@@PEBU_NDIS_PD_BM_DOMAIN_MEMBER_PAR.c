/*
 * XREFs of ?NdisPDBMAddMemberToDomain@@YAJPEAUNDIS_PD_BM_DOMAIN_HANDLE__@@PEBU_NDIS_PD_BM_DOMAIN_MEMBER_PARAMETERS@@PEAPEAUNDIS_PD_BM_DOMAIN_MEMBER_HANDLE__@@@Z @ 0x1C00E1B10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ **a3)
{
  ...
  *a3 = 0LL;
  v7 = a3;
  v8 = 0LL;
  KLockThisExclusive::KLockThisExclusive(&v25, a1 + 1);
  if ( a2->Header.Type != 0x80 || a2->Header.Revision != 1 || a2->Header.Size < 0x10u || a2->Flags )
  {
    v11 = -1073741811;
    goto LABEL_39;
  }
  v9 = *((_QWORD *)MiniportAdapterContext + 708);
...
LABEL_12:
  if ( !*((_BYTE *)&a1[4].m_Lock.0 + 1) )
  {
    ...
    if ( !DmaAdapter )
    {
      if ( (unsigned __int8)byte_1C00895E4 >= 2u )
...
LABEL_39:
  ...
  v21 = (struct NDIS_PD_BM_DOMAIN_HANDLE__ **)(v6 + 2);
  v11 = 0;
  if ( *Value != v12 )
    __fastfail(3u);
  *v21 = v12;
