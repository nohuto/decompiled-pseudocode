/*
 * XREFs of ndisQueryOidList @ 0x1C00AB9FC
 * Callers:
...
__int64 __fastcall ndisQueryOidList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(0x11u, &WPP_8ce524521b613c0e10407cfbf52a0b71_Traceguids, a1);
  ...
  *(_DWORD *)&v12[4] = 2;
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0x12u, &WPP_8ce524521b613c0e10407cfbf52a0b71_Traceguids, a1, v5);
  return v5;
}
