/*
 * XREFs of ndisTranslateOffloadSetsToTasks @ 0x1C00C6F10
 * Callers:
...
void __fastcall ndisTranslateOffloadSetsToTasks(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_q(0xC1u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1);
    v8 = byte_1C00895D2;
  }
  v9 = *(_DWORD **)(a1 + 4152);
  v10 = *(_DWORD *)(a2 + 4) == 1;
...
LABEL_92:
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 4152) + 1164LL) = v12;
  if ( (unsigned __int8)v8 >= 4u )
    WPP_SF_q(0xC2u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1);
}
