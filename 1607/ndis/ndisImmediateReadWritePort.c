/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00CD904
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00CD420 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00CD440 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00CD460 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00CD4A0 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00CD4D0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00CD500 (NdisImmediateWritePortUshort.c)
 * Callees:
