/*
 * XREFs of ndisPreRemoveMiniportWakeUpPattern @ 0x1C00C9A08
 * Callers:
...
char __fastcall ndisPreRemoveMiniportWakeUpPattern(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(0x23u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1, a2);
    v6 = byte_1C00895D2;
  }
...
LABEL_25:
  ...
  if ( (unsigned __int8)v6 >= 4u )
    WPP_SF_qq(0x24u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1, a2);
  return v4;
}
