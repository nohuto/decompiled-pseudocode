/*
 * XREFs of ?NdisPDBMAllocateCommonBuffer@@YAJPEAUNDIS_PD_BM_DOMAIN_HANDLE__@@KKKPEAT_LARGE_INTEGER@@PEAPEAX@Z @ 0x1C00E1DE0
 * Callers:
 *     <none>
 * Callees:
    ...
    else if ( *((_BYTE *)&a1[4].m_Lock.0 + 1) )
    {
      ...
      else
      {
        ...
        if ( (unsigned __int8)byte_1C00895E4 >= 2u )
          WPP_SF_dq(0xEu, &WPP_9918afbc946533ae20284988996b87b5_Traceguids, v8, a1);
      }
    }
    else
    {
