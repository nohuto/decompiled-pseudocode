/*
 * XREFs of ndisClearReceiveFiltersForProtocol @ 0x1C00AF48C
 * Callers:
 *     ndisCleanUpForProtocol @ 0x1C00AF3D0 (ndisCleanUpForProtocol.c)
 * Callees:
 *     ?ndisFindFirstReceiveFilterByOpen@@YAPEAU_NDIS_RECEIVE_FILTER_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@@Z @ 0x1C001EE08 (-ndisFindFirstReceiveFilterByOpen@@YAPEAU_NDIS_RECEIVE_FILTER_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@@Z.c)
...
struct _NDIS_RECEIVE_FILTER_BLOCK *__fastcall ndisClearReceiveFiltersForProtocol(struct _NDIS_OPEN_BLOCK *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    {
      ...
      WPP_SF_qqd(0x1Bu, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v2, MiniportHandle, v7);
    }
