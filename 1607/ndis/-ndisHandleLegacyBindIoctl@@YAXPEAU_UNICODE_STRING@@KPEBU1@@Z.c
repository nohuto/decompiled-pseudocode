/*
 * XREFs of ?ndisHandleLegacyBindIoctl@@YAXPEAU_UNICODE_STRING@@KPEBU1@@Z @ 0x1C00CBE70
 * Callers:
...
void __fastcall ndisHandleLegacyBindIoctl(PCUNICODE_STRING SourceString, int a2, const struct _UNICODE_STRING *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_(0x18u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  ...
  if ( v14 )
  {
    ...
    for ( i = 0LL; ; i = (unsigned int)(i + 1) )
    {
      if ( (_DWORD)i == v7 )
      {
        ...
        Ndis::BindEngine::ApplyBindChanges((Ndis::BindEngine *)(v14 + 5208), RunSynchronous, 0);
        ndisDereferenceMiniport(v14);
        return;
      }
      ...
      if ( RtlEqualUnicodeString(v10, a3, 1u) )
      {
        ...
        if ( a2 == 1 )
        {
            ...
            && (unsigned __int8)byte_1C00895E3 >= 4u )
          {
            ...
            v12 = 25;
LABEL_17:
            WPP_SF_Zq(v12, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, (unsigned __int16 *)v13[1], v13[0]);
            continue;
          }
        }
