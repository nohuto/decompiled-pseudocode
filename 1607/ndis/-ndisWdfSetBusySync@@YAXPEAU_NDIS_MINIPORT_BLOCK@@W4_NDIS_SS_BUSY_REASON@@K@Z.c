/*
 * XREFs of ?ndisWdfSetBusySync@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_SS_BUSY_REASON@@K@Z @ 0x1C006AC7C
 * Callers:
...
void __fastcall ndisWdfSetBusySync(struct _NDIS_MINIPORT_BLOCK *a1, __int32 a2, int a3)
{
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C00895D6 >= 4u )
      WPP_SF_qD(0x24u, &WPP_fb3ee79da3763fe19127143656620238_Traceguids, (__int64)a1, a2);
