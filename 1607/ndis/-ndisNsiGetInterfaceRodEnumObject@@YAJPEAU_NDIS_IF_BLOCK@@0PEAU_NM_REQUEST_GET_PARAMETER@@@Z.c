/*
 * XREFs of ?ndisNsiGetInterfaceRodEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0099450
 * Callers:
 ...
 *     ?ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z @ 0x1C009A5C0 (-ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z.c)
 */
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x56u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a3);
    v4 = v32;
    v7 = v33;
    v6 = v34;
  }
...
LABEL_34:
            ...
            v35 = Miniport;
            if ( (unsigned __int8)byte_1C00895DD >= 4u )
              WPP_SF_qq(0xCBu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, Miniport, v37);
            ...
            if ( (unsigned __int8)byte_1C00895DD >= 4u )
              WPP_SF_qq(0xCCu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, Miniport, v37);
            v8 = v31;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqd(0x57u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, v7, v5, v3);
  return v3;
}
