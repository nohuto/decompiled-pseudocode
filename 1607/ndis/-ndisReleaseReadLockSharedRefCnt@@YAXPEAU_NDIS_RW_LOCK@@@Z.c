/*
 * XREFs of ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C00596BC
 * Callers:
 *     NdisReleaseReadWriteLock @ 0x1C000F950 (NdisReleaseReadWriteLock.c)
 *     ndisReleaseReadWriteLockX @ 0x1C005A144 (ndisReleaseReadWriteLockX.c)
 * Callees:
 *     <none>
 */
