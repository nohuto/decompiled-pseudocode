/*
 * XREFs of ndisQueryGuidDataSize @ 0x1C00A95E4
 * Callers:
...
__int64 __fastcall ndisQueryGuidDataSize(int *a1, __int64 a2, void *a3, GUID *a4, void *a5)
{
  ...
  *(_DWORD *)&GuidString.Length = 0;
  ...
  if ( (v14 & 0x20000000) == 0 )
  {
    ...
    if ( (v14 & 0x1C) != 0 || (v20 = *(_DWORD *)(v44 + 20), v20 == -1) )
    {
      memset(v47, 0, sizeof(v47));
      *(_DWORD *)&v47[88] |= 8u;
...
LABEL_20:
  ...
  if ( v24 )
  {
    ...
    if ( v25 )
    {
      if ( a3 )
      {
        v26 = *(_QWORD *)v44 - *(_QWORD *)&GUID_NDIS_ENUMERATE_VC.Data1;
        if ( *(_QWORD *)v44 == *(_QWORD *)&GUID_NDIS_ENUMERATE_VC.Data1 )
          v26 = *(_QWORD *)(v44 + 8) - *(_QWORD *)GUID_NDIS_ENUMERATE_VC.Data4;
        if ( !v26 )
        {
          *a1 = 0;
          goto LABEL_21;
      ...
      v27 = *(_QWORD *)v44 - *(_QWORD *)&GUID_NDIS_ENUMERATE_ADAPTERS_EX.Data1;
      if ( *(_QWORD *)v44 == *(_QWORD *)&GUID_NDIS_ENUMERATE_ADAPTERS_EX.Data1 )
        v27 = *(_QWORD *)(v44 + 8) - *(_QWORD *)GUID_NDIS_ENUMERATE_ADAPTERS_EX.Data4;
      if ( !v27 )
      {
