/*
 * XREFs of ndisFDoDirectOidRequestInternal @ 0x1C0045350
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x34u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, v3);
  *(_DWORD *)a1 = v7;
}
