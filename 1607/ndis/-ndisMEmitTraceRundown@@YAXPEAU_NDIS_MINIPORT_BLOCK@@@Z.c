/*
 * XREFs of ?ndisMEmitTraceRundown@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C004E304
 * Callers:
...
void __fastcall ndisMEmitTraceRundown(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( byte_1C00895C9 )
  {
    WPP_SF_qqZ(91LL, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, a1, a1->DriverHandle, a1->pAdapterInstanceName);
    if ( byte_1C00895C9 )
    {
      WPP_SF_DDDDD(
        a1->DriverHandle,
        ...
        *((unsigned __int16 *)&a1->NetLuid.Info + 3),
        (a1->NetLuid.Value >> 24) & 0xFFFFFF);
      if ( byte_1C00895C9 )
        WPP_SF_dd(0x5Du, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, a1->State, a1->PnPDeviceState);
    }
  }
  if ( a1->AoAc )
  ...
  {
    if ( byte_1C00895C9 )
      WPP_SF_(0x5Eu, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  }
  else
  {
    if ( byte_1C00895C9 )
      WPP_SF_(0x5Fu, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
    for ( i = a1->LowestFilter; i; i = i->HigherFilter )
    {
      if ( byte_1C00895C9 )
        WPP_SF_qqZ(96LL, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, i, i->FilterDriver, i->FilterFriendlyName);
    }
  }
  if ( a1->OpenQueue )
  {
    if ( byte_1C00895C9 )
      WPP_SF_(0x62u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  ...
  {
    WPP_SF_(0x61u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  }
