/*
 * XREFs of ndisMDeferredSend @ 0x1C00540C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSend(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_q(0x18u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, (__int64)a1);
...
LABEL_11:
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_q(0x19u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, (__int64)a1);
  return 0;
}
