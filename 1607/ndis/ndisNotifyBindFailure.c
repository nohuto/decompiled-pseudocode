/*
 * XREFs of ndisNotifyBindFailure @ 0x1C00B02F8
 * Callers:
...
void __fastcall ndisNotifyBindFailure(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 3u )
    WPP_SF_qq(0x54u, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, a1, a2);
  v4 = *(_BYTE *)(a2 + 56);
  if ( v4 > 6u || v4 == 6 && *(_BYTE *)(a2 + 57) >= 0x1Eu )
  {
    ...
    *(_DWORD *)(a2 + 428) = 0;
    ...
    if ( (unsigned __int8)byte_1C00895CD >= 3u )
      WPP_SF_qq(0x55u, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, a1, a2);
  }
}
