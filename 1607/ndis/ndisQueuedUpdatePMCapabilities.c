/*
 * XREFs of ndisQueuedUpdatePMCapabilities @ 0x1C00C9EB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisQueuedUpdatePMCapabilities(PVOID P, char *MiniportAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895D5 >= 4u )
    WPP_SF_q(0x75u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, (__int64)MiniportAdapterHandle);
      ...
      *(_DWORD *)&v6[48] = 20;
      ...
      if ( SetMiniport )
      {
        if ( (unsigned __int8)byte_1C00895D5 >= 2u )
          WPP_SF_d(0x76u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, SetMiniport);
      }
    }
  ...
  if ( (unsigned __int8)byte_1C00895D5 >= 4u )
    WPP_SF_q(0x77u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, (__int64)MiniportAdapterHandle);
}
