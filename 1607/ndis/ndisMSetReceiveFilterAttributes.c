/*
 * XREFs of ndisMSetReceiveFilterAttributes @ 0x1C00B2864
 * Callers:
 ...
 *     ndisMCheckReceiveFilterPacketCoalescingAttributes @ 0x1C00B2A54 (ndisMCheckReceiveFilterPacketCoalescingAttributes.c)
 *     ndisShouldSuppressReceiveFilterCapabilities @ 0x1C00B2A64 (ndisShouldSuppressReceiveFilterCapabilities.c)
 */
...
__int64 __fastcall ndisMSetReceiveFilterAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qq(0x79u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 16);
...
LABEL_30:
    ...
    || (unsigned __int8)ndisShouldSuppressReceiveFilterCapabilities(*(_QWORD *)(a2 + 24)) )
  {
    if ( (unsigned __int8)byte_1C00895D4 < 4u )
      return v4;
    WPP_SF_qqq(0x7Au, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, *(_QWORD *)(a2 + 16), *(_QWORD *)(a2 + 24));
    goto LABEL_21;
  }
...
LABEL_21:
  ...
  {
    LODWORD(v19) = v4;
    WPP_SF_qqd(0x7Bu, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, a2, v19);
  }
  return v4;
}
