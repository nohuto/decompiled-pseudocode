/*
 * XREFs of NdisCoDeleteVc @ 0x1C00F7F40
 * Callers:
 *     NdisMCmDeleteVc @ 0x1C00F9050 (NdisMCmDeleteVc.c)
 * Callees:
...
NDIS_STATUS __stdcall NdisCoDeleteVc(NDIS_HANDLE NdisVcHandle)
{
      ...
      if ( WnodeEventItem )
      {
        ...
        if ( v6 < 0 )
        {
          if ( (unsigned __int8)byte_1C00895D9 >= 2u )
            WPP_SF_d(0x1Cu, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, v6);
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_d(0x1Du, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, v5);
  return v5;
}
