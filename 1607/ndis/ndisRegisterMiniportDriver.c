/*
 * XREFs of ndisRegisterMiniportDriver @ 0x1C00F5618
 * Callers:
...
__int64 __fastcall ndisRegisterMiniportDriver(struct _DRIVER_OBJECT **a1, _QWORD *a2, unsigned int a3, PVOID *a4)
{
  ...
  KIRQL v17; // bl
  PVOID v18; // rcx
  PVOID DriverObjectExtension; // [rsp+50h] [rbp+30h] BYREF

  v4 = 0;
  DriverObjectExtension = 0LL;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xEu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)a1);
  if ( !a1 )
  {
    v4 = -1073741823;
    goto LABEL_36;
...
LABEL_15:
  ...
  else if ( IoAllocateDriverObjectExtension(*a1, (PVOID)0x4E4D4944, 0x4A8u, &DriverObjectExtension) >= 0 )
  {
    ...
    *((_BYTE *)DriverObjectExtension + 25) = *((_BYTE *)a2 + 1);
    ...
    if ( MmIsDriverVerifying(*a1) && (*((_WORD *)DriverObjectExtension + 13) |= 2u, (ndisFlags & 0x400) != 0) )
    {
      v13 = 0LL;
...
LABEL_36:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xFu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DriverObjectExtension);
  return v4;
}
