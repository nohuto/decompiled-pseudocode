/*
 * XREFs of ndisHandleLegacyTransport @ 0x1C00AD6B0
 * Callers:
...
__int64 __fastcall ndisHandleLegacyTransport(__int64 a1)
{
  ...
  {
    WPP_SF_q(0x2Bu, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, a1);
    v2 = byte_1C00895CC;
  }
  Context = 0LL;
...
LABEL_9:
          if ( (unsigned __int8)byte_1C00895CC >= 4u )
            WPP_SF_(0x2Du, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  ...
  if ( (unsigned __int8)v2 >= 4u )
    WPP_SF_(0x2Cu, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  return 3221225473LL;
}
