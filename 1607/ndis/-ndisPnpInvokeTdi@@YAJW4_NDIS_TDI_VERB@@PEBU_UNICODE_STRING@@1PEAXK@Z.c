/*
 * XREFs of ?ndisPnpInvokeTdi@@YAJW4_NDIS_TDI_VERB@@PEBU_UNICODE_STRING@@1PEAXK@Z @ 0x1C00CBFFC
 * Callers:
...
__int64 __fastcall ndisPnpInvokeTdi(unsigned int a1, __int64 a2, __int64 a3)
{
