/*
 * XREFs of ?ndisIfCreateCompartmentBlock@@YAJIPEAU_GUID@@PEAU_NDIS_NSI_COMPARTMENT_RW@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C001D2BC
 * Callers:
 ...
 *     ?ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z @ 0x1C00406C0 (-ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z.c)
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_dq(122LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a3);
  *a4 = 0LL;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x6C0uLL, 0x6669444Eu);
  v11 = PoolWithTag;
  if ( !PoolWithTag )
  {
    v5 = -1073741670;
