/*
 * XREFs of ndisSriovInterfaceReadVfConfigBlock @ 0x1C00DBB30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVfConfigBlock(void *a1, __int16 a2, int a3, void *a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x5Bu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qD(0x5Cu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
