/*
 * XREFs of NdisFOidRequestComplete @ 0x1C000E990
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
    *((_DWORD *)NdisReserved + 2) = Status;
           ...
           0LL) < 0 )
    {
      ...
      *((_QWORD *)NdisFilterHandle + 19) = KeGetCurrentThread();
      v15 = v14;
      *((_DWORD *)NdisFilterHandle + 40) = 2101295;
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqd(
      40LL,
      &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids,
      OidRequest,
      v9,
  ...
  if ( v9 )
  {
    *((_QWORD *)NdisReserved + 3) = 0LL;
    ...
    if ( (unsigned __int8)byte_1C00895D2 >= 4u )
      WPP_SF_qq(175LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, OidRequest->RequestHandle, OidRequest);
    if ( v13 )
    {
    ...
    if ( (unsigned __int8)byte_1C00895D2 >= 4u )
      WPP_SF_qq(176LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, RequestHandle, 0LL);
    NdisReserved = (UCHAR *)(v9 + 72);
    goto LABEL_20;
  }
  if ( (unsigned __int8)byte_1C00895D2 >= 2u )
    WPP_SF_(41LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, *(_QWORD *)&Status);
}
