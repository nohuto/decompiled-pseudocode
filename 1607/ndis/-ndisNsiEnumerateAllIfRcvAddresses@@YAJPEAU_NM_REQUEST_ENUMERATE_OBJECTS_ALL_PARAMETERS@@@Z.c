/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddresses@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C0040CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfRcvAddresses(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x60u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qD(97LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, v2);
  return v2;
}
