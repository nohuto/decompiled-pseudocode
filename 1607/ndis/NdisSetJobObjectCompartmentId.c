/*
 * XREFs of NdisSetJobObjectCompartmentId @ 0x1C00D77D4
 * Callers:
 *     ndisNsiSetAllJobInformation @ 0x1C00D79F0 (ndisNsiSetAllJobInformation.c)
 * Callees:
 ...
 *     ndisIfSetCompartmentJobObject @ 0x1C00C4B34 (ndisIfSetCompartmentJobObject.c)
 */
...
LABEL_15:
  ...
  if ( JobProperty )
  {
    v8 = JobProperty[1];
    if ( v8 )
      ndisIfSetCompartmentJobObject(v8, 0LL);
  }
  if ( v3 )
  {
    ndisIfSetCompartmentJobObject((__int64)v3, a1);
    goto LABEL_15;
  }
LABEL_17:
  if ( Object )
