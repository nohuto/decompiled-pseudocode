/*
 * XREFs of Template_xqx @ 0x1C006F4CC
 * Callers:
...
NTSTATUS Template_xqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 8LL;
  return EtwWrite(Microsoft_Windows_NDISHandle, &ComponentCsStats, a3, 3u, &UserData);
}
