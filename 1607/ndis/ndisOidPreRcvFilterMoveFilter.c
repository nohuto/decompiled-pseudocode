/*
 * XREFs of ndisOidPreRcvFilterMoveFilter @ 0x1C003DC00
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_DWORD *)(v1 + 4) == 1 )
  {
    *(_DWORD *)(a1 + 40) = 0;
    ...
    if ( !*(_DWORD *)(a1 + 40) )
    {
      if ( v3 )
      {
        if ( ndisIovNicSwitchWithoutIovSupported(v3) && *(_QWORD *)(v3 + 4744) == v7 )
          goto LABEL_14;
        if ( !ndisIovNicSwitchWithoutIovSupported(v6) )
        {
          v10 = *(_QWORD *)(v3 + 4672);
          if ( !v10 || (*(_BYTE *)(v10 + 8) & 3) != 3 || *(_QWORD *)(v3 + 4744) == v9 )
            goto LABEL_14;
        }
        v11 = *(_DWORD *)(v5 + 4);
        if ( !v11 )
