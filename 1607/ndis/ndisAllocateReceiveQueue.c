/*
 * XREFs of ndisAllocateReceiveQueue @ 0x1C003C4EC
 * Callers:
 *     ndisOidPreRcvFilterAllocateQueue @ 0x1C00C3340 (ndisOidPreRcvFilterAllocateQueue.c)
 * Callees:
 ...
 *     ndisAddReceiveQueueToList @ 0x1C003C480 (ndisAddReceiveQueueToList.c)
...
char __fastcall ndisAllocateReceiveQueue(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E0 >= 4u )
    WPP_SF_q(0xEu, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v4);
  v8 = 1096;
...
LABEL_61:
  ...
  {
    if ( v12 )
      ndisMDereferenceOpenUnlocked(v39, 0xAu);
    if ( v13 )
      ndisDereferenceMiniport(v4);
    if ( v2 )
  ...
  if ( (unsigned __int8)byte_1C00895E0 >= 4u )
    WPP_SF_qdD(15LL, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v4, *(unsigned int *)(a1 + 40), v43);
  return v7;
}
