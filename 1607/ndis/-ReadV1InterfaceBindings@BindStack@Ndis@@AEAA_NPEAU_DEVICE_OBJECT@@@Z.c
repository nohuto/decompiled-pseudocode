/*
 * XREFs of ?ReadV1InterfaceBindings@BindStack@Ndis@@AEAA_NPEAU_DEVICE_OBJECT@@@Z @ 0x1C00E372C
 * Callers:
...
char __fastcall Ndis::BindStack::ReadV1InterfaceBindings(Ndis::BindStack *this, PDEVICE_OBJECT DeviceObject)
{
  ...
  if ( (int)KRegKey::Open((KRegKey *)&Handle, 1u, (wchar_t *)L"Linkage", v4) < 0
    ...
    || (int)Ndis::BindStack::ReadV1OrV2ProtocolList(this, (struct KRegKey *)&Handle, &Ndis::UpperBindValueName) < 0 )
  {
    v3 = 0;
  }
  if ( Handle )
