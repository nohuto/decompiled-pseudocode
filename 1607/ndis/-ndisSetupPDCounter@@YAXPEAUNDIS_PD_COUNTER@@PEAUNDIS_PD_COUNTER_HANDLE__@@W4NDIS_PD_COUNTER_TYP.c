/*
 * XREFs of ?ndisSetupPDCounter@@YAXPEAUNDIS_PD_COUNTER@@PEAUNDIS_PD_COUNTER_HANDLE__@@W4NDIS_PD_COUNTER_TYPE@@PEAUNDIS_PD_ASSOCIATION@@E@Z @ 0x1C00E0DB8
 * Callers:
...
void __fastcall ndisSetupPDCounter(__int64 a1, __int64 a2, int a3, __int64 a4, char a5)
{
  ...
  _QWORD *v10; // rdx
  _QWORD *v11; // rax
  KLockThisExclusive v12; // [rsp+20h] [rbp-28h] BYREF

  *(_QWORD *)(a1 + 56) = a2;
  v7 = (struct KPushLockBase *)qword_1C0089668;
  *(_BYTE *)(a1 + 68) = a5;
  *(_DWORD *)(a1 + 64) = a3;
  *(_QWORD *)(a1 + 40) = a4;
  KLockThisExclusive::KLockThisExclusive(&v12, v7 + 1);
  v8 = *(_QWORD **)(a4 + 112);
  v9 = (_QWORD *)(a1 + 8);
  if ( *v8 != a4 + 104 )
    __fastfail(3u);
