/*
 * XREFs of ndisMSetQosAttributes @ 0x1C00D16A4
 * Callers:
...
__int64 __fastcall ndisMSetQosAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qq(0x80u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 64);
  if ( *(_BYTE *)(v5 + 1)
...
LABEL_23:
  ...
  {
    v19 = v4;
    WPP_SF_qqd(0x81u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, a2, v19);
  }
  return v4;
}
