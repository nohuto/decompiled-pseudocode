/*
 * XREFs of ?Register@MINIPORT_HOOK_DRIVER@@QEAAJPEAXPEBU_NDIS_MINIPORT_HOOK_DRIVER_PROVIDER_CHARACTERISTICS@@@Z @ 0x1C00E3DB8
 * Callers:
 *     ?ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C00B0A10 (-ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z.c)
 * Callees:
 ...
 *     ?FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ @ 0x1C00ADACC (-FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ.c)
 */
        ...
        const struct _NDIS_MINIPORT_HOOK_DRIVER_PROVIDER_CHARACTERISTICS *a3)
{
  ...
  void *v8; // rcx
  _OWORD *v9; // rax
  KLockThisExclusive v11; // [rsp+30h] [rbp-28h] BYREF
  void *ProviderDispatch; // [rsp+60h] [rbp+8h] BYREF

  KLockThisExclusive::KLockThisExclusive(&v11, &g_MiniportHookDriversLock);
  if ( *((_BYTE *)this + 1) )
  {
    v6 = -1073741768;
  }
  else
  {
    ...
    *((_QWORD *)this + 2) = a2;
    ...
    v6 = NmrClientAttachProvider(v8, v7, &off_1C0076BE0, (PVOID *)this + 3, (const void **)&ProviderDispatch);
    if ( v6 >= 0 )
    {
      v9 = ProviderDispatch;
