/*
 * XREFs of NdisCopyReceiveNetBufferListInfo @ 0x1C0026030
 * Callers:
 *     <none>
 * Callees:
 *     ndisGenerateNetBufferListCorrelationIds @ 0x1C0010AE4 (ndisGenerateNetBufferListCorrelationIds.c)
 *     NetioCopyOpaqueNetBufferListInformation @ 0x1C0010D94 (NetioCopyOpaqueNetBufferListInformation.c)
...
void __stdcall NdisCopyReceiveNetBufferListInfo(PNET_BUFFER_LIST DestNetBufferList, PNET_BUFFER_LIST SrcNetBufferList)
{
  ...
  __int64 v10; // rax
  unsigned __int8 v11; // [rsp+20h] [rbp-19h]
  const struct _GUID *v12; // [rsp+28h] [rbp-11h]
  ...
  if ( Microsoft_Windows_Networking_CorrelationEnabled )
  {
    ...
    v10 = (__int64)SrcNetBufferList->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
    v14 = (struct _GUID)((__int64)DestNetBufferList->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL);
    v13 = (struct _GUID)(unsigned __int64)v10;
    if ( Microsoft_Windows_Networking_CorrelationEnabled )
      EtwEx_tidActivityInfoTransfer(0x7FFFFFFFFFFFFFFFuLL, v9, &v14, &v13, v11, v12, 5u);
  }
}
