/*
 * XREFs of ndisAddDevice @ 0x1C00E88C0
 * Callers:
 ...
 *     NdisConvertNdisStatusToNtStatus @ 0x1C004E5A0 (NdisConvertNdisStatusToNtStatus.c)
 ...
 *     ?Initialize@BindEngine@Ndis@@QEAAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C009C1D8 (-Initialize@BindEngine@Ndis@@QEAAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 ...
 *     ndisSetDeviceNames @ 0x1C00B0290 (ndisSetDeviceNames.c)
 *     ndisMInvokeAddDevice @ 0x1C00B2F14 (ndisMInvokeAddDevice.c)
 *     ndisQueryReferenceBusInterface @ 0x1C00D3180 (ndisQueryReferenceBusInterface.c)
        ...
        _QWORD *a5)
{
  ...
  PDRIVER_OBJECT DriverObjecta; // [rsp+A8h] [rbp-58h]
  PVOID v76; // [rsp+B0h] [rbp-50h] BYREF
  _NDIS_WDF_CX_DRIVER_BLOCK *CxBlock; // [rsp+B8h] [rbp-48h]
  _QWORD *v78; // [rsp+C0h] [rbp-40h]
  const WCHAR **v79; // [rsp+C8h] [rbp-38h]
  _QWORD v80[20]; // [rsp+D0h] [rbp-30h] BYREF
  GUID InterfaceClassGuid; // [rsp+170h] [rbp+70h] BYREF
  _BYTE v82[40]; // [rsp+180h] [rbp+80h] BYREF
  _BYTE v83[64]; // [rsp+1A8h] [rbp+A8h] BYREF
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_q(0x41u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)Pdo);
...
LABEL_83:
  ...
  v19 = 4;
  v22 = (*(unsigned __int16 *)(*(_QWORD *)(a4 + 40) + 8LL) + 5907) & 0xFFFFFFF8;
  *(_DWORD *)&String.Length = 2621440;
  *(_DWORD *)&DestinationString.Length = 3932160;
  v23 = v22 + 8 * ndisMaxNumberOfProcessors;
  String.Buffer = (wchar_t *)v82;
  DestinationString.Buffer = (wchar_t *)v83;
...
LABEL_84:
  ...
  v66 = 1;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, v23, 0x4E666477u);
  if ( !PoolWithTag )
  {
    DevicePropertyData = -1073741823;
    v25 = 0LL;
...
LABEL_102:
  ...
  *((_WORD *)DeviceExtension + 2133) = DestinationString.Length + 2;
    ...
    if ( MmIsDriverVerifying(DriverObjecta) )
    {
      ...
      if ( DevicePropertyData < 0 )
      {
        if ( (unsigned __int8)byte_1C00895D4 >= 2u )
          WPP_SF_q(0x42u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DeviceExtension);
        goto LABEL_100;
      }
    }
  }
  ...
  {
    if ( (unsigned __int8)byte_1C00895D4 >= 2u )
      WPP_SF_q(0x43u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DeviceExtension);
    if ( (Microsoft_Windows_NDISEnableBits & 0x40) != 0 )
      Template_qqq((__int64)v16, &AddDeviceFailed, &NDIS_PROVIDER_ID, DevicePropertyData, 240, (char)DeviceExtension);
    goto LABEL_100;
  }
  v63 = 1;
  *((_QWORD *)DeviceExtension + 627) = 0LL;
  ...
  ndisSetDeviceNames(
    ...
    (wchar_t *)DeviceExtension + 2948);
  v35 = (unsigned __int16 **)(DeviceExtension + 3912);
  v19 = 4;
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qZ(0x44u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DeviceExtension, *v35);
...
LABEL_101:
  ...
  *((_DWORD *)DeviceExtension + 1029) = 1;
  ...
  v19 = 4;
  v38 = ndisInitializeConfiguration((__int64)v36, (__int64)DeviceExtension, *v79);
  if ( v38 )
  {
LABEL_115:
  ...
  if ( (*((_DWORD *)DeviceExtension + 30) & 0x80u) != 0 )
  {
      ...
      && (unsigned __int8)byte_1C00895E3 >= 4u )
    {
      ...
      WPP_SF_Zq(0x45u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (unsigned __int16 *)v80[1], v80[0]);
    }
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x46u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, DriverObjectExtension, DeviceExtension);
LABEL_59:
...
LABEL_60:
    ...
    {
      if ( (unsigned __int8)byte_1C00895D4 >= 2u )
        WPP_SF_q(0x47u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DeviceExtension);
      if ( (Microsoft_Windows_NDISEnableBits & 0x40) != 0 )
        Template_qqq((__int64)v16, &AddDeviceFailed, &NDIS_PROVIDER_ID, DevicePropertyData, 227, (char)DeviceExtension);
      goto LABEL_124;
    }
    v62 = 1;
  ...
  if ( DevicePropertyData < 0 )
  {
    if ( DeviceExtension )
    {
      ...
      if ( v63 )
      {
        ...
        if ( v56 && (unsigned __int8)byte_1C00895D4 >= 4u )
          WPP_SF_qD(0x48u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DeviceExtension, v56);
      }
      if ( v64 )
    ...
    *((_QWORD *)DeviceExtension + 488) = ndisMiniportList;
    ...
    if ( (unsigned __int8)byte_1C00895D0 >= 4u )
      WPP_SF_qZ(
        ...
        (__int64)DeviceExtension,
        *((unsigned __int16 **)DeviceExtension + 489));
    ndisLogMiniportEvent((__int64)DeviceExtension, 0x1Fu);
  }
  ndisDereferencePackage((__int64)&ndisPkgs);
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qD(0x4Au, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)DeviceExtension, DevicePropertyData);
