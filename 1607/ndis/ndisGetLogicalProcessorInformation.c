/*
 * XREFs of ndisGetLogicalProcessorInformation @ 0x1C01040B0
 * Callers:
...
__int64 __fastcall ndisGetLogicalProcessorInformation(__int64 a1)
{
  ...
  v2 = 0;
  v57 = WPP_MAIN_CB.Queue.ListEntry.Blink;
  v3 = 0;
  v53 = 0;
  v4 = 0;
  v61 = 0;
  ...
  {
    v48 = *(_QWORD *)&WPP_MAIN_CB.DeviceType + 3LL + 20LL * v4;
  ...
  if ( PoolWithTag )
  {
          ...
          (v12 = v11) != 0LL) )
    {
      ...
      if ( v54 >= 0 )
      {
              ...
              if ( v23.m128i_i64[0] )
              {
                do
                {
                  if ( (v26 & 1) != 0 )
                  {
                    ...
                    *(_DWORD *)(*(_QWORD *)&WPP_MAIN_CB.DeviceType + 20LL * ProcessorIndexFromNumber + 12) = v25++;
        ...
        v18 = v12;
        LODWORD(Blink[1].Flink) = v3;
        v19 = 0;
        HIDWORD(Blink->Blink) = v2;
        v62 = 0;
        if ( Length )
        {
          do
                ...
                do
                {
                  ...
                  for ( k = 0; ; ++k )
                  {
                    ...
                    if ( (v42 & 1) != 0 )
                    {
                      ...
                      *(_DWORD *)(*(_QWORD *)&WPP_MAIN_CB.DeviceType + 20 * v45 + 8) = v47;
                      k = BYTE2(ProcNumber);
                    }
                    v42 >>= 1;
                    v43 = v42 == 0;
        ...
        {
          v21 = v61;
          LODWORD(Blink[1].Blink) = v61;
          if ( i )
          {
            if ( v21 )
              HIDWORD(Blink[1].Flink) = v53 / v21;
          }
        }
        v10 = v58;
        v7 = v55;
