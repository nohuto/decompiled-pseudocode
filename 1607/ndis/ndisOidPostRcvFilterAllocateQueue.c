/*
 * XREFs of ndisOidPostRcvFilterAllocateQueue @ 0x1C003CF20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostRcvFilterAllocateQueue(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x10u, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v3, v1);
  if ( v3 )
  {
    if ( *(_DWORD *)(a1 + 40) )
    {
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(17LL, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v3, *(unsigned int *)(a1 + 40));
}
