/*
 * XREFs of ndisCoIndicateStatusInternal @ 0x1C00F97E0
 * Callers:
...
void __fastcall ndisCoIndicateStatusInternal(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_(0x3Cu, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
  v9 = a2 + 296;
  if ( !a2 )
    v9 = *(_QWORD *)(a1 + 3912);
  if ( v9 )
...
LABEL_12:
          ...
          if ( *(_BYTE *)(v21 + 56) >= 6u && *(_QWORD *)(v21 + 192) )
            ...
            (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, int *, int))(v21 + 192))(
              *(_QWORD *)(i + 32),
              ...
              Src,
              v7);
          ndisMDereferenceOpenUnlocked(i, 0x11u);
        }
      }
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_(0x3Du, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
}
