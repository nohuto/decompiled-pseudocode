/*
 * XREFs of ndisMWanSend @ 0x1C0056AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisMWanSend(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(0x1Cu, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a3);
  v9 = *(_DWORD *)(v3 + 120);
  if ( v9 < 0 )
    return 3221225473LL;
  if ( (v9 & 0x40000) == 0 )
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqd(0x1Du, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a3, v12);
  return v12;
}
