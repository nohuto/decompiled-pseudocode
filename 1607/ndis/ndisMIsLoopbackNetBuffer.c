/*
 * XREFs of ndisMIsLoopbackNetBuffer @ 0x1C0054EA8
 * Callers:
...
void __fastcall ndisMIsLoopbackNetBuffer(__int64 a1, __int64 a2, __int64 a3, char *a4, unsigned __int8 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqq(0x3Eu, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
  v11 = *(_QWORD *)(a2 + 8);
  if ( (*(_BYTE *)(v11 + 10) & 5) != 0 )
    v12 = *(char **)(v11 + 24);
  else
...
LABEL_37:
      ...
      *v13 = v5;
      ...
      {
        LODWORD(v19) = v5;
        WPP_SF_qqd(0x3Fu, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a4, v19);
      }
      return;
    }
...
LABEL_22:
    ...
    else if ( *(_DWORD *)(v14 + 2) == *(_DWORD *)(v16 + 338) && *(_WORD *)v14 == *(_WORD *)(v16 + 336) )
    {
      v7 = 1;
      v5 = 1;
    }
