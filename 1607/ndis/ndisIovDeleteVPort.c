/*
 * XREFs of ndisIovDeleteVPort @ 0x1C00683C8
 * Callers:
 *     ndisOidPostIovDeleteVPort @ 0x1C00693C0 (ndisOidPostIovDeleteVPort.c)
...
__int64 __fastcall ndisIovDeleteVPort(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qq(0x31u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, 0LL, 0LL);
  v3 = P[9];
  v4 = P[10];
  v5 = P[11];
  ...
  *(_BYTE *)((*((_DWORD *)P + 31) >> 3) + *(_QWORD *)(v3 + 4824)) &= ~(1 << (*((_BYTE *)P + 124) & 7));
  ...
  {
    v19 = 0;
    WPP_SF_qqd(0x32u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v2, v19);
  }
  return 0LL;
}
