/*
 * XREFs of ?ndisCoIndicatePromiscPacket@@YAXPEAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_PACKET@@EE@Z @ 0x1C0051E28
 * Callers:
    ...
    do
    {
      ...
      if ( (v8->OpenFlags & 4) != 0 )
      {
        ...
        else
        {
          ...
          {
            WPP_SF_(0xAu, &WPP_4308510b5fb5364aadc32f04d3b40dd6_Traceguids);
          }
        }
      }
      v8 = FilterNextOpen;
