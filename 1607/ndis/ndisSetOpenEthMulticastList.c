/*
 * XREFs of ndisSetOpenEthMulticastList @ 0x1C00AE674
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenEthMulticastList(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(0x71u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a1, a2);
  ...
  if ( IsValidMulticastFilter )
  {
    if ( (unsigned __int8)byte_1C00895D2 >= 2u )
      WPP_SF_qqq(0x72u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a1, a2);
  }
...
LABEL_41:
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqqDD(0x73u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a1, a2, IsValidMulticastFilter, v7);
