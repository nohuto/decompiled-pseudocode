/*
 * XREFs of ?ndisNsiChangeInterfaceInfo@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_NSI_INTERFACE_INFORMATION_RW@@KKPEAK@Z @ 0x1C001AA78
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qq(118LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2);
...
LABEL_14:
  ...
  *(_DWORD *)&ifL2NetworkInfo->Length = v16;
  if ( !v16 )
    v9 = -1073741811;
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqd(119LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, v9);
  return v9;
}
