/*
 * XREFs of ndisGetPortList @ 0x1C0017F28
 * Callers:
...
__int64 __fastcall ndisGetPortList(__int64 a1, _QWORD *a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895DE >= 4u )
    WPP_SF_q(36LL, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, a1);
  *a2 = 0LL;
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( !v4 )
    *a2 = v7;
  if ( (unsigned __int8)byte_1C00895DE >= 4u )
    WPP_SF_qD(37LL, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, a1, v4);
  return v4;
}
