/*
 * XREFs of ndisOidPreIovDeleteNicSwitch @ 0x1C00D9BF0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovDeleteNicSwitch(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qqqq(0x10u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v1, a1[3], a1[1], v3);
  if ( !*a1 )
    goto LABEL_4;
...
LABEL_8:
  ...
  {
    LODWORD(v10) = v4;
    WPP_SF_qqqDD(0x11u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, *a1, a1[3], a1[1], v10, *((_DWORD *)a1 + 10));
  }
  return v4;
}
