/*
 * XREFs of ndisIfQueryBindingMiniportIfIndex @ 0x1C00A398C
 * Callers:
...
__int64 __fastcall ndisIfQueryBindingMiniportIfIndex(__int64 a1, _DWORD *a2, _QWORD *a3, _DWORD *a4, _QWORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x30u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1);
  *a2 = 0;
  *a3 = 0LL;
  *a4 = 0;
  *a5 = 0LL;
  ...
  *a3 = v11;
    ...
    && ndisReferenceMiniportByHandle(v13, 0, 0x3Eu) )
  {
    ...
    *a5 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 4080LL);
    ndisDereferenceMiniport(*(_QWORD *)(a1 + 16));
  }
  else
  {
    *a4 = *(_DWORD *)(a1 + 4112);
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x31u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1);
  return 0LL;
}
