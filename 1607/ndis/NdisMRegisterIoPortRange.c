/*
 * XREFs of NdisMRegisterIoPortRange @ 0x1C00D26A0
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT NumberOfPorts)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x14u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)MiniportAdapterHandle);
...
LABEL_4:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x15u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)MiniportAdapterHandle, v4);
  return v4;
}
