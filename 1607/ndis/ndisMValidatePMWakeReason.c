/*
 * XREFs of ndisMValidatePMWakeReason @ 0x1C004980C
 * Callers:
...
char __fastcall ndisMValidatePMWakeReason(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 4528) = *(_DWORD *)(v5 + 8);
  ...
  if ( (unsigned __int8)byte_1C00895D0 >= 4u )
    WPP_SF_LqZ(0x8Au, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, *(_DWORD *)(v5 + 8), a1, *(_QWORD *)(a1 + 3912));
  if ( *(_BYTE *)v5 != 0x80
    || *(_BYTE *)(v5 + 1) != 1
    ...
    || v10 + (int)v9 > (unsigned int)v8 )
  {
    ...
    v13 = 140;
LABEL_33:
    WPP_SF_q(v13, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1);
    return 0;
  }
  v11 = *(_DWORD *)(v5 + 8);
  if ( v11 == 1 )
