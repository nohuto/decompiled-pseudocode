/*
 * XREFs of ?ndisNsiGetInterfaceRodInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0099D60
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0x4Cu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, v5);
    v4 = v24;
    v7 = a2;
    v6 = a1;
  }
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqqL(0x4Du, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, v6, v7, v5, v3);
  return v3;
}
