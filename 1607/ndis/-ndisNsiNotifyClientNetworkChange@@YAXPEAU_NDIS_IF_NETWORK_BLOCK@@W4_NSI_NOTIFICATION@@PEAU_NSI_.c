/*
 * XREFs of ?ndisNsiNotifyClientNetworkChange@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@W4_NSI_NOTIFICATION@@PEAU_NSI_SINGLE_PARAM_DESC@@@Z @ 0x1C00C42B4
 * Callers:
...
void __fastcall ndisNsiNotifyClientNetworkChange(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( ndisIsCompartmentEnumerable(*(struct _NDIS_IF_COMPARTMENT_BLOCK **)(a1 + 48)) )
  {
    if ( (unsigned __int8)byte_1C00895DD >= 4u )
      WPP_SF_qD(0x92u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, v6);
    ...
    *(_QWORD *)&v8[1] = a1 + 32;
    ...
    (*(void (__fastcall **)(_OWORD *))(qword_1C0088D88 + 8))(v8);
    if ( (unsigned __int8)byte_1C00895DD >= 4u )
      WPP_SF_qD(0x93u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2);
  }
}
