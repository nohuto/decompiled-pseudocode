/*
 * XREFs of NdisIMQueueMiniportCallback @ 0x1C005C5D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( KeGetCurrentThread() == (struct _KTHREAD *)MiniportAdapterHandle[65] )
  {
    ...
    *((_DWORD *)MiniportAdapterHandle + 464) = 723973;
LABEL_5:
    ...
    *((_DWORD *)MiniportAdapterHandle + 464) = 0;
    ...
    MiniportAdapterHandle[65] = KeGetCurrentThread();
    *((_DWORD *)MiniportAdapterHandle + 464) = 723991;
  ...
  KeAcquireSpinLockAtDpcLevel(v6);
  MiniportAdapterHandle[65] = KeGetCurrentThread();
  *((_DWORD *)MiniportAdapterHandle + 464) = 723978;
  if ( !*((_BYTE *)MiniportAdapterHandle + 89) )
  {
    *((_BYTE *)MiniportAdapterHandle + 89) = 1;
    *((_DWORD *)MiniportAdapterHandle + 465) = 723979;
