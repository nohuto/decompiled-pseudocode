/*
 * XREFs of ndisSendPacketsWithPause @ 0x1C0056E90
 * Callers:
...
void __fastcall ndisSendPacketsWithPause(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqd(0x30u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
...
LABEL_37:
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
  {
    ...
    WPP_SF_qqd(0x31u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, v4, BugCheckOnFailure);
  }
}
