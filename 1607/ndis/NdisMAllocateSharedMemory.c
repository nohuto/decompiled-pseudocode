/*
 * XREFs of NdisMAllocateSharedMemory @ 0x1C00B1950
 * Callers:
        ...
        PNDIS_PHYSICAL_ADDRESS PhysicalAddress)
{
  ...
  {
    WPP_SF_qD(0x1Cu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)MiniportAdapterHandle, Length);
    v9 = byte_1C00895DC;
    Cached = v19;
  }
...
LABEL_14:
        ...
        if ( (unsigned __int8)byte_1C00895DC >= 4u )
          WPP_SF_qLq(0x1Fu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)MiniportAdapterHandle, v12);
        return;
      }
      *(_DWORD *)(v16 + 4092) = 0;
  ...
  *VirtualAddress = 0LL;
  if ( (unsigned __int8)v9 >= 4u )
    WPP_SF_qD(0x1Du, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)MiniportAdapterHandle, v7);
}
