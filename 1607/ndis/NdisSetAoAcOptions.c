/*
 * XREFs of NdisSetAoAcOptions @ 0x1C00DD150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisSetAoAcOptions(__int64 a1, char a2)
{
  ...
  {
    WPP_SF_qD(0x25u, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, a1, a2);
    v5 = byte_1C00895D5;
  }
  if ( *(_QWORD *)(v2 + 4520) )
  {
    ...
    *(_DWORD *)(v4 + 276) = v7;
    if ( (unsigned __int8)v5 >= 4u )
      WPP_SF_d(0x27u, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, v7);
    return 0LL;
  }
  else
  {
    if ( (unsigned __int8)v5 >= 3u )
      WPP_SF_(0x26u, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids);
    return 3221225659LL;
  }
}
