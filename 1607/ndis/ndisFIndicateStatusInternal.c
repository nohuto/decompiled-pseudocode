/*
 * XREFs of ndisFIndicateStatusInternal @ 0x1C00156C0
 * Callers:
 *     ndisFIndicateStatusWrapper @ 0x1C00156B0 (ndisFIndicateStatusWrapper.c)
 ...
 *     ndisIfUpdateL2MtuSize @ 0x1C0043D58 (ndisIfUpdateL2MtuSize.c)
...
void __fastcall ndisFIndicateStatusInternal(__int64 a1, __int64 a2)
{
  ...
  BOOL v30; // [rsp+24h] [rbp-4Ch]
  unsigned int v31; // [rsp+28h] [rbp-48h]
    ...
    *(_DWORD *)(a1 + 160) = 0;
    ...
    if ( HigherFilterWithPnpRef )
    {
      ...
      *(_DWORD *)(v13 + 160) = 0;
      ...
      if ( v4 == 1073872902 )
      {
        v24 = ndisFIndicateOffloadChange(v13, v7, v16);
      }
      else
      {
        if ( v4 == 1073938515 )
          ndisFilterIndicatePMCapabilities(v13, a2, v16);
        if ( v4 == 1073938513 )
        {
          v24 = ndisFilterIndicateWoLPatternReject(v13, a2, v16);
        }
        else
        {
          if ( v4 != 1073938514 )
            goto LABEL_20;
          v24 = ndisFilterIndicatePMOffloadReject(v13, a2, v16);
        }
      }
      if ( !v24 )
      {
...
LABEL_20:
      ndisFIndicateStatusToFilter(v13, a2, v16);
      if ( v30 )
