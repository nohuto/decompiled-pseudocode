/*
 * XREFs of NdisFRegisterFilterDriver @ 0x1C00141F0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisFilterDriverHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(
      10LL,
      &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids,
      DriverObject,
  ...
  if ( (_BYTE)v8 )
  {
      ...
      || FilterDriverCharacteristics->Header.Size < 0xE0u )
    {
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_(11LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, v9);
...
LABEL_66:
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_q(12LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
    FilterDriverRegistry = -1073676284;
...
LABEL_23:
    ...
    && FilterDriverCharacteristics->PauseHandler )
  {
    ...
    {
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_q(14LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
      FilterDriverRegistry = -1073676283;
      if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
        Template_zq(
          v17,
    ...
    else
    {
      ...
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_q(15LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
        FilterDriverRegistry = -1073676283;
        if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
          Template_zq(
            v17,
      ...
      if ( MinorNdisVersion )
      {
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(16LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
          FilterDriverRegistry = -1073676283;
          if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
            Template_zq(
              v17,
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(17LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
          FilterDriverRegistry = -1073676283;
          if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
            Template_zq(
              v17,
      ...
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_q(18LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
        FilterDriverRegistry = -1073676283;
        if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
          Template_zq(
            v17,
      ...
      else
      {
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_d(19LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, v20);
          FilterDriverRegistry = -1073741811;
        }
        else
        {
          v22 = FilterDriverCharacteristics->FriendlyName.Length + FilterDriverCharacteristics->UniqueName.Length;
          v23 = v22 + p_ServiceName->Length + 488;
          if ( v23 <= 0xFFFF )
          {
            ...
            *(_WORD *)&v4->Header.Type = 260;
            ...
            if ( Size < 0xE0u )
              v11 = Size;
            memmove(&v4->DefaultFilterCharacteristics, FilterDriverCharacteristics, v11);
            ...
            else
            {
              ...
              if ( v4->Bind._p )
              {
                ...
                *v44 = v4;
                ...
                if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                  WPP_SF_d(23LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, v42);
                *v37 = 0LL;
LABEL_110:
                if ( !FilterDriverRegistry )
                  goto LABEL_53;
              ...
              if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                WPP_SF__guid_(22LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, &Guid);
            }
...
LABEL_111:
          ...
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(20LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
          FilterDriverRegistry = -1073741811;
          if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
            Template_zq(
              v22,
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_q(13LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, DriverObject);
    FilterDriverRegistry = -1073676283;
    if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
    {
...
LABEL_53:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_d(24LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, FilterDriverRegistry);
