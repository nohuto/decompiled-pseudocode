/*
 * XREFs of ?ndisNsiGetIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0041490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetIfRcvAddress(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x5Cu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, (__int64)a1);
...
LABEL_19:
  ...
  v11 = ndisIfReferenceMiniport((__int64)InterfaceByNetLuid, 4u);
  if ( !v11 )
  {
    IfRcvAddressRodInformation = 0;
    goto LABEL_40;
...
LABEL_42:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qD(93LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, (unsigned int)IfRcvAddressRodInformation);
