/*
 * XREFs of NdisDeregisterDeviceEx @ 0x1C005F070
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisDeregisterDeviceEx(NDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x68u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)NdisDeviceHandle);
...
LABEL_23:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x69u, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)NdisDeviceHandle);
}
