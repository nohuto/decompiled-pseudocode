/*
 * XREFs of ndisQueryCustomGuids @ 0x1C00AB924
 * Callers:
...
__int64 __fastcall ndisQueryCustomGuids(__int64 a1, struct _NDIS_OID_REQUEST *a2, _QWORD *a3, unsigned __int16 *a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895D9 >= 4u )
    WPP_SF_q(0xDu, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, a1);
  *v5 = 0LL;
  *a4 = 0;
  memset(a2, 0, 0xF8uLL);
      ...
      if ( MethodId / 0x1Cu )
      {
        ...
        if ( !PoolWithTag )
        {
          if ( (unsigned __int8)byte_1C00895D9 >= 2u )
            WPP_SF_q(0xFu, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, a1);
          v10 = -1073741670;
          goto LABEL_7;
        }
        ...
        {
          if ( (unsigned __int8)byte_1C00895D9 >= 2u )
            WPP_SF_q(0x10u, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, a1);
        }
        else
        {
...
LABEL_25:
  ...
  if ( (unsigned __int8)byte_1C00895D9 >= 4u )
    WPP_SF_q(0xEu, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, a1);
  v10 = -1073741637;
LABEL_7:
  if ( (unsigned __int8)byte_1C00895D9 >= 4u )
    WPP_SF_qD(0x11u, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, a1, v10);
