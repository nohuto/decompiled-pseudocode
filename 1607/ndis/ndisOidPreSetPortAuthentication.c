/*
 * XREFs of ndisOidPreSetPortAuthentication @ 0x1C00475D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreSetPortAuthentication(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0xBBu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, *(_DWORD *)(v2 + 8));
  if ( *(_QWORD *)a1 )
  {
        ...
        if ( (*(_DWORD *)(v1 + 124) & 0x8000000) != 0 )
        {
          ...
          *(_DWORD *)(v6 + 1856) = 2307272;
          if ( (v9 & 0x80u) == 0 )
          {
            ...
            *(_DWORD *)(v6 + 3376) = v5[3];
            *(_DWORD *)(v6 + 3380) = v5[4];
            ndisIfSetInterfaceState((struct _NDIS_MINIPORT_BLOCK *)v6, v7, v8);
            v8 = v13;
          }
          *(_QWORD *)(v6 + 520) = 0LL;
          *(_DWORD *)(v6 + 1856) = 0;
...
LABEL_17:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0xBCu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, *(_DWORD *)(v2 + 8));
  return v3;
}
