 ...
 *     nullDeleteFilterOpenAdapter @ 0x1C001EE00 (nullDeleteFilterOpenAdapter.c)
...
void __fastcall ndisMKillOpen(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_q(0xAu, &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids, a1);
  ...
  *(_DWORD *)(v1 + 1856) = 0;
    ...
    else
    {
      ...
      *(_QWORD *)(v1 + 1864) = KeGetCurrentThread();
      ...
      if ( !*(_DWORD *)(v1 + 464) && (*(_DWORD *)(v1 + 124) & 0x4010) == 0 )
        ndisMRestoreFilterSettings(v1, a1, 0);
      *(_BYTE *)(v1 + 89) = 0;
      *(_DWORD *)(v1 + 1860) = 0;
      *(_QWORD *)(v1 + 1864) = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_q(0xBu, &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids, a1);
  KeLowerIrql(v3);
