/*
 * XREFs of ndisOidPreIovGetVFVendorDeviceId @ 0x1C00D9FC0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovGetVFVendorDeviceId(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x47u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
    v4 = byte_1C00895E1;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
...
LABEL_15:
  ...
  {
    v8 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x48u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v5, v8);
  }
  return v5;
}
