/*
 * XREFs of ndisMNotifyMachineName @ 0x1C00AF9AC
 * Callers:
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( v3 >= 0 && (_DWORD)Context == 1 )
  {
    ...
    if ( DestinationString.Buffer )
    {
      ...
      {
        WPP_SF_qD(0x67u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1, DestinationString.MaximumLength);
      }
    }
    else if ( (unsigned __int8)byte_1C00895D2 >= 2u )
    {
      WPP_SF_(0x66u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids);
    }
  }
  else if ( (unsigned __int8)byte_1C00895D2 >= 2u )
  {
