/*
 * XREFs of ?NdisTraceLoggingChecksumConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C00227B8
 * Callers:
...
void __fastcall NdisTraceLoggingChecksumConfigOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( (unsigned int)dword_1C0088010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v32 = (char)v14;
      v83 = 1LL;
      TlgWrite(v14, &unk_1C0078F27, v3, (LPCGUID)v4, 0x19u, &pData);
    }
  }
}
