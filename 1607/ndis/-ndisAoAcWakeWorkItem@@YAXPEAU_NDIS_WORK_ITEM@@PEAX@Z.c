/*
 * XREFs of ?ndisAoAcWakeWorkItem@@YAXPEAU_NDIS_WORK_ITEM@@PEAX@Z @ 0x1C006D730
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisAoAcWakeWorkItem(struct _NDIS_WORK_ITEM *a1, struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( (unsigned __int8)byte_1C00895D5 >= 4u )
      WPP_SF_qD(0x1Cu, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, (__int64)a2, AoAc->ActiveRef);
    KeReleaseSpinLock(&AoAc->Lock, v6);
    v8 = ndisRequestDevicePowerD0(a2, AoAc->WakeWorkItemWakeReason);
    if ( v8 != 259 )
    {
      NdisUnexpectedAoAcError(a2, 0x668u);
      if ( (unsigned __int8)byte_1C00895D5 >= 2u )
        WPP_SF_dq(0x1Du, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, v8, a2);
    }
  }
  else
  {
