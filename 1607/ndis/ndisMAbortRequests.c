/*
 * XREFs of ndisMAbortRequests @ 0x1C001BE34
 * Callers:
...
void __fastcall ndisMAbortRequests(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(63LL, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
  if ( *(_BYTE *)(a1 + 32) < 6u )
  {
    *(_DWORD *)(a1 + 4484) &= ~2u;
    if ( *(_QWORD *)(a1 + 2216) || *(_QWORD *)(a1 + 2200) != a1 + 2200 )
    {
      ...
      {
        if ( (unsigned __int8)byte_1C00895D2 >= 4u )
          WPP_SF_q(64LL, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
        v3 = *v2;
        v4 = **v2;
      ...
      if ( v23 != (__int64 *)&v23 )
      {
        ...
        *(_DWORD *)(a1 + 1856) = 0;
        ...
        while ( 1 )
        {
          ...
          v25[0] = a1;
          if ( (unsigned __int8)byte_1C00895D2 >= 4u )
            WPP_SF_qq(65LL, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, v9);
      ...
      if ( v18 )
      {
        ...
        *(_DWORD *)(a1 + 1856) = 0;
        ...
        KeAcquireSpinLockAtDpcLevel((PKSPIN_LOCK)(a1 + 96));
        *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
        *(_DWORD *)(a1 + 1856) = 725891;
      }
    }
  }
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(66LL, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
}
