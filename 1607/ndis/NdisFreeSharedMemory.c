/*
 * XREFs of NdisFreeSharedMemory @ 0x1C004B990
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisFreeSharedMemory(NDIS_HANDLE NdisHandle, NDIS_HANDLE AllocationHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895DC >= 4u )
    WPP_SF_q(0x17u, &WPP_27989bf75f273fb4647da878cf4d879f_Traceguids, (__int64)AllocationHandle);
  if ( NdisHandle )
  {
...
LABEL_28:
  if ( (unsigned __int8)byte_1C00895DC >= 4u )
    WPP_SF_(0x18u, &WPP_27989bf75f273fb4647da878cf4d879f_Traceguids);
}
