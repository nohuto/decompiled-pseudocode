/*
 * XREFs of ndisOidPreRemovePMProtocolOffload @ 0x1C00C9260
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisFindPatternEntry @ 0x1C00C82B0 (ndisFindPatternEntry.c)
 */
...
char __fastcall ndisOidPreRemovePMProtocolOffload(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x68u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v5, v1);
    v6 = byte_1C00895D2;
  }
  v7 = *(_QWORD *)(a1 + 24);
...
LABEL_36:
  ...
  *(_DWORD *)(v1 + 56) = 0;
  ...
  if ( v17 )
  {
    if ( (v11 & *(_DWORD *)(v1 + 88)) == 0 && !ndisFindPatternEntry((__int64 **)(v17 + 864), v16) )
      goto LABEL_35;
  }
  if ( !*(_QWORD *)a1 )
    goto LABEL_37;
...
LABEL_37:
  if ( (unsigned __int8)v6 >= 4u )
    WPP_SF_qD(0x69u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v4;
}
