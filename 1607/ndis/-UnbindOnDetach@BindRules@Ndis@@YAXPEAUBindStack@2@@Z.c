/*
 * XREFs of ?UnbindOnDetach@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00A5B6C
 * Callers:
...
void __fastcall Ndis::BindRules::UnbindOnDetach(Ndis::BindRules *this, struct Ndis::BindStack *a2)
{
  ...
  unsigned __int16 *v22; // [rsp+30h] [rbp-71h]
      ...
      if ( v3 )
      {
          ...
          && (unsigned __int8)byte_1C00895E3 >= 4u )
        {
          ...
          if ( (unsigned __int8)byte_1C00895E3 >= 4u )
          {
            v17 = 54;
LABEL_34:
            WPP_SF_Zq(v17, &WPP_339be45e8b703252d0c5449fb14c5e43_Traceguids, v22, v21);
          }
        }
      }
      else
    ...
    else
    {
      ...
      *(_DWORD *)(v14 + 48) = v15 & 0xFFFFFBFF;
      ...
      if ( v16 && (unsigned __int8)byte_1C00895E3 >= 4u )
      {
        ...
        v20 = 56;
LABEL_48:
        WPP_SF_Zq(v20, &WPP_339be45e8b703252d0c5449fb14c5e43_Traceguids, v22, v21);
        continue;
      }
    }
  }
