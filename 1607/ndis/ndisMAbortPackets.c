/*
 * XREFs of ndisMAbortPackets @ 0x1C001BE8C
 * Callers:
...
__int64 **__fastcall ndisMAbortPackets(__int64 a1, __int64 a2, struct _NDIS_STACK_RESERVED *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(67LL, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, 0LL);
  v4 = *(_QWORD **)(a1 + 832);
  if ( v4 )
  {
    *(_QWORD *)(a1 + 832) = *v4;
  ...
  *(_QWORD *)(a1 + 144) = 0LL;
  while ( 1 )
  {
    ...
    *(_DWORD *)(a1 + 1856) = 726091;
  }
  *(_DWORD *)(a1 + 120) |= 0x400000u;
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    return (__int64 **)WPP_SF_qq(68LL, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, 0LL);
  return result;
}
