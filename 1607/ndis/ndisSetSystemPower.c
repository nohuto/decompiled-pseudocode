/*
 * XREFs of ndisSetSystemPower @ 0x1C009C3F4
 * Callers:
...
NTSTATUS __fastcall ndisSetSystemPower(_IO_STATUS_BLOCK *Context, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(a3 + 1332) = v3;
  ...
  if ( (unsigned __int8)byte_1C00895D0 >= 4u )
    WPP_SF_LqZ(0x5Bu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, v3, a3, *(_QWORD *)(a3 + 3912));
  if ( *(_DWORD *)(a3 + 2256) != 1 || *(_DWORD *)(a3 + 1520) == 1 )
  {
    if ( v3 == 1 )
    {
      if ( (*(_DWORD *)(a3 + 124) & 0x800) == 0 )
      {
        if ( (unsigned __int8)byte_1C00895D5 >= 3u )
          WPP_SF_q(0x5Du, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, a3);
      ...
      if ( (unsigned __int8)byte_1C00895D5 >= 4u )
        WPP_SF_q(0x5Eu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, a3);
    ...
    else
    {
      ...
      if ( v3 > 5 )
      {
        ...
        {
          if ( (unsigned __int8)byte_1C00895D5 >= 4u )
            WPP_SF_qD(0x5Cu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, a3, 6);
          if ( (Microsoft_Windows_NDISEnableBits & 0x4000000) != 0 )
            Template_jqxqq(
              (__int64)Context,
      ...
      if ( (unsigned __int8)byte_1C00895D5 >= 4u )
      {
        ...
        WPP_SF_qdD(0x5Fu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, a3, v3, Timeout);
      }
      if ( (Microsoft_Windows_NDISEnableBits & 0x4000000) != 0 )
        Template_jqxqq(
          v8,
