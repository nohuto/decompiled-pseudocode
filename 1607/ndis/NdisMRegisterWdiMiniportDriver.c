/*
 * XREFs of NdisMRegisterWdiMiniportDriver @ 0x1C00E3B60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisMpHookGetHook@@YA?AV?$KRundownPtr@$$CBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@@@W4_NDIS_MINIPORT_HOOK_DRIVER_TYPE@@@Z @ 0x1C00E3E90 (-ndisMpHookGetHook@@YA-AV-$KRundownPtr@$$CBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@@@W4_NDIS_MINIPORT.c)
 */
        ...
        NDIS_MINIPORT_DRIVER_HANDLE *NdisMiniportDriverHandle)
{
  ...
  *NdisMiniportDriverHandle = 0LL;
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, 0x98uLL, 0x6843704Du);
  if ( !PoolWithTag )
  {
    v12 = -1073741670;
    goto LABEL_17;
