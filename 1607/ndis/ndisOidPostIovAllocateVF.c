/*
 * XREFs of ndisOidPostIovAllocateVF @ 0x1C0068DB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovAllocateVF(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qq(0x21u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 144);
    if ( *((_DWORD *)a1 + 10) )
...
LABEL_14:
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qq(0x22u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
}
