/*
 * XREFs of ndisMCommonHaltMiniport @ 0x1C00EB5E4
 * Callers:
...
void __fastcall ndisMCommonHaltMiniport(ULONG_PTR BugCheckParameter2, __int16 a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x1Bu, &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids, BugCheckParameter2);
  ...
  *(_DWORD *)(BugCheckParameter2 + 1856) = 1442906;
  ...
  if ( (unsigned __int8)byte_1C00895D0 >= 4u )
    WPP_SF_LqZ(
      0x1Cu,
      &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids,
      v7,
      BugCheckParameter2,
  ...
  *(_DWORD *)(BugCheckParameter2 + 124) &= ~0x80000u;
  ...
  v40 = *(struct _NDIS_PD_BLOCK **)(BugCheckParameter2 + 5664);
  if ( v40 )
...
LABEL_155:
  ...
  *(_QWORD *)(BugCheckParameter2 + 24) = 0LL;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x1Du, &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids, BugCheckParameter2);
}
