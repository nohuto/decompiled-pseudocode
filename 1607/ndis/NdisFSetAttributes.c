/*
 * XREFs of NdisFSetAttributes @ 0x1C001A440
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_FILTER_ATTRIBUTES FilterAttributes)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(33LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, NdisFilterHandle);
  ...
  *(_DWORD *)(v3 + 1856) = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(34LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, NdisFilterHandle);
  return 0;
}
