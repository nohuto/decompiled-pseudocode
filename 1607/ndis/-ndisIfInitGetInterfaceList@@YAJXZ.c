/*
 * XREFs of ?ndisIfInitGetInterfaceList@@YAJXZ @ 0x1C00C3974
 * Callers:
...
__int64 ndisIfInitGetInterfaceList(void)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_(0xA7u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids);
        ...
        for ( i = v12[7]; v5 < LODWORD(v12[13]); ++v5 )
        {
          ...
          if ( *(_BYTE *)v8 == 0xAE && *(_BYTE *)(v8 + 1) && *(_WORD *)(v8 + 2) >= 0x484u )
          {
            if ( (*(_DWORD *)(v8 + 1084) & 1) != 0 )
            {
              ...
              if ( (unsigned __int8)byte_1C00895DD >= 4u )
                WPP_SF_dd(0xA8u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, v9, v10);
...
LABEL_26:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_d(0xA9u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, InterfaceFromPersistentStore);
