/*
 * XREFs of NdisMSendComplete @ 0x1C0053400
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMSendComplete(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqd(0x10u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(0x11u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2);
}
