/*
 * XREFs of NdisCmCloseCallComplete @ 0x1C00F6A60
 * Callers:
...
void __stdcall NdisCmCloseCallComplete(NDIS_STATUS Status, NDIS_HANDLE NdisVcHandle, NDIS_HANDLE NdisPartyHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_LqDLqD(0x29u, (__int64)NdisVcHandle, Status, (__int64)NdisVcHandle);
  ...
  *((_DWORD *)NdisVcHandle + 1) &= 0xFFFFFF9F;
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_q(0x2Au, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, (__int64)NdisVcHandle);
}
