/*
 * XREFs of ndisIfReadInterfaceAddDeviceParameters @ 0x1C00AAE98
 * Callers:
...
__int64 __fastcall ndisIfReadInterfaceAddDeviceParameters(unsigned int *a1)
{
  ...
  {
    v18 = 0;
    if ( KRegKey::QueryValueUlong((KRegKey *)&Handle, (wchar_t *)L"NetLuidIndex", &v18) < 0
      || (v17 = 0, KRegKey::QueryValueUlong((KRegKey *)&Handle, (wchar_t *)L"IfType", &v17) < 0)
      || (v3 = v18,
          *((_WORD *)a1 + 11) = v17,
          *((_QWORD *)a1 + 2) = *((_QWORD *)a1 + 2) & 0xFFFF000000000000uLL | ((unsigned __int64)(v3 & 0xFFFFFF) << 24),
    ...
    else
    {
      ...
      if ( v2 >= 0 )
      {
        v4 = Rtl::KString::Initialize(Dest);
        KPtr<Rtl::KString,KDeletePtr<Rtl::KString>>::reset((void **)a1 + 5, v4);
        if ( *((_QWORD *)a1 + 5) )
          v2 = 0;
        else
          v2 = -1073741670;
