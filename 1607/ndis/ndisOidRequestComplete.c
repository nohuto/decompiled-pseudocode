/*
 * XREFs of ndisOidRequestComplete @ 0x1C000BB40
 * Callers:
...
LABEL_22:
  ...
  {
    v23 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_1C0075330 + 3 * *(unsigned int *)(v4 + 92));
    if ( v23 )
      v23(a1);
  }
  v24 = *(_QWORD *)a1;
  ...
  else if ( (v25 & 2) != 0 )
  {
    if ( (v25 & 0x100) != 0 )
    {
      ...
      *(_DWORD *)(v61 + 1856) = 2296880;
      if ( v26 && (*(_DWORD *)(v61 + 120) & 0x200000) != 0 )
      {
        v63 = *(_DWORD *)(a1 + 40);
        if ( v63 && v63 != -1073676276 && (unsigned __int8)byte_1C00895D2 >= 3u )
          WPP_SF_qdD(
            43LL,
    ...
    *(_DWORD *)(v27 + 1856) = 2296937;
    if ( !v11 )
    {
      *(_DWORD *)(v27 + 4484) &= ~2u;
      ...
      {
        if ( (unsigned __int8)byte_1C00895D2 >= 4u )
          WPP_SF_q(44LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v27);
...
LABEL_90:
  ...
  {
    if ( (unsigned __int8)byte_1C00895D2 >= 4u )
      WPP_SF_qq(45LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, *(_QWORD *)(a1 + 32), v8);
    if ( (Microsoft_Windows_NDISEnableBits & 0x4000) != 0 )
      Template_jqxqqq(
        *(_QWORD *)(a1 + 32),
    ...
    else
    {
      ...
      v42 = *(_DWORD *)(v39 + 32);
      if ( (unsigned __int8)byte_1C00895D2 >= 4u )
        WPP_SF_qLqL(123LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, v8, v42, v39, *(_DWORD *)(a1 + 40));
      (*(void (__fastcall **)(_QWORD, __int64, _QWORD, __int64))(v41 + 256))(*((_QWORD *)v8 + 3), v39, v40, a4);
      if ( (unsigned __int8)byte_1C00895D2 >= 4u )
        WPP_SF_qLq(124LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, v8, v42, v39);
    }
  }
  result = 0LL;
  *(_QWORD *)(a1 + 32) = 0LL;
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
  {
    ...
    if ( !*(_QWORD *)a1 )
      v68 = *(_QWORD *)(a1 + 16);
    return WPP_SF_qqq(46LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v68, v72, *(_QWORD *)(a1 + 24));
  }
  return result;
}
