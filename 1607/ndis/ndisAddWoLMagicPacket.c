/*
 * XREFs of ndisAddWoLMagicPacket @ 0x1C0025504
 * Callers:
...
__int64 __fastcall ndisAddWoLMagicPacket(KSPIN_LOCK *MiniportAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(84LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, MiniportAdapterHandle);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 2758172;
  while ( v5 )
  {
    v3 = v5;
    if ( *(_DWORD *)(v5 + 60) == 2 )
    ...
    *(_DWORD *)&Request.NdisReserved[16] |= 0x100008u;
    ...
    if ( v6 )
    {
      if ( (unsigned __int8)byte_1C00895D5 >= 2u )
        WPP_SF_d(85LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v6);
    }
  }
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(86LL, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, MiniportAdapterHandle, v2);
  return v2;
}
