/*
 * XREFs of ndisSetEnableWakeUp @ 0x1C00CA77C
 * Callers:
 *     ndisOidPreEnableWakeUp @ 0x1C00C8A00 (ndisOidPreEnableWakeUp.c)
 * Callees:
...
unsigned __int8 __fastcall ndisSetEnableWakeUp(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(0xCu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v5, v1, v3);
  *(_DWORD *)(a1 + 40) = 0;
  if ( v3[12] < 4u )
  {
    v3[14] = 4;
...
LABEL_7:
  ...
  if ( *(_QWORD *)(a1 + 24) )
  {
    ...
    *(_DWORD *)(a1 + 40) = v7;
    ...
    {
      if ( (unsigned __int8)byte_1C00895D2 >= 4u )
        WPP_SF_(0xDu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids);
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 40) = v11;
      ...
      {
        if ( (unsigned __int8)byte_1C00895D2 >= 4u )
          WPP_SF_qqq(0xEu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v5, v1, v3);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10) != 0 )
          Template_jqxtpp(
            v13,
            v12,
...
LABEL_8:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(0xFu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v5, v1, v3);
  return v2;
}
