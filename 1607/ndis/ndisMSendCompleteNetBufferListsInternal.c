/*
 * XREFs of ndisMSendCompleteNetBufferListsInternal @ 0x1C0002270
 * Callers:
...
void __fastcall ndisMSendCompleteNetBufferListsInternal(__int64 a1, struct _NET_BUFFER_LIST *a2, unsigned int a3)
{
  ...
  _SLIST_HEADER *v43; // [rsp+68h] [rbp-1h]
  __int64 v44; // [rsp+70h] [rbp+7h]
  struct _NET_BUFFER_LIST *v45; // [rsp+78h] [rbp+Fh]
  ...
  {
    WPP_SF_qq(68LL, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2);
    LOBYTE(a3) = v48;
    p_Alignment = 0LL;
    v3 = 0LL;
  }
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      {
        FirstNetBuffer = ($9AA51D7C58828BF91589D7C4AE47BC25 *)v11->FirstNetBuffer;
        v34 = 0;
        v40 = 0;
        if ( FirstNetBuffer )
        {
  ...
  if ( v7 )
    ndisMSendCompleteNetBufferListsToOpen(v7, v45, v15, &v41);
  if ( (v41.DatapathEventsMask & 0x200) != 0 )
    ndisPcwAddEvent(&v41, 9uLL, v40);
  if ( v9 != 2 )
    KeLowerIrql(v9);
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(69LL, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, v10, a2);
}
