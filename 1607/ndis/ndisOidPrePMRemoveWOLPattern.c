/*
 * XREFs of ndisOidPrePMRemoveWOLPattern @ 0x1C00C8ED0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMRemoveWOLPattern(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x57u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v8, v4);
  v9 = *(_QWORD *)(a1 + 24);
  v10 = 6;
  LOBYTE(a4) = 20;
  if ( v9
...
LABEL_31:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0x58u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v5;
}
