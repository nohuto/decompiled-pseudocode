/*
 * XREFs of ?NdisTraceLoggingUnexpectedSelectiveSuspendError@@YAXPEAU_NDIS_MINIPORT_BLOCK@@G@Z @ 0x1C00734F8
 * Callers:
...
void __fastcall NdisTraceLoggingUnexpectedSelectiveSuspendError(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0088010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      v7 = 16;
      v10 = 4;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C0079115, v2, v3, 4u, &pData);
    }
  }
}
