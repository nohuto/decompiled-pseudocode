/*
 * XREFs of ndisFilterIndicateReceiveNetBufferLists @ 0x1C000E750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_36:
  ...
  else
  {
    ...
    if ( (a5 & 2) != 0 && ndisNblTrackerMode )
      ndisNblTrackerTransferOwnershipInternal(a2, (struct NDIS_NBL_TRACKER_HANDLE__ *)v9[64], v9[99], 0x8Cu, a5 & 1);
  }
}
