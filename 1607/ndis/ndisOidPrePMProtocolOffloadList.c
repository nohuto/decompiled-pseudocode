/*
 * XREFs of ndisOidPrePMProtocolOffloadList @ 0x1C00C8C80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMProtocolOffloadList(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0x6Au, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v1, v3, v5);
    v8 = byte_1C00895D2;
  }
  v9 = a1[3];
  if ( v9
...
LABEL_33:
  if ( (unsigned __int8)v8 >= 4u )
    WPP_SF_qqqL(0x6Bu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v1, v3, v5, *((_DWORD *)a1 + 10));
  return v2;
}
