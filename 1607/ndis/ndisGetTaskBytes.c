/*
 * XREFs of ndisGetTaskBytes @ 0x1C0045874
 * Callers:
...
__int64 __fastcall ndisGetTaskBytes(__int64 a1)
{
  ...
  {
    WPP_SF_q(0xCDu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1);
    v3 = byte_1C00895D2;
  }
  v4 = 28;
  if ( v2[9] )
  ...
  if ( (unsigned __int8)v3 >= 4u )
    WPP_SF_qD(0xCEu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1, v4);
  return v4;
}
