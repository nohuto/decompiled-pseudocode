/*
 * XREFs of ?ndisAoAcStop@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_SS_STOP_REASON@@W4CallRunMode@@@Z @ 0x1C006D4D8
 * Callers:
 ...
 *     ?ndisAoAcCleanup@@YAXPEAU_NDIS_MINIPORT_AOAC@@@Z @ 0x1C006CF74 (-ndisAoAcCleanup@@YAXPEAU_NDIS_MINIPORT_AOAC@@@Z.c)
...
LABEL_23:
  ...
  if ( AoAc->ActiveState )
  {
    ...
    if ( (unsigned __int8)byte_1C00895D5 >= 4u )
      WPP_SF_q(0x21u, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, (__int64)a1);
    ...
    if ( v15 && v15 != 259 )
    {
      ...
      if ( (unsigned __int8)byte_1C00895D5 >= 2u )
        WPP_SF_dq(0x22u, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, v16, a1);
    }
  }
  else
  {
