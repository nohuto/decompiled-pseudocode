/*
 * XREFs of ndisOidPreIovBarResources @ 0x1C00D96E0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovBarResources(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x4Bu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
    v4 = byte_1C00895E1;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
...
LABEL_22:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x4Cu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v5, v11);
  }
  return v5;
}
