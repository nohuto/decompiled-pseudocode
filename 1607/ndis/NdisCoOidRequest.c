        ...
        PNDIS_OID_REQUEST OidRequest)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(0x40u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, NdisBindingHandle, NdisAfHandle, OidRequest);
...
LABEL_27:
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x41u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, v13, v5);
  if ( v10 )
...
LABEL_57:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0x42u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, (__int64)v5, v11);
  return v11;
}
