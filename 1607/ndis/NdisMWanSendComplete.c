/*
 * XREFs of NdisMWanSendComplete @ 0x1C00538A0
 * Callers:
 *     ndisMStartWanSends @ 0x1C00567A0 (ndisMStartWanSends.c)
 *     ndisMWanSendCompleteInternal @ 0x1C0056CF0 (ndisMWanSendCompleteInternal.c)
 * Callees:
...
void __fastcall NdisMWanSendComplete(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqd(0x1Eu, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
  ...
  *(_DWORD *)(a1 + 1856) = 1509068;
  ...
  if ( (*(_DWORD *)(a1 + 120) & 0x40000) != 0 && v6 != 2 )
    KeLowerIrql(v6);
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2);
}
