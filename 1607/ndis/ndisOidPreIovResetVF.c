/*
 * XREFs of ndisOidPreIovResetVF @ 0x1C00DA880
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovResetVF(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x43u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
    v4 = byte_1C00895E1;
  }
  v5 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
...
LABEL_13:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x44u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v5, v9);
  }
  return v5;
}
