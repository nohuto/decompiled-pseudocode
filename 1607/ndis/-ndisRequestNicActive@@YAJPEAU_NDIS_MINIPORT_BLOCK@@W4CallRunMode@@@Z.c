/*
 * XREFs of ?ndisRequestNicActive@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4CallRunMode@@@Z @ 0x1C006E81C
 * Callers:
...
__int64 __fastcall ndisRequestNicActive(struct _NDIS_MINIPORT_BLOCK *a1, enum CallRunMode a2)
{
  ...
  if ( ActiveState == NdisNicQuiet )
  {
    ...
    else
    {
      ...
      if ( v11 == 259 )
        goto LABEL_23;
      NdisUnexpectedAoAcError(a1, 0x3A4u);
      if ( (unsigned __int8)byte_1C00895D5 >= 2u )
        WPP_SF_dq(0xFu, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, v11, a1);
    }
  }
  else
  {
    ...
    {
      if ( (unsigned __int8)byte_1C00895D5 >= 2u )
        WPP_SF_q(0x10u, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, (__int64)a1);
      KeReleaseSpinLock(&AoAc->Lock, v9);
