/*
 * XREFs of ndisOidPostMediaState @ 0x1C0046800
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostMediaState(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x4Du, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v1);
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x4Eu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v1);
}
