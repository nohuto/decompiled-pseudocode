/*
 * XREFs of ndisOidPreNicSwitchCaps @ 0x1C00C3190
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreNicSwitchCaps(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0x20u, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v1, v5, v3);
    v6 = byte_1C00895D2;
  }
  *((_DWORD *)a1 + 10) = 0;
...
LABEL_20:
  if ( (unsigned __int8)v6 >= 4u )
  {
    v17 = *((_DWORD *)a1 + 10);
    LODWORD(v16) = v4;
    WPP_SF_qqDD(0x21u, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v1, v5, v16, v17);
  }
  return v4;
}
