/*
 * XREFs of ?ndisPDInitializeMiniportBufferManagement@@YAJPEAU_NDIS_PD_BLOCK@@@Z @ 0x1C00E0564
 * Callers:
 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C00E0538 (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x1C00E0C3C (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
 */
...
__int64 __fastcall ndisPDInitializeMiniportBufferManagement(struct _NDIS_PD_BLOCK *a1)
{
  ...
  KLockThisExclusive v23; // [rsp+40h] [rbp-20h] BYREF
  ...
  *(_WORD *)((char *)&v22 + 13) = 0;
  ...
  if ( a1->PDDomainId )
  {
    KLockThisExclusive::KLockThisExclusive(&v23, (struct KPushLockBase *)(qword_1C0089668 + 8));
...
LABEL_32:
  ...
  *((_QWORD *)v4 + 12) = PDBMFreeCommonBuffer;
  ...
  if ( !PDDomainId )
  {
    ...
    v14 = qword_1C0089668 + 8248;
    v15 = *(__int64 ***)(qword_1C0089668 + 8256);
    if ( *v15 != (__int64 *)(qword_1C0089668 + 8248) )
      __fastfail(3u);
    goto LABEL_30;
  }
