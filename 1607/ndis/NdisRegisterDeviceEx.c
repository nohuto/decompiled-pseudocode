/*
 * XREFs of NdisRegisterDeviceEx @ 0x1C001EA40
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(102LL, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, NdisHandle);
  *pDeviceObject = 0LL;
...
LABEL_33:
  ...
  if ( SymbolicLink >= 0 )
  {
    ...
    *((_WORD *)DeviceExtension + 145) = DeviceObjectAttributes->SymbolicName->Length + 2;
    ...
    {
      v28 = (KSPIN_LOCK *)(DriverObjectExtension + 392);
      DeviceExtension[3] = (KSPIN_LOCK)NdisHandle;
      v23 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)DriverObjectExtension + 49);
...
LABEL_17:
      ...
      v23 = KeAcquireSpinLockRaiseToDpc(v34 + 5);
      v24 = (char *)(v34 + 7);
      v25 = v34[7];
      if ( *(char **)(*(_QWORD *)v24 + 8LL) != v24 )
        __fastfail(3u);
      *v18 = v25;
      DeviceExtension[2] = (KSPIN_LOCK)v24;
      *(_QWORD *)(v25 + 8) = v18;
      v26 = v34 + 5;
      *(_QWORD *)v24 = v18;
    }
    KeReleaseSpinLock(v26, v23);
    goto LABEL_17;
  }
  IoDeleteDevice(DeviceObject);
LABEL_18:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(103LL, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, NdisHandle, (unsigned int)SymbolicLink);
  return SymbolicLink;
}
