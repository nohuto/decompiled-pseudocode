/*
 * XREFs of NdisMIdleNotificationCompleteEx @ 0x1C006B0F0
 * Callers:
 *     NdisMIdleNotificationComplete @ 0x1C006B0E0 (NdisMIdleNotificationComplete.c)
 * Callees:
...
void __fastcall NdisMIdleNotificationCompleteEx(struct _NDIS_MINIPORT_BLOCK *a1, int a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D6 >= 4u )
    WPP_SF_qD(0x1Bu, &WPP_fb3ee79da3763fe19127143656620238_Traceguids, (__int64)a1, a2);
