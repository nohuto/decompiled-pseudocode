/*
 * XREFs of ndisSetOpenRSSParameters @ 0x1C0024598
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenRSSParameters(_QWORD *a1, __int64 a2, int *a3)
{
  ...
  __int64 v41; // rax
  int v42; // eax
  unsigned __int8 v43; // [rsp+50h] [rbp-58h]
  int v44; // [rsp+54h] [rbp-54h]
  int v45; // [rsp+58h] [rbp-50h]
  KIRQL NewIrql; // [rsp+B0h] [rbp+8h]
  unsigned __int8 v47; // [rsp+B8h] [rbp+10h]
  unsigned __int8 v48; // [rsp+B8h] [rbp+10h]
  __int16 v50; // [rsp+C8h] [rbp+20h]
  unsigned __int8 v51; // [rsp+C8h] [rbp+20h]

  v3 = a1[2];
  v6 = 0LL;
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(136LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a1, a2);
  v7 = *(_DWORD *)(a2 + 48);
  v8 = 0;
  *(_DWORD *)(a2 + 56) = 0;
  if ( v7 < 0x1C )
  {
    *(_DWORD *)(a2 + 56) = 28;
    ...
    v23 = a1;
LABEL_36:
    WPP_SF_qqd(v22, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v23, -1073676268);
    goto LABEL_37;
  }
  v9 = *(_QWORD *)(a2 + 40);
  v10 = 40;
...
LABEL_42:
      ...
      v24 = 138LL;
LABEL_41:
      WPP_SF_qq(v24, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a2);
      goto LABEL_42;
    }
    if ( v11 >= 3u )
    {
...
LABEL_51:
    ...
    v25 = 141LL;
LABEL_50:
    WPP_SF_qq(v25, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a1);
    goto LABEL_51;
  }
    ...
    *(_DWORD *)(v3 + 1856) = 2305012;
    ...
    if ( v28
      ...
      && ((v29 = *(_DWORD *)(v9 + 32), *(_DWORD *)(v6 + 32) != v29)
       ...
       || v47 >= 3u && (*(_WORD *)(v6 + 40) != *(_WORD *)(v9 + 40) || *(_BYTE *)(v6 + 42) != *(_BYTE *)(v9 + 42))) )
    {
LABEL_27:
...
LABEL_30:
  *a3 = v8;
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqDD(144LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, a1, v19, v8);
