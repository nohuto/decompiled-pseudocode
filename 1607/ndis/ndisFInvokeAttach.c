/*
 * XREFs of ndisFInvokeAttach @ 0x1C00AA08C
 * Callers:
...
__int64 __fastcall ndisFInvokeAttach(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_q(0x70u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1);
  v5 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(v2 + 176))(a1, *(_QWORD *)(v2 + 32), a2);
  v6 = v5;
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_qD(0x71u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1, v5);
  return v6;
}
