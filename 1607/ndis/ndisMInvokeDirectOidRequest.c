/*
 * XREFs of ndisMInvokeDirectOidRequest @ 0x1C005E16C
 * Callers:
...
__int64 __fastcall ndisMInvokeDirectOidRequest(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0xE6u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, v4);
  ...
  if ( !v6 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C00895D2 >= 4u )
        WPP_SF_qqd(0xE7u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, v3, v11, v11->DATA.QUERY_INFORMATION.Oid);
      v3 = (__int64)v7;
    }
  ...
  {
    LODWORD(v10) = v8;
    WPP_SF_qdD(0xE8u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1, v4, v10);
  }
  return v8;
}
