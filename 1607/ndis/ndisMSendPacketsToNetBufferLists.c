/*
 * XREFs of ndisMSendPacketsToNetBufferLists @ 0x1C0056650
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToNetBufferLists(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqd(0x36u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(0x37u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2);
}
