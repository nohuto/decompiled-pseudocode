/*
 * XREFs of NdisMWriteConfigBlock @ 0x1C00D8AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMWriteConfigBlock(_QWORD *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x7Bu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)a1);
  ...
  if ( v8 && (v9 = a1[616]) != 0 && (v10 = a1[584]) != 0 && (*(_BYTE *)(v10 + 8) & 5) == 5 )
    ...
    v11 = -1073741637;
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x7Cu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)a1);
  return v11;
}
