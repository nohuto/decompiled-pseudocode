/*
 * XREFs of NdisAllocateNetBufferList @ 0x1C0006050
 * Callers:
  ...
  *((_BYTE *)&v10[12].Next + 8) = *((_BYTE *)PoolHandle + 88);
  ...
  if ( v10 )
  {
    ...
    if ( (*((_DWORD *)PoolHandle + 15) & 4) != 0 )
    {
      ...
      {
        v29 = *((unsigned int *)PoolHandle + 23);
        v30 = (unsigned __int64)v16 + *((unsigned int *)PoolHandle + 24);
        v31 = (_WORD)v16 + *((_DWORD *)PoolHandle + 24);
        v16->Next = 0LL;
        v16->MdlFlags = 0;
        v16->ByteCount = v29;
