/*
 * XREFs of ?NdisPDPIFreeQueue@@YAXPEAU_NDIS_PD_QUEUE@@@Z @ 0x1C00DF170
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDPIFreeQueue(struct _NDIS_PD_QUEUE *a1)
{
  ...
  ndisCleanupPDQAWM((struct NDIS_PD_QUEUE_AWM_STATE *)(v1 + 64));
  NDIS_PD_QUEUE_TRACKER::`scalar deleting destructor'((_UNICODE_STRING *)v1);
  if ( (unsigned __int8)byte_1C00895E4 >= 4u )
