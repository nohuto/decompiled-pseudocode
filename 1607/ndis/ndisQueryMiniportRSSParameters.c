/*
 * XREFs of ndisQueryMiniportRSSParameters @ 0x1C0047CE0
 * Callers:
...
__int64 __fastcall ndisQueryMiniportRSSParameters(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x84u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1, a2);
  v5 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
  *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
  *(_DWORD *)(a1 + 1856) = 2304666;
  if ( *(_WORD *)(a1 + 2730) )
  {
    v6 = *(_QWORD *)(a1 + 552);
    if ( v6 )
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0x85u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1, v3);
  return v3;
}
