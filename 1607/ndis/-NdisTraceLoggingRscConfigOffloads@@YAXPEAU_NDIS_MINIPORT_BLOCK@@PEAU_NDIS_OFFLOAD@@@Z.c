/*
 * XREFs of ?NdisTraceLoggingRscConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0022E5C
 * Callers:
...
void __fastcall NdisTraceLoggingRscConfigOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( (unsigned int)dword_1C0088010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v11 = 4LL;
      v13 = 4LL;
      TlgWrite(v2, &unk_1C007894B, v3, (LPCGUID)v4, 5u, &pData);
    }
  }
}
