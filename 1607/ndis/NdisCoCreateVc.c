        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_(0x12u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
  ...
  *((_QWORD *)v11 + 6) = v11 + 12;
  ...
  {
    if ( (unsigned __int8)byte_1C00895DA >= 4u )
      WPP_SF_(0x14u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
...
LABEL_26:
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_(0x13u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
  ...
  if ( !Increment )
  {
    v9 = (*((__int64 (__fastcall **)(_QWORD, _DWORD *, _DWORD *))NdisBindingHandle + 128))(
           *(_QWORD *)(v7 + 24),
           v11,
           v11 + 50);
    if ( v9 )
...
LABEL_27:
  ...
  *v11 = 1;
  ...
  {
    if ( (unsigned __int8)byte_1C00895DA >= 4u )
      WPP_SF_(0x15u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
    ...
    *((_QWORD *)v11 + 21) = *((_QWORD *)NdisBindingHandle + 132);
    v33 = *((_QWORD *)NdisBindingHandle + 133);
...
LABEL_56:
  ...
  else
  {
    *v22 = ProtocolVcContext;
    v9 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *, _DWORD *))(*((_QWORD *)NdisAfHandle + 46) + 1040LL))(
  ...
  if ( !v9 )
  {
    ...
    if ( v41 )
    {
      ExInterlockedInsertHeadList((PLIST_ENTRY)NdisBindingHandle + 69, (PLIST_ENTRY)v11 + 2, v26);
      *((_QWORD *)v11 + 13) = *v22;
      if ( *((_DWORD *)NdisAfHandle + 98) >= 6u )
    ...
    else
    {
      ...
      *((_QWORD *)v11 + 12) = *(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 1048LL);
      ExInterlockedInsertHeadList((PLIST_ENTRY)NdisBindingHandle + 69, (PLIST_ENTRY)(v11 + 38), v26);
      v28 = *((_QWORD *)NdisAfHandle + 46);
      v29 = (_LIST_ENTRY *)(v11 + 8);
    }
    ExInterlockedInsertHeadList((PLIST_ENTRY)(v28 + 1104), v29, (PKSPIN_LOCK)(v28 + 232));
    goto LABEL_97;
  }
  if ( !v8 )
  {
...
LABEL_104:
    ...
    {
      if ( (unsigned __int8)byte_1C00895DA >= 4u )
        WPP_SF_(0x16u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
      *((_QWORD *)v11 + 33) = 0LL;
    ...
    if ( (unsigned __int8)byte_1C00895DA >= 4u )
      WPP_SF_(0x17u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
    *((_QWORD *)v11 + 33) = 0LL;
...
LABEL_99:
  ...
  {
    if ( (unsigned __int8)byte_1C00895DA >= 4u )
      WPP_SF_(0x19u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
    *((_QWORD *)v11 + 31) = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_(0x18u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
  *((_QWORD *)v11 + 31) = 0LL;
...
LABEL_117:
  *NdisVcHandle = v11;
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_qD(0x1Au, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, (__int64)v11, v9);
  return v9;
}
