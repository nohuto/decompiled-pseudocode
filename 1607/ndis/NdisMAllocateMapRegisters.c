/*
 * XREFs of NdisMAllocateMapRegisters @ 0x1C00F45F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG MaximumPhysicalMapping)
{
  ...
  int v24; // eax
  int v25; // edx
  void (__fastcall *v26)(_DMA_ADAPTER *, void *, unsigned int); // r14
  void *v27; // rcx
  KIRQL v28; // r15
  ...
  if ( (*((_DWORD *)MiniportAdapterHandle + 934) & 1) != 0 )
    goto LABEL_4;
...
LABEL_53:
  ...
  *(_DWORD *)&DeviceDescription[12] = *((_DWORD *)MiniportAdapterHandle + 943);
  v14 = *((_DWORD *)MiniportAdapterHandle + 119);
  ...
  *(_DWORD *)&DeviceDescription[32] = MaximumPhysicalMapping;
  ...
  DmaAdapter = IoGetDmaAdapter(
                 *((PDEVICE_OBJECT *)MiniportAdapterHandle + 486),
  ...
  *((_QWORD *)MiniportAdapterHandle + 63) = v6;
    ...
    if ( HalPrivateDispatchTable[12](DmaAdapter, v15, v6[77], *((_QWORD *)v6 + 17)) < 0 )
    {
      ...
      else
      {
        ...
        *((_QWORD *)v6 + 17) = 0LL;
        ...
        v30 = 1;
        NdisWriteErrorLogEntry(MiniportAdapterHandle, 0xC0001389, 1u, (unsigned int)v16);
      }
    }
  ...
  if ( v6[77] )
  {
    ...
    {
      WPP_SF_d(0x2Bu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, v24);
      v25 = v32;
    }
    if ( (Microsoft_Windows_NDISEnableBits & 0x100) != 0 )
      Template_qqq(0LL, &AllocateAdapterChannelFailed, (const GUID *)MiniportAdapterHandle + 254, v25, 170, 0);
    if ( v22 )
    {
      v26 = FreeMapRegisters;
      do
        v26(*((_DMA_ADAPTER **)v6 + 3), *(void **)(*((_QWORD *)v6 + 17) + 16LL * --v22), v15);
      while ( v22 );
      v7 = v33;
    }
    if ( v23 != 2 )
...
LABEL_54:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x2Cu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)MiniportAdapterHandle, v7);
  return v7;
}
