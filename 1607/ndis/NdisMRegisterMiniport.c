/*
 * XREFs of NdisMRegisterMiniport @ 0x1C00D2780
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT CharacteristicsLength)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xAu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)NdisWrapperHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xBu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, v3, v7);
  return v7;
}
