/*
 * XREFs of ndisUpdateOffloadKeywords @ 0x1C00C745C
 * Callers:
 ...
 *     ndisConvertOffloadValueToString @ 0x1C00C4C9C (ndisConvertOffloadValueToString.c)
...
__int64 __fastcall ndisUpdateOffloadKeywords(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_q(0xD7u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1);
    LOBYTE(a2) = v52;
    LOBYTE(a3) = v53;
    v5 = 0;
    v9 = 0;
