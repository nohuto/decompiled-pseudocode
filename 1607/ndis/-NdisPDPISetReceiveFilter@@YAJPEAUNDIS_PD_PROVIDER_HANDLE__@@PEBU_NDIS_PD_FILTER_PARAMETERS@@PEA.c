/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C00DF770
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_FILTER_HANDLE__ **a3)
{
  ...
  KLockThisExclusive v27; // [rsp+40h] [rbp-48h] BYREF
...
LABEL_44:
  ...
  *((_DWORD *)v4 + 25) = *((_DWORD *)a2 + 3);
  v4[13] = *((_QWORD *)a2 + 4);
  KLockThisExclusive::KLockThisExclusive(&v27, v18 + 1);
...
LABEL_46:
  ...
  {
    LODWORD(v26) = v8;
    WPP_SF_qqd(0x31u, &WPP_2929d52fc6803c0d5180733d460ecc8a_Traceguids, a1, *a3, v26);
  }
