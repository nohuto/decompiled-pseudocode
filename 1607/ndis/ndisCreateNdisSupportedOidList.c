/*
 * XREFs of ndisCreateNdisSupportedOidList @ 0x1C00AC240
 * Callers:
...
__int64 __fastcall ndisCreateNdisSupportedOidList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(0x13u, &WPP_8ce524521b613c0e10407cfbf52a0b71_Traceguids, a1);
  v3 = *(_BYTE *)(a1 + 32);
  v4 = 45;
  v5 = 45;
  if ( v3 >= 6u )
  ...
  *(_QWORD *)(a1 + 3448) = PoolWithTag;
    ...
    *((_DWORD *)PoolWithTag + 44) = *((_DWORD *)&ndisHandledNdis5Ndis6GenOids + 44);
    if ( *(_BYTE *)(a1 + 32) >= 6u )
    {
      ...
      *v8 = ndisHandledNdis6OnlyGenOids;
      v8[1] = *(_OWORD *)(0x1C0000000LL + 1048624);
      v8[2] = *(_OWORD *)(0x1C0000000LL + 1048640);
      v8[3] = *(_OWORD *)(0x1C0000000LL + 1048656);
      v8[4] = *(_OWORD *)(0x1C0000000LL + 1048672);
      v8[5] = *(_OWORD *)(0x1C0000000LL + 1048688);
      v8[6] = *(_OWORD *)(0x1C0000000LL + 1048704);
      v8[7] = *(_OWORD *)(0x1C0000000LL + 1048720);
      v8[8] = *(_OWORD *)(0x1C0000000LL + 1048736);
    }
    if ( !*(_DWORD *)(a1 + 464) )
    {
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0x14u, &WPP_8ce524521b613c0e10407cfbf52a0b71_Traceguids, a1, v2);
  return v2;
}
