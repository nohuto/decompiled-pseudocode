/*
 * XREFs of ndisLegacyProtocolPauseRestartHandler @ 0x1C005AF7C
 * Callers:
...
void __fastcall ndisLegacyProtocolPauseRestartHandler(__int64 a1, int *a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qD(0x4Bu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, a1, *a2);
  if ( *a2 == 8 )
  {
    v5 = 0;
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qD(0x4Cu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, a1, *a2);
}
