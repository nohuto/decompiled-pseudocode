/*
 * XREFs of ?ndisAcquireReadLockSharedRefCnt@@YAHPEAU_NDIS_RW_LOCK@@@Z @ 0x1C005957C
 * Callers:
 *     ndisAcquireReadWriteLockX @ 0x1C000ECEC (ndisAcquireReadWriteLockX.c)
 *     NdisAcquireReadWriteLock @ 0x1C000EE80 (NdisAcquireReadWriteLock.c)
 * Callees:
 *     ?IsReadLockAlreadyHeldByCurrentThread@@YAHPEAU_NDIS_RW_LOCK@@@Z @ 0x1C005953C (-IsReadLockAlreadyHeldByCurrentThread@@YAHPEAU_NDIS_RW_LOCK@@@Z.c)
 */
