/*
 * XREFs of ndisIsMiniportReady @ 0x1C004F384
 * Callers:
...
char __fastcall ndisIsMiniportReady(_DWORD *a1)
{
  ...
  if ( (v1 & 0x80200020) != 0 )
  {
    ...
    v3 = 67;
LABEL_4:
    WPP_SF_qD(v3, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, (__int64)a1, v1);
    return 0;
  }
  v1 = a1[31];
  if ( (v1 & 0x1084910) != 0 )
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_q(0x47u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, (__int64)a1);
  return 1;
}
