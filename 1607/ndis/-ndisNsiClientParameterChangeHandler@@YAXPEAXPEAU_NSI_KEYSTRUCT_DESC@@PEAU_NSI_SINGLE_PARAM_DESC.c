/*
 * XREFs of ?ndisNsiClientParameterChangeHandler@@YAXPEAXPEAU_NSI_KEYSTRUCT_DESC@@PEAU_NSI_SINGLE_PARAM_DESC@@W4_NSI_NOTIFICATION@@@Z @ 0x1C00AF180
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisNsiClientParameterChangeHandler(unsigned __int64 a1, int **a2, _DWORD *a3, int a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqqL(0x68u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, a3, a4);
  v8 = *a2;
  if ( *a2 && a1 <= 7 )
  {
    if ( (_DWORD)a1 )
      ...
      switch ( (_DWORD)a1 )
      {
        case 1:
          if ( (unsigned __int8)byte_1C00895DD >= 4u )
            WPP_SF_dd(
              0x6Au,
              &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids,
        ...
        case 7:
          if ( (unsigned __int8)byte_1C00895DD >= 4u )
            WPP_SF_d(0x6Cu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, *v8);
          if ( (Microsoft_Windows_NDISEnableBits & 0x2000) != 0 )
  ...
  {
    LODWORD(v9) = a4;
    WPP_SF_qqqL(0x6Du, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, a3, v9);
  }
}
