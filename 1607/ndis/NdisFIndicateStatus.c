/*
 * XREFs of NdisFIndicateStatus @ 0x1C001ED80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisIsStatusIndicationCloneable @ 0x1C0058140 (NdisIsStatusIndicationCloneable.c)
    ...
    if ( (unsigned __int8)NdisIsStatusIndicationCloneable((unsigned int)StatusIndication->StatusCode) )
    {
      ...
      *(_QWORD *)v6 = PoolWithTag;
      if ( PoolWithTag )
      {
        ...
        *(_QWORD *)(v9 + 80) = 0LL;
        *(_QWORD *)(v9 + 88) = 0LL;
        ndisReferenceRefNoCheck((__int64)NdisFilterHandle + 312);
LABEL_12:
