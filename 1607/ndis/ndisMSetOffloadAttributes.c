/*
 * XREFs of ndisMSetOffloadAttributes @ 0x1C00B1D10
 * Callers:
 ...
 *     ndisValidateOffloadCapability @ 0x1C00B2070 (ndisValidateOffloadCapability.c)
 *     ndisValidateConnectionOffload @ 0x1C00D6CD0 (ndisValidateConnectionOffload.c)
 */
...
__int64 __fastcall ndisMSetOffloadAttributes(__int64 a1, __int64 a2, _WORD *a3, _WORD *a4, _WORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qq(0xAu, &WPP_fde93b4b8ac33b470d75b3ac150a1f69_Traceguids, a1, a2);
  v8 = 180;
  ...
  if ( a4 )
  {
    ...
    if ( v44 < 0x14u )
      v42 = v44;
    memmove(&v51, a5, v42);
    if ( !(unsigned __int8)ndisValidateConnectionOffload(&v49) || !(unsigned __int8)ndisValidateConnectionOffload(&v51) )
      goto LABEL_31;
    v9 = v50;
    v10 = v52;
  }
...
LABEL_28:
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qD(0xBu, &WPP_fde93b4b8ac33b470d75b3ac150a1f69_Traceguids, a1, v16);
  return v16;
}
