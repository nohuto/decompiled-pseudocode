/*
 * XREFs of ndisGetHardwareInfo @ 0x1C00CFC8C
 * Callers:
...
__int64 __fastcall ndisGetHardwareInfo(char *NdisHandle, _QWORD *a2, _DWORD *a3)
{
  ...
  *((_WORD *)v10 + 7) = *(_WORD *)(*((_QWORD *)NdisHandle + 477) + 482LL);
  *((_WORD *)v10 + 8) = *(_WORD *)(*((_QWORD *)NdisHandle + 477) + 480LL);
  ...
  if ( v12 )
  {
    *((_OWORD *)v10 + 2) = *(_OWORD *)(NdisHandle + 3672);
    *((_QWORD *)v10 + 6) = *((_QWORD *)NdisHandle + 461);
    *((_QWORD *)v10 + 7) = *((_QWORD *)NdisHandle + 462);
    v10[16] = *((_DWORD *)NdisHandle + 926);
    if ( *(_BYTE *)(v12 + 192) )
    {
      v13 = v10[1] | 4;
      v10[1] = v13;
      if ( *(_BYTE *)(v12 + 193) )
      {
        ...
        if ( NdisHandle[3696] == 17 )
        {
          v17 = v10[1] | 0x10;
          v10[1] = v17;
          v10[6] = (*((_WORD *)NdisHandle + 1849) & 0x7FF) + 1;
          if ( *((__int16 *)NdisHandle + 1849) < 0 )
            v10[1] = v17 | 0x20;
        }
      }
      else
...
LABEL_24:
  v10[22] = 120;
  v10[23] = 52;
  *(_OWORD *)(v10 + 30) = *(_OWORD *)(NdisHandle + 3384);
  *(_OWORD *)(v10 + 34) = *(_OWORD *)(NdisHandle + 3400);
  *(_OWORD *)(v10 + 38) = *(_OWORD *)(NdisHandle + 3416);
  v10[42] = *((_DWORD *)NdisHandle + 858);
  v10[19] = *((_DWORD *)NdisHandle + 856);
  v10[20] = *((_DWORD *)NdisHandle + 857);
  v10[21] = *((_DWORD *)NdisHandle + 858);
  v10[59] = *((_DWORD *)NdisHandle + 930);
  *((_BYTE *)v10 + 240) = NdisHandle[1288];
  v18 = (NdisHandle[120] & 0x10) != 0;
  v10[24] = 172;
  *((_BYTE *)v10 + 241) = v18;
  v10[25] = 20;
  *(_OWORD *)(v10 + 43) = *(_OWORD *)(NdisHandle + 2728);
  v10[47] = *((_DWORD *)NdisHandle + 686);
