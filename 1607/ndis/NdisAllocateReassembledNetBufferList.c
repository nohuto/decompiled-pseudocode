/*
 * XREFs of NdisAllocateReassembledNetBufferList @ 0x1C004CA30
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG AllocateReassembleFlags)
{
  ...
  int v40; // [rsp+80h] [rbp+0h] BYREF

  v6 = (unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL;
  *(_DWORD *)(v6 + 4) = DataOffsetDelta;
  v7 = StartOffset;
  *(_DWORD *)v6 = StartOffset;
          ...
          while ( MdlChain )
          {
            ...
            if ( v17 < ByteCount )
            {
              ...
              *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = v20;
              ...
              if ( !Mdl )
                goto LABEL_33;
              IoBuildPartialMdl(MdlChain, Mdl, *(PVOID *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10), v19);
              v22->Next = 0LL;
              if ( v13->MdlChain )
              {
                **(_QWORD **)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = v22;
              }
              else
              {
              ...
              *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = v22;
              ...
              if ( v23 )
              {
                for ( i = MdlChain->Next; i; i = i->Next )
                {
                  ...
                  *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = v26;
                  if ( v23 < v25 )
                    v25 = v23;
                  ...
                  if ( !v27 )
                    goto LABEL_33;
                  IoBuildPartialMdl(i, v27, *(PVOID *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10), v25);
                  v29 = *(struct _MDL ***)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30);
                  v28->Next = 0LL;
                  *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = v28;
                  *v29 = v28;
                  v30 = v13->DataLength;
                  if ( v30 + v25 < v30 )
                  {
...
LABEL_30:
      ...
      v33 = NdisRetreatNetBufferListDataStart(
              v11,
              *(_DWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 4),
              DataBackFill,
      ...
      if ( !v33 )
      {
        v34 = *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20);
        NetioCopyOpaqueNetBufferListInformation((__int64)v11, v34);
        if ( Microsoft_Windows_Networking_CorrelationEnabled )
        {
          *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) = 0LL;
          *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = *(_QWORD *)(v34 + 248) & 0x7FFFFFFFFFFFFFFFLL;
          v36 = *(_OWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20);
          *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = 0LL;
          v37 = (__int64)v11->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
          *(_OWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = v36;
          *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = v37;
          LODWORD(v37) = Microsoft_Windows_Networking_CorrelationEnabled;
          *(_OWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = *(_OWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL)
                                                                                           + 0x10);
          if ( (_DWORD)v37 )
