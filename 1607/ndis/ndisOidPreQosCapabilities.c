/*
 * XREFs of ndisOidPreQosCapabilities @ 0x1C00C5890
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreQosCapabilities(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x7Eu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v1);
    v5 = byte_1C00895D2;
  }
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_14:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x7Fu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v4, v9);
  }
  return v4;
}
