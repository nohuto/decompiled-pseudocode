/*
 * XREFs of ndisCreateFilterDriverRegistry @ 0x1C00A0EFC
 * Callers:
...
__int64 __fastcall ndisCreateFilterDriverRegistry(PCUNICODE_STRING Source, unsigned __int8 a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x55u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, (__int64)Source);
  ...
  v9 = RegistryValues;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_dd(0x56u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, RegistryValues, a2);
  if ( !v9 )
    goto LABEL_10;
  if ( v9 != -1073741772 )
  {
...
LABEL_12:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x57u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, (__int64)Source, v3);
  return v3;
}
