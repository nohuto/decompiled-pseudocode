/*
 * XREFs of ndisXlateWakeUpPatternListToWolPatternList @ 0x1C00CB9D8
 * Callers:
 *     ndisOidPostWolPatternList @ 0x1C004A050 (ndisOidPostWolPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWakeUpPatternListToWolPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v5 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C00895D2 >= 2u )
      WPP_SF_(0x74u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids);
    return;
  }
  if ( !(_DWORD)v5 )
    return;
