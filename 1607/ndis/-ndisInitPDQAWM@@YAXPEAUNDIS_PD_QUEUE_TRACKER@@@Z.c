/*
 * XREFs of ?ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x1C00E01B8
 * Callers:
...
void __fastcall ndisInitPDQAWM(char *DeferredContext)
{
  ...
  v1 = (struct _KDPC *)(DeferredContext + 96);
  DeferredContext[68] = 1;
  ProcNumber = 0;
  KeInitializeDpc((PRKDPC)(DeferredContext + 96), (PKDEFERRED_ROUTINE)ndisPdAwmDpcRoutine, DeferredContext);
  KeSetImportanceDpc(v1, MediumHighImportance);
  v3 = *((__m128i *)DeferredContext + 11);
