/*
 * XREFs of ndisQueryMediaStatus @ 0x1C00D4A6C
 * Callers:
...
void __fastcall ndisQueryMediaStatus(void *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D5 >= 4u )
    WPP_SF_q(0x8Au, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, (__int64)a1);
  ...
  *(_DWORD *)&v3[48] = 4;
  ...
  if ( (unsigned __int8)byte_1C00895D5 >= 4u )
    WPP_SF_q(0x8Bu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, (__int64)a1);
}
