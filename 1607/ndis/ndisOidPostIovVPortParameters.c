/*
 * XREFs of ndisOidPostIovVPortParameters @ 0x1C0069620
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovVPortParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qq(0x39u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qq(0x3Au, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
}
