/*
 * XREFs of ndisMSendPacketCompleteToOpen @ 0x1C0055E80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketCompleteToOpen(__int64 a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqd(0x14u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
  ...
  *((_DWORD *)v10 + 2) = 0;
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qq(0x15u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2);
}
