/*
 * XREFs of ndisXlateAddWolPatternToPacketPatternOid @ 0x1C00CB4CC
 * Callers:
...
__int64 __fastcall ndisXlateAddWolPatternToPacketPatternOid(__int64 a1, _BYTE *a2)
{
  ...
  *a2 = 0;
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)v8 + 4) = *(_DWORD *)(a1 + 48);
      ...
      if ( (unsigned __int8)byte_1C00895D2 >= 4u )
        WPP_SF_q(0x70u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1);
      ExFreePoolWithTag(v8, 0);
    }
    else if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    {
      WPP_SF_q(0x6Fu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1);
    }
    v3 = -1073741670;
    *a2 = 1;
  }
  ...
  {
    if ( (unsigned __int8)byte_1C00895D2 >= 4u )
      WPP_SF_qD(0x6Eu, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, a1, v6);
    *a2 = 1;
