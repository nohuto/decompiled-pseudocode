/*
 * XREFs of NdisMEnableVirtualization @ 0x1C00D87A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMEnableVirtualization(__int64 a1, unsigned __int16 a2, __int64 a3, __int64 a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x71u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qD(0x72u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1, v11);
  return v11;
}
