/*
 * XREFs of ndisWmiQueryAllData @ 0x1C00D5C4C
 * Callers:
 ...
 *     ndisWmiGuidIsAdapterSpecific @ 0x1C00D5B18 (ndisWmiGuidIsAdapterSpecific.c)
  ...
  *a5 = 0;
  ...
  if ( (int)ndisWmiGetGuid(&v45, (__int64)a1, (_QWORD *)(a3 + 24), 0) < 0 )
  {
    if ( (unsigned __int8)byte_1C00895D9 >= 2u )
      WPP_SF_q(v12 + 35, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, (__int64)a1);
  ...
  if ( a4 >= v19 )
  {
    ...
    *v20 = a1->pAdapterInstanceName->Length;
    ...
    if ( GuidDataSize < 0 )
    {
      ...
      v22 = 39;
LABEL_59:
      WPP_SF_q(v22, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, (__int64)a1);
      goto LABEL_60;
    }
    v17 = a4;
    *(_DWORD *)(a3 + 64) = Size;
          ...
          if ( GuidDataSize >= 0 )
          {
            ...
            if ( a4 >= v19 )
            {
              ...
              *v29 = (unsigned __int16)v26[18].Blink;
              ...
              {
                if ( (unsigned __int8)byte_1C00895D9 >= 2u )
                  WPP_SF_qq(0x29u, &WPP_6cfa583b85a83ad776181b24463a0d24_Traceguids, a1, v26);
...
LABEL_60:
  if ( v5 )
    ndisDereferenceMiniport((__int64)v5);
LABEL_62:
