/*
 * XREFs of EthFilterDprIndicateReceive @ 0x1C0060CA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ethFilterReceivePacketStats @ 0x1C0061EE8 (ethFilterReceivePacketStats.c)
 */
        ...
        unsigned int a8)
{
  ...
  if ( a1 && (*(_DWORD *)(a1[37] + 120) & 0x20000000) != 0 )
  {
    ...
    if ( a5 >= 0xE && a8 )
    {
      if ( (*(_BYTE *)a3 & 1) == 0 )
      {
        v16 = *(_QWORD *)(v12[37] + 3192);
        if ( v16 )
        {
          v17 = 112LL * KeGetPcr()->Prcb.Number;
          ++*(_QWORD *)(v17 + v16 + 32);
        }
        v18 = *(_QWORD *)(v12[37] + 3192);
        if ( v18 )
        {
