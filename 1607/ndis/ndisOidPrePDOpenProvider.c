/*
 * XREFs of ndisOidPrePDOpenProvider @ 0x1C00E15A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_ASSOCIATION@@QEAAPEAXI@Z @ 0x1C00DD64C (--_GNDIS_PD_ASSOCIATION@@QEAAPEAXI@Z.c)
 ...
 *     ?ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z @ 0x1C00E01A0 (-ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z.c)
 */
...
unsigned __int8 __fastcall ndisOidPrePDOpenProvider(__int64 a1)
{
  ...
  KLockThisExclusive v32; // [rsp+40h] [rbp-C0h] BYREF
...
LABEL_56:
    ...
    v19 = (struct KPushLockBase *)qword_1C0089668;
    *((_QWORD *)v3 + 10) = *(_QWORD *)(v6 + 8);
    *((_QWORD *)v3 + 11) = *(_QWORD *)(v6 + 16);
    KLockThisExclusive::KLockThisExclusive(&v32, v19 + 1);
    *((_QWORD *)v3 + 8) = v11;
    v20 = (struct NDIS_PD_CLIENT **)*((_QWORD *)v11 + 4);
    v21 = (struct NDIS_PD_CLIENT *)(v3 + 8);
    if ( *v20 != (struct NDIS_PD_CLIENT *)((char *)v11 + 24) )
      __fastfail(3u);
    *(_QWORD *)v21 = (char *)v11 + 24;
    *((_QWORD *)v3 + 2) = v20;
    *v20 = v21;
    *((_QWORD *)v11 + 4) = v21;
    v22 = (__int64 *)(v3 + 40);
    v23 = *(_QWORD *)(v1 + 5664) + 40LL;
    v24 = *(__int64 ***)(*(_QWORD *)(v1 + 5664) + 48LL);
    if ( *v24 != (__int64 *)v23 )
      __fastfail(3u);
    *v22 = v23;
    *((_QWORD *)v3 + 6) = v24;
    ...
    *(_QWORD *)(v23 + 8) = v22;
    ...
    if ( *((_UNKNOWN **)v3 + 11) == &unk_1C0076B70 )
      v3[96] = 1;
    if ( (unsigned __int8)byte_1C00895E4 >= 4u )
    {
      v26 = L"PASS_THROUGH";
