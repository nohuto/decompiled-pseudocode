/*
 * XREFs of ndisHandleOrphanDevice @ 0x1C00F2A14
 * Callers:
...
__int64 __fastcall ndisHandleOrphanDevice(PCUNICODE_STRING SourceString)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0x24u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
...
LABEL_14:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0x25u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  return 0LL;
}
