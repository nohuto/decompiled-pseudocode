/*
 * XREFs of ndisSetupNoFilterHandlers @ 0x1C00194C8
 * Callers:
...
__int64 __fastcall ndisSetupNoFilterHandlers(__int64 a1)
{
  ...
  {
    WPP_SF_q(65LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1);
    v2 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  ...
  *(_QWORD *)(a1 + 2528) = v8;
  if ( v2 >= 4u )
    return WPP_SF_q(66LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1);
  return result;
}
