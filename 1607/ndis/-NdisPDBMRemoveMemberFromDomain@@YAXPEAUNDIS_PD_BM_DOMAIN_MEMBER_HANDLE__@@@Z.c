/*
 * XREFs of ?NdisPDBMRemoveMemberFromDomain@@YAXPEAUNDIS_PD_BM_DOMAIN_MEMBER_HANDLE__@@@Z @ 0x1C00E20F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDBMRemoveMemberFromDomain(struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ *this)
{
  ...
  KLockThisExclusive::KLockThisExclusive(&v6, (struct KPushLockBase *)(*((_QWORD *)this + 3) + 8LL));
  v2 = this + 2;
