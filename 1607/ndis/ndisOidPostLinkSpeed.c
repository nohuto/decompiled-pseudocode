/*
 * XREFs of ndisOidPostLinkSpeed @ 0x1C00465B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostLinkSpeed(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x4Bu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v1);
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x4Cu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v1);
}
