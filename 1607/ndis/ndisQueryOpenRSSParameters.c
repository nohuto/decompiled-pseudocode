/*
 * XREFs of ndisQueryOpenRSSParameters @ 0x1C0047E38
 * Callers:
...
__int64 __fastcall ndisQueryOpenRSSParameters(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x86u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v2, a2);
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 96));
  *(_QWORD *)(v2 + 520) = KeGetCurrentThread();
  *(_DWORD *)(v2 + 1856) = 2304754;
  if ( *(_WORD *)(v2 + 2730) )
  {
    v7 = *(_QWORD *)(a1 + 488);
    if ( v7 )
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qD(0x87u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v2, v3);
  return v3;
}
