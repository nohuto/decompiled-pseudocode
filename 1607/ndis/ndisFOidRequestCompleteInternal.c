/*
 * XREFs of ndisFOidRequestCompleteInternal @ 0x1C000B670
 * Callers:
...
void __fastcall ndisFOidRequestCompleteInternal(char *Parameter)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqd(55LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, Parameter, v1, *(_DWORD *)(v1 + 80));
...
LABEL_13:
  ...
  v15 = (*((_WORD *)Parameter + 160))-- == 1;
  if ( v15 && !Parameter[323] )
  {
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(56LL, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, Parameter, v1);
}
