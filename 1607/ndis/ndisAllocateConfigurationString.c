/*
 * XREFs of ndisAllocateConfigurationString @ 0x1C00A0BF4
 * Callers:
        ...
        PUNICODE_STRING Destination)
{
  ...
  if ( (unsigned __int8)byte_1C00895CF >= 4u )
    WPP_SF_qqq(0x1Du, &WPP_88e16e7e343236ed4c0ce3da79f3a552_Traceguids, SourceString, Source, a3);
  v8 = 0;
  v9 = -1073741675;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x1Eu, &WPP_88e16e7e343236ed4c0ce3da79f3a552_Traceguids, SourceString, Source, a3);
  return v8;
}
