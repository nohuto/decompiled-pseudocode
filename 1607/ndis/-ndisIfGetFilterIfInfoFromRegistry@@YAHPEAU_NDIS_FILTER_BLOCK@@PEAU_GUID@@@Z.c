/*
 * XREFs of ?ndisIfGetFilterIfInfoFromRegistry@@YAHPEAU_NDIS_FILTER_BLOCK@@PEAU_GUID@@@Z @ 0x1C009F758
 * Callers:
...
__int64 __fastcall ndisIfGetFilterIfInfoFromRegistry(struct _NDIS_FILTER_BLOCK *a1, struct _GUID *a2)
{
  ...
  *(_DWORD *)&Keyword.Length = 1835034;
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qq(0xC5u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2);
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
  {
    ...
    WPP_SF_qqd(0xC6u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, ParameterType);
  }
  return v5;
}
