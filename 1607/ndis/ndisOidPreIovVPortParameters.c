/*
 * XREFs of ndisOidPreIovVPortParameters @ 0x1C00DAC60
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVPortParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x37u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v1, v3);
    v7 = byte_1C00895E1;
  }
  v8 = *(_DWORD *)(v3 + 4);
...
LABEL_51:
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qqDD(0x38u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v1, v4, v2, *(_DWORD *)(a1 + 40));
  return v2;
}
