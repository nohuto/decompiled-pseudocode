/*
 * XREFs of NdisOpenProtocolConfiguration @ 0x1C00A81A0
 * Callers:
...
void __fastcall NdisOpenProtocolConfiguration(NTSTATUS *a1, _QWORD *a2, _UNICODE_STRING *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_Z(0x28u, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, &a3->Length);
  ...
  *a1 = PoolWithTag == 0LL ? 0xC000009A : 0;
  ...
  if ( KeyHandle )
    ZwClose(KeyHandle);
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_(0x29u, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids);
}
