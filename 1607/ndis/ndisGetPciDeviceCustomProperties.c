/*
 * XREFs of ndisGetPciDeviceCustomProperties @ 0x1C00B2088
 * Callers:
...
__int64 __fastcall ndisGetPciDeviceCustomProperties(__int64 a1, _DWORD *a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895CE >= 4u )
    WPP_SF_q(0x24u, &WPP_8cdf937d6f313bc131af68fc7a29b768_Traceguids, a1);
  if ( a2 && a1 )
  {
    memset(a2, 0, 0x34uLL);
    *a2 = 3408512;
...
LABEL_10:
    ...
    if ( (unsigned __int8)byte_1C00895CE < 4u )
      return v6;
    WPP_SF_qD(0x25u, &WPP_8cdf937d6f313bc131af68fc7a29b768_Traceguids, a1, DevicePropertyData);
  }
  else
  {
    v6 = -1073741811;
...
LABEL_13:
  if ( (unsigned __int8)byte_1C00895CE >= 4u )
    WPP_SF_qD(0x26u, &WPP_8cdf937d6f313bc131af68fc7a29b768_Traceguids, a1, v6);
  return v6;
}
