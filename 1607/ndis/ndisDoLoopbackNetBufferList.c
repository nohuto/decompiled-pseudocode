/*
 * XREFs of ndisDoLoopbackNetBufferList @ 0x1C0053AA0
 * Callers:
...
void __fastcall ndisDoLoopbackNetBufferList(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqq(0x40u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, a3);
...
LABEL_38:
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqq(0x41u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1, a2, v5);
}
