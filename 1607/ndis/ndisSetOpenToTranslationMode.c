/*
 * XREFs of ndisSetOpenToTranslationMode @ 0x1C00F4520
 * Callers:
...
void __fastcall ndisSetOpenToTranslationMode(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_q(0x86u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
  ...
  *(_QWORD *)(a1 + 112) = ndisSendCompleteWithPause;
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_q(0x87u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
}
