/*
 * XREFs of ndisOidPreGetPciDeviceCustomProperties @ 0x1C00C50A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreGetPciDeviceCustomProperties(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0xAAu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, 0LL, v1);
    v4 = byte_1C00895D2;
  }
  ...
  {
    v8 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0xABu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, 1, v8);
  }
  return 1;
}
