/*
 * XREFs of ?rbc_InitializeFeatureStaging@@YAJXZ @ 0x1C004E550
 * Callers:
 ...
 *     ?reg_FeatureDescriptors_SkipPadding@@YAPEBUreg_FeatureDescriptor@@_K@Z @ 0x1C004E580 (-reg_FeatureDescriptors_SkipPadding@@YAPEBUreg_FeatureDescriptor@@_K@Z.c)
 */
