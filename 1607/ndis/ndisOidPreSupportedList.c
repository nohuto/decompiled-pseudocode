/*
 * XREFs of ndisOidPreSupportedList @ 0x1C001E2D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreSupportedList(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(79LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1);
...
LABEL_14:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_q(80LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1);
  return v4;
}
