/*
 * XREFs of NdisMGetDeviceProperty @ 0x1C00B0820
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        PCM_RESOURCE_LIST *AllocatedResourcesTranslated)
{
  ...
  if ( PhysicalDeviceObject )
    *PhysicalDeviceObject = (PDEVICE_OBJECT)*((_QWORD *)MiniportAdapterHandle + 486);
  if ( FunctionalDeviceObject )
    *FunctionalDeviceObject = (PDEVICE_OBJECT)*((_QWORD *)MiniportAdapterHandle + 485);
  if ( NextDeviceObject )
    *NextDeviceObject = (PDEVICE_OBJECT)*((_QWORD *)MiniportAdapterHandle + 487);
