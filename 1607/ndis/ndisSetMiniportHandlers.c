/*
 * XREFs of ndisSetMiniportHandlers @ 0x1C00E839C
 * Callers:
...
void __fastcall ndisSetMiniportHandlers(__int64 a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x8Eu, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
  v2 = *(_BYTE *)(a1 + 32) < 6u;
  ...
  *(_QWORD *)(a1 + 2336) = a1;
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 2472) = ndisMSendNBLToMiniport;
    v4 = *(_DWORD *)(a1 + 3968) & 0x3000;
    *(_QWORD *)(a1 + 2192) = a1;
    *(_QWORD *)(a1 + 2312) = a1;
    *(_QWORD *)(a1 + 2376) = a1;
    *(_QWORD *)(a1 + 2384) = v3;
    *(_QWORD *)(a1 + 2392) = a1;
    if ( v4 == 0x2000 || *(int *)(a1 + 1872) < 0 && ndisNoPauseOnSuspend )
    {
      *(_QWORD *)(a1 + 2352) = a1;
    ...
    {
      v5 = *(_QWORD *)(*(_QWORD *)(a1 + 3816) + 192LL);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x8Fu, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, a1);
}
