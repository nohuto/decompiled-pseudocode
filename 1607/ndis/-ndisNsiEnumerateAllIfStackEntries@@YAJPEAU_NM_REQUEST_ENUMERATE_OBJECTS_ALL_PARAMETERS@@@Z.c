/*
 * XREFs of ?ndisNsiEnumerateAllIfStackEntries@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C0040EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfStackEntries(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x62u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qD(99LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, v1);
  return v1;
}
