/*
 * XREFs of ndisOidPreIovEnumNicSwitches @ 0x1C0069830
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumNicSwitches(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x13u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1);
...
LABEL_19:
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_qD(0x14u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v3;
}
