/*
 * XREFs of NdisReadNetworkAddress @ 0x1C009EA60
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_HANDLE ConfigurationHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895CF >= 4u )
    WPP_SF_q(0x19u, &WPP_88e16e7e343236ed4c0ce3da79f3a552_Traceguids, (__int64)ConfigurationHandle);
  *Status = -1073741823;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C00895CF >= 4u )
    WPP_SF_q(0x1Au, &WPP_88e16e7e343236ed4c0ce3da79f3a552_Traceguids, (__int64)ConfigurationHandle);
}
