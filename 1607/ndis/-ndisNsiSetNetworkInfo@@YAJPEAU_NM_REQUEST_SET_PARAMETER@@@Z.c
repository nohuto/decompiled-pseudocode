/*
 * XREFs of ?ndisNsiSetNetworkInfo@@YAJPEAU_NM_REQUEST_SET_PARAMETER@@@Z @ 0x1C0041F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetNetworkInfo(struct _NM_REQUEST_SET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x70u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, (__int64)a1);
...
LABEL_32:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qD(113LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, v1);
  return v1;
}
