/*
 * XREFs of ?CheckAllDriversRunning@Initmode@Ndis@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00AA904
 * Callers:
...
char __fastcall Ndis::Initmode::CheckAllDriversRunning(Ndis::Initmode *this, struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  v6 = *((unsigned int *)this + 1270);
  for ( i = 0LL; (_DWORD)i != (_DWORD)v6; i = (unsigned int)(i + 1) )
  {
    if ( (unsigned int)i >= v6 )
      __fastfail(0xBAD0FFu);
    v8 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 636) + 8 * i) + 104LL);
    if ( (*(_DWORD *)(v8 + 48) & 1) != 0 && !*(_QWORD *)(v8 + 56) )
      return 0;
  }
  return 1;
}
