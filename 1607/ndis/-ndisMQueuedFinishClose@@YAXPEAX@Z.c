/*
 * XREFs of ?ndisMQueuedFinishClose@@YAXPEAX@Z @ 0x1C00AC7E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMQueuedFinishClose(void *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_qq(0xFu, &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids, a1, v1);
  ...
  if ( (unsigned __int8)byte_1C00895CD >= 4u )
    WPP_SF_qq(0x10u, &WPP_b02f9d78c57635ef76bd3f6eba54b479_Traceguids, a1, v1);
}
