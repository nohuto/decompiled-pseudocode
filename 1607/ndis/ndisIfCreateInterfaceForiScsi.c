/*
 * XREFs of ndisIfCreateInterfaceForiScsi @ 0x1C00C44B8
 * Callers:
        ...
        UINT32 *a5)
{
  ...
  *(_DWORD *)&ValueName.Length = 1703960;
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qq(0xCFu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, KeyHandle, a2);
  *a5 = -1;
  QueryTable.Flags = 16;
  Context = 0LL;
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qq(0xD0u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, KeyHandle, a2);
