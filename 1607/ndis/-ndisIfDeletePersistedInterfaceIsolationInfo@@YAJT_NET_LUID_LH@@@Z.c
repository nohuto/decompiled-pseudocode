/*
 * XREFs of ?ndisIfDeletePersistedInterfaceIsolationInfo@@YAJT_NET_LUID_LH@@@Z @ 0x1C0040480
 * Callers:
...
__int64 __fastcall ndisIfDeletePersistedInterfaceIsolationInfo(union _NET_LUID_LH a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_dL(191LL, a2, *((unsigned __int16 *)&a1.Info + 3), (a1.Value >> 24) & 0xFFFFFF);
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_llL(192LL, v4, HIWORD(a1.Value), (a1.Value >> 24) & 0xFFFFFF, v5);
