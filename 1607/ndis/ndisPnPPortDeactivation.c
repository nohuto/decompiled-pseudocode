/*
 * XREFs of ndisPnPPortDeactivation @ 0x1C003F694
 * Callers:
      ...
      while ( *v15 )
      {
        ...
        if ( !PortByPortNumber )
        {
          ...
          if ( (unsigned __int8)byte_1C00895DE >= 2u )
            WPP_SF_qD(30LL, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, a1, v5[v14]);
        ...
        if ( *((_DWORD *)PortByPortNumber + 4) != 4 )
        {
          ...
          v19 = 0;
          if ( (unsigned __int8)byte_1C00895DE >= 2u )
            WPP_SF_qD(31LL, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, a1, v5[v14]);
          if ( (Microsoft_Windows_NDISEnableBits & 0x4000000000LL) != 0 )
            Template_jqxqq(
              v5[v14],
              &PnPPortDeactivationFailed,
        ...
        *((_DWORD *)PortByPortNumber + 4) = 2;
        if ( (unsigned __int8)byte_1C00895DE >= 5u )
          WPP_SF_qD(32LL, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, a1, *v15);
        ++v14;
        ++v15;
        if ( v14 >= v6 )
          goto LABEL_42;
