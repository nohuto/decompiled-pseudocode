/*
 * XREFs of ?ndisNsiGetInterfaceRosEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0099200
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x58u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a3);
    v7 = byte_1C00895DD;
    v18 = byte_1C00895DD;
  }
  v8 = (char *)*((_QWORD *)a3 + 5);
...
LABEL_25:
  ...
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qqd(0x59u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a3, v3);
  return v3;
}
