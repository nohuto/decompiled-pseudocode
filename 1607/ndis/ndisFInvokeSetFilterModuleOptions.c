/*
 * XREFs of ndisFInvokeSetFilterModuleOptions @ 0x1C00A1C38
 * Callers:
...
__int64 __fastcall ndisFInvokeSetFilterModuleOptions(__int64 a1)
{
  ...
  if ( *(_QWORD *)(v1 + 168) )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_q(0x6Du, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1);
    v4 = (*(__int64 (__fastcall **)(_QWORD))(v1 + 168))(*(_QWORD *)(a1 + 24));
    v2 = v4;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_qD(0x6Eu, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1, v4);
  }
  else if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    WPP_SF_q(0x6Fu, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1);
  }
  return v2;
}
