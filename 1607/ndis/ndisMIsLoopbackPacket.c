/*
 * XREFs of ndisMIsLoopbackPacket @ 0x1C00550E4
 * Callers:
 ...
 *     NdisPacketSize @ 0x1C001C810 (NdisPacketSize.c)
 *     memset @ 0x1C0027500 (memset.c)
 *     ?NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z @ 0x1C004B130 (-NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z.c)
 *     NdisAllocateBuffer @ 0x1C00502B0 (NdisAllocateBuffer.c)
 *     ndisMCopyFromPacketToBuffer @ 0x1C0053F54 (ndisMCopyFromPacketToBuffer.c)
 *     ethFindMulticast @ 0x1C0061D48 (ethFindMulticast.c)
 */
                ...
                *(_DWORD *)&v24[-1].ProtocolReserved[4] = -1;
                ...
                if ( !(_DWORD)LockState )
                {
                  ...
                  *(_QWORD *)&v24->ProtocolReserved[v28] = v24;
                  ndisMCopyFromPacketToBuffer(a2, v26, Length, v30, (unsigned int *)&LockState);
