/*
 * XREFs of ndisFindMiniportOnGlobalList @ 0x1C00F5300
 * Callers:
...
wchar_t *__fastcall ndisFindMiniportOnGlobalList(PCUNICODE_STRING SourceString)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_q(0x5Du, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)SourceString);
  ...
  if ( result )
  {
    ...
    if ( (unsigned __int8)byte_1C00895D4 >= 4u )
      WPP_SF_q(0x5Eu, &WPP_31395673df433bc870ce0871a9c25aaa_Traceguids, (__int64)v5);
    return (wchar_t *)v5;
  }
  return result;
}
