/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEAT_NET_LUID_LH@@PEAU_NDIS_NSI_INTERFACE_PERSIST_RW@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C00A24F0
 * Callers:
        ...
        enum NdisIfBlockSource a7)
{
  ...
  *(_DWORD *)&Source.Length = 262146;
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqqqq(0x7Eu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a3, a4, a5, a6);
  if ( !a1
...
LABEL_78:
        ...
        v24.Value = (ULONG64)a3->LoopbackIfLuid;
        ...
        *((_QWORD *)v13 + 79) = 1LL;
        if ( v43 )
        {
          RtlInitUnicodeString(&DestinationString, &xmmword_1C0089112);
          ...
          *((_WORD *)v13 + 24) = Destination.Length;
          RtlInitUnicodeString(&DestinationString, &xmmword_1C0089332);
          *(_DWORD *)&Destination.Length = 0x2000000;
...
LABEL_29:
        ...
        *(_GUID *)(v13 + 100) = NetworkGuid;
        v26 = ndisIfProviderHandle;
        if ( a3 )
          v26 = ndisIfLoopbackProviderHandle;
        appended = ndisIfRegisterInterfaceEx((__int64)v26, v24, a6, (struct _NET_IF_INFORMATION *)v13, a7, &v37);
        if ( !appended )
        {
          if ( a3 )
            ndisIfUpdateLoopbackInterfaceOnNetwork(a1, v24);
          goto LABEL_34;
        }
        goto LABEL_78;
      }
...
LABEL_18:
          ...
          *((_DWORD *)v13 + 3) = -1;
          *((_DWORD *)v13 + 4) = -1;
          v18 = (*((unsigned __int8 *)a5 + 1084) >> 1) & 1;
          *((_DWORD *)v13 + 6) = 0;
          v13[40] = 0;
          *((_DWORD *)v13 + 1) = v18 | 0x1C;
          *(_DWORD *)(v13 + 42) = 0;
          *((_WORD *)v13 + 23) = 0;
          ...
          *(_OWORD *)(v13 + 52) = *((_OWORD *)a5 + 65);
          ...
          if ( v22 )
          {
            ...
            *((_WORD *)v13 + 322) = v22;
            *((_DWORD *)v13 + 11) = 44565126;
            memmove(v13 + 646, (char *)a5 + 1090, v22);
            v23 = *((unsigned __int16 *)v13 + 21);
            *((_WORD *)v13 + 339) = v23;
            memmove(v13 + 680, (char *)a5 + 1124, v23);
          }
          goto LABEL_28;
        }
LABEL_16:
