/*
 * XREFs of NdisWriteEventLogEntry @ 0x1C005A990
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Data)
{
  ...
  {
    WPP_SF_qdD(0x2Eu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, (__int64)LogHandle, EventCode, UniqueEventValue);
    v12 = LogHandle;
  }
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_(0x2Fu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids);
  return v7;
}
