/*
 * XREFs of ndisFDoLoopbackNetBufferList @ 0x1C0058484
 * Callers:
...
void __fastcall ndisFDoLoopbackNetBufferList(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqq(0x66u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1, a2, a3);
...
LABEL_38:
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_qqq(0x67u, &WPP_769814ed3e85312f0115d0e4b03a7387_Traceguids, a1, a2, v5);
}
