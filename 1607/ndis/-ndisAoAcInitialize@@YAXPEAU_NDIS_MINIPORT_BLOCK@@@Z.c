/*
 * XREFs of ?ndisAoAcInitialize@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00DCACC
 * Callers:
...
void __fastcall ndisAoAcInitialize(_QWORD *FunctionContext)
{
  ...
  if ( PoolWithTag || (PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x3E0uLL, 0x6D61444Eu)) != 0LL )
  {
  ...
  {
    WPP_SF_q(0xAu, &WPP_1f3fc036deb630b8c59945bf71e899eb_Traceguids, (__int64)FunctionContext);
  }
}
