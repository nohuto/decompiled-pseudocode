/*
 * XREFs of ndisOidPreReceiveFilterCaps @ 0x1C00C3610
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreReceiveFilterCaps(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0xAu, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v1, v5, v3);
    v6 = byte_1C00895D2;
  }
  *((_DWORD *)a1 + 10) = 0;
...
LABEL_23:
  if ( (unsigned __int8)v6 >= 4u )
  {
    v13 = *((_DWORD *)a1 + 10);
    LODWORD(v12) = v4;
    WPP_SF_qqDD(0xBu, &WPP_e0b1f8b808d7390f894176100c6a8720_Traceguids, v1, v5, v12, v13);
  }
  return v4;
}
