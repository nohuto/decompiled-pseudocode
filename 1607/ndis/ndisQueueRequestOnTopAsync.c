/*
 * XREFs of ndisQueueRequestOnTopAsync @ 0x1C0047F94
 * Callers:
...
__int64 __fastcall ndisQueueRequestOnTopAsync(__int64 a1, _LIST_ENTRY *a2)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x3Du, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1, a2);
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqd(62LL, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, a1, a2, v4);
  return v4;
}
