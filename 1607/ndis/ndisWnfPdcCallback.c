/*
 * XREFs of ndisWnfPdcCallback @ 0x1C004FC70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     TemplateEventDescriptor @ 0x1C004E718 (TemplateEventDescriptor.c)
...
__int64 __fastcall ndisWnfPdcCallback(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v14 = 20;
  v4 = 0;
  v5 = ((__int64 (__fastcall *)(__int64, int *, _QWORD *, int *))ExQueryWnfStateData)(a1, &v15, v16, &v14);
  if ( v5 >= 0 )
  {
    ...
    if ( ndisConnectedStandby != v4 )
    {
      ...
      while ( v9 )
      {
        if ( v9->AoAc && ndisReferenceMiniport((__int64)v9, 7u) )
        {
          ...
          ndisDereferenceMiniport((__int64)v9);
        }
  ...
  {
    WPP_SF_d(0x68u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids, v5);
  }
  return 0LL;
}
