/*
 * XREFs of ndisMStartWanSends @ 0x1C00567A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMStartWanSends(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_q(0x20u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1);
  v2 = (__int64 **)(a1 + 128);
  while ( *v2 != (__int64 *)v2 )
  {
    v3 = *v2;
  ...
  if ( (unsigned __int8)byte_1C00895CA >= 4u )
    WPP_SF_q(0x21u, &WPP_98491548b3413749efaf9ab44284e0a4_Traceguids, a1);
  return 0;
}
