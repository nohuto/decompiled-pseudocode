/*
 * XREFs of ndisOidPreIovDeleteVPort @ 0x1C00D9D50
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovDeleteVPort(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x33u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
    v4 = byte_1C00895E1;
  }
  v5 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
...
LABEL_21:
  ...
  {
    v12 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x34u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v5, v12);
  }
  return v5;
}
