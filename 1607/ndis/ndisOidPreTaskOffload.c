/*
 * XREFs of ndisOidPreTaskOffload @ 0x1C00C5C90
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreTaskOffload(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(0xC9u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, v4, v3);
...
LABEL_14:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
  {
    v12 = *(_DWORD *)(a1 + 40);
    LODWORD(v11) = v5;
    WPP_SF_qqDD(0xCAu, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, v4, v11, v12);
  }
  return v5;
}
