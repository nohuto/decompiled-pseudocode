/*
 * XREFs of ndisNetBufferToPacket @ 0x1C004D0E4
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(__int64 a1, char a2, PNDIS_PACKET *a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rdx
  $485E4893DB86C6E41F9F1F07AB0C4B65 *ProtocolReserved; // r9
  _MDL *v10; // rcx
  __int64 v11; // r8
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($485E4893DB86C6E41F9F1F07AB0C4B65 *)v8->ProtocolReserved;
    if ( !a2 )
