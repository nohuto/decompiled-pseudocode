/*
 * XREFs of ?ndisNsiGetNetworkInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00416E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetNetworkInfo(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(0x6Eu, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, (__int64)a1);
...
LABEL_34:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qD(111LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, (unsigned int)v3);
