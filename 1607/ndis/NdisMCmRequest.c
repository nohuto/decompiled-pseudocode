        ...
        PNDIS_REQUEST NdisRequest)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x34u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, NdisAfHandle);
...
LABEL_30:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0x35u, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, NdisAfHandle, NdisRequest);
