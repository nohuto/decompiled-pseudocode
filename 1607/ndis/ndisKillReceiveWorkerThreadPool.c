/*
 * XREFs of ndisKillReceiveWorkerThreadPool @ 0x1C00CC770
 * Callers:
...
void ndisKillReceiveWorkerThreadPool()
{
  ...
  if ( (unsigned __int8)byte_1C00895D3 >= 4u )
    WPP_SF_(0x54u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
  ...
  for ( i = 0LL; (unsigned int)i < ndisMaxNumberOfProcessors; i = (unsigned int)(i + 1) )
  {
    if ( !*((_QWORD *)WPP_MAIN_CB.Dpc.DeferredContext + i) )
      break;
    v2 = (struct _WORK_QUEUE_ITEM *)((char *)WPP_MAIN_CB.DeviceExtension + 32 * (unsigned int)i);
  ...
  if ( (unsigned __int8)byte_1C00895D3 >= 4u )
    WPP_SF_(0x55u, &WPP_79db669c0b7b3867b570cbb53c4c883f_Traceguids);
}
