/*
 * XREFs of ndisQueryPowerCapabilities @ 0x1C00AC57C
 * Callers:
...
__int64 __fastcall ndisQueryPowerCapabilities(char *NdisAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00895D5 >= 4u )
    WPP_SF_q(0xDu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, (__int64)NdisAdapterHandle);
  ...
  if ( *((_QWORD *)NdisAdapterHandle + 487) )
  {
    ...
    if ( Irp )
    {
      ...
      *(_WORD *)&CurrentStackLocation[-1].MajorFunction = 2331;
      ...
      {
        if ( (unsigned __int8)byte_1C00895D5 >= 4u )
          WPP_SF_qD(0xFu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, (__int64)NdisAdapterHandle, v18);
        goto LABEL_15;
      }
...
LABEL_15:
    ...
    if ( (unsigned __int8)byte_1C00895D5 >= 2u )
      WPP_SF_q(0xEu, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, (__int64)NdisAdapterHandle);
    NdisWriteErrorLogEntry(NdisAdapterHandle, 0xC0001389, 0);
    v2 = -1073741670;
  }
LABEL_16:
  if ( (unsigned __int8)byte_1C00895D5 >= 4u )
    WPP_SF_qD(0x10u, &WPP_7b68669345513bc3aa7a551c4dacedad_Traceguids, (__int64)NdisAdapterHandle, v2);
  return v2;
}
