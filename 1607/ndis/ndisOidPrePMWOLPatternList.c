/*
 * XREFs of ndisOidPrePMWOLPatternList @ 0x1C00C9090
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMWOLPatternList(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqq(0x59u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v4, v6, v8);
  v9 = *(_QWORD *)(a1 + 24);
  LOBYTE(a4) = 6;
  if ( v9
...
LABEL_31:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qqqL(0x5Au, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids, v4, v6, v8, *(_DWORD *)(a1 + 40));
  return v7;
}
