/*
 * XREFs of NdisWriteErrorLogEntry @ 0x1C0024CB0
 * Callers:
...
void NdisWriteErrorLogEntry(NDIS_HANDLE NdisAdapterHandle, ULONG ErrorCode, ULONG NumberOfErrorValues, ...)
{
  ...
  {
    WPP_SF_qD(10LL, &WPP_8ce524521b613c0e10407cfbf52a0b71_Traceguids, NdisAdapterHandle, ErrorCode);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(11LL, &WPP_8ce524521b613c0e10407cfbf52a0b71_Traceguids, NdisAdapterHandle, ErrorCode);
}
