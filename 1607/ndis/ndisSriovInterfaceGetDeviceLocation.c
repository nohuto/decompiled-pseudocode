/*
 * XREFs of ndisSriovInterfaceGetDeviceLocation @ 0x1C00DB620
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisSriovInterfaceGetDeviceLocation(__int64 a1, unsigned __int16 a2, _WORD *a3, _BYTE *a4, _BYTE *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895E1 >= 4u )
    WPP_SF_q(0x67u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1);
  ...
  if ( v11 >= 4u )
    WPP_SF_qD(0x68u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, a1, v9);
}
