/*
 * XREFs of ndisCreateAdapterInstanceName @ 0x1C00AEF50
 * Callers:
        ...
        _UNICODE_STRING **a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_q(0xEu, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, (__int64)a3);
  *a1 = 0LL;
  ...
  if ( PoolWithTag )
  {
    ...
    if ( appended < 0 )
    {
      if ( (unsigned __int8)byte_1C00895D4 >= 2u )
      {
        v23 = 17;
LABEL_38:
        WPP_SF_qq(v23, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, a2, a3);
      }
    }
    else
    {
      ...
      {
        if ( (unsigned __int8)byte_1C00895D4 >= 4u )
          WPP_SF_Z(0x13u, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, &v14->Length);
        if ( !v4 )
          goto LABEL_20;
        v15 = 0;
...
LABEL_20:
          *a1 = v14;
          if ( a2 )
          {
            ...
            {
              WPP_SF_Z(0x16u, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, &v14->Length);
            }
          }
          goto LABEL_24;
        }
...
LABEL_24:
  ...
  if ( (unsigned __int8)byte_1C00895D4 >= 2u )
  {
    v22 = 16;
LABEL_33:
    WPP_SF_qq(v22, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, a2, a3);
  }
LABEL_25:
  if ( (unsigned __int8)byte_1C00895D4 >= 4u )
    WPP_SF_qD(0x17u, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, (__int64)a3, appended);
