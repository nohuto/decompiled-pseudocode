/*
 * XREFs of ndisXlateWolPatternListToWakeUpPatternList @ 0x1C00CBC40
 * Callers:
 *     ndisOidPostWakeUpPatternList @ 0x1C004A020 (ndisOidPostWakeUpPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWolPatternListToWakeUpPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v4 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C00895D2 >= 2u )
      WPP_SF_(0x73u, &WPP_cb02054c676b38280cb5aae44c86a7fe_Traceguids);
    return;
  }
  if ( !(_DWORD)v4 )
    return;
