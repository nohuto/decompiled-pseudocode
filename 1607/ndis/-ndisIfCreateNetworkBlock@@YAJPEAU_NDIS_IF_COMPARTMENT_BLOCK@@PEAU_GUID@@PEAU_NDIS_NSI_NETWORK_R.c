/*
 * XREFs of ?ndisIfCreateNetworkBlock@@YAJPEAU_NDIS_IF_COMPARTMENT_BLOCK@@PEAU_GUID@@PEAU_NDIS_NSI_NETWORK_RW@@PEAPEAU_NDIS_IF_NETWORK_BLOCK@@@Z @ 0x1C001D40C
 * Callers:
        ...
        _LIST_ENTRY ***a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qq(124LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2);
...
LABEL_18:
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqqL(125LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, *a4, v8);
  return v8;
}
