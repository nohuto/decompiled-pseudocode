/*
 * XREFs of NdisRegisterProtocol @ 0x1C00CF100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisRegisterProtocol(int *a1, __int64 *a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895CC >= 4u )
    WPP_SF_Z(0xEu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, (unsigned __int16 *)(a3 + 88));
...
LABEL_8:
  *a1 = v4;
  ...
  {
    LODWORD(v16) = v4;
    WPP_SF_qZL(0xFu, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, v9, (unsigned __int16 *)(a3 + 88), v16);
  }
