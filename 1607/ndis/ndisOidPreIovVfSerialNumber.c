/*
 * XREFs of ndisOidPreIovVfSerialNumber @ 0x1C00DAFE0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVfSerialNumber(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x4Fu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
    v5 = byte_1C00895E1;
  }
...
LABEL_14:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x50u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v4, v9);
  }
  return v4;
}
