/*
 * XREFs of ndisOidPreIovPfLuid @ 0x1C00DA400
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovPfLuid(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x4Du, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v3, v1);
    v5 = byte_1C00895E1;
  }
  if ( *(_DWORD *)(v1 + 4) )
    goto LABEL_12;
...
LABEL_14:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x4Eu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, (__int64)v3, v4, v9);
  }
  return v4;
}
