/*
 * XREFs of ndisPreOffloadAdminSettings @ 0x1C00C6080
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisPreOffloadAdminSettings(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qq(0xD8u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, v3);
  v4 = 1;
  if ( *(_DWORD *)(v3 + 4) != 1 )
    goto LABEL_4;
  if ( !*(_QWORD *)a1 )
...
LABEL_61:
  if ( (unsigned __int8)byte_1C00895D2 >= 4u )
    WPP_SF_qdD(0xD9u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v1, *(_DWORD *)(a1 + 40), v4);
  return v4;
}
