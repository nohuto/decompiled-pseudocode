/*
 * XREFs of ndisDoesSystemSupportSriov @ 0x1C00ADB04
 * Callers:
...
void ndisDoesSystemSupportSriov()
{
  ...
  {
    WPP_SF_(0x7Fu, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids);
    v0 = byte_1C00895E1;
  }
  _RAX = 1LL;
  __asm { cpuid }
...
LABEL_4:
  ...
  if ( ndisSriovSupportTestOverride )
  {
    ...
    {
      WPP_SF_(0x80u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids);
      v0 = byte_1C00895E1;
    }
    v6 = 1;
  ...
  if ( (unsigned __int8)v0 >= 4u )
  {
    ...
    if ( v6 != 1 )
      v22 = L"No";
    WPP_SF_S(0x81u, &WPP_66e150bf10bd3961f505aba1a8a4f7d8_Traceguids, v22);
  }
}
