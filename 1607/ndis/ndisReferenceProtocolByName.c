/*
 * XREFs of ndisReferenceProtocolByName @ 0x1C00F43A4
 * Callers:
...
__int64 __fastcall ndisReferenceProtocolByName(PCUNICODE_STRING SourceString, __int64 *a2, char a3, unsigned __int8 a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895CC >= 4u )
    WPP_SF_Z(0x23u, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, &SourceString->Length);
...
LABEL_24:
  if ( (unsigned __int8)byte_1C00895CC >= 4u )
    WPP_SF_qD(0x24u, &WPP_5a7dd1586dbc3ec36657a43c35bc8834_Traceguids, *a2, v8);
  return v8;
}
