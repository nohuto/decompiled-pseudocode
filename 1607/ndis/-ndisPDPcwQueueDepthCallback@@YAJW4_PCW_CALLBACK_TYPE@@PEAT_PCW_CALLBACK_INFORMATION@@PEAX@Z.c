/*
 * XREFs of ?ndisPDPcwQueueDepthCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C00709B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPDPcwQueueDepthCallback(int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  v5 = 0;
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v19, (struct KPushLockBase *)(qword_1C0089668 + 8));
  v6 = qword_1C0089668;
  v7 = qword_1C0089668 + 16;
  v8 = *(_QWORD **)(qword_1C0089668 + 16);
  while ( v8 != (_QWORD *)v7 )
  {
    v9 = (__int64 *)v8[6];
    if ( v9 != v8 + 6 )
