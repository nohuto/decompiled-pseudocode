/*
 * XREFs of ?ndisPauseFilterInner@@YAXPEAU_NDIS_FILTER_BLOCK@@K@Z @ 0x1C00E7430
 * Callers:
...
void __fastcall ndisPauseFilterInner(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xAu, &WPP_95145dda949833bd55dad319dd5d3165_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xCu, &WPP_95145dda949833bd55dad319dd5d3165_Traceguids, (__int64)a1);
}
