/*
 * XREFs of ndisOidPreQosSetParameters @ 0x1C00C5990
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreQosSetParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x80u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v1);
    v5 = byte_1C00895D2;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
  {
...
LABEL_21:
  if ( (unsigned __int8)v5 >= 4u )
  {
    ...
    WPP_SF_qdD(0x81u, &WPP_aebdfe7d38b7359b1048ceacddaf5972_Traceguids, v3, v4, v9);
  }
  return v4;
}
