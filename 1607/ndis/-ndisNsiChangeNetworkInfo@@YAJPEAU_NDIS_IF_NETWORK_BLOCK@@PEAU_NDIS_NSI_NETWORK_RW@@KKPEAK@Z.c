/*
 * XREFs of ?ndisNsiChangeNetworkInfo@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@PEAU_NDIS_NSI_NETWORK_RW@@KKPEAK@Z @ 0x1C00407B0
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qq(0x74u, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2);
  v10 = a3;
  v34 = a3;
  v11 = a4;
  v12 = -1073741811;
...
LABEL_11:
  ...
  *a5 = v16;
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_qqd(117LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1, a2, v9);
  return v9;
}
