/*
 * XREFs of ndisCreateNotifyQueue @ 0x1C00F3E80
 * Callers:
...
__int64 __fastcall ndisCreateNotifyQueue(__int64 a1, __int64 a2, __int64 a3, _QWORD **a4)
{
  ...
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_qq(0xCu, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, a1, a2);
  *a4 = 0LL;
  if ( a2 )
  {
    ...
    if ( (*(_DWORD *)(a2 + 224) & 0x18000) == 0 )
    {
      ...
      while ( v9 )
      {
        ...
        if ( !PoolWithTag )
        {
          if ( (unsigned __int8)byte_1C00895DA >= 2u )
            WPP_SF_(0xDu, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
          v8 = -1073741670;
          break;
        }
      ...
      while ( 1 )
      {
        if ( *(_QWORD *)(*(_QWORD *)(v12 + 24) + 200LL) )
        {
          ...
          else
          {
            ...
            {
              if ( (unsigned __int8)byte_1C00895DA >= 2u )
                WPP_SF_(0xEu, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids);
              v8 = -1073741670;
...
LABEL_30:
  if ( (unsigned __int8)byte_1C00895DA >= 4u )
    WPP_SF_qqd(0xFu, &WPP_3d0b798491933f9ef0d7aa79c6629068_Traceguids, a1, a2, v8);
  return v8;
}
