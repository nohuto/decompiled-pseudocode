/*
 * XREFs of ndisIfUpdateFilterIfStack @ 0x1C001A948
 * Callers:
...
void __fastcall ndisIfUpdateFilterIfStack(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(201LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1);
...
LABEL_4:
  ...
  if ( (unsigned __int8)byte_1C00895DD >= 4u )
    WPP_SF_q(202LL, &WPP_85e9149e4b3435a752b049efc8d5abea_Traceguids, a1);
}
