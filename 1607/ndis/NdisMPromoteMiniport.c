/*
 * XREFs of NdisMPromoteMiniport @ 0x1C005CB70
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMPromoteMiniport(NDIS_HANDLE MiniportHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x64u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, (__int64)MiniportHandle);
  ...
  *((_DWORD *)MiniportHandle + 464) = 727504;
  if ( v4
...
LABEL_16:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x65u, &WPP_6aaf1c75542c3fb73373be6b27303be0_Traceguids, (__int64)MiniportHandle);
