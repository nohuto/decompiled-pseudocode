/*
 * XREFs of CiDispatchFastIoDeviceControl @ 0x1C000A2A0
 * Callers:
 *     <none>
 * Callees:
 *     CiSchedulerTaskIndexYield @ 0x1C00010B0 (CiSchedulerTaskIndexYield.c)
 ...
 *     WPP_SF_dd @ 0x1C0004424 (WPP_SF_dd.c)
  ...
  if ( (unsigned int)v13 < 8 && (a7 & 0xFFFFE003) == 0x222003 )
  {
      ...
      && Length == dword_1C00065B4[2 * v13] )
    {
      ...
      if ( (_DWORD)v13 == 5 )
      {
        ...
        CiSchedulerTaskIndexYield(v20, v11, HIDWORD(v19));
      }
      else
      {
        if ( (_DWORD)v13 == 7 )
        ...
        {
          case 0:
            TaskIndexClientFromThread = CiThreadSetRelativePriority(v20, (unsigned __int8)v19);
            break;
          case 1:
            TaskIndexClientFromThread = 0;
