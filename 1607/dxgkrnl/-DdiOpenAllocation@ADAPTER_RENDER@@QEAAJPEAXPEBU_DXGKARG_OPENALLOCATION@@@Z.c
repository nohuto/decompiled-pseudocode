/*
 * XREFs of ?DdiOpenAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_OPENALLOCATION@@@Z @ 0x1C0144404
 * Callers:
        ...
        const struct _DXGKARG_OPENALLOCATION *a3)
{
  ...
  DXGPROCESSDDILOCK::DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)v37, ProcessDxgProcess);
...
LABEL_13:
  ...
  v19 = *(_DWORD *)(v14 + 136);
LABEL_14:
  v21 = (*(int (__fastcall **)(void *, const struct _DXGKARG_OPENALLOCATION *))(*((_QWORD *)this + 2) + 584LL))(a2, a3);
  ...
  v29[3] = v21;
  v29[4] = a2;
  v29[5] = a3->pOpenAllocation->hAllocation;
  v29[6] = a3->pOpenAllocation->pPrivateDriverData;
  pOpenAllocation = a3->pOpenAllocation;
  v29[7] = pOpenAllocation->hDeviceSpecificAllocation;
  if ( (_DWORD)v21 != -1073741811 && (_DWORD)v21 != -1073741801 && (_DWORD)v21 )
  {
    v31 = WdLogNewEntry5_WdError(pOpenAllocation);
    *(_QWORD *)(v31 + 24) = v21;
    WdLogEvent5_WdError(v31);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( !a3->pOpenAllocation->hDeviceSpecificAllocation && (int)v21 >= 0 )
  {
    v33 = WdLogNewEntry5_WdAssertion(v32);
    *(_QWORD *)(v33 + 24) = 2263LL;
    WdLogEvent5_WdAssertion(v33);
  }
  DXGAUTOPUSHLOCK::Release((DXGAUTOPUSHLOCK *)v37);
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v34, &EventProfilerExit, v35, 5028);
