/*
 * XREFs of ?ReleaseModeInfo@DXGDMM_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORSOURCEMODESET__@@QEBU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C01B1FB0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  else
  {
    ...
    v18 = (struct _ERESOURCE *)((char *)v13 + 240);
    v11 = v17;
    ExReleaseResourceLite(v18);
    KeLeaveCriticalRegion();
  }
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v9, &EventProfilerExit, v10, 6001);
  return v11;
}
