/*
 * XREFs of ?DxgEscapeEvictByNtHandle@@YAJPEAU_D3DKMT_VIDMM_ESCAPE@@@Z @ 0x1C016858C
 * Callers:
...
__int64 __fastcall DxgEscapeEvictByNtHandle(struct _D3DKMT_VIDMM_ESCAPE *a1)
{
  ...
  struct _OBJECT_HANDLE_INFORMATION v20; // [rsp+A8h] [rbp+10h] BYREF
