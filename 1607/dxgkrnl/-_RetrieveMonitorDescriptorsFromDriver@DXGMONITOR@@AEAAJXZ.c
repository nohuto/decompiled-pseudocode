/*
 * XREFs of ?_RetrieveMonitorDescriptorsFromDriver@DXGMONITOR@@AEAAJXZ @ 0x1C00F03AC
 * Callers:
...
__int64 __fastcall DXGMONITOR::_RetrieveMonitorDescriptorsFromDriver(DXGMONITOR *this)
{
  ...
  while ( 1 )
  {
    v4 = operator new(0x9FuLL, 0x4D677844u, PagedPool);
    v7 = v4;
    if ( !v4 )
    {
    ...
    MonitorDescriptor = DpiGetMonitorDescriptor(*((_QWORD *)this + 5), v3 << 7, v6, (__int64)(v4 + 6));
