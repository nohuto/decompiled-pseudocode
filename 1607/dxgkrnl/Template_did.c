/*
 * XREFs of Template_did @ 0x1C0028798
 * Callers:
...
NTSTATUS __fastcall Template_did(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v10 = &a6;
  v11 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventBltQueueCompleteIndirectPresent, 0LL, 3u, &UserData);
}
