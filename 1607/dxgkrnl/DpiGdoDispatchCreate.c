/*
 * XREFs of DpiGdoDispatchCreate @ 0x1C00D11E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiGdoDispatchCreate(__int64 a1, IRP *a2)
{
  ...
  {
    v6 = dword_1C0057170 != 4 ? 0xC0000001 : 0;
  }
  else
  {
    KeEnterCriticalRegion();
    v4 = (struct _ERESOURCE *)(v3 + 3584);
    ExAcquireResourceExclusiveLite((PERESOURCE)(v3 + 3584), 1u);
    v5 = *(_DWORD *)(v3 + 236);
