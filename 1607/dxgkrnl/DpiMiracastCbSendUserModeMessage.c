/*
 * XREFs of DpiMiracastCbSendUserModeMessage @ 0x1C0196C80
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v8 = a3;
  v9 = Size;
  if ( P && P[4] == 1953656900 && P[5] == 14 && *((_QWORD *)P + 55) )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200000) != 0 )
    {
      v25 = 0;
      Sizec = Size;
      Template_xqqppq((__int64)P, &EventEnterDxgkCbSendUserModeMessage, a3, *((_QWORD *)P + 12), Sizec, a4, a6, a7, v25);
    }
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200000) != 0 )
    {
      ...
      LODWORD(v24) = a4;
      LODWORD(Sizeb) = v9;
      Template_xqqppq(v14, &EventLeaveDxgkCbSendUserModeMessage, v15, *((_QWORD *)P + 12), Sizeb, v24, a6, a7, v26);
    }
