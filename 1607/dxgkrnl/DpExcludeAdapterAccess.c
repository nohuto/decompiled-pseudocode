/*
 * XREFs of DpExcludeAdapterAccess @ 0x1C0192260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpExcludeAdapterAccess(PDEVICE_OBJECT DeviceObject, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( !DeviceObject || !a3 )
  {
    ...
    v28 = WdLogNewEntry5_WdError(DeviceObject);
...
LABEL_32:
  ...
  if ( ((*((_DWORD *)DeviceExtension + 942) - 1) & 0xFFFFFFFB) == 0 )
  {
    v12 = -1073741661LL;
LABEL_29:
    LODWORD(v13) = v12;
...
LABEL_10:
  ...
  v16 = a2 & 2;
  if ( (a2 & 2) != 0 && ((a2 & 1) != 0 || !DxgkIsAdapterCoreSyncAcquired(*((DXGADAPTER **)DeviceExtension + 461), 2)) )
  {
  ...
  if ( (a2 & 4) != 0 && (!*((_QWORD *)DeviceExtension + 340) || !*((_QWORD *)DeviceExtension + 341)) )
  {
    LODWORD(v13) = -1073741637;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)PoolWithTag + 14) = 13;
    v22 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)DeviceExtension + 2, WorkItem, &byte_1C00FF410, 1u, 0x20u);
    v13 = v22;
    if ( v22 >= 0 )
    {
