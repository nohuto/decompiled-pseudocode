/*
 * XREFs of Template_xtq @ 0x1C002F68C
 * Callers:
...
NTSTATUS Template_xtq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndirectDisableRenderD3, 0LL, 3u, &UserData);
}
