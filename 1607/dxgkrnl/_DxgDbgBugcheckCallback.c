/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C00229D0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C0058018 )
    {
      v4 = (unsigned int)(dword_1C0058014 - 1);
      if ( dword_1C0058014 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C0058018) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C0057318;
      ReasonSpecificData[4] = qword_1C0058018;
      v8 = *((_DWORD *)ReasonSpecificData + 3);
      *((_OWORD *)ReasonSpecificData + 1) = v7;
      if ( v6 < v8 )
        v8 = v6;
      *((_DWORD *)ReasonSpecificData + 10) = v8;
    }
    else
    {
      v5 = ReasonSpecificData[4] == 0LL;
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C0057318;
      if ( v5 )
      {
