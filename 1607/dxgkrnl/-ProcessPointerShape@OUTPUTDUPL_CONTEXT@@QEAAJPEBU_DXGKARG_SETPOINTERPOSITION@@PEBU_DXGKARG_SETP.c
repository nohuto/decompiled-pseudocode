/*
 * XREFs of ?ProcessPointerShape@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1C0181FD0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *((_DWORD *)this + 80) )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = 1986LL;
    return 0LL;
  }
  else
  {
    updated = DXGDXGIKEYEDMUTEX::OpenLocalMutex(this[*((unsigned int *)this + 11) + 6], 2, (__int64)a3);
    if ( updated >= 0 )
    {
      v12 = 0LL;
      v11 = 2;
