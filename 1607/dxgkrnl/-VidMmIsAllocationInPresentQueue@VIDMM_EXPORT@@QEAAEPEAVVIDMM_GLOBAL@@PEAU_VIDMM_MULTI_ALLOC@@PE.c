/*
 * XREFs of ?VidMmIsAllocationInPresentQueue@VIDMM_EXPORT@@QEAAEPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@PEAI@Z @ 0x1C001EE64
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  LOBYTE(this) = (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, struct _VIDMM_MULTI_ALLOC *, unsigned int *))(*((_QWORD *)this + 1) + 688LL))(
                   a2,
                   a3,
                   a4);
