/*
 * XREFs of DpiProcessMiracastNotifyInterrupt @ 0x1C002CE90
 * Callers:
  ...
  if ( v3 && *(_DWORD *)(v3 + 16) == 1953656900 && *(_DWORD *)(v3 + 20) == 2 )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200000) != 0 )
      Template_xqqqqqqqq(
        ...
        *(_DWORD *)(a2 + 48),
        *(_DWORD *)(a2 + 52));
    if ( *(_QWORD *)(v3 + 3040) && !*(_BYTE *)(v3 + 3057) )
    {
      if ( *(_DWORD *)(a2 + 8) == *(_DWORD *)(v3 + 3032) && *(_DWORD *)(a2 + 48) <= *(_DWORD *)(v3 + 3024) )
      {
        v7 = MIRACAST_CHUNK_LIST::RemoveHead(*(MIRACAST_CHUNK_LIST **)(v3 + 3064));
        v12 = v7;
        if ( v7 )
        {
