/*
 * XREFs of ?DdiRenderGdi@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_RENDERGDI@@@Z @ 0x1C014419C
 * Callers:
...
LABEL_13:
  ...
  v19 = *(_DWORD *)(v14 + 136);
LABEL_14:
  v21 = (*(int (__fastcall **)(void *, struct _DXGKARG_RENDERGDI *))(*((_QWORD *)this + 2) + 800LL))(a2, a3);
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v32, &EventProfilerExit, v33, 5066);
