/*
 * XREFs of ?SetupPresentParameters@BLTENTRY@@QEAAJPEAVBLTQUEUE@@PEAVDXGCONTEXT@@PEBU_D3DKMT_PRESENT@@PEBU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@E@Z @ 0x1C0184B38
 * Callers:
        ...
        unsigned __int8 a7)
{
  ...
  if ( v12 < *(_DWORD *)(v11 + 224)
    && (v14 = *(_QWORD *)(v11 + 208), v15 = *(_DWORD *)(v14 + 16LL * v12 + 8), v13 == ((v15 >> 4) & 3))
    && (v15 & 0x1000) == 0
    && (v15 & 0xF) != 0
...
LABEL_14:
  ...
  if ( !a7 )
  {
    ...
    if ( *(_QWORD *)(v21 + 16) != *(_QWORD *)(*((_QWORD *)a3[2] + 2) + 16LL) )
    {
