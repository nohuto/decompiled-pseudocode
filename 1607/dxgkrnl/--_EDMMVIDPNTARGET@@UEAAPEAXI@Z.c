/*
 * XREFs of ??_EDMMVIDPNTARGET@@UEAAPEAXI@Z @ 0x1C0003550
 * Callers:
 *     ??_EDMMVIDPNTARGET@@WCA@EAAPEAXI@Z @ 0x1C0012CB0 (--_EDMMVIDPNTARGET@@WCA@EAAPEAXI@Z.c)
 *     ??_EDMMVIDPNTARGET@@WDA@EAAPEAXI@Z @ 0x1C0012CC0 (--_EDMMVIDPNTARGET@@WDA@EAAPEAXI@Z.c)
 *     ??_EDMMVIDPNTARGET@@WFA@EAAPEAXI@Z @ 0x1C0012CD0 (--_EDMMVIDPNTARGET@@WFA@EAAPEAXI@Z.c)
 * Callees:
...
DMMVIDPNTARGET *__fastcall DMMVIDPNTARGET::`vector deleting destructor'(DMMVIDPNTARGET *this, char a2)
{
  ...
  *((_QWORD *)this + 6) = &SignedWithClassSignature<DMMVIDPNTARGET>::`vftable';
  *((_QWORD *)this + 4) = &ContainedBy<DMMVIDPNTARGETSET>::`vftable';
  *((_QWORD *)this + 5) = 0LL;
