/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x1C00FAF90
 * Callers:
 *     DpiReadSystemFirmwareTable @ 0x1C00FAF20 (DpiReadSystemFirmwareTable.c)
 *     DpiEnumSystemFirmwareTables @ 0x1C01965D0 (DpiEnumSystemFirmwareTables.c)
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  if ( KeGetCurrentIrql() )
  {
    ...
    v18 = (_QWORD *)WdLogNewEntry5_WdCriticalError(a1, a2, a3);
    v18[3] = 275LL;
    v18[4] = 21LL;
    v18[5] = -1073741811LL;
