/*
 * XREFs of ?DdiCheckMultiPlaneOverlaySupport@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT@@@Z @ 0x1C014A8B0
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiCheckMultiPlaneOverlaySupport@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT@@@Z @ 0x1C0021F60 (-ADAPTER_DISPLAY_DdiCheckMultiPlaneOverlaySupport@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_CHECKMUL.c)
...
LABEL_14:
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v27, &EventProfilerExit, v28, 5055);
