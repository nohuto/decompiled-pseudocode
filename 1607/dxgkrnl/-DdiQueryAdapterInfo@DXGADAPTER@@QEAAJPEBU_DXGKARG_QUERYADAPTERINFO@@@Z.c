/*
 * XREFs of ?DdiQueryAdapterInfo@DXGADAPTER@@QEAAJPEBU_DXGKARG_QUERYADAPTERINFO@@@Z @ 0x1C009F708
 * Callers:
 *     DXGADAPTER_DdiQueryAdapterInfo @ 0x1C0010BE0 (DXGADAPTER_DdiQueryAdapterInfo.c)
...
LABEL_25:
  v14 = 0;
LABEL_12:
  v16 = (*((int (__fastcall **)(_QWORD, const struct _DXGKARG_QUERYADAPTERINFO *))this + 39))(
          *((_QWORD *)this + 30),
          a2);
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v21, &EventProfilerExit, v22, 5000);
