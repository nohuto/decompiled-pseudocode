/*
 * XREFs of ?CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z @ 0x1C001D880
 * Callers:
 *     DxgkCompletePStateTransitionCB @ 0x1C0022250 (DxgkCompletePStateTransitionCB.c)
 * Callees:
 *     Template_pqqq @ 0x1C001E928 (Template_pqqq.c)
 *     ?RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z @ 0x1C0025C98 (-RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z.c)
 */
...
void __fastcall DXGADAPTER::CompletePStateTransitionCB(DXGADAPTER *this, int a2, unsigned int a3)
{
  ...
  if ( *((_QWORD *)this + 272) )
  {
    v5 = *(_QWORD *)(520LL * ((unsigned __int16)a2 + (unsigned int)*((unsigned __int16 *)this + HIWORD(a2) + 1092))
                   + *((_QWORD *)this + 271)
                   + 512);
    if ( bTracingEnabled )
    {
