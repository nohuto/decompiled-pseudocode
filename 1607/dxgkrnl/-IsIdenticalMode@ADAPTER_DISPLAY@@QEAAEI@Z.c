/*
 * XREFs of ?IsIdenticalMode@ADAPTER_DISPLAY@@QEAAEI@Z @ 0x1C001ED1C
 * Callers:
...
char __fastcall ADAPTER_DISPLAY::IsIdenticalMode(DXGADAPTER **this, unsigned int a2)
{
  ...
  v4 = this[14];
  v5 = 1016 * v3;
  if ( ((*((_DWORD *)v4 + 254 * v3 + 223) - 2) & 0xFFFFFFFD) != 0 )
  {
    if ( *(_DWORD *)((char *)v4 + v5 + 864) != *(_DWORD *)((char *)v4 + v5 + 644) )
      return 0;
    v6 = *(_DWORD *)((char *)v4 + v5 + 648);
  }
  else
  {
    if ( *(_DWORD *)((char *)v4 + v5 + 864) != *(_DWORD *)((char *)v4 + v5 + 648) )
      return 0;
    v6 = *(_DWORD *)((char *)v4 + v5 + 644);
  }
  if ( *(_DWORD *)((char *)v4 + v5 + 868) != v6 )
    return 0;
  ...
  if ( *(_DWORD *)((char *)v10 + v5 + 652)
    ...
    || *(_DWORD *)((char *)v10 + v5 + 660) != *(_DWORD *)((char *)v10 + v5 + 864)
    || *(_DWORD *)((char *)v10 + v5 + 664) != *(_DWORD *)((char *)v10 + v5 + 868) )
  {
    return 0;
  }
  return v9;
