/*
 * XREFs of ?SaveManagedPrimaryState@MANAGEDPRIMARIESTRACKER@@QEAAXPEAVDXGDEVICE@@I@Z @ 0x1C0073F88
 * Callers:
      ...
      if ( (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*(DXGADAPTER ***)this, v7) - 1 <= 1 )
      {
        ...
        if ( a2 != VidPnSourceOwner || !_bittest(&a3, v7) )
        {
          ...
          *((_DWORD *)this + v7 + 86) ^= (*((_DWORD *)this + v7 + 86) ^ ((unsigned __int8)BYTE1(*((_DWORD *)VidPnSourceOwner
                                                                                                + v7
                                                                                                + 250)) << 8)) & 0x100;
          *((_DWORD *)this + v7 + 86) ^= ((unsigned __int16)*((_DWORD *)this + v7 + 86) ^ (unsigned __int16)((unsigned __int8)(*((_DWORD *)VidPnSourceOwner + v7 + 250) >> 9) << 9)) & 0x200;
          *((_QWORD *)this + v7 + 19) = DXGDEVICE::GetDisplayedPrimary(VidPnSourceOwner, v7);
          DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v14, v10 + 26);
          v11 = *((_DWORD *)v10 + v7 + 234);
