/*
 * XREFs of DpiLdaLinkDeviceToChain @ 0x1C019DAFC
 * Callers:
...
__int64 __fastcall DpiLdaLinkDeviceToChain(__int64 a1)
{
  ...
  if ( *(_QWORD *)v4 != v4 )
  {
    do
    {
      ...
      if ( *(_BYTE *)(v9 + 508) == 1 || *(_DWORD *)(v8 + 2600) >= *(_DWORD *)(v8 + 504) )
      {
        v2 = -1071774666;
      ...
      *(_QWORD *)(v9 + 2592) = *(_QWORD *)(v8 + 24);
      *(_DWORD *)(v9 + 2600) = *(_DWORD *)(v8 + 2600);
      *(_QWORD *)(*(_QWORD *)(v8 + 2592) + 8LL * (unsigned int)(*(_DWORD *)(v8 + 2600))++) = *(_QWORD *)(v9 + 24);
      if ( *(_BYTE *)(v9 + 1136) )
        *(_BYTE *)(v8 + 1138) = 1;
      if ( *(_BYTE *)(v4 + 483) )
