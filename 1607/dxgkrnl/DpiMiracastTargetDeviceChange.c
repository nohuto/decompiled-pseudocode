/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1C002C600
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v6 )
  {
    ...
    if ( v8 )
    {
      ...
      else
      {
        ...
        v15 = (void *)*((_QWORD *)Context + 51);
        v16 = *((_DWORD *)Context + 104) == 0;
        *((_QWORD *)Context + 51) = 0LL;
        *((_QWORD *)Context + 11) = 0LL;
        ...
        if ( v15 )
        {
          ...
          *((_QWORD *)Context + 11) = KeGetCurrentThread();
          v22 = *((_DWORD *)Context + 104);
          if ( v22 )
          {
            *((_DWORD *)Context + 105) = v22;
            *((_DWORD *)Context + 104) = 0;
          ...
          *v24 = v23;
          v23[1] = v24;
          v25 = (char **)qword_1C00571E8;
          if ( *(__int64 **)qword_1C00571E8 != &qword_1C00571E0 )
            __fastfail(3u);
          *(_QWORD *)Context = &qword_1C00571E0;
          *((_QWORD *)Context + 1) = v25;
          *v25 = Context;
          qword_1C00571E8 = (__int64)Context;
          ...
          v27 = (void *)*((_QWORD *)Context + 43);
          if ( v27 )
          {
            ExFreePoolWithTag(v27, 0);
            *((_QWORD *)Context + 43) = 0LL;
          }
          v28 = (void *)*((_QWORD *)Context + 44);
          if ( v28 )
          {
            ExFreePoolWithTag(v28, 0);
            *((_QWORD *)Context + 44) = 0LL;
          }
          v29 = (void *)*((_QWORD *)Context + 45);
          if ( v29 )
          {
            ExFreePoolWithTag(v29, 0);
            *((_QWORD *)Context + 45) = 0LL;
          }
          v30 = (void *)*((_QWORD *)Context + 46);
          if ( v30 )
          {
            ExFreePoolWithTag(v30, 0);
            *((_QWORD *)Context + 46) = 0LL;
          }
          v31 = (void *)*((_QWORD *)Context + 47);
          if ( v31 )
          {
            ExFreePoolWithTag(v31, 0);
            *((_QWORD *)Context + 47) = 0LL;
          }
