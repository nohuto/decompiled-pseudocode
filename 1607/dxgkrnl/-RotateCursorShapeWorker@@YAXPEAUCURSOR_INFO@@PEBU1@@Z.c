/*
 * XREFs of ?RotateCursorShapeWorker@@YAXPEAUCURSOR_INFO@@PEBU1@@Z @ 0x1C016F938
 * Callers:
 ...
 * Callees:
 *     ?GetRotatedPoint@@YAXIIPEAI0W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@II@Z @ 0x1C016F62C (-GetRotatedPoint@@YAXIIPEAI0W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@II@Z.c)
 */
  ...
  for ( i = v2; v3 < v2; ++v3 )
  {
    ...
    if ( v4 )
    {
      ...
      do
      {
        if ( *((_DWORD *)a1 + 9) )
        {
          v10 = (*(_BYTE *)((v8 >> 3) + v3 * *((_DWORD *)a2 + 4) + *((_QWORD *)a2 + 3)) >> (7 - (v7 & 7))) & 1;
          GetRotatedPoint(
            v7,
            v3,
            &v14,
