/*
 * XREFs of ?CopyPresentArgs@DXGCONTEXT@@QEAAJPEAU_D3DKMT_PRESENT@@PEAVDXGPROCESS@@@Z @ 0x1C001C950
 * Callers:
...
__int64 __fastcall DXGCONTEXT::CopyPresentArgs(DXGPRESENT **this, struct _D3DKMT_PRESENT *a2, struct DXGPROCESS *a3)
{
  ...
  {
    if ( this[17] )
      return DXGPRESENT::CopyPresentArgs(this[17], (struct DXGCONTEXT *)this, a2);
    v9 = (DXGPRESENT *)DXGQUOTAALLOCATOR<1,1265072196>::operator new(0x668uLL);
    if ( v9 )
      v9 = DXGPRESENT::DXGPRESENT(v9, *((_DWORD *)this[2] + 716));
    this[17] = v9;
    if ( v9 )
    {
      return DXGPRESENT::CopyPresentArgs(this[17], (struct DXGCONTEXT *)this, a2);
