/*
 * XREFs of ?DxgkCddSetPointerShape@@YAJQEAXPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@IIH@Z @ 0x1C0078BC0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a6)
{
  ...
  if ( Global && *((_BYTE *)Global + 1000) )
    ...
    return DxgkSetPointerShape(a1, a2, a3, a4, a5, a6);
}
