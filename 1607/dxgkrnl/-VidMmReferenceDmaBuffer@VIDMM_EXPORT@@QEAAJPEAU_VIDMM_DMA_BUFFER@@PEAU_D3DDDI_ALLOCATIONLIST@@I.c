/*
 * XREFs of ?VidMmReferenceDmaBuffer@VIDMM_EXPORT@@QEAAJPEAU_VIDMM_DMA_BUFFER@@PEAU_D3DDDI_ALLOCATIONLIST@@IEJPEAKPEAT_LARGE_INTEGER@@PEA_KPEAPEAUVIDMM_ALLOC@@PEAU_VIDMM_PRIMARIES_REFERENCES@@PEAPEAVDXGALLOCATION@@@Z @ 0x1C001CED0
 * Callers:
        ...
        struct DXGALLOCATION **a12)
{
  ...
  LOBYTE(v17) = a5;
  LODWORD(this) = (*(__int64 (__fastcall **)(struct _VIDMM_DMA_BUFFER *, struct _D3DDDI_ALLOCATIONLIST *, _QWORD, __int64, int, unsigned int *, union _LARGE_INTEGER *, unsigned __int64 *, char *, struct VIDMM_ALLOC **, struct _VIDMM_PRIMARIES_REFERENCES *, struct DXGALLOCATION **))(*((_QWORD *)this + 1) + 568LL))(
                    a2,
                    a3,
                    a4,
                    v17,
