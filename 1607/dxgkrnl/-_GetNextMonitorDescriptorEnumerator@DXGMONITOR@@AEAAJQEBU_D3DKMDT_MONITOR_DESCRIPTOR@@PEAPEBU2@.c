/*
 * XREFs of ?_GetNextMonitorDescriptorEnumerator@DXGMONITOR@@AEAAJQEBU_D3DKMDT_MONITOR_DESCRIPTOR@@PEAPEBU2@@Z @ 0x1C00F1A2C
 * Callers:
...
LABEL_19:
  ...
  if ( v15 )
  {
    ...
    v21 = (struct _D3DKMDT_MONITOR_DESCRIPTOR **)*((_QWORD *)v7 + 1);
    v22 = (struct _D3DKMDT_MONITOR_DESCRIPTOR *)&v17[1];
    if ( *v21 != (struct _D3DKMDT_MONITOR_DESCRIPTOR *)v7 )
      __fastfail(3u);
    *(_QWORD *)&v22->Id = v7;
