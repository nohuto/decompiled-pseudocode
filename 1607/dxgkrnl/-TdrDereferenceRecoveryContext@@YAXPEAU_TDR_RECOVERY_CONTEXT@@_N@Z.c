/*
 * XREFs of ?TdrDereferenceRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C0166ED0
 * Callers:
 ...
 *     ?Worker@CTDR_SUBMIT_REPORT_THREAD@@MEAAXXZ @ 0x1C0167880 (-Worker@CTDR_SUBMIT_REPORT_THREAD@@MEAAXXZ.c)
 * Callees:
 *     ?ReleaseReference@DXGADAPTER@@QEAAX_K@Z @ 0x1C0008780 (-ReleaseReference@DXGADAPTER@@QEAAX_K@Z.c)
 *     ?Start@CVP_SYSTEM_THREAD@@QEAAJXZ @ 0x1C0165CD0 (-Start@CVP_SYSTEM_THREAD@@QEAAJXZ.c)
...
void __fastcall TdrDereferenceRecoveryContext(struct _TDR_RECOVERY_CONTEXT *a1, char a2)
{
  ...
  if ( a1 )
  {
    ...
    else if ( _InterlockedExchangeAdd((volatile signed __int32 *)a1 + 720, 0xFFFFFFFF) <= 1 )
    {
