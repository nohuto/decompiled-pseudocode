/*
 * XREFs of ?ProcessPointerShapeChange@OUTPUTDUPL_MGR@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@II@Z @ 0x1C0077E80
 * Callers:
        ...
        UINT a5)
{
  ...
  else
  {
    ...
    *(__m128i *)&v25.VidPnSourceId = v9;
    v25.Width = a4;
    *(_QWORD *)&v25.XHot = v10;
    v12 = 3LL * v11;
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v24, *(struct DXGFASTMUTEX *const *)(v8 + 24LL * v11));
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v24);
    v13 = *(OUTPUTDUPL_CONTEXT ***)(v8 + 8 * v12 + 8);
    LODWORD(v14) = 0;
    v15 = 0;
    v16 = 1;
    if ( *((_DWORD *)this + 2) )
