/*
 * XREFs of ??0DMMVIDPNPRESENTPATH@@QEAA@PEAVDMMVIDPNSOURCE@@PEAVDMMVIDPNTARGET@@W4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@G@Z @ 0x1C0004E54
 * Callers:
 ...
 * Callees:
 *     ?SetImportanceOrdinal@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@@Z @ 0x1C0004FA0 (-SetImportanceOrdinal@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@@Z.c)
 */
        ...
        unsigned __int16 a5)
{
  ...
  *((_QWORD *)this + 7) = &DMMVIDPNPRESENTPATH::`vftable'{for `FallibleConstruction'};
  ...
  *((_QWORD *)this + 24) = 0LL;
  *((_QWORD *)this + 25) = 0LL;
  v9 = DMMVIDPNPRESENTPATH::SetImportanceOrdinal(this, (enum _D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE)v5);
  v10 = v9;
  if ( v9 < 0 )
  {
