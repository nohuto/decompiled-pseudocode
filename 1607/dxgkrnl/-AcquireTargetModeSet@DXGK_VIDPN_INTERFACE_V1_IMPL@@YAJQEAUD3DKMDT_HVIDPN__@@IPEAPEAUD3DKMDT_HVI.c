/*
 * XREFs of ?AcquireTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00CDBD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  __int64 v28; // rax
  __int64 v29; // rax
  struct D3DKMDT_HVIDPNTARGETMODESET__ *v30; // [rsp+50h] [rbp+8h]
  ...
  if ( a3 && a4 )
  {
    ...
    *a4 = 0LL;
    ...
    if ( v12 )
    {
      ...
      do
      {
        if ( *(_DWORD *)(*((_QWORD *)v13 + 12) + 24LL) == (_DWORD)v6 )
          break;
...
LABEL_37:
      ...
      v14 = *((_QWORD *)v12 + 39);
      v15 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(*((_QWORD *)v12 + 6) + 392LL);
      v16 = (_QWORD *)(v14 + 24);
      v30 = v15;
      if ( (_QWORD *)*v16 == v16 )
      {
...
LABEL_20:
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v18, &EventProfilerExit, v10, 7048);
  return v11;
}
