/*
 * XREFs of ?AcquirePinnedModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C00812F0
 * Callers:
 *     <none>
 * Callees:
...
{
  DXGGLOBAL *v4; // rax
  DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *v6; // rbx
  __int64 v7; // rax
  __int64 v8; // rcx
  ...
  DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *v26; // [rsp+40h] [rbp+8h] BYREF
  ...
  _InterlockedIncrement((volatile signed __int32 *)v4 + 10);
  ...
  *(_QWORD *)(v7 + 32) = a2;
    ...
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v9 )
    {
      ...
      v10 = DMMVIDPNSOURCEMODESET::AcquireDdiEnumeratorCachedModeInfo<KM_STL::mem_fun_t<DMMVIDPNSOURCEMODE *,DMMVIDPNSOURCEMODESET>>(
              ...
              &v24,
              &v26);
      v6 = (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)v10;
      if ( v10 == -1071774902 )
      {
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v12, &EventProfilerExit, v13, 7003);
