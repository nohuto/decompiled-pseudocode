/*
 * XREFs of ?Reset@DXGDEVICE@@QEAAXXZ @ 0x1C015ED08
 * Callers:
...
void __fastcall DXGDEVICE::Reset(DXGDEVICE *this)
{
  ...
  for ( i = (__int64 *)*((_QWORD *)this + 41); i != (__int64 *)((char *)this + 328) && i; i = (__int64 *)*i )
  {
  ...
  v8 = *((_QWORD *)this + 71);
  *((_DWORD *)this + 94) = 2;
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v7 + 376) + 8LL) + 488LL))(v8) )
    *((_DWORD *)this + 94) = 3;
  else
    (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 376LL) + 8LL) + 208LL))(
      *((_QWORD *)this + 71),
      22LL);
