/*
 * XREFs of ?CreateTtmDevice@DXGSESSIONMGR@@QEAAJW4TTM_DEVICE_TYPE@@PEAU_DEVICE_OBJECT@@PEAVDXGADAPTER@@IKPEAPEAX@Z @ 0x1C00FAA64
 * Callers:
 ...
 *     ??0CTTMDEVICE@@AEAA@W4TTM_DEVICE_TYPE@@@Z @ 0x1C00FADE0 (--0CTTMDEVICE@@AEAA@W4TTM_DEVICE_TYPE@@@Z.c)
        ...
        CTTMDEVICE **a7)
{
  ...
  if ( a7 && (a3 || a4) && ((a5 + 3) & 0xFFFFFFFD) != 0 )
  {
    ...
    if ( v10 )
      v12 = (CTTMDEVICE *)CTTMDEVICE::CTTMDEVICE(v10);
    else
      v12 = 0LL;
    if ( v12 )
    {
