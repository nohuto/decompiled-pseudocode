/*
 * XREFs of ?_EnableDisableMonitorInternal@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00E2BAC
 * Callers:
 ...
 * Callees:
 *     ?_ChangeLIDStatus@DXGMONITOR@@QEAAXE@Z @ 0x1C0034E44 (-_ChangeLIDStatus@DXGMONITOR@@QEAAXE@Z.c)
  ...
  if ( v12 != (__int64 *)(a1 + 128) && v12 )
  {
    do
    {
      if ( (_DWORD)v7 == -1 || *((_DWORD *)v12 + 7) == (_DWORD)v7 )
      {
        ...
        ExAcquireResourceExclusiveLite((PERESOURCE)(v12 + 30), 1u);
        if ( a4 == 1 )
          DXGMONITOR::_ChangeLIDStatus((DXGMONITOR *)v12, a3);
        else
          *((_DWORD *)v12 + 6) ^= (*((_DWORD *)v12 + 6) ^ (32 * (a3 == 0))) & 0x20;
        ExReleaseResourceLite((PERESOURCE)(v12 + 30));
        ...
        if ( *((_DWORD *)v12 + 94) != 1 )
        {
          ...
          if ( v17 )
          {
            ...
            KeEnterCriticalRegion();
            v21 = (struct _ERESOURCE *)(v19 + 240);
            ExAcquireResourceExclusiveLite(v21, 1u);
            if ( a4 == 1 )
              DXGMONITOR::_ChangeLIDStatus((DXGMONITOR *)v12[48], a3);
            else
              *(_DWORD *)(v12[48] + 24) ^= (*(_DWORD *)(v12[48] + 24) ^ (32 * (a3 == 0))) & 0x20;
