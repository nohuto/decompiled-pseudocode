/*
 * XREFs of ?InitializeAdapterObject@DXGADAPTERSYNCOBJECT@@QEAAJPEAVDXGSYNCOBJECT@@@Z @ 0x1C007F578
 * Callers:
...
__int64 __fastcall DXGADAPTERSYNCOBJECT::InitializeAdapterObject(DXGADAPTERSYNCOBJECT *this, struct DXGSYNCOBJECT *a2)
{
  ...
  if ( *((_QWORD *)this + 4) )
  {
    ...
    *(_QWORD *)(v16 + 24) = 1161LL;
    WdLogEvent5_WdAssertion(v16);
  }
  v5 = (__int128 *)((char *)a2 + 128);
  if ( *((_DWORD *)a2 + 32) == 5 )
  ...
  if ( (*((_DWORD *)a2 + 33) & 4) != 0 )
    ...
    v7 = 0LL;
  v8 = (*(__int64 (__fastcall **)(_QWORD, struct DXGSYNCOBJECT *, char *, __int64, _QWORD, char *, struct VIDMM_MONITORED_FENCE_STORAGE *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 376LL) + 8LL) + 520LL))(
  ...
  if ( v8 >= 0 )
  {
    ...
    *((_BYTE *)this + 26) = (*((_DWORD *)a2 + 33) & 4) != 0;
    if ( (*((_DWORD *)a2 + 33) & 4) != 0 )
    {
      v18 = (struct DXGSYNCOBJECT **)*((_QWORD *)a2 + 28);
      v19 = (DXGADAPTERSYNCOBJECT *)((char *)this + 40);
      if ( *v18 != (struct DXGSYNCOBJECT *)((char *)a2 + 216) )
        __fastfail(3u);
      *(_QWORD *)v19 = (char *)a2 + 216;
      *((_QWORD *)this + 6) = v18;
      *v18 = v19;
      *((_QWORD *)a2 + 28) = v19;
    }
