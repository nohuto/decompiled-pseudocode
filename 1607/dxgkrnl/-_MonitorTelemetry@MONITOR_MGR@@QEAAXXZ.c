/*
 * XREFs of ?_MonitorTelemetry@MONITOR_MGR@@QEAAXXZ @ 0x1C01AF9BC
 * Callers:
...
void __fastcall MONITOR_MGR::_MonitorTelemetry(struct _FAST_MUTEX *this)
{
  ...
  if ( (ULONG *)v8 != p_Contention )
  {
    ...
    {
      v9 = v8;
      if ( *(_DWORD *)(v8 + 376) != 1 && *(_QWORD *)(v8 + 384) )
        v9 = *(_QWORD *)(v8 + 384);
      if ( !v9 )
      {
      ...
      ExAcquireResourceSharedLite((PERESOURCE)(v9 + 240), 1u);
      DXGMONITOR::_MonitorTelemetry(v9, 2);
      v8 = *(_QWORD *)v8;
      if ( (ULONG *)v8 == p_Contention )
        v8 = 0LL;
      ExReleaseResourceLite((PERESOURCE)(v9 + 240));
