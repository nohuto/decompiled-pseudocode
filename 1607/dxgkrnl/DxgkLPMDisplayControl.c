/*
 * XREFs of DxgkLPMDisplayControl @ 0x1C016B3D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCaps@LPMDisplayCtrl@@QEAAJPEAU_D3DKMT_LPMD_CAPS@@@Z @ 0x1C016ACC4 (-GetCaps@LPMDisplayCtrl@@QEAAJPEAU_D3DKMT_LPMD_CAPS@@@Z.c)
