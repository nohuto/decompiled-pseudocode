/*
 * XREFs of ?CalculatePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAXI@Z @ 0x1C002598C
 * Callers:
 ...
 * Callees:
 *     ?CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z @ 0x1C0025908 (-CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z.c)
 */
        ...
        unsigned int a2)
{
  ...
  v2 = *(_DWORD **)this;
  v4 = *((_DWORD *)this + 14);
  if ( a2 <= *(_DWORD *)(*(_QWORD *)this + 3688LL) )
  {
    if ( a2 > v2[923] && v4 )
  ...
  if ( a2 >= v2[924] || v4 >= **((_DWORD **)this + 2) - 1 )
    goto LABEL_12;
  ++*((_DWORD *)this + 21);
  v6 = *((_DWORD *)this + 20);
  v7 = *((_DWORD *)this + 21);
