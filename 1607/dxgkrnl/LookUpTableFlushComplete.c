/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0010914
 * Callers:
 *     TlgAggregateInternalProviderCallback @ 0x1C0010830 (TlgAggregateInternalProviderCallback.c)
 ...
 *     UpdateInternalStatsOnFlush @ 0x1C00353BC (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 344) )
    {
      if ( (unsigned int)dword_1C0056900 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0056900, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0056900, &unk_1C003E6F4, 0LL, v6, 0xBu, &pData);
      }
