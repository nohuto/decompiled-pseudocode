/*
 * XREFs of DxgkOpenResourceFromNtHandle @ 0x1C00D2AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenResourceFromNtHandle(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  _BYTE v47[160]; // [rsp+130h] [rbp+130h] BYREF

  v3 = (unsigned int *)((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL);
  ...
  *(_OWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = *(_OWORD *)(v5 + 16);
  *(_OWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = *(_OWORD *)(v5 + 32);
  *(_OWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x60) = *(_OWORD *)(v5 + 48);
  *(_OWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x70) = *(_OWORD *)(v5 + 64);
  *(_OWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x80) = *(_OWORD *)(v5 + 80);
  *(_QWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x90) = *(_QWORD *)(v5 + 96);
  v6 = *(void **)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38);
  ...
  if ( v7 == -1073741788 )
  {
    ...
    *(_QWORD *)(v13 + 32) = -1073741788LL;
    ...
    if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(qword_1C0056840, &EventProfilerExit, v14, 2076);
    return 3221225508LL;
  }
  if ( v7 < 0 )
  {
  ...
  v19 = (*(_BYTE *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x24) & 1) == 0;
  *v3 = 0;
  *(_DWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 4) = 0;
  v20 = *(_QWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 8);
  v21 = *(DXGKEYEDMUTEX **)(v20 + 24);
  if ( !v21
    || (v22 = DXGKEYEDMUTEX::Open(
                v21,
                (unsigned int *)((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL),
                *(void **)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x88),
                *(_DWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x90),
                Object),
        v22 >= 0) )
  {
    if ( *(_QWORD *)(v20 + 32) )
    {
      ...
      if ( v22 < 0 )
      {
        if ( *(_BYTE *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) )
    ...
    *v25 = *(_DWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
    ...
    if ( v22 >= 0 )
    {
      ...
      v27 = *(unsigned int *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
      v28 = (*(_DWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 4) >> 6) & 0xFFFFFF;
      if ( v28 < *((_DWORD *)Current + 56) )
      {
        ...
        if ( (((unsigned int)v27 >> 26) & 0x30) == (v30 & 0x30) && (v30 & 0xF) != 0 )
        {
          ...
          *(_DWORD *)(*((_QWORD *)Current + 26) + 8 * v32 + 8) &= ~0x1000u;
        }
      }
      *((_QWORD *)Current + 24) = 0LL;
      ...
      if ( (_DWORD)v34 )
      {
        ...
        DXGPUSHLOCK::AcquireExclusive((struct DXGPROCESS *)((char *)v35 + 184));
        v36 = ((unsigned int)v34 >> 6) & 0xFFFFFF;
        if ( (unsigned int)v36 < *((_DWORD *)v35 + 56) )
        {
          v37 = *((_QWORD *)v35 + 26);
          ...
          if ( (((unsigned int)v34 >> 26) & 0x30) == (v38 & 0x30) && (v38 & 0xF) != 0 )
          {
            ...
            *(_DWORD *)(*((_QWORD *)v35 + 26) + 8 * v40 + 8) &= ~0x1000u;
          }
        }
        *((_QWORD *)v35 + 24) = 0LL;
        ExReleasePushLockExclusiveEx((char *)v35 + 184, 0LL);
        KeLeaveCriticalRegion();
      }
    }
  }
LABEL_43:
  if ( v22 < 0 )
  {
    ...
    v42 = *(_DWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
    if ( v42 )
    {
      v43 = DXGGLOBAL::GetGlobal((__int64)v21);
      DXGGLOBAL::DestroySyncObject(v43, *(struct DXGSYNCOBJECT **)(v20 + 32), v42, 0);
    }
  }
