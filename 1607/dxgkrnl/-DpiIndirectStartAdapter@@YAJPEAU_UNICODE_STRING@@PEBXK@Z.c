/*
 * XREFs of ?DpiIndirectStartAdapter@@YAJPEAU_UNICODE_STRING@@PEBXK@Z @ 0x1C019AEEC
 * Callers:
...
__int64 __fastcall DpiIndirectStartAdapter(struct _UNICODE_STRING *a1, const void *a2, unsigned int a3)
{
  ...
  wchar_t *v19; // [rsp+78h] [rbp+20h] BYREF

  v19 = 0LL;
  v4 = a3;
  StartContext = (wchar_t *)ExAllocatePoolWithTag(PagedPool, 0x46CuLL, 0x74727044u);
...
LABEL_9:
  ...
  v10 = RtlStringCchCopyW(StartContext + 2, 0x32uLL, a1->Buffer);
  v12 = v10;
  if ( v10 >= 0 )
  {
    if ( (unsigned int)v4 <= 0x400 )
    {
      memmove(StartContext + 54, a2, v4);
      *((_DWORD *)StartContext + 26) = v4;
      *(_DWORD *)StartContext = 12;
