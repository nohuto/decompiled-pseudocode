/*
 * XREFs of DxgkFlipOverlay @ 0x1C016DF10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    if ( !v13 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(v12, &EventProfilerExit, v11, 2024);
    return v10;
  }
  if ( (unsigned __int64)v4 >= MmUserProbeAddress )
    v4 = (_OWORD *)MmUserProbeAddress;
  *(_OWORD *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = *v4;
  *(_OWORD *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) = v4[1];
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE(
    (DXGDEVICEBYHANDLE *)((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL),
    *(_DWORD *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18),
  ...
  if ( !v16 )
  {
    ...
    *(_QWORD *)(v17 + 24) = *(unsigned int *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18);
    v10 = -1073741811;
...
LABEL_14:
  ...
  DXGHANDLETABLELOCKSHARED::DXGHANDLETABLELOCKSHARED(
    (DXGHANDLETABLELOCKSHARED *)(v3 + 72),
    (struct _KTHREAD **)ProcessDxgProcess);
  v21 = (*(_DWORD *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x1C) >> 6) & 0xFFFFFF;
  if ( (unsigned int)v21 < *(_DWORD *)(ProcessDxgProcess + 224)
    && (v20 = *(_QWORD *)(ProcessDxgProcess + 208),
        ...
        v18 = (*(_DWORD *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x1C) >> 26) & 0x30,
        ((*(_DWORD *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x1C) >> 26) & 0x30) == (*(_BYTE *)(v20 + 16LL * (unsigned int)v21 + 8) & 0x30))
    && (v19 & 0x1000) == 0
    && (v19 & 0xF) != 0
  ...
  if ( !v22 )
  {
    ...
    v23[3] = *(unsigned int *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x1C);
    v10 = -1073741811;
    v23[4] = -1073741811LL;
LABEL_24:
    WdLogEvent5_WdWarning(v23);
    DXGAUTOPUSHLOCK::~DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)(v3 + 72));
LABEL_25:
  ...
  if ( v16 != *((struct ADAPTER_RENDER ***)v22 + 2) )
  {
    v23 = (_QWORD *)WdLogNewEntry5_WdWarning(v18, v21, v19, v20);
    v23[3] = *(unsigned int *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x1C);
    v23[4] = *(unsigned int *)(((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18);
    v10 = -1073741811;
    v23[5] = -1073741811LL;
    goto LABEL_24;
  }
  DXGAUTOPUSHLOCK::~DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)(v3 + 72));
  COREOVERLAYACCESS::COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 96), v22);
  v24 = COREOVERLAYACCESS::AcquireShared((COREOVERLAYACCESS *)(v3 + 96));
  if ( v24 >= 0 )
  {
    ...
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)(v3 + 56), v16[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)(v3 + 56));
    v10 = DXGOVERLAY::FlipOverlay(v22, (struct _D3DKMT_FLIPOVERLAY *)(v3 + 24));
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)(v3 + 56));
    DXGPROCESSMUTEX::~DXGPROCESSMUTEX((DXGPROCESSMUTEX *)(v3 + 56));
  ...
  DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v29 & 0xFFFFFFFFFFFFFFC0uLL));
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v25, &EventProfilerExit, v26, 2024);
