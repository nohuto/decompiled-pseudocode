/*
 * XREFs of ?ConvertToCheckMultiPlaneOverlaySupport@DXGDEVICE@@AEAAJIPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE2@@_NPEAH@Z @ 0x1C015D11C
 * Callers:
        ...
        int *a5)
{
  ...
  if ( v11 )
  {
    ...
    v17 = DXGDEVICE::CheckMultiPlaneOverlaySupport(this, a2, v15, a4, a5);
    operator delete(v15);
  }
  else
  {
