/*
 * XREFs of ?DdiQueryVirtualFunctionLuid@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z @ 0x1C015917C
 * Callers:
...
void __fastcall ADAPTER_RENDER::DdiQueryVirtualFunctionLuid(
        ADAPTER_RENDER *this,
