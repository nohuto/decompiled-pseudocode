/*
 * XREFs of ?FindContextForProcess@OUTPUTDUPL_MGR@@AEAAPEAPEAVOUTPUTDUPL_CONTEXT@@PEAU_OUTPUTDUPL_CONTEXTLIST@@PEAU_EPROCESS@@PEAI@Z @ 0x1C017BD18
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  while ( 1 )
  {
    if ( *(_QWORD *)v9 )
    {
      ...
      v11 = v12 == PsGetCurrentProcess(this);
    }
    else
    {
      v11 = a3 == 0LL;
