/*
 * XREFs of ?CapturePresentMultiPlaneOverlayArgs2@@YAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY2@@PEAU1@PEAPEAU_D3DKMT_MULTIPLANE_OVERLAY2@@PEAPEAUtagRECT@@@Z @ 0x1C0185530
 * Callers:
        ...
        struct tagRECT **a4)
{
  ...
  _BYTE v31[284]; // [rsp+40h] [rbp-148h] BYREF
  unsigned int v32; // [rsp+15Ch] [rbp-2Ch]
