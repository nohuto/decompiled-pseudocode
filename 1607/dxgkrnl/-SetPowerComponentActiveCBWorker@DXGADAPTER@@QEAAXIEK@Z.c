/*
 * XREFs of ?SetPowerComponentActiveCBWorker@DXGADAPTER@@QEAAXIEK@Z @ 0x1C001E2C8
 * Callers:
 *     ?SetPowerComponentActiveCB@DXGADAPTER@@QEAAXI@Z @ 0x1C001E18C (-SetPowerComponentActiveCB@DXGADAPTER@@QEAAXI@Z.c)
 ...
 *     ?RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C0025BF0 (-RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
        ...
        unsigned int a4)
{
  ...
  if ( *((_QWORD *)this + 272) )
  {
    ...
    if ( v10 )
    {
      ...
      if ( *((_DWORD *)this + 812) )
      {
        KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 459, &LockHandle);
        *(_BYTE *)(*(_QWORD *)(v9 + 512) + 240LL) = 1;
        if ( !*((_BYTE *)this + 3680) )
        {
          ...
          *((_QWORD *)this + 442) = -1LL;
          KeSetTimer((PKTIMER)((char *)this + 3544), (LARGE_INTEGER)-120000LL, (PKDPC)((char *)this + 3608));
        }
    ...
    if ( (int)++*(_DWORD *)(v9 + 352) <= 1 )
    {
      ...
      {
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 338, &v23);
        v14 = v9 + 440;
        if ( *(_QWORD *)(v9 + 440) )
        {
          v15 = *(_QWORD *)v14;
          ...
          *(_QWORD *)(v15 + 8) = v16;
          *(_QWORD *)v14 = 0LL;
          if ( *((DXGADAPTER **)this + 332) == (DXGADAPTER *)((char *)this + 2656) )
          {
            KeCancelTimer((PKTIMER)((char *)this + 2720));
            *((_BYTE *)this + 2605) = 0;
          }
    ...
    if ( v11 )
    {
      ...
      PoFxActivateComponent(*((_QWORD *)this + 272), (unsigned int)v5, v21);
      if ( v12 )
      {
        if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
