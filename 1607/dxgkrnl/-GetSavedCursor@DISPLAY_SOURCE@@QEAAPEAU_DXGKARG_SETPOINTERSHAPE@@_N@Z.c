/*
 * XREFs of ?GetSavedCursor@DISPLAY_SOURCE@@QEAAPEAU_DXGKARG_SETPOINTERSHAPE@@_N@Z @ 0x1C007CB88
 * Callers:
...
struct _DXGKARG_SETPOINTERSHAPE *__fastcall DISPLAY_SOURCE::GetSavedCursor(DISPLAY_SOURCE *this, char a2)
{
  ...
  if ( !*((_QWORD *)this + 93) && a2 )
  {
    v7 = 4LL * (unsigned int)(*(_DWORD *)(v5 + 1480) * *(_DWORD *)(v5 + 1484));
    if ( !is_mul_ok((unsigned int)(*(_DWORD *)(v5 + 1480) * *(_DWORD *)(v5 + 1484)), 4uLL) )
      v7 = -1LL;
    *((_QWORD *)this + 93) = operator new(v7, 0x4B677844u, PagedPool);
  }
  return (struct _DXGKARG_SETPOINTERSHAPE *)((char *)this + 720);
}
