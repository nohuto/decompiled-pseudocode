/*
 * XREFs of ?MakeCloneGroupDWMClipBoxValid@CCD_TOPOLOGY@@QEAAJI@Z @ 0x1C008B998
 * Callers:
 ...
 *     ?CalculateScaling@@YA_NW4DISPLAYCONFIG_SCALING@@PEBU_D3DKMDT_2DREGION@@1PEAU_RECTL@@@Z @ 0x1C000D554 (-CalculateScaling@@YA_NW4DISPLAYCONFIG_SCALING@@PEBU_D3DKMDT_2DREGION@@1PEAU_RECTL@@@Z.c)
...
__int64 __fastcall CCD_TOPOLOGY::MakeCloneGroupDWMClipBoxValid(CCD_TOPOLOGY *this, unsigned int a2)
{
  ...
  while ( 1 )
  {
    ...
    v8 = *((_DWORD *)PathDescriptor + 31);
    v38 = *((_QWORD *)PathDescriptor + 11);
    ...
    if ( v25 )
      goto LABEL_15;
    v10 = *((unsigned int *)v7 + 41);
    if ( (int)v10 < 0 )
      break;
    v16 = *((_DWORD *)v7 + 40);
    if ( v16 < 0 )
      break;
    v9 = *((unsigned int *)v7 + 42);
    if ( (int)v9 <= v16 )
      break;
    v17 = *((_DWORD *)v7 + 43);
...
LABEL_15:
    ...
    if ( *((_DWORD *)v7 + 32) == 1 )
    {
      ...
      if ( !CalculateScaling(v22, (unsigned int *)&v38, &v36, (unsigned int *)v7 + 40) )
      {
        ...
        *(_QWORD *)(v29 + 24) = (int)*v20;
        ...
        v31 = CalculateScaling(v30, (unsigned int *)&v38, &v36, (unsigned int *)v7 + 40);
        *((_DWORD *)v7 + 46) |= 0x40u;
        if ( !v31 )
        {
          v33 = WdLogNewEntry5_WdAssertion(v32);
          *(_QWORD *)(v33 + 24) = 5589LL;
          WdLogEvent5_WdAssertion(v33);
        }
      }
LABEL_22:
      *(_DWORD *)v7 |= 0x800000u;
      v24 = *((unsigned int *)v7 + 41);
      if ( (int)v24 < 0 || *v21 < 0 || *((_DWORD *)v7 + 42) <= *v21 || *((_DWORD *)v7 + 43) <= (int)v24 )
      {
        v35 = WdLogNewEntry5_WdAssertion(v24);
        *(_QWORD *)(v35 + 24) = 5609LL;
