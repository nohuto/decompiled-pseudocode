/*
 * XREFs of ?_QueryTopologySetIdStr@CCD_TOPOLOGY@@AEBAJPEAGG@Z @ 0x1C008AE98
 * Callers:
  ...
  if ( *(_WORD *)(v4 + 20) )
  {
    ...
    while ( 1 )
    {
        ...
        && (unsigned __int8)CCD_TOPOLOGY::IsPrimaryClonePathByModality(this, v8) )
      {
        ...
        {
          if ( v7 )
            result = RtlStringCchCopyW(pszDest, v7, pszSrc);
          else
            result = -1073741811;
        ...
        v10 = CCD_TOPOLOGY::_QueryMonitorIdStr(
                (const struct _LUID *)(v9 + *((_QWORD *)this + 8) + 56LL),
        ...
        if ( v8 + 1 < *(unsigned __int16 *)(*((_QWORD *)this + 8) + 20LL) )
        {
          do
          {
            if ( CCD_TOPOLOGY::IsSameCloneGroup(this, v8, v12, 0) )
            {
              ...
              if ( v7 )
                result = RtlStringCchCopyW(pszDest, v7, asc_1C003FAB8);
              else
                result = -1073741811;
              if ( result == -2147483643 )
                result = -1073741789;
              ...
              v19 = CCD_TOPOLOGY::_QueryMonitorIdStr(
                      (const struct _LUID *)(v15 + *((_QWORD *)this + 8) + 56LL),
                      *(_DWORD *)(*((_QWORD *)this + 8) + v15 + 68),
                      v18,
                      v17,
                      &v24);
              v6 = v19;
              ...
              v7 = v17 - v24;
              *(_DWORD *)(*((_QWORD *)this + 8) + v15 + 232) = v23++;
              pszDest = &v18[v24];
            }
            ++v12;
          }
