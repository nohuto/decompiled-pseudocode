/*
 * XREFs of ?AcquireTargetModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGDMM_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00BDB10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  __int64 v20; // rdi
  __int64 v21; // rdi
  struct _DXGDMM_VIDPNTARGETMODESET_INTERFACE *v22; // rax
  _QWORD *v24; // rax
  __int64 v25; // rax
  __int64 v26; // rax
  __int64 v27; // rax
  __int64 v28; // rax
  __int64 v29; // rax
  struct _DXGDMM_VIDPNTARGETMODESET_INTERFACE *v30; // [rsp+50h] [rbp+18h] BYREF
  ...
  if ( a3 && a4 )
  {
    ...
    *a4 = 0LL;
    ...
    if ( v9 )
    {
      ...
      {
        v30 = 0LL;
        VIDPN_MGR::QueryDxgDmmVidPnTargetModeSetInterface(v13, &v30);
...
LABEL_10:
              ...
              v22 = v30;
              *a3 = v21;
              *a4 = (struct D3DKMDT_HVIDPNTARGETMODESET__ *)v22;
              goto LABEL_13;
            }
          }
          else
...
LABEL_13:
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v15, &EventProfilerExit, v16, 6036);
  return v8;
}
