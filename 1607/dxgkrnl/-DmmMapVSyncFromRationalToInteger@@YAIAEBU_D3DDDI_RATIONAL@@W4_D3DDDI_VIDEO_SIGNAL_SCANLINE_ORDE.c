/*
 * XREFs of ?DmmMapVSyncFromRationalToInteger@@YAIAEBU_D3DDDI_RATIONAL@@W4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@PEAE@Z @ 0x1C00BEAF0
 * Callers:
 ...
 *     DxgkUpdateCddDevmodeExtraData @ 0x1C00DA730 (DxgkUpdateCddDevmodeExtraData.c)
        ...
        unsigned __int8 *a3)
{
  ...
  v7 = 0LL;
  while ( !DMMVIDEOSIGNALMODE::IsFreqWithinToleranceRange(a1, (const struct _D3DDDI_RATIONAL *)&unk_1C0038370 + v7, 50) )
  {
