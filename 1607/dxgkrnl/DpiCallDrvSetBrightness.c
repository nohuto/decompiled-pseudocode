/*
 * XREFs of DpiCallDrvSetBrightness @ 0x1C019984C
 * Callers:
...
__int64 __fastcall DpiCallDrvSetBrightness(__int64 a1, __int64 a2, unsigned __int8 a3)
{
  __int64 v3; // r9
