/*
 * XREFs of ?DdiMapCpuHostAperture@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_MAPCPUHOSTAPERTURE@@@Z @ 0x1C00DF0FC
 * Callers:
 *     ?ADAPTER_RENDER_DdiMapCpuHostAperture@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_MAPCPUHOSTAPERTURE@@@Z @ 0x1C000EA80 (-ADAPTER_RENDER_DdiMapCpuHostAperture@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_MAPCPUHOSTAPERTURE@@@.c)
 * Callees:
...
LABEL_8:
  ...
  v13 = *(_DWORD *)(v10 + 136);
LABEL_9:
  v15 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_MAPCPUHOSTAPERTURE *))(*((_QWORD *)this + 2) + 832LL))(
  ...
  *(_QWORD *)(v18 + 24) = v15;
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v20, &EventProfilerExit, v21, 5061);
