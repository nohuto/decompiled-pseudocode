/*
 * XREFs of ?QueryAllocationResidency@DXGDEVICE@@QEAAJPEAU_D3DKMT_QUERYALLOCATIONRESIDENCY@@E@Z @ 0x1C0098CDC
 * Callers:
        ...
        __int64 a4)
{
  ...
  D3DKMT_ALLOCATIONRESIDENCYSTATUS *v30; // r8
  ...
  if ( !(_DWORD)hResource )
  {
    if ( a2->AllocationCount )
    {
      for ( i = 0; ; ++i )
      {
        ...
        v21 = *v20;
        DXGPROCESS::GetAllocationSafe(*((_QWORD *)this + 5), (DXGALLOCATIONREFERENCE *)&v33, *v20);
        if ( !v33 )
          break;
        v26 = *(_QWORD *)(*(_QWORD *)(v33 + 8) + 16LL);
        v27 = *((_QWORD *)this + 2);
        ...
        AllocationResidency = (unsigned int)VIDMM_EXPORT::VidMmQueryAllocationResidency(
                                              ...
                                              *(struct _VIDMM_MULTI_ALLOC **)(v33 + 24));
        v30 = &a2->pResidencyStatus[v19];
        if ( (unsigned __int64)v30 >= MmUserProbeAddress )
          v30 = (D3DKMT_ALLOCATIONRESIDENCYSTATUS *)MmUserProbeAddress;
        *v30 = AllocationResidency;
...
LABEL_34:
  ...
  DXGPROCESS::GetResourceSafe(*((_QWORD *)this + 5), (DXGRESOURCEREFERENCE *)&v33, hResource);
  if ( !v33 )
  {
...
LABEL_6:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v33 + 8) + 16LL) + 16LL) != v13 )
  {
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v32, (struct DXGFASTMUTEX *const)(v33 + 80));
  ...
  if ( v15 )
  {
    while ( 1 )
    {
      v16 = VIDMM_EXPORT::VidMmQueryAllocationResidency(
              ...
              *(struct _VIDMM_MULTI_ALLOC **)(v15 + 24));
      if ( v16 == 3 )
        break;
      if ( v16 == 2 )
        v6 = 2;
