/*
 * XREFs of ?MakeCloneGroupContentResolutionValid@CCD_TOPOLOGY@@QEAAJI@Z @ 0x1C008B4F0
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::MakeCloneGroupContentResolutionValid(CCD_TOPOLOGY *this, unsigned int a2)
{
  ...
  __int64 v34; // rax
  _QWORD *v35; // rax
  struct _D3DKMDT_2DREGION v36; // [rsp+70h] [rbp+40h] BYREF
  unsigned int v37; // [rsp+80h] [rbp+50h] BYREF
  struct _D3DKMDT_2DREGION v38; // [rsp+88h] [rbp+58h] BYREF
  ...
  v4 = 0;
  v6 = 0;
  v37 = *((_DWORD *)CCD_TOPOLOGY::GetPathDescriptor(this, a2) + 50);
  v8 = 0x7FFFFFFF;
  cy = 0x7FFFFFFF;
  ...
  while ( 1 )
  {
    ...
    v7 = v37;
    if ( *((_DWORD *)PathDescriptor + 50) == v37 )
      break;
LABEL_11:
    ++v6;
...
LABEL_47:
    ...
    while ( 1 )
    {
      ...
      if ( v28[50] == v14 )
      {
        if ( cx )
        {
          v29 = v28[38];
          v30 = v28[39];
          v31 = v28[36] * (__int64)v28[37] - v30 * v29;
          v32 = (*((_QWORD *)&v31 + 1) ^ v31) - *((_QWORD *)&v31 + 1);
          if ( v32 < v25 )
          {
            v8 = v29;
            cy = v30;
        ...
        else if ( v28[36] == v28[38] )
        {
          v33 = v28[39];
          if ( *(_DWORD *)(v7 + 148) == v33 )
          {
            v8 = *(_DWORD *)(v7 + 152);
            cy = v33;
            goto LABEL_27;
  ...
  if ( !v3 )
    v3 = (_QWORD *)((char *)PathDescriptor + 144);
  v7 = *((unsigned int *)PathDescriptor + 36);
  if ( (_DWORD)v7 )
  {
    v11 = *((_DWORD *)PathDescriptor + 37);
    if ( v11 )
    {
      if ( *v3 == __PAIR64__(v11, v7) )
      {
        ...
        {
          if ( __PAIR64__(v11, v7) == *((_QWORD *)PathDescriptor + 19) )
            LOBYTE(v36.cx) = 0;
        }
        else
        {
...
LABEL_26:
  ...
  CCD_TOPOLOGY::_QueryDesktopSurfaceRegionWithRotation(v15, 1, &v38);
...
LABEL_27:
  ...
  while ( 2 )
  {
    ...
    if ( *((_DWORD *)v21 + 50) != v14
      || (v7 = *(unsigned int *)v21, (v7 & 0x20000) != 0) && *((_DWORD *)v21 + 36) == v8 && *((_DWORD *)v21 + 37) == cy )
    {
LABEL_37:
