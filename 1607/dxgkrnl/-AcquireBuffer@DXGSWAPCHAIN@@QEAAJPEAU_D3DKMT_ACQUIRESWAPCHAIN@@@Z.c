/*
 * XREFs of ?AcquireBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_ACQUIRESWAPCHAIN@@@Z @ 0x1C018D720
 * Callers:
...
__int64 __fastcall DXGSWAPCHAIN::AcquireBuffer(struct _KTHREAD **this, struct _D3DKMT_ACQUIRESWAPCHAIN *a2)
{
  __int64 v4; // rax
  char *v5; // rbp
  _DWORD *v6; // rax
  ...
  DXGSWAPCHAIN::GetClientSurfaceInfo(
    (DXGSWAPCHAIN *)this,
    (struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *)v5,
    v7,
    &v18,
    &v21);
  v10 = (__int64)v18;
