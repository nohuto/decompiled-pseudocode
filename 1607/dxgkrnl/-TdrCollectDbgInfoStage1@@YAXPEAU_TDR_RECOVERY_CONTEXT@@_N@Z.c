/*
 * XREFs of ?TdrCollectDbgInfoStage1@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C0165EF0
 * Callers:
 ...
 *     DpiGetAdapterDebugData @ 0x1C0029D38 (DpiGetAdapterDebugData.c)
 *     DpiGetDbgInfoAdapters @ 0x1C0029DB8 (DpiGetDbgInfoAdapters.c)
 *     DpiGetGlobalDebugData @ 0x1C0029EAC (DpiGetGlobalDebugData.c)
 ...
 *     ??0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z @ 0x1C01658A8 (--0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z.c)
...
void __fastcall TdrCollectDbgInfoStage1(struct _TDR_RECOVERY_CONTEXT *a1, char a2)
{
  ...
  _QWORD *v92; // rax
  bool v93; // [rsp+48h] [rbp-C0h]
  _DWORD *v94; // [rsp+50h] [rbp-B8h] BYREF
  _DWORD *v95; // [rsp+58h] [rbp-B0h] BYREF
  _DXGKARG_COLLECTDBGINFO v96; // [rsp+60h] [rbp-A8h] BYREF
  int v97; // [rsp+80h] [rbp-88h]
  __int64 v98; // [rsp+84h] [rbp-84h]
  _DWORD v99[28]; // [rsp+98h] [rbp-70h] BYREF
      ...
      *((_QWORD *)a1 + 357) = v7;
      if ( v7 )
      {
        ...
        *(_QWORD *)&v9[1].Data1 = *(_QWORD *)&v11[1].Data1;
        v13 = CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 0xFFFF, 0xAA0u);
        if ( v13 )
        {
          v14 = v13;
          v15 = (_OWORD *)((char *)a1 + 112);
          v16 = 21LL;
          do
          {
            *v14 = *v15;
        ...
        *(&v96.Reason + 1) = 32;
        ...
        do
        {
          ...
          if ( RecentEvents )
          {
            v23 = CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), (unsigned int)v19 + 16, RecentEvents);
            if ( v23 )
        ...
        while ( v19 < 0xBu );
        v24 = (unsigned int *)*((_QWORD *)a1 + 357);
        CTDR_DUMP_BUFFER::ShrinkLastSegment((CTDR_DUMP_BUFFER *)v24);
        *((_QWORD *)a1 + 356) = v24[6];
        *((_DWORD *)a1 + 36) = 27;
        if ( a2 )
          TdrUpdateDbgReport(a1, 1);
        v25 = CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 1, 0x200004u);
        v26 = v25;
        if ( v25 )
        {
          v27 = *((_DWORD *)a1 + 4) == 6;
          ...
          v96.pBuffer = v25;
          v29 = (char *)v25;
          v96.BufferSize = 0x200000LL;
          if ( v27 )
            v28 = 321;
          v30 = (DXGKARG_COLLECTDBGINFO_EXT *)*((_QWORD *)a1 + 358);
          v96.Reason = v28;
          v96.pExtension = v30;
          CTDR_DUMP_BUFFER_CANARY::CTDR_DUMP_BUFFER_CANARY((CTDR_DUMP_BUFFER_CANARY *)&v94, v29, 0x200000);
          CTDR_DUMP_BUFFER_CANARY::CTDR_DUMP_BUFFER_CANARY((CTDR_DUMP_BUFFER_CANARY *)&v95, *((char **)a1 + 358), 32);
        ...
        v41 = (unsigned int *)*((_QWORD *)a1 + 357);
        CTDR_DUMP_BUFFER::ShrinkLastSegment((CTDR_DUMP_BUFFER *)v41);
        *((_QWORD *)a1 + 356) = v41[6];
        *((_DWORD *)a1 + 36) = 1;
        if ( a2 )
          TdrUpdateDbgReport(a1, 1);
        v42 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 2, 0x4004u);
        v43 = v42;
        if ( v42 )
        {
        ...
        *((_DWORD *)a1 + 36) = 2;
        if ( a2 )
          TdrUpdateDbgReport(a1, 1);
        v49 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 6, 0x404u);
        v50 = (__int64)v49;
        if ( v49 )
        {
          CTDR_DUMP_BUFFER_CANARY::CTDR_DUMP_BUFFER_CANARY((CTDR_DUMP_BUFFER_CANARY *)&v94, v49, 1024);
          AdapterDebugData = DpiGetAdapterDebugData(*(_QWORD *)(*((_QWORD *)a1 + 4) + 192LL), v50);
        ...
        v54 = (unsigned int *)*((_QWORD *)a1 + 357);
        ...
        *((_DWORD *)a1 + 36) = 6;
        ...
        if ( !(unsigned __int8)TdrIsDisplayOnlyTdr(*((unsigned int *)a1 + 4)) && !v93 )
        {
          ...
          if ( v59 )
          {
            ...
            v61 = v58;
            v62 = (*(__int64 (__fastcall **)(struct _TDR_RECOVERY_CONTEXT *, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2136LL) + 376LL) + 8LL)
                                                                                            + 512LL))(
                    a1,
                    v60,
                    v58);
          ...
          v66 = (unsigned int *)*((_QWORD *)a1 + 357);
        ...
        {
          v68 = (CTDR_DUMP_BUFFER *)*((_QWORD *)a1 + 357);
          CTDR_DUMP_BUFFER::ShrinkLastSegment(v68);
          v69 = *((_DWORD *)v68 + 4) - *((_DWORD *)v68 + 6) - 10248;
          v70 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 4, v69 + 4);
          v71 = v70;
          if ( v70 )
          {
            ...
            if ( v72 )
              ...
              v73 = 0LL;
            if ( !(*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2136LL) + 400LL) + 8LL)
                                                                                             + 344LL))(
                    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2136LL) + 408LL),
                    *((unsigned int *)a1 + 14),
                    *((_QWORD *)a1 + 8),
                    v73,
                    v71,
          ...
          v76 = (unsigned int *)*((_QWORD *)a1 + 357);
        ...
        v77 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 9, 0xCu);
        v78 = (__int64)v77;
        if ( v77 )
        {
        ...
        *((_DWORD *)a1 + 36) = 9;
        ...
        if ( (int)DpiGetDbgInfoAdapters((__int64)v99) >= 0 )
        {
          for ( i = 0; i < 7u; ++i )
          {
            ...
            if ( !v84 )
              break;
            v85 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), (unsigned int)i + 32, 0x14u);
            v86 = v85;
            if ( !v85 )
            {
              *((_DWORD *)a1 + 29) |= 0x80000000;
            ...
            *(_DWORD *)v86 = v84;
            ...
            v91 = (unsigned int *)*((_QWORD *)a1 + 357);
