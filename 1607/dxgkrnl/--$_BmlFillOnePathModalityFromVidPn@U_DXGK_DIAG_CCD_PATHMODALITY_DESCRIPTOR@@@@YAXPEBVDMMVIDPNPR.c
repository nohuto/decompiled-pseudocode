/*
 * XREFs of ??$_BmlFillOnePathModalityFromVidPn@U_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR@@@@YAXPEBVDMMVIDPNPRESENTPATH@@PEAU_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00BC048
 * Callers:
...
__int64 __fastcall _BmlFillOnePathModalityFromVidPn<_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR>(__int64 a1, __int64 a2)
{
  ...
  if ( v7 )
  {
    if ( (*(_DWORD *)a2 & 0x100) != 0 )
    {
      ...
      if ( *(_DWORD *)(a2 + 80) != GraphicsInfo->PrimSurfSize.cx
        || *(_DWORD *)(a2 + 84) != GraphicsInfo->PrimSurfSize.cy )
      {
        *(_DWORD *)a2 &= ~0x800000u;
      }
    }
    ...
    *(_OWORD *)(a2 + 80) = *(_OWORD *)&v8->PrimSurfSize.cx;
    v9 = *(_OWORD *)&v8->Stride;
    *(_DWORD *)a2 |= 0x100u;
    *(_OWORD *)(a2 + 96) = v9;
  }
  ...
  *(_DWORD *)(a2 + 72) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 96) + 96LL) + 72LL);
