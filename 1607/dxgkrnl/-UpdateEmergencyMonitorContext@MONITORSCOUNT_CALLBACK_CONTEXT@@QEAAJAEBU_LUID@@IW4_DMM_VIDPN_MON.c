/*
 * XREFs of ?UpdateEmergencyMonitorContext@MONITORSCOUNT_CALLBACK_CONTEXT@@QEAAJAEBU_LUID@@IW4_DMM_VIDPN_MONITOR_TYPE@@@Z @ 0x1C017A3A0
 * Callers:
...
__int64 __fastcall MONITORSCOUNT_CALLBACK_CONTEXT::UpdateEmergencyMonitorContext(__int64 a1, struct _LUID *a2, int a3)
{
  ...
  _BYTE v22[80]; // [rsp+30h] [rbp-58h] BYREF
