/*
 * XREFs of ?_GetMonitorDescriptorIDs@DXGMONITOR@@QEAAJPEAU_DXGK_GENERIC_DESCRIPTOR@@@Z @ 0x1C00F1D0C
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        SourceString[7] = 0;
        v15 = DxgkConvertStringToWideString(SourceString, 0x66uLL, a2->HardwareId);
        v17 = v15;
        if ( v15 < 0 )
        {
