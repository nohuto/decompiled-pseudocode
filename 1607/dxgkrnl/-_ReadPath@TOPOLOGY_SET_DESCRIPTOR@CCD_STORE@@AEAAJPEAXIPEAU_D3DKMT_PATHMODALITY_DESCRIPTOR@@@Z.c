/*
 * XREFs of ?_ReadPath@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@AEAAJPEAXIPEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00B4B4C
 * Callers:
        ...
        struct _D3DKMT_PATHMODALITY_DESCRIPTOR *a4)
{
  ...
  {
    v10 = CcdReadRegistryValues(a2, &pszDest, &unk_1C00561D0, 0xDu, (__int64)a4);
    v9 = v10;
    if ( v10 < 0 )
    {
    ...
    else
    {
      ...
      {
        v15 = CcdReadRegistryValues(a2, &pszDest, &unk_1C0056520, 6u, (__int64)a4);
        v9 = v15;
        if ( v15 < 0 )
        {
          ...
          RegistryValues = CcdReadRegistryValues(a2, 0LL, &unk_1C0056670, 8u, (__int64)a4);
          v31 = RegistryValues;
          if ( RegistryValues < 0 )
          {
      ...
      {
        v20 = CcdReadRegistryValues(a2, &pszDest, &unk_1C00560B0, 5u, (__int64)a4);
        v9 = v20;
        if ( v20 < 0 )
        {
        ...
        else if ( *((_DWORD *)a4 + 42) == *((_DWORD *)a4 + 40) || *((_DWORD *)a4 + 43) == *((_DWORD *)a4 + 41) )
        {
          *(_DWORD *)a4 &= ~0x800000u;
        }
      }
