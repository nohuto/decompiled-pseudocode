/*
 * XREFs of ?ProcessComponentIdleList@DXGADAPTER@@QEAAXXZ @ 0x1C00089A0
 * Callers:
 *     ?DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C0011290 (-DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessComponentIdleList(KSPIN_LOCK *this)
{
  ...
  if ( !*((_BYTE *)this + 2606) )
  {
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 338, &LockHandle);
    v17[1] = v17;
    v3 = (char *)(this + 332);
    v17[0] = v17;
    v4 = (char *)this[332];
