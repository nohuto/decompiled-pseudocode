/*
 * XREFs of ?RegQueryControllerInstallKey@DisjointExperienceConfig@DefaultMultiScreenConfig@@YAJPEAGKPEAK@Z @ 0x1C0026A48
 * Callers:
 ...
 *     KappxParsePackageFullNameFromToken @ 0x1C0191CD8 (KappxParsePackageFullNameFromToken.c)
 */
