/*
 * XREFs of DpiMiracastHandlePowerCallback @ 0x1C01974C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiMiracastHandlePowerCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      if ( *Value )
      {
        if ( byte_1C0056E9A && KeCancelTimer(&Timer) )
        {
          _InterlockedIncrement(&dword_1C0057220);
      ...
      {
        byte_1C0056E9A = 1;
        if ( byte_1C0056E99 && dword_1C00571F0 )
        {
