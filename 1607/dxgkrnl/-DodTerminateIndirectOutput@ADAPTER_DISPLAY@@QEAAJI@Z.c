/*
 * XREFs of ?DodTerminateIndirectOutput@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C0147B60
 * Callers:
...
LABEL_5:
  ...
  if ( !*(_QWORD *)(v8 + 1432) )
    return 3221225659LL;
  if ( (*(unsigned int (__fastcall **)(_QWORD, _QWORD))(v8 + 1432))(*(_QWORD *)(v8 + 1368), (unsigned int)a2) == -1073741637 )
