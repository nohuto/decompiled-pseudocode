/*
 * XREFs of ?BmlGetPathModalityForAdapterWithCoreAccessHeld@@YAJPEAU_D3DKMT_GETPATHSMODALITY@@PEAX_NW4DXGK_DIAG_CCD_BML_ORIGIN@@IPEAPEAUD3DKMDT_HVIDPN__@@@Z @ 0x1C00BCB40
 * Callers:
        ...
        __int64 a6)
{
  ...
  v6 = (unsigned __int16 *)&unk_1C0056C68;
  v11 = 0;
  do
  {
    v12 = v6[1];
    ...
    DxgkLogCodePointPacket(0x17u, v11++, *v6, 0xC01E0306);
    v6 += 2;
  }
  while ( v11 < 5 );
  if ( (int)v19 >= 0 )
