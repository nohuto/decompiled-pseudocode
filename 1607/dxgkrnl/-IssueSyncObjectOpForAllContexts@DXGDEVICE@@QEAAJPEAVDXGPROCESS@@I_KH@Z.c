/*
 * XREFs of ?IssueSyncObjectOpForAllContexts@DXGDEVICE@@QEAAJPEAVDXGPROCESS@@I_KH@Z @ 0x1C006E408
 * Callers:
        ...
        int a5)
{
  ...
  {
    v17 = (char *)this + 312;
    for ( i = (char *)*((_QWORD *)this + 39); i != v17 && i; i = *(char **)i )
    {
      v19 = *((_DWORD *)i + 6);
      v26[0] = a3;
      v20 = WaitForSynchronizationObjectFromGpu(1u, v26, 0LL, a4, v19, a2, 1, 0);
      v9 = v20;
      if ( v20 < 0 )
      {
  ...
  if ( v14 )
  {
    ...
    if ( v12 != (_DWORD)v16 )
    {
      ...
      *(_QWORD *)(v23 + 24) = 5203LL;
      WdLogEvent5_WdAssertion(v23);
    }
    v21 = SignalSynchronizationObjectInternal(1u, v26, 0, v12, v14, 0LL, a4, 0LL, a2, 0, 1);
    v9 = v21;
    if ( v21 < 0 )
    {
