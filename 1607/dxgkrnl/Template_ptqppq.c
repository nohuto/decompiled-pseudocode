/*
 * XREFs of Template_ptqppq @ 0x1C003245C
 * Callers:
...
NTSTATUS Template_ptqppq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventOpmCreateProtectedOutput, 0LL, 6u, &UserData);
}
