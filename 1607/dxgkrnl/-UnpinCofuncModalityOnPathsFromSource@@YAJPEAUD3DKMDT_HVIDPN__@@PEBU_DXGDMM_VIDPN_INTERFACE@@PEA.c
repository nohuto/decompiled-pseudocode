/*
 * XREFs of ?UnpinCofuncModalityOnPathsFromSource@@YAJPEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@I_K@Z @ 0x1C00C532C
 * Callers:
...
LABEL_46:
  ...
  if ( !v58 )
  {
    ...
    *(_QWORD *)(v42 + 24) = 3134LL;
    WdLogEvent5_WdAssertion(v42);
  }
  if ( !v60 )
  {
    v43 = WdLogNewEntry5_WdAssertion(v13);
    *(_QWORD *)(v43 + 24) = 3135LL;
...
LABEL_45:
    ...
    if ( !v58 )
    {
      ...
      *(_QWORD *)(v45 + 24) = 3234LL;
      WdLogEvent5_WdAssertion(v45);
    }
    if ( !v61 )
    {
      v46 = WdLogNewEntry5_WdAssertion(v26);
      *(_QWORD *)(v46 + 24) = 3235LL;
