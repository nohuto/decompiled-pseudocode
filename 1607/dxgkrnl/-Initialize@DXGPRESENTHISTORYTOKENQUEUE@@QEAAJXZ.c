/*
 * XREFs of ?Initialize@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJXZ @ 0x1C00CAFD8
 * Callers:
...
NTSTATUS __fastcall DXGPRESENTHISTORYTOKENQUEUE::Initialize(union _SLIST_HEADER *this)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    result = ObCreateObject(0LL, ExSemaphoreObjectType, &ObjectAttributes, 0LL, 0LL, 32, 0, 0, &this[4]);
    v5 = result;
    if ( result >= 0 )
    {
