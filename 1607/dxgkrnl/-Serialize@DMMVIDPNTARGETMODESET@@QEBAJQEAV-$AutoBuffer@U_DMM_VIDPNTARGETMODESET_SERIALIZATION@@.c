/*
 * XREFs of ?Serialize@DMMVIDPNTARGETMODESET@@QEBAJQEAV?$AutoBuffer@U_DMM_VIDPNTARGETMODESET_SERIALIZATION@@@DMM@@@Z @ 0x1C01A9F54
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      *v13 = *((_BYTE *)this + 64);
      if ( (_QWORD *)*v14 != v14 )
      {
        for ( i = (struct DMMVIDPNSOURCEMODE *)(*v14 - 8LL); i; i = DMMVIDPNSOURCEMODESET::GetNextMode(this, i) )
        {
          v17 = *(_QWORD *)(a2 + 32);
          v18 = 9LL * v15;
