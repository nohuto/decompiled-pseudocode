/*
 * XREFs of ?HandleRapidHPDAction@@YAJQEAUMONITORSCOUNT_CALLBACK_CONTEXT@@AEBU_LUID@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0179FF4
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a4)
{
  ...
  *((_DWORD *)a1 + 8) |= 0x10u;
  v17 = 0;
  if ( (int)DisplayConfigHelperCreateSimulateMonitor(a2, a3, 3, 0, (__int64)&v17, (__int64)a4) >= 0 )
    *((_BYTE *)a1 + 25) = 0;
