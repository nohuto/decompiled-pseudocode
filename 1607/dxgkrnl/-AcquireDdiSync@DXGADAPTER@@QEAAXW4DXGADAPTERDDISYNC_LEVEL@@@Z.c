/*
 * XREFs of ?AcquireDdiSync@DXGADAPTER@@QEAAXW4DXGADAPTERDDISYNC_LEVEL@@@Z @ 0x1C0008810
 * Callers:
...
char __fastcall DXGADAPTER::AcquireDdiSync(__int64 a1, int a2)
{
  ...
  if ( !v2
    || !*(_QWORD *)(v2 + 384)
    || (LOBYTE(CurrentThread) = (*(__int64 (**)(void))(*(_QWORD *)(*(_QWORD *)(v2 + 376) + 8LL) + 72LL))(),
        !(_BYTE)CurrentThread)
    && (CurrentThread = KeGetCurrentThread(), *(struct _KTHREAD **)(a1 + 2144) != CurrentThread) )
  {
    ...
    {
      v6 = WdLogNewEntry5_WdError((unsigned int)(v4 - 1));
      *(_QWORD *)(v6 + 24) = v4;
