/*
 * XREFs of ?DdiGetStandardAllocationDriverData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETSTANDARDALLOCATIONDRIVERDATA@@@Z @ 0x1C0093B78
 * Callers:
...
LABEL_23:
  v14 = 0;
LABEL_12:
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETSTANDARDALLOCATIONDRIVERDATA *))(*((_QWORD *)this + 2) + 352LL))(
  ...
  v19[3] = v16;
  v19[4] = a2->AllocationPrivateDriverDataSize;
  v19[5] = a2->ResourcePrivateDriverDataSize;
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v21, &EventProfilerExit, v22, 5004);
