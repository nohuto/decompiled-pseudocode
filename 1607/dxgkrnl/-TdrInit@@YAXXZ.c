/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1C00F9200
 * Callers:
...
void TdrInit(void)
{
  ...
  if ( dword_1C0057364 != v28 )
  {
    v20 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v20 + 24) = v28;
    *(_QWORD *)(v20 + 32) = (unsigned int)dword_1C0057364;
  ...
  if ( dword_1C0057368 != v29 )
  {
    v21 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v21 + 24) = v29;
    *(_QWORD *)(v21 + 32) = (unsigned int)dword_1C0057368;
  ...
  if ( dword_1C005736C != v30 )
  {
    v22 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v22 + 24) = v30;
    *(_QWORD *)(v22 + 32) = (unsigned int)dword_1C005736C;
  ...
  if ( dword_1C0057370 != v31 )
  {
    v23 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v23 + 24) = v31;
    *(_QWORD *)(v23 + 32) = (unsigned int)dword_1C0057370;
  ...
  if ( dword_1C0057378 != v32 )
  {
    v24 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v24 + 24) = v32;
    *(_QWORD *)(v24 + 32) = (unsigned int)dword_1C0057378;
  ...
  if ( dword_1C005737C != v33 )
  {
    v25 = WdLogNewEntry5_WdWarning(3600LL, v2, v4, v5);
    *(_QWORD *)(v25 + 24) = v33;
    *(_QWORD *)(v25 + 32) = (unsigned int)dword_1C005737C;
    WdLogEvent5_WdWarning(v25);
  }
  LOBYTE(v13) = 1;
  byte_1C0057374 = (unsigned __int8)WdIsDebuggerPresent(v13) != 0;
  if ( v27 <= 3 )
    v0 = v27;
  g_TdrDebugMode = v0;
  if ( v0 != v27 )
