/*
 * XREFs of DpiDxgkDdiStopDeviceAndReleasePostDisplayOwnership @ 0x1C019EB60
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    Template_pqqqqqq(a1, &EventEnterDdiStopDeviceAndReleasePostDisplayOwnership, a3, a2, a3, 0, 0, 0, 0, 0);
