/*
 * XREFs of DpiSetDevicePowerTransitionStateAtPassiveLevel @ 0x1C0029FAC
 * Callers:
...
void __fastcall DpiSetDevicePowerTransitionStateAtPassiveLevel(__int64 a1, int a2, char a3)
{
  ...
  if ( (_DWORD)v3 != 5 || *(_DWORD *)(a1 + 3928) == 4 )
  {
  ...
  if ( a3 && !*(_DWORD *)(a1 + 3932) )
  {
    ...
    DxgkReportDevicePoweredOn(*(_QWORD *)(a1 + 3688));
  }
