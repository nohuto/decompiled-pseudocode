/*
 * XREFs of ?DxgkCddNotifyGdiRendering@@YAJPEAXI@Z @ 0x1C0155540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddNotifyGdiRendering(struct _KTHREAD **a1, unsigned int a2)
{
  ...
  if ( v4 < *((_DWORD *)a1 + 56)
    && (v5 = a1[26],
        v6 = *((_DWORD *)v5 + 4 * v4 + 2),
        (((unsigned int)v2 >> 26) & 0x30) == (*((_BYTE *)v5 + 16 * v4 + 8) & 0x30))
    && (v6 & 0x1000) == 0
    && (v6 & 0xF) != 0
    && (*((_BYTE *)v5 + 16 * v4 + 8) & 0xF) == 5 )
  {
    v7 = (struct _EX_RUNDOWN_REF *)*((_QWORD *)v5 + 2 * v4);
  }
  else
  {
    v7 = 0LL;
