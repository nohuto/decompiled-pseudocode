/*
 * XREFs of ?GetConnectedSetStr@CCD_SET_STRING_ID@@QEBAAEBU_STRING@@XZ @ 0x1C008DF00
 * Callers:
 ...
 *     ?_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z @ 0x1C008DFB0 (-_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z.c)
