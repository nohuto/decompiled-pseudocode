/*
 * XREFs of DxgkReleaseSwapChain @ 0x1C01904D0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(((unsigned __int64)&v19 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = *(_QWORD *)(v4 + 16);
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_QWORD *)(((unsigned __int64)&v19 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = 0LL;
    ...
    v17 = SwapChainReleaseInternal(**(struct DXGSWAPCHAIN ***)v3, (struct _D3DKMT_RELEASESWAPCHAIN *)(v3 + 8), v15, 1);
    ObfDereferenceObject(v16);
    if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(qword_1C0056840, &EventProfilerExit, v18, 2112);
    return v17;
  }
  else
  {
    ...
    *(_QWORD *)(v12 + 32) = v11;
    ...
    if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(qword_1C0056840, &EventProfilerExit, v13, 2112);
