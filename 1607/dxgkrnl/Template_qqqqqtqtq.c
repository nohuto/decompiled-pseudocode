/*
 * XREFs of Template_qqqqqtqtq @ 0x1C0027C30
 * Callers:
...
NTSTATUS __fastcall Template_qqqqqtqtq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v27 = 4LL;
  v29 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &Dxgk_Diag_OutputDupl_High_Level_Update_Stop, 0LL, 9u, &UserData);
}
