/*
 * XREFs of ?WriteDxgDiagnosticsEvent_COMMIT_VIDPN_FAILED@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0023DA4
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_COMMIT_VIDPN_FAILED(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  EVENT_DATA_DESCRIPTOR v122; // [rsp+378h] [rbp+270h] BYREF
  void *v123; // [rsp+398h] [rbp+290h]
  __int64 v124; // [rsp+3A0h] [rbp+298h]
  int *v125; // [rsp+3A8h] [rbp+2A0h]
  __int64 v126; // [rsp+3B0h] [rbp+2A8h]
  int *v127; // [rsp+3B8h] [rbp+2B0h]
  __int64 v128; // [rsp+3C0h] [rbp+2B8h]
  int *v129; // [rsp+3C8h] [rbp+2C0h]
  __int64 v130; // [rsp+3D0h] [rbp+2C8h]
  int *v131; // [rsp+3D8h] [rbp+2D0h]
  __int64 v132; // [rsp+3E0h] [rbp+2D8h]
  int *v133; // [rsp+3E8h] [rbp+2E0h]
  __int64 v134; // [rsp+3F0h] [rbp+2E8h]
  int *v135; // [rsp+3F8h] [rbp+2F0h]
  __int64 v136; // [rsp+400h] [rbp+2F8h]
  int *v137; // [rsp+408h] [rbp+300h]
  __int64 v138; // [rsp+410h] [rbp+308h]
  const GUID *v139; // [rsp+418h] [rbp+310h]
  __int64 v140; // [rsp+420h] [rbp+318h]
  int *v141; // [rsp+428h] [rbp+320h]
  __int64 v142; // [rsp+430h] [rbp+328h]
  int *v143; // [rsp+438h] [rbp+330h]
  __int64 v144; // [rsp+440h] [rbp+338h]
  unsigned __int16 *v145; // [rsp+448h] [rbp+340h]
  __int64 v146; // [rsp+450h] [rbp+348h]
  int *v147; // [rsp+458h] [rbp+350h]
  int v148; // [rsp+460h] [rbp+358h]
  int v149; // [rsp+464h] [rbp+35Ch]
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000100uLL) )
  {
    if ( *(_DWORD *)(v1 + 68) )
    {
      if ( hProvider > 4u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000100uLL) )
        {
          ...
          v119 = v3;
          v121 = v4;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003B879, 0LL, v2, 0x2Fu, &pData);
        }
      }
    }
    else if ( hProvider > 4u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000100uLL) )
    {
      ...
      v147 = v8;
      v149 = v9;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003B7AE, 0LL, v7, 0xFu, &v122);
    }
  }
}
