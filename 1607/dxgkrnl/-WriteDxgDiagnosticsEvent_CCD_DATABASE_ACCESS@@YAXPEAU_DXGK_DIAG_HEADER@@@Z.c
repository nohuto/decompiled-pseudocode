/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CCD_DATABASE_ACCESS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C000B4A0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CCD_DATABASE_ACCESS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  EVENT_DATA_DESCRIPTOR v114; // [rsp+358h] [rbp+250h] BYREF
  void *v115; // [rsp+378h] [rbp+270h]
  __int64 v116; // [rsp+380h] [rbp+278h]
  int *v117; // [rsp+388h] [rbp+280h]
  __int64 v118; // [rsp+390h] [rbp+288h]
  int *v119; // [rsp+398h] [rbp+290h]
  __int64 v120; // [rsp+3A0h] [rbp+298h]
  int *v121; // [rsp+3A8h] [rbp+2A0h]
  __int64 v122; // [rsp+3B0h] [rbp+2A8h]
  int *v123; // [rsp+3B8h] [rbp+2B0h]
  __int64 v124; // [rsp+3C0h] [rbp+2B8h]
  int *v125; // [rsp+3C8h] [rbp+2C0h]
  __int64 v126; // [rsp+3D0h] [rbp+2C8h]
  int *v127; // [rsp+3D8h] [rbp+2D0h]
  __int64 v128; // [rsp+3E0h] [rbp+2D8h]
  const GUID *v129; // [rsp+3E8h] [rbp+2E0h]
  __int64 v130; // [rsp+3F0h] [rbp+2E8h]
  int *v131; // [rsp+3F8h] [rbp+2F0h]
  __int64 v132; // [rsp+400h] [rbp+2F8h]
  int *v133; // [rsp+408h] [rbp+300h]
  __int64 v134; // [rsp+410h] [rbp+308h]
  unsigned __int16 *v135; // [rsp+418h] [rbp+310h]
  __int64 v136; // [rsp+420h] [rbp+318h]
  int *v137; // [rsp+428h] [rbp+320h]
  int v138; // [rsp+430h] [rbp+328h]
  int v139; // [rsp+434h] [rbp+32Ch]
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000040uLL) )
  {
    if ( *(_DWORD *)(v1 + 60) )
    {
      if ( hProvider > 4u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000040uLL) )
        {
          ...
          v111 = v3;
          v113 = v4;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003AA46, 0LL, v2, 0x2Eu, &pData);
        }
      }
    }
    else if ( hProvider > 4u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000040uLL) )
    {
      ...
      v137 = v7;
      v139 = v8;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003A9A1, 0LL, v6, 0xEu, &v114);
    }
  }
}
