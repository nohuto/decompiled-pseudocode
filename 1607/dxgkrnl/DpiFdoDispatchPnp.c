/*
 * XREFs of DpiFdoDispatchPnp @ 0x1C00F8480
 * Callers:
 *     <none>
 * Callees:
  ...
  switch ( MinorFunction )
  {
    ...
    case 1u:
      ...
      if ( DeviceExtension[483] )
        DpiCheckForOutstandingD3Requests((__int64)DeviceExtension);
      ExAcquireResourceExclusiveLite(*((PERESOURCE *)DeviceExtension + 21), 1u);
      if ( byte_1C0056E91 || DeviceExtension[480] )
      {
        v7 = 1;
        Status = -1073741823;
      }
      else
      {
        ...
        *((_DWORD *)DeviceExtension + 59) = 5;
        if ( v16 && *((_DWORD *)DeviceExtension + 5) == 2 && DeviceExtension[4952] )
          Status = 259;
        else
LABEL_78:
          Status = 0;
...
LABEL_60:
  ...
  if ( MinorFunction != 20 )
  {
    ...
    *((_DWORD *)DeviceExtension + 59) = 6;
    if ( !v16 || *((_DWORD *)DeviceExtension + 5) != 2 || (Status = 259, !DeviceExtension[4952]) )
      Status = 0;
...
LABEL_21:
  if ( Status == 259 )
  {
    ...
    v32 = (void *)*((_QWORD *)DeviceExtension + 618);
    if ( v32 )
    {
      v33 = IoCsqRemoveNextIrp((PIO_CSQ)(DeviceExtension + 4840), v32);
    ...
    *((_QWORD *)DeviceExtension + 617) = Irp;
