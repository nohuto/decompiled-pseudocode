/*
 * XREFs of MonitorGetMonitorDeviceInterfaceName @ 0x1C00BA98C
 * Callers:
 ...
 *     RtlStringCchCopyUnicodeString @ 0x1C000CDDC (RtlStringCchCopyUnicodeString.c)
        ...
        NTSTRSAFE_PWSTR pszDest)
{
  ...
  *(_QWORD *)(v8 + 32) = this;
  ...
  v13 = (struct _ERESOURCE *)((char *)v12 + 240);
