/*
 * XREFs of Template_pqqqqqttttttttq @ 0x1C0027E00
 * Callers:
...
NTSTATUS Template_pqqqqqttttttttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_list va13; // [rsp+1C0h] [rbp+C0h]
  va_list va14; // [rsp+1C8h] [rbp+C8h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v30 = 4LL;
  v32 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventOutputDuplicationProcessHighLevel, 0LL, 0xFu, &UserData);
}
