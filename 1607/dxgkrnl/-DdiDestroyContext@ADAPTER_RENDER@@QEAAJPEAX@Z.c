/*
 * XREFs of ?DdiDestroyContext@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C0091524
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyContext@@YAJPEAVADAPTER_RENDER@@QEAX@Z @ 0x1C0021FF0 (-ADAPTER_RENDER_DdiDestroyContext@@YAJPEAVADAPTER_RENDER@@QEAX@Z.c)
...
LABEL_22:
  v14 = 0;
LABEL_12:
  v16 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 648LL))(a2);
  ...
  *(_QWORD *)(v19 + 32) = a2;
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v21, &EventProfilerExit, v22, 5042);
