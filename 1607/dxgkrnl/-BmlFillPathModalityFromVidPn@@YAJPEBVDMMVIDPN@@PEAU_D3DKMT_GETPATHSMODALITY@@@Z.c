/*
 * XREFs of ?BmlFillPathModalityFromVidPn@@YAJPEBVDMMVIDPN@@PEAU_D3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00BC524
 * Callers:
      ...
      do
      {
        ...
        while ( v10 )
        {
          ...
          if ( (*((_DWORD *)v12 + 12) & 0x7000) == 0x7000 )
          {
            ...
            a1 = (const struct DMMVIDPN *)*(unsigned int *)(*((_QWORD *)a2 + 2) + 268LL);
              ...
              if ( *((_DWORD *)v12 + 15) == *((_DWORD *)a1 + 68) )
              {
                ...
                if ( *((_DWORD *)v12 + 16) == (_DWORD)a1 )
                {
                  ...
                  if ( *((_DWORD *)v12 + 17) == (_DWORD)a1 )
                  {
                    ...
                    if ( v13 && *((_QWORD *)v12 + 17) != __PAIR64__(v20, v8) )
