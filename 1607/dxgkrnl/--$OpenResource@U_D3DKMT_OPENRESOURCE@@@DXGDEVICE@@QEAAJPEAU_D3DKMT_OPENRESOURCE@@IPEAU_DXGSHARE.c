/*
 * XREFs of ??$OpenResource@U_D3DKMT_OPENRESOURCE@@@DXGDEVICE@@QEAAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_DXGSHAREDALLOCOBJECT@@IPEAVCOREDEVICEACCESS@@HPEAU_EPROCESS@@PEAIPEA_K@Z @ 0x1C0097038
 * Callers:
...
LABEL_41:
  ...
  v16 = *(unsigned int *)(*(_QWORD *)(ObjectA + 128) - 44LL);
  if ( (v16 & 2) != 0 && !(*(unsigned int (**)(void))(*(_QWORD *)(*((_QWORD *)this + 5) + 72LL) + 208LL))() )
  {
  ...
  if ( *(_DWORD *)(v23 + 124) != *(_DWORD *)(a2 + 8) )
  {
    v54 = (_QWORD *)WdLogNewEntry5_WdError(v16);
    v54[3] = this;
    v55 = *(unsigned int *)(v23 + 124);
...
LABEL_47:
  ...
  if ( v24 )
    memmove(*(void **)(a2 + 24), *(const void **)(v23 + 96), v24);
  ...
  if ( (_DWORD)v30 != *(_DWORD *)(v23 + 120) )
  {
    v52 = (_QWORD *)WdLogNewEntry5_WdWarning(v30, v26, v28, v31);
    v52[3] = this;
    v52[4] = *(unsigned int *)(a2 + 48);
    v56 = *(unsigned int *)(v23 + 120);
    goto LABEL_47;
  }
  if ( (_DWORD)v30 )
    memmove(v31, *(const void **)(v23 + 112), v30);
  v32 = 0LL;
  v33 = *(char **)(a2 + 56);
  v34 = *(_QWORD **)(v23 + 128);
  v62 = 0;
