/*
 * XREFs of ?AcquireDiagInfo@VIDPN_MGR@@QEAAJQEAX_KW4DIAGINFO_TYPE@1@QEBTDIAGINFO_CONTEXT@1@QEA_K@Z @ 0x1C019EE9C
 * Callers:
...
LABEL_7:
  ...
  if ( a6 )
    *a6 = 0LL;
  Src = 0LL;
  v115 = (__int64)&DMM::AutoBuffer<unsigned char>::`vftable'{for `SetElement'};
  v117 = &DMM::AutoBuffer<unsigned char>::`vftable'{for `NonReferenceCounted'};
  v119 = 0LL;
  v120 = 3;
  v116 = 0LL;
  if ( (int)v6 > 7 )
    ...
    else
    {
      ...
      if ( (int)v6 > 11 )
      {
        if ( (_DWORD)v6 == 12 )
        {
          ...
          auto_rc<DMMVIDPN const>::reset(&v113, v61);
          v66 = v113;
          if ( v113 )
          {
            v70 = DMMVIDPN::Serialize(v113, &v115);
            v23 = v70;
            if ( v70 >= 0 )
            {
              v35 = &v113;
...
LABEL_71:
            ...
            if ( (int)v23 >= 0 )
            {
              ...
              v119 = v54;
              DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v123 + 40));
              goto LABEL_140;
            }
...
LABEL_79:
      ...
      v114 = 0LL;
      v77 = VIDPN_MGR::CreateClientVidPnFromActive((__int64)v9, &v114, v75, v76);
      v23 = v77;
      if ( v77 >= 0 )
      {
        v80 = v114;
        v81 = (unsigned int)*a5;
        if ( DMMVIDPNTOPOLOGY::IsSourceInTopology((DMMVIDPNTOPOLOGY *)(v114 + 96), *a5) )
        {
          ...
          if ( v86 >= 0 )
          {
            ...
            if ( v88 >= 0 )
            {
              auto_rc<DMMVIDPN>::reset(&v114, 0LL);
              DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v124 + 40));
              v8 = v126;
              goto LABEL_139;
            }
          }
...
LABEL_149:
  DMM::AutoBuffer<unsigned char>::~AutoBuffer<unsigned char>(&v115);
