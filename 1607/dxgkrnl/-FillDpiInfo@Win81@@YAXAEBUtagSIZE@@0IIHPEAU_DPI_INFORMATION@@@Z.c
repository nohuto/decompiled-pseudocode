/*
 * XREFs of ?FillDpiInfo@Win81@@YAXAEBUtagSIZE@@0IIHPEAU_DPI_INFORMATION@@@Z @ 0x1C0190940
 * Callers:
 ...
 * Callees:
 *     ?CalcDpi@Win81@@YAIII@Z @ 0x1C0190704 (-CalcDpi@Win81@@YAIII@Z.c)
 *     ?SatisfyMinResolutionBarForScaleIdx@Win81@@YAKHUtagSIZE@@QEBUDPI_SCALE_FACTOR_COLLECTION@1@@Z @ 0x1C0190E38 (-SatisfyMinResolutionBarForScaleIdx@Win81@@YAKHUtagSIZE@@QEBUDPI_SCALE_FACTOR_COLLECTION@1@@Z.c)
 */
        ...
        __int64 a6)
{
  ...
  *(_QWORD *)(a6 + 56) = v17;
  ...
  do
  {
    if ( (unsigned int)(((int)v17 + v12.cx) / 2) < *(_DWORD *)v13 )
      break;
    ++v8;
    v13 += 2;
  }
