/*
 * XREFs of ?SuspendResumeEscapeAllDevices@DXGPROCESS@@QEAAXPEBVDXGADAPTER@@_N1@Z @ 0x1C0173C9C
 * Callers:
        ...
        char a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(const struct DXGADAPTER **)(*((_QWORD *)Current + 2) + 16LL) == a2 )
    {
      ...
      LOBYTE(v14) = a4;
      v15 = *(_QWORD *)(*((_QWORD *)v13 + 2) + 400LL);
      v16 = *(_QWORD *)(v15 + 8);
      LOBYTE(v15) = a3;
      (*(void (__fastcall **)(_QWORD, __int64, __int64))(v16 + 1096))(*((_QWORD *)v13 + 70), v15, v14);
      if ( v18[0] )
