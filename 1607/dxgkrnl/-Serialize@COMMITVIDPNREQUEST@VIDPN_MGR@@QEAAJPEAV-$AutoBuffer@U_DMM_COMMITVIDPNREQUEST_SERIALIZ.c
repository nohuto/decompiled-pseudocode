/*
 * XREFs of ?Serialize@COMMITVIDPNREQUEST@VIDPN_MGR@@QEAAJPEAV?$AutoBuffer@U_DMM_COMMITVIDPNREQUEST_SERIALIZATION@@@DMM@@@Z @ 0x1C0033C60
 * Callers:
...
__int64 __fastcall VIDPN_MGR::COMMITVIDPNREQUEST::Serialize(__int64 a1, __int64 a2)
{
  ...
  Src = 0LL;
  Size = 0LL;
  v12 = &DMM::AutoBuffer<_DMM_VIDPN_SERIALIZATION>::`vftable'{for `SetElement'};
  v14 = &DMM::AutoBuffer<_DMM_VIDPN_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v13 = 0LL;
  v17 = 3;
  ...
  DMM::AutoBuffer<_DMM_VIDPN_SERIALIZATION>::~AutoBuffer<_DMM_VIDPN_SERIALIZATION>(&v12);
