/*
 * XREFs of ?DdiDestroyVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYVIRTUALGPU@@@Z @ 0x1C015800C
 * Callers:
...
LABEL_10:
  ...
  v14 = *(_DWORD *)(v9 + 136);
LABEL_11:
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_DESTROYVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                           + 88LL))(
