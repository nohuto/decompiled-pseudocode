/*
 * XREFs of ?FindPathByMonitorId@CCD_SET_STRING_ID@@QEBAJAEBU_STRING@@PEAI@Z @ 0x1C01AADE8
 * Callers:
 *     ?_TryToMapCloneGroups@CCD_SET_STRING_ID@@CA_NAEBV1@0@Z @ 0x1C01AB870 (-_TryToMapCloneGroups@CCD_SET_STRING_ID@@CA_NAEBV1@0@Z.c)
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  {
    v8 = (_QWORD *)WdLogNewEntry5_WdAssertion(this);
    v8[3] = this;
    v8[4] = a2->Buffer;
    v8[5] = a2->Length;
    v8[6] = a3;
