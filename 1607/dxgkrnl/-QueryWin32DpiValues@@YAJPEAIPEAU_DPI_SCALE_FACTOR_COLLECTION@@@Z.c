/*
 * XREFs of ?QueryWin32DpiValues@@YAJPEAIPEAU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x1C00D9C74
 * Callers:
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( a1 && (v13 = 0x400000000LL, v14 = a1, v4 = v7(&v13), v4 < 0) )
      {
        ...
        *(_QWORD *)(v12 + 24) = 1634LL;
      }
      else
      {
        if ( !a2 )
          return (unsigned int)v4;
        v9 = *(__int64 (__fastcall **)(__int64 *))(v6 + 368);
        v13 = 0x2000000001LL;
        v14 = (unsigned int *)a2;
        v4 = v9(&v13);
        if ( v4 >= 0 )
