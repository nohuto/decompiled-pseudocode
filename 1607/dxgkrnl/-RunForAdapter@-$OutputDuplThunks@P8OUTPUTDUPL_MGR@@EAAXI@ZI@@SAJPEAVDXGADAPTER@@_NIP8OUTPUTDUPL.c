/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@P8OUTPUTDUPL_MGR@@EAAXI@ZI@@SAJPEAVDXGADAPTER@@_NIP8OUTPUTDUPL_MGR@@EAAXI@ZIP6AJPEAV3@2I@Z@Z @ 0x1C00D9FB0
 * Callers:
 *     DxgkDesktopSwitch @ 0x1C00D9F80 (DxgkDesktopSwitch.c)
 * Callees:
        ...
        __int64 (__fastcall *a6)(struct OUTPUTDUPL_MGR *, void (__fastcall *)(OUTPUTDUPL_CONTEXT **this, unsigned int a2), _QWORD))
{
  ...
  if ( a1 )
  {
    ...
    {
      v22 = WdLogNewEntry5_WdWarning(v11, v10, v12, v13);
      *(_QWORD *)(v22 + 24) = a1;
      *(_QWORD *)(v22 + 32) = v14;
...
LABEL_5:
        ...
        v18 >= 0) )
  {
    ...
    {
      v18 = a6(RemoteOutputDuplMgr, OUTPUTDUPL_MGR::ProcessDesktopSwitch, a5);
    }
  }
