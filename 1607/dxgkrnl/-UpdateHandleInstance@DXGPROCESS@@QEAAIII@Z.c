/*
 * XREFs of ?UpdateHandleInstance@DXGPROCESS@@QEAAIII@Z @ 0x1C0009580
 * Callers:
  ...
  if ( v8 < *((_DWORD *)this + 56) )
  {
    ...
    if ( ((a2 >> 26) & 0x30) == (*(_BYTE *)(v9 + 16LL * v8 + 8) & 0x30) && (v10 & 0x1000) == 0 && (v10 & 0xF) != 0 )
    {
      *(_DWORD *)(v9 + 16LL * v8 + 8) ^= (*(_DWORD *)(v9 + 16LL * v8 + 8) ^ (a3 << 6)) & 0xFC0;
      v7 = (*(_DWORD *)(*((_QWORD *)this + 26) + 16LL * v8 + 8) >> 6) & 0x3F | (((*(_DWORD *)(*((_QWORD *)this + 26)
                                                                                            + 16LL * v8
                                                                                            + 8) << 20) ^ (v8 ^ (*(_DWORD *)(*((_QWORD *)this + 26) + 16LL * v8 + 8) << 20)) & 0xFFFFFF) << 6);
    }
  }
  *((_QWORD *)v3 + 1) = 0LL;
