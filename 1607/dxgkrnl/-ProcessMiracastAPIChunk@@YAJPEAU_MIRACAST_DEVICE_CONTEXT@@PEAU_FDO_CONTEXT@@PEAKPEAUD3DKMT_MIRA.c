/*
 * XREFs of ?ProcessMiracastAPIChunk@@YAJPEAU_MIRACAST_DEVICE_CONTEXT@@PEAU_FDO_CONTEXT@@PEAKPEAUD3DKMT_MIRACAST_CHUNK_DATA@@2@Z @ 0x1C002B038
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  {
    v12 = (MIRACAST_CHUNK_LIST *)*((_QWORD *)a1 + 62);
    v13 = *(_QWORD *)v12;
