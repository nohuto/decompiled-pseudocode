/*
 * XREFs of DpiMiracastChunkInfoCallbackDpc @ 0x1C002B1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( v5 )
  {
    ...
    v17[1] = v17;
    v17[0] = v17;
    v15 = (_QWORD *)*((_QWORD *)DeferredContext + 64);
    v16 = v17;
    v18 = 0;
    DpSynchronizeExecution(v5, (KSYNCHRONIZE_ROUTINE *)DpiMiracastMoveChunkList, &v15, *(_DWORD *)(v6 + 3700), &v21);
    v8 = (_QWORD *)v17[0];
    v9 = v17[0] == (_QWORD)v17;
    v10 = _InterlockedExchange((volatile __int32 *)DeferredContext + 148, 0);
    if ( v9 )
      v8 = 0LL;
    if ( v10 )
    {
    ...
    v12 = *((_QWORD *)DeferredContext + 55);
    v15 = v17;
    v16 = (_QWORD *)*((_QWORD *)DeferredContext + 65);
    DpSynchronizeExecution(v12, (KSYNCHRONIZE_ROUTINE *)DpiMiracastMoveChunkList, &v15, *(_DWORD *)(v6 + 3700), &v21);
    if ( v11 )
    {
      DpiMiracastPerfResetPerfTrack(DeferredContext);
      *((_QWORD *)DeferredContext + 131) = *((_QWORD *)DeferredContext + 130) + 40LL;
    }
    while ( 1 )
    {
