/*
 * XREFs of DxgkOpenSyncObjectFromNtHandle @ 0x1C016BF80
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)(((unsigned __int64)v35 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = *v5;
  ...
  if ( v7 == -1073741788 )
  {
    ...
    *(_QWORD *)(v13 + 32) = -1073741788LL;
    ...
    if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(qword_1C0056840, &EventProfilerExit, v14, 2086);
    return 3221225508LL;
  }
  if ( v7 < 0 )
  {
      ...
      *v24 = v25;
      ...
      if ( v27 < *((_DWORD *)Current + 56) )
      {
        ...
        if ( (((unsigned int)v25 >> 26) & 0x30) == (v29 & 0x30) && (v29 & 0xF) != 0 )
        {
          ...
          *(_DWORD *)(*((_QWORD *)Current + 26) + 8 * v31 + 8) &= ~0x1000u;
        }
      }
