/*
 * XREFs of IopDevObjApplyPostCreationSettings @ 0x1C00EDF6C
 * Callers:
 *     IoDevObjCreateDeviceSecure @ 0x1C00ED730 (IoDevObjCreateDeviceSecure.c)
 * Callees:
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00EE028 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 */
