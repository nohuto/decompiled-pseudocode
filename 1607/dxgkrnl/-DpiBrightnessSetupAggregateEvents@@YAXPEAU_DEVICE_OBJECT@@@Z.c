/*
 * XREFs of ?DpiBrightnessSetupAggregateEvents@@YAXPEAU_DEVICE_OBJECT@@@Z @ 0x1C0199614
 * Callers:
...
void __fastcall DpiBrightnessSetupAggregateEvents(struct _DEVICE_OBJECT *a1)
{
  ...
  memset(DeviceExtension + 510, 0, 0x30uLL);
  v3 = 2LL;
  DeviceExtension[512] = &WNF_SEB_SYSTEM_AC;
  DeviceExtension[515] = &WNF_SEB_FULL_SCREEN_VIDEO_PLAYBACK;
  v4 = DeviceExtension + 511;
  do
  {
