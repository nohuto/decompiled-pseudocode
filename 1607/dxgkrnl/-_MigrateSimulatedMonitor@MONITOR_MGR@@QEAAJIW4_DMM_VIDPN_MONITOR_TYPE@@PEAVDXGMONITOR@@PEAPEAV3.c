/*
 * XREFs of ?_MigrateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@PEAVDXGMONITOR@@PEAPEAV3@@Z @ 0x1C01AF880
 * Callers:
        ...
        struct DXGMONITOR **a5)
{
  ...
  __int64 v18; // r9
  __int64 v19; // rax
  struct DXGMONITOR *v21; // [rsp+20h] [rbp-28h] BYREF
  ...
  v21 = 0LL;
  MonitorInstance = MONITOR_MGR::_GetMonitorInstance(a1, v7, 0, (ULONG **)&v21);
  ...
  else
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v16 + 32) = v5;
      ...
      if ( *((_DWORD *)v12 + 94) == 2 )
        MONITOR_MGR::_DeleteTargetFromPersistencyRegistry((MONITOR_MGR *)a1, (unsigned int)v7, v17, v18);
      *((_DWORD *)v12 + 94) = v5;
      if ( (_DWORD)v5 == 2 )
        MONITOR_MGR::_AddTargetIntoPersistencyRegistry((MONITOR_MGR *)a1, (unsigned int)v7, v17, v18);
    }
    if ( a4 )
