/*
 * XREFs of BmlCompareSourceModesWithMonitors @ 0x1C00BFD08
 * Callers:
 *     BmlCompareSourceModes @ 0x1C00C01D4 (BmlCompareSourceModes.c)
 * Callees:
 *     ??$DIFF@H@@YAHHH@Z @ 0x1C000B490 (--$DIFF@H@@YAHHH@Z.c)
 ...
 *     ??$BmlCompareValues@H@@YA?AW4BML_COMPARISON_RESULT@@HH@Z @ 0x1C00C22A0 (--$BmlCompareValues@H@@YA-AW4BML_COMPARISON_RESULT@@HH@Z.c)
 */
