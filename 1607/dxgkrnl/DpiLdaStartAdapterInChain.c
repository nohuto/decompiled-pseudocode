/*
 * XREFs of DpiLdaStartAdapterInChain @ 0x1C019DF8C
 * Callers:
...
__int64 __fastcall DpiLdaStartAdapterInChain(__int64 a1, char a2, __int64 a3, __int64 a4, unsigned int a5, __int64 a6)
{
  char v9; // bl
  __int64 v10; // rdx
  __int64 v11; // rcx
