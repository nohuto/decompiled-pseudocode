/*
 * XREFs of ?VidMmQueryProcessStatistics@VIDMM_EXPORT@@QEAAJPEAVVIDMM_GLOBAL@@PEAVDXGPROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_INFORMATION@@@Z @ 0x1C0020E2C
 * Callers:
        ...
        struct _D3DKMT_QUERYSTATISTICS_PROCESS_INFORMATION *a4)
{
  ...
  v11 = (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, __int64, struct _D3DKMT_QUERYSTATISTICS_PROCESS_INFORMATION *))(*((_QWORD *)this + 1) + 296LL))(
          a2,
          v10,
          a4);
