/*
 * XREFs of BmlPinPathContentScaling @ 0x1C00BD4B8
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(_QWORD *a1, __int64 a2, unsigned __int16 a3)
{
  ...
  if ( !DMMVIDPNPRESENTPATH::DoSourceTargetResolutionsMatch(Path) )
  {
    ...
    {
      if ( (dword_1C005824C & 1) == 0 )
      {
        v25 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C005824C |= 1u;
        dword_1C0058210[0] = VIDPN_MGR::GetAdapterDefaultScaling(v25);
        dword_1C0058214 = 3;
        dword_1C0058218 = 4;
        dword_1C005821C = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v26 >= 4 )
          break;
        v9 = dword_1C0058210;
        v10 = (unsigned int)dword_1C0058210[v26];
