/*
 * XREFs of ?ClipRects@DXGPRESENT@@SAHPEAUtagRECT@@0PEBU2@1@Z @ 0x1C00DC680
 * Callers:
 ...
 * Callees:
 *     ?ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z @ 0x1C0170B08 (-ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z.c)
        ...
        const struct tagRECT *a4)
{
  ...
  unsigned int v38; // [rsp+48h] [rbp-28h]
  LONG v39; // [rsp+4Ch] [rbp-24h]
  LONG v40; // [rsp+50h] [rbp-20h]
        ...
        if ( v18 > 0 && v14 < v15 && v16 < v18 )
        {
          ...
          if ( v20 && ((v15 - v14) << 16) / (int)v23 )
          {
            if ( DXGPRESENT::IntersectRect(&v37, a3, a1) )
            {
              v25 = v35;
              v26 = v38;
              v45 = (v39 << 16) + v38 * (v37.left - v44);
              v27 = (v14 << 16) + v35 * (v37.top - v41);
              v34 = (v33 << 16) + v38 * (v37.right - v40);
              v43.left = (v45 + 0xFFFF) >> 16;
              v43.right = v34 >> 16;
              v43.top = (v27 + 0xFFFF) >> 16;
              v28 = v35 * (v37.bottom - v42);
              v36 = v27;
              v29 = (v15 << 16) + v28;
              v43.bottom = v29 >> 16;
