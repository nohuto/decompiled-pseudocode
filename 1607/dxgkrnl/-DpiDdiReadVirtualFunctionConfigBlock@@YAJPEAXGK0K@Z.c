/*
 * XREFs of ?DpiDdiReadVirtualFunctionConfigBlock@@YAJPEAXGK0K@Z @ 0x1C002F010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDdiReadVirtualFunctionConfigBlock(
        _QWORD *a1,
        unsigned __int16 a2,
        int a3,
        void *a4,
        unsigned int a5)
{
  ...
  if ( v12 >= 0 )
  {
    VirtualFunctionConfigBlock = DxgkDdiReadVirtualFunctionConfigBlock(*(_QWORD *)(v11 + 3688), a2, a3, v6, a5);
