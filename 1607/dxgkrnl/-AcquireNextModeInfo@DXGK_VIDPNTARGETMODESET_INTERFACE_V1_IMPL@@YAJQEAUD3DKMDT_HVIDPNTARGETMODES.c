/*
 * XREFs of ?AcquireNextModeInfo@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@QEBU_D3DKMDT_VIDPN_TARGET_MODE@@PEAPEBU3@@Z @ 0x1C007CCE0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_TARGET_MODE **a4)
{
  ...
  _InterlockedIncrement((volatile signed __int32 *)DXGGLOBAL::GetGlobal() + 17);
...
LABEL_21:
  ...
  *(_QWORD *)&a3->Id = 0LL;
  v15 = ExposedViaHandle<DMMVIDPNTARGETMODESET,D3DKMDT_HVIDPNTARGETMODESET__ *>::GetFromHandle(this);
  if ( !v15 )
  {
