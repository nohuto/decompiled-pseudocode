/*
 * XREFs of DxgNotifyInterruptCB @ 0x1C000C0B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgNotifyInterruptCB(__int64 a1, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *a2)
{
  ...
  else if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 3708LL), 0, 0) & 2) != 0 )
  {
    v4 = *(struct DXGADAPTER **)(*(_QWORD *)(a1 + 64) + 3688LL);
    if ( v4 )
    {
      v5 = *((_QWORD *)v4 + 267);
      if ( v5 )
      {
        (*(void (__fastcall **)(__int64, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *))(*(_QWORD *)(*(_QWORD *)(v5 + 376)
                                                                                               + 8LL)
                                                                                   + 8LL))(
          a1,
          a2);
      ...
      {
        v7 = *(DXGDODPRESENT **)(*((_QWORD *)v4 + 266) + 256LL);
        if ( v7 )
