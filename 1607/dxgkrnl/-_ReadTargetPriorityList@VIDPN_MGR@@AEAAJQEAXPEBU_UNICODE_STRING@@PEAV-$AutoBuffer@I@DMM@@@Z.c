/*
 * XREFs of ?_ReadTargetPriorityList@VIDPN_MGR@@AEAAJQEAXPEBU_UNICODE_STRING@@PEAV?$AutoBuffer@I@DMM@@@Z @ 0x1C00F4920
 * Callers:
...
__int64 __fastcall VIDPN_MGR::_ReadTargetPriorityList(__int64 a1, void *a2, struct _UNICODE_STRING *a3, __int64 a4)
{
  ...
  if ( v7 == -2147483643 || v7 == -1073741789 )
  {
    ...
    v26 = 0LL;
    v22 = &DMM::AutoBuffer<_KEY_VALUE_PARTIAL_INFORMATION>::`vftable'{for `SetElement'};
    v24 = &DMM::AutoBuffer<_KEY_VALUE_PARTIAL_INFORMATION>::`vftable'{for `NonReferenceCounted'};
    v23 = 0LL;
    v27 = 3;
...
LABEL_12:
        DMM::AutoBuffer<_KEY_VALUE_PARTIAL_INFORMATION>::~AutoBuffer<_KEY_VALUE_PARTIAL_INFORMATION>(&v22);
