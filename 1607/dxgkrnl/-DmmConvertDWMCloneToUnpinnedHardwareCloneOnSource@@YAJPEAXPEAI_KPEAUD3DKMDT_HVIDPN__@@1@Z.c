/*
 * XREFs of ?DmmConvertDWMCloneToUnpinnedHardwareCloneOnSource@@YAJPEAXPEAI_KPEAUD3DKMDT_HVIDPN__@@1@Z @ 0x1C01A029C
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  v12 = *(VIDPN_MGR **)(*((_QWORD *)a1 + 266) + 88LL);
...
LABEL_37:
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      v24 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v18, v19, 0LL, &v44);
      v26 = v44;
      if ( v24 < 0 || v44 == -1 )
      {
