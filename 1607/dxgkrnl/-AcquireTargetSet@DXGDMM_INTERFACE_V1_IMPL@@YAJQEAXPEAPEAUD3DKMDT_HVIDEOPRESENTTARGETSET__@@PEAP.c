/*
 * XREFs of ?AcquireTargetSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXPEAPEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEAPEBU_DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE@@@Z @ 0x1C01A5CC0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 && a3 )
  {
    ...
    *a3 = 0LL;
    if ( this )
    {
      ...
      {
        v9 = *(_QWORD *)(v14 + 88);
        v17 = *(struct D3DKMDT_HVIDEOPRESENTTARGETSET__ **)(v9 + 416);
