/*
 * XREFs of ??0DXGDODPRESENT@@QEAA@PEAVADAPTER_DISPLAY@@PEAEE@Z @ 0x1C00F7DA8
 * Callers:
        ...
        char a4)
{
  ...
  *((_DWORD *)this + 33) = 0;
  ...
  v9 = 0;
  for ( *((_QWORD *)this + 1) = a3; v9 < *(_DWORD *)this; a3 = (BLTQUEUE *)((char *)a3 + 2632) )
  {
    if ( a3 )
      BLTQUEUE::BLTQUEUE(a3, this, v9, (struct _KEVENT *)(1016LL * v9 + *((_QWORD *)a2 + 14) + 808LL), a4);
    ++v9;
  }
  return this;
}
