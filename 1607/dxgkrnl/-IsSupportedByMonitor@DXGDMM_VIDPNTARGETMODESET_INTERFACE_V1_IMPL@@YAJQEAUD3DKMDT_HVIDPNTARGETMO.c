/*
 * XREFs of ?IsSupportedByMonitor@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@IQEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C00D32D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  *(_DWORD *)a4 = 0;
  ...
  if ( v8 )
  {
    v12 = (DMMVIDPNTARGETMODE *)IndexedSet<DMMVIDPNTARGETMODE>::FindById(v8 + 24, v6);
    if ( v12 )
    {
      v14 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v13 + 112) + 96LL) + 76LL);
      LOBYTE(v10) = v14 >= 15 && v14 <= 16;
