/*
 * XREFs of ?_GetMonitorCCDMonitorID@DXGMONITOR@@QEAAJEKPEAG@Z @ 0x1C007B3FC
 * Callers:
...
__int64 __fastcall DXGMONITOR::_GetMonitorCCDMonitorID(DXGMONITOR *this, char a2, int a3, unsigned __int16 *a4)
{
  __int64 v8; // rax
...
LABEL_21:
  ...
  v11 = (const UNICODE_STRING *)((char *)this + 456);
  if ( !a2 )
    v11 = (const UNICODE_STRING *)((char *)this + 472);
  ...
  v31 = RtlAppendUnicodeStringToString(&Destination, (PCUNICODE_STRING)((char *)this + 488));
  v36 = v31;
  if ( v31 >= 0 )
    return 0LL;
