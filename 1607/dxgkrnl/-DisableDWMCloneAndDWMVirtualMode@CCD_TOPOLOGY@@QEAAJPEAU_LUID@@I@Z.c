/*
 * XREFs of ?DisableDWMCloneAndDWMVirtualMode@CCD_TOPOLOGY@@QEAAJPEAU_LUID@@I@Z @ 0x1C00DE7C8
 * Callers:
  ...
  for ( k = 0; ; ++k )
  {
    ...
    if ( *((_DWORD *)v18 + 50) == v11 )
    {
      ...
      *((_BYTE *)v18 + 121) = 0;
      ...
      {
        if ( (v20 & 0x200) != 0 && ((*((_DWORD *)v19 + 31) - 2) & 0xFFFFFFFD) == 0 )
        {
          *((_DWORD *)v19 + 22) = *((_DWORD *)v19 + 37);
          v21 = *((_DWORD *)v19 + 36);
        }
        else
        {
          *((_DWORD *)v19 + 22) = *((_DWORD *)v19 + 36);
          v21 = *((_DWORD *)v19 + 37);
        }
        *((_DWORD *)v19 + 1) |= 0x100u;
        *((_DWORD *)v19 + 23) = v21;
