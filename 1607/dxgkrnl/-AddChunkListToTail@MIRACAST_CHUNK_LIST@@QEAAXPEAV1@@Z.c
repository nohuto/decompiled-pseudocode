/*
 * XREFs of ?AddChunkListToTail@MIRACAST_CHUNK_LIST@@QEAAXPEAV1@@Z @ 0x1C002AC4C
 * Callers:
 *     ?MiracastProcessPendingDPCChunks@@YAEPEAX@Z @ 0x1C002AF60 (-MiracastProcessPendingDPCChunks@@YAEPEAX@Z.c)
 *     DpiMiracastMoveChunkList @ 0x1C002BF10 (DpiMiracastMoveChunkList.c)
 * Callees:
 *     <none>
 */
...
void __fastcall MIRACAST_CHUNK_LIST::AddChunkListToTail(MIRACAST_CHUNK_LIST *this, struct MIRACAST_CHUNK_LIST *a2)
{
  ...
  {
    v3 = (struct MIRACAST_CHUNK_LIST **)*((_QWORD *)a2 + 1);
    if ( v2[1] != a2 || *v3 != a2 )
      __fastfail(3u);
