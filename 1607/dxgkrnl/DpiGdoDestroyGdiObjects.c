/*
 * XREFs of DpiGdoDestroyGdiObjects @ 0x1C019E4F0
 * Callers:
...
__int64 __fastcall DpiGdoDestroyGdiObjects(__int64 a1)
{
  ...
  KeWaitForSingleObject((PVOID)(v1 + 3376), Executive, 0, 0, 0LL);
  v3 = *(struct _IO_REMOVE_LOCK **)(v1 + 3360);
  if ( *(struct _IO_REMOVE_LOCK **)&v3->Common.Removed != v3 )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)((char *)&SymbolicLinkName.Buffer + 2) = 0;
      ...
      v7 = IoAcquireRemoveLockEx(v6, v5, &byte_1C00FF410, 1u, 0x20u);
      v2 = v7;
      if ( v7 < 0 )
        break;
      ...
      *(_QWORD *)(v11 + 8) = v12;
      ...
      LODWORD(v2) = 0;
      if ( *(_QWORD *)&v3->Common.Removed == *(_QWORD *)(v1 + 3360) )
        goto LABEL_13;
    }
...
LABEL_13:
  KeReleaseMutex((PRKMUTEX)(v1 + 3376), 0);
