/*
 * XREFs of ?_FillPathDescriptor@CDS_JOURNAL@CCD_BTL@@CAXPEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@AEBU_ENTRY@12@_N2PEAVDXGADAPTER@@@Z @ 0x1C00D58F0
 * Callers:
 ...
 * Callees:
 *     ?_IsCDSJWidthAndHeightSwapped@CDS_JOURNAL@CCD_BTL@@CA_NPEBU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C000CCFC (-_IsCDSJWidthAndHeightSwapped@CDS_JOURNAL@CCD_BTL@@CA_NPEBU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z.c)
...
LABEL_4:
  ...
  {
    if ( a5 )
      DmmGetDefaultScaling(a5, (char *)a1 + 132);
    else
      DxgkGetAdapterDefaultScaling((char *)a2 + 20);
  }
  if ( a5 )
    EnforceDriverModelScalingPolicy(a5, (char *)a1 + 132);
  else
