/*
 * XREFs of ??1DXGADAPTERSYNCOBJECT@@QEAA@XZ @ 0x1C007F690
 * Callers:
...
void __fastcall DXGADAPTERSYNCOBJECT::~DXGADAPTERSYNCOBJECT(DXGADAPTERSYNCOBJECT *this)
{
  ...
  if ( *((_BYTE *)this + 24) )
  {
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v2 + 16, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v11 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
            Template_q(v6, &EventBlockThread, v5, v11);
        }
    ...
    v8 = (DXGADAPTERSYNCOBJECT **)*((_QWORD *)v1 + 1);
    if ( *(DXGADAPTERSYNCOBJECT **)(*(_QWORD *)v1 + 8LL) != v1 || *v8 != v1 )
      __fastfail(3u);
    *v8 = v7;
    *((_QWORD *)v7 + 1) = v8;
    if ( *(struct _KTHREAD **)(v2 + 8) != KeGetCurrentThread() )
    {
      v14 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v7, v3, v5);
      v14[3] = 275LL;
      v14[4] = 4LL;
      v14[5] = v2;
      v14[6] = 0LL;
