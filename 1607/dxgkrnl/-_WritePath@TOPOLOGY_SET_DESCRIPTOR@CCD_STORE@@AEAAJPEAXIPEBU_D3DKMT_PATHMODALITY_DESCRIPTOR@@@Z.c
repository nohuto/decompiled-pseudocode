/*
 * XREFs of ?_WritePath@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@AEAAJPEAXIPEBU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00B4A58
 * Callers:
        ...
        const struct _D3DKMT_PATHMODALITY_DESCRIPTOR *a4)
{
  ...
  else
  {
    ...
    if ( v10 < 0
      ...
      && (v16 = CcdWriteRegistryValues((int)a2, &pszDest, (__int64)a4), v9 = v16, v16 < 0) )
    {
