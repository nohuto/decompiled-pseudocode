/*
 * XREFs of ?ReleaseDescriptorInfo@DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORDESCRIPTORSET__@@QEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x1C00EF010
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(v6 + 32) = a2;
  if ( a2 )
  {
    ...
    else
    {
      ...
      v11 = DXGMONITOR::_ReleaseMonitorDescriptorEnumerator(v10, a2);
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v14, &EventProfilerExit, v15, 7030);
  return v13;
}
