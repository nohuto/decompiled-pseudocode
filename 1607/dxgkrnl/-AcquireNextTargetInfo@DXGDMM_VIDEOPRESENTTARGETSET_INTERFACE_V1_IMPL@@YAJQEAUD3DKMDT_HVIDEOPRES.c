/*
 * XREFs of ?AcquireNextTargetInfo@DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEBU_D3DKMDT_VIDEO_PRESENT_TARGET@@PEAPEBU3@@Z @ 0x1C01A5960
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
  ...
  *(_QWORD *)&a3->Id = 0LL;
  ...
  if ( !DoublyLinkedList<DMMVIDEOPRESENTTARGET>::ContainsByReference(v13 + 8, v16) )
  {
