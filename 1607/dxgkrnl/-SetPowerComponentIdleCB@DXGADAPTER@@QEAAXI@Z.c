/*
 * XREFs of ?SetPowerComponentIdleCB@DXGADAPTER@@QEAAXI@Z @ 0x1C001E640
 * Callers:
 *     DxgSetPowerComponentIdleCB @ 0x1C0022210 (DxgSetPowerComponentIdleCB.c)
 * Callees:
...
void __fastcall DXGADAPTER::SetPowerComponentIdleCB(DXGADAPTER *this, int a2)
{
  ...
  if ( *((_BYTE *)this + 2609) )
  {
    _InterlockedDecrement((volatile signed __int32 *)(520LL * v3 + *((_QWORD *)this + 271) + 348));
