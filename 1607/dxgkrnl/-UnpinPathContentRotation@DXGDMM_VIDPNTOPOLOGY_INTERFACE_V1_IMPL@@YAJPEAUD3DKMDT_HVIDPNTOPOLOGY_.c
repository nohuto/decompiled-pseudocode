/*
 * XREFs of ?UnpinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C00C55A0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( Path )
    {
      ...
      v16 = VIDPN_MGR::FormalizeVidPnChange(*(_QWORD *)(Container + 48), v15, 10, a4, v24);
      v6 = v16;
      if ( v16 < 0 )
      {
