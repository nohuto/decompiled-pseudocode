/*
 * XREFs of ??1VIDPN_MGR@@UEAA@XZ @ 0x1C0032A18
 * Callers:
...
LABEL_24:
  ...
  Queue<VIDPN_MGR::COMMITVIDPNREQUEST>::~Queue<VIDPN_MGR::COMMITVIDPNREQUEST>((_QWORD *)this + 20);
  Set<DMMVIDPN>::~Set<DMMVIDPN>((_QWORD *)this + 13);
