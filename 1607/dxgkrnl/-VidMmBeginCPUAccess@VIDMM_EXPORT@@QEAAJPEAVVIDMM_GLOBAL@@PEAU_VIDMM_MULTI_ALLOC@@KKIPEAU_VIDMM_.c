/*
 * XREFs of ?VidMmBeginCPUAccess@VIDMM_EXPORT@@QEAAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAPEAX@Z @ 0x1C0007044
 * Callers:
        ...
        void **a8)
{
  ...
  LODWORD(this) = (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, struct _VIDMM_MULTI_ALLOC *, _QWORD, _QWORD, unsigned int, _QWORD, char *, void **))(*((_QWORD *)this + 1) + 256LL))(
                    a2,
                    a3,
                    a4,
                    a5,
