/*
 * XREFs of ?_FillTargetInfoMonitorsCallback@CCD_TOPOLOGY@@CAJPEAX0IW4_DMM_VIDPN_MONITOR_TYPE@@EE@Z @ 0x1C0089C50
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( *((_DWORD *)PathDescriptor + 5) == a3
      && *((_DWORD *)PathDescriptor + 2) == *(_DWORD *)(a1 + 268)
      && *((_DWORD *)PathDescriptor + 3) == *(_DWORD *)(a1 + 272) )
    {
      if ( a5 )
