/*
 * XREFs of Template_pqpqtt @ 0x1C0026070
 * Callers:
...
NTSTATUS Template_pqpqtt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 4LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventFlip, 0LL, 6u, &UserData);
}
