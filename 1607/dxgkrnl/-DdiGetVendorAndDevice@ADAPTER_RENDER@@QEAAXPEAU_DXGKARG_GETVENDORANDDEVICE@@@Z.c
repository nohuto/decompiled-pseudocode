/*
 * XREFs of ?DdiGetVendorAndDevice@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_GETVENDORANDDEVICE@@@Z @ 0x1C015873C
 * Callers:
...
void __fastcall ADAPTER_RENDER::DdiGetVendorAndDevice(ADAPTER_RENDER *this, struct _DXGKARG_GETVENDORANDDEVICE *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // r8
