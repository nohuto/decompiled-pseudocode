/*
 * XREFs of ?DxgkpGetBilinearLineFromSource@@YAXPEAEJJPEAU_PIXEL@@PEAU_UFIXPOINT_PIXEL@@JJJ@Z @ 0x1C00E3080
 * Callers:
        ...
        int a8)
{
  ...
  int v41; // r12d
  int v42; // edi
  struct _UFIXPOINT_PIXEL *v43; // r8
  int v44; // edi
  int v45; // edx
  ...
  else if ( a6 <= a3 )
  {
    ...
    else
    {
      v37 = (v35 << 16) / a3;
      v31 = a6 << 16;
      v32 = (unsigned __int16)v37 * v13[-v12 + 3];
      v38 = (unsigned __int16)v37 * v13[-v12 + 2];
      v39 = (unsigned __int16)v37 * v13[-v12 + 1];
      v33 = (unsigned __int16)v37 * v13[-v12];
    }
    if ( a7 >= a8 )
    {
      v43 = a5;
    ...
    else
    {
      ...
      do
      {
        ...
        if ( v36 >= a3 )
        {
          v41 -= v40;
          v36 -= a3;
          v44 = (unsigned __int16)(v41 / a3);
          if ( a4 )
          {
            *((_BYTE *)a4 + 3) = (v32 + (v34 - v44) * (unsigned int)v13[3] + 0x8000) >> 16;
            *((_BYTE *)a4 + 2) = (v38 + (v34 - v44) * (unsigned int)v13[2] + 0x8000) >> 16;
            *((_BYTE *)a4 + 1) = (v39 + (v34 - v44) * (unsigned int)v13[1] + 0x8000) >> 16;
            *(_BYTE *)a4 = ((v34 - v44) * (unsigned int)*v13 + v33 + 0x8000) >> 16;
            a4 = (struct _PIXEL *)((char *)a4 + 4);
          }
          else
          {
            *((_DWORD *)v43 + 3) = v32 + (v34 - v44) * v13[3];
            *((_DWORD *)v43 + 2) = v38 + (v34 - v44) * v13[2];
            *((_DWORD *)v43 + 1) = v39 + (v34 - v44) * v13[1];
            *(_DWORD *)v43 = v33 + (v34 - v44) * *v13;
            v43 = (struct _UFIXPOINT_PIXEL *)((char *)v43 + 16);
          }
          v31 = a6 << 16;
          v40 = a3 << 16;
          v32 = v44 * v13[3];
    ...
    if ( v36 )
    {
      v45 = (unsigned __int16)(((a3 - v36) << 16) / a3);
      if ( a4 )
      {
        *((_BYTE *)a4 + 3) = (v32 + v45 * (unsigned int)v13[3] + 0x8000) >> 16;
        *((_BYTE *)a4 + 2) = (v38 + v45 * (unsigned int)v13[2] + 0x8000) >> 16;
        *((_BYTE *)a4 + 1) = (v39 + v45 * (unsigned int)v13[1] + 0x8000) >> 16;
        *(_BYTE *)a4 = (v45 * (unsigned int)*v13 + v33 + 0x8000) >> 16;
      }
      else
      {
        *((_DWORD *)v43 + 3) = v32 + v45 * v13[3];
        *((_DWORD *)v43 + 2) = v38 + v45 * v13[2];
        *((_DWORD *)v43 + 1) = v39 + v45 * v13[1];
        *(_DWORD *)v43 = v33 + v45 * *v13;
      }
    }
  }
  else
