/*
 * XREFs of ?CleanupPresentHistoryTokenQueue@ADAPTER_RENDER@@QEAAXXZ @ 0x1C00932FC
 * Callers:
...
void __fastcall ADAPTER_RENDER::CleanupPresentHistoryTokenQueue(struct _KTHREAD **this)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v5, this + 74);
  ...
  if ( CurrentProcessSessionId < *((_DWORD *)this + 154) )
  {
    ...
    v4 = (DXGPRESENTHISTORYTOKENQUEUE *)*((_QWORD *)this[78] + CurrentProcessSessionId);
    if ( v4 )
    {
      DXGPRESENTHISTORYTOKENQUEUE::`scalar deleting destructor'(v4);
      *((_QWORD *)this[78] + v3) = 0LL;
    }
  }
