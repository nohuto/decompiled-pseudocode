/*
 * XREFs of ?DisplayConfigGetTargetBaseType@@YAJPEAUDISPLAYCONFIG_TARGET_BASE_TYPE@@@Z @ 0x1C00C49F8
 * Callers:
...
__int64 __fastcall DisplayConfigGetTargetBaseType(struct _LUID *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  _QWORD *v29; // rax
  __int64 v30; // rax
  _BYTE v31[104]; // [rsp+20h] [rbp-68h] BYREF
  ...
  if ( a1 && a1->LowPart == 6 && a1->HighPart == 24 )
  {
    ...
    v6 = DXGGLOBAL::ReferenceAdapterByLuid(Global, a1[1], &v33);
    v11 = v6;
    if ( v6 )
    {
