/*
 * XREFs of ?DxgkSetBootAnimationRelayState@@YAEW4_CDD_BOOT_ANIMATION_RELAY_STATE@@@Z @ 0x1C00DAF20
 * Callers:
...
char __fastcall DxgkSetBootAnimationRelayState(__int64 a1)
{
  ...
  v4 = 1;
  v6 = *((_DWORD *)DXGGLOBAL::GetGlobal(v3) + 251);
  if ( v6 )
  {
    v7 = v6 - 1;
    if ( v7 )
...
LABEL_5:
  ...
  *((_DWORD *)DXGGLOBAL::GetGlobal(v5) + 251) = v1;
LABEL_6:
  if ( v11[8] )
