/*
 * XREFs of ?InitializeInterface@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAXPEAU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@@Z @ 0x1C00F584C
 * Callers:
        ...
        struct _DXGDMM_VIDPNTOPOLOGY_INTERFACE *a2)
{
  ...
  *((_QWORD *)this + 13) = DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL::RestoreFromLkgForSource;
  *((_QWORD *)this + 14) = DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL::RemoveCopyProtection;
  *((_QWORD *)this + 15) = DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL::GetPathImportance;
  *((_QWORD *)this + 16) = DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL::GetNumPaths;
  *((_QWORD *)this + 17) = DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL::EnumPaths;
}
