/*
 * XREFs of ?DdiGetDeviceLocation@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_GETDEVICELOCATION@@@Z @ 0x1C01581B4
 * Callers:
...
void __fastcall ADAPTER_RENDER::DdiGetDeviceLocation(ADAPTER_RENDER *this, struct _DXGKARG_GETDEVICELOCATION *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // r8
