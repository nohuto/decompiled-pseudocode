/*
 * XREFs of ?AcquireDiagSummary@VIDPN_MGR@@QEAAJPEAV?$AutoBuffer@E@DMM@@@Z @ 0x1C019F7F8
 * Callers:
...
__int64 __fastcall VIDPN_MGR::AcquireDiagSummary(_QWORD *a1, __int64 a2)
{
  ...
  void *v116; // [rsp+198h] [rbp+90h]
  size_t v117; // [rsp+1A0h] [rbp+98h]
  ...
  v7 = a1[11];
  v119 = &DMM::AutoBuffer<_DMM_VIDEOPRESENTSOURCESET_SERIALIZATION>::`vftable'{for `SetElement'};
  Src = 0LL;
  v121 = &DMM::AutoBuffer<_DMM_VIDEOPRESENTSOURCESET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  Size = 0LL;
  v120 = 0LL;
  v124 = 3;
  v8 = DMMVIDEOPRESENTSOURCESET::Serialize(v7, &v119);
  v10 = v8;
  if ( v8 < 0 )
  {
  ...
  v113 = &DMM::AutoBuffer<_DMM_VIDEOPRESENTTARGETSET_SERIALIZATION>::`vftable'{for `SetElement'};
  v116 = 0LL;
  v115 = &DMM::AutoBuffer<_DMM_VIDEOPRESENTTARGETSET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v114 = 0LL;
  v117 = 0LL;
  v118 = 3;
  ...
  v22 = a1[9];
  v107 = &DMM::AutoBuffer<_DMM_VIDPN_SERIALIZATION>::`vftable'{for `SetElement'};
  v110 = 0LL;
  v109 = &DMM::AutoBuffer<_DMM_VIDPN_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v108 = 0LL;
  v111 = 0LL;
  v112 = 3;
  v23 = DMMVIDPN::Serialize(v22, &v107);
  v10 = v23;
  if ( v23 < 0 )
  {
  ...
  v104 = 0LL;
  v101 = &DMM::AutoBuffer<_DMM_COMMITVIDPNREQUESTSET_SERIALIZATION>::`vftable'{for `SetElement'};
  v105 = 0LL;
  v103 = &DMM::AutoBuffer<_DMM_COMMITVIDPNREQUESTSET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v106 = 3;
  v102 = 0LL;
  v29 = VIDPN_MGR::COMMITVIDPNREQUEST::SerializeCommitVidPnRequests(a1 + 20, &v101);
  v10 = v29;
  if ( v29 < 0 )
  {
  ...
  v34 = a1[12];
  v95 = &DMM::AutoBuffer<_DMM_MONITORSET_SERIALIZATION>::`vftable'{for `SetElement'};
  v98 = 0LL;
  v97 = &DMM::AutoBuffer<_DMM_MONITORSET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v96 = 0LL;
  v99 = 0LL;
  v100 = 3;
  v35 = DMMVIDEOPRESENTTARGETSET::SerializeConnectedMonitors(v34, &v95);
  v10 = v35;
  if ( v35 < 0 )
  {
  ...
  v92 = 0LL;
  v89 = &DMM::AutoBuffer<_DMM_DISPMODECHANGEREQUESTSET_SERIALIZATION>::`vftable'{for `SetElement'};
  v93 = 0LL;
  v91 = &DMM::AutoBuffer<_DMM_DISPMODECHANGEREQUESTSET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v94 = 3;
  v90 = 0LL;
  v41 = VIDPN_MGR::DISPMODECHANGEREQUEST::SerializeModeChangeRequests(a1 + 36, &v89);
  v10 = v41;
  if ( v41 < 0 )
  {
  ...
  v86 = 0LL;
  v85[0] = &DMM::AutoBuffer<_DMM_VIDPNSET_SERIALIZATION>::`vftable'{for `SetElement'};
  v87 = 0LL;
  v85[3] = &DMM::AutoBuffer<_DMM_VIDPNSET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v88 = 3;
  *(_OWORD *)&v85[1] = 0LL;
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)&v131, (__int64)a1);
  v46 = DMMVIDPN::SerializeVidPns(a1 + 28, v85);
  v10 = v46;
  if ( v46 < 0 )
  {
  ...
  v127 = &DMM::AutoBuffer<_DMM_MONITORPRESENCEEVENTSET_SERIALIZATION>::`vftable'{for `NonReferenceCounted'};
  v126 = 0LL;
  v128 = 0LL;
  v129 = 0LL;
  v130 = 3;
...
LABEL_46:
  ...
  LODWORD(v84) = 3;
  v66 = v129;
  v81[0] = &DMM::AutoBuffer<unsigned char>::`vftable'{for `SetElement'};
  v67 = v117 + v111 + v105 + v99 + v93 + v129 + v87 + Size + 40;
  v81[3] = &DMM::AutoBuffer<unsigned char>::`vftable'{for `NonReferenceCounted'};
  v82 = 0LL;
  v83 = 0LL;
  *(_OWORD *)&v81[1] = 0LL;
...
LABEL_55:
  DMM::AutoBuffer<unsigned char>::~AutoBuffer<unsigned char>(v81);
LABEL_56:
  DMM::AutoBuffer<_DMM_MONITORPRESENCEEVENTSET_SERIALIZATION>::~AutoBuffer<_DMM_MONITORPRESENCEEVENTSET_SERIALIZATION>(&v125);
LABEL_57:
  DMM::AutoBuffer<_DMM_VIDPNSET_SERIALIZATION>::~AutoBuffer<_DMM_VIDPNSET_SERIALIZATION>(v85);
LABEL_58:
  DMM::AutoBuffer<_DMM_DISPMODECHANGEREQUESTSET_SERIALIZATION>::~AutoBuffer<_DMM_DISPMODECHANGEREQUESTSET_SERIALIZATION>(&v89);
LABEL_59:
  DMM::AutoBuffer<_DMM_MONITORSET_SERIALIZATION>::~AutoBuffer<_DMM_MONITORSET_SERIALIZATION>(&v95);
LABEL_60:
  DMM::AutoBuffer<_DMM_COMMITVIDPNREQUESTSET_SERIALIZATION>::~AutoBuffer<_DMM_COMMITVIDPNREQUESTSET_SERIALIZATION>(&v101);
LABEL_61:
  DMM::AutoBuffer<_DMM_VIDPN_SERIALIZATION>::~AutoBuffer<_DMM_VIDPN_SERIALIZATION>(&v107);
LABEL_62:
  DMM::AutoBuffer<_DMM_VIDEOPRESENTTARGETSET_SERIALIZATION>::~AutoBuffer<_DMM_VIDEOPRESENTTARGETSET_SERIALIZATION>(&v113);
LABEL_63:
