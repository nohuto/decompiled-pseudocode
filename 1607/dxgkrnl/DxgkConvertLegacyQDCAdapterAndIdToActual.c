/*
 * XREFs of DxgkConvertLegacyQDCAdapterAndIdToActual @ 0x1C00BA730
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a3 = *a1;
  *a4 = a2;
  v8 = (struct DXGGLOBAL *)((char *)DXGGLOBAL::GetGlobal((__int64)a1) + 792);
  ...
  v17 = v21;
  result = DxgkIsVirtualizationDisabledForTarget(
             v21.LowPart,
             a2 & ~HashBitMask,
             (unsigned int)&v19,
             (unsigned int)&v20,
