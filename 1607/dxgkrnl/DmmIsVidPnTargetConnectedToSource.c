/*
 * XREFs of DmmIsVidPnTargetConnectedToSource @ 0x1C01A4CC8
 * Callers:
...
LABEL_5:
  ...
  if ( v15 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)v22, v15);
    v17 = *(_QWORD *)(v15 + 80);
    v23 = 0LL;
    if ( v17 )
    {
    ...
    if ( v23 )
    {
      *a4 = (unsigned int)DMMVIDPNTOPOLOGY::GetPathSourceFromTarget((DMMVIDPNTOPOLOGY *)(v23 + 96), a3, v20, v21) == a2;
    ...
    DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v22[0] + 40LL));
    return v4;
  }
  else
  {
