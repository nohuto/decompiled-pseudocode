/*
 * XREFs of TdrAllowToDebugTimeout @ 0x1C0167928
 * Callers:
 ...
 * Callees:
 *     ?TdrValidateDebugMode@@YAXXZ @ 0x1C00235E8 (-TdrValidateDebugMode@@YAXXZ.c)
...
__int64 __fastcall TdrAllowToDebugTimeout(struct _TDR_RECOVERY_CONTEXT *a1)
{
  ...
  if ( (byte_1C0057374 || (unsigned __int8)WdQueryDebugFlag(0LL)) && !g_TdrDebugMode )
  {
