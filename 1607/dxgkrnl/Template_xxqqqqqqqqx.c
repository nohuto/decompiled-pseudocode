/*
 * XREFs of Template_xxqqqqqqqqx @ 0x1C000BBA8
 * Callers:
...
NTSTATUS Template_xxqqqqqqqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v22 = 4LL;
  v24 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &DMM_SnapPerfCounters, 0LL, 0xBu, &UserData);
}
