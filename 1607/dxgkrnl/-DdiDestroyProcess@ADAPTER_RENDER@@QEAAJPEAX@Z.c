/*
 * XREFs of ?DdiDestroyProcess@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C0091F24
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyProcess@@YAJPEAVADAPTER_RENDER@@PEAX@Z @ 0x1C0022010 (-ADAPTER_RENDER_DdiDestroyProcess@@YAJPEAVADAPTER_RENDER@@PEAX@Z.c)
...
LABEL_22:
  v11 = 0;
LABEL_12:
  v13 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 856LL))(
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v16, &EventProfilerExit, v17, 5065);
