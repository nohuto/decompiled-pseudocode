/*
 * XREFs of ?SetGammaRamp@ADAPTER_DISPLAY@@QEAAJIPEAVDXGDEVICE@@@Z @ 0x1C0086AD8
 * Callers:
 ...
 *     ?AdjustFullscreenGammaRampDXGI1@ADAPTER_DISPLAY@@QEAAXPEAU_D3DDDI_GAMMA_RAMP_DXGI_1@@0PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C0146EC8 (-AdjustFullscreenGammaRampDXGI1@ADAPTER_DISPLAY@@QEAAXPEAU_D3DDDI_GAMMA_RAMP_DXGI_1@@0PEAUDXGK_G.c)
 *     ?AdjustFullscreenGammaRampRGB256x3x16@ADAPTER_DISPLAY@@QEAAXPEAU_D3DDDI_GAMMA_RAMP_RGB256x3x16@@0PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C0146F58 (-AdjustFullscreenGammaRampRGB256x3x16@ADAPTER_DISPLAY@@QEAAXPEAU_D3DDDI_GAMMA_RAMP_RGB256x3x16@@.c)
 */
...
__int64 __fastcall ADAPTER_DISPLAY::SetGammaRamp(PERESOURCE **this, unsigned int a2, struct DXGDEVICE *a3)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    *(_QWORD *)(v22 + 24) = 5527LL;
    WdLogEvent5_WdAssertion(v22);
  }
  if ( !*((_DWORD *)this[2] + 376) )
    return 0LL;
  v7 = this[14];
  v8 = v4;
  v9 = 127 * v4;
...
LABEL_9:
  ...
  if ( !a3 )
    goto LABEL_12;
  v11 = *((_DWORD *)a3 + v4 + 634);
  v12 = (struct DXGK_GAMMA_ADJUSTMENT *)*((_QWORD *)a3 + v4 + 333);
  v13 = (struct _D3DDDI_GAMMA_RAMP_RGB256x3x16 *)*((_QWORD *)a3 + v4 + 301);
  v14 = *((unsigned int *)a3 + v8 + 650);
  v29 = v13;
  v27 = v11;
  v28 = v14;
  if ( v12 )
...
LABEL_12:
    ...
    v27 = 2;
    v28 = 1536LL;
    v13 = (struct _D3DDDI_GAMMA_RAMP_RGB256x3x16 *)v15[v9 + 100];
    v29 = v13;
    if ( !v13 )
    {
      v28 = 0LL;
  ...
  if ( DXGADAPTER::IsFullWDDMAdapter((DXGADAPTER *)this[2])
    && (v18 = ADAPTER_RENDER::SuspendScheduler(*(ADAPTER_RENDER **)(v16 + 2136), 0, 0), v18 < 0) )
  {
    if ( v10 )
      operator delete(v13);
  ...
  else
  {
    ...
    if ( v10 )
      operator delete(v29);
    if ( DXGADAPTER::IsFullWDDMAdapter((DXGADAPTER *)this[2]) )
      ADAPTER_RENDER::ResumeScheduler(*(ADAPTER_RENDER **)(v20 + 2136), 0, 0);
    return updated;
  }
}
