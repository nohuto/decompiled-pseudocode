/*
 * XREFs of ?PinPathContentScaling@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C00BDFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a5)
{
  ...
  enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING v18; // r12d
  int v19; // eax
  __int64 v20; // rcx
    ...
    else
    {
      ...
      if ( Path )
      {
        ...
        else
        {
          ...
          v23 = VIDPN_MGR::FormalizeVidPnChange(*(_QWORD *)(Container + 48), v22, 7, a5, v37);
          v5 = v23;
          if ( v23 < 0 )
          {
            if ( v23 == -1071774970 )
            ...
            if ( v18 == D3DKMDT_VPPS_UNPINNED )
              v35 = DMMVIDPNPRESENTPATH::UnpinContentScaling(v17);
            else
              v35 = DMMVIDPNPRESENTPATH::PinContentScaling(v17, v18);
            if ( v35 < 0 )
            {
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v25, &EventProfilerExit, v26, 6026);
