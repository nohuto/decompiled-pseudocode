/*
 * XREFs of ?NotifyHardwareContentProtectionTeardown@DXGADAPTER@@QEAAXI@Z @ 0x1C001DB9C
 * Callers:
 *     DxgkHardwareContentProtectionTeardownCB @ 0x1C0022260 (DxgkHardwareContentProtectionTeardownCB.c)
 * Callees:
