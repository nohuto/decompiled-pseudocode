/*
 * XREFs of DpiFdoHandleQuerySrIovInterface @ 0x1C0199A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiFdoHandleQuerySrIovInterface(_QWORD *Object, __int64 a2, __int64 a3, _QWORD *a4)
{
  __int64 v4; // rdi
  __int64 v7; // rax
  __int64 v9; // rax
  ...
  if ( (_WORD)a3 == 2 )
  {
    if ( (unsigned __int16)a2 >= 0x90u )
    {
      ...
      if ( *(_BYTE *)(v4 + 4520) )
      {
        memmove(a4, &unk_1C00569A0, 0x90uLL);
        a4[1] = Object;
    ...
    {
      v9 = WdLogNewEntry5_WdError(Object);
      v10 = -1073741789;
