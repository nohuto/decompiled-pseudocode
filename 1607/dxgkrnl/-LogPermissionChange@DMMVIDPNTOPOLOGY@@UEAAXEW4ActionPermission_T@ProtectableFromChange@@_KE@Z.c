/*
 * XREFs of ?LogPermissionChange@DMMVIDPNTOPOLOGY@@UEAAXEW4ActionPermission_T@ProtectableFromChange@@_KE@Z @ 0x1C007FD10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_14:
  ...
  v12 = WdLogNewEntry5_WdTrace(v9, a2, a3, a4);
  *(_QWORD *)(v12 + 24) = a1 - 56;
