/*
 * XREFs of ?IsValidCheckSum@EDID_PARSER@MonDescParser@@AEBA_NPEAT_EDID_V1_BLOCK@@@Z @ 0x1C000CFE0
 * Callers:
 *     ?IsValidCheckSum@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C000CFA4 (-IsValidCheckSum@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 * Callees:
 *     <none>
 */
