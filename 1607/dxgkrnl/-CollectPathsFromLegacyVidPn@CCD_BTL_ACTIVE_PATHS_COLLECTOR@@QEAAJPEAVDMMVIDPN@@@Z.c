/*
 * XREFs of ?CollectPathsFromLegacyVidPn@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@QEAAJPEAVDMMVIDPN@@@Z @ 0x1C01ACA68
 * Callers:
        ...
        struct DMMVIDPN *a2)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( *(_WORD *)(v6 + 20) )
    {
      do
      {
        v7 = D3DKMDT_VPPR_GET_CONTENT_ROTATION(*(D3DKMDT_VIDPN_PRESENT_PATH_ROTATION *)(216LL * v5 + v6 + 172));
        v9 = *(_DWORD *)(v8 + v6 + 140);
        v10 = ((v7 - 1) & 0xFFFFFFFD) == 0;
        v11 = *(_DWORD *)(v8 + v6 + 136);
        if ( v10 )
        {
        ...
        {
          *(_DWORD *)(v8 + v6 + 196) = v11;
          *(_DWORD *)(v8 + v6 + 192) = v9;
        }
        *(_DWORD *)(v8 + v6 + 48) |= 0x820000u;
        v10 = (*(_DWORD *)(v8 + v6 + 48) & 0x40000) == 0;
        *(_QWORD *)(v8 + v6 + 208) = 0LL;
        *(_DWORD *)(v8 + v6 + 216) = v11;
        *(_DWORD *)(v8 + v6 + 220) = v9;
        if ( v10 )
        {
          v12 = v5;
