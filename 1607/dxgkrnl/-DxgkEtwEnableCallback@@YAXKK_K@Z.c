/*
 * XREFs of ?DxgkEtwEnableCallback@@YAXKK_K@Z @ 0x1C0010610
 * Callers:
...
void __fastcall DxgkEtwEnableCallback(int a1, char a2, int a3, int a4)
{
  ...
  if ( a1 == 2 && bTracingEnabled )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      Template_qxq(2, a2, a3, a4, qword_1C0056840, a2);
    DxgkReportGlobalState();
    goto LABEL_43;
  }
  v5 = qword_1C0056840;
  if ( qword_1C0056840 == g_OldAnyKeywords )
    goto LABEL_17;
  if ( (g_OldAnyKeywords & 8) == 0 && (qword_1C0056840 & 8) != 0 )
  {
    v9 = 1;
LABEL_28:
...
LABEL_17:
  if ( (v5 & 0x188ED7) == 0 || (bTracingEnabled = 1, (qword_1C0056848 & 0xFFFFFFFFFFE77128uLL) != 0) )
    bTracingEnabled = 0;
  g_OldAnyKeywords = v5;
}
