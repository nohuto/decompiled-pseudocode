/*
 * XREFs of ?DdiRender@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_RENDER@@@Z @ 0x1C014BB9C
 * Callers:
...
LABEL_13:
  ...
  v19 = *(_DWORD *)(v14 + 136);
LABEL_14:
  v21 = (*(int (__fastcall **)(void *, struct _DXGKARG_RENDER *))(*((_QWORD *)this + 2) + 600LL))(a2, a3);
  ...
  if ( (_DWORD)v21 != -1073741816
    ...
    && (_DWORD)v21 != -1073741795
    && (_DWORD)v21 != -1073741674
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v32, &EventProfilerExit, v33, 5030);
