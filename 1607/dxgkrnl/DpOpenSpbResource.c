/*
 * XREFs of DpOpenSpbResource @ 0x1C019CE70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiCreateSpbResourceRecord @ 0x1C019D5D8 (DpiCreateSpbResourceRecord.c)
 */
      ...
      if ( (_BYTE)a3 )
      {
        ...
        if ( (int)v11 >= 0 )
        {
          ...
          *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
          v23 = ZwOpenFile(&FileHandle, DesiredAccess, &ObjectAttributes, &IoStatusBlock, ShareAccess, OpenOptions);
          v11 = v23;
          if ( v23 >= 0 )
          {
            v25 = DpiCreateSpbResourceRecord(v13, FileHandle, &v31);
            v11 = v25;
            if ( v25 >= 0 )
            {
              *a7 = v31;
LABEL_38:
    ...
    v26 = WdLogNewEntry5_WdWarning(a1, v14, a3, a4);
    *(_QWORD *)(v26 + 24) = SHIDWORD(FileHandle);
    WdLogEvent5_WdWarning(v26);
    return 3221225712LL;
  }
  else
  {
    v27 = WdLogNewEntry5_WdWarning(a1, a2, a3, a4);
    *(_QWORD *)(v27 + 24) = v9;
