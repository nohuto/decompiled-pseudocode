/*
 * XREFs of ?DdiResetFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C014C07C
 * Callers:
...
LABEL_13:
  ...
  v14 = *(_DWORD *)(v9 + 136);
LABEL_14:
  v16 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 432LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 240LL));
  ...
  *(_QWORD *)(v23 + 32) = *(_QWORD *)(*((_QWORD *)this + 2) + 240LL);
  ...
  if ( (qword_1C0056840 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v26, &EventProfilerExit, v27, 5020);
