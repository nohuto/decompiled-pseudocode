/*
 * XREFs of DxgkOpmGetRedirectionInfo @ 0x1C0149C58
 * Callers:
...
__int64 __fastcall DxgkOpmGetRedirectionInfo(__int64 a1, unsigned int a2, unsigned __int64 *a3, char *a4)
{
  ...
  result = ADAPTER_DISPLAY::DodGetOpmMftContext(*(ADAPTER_DISPLAY **)(a1 + 2128), (unsigned int)v5, a3);
...
LABEL_7:
    if ( a4 )
    {
      ...
      DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo(*(DXGADAPTER ***)(a1 + 2128), Numerator);
      if ( !DisplayModeInfo )
      {
