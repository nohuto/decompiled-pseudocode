/*
 * XREFs of ?_CreateAndInsertMonitorEventHandler@MONITOR_MGR@@QEAAJP6AJPEAXI0W4MONITOR_EVENT@@_KW4_DMM_VIDPN_MONITOR_TYPE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z0PEAPEAUHDXGMONITOREVENT__@@@Z @ 0x1C00F3480
 * Callers:
  ...
  *a4 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *a4 = v8;
    if ( this == (struct _FAST_MUTEX *)-224LL )
    {
      v15 = WdLogNewEntry5_WdAssertion(Blink);
