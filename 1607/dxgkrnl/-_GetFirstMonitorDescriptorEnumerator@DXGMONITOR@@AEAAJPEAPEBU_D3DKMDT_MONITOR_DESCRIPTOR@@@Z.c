/*
 * XREFs of ?_GetFirstMonitorDescriptorEnumerator@DXGMONITOR@@AEAAJPEAPEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x1C00F1ACC
 * Callers:
        ...
        __int64 a4)
{
  ...
  __int64 v8; // rcx
  const struct _D3DKMDT_MONITOR_DESCRIPTOR *v9; // rdi
  __int64 v10; // rcx
  char *v11; // rbx
  struct _D3DKMDT_MONITOR_DESCRIPTOR *v12; // rax
  char **v13; // rcx
  __int64 v15; // rax
  __int64 v16; // rax
  __int64 v17; // rax
...
LABEL_13:
  ...
  if ( v7 )
  {
    ...
    v11 = (char *)this + 136;
    v12 = (struct _D3DKMDT_MONITOR_DESCRIPTOR *)&v9[1];
    v13 = (char **)*((_QWORD *)v11 + 1);
    if ( *v13 != v11 )
      __fastfail(3u);
    *(_QWORD *)&v12->Id = v11;
    v9[1].DataSize = (SIZE_T)v13;
    *v13 = (char *)v12;
    *((_QWORD *)v11 + 1) = v12;
    *a2 = v9;
    return 0LL;
