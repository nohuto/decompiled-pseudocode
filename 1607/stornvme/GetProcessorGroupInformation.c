/*
 * XREFs of GetProcessorGroupInformation @ 0x1C0005670
 * Callers:
...
char __fastcall GetProcessorGroupInformation(__int64 a1)
{
  ...
  StorPortExtendedFunction(18LL, a1, a1 + 160);
  v3 = 0;
  if ( *(_WORD *)(a1 + 160)
    && (v4 = (_QWORD *)(a1 + 176),
        StorPortExtendedFunction(0LL, a1, 16 * (unsigned int)*(unsigned __int16 *)(a1 + 160)),
        *(_QWORD *)(a1 + 176)) )
  {
    NVMeZeroMemory(*(void **)(a1 + 176), 16 * *v2);
    if ( *v2 )
    {
      do
      {
