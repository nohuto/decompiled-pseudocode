/*
 * XREFs of ??0FxUsbDevice@@QEAA@PEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C008A95C
 * Callers:
 *     FxUsbTargetDeviceCreate @ 0x1C0087144 (FxUsbTargetDeviceCreate.c)
 * Callees:
 *     ??0FxWaitLockInternal@@QEAA@XZ @ 0x1C002C9F8 (--0FxWaitLockInternal@@QEAA@XZ.c)
...
void __fastcall FxUsbDevice::FxUsbDevice(FxUsbDevice *this, _FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  *(_QWORD *)&this->m_DeviceDescriptor.bLength = 0LL;
  *(_QWORD *)&this->m_DeviceDescriptor.idVendor = 0LL;
