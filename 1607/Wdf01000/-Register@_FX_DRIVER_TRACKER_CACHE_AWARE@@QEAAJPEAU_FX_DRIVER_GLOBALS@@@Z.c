/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C00181F4
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x1C0018110 (FxRegisterBugCheckCallback.c)
 * Callees:
 *     WdmlibProcgrpInitialize @ 0x1C00CBB84 (WdmlibProcgrpInitialize.c)
 */
