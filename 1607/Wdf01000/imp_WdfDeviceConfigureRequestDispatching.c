/*
 * XREFs of imp_WdfDeviceConfigureRequestDispatching @ 0x1C00734B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int RequestType)
{
  ...
  if ( RequestType <= 0xF && (v8 = 49177, _bittest(&v8, RequestType)) )
  {
    ...
    {
      v9 = -1073741808;
      WPP_IFR_SF_qid(m_Globals, 2u, 0xDu, 0x31u, WPP_FxDeviceApi_cpp_Traceguids, Queue, (__int64)Device, -1073741808);
      return v9;
    }
    if ( pDevice->m_Legacy )
    {
