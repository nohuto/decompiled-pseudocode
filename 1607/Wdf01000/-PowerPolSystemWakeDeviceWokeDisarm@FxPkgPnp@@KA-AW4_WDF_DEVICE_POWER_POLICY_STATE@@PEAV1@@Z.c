/*
 * XREFs of ?PowerPolSystemWakeDeviceWokeDisarm@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C009A6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerPolSystemWakeDeviceWokeDisarm(FxPkgPnp *This)
{
  ...
  if ( m_DeviceBase->m_ObjectSize )
    ...
    v3 = 0LL;
  FxPowerDeviceWakeFromS0Triggered::Invoke(&This->m_PowerPolicyMachine.m_Owner->m_DeviceWakeFromSxTriggered, v3);
