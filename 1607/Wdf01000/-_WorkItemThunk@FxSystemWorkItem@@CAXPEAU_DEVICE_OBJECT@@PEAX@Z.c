/*
 * XREFs of ?_WorkItemThunk@FxSystemWorkItem@@CAXPEAU_DEVICE_OBJECT@@PEAX@Z @ 0x1C000E300
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxSystemWorkItem::_WorkItemThunk(_DEVICE_OBJECT *DeviceObject, char *Context, unsigned __int8 a3)
{
  ...
  *((_QWORD *)Context + 17) = 0LL;
  ...
  v7(v8);
  if ( Context[24] < 0 && (v14 = (FxVerifierLock *)*((_QWORD *)Context - 3)) != 0LL )
  {
  ...
  if ( Context[24] < 0 && (v15 = (FxVerifierLock *)*((_QWORD *)Context - 3)) != 0LL )
