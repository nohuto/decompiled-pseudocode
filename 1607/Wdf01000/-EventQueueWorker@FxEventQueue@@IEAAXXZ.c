/*
 * XREFs of ?EventQueueWorker@FxEventQueue@@IEAAXXZ @ 0x1C0063EC0
 * Callers:
 *     ?_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z @ 0x1C009BD70 (-_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z.c)
 * Callees:
 *     FX_TRACK_DRIVER @ 0x1C00171CC (FX_TRACK_DRIVER.c)
