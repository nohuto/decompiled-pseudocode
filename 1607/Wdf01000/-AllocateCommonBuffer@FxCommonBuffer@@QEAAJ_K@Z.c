/*
 * XREFs of ?AllocateCommonBuffer@FxCommonBuffer@@QEAAJ_K@Z @ 0x1C002FA34
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( m_RawLength > 0xFFFFFFFF )
  {
    if ( m_DmaEnabler->m_ObjectSize )
      ...
      v21 = 0LL;
    WPP_IFR_SF_qi(v12, m_RawLength, m_Alignment, 0x1Cu, WPP_FxDmaEnabler_cpp_Traceguids, v21, m_RawLength);
