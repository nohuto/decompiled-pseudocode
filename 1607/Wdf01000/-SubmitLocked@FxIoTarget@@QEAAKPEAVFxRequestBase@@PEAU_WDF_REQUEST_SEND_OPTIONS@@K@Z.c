/*
 * XREFs of ?SubmitLocked@FxIoTarget@@QEAAKPEAVFxRequestBase@@PEAU_WDF_REQUEST_SEND_OPTIONS@@K@Z @ 0x1C000D9D0
 * Callers:
 ...
 *     ?PendRequestLocked@FxIoTarget@@IEAAJPEAVFxRequestBase@@@Z @ 0x1C0083EE0 (-PendRequestLocked@FxIoTarget@@IEAAJPEAVFxRequestBase@@@Z.c)
        ...
        int Flags)
{
  ...
  $8B26BD50DADCE63D5F5F71A785E147C5 *v17; // rax
  ...
  _FX_DRIVER_GLOBALS *FxDriverGlobals; // [rsp+A8h] [rbp+10h]
