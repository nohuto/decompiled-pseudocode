/*
 * XREFs of imp_WdfDeviceSetPowerCapabilities @ 0x1C00346A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z @ 0x1C0028520 (-SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z.c)
