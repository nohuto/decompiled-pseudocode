/*
 * XREFs of ?Initialize@FxPkgPdo@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C002BE50
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall FxPkgPdo::Initialize(FxPkgPdo *this, WDFDEVICE_INIT *DeviceInit)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( v12 )
    {
      ...
      {
        v22 = 327;
        m_DeviceList = *(FxChildList **)(*(_QWORD *)(*(_QWORD *)&this->m_DeviceBase[1].m_ObjectFlags + 648LL) + 1568LL);
      }
      else
      {
