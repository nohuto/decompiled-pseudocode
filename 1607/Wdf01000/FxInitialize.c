/*
 * XREFs of FxInitialize @ 0x1C0017CE8
 * Callers:
 ...
 *     ?FxPoolInitialize@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUFX_POOL@@@Z @ 0x1C00359E8 (-FxPoolInitialize@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUFX_POOL@@@Z.c)
        ...
        _WDF_DRIVER_CONFIG *a4)
{
  ...
  if ( MmIsDriverVerifying(DriverObject) )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    FxAutoRegKey::~FxAutoRegKey((FxAutoRegKey *)&KeyHandle);
  }
  else
  {
    v7 = 0;
