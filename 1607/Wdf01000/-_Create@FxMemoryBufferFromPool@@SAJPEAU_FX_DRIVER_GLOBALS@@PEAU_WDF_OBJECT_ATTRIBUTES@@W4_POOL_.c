/*
 * XREFs of ?_Create@FxMemoryBufferFromPool@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@W4_POOL_TYPE@@K_KPEAPEAVFxMemoryObject@@@Z @ 0x1C00146A0
 * Callers:
...
LABEL_6:
  ...
  {
    FxMemoryObject::FxMemoryObject(v13, FxDriverGlobals, 0x80u, BufferSize);
    v14->FxObject::__vftable = (FxMemoryObject_vtbl *)&FxMemoryBufferFromPool::`vftable'{for `FxObject'};
    goto LABEL_6;
  }
  v14 = 0LL;
LABEL_7:
