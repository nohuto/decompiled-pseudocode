/*
 * XREFs of ?_Create@FxWaitLock@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxObject@@EPEAPEAUWDFWAITLOCK__@@@Z @ 0x1C001A21C
 * Callers:
        ...
        WDFWAITLOCK__ **LockHandle)
{
  ...
  *LockHandle = 0LL;
  ...
  if ( v14 )
  {
    ...
    FxContextHeaderInit((FxContextHeader *)(v15 + 18), (FxObject *)v15, Attributes);
  }
  if ( v15 )
  {
...
LABEL_14:
  ...
  if ( v15 )
  {
    KeInitializeEvent((PRKEVENT)(v15 + 13), SynchronizationEvent, 1u);
    *((_BYTE *)v15 + 128) = 1;
    v16 = FxObject::Commit((FxObject *)v15, Attributes, v5, ParentObject, AssignDriverAsDefaultParent);
    if ( v16 < 0 )
