/*
 * XREFs of imp_WdfFdoInitSetEventCallbacks @ 0x1C0038A80
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDF_FDO_EVENT_CALLBACKS *FdoEventCallbacks)
{
  ...
  if ( (int)FxVerifierCheckIrqlLevel(v7, 0) >= 0 )
  {
    ...
    else
    {
      ...
      {
        if ( !FdoEventCallbacks->EvtDeviceFilterAddResourceRequirements
        ...
        v8 = (_FX_DRIVER_GLOBALS *)&DriverGlobals[-8].DriverName[16];
LABEL_16:
