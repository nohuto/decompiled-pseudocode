/*
 * XREFs of ?ProcessPowerEvents@FxIoQueue@@AEAAEPEAE@Z @ 0x1C001D3D4
 * Callers:
...
LABEL_113:
      if ( m_Globals->FxVerboseOn )
      {
        ...
        if ( this->m_ObjectSize )
          ...
          v56 = 0LL;
        WPP_IFR_SF_qq(m_Globals, 5u, 0xDu, 0x5Bu, WPP_FxIoQueue_cpp_Traceguids, v56, v55);
      }
      FxObject::AddRef(
        (FxObject *)v31,
        (void *)0x646C6F48,
  ...
  if ( v9 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( !v11 )
      {
        ...
        if ( _mm_srli_si128((__m128i)resumeCallback, 8).m128i_u64[0] && !HIBYTE(v31[13].Flink) )
        {
          if ( m_Globals->FxVerboseOn )
          {
            ...
            if ( this->m_ObjectSize )
              ...
              v65 = 0LL;
            WPP_IFR_SF_qq(m_Globals, 5u, 0xDu, 0x62u, WPP_FxIoQueue_cpp_Traceguids, v65, v64);
          }
          FxObject::AddRef(
            (FxObject *)v31,
            (void *)0x646C6F48,
        ...
        v44 = 99;
LABEL_99:
        WPP_IFR_SF_q(m_Globals, 5u, 0xDu, v44, WPP_FxIoQueue_cpp_Traceguids, v43);
        return 1;
      }
      if ( v11 == 1 )
      {
        if ( m_Globals->FxVerboseOn )
        {
          if ( this->m_ObjectSize )
            ...
            v59 = 0LL;
          WPP_IFR_SF_q(m_Globals, 5u, 0xDu, 0x64u, WPP_FxIoQueue_cpp_Traceguids, v59);
        }
    ...
    *p_m_PowerState = FxIoQueuePowerRestartingNotifyingDriver;
    ...
    if ( m_Globals->FxVerboseOn )
    {
      ...
      v42 = 96;
LABEL_92:
      WPP_IFR_SF_q(m_Globals, 5u, 0xDu, v42, WPP_FxIoQueue_cpp_Traceguids, v39);
      goto LABEL_58;
    }
    goto LABEL_58;
  }
    ...
    do
    {
      ...
      if ( (unsigned __int8)(BYTE1(v22[3].Flink) - 1) <= 1u )
      {
        ...
        if ( acknowledgedList.Blink->Flink != &acknowledgedList )
          __fastfail(3u);
        v22->Blink = acknowledgedList.Blink;
    ...
    if ( !this->m_TwoPhaseCompletions )
    {
      if ( this->m_Dispatching == 1 )
      {
        if ( m_Globals->FxVerboseOn )
        {
          ...
          WPP_IFR_SF_q(m_Globals, 5u, 0xDu, 0x5Eu, WPP_FxIoQueue_cpp_Traceguids, v21);
        }
