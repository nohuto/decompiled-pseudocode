/*
 * XREFs of ?PipesGotoRemoveState@FxUsbDevice@@IEAAXE@Z @ 0x1C008BF80
 * Callers:
...
void __fastcall FxUsbDevice::PipesGotoRemoveState(FxUsbDevice *this, _FX_DRIVER_GLOBALS *ForceRemovePipes)
{
  ...
  for ( k = 0LL; (unsigned int)k < this->m_NumInterfaces; k = (unsigned int)(k + 1) )
  {
    ...
    FxUsbInterface::CleanUpAndDelete(v13, (unsigned __int8)v11);
  }
  FxWaitLockInternal::ReleaseLock(p_m_InterfaceIterationLock, v11);
}
