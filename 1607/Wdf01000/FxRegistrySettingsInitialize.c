/*
 * XREFs of FxRegistrySettingsInitialize @ 0x1C0018950
 * Callers:
 ...
 *     ?SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z @ 0x1C00625FC (-SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z.c)
        ...
        if ( SystemRoutineAddress(3221225472u, (const wchar_t *)hWdf.m_Key, paramTable, 0LL, 0LL) >= 0 )
        {
          ...
          if ( FxDriverGlobals->FxVerifierDbgBreakOnError )
          {
            ...
            *(_DWORD *)&KeyValueInformation.Length = 3801144;
            ...
            v43 = *(_QWORD *)L"nSec";
            if ( (int)FxRegKey::_QueryULong(hWdf.m_Key, &KeyValueInformation, &timeoutValue) >= 0 )
