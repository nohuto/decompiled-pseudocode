/*
 * XREFs of ?PowerPolStartingDecideS0Wake@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C0021490
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
        ...
        for ( i = Blink[17].Flink; i != v12; i = i->Flink )
        {
          if ( !BYTE2(i[5].Flink) )
          {
            Flink = i[4].Flink;
            if ( Flink )
              FxPkgPnp::PowerProcessEvent((FxPkgPnp *)Flink[40].Blink, PowerParentToD0, 0);
          }
        }
