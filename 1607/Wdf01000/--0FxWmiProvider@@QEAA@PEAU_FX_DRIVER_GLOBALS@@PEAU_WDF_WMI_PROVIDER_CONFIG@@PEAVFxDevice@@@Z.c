/*
 * XREFs of ??0FxWmiProvider@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_WMI_PROVIDER_CONFIG@@PEAVFxDevice@@@Z @ 0x1C0031360
 * Callers:
        ...
        FxDevice *Device)
{
  ...
  FxNonPagedObject::FxNonPagedObject(this, (_FX_DRIVER_GLOBALS *)0x1004, 0xD8u, FxDriverGlobals);
