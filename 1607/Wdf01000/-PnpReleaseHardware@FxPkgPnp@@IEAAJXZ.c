/*
 * XREFs of ?PnpReleaseHardware@FxPkgPnp@@IEAAJXZ @ 0x1C0093A90
 * Callers:
 *     ?PnpEventFailedOwnHardware@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C0092A00 (-PnpEventFailedOwnHardware@FxPkgPnp@@KA-AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z.c)
...
__int64 __fastcall FxPkgPnp::PnpReleaseHardware(FxPkgPnp *this)
{
  ...
  p_m_DeviceReleaseHardware->m_Device = (WDFDEVICE__ *)v5;
  p_m_DeviceReleaseHardware->m_ResourcesTranslated = (WDFCMRESLIST__ *)v3;
  v7 = FxPrePostCallback::InvokeStateless(p_m_DeviceReleaseHardware);
  if ( v7 == -1073741637 )
  {
