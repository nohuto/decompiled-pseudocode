/*
 * XREFs of imp_WdfDmaTransactionInitialize @ 0x1C0065AA0
 * Callers:
 *     imp_WdfDmaTransactionInitializeUsingOffset @ 0x1C0065CC0 (imp_WdfDmaTransactionInitializeUsingOffset.c)
 * Callees:
