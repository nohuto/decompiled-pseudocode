/*
 * XREFs of imp_WdfIoQueueFindRequest @ 0x1C0011080
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  $8B26BD50DADCE63D5F5F71A785E147C5 *v20; // rdx
  _QWORD *v21; // rcx
  bool v22; // r9
  _QWORD *v23; // r8
  int v24; // edi
  $8B26BD50DADCE63D5F5F71A785E147C5 *v26; // r12
  int v27; // r8d
...
LABEL_19:
  ...
  while ( 1 )
  {
    if ( !*((_BYTE *)v23 - 100) )
    {
      v26 = ($8B26BD50DADCE63D5F5F71A785E147C5 *)*(v23 - 3);
      if ( !v22 )
      {
        v22 = v26 == v20;
        goto LABEL_65;
