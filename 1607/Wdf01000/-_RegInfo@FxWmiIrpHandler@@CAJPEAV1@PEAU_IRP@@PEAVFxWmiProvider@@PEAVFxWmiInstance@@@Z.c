/*
 * XREFs of ?_RegInfo@FxWmiIrpHandler@@CAJPEAV1@PEAU_IRP@@PEAVFxWmiProvider@@PEAVFxWmiInstance@@@Z @ 0x1C0030F40
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    else
    {
      ...
      for ( i = v10; v18 < This->m_NumProviders; ++v18 )
      {
        ...
        *(_LIST_ENTRY *)(v24 + 6) = Flink[3];
        v24[11] = (unsigned int)Flink[2].Flink;
    ...
    {
      FxVerifierLock::Unlock(v29, irql, v10);
    }
    else
    {
