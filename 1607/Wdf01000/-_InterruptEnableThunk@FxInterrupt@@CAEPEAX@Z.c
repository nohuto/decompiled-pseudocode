/*
 * XREFs of ?_InterruptEnableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1C0015090
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxInterrupt::_InterruptEnableThunk(_DWORD *SyncContext, _FX_DRIVER_GLOBALS *a2)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)SyncContext + 258LL) )
  {
    ...
    v7 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v2 + 312))(v3, v10);
  ...
  else
  {
    ...
    if ( *(_WORD *)(v2 + 10) )
      v3 = v2 ^ 0xFFFFFFFFFFFFFFF8uLL;
    v7 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v2 + 312))(v3, v6);
  }
  SyncContext[2] = v7;
  return 1;
}
