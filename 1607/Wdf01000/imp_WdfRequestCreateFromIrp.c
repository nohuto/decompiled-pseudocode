/*
 * XREFs of imp_WdfRequestCreateFromIrp @ 0x1C0074F30
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **Request)
{
  ...
  if ( RequestAttributes )
  {
    ...
    if ( ParentObject )
    {
      FxObjectHandleGetPtr(v5, (unsigned __int64)ParentObject, 0x1000u, &PPObject);
      v5 = (_FX_DRIVER_GLOBALS *)*((_QWORD *)PPObject + 2);
    }
  }
  if ( !Irp )
