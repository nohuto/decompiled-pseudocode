/*
 * XREFs of ?_AdapterControl@FxDmaPacketTransaction@@KA?AW4_IO_ALLOCATION_ACTION@@PEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAX2@Z @ 0x1C00685D0
 * Callers:
        ...
        unsigned __int64 Context)
{
  ...
  level = 0LL;
  v8 = (*(__int64 (__fastcall **)(unsigned __int64, _IRP *))(*(_QWORD *)Context + 136LL))(Context, Irp);
