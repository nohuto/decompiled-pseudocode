/*
 * XREFs of LogDriverInfoStream @ 0x1C0080C00
 * Callers:
 *     ?PnpEventStarted@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C0033930 (-PnpEventStarted@FxPkgPnp@@KA-AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z.c)
 * Callees:
 ...
 *     GetDriverInfo @ 0x1C0080900 (GetDriverInfo.c)
 *     GetFirstHardwareId @ 0x1C0080BA4 (GetFirstHardwareId.c)
...
void __fastcall LogDriverInfoStream(_FX_DRIVER_GLOBALS *DriverGlobals, FxDevice *Fdo)
{
  ...
  bool v25; // [rsp+3Fh] [rbp-C1h] BYREF
  ...
  *(_QWORD *)&manufacturer.m_UnicodeString.Length = 0LL;
    ...
    && (Tlgg_TelemetryProviderProv.KeywordAll & 0x200000000000LL) == Tlgg_TelemetryProviderProv.KeywordAll )
  {
    ...
    *(_QWORD *)&_TlgData[26].Size = 1LL;
    ...
    TlgWrite(v7, (char *)&TlgEvent_1._TlgChannel, v8, v9, 0x1Fu, _TlgData);
  }
