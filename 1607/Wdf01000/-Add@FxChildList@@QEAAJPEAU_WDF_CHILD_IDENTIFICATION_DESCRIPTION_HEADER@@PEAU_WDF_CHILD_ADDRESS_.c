/*
 * XREFs of ?Add@FxChildList@@QEAAJPEAU_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER@@PEAU_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER@@PEAK@Z @ 0x1C002267C
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)(v16 + 48) = v17;
      ...
      if ( this->m_StaticList )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(v21 + 648) + 1576LL) = v16;
        *(_BYTE *)(*(_QWORD *)(v21 + 648) + 1650LL) = 1;
      }
    }
  }
  else
