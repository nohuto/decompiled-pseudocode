/*
 * XREFs of ??0FxSelfManagedIoMachine@@QEAA@PEAVFxPkgPnp@@@Z @ 0x1C002DA84
 * Callers:
...
void __fastcall FxSelfManagedIoMachine::FxSelfManagedIoMachine(FxSelfManagedIoMachine *this, FxPkgPnp *PkgPnp)
{
  ...
  this->m_DeviceSelfManagedIoFlush.__vftable = (FxPnpDeviceSelfManagedIoFlush_vtbl *)&FxPnpDeviceSelfManagedIoFlush::`vftable';
