/*
 * XREFs of ?FxUsbValidateDescriptorType@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAU_USB_CONFIGURATION_DESCRIPTOR@@PEAX2J_KW4FxUsbValidateDescriptorOp@@K@Z @ 0x1C008A574
 * Callers:
        ...
        unsigned int FxDriverGlobals_0)
{
  ...
  while ( 1 )
  {
    ...
    if ( FxDriverGlobals_0 && _a4 == FxDriverGlobals_0 )
      break;
    Start = (char *)(&v16->bLength + bLength);
  }
  return 0LL;
}
