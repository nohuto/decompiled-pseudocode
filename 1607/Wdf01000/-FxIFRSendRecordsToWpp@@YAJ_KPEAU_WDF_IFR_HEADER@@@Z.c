/*
 * XREFs of ?FxIFRSendRecordsToWpp@@YAJ_KPEAU_WDF_IFR_HEADER@@@Z @ 0x1C006EC80
 * Callers:
 *     ?FxIFRReplay@@YAX_K@Z @ 0x1C006E9C0 (-FxIFRReplay@@YAX_K@Z.c)
 * Callees:
 *     memset @ 0x1C003C780 (memset.c)
 *     FxWmiTraceMessage @ 0x1C006CD0C (FxWmiTraceMessage.c)
 *     ?FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z @ 0x1C006EF18 (-FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z.c)
 */
      ...
      if ( PoolWithTag )
      {
        ...
        if ( v19 )
        {
          ...
          while ( (_DWORD)v11 )
          {
            ...
            {
              FxWmiTraceMessage(LoggerHandle, 43LL, (_GUID *)(v16 + 12), *((_WORD *)v16 + 5), v16 + 28, v17 - 28LL, 0LL);
            }
          }
        }
