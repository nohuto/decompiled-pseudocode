/*
 * XREFs of imp_WdfUsbTargetDeviceFormatRequestForControlTransfer @ 0x1C00879A0
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFMEMORY_OFFSET *TransferOffset)
{
  ...
  if ( _a3 )
  {
    ...
    if ( TransferOffset )
    {
      v12 = TransferOffset->BufferLength + TransferOffset->BufferOffset;
      if ( v12 < TransferOffset->BufferLength || v12 > pMemory->GetBufferSize(pMemory) )
        return 3221225621LL;
    }
