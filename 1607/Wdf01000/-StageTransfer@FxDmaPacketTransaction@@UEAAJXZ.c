/*
 * XREFs of ?StageTransfer@FxDmaPacketTransaction@@UEAAJXZ @ 0x1C0067CD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InvokeProgramDma@FxDmaTransactionProgramOrReserveDma@@QEAAEPEAUWDFDMATRANSACTION__@@PEAUWDFDEVICE__@@PEAXW4_WDF_DMA_DIRECTION@@PEAU_SCATTER_GATHER_LIST@@@Z @ 0x1C0067738 (-InvokeProgramDma@FxDmaTransactionProgramOrReserveDma@@QEAAEPEAUWDFDMATRANSACTION__@@PEAUWDFDEVI.c)
...
__int64 __fastcall FxDmaPacketTransaction::StageTransfer(FxDmaPacketTransaction *this, __int64 a2, unsigned __int8 a3)
{
  ...
  unsigned int m_MapRegistersReserved; // r10d
      ...
      if ( m_MapRegistersReserved )
      {
        if ( this->m_MapRegistersNeeded > m_MapRegistersReserved )
        {
          ...
          v17 = ((m_MapRegistersReserved - 1) << 12)
              - (unsigned __int64)(((_WORD)v13 + (unsigned __int16)m_CurrentFragmentMdl->ByteOffset) & 0xFFF)
              + 4096;
