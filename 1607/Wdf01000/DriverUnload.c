/*
 * XREFs of DriverUnload @ 0x1C0064680
 * Callers:
 *     <none>
 * Callees:
 *     ?WdfDeleteKmdfVersionFromRegistry@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C0064504 (-WdfDeleteKmdfVersionFromRegistry@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 */
