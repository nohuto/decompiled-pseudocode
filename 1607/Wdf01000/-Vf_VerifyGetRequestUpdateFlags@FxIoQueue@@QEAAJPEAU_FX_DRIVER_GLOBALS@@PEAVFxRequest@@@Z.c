/*
 * XREFs of ?Vf_VerifyGetRequestUpdateFlags@FxIoQueue@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAVFxRequest@@@Z @ 0x1C00C9C44
 * Callers:
        ...
        FxRequest *TagRequest)
{
  ...
  if ( this->m_Type == WdfIoQueueDispatchSequential && !this->m_DriverIoCount )
  {
    ...
    WPP_IFR_SF_q(FxDriverGlobals, 2u, 0xDu, 0x19u, WPP_FxIoQueue_cpp_Traceguids, v3);
    FxVerifierDbgBreakPoint(FxDriverGlobals);
  }
