/*
 * XREFs of ?GetDmaDescription@FxDmaEnabler@@QEAAPEAU_FxDmaDescription@@W4_WDF_DMA_DIRECTION@@@Z @ 0x1C002FE4C
 * Callers:
 ...
 *     ?SupportsChainedMdls@FxDmaEnabler@@QEAAEXZ @ 0x1C0064E40 (-SupportsChainedMdls@FxDmaEnabler@@QEAAEXZ.c)
 ...
 *     ?ReleaseResources@FxDmaPacketTransaction@@UEAAXE@Z @ 0x1C0067890 (-ReleaseResources@FxDmaPacketTransaction@@UEAAXE@Z.c)
...
$573AD7123BB726F3889E56BBEE799ACF *__fastcall FxDmaEnabler::GetDmaDescription(
        FxDmaEnabler *this,
        _WDF_DMA_DIRECTION Direction)
{
  if ( (*((_BYTE *)this + 380) & 0x10) != 0 )
    return ($573AD7123BB726F3889E56BBEE799ACF *)((char *)&this->184 + 96 * Direction);
  else
    return &this->184;
}
