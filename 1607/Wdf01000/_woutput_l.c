...
__int64 __fastcall woutput_l(_iobuf *stream, const wchar_t *format, localeinfo_struct *plocinfo, char *argptr)
{
  ...
  int v19; // ecx
  $B4FF2100EA110D8CD0B9C89F852FB035 *v20; // rax
  _BYTE *v21; // rax
  wchar_t v22; // ax
  int v23; // eax
  int v24; // r9d
  ...
  char tempchar[4]; // [rsp+54h] [rbp-ACh] BYREF
  wchar_t wchar[2]; // [rsp+58h] [rbp-A8h] BYREF
  wchar_t prefix[2]; // [rsp+5Ch] [rbp-A4h] BYREF
  int v57; // [rsp+60h] [rbp-A0h]
  _iobuf *f; // [rsp+68h] [rbp-98h]
  int v59; // [rsp+70h] [rbp-90h]
  $12F061FBE778B92DEB8200A0ACF7A038 text; // [rsp+78h] [rbp-88h]
...
LABEL_172:
          ...
          case 5:
            if ( v11 != 42 )
            {
              v8 = (unsigned int)v11 + 2 * (5 * (_DWORD)v8 - 24);
              goto LABEL_167;
            }
            v8 = *(unsigned int *)v5;
            v5 += 4;
...
LABEL_167:
          ...
          case 6:
            ...
            v45 = *format;
            v6 |= 0x8000u;
            if ( *(_DWORD *)format == 3407926 )
            {
              format += 2;
              v6 |= 0x8000u;
              break;
            }
            if ( (_WORD)v45 == 51 && format[1] == 50 )
            {
              format += 2;
              v6 &= ~0x8000u;
              break;
            ...
            if ( v11 > 0x69u )
            {
              switch ( v11 )
              {
                case 'n':
                  v37 = *(_WORD **)v5;
                  v50 = (char *)(v5 + 4);
                  if ( !(unsigned int)get_printf_count_output((unsigned int)v11 - 110, v8) )
                    goto LABEL_184;
                  if ( (v6 & 0x20) != 0 )
                    *v37 = v12;
                  else
              ...
              if ( v11 != 83 )
              {
                if ( v11 != 88 )
                {
                  if ( v11 == 90 )
                  {
                    ...
                    v50 = (char *)(v5 + 4);
                    if ( v18 && (sz = ($B4FF2100EA110D8CD0B9C89F852FB035 *)*((_QWORD *)v18 + 1)) != 0LL )
                    {
                      if ( v18[1] < *v18 )
                        goto LABEL_184;
                      LODWORD(v13) = *v18;
                      if ( (v6 & 0x800) != 0 )
                      {
                        if ( (v13 & 1) != 0 || ((unsigned __int8)sz & 1) != 0 )
                        {
LABEL_184:
...
LABEL_90:
                        ...
                        v9 = v47;
                        v36 = (unsigned int)&buffer.wz[64] + 383 - (_DWORD)v30;
                        v49 = v29;
                        v12 = charsout;
                        sz = ($B4FF2100EA110D8CD0B9C89F852FB035 *)(v30 + 1);
                        LODWORD(v13) = v36;
                        if ( (v6 & 0x200) != 0 && (!v36 || sz->sz[0] != 48) )
                        {
...
LABEL_121:
                            v39 = v7 - v13 - v38;
                            if ( (v6 & 0xC) == 0 )
                              write_multi_char(0x20u, v39, f, &charsout);
                            write_string(prefix, v38, f, &charsout);
                            v40 = f;
                            if ( (v6 & 0xC) == 8 )
                              write_multi_char(0x30u, v39, f, &charsout);
                            if ( v51 || (int)v13 <= 0 )
                            {
                              write_string((wchar_t *)sz, v13, v40, &charsout);
LABEL_135:
                              v12 = charsout;
                            }
                            else
                            {
                              ...
                              {
                                --v42;
                                v43 = mbtowc(wchar, v41, _mb_cur_max);
                                v44 = v43;
                                if ( v43 == 2 )
                                  --v42;
                                if ( v43 <= 0 )
                            ...
                            if ( v12 >= 0 && (v6 & 4) != 0 )
                            {
                              write_multi_char(0x20u, v39, v40, &charsout);
                              v12 = charsout;
                            }
                            format = (const wchar_t *)text.sz;
                            v7 = v52;
...
LABEL_52:
                  ...
                  if ( (v6 & 0x20) != 0 )
                  {
                    tempchar[0] = v22;
                    tempchar[1] = 0;
                    v23 = mbtowc((wchar_t *)&buffer, tempchar, _mb_cur_max);
                    v9 = v47;
                    if ( v23 < 0 )
                      v57 = 1;
                  }
...
LABEL_77:
            ...
            if ( (_DWORD)v8 == -1 )
              v19 = 0x7FFFFFFF;
            v20 = *($B4FF2100EA110D8CD0B9C89F852FB035 **)v5;
            v50 = (char *)(v5 + 4);
            if ( (v6 & 0x20) != 0 )
            {
              sz = ($B4FF2100EA110D8CD0B9C89F852FB035 *)"(null)";
