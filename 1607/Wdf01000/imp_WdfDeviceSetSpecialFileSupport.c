/*
 * XREFs of imp_WdfDeviceSetSpecialFileSupport @ 0x1C0035D50
 * Callers:
 *     <none>
 * Callees:
 *     ?FxObjectHandleGetPtr@@YAXPEAU_FX_DRIVER_GLOBALS@@PEAXGPEAPEAX@Z @ 0x1C0001BF0 (-FxObjectHandleGetPtr@@YAXPEAU_FX_DRIVER_GLOBALS@@PEAXGPEAPEAX@Z.c)
 *     WPP_IFR_SF_qd @ 0x1C0002600 (WPP_IFR_SF_qd.c)
 *     ?_SpecialTypeToUsage@FxPkgPnp@@KA?AW4_DEVICE_USAGE_NOTIFICATION_TYPE@@W4_WDF_SPECIAL_FILE_TYPE@@@Z @ 0x1C0037D20 (-_SpecialTypeToUsage@FxPkgPnp@@KA-AW4_DEVICE_USAGE_NOTIFICATION_TYPE@@W4_WDF_SPECIAL_FILE_TYPE@@.c)
