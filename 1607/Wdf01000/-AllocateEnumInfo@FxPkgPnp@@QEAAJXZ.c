/*
 * XREFs of ?AllocateEnumInfo@FxPkgPnp@@QEAAJXZ @ 0x1C0025CD4
 * Callers:
 *     ?Initialize@FxPkgFdo@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C0029C70 (-Initialize@FxPkgFdo@@UEAAJPEAUWDFDEVICE_INIT@@@Z.c)
 *     ?AllocateEnumInfo@FxDevice@@UEAAJXZ @ 0x1C00798A0 (-AllocateEnumInfo@FxDevice@@UEAAJXZ.c)
 * Callees:
...
LABEL_10:
  if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v13 = (FxVerifierLock *)this[-1].m_DeviceSurpriseRemoval.m_PkgPnp) != 0LL )
    FxVerifierLock::Unlock(v13, v4, v5);
  else
