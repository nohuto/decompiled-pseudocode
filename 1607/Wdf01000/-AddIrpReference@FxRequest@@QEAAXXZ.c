/*
 * XREFs of ?AddIrpReference@FxRequest@@QEAAXXZ @ 0x1C00784FC
 * Callers:
 ...
 *     ?AddRef@FxRequestOutputBuffer@@UEAAKPEAXJPEAD@Z @ 0x1C007B4B0 (-AddRef@FxRequestOutputBuffer@@UEAAKPEAXJPEAD@Z.c)
 *     ?AddRef@FxRequestSystemBuffer@@UEAAKPEAXJPEAD@Z @ 0x1C007B5A0 (-AddRef@FxRequestSystemBuffer@@UEAAKPEAXJPEAD@Z.c)
 * Callees:
