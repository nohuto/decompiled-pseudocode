/*
 * XREFs of imp_WdfRegistryAssignMemory @ 0x1C007F440
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
          ...
          v18 = _a2;
          if ( _a2 < 0 )
            WPP_IFR_SF_qd(m_Globals, 2u, 2u, 0x23u, WPP_FxRegistryAPI_cpp_Traceguids, Key, _a2);
          return v18;
        }
      ...
      v18 = -1073741675;
      WPP_IFR_SF_qid(m_Globals, 2u, 2u, v19, WPP_FxRegistryAPI_cpp_Traceguids, Key, (__int64)v9, -1073741675);
      return v18;
    }
  }
  return result;
