/*
 * XREFs of ?PerfEvtDevicePrepareHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C0071BE0
 * Callers:
...
char __fastcall PerfEvtDevicePrepareHardwareStart(unsigned __int64 Handle, _GUID *pActivityId)
{
  ...
  if ( ((__int64)WPP_GLOBAL_WDF_Control.DeviceQueue.DeviceListHead.Blink & 1) != 0 )
    Template_pp(v8, &FX_POWER_HW_PREPARE_START, pActivityId, v7, (const void *)Handle);
  return v3;
}
