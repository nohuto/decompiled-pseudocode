/*
 * XREFs of ?AllocateAdapterChannel@FxDmaPacketTransaction@@IEAAJE@Z @ 0x1C0067398
 * Callers:
        ...
        unsigned __int8 MapRegistersReserved)
{
  ...
  if ( m_Globals->FxVerifierOn )
  {
    ...
    WPP_IFR_SF_dq(m_Globals, 5u, 0xFu, v9, WPP_FxDmaTransactionPacket_hpp_Traceguids, this->m_MapRegistersNeeded, _a2);
  }
LABEL_14:
