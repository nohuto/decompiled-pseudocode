/*
 * XREFs of ?DmaCompleted@FxDmaTransactionBase@@QEAAE_KPEAJW4FxDmaCompletionType@@@Z @ 0x1C006A7CC
 * Callers:
    ...
    if ( this->m_RequireSingleTransfer )
    {
      ...
      if ( m_Remaining )
      {
        ...
        if ( this->m_ObjectSize )
          ...
          v17 = 0LL;
        WPP_IFR_SF_qPPd(m_Globals, m_Remaining, v15, 0x19u, traceGuid, v17, m_Remaining, this->m_TransactionLength, _a4);
        goto LABEL_11;
      }
    }
...
LABEL_12:
  if ( m_Globals->FxVerifierOn && m_Globals->FxVerboseOn )
  {
    if ( this->m_ObjectSize )
      ...
      v13 = 0LL;
    WPP_IFR_SF_qd(m_Globals, 5u, 0xFu, 0x1Au, WPP_FxDmaTransactionBase_cpp_Traceguids, v13, v12);
  }
  this->ReleaseResources(this, 0);
  m_EncodedRequest = this->m_EncodedRequest;
  if ( m_EncodedRequest )
  {
    v19 = (FxRequest *)((unsigned __int64)m_EncodedRequest & 0xFFFFFFFFFFFFFFFEuLL);
    this->m_EncodedRequest = v19;
...
LABEL_40:
  *ReturnStatus = v12;
  if ( m_Globals->FxVerifierOn && m_Globals->FxVerboseOn )
    WPP_IFR_SF_qc(m_Globals, m_Remaining, v15, v16, traceGuid, _a1, v11);
  return v11;
}
