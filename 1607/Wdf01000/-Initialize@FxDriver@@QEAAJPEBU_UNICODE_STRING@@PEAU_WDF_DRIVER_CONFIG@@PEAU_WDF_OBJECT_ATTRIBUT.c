/*
 * XREFs of ?Initialize@FxDriver@@QEAAJPEBU_UNICODE_STRING@@PEAU_WDF_DRIVER_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C00210C0
 * Callers:
 ...
 *     ?ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C0020DD4 (-ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z.c)
    ...
    if ( result >= 0 )
    {
      ...
      *(_QWORD *)DriverObjectExtension = this;
      ...
      if ( ArgRegistryPath )
      {
        ...
        v18 = (wchar_t *)FxPoolAllocator(v16, &v16->FxPoolFrameworks, 1u, v17, v16->Tag, Caller);
