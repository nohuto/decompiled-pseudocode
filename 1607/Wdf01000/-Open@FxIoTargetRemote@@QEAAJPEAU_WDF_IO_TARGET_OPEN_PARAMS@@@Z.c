/*
 * XREFs of ?Open@FxIoTargetRemote@@QEAAJPEAU_WDF_IO_TARGET_OPEN_PARAMS@@@Z @ 0x1C002D058
 * Callers:
 ...
 *     ?GetTargetDeviceRelations@FxIoTargetRemote@@QEAAJPEAE@Z @ 0x1C002CDBC (-GetTargetDeviceRelations@FxIoTargetRemote@@QEAAJPEAE@Z.c)
 ...
 *     ?RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ @ 0x1C002D010 (-RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ.c)
 *     ?Clear@FxIoTargetRemoveOpenParams@@QEAAXXZ @ 0x1C002D548 (-Clear@FxIoTargetRemoveOpenParams@@QEAAXXZ.c)
 *     ?Set@FxIoTargetRemoveOpenParams@@QEAAXPEAU_WDF_IO_TARGET_OPEN_PARAMS@@PEAU_UNICODE_STRING@@PEAXK@Z @ 0x1C002D584 (-Set@FxIoTargetRemoveOpenParams@@QEAAXPEAU_WDF_IO_TARGET_OPEN_PARAMS@@PEAU_UNICODE_STRING@@PEAXK.c)
...
__int64 __fastcall FxIoTargetRemote::Open(FxIoTargetRemote *this, _WDF_IO_TARGET_OPEN_PARAMS *OpenParams)
{
  ...
  *(_QWORD *)&name.Length = 0LL;
  ...
  v7 = 0;
  close = 0;
  v45 = Type == WdfIoTargetOpenReopen;
  Ea = 0LL;
  EaLength = 0;
                ...
                if ( TargetDeviceRelations < 0 )
                {
                  ...
                  if ( v34->FxVerboseOn )
                  {
                    if ( this->m_ObjectSize )
                      ...
                      v35 = 0LL;
                    WPP_IFR_SF_qd(v34, 5u, 0xEu, 0x15u, WPP_FxIoTargetRemote_cpp_Traceguids, v35, TargetDeviceRelations);
                  }
                  v7 = 1;
                }
              }
