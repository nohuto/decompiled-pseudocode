/*
 * XREFs of USBD_UrbFree @ 0x1C009DEAC
 * Callers:
 ...
 *     ?Dispose@FxUsbPipeRequestContext@@UEAAXXZ @ 0x1C0089090 (-Dispose@FxUsbPipeRequestContext@@UEAAXXZ.c)
 *     ?Dispose@FxUsbPipeTransferContext@@UEAAXXZ @ 0x1C00890E0 (-Dispose@FxUsbPipeTransferContext@@UEAAXXZ.c)
 *     ??1FxUsbDeviceControlContext@@UEAA@XZ @ 0x1C008AB70 (--1FxUsbDeviceControlContext@@UEAA@XZ.c)
 ...
 *     ?Dispose@FxUsbDeviceStringContext@@UEAAXXZ @ 0x1C008BB70 (-Dispose@FxUsbDeviceStringContext@@UEAAXXZ.c)
 *     ?Dispose@FxUsbUrb@@MEAAEXZ @ 0x1C008BBC0 (-Dispose@FxUsbUrb@@MEAAEXZ.c)
 * Callees:
 *     <none>
 */
  ...
  if ( Urb )
  {
    if ( USBDHandle )
    {
      ...
      if ( _InterlockedExchangeAdd((volatile signed __int32 *)USBDHandle + 43, 0xFFFFFFFF) <= 1 )
      {
        ...
        else if ( BYTE4(WPP_GLOBAL_WDF_Control.Dpc.DpcListEntry.Next) )
        {
