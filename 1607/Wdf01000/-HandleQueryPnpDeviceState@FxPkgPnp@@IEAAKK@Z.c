/*
 * XREFs of ?HandleQueryPnpDeviceState@FxPkgPnp@@IEAAKK@Z @ 0x1C00279B0
 * Callers:
 *     ?HandleQueryPnpDeviceStateCompletion@FxPkgFdo@@AEAAXPEAVFxIrp@@@Z @ 0x1C0029F74 (-HandleQueryPnpDeviceStateCompletion@FxPkgFdo@@AEAAXPEAVFxIrp@@@Z.c)
...
__int64 __fastcall FxPkgPnp::HandleQueryPnpDeviceState(FxPkgPnp *this, unsigned int PnpDeviceState, unsigned __int8 a3)
{
  ...
  {
    FxVerifierLock::Lock(m_PkgPnp, &PreviousIrql, a3);
    v5 = PreviousIrql;
  }
  else
  {
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v17 = (FxVerifierLock *)this[-1].m_DeviceSurpriseRemoval.m_PkgPnp) != 0LL )
  ...
  if ( v9 == 8 )
  {
    if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v18 = (FxVerifierLock *)this[-1].m_DeviceSurpriseRemoval.m_PkgPnp) != 0LL )
    {
    ...
    if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v19 = (FxVerifierLock *)this[-1].m_DeviceSurpriseRemoval.m_PkgPnp) != 0LL )
