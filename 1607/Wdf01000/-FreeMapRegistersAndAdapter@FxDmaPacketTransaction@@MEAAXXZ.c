/*
 * XREFs of ?FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ @ 0x1C0067560
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxDmaPacketTransaction::FreeMapRegistersAndAdapter(FxDmaPacketTransaction *this)
{
  ...
  else
  {
    ...
    if ( v4->FxVerifierOn && v4->FxVerboseOn )
    {
      ...
      WPP_IFR_SF_dq(v4, 5u, 0xFu, 0x11u, WPP_FxDmaTransactionPacket_hpp_Traceguids, this->m_MapRegistersNeeded, _a2);
    }
  }
}
