/*
 * XREFs of ?StartTransfer@FxDmaPacketTransaction@@UEAAJXZ @ 0x1C0068350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxDmaPacketTransaction::StartTransfer(FxDmaPacketTransaction *this)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( m_Globals->FxVerifierOn && m_Globals->FxVerboseOn )
      WPP_IFR_SF_qd(m_Globals, 5u, 0xFu, 0x17u, WPP_FxDmaTransactionPacket_cpp_Traceguids, _a1, v7);
  }
  else
  {
    ...
    if ( m_DmaEnabler->m_ObjectSize )
      ...
      v9 = 0LL;
    WPP_IFR_SF_qd(m_Globals, 2u, 0xFu, 0x15u, WPP_FxDmaTransactionPacket_cpp_Traceguids, v9, v7);
