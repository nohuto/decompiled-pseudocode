/*
 * XREFs of ?IsCorrectVersionRegistered@_FX_DRIVER_GLOBALS@@QEAAEPEBU_UNICODE_STRING@@@Z @ 0x1C0017DD4
 * Callers:
        ...
        _UNICODE_STRING *ServiceKeyName)
{
  ...
  _BYTE wdfMajorValue_buffer[72]; // [rsp+D8h] [rbp-30h] OVERLAPPED BYREF
