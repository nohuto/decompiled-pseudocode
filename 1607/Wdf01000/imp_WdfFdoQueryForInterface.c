/*
 * XREFs of imp_WdfFdoQueryForInterface @ 0x1C002B4A0
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( Irp )
      {
        ...
        *(_WORD *)&CurrentStackLocation[-1].MajorFunction = 2075;
        ...
        v22[-1].CompletionRoutine = FxIrp::_IrpSynchronousCompletion;
        v22[-1].Context = &Event;
        v22[-1].Control = -32;
        Status = IofCallDriver(AttachedDeviceReference, v20);
        if ( Status == 259 )
        {
