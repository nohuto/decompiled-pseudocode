/*
 * XREFs of ?Close@FxIoTargetRemote@@QEAAXW4FxIoTargetRemoteCloseReason@@@Z @ 0x1C0084FF4
 * Callers:
 ...
 *     ?Remove@FxIoTargetRemote@@UEAAXXZ @ 0x1C00854E0 (-Remove@FxIoTargetRemote@@UEAAXXZ.c)
 * Callees:
