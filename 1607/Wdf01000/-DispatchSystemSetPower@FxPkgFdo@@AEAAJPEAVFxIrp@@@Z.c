/*
 * XREFs of ?DispatchSystemSetPower@FxPkgFdo@@AEAAJPEAVFxIrp@@@Z @ 0x1C0012ABC
 * Callers:
...
NTSTATUS __fastcall FxPkgFdo::DispatchSystemSetPower(FxPkgFdo *this, FxIrp *Irp)
{
  ...
  else
  {
    ...
    *(_OWORD *)&v7[-1].Parameters.QueryFile.FileInformationClass = *(_OWORD *)&v7->Parameters.QueryFile.FileInformationClass;
    *(_OWORD *)(&v7[-1].Parameters.QueryDeviceRelations + 6) = *(_OWORD *)(&v7->Parameters.QueryDeviceRelations + 6);
