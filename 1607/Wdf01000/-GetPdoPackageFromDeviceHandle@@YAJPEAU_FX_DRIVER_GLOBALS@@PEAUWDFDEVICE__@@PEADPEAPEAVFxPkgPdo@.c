/*
 * XREFs of ?GetPdoPackageFromDeviceHandle@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFDEVICE__@@PEADPEAPEAVFxPkgPdo@@PEAPEAU1@PEAPEAVFxDevice@@@Z @ 0x1C0036018
 * Callers:
 *     imp_WdfPdoGetParent @ 0x1C0035FC0 (imp_WdfPdoGetParent.c)
 *     imp_WdfPdoAddEjectionRelationsPhysicalDevice @ 0x1C006C900 (imp_WdfPdoAddEjectionRelationsPhysicalDevice.c)
 *     imp_WdfPdoClearEjectionRelationsDevices @ 0x1C006C960 (imp_WdfPdoClearEjectionRelationsDevices.c)
