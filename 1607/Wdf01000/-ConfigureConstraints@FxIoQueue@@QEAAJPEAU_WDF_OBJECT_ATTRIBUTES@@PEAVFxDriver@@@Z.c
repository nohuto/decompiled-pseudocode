/*
 * XREFs of ?ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z @ 0x1C001DABC
 * Callers:
        ...
        FxDriver *Caller)
{
  ...
  const void *v7; // rdi
  _WDF_EXECUTION_LEVEL v8; // r8d
  _WDF_EXECUTION_LEVEL globals; // eax
...
LABEL_18:
  ...
  else
  {
    ...
    WPP_IFR_SF_qDDd(this->m_Globals, (_BYTE)this + 16, 0xDu, 0x15u, WPP_FxIoQueue_cpp_Traceguids, v7, v8, globals, v15);
  }
  return 3221225485LL;
}
