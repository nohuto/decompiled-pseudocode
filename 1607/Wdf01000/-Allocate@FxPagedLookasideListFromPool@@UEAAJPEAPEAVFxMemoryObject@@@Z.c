/*
 * XREFs of ?Allocate@FxPagedLookasideListFromPool@@UEAAJPEAPEAVFxMemoryObject@@@Z @ 0x1C007AD70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  v12->FxMemoryObject::FxObject::__vftable = (FxMemoryBufferFromLookaside_vtbl *)&FxMemoryPagedBufferFromPoolLookaside::`vftable'{for `FxObject'};
