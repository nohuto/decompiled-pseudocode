/*
 * XREFs of ?FdoInitialize@FxDevice@@QEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C001FB28
 * Callers:
...
NTSTATUS __fastcall FxDevice::FdoInitialize(FxDevice *this, WDFDEVICE_INIT *DeviceInit)
{
  ...
  if ( result >= 0 )
  {
    ...
    {
      WPP_IFR_SF_d(v14, 2u, 0xDu, 0x1Du, WPP_FxPkgIo_cpp_Traceguids, -1073741808);
...
LABEL_12:
        ...
        {
          v21 = this->m_PkgPnp;
          v21[1].m_ChildEntry.Blink = (_LIST_ENTRY *)DeviceInit->Fdo.EventCallbacks.EvtDeviceFilterAddResourceRequirements;
          v21[1].m_DisposeSingleEntry.Next = (_SINGLE_LIST_ENTRY *)DeviceInit->Fdo.EventCallbacks.EvtDeviceFilterRemoveResourceRequirements;
          v21[1].m_DeviceBase = (FxDeviceBase *)DeviceInit->Fdo.EventCallbacks.EvtDeviceRemoveAddedResources;
        }
