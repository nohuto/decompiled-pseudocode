/*
 * XREFs of ?RemoveCompletedRequestLocked@FxIoTarget@@IEAAEPEAVFxRequestBase@@@Z @ 0x1C000D920
 * Callers:
        ...
        unsigned __int8 a3)
{
  ...
  $8B26BD50DADCE63D5F5F71A785E147C5 *v6; // rax
  _IRP *Irp; // rcx
  ...
  if ( ($8B26BD50DADCE63D5F5F71A785E147C5 *)Flink->Blink != &Request->120
    || *($8B26BD50DADCE63D5F5F71A785E147C5 **)&Irp->Type != v6 )
  {
    __fastfail(3u);
  }
