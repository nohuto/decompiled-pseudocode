/*
 * XREFs of ?PoxRegisterDevice@FxPoxInterface@@AEAAJXZ @ 0x1C0022C28
 * Callers:
...
__int64 __fastcall FxPoxInterface::PoxRegisterDevice(FxPoxInterface *this)
{
  ...
  *(_QWORD *)&poxDevice_8[40] = FxPoxInterface::PowerNotRequiredCallback;
  ...
  v4 = PoFxRegisterDevice(this->m_PkgPnp->m_DeviceBase->m_PhysicalDevice.m_DeviceObject, poxDevice_8, &this->m_PoHandle);
  if ( v4 < 0 )
  {
    ...
    if ( m_DeviceBase->m_ObjectSize )
      ...
      _a1 = 0LL;
    WPP_IFR_SF_qid(m_PkgPnp->m_Globals, 2u, 0xCu, 0x12u, WPP_PoxInterfaceKm_cpp_Traceguids, _a1, _a2, v4);
  }
  else
  {
    return 0;
