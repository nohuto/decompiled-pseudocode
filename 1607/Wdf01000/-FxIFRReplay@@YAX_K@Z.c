/*
 * XREFs of ?FxIFRReplay@@YAX_K@Z @ 0x1C006E9C0
 * Callers:
...
void __fastcall FxIFRReplay(unsigned __int64 LoggerHandle)
{
  ...
  char driverChar[32]; // [rsp+250h] [rbp+150h] BYREF
  ...
  memset(&fxGlobalsForReplay.ThreadTableLock.m_Lock, 0, 200);
        ...
        if ( v2 >= 0 )
        {
          ...
          if ( *v5 )
          {
            do
            {
              ...
              *(_DWORD *)&currentDriverAnsi.Length = 0x200000;
