/*
 * XREFs of _handle_error @ 0x1C0006D74
 * Callers:
 *     log10 @ 0x1C0006900 (log10.c)
 *     _pow_special @ 0x1C0006EA0 (_pow_special.c)
 * Callees:
 ...
 *     _raise_exc @ 0x1C000702C (_raise_exc.c)
 *     _set_errno_from_matherr @ 0x1C00072DC (_set_errno_from_matherr.c)
