/*
 * XREFs of USBParseMIDIInJack @ 0x1C001F6B0
 * Callers:
 *     <none>
 * Callees:
 *     BusApiBuildTerminalFunctionUnit @ 0x1C001B4DC (BusApiBuildTerminalFunctionUnit.c)
...
__int64 __fastcall USBParseMIDIInJack(__int64 a1, __int64 a2, unsigned __int8 *a3)
{
  ...
  if ( *a3 < 6u
    || (unsigned __int64)(a3 + 6) > *(_QWORD *)(v6 + 40)
