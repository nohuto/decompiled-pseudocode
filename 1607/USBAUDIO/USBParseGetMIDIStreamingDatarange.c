/*
 * XREFs of USBParseGetMIDIStreamingDatarange @ 0x1C0020520
 * Callers:
        ...
        _QWORD *PoolWithTag)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v11->bNumEndpoints )
    {
      ...
      *((_OWORD *)v12 + 1) = xmmword_1C000AD90;
      *((_OWORD *)v12 + 2) = xmmword_1C000ADA0;
      *((_OWORD *)v12 + 3) = xmmword_1C000ADB0;
      *((_DWORD *)v12 + 24) = v27 < 0 ? 16 : 8;
      *((_OWORD *)v12 + 4) = xmmword_1C000ADC0;
      *((_OWORD *)v12 + 5) = xmmword_1C000ADD0;
      *a5 = v12;
      v28 = 88;
