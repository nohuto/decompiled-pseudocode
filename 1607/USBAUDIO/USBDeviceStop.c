/*
 * XREFs of USBDeviceStop @ 0x1C001C310
 * Callers:
 *     USBDeviceSurpriseRemove @ 0x1C001C3D0 (USBDeviceSurpriseRemove.c)
 * Callees:
...
__int64 __fastcall USBDeviceStop(__int64 a1)
{
  ...
  if ( *(_QWORD *)(v4 + 192) == v4 + 192 || (v3 = USBHwStopAllMIDIPipes(), v3 >= 0) )
  {
    ...
    {
      v3 = -1073741670;
      PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, 0x58uLL, 0x41627845u);
      v6 = PoolWithTag;
      if ( PoolWithTag )
      {
        *PoolWithTag = 88;
