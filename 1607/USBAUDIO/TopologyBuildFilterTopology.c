/*
 * XREFs of TopologyBuildFilterTopology @ 0x1C0018368
 * Callers:
 ...
 *     TopologyCountComponents @ 0x1C0016A94 (TopologyCountComponents.c)
 */
...
__int64 __fastcall TopologyBuildFilterTopology(__int64 a1, __int64 a2)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    *(_DWORD *)(a2 + 68) = 152;
    ...
    if ( v19 > 0xFFFFFFFF )
      return 3221225858LL;
    PoolWithTag = (GUID *)ExAllocatePoolWithTag((POOL_TYPE)512, (unsigned int)v19, 0x41627845u);
    v24 = PoolWithTag;
    if ( !PoolWithTag )
      return 3221225626LL;
...
LABEL_68:
          ...
          if ( v29 )
          {
            ...
            do
            {
              ...
              v48 = dword_1C000A2F0[4 * *((unsigned int *)v46 + 13)];
              if ( v48 )
              {
                *(_DWORD *)v46 = v48;
                *((_QWORD *)v46 + 1) = (&off_1C000A2F8)[v47];
                *((_DWORD *)v46 + 1) = 72;
              }
              v46 += 152;
              --v45;
