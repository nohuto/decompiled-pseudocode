/*
 * XREFs of WPP_RECORDER_SF_DDDddd @ 0x1C0002DF4
 * Callers:
 *     USBType1AsyncEndpointPollCallback @ 0x1C00035E0 (USBType1AsyncEndpointPollCallback.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_DDDddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_dd18a67003f138bbaf0b6e5bb4153cdd_Traceguids,
      13LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 5LL, 3LL, &WPP_dd18a67003f138bbaf0b6e5bb4153cdd_Traceguids, v7, (__int64 *)va);
}
