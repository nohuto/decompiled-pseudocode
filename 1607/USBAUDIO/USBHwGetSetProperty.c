/*
 * XREFs of USBHwGetSetProperty @ 0x1C001C5E8
 * Callers:
 *     USBHwGetSetByte @ 0x1C001C730 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C001C7F0 (USBHwGetSetShort.c)
 *     USBHwGetSetMemory @ 0x1C001C8A8 (USBHwGetSetMemory.c)
 *     USBCntrlGetSetGEQ @ 0x1C0020C90 (USBCntrlGetSetGEQ.c)
 *     USBCntrlGetSetProcessingUnitValue @ 0x1C0020E90 (USBCntrlGetSetProcessingUnitValue.c)
 *     USBCntrlMuxSource @ 0x1C0020F40 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C0020FF0 (USBCntrlGetSetMixerLevels.c)
