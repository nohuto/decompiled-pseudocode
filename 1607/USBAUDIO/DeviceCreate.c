...
__int64 __fastcall DeviceCreate(__int64 a1)
{
  ...
  PoolWithTag = (PDRIVER_CONTROL *)ExAllocatePoolWithTag((POOL_TYPE)512, 0x2B0uLL, 0x41627845u);
  v8 = PoolWithTag;
  if ( !PoolWithTag )
    goto LABEL_15;
