 ...
 *     rbc_InitializeFeatureStaging @ 0x1C0001AD8 (rbc_InitializeFeatureStaging.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  void (__fastcall *v11)(struct _DRIVER_OBJECT *, _QWORD, __int64 (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *); // rax
  NTSTATUS v12; // eax
  NTSTATUS v13; // ecx
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  if ( WPP_GLOBAL_Control != &WPP_MAIN_CB )
  {
    ...
    if ( v7 == 4 )
    {
      do
      {
        v11 = (void (__fastcall *)(struct _DRIVER_OBJECT *, _QWORD, __int64 (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *))pfnEtwRegisterClassicProvider;
        v10->Vpb = 0LL;
        v15 = (_DWORD)v10 + 56;
