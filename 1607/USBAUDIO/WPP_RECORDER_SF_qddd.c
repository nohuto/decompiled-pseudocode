/*
 * XREFs of WPP_RECORDER_SF_qddd @ 0x1C0001FB0
 * Callers:
...
__int64 WPP_RECORDER_SF_qddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80u) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_89771fce86223ed4814147843477e0f4_Traceguids,
      21LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 21;
  return WppAutoLogTrace(a1, 4LL, 8LL, &WPP_89771fce86223ed4814147843477e0f4_Traceguids, v7, (__int64 *)va);
}
