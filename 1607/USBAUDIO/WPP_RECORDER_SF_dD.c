/*
 * XREFs of WPP_RECORDER_SF_dD @ 0x1C0004DFC
 * Callers:
 *     USBCaptureCompleteCallback @ 0x1C00051D0 (USBCaptureCompleteCallback.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_dD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_cd889c5661493256fd20720ba3c49600_Traceguids,
      12LL,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 12;
  return WppAutoLogTrace(a1, 5LL, 3LL, &WPP_cd889c5661493256fd20720ba3c49600_Traceguids, v7, (__int64 *)va);
}
