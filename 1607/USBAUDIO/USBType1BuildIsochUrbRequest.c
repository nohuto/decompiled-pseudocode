/*
 * XREFs of USBType1BuildIsochUrbRequest @ 0x1C0003F40
 * Callers:
 *     USBType1Build1MsecIsocRequest @ 0x1C00045D8 (USBType1Build1MsecIsocRequest.c)
 *     USBType1ProcessStreamPointer @ 0x1C0004774 (USBType1ProcessStreamPointer.c)
...
LABEL_30:
    ...
    v21 = (__int64 *)*((_QWORD *)&ListEntry.Next + 1);
    v22 = *(_QWORD *)(v14 + 24);
    v70 = v22;
    if ( **((_SLIST_ENTRY ***)&ListEntry.Next + 1) != &ListEntry )
      __fastfail(3u);
    *(_QWORD *)(v14 + 8) = *((_QWORD *)&ListEntry.Next + 1);
