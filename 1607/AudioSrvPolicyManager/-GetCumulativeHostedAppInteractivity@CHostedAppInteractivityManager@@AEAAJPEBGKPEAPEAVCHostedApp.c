/*
 * XREFs of ?GetCumulativeHostedAppInteractivity@CHostedAppInteractivityManager@@AEAAJPEBGKPEAPEAVCHostedAppInteractivity@@@Z @ 0x18001753C
 * Callers:
...
LABEL_10:
  ...
  result = CHostedAppInteractivity::CreateInstance(a2, a3, (unsigned __int16 ***)&v19);
  v18 = result;
  if ( (int)result >= 0 )
  {
    v18 = 0;
    try
    {
      ATL::CAtlList<CHostedAppInteractivity *,ATL::CElementTraits<CHostedAppInteractivity *>>::AddHead(v7, &v19);
    }
...
LABEL_12:
  ...
  if ( (int)result < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, &WPP_396aba38fe233c5efaf9c5dc644ed068_Traceguids, result);
      result = v18;
    }
