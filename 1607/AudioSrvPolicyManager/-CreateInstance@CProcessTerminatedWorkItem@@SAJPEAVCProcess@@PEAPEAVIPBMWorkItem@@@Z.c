/*
 * XREFs of ?CreateInstance@CProcessTerminatedWorkItem@@SAJPEAVCProcess@@PEAPEAVIPBMWorkItem@@@Z @ 0x1800210B0
 * Callers:
...
__int64 __fastcall CProcessTerminatedWorkItem::CreateInstance(struct CProcess *a1, struct IPBMWorkItem **a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x19u, &WPP_ad7b8a207b4c33c21ba4cfb512d2eba6_Traceguids, result);
    result = v10;
  }
