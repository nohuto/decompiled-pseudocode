/*
 * XREFs of ?CreateInstance@CStreamStoppedWorkItem@@SAJPEAUIAudioStreamInfo@@PEAPEAVIPBMWorkItem@@@Z @ 0x1800200D0
 * Callers:
...
__int64 __fastcall CStreamStoppedWorkItem::CreateInstance(struct IAudioStreamInfo *a1, struct IPBMWorkItem **a2)
{
  ...
  if ( v8 )
  {
    result = CStreamStoppedWorkItem::Initialize(v8, a1);
    v11 = result;
    if ( (int)result >= 0 )
    {
      *a2 = v8;
  ...
  if ( v8 )
  {
    (*(void (__fastcall **)(CStreamStoppedWorkItem *, __int64))(*(_QWORD *)v8 + 8LL))(v8, 1LL);
    result = v11;
  }
  if ( (int)result < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, &WPP_ad7b8a207b4c33c21ba4cfb512d2eba6_Traceguids, result);
      result = v11;
    }
