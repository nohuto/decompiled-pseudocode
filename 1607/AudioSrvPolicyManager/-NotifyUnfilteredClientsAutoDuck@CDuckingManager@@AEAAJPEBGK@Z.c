/*
 * XREFs of ?NotifyUnfilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBGK@Z @ 0x180007A40
 * Callers:
        ...
        int a3)
{
  ...
  if ( !v6 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Fu, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, a2);
    }
    v7 = -1LL;
    do
      ++v7;
