/*
 * XREFs of ?Initialize@CAppStateChangedWorkItem@@QEAAJPEBG@Z @ 0x180020A90
 * Callers:
...
__int64 __fastcall CAppStateChangedWorkItem::Initialize(CAppStateChangedWorkItem *this, const unsigned __int16 *a2)
{
  ...
  v2 = (unsigned __int16 **)((char *)this + 8);
  v10 = 0;
  v3 = -1LL;
  do
    ++v3;
  while ( a2[v3] );
  result = _AllocStringWorker<CTCoAllocPolicy>((__int64)v2, (__int64)a2, a2, v3, v8, v2);
  v10 = result;
  if ( (int)result < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_ad7b8a207b4c33c21ba4cfb512d2eba6_Traceguids, result);
      result = v10;
    }
