/*
 * XREFs of ??_G?$CGenericApplicationManagerWorkItem@USessionDisplayStateChangedContext@@@@UEAAPEAXI@Z @ 0x18001EF10
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *lpMem = &CGenericApplicationManagerWorkItem<SessionDisplayStateChangedContext>::`vftable';
