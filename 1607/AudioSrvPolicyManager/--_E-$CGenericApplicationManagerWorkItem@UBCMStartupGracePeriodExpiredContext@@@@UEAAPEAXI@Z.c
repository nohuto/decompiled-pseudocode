/*
 * XREFs of ??_E?$CGenericApplicationManagerWorkItem@UBCMStartupGracePeriodExpiredContext@@@@UEAAPEAXI@Z @ 0x1800109B0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *lpMem = &CGenericApplicationManagerWorkItem<BCMStartupGracePeriodExpiredContext>::`vftable';
