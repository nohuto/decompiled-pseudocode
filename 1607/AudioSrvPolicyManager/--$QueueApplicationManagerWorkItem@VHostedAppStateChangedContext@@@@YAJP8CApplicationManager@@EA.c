/*
 * XREFs of ??$QueueApplicationManagerWorkItem@VHostedAppStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAVHostedAppStateChangedContext@@@Z0@Z @ 0x1800179BC
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<HostedAppStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    *v4 = &CGenericApplicationManagerWorkItem<HostedAppStateChangedContext>::`vftable';
