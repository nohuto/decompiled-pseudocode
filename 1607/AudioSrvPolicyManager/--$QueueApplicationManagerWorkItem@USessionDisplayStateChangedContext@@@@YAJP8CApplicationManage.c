/*
 * XREFs of ??$QueueApplicationManagerWorkItem@USessionDisplayStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAUSessionDisplayStateChangedContext@@@Z0@Z @ 0x18001EE38
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<SessionDisplayStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    *v4 = &CGenericApplicationManagerWorkItem<SessionDisplayStateChangedContext>::`vftable';
