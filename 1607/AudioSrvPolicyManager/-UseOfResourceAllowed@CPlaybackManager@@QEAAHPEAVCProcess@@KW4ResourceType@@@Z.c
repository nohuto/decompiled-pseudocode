/*
 * XREFs of ?UseOfResourceAllowed@CPlaybackManager@@QEAAHPEAVCProcess@@KW4ResourceType@@@Z @ 0x18001830C
 * Callers:
 *     ?UseOfResourceAllowed@CProcess@@UEAAHKW4ResourceType@@@Z @ 0x18000E140 (-UseOfResourceAllowed@CProcess@@UEAAHKW4ResourceType@@@Z.c)
 * Callees:
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
  {
    ...
    WPP_SF_dSd(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0xFu,
      &WPP_9a8bf233b577350336875a646611b6e3_Traceguids,
      *((unsigned int *)a2 + 42),
      off_180028280[v5],
      pvData);
  }
