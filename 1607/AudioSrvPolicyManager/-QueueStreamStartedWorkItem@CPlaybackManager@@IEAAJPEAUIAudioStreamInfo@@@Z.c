/*
 * XREFs of ?QueueStreamStartedWorkItem@CPlaybackManager@@IEAAJPEAUIAudioStreamInfo@@@Z @ 0x180017F3C
 * Callers:
...
__int64 __fastcall CPlaybackManager::QueueStreamStartedWorkItem(CPlaybackManager *this, struct IAudioStreamInfo *a2)
{
  ...
  v9 = 0LL;
  result = CStreamStartedWorkItem::CreateInstance(a2, &v9);
  v5 = v9;
  v8 = result;
  if ( (int)result >= 0 )
  {
  ...
  if ( (int)result < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, &WPP_9a8bf233b577350336875a646611b6e3_Traceguids, result);
      result = v8;
    }
