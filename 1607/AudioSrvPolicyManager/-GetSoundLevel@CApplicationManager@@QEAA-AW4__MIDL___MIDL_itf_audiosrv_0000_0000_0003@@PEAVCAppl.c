/*
 * XREFs of ?GetSoundLevel@CApplicationManager@@QEAA?AW4__MIDL___MIDL_itf_audiosrv_0000_0000_0003@@PEAVCApplication@@@Z @ 0x18001461C
 * Callers:
...
__int64 __fastcall CApplicationManager::GetSoundLevel(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    if ( (unsigned int)CApplication::GetTotalActiveRenderStreamCount((CApplication *)a2) || *(_DWORD *)(a2 + 392) )
      goto LABEL_4;
