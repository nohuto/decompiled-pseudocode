/*
 * XREFs of ??_G?$CGenericApplicationManagerWorkItem@U_ActiveMediaAppsNotificationContext@@@@UEAAPEAXI@Z @ 0x18001EFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *lpMem = &CGenericApplicationManagerWorkItem<_ActiveMediaAppsNotificationContext>::`vftable';
