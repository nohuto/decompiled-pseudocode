/*
 * XREFs of ??_G?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x180003588
 * Callers:
 ...
 *     ??1ThreadLocalData@details_abi@wil@@QEAA@XZ @ 0x180002B78 (--1ThreadLocalData@details_abi@wil@@QEAA@XZ.c)
 */
        ...
        _QWORD *a1)
{
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x623, v11, v12);
    __debugbreak();
  }
  v13 = (void *)a1[1];
  if ( v13 && !CloseHandle(v13) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x623, v14, v15);
    JUMPOUT(0x18000366DLL);
  }
  return a1;
}
