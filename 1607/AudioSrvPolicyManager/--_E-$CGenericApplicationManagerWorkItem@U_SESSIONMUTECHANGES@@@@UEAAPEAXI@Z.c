/*
 * XREFs of ??_E?$CGenericApplicationManagerWorkItem@U_SESSIONMUTECHANGES@@@@UEAAPEAXI@Z @ 0x18001F070
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *lpMem = &CGenericApplicationManagerWorkItem<_SESSIONMUTECHANGES>::`vftable';
