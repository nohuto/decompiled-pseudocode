/*
 * XREFs of ??$QueueApplicationManagerWorkItem@U_CastingAppStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAU_CastingAppStateChangedContext@@@Z0@Z @ 0x1800195E8
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<_CastingAppStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    *v4 = &CGenericApplicationManagerWorkItem<_CastingAppStateChangedContext>::`vftable';
