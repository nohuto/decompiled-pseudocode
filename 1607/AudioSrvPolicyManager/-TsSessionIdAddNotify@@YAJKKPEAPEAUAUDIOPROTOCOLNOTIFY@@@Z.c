/*
 * XREFs of ?TsSessionIdAddNotify@@YAJKKPEAPEAUAUDIOPROTOCOLNOTIFY@@@Z @ 0x18001C594
 * Callers:
...
__int64 __fastcall TsSessionIdAddNotify(DWORD SessionId, int a2, struct AUDIOPROTOCOLNOTIFY **a3)
{
  ...
  __int64 v15; // rax
  HANDLE v16; // rax
  struct TSSession *v18; // [rsp+48h] [rbp+20h] BYREF
  ...
  if ( !v7 )
    goto LABEL_11;
  *(_DWORD *)v7 = a2;
  v9 = TsSessionFromSessionId(SessionId, 1, 0LL, &v18);
  if ( v9 )
    goto LABEL_12;
  v10 = v18;
  v11 = GetProcessHeap();
