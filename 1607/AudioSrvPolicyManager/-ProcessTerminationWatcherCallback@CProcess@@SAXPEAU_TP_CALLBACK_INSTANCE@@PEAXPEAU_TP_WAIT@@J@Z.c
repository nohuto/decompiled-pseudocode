/*
 * XREFs of ?ProcessTerminationWatcherCallback@CProcess@@SAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x18000FC30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TP_WAIT *a3)
{
  ...
  v3 = CProcessTerminatedWorkItem::CreateInstance((struct CProcess *)a2, &v11);
  v6 = v11;
  v9 = v3;
  if ( v3 >= 0 )
  {
  ...
  if ( v3 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, &WPP_5f6cc46befba39241e72a8abc69dfa61_Traceguids, v3);
    }
