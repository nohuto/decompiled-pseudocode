/*
 * XREFs of ?TS_SessionIdStreamStopped@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x18001E348
 * Callers:
...
__int64 __fastcall TS_SessionIdStreamStopped(DWORD SessionId, struct IAudioStreamInfo *a2, const unsigned __int16 *a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_e3e7735b747b3b21be9d3d9ebc03ddc3_Traceguids, SessionId);
  }
  ...
  else
  {
    v8 = *((_QWORD *)v14 + 39);
    if ( v8 )
      v13 = (*(__int64 (__fastcall **)(__int64, struct IAudioStreamInfo *, const unsigned __int16 *))(*(_QWORD *)v8 + 32LL))(
              v8,
              a2,
              a3);
  }
  ...
  if ( (v13 & 0x80000000) != 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x29u, &WPP_e3e7735b747b3b21be9d3d9ebc03ddc3_Traceguids, v13);
      result = v13;
    }
