/*
 * XREFs of ?Create@CWindowsPolicyManager@@SAJPEAPEAV1@@Z @ 0x180004084
 * Callers:
 *     ActivatePolicyManager @ 0x180003B50 (ActivatePolicyManager.c)
 * Callees:
...
__int64 __fastcall CWindowsPolicyManager::Create(struct CWindowsPolicyManager **a1)
{
  ...
  v3 = (struct CWindowsPolicyManager *)HeapAlloc(ProcessHeap, 0, 0x38uLL);
  v4 = v3;
  if ( v3 )
  {
    *((_DWORD *)v3 + 6) = 1;
