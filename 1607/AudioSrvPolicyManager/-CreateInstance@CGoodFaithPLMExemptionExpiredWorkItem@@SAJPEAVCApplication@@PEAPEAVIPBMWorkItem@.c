/*
 * XREFs of ?CreateInstance@CGoodFaithPLMExemptionExpiredWorkItem@@SAJPEAVCApplication@@PEAPEAVIPBMWorkItem@@@Z @ 0x180021288
 * Callers:
        ...
        struct IPBMWorkItem **a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, &WPP_ad7b8a207b4c33c21ba4cfb512d2eba6_Traceguids, result);
    result = v10;
  }
