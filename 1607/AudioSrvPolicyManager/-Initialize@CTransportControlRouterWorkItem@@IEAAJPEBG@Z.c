/*
 * XREFs of ?Initialize@CTransportControlRouterWorkItem@@IEAAJPEBG@Z @ 0x1800216B4
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( (int)result < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, &WPP_ad7b8a207b4c33c21ba4cfb512d2eba6_Traceguids, result);
        result = v10;
      }
