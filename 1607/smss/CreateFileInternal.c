/*
 * XREFs of CreateFileInternal @ 0x140014BEC
 * Callers:
 *     CreateFileW @ 0x1400150F4 (CreateFileW.c)
 * Callees:
...
__int64 __fastcall CreateFileInternal(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  ULONG DestinationString; // [rsp+70h] [rbp-98h] BYREF
  int DestinationString_4; // [rsp+74h] [rbp-94h]
...
LABEL_15:
  ...
  if ( DestinationString_8.Length <= 1u || (v27 = 1, aMountpointmana[(DestinationString_8.Length >> 1) - 1] != 92) )
    v27 = 0;
  CreateOptions = 0;
...
LABEL_23:
  ...
  if ( a5 )
  {
    ...
    if ( (unsigned __int64)(v19 - 1) <= 0xFFFFFFFFFFFFFFFDuLL
      && NtQueryInformationFile(v19, &IoStatusBlock, &DestinationString, 4u, FileEaInformation) >= 0 )
    {
