/*
 * XREFs of SmpTranslateSystemPartitionInformation @ 0x140005400
 * Callers:
...
int SmpTranslateSystemPartitionInformation()
{
  ...
  const wchar_t *v12; // [rsp+A8h] [rbp-58h]
  ...
  const wchar_t *v17; // [rsp+E8h] [rbp-18h]
  struct _UNICODE_STRING v18; // [rsp+F0h] [rbp-10h] BYREF
  ...
  v11 = 4063292;
  v12 = L"\\Registry\\Machine\\System\\Setup";
  ...
  *(_DWORD *)&String2.Length = 1703960;
  ...
  v16 = 8650882;
  v18.Buffer = L"BootDir";
  *(_DWORD *)&v18.Length = 1048590;
...
LABEL_19:
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( result >= 0 )
      {
        Data[0] = *(_DWORD *)i;
        Data[1] = 92;
        NtSetValueKey(KeyHandle, &v18, 0, 1u, Data, 8u);
