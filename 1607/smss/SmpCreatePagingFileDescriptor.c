/*
 * XREFs of SmpCreatePagingFileDescriptor @ 0x140009D00
 * Callers:
 *     SmpCreatePagingFiles @ 0x1400099F0 (SmpCreatePagingFiles.c)
 * Callees:
 *     SmpParseCommandLine @ 0x1400020D0 (SmpParseCommandLine.c)
 *     SmpParseSwapOrPageFileArguments @ 0x140009E70 (SmpParseSwapOrPageFileArguments.c)
 */
...
__int64 __fastcall SmpCreatePagingFileDescriptor(__int128 *a1)
{
  ...
  if ( v2 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v11) = 972;
  ...
  if ( v4 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v12) = 1010;
...
LABEL_16:
  ...
  *(_WORD *)(v6[3] + 8LL) = v8;
  ...
  {
    v9 = (_QWORD *)qword_140025D58;
    if ( *(PVOID **)qword_140025D58 != &SmpPagingFileDescriptorList )
      __fastfail(3u);
    *v6 = &SmpPagingFileDescriptorList;
    v6[1] = v9;
    *v9 = v6;
    qword_140025D58 = (__int64)v6;
  }
