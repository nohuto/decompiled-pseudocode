 ...
 *     SmpReadyBootSync @ 0x140007DC0 (SmpReadyBootSync.c)
 *     SmpInit @ 0x14000A460 (SmpInit.c)
 *     SmpGetCoreProcessIds @ 0x14000C2E4 (SmpGetCoreProcessIds.c)
  ...
  if ( a1 <= 1 )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        xmmword_140025588 = 0LL;
        qword_140025598 = 0LL;
        xmmword_1400255A0 = 0LL;
        qword_1400255B0 = 0LL;
        dword_1400255B8 = 0;
        dword_1400255BC = 1;
        dword_1400255C0 = 72;
        *(_QWORD *)&xmmword_140025588 = v43;
        v20 = SmpInit();
