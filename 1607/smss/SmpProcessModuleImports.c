/*
 * XREFs of SmpProcessModuleImports @ 0x140008BD0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall SmpProcessModuleImports(__int64 *a1, const char *a2)
{
  ...
  const WCHAR *v40; // [rsp+60h] [rbp-A0h]
  ...
  *(_DWORD *)&v38.Length = 34209792;
  v38.Buffer = (PWSTR)&v43;
  result = RtlAnsiStringToUnicodeString(&v38, &DestinationString, 0);
  if ( result < 0 )
    return result;
  v5 = *v3;
  ...
  if ( v38.Length < 8u )
    goto LABEL_31;
  v9 = *(_QWORD *)v38.Buffer & 0xFFFFFFDFFFDFFFDFuLL;
  if ( v9 != 0x2D004900500041LL && v9 != 0x2D005400580045LL )
    goto LABEL_31;
  v10 = v38.Length;
  v11 = (PWSTR)((char *)v38.Buffer + v38.Length);
  if ( v38.Length > 1u )
  {
    do
    {
...
LABEL_18:
  ...
  if ( !v22 )
    goto LABEL_30;
  if ( RtlCompareUnicodeStrings(v38.Buffer, v12, (PCWCH)((char *)v6 + v22[1]), v22[3] >> 1, 1u) )
    goto LABEL_29;
...
LABEL_50:
    ...
    return SmpSaveRegistryValue_U(v3[1], v26, &v38, 1LL, 0LL);
  }
  v27 = v23 - 1;
  v28 = 1;
