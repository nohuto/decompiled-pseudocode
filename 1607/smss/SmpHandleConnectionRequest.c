/*
 * XREFs of SmpHandleConnectionRequest @ 0x140003F40
 * Callers:
 ...
 *     SmpAddKnownSubSys @ 0x140004A80 (SmpAddKnownSubSys.c)
 *     SmpCreateKnownSubSys @ 0x140004AC0 (SmpCreateKnownSubSys.c)
...
char __fastcall SmpHandleConnectionRequest(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  else
  {
    ...
    if ( v13 )
    {
      ...
      v32 = v39;
      SmpWaitForSubSysStartup(v12, 1u, 0LL, (__int64)v39);
