/*
 * XREFs of SmpUpdatePagefileUsageCallback @ 0x140010580
 * Callers:
 *     <none>
 * Callees:
...
char SmpUpdatePagefileUsageCallback()
{
  ...
  v0 = SmpMemorySize / (unsigned __int64)(unsigned int)dword_140025A88;
    ...
    if ( (int)Heap >= 0 )
    {
      ...
      for ( i = 256LL; ; i = ReturnLength )
      {
        ...
        if ( v5 >= 0 )
        {
          ...
          v10 = v7 + v22;
          v11 = 10 * v2 / 9;
          v12 = 0x400000000uLL / (unsigned int)dword_140025A88;
          if ( v11 > v12 + v2 )
            v11 = v12 + v2;
          if ( v11 > v0 )
          {
          ...
          if ( v10 > 0xFFFFFFFF )
            LODWORD(v10) = -1;
          dword_140025DD4[(unsigned int)Data % 0xF0] = v10;
          v14 = 7;
          LODWORD(Data) = Data + 1;
          v15 = SmpPagefileUsage + 1;
          SmpPagefileUsage = v15;
          LOBYTE(Heap) = v15 - 1;
