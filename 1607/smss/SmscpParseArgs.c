/*
 * XREFs of SmscpParseArgs @ 0x140002BA4
 * Callers:
 *     SmscMain @ 0x140001A14 (SmscMain.c)
 * Callees:
 *     SmpGetFirstSessionId @ 0x140002E24 (SmpGetFirstSessionId.c)
 *     SmscpSetupSharedSpace @ 0x140002E50 (SmscpSetupSharedSpace.c)
 *     SmscpIsDebuggerPresent @ 0x140013C20 (SmscpIsDebuggerPresent.c)
 */
...
__int64 __fastcall SmscpParseArgs(unsigned int a1, __int64 a2, int *a3, struct _UNICODE_STRING *a4)
{
  ...
  *a3 = 0;
  ...
  if ( (int)result >= 0 )
  {
    v12 = *(_DWORD *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 704LL) == (unsigned int)SmpGetFirstSessionId();
    *a3 &= ~8u;
    *a3 |= 8 * v12;
        ...
        if ( Heap )
        {
          ...
          *Heap = 0;
          ...
          if ( (*(_BYTE *)a3 & 1) == 0 )
          {
            ...
            v19 = a4;
            if ( (*(_BYTE *)a3 & 8) == 0 )
              v18 = (const UNICODE_STRING *)&SmscpInitExecuteCmd;
            goto LABEL_16;
          }
...
LABEL_14:
              ...
              && (SystemInformation[0] & 0x4000004) != 0 )
            {
              ...
              {
                RtlAppendUnicodeStringToString(a4, &stru_140017BE0);
                v30 = SystemInformation[0];
                if ( (SystemInformation[0] & 0x20000) != 0 )
                {
                  RtlAppendUnicodeStringToString(a4, &stru_140017BD0);
                  v30 = SystemInformation[0];
                }
                if ( (v30 & 0x4000000) != 0 )
                  RtlAppendUnicodeStringToString(a4, &stru_140017BC0);
              }
            }
LABEL_15:
            v18 = v4;
