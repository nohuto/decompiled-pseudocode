/*
 * XREFs of RaidSyncAcpiEvalMethod @ 0x1C0019A10
 * Callers:
...
LABEL_9:
  ...
  if ( !v11 )
  {
    ...
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_a0aaf6c2955e31bbd69faa467326e0b4_Traceguids, DeviceObject);
    }
    Status = -1073741670;
    goto LABEL_9;
  }
