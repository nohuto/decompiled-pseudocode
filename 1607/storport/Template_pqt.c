/*
 * XREFs of Template_pqt @ 0x1C0032A9C
 * Callers:
 *     StorPortAdapterPowerNotRequiredStep2 @ 0x1C0019C50 (StorPortAdapterPowerNotRequiredStep2.c)
 *     StorPortAdapterPoFxD0Completion @ 0x1C00318C0 (StorPortAdapterPoFxD0Completion.c)
 *     StorPortAdapterPowerRequiredStep2 @ 0x1C0031AD8 (StorPortAdapterPowerRequiredStep2.c)
 * Callees:
