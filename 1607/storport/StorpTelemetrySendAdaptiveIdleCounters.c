/*
 * XREFs of StorpTelemetrySendAdaptiveIdleCounters @ 0x1C004005C
 * Callers:
...
void __fastcall StorpTelemetrySendAdaptiveIdleCounters(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    ...
    if ( (v2 & 0x80u) != 0 && (v2 & 0x100) != 0 )
    {
      ...
      v3 = MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 2544);
      if ( v3 > 0 )
      ...
      if ( (unsigned int)dword_1C004F010 > 5 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)v3, 0x400000000000uLL) )
        {
          ...
          v39 = 4LL;
          v41 = 4LL;
          TlgWrite((TraceLoggingHProvider)v13, &unk_1C0047DD3, (LPCGUID)v6, v4, 0xDu, &pData);
        }
      }
    }
