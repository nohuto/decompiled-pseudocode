/*
 * XREFs of RaidAdapterSetSystemPowerCompletion @ 0x1C000B190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 42LL, &WPP_a3dcb199dfb635f773f8f8e69f1de7fa_Traceguids, v2, a2);
    v5 = WPP_GLOBAL_Control;
  }
  v6 = *(_QWORD *)(a2 + 184);
  v7 = *(int *)(v6 + 24);
...
LABEL_6:
  ...
  if ( v5 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v5->Timer) & 4) != 0 && BYTE1(v5->Timer) >= 4u )
    WPP_SF_qqD(v5->AttachedDevice, 43LL, &WPP_a3dcb199dfb635f773f8f8e69f1de7fa_Traceguids, v2, a2, v11);
