/*
 * XREFs of RaidAdapterSetSystemPowerIrp @ 0x1C000B2F4
 * Callers:
...
__int64 __fastcall RaidAdapterSetSystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 38LL, &WPP_a3dcb199dfb635f773f8f8e69f1de7fa_Traceguids, a1, a2);
  }
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.QueryDeviceRelations + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.QueryDeviceRelations
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 39LL, &WPP_a3dcb199dfb635f773f8f8e69f1de7fa_Traceguids, a1, a2, 259);
  }
  return 259LL;
}
