/*
 * XREFs of RaSqmLogAdapterStatistics @ 0x1C002B738
 * Callers:
 ...
 *     StorSqmCreateStringStreamEntry @ 0x1C0044DA4 (StorSqmCreateStringStreamEntry.c)
 */
...
void RaSqmLogAdapterStatistics()
{
  ...
  if ( PortData )
  {
    ...
    v2 = v1 + 8;
    for ( i = (_QWORD *)*((_QWORD *)v1 + 1); i != v2; i = (_QWORD *)*i )
    {
