/*
 * XREFs of RaidUnitSetPowerIrp @ 0x1C000A288
 * Callers:
...
LABEL_8:
    if ( v6 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v6->Timer) & 4) != 0 && BYTE1(v6->Timer) >= 4u )
      WPP_SF_qqDD(v6->AttachedDevice, 49LL, &WPP_a3dcb199dfb635f773f8f8e69f1de7fa_Traceguids, Context, Irp, Options, v8);
    return v8;
  }
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 47LL, &WPP_a3dcb199dfb635f773f8f8e69f1de7fa_Traceguids, Context, Irp);
  }
  return v8;
}
