/*
 * XREFs of RaWmiPassToMiniPort @ 0x1C005B544
 * Callers:
 *     RaWmiIrpRegisterRequest @ 0x1C005B37C (RaWmiIrpRegisterRequest.c)
 *     RaWmiIrpNormalRequest @ 0x1C005FB5C (RaWmiIrpNormalRequest.c)
 * Callees:
...
__int64 __fastcall RaWmiPassToMiniPort(__int64 a1, char a2, __int64 a3)
{
  ...
  *(_QWORD *)(v8 + 168) = Srb;
  v15 = RaidBuildMdlForXrb(v8, *(void **)(a3 + 24), v9);
  if ( v15 < 0 )
  {
LABEL_42:
    *(_DWORD *)(a3 + 16) = 0;
  ...
  RaSrbSetMiniportContext(v3, (__int64)Srb, (__int64)BaseAddress + 1056);
  v20 = *(_QWORD *)(a1 + 64);
  if ( *(_DWORD *)v20 == v19 )
  {
    v21 = *(_BYTE *)(v20 + 88);
...
LABEL_81:
  ...
  if ( v39 )
  {
    if ( (*(_BYTE *)(v8 + 17) & 2) != 0 )
    {
      RaidUnitPoFxIdleComponentFromMiniport(v39, *(_DWORD *)(v8 + 748));
      *(_BYTE *)(v8 + 17) &= ~2u;
    }
