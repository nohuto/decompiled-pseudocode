/*
 * XREFs of RaidUnitPendingDpcRoutine @ 0x1C00094B0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v11 != -1 )
      {
        ...
        if ( !v11 || v11 < (unsigned int)v10 )
        {
          ...
          *(_BYTE *)(v4 + 154) |= 2u;
          ...
          WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 65LL, &WPP_a0aaf6c2955e31bbd69faa467326e0b4_Traceguids, v4);
        }
      }
    }
  }
...
LABEL_31:
  ...
  else if ( v6 )
  {
    if ( v15 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v15->Timer) & 8) != 0 && BYTE1(v15->Timer) >= 2u )
      WPP_SF_q(v15->AttachedDevice, 66LL, &WPP_a0aaf6c2955e31bbd69faa467326e0b4_Traceguids, v4);
