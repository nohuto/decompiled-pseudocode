/*
 * XREFs of Template_qcccqqq @ 0x1C0032EB0
 * Callers:
...
NTSTATUS __fastcall Template_qcccqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v21 = 4LL;
  v23 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventUnitPowerCycleCount, 0LL, 7u, &UserData);
}
