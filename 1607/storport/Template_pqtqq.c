/*
 * XREFs of Template_pqtqq @ 0x1C002A9F4
 * Callers:
...
NTSTATUS Template_pqtqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 4LL;
  v12 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventAdapterPoFxRegistered, 0LL, 5u, &UserData);
}
