/*
 * XREFs of StorpTelemetryDeviceStatisticsCommand @ 0x1C003DAD4
 * Callers:
 ...
 *     SendAtaPassthrough @ 0x1C003BDB8 (SendAtaPassthrough.c)
 */
...
__int64 __fastcall StorpTelemetryDeviceStatisticsCommand(__int64 a1, __int64 a2, char a3)
{
  ...
  *(_DWORD *)&InputBuffer[44] = 3137536;
  v8 = SendAtaPassthrough(v6, InputBuffer, v7, InputBuffer, v10, v11, &v12);
  if ( v8 >= 0 )
  {
