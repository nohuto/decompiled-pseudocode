/*
 * XREFs of WPP_SF_qqddds @ 0x1C002B484
 * Callers:
 *     RaidBusEnumeratorProcessModifiedNodes @ 0x1C0010690 (RaidBusEnumeratorProcessModifiedNodes.c)
 * Callees:
...
__int64 WPP_SF_qqddds(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  if ( v17 )
    v5 = v17;
  return ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, const char *, __int64, _QWORD))pfnWppTraceMessage)(
           a1,
           43LL,
