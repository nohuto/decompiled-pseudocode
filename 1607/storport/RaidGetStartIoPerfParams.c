/*
 * XREFs of RaidGetStartIoPerfParams @ 0x1C0018AE0
 * Callers:
...
__int64 __fastcall RaidGetStartIoPerfParams(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4)
{
  ...
  if ( !v5 )
  {
    ...
    v11 = 39LL;
LABEL_22:
    WPP_SF_(v10->AttachedDevice, v11, &WPP_222db84838ff3f85fffe5432ece91366_Traceguids, a4);
    return 3238002694LL;
  }
  v6 = *(_DWORD *)(v5 + 18);
  ...
  if ( (*(_BYTE *)(v4 + 4740) & 2) == 0
    ...
    || (v12 = *(unsigned __int8 *)(((unsigned __int16)v6 << 6) + BYTE2(v6) + *(_QWORD *)(v4 + 4760)),
        a3[2] = v12,
        v12 == 255) )
  {
    a3[2] = 0;
