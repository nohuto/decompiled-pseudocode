/*
 * XREFs of RaidAdapterHwFirmwareGetInfoIoctl @ 0x1C00272F4
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C0033F3C (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
 */
...
LABEL_5:
    ...
    InfoFromMiniport = RaidAdapterHwFirmwareGetInfoFromMiniport((__int64)a1, (__int64)a2, (__int64)P, v10);
