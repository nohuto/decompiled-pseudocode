/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C00184CC
 * Callers:
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, IRP *a2)
{
  ...
  _IRP *v31; // [rsp+A8h] [rbp+10h]
  PVOID BaseAddress; // [rsp+B0h] [rbp+18h]
  _BYTE *v33; // [rsp+B8h] [rbp+20h]
  ...
  *v6 = 7340288;
  v6[14] = v31->AssociatedIrp.IrpCount;
...
LABEL_45:
    ...
    *(_QWORD *)(v7 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 38LL, &WPP_a0aaf6c2955e31bbd69faa467326e0b4_Traceguids, v7, Srb);
    }
    if ( *(_BYTE *)(v2 + 4450) )
...
LABEL_37:
    ...
    if ( p_Process )
    {
      ...
      if ( v24 )
      {
        v28[0] = *(_QWORD *)(p_Process + 168);
        v25 = *(_QWORD *)(p_Process + 176);
        v29 = v24;
        v28[1] = v25;
        StorFreeContiguousMemory(v22, v28);
      }
    }
    ...
    if ( BaseAddress )
    {
      RaidXrbDeallocateResources(v7, 0, v26);
