/*
 * XREFs of RaInitializeDriver @ 0x1C0057AE4
 * Callers:
 *     StorPortInitialize @ 0x1C000D300 (StorPortInitialize.c)
 * Callees:
 *     StorSqmInitialize @ 0x1C000CB48 (StorSqmInitialize.c)
 *     McGenEventRegister @ 0x1C000CBDC (McGenEventRegister.c)
 *     RaidAddPortDriver @ 0x1C000D528 (RaidAddPortDriver.c)
...
__int64 __fastcall RaInitializeDriver(__int64 a1, _QWORD *a2, __int64 a3, const UNICODE_STRING *a4)
{
  ...
  if ( _InterlockedIncrement(&g_RaidSQMAndETWRefCount) == 1 )
  {
    if ( (int)StorSqmInitialize() >= 0 )
    {
      ...
      KeInitializeTimer((PKTIMER)&WPP_MAIN_CB.Reserved);
      KeInitializeDpc((PRKDPC)&WPP_MAIN_CB.Dpc.DpcData, (PKDEFERRED_ROUTINE)RaSqmTimerDpc, 0LL);
      KeSetCoalescableTimer(
        (PKTIMER)&WPP_MAIN_CB.Reserved,
        (LARGE_INTEGER)-3000000000LL,
        0,
        0xEA60u,
        (PKDPC)&WPP_MAIN_CB.Dpc.DpcData);
    }
