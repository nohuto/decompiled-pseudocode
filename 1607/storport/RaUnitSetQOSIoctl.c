/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C0035904
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C0001D30 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C0026FB8 (RaidAdapterEnableQosWaitTimeoutCheck.c)
...
__int64 __fastcall RaUnitSetQOSIoctl(__int64 a1, IRP *a2)
{
  ...
  if ( v6 && (*v6 & 0x1F) != 0 )
  {
    ...
    v8 = 46;
LABEL_83:
    WPP_SF_q((__int64)v7->AttachedDevice, v8, (__int64)&WPP_a0aaf6c2955e31bbd69faa467326e0b4_Traceguids, a1);
LABEL_84:
    v5 = -1073741637;
    goto LABEL_85;
  }
...
LABEL_32:
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v16 = 52;
LABEL_77:
    WPP_SF_q((__int64)v15->AttachedDevice, v16, (__int64)&WPP_a0aaf6c2955e31bbd69faa467326e0b4_Traceguids, a1);
LABEL_78:
    v5 = -1073741811;
    goto LABEL_85;
  }
  ...
  *(_DWORD *)(a1 + 2556) = HIDWORD(MasterIrp->MdlAddress);
  *(_DWORD *)(a1 + 2568) = *(&MasterIrp->Flags + 1) / 0x3E8;
  v18 = MasterIrp->Flags;
  if ( v18 == -1 )
    *(_DWORD *)(a1 + 2576) = -1;
  else
    *(_DWORD *)(a1 + 2576) = v18 / 0x1F4;
  *(_DWORD *)(a1 + 2572) = MasterIrp->AssociatedIrp.IrpCount / 0x3E8u;
  *(_DWORD *)(a1 + 2564) = MasterIrp->ThreadListEntry.Flink;
  v19 = HIDWORD(MasterIrp->AssociatedIrp.SystemBuffer);
  if ( v19 == -1 )
    *(_DWORD *)(a1 + 2560) = -1;
  else
    *(_DWORD *)(a1 + 2560) = v19 / 0x1F4;
  if ( *(_DWORD *)(a1 + 2576) == -1 && !*(_DWORD *)(a1 + 2564) && *(_DWORD *)(a1 + 2560) == -1 )
  {
    RaidUnitDisableWaitCheckTimer(a1);
  }
  else if ( !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 2584), 1, 0) )
  {
    RaidAdapterEnableQosWaitTimeoutCheck(*(_QWORD *)(a1 + 24));
  }
  v20 = 10000000 * (*(_DWORD *)(a1 + 2568) + 1 + ((unsigned int)(*(_DWORD *)(a1 + 2560) + *(_DWORD *)(a1 + 2576)) >> 1));
