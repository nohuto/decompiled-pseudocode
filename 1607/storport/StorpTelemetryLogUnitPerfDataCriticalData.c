/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C003EB10
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1, __int64 a2)
{
  __int64 v4; // rcx
  __int64 v5; // r8
  const WCHAR *v6; // r9
  ...
  if ( (unsigned int)dword_1C004F010 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x800000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = v12 / 0x2710;
      ...
      v81 = v10;
      v83 = 0;
      TlgWrite(&hProvider, &unk_1C0047399, v16, v17, 0x1Eu, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAny);
    }
  }
}
