/*
 * XREFs of StorpCSExitTelemetry @ 0x1C003C4D8
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 5088) )
    {
      ...
      if ( (unsigned int)dword_1C004F010 > 5 && TlgKeywordOn(v6, 0x400000000000uLL) )
      {
        v25 = *(_DWORD *)(a1 + 56);
        v10 = *(_QWORD *)(v9 + 8);
        v44 = v8;
        ...
        v126 = 8LL;
        v128 = 4LL;
        TlgWrite(v11, &unk_1C0047997, v7, v8, 0x11u, &pData);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 120); i != (__int64 *)(a1 + 120); i = (__int64 *)*i )
    {
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 6)) )
      {
        v13 = i[209];
        if ( v13 )
          i[210] += (v2 - v13) / 0x2710uLL;
        v14 = i[211];
        if ( v14 )
          i[212] += (v2 - v14) / 0x2710uLL;
        v15 = (const struct _TlgProvider_t *)i[208];
        if ( v15 )
