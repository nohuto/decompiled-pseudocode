/*
 * XREFs of Template_pqqcccqpp @ 0x1C002FF00
 * Callers:
...
NTSTATUS Template_pqqcccqpp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 8LL;
  v20 = 8LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventStateChangeDetected, a3, 9u, &UserData);
}
