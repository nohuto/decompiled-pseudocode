/*
 * XREFs of RaidBusEnumeratorGetLunList @ 0x1C00123A0
 * Callers:
...
__int64 __fastcall RaidBusEnumeratorGetLunList(__int64 a1, unsigned int a2, _QWORD *a3)
{
  ...
  struct _KLOCK_QUEUE_HANDLE v21; // [rsp+38h] [rbp-B0h] BYREF
...
LABEL_11:
      ...
      if ( UnitAtDirql )
        goto LABEL_20;
      v14 = *(_QWORD *)a1;
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)a1 + 192LL), &v21);
      v15 = (_QWORD *)(v14 + 200);
      v16 = (_QWORD *)*v15;
      if ( (_QWORD *)*v15 == v15 )
        goto LABEL_15;
