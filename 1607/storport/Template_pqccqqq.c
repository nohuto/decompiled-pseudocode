/*
 * XREFs of Template_pqccqqq @ 0x1C002BFFC
 * Callers:
...
NTSTATUS Template_pqccqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v15 = 4LL;
  v17 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &LunQueue, a3, 7u, &UserData);
}
