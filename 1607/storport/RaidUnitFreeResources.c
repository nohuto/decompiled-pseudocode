/*
 * XREFs of RaidUnitFreeResources @ 0x1C0014E08
 * Callers:
 ...
 *     StorpUninititalizePerUnitPerfTelemetry @ 0x1C0041F18 (StorpUninititalizePerUnitPerfTelemetry.c)
 *     RaDeleteTagList @ 0x1C005A774 (RaDeleteTagList.c)
 */
...
__int64 __fastcall RaidUnitFreeResources(__int64 a1)
{
  ...
  v8 = *(struct _IO_WORKITEM **)(a1 + 1560);
  if ( v8 )
  {
    IoFreeWorkItem(v8);
    *(_QWORD *)(a1 + 1560) = 0LL;
  }
  v9 = *(struct _IO_WORKITEM **)(a1 + 1576);
  if ( v9 )
  {
    IoFreeWorkItem(v9);
    *(_QWORD *)(a1 + 1576) = 0LL;
  }
  v10 = *(struct _IO_WORKITEM **)(a1 + 1600);
  if ( v10 )
  {
    IoFreeWorkItem(v10);
    *(_QWORD *)(a1 + 1600) = 0LL;
  ...
  if ( v11 )
  {
    if ( *(_QWORD *)(v11 + 5088) )
    {
      ...
      if ( (v15 & 8) != 0 )
      {
        *(_BYTE *)(a1 + 153) = v15 & 0xF7;
        RaidAdapterPoFxIdleComponent(v11, 0LL, 0LL);
      }
    }
  }
  v12 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(a1 + 1448);
  if ( v12 )
  {
