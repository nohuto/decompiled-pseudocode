/*
 * XREFs of RaUnitStorageDiagnosticIoctl @ 0x1C005F2E0
 * Callers:
 ...
 *     RaidCallerIsAdmin @ 0x1C0034300 (RaidCallerIsAdmin.c)
 */
  ...
  *v31 = v18;
  ...
  if ( Srb )
  {
    ContiguousIoResources = StorAllocateContiguousIoResources(
                              ((*(_DWORD *)(v29 + 444) + 7) & 0xFFFFFFF8) + 1056,
                              v21,
                              (_QWORD *)v29);
    ...
    if ( ContiguousIoResources )
    {
      ...
      *(_QWORD *)(v8 + 168) = Srb;
      ...
      v9 = BaseAddress;
      RaSrbSetMiniportContext(v29, (__int64)Srb, (__int64)BaseAddress + 1056);
