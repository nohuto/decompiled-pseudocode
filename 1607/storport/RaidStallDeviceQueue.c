/*
 * XREFs of RaidStallDeviceQueue @ 0x1C000BF84
 * Callers:
...
void __fastcall RaidStallDeviceQueue(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  {
    WPP_SF_DD(WPP_GLOBAL_Control->AttachedDevice, 11LL, &WPP_853dacc0765f33640d40b8b391c2a4b7_Traceguids, a2, a3);
  }
  if ( a2 && a3 )
  {
    ...
    if ( *(int *)(a1 + 28) > 0 || *(_DWORD *)(a1 + 32) || (v10 = *(_DWORD *)(a1 + 76), v10 >= *(_DWORD *)(a1 + 4)) )
    {
      ...
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
      {
        WPP_SF_DD(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_853dacc0765f33640d40b8b391c2a4b7_Traceguids, a2, a3);
      }
    }
    else
    {
        ...
        if ( (qword_1C004F2A0 & 0x200) != 0 )
          DbgLogRequest(
            *(_QWORD *)(a4 + 24),
            4,
            (_DWORD)retaddr,
            BYTE2(v13) | ((BYTE1(v13) | (((unsigned __int8)v13 | (v12 << 8)) << 8)) << 8),
            *(int *)(a4 + 428),
            0LL,
            0LL);
      }
      else if ( a2 == 2 && v10 > 0 )
      {
        ...
        *(_DWORD *)(a1 + 32) = v14;
        ...
        {
          WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 13LL, &WPP_853dacc0765f33640d40b8b391c2a4b7_Traceguids, v14);
        }
      }
      ...
      if ( a2 == 1 )
      {
        if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
        {
          WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_853dacc0765f33640d40b8b391c2a4b7_Traceguids, a3);
        }
