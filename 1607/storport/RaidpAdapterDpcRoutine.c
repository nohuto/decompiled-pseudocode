/*
 * XREFs of RaidpAdapterDpcRoutine @ 0x1C0005F40
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  LARGE_INTEGER v28; // [rsp+70h] [rbp-68h]
  union _LARGE_INTEGER PerformanceFrequency; // [rsp+78h] [rbp-60h] BYREF
  unsigned __int64 v30; // [rsp+80h] [rbp-58h]
...
LABEL_17:
  ...
  v26 = MEMORY[0xFFFFF78000000320] - v30;
  if ( (unsigned int)(MEMORY[0xFFFFF78000000320] - v30) > *(_DWORD *)(v4 + 4792) )
  {
    *(_DWORD *)(v4 + 4792) = v26;
    *(_DWORD *)(v4 + 4796) = v6;
  }
  if ( v6 > *(_DWORD *)(v4 + 4788) )
    *(_DWORD *)(v4 + 4788) = v6;
  if ( StorEtwLoggingEnabled && (Microsoft_Windows_StorPortEnableBits & 0x4000000) != 0 && v6 >= 0x19 )
  {
    ...
    if ( v17.QuadPart <= 0 || v17.QuadPart >= v28.QuadPart )
      v20 = v17.QuadPart - v28.QuadPart;
    else
      v20 = v17.QuadPart - v28.QuadPart - 1;
    v31 = v20;
    if ( UseQPCTime )
    {
