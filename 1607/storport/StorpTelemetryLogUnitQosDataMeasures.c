/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1C003F228
 * Callers:
...
void __fastcall StorpTelemetryLogUnitQosDataMeasures(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C004F010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      *(_DWORD *)hProvider = *(_DWORD *)(v2 + 2556);
      *(_DWORD *)&hProvider[4] = *(_DWORD *)(v2 + 2560);
      *(_QWORD *)&hProvider[8] = *(_QWORD *)(v2 + 2564);
      *(_QWORD *)&hProvider[16] = *(_QWORD *)(v2 + 2572);
      v6 = (*(_BYTE *)(v2 + 154) & 2) != 0;
      v20 = 16LL;
      v14 = v6;
      *(_OWORD *)&hProvider[36] = *(_OWORD *)(v2 + 1792);
      v15 = *(_BYTE *)(v3 + 32);
      *(_OWORD *)&hProvider[52] = *(_OWORD *)(v2 + 1808);
      *(_DWORD *)&hProvider[24] = *(_DWORD *)(v2 + 1824);
      *(_DWORD *)&hProvider[28] = *(_DWORD *)(v2 + 1828);
      *(_DWORD *)&hProvider[32] = *(_DWORD *)(v3 + 28);
      ...
      v61 = 4LL;
      v63 = 4LL;
      TlgWrite((TraceLoggingHProvider)hProvider, &unk_1C0046E41, v9, v10, 0x1Au, &pData);
    }
  }
}
