/*
 * XREFs of PortRegistryCreateKeyEx @ 0x1C0013990
 * Callers:
 *     RaidUnitRegisterInterfaces @ 0x1C001094C (RaidUnitRegisterInterfaces.c)
 *     PortMapBuildAdapterEntry @ 0x1C0010D0C (PortMapBuildAdapterEntry.c)
 *     PortMapBuildLunEntry @ 0x1C0010DF0 (PortMapBuildLunEntry.c)
 *     PortMapBuildBusEntry @ 0x1C0013928 (PortMapBuildBusEntry.c)
 * Callees:
