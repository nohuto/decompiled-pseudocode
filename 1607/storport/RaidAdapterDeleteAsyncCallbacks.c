/*
 * XREFs of RaidAdapterDeleteAsyncCallbacks @ 0x1C0026BEC
 * Callers:
 ...
 *     RaidAdapterCancelWaitCheckTimer @ 0x1C00268B8 (RaidAdapterCancelWaitCheckTimer.c)
 *     RaidAdapterDisConnectMSIInterrupt @ 0x1C005E03C (RaidAdapterDisConnectMSIInterrupt.c)
 *     RaidAdapterDisConnectNonMSIInterrupt @ 0x1C005E07C (RaidAdapterDisConnectNonMSIInterrupt.c)
 */
...
void __fastcall RaidAdapterDeleteAsyncCallbacks(__int64 a1)
{
  ...
  RaidAdapterCancelWaitCheckTimer(a1);
  v2 = KfRaiseIrql(2u);
