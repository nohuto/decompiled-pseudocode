/*
 * XREFs of RaidBusEnumeratorGetLunListFromTarget @ 0x1C0012704
 * Callers:
 *     RaidBusEnumeratorGetLunList @ 0x1C00123A0 (RaidBusEnumeratorGetLunList.c)
 * Callees:
 *     RaidBusEnumeratorIssueReportLuns @ 0x1C00128A0 (RaidBusEnumeratorIssueReportLuns.c)
...
LABEL_8:
      ...
      do
      {
        ...
        if ( v16 >= 0xFFu )
        {
          if ( v14 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
          {
            ...
            {
              WPP_SF_qD(v14->AttachedDevice, 17LL, &WPP_0f528954af03336098861edcd0252264_Traceguids, *a1, v16);
              v14 = WPP_GLOBAL_Control;
            }
            if ( v14 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
              ...
              && BYTE1(v14->Timer) >= 3u )
            {
              WPP_SF_D(v14->AttachedDevice, 18LL, &WPP_0f528954af03336098861edcd0252264_Traceguids, v16);
              v14 = WPP_GLOBAL_Control;
            }
          }
        }
    ...
    if ( v14 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_q(v14->AttachedDevice, 19LL, &WPP_0f528954af03336098861edcd0252264_Traceguids, *a1);
        v14 = WPP_GLOBAL_Control;
      }
      if ( v14 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v14->Timer) & 0x4000) != 0 && BYTE1(v14->Timer) >= 5u )
      {
        WPP_SF_(v14->AttachedDevice, 20LL, &WPP_0f528954af03336098861edcd0252264_Traceguids, v13);
        v14 = WPP_GLOBAL_Control;
      }
    }
    for ( i = v8; i < 0xFFu; ++i )
    {
      if ( *a4 != (_BYTE)v8
        ...
        && BYTE1(v14->Timer) >= 5u )
      {
        WPP_SF_D(v14->AttachedDevice, 21LL, &WPP_0f528954af03336098861edcd0252264_Traceguids, i);
        v14 = WPP_GLOBAL_Control;
      }
      ++a4;
    }
