/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C0014C94
 * Callers:
...
LABEL_13:
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 5192LL);
  ...
  if ( (unsigned int)dword_1C004F010 > 5 && TlgKeywordOn(Length, 0x400000000000uLL) )
  {
    ...
    v27 = 1LL;
    v29 = 1LL;
    TlgWrite((TraceLoggingHProvider)v10, &unk_1C0046371, v7, v8, 8u, &pData);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
