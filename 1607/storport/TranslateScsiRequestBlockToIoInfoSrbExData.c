/*
 * XREFs of TranslateScsiRequestBlockToIoInfoSrbExData @ 0x1C000994C
 * Callers:
 *     TranslateToExtendedSrb @ 0x1C001A3E8 (TranslateToExtendedSrb.c)
 * Callees:
 *     StRtlIoStorInfoGetNvCachePriority @ 0x1C0009A7C (StRtlIoStorInfoGetNvCachePriority.c)
 *     StRtlIoStorInfoGetHybridWriteThrough @ 0x1C0009AD0 (StRtlIoStorInfoGetHybridWriteThrough.c)
 */
