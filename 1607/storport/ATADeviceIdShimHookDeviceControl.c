/*
 * XREFs of ATADeviceIdShimHookDeviceControl @ 0x1C0042C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATADeviceIdShimHookDeviceControl(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)v2 == 1 )
  {
    if ( *(_QWORD *)(v2 + 136) )
    {
      if ( *((_DWORD *)v4 + 6) == 2954240 )
      {
        ...
        if ( v7 )
        {
          if ( !v7[1] && *v7 == 2 && (unsigned int)v8 >= 8 )
          {
            ...
            (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), __int64))(qword_1C004F120 + 8))(
              a1,
              a2,
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD))qword_1C004F120)(*(_QWORD *)(a1 + 8));
