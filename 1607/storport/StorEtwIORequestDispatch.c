/*
 * XREFs of StorEtwIORequestDispatch @ 0x1C003A0D4
 * Callers:
  ...
  if ( !v8 )
  {
    if ( ((v2 - 8) & 0x5F) != 0 )
    {
      ...
      if ( ((v2 - 10) & 0x5F) == 0 )
      {
        ...
        {
          if ( (Microsoft_Windows_StorPortEnableBits & 0x1000) != 0 )
          {
            v14 = &EventPagingWriteRequest;
            goto LABEL_28;
          }
        }
        else if ( (Microsoft_Windows_StorPortEnableBits & 0x400) != 0 )
        {
    ...
    else
    {
      ...
      if ( (NvCachePriority & 0x42) != 0 )
      {
        if ( (Microsoft_Windows_StorPortEnableBits & 0x800) != 0 )
        {
          v14 = &EventPagingReadRequest;
          goto LABEL_28;
        }
      }
      else if ( (Microsoft_Windows_StorPortEnableBits & 0x200) != 0 )
      {
