/*
 * XREFs of StorPortResumeDevice @ 0x1C000AE90
 * Callers:
 *     StorPortResumeDeviceVrfy @ 0x1C00625F0 (StorPortResumeDeviceVrfy.c)
 * Callees:
...
char __fastcall StorPortResumeDevice(__int64 a1, unsigned __int8 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v8 )
  {
    ...
    {
      WPP_SF_ddd(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_adf5a490639137350fe391398fd0549f_Traceguids, a2, v5, v4);
    }
