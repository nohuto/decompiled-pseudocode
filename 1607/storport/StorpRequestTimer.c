/*
 * XREFs of StorpRequestTimer @ 0x1C0009378
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( !a1 || !a2 || !a3 )
  {
    ...
    {
      WPP_SF_qqq(WPP_GLOBAL_Control->AttachedDevice, 72LL, &WPP_adf5a490639137350fe391398fd0549f_Traceguids, a1, a2, a3);
    }
    return 3238002694LL;
  }
  v10 = **(_DWORD ***)(a1 - 16);
  ...
  if ( !*(_QWORD *)a2 || *v11 )
  {
    ...
    v9 = a2;
LABEL_27:
    WPP_SF_q(v15->AttachedDevice, v16, &WPP_adf5a490639137350fe391398fd0549f_Traceguids, v9);
    return 3238002694LL;
  }
  if ( a5 )
  {
