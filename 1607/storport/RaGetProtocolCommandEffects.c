/*
 * XREFs of RaGetProtocolCommandEffects @ 0x1C002650C
 * Callers:
...
__int64 __fastcall RaGetProtocolCommandEffects(__int64 a1, __int64 a2, _BYTE *a3, _BYTE *a4)
{
  ...
  *a4 = 0;
  ...
  if ( (*(_BYTE *)(v4 + 109) & 0x10) != 0 )
  {
    ...
    *((_DWORD *)v7 + 13) = 44;
    *((_DWORD *)v7 + 14) = 4096;
    v5 = RaidAdapterSendSrbIoControlSynchronously(v4, a2, v7, 4176LL, 0LL, 0, 64);
    if ( v5 >= 0 )
    {
      v15 = *(_OWORD **)(v4 + 5472);
  ...
  if ( v27 )
  {
    v28 = v6[20];
    if ( v6[14] == 1 )
      v29 = (unsigned int *)(v27 + 4LL * (unsigned __int8)v28);
    else
      v29 = (unsigned int *)(v27 + 4 * ((unsigned __int8)v28 + 256LL));
    v30 = *v29;
    if ( (*v29 & 1) != 0 )
    {
  ...
  else if ( (unsigned __int8)v6[20] == 0x80 )
  {
    v5 = 0;
    goto LABEL_39;
  }
