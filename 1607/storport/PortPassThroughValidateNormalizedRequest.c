/*
 * XREFs of PortPassThroughValidateNormalizedRequest @ 0x1C0060DC0
 * Callers:
...
__int64 __fastcall PortPassThroughValidateNormalizedRequest(unsigned __int16 *a1, __int64 a2, char a3)
{
  ...
  ULONG pulResult; // [rsp+80h] [rbp+20h] BYREF
  ...
  if ( v9 )
  {
    if ( RtlULongAdd(*((_DWORD *)a1 + 8), v9, &pulResult) < 0 )
      return 3221225485LL;
    ...
    if ( !a3 )
    {
      ...
      {
        v11 = *((_QWORD *)a1 + 3);
        if ( v10 >= v11 || pulResult > v11 )
          return 3221225485LL;
      }
    }
    if ( (unsigned int)v10 > (unsigned int)v7 || pulResult > (unsigned int)v7 )
      return 3221225485LL;
  }
  if ( a3 )
  {
