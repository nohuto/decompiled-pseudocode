/*
 * XREFs of RaidUnitAdaptiveIdleTimeout @ 0x1C0030DE0
 * Callers:
 ...
 *     RaidUnitPowerCycleCheck @ 0x1C0031250 (RaidUnitPowerCycleCheck.c)
 ...
 *     RaidUnitGetMinimumPowerCyclePeriod @ 0x1C0009F6C (RaidUnitGetMinimumPowerCyclePeriod.c)
...
void __fastcall RaidUnitAdaptiveIdleTimeout(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1456) + 32LL) & 0x80u) != 0 )
    {
      ...
      {
        v9 = MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 2544);
        if ( v9 > 0 )
        {
          v10 = v9 / 10000;
          v11 = v9 / 10000 / v6;
