/*
 * XREFs of RaAssignConfigurationResources @ 0x1C0057DDC
 * Callers:
 *     RaInitializeMiniport @ 0x1C0057D8C (RaInitializeMiniport.c)
 * Callees:
 *     <none>
 */
