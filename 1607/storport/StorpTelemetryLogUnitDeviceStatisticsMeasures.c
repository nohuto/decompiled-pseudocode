/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsMeasures @ 0x1C003E0D8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsMeasures(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C004F010 > 5 && TlgKeywordOn(a1, 0x400000000000uLL) )
  {
    v4 = *(_QWORD *)(v1 + 24);
    v5 = v2 + 1688;
    v6 = *(_QWORD **)(v3 + 40);
    ...
    *((_WORD *)&hProvider.LevelPlus1 + 3) = *(_WORD *)(v3 + 98);
    ...
    v100[1] = 0;
    v102 = 1LL;
    TlgWrite(&hProvider, &unk_1C00482D6, v29, 0LL, 0x24u, &pData);
  }
}
