/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C00220B8
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, PVOID **a2)
{
  ...
  v2 = (unsigned int)dword_1C000F220;
  v4 = 0LL;
  v5 = 0LL;
  v6 = (unsigned int)(16 * dword_1C000F220 + 4);
  ...
  if ( PoolWithTag )
  {
    ...
    *v8 = v2;
    v9 = PoFxProcessorNotification(*(_QWORD *)(a1 + 1064), 29LL, v8);
    if ( v9 >= 0 )
    {
      v10 = 0;
      v11 = 0;
...
LABEL_27:
          ...
          while ( 1 )
          {
            ...
            *v5 = v30;
            v5[1] = v32;
            v5[2] = *(_DWORD *)v31;
            v9 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C000EF98)(*(_QWORD *)(a1 + 1064), v5);
            if ( v9 < 0 )
              break;
