/*
 * XREFs of ValidateAcpiCStates @ 0x1C0015D04
 * Callers:
...
LABEL_8:
  ...
  if ( v2 )
  {
    for ( i = a1 + 4;
       ...
       && *i != 1
       && (*i == 2
        || IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C000F464)
        && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C000F434))
       && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C000F44C);
          i += 20 )
    {
      if ( ++v5 >= v2 )
        return v1;
