/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x1C001D640
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0002A70 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0002DC0 (memset.c)
 *     DecodeGenAddressToHvPerfReg @ 0x1C001D010 (DecodeGenAddressToHvPerfReg.c)
 */
...
LABEL_39:
    ...
    v31 = a1;
    if ( qword_1C000EF68 )
      return (unsigned int)qword_1C000EF68(&v29);
    else
