/*
 * XREFs of ProcLibTraceEnergyCounterUpdate @ 0x1C0004238
 * Callers:
...
char __fastcall ProcLibTraceEnergyCounterUpdate(__int64 a1, int a2, __int64 a3)
{
  ...
  v20 = a3;
  v19 = a2;
  LOBYTE(ProcessorNumber) = EtwEventEnabled(ProcLibEtwHandle, &PPM_ETW_ENERGY_COUNTER_UPDATE);
  if ( (_BYTE)ProcessorNumber )
  {
    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      v14 = 4;
      v17 = 8;
      LOBYTE(ProcessorNumber) = EtwWrite(ProcLibEtwHandle, &PPM_ETW_ENERGY_COUNTER_UPDATE, 0LL, 4u, &UserData);
    }
  }
