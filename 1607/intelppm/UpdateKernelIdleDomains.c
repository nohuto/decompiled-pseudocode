/*
 * XREFs of UpdateKernelIdleDomains @ 0x1C0021A94
 * Callers:
    ...
    *((_DWORD *)PoolWithTag + 1) = v2;
    ...
    if ( (_DWORD)v2 )
    {
      ...
      do
      {
        ...
        v8 = *(_QWORD *)(v6 + *(_QWORD *)(a1 + 656) + 120);
        if ( v8 )
        {
          v9 = *(_QWORD *)(v8 + 8);
          if ( v9 )
    ...
    v5 = ((__int64 (__fastcall *)(char *))qword_1C000EF18)(v4);
