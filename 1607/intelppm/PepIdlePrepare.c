/*
 * XREFs of PepIdlePrepare @ 0x1C0006B10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepIdleCancel @ 0x1C0006900 (PepIdleCancel.c)
 */
...
__int64 __fastcall PepIdlePrepare(_QWORD **a1)
{
  ...
  if ( dword_1C000F218 >= (unsigned int)dword_1C000ECF4 )
  {
    ...
    v18 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C000EF88)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C000F220 )
