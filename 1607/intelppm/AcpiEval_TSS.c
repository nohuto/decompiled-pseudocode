/*
 * XREFs of AcpiEval_TSS @ 0x1C001665C
 * Callers:
...
__int64 __fastcall AcpiEval_TSS(__int64 a1, _QWORD *a2)
{
  ...
  __int64 (__fastcall *v20)(__int64, _DWORD *, unsigned int); // [rsp+60h] [rbp-59h]
  char v21; // [rsp+68h] [rbp-51h]
  int v22; // [rsp+6Ah] [rbp-4Fh]
  const char *v23; // [rsp+70h] [rbp-49h]
  __int64 (__fastcall *v24)(__int64, _DWORD *, unsigned int); // [rsp+78h] [rbp-41h]
  char v25; // [rsp+80h] [rbp-39h]
  int v26; // [rsp+82h] [rbp-37h]
  const char *v27; // [rsp+88h] [rbp-31h]
  __int64 (__fastcall *v28)(__int64, _DWORD *, unsigned int); // [rsp+90h] [rbp-29h]
  char v29; // [rsp+98h] [rbp-21h]
  int v30; // [rsp+9Ah] [rbp-1Fh]
  const char *v31; // [rsp+A0h] [rbp-19h]
  __int64 (__fastcall *v32)(__int64, _DWORD *, unsigned int); // [rsp+A8h] [rbp-11h]
  char v33; // [rsp+B0h] [rbp-9h]
  int v34; // [rsp+B2h] [rbp-7h]
  const char *v35; // [rsp+B8h] [rbp-1h]
  __int64 (__fastcall *v36)(__int64, _DWORD *, unsigned int); // [rsp+C0h] [rbp+7h]
  ...
  v6 = AcpiEvaluateMethod(a1, 1397970015, 0, (unsigned int)&P, (__int64)&v15);
  if ( v6 >= 0 )
  {
