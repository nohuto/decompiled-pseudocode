/*
 * XREFs of PopulateEnergyEstimationModel @ 0x1C002513C
 * Callers:
 ...
 *     RtlStringCchCatW @ 0x1C0007270 (RtlStringCchCatW.c)
 *     RtlStringCchPrintfW @ 0x1C00072B8 (RtlStringCchPrintfW.c)
...
int __fastcall PopulateEnergyEstimationModel(unsigned __int8 a1, _DWORD *a2)
{
  ...
  if ( RtlStringCchPrintfW(
    ...
    && (int)GetRegistryDwordValueNoDefault((__int64)pszDest, (__int64)L"PowerEnvelope", (__int64)&v14) >= 0
    && (unsigned int)(v14 - 1) <= 0x3E7F )
  {
    *a2 = v14;
