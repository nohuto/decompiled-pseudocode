/*
 * XREFs of RegisterVmIdleStates @ 0x1C001E27C
 * Callers:
 *     RegisterGuestIdleStates @ 0x1C001D350 (RegisterGuestIdleStates.c)
 *     RegisterHvPepIdleStatesV2 @ 0x1C001DD9C (RegisterHvPepIdleStatesV2.c)
 * Callees:
...
__int64 __fastcall RegisterVmIdleStates(__int64 a1)
{
  ...
  if ( v2 && (v3 = *v2) != 0 )
  {
    ...
    if ( ProcessorNumberFromIndex >= 0 )
    {
      ...
      BYTE2(v8[2]) = 1;
      HIDWORD(v8[13]) = 1;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD *))qword_1C000EF10)(v8);
      if ( ProcessorNumberFromIndex >= 0 )
      {
        if ( !*(_BYTE *)(a1 + 664) )
        {
