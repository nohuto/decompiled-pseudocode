/*
 * XREFs of ReadIoMemRawHidden @ 0x1C00045E4
 * Callers:
...
__int64 __fastcall ReadIoMemRawHidden(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)a2 == 1 )
  {
    ...
    ((void (__fastcall *)(__int64, _QWORD, __int64, __int64 *))qword_1C000EFC8)(a1, (unsigned __int16)v2, v5, &v6);
    return v6;
  }
  if ( *(_BYTE *)a2 != 127 || v3 != 64 )
    return 0LL;
  ((void (__fastcall *)(__int64, _QWORD, __int64 *))qword_1C000EFB8)(a1, (unsigned int)v2, &v6);
  return v6;
}
