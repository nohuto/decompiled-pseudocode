/*
 * XREFs of RegisterIdleDomain @ 0x1C0020874
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  v5 = 3LL * a2;
  v6 = qword_1C000ED38;
  if ( (__int64 *)qword_1C000ED38 == &qword_1C000ED38 )
    goto LABEL_5;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C000ED38 );
  if ( !v7 )
  {
LABEL_5:
    ...
    *(_QWORD *)(v7 + 24) = v7 + 16;
    *(_QWORD *)(v7 + 16) = v7 + 16;
    v9 = (__int64 *)qword_1C000ED40;
    if ( *(__int64 **)qword_1C000ED40 != &qword_1C000ED38 )
      __fastfail(3u);
    *(_QWORD *)v7 = &qword_1C000ED38;
    *(_QWORD *)(v7 + 8) = v9;
    *v9 = v7;
    qword_1C000ED40 = v7;
