/*
 * XREFs of RegisterHvPerfStates @ 0x1C001DE00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeAcpiPStates @ 0x1C0021B9C (DecodeAcpiPStates.c)
 *     DecodeAcpiTStates @ 0x1C0021D40 (DecodeAcpiTStates.c)
 */
...
LABEL_18:
    ...
    if ( v3 )
      v3[770] = dword_1C000F108;
    if ( v5 )
      v5[802] = dword_1C000F108;
    ++dword_1C000F108;
    v8 = 0;
