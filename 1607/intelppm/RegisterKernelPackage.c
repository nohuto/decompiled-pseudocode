/*
 * XREFs of RegisterKernelPackage @ 0x1C0020BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 66) )
    ...
    v3 = ((__int64 (__fastcall *)(_QWORD))qword_1C000EFA8)(*(unsigned int *)(a1 + 56));
  v4 = v3;
  v5 = qword_1C000ED28;
  ...
  while ( (__int64 *)v5 != &qword_1C000ED28 );
  if ( !v6 )
  {
LABEL_8:
    ...
    *(_DWORD *)(v6 + 32) = v4;
    *(_DWORD *)(v6 + 36) = ((__int64 (__fastcall *)(_QWORD))qword_1C000EFB0)(v4);
    *(_DWORD *)(v6 + 36) += HalPrivateDispatchTable[125](v4);
    *(_QWORD *)(v6 + 24) = v6 + 16;
    *(_QWORD *)(v6 + 16) = v6 + 16;
    v8 = (__int64 *)qword_1C000ED30;
    if ( *(__int64 **)qword_1C000ED30 != &qword_1C000ED28 )
      __fastfail(3u);
    *(_QWORD *)v6 = &qword_1C000ED28;
    *(_QWORD *)(v6 + 8) = v8;
    *v8 = v6;
    qword_1C000ED30 = v6;
  }
