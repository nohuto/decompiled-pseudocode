/*
 * XREFs of InitLegacyPccInternal @ 0x1C0005DC8
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C00061F0 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C001DC60 (RegisterHvLegacyPccCounters.c)
 * Callees:
...
__int64 __fastcall InitLegacyPccInternal(__int64 a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  if ( qword_1C000F210 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C000ECF8,
      0LL);
    PerfDomain = GetPerfDomain(a1, v28, &v30);
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 7) = v16;
      ...
      v3[33] = *(_QWORD *)(a1 + 320);
      if ( dword_1C000F1B4 )
        *((_DWORD *)v3 + 9) = 0x989680 / ((unsigned int)dword_1C000F1B4 >> 1);
      *((_DWORD *)v13 + 3) = 0;
      *((_WORD *)v13 + 8) = 0;
      ...
      *((_DWORD *)v3 + 8) = 1;
      ...
      while ( !(unsigned int)EnumerateNextDevice((__int64)v28, &v30) )
      {
        InitCommonPerfStateContext(v30, v22, v23, 100, 0);
      ...
      if ( v5 >= 0 )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2528))(
          ...
          qword_1C000F208);
        ResetEnumerationContext(v28);
        if ( !(unsigned int)EnumerateNextDevice((__int64)v28, &v30) )
        {
          v24 = v9 + 1;
          v25 = &qword_1C000ED48;
          do
          {
            *(_QWORD *)(v30 + 216) = v24 - 1;
            v26 = (__int64 *)qword_1C000ED50;
            if ( *(__int64 **)qword_1C000ED50 != v25 )
              __fastfail(3u);
            *v24 = v25;
            v24[1] = v26;
            *v26 = (__int64)v24;
            qword_1C000ED50 = (__int64)v24;
          }
          while ( !(unsigned int)EnumerateNextDevice((__int64)v28, &v30) );
        }
