/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C00217CC
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = dword_1C000ECF4;
  if ( byte_1C000F424 && dword_1C000F420 > (unsigned int)dword_1C000ECF4 )
    v1 = dword_1C000F420;
  v2 = (unsigned int)dword_1C000F220;
  if ( dword_1C000F220 )
  {
    v4 = (48 * dword_1C000F220 + 59) & 0xFFFFFFFC;
    PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * v1 * dword_1C000F220, 0x72637250u);
    v6 = PoolWithTag;
    if ( PoolWithTag )
    {
      ...
      if ( v8 )
      {
        ...
        if ( (_DWORD)v2 )
        {
          ...
          while ( 1 )
          {
            ...
            *v8 = v9;
            v8[8] = v1;
            ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C000EF90)(
                                         *(_QWORD *)(a1 + 1064),
                                         v8,
                                         0LL);
...
LABEL_19:
          *(_DWORD *)v6 = 44;
          *((_DWORD *)v6 + 1) = dword_1C000F220;
          *((_DWORD *)v6 + 2) = dword_1C000F220;
          ...
          *((_QWORD *)v6 + 4) = PepIdleComplete;
          ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C000EF20)(v6);
          if ( ProcessorNumberFromIndex >= 0 )
          {
            Src = v6;
            v6 = 0LL;
