/*
 * XREFs of AcpiEval_CPC @ 0x1C0016900
 * Callers:
...
__int64 __fastcall AcpiEval_CPC(__int64 a1, _QWORD *a2)
{
  ...
  unsigned __int8 v19[2]; // [rsp+60h] [rbp-A0h] BYREF
  int v20; // [rsp+62h] [rbp-9Eh]
  const char *v21; // [rsp+68h] [rbp-98h]
  __int64 (__fastcall *v22)(__int64, _DWORD *, unsigned int); // [rsp+70h] [rbp-90h]
  char v23; // [rsp+78h] [rbp-88h]
  int v24; // [rsp+7Ah] [rbp-86h]
  const char *v25; // [rsp+80h] [rbp-80h]
  __int64 (__fastcall *v26)(__int64, _DWORD *, unsigned int); // [rsp+88h] [rbp-78h]
  ...
  __int64 (__fastcall *v34)(__int64, __int64, unsigned int); // [rsp+B8h] [rbp-48h]
  ...
  __int64 (__fastcall *v42)(__int64, __int64, unsigned int); // [rsp+E8h] [rbp-18h]
  ...
  __int64 (__fastcall *v50)(__int64, __int64, unsigned int); // [rsp+118h] [rbp+18h]
  ...
  __int64 (__fastcall *v110)(__int64, __int64, unsigned int); // [rsp+280h] [rbp+180h]
  char v111; // [rsp+288h] [rbp+188h]
  int v112; // [rsp+28Ah] [rbp+18Ah]
  const char *v113; // [rsp+290h] [rbp+190h]
  __int64 (__fastcall *v114)(__int64, __int64, unsigned int); // [rsp+298h] [rbp+198h]
  char v115; // [rsp+2A0h] [rbp+1A0h]
  int v116; // [rsp+2A2h] [rbp+1A2h]
  const char *v117; // [rsp+2A8h] [rbp+1A8h]
  __int64 (__fastcall *v118)(__int64, __int64, unsigned int); // [rsp+2B0h] [rbp+1B0h]
  ...
  __int64 (__fastcall *v126)(__int64, __int64, unsigned int); // [rsp+2E0h] [rbp+1E0h]
  ...
  P = 0LL;
  _InterlockedOr((volatile signed __int32 *)(a1 + 1052), 0x40000u);
  v4 = AcpiEvaluateMethod(a1, 1129333599, 0, (unsigned int)&P, (__int64)&v16);
  if ( v4 < 0 )
    goto LABEL_2;
  *(_QWORD *)(a1 + 240) |= *(_DWORD *)(a1 + 248) & 0x8000000;
  ...
  v5 = P;
  v4 = AcpiParseCore(v19, 2u, (_WORD *)P + 6, *((_DWORD *)P + 1) - 12, (__int64)v3, 236, v14, 1);
  if ( v4 < 0 )
    goto LABEL_2;
  v8 = v3[1];
  if ( v8 )
  {
    ...
    if ( v9 )
    {
      v10 = 27;
      v11 = v9 != 1;
      v12 = (unsigned int *)&Cpc2RegisterTable;
    }
    else
    {
      v10 = 21;
      v11 = 0;
      v12 = (unsigned int *)&CpcRegisterTable;
    }
    v4 = AcpiParseCore(v19, v10, v5 + 6, *((_DWORD *)v5 + 1) - 12, (__int64)v3, 236, v15, v11);
    if ( v4 < 0 )
      goto LABEL_2;
    do
    {
      AcpiTranslateAccessSize((char *)v3 + *v12);
      v12 += 6;
    }
    while ( v13 != 1 );
    *v18 = v3;
