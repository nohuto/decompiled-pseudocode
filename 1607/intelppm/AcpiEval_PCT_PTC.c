/*
 * XREFs of AcpiEval_PCT_PTC @ 0x1C0016DEC
 * Callers:
...
__int64 __fastcall AcpiEval_PCT_PTC(__int64 a1, int a2, __int64 a3)
{
  ...
  __int64 (__fastcall *v16)(__int64, __int64, unsigned int); // [rsp+60h] [rbp-20h]
  char v17; // [rsp+68h] [rbp-18h]
  int v18; // [rsp+6Ah] [rbp-16h]
  const char *v19; // [rsp+70h] [rbp-10h]
  __int64 (__fastcall *v20)(__int64, __int64, unsigned int); // [rsp+78h] [rbp-8h]
