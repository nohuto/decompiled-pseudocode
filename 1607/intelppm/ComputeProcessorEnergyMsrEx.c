/*
 * XREFs of ComputeProcessorEnergyMsrEx @ 0x1C0003580
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ComputeProcessorEnergyMsr @ 0x1C00034F0 (ComputeProcessorEnergyMsr.c)
        ...
        unsigned __int64 *a5)
{
  ...
  if ( (unsigned int)dword_1C000EC50 > 4 )
    goto LABEL_76;
  v7 = 0;
  if ( !dword_1C000EC50 )
  {
LABEL_10:
    if ( dword_1C000EC64 )
    {
      v13 = (unsigned int *)&unk_1C000EC68;
      v14 = 0LL;
      v15 = (unsigned int)dword_1C000EC64;
      do
      {
        v16 = *v13;
        v17 = __readmsr(v16);
        v18 = v17 - EnergyModelContext[v14 + 5];
        ProcLibTracePackageEnergyCounterUpdate(v16, v18);
        v77[v14] = v18;
        ++v13;
        EnergyModelContext[v14 + 5] = v17;
        ++v14;
        --v15;
      }
      while ( v15 );
    ...
    v80 = 0LL;
    v81 = 0LL;
    v74[0] = (__int64)&qword_1C000ED08;
    v74[1] = (__int64)&qword_1C000ED08;
    v74[2] = 0LL;
    ...
    while ( !(unsigned int)EnumerateNextDevice((__int64)v74, v82) )
    {
      ...
      v78[0] = 3LL;
      v22 = (unsigned __int64 *)(*(_QWORD *)(v82[0] + 328LL) + 24LL);
      do
      {
        v23 = *v22;
        v24 = *(v22 - 1);
        if ( v24 < *v22 )
          v25 = qword_1C000EC10 - v23 + v24 + 1;
        else
          v25 = v24 - v23;
    ...
    v26 = 1000000 * a3 / (qword_1C000F410 * (unsigned __int64)(unsigned int)dword_1C000F408);
    if ( !v26 )
      goto LABEL_76;
    v27 = (double)(int)a2;
    if ( a2 < 0 )
    ...
    v33 = (unsigned int)dword_1C000EC50;
    v83[2] = v29;
    v83[1] = v30 / v32 * v29;
    v83[3] = 1.0 - v29;
    if ( (EnergyModelContext[0] & 1) != 0 )
    {
      if ( (EnergyModelContext[0] & 1) == 1 && dword_1C000EC50 )
      {
        v34 = *(double *)&qword_1C000EC08;
        v35 = (double)(int)v26;
        if ( v26 < 0 )
          v35 = v35 + 1.844674407370955e19;
        v36 = v76;
        v37 = (unsigned int)dword_1C000EC50;
        v38 = (double *)v84;
        v39 = 4LL;
        do
        {
    ...
    else if ( dword_1C000EC50 )
    {
      v41 = ((unsigned __int64)EnergyModelContext[0] >> 1) & 0x1F;
      v42 = (double)(int)v26;
      if ( v26 < 0 )
        v42 = v42 + 1.844674407370955e19;
      v43 = v76;
      v44 = (unsigned int)dword_1C000EC50;
      v45 = (double *)v84;
      v39 = 4LL;
      do
      {
    ...
    v39 = 4LL;
LABEL_51:
    v48 = (unsigned int)dword_1C000EC64;
    if ( dword_1C000EC64 )
    {
      v49 = (double)((int)v26 * (int)qword_1C000F418);
      if ( v26 * qword_1C000F418 < 0 )
        v49 = v49 + 1.844674407370955e19;
      v50 = v49 / 1000000.0;
      v51 = v77;
      v52 = (unsigned int)dword_1C000EC64;
      v53 = (double *)v85;
      do
      {
        v54 = (double)(int)*v51;
    ...
    v55 = *(double *)&qword_1C000EC78;
    v56 = 0LL;
    do
    {
      v57 = *(double *)&EnergyModelContext[v56 + 16] * v83[v56];
      ++v56;
      v55 = v55 + v57;
      --v39;
    }
    ...
    if ( v55 >= 0.0
      && v55 <= (double)dword_1C000EC4C
      && (v55 <= (double)((unsigned int)dword_1C000EC4C >> 1) || v55 <= (double)(a4 * dword_1C000EC4C / 0x64u)) )
    {
      v67 = (double)(int)v26;
      if ( v26 < 0 )
  ...
  while ( 1 )
  {
    v9 = __readmsr(*(_DWORD *)((char *)&EnergyModelContext[10] + v8 + 4));
    *(_DWORD *)((char *)v78 + v8) = v9;
    LODWORD(v9) = v9 - *(_DWORD *)((char *)&EnergyModelContext[3] + v8);
    *(_DWORD *)((char *)v82 + v8) = v9;
    ...
    if ( v7 >= (unsigned int)v6 )
    {
      ...
      do
      {
        v12 = *(_DWORD *)((char *)v82 + v10);
        ProcLibTracePackageEnergyCounterUpdate(*(unsigned int *)((char *)&EnergyModelContext[10] + v10 + 4), v12);
        *(_DWORD *)((char *)&EnergyModelContext[3] + v10) = *(_DWORD *)((char *)v78 + v10);
        v76[v10 / 4] = v12;
        v10 += 4LL;
        --v11;
      }
