/*
 * XREFs of GetWmiBiosInfoV1 @ 0x1C0005890
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  *(_DWORD *)(a3 + 16) = *(_DWORD *)(v10 + 56);
  do
  {
    v14 = *((unsigned __int8 *)v11 + v13++ + 376);
    *v12++ = v14;
  }
  while ( v13 < 4 );
  v15 = (_DWORD *)(a3 + 48);
  *(_QWORD *)(a3 + 40) = *(_QWORD *)((char *)v11 + 380);
  for ( i = 0LL; i < 4; ++i )
  {
    v17 = *((unsigned __int8 *)v11 + i + 388);
    *v15++ = v17;
  }
  *(_QWORD *)(a3 + 64) = v11[49];
  v18 = (unsigned int *)v11[50];
  if ( !v18 )
  {
    *(_QWORD *)(a3 + 72) = 0LL;
    *(_QWORD *)(a3 + 80) = 0LL;
