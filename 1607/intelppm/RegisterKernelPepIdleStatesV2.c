/*
 * XREFs of RegisterKernelPepIdleStatesV2 @ 0x1C0021064
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStatesV2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v28; // ecx
  int v29; // eax
  char v31[4]; // [rsp+30h] [rbp-40h] BYREF
  ...
  *(_QWORD *)(a3 + 48) = 0LL;
  *(_DWORD *)(a3 + 40) = 0;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v12 + 2504))(v11, qword_1C000ED00, 0LL);
  *(_BYTE *)(a1 + 1121) = 0;
  v35[1] = 0x100000000LL;
  v35[0] = 127LL;
  v36 = 0;
...
LABEL_21:
    ...
    if ( v18 != v35 )
      *(_QWORD *)v13 = v18;
    if ( (int)DecodeAcpi2CState(a1, v18, 0LL, v31, v13) < 0 )
      break;
