/*
 * XREFs of InitAcpiProcessorDomains @ 0x1C001562C
 * Callers:
...
__int64 __fastcall InitAcpiProcessorDomains(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    *(_QWORD *)(a1 + 192),
    0LL);
  if ( (*(_DWORD *)(a1 + 248) & 0x7F070LL) != 0 && *(_QWORD *)(a1 + 480) && (int)InitAcpiIdleDomain(a1, a1 + 488) < 0 )
    *(_QWORD *)(a1 + 488) = 0LL;
  v2 = *(_QWORD *)(a1 + 248);
