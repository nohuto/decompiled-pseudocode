/*
 * XREFs of RegisterKernelIdleStates @ 0x1C0001A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelIdleStates(__int64 a1)
{
  ...
  v3 = 0LL;
  if ( *(_BYTE *)(a1 + 66) )
    return (unsigned int)((__int64 (*)(void))qword_1C000F0C8)();
      ...
      *(_QWORD *)v2 = *(_QWORD *)(a1 + 1064);
      ...
      if ( *((_BYTE *)v2 + 20) )
      {
        ...
        if ( (*(_QWORD *)(a1 + 248) & 0x300000300LL) != 0 && *(_QWORD *)(a1 + 656) )
          HIBYTE(v1[4].Group) = 1;
        ProcessorNumberFromIndex = ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1C000EF10)(v1);
        if ( ProcessorNumberFromIndex >= 0 )
        {
          v3 = *(_QWORD **)(a1 + 656);
          *(_QWORD *)(a1 + 656) = v2;
