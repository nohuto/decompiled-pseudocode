/*
 * XREFs of PerfControlCpcSingleRegisterHidden @ 0x1C0004E10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  if ( *(_BYTE *)(a1 + 94) )
  {
    ...
    {
      LODWORD(v10) = PerformanceFromPercentage(a1, a3);
    }
  }
  if ( *(_BYTE *)(a1 + 95) )
  {
    ...
    {
      LODWORD(v10) = PerformanceFromPercentage(a1, a4);
    }
  }
  if ( *(_BYTE *)(a1 + 96) )
  {
    ...
    {
      LODWORD(v10) = PerformanceFromPercentage(a1, a5);
    }
  }
