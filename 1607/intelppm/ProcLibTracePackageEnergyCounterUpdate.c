/*
 * XREFs of ProcLibTracePackageEnergyCounterUpdate @ 0x1C00043D8
 * Callers:
...
BOOLEAN __fastcall ProcLibTracePackageEnergyCounterUpdate(int a1, __int64 a2)
{
  ...
  v8 = a2;
  v7 = a1;
  result = EtwEventEnabled(ProcLibEtwHandle, &PPM_ETW_PACKAGE_ENERGY_COUNTER_UPDATE);
  if ( result )
  {
    UserData.Reserved = 0;
    v6 = 0;
    ...
    v4 = &v8;
    v5 = 8;
    return EtwWrite(ProcLibEtwHandle, &PPM_ETW_PACKAGE_ENERGY_COUNTER_UPDATE, 0LL, 2u, &UserData);
  }
  return result;
}
