/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C001D9A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C001E3D0 (DecodeDoorbellAddressIo.c)
 */
...
__int64 __fastcall RegisterHvLegacyPcc(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C000ECF8,
    0LL);
  PerfDomain = GetPerfDomain(a1, (__int64)v24, &v18);
  ...
  v21 = qword_1C000F158;
  v22 = dword_1C000F160;
  if ( (unsigned __int8)qword_1C000F158 <= 1u )
  {
    v4 = qword_1C000F150;
    v5 = qword_1C000F148;
    v18 = 0LL;
    if ( (_BYTE)qword_1C000F158 == 1 )
    {
      v10 = DecodeDoorbellAddressIo(&v21, &v18, &v20, &v19);
      v1 = v20;
      v9 = v10;
      v8 = v18;
      v3 = v19;
  ...
  if ( v9 >= 0 )
  {
    v11 = dword_1C000F108;
    LODWORD(v25[0]) = 0;
    v25[2] = qword_1C000F138;
    LODWORD(v25[3]) = dword_1C000F140;
    v25[1] = __PAIR64__(v7, PerfDomain);
    v25[6] = v5 << v3;
    v25[5] = v4 << v3;
    HIDWORD(v25[0]) = dword_1C000F108;
    v25[4] = v8;
    v25[7] = v1;
    ...
    v13 = (__int64 (__fastcall *)(_QWORD *))qword_1C000EF50;
    if ( !v12 )
    {
      do
      {
        v25[8] = **(_QWORD **)(v17 + 528);
