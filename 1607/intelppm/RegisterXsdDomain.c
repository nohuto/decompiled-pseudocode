/*
 * XREFs of RegisterXsdDomain @ 0x1C0015380
 * Callers:
...
bool __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    0LL);
  v4 = qword_1C000ED18;
  if ( (__int64 *)qword_1C000ED18 == &qword_1C000ED18 )
    goto LABEL_7;
  do
  {
    v5 = v4;
  ...
  while ( (__int64 *)v4 != &qword_1C000ED18 );
  if ( !v5 )
  {
LABEL_7:
    ...
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v10 = (__int64 *)qword_1C000ED20;
    if ( *(__int64 **)qword_1C000ED20 != &qword_1C000ED18 )
      __fastfail(3u);
    *(_QWORD *)v5 = &qword_1C000ED18;
    *(_QWORD *)(v5 + 8) = v10;
    *v10 = v5;
    qword_1C000ED20 = v5;
    *(_DWORD *)(v5 + 36) = v2[3];
