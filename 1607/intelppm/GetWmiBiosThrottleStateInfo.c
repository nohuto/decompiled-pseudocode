/*
 * XREFs of GetWmiBiosThrottleStateInfo @ 0x1C0005A60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  *(_BYTE *)a3 = byte_1C000F476;
  *(_BYTE *)(a3 + 1) = byte_1C000F477;
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v10 + 56);
  *(_DWORD *)(a3 + 8) = *(_DWORD *)(v10 + 464);
  v12 = *(_QWORD *)(v10 + 248);
  if ( (v12 & 0x3000000) != 0 )
    v13 = 3;
  else
  ...
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v11 + 56);
  do
  {
    v16 = *(unsigned __int8 *)(v11 + v15++ + 432);
    *v14++ = v16;
  }
  while ( v15 < 4 );
  v17 = (_DWORD *)(a3 + 56);
  *(_QWORD *)(a3 + 48) = *(_QWORD *)(v11 + 436);
  for ( i = 0LL; i < 4; ++i )
  {
    v19 = *(unsigned __int8 *)(v11 + i + 444);
    *v17++ = v19;
  }
  *(_QWORD *)(a3 + 72) = *(_QWORD *)(v11 + 448);
  v20 = *(unsigned int **)(v11 + 456);
  if ( !v20 )
  {
    memset((void *)(a3 + 80), 0, 0x30uLL);
    goto LABEL_22;
  }
  v21 = *v20;
  if ( (_DWORD)v21 )
