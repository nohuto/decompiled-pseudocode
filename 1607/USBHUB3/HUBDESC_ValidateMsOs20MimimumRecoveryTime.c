/*
 * XREFs of HUBDESC_ValidateMsOs20MimimumRecoveryTime @ 0x1C002FB30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20MimimumRecoveryTime(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( *(char *)a2 < 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Du, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x151u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  return v6;
}
