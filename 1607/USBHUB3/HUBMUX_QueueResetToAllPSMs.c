/*
 * XREFs of HUBMUX_QueueResetToAllPSMs @ 0x1C000CD4C
 * Callers:
 *     HUBHSM_NotifyingHubResetToPortsOnResetOnResume @ 0x1C0007510 (HUBHSM_NotifyingHubResetToPortsOnResetOnResume.c)
 * Callees:
