/*
 * XREFs of HUBFDO_ReleaseWdfPowerReference @ 0x1C000B018
 * Callers:
 *     HUBHSM_SendingInterruptTransfer @ 0x1C0007BC0 (HUBHSM_SendingInterruptTransfer.c)
 *     HUBHSM_SendingInterruptTransferAfterResettingPipe @ 0x1C0007BF0 (HUBHSM_SendingInterruptTransferAfterResettingPipe.c)
 ...
 *     HUBHSM_WaitingForEnableInterruptsOnSx @ 0x1C0007D80 (HUBHSM_WaitingForEnableInterruptsOnSx.c)
 * Callees:
