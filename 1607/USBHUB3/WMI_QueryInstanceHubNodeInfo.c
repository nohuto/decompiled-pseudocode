/*
 * XREFs of WMI_QueryInstanceHubNodeInfo @ 0x1C0070C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WMI_QueryInstanceHubNodeInfo(__int64 a1, unsigned int a2, _DWORD *a3, unsigned int *a4)
{
  ...
  if ( v12 <= (unsigned int)v5 )
  {
    ...
    *a3 = 1431519822;
    a3[1] = v12;
    a3[22] = 1;
    *(_OWORD *)(a3 + 23) = *(_OWORD *)(v9 + 280);
    *(_OWORD *)(a3 + 27) = *(_OWORD *)(v9 + 296);
    HUBFDO_BuildUsb20HubDescriptor(v9, a3 + 31);
    *(_DWORD *)((char *)a3 + 195) = *(_DWORD *)(v9 + 88);
    *(_DWORD *)((char *)a3 + 207) = v10;
    if ( !*(_BYTE *)(v9 + 216) )
      *((_BYTE *)a3 + 202) = 1;
    v13 = 0;
    *((_BYTE *)a3 + 201) = *(_DWORD *)(v9 + 84) != 100;
    if ( (_WORD)v10 )
    {
      v14 = (__int64 *)(v9 + 2304);
