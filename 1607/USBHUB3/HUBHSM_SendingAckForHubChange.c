/*
 * XREFs of HUBHSM_SendingAckForHubChange @ 0x1C0007AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_SendingAckForHubChange(__int64 a1)
{
  ...
  *(_BYTE *)(v1 + 896) = v2 | 0x20;
  v3 = *(unsigned __int16 *)(v1 + 732);
  *(_WORD *)(v1 + 898) = v3;
  *(_DWORD *)(v1 + 900) = 0;
  v6 = v3;
  WPP_RECORDER_SF_d(*(_QWORD *)(v1 + 2464), 4u, 3u, 0xCu, (__int64)&WPP_aebd157f2d2c311e8b884f2de7866b9a_Traceguids, v6);
