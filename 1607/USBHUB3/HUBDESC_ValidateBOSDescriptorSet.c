/*
 * XREFs of HUBDESC_ValidateBOSDescriptorSet @ 0x1C002DDF4
 * Callers:
        ...
        __int64 a10)
{
  ...
  {
    v18 = a10;
    WPP_RECORDER_SF_dD(a10, 2u, 5u, 0xE4u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, a2, 5);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 23LL);
LABEL_9:
    v19 = 0;
LABEL_40:
    WPP_RECORDER_SF_(v18, 2u, 5u, 0xEAu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    return v19;
  }
  v18 = a10;
  v40 = 0;
  ...
  {
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 23LL);
    WPP_RECORDER_SF_ddd(v18, v20, v21, 0xE5u, v29);
    v19 = 0;
  }
  if ( a2 > *(unsigned __int16 *)(a1 + 2) )
  {
  ...
  if ( (unsigned __int64)v23 < v35 )
  {
    while ( 1 )
    {
      ...
      else
      {
        ...
        WPP_RECORDER_SF_dD(v18, 2u, 5u, 0xE7u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v30, v31);
...
LABEL_25:
  if ( *(unsigned __int8 *)(a1 + 4) != v11 )
  {
    ...
    LODWORD(v30) = v11;
    WPP_RECORDER_SF_dD(v18, 2u, 5u, 0xE8u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v30, v31);
  ...
  {
    WPP_RECORDER_SF_(v18, 2u, 5u, 0xE9u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
