/*
 * XREFs of HUBDESC_ValidateMsOs20FunctionSubset @ 0x1C002F4B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Du, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Eu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  return v8;
}
