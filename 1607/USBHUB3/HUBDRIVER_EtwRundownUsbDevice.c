/*
 * XREFs of HUBDRIVER_EtwRundownUsbDevice @ 0x1C0062914
 * Callers:
...
void __fastcall HUBDRIVER_EtwRundownUsbDevice(const GUID *a1, __int64 a2)
{
  ...
  char v32; // [rsp+100h] [rbp-80h]
  __int16 v33; // [rsp+104h] [rbp-7Ch]
  char v34; // [rsp+108h] [rbp-78h]
  int v35; // [rsp+10Ch] [rbp-74h]
  int v36; // [rsp+110h] [rbp-70h]
  int v37; // [rsp+114h] [rbp-6Ch]
  int v38; // [rsp+118h] [rbp-68h]
  unsigned __int16 v39; // [rsp+11Ch] [rbp-64h]
  __int64 v40; // [rsp+120h] [rbp-60h] BYREF
  __int64 v41; // [rsp+128h] [rbp-58h] BYREF
  const wchar_t *v42; // [rsp+130h] [rbp-50h]
  __int64 v43; // [rsp+138h] [rbp-48h] BYREF
  ...
  __int64 v49; // [rsp+170h] [rbp-10h]
  const GUID *v50; // [rsp+178h] [rbp-8h]
  ...
  if ( (int)HUBMISC_GetDeviceInterfacePath((__int64)v5, a2, &v43, *(_QWORD *)(*(_QWORD *)(v4 + 8) + 1432LL)) < 0 )
  {
    v7 = 0LL;
  }
  else
