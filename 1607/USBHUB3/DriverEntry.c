/*
 * XREFs of DriverEntry @ 0x1C0074000
 * Callers:
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters = MmGetSystemRoutineAddress(&DestinationString);
    ...
    qword_1C005B4F0 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 3448))(WdfDriverGlobals);
    dword_1C005B4C0 = WPP_MAIN_CB.Queue.Wcb.WaitQueueEntry.SortKey;
    qword_1C005B4C4 = (__int64)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine;
    dword_1C005B4CC = *((_DWORD *)&WPP_MAIN_CB.Queue.Wcb.1 + 5);
    dword_1C005B4D0 = (int)WPP_MAIN_CB.Queue.Wcb.DeviceContext;
  }
  else
  {
