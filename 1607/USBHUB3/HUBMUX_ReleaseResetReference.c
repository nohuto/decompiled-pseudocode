/*
 * XREFs of HUBMUX_ReleaseResetReference @ 0x1C000CCA4
 * Callers:
 *     HUBPSM30_ReleasingResetReferenceInSuperSpeedDisabled @ 0x1C000E1C0 (HUBPSM30_ReleasingResetReferenceInSuperSpeedDisabled.c)
