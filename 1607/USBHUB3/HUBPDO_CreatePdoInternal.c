/*
 * XREFs of HUBPDO_CreatePdoInternal @ 0x1C0068850
 * Callers:
 *     HUBPDO_CreatePdo @ 0x1C00698F0 (HUBPDO_CreatePdo.c)
 *     HUBPDO_CreateUnknownPdo @ 0x1C00699B0 (HUBPDO_CreateUnknownPdo.c)
 * Callees:
...
LABEL_8:
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 528))(
    ...
    v66,
    34LL);
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 496))(WdfDriverGlobals, v66, 0LL);
  LOBYTE(v12) = 15;
...
LABEL_11:
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64 *))(WdfFunctions_01015 + 3224))(
    ...
    v66,
    &v67);
  v13 = HUBPDO_AssignPDOIds(a1, v66);
  v10 = v13;
  if ( v13 < 0 )
  {
    v15 = 101;
...
LABEL_70:
  if ( v65 )
  {
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x20) != 0 )
    {
  ...
  else if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x40) != 0 )
  {
    LODWORD(v58) = v10;
    Template_pq(
      v9,
