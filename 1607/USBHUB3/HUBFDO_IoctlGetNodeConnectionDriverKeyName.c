/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionDriverKeyName @ 0x1C0064C94
 * Callers:
...
LABEL_14:
  ...
  {
    WPP_RECORDER_SF_d(v9[308], 2u, 3u, 0x28u, (__int64)&WPP_771bea9a86b4322fb3e9b71551aa114b_Traceguids, v10);
  }
