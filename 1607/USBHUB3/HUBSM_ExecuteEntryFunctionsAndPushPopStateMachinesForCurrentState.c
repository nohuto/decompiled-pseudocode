/*
 * XREFs of HUBSM_ExecuteEntryFunctionsAndPushPopStateMachinesForCurrentState @ 0x1C00090A8
 * Callers:
...
LABEL_45:
                  ...
                  {
                    g_IoSetActivityIdIrp(*(_QWORD *)(v33 + 248), v35);
                    if ( g_IoSetActivityIdIrp )
                      g_IoSetActivityIdIrp(*(_QWORD *)(v33 + 408), v35);
                  }
...
LABEL_25:
  ...
  (*(void (__fastcall **)(_QWORD, __int64 (__fastcall *)(), __int64, _QWORD))(*(_QWORD *)(a1 + 1000) + 488LL))(
    *(_QWORD *)(a1 + 992),
    HUBSM_EvtSmWorkItem,
    a1,
