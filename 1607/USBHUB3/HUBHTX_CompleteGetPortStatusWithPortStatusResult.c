/*
 * XREFs of HUBHTX_CompleteGetPortStatusWithPortStatusResult @ 0x1C000551C
 * Callers:
 *     HUBHSM_CompletingPDORequestForGetPortStatusFromConfigWithIntTransfer @ 0x1C00072D0 (HUBHSM_CompletingPDORequestForGetPortStatusFromConfigWithIntTransfer.c)
 * Callees:
...
__int64 __fastcall HUBHTX_CompleteGetPortStatusWithPortStatusResult(__int64 *a1)
{
  ...
  if ( v3 == 2228240 )
  {
    ...
    {
      WPP_RECORDER_SF_d(a1[308], 2u, 3u, 0x71u, (__int64)&WPP_aebd157f2d2c311e8b884f2de7866b9a_Traceguids, v4);
    }
  }
  else if ( v3 == 2228243 )
  {
