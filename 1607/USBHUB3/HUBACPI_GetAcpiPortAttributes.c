/*
 * XREFs of HUBACPI_GetAcpiPortAttributes @ 0x1C00702A4
 * Callers:
...
LABEL_3:
  ...
  if ( v5 == -1073741637 )
  {
    ...
    v7 = 4;
LABEL_6:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), v7, 3u, v6, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
    goto LABEL_47;
  }
  if ( v5 == -2147483643 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 4u, 3u, 0x22u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
