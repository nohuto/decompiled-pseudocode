/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C001EADC
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x1C0008390 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
...
LABEL_3:
    LODWORD(v6) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2464), 2u, 3u, v5, (__int64)&WPP_b5a7d2259efb34a086b7c731ef7dab2f_Traceguids, v6);
    goto LABEL_14;
  }
  memset(v7, 0, 0x38uLL);
  v7[4] = v9;
  ...
  memset(v8, 0, 0x28uLL);
  *(_DWORD *)v8 = 40;
  *((_QWORD *)v8 + 1) = *(_QWORD *)(a1 + 224);
  *((_QWORD *)v8 + 2) = *(_QWORD *)(a1 + 224);
  *((_DWORD *)v8 + 6) = *(unsigned __int16 *)(a1 + 44);
  if ( *(_DWORD *)(a1 + 232) == 2 )
  {
    ...
    *((_DWORD *)v8 + 8) = (*(unsigned __int16 *)(a1 + 1127) >> 5) & 3;
  }
