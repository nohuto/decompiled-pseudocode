/*
 * XREFs of HUBDTX_GetConfigDescriptorWithDefaultSizeUsingControlTransfer @ 0x1C00207D0
 * Callers:
 *     HUBDSM_GettingConfigDescriptorWhileRenuemrating @ 0x1C0018AF0 (HUBDSM_GettingConfigDescriptorWhileRenuemrating.c)
 * Callees:
