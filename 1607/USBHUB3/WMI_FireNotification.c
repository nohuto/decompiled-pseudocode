/*
 * XREFs of WMI_FireNotification @ 0x1C00715BC
 * Callers:
 ...
 *     HUBMISC_GenerateUserNotificationForPersistentOverCurrent @ 0x1C006B048 (HUBMISC_GenerateUserNotificationForPersistentOverCurrent.c)
 * Callees:
