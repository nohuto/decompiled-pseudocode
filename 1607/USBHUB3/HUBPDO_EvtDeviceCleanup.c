/*
 * XREFs of HUBPDO_EvtDeviceCleanup @ 0x1C0014050
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall HUBPDO_EvtDeviceCleanup(__int64 a1)
{
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 2) != 0 )
    Template_p(LODWORD(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink), &USBHUB3_ETW_EVENT_DEVICE_CLEANUP_START, 0LL, v2[3]);
  v4 = (PVOID *)(v1 + 272);
  v5 = 5LL;
  do
  {
