/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpQueryDeviceTextPreprocess @ 0x1C0012608
 * Callers:
...
LABEL_19:
          ...
          (v17 = *(unsigned __int8 **)(v6 + 2016)) != 0LL) )
    {
      ...
      v19 = (char *)ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, 2LL * v18, 0x64334855u);
      v20 = v19;
      if ( !v19 )
      {
        v9 = 49;
      ...
      v21 = 2LL * (v18 - 1);
      memmove(v19, (const void *)(*(_QWORD *)(v6 + 2016) + 2LL), v21);
      *(_WORD *)&v20[v21] = 0;
