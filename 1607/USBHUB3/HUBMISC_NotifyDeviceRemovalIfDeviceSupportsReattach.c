/*
 * XREFs of HUBMISC_NotifyDeviceRemovalIfDeviceSupportsReattach @ 0x1C0027A00
 * Callers:
 *     HUBPSM20_Disconnected @ 0x1C000DB50 (HUBPSM20_Disconnected.c)
 * Callees:
...
__int64 __fastcall HUBMISC_NotifyDeviceRemovalIfDeviceSupportsReattach(__int64 a1)
{
  ...
  {
    result = *(_QWORD *)a1;
    if ( (*(_DWORD *)(*(_QWORD *)a1 + 2296LL) & 0x10) == 0 && (*(_BYTE *)(a1 + 192) & 1) == 0 )
    {
