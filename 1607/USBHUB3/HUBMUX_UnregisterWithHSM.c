/*
 * XREFs of HUBMUX_UnregisterWithHSM @ 0x1C000D6AC
 * Callers:
 *     HUBDSM_UnregisteringWithHSMOnDetachAfterCleanup @ 0x1C0018020 (HUBDSM_UnregisteringWithHSMOnDetachAfterCleanup.c)
 *     HUBDSM_UnregsiteringWithHsmOnDetach @ 0x1C0018050 (HUBDSM_UnregsiteringWithHsmOnDetach.c)
 * Callees:
  ...
  *(_QWORD *)(v6 + 8) = v7;
  ...
  if ( v4 )
  {
    if ( v3 )
      ...
      v9 = 2014;
    HUBSM_AddEvent(*(_QWORD *)a1 + 1208LL, v9);
  }
}
