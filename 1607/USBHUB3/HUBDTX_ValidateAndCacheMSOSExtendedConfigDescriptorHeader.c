/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSExtendedConfigDescriptorHeader @ 0x1C0022268
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedConfigDescriptorHeader @ 0x1C0019690 (HUBDSM_ValidatingMSOSExtendedConfigDescriptorHeader.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheMSOSExtendedConfigDescriptorHeader(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 240) != 16 )
  {
    v13 = 16;
    v10 = *(_DWORD *)(a1 + 240);
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x10Du, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v10, v13);
    v5 = 122LL;
LABEL_3:
    HUBMISC_LogDescriptorValidationErrorForDevice(a1, v5);
LABEL_13:
    WPP_RECORDER_SF_(v4, 2u, 5u, 0x112u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  ...
  if ( v6 != 256 )
  {
    v14 = 256;
    v11 = v6;
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x10Eu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v11, v14);
  ...
  if ( v7 != 4 )
  {
    LODWORD(v12) = 4;
    LODWORD(v9) = v7;
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x10Fu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v9, v12);
    HUBMISC_LogDescriptorValidationErrorForDevice(a1, 125LL);
    v3 = 0;
  }
  if ( *(_BYTE *)(a1 + 1724) != 1 )
  {
    WPP_RECORDER_SF_(v4, 2u, 5u, 0x110u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    v5 = 121LL;
    goto LABEL_3;
  }
  if ( *(_DWORD *)(a1 + 1716) != 40 )
  {
    ...
    WPP_RECORDER_SF_dD(v4, 2u, 5u, 0x111u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v9, v12);
