/*
 * XREFs of HUBMISC_PrepareEndpointAndInterfaceListsForConfiguringDeviceOnSelectConfiguration @ 0x1C0024028
 * Callers:
 *     HUBDSM_PreparingEndpointAndInterfaceListsOnSelectConfiguration @ 0x1C0017550 (HUBDSM_PreparingEndpointAndInterfaceListsOnSelectConfiguration.c)
 * Callees:
...
LABEL_125:
    ...
    if ( v69 )
    {
      ...
      *(_DWORD *)(a1 + 128) = 0;
      v71 = *v70 - 8LL;
      while ( v70 != (_QWORD *)(v71 + 8) )
      {
        for ( m = 0; m < *(_DWORD *)(v71 + 24); ++m )
        {
          v73 = (unsigned __int64)m << 6;
          v74 = *(_DWORD *)(v73 + v71 + 48);
          if ( v74 == 4 )
          {
            *(_DWORD *)(v73 + v71 + 48) = 5;
            *(_QWORD *)(*(_QWORD *)(a1 + 120) + 8LL * (unsigned int)(*(_DWORD *)(a1 + 128))++) = *(_QWORD *)(v73 + v71 + 40);
          }
          else if ( v74 == 6 )
          {
            *(_QWORD *)(*(_QWORD *)(a1 + 136) + 8LL * (unsigned int)(*(_DWORD *)(a1 + 144))++) = *(_QWORD *)(v73 + v71 + 40);
          }
        }
        v71 = *(_QWORD *)(v71 + 8) - 8LL;
        v70 = (_QWORD *)(*(_QWORD *)(a1 + 56) + 16LL);
      }
    }
    goto LABEL_74;
  }
    ...
    *(_QWORD *)(a1 + 56) = 0LL;
    ...
    if ( v75 )
    {
      ...
      while ( *v76 != (__int64 *)v76 )
      {
        v77 = *v76;
        v78 = **v76;
        if ( (__int64 **)(*v76)[1] != v76 || *(__int64 **)(v78 + 8) != v77 )
          __fastfail(3u);
