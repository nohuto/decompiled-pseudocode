/*
 * XREFs of HUBDESC_InternalValidateInterfaceDescriptor @ 0x1C002AF80
 * Callers:
  ...
  *a3 = v9;
  if ( (unsigned __int8)v9 < 9u )
  {
    ...
    if ( *a3 < 9 )
    {
      v15 = 1;
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v11, 2u, v14, 0x6Au, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, *a1, v10, 9);
      goto LABEL_58;
    }
  ...
  if ( *a1 > 9u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
      *v5 = 2;
    WPP_RECORDER_SF_DDD(v11, 2u, v16, 0x6Cu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, *a1, v10, 9);
    ...
    if ( *v5 != 1 )
    {
      if ( v29 )
      {
        if ( _bittest64(*(const signed __int64 **)(a2 + 216), v17) )
        {
          ...
          LODWORD(v27) = v17;
          LODWORD(v26) = v10;
          WPP_RECORDER_SF_dD(v11, 2u, 5u, 0x6Eu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v26, v27);
  ...
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
      *v5 = 2;
    LODWORD(v26) = v10;
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x6Du, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v26);
...
LABEL_58:
  ...
  {
    v15 = 0;
    WPP_RECORDER_SF_(v11, 2u, 5u, 0x73u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  }
  return v15;
}
