/*
 * XREFs of HUBPARENT_ResetHubComplete @ 0x1C0006900
 * Callers:
 *     <none>
 * Callees:
 *     Template_pq @ 0x1C000128C (Template_pq.c)
 *     WPP_RECORDER_SF_d @ 0x1C0001904 (WPP_RECORDER_SF_d.c)
 *     HUBMUX_PropogateDeviceProgrammingLostFlagsToAllDSMs @ 0x1C000D44C (HUBMUX_PropogateDeviceProgrammingLostFlagsToAllDSMs.c)
...
__int64 __fastcall HUBPARENT_ResetHubComplete(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x400) != 0 )
    Template_pq(v7, &USBHUB3_ETW_EVENT_HUB_RESET_REQUEST_COMPLETE, 0LL, *(_QWORD *)(v6 + 224), v9);
  if ( v9 >= 0 )
  {
    if ( (*(_DWORD *)(v8 + 2352) & 1) != 0 )
  ...
  return HUBSM_AddEvent(v8 + 1208, v10);
}
