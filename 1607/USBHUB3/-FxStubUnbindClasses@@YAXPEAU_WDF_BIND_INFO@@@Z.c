/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C00350E0
 * Callers:
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0034E00 (-FxStubDriverUnloadCommon@@YAXXZ.c)
 * Callees:
 *     WdfVersionUnbindClass_0 @ 0x1C0035190 (WdfVersionUnbindClass_0.c)
 */
...
void __fastcall FxStubUnbindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  if ( off_1C005B6A8 != &__KMDF_CLASS_BIND_START && &__KMDF_CLASS_BIND_END <= (_QWORD *)off_1C005B6A8 )
  {
    do
    {
