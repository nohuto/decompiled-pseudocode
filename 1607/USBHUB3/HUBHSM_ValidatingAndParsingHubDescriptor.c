/*
 * XREFs of HUBHSM_ValidatingAndParsingHubDescriptor @ 0x1C00083B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
    v5 = 2045;
    WPP_RECORDER_SF_(*(_QWORD *)(v1 + 2464), 2u, 3u, 0x21u, (__int64)&WPP_aebd157f2d2c311e8b884f2de7866b9a_Traceguids);
    return v5;
  }
