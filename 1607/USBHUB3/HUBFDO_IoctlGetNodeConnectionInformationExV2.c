/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInformationExV2 @ 0x1C00665C8
 * Callers:
 ...
 *     HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher @ 0x1C0025BC4 (HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher.c)
 *     HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher @ 0x1C0025C00 (HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher.c)
        ...
        if ( (v12 & 4) != 0 )
        {
          ...
          *((_DWORD *)v28 + 1) = 16;
          (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 2200))(
            ...
            a2,
            16LL);
          for ( i = *(_QWORD *)(v9 + 2304); ; i = *(_QWORD *)(v14 + 248) )
          {
            v14 = i - 248;
            if ( v9 + 2304 == v14 + 248 )
              break;
            if ( *(_WORD *)(v14 + 200) == (_WORD)v7 )
            {
              ...
              {
                *((_DWORD *)v28 + 2) |= 1u;
                if ( *(_DWORD *)(v9 + 232) == 2 || *(_DWORD *)(v9 + 2160) == 4 )
                  *((_DWORD *)v28 + 2) |= 2u;
              }
              else if ( v19 == 768 )
              {
