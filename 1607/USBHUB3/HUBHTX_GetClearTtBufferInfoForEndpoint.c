/*
 * XREFs of HUBHTX_GetClearTtBufferInfoForEndpoint @ 0x1C00059F4
 * Callers:
...
__int64 __fastcall HUBHTX_GetClearTtBufferInfoForEndpoint(__int64 a1, __int64 a2, char a3, _WORD *a4)
{
  ...
  *a4 = 0;
  if ( v5 )
  {
    if ( a2 == *(_QWORD *)(a1 + 88) )
    {
      *a4 = a3 & 0xF | (16 * (*(_WORD *)(a1 + 1632) & 0x7F));
      return 0;
    }
    else
    {
      ...
      for ( i = *v8; ; i = *(_QWORD *)(v10 + 8) )
      {
        ...
        if ( v11 )
        {
          ...
          v15 = a3 & 0xF | *a4 & 0xF800 | (16 * (*(_WORD *)(a1 + 1632) & 0x7F));
          *a4 = v15;
          if ( a3 < 0 )
            *a4 = v15 | 0x8000;
          return 0;
