/*
 * XREFs of HUBDESC_ValidateDeviceDescriptor @ 0x1C002E3F4
 * Callers:
        ...
        __int64 a5)
{
  ...
  {
    v9 = a5;
    WPP_RECORDER_SF_(a5, 2u, 5u, 0xF2u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    v10 = 79LL;
LABEL_3:
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), v10);
LABEL_50:
    v16 = 0;
    WPP_RECORDER_SF_(v9, 2u, 5u, 0xFFu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    return v16;
  }
  if ( a2 < 2 )
  {
    ...
    LODWORD(v28) = a2;
LABEL_6:
    WPP_RECORDER_SF_d(v9, 2u, 5u, v11, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
    v10 = 71LL;
    goto LABEL_3;
  }
  v9 = a5;
  if ( *a1 < 0x12u )
  {
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF4u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, *a1);
  ...
  {
    LODWORD(v28) = v12;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF5u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
  ...
  {
    LODWORD(v28) = v13;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF7u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
  ...
  {
    LODWORD(v28) = v15;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF8u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
...
LABEL_26:
  ...
  if ( v17 )
  {
    switch ( v17 )
    {
      ...
      case 2:
        ...
        {
          LODWORD(v28) = v23;
          WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFCu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
      ...
      case 3:
        ...
        {
          LODWORD(v28) = v26;
          WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFEu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
          (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL);
  ...
  else
  {
    ...
    {
      LODWORD(v28) = v18;
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF9u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
      (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL);
...
LABEL_44:
        ...
        WPP_RECORDER_SF_d(a5, 2u, 5u, v21, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v28);
        (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL);
        v5 = 2;
      }
    }
