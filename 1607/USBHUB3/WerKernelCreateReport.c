/*
 * XREFs of WerKernelCreateReport @ 0x1C0034364
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0071FB4 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpCreateRegistryKey @ 0x1C0033E8C (WerpCreateRegistryKey.c)
 *     CheckSpaceAvailable @ 0x1C0034244 (CheckSpaceAvailable.c)
 */
