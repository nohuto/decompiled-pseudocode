/*
 * XREFs of HUBSM_RunStateMachine @ 0x1C0009C00
 * Callers:
 *     HUBSM_EvtSmWorkItem @ 0x1C0009780 (HUBSM_EvtSmWorkItem.c)
...
LABEL_30:
      ...
      {
        g_IoSetActivityIdIrp(*(_QWORD *)(v18 + 248), v20);
        if ( g_IoSetActivityIdIrp )
          g_IoSetActivityIdIrp(*(_QWORD *)(v18 + 408), v20);
      }
