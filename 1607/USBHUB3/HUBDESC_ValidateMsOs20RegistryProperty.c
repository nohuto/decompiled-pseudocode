/*
 * XREFs of HUBDESC_ValidateMsOs20RegistryProperty @ 0x1C002F920
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    ...
    v6 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Cu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    return v6;
  }
  v8 = a3[3];
