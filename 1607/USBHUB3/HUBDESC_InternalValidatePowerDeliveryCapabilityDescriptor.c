/*
 * XREFs of HUBDESC_InternalValidatePowerDeliveryCapabilityDescriptor @ 0x1C002BD38
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( v12 )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v10, 2u, v14, 0x88u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v8, *a1, 18);
      goto LABEL_25;
    }
    v15 = v23;
    *v5 = 2;
  ...
  if ( *a1 > 0x12u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
      *v5 = 2;
    WPP_RECORDER_SF_DDD(v10, 2u, v16, 0x89u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v8, *a1, 18);
  ...
  if ( *v23 <= v22 )
  {
    ...
    if ( (a1[4] & 0x20) != 0 )
    {
      *(_BYTE *)(*(_QWORD *)(a2 + 80) + 41LL) = 1;
      WPP_RECORDER_SF_(v10, 4u, 5u, 0x8Cu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    }
  }
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v5 = 2;
    LODWORD(v20) = v8;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0x8Au, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v20);
...
LABEL_25:
  ...
  {
    v9 = 0;
    WPP_RECORDER_SF_(v10, 2u, 5u, 0x8Du, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  }
  return v9;
}
