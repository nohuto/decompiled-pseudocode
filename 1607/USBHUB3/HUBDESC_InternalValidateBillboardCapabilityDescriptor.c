/*
 * XREFs of HUBDESC_InternalValidateBillboardCapabilityDescriptor @ 0x1C002C49C
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *a3 <= v10 )
  {
    ...
    if ( result )
    {
      if ( result <= 0x80u )
      {
        ...
        *v5 = 1;
        LODWORD(v17) = a1[5];
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0xA2u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v17);
        v16 = 241LL;
      }
      else
      {
        *v5 = 1;
        LODWORD(v17) = a1[4];
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0xA1u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v17);
        v16 = 239LL;
      }
    }
    else
    {
      *v5 = 1;
      WPP_RECORDER_SF_(v11, 2u, 5u, 0xA0u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
      v16 = 238LL;
    }
  }
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v5 = 2;
    LODWORD(v17) = v9;
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x9Fu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v17);
    v16 = 237LL;
  }
  result = (*(__int64 (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), v16);
LABEL_24:
  if ( *v5 )
    return WPP_RECORDER_SF_(v11, 2u, 5u, 0xA6u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  return result;
}
