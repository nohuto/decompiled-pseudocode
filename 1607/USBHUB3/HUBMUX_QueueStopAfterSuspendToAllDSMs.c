/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x1C000D22C
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1C0007620 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
...
void __fastcall HUBMUX_QueueStopAfterSuspendToAllDSMs(__int64 a1)
{
  ...
  *(_DWORD *)(v2 + 12) = v6;
  ...
  if ( &v17 != v17 )
  {
    do
    {
      HUBSM_AddEvent((__int64)(v13 + 61), 0xFBAu);
