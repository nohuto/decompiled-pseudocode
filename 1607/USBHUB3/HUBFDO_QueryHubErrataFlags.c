/*
 * XREFs of HUBFDO_QueryHubErrataFlags @ 0x1C00672B4
 * Callers:
 *     HUBHSM_QueryingForHubHackFlags @ 0x1C0007680 (HUBHSM_QueryingForHubHackFlags.c)
 * Callees:
...
__int64 __fastcall HUBFDO_QueryHubErrataFlags(__int64 a1)
{
  ...
  {
    v4 = a1 + 2400;
    HUBMISC_ConvertUsbDeviceIdsToString((unsigned __int16 *)(a1 + 2400), pszDest, v9, v7);
    v3 = v4;
  }
  else
  {
    ...
    if ( v2 )
    {
      if ( v2 == 1 )
      {
        *(_DWORD *)pszDest = *(_DWORD *)(a1 + 156);
        v12 = *(_BYTE *)(a1 + 160);
        *(_DWORD *)v9 = *(_DWORD *)(a1 + 161);
        v10 = *(_BYTE *)(a1 + 165);
        *(_DWORD *)v7 = *(_DWORD *)(a1 + 166);
        v8 = *(_BYTE *)(a1 + 170);
      }
      else
      {
    ...
    else
    {
      ...
      RtlStringCchPrintfA(v9, 5uLL, "%04X", *(_DWORD *)(a1 + 160));
      RtlStringCchPrintfA(v7, 5uLL, "%04X", *(unsigned __int16 *)(a1 + 164));
    }
    v3 = a1 + 2400;
  }
