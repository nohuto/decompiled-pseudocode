/*
 * XREFs of HUBREG_QueryHubErrataFlags @ 0x1C006C5B4
 * Callers:
...
LABEL_26:
  ...
  {
    WER_CreateReport(a1, 0x800000000LL, 0x800000LL, 12290, 0);
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 4u, 3u, 0x26u, (__int64)&WPP_d9e6b8ce2d2d3a2fc161dd0ed8437b42_Traceguids);
  }
  v8 = 0;
LABEL_75:
  if ( v22 )
