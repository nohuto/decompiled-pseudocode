/*
 * XREFs of HUBDESC_InternalValidateStringDescriptor @ 0x1C002E1C4
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( (unsigned int)a2 < 2 )
  {
    *a3 = 0;
    v9 = a5;
    v17 = a2;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xEBu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v17);
    (*(void (__fastcall **)(_QWORD, __int64))(a6 + 24))(*(_QWORD *)(a6 + 40), 131LL);
LABEL_14:
    v13 = 0;
    WPP_RECORDER_SF_(v9, 2u, 5u, 0xF1u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    return v13;
  }
  v10 = *a1;
  v9 = a5;
  *a3 = v10;
  ...
  if ( *a1 <= 2u )
  {
    ...
    *a3 = v7;
    v18 = v7;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xEDu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v18);
  ...
  if ( v11 != 3 )
  {
    ...
    v20 = 3;
    LODWORD(v16) = v11;
    WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xEEu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v16, v20);
  ...
  if ( (*a1 & 1) != 0 )
  {
    *a3 &= ~1u;
    ...
    LODWORD(v19) = *a3;
    LODWORD(v16) = v12;
    WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xEFu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v16, v19);
  ...
  if ( *a1 != v7 )
  {
    LODWORD(v19) = v7;
    LODWORD(v16) = *a1;
    WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xF0u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v16, v19);
