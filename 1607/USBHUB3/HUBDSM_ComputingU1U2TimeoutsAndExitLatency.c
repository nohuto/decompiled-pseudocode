/*
 * XREFs of HUBDSM_ComputingU1U2TimeoutsAndExitLatency @ 0x1C001BE10
 * Callers:
 *     <none>
 * Callees:
 *     HUBMISC_ComputeU1Timeout @ 0x1C002566C (HUBMISC_ComputeU1Timeout.c)
 *     HUBMISC_ComputeU2Timeout @ 0x1C002588C (HUBMISC_ComputeU2Timeout.c)
 */
...
__int64 __fastcall HUBDSM_ComputingU1U2TimeoutsAndExitLatency(__int64 a1)
{
  ...
  if ( v5 || v4 )
  {
    ...
    v9 = *(unsigned __int16 *)(v1 + 2558)
       + *(unsigned __int16 *)(*(_QWORD *)v1 + 1132LL)
       + *(unsigned __int16 *)(*(_QWORD *)v1 + 2436LL);
