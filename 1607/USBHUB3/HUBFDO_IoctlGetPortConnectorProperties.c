/*
 * XREFs of HUBFDO_IoctlGetPortConnectorProperties @ 0x1C006620C
 * Callers:
...
LABEL_8:
  ...
  WPP_RECORDER_SF_d(v9[308], 2u, 3u, 0x32u, (__int64)&WPP_771bea9a86b4322fb3e9b71551aa114b_Traceguids, v10);
LABEL_10:
