/*
 * XREFs of HUBMISC_InitializeHsm @ 0x1C006AA80
 * Callers:
...
__int64 __fastcall HUBMISC_InitializeHsm(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 2168) = a1;
  ...
  if ( v5 < 0 )
  {
    v7 = 10;
LABEL_3:
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2464), 2u, 3u, v7, (__int64)&WPP_ad6d99566eff37ab7f3364317bcf702c_Traceguids, v5);
    return v6;
  }
  ...
  *(_QWORD *)(a1 + 2248) = Timer;
  if ( Timer )
  {
    ...
    *(_QWORD *)(a1 + 2200) = v13;
    if ( !v13 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0xDu, (__int64)&WPP_ad6d99566eff37ab7f3364317bcf702c_Traceguids);
      return (unsigned int)-1073741670;
    }
  }
  else
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0xCu, (__int64)&WPP_ad6d99566eff37ab7f3364317bcf702c_Traceguids);
  }
  return v6;
}
