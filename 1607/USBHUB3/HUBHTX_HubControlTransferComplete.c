/*
 * XREFs of HUBHTX_HubControlTransferComplete @ 0x1C00029E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHTX_HubControlTransferComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v4 < 0 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x8000) != 0 )
    {
      ...
      LODWORD(v14) = v5;
      LODWORD(v12) = 0;
      Template_pqqq(v9, &USBHUB3_ETW_EVENT_HUB_CONTROL_TRANSFER_ERROR, 0LL, *(_QWORD *)(a4 + 224), v12, v14, v15);
    }
    if ( (*(_DWORD *)(a4 + 2536) & 2) != 0 )
      HUBMISC_VerifierDbgBreak("HubHwVerifierControlTransferFailure", a4 + 1208);
    *(_DWORD *)(a4 + 2540) = 1073872897;
  }
  v10 = 2004LL;
  if ( v4 >= 0 )
    v10 = 2008LL;
