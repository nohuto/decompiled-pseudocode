/*
 * XREFs of Template_ppqq @ 0x1C000F9A0
 * Callers:
 *     HUBMISC_LogDescriptorValidationErrorForDevice @ 0x1C00280F0 (HUBMISC_LogDescriptorValidationErrorForDevice.c)
 *     HUBMISC_LogDescriptorValidationWarningForDevice @ 0x1C0028180 (HUBMISC_LogDescriptorValidationWarningForDevice.c)
 *     HUBMISC_LogDescriptorValidationErrorForHub @ 0x1C0028220 (HUBMISC_LogDescriptorValidationErrorForHub.c)
 *     HUBMISC_LogDescriptorValidationWarningForHub @ 0x1C0028260 (HUBMISC_LogDescriptorValidationWarningForHub.c)
