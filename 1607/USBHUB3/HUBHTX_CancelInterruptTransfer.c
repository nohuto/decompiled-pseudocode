/*
 * XREFs of HUBHTX_CancelInterruptTransfer @ 0x1C00033B4
 * Callers:
 *     HUBHSM_CancellingInterruptTransferOnSuspend @ 0x1C0007030 (HUBHSM_CancellingInterruptTransferOnSuspend.c)
 * Callees:
