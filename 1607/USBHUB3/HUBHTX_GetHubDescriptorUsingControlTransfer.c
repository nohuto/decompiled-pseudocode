/*
 * XREFs of HUBHTX_GetHubDescriptorUsingControlTransfer @ 0x1C0002C50
 * Callers:
 *     HUBHSM_GettingHubDescriptor @ 0x1C0008210 (HUBHSM_GettingHubDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBHTX_GetHubDescriptorUsingControlTransfer(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v4 > 0 )
  {
    ...
    if ( v4 == 3 )
    {
      ...
      v6 = 12LL;
LABEL_6:
      result = HUBHTX_GetDescriptor(a1, a1 + 1124, v6, a4, v8, 1);
      goto LABEL_8;
    }
  }
  result = 3221225473LL;
