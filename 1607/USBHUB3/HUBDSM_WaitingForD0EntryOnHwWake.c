/*
 * XREFs of HUBDSM_WaitingForD0EntryOnHwWake @ 0x1C001AF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_WaitingForD0EntryOnHwWake(__int64 a1)
{
  ...
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *))(WdfFunctions_01015 + 1616))(
         ...
         off_1C00580E8);
  WPP_RECORDER_SF_q(*(_QWORD *)(v5 + 64), 4u, 2u, 0x73u, (__int64)&WPP_54842a9813333d375964e0f94b002c66_Traceguids, v4);
  return 1000LL;
}
