/*
 * XREFs of HUBHSM_ResettingInterruptPipeOnFailure @ 0x1C0007930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_ResettingInterruptPipeOnFailure(__int64 a1)
{
  ...
  v1 = *(_QWORD **)(a1 + 960);
  memset(v1 + 96, 0, 0x28uLL);
  v2 = WdfDriverGlobals;
  v1[97] = v1[28];
  *((_DWORD *)v1 + 192) = 1966120;
  v1[99] = v1[131];
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, _QWORD))(WdfFunctions_01015 + 2024))(
          ...
          0LL) )
  {
    WPP_RECORDER_SF_(v1[308], 2u, 3u, 0x11u, (__int64)&WPP_d887d9a76eb73ffd9207a7a58ef2b697_Traceguids);
    if ( (*(int (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2032))(WdfDriverGlobals, v4) < 0 )
      HUBSM_AddEvent(v1 + 151, 2012LL);
  }
  return 1000LL;
}
