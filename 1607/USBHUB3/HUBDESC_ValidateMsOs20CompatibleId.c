/*
 * XREFs of HUBDESC_ValidateMsOs20CompatibleId @ 0x1C002F730
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20CompatibleId(__int64 a1, __int64 a2, _WORD *a3)
{
  ...
  if ( (*(_BYTE *)a2 & 0x20) != 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Fu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  ...
  do
  {
    ...
    if ( *v12 )
    {
      if ( v11 == 1 )
      {
        v20 = 321;
LABEL_26:
        WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, v20, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
        v9 = 168LL;
        goto LABEL_6;
      }
