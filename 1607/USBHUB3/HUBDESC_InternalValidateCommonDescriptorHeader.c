/*
 * XREFs of HUBDESC_InternalValidateCommonDescriptorHeader @ 0x1C0028E50
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = 0;
  if ( v11 < 2 )
  {
    *v5 = 1;
    v12 = a5;
    WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xDu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v11, 2);
    v13 = 90LL;
LABEL_19:
  ...
  *a3 = v14;
  ...
  if ( *a1 < 2u )
  {
    ...
    LODWORD(v19) = v8;
    LODWORD(v18) = *a1;
    WPP_RECORDER_SF_DDD(v12, 2u, v15, 0x10u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v18, v19, v20);
  ...
  if ( !*a1 )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v5 = 1;
    LODWORD(v18) = v8;
    WPP_RECORDER_SF_d(v12, 2u, 5u, 0x11u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v18);
    v13 = 91LL;
    goto LABEL_19;
  }
LABEL_20:
  if ( *v5 )
  {
    WPP_RECORDER_SF_(v12, 2u, 5u, 0x12u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    return 0;
  }
  return v10;
}
