/*
 * XREFs of HUBHTX_CheckAndSelectIfAny30PortChangeSet @ 0x1C0004504
 * Callers:
 *     HUBPSM30_CheckIfThereIsAPortChangeOnStartResumeOnGetPortStatus @ 0x1C000F1A0 (HUBPSM30_CheckIfThereIsAPortChangeOnStartResumeOnGetPortStatus.c)
 * Callees:
