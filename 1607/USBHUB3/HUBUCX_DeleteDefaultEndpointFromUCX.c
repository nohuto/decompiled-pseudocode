/*
 * XREFs of HUBUCX_DeleteDefaultEndpointFromUCX @ 0x1C001EA14
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30 @ 0x1C00185B0 (HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30.c)
 * Callees:
