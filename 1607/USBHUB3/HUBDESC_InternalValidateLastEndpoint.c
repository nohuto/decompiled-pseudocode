/*
 * XREFs of HUBDESC_InternalValidateLastEndpoint @ 0x1C002938C
 * Callers:
...
bool __fastcall HUBDESC_InternalValidateLastEndpoint(__int64 a1, int *a2, __int64 a3)
{
  ...
  if ( (v6 & 2) != 0 )
  {
    if ( *(_DWORD *)(a1 + 4) == 3 )
    {
      ...
      {
        *v4 = 2;
        WPP_RECORDER_SF_(a3, 2u, 5u, 0x1Bu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
      ...
      {
        *v4 = 2;
        WPP_RECORDER_SF_(a3, 2u, 5u, 0x1Cu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
