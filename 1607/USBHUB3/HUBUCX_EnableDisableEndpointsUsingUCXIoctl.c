/*
 * XREFs of HUBUCX_EnableDisableEndpointsUsingUCXIoctl @ 0x1C001D258
 * Callers:
 ...
 *     HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency @ 0x1C001ACD0 (HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency.c)
...
LABEL_4:
  ...
  memset(v8, 0, 0x58uLL);
  *v8 = 88;
  *((_QWORD *)v8 + 1) = *(_QWORD *)(*(_QWORD *)a1 + 224LL);
