/*
 * XREFs of Template_pqqhhhq @ 0x1C000FAA4
 * Callers:
 ...
 *     EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x1C0015A24 (EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0034DE0 (__security_check_cookie.c)
 */

NTSTATUS Template_pqqhhhq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  return EtwWrite(
           ...
           &USBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_V1,
           a3,
           7u,
           &UserData);
}
