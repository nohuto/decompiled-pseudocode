/*
 * XREFs of HUBACPI_EnumChildren @ 0x1C006FF1C
 * Callers:
...
LABEL_4:
  ...
  *(_DWORD *)(v19 + 4) = 1;
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, _QWORD *))(WdfFunctions_01015 + 2024))(
          ...
          v12,
          v23) )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0x1Bu, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
...
LABEL_27:
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, v14, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
    goto LABEL_27;
  }
  if ( v7 != -1073741637 )
  {
