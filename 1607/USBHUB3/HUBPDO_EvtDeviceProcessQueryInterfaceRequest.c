/*
 * XREFs of HUBPDO_EvtDeviceProcessQueryInterfaceRequest @ 0x1C00142F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPDO_EvtDeviceProcessQueryInterfaceRequest(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (v6[202] & 2) != 0 )
  {
    ...
    *(_QWORD *)(a3 + 24) = HUBFDO_GetPortStatusForDebuggingComplete;
    ...
    v8 = *(_BYTE *)(*v6 + 216) + 1;
    *(_BYTE *)(a3 + 32) = v8;
    *(_BYTE *)(a3 + 52) = BYTE1(*((_DWORD *)v6 + 404)) & 1;
    v9 = *v6;
    *(_OWORD *)(a3 + 96) = *(_OWORD *)(*v6 + 280);
    *(_OWORD *)(a3 + 112) = *(_OWORD *)(v9 + 296);
    if ( v8 == 1 )
    {
    ...
    {
      *(_WORD *)(a3 + 2LL * (v8 - 2) + 114) = *(_WORD *)(v6[1] + 200);
    }
    *(_DWORD *)(a3 + 48) = *((_DWORD *)v6 + 39);
    *(_BYTE *)(a3 + 53) = (v6[202] & 0x1000) != 0;
    *(_QWORD *)(a3 + 40) = v6[3];
