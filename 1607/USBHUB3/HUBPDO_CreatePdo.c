/*
 * XREFs of HUBPDO_CreatePdo @ 0x1C00698F0
 * Callers:
 *     HUBDSM_CreatingChildPDOAndReportingToPnp @ 0x1C001A480 (HUBDSM_CreatingChildPDOAndReportingToPnp.c)
 * Callees:
...
__int64 __fastcall HUBPDO_CreatePdo(_QWORD *a1)
{
  ...
  *((_DWORD *)a1 + 604) = 0;
  ...
  if ( PdoInternal == 4077 )
  {
    v3 = *(void (__fastcall **)(_QWORD, _QWORD, __int64))(*a1 + 400LL);
