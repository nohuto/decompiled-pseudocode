/*
 * XREFs of HUBHSM_CheckingPSMInterruptReferencesOnReset @ 0x1C0007240
 * Callers:
 *     <none>
 * Callees:
 *     HUBMUX_QueueSurpriseRemovalToAllPSMs @ 0x1C000CCDC (HUBMUX_QueueSurpriseRemovalToAllPSMs.c)
 *     HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased @ 0x1C000CDEC (HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased.c)
 */
