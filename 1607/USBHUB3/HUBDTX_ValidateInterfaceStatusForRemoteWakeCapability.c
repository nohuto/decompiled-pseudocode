/*
 * XREFs of HUBDTX_ValidateInterfaceStatusForRemoteWakeCapability @ 0x1C00204B4
 * Callers:
 *     HUBDSM_ValidatingInterfaceStatusForRemoteWake @ 0x1C001C4B0 (HUBDSM_ValidatingInterfaceStatusForRemoteWake.c)
 * Callees:
