/*
 * XREFs of HUBPARENT_SetHubConfiguration @ 0x1C0006328
 * Callers:
 *     HUBHSM_SettingHubConfiguration @ 0x1C0008370 (HUBHSM_SettingHubConfiguration.c)
 * Callees:
...
LABEL_9:
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0xCu, (__int64)&WPP_d887d9a76eb73ffd9207a7a58ef2b697_Traceguids);
LABEL_20:
  if ( v13 )
