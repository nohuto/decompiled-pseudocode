/*
 * XREFs of WPP_RECORDER_SF_qd @ 0x1C00028BC
 * Callers:
 *     HUBHTX_Get30PortChangeEvent @ 0x1C000499C (HUBHTX_Get30PortChangeEvent.c)
 *     HUBHSM_WaitingForOvercurrentToClear @ 0x1C0007DA0 (HUBHSM_WaitingForOvercurrentToClear.c)
 *     HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax @ 0x1C0023DD0 (HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax.c)
 *     HUBMISC_StartOverCurrentTimer @ 0x1C0026ECC (HUBMISC_StartOverCurrentTimer.c)
 *     HUBMISC_StartD3ColdReconnectTimer @ 0x1C0026FAC (HUBMISC_StartD3ColdReconnectTimer.c)
 * Callees:
