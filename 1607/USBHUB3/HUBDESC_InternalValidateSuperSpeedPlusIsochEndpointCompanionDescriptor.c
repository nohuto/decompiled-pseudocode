/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedPlusIsochEndpointCompanionDescriptor @ 0x1C002AC78
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v11;
  ...
  {
    v14 = a5;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0x61u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v10);
  ...
  if ( (unsigned __int8)v11 < 8u )
  {
    ...
    *a4 = 2;
    ...
    WPP_RECORDER_SF_DDDD(v14, 8LL, v15, 0x63u, v21);
  }
  if ( *a1 > 8u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
      *a4 = 2;
    WPP_RECORDER_SF_DDD(v14, 2u, v18, 0x64u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, *a1, v10, 8);
    ...
    *(_DWORD *)(a2 + 256) = v19 & 0xFFFFFFD7 | 0x20;
    if ( *a3 > v25 )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
        *a4 = 2;
      LODWORD(v22) = v10;
      WPP_RECORDER_SF_d(v14, 2u, 5u, 0x66u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v22);
      v20 = 209LL;
LABEL_23:
    ...
    if ( *((_WORD *)a1 + 1) )
    {
      ...
      LODWORD(v22) = v10;
      WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x67u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v22, v23);
...
LABEL_33:
    if ( !*a4 )
      return result;
    return WPP_RECORDER_SF_(v14, 2u, 5u, 0x69u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  }
  LODWORD(v22) = v10;
  WPP_RECORDER_SF_d(v14, 2u, 5u, 0x65u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids, v22);
