/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x1C002FE9C
 * Callers:
...
LABEL_23:
    *(_DWORD *)a2 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x161u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
    return v5;
  }
  if ( v7 < 0xA )
  {
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x160u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
