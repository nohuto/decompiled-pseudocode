/*
 * XREFs of HUBPDO_ValidateSelectConfigUrb @ 0x1C0011320
 * Callers:
 *     HUBDSM_ValidatingSelectConfigUrbFromConfigured @ 0x1C0018070 (HUBDSM_ValidatingSelectConfigUrbFromConfigured.c)
 * Callees:
...
__int64 __fastcall HUBPDO_ValidateSelectConfigUrb(__int64 a1)
{
  ...
  if ( !v6 )
  {
    ...
    *(_DWORD *)(v1 + 36) = v9;
    if ( *(_BYTE *)(v8 + 216) && v9 > *(_DWORD *)(v8 + 84) )
    {
      WPP_RECORDER_SF_(
