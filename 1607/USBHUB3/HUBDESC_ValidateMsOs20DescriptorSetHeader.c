/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSetHeader @ 0x1C002F150
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20DescriptorSetHeader(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( (*(_BYTE *)a2 & 2) != 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x12Eu, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  ...
  if ( v6 == 1 )
    *(_DWORD *)a2 |= 2u;
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x130u, (__int64)&WPP_91309e1e7e68342ce699a1e67e712f7c_Traceguids);
  return v6;
}
