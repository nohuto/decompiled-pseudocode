/*
 * XREFs of __wmainCRTStartup @ 0x140002E50
 * Callers:
 *     wWinMainCRTStartup @ 0x1400030C0 (wWinMainCRTStartup.c)
 * Callees:
 *     wWinMain @ 0x140001C10 (wWinMain.c)
 *     _XcptFilter_0 @ 0x1400033FE (_XcptFilter_0.c)
 *     _amsg_exit_0 @ 0x1400034B4 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x140003510 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x14000368A (_initterm_0.c)
...
LABEL_18:
    ...
    dword_14000A180 = result;
    if ( !dword_14000A1A0 )
      exit(result);
    if ( !dword_14000A184 )
    {
      _cexit();
      return dword_14000A180;
    }
    return result;
  }
