/*
 * XREFs of ?GetFloat@CSettingsManager@@AEAAJPEBGPEAM@Z @ 0x14000486C
 * Callers:
 *     ?GetPreferenceFloat@CSettingsManager@@UEAAJPEBGPEAM@Z @ 0x1400049A0 (-GetPreferenceFloat@CSettingsManager@@UEAAJPEBGPEAM@Z.c)
 * Callees:
