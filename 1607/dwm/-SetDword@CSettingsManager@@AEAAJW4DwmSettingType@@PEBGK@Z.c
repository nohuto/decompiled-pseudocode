/*
 * XREFs of ?SetDword@CSettingsManager@@AEAAJW4DwmSettingType@@PEBGK@Z @ 0x1400049AC
 * Callers:
 *     ?SetPreferenceDword@CSettingsManager@@UEAAJPEBGK@Z @ 0x140004A50 (-SetPreferenceDword@CSettingsManager@@UEAAJPEBGK@Z.c)
 * Callees:
...
__int64 __fastcall CSettingsManager::SetDword(__int64 a1, __int64 a2, const WCHAR *a3, int a4)
{
  ...
  if ( v8 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xDDu);
