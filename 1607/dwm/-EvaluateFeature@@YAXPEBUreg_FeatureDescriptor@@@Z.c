/*
 * XREFs of ?EvaluateFeature@@YAXPEBUreg_FeatureDescriptor@@@Z @ 0x140004B50
 * Callers:
 *     ?EvaluateCurrentState@@YAHPEBUreg_FeatureDescriptor@@@Z @ 0x140004AA8 (-EvaluateCurrentState@@YAHPEBUreg_FeatureDescriptor@@@Z.c)
 * Callees:
 *     ?EvaluateCurrentStateFromRegistry@@YAHIHW4reg_FeatureStage@@EPEAE@Z @ 0x140004AD0 (-EvaluateCurrentStateFromRegistry@@YAHIHW4reg_FeatureStage@@EPEAE@Z.c)
 */
...
void __fastcall EvaluateFeature(const struct reg_FeatureDescriptor *a1)
{
    ...
    && g_Feature_2566179129_cachedvariant == 0x80000000 )
  {
    ...
    _InterlockedCompareExchange(
      ...
      0);
    _InterlockedCompareExchange(
      (volatile signed __int32 *)&g_Feature_2566179129_cachedvariant,
      (unsigned __int8)v1,
      0x80000000);
  }
}
