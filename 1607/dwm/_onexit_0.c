/*
 * XREFs of _onexit_0 @ 0x140003114
 * Callers:
 *     atexit @ 0x1400031A8 (atexit.c)
 * Callees:
 *     _lock_0 @ 0x1400036BA (_lock_0.c)
 *     _unlock_0 @ 0x1400036C6 (_unlock_0.c)
 *     __dllonexit_0 @ 0x1400036D2 (__dllonexit_0.c)
