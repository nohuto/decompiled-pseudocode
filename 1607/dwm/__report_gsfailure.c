/*
 * XREFs of __report_gsfailure @ 0x140003210
 * Callers:
 *     __security_check_cookie @ 0x1400030F0 (__security_check_cookie.c)
 * Callees:
 *     __raise_securityfailure @ 0x1400031C8 (__raise_securityfailure.c)
 */
...
void __cdecl __noreturn _report_gsfailure(uintptr_t StackCookie)
{
  ...
  qword_14000A1C0 = ContextRecord.Rip;
  ContextRecord.Rcx = StackCookie;
  dword_14000A1B0 = -1073740791;
  dword_14000A1B4 = 1;
  dword_14000A1C8 = 3;
  qword_14000A1D0[0] = 2LL;
  qword_14000A1D0[1] = _security_cookie;
  qword_14000A1D0[2] = _security_cookie_complement;
