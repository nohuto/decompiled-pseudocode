/*
 * XREFs of ?StartComposition@CDwmAppHost@@AEAAJXZ @ 0x140002110
 * Callers:
...
__int64 __fastcall CDwmAppHost::StartComposition(CDwmAppHost *this)
{
  ...
  if ( v1 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v1, 0xF4u);
  }
  else
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0xFEu);
    }
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, result, 0x100u);
    }
  }
  return v3;
}
