/*
 * XREFs of ?ProcessLPCCommand@CDwmAppHost@@AEAAJPEAVCPortMessage@@PEBUPORT_CONTEXT@@PEAH2@Z @ 0x1400012E0
 * Callers:
        ...
        int *a5)
{
  ...
  *a4 = 1;
  *a5 = 0;
  if ( (*(unsigned __int16 *)(v9 + 4) & 0xFFFF00FF) == 1 )
  {
    v16 = *(_DWORD *)(v9 + 40);
...
LABEL_25:
      ...
      v7 = v21;
      if ( v21 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x1BBu);
      *(_DWORD *)(v9 + 44) = v7;
    }
    else
    {
  ...
  if ( (*(unsigned __int16 *)(v9 + 4) & 0xFFFF00FF) != 3 )
    return v7;
  v11 = *(_DWORD *)(v9 + 40);
    ...
    if ( v14 )
    {
      if ( v14 == 2 )
      {
        if ( (_BYTE)v10 )
        {
          ...
          v7 = v15;
          if ( v15 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x173u);
        }
        return v7;
      }
LABEL_5:
