/*
 * XREFs of EtwpBufferingModeFlush @ 0x1800FD694
 * Callers:
 ...
 *     EtwpFindAndLockBufferForFlushing @ 0x1800FD874 (EtwpFindAndLockBufferForFlushing.c)
 */
...
__int64 __fastcall EtwpBufferingModeFlush(__int64 a1)
{
  ...
  {
    v6 = *(_QWORD *)(a1 + 8 * i + 528);
    if ( v6 )
    {
      *(_QWORD *)(a1 + 8 * i + 528) = 0LL;
