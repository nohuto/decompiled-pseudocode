/*
 * XREFs of RtlCheckHeldCriticalSections @ 0x1800824A0
 * Callers:
 *     RtlCheckForOrphanedCriticalSections @ 0x180082480 (RtlCheckForOrphanedCriticalSections.c)
 * Callees:
...
struct _PEB *__fastcall RtlCheckHeldCriticalSections(__int64 a1, _QWORD *a2)
{
  ...
  result = (struct _PEB *)memset(v19, 0, sizeof(v19));
  v23 = 0;
