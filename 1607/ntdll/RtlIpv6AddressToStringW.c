/*
 * XREFs of RtlIpv6AddressToStringW @ 0x18005C150
 * Callers:
...
PWSTR __stdcall RtlIpv6AddressToStringW(const struct in6_addr *Addr, PWSTR S)
{
  ...
  {
    if ( !Addr->u.Word[4] && ((Addr->u.Word[5] + 1) & 0xFFFE) == 0 )
    {
      v16 = (const char *)&unk_18010C822;
      if ( Addr->u.Word[5] )
        v16 = "ffff:";
      v27 = Addr->u.Byte[15];
      v24 = Addr->u.Byte[14];
    ...
    if ( Addr->u.Word[4] == 0xFFFF && !Addr->u.Word[5] )
    {
      ...
      v23 = Addr->u.Byte[14];
      v20 = Addr->u.Byte[13];
      v17 = swprintf_s(S, 0x2EuLL, L"::ffff:0:%u.%u.%u.%u", Addr->u.Byte[12], v20, v23, v26);
      return &v4[v17];
    }
  }
  v6 = 0;
  v7 = 0;
  v8 = 0;
  if ( (Addr->u.Word[4] & 0xFFFD) == 0 )
  {
    if ( Addr->u.Word[5] == 0xFE5E )
      v2 = 6;
    v28 = v2;
  }
  v9 = 0LL;
  ...
  do
  {
    if ( v11 >= v12 || v13 > v11 )
    {
      ...
      v14 = swprintf_s(v4, v3 - v4, L"%x", (unsigned __int16)__ROR2__(Addr->u.Word[v11], 8));
    }
    else
    {
  ...
  if ( v28 < 8 )
  {
    ...
    v22 = Addr->u.Byte[14];
    v19 = Addr->u.Byte[13];
    v4 += swprintf_s(v4, v3 - v4, L":%u.%u.%u.%u", Addr->u.Byte[12], v19, v22, v25);
  }
  return v4;
}
