/*
 * XREFs of RtlpSparseBitmapCtxFindRunsInternal @ 0x18010123C
 * Callers:
        ...
        char *a8)
{
  ...
  unsigned int v34; // [rsp+E0h] [rbp+38h]
  ...
  if ( (unsigned int)v14 < v12 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(a1 + 8) )
      {
        ...
        {
          v23 = *(_QWORD *)(a1 + 8);
          v20 = *(volatile signed __int64 **)(v22 + v23);
          if ( v20 )
          {
            v33 = 1;
            RtlpSparseBitmapCtxLockShared(a1, *(volatile signed __int64 **)(v22 + v23), v21, v22);
            v11 = a3;
          }
        }
      }
...
LABEL_17:
    ...
    if ( v20 )
      ...
      RunsFromRange = RtlpSparseBitmapCtxFindRunsFromNullRange(a1, v16, v24, a6, v8, v14, v13, a3, a8);
    v26 = RunsFromRange;
    goto LABEL_22;
  }
  return (__int64)&v8[-a7] / 24;
