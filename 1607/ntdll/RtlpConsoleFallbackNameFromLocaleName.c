...
LABEL_12:
        ...
        v22 = *(_QWORD *)(pTblPtrs + 40) + 2LL;
        v23 = (const wchar_t *)(v22 + 2LL * *(unsigned int *)(v17 + v16 + 276));
...
LABEL_45:
        ...
        if ( wcsicmp(v23, String2) )
        {
          ...
          if ( v25 < 0 )
            goto LABEL_41;
          _mm_lfence();
          v26 = *(unsigned __int16 *)(*(_QWORD *)(pTblPtrs + 32) + 8LL * v25 + 2) * *(unsigned __int16 *)(pTblPtrs + 56);
