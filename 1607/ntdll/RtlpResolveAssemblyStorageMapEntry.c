/*
 * XREFs of RtlpResolveAssemblyStorageMapEntry @ 0x180068EAC
 * Callers:
      ...
      if ( !v44 )
      {
        ...
        if ( v45 )
        {
          while ( 1 )
          {
            ...
            v42 = 34996224;
            LOWORD(v41) = 0;
            RtlpAssemblyStorageMapResolutionDefaultCallback(2LL, &v39, v50);
            if ( (_BYTE)v41 )
              break;
            if ( BYTE1(v41) )
            {
...
LABEL_22:
          v39 = v38;
          RtlpAssemblyStorageMapResolutionDefaultCallback(4LL, &v39, v50);
          goto LABEL_23;
        }
        goto LABEL_18;
      }
