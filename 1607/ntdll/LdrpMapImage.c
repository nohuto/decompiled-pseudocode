/*
 * XREFs of LdrpMapImage @ 0x18002F43C
 * Callers:
...
__int64 __fastcall LdrpMapImage(HANDLE SectionHandle, __int64 a2, char a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  v10 = (PVOID *)(a2 + 48);
  v34 = v9;
  v11 = LdrpMapViewOfSection(SectionHandle, *(_QWORD *)(a2 + 96), *(void **)(a2 + 80), v9, (PVOID *)(a2 + 48), &Size);
  v12 = v11;
  v13 = v11;
  if ( v11 < 0 )
  {
...
LABEL_9:
  ...
  v28 = LdrpHashUnicodeString((_UNICODE_STRING *)(a2 + 88));
  ...
  if ( !*a4 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( MEMORY[0x7FFE0384] && (NtCurrentPeb()->TracingFlags & 4) != 0 && (MEMORY[0x7FFE0385] & 0x20) != 0 )
      {
        LOBYTE(v17) = -1;
        LOBYTE(v16) = -1;
        LdrpLogEtwEvent(5264, (unsigned int)*v10, v16, v17, 0LL, 0LL);
      }
      if ( v34 )
      {
        v13 = -1073741800;
...
LABEL_44:
    ...
    if ( MEMORY[0x7FFE0384] && (NtCurrentPeb()->TracingFlags & 4) != 0 && (MEMORY[0x7FFE0385] & 0x20) != 0 )
    {
      LOBYTE(v17) = -1;
      LOBYTE(v16) = -1;
      LdrpLogEtwEvent(5265, (unsigned int)*v10, v16, v17, 0LL, 0LL);
    }
  }
  return v13;
}
