/*
 * XREFs of RtlpSysVolCreateSecurityDescriptor @ 0x18008C3E4
 * Callers:
 ...
 *     RtlSetControlSecurityDescriptor @ 0x180086C40 (RtlSetControlSecurityDescriptor.c)
...
__int64 __fastcall RtlpSysVolCreateSecurityDescriptor(unsigned __int64 *a1, char **a2)
{
  ...
  Heap = (_BYTE *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, 0x28uLL);
  ...
  if ( SecurityDescriptor >= 0 )
  {
    ...
    Src = 257;
    v15 = 18;
    v7 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, 0x1CuLL);
    v8 = (char *)v7;
    if ( v7 )
    {
