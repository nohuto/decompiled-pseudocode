/*
 * XREFs of RtlAddResourceAttributeAce @ 0x1800E1510
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlpValidAttributeInfo @ 0x1800E275C (RtlpValidAttributeInfo.c)
 */
            ...
            *a7 += (unsigned __int16)v23;
            ...
            if ( v27 && v27 + (unsigned __int64)v19 <= (unsigned __int64)&a1[*((unsigned __int16 *)a1 + 1)] )
            {
              ...
              *(_DWORD *)(v20 + 4) = 0;
              ...
              memmove((void *)(v20 + 8 + 4 * *(unsigned __int8 *)(a5 + 1) + 8), v9, v15);
              ++*((_WORD *)a1 + 2);
              *a1 = v26;
            }
            else
