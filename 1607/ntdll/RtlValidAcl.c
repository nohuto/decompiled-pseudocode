/*
 * XREFs of RtlValidAcl @ 0x180014FB0
 * Callers:
 ...
 *     RtlValidRelativeSecurityDescriptor @ 0x180076CB0 (RtlValidRelativeSecurityDescriptor.c)
 ...
 *     RtlpValidCompoundAce @ 0x1800E28A0 (RtlpValidCompoundAce.c)
 */
