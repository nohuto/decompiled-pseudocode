/*
 * XREFs of RtlFindClearBits @ 0x1800E3AA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall RtlFindClearBits(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  while ( 1 )
  {
    ...
    v19 = v14 + 8 * ((unsigned __int64)v16 >> 6);
    if ( a2 > 0x7F )
    {
      if ( (v16 & 0x3F) != 0 )
        v19 += 8LL;
...
LABEL_22:
      v15 = ((unsigned int)(((__int64)v17 - v14) >> 3) << 6) - v20;
      if ( v15 <= v16 )
      {
        v23 = a2 - v20;
        v24 = a2 - v20;
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( v21 )
            ...
            v36 = 63 - v35;
          v15 = (((unsigned int)(((__int64)v17 - v14) >> 3) + 1) << 6) - v36;
          if ( v15 > v16 )
            goto LABEL_72;
          v37 = a2 - v36;
          if ( a2 == v36 )
...
LABEL_63:
    ...
    {
      v29 = 0;
      v30 = (unsigned __int64 *)(v14 + 8 * ((unsigned __int64)v12 >> 6));
      while ( v18 != -1 )
      {
LABEL_43:
        ...
        if ( v29 + (int)v31 >= a2 )
        {
          LODWORD(v34) = -v29;
LABEL_74:
          v15 = ((unsigned int)(((__int64)v17 - v14) >> 3) << 6) + v34;
          v40 = v15 <= v16;
          goto LABEL_75;
        }
        v32 = a2;
    ...
    v15 = v41 + ((unsigned int)(((__int64)v17 - v14) >> 3) << 6);
    v40 = v15 <= v16;
LABEL_75:
    if ( !v40 )
      goto LABEL_72;
