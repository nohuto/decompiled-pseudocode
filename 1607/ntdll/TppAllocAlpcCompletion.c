/*
 * XREFs of TppAllocAlpcCompletion @ 0x180065614
 * Callers:
 *     TpAllocAlpcCompletion @ 0x180065490 (TpAllocAlpcCompletion.c)
 *     TpAllocAlpcCompletionEx @ 0x1800655F0 (TpAllocAlpcCompletionEx.c)
 * Callees:
