/*
 * XREFs of LZNT1CompressChunk @ 0x18008E5E0
 * Callers:
 *     RtlCompressBufferLZNT1 @ 0x18008E4F0 (RtlCompressBufferLZNT1.c)
 * Callees:
 *     LZNT1FindMatchStandard @ 0x18008E8C0 (LZNT1FindMatchStandard.c)
...
LABEL_18:
  ...
  v22 = (unsigned int *)&unk_18010E15C;
  v30 = (unsigned int *)&unk_18010E15C;
  v23 = a4 + 2;
  do
  {
    if ( &a2[*v22] < v17 )
    ...
    if ( (unsigned __int64)(v17 + 3) > v13 )
      goto LABEL_13;
    if ( (char *)v16 == (char *)LZNT1FindMatchStandard )
      MatchStandard = LZNT1FindMatchStandard(v17, v15);
    else
      MatchStandard = v16(v17, v15);
    v9 = v34;
    if ( !MatchStandard )
    {
      LOBYTE(v19) = v33;
