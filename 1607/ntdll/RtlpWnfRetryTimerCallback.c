/*
 * XREFs of RtlpWnfRetryTimerCallback @ 0x1800D9D60
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( qword_1801530A0 )
  {
    ...
    *(_QWORD *)(qword_1801530A0 + 88) = 0LL;
    ...
    while ( 1 )
    {
      ...
      RtlAcquireSRWLockShared((volatile signed __int64 *)(qword_1801530A0 + 8), MEMORY[0x7FFE03B0], 2147352584LL, v6);
      v12 = qword_1801530A0;
      v13 = qword_1801530A0 + 16;
      v14 = *(__int64 **)(qword_1801530A0 + 16);
