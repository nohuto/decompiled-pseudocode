/*
 * XREFs of RtlIsTextUnicode @ 0x1800614C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_87:
  ...
  if ( a2 > 2 && v4 <= 0x100 && (a2 & 1) == 0 && (*(_WORD *)(a1 + 2LL * (v16 - 1)) & 0xFF00) == 0 )
    --v16;
LABEL_9:
  if ( !v16 )
  {
...
LABEL_27:
  ...
  if ( NlsMbCodePageTag )
  {
    ...
    if ( v26 )
    {
      do
      {
        if ( NlsLeadByteInfoTable[*(unsigned __int8 *)(v31 + a1)] )
        {
          ++v27;
          ++v31;
        }
...
LABEL_32:
  v28 = a3;
  if ( NlsMbCodePageTag && v27 && a3 && (*a3 & 0x400) != 0 )
  {
    if ( v46 <= 0x100 )
