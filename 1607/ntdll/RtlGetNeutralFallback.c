/*
 * XREFs of RtlGetNeutralFallback @ 0x18003F59C
 * Callers:
...
__int64 __fastcall RtlGetNeutralFallback(__int64 a1, const WCHAR *a2, __int64 a3, _BYTE *a4)
{
...
LABEL_5:
    ...
    if ( (unsigned __int8)RtlCultureNameToLCID(&DestinationString, &v13) && ((v13 - 4096) & 0xFFFFFBFF) == 0 )
      *a4 = 1;
    if ( !*a4 )
      return (unsigned int)RtlGetParentLocaleName(a2, a3, 6, 0);
  }
