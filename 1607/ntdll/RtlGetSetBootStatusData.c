/*
 * XREFs of RtlGetSetBootStatusData @ 0x180087D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlGetSetBootStatusData(int a1, char a2, int a3, _BYTE *a4, int a5, _DWORD *a6)
{
  ...
  __int64 v13; // r8
  __int64 v14; // rdx
  _BYTE v15[4]; // [rsp+30h] [rbp-B8h] BYREF
  _DWORD v16[3]; // [rsp+34h] [rbp-B4h] BYREF
  ...
  if ( (int)result >= 0 )
  {
    result = RtlpGetSetBootStatusData(a1, 1, a3, (unsigned int)v17, 120, 0LL);
    if ( (int)result >= 0 )
    {
