/*
 * XREFs of RtlpHpVsContextFree @ 0x18001CC40
 * Callers:
...
__int64 __fastcall RtlpHpVsContextFree(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, _DWORD *a5)
{
  ...
  int v35; // ebx
  __int64 v36; // rcx
  void (__fastcall *v37)(__int64, __int64, _QWORD); // rax
  ...
  if ( (*(_WORD *)(a2 + 34) ^ 0xABED) == *(_WORD *)(a2 + 32) )
  {
    ...
    *a5 = 16 * (WORD1(RtlpLFHKey) ^ WORD1(v5) ^ *(unsigned __int16 *)(v5 + 2)) - 16;
    ...
    if ( ((HIDWORD(v5) ^ HIDWORD(RtlpLFHKey) ^ HIDWORD(*(_QWORD *)v5)) & 0xFF0000) != 0 )
    {
      ...
      while ( 1 )
      {
        v13 = RtlpHpVsChunkCoalesce(a1, v8, v5, &v40);
        v5 = v13;
        if ( v40 == *(unsigned __int16 *)(v8 + 32) )
        {
          RtlpHpVsSubsegmentCleanup(a1, v8);
          goto LABEL_21;
        }
        if ( v40 <= v12 )
          break;
        ...
        if ( v31 <= 8 )
          v31 = 8LL;
        if ( *(_QWORD *)(a1 + 48) + (unsigned __int64)(unsigned int)v32 <= v31 )
          break;
        ...
        *(_DWORD *)(v5 + 8) = (unsigned __int8)v33 | 0x200;
        ...
        RtlpHpVsSubsegmentCommitPages(a1, v8, v17, v32, 0);
        if ( !v35 )
          RtlAcquireSRWLockExclusive(a1);
        *(_DWORD *)(v5 + 8) &= ~0x200u;
        v12 = v40;
      ...
      *(_WORD *)v5 = v11 ^ v5 ^ (v23
      ...
      if ( v28 )
      {
        while ( 1 )
        {
          if ( ((unsigned int)v5 ^ (unsigned int)v11 ^ *(_DWORD *)v5) < ((unsigned int)v11 ^ ((_DWORD)v28 - 8) ^ *((_DWORD *)v28 - 2)) )
          {
            v29 = (_QWORD *)*v28;
            if ( !*v28 )
            {
      ...
      RtlRbInsertNodeEx((unsigned __int64 *)(a1 + 8), (unsigned __int64)v28, v26, v5 + 8);
      v8 = 0LL;
LABEL_21:
      if ( !v41 )
        RtlReleaseSRWLockExclusive((volatile signed __int64 *)a1);
      ...
      {
        v36 = *(_QWORD *)(a1 + 56);
        v37 = (void (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ RtlpHeapKey ^ *(_QWORD *)(a1 + 72));
    ...
    {
      RtlpLogHeapFailure(8, *(_QWORD *)(a1 + 56), v7, v5, 0LL, 0LL);
      if ( !v10 )
        RtlReleaseSRWLockExclusive((volatile signed __int64 *)a1);
      return 0LL;
    }
