/*
 * XREFs of RtlpLookupDynamicFunctionEntry @ 0x180080810
 * Callers:
 ...
 *     RtlpSearchFunctionTable @ 0x1800809B4 (RtlpSearchFunctionTable.c)
...
LABEL_29:
  ...
  v11 = (unsigned int *)RtlpSearchFunctionTable(v6[2], *((unsigned int *)v6 + 21), a1, v6[6]);
  RtlReleaseSRWLockShared(&RtlpDynamicFunctionTableLock);
  if ( v11 )
LABEL_41:
    *a2 = v12;
