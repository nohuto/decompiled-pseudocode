/*
 * XREFs of RtlGetProductInfo @ 0x180084830
 * Callers:
 *     <none>
 * Callees:
 *     CompareVersions @ 0x180084970 (CompareVersions.c)
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = *(_OWORD *)Type_8;
  v17 = xmmword_180112918;
  if ( (int)CompareVersions(Type_8, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180108850, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180108840, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
