/*
 * XREFs of RtlWow64LogMessageInEventLogger @ 0x1800D4370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlWow64LogMessageInEventLogger(__int16 a1, __int64 a2, unsigned int a3)
{
  ...
  void (__fastcall *v11)(__int64, __int64, _QWORD, _QWORD, _QWORD, __int16, _DWORD, __int64, _QWORD); // [rsp+58h] [rbp-20h] BYREF
  void (__fastcall *v12[2])(_QWORD); // [rsp+60h] [rbp-18h] BYREF
  unsigned __int64 v13; // [rsp+98h] [rbp+20h] BYREF

  result = LdrLoadDll(0LL, 0LL, (__int64)&unk_180109380, &v13);
  if ( (int)result >= 0 )
  {
    if ( (int)LdrGetProcedureAddress(v13, &qword_1801093A0, 0LL, (__int64)&v10) >= 0
      && (int)LdrGetProcedureAddress(v13, &qword_180109390, 0LL, (__int64)v12) >= 0
      && (int)LdrGetProcedureAddress(v13, &qword_1801093B0, 0LL, (__int64)&v11) >= 0 )
    {
