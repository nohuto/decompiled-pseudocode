...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( SubProcessTag == (void *)RtlpHpNullGUID )
    v4 = *((_QWORD *)&v16 + 1) - qword_1801533B8;
  if ( !v4 )
    return 0LL;
  if ( word_180150944 )
  {
    v6 = *(_QWORD *)(qword_180150938 + 8LL * ((unsigned __int16)word_180150944 - 1));
  ...
  while ( v10 );
  Mapping = RtlpHpTagContextFindMapping((__int64)&RtlpHpTagContext, &v16, v13 + 37 * v12);
  if ( Mapping )
  {
