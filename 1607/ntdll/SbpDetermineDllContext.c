/*
 * XREFs of SbpDetermineDllContext @ 0x18002E304
 * Callers:
...
__int64 __fastcall SbpDetermineDllContext(void *a1, _QWORD *a2)
{
  unsigned int v2; // ebx
  __int64 v5; // rax
  unsigned int v6; // edi
  ...
  if ( a2 && a1 )
  {
    ...
    {
      if ( (unsigned int)SbpRetrieveCompatibilityManifest(a1, (__int64 *)&v12, &v16) )
      {
        v9 = v12;
        if ( v12 )
        {
