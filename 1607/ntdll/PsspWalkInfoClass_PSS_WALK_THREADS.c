/*
 * XREFs of PsspWalkInfoClass_PSS_WALK_THREADS @ 0x1800085B4
 * Callers:
...
__int64 __fastcall PsspWalkInfoClass_PSS_WALK_THREADS(__int64 a1, __int64 *a2, _OWORD *a3)
{
  __int64 v5; // rcx
  ...
  {
    v11 = 0LL;
    result = ZwMapViewOfSection(v5, -1LL, a2, 0LL, 0LL, 0LL, &v11, 1, 0, 2);
    if ( (int)result < 0 )
      return result;
    a2[1] = 0LL;
  }
