/*
 * XREFs of TpCallbackIndependent @ 0x180065180
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall TpCallbackIndependent(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 72) = 2;
  if ( v6 && (*(_BYTE *)(v6 + 288) & 3) == 3 )
  {
    ...
    {
      v7 = *(_DWORD *)(v6 + 284);
      v8 = MEMORY[0x7FFE03C0] + *(_DWORD *)(*(_QWORD *)(v6 + 216) + 420LL);
      v9 = v8 + MEMORY[0x7FFE03C0];
      if ( v7 >= v8 && v7 <= (int)(v9 + MEMORY[0x7FFE03C0]) )
        break;
      if ( v7 == _InterlockedCompareExchange((volatile signed __int32 *)(v6 + 284), v9, v7) )
        AlpcAdjustCompletionListConcurrencyCount(*(HANDLE *)(v6 + 272), v9);
    }
  }
