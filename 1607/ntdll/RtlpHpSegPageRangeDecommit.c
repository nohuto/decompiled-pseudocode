/*
 * XREFs of RtlpHpSegPageRangeDecommit @ 0x180041808
 * Callers:
 ...
 * Callees:
 *     RtlpHpSegUpdateCommit @ 0x1800418F8 (RtlpHpSegUpdateCommit.c)
 *     RtlpHpSegPageRangeCalcCommitRegion @ 0x180041958 (RtlpHpSegPageRangeCalcCommitRegion.c)
...
__int64 __fastcall RtlpHpSegPageRangeDecommit(__int64 a1, int a2, int a3, int a4)
{
  ...
  if ( v6 )
  {
    ...
    v11 = (v9 & 0xFFFFFFFFFFF00000uLL) + ((unsigned int)((__int64)(v9 - (v9 & 0xFFFFFFFFFFF00000uLL)) >> 5) << 12);
    ZwFreeVirtualMemory(-1LL, &v11, &v10, 0x4000LL);
    RtlpHpSegUpdateCommit(a1, a2, v9, v8, -v6);
    if ( MEMORY[0x7FFE0380] )
    {
      if ( (NtCurrentPeb()->TracingFlags & 1) != 0 )
        RtlpLogHeapDecommit(a1, v11, v10, 13LL);
    }
  }
  return v6;
}
