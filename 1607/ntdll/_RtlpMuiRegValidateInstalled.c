...
__int64 __fastcall RtlpMuiRegValidateInstalled(__int64 a1)
{
  ...
  int v28; // edi
  __int64 v29; // rsi
  unsigned __int16 v30; // [rsp+28h] [rbp-E0h]
  ...
  wchar_t *v35; // [rsp+48h] [rbp-C0h]
  __int64 v36; // [rsp+50h] [rbp-B8h] BYREF
  WCHAR *v37; // [rsp+58h] [rbp-B0h]
  int v38; // [rsp+60h] [rbp-A8h] BYREF
  unsigned __int16 v39; // [rsp+64h] [rbp-A4h]
  __int16 v40; // [rsp+66h] [rbp-A2h]
  __int16 v41; // [rsp+68h] [rbp-A0h]
  _WORD v42[14]; // [rsp+6Ch] [rbp-9Ch]
  _BYTE v43[176]; // [rsp+88h] [rbp-80h] BYREF
  ...
  if ( InstalledLanguageIndexByLangId == -1073741772 || InstalledLanguageIndexByLangId == -1073741637 )
  {
    ...
    if ( !v12 )
      return 3221225495LL;
    if ( RtlpInitAndCallLcidToCultureName((__int64)&v36, v12, v30) )
    {
      LOBYTE(v13) = 1;
      v14 = RtlpMuiRegGetOrAddString(a1, v37, v13, (__int16 *)&v32);
      v15 = -1;
      if ( v14 >= 0 )
        v15 = v32;
      v39 = v30;
      ...
      while ( v16 < 4 );
      RtlpMuiRegAddNeutralLanguage(a1, (__int64)&v38, v37);
...
LABEL_18:
    if ( v3 != -1 )
    {
      v35 = (wchar_t *)v43;
      WORD1(v34) = 170;
      if ( (int)RtlpGetNameFromLangInfoNode(a1, 28LL * v3 + *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL), (__int64)&v34) >= 0 )
      {
        if ( (int)RtlpIsALicensedRegularLanguage((_QWORD *)a1, v35) >= 0 )
        {
          v4 = 1;
        }
        else
