/*
 * XREFs of RtlFormatMessageEx @ 0x18005C720
 * Callers:
 *     RtlFormatMessage @ 0x1800EE500 (RtlFormatMessage.c)
 * Callees:
 *     RtlStringCbCopyExW @ 0x18005C690 (RtlStringCbCopyExW.c)
        ...
        PPARSE_MESSAGE_CONTEXT ParseContext)
{
  ...
  PWSTR v70; // [rsp+A0h] [rbp-68h]
  PULONG v71; // [rsp+A8h] [rbp-60h]
