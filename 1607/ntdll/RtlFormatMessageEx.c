/*
 * XREFs of RtlFormatMessageEx @ 0x18005C730
 * Callers:
 *     RtlFormatMessage @ 0x1800EE440 (RtlFormatMessage.c)
 * Callees:
 *     RtlStringCbCopyExW @ 0x18005C6A0 (RtlStringCbCopyExW.c)
        ...
        __int64 a10)
{
  ...
  _WORD *v69; // [rsp+98h] [rbp-70h]
  __int16 *v70; // [rsp+A0h] [rbp-68h]
