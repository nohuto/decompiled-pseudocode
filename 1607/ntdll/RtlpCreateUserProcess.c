/*
 * XREFs of RtlpCreateUserProcess @ 0x18008CBD8
 * Callers:
 *     RtlCreateUserProcess @ 0x18008CAE0 (RtlCreateUserProcess.c)
        ...
        _DWORD *a11)
{
  ...
  *v11 = 104;
  ...
  v40 = 32LL * v16 + 8;
  return NtCreateUserProcess(v11 + 2, v11 + 4, 0x2000000LL, 0x2000000LL, &v33, &v27, v19, a8, a2, v39, &v40);
}
