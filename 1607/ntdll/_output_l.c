/*
 * XREFs of _output_l @ 0x18009D0F0
 * Callers:
 ...
 *     _get_printf_count_output @ 0x1800A090C (_get_printf_count_output.c)
...
LABEL_120:
                      ...
                      {
                        LOBYTE(v19) = 32;
                        write_multi_char(v19, v36, v54, &v48);
                      }
                      write_string(v50, v35, v54, &v48);
                      v38 = v54;
                      if ( (v7 & 0xC) == 8 )
                      {
                        LOBYTE(v37) = 48;
                        write_multi_char(v37, v36, v54, &v48);
                      }
                      v39 = SizeConverted;
                      if ( v52 && SizeConverted > 0 )
                      {
                        ...
                        while ( 1 )
                        {
                          ...
                          if ( wctomb_s(&v58, v62, 6uLL, v41) || !v58 )
                            break;
                          write_string(v62, (unsigned int)v58, v54, &v48);
                          if ( !v39 )
                            goto LABEL_134;
                        }
                        v13 = -1;
                      ...
                      {
                        write_string(v15, (unsigned int)SizeConverted, v38, &v48);
LABEL_134:
                        v13 = v48;
                      }
                      if ( v13 >= 0 && (v7 & 4) != 0 )
                      {
                        LOBYTE(v42) = 32;
                        write_multi_char(v42, v36, v54, &v48);
                        v13 = v48;
                      }
                      a2 = v57;
                      v8 = v51;
