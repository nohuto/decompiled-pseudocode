/*
 * XREFs of RtlFindSetBitsAndClear @ 0x1800E4260
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a2 >= 0x40 )
    {
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( !v20 )
            v28 = 63 - v29;
          v14 = (((unsigned int)(((__int64)v16 - v13) >> 3) + 1) << 6) - v28;
          if ( v14 > v15 )
            goto LABEL_74;
          v30 = a2 - v28;
          if ( a2 == v28 )
...
LABEL_49:
    ...
    {
      v32 = 0;
      v33 = (_QWORD *)(v13 + 8 * ((unsigned __int64)v11 >> 6));
      while ( 1 )
      {
        if ( v17 == -1LL )
        {
      ...
      LODWORD(v36) = -v32;
LABEL_72:
      v14 = ((unsigned int)(((__int64)v16 - v13) >> 3) << 6) + v36;
      v38 = v14 <= v15;
    }
    if ( !v38 )
      goto LABEL_74;
