/*
 * XREFs of RtlpIsDosDeviceName_Ustr @ 0x18001E290
 * Callers:
...
LABEL_23:
          ...
          if ( v21 == 3 )
          {
            if ( RtlEqualUnicodeString((unsigned __int16 *)&v28, RtlpDosPRNDevice, 1)
              || RtlEqualUnicodeString((unsigned __int16 *)&v28, RtlpDosAUXDevice, 1)
              || RtlEqualUnicodeString((unsigned __int16 *)&v28, RtlpDosNULDevice, 1)
              || RtlEqualUnicodeString((unsigned __int16 *)&v28, RtlpDosCONDevice, 1) )
            {
          ...
          else
          {
            ...
            if ( v25 )
            {
              ...
              if ( v26 )
              {
                if ( v26 != 1 )
                  return 0LL;
                v27 = (unsigned __int16 *)&RtlpDosCONOUTDevice;
              }
              else
              {
                v27 = (unsigned __int16 *)&RtlpDosCONINDevice;
              }
            }
            else
            {
              ...
              if ( RtlEqualUnicodeString((unsigned __int16 *)&v28, RtlpDosLPTDevice, 1) )
                return (v1 << 16) | (unsigned int)(2 * v21);
              v27 = (unsigned __int16 *)&RtlpDosCOMDevice;
            }
...
LABEL_16:
        ...
        else
        {
          ...
          v13 = v10 + 1;
          if ( (unsigned __int64)v13 >= v28.m128i_i64[1] + 2 * ((unsigned __int64)v6 >> 1) )
            return 0LL;
          v14 = (*v13 | 0x20) - 97;
          if ( v14 > 0xFu )
            return 0LL;
