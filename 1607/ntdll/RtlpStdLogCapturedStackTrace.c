/*
 * XREFs of RtlpStdLogCapturedStackTrace @ 0x1800F2E18
 * Callers:
...
__int64 __fastcall RtlpStdLogCapturedStackTrace(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbp
  unsigned int v6; // edx
  SIZE_T v7; // rbp
  ...
  v11 = a1 + 16LL * v6;
  RtlpStdLockAcquire(v11 + 736, (char *)v6, a3, a4);
