/*
 * XREFs of RtlIdnToUnicode @ 0x180056680
 * Callers:
        ...
        PLONG DestinationStringLength)
{
  ...
  {
    if ( (int)RtlStringCchLengthW(SourceString, 0x203uLL, &v25[7]) < 0 )
      return -1073740010;
    v6 = *(_DWORD *)&v25[7] + 1;
  }
  if ( !v7[v6 - 1] )
    v9 = 1;
  *(_DWORD *)&v25[3] = 511;
  result = punycode_decode(v7, (v8 & 4) != 0, (v8 & 2) != 0, (__int64)v25, (__int64)&v26);
  if ( result < 0 )
    return result;
  if ( v9 )
  {
