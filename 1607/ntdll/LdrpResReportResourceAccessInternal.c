/*
 * XREFs of LdrpResReportResourceAccessInternal @ 0x180082740
 * Callers:
 ...
 *     _TlgKeywordOn @ 0x1800D1CA4 (_TlgKeywordOn.c)
 *     _TlgWrite @ 0x1800D1CD0 (_TlgWrite.c)
 */

char __fastcall LdrpResReportResourceAccessInternal(__int64 a1, unsigned __int64 a2, __int64 *a3, int a4)
{
    ...
    if ( !(_DWORD)RcConfig )
    {
      ...
      if ( v11 )
      {
        if ( a4 >= 2 )
        {
          if ( a4 == 2 )
          {
            if ( dword_18014C4C0 > 5u )
            {
              ...
              if ( (_BYTE)RcConfig )
              {
                ...
                v40 = v18;
                v42 = 16LL;
                LOBYTE(RcConfig) = TlgWrite((TraceLoggingHProvider)&dword_18014C4C0, &unk_18011C420, v16, v17, 7u, &v32);
              }
            }
          }
          else if ( a4 == 3 )
          {
            if ( dword_18014C4C0 > 5u )
            {
              ...
              if ( (_BYTE)RcConfig )
              {
                ...
                v42 = v21;
                v44 = 16LL;
                LOBYTE(RcConfig) = TlgWrite((TraceLoggingHProvider)&dword_18014C4C0, &unk_18011C365, v19, v20, 8u, &v32);
              }
            }
          }
          else if ( dword_18014C4C0 > 5u )
          {
            ...
            if ( (_BYTE)RcConfig )
            {
              ...
              v44 = v24;
              v46 = 16LL;
              LOBYTE(RcConfig) = TlgWrite((TraceLoggingHProvider)&dword_18014C4C0, &unk_18011C29D, v22, v23, 9u, &v32);
            }
          }
        }
        else if ( dword_18014C4C0 > 5u )
        {
          ...
          if ( (_BYTE)RcConfig )
          {
            ...
            LOBYTE(RcConfig) = TlgWrite((TraceLoggingHProvider)&dword_18014C4C0, &unk_18011C261, v14, v15, 3u, pData);
          }
        }
      }
      else if ( dword_18014C4C0 > 5u )
      {
        ...
        if ( (_BYTE)RcConfig )
        {
          ...
          LOBYTE(RcConfig) = TlgWrite((TraceLoggingHProvider)&dword_18014C4C0, &unk_18011C31C, v12, v13, 3u, pData);
        }
      }
    }
  }
