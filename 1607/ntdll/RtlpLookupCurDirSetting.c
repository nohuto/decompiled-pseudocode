/*
 * XREFs of RtlpLookupCurDirSetting @ 0x1800093F0
 * Callers:
...
__int64 __fastcall RtlpLookupCurDirSetting(__int64 a1, unsigned __int32 a2, volatile signed __int32 *a3)
{
  ...
  {
    Handle = (HANDLE)qword_180153348;
    v6 = (HANDLE)qword_180153348;
    if ( !qword_180153348 )
    {
      if ( (int)NtOpenKey(&Handle, 1LL, &unk_1801080D0) < 0 )
      {
LABEL_7:
        v7 = a2;
        goto LABEL_8;
      }
      v6 = (HANDLE)_InterlockedCompareExchange64(&qword_180153348, (signed __int64)Handle, 0LL);
      if ( v6 )
      {
        NtClose(Handle);
        Handle = v6;
