/*
 * XREFs of RtlFlsAlloc @ 0x1800501A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlFlsAlloc(__int64 a1, char *a2, __int64 a3, __int64 a4)
{
  struct _TEB *v4; // r15
  _LIST_ENTRY *v7; // rdi
  ...
  Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, (NtdllBaseTag + 2883584) | 8u, 0x410uLL);
  v7 = (_LIST_ENTRY *)Heap;
  if ( Heap )
  {
...
LABEL_3:
    ...
    {
      v14 = (_QWORD *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, NtdllBaseTag + 2883584, 0x800uLL);
