/*
 * XREFs of LdrResFallbackLangList @ 0x18000FD94
 * Callers:
...
__int64 __fastcall LdrResFallbackLangList(__int64 a1, int a2, unsigned __int16 a3, int a4, unsigned __int16 *a5)
{
  ...
  unsigned __int16 v32[2]; // [rsp+40h] [rbp-40h] BYREF
  ...
  v41 = a2;
  v35 = 3801144;
  v36 = L"LdrResFallbackLangList Enter";
  v37 = 3670070;
  v6 = a1;
  v7 = 0;
  v38 = L"LdrResFallbackLangList Exit";
...
LABEL_27:
    ...
    if ( v15 )
    {
      ...
      if ( !v16 )
      {
        ...
        if ( !(unsigned __int8)RtlCultureNameToLCID(&DestinationString, v32) )
        {
          v11 = -1073020923;
LABEL_34:
          v6 = a1;
LABEL_35:
      ...
      if ( v17 )
      {
        ...
        if ( (_DWORD)v18 )
        {
          ...
          CurrentLocale = -4370;
          v25 = NtQueryDefaultLocale(0LL, &v31);
          a3 = v42;
          v6 = a1;
          v11 = v25;
          a2 = v41;
        ...
        else
        {
          LODWORD(v18) = 1;
          CurrentLocale = -4370;
          v26 = NtQueryDefaultLocale(v18, &v30);
          a3 = v42;
          v6 = a1;
          v11 = v26;
          a2 = v41;
  ...
  if ( (a4 & 4) == 0 )
  {
    ...
    {
      *((_BYTE *)v8 + 516) = 1;
      if ( (int)LdrpGetParentLangId(CurrentLocale, &v29) < 0 )
        goto LABEL_29;
      CurrentLocale = v29;
      if ( v29 )
        --v9;
