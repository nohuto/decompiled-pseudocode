/*
 * XREFs of RtlActivateActivationContextEx @ 0x180068C30
 * Callers:
 *     RtlActivateActivationContext @ 0x180068BE0 (RtlActivateActivationContext.c)
 * Callees:
        ...
        PULONG_PTR Cookie)
{
  ...
  if ( Cookie )
    *Cookie = 0LL;
  v6 = (_ACTIVATION_CONTEXT *)&unk_180108498;
