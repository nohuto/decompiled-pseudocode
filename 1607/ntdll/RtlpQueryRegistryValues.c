/*
 * XREFs of RtlpQueryRegistryValues @ 0x1800579E4
 * Callers:
 ...
 *     RtlQueryRegistryValuesEx @ 0x1800579C0 (RtlQueryRegistryValuesEx.c)
 *     RtlCheckPortableOperatingSystem @ 0x180059090 (RtlCheckPortableOperatingSystem.c)
 *     RtlQueryRegistryValues @ 0x1800E54F0 (RtlQueryRegistryValues.c)
 * Callees:
