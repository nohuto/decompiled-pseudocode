/*
 * XREFs of RtlSwitchedVVI @ 0x18002B390
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
      ...
      if ( (v4 & 8) != 0 )
      {
        v12 = (a3 & 0x8000000000000000uLL) != 0 ? RtlpVerGetConditionMask(a3, 8LL) : 0;
        if ( !(unsigned __int8)RtlpVerCompare(v12, *(_DWORD *)(a1 + 16), v21[4], (unsigned int)v20, 0) )
          return 3221225561LL;
      }
      if ( v4 < 0 )
      {
        v11 = (a3 & 0x8000000000000000uLL) != 0 ? RtlpVerGetConditionMask(a3, 128LL) : 0;
