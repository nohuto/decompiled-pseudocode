/*
 * XREFs of RtlpFilterandReplaceConsoleLanguages @ 0x180013698
 * Callers:
...
__int64 __fastcall RtlpFilterandReplaceConsoleLanguages(__int64 a1, __int64 a2, __int64 a3, __int16 a4, __int64 a5)
{
  ...
  if ( !a1 || !a2 || !a5 || !*(_QWORD *)a5 )
    return 3221225485LL;
  LangFallbackList = LdrpCreateLangFallbackList(v16, a2, 25LL, 0LL);
...
LABEL_10:
      ...
      if ( *(_WORD *)(v16[0] + 4LL) )
      {
        do
        {
          ...
          *((_QWORD *)&v15 + 1) = v17;
          LangFallbackList = GetNameFromLangListNode(a2, *(_QWORD *)(v11 + 24) + 6LL * v12, &v15);
          if ( LangFallbackList < 0 )
            break;
