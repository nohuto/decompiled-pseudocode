/*
 * XREFs of LdrpProcessMappedModule @ 0x18002F938
 * Callers:
...
__int64 __fastcall LdrpProcessMappedModule(__int64 a1, int a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 48);
  Config = RtlImageNtHeaderEx(3LL, v2, 0LL, &v15);
  if ( Config < 0 )
  ...
  *(_QWORD *)(a1 + 256) = MEMORY[0x7FFE0014];
  if ( !v11 && (*(_DWORD *)(a1 + 104) & 0x2000) == 0 && a2 )
  {
    v16 = 0LL;
    v12 = LdrpGenRandom();
    inited = LdrInitSecurityCookie(v2, *(_DWORD *)(a1 + 64), 0, v12 ^ (unsigned int)dword_180163300, (__int64)&v16);
    if ( v2 == 0x180000000LL
      || !*(_QWORD *)(a1 + 56)
