/*
 * XREFs of LdrEnumResources @ 0x1800DBC30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
  ...
  if ( (v19 & 0x80000000) != 0 )
  {
    ...
    if ( !v16 )
    {
      do
      {
        if ( v7 <= 1 || (v26 = LdrpCompareResourceNamesWithValidation(0LL, 0LL, v8[1], v10, v22, &v37), v25 = v39, !v26) )
        {
          v27 = v22[1];
          if ( (v27 & 0x80000000) == 0 )
            return 3221225595LL;
          ...
          if ( v46 )
          {
            do
            {
              if ( a3 <= 2 || !(unsigned int)LdrpCompareResourceNamesWithValidation(0LL, 0LL, a2[2], v10, v30, v38) )
              {
