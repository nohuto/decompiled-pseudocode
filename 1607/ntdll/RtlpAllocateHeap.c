/*
 * XREFs of RtlpAllocateHeap @ 0x180025050
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  ULONG Protect; // r14d
  __int16 updated; // ax
  _RTL_CRITICAL_SECTION *v191; // rdx
  _RTL_CRITICAL_SECTION_DEBUG *v192; // r8
  __int64 *v193; // rax
  char v194; // [rsp+30h] [rbp-2A8h]
  PVOID v195; // [rsp+38h] [rbp-2A0h] BYREF
  ...
  ULONG_PTR j; // [rsp+C0h] [rbp-218h]
  unsigned __int64 v224; // [rsp+C8h] [rbp-210h]
  unsigned __int64 v225; // [rsp+D0h] [rbp-208h]
  PVOID BaseAddressa; // [rsp+D8h] [rbp-200h] BYREF
  ULONG_PTR RegionSize; // [rsp+E0h] [rbp-1F8h] BYREF
  ULONG_PTR v228; // [rsp+E8h] [rbp-1F0h]
  ...
  SIZE_T v243; // [rsp+1A0h] [rbp-138h]
  PRTL_CRITICAL_SECTION *v244; // [rsp+1A8h] [rbp-130h]
  ...
  unsigned int *v256; // [rsp+208h] [rbp-D0h]
  ...
  ULONG_PTR v272; // [rsp+298h] [rbp-40h]
  unsigned __int64 v274; // [rsp+2F0h] [rbp+18h]
  ULONG_PTR v275; // [rsp+2F8h] [rbp+20h] BYREF
  ...
  if ( v11 > *((unsigned int *)BaseAddress + 37) )
  {
    if ( ((_BYTE)BaseAddress[14] & 2) != 0 )
    {
      ...
      if ( ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &BaseAddressa, 0LL, &RegionSize, 0x2000u, Protect) < 0 )
        goto LABEL_497;
      v195 = (char *)BaseAddressa + v188;
      if ( ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &v195, 0LL, &v275, 0x1000u, Protect) >= 0 )
      {
        *((_WORD *)v195 + 28) = v275 - v274;
        *((_BYTE *)v195 + 58) = v6 | 2;
        *((_QWORD *)v195 + 4) = v275;
        *((_QWORD *)v195 + 5) = RegionSize;
        *((_BYTE *)v195 + 63) = 4;
        BaseAddress[70] = (PRTL_CRITICAL_SECTION)((char *)BaseAddress[70] + v275);
        if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
          RtlpLogHeapCommit(BaseAddress, v195, v275, 9LL);
        if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        ...
        if ( ((_DWORD)BaseAddress[14] & 0x8000000) != 0 )
          *((_WORD *)v195 + 8) = RtlLogStackBackTraceEx(1LL);
        if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
        {
          updated = RtlpUpdateTagEntry(
                      ...
                      *((_QWORD *)v195 + 4) >> 4,
                      1);
          *((_WORD *)v195 + 9) = updated;
        }
        v191 = (_RTL_CRITICAL_SECTION *)v195;
        if ( *((_DWORD *)BaseAddress + 31) )
        {
          *((_BYTE *)v195 + 59) = *((_BYTE *)v195 + 56) ^ *((_BYTE *)v195 + 57) ^ *((_BYTE *)v195 + 58);
          LODWORD(v191[1].OwningThread) ^= *((_DWORD *)BaseAddress + 34);
          v191 = (_RTL_CRITICAL_SECTION *)v195;
        }
        v192 = (_RTL_CRITICAL_SECTION_DEBUG *)(BaseAddress + 34);
        v193 = (__int64 *)BaseAddress[35];
        if ( (PRTL_CRITICAL_SECTION *)*v193 == BaseAddress + 34 )
        {
          v191->DebugInfo = v192;
          *(_QWORD *)&v191->LockCount = v193;
          *v193 = (__int64)v191;
          BaseAddress[35] = v191;
        }
        else
  ...
  if ( (a2 & 0x800000) == 0 )
  {
    if ( v10 < *((unsigned __int16 *)BaseAddress + 200) )
    {
      ...
      if ( ((unsigned __int8)(1 << (v10 & 7)) & *((_BYTE *)BaseAddress + (v10 >> 3) + 402)) != 0 )
        goto LABEL_58;
      v23 = (unsigned __int16 *)((char *)BaseAddress[49] + 2 * v10);
      v270 = v23;
      v24 = *v23 + 33;
      *v23 = v24;
      if ( !v211 )
      ...
      {
        *v23 = LFHContext;
        *((_BYTE *)BaseAddress + v21 + 402) |= 1 << v22;
...
LABEL_57:
      ...
      v20 = BaseAddress[47] == 0LL;
    }
    else
    {
      if ( v7 > RtlpLargestLfhBlock || *((_BYTE *)BaseAddress + 386) == 2 && BaseAddress[47] )
        goto LABEL_58;
      v20 = *((_BYTE *)BaseAddress + 387) == 2;
    }
    if ( v20 )
      goto LABEL_57;
  }
...
LABEL_83:
    ...
    else
    {
      ...
      if ( *((_DWORD *)BaseAddress + 31) )
      {
        v232 = v46 ^ *((_DWORD *)BaseAddress + 34);
      ...
      if ( v254 <= 0 )
      {
        ...
        if ( *((_DWORD *)BaseAddress + 31) )
        {
          v233 = v48 ^ *((_DWORD *)BaseAddress + 34);
        ...
        if ( v259 > 0 )
        {
          ...
          else
          {
            ...
            for ( k = *(char ***)(*(_QWORD *)&i[1].LockCount + 8 * v41); SpinCount != k; k = (char **)*k )
            {
              ...
              if ( *((_DWORD *)BaseAddress + 31) )
              {
                v234 = v50 ^ *((_DWORD *)BaseAddress + 34);
...
LABEL_472:
  ...
  {
LABEL_164:
    v75 = (char *)RtlpExtendHeap(BaseAddress);
    v28 = (__int64)v75;
    v214 = v75;
    if ( v75 )
    {
      v58 = v75 + 16;
      v76 = *((_QWORD *)v75 + 2);
      v209 = (__int64 *)*((_QWORD *)v75 + 3);
      v60 = *v209;
      v61 = *(_QWORD *)(v76 + 8);
      if ( *v209 != v61 || (char *)v60 != v58 )
        goto LABEL_161;
      BaseAddress[24] = (PRTL_CRITICAL_SECTION)((char *)BaseAddress[24] - *(unsigned __int16 *)(v28 + 8));
      v77 = BaseAddress[39];
      if ( v77 )
...
LABEL_161:
  ...
  else
  {
    ...
    if ( *(_QWORD *)v58 != v62->SpinCount )
    {
      ...
      if ( *((_DWORD *)BaseAddress + 31) )
      {
        v229 = v73 ^ *((_DWORD *)BaseAddress + 34);
      ...
      if ( !(v65 - (unsigned __int16)v229) )
      {
        *(_QWORD *)(*(_QWORD *)&v62[1].LockCount + v68) = v72;
        v28 = (__int64)v214;
        goto LABEL_157;
      }
      v28 = (__int64)v214;
    }
    *(_QWORD *)(*(_QWORD *)&v62[1].LockCount + v68) = 0LL;
  }
...
LABEL_193:
  ...
  *v36 = v198;
  v93 = v217;
  v94 = *(unsigned __int16 *)(v28 + 8) - v217;
  v272 = v94;
  *(_WORD *)(v28 + 8) = v217;
  v95 = v274;
  v96 = v275 - v274;
  ...
  *(_WORD *)(v101 + 12) = v93 ^ *((_WORD *)BaseAddress + 70);
  ...
  {
    v103 = ((unsigned __int64)(v101 - (_QWORD)v100) >> 16) + 1;
    v268 = v103;
    if ( (unsigned __int64)(v101 - (_QWORD)v100) >> 16 > 0xFC )
...
LABEL_229:
            ...
            else
            {
              ...
              if ( *((_DWORD *)BaseAddress + 31) )
              {
                v235 = v114 ^ *((_DWORD *)BaseAddress + 34);
              ...
              v262 = v105 - (unsigned __int16)v235;
              if ( v262 <= 0 )
              {
                v115 = *v111 - 16LL;
                v116 = *(_DWORD *)(v115 + 8);
                ...
                v263 = v105 - (unsigned __int16)v236;
                if ( v263 > 0 )
                {
                  if ( v107->DebugInfo || (_DWORD)v222 != v107->LockCount - 1 )
                  {
                    v119 = (unsigned int)v109 >> 5;
                    v213 = (unsigned int)v109 >> 5;
                  ...
                  else
                  {
                    ...
                    for ( m = *(_QWORD **)(*(_QWORD *)&v107[1].LockCount + 8 * v109); v111 != m; m = (_QWORD *)*m )
                    {
                      ...
                      if ( *((_DWORD *)BaseAddress + 31) )
                      {
                        v237 = v118 ^ *((_DWORD *)BaseAddress + 34);
...
LABEL_271:
        ...
        while ( v106 != v110 )
        {
          if ( *((_DWORD *)BaseAddress + 31) )
          {
            ...
            if ( (v125 & *((_DWORD *)BaseAddress + 31)) != 0 )
              v264 = v125 ^ *((_DWORD *)BaseAddress + 34);
            v126 = v264;
          }
          else
          {
        ...
        if ( v129 )
        {
          ...
          if ( *((_DWORD *)BaseAddress + 31) )
          {
            v230 = v137 ^ *((_DWORD *)BaseAddress + 34);
          ...
          v241 = v132 - (unsigned __int16)v230;
          if ( v241 <= 0 )
LABEL_300:
      ...
      while ( v140 != Entry )
      {
        if ( *((_DWORD *)BaseAddress + 31) )
        {
          ...
          if ( (v142 & *((_DWORD *)BaseAddress + 31)) != 0 )
            v265 = v142 ^ *((_DWORD *)BaseAddress + 34);
          v143 = v265;
        }
        else
        {
...
LABEL_415:
  ...
  *(_BYTE *)(v101 + 10) = *(_BYTE *)(v104 + 10);
  ...
  if ( v159 > 0xFF00 )
  {
    RtlpInsertFreeBlock(BaseAddress, v101, v159);
    goto LABEL_418;
  }
  *(_WORD *)(v101 + 8) = v159;
    ...
    while ( v167 != v168 )
    {
      if ( *((_DWORD *)BaseAddress + 31) )
      {
        ...
        if ( (v169 & *((_DWORD *)BaseAddress + 31)) != 0 )
          v267 = v169 ^ *((_DWORD *)BaseAddress + 34);
        v170 = v267;
      }
      else
      {
...
LABEL_419:
  ...
  if ( v199 )
  {
    ...
    if ( v194 )
    {
      if ( (*((_DWORD *)BaseAddress + 29) & 0x1000000) == 0 )
      {
        ...
        v175 = *((_DWORD *)BaseAddress + 154);
        if ( *((_DWORD *)BaseAddress + 152) > v175 )
        {
          *((_DWORD *)BaseAddress + 152) = 0;
          v176 = (unsigned __int64)BaseAddress[68] - 16 * (_QWORD)BaseAddress[24];
          if ( v176 > (unsigned __int64)BaseAddress[80] )
            BaseAddress[80] = (PRTL_CRITICAL_SECTION)v176;
          BaseAddress[81] = (PRTL_CRITICAL_SECTION)v176;
        }
        if ( ++*((_DWORD *)BaseAddress + 155) >= 0x1000u )
        {
          if ( *((_BYTE *)BaseAddress + 386) != 2 || (v177 = 4, *((_DWORD *)BaseAddress + 156) <= 0x10u) )
            v177 = 8;
          if ( *((_DWORD *)BaseAddress + 153) > (unsigned int)(4096 >> v177) && v175 < 0x10000 )
            *((_DWORD *)BaseAddress + 154) = 2 * v175;
      ...
      if ( v20 )
      {
        ...
        if ( v179 != -2 )
        {
          ...
          DeferredCriticalSectionEvent = (__int64)v178->LockSemaphore;
          if ( !DeferredCriticalSectionEvent )
            DeferredCriticalSectionEvent = RtlpCreateDeferredCriticalSectionEvent(v178);
          do
          {
            v181 = v179 & 2 | 1;
            v182 = _InterlockedCompareExchange(&v178->LockCount, v181 + v179, v179);
            v20 = v179 == v182;
            v179 = v182;
          }
          while ( !v20 );
  ...
  if ( ((_BYTE)BaseAddress[14] & 0x40) != 0 )
  {
    v183 = (char *)v200;
    v258 = v200;
    v184 = (v95 & 0xFFFFFFFFFFFFFFFCuLL) >> 2;
    v225 = v184;
    if ( v184 )
    {
...
LABEL_461:
  ...
  {
    v185 = (char *)v200;
    *(_QWORD *)((char *)v200 + v95) = 0xABABABABABABABABuLL;
    *(_QWORD *)&v185[v95 + 8] = 0xABABABABABABABABuLL;
    *(_BYTE *)(v215 + 10) |= 4u;
  }
  v186 = v215;
  *(_BYTE *)(v215 + 11) = 0;
  if ( (*(_BYTE *)(v186 + 10) & 2) != 0 )
  {
    ...
    *ExtraStuffPointer = 0LL;
    ...
    if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
      *((_WORD *)v255 + 1) = RtlpUpdateTagEntry((_DWORD)BaseAddress, (a2 >> 18) & 0xFFF, 0, *v173, 0);
  }
  else if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
  {
    *(_BYTE *)(v186 + 11) = RtlpUpdateTagEntry((_DWORD)BaseAddress, (unsigned __int8)(a2 >> 18), 0, *v173, 0);
  }
  if ( *((_DWORD *)BaseAddress + 31) )
  {
...
LABEL_497:
  ...
  {
    if ( v195 )
      RtlpHeapLogRangeReserve(BaseAddress, (unsigned __int64)v195 & 0xFFFFFFFFFFFF0000uLL, *((_QWORD *)v195 + 5));
  }
  return v200;
}
