/*
 * XREFs of RtlLookupFunctionEntry @ 0x180035FA0
 * Callers:
        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  {
    HistoryTable->Once = 0;
    v31 = *(_QWORD *)&RtlpUnwindHistoryTable[4 * (unsigned __int8)byte_180163345 + 6];
    result = *(PRUNTIME_FUNCTION *)&RtlpUnwindHistoryTable[4 * (unsigned __int8)byte_180163345 + 8];
    if ( result )
    {
  ...
  if ( !HistoryTable->Search )
    goto LABEL_10;
  if ( ControlPc < qword_180163348
    || ControlPc >= qword_180163350
