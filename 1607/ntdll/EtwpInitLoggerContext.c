/*
 * XREFs of EtwpInitLoggerContext @ 0x1800550D0
 * Callers:
...
char *__fastcall EtwpInitLoggerContext(__int64 a1, int a2, unsigned int a3, __int64 a4, unsigned int a5)
{
  ...
  *((LARGE_INTEGER *)&v26 + 1) = v10;
  Heap = (char *)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8u, 8 * a3 + 536);
  if ( !Heap )
    return 0LL;
  ...
  *((_QWORD *)Heap + 65) = v12;
  if ( v12 )
  {
    if ( a4 )
    {
      if ( (unsigned int)EtwpFillProcessorStreamIndexMap((__int64)Heap, v9, a4, a5) )
        goto LABEL_43;
