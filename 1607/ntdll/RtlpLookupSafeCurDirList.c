/*
 * XREFs of RtlpLookupSafeCurDirList @ 0x1800DA380
 * Callers:
  ...
  *(_DWORD *)&ValueName.Length = 0x2000000;
  if ( qword_18014FE00 == -1 )
  {
    ...
    if ( Heap )
    {
      Heap[1] = (__int64 *)Heap;
      *Heap = (__int64 *)Heap;
      KeyHandle = qword_180153538;
      v3 = qword_180153538;
      if ( !qword_180153538 )
      {
        v4 = NtOpenKey(&KeyHandle, 1u, (POBJECT_ATTRIBUTES)&stru_180109430);
        v5 = (signed __int64)KeyHandle;
        if ( v4 < 0 )
          v5 = -1LL;
        KeyHandle = (HANDLE)v5;
        v3 = (HANDLE)_InterlockedCompareExchange64((volatile signed __int64 *)&qword_180153538, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose(KeyHandle);
      ...
      if ( v3 != (HANDLE)-1LL
        && NtQueryValueKey(
             v3,
             (PUNICODE_STRING)&stru_180109410,
      ...
      if ( RtlQueryEnvironmentVariable_U(0LL, (PUNICODE_STRING)&stru_180109420, &Value) >= 0
...
LABEL_32:
    ...
    v12 = _InterlockedCompareExchange64(&qword_18014FE00, (signed __int64)v2, -1LL);
    if ( v12 == -1 )
    {
      return (__int64)v2;
    }
