/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x18007A380
 * Callers:
  ...
  if ( (a1 & 0x20000000) == 0 )
  {
    if ( (a1 & 0xFF0000) != 0x70000 || ((HIBYTE(a1) - 128) & 0xFFFFFFBF) != 0 )
    {
      ...
      do
      {
        ...
        {
          if ( v6 < (unsigned __int8)byte_18011AED4[8 * v4] )
          {
            v7 = (unsigned __int16)word_18011AED6[4 * v4];
            if ( byte_18011AED5[8 * v4] == 1 )
