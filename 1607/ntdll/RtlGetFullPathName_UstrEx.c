/*
 * XREFs of RtlGetFullPathName_UstrEx @ 0x180019120
 * Callers:
    ...
    if ( FullPathName_Ustr )
    {
      ...
      else if ( DynamicString )
      {
        ...
        for ( i = FullPathName_Ustr + 2LL; ; i = v18 + 2 )
        {
          ...
          v22 = v18 + 2;
          v23 = v22;
          StringRoutine = NtdllpAllocateStringRoutine(v22);
          if ( !StringRoutine )
          {
            v19 = -1073741801;
            goto LABEL_18;
...
LABEL_22:
  ...
  MaximumLength = 520;
  v31 = 520LL;
  v26 = (wchar_t *)NtdllpAllocateStringRoutine(0x208uLL);
  v11 = v26;
  if ( v26 )
  {
    Buffer = v26;
