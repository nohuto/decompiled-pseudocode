/*
 * XREFs of RtlpQueryExtendedHeapInformation @ 0x1800EA764
 * Callers:
...
__int64 __fastcall RtlpQueryExtendedHeapInformation(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  __int64 (__fastcall *v23)(__int64, _QWORD *); // [rsp+70h] [rbp-90h]
  ...
  if ( *(_QWORD *)a1 == -1LL )
  {
    ...
    if ( v8 )
    {
      ...
      ExtendedInformationHeap = RtlpQueryExtendedInformationHeap(*(_DWORD **)(a1 + 8), (__int64)&v25);
      if ( v10 != -1 )
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v14 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          v15 = 0LL;
          memset(v28, 0, sizeof(v28));
          v23 = *(__int64 (__fastcall **)(__int64, _QWORD *))(a1 + 24);
          if ( v23 )
          {
            v16 = *(_QWORD **)(a1 + 32);
          }
          else
          {
            ...
            v28[11] = a1 + a2;
            v16 = v28;
            v23 = RtlpExtendedHeapInformationGenerator;
          }
          v24 = v16;
          v30 = 0;
          if ( LODWORD(Buffer[5]) )
...
LABEL_48:
          if ( v23 == RtlpExtendedHeapInformationGenerator )
          {
            if ( v12 >= 0 )
            {
              if ( a3 )
