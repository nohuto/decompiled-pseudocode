/*
 * XREFs of RtlpHeapGenerateRandomValue32 @ 0x180042348
 * Callers:
...
__int64 RtlpHeapGenerateRandomValue32()
{
  ...
  if ( !dword_180153040
    && NtQueryInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, (PROCESSINFOCLASS)36, &dword_180153040, 4u, 0LL) < 0 )
  {
    dword_180153040 = (MEMORY[0x7FFE0320] * (unsigned __int64)MEMORY[0x7FFE0004]) >> 24;
  }
...
LABEL_4:
  dword_180153040 = (2147483629 * (unsigned __int64)(unsigned int)dword_180153040 + 2147483587) % 0x7FFFFFFF;
  v1 = _InterlockedExchange(&RtlpRandomExConstantVector[RtlpRandomExAuxVarY & 0x7F], dword_180153040);
