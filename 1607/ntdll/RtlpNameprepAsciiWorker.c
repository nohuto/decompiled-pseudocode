/*
 * XREFs of RtlpNameprepAsciiWorker @ 0x180055E84
 * Callers:
 *     RtlCanonicalizeDomainName @ 0x180055610 (RtlCanonicalizeDomainName.c)
 *     RtlIdnToAscii @ 0x180055E60 (RtlIdnToAscii.c)
 ...
 *     RtlpValidateAsciiStd3AndLength @ 0x180056110 (RtlpValidateAsciiStd3AndLength.c)
...
LABEL_30:
          ...
          v39 = 515;
          result = punycode_encode(Src, v20, v42, &v39, v36, v14);
          v8 = v39;
          if ( !v39 )
          {
LABEL_34:
