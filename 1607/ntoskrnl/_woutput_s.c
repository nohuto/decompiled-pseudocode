/*
 * XREFs of _woutput_s @ 0x140153F60
 * Callers:
 *     _swoutput_s @ 0x140153E4C (_swoutput_s.c)
 * Callees:
 *     xHalFreeMessageTarget @ 0x140130D64 (xHalFreeMessageTarget.c)
 *     __security_check_cookie @ 0x14014CA50 (__security_check_cookie.c)
 *     _safecrt_mbtowc @ 0x140153B94 (_safecrt_mbtowc.c)
 *     write_char_1 @ 0x140154838 (write_char_1.c)
 *     write_multi_char_1 @ 0x140154890 (write_multi_char_1.c)
 *     write_string_2 @ 0x1401548DC (write_string_2.c)
 */
          ...
          if ( v10 != 83 )
          {
            if ( v10 != 88 )
            {
              if ( v10 == 90 )
              {
                ...
                v46 = a3 + 4;
                if ( v17 && (v13 = (wchar_t *)*((_QWORD *)v17 + 1)) != 0LL )
                {
                  if ( v17[1] < *v17 )
                    goto LABEL_177;
                  LODWORD(v11) = *v17;
...
LABEL_113:
                ...
                if ( (v5 & 0xC) == 0 )
                {
                  write_multi_char_1(32LL, v34, v52, &v45);
                  v33 = v44;
                }
                write_string_2(v51, v33, v52, &v45);
                v35 = v52;
                if ( (v5 & 0xC) == 8 )
                  write_multi_char_1(48LL, v34, v52, &v45);
                if ( v47 || (int)v11 <= 0 )
                {
                ...
                else
                {
                  ...
                  {
                    --v37;
                    v38 = safecrt_mbtowc(&v50, v36, _mb_cur_max);
                    if ( v38 == 2 )
                      --v37;
                    v4 = 0;
                    if ( v38 <= 0 )
                      break;
                    write_char_1(v50, v52, &v45);
                    v36 += v39;
                    v4 = 0;
                    if ( v37 <= 0 )
                      goto LABEL_127;
...
LABEL_127:
                ...
                write_multi_char_1(32LL, v34, v35, &v45);
                v12 = v42;
                v6 = v48;
                v8 = v44;
                goto LABEL_132;
...
LABEL_53:
              ...
              if ( (v5 & 0x20) != 0 )
              {
                SrcCh[1] = 0;
                SrcCh[0] = v21;
                v22 = safecrt_mbtowc(DstCh, SrcCh, _mb_cur_max);
                v7 = v43;
                v4 = 0;
                if ( v22 < 0 )
                  v54 = 1;
