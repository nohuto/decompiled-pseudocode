/*
 * XREFs of KeReleaseQueuedSpinLock @ 0x1400E6C40
 * Callers:
 ...
 *     IoReleaseVpbSpinLock @ 0x1400B0D2C (IoReleaseVpbSpinLock.c)
 ...
 *     IopCsqCancelRoutine @ 0x140131590 (IopCsqCancelRoutine.c)
