...
LABEL_178:
          ...
          if ( v31 == 123 )
          {
            v53 = ReadStringDelimited_0(v38, &v74, (wint_t *)&v57, &v59, (void **)v72, v15, File, Src, &v67);
            v4 = v74;
          }
          else
          {
            v53 = ReadString_0(v38, 0LL, (wint_t *)&v57, &v59, (void **)v72, v15, File, Src, &v67);
          }
          LOWORD(v5) = v57;
          if ( v53 )
            goto LABEL_204;
