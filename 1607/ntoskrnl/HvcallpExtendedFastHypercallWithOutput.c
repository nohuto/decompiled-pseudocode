/*
 * XREFs of HvcallpExtendedFastHypercallWithOutput @ 0x140168B70
 * Callers:
...
__int64 __fastcall HvcallpExtendedFastHypercallWithOutput(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 result; // rax
  __int64 v6; // rdx
  __int64 v7; // r8
