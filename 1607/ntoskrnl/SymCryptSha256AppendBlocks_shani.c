        ...
        unsigned __int64 *a4)
{
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      v17 = _XMM10;
      v18 = _mm_alignr_epi8(_XMM4, _XMM3, 4);
      _XMM8 = v9;
      ...
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg2 xmm1, xmm7 }
      _XMM5 = _mm_add_epi32(_mm_alignr_epi8(_XMM1, _XMM7, 4), _XMM2);
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg2 xmm5, xmm1 }
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg1 xmm3, xmm7 }
      _XMM4 = _mm_add_epi32(_mm_alignr_epi8(_XMM5, _XMM1, 4), _XMM3);
      __asm { sha256msg2 xmm4, xmm5 }
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg1 xmm7, xmm1 }
      _XMM3 = _mm_add_epi32(_mm_alignr_epi8(_XMM4, _XMM5, 4), _XMM7);
      __asm
      {
        sha256msg1 xmm1, xmm5
        sha256msg2 xmm3, xmm4
      }
      _XMM2 = _mm_add_epi32(_mm_alignr_epi8(_XMM3, _XMM4, 4), _XMM1);
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg2 xmm2, xmm3 }
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg1 xmm5, xmm4 }
      _XMM1 = _mm_add_epi32(_mm_alignr_epi8(_XMM2, _XMM3, 4), _XMM5);
      __asm { sha256msg2 xmm1, xmm2 }
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      __asm { sha256rnds2 xmm10, xmm8, xmm0 }
      __asm { sha256msg1 xmm4, xmm3 }
      _XMM0 = _mm_add_epi32(_mm_alignr_epi8(_XMM1, _XMM2, 4), _XMM4);
