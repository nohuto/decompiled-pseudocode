/*
 * XREFs of CmpDoParseKey @ 0x140453D10
 * Callers:
 ...
 *     CmpTransSilentIgnore @ 0x1400968C0 (CmpTransSilentIgnore.c)
...
LABEL_810:
                            if ( KeGetCurrentThread()->PreviousMode == 1 )
                            {
                              ...
                              if ( v375 != (unsigned int)RtlGetCurrentServiceSessionId() )
                              {
...
LABEL_1021:
  v458 = *(struct _SLIST_ENTRY **)&v544[10];
  if ( *(_QWORD *)&v544[10] )
  {
    ...
    {
      ++v460->FreeMisses;
      ((void (__fastcall *)(struct _SLIST_ENTRY *))v460->FreeEx)(v458);
    }
