/*
 * XREFs of _CmIsDeviceSafeRemovalRequired @ 0x1404CF88C
 * Callers:
...
bool __fastcall CmIsDeviceSafeRemovalRequired(__int64 a1, wchar_t *a2, int a3)
{
  bool v6; // di
  char v7; // bl
  ...
  v19 = 0;
  v6 = 0;
  if ( (int)CmGetDeviceStatus(a1, (_DWORD)a2, a3, (unsigned int)&v18, (__int64)&v20, (__int64)&v19) >= 0 )
  {
    v7 = v18;
    v16 = 4;
    DeviceRegProp = CmGetDeviceRegProp(a1, (_DWORD)a2, a3, 16, (__int64)v23, (__int64)&v17, (__int64)&v16, 0);
    v9 = v17;
    if ( DeviceRegProp < 0 )
      v9 = 0;
    v17 = v9;
    ...
    if ( (v7 & 8) != 0 || (v9 & 2) != 0 )
    {
      ...
      {
        v6 = 0;
        for ( i = a2; RtlStringCchCopyExW(pszDest, 0xC8uLL, i, 0LL, 0LL, 0x800u) >= 0; i = pszSrc )
        {
          v22 = 200;
          if ( (int)CmGetDeviceParent(a1, pszDest, pszSrc, &v22) < 0 )
            return v10;
          v16 = 4;
          v13 = CmGetDeviceRegProp(a1, (unsigned int)pszSrc, 0, 16, (__int64)v23, (__int64)&v17, (__int64)&v16, 0);
          v14 = v17;
          if ( v13 < 0 )
            v14 = 0;
          v17 = v14;
