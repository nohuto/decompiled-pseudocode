/*
 * XREFs of KseShimDriverIoCallbacks @ 0x1404E5818
 * Callers:
...
__int64 __fastcall KseShimDriverIoCallbacks(_QWORD *a1, __int64 a2, const void **a3)
{
  __int64 v3; // rsi
  ...
  if ( a3 )
  {
    if ( dword_140328EF4 == 2 && (KseEngine & 1) == 0 )
    {
