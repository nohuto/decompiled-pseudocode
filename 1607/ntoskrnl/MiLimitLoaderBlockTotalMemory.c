/*
 * XREFs of MiLimitLoaderBlockTotalMemory @ 0x14078EDB0
 * Callers:
...
unsigned __int64 __fastcall MiLimitLoaderBlockTotalMemory(__int64 a1, ULONG_PTR a2)
{
  ...
  {
    v10 = *((int *)v7 + 4);
    if ( (unsigned int)v10 > 0x20 || !_bittest64(&v8, v10) )
    {
      v11 = v7[4];
      v4 += v11;
  ...
  while ( v2 != v3 )
  {
    ...
    v13 = *((int *)v2 + 4);
    if ( (unsigned int)v13 > 0x20 || !_bittest64(&v8, v13) )
    {
      v14 = v2[4];
      if ( v14 )
      {
