/*
 * XREFs of MiDecrementCloneBlockReference @ 0x1400B8CA0
 * Callers:
        ...
        ULONG_PTR a3)
{
  ...
  if ( *(_QWORD *)(qword_140327F90 + 276840632) > *(_QWORD *)(BugCheckParameter2 + 72) )
  {
  ...
  if ( _InterlockedExchangeAdd64((volatile signed __int64 *)(BugCheckParameter2 + 48), 0xFFFFFFFFFFFFFFFFuLL) == 1 )
  {
    ...
    if ( _InterlockedExchangeAdd64((volatile signed __int64 *)(v12 + 8), 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    {
      ...
      *(_QWORD *)(v13 + 24) = v4 + (unsigned int)(v14 >> 12);
      RtlpInterlockedPushEntrySList(&stru_140326950, (PSLIST_ENTRY)v13);
      KeSetEvent(&stru_140326938, 0, 0);
