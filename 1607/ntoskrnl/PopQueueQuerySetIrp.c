/*
 * XREFs of PopQueueQuerySetIrp @ 0x14012B068
 * Callers:
...
LABEL_22:
  ...
  if ( v1 )
  {
    ...
    qword_140303AD8 = (__int64)&v3->Tail.Overlay.ListEntry;
  }
  Flink = v8[1];
  if ( Flink )
  {
