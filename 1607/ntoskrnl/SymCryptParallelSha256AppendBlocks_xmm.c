  ...
  *a4 = v12;
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      v48 = _mm_load_si128(a4 + 8);
      do
      {
        v49 = _mm_load_si128(v46 + 3);
        v50 = _mm_load_si128(v46 + 2);
        v51 = _mm_load_si128(v46 + 1);
        v52 = _mm_add_epi32(
                _mm_add_epi32(
                  _mm_add_epi32(
                    _mm_add_epi32(
                      ...
                      v46[8]),
                    *v46),
                  _mm_xor_si128(_mm_and_si128(_mm_xor_si128(v50, v51), v49), v51)),
                _mm_shuffle_epi32(_mm_cvtsi32_si128(*(v44 - 2)), 0));
        v53 = _mm_add_epi32(v52, v48);
        v46[4] = v53;
        v48 = _mm_add_epi32(
                _mm_add_epi32(
                  _mm_xor_si128(
                ...
                _mm_add_epi32(
                  _mm_add_epi32(
                    _mm_add_epi32(
                      ...
                      v46[9]),
                    v51),
                  _mm_xor_si128(_mm_and_si128(_mm_xor_si128(v50, v49), v53), v50)),
                ...
                _mm_add_epi32(
                  _mm_add_epi32(
                    _mm_add_epi32(
                      ...
                      v46[10]),
                    v50),
                  _mm_xor_si128(_mm_and_si128(_mm_xor_si128(v53, v49), v55), v49)),
        ...
        v45 = _mm_add_epi32(
                _mm_add_epi32(
                  ...
                  v56),
                _mm_or_si128(_mm_and_si128(_mm_or_si128(v47, v48), v43), _mm_and_si128(v47, v48)));
        v58 = _mm_add_epi32(
                _mm_add_epi32(
                  _mm_add_epi32(
                    _mm_add_epi32(
                      ...
                      v46[7]),
                    v49),
                  _mm_xor_si128(_mm_and_si128(_mm_xor_si128(v55, v53), v57), v53)),
                _mm_shuffle_epi32(_mm_cvtsi32_si128(v44[1]), 0));
        v44 += 4;
        v46[3] = _mm_add_epi32(v58, v43);
        v43 = _mm_add_epi32(
                _mm_add_epi32(
                  _mm_xor_si128(
                    _mm_xor_si128(
      ...
      while ( (__int64)v44 < (__int64)GUID_DEVICE_PROPERTY_CHANGED.Data4 );
      v59 = _mm_add_epi32(v43, a4[3]);
      a4[11] = v59;
      v60 = _mm_add_epi32(v45, a4[2]);
      a4[3] = v59;
      a4[10] = v60;
      v61 = _mm_add_epi32(v47, a4[1]);
      a4[2] = v60;
      a4[9] = v61;
      v62 = _mm_load_si128(a4);
      a4[1] = v61;
      v63 = _mm_add_epi32(v62, v48);
      a4[8] = v63;
      *a4 = v63;
      v64 = _mm_load_si128(a4 + 6);
      a4[7] = _mm_add_epi32(_mm_load_si128(a4 + 7), a4[71]);
      a4[6] = _mm_add_epi32(v64, a4[70]);
      v65 = _mm_load_si128(a4 + 4);
      a4[5] = _mm_add_epi32(_mm_load_si128(a4 + 69), a4[5]);
      a4[4] = _mm_add_epi32(v65, a4[68]);
      --v21;
    }
    while ( v21 );
  }
  v66 = _mm_load_si128(a4 + 10);
  v67 = _mm_load_si128(a4 + 11);
  v68 = _mm_load_si128(a4 + 9);
  v69 = _mm_unpacklo_epi32(v67, v66);
  v70 = _mm_unpackhi_epi32(v67, v66);
  v71 = _mm_load_si128(a4 + 8);
  v72 = _mm_unpackhi_epi32(v68, v71);
  v73 = _mm_unpacklo_epi32(v68, v71);
  **a1 = _mm_unpacklo_epi64(v69, v73);
  *a1[1] = _mm_unpackhi_epi64(v69, v73);
  *a1[2] = _mm_unpacklo_epi64(v70, v72);
  *a1[3] = _mm_unpackhi_epi64(v70, v72);
  v74 = _mm_load_si128(a4 + 7);
  v75 = _mm_load_si128(a4 + 5);
  v76 = _mm_unpacklo_epi32(v74, a4[6]);
  v77 = _mm_unpacklo_epi32(v75, a4[4]);
  v78 = _mm_unpackhi_epi32(v74, a4[6]);
  v79 = _mm_unpackhi_epi32(v75, a4[4]);
  (*a1)[1] = _mm_unpacklo_epi64(v76, v77);
  a1[1][1] = _mm_unpackhi_epi64(v76, v77);
  a1[2][1] = _mm_unpacklo_epi64(v78, v79);
  result = a1[3];
  result[1] = _mm_unpackhi_epi64(v78, v79);
  return result;
}
