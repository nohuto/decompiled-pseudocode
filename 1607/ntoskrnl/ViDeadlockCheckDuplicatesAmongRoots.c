/*
 * XREFs of ViDeadlockCheckDuplicatesAmongRoots @ 0x140715024
 * Callers:
 *     VfDeadlockAcquireResource @ 0x140713510 (VfDeadlockAcquireResource.c)
 * Callees:
 *     ViDeadlockMergeNodes @ 0x1407154C8 (ViDeadlockMergeNodes.c)
 *     ViDeadlockSimilarNodes @ 0x140715D58 (ViDeadlockSimilarNodes.c)
 */
