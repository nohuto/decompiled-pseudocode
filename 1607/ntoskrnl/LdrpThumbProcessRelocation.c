/*
 * XREFs of LdrpThumbProcessRelocation @ 0x1402158A8
 * Callers:
 *     LdrProcessRelocationBlockLongLong @ 0x140554168 (LdrProcessRelocationBlockLongLong.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1402157D8 (LdrpArmProcessRelocation.c)
 */
