/*
 * XREFs of FsRtlpRegisterUncProvider @ 0x140578250
 * Callers:
 *     FsRtlRegisterUncProviderEx2 @ 0x140578238 (FsRtlRegisterUncProviderEx2.c)
 *     FsRtlRegisterUncProvider @ 0x14061E470 (FsRtlRegisterUncProvider.c)
 *     FsRtlRegisterUncProviderEx @ 0x14061E4A8 (FsRtlRegisterUncProviderEx.c)
 * Callees:
