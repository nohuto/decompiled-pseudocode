/*
 * XREFs of SdbpCheckMatchingRegistry @ 0x1406C2448
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SdbpCheckMatchingRegistry(_DWORD *a1, __int64 a2, int a3, __int64 a4, int a5, __int64 a6)
{
  ...
  *a1 = 0;
  ...
  if ( (unsigned int)SdbpGetRegistryMatchingAttributes(
                       ...
                       (__int64)&v12) )
  {
    if ( (unsigned int)SdbpCheckMatchingRegistryEntry(v17, v16, v10, v15, v18, v14, v13, v12, &v11) )
    {
      v7 = 1;
      *(_DWORD *)(a6 + 80) = 1;
      *a1 = v11;
    ...
    else
    {
      AslLogCallPrintf(
        1,
        (unsigned int)"SdbpCheckMatchingRegistry",
        1251,
        (unsigned int)"Failed to check MATCHING_REG entry");
    }
  }
  else
  {
    AslLogCallPrintf(
      ...
      (unsigned int)"SdbpCheckMatchingRegistry",
      1234,
      (unsigned int)"Failed to read MATCHING_REG entry");
  }
  return v7;
}
