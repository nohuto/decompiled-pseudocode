/*
 * XREFs of KsepDsEventPoolFree @ 0x1401DDD90
 * Callers:
 *     KseDsHookExFreePool @ 0x1401DD214 (KseDsHookExFreePool.c)
 *     KseDsHookExFreePoolWithTag @ 0x1401DD23C (KseDsHookExFreePoolWithTag.c)
 * Callees:
...
char __fastcall KsepDsEventPoolFree(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( KseEtwHandle )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v8 = 8;
      v11 = 4;
      LOBYTE(v3) = EtwWrite(v4, &KseDsEventPoolFree, 0LL, 3u, &UserData);
    }
  }
  return (char)v3;
}
