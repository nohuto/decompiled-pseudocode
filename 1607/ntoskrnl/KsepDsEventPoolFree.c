/*
 * XREFs of KsepDsEventPoolFree @ 0x1401DDF64
 * Callers:
 *     KseDsHookExFreePool @ 0x1401DD3E8 (KseDsHookExFreePool.c)
 *     KseDsHookExFreePoolWithTag @ 0x1401DD410 (KseDsHookExFreePoolWithTag.c)
 * Callees:
