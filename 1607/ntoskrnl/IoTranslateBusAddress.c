/*
 * XREFs of IoTranslateBusAddress @ 0x1401CD674
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IopFindResourceHandlerInfo @ 0x140557390 (IopFindResourceHandlerInfo.c)
 *     IopFindLegacyBusDeviceNode @ 0x14055741C (IopFindLegacyBusDeviceNode.c)
