/*
 * XREFs of MiReserveWorkingSetSwapSpaceRuns @ 0x140663564
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  v6 = a2;
  v7 = a4;
  if ( *(_QWORD *)(*(_QWORD *)(a1 + 8LL * a3 + 6304) + 48LL) >= a2 )
  {
    v9 = a5;
    if ( a5 < a5 + 80 )
    {
      ...
      do
      {
        ...
        *(_QWORD *)v9 = ((unsigned __int64)(v5 & 0xF) << 12) | MiMakePageFilePte(v7) & 0xFFFFFFFFFFFF0FFFuLL;
        FreePageFileSpace = MiFindFreePageFileSpace(a1, (_WORD *)v9, v6, 0x29u);
