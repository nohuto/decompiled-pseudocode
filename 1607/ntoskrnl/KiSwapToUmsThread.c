/*
 * XREFs of KiSwapToUmsThread @ 0x1406508F8
 * Callers:
 ...
 *     KeSaveLegacyFloatingPointControlWord @ 0x14015DB70 (KeSaveLegacyFloatingPointControlWord.c)
    ...
    else
    {
      ...
      *(_QWORD *)(a1 + 64) = ((unsigned __int64)&ExitStatus.ExceptionInformation[1] + 7) & 0xFFFFFFFFFFFFFFC0uLL;
      ...
      if ( SBYTE8(PerfGlobalGroupMask) < 0 )
      {
        ...
        v35 = 0;
        v31[0] = CurrentRunTime;
        v31[2] = CurrentThread[1].KernelStack;
        v31[1] = *(_DWORD *)(v6 + 1592);
        v22 = *(_BYTE *)(a1 + 72) & 1;
        v34 = 16;
        v31[3] = v22;
        v33 = v31;
        EtwTraceKernelEvent((int)&v33, 1, 0x40000080u, 6432, 4200450);
      }
      ...
      if ( SBYTE8(PerfGlobalGroupMask) < 0 )
      {
        ...
        v36 = v32;
        v37 = 16;
        EtwTraceKernelEvent((int)&v36, 1, 0x40000080u, 6433, 4200450);
      }
