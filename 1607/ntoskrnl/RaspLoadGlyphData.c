/*
 * XREFs of RaspLoadGlyphData @ 0x140129DE4
 * Callers:
...
__int64 __fastcall RaspLoadGlyphData(__int64 a1, int a2, int a3, __int64 *a4, __int64 a5)
{
  int v9; // eax
  __int64 v10; // rcx
  ...
  if ( v12 < 0 )
    return RaspLoadCompositeGlyphData(a1, a2, a3, (_DWORD)a4, a5);
  else
