/*
 * XREFs of AlpcpAllocateFromBitmap @ 0x1404B9CE0
 * Callers:
 *     AlpcpAllocateCompletionBuffer @ 0x1404B9BF0 (AlpcpAllocateCompletionBuffer.c)
 * Callees:
 *     AlpcpFreeBitmap @ 0x14052A428 (AlpcpFreeBitmap.c)
 */
