/*
 * XREFs of IopWriteDriverList @ 0x1401C7E98
 * Callers:
...
__int64 __fastcall IopWriteDriverList(__int64 a1, char a2, unsigned int a3, unsigned int a4)
{
  PVOID *v4; // rbx
  __int64 v5; // rsi
  unsigned int *v6; // rdi
  ...
  while ( 1 )
  {
    if ( v4 == &PsLoadedModuleList )
      return 0LL;
    if ( a2 == 1
      && (!IopIsAddressRangeValid((__int64)v4, 160LL)
       || !IopIsAddressRangeValid((__int64)v4[12], *((unsigned __int16 *)v4 + 44))) )
    {
      break;
    }
