...
__int64 __fastcall ExpSetBootEntry(int a1, _DWORD *a2, unsigned __int64 a3)
{
  ...
  unsigned int v53; // [rsp+80h] [rbp-78h]
  ...
  if ( *v14 == 1 && (v50 || v14[2] <= 0xFFFF) )
  {
    ...
    if ( (v17 & 1) != 0
      ...
      || (v56 = (char *)v14 + v18 + 28, v56 >= (char *)v14 + v9) )
    {
...
LABEL_85:
    ...
    if ( EnvironmentVariable >= 0 )
    {
      if ( v56 > v20 || &v20[(unsigned int)Size] > (char *)v16 )
      {
        EnvironmentVariable = -1073741811;
        goto LABEL_84;
      }
      ...
      else
      {
        ...
        EnvironmentVariable = ZwTranslateFilePath(v16, 4u, v23, (ULONG)&v43);
        if ( EnvironmentVariable < 0 )
          goto LABEL_84;
...
LABEL_54:
        v51 = Size + 6 + v26 + v25;
        v27 = v51;
        v28 = ExAllocatePoolWithTag(NonPagedPoolNx, v51, 0x72766E45u);
        P = v28;
        if ( !v28 )
        {
          EnvironmentVariable = -1073741670;
LABEL_56:
        ...
        *((_WORD *)v30 + 2) = OutputFilePathLength;
        ...
        v34 = (char *)P + v33 + 6;
        memmove(v34, v44->FilePath, OutputFilePathLength);
...
LABEL_81:
      ...
      EnvironmentVariable = ZwTranslateFilePath(v19, 4u, 0LL, (ULONG)&v47);
      if ( EnvironmentVariable == -1073741789 )
      {
        v26 = v47 + v14[6] - v19->Length;
...
LABEL_86:
  ...
  if ( v50 && v3 && EnvironmentVariable >= 0 )
    *v3 = i;
