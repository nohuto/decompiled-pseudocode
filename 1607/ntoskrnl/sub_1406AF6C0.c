/*
 * XREFs of sub_1406AF6C0 @ 0x1406AF6C0
 * Callers:
...
__int64 __fastcall sub_1406AF6C0(unsigned int a1, _DWORD *a2)
{
  __int64 result; // rax
  __int64 v4; // rcx
  char *v5; // rdi
        ...
        (int)result >= 0) )
  {
    ...
    {
      LODWORD(v7) = a2[2] + 24;
      return CmSetValueKey(v6, (UNICODE_STRING *)&stru_1406E97E0, 3, a2, v7, 0LL, 0);
    }
    else
    {
      v8 = stru_1406E97E0;
