...
__int64 __fastcall MiMemoryLicense(__int64 a1)
{
  ...
  v3 = 0xFFFFFFFFALL;
  qword_1403269F0 = v2;
  if ( ((unsigned __int64)qword_140326A00 >> 12) - 1 < 0xFFFFFFFFALL )
    v3 = ((unsigned __int64)qword_140326A00 >> 12) - 1;
  ...
  qword_140327360 = 0xFFFFFF7FALL;
  qword_140326A90 = 0xFFFFFF7FALL;
  return result;
}
