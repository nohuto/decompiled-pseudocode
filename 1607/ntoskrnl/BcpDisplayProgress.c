/*
 * XREFs of BcpDisplayProgress @ 0x14023A124
 * Callers:
 ...
 *     BcpCursorLessThan @ 0x140239A1C (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, int a2, unsigned int a3)
{
  ...
  if ( BcpCursorLessThan(&v20) )
  {
    ...
    v14 = HIDWORD(v20);
    v24 = v20;
    v15 = *(_DWORD *)(*(_QWORD *)(qword_1403293B0 + 24) + 40LL);
    ...
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_1403293B0, v13, v14, v15, v15, &v22, &v23, v19) < 0 )
        return 0LL;
      v13 += v22;
      LODWORD(v24) = v13;
      if ( v13 > v17 )
