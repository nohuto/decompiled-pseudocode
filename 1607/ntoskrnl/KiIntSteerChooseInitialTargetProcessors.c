/*
 * XREFs of KiIntSteerChooseInitialTargetProcessors @ 0x14012DD00
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  *(_QWORD *)(a6 + 8) = 0LL;
  v11 = *(_DWORD *)(a3 + 16);
  LOBYTE(a3) = a5;
  SteeringMode = KeIntSteerGetSteeringMode(a1, a2, a3, v11, v19);
  if ( SteeringMode != 2 || (v10 = KiIntRedirectConnnect(a1, a2, v13), v10 >= 0) )
  {
    ...
    else
    {
      ...
      *(_WORD *)(a6 + 8) = v17;
      v18 = *v7;
      *(_QWORD *)a6 = *v7;
      if ( LOWORD(KiIntSteerAffinitizedInterrupts[0]) <= v17 )
        LOWORD(KiIntSteerAffinitizedInterrupts[0]) = v17 + 1;
      qword_140307A68[v17] |= v18;
    }
    *a7 = SteeringMode;
  }
