/*
 * XREFs of MiInitializeVadBitMap @ 0x14046D8CC
 * Callers:
...
__int64 __fastcall MiInitializeVadBitMap(int a1)
{
  ...
  v4 = (int *)(qword_140327F90 + 276840480);
  *(_DWORD *)(qword_140327F90 + 276840548) = (unsigned __int64)(*(_QWORD *)(Process + 1152) - 65537LL) >> 16;
  for ( i = 0; i < 2; ++i )
  {
    v6 = (unsigned int)v4[3] >> 15 << 12;
    *v4 = v4[3] & 0x7FFF;
    *((_QWORD *)v4 - 1) = qword_140327F90 + 4 * (v6 >> 2);
    if ( a1 == 1 )
      *(v4 - 4) = 0;
