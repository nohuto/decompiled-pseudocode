/*
 * XREFs of sub_1401587A0 @ 0x1401587A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1401587A0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r9
  __int64 v7; // rdx
  int v8; // ecx
  ...
  v7 = (0x5851F42D4C957F2DLL * v4) ^ (((unsigned __int64)v4 * (unsigned __int128)0x5851F42D4C957F2DuLL) >> 64);
  v8 = 4;
  v9 = v7;
  v10 = (_QWORD *)(a2 + 24);
  do
  ...
  {
    v12 = ((unsigned __int64)v11 ^ __ROL8__(v11, 17)) * (unsigned __int128)0x5851F42D4C957F2DuLL;
    v13 = 6;
    *((_QWORD *)&v12 + 1) ^= v12;
  ...
  result = MmSetPageProtection((unsigned __int64)v19, (v18[10] + 4095 + ((v18[8] + v18[11]) & 0xFFF)) & 0xFFFFF000);
  *(_QWORD *)(a1 + 40) = 0LL;
  *(_QWORD *)(a1 + 32) = a3;
  return result;
}
