...
char __fastcall PopCheckShutdownMarker(int a1, void *a2)
{
  ...
  xmmword_140328FA8 = xmmword_140341530;
    ...
    && TlgKeywordOn(&hProvider, 0x200000000000uLL) )
  {
    ...
    v16 = WORD6(xmmword_140328FA8);
    v18 = HIWORD(xmmword_140328FA8);
    ...
    v41 = 1LL;
    v43 = 1LL;
    TlgWrite(&hProvider, &unk_14027CB65, 0LL, 0LL, 0xCu, &pData);
  }
  ...
  xmmword_140328FC8 = *(_OWORD *)&::Buffer;
