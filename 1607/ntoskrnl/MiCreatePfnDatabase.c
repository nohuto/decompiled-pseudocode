...
__int64 __fastcall MiCreatePfnDatabase(__int64 a1)
{
  ...
  v4 = (unsigned __int16)KeNumberNodes * (unsigned int)(unsigned __int8)MiChannelMaximumPowerOf2 * dword_1403269FC;
  v5 = (unsigned int)v4;
  dword_1403269FC *= (unsigned __int16)KeNumberNodes * (unsigned __int8)MiChannelMaximumPowerOf2;
  qword_140323C00 = 48 * (qword_140326A90 + 1);
  v6 = 40 * v4;
  v7 = (unsigned __int64 *)&unk_140323C10;
  qword_140323C08 = v6 + qword_140323C00;
  v8 = v6 + 15;
  v9 = (unsigned __int64 *)&unk_140323C10;
  v10 = (qword_140323C08 + v8) & 0xFFFFFFFFFFFFFFF0uLL;
  v11 = 16 * v5;
  do
  {
    *v9 = v10;
  ...
  while ( (__int64)v9 < (__int64)qword_140323C20 );
  v12 = 416LL * v2;
  v13 = 144LL * v2 + 4095;
  ...
  do
    *v16++ -= 0x58000000000LL;
  while ( (__int64)v16 < (__int64)&unk_140323C10 );
  do
    *v7++ -= 0x58000000000LL;
  while ( (__int64)v7 < (__int64)qword_140323C20 );
  qword_1403269B0 = (PSLIST_HEADER)(v14 - 0x58000000000LL);
  qword_1403269A8 = (void *)(v12 + v14 - 0x58000000000LL);
  qword_1403274D0 = v15 - 0x58000000000LL;
  qword_140323570 = v10 - 0x58000000000LL;
