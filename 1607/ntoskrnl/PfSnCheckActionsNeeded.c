/*
 * XREFs of PfSnCheckActionsNeeded @ 0x1403E7994
 * Callers:
 ...
 *     PfpGetPageListCount @ 0x14042BC08 (PfpGetPageListCount.c)
 */
...
LABEL_27:
  ...
  v23 = (_DWORD *)PfSnPrefetchCacheEntryGet(&unk_140328738, v34, v12, &v32);
  v24 = v23;
  if ( v23 )
  {
    if ( v32 )
