/*
 * XREFs of ?StStart@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@PEAU_ST_CREATE_PARAMS@@@Z @ 0x140004FE4
 * Callers:
 ...
 *     RtlGetCompressionWorkSpaceSize @ 0x14000634C (RtlGetCompressionWorkSpaceSize.c)
