/*
 * XREFs of NtReleaseWorkerFactoryWorker @ 0x1400F68B0
 * Callers:
 *     <none>
 * Callees:
          ...
          *(_QWORD *)(v19 + 8) = v20;
          ...
          if ( *(_BYTE *)(v22 + 388) == 5 )
          {
            ...
            if ( v24 == 1 || v24 == 4 )
            {
              ...
              {
                v34[0] = 0;
                while ( _interlockedbittestandset64((volatile signed __int32 *)(v26 + 22672), 0LL) )
                {
                  do
                    KeYieldProcessorEx(v34);
                  while ( *(_QWORD *)(v26 + 22672) );
                }
                if ( *(_QWORD *)(v22 + 712) )
                {
                  v27 = *(_QWORD *)(v22 + 216);
                ...
                _InterlockedAnd64((volatile signed __int64 *)(v26 + 22672), 0LL);
              }
              CurrentPrcb = v35;
              *(_BYTE *)(v22 + 388) = 7;
              v21 = 1;
...
LABEL_45:
      ...
      KiExitDispatcher((__int64)v35, 0LL, 1LL, 0LL, v37);
    }
    else
    {
      LOBYTE(v6) = 1;
