/*
 * XREFs of CcInitializeBcbProfiler @ 0x140777304
 * Callers:
 ...
 *     KiGetLoadOptions @ 0x1407CFB60 (KiGetLoadOptions.c)
 */
...
char CcInitializeBcbProfiler()
{
  ...
  _QWORD v82[12]; // [rsp+90h] [rbp-9h] BYREF
  unsigned int v83; // [rsp+100h] [rbp+67h] BYREF
  int v84; // [rsp+108h] [rbp+6Fh]
  int v85; // [rsp+110h] [rbp+77h]
  int v86; // [rsp+118h] [rbp+7Fh]

  LOBYTE(PoolWithTag) = MEMORY[0xFFFFF780000002D4];
  if ( (MEMORY[0xFFFFF780000002D4] & 0xFE) == 0 )
  {
    v84 = 1359872;
    SubStr[0] = __ROR4__(1359872, 14);
    v85 = 34094095;
    SubStr[1] = __ROR4__(34078720, 51);
    v86 = 4587520;
    SubStr[2] = __ROL4__(4587520, 16);
    v64 = 9043968;
    SubStr[3] = __ROR4__(9043968, 17);
    v65 = 536886294;
    SubStr[4] = __ROR4__(536870916, 60);
    v66 = 647168;
    SubStr[5] = __ROL4__(647168, 19);
    v67 = 82837504;
    SubStr[6] = __ROR4__(82837504, 20);
    v68 = 13973;
    SubStr[7] = __ROR4__(2688, 69);
    v69 = 59392;
    SubStr[8] = __ROL4__(59392, 22);
    SubStr[9] = 0;
    ...
    if ( !PoolWithTag )
    {
      ...
      *((_QWORD *)&v4 + 1) = (((unsigned __int64)v4 ^ *((_QWORD *)&v4 + 1)) * (unsigned __int128)0x47AE147AE147AE15uLL) >> 64;
      ...
      v9 = (unsigned int *)RtlLookupFunctionTable((unsigned __int64)v8, v82, &v83);
      if ( !v9 || v83 < 0xC )
      {
        v17 = -1073741701;
LABEL_58:
        v80 = 649216;
        KeBugCheckEx(__ROR4__(649216, 11), 6uLL, (ULONG_PTR)v8, v17, 0LL);
      }
      v10 = v8[3];
      v11 = 0LL;
      v12 = 0;
        ...
        if ( PoolWithTag )
        {
          ...
          *(_QWORD *)&Dpc[2].Header.Lock = v41;
          ...
          if ( v7 )
          {
            ...
            *(_QWORD *)&Dpc[3].Header.Lock = sub_1403E1000;
            Dpc[2].Dpc = 0LL;
          }
          v57 = __rdtsc();
          v58 = __ROR8__(v57, 3);
