/*
 * XREFs of _woutput_l @ 0x140150144
 * Callers:
...
LABEL_121:
                            v39 = v7 - v13 - v38;
                            if ( (v6 & 0xC) == 0 )
                              write_multi_char(32LL, v39, v58, &v48);
                            write_string(v56, v38, v58, &v48);
                            v40 = v58;
                            if ( (v6 & 0xC) == 8 )
                              write_multi_char(48LL, v39, v58, &v48);
                            if ( v51 || (int)v13 <= 0 )
                            {
                              write_string(v15, (unsigned int)v13, v40, &v48);
LABEL_135:
                              v12 = v48;
                            }
                            else
                            {
                              ...
                              {
                                --v42;
                                v43 = safecrt_mbtowc(v55, v41, _mb_cur_max);
                                v44 = v43;
                                if ( v43 == 2 )
                                  --v42;
                                if ( v43 <= 0 )
                                  break;
                                write_char(v55[0], v58, &v48);
                                v41 += v44;
                                if ( v42 <= 0 )
                                {
                                  v40 = v58;
                            ...
                            if ( v12 >= 0 && (v6 & 4) != 0 )
                            {
                              write_multi_char(32LL, v39, v40, &v48);
                              v12 = v48;
                            }
                            a2 = v60;
                            v7 = v52;
