/*
 * XREFs of sub_1406AF9A8 @ 0x1406AF9A8
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406AF9A8(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_1406AEC14(a1, a2, a3, a4, 4);
  }
  else
  {
    v14 = -1073741772;
