/*
 * XREFs of IopDumpCallAddPagesCallbacks @ 0x1401C7004
 * Callers:
...
char __fastcall IopDumpCallAddPagesCallbacks(int a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (__int64 *)v3 == &KeBugCheckAddRemovePagesCallbackListHead )
      break;
    result = KeValidateBugCheckCallbackRecord(v3, 4LL, &v10);
    if ( result )
    {
      v5 = 0LL;
      HIDWORD(v6) = a1;
      ...
      do
      {
        ...
        v8 = 0LL;
        v9 = 0;
        (*(void (__fastcall **)(__int64, __int64, __int64 *))(v3 + 16))(4LL, v3, &v5);
        if ( v4 >= 0 )
        {
          if ( v8 )
            v4 = IopAddPageDumpRange((__int64)&v5, &v9);
        }
      }
      while ( v9 );
      result = (v4 < 0) + 3;
