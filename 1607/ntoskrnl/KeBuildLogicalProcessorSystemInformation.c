/*
 * XREFs of KeBuildLogicalProcessorSystemInformation @ 0x1404B70E4
 * Callers:
...
LABEL_24:
          ...
          else
          {
            ...
            *((_DWORD *)v17 - 2) = 2;
            ...
            a2 += 32LL;
            *v17 = 0LL;
            *v17 = *(_QWORD *)(v11 + 12 * v19 + 24448);
            *((_DWORD *)v17 + 2) = *(_DWORD *)(v11 + 12 * v19 + 24456);
            v17 += 4;
          }
          goto LABEL_12;
        }
