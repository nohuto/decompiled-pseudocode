/*
 * XREFs of LdrpResGetResourceDirectory @ 0x1404FE824
 * Callers:
        ...
        PIMAGE_NT_HEADERS *a5)
{
  ...
  if ( result >= 0 )
  {
    ...
    {
      v17 = v28;
      v18 = (unsigned int *)LdrpSectionTableFromVirtualAddress(v5, v28, (__int64)NtHeader, v11, v15, v9 != 0);
      if ( !v18 )
        return -1073741701;
      if ( !v18[4] )
        return -1073741687;
