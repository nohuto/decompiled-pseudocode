/*
 * XREFs of EmpParseCallbacks @ 0x1407A7874
 * Callers:
 *     EmpParseInfDatabase @ 0x1407A7384 (EmpParseInfDatabase.c)
 * Callees:
 *     EmpSearchCallbackDatabase @ 0x14013CDFC (EmpSearchCallbackDatabase.c)
 *     EmpSearchEntryDatabase @ 0x14013CE30 (EmpSearchEntryDatabase.c)
 *     __security_check_cookie @ 0x14014CA50 (__security_check_cookie.c)
 *     strtoul @ 0x14014F838 (strtoul.c)
...
__int64 __fastcall EmpParseCallbacks(__int64 a1)
{
  ...
  if ( SectionLineCount )
  {
    while ( 1 )
    {
      ...
      GuidFromName = EmpInfParseGetGuidFromName(a1, "CallbackGuidDef", KeyName, PoolWithTag);
      v10 = v9;
...
LABEL_12:
    ...
    while ( 1 )
    {
      ...
      GuidFromName = EmpInfParseGetGuidFromName(a1, "EntryTypeGuidDef", v15, v18);
      if ( GuidFromName < 0 )
        break;
