/*
 * XREFs of _RtlpMuiRegSerializeRegistryInfo @ 0x14056165C
 * Callers:
      ...
      *((_QWORD *)a2 + 20) = *(_QWORD *)(a1 + 160);
      ...
      if ( v23 )
      {
        ...
        *((_QWORD *)a2 + 4) = (char *)v21 - (char *)a2;
        v10 = (**(_DWORD **)(a1 + 32) + 7 + v10) & 0xFFFFFFF8;
        v21 = (_QWORD *)((char *)a2 + v10);
      }
      ...
      if ( v24 )
      {
        ...
        *((_QWORD *)a2 + 5) = (char *)v21 - (char *)a2;
        v10 = (**(_DWORD **)(a1 + 40) + 7 + v10) & 0xFFFFFFF8;
        v21 = (_QWORD *)((char *)a2 + v10);
      }
      ...
      if ( v25 )
      {
        ...
        *((_QWORD *)a2 + 7) = (char *)v21 - (char *)a2;
        v10 = (**(_DWORD **)(a1 + 56) + 7 + v10) & 0xFFFFFFF8;
        v21 = (_QWORD *)((char *)a2 + v10);
      }
      if ( *(_DWORD *)(a1 + 148) )
      {
        ...
        if ( v30 )
        {
          ...
          *((_QWORD *)a2 + 16) = (char *)v21 - (char *)a2;
          v10 = (*(_DWORD *)(a1 + 148) + 7 + v10) & 0xFFFFFFF8;
          v21 = (_QWORD *)((char *)a2 + v10);
        }
      }
      if ( *(_DWORD *)(a1 + 160) )
