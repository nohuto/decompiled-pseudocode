/*
 * XREFs of MiReplenishNonPagedSlists @ 0x1400174C0
 * Callers:
 ...
 *     MiAllocatingNonPagedPoolVa @ 0x140017AA8 (MiAllocatingNonPagedPoolVa.c)
...
__int64 __fastcall MiReplenishNonPagedSlists(__int128 *a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  struct _SLIST_ENTRY *v24; // [rsp+A0h] [rbp+28h]

  v6 = &qword_1403269B0[26 * a2];
  ListHead = &v6[a5 + 3];
  Alignment_low = LOWORD(ListHead->Alignment);
  if ( Alignment_low >= (unsigned int)dword_140326448[a5 - 1] >> 1 )
    return 0LL;
  ...
  *(_QWORD *)&v22 = v9;
  ...
  if ( v14 )
  {
    ...
    while ( 1 )
    {
      ...
      v18 = v24;
      *(_QWORD *)v17 = v17 ^ qword_140327780;
      if ( !v13 )
