/*
 * XREFs of LdrpResSearchResourceMappedFile @ 0x1400F7358
 * Callers:
 *     LdrResSearchResource @ 0x14051B158 (LdrResSearchResource.c)
 *     LdrResGetRCConfig @ 0x140542FA0 (LdrResGetRCConfig.c)
 * Callees:
 *     LdrpFindMessageInAlternateModule @ 0x1400FA1CC (LdrpFindMessageInAlternateModule.c)
        ...
        __int64 a9)
{
  ...
  ULONGLONG v49; // [rsp+C8h] [rbp-330h]
...
LABEL_40:
  ...
  if ( !v41 )
  {
    MappingSize = LdrpResGetMappingSize(ullAugenda, &v41, 512LL);
    v33 = v41;
  }
  if ( (v10 & 0x1000) != 0 && MappingSize < 0 )
    goto LABEL_41;
  MappingSize = LdrpResGetResourceDirectory(ullAugenda, v33, (__int64)&v46);
  if ( MappingSize < 0 )
    goto LABEL_39;
LABEL_20:
  ...
  if ( v38 && v27 >= 0 && v44 && v22 )
  {
    if ( v50 )
      ...
      LODWORD(v34) = v51;
    MappingSize = LdrpFindMessageInAlternateModule(ullAugenda, *v44, v34, *(_DWORD *)(a4 + 24), 1);
    if ( MappingSize < 0 )
    {
      *v44 = 0LL;
