/*
 * XREFs of sub_1406C0614 @ 0x1406C0614
 * Callers:
...
__int64 __fastcall sub_1406C0614(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // edx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
...
LABEL_17:
    ...
    if ( v8 && *(_DWORD *)a1 > 4u )
    {
      ...
      if ( !*v8 )
        v18 = 0LL;
      v19 = qword_140747360 ? qword_140747360(v18) : -1073741637;
      v20 = *(_DWORD *)(a2 + 32);
