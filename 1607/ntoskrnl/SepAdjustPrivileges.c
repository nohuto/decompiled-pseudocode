/*
 * XREFs of SepAdjustPrivileges @ 0x14045FEC8
 * Callers:
        ...
        _BYTE *a9)
{
  ...
  *a9 = 0;
  ...
  if ( v45 )
  {
    ...
    v12 = 0;
LABEL_22:
    if ( !v45 && ((unsigned int)v47 < (unsigned int)v51 || v12) )
      v14 = 262;
  }
  else if ( (_DWORD)v51 )
  {
    v16 = v49;
    Buf1 = (void *)(unsigned int)v51;
    while ( 1 )
    {
      v17 = *a5;
      v18 = *(_QWORD *)(a1 + 64);
