/*
 * XREFs of VfCtxHookAndConnectInterrupt @ 0x140719A74
 * Callers:
 *     VerifierIoConnectInterrupt @ 0x1407055AC (VerifierIoConnectInterrupt.c)
 * Callees:
        ...
        char a11)
{
  ...
  v18 = pXdvIoConnectInterrupt(a1, v14, v13, a4, a5, a6, a7, a8, a9, a10, a11);
  if ( v18 < 0 )
  {
    if ( v11 )
