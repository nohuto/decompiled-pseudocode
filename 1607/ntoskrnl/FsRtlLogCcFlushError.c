/*
 * XREFs of FsRtlLogCcFlushError @ 0x14061DC2C
 * Callers:
        ...
        ULONG Flags)
{
  ...
  v7 = 0;
  result = MmIsWriteErrorFatal(1, (DeviceObject->Characteristics & 0x10) != 0, FlushError);
  if ( !result )
    return result;
...
LABEL_30:
  ...
  {
    v13 = -16;
    if ( (unsigned __int64)(FileName->Length + 48 + 2LL) <= 0xF0 )
