/*
 * XREFs of PiCMCreateDevice @ 0x1406461E4
 * Callers:
...
LABEL_43:
    ...
    if ( (v15 & 2) != 0 )
    {
      ...
      v42 = 1;
      inited = PnpCtxRegSetValue(v22, v44, (__int64)L"Phantom", 4LL, (__int64)&v42, 4u);
      ZwClose(v44);
      if ( inited < 0 )
        goto LABEL_20;
...
LABEL_73:
    ...
    if ( DeviceRegProp < 0 )
      v29 = 0;
    v38 = v29;
    DeviceInstanceCsConfigFlags = PnpGetDeviceInstanceCsConfigFlags((__int64)&v48, v28, &v41);
    v31 = v41;
