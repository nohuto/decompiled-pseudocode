/*
 * XREFs of KsepDsEventPoolAllocate @ 0x1401DDE84
 * Callers:
 *     KseDsHookExAllocatePool @ 0x1401DD348 (KseDsHookExAllocatePool.c)
 *     KseDsHookExAllocatePoolWithTag @ 0x1401DD394 (KseDsHookExAllocatePoolWithTag.c)
 * Callees:
