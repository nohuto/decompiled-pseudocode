 ...
 *     MmGetPagedPoolCommitPointer @ 0x1400B5FC8 (MmGetPagedPoolCommitPointer.c)
  ...
  if ( !(_BYTE)KdDebuggerEnabled )
  {
    ...
    if ( !KdpDebuggerDataListHead )
    {
      *((_QWORD *)&KdpContext + 1) = KdDebugDevice;
      ...
      qword_14031CC98 = (__int64)&KdpPowerListHead;
      KdpPowerListHead = (__int64)&KdpPowerListHead;
      qword_14031CC88 = (__int64)&KdpDebuggerDataListHead;
    ...
    if ( a2 )
    {
      ...
      *(_QWORD *)&xmmword_1402F4E38 = v10;
      ...
      {
        strupr(v11);
        *(_DWORD *)((char *)&KdDebuggerNotPresent + 3) = 0;
        v12 = 0;
        v13 = strstr(v11, "DBGPRINT_LOG_SIZE=");
        if ( v13 )
        {
          v28 = (atol(v13 + 18) + 4095) & 0xFFFFF000;
          *(_DWORD *)((char *)&KdDebuggerNotPresent + 3) = v28;
          if ( v28 > 0x1000000 )
          {
            v28 = 0x1000000;
            *(_DWORD *)((char *)&KdDebuggerNotPresent + 3) = 0x1000000;
          }
          if ( v28 <= 0x1000 )
            *(_DWORD *)((char *)&KdDebuggerNotPresent + 3) = 0;
        }
