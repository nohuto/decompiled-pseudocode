/*
 * XREFs of _CmGetDeviceMappedPropertyFromComposite @ 0x1404CE780
 * Callers:
 ...
 *     _PnpMultiSzGetLen @ 0x1404D55C8 (_PnpMultiSzGetLen.c)
        ...
        int a9)
{
  ...
  unsigned int v51; // [rsp+7Ch] [rbp-84h] BYREF
  unsigned int v52; // [rsp+80h] [rbp-80h] BYREF
  char v53[4]; // [rsp+84h] [rbp-7Ch] BYREF
  ...
  unsigned int v58; // [rsp+A8h] [rbp-58h] BYREF
  char v59[4]; // [rsp+ACh] [rbp-54h] BYREF
  ...
  *v12 = 0;
    ...
    && *(_QWORD *)(a4 + 8) == *(_QWORD *)DEVPKEY_Device_ProblemStatus.fmtid.Data4 )
  {
    ...
    v52 = 0;
    v51 = 0;
    DeviceStatus = CmGetDeviceStatus(a1, (_DWORD)a2, pcchLength, (unsigned int)&v48, (__int64)&v52, (__int64)&v51);
    if ( DeviceStatus >= 0 )
    {
      v26 = *(_DWORD *)(a4 + 16);
      v27 = v48;
    ...
    && *(_QWORD *)(a4 + 8) == *(_QWORD *)DEVPKEY_Device_RemovalRelations.fmtid.Data4 )
  {
    v31 = 8;
LABEL_94:
    DeviceRelationsList = CmGetDeviceRelationsList(a1, (_DWORD)a2, v31, 0, 0, (__int64)&v49);
    ...
    if ( DeviceRelationsList != -1073741772 && DeviceRelationsList )
    {
      if ( DeviceRelationsList == -1073741789 )
      {
        ...
        *a5 = 8210;
        ...
        {
          v21 = a1;
          DeviceStatus = CmGetDeviceRelationsList(a1, (_DWORD)a2, v31, (_DWORD)v10, v33 >> 1, (__int64)&v49);
          if ( !DeviceStatus )
          {
...
LABEL_22:
  ...
  {
    v49 = v16 >> 1;
    DeviceParent = CmGetDeviceParent(a1, a2, v10, &v49);
  ...
  {
    v49 = v16 >> 1;
    DeviceChildren = CmGetDeviceChildren(a1, a2, v10, &v49);
    goto LABEL_114;
  }
  if ( v17 == 10
  ...
  {
    v49 = v16 >> 1;
    DeviceChildren = CmGetDeviceSiblings(a1, a2, v10, &v49);
LABEL_114:
...
LABEL_108:
  ...
  if ( v17 == 2 )
  {
    ...
    {
      v50 = 78;
      DeviceStatus = CmGetDeviceRegProp(a1, (_DWORD)a2, pcchLength, 37, (__int64)v60, (__int64)Str2, (__int64)&v50, v15);
      if ( DeviceStatus < 0 )
        goto LABEL_21;
...
LABEL_142:
    ...
    && *(_QWORD *)(a4 + 8) == *(_QWORD *)DEVPKEY_Device_HasProblem.fmtid.Data4 )
  {
    ...
    *(_BYTE *)v10 = 0;
    ...
    if ( (v48 & 0x8000) == 0 )
    {
      if ( (v48 & 0x400) == 0 || v52 <= 0x1D && (v38 = 591396864, _bittest(&v38, v52)) )
      {
        if ( (v48 & 8) != 0 )
          goto LABEL_19;
  ...
  else
  {
      ...
      && *(_QWORD *)(a4 + 8) == *(_QWORD *)DEVPKEY_Device_IsRebootRequired.fmtid.Data4 )
    {
      ...
      *(_BYTE *)v10 = 0;
      ...
      if ( v42 == -1073741810 )
        return 0;
      if ( v42 < 0 || (v48 & 0x100) == 0 && ((v48 & 0x400) == 0 || v52 != 14) )
        goto LABEL_19;
      goto LABEL_185;
    }
    if ( v17 == 8
...
LABEL_23:
  if ( DeviceStatus != -1073741810 )
    return (unsigned int)DeviceStatus;
  v24 = CmOpenDeviceRegKey(v21, (_DWORD)v23, 16, 0, 1, 0, (__int64)&Handle, 0LL);
  DeviceStatus = v24;
  if ( !v24 )
  {
    ZwClose(Handle);
