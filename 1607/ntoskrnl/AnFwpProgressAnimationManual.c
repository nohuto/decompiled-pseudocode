...
LONGLONG AnFwpProgressAnimationManual()
{
  ...
  result = qword_140328C18;
  if ( v2 + v0.QuadPart >= qword_140328C18 + PerformanceFrequency.QuadPart / 33 )
  {
    v4 = word_1402F4E60;
    if ( word_1402F4E60 != -7989 && (qword_140328C18 - v2 - v0.QuadPart) / v1 >= 2 )
      v4 = ++word_1402F4E60;
