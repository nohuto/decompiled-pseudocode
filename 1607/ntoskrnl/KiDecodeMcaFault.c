...
__int64 KiDecodeMcaFault()
{
  ...
  if ( !KeTestSpinLock((PKSPIN_LOCK)CompleteDev + 183) )
    return (*((__int64 (__fastcall **)(_BYTE *, _QWORD))CompleteDev + 74))(CompleteDev + 1464, 0LL);
  v2 = *((unsigned int *)CompleteDev + 359);
  v3 = *((_QWORD *)CompleteDev + 176);
  v4 = (__int64 (__fastcall *)(__int64, __int64, _QWORD, __int64))*((_QWORD *)CompleteDev + 29);
  v5 = *((unsigned int *)CompleteDev + 354);
