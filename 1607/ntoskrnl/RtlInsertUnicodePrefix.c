/*
 * XREFs of RtlInsertUnicodePrefix @ 0x1404C072C
 * Callers:
 *     <none>
 * Callees:
 *     RtlSplay @ 0x1400C59E0 (RtlSplay.c)
 *     CompareUnicodeStrings @ 0x1404C0990 (CompareUnicodeStrings.c)
 *     ComputeUnicodeNameLength @ 0x1404C0B10 (ComputeUnicodeNameLength.c)
 */
