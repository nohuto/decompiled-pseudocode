/*
 * XREFs of AdtpBuildAccessesString @ 0x1406D17B8
 * Callers:
        ...
        _BYTE *a9)
{
  ...
  PCUNICODE_STRING v48; // [rsp+58h] [rbp-71h]
  _QWORD *v49; // [rsp+60h] [rbp-69h]
  ...
  if ( (_WORD)v9 )
  {
    ...
    *(_DWORD *)&String.Length = 1310720;
    ...
    do
    {
      if ( (v41 & v9) != 0 )
      {
        v42 = RtlIntegerToUnicodeString(v39 + v40, 0xAu, &String);
        appended = v42;
        if ( v42 >= 0 )
        {
          RtlAppendUnicodeToString(&Destination, L"%%");
