/*
 * XREFs of MiDeleteSessionAddressSpace @ 0x140122D08
 * Callers:
...
void __fastcall MiDeleteSessionAddressSpace(unsigned __int64 a1, _QWORD *a2)
{
  ...
  v30 = 0LL;
  v31 = 0LL;
  v25 = (((unsigned __int64)qword_140326910 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
  v26[0] = (((unsigned __int64)(qword_140326910 + 0x7FFFFFFFFFLL) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
  v26[1] = (((unsigned __int64)qword_140326910 >> 27) & 0x1FFFF8) - 0x90482600000LL;
  v26[2] = (((unsigned __int64)(qword_140326910 + 0x7FFFFFFFFFLL) >> 27) & 0x1FFFF8) - 0x90482600000LL;
  SharedVm = MiGetSharedVm(v8);
  v11 = MiGetSharedVm(v10);
  v12 = ExAcquireSpinLockExclusive(v11);
  v11[1] = 0;
  v15 = v12;
  v16 = (struct _SLIST_ENTRY *)*((_QWORD *)SharedVm + 5);
  if ( v16 )
  {
