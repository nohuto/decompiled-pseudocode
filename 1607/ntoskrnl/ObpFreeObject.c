/*
 * XREFs of ObpFreeObject @ 0x14041B800
 * Callers:
...
void __fastcall ObpFreeObject(unsigned __int64 a1, PVOID *a2, __int64 a3)
{
  ...
  if ( v5 && (_QWORD *)*v5 != v5 )
  {
    ...
    v25 = (_BYTE *)KeAbPreAcquire(v10 + 184, 0LL, 0);
    v26 = v25;
    v39 = v25;
  ...
  if ( (*(_BYTE *)(a1 + 27) & 1) != 0 )
  {
    ...
    {
      ++P->FreeMisses;
      ((void (__fastcall *)(struct _SLIST_ENTRY *))P->FreeEx)(v20);
    }
    goto LABEL_25;
  }
  if ( *(_QWORD *)(a1 + 32) )
  {
    if ( v7 )
    {
      ...
      {
        if ( v7[2] )
          PspReturnQuota(*((char **)v7 + 2), 0LL, 1u, (unsigned int)v7[2]);
    ...
    if ( v14 == 1 )
      goto LABEL_24;
    if ( v12 )
      PspReturnQuota(*(char **)(a1 + 32), 0LL, 1u, v12);
    if ( v13 )
