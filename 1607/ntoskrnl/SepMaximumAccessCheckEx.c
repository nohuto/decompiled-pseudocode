      ...
      if ( v23 != 4 )
      {
        ...
        if ( v23 == 6 )
        {
          if ( !SepSidInToken(
                  a1,
                  0LL,
                  &v22[16 * (*((_DWORD *)v22 + 2) & 1) + 12 + 8 * (*((_DWORD *)v22 + 2) & 2)],
                  1,
                  v15,
                  a12) )
            goto LABEL_13;
...
LABEL_11:
        ...
        if ( v23 != 9 )
        {
          ...
          if ( ((v59 + 1) & 0xFFFFFFFD) != 0 )
            goto LABEL_13;
LABEL_97:
          if ( !SepSidInToken(a1, 0LL, v22 + 8, 1, v15, a12) )
            goto LABEL_13;
          goto LABEL_98;
        }
...
LABEL_13:
    ...
    {
      if ( !a9
        || !SepSidInToken(a1, 0LL, &v22[8 * (v34 & 2) + 12 + (v35 != 0 ? 0x10 : 0)], 0, v15, a12)
    ...
    v37 = &v22[8 * (v34 & 2) + 12 + (v35 != 0 ? 0x10 : 0)];
LABEL_34:
    v25 = SepSidInToken(a1, 0LL, v37, 0, v15, a12);
    goto LABEL_9;
  }
LABEL_14:
  if ( v15 && (_DWORD)v18 )
