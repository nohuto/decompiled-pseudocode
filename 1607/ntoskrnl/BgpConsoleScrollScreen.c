...
__int64 BgpConsoleScrollScreen()
{
  ...
  v1 = 0;
  v2 = 0LL;
  v3 = (_DWORD *)(qword_140329968 + 60);
  v4 = (_DWORD *)(qword_140329968 + 48);
  v25 = qword_140329968 + 60;
  v26 = qword_140329968 + 48;
  do
  {
    v5 = 0;
    if ( *(_DWORD *)(v0 + 4) != 1 )
...
LABEL_7:
      ...
      if ( v12 >= 0 )
      {
        *(_WORD *)(qword_140329968 + 12 * v7 + 88) = v9;
...
LABEL_10:
  ...
  do
  {
    ...
    if ( v18 >= 0 )
    {
      v19 = v17 + v15;
      v20 = 3 * v19;
      *(_WORD *)(qword_140329968 + 4 * v20 + 88) = 32;
