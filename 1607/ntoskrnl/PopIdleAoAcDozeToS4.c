/*
 * XREFs of PopIdleAoAcDozeToS4 @ 0x140674EC0
 * Callers:
 *     <none>
 * Callees:
...
void PopIdleAoAcDozeToS4()
{
  ...
  dword_1403033B0 = 0;
  memset(v2, 0, 24);
  if ( dword_1403033C8 == 1 )
    goto LABEL_10;
  if ( dword_1403033C8 != 2 )
  {
    if ( dword_1403033C8 == 3 )
    {
      LODWORD(v2[0]) = 13;
      goto LABEL_11;
    }
    if ( dword_1403033C8 == 4 )
    {
      LODWORD(v2[0]) = 14;
      goto LABEL_11;
    }
LABEL_10:
  ...
  LODWORD(v2[0]) = 11;
  if ( qword_1403034B8
    && MEMORY[0xFFFFF78000000008] - qword_1403034B8 > 10000000
...
LABEL_11:
  ...
  _InterlockedAnd(&dword_1403033CC, 0);
