/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x14022A6E4
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x14022A7D0 (EtwpDequeueBufferPendingCompressionFromQueue.c)
