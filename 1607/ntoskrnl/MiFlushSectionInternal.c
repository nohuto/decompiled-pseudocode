/*
 * XREFs of MiFlushSectionInternal @ 0x140029DB0
 * Callers:
 ...
 *     MiWaitForAsynchronousFlushes @ 0x1401EB0D0 (MiWaitForAsynchronousFlushes.c)
...
LABEL_143:
      ...
      if ( (v41 & 0x10) != 0 )
      {
        ...
        {
          v45 = *(int **)(qword_140326FF8 + 8LL * v44);
          v104 = v45;
        }
        if ( (v43 & 1) != 0 )
        {
