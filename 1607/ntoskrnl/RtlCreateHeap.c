        ...
        PRTL_HEAP_PARAMETERS Parameters)
{
  ...
  PVOID v41; // [rsp+60h] [rbp-198h] BYREF
  ULONG_PTR v42; // [rsp+68h] [rbp-190h] BYREF
  PVOID BaseAddress; // [rsp+70h] [rbp-188h] BYREF
  ULONG_PTR RegionSize; // [rsp+78h] [rbp-180h] BYREF
...
LABEL_65:
  ...
  if ( v21 == v20 )
  {
    if ( ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &v41, 0LL, &v42, 0x1000u, 4u) < 0 )
      goto LABEL_64;
    if ( (BYTE8(PerfGlobalGroupMask) & 0x20) != 0 )
      RtlpLogHeapCommit((__int64)v36, (__int64)v41, v42, 1u);
    v20 += v42;
    v22 = (char *)v36;
  }
  v23 = (__int64)(v22 + 672);
  ...
  {
    v35 = (unsigned __int64)(v22 + 679) & 0xFFFFFFFFFFFFFFF8uLL;
    *((_QWORD *)v22 + 41) = v35;
    v24 += 2064;
    v23 = v35 + 2064;
    v8 |= 0x4000000u;
  ...
  *((_DWORD *)v36 + 30) |= 0x80000000;
  if ( !RtlpInitializeHeapSegment(
          ...
          (__int64)v41,
          v20,
          (ULONG_PTR)v41 + InitialReserve - v46) )
  {
LABEL_64:
    v18 = v37;
    goto LABEL_65;
  ...
  *((_QWORD *)v36 + 33) = -16LL;
  ...
  if ( (BYTE8(PerfGlobalGroupMask) & 0x20) != 0 )
  {
    RtlpLogHeapCreateEvent((__int64)v31, v8, InitialReserve, v42);
    v31 = v36;
    if ( (BYTE8(PerfGlobalGroupMask) & 0x20) != 0 )
    {
