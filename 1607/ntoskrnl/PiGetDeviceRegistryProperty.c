/*
 * XREFs of PiGetDeviceRegistryProperty @ 0x14062A568
 * Callers:
 ...
 *     RtlFormatMessage @ 0x140686F04 (RtlFormatMessage.c)
 */
    ...
    else if ( v10[1] == 8 )
    {
      if ( v7 )
      {
        if ( v21 )
          ...
          RegistryValue = RtlFormatMessage(v13, 0, 0, 0, 1u, Arguments, Buffer, *ReturnLength, ReturnLength);
      }
      else
      {
