/*
 * XREFs of VmCreateMemoryRange @ 0x14069B2E4
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VmValidateMemoryRangeParameters @ 0x14069B55C (VmValidateMemoryRangeParameters.c)
 */
...
__int64 __fastcall VmCreateMemoryRange(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !VmTbFlushEnabled )
    VmTbFlushEnabled = 1;
  v10 = (_QWORD *)Process[2].ActiveProcessors.Bitmap[14];
  if ( !v10 )
  {
    ...
    if ( _InterlockedCompareExchange64(
           (volatile signed __int64 *)&Process[2].ActiveProcessors.Bitmap[14],
           (signed __int64)v10,
           0LL) )
    {
  ...
  v14[8] = v16;
  v14[9] = v16 + a3 - 1;
  inserted = VmpInsertMemoryRange((volatile LONG *)v10, v14, a4);
  if ( inserted >= 0 )
  {
    v14 = 0LL;
    inserted = 0;
