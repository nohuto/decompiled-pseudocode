...
__int64 MiInitializeDummyPages()
{
  ...
  *(_QWORD *)(v1 + 16) = DemandZeroPte;
  qword_1403276A0 = (v1 + 0x58000000000LL) / 48;
  MxFillPhysicalPage(qword_1403276A0);
  qword_140327680 = MiAllocateDummyPage();
  *(_QWORD *)(qword_140327680 + 16) = DemandZeroPte;
  qword_140327688 = (qword_140327680 + 0x58000000000LL) / 48;
  MxFillPhysicalPage(qword_140327688);
  ...
  *(_QWORD *)(DummyPage + 16) = DemandZeroPte;
  ...
  if ( (unsigned int)MI_SHOULD_PTE_BE_GLOBAL((((unsigned __int64)MmPfnDatabase >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL) )
    v5 |= 0x100uLL;
  v6 = ~v4 & (v5 | 0x8000000000000100uLL) ^ ((unsigned __int16)~(_WORD)v4 ^ (unsigned __int16)((unsigned __int8)word_140326AA8 << 8)) & 0x100;
  MxFillPhysicalPage(v3);
  qword_140327710 = (v6 & 0xFFFFFFFFFFFFFEFFuLL ^ (qword_140327708 << 12)) & 0xFFFFFFFFF000LL ^ v6 & 0xFFFFFFFFFFFFFEFFuLL;
  ...
  *(_QWORD *)(v7 + 16) = DemandZeroPte;
  ...
  if ( (unsigned int)MI_SHOULD_PTE_BE_GLOBAL((((unsigned __int64)MmPfnDatabase >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL) )
    v10 |= 0x100uLL;
  v11 = ~v9 & (v10 | 0x8000000000000100uLL) ^ ((unsigned __int16)~(_WORD)v9 ^ (unsigned __int16)((unsigned __int8)word_140326AA8 << 8)) & 0x100;
  MxFillPhysicalPage(v8);
  v11 &= ~0x100uLL;
  result = (v11 ^ (qword_140327718 << 12)) & 0xFFFFFFFFF000LL;
  qword_140327720 = result ^ v11;
  return result;
}
