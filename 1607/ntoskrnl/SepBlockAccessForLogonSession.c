/*
 * XREFs of SepBlockAccessForLogonSession @ 0x140533AB8
 * Callers:
 *     SepRmInteractiveLogoffLogonSessionCompletedWrkr @ 0x140533A90 (SepRmInteractiveLogoffLogonSessionCompletedWrkr.c)
 * Callees:
