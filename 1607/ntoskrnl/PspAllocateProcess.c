/*
 * XREFs of PspAllocateProcess @ 0x14046F030
 * Callers:
 ...
 *     PspSelectNodeForProcess @ 0x14046D2F8 (PspSelectNodeForProcess.c)
 *     MmInitializeProcessAddressSpace @ 0x14046D378 (MmInitializeProcessAddressSpace.c)
 *     MmGetSessionSchedulingGroupByProcess @ 0x14046EE54 (MmGetSessionSchedulingGroupByProcess.c)
 *     KeInitializeProcess @ 0x14046EE78 (KeInitializeProcess.c)
 *     PspInheritMitigationOptions @ 0x140470C84 (PspInheritMitigationOptions.c)
 ...
 *     PspReadIFEOPerfOptions @ 0x1404731FC (PspReadIFEOPerfOptions.c)
 *     RtlQueryImageFileKeyOption @ 0x1404732C4 (RtlQueryImageFileKeyOption.c)
 *     PspReadIFEONodeOptions @ 0x140473474 (PspReadIFEONodeOptions.c)
 ...
 *     PspInheritQuota @ 0x1404E1674 (PspInheritQuota.c)
 ...
 *     PspHardenMitigationOptions @ 0x1404EC218 (PspHardenMitigationOptions.c)
...
LABEL_324:
  ...
  {
    KeQuerySystemTimePrecise((__int64 *)v24 + 97);
  }
  else
  {
    v24 = (char *)Object;
