/*
 * XREFs of PspProcessOpen @ 0x1404BB280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PspProcessOpen(__int64 a1, char a2, __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  v7 = a5;
  if ( a2
    && !(unsigned __int8)RtlTestProtectedAccess(*(unsigned __int8 *)(a3 + 1738), *(unsigned __int8 *)(a4 + 1738))
    && (dword_1406EA304[3 * ((unsigned __int64)v9 >> 4)] & *v7) != 0
