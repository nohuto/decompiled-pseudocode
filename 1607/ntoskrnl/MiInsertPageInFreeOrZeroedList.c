/*
 * XREFs of MiInsertPageInFreeOrZeroedList @ 0x1400671C0
 * Callers:
...
LABEL_3:
  ...
  *(_QWORD *)(v5 + 8) |= 0x8000000000000000uLL;
  ...
  v12 = dword_1403269F8 & (unsigned int)BugCheckParameter2 | (((v11 >> 36) & 3) << byte_1403269D8) | ((unsigned __int8)((v11 >> 58) & 0x3F) << byte_1403269C9);
  v13 = v12;
  v14 = *((_QWORD *)v8 + 6) + 2184 * (v12 >> byte_1403269C9);
  v15 = *((_QWORD *)v8 + 219);
  v16 = (unsigned __int8)(MiChannelMaximumPowerOf2Mask & ((unsigned int)v12 >> byte_1403269D8));
...
LABEL_19:
  ...
  if ( (unsigned int)MmNumberOfChannels > 1 )
    _InterlockedIncrement64((volatile signed __int64 *)(v14
                                                      ...
                                                      * (v23
                                                       + 2LL
                                                       * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & ((unsigned int)*(_QWORD *)(((unsigned __int64)v63 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58) >> byte_1403269D8)))
                                                      + 2072));
