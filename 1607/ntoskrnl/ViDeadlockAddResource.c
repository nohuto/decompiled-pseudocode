/*
 * XREFs of ViDeadlockAddResource @ 0x14071474C
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( v11 )
  {
    ...
    {
      ViDeadlockPreprocessOptions(byte_1402F99E0, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(196, 4101, a1, v11, 0LL, byte_1402F99E0);
    }
    if ( *(_QWORD *)(v11 + 16) )
    {
      ViDeadlockPreprocessOptions(byte_1402F99D8, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(196, 4101, a1, v11, 1uLL, byte_1402F99D8);
    }
