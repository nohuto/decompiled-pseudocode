...
__int64 __fastcall HvStoreModifiedData(ULONG_PTR BugCheckParameter2, char a2, char a3)
{
  ...
  PVOID v37; // [rsp+48h] [rbp-38h]
  unsigned int i; // [rsp+50h] [rbp-30h] BYREF
  ...
  *(_DWORD *)(BugCheckParameter2 + 2892) = (unsigned __int8)HvpTruncateBins(BugCheckParameter2);
  ...
  if ( *(_DWORD *)(BugCheckParameter2 + 88) )
  {
    ...
    v39 = *(_DWORD *)(BugCheckParameter2 + 72);
    LODWORD(v43) = v39;
    v44 = v3;
    v13 = HvpGenerateLogEntry(BugCheckParameter2, &P, &v40);
    v5 = P;
    if ( v13 < 0 )
    {
LABEL_50:
...
LABEL_9:
    ...
    if ( *(_DWORD *)(BugCheckParameter2 + 88) )
    {
      *(_DWORD *)(BugCheckParameter2 + 2856) = v39;
      v16 = v40;
    ...
    {
      v6 = 0LL;
      *(_QWORD *)(BugCheckParameter2 + 2944) = v37;
  ...
  if ( *(_DWORD *)(BugCheckParameter2 + 88) )
    RtlMergeBitMaps((__int64)&BitMapHeader, (__int64)&v43);
