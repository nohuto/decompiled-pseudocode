/*
 * XREFs of PopPluginQuerySocSubsystemMetadata @ 0x14066DC78
 * Callers:
...
char __fastcall PopPluginQuerySocSubsystemMetadata(__int64 a1, int a2, __int64 a3)
{
  ...
  v7 = 0;
  v8 = v3;
  PoolWithTag = (const wchar_t **)ExAllocatePoolWithTag(PagedPool, v6, 0x4D584650u);
  v10 = PoolWithTag;
  if ( PoolWithTag )
  {
      ...
      if ( v3 )
      {
        ...
        do
        {
          ...
          v7 = PopFxValidateReturnedUnicodeString(
                 *v18 + 8,
                 *(const wchar_t **)((char *)v19 + (char *)v12 - (char *)v10),
