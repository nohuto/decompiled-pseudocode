/*
 * XREFs of _CmCreateInterfaceClassWorker @ 0x1406D7860
 * Callers:
...
__int64 __fastcall CmCreateInterfaceClassWorker(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, bool *a5, __int16 a6)
{
  int v9; // ebx
  bool v10; // dl
