/*
 * XREFs of MiExpandPartitionIds @ 0x1406603B4
 * Callers:
...
__int64 __fastcall MiExpandPartitionIds(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  v3 = (__int64 *)qword_140326FF8;
  v4 = qword_140326FD8;
  if ( (__int64 *)qword_140326FF8 == &qword_140326FF0 )
    v5 = 512;
  else
    v5 = qword_140326FD8->SizeOfBitMap + 512;
  if ( v5 <= qword_140326FD8->SizeOfBitMap || v5 > 0x400 )
  {
    v6 = 0;
    v8 = 0LL;
  }
  ...
  if ( !v8 )
    return 0LL;
  if ( v3 == &qword_140326FF0 )
  {
    v10 = MiReservePtes((__int64)&qword_140327870, 2uLL, a3);
    if ( !v10 )
      goto LABEL_14;
  ...
  {
    if ( (__int64 *)qword_140326FF8 == &qword_140326FF0 )
      MiReleasePtes((__int64)&qword_140327870, PteAddress, 1u);
LABEL_14:
  ...
  if ( (__int64 *)qword_140326FF8 == &qword_140326FF0 )
  {
    *(_QWORD *)v11 = *(_QWORD *)qword_140326FF8;
    qword_140326FF8 = v11;
  }
  RtlClearAllBits(v8);
  SizeOfBitMap = qword_140326FD8->SizeOfBitMap;
  LOBYTE(v6) = (SizeOfBitMap & 0x3F) != 0;
  memmove(v8->Buffer, qword_140326FD8->Buffer, 8 * (v6 + (SizeOfBitMap >> 6)));
  if ( v8->SizeOfBitMap > 0x3FF )
    v8->Buffer[31] |= 0x80000000;
  if ( v8->SizeOfBitMap > 0x3FE )
    v8->Buffer[31] |= 0x40000000u;
  if ( qword_140326FD8 != (PRTL_BITMAP)&dword_140326FE0 )
    ExFreePoolWithTag(qword_140326FD8, 0);
  qword_140326FD8 = v8;
  return 1LL;
}
