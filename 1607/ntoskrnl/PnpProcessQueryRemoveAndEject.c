/*
 * XREFs of PnpProcessQueryRemoveAndEject @ 0x1404C41D8
 * Callers:
 ...
 *     IopRemoveDeviceRelationsFromList @ 0x1404C3768 (IopRemoveDeviceRelationsFromList.c)
 *     PiEventRemovalPostSurpriseRemove @ 0x1404C37B4 (PiEventRemovalPostSurpriseRemove.c)
 *     PiEventRemovalCompleteNotifyKernel @ 0x1404C4598 (PiEventRemovalCompleteNotifyKernel.c)
