/*
 * XREFs of KiEmulateAtlThunk @ 0x1401DC598
 * Callers:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$1A06FDC1EC270D7EC697F13D78904F04::$120F2532A465E26E2E996D9F9639858A::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
  ...
  else
  {
    if ( v15 != -71 || *(_BYTE *)(v10 + 5) != 0xB8 || *(_WORD *)(v10 + 10) != 0xE0FF )
    {
        ...
        && *(_BYTE *)(v10 + 5) == 4 )
      {
        ...
        v20 = *(_DWORD *)(unsigned int)(*(_DWORD *)v19 + 4);
