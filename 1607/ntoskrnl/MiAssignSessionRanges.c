...
__int64 MiAssignSessionRanges()
{
  ...
  struct _RTL_BITMAP BitMapHeader; // [rsp+30h] [rbp-91h] BYREF
  ...
  qword_1403268C0 = v18[1];
  qword_1403268C8 = v18[4];
  qword_140326900 = v18[10];
  qword_140326910 = v16;
  qword_140326908 = v18[10] + 8 * v0;
  result = v18[7];
  qword_140326918 = v18[7];
  return result;
}
