/*
 * XREFs of VfIsVerificationEnabled @ 0x1401319D0
 * Callers:
 *     VfFailDeviceNode @ 0x1401319A0 (VfFailDeviceNode.c)
 * Callees:
 *     PpvUtilIsHardwareBeingVerified @ 0x140701838 (PpvUtilIsHardwareBeingVerified.c)
 */
