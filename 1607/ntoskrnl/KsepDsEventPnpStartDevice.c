/*
 * XREFs of KsepDsEventPnpStartDevice @ 0x1401DDB28
 * Callers:
 *     KseDsCompletionHookForStartDevice @ 0x1401DD11C (KseDsCompletionHookForStartDevice.c)
 * Callees:
...
char __fastcall KsepDsEventPnpStartDevice(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( KseEtwHandle )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v12 = 8;
      v15 = 4;
      LOBYTE(v4) = EtwWrite(v5, &KseDsEventStartDevice, 0LL, 4u, &UserData);
    }
  }
  return (char)v4;
}
