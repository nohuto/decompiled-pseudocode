/*
 * XREFs of SeCodeIntegrityInitializePolicy @ 0x1407B9BC4
 * Callers:
...
__int64 __fastcall SeCodeIntegrityInitializePolicy(__int64 a1)
{
  ...
  if ( !v1
    || (v3 = *(_QWORD *)(v1 + 2520)) == 0
    || (v4 = *(unsigned int *)(v3 + 80), !(_DWORD)v4)
    || (v2 = SeSecureBootRegisterPolicy(*(unsigned int *)(v3 + 76) + v3 + 88, v4), v2 >= 0) )
  {
    SepInitializeDebugOptions();
    if ( qword_140301180 )
    {
      v2 = qword_140301180(v3, &v7, &v6);
      if ( v2 >= 0 )
      {
