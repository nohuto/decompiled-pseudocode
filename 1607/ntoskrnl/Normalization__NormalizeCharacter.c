/*
 * XREFs of Normalization__NormalizeCharacter @ 0x14068B660
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x14068A798 (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x14068B4B4 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1402150B4 (ComposeHangulLV.c)
 ...
 *     NormBuffer__LastStartBase @ 0x140215478 (NormBuffer__LastStartBase.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1402156FC (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x14068A798 (Normalization__AppendDecomposedChar.c)
