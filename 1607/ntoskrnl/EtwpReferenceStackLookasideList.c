/*
 * XREFs of EtwpReferenceStackLookasideList @ 0x1406A8420
 * Callers:
...
_SLIST_ENTRY *EtwpReferenceStackLookasideList()
{
  ...
  v0 = 2 * KeNumberProcessors_0 * _InterlockedIncrement(&dword_140329310);
  do
  {
    ...
    result = (_SLIST_ENTRY *)(unsigned int)_InterlockedIncrement(&dword_140329314);
  }
  while ( (int)result < v0 );
  return result;
}
