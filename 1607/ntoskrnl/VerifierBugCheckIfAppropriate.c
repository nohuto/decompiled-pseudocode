/*
 * XREFs of VerifierBugCheckIfAppropriate @ 0x14070C2E8
 * Callers:
 *     VfFailDeviceNode @ 0x1401319A0 (VfFailDeviceNode.c)
 *     VerifierFreeTrackedPool @ 0x1401EEE28 (VerifierFreeTrackedPool.c)
 *     VfFailDriver @ 0x1402226CC (VfFailDriver.c)
 *     VfFailSystemBIOS @ 0x1402226F4 (VfFailSystemBIOS.c)
 ...
 *     VerifierIoVolumeDeviceToDosName @ 0x14070D650 (VerifierIoVolumeDeviceToDosName.c)
 ...
 *     VfRemLockReportBadReleaseAndWaitTag @ 0x14070DE5C (VfRemLockReportBadReleaseAndWaitTag.c)
