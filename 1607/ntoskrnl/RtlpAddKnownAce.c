/*
 * XREFs of RtlpAddKnownAce @ 0x140421800
 * Callers:
 ...
 *     RtlAddAccessDeniedAceEx @ 0x1405718E4 (RtlAddAccessDeniedAceEx.c)
 *     NtSetUuidSeed @ 0x140577398 (NtSetUuidSeed.c)
 *     _PnpGetEnumSecurityDescriptor @ 0x14057B14C (_PnpGetEnumSecurityDescriptor.c)
 *     RtlAddAccessAllowedObjectAce @ 0x140684598 (RtlAddAccessAllowedObjectAce.c)
 *     RtlAddAccessDeniedObjectAce @ 0x1406845F4 (RtlAddAccessDeniedObjectAce.c)
 *     RtlAddAuditAccessAce @ 0x140684650 (RtlAddAuditAccessAce.c)
 *     RtlAddAuditAccessAceEx @ 0x140684674 (RtlAddAuditAccessAceEx.c)
 *     RtlAddAuditAccessObjectAce @ 0x140684698 (RtlAddAuditAccessObjectAce.c)
