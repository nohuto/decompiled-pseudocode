/*
 * XREFs of sub_1406AE414 @ 0x1406AE414
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406AE414(unsigned int a1, size_t Size, _DWORD *Src, char a4, char a5)
{
  SIZE_T v5; // rbx
  void *v6; // r15
  __int64 v9; // r12
...
LABEL_47:
    if ( *(_QWORD *)&qword_140747E48
      || (updated = ExpObtainFastCacheKeyBody((UNICODE_STRING *)&stru_1406E9958, (PVOID *)&qword_140747E48), updated >= 0) )
    {
      v63 = 0LL;
...
LABEL_55:
    ...
    if ( updated >= 0 )
    {
      updated = sub_1406AF6C0((unsigned int)v9, MappedBase);
      if ( updated >= 0 )
      {
...
LABEL_78:
  ...
  updated = sub_1406AEC3C((unsigned int)v5, &Object, &MappedBase);
  if ( updated >= 0 )
  {
    v11 = MappedBase;
    goto LABEL_21;
