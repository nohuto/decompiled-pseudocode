...
char __fastcall IoInitSystemPreDrivers(__int64 a1)
{
  ...
  IopErrorLogLock = 0LL;
  qword_140320988 = (__int64)&IopErrorLogListHead;
  ...
  if ( (IopIrpStackProfilerFlags & 3) != 0 )
  {
    ...
    qword_140320AB8 = (__int64)IopIrpStackProfilerDpcRoutine;
  ...
  *(_QWORD *)&IopTimer.Header.Lock = 9LL;
  ...
  qword_140320B88 = (__int64)&IopDeadIrps;
  IopDeadIrps = (__int64)&IopDeadIrps;
  IopHardError.WorkerRoutine = (void (__fastcall *)(void *))IopHardErrorThread;
  qword_140320BC8 = (__int64)&qword_140320BC0;
  qword_140320BC0 = (__int64)&qword_140320BC0;
  ...
  qword_140320C28 = (__int64)&qword_140320C20;
  qword_140320C20 = &qword_140320C20;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  stru_140320CC0.Header.WaitListHead.Blink = &stru_140320CC0.Header.WaitListHead;
  stru_140320CC0.Header.WaitListHead.Flink = &stru_140320CC0.Header.WaitListHead;
  ...
  LOWORD(stru_140320CC0.Header.Lock) = 0;
  stru_140320CC0.Header.Size = 6;
  stru_140320CC0.Header.SignalState = 0;
  ...
  qword_1403202A8 = (__int64)&ActiveConnectList;
  ...
  NtGlobalFlag = v13;
  if ( SystemDlls < 0
    || (PfSnBeginBootPhase(0), !(unsigned __int8)IopReassignSystemRoot(a1, &v21))
