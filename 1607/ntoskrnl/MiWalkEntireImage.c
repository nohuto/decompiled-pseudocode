/*
 * XREFs of MiWalkEntireImage @ 0x14004C570
 * Callers:
 ...
 *     MiGetNextDirectFixupProto @ 0x140661738 (MiGetNextDirectFixupProto.c)
 *     MiPageHasRelocations @ 0x140661750 (MiPageHasRelocations.c)
 */
...
LABEL_73:
        ...
        if ( v52 == 1023 )
          ...
          v53 = *(int **)(qword_140326FF8 + 8LL * v52);
