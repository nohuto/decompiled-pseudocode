/*
 * XREFs of IopInitializeInMemoryDumpData @ 0x1401C75E4
 * Callers:
...
void IopInitializeInMemoryDumpData()
{
  ...
  *((_QWORD *)&v15 + 1) = 0xB50211F197DACBD4uLL;
  if ( _InterlockedExchange(InMemData, 1) != 1 )
  {
    dword_140328E44 = 0;
    dword_140328E30 = 0;
    v1 = ZwFilterBootOption(1LL, 270532611LL, 637534368LL);
    v2 = 9088;
    v3 = (PVOID *)&unk_140328E18;
    v4 = v1 >= 0;
    qword_140328E28 = 9088LL;
    v5 = 0;
    v6 = (__int64 *)&unk_140328E18;
    while ( 1 )
    {
      ...
      *v6 = (__int64)ContiguousNodeMemory;
      if ( !ContiguousNodeMemory )
        break;
      memset(ContiguousNodeMemory, 0, qword_140328E28);
      v11 = *v6;
      *(_OWORD *)v11 = v15;
      *(_QWORD *)(v11 + 16) = 0x199B7088610836E8LL;
      ...
      {
        v12 = __rdtsc();
        LODWORD(qword_140328E38) = v12;
        v13 = __rdtsc();
        HIDWORD(qword_140328E38) = v13;
        RtlRandomEx((PULONG)&qword_140328E38 + 1);
        v14 = IoSetEnvironmentVariableEx(
                (unsigned int)L"DumpInstance",
                (unsigned int)v16,
                (unsigned int)&qword_140328E38,
                8,
                7);
        if ( v14 < 0 )
        {
          dword_140328E44 = v14;
          qword_140328E38 = 0x4547415045474150LL;
        }
        dword_140328E14 = 1;
        goto LABEL_15;
      }
