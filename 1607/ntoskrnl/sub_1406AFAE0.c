/*
 * XREFs of sub_1406AFAE0 @ 0x1406AFAE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406AFAE0(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_1406AED4C(a1, a2, a3, a4, 4);
  }
  else
  {
    v14 = -1073741772;
