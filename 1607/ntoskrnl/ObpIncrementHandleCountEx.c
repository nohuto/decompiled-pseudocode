/*
 * XREFs of ObpIncrementHandleCountEx @ 0x14044DC50
 * Callers:
 ...
 *     OBJECT_HEADER_TO_PROCESS_INFO @ 0x1400B30C8 (OBJECT_HEADER_TO_PROCESS_INFO.c)
 ...
 *     ObpLockHandleDataBaseEntry @ 0x1404BAF00 (ObpLockHandleDataBaseEntry.c)
 */
