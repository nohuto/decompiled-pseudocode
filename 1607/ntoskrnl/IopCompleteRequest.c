/*
 * XREFs of IopCompleteRequest @ 0x140054840
 * Callers:
 ...
 *     IopAbortRequest @ 0x140620D88 (IopAbortRequest.c)
 * Callees:
 ...
 *     IopUpdateWriteTransferCount @ 0x14009F934 (IopUpdateWriteTransferCount.c)
