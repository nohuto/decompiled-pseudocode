...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    if ( v3 == 1 )
    {
      v7 = (_QWORD *)qword_140304208;
      v8 = *(_QWORD **)(qword_140304208 + 8);
      if ( *(__int64 **)qword_140304208 != &PopWakeInfoList || *v8 != qword_140304208 )
        __fastfail(3u);
      qword_140304208 = *(_QWORD *)(qword_140304208 + 8);
      *v8 = &PopWakeInfoList;
      v7[1] = v7;
      *v7 = v7;
