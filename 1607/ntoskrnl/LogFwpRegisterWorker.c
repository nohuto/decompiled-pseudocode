  ...
  if ( result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v1 >= 0 )
    {
      ...
      Data = 1000000 * qword_140328C28 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * qword_140328C60 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"ProgressManual");
      Data = 1000000 * qword_140328C70 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * qword_140328C40 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"FadeTotal");
      Data = 1000000 * qword_140328C58 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"AnimationTotal");
      Data = 1000000 * qword_140328C50 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"CompressBitmaps");
      Data = 1000000 * qword_140341C58 / PerformanceFrequency.QuadPart;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      v2 = Handle;
    }
    return ZwClose(v2);
