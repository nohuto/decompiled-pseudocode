/*
 * XREFs of KdSystemDebugControl @ 0x14064E858
 * Callers:
 *     <none>
 * Callees:
 *     ExUnlockUserBuffer @ 0x140086998 (ExUnlockUserBuffer.c)
 *     KdpSysReadIoSpace @ 0x1401D1B38 (KdpSysReadIoSpace.c)
 *     KdpSysReadMsr @ 0x1401D1BF0 (KdpSysReadMsr.c)
 *     KdpSysWriteIoSpace @ 0x1401D1C1C (KdpSysWriteIoSpace.c)
 *     KdpSysWriteMsr @ 0x1401D1CCC (KdpSysWriteMsr.c)
 ...
 *     KdpSysGetVersion @ 0x1406F418C (KdpSysGetVersion.c)
        ...
        KPROCESSOR_MODE a7)
{
  ...
  struct _MDL *v33; // [rsp+50h] [rbp-128h] BYREF
  ...
  if ( a1 > 14 )
  {
    ...
    if ( !v23 )
    {
      ...
      if ( v30 )
      {
        v15 = ExLockUserBuffer(v44.m128i_u64[1], v30, a7, IoReadAccess, &v32, &v33);
        if ( v15 >= 0 )
        {
    ...
    if ( !v26 )
    {
      ...
      if ( v29 )
      {
        v15 = ExLockUserBuffer(v42.m128i_u64[1], v29, a7, IoWriteAccess, &v32, &v33);
        if ( v15 >= 0 )
        {
    ...
    if ( !v27 )
    {
      ...
      if ( v28 )
      {
        v15 = ExLockUserBuffer(v40.m128i_u64[1], v28, a7, IoReadAccess, &v32, &v33);
        if ( v15 >= 0 )
        {
  ...
  if ( a1 == 14 )
  {
    ...
    if ( v22 )
    {
      v15 = ExLockUserBuffer(v38.m128i_u64[1], v22, a7, IoWriteAccess, &v32, &v33);
      if ( v15 >= 0 )
      {
  ...
  if ( !v9 )
  {
    ...
    if ( (_DWORD)v53 )
    {
      v15 = ExLockUserBuffer(v52.m128i_u64[1], v53, a7, IoWriteAccess, &v32, &v33);
      if ( v15 >= 0 )
      {
  ...
  if ( !v10 )
  {
    ...
    if ( (_DWORD)v51 )
    {
      v15 = ExLockUserBuffer(v50.m128i_u64[1], v51, a7, IoReadAccess, &v32, &v33);
      if ( v15 >= 0 )
      {
  ...
  if ( !v11 )
  {
    ...
    if ( (_DWORD)v49 )
    {
      v15 = ExLockUserBuffer(v48.m128i_u64[1], v49, a7, IoWriteAccess, &v32, &v33);
      if ( v15 >= 0 )
      {
  ...
  if ( !v12 )
  {
    ...
    if ( (_DWORD)v47 )
    {
      v15 = ExLockUserBuffer(v46.m128i_u64[1], v47, a7, IoReadAccess, &v32, &v33);
      if ( v15 >= 0 )
      {
  ...
  if ( v13 )
  {
    if ( v13 == 1 )
    {
      ...
      if ( (_DWORD)v35 )
      {
        v15 = ExLockUserBuffer(v34.m128i_u64[1], v35, a7, IoReadAccess, &v32, &v33);
        if ( v15 >= 0 )
        {
...
LABEL_60:
  ...
  if ( !(_DWORD)v37 )
    goto LABEL_43;
  v15 = ExLockUserBuffer(v36.m128i_u64[1], v37, a7, IoWriteAccess, &v32, &v33);
  if ( v15 >= 0 )
  {
