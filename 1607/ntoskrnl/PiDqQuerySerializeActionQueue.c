/*
 * XREFs of PiDqQuerySerializeActionQueue @ 0x14048B994
 * Callers:
 ...
 *     PiDqQueryGetObjectManager @ 0x14048C958 (PiDqQueryGetObjectManager.c)
 */
      ...
      if ( v7 >= 0 )
      {
        ...
        *(_QWORD *)(a1 + 184) = 0LL;
        ...
        do
        {
          if ( v21 )
          {
            NdrMesTypeEncode3(v14, "TP 3\a", &off_140257560, &off_1402F32A0, 1, &v21);
            if ( HIBYTE(v20) )
            {
              v7 = -1073741819;
              goto LABEL_31;
