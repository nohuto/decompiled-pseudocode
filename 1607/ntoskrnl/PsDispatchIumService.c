/*
 * XREFs of PsDispatchIumService @ 0x14020FC24
 * Callers:
 ...
 *     PspIumGetSystemData @ 0x140581B24 (PspIumGetSystemData.c)
 ...
 *     PspIumGetProcessorInfo @ 0x1406822C8 (PspIumGetProcessorInfo.c)
