/*
 * XREFs of _PnpInstallerClassRaisePropertyChangeEventWorker @ 0x1406DC1B4
 * Callers:
...
_UNKNOWN **__fastcall PnpInstallerClassRaisePropertyChangeEventWorker(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
