/*
 * XREFs of FsRtlpPostStackOverflow @ 0x1401BA684
 * Callers:
 *     FsRtlPostPagingFileStackOverflow @ 0x1401BA60C (FsRtlPostPagingFileStackOverflow.c)
 *     FsRtlPostStackOverflow @ 0x1401BA614 (FsRtlPostStackOverflow.c)
 * Callees:
