...
NTSTATUS PopInitializeIrpWorkers()
{
  ...
  qword_140302778 = (__int64)&PopIrpThreadList;
  PopIrpThreadList = (__int64)&PopIrpThreadList;
  qword_140303418 = (__int64)&PopIrpWorkerList;
  PopIrpWorkerList = (__int64)&PopIrpWorkerList;
  PopIrpWorkerCount = 0;
  qword_140303430 = (__int64)&qword_140303428;
  qword_140303428 = (__int64)&qword_140303428;
