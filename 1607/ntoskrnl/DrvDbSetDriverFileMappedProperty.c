/*
 * XREFs of DrvDbSetDriverFileMappedProperty @ 0x1406E2BDC
 * Callers:
        ...
        int a7)
{
  ...
  if ( !a3 )
  {
    v18 = 0;
    v17 = 2;
    v13 = DrvDbOpenObjectRegKey(a1, 0LL, 4, a2, v17, v18, Handle, 0LL);
    if ( v13 < 0 )
      goto LABEL_17;
    LODWORD(a3) = Handle[0];
  }
