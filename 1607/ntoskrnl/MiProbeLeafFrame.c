/*
 * XREFs of MiProbeLeafFrame @ 0x14002FDC0
 * Callers:
...
LABEL_64:
          ...
          {
            v24 = 2LL;
            if ( *(_DWORD *)(a1 + 56) == 5 && v1 >= qword_140327FF0 && v1 < qword_140327FF0 + 0x8000000000LL )
              v24 = 0LL;
          }
        ...
        if ( (v9 & 0x800) == 0 )
        {
          if ( (_DWORD)v10 == 5 && v1 >= qword_140327FF0 && v1 < v11 + qword_140327FF0 )
          {
            if ( !v14 )
              goto LABEL_54;
            v22 = *(_QWORD *)(v14 + 40);
