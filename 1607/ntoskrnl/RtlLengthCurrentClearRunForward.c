/*
 * XREFs of RtlLengthCurrentClearRunForward @ 0x14001A990
 * Callers:
...
__int64 __fastcall RtlLengthCurrentClearRunForward(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( v7 )
    --v6;
  v8 = a2 & 0x1F;
  LODWORD(v9) = ~dword_14026D370[v8] & *v5;
  v10 = 0;
  if ( v5 > v6 )
  {
LABEL_18:
    if ( v7 )
    {
      if ( v10 )
        LODWORD(v9) = v5[1];
      v14 = -1;
      v11 = !_BitScanForward64((unsigned __int64 *)&v9, (unsigned int)v9 | ~dword_14026D370[*(_DWORD *)a1 & 0x1F]);
      if ( !v11 )
        v14 = v9;
      v12 = v14;
      goto LABEL_8;
