/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x1403EEF00
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x1403EE5B4 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x140007A64 (PfVolumeSupportedForPrefetch.c)
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x130CuLL, 0LL, 0LL, 0LL);
...
LABEL_6:
        ...
        if ( (DevicePowerState & 0xC0000000) == 0xC0000000 )
          goto LABEL_15;
        if ( DevicePowerState == 259 )
          KeBugCheckEx(0x191u, 0x1355uLL, 0LL, 0LL, 0LL);
