/*
 * XREFs of CmpCreateChild @ 0x1403FE088
 * Callers:
 ...
 *     CmpRecordParseFailure @ 0x1401B3DB4 (CmpRecordParseFailure.c)
 ...
 *     CmpTryAcquireIXLockIntent @ 0x140403084 (CmpTryAcquireIXLockIntent.c)
