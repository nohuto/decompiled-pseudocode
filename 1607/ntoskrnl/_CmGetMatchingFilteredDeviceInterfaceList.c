/*
 * XREFs of _CmGetMatchingFilteredDeviceInterfaceList @ 0x1404F64E0
 * Callers:
        ...
        int a10)
{
  ...
  LODWORD(v24[0]) = 0;
  memset(&v24[1], 0, 0x50uLL);
  v24[2] = a2;
  v24[3] = a3;
  LODWORD(v24[4]) = a4;
  v13 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64, int, _QWORD *))(a1 + 328);
  LODWORD(v24[8]) = a8;
  v24[5] = a5;
  v24[9] = a9;
  LODWORD(v24[10]) = a10;
