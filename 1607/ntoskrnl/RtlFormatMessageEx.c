/*
 * XREFs of RtlFormatMessageEx @ 0x140686F50
 * Callers:
...
LABEL_27:
          LODWORD(v59) = v23 + 1;
          v30 = RtlStringCchPrintfExW(v13, v15, &v67, 0LL, 0, L"%%%u", v59);
        }
        else
        {
          LODWORD(v59) = v23 + 1;
          v30 = RtlStringCchPrintfExW(v13, v15, &v67, 0LL, 0, L"%%%u!%s!", v59, v76);
        }
LABEL_61:
        if ( v30 < 0 )
          return 2147483653LL;
...
LABEL_40:
      ...
      v30 = RtlStringCchPrintfExW(v13, v15, &v67, 0LL, 0, &pszDest, v40, v41, v42);
      goto LABEL_61;
    }
    switch ( v19 )
    {
