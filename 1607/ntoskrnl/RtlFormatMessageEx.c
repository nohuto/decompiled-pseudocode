/*
 * XREFs of RtlFormatMessageEx @ 0x140687034
 * Callers:
        ...
        PPARSE_MESSAGE_CONTEXT ParseContext)
{
  ...
  NTSTRSAFE_PWSTR ppszDestEnd; // [rsp+70h] [rbp-98h] BYREF
  NTSTRSAFE_PWSTR v68; // [rsp+78h] [rbp-90h] BYREF
  int v69; // [rsp+80h] [rbp-88h]
  int v70; // [rsp+84h] [rbp-84h]
  PWSTR v71; // [rsp+88h] [rbp-80h]
  __int64 v72; // [rsp+90h] [rbp-78h]
  PWSTR v73; // [rsp+98h] [rbp-70h]
  PULONG v74; // [rsp+A0h] [rbp-68h]
...
LABEL_27:
          LODWORD(v60) = v24 + 1;
          v31 = RtlStringCchPrintfExW(v14, v16, &v68, 0LL, 0, L"%%%u", v60);
        }
        else
        {
          LODWORD(v60) = v24 + 1;
          v31 = RtlStringCchPrintfExW(v14, v16, &v68, 0LL, 0, L"%%%u!%s!", v60, v77);
        }
LABEL_61:
        if ( v31 < 0 )
          return -2147483643;
...
LABEL_40:
      ...
      v31 = RtlStringCchPrintfExW(v14, v16, &v68, 0LL, 0, &pszDest, v41, v42, v43);
      goto LABEL_61;
    }
    switch ( v20 )
    {
