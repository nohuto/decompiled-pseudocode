/*
 * XREFs of KdpPromptString @ 0x1406F65C4
 * Callers:
...
char __fastcall KdpPromptString(char **a1, __int64 a2)
{
  ...
  KdpCopyMemoryChunks(a1[1], (__int64)&KdpMessageBuffer, *(unsigned __int16 *)a1, 0, 4, &v7);
  if ( (unsigned __int64)v7 + 16 > (unsigned int)KdTransportMaxPacketSize )
    v7 = KdTransportMaxPacketSize - 16;
  ...
  v7 = v4;
  KdpCopyMemoryChunks(v5, (__int64)&KdpMessageBuffer, v4, 0, 5, &v7);
  *(_WORD *)a2 = v7;
  return 0;
}
