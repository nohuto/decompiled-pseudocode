/*
 * XREFs of PopActionRetrieveInitialState @ 0x1401263B0
 * Callers:
...
__int64 __fastcall PopActionRetrieveInitialState(_DWORD *a1, _DWORD *a2, _DWORD *a3, _BYTE *a4)
{
  ...
  else if ( (_DWORD)qword_140303464 == 7 )
  {
    *a2 = 5;
  ...
  v11 = dword_14030346C;
  *a4 = 1;
  if ( v10 || v11 < 0 && (unsigned int)(dword_140303474 - 1) <= 1 )
    *a4 = 0;
  if ( (unsigned __int8)PopFastS4Check() )
  {
    *a1 = *a2;
    v12 = dword_14030346C & 0xEFFFFFFF;
    dword_14030346C &= ~0x10000000u;
  }
  if ( (v12 & 0x10000000) != 0 )
