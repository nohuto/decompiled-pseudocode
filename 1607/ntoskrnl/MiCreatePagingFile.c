/*
 * XREFs of MiCreatePagingFile @ 0x140568224
 * Callers:
 *     NtCreatePagingFile @ 0x1405681F0 (NtCreatePagingFile.c)
                          ...
                          if ( Pagefile )
                          {
                            ...
                            else
                            {
                              if ( (int *)a6 == MiSystemPartition )
                              {
                                ...
                                if ( !byte_140327010 && (*(_BYTE *)(v27 + 204) & 0x10) == 0 )
                                {
                                  v64 = *(_OWORD *)(v27 + 96);
                                  byte_140327010 = IoInitializeCrashDump(FileHandle);
                                }
                              }
                              return 0LL;
                            }
