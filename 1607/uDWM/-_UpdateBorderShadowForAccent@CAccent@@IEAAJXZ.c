/*
 * XREFs of ?_UpdateBorderShadowForAccent@CAccent@@IEAAJXZ @ 0x180036E3C
 * Callers:
...
__int64 __fastcall CAccent::_UpdateBorderShadowForAccent(CVisual **this)
{
  ...
  v32 = 0LL;
  if ( !v4
    || (v5 = *((double *)CDesktopManager::s_pDesktopManagerInstance + 163),
        v6 = 0,
...
LABEL_19:
  ...
  while ( v23 );
  v26 = this[47];
  v27 = *(void (__fastcall **)(CVisual *, int))(*(_QWORD *)v26 + 24LL);
  if ( v27 == CVisual::SetDirtyFlags )
    CVisual::SetDirtyFlags(v26, 4096);
  else
    v27(v26, 4096);
  return 0LL;
}
