/*
 * XREFs of ?_EnsureBrushForCVI@CTransitionWindowSnapshot@@AEAAJXZ @ 0x18000A00C
 * Callers:
...
LABEL_7:
  ...
  v11 = _xmm;
  v10 = _xmm;
  v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int128 *, __int128 *, _DWORD, _DWORD, _DWORD, int, int, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v9 + 2) + 1152LL))(
         *((_QWORD *)v9 + 2),
         *((unsigned int *)v9 + 6),
         *((_QWORD *)v9 + 2),
         &v11,
