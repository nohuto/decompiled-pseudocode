/*
 * XREFs of ?Initialize@CAnimatedGlassSheet@@MEAAJPEAUIDwmChannel@@_N@Z @ 0x1800837E0
 * Callers:
 ...
 *     ?GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z @ 0x18007E7DC (-GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z.c)
 */

__int64 __fastcall CAnimatedGlassSheet::Initialize(CAnimatedGlassSheet *this, struct IDwmChannel *a2, char a3)
{
  int v5; // eax
  int v6; // edi
  ...
  struct IDwmChannel *v37; // [rsp+40h] [rbp-C0h]
  ...
  if ( v5 >= 0 )
  {
    ...
    do
    {
      ...
      if ( WindowFramePart )
      {
        ...
        *(_DWORD *)v10 = (int)((double)*(int *)v10 * *(double *)(v12 + 1304));
        *(_DWORD *)(v10 + 4) = (int)(v13 * *(double *)(v12 + 1312));
      }
      else
      {
        *(_DWORD *)v10 = 0;
    ...
    *((_DWORD *)this + 123) = v17;
    ...
    v41[8] = -v15;
    v41[9] = -v16;
    *(double *)v18.m128i_i64 = _mm_cvtepi32_pd(v18).m128d_f64[0] * *(double *)(v19 + 1304);
    v47 = -v15;
    v55 = -v17;
    v60 = 0x7FFFFFFF;
    v61 = -v17;
    ...
    v97 = -v23;
    v86 = v103;
    v38 = (char *)&v100 - (char *)this;
    v87 = 0x7FFFFFFF;
    v39 = (char *)v101 - (char *)this;
    v91 = 0x7FFFFFFF;
    v92 = 0x7FFFFFFF;
    v96 = 0x7FFFFFFF;
    v98 = 0x7FFFFFFF;
    ...
    while ( 1 )
    {
      v25 = CAtlasedImage::Create(v37, (struct CAtlasedImage **)this + v22 + 38);
      v6 = v25;
      if ( v25 < 0 )
        break;
      CAtlasedRectsVisual::InsertAtlasImageAtIndex(this, *v21, *((_DWORD *)this + 72));
      if ( *(int *)((char *)v21 + v38 - 304) <= 0 || *(int *)((char *)v21 + v39 - 304) <= 0 )
        v26 = 0LL;
      else
