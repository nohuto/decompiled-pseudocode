/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x180021E8C
 * Callers:
  ...
  if ( (*((_BYTE *)this + 264) & 4) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( !CombineRgn(a2, a2, v8, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, &dword_1800A3CB8, 0xBu, v2, 0x108Cu);
      }
      DeleteObject(v8);
    }
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, &dword_1800A3CB8, 0xBu, v2, 0x108Au);
    }
  }
