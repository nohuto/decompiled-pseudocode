/*
 * XREFs of ?SetVisual@CDesktopThumbnailCVIVisual@@QEAAJPEAVCDesktopThumbnailCVI@@AEBUtagRECT@@@Z @ 0x180097664
 * Callers:
        ...
        const struct tagRECT *a3)
{
  ...
  if ( v7 >= 0 )
  {
    v9 = CResource::Create(0x18u, *(_QWORD *)(*(_QWORD *)&this[1].left + 16LL), &v17);
    v8 = v9;
    if ( v9 >= 0 )
    {
      ...
      if ( v10 >= 0 )
      {
        ...
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x1EDu);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x1ECu);
      }
      if ( v15 )
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x1EBu);
      v5 = (volatile signed __int32 *)v17;
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x1EAu);
  }
  if ( v18 )
