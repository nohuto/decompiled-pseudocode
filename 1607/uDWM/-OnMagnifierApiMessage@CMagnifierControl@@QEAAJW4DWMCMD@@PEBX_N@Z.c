/*
 * XREFs of ?OnMagnifierApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEBX_N@Z @ 0x18007BDE8
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierApiMessage(CVisual ***a1, int a2, __int64 a3)
{
  ...
  v3 = 0;
  if ( (dword_1800BB43C & 1) == 0 )
  {
    dword_1800BB380 = -2147023728;
    dword_1800BB43C |= 1u;
  }
  ...
  if ( !v7 )
  {
    ...
    v16 = v31;
    if ( v31 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v31, 0xC1u);
    goto LABEL_37;
  }
  v8 = v7 - 1;
  if ( !v8 )
  {
    ...
    v16 = v30;
    if ( v30 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v30, 0xC9u);
    goto LABEL_37;
  }
  v9 = v8 - 1;
  if ( !v9 )
  {
    ...
    if ( v28 >= 0 )
    {
      ...
      v16 = v29;
      if ( v29 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v29, 0xD5u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v28, 0xD3u);
    }
    goto LABEL_37;
  }
  v10 = v9 - 1;
  if ( !v10 )
  {
    ...
    if ( v25 >= 0 )
    {
      ...
      v16 = v26;
      if ( v26 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v26, 0xE3u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v25, 0xDFu);
    }
    goto LABEL_37;
  }
  v11 = v10 - 1;
  if ( !v11 )
  {
    ...
    if ( v22 >= 0 )
    {
      ...
      v16 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v23, 0xF1u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v22, 0xEDu);
    }
    goto LABEL_37;
  }
  v12 = v11 - 3;
  if ( !v12 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v19, 0x107u);
      goto LABEL_37;
    }
    goto LABEL_19;
  }
  ...
  if ( !v13 )
  {
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v18, 0x113u);
      goto LABEL_37;
    }
LABEL_19:
    ...
    v16 = v20;
    if ( v20 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v20, 0x11Cu);
    goto LABEL_37;
  }
  if ( v13 != 2 )
    goto LABEL_40;
  ...
  if ( v15 >= 0 )
  {
    ...
    v16 = v17;
    if ( v17 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v17, 0xFFu);
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, &dword_1800BB380, 1LL, v15, 0xFBu);
  }
LABEL_37:
  if ( v16 == -2147023728 )
    v16 = 0;
