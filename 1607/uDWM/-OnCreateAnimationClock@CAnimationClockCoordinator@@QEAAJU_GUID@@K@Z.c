/*
 * XREFs of ?OnCreateAnimationClock@CAnimationClockCoordinator@@QEAAJU_GUID@@K@Z @ 0x18003BDB0
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAVCBitmapSource@@$0A@@@QEAAHAEBQEAVCBitmapSource@@@Z @ 0x18009A978 (-Remove@-$DynArray@PEAVCBitmapSource@@$0A@@@QEAAHAEBQEAVCBitmapSource@@@Z.c)
...
LABEL_14:
    ...
    if ( AnimationClock >= 0 )
    {
      ...
      {
        v24 = *a2;
        AnimationClock = CAnimationClock::Initialize((union _LARGE_INTEGER *)v18, &v24, a3);
        if ( AnimationClock < 0 )
        {
          v20 = v8;
