/*
 * XREFs of ?GetWindowRestoreRect@CWindowData@@QEAAJPEAUtagRECT@@_N@Z @ 0x180080F5C
 * Callers:
 ...
 *     ?GetPhysicalPtFromLogical@CWindowList@@QEAAXPEAVCWindowData@@AEAUtagRECT@@PEAH2@Z @ 0x18007033C (-GetPhysicalPtFromLogical@CWindowList@@QEAAXPEAVCWindowData@@AEAUtagRECT@@PEAH2@Z.c)
 */
    ...
    if ( v15 )
    {
      ...
      else
      {
        *a2 = wndpl.rcNormalPosition;
        ...
        if ( !v18 || v18 != v15 )
          return v3;
        rcWork = *(RECT *)(*(_QWORD *)(*((_QWORD *)this + 51) + 32LL) + 48LL);
      }
      *a2 = rcWork;
      return v3;
    }
