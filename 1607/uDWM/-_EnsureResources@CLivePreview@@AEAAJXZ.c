/*
 * XREFs of ?_EnsureResources@CLivePreview@@AEAAJXZ @ 0x180044D08
 * Callers:
...
__int64 __fastcall CLivePreview::_EnsureResources(CLivePreview *this)
{
  ...
  v2 = CResource::Create(9u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (_QWORD *)this + 57);
  v3 = v2;
  if ( v2 < 0 )
  {
  ...
  {
    v4 = CResource::Create(9u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (_QWORD *)this + 58);
    v3 = v4;
    if ( v4 < 0 )
    {
    ...
    {
      v5 = CVisual::Create(*(struct IDwmChannel **)(*((_QWORD *)this + 2) + 16LL), (struct CVisual **)this + 61);
      v3 = v5;
      if ( v5 < 0 )
      {
      ...
      {
        v6 = CVisual::Create(*(struct IDwmChannel **)(*((_QWORD *)this + 2) + 16LL), (struct CVisual **)this + 62);
        v3 = v6;
        if ( v6 < 0 )
        {
        ...
        {
          v7 = CVisual::Create(*(struct IDwmChannel **)(*((_QWORD *)this + 2) + 16LL), (struct CVisual **)this + 63);
          v3 = v7;
          if ( v7 < 0 )
          {
          ...
          {
            v8 = CVisual::Create(*(struct IDwmChannel **)(*((_QWORD *)this + 2) + 16LL), (struct CVisual **)this + 64);
            v3 = v8;
            if ( v8 < 0 )
