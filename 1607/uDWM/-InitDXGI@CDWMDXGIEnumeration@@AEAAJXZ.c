/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x18003DEB4
 * Callers:
...
LABEL_48:
    v16 = v3;
LABEL_50:
    MilInstrumentationCheckHR(0x14u, &dword_1800A3CA8, 1u, v16, v17);
LABEL_32:
    if ( ppFactory )
  ...
  while ( (*(unsigned int (__fastcall **)(void *, _QWORD, __int64 *))(*(_QWORD *)ppFactory + 96LL))(ppFactory, v2, &v21) != -2005270526 )
  {
    ...
    if ( v6 + 1 < v6 )
    {
      ...
      v4 = -2147024362;
LABEL_56:
      MilInstrumentationCheckHR(0x14u, &dword_1800A3CA8, 1u, v9, 0x11Eu);
      goto LABEL_32;
    }
    v4 = 0;
    if ( v7 > *((_DWORD *)this + 19) )
    {
      v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 56, 8u, 1, v22);
      v9 = v8;
      if ( v8 < 0 )
  ...
  *((_QWORD *)this + 5) = v18;
  if ( v12 )
  {
    (*(void (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v12 + 8LL))(v12, v5, v11);
    v10 = v24;
    v11 = v25;
    v12 = v18;
  }
