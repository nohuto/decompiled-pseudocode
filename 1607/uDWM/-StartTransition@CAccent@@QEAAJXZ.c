/*
 * XREFs of ?StartTransition@CAccent@@QEAAJXZ @ 0x1800072BC
 * Callers:
...
__int64 __fastcall CAccent::StartTransition(CAccent *this)
{
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x3A0u);
    goto LABEL_14;
  }
  if ( (*((_DWORD *)this + 70) & 0xFFFFFFFB) == 0 || !CAccent::_IsAnimationNeeded(this) )
  {
    ...
    if ( v4 >= 0 )
      return v3;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x3B2u);
    goto LABEL_14;
  }
  v6 = *((_QWORD *)this + 42);
  if ( v6 )
  ...
  *((_QWORD *)this + 42) = v7;
  ...
  if ( started < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, started, 0x3ADu);
LABEL_14:
    v9 = *((_QWORD *)this + 42);
    if ( v9 )
    {
