/*
 * XREFs of ?CreateBlurBehindAnimationComponent@CTransitionVisualController@@QEAAJPEAVCWindowData@@HPEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x18000DF6C
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v11, 0x346u);
    return v12;
  }
...
LABEL_16:
    ...
    v16 = (*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
            ...
            144LL);
    if ( v16 )
      v9 = (volatile signed __int32 *)CAnimationComponent::CAnimationComponent(
                                        v16,
                                        *((_QWORD *)a2 + 5),
                                        v10,
                                        v30,
    ...
    if ( v9 )
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v17, 0x34Fu);
        v8 = v29;
      }
      else
      {
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v18, 0x351u);
        }
        else
        {
          v19 = *((_QWORD *)a2 + 6);
