/*
 * XREFs of ??1CWindowSnapshot@@MEAA@XZ @ 0x180038088
 * Callers:
...
void __fastcall CWindowSnapshot::~CWindowSnapshot(CWindowSnapshot *this)
{
  ...
  *((_QWORD *)this + 2) = &CWindowSnapshot::`vftable'{for `ISecondaryWindowRepresentationChangedListener'};
  ...
  if ( v8 )
  {
    ...
    v11 = *(CBaseObject **)(*((_QWORD *)this + 4) + 384LL);
    if ( v11 )
      CBaseObject::Release(v11);
    v12 = *(CBaseObject **)(*((_QWORD *)this + 4) + 352LL);
    if ( v12 )
      CBaseObject::Release(v12);
    v13 = *(CBaseObject **)(*((_QWORD *)this + 4) + 368LL);
    if ( v13 )
  ...
  if ( v15 )
  {
    CWindowData::`scalar deleting destructor'(v15);
    *((_QWORD *)this + 4) = 0LL;
  }
