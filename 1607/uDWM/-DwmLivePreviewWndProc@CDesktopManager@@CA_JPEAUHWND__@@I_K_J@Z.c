/*
 * XREFs of ?DwmLivePreviewWndProc@CDesktopManager@@CA_JPEAUHWND__@@I_K_J@Z @ 0x180076640
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( Msg == 71 )
    {
      if ( (*(_BYTE *)(lParam + 32) & 0x40) != 0 )
      {
        ...
        else
        {
          ...
          if ( v15 >= 0 )
            v15 = -2003304445;
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v15, 0x7B8u);
          v9 = 1;
        }
        goto LABEL_15;
      }
    ...
    if ( Msg != 257 )
    {
      if ( Msg == 1028 )
      {
        ...
        if ( !SetWindowPos(wParam, 0LL, 0, 0, 0, 0, uFlags) )
        {
          ...
          if ( v13 >= 0 )
            v13 = -2003304445;
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x7A2u);
          v9 = wParam == hWnd;
        }
        v10 = 0;
LABEL_15:
...
LABEL_29:
  CLivePreview::Activate(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 168), 0, 0LL, 0LL, 1, 0, 0, 0LL);
LABEL_30:
  if ( v10 )
    goto LABEL_31;
LABEL_32:
