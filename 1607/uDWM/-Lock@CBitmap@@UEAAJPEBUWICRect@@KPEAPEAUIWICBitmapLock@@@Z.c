/*
 * XREFs of ?Lock@CBitmap@@UEAAJPEBUWICRect@@KPEAPEAUIWICBitmapLock@@@Z @ 0x18009C6B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBitmap::Lock(CBitmap *this, const struct WICRect *a2, unsigned int a3, struct IWICBitmapLock **a4)
{
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x133u);
    goto LABEL_15;
  }
  if ( !a4 )
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x134u);
    goto LABEL_15;
  }
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, v13);
LABEL_15:
  if ( v14 )
