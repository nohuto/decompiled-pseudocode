/*
 * XREFs of ?ArrangeCloneDisplays@CDWMDisplaySet@@AEAAJXZ @ 0x18003EBD0
 * Callers:
...
LABEL_7:
  ...
  if ( v6 )
  {
    while ( 1 )
    {
      ...
      if ( !*(_QWORD *)(v8 + 88) )
        break;
      if ( *(_BYTE *)(v8 + 213) && *(_QWORD *)(v8 + 88) != v8 )
      {
        v12 = 399;
        goto LABEL_22;
      }
...
LABEL_22:
    v1 = -2003304291;
    MilInstrumentationCheckHR(0x14u, &dword_1800A3CA8, 1u, -2003304291, v12);
  }
  return v1;
}
