/*
 * XREFs of ?_SlideWindowHorizontally@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEBU3@PEAPEAVCAnimationComponent@@@Z @ 0x180040CB4
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v13, 0x124u);
    v15 = v30;
    goto LABEL_16;
  }
  v15 = v30;
