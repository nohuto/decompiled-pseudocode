/*
 * XREFs of ?OnModifyWindowFilterList@CMagnifier@@QEAAJPEBUMAGN_FILTERLIST@@@Z @ 0x18007B474
 * Callers:
...
__int64 __fastcall CMagnifier::OnModifyWindowFilterList(CMagnifier *this, const struct MAGN_FILTERLIST *a2)
{
  ...
  if ( (dword_1800BB438 & 1) == 0 )
  {
    dword_1800BB36C = -2147023728;
    dword_1800BB438 |= 1u;
  }
  v6 = (char *)this + 56;
  if ( *((_QWORD *)this + 7)
    || (v7 = CResource::Create(0x24u, *((_QWORD *)this + 2), (_QWORD *)this + 7), v8 = v7, v7 >= 0) )
  {
    if ( !v3 || *(_DWORD *)a2 == 1 && *((_QWORD *)this + 8) == *((_QWORD *)a2 + 1) )
    {
      v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 752LL))(
              *(_QWORD *)(*((_QWORD *)this + 4) + 16LL),
              *(unsigned int *)(*((_QWORD *)this + 4) + 24LL),
              0LL);
      v8 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_1800BB36C, 1LL, v23, 0x100u);
    }
    else
    {
      v9 = 0;
      ...
      if ( (unsigned int)i < v3 )
      {
        ...
        while ( (unsigned int)i < 0x19 )
        {
          if ( *((_QWORD *)this + 8) != *v16 )
          {
            ...
            {
              v8 = -2147023728;
              MilInstrumentationCheckHR(0x14u, &dword_1800BB36C, 1LL, -2147023728, 0x135u);
              return v8;
            }
            ...
            if ( v18 )
            {
              ...
              if ( v19 )
              {
                v20 = *(_QWORD *)(*(_QWORD *)(v19 + 280) + 16LL);
                if ( v20 )
      ...
      if ( v21 >= 0 )
      {
        v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 752LL))(
                *(_QWORD *)(*((_QWORD *)this + 4) + 16LL),
                *(unsigned int *)(*((_QWORD *)this + 4) + 24LL),
                *(unsigned int *)(*(_QWORD *)v6 + 24LL));
        v8 = v22;
        if ( v22 < 0 )
          MilInstrumentationCheckHR(0x14u, &dword_1800BB36C, 1LL, v22, 0x151u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, &dword_1800BB36C, 1LL, v21, 0x14Du);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, &dword_1800BB36C, 1LL, v7, 0xF8u);
  }
  return v8;
}
