/*
 * XREFs of ??0CMagnifierControl@@AEAA@PEAUIDwmChannel@@PEAVCResource@@PEAVCVisual@@2@Z @ 0x180047C38
 * Callers:
        ...
        struct CVisual *a5)
{
  ...
  *((_DWORD *)this + 2) = 1;
  RtlInitializeGenericTable(
    ...
    (PRTL_GENERIC_FREE_ROUTINE)CGenericTableMap<unsigned __int64,CWindowList::DESKTOP_WINDOWLIST_MAP_ENTRY>::FreeTableData,
    0LL);
  *((_QWORD *)this + 3) = a3;
  if ( a3 )
