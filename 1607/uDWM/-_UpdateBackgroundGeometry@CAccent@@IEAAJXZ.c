/*
 * XREFs of ?_UpdateBackgroundGeometry@CAccent@@IEAAJXZ @ 0x1800075F8
 * Callers:
...
__int64 __fastcall CAccent::_UpdateBackgroundGeometry(CAccent *this)
{
  ...
  *(float *)&v10[2] = (float)v5 + 0.0;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x2A6u);
  }
  else
  {
    v7 = *((_QWORD *)this + 39);
    if ( v7 )
    {
      ...
      v2 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x2ABu);
    }
  }
  return v2;
}
