/*
 * XREFs of ?SetColorizationParameters@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS@@@Z @ 0x180030820
 * Callers:
        ...
        const struct MILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS *a2)
{
  ...
  {
    v5 = *((_DWORD *)a2 + 1);
    v6 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 347) == 2;
    v7 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 1380);
    ...
    while ( v12 )
    {
      ...
      for ( i = (CWindowData *)v12[8]; i != v15; i = *(CWindowData **)i )
      {
        ...
        v17 = (CTopLevelWindow *)*((_QWORD *)i + 48);
        if ( v17 && v13 )
