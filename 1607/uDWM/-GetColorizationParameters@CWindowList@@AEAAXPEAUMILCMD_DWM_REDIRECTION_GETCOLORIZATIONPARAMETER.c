/*
 * XREFs of ?GetColorizationParameters@CWindowList@@AEAAXPEAUMILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS@@@Z @ 0x180030988
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS *a2)
{
  ...
  v3 = *(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 1364);
  v4 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 347);
  v5 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 1364);
  v8 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 1380);
