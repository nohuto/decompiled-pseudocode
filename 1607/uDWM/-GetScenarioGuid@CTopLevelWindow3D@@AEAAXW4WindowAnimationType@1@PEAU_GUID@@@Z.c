/*
 * XREFs of ?GetScenarioGuid@CTopLevelWindow3D@@AEAAXW4WindowAnimationType@1@PEAU_GUID@@@Z @ 0x180029038
 * Callers:
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            if ( v7 == 1 )
              v8 = (GUID)xmmword_1800A4D40;
            else
              v8 = GUID_NULL;
          }
          else
          {
            v8 = (GUID)xmmword_1800A4D50;
          }
        }
        else
        {
          v8 = (GUID)xmmword_1800A4DD8;
        }
      }
      else
      {
        v8 = (GUID)xmmword_1800A4D30;
      }
    }
    else
    {
      v8 = (GUID)xmmword_1800A4DC8;
    }
  }
  else
  {
    v8 = (GUID)xmmword_1800A4CC0;
  }
  *a3 = v8;
}
