/*
 * XREFs of ?ShowHide@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18002C790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ShowHide(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x718u);
  }
  else
  {
    v6 = v10;
    if ( v10 )
    {
      ...
      if ( v7 != (*((_BYTE *)v6 + 576) & 1) )
      {
        *((_BYTE *)v6 + 576) ^= (v7 ^ *((_BYTE *)v6 + 576)) & 1;
        v8 = CWindowList::ShowHide(this, v6, 1);
        v5 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x722u);
      }
    }
  }
