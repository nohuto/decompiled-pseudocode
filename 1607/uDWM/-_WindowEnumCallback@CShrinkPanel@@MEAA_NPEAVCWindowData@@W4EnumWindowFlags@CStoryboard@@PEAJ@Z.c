/*
 * XREFs of ?_WindowEnumCallback@CShrinkPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180095770
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CShrinkPanel::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) == 0 )
  {
    if ( (a3 & 4) == 0 || (*(_DWORD *)(a2 + 584) & 0xFFF) != 0x29 )
      goto LABEL_29;
    v23 = *(_OWORD *)(a2 + 48);
    *(_BYTE *)(a1 + 128) = 1;
    *(_OWORD *)(a1 + 132) = v23;
  ...
  if ( (*(_DWORD *)(a2 + 584) & 0xFFF) != 0x28 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x5F5u);
LABEL_12:
      v4 = v27;
      goto LABEL_27;
    }
  ...
  if ( *(_BYTE *)(a1 + 128) )
  {
    v14 = CShrinkPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 584));
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x5D7u);
      goto LABEL_12;
    }
    v4 = v27;
...
LABEL_27:
  ...
  v8 = v22;
  if ( v22 < 0 )
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v22, 0x5EDu);
LABEL_29:
  result = 1;
  *a4 = v8;
  return result;
