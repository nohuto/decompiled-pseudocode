/*
 * XREFs of ?OnWindowArrangementContinue@CWindowList@@AEAAJPEBUMILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION@@@Z @ 0x180081490
 * Callers:
        ...
        const struct MILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x161Du);
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0x161Cu);
  }
