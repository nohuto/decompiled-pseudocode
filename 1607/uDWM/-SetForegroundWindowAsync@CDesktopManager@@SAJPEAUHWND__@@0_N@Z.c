/*
 * XREFs of ?SetForegroundWindowAsync@CDesktopManager@@SAJPEAUHWND__@@0_N@Z @ 0x180077058
 * Callers:
...
__int64 __fastcall CDesktopManager::SetForegroundWindowAsync(HWND hWnd, WPARAM wParam)
{
  ...
  {
    if ( *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 188) )
    {
      if ( hWnd )
      {
        SetLastError(0);
        if ( !PostMessageW(hWnd, 0x404u, wParam, 1LL) )
        {
          ...
          v2 = LastError;
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, LastError, 0xA1Bu);
        }
      }
    }
  }
