/*
 * XREFs of ?CreateBrushForCVI@CSecondaryWindowRepresentation@@QEAAJW4Enum@MilStretch@@PEAVCResource@@11PEAPEAV4@@Z @ 0x180033D28
 * Callers:
        ...
        CBaseObject **a6)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x459u);
LABEL_12:
  ...
  if ( a5 )
    ...
    v14 = 0;
  v15 = (volatile signed __int32 *)v18;
  v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int128 *, __int128 *, int, _DWORD, _DWORD, int, int, int, _DWORD, int, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v18 + 2) + 1152LL))(
          *((_QWORD *)v18 + 2),
          *((unsigned int *)v18 + 6),
          v13,
          &v19,
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x48Au);
LABEL_13:
  if ( v15 )
