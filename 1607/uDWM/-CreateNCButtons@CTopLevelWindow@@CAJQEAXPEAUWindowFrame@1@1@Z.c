/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x1800497F0
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( ThemeMargins < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, ThemeMargins, 0x2ECu);
      return v3;
    }
    if ( *(_DWORD *)(v9 + 24) )
    {
...
LABEL_9:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x2EBu);
  return v3;
}
