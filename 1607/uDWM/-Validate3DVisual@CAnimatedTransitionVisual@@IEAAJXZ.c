/*
 * XREFs of ?Validate3DVisual@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008C654
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::Validate3DVisual(CAnimatedTransitionVisual *this)
{
  ...
  if ( (*((_DWORD *)this + 22) & 0x1000) != 0 )
  {
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x627u);
      return v1;
    }
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v5 >= 0 )
        *((_DWORD *)this + 22) &= ~0x2000u;
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x630u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0x62Fu);
    }
  }
  return v1;
}
