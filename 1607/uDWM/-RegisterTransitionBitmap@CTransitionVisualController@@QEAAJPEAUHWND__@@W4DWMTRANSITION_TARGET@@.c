/*
 * XREFs of ?RegisterTransitionBitmap@CTransitionVisualController@@QEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@PEBUtagRECT@@22PEAX_K@Z @ 0x180004D7C
 * Callers:
...
LABEL_34:
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v20, 0xC90u);
...
LABEL_18:
  ...
  *(_OWORD *)&v35[28] = v25;
  ...
  if ( (int)v26 + 1 < (unsigned int)v26 )
  {
    ...
    v21 = -2147024362;
LABEL_32:
    MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v28, 0xC9Eu);
    goto LABEL_18;
  }
  v21 = 0;
