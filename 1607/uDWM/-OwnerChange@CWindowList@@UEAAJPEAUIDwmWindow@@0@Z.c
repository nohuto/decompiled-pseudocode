/*
 * XREFs of ?OwnerChange@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x18002DB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::OwnerChange(CWindowList *this, struct IDwmWindow *a2, struct IDwmWindow *a3)
{
  ...
  *((_QWORD *)v10 + 5) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
  ...
  v8 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x56Eu);
  else
LABEL_4:
    v7 = v10;
  v11 = v8;
  ...
  {
LABEL_18:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xA48u);
    goto LABEL_7;
  }
  if ( v7 )
  {
