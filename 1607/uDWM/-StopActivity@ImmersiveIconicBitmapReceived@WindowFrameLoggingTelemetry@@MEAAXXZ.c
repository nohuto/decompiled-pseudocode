/*
 * XREFs of ?StopActivity@ImmersiveIconicBitmapReceived@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x180079FA0
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::ImmersiveIconicBitmapReceived *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v6 + 24) & 0x200000000000LL) == *(_QWORD *)(v6 + 24) )
    {
      ...
      TlgWrite(v18, &unk_1800A7E79, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v19 + 3) & 0x200000000000LL) == *((_QWORD *)v19 + 3) )
    {
      ...
      v32 = 4;
      v31 = &v22;
      TlgWrite(v19, &unk_1800A7F8E, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v27);
    }
  }
