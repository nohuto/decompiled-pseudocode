/*
 * XREFs of ?CreateRootVisual@CWindowList@@QEAAJXZ @ 0x180047388
 * Callers:
...
__int64 __fastcall CWindowList::CreateRootVisual(struct CVisual **this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x415u);
  }
  else
  {
    v4 = *v1;
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x418u);
    }
    else
    {
      ...
      else
      {
        ...
        v3 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x41Du);
      }
    }
  }
  return v3;
