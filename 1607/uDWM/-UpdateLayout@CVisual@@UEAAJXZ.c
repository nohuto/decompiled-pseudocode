/*
 * XREFs of ?UpdateLayout@CVisual@@UEAAJXZ @ 0x18001F850
 * Callers:
...
__int64 __fastcall CVisual::UpdateLayout(CVisual *this)
{
  ...
  bool v13; // zf
  void (__fastcall *v14)(CThumbnailVisual *, int); // rax
  int v15; // eax
  CVisual *v16; // r14
  int v17; // ecx
  void (__fastcall *v18)(CVisual *__hidden); // rax
  void (__fastcall *v19)(CThumbnailVisual *, int); // rax
  int v20; // eax
  CVisual *i; // rbx
  int v22; // ecx
...
LABEL_10:
  ...
  else
  {
    ...
    if ( v25 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v25, 0x181u);
      return v3;
    }
  }
