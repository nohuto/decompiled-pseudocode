/*
 * XREFs of ?AdjustTargetRect@CAnimatedGlassSheet@@AEAAJXZ @ 0x180083514
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( GetMonitorInfoW(v4, &mi) )
    {
      ...
      if ( mi.rcWork.left == v6 )
        *((_DWORD *)this + 110) = v6 - (int)(*((double *)CDesktopManager::s_pDesktopManagerInstance + 163) * -8.0);
      v8 = *((_DWORD *)this + 112);
      if ( mi.rcWork.right == v8 )
        *((_DWORD *)this + 112) = v8 - (int)(*((double *)v7 + 163) * 8.0);
      v9 = *((_DWORD *)this + 111);
      if ( mi.rcWork.top == v9 )
        *((_DWORD *)this + 111) = v9 - (int)(*((double *)v7 + 164) * -8.0);
      v10 = *((_DWORD *)this + 113);
      if ( mi.rcWork.bottom == v10 )
        *((_DWORD *)this + 113) = v10 - (int)(*((double *)v7 + 164) * 8.0);
