/*
 * XREFs of _CRT_INIT @ 0x18004FCFC
 * Callers:
 *     __DllMainCRTStartup @ 0x18004FF80 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800501DE (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180050240 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800503AA (_initterm_0.c)
