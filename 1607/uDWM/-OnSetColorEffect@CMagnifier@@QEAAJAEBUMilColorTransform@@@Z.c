/*
 * XREFs of ?OnSetColorEffect@CMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x18007B718
 * Callers:
...
__int64 __fastcall CMagnifier::OnSetColorEffect(CMagnifier *this, const struct MilColorTransform *a2)
{
  ...
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 736LL))(
    ...
    *(_OWORD *)((char *)this + 92) = xmmword_1800B76A0;
    *(_OWORD *)((char *)this + 108) = xmmword_1800B76B0;
    *(_OWORD *)((char *)this + 124) = xmmword_1800B76C0;
    *(_OWORD *)((char *)this + 140) = xmmword_1800B76D0;
    *(_OWORD *)((char *)this + 156) = xmmword_1800B76E0;
    v6 = dword_1800B76F0;
    goto LABEL_15;
  }
  if ( memcmp_0((char *)this + 76, a2, 0x64uLL) )
  {
    v7 = (char *)this + 48;
    if ( *((_QWORD *)this + 6)
      || (v8 = CResource::Create(6u, *((_QWORD *)this + 2), (_QWORD *)this + 6), v3 = v8, v8 >= 0) )
    {
      ...
      if ( v9 >= 0 )
      {
        v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 736LL))(
                *(_QWORD *)(*((_QWORD *)this + 4) + 16LL),
                *(unsigned int *)(*((_QWORD *)this + 4) + 24LL),
                *(unsigned int *)(*(_QWORD *)v7 + 24LL));
        v3 = v10;
