/*
 * XREFs of ?Ensure3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008BDB8
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::Ensure3DResources(CAnimatedTransitionVisual *this)
{
  ...
  v1 = 0;
  if ( *((_QWORD *)this + 34)
    || (v3 = CResource::Create(0x15u, *(_QWORD *)(*((_QWORD *)this + 3) + 16LL), (_QWORD *)this + 34), v1 = v3, v3 >= 0) )
  {
    if ( *((_QWORD *)this + 35)
      || (v4 = CResource::Create(0x15u, *(_QWORD *)(*((_QWORD *)this + 3) + 16LL), (_QWORD *)this + 35), v1 = v4, v4 >= 0) )
    {
      if ( *((_QWORD *)this + 36)
        || (v5 = CResource::Create(0x20u, *(_QWORD *)(*((_QWORD *)this + 3) + 16LL), (_QWORD *)this + 36),
            v1 = v5,
            v5 >= 0) )
      {
        if ( *((_QWORD *)this + 37)
          || (v6 = CResource::Create(0xAu, *(_QWORD *)(*((_QWORD *)this + 3) + 16LL), (_QWORD *)this + 37),
              v1 = v6,
              v6 >= 0) )
        {
          if ( !*((_QWORD *)this + 38) )
          {
            v7 = CResource::Create(0x1Du, *(_QWORD *)(*((_QWORD *)this + 3) + 16LL), (_QWORD *)this + 38);
            v1 = v7;
            if ( v7 < 0 )
