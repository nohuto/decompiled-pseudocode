/*
 * XREFs of ?CreateGeometryFromHRGN@ResourceHelper@@SAJPEAUHRGN__@@PEAPEAVCResource@@@Z @ 0x18003D0C0
 * Callers:
...
__int64 __fastcall ResourceHelper::CreateGeometryFromHRGN(HRGN hrgn, struct CResource **a2)
{
  ...
  volatile signed __int32 *v20; // [rsp+30h] [rbp-68h] BYREF
  ...
  if ( !v5 )
  {
    v15 = CResource::Create(0x1Bu, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v20);
    v11 = v15;
    if ( v15 < 0 )
    {
