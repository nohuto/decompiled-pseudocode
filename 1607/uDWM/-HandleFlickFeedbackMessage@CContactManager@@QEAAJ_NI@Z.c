/*
 * XREFs of ?HandleFlickFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x18008606C
 * Callers:
  ...
  if ( v3 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( a2 )
      {
        ...
        v5 = CContactManager::LoadFeedbackString(v14, ModuleHandleW, dword_1800A9280[v12], &v26);
        if ( !v5 )
        {
          v25 = 1772;
LABEL_12:
