/*
 * XREFs of ?SetVisualStates@CButton@@QEAAJAEBVCBitmapSourceArray@@0PEAVCBitmapSource@@M@Z @ 0x18001C1A0
 * Callers:
        ...
        float a5)
{
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x4Bu);
    return v10;
  }
  v7 = 1;
LABEL_11:
...
LABEL_19:
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x51u);
      return v10;
    }
    v7 = 1;
    goto LABEL_21;
