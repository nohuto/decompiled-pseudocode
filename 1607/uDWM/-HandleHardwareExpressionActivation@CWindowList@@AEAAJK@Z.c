/*
 * XREFs of ?HandleHardwareExpressionActivation@CWindowList@@AEAAJK@Z @ 0x1800811D8
 * Callers:
    ...
    if ( v7 >= 0 )
    {
      ...
      *((float *)v8 + 89) = GammaLUT_sRGB_to_scRGB[BYTE2(a2)] / 255.0;
      ...
      if ( v9 >= 0 )
      {
        ...
        v6 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x4C3u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x4BFu);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x4BCu);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x4B7u);
  }
