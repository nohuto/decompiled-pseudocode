/*
 * XREFs of ?StartAnimation@CThumbnailTransition@@QEAAJPEAVCThumbnailAnimatedVisual@@H@Z @ 0x1800986E4
 * Callers:
...
LABEL_15:
  ...
  if ( v7 >= 0 )
  {
    v8 = *((_QWORD *)this + 3);
    if ( v8 )
      v11 = (struct IAnimatedVisual *)(v8 + 264);
    else
      v11 = 0LL;
    started = CAnimationEngine::ScheduleStartAnimation(v5, 0x3Eu, &v11, 1u, (unsigned int *)this + 8);
    v6 = started;
    if ( started >= 0 )
      *((_BYTE *)this + 36) = 1;
    else
