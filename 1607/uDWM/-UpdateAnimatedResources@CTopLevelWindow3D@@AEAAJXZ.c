/*
 * XREFs of ?UpdateAnimatedResources@CTopLevelWindow3D@@AEAAJXZ @ 0x180029170
 * Callers:
 ...
 *     cosf_0 @ 0x18005055E (cosf_0.c)
 *     sinf_0 @ 0x1800505B2 (sinf_0.c)
...
__int64 __fastcall CTopLevelWindow3D::UpdateAnimatedResources(CTopLevelWindow3D *this)
{
  ...
  __int64 v16; // rax
  __int64 v17; // rax
  void (__fastcall *v18)(CVisual *, int); // rax
  int v19; // xmm1_4
  float v20; // xmm0_4
  float v21; // xmm8_4
  float v22; // xmm11_4
  ...
  double v92[6]; // [rsp+E8h] [rbp-20h] BYREF
  ...
  *(_DWORD *)&v71[20] = 1065353216;
  v68 = 1.0;
  HIDWORD(v65) = 1065353216;
  *(float *)&v71[8] = (float)(v53 + v75) + v58;
  *(float *)&v71[12] = (float)(v56 + v76) + v60;
  D2DMatrixMultiply(
    (struct D2DMatrix *)&v81,
    (const struct D2DMatrix *)&v81,
    (const struct D2DMatrix *)((char *)&v65 + 4));
  ...
  v92[0] = v81;
  v92[1] = *(float *)&v82;
  result = (*(__int64 (__fastcall **)(_QWORD, _QWORD, double *))(**(_QWORD **)(v62 + 16) + 1112LL))(
             *(_QWORD *)(v62 + 16),
             *(unsigned int *)(v62 + 24),
             v92);
  v64 = result;
  if ( (int)result < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, result, 0x2E0u);
    return v64;
  }
  return result;
}
