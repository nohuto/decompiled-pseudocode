/*
 * XREFs of ?CalculateRotationAngles@CDWMDisplaySet@@SAJPEBV1@0PEAH1@Z @ 0x180072C00
 * Callers:
 ...
 *     ?DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z @ 0x180072CF0 (-DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z.c)
 */
        ...
        int *a4)
{
  ...
  if ( ClonePrimaryDisplaysNoRef >= 0 )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x288u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, ClonePrimaryDisplaysNoRef, 0x282u);
  }
