/*
 * XREFs of ?LoadCentralImage@CWindowIconic@@AEAAJXZ @ 0x180038A24
 * Callers:
...
__int64 __fastcall CWindowIconic::LoadCentralImage(CWindowIconic *this)
{
  ...
  if ( v4 )
  {
    ...
    {
      v14 = (unsigned int)(int)*(double *)(*((_QWORD *)this + 8) + 48LL);
      v15 = *((_DWORD *)this + 14) - 1;
      if ( v15 < (unsigned int)v14 )
        v14 = v15;
      v13 = *(volatile signed __int32 **)(*((_QWORD *)this + 4) + 8 * v14);
    }
    v16 = (CBaseObject *)v13;
    if ( !v13 )
      goto LABEL_12;
  ...
  else
  {
    ...
    if ( !hIcon )
      goto LABEL_12;
    v7 = CBitmapSource::Create(hIcon, *((struct IDwmChannel **)CDesktopManager::s_pDesktopManagerInstance + 4), &v16);
    v1 = v7;
    if ( v7 < 0 )
    {
...
LABEL_10:
  ...
  if ( v16 )
  {
    v9 = CVisual::SetSize(*((struct tagSIZE **)this + 12), (const struct tagSIZE *)v16 + 3);
    v1 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xE5u);
    }
    else
    {
      ...
      v1 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0xE6u);
    }
    goto LABEL_10;
  }
LABEL_12:
