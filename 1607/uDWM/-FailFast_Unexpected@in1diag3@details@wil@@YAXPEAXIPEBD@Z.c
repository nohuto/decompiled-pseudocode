/*
 * XREFs of ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x1800711C8
 * Callers:
        ...
        const char *a4)
{
  ...
  wil::details::ReportFailure_Hr(this, 1879LL, "internal\\sdk\\inc\\wil\\Resource.h", 0LL, 0LL, retaddr, 3, -2147418113);
}
