/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x18009CD30
 * Callers:
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x18009CC54 (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
