/*
 * XREFs of ?ShouldBeIncludedInOwnerSWR@CWindowData@@AEBA_NXZ @ 0x18001AE28
 * Callers:
...
char __fastcall CWindowData::ShouldBeIncludedInOwnerSWR(CWindowData *this)
{
  ...
  if ( (*((_BYTE *)this + 576) & 1) != 0
    ...
    && (*((char *)this + 104) >= 0 || (*((_DWORD *)this + 146) & 0xFFF) == 0x11) )
  {
    if ( *((_QWORD *)this + 4) )
    {
      v4 = (CWindowData *)*((_QWORD *)this + 66);
      if ( v4 )
      {
        v5 = CWindowData::WillEndAnimationCloaked(v4);
        if ( CWindowData::WillEndAnimationCloaked(this) == v5
          && ContainsRect((const struct tagRECT *)(*((_QWORD *)this + 66) + 48LL), (const struct tagRECT *)this + 3) )
        {
