/*
 * XREFs of ?Initialize@CMagnifier@@AEAAJXZ @ 0x18007B1EC
 * Callers:
...
__int64 __fastcall CMagnifier::Initialize(CMagnifier *this)
{
  ...
  v1 = (char *)this + 32;
  v3 = CResource::Create(0x17u, *((_QWORD *)this + 2), (_QWORD *)this + 4);
  v4 = v3;
  if ( v3 >= 0 )
  {
    ...
    if ( v5 )
      ...
      v6 = 0LL;
    v7 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**(_QWORD **)(*(_QWORD *)v1 + 16LL) + 688LL))(
    ...
    if ( v7 >= 0 )
    {
      v8 = (char *)this + 40;
      if ( *((_QWORD *)this + 5)
        || (v9 = CResource::Create(0x14u, *((_QWORD *)this + 2), (_QWORD *)this + 5), v4 = v9, v9 >= 0) )
      {
        v10 = *(_QWORD *)v8;
        v14[0] = _xmm;
        v14[1] = _xmm;
        v14[2] = 0LL;
        v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _OWORD *))(**(_QWORD **)(v10 + 16) + 1112LL))(
                *(_QWORD *)(v10 + 16),
                *(unsigned int *)(v10 + 24),
                v14);
        v4 = v11;
        if ( v11 >= 0 )
        {
          v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)v1 + 16LL) + 728LL))(
                  *(_QWORD *)(*(_QWORD *)v1 + 16LL),
                  *(unsigned int *)(*(_QWORD *)v1 + 24LL),
