/*
 * XREFs of ?PostInitializeComObjects@CDesktopManager@@QEAAJXZ @ 0x180076EC0
 * Callers:
...
__int64 __fastcall CDesktopManager::PostInitializeComObjects(CDesktopManager *this)
{
  ...
  v2 = 0;
  SetLastError(0);
  if ( !PostThreadMessageW(*((_DWORD *)this + 374), 0x409u, 0LL, 0LL) )
  {
    ...
    v2 = LastError;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, LastError, 0x4E1u);
  }
  return v2;
}
