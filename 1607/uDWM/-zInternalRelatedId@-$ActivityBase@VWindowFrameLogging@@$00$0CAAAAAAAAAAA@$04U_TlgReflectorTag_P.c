/*
 * XREFs of ?zInternalRelatedId@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEBAPEBU_GUID@@XZ @ 0x18004F1FC
 * Callers:
 ...
 * Callees:
 *     ?_TlgGuidIsZero@@YA_NAEBU_GUID@@@Z @ 0x180079464 (-_TlgGuidIsZero@@YA_NAEBU_GUID@@@Z.c)
 */
