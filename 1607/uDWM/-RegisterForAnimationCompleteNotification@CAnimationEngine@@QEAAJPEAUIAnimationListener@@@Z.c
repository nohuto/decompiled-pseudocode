/*
 * XREFs of ?RegisterForAnimationCompleteNotification@CAnimationEngine@@QEAAJPEAUIAnimationListener@@@Z @ 0x180012F18
 * Callers:
...
LABEL_12:
      ...
      else
      {
        ...
        {
          v12 = DynArrayImpl<0>::AddMultipleAndSet(v8, 8LL, 1LL, &v14);
          v11 = v12;
          if ( v12 < 0 )
  ...
  {
    v3 = -2147221008;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147221008, 0x21Eu);
  }
