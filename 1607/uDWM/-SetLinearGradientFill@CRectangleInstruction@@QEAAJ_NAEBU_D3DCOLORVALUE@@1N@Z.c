/*
 * XREFs of ?SetLinearGradientFill@CRectangleInstruction@@QEAAJ_NAEBU_D3DCOLORVALUE@@1N@Z @ 0x18003962C
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a4)
{
  ...
  if ( *((_QWORD *)this + 2)
    || (v5 = CResource::Create(0x13u, *((_QWORD *)this + 5), (_QWORD *)this + 2), v6 = v5, v5 >= 0) )
  {
    v10[0] = 0LL;
    v12 = 0LL;
    v10[1] = 0LL;
    v7 = *v4;
    v13 = xmmword_1800A3D20;
    v14 = DOUBLE_1_0;
    v15 = xmmword_1800A3D10;
    v11 = _xmm;
    v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int128 *, _QWORD *, __int128 *, _DWORD, _DWORD, _DWORD, _DWORD, int, _DWORD, __int64 *, int))(**(_QWORD **)(v7 + 16) + 1144LL))(
           *(_QWORD *)(v7 + 16),
           *(unsigned int *)(v7 + 24),
           &v11,
           v10,
