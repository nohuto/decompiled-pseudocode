/*
 * XREFs of ?EnsureThumbnailVisual@CDCompVirtualDesktopThumbnailData@@UEAAJXZ @ 0x1800807D0
 * Callers:
...
__int64 __fastcall CDCompVirtualDesktopThumbnailData::EnsureThumbnailVisual(CDCompVirtualDesktopThumbnailData *this)
{
  ...
  v4 = 0LL;
  v20 = 0LL;
  if ( (*(_BYTE *)(v1 + 578) & 0x20) == 0 )
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x1D09u);
    return v3;
  }
  if ( *((_QWORD *)this + 13) )
    return v3;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x1D0Fu);
    goto LABEL_22;
  }
  v6 = v19;
  *((_QWORD *)v19 + 38) = this;
  *((_QWORD *)v6 + 37) = *(_QWORD *)(*((_QWORD *)this + 2) + 120LL);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x1D11u);
    goto LABEL_23;
  }
    ...
    *((_QWORD *)v10 + 3) = v6;
    ...
    if ( v13 >= 0 )
    {
      ...
      *((_BYTE *)v14 + 321) = 1;
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x1D1Du);
LABEL_22:
        v6 = v19;
        goto LABEL_23;
      }
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x1D18u);
    }
    v4 = v20;
    goto LABEL_22;
  }
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x1D14u);
LABEL_23:
  if ( v6 )
