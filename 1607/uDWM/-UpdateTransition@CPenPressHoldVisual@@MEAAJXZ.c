/*
 * XREFs of ?UpdateTransition@CPenPressHoldVisual@@MEAAJXZ @ 0x18008B320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPenPressHoldVisual::UpdateTransition(CPenPressHoldVisual *this)
{
  ...
  v2 = *((_DWORD *)this + 84);
  v3 = (int)(float)((float)*(double *)(*((_QWORD *)this + 36) + 48LL) * (float)v2);
  if ( v3 >= v2 )
    v3 = v2 - 1;
  CImage::SetBitmapSource(*((CImage **)this + 37), *(struct CBitmapSource **)(*((_QWORD *)this + 39) + 8LL * v3));
