/*
 * XREFs of ?OnEndTransitionRequest@CSlideOutCharm@@UEAAJXZ @ 0x18000F9F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  *((_QWORD *)this + 16) = v1;
  v6 = CStoryboard::OnEndTransitionRequest((struct _GUID *)this);
  CAnimationScheduler::AbandonTransition(*((CAnimationScheduler **)CDesktopManager::s_pDesktopManagerInstance + 22), 5);
  v7 = 0LL;
  v8 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 22);
  if ( *(_DWORD *)(v8 + 40) )
  {
    do
    {
