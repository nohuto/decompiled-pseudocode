/*
 * XREFs of ?NotifySWROfMarginOrSizeChange@CWindowData@@QEAAX_N0@Z @ 0x18001B598
 * Callers:
...
void __fastcall CWindowData::NotifySWROfMarginOrSizeChange(CWindowData *this, char a2, char a3)
{
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 112); i = (unsigned int)(i + 1) )
  {
    v7 = *(CSecondaryWindowRepresentation **)(*((_QWORD *)this + 53) + 8 * i);
    v8 = *((_OWORD *)v7 + 4);
