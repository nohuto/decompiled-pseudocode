/*
 * XREFs of ?Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z @ 0x18008A6B8
 * Callers:
 ...
 * Callees:
 *     ?CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z @ 0x18008A5E0 (-CreateTrackingTooltip@CTrackingTooltip@@IEAAPEAUHWND__@@PEAG@Z.c)
 *     ?UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ @ 0x18008A7BC (-UpdateTooltipLocation@CTrackingTooltip@@IEAAXXZ.c)
 */
