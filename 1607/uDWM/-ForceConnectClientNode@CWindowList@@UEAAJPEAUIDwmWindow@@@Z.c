/*
 * XREFs of ?ForceConnectClientNode@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180005F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceConnectClientNode(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x11D6u);
  }
  else
  {
    v6 = v11;
    ...
    {
      if ( *((_DWORD *)v11 + 32)
        || (v7 = (*(__int64 (__fastcall **)(struct IDwmWindow *, _QWORD))(*(_QWORD *)a2 + 288LL))(
                   a2,
            ...
            v7 >= 0) )
      {
        ...
        if ( v8 )
        {
          ...
          v5 = v9;
          if ( v9 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x11E1u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x11DCu);
      }
    }
  }
