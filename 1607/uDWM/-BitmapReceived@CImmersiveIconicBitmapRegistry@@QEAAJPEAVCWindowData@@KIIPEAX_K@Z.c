/*
 * XREFs of ?BitmapReceived@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_K@Z @ 0x180079734
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  __int64 v22[40]; // [rsp+50h] [rbp-B0h] BYREF
  ...
  v22[0] = (__int64)&WindowFrameLoggingTelemetry::ImmersiveIconicBitmapReceived::`vftable';
  ...
  wil::ActivityBase<WindowFrameLogging,1,35184372088832,5,_TlgReflectorTag_Param0IsProviderType>::Stop(v22, v17);
