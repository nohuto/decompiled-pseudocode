/*
 * XREFs of ?_EnsureBackgroundVisual@CAccent@@IEAAJPEBUACCENT_POLICY@@PEAPEAVCVisual@@PEAV3@@Z @ 0x180007570
 * Callers:
        ...
        struct CVisual *a4)
{
  ...
  {
    v9 = CVisual::Create(*(struct IDwmChannel **)(*((_QWORD *)this + 2) + 16LL), a3);
    v4 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x2BDu);
    }
    else
    {
      ...
      if ( inserted >= 0 )
        return v4;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, inserted, 0x2BEu);
    }
    if ( *a3 )
    {
