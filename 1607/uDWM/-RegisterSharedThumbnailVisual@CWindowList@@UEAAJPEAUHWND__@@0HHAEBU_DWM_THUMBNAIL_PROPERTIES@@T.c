/*
 * XREFs of ?RegisterSharedThumbnailVisual@CWindowList@@UEAAJPEAUHWND__@@0HHAEBU_DWM_THUMBNAIL_PROPERTIES@@T_LARGE_INTEGER@@II@Z @ 0x18002FF10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  __int64 (__fastcall *v31)(CDCompThumbnailData *__hidden); // rax
  int v32; // eax
  int updated; // eax
  CVisual *v34; // rcx
  int v36; // eax
...
LABEL_63:
  ...
  if ( !v44
    ...
    || ((*((_QWORD *)this + 49) = v44, !v16)
      ...
      : (IsBaseThumbnailDestinationReachable = CWindowList::IsBaseThumbnailDestinationReachable(this, v16)),
        *((_QWORD *)this + 49) = 0LL,
  ...
  *((_BYTE *)v20 + 32) = 0;
  *((_BYTE *)v20 + 34) = 1;
  SyncedWindowDataByHwnd = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, unsigned int *))(**((_QWORD **)v21 + 4) + 104LL))(
                             *((_QWORD *)v21 + 4),
                             a8,
                             a9,
                             35LL,
  ...
  if ( v23 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v23, 0xB3Cu);
    v12 = v43;
    goto LABEL_37;
  }
  v12 = v43;
  ...
  v36 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v24, 8u, 1, &v45);
  v37 = v36;
  if ( v36 < 0 )
...
LABEL_75:
  ...
  if ( v28 <= *((_DWORD *)v15 + 121) )
  {
    *(_QWORD *)(*((_QWORD *)v15 + 58) + 8LL * v27) = v45;
    *((_DWORD *)v15 + 122) = v28;
    goto LABEL_24;
  }
  v38 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v15 + 464, 8u, 1, &v45);
  v37 = v38;
  if ( v38 < 0 )
...
LABEL_24:
  if ( v16 )
  {
    ...
    {
      if ( v30 <= *((_DWORD *)v16 + 129) )
      {
        *(_QWORD *)(*((_QWORD *)v16 + 62) + 8LL * v29) = v45;
        *((_DWORD *)v16 + 130) = v30;
        goto LABEL_28;
      }
      v39 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v16 + 496, 8u, 1, &v45);
      v37 = v39;
      if ( v39 < 0 )
