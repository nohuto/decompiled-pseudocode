/*
 * XREFs of ?ProcessAsyncDwmMessage@CWindowList@@UEAAJW4DWMCMD@@PEBXI_N@Z @ 0x18002F3B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_125:
        v49 = v6;
LABEL_150:
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v49, v54);
        return v6;
      }
  ...
  if ( a2 > 1073741887 )
  {
    if ( a2 <= 1073741922 )
    {
      if ( a2 == 1073741922 )
      {
        ...
        {
          v6 = -2003303421;
          MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x169u);
          return v6;
        }
        v55[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
        ...
        if ( MagnifierControlForDesktop )
        {
          ...
          v6 = v44;
          if ( v44 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v44, 0x172u);
        }
      }
      else
      {
        ...
        if ( !v31 )
        {
          ...
          {
            v6 = -2003303421;
            MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x1BCu);
          }
          return v6;
        }
        v32 = v31 - 13;
        if ( v32 )
        {
          ...
          if ( v33 )
          {
            ...
            if ( v34 )
            {
              ...
              {
                v6 = -2003303421;
                MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x159u);
                return v6;
              }
              v55[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
              EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
              ...
              if ( v35 )
              {
                ...
                v6 = v36;
                if ( v36 < 0 )
                  MilInstrumentationCheckHR(0x14u, 0LL, 0, v36, 0x162u);
              }
            }
            else
            {
              ...
              if ( v37 )
              {
                ...
                v6 = v38;
                if ( v38 < 0 )
                  MilInstrumentationCheckHR(0x14u, 0LL, 0, v38, 0x152u);
              }
            }
          }
          else
          {
            ...
            {
              v6 = -2003303421;
              MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x139u);
              return v6;
            }
            v55[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
            EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
            ...
            if ( v39 )
            {
              ...
              v6 = v40;
              if ( v40 < 0 )
                MilInstrumentationCheckHR(0x14u, 0LL, 0, v40, 0x142u);
            }
          }
        }
        else
        {
          ...
          {
            v6 = -2003303421;
            MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x129u);
            return v6;
          }
          v55[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
          EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
          ...
          if ( v41 )
          {
            ...
            v6 = v42;
            if ( v42 < 0 )
              MilInstrumentationCheckHR(0x14u, 0LL, 0, v42, 0x132u);
          }
        }
      }
      goto LABEL_107;
    ...
    if ( !v23 )
    {
      ...
      {
        v6 = -2003303421;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x179u);
        return v6;
      }
      v55[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
      EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
      ...
      if ( v52 )
      {
        ...
        v6 = v53;
        if ( v53 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v53, 0x182u);
      }
      goto LABEL_107;
    }
    v24 = v23 - 1;
    if ( !v24 )
    {
      ...
      {
        v6 = -2003303421;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x189u);
        return v6;
      }
      v55[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
      EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
      ...
      if ( v50 )
      {
        ...
        v6 = v51;
        if ( v51 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v51, 0x192u);
      }
      goto LABEL_107;
    }
    v25 = v24 - 1;
    if ( v25 )
    {
      ...
      if ( v45 )
      {
        ...
        v6 = v46;
        if ( v46 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v46, 0x1A2u);
      }
LABEL_107:
      CGuard<CDwmCS>::~CGuard<CDwmCS>((struct _RTL_CRITICAL_SECTION **)v55);
      return v6;
