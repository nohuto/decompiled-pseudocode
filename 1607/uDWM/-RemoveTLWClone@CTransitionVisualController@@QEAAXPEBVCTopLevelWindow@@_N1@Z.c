/*
 * XREFs of ?RemoveTLWClone@CTransitionVisualController@@QEAAXPEBVCTopLevelWindow@@_N1@Z @ 0x18000EB20
 * Callers:
      ...
      do
      {
        ...
        if ( *(const struct CTopLevelWindow **)(v9 + *v8) == a2 )
        {
          ...
          if ( a4 )
          {
            ...
            DynArray<CTransitionVisualController::TlwPair,0>::RemoveAt(v8, v5);
          }
        }
        v9 -= 24LL;
        --v5;
