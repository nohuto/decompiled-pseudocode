/*
 * XREFs of ?OnMagnifierDestroy@CMagnifierControl@@AEAAJPEAUHWND__@@@Z @ 0x18007C290
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierDestroy(CMagnifierControl *this, __int64 a2)
{
  ...
  v2 = 0;
  if ( (dword_1800BB44C & 1) == 0 )
  {
    dword_1800BB370 = -2147023728;
    dword_1800BB44C |= 1u;
  }
  ...
  {
    v2 = -2147023728;
    MilInstrumentationCheckHR(0x14u, &dword_1800BB370, 1LL, -2147023728, 0x226u);
  }
  return v2;
}
