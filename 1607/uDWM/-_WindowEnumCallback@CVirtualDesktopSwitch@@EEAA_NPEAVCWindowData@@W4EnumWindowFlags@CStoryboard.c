/*
 * XREFs of ?_WindowEnumCallback@CVirtualDesktopSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180095AC0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( (unsigned int)(v9 - 75) <= 1 )
      {
        ...
        if ( v8 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( v14 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x12D6u);
              goto LABEL_21;
            }
            ...
            *(_DWORD *)(v17 + 68) = 2;
            ...
            if ( v20 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v20, 0x12DDu);
              goto LABEL_18;
            }
          ...
          MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v18, 0x12DCu);
LABEL_18:
          if ( v19 )
            CBaseObject::Release(v19);
        }
    ...
    {
      v7 = -2147019873;
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, -2147019873, 0x12BDu);
    }
  }
LABEL_21:
  *a4 = v7;
