/*
 * XREFs of ?GetSurfaceFromThumbnail@CTransitionVisualController@@QEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@PEBUtagRECT@@_NPEAPEAVCResource@@4PEAUMilPoint3F@@@Z @ 0x18000C92C
 * Callers:
  ...
  *(_QWORD *)&v29 = a4;
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)v14 >= *(_DWORD *)(a2 + 520) )
        goto LABEL_25;
  ...
  if ( (LODWORD(v10) & 0x4000000) != 0 )
    (*(void (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)v26 + 2) + 960LL))(
      *((_QWORD *)v26 + 2),
      *((unsigned int *)v26 + 6));
  ...
  if ( v21 >= 0 )
  {
    ...
    v30 = _xmm;
    v29 = _xmm;
    v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int128 *, __int128 *, _DWORD, _DWORD, _DWORD, int, int, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v25 + 2) + 1152LL))(
            *((_QWORD *)v25 + 2),
            *((unsigned int *)v25 + 6),
            *((_QWORD *)v25 + 2),
            &v30,
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v22, 0x9A9u);
      goto LABEL_26;
    }
    if ( *a7 )
...
LABEL_25:
  ...
  MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v21, 0x98Bu);
  v8 = v25;
LABEL_26:
  if ( v20 )
