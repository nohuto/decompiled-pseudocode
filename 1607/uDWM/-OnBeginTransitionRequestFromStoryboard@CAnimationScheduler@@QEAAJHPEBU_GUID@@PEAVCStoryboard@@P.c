/*
 * XREFs of ?OnBeginTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAVCStoryboard@@PEAU2@@Z @ 0x1800107F4
 * Callers:
        ...
        struct _GUID *a5)
{
  ...
  CStoryboard *v27; // [rsp+30h] [rbp-40h] BYREF
...
LABEL_41:
      v25 = v13;
LABEL_44:
      MilInstrumentationCheckHR(0x14u, &dword_1800A92F8, 1u, v25, v26);
      goto LABEL_20;
    }
    if ( a3 )
...
LABEL_14:
  ...
  if ( CStoryboard::IsEnabled((CStoryboard *)v12) )
  {
    ...
    {
      v13 = (*(__int64 (__fastcall **)(CStoryboard *))(*(_QWORD *)v27 + 64LL))(v27);
      v11 = v13;
      if ( v13 < 0 )
      {
        v26 = 249;
    ...
    CStoryboard::Abandon((struct _GUID *)v27);
    v11 = -2147467259;
  }
  else
  {
