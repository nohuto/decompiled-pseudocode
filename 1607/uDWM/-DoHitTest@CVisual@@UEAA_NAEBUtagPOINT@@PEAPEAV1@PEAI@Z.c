/*
 * XREFs of ?DoHitTest@CVisual@@UEAA_NAEBUtagPOINT@@PEAPEAV1@PEAI@Z @ 0x180020810
 * Callers:
...
bool __fastcall CVisual::DoHitTest(CVisual *this, const struct tagPOINT *a2, struct CVisual **a3, unsigned int *a4)
{
  ...
  while ( 1 )
  {
    ...
    v19 = *v7;
    v27 = v12;
    v19.x -= *(_DWORD *)(v12 + 104);
    v19.y -= *(_DWORD *)(v12 + 108);
    if ( (*(_BYTE *)(v12 + 84) & 2) != 0 )
    {
    ...
    {
LABEL_9:
      v13 = *(bool (__fastcall **)(CVisual *__hidden, const struct tagPOINT *, struct CVisual **, unsigned int *))(*(_QWORD *)v12 + 112LL);
  ...
  v8 = v23;
  if ( v23 || v7->x < 0 || v7->x >= *((_DWORD *)this + 28) || (v16 = v7->y, v16 < 0) || v16 >= *((_DWORD *)this + 29) )
  {
    v9 = v20;
  }
  else
