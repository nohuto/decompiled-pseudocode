/*
 * XREFs of ?FreeTableData@?$CGenericTableMap@PEAVCWindowData@@U?$SetElement@PEAVCWindowData@@@?$CGenericSet@PEAVCWindowData@@@@@@CAXPEAU_RTL_GENERIC_TABLE@@PEAX@Z @ 0x180041CD0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
