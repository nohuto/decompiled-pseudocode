/*
 * XREFs of ?UpdateNonClientMetrics@CWindowData@@QEAAXXZ @ 0x18001A3A0
 * Callers:
...
void __fastcall CWindowData::UpdateNonClientMetrics(CWindowData *this)
{
  ...
  if ( v1 )
  {
    if ( v1 == 1 || *((_DWORD *)this + 82) )
      v2 = (double)*((int *)this + 77) / (double)*((int *)CDesktopManager::s_pDesktopManagerInstance + 361);
    v4 = (char *)CDesktopManager::s_pDesktopManagerInstance + 264;
    v30 = 3LL;
    v3 = (char *)this + 668;
    do
    {
  ...
  else
  {
    v3 = (char *)this + 668;
    v2 = *((double *)this + 37);
    v4 = (char *)CDesktopManager::s_pDesktopManagerInstance + 768;
    v5 = 3LL;
    do
    {
      v3 += 128;
  ...
  *((_QWORD *)v3 + 14) = *((_QWORD *)v4 + 14);
  v7 = (double)*((int *)this + 172);
  *((_DWORD *)this + 171) = (int)((double)*((int *)this + 171) * v2);
  v8 = (int)(v7 * v2);
  v9 = (double)*((int *)this + 173);
  *((_DWORD *)this + 172) = v8;
  v10 = (int)(v9 * v2);
  v11 = (double)*((int *)this + 174);
  *((_DWORD *)this + 173) = v10;
  v12 = (int)(v11 * v2);
  v13 = (double)*((int *)this + 197);
  *((_DWORD *)this + 174) = v12;
  v14 = (int)(v13 * v2);
  v15 = (double)*((int *)this + 196);
  *((_DWORD *)this + 197) = v14;
  v16 = (int)(v15 * v2);
  v17 = (double)*((int *)this + 198);
  *((_DWORD *)this + 196) = v16;
  v18 = (int)(v17 * v2);
  v19 = (double)*((int *)this + 199);
  *((_DWORD *)this + 198) = v18;
  v20 = (int)(v19 * v2);
  v21 = (double)*((int *)this + 222);
  *((_DWORD *)this + 199) = v20;
  v22 = (int)(v21 * v2);
  v23 = (double)*((int *)this + 223);
  *((_DWORD *)this + 222) = v22;
  v24 = (int)(v23 * v2);
  v25 = (double)*((int *)this + 224);
  *((_DWORD *)this + 223) = v24;
  v26 = (int)(v25 * v2);
  v27 = (double)*((int *)this + 168);
  *((_DWORD *)this + 224) = v26;
  v28 = (int)(v27 * v2);
  v29 = (double)*((int *)this + 292);
  *((_DWORD *)this + 168) = v28;
  *((_DWORD *)this + 292) = (int)(v29 * v2);
}
