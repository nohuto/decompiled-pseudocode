/*
 * XREFs of ?SetIsVisible@CVisual@@QEAAJ_N@Z @ 0x180020BDC
 * Callers:
...
__int64 __fastcall CVisual::SetIsVisible(CVisual *this, char a2)
{
  ...
  {
    v5 = *((_QWORD *)this + 3);
    v6 = *((_BYTE *)this + 84) ^ (*((_BYTE *)this + 84) ^ (4 * a2)) & 4;
    *((_BYTE *)this + 84) = v6;
    v7 = (v6 & 4) == 0;
    ...
    if ( v7 )
    {
      v14 = (*(__int64 (__fastcall **)(__int64 *, __int64, __int64))(v12 + 408))(v9, v11, v10);
      v2 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x1A4u);
      if ( v2 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x5B1u);
    }
    else
    {
      v13 = (*(__int64 (__fastcall **)(__int64 *, __int64, __int64, _QWORD))(v12 + 416))(v9, v11, v10, 0LL);
      v2 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x187u);
      if ( v2 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x5ADu);
    }
  }
