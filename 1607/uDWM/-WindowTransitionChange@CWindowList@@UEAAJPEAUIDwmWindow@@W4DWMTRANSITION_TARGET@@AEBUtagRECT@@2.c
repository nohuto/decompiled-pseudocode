/*
 * XREFs of ?WindowTransitionChange@CWindowList@@UEAAJPEAUIDwmWindow@@W4DWMTRANSITION_TARGET@@AEBUtagRECT@@2222@Z @ 0x18002FE20
 * Callers:
 *     <none>
 * Callees:
        ...
        RECT *a8)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x11BDu);
  }
  else
  {
    v15 = v17;
