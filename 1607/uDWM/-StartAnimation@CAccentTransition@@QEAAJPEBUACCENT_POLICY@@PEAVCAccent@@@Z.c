/*
 * XREFs of ?StartAnimation@CAccentTransition@@QEAAJPEBUACCENT_POLICY@@PEAVCAccent@@@Z @ 0x1800961AC
 * Callers:
...
LABEL_23:
  ...
  if ( *((_DWORD *)a2 + 3) == 5 )
  {
    ...
    rc = si128;
    OffsetRect(&rc, (v17 ? 1 : -1) * (int)(*((double *)CDesktopManager::s_pDesktopManagerInstance + 163) * 81.0), 0);
