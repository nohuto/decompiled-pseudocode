/*
 * XREFs of ?OnStoryboardStatusChanged@CAnimationEngine@@UEAAJPEAUIUIAnimationStoryboard2@@W4__MIDL___MIDL_itf_UIAnimation_0000_0002_0001@@1@Z @ 0x180011660
 * Callers:
 *     <none>
 * Callees:
        ...
        enum __MIDL___MIDL_itf_UIAnimation_0000_0002_0001 a4)
{
  ...
  if ( a3 == UI_ANIMATION_STORYBOARD_FINISHED && ((a4 - 1) & 0xFFFFFFFD) == 0 )
  {
    ...
    else
    {
      ...
      {
        v4 = -2147467259;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x571u);
      }
      else
      {
        ...
        v4 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x56Du);
      }
      CGuard<CDwmCS>::~CGuard<CDwmCS>(&v11);
      if ( v4 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x5D7u);
    }
  }
