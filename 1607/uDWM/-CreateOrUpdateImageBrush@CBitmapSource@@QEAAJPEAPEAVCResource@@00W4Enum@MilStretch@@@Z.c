/*
 * XREFs of ?CreateOrUpdateImageBrush@CBitmapSource@@QEAAJPEAPEAVCResource@@00W4Enum@MilStretch@@@Z @ 0x180075B70
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( !v29 )
  {
    v12 = CResource::Create(0x10u, *(_QWORD *)(*((_QWORD *)a1 + 2) + 16LL), &v29);
    v13 = v12;
    if ( v12 < 0 )
    {
  ...
  if ( a3 )
  {
    ...
    if ( !v28 )
    {
      v15 = CResource::Create(0x19u, *(_QWORD *)(*((_QWORD *)a1 + 2) + 16LL), &v28);
      v13 = v15;
      if ( v15 < 0 )
      {
...
LABEL_43:
  ...
  if ( v7 )
    ...
    v22 = v19;
  v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _OWORD *, __int128 *, int, _DWORD, _DWORD, int, int, int, _DWORD, unsigned int, _DWORD, int, int, _DWORD))(**((_QWORD **)v29 + 2) + 1152LL))(
          *((_QWORD *)v29 + 2),
          *((unsigned int *)v29 + 6),
          a5,
          v31,
