/*
 * XREFs of ?OnRepresentationUpdated@CSecondaryWindowRepresentation@@QEAAJXZ @ 0x180034A0C
 * Callers:
...
__int64 __fastcall CSecondaryWindowRepresentation::OnRepresentationUpdated(CSecondaryWindowRepresentation *this)
{
  ...
  void (__fastcall *v17)(CThumbnailVisual *, const struct CSecondaryWindowRepresentation *); // rax
  CWindowData *v18; // rdx
  CWindowData *v19; // rsi
  CVisual *v20; // rcx
  CBaseObject *v22; // rcx
  CThumbnailVisual *v23; // rcx
  void (__fastcall *v24)(CThumbnailVisual *, const struct CSecondaryWindowRepresentation *); // rax
  CBaseObject *v25; // rcx
  int v26; // eax
  ...
  if ( (CWindowData *)v27 != *v4 || DWORD2(v27) != *((_DWORD *)this + 18) )
  {
    ...
    if ( *((_DWORD *)this + 18) == 3 && CWindowData::IsImmersiveWindow(*((CWindowData **)this + 4)) )
    {
      ...
      if ( v26 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v26, 0x1CBu);
        return v2;
      }
    }
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x1CEu);
      return v2;
    }
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x1CFu);
      return v2;
    }
  }
  v10 = 0LL;
  ...
  if ( *((_DWORD *)this + 18) != 1 )
  {
    if ( *((_DWORD *)this + 18) == 2 )
    {
      v10 = *(CWindowData **)(*((_QWORD *)v12 + 51) + 32LL);
      goto LABEL_11;
    }
    if ( *((_DWORD *)this + 18) != 3 )
      goto LABEL_11;
    ...
    {
      v10 = *(CWindowData **)(*((_QWORD *)v12 + 52) + 80LL);
      goto LABEL_11;
    }
  }
  v10 = v12;
...
LABEL_14:
        ...
        break;
      case 2:
        v13 = *(CWindowData **)(*((_QWORD *)v14 + 51) + 32LL);
        break;
      case 3:
        if ( CWindowData::IsImmersiveWindow(*v4) )
          goto LABEL_14;
        v13 = *(CWindowData **)(*((_QWORD *)v14 + 52) + 80LL);
        break;
    }
...
LABEL_16:
  *((_BYTE *)this + 472) = v5;
  ...
  {
    v23 = (CThumbnailVisual *)*((_QWORD *)this + 21);
    v24 = *(void (__fastcall **)(CThumbnailVisual *, const struct CSecondaryWindowRepresentation *))(*(_QWORD *)v23 + 16LL);
    if ( v24 == CThumbnailVisual::OnRootVisualChanged )
      CThumbnailVisual::OnRootVisualChanged(v23, this);
    else
      v24(v23, this);
  }
  v15 = *((_DWORD *)this + 6);
  if ( (v15 & 4) == 0 )
  {
    ...
    *((_DWORD *)this + 6) = v15 | 4;
    v17 = **(void (__fastcall ***)(CThumbnailVisual *, const struct CSecondaryWindowRepresentation *))v16;
  ...
  if ( *((_DWORD *)this + 18) != 1 )
  {
    if ( *((_DWORD *)this + 18) == 2 )
    {
      v18 = *(CWindowData **)(*((_QWORD *)v19 + 51) + 32LL);
      goto LABEL_23;
    }
    if ( *((_DWORD *)this + 18) != 3 )
      goto LABEL_23;
    if ( !CWindowData::IsImmersiveWindow(*v4) )
    {
      v18 = *(CWindowData **)(*((_QWORD *)v19 + 52) + 80LL);
      goto LABEL_23;
    }
  }
  v18 = v19;
