/*
 * XREFs of ?SendBoundsToSwapchainTarget@CTopLevelWindow@@QEAAJXZ @ 0x18006F1EC
 * Callers:
  ...
  if ( *((_QWORD *)this + 100) )
  {
    ...
    if ( *((_BYTE *)this + 796) )
    {
      ...
      *(_QWORD *)&v13.cyTopHeight = 0LL;
      ...
      v5 = *(_QWORD *)(*((_QWORD *)this + 93) + 48LL);
      v6 = _mm_srli_si128(*(__m128i *)(*((_QWORD *)this + 93) + 48LL), 8).m128i_u64[0];
    ...
    v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, int, int))(**(_QWORD **)(*((_QWORD *)this + 100)
                                                                                            + 16LL)
                                                                              + 776LL))(
            *(_QWORD *)(*((_QWORD *)this + 100) + 16LL),
            *(unsigned int *)(*((_QWORD *)this + 100) + 24LL),
            cxLeftWidth,
            cyTopHeight,
            v7,
            v8);
    v1 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x14B6u);
  }
  return v1;
}
