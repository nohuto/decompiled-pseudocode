/*
 * XREFs of ?_UpdateSolidFill@CAccent@@IEAAJPEAVCVisual@@KPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@M@Z @ 0x180036490
 * Callers:
  ...
  else
  {
    ...
    *((float *)&v27 + 2) = GammaLUT_sRGB_to_scRGB[BYTE2(a3)] / 255.0;
      ...
      while ( CDesktopManager::GetMonitorRectAtIndex(v17, &v26) )
      {
        if ( v26.left || v26.top || (a1[67] & 8) == 0 )
        {
          ...
          *((float *)&v27 + 3) = _mm_cvtepi32_ps(v21).m128_f32[0] + v20;
          ...
          if ( v23 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v23, 0x3E8u);
            goto LABEL_27;
          }
          v8 = v25;
          ...
          *((_OWORD *)v8 + 1) = v16;
          ...
          if ( v24 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v24, 0x3EBu);
            break;
          }
        }
        ++v17;
    ...
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x3F0u);
LABEL_27:
        v8 = v25;
      }
      else
      {
        ...
        *((_OWORD *)v8 + 1) = v27;
        ...
        v10 = v14;
        if ( v14 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x3F3u);
      }
    }
    if ( v8 )
