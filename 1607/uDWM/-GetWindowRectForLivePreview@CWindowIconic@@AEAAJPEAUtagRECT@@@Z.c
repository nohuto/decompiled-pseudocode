/*
 * XREFs of ?GetWindowRectForLivePreview@CWindowIconic@@AEAAJPEAUtagRECT@@@Z @ 0x180082B64
 * Callers:
...
__int64 __fastcall CWindowIconic::GetWindowRectForLivePreview(CWindowIconic *this, struct tagRECT *a2)
{
  ...
  v3 = 0;
  v4 = *((_QWORD *)this + 9);
  if ( (*(_BYTE *)(v4 + 578) & 1) == 0 || (MDIOwner = CWindowData::GetMDIOwner((HWND *)v4)) == 0LL )
    MDIOwner = (struct CWindowData *)*((_QWORD *)this + 9);
  v7 = *((_QWORD *)MDIOwner + 51);
  if ( v7 )
  {
  ...
  if ( *((_DWORD *)this + 4) == 2 )
  {
    ...
    {
      v9 = *(_QWORD *)(v8 + 24);
      v10 = _mm_cvtsi32_si128(HIDWORD(*(_QWORD *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 26) + 104LL)));
