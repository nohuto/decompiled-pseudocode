/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x18008FBF0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x18008F940 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
        ...
        unsigned int a4)
{
  ...
  if ( v7 < 1.0 )
  {
    ...
    if ( a4 )
    {
      ...
      do
      {
        a3[v16] = v14 * *(double *)(*((_QWORD *)this + 3) + v16 * 8)
