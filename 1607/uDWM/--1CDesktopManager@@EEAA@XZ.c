/*
 * XREFs of ??1CDesktopManager@@EEAA@XZ @ 0x180075FA4
 * Callers:
...
void __fastcall CDesktopManager::~CDesktopManager(CDesktopManager *this, __int64 a2)
{
  ...
  v2 = *((unsigned int *)this + 358);
  *(_QWORD *)this = &CDesktopManager::`vftable';
  if ( (_DWORD)v2 )
  {
    v19 = 0LL;
    DynArrayImpl<0>::DetachData((char *)this + 1408, a2, &v19);
    if ( v19 )
    {
      v4 = v19;
      do
  ...
  v9 = (CWindowList *)*((_QWORD *)this + 165);
  if ( v9 )
  {
  ...
  v10 = (CBaseObject *)*((_QWORD *)this + 168);
  if ( v10 )
  ...
  DynArrayImpl<0>::~DynArrayImpl<0>((__int64)this + 1592);
  DynArrayImpl<0>::~DynArrayImpl<0>((__int64)this + 1408);
