/*
 * XREFs of ?SendRoundTripRequest@CDesktopManager@@QEAAJPEAI@Z @ 0x18001F024
 * Callers:
...
__int64 __fastcall CDesktopManager::SendRoundTripRequest(CDesktopManager *this, unsigned int *a2)
{
  ...
  v2 = *((_DWORD *)this + 393);
  *((_DWORD *)this + 393) = v2 + 1;
  v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this + 4) + 136LL))(*((_QWORD *)this + 4), v2);
  v5 = v4;
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x4A3u);
  }
  else if ( a2 )
  {
    *a2 = v2;
