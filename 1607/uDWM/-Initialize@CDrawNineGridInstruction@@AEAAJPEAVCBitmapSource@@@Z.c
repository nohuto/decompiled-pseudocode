/*
 * XREFs of ?Initialize@CDrawNineGridInstruction@@AEAAJPEAVCBitmapSource@@@Z @ 0x18000A880
 * Callers:
 ...
 * Callees:
 *     ?GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLayout@@@Z @ 0x18000AAFC (-GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLay.c)
 *     ?HasSourceClip@CBitmapSource@@QEBA_NXZ @ 0x180019CFC (-HasSourceClip@CBitmapSource@@QEBA_NXZ.c)
...
__int64 __fastcall CDrawNineGridInstruction::Initialize(struct _MARGINS *this, struct CBitmapSource *a2)
{
  ...
  for ( i = this + 3; ; i = (struct _MARGINS *)((char *)i + 8) )
  {
    ...
    ++this[7].cyTopHeight;
    v14 = CResource::Create(16LL, *(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL));
    v6 = v14;
    if ( v14 < 0 )
      break;
    ...
    *((float *)&v20 + 1) = (float)v19;
    ...
    v21 = (float)(v11 + v18);
    v22 = (float)(v19 + v12);
    v17 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, struct _MARGINS *, __int64 *, _DWORD, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, int, _DWORD, int, int, _DWORD))(**(_QWORD **)(v15 + 16) + 1152LL))(
            *(_QWORD *)(v15 + 16),
            *(unsigned int *)(v15 + 24),
            *(_QWORD *)(v15 + 16),
            &v23,
