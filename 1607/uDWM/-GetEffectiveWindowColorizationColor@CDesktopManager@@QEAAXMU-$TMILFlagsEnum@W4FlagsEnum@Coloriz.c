/*
 * XREFs of ?GetEffectiveWindowColorizationColor@CDesktopManager@@QEAAXMU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@PEAK@Z @ 0x18001EF10
 * Callers:
...
__int64 __fastcall CDesktopManager::GetEffectiveWindowColorizationColor(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  {
    if ( (a3 & 1) != 0 )
      result = *(unsigned int *)(a1 + 1396);
    else
      result = *(unsigned int *)(a1 + 1400);
    *a4 = result;
  }
  else
  {
