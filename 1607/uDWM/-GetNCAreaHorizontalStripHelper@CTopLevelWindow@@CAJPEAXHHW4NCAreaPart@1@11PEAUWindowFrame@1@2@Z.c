/*
 * XREFs of ?GetNCAreaHorizontalStripHelper@CTopLevelWindow@@CAJPEAXHHW4NCAreaPart@1@11PEAUWindowFrame@1@2@Z @ 0x1800494DC
 * Callers:
        ...
        __int64 a8)
{
  ...
  v29 = a2;
  v30 = a1;
  if ( (dword_1800B7F58 & 1) == 0 )
  {
    dword_1800B7F08 = -2147023728;
    dword_1800B7F58 |= 1u;
  }
  v12 = 0;
  while ( 1 )
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          v24 = CBitmapSource::Create(
                  ...
                  &v31,
                  0LL,
                  (struct CBitmapSource **)(v19 + 8 * (v12 + 2 * v23 + 187)));
          v14 = v24;
          if ( v24 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &dword_1800B7F08, 1u, v24, 0x44Cu);
            return v14;
          }
          ++v22;
          ++v21;
  ...
  MilInstrumentationCheckHR(0x14u, &dword_1800B7F08, 1u, ThemeRect, 0x420u);
  return v14;
}
