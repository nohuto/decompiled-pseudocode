/*
 * XREFs of ?LivePreviewExcludeChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18002ED60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::LivePreviewExcludeChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x107Fu);
  }
  else
  {
    v6 = v9;
