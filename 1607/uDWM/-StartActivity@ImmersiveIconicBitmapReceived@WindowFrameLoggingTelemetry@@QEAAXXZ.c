/*
 * XREFs of ?StartActivity@ImmersiveIconicBitmapReceived@WindowFrameLoggingTelemetry@@QEAAXXZ @ 0x180079ECC
 * Callers:
        ...
        WindowFrameLoggingTelemetry::ImmersiveIconicBitmapReceived *this)
{
    ...
    && (*((_QWORD *)v3 + 3) & 0x200000000000LL) == *((_QWORD *)v3 + 3) )
  {
    ...
    TlgWrite(v3, &unk_1800A7E34, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v4, 3u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
