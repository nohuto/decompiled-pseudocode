/*
 * XREFs of ?GetOwnedInclusiveClipRect@CTransitionVisualController@@QEAAXPEAVCWindowData@@PEAUtagRECT@@@Z @ 0x180004468
 * Callers:
        ...
        struct tagRECT *a3)
{
  ...
  *a3 = a2[3];
  ...
  {
    v5 = &v6;
    CTransitionVisualController::ForEachOwnedWindow<_lambda_22fca495aa2a21adbf46ac02ecb94f06_>(
      (__int64)a2,
      (__int64)&v5,
      1);
  }
