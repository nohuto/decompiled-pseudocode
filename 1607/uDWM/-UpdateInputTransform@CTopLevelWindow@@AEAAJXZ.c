/*
 * XREFs of ?UpdateInputTransform@CTopLevelWindow@@AEAAJXZ @ 0x1800215A4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateInputTransform(CTopLevelWindow *this)
{
  ...
  if ( *(_QWORD *)(v1 + 40) )
  {
    ...
    if ( (*((_BYTE *)this + 264) & 1) == 0 || !v4 )
    {
      ...
      if ( (dword_1800BB450 & 1) == 0 )
      {
        dword_1800BB398 = -2147024891;
        dword_1800BB450 |= 1u;
        dword_1800BB39C = -2147023496;
        dword_1800BB3A0 = -2147024809;
      }
      SetLastError(0);
      ...
      else
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, &dword_1800BB398, 3u, v2, 0x121Eu);
      }
