/*
 * XREFs of ?PostActivateLivePreview@CDesktopManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_ACTIVATELIVEPREVIEW@@@Z @ 0x18001E080
 * Callers:
...
LABEL_15:
  ...
  *(_OWORD *)(v6 + 36) = *((_OWORD *)a2 + 2);
  SetLastError(0);
  if ( !PostThreadMessageW(*((_DWORD *)this + 374), 0x405u, v5, 0LL) )
  {
