/*
 * XREFs of ?UpdateOpacityAndLocation@CTouchPressHoldVisual@@IEAAJXZ @ 0x180098FEC
 * Callers:
...
__int64 __fastcall CTouchPressHoldVisual::UpdateOpacityAndLocation(CTouchPressHoldVisual *this)
{
  ...
  *(float *)&v42 = v5;
  v6 = MulDiv(-5, v4, 100);
  v7 = *((_DWORD *)this + 76);
  v8 = *((_DWORD *)this + 72) - *((_DWORD *)this + 77) - v3 / 2 + v6;
  ...
  *((float *)&v42 + 3) = (float)v7 + (float)v8;
  if ( v3 <= 4 || v7 <= 4 )
  {
    ...
    if ( v38 >= 0 )
    {
      ...
      v39 = CVisual::AddInstruction(this, v17);
      v16 = v39;
      if ( v39 < 0 )
...
LABEL_47:
    ...
    CRectangleInstruction::SetRect((__int64)v17, &v42);
    v19 = CVisual::AddInstruction(this, v17);
    v16 = v19;
    if ( v19 < 0 )
    {
    ...
    *((float *)&v42 + 3) = v9 + 2.0;
    ...
    CRectangleInstruction::SetRect((__int64)v17, &v42);
    v24 = CVisual::AddInstruction(this, v17);
    v16 = v24;
    if ( v24 < 0 )
    {
    ...
    *((float *)&v42 + 2) = *(float *)&v42 + 2.0;
    ...
    CRectangleInstruction::SetRect((__int64)v17, &v42);
    v28 = CVisual::AddInstruction(this, v17);
    v16 = v28;
    if ( v28 < 0 )
    {
    ...
    *((float *)&v42 + 2) = (float)(v20 + v11) - 4.0;
    ...
    CRectangleInstruction::SetRect((__int64)v17, &v42);
    v32 = CVisual::AddInstruction(this, v17);
    v16 = v32;
    if ( v32 < 0 )
    {
    ...
    *((float *)&v42 + 3) = (float)(*((float *)&v42 + 1) + v10) - 4.0;
    ...
    {
      CRectangleInstruction::SetRect((__int64)v17, &v42);
      v36 = CVisual::AddInstruction(this, v17);
      v16 = v36;
      if ( v36 < 0 )
