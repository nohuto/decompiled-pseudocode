/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x1800768A0
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( !a1 )
  {
    ...
    v15 = (HWND)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 190);
    if ( v15 )
    {
      if ( IsWindow(v15) )
        CDesktopManager::SetForegroundWindowAsync(*a4, *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 190), v16);
      *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 190) = 0LL;
    }
...
LABEL_18:
  ...
  {
    v19 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 1272);
    v8 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 160);
    v9 = v19;
  }
  ...
  if ( WindowInBand )
  {
    *a4 = WindowInBand;
    ...
    if ( a2 )
      return v4;
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 190) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800A90D0, 2LL, v13, 0x949u);
    }
    goto LABEL_18;
  }
  v4 = -2147024890;
  MilInstrumentationCheckHR(0x14u, &dword_1800A90D0, 2LL, -2147024890, 0x938u);
LABEL_19:
  if ( a1 )
