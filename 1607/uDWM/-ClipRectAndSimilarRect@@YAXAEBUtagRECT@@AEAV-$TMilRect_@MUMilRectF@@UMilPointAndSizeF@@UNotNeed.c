/*
 * XREFs of ?ClipRectAndSimilarRect@@YAXAEBUtagRECT@@AEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@1@Z @ 0x180008B98
 * Callers:
...
_UNKNOWN **__fastcall ClipRectAndSimilarRect(int *a1, float *a2, float *a3)
{
  ...
  if ( v4 > 0.0 && (float)(a2[3] - a2[1]) > 0.0 )
  {
    ...
    *((_QWORD *)&v10 + 1) = __PAIR64__(
    ...
    v8 = (float)((float)((float)(*(float *)&v10 - *a2) * (float)(v5 - *a3)) / v4) + *a3;
    *a3 = v8;
    v9 = (float)((float)((float)(*((float *)&v10 + 1) - a2[1]) * v7) / (float)(a2[3] - a2[1])) + a3[1];
    a3[1] = v9;
    a3[2] = (float)((float)((float)(v5 - v8) * (float)(*((float *)&v10 + 2) - *(float *)&v10)) / (float)(a2[2] - *a2))
          + v8;
    a3[3] = (float)((float)((float)(v6 - v9) * (float)(*((float *)&v10 + 3) - *((float *)&v10 + 1)))
                  / (float)(a2[3] - a2[1]))
          + v9;
    *(_OWORD *)a2 = v10;
  }
