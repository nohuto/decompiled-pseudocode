/*
 * XREFs of ?_initimpl@CImmersiveOrPrimaryMonitor@@CAJPEAUHMONITOR__@@QEAUSCALINGINFO@@@Z @ 0x1800424A0
 * Callers:
 ...
 *     ?ResultFromKnownLastError@@YAJXZ @ 0x18009A6C4 (-ResultFromKnownLastError@@YAJXZ.c)
