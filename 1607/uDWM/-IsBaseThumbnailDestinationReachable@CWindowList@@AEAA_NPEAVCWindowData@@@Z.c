/*
 * XREFs of ?IsBaseThumbnailDestinationReachable@CWindowList@@AEAA_NPEAVCWindowData@@@Z @ 0x1800314EC
 * Callers:
...
char __fastcall CWindowList::IsBaseThumbnailDestinationReachable(struct CWindowData **this, struct CWindowData *a2)
{
  ...
  if ( a2 == this[49] )
    return 1;
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)a2 + 122); i = (unsigned int)(i + 1) )
  {
    if ( IsBaseThumbnailDestinationReachable )
      break;
    v7 = *(_QWORD *)(*((_QWORD *)a2 + 58) + 8 * i);
