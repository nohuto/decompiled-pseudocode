/*
 * XREFs of ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NPEBUtagRECT@@0@Z @ 0x18007E0CC
 * Callers:
 ...
 * Callees:
 *     ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z @ 0x18007E094 (-s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z.c)
 */
