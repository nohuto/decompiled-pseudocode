/*
 * XREFs of ?Create@CDesktopManager@@SAJPEBUStartupInfo@@PEAUCompositionInfo@@PEAPEAV1@@Z @ 0x180044ABC
 * Callers:
        ...
        struct CDesktopManager **a3)
{
  ...
  if ( v6 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800A3CAC, 1u, v7, 0x491u);
    }
    else
    {
      g_pdmInstance = v6;
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_1800A3CAC, 1u, -2147024882, 0x48Du);
  }
