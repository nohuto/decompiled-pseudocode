/*
 * XREFs of ?Start@CPressTapVisual@@QEAAJPEBUtagPOINT@@PEBUtagRECT@@0@Z @ 0x18008B604
 * Callers:
        ...
        const struct tagPOINT *a4)
{
  ...
  *((_QWORD *)this + 38) = *((_QWORD *)this + 36);
  ...
  v34 = (_QWORD *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                    WPF::g_pProcessHeap,
                    80LL);
  if ( v34 )
    v34 = CTimeline<float>::CTimeline<float>((__int64)v34, *((float *)this + 86), 0.0, 1.0, 0);
  *((_QWORD *)this + 48) = v34;
  if ( !v34 )
  {
    v35 = -2147024882;
...
LABEL_25:
  ...
  if ( v36 >= 0 )
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v36, 0x94u);
  if ( v35 < 0 )
    goto LABEL_25;
  return (unsigned int)v35;
}
