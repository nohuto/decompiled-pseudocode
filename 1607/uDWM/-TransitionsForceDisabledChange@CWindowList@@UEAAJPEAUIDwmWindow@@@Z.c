/*
 * XREFs of ?TransitionsForceDisabledChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800823B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::TransitionsForceDisabledChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( SyncedWindowData >= 0 )
  {
    ...
    if ( v9 )
    {
      ...
      *((_BYTE *)v6 + 576) &= ~0x10u;
      *((_BYTE *)v6 + 576) |= 16 * (v7 & 1);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x11A4u);
  }
