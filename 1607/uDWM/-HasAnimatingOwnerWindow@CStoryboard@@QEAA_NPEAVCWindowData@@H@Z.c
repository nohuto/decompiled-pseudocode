/*
 * XREFs of ?HasAnimatingOwnerWindow@CStoryboard@@QEAA_NPEAVCWindowData@@H@Z @ 0x1800929A0
 * Callers:
...
char __fastcall CStoryboard::HasAnimatingOwnerWindow(CStoryboard *this, struct CWindowData *a2)
{
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v5 )
      {
        if ( CAnimationScheduler::IsWindowCurrentlyAnimating(*((CAnimationScheduler **)v4 + 22), v5, 83, 0x10000000) )
          break;
      }
      v3 = (struct CWindowData *)*((_QWORD *)v3 + 66);
      if ( !v3 )
        return v2;
    }
    return 1;
