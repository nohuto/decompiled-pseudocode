/*
 * XREFs of ?Create@CDWMDXGIAdapter@@SAJPEAUIDXGIAdapter@@IPEAPEAV1@@Z @ 0x18003E2E4
 * Callers:
 ...
 *     ?AddRef@CMILRefCountBase@@UEAAKXZ @ 0x18003E420 (-AddRef@CMILRefCountBase@@UEAAKXZ.c)
