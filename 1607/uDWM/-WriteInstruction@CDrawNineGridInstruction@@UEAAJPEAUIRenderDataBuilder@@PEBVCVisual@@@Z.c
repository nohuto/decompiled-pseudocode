/*
 * XREFs of ?WriteInstruction@CDrawNineGridInstruction@@UEAAJPEAUIRenderDataBuilder@@PEBVCVisual@@@Z @ 0x18000A6D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CVisual *a3)
{
  ...
  {
    v13 = v10 * (int)v29 / ((int)v29 + DWORD1(v29));
    v12 = v13;
  }
  else
  {
  ...
  while ( 1 )
  {
    ...
    if ( *v16 )
    {
      ...
      *((float *)&v29 + 1) = (float)v21;
      v26 = (float)v25;
      v27 = *(__int64 (__fastcall **)(struct IRenderDataBuilder *, __int128 *, _QWORD))(*(_QWORD *)a2 + 64LL);
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v28, 0x11Fu);
  return v4;
}
