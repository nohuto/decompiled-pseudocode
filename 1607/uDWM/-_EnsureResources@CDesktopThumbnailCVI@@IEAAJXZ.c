/*
 * XREFs of ?_EnsureResources@CDesktopThumbnailCVI@@IEAAJXZ @ 0x180097E30
 * Callers:
...
__int64 __fastcall CDesktopThumbnailCVI::_EnsureResources(CDesktopThumbnailCVI *this)
{
  ...
  if ( *((_QWORD *)this + 4) )
    return v1;
  v4 = CResource::Create(5u, *((_QWORD *)this + 2), (_QWORD *)this + 4);
  v1 = v4;
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0x22Cu);
    goto LABEL_15;
  }
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x22Fu);
    goto LABEL_15;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x232u);
    goto LABEL_15;
  }
  v7 = v21[0];
  v8 = v21[1];
  ...
  *((_QWORD *)this + 7) = v10;
  ...
  v18 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *, _QWORD *, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v14 + 2) + 952LL))(
          *((_QWORD *)v14 + 2),
          *((unsigned int *)v14 + 6),
          v22,
          v23,
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v18, 0x253u);
LABEL_15:
    if ( *v2 )
    {
