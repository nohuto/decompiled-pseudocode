/*
 * XREFs of ??_GContentItemImpl@TargetedContent@ContentManagement@@UEAAPEAXI@Z @ 0x180050610
 * Callers:
 *     <none>
 * Callees:
...
ContentManagement::TargetedContent::ContentItemImpl *__fastcall ContentManagement::TargetedContent::ContentItemImpl::`scalar deleting destructor'(
