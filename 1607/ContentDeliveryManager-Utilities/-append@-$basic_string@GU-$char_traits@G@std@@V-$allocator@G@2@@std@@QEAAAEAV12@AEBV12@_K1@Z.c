/*
 * XREFs of ?append@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAAEAV12@AEBV12@_K1@Z @ 0x180029644
 * Callers:
...
_WORD **__fastcall std::wstring::append(_WORD **a1, _QWORD *a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  {
    v11 = &v10[v5];
    if ( (unsigned __int64)&v10[v5] > 0x7FFFFFFFFFFFFFFELL )
      std::wstring::_Xlen();
    if ( a1[3] >= (_WORD *)v11 )
    {
      if ( v11 )
...
LABEL_15:
    ...
    {
      std::wstring::_Copy((const void **)a1, (unsigned __int64)&v10[v5], v10);
    }
    if ( !v11 )
      return a1;
    goto LABEL_15;
