/*
 * XREFs of ?message@_System_error_category@std@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z @ 0x180006810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Winerror_map@std@@YAPEBDH@Z @ 0x180053B98 (-_Winerror_map@std@@YAPEBDH@Z.c)
 */
