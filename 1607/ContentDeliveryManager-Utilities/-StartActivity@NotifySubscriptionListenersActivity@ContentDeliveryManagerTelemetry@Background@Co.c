/*
 * XREFs of ?StartActivity@NotifySubscriptionListenersActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG@Z @ 0x18003D7C8
 * Callers:
...
void __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::NotifySubscriptionListenersActivity::StartActivity(
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*((_QWORD *)v5 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v4 == *((_QWORD *)v5 + 3) )
    {
      ...
      TlgWrite(v5, &unk_18007DC69, (LPCGUID)(v8 + 8), v9, 4u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
