/*
 * XREFs of ??1?$BaseScenarioEvents@$0L@@details@Health@CreativeFramework@@QEAA@XZ @ 0x18002C7E0
 * Callers:
 *     ??__Fs_traits@?1???$HandleEvent@$09I_K@?$OffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@SAXI_K@Z@YAXXZ @ 0x18005D060 (--__Fs_traits@-1---$HandleEvent@$09I_K@-$OffersHealthTracker@$0L@$00@details@Health@CreativeFram.c)
 *     ??__Fs_traits@?1???$HandleEvent@$00$$V@?$OffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D180 (--__Fs_traits@-1---$HandleEvent@$00$$V@-$OffersHealthTracker@$0L@$00@details@Health@CreativeFram.c)
 *     ??__Fs_traits@?1???$HandleEvent@$08$$V@?$OffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D2A0 (--__Fs_traits@-1---$HandleEvent@$08$$V@-$OffersHealthTracker@$0L@$00@details@Health@CreativeFram.c)
 * Callees:
...
void __fastcall CreativeFramework::Health::details::BaseScenarioEvents<11>::~BaseScenarioEvents<11>(__int64 a1)
{
  const WCHAR *v2; // rdx
  unsigned int v3; // eax
  __int64 v4; // r8
  ...
  *(_QWORD *)a1 = &CreativeFramework::Health::details::BaseScenarioEvents<11>::`vftable';
