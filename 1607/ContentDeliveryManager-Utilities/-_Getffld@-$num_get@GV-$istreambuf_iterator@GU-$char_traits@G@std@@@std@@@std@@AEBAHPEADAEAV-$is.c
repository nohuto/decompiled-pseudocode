/*
 * XREFs of ?_Getffld@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x180027B2C
 * Callers:
...
LABEL_15:
  ...
  if ( (unsigned __int8)(*(_BYTE *)v24 - 1) <= 0x7Du )
  {
    ...
    LOWORD(v69[0]) = 0;
    v69[2] = 1LL;
    v26 = std::istreambuf_iterator<unsigned short>::equal(a3, v6);
    v27 = (_QWORD *)v69[0];
    if ( v26 )
      goto LABEL_50;
    while ( 1 )
...
LABEL_80:
      ...
      else
      {
        ...
        if ( v22 < 36 )
        {
          if ( v31 || v22 )
          {
            *v13++ = `std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getffld'::`2'::_Src[v31];
            ++v22;
          }
        }
        else
...
LABEL_44:
      ...
      if ( (unsigned __int8)std::istreambuf_iterator<unsigned short>::equal(a3, v63) )
        goto LABEL_45;
    }
  }
  if ( !(unsigned __int8)std::istreambuf_iterator<unsigned short>::equal(a3, v6) )
  {
    do
    {
      ...
      if ( v22 < 36 )
      {
        if ( v43 || v22 )
        {
          *v13++ = `std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getffld'::`2'::_Src[v43];
          ++v22;
        }
      }
      else
...
LABEL_83:
  ...
  if ( !(unsigned __int8)std::istreambuf_iterator<unsigned short>::equal(a3, v6) )
  {
    do
    {
      ...
      if ( v22 < 36 )
      {
        *v13++ = `std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getffld'::`2'::_Src[v49];
        ++v22;
      }
      v21 = 1;
      std::istreambuf_iterator<unsigned short>::_Inc(a3);
...
LABEL_114:
        ...
        if ( !(unsigned __int8)std::istreambuf_iterator<unsigned short>::equal(a3, v6) )
        {
          do
          {
            ...
            if ( (int)v17 < 8 )
            {
              *v13++ = `std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getffld'::`2'::_Src[v59];
              LODWORD(v17) = v17 + 1;
            }
            v21 = 1;
            std::istreambuf_iterator<unsigned short>::_Inc(a3);
