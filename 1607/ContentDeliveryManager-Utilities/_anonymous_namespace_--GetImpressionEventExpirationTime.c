/*
 * XREFs of _anonymous_namespace_::GetImpressionEventExpirationTime @ 0x18001EED0
 * Callers:
...
__int64 __fastcall anonymous_namespace_::GetImpressionEventExpirationTime(LPCWCH lpString1, _WORD *a2, __int64 a3)
{
  __int64 v5; // r8
  __int64 v6; // rcx
  __int64 v7; // rdx
