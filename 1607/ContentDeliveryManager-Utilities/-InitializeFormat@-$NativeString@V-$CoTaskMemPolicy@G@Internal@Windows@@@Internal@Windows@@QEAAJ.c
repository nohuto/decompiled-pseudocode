/*
 * XREFs of ?InitializeFormat@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@QEAAJPEBGZZ @ 0x180024744
 * Callers:
        ...
        ...)
{
  ...
  int Value[14]; // [rsp+20h] [rbp-38h] BYREF
  ...
  while ( 1 )
  {
    v5 = Windows::Internal::NativeString<Windows::Internal::CoTaskMemPolicy<unsigned short>>::_EnsureCapacity(a1, v3);
    if ( v5 < 0 )
      break;
    v6 = *(_QWORD *)(a1 + 16);
    v7 = *(wchar_t **)a1;
