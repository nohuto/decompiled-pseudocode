        ...
        _BYTE *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v9 )
  {
    ...
    do
    {
      XWinRT::InterfaceLifetimeTraits::Destroy<ContentManagement::TargetedContent::ITargetedContentValue>(v19, v10, v12);
      v19 += 16;
      --v20;
    }
    while ( v20 );
