/*
 * XREFs of ??0?$OffersHealthTracker@$02$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D77C
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<3,1>::OffersHealthTracker<3,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<3>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,3>::`vftable';
  return a1;
}
