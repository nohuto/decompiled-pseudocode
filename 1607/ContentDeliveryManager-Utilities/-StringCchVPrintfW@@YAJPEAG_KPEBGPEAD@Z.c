/*
 * XREFs of ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x1800015C0
 * Callers:
...
__int64 __fastcall StringCchVPrintfW(wchar_t *Buffer, __int64 a2, const unsigned __int16 *a3, va_list a4)
{
  int v5; // esi
