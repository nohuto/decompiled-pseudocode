/*
 * XREFs of ??0?$OffersHealthTracker@$0BA@$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D014
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<16,1>::OffersHealthTracker<16,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<16>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,16>::`vftable';
  return a1;
}
