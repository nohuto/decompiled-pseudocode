/*
 * XREFs of ?QueryInterface@?$RuntimeClass@U?$InterfaceList@UIAsyncActionCompletedHandler@Foundation@Windows@@U?$InterfaceList@VFtmBase@WRL@Microsoft@@VNil@Details@23@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800110A0
 * Callers:
 *     ?QueryInterface@?$RuntimeClass@U?$InterfaceList@UIAsyncActionCompletedHandler@Foundation@Windows@@U?$InterfaceList@VFtmBase@WRL@Microsoft@@VNil@Details@23@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800183F0 (-QueryInterface@-$RuntimeClass@U-$InterfaceList@UIAsyncActionCompletedHandler@Found_ea_1800183F0.c)
 * Callees:
