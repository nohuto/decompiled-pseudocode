/*
 * XREFs of ??$HandleEvent@$09I_K@?$OffersHealthTracker@$01$00@details@Health@CreativeFramework@@SAXI_K@Z @ 0x18002AE74
 * Callers:
...
DWORD __fastcall CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>(
        int a1,
        __int64 a2)
{
  DWORD result; // eax
  ...
  if ( !byte_18008D843 )
    result = CreativeFramework::Health::details::BaseScenarioEvents<2>::ReadPlacementReportedInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>'::`2'::s_traits);
  if ( v5 != qword_18008D7E0 )
  {
    qword_18008D7E0 = v5;
    byte_18008D842 = 1;
    result = CreativeFramework::Health::details::BaseScenarioEvents<14>::WritePlacementReportedInfo(&`CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>'::`2'::s_traits);
  }
  if ( !byte_18008D843 )
    result = CreativeFramework::Health::details::BaseScenarioEvents<2>::ReadPlacementReportedInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>'::`2'::s_traits);
  if ( v5 != qword_18008D7E8 )
  {
    qword_18008D7E8 = v5;
    byte_18008D842 = 1;
    result = CreativeFramework::Health::details::BaseScenarioEvents<14>::WritePlacementReportedInfo(&`CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>'::`2'::s_traits);
  ...
  if ( !byte_18008D843 )
    result = CreativeFramework::Health::details::BaseScenarioEvents<2>::ReadPlacementReportedInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>'::`2'::s_traits);
  if ( a2 != qword_18008D7F0 )
  {
    qword_18008D7F0 = a2;
    byte_18008D842 = 1;
    return CreativeFramework::Health::details::BaseScenarioEvents<14>::WritePlacementReportedInfo(&`CreativeFramework::Health::details::OffersHealthTracker<2,1>::HandleEvent<10,unsigned int,unsigned __int64>'::`2'::s_traits);
  }
  return result;
}
