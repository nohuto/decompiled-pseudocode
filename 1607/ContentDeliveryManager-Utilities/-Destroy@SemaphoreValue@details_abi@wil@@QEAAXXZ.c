/*
 * XREFs of ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x180002EA0
 * Callers:
 ...
 *     ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x18000D4B4 (-Release@-$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ.c)
 * Callees:
...
void __fastcall wil::details_abi::SemaphoreValue::Destroy(wil::details_abi::SemaphoreValue *this)
{
  ...
  if ( *(_QWORD *)this )
  {
    ...
    if ( !CloseHandle(v1) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x623, v4, v5);
      __debugbreak();
    }
