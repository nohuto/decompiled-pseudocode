/*
 * XREFs of ?GetWeakReference@?$RuntimeClass@U?$InterfaceList@VFtmBase@WRL@Microsoft@@U?$InterfaceList@UITargetedContentCollection@TargetedContent@ContentManagement@@U?$InterfaceList@UITargetedContentInteractionReporter@TargetedContent@ContentManagement@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@23@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$02@34@$00$00$0A@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x180041FC0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(v9 + 16) = v5;
    ...
    v14 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 32), v12, v5);
    for ( i = v5 == v14; ; i = v14 == v15 )
    {
      ...
      if ( v14 < 0 )
        break;
      *(_DWORD *)(v9 + 16) = v14;
      v14 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 32), v12, v14);
    }
