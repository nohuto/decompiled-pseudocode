/*
 * XREFs of ?GetStringFromSetting@ContentManagement@@YAJPEAUIPropertySet@Collections@Foundation@Windows@@PEBGPEAPEAUHSTRING__@@@Z @ 0x180021660
 * Callers:
        ...
        HSTRING *a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( v13 >= 0 )
    {
      v13 = (*(__int64 (__fastcall **)(__int64, const unsigned __int16 *))(*(_QWORD *)v19 + 152LL))(v19, a3);
      v9 = v13;
      if ( v13 >= 0 )
      {
        v9 = 0;
