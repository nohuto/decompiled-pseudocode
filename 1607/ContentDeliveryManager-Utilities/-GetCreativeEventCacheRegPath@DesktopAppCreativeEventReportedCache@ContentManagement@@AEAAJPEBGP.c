/*
 * XREFs of ?GetCreativeEventCacheRegPath@DesktopAppCreativeEventReportedCache@ContentManagement@@AEAAJPEBGPEAPEAG@Z @ 0x180022B34
 * Callers:
...
__int64 __fastcall ContentManagement::DesktopAppCreativeEventReportedCache::GetCreativeEventCacheRegPath(
