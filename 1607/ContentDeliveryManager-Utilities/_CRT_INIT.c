/*
 * XREFs of _CRT_INIT @ 0x1800584CC
 * Callers:
 *     __DllMainCRTStartup @ 0x180058754 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x18005900A (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180059070 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800591DA (_initterm_0.c)
