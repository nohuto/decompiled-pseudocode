/*
 * XREFs of ??0?$OffersHealthTracker@$01$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D8B8
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<2,1>::OffersHealthTracker<2,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<2>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,2>::`vftable';
  return a1;
}
