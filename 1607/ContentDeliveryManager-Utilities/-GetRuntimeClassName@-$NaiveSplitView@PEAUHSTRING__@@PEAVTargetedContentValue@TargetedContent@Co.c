        ...
        HSTRING *a2)
{
  *a2 = 0LL;
  return WindowsCreateString(
           L"Windows.Foundation.Collections.IMapView`2<String, ContentManagement.TargetedContent.TargetedContentValue>",
           0x69u,
           a2);
}
