/*
 * XREFs of ?Evaluate@?$BaseScenarioEvents@$0L@@details@Health@CreativeFramework@@AEAAXXZ @ 0x180030DBC
 * Callers:
...
void CreativeFramework::Health::details::BaseScenarioEvents<11>::Evaluate()
{
  const WCHAR *v0; // rdx
  ...
  v16[1] = -2LL;
  CreativeFramework::Health::details::BaseScenarioEvents<12>::ReadTrackingInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<11,1>::HandleEvent<1,>'::`2'::s_traits);
  CreativeFramework::Health::details::BaseScenarioEvents<2>::ReadPlacementReportedInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<11,1>::HandleEvent<1,>'::`2'::s_traits);
  word_18008D924 = 256;
  pcbData = 20;
  v0 = (const WCHAR *)&qword_18008D900;
  if ( (unsigned __int64)qword_18008D918 >= 8 )
    v0 = qword_18008D900;
  if ( RegGetValueW(HKEY_CURRENT_USER, v0, L"HealthEvaluation", 8u, 0LL, &dword_18008D8E0, &pcbData)
    || pcbData <= 4
    || (_BYTE)dword_18008D8E0 != 3 )
  {
    dword_18008D8E0 = 3;
    qword_18008D8E8 = 0LL;
    qword_18008D8F0 = 0LL;
  ...
  v2 = qword_18008D8E8;
  v3 = (unsigned int)(qword_18008D8E8 + 711573504)
     + ((unsigned __int64)((unsigned int)qword_18008D8E8 + (HIDWORD(qword_18008D8E8) << 32) + 864000000000LL) >> 32 << 32);
  v4 = (*(__int64 (__fastcall **)(__int64 *))`CreativeFramework::Health::details::OffersHealthTracker<11,1>::HandleEvent<1,>'::`2'::s_traits)(&`CreativeFramework::Health::details::OffersHealthTracker<11,1>::HandleEvent<1,>'::`2'::s_traits);
  if ( (v4 & 2) != 0 )
    v5 = 2;
  else
    v5 = (v4 & 1) != 0;
  CreativeFramework::Health::details::HealthTrackingInfo::ToString((__int64)&unk_18008D860, v19);
  CreativeFramework::Health::details::PlacementReportedInfo::ToString((__int64)&unk_18008D8C0, v17);
  v7 = v17;
  if ( v18 >= 8 )
    v7 = (void **)v17[0];
  v14 = (__int64)v7;
  ...
  v16[0] = v4;
  LOWORD(pcbData) = v5;
  SystemTimeAsFileTime.dwLowDateTime = 11;
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::PlacementHealthEvaluation<unsigned int,unsigned short,unsigned __int64,unsigned char const &,unsigned short const *,unsigned short const *>(
    ...
    (__int64)&v15,
    (__int64)&v14);
  if ( (_WORD)qword_18008D8F0 != v5 || v3 <= v1 || !v2 )
  {
    LOWORD(qword_18008D8F0) = v5;
    qword_18008D8E8 = v1;
    LOBYTE(word_18008D924) = 1;
    CreativeFramework::Health::details::BaseScenarioEvents<15>::WriteHealthEvaluationInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<11,1>::HandleEvent<1,>'::`2'::s_traits);
    v10 = v17;
    if ( v18 >= 8 )
      v10 = (void **)v17[0];
    v16[0] = v10;
