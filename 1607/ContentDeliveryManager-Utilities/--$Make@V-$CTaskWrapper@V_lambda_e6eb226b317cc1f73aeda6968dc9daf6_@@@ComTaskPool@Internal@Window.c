/*
 * XREFs of ??$Make@V?$CTaskWrapper@V_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@ComTaskPool@Internal@Windows@@V_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@Details@WRL@Microsoft@@YA?AV?$ComPtr@V?$CTaskWrapper@V_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@ComTaskPool@Internal@Windows@@@12@$$QEAV_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@Z @ 0x180039D58
 * Callers:
 *     ??$WrapWithTask@V_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@ComTaskPool@Internal@Windows@@SA?AV?$ComPtr@UIComPoolTask@Internal@Windows@@@WRL@Microsoft@@$$QEAV_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@Z @ 0x1800390CC (--$WrapWithTask@V_lambda_e6eb226b317cc1f73aeda6968dc9daf6_@@@ComTaskPool@Internal@Windows@@SA-AV.c)
 * Callees:
 *     ??2@YAPEAX_KAEBUnothrow_t@std@@@Z @ 0x180058B88 (--2@YAPEAX_KAEBUnothrow_t@std@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1800597C0 (_guard_dispatch_icall_nop.c)
 */

_QWORD *__fastcall Microsoft::WRL::Details::Make<Windows::Internal::ComTaskPool::CTaskWrapper<_lambda_e6eb226b317cc1f73aeda6968dc9daf6_>,_lambda_e6eb226b317cc1f73aeda6968dc9daf6_>(
        _QWORD *a1,
        _QWORD *a2)
{
  _DWORD *v4; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &Windows::Internal::ComTaskPool::CTaskWrapper<_lambda_e6eb226b317cc1f73aeda6968dc9daf6_>::`vftable';
    *((_QWORD *)v4 + 2) = 0LL;
    if ( v4 + 4 != (_DWORD *)a2 )
    {
      *((_QWORD *)v4 + 2) = *a2;
