/*
 * XREFs of ?do_grouping@?$numpunct@G@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ @ 0x1800263F0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::numpunct<unsigned short>::do_grouping(__int64 a1, _QWORD *a2)
{
  size_t v3; // r8
  char *v4; // rdx
  __int64 v5; // rax
