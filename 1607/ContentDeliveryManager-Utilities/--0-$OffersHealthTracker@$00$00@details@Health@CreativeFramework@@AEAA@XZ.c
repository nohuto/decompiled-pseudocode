/*
 * XREFs of ??0?$OffersHealthTracker@$00$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D9F4
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<1,1>::OffersHealthTracker<1,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<1>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,1>::`vftable';
  return a1;
}
