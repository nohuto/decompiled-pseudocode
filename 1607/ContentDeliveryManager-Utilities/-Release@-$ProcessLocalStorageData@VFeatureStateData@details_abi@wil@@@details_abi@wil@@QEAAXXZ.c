/*
 * XREFs of ?Release@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x18000CF8C
 * Callers:
...
LABEL_20:
    ...
    else
    {
      ...
      if ( v12 && !CloseHandle(v12) )
        wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x623, v13, v14);
      v15 = (void *)lpMem[1];
      if ( v15 && !CloseHandle(v15) )
      {
        wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x623, v16, v17);
        __debugbreak();
      }
  ...
  if ( v7 )
  {
    if ( !ReleaseMutex(v7) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x629, v19, v20);
      __debugbreak();
    }
  }
}
