/*
 * XREFs of ?GetIids@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180018AA0
 * Callers:
 *     ?GetIids@ContentManagementBrokerServer@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x18001B430 (-GetIids@ContentManagementBrokerServer@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
