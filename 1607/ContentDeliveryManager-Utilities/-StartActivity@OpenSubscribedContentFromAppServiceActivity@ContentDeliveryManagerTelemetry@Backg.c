/*
 * XREFs of ?StartActivity@OpenSubscribedContentFromAppServiceActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIPEBG0@Z @ 0x18003BAC8
 * Callers:
...
void __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::OpenSubscribedContentFromAppServiceActivity::StartActivity(
        ...
        const unsigned __int16 *a4)
{
  ...
  if ( *(_DWORD *)v8 > 5u && (*((_QWORD *)v8 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v7 == *((_QWORD *)v8 + 3) )
    {
      ...
      TlgWrite(v8, &unk_18007D166, (LPCGUID)(v12 + 8), v13, 6u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
