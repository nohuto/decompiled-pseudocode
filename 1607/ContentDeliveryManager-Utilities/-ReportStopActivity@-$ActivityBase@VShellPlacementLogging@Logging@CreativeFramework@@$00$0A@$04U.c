/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x180025F28
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v6 )
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        v73 = 2 * v11 + 2;
        v74 = 0;
        TlgWrite(v8, &unk_18007BD7C, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
      }
    }
    else
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        v84 = 2 * v29 + 2;
        v85 = 0;
        TlgWrite(v26, &unk_18007C105, (LPCGUID)(v27 + 8), 0LL, 6u, &v75);
      }
    }
  }
