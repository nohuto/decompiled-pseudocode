/*
 * XREFs of ?StartActivity@LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG@Z @ 0x18001D888
 * Callers:
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v7 > 5u && (*((_QWORD *)v7 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)v7 + 3) )
    {
      ...
      TlgWrite(v9, &unk_18007C44C, (LPCGUID)(v12 + 8), v13, 4u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
