/*
 * XREFs of ?GetIids@AppContainerCreativeEventReportedCache@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180018B00
 * Callers:
 *     ?GetIids@AppContainerCreativeEventReportedCache@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x18001B3D0 (-GetIids@AppContainerCreativeEventReportedCache@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
