/*
 * XREFs of ??0?$OffersHealthTracker@$0N@$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D3C8
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<13,1>::OffersHealthTracker<13,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<13>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,13>::`vftable';
  return a1;
}
