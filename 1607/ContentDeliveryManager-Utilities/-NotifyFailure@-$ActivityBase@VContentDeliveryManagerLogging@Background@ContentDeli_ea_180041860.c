/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180041860
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  const unsigned __int16 *v23; // r11
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD *, _QWORD))(*a1 + 16LL))(a1, (unsigned int)a2[2]) )
  {
    ...
    if ( *(_DWORD *)v22 > 5u
      && (*((_QWORD *)v22 + 2) & 0x400000000000LL) != 0
      && (*((_QWORD *)v22 + 3) & 0x400000000000LL) == *((_QWORD *)v22 + 3) )
    {
      v23 = &word_1800717D0;
      ...
      v94 = v25 + 1;
      v95 = 0;
      TlgWrite(v22, &unk_18007D4CB, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v4 + 3) & 0x600000000000LL) == *((_QWORD *)v4 + 3) )
    {
      ...
      v87 = 2 * v7 + 2;
      v88 = 0;
      TlgWrite(v4, &unk_18007D5F3, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
    }
  }
