/*
 * XREFs of ?GetMany@?$IVector_impl@U?$AggregateType@PEAVTargetedContentItem@TargetedContent@ContentManagement@@PEAUITargetedContentItem@23@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUITargetedContentItem@TargetedContent@ContentManagement@@PEAI@Z @ 0x18000C1A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Foundation::Collections::IVector_impl<Windows::Foundation::Internal::AggregateType<ContentManagement::TargetedContent::TargetedContentItem *,ContentManagement::TargetedContent::ITargetedContentItem *>,1>::GetMany(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        void *a4,
