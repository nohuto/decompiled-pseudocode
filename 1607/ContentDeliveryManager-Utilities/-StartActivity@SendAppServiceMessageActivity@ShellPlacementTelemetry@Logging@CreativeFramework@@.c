/*
 * XREFs of ?StartActivity@SendAppServiceMessageActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXW4TriggerId@Triggers@4@@Z @ 0x18001DE78
 * Callers:
        ...
        int a2)
{
  ...
  DWORD v16; // [rsp+30h] [rbp-19h] BYREF
  PSRWLOCK SRWLock; // [rsp+38h] [rbp-11h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+40h] [rbp-9h] BYREF
  DWORD *v19; // [rsp+60h] [rbp+17h]
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)Local > 5u && (*((_QWORD *)Local + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)Local + 3) )
    {
      ...
      LODWORD(Local) = TlgWrite(v9, &unk_18007BD2C, (LPCGUID)(v11 + 8), v12, 4u, &pData);
    }
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
