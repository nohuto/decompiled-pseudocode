/*
 * XREFs of ??0?$OffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D640
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<11,1>::OffersHealthTracker<11,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<11>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,11>::`vftable';
  return a1;
}
