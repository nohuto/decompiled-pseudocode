/*
 * XREFs of ??1?$BaseScenarioEvents@$0N@@details@Health@CreativeFramework@@QEAA@XZ @ 0x18002CB64
 * Callers:
 *     ??__Fs_traits@?1???$HandleEvent@$09I_K@?$OffersHealthTracker@$0N@$00@details@Health@CreativeFramework@@SAXI_K@Z@YAXXZ @ 0x18005D0C0 (--__Fs_traits@-1---$HandleEvent@$09I_K@-$OffersHealthTracker@$0N@$00@details@Health@CreativeFram.c)
 *     ??__Fs_traits@?1???$HandleEvent@$00$$V@?$OffersHealthTracker@$0N@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D1E0 (--__Fs_traits@-1---$HandleEvent@$00$$V@-$OffersHealthTracker@$0N@$00@details@Health@CreativeFram.c)
 *     ??__Fs_traits@?1???$HandleEvent@$08$$V@?$OffersHealthTracker@$0N@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D300 (--__Fs_traits@-1---$HandleEvent@$08$$V@-$OffersHealthTracker@$0N@$00@details@Health@CreativeFram.c)
 * Callees:
...
void __fastcall CreativeFramework::Health::details::BaseScenarioEvents<13>::~BaseScenarioEvents<13>(__int64 a1)
{
  const WCHAR *v2; // rdx
  unsigned int v3; // eax
  __int64 v4; // r8
  ...
  *(_QWORD *)a1 = &CreativeFramework::Health::details::BaseScenarioEvents<13>::`vftable';
