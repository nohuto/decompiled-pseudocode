/*
 * XREFs of ?GetIids@AppInstallInfoRecordImpl@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180006910
 * Callers:
 *     ?GetIids@AppInstallInfoRecordImpl@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180018560 (-GetIids@AppInstallInfoRecordImpl@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
