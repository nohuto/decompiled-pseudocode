/*
 * XREFs of ?ReportInteraction@ContentItemImpl@TargetedContent@ContentManagement@@UEAAJW4TargetedContentInteraction@23@PEAUHSTRING__@@@Z @ 0x18004A7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ContentManagement::TargetedContent::ContentItemImpl::ReportInteraction(
        __int64 a1,
        int a2,
        HSTRING a3)
{
