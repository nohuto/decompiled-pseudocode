/*
 * XREFs of ?StartActivity@GetSubscribedContentActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG_N1@Z @ 0x18003E878
 * Callers:
...
void __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::GetSubscribedContentActivity::StartActivity(
        ...
        unsigned __int8 a4)
{
  ...
  if ( *(_DWORD *)v9 > 5u && (*((_QWORD *)v9 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)v9 + 3) )
    {
      ...
      TlgWrite(v9, &unk_18007D6F8, (LPCGUID)(v12 + 8), v13, 6u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
