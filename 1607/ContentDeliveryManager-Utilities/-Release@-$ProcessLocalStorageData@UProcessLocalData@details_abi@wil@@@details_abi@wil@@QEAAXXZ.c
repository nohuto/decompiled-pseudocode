/*
 * XREFs of ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x18000D4B4
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x18005CD60 (wil--details--_dynamic_atexit_destructor_for__g_processLocalData__.c)
 * Callees:
 ...
 *     ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x180002EA0 (-Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ.c)
 *     ??_G?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x18000D610 (--_G-$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z.c)
...
void __fastcall wil::details_abi::ProcessLocalStorageData<wil::details_abi::ProcessLocalData>::Release(char *lpMem)
{
  ...
  if ( (*(_DWORD *)lpMem)-- == 1 )
  {
    ...
    if ( hMutex )
    {
      ...
      if ( !ReleaseMutex(v3) )
      {
        wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x629, v5, v6);
        __debugbreak();
      }
  ...
  if ( v7 )
  {
    if ( !ReleaseMutex(v7) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x629, v10, v11);
      __debugbreak();
    }
  }
}
