/*
 * XREFs of _lambda_65e132131f351cb9064538b793e0e588_::operator() @ 0x180034CF4
 * Callers:
 *     ?_Do_call@?$_Func_impl@U?$_Callable_obj@V_lambda_65e132131f351cb9064538b793e0e588_@@$0A@@wistd@@V?$function_allocator@V?$_Func_class@XU_Nil@wistd@@U12@U12@U12@U12@U12@U12@@wistd@@@details@2@XU_Nil@2@U52@U52@U52@U52@U52@U52@@wistd@@UEAAXXZ @ 0x180039FD0 (-_Do_call@-$_Func_impl@U-$_Callable_obj@V_lambda_65e132131f351cb9064538b793e0e588_@@$0A@@wistd@@.c)
 * Callees:
...
void __fastcall lambda_65e132131f351cb9064538b793e0e588_::operator()(
        ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl **a1)
{
  ...
  try
  {
    ...
    if ( v1 )
      Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::InterfaceList<ContentManagement::IThumbnailCacheHelper,Microsoft::WRL::Details::Nil>>,Microsoft::WRL::RuntimeClassFlags<3>,1,1,0>::AddRef((__int64)v1);
    v2 = *(struct Windows::Internal::IComPoolTask **)Windows::Internal::ComTaskPool::WrapWithTask<_lambda_e6eb226b317cc1f73aeda6968dc9daf6_>(
                                                       &v8,
                                                       &v9);
