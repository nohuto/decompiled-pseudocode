/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180023FB0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v5 )
  {
    v24 = CreativeFramework::Logging::ShellPlacementLogging::Provider();
    if ( *(_DWORD *)v24 > 5u )
    {
      ...
      v102 = v28 + 1;
      v103 = 0;
      TlgWrite(v24, &unk_18007C170, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v60);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v139 = 2 * v9 + 2;
      v140 = 0;
      TlgWrite(v6, &unk_18007C48A, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
