/*
 * XREFs of ??1?$BaseScenarioEvents@$0P@@details@Health@CreativeFramework@@QEAA@XZ @ 0x18002C6B4
 * Callers:
 *     ??__Fs_traits@?1???$HandleEvent@$09I_K@?$OffersHealthTracker@$0P@$00@details@Health@CreativeFramework@@SAXI_K@Z@YAXXZ @ 0x18005D040 (--__Fs_traits@-1---$HandleEvent@$09I_K@-$OffersHealthTracker@$0P@$00@details@Health@CreativeFram.c)
 *     ??__Fs_traits@?1???$HandleEvent@$00$$V@?$OffersHealthTracker@$0P@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D160 (--__Fs_traits@-1---$HandleEvent@$00$$V@-$OffersHealthTracker@$0P@$00@details@Health@CreativeFram.c)
 *     ??__Fs_traits@?1???$HandleEvent@$08$$V@?$OffersHealthTracker@$0P@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D280 (--__Fs_traits@-1---$HandleEvent@$08$$V@-$OffersHealthTracker@$0P@$00@details@Health@CreativeFram.c)
 * Callees:
...
void __fastcall CreativeFramework::Health::details::BaseScenarioEvents<15>::~BaseScenarioEvents<15>(__int64 a1)
{
  const WCHAR *v2; // rdx
  unsigned int v3; // eax
  __int64 v4; // r8
  ...
  *(_QWORD *)a1 = &CreativeFramework::Health::details::BaseScenarioEvents<15>::`vftable';
