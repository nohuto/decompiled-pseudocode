/*
 * XREFs of ?Stop@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x180041E30
 * Callers:
  ...
  else
  {
    ...
    if ( *(_DWORD *)v7 > 5u )
    {
        ...
        && (*((_QWORD *)v8 + 3) & 0x400000000000LL) == *((_QWORD *)v8 + 3) )
      {
        ...
        p_SRWLock = &SRWLock;
        v22 = 4;
        LODWORD(v7) = TlgWrite(v8, &unk_18007D482, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
      }
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
