/*
 * XREFs of ??0?$OffersHealthTracker@$0M@$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D504
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<12,1>::OffersHealthTracker<12,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<12>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,12>::`vftable';
  return a1;
}
