/*
 * XREFs of ??_G?$basic_istream@GU?$char_traits@G@std@@@std@@UEAAPEAXI@Z @ 0x180025D88
 * Callers:
 *     ??_E?$basic_istream@GU?$char_traits@G@std@@@std@@$4PPPPPPPM@A@EAAPEAXI@Z @ 0x1800327E0 (--_E-$basic_istream@GU-$char_traits@G@std@@@std@@$4PPPPPPPM@A@EAAPEAXI@Z.c)
 * Callees:
