/*
 * XREFs of ??1?$BaseScenarioEvents@$01@details@Health@CreativeFramework@@QEAA@XZ @ 0x18002CDBC
 * Callers:
 *     ??__Fs_traits@?1???$HandleEvent@$09I_K@?$OffersHealthTracker@$01$00@details@Health@CreativeFramework@@SAXI_K@Z@YAXXZ @ 0x18005D100 (--__Fs_traits@-1---$HandleEvent@$09I_K@-$OffersHealthTracker@$01$00@details@Health@CreativeFrame.c)
 *     ??__Fs_traits@?1???$HandleEvent@$00$$V@?$OffersHealthTracker@$01$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D220 (--__Fs_traits@-1---$HandleEvent@$00$$V@-$OffersHealthTracker@$01$00@details@Health@CreativeFrame.c)
 *     ??__Fs_traits@?1???$HandleEvent@$08$$V@?$OffersHealthTracker@$01$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D340 (--__Fs_traits@-1---$HandleEvent@$08$$V@-$OffersHealthTracker@$01$00@details@Health@CreativeFrame.c)
 * Callees:
...
void __fastcall CreativeFramework::Health::details::BaseScenarioEvents<2>::~BaseScenarioEvents<2>(__int64 a1)
{
  const WCHAR *v2; // rdx
  unsigned int v3; // eax
  __int64 v4; // r8
  ...
  *(_QWORD *)a1 = &CreativeFramework::Health::details::BaseScenarioEvents<2>::`vftable';
