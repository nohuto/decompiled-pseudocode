/*
 * XREFs of ?StartActivity@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXXZ @ 0x180034338
 * Callers:
        ...
        ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::SubscriptionManagerContentUpdatedActivity *this)
{
  ...
  if ( *(_DWORD *)v3 > 5u && (*((_QWORD *)v3 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v2 == *((_QWORD *)v3 + 3) )
    {
      ...
      TlgWrite(v3, &unk_18007CDAB, (LPCGUID)(v4 + 8), v5, 3u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
