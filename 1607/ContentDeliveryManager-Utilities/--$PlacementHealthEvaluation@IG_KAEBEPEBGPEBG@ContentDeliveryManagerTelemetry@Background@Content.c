/*
 * XREFs of ??$PlacementHealthEvaluation@IG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAI$$QEAG$$QEA_KAEBE$$QEAPEBG4@Z @ 0x1800324C0
 * Callers:
        ...
        const WCHAR **a6)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    ...
    v29 = 2 * v14 + 2;
    v30 = 0;
    LODWORD(v9) = TlgWrite(v10, &unk_18007C3BE, 0LL, 0LL, 8u, &pData);
  }
  return (int)v9;
}
