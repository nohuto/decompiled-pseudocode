...
void __fastcall Windows::Foundation::Collections::Internal::Vector_ContentManagement::AppInstallInfoRecord_____ptr64_Windows::Foundation::Collections::Internal::DefaultEqualityPredicate_ContentManagement::AppInstallInfoRecord_____ptr64__Windows::Foundation::Collections::Internal::DefaultLifetimeTraits_ContentManagement::AppInstallInfoRecord_____ptr64__Windows::Foundation::Collections::Internal::VectorOptions_ContentManagement::AppInstallInfoRecord_____ptr64_0_1_0___::SetAt_::_1_::dtor_2(
        ...
        __int64 a2)
{
  XWinRT::detail::LockHolder<XWinRT::ComLock,XWinRT::detail::AcquireWrite>::~LockHolder<XWinRT::ComLock,XWinRT::detail::AcquireWrite>((__int64 *)(a2 + 112));
}
