/*
 * XREFs of ?StopActivity@RemoveSubscribedContentListenerActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x18003DEF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::RemoveSubscribedContentListenerActivity::StopActivity(
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v74 = 2 * v10 + 2;
      v75 = 0;
      TlgWrite(v7, &unk_18007D97D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v25 + 3) & 0x200000000000LL) == *((_QWORD *)v25 + 3) )
    {
      ...
      v34 = CurrentThreadId;
      v79 = &v34;
      TlgWrite(v26, &unk_18007D925, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v76);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
