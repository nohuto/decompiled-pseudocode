/*
 * XREFs of ??0?$OffersHealthTracker@$0P@$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18002D150
 * Callers:
...
void **__fastcall CreativeFramework::Health::details::OffersHealthTracker<15,1>::OffersHealthTracker<15,1>(void **a1)
{
  ...
  *a1 = &CreativeFramework::Health::details::BaseScenarioEvents<15>::`vftable';
  ...
  *a1 = &CreativeFramework::Health::details::BaseEventsWithEvaluation<1,15>::`vftable';
  return a1;
}
