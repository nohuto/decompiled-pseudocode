/*
 * XREFs of _ContentManagement::TargetedContent::NumericContentValueFromJson_::_1_::dtor$0 @ 0x18005C596
 * Callers:
 *     <none>
 * Callees:
...
volatile signed __int64 *__fastcall ContentManagement::TargetedContent::NumericContentValueFromJson_::_1_::dtor_0(
        __int64 a1,
        __int64 a2)
{
