/*
 * XREFs of ??1?$BaseScenarioEvents@$0BA@@details@Health@CreativeFramework@@QEAA@XZ @ 0x18002C588
 * Callers:
 *     ??__Fs_traits@?1???$HandleEvent@$09I_K@?$OffersHealthTracker@$0BA@$00@details@Health@CreativeFramework@@SAXI_K@Z@YAXXZ @ 0x18005D020 (--__Fs_traits@-1---$HandleEvent@$09I_K@-$OffersHealthTracker@$0BA@$00@details@Health@CreativeFra.c)
 *     ??__Fs_traits@?1???$HandleEvent@$00$$V@?$OffersHealthTracker@$0BA@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D140 (--__Fs_traits@-1---$HandleEvent@$00$$V@-$OffersHealthTracker@$0BA@$00@details@Health@CreativeFra.c)
 *     ??__Fs_traits@?1???$HandleEvent@$08$$V@?$OffersHealthTracker@$0BA@$00@details@Health@CreativeFramework@@SAXXZ@YAXXZ @ 0x18005D260 (--__Fs_traits@-1---$HandleEvent@$08$$V@-$OffersHealthTracker@$0BA@$00@details@Health@CreativeFra.c)
 * Callees:
...
void __fastcall CreativeFramework::Health::details::BaseScenarioEvents<16>::~BaseScenarioEvents<16>(__int64 a1)
{
  const WCHAR *v2; // rdx
  unsigned int v3; // eax
  __int64 v4; // r8
  ...
  *(_QWORD *)a1 = &CreativeFramework::Health::details::BaseScenarioEvents<16>::`vftable';
