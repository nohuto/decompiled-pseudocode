/*
 * XREFs of ?NewNode@?$CAtlList@PEAVAudioEffectsWatcher@@V?$CElementTraits@PEAVAudioEffectsWatcher@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVAudioEffectsWatcher@@PEAV312@1@Z @ 0x18000404C
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<AudioEffectsWatcher *,ATL::CElementTraits<AudioEffectsWatcher *>>::NewNode(
        __int64 a1,
        __int64 *a2,
        __int64 a3)
{
