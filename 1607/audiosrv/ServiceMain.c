/*
 * XREFs of ServiceMain @ 0x180032340
 * Callers:
 *     <none>
 * Callees:
 *     ReportStatusToSCMgr @ 0x180031B58 (ReportStatusToSCMgr.c)
 *     StringCbCopyW @ 0x1800325B0 (StringCbCopyW.c)
 *     AudioWriteLogHeader @ 0x180032634 (AudioWriteLogHeader.c)
 *     WppInitUm @ 0x180032794 (WppInitUm.c)
...
void __fastcall ServiceMain(unsigned int a1, LPCWSTR *a2)
{
  ...
  qword_1800CAD70 = 0LL;
  WPP_GLOBAL_Control = (CAudioSession *)&WPP_MAIN_CB;
  WPP_MAIN_CB = 0LL;
  WppInitUm();
...
LABEL_27:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSession *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_579770171f033cf210c6bb4fbf8d98d3_Traceguids, v4);
  }
