/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x1800273C4
 * Callers:
        ...
        struct tagPROPVARIANT *a4)
{
  ...
  if ( v7 < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 0x10BFu, v7);
  if ( v9[0] )
