/*
 * XREFs of ?APOTrackAndLogException@@YAXPEBU_TlgProvider_t@@PEBGPEAUIMMDevice@@W4APO_TYPE@@U_GUID@@PEADKJ_N6@Z @ 0x18008BEB8
 * Callers:
        ...
        char a8)
{
  ...
  if ( *(_DWORD *)v10 > 2u && TlgKeywordOn(v10, 0x400000000000uLL) )
  {
    ...
    v24 = &a8;
    v25 = 4LL;
    TlgWrite(v10, &unk_1800A87AC, v12, v13, 8u, &pData);
  }
  TrackSystemEffectBehavior((__int64)v9, v8, 0, 1, cData);
  CoTaskMemFree(pv[0]);
}
