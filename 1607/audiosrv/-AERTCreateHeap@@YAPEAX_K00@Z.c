/*
 * XREFs of ?AERTCreateHeap@@YAPEAX_K00@Z @ 0x180034420
 * Callers:
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x1800343C0 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 * Callees:
 *     WPP_SF_PPPL @ 0x18008DBB8 (WPP_SF_PPPL.c)
