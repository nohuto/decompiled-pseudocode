/*
 * XREFs of ??1?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x180059374
 * Callers:
 *     _CVolumeStrip::CVolumeStrip_::_1_::dtor$0 @ 0x18003A9D8 (_CVolumeStrip--CVolumeStrip_--_1_--dtor$0.c)
 *     _CVolumeStrip::_CVolumeStrip_::_1_::dtor$0 @ 0x1800596A6 (_CVolumeStrip--_CVolumeStrip_--_1_--dtor$0.c)
 * Callees:
