/*
 * XREFs of ?StringCbCatExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x180028500
 * Callers:
 *     ?LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z @ 0x18001793C (-LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z.c)
 * Callees:
 *     StringCopyWorkerW_0 @ 0x1800285BC (StringCopyWorkerW_0.c)
 *     StringLengthWorkerW @ 0x180028630 (StringLengthWorkerW.c)
 */
