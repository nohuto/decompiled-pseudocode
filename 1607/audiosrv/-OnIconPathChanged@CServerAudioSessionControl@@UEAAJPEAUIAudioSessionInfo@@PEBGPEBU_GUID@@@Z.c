/*
 * XREFs of ?OnIconPathChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@PEBGPEBU_GUID@@@Z @ 0x180060960
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 )
  {
    ...
    if ( v14 )
    {
      ...
      *(GUID *)(v15 + 7) = v18;
      ...
      operator delete(v15);
      if ( MediaEvent < 0 )
        AudSrvTraceLoggingErrorHelper("CServerAudioSessionControl::OnIconPathChanged", 494, MediaEvent);
    }
  }
  if ( v24 )
