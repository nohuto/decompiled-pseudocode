/*
 * XREFs of ?SetDeviceFormat@CPolicyConfig@@UEAAJPEBGPEBUtWAVEFORMATEX@@1@Z @ 0x18006E7B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  if ( v7 >= 0 )
  {
    v8 = CPolicyConfig::SetDeviceFormat(this, v10, a3);
    v6 = v10;
    v7 = v8;
    goto LABEL_6;
  }
LABEL_7:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetDeviceFormat", 2611, v7);
  v6 = v10;
LABEL_8:
  if ( v6 )
