/*
 * XREFs of ?GetEndpointBufferSize@CBaseStreamGroupProxy@@UEAAJPEAIPEAM@Z @ 0x180074E70
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v3 )
  {
    ...
    Microsoft::WRL::ComPtr<IMMDevice>::InternalRelease(&v8);
    if ( v4 < 0 )
      AudSrvTraceLoggingErrorHelper("CBaseStreamGroupProxy::GetEndpointBufferSize", 435, v4);
  }
