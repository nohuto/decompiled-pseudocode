/*
 * XREFs of ServiceStart @ 0x180031A48
 * Callers:
...
__int64 __fastcall ServiceStart(struct SERVICE_STATUS_HANDLE__ *a1, int a2, _QWORD *a3, __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    if ( v10 )
    {
      ...
      {
LABEL_17:
        if ( v14 != (CAudioSession *)&WPP_GLOBAL_Control
          && (*((_BYTE *)v14 + 28) & 0x10) != 0
          && *((_BYTE *)v14 + 25) >= 4u )
        {
