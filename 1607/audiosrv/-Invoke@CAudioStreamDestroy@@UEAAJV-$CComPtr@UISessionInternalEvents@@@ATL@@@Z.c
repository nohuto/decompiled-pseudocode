/*
 * XREFs of ?Invoke@CAudioStreamDestroy@@UEAAJV?$CComPtr@UISessionInternalEvents@@@ATL@@@Z @ 0x18000F250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStreamDestroy::Invoke(__int64 a1, volatile signed __int32 **a2)
{
  __int64 v3; // rax
  __int64 v4; // r8
  __int64 result; // rax
  ...
  if ( v3 )
    ...
    v4 = 0LL;
  result = (*(__int64 (__fastcall **)(volatile signed __int32 *, _QWORD, __int64))(*(_QWORD *)*a2 + 96LL))(
             *a2,
             *(_QWORD *)(a1 + 8),
             v4);
  v6 = result;
  ...
  if ( *a2 )
  {
    ...
    else
    {
      ...
      if ( (char *)v8 == (char *)CAudioSessionManager::Release )
