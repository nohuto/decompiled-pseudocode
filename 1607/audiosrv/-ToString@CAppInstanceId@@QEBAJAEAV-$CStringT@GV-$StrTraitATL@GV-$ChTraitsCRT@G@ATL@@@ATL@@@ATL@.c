/*
 * XREFs of ?ToString@CAppInstanceId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18000DAE4
 * Callers:
...
LABEL_4:
      v2 = v8;
      if ( v8 < 0 )
        AudSrvTraceLoggingErrorHelper("CAppInstanceId::ToString", 0x299u, v8);
    }
  }
  else
  {
