/*
 * XREFs of ?PropertyStoreSetValue@CAudioSession@@UEAAJAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x18005E9C0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 != 2 )
    return (*(__int64 (__fastcall **)(_QWORD, const struct _tagpropertykey *, const struct tagPROPVARIANT *))(**((_QWORD **)this + 77) + 48LL))(
             *((_QWORD *)this + 77),
             a2,
             a3);
  AudSrvTraceLoggingErrorHelper("CAudioSession::PropertyStoreSetValue", 5997, -2147024809);
  return 2147942487LL;
}
