/*
 * XREFs of ?SetDefaultEndpoint@CPolicyConfig@@UEAAJPEBGW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@@Z @ 0x18006E4E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPolicyConfig::SetDefaultEndpoint(CPolicyConfig *this, const unsigned __int16 *a2, unsigned int a3)
{
  ...
  if ( !a2 )
  {
    v5 = -2147467261;
LABEL_5:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetDefaultEndpoint", 3866, v5);
    goto LABEL_6;
  }
  v5 = CoCreateInstance(
