/*
 * XREFs of ?Copy@CAppAudioSessionId@@QEAAJAEBV1@@Z @ 0x18002A314
 * Callers:
        ...
        int a14)
{
  ...
  *((_OWORD *)this + 1) = *((_OWORD *)a2 + 1);
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::operator=(this, (__int64 *)a2);
  }
  ...
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::operator=((_QWORD *)v15 + 1, (__int64 *)v14 + 1);
  }
  ...
  *((_DWORD *)v15 + 10) = *((_DWORD *)v14 + 10);
  ...
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::operator=((_QWORD *)v15 + 4, (__int64 *)v14 + 4);
  }
  catch ( ATL::CAtlException *v22 )
  {
    ...
    if ( v26 < 0 )
LABEL_9:
      AudSrvTraceLoggingErrorHelper("CAppAudioSessionId::Copy", 470, v16);
  }
  return v16;
}
