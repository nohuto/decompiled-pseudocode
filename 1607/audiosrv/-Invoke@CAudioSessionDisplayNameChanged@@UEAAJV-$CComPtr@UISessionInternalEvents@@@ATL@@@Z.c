/*
 * XREFs of ?Invoke@CAudioSessionDisplayNameChanged@@UEAAJV?$CComPtr@UISessionInternalEvents@@@ATL@@@Z @ 0x18005CB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSessionDisplayNameChanged::Invoke(_QWORD *a1, CAudioSessionManager **a2)
{
  ...
  v3 = (*(__int64 (__fastcall **)(CAudioSessionManager *, _QWORD, _QWORD, _QWORD))(*(_QWORD *)*a2 + 24LL))(
         *a2,
         a1[1],
         a1[2],
         a1[3]);
