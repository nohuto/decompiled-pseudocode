/*
 * XREFs of ??$?4UIMMDevice@@@?$CComPtr@UIMMEndpointInternal@@@ATL@@QEAAPEAUIMMEndpointInternal@@AEBV?$CComPtr@UIMMDevice@@@1@@Z @ 0x180027688
 * Callers:
...
LABEL_4:
  if ( !v6 )
    return ATL::AtlComQIPtrAssign(a1, *a2, &GUID_eecca8a7_a629_4dba_9f23_20f6db42d990);
  return *a1;
}
