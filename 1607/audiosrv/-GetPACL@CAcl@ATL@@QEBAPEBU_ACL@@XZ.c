/*
 * XREFs of ?GetPACL@CAcl@ATL@@QEBAPEBU_ACL@@XZ @ 0x18002CCA8
 * Callers:
...
const struct _ACL *__fastcall ATL::CAcl::GetPACL(ATL::CAcl *this)
{
  ...
  __int64 (__fastcall *v10)(ATL::CDacl::CAccessAce *); // rax
  int Length; // eax
  struct _ACL *v12; // rax
  ...
  __int64 (__fastcall *v19)(ATL::CDacl::CAccessAce *); // rax
  DWORD v20; // eax
  DWORD nAceListLength; // r14d
  void *(__fastcall *v22)(ATL::CDacl::CAccessAce *); // rax
  void *v23; // rax
  int Error; // ebx
  int v26; // ebx
  ...
  if ( !*((_QWORD *)this + 1) && !*((_BYTE *)this + 16) )
  {
    ...
    for ( i = AceCount; v5 < i; ++v5 )
    {
      ...
      if ( Ace )
      {
        v10 = *(__int64 (__fastcall **)(ATL::CDacl::CAccessAce *))(*(_QWORD *)Ace + 16LL);
    ...
    *((_QWORD *)this + 1) = v12;
    ...
    for ( j = 0; j < i; ++j )
    {
      ...
      {
        v18 = v16;
        v19 = *(__int64 (__fastcall **)(ATL::CDacl::CAccessAce *))(*(_QWORD *)v16 + 16LL);
        v20 = v19 == ATL::CDacl::CAccessAce::GetLength ? ATL::CDacl::CAccessAce::GetLength(v18) : v19(v18);
        nAceListLength = v20;
        v22 = *(void *(__fastcall **)(ATL::CDacl::CAccessAce *))(*(_QWORD *)v17 + 8LL);
