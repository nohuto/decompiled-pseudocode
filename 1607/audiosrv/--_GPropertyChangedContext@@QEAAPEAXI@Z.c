/*
 * XREFs of ??_GPropertyChangedContext@@QEAAPEAXI@Z @ 0x18007B1A4
 * Callers:
 *     ??1?$CAutoPtr@UPropertyChangedContext@@@ATL@@QEAA@XZ @ 0x18007AF40 (--1-$CAutoPtr@UPropertyChangedContext@@@ATL@@QEAA@XZ.c)
