/*
 * XREFs of ?ClearApplicationDefaultEndpoint@CPolicyConfig@@UEAAJKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x180067600
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  v9 = -2147024809;
LABEL_10:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::ClearApplicationDefaultEndpoint", 4157, v9);
  v8 = ppv;
LABEL_11:
  if ( v8 )
