/*
 * XREFs of ?Start@CMonitor@@QEAAJXZ @ 0x180081714
 * Callers:
 ...
 *     ?AddHead@?$CAtlList@PEAUSampleDataBlock@CMonitor@@V?$CElementTraits@PEAUSampleDataBlock@CMonitor@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAUSampleDataBlock@CMonitor@@@Z @ 0x18007F394 (-AddHead@-$CAtlList@PEAUSampleDataBlock@CMonitor@@V-$CElementTraits@PEAUSampleDataBlock@CMonitor.c)
 *     ?AllocateBytes@?$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z @ 0x18007F3CC (-AllocateBytes@-$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z.c)
...
__int64 __fastcall CMonitor::Start(CMonitor *this)
{
  ...
  {
    if ( v3 != (CAudioSession *)&WPP_GLOBAL_Control
  ...
  else
  {
      ...
      || !(_DWORD)v35 )
    {
      ...
      *((_DWORD *)v1 + 114) = GetTickCount();
      ...
      v12 = (void *)(v11 + (unsigned int)(int)v10);
      ppv = v12;
      if ( WPP_GLOBAL_Control != (CAudioSession *)&WPP_GLOBAL_Control
        && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x800000) != 0
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
