/*
 * XREFs of ?SetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEBUtagPROPVARIANT@@@Z @ 0x18006F890
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPROPVARIANT *a5)
{
  ...
  if ( !a2 || !a5 )
  {
    v7 = -2147467261;
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetPropertyValue", 3834, v7);
    goto LABEL_7;
  }
