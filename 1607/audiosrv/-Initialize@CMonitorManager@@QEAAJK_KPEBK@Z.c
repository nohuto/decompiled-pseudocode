/*
 * XREFs of ?Initialize@CMonitorManager@@QEAAJK_KPEBK@Z @ 0x18003314C
 * Callers:
        ...
        CMonitorManager::CaptureMonitor *a4)
{
  ...
  LPCRITICAL_SECTION v32; // [rsp+58h] [rbp-90h] BYREF
  ...
  v36 = 0LL;
  v37 = 10;
  ATL::CCritSecLock::CCritSecLock((ATL::CCritSecLock *)&v32, (struct _RTL_CRITICAL_SECTION *)((char *)v4 + 16));
...
LABEL_66:
    ...
    while ( v35 )
    {
      v25 = (__int64 *)ATL::CAtlList<ATL::CComQIPtr<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>,ATL::CComQIPtrElementTraits<CMonitorManager::CaptureMonitor,&_GUID const IID_IUnknown>>::RemoveHead(
                         &v34,
                         &v41);
