/*
 * XREFs of Template_qqzr1qzr3qqqxqpqqqzr13q @ 0x18008EDF8
 * Callers:
        ...
        char a18)
{
  ...
  int v52; // [rsp+168h] [rbp+68h] BYREF
  ...
  v45 = 4LL;
  v50 = 4LL;
  return EtwEventWrite(Microsoft_Windows_PDCHandle, &PDCV2_ACTIVATION_CALLBACK, 16LL, v20);
}
