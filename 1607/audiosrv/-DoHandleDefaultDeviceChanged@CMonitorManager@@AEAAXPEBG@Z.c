/*
 * XREFs of ?DoHandleDefaultDeviceChanged@CMonitorManager@@AEAAXPEBG@Z @ 0x18007BC7C
 * Callers:
...
void __fastcall CMonitorManager::DoHandleDefaultDeviceChanged(CMonitorManager *this, struct IMMDevice *a2)
{
  ...
  ATL::CAtlException *v23; // [rsp+48h] [rbp-70h] BYREF
  LPCRITICAL_SECTION v24; // [rsp+50h] [rbp-68h] BYREF
  char v25; // [rsp+58h] [rbp-60h]
  LPCRITICAL_SECTION v26; // [rsp+60h] [rbp-58h] BYREF
  char v27; // [rsp+68h] [rbp-50h]
  _QWORD *v28; // [rsp+70h] [rbp-48h] BYREF
  unsigned __int64 v29; // [rsp+78h] [rbp-40h]
  unsigned __int64 v30; // [rsp+80h] [rbp-38h]
  int v31; // [rsp+88h] [rbp-30h]
  struct CMonitorManager::CaptureMonitor *v32; // [rsp+C0h] [rbp+8h] BYREF
  struct IMMDevice *v33; // [rsp+C8h] [rbp+10h] BYREF
  ...
  while ( v6 )
  {
    Next = ATL::CAtlList<CVADServer *,ATL::CElementTraits<CVADServer *>>::GetNext(v3, v22);
    ...
    else
    {
      ...
      WPP_SF_SS(
        ...
        *((const wchar_t **)pv + 9),
        *(const wchar_t **)(*((_QWORD *)pv + 8) + 64LL));
      v8 = WPP_GLOBAL_Control;
    }
    if ( v9[13] )
    {
