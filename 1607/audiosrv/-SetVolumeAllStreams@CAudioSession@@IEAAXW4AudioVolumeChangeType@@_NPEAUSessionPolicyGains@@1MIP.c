/*
 * XREFs of ?SetVolumeAllStreams@CAudioSession@@IEAAXW4AudioVolumeChangeType@@_NPEAUSessionPolicyGains@@1MIPEAM_J@Z @ 0x180013044
 * Callers:
        ...
        __int64 a9)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 113LL, &WPP_3a746c8541623b49d47b96eacc8d2afc_Traceguids, a1);
  }
  ...
  if ( *(_QWORD *)(a1 + 104) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a2 == 3 )
      {
        a9 = *((_BYTE *)v17 + 344) != 0 ? 0x3D0900 : 0;
      }
      else if ( a2 == 4 )
      {
        a9 = *((_BYTE *)v17 + 344) != 0 ? 0x2710 : 0;
      }
