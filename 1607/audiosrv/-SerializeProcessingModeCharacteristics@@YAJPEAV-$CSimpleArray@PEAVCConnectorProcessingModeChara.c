/*
 * XREFs of ?SerializeProcessingModeCharacteristics@@YAJPEAV?$CSimpleArray@PEAVCConnectorProcessingModeCharacteristics@@V?$CSimpleArrayEqualHelper@PEAVCConnectorProcessingModeCharacteristics@@@ATL@@@ATL@@PEAKPEAPEAE@Z @ 0x18008A0AC
 * Callers:
          ...
          if ( *(int *)(v15 + 24) > 0 )
          {
            ...
            while ( 1 )
            {
              ...
              *v29 = *((_DWORD *)v20 + 6);
              v30 = v28 - 4;
              v31 = v29 + 1;
              if ( v30 < (unsigned __int64)*((unsigned __int16 *)*v20 + 8) + 18 )
                goto LABEL_8;
              memcpy_0(v31, *v20, *((unsigned __int16 *)*v20 + 8) + 18LL);
              v11 = -18 - *((unsigned __int16 *)*v20 + 8) + v30;
              v12 = (__int64)v31 + *((unsigned __int16 *)*v20 + 8) + 18;
              v17 = (_DWORD)pv + 1;
              LODWORD(pv) = v17;
              v18 = v15 + 16;
