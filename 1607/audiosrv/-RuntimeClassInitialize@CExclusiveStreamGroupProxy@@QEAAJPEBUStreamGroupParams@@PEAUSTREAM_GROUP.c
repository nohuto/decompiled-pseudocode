/*
 * XREFs of ?RuntimeClassInitialize@CExclusiveStreamGroupProxy@@QEAAJPEBUStreamGroupParams@@PEAUSTREAM_GROUP_DESCRIPTOR@@K@Z @ 0x18007581C
 * Callers:
        ...
        int a4)
{
  ...
  if ( Instance < 0
    ...
    || (Microsoft::WRL::ComPtr<IStreamGroup>::operator=((__int64 *)this + 9, (__int64)pProxy[0]),
        Instance = CBaseStreamGroupProxy::RuntimeClassInitialize((void **)this + 1, a2, a4),
        Instance < 0) )
  {
    if ( WPP_GLOBAL_Control != (CAudioSession *)&WPP_GLOBAL_Control
      && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x100) != 0
