...
LABEL_13:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSession *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x15u, (__int64)&WPP_ae0e5f86dcf339e9416e2a34673eb067_Traceguids, v7);
  }
  return v7;
}
