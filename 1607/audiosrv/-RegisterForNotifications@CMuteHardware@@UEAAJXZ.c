/*
 * XREFs of ?RegisterForNotifications@CMuteHardware@@UEAAJXZ @ 0x180025F50
 * Callers:
...
__int64 __fastcall CMuteHardware::RegisterForNotifications(CMuteHardware *this)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_5d80dfde78b839f7e098599d7a4ea935_Traceguids, this);
  }
  ...
  v3 = v2;
  if ( v2 < 0 )
    AudSrvTraceLoggingErrorHelper("CMuteHardware::RegisterForNotifications", 0x1E2u, v2);
  else
    *((_DWORD *)this + 14) = 1;
  return v3;
}
