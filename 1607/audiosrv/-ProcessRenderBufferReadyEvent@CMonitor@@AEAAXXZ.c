/*
 * XREFs of ?ProcessRenderBufferReadyEvent@CMonitor@@AEAAXXZ @ 0x180034C10
 * Callers:
...
void __fastcall CMonitor::ProcessRenderBufferReadyEvent(CMonitor *this)
{
  ...
  LPCRITICAL_SECTION v30; // [rsp+80h] [rbp-78h] BYREF
  ...
  v27[1] = (void *)-2LL;
  v1 = this;
  ATL::CCritSecLock::CCritSecLock((ATL::CCritSecLock *)&v30, (struct _RTL_CRITICAL_SECTION *)((char *)this + 392));
  v2 = (*(__int64 (__fastcall **)(_QWORD, int *))(**((_QWORD **)v1 + 22) + 48LL))(*((_QWORD *)v1 + 22), &v33);
  if ( v2 < 0 )
  {
LABEL_2:
    if ( v31 )
      ATL::CCritSecLock::Unlock(&v30);
    goto LABEL_7;
  }
  if ( !*((_QWORD *)v1 + 45) )
  {
