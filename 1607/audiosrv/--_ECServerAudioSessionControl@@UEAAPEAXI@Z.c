/*
 * XREFs of ??_ECServerAudioSessionControl@@UEAAPEAXI@Z @ 0x18000F1FC
 * Callers:
 *     ??_ECServerAudioSessionControl@@W7EAAPEAXI@Z @ 0x180039200 (--_ECServerAudioSessionControl@@W7EAAPEAXI@Z.c)
 * Callees:
