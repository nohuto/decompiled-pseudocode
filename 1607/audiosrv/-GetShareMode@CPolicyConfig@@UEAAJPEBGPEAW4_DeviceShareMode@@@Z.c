/*
 * XREFs of ?GetShareMode@CPolicyConfig@@UEAAJPEBGPEAW4_DeviceShareMode@@@Z @ 0x18006B9B0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _DeviceShareMode *a3)
{
  ...
  if ( PropertyStoreProperty < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetShareMode", 3454, PropertyStoreProperty);
  if ( v7 )
