/*
 * XREFs of ?ConnectorSupportsFormat@@YAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@@Z @ 0x180067EC0
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  PROPVARIANT v23; // [rsp+A0h] [rbp-68h] BYREF
  ...
  _DWORD v33[6]; // [rsp+100h] [rbp-8h] BYREF
