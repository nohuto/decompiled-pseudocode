/*
 * XREFs of ?HandleDeviceAccess@@YAJPEAXPEBG1_N@Z @ 0x180063EF8
 * Callers:
 *     s_GrantDeviceAccessForPackage @ 0x180064320 (s_GrantDeviceAccessForPackage.c)
 *     s_RevokeDeviceAccessForPackage @ 0x180064330 (s_RevokeDeviceAccessForPackage.c)
 * Callees:
 ...
 *     ?GetTokenInformation@@YAKPEAXPEAPEAGPEAK12@Z @ 0x1800528AC (-GetTokenInformation@@YAKPEAXPEAPEAGPEAK12@Z.c)
