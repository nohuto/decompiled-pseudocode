/*
 * XREFs of ??$FindFirstMatchingPreferredFormat@V_lambda_353b87aafb6929f0b8cf31fbc22c501a_@@@CEndpointCharacteristics@@AEAAJPEAUWAVEFORMATEXTENSIBLE@@V_lambda_353b87aafb6929f0b8cf31fbc22c501a_@@@Z @ 0x1800852FC
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::FindFirstMatchingPreferredFormat<_lambda_353b87aafb6929f0b8cf31fbc22c501a_>(
        __int64 a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  while ( 1 )
  {
    ...
    *(_WORD *)(a2 + 16) = 22;
    ...
    if ( v17 < 0 )
      break;
    if ( v19
      && lambda_ea783823a3a088a32542d9fbc7fb427f_::operator()((__int64)(a3 + 3), (const struct tWAVEFORMATEX *)a2) )
    {
