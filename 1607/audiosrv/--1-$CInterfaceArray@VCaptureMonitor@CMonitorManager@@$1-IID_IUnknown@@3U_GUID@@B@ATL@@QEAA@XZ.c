/*
 * XREFs of ??1?$CInterfaceArray@VCaptureMonitor@CMonitorManager@@$1?IID_IUnknown@@3U_GUID@@B@ATL@@QEAA@XZ @ 0x18007AF84
 * Callers:
 *     _CMonitorManager::DoHandleDefaultDeviceChanged_::_1_::dtor$3 @ 0x18007C13B (_CMonitorManager--DoHandleDefaultDeviceChanged_--_1_--dtor$3.c)
 * Callees:
