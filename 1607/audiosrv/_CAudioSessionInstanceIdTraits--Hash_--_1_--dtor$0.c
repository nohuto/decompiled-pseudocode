/*
 * XREFs of _CAudioSessionInstanceIdTraits::Hash_::_1_::dtor$0 @ 0x18003C52B
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceIdTraits::Hash_::_1_::dtor_0(__int64 a1, __int64 a2)
{
