/*
 * XREFs of _dynamic_initializer_for__std::_Error_objects_int_::_Iostream_object__ @ 0x180001010
 * Callers:
 *     <none>
 * Callees:
 *     ??0_Iostream_error_category@std@@QEAA@XZ @ 0x1800349F4 (--0_Iostream_error_category@std@@QEAA@XZ.c)
 */
