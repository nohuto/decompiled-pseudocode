/*
 * XREFs of ?Initialize@CVolumeSoftware@@UEAAJPEAUIMMDevice@@@Z @ 0x180056D40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IMMDevice *a2)
{
  ...
  struct IPolicyConfig *v11; // [rsp+78h] [rbp+38h] BYREF

  GetFormFactor(a2, this + 62);
  v11 = 0LL;
  ...
  {
    pv = 0LL;
    PolicyConfig = (*(__int64 (__fastcall **)(struct IPolicyConfig *, LPVOID, _QWORD, LPVOID *))(*(_QWORD *)v11 + 32LL))(
                     v11,
                     v10,
                     0LL,
                     &pv);
