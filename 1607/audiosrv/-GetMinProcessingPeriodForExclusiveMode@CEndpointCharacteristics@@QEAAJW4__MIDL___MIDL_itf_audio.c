/*
 * XREFs of ?GetMinProcessingPeriodForExclusiveMode@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@PEA_J@Z @ 0x18001BE80
 * Callers:
        ...
        __int64 *a5)
{
  ...
  *a5 = 30000LL;
  v10 = (__int128)*a4;
  if ( (int)CEndpointCharacteristics::GetSharedModeEnginePeriodicity((__int64)this, 0, a3, &v10, 0, 0LL, 0LL, &v11, 0LL) >= 0 )
  {
    v7 = *v5;
