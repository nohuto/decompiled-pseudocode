/*
 * XREFs of ?InitializeSystemEffectsInterface@@YAJPEAUIMMDevice@@PEAUIAudioProcessingObject@@PEAU_GUID@@U3@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x18008D170
 * Callers:
...
LABEL_16:
  ...
  if ( (Microsoft_Windows_AudioEnableBits & 0x200) != 0 )
  {
    ...
    if ( v19 )
      v16 = a4;
    Template_jjt(v19, a5 & (unsigned int)-(v19 != 0LL), a3, v16, v19 != 0LL && a5);
  }
  if ( a7 )
  {
    v17 = v19;
