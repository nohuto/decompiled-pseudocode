/*
 * XREFs of ?IsDriverVolumeLimitTrackingSupported@CEndpointCharacteristics@@UEAAHXZ @ 0x1800899A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEndpointCharacteristics::IsDriverVolumeLimitTrackingSupported(CEndpointCharacteristics *this)
{
  ...
  _OWORD v15[3]; // [rsp+80h] [rbp+27h] BYREF
  unsigned __int16 v16; // [rsp+C0h] [rbp+67h] BYREF
  ...
  *((_DWORD *)this + 98) = 0;
    ...
    && (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v8 + 64LL))(v8, &v10) >= 0 )
  {
    ...
    if ( v3 < 0 )
      goto LABEL_16;
    v5 = (*(__int64 (__fastcall **)(__int64, unsigned __int16 *))(*(_QWORD *)v7 + 32LL))(v7, &v16);
    v4 = v7;
    if ( v5 < 0 )
      goto LABEL_16;
           ...
           &v12) >= 0 )
    {
      ...
      DWORD2(v15[1]) = v16;
      v15[0] = GUID_45ffaaa0_6e1b_11d0_bcf2_444553540000;
      *(_QWORD *)&v15[1] = 0x20000000039LL;
      if ( (*(int (__fastcall **)(__int64, _OWORD *, __int64, unsigned __int8 *, int, int *))(*(_QWORD *)v12 + 24LL))(
             v12,
             v15,
             32LL,
             &v18,
