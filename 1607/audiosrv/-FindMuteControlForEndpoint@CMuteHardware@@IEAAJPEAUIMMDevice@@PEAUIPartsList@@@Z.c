/*
 * XREFs of ?FindMuteControlForEndpoint@CMuteHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x180026040
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_5d80dfde78b839f7e098599d7a4ea935_Traceguids, this);
    v6 = v16;
  }
  if ( a2 )
  {
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (CAudioSession *)&WPP_GLOBAL_Control )
        {
          ...
          if ( v8 != (CAudioSession *)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v8 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v8 + 2), 16LL, &WPP_5d80dfde78b839f7e098599d7a4ea935_Traceguids, this);
          }
        }
