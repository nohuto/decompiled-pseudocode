/*
 * XREFs of ?FixupProcessingModeSupport@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@HH@Z @ 0x18002E1D0
 * Callers:
        ...
        int a4)
{
  ...
  __int64 v28; // rax
  struct _tagpropertykey v29; // [rsp+30h] [rbp-20h] BYREF
...
LABEL_17:
  ...
  if ( *((int *)this + 4 * v8 + 38) > 0 )
  {
    ...
    v24 = (__int64 *)((char *)this + 16 * v8 + 208);
    while ( 1 )
    {
      v25 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[]((__int64)v23, v21);
      if ( (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find(v24, v25) == -1 )
      {
        v28 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[]((__int64)v23, v21);
        if ( !(unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Add(v24, v28) )
          break;
      }
