/*
 * XREFs of Usbh_SetPdoEXT_PROPERTY_INSTALLED @ 0x1C004CEC0
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_SetPdoEXT_PROPERTY_INSTALLED(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4)
{
  _UNKNOWN **result; // rax
  int v5; // ebx
