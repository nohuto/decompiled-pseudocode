/*
 * XREFs of UsbhPdo_ReportPnPFailureProblem @ 0x1C0055058
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x1C0053B58 (RtlUnalignedStringCbLengthW.c)
 */
...
void __fastcall UsbhPdo_ReportPnPFailureProblem(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v8[699] )
  {
    LODWORD(pcbLength) = PdoExt((__int64)DeviceObject, v5, v6, v7)[699];
    UsbhSetPdoRegistryParameter(DeviceObject, L"EnumerationFailureCode", 4u, &pcbLength, 4u);
    if ( RtlFindMessage(WPP_MAIN_CB.Queue.ListEntry.Blink[1].Blink, 0xBu, 0, v8[699], &v14) >= 0
      && RtlUnalignedStringCbLengthW((STRSAFE_PCUNZWCH)v14->Text, v14->Length - 4, &pcbLength) >= 0 )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        LODWORD(MessageResourceEntry) = v8[699];
