/*
 * XREFs of UsbhPCE_Enable @ 0x1C00289D8
 * Callers:
...
int *__fastcall UsbhPCE_Enable(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_d(
      ...
      v4);
  Log((__int64)a1, 512, 1346711601, 0LL, v4);
