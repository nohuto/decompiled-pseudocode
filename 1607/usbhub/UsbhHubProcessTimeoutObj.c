/*
 * XREFs of UsbhHubProcessTimeoutObj @ 0x1C0040C70
 * Callers:
...
__int64 __fastcall UsbhHubProcessTimeoutObj(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  KSPIN_LOCK *v8; // rax
  unsigned int v9; // ebp
  KSPIN_LOCK *v10; // r15
  ...
  v8 = (KSPIN_LOCK *)FdoExt((__int64)a1, a2, a3, (__int64)a4);
