/*
 * XREFs of UsbhSetPortPower @ 0x1C003CE24
 * Callers:
...
__int64 __fastcall UsbhSetPortPower(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int16 v13; // [rsp+5Ch] [rbp-24h]
  __int16 v14; // [rsp+5Eh] [rbp-22h]
  ...
  *(_DWORD *)&v15[1] = 0;
  ...
  v16 = 3;
  v13 = v4;
  v6 = (int)UsbhSyncSendCommand(a1, (__int64)&v12, 0LL, &v15[2], v9, &v11);
  Log(a1, 8, 1886416945, v6, v11);
