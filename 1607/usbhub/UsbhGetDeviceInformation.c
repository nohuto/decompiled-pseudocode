/*
 * XREFs of UsbhGetDeviceInformation @ 0x1C0007814
 * Callers:
 *     UsbhSetupDevice @ 0x1C0005530 (UsbhSetupDevice.c)
 *     UsbhGetAlternateUsbDescriptors @ 0x1C0043894 (UsbhGetAlternateUsbDescriptors.c)
 * Callees:
 *     UsbhValidateConfigurationDescriptor @ 0x1C00079FC (UsbhValidateConfigurationDescriptor.c)
...
LABEL_6:
  ...
  else
  {
    ...
    if ( (unsigned __int8)UsbhValidateConfigurationDescriptor(v8, Size, v25, dword_1C0067630 != 0) )
    {
      ...
      else
      {
        ...
        if ( v15 )
        {
          ...
          *(_QWORD *)(v4 + 2408) = *(_QWORD *)v16;
          *(_BYTE *)(v4 + 2416) = *(_BYTE *)(v16 + 8);
        }
      }
