/*
 * XREFs of UsbhPortResumeTimeout @ 0x1C0044354
 * Callers:
...
__int64 __fastcall UsbhPortResumeTimeout(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( Usb_Disconnected(v10) )
    return v11;
  LOBYTE(v32) = 0;
  UsbhException((int)DeviceObject, *(unsigned __int16 *)(a3 + 4), 124, 0, 0, v11, v34, usbfile_bus_c, 7348, v32);
  ...
  if ( v13 )
  {
    ...
    else
    {
      ...
      if ( (v19 & 0xC0000000) == 0xC0000000 )
      {
        ...
        LOBYTE(v33) = 0;
        v27[353] &= ~0x4000u;
        UsbhException((int)DeviceObject, 0, 125, 0, 0, v23, 0, usbfile_bus_c, 7408, v33);
      }
      else
      {
