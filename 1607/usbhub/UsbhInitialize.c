/*
 * XREFs of UsbhInitialize @ 0x1C0019A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhInitialize(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (HubCount & 0xC0000000) == 0xC0000000 )
  {
    ...
    v27 = 5491;
LABEL_40:
    UsbhLogStartFailure((int)a1, HubCount, 3, v27, (__int64)"onecore\\drivers\\wdm\\usb\\hub\\usbhub\\hub.c", Src);
    return HubCount;
  }
  if ( v28 <= 6 )
  {
    HubCount = UsbhGetHubDeviceInformation((__int64)a1, a2);
    if ( (HubCount & 0xC0000000) == 0xC0000000 )
    {
...
LABEL_28:
        ...
        if ( (v7[640] & 0x40) != 0
          && (ExtendedHubInformation = UsbhInitializeTtHub((__int64)a1, a2),
