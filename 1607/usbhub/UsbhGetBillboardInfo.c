/*
 * XREFs of UsbhGetBillboardInfo @ 0x1C0043A00
 * Callers:
...
__int64 __fastcall UsbhGetBillboardInfo(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( PoolWithTag )
  {
    ...
    if ( *(_BYTE *)(a3 + 3) )
    {
      ...
      {
        LOBYTE(v20) = 0;
        UsbhException(a1, *((unsigned __int16 *)v7 + 710), 38, (int)v9, v15, v10, v21[0], usbfile_bus_c, 7556, v20);
        v13 = 4678195;
        goto LABEL_5;
      }
    }
    for ( i = 0; i < *(_BYTE *)(a3 + 4); ++i )
    {
      if ( *(_BYTE *)(a3 + 4LL * i + 47) )
      {
        ...
        {
          LOBYTE(v20) = 0;
          UsbhException(a1, *((unsigned __int16 *)v7 + 710), 141, (int)v9, v22, v17, v21[0], usbfile_bus_c, 7581, v20);
          v13 = 4678196;
LABEL_5:
        ...
        {
          LOBYTE(v20) = 0;
          UsbhException(a1, *((unsigned __int16 *)v7 + 710), 38, (int)v9, v22, v10, v21[0], usbfile_bus_c, 7593, v20);
          v13 = 4678197;
          goto LABEL_5;
        }
      }
