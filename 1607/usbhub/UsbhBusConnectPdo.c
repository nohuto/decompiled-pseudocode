/*
 * XREFs of UsbhBusConnectPdo @ 0x1C0021174
 * Callers:
  ...
  *(_QWORD *)(v2 + 24) = KeGetCurrentThread();
  ...
  if ( v8 )
  {
    ...
    if ( (_DWORD)v9 != 3 )
    {
      ...
      *((_QWORD *)v13 + 602) = v22;
      LOBYTE(v22) = 1;
      UsbhEtwLogDeviceInformation((__int64)v17, &USBHUB_ETW_EVENT_DEVICE_ADD, (__int64)v22, v20);
      SET_PDO_HWPNPSTATE(v8, 2LL, 2LL, v23);
      v13[226] = 1;
      *(_DWORD *)(v2 + 136) = 0;
      ...
      *(_DWORD *)(v2 + 88) = 1734964085;
      ...
      if ( (v17[353] & 0x100) != 0 )
      {
        if ( !LOWORD(v25->DeviceType) )
          goto LABEL_10;
        WPP_RECORDER_SF_(v25->DeviceExtension, 0, 1, 44, (__int64)&WPP_aa88946eb7ae3adf49862ed4f4bccb5e_Traceguids);
        v25 = WPP_GLOBAL_Control;
      }
      if ( LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_(v25->DeviceExtension, 0, 1, 45, (__int64)&WPP_aa88946eb7ae3adf49862ed4f4bccb5e_Traceguids);
        v25 = WPP_GLOBAL_Control;
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
        {
          WPP_RECORDER_SF_d(
...
LABEL_10:
      if ( *((_QWORD *)v17 + 260) && LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v25->DeviceExtension,
          0,
      ...
      if ( *((_QWORD *)v17 + 262) && LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v25->DeviceExtension,
          0,
      ...
      if ( *((_QWORD *)v17 + 264) && LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v25->DeviceExtension,
          0,
      ...
      if ( *((_QWORD *)v17 + 268) && LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v25->DeviceExtension,
          0,
      ...
      if ( *((_QWORD *)v17 + 266) && LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v25->DeviceExtension,
          0,
...
LABEL_25:
      ...
      if ( LOWORD(v25->DeviceType) )
      {
        WPP_RECORDER_SF_(v25->DeviceExtension, 0, 1, 67, (__int64)&WPP_aa88946eb7ae3adf49862ed4f4bccb5e_Traceguids);
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          WPP_RECORDER_SF_(
            WPP_GLOBAL_Control->DeviceExtension,
            0,
