/*
 * XREFs of UsbhPdoWaitForD3Reconnect @ 0x1C0046760
 * Callers:
...
LONG __fastcall UsbhPdoWaitForD3Reconnect(PDEVICE_OBJECT DeviceObject, PDEVICE_OBJECT a2, __int64 a3, __int64 a4)
{
  char v6; // r15
  int v7; // edi
  _DWORD *v8; // rax
  ...
  {
    v6 = 1;
    v7 = UsbhWaitEventWithTimeoutEx(DeviceObject, v8 + 722, v8[734], 1684222788, 0, 0LL);
  }
