/*
 * XREFs of WPP_RECORDER_SF_sdsd @ 0x1C003DAA8
 * Callers:
...
__int64 WPP_RECORDER_SF_sdsd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const char *a6, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_769f670b4daf3a39507e1b81909708b8_Traceguids,
      20LL,
      v15,
      v14,
      (__int64 *)va,
  ...
  if ( a6 )
    v6 = a6;
  LOWORD(v18) = 20;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_769f670b4daf3a39507e1b81909708b8_Traceguids, v18, v6);
}
