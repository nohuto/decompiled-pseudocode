/*
 * XREFs of UsbhPdoPnp_QueryDeviceText @ 0x1C001B820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_QueryDeviceText(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  if ( Length )
  {
    if ( Length == 1 )
    {
      ...
      {
        WPP_RECORDER_SF_(v14->DeviceExtension, 0, 1, 19, (__int64)&WPP_eedbca65ee47349068ca6cb62991bd41_Traceguids);
        v14 = WPP_GLOBAL_Control;
      }
      if ( !v11[555] )
      {
  ...
  else
  {
    if ( LOWORD(v14->DeviceType) )
    {
      WPP_RECORDER_SF_(v14->DeviceExtension, 0, 1, 20, (__int64)&WPP_eedbca65ee47349068ca6cb62991bd41_Traceguids);
      v14 = WPP_GLOBAL_Control;
    }
...
LABEL_26:
  if ( LOWORD(v14->DeviceType) )
    WPP_RECORDER_SF_d(v14->DeviceExtension, 0, 1, 22, (__int64)&WPP_eedbca65ee47349068ca6cb62991bd41_Traceguids, Status);
LABEL_19:
