/*
 * XREFs of WPP_RECORDER_SF_qDD @ 0x1C0055618
 * Callers:
...
__int64 WPP_RECORDER_SF_qDD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_eedbca65ee47349068ca6cb62991bd41_Traceguids,
      18LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 18;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_eedbca65ee47349068ca6cb62991bd41_Traceguids, v7, (__int64 *)va);
}
