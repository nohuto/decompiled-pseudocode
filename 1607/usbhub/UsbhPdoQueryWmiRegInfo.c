/*
 * XREFs of UsbhPdoQueryWmiRegInfo @ 0x1C0027580
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  *v10 = DeviceObject;
  ...
  {
    v12 = 80;
    if ( IoGetDeviceProperty(DeviceObject, DevicePropertyDeviceDescription, 0x50u, (char *)v9 + 2418, &BufferLength) != -1073741789 )
      return 0LL;
