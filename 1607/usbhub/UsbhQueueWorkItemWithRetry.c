/*
 * XREFs of UsbhQueueWorkItemWithRetry @ 0x1C0023E60
 * Callers:
 ...
 *     UsbhIsrRetryTimer @ 0x1C0044210 (UsbhIsrRetryTimer.c)
 *     UsbhResetIrqPipeRetryTimer @ 0x1C0044670 (UsbhResetIrqPipeRetryTimer.c)
 *     UsbHubhInitTimeoutTimer @ 0x1C004B170 (UsbHubhInitTimeoutTimer.c)
 *     UsbhInitRetryTimer @ 0x1C004BCA0 (UsbhInitRetryTimer.c)
 *     UsbhIdleIrpRetryTimer @ 0x1C0055870 (UsbhIdleIrpRetryTimer.c)
 *     UsbhIdleIrp_NoIrp @ 0x1C0055DA0 (UsbhIdleIrp_NoIrp.c)
 *     UsbhSS_WakeIrpRetryTimer @ 0x1C0056650 (UsbhSS_WakeIrpRetryTimer.c)
 * Callees:
        ...
        unsigned int a7)
{
  ...
  __int64 v32; // rcx
  __int64 v33; // rax
  void (__fastcall *v34)(__int64, _QWORD, __int64 (__fastcall *(__fastcall *)(__int64, __int64, __int64, __int64))(__int64), _QWORD, _DWORD *, int); // rax
  int v35; // edx
...
LABEL_60:
  ...
  *((_QWORD *)v19 + 3) = a3;
  ...
  v34 = *(void (__fastcall **)(__int64, _QWORD, __int64 (__fastcall *(__fastcall *)(__int64, __int64, __int64, __int64))(__int64), _QWORD, _DWORD *, int))(v33 + 4784);
  if ( v34 )
  {
    LOBYTE(v37) = v38;
