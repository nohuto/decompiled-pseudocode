/*
 * XREFs of UsbhBuildContainerID @ 0x1C0027E9C
 * Callers:
 ...
 *     RtlStringCbCatW @ 0x1C00282EC (RtlStringCbCatW.c)
...
LABEL_57:
  ...
  if ( pcbResult[0] == 4 && pbOutput >= 0x10 )
  {
    ...
    if ( v24 )
    {
      ...
      if ( Property >= 0 )
      {
        *(_OWORD *)(v9 + 673) = *(_OWORD *)v3;
        *((_WORD *)v9 + 1349) = *((_WORD *)v9 + 1349) & 0xFFF | 0x5000;
        *((_BYTE *)v9 + 2700) = v9[675] & 0x3F | 0x80;
        *((_BYTE *)v9 + 2708) = 1;
      }
      goto LABEL_31;
    }
