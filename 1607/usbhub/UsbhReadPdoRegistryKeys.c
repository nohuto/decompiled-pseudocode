/*
 * XREFs of UsbhReadPdoRegistryKeys @ 0x1C0008DB0
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( v24 == 1 )
      {
        for ( i = 8; ; i = v17 )
        {
          ...
          LOBYTE(v18) = *v3;
          if ( (UsbhGetPdoRegistryParameter(a2, *(const WCHAR **)(v3 - 12), v15, i, &v24, &v25, v18) & 0xC0000000) == 0xC0000000 )
            goto LABEL_18;
          if ( v24 != 1 )
            goto LABEL_18;
          v17 = v25;
