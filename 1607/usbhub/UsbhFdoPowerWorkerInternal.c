/*
 * XREFs of UsbhFdoPowerWorkerInternal @ 0x1C001E220
 * Callers:
 *     UsbhFdoPower @ 0x1C001E1F0 (UsbhFdoPower.c)
 *     UsbhFdoPowerWorker @ 0x1C0045ED0 (UsbhFdoPowerWorker.c)
 * Callees:
...
NTSTATUS __fastcall UsbhFdoPowerWorkerInternal(struct _DEVICE_OBJECT *a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  *((_DWORD *)DeviceExtension + 4) = (unsigned __int8)v9;
  ...
  if ( v12 < 4u )
    return off_1C0059CD8[2 * v12](a1, a2);
