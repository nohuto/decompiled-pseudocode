/*
 * XREFs of Usbh_PCE_SoftDisconnect_Action @ 0x1C0042914
 * Callers:
...
void __fastcall Usbh_PCE_SoftDisconnect_Action(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // rbx
  __int64 v8; // r8
  __int64 v9; // r9
  ...
  v7 = (int)UsbhLockPcqWithTag((__int64)a1, a2, 8, &v20, 0);
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_dq(
      ...
      *(unsigned __int16 *)(a2 + 4),
      a2);
  Log((__int64)a1, 512, 1597534256, v7, *(unsigned __int16 *)(a2 + 4));
  if ( (int)v7 <= 11 )
  {
    ...
    if ( (int)v7 > 1 )
    {
      if ( (int)v7 > 4 )
      {
        ...
        if ( (_DWORD)v7 != 6 )
        {
          if ( (_DWORD)v7 == 7 )
          {
            Log((__int64)a1, 512, 1597534257, v9, *(unsigned __int16 *)(a2 + 4));
            v13 = v20;
            v14 = 32LL * *(unsigned int *)(a2 + 2400);
            *(_DWORD *)(a2 + 400) = 0;
            *(_DWORD *)(a2 + 12) = v15;
            *(_DWORD *)(v14 + a2 + 1384) = v15;
            UsbhUnlockPcqWithTag((__int64)a1, a2, v13, 0);
            v12 = 20LL;
            goto LABEL_12;
          }
LABEL_11:
          Log((__int64)a1, 512, 1597534261, v9, *(unsigned __int16 *)(a2 + 4));
          UsbhFlushPortChangeQueue((__int64)a1, a2, v10, v11);
          UsbhUnlockPcqWithTag((__int64)a1, a2, v20, 0);
          v12 = 23LL;
LABEL_12:
...
LABEL_21:
        Log((__int64)a1, 512, 1597534258, v9, *(unsigned __int16 *)(a2 + 4));
        UsbhUnlockPcqWithTag((__int64)a1, a2, v20, 0);
        v12 = 21LL;
        goto LABEL_12;
      }
...
LABEL_20:
    ...
    *(_DWORD *)(32 * v16 + a2 + 1384) = 19;
    UsbhUnlockPcqWithTag((__int64)a1, a2, v17, 0);
    return;
  }
  if ( (int)v7 <= 13 )
    goto LABEL_11;
...
LABEL_22:
  Log((__int64)a1, 512, 1597534259, v9, *(unsigned __int16 *)(a2 + 4));
  UsbhUnlockPcqWithTag((__int64)a1, a2, v20, 0);
  UsbhPCE_Disable(a1, *(unsigned __int16 *)(a2 + 4), a3, v18);
  Log((__int64)a1, 512, 1597534260, a3, *(unsigned __int16 *)(a2 + 4));
