/*
 * XREFs of UsbhPdoPnp_QueryId @ 0x1C0017FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_28:
  ...
  else
  {
    ...
    {
      v21 = PdoExt(a1);
      v22 = (_QWORD *)UsbhIncHubBusy(*(PDEVICE_OBJECT *)(v7 + 1176), v21 + 944, a1, 1346728819LL, 1);
      KeWaitForSingleObject((PVOID)(v7 + 2864), Executive, 0, 0, 0LL);
      UsbhPdoPnp_EnablePdo(a1);
      KeSetEvent((PRKEVENT)(v7 + 2864), 0, 0);
      PdoExt(a1);
      UsbhDecHubBusy(*(_QWORD *)(v7 + 1176), v23, v22, v24);
    }
    v15 = v7 + 2072;
  }
  if ( !v15 )
