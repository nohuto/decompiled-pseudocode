/*
 * XREFs of UsbhReset1DropDevice @ 0x1C00515D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhReset1DropDevice(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rdx
  __int64 v7; // r8
  __int64 v8; // r9
  ...
  Log((__int64)a1, 1024, 1884443492, a2, 0LL);
