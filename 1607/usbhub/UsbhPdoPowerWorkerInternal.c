/*
 * XREFs of UsbhPdoPowerWorkerInternal @ 0x1C001ABD8
 * Callers:
 *     UsbhPdoPower @ 0x1C001ACB0 (UsbhPdoPower.c)
 *     UsbhPdoPowerWorker @ 0x1C00466E0 (UsbhPdoPowerWorker.c)
 * Callees:
...
LABEL_12:
  ...
  return (unsigned int)off_1C0059C98[2 * v15](a1, (ULONG_PTR)a2);
}
