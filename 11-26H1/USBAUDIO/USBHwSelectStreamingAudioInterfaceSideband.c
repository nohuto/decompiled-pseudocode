/*
 * XREFs of USBHwSelectStreamingAudioInterfaceSideband @ 0x140035C6C
 * Callers:
 ...
 *     USBD_GetEndpointOffloadInformationForIndex @ 0x14001A24C (USBD_GetEndpointOffloadInformationForIndex.c)
