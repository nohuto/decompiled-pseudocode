/*
 * XREFs of RegistryInitProductNameKey @ 0x1400344B8
 * Callers:
 *     FilterInitComponentId @ 0x14003081C (FilterInitComponentId.c)
 * Callees:
 *     RegistryCreateMediaCategoriesKey @ 0x140033EFC (RegistryCreateMediaCategoriesKey.c)
 */
