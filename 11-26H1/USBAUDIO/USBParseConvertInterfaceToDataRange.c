/*
 * XREFs of USBParseConvertInterfaceToDataRange @ 0x140036C4C
 * Callers:
 *     USBParseGetAudioStreamingDataranges @ 0x14003B6E4 (USBParseGetAudioStreamingDataranges.c)
 * Callees:
 *     IsAudioStreamValid @ 0x14000DCDC (IsAudioStreamValid.c)
...
LABEL_50:
          ...
          if ( v32 )
          {
            ...
            *(_DWORD *)(a3 + 108) = v33;
            ...
            {
              *(_DWORD *)(a3 + 80) = v32[3] + ((v32[4] + (v32[5] << 8)) << 8);
            }
            return v3;
          }
          return 3221225628LL;
      ...
      v34 = IsAudioStreamValid((__int64)v10, *v10, 8uLL, *(_WORD *)(v8 + 5) & 0xF000, v29);
      v32 = v10 + 8;
      if ( !v34 )
        v32 = 0LL;
      v33 = v10[7];
