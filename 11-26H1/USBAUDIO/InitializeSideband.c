/*
 * XREFs of InitializeSideband @ 0x14000EDBC
 * Callers:
 ...
 *     ??0CSidebandDevice@@QEAA@PEAU_KSDEVICE@@PEAUIUnknown@@@Z @ 0x14000F2EC (--0CSidebandDevice@@QEAA@PEAU_KSDEVICE@@PEAUIUnknown@@@Z.c)
