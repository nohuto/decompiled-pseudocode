/*
 * XREFs of USBMIDICreateEventPackets @ 0x14003C994
 * Callers:
 ...
 *     USBMidiOutCreateFirstByte @ 0x14003EC30 (USBMidiOutCreateFirstByte.c)
 *     USBMidiOutCreateSecondByte @ 0x14003ED30 (USBMidiOutCreateSecondByte.c)
 *     USBMidiOutCreateThirdByte @ 0x14003EF90 (USBMidiOutCreateThirdByte.c)
 */
    ...
    do
    {
      ...
      if ( v18 || v19 )
        WPP_RECORDER_AND_TRACE_SF_DDDD(
          ...
          v22,
          v23,
          (__int64)&WPP_e0d5aff66fb93a5753954193075604a1_Traceguids);
      if ( v10 )
        v11 = 0;
      else
        *(_DWORD *)(v9 + 76) = *v6;
