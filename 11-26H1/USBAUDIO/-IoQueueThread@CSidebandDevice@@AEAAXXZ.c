/*
 * XREFs of ?IoQueueThread@CSidebandDevice@@AEAAXXZ @ 0x140006434
 * Callers:
 *     ?staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z @ 0x140014D20 (-staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z.c)
 * Callees:
