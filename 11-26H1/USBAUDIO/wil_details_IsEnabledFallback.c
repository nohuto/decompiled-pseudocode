/*
 * XREFs of wil_details_IsEnabledFallback @ 0x14000D3B0
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x14000D210 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
