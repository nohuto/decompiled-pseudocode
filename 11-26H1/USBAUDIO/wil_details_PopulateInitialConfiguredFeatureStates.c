/*
 * XREFs of wil_details_PopulateInitialConfiguredFeatureStates @ 0x14004313C
 * Callers:
 ...
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1400300C8 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
...
_BYTE *wil_details_PopulateInitialConfiguredFeatureStates()
{
  ...
  for ( i = &wil_details_featureDescriptors_a; ; i = v6 + 56 )
  {
    ...
    else
    {
      v1 = result[28];
      v2 = v1 != 3 && v1 != 2;
      v3 = ((__int64 (__fastcall *)(_QWORD, _BOOL8, __int64 *, __int64 *, __int64))RtlQueryFeatureConfiguration)(
             *((unsigned int *)v6 + 6),
             v2,
             &v8,
             &v9,
