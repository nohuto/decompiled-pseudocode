/*
 * XREFs of USBD_QueryUsbCapability @ 0x14001A27C
 * Callers:
 *     USBHwGetOffloadCapability @ 0x140035788 (USBHwGetOffloadCapability.c)
 * Callees:
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1400198E0 (USBDInternal_BuildandSendIoctlSynchronously.c)
