/*
 * XREFs of USBD_CreateHandle @ 0x140019E3C
 * Callers:
 ...
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1400195EC (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
