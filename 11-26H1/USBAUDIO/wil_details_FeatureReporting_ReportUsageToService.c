/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToService @ 0x14000CFA0
 * Callers:
 ...
 *     wil_details_MapReportingKind @ 0x14000D444 (wil_details_MapReportingKind.c)
        ...
        __int64 a3))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    {
      v8 = 0;
      return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))g_wil_details_pfnFeatureLoggingHook(38679741LL, &Feature_MIDI2_logged_traits, 0LL, v3, &v9, 0LL, v8, 1LL);
    }
  }
  return result;
}
