/*
 * XREFs of ?IntersectDataFormatsWithDataRange@CSidebandDevice@@AEAAJPEAPEATKSDATAFORMAT@@KPEAU_KSPIN_DESCRIPTOR_EX@@PEAEPEAK3@Z @ 0x14000522C
 * Callers:
...
LABEL_25:
  ...
  if ( (_BYTE)a2 || v10 )
  {
    v18 = &WPP_5beda4ce5be130d4523b4ac6acb25968_Traceguids;
    LOBYTE(v18) = v10;
