/*
 * XREFs of USBDeviceStart @ 0x140040220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     USBHwGetAudioDeviceDescriptor @ 0x14002D600 (USBHwGetAudioDeviceDescriptor.c)
 *     USBHwLogStartFailure @ 0x14002DBCC (USBHwLogStartFailure.c)
 *     USBHwGetUsbBusInterface @ 0x14002DDAC (USBHwGetUsbBusInterface.c)
 *     USBDeviceDescriptorHacks @ 0x140034F3C (USBDeviceDescriptorHacks.c)
 *     USBHwGetAudioConfigurationDescriptor @ 0x1400354A4 (USBHwGetAudioConfigurationDescriptor.c)
 *     USBHwSelectAudioConfiguration @ 0x140035AB0 (USBHwSelectAudioConfiguration.c)
 *     IsLegacyMIDIDevice @ 0x1400369D0 (IsLegacyMIDIDevice.c)
...
__int64 __fastcall USBDeviceStart(__int64 a1)
{
  ...
  if ( UsbBusInterface < 0 )
  {
    ...
    USBHwLogStartFailure(a1, UsbBusInterface, (const char *)v28, 0x20u);
    v6 = Item;
    goto LABEL_43;
  }
  v6 = Item;
  ...
  if ( AudioDeviceDescriptor < 0 )
    goto LABEL_43;
  AudioDeviceDescriptor = USBHwGetAudioDeviceDescriptor(a1, &P);
  if ( AudioDeviceDescriptor < 0 )
  {
...
LABEL_33:
  ...
  v7 = (struct _USB_CONFIGURATION_DESCRIPTOR *)P;
  AudioDeviceDescriptor = KsAddItemToObjectBag(*(KSOBJECT_BAG *)(a1 + 8), P, ExFreePool);
  if ( AudioDeviceDescriptor < 0 )
  {
    v23 = v7;
    goto LABEL_40;
  ...
  *(_QWORD *)(v3 + 40) = v9;
  ...
  if ( !v11 )
  {
    ...
    *(_BYTE *)(v3 + 5) = v19;
    ...
    USBHwLogStartFailure(a1, AudioDeviceDescriptor, (const char *)v28, 0x3Du);
...
LABEL_18:
    v28[1] = v17;
    USBHwLogStartFailure(a1, v18, (const char *)v28, v16);
    goto LABEL_43;
  }
