/*
 * XREFs of PropertyGetProcessControlRange @ 0x140032D58
 * Callers:
 *     TopologyPU3DExtender @ 0x1400310E0 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x1400311D0 (TopologyPUChorus.c)
 *     TopologyPUDynRangeCompressor @ 0x140031350 (TopologyPUDynRangeCompressor.c)
 *     TopologyPUReverb @ 0x1400316D0 (TopologyPUReverb.c)
 * Callees:
