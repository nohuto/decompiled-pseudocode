/*
 * XREFs of PropertyGetDbBasicSupport @ 0x140032450
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PropertyGetDbBasicSupport(IRP *a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v22; // r14
  __int64 v23; // rcx
  const KSNODE_DESCRIPTOR *NodeDescriptors; // [rsp+68h] [rbp+10h]
  ...
  if ( FilterFromIrp )
  {
    v10 = 168LL * *(unsigned int *)(a2 + 24);
    v26 = v10;
    NodeDescriptors = FilterFromIrp->Descriptor->NodeDescriptors;
    v11 = *(_DWORD *)((char *)&NodeDescriptors[3].Name + v10 + 4);
    v12 = (char *)NodeDescriptors + v10;
    if ( *(_DWORD *)(a2 + 16) == 18 )
      v7 = *(_DWORD *)(*((_QWORD *)v12 + 16) + 12LL);
    v13 = 16 * v11 * (v7 + 1) + 40;
    if ( Length >= 4 )
    {
      v9 = 0;
          ...
          if ( v11 )
          {
            ...
            do
            {
              *v15 = 2;
              ...
              v15[2] = v7;
              v15[3] = 2;
              v20 = *(_DWORD *)((char *)&NodeDescriptors[4].AutomationTable + v10);
              if ( _bittest(&v20, v16) )
              {
                if ( *(_DWORD *)(a2 + 16) == 18 )
                {
