/*
 * XREFs of ?SidebandApi@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x14000952C
 * Callers:
 ...
 *     ?IsPowerRequiredForIo@CSidebandDevice@@AEAA_NK@Z @ 0x140012E78 (-IsPowerRequiredForIo@CSidebandDevice@@AEAA_NK@Z.c)
 ...
 *     IsDevicePoweredUp @ 0x140041454 (IsDevicePoweredUp.c)
 */
...
LABEL_249:
  ...
  if ( (_BYTE)v10 || v5 )
  {
    v36 = &WPP_5beda4ce5be130d4523b4ac6acb25968_Traceguids;
    LOBYTE(v36) = v5;
