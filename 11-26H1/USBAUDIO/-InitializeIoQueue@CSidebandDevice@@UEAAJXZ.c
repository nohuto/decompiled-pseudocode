/*
 * XREFs of ?InitializeIoQueue@CSidebandDevice@@UEAAJXZ @ 0x1400125B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StartIoQueueThread@CSidebandDevice@@AEAAJXZ @ 0x1400139B4 (-StartIoQueueThread@CSidebandDevice@@AEAAJXZ.c)
...
__int64 __fastcall CSidebandDevice::InitializeIoQueue(CSidebandDevice *this)
{
  ...
  if ( (_BYTE)v5 || v2 )
  {
    v8 = &WPP_5beda4ce5be130d4523b4ac6acb25968_Traceguids;
    LOBYTE(v8) = v2;
