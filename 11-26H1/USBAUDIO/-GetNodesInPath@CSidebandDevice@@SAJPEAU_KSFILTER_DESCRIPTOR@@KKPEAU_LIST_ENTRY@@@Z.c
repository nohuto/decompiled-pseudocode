/*
 * XREFs of ?GetNodesInPath@CSidebandDevice@@SAJPEAU_KSFILTER_DESCRIPTOR@@KKPEAU_LIST_ENTRY@@@Z @ 0x14000B258
 * Callers:
...
LABEL_26:
  ...
  if ( (_BYTE)a2 || v9 )
  {
    v15 = &WPP_5beda4ce5be130d4523b4ac6acb25968_Traceguids;
    LOBYTE(v15) = v9;
