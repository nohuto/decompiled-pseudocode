/*
 * XREFs of _raise_exc_ex @ 0x14001C170
 * Callers:
 *     _raise_exc @ 0x14001C130 (_raise_exc.c)
 *     _raise_excf @ 0x14001C490 (_raise_excf.c)
 * Callees:
 *     _clrfp @ 0x14001C4D0 (_clrfp.c)
 *     _statfp @ 0x14001C5C0 (_statfp.c)
 *     RtlRaiseException_0 @ 0x14001C665 (RtlRaiseException_0.c)
...
__int64 __fastcall raise_exc_ex(ULONG_PTR a1, unsigned __int64 *a2, char a3, int a4, _DWORD *a5, _DWORD *a6, int a7)
{
  ...
  int v17; // eax
  __int64 result; // rax
  struct _EXCEPTION_RECORD ExceptionRecord; // [rsp+20h] [rbp-D8h] BYREF
