/*
 * XREFs of USBD_SelectInterfaceWithEndpointOffloadUrbAllocateAndBuild @ 0x14001A480
 * Callers:
...
LABEL_41:
  ...
  if ( a5 )
  {
    ...
    {
      v8 = (volatile signed __int32 *)(P + 220);
      if ( *((int *)P + 55) >= 1 )
      {
        _InterlockedIncrement(v8);
        v9 = (__int64 (__fastcall *)(_QWORD))*((_QWORD *)P + 22);
        if ( v9 )
        {
          v6 = v9(*((_QWORD *)P + 6));
          if ( (v6 & 0x80000000) == 0 )
        ...
        if ( _InterlockedExchangeAdd(v8, 0xFFFFFFFF) <= 1 )
        {
          if ( P[225] )
          {
            v10 = (void (__fastcall *)(_QWORD))*((_QWORD *)P + 14);
            if ( v10 )
              v10(*((_QWORD *)P + 6));
