/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14000D108
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14000D258 (wil_details_GetCurrentFeatureEnabledState.c)
