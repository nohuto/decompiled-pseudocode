/*
 * XREFs of ?CsqInsertIrpEx@CSidebandDevice@@AEAAJPEAU_IO_CSQ@@PEAU_IRP@@PEAX@Z @ 0x14000BB10
 * Callers:
 *     ?staticCsqInsertIrpEx@CSidebandDevice@@SAJPEAU_IO_CSQ@@PEAU_IRP@@PEAX@Z @ 0x14000BAF0 (-staticCsqInsertIrpEx@CSidebandDevice@@SAJPEAU_IO_CSQ@@PEAU_IRP@@PEAX@Z.c)
 * Callees:
 *     <none>
 */
