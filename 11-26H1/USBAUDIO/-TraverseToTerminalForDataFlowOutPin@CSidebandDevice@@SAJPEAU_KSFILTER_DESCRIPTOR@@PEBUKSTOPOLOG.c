/*
 * XREFs of ?TraverseToTerminalForDataFlowOutPin@CSidebandDevice@@SAJPEAU_KSFILTER_DESCRIPTOR@@PEBUKSTOPOLOGY_CONNECTION@@PEAK@Z @ 0x140014534
 * Callers:
  ...
  *a3 = -1;
  ...
  if ( v6 >= 0 )
  {
    while ( 1 )
    {
      ...
      while ( v12 < v11->ConnectionsCount )
      {
        v14 = v12;
        if ( Connections[v14].ToNode == LODWORD(Flink[1].Flink) )
        {
