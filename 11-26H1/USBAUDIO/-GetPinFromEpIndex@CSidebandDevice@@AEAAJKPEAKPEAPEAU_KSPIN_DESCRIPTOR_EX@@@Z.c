/*
 * XREFs of ?GetPinFromEpIndex@CSidebandDevice@@AEAAJKPEAKPEAPEAU_KSPIN_DESCRIPTOR_EX@@@Z @ 0x140007068
 * Callers:
        ...
        struct _KSPIN_DESCRIPTOR_EX **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    a2 = *(_QWORD *)(v13 + 168) + *(_DWORD *)(v13 + 164) * v12;
    if ( *(_DWORD *)(a2 + 68) != 4 )
    {
      v14 = **(_QWORD **)(a2 + 56);
      v15 = *(_QWORD *)(v14 + 32) - *(_QWORD *)&GUID_6dba3190_67bd_11cf_a0f7_0020afd156e4.Data1;
      if ( !v15 )
        v15 = *(_QWORD *)(v14 + 40) - *(_QWORD *)GUID_6dba3190_67bd_11cf_a0f7_0020afd156e4.Data4;
      if ( v15 )
      {
        if ( v6 == v11 )
        {
          *v5 = v12;
          *a4 = (struct _KSPIN_DESCRIPTOR_EX *)a2;
          if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
            || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) == 0
            || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
          {
