/*
 * XREFs of ?OnWindowTransformUpdated@CCaptureManager@@UEAAJPEAVCWindowData@@@Z @ 0x180075160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureManager::OnWindowTransformUpdated(CCaptureManager *this, struct CWindowData *a2)
{
  ...
  updated = CCaptureManager::_UpdateCaptureControllerTransform(v4, HostWindowHandleForProxyWindow);
  v6 = updated;
  if ( updated >= 0 )
    return 0LL;
