/*
 * XREFs of ?OnTick@CAnimationEngine@@QEAAJNPEA_N@Z @ 0x18001D6A4
 * Callers:
...
__int64 __fastcall CAnimationEngine::OnTick(CAnimationEngine *this, double a2, bool *a3)
{
  ...
  *((double *)this + 13) = a2;
  ...
  if ( started < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x13Fu, 0LL);
    goto LABEL_30;
  }
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( i >= *((_DWORD *)this + 16) )
    {
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x20Eu, 0LL);
      }
  ...
  for ( j = 0; ; j = v18 + 1 )
  {
    ...
    if ( v15 )
    {
      ...
      if ( v63 == 2 )
      {
        ...
        if ( v35 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0x17Eu, 0LL);
          goto LABEL_40;
        }
        v85 = 0LL;
        v86 = 0LL;
        ...
        *((float *)&v86 + 2) = v69;
        ...
        if ( v36 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v36, 0x184u, 0LL);
          goto LABEL_40;
        }
      }
      else if ( v63 == 3 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v46 )
          {
            ...
            if ( v47 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v47, 0x192u, 0LL);
              goto LABEL_40;
            }
            ...
            if ( v49 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v49, 0x197u, 0LL);
              goto LABEL_40;
            }
            v85 = 0LL;
            LODWORD(v86) = 0;
            ...
            *((float *)&v86 + 3) = v91;
            ...
            if ( v52 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v52, 0x19Fu, 0LL);
              goto LABEL_40;
            }
            v34 = v63;
            v45 = v67;
...
LABEL_14:
    ...
    if ( v29 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v29, 0x1ABu, 0LL);
      goto LABEL_40;
    }
    if ( v63 == 2 )
    {
      ...
      if ( v30 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x1AEu, 0LL);
        goto LABEL_40;
      }
      v85 = 0uLL;
      LODWORD(v86) = 0;
      ...
      *((_QWORD *)&v86 + 1) = COERCE_UNSIGNED_INT(v69);
      ...
      if ( v32 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v32, 0x1B6u, 0LL);
        goto LABEL_40;
      }
    }
    else
    {
      ...
      if ( v39 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v39, 0x1BAu, 0LL);
        goto LABEL_40;
      }
      v85 = 0LL;
      LODWORD(v86) = 0;
      ...
      *((float *)&v86 + 3) = v41;
      ...
      if ( v43 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v43, 0x1C4u, 0LL);
        goto LABEL_40;
      }
    }
LABEL_15:
    if ( v17 )
    {
      ...
      if ( v53 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v53, 0x1CEu, 0LL);
        goto LABEL_40;
      }
      if ( v63 == 2 )
      {
        ...
        if ( v54 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v54, 0x1D1u, 0LL);
          goto LABEL_40;
        }
        v85 = 0uLL;
        LODWORD(v86) = 0;
        ...
        *((_QWORD *)&v86 + 1) = COERCE_UNSIGNED_INT(v69);
        ...
        if ( v56 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v56, 0x1D9u, 0LL);
          goto LABEL_40;
        }
      }
      else if ( v63 == 3 )
      {
        ...
        if ( v57 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v57, 0x1DDu, 0LL);
          goto LABEL_40;
        }
        v85 = 0LL;
        LODWORD(v86) = 0;
        ...
        *((float *)&v86 + 3) = v59;
        ...
        if ( v61 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v61, 0x1E6u, 0LL);
          goto LABEL_40;
        }
      }
    }
    ...
    if ( v72 )
    {
      ...
      if ( v20 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x1F0u, 0LL);
        goto LABEL_40;
      }
      v70 = 0.0;
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x1F4u, 0LL);
        goto LABEL_40;
      }
      v85 = 0LL;
      LODWORD(v86) = 0;
      *(_QWORD *)((char *)&v86 + 4) = COERCE_UNSIGNED_INT(v70);
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x1F9u, 0LL);
        goto LABEL_40;
      }
    }
    if ( v73 )
    {
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x1FEu, 0LL);
        goto LABEL_40;
      }
      v85 = 0LL;
      v86 = 0LL;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x206u, 0LL);
LABEL_40:
  CBaseObject::Release((CBaseObject *)v10);
LABEL_30:
