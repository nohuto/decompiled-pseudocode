/*
 * XREFs of ?_WindowEnumCallback@CInplaceResize@@UEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800381B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CInplaceResize::_WindowEnumCallback(CStoryboard *a1, __int64 a2, char a3, int *a4)
{
  ...
  for ( i = 0; i < 4; ++i )
  {
    if ( (*(_DWORD *)v10 & 0xFFF) == v9 )
    {
      v12 = *(_DWORD *)&`CInplaceResize::GetPVLTarget'::`2'::s_rgPVLTargetLookupTable[8 * i + 4];
      break;
    }
    v10 += 8;
  }
