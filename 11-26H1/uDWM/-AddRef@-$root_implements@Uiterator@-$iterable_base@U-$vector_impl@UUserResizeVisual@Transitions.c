 ...
 *     ?AddRef@?$produce_base@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@3456@X@impl@winrt@@UEAAIXZ @ 0x1800D2AD0 (-AddRef@-$produce_base@UScreenRotationTransition@implementation@Private@Transitions_ea_1800D2AD0.c)
