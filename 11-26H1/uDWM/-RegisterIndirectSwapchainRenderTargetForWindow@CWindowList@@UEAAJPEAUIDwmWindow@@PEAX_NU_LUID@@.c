/*
 * XREFs of ?RegisterIndirectSwapchainRenderTargetForWindow@CWindowList@@UEAAJPEAUIDwmWindow@@PEAX_NU_LUID@@@Z @ 0x1800E3450
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _LUID a5)
{
  ...
  if ( v14 && (v9 = (CTopLevelWindow *)*((_QWORD *)v14 + 55)) != 0LL )
  {
    ...
    v11 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x197Cu, 0LL);
  }
  else
  {
    v11 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467261, 0x1975u, 0LL);
    if ( a3 )
      CloseHandle(a3);
  }
