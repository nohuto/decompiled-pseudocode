/*
 * XREFs of ?StopActivity@AnimationClockStateChange@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x180026C10
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::AnimationClockStateChange *this)
{
  ...
  {
    wil::ActivityBase<AnimationClockLogging,0,0,4,0,_TlgReflectorTag_Param0IsProviderType>::zInternalStop((__int64)this);
    v6 = (_DWORD *)wil::details::static_lazy<AnimationClockLogging>::get(v5, v4)[1];
    if ( *v6 > 4u )
    {
