/*
 * XREFs of ?ZOrderProjectedShadowReceiverVisual@CProjectedShadowScene@@AEAAJXZ @ 0x18004DDF4
 * Callers:
...
__int64 __fastcall CProjectedShadowScene::ZOrderProjectedShadowReceiverVisual(CProjectedShadowScene *this)
{
  ...
  if ( *((_BYTE *)this + 64) && *((_QWORD *)this + 7) )
  {
    ...
    if ( LowestProjectedShadowCasterWindowForDesktop
      && (v3 = *((_QWORD *)LowestProjectedShadowCasterWindowForDesktop + 3)) != 0 )
    {
      inserted = VisualCollection::InsertRelative(
                   (VisualCollection *)(v3 + 136),
                   *((CBaseObject ****)this + 7),
                   (CBaseObject ***)LowestProjectedShadowCasterWindowForDesktop,
                   0);
      if ( inserted < 0 )
      {
        v5 = 156LL;
