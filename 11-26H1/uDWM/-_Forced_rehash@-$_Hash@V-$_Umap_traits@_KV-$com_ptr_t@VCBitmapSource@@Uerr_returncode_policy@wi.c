/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@_KV?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KV?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x18009AEAC
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  *((_QWORD *)v2 + 6) = v6 - 1;
  ...
  {
    v8 = (_QWORD *)*v8;
    v9 = std::_Conditionally_enabled_hash<unsigned __int64,1>::operator()((const unsigned __int8 *)v7 + 16);
    v11 = *((_QWORD *)v2 + 3);
    v12 = 2 * (*((_QWORD *)v2 + 6) & v9);
    if ( *(_QWORD *)(v11 + 16 * (*((_QWORD *)v2 + 6) & v9)) == v4 )
    {
      *(_QWORD *)(v11 + 16 * (*((_QWORD *)v2 + 6) & v9)) = v10;
LABEL_7:
      *(_QWORD *)(v11 + 8 * v12 + 8) = v10;
      goto LABEL_15;
    }
    v13 = *(__int64 **)(v11 + 16 * (*((_QWORD *)v2 + 6) & v9) + 8);
    v14 = *(_QWORD *)(v10 + 16);
    if ( v14 == v13[2] )
    {
      v15 = *v13;
