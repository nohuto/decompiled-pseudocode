/*
 * XREFs of ?_WindowEnumCallback@CVirtualDesktopSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C80E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CVirtualDesktopSwitch::_WindowEnumCallback(__int64 a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    if ( *(_DWORD *)(a1 + 184) == *(_DWORD *)(a1 + 152) )
    {
      ...
      if ( v9 == 75 || (*((_DWORD *)a2 + 186) & 0xFFF) == 0x4C )
      {
        for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 184); i = (unsigned int)(i + 1) )
        {
          ...
          *(_DWORD *)(v19 + 68) = 2;
          ...
          CAnimatedTransitionVisual::SetBeginRect(*((CAnimatedTransitionVisual **)v4 + 5), &v27);
