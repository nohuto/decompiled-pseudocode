/*
 * XREFs of ?UpdateWindowedSwapChainCaptureBorder@CCaptureManager@@UEAAJAEBUDWM_CAPTURE_TOKEN@@H@Z @ 0x1800A3A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureManager::UpdateWindowedSwapChainCaptureBorder(
        HWND *this,
