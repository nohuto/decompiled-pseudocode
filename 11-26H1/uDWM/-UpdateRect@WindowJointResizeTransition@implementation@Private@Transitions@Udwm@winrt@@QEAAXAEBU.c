/*
 * XREFs of ?UpdateRect@WindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXAEBURect@Foundation@Windows@6@@Z @ 0x1800D787C
 * Callers:
 *     ?UpdateRect@?$produce@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHURect@Foundation@Windows@3@@Z @ 0x1800D7850 (-UpdateRect@-$produce@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt.c)
 * Callees:
        ...
        const struct winrt::Windows::Foundation::Rect *a2)
{
  ...
  for ( i = v25; i != v27; v25 = i )
  {
    ...
    winrt::impl::consume_Udwm_Transitions_IUserResizeVisual<winrt::Udwm::Transitions::IUserResizeVisual>::Rect(
      (__int64)&v28,
      &v23);
    v9 = winrt::impl::consume_Udwm_Transitions_IUserResizeVisual<winrt::Udwm::Transitions::IUserResizeVisual>::Target(&v28)
       - 95;
    if ( !v9 )
    {
...
LABEL_24:
    winrt::impl::consume_Udwm_Transitions_IUserResizeVisual<winrt::Udwm::Transitions::IUserResizeVisual>::Rect(
      &v28,
      &v23);
    winrt::com_ptr<winrt::impl::IWeakReferenceSource>::~com_ptr<winrt::impl::IWeakReferenceSource>((__int64 *)&v28);
    ++i;
  }
}
