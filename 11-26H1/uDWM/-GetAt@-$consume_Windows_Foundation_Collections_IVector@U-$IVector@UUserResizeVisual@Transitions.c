/*
 * XREFs of ?GetAt@?$consume_Windows_Foundation_Collections_IVector@U?$IVector@UUserResizeVisual@Transitions@Udwm@winrt@@@Collections@Foundation@Windows@winrt@@UUserResizeVisual@Transitions@Udwm@5@@impl@winrt@@QEBA@I@Z @ 0x1800D7084
 * Callers:
        ...
        unsigned int a3)
{
  ...
  const char *v14; // [rsp+30h] [rbp-28h]
  __int64 v15; // [rsp+38h] [rbp-20h]
  int v16; // [rsp+60h] [rbp+8h] BYREF
  CDisplayBroker *v17; // [rsp+68h] [rbp+10h]

  v17 = a2;
  CDisplayBroker::CDisplayBroker(a2);
  v6 = *v5;
  v13 = 566;
  v14 = "OneCoreUap\\Internal\\BuildMetadata\\internal\\cppwinrt\\winrt\\Windows.Foundation.Collections.h";
  v15 = 0LL;
  v7 = *(__int64 (__fastcall **)(__int64, _QWORD, void **))(*(_QWORD *)v6 + 48LL);
  v10 = winrt::put_abi(v9, v8);
  v11 = v7(v6, a3, v10);
  winrt::check_hresult(&v16, v11, (__int64)&v13);
  return a2;
}
