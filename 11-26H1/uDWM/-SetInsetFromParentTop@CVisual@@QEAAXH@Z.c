/*
 * XREFs of ?SetInsetFromParentTop@CVisual@@QEAAXH@Z @ 0x180013488
 * Callers:
...
void __fastcall CVisual::SetInsetFromParentTop(CVisual *this, __int64 a2, __int64 a3)
{
  unsigned int *v3; // rax
  __int64 v4; // r9
  char v5; // [rsp+38h] [rbp+10h] BYREF

  if ( *((_DWORD *)this + 20) != (_DWORD)a2 )
  {
    *((_DWORD *)this + 20) = a2;
