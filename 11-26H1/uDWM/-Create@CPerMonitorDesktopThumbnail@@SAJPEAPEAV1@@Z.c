/*
 * XREFs of ?Create@CPerMonitorDesktopThumbnail@@SAJPEAPEAV1@@Z @ 0x1800AD858
 * Callers:
...
__int64 __fastcall CPerMonitorDesktopThumbnail::Create(struct CPerMonitorDesktopThumbnail **a1)
{
  ...
  struct CPerMonitorDesktopThumbnail *v4; // rbx
  ...
  if ( a1 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, TrustLevel, 0x64u, 0LL);
    *a1 = 0LL;
    if ( v4 )
  ...
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x64u, 0LL);
  }
