/*
 * XREFs of ?CreateGutterAnimationComponentsForRect@CTransitionVisualController@@QEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEBUtagRECT@@2PEAVCStoryboard@@PEAPEAVCAnimationComponent@@4@Z @ 0x1800CF288
 * Callers:
        ...
        CBaseObject **a9)
{
  ...
  int v31; // eax
  int v32; // eax
  CBaseObject *v36; // [rsp+38h] [rbp-A9h] BYREF
  __int64 v37; // [rsp+40h] [rbp-A1h]
  CBaseObject *v38; // [rsp+48h] [rbp-99h] BYREF
  int *v39; // [rsp+50h] [rbp-91h]
  __int64 v40; // [rsp+58h] [rbp-89h]
  CBaseObject **v41; // [rsp+60h] [rbp-81h]
  ...
  if ( v13 )
  {
    ...
    if ( v39[3] - v39[1] >= 0 )
      v18 = v39[3] - v39[1];
    v20 = MulDiv(v15, v18, *(_DWORD *)(*((_QWORD *)a1 + 23) + 132LL));
    v43[0] = a4;
    v21 = *v42;
    v22 = v42[1];
    v23 = v42[3];
