/*
 * XREFs of ?AnimationsEnabled@TransitionState@implementation@Transitions@Udwm@winrt@@QEAA_NXZ @ 0x180042584
 * Callers:
 *     ?get_AnimationsEnabled@?$produce@UTransitionState@implementation@Transitions@Udwm@winrt@@UITransitionState@345@@impl@winrt@@UEAAHPEA_N@Z @ 0x180040C40 (-get_AnimationsEnabled@-$produce@UTransitionState@implementation@Transitions@Udwm@winrt@@UITrans.c)
 * Callees:
        ...
        winrt::Udwm::Transitions::implementation::TransitionState *this)
{
  ...
  bool ShouldShowTransition; // di
  __int64 v6; // [rsp+30h] [rbp+8h] BYREF

  v6 = 0LL;
  v1 = (__int64 (__fastcall ****)(_QWORD, __int64 *, __int64 *))((char *)this + 104);
  if ( !winrt::Windows::Foundation::operator!=((_QWORD *)this + 13, &v6) )
    return 1;
