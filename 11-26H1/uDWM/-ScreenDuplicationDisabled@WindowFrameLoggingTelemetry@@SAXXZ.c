/*
 * XREFs of ?ScreenDuplicationDisabled@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800BE254
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationDisabled(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rcx
  int v3; // ecx
