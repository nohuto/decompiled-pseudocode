/*
 * XREFs of ?QueryInterface@?$weak_ref@$00$00@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800D11F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$is_guid_of@UIWeakReference@impl@winrt@@@winrt@@YA_NAEBUguid@0@@Z @ 0x1800D094C (--$is_guid_of@UIWeakReference@impl@winrt@@@winrt@@YA_NAEBUguid@0@@Z.c)
 */
