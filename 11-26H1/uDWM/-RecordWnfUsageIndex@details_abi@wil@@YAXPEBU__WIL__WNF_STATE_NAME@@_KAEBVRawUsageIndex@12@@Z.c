/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x18005B12C
 * Callers:
 ...
 *     ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x18005B32C (--0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  while ( 1 )
  {
    ...
    {
      v10 = ((__int64 (__fastcall *)(wil::details_abi *, _QWORD, _QWORD, struct __WIL__WNF_STATE_NAME **, _BYTE *, unsigned __int64 *))NtDllProcedureAddress)(
              v5,
              0LL,
              0LL,
              &v19,
    ...
    v23[1] = &v22;
    v23[2] = v24;
    v12 = wistd::function<bool (void *,unsigned __int64,void *,unsigned __int64,unsigned int)>::X::Z::Z(v27, v23);
