/*
 * XREFs of ?Create@CSystemBackdropVisual@@SAJW4SYSTEMBACKDROP_TYPE@@PEAPEAV1@@Z @ 0x180027194
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    if ( v5 )
    {
      ...
      v12 = (CBaseObject *)DefaultHeap::AllocClear(0xE0uLL);
      v8 = v12;
      v16 = v12;
      if ( v12 )
      {
    ...
    {
      v13 = (CBaseObject *)DefaultHeap::AllocClear(0xE0uLL);
      v8 = v13;
      v16 = v13;
      if ( v13 )
      {
...
LABEL_7:
  ...
  v7 = (CBaseObject *)DefaultHeap::AllocClear(0xE0uLL);
  v8 = v7;
  v16 = v7;
  if ( !v7 )
    goto LABEL_7;
