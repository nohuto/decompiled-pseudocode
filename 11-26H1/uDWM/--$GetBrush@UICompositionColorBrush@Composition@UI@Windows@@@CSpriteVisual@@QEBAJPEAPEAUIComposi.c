/*
 * XREFs of ??$GetBrush@UICompositionColorBrush@Composition@UI@Windows@@@CSpriteVisual@@QEBAJPEAPEAUICompositionColorBrush@Composition@UI@Windows@@@Z @ 0x18004CE98
 * Callers:
...
__int64 __fastcall CSpriteVisual::GetBrush<Windows::UI::Composition::ICompositionColorBrush>(__int64 a1, _QWORD *a2)
{
  __int64 *v3; // rcx
  __int64 v4; // rax
  int v5; // eax
  ...
  if ( v16 )
  {
    ...
    v11 = (**v10)(v10, &GUID_2b264c5e_bf35_4831_8642_cf70c20fff2f, v9);
    v6 = v11;
    if ( v11 >= 0 )
    {
      v7 = v16;
