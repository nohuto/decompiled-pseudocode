/*
 * XREFs of ?Create@CDCompDesktopThumbnailCVI@@SAJPEAPEAV1@@Z @ 0x1800DE9F0
 * Callers:
...
__int64 __fastcall CDCompDesktopThumbnailCVI::Create(struct CDCompDesktopThumbnailCVI **a1)
{
  ...
  if ( a1 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, TrustLevel, 0x91u, 0LL);
    *a1 = 0LL;
    if ( v4 )
  ...
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x91u, 0LL);
  }
