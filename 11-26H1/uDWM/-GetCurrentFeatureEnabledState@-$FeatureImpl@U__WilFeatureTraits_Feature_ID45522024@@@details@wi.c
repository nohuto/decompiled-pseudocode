/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ID45522024@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800A0284
 * Callers:
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18009F308 (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_ID52435335@@@details@wil.c)
 */
  ...
  *(_DWORD *)a2 = v13;
  ...
  if ( (v14 & 0x400) != 0 && v14 >= 0x800 || (v14 & 0x40) != 0 )
  {
    ...
    wil::details::ReportUsageToService(
      (volatile signed __int32 *)&unk_180118BF0,
      0x3201987u,
      (v16 >> 10) & 1,
      (v16 >> 11) & 1,
      (__int64)&v19,
