/*
 * XREFs of ?_SlideWindow@CSlide@@IEAAJPEAVCWindowData@@MPEAPEAVCAnimationComponent@@@Z @ 0x1800C464C
 * Callers:
        ...
        struct CAnimationComponent **a4)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    CAnimatedTransitionVisual::SetBeginRect(*((CAnimatedTransitionVisual **)v20 + 5), &rc);
