/*
 * XREFs of CCaptureManager::_ApplyToAllCaptureControllersForCapturedWindowedSwapChain__CCaptureManager::_UpdateCaptureControllerCaptureState_::_4_::_lambda_1___ @ 0x18009CCF0
 * Callers:
...
__int64 __fastcall CCaptureManager::_ApplyToAllCaptureControllersForCapturedWindowedSwapChain__CCaptureManager::_UpdateCaptureControllerCaptureState_::_4_::_lambda_1___(
        __int64 a1,
        __int64 a2,
        char a3,
        _BYTE *a4)
