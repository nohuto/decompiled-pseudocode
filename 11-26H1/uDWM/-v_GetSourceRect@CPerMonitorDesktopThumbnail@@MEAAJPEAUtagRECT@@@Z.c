/*
 * XREFs of ?v_GetSourceRect@CPerMonitorDesktopThumbnail@@MEAAJPEAUtagRECT@@@Z @ 0x1800AE3B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPerMonitorDesktopThumbnail::v_GetSourceRect(HMONITOR *this, struct tagRECT *a2)
{
  ...
  else
  {
    ...
    if ( v4 >= 0 )
      v4 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x172u, 0LL);
  }
