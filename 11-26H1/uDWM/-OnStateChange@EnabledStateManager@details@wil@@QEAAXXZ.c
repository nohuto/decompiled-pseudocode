/*
 * XREFs of ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x180076FC0
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_1_@?4??EnsureSubscribedToFeatureConfigurationChangesImpl@EnabledStateManager@details@wil@@AEAAIXZ@SA@PEAX@Z @ 0x18008DBB0 (-_lambda_invoker_cdecl_@_lambda_1_@-4--EnsureSubscribedToFeatureConfigurationChangesImpl@Enabled.c)
 * Callees:
 *     <none>
 */
