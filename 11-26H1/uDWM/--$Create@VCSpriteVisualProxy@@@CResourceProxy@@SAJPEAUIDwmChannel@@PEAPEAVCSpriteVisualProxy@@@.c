/*
 * XREFs of ??$Create@VCSpriteVisualProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCSpriteVisualProxy@@@Z @ 0x180083010
 * Callers:
...
__int64 __fastcall CResourceProxy::Create<CSpriteVisualProxy>(struct IDwmChannel *a1, CBaseObject **a2)
{
  unsigned int v4; // ebx
  int v5; // eax
  unsigned int v6; // edi
  CSpriteVisualProxy *v8; // rax
  CBaseObject *v9; // rax
  int v10; // eax
  ...
  CSpriteVisualProxy *v15; // [rsp+58h] [rbp+20h]

  v4 = 0;
  v14 = 0LL;
  v13 = 0;
  v5 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 19LL, &v13);
  v6 = v5;
  if ( v5 >= 0 )
  {
    v8 = (CSpriteVisualProxy *)DefaultHeap::AllocClear(0x30uLL);
    v15 = v8;
    if ( v8 )
      v9 = CSpriteVisualProxy::CSpriteVisualProxy(v8, a1, v13);
    else
      v9 = 0LL;
    v14 = v9;
    if ( v9 )
