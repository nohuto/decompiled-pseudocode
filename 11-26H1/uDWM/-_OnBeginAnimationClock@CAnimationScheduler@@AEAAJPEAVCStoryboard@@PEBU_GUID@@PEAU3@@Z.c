/*
 * XREFs of ?_OnBeginAnimationClock@CAnimationScheduler@@AEAAJPEAVCStoryboard@@PEBU_GUID@@PEAU3@@Z @ 0x18003F114
 * Callers:
 ...
 * Callees:
 *     ?_LookupAnimationClockIdFromStoryboard@CAnimationScheduler@@AEAAJHPEBU_GUID@@PEAU2@PEAH@Z @ 0x18003F254 (-_LookupAnimationClockIdFromStoryboard@CAnimationScheduler@@AEAAJHPEBU_GUID@@PEAU2@PEAH@Z.c)
        ...
        struct _GUID *a4)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    Buf2 = v19;
    LODWORD(v8) = CAnimationClockCoordinator::OnCreateAnimationClock(v11, &Buf2, v12);
    if ( (int)(v8 + 0x80000000) < 0 || (_DWORD)v8 == -2147019886 )
    {
      ...
      if ( AnimationDuration < 0 )
        v14 = 0;
      LODWORD(v8) = CAnimationClockCoordinator::OnBeginAnimationClock(v11, &Buf2, v14);
