/*
 * XREFs of ?UpdateGlobalTime@CDesktopManager@@AEAAJNPEA_N@Z @ 0x18001D070
 * Callers:
...
__int64 __fastcall CDesktopManager::UpdateGlobalTime(CDesktopManager *this, double a2, bool *a3)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x794u, 0LL);
  }
  else if ( !CAnimationEngine::IsIdle(v3[22]) )
  {
    LOBYTE(v9) = 0;
