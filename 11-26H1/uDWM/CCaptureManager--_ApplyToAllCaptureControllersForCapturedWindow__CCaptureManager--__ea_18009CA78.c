/*
 * XREFs of CCaptureManager::_ApplyToAllCaptureControllersForCapturedWindow__CCaptureManager::_UpdateCaptureControllerDefaultSDRBoost_::_11_::_lambda_2___ @ 0x18009CA78
 * Callers:
...
__int64 __fastcall CCaptureManager::_ApplyToAllCaptureControllersForCapturedWindow__CCaptureManager::_UpdateCaptureControllerDefaultSDRBoost_::_11_::_lambda_2___(
        __int64 a1,
        __int64 *a2,
        int a3,
        _BYTE *a4)
