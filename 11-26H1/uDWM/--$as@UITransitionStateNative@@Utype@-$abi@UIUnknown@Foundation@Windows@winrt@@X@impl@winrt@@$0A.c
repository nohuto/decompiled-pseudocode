/*
 * XREFs of ??$as@UITransitionStateNative@@Utype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@impl@winrt@@$0A@@impl@winrt@@YA?AU?$com_ptr@UITransitionStateNative@@@1@PEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@01@@Z @ 0x1800D1CFC
 * Callers:
...
_QWORD *__fastcall winrt::impl::as<ITransitionStateNative,winrt::impl::abi<winrt::Windows::Foundation::IUnknown,void>::type,0>(
        _QWORD *a1,
        __int64 (__fastcall ***a2)(_QWORD, __int64 *, __int64 *))
{
  ...
  if ( a2 )
  {
    ...
    v8 = 0LL;
    v6 = 2123;
    v4 = (*v3)(a2, &winrt::impl::guid_v<ITransitionStateNative>, &v10);
