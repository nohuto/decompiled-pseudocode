/*
 * XREFs of ?SkipAnimationDelays@WindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800D6070
 * Callers:
 *     ?SkipAnimationDelays@?$produce@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHXZ @ 0x1800D6060 (-SkipAnimationDelays@-$produce@UWindowMoveResizeCrossfadeTransition@implementation@Private@Trans.c)
 * Callees:
