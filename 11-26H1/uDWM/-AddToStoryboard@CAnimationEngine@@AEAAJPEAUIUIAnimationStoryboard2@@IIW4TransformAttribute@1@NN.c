/*
 * XREFs of ?AddToStoryboard@CAnimationEngine@@AEAAJPEAUIUIAnimationStoryboard2@@IIW4TransformAttribute@1@NNPEAN2IPEAUTA_TIMINGFUNCTION@@W4TransformMode@@22I@Z @ 0x180052988
 * Callers:
...
LABEL_9:
  ...
  else
  {
    ...
    v28 = ((__int64 (__fastcall *)(struct IUIAnimationStoryboard2 *, _QWORD, struct IUIAnimationTransition2 *))a2->lpVtbl->AddTransition)(
            a2,
            *(_QWORD *)v19,
            v64);
    v22 = v28;
