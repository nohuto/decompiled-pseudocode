/*
 * XREFs of ?get_Target@?$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@@impl@winrt@@UEAAHPEAH@Z @ 0x1800DDE50
 * Callers:
 *     <none>
 * Callees:
 *     ??$detach_from@I@impl@winrt@@YA?A_P$$QEAI@Z @ 0x1800D9FA8 (--$detach_from@I@impl@winrt@@YA-A_P$$QEAI@Z.c)
 *     ?Target@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAAHXZ @ 0x1800DDA84 (-Target@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAAHXZ.c)
 */
