/*
 * XREFs of ?Create@CDisplayExtendToDuplicateAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B2F74
 * Callers:
...
__int64 __fastcall CDisplayExtendToDuplicateAnimatedVisual::Create(struct CDisplayExtendToDuplicateAnimatedVisual **a1)
{
  ...
  if ( a1 )
  {
    v3 = (CDisplayExtendToDuplicateAnimatedVisual *)DefaultHeap::AllocClear(0x1A0uLL);
    if ( v3 )
