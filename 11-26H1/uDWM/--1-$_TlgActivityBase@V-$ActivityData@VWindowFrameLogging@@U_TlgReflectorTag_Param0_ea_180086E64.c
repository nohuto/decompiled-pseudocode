/*
 * XREFs of ??1?$_TlgActivityBase@V?$ActivityData@VWindowFrameLogging@@U_TlgReflectorTag_Param0IsProviderType@@@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@$0CAAAAAAAAAAA@$04@@IEAA@XZ @ 0x180086E64
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( *a1 == 1 )
  {
    *a1 = 2;
    ...
    _tlgWriteActivityAutoStop<35184372088832,5>(v3[1], a1 + 2);
  }
  *a1 = 3;
}
