/*
 * XREFs of ?GetLightByType@CGlobalLightSet@@QEAAJW4LightType@UI@Windows@@PEAPEAUICompositionLight@Composition@34@@Z @ 0x180088AA4
 * Callers:
...
__int64 __fastcall CGlobalLightSet::GetLightByType(__int64 a1, int a2, _QWORD *a3)
{
  _QWORD *v6; // rax
  __int64 v8; // rcx
