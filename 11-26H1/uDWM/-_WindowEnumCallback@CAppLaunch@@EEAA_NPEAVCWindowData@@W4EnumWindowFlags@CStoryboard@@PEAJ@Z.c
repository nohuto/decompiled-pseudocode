/*
 * XREFs of ?_WindowEnumCallback@CAppLaunch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C6170
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CAppLaunch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C0BE0 (-GetPVLTarget@CAppLaunch@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
LABEL_13:
  ...
  v8 = (CAnimatedTransitionVisual **)v27;
  v23 = (CAnimatedTransitionVisual *)*((_QWORD *)v27 + 5);
