/*
 * XREFs of ?CreateRectangleGeometry@ResourceHelper@@SAJAEBUD2D_POINTANDSIZE_L@@MPEAPEAVCRectangleGeometryProxy@@@Z @ 0x18000FE00
 * Callers:
        ...
        struct CRectangleGeometryProxy **a3)
{
  ...
  CRectangleGeometryProxy *v15; // [rsp+A0h] [rbp+18h] BYREF
