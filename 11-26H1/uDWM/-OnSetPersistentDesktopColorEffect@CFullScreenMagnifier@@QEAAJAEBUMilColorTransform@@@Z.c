/*
 * XREFs of ?OnSetPersistentDesktopColorEffect@CFullScreenMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x1800B51B0
 * Callers:
        ...
        const struct MilColorTransform *a2)
{
  ...
  *((_DWORD *)this + 62) = *((_DWORD *)a2 + 24);
  ...
  v3 = updated;
  if ( updated < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x13Eu, 0LL);
  return v3;
}
