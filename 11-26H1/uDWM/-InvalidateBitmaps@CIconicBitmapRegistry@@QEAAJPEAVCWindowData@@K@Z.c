/*
 * XREFs of ?InvalidateBitmaps@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@K@Z @ 0x180068EC0
 * Callers:
...
__int64 __fastcall CIconicBitmapRegistry::InvalidateBitmaps(CIconicBitmapRegistry *this, HWND *a2, int a3)
{
  ...
  if ( !GetWindowThreadProcessId(a2[5], &v13) || a3 != v13 )
  {
    ...
    v12 = 813;
LABEL_7:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F6730, 1LL, v9, v12, 0LL);
    return v5;
  }
