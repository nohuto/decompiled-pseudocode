/*
 * XREFs of ??$GetBrush@UICompositionSurfaceBrush@Composition@UI@Windows@@@CSpriteVisual@@QEBAJPEAPEAUICompositionSurfaceBrush@Composition@UI@Windows@@@Z @ 0x1800093C8
 * Callers:
...
__int64 __fastcall CSpriteVisual::GetBrush<Windows::UI::Composition::ICompositionSurfaceBrush>(__int64 a1, _QWORD *a2)
{
  __int64 *v3; // rcx
  __int64 v4; // rax
  int v5; // eax
  ...
  if ( v16 )
  {
    ...
    v11 = (**v10)(v10, &GUID_ad016d79_1e4c_4c0d_9c29_83338c87c162, v9);
    v6 = v11;
    if ( v11 >= 0 )
    {
      v7 = v16;
