/*
 * XREFs of ?_WindowEnumCallback@CShrinkPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C7200
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CShrinkPanel@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C0FA0 (-GetPVLTarget@CShrinkPanel@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
char __fastcall CShrinkPanel::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) == 0 )
  {
    if ( (a3 & 4) == 0 || (*(_DWORD *)(a2 + 744) & 0xFFF) != 0x29 )
      goto LABEL_29;
    v29 = *(_OWORD *)(a2 + 48);
    *(_BYTE *)(a1 + 136) = 1;
    *(_OWORD *)(a1 + 140) = v29;
  ...
  if ( v9 )
  {
    ...
    if ( !CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(WPT, *(HWND *)(a2 + 40), 0) )
      goto LABEL_29;
    PVLTarget = CShrinkPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 744));
...
LABEL_7:
      CAnimatedTransitionVisual::SetBeginRect(*((CAnimatedTransitionVisual **)v4 + 5), v13);
  ...
  if ( *(_BYTE *)(a1 + 136) )
  {
    v15 = CShrinkPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 744));
