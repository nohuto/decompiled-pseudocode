/*
 * XREFs of ?OnMarginsOrSizeUpdated@CSecondaryWindowRepresentation@@QEAAXXZ @ 0x18002910C
 * Callers:
...
void __fastcall CSecondaryWindowRepresentation::OnMarginsOrSizeUpdated(CSecondaryWindowRepresentation *this)
{
  ...
  if ( !*((_BYTE *)this + 257) && CSecondaryWindowRepresentation::CalculateWindowMetrics(this, &v7, &v6) )
  {
    if ( v7.cx != *((_DWORD *)this + 20)
      ...
      || (v3 = (_DWORD *)*((_QWORD *)RepresentationWindowData + 55), *((_DWORD *)this + 26) != v3[147])
      || *((_DWORD *)this + 27) != v3[148]
      || *((_DWORD *)this + 28) != v3[149]
      || *((_DWORD *)this + 29) != v3[150] )
    {
      v4 = v6;
      *((struct tagSIZE *)this + 10) = v7;
      v5 = *((_QWORD *)this + 21);
      *(struct _MARGINS *)((char *)this + 88) = v4;
      *(_OWORD *)((char *)this + 104) = *(_OWORD *)(*((_QWORD *)RepresentationWindowData + 55) + 588LL);
