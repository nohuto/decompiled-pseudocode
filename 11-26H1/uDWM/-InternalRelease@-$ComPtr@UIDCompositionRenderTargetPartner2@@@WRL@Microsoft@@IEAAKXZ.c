/*
 * XREFs of ?InternalRelease@?$ComPtr@UIDCompositionRenderTargetPartner2@@@WRL@Microsoft@@IEAAKXZ @ 0x1800ABDA4
 * Callers:
 ...
 *     ??1?$ComPtr@UIDCompositionRenderTargetPartner2@@@WRL@Microsoft@@QEAA@XZ @ 0x1800AA004 (--1-$ComPtr@UIDCompositionRenderTargetPartner2@@@WRL@Microsoft@@QEAA@XZ.c)
 * Callees:
