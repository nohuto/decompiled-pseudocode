/*
 * XREFs of ?OnMagnifierSyncApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEAX_NKPEBU_REMOTE_PORT_VIEW@@PEAJPEAI@Z @ 0x180066DD4
 * Callers:
 ...
 *     ?OnCaptureRTBits@CMagnifier@@QEAAX_KKPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@PEAJ@Z @ 0x180066FB4 (-OnCaptureRTBits@CMagnifier@@QEAAX_KKPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_META.c)
 */
  ...
  if ( a2 == 1073741935 && a4 )
  {
    *a8 = 40;
    ...
    if ( v12 < 0 )
    {
      ...
      if ( v12 != -2147023728 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F91CC, 1LL, v12, 0x1B5u, 0LL);
        goto LABEL_8;
      }
      v12 = 0;
    }
