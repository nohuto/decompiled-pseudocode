/*
 * XREFs of ?Create@CDisplayDuplicateToExtendAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800B2DDC
 * Callers:
...
__int64 __fastcall CDisplayDuplicateToExtendAnimatedVisual::Create(struct CDisplayDuplicateToExtendAnimatedVisual **a1)
{
  ...
  if ( a1 )
  {
    v3 = (CDisplayDuplicateToExtendAnimatedVisual *)DefaultHeap::AllocClear(0x1D0uLL);
    if ( v3 )
