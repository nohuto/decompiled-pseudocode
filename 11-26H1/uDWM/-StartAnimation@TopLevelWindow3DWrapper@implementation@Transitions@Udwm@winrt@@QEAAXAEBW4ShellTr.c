/*
 * XREFs of ?StartAnimation@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAAXAEBW4ShellTransitionType@345@AEBURect@Foundation@Windows@5@@Z @ 0x18003FE24
 * Callers:
 *     ?StartAnimation@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHHURect@Foundation@Windows@3@@Z @ 0x18003FDF0 (-StartAnimation@-$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopL.c)
 * Callees:
        ...
        const struct winrt::Windows::Foundation::Rect *a3)
{
  ...
  CTopLevelWindow::SetSuppressBorderUpdates(
    *(CTopLevelWindow **)(*(_QWORD *)(*((_QWORD *)this + 4) + 232LL) + 440LL),
    0);
}
