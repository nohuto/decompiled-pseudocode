/*
 * XREFs of ?_UpdateFinalSize@CTouchPressHoldVisual@@IEAAXXZ @ 0x1800CDC60
 * Callers:
...
void __fastcall CTouchPressHoldVisual::_UpdateFinalSize(CTouchPressHoldVisual *this)
{
  ...
  nNumerator = 100;
  v2 = MonitorFromPoint(*(POINT *)((char *)this + 228), 2u);
  GetScaleFactorForMonitorImp(v2, (enum DEVICE_SCALE_FACTOR *)&nNumerator);
  v3 = nNumerator;
  *((_DWORD *)this + 66) = nNumerator;
  v4 = MulDiv(90, v3, 100);
  v5 = *((_DWORD *)this + 66);
  *((_DWORD *)this + 60) = v4;
  *((_DWORD *)this + 59) = MulDiv(90, v5, 100);
}
