...
LABEL_8:
  if ( (int)v8 > 0 && (int)a5 > 0 && v11 )
  {
    ...
    if ( v12 <= 0xFFFFFFFF )
    {
      ...
      {
        v13 = -2147024362;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0x1926u, 0LL);
      }
      else
      {
        ...
        {
          v13 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x1930u, 0LL);
        ...
        else
        {
          ...
          if ( v18 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x193Cu, 0LL);
    ...
    {
      v13 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0x1922u, 0LL);
    }
  }
  else
  {
    v13 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x1941u, 0LL);
  }
