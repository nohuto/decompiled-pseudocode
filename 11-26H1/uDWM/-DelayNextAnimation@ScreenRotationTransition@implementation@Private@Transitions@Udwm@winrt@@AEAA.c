/*
 * XREFs of ?DelayNextAnimation@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@AEAAXAEBW4RotationTimelineReason@23456@@Z @ 0x1800D2C08
 * Callers:
        ...
        const char *a4)
{
  ...
  v7 = (CBaseObject *)CTimeline<float>::operator new();
  v14 = v7;
  if ( v7 )
    v7 = (CBaseObject *)CTimeline<float>::CTimeline<float>((__int64)v7, v8, v9, v10, 0);
