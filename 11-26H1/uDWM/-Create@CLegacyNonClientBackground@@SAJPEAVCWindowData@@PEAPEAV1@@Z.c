/*
 * XREFs of ?Create@CLegacyNonClientBackground@@SAJPEAVCWindowData@@PEAPEAV1@@Z @ 0x18006969C
 * Callers:
...
__int64 __fastcall CLegacyNonClientBackground::Create(struct CWindowData *a1, struct CLegacyNonClientBackground **a2)
{
  ...
  *a2 = 0LL;
  v4 = (CLegacyNonClientBackground *)CContainerVisual::operator new(0x110uLL);
  if ( v4 )
