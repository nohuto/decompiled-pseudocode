/*
 * XREFs of ?RemoveSecondaryWindowRepresentation@CWindowData@@QEAAXPEAVCSecondaryWindowRepresentation@@@Z @ 0x18002AB54
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v7 != this )
  {
    ...
    DynArray<CStoryboard const *,0>::Remove((__int64 *)this + 62, (__int64 *)&v8);
  }
  LOBYTE(a4) = 1;
