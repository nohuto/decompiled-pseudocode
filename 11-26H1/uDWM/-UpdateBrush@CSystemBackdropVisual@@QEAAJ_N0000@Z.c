/*
 * XREFs of ?UpdateBrush@CSystemBackdropVisual@@QEAAJ_N0000@Z @ 0x180027990
 * Callers:
        ...
        bool a6)
{
  ...
  v8 = *((_DWORD *)this + 49);
  if ( v8 == v6 && v6 != 3 && *((_BYTE *)this + 192) == a5 )
    return 0LL;
  if ( v8 == 3 && v6 == 3 )
  {
    SysColor = GetSysColor(5);
    if ( *((_BYTE *)this + 200) == 0xFF
      && *(_WORD *)((char *)this + 201) == (_WORD)SysColor
      && *((_BYTE *)this + 203) == BYTE2(SysColor) )
    {
      return 0LL;
    }
  }
