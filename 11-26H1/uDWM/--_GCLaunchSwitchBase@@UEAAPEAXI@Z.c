/*
 * XREFs of ??_GCLaunchSwitchBase@@UEAAPEAXI@Z @ 0x1800C06F0
 * Callers:
 *     <none>
 * Callees:
...
CLaunchSwitchBase *__fastcall CLaunchSwitchBase::`scalar deleting destructor'(CLaunchSwitchBase *this, char a2)
{
