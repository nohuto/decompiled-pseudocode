/*
 * XREFs of ?HasNonTrivialRepresentation@CWindowData@@QEBA_NXZ @ 0x180034478
 * Callers:
 ...
 *     ?IsSplashScreen@CWindowData@@QEBA_NXZ @ 0x180033DD4 (-IsSplashScreen@CWindowData@@QEBA_NXZ.c)
 */
