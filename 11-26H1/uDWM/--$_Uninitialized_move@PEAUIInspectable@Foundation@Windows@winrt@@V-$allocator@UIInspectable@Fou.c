/*
 * XREFs of ??$_Uninitialized_move@PEAUIInspectable@Foundation@Windows@winrt@@V?$allocator@UIInspectable@Foundation@Windows@winrt@@@std@@@std@@YAPEAUIInspectable@Foundation@Windows@winrt@@QEAU1234@0PEAU1234@AEAV?$allocator@UIInspectable@Foundation@Windows@winrt@@@0@@Z @ 0x1800D9D50
 * Callers:
...
__int64 *__fastcall std::_Uninitialized_move<winrt::Windows::Foundation::IInspectable *>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
