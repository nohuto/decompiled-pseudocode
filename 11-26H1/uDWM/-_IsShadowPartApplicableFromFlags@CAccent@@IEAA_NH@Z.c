/*
 * XREFs of ?_IsShadowPartApplicableFromFlags@CAccent@@IEAA_NH@Z @ 0x180059790
 * Callers:
...
LABEL_19:
          LOBYTE(v6) = *((_BYTE *)this + 188) >> 5;
          return v6 & 1;
        }
        return (*((_BYTE *)this + 188) & 0xC0) == 0xC0;
      }
      v10 = *((_DWORD *)this + 47);
      v11 = 288;
    }
