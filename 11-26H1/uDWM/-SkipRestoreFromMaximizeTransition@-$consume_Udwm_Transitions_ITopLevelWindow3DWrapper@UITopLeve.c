/*
 * XREFs of ?SkipRestoreFromMaximizeTransition@?$consume_Udwm_Transitions_ITopLevelWindow3DWrapper@UITopLevelWindow3DWrapper@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x18007DC20
 * Callers:
        ...
        __int64 **a1)
{
  ...
  v2 = *v1;
  v7 = 0LL;
  v3 = (*(__int64 (__fastcall **)(__int64 *, char *))(v2 + 64))(v1, &v8);
  if ( v3 < 0 )
