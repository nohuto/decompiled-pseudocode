/*
 * XREFs of ?GetStillZoneFromOffset@MagnifierExperienceHelper@@AEBA?AUtagRECT@@AEBUtagPOINT@@0@Z @ 0x1800BB100
 * Callers:
 ...
 *     ?IsEmptyRegionOnVirtualDesktop@MagnifierExperienceHelper@@AEBA_NUtagPOINT@@@Z @ 0x1800BB478 (-IsEmptyRegionOnVirtualDesktop@MagnifierExperienceHelper@@AEBA_NUtagPOINT@@@Z.c)
 */
        ...
        const struct tagPOINT *a4)
{
  ...
  LONG x; // eax
  double v10; // xmm6_8
  bool IsEmptyRegionOnVirtualDesktop; // r12
  bool v12; // di
  bool v13; // bp
  bool v14; // al
  double v15; // xmm4_8
  ...
  double v29; // xmm6_8
  LONG v30; // eax
  double bottom; // xmm0_8
  POINT pt; // [rsp+E0h] [rbp+8h]
  ...
  *retstr = 0LL;
  ...
  v22 = v17 * (1.0 - v4);
  v23 = top / v15 + (double)a3->y;
  v24 = _mm_load_si128((const __m128i *)&_xmm).m128i_u64[0];
  if ( v12 )
    *(_QWORD *)&v25 = COERCE_UNSIGNED_INT64((double)(lprc[3].left - lprc->left) / v15) & v24;
  else
    v25 = 0.0;
  right = lprc->right;
  if ( v13 )
    *(_QWORD *)&v27 = COERCE_UNSIGNED_INT64((double)(lprc[3].right - right) / v15) & v24;
  else
    v27 = 0.0;
  if ( IsEmptyRegionOnVirtualDesktop )
    *(_QWORD *)&v28 = COERCE_UNSIGNED_INT64((double)(lprc[3].top - lprc->top) / v15) & v24;
  else
    v28 = 0.0;
  if ( v14 )
    *(_QWORD *)&v29 = COERCE_UNSIGNED_INT64((double)(lprc[3].bottom - lprc->bottom) / v15) & v24;
  else
    v29 = 0.0;
  retstr->left = (int)((v21 - left) / *(double *)&lprc[1].left * v22 + v25 + v21 + 0.5);
  retstr->top = (int)((v23 - top) / *(double *)&lprc[1].right * v20 + v28 + v23 + 0.5);
  v30 = (int)o_ceilf_0(v17 + v21 - (((double)right - (v17 + v21)) / *(double *)&lprc[1].left * v22 - v27));
  bottom = (double)lprc->bottom;
  retstr->right = v30;
  retstr->bottom = (int)o_ceilf_0(v16 + v23 - ((bottom - (v16 + v23)) / *(double *)&lprc[1].right * v20 - v29));
  return retstr;
}
