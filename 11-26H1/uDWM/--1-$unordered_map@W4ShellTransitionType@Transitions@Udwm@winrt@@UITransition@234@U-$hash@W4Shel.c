/*
 * XREFs of ??1?$unordered_map@W4ShellTransitionType@Transitions@Udwm@winrt@@UITransition@234@U?$hash@W4ShellTransitionType@Transitions@Udwm@winrt@@@std@@U?$equal_to@W4ShellTransitionType@Transitions@Udwm@winrt@@@7@V?$allocator@U?$pair@$$CBW4ShellTransitionType@Transitions@Udwm@winrt@@UITransition@234@@std@@@7@@std@@QEAA@XZ @ 0x1800D8A50
 * Callers:
 *     _winrt::Udwm::Transitions::TransitionManager::TransitionManager_::_1_::dtor$0 @ 0x1800E8244 (_winrt--Udwm--Transitions--TransitionManager--TransitionManager_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
