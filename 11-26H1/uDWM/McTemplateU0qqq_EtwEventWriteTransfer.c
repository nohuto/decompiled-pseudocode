/*
 * XREFs of McTemplateU0qqq_EtwEventWriteTransfer @ 0x1800AD4A8
 * Callers:
...
__int64 __fastcall McTemplateU0qqq_EtwEventWriteTransfer(int a1, __int64 a2, int a3, int a4, char a5)
{
  ...
  v10 = 4LL;
  v12 = 4LL;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (unsigned int)&UdwmProcessModeChange_Info, a3, 4, (__int64)v6);
}
