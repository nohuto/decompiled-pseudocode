/*
 * XREFs of ?StopImpl@CDisplayDuplicateAnimatedVisual@@EEAAJXZ @ 0x1800AFF00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDisplayDuplicateAnimatedVisual::StopImpl(CDisplayDuplicateAnimatedVisual *this)
{
  ...
  int v5; // eax
  unsigned int v6; // ebx
  unsigned int *v8[5]; // [rsp+20h] [rbp-28h] BYREF
  ...
  *((_QWORD *)this + 49) = 0LL;
  ...
  v8[0] = (unsigned int *)((char *)this + 400);
  v8[1] = (unsigned int *)((char *)this + 404);
  v8[2] = (unsigned int *)((char *)this + 408);
  v8[3] = (unsigned int *)((char *)this + 412);
