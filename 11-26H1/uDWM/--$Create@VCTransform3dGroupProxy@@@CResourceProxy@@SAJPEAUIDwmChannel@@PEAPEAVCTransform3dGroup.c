/*
 * XREFs of ??$Create@VCTransform3dGroupProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCTransform3dGroupProxy@@@Z @ 0x1800A7758
 * Callers:
...
__int64 __fastcall CResourceProxy::Create<CTransform3dGroupProxy>(struct IDwmChannel *a1, CBaseObject **a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  __int64 v6; // r9
  ...
  v14 = 0LL;
  v13 = 0;
  v4 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 20LL, &v13);
  v5 = v4;
  if ( v4 < 0 )
  {
    v6 = (unsigned int)v4;
...
LABEL_10:
  ...
  v9 = CTransform3dGroupProxy::CTransform3dGroupProxy(v8, a1, v13);
  v14 = v9;
  if ( !v9 )
  {
LABEL_7:
