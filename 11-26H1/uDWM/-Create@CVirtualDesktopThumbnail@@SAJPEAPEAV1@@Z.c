/*
 * XREFs of ?Create@CVirtualDesktopThumbnail@@SAJPEAPEAV1@@Z @ 0x1800668CC
 * Callers:
  ...
  if ( a1 )
  {
    ...
    if ( v3 )
    {
      ...
      *(_QWORD *)v4 = &CVirtualDesktopThumbnail::`vftable';
      v2 = CDesktopThumbnailBase::Initialize(v4);
      if ( v2 >= 0 )
      {
        *a1 = v4;
        return 0;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0xEBu, 0LL);
    *a1 = 0LL;
    if ( v4 )
