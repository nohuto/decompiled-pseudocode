/*
 * XREFs of ??$Create@VCEffectGroupProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCEffectGroupProxy@@@Z @ 0x180081F90
 * Callers:
...
__int64 __fastcall CResourceProxy::Create<CEffectGroupProxy>(struct IDwmChannel *a1, CBaseObject **a2)
{
  unsigned int v4; // ebx
  int v5; // eax
  unsigned int v6; // edi
  ...
  v14 = 0LL;
  v13 = 0;
  v5 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 5LL, &v13);
  v6 = v5;
  if ( v5 < 0 )
  {
  ...
  v9 = CEffectGroupProxy::CEffectGroupProxy(v8, a1, v13);
  v14 = v9;
  if ( !v9 )
  {
LABEL_7:
