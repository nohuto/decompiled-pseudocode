/*
 * XREFs of ?_WindowEnumCallback@CReposition@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C7150
 * Callers:
 *     <none>
 * Callees:
 *     ?Release@CBaseObject@@QEAAKXZ @ 0x18001BCE0 (-Release@CBaseObject@@QEAAKXZ.c)
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18001E310 (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?SetOverrideMorphedBeginAlpha@CAnimatedTransitionVisual@@QEAAX_N@Z @ 0x180096704 (-SetOverrideMorphedBeginAlpha@CAnimatedTransitionVisual@@QEAAX_N@Z.c)
...
char __fastcall CReposition::_WindowEnumCallback(CSlide *a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  v5 = 0;
  v9 = 0LL;
  if ( (a3 & 1) != 0 && (*((_DWORD *)a2 + 186) & 0xFFF) == 0x2C )
  {
