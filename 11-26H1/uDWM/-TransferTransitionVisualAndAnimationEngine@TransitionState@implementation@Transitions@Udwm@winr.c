/*
 * XREFs of ?TransferTransitionVisualAndAnimationEngine@TransitionState@implementation@Transitions@Udwm@winrt@@QEAA?AUTopLevelWindow3DWrapper@345@XZ @ 0x180041750
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  CTopLevelWindow::SetSuppressBorderUpdates(*(CTopLevelWindow **)(*(_QWORD *)(v7 + 232) + 440LL), 1);
  v8 = *(_QWORD *)(a1 + 104);
  *a2 = v8;
  if ( v8 )
