/*
 * XREFs of ?LookupAndValidateMagnifier@CMagnifierControl@@AEAAJ_KPEAPEAVCMagnifier@@@Z @ 0x180066F0C
 * Callers:
        ...
        struct CMagnifier **a3)
{
  ...
  {
    v5 = -2147023728;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F91C8, 1LL, -2147023728, 0x1FFu, 0LL);
  }
  return v5;
}
