/*
 * XREFs of ??1CWindowBorder@@UEAA@XZ @ 0x18005DCBC
 * Callers:
...
void __fastcall CWindowBorder::~CWindowBorder(CBaseObject **this)
{
  wil::com_ptr_t<CDisplaySecondaryOnlyToExtendAnimatedVisual,wil::err_returncode_policy>::~com_ptr_t<CDisplaySecondaryOnlyToExtendAnimatedVisual,wil::err_returncode_policy>(this + 28);
  ...
  CGraphicsResourceOwner::~CGraphicsResourceOwner((CGraphicsResourceOwner *)(this + 23));
