/*
 * XREFs of ?UpdateThumbnailsForNewWindow@CWindowList@@AEAAJPEAVCWindowData@@@Z @ 0x180059450
 * Callers:
...
__int64 __fastcall CWindowList::UpdateThumbnailsForNewWindow(CWindowList *this, struct CWindowData *a2)
{
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)a2 + 140); i = (unsigned int)(i + 1) )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x1AE3u, 0LL);
      return v2;
    }
    ...
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1AEEu, 0LL);
        return v2;
      }
    }
  }
