 ...
 * Callees:
 *     ??0CAPTURE_DISPLAY_MAP_ENTRY@CCaptureManager@@QEAA@$$QEAU01@@Z @ 0x18009DFD0 (--0CAPTURE_DISPLAY_MAP_ENTRY@CCaptureManager@@QEAA@$$QEAU01@@Z.c)
 */

_QWORD *__fastcall std::construct_at<std::pair<_LARGE_INTEGER const,CCaptureManager::CAPTURE_FILTERED_DISPLAY_MAP_ENTRY>,_LARGE_INTEGER const &,CCaptureManager::CAPTURE_FILTERED_DISPLAY_MAP_ENTRY>(
        _QWORD *a1,
        _QWORD *a2,
        __int64 a3)
{
