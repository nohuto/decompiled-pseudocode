/*
 * XREFs of McTemplateU0qqqp_EtwEventWriteTransfer @ 0x180099FC4
 * Callers:
...
__int64 __fastcall McTemplateU0qqqp_EtwEventWriteTransfer(__int64 a1, __int64 a2, int a3, int a4, char a5, char a6)
{
