/*
 * XREFs of ?TransferJointResizeVisuals@?$consume_Udwm_Transitions_ITransitionState@UITransitionState@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x1800D77A4
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  v4 = *v2;
  v9 = 0LL;
  v5 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v4 + 80))(v2, &v10);
  winrt::check_hresult((int *)&v11, v5, (__int64)&v7);
  *a2 = v10;
  return a2;
}
