/*
 * XREFs of ?CreateWindowWithNotify@CTopLevelWindow@@SAJPEAVCWindowData@@PEAPEAV1@@Z @ 0x1800172A4
 * Callers:
...
__int64 __fastcall CTopLevelWindow::CreateWindowWithNotify(struct CWindowData *a1, struct CTopLevelWindow **a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x5Cu, 0LL);
  }
  return v5;
}
