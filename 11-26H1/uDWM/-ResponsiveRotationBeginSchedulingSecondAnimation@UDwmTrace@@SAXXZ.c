/*
 * XREFs of ?ResponsiveRotationBeginSchedulingSecondAnimation@UDwmTrace@@SAXXZ @ 0x1800D3648
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationBeginSchedulingSecondAnimation(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rcx
  int v3; // ecx
  __int64 v4; // r8
