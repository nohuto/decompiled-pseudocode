/*
 * XREFs of ?GetMaximizeSnapStartRect@?$consume_Udwm_Transitions_ITopLevelWindow3DWrapper@UITopLevelWindow3DWrapper@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x180040568
 * Callers:
        ...
        _OWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v4 + 136LL))(v4, v3);
  if ( v5 < 0 )
