        ...
        const unsigned __int16 **a22)
{
  ...
  v57 = 4LL;
  v55 = 8LL;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, a3, 0, 20, (__int64)v53);
}
