/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x18002D190
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( CDesktopManager::s_pDesktopManagerInstance )
  {
    if ( a1 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F8D48, 2LL, v16, v15, 0LL);
