/*
 * XREFs of ?DestroyWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18007FEC0
 * Callers:
...
__int64 __fastcall CWindowList::DestroyWindow(CWindowArrangementTransition **this, struct IDwmWindow *a2)
{
  ...
  if ( v18 )
  {
    ...
    {
      v19 = &v18;
      CWindowList::ForEachSoftwareCursorListener__CWindowList::DestroyWindow_::_11_::_lambda_1___(
        (__int64)this,
        (__int64)&v19);
      v4 = v18;
    }
    ...
    if ( (*((_BYTE *)v18 + 736) & 4) == 0 )
    {
      ...
      *((_QWORD *)v18 + 1) = v18;
      *(_QWORD *)v18 = v18;
      CWindowList::ImmediateDestroyWindow((CWindowList *)this, v18, v8, v9);
    }
    v14 = this[66];
