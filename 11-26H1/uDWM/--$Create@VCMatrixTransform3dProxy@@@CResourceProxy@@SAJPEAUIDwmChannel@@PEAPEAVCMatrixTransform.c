/*
 * XREFs of ??$Create@VCMatrixTransform3dProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCMatrixTransform3dProxy@@@Z @ 0x1800A7458
 * Callers:
...
__int64 __fastcall CResourceProxy::Create<CMatrixTransform3dProxy>(struct IDwmChannel *a1, CBaseObject **a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  __int64 v6; // r9
  ...
  v14 = 0LL;
  v13 = 0;
  v4 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 11LL, &v13);
  v5 = v4;
  if ( v4 < 0 )
  {
    v6 = (unsigned int)v4;
...
LABEL_10:
  ...
  v9 = CMatrixTransform3dProxy::CMatrixTransform3dProxy(v8, a1, v13);
  v14 = v9;
  if ( !v9 )
  {
LABEL_7:
