/*
 * XREFs of ?CalculateOutsideMargins@CTopLevelWindow@@SAXPEAVCWindowData@@IPEAU_MARGINS@@@Z @ 0x18001F0C0
 * Callers:
        ...
        struct _MARGINS *a3)
{
  ...
  *a3 = 0LL;
  if ( CTopLevelWindow::HasRenderedBorder(a2)
    ...
    && *((_DWORD *)this + 17) >= dword_1801158C4
    && *((_DWORD *)this + 18) >= dword_1801158C8
    && *((_DWORD *)this + 19) >= dword_1801158CC
    && (*((_DWORD *)this + 30) & 0x800000) == 0
    && (int)CWindowData::GetMetricsForCaptionBar(this, 92) > 0 )
  {
    v16 = 0LL;
