/*
 * XREFs of ?RemoveInteropVisualFromTree@CGlobalLightSet@@AEAAXXZ @ 0x1800B5C84
 * Callers:
...
void __fastcall CGlobalLightSet::RemoveInteropVisualFromTree(CGlobalLightSet *this)
{
  ...
  if ( v2 )
  {
    ...
    {
      v5 = *(CBaseObject **)(*(_QWORD *)(v3 + 144) + 8LL * v4);
      v11 = v5;
      if ( v5 )
        CBaseObject::AddRef(v5);
      v6 = VisualCollection::Remove((VisualCollection *)(v3 + 136), (struct CVisualProxy **)v5);
      if ( v6 < 0 )
