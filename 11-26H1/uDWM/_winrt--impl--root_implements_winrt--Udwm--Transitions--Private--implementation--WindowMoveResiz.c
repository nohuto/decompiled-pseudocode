/*
 * XREFs of _winrt::impl::root_implements_winrt::Udwm::Transitions::Private::implementation::WindowMoveResizeCrossfadeTransition_winrt::Udwm::Transitions::Private::WindowMoveResizeCrossfadeTransition_::get_weak_winrt::Udwm::Transitions::Private::implementation::WindowMoveResizeCrossfadeTransition__::_1_::dtor$1 @ 0x1800E787C
 * Callers:
 *     <none>
 * Callees:
