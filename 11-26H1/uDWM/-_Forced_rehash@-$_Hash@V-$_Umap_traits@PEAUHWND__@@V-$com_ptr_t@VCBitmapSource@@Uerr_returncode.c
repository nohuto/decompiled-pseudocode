 ...
 *     ??1_Clear_guard@?$_Hash@V?$_Umap_traits@PEAUHWND__@@V?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@V?$_Uhash_compare@PEAUHWND__@@U?$hash@PEAUHWND__@@@std@@U?$equal_to@PEAUHWND__@@@3@@std@@V?$allocator@U?$pair@QEAUHWND__@@V?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@@std@@@5@$0A@@std@@@std@@QEAA@XZ @ 0x1800D6E38 (--1_Clear_guard@-$_Hash@V-$_Umap_traits@PEAUHWND__@@V-$com_ptr_t@VCBitmapSource@@Uerr_returncode.c)
 */
        ...
        unsigned __int64 a2)
{
  ...
  *((_QWORD *)v2 + 6) = v6 - 1;
  ...
  {
    v8 = std::_Conditionally_enabled_hash<__int64,1>::operator()(i + 16);
    v11 = *((_QWORD *)v2 + 3);
...
LABEL_15:
  ...
  v28 = 0LL;
  return std::_Hash<std::_Umap_traits<HWND__ *,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>,std::_Uhash_compare<HWND__ *,std::hash<HWND__ *>,std::equal_to<HWND__ *>>,std::allocator<std::pair<HWND__ * const,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>>>,0>>::_Clear_guard::~_Clear_guard(&v28);
}
