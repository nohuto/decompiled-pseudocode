/*
 * XREFs of ?GetAbsoluteWindowRect@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAA?AURect@Foundation@Windows@5@XZ @ 0x18000B470
 * Callers:
        ...
        __int64 a2)
{
  ...
  CTopLevelWindow::GetActualWindowRect(
    *(CTopLevelWindow **)(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 232LL) + 440LL),
    &v9,
    0,
    1,
    1);
