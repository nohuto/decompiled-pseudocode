/*
 * XREFs of ?ScheduleEntranceAnimation@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800B3D5C
 * Callers:
...
__int64 __fastcall CDisplaySecondaryOnlyToDuplicateAnimatedVisual::ScheduleEntranceAnimation(
