/*
 * XREFs of ??$SetBrush@PEAUICompositionBrush@Composition@UI@Windows@@@CSpriteVisual@@QEAAJPEAUICompositionBrush@Composition@UI@Windows@@@Z @ 0x18000D204
 * Callers:
...
__int64 __fastcall CSpriteVisual::SetBrush<Windows::UI::Composition::ICompositionBrush *>(__int64 a1)
{
  int v1; // eax
  unsigned int v2; // ebx
  ...
  v1 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)(a1 + 16) + 40LL) + 56LL))(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 40LL));
  v2 = v1;
  if ( v1 >= 0 )
    return 0LL;
