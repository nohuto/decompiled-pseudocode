/*
 * XREFs of ??1?$test_watcher@V?$merged_data@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@U12345@@details@tip2@@@tip2@@QEAA@XZ @ 0x180076880
 * Callers:
 ...
 *     _winrt::Udwm::Transitions::Private::implementation::ScreenRotationTransition::Cancel_::_1_::dtor$0 @ 0x1800E7A49 (_winrt--Udwm--Transitions--Private--implementation--ScreenRotationTransition--Cancel_--_1_--dtor.c)
 *     _winrt::Udwm::Transitions::Private::implementation::ScreenRotationTransition::PreTransition_::_1_::dtor$2 @ 0x1800E9522 (_winrt--Udwm--Transitions--Private--implementation--ScreenRotationTransition--PreTransition_--_1.c)
 * Callees:
