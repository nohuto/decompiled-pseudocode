/*
 * XREFs of ?query_interface@?$root_implements@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIBitmapManager@@@impl@winrt@@AEAAHAEBUguid@3@PEAPEAX@Z @ 0x180088990
 * Callers:
 *     ?QueryInterface@?$implements@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIBitmapManager@@@winrt@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180088980 (-QueryInterface@-$implements@UWindowJointResizeTransition@implementation@Private@Transitions@Udw.c)
 * Callees:
 *     ?NonDelegatingAddRef@?$root_implements@UWindowJointResizeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@UIBitmapManager@@@impl@winrt@@IEAAIXZ @ 0x180030850 (-NonDelegatingAddRef@-$root_implements@UWindowJointResizeTransition@implementation@Private@Trans.c)
