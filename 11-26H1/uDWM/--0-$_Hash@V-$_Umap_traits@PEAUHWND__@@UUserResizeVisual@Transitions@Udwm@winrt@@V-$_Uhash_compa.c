 ...
 *     ??0?$list@U?$pair@QEAUHWND__@@UUserResizeVisual@Transitions@Udwm@winrt@@@std@@V?$allocator@U?$pair@QEAUHWND__@@UUserResizeVisual@Transitions@Udwm@winrt@@@std@@@2@@std@@QEAA@AEBV?$allocator@U?$pair@QEAUHWND__@@UUserResizeVisual@Transitions@Udwm@winrt@@@std@@@1@@Z @ 0x18008C8F8 (--0-$list@U-$pair@QEAUHWND__@@UUserResizeVisual@Transitions@Udwm@winrt@@@std@@V-$allocator@U-$pa.c)
 */
