/*
 * XREFs of ?originate@hresult_error@winrt@@AEAAXUhresult@2@PEAXAEBUslim_source_location@impl@2@@Z @ 0x1800D1628
 * Callers:
 ...
 *     RoOriginateLanguageException_0 @ 0x18009002D (RoOriginateLanguageException_0.c)
...
__int64 __fastcall winrt::hresult_error::originate(__int64 a1, int a2, __int64 a3, unsigned int *a4)
{
  ...
  result = (__int64)winrt::Udwm::Transitions::TopLevelWindow3DWrapper::operator=((__int64 *)(a1 + 16), v8);
  if ( v8[0] )
