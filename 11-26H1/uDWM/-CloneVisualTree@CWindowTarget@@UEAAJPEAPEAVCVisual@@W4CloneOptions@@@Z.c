/*
 * XREFs of ?CloneVisualTree@CWindowTarget@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x1800E5270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowTarget::CloneVisualTree(__int64 a1, struct CWindowTarget **a2)
{
  ...
  *a2 = 0LL;
  v14 = 0LL;
  v4 = (struct IDwmChannel **)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 6);
  Microsoft::WRL::ComPtr<CSpriteVisual>::InternalRelease(&v14);
...
LABEL_5:
  ...
  if ( v8 >= 0 )
  {
    v8 = CVisual::InitializeVisualTreeClone(a1, v13);
    v6 = v8;
    if ( v8 >= 0 )
    {
      v10 = v13;
