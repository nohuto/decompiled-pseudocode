/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2509@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800ACB8C
 * Callers:
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2509@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800AD24C (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2509@@@details@w.c)
 * Callees:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisplayBugBundle_2509>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisplayBugBundle_2509>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v7);
    v7 = v3;
  }
