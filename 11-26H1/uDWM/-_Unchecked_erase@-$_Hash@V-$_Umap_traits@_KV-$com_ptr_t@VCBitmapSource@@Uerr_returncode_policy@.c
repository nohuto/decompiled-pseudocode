/*
 * XREFs of ?_Unchecked_erase@?$_Hash@V?$_Umap_traits@_KV?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KV?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@@std@@@4@$0A@@std@@@std@@AEAAPEAU?$_List_node@U?$pair@$$CB_KV?$com_ptr_t@VCBitmapSource@@Uerr_returncode_policy@wil@@@wil@@@std@@PEAX@2@PEAU32@QEAU32@@Z @ 0x18009B030
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( a2 != a3 )
  {
    ...
    v21 = v6;
    v22 = a2;
    v9 = std::_Conditionally_enabled_hash<unsigned __int64,1>::operator()((const unsigned __int8 *)(a2 + 16));
    v11 = 2 * (a1[6] & v9);
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v7 + 8 * v11 + 8) = v6; ; *(_QWORD *)(v7 + 8 * v11 + 8) = v8 )
    {
      ...
      if ( v22 == a3 )
        break;
      v17 = std::_Conditionally_enabled_hash<unsigned __int64,1>::operator()((const unsigned __int8 *)(v22 + 16));
      v11 = 2 * (a1[6] & v17);
