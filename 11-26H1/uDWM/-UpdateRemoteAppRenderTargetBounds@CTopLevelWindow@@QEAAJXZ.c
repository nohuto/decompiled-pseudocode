/*
 * XREFs of ?UpdateRemoteAppRenderTargetBounds@CTopLevelWindow@@QEAAJXZ @ 0x18005454C
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateRemoteAppRenderTargetBounds(CTopLevelWindow *this)
{
  ...
  if ( *((_QWORD *)this + 98) )
  {
    ...
    {
      v4 = this;
      v5 = *(_QWORD *)(*((_QWORD *)this + 87) + 480LL);
      if ( v5 )
        v4 = *(CTopLevelWindow **)(v5 + 24);
      CTopLevelWindow::GetFrameMargins(v4, &v15);
      v6 = *(__m128i *)(*((_QWORD *)v4 + 87) + 48LL);
    }
    else
    {
      v6 = *(__m128i *)(*((_QWORD *)this + 87) + 48LL);
      if ( (*((_BYTE *)this + 184) & 4) != 0 )
        v15 = *(struct _MARGINS *)((char *)this + 620);
      else
    ...
    (*(void (__fastcall **)(_QWORD, __int64 *))(**((_QWORD **)this + 98) + 40LL))(*((_QWORD *)this + 98), &v16);
    v13 = *((_QWORD *)this + 98);
    v17 = cxLeftWidth;
    v18 = cyTopHeight;
    ...
    v1 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x17D3u, 0LL);
  }
  return v1;
}
