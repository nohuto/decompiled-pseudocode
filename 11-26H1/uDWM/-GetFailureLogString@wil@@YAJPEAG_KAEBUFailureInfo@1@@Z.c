/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x1800913B4
 * Callers:
 ...
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z @ 0x180091CD4 (-MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z.c)
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180093610 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x18008E1C0 (__security_check_cookie.c)
 *     memset_0 @ 0x18008EF30 (memset_0.c)
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180091984 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
