/*
 * XREFs of ?_SetupOwneePreview@CLivePreview@@AEAAJPEBVCWindowData@@PEAUHWND__@@W4Enum@LivePreviewWindowState@@@Z @ 0x18007AFF0
 * Callers:
...
__int64 __fastcall CLivePreview::_SetupOwneePreview(CLivePreview *a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a2 + 632); i = (unsigned int)(i + 1) )
  {
      ...
      && ((*(_BYTE *)(v10 + 736) & 1) != 0 || *(_QWORD *)(v10 + 480)) )
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x161u, 0LL);
        return v4;
      }
    }
  }
