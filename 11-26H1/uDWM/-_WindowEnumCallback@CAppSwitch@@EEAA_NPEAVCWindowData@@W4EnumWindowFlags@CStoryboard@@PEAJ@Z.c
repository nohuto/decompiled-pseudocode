/*
 * XREFs of ?_WindowEnumCallback@CAppSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C6370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetBeginAlpha@CAnimatedTransitionVisual@@UEAAJPEAM@Z @ 0x180076B10 (-GetBeginAlpha@CAnimatedTransitionVisual@@UEAAJPEAM@Z.c)
 ...
 *     ?GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C0C20 (-GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
char __fastcall CAppSwitch::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, _DWORD *a4)
{
  ...
  struct tagRECT v37; // [rsp+58h] [rbp-31h] BYREF
  CBaseObject *v38; // [rsp+68h] [rbp-21h] BYREF
  _DWORD *v39; // [rsp+70h] [rbp-19h]
    ...
    case 2u:
      ...
      if ( v26 )
      {
        if ( v37.right - v37.left >= 0 )
          v27 = v37.right - v37.left;
        v27 = -v27;
      }
      else if ( v37.right - v37.left >= 0 )
      {
        v27 = v37.right - v37.left;
      }
      OffsetRect(&rc, v27, 0);
      ...
      if ( v8 <= 0x1C )
      {
        ...
        if ( _bittest(&v29, v8) )
        {
          ...
          *(_QWORD *)&v37.left = a1;
          ...
          if ( v8 - 2 <= 1 )
            CAppSwitch::_WindowEnumCallback_::_81_::_lambda_1_::operator()((__int64)&v37, v28);
          if ( (*(_DWORD *)(a2 + 744) & 0x18000) != 0 )
          {
            CGroupingStoryboard::_CreateGuttersForApp(
              ...
              (CBaseObject *)&v38,
              (CBaseObject *)&v35);
            v10 = (CAnimatedTransitionVisual **)v38;
            if ( v38 )
              CAppSwitch::_WindowEnumCallback_::_81_::_lambda_1_::operator()(
                (__int64)&v37,
                (CAnimatedTransitionVisual **)v38);
            v32 = v35;
            if ( v35 )
              CAppSwitch::_WindowEnumCallback_::_81_::_lambda_1_::operator()((__int64)&v37, v10);
            goto LABEL_79;
          }
        }
      }
