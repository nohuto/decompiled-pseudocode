/*
 * XREFs of ??$_Emplace_reallocate@AEAPEAVCPrimitive@@@?$vector@V?$com_ptr_t@VCPrimitive@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCPrimitive@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@AEAAPEAV?$com_ptr_t@VCPrimitive@@Uerr_returncode_policy@wil@@@wil@@QEAV23@AEAPEAVCPrimitive@@@Z @ 0x1800BD934
 * Callers:
...
CBaseObject **__fastcall std::vector<wil::com_ptr_t<CPrimitive,wil::err_returncode_policy>>::_Emplace_reallocate<CPrimitive * &>(
        __int64 a1,
        __int64 a2,
        CBaseObject **a3)
{
  ...
  *v16 = v14;
  ...
  std::vector<wil::com_ptr_t<CVisual,wil::err_returncode_policy>>::_Reallocation_guard::~_Reallocation_guard(v21);
  return v16;
}
