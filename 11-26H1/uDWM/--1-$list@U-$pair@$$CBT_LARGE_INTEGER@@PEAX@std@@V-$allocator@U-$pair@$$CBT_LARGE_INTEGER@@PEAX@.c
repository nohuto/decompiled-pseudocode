/*
 * XREFs of ??1?$list@U?$pair@$$CBT_LARGE_INTEGER@@PEAX@std@@V?$allocator@U?$pair@$$CBT_LARGE_INTEGER@@PEAX@std@@@2@@std@@QEAA@XZ @ 0x1800C02F4
 * Callers:
 *     _CWindowData::CWindowData_::_1_::dtor$6 @ 0x1800E914F (_CWindowData--CWindowData_--_1_--dtor$6.c)
 * Callees:
