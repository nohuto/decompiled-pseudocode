/*
 * XREFs of ??$GetBrush@UICompositionNineGridBrush@Composition@UI@Windows@@@CSpriteVisual@@QEBAJPEAPEAUICompositionNineGridBrush@Composition@UI@Windows@@@Z @ 0x180009EC4
 * Callers:
...
__int64 __fastcall CSpriteVisual::GetBrush<Windows::UI::Composition::ICompositionNineGridBrush>(__int64 a1, _QWORD *a2)
{
  __int64 *v3; // rcx
  __int64 v4; // rax
  int v5; // eax
  ...
  if ( v16 )
  {
    ...
    v11 = (**v10)(v10, &GUID_f25154e4_bc8c_4be7_b80f_8685b83c0186, v9);
    v6 = v11;
    if ( v11 >= 0 )
    {
      v7 = v16;
