/*
 * XREFs of ?Cancel@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x180041D0C
 * Callers:
 *     ?Cancel@?$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHXZ @ 0x180041CE0 (-Cancel@-$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UITra.c)
