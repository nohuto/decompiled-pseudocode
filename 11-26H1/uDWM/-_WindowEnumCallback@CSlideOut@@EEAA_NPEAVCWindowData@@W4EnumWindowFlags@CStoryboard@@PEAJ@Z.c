/*
 * XREFs of ?_WindowEnumCallback@CSlideOut@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C7A40
 * Callers:
 *     <none>
 * Callees:
      ...
      && !CTransitionVisualController::HasVisibleStyle(*(HWND *)(a2 + 40)) )
    {
      ...
      if ( WindowDataByHwnd )
      {
        *((_DWORD *)WindowDataByHwnd + 186) = *(_DWORD *)(a2 + 744) & 0xEBFFF000 | 0x1400002A;
        if ( *(float *)(*(_QWORD *)(*((_QWORD *)a1 + 17) + 40LL) + 680LL) == 1.0 )
        {
          ...
          if ( v18 >= 0 )
          {
            v19 = CSlide::_SlideWindowHorizontally(a1, v16, &v32, 0, 0LL, (CAnimatedTransitionVisual ***)&v31);
            v7 = v19;
            if ( v19 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_21:
        ...
        {
          v22 = CSlide::_SlideWindowHorizontally(
                  a1,
                  (struct CWindowData *)a2,
                  &v32,
                  0,
                  0LL,
                  (CAnimatedTransitionVisual ***)&v33);
          v7 = v22;
          if ( v22 >= 0 )
          {
            v23 = CSlide::_SlideWindowHorizontally(a1, v16, &v32, 0, 0LL, (CAnimatedTransitionVisual ***)&v31);
            v7 = v23;
            if ( v23 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_37:
      ...
      {
LABEL_34:
        v24 = CSlide::_SlideWindowHorizontally(
                a1,
                (struct CWindowData *)a2,
                &v32,
                0,
