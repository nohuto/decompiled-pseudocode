/*
 * XREFs of ?UpdateProperties@CThumbnailData@@QEAAJPEBU_DWM_THUMBNAIL_PROPERTIES@@@Z @ 0x180027FF8
 * Callers:
...
__int64 __fastcall CThumbnailData::UpdateProperties(CThumbnailData *this, const struct _DWM_THUMBNAIL_PROPERTIES *a2)
{
  ...
  if ( (a2->dwFlags & 2) != 0 )
  {
    if ( !EqualRect((const RECT *)((char *)this + 56), &a2->rcSource) || (v18 = (char *)v3, (*(_BYTE *)v3 & 2) == 0) )
    {
      v4 |= 2u;
      v18 = (char *)this + 36;
    }
...
LABEL_38:
  ...
  v15 = (CSecondaryWindowRepresentation **)*((_QWORD *)this + 11);
  if ( v15 )
  {
