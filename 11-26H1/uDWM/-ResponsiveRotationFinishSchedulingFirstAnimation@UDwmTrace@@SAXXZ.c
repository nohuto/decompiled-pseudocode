/*
 * XREFs of ?ResponsiveRotationFinishSchedulingFirstAnimation@UDwmTrace@@SAXXZ @ 0x1800D3698
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationFinishSchedulingFirstAnimation(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rcx
  int v3; // ecx
  __int64 v4; // r8
