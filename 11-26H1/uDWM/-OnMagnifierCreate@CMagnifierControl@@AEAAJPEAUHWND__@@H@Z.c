/*
 * XREFs of ?OnMagnifierCreate@CMagnifierControl@@AEAAJPEAUHWND__@@H@Z @ 0x1800BA730
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierCreate(struct CVisual **this, HWND a2, unsigned int a3)
{
  ...
  CBaseObject *v17; // [rsp+60h] [rbp+8h] BYREF
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F91C4, 1LL, -2147024809, 0x245u, 0LL);
  }
  else
  {
    ...
    {
      v9 = -2147023728;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F91C4, 1LL, -2147023728, 0x23Au, 0LL);
LABEL_17:
      v6 = v17;
      goto LABEL_19;
    }
    ...
    if ( v13 )
    {
      ...
      if ( IsMagnifier < 0 )
      {
        v15 = 563;
LABEL_16:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F91C4, 1LL, IsMagnifier, v15, 0LL);
        goto LABEL_17;
      }
    }
    else
    ...
    {
      v9 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F91C4, 1LL, -2147024882, 0x23Fu, 0LL);
    }
