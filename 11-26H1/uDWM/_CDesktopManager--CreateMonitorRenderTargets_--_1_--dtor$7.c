/*
 * XREFs of _CDesktopManager::CreateMonitorRenderTargets_::_1_::dtor$7 @ 0x1800E8F75
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
BOOL __fastcall CDesktopManager::CreateMonitorRenderTargets_::_1_::dtor_7(__int64 a1, __int64 a2)
{
