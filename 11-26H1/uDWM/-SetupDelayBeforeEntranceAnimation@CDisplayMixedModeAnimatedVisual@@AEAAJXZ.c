/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayMixedModeAnimatedVisual@@AEAAJXZ @ 0x1800B272C
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z @ 0x1800B2660 (-OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayMixedModeAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=(this + 54, v2);
  if ( !*v6 )
  {
    v7 = -2147024882;
    v8 = 155LL;
