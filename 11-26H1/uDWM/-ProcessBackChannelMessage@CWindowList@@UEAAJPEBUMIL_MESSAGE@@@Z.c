/*
 * XREFs of ?ProcessBackChannelMessage@CWindowList@@UEAAJPEBUMIL_MESSAGE@@@Z @ 0x18003DF60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  {
    v2 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147418113, 0x700u, 0LL);
  }
  return v2;
}
