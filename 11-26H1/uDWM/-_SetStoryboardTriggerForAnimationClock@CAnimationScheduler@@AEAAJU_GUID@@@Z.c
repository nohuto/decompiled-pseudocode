/*
 * XREFs of ?_SetStoryboardTriggerForAnimationClock@CAnimationScheduler@@AEAAJU_GUID@@@Z @ 0x18003E6A4
 * Callers:
 ...
 *     ?UseDComposition@CStoryboard@@QEAA_NXZ @ 0x18003E8F0 (-UseDComposition@CStoryboard@@QEAA_NXZ.c)
