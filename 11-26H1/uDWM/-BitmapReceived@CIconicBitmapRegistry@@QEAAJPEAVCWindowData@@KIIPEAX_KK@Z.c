/*
 * XREFs of ?BitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_KK@Z @ 0x18007132C
 * Callers:
        ...
        char a8)
{
    ...
    && v14 )
  {
    if ( !CIconicBitmapRegistry::CanAcceptBitmap(this, a2) )
    {
      if ( ((unsigned __int8)v20 & (unsigned __int8)Microsoft_Windows_Dwm_UdwmEnableBits) != 0 )
        McTemplateU0qp_EtwEventWriteTransfer(v19, &UdwmManageIconicThumbnail_Info, v20);
      return v10;
    }
    if ( !IsWindowTab(a2) )
    {
      ...
      if ( !(unsigned int)DwmGetIdealIconicThumbnailSize(v21, &v31) )
      {
        if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
          McTemplateU0qp_EtwEventWriteTransfer(v22, &UdwmManageIconicThumbnail_Info, 1LL);
        v10 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F6BB8, 1LL, -2147467259, 0x296u, 0LL);
        return v10;
      }
      cx = v31.cx;
      cy = v31.cy;
    ...
    if ( v25 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F6BB8, 1LL, v25, 0x2A5u, 0LL);
      v11 = v29;
    }
    else
    {
  ...
  {
    if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
      McTemplateU0qp_EtwEventWriteTransfer(v13, &UdwmManageIconicThumbnail_Info, 1LL);
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F6BB8, 1LL, -2147024809, 0x284u, 0LL);
  }
  if ( v11 )
