/*
 * XREFs of ?IsFullscreen@?$consume_Udwm_Transitions_ITopLevelWindow3DWrapper@UITopLevelWindow3DWrapper@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x1800406C8
 * Callers:
...
char __fastcall winrt::impl::consume_Udwm_Transitions_ITopLevelWindow3DWrapper<winrt::Udwm::Transitions::ITopLevelWindow3DWrapper>::IsFullscreen(
        __int64 **a1)
{
  __int64 *v1; // rcx
  __int64 v2; // rax
  ...
  v2 = *v1;
  v7 = 0LL;
  v3 = (*(__int64 (__fastcall **)(__int64 *, char *))(v2 + 48))(v1, &v8);
  if ( v3 < 0 )
