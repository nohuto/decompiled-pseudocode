/*
 * XREFs of _CDisplaySecondaryOnlyToExtendAnimatedVisual::Create_::_1_::dtor$0 @ 0x1800E9029
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDisplaySecondaryOnlyToExtendAnimatedVisual::Create_::_1_::dtor_0(__int64 a1, __int64 a2)
{
