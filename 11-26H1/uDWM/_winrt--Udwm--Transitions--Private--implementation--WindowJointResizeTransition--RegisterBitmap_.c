/*
 * XREFs of _winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::RegisterBitmap_::_1_::dtor$0 @ 0x1800E968A
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransition::RegisterBitmap_::_1_::dtor_0(
        __int64 a1,
        __int64 a2)
{
