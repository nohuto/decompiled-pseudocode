/*
 * XREFs of ?StopImpl@CDisplayExtendToDuplicateAnimatedVisual@@EEAAJXZ @ 0x1800B1D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDisplayExtendToDuplicateAnimatedVisual::StopImpl(CDisplayExtendToDuplicateAnimatedVisual *this)
{
  ...
  int v4; // eax
  unsigned int v5; // ebx
  unsigned int *v7[5]; // [rsp+20h] [rbp-28h] BYREF
  ...
  *((_QWORD *)this + 49) = 0LL;
  ...
  v7[0] = (unsigned int *)((char *)this + 400);
  v7[1] = (unsigned int *)((char *)this + 404);
  v7[2] = (unsigned int *)((char *)this + 408);
  v7[3] = (unsigned int *)((char *)this + 412);
