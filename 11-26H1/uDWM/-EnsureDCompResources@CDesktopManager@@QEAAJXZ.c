/*
 * XREFs of ?EnsureDCompResources@CDesktopManager@@QEAAJXZ @ 0x1800624F0
 * Callers:
...
__int64 __fastcall CDesktopManager::EnsureDCompResources(CDesktopManager *this)
{
  ...
  if ( !*((_QWORD *)this + 10) )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x5A1u, 0LL);
    }
    else
    {
      ...
      v10 = (*(__int64 (__fastcall **)(__int64, GUID *, __int64))(*(_QWORD *)v9 + 216LL))(
              v9,
      ...
      if ( v10 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, VisualTargetProxyFromSharedHandle, 0x5ACu, 0LL);
          }
          else
          {
            ...
            v1 = v14;
            if ( v14 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x5AEu, 0LL);
            else
              (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*((_QWORD *)this + 6) + 32LL) + 24LL))(*(_QWORD *)(*((_QWORD *)this + 6) + 32LL));
          }
        }
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x5AAu, 0LL);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x5A4u, 0LL);
      }
    }
    if ( hObject )
      CloseHandle(hObject);
