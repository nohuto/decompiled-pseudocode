/*
 * XREFs of ??1CCubicBezierChopper@CThemeAnimationScheduleHelper@@QEAA@XZ @ 0x18009904C
 * Callers:
 ...
 *     _CThemeAnimationScheduleHelper::CreateAndAddChoppedCubicBezierTransition_::_1_::dtor$0 @ 0x1800E8B9C (_CThemeAnimationScheduleHelper--CreateAndAddChoppedCubicBezierTransition_--_1_--dtor$0.c)
 * Callees:
