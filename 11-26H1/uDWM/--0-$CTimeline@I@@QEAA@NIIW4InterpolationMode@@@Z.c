/*
 * XREFs of ??0?$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z @ 0x1800DE6D8
 * Callers:
...
_QWORD *__fastcall CTimeline<unsigned int>::CTimeline<unsigned int>(CBaseObject *a1, double a2, __int64 a3, int a4)
{
  _QWORD *v4; // r10
  _QWORD *result; // rax
