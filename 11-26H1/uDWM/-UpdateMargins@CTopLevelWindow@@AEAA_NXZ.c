/*
 * XREFs of ?UpdateMargins@CTopLevelWindow@@AEAA_NXZ @ 0x18001EC20
 * Callers:
...
_BOOL8 __fastcall CTopLevelWindow::UpdateMargins(CTopLevelWindow *this)
{
  ...
  v5 = v1[17];
  v6 = v1[19];
  v7 = SetMargin((struct _MARGINS *)((char *)this + 572), v3, v5, v4, v6, 0LL);
  ...
  v15 = SetMargin((struct _MARGINS *)((char *)this + 588), v11 + v3, v13 + v5, v4 + v12, v14 + v6, 0LL) || v7;
  if ( v15 )
  {
    v17 = (struct CWindowData *)*((_QWORD *)this + 87);
