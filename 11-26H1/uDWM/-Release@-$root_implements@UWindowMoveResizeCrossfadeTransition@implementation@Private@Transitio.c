/*
 * XREFs of ?Release@?$root_implements@UWindowMoveResizeCrossfadeTransition@implementation@Private@Transitions@Udwm@winrt@@U13456@@impl@winrt@@QEAAIXZ @ 0x18002F170
 * Callers:
        ...
        __int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    v2 = _InterlockedCompareExchange64(v6, v8, (signed __int64)v7);
    v4 = v2;
    v3 = v2;
    if ( v7 == (void *)v2 )
      goto LABEL_4;
  ...
  if ( !v5 )
    winrt::impl::weak_ref<1,1>::Release(v7);
LABEL_4:
  if ( !v5 )
  {
    std::_Atomic_storage<unsigned __int64,8>::store(a1 + 8, v3, v7);
    if ( a1 )
