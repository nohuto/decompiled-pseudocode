/*
 * XREFs of ?BeginClip@AnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@QEAA?AURect@Foundation@Windows@5@XZ @ 0x1800D0C78
 * Callers:
 ...
 *     ?GetBeginClip@CAnimatedTransitionVisual@@UEAAJPEAUtagRECT@@@Z @ 0x180096290 (-GetBeginClip@CAnimatedTransitionVisual@@UEAAJPEAUtagRECT@@@Z.c)
 */
        ...
        __int64 a2)
{
  ...
  v13 = 0LL;
  CAnimatedTransitionVisual::GetBeginClip(v4, &v13);
