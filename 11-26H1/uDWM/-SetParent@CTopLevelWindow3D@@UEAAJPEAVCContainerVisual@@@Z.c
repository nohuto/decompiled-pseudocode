/*
 * XREFs of ?SetParent@CTopLevelWindow3D@@UEAAJPEAVCContainerVisual@@@Z @ 0x18006C950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTopLevelWindow3D::SetParent(CTopLevelWindow3D *this, struct CContainerVisual *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x73Du, 0LL);
  }
  else if ( !a2 )
  {
    ...
    v5 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x742u, 0LL);
  }
  return v5;
}
