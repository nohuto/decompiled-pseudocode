/*
 * XREFs of ?SetRepresentationType@CImmersiveWindowIconic@@QEAAJW4IconicRepresentationType@@_N@Z @ 0x1800B8004
 * Callers:
  ...
  *((_DWORD *)a1 + 54) = a2;
  if ( a2 != 1 )
  {
    ImmersiveIconContainerSize = CImmersiveIconicBitmapRegistry::GetImmersiveIconContainerSize(
                                   (enum DEVICE_SCALE_FACTOR)*((_DWORD *)a1 + 57),
                                   a2);
    v9 = *((_DWORD *)a1 + 57);
    *((_DWORD *)a1 + 55) = ImmersiveIconContainerSize - 2;
    *((_DWORD *)a1 + 56) = CImmersiveIconicBitmapRegistry::GetImmersiveIconContainerSize(v9, a2);
  }
  if ( *((_DWORD *)a1 + 54) != v3 )
  {
    if ( a3 )
    {
      ...
      v4 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0xEAu, 0LL);
    }
  }
  return v4;
}
