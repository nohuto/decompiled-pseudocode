/*
 * XREFs of ?Create@CCompositionEffectCache@@SAJPEAPEAV1@@Z @ 0x180076B24
 * Callers:
 *     ?Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z @ 0x1800720A0 (-Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z.c)
 * Callees:
 *     ??$make_unique@VCCompositionEffectCache@@$$V$0A@@std@@YA?AV?$unique_ptr@VCCompositionEffectCache@@U?$default_delete@VCCompositionEffectCache@@@std@@@0@XZ @ 0x180076BA4 (--$make_unique@VCCompositionEffectCache@@$$V$0A@@std@@YA-AV-$unique_ptr@VCCompositionEffectCache.c)
