/*
 * XREFs of ?QueryInterface@CCubicBezierInterpolator@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9C40
 * Callers:
 *     <none>
 * Callees:
 *     ?AddRef@CCubicBezierInterpolator@@UEAAKXZ @ 0x1800A97C0 (-AddRef@CCubicBezierInterpolator@@UEAAKXZ.c)
 */
