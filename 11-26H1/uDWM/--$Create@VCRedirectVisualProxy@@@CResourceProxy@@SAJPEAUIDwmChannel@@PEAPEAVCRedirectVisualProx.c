/*
 * XREFs of ??$Create@VCRedirectVisualProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCRedirectVisualProxy@@@Z @ 0x1800A7560
 * Callers:
...
__int64 __fastcall CResourceProxy::Create<CRedirectVisualProxy>(struct IDwmChannel *a1, CRedirectVisualProxy **a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  __int64 v6; // r9
  __int64 v7; // rdx
  CRedirectVisualProxy *v8; // rax
  int v9; // eax
  wil::details::in1diag3 *retaddr; // [rsp+38h] [rbp+0h]
  unsigned int v12; // [rsp+40h] [rbp+8h] BYREF
  CBaseObject *v13; // [rsp+50h] [rbp+18h] BYREF
  CRedirectVisualProxy *v14; // [rsp+58h] [rbp+20h]

  v13 = 0LL;
  v12 = 0;
  v4 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 14LL, &v12);
  v5 = v4;
  if ( v4 >= 0 )
  {
    v8 = (CRedirectVisualProxy *)DefaultHeap::AllocClear(0x28uLL);
    v14 = v8;
    if ( v8 )
      v8 = CRedirectVisualProxy::CRedirectVisualProxy(v8, a1, v12);
    v13 = v8;
    if ( v8 )
    {
      v13 = 0LL;
