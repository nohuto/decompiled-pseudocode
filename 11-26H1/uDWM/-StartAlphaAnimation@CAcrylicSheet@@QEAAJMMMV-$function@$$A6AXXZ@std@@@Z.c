/*
 * XREFs of ?StartAlphaAnimation@CAcrylicSheet@@QEAAJMMMV?$function@$$A6AXXZ@std@@@Z @ 0x180095B90
 * Callers:
...
__int64 __fastcall CAcrylicSheet::StartAlphaAnimation(CAcrylicSheet *this, float a2, float a3, float a4, __int64 a5)
{
  ...
  v6 = (char *)this + 224;
  std::function<void (void)>::operator=((__int64)this + 224, a5);
  started = CAcrylicSheet::StartAlphaAnimation(this, a2, a3, a4);
  v9 = started;
  if ( started < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x29Du, 0LL);
