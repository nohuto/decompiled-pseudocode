/*
 * XREFs of ??$Create@VCCombinedGeometryProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCCombinedGeometryProxy@@@Z @ 0x1800833D0
 * Callers:
 *     ?CreateCombinedGeometryProxy@CCompositor@@QEAAJPEAPEAVCCombinedGeometryProxy@@@Z @ 0x180081AF8 (-CreateCombinedGeometryProxy@CCompositor@@QEAAJPEAPEAVCCombinedGeometryProxy@@@Z.c)
 * Callees:
...
__int64 __fastcall CResourceProxy::Create<CCombinedGeometryProxy>(struct IDwmChannel *a1, CBaseObject **a2)
{
  unsigned int v4; // ebx
  int v5; // eax
  unsigned int v6; // edi
  ...
  v14 = 0LL;
  v13 = 0;
  v5 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 3LL, &v13);
  v6 = v5;
  if ( v5 < 0 )
  {
  ...
  v9 = CCombinedGeometryProxy::CCombinedGeometryProxy(v8, a1, v13);
  v14 = v9;
  if ( !v9 )
  {
LABEL_7:
