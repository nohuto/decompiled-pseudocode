/*
 * XREFs of ?_Change_array@?$vector@U_DWMCaptureWindowInformation@@V?$allocator@U_DWMCaptureWindowInformation@@@std@@@std@@AEAAXQEAU_DWMCaptureWindowInformation@@_K1@Z @ 0x1800A4AF0
 * Callers:
