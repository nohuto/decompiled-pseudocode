/*
 * XREFs of ??$save_nothrow@Utest_flag@tip2@@@tson@@YAXAEAVoutput_archive@0@AEAV?$vector_nothrow@Utest_flag@tip2@@@tip2@@@Z @ 0x1800D23EC
 * Callers:
 ...
 * Callees:
 *     ??$?RUsize_tag@tson@@@output_archive@tson@@QEAAAEAV01@$$QEAUsize_tag@1@@Z @ 0x1800D1A78 (--$-RUsize_tag@tson@@@output_archive@tson@@QEAAAEAV01@$$QEAUsize_tag@1@@Z.c)
...
void __fastcall tson::save_nothrow<tip2::test_flag>(tson::output_archive *this, __int64 a2)
{
  __int64 v3; // r10
  struct tson::output_archive *v4; // rbx
  __int64 v5; // rsi
  struct tip2::test_flag *v6; // r8
  __int64 v7; // [rsp+38h] [rbp+10h] BYREF

  v7 = *(_QWORD *)(a2 + 16);
  tson::output_archive::operator()<tson::size_tag>((__int64)this, &v7);
  v4 = *(struct tson::output_archive **)v3;
  v5 = *(_QWORD *)v3 + 104LL * *(_QWORD *)(v3 + 16);
  while ( v4 != (struct tson::output_archive *)v5 )
  {
    ...
    v4 = (struct tson::output_archive *)((char *)v4 + 104);
  }
}
