/*
 * XREFs of CWindowList::ForEachSoftwareCursorListener__CWindowList::UpdateCursorPosition_::_2_::_lambda_1___ @ 0x1800DF0F0
 * Callers:
...
void __fastcall CWindowList::ForEachSoftwareCursorListener__CWindowList::UpdateCursorPosition_::_2_::_lambda_1___(
        __int64 a1,
        _QWORD *a2)
{
  __int64 i; // rbx
