/*
 * XREFs of McTemplateU0pddddq_EtwEventWriteTransfer @ 0x1800D0330
 * Callers:
...
__int64 __fastcall McTemplateU0pddddq_EtwEventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  return McGenEventWrite_EtwEventWriteTransfer(
           ...
           (unsigned int)&UdwmSystemAnimation_ClipVisual,
           a3,
           7,
           (__int64)v9);
}
