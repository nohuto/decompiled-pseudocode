/*
 * XREFs of ?get@?$weak_ref@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@@winrt@@QEBA@XZ @ 0x18008BFD4
 * Callers:
...
struct IUnknown *__fastcall winrt::weak_ref<winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper>::get(
        __int64 *a1,
        struct IUnknown *a2)
{
  __int64 v2; // rsi
  ...
  if ( *a1 )
  {
    ...
    v4(v2, &winrt::impl::guid_v<winrt::Udwm::Transitions::ITopLevelWindow3DWrapper>, v5);
    v6 = 0LL;
    if ( v8 )
    {
