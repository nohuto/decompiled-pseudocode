/*
 * XREFs of ??$Create@VCLegacyVisualCaptureRenderTargetProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAPEAVCLegacyVisualCaptureRenderTargetProxy@@@Z @ 0x1800A7248
 * Callers:
...
__int64 __fastcall CResourceProxy::Create<CLegacyVisualCaptureRenderTargetProxy>(
        ...
        CBaseObject **a2)
{
  ...
  v14 = 0LL;
  v13 = 0;
  v4 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, unsigned int *))(*(_QWORD *)a1 + 72LL))(a1, 9LL, &v13);
  v5 = v4;
  if ( v4 < 0 )
  {
    v6 = (unsigned int)v4;
...
LABEL_10:
  ...
  v9 = CLegacyVisualCaptureRenderTargetProxy::CLegacyVisualCaptureRenderTargetProxy(v8, a1, v13);
  v14 = v9;
  if ( !v9 )
  {
LABEL_7:
