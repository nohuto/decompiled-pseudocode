/*
 * XREFs of ?_Change_array@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@AEAAXQEAUtagRECT@@_K1@Z @ 0x1800B2920
 * Callers:
...
void __fastcall std::vector<tagRECT>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = *(void **)a1;
  if ( v6 )
    std::_Deallocate<16>(v6, (*(_QWORD *)(a1 + 16) - (_QWORD)v6) & 0xFFFFFFFFFFFFFFF0uLL);
  *(_QWORD *)a1 = a2;
