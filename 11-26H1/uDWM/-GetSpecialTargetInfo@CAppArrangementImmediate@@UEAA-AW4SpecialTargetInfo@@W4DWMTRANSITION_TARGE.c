/*
 * XREFs of ?GetSpecialTargetInfo@CAppArrangementImmediate@@UEAA?AW4SpecialTargetInfo@@W4DWMTRANSITION_TARGET@@@Z @ 0x1800C12F0
 * Callers:
...
__int64 __fastcall CAppArrangementImmediate::GetSpecialTargetInfo(__int64 a1, int a2)
{
  unsigned int v2; // r8d
  unsigned int v3; // ecx
  _DWORD *v4; // r9
  ...
  v2 = 0;
  v3 = 0;
  v4 = `CAppArrangementImmediate::GetSpecialTargetInfo'::`2'::s_rgSpecialTargetLookupTable;
  while ( v3 < 0x15 )
  {
    if ( ((*v4 ^ a2) & 0xFFF) == 0 )
