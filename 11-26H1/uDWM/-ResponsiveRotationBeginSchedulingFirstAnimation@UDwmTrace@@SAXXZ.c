/*
 * XREFs of ?ResponsiveRotationBeginSchedulingFirstAnimation@UDwmTrace@@SAXXZ @ 0x180089A48
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationBeginSchedulingFirstAnimation(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rcx
  int v3; // ecx
  __int64 v4; // r8
