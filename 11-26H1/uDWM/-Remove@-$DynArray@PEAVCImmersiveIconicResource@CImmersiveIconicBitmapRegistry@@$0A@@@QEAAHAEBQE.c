/*
 * XREFs of ?Remove@?$DynArray@PEAVCImmersiveIconicResource@CImmersiveIconicBitmapRegistry@@$0A@@@QEAAHAEBQEAVCImmersiveIconicResource@CImmersiveIconicBitmapRegistry@@@Z @ 0x18004D1D0
 * Callers:
        ...
        __int64 *a2)
{
  ...
  if ( (unsigned int)v3 < v2 - 1 )
  {
    do
    {
      ...
      *(_QWORD *)(v4 + 8LL * (unsigned int)v3) = *(_QWORD *)(v4 + 8 * v6);
      LODWORD(v3) = v3 + 1;
    }
