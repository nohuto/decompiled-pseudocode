/*
 * XREFs of ?IsFullscreen@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAA_NXZ @ 0x18006EB50
 * Callers:
 *     ?get_IsFullscreen@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHPEA_N@Z @ 0x18006EB10 (-get_IsFullscreen@-$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITo.c)
 * Callees:
        ...
        winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper *this)
{
  ...
  v3 = 0;
  if ( !GetMonitorInfoW(*(HMONITOR *)(*(_QWORD *)(v1 + 232) + 384LL), &mi) )
    return 1;
  v4 = 0;
