/*
 * XREFs of ?Rect@?$consume_Udwm_Transitions_IUserResizeVisual@UIUserResizeVisual@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@AEBU0Foundation@Windows@3@@Z @ 0x18007BF18
 * Callers:
