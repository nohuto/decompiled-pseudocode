/*
 * XREFs of ?StartThemeAnimation@CInputView_SizeOrModeChangeBase@@AEAAJPEAVCWindowData@@@Z @ 0x1800C2BD8
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  {
    v7 = (*((_DWORD *)a2 + 186) & 0x1000000) == 0;
    v8 = (CAnimatedTransitionVisual **)v11;
    v10 = *(struct tagRECT *)((char *)v11 + 88);
    if ( !v7 )
      v10 = *(struct tagRECT *)((char *)a2 + 764);
    CAnimatedTransitionVisual::SetBeginRect(*((CAnimatedTransitionVisual **)v11 + 5), &v10);
