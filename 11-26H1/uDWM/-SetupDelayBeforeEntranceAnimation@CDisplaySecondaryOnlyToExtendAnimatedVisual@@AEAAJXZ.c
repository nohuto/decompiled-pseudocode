/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplaySecondaryOnlyToExtendAnimatedVisual@@AEAAJXZ @ 0x1800B44A0
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplaySecondaryOnlyToExtendAnimatedVisual@@EEAAJI@Z @ 0x1800B4300 (-OnAnimationCompleteImpl@CDisplaySecondaryOnlyToExtendAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplaySecondaryOnlyToExtendAnimatedVisual::SetupDelayBeforeEntranceAnimation(CTimelineBase **this)
{
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=(this + 48, v2);
  if ( !*v6 )
  {
    v7 = -2147024882;
    v8 = 336LL;
