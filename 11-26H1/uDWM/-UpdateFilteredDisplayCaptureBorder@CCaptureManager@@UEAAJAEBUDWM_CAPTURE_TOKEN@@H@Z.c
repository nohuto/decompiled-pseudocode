/*
 * XREFs of ?UpdateFilteredDisplayCaptureBorder@CCaptureManager@@UEAAJAEBUDWM_CAPTURE_TOKEN@@H@Z @ 0x1800A3580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCaptureManager::UpdateFilteredDisplayCaptureBorder(
