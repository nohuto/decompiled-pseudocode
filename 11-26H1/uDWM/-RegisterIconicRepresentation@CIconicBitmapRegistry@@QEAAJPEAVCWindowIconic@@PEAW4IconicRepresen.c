/*
 * XREFs of ?RegisterIconicRepresentation@CIconicBitmapRegistry@@QEAAJPEAVCWindowIconic@@PEAW4IconicRepresentationType@@@Z @ 0x180038A3C
 * Callers:
        ...
        enum IconicRepresentationType *a3)
{
  ...
  if ( *((_BYTE *)a2 + 20) )
  {
    ...
    v13 = *((_BYTE *)this + 88);
    v11 = *((_BYTE *)this + 89);
    CanAcceptBitmap = (*(_BYTE *)(v4 + 738) & 2) != 0;
    v4 = -(__int64)(*(_QWORD *)(v4 + 920) != 0LL) - 1;
  }
  else
  {
