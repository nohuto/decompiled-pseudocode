/*
 * XREFs of ?CloneVisualTree@CLightMicaSystemBackdropVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x18006E860
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLightMicaSystemBackdropVisual::CloneVisualTree(__int64 a1, CBaseObject **a2, unsigned int a3)
{
  int v6; // eax
  unsigned int v7; // ebx
  CBaseObject *v8; // rbx
  ...
  *a2 = 0LL;
  v14 = 0LL;
  v6 = CSystemBackdropVisual::Create(4, &v14);
  v7 = v6;
  if ( v6 < 0 )
  {
