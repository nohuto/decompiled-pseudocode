/*
 * XREFs of ?CreateTextLayout@CDWriteText@@AEAAJXZ @ 0x18000BE00
 * Callers:
...
__int64 __fastcall CDWriteText::CreateTextLayout(CDWriteText *this)
{
  ...
  v2 = (char *)this + 356;
  v3 = (char *)this + 264;
  if ( memcmp_0((char *)this + 264, (char *)this + 356, 0x5CuLL) )
  {
    *(_OWORD *)v2 = *(_OWORD *)v3;
  ...
  TextFormat = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 27) + 40LL))(
                 *((_QWORD *)this + 27),
                 1LL);
  if ( TextFormat < 0 )
  {
  ...
  if ( *((_BYTE *)this + 464) )
  {
    TextFormat = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 27) + 48LL))(
                   *((_QWORD *)this + 27),
                   1LL);
    if ( TextFormat < 0 )
    {
  ...
  if ( *((_BYTE *)this + 465) )
  {
    TextFormat = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 27) + 24LL))(
                   *((_QWORD *)this + 27),
                   1LL);
    if ( TextFormat < 0 )
    {
  ...
  Microsoft::WRL::ComPtr<IDCompositionTarget>::InternalRelease((char *)this + 224);
  v8 = (char *)this + 232;
  v9 = (char *)this + 232;
  if ( *((_QWORD *)this + 32) > 7uLL )
    v9 = *(char **)v8;
  v10 = -1LL;
  do
    ++v10;
  ...
  if ( *((_QWORD *)this + 32) > 7uLL )
    v8 = *(char **)v8;
  v17 = (float)(int)v5;
  TextFormat = v7(v6, v8, v10, *((_QWORD *)this + 27));
  if ( TextFormat < 0 )
  {
    v16 = 382LL;
LABEL_18:
  ...
  v12 = *v11;
  v18[0] = 0LL;
  v13 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, _QWORD *))(v12 + 160))(v11, *((_QWORD *)this + 27), v18);
  TextFormat = v13;
  if ( v13 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
  ...
  v19 = 1;
  v20 = 0LL;
  v14 = (*(__int64 (__fastcall **)(_QWORD, int *, _QWORD))(**((_QWORD **)this + 28) + 72LL))(
          *((_QWORD *)this + 28),
          &v19,
          v18[0]);
  TextFormat = v14;
