/*
 * XREFs of McTemplateU0ddqqqqqqp_EtwEventWriteTransfer @ 0x180097F80
 * Callers:
...
__int64 __fastcall McTemplateU0ddqqqqqqp_EtwEventWriteTransfer(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        char a11)
{
  ...
  int v31; // [rsp+100h] [rbp+3Fh] BYREF
  ...
  return McGenEventWrite_EtwEventWriteTransfer(
           ...
           (unsigned int)&UdwmAnimationResource_ResourceHandles,
           a3,
           10,
           (__int64)v12);
}
