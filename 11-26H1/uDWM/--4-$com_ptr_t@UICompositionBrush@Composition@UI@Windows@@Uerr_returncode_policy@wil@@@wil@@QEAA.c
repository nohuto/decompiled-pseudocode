/*
 * XREFs of ??4?$com_ptr_t@UICompositionBrush@Composition@UI@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAUICompositionBrush@Composition@UI@Windows@@@Z @ 0x18006A2A4
 * Callers:
