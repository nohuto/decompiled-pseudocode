/*
 * XREFs of ?ScreenDuplicationFailedToGetDisplayConfig@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800BE2D4
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationFailedToGetDisplayConfig(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rcx
  int v3; // ecx
