/*
 * XREFs of ?get_local_iids@?$implements@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x1800D8780
 * Callers:
 *     <none>
 * Callees:
 *     <none>
