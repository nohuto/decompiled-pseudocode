/*
 * XREFs of ?PostActivateLivePreview@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_ACTIVATELIVEPREVIEW@@@Z @ 0x1800E22C0
 * Callers:
...
__int64 __fastcall CWindowList::PostActivateLivePreview(CWindowList *this, HWND *a2)
{
  ...
  v8 = v7;
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1E57u, 0LL);
