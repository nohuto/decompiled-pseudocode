/*
 * XREFs of ?OnGlobalTimeUpdated@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x18007696C
 * Callers:
 *     ?OnGlobalTimeUpdated@?$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UIScreenRotationTransition@3456@@impl@winrt@@UEAAHXZ @ 0x180076940 (-OnGlobalTimeUpdated@-$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm.c)
 * Callees:
