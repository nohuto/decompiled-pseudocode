/*
 * XREFs of ?UpdateRect@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@QEAAXAEBURect@Foundation@Windows@6@@Z @ 0x1800D4370
 * Callers:
 *     ?UpdateRect@?$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@UITransition@456@@impl@winrt@@UEAAHURect@Foundation@Windows@3@@Z @ 0x1800D4360 (-UpdateRect@-$produce@UScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@U.c)
 * Callees:
