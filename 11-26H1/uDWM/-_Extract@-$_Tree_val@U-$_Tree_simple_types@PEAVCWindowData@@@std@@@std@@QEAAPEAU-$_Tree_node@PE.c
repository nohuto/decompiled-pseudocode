/*
 * XREFs of ?_Extract@?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAPEAU?$_Tree_node@PEAVCWindowData@@PEAX@2@V?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@U_Iterator_base0@2@@2@@Z @ 0x1800AF3A8
 * Callers:
 ...
 * Callees:
 *     ??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x1800AE9E0 (--E-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@PEAVCWindowData@@@std@@@s.c)
 *     ?_Lrotate@?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAXPEAU?$_Tree_node@PEAVCWindowData@@PEAX@2@@Z @ 0x1800AF770 (-_Lrotate@-$_Tree_val@U-$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAXPEAU-$_Tree_node@P.c)
 ...
 *     ?_Rrotate@?$_Tree_val@U?$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAXPEAU?$_Tree_node@PEAVCWindowData@@PEAX@2@@Z @ 0x1800AF7E4 (-_Rrotate@-$_Tree_val@U-$_Tree_simple_types@PEAVCWindowData@@@std@@@std@@QEAAXPEAU-$_Tree_node@P.c)
 */
...
__int64 *__fastcall std::_Tree_val<std::_Tree_simple_types<CWindowData *>>::_Extract(__int64 **a1, __int64 a2)
{
  ...
  v19 = (__int64 *)a2;
  std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<CWindowData *>>,std::_Iterator_base0>::operator++(
    (__int64 *)&v19,
    a2);
  v5 = v4[2];
  if ( *(_BYTE *)(*v4 + 25) )
