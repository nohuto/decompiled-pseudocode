/*
 * XREFs of ??$CreateTouchVisual@VCTouchPressHoldVisual@@@@YAJ_KPEAPEAVCTouchPressHoldVisual@@@Z @ 0x1800A840C
 * Callers:
...
__int64 __fastcall CreateTouchVisual<CTouchPressHoldVisual>(unsigned __int64 a1, CBaseObject **a2)
{
  ...
  v5 = (CTouchPressHoldVisual *)CContainerVisual::operator new(0x138uLL);
  if ( v5 )
  {
