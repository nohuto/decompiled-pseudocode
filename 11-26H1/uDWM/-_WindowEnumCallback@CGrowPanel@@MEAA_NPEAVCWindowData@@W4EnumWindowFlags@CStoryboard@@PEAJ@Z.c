/*
 * XREFs of ?_WindowEnumCallback@CGrowPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800C6D40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CGrowPanel@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800C0D60 (-GetPVLTarget@CGrowPanel@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
char __fastcall CGrowPanel::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) == 0 )
  {
    if ( (a3 & 4) == 0 || (*(_DWORD *)(a2 + 744) & 0xFFF) != 0x28 )
      goto LABEL_31;
    v27 = *(_OWORD *)(a2 + 48);
    *(_BYTE *)(a1 + 136) = 1;
    *(_OWORD *)(a1 + 140) = v27;
  ...
  v9 = (CStoryboard *)((*(_DWORD *)(a2 + 744) & 0xFFFu) - 40);
  if ( (*(_DWORD *)(a2 + 744) & 0xFFF) == 0x28 )
  {
    WPT = CStoryboard::_GetWPT(v9);
    if ( !CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(WPT, *(HWND *)(v22 + 40), 1) )
      goto LABEL_31;
    PVLTarget = CGrowPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 744));
    ...
    if ( v24 >= 0 )
    {
      ...
      v26 = (CAnimatedTransitionVisual *)*((_QWORD *)v31 + 5);
      v30 = v25;
...
LABEL_29:
  ...
  if ( *(_BYTE *)(a1 + 136) )
  {
    v12 = CGrowPanel::GetPVLTarget(a1, *(_DWORD *)(a2 + 744));
