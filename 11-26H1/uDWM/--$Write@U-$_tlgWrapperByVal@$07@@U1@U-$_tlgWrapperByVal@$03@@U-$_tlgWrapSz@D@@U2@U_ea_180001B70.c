        ...
        const unsigned __int16 **a23)
{
  ...
  v58 = 8LL;
  v56 = 8LL;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, a3, 0, 21, (__int64)v54);
}
