/*
 * XREFs of ?GetTrustLevel@?$implements@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@@@winrt@@UEAAJPEAW4TrustLevel@@@Z @ 0x1800D1050
 * Callers:
 *     <none>
 * Callees:
 *     <none>
