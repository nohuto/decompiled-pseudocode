/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_FixDwmAnimations@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800E40CC
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_FixDwmAnimations>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_FixDwmAnimations>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v7);
    v7 = v3;
  }
