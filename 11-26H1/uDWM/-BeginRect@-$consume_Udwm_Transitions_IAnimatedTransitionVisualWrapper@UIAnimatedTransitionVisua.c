/*
 * XREFs of ?BeginRect@?$consume_Udwm_Transitions_IAnimatedTransitionVisualWrapper@UIAnimatedTransitionVisualWrapper@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x1800404FC
 * Callers:
        ...
        _OWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v4 + 48LL))(v4, v3);
  if ( v5 < 0 )
