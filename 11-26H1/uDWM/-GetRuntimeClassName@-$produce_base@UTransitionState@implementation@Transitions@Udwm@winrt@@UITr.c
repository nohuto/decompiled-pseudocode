/*
 * XREFs of ?GetRuntimeClassName@?$produce_base@UTransitionState@implementation@Transitions@Udwm@winrt@@UITransitionState@345@X@impl@winrt@@UEAAHPEAPEAX@Z @ 0x1800DB410
 * Callers:
 *     <none>
 * Callees:
 *     <none>
