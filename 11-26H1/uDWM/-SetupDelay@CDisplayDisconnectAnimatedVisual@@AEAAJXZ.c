/*
 * XREFs of ?SetupDelay@CDisplayDisconnectAnimatedVisual@@AEAAJXZ @ 0x180070EF8
 * Callers:
...
__int64 __fastcall CDisplayDisconnectAnimatedVisual::SetupDelay(CDisplayDisconnectAnimatedVisual *this, __int64 a2)
{
  CBaseObject *v3; // rax
  _QWORD *v4; // r9
  _QWORD *v5; // r10
  ...
  if ( v3 )
  {
    CTimelineBase::CTimelineBase(v3, 1.0, 0.0, 1.0, 0);
