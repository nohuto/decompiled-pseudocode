/*
 * XREFs of ?EndAnimationFrameStats@ScreenRotationTransition@implementation@Private@Transitions@Udwm@winrt@@AEAAXXZ @ 0x180089D4C
 * Callers:
        ...
        winrt::Udwm::Transitions::Private::implementation::ScreenRotationTransition *this)
{
  ...
  if ( v3 )
  {
    ...
    if ( (*(int (__fastcall **)(__int64, __int128 *))(*(_QWORD *)v3 + 88LL))(v3, &v10) >= 0 )
    {
      ...
      std::_Integral_to_string<unsigned short,int>(v13, *((unsigned int *)this + 28));
      v6 = v13;
      if ( v13[3] > 7uLL )
        v6 = (_QWORD *)v13[0];
      v7 = v10;
    ...
    wil::com_ptr_t<Windows::UI::Composition::ICompositionSurface,wil::err_returncode_policy>::reset(v2);
    *((_DWORD *)this + 28) = 0;
  }
}
