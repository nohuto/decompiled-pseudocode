/*
 * XREFs of ?compare_exchange_strong@?$_Atomic_storage@_K$07@std@@QEAA_NAEA_K_KW4memory_order@2@@Z @ 0x18002F620
 * Callers:
 *     ?NonDelegatingAddRef@?$root_implements@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@@@impl@winrt@@IEAAIXZ @ 0x180086BD0 (-NonDelegatingAddRef@-$root_implements@UAnimatedTransitionVisualWrapper@implementation@Transitio.c)
