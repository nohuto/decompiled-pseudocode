/*
 * XREFs of ??$CreateFromSharedHandle@VCVisualSurfaceProxy@@@CResourceProxy@@SAJPEAUIDwmChannel@@PEAXPEAPEAVCVisualSurfaceProxy@@@Z @ 0x1800A7D98
 * Callers:
...
__int64 __fastcall CResourceProxy::CreateFromSharedHandle<CVisualSurfaceProxy>(
        ...
        CBaseObject **a3)
{
  ...
  v14 = 0LL;
  v5 = (*(__int64 (__fastcall **)(struct IDwmChannel *, __int64, __int64))(*(_QWORD *)a1 + 88LL))(a1, a2, 27LL);
  v6 = v5;
  if ( v5 < 0 )
  {
    v7 = (unsigned int)v5;
...
LABEL_10:
  ...
  v10 = CVisualSurfaceProxy::CVisualSurfaceProxy(v9, a1, 0);
  v14 = v10;
  if ( !v10 )
  {
LABEL_7:
