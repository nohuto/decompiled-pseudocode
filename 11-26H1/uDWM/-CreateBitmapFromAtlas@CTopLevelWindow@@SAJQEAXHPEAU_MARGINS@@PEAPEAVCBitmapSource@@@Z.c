/*
 * XREFs of ?CreateBitmapFromAtlas@CTopLevelWindow@@SAJQEAXHPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x18000504C
 * Callers:
        ...
        struct CBitmapSource **a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F4AB4, 1u, ThemeMargins, 0x1F4u, 0LL);
  }
  else
  {
    rc = 0LL;
    ...
    if ( ThemeRect < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F4AB4, 1u, ThemeRect, 0x1F8u, 0LL);
    }
    else
    {
      InflateRect(&rc, -1, -1);
      ...
      v9 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800F4AB4, 1u, v11, 0x200u, 0LL);
    }
  }
  return v9;
}
