/*
 * XREFs of ?ResponsiveRotationAnimationTeardownComplete@UDwmTrace@@SAXXZ @ 0x1800D35A8
 * Callers:
...
void __fastcall UDwmTrace::ResponsiveRotationAnimationTeardownComplete(__int64 a1, __int64 a2)
{
  _DWORD *v2; // rcx
  int v3; // ecx
  __int64 v4; // r8
