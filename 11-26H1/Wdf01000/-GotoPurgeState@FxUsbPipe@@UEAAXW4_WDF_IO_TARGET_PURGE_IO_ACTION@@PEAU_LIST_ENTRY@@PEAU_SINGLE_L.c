/*
 * XREFs of ?GotoPurgeState@FxUsbPipe@@UEAAXW4_WDF_IO_TARGET_PURGE_IO_ACTION@@PEAU_LIST_ENTRY@@PEAU_SINGLE_LIST_ENTRY@@PEAEE@Z @ 0x14009E440
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 LockSelf)
{
  ...
  _WDF_IO_TARGET_PURGE_IO_ACTION flags; // r12d
  ...
  _LIST_ENTRY *v18; // [rsp+80h] [rbp+18h]

  v18 = PendedRequestListHead;
  ...
  v13 = Wait;
  FxIoTarget::GotoPurgeState(this, flags, v18, SentRequestListHead, Wait, 0);
  ...
  if ( LockSelf )
    FxNonPagedObject::Unlock(this, v10, v14);
}
