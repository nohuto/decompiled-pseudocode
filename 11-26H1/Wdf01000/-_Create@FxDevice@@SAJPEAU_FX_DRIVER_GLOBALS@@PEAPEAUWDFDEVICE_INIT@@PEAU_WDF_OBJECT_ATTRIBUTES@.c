/*
 * XREFs of ?_Create@FxDevice@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAPEAUWDFDEVICE_INIT@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAPEAV1@@Z @ 0x14001FCC8
 * Callers:
 ...
 *     ??0FxDevice@@QEAA@PEAVFxDriver@@@Z @ 0x140020850 (--0FxDevice@@QEAA@PEAVFxDriver@@@Z.c)
        ...
        FxDevice **Device)
{
  ...
  *Device = 0LL;
  v8 = (FxDevice *)FxObjectHandleAlloc2(
                     FxDriverGlobals,
  ...
  FxDevice::FxDevice(v8, *(FxDriver **)(v4 + 8));
  v10 = v9;
  v11 = v9;
  if ( !v9 )
  {
