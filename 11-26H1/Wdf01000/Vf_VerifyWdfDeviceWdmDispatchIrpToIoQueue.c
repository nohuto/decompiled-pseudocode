/*
 * XREFs of Vf_VerifyWdfDeviceWdmDispatchIrpToIoQueue @ 0x1400E524C
 * Callers:
 *     imp_WdfDeviceWdmDispatchIrpToIoQueue @ 0x14000EBE0 (imp_WdfDeviceWdmDispatchIrpToIoQueue.c)
 * Callees:
 *     WPP_IFR_SF_qd @ 0x140012548 (WPP_IFR_SF_qd.c)
 *     ?GetDispatchPackage@FxDevice@@QEAAPEAVFxPackage@@E@Z @ 0x140058C80 (-GetDispatchPackage@FxDevice@@QEAAPEAVFxPackage@@E@Z.c)
 *     ?IsIoEventHandlerRegistered@FxIoQueue@@QEAAEW4_WDF_REQUEST_TYPE@@@Z @ 0x14005D834 (-IsIoEventHandlerRegistered@FxIoQueue@@QEAAEW4_WDF_REQUEST_TYPE@@@Z.c)
...
LABEL_9:
    ...
    if ( *p_m_ObjectSize <= (unsigned __int16)v18 )
      v13 = v18;
    v21 = (const void *)((unsigned __int64)queue ^ 0xFFFFFFFFFFFFFFF8uLL);
    if ( !m_ObjectSize )
      v21 = v18;
    WPP_IFR_SF_qqcDqd(FxDriverGlobals, v15, v16, v19, _a2, v21, v17, _a5, MinorFunction, v13);
    goto LABEL_29;
  }
  ...
  if ( m_ParentDevice == m_Device )
  {
    ...
    {
      v9 = -1073741811;
      v24 = *p_m_ObjectSize <= (unsigned __int16)v18;
      v25 = 67;
LABEL_19:
      if ( v24 )
        v13 = v18;
      WPP_IFR_SF_qd(FxDriverGlobals, 2u, 0xDu, v25, WPP_FxDeviceApi_cpp_Traceguids, v13, v9);
      goto LABEL_29;
    }
    m_PkgPnp = device->m_PkgPnp;
    if ( m_PkgPnp && BYTE3(m_PkgPnp[1].m_DisposeSingleEntry.Next) == (_BYTE)v18 )
    {
      v9 = -1073741808;
      v24 = device->m_ObjectSize <= (unsigned __int16)v18;
      v25 = 68;
      goto LABEL_19;
    }
  }
  ...
  {
    v9 = -1073741811;
    v27 = m_Device->m_ObjectSize;
    v28 = (const void *)((unsigned __int64)m_Device ^ 0xFFFFFFFFFFFFFFF8uLL);
    if ( !v27 )
      v28 = v18;
    WPP_IFR_SF_qd(FxDriverGlobals, 2u, 0xDu, 0x45u, WPP_FxDeviceApi_cpp_Traceguids, v28, -1073741811);
    goto LABEL_29;
  }
  return v9;
}
