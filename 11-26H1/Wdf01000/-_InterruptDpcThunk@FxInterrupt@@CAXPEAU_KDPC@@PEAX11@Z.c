/*
 * XREFs of ?_InterruptDpcThunk@FxInterrupt@@CAXPEAU_KDPC@@PEAX11@Z @ 0x140008670
 * Callers:
 *     <none>
 * Callees:
        ...
        void *SystemArgument2)
{
  ...
  else
  {
    ...
    v7 = *(void (__fastcall **)(void (__fastcall **)(unsigned __int64, unsigned __int64), __int64, __int64, __int64, char))(unk_1400C90A8 + 8LL);
    if ( v7 )
      v7(v6, 8LL, 2164260864LL, 3938LL, 2);
    v8 = *(_QWORD *)(DeferredContext + 16);
    if ( *(_BYTE *)(v8 + 348) )
      *(_QWORD *)((unsigned int)(unk_1400C9080 * HIDWORD(KeGetPcr()[1].LockArray)) + unk_1400C9070) = v8;
