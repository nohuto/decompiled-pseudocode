/*
 * XREFs of ?AllocateAdapterChannel@FxDmaPacketTransaction@@IEAAJE@Z @ 0x14001FAEC
 * Callers:
        ...
        unsigned __int8 MapRegistersReserved)
{
  ...
  if ( m_Globals->FxVerifierOn && m_Globals->FxVerboseOn )
  {
    ...
    if ( !this->m_ObjectSize )
      _a2 = 0LL;
    WPP_IFR_SF_dq(m_Globals, 5u, 0xFu, v13, WPP_FxDmaTransactionPacket_hpp_Traceguids, this->m_MapRegistersNeeded, _a2);
  }
