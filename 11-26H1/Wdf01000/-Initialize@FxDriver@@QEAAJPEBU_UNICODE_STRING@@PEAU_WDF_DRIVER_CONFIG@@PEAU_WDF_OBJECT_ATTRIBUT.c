/*
 * XREFs of ?Initialize@FxDriver@@QEAAJPEBU_UNICODE_STRING@@PEAU_WDF_DRIVER_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1400729D4
 * Callers:
 ...
 *     ?AllocateDriverObjectExtensionAndStoreFxDriver@FxDriver@@QEAAJXZ @ 0x140072D74 (-AllocateDriverObjectExtensionAndStoreFxDriver@FxDriver@@QEAAJXZ.c)
        ...
        _WDF_OBJECT_ATTRIBUTES *DriverAttributes)
{
  ...
  wchar_t *v21; // rax
  wchar_t *Buffer; // rax
  unsigned int DriverInitFlags; // edx
  ...
  if ( m_DriverObject )
  {
    DriverObjectExtensionAndStoreFxDriver = FxDisposeList::_Create(m_Globals, m_DriverObject, &this->m_DisposeList, v9);
      ...
      if ( DriverObjectExtensionAndStoreFxDriver >= 0 )
      {
        ...
        else if ( DriverObjectExtensionAndStoreFxDriver >= 0 )
        {
          ...
          if ( (DriverInitFlags & 2) == 0 )
          {
            ...
            do
            {
              v26 = (unsigned int)FxDevice::_RequiresRemLock(v25, 0) == 0;
