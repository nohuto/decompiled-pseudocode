/*
 * XREFs of ?FxCalculateObjectTotalSize2@@YAJPEAU_FX_DRIVER_GLOBALS@@GG_KPEA_K@Z @ 0x1400261F0
 * Callers:
        ...
        unsigned __int64 *Total)
{
  ...
  v9 = ((unsigned __int16)(RawObjectSize + 15) & 0xFFF0) + (unsigned __int64)((unsigned __int16)(level + 15) & 0xFFF0);
  v10 = v9 + 48;
  if ( v9 + 48 < v9 )
  {
    *Total = -1LL;
