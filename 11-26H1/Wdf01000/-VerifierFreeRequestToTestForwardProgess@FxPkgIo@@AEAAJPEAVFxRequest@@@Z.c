/*
 * XREFs of ?VerifierFreeRequestToTestForwardProgess@FxPkgIo@@AEAAJPEAVFxRequest@@@Z @ 0x1400A16FC
 * Callers:
...
__int64 __fastcall FxPkgIo::VerifierFreeRequestToTestForwardProgess(FxPkgIo *this, FxRequest *Request)
{
  ...
  if ( (FxEnhancedVerifierOptions & 0x10000) == 0 )
  {
    if ( (FxEnhancedVerifierOptions & 0x20000) == 0 )
      return 0LL;
    v4 = 1103515245 * this->m_RandomSeed + 12345;
    this->m_RandomSeed = v4;
    if ( (HIWORD(v4) & 0x7FFF) != 17 * ((HIWORD(v4) & 0x7FFF) / 0x11u) )
      return 0LL;
  }
