/*
 * XREFs of ?CompleteSubmitted@FxRequestBase@@QEAAXXZ @ 0x1400486F0
 * Callers:
 ...
 * Callees:
 *     ?VerifierClearFormatted@FxRequestBase@@QEAAXXZ @ 0x14006154C (-VerifierClearFormatted@FxRequestBase@@QEAAXXZ.c)
