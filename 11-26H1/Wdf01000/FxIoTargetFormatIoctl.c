/*
 * XREFs of FxIoTargetFormatIoctl @ 0x14005D154
 * Callers:
 *     imp_WdfIoTargetFormatRequestForIoctl @ 0x14005D0A0 (imp_WdfIoTargetFormatRequestForIoctl.c)
 *     imp_WdfIoTargetFormatRequestForInternalIoctl @ 0x14005D100 (imp_WdfIoTargetFormatRequestForInternalIoctl.c)
 * Callees:
        ...
        _WDFMEMORY_OFFSET *OutputBufferOffsets)
{
  ...
  FxRequestBuffer *v48; // [rsp+20h] [rbp-A1h]
  FxFileObject *level; // [rsp+30h] [rbp-91h]
  FxIoTarget *pTarget; // [rsp+60h] [rbp-61h] BYREF
  FxRequest *pRequest; // [rsp+68h] [rbp-59h] BYREF
  void *p_pTarget; // [rsp+70h] [rbp-51h] BYREF
  __int16 v53; // [rsp+78h] [rbp-49h]
  __int16 v54; // [rsp+7Ah] [rbp-47h]
  int v55; // [rsp+7Ch] [rbp-45h]
  FxRequestBuffer outputBuf; // [rsp+80h] [rbp-41h] BYREF
  FxRequestBuffer inputBuf; // [rsp+A0h] [rbp-21h] BYREF
  IFxMemory *pInputMemory; // [rsp+110h] [rbp+4Fh] BYREF
  IFxMemory *pOutputMemory; // [rsp+118h] [rbp+57h] BYREF
  void *_a2; // [rsp+120h] [rbp+5Fh]
  unsigned int v61; // [rsp+128h] [rbp+67h]
  ...
  if ( (IoTarget & 1) != 0 )
  {
    v9 = LOWORD(v13->__vftable);
    v13 = (FxIoTarget *)((char *)v13 - v9);
  }
  if ( v13->m_Type == 4608 )
  {
    pTarget = v13;
  ...
  if ( v16 )
  {
    ...
    else
    {
      ...
      v55 = 0;
      v42.__vftable = *(IFxMemory_vtbl **)v22;
      v53 = 4106;
      if ( ((int (__fastcall *)(unsigned __int16 *, void **))v42.GetDriverGlobals)(v22, &p_pTarget) < 0 )
      {
        WPP_IFR_SF_qDqD(
  ...
  if ( v15 )
  {
    ...
    else
    {
      ...
      v55 = 0;
      v46.__vftable = *(IFxMemory_vtbl **)v30;
      v53 = 4106;
      if ( ((int (__fastcall *)(unsigned __int16 *, void **))v46.GetDriverGlobals)(v30, &p_pTarget) < 0 )
      {
        WPP_IFR_SF_qDqD(
    ...
    if ( !v24 )
      goto LABEL_35;
    v44 = v24->BufferLength;
    p_pTarget = (void *)(v44 + v24->BufferOffset);
    if ( (unsigned __int64)p_pTarget >= v44 )
    {
      v45 = (*(__int64 (__fastcall **)(unsigned __int16 *, unsigned __int64, __int64))(*(_QWORD *)v30 + 8LL))(
              v30,
              v44,
              v20);
      if ( (unsigned __int64)p_pTarget <= v45 )
      {
        v30 = (unsigned __int16 *)pOutputMemory;
LABEL_35:
...
LABEL_22:
  v25 = FxIoTarget::FormatIoctlRequest(pTarget, pRequest, v61, Internal, &inputBuf, &outputBuf, level);
  if ( (v25 & 0x80000000) == 0 )
  {
    v26 = Internal != 0;
    Internal = -Internal;
    m_RequestContext = pRequest->m_RequestContext;
    m_RequestContext->m_CompletionParams.Parameters.Ioctl.IoControlCode = v61;
