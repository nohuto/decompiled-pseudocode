/*
 * XREFs of imp_WdfUsbTargetPipeFormatRequestForRead @ 0x140012C00
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFMEMORY_OFFSET *ReadOffsets)
{
  ...
  FxRequestBase *v37; // [rsp+50h] [rbp-31h] BYREF
  FxUsbPipe **v38; // [rsp+58h] [rbp-29h] BYREF
  __int16 v39; // [rsp+60h] [rbp-21h]
  __int16 v40; // [rsp+62h] [rbp-1Fh]
  int v41; // [rsp+64h] [rbp-1Dh]
  FxRequestBase **v42; // [rsp+68h] [rbp-19h] BYREF
  __int16 v43; // [rsp+70h] [rbp-11h]
  __int16 v44; // [rsp+72h] [rbp-Fh]
  int v45; // [rsp+74h] [rbp-Dh]
  FxRequestBuffer Buffer; // [rsp+78h] [rbp-9h] BYREF
  _FX_DRIVER_GLOBALS **v47; // [rsp+E0h] [rbp+5Fh] BYREF
  FxUsbPipe *v48; // [rsp+E8h] [rbp+67h] BYREF
  ...
  m_Globals = v48->m_Globals;
  v38 = (FxUsbPipe **)m_Globals;
  if ( !Request )
  ...
  if ( ReadMemory )
  {
    ...
    else
    {
      ...
      v45 = 0;
      v32 = *v16;
      v42 = (FxRequestBase **)&v47;
      v43 = 4106;
      if ( ((int (__fastcall *)(_FX_DRIVER_GLOBALS **, FxRequestBase ***))v32->DestroyEvent.m_Event.Header.WaitListHead.Blink)(
             v16,
             &v42) < 0 )
      {
        WPP_IFR_SF_qDqD(
  ...
  v18 = FxUsbPipe::FormatTransferRequest(v48, v37, &Buffer, 3u);
  if ( v18 >= 0 )
  {
    ...
    *(_QWORD *)&m_RequestContext[1].m_CompletionParams.Size = ReadMemory;
    ...
    m_Globals = (_FX_DRIVER_GLOBALS *)v38;
