/*
 * XREFs of ?AssignForwardProgressPolicy@FxIoQueue@@QEAAJPEAU_WDF_IO_QUEUE_FORWARD_PROGRESS_POLICY@@@Z @ 0x1400A1CF0
 * Callers:
...
LABEL_7:
  ...
  *((_DWORD *)v12 + 8) = Policy->ForwardProgressReservedPolicy;
  ...
  while ( v16 < this->m_FwdProgContext->m_NumberOfReservedRequests )
  {
