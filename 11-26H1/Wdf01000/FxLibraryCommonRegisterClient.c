/*
 * XREFs of FxLibraryCommonRegisterClient @ 0x140077428
 * Callers:
 ...
 *     FxAllocateDriverGlobals @ 0x14007D2F4 (FxAllocateDriverGlobals.c)
 ...
 *     McGenEventRegister_EtwRegister @ 0x14008EF5C (McGenEventRegister_EtwRegister.c)
 *     LockVerifierSection @ 0x140096EFC (LockVerifierSection.c)
        ...
        _CLIENT_INFO *ClientInfo)
{
  ...
  if ( !Info || !WdfDriverGlobalsParam || !Info->FuncTable )
  {
    if ( !WdfLdrDbgPrintOn )
      return v6;
    DbgPrintEx(0x65u, 0, "%s: ", "Wdf01000");
...
LABEL_31:
    ...
    *WdfDriverGlobalsParam = DriverGlobals;
    if ( !DriverGlobals )
      goto $Done_36;
