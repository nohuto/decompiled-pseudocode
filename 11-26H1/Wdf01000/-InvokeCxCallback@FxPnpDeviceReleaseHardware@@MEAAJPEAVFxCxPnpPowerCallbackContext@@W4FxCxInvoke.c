/*
 * XREFs of ?InvokeCxCallback@FxPnpDeviceReleaseHardware@@MEAAJPEAVFxCxPnpPowerCallbackContext@@W4FxCxInvokeCallbackSubType@@@Z @ 0x14007A320
 * Callers:
 *     <none>
 * Callees:
        ...
        FxCxInvokeCallbackSubType PrePost)
{
  ...
  level = (*(__int64 (__fastcall **)(WDFDEVICE__ *, WDFCMRESLIST__ *))((char *)&Context->u.Generic.PreCallback
