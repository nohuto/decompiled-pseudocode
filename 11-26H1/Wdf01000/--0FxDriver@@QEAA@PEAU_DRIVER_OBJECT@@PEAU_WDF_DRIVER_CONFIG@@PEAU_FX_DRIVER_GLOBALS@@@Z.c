/*
 * XREFs of ??0FxDriver@@QEAA@PEAU_DRIVER_OBJECT@@PEAU_WDF_DRIVER_CONFIG@@PEAU_FX_DRIVER_GLOBALS@@@Z @ 0x14006C2C8
 * Callers:
        ...
        _FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  *(&this->m_Config.Size + 1) = 0;
  this->m_Config.EvtDriverUnload = 0LL;
  *(_QWORD *)&this->m_Config.DriverInitFlags = 0LL;
