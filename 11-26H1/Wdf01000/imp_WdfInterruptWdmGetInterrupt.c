/*
 * XREFs of imp_WdfInterruptWdmGetInterrupt @ 0x14005D8A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetInterruptPtr@FxInterrupt@@QEAAPEAU_KINTERRUPT@@XZ @ 0x14005D8DC (-GetInterruptPtr@FxInterrupt@@QEAAPEAU_KINTERRUPT@@XZ.c)
 */
