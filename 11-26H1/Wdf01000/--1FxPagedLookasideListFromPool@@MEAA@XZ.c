/*
 * XREFs of ??1FxPagedLookasideListFromPool@@MEAA@XZ @ 0x140095E28
 * Callers:
 *     ??_GFxPagedLookasideListFromPool@@MEAAPEAXI@Z @ 0x140095EF0 (--_GFxPagedLookasideListFromPool@@MEAAPEAXI@Z.c)
 * Callees:
