/*
 * XREFs of ?GotoStartState@FxUsbPipe@@UEAAJPEAU_LIST_ENTRY@@E@Z @ 0x140020FF0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall FxUsbPipe::GotoStartState(FxUsbPipe *this, _LIST_ENTRY *RequestListHead, unsigned __int8 Lock)
{
  int started; // esi
  int v6; // edi
