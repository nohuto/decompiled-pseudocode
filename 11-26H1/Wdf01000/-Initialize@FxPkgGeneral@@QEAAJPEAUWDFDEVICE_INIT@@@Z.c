/*
 * XREFs of ?Initialize@FxPkgGeneral@@QEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x14001EB5C
 * Callers:
 ...
 *     ??0FxFileObjectInfo@@QEAA@XZ @ 0x14007EB38 (--0FxFileObjectInfo@@QEAA@XZ.c)
...
__int64 __fastcall FxPkgGeneral::Initialize(FxPkgGeneral *this, WDFDEVICE_INIT *DeviceInit)
{
  ...
  void *v18; // rax
  FxFileObjectInfo *v19; // rax
  __int64 v20; // rax
  __int64 v21; // rdx
  _LIST_ENTRY *v22; // rcx
  unsigned int v23; // eax
  FxPoolTypeOrPoolFlags v24; // [rsp+30h] [rbp-18h] BYREF
  ...
  if ( DeviceInit->FileObject.Set )
  {
    ...
    *(_QWORD *)&v24.UsePoolType = 0LL;
    ...
    if ( !m_Globals->FxPoolTrackingOn )
      v10 = 0LL;
    v11 = (FxFileObjectInfo *)FxPoolAllocator(m_Globals, &m_Globals->FxPoolFrameworks, &v24, 0xA0uLL, Tag, v10);
    if ( !v11 || (FxFileObjectInfo::FxFileObjectInfo(v11), (v14 = v13) == 0) )
    {
      v7 = -1073741670;
      v12 = 10;
LABEL_15:
  ...
  for ( i = DeviceInit->CxDeviceInitListHead.Flink; i != p_CxDeviceInitListHead; i = i->Flink )
  {
    if ( BYTE4(i[13].Flink) )
    {
      ...
      *(_QWORD *)&v24.UsePoolType = 0LL;
      ...
      if ( !m_Globals->FxPoolTrackingOn )
        v18 = 0LL;
      v19 = (FxFileObjectInfo *)FxPoolAllocator(m_Globals, &m_Globals->FxPoolFrameworks, &v24, 0xA0uLL, v17, v18);
      if ( !v19 || (FxFileObjectInfo::FxFileObjectInfo(v19), (v21 = v20) == 0) )
      {
        v7 = -1073741670;
        v12 = 11;
        goto LABEL_15;
