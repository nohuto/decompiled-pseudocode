/*
 * XREFs of FxpBugCheckCallback @ 0x1400AC280
 * Callers:
 *     <none>
 * Callees:
 *     FxpBugCheckCallbackFilter @ 0x1400AC330 (FxpBugCheckCallbackFilter.c)
 */
...
LABEL_9:
        ...
        if ( !unk_1400C9088
          ...
          && *(unsigned __int8 ***)((unsigned int)(unk_1400C9080 * HIDWORD(KeGetPcr()[1].LockArray)) + unk_1400C9070) == p_Component )
        {
          goto LABEL_9;
        }
      }
