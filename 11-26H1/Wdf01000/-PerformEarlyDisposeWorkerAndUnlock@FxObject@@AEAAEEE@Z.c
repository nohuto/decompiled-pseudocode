/*
 * XREFs of ?PerformEarlyDisposeWorkerAndUnlock@FxObject@@AEAAEEE@Z @ 0x140037660
 * Callers:
...
{
  $290BB65A515BE5F04C495658DA243B85 *v3; // r14
  unsigned __int16 v7; // ax
  FxDeviceBase *m_DeviceBase; // rax
  FxDisposeList *m_DisposeList; // rcx
  _FX_DRIVER_GLOBALS *m_Globals; // rcx
  const void *_a2; // rdx
  $290BB65A515BE5F04C495658DA243B85 *v13; // rcx
