/*
 * XREFs of ?EnableTimer@FxPowerIdleMachine@@QEAAXXZ @ 0x140066644
 * Callers:
 *     ?PowerPolStartedIdleCapable@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x140066620 (-PowerPolStartedIdleCapable@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z.c)
 * Callees:
