/*
 * XREFs of ?GetDeviceControlOutputMdl@FxRequest@@QEAAJPEAPEAU_MDL@@@Z @ 0x140009D80
 * Callers:
...
__int64 __fastcall FxRequest::GetDeviceControlOutputMdl(FxRequest *this, _MDL **pMdl, unsigned __int8 a3)
{
  ...
  unsigned int MajorFunction; // eax
  ...
  if ( (_BYTE)MajorFunction != 15 && (_BYTE)MajorFunction != 14 )
  {
