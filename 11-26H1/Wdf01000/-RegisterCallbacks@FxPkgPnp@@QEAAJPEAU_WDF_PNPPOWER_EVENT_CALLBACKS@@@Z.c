/*
 * XREFs of ?RegisterCallbacks@FxPkgPnp@@QEAAJPEAU_WDF_PNPPOWER_EVENT_CALLBACKS@@@Z @ 0x14001BB34
 * Callers:
 ...
 *     ?IsCxUsingSelfManagedIo@FxDevice@@QEAAEXZ @ 0x14007ACF4 (-IsCxUsingSelfManagedIo@FxDevice@@QEAAEXZ.c)
 */
