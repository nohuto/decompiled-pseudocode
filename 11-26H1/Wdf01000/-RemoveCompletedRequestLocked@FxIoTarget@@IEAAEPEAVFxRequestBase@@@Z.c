/*
 * XREFs of ?RemoveCompletedRequestLocked@FxIoTarget@@IEAAEPEAVFxRequestBase@@@Z @ 0x140005360
 * Callers:
...
unsigned __int8 __fastcall FxIoTarget::RemoveCompletedRequestLocked(FxIoTarget *this, FxRequestBase *Request)
{
  ...
  $87BF65E0DFCCE0C1CCAAC6538D1C71CB *v6; // rax
  _IRP *Irp; // rdx
  ...
  if ( ($87BF65E0DFCCE0C1CCAAC6538D1C71CB *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($87BF65E0DFCCE0C1CCAAC6538D1C71CB **)&Irp->Type != v6) )
  {
    __fastfail(3u);
  }
