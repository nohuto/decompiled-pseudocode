/*
 * XREFs of imp_WdfRegistryAssignULong @ 0x14003CD90
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall imp_WdfRegistryAssignULong(
        ...
        unsigned int Value)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( result >= 0 )
    {
      ...
      if ( _a2 < 0 )
        WPP_IFR_SF_qd(pFxDriverGlobals, 2u, 2u, 0x24u, WPP_FxRegistryAPI_cpp_Traceguids, Key, _a2);
      else
