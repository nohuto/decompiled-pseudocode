/*
 * XREFs of ?LogRequestDIrpReason@FxDevicePowerIrpTracker@@QEAAXW4RequestDIrpReason@@E@Z @ 0x140042644
 * Callers:
 ...
 *     ?PowerPolCancelingWakeForSystemSleepWakeCanceled@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x140079EB0 (-PowerPolCancelingWakeForSystemSleepWakeCanceled@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_POLICY_STATE@.c)
 * Callees:
        ...
        unsigned __int8 PowerUp)
{
  ...
  __int64 v11; // r10
  __int16 v12; // cx
  unsigned int BucketArg1[4]; // [rsp+20h] [rbp-18h] BYREF
  ...
  BucketArg1[0] = v4;
  BucketArg1[1] = 0;
  *(_QWORD *)&BucketArg1[2] = MEMORY[0xFFFFF78000000014];
  this->m_History[this->m_HistoryIndex] = *(FxDevicePowerIrpTracker::HistoryEntry *)BucketArg1;
