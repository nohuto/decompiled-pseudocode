/*
 * XREFs of imp_WdfRegistryAssignMultiString @ 0x140099E90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FxCalculateTotalStringSize@@YA_KPEAUFxCollectionInternal@@EPEAE@Z @ 0x140071780 (-FxCalculateTotalStringSize@@YA_KPEAUFxCollectionInternal@@EPEAE@Z.c)
