/*
 * XREFs of RtlUnicodeStringPrintf @ 0x1400860C4
 * Callers:
 ...
 *     RtlUnicodeStringValidateDestWorker @ 0x140086370 (RtlUnicodeStringValidateDestWorker.c)
 */
...
__int64 RtlUnicodeStringPrintf(_UNICODE_STRING *DestinationString, const wchar_t *pszFormat, ...)
{
  ...
  v14 = va_arg(va1, unsigned __int64 *);
  pszDest = 0LL;
  cchDest = 0LL;
  v3 = RtlUnicodeStringValidateDestWorker(DestinationString, &pszDest, &cchDest, v14, v6, v7);
  if ( v3 >= 0 )
  {
    v3 = 0;
    argList = 0LL;
