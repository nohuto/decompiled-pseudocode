/*
 * XREFs of FxIoTargetFormatIo @ 0x14002CCC8
 * Callers:
 *     imp_WdfIoTargetFormatRequestForWrite @ 0x14006F530 (imp_WdfIoTargetFormatRequestForWrite.c)
 * Callees:
