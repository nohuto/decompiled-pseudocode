/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x140083E80
 * Callers:
 ...
 *     _tlgCreate1Sz_char @ 0x1400017B8 (_tlgCreate1Sz_char.c)
 *     GetImageTuple @ 0x1400AB954 (GetImageTuple.c)
...
$Done_45:
  ...
  {
    v29 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v21, g_ModuleName, v25, SizeOfImage, 0LL, 0LL, 0);
    if ( Tlgmtakm_hTelemetryAssertProv.LevelPlus1 > 5 && tlgKeywordOn(&Tlgmtakm_hTelemetryAssertProv, 0x400000000000uLL) )
    {
      _tlgTemp10 = 10;
      ...
      *(_QWORD *)&_tlgData[5].Size = 4LL;
      ...
      if ( g_ModuleName )
        v30 = (const char *)g_ModuleName;
      tlgCreate1Sz_char(&_tlgData[6], v30);
      LODWORD(_tlgTemp5) = v44;
      *(_QWORD *)&_tlgData[7].Size = 4LL;
      _tlgData[7].Ptr = (unsigned __int64)&_tlgTemp5;
      _tlgTemp3 = HIDWORD(v44);
      ...
      *(_QWORD *)&_tlgData[11].Size = 4LL;
      ...
      v36 = ReturnAddress_0;
      _tlgData[12].Ptr = (unsigned __int64)&v36;
      *(_QWORD *)&_tlgData[12].Size = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(
        &Tlgmtakm_hTelemetryAssertProv,
    ...
    if ( !v29 )
    {
      ...
      v33 = g_MicrosoftTelemetryAssertsTriggeredList.Flink;
      v9 = v32;
      if ( &g_MicrosoftTelemetryAssertsTriggeredList != g_MicrosoftTelemetryAssertsTriggeredList.Flink )
      {
        while ( v33[-2].Flink != (_LIST_ENTRY *)ReturnAddress )
        {
          v33 = v33->Flink;
