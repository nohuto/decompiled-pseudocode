/*
 * XREFs of ?AllocateDmaEnablerList@FxPkgPnp@@QEAAJXZ @ 0x1400A7BF0
 * Callers:
 *     ?AllocateDmaEnablerList@FxDevice@@UEAAJXZ @ 0x1400952D0 (-AllocateDmaEnablerList@FxDevice@@UEAAJXZ.c)
 * Callees:
