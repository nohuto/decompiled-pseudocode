/*
 * XREFs of ?Allocate@FxNPagedLookasideList@@UEAAJPEAPEAVFxMemoryObject@@@Z @ 0x14005F830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxNPagedLookasideList::Allocate(FxNPagedLookasideList *this, FX_POOL ***PPMemory)
{
  ...
  *PPMemory = 0LL;
  ...
  if ( m_BufferSize >= 0x1000 )
    goto LABEL_26;
  v10 = ((m_BufferSize + 15) & 0xFFF0) + 128;
  ...
  v11 = v10;
  *(_OWORD *)((char *)p_Pool + v10) = 0LL;
  *(_OWORD *)((char *)p_Pool + v10 + 16) = 0LL;
  *(_OWORD *)((char *)p_Pool + v10 + 32) = 0LL;
  *(FX_POOL **)((char *)p_Pool + v10) = (FX_POOL *)p_Pool;
  if ( this != (FxNPagedLookasideList *)-104LL )
  {
    ...
    if ( ContextTypeInfo )
    {
      ...
      memset((char *)p_Pool + v10 + 48, 0, (ContextSizeOverride + 7) & 0xFFFFFFFFFFFFFFF8uLL);
    }
    *(FX_POOL **)((char *)p_Pool + v11 + 32) = (FX_POOL *)this->m_MemoryAttributes.ContextTypeInfo;
  }
  if ( p_Pool )
  {
