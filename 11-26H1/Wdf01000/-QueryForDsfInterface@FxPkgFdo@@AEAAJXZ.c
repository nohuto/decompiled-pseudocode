/*
 * XREFs of ?QueryForDsfInterface@FxPkgFdo@@AEAAJXZ @ 0x140064274
 * Callers:
...
__int64 __fastcall FxPkgFdo::QueryForDsfInterface(FxPkgFdo *this)
{
  ...
  v2 = FxDeviceBase::QueryForInterface(
         this->m_DeviceBase,
  ...
  {
    WPP_IFR_SF_D(this->m_Globals, 2u, 0xCu, 0xEu, WPP_FxPkgFdoKm_cpp_Traceguids, v2);
  }
  return v4;
}
