/*
 * XREFs of ?ProcessEventInner@FxDevicePwrRequirementMachine@@AEAAXPEAUFxPostProcessInfo@@@Z @ 0x140041FC8
 * Callers:
        ...
        FxPostProcessInfo *Info)
{
  ...
  __int64 (__fastcall *v15)(FxObject *__hidden, struct FxQueryInterfaceParams *); // rax
  KIRQL v16; // r9
  FxPkgPnp *v17; // rcx
      ...
      if ( TargetStates[i].DprEvent == _a4 )
      {
        ...
        if ( _a3 != 15 )
        {
          do
          {
            ...
            v15 = funcs_14004210C[3 * (unsigned __int8)_a3];
            if ( !v15 )
              break;
