/*
 * XREFs of FxDriverGlobalsInitializeDebugExtension @ 0x1400963E8
 * Callers:
 ...
 *     FxVerifierReadObjectDebugInfo @ 0x140096BCC (FxVerifierReadObjectDebugInfo.c)
 */
...
void __fastcall FxDriverGlobalsInitializeDebugExtension(_FX_DRIVER_GLOBALS *FxDriverGlobals, void *Key)
{
  ...
  FxStateSeparationDetectionOption *v8; // r15
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(Pool2 + 424) = Pool2 + 416;
    v8 = (FxStateSeparationDetectionOption *)(Pool2 + 452);
    ...
    *(_DWORD *)(Pool2 + 452) = 0;
    ...
    if ( Key )
    {
      ...
      *v6 = v9;
      ...
      FxVerifierQueryStateSeparationDetection(Key, v8);
    }
    v6[51] = 0LL;
  }
}
