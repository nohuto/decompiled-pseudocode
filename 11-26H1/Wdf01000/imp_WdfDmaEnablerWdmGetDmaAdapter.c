/*
 * XREFs of imp_WdfDmaEnablerWdmGetDmaAdapter @ 0x14006FC90
 * Callers:
 *     <none>
 * Callees:
...
{
  __int64 v4; // rbx
  $E4A3ECB67F2D0678F53DA0B3123C8A42 *v7; // rbx
  ...
  if ( DmaDirection == 1 )
  {
    v7 = ($E4A3ECB67F2D0678F53DA0B3123C8A42 *)&pDmaEnabler->m_DuplexAdapterInfo[1];
