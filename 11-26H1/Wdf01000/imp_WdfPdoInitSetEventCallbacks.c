/*
 * XREFs of imp_WdfPdoInitSetEventCallbacks @ 0x140078D00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    _a1 = DispatchTable->Size;
    if ( DispatchTable->Size != 64 && _a1 != 56 )
    {
      WPP_IFR_SF_dd(v5, 2u, 0x12u, 0x36u, WPP_FxDeviceInitApi_cpp_Traceguids, _a1, 64);
      goto LABEL_11;
    }
