/*
 * XREFs of ?Thread@FxSystemThread@@AEAAXXZ @ 0x140070D88
 * Callers:
 *     ?StaticThreadThunk@FxSystemThread@@CAXPEAX@Z @ 0x1400AC780 (-StaticThreadThunk@FxSystemThread@@CAXPEAX@Z.c)
 * Callees:
...
void __fastcall FxSystemThread::Thread(FxSystemThread *this)
{
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      this->m_WorkList.Blink = p_m_WorkList;
