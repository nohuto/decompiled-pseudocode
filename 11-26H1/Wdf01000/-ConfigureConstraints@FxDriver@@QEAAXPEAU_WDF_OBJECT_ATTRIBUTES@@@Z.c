/*
 * XREFs of ?ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x140072CC4
 * Callers:
...
void __fastcall FxDriver::ConfigureConstraints(FxDriver *this, _WDF_OBJECT_ATTRIBUTES *DriverAttributes)
{
  ...
  if ( m_SynchronizationScope == WdfSynchronizationScopeDevice || m_SynchronizationScope == WdfSynchronizationScopeQueue )
    v5 = 1;
  this->m_DriverDeviceAdd.m_CallbackLock = (FxCallbackLock *)((unsigned __int64)p_m_CallbackMutexLock & -(__int64)(v5 != 0));
}
