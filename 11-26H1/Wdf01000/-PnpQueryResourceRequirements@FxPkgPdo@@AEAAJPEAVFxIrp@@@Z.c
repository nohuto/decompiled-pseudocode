/*
 * XREFs of ?PnpQueryResourceRequirements@FxPkgPdo@@AEAAJPEAVFxIrp@@@Z @ 0x14006EE28
 * Callers:
 *     ?_PnpQueryResourceRequirements@FxPkgPdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z @ 0x14006EE10 (-_PnpQueryResourceRequirements@FxPkgPdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z.c)
 * Callees:
...
__int64 __fastcall FxPkgPdo::PnpQueryResourceRequirements(FxPkgPdo *this, _FX_DRIVER_GLOBALS *Irp)
{
  ...
  if ( Flink >= 0 )
  {
    ...
    {
      Flink = FxIoResReqList::_CreateAndInit(&pIoResReqList, this->m_Globals, v11, v12);
      if ( Flink >= 0 )
      {
        v13 = pIoResReqList;
        reqlist = 0LL;
