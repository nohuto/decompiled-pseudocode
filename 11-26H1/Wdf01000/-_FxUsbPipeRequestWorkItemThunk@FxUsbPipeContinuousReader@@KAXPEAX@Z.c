/*
 * XREFs of ?_FxUsbPipeRequestWorkItemThunk@FxUsbPipeContinuousReader@@KAXPEAX@Z @ 0x140070330
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  unsigned int m_WorkItemFlags; // edx
  char v9; // bp
  int v10; // ecx
  ...
  Parent->m_WorkItemFlags = m_WorkItemFlags | v10;
