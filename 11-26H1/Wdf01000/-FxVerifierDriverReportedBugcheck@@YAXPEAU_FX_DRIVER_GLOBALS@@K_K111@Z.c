/*
 * XREFs of ?FxVerifierDriverReportedBugcheck@@YAXPEAU_FX_DRIVER_GLOBALS@@K_K111@Z @ 0x140097374
 * Callers:
 *     imp_WdfCxVerifierKeBugCheck @ 0x140092C90 (imp_WdfCxVerifierKeBugCheck.c)
 *     imp_WdfVerifierKeBugCheck @ 0x140092D60 (imp_WdfVerifierKeBugCheck.c)
