/*
 * XREFs of ?SleepStudyRegisterBlockingComponents@FxPkgPnp@@QEAAJXZ @ 0x1400A8114
 * Callers:
...
__int64 __fastcall FxPkgPnp::SleepStudyRegisterBlockingComponents(FxPkgPnp *this)
{
  ...
  _GUID v33; // [rsp+70h] [rbp-90h] BYREF
  _GUID v34; // [rsp+80h] [rbp-80h] BYREF
...
LABEL_5:
  ...
  if ( friendlyName.Buffer )
  {
    ...
    v34 = parentGuid;
    v6 = SleepstudyHelper_RegisterComponentEx(SleepStudyLibContext, &v34, &v33, &friendlyName, &componentPowerRef);
    if ( v6 >= 0 )
    {
      ...
      else
      {
        ...
        if ( !v24 )
          v25 = 0LL;
        WPP_IFR_SF_qd(this->m_Globals, 3u, 0xCu, 0x1Au, WPP_FxPkgPnpKM_cpp_Traceguids, v25, v6);
