/*
 * XREFs of ?_FxTimerExtCallbackThunk@FxTimer@@CAXPEAU_EX_TIMER@@PEAX@Z @ 0x140007D00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxTimer::_FxTimerExtCallbackThunk(struct _EX_TIMER *Timer, FxTimer *Context)
{
  ...
  {
    v4 = *(void (__fastcall **)(void (__fastcall **)(WDFTIMER__ *), __int64, __int64, __int64, char))(unk_1400C90A8 + 8LL);
    if ( v4 )
