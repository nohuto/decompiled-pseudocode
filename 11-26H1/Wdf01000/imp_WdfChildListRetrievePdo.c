/*
 * XREFs of imp_WdfChildListRetrievePdo @ 0x140068640
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDF_CHILD_RETRIEVE_INFO *RetrieveInfo)
{
  ...
  int IdentificationDescriptionSize; // edx
  FxChildList *v11; // rcx
  unsigned int m_IdentificationDescriptionSize; // eax
  ...
  if ( m_IdentificationDescriptionSize != IdentificationDescriptionSize )
  {
    WPP_IFR_SF_dd(
      v8,
      2u,
...
LABEL_8:
  ...
  DeviceFromId = (unsigned __int64)FxChildList::GetDeviceFromId(v11, RetrieveInfo);
  if ( DeviceFromId )
  {
    v15 = (const void *)(DeviceFromId ^ 0xFFFFFFFFFFFFFFF8uLL);
  ...
  if ( v8->FxVerboseOn )
    WPP_IFR_SF_qqd(v8, 5u, 0xCu, 0x32u, WPP_FxChildListAPI_cpp_Traceguids, DeviceList, v15, RetrieveInfo->Status);
  return (WDFDEVICE__ *)v15;
}
