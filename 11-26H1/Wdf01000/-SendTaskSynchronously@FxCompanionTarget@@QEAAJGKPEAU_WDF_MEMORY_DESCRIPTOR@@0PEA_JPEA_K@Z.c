/*
 * XREFs of ?SendTaskSynchronously@FxCompanionTarget@@QEAAJGKPEAU_WDF_MEMORY_DESCRIPTOR@@0PEA_JPEA_K@Z @ 0x14006F778
 * Callers:
 *     imp_WdfCompanionTargetSendTaskSynchronously @ 0x14006F5F0 (imp_WdfCompanionTargetSendTaskSynchronously.c)
 * Callees:
 *     WPP_IFR_SF_q @ 0x1400488BC (WPP_IFR_SF_q.c)
 *     ?DecrementPendingTaskCount@FxCompanionTarget@@AEAAXXZ @ 0x14006F894 (-DecrementPendingTaskCount@FxCompanionTarget@@AEAAXXZ.c)
 *     ?IncrementPendingTaskCountWithFloor@FxCompanionTarget@@AEAAJXZ @ 0x14006F8D0 (-IncrementPendingTaskCountWithFloor@FxCompanionTarget@@AEAAJXZ.c)
