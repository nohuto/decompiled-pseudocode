/*
 * XREFs of ?Initialize@FxNPagedLookasideListFromPool@@UEAAJ_KPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x140095D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxNPagedLookasideListFromPool::Initialize(
