/*
 * XREFs of ?PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z @ 0x140067F3C
 * Callers:
 *     ?ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z @ 0x140069710 (-ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z.c)
 * Callees:
