/*
 * XREFs of AddEventHooksWdfDeviceCreate @ 0x1400E2A7C
 * Callers:
        ...
        WDFDEVICE__ **Device)
{
  ...
  unsigned __int64 retaddr; // [rsp+138h] [rbp+57h]
...
LABEL_8:
  ...
  *(_OWORD *)&pnpPowerEvtsOriginal.EvtDeviceRelationsQuery = v19;
  ...
  v23 = *v11;
  context = 0LL;
  v21 = VfAddContextToHandle(contextHeader, &attributes, v23, (void **)&context);
  if ( v21 < 0 )
  {
    if ( !v22 )
      return v21;
