/*
 * XREFs of ?Initialize@FxDevice@@QEAAJPEAUWDFDEVICE_INIT@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x14002008C
 * Callers:
 ...
 *     ?ConfigureAutoForwardCleanupClose@FxDevice@@QEAAXPEAUWDFDEVICE_INIT@@@Z @ 0x140020B28 (-ConfigureAutoForwardCleanupClose@FxDevice@@QEAAXPEAUWDFDEVICE_INIT@@@Z.c)
 ...
 *     ??0FxPkgGeneral@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxDevice@@@Z @ 0x140020D1C (--0FxPkgGeneral@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxDevice@@@Z.c)
        ...
        _WDF_OBJECT_ATTRIBUTES *DeviceAttributes)
{
  ...
  _WDF_OBJECT_ATTRIBUTES *v35; // rcx
  unsigned int j; // r15d
  FxPoolTypeOrPoolFlags v37; // [rsp+40h] [rbp-38h] BYREF
  ...
  if ( result >= 0 )
  {
    v10 = (FxNonPagedObject *)FxObjectHandleAlloc2(m_Globals, v8, 0x78uLL, v9, 0LL, 0, FxObjectTypeInternal);
    v11 = (FxDefaultIrpHandler *)v10;
    if ( v10 )
    {
      FxNonPagedObject::FxNonPagedObject(v10, (_FX_DRIVER_GLOBALS *)0x1105, 0, m_Globals);
    ...
    for ( i = DeviceInit->CxDeviceInitListHead.Flink; i != &DeviceInit->CxDeviceInitListHead; i = i->Flink )
    {
      ...
      *(_QWORD *)&v37.UsePoolType = 0LL;
      ...
      if ( v29 )
        ...
        v31 = retaddr;
      v32 = (_LIST_ENTRY **)FxPoolAllocator(m_Globals, &m_Globals->FxPoolFrameworks, &v37, 0x108uLL, Tag, v31);
      v33 = v32;
      if ( !v32 )
        return -1073741670;
      v32[2] = 0LL;
      v32[3] = 0LL;
      v32[1] = (_LIST_ENTRY *)v32;
      *v32 = (_LIST_ENTRY *)v32;
      *((_OWORD *)v32 + 2) = 0LL;
      *((_OWORD *)v32 + 3) = 0LL;
      *((_OWORD *)v32 + 4) = 0LL;
      ...
      *((_BYTE *)v33 + 88) = ++v6;
      v39 = v6;
      v33[2] = i[1].Blink[5].Flink;
      v33[3] = i[2].Blink;
      *((_LIST_ENTRY *)v33 + 2) = i[3];
      *((_LIST_ENTRY *)v33 + 3) = i[4];
      *((_LIST_ENTRY *)v33 + 4) = i[5];
      v33[10] = i[6].Flink;
      Blink = this->m_CxDeviceInfoListHead.Blink;
      if ( Blink->Flink != &this->m_CxDeviceInfoListHead )
        __fastfail(3u);
      *v33 = &this->m_CxDeviceInfoListHead;
      v33[1] = Blink;
      Blink->Flink = (_LIST_ENTRY *)v33;
      this->m_CxDeviceInfoListHead.Blink = (_LIST_ENTRY *)v33;
      i[40].Blink = (_LIST_ENTRY *)v33;
      if ( FxGetContextSize((_WDF_OBJECT_ATTRIBUTES *)&i[3]) > ContextSize )
        ContextSize = FxGetContextSize(v35);
      if ( LOBYTE(i[40].Flink) == 1 )
      {
        for ( j = 0; j < 0x15; ++j )
        {
          result = FxPrePostCallback::_InitializeContext(
                     this->m_Globals,
                     (WDFCXDEVICE_INIT *)i,
                     (FxCxPnpPowerCallbackContext **)&v33[j + 12],
                     (FxCxCallbackType)j);
          if ( result < 0 )
            return result;
        }
    ...
    if ( result >= 0 )
    {
      ...
      if ( result >= 0 )
      {
        ...
        v18 = (FxPkgGeneral *)FxObjectHandleAlloc2(m_Globals, v16, 0xD0uLL, v17, 0LL, 0, FxObjectTypeInternal);
        if ( v18 )
          FxPkgGeneral::FxPkgGeneral(v18, m_Globals, this);
        else
          v19 = 0LL;
        ...
        v22 = (FxWmiIrpHandler *)FxObjectHandleAlloc2(m_Globals, v20, 0xD0uLL, v21, 0LL, 0, FxObjectTypeInternal);
        if ( v22 )
        ...
        v27 = (FxPkgIo *)FxObjectHandleAlloc2(m_Globals, v25, 0x190uLL, v26, 0LL, 0, FxObjectTypeInternal);
        if ( v27 )
          FxPkgIo::FxPkgIo(v27, m_Globals, this);
        else
          v28 = 0LL;
        this->m_PkgIo = v28;
        if ( !v28 )
