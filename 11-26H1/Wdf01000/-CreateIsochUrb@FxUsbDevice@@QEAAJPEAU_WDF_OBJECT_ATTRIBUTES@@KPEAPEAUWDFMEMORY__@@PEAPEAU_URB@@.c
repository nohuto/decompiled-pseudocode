/*
 * XREFs of ?CreateIsochUrb@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@KPEAPEAUWDFMEMORY__@@PEAPEAU_URB@@@Z @ 0x140001AE0
 * Callers:
        ...
        _URB **Urb)
{
  ...
  if ( v10 >= 0 )
  {
    FxObjectHandleGetPtrAndGlobals(m_Globals, Attributes->ParentObject, 0x1000u, (void **)&pParent, &pFxDriverGlobals);
  ...
  if ( v11 >= 0 )
  {
    ...
    *UrbMemory = 0LL;
    ...
    {
      v16 = (FxUsbUrb *)FxObjectHandleAlloc2(v12, v14, 0x88uLL, v15, Attributes, 0, FxObjectTypeExternal);
      if ( v16
        && (FxUsbUrb::FxUsbUrb(v16, v12, this->m_USBDHandle, urbLocal, 12 * NumberOfIsochPackets + 152),
            (v18 = v17) != 0LL) )
      {
        urbLocal = 0LL;
