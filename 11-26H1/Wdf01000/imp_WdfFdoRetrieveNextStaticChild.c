/*
 * XREFs of imp_WdfFdoRetrieveNextStaticChild @ 0x1400479F0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (Flags & 1) != 0 )
    {
      for ( i = *(__int64 **)(v11 + 272); i != (__int64 *)(v11 + 272); i = (__int64 *)*i )
      {
        if ( !*((_BYTE *)i + 82) )
        {
          ...
          {
            if ( *((_DWORD *)i + 4) == 2
              || (Flags & 2) != 0 && ((v31 = *((_DWORD *)i + 4), v31 == 3) || v31 == 4)
    ...
    if ( (Flags & 4) != 0 )
    {
      for ( j = *(__int64 **)(v11 + 288); j != (__int64 *)(v11 + 288); j = (__int64 *)*j )
      {
        if ( !*((_BYTE *)j + 42) )
        {
          ...
          v32 = *(_QWORD *)(v24 + 8);
          v33 = *(_WORD *)(v32 + 10);
          v34 = (WDFDEVICE__ *)(v32 ^ 0xFFFFFFFFFFFFFFF8uLL);
          if ( !v33 )
            v34 = 0LL;
          if ( v34 == PreviousChild )
            v13 = 1;
        }
      }
    }
