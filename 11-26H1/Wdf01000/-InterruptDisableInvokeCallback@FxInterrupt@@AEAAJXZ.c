/*
 * XREFs of ?InterruptDisableInvokeCallback@FxInterrupt@@AEAAJXZ @ 0x140071894
 * Callers:
 *     ?_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z @ 0x140071870 (-_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z.c)
 * Callees:
