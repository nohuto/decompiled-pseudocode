/*
 * XREFs of ?Close@FxIoTargetRemote@@QEAAXW4FxIoTargetRemoteCloseReason@@@Z @ 0x140005E2C
 * Callers:
 *     imp_WdfIoTargetClose @ 0x140005BA0 (imp_WdfIoTargetClose.c)
 *     ?Remove@FxIoTargetRemote@@UEAAXXZ @ 0x140005D40 (-Remove@FxIoTargetRemote@@UEAAXXZ.c)
...
LABEL_9:
  ...
  if ( pointers.TargetFileObject )
  {
    ...
    if ( !this->m_ObjectSize )
      v21 = 0LL;
    WPP_IFR_SF_qq(m_Globals, 4u, 0xEu, 0x1Fu, WPP_FxIoTargetRemote_cpp_Traceguids, v21, pointers.TargetFileObject);
  ...
  if ( pointers.TargetHandle )
  {
    if ( !this->m_ObjectSize )
      v19 = 0LL;
    WPP_IFR_SF_qq(m_Globals, 4u, 0xEu, 0x20u, WPP_FxIoTargetRemote_cpp_Traceguids, v19, pointers.TargetHandle);
