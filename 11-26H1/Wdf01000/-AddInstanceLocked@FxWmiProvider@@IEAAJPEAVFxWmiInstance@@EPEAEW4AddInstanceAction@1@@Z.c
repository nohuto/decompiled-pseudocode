/*
 * XREFs of ?AddInstanceLocked@FxWmiProvider@@IEAAJPEAVFxWmiInstance@@EPEAEW4AddInstanceAction@1@@Z @ 0x14003F7D4
 * Callers:
        ...
        FxWmiProvider::AddInstanceAction Action)
{
  ...
  *Update = 0;
  if ( v5->Flink == v5 )
  {
    ...
    {
      v8 = *(_WORD *)(Instance + 10);
      _a1 = (const void *)(Instance ^ 0xFFFFFFFFFFFFFFF8uLL);
      if ( !v8 )
        _a1 = 0LL;
      v10 = -1073741436;
      WPP_IFR_SF_qd(this->m_Globals, 4u, 0x12u, 0x11u, WPP_FxWmiProvider_cpp_Traceguids, _a1, -1073741436);
      return v10;
    }
...
LABEL_17:
  ...
  if ( NoErrorIfPresent )
    return 0LL;
  v11 = *(_WORD *)(Instance + 10);
  v12 = (const void *)(Instance ^ 0xFFFFFFFFFFFFFFF8uLL);
  if ( !v11 )
    v12 = 0LL;
  v10 = -1073741808;
  WPP_IFR_SF_qd(this->m_Globals, 2u, 0x12u, 0x10u, WPP_FxWmiProvider_cpp_Traceguids, v12, -1073741808);
  return v10;
}
