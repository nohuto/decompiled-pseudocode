/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1400AC04C
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x14006CE18 (FxRegisterBugCheckCallback.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1400ACF10 (_guard_dispatch_icall.c)
 *     WdmlibProcgrpInitialize @ 0x1400DBF2C (WdmlibProcgrpInitialize.c)
 */
