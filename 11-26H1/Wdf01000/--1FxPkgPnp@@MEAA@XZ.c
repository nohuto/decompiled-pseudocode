 ...
 *     ?SleepStudyStop@FxPkgPnp@@QEAAXXZ @ 0x14003BAC4 (-SleepStudyStop@FxPkgPnp@@QEAAXXZ.c)
 *     ??_GFxDeviceInterface@@QEAAPEAXI@Z @ 0x14003C358 (--_GFxDeviceInterface@@QEAAPEAXI@Z.c)
 *     ??_GFxEnumerationInfo@@QEAAPEAXI@Z @ 0x14007D9D0 (--_GFxEnumerationInfo@@QEAAPEAXI@Z.c)
...
void __fastcall FxPkgPnp::~FxPkgPnp(FxPkgPnp *this)
{
  ...
  while ( Next )
  {
    ...
    v17->Next = 0LL;
    if ( v16 )
      FxDeviceInterface::`scalar deleting destructor'(v16, v2);
  }
