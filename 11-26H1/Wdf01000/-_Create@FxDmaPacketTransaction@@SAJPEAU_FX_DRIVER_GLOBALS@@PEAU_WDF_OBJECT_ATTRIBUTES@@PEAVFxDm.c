/*
 * XREFs of ?_Create@FxDmaPacketTransaction@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDmaEnabler@@PEAPEAUWDFDMATRANSACTION__@@@Z @ 0x140087D14
 * Callers:
        ...
        WDFDMATRANSACTION__ **Transaction)
{
  ...
  $E4A3ECB67F2D0678F53DA0B3123C8A42 *v12; // rax
