/*
 * XREFs of ?_QueryForInterface@FxQueryInterface@@SAJPEAU_DEVICE_OBJECT@@PEBU_GUID@@PEAU_INTERFACE@@GGPEAX@Z @ 0x14006499C
 * Callers:
        ...
        _NAMED_PIPE_CREATE_PARAMETERS *InterfaceSpecificData)
{
  ...
  if ( v10 )
  {
    ...
    *(_WORD *)&CurrentStackLocation[-1].MajorFunction = 2075;
    ...
    v14 = FxIrp::SendIrpSynchronously(&irp, TopOfStack);
    IoFreeIrp(v11);
  }
  else
  {
