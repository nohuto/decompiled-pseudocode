/*
 * XREFs of ?GotoPurgeState@FxIoTarget@@MEAAXW4_WDF_IO_TARGET_PURGE_IO_ACTION@@PEAU_LIST_ENTRY@@PEAU_SINGLE_LIST_ENTRY@@PEAEE@Z @ 0x140022990
 * Callers:
        ...
        unsigned __int8 LockSelf)
{
  ...
  _a2 = this->m_State;
  if ( _a2 == WdfIoTargetStarted || _a2 == WdfIoTargetStopped )
  {
