/*
 * XREFs of ?AllocateThreadTable@FxVerifierLock@@SAXPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x14009820C
 * Callers:
...
void __fastcall FxVerifierLock::AllocateThreadTable(_FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  if ( !FxDriverGlobals->ThreadTable )
  {
    ...
    if ( v4 )
      ...
      v7 = retaddr;
    v8 = FxPoolAllocator(FxDriverGlobals, &FxDriverGlobals->FxPoolFrameworks, &v11, 0x400uLL, Tag, v7);
    v9 = (_LIST_ENTRY *)v8;
    if ( !v8 )
    {
