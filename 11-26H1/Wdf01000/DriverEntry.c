/*
 * XREFs of DriverEntry @ 0x140085CB0
 * Callers:
 *     GsDriverEntry @ 0x1400E6010 (GsDriverEntry.c)
 * Callees:
 *     ?FxLibraryCleanup@@YAXXZ @ 0x1400855A4 (-FxLibraryCleanup@@YAXXZ.c)
 *     ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1400855FC (-FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z.c)
 *     ?WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1400858DC (-WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
...
__int64 __fastcall DriverEntry(_DRIVER_OBJECT *DriverObject, _UNICODE_STRING *RegistryPath)
{
  ...
  *(_QWORD *)&WPP_GLOBAL_WDF_Control.SectorSize = DriverObject;
