/*
 * XREFs of ?AllocateTarget@FxDeviceBase@@QEAAJPEAPEAVFxIoTarget@@E@Z @ 0x14001D738
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( SelfTarget )
  {
    v21 = (FxIoTarget *)FxObjectHandleAlloc2(
                          m_Globals,
    ...
    if ( v21 )
    {
      FxIoTarget::FxIoTarget(v21, *p_m_Globals, 0x160u, 0x1205u);
      v10[1].__vftable = 0LL;
  ...
  {
    v8 = (FxIoTarget *)FxObjectHandleAlloc2(
                         m_Globals,
                         (unsigned __int64)Target,
                         0x158uLL,
                         a4,
    ...
    FxIoTarget::FxIoTarget(v8, *p_m_Globals, 0x158u);
    v10 = v9;
  }
  if ( !v10 )
  {
