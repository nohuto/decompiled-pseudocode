/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToService @ 0x14008AE54
 * Callers:
 ...
 *     wil_details_MapReportingKind @ 0x14008B320 (wil_details_MapReportingKind.c)
        ...
        unsigned __int64 a4)
{
  ...
  if ( wil_details_FeatureReporting_ReportUsageToServiceDirect(descriptor, v7, v6, v7.exchange64) )
  {
    if ( *(_QWORD *)&WPP_GLOBAL_WDF_Control.DeviceType )
      (*(void (__fastcall **)(unsigned int, const FEATURE_LOGGED_TRAITS *, const FEATURE_ERROR *, int, const wil_ReportingKind *, const wil_VariantReportingKind *, unsigned __int8, unsigned __int64))&WPP_GLOBAL_WDF_Control.DeviceType)(
