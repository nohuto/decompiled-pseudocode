/*
 * XREFs of WppInitGlobalLoggerWdf @ 0x14008C038
 * Callers:
 *     WppTraceCallbackWdf @ 0x14008C430 (WppTraceCallbackWdf.c)
 * Callees:
 *     WppGuidToStr @ 0x14008BF34 (WppGuidToStr.c)
 *     wcscmp_0 @ 0x1400ACEA6 (wcscmp_0.c)
    ...
    if ( Pool2 )
    {
      ...
      else
      {
        ...
        *((_WORD *)Pool2 + 14) = aWmiAutologger[14];
        ...
        do
          ++v14;
        while ( *((_WORD *)Pool2 + v14) );
        memmove((char *)Pool2 + 2 * v14, LoggerName, (unsigned int)(2 * v13));
        v15 = -1LL;
        do
          ++v15;
        ...
        && Lstart )
      {
        ...
        LoggerNameStr = 0LL;
        RtlInitUnicodeString(&LoggerNameStr, L"RtlQueryRegistryValuesEx");
        v17 = MmGetSystemRoutineAddress(&LoggerNameStr);
        if ( !v17 )
          v17 = RtlQueryRegistryValues;
        v18 = ((__int64 (__fastcall *)(__int64, _OWORD *, _RTL_QUERY_REGISTRY_TABLE *, _QWORD, _QWORD))v17)(
                2147483650LL,
                Pool2,
                parms,
                0LL,
