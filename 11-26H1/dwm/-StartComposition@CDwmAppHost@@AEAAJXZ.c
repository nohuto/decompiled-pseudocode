/*
 * XREFs of ?StartComposition@CDwmAppHost@@AEAAJXZ @ 0x1400044E0
 * Callers:
 ...
 *     McTemplateU0q_EtwEventWriteTransfer @ 0x14000CD70 (McTemplateU0q_EtwEventWriteTransfer.c)
 */
...
__int64 __fastcall CDwmAppHost::StartComposition(CDwmAppHost *this)
{
  ...
  v9 = this;
  if ( dword_14001C4E8 || (v9 = 0LL, v1 = MilCompositionEngine_Initialize(15, &v9), v2 = v1, v1 >= 0) )
  {
    ...
    if ( dword_14001C4E8 || (v6 = DwmClientStartup(&g_dwmAppHost), v2 = v6, v6 >= 0) )
    {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x146u, 0LL);
    }
  }
  else
  {
