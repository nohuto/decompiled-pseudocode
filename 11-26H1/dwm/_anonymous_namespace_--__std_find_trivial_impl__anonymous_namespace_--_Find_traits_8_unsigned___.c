/*
 * XREFs of _anonymous_namespace_::__std_find_trivial_impl__anonymous_namespace_::_Find_traits_8_unsigned___int64_ @ 0x140005FB0
 * Callers:
 *     __std_find_trivial_8 @ 0x1400060B0 (__std_find_trivial_8.c)
 * Callees:
 *     <none>
 */
...
LABEL_9:
    ...
    _RAX = (char *)&unk_140012880 - (v11 & 0xFFFFFFFC);
    __asm
    {
