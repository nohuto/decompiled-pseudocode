/*
 * XREFs of ??1Completer@?$static_lazy@VFeatureLogging@details@wil@@@details@wil@@QEAA@XZ @ 0x140007000
 * Callers:
 ...
 * Callees:
 *     TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation @ 0x140001A30 (TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation.c)
