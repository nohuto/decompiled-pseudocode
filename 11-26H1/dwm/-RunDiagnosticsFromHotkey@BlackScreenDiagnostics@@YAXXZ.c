/*
 * XREFs of ?RunDiagnosticsFromHotkey@BlackScreenDiagnostics@@YAXXZ @ 0x14000EA38
 * Callers:
 ...
 *     ??$duration_cast@V?$duration@_JU?$ratio@$00$00@std@@@chrono@std@@_JU?$ratio@$00$0DLJKMKAA@@3@$0A@@chrono@std@@YA?AV?$duration@_JU?$ratio@$00$00@std@@@01@AEBV?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@01@@Z @ 0x14000DA8C (--$duration_cast@V-$duration@_JU-$ratio@$00$00@std@@@chrono@std@@_JU-$ratio@$00$0DLJKMKAA@@3@$0A.c)
 ...
 *     ?now@steady_clock@chrono@std@@SA?AV?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@23@XZ @ 0x14000EE48 (-now@steady_clock@chrono@std@@SA-AV-$time_point@Usteady_clock@chrono@std@@V-$duration@_JU-$ratio.c)
 */
...
void __fastcall BlackScreenDiagnostics::RunDiagnosticsFromHotkey(BlackScreenDiagnostics *this)
{
  ...
  Uuid = 0LL;
  UuidCreate(&Uuid);
  v2 = *(_QWORD *)std::chrono::steady_clock::now(&v1) - qword_140018B40;
  ...
  else
  {
    ...
    qword_140018B40 = *(_QWORD *)std::chrono::steady_clock::now(&v1);
  }
}
