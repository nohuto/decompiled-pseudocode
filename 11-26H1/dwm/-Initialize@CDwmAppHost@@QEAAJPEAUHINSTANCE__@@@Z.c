/*
 * XREFs of ?Initialize@CDwmAppHost@@QEAAJPEAUHINSTANCE__@@@Z @ 0x140002EE8
 * Callers:
...
__int64 __fastcall CDwmAppHost::Initialize(CDwmAppHost *this, HINSTANCE a2)
{
  ...
  v16 = this;
  hInstance = a2;
  HIDWORD(qword_14001C4E0) = GetCurrentThreadId();
  ...
  v3 = DwmInitializePort(&g_dwmAppHost, CDwmAppHost::s_LpcCommandHandler, &hInstance + 1, &dword_14001C4E8);
  v4 = v3;
  if ( v3 < 0 )
  {
    v15 = 46;
LABEL_26:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_140012D58, 2LL, v3, v15, 0LL);
    return v4;
  }
  if ( !dword_14001C4E8 )
  {
    ...
    if ( !(unsigned int)RegisterSessionPort(*(&hInstance + 1)) )
    {
      ...
      if ( (v4 & 0x80000000) == 0 )
        v4 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_140012D58, 2LL, v4, 0x36u, 0LL);
      CDwmAppHost::ReportEventWithDword(v7, 1u, 0xC0002344, v4);
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_140012D58, 2LL, v4, 0x42u, 0LL);
      return v4;
    }
