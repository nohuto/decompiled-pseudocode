/*
 * XREFs of ?EnsureSubscribedToProcessWideUsageFlushUnderLock@FeatureStateManager@details@wil@@AEAAXXZ @ 0x140007AA0
 * Callers:
    ...
    if ( v3 )
    {
      ...
      *v1 = 0LL;
      ...
      wil::details_abi::SubscriptionList::SubscribeUnderLock(
        ...
        v1,
        (void (*)(void *))`wil::details::FeatureStateManager::EnsureSubscribedToProcessWideUsageFlushUnderLock'::`5'::_lambda_1_::_lambda_invoker_cdecl_,
        this);
