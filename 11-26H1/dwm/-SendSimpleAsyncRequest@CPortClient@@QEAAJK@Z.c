/*
 * XREFs of ?SendSimpleAsyncRequest@CPortClient@@QEAAJK@Z @ 0x140002398
 * Callers:
 ...
 *     ?LpcVerifyOutgoingPayloadSize@@YAXPEBU_PORT_MESSAGE@@@Z @ 0x14000248C (-LpcVerifyOutgoingPayloadSize@@YAXPEBU_PORT_MESSAGE@@@Z.c)
...
__int64 __fastcall CPortClient::SendSimpleAsyncRequest(CPortClient *this, int a2)
{
  ...
  *(_DWORD *)v7 = 3145736;
  ...
  v4 = NtAlpcSendWaitReceivePort(*((_QWORD *)this + 2), 0x10000LL, v7, 0LL, 0LL, 0LL, 0LL, 0LL);
