/*
 * XREFs of ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x140003D48
 * Callers:
 ...
 * Callees:
 *     ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x140004414 (--0SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 */
