/*
 * XREFs of __scrt_common_main_seh @ 0x1400047F0
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x140004A04 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x140004AD8 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x140004B78 (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x140004BA4 (__scrt_uninitialize_crt.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x140004F60 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_get_dyn_tls_dtor_callback @ 0x140004F70 (__scrt_get_dyn_tls_dtor_callback.c)
 *     __scrt_fastfail @ 0x140004F94 (__scrt_fastfail.c)
 *     __scrt_get_show_window_mode @ 0x140005108 (__scrt_get_show_window_mode.c)
 *     __scrt_is_managed_app @ 0x140005154 (__scrt_is_managed_app.c)
 *     _initterm_0 @ 0x1400057EC (_initterm_0.c)
 *     _initterm_e_0 @ 0x1400057F8 (_initterm_e_0.c)
 *     _c_exit_0 @ 0x140005804 (_c_exit_0.c)
 *     _register_thread_local_exe_atexit_callback_0 @ 0x140005810 (_register_thread_local_exe_atexit_callback_0.c)
 *     _o__cexit_0 @ 0x140005858 (_o__cexit_0.c)
 *     _o__exit_0 @ 0x140005888 (_o__exit_0.c)
 *     _o__get_wide_winmain_command_line_0 @ 0x140005894 (_o__get_wide_winmain_command_line_0.c)
 *     _seh_filter_exe @ 0x1400058E8 (_seh_filter_exe.c)
 *     _o_exit_0 @ 0x140005918 (_o_exit_0.c)
