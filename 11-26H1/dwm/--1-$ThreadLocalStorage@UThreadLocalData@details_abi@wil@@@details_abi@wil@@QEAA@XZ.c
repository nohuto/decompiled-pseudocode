/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x140006EA8
 * Callers:
 ...
 * Callees:
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x140007704 (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
