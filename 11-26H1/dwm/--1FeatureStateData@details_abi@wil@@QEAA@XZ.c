/*
 * XREFs of ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x140007068
 * Callers:
 ...
 * Callees:
 *     ??1SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1400045D8 (--1SubscriptionList@details_abi@wil@@QEAA@XZ.c)
