...
__int64 __fastcall CDwmAppHost::Run(CDwmAppHost *this)
{
  ...
  if ( (_DWORD)v8 != 10 )
    BlackScreenDiagnostics::CLongPowerButtonHoldListener::Start(
      (BlackScreenDiagnostics::CLongPowerButtonHoldListener *)&byte_14001C548,
      v4,
      v5);
  ...
  if ( (_DWORD)v8 != 10 )
    BlackScreenDiagnostics::CLongPowerButtonHoldListener::Stop((BlackScreenDiagnostics::CLongPowerButtonHoldListener *)&byte_14001C548);
  if ( hWnd )
