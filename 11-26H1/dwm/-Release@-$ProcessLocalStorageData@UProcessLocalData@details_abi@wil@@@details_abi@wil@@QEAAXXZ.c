/*
 * XREFs of ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x14000A4D8
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x14000F920 (wil--details--_dynamic_atexit_destructor_for__g_processLocalData__.c)
 * Callees:
