/*
 * XREFs of ?GetDword@CSettingsManager@@AEAAJW4DwmSettingType@@PEBGPEAK@Z @ 0x140002A8C
 * Callers:
 *     ?ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z @ 0x1400028A0 (-ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z.c)
 *     ?GetPreferenceDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x140002910 (-GetPreferenceDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 ...
 *     ?GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x14000CF50 (-GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 * Callees:
 *     <none>
 */
