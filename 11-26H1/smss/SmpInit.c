 ...
 *     SmpInitializeKnownSubSystems @ 0x14000E0C0 (SmpInitializeKnownSubSystems.c)
...
LABEL_3:
  ...
  if ( v4 < 0 )
  {
    SmpLogFailure((__int64)"SmpInit", 1718, v4);
...
LABEL_9:
  ...
  if ( v6 >= 0 )
  {
    ...
    SmpInitLastCall = (__int64)NtQuerySystemInformation;
    SmpLogFailure((__int64)"SmpInit", 1798, v6);
    return 3221225473LL;
  }
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( SecurityDescriptors >= 0 )
      {
        ...
        *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
        ...
        if ( v15 < 0 )
        {
          SmpLogFailureString((__int64)"SmpInit", 0x767u, (__int64)v21, v15);
          EventHandle = 0LL;
        }
    ...
    SmpInitLastCall = (__int64)NtQuerySystemInformation;
    SmpLogFailure((__int64)"SmpInit", 1778, v9);
