/*
 * XREFs of SmpBuildSubSystemLists @ 0x1400132D0
 * Callers:
 *     <none>
 * Callees:
 *     SmpLogFailureString @ 0x140001D34 (SmpLogFailureString.c)
 *     SmpFindRegistryValueEx @ 0x140008F4C (SmpFindRegistryValueEx.c)
 *     SmpDeallocSavedRegistryEntry @ 0x14000BD48 (SmpDeallocSavedRegistryEntry.c)
 */
...
LABEL_18:
        ...
        *(_QWORD *)(v10 + 8) = Buffer;
        ...
        {
          v14 = (struct _UNICODE_STRING **)qword_140031A88;
          if ( *(__int64 **)qword_140031A88 != &SmpSubSystemsToDefer )
            goto LABEL_18;
          *(_QWORD *)&v9->Length = &SmpSubSystemsToDefer;
          v9->Buffer = (PWSTR)v14;
          *v14 = v9;
          qword_140031A88 = (__int64)v9;
        }
        else
        {
          v13 = (struct _UNICODE_STRING **)qword_140031A78;
          if ( *(__int64 **)qword_140031A78 != &SmpSubSystemsRequired )
            goto LABEL_18;
          *(_QWORD *)&v9->Length = &SmpSubSystemsRequired;
          v9->Buffer = (PWSTR)v13;
          *v13 = v9;
          qword_140031A78 = (__int64)v9;
          *(_DWORD *)a6 += 2;
      ...
      {
        SmpLogFailureString((__int64)"SmpBuildSubSystemLists", 0x229Cu, (__int64)a3, 0);
        do
        {
          v16 = *a3;
          v15 = a3++;
