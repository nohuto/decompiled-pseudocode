/*
 * XREFs of SmpCopyFile @ 0x14001196C
 * Callers:
...
__int64 __fastcall SmpCopyFile(HANDLE FileHandle, struct _UNICODE_STRING *a2, union _LARGE_INTEGER a3)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v8.QuadPart )
    {
      ...
      if ( v8.QuadPart % (unsigned __int64)(unsigned int)dword_140031AE8 )
        v7 = dword_140031AE8;
  ...
  if ( FileHandlea )
  {
          ...
          v12 < 0) )
    {
      ...
      if ( (unsigned int)dword_14002FE08 > 5 )
      {
        ...
        v29 = &v24;
        v30 = 8LL;
        tlgWriteTransfer_EtwEventWriteTransfer(4LL, byte_14002AF09, v13, v14, 4, (__int64)v26);
      }
      v11 = FileHandlea;
    }
    NtClose(v11);
