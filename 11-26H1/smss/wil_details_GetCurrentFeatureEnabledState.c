/*
 * XREFs of wil_details_GetCurrentFeatureEnabledState @ 0x14001A128
 * Callers:
...
__int64 __fastcall wil_details_GetCurrentFeatureEnabledState(__int64 a1, _DWORD *a2)
{
  ...
  *a2 = 1;
  ...
  v16 = 0LL;
  v15 = 0LL;
  FeatureState = wil_RtlStagingConfig_QueryFeatureState((__int64)&v15, v6, v5);
  HIDWORD(v17) = 0;
  v8 = (unsigned __int8)v15 & (unsigned __int8)-(FeatureState != 0) & 3;
  if ( v8 )
  {
    v9 = 0;
    if ( (_DWORD)v15 == 2 )
