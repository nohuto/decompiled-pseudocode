/*
 * XREFs of CreateRegistryLinksForMachine @ 0x14000B980
 * Callers:
 ...
 *     Wow64SelectWowNodePathInternal @ 0x14001AA34 (Wow64SelectWowNodePathInternal.c)
 */
  ...
  for ( i = 0; i < 0x4E; ++i )
  {
    ...
    if ( v5 )
    {
      ...
      if ( v11 - 24 < 0 )
        v12 = 24 - v11;
      v13 = 2 * v12;
      v14 = p_DestinationString->MaximumLength + v13;
      v15 = (unsigned __int16)(v9->MaximumLength + v13);
      Heap = (WCHAR *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), 0, v14);
      *(_QWORD *)&DestinationString.Length = 0LL;
      DestinationString.MaximumLength = v14;
      DestinationString.Buffer = Heap;
      v17 = (WCHAR *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), 0, v15);
      *(_QWORD *)&v20.Length = 0LL;
      v20.MaximumLength = v15;
      v20.Buffer = v17;
