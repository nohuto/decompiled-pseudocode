/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x14000E574
 * Callers:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_140031AE8 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_140031AE8
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_140031AE8 - 1)
                                                   + 8256LL);
