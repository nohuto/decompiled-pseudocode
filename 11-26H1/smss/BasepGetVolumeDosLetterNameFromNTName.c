/*
 * XREFs of BasepGetVolumeDosLetterNameFromNTName @ 0x14001ACB8
 * Callers:
...
__int64 __fastcall BasepGetVolumeDosLetterNameFromNTName(const wchar_t *Src, _QWORD *a2)
{
  ...
  LODWORD(v19) = _wcsnicmp(Src, L"\\Device\\MUP", 0xBuLL);
  if ( (_DWORD)v19 )
  {
        ...
        *Heap = v12;
        ...
        while ( 1 )
        {
          ...
          if ( !v14 )
            goto LABEL_38;
          v15 = (WCHAR *)(v14 + 1);
          v7 = DeviceIoControl(FileW, 0x6D0030u, (__int64)(v14 + 1), v13 - 8, (__int64)&v19);
          v13 = *(_DWORD *)v15 + 16;
          if ( v7 )
            break;
