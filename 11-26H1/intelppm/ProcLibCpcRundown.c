/*
 * XREFs of ProcLibCpcRundown @ 0x14002C048
 * Callers:
 ...
 *     CpcLastValue @ 0x14002BD80 (CpcLastValue.c)
 */
        ...
        if ( v13 )
        {
          ...
          do
          {
            if ( CpcRegisterIsSupportedEx(*v5 + v4) )
            {
              ...
              EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v3, 0LL, (ULONG)(5 - (Value != 1)), &UserData);
            }
            v5 += 6;
            --v6;
          }
