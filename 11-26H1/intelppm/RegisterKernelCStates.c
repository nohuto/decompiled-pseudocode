/*
 * XREFs of RegisterKernelCStates @ 0x140042198
 * Callers:
  ...
  if ( v3 && *(_DWORD *)v3 )
  {
    ...
    *(_DWORD *)(a3 + 48) = 0;
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      HIWORD(v34) = 0;
      v35 = 0;
      DecodeAcpi2CState(v7, (unsigned int)&v34, (unsigned int)&v29, (unsigned int)&v28, a3 + 56);
      v8 = 2;
      *(_DWORD *)(a2 + 104) = *(_DWORD *)(a2 + 104) & 0x7FFFFD80 | (v28 << 31) | 0xF;
      *(_DWORD *)(a2 + 96) = 1;
      *(_DWORD *)(a3 + 48) = 1;
    }
    v12 = *(_DWORD *)v3;
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v14 == v8 )
      {
        ...
        v32 = v17;
        v27 = (_QWORD *)(v17 + a3 + 56);
        v33 = 5LL * i;
        v18 = v3 + 4 * (v33 + 1);
        *v27 = v18;
        if ( (int)DecodeAcpi2CState(v7, v18, (unsigned int)&v29, (unsigned int)&v28, (__int64)v27) < 0 )
        {
