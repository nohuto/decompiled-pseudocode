/*
 * XREFs of RegisterHvPackage @ 0x14003EC90
 * Callers:
 *     <none>
 * Callees:
 *     GetHvProcessorInfo @ 0x140005FB0 (GetHvProcessorInfo.c)
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( HvProcessorInfo )
  {
    ...
    while ( (__int64 *)v6 != &qword_140019208 );
    if ( !v7 )
    {
LABEL_6:
...
LABEL_18:
      ...
      *v10 = v10;
      if ( dword_140019758 )
      {
        v11 = (unsigned int)dword_140019758;
        v12 = (_DWORD *)(qword_140019750 + 8);
        do
        {
          v13 = v4 == *v12;
          v14 = v9 + 1;
      ...
      *(_DWORD *)(v7 + 36) = v9;
      ...
      v15 = (__int64 *)qword_140019210;
      if ( *(__int64 **)qword_140019210 != &qword_140019208 )
LABEL_20:
        __fastfail(3u);
      *(_QWORD *)(v7 + 8) = qword_140019210;
      *(_QWORD *)v7 = &qword_140019208;
      *v15 = v7;
      qword_140019210 = v7;
