/*
 * XREFs of ProcLibTraceQueryWpsCapabilities @ 0x14002CA80
 * Callers:
...
BOOLEAN __fastcall ProcLibTraceQueryWpsCapabilities(char a1)
{
  ...
  if ( result )
  {
    v3 = (unsigned __int8)byte_140019B90;
    v4 = (unsigned __int8)byte_140019B91;
    UserData.Ptr = (unsigned __int64)&v3;
    v6 = &v4;
    *(_QWORD *)&UserData.Size = 4LL;
    v7 = 4LL;
    return EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v1, 0LL, (ULONG)2, &UserData);
  }
  return result;
}
