/*
 * XREFs of PepDevicePowerControlCallback @ 0x14000F4C0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_ @ 0x140003440 (WPP_RECORDER_SF_.c)
 *     PepUpdatePerformanceConstraint @ 0x140005A24 (PepUpdatePerformanceConstraint.c)
        ...
        _QWORD *a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( v14 )
    return -1073741637;
  if ( _InterlockedCompareExchange(&dword_140019B8C, 1, 0) )
  {
  ...
  {
    if ( byte_140019B90 && qword_140019BB0 )
      IoQueueWorkItem(qword_140019BB0, PepWpsUpdateWorker, DelayedWorkQueue, 0LL);
    return 0;
  }
}
