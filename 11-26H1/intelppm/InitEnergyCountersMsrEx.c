/*
 * XREFs of InitEnergyCountersMsrEx @ 0x14002A440
 * Callers:
 *     InitEnergyCounters @ 0x14002A270 (InitEnergyCounters.c)
 * Callees:
 *     ActivateFixedFunctionCounters @ 0x140006188 (ActivateFixedFunctionCounters.c)
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_1400199A0[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_140019998[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
