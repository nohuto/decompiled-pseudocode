/*
 * XREFs of CpcHighestNotifyWorker @ 0x140045AFC
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1400285C0 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x140045AE0 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
...
LABEL_12:
      ...
      *(_DWORD *)(v6 + 100) = v15;
      if ( (unsigned int)v15 > *(_DWORD *)(v6 + 104) )
        *(_DWORD *)(v6 + 104) = v15;
      LODWORD(v22) = 100 * GenAddrMaybeHidden / v14;
      if ( *(_DWORD *)(v5 + 80) )
      {
        v23 = *(_DWORD *)(v5 + 80);
        v16 = *(_DWORD *)(v5 + 84);
      ...
      {
        if ( !byte_140019740 || (v17 = *(_QWORD *)(v5 + 1080)) == 0 || *(_DWORD *)(v17 + 36) <= 1u )
        {
...
LABEL_39:
          ...
          ((void (__fastcall *)(__int64 *))qword_1400194D0)(&v22);
