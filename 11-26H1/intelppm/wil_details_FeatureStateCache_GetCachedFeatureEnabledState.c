/*
 * XREFs of wil_details_FeatureStateCache_GetCachedFeatureEnabledState @ 0x140002B7C
 * Callers:
 *     wil_details_AreDependenciesEnabled @ 0x14000723C (wil_details_AreDependenciesEnabled.c)
