/*
 * XREFs of ReadEnergyEquation @ 0x14004C7C8
 * Callers:
 *     PopulateEnergyEstimationModel @ 0x14004C678 (PopulateEnergyEstimationModel.c)
 * Callees:
 *     RtlStringCchPrintfW @ 0x140005BB8 (RtlStringCchPrintfW.c)
 *     RtlStringCopyWorkerW @ 0x140005F40 (RtlStringCopyWorkerW.c)
 *     RtlStringCchCatW @ 0x14000EC54 (RtlStringCchCatW.c)
