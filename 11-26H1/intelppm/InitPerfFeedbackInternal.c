/*
 * XREFs of InitPerfFeedbackInternal @ 0x140037C40
 * Callers:
 *     RegisterKernelPerfFeedback @ 0x140039840 (RegisterKernelPerfFeedback.c)
 *     RegisterHvPerfFeedbackCounters @ 0x14003EF20 (RegisterHvPerfFeedbackCounters.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *))
{
        ...
        (v4 = (_QWORD *)inited) != 0LL) )
  {
    ...
    *(_WORD *)(inited + 6) = 1;
    *(_BYTE *)(inited + 52) = 2;
    *(_BYTE *)(inited + 14) = byte_140019748;
