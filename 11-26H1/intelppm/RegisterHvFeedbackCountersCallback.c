/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x14003E540
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_D @ 0x140004618 (WPP_RECORDER_SF_D.c)
 *     _guard_dispatch_icall @ 0x140010390 (_guard_dispatch_icall.c)
 *     DecodeGenAddressToHvPerfReg @ 0x14003DE8C (DecodeGenAddressToHvPerfReg.c)
 */
          ...
          *v10 = 0;
          ...
          while ( 1 )
          {
            ...
            if ( *(_BYTE *)(v14 + 24 * v13 + 17) && *(_BYTE *)(v14 + 24 * v13 + 16) )
            {
              ...
              {
                v19 = *(_QWORD *)(v14 + 24 * v13) == (_QWORD)PerfReadWrappingCounter;
          ...
          if ( *(_BYTE *)(a1 + 13) && qword_140019420 )
          {
            v6 = qword_140019420(*(_QWORD *)(32LL * (unsigned int)v12 + v9 + 8));
            if ( v6 < 0 )
            {
              *(_BYTE *)(a1 + 13) = 0;
              goto LABEL_45;
