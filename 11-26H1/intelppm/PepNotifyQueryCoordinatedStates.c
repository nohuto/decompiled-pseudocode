/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x14003A390
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, PVOID **a2)
{
  ...
  v2 = (unsigned int)dword_140019854;
  v4 = 0LL;
  v5 = 0LL;
  Pool2 = (unsigned int *)ExAllocatePool2(64LL, (unsigned int)(16 * dword_140019854 + 4), 1919119952LL);
  v37 = Pool2;
  v7 = Pool2;
  if ( Pool2 )
  {
        ...
        for ( i = 0LL; (unsigned int)i < (unsigned int)v2; i = (unsigned int)(i + 1) )
        {
          ...
          for ( j = 0; j < *((_DWORD *)v28 + 87); ++j )
          {
            ...
            *v5 = i;
            v5[1] = j;
            v5[2] = *((_DWORD *)v28 + 86);
            v8 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_140019550)(*(_QWORD *)(a1 + 1120), v5);
            if ( v8 < 0 )
              goto LABEL_31;
