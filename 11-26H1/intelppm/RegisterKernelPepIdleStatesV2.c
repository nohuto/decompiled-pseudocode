/*
 * XREFs of RegisterKernelPepIdleStatesV2 @ 0x140041DEC
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStatesV2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v35; // ecx
  int v36; // ecx
  unsigned __int8 v38; // [rsp+30h] [rbp-39h] BYREF
  ...
  while ( 1 )
  {
    ...
    *(_OWORD *)(v19 + 120) = v23;
    ...
    if ( v24 )
    {
      ...
      if ( v26 != &v46 )
        *v42 = v26;
      if ( (int)DecodeAcpi2CState(a1, (_DWORD)v26, (unsigned int)&v44, (unsigned int)&v38, v29) < 0 )
      {
