/*
 * XREFs of AcpiParseProcessorContainer @ 0x140030AC0
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x14002FA9C (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x140008598 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x140009EB8 (RtlUnicodeStringCopyString.c)
      ...
      if ( v15 )
      {
        ...
        *(_QWORD *)(a3 + 32) = v16;
        ...
        while ( v17 < a1[2 * v5 + 6] )
        {
          ...
          {
            if ( dword_140019ACC <= (unsigned int)dword_1400191A4 )
              return -1073741275;
