/*
 * XREFs of GetWmiBiosThrottleStateInfo @ 0x14000B3E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  *(_BYTE *)a3 = byte_140019186;
  *(_BYTE *)(a3 + 1) = byte_140019187;
  ...
  *(_DWORD *)(a3 + 80) = v21;
  if ( (_DWORD)v21 )
  {
    ...
    do
    {
      v25 = *(_QWORD *)(v11 + 504);
      v22 += 20LL;
      *(v24 - 1) = *(_DWORD *)(v22 + v25 - 16);
      *v24 = *(_DWORD *)(v22 + v25 - 12);
      v24 += 10;
      *(v24 - 9) = *(_DWORD *)(v22 + v25 - 8);
      *(v24 - 8) = *(_DWORD *)(v22 + v25 - 4);
      *(v24 - 7) = *(_DWORD *)(v22 + v25);
      *(_QWORD *)(v24 - 5) = 0LL;
      *(_QWORD *)(v24 - 3) = 0LL;
      --v23;
    }
