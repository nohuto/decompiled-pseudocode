/*
 * XREFs of RegisterIdleDomain @ 0x140038960
 * Callers:
...
char __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  v6 = qword_140019218;
  v7 = v2 + 24LL * a2;
  if ( (__int64 *)qword_140019218 == &qword_140019218 )
    goto LABEL_6;
  do
  {
    v8 = v6;
  ...
  while ( (__int64 *)v6 != &qword_140019218 );
  if ( !v8 )
  {
LABEL_6:
    ...
    v10[1] = v10;
    *v10 = v10;
    v11 = (__int64 *)qword_140019220;
    if ( *(__int64 **)qword_140019220 != &qword_140019218 )
LABEL_15:
      __fastfail(3u);
    *(_QWORD *)v8 = &qword_140019218;
    *(_QWORD *)(v8 + 8) = v11;
    *v11 = v8;
    qword_140019220 = v8;
