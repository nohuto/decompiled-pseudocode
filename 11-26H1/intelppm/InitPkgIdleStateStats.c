/*
 * XREFs of InitPkgIdleStateStats @ 0x1400474C0
 * Callers:
 *     InitMeasRegisters @ 0x14002B710 (InitMeasRegisters.c)
 * Callees:
 *     ReadMSRValue @ 0x1400024F0 (ReadMSRValue.c)
...
__int64 __fastcall InitPkgIdleStateStats(__int64 a1, char a2)
{
  ...
  v22 = 0LL;
  v25 = 0LL;
  if ( (qword_140019AF8 & 0x100000000LL) != 0 )
