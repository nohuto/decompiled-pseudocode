/*
 * XREFs of wil_details_RegisterFeatureUsageProvider @ 0x14002D93C
 * Callers:
...
__int64 wil_details_RegisterFeatureUsageProvider()
{
  ...
  v1[0] = wil_details_FeatureDescriptors_SkipPadding(&Feature_ShortQosHysteresisIntel__private_descriptor);
  v1[2] = 0LL;
