/*
 * XREFs of ProcLibTracePerfStatesRundown @ 0x1400452F8
 * Callers:
...
void __fastcall ProcLibTracePerfStatesRundown(__int64 a1)
{
  ...
  {
    if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, EventDescriptorAndProcessorId) )
    {
      v4 = *(_QWORD *)(a1 + 224);
      if ( v4 )
      {
        ...
        if ( Pool2 )
        {
          ...
          v18 = 6 * v7;
          v19 = 0;
          EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v3, 0LL, (ULONG)3, &UserData);
