/*
 * XREFs of FxDriverEntryWorker @ 0x140007F24
 * Callers:
 *     FxDriverEntry @ 0x140007EF0 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_140018F10;
...
LABEL_10:
    ...
    if ( WdfDriverGlobals->DisplaceDriverUnload )
    {
      if ( DriverObject->DriverUnload )
        qword_140019118 = (__int64)DriverObject->DriverUnload;
