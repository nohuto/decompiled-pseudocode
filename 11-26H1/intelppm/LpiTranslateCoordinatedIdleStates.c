/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x14003F484
 * Callers:
 ...
 *     ValidateCoordinatedLpiStates @ 0x140034B34 (ValidateCoordinatedLpiStates.c)
...
__int64 __fastcall LpiTranslateCoordinatedIdleStates(int a1, _DWORD *a2, unsigned int **a3, PVOID *a4, _QWORD *a5)
{
  ...
  v43 = 0LL;
  v45 = 0LL;
  v6 = ValidateCoordinatedLpiStates((_DWORD *)qword_140019888, 0LL);
  if ( v6 < 0 )
      ...
      while ( (unsigned int)v22 < *(_DWORD *)(v21 + 16) )
      {
        ...
        *(_QWORD *)(v25 + 280) = *(_QWORD *)(v21 + 8);
        ...
        if ( v6 < 0 )
          goto LABEL_18;
        v28 = (char *)(v41 + 304);
        if ( (unsigned int)KeIsEqualAffinityEx(v41, &unk_1400195E8) )
          *v28 = 1;
        v29 = v44;
        v24[48] = *v28;
