/*
 * XREFs of CpcConnectNativeInterrupt @ 0x14002DA68
 * Callers:
...
void __fastcall CpcConnectNativeInterrupt(struct _DEVICE_OBJECT **DeferredContext)
{
  ...
  if ( WorkItem )
  {
    ...
    if ( (int)((__int64 (__fastcall *)(struct _DEVICE_OBJECT **))qword_1400193F8)(DeferredContext) >= 0 )
    {
      LOBYTE(v1->Queue.Wcb.CurrentIrp) = 1;
      ((void (*)(void))qword_140019410)();
    }
  }
