/*
 * XREFs of RegisterKernelPepPerf @ 0x140039290
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepTranslateLimitReason @ 0x140029770 (PepTranslateLimitReason.c)
...
__int64 __fastcall RegisterKernelPepPerf(__int64 a1)
{
  ...
  v42 = 0LL;
  v46 = 0;
  v2(WdfDriverGlobals, qword_1400191A8, 0LL);
  v4 = *(_QWORD *)(a1 + 1184);
  v5 = 0LL;
  Pool2 = 0LL;
  v43 = v4;
  ...
  if ( v41 )
  {
    ...
    while ( !(unsigned int)EnumerateNextDevice((__int64 *)v44, &v42) )
    {
      ...
      *(_QWORD *)v11 = *(_QWORD *)(v12 + 1184);
      ...
      v13 = *(_DWORD *)(v4 + 8);
      v14 = *((_DWORD *)v11 + 6);
      if ( v14 > v13 || v14 < *(_DWORD *)(v4 + 16) )
      {
        v7 = -1073741811;
        goto LABEL_68;
      }
      *((_DWORD *)v11 + 7) = 100 * v14 / v13;
      v11 += 72;
    }
    v16 = v48;
    ...
    if ( inited )
    {
      ...
      *(_BYTE *)(v5 + 15) = v27;
      v7 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))qword_1400194C8)(v5, v33, v32, v31);
      if ( v7 >= 0 )
      {
        ResetEnumerationContext((__int64 *)v44);
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v44, &v42) )
