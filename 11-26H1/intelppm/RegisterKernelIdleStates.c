/*
 * XREFs of RegisterKernelIdleStates @ 0x140041490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelIdleStates(__int64 a1)
{
  ...
  v1 = 0LL;
  if ( *(_DWORD *)(a1 + 80) )
    return (unsigned int)((__int64 (*)(void))qword_140019738)();
...
LABEL_6:
  ...
  v6 = 3;
LABEL_7:
  Pool2 = (_DWORD *)ExAllocatePool2(64LL, (unsigned int)(88 * v6 + 56), 1919119952LL);
  if ( !Pool2 )
  ...
  if ( v8 )
  {
    ...
    *v9 = (struct _PROCESSOR_NUMBER)87;
...
LABEL_43:
    ...
    if ( (*(_QWORD *)(a1 + 280) & 0x100200000200LL) != 0 && *(_QWORD *)(a1 + 712) )
      HIBYTE(v9[4].Group) = 1;
    v13 = ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1400194E0)(v9);
