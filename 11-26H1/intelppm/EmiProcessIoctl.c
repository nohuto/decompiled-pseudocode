/*
 * XREFs of EmiProcessIoctl @ 0x140042B10
 * Callers:
 *     <none>
 * Callees:
  ...
  switch ( a5 )
  {
      ...
      if ( v13 >= 0 )
      {
        ...
        *((_WORD *)v21 + 33) = *(_WORD *)(v10 + 1256);
        if ( *(_WORD *)(v10 + 1256) )
        {
          ...
          do
          {
            LODWORD(v31) = ((__int64 (__fastcall *)(__int64, _QWORD, __int64))qword_140019468)(
                             v10,
                             v23,
                             0x800000000000LL);
            ((void (__fastcall *)(_QWORD, __int64 *, __int64 *, int *))qword_140019478)(
              (unsigned int)v31,
              &v34,
              &v33,
              &v30);
    ...
    case 2244620:
      ...
      if ( v13 >= 0 )
      {
        ...
        v7 = v12;
        v36 = v12;
        ((void (__fastcall *)(__int64, __int64))qword_140019460)(v10, 0x800000000000LL);
        v14 = 0;
        if ( *(_WORD *)(v10 + 1256) )
        {
          v15 = v31;
          do
          {
            v16 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64))qword_140019468)(v10, v14, 0x800000000000LL);
            v17 = (unsigned __int64 *)&v15[16 * v5];
            v13 = ((__int64 (__fastcall *)(__int64, _QWORD, unsigned __int64 *, unsigned __int64 *))qword_140019470)(
                    v10,
                    v16,
                    v17,
                    v17 + 1);
