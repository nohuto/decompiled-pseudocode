/*
 * XREFs of ProcLibTracePlatformIdleStates @ 0x140044500
 * Callers:
...
void __fastcall ProcLibTracePlatformIdleStates(char a1)
{
  ...
  if ( Src )
  {
    ...
    if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v3) )
    {
      ...
      if ( !(_DWORD)v8 || (Pool2 = (_WORD *)ExAllocatePool2(256LL, 12 * v8, 1919119952LL)) != 0LL )
      {
LABEL_16:
        v19 = 0;
        if ( v1[1] )
        {
          ...
          do
          {
            *(_QWORD *)&UserData.Size = 4LL;
            ...
            EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v3, 0LL, v11, &UserData);
