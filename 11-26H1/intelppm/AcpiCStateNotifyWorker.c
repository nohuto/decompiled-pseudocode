/*
 * XREFs of AcpiCStateNotifyWorker @ 0x14003F9F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AcpiCStateNotifyWorker(__int64 a1, struct _IO_WORKITEM *a2)
{
  ...
  if ( (*(_DWORD *)(v8 + 280) & 0x7F070) != 0 )
  {
    ...
    *(_QWORD *)(v8 + 536) = v4;
    ...
    ((void (__fastcall *)(__int64))qword_1400196F0)(v8);
    v12 = (_QWORD *)(v8 + 208);
...
LABEL_11:
  ProcLibTraceProcessorSpecificEvent(v8, &PPM_ETW_NOTIFY_81, &PPM_ETW_NOTIFY_81_HV, 0, 0LL);
