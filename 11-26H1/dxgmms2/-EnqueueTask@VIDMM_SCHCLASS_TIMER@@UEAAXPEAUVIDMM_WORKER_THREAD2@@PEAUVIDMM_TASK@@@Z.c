/*
 * XREFs of ?EnqueueTask@VIDMM_SCHCLASS_TIMER@@UEAAXPEAUVIDMM_WORKER_THREAD2@@PEAUVIDMM_TASK@@@Z @ 0x1400C0490
 * Callers:
 *     <none>
 * Callees:
 *     CompareTaskExpiration @ 0x1400C025C (CompareTaskExpiration.c)
 */
