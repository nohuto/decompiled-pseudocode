/*
 * XREFs of ?Init@VIDMM_LINEAR_POOL@@QEAAJ_KEP6AXPEAX1@ZP6A_N1@Z@Z @ 0x1400BFD04
 * Callers:
        ...
        bool (*a5)(void *))
{
  ...
  struct _VIDMM_POOL_BLOCK *v9; // rsi
  _QWORD *v10; // rcx
  _QWORD *v11; // rax
  __int64 v12; // rdx
  _QWORD *v13; // rcx
  ...
  *((_QWORD *)this + 5) = a5;
  ...
  if ( Block )
  {
    ...
    *((_QWORD *)v9 + 1) = a2;
    ...
    v12 = *((_QWORD *)this + 6);
    if ( *(VIDMM_LINEAR_POOL **)(v12 + 8) != (VIDMM_LINEAR_POOL *)((char *)this + 48)
      || (*((_QWORD *)v9 + 4) = v10,
          *v11 = v12,
          *(_QWORD *)(v12 + 8) = v11,
          *v10 = v11,
          ...
          *(VIDMM_LINEAR_POOL **)(v14 + 8) != (VIDMM_LINEAR_POOL *)((char *)this + 80)) )
    {
      __fastfail(3u);
    }
    *v15 = v14;
