/*
 * XREFs of ?DelayExecution@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@IPEAUVIDMM_PAGING_QUEUE@@KPEA_K@Z @ 0x14009D64C
 * Callers:
 *     VidMmDelayExecution @ 0x14004D4B0 (VidMmDelayExecution.c)
 * Callees:
