/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1400A2C90
 * Callers:
 *     VidMmCreateCompanionContext @ 0x14004D470 (VidMmCreateCompanionContext.c)
 * Callees:
