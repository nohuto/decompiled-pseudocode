/*
 * XREFs of McTemplateK0pqqqxq_EtwWriteTransfer @ 0x14003F308
 * Callers:
...
NTSTATUS McTemplateK0pqqqxq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &SetInterruptTargetPresentId, a3, 7u, &v4);
}
