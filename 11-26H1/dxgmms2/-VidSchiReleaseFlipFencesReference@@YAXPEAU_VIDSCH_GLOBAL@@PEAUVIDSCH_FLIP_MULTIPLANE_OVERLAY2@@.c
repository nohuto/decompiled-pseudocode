/*
 * XREFs of ?VidSchiReleaseFlipFencesReference@@YAXPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_MULTIPLANE_OVERLAY2@@@Z @ 0x140014EB8
 * Callers:
        ...
        struct VIDSCH_FLIP_MULTIPLANE_OVERLAY2 *a2)
{
  ...
  if ( !VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR::end((VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR *)v17) )
  {
    while ( 1 )
    {
      v14 = (unsigned int)(8 * v13 * (*((_DWORD *)a2 + 2) + 28));
      v15 = *(char **)((char *)a2 + v14 + 216);
      if ( v15 )
      {
        VidSchiReleaseSyncObjectReference(v15, v12);
        *(_QWORD *)((char *)a2 + v14 + 216) = 0LL;
      }
      v16 = *(char **)((char *)a2 + v14 + 232);
      if ( v16 )
      {
        if ( v10 < v11 )
        {
          VidSchiReleaseSyncObjectReference(v16, v12);
          *(_QWORD *)((char *)a2 + v14 + 232) = 0LL;
        }
      }
      VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR::operator++(v17);
      if ( VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR::end((VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR *)v17) )
        break;
      v11 = v22;
      v10 = v21;
