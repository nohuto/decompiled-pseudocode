/*
 * XREFs of ?FindAvailableCurrentValueStorageSlot@VIDMM_PROCESS_FENCE_STORAGE@@AEAA_NPEAVVIDMM_DEVICE@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z @ 0x14004E7C4
 * Callers:
      ...
      if ( *(_QWORD **)(*v8 + 8LL) != v8
        ...
        || (*v10 = v9,
            *(_QWORD *)(v9 + 8) = v10,
            ...
            v12 = *((_QWORD *)this + 5),
            *(VIDMM_PROCESS_FENCE_STORAGE **)(v12 + 8) != (VIDMM_PROCESS_FENCE_STORAGE *)((char *)this + 40)) )
      {
        __fastfail(3u);
      }
      *v8 = v12;
