/*
 * XREFs of VidSchiCreateNodeSchedulingLog @ 0x140057C78
 * Callers:
...
__int64 __fastcall VidSchiCreateNodeSchedulingLog(struct _VIDSCH_NODE *a1, unsigned int a2)
{
  ...
  v24 = 0LL;
  v22 = 0LL;
  if ( (unsigned int)v4 < *(_DWORD *)(v2 + 768) )
    v6 += 8 * v4;
  ...
  v10 = *(_QWORD *)(v2 + 696);
  if ( (unsigned int)v9 < *(_DWORD *)(v2 + 768) )
    v10 += 8 * v9;
  v20.EngineOrdinal = *(unsigned __int16 *)(*(_QWORD *)v10 + 6LL);
  v11 = *(_QWORD *)(v2 + 696) + 8 * v9;
  if ( (unsigned int)v9 >= *(_DWORD *)(v2 + 768) )
    v11 = *(_QWORD *)(v2 + 696);
...
LABEL_16:
  ...
  {
    AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v21, (unsigned __int64 *)(v2 + 2016), 1, 0);
