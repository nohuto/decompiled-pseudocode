/*
 * XREFs of ?MarkAllDevicesAsError@VIDMM_PROCESS@@QEAAXPEAVVIDMM_GLOBAL@@W4_VIDSCH_ERROR_CODE@@@Z @ 0x1400A9314
 * Callers:
...
__int64 __fastcall VIDMM_PROCESS::MarkAllDevicesAsError(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    if ( *(_QWORD *)(v4 + 8) )
    {
      for ( i = 0; (unsigned int)i < *(_DWORD *)(a2 + 6952); result = i )
      {
        v6 = 0;
        v7 = *(_QWORD *)(*(_QWORD *)(a2 + 40320) + 8LL * i);
        if ( *(_DWORD *)(v7 + 136) )
        {
          do
          {
            v8 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 8) + 304LL * i) + 184LL * v6 + 40);
            for ( j = (_QWORD *)*v8; j != v8; j = (_QWORD *)*j )
            {
              v10 = *(_QWORD *)(j[4] + 32LL);
              if ( v10 )
                VidSchMarkDeviceAsError(v10, 27);
            }
            ++v6;
          }
          while ( (unsigned int)v6 < *(_DWORD *)(v7 + 136) );
        }
        ++i;
      }
    }
