/*
 * XREFs of ?AddVaRangeToVadWithFix@CVirtualAddressAllocator@@QEAAXPEAUVIDMM_VAD@@PEAU_RTL_AVL_TREE@@PEAUVIDMM_MAPPED_VA_RANGE@@@Z @ 0x1400A9D2C
 * Callers:
  ...
  *((_DWORD *)a4 + 18) |= 0x4000u;
  ...
  if ( (*((_BYTE *)a4 + 96) & 4) != 0 )
  {
    ...
    if ( !*((_QWORD *)a2 + 7) )
    {
      ...
      v21 = *((_QWORD *)this + 17);
      if ( *(CVirtualAddressAllocator **)(v21 + 8) != (CVirtualAddressAllocator *)((char *)this + 136) )
        goto LABEL_19;
      *v19 = v21;
      *((_QWORD *)a2 + 8) = v20;
      *(_QWORD *)(v21 + 8) = v19;
