/*
 * XREFs of McTemplateK0txqqqtxtx_EtwWriteTransfer @ 0x140002F2C
 * Callers:
...
__int64 __fastcall McTemplateK0txqqqtxtx_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  v29 = 4LL;
  v31 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventIndependentFlipTransition, a3, 10LL, v13);
}
