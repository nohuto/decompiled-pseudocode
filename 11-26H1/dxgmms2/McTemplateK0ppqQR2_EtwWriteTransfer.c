/*
 * XREFs of McTemplateK0ppqQR2_EtwWriteTransfer @ 0x140046C0C
 * Callers:
...
NTSTATUS McTemplateK0ppqQR2_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v11 = v20;
  v12 = 4 * v18;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventCpuHostApertureUnmap, a3, 5u, &v4);
}
