/*
 * XREFs of ?AssignMaximumBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1400C6EF8
 * Callers:
        ...
        struct VIDMM_SEGMENT_GROUP_STATE *a3)
{
  ...
  for ( i = 0; i < 3u; ++i )
  {
    ...
    if ( *((_DWORD *)a3 + i + 81) )
    {
      ...
      while ( v10 != (char *)v9 )
      {
        v11 = (struct VIDMM_PROCESS_ADAPTER_INFO *)(v10 - 72);
        v12 = v10;
        v10 = *(char **)v10;
