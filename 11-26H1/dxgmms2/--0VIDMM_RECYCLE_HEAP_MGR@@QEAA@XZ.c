/*
 * XREFs of ??0VIDMM_RECYCLE_HEAP_MGR@@QEAA@XZ @ 0x1401148B0
 * Callers:
...
VIDMM_RECYCLE_HEAP_MGR *__fastcall VIDMM_RECYCLE_HEAP_MGR::VIDMM_RECYCLE_HEAP_MGR(char *DeferredContext)
{
  ...
  *(_OWORD *)(DeferredContext + 1624) = 0LL;
  *(_OWORD *)(DeferredContext + 1640) = 0LL;
  result = (VIDMM_RECYCLE_HEAP_MGR *)DeferredContext;
  *(_OWORD *)(DeferredContext + 1656) = 0LL;
  *(_OWORD *)(DeferredContext + 1672) = 0LL;
  return result;
}
