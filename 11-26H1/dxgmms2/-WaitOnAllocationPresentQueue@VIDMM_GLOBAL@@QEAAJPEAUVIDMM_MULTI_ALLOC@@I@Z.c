/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@I@Z @ 0x14011B6B8
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x14004DA00 (VidMmWaitOnAllocationPresentQueue.c)
...
__int64 __fastcall VIDMM_GLOBAL::WaitOnAllocationPresentQueue(VIDMM_GLOBAL *this, struct VIDMM_MULTI_ALLOC *a2)
{
  ...
  if ( *(_BYTE *)(v5 + 212) || _InterlockedCompareExchange((volatile signed __int32 *)(v5 + 208), 0, 0) )
  {
    ...
    WdLogGlobalForLineNumber = 23752;
  }
  else
  {
