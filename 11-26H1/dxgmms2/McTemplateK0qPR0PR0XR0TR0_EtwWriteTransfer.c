/*
 * XREFs of McTemplateK0qPR0PR0XR0TR0_EtwWriteTransfer @ 0x140011498
 * Callers:
...
__int64 __fastcall McTemplateK0qPR0PR0XR0TR0_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a8)
{
  _BYTE v9[16]; // [rsp+30h] [rbp-39h] BYREF
  ...
  v20 = 0;
  v23 = 0;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, 0LL, 6LL, v9);
}
