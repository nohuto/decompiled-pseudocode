/*
 * XREFs of ?VidSchiAddTriageData@@YAXPEAU_KBUGCHECK_TRIAGE_DUMP_DATA@@PEAU_KTRIAGE_DUMP_DATA_ARRAY@@@Z @ 0x14005921C
 * Callers:
 *     DxgMmsDbgTriageDumpCallback @ 0x14004D390 (DxgMmsDbgTriageDumpCallback.c)
 * Callees:
 *     <none>
 */
...
void __fastcall VidSchiAddTriageData(struct _KBUGCHECK_TRIAGE_DUMP_DATA *a1, struct _KTRIAGE_DUMP_DATA_ARRAY *a2)
{
  ...
  if ( MmIsAddressValid(&gAdapterListHead) )
  {
    for ( i = (PVOID *)gAdapterListHead; i != &gAdapterListHead; i = (PVOID *)*i )
    {
      ...
      v7 = i - 476;
      v8 = (__int64)*(i - 474);
      if ( !v8 || !MmIsAddressValid(*(i - 474)) )
        return;
      v9 = *(_DWORD *)(v8 + 444);
      if ( (v9 & 8) == 0 && (v9 & 0x10) == 0 && (v9 & 4) == 0 && (v9 & 0x20) == 0 )
      {
        v10 = KeAddTriageDumpDataBlock(a2, (_DWORD)i - 3808, (PVOID)0x1BC0, v5);
        if ( v10 < 0 )
        {
          WdLogSingleEntry3(3LL, i - 476, 7104LL, v10);
    ...
    if ( a1->BugCheckCode == 281 && g_DxgMmsBugcheckExportIndex == 1 )
    {
      ...
      if ( BugCheckParameter4 )
      {
        ...
        if ( MmIsAddressValid(BugCheckParameter4) )
        {
          ...
          if ( v26 )
          {
            v27 = KeAddTriageDumpDataBlock(a2, (ULONG)v26, (PVOID)0x3F0, v25);
            if ( v27 < 0 )
            {
              WdLogSingleEntry3(3LL, v26, 1008LL, v27);
              WdLogGlobalForLineNumber = 3164;
            }
            if ( MmIsAddressValid(v26) )
            {
              ...
              if ( v29 )
              {
                v30 = KeAddTriageDumpDataBlock(a2, (ULONG)v29, (PVOID)0x7C0, v28);
                if ( v30 < 0 )
                {
                  WdLogSingleEntry3(3LL, v29, 1984LL, v30);
                  WdLogGlobalForLineNumber = 3164;
                }
                if ( MmIsAddressValid(v29) )
                {
                  ...
                  if ( v32 )
                  {
                    ...
                    if ( MmIsAddressValid(v32) )
                    {
                      ...
                      if ( v35 )
                      {
                        v36 = KeAddTriageDumpDataBlock(a2, (ULONG)v35, (PVOID)0x1440, v34);
                        if ( v36 < 0 )
                        {
                          WdLogSingleEntry3(3LL, v35, 5184LL, v36);
                          WdLogGlobalForLineNumber = 3164;
                        }
