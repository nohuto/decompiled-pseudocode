/*
 * XREFs of ?ExpandZeroPte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@II_K222PEAPEAUVIDMM_ALLOC@@@Z @ 0x1400DC464
 * Callers:
        ...
        struct VIDMM_ALLOC **a10)
{
  ...
  v14 = *((_QWORD *)this + 7);
  v15 = a4;
  if ( (*(_BYTE *)(*((_QWORD *)this + 6) + 16LL * a4) & 2) == 0 )
    v15 = a5;
  v16 = (unsigned int)v15;
  if ( !*(_QWORD *)(v14 + 8 * v15) )
  {
    *(_QWORD *)(*((_QWORD *)this + 7) + 8LL * (unsigned int)v15) = CreatePageTable(
                                                                     a2,
                                                                     (*(_DWORD *)this >> 8) & 0x1F,
                                                                     (unsigned int)v15 > a4,
                                                                     0);
  ...
  {
LABEL_8:
    *(_QWORD *)(16 * v16 + *((_QWORD *)this + 6)) &= ~2uLL;
