/*
 * XREFs of ?InitializePartitionForAllAdapters@VIDMM_GLOBAL@@SAJPEAUVIDMM_PARTITION@@@Z @ 0x14009F50C
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::InitializePartitionForAllAdapters(struct VIDMM_PARTITION *this)
{
  ...
  {
    v4 = VIDMM_PARTITION::EnsureAdapter(this, (struct VIDMM_GLOBAL *)(i - 5655));
    v2 = v4;
    if ( v4 < 0 )
    {
      WdLogSingleEntry3(1LL, i - 5655, this, v4);
