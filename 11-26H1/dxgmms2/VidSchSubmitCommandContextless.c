/*
 * XREFs of VidSchSubmitCommandContextless @ 0x140005B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchSubmitCommandContextless(__int64 *Src, struct _VIDSCH_DEVICE *a2, __int64 a3)
{
  ...
  __int64 result; // rax
  void (*v6)(_QWORD, __int64, __int64, const wchar_t *, ...); // rax
  ...
  else
  {
    ...
    v6 = (void (*)(_QWORD, __int64, __int64, const wchar_t *, ...))DxgCoreInterface[88];
