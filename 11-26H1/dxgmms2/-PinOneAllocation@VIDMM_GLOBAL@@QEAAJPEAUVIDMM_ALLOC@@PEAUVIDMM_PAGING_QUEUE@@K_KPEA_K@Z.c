/*
 * XREFs of ?PinOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@K_KPEA_K@Z @ 0x1400E41A0
 * Callers:
 ...
 *     ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1400E4154 (-PinAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MULTI_ALLOC@@PEAUVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_.c)
 * Callees:
        ...
        unsigned __int64 *a6)
{
  ...
  if ( (int)result >= 0 && !v18 )
  {
    ...
    v13 = *v12;
    v14 = 0;
    LODWORD(v17[4]) = (**(_DWORD **)(*v12 + 368) & 0x20000) != 0 ? 5 : 0;
    if ( !a3 )
    {
      v14 = 1;
      a3 = *(struct VIDMM_PAGING_QUEUE **)(32LL * ((*(_DWORD *)(*(_QWORD *)v13 + 52LL) >> 2) & 0x3F)
