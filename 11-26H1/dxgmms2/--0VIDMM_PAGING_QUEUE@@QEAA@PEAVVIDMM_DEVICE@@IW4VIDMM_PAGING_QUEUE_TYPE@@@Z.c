/*
 * XREFs of ??0VIDMM_PAGING_QUEUE@@QEAA@PEAVVIDMM_DEVICE@@IW4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1400CA438
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::VIDMM_PAGING_QUEUE(__int64 a1, __int64 *a2, __int64 a3, char a4)
{
  ...
  *(_BYTE *)(a1 + 196) = 2;
  ...
  v6 = *(_DWORD *)(a1 + 112);
  *(_QWORD *)(a1 + 96) = a2;
  v7 = v6 ^ ((unsigned __int8)v6 ^ (unsigned __int8)(4 * *(_BYTE *)(v5 + 4576))) & 4;
  *(_DWORD *)(a1 + 112) = v7;
  *(_DWORD *)(a1 + 108) = dword_14008A584;
  *(_DWORD *)(a1 + 112) = v7 ^ ((unsigned __int8)v7 ^ (unsigned __int8)(8 * a4)) & 0x18;
  ...
  v13 = *(_QWORD *)(v11 + 24);
  if ( (*(_DWORD *)(*(_QWORD *)(v11 + 8) + 136LL) & 2) == 0 || v13 && (*(_BYTE *)(v13 + 1917) & 0x10) != 0 )
    v12 = 0;
  v14 = v12 & 0xFFFFFFFD | v9 & 0xFFFFFFFC;
  *(_DWORD *)(v10 + 112) = v14;
  v15 = *(_QWORD *)(*(_QWORD *)(v11 + 8) + 72LL);
  if ( v15 )
