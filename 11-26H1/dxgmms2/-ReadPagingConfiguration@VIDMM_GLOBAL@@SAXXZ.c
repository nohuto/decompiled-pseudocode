/*
 * XREFs of ?ReadPagingConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x140120BD4
 * Callers:
...
void VIDMM_GLOBAL::ReadPagingConfiguration(void)
{
  ...
  unsigned int v7; // [rsp+48h] [rbp-B8h] BYREF
  unsigned int v8; // [rsp+4Ch] [rbp-B4h] BYREF
  ...
  unsigned int *v88; // [rsp+270h] [rbp+170h]
  ...
  unsigned int *v95; // [rsp+2A8h] [rbp+1A8h]
  ...
  qword_14008A588 = 10000LL * v3;
  qword_14008A590 = 10000LL * v4;
  qword_14008A598 = 10000LL * v5;
  qword_14008A5A0 = 10000LL * v6;
  qword_14008A5A8 = 10000LL * v0;
  qword_14008A5B0 = 10000LL * v7;
  qword_14008A5C0 = v35;
  byte_14008A5CC = v9 != 0;
  dword_14008A5C8 = v10;
  qword_14008A5F0 = (unsigned __int64)v11 << 20;
  dword_14008A4FC = v12;
  dword_14008A5D0 = v13;
  dword_14008A5D4 = v14;
  dword_14008A658 = v15;
  dword_14008A65C = v16;
  qword_14008A5B8 = 10000LL * v8;
  byte_14008A660 = 0;
}
