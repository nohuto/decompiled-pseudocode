/*
 * XREFs of ?SuspendPurgeForVPRGrow@VIDMM_MEMORY_SEGMENT@@QEAAXPEAUVIDMM_GLOBAL_ALLOC@@@Z @ 0x14009A53C
 * Callers:
...
void __fastcall VIDMM_MEMORY_SEGMENT::SuspendPurgeForVPRGrow(VIDMM_MEMORY_SEGMENT *this, struct VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v11, (struct _KTHREAD **)(v3 + 45000));
  if ( (unsigned __int8)VIDMM_SEGMENT::FreeSpaceForSecureResource(this, v10, a2, 6LL) )
  {
    WdLogSingleEntry0(3LL);
    v6 = *((_DWORD *)this + 105) == 0;
