/*
 * XREFs of ?Unlock1@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@K@Z @ 0x1400F69DC
 * Callers:
 *     VidMmEndCPUAccess @ 0x1400417B0 (VidMmEndCPUAccess.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::Unlock1(VIDMM_GLOBAL *this, __int64 ***a2, unsigned int a3)
{
  __int64 v3; // rbx
  __int64 v4; // rsi
  __int64 v7; // rax
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    ...
    *(_QWORD *)(v7 + 24) = a2;
    *(_QWORD *)(v7 + 32) = v4;
    WdLogGlobalForLineNumber = 23335;
  }
  if ( (v4 & 0xFFFFFFFE) != 0 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 23343;
