/*
 * XREFs of ?VidSchiSelectPresentAtFlip@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@PEAKPEAPEAU_VIDSCH_FLIP_QUEUE_ENTRY@@@Z @ 0x140034908
 * Callers:
        ...
        struct _VIDSCH_FLIP_QUEUE_ENTRY **a6)
{
  ...
  LOBYTE(a3) = 1;
  v9 = *((_QWORD *)a2 + v6 + 431);
  CurrentVSyncPeriodQpc = VidSchiGetCurrentVSyncPeriodQpc(a2, v6, a3);
  if ( *(_DWORD *)(v9 + 3192) == -1 )
    ...
    if ( v16 != v15 )
    {
      do
      {
        ...
        if ( VidSchiCheckPendingFlipsForThisEntry(
               a2,
               (struct _VIDSCH_PRESENT_INFO *)v9,
               (struct VIDSCH_FLIP_QUEUE *)((char *)a4 + 1400 * v16 + 120),
               a4) )
        {
          break;
        }
