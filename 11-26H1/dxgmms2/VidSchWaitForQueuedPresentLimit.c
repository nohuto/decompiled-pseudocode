/*
 * XREFs of VidSchWaitForQueuedPresentLimit @ 0x1400EB210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchWaitForQueuedPresentLimit(__int64 a1, unsigned int a2, char a3)
{
  ...
  if ( *(_BYTE *)(a1 + 212) || _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 208), 0, 0) )
  {
    ...
    WdLogGlobalForLineNumber = 4956;
    return v3;
  }
  if ( *(_DWORD *)(a1 + 4LL * a2 + 1708) < *(_DWORD *)(a1 + 252) )
    return v3;
  if ( a3 )
  {
    ...
    if ( *(_DWORD *)(a1 + 4 * v4 + 1708) >= *(_DWORD *)(a1 + 252) )
      v3 = VidSchWaitForCompletionEvent(v6, (__int64)v9, 2LL);
    VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v6 + 2032), v9, 0LL);
    return v3;
  }
  return 3223191810LL;
}
