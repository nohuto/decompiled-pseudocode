/*
 * XREFs of ?VidMmPbmmAddResidentBytesCB@@YAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_PHYSICAL_ALLOC@@II@Z @ 0x1400B08C0
 * Callers:
...
void __fastcall VidMmPbmmAddResidentBytesCB(
