/*
 * XREFs of ?FreeSpaceForSecureResource@VIDMM_SEGMENT@@QEAAEPEAU_LIST_ENTRY@@PEBUVIDMM_GLOBAL_ALLOC@@W4VIDMM_PLACEMENT_RESTRICTION@@@Z @ 0x14011B504
 * Callers:
...
LABEL_7:
  ...
  VIDMM_LINEAR_POOL::IterateAllocatedBlocksInRange(*(VIDMM_LINEAR_POOL **)(a1 + 256), v13, v12, &v16, v15);
  return v17;
}
