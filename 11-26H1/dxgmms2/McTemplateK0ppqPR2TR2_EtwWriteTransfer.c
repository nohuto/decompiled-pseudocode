/*
 * XREFs of McTemplateK0ppqPR2TR2_EtwWriteTransfer @ 0x14003AAD0
 * Callers:
...
NTSTATUS McTemplateK0ppqPR2TR2_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v8 = 8LL;
  v10 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, (const EVENT_DESCRIPTOR *)"+", a3, 6u, &v4);
}
