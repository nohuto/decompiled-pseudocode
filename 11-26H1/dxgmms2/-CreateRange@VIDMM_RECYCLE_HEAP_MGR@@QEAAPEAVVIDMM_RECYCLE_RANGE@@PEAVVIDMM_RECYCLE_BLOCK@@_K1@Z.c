/*
 * XREFs of ?CreateRange@VIDMM_RECYCLE_HEAP_MGR@@QEAAPEAVVIDMM_RECYCLE_RANGE@@PEAVVIDMM_RECYCLE_BLOCK@@_K1@Z @ 0x14010B648
 * Callers:
  ...
  if ( v11 )
  {
    ...
    *((_BYTE *)v11 + 168) = 0;
    ...
    if ( v15 )
    {
      ...
      v18 = 144 * v15[1];
      *(_DWORD *)(v18 + v17) = 0;
      *(_QWORD *)(v18 + v17 + 8) = v11;
      RtlCaptureStackBackTrace(1u, 0x10u, (PVOID *)(v18 + v17 + 16), 0LL);
      ++*(_QWORD *)(*(_QWORD *)(v14 + 152) + 8LL);
      v19 = *(_QWORD *)(v14 + 152);
      if ( *(_QWORD *)(v19 + 8) == *(_QWORD *)(v19 + 48) )
      {
        *(_QWORD *)(v19 + 8) = 0LL;
        *(_BYTE *)(*(_QWORD *)(v14 + 152) + 16LL) = 1;
      }
    }
  }
