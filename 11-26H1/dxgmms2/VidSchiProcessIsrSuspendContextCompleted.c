/*
 * XREFs of VidSchiProcessIsrSuspendContextCompleted @ 0x14002F6E4
 * Callers:
    ...
    if ( (_DWORD)result != 1 )
    {
      ...
      if ( v7 )
      {
        ...
        *((_QWORD *)&v7[2].Next + 1) = *(_QWORD *)(a2 + 16);
        LODWORD(v7->Next) = 17;
        return (__int64)ExpInterlockedPushEntrySList(a1 + 129, v7 + 1);
      }
      else
      {
