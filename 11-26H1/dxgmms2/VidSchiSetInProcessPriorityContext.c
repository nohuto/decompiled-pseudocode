/*
 * XREFs of VidSchiSetInProcessPriorityContext @ 0x140045050
 * Callers:
 *     VidSchSetInProcessPriorityContext @ 0x14011D4C0 (VidSchSetInProcessPriorityContext.c)
 * Callees:
  ...
  if ( v8 != a2 )
  {
    ...
    *(_DWORD *)(a1 + 416) = a2;
    if ( (v9 & 1) != 0 )
    {
      ...
      {
        v12 = (_QWORD *)(a1 + 424);
        v13 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 104) + 48LL) + 32LL)
