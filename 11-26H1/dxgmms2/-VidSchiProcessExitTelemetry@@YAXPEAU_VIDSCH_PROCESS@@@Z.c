/*
 * XREFs of ?VidSchiProcessExitTelemetry@@YAXPEAU_VIDSCH_PROCESS@@@Z @ 0x14003EFB0
 * Callers:
...
void __fastcall VidSchiProcessExitTelemetry(__m128i *a1)
{
  ...
  *(__m128i *)P = a1[180];
  ...
  if ( (unsigned __int8)_mm_cvtsi128_si32(v1) )
  {
    ...
    {
      if ( (unsigned int)dword_14008A048 > 5 && (unsigned __int8)tlgKeywordOn(&dword_14008A048, 0x400000000010LL) )
      {
        v14 = 1;
        v23 = (__int64)&v28;
        v20 = v24.m128i_i64[1];
    ...
    else if ( (unsigned int)dword_14008A048 > 5 && (unsigned __int8)tlgKeywordOn(&dword_14008A048, 0x400000000010LL) )
    {
      v14 = 1;
      v15 = (__int64)&v28;
      v18 = v24.m128i_i64[1];
