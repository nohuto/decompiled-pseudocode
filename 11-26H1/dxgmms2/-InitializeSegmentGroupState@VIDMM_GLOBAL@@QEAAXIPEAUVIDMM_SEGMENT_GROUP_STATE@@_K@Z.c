/*
 * XREFs of ?InitializeSegmentGroupState@VIDMM_GLOBAL@@QEAAXIPEAUVIDMM_SEGMENT_GROUP_STATE@@_K@Z @ 0x14012411C
 * Callers:
 *     ?CalculatePartitionAdapterBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PARTITION@@PEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x1400ABD34 (-CalculatePartitionAdapterBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PARTITION@@PEAUVIDMM_PARTITION_AD.c)
        ...
        __int64 a4)
{
  ...
  *(_DWORD *)a3 = v5;
  v9 = *(_QWORD *)(v8 + 8 * v5 + 8);
  v10 = a4 + *(_QWORD *)(v8 + 24 * v5 + 624);
  if ( v9 && v10 >= v9 )
    v10 = *(_QWORD *)(v8 + 8 * v5 + 8);
  if ( a4 )
  {
    v11 = dword_14008A568;
    v12 = 0x20000000;
  ...
  if ( v13 >= v12 )
    LODWORD(v13) = v12;
  v14 = v10 * (unsigned int)dword_14008A56C;
  v15 = qword_14008A578;
  *((_QWORD *)a3 + 1) = v10;
