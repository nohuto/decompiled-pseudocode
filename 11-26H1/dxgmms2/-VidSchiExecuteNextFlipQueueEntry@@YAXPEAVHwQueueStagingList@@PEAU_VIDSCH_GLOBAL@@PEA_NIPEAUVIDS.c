/*
 * XREFs of ?VidSchiExecuteNextFlipQueueEntry@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEA_NIPEAUVIDSCH_FLIP_QUEUE@@@Z @ 0x1400329BC
 * Callers:
        ...
        struct VIDSCH_FLIP_QUEUE *a5)
{
  ...
  v9 = (struct _VIDSCH_PRESENT_INFO *)*((_QWORD *)a2 + a4 + 431);
  v28 = v9;
  ...
  if ( !v11 )
  {
    ...
    {
      v17 = *((_DWORD *)v10 + 263);
      if ( v17 == 2 || v17 == 3 || v17 == 14 )
      {
        if ( !*((_BYTE *)a2 + 67) )
          *((_QWORD *)v10 + 138) = MEMORY[0xFFFFF78000000320];
