/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@SAXXZ @ 0x14011EF18
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  unsigned int *v110; // [rsp+288h] [rbp+180h]
  ...
  dword_14008A55C = 10000 * v5;
  dword_14008A560 = 10000 * v3;
  dword_14008A554 = 10000 * v1;
  dword_14008A558 = 10000 * v2;
  v6 = 50;
  if ( v21 < 0x32 )
    v6 = v21;
  dword_14008A564 = v6;
