/*
 * XREFs of ?VidSchiIncrementPendingFlipsForFlipEntry@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@@Z @ 0x14001DCBC
 * Callers:
        ...
        struct _VIDSCH_FLIP_QUEUE_ENTRY *a3)
{
  ...
  if ( *((_BYTE *)a1 + 67) )
  {
    ...
    if ( v10 )
      ...
      v11 = (v7 >> 10) & 0x3FF;
    v10 = !_BitScanForward((unsigned int *)&v12, v9);
    v13 = -1;
    v14 = -1;
    v21 = v11;
    if ( !v10 )
    ...
    while ( v9 || v11 )
    {
      ...
      *((_DWORD *)v3 + 812) |= 1 << v17;
      VIDSCH_FLIP_MULTIPLANE_OVERLAY_ITERATOR::operator++(v19);
      v17 = v24;
      v9 = v20;
      v15 = v23;
      v11 = v21;
