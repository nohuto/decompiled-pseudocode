/*
 * XREFs of ?UnlockHeapAllocation@VIDMM_SYSTEM_HEAP@@UEAAXPEAUVIDMM_HEAP_ALLOC@@_K1_N@Z @ 0x14011A050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_SYSTEM_HEAP::UnlockHeapAllocation(
        ...
        bool a5)
{
  ...
  if ( a5 )
  {
    v5 = (struct _MDL *)*((_QWORD *)a2 + 5);
    *((_QWORD *)a2 + 5) = 0LL;
  }
  else
  {
    v5 = (struct _MDL *)*((_QWORD *)a2 + 4);
    *((_QWORD *)a2 + 4) = 0LL;
  }
  v8 = -1;
  v9 = 0LL;
