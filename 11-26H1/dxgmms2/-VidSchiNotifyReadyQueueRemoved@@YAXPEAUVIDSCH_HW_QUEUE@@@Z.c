/*
 * XREFs of ?VidSchiNotifyReadyQueueRemoved@@YAXPEAUVIDSCH_HW_QUEUE@@@Z @ 0x14000AD98
 * Callers:
...
void __fastcall VidSchiNotifyReadyQueueRemoved(struct VIDSCH_HW_QUEUE *a1)
{
  ...
  *(_DWORD *)(v2 + 1728) = v3 - 1;
  ...
  if ( !*(_DWORD *)(v2 + 1728) )
  {
    ...
    if ( (_DWORD)v5 != -1 )
    {
      v6 = *(void (__fastcall **)(_QWORD, __int64, _QWORD))(v4 + 3336);
      if ( v6 )
        v6(*(_QWORD *)(v4 + 3368), v5, 0LL);
    }
  }
}
