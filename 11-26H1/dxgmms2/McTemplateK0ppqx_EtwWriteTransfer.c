/*
 * XREFs of McTemplateK0ppqx_EtwWriteTransfer @ 0x14004DE18
 * Callers:
...
NTSTATUS McTemplateK0ppqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 8LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &VidMmTrimWnfProcess, a3, 5u, &v4);
}
