/*
 * XREFs of VidSchiProcessIsrHwQueuePageFaulted @ 0x14005846C
 * Callers:
...
__int64 __fastcall VidSchiProcessIsrHwQueuePageFaulted(__int64 a1, __int64 a2)
{
  ...
  v8 = (unsigned int)v7;
  if ( (unsigned int)v7 < *(_DWORD *)(a1 + 768) )
    v2 += v7;
  v9 = *v2;
  if ( (*(_DWORD *)(v9 + 12) & 2) == 0 )
  {
    ...
    if ( (_DWORD)result != 1 )
    {
      ...
      if ( v12 )
      {
        ...
        *(PSLIST_ENTRY)((char *)v12 + 88) = v13;
        return (__int64)ExpInterlockedPushEntrySList((PSLIST_HEADER)(a1 + 2064), v12 + 1);
      }
      else
      {
