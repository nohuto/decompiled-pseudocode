/*
 * XREFs of ?AssignBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1400C6224
 * Callers:
 *     ?RecalculateBudget@VIDMM_GLOBAL@@QEAA_NXZ @ 0x1400C60A4 (-RecalculateBudget@VIDMM_GLOBAL@@QEAA_NXZ.c)
 * Callees:
 *     ?BucketizeBudgetStateProcesses@VIDMM_GLOBAL@@QEAAXKW4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1400C6324 (-BucketizeBudgetStateProcesses@VIDMM_GLOBAL@@QEAAXKW4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z.c)
        ...
        enum _D3DKMT_MEMORY_SEGMENT_GROUP a3)
{
  ...
  v6 = *(_QWORD *)(*((_QWORD *)this + 5040) + 8LL * *(unsigned __int16 *)a2);
  if ( (*(_BYTE *)(v6 + 24 * v3 + 632) & 1) != 0 )
  {
  ...
  {
    VIDMM_GLOBAL::AssignBudgets(this, a2, (struct VIDMM_SEGMENT_GROUP_STATE *)(v6 + 664 + 344 * v3));
  }
}
