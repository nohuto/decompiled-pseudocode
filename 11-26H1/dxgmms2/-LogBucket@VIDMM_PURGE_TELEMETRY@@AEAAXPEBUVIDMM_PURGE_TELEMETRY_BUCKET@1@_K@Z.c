/*
 * XREFs of ?LogBucket@VIDMM_PURGE_TELEMETRY@@AEAAXPEBUVIDMM_PURGE_TELEMETRY_BUCKET@1@_K@Z @ 0x14009B524
 * Callers:
        ...
        const struct VIDMM_PURGE_TELEMETRY::VIDMM_PURGE_TELEMETRY_BUCKET *a2)
{
  ...
  if ( *((_DWORD *)a2 + 6) && (unsigned int)dword_14008A048 > 5 )
  {
