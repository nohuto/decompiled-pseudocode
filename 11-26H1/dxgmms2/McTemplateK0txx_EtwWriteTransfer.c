/*
 * XREFs of McTemplateK0txx_EtwWriteTransfer @ 0x14004F7A4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0txx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           ...
           &VidMmUpgradeQueryAllocationContiguityEnd,
           a3,
           4u,
           &v7);
}
