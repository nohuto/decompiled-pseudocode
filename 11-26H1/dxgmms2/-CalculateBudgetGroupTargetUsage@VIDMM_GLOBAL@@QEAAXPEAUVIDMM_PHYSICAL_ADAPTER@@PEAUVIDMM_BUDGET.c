/*
 * XREFs of ?CalculateBudgetGroupTargetUsage@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1400C6A48
 * Callers:
        ...
        struct VIDMM_SEGMENT_GROUP_STATE *a4)
{
  ...
  {
    v5 = dword_14008A624;
    v6 = (unsigned int)dword_14008A628;
LABEL_4:
    v7 = *((_QWORD *)a4 + 2);
  ...
  {
    v5 = dword_14008A62C;
    v6 = (unsigned int)dword_14008A630;
    goto LABEL_4;
  }
  if ( (_DWORD)v4 == 1 )
  {
    v5 = dword_14008A634;
    v6 = (unsigned int)dword_14008A638;
    goto LABEL_4;
  }
