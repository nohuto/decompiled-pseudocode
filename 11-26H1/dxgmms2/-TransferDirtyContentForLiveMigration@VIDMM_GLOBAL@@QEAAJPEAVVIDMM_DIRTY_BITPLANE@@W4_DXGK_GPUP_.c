/*
 * XREFs of ?TransferDirtyContentForLiveMigration@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DIRTY_BITPLANE@@W4_DXGK_GPUP_MIGRATIONTYPE@@PEAVVIDMM_TRANSPORT_BUFFER@@PEA_K@Z @ 0x1400A21A0
 * Callers:
 *     VidMmTransferDirtyContentForLiveMigration @ 0x14004D8F0 (VidMmTransferDirtyContentForLiveMigration.c)
 * Callees:
