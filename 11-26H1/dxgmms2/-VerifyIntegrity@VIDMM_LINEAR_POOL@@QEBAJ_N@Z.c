/*
 * XREFs of ?VerifyIntegrity@VIDMM_LINEAR_POOL@@QEBAJ_N@Z @ 0x1400C00CC
 * Callers:
 *     ValidateIntegrity @ 0x1400B3198 (ValidateIntegrity.c)
 * Callees:
...
__int64 __fastcall VIDMM_LINEAR_POOL::VerifyIntegrity(VIDMM_LINEAR_POOL *this)
{
      ...
      if ( v9 )
      {
        ...
        if ( v10 )
        {
          ...
          if ( ActiveVprStart != ActiveVprEnd )
          {
            ...
            {
              if ( (**(_DWORD **)(*(_QWORD *)v14 + 368LL) & 0x20000) != 0 )
                v5 = -1073741823;
            }
            else
            {
  ...
  v17 = *((_QWORD *)this + 1);
  v18 = 1;
  v19 = (VIDMM_LINEAR_POOL *)*((_QWORD *)this + 6);
  if ( v1 != v17 )
    v5 = -1073741823;
  v20 = 0LL;
  while ( v19 != (VIDMM_LINEAR_POOL *)((char *)this + 48) )
  {
    v21 = *((_QWORD *)v19 - 3);
    v22 = v19;
    v23 = *((_QWORD *)v19 - 2);
    v19 = *(VIDMM_LINEAR_POOL **)v19;
    if ( v21 < v20 )
      v5 = -1073741823;
    if ( !v23 )
      v5 = -1073741823;
    if ( v18 == 2 && *((_BYTE *)v22 + 32) == 2 && v21 <= v20 )
      v5 = -1073741823;
    v18 = *((_BYTE *)v22 + 32);
    if ( v18 != 3 && v18 != 5 )
      --v4;
