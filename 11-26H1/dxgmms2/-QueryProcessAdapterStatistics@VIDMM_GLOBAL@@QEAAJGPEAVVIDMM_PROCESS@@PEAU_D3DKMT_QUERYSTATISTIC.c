/*
 * XREFs of ?QueryProcessAdapterStatistics@VIDMM_GLOBAL@@QEAAJGPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION@@@Z @ 0x1400A8DAC
 * Callers:
 *     VidMmQueryProcessAdapterStatistics @ 0x14004D7E0 (VidMmQueryProcessAdapterStatistics.c)
 * Callees:
        ...
        struct _D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION *a4)
{
  ...
  if ( a2 < v6 )
  {
    DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v21, (struct _KTHREAD **)this + 5152);
    v10 = 0;
    v11 = *(_QWORD *)(*((_QWORD *)a3 + 4) + 8LL * *(unsigned int *)(*((_QWORD *)this + 3) + 240LL));
    if ( v11 )
    {
      *(_DWORD *)a4 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 5040) + 8 * v5) + 136LL);
      *((_QWORD *)a4 + 3) = *(_QWORD *)(*(_QWORD *)(v11 + 184) + 8LL);
      *((_DWORD *)a4 + 4) = **(_DWORD **)(v11 + 184);
      *((_DWORD *)a4 + 8) = *(_DWORD *)(*(_QWORD *)(v11 + 184) + 16LL);
      *((_DWORD *)a4 + 9) = *(_DWORD *)(*(_QWORD *)(v11 + 184) + 20LL);
      *((_QWORD *)a4 + 23) = 1LL;
      *((_QWORD *)a4 + 22) = *(int *)(*(_QWORD *)(v11 + 184) + 36LL);
      *((_QWORD *)a4 + 21) = (int)VIDMM_POLICY::IsActive((VIDMM_POLICY *)(*(_QWORD *)(v11 + 184) + 24LL));
      v12 = 0;
