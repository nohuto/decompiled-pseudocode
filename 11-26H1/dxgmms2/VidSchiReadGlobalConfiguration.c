/*
 * XREFs of VidSchiReadGlobalConfiguration @ 0x1400C09BC
 * Callers:
...
struct DXGGLOBAL *__fastcall VidSchiReadGlobalConfiguration(__int64 a1)
{
  __int64 v1; // r8
  int v3; // edi
  int v4; // edx
  ...
  v95 = 20;
  v54 = 7;
  v5 = *(_DWORD *)(*(_QWORD *)(v1 + 3048) + 4LL) & 1;
  v99 = 900;
  v97 = v5;
  v100 = 1000;
  v101 = 8;
  ...
  v107 = *(_DWORD *)(a1 + 252);
  v72 = 64;
  v7 = __OFSUB__(*(_DWORD *)(v1 + 3044), 2000);
  v6 = *(_DWORD *)(v1 + 3044) - 2000 < 0;
  v111 = 2;
  v112 = 1;
  v110 = v6 == v7;
  v79 = v110;
  ...
  v48 = 60000;
  v46 = v107;
  if ( *(int *)(v1 + 3044) >= 1300 && *(_BYTE *)(v1 + 2981) )
  {
    v54 = 1;
    v53 = 1;
  }
  ...
  NodeConfiguration = VidSchiReadNodeConfiguration(a1, *(_QWORD *)(a1 + 2848));
  for ( i = 0; i < *(_DWORD *)(a1 + 88); *v14 = v18 )
  {
    v10 = *(_DWORD *)(a1 + 2888);
    v11 = i;
...
LABEL_11:
  ...
  v19 = v61;
  *(_DWORD *)(a1 + 2824) = (v60 != 0 ? 0x200 : 0) | (v59 != 0) | (v58 != 0 ? 8 : 0) | (v57 != 0 ? 4 : 0) | *(_DWORD *)(a1 + 2824) & 0xFFFFFDF2;
  ...
  v21 = v65 == 0;
  *(_DWORD *)(a1 + 232) = v20;
  *(_DWORD *)(a1 + 236) = v20 + 15;
  v22 = (unsigned int)(10000 * v66);
  *(_BYTE *)(a1 + 65) = !v21;
  *(_QWORD *)(a1 + 3112) = v69;
  *(_QWORD *)(a1 + 3032) = 1000LL;
  *(_QWORD *)(a1 + 3008) = v22;
  v23 = (unsigned int)(10000 * v67);
  *(_QWORD *)(a1 + 3040) = 2500LL;
  *(_QWORD *)(a1 + 3048) = 5000LL;
  *(_QWORD *)(a1 + 3056) = 10000LL;
  *(_QWORD *)(a1 + 3064) = 25000LL;
  *(_QWORD *)(a1 + 3016) = v23;
  v24 = (unsigned int)(10000 * v68);
  *(_QWORD *)(a1 + 3072) = 50000LL;
  *(_QWORD *)(a1 + 3080) = 100000LL;
  *(_QWORD *)(a1 + 3088) = 250000LL;
  *(_QWORD *)(a1 + 3096) = 500000LL;
  *(_QWORD *)(a1 + 3104) = v24;
  *(_QWORD *)(a1 + 3024) = (unsigned int)(10000 * v70);
  *(_QWORD *)(a1 + 3120) = (unsigned int)(10000 * v71);
  v25 = v45;
  if ( v45 < 0x10 )
  {
    v25 = 16;
LABEL_38:
  ...
  if ( ((v45 - 1) & v45) != 0 )
  {
    ...
    WdLogGlobalForLineNumber = 15467;
...
LABEL_44:
  *(_DWORD *)(a1 + 252) = v27;
  *(_DWORD *)(a1 + 2824) = *(_DWORD *)(a1 + 2824) & 0xFFFFFEFF | (TdrIsEnabled() << 8);
  v28 = (__int64 *)(a1 + 2960);
  if ( *(_BYTE *)(a1 + 7077) )
  {
    v29 = 6LL;
  ...
  else
  {
    for ( j = 0LL; j < 24; j += 4LL )
    {
      ...
      if ( v49 > 1 )
        v34 = v49;
      v31 = v50 <= 1;
      *(v28 - 6) = (unsigned int)(*(_DWORD *)((char *)&gulQuantumMultiplierTableByPriorityClass + j) * v34);
      v35 = 1;
      if ( !v31 )
        v35 = v50;
...
LABEL_74:
  ...
  *(_BYTE *)(a1 + 7082) = *((_BYTE *)result + 305952);
  return result;
}
