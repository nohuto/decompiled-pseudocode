/*
 * XREFs of ?DestroyPdePageTableData@VIDMM_PAGE_DIRECTORY@@QEAAXPEAVCVirtualAddressAllocator@@I_K@Z @ 0x14011133C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v4 = 2LL * a3;
  v5 = a3;
  if ( (*(_DWORD *)(*((_QWORD *)this + 6) + 16LL * a3) & 0x402) == 0x400LL )
  {
    ExFreeToPagedLookasideList(
      (PPAGED_LOOKASIDE_LIST)(*((_QWORD *)a2 + 12) + 40384LL),
      *(PVOID *)(*((_QWORD *)this + 7) + 8LL * a3));
    *(_QWORD *)(*((_QWORD *)this + 7) + 8 * v5) = 0LL;
  }
  v6 = *((_QWORD *)this + 6);
  *(_QWORD *)(v6 + 8 * v4) = 0LL;
