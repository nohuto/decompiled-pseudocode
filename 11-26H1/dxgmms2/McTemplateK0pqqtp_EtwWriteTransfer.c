/*
 * XREFs of McTemplateK0pqqtp_EtwWriteTransfer @ 0x14003FA00
 * Callers:
...
NTSTATUS McTemplateK0pqqtp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v14, va3);
  v15 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventLock2, 0LL, 6u, &v5);
}
