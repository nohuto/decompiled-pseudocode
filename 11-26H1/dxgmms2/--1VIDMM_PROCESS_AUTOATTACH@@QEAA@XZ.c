/*
 * XREFs of ??1VIDMM_PROCESS_AUTOATTACH@@QEAA@XZ @ 0x14003BA5C
 * Callers:
...
void __fastcall VIDMM_PROCESS_AUTOATTACH::~VIDMM_PROCESS_AUTOATTACH(VIDMM_PROCESS_AUTOATTACH *this)
{
  if ( *(_BYTE *)this )
  {
    VIDMM_PROCESS::SafeDetach(this, (struct _KAPC_STATE *)((char *)this + 8));
    *(_BYTE *)this = 0;
  }
}
