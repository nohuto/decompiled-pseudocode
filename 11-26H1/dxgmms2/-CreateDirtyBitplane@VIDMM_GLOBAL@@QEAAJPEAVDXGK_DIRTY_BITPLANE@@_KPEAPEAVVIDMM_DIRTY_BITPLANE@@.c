/*
 * XREFs of ?CreateDirtyBitplane@VIDMM_GLOBAL@@QEAAJPEAVDXGK_DIRTY_BITPLANE@@_KPEAPEAVVIDMM_DIRTY_BITPLANE@@@Z @ 0x14009D378
 * Callers:
 *     VidMmCreateDirtyBitplane @ 0x14004D490 (VidMmCreateDirtyBitplane.c)
 * Callees:
