/*
 * XREFs of McTemplateK0ppt_EtwWriteTransfer @ 0x14003D154
 * Callers:
...
NTSTATUS McTemplateK0ppt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           ...
           &EventVidSchiSyncObjectSetToAlwaysSignaled,
           a3,
           4u,
           &v4);
}
