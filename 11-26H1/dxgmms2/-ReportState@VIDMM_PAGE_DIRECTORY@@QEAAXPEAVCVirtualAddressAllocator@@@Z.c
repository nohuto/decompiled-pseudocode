/*
 * XREFs of ?ReportState@VIDMM_PAGE_DIRECTORY@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1400D7DF4
 * Callers:
...
void __fastcall VIDMM_PAGE_DIRECTORY::ReportState(VIDMM_PAGE_DIRECTORY *this, struct CVirtualAddressAllocator *a2)
{
  ...
  if ( *((_QWORD *)this + 7) )
  {
    ...
    if ( v5 )
    {
      ...
      do
      {
        v9 = *(VIDMM_PAGE_TABLE_BASE **)(v8 + *((_QWORD *)this + 7));
        if ( v9 )
        {
          if ( (*(_DWORD *)this & 0x20) != 0 )
          {
            if ( (*(_DWORD *)(v7 + *((_QWORD *)this + 6)) & 0x400LL) == 0 )
