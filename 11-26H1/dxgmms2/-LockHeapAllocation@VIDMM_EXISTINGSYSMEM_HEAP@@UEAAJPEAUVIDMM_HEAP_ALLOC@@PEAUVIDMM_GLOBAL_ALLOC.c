/*
 * XREFs of ?LockHeapAllocation@VIDMM_EXISTINGSYSMEM_HEAP@@UEAAJPEAUVIDMM_HEAP_ALLOC@@PEAUVIDMM_GLOBAL_ALLOC@@_K2W4_LOCK_OPERATION@@PEAVVIDMM_GLOBAL@@_N@Z @ 0x1400F8700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_EXISTINGSYSMEM_HEAP::LockHeapAllocation(
