/*
 * XREFs of McTemplateK0pqqXR2qqddddddddtqtdqiiqQR2qq_EtwWriteTransfer @ 0x14003DF20
 * Callers:
...
NTSTATUS __fastcall McTemplateK0pqqXR2qqddddddddtqtdqiiqQR2qq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a28)
{
  ...
  __int64 v82; // [rsp+208h] [rbp+108h] BYREF
  ...
  v79 = 4LL;
  v81 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &MMIOFlipMultiPlaneOverlay3, a3, 0x1Au, &v29);
}
