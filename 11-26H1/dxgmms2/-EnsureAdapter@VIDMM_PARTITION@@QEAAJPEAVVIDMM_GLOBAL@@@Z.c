/*
 * XREFs of ?EnsureAdapter@VIDMM_PARTITION@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1400ABE44
 * Callers:
...
__int64 __fastcall VIDMM_PARTITION::EnsureAdapter(VIDMM_PARTITION *this, unsigned int **a2)
{
  ...
  else
  {
    ...
    {
LABEL_8:
      _InterlockedAdd(&dword_14008A854, 1u);
