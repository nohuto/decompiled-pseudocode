/*
 * XREFs of ?FindBlockRun@VIDMM_LINEAR_POOL@@IEAAJ_KKE00W4VIDMM_BLOCK_RUN_CONSTRAINT@@PEAPEAU_VIDMM_POOL_BLOCK@@2PEA_K3@Z @ 0x1400FA770
 * Callers:
        ...
        unsigned __int64 *a11)
{
  ...
  unsigned __int64 v48; // [rsp+28h] [rbp-30h]
  ...
  *a11 = 0LL;
  if ( i != (_QWORD *)(a1 + 48) )
  {
    v48 = (a2 + 4095) & 0xFFFFFFFFFFFFF000uLL;
    v47 = (a3 + 4095) & 0xFFFFF000;
    if ( !a4 )
      i = *(_QWORD **)(a1 + 56);
LABEL_4:
    v15 = a7;
            ...
            if ( a6 > v16 )
            {
              if ( a6 < v19 )
              {
                ...
                if ( g_IsInternalReleaseOrDbg )
                {
                  ...
                  v46 = WdLogNewEntry5_WdTrace(v45);
                  *(_QWORD *)(v46 + 24) = v16;
                  *(_QWORD *)(v46 + 32) = a6;
...
LABEL_54:
            if ( a4 )
            {
              if ( v47 && (v15 = v47, v16 % v47) && (v15 = v47 - v16 % v47, v16 += v15, v16 >= v19) )
              {
                v15 = a7;
                v12 = a1;
                if ( g_IsInternalReleaseOrDbg )
...
LABEL_24:
            ...
            else
            {
              ...
              if ( v41 >= v16 )
              {
                ...
                if ( g_IsInternalReleaseOrDbg )
                {
                  v42 = WdLogNewEntry5_WdTrace(v15);
                  *(_QWORD *)(v42 + 24) = v41;
                  *(_QWORD *)(v42 + 32) = v19;
