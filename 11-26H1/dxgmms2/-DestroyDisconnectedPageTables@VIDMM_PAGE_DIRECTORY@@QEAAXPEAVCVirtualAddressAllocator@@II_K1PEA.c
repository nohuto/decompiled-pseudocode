/*
 * XREFs of ?DestroyDisconnectedPageTables@VIDMM_PAGE_DIRECTORY@@QEAAXPEAVCVirtualAddressAllocator@@II_K1PEAUVIDMM_ALLOC@@@Z @ 0x1400D4458
 * Callers:
        ...
        struct VIDMM_ALLOC *a7)
{
  ...
  if ( a3 < a4 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (v14 & 0x400) != 0 )
      {
        ...
        if ( v17 )
        {
          ...
          if ( v18 )
          {
            ...
            *(_QWORD *)(*(_QWORD *)(v10 + *((_QWORD *)this + 7)) + 24LL) = 0LL;
          }
        }
        goto LABEL_7;
      }
      if ( (v14 & 3) != 1 )
      {
        v15 = *(struct VIDMM_ALLOC ***)(v10 + *((_QWORD *)this + 7));
        if ( v15 )
        {
          if ( v15[4] != a7 && (*(_DWORD *)v15 & 0x80000) == 0 )
          {
            VIDMM_PAGE_TABLE::DestroyPageTable((VIDMM_PAGE_TABLE *)v15, a2, a5);
LABEL_12:
            *(_QWORD *)(v10 + *((_QWORD *)this + 7)) = 0LL;
          }
        }
      }
LABEL_7:
    ...
    if ( (*(_BYTE *)(v11 + v13) & 3) == 1 )
      goto LABEL_7;
    v16 = *(VIDMM_PAGE_DIRECTORY **)(v10 + *((_QWORD *)this + 7));
    if ( !v16 )
      goto LABEL_7;
    VIDMM_PAGE_DIRECTORY::DestroyPageDirectory(v16, a2, a5);
    goto LABEL_12;
  }
}
