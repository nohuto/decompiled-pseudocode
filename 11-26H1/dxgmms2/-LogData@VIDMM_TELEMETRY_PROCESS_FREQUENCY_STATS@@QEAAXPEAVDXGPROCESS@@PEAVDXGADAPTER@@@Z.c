/*
 * XREFs of ?LogData@VIDMM_TELEMETRY_PROCESS_FREQUENCY_STATS@@QEAAXPEAVDXGPROCESS@@PEAVDXGADAPTER@@@Z @ 0x1400C74F4
 * Callers:
        ...
        struct DXGADAPTER *a3)
{
  ...
  if ( *((_BYTE *)this + 20) && (unsigned int)dword_14008A048 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_14008A048, 0x400000000008LL) )
    {
      ...
      v13 = v5[1];
      v14 = *v5;
      v15 = *(unsigned __int16 **)(v6 + 1968);
      v8 = *(_OWORD *)(*(_QWORD *)(v7 + 64) + 144LL);
      v9[0] = 0;
      v16 = &v18;
      v18 = v8;
      v17 = 0x1000000LL;
