/*
 * XREFs of ??0VIDMM_DEVICE@@QEAA@PEAVVIDMM_GLOBAL@@PEAVDXGDEVICE@@@Z @ 0x1400C7944
 * Callers:
 *     VidMmCreateDevice @ 0x140041980 (VidMmCreateDevice.c)
