/*
 * XREFs of ?LogData@VIDMM_TELEMETRY_PROCESS_MIGRATION_STATS@@QEAAXPEAVDXGPROCESS@@PEAVDXGADAPTER@@@Z @ 0x1400C7620
 * Callers:
  ...
  if ( *((_BYTE *)this + 976) )
  {
    ...
    if ( (unsigned int)dword_14008A048 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_14008A048, 0x400000000008LL) )
      {
        ...
        v13 = v9[1];
        v14 = *v9;
        v15 = (unsigned __int16 *)*((_QWORD *)a3 + 246);
        v10 = *((_QWORD *)a2 + 8);
        v21 = 176;
        v27 = 176;
        v29 = 176;
