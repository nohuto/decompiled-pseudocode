/*
 * XREFs of ?IsNonOverlappingResourceCB@VIDMM_SEGMENT@@SA_NPEBUVIDMM_PHYSICAL_ALLOC_LEGACY@@@Z @ 0x1400B6A20
 * Callers:
...
char __fastcall VIDMM_SEGMENT::IsNonOverlappingResourceCB(const struct VIDMM_PHYSICAL_ALLOC_LEGACY *a1)
{
  __int64 v1; // r9
  _QWORD *v2; // r8
  _QWORD *v3; // rcx
  ...
  if ( VIDMM_GLOBAL_ALLOC_NONPAGED::HasOutstandingPresentReferences(*(VIDMM_GLOBAL_ALLOC_NONPAGED **)(*(_QWORD *)a1 + 368LL)) )
    return 1;
  v2 = (_QWORD *)(v1 + 112);
  v3 = *(_QWORD **)(v1 + 112);
  while ( 1 )
