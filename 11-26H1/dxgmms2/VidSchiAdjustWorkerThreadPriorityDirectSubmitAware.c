/*
 * XREFs of VidSchiAdjustWorkerThreadPriorityDirectSubmitAware @ 0x14004BC94
 * Callers:
 *     VidSchiAdjustWorkerThreadPriority @ 0x1400303B0 (VidSchiAdjustWorkerThreadPriority.c)
 * Callees:
 *     VidSchiComputeWorkerThreadPriority @ 0x140036580 (VidSchiComputeWorkerThreadPriority.c)
 */
...
void __fastcall VidSchiAdjustWorkerThreadPriorityDirectSubmitAware(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(v4 + 2824) & 0x20) == 0 )
  {
    if ( CurrentThread == v5 )
      return;
    v9 = (struct _ERESOURCE *)(v4 + 1256);
    goto LABEL_16;
  }
  if ( CurrentThread != v5 )
  {
    ...
    for ( i = (struct _ERESOURCE *)(v4 + 1256); ; ExAcquireResourceExclusiveLite(i, 1u) )
    {
LABEL_8:
      v8 = *(_DWORD *)(a1 + 788);
...
LABEL_16:
  ...
  if ( !*(_DWORD *)(a1 + 788) )
  {
    i = (struct _ERESOURCE *)(v4 + 1256);
    ExAcquireResourceExclusiveLite((PERESOURCE)(v4 + 1256), 1u);
    v6 = 16;
    goto LABEL_8;
  }
}
