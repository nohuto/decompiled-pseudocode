/*
 * XREFs of ?AllocateElements@?$NonPagedPoolZeroedArray@PEBX$00$0ELGHHIEE@@@QEAAPEAPEBXI@Z @ 0x14003990C
 * Callers:
...
__int64 __fastcall NonPagedPoolZeroedArray<void const *,1,1265072196>::AllocateElements(__int64 *a1, unsigned int a2)
{
  void *v4; // rcx
  __int64 result; // rax
