/*
 * XREFs of ?VidSchiKeepInterruptTargetEnabledForFlip@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_PRESENT_INFO@@@Z @ 0x14004B17C
 * Callers:
        ...
        struct _VIDSCH_PRESENT_INFO *a3)
{
  ...
  v19 = (unsigned int *)*((_QWORD *)a2 + 149);
  v18 = a1;
  v6 = *v19;
  v7 = *v19 & 0x3FF;
  v8 = *((_BYTE *)a1 + 164) == 0;
  ...
  while ( v7 || v9 )
  {
    if ( v15 < v16 )
      v16 = v15;
    v17 = *(_QWORD *)((unsigned int)(8 * v10 * (*(_DWORD *)(*((_QWORD *)a2 + 149) + 8LL) + 28))
                    + *((_QWORD *)a2 + 149)
                    + 32LL);
    if ( v17 )
    {
      if ( *((_QWORD *)a3 + 38 * v16 + 53) >= v17 )
