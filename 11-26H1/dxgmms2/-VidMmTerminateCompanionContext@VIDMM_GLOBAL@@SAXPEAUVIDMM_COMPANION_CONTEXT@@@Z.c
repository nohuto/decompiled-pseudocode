/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x140124E38
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1400476E0 (VidMmTerminateCompanionContext.c)
 * Callees:
