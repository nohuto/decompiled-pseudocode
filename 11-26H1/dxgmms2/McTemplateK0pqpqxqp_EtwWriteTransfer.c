/*
 * XREFs of McTemplateK0pqpqxqp_EtwWriteTransfer @ 0x140046EBC
 * Callers:
...
NTSTATUS McTemplateK0pqpqxqp_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
