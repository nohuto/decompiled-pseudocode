/*
 * XREFs of ?RecordVaPagingHistoryReserveGpuVa@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@_K1@Z @ 0x1400CC3F8
 * Callers:
        ...
        __int64 a4)
{
  ...
  *((_QWORD *)v5 + 1) = KeGetCurrentThread();
  v9 = operator new(32, (VIDMM_GLOBAL *)((char *)this + 41168), 0x10u, 0);
  if ( v9 )
  {
