/*
 * XREFs of McTemplateK0xxxxq_EtwWriteTransfer @ 0x14004F004
 * Callers:
...
NTSTATUS McTemplateK0xxxxq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &VidMmUpgradeAllocationFailPageSwitch, a3, 6u, &v4);
}
