/*
 * XREFs of ??$VidSchRundownUnorderedWaiter@U_VIDSCH_GLOBAL@@@@YAJPEAU_VIDSCH_GLOBAL@@0W4_VIDSCH_FLUSH_STAGE@@_NP6AXPEAVHwQueueStagingList@@0@Z@Z @ 0x140055BD8
 * Callers:
...
{
  unsigned int v3; // ebx
  struct _KEVENT *v7; // [rsp+20h] [rbp-50h] BYREF
  ...
  v3 = 0;
  if ( a3 != 5 && *(_DWORD *)(a1 + 880) )
  {
    if ( a3 < 8 )
    {
      return (unsigned int)-2147483631;
    }
    else if ( *(_DWORD *)(a1 + 880) )
    {
      AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v11, (unsigned __int64 *)(a2 + 2016), 1, 0);
      v7 = (struct _KEVENT *)a2;
      v9 = 0;
      v8[1] = v8;
      v10 = 2;
      v8[0] = v8;
      VidSchiRundownUnorderedWaiterGlobal((struct HwQueueStagingList *)&v7, a1);
      HwQueueStagingList::~HwQueueStagingList(&v7);
