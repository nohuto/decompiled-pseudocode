/*
 * XREFs of ?LogData@VIDMM_TELEMETRY_PROCESS_DEMOTED_CONTENT_BY_PRIORITY@@QEAAXPEAVDXGPROCESS@@PEAVDXGADAPTER@@@Z @ 0x1400C71D8
 * Callers:
        ...
        struct DXGADAPTER *a3)
{
  ...
  if ( *((_BYTE *)this + 60) && (unsigned int)dword_14008A048 > 5 )
  {
