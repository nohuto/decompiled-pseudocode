/*
 * XREFs of ?VidSchiIsExpectedVSyncCookie3@@YAHPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@QEAK@Z @ 0x14003D54C
 * Callers:
        ...
        unsigned int *const a4)
{
  ...
  for ( i = 0; ; ++i )
  {
    if ( !v8 )
      return 1LL;
    v13 = *(_QWORD *)((char *)v5 + (unsigned int)(8 * i * (v5[2] + 28)) + 32);
    if ( v13 )
      break;
LABEL_15:
    v21 = v11;
    v11 = -1;
    v8 &= ~(1 << v21);
    v9 = !_BitScanForward((unsigned int *)&v22, v8);
    if ( !v9 )
      v11 = v22;
  }
  v14 = 304LL * v11;
