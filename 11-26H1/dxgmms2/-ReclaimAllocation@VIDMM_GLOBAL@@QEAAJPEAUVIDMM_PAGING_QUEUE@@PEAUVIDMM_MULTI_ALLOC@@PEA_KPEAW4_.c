/*
 * XREFs of ?ReclaimAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_PAGING_QUEUE@@PEAUVIDMM_MULTI_ALLOC@@PEA_KPEAW4_D3DDDI_RECLAIM_RESULT@@@Z @ 0x14010CE44
 * Callers:
 *     VidMmReclaimAllocation @ 0x14003C4F0 (VidMmReclaimAllocation.c)
 * Callees:
