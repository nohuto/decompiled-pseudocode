/*
 * XREFs of ?VidSchiQueueAsyncOperation@@YAJPEAU_VIDSCH_NODE@@W4VIDSCH_ASYNC_OPERATION_TYPE@@PEATVIDSCH_ASYNC_OPERATION_DATA@@@Z @ 0x1400575AC
 * Callers:
...
__int64 __fastcall VidSchiQueueAsyncOperation(__int64 a1, __int64 a2, __int128 *a3)
{
  ...
  if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 16488)) > 1 )
  {
    WdLogSingleEntry0(4LL);
    WdLogGlobalForLineNumber = 7410;
    _InterlockedDecrement((volatile signed __int32 *)(a1 + 16488));
    KeSetEvent((PRKEVENT)(a1 + 16496), 0, 0);
    return 0LL;
  }
  v6 = operator new(64LL, 0x34626956u, 64LL);
  if ( v6 )
  {
    v7 = *a3;
    *(_QWORD *)(v6 + 32) = a1;
