/*
 * XREFs of ValidateCommonLockParameters @ 0x140036320
 * Callers:
...
__int64 __fastcall ValidateCommonLockParameters(__int64 a1, __int64 **a2)
{
  ...
  if ( (v7 & 1) != 0 )
  {
    if ( (v7 & 8) != 0 || (v8 = *(_QWORD *)(v2[1] + 16), v8 == PsGetCurrentProcess()) || (*(_DWORD *)(v6 + 28) & 8) != 0 )
    {
      if ( (**(_DWORD **)(v6 + 368) & 0x60000000) != 0x20000000 )
        return 0LL;
      if ( (*(_DWORD *)(v6 + 24) & 2) != 0 )
        return 0LL;
      v10 = *(_QWORD *)(a1 + 24);
      v11 = *(_DWORD *)(v10 + 444);
      if ( (v11 & 0x10) != 0 || (v11 & 8) != 0 || (*(_DWORD *)(v10 + 2508) & 0x80u) != 0 || v2 == *(__int64 **)(v6 + 48) )
      {
        return 0LL;
      }
      else
