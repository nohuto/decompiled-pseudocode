/*
 * XREFs of ?LogData@VIDMM_TELEMETRY_PROCESS_DEMOTED_CONTENT_BY_FREE_MEMORY@@QEAAXPEAVDXGPROCESS@@PEAVDXGADAPTER@@@Z @ 0x1400C73EC
 * Callers:
...
void __fastcall VIDMM_TELEMETRY_PROCESS_DEMOTED_CONTENT_BY_FREE_MEMORY::LogData(
        VIDMM_TELEMETRY_PROCESS_DEMOTED_CONTENT_BY_FREE_MEMORY *this,
        ...
        struct DXGADAPTER *a3)
{
  ...
  if ( *((_BYTE *)this + 348) && (unsigned int)dword_14008A048 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_14008A048, 0x400000000008LL) )
    {
      v14 = v5;
      v16 = v5 + 232;
      v11 = *(unsigned __int16 **)(v6 + 1968);
      v8 = *(_QWORD *)(v7 + 64);
      v15 = 232;
      v17 = 116;
      v9 = *(_OWORD *)(v8 + 144);
