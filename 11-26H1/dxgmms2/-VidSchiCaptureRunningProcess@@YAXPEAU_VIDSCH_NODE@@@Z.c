/*
 * XREFs of ?VidSchiCaptureRunningProcess@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x14004C348
 * Callers:
...
void __fastcall VidSchiCaptureRunningProcess(struct _VIDSCH_NODE *a1)
{
  ...
  if ( (*((_DWORD *)a1 + 3) & 2) == 0 )
  {
    AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v11, (unsigned __int64 *)(*((_QWORD *)a1 + 3) + 2016LL), 1, 0);
    ...
    if ( (_DWORD)v2 != *((_DWORD *)a1 + 392) )
    {
      ...
      {
        v4 = (char *)a1 + 2156;
        v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 104) + 48LL) + 2648LL);
        if ( !v5 )
          goto LABEL_12;
        v6 = 15LL;
        v7 = (char *)a1 + 2156;
