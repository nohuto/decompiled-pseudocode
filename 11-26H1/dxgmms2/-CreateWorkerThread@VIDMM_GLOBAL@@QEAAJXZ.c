/*
 * XREFs of ?CreateWorkerThread@VIDMM_GLOBAL@@QEAAJXZ @ 0x1400A7728
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::CreateWorkerThread(VIDMM_GLOBAL *this)
{
  ...
  {
    v2 = (VIDMM_WORKER_THREAD2 *)operator new(5936LL, 0x37346956u, 64LL);
    if ( v2 )
    {
  ...
  {
    v4 = (VIDMM_WORKER_THREAD *)operator new(5336LL, 0x37346956u, 64LL);
    v3 = v4;
    if ( v4 )
    {
