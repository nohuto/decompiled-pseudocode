/*
 * XREFs of ?VidMmPbmmAddCommittedBytesCB@@YAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_PHYSICAL_ALLOC@@II@Z @ 0x1400B0870
 * Callers:
...
void __fastcall VidMmPbmmAddCommittedBytesCB(
