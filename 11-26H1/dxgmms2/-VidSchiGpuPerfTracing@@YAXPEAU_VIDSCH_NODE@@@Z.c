/*
 * XREFs of ?VidSchiGpuPerfTracing@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1400542E4
 * Callers:
 *     ?VidSchiNodePerfTracingThread@@YAXPEAX@Z @ 0x140054500 (-VidSchiNodePerfTracingThread@@YAXPEAX@Z.c)
 * Callees:
