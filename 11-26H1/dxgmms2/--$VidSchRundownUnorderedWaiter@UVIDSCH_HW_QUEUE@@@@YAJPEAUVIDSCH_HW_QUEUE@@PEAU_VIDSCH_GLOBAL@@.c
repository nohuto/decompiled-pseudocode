/*
 * XREFs of ??$VidSchRundownUnorderedWaiter@UVIDSCH_HW_QUEUE@@@@YAJPEAUVIDSCH_HW_QUEUE@@PEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_STAGE@@_NP6AXPEAVHwQueueStagingList@@0@Z@Z @ 0x140042058
 * Callers:
        ...
        union _LARGE_INTEGER Interval)
{
  ...
  if ( *(_DWORD *)(a1 + 156) )
  {
    ...
    if ( *(_DWORD *)(a1 + 156) )
    {
      AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v12, (unsigned __int64 *)(a2 + 2016), 1, 0);
      v8 = (struct _KEVENT *)a2;
      v10 = 0;
      v9[1] = v9;
      v11 = 2;
      v9[0] = v9;
