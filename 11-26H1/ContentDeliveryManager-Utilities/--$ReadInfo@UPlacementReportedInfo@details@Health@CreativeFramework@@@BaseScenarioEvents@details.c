/*
 * XREFs of ??$ReadInfo@UPlacementReportedInfo@details@Health@CreativeFramework@@@BaseScenarioEvents@details@Health@CreativeFramework@@AEAAXAEAUHealthInfoHeader@123@AEAUPlacementReportedInfo@123@AEA_N2PEBG@Z @ 0x180048434
 * Callers:
...
LSTATUS __fastcall CreativeFramework::Health::details::BaseScenarioEvents::ReadInfo<CreativeFramework::Health::details::PlacementReportedInfo>(
        __int64 a1,
        _DWORD *a2,
        _OWORD *a3,
        _BYTE *a4,
        _BYTE *pcbData)
{
  ...
  *v5 = 1;
  if ( *(_QWORD *)(a1 + 240) >= 8uLL )
    v7 = *(const WCHAR **)v7;
  result = RegGetValueW(HKEY_CURRENT_USER, v7, L"PlacementReported", 8u, 0LL, a2, (LPDWORD)&pcbData);
