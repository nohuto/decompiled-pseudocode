/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180030F44
 * Callers:
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v9;
  ...
  IsEnabled = wil::details::FeatureImpl<__WilFeatureTraits_Feature_DmaSsoMSACompliance>::__private_IsEnabled(
                &`wil::Feature<__WilFeatureTraits_Feature_DmaSsoMSACompliance>::GetImpl'::`2'::impl,
                v6);
  LOBYTE(v6) = IsEnabled;
  if ( v11 && !IsEnabled )
    *(_DWORD *)a2 &= ~0x400u;
