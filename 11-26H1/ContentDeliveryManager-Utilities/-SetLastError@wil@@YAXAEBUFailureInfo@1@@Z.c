/*
 * XREFs of ?SetLastError@wil@@YAXAEBUFailureInfo@1@@Z @ 0x18003B614
 * Callers:
 ...
 * Callees:
 *     ?GetThreadLocalDataCache@details_abi@wil@@YAPEAUThreadLocalData@12@_N@Z @ 0x180033240 (-GetThreadLocalDataCache@details_abi@wil@@YAPEAUThreadLocalData@12@_N@Z.c)
