    ...
    else
    {
      ...
      if ( CanCastTo == -2147467262 )
      {
        ...
        if ( InlineIsEqualGUID(a2, &GUID_00000038_0000_0000_c000_000000000046)
          || (v10 += 8, InlineIsEqualGUID(v11, &GUID_8db07c2e_d5b7_55b8_b29e_1853d3eac30a)) )
        {
          *v8 = v10;
          CanCastTo = 0;
        }
