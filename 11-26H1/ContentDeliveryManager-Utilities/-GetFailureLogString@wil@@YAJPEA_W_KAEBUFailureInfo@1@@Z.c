/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEA_W_KAEBUFailureInfo@1@@Z @ 0x1800777F8
 * Callers:
 ...
 *     ?LogStringPrintf@details@wil@@YAPEA_WPEA_WPEB_W1ZZ @ 0x180077CE0 (-LogStringPrintf@details@wil@@YAPEA_WPEA_WPEB_W1ZZ.c)
