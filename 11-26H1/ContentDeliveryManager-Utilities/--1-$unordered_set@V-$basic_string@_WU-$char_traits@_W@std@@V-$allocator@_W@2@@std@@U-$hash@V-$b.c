/*
 * XREFs of ??1?$unordered_set@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@U?$hash@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@U?$equal_to@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@@std@@QEAA@XZ @ 0x1800959DC
 * Callers:
 *     _CreativeFramework::NotificationManager::ToastHelpers::EnforceSchemaAndValidate_::_1_::dtor$0 @ 0x1800BE7A1 (_CreativeFramework--NotificationManager--ToastHelpers--EnforceSchemaAndValidate_--_1_--dtor$0.c)
 *     _CreativeFramework::NotificationManager::ToastHelpers::GetMacros_::_1_::dtor$0 @ 0x1800BE813 (_CreativeFramework--NotificationManager--ToastHelpers--GetMacros_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
