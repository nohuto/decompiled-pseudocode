/*
 * XREFs of ?ConvertFromStoreRecords@AppManager@ContentManagement@@AEAAJPEAU?$IVectorView@PEAVInstallAppInfo@Internal@InstallControl@Preview@Store@ApplicationModel@Windows@@@Collections@Foundation@Windows@@PEAPEAU?$IVectorView@PEAVAppInstallInfoRecord@ContentManagement@@@456@@Z @ 0x180075170
 * Callers:
...
__int64 __fastcall ContentManagement::AppManager::ConvertFromStoreRecords(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  volatile int *v25; // [rsp+30h] [rbp-10h] BYREF
...
LABEL_29:
        ...
        v19 = ContentManagement::AppInstallInfoRecordImpl::put_ProductId(
                (ContentManagement::AppInstallInfoRecordImpl *)(v25 + 12),
                v30);
        v8 = v19;
        if ( v19 < 0 )
        {
        ...
        *((_DWORD *)v25 + 26) = v29;
        v19 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v26 + 104LL))(
                v26,
                (unsigned __int64)(v25 + 12) & ((unsigned __int128)-(__int128)(unsigned __int64)v25 >> 64));
        v8 = v19;
        if ( v19 < 0 )
        {
          v20 = 457LL;
