    ...
    else
    {
      ...
      if ( CanCastTo == -2147467262 )
      {
        ...
        if ( (unsigned int)InlineIsEqualGUID(a2, &GUID_00000038_0000_0000_c000_000000000046)
          || (v10 += 8, (unsigned int)InlineIsEqualGUID(v11, &GUID_d44cacd9_8c72_5e35_9919_0cd862bfd0b4)) )
        {
          *v8 = v10;
          CanCastTo = 0;
        }
