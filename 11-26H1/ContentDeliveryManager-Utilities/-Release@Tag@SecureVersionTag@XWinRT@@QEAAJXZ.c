/*
 * XREFs of ?Release@Tag@SecureVersionTag@XWinRT@@QEAAJXZ @ 0x18008CAE4
 * Callers:
 *     ??1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ @ 0x18008C908 (--1TagManager@SecureVersionTag@XWinRT@@QEAA@XZ.c)
