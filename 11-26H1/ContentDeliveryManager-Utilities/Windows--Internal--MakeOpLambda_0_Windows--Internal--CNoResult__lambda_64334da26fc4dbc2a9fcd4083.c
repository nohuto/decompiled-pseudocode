/*
 * XREFs of Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_64334da26fc4dbc2a9fcd40835aea43a___ @ 0x18006C71C
 * Callers:
 *     ?InvokeAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUIAsyncAction@Foundation@5@@Z @ 0x18006F750 (-InvokeAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJP.c)
 * Callees:
