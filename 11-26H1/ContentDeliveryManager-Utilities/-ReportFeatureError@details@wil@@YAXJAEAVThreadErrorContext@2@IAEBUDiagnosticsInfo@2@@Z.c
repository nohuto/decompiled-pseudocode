/*
 * XREFs of ?ReportFeatureError@details@wil@@YAXJAEAVThreadErrorContext@2@IAEBUDiagnosticsInfo@2@@Z @ 0x1800397B8
 * Callers:
 ...
 *     ?SetLastError@wil@@YAXAEBUFailureInfo@1@@Z @ 0x18003B614 (-SetLastError@wil@@YAXAEBUFailureInfo@1@@Z.c)
 */
