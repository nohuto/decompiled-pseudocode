/*
 * XREFs of ?_Getcat@?$numpunct@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18005AA08
 * Callers:
 ...
 *     ??0?$numpunct@_W@std@@QEAA@AEBV_Locinfo@1@_K_N@Z @ 0x18004B778 (--0-$numpunct@_W@std@@QEAA@AEBV_Locinfo@1@_K_N@Z.c)
