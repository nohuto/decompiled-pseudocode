/*
 * XREFs of ??$ReportFailure_Win32Msg@$00@details@wil@@YAJPEAXIPEBD110K1PEAD@Z @ 0x1800273A4
 * Callers:
        ...
        char *a9)
{
  ...
  v15[0] = v9;
  v15[1] = wil::details::HrToNtStatus((wil::details *)v9, a2);
  v15[2] = 0;
  wil::details::ReportFailure_Msg<1>(v12, v10, v11, v12, v14, a6, (__int64)v15, a8, a9);
  return v9;
}
