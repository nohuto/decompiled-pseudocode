 ...
 *     ??$make_shared@VLaunchAppByIdService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VLaunchAppByIdService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x180099C50 (--$make_shared@VLaunchAppByIdService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VLa.c)
...
_QWORD *__fastcall CreativeFramework::Actions::MakeLaunchAppByIdService(_QWORD *a1, __int64 a2, _QWORD *a3)
{
  ...
  v4 = std::make_shared<CreativeFramework::Actions::LaunchAppByIdService,wchar_t const *>(&v6);
  *a1 = *v4;
  a1[1] = v4[1];
  *v4 = 0LL;
  v4[1] = 0LL;
