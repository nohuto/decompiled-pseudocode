/*
 * XREFs of ?UnstageAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUIAsyncAction@Foundation@5@@Z @ 0x180071E50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Foundation::IAsyncAction **a2)
{
  ...
  *a2 = 0LL;
  ...
  v9 = 3;
  v10 = 130LL;
  v4 = Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_6ab1f6f5bfb1610cca41dbb66aaa8812___(v3);
