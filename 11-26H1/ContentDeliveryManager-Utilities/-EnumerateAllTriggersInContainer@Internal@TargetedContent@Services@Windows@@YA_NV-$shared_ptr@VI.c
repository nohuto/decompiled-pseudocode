/*
 * XREFs of ?EnumerateAllTriggersInContainer@Internal@TargetedContent@Services@Windows@@YA_NV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@V?$function@$$A6A_NV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@AEAVPropertySetHelper@Triggers@CreativeFramework@@@Z@6@@Z @ 0x180086838
 * Callers:
 ...
 *     ??0?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@2@@std@@QEAA@AEBU01@@Z @ 0x180085160 (--0-$pair@$$CBV-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@V-$shared_ptr@VIS.c)
 ...
 *     ?EnumerateAllTriggersInContainer@Internal@TargetedContent@Services@Windows@@YA_NV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@V?$function@$$A6A_NV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@AEAVPropertySetHelper@Triggers@CreativeFramework@@@Z@6@@Z @ 0x180086838 (-EnumerateAllTriggersInContainer@Internal@TargetedContent@Services@Windows@@YA_NV-$shared_ptr@VI.c)
 *     ?get_Type@Accessor@RoVariant@@QEBAJPEAW4PropertyType@Foundation@Windows@@@Z @ 0x180089F24 (-get_Type@Accessor@RoVariant@@QEBAJPEAW4PropertyType@Foundation@Windows@@@Z.c)
...
char __fastcall Windows::Services::TargetedContent::Internal::EnumerateAllTriggersInContainer(__int64 *a1, __int64 a2)
{
  ...
  struct Windows::Foundation::Collections::IPropertySet *v43; // [rsp+38h] [rbp-C8h] BYREF
  ...
  v7(v6, &GUID_fe2f3d47_5d47_5499_8374_430c7cda0204, &v45);
  v41 = 0LL;
  v8 = v45;
  v9 = *(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v45 + 48LL);
  ...
  while ( (*(int (__fastcall **)(__int64, int *))(*(_QWORD *)v41 + 56LL))(v41, &v40) >= 0 )
  {
    ...
    v55 = &v48;
    v56 = 0LL;
    v16 = (*(__int64 (__fastcall **)(__int64 *, struct IInspectable **))(v15 + 56))(v44, &v56);
    if ( v16 < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        165LL,
    ...
    *((_DWORD *)v17 + 2) = v19;
    ...
    v50 = v48;
    LODWORD(v51) = v49;
    Type = RoVariant::Accessor::get_Type((RoVariant::Accessor *)&v50, (enum Windows::Foundation::PropertyType *)&v42);
    if ( Type < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        167LL,
    ...
    if ( v42 == 13 )
    {
      ...
      v25 = v24(v23, &GUID_8a43ed9f_f4e6_4421_acf9_1dab2986820c, &v43);
      v22 = v43;
    }
    else
    {
    ...
    CreativeFramework::Triggers::PropertySetHelper::PropertySetHelper(
      ...
      v22);
    v26 = std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>(
            v59,
            a1);
    v47 = v26;
    v27 = *(_QWORD *)(a2 + 24);
...
LABEL_26:
  ...
  while ( v30 != v29 )
  {
    ...
    v58 = v32;
    v34 = std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>(
            v59,
            &v65);
