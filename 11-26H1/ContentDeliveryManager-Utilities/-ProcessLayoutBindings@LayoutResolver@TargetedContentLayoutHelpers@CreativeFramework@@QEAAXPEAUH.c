/*
 * XREFs of ?ProcessLayoutBindings@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@QEAAXPEAUHSTRING__@@V1ShellPlacementTelemetry@Logging@3@@Z @ 0x1800B0210
 * Callers:
 ...
 *     ??$LayoutAndItemsRetrieved@_NII@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEA_N$$QEAI1@Z @ 0x1800ACE30 (--$LayoutAndItemsRetrieved@_NII@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework.c)
        ...
        CreativeFramework::Logging::ShellPlacementTelemetry::LayoutResolver *a3)
{
  ...
  _QWORD v35[42]; // [rsp+70h] [rbp-1D8h] BYREF
  _QWORD v36[3]; // [rsp+1C0h] [rbp-88h] BYREF
  unsigned __int64 v37; // [rsp+1D8h] [rbp-70h]
  HSTRING_HEADER v38; // [rsp+1E0h] [rbp-68h] BYREF
