/*
 * XREFs of ?_Initialize@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_K@Z @ 0x180072A58
 * Callers:
 ...
 *     ??0MRTHelperForPackage@ShellMRTHelper@@QEAA@PEBG@Z @ 0x1800ABB6C (--0MRTHelperForPackage@ShellMRTHelper@@QEAA@PEBG@Z.c)
 ...
 *     ?TryRemoveImplicitResourcesPrefixFromShortenedMsResourceUri@Common@ShellMRTHelper@@YAJPEAUHSTRING__@@PEAPEAG@Z @ 0x1800AC604 (-TryRemoveImplicitResourcesPrefixFromShortenedMsResourceUri@Common@ShellMRTHelper@@YAJPEAUHSTRIN.c)
 * Callees:
 ...
 *     ?StringCchCopyNW@@YAJPEAG_KPEBG1@Z @ 0x1800729DC (-StringCchCopyNW@@YAJPEAG_KPEBG1@Z.c)
 */
