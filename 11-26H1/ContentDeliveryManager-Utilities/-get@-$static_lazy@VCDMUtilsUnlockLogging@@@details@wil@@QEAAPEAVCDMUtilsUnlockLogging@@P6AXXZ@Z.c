/*
 * XREFs of ?get@?$static_lazy@VCDMUtilsUnlockLogging@@@details@wil@@QEAAPEAVCDMUtilsUnlockLogging@@P6AXXZ@Z @ 0x1800914A8
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<CDMUtilsUnlockLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`CDMUtilsUnlockLogging::Instance'::`2'::wrapper, 0, &v8, (LPVOID *)&v10) && v8 )
  {
    ...
    v10 = &qword_1801805C0;
    qword_1801805C0 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_1801805C8 = 0LL;
    byte_1801805D0 = 0;
    dword_1801805D4 = 0;
    qword_1801805D8 = (__int64)&`CDMUtilsUnlockLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
