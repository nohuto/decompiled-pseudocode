/*
 * XREFs of _Towlower @ 0x180005BFC
 * Callers:
 *     ?do_tolower@?$ctype@_W@std@@MEBA_W_W@Z @ 0x18005DDD0 (-do_tolower@-$ctype@_W@std@@MEBA_W_W@Z.c)
 *     ?do_tolower@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18005DDF0 (-do_tolower@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD4C (_GetLocaleHandleByColl.c)
 *     __crtLCMapStringW_Stub @ 0x18000DE2C (__crtLCMapStringW_Stub.c)
 */
