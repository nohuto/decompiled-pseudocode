/*
 * XREFs of ?TryGetMobilityString@MobilityExperienceSettings@CreativeFramework@@YAJPEB_W0PEAPEA_W@Z @ 0x1800A9E94
 * Callers:
 *     ?get_PairingContext@MobilityExperienceManager@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x1800AA1B0 (-get_PairingContext@MobilityExperienceManager@@UEAAJPEAPEAUHSTRING__@@@Z.c)
 * Callees:
