/*
 * XREFs of ?_Getfmt@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@IEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@PEBD@Z @ 0x180012184
 * Callers:
  ...
  if ( *a8 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v16 == 32 )
        {
          while ( !(unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(v19, a4) )
          {
        ...
        else
        {
          ...
          if ( (*(unsigned __int8 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v13 + 112LL))(v13, *v20, 0LL) != *v15 )
          {
            *v17 |= 2u;
            break;
          }
