/*
 * XREFs of ??$ReportFailure_GetLastErrorHr@$00@details@wil@@YAJPEAXIPEBD110@Z @ 0x180026A6C
 * Callers:
        ...
        const char *a6)
{
  ...
  v17[2] = 0;
  wil::details::ReportFailure_Base<1,0>(v8, v7, a3, v12, v15, (__int64)a6, (int)v17, 0LL);
  return v11;
}
