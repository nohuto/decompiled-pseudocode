/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x1800B9070
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler4_0 @ 0x1800218F3 (__CxxFrameHandler4_0.c)
 *     __GSHandlerCheckCommon @ 0x180021D4C (__GSHandlerCheckCommon.c)
 */
