/*
 * XREFs of ??1TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAA@XZ @ 0x18007C704
 * Callers:
 ...
 *     __lambda_0f325790d88d3e0e1d8faff7704602cc_::operator()_::_1_::dtor$0 @ 0x1800BC442 (__lambda_0f325790d88d3e0e1d8faff7704602cc_--operator()_--_1_--dtor$0.c)
 *     _Windows::Services::TargetedContent::Internal::TargetedContentTriggerManagerStatics::GetTriggeredItemsForStateAsync_::_1_::dtor$1 @ 0x1800BC5D6 (_Windows--Services--TargetedContent--Internal--TargetedContentTriggerManagerStatics_ea_1800BC5D6.c)
 * Callees:
