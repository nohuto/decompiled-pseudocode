/*
 * XREFs of ?GetStringSetting@ContentDeliveryManagerSettings@CreativeFramework@@YAJPEBG0_NPEAPEAG@Z @ 0x180032FDC
 * Callers:
  ...
  *a4 = 0LL;
  ...
  else
  {
    ...
    wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::reset(
      ...
      v10);
    v11 = pvData[0];
    v12 = RegGetValueW(HKEY_CURRENT_USER, this, v5, 2u, 0LL, pvData[0], (LPDWORD)&cb);
    if ( v12 )
    {
      if ( !v5 )
        v5 = &Src;
