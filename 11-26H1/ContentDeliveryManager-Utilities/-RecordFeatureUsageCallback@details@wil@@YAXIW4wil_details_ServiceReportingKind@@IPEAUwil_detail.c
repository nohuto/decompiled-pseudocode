/*
 * XREFs of ?RecordFeatureUsageCallback@details@wil@@YAXIW4wil_details_ServiceReportingKind@@IPEAUwil_details_FeatureReportingCache@@PEAUwil_details_RecordUsageResult@@@Z @ 0x180037570
 * Callers:
 ...
 *     ?QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIPEAUwil_details_FeatureReportingCache@@@Z @ 0x180036E10 (-QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIPEAUwil_details_FeatureRep.c)
        ...
        RTL_SRWLOCK *a5)
{
  ...
  if ( !LODWORD(v7[2].Ptr) && wil::details::g_enabledStateManager )
  {
    ...
    if ( !qword_18017F3B0 )
    {
      ...
      {
        v9(&qword_18017F3B0, _lambda_aa194dc0bf891154933407eb98fb868a_::_lambda_invoker_cdecl_, -1LL);
      }
    }
