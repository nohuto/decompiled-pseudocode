/*
 * XREFs of ?_Getifld@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@1HAEBVlocale@2@@Z @ 0x18005B730
 * Callers:
 *     ?do_get@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHAEAG@Z @ 0x18005CFC0 (-do_get@-$num_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-AV-$istreambuf.c)
 *     ?do_get@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHAEAI@Z @ 0x18005D0D0 (-do_get@-$num_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-A_ea_18005D0D0.c)
 ...
 *     ?do_get@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHAEAK@Z @ 0x18005D2E0 (-do_get@-$num_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-A_ea_18005D2E0.c)
 ...
 *     ??$_Find_elem@G@std@@YA_KPEAGG@Z @ 0x1800493E8 (--$_Find_elem@G@std@@YA_KPEAGG@Z.c)
 ...
 *     ?grouping@?$numpunct@G@std@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ @ 0x18005E97C (-grouping@-$numpunct@G@std@@QEBA-AV-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@2@XZ.c)
        ...
        std::locale *a6)
{
  ...
  char *v41; // [rsp+40h] [rbp-79h]
  char *v42; // [rsp+48h] [rbp-71h]
  void *v43[3]; // [rsp+50h] [rbp-69h] BYREF
  unsigned __int64 v44; // [rsp+68h] [rbp-51h]
  void *v45[4]; // [rsp+70h] [rbp-49h] BYREF
  _WORD v46[28]; // [rsp+90h] [rbp-29h] BYREF

  v42 = a2;
  v8 = std::use_facet<std::numpunct<unsigned short>>(a6);
  std::numpunct<unsigned short>::grouping(v8, v45);
  v9 = 0;
  if ( v45[2] )
    v38 = (*(__int64 (__fastcall **)(const struct std::locale::facet *))(*(_QWORD *)v8 + 32LL))(v8);
  else
    v38 = 0;
...
LABEL_30:
  ...
  while ( !(unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
  {
    ...
    if ( v26 >= v16 )
    {
      ...
      if ( v23 >= 0x10 )
        v30 = v24;
      if ( !*((_BYTE *)v30 + v20) || !v38 || *(_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3) != v38 )
        break;
      std::string::append(v43, 1LL);
      ++v20;
      goto LABEL_49;
    }
    v27 = `std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getifld'::`2'::_Src[v26];
    *v11 = v27;
