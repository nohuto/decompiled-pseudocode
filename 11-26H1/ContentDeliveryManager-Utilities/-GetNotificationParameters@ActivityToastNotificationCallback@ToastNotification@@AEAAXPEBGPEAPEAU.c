/*
 * XREFs of ?GetNotificationParameters@ActivityToastNotificationCallback@ToastNotification@@AEAAXPEBGPEAPEAUHSTRING__@@PEAU_GUID@@PEAW4CDPActivityType@@PEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z @ 0x1800694C8
 * Callers:
 ...
 *     ?str@?$basic_stringstream@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@XZ @ 0x180065C84 (-str@-$basic_stringstream@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEBA-AV-$basic_string@GU.c)
 *     ??$GetActivationFactory@UIUriRuntimeClassFactory@Foundation@Windows@@@wil@@YA?AV?$com_ptr_t@UIUriRuntimeClassFactory@Foundation@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x18006653C (--$GetActivationFactory@UIUriRuntimeClassFactory@Foundation@Windows@@@wil@@YA-AV-$com_ptr_t@UIUr.c)
 ...
 *     ?end@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA?AV?$_String_iterator@V?$_String_val@U?$_Simple_types@G@std@@@std@@@2@XZ @ 0x18006B864 (-end@-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEAA-AV-$_String_iterator@V-$_.c)
        ...
        __int64 a6)
{
  ...
  _BYTE v46[240]; // [rsp+70h] [rbp-90h] BYREF
  _QWORD v47[32]; // [rsp+160h] [rbp+60h] BYREF
  HSTRING_HEADER hstringHeader; // [rsp+260h] [rbp+160h] BYREF
  __int64 v49; // [rsp+278h] [rbp+178h]
  _QWORD v50[4]; // [rsp+280h] [rbp+180h] BYREF
  _QWORD v51[4]; // [rsp+2A0h] [rbp+1A0h] BYREF
  ...
  *v9 = 0;
  std::basic_stringstream<unsigned short,std::char_traits<unsigned short>,std::allocator<unsigned short>>::basic_stringstream<unsigned short,std::char_traits<unsigned short>,std::allocator<unsigned short>>(
    ...
    (__int64)a2,
    (char)a3);
  v10 = std::operator<<<wchar_t,std::char_traits<wchar_t>>((__int64)v46, L"http://ignore?");
  std::operator<<<wchar_t,std::char_traits<wchar_t>>(v10, a2);
  ...
  *(_QWORD *)v37 = 0LL;
  ...
  v38 = 0;
  std::basic_istream<unsigned short>::operator>>((__int64)v47, (__int64)&v38);
  *a5 = v38;
  v39 = 0LL;
  v32 = *(_QWORD *)v37;
  ...
  v35 = *(char **)std::wstring::end(v50, &v44);
  v36 = (char *)v50;
  if ( v50[3] >= 8uLL )
    v36 = (char *)v50[0];
  v49 = 15LL;
  *(_QWORD *)&hstringHeader.Reserved.Reserved2[16] = 0LL;
  ...
  v39 = 0LL;
  std::basic_stringstream<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t>>::`vbase destructor'((__int64)v47);
