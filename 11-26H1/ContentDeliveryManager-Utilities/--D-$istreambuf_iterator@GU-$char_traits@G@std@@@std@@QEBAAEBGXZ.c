/*
 * XREFs of ??D?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@QEBAAEBGXZ @ 0x18004D728
 * Callers:
 ...
 * Callees:
 *     ?_Peek@?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@AEBA_WXZ @ 0x18005C3B0 (-_Peek@-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@AEBA_WXZ.c)
 */

__int64 __fastcall std::istreambuf_iterator<unsigned short>::operator*(__int64 a1)
{
  if ( !*(_BYTE *)(a1 + 8) )
    std::istreambuf_iterator<wchar_t>::_Peek();
  return a1 + 10;
}
