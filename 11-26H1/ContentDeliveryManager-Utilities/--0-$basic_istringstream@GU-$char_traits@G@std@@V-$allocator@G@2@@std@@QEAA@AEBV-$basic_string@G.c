/*
 * XREFs of ??0?$basic_istringstream@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@H@Z @ 0x18004B470
 * Callers:
        ...
        char a3)
{
  *a1 = &std::wistringstream::`vbtable';
  ...
  std::basic_istream<unsigned short>::basic_istream<unsigned short>(a1, (__int64)(a1 + 2), a3);
