/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_56845155@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180039BEC
 * Callers:
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_56845155@@@details@wil@@QEAA_NXZ @ 0x18003E238 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_56845155@@@details@wil@@QEAA_NXZ.c)
 * Callees:
...
__int64 wil::details::FeatureImpl<__WilFeatureTraits_Feature_56845155>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_56845155>::GetCachedFeatureEnabledState(a1, &v7);
    v7 = v3;
  }
  LODWORD(v8) = 0;
  WORD2(v8) = 2;
