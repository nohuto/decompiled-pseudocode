/*
 * XREFs of ?DeleteLockScreenRegistryKeys@SetLockScreenHotspotsService@Actions@CreativeFramework@@AEAAJXZ @ 0x1800A369C
 * Callers:
 *     ?Unstage@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800A42F0 (-Unstage@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
        ...
        CreativeFramework::Actions::SetLockScreenHotspotsService *this)
{
  ...
  _QWORD v28[4]; // [rsp+90h] [rbp-658h] BYREF
  ...
  *(_OWORD *)lpSubKey = 0LL;
  ...
  {
    *((_BYTE *)this + 124) = 1;
    for ( j = lpSubKey[0]; j != v10; j += 16 )
    {
      if ( *((_QWORD *)j + 3) < 8uLL )
        v12 = j;
      else
        v12 = *(const WCHAR **)j;
      v15 = RegDeleteKeyExW(hKey, v12, 0, 0);
      if ( v15 )
        wil::details::in1diag3::_Throw_Win32(
          retaddr,
          181LL,
    ...
    pcbData = 1;
    v14 = RegSetKeyValueW(hKey, 0LL, L"LockImageFlags", 4u, &pcbData, 4u);
    v5 = retaddr;
    if ( v14 )
      wil::details::in1diag3::_Throw_Win32(
        retaddr,
  ...
  if ( lpSubKey[0] )
  {
    std::vector<std::wstring>::_Destroy((__int64)v5, (_QWORD *)lpSubKey[0], v10);
