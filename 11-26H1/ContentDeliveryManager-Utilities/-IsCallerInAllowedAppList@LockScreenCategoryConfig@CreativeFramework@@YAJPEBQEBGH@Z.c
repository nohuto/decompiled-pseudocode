/*
 * XREFs of ?IsCallerInAllowedAppList@LockScreenCategoryConfig@CreativeFramework@@YAJPEBQEBGH@Z @ 0x180033D24
 * Callers:
 *     ??$MakeAndInitialize@VContextualSuggestionsManager@ContentManagement@@UIContextualSuggestionsManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIContextualSuggestionsManager@ContentManagement@@@Z @ 0x1800252EC (--$MakeAndInitialize@VContextualSuggestionsManager@ContentManagement@@UIContextualSuggestionsMan.c)
 *     ??$MakeAndInitialize@VIdentityManager@ContentManagement@@UIIdentityManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIIdentityManager@ContentManagement@@@Z @ 0x1800259FC (--$MakeAndInitialize@VIdentityManager@ContentManagement@@UIIdentityManager@2@$$V@Details@WRL@Mic.c)
 *     ??$MakeAndInitialize@VThumbnailCacheHelper@ContentManagement@@UIThumbnailCacheHelper@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIThumbnailCacheHelper@ContentManagement@@@Z @ 0x180025FC0 (--$MakeAndInitialize@VThumbnailCacheHelper@ContentManagement@@UIThumbnailCacheHelper@2@$$V@Detai.c)
 * Callees:
        ...
        const unsigned __int16 *const *a2)
{
  ...
  if ( CallingProcessHandle >= 0 )
  {
    ...
    if ( CallingProcessPackageSidString >= 0 )
    {
      ...
      while ( (__int64)v9 < (__int64)off_1800CC2C0 );
      v19 = 0LL;
      v20 = 0LL;
      v21 = 0LL;
