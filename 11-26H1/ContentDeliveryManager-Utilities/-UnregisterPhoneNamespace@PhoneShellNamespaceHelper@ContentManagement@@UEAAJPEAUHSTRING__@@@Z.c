/*
 * XREFs of ?UnregisterPhoneNamespace@PhoneShellNamespaceHelper@ContentManagement@@UEAAJPEAUHSTRING__@@@Z @ 0x18003CB30
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a2)
{
  ...
  CreativeFramework::ContentDeliveryManagerSettings *v17[3]; // [rsp+20h] [rbp-30h] BYREF
  CreativeFramework::ContentDeliveryManagerSettings *v18[3]; // [rsp+38h] [rbp-18h] BYREF
  ...
  if ( v8 >= 0 )
  {
    CreativeFramework::ContentDeliveryManagerSettings::DeleteSettingTree((const WCHAR *)v18[0], v9);
    ...
    if ( v12 >= 0 )
    {
      CreativeFramework::ContentDeliveryManagerSettings::DeleteSettingKey((const WCHAR *)v17[0], v13);
