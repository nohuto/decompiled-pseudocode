/*
 * XREFs of ?get@?$static_lazy@VDelayAllocateTLSLogging@@@details@wil@@QEAAPEAVDelayAllocateTLSLogging@@P6AXXZ@Z @ 0x18003E7D4
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<DelayAllocateTLSLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`DelayAllocateTLSLogging::Instance'::`2'::wrapper, 0, &v8, (LPVOID *)&v10) && v8 )
  {
    ...
    v10 = &qword_1801804F0;
    qword_1801804F0 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_1801804F8 = 0LL;
    byte_180180500 = 0;
    dword_180180504 = 0;
    qword_180180508 = (__int64)&`DelayAllocateTLSLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
