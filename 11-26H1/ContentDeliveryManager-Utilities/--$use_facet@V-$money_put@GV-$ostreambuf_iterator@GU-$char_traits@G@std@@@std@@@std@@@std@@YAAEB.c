/*
 * XREFs of ??$use_facet@V?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@@std@@YAAEBV?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@0@AEBVlocale@0@@Z @ 0x18000F9D4
 * Callers:
 ...
 *     ?_Getcat@?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800118DC (-_Getcat@-$money_put@GV-$ostreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@SA_KPEAPEBVfacet.c)
        ...
        __int64 *a1)
{
  ...
  v12 = (struct std::_Facet_base *)std::_Facetptr<std::money_put<unsigned short,std::ostreambuf_iterator<unsigned short>>>::_Psave;
  ...
  if ( !v6 )
  {
    ...
    {
      if ( std::money_put<unsigned short,std::ostreambuf_iterator<unsigned short>>::_Getcat(&v12, a1) == -1 )
      {
        bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
        throw (bad_cast *)pExceptionObject;
      }
      v6 = v12;
      std::_Facetptr<std::money_put<unsigned short,std::ostreambuf_iterator<unsigned short>>>::_Psave = (__int64)v12;
