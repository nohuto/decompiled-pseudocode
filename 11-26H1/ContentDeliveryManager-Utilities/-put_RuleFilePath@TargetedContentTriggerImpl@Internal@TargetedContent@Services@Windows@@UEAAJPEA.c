/*
 * XREFs of ?put_RuleFilePath@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x180079590
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a2)
{
  ...
  v8 = v2;
  v4 = Microsoft::WRL::Wrappers::HString::Set((HSTRING *)this + 18, &v9);
  v5 = v4;
  if ( v4 >= 0 )
    v5 = 0;
  else
