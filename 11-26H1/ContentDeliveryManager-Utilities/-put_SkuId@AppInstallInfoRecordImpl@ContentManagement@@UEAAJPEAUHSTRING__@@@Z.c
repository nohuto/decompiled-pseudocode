/*
 * XREFs of ?put_SkuId@AppInstallInfoRecordImpl@ContentManagement@@UEAAJPEAUHSTRING__@@@Z @ 0x180045A20
 * Callers:
        ...
        HSTRING a2)
{
  ...
  v5 = v2;
  LODWORD(v2) = Microsoft::WRL::Wrappers::HString::Set((HSTRING *)this + 5, &v6);
