/*
 * XREFs of ??$ReportFailure_NtStatus@$00@details@wil@@YAJPEAXIPEBD110J@Z @ 0x180026F6C
 * Callers:
 ...
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x180035420 (-NtStatusToHr@details@wil@@YAJJ@Z.c)
 */
        ...
        wil::details *a7)
{
  ...
  v13[1] = (_DWORD)a7;
  v13[2] = 1;
  wil::details::ReportFailure_Base<1,0>(a1, a2, a3, a6, v12, a6, (int)v13, 0LL);
  return v10;
}
