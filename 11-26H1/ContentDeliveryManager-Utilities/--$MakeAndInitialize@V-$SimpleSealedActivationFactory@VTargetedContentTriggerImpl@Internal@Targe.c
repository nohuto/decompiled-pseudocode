...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Microsoft::WRL::SimpleSealedActivationFactory<Windows::Services::TargetedContent::Internal::TargetedContentTriggerImpl,0>,Microsoft::WRL::SimpleSealedActivationFactory<Windows::Services::TargetedContent::Internal::TargetedContentTriggerImpl,0>,>(
        _QWORD *a1)
{
  unsigned int v1; // ebx
  void *v3; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v3 )
  {
    ...
    v6 = 0LL;
    *v4 = &Microsoft::WRL::SimpleSealedActivationFactory<Windows::Services::TargetedContent::Internal::TargetedContentTriggerImpl,0>::`vftable';
