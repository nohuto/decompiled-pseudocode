/*
 * XREFs of ?RemovePhoneLink@PhoneShellNamespaceHelper@ContentManagement@@AEAAJPEBG@Z @ 0x1800396D4
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  int v2; // eax
  unsigned int v3; // ebx
  CreativeFramework::ContentDeliveryManagerSettings *v5[4]; // [rsp+30h] [rbp-20h] BYREF
  ...
  Windows::Internal::NativeString<Windows::Internal::CoTaskMemPolicy<unsigned short>>::_Free(v5);
  return v3;
}
