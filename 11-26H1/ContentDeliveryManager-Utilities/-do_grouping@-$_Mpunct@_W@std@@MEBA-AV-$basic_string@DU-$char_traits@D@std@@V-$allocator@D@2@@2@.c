/*
 * XREFs of ?do_grouping@?$_Mpunct@_W@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ @ 0x18000AEC0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Mpunct<wchar_t>::do_grouping(__int64 a1, _QWORD *a2)
{
  char *v2; // rdi
  size_t v3; // rax
