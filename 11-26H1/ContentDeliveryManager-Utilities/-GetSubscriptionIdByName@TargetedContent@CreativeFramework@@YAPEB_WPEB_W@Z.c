/*
 * XREFs of ?GetSubscriptionIdByName@TargetedContent@CreativeFramework@@YAPEB_WPEB_W@Z @ 0x18009736C
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  for ( i = &off_1800DF090; i != (const wchar_t near *const *)&off_1800DF2B8; i += 3 )
  {
