/*
 * XREFs of _lambda_0d276c7ea3d710d19b822c1822ed0068_::operator() @ 0x18006E50C
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows::Internal::CNoResult_::Run @ 0x18006FFD0 (Windows--Internal--COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows--Inte.c)
 * Callees:
...
__int64 __fastcall lambda_0d276c7ea3d710d19b822c1822ed0068_::operator()(__int64 *a1)
{
  __int64 v2; // rbx
  __int64 v3; // rax
  ...
  v17[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v17,
    v10,
    v7,
    v4);
  ...
  try
  {
    ...
    ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::~ActionStagedActivity((ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v17);
    result = 0LL;
  }
  catch ( ... )
  {
