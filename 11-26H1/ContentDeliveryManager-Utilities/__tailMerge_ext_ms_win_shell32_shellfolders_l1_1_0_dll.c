/*
 * XREFs of __tailMerge_ext_ms_win_shell32_shellfolders_l1_1_0_dll @ 0x1800228FF
 * Callers:
 *     __imp_load_SHGetKnownFolderPath @ 0x18002297E (__imp_load_SHGetKnownFolderPath.c)
 * Callees:
