/*
 * XREFs of ??0?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x1800A978C
 * Callers:
 *     ??$MakeAndInitialize@V?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAV?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@12@@Z @ 0x1800A9610 (--$MakeAndInitialize@V-$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@V123@.c)
 * Callees:
