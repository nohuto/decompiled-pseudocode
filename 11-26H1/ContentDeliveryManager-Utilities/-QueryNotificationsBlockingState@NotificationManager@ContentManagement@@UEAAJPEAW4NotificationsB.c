/*
 * XREFs of ?QueryNotificationsBlockingState@NotificationManager@ContentManagement@@UEAAJPEAW4NotificationsBlockingStateFlags@2@@Z @ 0x180036CA0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetActionCenterQuietHoursState@NotificationManager@ContentManagement@@AEAAJPEA_N@Z @ 0x1800301CC (-GetActionCenterQuietHoursState@NotificationManager@ContentManagement@@AEAAJPEA_N@Z.c)
