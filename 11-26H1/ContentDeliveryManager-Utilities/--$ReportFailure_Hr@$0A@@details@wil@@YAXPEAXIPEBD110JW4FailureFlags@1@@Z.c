/*
 * XREFs of ??$ReportFailure_Hr@$0A@@details@wil@@YAXPEAXIPEBD110JW4FailureFlags@1@@Z @ 0x180026C30
 * Callers:
        ...
        unsigned int a7)
{
  ...
  v14 = *(_DWORD *)(v7 + 8);
  v13 = v8;
  wil::details::ReportFailure_Base<0,0>(v11, v10, v9, v9, v12, a6, (__int64)&v13, 0LL);
}
