/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_6ab1f6f5bfb1610cca41dbb66aaa8812__Windows::Internal::CNoResult_::Run @ 0x180070090
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  if ( a3 >= 0 )
    a3 = *(_DWORD *)(a1 + 16);
  if ( a2 == 1 && a3 >= 0 )
    return (unsigned int)lambda_6ab1f6f5bfb1610cca41dbb66aaa8812_::operator()((__int64 *)(a1 + 8));
