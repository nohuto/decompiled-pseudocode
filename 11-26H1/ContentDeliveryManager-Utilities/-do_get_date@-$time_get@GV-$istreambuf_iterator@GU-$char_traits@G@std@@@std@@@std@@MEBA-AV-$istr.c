/*
 * XREFs of ?do_get_date@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x180018210
 * Callers:
 *     <none>
 * Callees:
...
__int128 *__fastcall std::time_get<unsigned short,std::istreambuf_iterator<unsigned short>>::do_get_date(
        __int64 a1,
        __int128 *a2,
        __int128 *a3,
        __int128 *a4,
        ...
        __int64 a7)
{
  ...
  v13 = std::use_facet<std::ctype<unsigned short>>((std::locale *)&v43);
  if ( v10 )
  {
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 4LL, *v18) )
  {
    v40 = *a4;
    v41 = *a3;
    v19 = a7;
...
LABEL_17:
  while ( !(unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
  {
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 72LL, *v21) )
      break;
  ...
  v23 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v13 + 112LL))(v13, *v22, 0LL);
...
LABEL_24:
  ...
  while ( (*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 72LL, *v25) );
  if ( (unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
    goto LABEL_34;
  v26 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*(a3);
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 4LL, *v26) )
  {
...
LABEL_37:
  while ( !(unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
  {
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 72LL, *v29) )
      break;
    std::istreambuf_iterator<unsigned short>::_Inc(a3);
  }
  if ( (unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
  ...
  v31 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v13 + 112LL))(v13, *v30, 0LL);
...
LABEL_44:
  ...
  while ( (*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 72LL, *v33) );
  if ( (unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
    goto LABEL_46;
  v34 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*(a3);
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v13 + 32LL))(v13, 4LL, *v34) )
  {
    if ( v15 == 4 )
    {
      v36 = (_DWORD *)(a7 + 16);
