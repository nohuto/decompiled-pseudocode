/*
 * XREFs of ??$MakeAndInitialize@V?$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@@$0A@@WRL@Microsoft@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAV?$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@@$0A@@12@@Z @ 0x180066684
 * Callers:
 *     ??$CreateClassFactory@V?$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x1800661B0 (--$CreateClassFactory@V-$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification.c)
 * Callees:
