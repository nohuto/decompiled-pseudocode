/*
 * XREFs of ?CheckCapabilityFromImpersonationToken@CallerIdentity@@YAJPEAXPEBGPEA_N@Z @ 0x180072BA0
 * Callers:
  ...
  *(_BYTE *)a3 = 0;
  ...
  if ( v5 < 0 )
    return wil::details::in1diag3::Return_NtStatus(
             retaddr,
             (void *)0xE,
             (int)"onecore\\shell\\lib\\calleridentity\\calleridentity_capability.cpp",
