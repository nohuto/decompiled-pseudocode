/*
 * XREFs of ??$?0$0BAE@@HStringReference@Wrappers@WRL@Microsoft@@QEAA@AEAY0BAE@_W@Z @ 0x18008A598
 * Callers:
 ...
 *     ?RaiseException@Details@WRL@Microsoft@@YAXJK@Z @ 0x180036EAC (-RaiseException@Details@WRL@Microsoft@@YAXJK@Z.c)
 */
