/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x180036FC8
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800BA45F (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
