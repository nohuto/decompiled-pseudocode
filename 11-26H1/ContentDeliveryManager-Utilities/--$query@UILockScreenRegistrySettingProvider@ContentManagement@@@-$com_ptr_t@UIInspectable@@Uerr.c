/*
 * XREFs of ??$query@UILockScreenRegistrySettingProvider@ContentManagement@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UILockScreenRegistrySettingProvider@ContentManagement@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A2A5C
 * Callers:
