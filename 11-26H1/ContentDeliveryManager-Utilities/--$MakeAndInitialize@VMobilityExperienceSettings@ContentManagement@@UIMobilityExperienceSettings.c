/*
 * XREFs of ??$MakeAndInitialize@VMobilityExperienceSettings@ContentManagement@@UIMobilityExperienceSettings@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIMobilityExperienceSettings@ContentManagement@@@Z @ 0x180025C6C
 * Callers:
