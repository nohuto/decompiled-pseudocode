/*
 * XREFs of ?do_get@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x18001EFC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Getfmt@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@IEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@PEBD@Z @ 0x18001C750 (-_Getfmt@-$time_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@IEBA-AV-$istreamb.c)
...
LABEL_21:
        v22 = &v35;
LABEL_56:
        v24 = *std::time_get<char,std::istreambuf_iterator<char>>::_Getfmt(a1, v22, v21, v20, v12, a6, (__int64)a7, v19);
        goto LABEL_38;
      }
      if ( a8 != 65 )
      {
...
LABEL_73:
  ...
  if ( a8 > 110 )
  {
    if ( a8 == 112 )
    {
      v28 = std::_Getloctxt<char,std::istreambuf_iterator<char>>(a3, (__int64)a4, 0LL, ":AM:am:PM:pm");
      if ( v28 < 0 )
        goto LABEL_73;
      a7[2] += 12 * v28;
      goto LABEL_75;
...
LABEL_52:
  ...
  if ( a8 != 109 )
    goto LABEL_73;
  *v16 |= std::time_get<char,std::istreambuf_iterator<char>>::_Getint(a1, (__int64)a3, a4, 1, 12, &a5, (__int64)v14);
  if ( (*(_BYTE *)v16 & 2) == 0 )
    a7[4] = a5 - 1;
LABEL_75:
