/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_64334da26fc4dbc2a9fcd40835aea43a__Windows::Internal::CNoResult_::Run @ 0x180070050
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  if ( a3 >= 0 )
    a3 = *(_DWORD *)(a1 + 16);
  if ( a2 == 1 && a3 >= 0 )
    return (unsigned int)lambda_64334da26fc4dbc2a9fcd40835aea43a_::operator()((__int64 *)(a1 + 8));
