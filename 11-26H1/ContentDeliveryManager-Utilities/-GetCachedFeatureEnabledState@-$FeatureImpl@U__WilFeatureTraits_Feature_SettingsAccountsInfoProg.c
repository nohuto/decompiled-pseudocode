/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsAccountsInfoProgrammablePromoCard@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180050AFC
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsAccountsInfoProgrammablePromoCard@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800571DC (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_SettingsAccountsInfoProgrammablePromoCard.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsAccountsInfoProgrammablePromoCard@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180051B64 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_SettingsAccountsInfoPro.c)
 */
