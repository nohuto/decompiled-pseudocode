/*
 * XREFs of ?OnPublishError@ActivityToastNotificationCallback@ToastNotification@@UEAAJPEBU_GUID@@J@Z @ 0x180069FA0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  wil::details::in1diag3::Log_HrMsg(
    ...
    (const char *)a3,
    (unsigned __int64)"Error publishing completion activity",
    v6);
