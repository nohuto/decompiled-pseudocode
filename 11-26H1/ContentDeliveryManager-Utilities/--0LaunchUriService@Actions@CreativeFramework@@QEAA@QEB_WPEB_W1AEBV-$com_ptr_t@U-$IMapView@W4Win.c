/*
 * XREFs of ??0LaunchUriService@Actions@CreativeFramework@@QEAA@QEB_WPEB_W1AEBV?$com_ptr_t@U?$IMapView@W4WindowPosition@ContentManagement@@I@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@0_N@Z @ 0x18009A1C0
 * Callers:
        ...
        char a7)
{
  ...
  *(_BYTE *)(a1 + 113) = a7;
  if ( *(_QWORD *)(a1 + 56) )
  {
    ...
    if ( v8 )
    {
      for ( i = &off_1800DF320; i != off_1800DF3C0; i += 2 )
      {
