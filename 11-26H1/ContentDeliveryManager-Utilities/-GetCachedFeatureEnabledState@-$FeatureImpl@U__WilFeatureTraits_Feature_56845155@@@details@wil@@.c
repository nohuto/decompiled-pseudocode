/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_56845155@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800303D4
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = v2;
  if ( (v2 & 6) != 6 )
  {
    ...
    v15 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_56845155>::GetCurrentFeatureEnabledState(v7, &v16, &v15);
    v8 = *(_DWORD *)a2;
    v9 = (__int16)v16;
    do
    {
