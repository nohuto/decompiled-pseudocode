/*
 * XREFs of ContentManagement::ExecuteHandlerByEventPolicy__lambda_929976d9f769b9ae6bfa1e1f0592e0ca___ @ 0x1800462B0
 * Callers:
        ...
        __int64 a7)
{
  ...
  _BYTE v25[8]; // [rsp+30h] [rbp-20h] BYREF
...
LABEL_17:
  ...
  if ( (_BYTE)v28 )
  {
    v23 = lambda_929976d9f769b9ae6bfa1e1f0592e0ca_::operator()(a6, 12LL);
    v21 = v23;
    if ( v23 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
