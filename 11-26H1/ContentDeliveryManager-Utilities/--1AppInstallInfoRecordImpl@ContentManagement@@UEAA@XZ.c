/*
 * XREFs of ??1AppInstallInfoRecordImpl@ContentManagement@@UEAA@XZ @ 0x180042CD0
 * Callers:
 *     ??_EAppInstallInfoRecordImpl@ContentManagement@@UEAAPEAXI@Z @ 0x180043120 (--_EAppInstallInfoRecordImpl@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
 *     <none>
 */
