...
__int64 __fastcall Windows::Foundation::ActivateInstance<Microsoft::WRL::ComPtr<Windows::ApplicationModel::Store::Preview::InstallControl::Internal::IInstallAppInfo>>(
        __int64 a1,
        __int64 *a2)
{
  int v4; // edi
  ...
  *a2 = 0LL;
  ...
  if ( v4 >= 0 )
  {
    if ( !memcmp_0(&GUID_2b7a9a4b_b688_42bc_8b8e_b3439137d20e, &GUID_af86e2e0_b12d_4c6a_9c5a_d7aa65101e90, 0x10uLL) )
    {
      *a2 = v6;
    }
    else
