/*
 * XREFs of ?IsLockScreenEnabled@ContentManagementService@ContentManagement@@UEAAJPEAE0@Z @ 0x180054420
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  LOBYTE(v10) = 0;
  v11 = 0;
  LockScreenEnabled = CreativeFramework::LockScreenCreativeConfigHelpers::GetLockScreenEnabled(
                        this,
                        (bool *)&v10,
                        &v11,
                        a4);
