/*
 * XREFs of ?_Getffldx@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x1800A0900
 * Callers:
  ...
  *v12 = 30768;
  ...
  if ( *(_BYTE *)v24 == 127 || *(char *)v24 <= 0 )
  {
    while ( !std::istreambuf_iterator<wchar_t>::equal(a3, v6) )
    {
      ...
      if ( v19 < 36 )
      {
        if ( v38 || v19 )
        {
          *v17++ = `std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getffldx'::`2'::_Src[v38];
          ++v19;
        }
      }
      else
  ...
  while ( !std::istreambuf_iterator<wchar_t>::equal(a3, v56) )
  {
    ...
    if ( v19 < 36 )
    {
      if ( v28 || v19 )
      {
        *v17++ = `std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getffldx'::`2'::_Src[v28];
        ++v19;
      }
    }
    else
...
LABEL_71:
  ...
  while ( !std::istreambuf_iterator<wchar_t>::equal(a3, v6) )
  {
    ...
    if ( v19 < 36 )
    {
      *v17++ = `std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getffldx'::`2'::_Src[v42];
      ++v19;
    }
    v18 = 1;
    std::istreambuf_iterator<unsigned short>::_Inc(a3);
...
LABEL_100:
        ...
        while ( !std::istreambuf_iterator<wchar_t>::equal(a3, v6) )
        {
          ...
          if ( (int)v13 < 8 )
          {
            *v17++ = `std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getffldx'::`2'::_Src[v51];
            LODWORD(v13) = v13 + 1;
          }
          v18 = 1;
          std::istreambuf_iterator<unsigned short>::_Inc(a3);
