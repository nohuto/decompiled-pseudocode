/*
 * XREFs of ??$use_facet@V?$messages@G@std@@@std@@YAAEBV?$messages@G@0@AEBVlocale@0@@Z @ 0x18000F4A4
 * Callers:
 ...
 *     ?_Getcat@?$messages@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x180011678 (-_Getcat@-$messages@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
