/*
 * XREFs of ?CheckCallerCapability@CallerIdentity@@YAJPEBGPEA_N@Z @ 0x180072B04
 * Callers:
 ...
 *     ?GetCallingProcessHandle@CallerIdentity@@YAJKPEAPEAX@Z @ 0x180073124 (-GetCallingProcessHandle@CallerIdentity@@YAJKPEAPEAX@Z.c)
 */
