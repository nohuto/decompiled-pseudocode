/*
 * XREFs of ??1CreativeEventReportedCache@ContentManagement@@UEAA@XZ @ 0x18004D090
 * Callers:
 *     ??_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z @ 0x18004E550 (--_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
