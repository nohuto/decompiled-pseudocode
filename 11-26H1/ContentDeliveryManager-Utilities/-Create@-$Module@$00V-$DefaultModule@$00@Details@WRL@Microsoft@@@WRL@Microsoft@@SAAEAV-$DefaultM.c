/*
 * XREFs of ?Create@?$Module@$00V?$DefaultModule@$00@Details@WRL@Microsoft@@@WRL@Microsoft@@SAAEAV?$DefaultModule@$00@Details@23@XZ @ 0x1800438CC
 * Callers:
 ...
 *     DllGetClassObject @ 0x180045B60 (DllGetClassObject.c)
 * Callees:
 *     <none>
 */
