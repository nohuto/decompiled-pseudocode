/*
 * XREFs of ?StopActivity@CreativeEventActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@MEAAXXZ @ 0x1800590B0
 * Callers:
 *     <none>
 * Callees:
        ...
        CreativeFramework::Logging::ShellPlacementTelemetry::CreativeEventActivity *this)
{
  ...
  {
    wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::zInternalStop();
    v10 = CreativeFramework::Logging::ShellPlacementLogging::Provider(v9);
    if ( *(_DWORD *)v10 > 5u )
    {
