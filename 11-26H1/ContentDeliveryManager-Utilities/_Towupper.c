/*
 * XREFs of _Towupper @ 0x180006278
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x18005DE40 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18005DE60 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
