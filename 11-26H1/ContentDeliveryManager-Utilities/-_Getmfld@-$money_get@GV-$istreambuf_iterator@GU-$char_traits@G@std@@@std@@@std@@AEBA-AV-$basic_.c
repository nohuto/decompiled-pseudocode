/*
 * XREFs of ?_Getmfld@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@0_NAEAVios_base@2@PEAG@Z @ 0x180012528
 * Callers:
        ...
        __int16 *a7)
{
  ...
  if ( a5 )
  {
    ...
    v11 = 256;
    v12 = std::use_facet<std::moneypunct<unsigned short,1>>(&v89);
    v87 = v12;
    if ( v10 )
    {
  ...
  else
  {
    ...
    (*(void (__fastcall **)(__int64))(*(_QWORD *)v10 + 8LL))(v10);
    v11 = 128;
    v12 = std::use_facet<std::moneypunct<unsigned short,0>>(&v89);
    v87 = v12;
    if ( v10 )
    {
  ...
  *(_BYTE *)v9 = 0;
  ...
  v16 = v11 | 0x21;
  v17 = std::use_facet<std::ctype<unsigned short>>((std::locale *)&v89);
  v89 = v17;
  if ( v15 )
  {
