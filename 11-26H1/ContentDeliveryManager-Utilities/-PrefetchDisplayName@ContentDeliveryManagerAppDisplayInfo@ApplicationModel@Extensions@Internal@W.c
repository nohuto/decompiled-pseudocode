/*
 * XREFs of ?PrefetchDisplayName@ContentDeliveryManagerAppDisplayInfo@ApplicationModel@Extensions@Internal@Windows@@AEAAXPEBG@Z @ 0x1800AC0AC
 * Callers:
 ...
 *     ?Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEB_WI@Z @ 0x180083804 (-Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEB_WI@Z.c)
 *     ??0MRTHelperForPackage@ShellMRTHelper@@QEAA@PEBG@Z @ 0x1800ABB6C (--0MRTHelperForPackage@ShellMRTHelper@@QEAA@PEBG@Z.c)
 *     ??1MRTHelperBase@ShellMRTHelper@@QEAA@XZ @ 0x1800ABC34 (--1MRTHelperBase@ShellMRTHelper@@QEAA@XZ.c)
