/*
 * XREFs of ?CommitAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUIAsyncAction@Foundation@5@@Z @ 0x18006F260
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_1535a6ac74a46a99e57700c911cef706___ @ 0x18006C688 (Windows--Internal--MakeOpLambda_0_Windows--Internal--CNoResult__lambda_1535a6ac74a46a99e57700c91.c)
 */
        ...
        struct Windows::Foundation::IAsyncAction **a2)
{
  ...
  *a2 = 0LL;
  ...
  v10 = 3;
  v11 = 130LL;
  v4 = Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_1535a6ac74a46a99e57700c911cef706___(v3);
