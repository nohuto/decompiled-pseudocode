/*
 * XREFs of ?GetWindowExperienceManager@LaunchManager@ContentManagement@@AEAAJPEAPEAUIWindowExperienceManager@2@@Z @ 0x180033820
 * Callers:
 *     ?PositionAppOnScreen@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@PEAU?$IMapView@W4WindowPosition@ContentManagement@@I@Collections@Foundation@Windows@@I@Z @ 0x1800359E0 (-PositionAppOnScreen@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@PEAU-$IMapView@W4Windo.c)
 * Callees:
