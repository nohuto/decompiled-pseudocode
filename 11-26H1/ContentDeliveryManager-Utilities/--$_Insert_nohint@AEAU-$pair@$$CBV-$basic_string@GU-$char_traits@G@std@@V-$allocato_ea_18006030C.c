        ...
        __int64 a5)
{
  ...
  try
  {
    ...
    if ( (_BYTE)v10 )
    {
      ...
      {
        v12 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Max();
      }
    }
    if ( std::wstring::compare((const wchar_t *)(v12 + 32), a4) >= 0 )
    {
