/*
 * XREFs of ?FindActivityAndStore@CDPActivityHelper@MobilityExperience@@YA_NAEBU_GUID@@AEBV?$vector@V?$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@PEAPEAVICDPActivity@@PEAPEAVICDPActivityStore@@@Z @ 0x180068DE8
 * Callers:
