/*
 * XREFs of _anonymous_namespace_::PlacementHealth::HandleEvent_10_unsigned_int_unsigned___int64_ @ 0x180046DD0
 * Callers:
 ...
 *     _anonymous_namespace_::StartsWith @ 0x180058E74 (_anonymous_namespace_--StartsWith.c)
