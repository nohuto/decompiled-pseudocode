/*
 * XREFs of ?EnableStartMenuSystemPaneSuggestionsAsync@ContentManagementService@ContentManagement@@UEAAJEPEAPEAUIAsyncAction@Foundation@Windows@@@Z @ 0x18004F5B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Foundation::IAsyncAction **a3)
{
  ...
  v12 = 3;
  v13 = 128LL;
  v6 = Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_42fbd5d3fb16a796ab83ae5a767075fb___((__int64)&v14);
