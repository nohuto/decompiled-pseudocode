        ...
        _QWORD *a5)
{
  ...
  int v29[4]; // [rsp+20h] [rbp-208h] BYREF
  ...
  try
  {
    ...
    ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerUnregisterActivity::StartActivity(
      ...
      (const wchar_t *)(v8 + 8));
    v29[0] = 0;
    v9 = (*(__int64 (__fastcall **)(Windows::Services::TargetedContent::Internal *, int *))(*(_QWORD *)a2 + 80LL))(
           a2,
           v29);
    if ( v9 < 0 )
    ...
    if ( !v29[0] )
      wil::details::in1diag3::Throw_Hr(
        ...
        0);
    v10 = Windows::Services::TargetedContent::Internal::ResolveTriggerRegistrationOption((unsigned int)v29[0]);
    ...
    Windows::Services::TargetedContent::Internal::ResolveTriggerCleanupHandler(v38, (unsigned int)v29[0]);
