/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DeleteMinuteZeroExperiences@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180050618
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_DeleteMinuteZeroExperiences@@@details@wil@@QEAA_NXZ @ 0x18005C824 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_DeleteMinuteZeroExperiences@@@det.c)
 * Callees:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_DeleteMinuteZeroExperiences>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v2; // eax
  ...
  *(_DWORD *)a2 = v2;
  if ( (v2 & 6) != 6 )
  {
    ...
    v15 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_DeleteMinuteZeroExperiences>::GetCurrentFeatureEnabledState(
      v7,
      &v16,
      &v15);
    v8 = *(_DWORD *)a2;
