/*
 * XREFs of ??$Allocated@AEAPEBG@DelayAllocateTLSTelemetry@@SAXAEAPEBG@Z @ 0x180023B70
 * Callers:
 *     ?DelayAllocateTLS_AllocateInternal@@YAXPEAKPEBG@Z @ 0x18002E254 (-DelayAllocateTLS_AllocateInternal@@YAXPEAKPEBG@Z.c)
 * Callees:
