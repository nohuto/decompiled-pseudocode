/*
 * XREFs of ??_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x180096110
 * Callers:
 *     <none>
 * Callees:
 *     ??1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ @ 0x180095AC8 (--1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ.c)
 */
