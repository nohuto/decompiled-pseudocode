/*
 * XREFs of ?FindLayout@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXPEAUITargetedContentCollection@TargetedContent@Services@Windows@@PEAUHSTRING__@@PEAUITargetedContentIdAliasStore@Internal@567@@Z @ 0x1800AEC84
 * Callers:
        ...
        struct Windows::Services::TargetedContent::Internal::ITargetedContentIdAliasStore *a4)
{
  ...
  v12 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v35, (const WCHAR **)off_1800DF4A8, v9);
  ...
  if ( v31[0] )
  {
    ...
    v33 = 0LL;
    v17 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v35, (const WCHAR **)off_1800DF4A8, v14);
    ...
    *this = 0LL;
    ...
    v27 = string;
    v28 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v35, (const WCHAR **)&off_1800DF4B0, v25);
