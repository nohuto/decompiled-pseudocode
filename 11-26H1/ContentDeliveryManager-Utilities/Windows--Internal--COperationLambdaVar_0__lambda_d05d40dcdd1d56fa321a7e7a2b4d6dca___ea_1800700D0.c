/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_d05d40dcdd1d56fa321a7e7a2b4d6dca__Windows::Internal::CNoResult_::Run @ 0x1800700D0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  if ( a3 >= 0 )
    a3 = *(_DWORD *)(a1 + 16);
  if ( a2 == 1 && a3 >= 0 )
    return (unsigned int)lambda_d05d40dcdd1d56fa321a7e7a2b4d6dca_::operator()((__int64 *)(a1 + 8));
