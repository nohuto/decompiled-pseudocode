/*
 * XREFs of ??Rless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@QEAA_NAEBV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@0@Z @ 0x1800B4570
 * Callers:
 ...
 *     ??$_Merge_backward@PEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@PEAV12@PEAV12@Uless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@@std@@YAPEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@0@PEAV10@0000Uless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@@Z @ 0x1800B37E4 (--$_Merge_backward@PEAV-$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFram_ea_1800B37E4.c)
 * Callees:
 *     <none>
 */
        ...
        __int64 a3)
{
  ...
  v3 = *(double *)(*(_QWORD *)a3 + 32LL);
  v4 = *(double *)(*(_QWORD *)a2 + 32LL);
  return v3 > v4 || v4 == v3 && *(double *)(*(_QWORD *)a3 + 40LL) > *(double *)(*(_QWORD *)a2 + 40LL);
}
