/*
 * XREFs of ?_Getffldx@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x18005B10C
 * Callers:
...
LABEL_7:
  *v12 = 30768;
  ...
  if ( v64[2] )
    v54 = (*(__int64 (__fastcall **)(const struct std::locale::facet *))(*(_QWORD *)v57 + 32LL))(v57);
  else
    v54 = 0;
...
LABEL_71:
  ...
  if ( !(unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, v6) )
  {
    v39 = (*(__int64 (__fastcall **)(const struct std::locale::facet *))(*(_QWORD *)v57 + 24LL))(v57);
    if ( *(_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3) == v39 )
    {
