/*
 * XREFs of ??_GSetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800A3620
 * Callers:
 *     <none>
 * Callees:
 *     ??1SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800A35C0 (--1SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAA@XZ.c)
 */
