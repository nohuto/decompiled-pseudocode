/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x180090510
 * Callers:
...
__int64 __fastcall wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::ReportStopActivity(
        _QWORD *a1,
        int a2)
{
  __int64 v4; // rdi
  ...
  if ( a2 < 0 )
  {
    ...
    {
      v7 = CDMUtilsUnlockLogging::Provider((__int64)a1);
    ...
    {
      v11 = CDMUtilsUnlockLogging::Provider((__int64)a1);
      v12 = (__int64)v11;
