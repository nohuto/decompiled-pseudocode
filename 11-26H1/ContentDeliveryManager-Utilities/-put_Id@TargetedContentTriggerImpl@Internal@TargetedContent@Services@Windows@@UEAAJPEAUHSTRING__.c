/*
 * XREFs of ?put_Id@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x180079260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::TargetedContentTriggerImpl::put_Id(
        ...
        HSTRING a2)
{
  ...
  v8 = v2;
  v4 = Microsoft::WRL::Wrappers::HString::Set((HSTRING *)this + 11, &v9);
  v5 = v4;
  if ( v4 >= 0 )
    v5 = 0;
  else
