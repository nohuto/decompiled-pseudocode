/*
 * XREFs of ??$query@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@@?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTilePrivate@StartScreen@UI@Internal@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A5E80
 * Callers:
