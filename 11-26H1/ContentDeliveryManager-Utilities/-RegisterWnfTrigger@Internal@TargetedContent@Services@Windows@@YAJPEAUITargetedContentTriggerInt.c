/*
 * XREFs of ?RegisterWnfTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x180082F60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetTaskConditionFlagsForTrigger@Internal@TargetedContent@Services@Windows@@YA?AW4TaskConditionFlags@CommonHelper@CreativeFramework@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x1800824A8 (-GetTaskConditionFlagsForTrigger@Internal@TargetedContent@Services@Windows@@YA-AW4TaskConditionF.c)
 ...
 *     ?GetTaskOptionsFlagsForTrigger@Internal@TargetedContent@Services@Windows@@YA?AW4TaskOptionFlags@CommonHelper@CreativeFramework@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x1800828DC (-GetTaskOptionsFlagsForTrigger@Internal@TargetedContent@Services@Windows@@YA-AW4TaskOptionFlags@.c)
        ...
        __int64 a2)
{
  ...
  int v22; // [rsp+20h] [rbp-138h]
  char TaskConditionFlagsForTrigger; // [rsp+50h] [rbp-108h]
  unsigned int v24; // [rsp+50h] [rbp-108h]
  HSTRING string; // [rsp+58h] [rbp-100h] BYREF
  unsigned int v26; // [rsp+60h] [rbp-F8h] BYREF
  int v27; // [rsp+64h] [rbp-F4h] BYREF
  int TaskOptionsFlagsForTrigger; // [rsp+68h] [rbp-F0h]
  void *v29; // [rsp+70h] [rbp-E8h] BYREF
  const WCHAR *v30; // [rsp+78h] [rbp-E0h] BYREF
  __int64 v31; // [rsp+80h] [rbp-D8h]
  _QWORD v32[4]; // [rsp+88h] [rbp-D0h] BYREF
  _QWORD v33[4]; // [rsp+A8h] [rbp-B0h] BYREF
  _QWORD v34[4]; // [rsp+C8h] [rbp-90h] BYREF
  HSTRING_HEADER v35; // [rsp+E8h] [rbp-70h] BYREF
  HSTRING_HEADER v36; // [rsp+108h] [rbp-50h] BYREF
  ...
  try
  {
    ...
    if ( v7 < 0 )
      wil::details::in1diag3::Throw_Hr(
        ...
        v22);
    v8 = Windows::Services::TargetedContent::Internal::ResolveTriggerRegistrationOption(v26);
    if ( ((v8 & 2) != 0 || !WindowsIsStringEmpty(string)) && (v8 & 0x100) == 0 )
    {
      Windows::Services::TargetedContent::Internal::ResolvePredicateHandler(v32, a1);
    ...
    Windows::Services::TargetedContent::Internal::GetTaskNameForTrigger((__int64)v34, (__int64)a1);
    v9 = v34;
    if ( v34[3] >= 8uLL )
      v9 = (_QWORD *)v34[0];
    Windows::Services::TargetedContent::Internal::ResolveCDMTaskName(v33, v9);
    ...
    v11 = v27;
    v12 = (int)v29;
    Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v35, (const WCHAR **)&off_1800D59F0, v13)[1].Reserved.Reserved1;
    v16 = (const WCHAR *)v33;
    if ( v33[3] >= 8uLL )
      v16 = (const WCHAR *)v33[0];
    v30 = v16;
    v17 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v36, &v30, v15);
    CreativeFramework::CommonHelper::RegisterBackgroundTaskWithWnfTrigger(
      ...
      (__int64)v10);
    std::wstring::_Tidy(v33, 1, 0LL);
    std::wstring::_Tidy(v34, 1, 0LL);
