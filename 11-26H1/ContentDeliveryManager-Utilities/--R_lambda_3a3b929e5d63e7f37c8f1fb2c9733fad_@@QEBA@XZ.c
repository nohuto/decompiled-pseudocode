/*
 * XREFs of ??R_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@QEBA@XZ @ 0x18002B40C
 * Callers:
 *     ?Run@?$functor_wrapper_void@AEAV_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@@details@wil@@UEAAJXZ @ 0x18003A940 (-Run@-$functor_wrapper_void@AEAV_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@@details@wil@@UEAAJXZ.c)
 * Callees:
 ...
 *     ?IsSystemProductValidForTaskbarIcon@Pinning@Mobility@@YA_NXZ @ 0x1800344B8 (-IsSystemProductValidForTaskbarIcon@Pinning@Mobility@@YA_NXZ.c)
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_YourPhoneTaskbarIcon@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180039E90 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_YourPhoneTaskbarIcon@@@details@wil@@QEAAX.c)
 *     ?SetMobilityValue@MobilityExperienceSettings@CreativeFramework@@YAJEPEBG0@Z @ 0x18003B684 (-SetMobilityValue@MobilityExperienceSettings@CreativeFramework@@YAJEPEBG0@Z.c)
 ...
 *     ?isTaskbarIconCreationBlockedByPolicy@Policy@Mobility@@YA_NXZ @ 0x18003F6B0 (-isTaskbarIconCreationBlockedByPolicy@Policy@Mobility@@YA_NXZ.c)
