/*
 * XREFs of ?GetCreativeEventCacheRegPath@CreativeEventReportedCache@ContentManagement@@CAJPEBGPEAPEAG@Z @ 0x1800516AC
 * Callers:
 *     ?RuntimeClassInitialize@CreativeEventReportedCache@ContentManagement@@QEAAJPEBG@Z @ 0x180057D58 (-RuntimeClassInitialize@CreativeEventReportedCache@ContentManagement@@QEAAJPEBG@Z.c)
 * Callees:
