/*
 * XREFs of ?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@PEBD_K@Z @ 0x18003E418
 * Callers:
 ...
 *     ?_Inside@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA_NPEBD@Z @ 0x18003DD00 (-_Inside@-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@std@@QEAA_NPEBD@Z.c)
