/*
 * XREFs of ?do_get@?$money_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0_NAEAVios_base@2@AEAHAEAO@Z @ 0x18001ED50
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a8)
{
  ...
  v15[1] = -2LL;
  std::money_get<char,std::istreambuf_iterator<char>>::_Getmfld(a1, v16, (__int64)a3, a4, a5, a6, v18);
