/*
 * XREFs of _Toupper @ 0x18000E840
 * Callers:
 *     ?do_toupper@?$ctype@D@std@@MEBADD@Z @ 0x18000B940 (-do_toupper@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x18000B960 (-do_toupper@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
...
int __cdecl Toupper(int a1, const _Ctypevec *a2)
{
  ...
  if ( (unsigned int)v2 < 0x100 )
  {
    ...
    if ( (a2->_Table[v2] & 2) == 0 )
      return v2;
LABEL_13:
    v10 = (unsigned __int16)a2->_Table[v9] >> 15;
    v11 = (int)v2 >> 8;
    goto LABEL_14;
  }
  v9 = BYTE1(v2);
...
LABEL_17:
  v11 = (int)v2 >> 8;
  v10 = __pctype_func()[BYTE1(v2)] & 0x8000;
LABEL_14:
  if ( v10 )
  {
    v14 = v11;
