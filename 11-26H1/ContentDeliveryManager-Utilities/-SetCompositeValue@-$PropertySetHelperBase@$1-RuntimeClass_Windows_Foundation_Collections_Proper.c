/*
 * XREFs of ?SetCompositeValue@?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_PropertySet@@3QB_WB@Triggers@CreativeFramework@@QEAAJPEAUHSTRING__@@PEAUIPropertySet@Collections@Foundation@Windows@@@Z @ 0x18008836C
 * Callers:
 ...
 *     ??0RoVariant@@AEAA@PEAUIInspectable@@_N1@Z @ 0x1800851F8 (--0RoVariant@@AEAA@PEAUIInspectable@@_N1@Z.c)
 *     ??1RoVariant@@QEAA@XZ @ 0x1800854C8 (--1RoVariant@@QEAA@XZ.c)
