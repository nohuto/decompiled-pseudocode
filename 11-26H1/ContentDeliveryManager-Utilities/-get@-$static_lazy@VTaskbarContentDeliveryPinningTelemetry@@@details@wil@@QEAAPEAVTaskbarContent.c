/*
 * XREFs of ?get@?$static_lazy@VTaskbarContentDeliveryPinningTelemetry@@@details@wil@@QEAAPEAVTaskbarContentDeliveryPinningTelemetry@@P6AXXZ@Z @ 0x18003EA2C
 * Callers:
        ...
        void (__cdecl *a2)())
{
    ...
    && v6 )
  {
    ...
    v8 = &qword_1801804C8;
    qword_1801804D0 = 0LL;
    qword_1801804C8 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    byte_1801804D8 = 0;
    dword_1801804DC = 0;
    atexit(a2);
    v5 = 0;
