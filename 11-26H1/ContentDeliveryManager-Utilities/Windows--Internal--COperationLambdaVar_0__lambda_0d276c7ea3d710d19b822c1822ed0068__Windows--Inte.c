/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows::Internal::CNoResult_::Run @ 0x18006FFD0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  if ( a3 >= 0 )
    a3 = *(_DWORD *)(a1 + 16);
  if ( a2 == 1 && a3 >= 0 )
    return (unsigned int)lambda_0d276c7ea3d710d19b822c1822ed0068_::operator()((__int64 *)(a1 + 8));
