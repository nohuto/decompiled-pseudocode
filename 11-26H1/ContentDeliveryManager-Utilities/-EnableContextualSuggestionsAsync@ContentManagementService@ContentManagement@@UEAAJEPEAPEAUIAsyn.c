/*
 * XREFs of ?EnableContextualSuggestionsAsync@ContentManagementService@ContentManagement@@UEAAJEPEAPEAUIAsyncAction@Foundation@Windows@@@Z @ 0x18004F370
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Foundation::IAsyncAction **a3)
{
  ...
  v12 = 3;
  v13 = 128LL;
  v6 = Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_822b4fd04ca4bb1472820328fff37fc1___((__int64)&v14);
