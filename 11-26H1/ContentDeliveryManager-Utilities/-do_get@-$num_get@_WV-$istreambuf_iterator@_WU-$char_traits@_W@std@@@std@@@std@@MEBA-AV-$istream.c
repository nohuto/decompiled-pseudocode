/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAG@Z @ 0x1800A1430
 * Callers:
 *     <none>
 * Callees:
        ...
        _WORD *a7)
{
  ...
  v17 = 0LL;
  v16 = 0;
  v11 = std::ios_base::getloc(a5, (std::locale *)v18);
