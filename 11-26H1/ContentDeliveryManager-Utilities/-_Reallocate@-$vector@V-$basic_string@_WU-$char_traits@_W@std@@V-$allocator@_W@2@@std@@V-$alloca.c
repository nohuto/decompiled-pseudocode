/*
 * XREFs of ?_Reallocate@?$vector@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$allocator@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@@std@@IEAAX_K@Z @ 0x1800A4324
 * Callers:
...
char *__fastcall std::vector<std::wstring>::_Reallocate(__int64 *a1, unsigned __int64 a2)
{
  ...
  if ( a2 )
  {
    if ( a2 > 0x7FFFFFFFFFFFFFFLL || (v4 = 32 * a2, (v3 = (char *)operator new(32 * a2)) == 0LL) )
      std::_Xbad_alloc();
  }
  else
  {
