/*
 * XREFs of ?_Reallocate@?$vector@UTile@TargetedContentLayoutHelpers@CreativeFramework@@V?$allocator@UTile@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@std@@IEAAX_K@Z @ 0x1800B1AC0
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( a2 )
  {
    if ( a2 > 0x492492492492492LL || (v4 = 56 * a2, v3 = (char *)operator new(56 * a2), (v8 = v3) == 0LL) )
      std::_Xbad_alloc();
  }
  else
  {
