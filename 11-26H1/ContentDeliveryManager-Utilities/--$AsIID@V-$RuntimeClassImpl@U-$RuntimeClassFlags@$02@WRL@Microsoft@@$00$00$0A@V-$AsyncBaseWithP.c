    ...
    else
    {
      ...
      if ( CanCastTo == -2147467262 )
      {
        ...
        if ( (unsigned int)InlineIsEqualGUID(a2, &GUID_00000038_0000_0000_c000_000000000046)
          || (v10 += 8, (unsigned int)InlineIsEqualGUID(v11, &GUID_3e1fe603_f897_5263_b328_0806426b8a79)) )
        {
          *v8 = v10;
          CanCastTo = 0;
        }
