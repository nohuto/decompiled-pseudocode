/*
 * XREFs of ?PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z @ 0x18009F154
 * Callers:
 *     ?Invoke@TaskbarPinService@Actions@CreativeFramework@@UEAAXXZ @ 0x18009ECA0 (-Invoke@TaskbarPinService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?GetTaskBarSuggestionsPinHelper@Actions@CreativeFramework@@YA?AV?$com_ptr_t@UITaskBarSuggestionsPinHelper@TaskBarSuggestions@UI@Internal@Windows@@Uerr_exception_policy@wil@@@wil@@XZ @ 0x18009EB18 (-GetTaskBarSuggestionsPinHelper@Actions@CreativeFramework@@YA-AV-$com_ptr_t@UITaskBarSuggestions.c)
...
void __fastcall CreativeFramework::Actions::PinApp(const WCHAR *this, const wchar_t *a2, __int64 a3, const wchar_t *a4)
{
  ...
  const WCHAR *v15; // [rsp+38h] [rbp-70h] BYREF
  ...
  Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v17, &v15, v7)[1].Reserved.Reserved1;
