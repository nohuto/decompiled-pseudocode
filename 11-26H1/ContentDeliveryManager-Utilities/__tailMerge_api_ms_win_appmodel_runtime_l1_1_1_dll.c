/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x180022EFC
 * Callers:
 *     __imp_load_FormatApplicationUserModelId @ 0x180022F7B (__imp_load_FormatApplicationUserModelId.c)
 * Callees:
