 ...
 *     ?UnregisterSubscription@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UEAAJPEAUHSTRING__@@PEAUISubscriptionPriv@234@@Z @ 0x180064A30 (-UnregisterSubscription@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UEAA.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  __int64 *v8; // rax
  __int64 v9; // rdx
  std::_Ref_count_base *v11[2]; // [rsp+20h] [rbp-68h] BYREF
  std::_Ref_count_base *v12; // [rsp+30h] [rbp-58h] BYREF
  ...
  if ( (__int64 *)v11[0] == *a1 )
  {
    *(_OWORD *)v11 = 0LL;
    ...
    std::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>(
      ...
      (__int64 *)v11);
    v5 = **a1;
    v7 = std::_List_buy<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>::_Buynode<std::pair<std::wstring,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>(
           v6,
           v5,
           *(_QWORD *)(v5 + 8),
           (__int64)v13);
    v8 = a1[1];
    if ( v8 == (__int64 *)0x3FFFFFFFFFFFFFELL )
