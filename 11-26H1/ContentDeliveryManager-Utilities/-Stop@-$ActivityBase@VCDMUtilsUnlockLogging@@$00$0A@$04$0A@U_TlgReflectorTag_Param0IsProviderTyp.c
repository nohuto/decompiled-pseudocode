/*
 * XREFs of ?Stop@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x180090E40
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  if ( v2 )
  {
    wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::ReportStopActivity(a1, v8);
  }
  else
  {
    v4 = CDMUtilsUnlockLogging::Provider(v3);
    if ( *(_DWORD *)v4 > 5u )
    {
