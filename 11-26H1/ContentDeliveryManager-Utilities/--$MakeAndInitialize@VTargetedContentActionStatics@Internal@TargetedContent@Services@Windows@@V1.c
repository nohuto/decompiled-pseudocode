/*
 * XREFs of ??$MakeAndInitialize@VTargetedContentActionStatics@Internal@TargetedContent@Services@Windows@@V12345@$$V@Details@WRL@Microsoft@@YAJPEAPEAVTargetedContentActionStatics@Internal@TargetedContent@Services@Windows@@@Z @ 0x18006C208
 * Callers:
 ...
 *     ?AddRef@?$ActivationFactory@U?$Implements@VFtmBase@WRL@Microsoft@@UITargetedContentSubscriptionStatics@TargetedContent@ContentManagement@@@WRL@Microsoft@@VNil@Details@23@V4523@$0A@@WRL@Microsoft@@UEAAKXZ @ 0x1800432F0 (-AddRef@-$ActivationFactory@U-$Implements@VFtmBase@WRL@Microsoft@@UITargetedContentSubscriptionS.c)
 ...
 *     ??0TargetedContentActionStatics@Internal@TargetedContent@Services@Windows@@QEAA@XZ @ 0x18006DA7C (--0TargetedContentActionStatics@Internal@TargetedContent@Services@Windows@@QEAA@XZ.c)
 */
