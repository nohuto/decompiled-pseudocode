/*
 * XREFs of ?_GetCachedSTAObject@@YAJKPEAHPEAPEAVCCachedSTAObject@@@Z @ 0x18003DB0C
 * Callers:
 ...
 *     ??0CCachedSTAObject@@QEAA@XZ @ 0x180028D64 (--0CCachedSTAObject@@QEAA@XZ.c)
 *     ?Release@CCachedSTAObject@@UEAAKXZ @ 0x180039650 (-Release@CCachedSTAObject@@UEAAKXZ.c)
 */
  ...
  *a3 = 0LL;
  if ( a2 )
  {
    *a2 = 0;
    v12 = 0;
    v13 = 0;
    if ( CoGetApartmentType((APTTYPE *)&v12, (APTTYPEQUALIFIER *)&v13) < 0 || v12 != 3 && v12 )
