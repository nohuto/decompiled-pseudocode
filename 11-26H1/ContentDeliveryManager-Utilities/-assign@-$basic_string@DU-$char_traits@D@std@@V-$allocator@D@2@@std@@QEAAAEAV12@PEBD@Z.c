/*
 * XREFs of ?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@PEBD@Z @ 0x18003E3E0
 * Callers:
 ...
 * Callees:
 *     ?length@?$char_traits@D@std@@SA_KPEBD@Z @ 0x18003F764 (-length@-$char_traits@D@std@@SA_KPEBD@Z.c)
 */
