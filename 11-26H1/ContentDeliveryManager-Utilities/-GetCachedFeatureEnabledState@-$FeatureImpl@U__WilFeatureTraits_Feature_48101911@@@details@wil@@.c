/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180030298
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAA_NXZ @ 0x18003E1FC (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAA_NXZ.c)
 * Callees:
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = v2;
  if ( (v2 & 6) != 6 )
  {
    ...
    v15 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_48101911>::GetCurrentFeatureEnabledState(v7, &v16, &v15);
    if ( !v6 )
      v15 = 0;
    v8 = *(_DWORD *)a2;
    v9 = (__int16)v16;
