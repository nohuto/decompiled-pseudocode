/*
 * XREFs of ?PinToStart@Actions@CreativeFramework@@YAXPEB_W00_N@Z @ 0x180097F90
 * Callers:
 *     ?Invoke@PinToStartService@Actions@CreativeFramework@@UEAAXXZ @ 0x180097770 (-Invoke@PinToStartService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
        ...
        const wchar_t *a4)
{
  ...
  for ( i = &off_1800DF068; i != off_1800DF088; i += 2 )
  {
