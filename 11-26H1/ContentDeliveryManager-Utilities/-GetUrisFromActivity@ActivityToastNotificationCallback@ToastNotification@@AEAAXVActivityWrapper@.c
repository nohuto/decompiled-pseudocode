/*
 * XREFs of ?GetUrisFromActivity@ActivityToastNotificationCallback@ToastNotification@@AEAAXVActivityWrapper@MobilityExperience@@PEAPEAUHSTRING__@@1@Z @ 0x180069A00
 * Callers:
 ...
 *     ??$query@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@@?$com_ptr_t@UIUriRuntimeClass@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800677F0 (--$query@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@@-$com_ptr_t@UIUriRuntime.c)
