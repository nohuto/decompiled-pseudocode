/*
 * XREFs of ??0?$basic_stringbuf@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@H@Z @ 0x18004B6B8
 * Callers:
 ...
 * Callees:
 *     ??0?$basic_streambuf@GU?$char_traits@G@std@@@std@@IEAA@XZ @ 0x18004B514 (--0-$basic_streambuf@GU-$char_traits@G@std@@@std@@IEAA@XZ.c)
