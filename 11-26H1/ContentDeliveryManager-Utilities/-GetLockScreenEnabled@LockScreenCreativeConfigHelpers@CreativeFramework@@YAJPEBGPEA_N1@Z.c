/*
 * XREFs of ?GetLockScreenEnabled@LockScreenCreativeConfigHelpers@CreativeFramework@@YAJPEBGPEA_N1@Z @ 0x180052E00
 * Callers:
 *     ?IsLockScreenEnabled@ContentManagementService@ContentManagement@@UEAAJPEAE0@Z @ 0x180054420 (-IsLockScreenEnabled@ContentManagementService@ContentManagement@@UEAAJPEAE0@Z.c)
 * Callees:
 ...
 *     ?IsContentDeliveryAllowedOverrideInEffect@ContentDeliveryManagerDebugSettings@CreativeFramework@@YA_NPEA_N@Z @ 0x180053FE4 (-IsContentDeliveryAllowedOverrideInEffect@ContentDeliveryManagerDebugSettings@CreativeFramework@.c)
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_WindowsSpotlightV3@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180057574 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_WindowsSpotlightV3@@@details@wil@@QEAAX_N.c)
 */
        ...
        bool *a4)
{
  ...
  _BYTE v26[8]; // [rsp+50h] [rbp-19h] BYREF
  LPCWSTR lpSubKey[3]; // [rsp+58h] [rbp-11h] BYREF
  LPCWSTR v28[10]; // [rsp+70h] [rbp+7h] BYREF
  ...
  DWORD v33; // [rsp+E8h] [rbp+7Fh] BYREF
...
LABEL_40:
      ...
      hKey = 0LL;
      v19 = RegOpenKeyExW(HKEY_LOCAL_MACHINE, v28[0], 0, 9u, &hKey);
      v13 = v19;
      if ( v19 > 0 )
...
LABEL_39:
    ...
    LODWORD(pdwValue) = 0;
    v33 = 4;
    v22 = RegGetValueW(hKey, 0LL, L"RotatingLockScreenOverlayEnabled", 0x10u, 0LL, &pdwValue, &v33);
    v13 = v22;
    if ( v22 > 0 )
