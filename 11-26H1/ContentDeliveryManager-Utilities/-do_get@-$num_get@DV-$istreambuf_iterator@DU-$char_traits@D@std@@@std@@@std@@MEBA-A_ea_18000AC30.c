/*
 * XREFs of ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEA_N@Z @ 0x18000AC30
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  char *v24; // [rsp+40h] [rbp-91h] BYREF
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x4000) != 0 )
  {
    ...
    v14 = std::use_facet<std::numpunct<char>>((__int64 *)&v24);
    if ( v13 )
    {
      v15 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (__fastcall **)(char *))(*(_QWORD *)v13 + 16LL))(v13);
      if ( v15 )
        (**v15)(v15, 1LL);
    }
    v29 = 15LL;
  ...
  else
  {
    ...
    v18 = std::num_get<char,std::istreambuf_iterator<char>>::_Getifld(
            a1,
            v32,
            a3,
            a4,
            *(_DWORD *)(a5 + 24),
            (__int64 *)&v25);
    v19 = Stoulx(v32, &v24, v18, &v22);
    if ( v25 )
    {
      v20 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (__fastcall **)(char *))(*(_QWORD *)v25 + 16LL))(v25);
      if ( v20 )
        (**v20)(v20, 1LL);
    }
    if ( v24 != v32 && !v22 && v19 <= 1 )
      v11 = v19;
    v17 = v23;
  }
