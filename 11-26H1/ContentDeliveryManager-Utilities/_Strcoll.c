/*
 * XREFs of _Strcoll @ 0x180020F70
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x18001ECC0 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000DD4C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000DD58 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x18000DDB4 (__crtCompareStringA_Stub.c)
