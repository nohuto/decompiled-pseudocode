/*
 * XREFs of ?CreateKey@ContentDeliveryManagerSettings@CreativeFramework@@YAJPEBG@Z @ 0x18002DBF0
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  v7 = 0LL;
  v3 = RegCreateKeyExW(HKEY_CURRENT_USER, this, 0, 0LL, 0, 0x20019u, 0LL, &v7, 0LL);
  if ( v3 )
