/*
 * XREFs of ?GetLastError@ThreadLocalData@details_abi@wil@@QEBA_NAEAUFailureInfo@3@IJ@Z @ 0x180031E00
 * Callers:
 ...
 * Callees:
 *     ?Get@ThreadLocalFailureInfo@details_abi@wil@@QEBAXAEAUFailureInfo@3@@Z @ 0x180030150 (-Get@ThreadLocalFailureInfo@details_abi@wil@@QEBAXAEAUFailureInfo@3@@Z.c)
 */
...
char __fastcall wil::details_abi::ThreadLocalData::GetLastError(
        ...
        int a4)
{
  wil::details_abi::ThreadLocalFailureInfo *v4; // r11
