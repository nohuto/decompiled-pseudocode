/*
 * XREFs of _lambda_6ab1f6f5bfb1610cca41dbb66aaa8812_::operator() @ 0x18006E9DC
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_6ab1f6f5bfb1610cca41dbb66aaa8812__Windows::Internal::CNoResult_::Run @ 0x180070090 (Windows--Internal--COperationLambdaVar_0__lambda_6ab1f6f5bfb1610cca41dbb66aaa8812__Windows--Inte.c)
 * Callees:
...
__int64 __fastcall lambda_6ab1f6f5bfb1610cca41dbb66aaa8812_::operator()(__int64 *a1)
{
  __int64 v2; // rbx
  __int64 v3; // rax
  ...
  v17[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionUnstagedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionUnstagedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionUnstagedActivity *)v17,
    v10,
    v7,
    v4);
  ...
  try
  {
    ...
    ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionUnstagedActivity::~ActionUnstagedActivity((ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionUnstagedActivity *)v17);
    result = 0LL;
  }
  catch ( ... )
  {
