/*
 * XREFs of ??1ActivityToastNotificationCallback@ToastNotification@@UEAA@XZ @ 0x18006801C
 * Callers:
 *     ??_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z @ 0x180068670 (--_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z.c)
 * Callees:
