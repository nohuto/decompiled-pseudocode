/*
 * XREFs of _LXp_addh @ 0x18000DE78
 * Callers:
...
long double *__fastcall LXp_addh(long double *a1, int a2, double a3)
{
  ...
  long double *v30; // [rsp+30h] [rbp-20h]
  long double v31; // [rsp+38h] [rbp-18h] BYREF
...
LABEL_31:
    ...
    if ( v35 - 26 < (int)v19 )
    {
      ...
      LDint(&v34, v19);
      LDscale((__int16 *)&v34, (unsigned int)v32);
      v20 = a1[v3] - v34;
      a1[v3] = v20;
      if ( v20 == 0.0 )
      {
