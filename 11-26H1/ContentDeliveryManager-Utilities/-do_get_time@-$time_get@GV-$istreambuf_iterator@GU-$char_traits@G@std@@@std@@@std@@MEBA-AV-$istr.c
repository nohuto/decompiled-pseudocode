/*
 * XREFs of ?do_get_time@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x180018820
 * Callers:
 *     <none>
 * Callees:
  ...
  *a6 |= v15;
  if ( v17
    && (v18 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*(a3),
        (*(unsigned __int8 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v12 + 112LL))(v12, *v18, 0LL) == 58) )
  {
  ...
  if ( *v16
    || (v19 = (unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*(a3),
        (*(unsigned __int8 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v12 + 112LL))(v12, *v19, 0LL) != 58) )
  {
    *v16 |= 2u;
  }
  else
