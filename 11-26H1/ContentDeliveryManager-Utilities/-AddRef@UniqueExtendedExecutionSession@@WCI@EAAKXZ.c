/*
 * XREFs of ?AddRef@UniqueExtendedExecutionSession@@WCI@EAAKXZ @ 0x18008EED0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall UniqueExtendedExecutionSession::AddRef(__int64 a1, volatile int *a2)
{
