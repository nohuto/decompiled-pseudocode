        ...
        _QWORD *a3)
{
  ...
  while ( 1 )
  {
    ...
    v13 = v12[4];
    v14 = *(double *)(v11 + 32);
    if ( v14 == v13 && (!*((_BYTE *)v12 + 18) || *(double *)(v11 + 40) == v12[5]) )
    {
    ...
    else if ( v13 > v14 || v14 == v13 && v12[5] > *(double *)(v11 + 40) )
    {
      ++v6;
      v7 += 56LL;
LABEL_20:
    ...
    else if ( v14 > v13 || (v3 = a2, v14 == v13) && *(double *)(v11 + 40) > v12[5] )
    {
      ++v5;
      v8 += 16LL;
      goto LABEL_20;
