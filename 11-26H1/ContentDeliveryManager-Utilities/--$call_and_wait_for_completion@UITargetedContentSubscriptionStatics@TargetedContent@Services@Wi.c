 ...
 *     ??$wait_for_completion@PEAVTargetedContentSubscription@TargetedContent@Services@Windows@@V?$ComPtr@UITargetedContentSubscription@TargetedContent@Services@Windows@@@WRL@Microsoft@@@wil@@YA?AV?$ComPtr@UITargetedContentSubscription@TargetedContent@Services@Windows@@@WRL@Microsoft@@PEAU?$IAsyncOperation@PEAVTargetedContentSubscription@TargetedContent@Services@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@@Z @ 0x1800ADCD4 (--$wait_for_completion@PEAVTargetedContentSubscription@TargetedContent@Services@Windows@@V-$ComP.c)
 */
