/*
 * XREFs of ?do_put@?$num_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@AEAVios_base@2@G_N@Z @ 0x180019FB0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  if ( (*(_DWORD *)(a4 + 24) & 0x4000) != 0 )
  {
    ...
    *(_QWORD *)&v21 = v10;
    ...
    v11 = (__int64 *)std::use_facet<std::numpunct<unsigned short>>((std::locale *)&v21);
    if ( v10 )
    {
