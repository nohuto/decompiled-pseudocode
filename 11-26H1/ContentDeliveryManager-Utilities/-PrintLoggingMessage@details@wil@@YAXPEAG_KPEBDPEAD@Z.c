/*
 * XREFs of ?PrintLoggingMessage@details@wil@@YAXPEAG_KPEBDPEAD@Z @ 0x180035B24
 * Callers:
 ...
 *     ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x18003BCFC (-StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z.c)
