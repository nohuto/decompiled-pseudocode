/*
 * XREFs of ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180035C70
 * Callers:
 ...
 *     ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x180037010 (-Record@UsageIndexes@details_abi@wil@@QEAAXXZ.c)
