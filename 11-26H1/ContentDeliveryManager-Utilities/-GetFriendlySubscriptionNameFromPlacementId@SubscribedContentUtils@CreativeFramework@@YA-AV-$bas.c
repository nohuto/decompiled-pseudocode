/*
 * XREFs of ?GetFriendlySubscriptionNameFromPlacementId@SubscribedContentUtils@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W@Z @ 0x180096B04
 * Callers:
 ...
 *     ?GetSubscriptionIdByName@TargetedContent@CreativeFramework@@YAPEB_WPEB_W@Z @ 0x18009736C (-GetSubscriptionIdByName@TargetedContent@CreativeFramework@@YAPEB_WPEB_W@Z.c)
