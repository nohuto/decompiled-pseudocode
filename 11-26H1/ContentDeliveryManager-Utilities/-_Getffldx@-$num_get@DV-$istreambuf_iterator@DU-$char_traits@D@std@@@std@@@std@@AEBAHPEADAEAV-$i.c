/*
 * XREFs of ?_Getffldx@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x18000811C
 * Callers:
  ...
  *v16 = 30768;
  ...
  if ( !(unsigned __int8)std::istreambuf_iterator<char>::equal(a3, a4) )
  {
    if ( !*((_BYTE *)a3 + 8) )
    {
      v23 = *a3;
      if ( !*a3
        || ((v24 = **(unsigned __int8 ***)(v23 + 56)) == 0LL || **(int **)(v23 + 80) <= 0
    ...
    if ( *((_BYTE *)a3 + 9) == v109[0] )
    {
      ...
      if ( !*((_BYTE *)a3 + 8) )
      {
        v26 = *a3;
        if ( !*a3
          || ((v27 = **(unsigned __int8 ***)(v26 + 56)) == 0LL || **(int **)(v26 + 80) <= 0
            ? (v28 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v26 + 48LL))(v26))
            : (v28 = *v27),
              v28 == -1) )
        {
          *a3 = 0LL;
...
LABEL_49:
  ...
  if ( *(_BYTE *)v30 == 127 || *(char *)v30 <= 0 )
  {
    ...
    do
    {
      ...
      if ( v21 < 36 )
      {
        if ( v64 || v21 )
        {
          *v20++ = `std::num_get<char,std::istreambuf_iterator<char>>::_Getffldx'::`2'::_Src[v64];
          ++v21;
        }
      }
      else
  ...
  {
    if ( v107[2] )
      v31 = (*(__int64 (__fastcall **)(struct std::_Facet_base *))(*(_QWORD *)v11 + 32LL))(v11);
    else
      v31 = 0;
    v32 = 15LL;
    v106 = 15LL;
...
LABEL_114:
        ...
        else
        {
          ...
          if ( v36 < 36 )
          {
            if ( v42 || v36 )
            {
              *v20++ = `std::num_get<char,std::istreambuf_iterator<char>>::_Getffldx'::`2'::_Src[v42];
              ++v36;
            }
          }
          else
...
LABEL_119:
  ...
  if ( !(unsigned __int8)std::istreambuf_iterator<char>::equal(a3, v52) )
  {
    do
    {
      ...
      if ( v21 < 36 )
      {
        *v20++ = `std::num_get<char,std::istreambuf_iterator<char>>::_Getffldx'::`2'::_Src[v75];
        ++v21;
      }
      v53 = 1;
      std::istreambuf_iterator<char>::_Inc(a3);
...
LABEL_248:
  if ( !(unsigned __int8)std::istreambuf_iterator<char>::equal(a3, v52) )
  {
    do
    {
      ...
      if ( v80 < 8 )
      {
        *v20++ = `std::num_get<char,std::istreambuf_iterator<char>>::_Getffldx'::`2'::_Src[v93];
        ++v80;
      }
      v53 = 1;
      std::istreambuf_iterator<char>::_Inc(a3);
