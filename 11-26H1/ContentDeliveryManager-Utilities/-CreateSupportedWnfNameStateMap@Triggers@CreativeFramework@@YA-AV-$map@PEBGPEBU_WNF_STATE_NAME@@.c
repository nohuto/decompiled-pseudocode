/*
 * XREFs of ?CreateSupportedWnfNameStateMap@Triggers@CreativeFramework@@YA?AV?$map@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@@std@@XZ @ 0x18008D2B0
 * Callers:
...
__int64 *__fastcall CreativeFramework::Triggers::CreateSupportedWnfNameStateMap(__int64 *a1)
{
  ...
  AcquireSRWLockShared(&stru_1801803D8);
  v14 = &stru_1801803D8;
  if ( qword_180180578 )
  {
LABEL_9:
  ...
  ReleaseSRWLockShared(&stru_1801803D8);
  wil::last_error_context::~last_error_context((wil::last_error_context *)&v14);
  v14 = 0LL;
  AcquireSRWLockExclusive(&stru_1801803D8);
  v15 = &stru_1801803D8;
  if ( !qword_180180578 )
  {
    v6 = off_1800D5B78;
