/*
 * XREFs of ?CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z @ 0x1800A65B8
 * Callers:
 ...
 *     ??$query@UIStorageItem@Storage@Windows@@@?$com_ptr_t@UIStorageFile@Storage@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIStorageItem@Storage@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800A5ED8 (--$query@UIStorageItem@Storage@Windows@@@-$com_ptr_t@UIStorageFile@Storage@Windows@@Uerr_excepti.c)
...
__int64 __fastcall CopyFaviconToEdge(__int64 (__fastcall ***a1)(_QWORD, GUID *, _QWORD *), HSTRING *a2)
{
  ...
  newString = 0LL;
  v12 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v32, (const WCHAR **)off_1800DF3F0, v11);
  ...
  *v15 = 0LL;
  ...
  v17 = newString;
  v19 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v32, (const WCHAR **)off_1800DF3F8, v18);
