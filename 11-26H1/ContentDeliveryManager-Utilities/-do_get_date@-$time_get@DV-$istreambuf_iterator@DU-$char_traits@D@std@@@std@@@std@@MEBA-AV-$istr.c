/*
 * XREFs of ?do_get_date@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x18001F4E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( !v17 )
  {
    ...
    if ( (*(_BYTE *)(*((_QWORD *)v14 + 3) + 2LL * *(unsigned __int8 *)(a3 + 9)) & 4) != 0 )
    {
      if ( v16 == 2 )
      {
        v23 = (_DWORD *)(a7 + 16);
