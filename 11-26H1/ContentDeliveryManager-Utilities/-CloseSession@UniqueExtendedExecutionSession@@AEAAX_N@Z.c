/*
 * XREFs of ?CloseSession@UniqueExtendedExecutionSession@@AEAAX_N@Z @ 0x18008EEE0
 * Callers:
 *     ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x18008EBC0 (--1UniqueExtendedExecutionSession@@UEAA@XZ.c)
 *     ?OnSessionRevoked@UniqueExtendedExecutionSession@@QEAAJPEAUIInspectable@@PEAUIExtendedExecutionRevokedEventArgs@ExtendedExecution@ApplicationModel@Windows@@@Z @ 0x18008FEE0 (-OnSessionRevoked@UniqueExtendedExecutionSession@@QEAAJPEAUIInspectable@@PEAUIExtendedExecutionR.c)
 ...
 *     ?SHIsSameObject@@YAHPEAUIUnknown@@0@Z @ 0x180090C08 (-SHIsSameObject@@YAHPEAUIUnknown@@0@Z.c)
