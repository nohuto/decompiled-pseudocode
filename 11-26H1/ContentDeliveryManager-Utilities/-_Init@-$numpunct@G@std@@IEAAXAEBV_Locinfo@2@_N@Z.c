/*
 * XREFs of ?_Init@?$numpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x18005BD20
 * Callers:
 ...
 *     ??$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z @ 0x1800498B4 (--$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z.c)
...
wchar_t *__fastcall std::numpunct<unsigned short>::_Init(mbstate_t a1, __int64 a2, char a3)
{
  ...
  _Cvtvec v12; // [rsp+48h] [rbp-70h] BYREF
  _OWORD v13[3]; // [rsp+78h] [rbp-40h] BYREF

  v11 = a1;
  v5 = localeconv();
  v6 = Getcvt(&v12);
  v13[0] = *(_OWORD *)&v6->_Page;
  v13[1] = *(_OWORD *)&v6->_Isleadbyte[4];
  v13[2] = *(_OWORD *)&v6->_Isleadbyte[20];
  *(_QWORD *)(*(_QWORD *)&a1 + 16LL) = 0LL;
  *(_QWORD *)(*(_QWORD *)&a1 + 32LL) = 0LL;
  *(_QWORD *)(*(_QWORD *)&a1 + 40LL) = 0LL;
  Getcvt(&v12);
  grouping = (wchar_t *)&Str;
  if ( !a3 )
    grouping = (wchar_t *)v5->grouping;
  try
  {
    *(_QWORD *)(*(_QWORD *)&a1 + 16LL) = std::_Maklocstr<char>(grouping);
    *(_QWORD *)(*(_QWORD *)&a1 + 32LL) = std::_Maklocstr<unsigned short>("false", 0LL, (const _Cvtvec *)v13);
    *(_QWORD *)(*(_QWORD *)&a1 + 40LL) = std::_Maklocstr<unsigned short>("true", 0LL, (const _Cvtvec *)v13);
  }
  catch ( ... )
  {
  ...
  if ( a3 )
  {
    ...
    v10 = 0;
    v11._Wchar = 0;
    Mbrtowc(&v10, v9, 1uLL, &v11, (const _Cvtvec *)v13);
