/*
 * XREFs of ?do_put@?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@_NAEAVios_base@2@GAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@@Z @ 0x180018FB0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a7)
{
  ...
  *(_QWORD *)&v26 = v11;
  ...
  v12 = std::use_facet<std::ctype<unsigned short>>((std::locale *)&v26);
  if ( v11 )
  {
