/*
 * XREFs of ??1AppManager@ContentManagement@@UEAA@XZ @ 0x180074A84
 * Callers:
 *     ??_EAppManager@ContentManagement@@UEAAPEAXI@Z @ 0x180074FF0 (--_EAppManager@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
