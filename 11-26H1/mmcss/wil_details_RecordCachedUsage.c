/*
 * XREFs of wil_details_RecordCachedUsage @ 0x14000498C
 * Callers:
 *     wil_details_OnFeatureUsageProviderFlushNotification @ 0x14000DA50 (wil_details_OnFeatureUsageProviderFlushNotification.c)
 * Callees:
...
_DWORD *__fastcall wil_details_RecordCachedUsage(int a1, __int64 a2)
{
  ...
  v8 = (v6 - (char *)v9) >> 3;
  if ( v8 > 0 )
    return (_DWORD *)RtlRecordFeatureUsage(v9, v8);
  return result;
}
