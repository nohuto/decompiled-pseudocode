/*
 * XREFs of CiConfigInitialize @ 0x140010010
 * Callers:
...
__int64 CiConfigInitialize()
{
  ...
  *(_QWORD *)&ObjectAttributes.Attributes = 64LL;
  ObjectAttributes.ObjectName = (PUNICODE_STRING)0x140012110LL;
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    DWORD = CiConfigReadDWORD(KeyHandle, 0x140012090LL, 100LL);
    if ( DWORD - 10 > 0x5A )
      v2 = 20;
    else
      v2 = 10 * (DWORD / 0xA);
    ...
    {
      v3 = CiConfigReadDWORD(KeyHandle, 0x1400120A0LL, 10LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          v4);
      v5 = (unsigned __int8)CiConfigReadDWORD(KeyHandle, 0x140012080LL, 0LL) != 0;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          v5);
      v6 = CiConfigReadDWORD(KeyHandle, 0x1400120B0LL, 2LL);
      ...
      HIDWORD(WPP_MAIN_CB.Dpc.DpcData) = CiConfigReadDWORD(KeyHandle, 0x1400120C0LL, 1000000LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          DpcData_high);
      WPP_MAIN_CB.ActiveThreadCount = CiConfigReadDWORD(KeyHandle, 0x1400120D0LL, 10000LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          ActiveThreadCount);
      v9 = CiConfigReadDWORD(KeyHandle, 0x1400120E0LL, 100000LL);
      *(&WPP_MAIN_CB.ActiveThreadCount + 1) = v9;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          v9);
      v10 = CiConfigReadDWORD(KeyHandle, 0x1400120F0LL, 32LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          v10);
      v11 = CiConfigReadDWORD(KeyHandle, 0x140012100LL, 256LL);
      ...
      ObjectAttributes.ObjectName = (PUNICODE_STRING)0x140012120LL;
