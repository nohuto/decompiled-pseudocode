/*
 * XREFs of memset @ 0x140005C40
 * Callers:
 *     RtlSetVolatileMemory @ 0x140005830 (RtlSetVolatileMemory.c)
 *     memset$thunk$772440563353939046 @ 0x140007040 (memset$thunk$772440563353939046.c)
