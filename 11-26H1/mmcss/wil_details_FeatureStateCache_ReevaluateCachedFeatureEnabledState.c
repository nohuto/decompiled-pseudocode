/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x140005260
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1400053B0 (wil_details_GetCurrentFeatureEnabledState.c)
 *     wil_details_IsEnabledFallback @ 0x140005508 (wil_details_IsEnabledFallback.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1400053B0 (wil_details_GetCurrentFeatureEnabledState.c)
