/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x140005174
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x1400050F8 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x140004F74 (wil_details_FeatureReporting_RecordUsageInCache.c)
...
__int64 __fastcall wil_details_FeatureReporting_ReportUsageToServiceDirect(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = wil_details_FeatureReporting_RecordUsageInCache(
         (__int64)v10,
         (volatile signed __int32 *)&Feature_229060921__private_reporting,
         a3,
         SHIDWORD(a2));
  v6 = 0;
  v11 = *(_OWORD *)v5;
  ...
  if ( g_wil_details_recordFeatureUsage )
    g_wil_details_recordFeatureUsage(59782941LL, v4, 1LL, &Feature_229060921__private_reporting, &v11);
