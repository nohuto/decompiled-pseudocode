/*
 * XREFs of wil_details_IsEnabledFallback @ 0x140005508
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x140005368 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
