/*
 * XREFs of CiThreadCreate @ 0x14000E900
 * Callers:
 ...
 *     CiThreadInsertInTree @ 0x140003AF0 (CiThreadInsertInTree.c)
 *     CiTaskIndexDereference @ 0x140003BB0 (CiTaskIndexDereference.c)
 *     CiTryIncrementTotalThreadCount @ 0x140003DC0 (CiTryIncrementTotalThreadCount.c)
 ...
 *     CiProcessAddThread @ 0x14000EE90 (CiProcessAddThread.c)
  ...
  *(_BYTE *)(v11 + 104) = *(_BYTE *)v3;
  ...
  if ( v21 != v18 )
  {
    ...
    if ( InformationThread < 0 )
    {
      ...
      if ( InformationThread != -1073741811 || (~qword_14000A330 & v21) != 0 )
        goto LABEL_19;
    }
  }
