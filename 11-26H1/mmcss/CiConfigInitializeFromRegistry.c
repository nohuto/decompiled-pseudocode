/*
 * XREFs of CiConfigInitializeFromRegistry @ 0x1400112E0
 * Callers:
 ...
 *     CiConfigTaskPolicy @ 0x140011240 (CiConfigTaskPolicy.c)
 */
...
__int64 __fastcall CiConfigInitializeFromRegistry(HANDLE KeyHandle)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( Src < 0x80 )
    {
      Pool2 = (WCHAR *)ExAllocatePool2(64LL, 2LL * (Src + 1), 1953658433LL);
      v5 = Pool2;
      if ( Pool2 )
      {
        memmove(Pool2, Src_4, Src);
