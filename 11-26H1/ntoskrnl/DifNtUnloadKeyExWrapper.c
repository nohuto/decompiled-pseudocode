/*
 * XREFs of DifNtUnloadKeyExWrapper @ 0x140693CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnloadKeyExWrapper(POBJECT_ATTRIBUTES TargetKey, HANDLE Event)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(810);
  ...
  DWORD2(v16) = NtUnloadKeyEx(TargetKey, Event);
  if ( v6 )
  {
