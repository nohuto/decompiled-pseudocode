/*
 * XREFs of DifNtQueueApcThreadWrapper @ 0x140687280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueueApcThreadWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtQueueApcThread(a1, a2, a3, a4, a5);
  if ( v10 )
  {
