/*
 * XREFs of DifNtCreateJobObjectWrapper @ 0x140674F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateJobObjectWrapper(
        PHANDLE JobHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtCreateJobObject(JobHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
