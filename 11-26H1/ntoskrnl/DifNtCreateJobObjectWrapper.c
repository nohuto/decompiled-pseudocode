/*
 * XREFs of DifNtCreateJobObjectWrapper @ 0x140671350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateJobObjectWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtCreateJobObject(a1, a2, a3);
  if ( v8 )
  {
