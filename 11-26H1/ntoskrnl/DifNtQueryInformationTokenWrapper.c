/*
 * XREFs of DifNtQueryInformationTokenWrapper @ 0x140687200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationTokenWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(485);
  ...
  LODWORD(v21) = NtQueryInformationToken(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
