/*
 * XREFs of DifZwImpersonateClientOfPortWrapper @ 0x1406A8350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwImpersonateClientOfPortWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwImpersonateClientOfPort(a1, a2);
  if ( v6 )
  {
