/*
 * XREFs of DifZwImpersonateClientOfPortWrapper @ 0x1406ABF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwImpersonateClientOfPortWrapper(HANDLE PortHandle, PPORT_MESSAGE Message)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(955);
  ...
  DWORD2(v16) = ZwImpersonateClientOfPort(PortHandle, Message);
  if ( v6 )
  {
