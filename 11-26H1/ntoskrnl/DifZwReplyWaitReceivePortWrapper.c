/*
 * XREFs of DifZwReplyWaitReceivePortWrapper @ 0x1406B7810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplyWaitReceivePortWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = ZwReplyWaitReceivePort(
                  a1,
                  a2,
                  a3,
                  a4,
