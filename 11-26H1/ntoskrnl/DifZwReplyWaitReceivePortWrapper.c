/*
 * XREFs of DifZwReplyWaitReceivePortWrapper @ 0x1406BB3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplyWaitReceivePortWrapper(void *a1, PVOID *a2, _PORT_MESSAGE *a3, _PORT_MESSAGE *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(953);
  ...
  DWORD2(v20) = ZwReplyWaitReceivePort(a1, a2, a3, a4);
  if ( v9 )
  {
