/*
 * XREFs of sub_1408391D8 @ 0x1408391D8
 * Callers:
...
__int64 __fastcall sub_1408391D8(__int64 a1, const void *a2, _DWORD *a3, void *a4, unsigned int a5, _DWORD *a6)
{
  void *v8; // rax
  ...
  v8 = bsearch(
         ...
         *(unsigned int *)(a1 + 46824),
         0x10uLL,
         (int (__cdecl *)(const void *, const void *))sub_140838A90);
  if ( v8 )
  {
