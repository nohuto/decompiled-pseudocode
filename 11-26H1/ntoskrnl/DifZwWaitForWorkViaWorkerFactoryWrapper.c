/*
 * XREFs of DifZwWaitForWorkViaWorkerFactoryWrapper @ 0x1406C3540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWaitForWorkViaWorkerFactoryWrapper(
        void *a1,
        ...
        _WORKER_FACTORY_DEFERRED_WORK *DeferredWork)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1117);
  ...
  LODWORD(v21) = ZwWaitForWorkViaWorkerFactory(a1, a2, a3, a4, DeferredWork);
  if ( v10 )
  {
