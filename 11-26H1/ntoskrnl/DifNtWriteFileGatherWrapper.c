/*
 * XREFs of DifNtWriteFileGatherWrapper @ 0x140695560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWriteFileGatherWrapper(
        void *a1,
        void *a2,
...
LABEL_17:
  v31 = NtWriteFileGather(a1, a2, a3, a4, IoStatusBlock, SegmentArray, Length, ByteOffset, Key);
  if ( v14 )
  {
