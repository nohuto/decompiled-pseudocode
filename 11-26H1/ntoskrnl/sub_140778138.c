/*
 * XREFs of sub_140778138 @ 0x140778138
 * Callers:
...
__int64 __fastcall sub_140778138(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // edx
  unsigned int *v7; // rax
  unsigned int i; // edx
        ...
        if ( v7 )
        {
          if ( *(_DWORD *)a1 > 3u )
          {
            ...
            if ( v10 >= v7 )
            {
              ...
              {
                if ( stru_140EF49E0.Header.SignalState || !LODWORD(ExpPlatformBinaryLock.WaitStatus) )
                {
                  v14 = MEMORY[0xFFFFF78000000320];
                  TimeIncrement = KeQueryTimeIncrement();
                  LODWORD(ExpPlatformBinaryLock.WaitStatus) = 1;
