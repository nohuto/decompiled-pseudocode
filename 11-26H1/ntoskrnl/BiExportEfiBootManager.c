/*
 * XREFs of BiExportEfiBootManager @ 0x140B37EA8
 * Callers:
...
__int64 __fastcall BiExportEfiBootManager(__int64 a1, __int64 **a2)
{
  ...
  HANDLE v25; // [rsp+38h] [rbp-41h] BYREF
  ...
  Element = BiGetElement((__int64)v25, 603979777LL, &P, &v22);
  v8 = Element;
  if ( Element >= 0 )
  {
    v22 >>= 4;
...
LABEL_41:
    ...
    v12 = v31;
    BiTranslateDisplayOrder((__int64)v31, (__int64)P, (__int64)Pool2, &v22);
LABEL_11:
    ...
    *(_QWORD *)&v35 = 0x1800000001LL;
    v16 = BiGetElement((__int64)v25, 620756996LL, &v33, &v30);
    v4 = v33;
    v8 = v16;
    if ( v16 < 0 )
    {
    ...
    v18 = BiGetElement((__int64)v25, 603979778LL, &v23, &v24);
    v8 = v18;
    if ( v18 >= 0 )
    {
      v2 = v23;
