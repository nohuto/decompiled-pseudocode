/*
 * XREFs of DifZwOpenKeyExWrapper @ 0x1406AFA30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenKeyExWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(82);
  ...
  DWORD2(v20) = ZwOpenKeyEx(a1, a2, a3, a4);
  if ( v9 )
  {
