/*
 * XREFs of DifZwLockProductActivationKeysWrapper @ 0x1406AD290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwLockProductActivationKeysWrapper(ULONG *pPrivateVer, ULONG *pSafeMode)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1097);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = pPrivateVer;
    *((_QWORD *)&v15 + 1) = pSafeMode;
  ...
  DWORD2(v16) = ZwLockProductActivationKeys(pPrivateVer, pSafeMode);
  if ( v6 )
  {
