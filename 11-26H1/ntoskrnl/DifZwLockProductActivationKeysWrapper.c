/*
 * XREFs of DifZwLockProductActivationKeysWrapper @ 0x1406A96B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwLockProductActivationKeysWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwLockProductActivationKeys(a1, a2);
  if ( v6 )
  {
