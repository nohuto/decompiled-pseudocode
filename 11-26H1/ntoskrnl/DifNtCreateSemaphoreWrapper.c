/*
 * XREFs of DifNtCreateSemaphoreWrapper @ 0x140677530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateSemaphoreWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        LONG MaximumCount)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(692);
  ...
  DWORD2(v21) = NtCreateSemaphore(a1, a2, a3, a4, MaximumCount);
  if ( v10 )
  {
