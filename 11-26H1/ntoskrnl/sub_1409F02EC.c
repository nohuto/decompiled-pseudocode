/*
 * XREFs of sub_1409F02EC @ 0x1409F02EC
 * Callers:
 ...
 *     sub_1409F04FC @ 0x1409F04FC (sub_1409F04FC.c)
 */

__int64 __fastcall sub_1409F02EC(__int64 a1, unsigned int a2, int a3, struct _KLOCK_ENTRIES *a4)
{
...
LABEL_10:
  ...
  if ( a2 != -1 )
  {
    ...
    if ( (unsigned int)sub_1409F04FC(a1, a2, v9) == -1 )
    {
