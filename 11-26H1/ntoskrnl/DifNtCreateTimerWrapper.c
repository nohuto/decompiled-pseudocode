/*
 * XREFs of DifNtCreateTimerWrapper @ 0x1406743A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateTimerWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
