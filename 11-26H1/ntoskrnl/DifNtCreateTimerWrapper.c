/*
 * XREFs of DifNtCreateTimerWrapper @ 0x140677F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateTimerWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, TIMER_TYPE a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(696);
  ...
  DWORD2(v20) = NtCreateTimer(a1, a2, a3, a4);
  if ( v9 )
  {
