/*
 * XREFs of IopXxxControlFile @ 0x1408F5EA0
 * Callers:
 *     NtFsControlFile @ 0x1408F5DC0 (NtFsControlFile.c)
 ...
 *     IopIsStandardFsctlIoControlCode @ 0x14046DCB0 (IopIsStandardFsctlIoControlCode.c)
