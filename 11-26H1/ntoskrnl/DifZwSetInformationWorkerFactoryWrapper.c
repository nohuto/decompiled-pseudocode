/*
 * XREFs of DifZwSetInformationWorkerFactoryWrapper @ 0x1406BEE80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationWorkerFactoryWrapper(void *a1, WORKERFACTORYINFOCLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1118);
  ...
  DWORD2(v20) = ZwSetInformationWorkerFactory(a1, a2, a3, a4);
  if ( v9 )
  {
