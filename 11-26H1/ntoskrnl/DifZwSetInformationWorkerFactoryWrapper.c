/*
 * XREFs of DifZwSetInformationWorkerFactoryWrapper @ 0x1406BB2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationWorkerFactoryWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = ZwSetInformationWorkerFactory(
                  a1,
                  a2,
                  a3,
                  a4,
