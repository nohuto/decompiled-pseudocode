/*
 * XREFs of CcLazyWriteScan @ 0x1404FB788
 * Callers:
 ...
 *     CcAdjustThrottleForPartition @ 0x1405B0AC4 (CcAdjustThrottleForPartition.c)
...
LABEL_75:
  ...
  *(_QWORD *)(a2 + 216) = MEMORY[0xFFFFF78000000014];
  ...
  v62 = 0LL;
  v72 = 0LL;
  if ( !(_BYTE)dword_140FBE22C && !v60 && *(_QWORD *)(a1 + 1168) == a1 + 1168 )
  {
