/*
 * XREFs of DifMmUnmapIoSpaceWrapper @ 0x14066C3C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmUnmapIoSpaceWrapper(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(211);
  ...
  MiUnmapContiguousMemory(a1, a2, 1);
  if ( v6 )
  {
