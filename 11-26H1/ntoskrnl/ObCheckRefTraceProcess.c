/*
 * XREFs of ObCheckRefTraceProcess @ 0x140984928
 * Callers:
...
NTSTATUS __fastcall ObCheckRefTraceProcess(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    v6 = (AutoBoost *)KeAbPreAcquire((__int64)&stru_140F132C8, 0LL, 0LL, v4);
    v8 = _interlockedbittestandset64(&stru_140F132C8.Header.Lock, 0LL);
    v9 = v6;
    if ( v8 )
      ExfAcquirePushLockExclusiveEx((unsigned __int64 *)&stru_140F132C8, v6, (__int64)&stru_140F132C8);
    if ( v9 )
    {
    ...
    if ( (ObpTraceFlags & 0x20) != 0 && RtlPrefixUnicodeString(&String1, (PCUNICODE_STRING)stru_140F132C8.NpxState, 1u) )
