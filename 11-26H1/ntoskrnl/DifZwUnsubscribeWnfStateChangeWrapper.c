/*
 * XREFs of DifZwUnsubscribeWnfStateChangeWrapper @ 0x1406BEB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnsubscribeWnfStateChangeWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = ZwUnsubscribeWnfStateChange(a1);
  if ( v4 )
  {
