/*
 * XREFs of DifZwUnsubscribeWnfStateChangeWrapper @ 0x1406C2750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnsubscribeWnfStateChangeWrapper(PCWNF_STATE_NAME StateName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1056);
  ...
  LODWORD(v14) = ZwUnsubscribeWnfStateChange(StateName);
  if ( v4 )
  {
