/*
 * XREFs of DifPoFxReportDevicePoweredOnWrapper @ 0x140697500
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxReportDevicePoweredOnWrapper(ULONG_PTR BugCheckParameter2)
{
  ...
  PopFxHandleReportDevicePoweredOn(BugCheckParameter2);
  if ( v4 )
  {
