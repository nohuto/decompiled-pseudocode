/*
 * XREFs of DifZwSetIoCompletionWrapper @ 0x1406BF1C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetIoCompletionWrapper(
        void *a1,
        void *a2,
        void *a3,
        NTSTATUS a4,
        ULONG_PTR IoStatusInformation)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v20 + 1) = a1;
    *((_QWORD *)&v18 + 1) = IoStatusInformation;
    *(_QWORD *)&v20 = a2;
    *((_QWORD *)&v19 + 1) = a3;
    LODWORD(v19) = a4;
  ...
  LODWORD(v21) = ZwSetIoCompletion(a1, a2, a3, a4, IoStatusInformation);
  if ( v10 )
  {
