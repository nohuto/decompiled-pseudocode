/*
 * XREFs of DifZwSetIoCompletionWrapper @ 0x1406BB5E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetIoCompletionWrapper(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(986);
  ...
  LODWORD(v21) = ZwSetIoCompletion(a1, a2, a3, a4, a5);
  if ( v10 )
  {
