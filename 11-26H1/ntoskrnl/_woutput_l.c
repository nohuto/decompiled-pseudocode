...
__int64 __fastcall woutput_l(__int64 a1, unsigned __int16 *a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  _WORD v56[2]; // [rsp+54h] [rbp-ACh] BYREF
...
LABEL_87:
              ...
              v49 &= -(v25 != 0);
              v27 = v49;
              for ( j = (wchar_t *)&v64; ; j = (wchar_t *)((char *)j - 1) )
              {
                v29 = v6--;
                if ( v29 <= 0 && !v25 )
                  break;
              ...
              LODWORD(v12) = (unsigned int)&v63 + 383 - (_DWORD)j;
              v50 = v6;
              v7 = (wchar_t *)((char *)j + 1);
              if ( (v5 & 0x200) != 0 )
              {
                if ( !(_DWORD)v12 || (v49 = v27, *(_BYTE *)v7 != 48) )
                {
                  v7 = j;
                  LODWORD(v12) = v12 + 1;
                  v49 = v27;
