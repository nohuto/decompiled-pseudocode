/*
 * XREFs of DifMmUnmapLockedPagesWrapper @ 0x14066C530
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmUnmapLockedPagesWrapper(PVOID BaseAddress, PMDL MemoryDescriptorList)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(210);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    v15 = BaseAddress;
    *((_QWORD *)&v14 + 1) = MemoryDescriptorList;
