/*
 * XREFs of MiCaptureImageHeaderFieldsForPeb @ 0x140ACAAB8
 * Callers:
...
__int64 __fastcall MiCaptureImageHeaderFieldsForPeb(__int64 a1)
{
  ...
  *(_WORD *)a1 = ((*(__int16 *)(v4 + 12) >> 15) & 0xFF00) + 523;
  ...
  if ( !v8 )
    return 3221225776LL;
  *(_DWORD *)(a1 + 44) = RtlReadULongFromUser(v8 + 19);
  v9 = RtlImageDirectoryEntryToData(v7, 1, 0xAu, &v27);
  ...
  if ( v9 )
  {
    ...
    v24[0] = v9 - v7;
    v24[1] = v27;
    if ( (int)MiImageLoadConfigSize((unsigned int)&v28, v7, v23, (unsigned int)v24, *(_WORD *)a1) < 0 )
      return 3221225776LL;
...
LABEL_15:
  ...
  if ( (v6 & 0x4000) != 0 )
  {
    ...
    v20 = _InterlockedIncrement((volatile signed __int32 *)&stru_140E2D150.Padding[4]);
