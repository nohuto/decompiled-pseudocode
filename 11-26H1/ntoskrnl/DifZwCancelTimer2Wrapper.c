/*
 * XREFs of DifZwCancelTimer2Wrapper @ 0x1406A06B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCancelTimer2Wrapper(HANDLE TimerHandle, PT2_CANCEL_PARAMETERS Parameters)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1020);
  ...
  DWORD2(v16) = ZwCancelTimer2(TimerHandle, Parameters);
  if ( v6 )
  {
