/*
 * XREFs of DifZwCreateSemaphoreWrapper @ 0x1406A5920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateSemaphoreWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        LONG MaximumCount)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1010);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *(_QWORD *)&v21 = a1;
    *((_QWORD *)&v19 + 1) = __PAIR64__(a4, MaximumCount);
    DWORD2(v20) = a2;
    *(_QWORD *)&v20 = a3;
  ...
  DWORD2(v21) = ZwCreateSemaphore(a1, a2, a3, a4, MaximumCount);
  if ( v10 )
  {
