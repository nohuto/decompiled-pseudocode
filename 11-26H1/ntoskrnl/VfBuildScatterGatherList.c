/*
 * XREFs of VfBuildScatterGatherList @ 0x140C23A10
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *(_DWORD *)(AdapterInformationInternal + 224) == 3 )
    {
      ...
      if ( v10 )
      {
        ...
        ViHalPreprocessOptions(
          ...
          0LL,
          0LL);
        VfReportIssueWithOptions(0xE6u, 0x24uLL, v11, 0LL, 0LL, byte_140E0EAA4);
        v9 = v33;
      }
    }
    if ( ViDoubleBufferDma )
    {
      v12 = (PVOID **)ExAllocateFromNPagedLookasideList((PPAGED_LOOKASIDE_LIST)&stru_140E27B08.AffinityVersion);
      v3 = v12;
      if ( v12 )
      {
        v13 = v34;
