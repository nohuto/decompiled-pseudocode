/*
 * XREFs of DifNtSinglePhaseRejectWrapper @ 0x140692A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSinglePhaseRejectWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(844);
  ...
  DWORD2(v16) = NtSinglePhaseReject(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
