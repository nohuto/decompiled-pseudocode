/*
 * XREFs of DifNtOpenThreadTokenExWrapper @ 0x140682E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenThreadTokenExWrapper(void *a1, ACCESS_MASK a2, BOOLEAN a3, ULONG a4, HANDLE *TokenHandle)
{
  ...
  DWORD2(v21) = NtOpenThreadTokenEx(a1, a2, a3, a4, TokenHandle);
  if ( v10 )
  {
