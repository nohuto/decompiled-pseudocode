/*
 * XREFs of DifNtQueryVirtualMemoryWrapper @ 0x14068A440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryVirtualMemoryWrapper(
        void *a1,
        void *a2,
        ...
        ULONG_PTR *ReturnLength)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(756);
...
LABEL_17:
  VirtualMemory = NtQueryVirtualMemory(a1, a2, a3, a4, MemoryInformationLength, ReturnLength);
  if ( v11 )
  {
