/*
 * XREFs of DifNtDeviceIoControlFileWrapper @ 0x140679CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDeviceIoControlFileWrapper(
        void *a1,
        void *a2,
        ...
        ULONG OutputBufferLength)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(612);
