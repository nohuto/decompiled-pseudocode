/*
 * XREFs of DifNtCreateDebugObjectWrapper @ 0x140673CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateDebugObjectWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(861);
  ...
  DWORD2(v20) = NtCreateDebugObject(a1, a2, a3, a4);
  if ( v9 )
  {
