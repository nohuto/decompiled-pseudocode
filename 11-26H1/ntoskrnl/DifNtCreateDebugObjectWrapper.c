/*
 * XREFs of DifNtCreateDebugObjectWrapper @ 0x140670100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateDebugObjectWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtCreateDebugObject(
                  a1,
                  a2,
                  a3,
                  a4,
