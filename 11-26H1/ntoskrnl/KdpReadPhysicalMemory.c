...
__int64 __fastcall KdpReadPhysicalMemory(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)a1 == 12642 )
  {
    ...
    v13 = MmDbgCopyMemory(*(_QWORD *)(a1 + 16), *(_QWORD *)(a2 + 8), v4, 0, v9);
    if ( v13 < 0 )
      LODWORD(v4) = 0;
  }
  else
  {
    v13 = KdpCopyMemoryChunks(*(_QWORD *)(a1 + 16), *(_QWORD *)(a2 + 8), v4, 0, v9, (__int64)&v16);
    LODWORD(v4) = v16;
  }
  *(_DWORD *)(a1 + 8) = v13;
  *(_DWORD *)(a1 + 28) = v4;
