/*
 * XREFs of DifZwExtendSectionWrapper @ 0x1406A96E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwExtendSectionWrapper(HANDLE SectionHandle, PLARGE_INTEGER NewSectionSize)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1072);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = SectionHandle;
    *((_QWORD *)&v15 + 1) = NewSectionSize;
  ...
  DWORD2(v16) = ZwExtendSection(SectionHandle, NewSectionSize);
  if ( v6 )
  {
