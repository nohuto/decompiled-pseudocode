/*
 * XREFs of DifNtSignalAndWaitForSingleObjectWrapper @ 0x1406928F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSignalAndWaitForSingleObjectWrapper(void *a1, void *a2, BOOLEAN a3, LARGE_INTEGER *a4)
{
  ...
  DWORD2(v20) = NtSignalAndWaitForSingleObject(a1, a2, a3, a4);
  if ( v9 )
  {
