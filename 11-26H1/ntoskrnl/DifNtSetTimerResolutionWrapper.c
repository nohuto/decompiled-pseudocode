/*
 * XREFs of DifNtSetTimerResolutionWrapper @ 0x14068E3A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetTimerResolutionWrapper(unsigned int a1, char a2, __int64 a3)
{
  ...
  LOBYTE(v7) = a2;
  DWORD2(v18) = NtSetTimerResolution(a1, v7, a3);
  if ( v8 )
  {
