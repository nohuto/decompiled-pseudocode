/*
 * XREFs of DifNtSetTimerResolutionWrapper @ 0x140691F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetTimerResolutionWrapper(ULONG DesiredTime, BOOLEAN a2, ULONG *a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(710);
  ...
  DWORD2(v18) = NtSetTimerResolution(DesiredTime, a2, a3);
  if ( v8 )
  {
