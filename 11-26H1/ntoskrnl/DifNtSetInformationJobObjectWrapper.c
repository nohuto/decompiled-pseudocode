/*
 * XREFs of DifNtSetInformationJobObjectWrapper @ 0x14068F9E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationJobObjectWrapper(void *a1, JOBOBJECTINFOCLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(562);
  ...
  DWORD2(v20) = NtSetInformationJobObject(a1, a2, a3, a4);
  if ( v9 )
  {
