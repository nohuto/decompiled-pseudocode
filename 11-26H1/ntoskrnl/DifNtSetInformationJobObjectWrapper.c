/*
 * XREFs of DifNtSetInformationJobObjectWrapper @ 0x14068BE00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationJobObjectWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtSetInformationJobObject(
                  a1,
                  a2,
                  a3,
                  a4,
