/*
 * XREFs of __asan_storeN_volatile @ 0x1405E3F00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_storeN_volatile(ULONG_PTR BugCheckParameter1, ULONG_PTR a2)
{
...
LABEL_8:
    ...
    if ( KcsaniValidationEnabled )
      KcsanValidateAddress(BugCheckParameter1, a2, 1, 1, retaddr);
  }
}
