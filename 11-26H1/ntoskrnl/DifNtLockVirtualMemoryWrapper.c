/*
 * XREFs of DifNtLockVirtualMemoryWrapper @ 0x14067EC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLockVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, ULONG a4)
{
  ...
  DWORD2(v20) = NtLockVirtualMemory(a1, a2, a3, a4);
  if ( v9 )
  {
