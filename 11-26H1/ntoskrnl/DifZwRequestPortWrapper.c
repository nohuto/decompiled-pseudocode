/*
 * XREFs of DifZwRequestPortWrapper @ 0x1406BB6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRequestPortWrapper(HANDLE PortHandle, PPORT_MESSAGE RequestMessage)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(950);
  ...
  DWORD2(v16) = ZwRequestPort(PortHandle, RequestMessage);
  if ( v6 )
  {
