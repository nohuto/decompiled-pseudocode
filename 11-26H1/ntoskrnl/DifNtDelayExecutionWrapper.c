/*
 * XREFs of DifNtDelayExecutionWrapper @ 0x140679430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDelayExecutionWrapper(BOOLEAN a1, LARGE_INTEGER *a2)
{
  ...
  HIDWORD(v16) = NtDelayExecution(a1, a2);
  if ( v6 )
  {
