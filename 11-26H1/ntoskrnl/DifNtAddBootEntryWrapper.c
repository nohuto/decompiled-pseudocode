/*
 * XREFs of DifNtAddBootEntryWrapper @ 0x14066DF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAddBootEntryWrapper(PBOOT_ENTRY BootEntry, PULONG Id)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(663);
  ...
  DWORD2(v16) = NtAddBootEntry(BootEntry, Id);
  if ( v6 )
  {
