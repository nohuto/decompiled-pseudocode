/*
 * XREFs of DifKeTryToAcquireGuardedMutexWrapper @ 0x1406686D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeTryToAcquireGuardedMutexWrapper(PFAST_MUTEX FastMutex)
{
  ...
  LOBYTE(v14) = ExTryToAcquireFastMutex(FastMutex);
  if ( v4 )
  {
