/*
 * XREFs of ?SmFeAddComplete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KKK@Z @ 0x14027F190
 * Callers:
...
LABEL_28:
  ...
  if ( (a5 & 2) == 0 )
  {
    ...
    if ( v27->SpecialApcDisable++ == -1
      && ($7A85BAF4F1FA08634C1C4A3E45B775B3 *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
    {
