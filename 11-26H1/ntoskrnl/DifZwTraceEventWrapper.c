/*
 * XREFs of DifZwTraceEventWrapper @ 0x1406C16E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwTraceEventWrapper(void *a1, ULONG a2, ULONG a3, void *a4)
{
  ...
  LODWORD(v19) = ZwTraceEvent(a1, a2, a3, a4);
  if ( v9 )
  {
