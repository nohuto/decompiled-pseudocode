/*
 * XREFs of DifNtSetInformationSymbolicLinkWrapper @ 0x1406901C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationSymbolicLinkWrapper(void *a1, SYMBOLIC_LINK_INFO_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(528);
  ...
  DWORD2(v20) = NtSetInformationSymbolicLink(a1, a2, a3, a4);
  if ( v9 )
  {
