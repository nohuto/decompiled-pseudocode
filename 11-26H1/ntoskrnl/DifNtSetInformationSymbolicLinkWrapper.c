/*
 * XREFs of DifNtSetInformationSymbolicLinkWrapper @ 0x14068C5E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationSymbolicLinkWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtSetInformationSymbolicLink(
                  a1,
                  a2,
                  a3,
                  a4,
