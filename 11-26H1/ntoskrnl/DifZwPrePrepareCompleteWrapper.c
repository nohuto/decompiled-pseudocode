/*
 * XREFs of DifZwPrePrepareCompleteWrapper @ 0x1406B2340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPrePrepareCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1107);
  ...
  DWORD2(v16) = ZwPrePrepareComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
