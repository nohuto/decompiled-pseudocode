/*
 * XREFs of DifZwSetEventExWrapper @ 0x1406BD0A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetEventExWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1000);
  ...
  LODWORD(v19) = ZwSetEventEx(a1, a2, a3);
  if ( v8 )
  {
