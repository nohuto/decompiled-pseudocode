/*
 * XREFs of DifZwSetInformationResourceManagerWrapper @ 0x1406BE370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationResourceManagerWrapper(
        void *a1,
        ...
        ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1112);
  ...
  DWORD2(v20) = ZwSetInformationResourceManager(a1, a2, a3, a4);
  if ( v9 )
  {
