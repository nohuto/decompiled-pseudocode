/*
 * XREFs of DifZwReplacePartitionUnitWrapper @ 0x1406BAF50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplacePartitionUnitWrapper(
        ...
        ULONG Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1101);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = TargetInstancePath;
    *(_QWORD *)&v18 = SpareInstancePath;
    DWORD2(v17) = Flags;
  ...
  LODWORD(v19) = ZwReplacePartitionUnit(TargetInstancePath, SpareInstancePath, Flags);
  if ( v8 )
  {
