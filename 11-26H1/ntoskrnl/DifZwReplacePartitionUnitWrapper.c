/*
 * XREFs of DifZwReplacePartitionUnitWrapper @ 0x1406B7370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplacePartitionUnitWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = ZwReplacePartitionUnit(a1, a2, a3);
  if ( v8 )
  {
