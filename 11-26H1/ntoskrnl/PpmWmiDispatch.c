/*
 * XREFs of PpmWmiDispatch @ 0x140A91490
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall PpmWmiDispatch(int a1, __int64 *a2, unsigned int a3, _DWORD *a4, __int64 a5, int *a6)
{
  ...
  if ( a1 > 5 )
  {
    if ( a1 == 8 )
    {
      result = PpmWmiRegisterInfo(*(_DWORD *)(a5 - 35092), (__int64)a2, a3, a4, a6);
LABEL_6:
      if ( result < 0 )
        return result;
      return 0;
  ...
  if ( a1 != 5 )
  {
    if ( !a1 )
    {
      v7 = 1;
LABEL_5:
      result = PpmWmiGetAllData((int)a5 - 248, (_DWORD)a2, a3, (_DWORD)a4, (__int64)a6, v7);
      goto LABEL_6;
    }
    v9 = a1 - 1;
    if ( !v9 )
