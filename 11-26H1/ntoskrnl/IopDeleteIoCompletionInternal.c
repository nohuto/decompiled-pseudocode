/*
 * XREFs of IopDeleteIoCompletionInternal @ 0x1403DC1DC
 * Callers:
 *     IopCloseIoCompletion @ 0x140ABC310 (IopCloseIoCompletion.c)
 *     IopDeleteIoCompletion @ 0x140ADEA60 (IopDeleteIoCompletion.c)
 * Callees:
