/*
 * XREFs of DifZwCreateIoRingWrapper @ 0x14069F5A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateIoRingWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  LODWORD(v21) = ZwCreateIoRing(a1, a2, a3, a4, a5);
  if ( v10 )
  {
