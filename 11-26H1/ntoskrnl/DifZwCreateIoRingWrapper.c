/*
 * XREFs of DifZwCreateIoRingWrapper @ 0x1406A3180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateIoRingWrapper(HANDLE *a1, ULONG a2, void *a3, ULONG a4, PVOID OutputParameters)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1129);
  ...
  LODWORD(v21) = ZwCreateIoRing(a1, a2, a3, a4, OutputParameters);
  if ( v10 )
  {
