/*
 * XREFs of DifZwRestoreKeyWrapper @ 0x1406BBCD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRestoreKeyWrapper(HANDLE KeyHandle, HANDLE FileHandle, ULONG Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(26);
  ...
  LODWORD(v19) = ZwRestoreKey(KeyHandle, FileHandle, Flags);
  if ( v8 )
  {
