/*
 * XREFs of sub_1407771E4 @ 0x1407771E4
 * Callers:
...
__int64 __fastcall sub_1407771E4(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // edx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
        ...
        if ( *(_DWORD *)a1 > 3u )
        {
          ...
          if ( *(_DWORD *)a1 > 4u )
          {
            ...
            if ( v17 >= v8 )
            {
              ...
              if ( (_DWORD)v16 )
                v18 = (__int64)v17;
              v19 = ExpPlatformBinaryLock.SavedApcState.ApcListHead[1].Flink
