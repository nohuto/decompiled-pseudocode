/*
 * XREFs of ?SmStUnhandledExceptionFilter@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAXPEAU_EXCEPTION_POINTERS@@W4_SMST_STORE_EXCEPTION_SOURCE@1@@Z @ 0x14063D49C
 * Callers:
        ...
        int a3)
{
  ...
  if ( a3 == 1 )
  {
    ...
    if ( v6 == -1073741819 || v6 == -1073740768 )
      SmHpChunkHeapProtect(BugCheckParameter1 + 256, 2, 1u);
  }
