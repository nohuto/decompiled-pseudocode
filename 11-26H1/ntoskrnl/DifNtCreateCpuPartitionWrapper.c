/*
 * XREFs of DifNtCreateCpuPartitionWrapper @ 0x1406737E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateCpuPartitionWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, int a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(572);
  ...
  LODWORD(v21) = NtCreateCpuPartition(a1, a2, a3, a4, a5);
  if ( v10 )
  {
