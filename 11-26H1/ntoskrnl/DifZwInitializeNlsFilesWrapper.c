/*
 * XREFs of DifZwInitializeNlsFilesWrapper @ 0x1406A87F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwInitializeNlsFilesWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwInitializeNlsFiles(a1, a2, a3);
  if ( v8 )
  {
