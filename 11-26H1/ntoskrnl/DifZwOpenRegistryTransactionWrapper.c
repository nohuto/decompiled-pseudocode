/*
 * XREFs of DifZwOpenRegistryTransactionWrapper @ 0x1406B0D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenRegistryTransactionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1099);
  ...
  LODWORD(v19) = ZwOpenRegistryTransaction(a1, a2, a3);
  if ( v8 )
  {
