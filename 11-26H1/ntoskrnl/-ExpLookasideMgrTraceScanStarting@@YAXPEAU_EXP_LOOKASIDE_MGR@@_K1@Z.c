/*
 * XREFs of ?ExpLookasideMgrTraceScanStarting@@YAXPEAU_EXP_LOOKASIDE_MGR@@_K1@Z @ 0x1404EFE78
 * Callers:
...
void __fastcall ExpLookasideMgrTraceScanStarting(struct _EXP_LOOKASIDE_MGR *a1)
{
  ...
  if ( (unsigned int)dword_140E09178 > 4 && tlgKeywordOn((__int64)&dword_140E09178, 1LL) )
  {
    v5 = *(_QWORD *)(v3 + 56);
    v9 = *(_DWORD *)(v3 + 16);
    v6 = v2;
