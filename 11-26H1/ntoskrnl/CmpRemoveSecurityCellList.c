/*
 * XREFs of CmpRemoveSecurityCellList @ 0x1404C21E4
 * Callers:
...
__int64 __fastcall CmpRemoveSecurityCellList(ULONG_PTR BugCheckParameter3, __int64 a2)
{
  ...
  if ( v5 )
    ...
    result = HvpGetCellFlat(BugCheckParameter3, a2, &v11);
  v7 = result;
  if ( result )
  {
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      CellFlat = HvpGetCellFlat(BugCheckParameter3, *(unsigned int *)(result + 4), &v13);
    else
    ...
    if ( CellFlat
      && ((*(_BYTE *)(BugCheckParameter3 + 140) & 1) == 0
        ...
        : (CellPaged = HvpGetCellFlat(BugCheckParameter3, *(unsigned int *)(v7 + 8), &v15)),
          (v4 = CellPaged) != 0) )
    {
