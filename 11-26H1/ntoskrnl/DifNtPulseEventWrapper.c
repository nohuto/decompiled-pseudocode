/*
 * XREFs of DifNtPulseEventWrapper @ 0x140684B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPulseEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(678);
  ...
  DWORD2(v16) = NtPulseEvent(EventHandle, PreviousState);
  if ( v6 )
  {
