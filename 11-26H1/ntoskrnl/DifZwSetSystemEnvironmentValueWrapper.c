/*
 * XREFs of DifZwSetSystemEnvironmentValueWrapper @ 0x1406BF820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetSystemEnvironmentValueWrapper(PUNICODE_STRING VariableName, PUNICODE_STRING VariableValue)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(995);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = VariableName;
    *((_QWORD *)&v15 + 1) = VariableValue;
  ...
  DWORD2(v16) = ZwSetSystemEnvironmentValue(VariableName, VariableValue);
  if ( v6 )
  {
