/*
 * XREFs of DifZwSetSystemEnvironmentValueWrapper @ 0x1406BBC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetSystemEnvironmentValueWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwSetSystemEnvironmentValue(a1, a2);
  if ( v6 )
  {
