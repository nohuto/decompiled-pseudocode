/*
 * XREFs of MiCompactServiceTable @ 0x14087AC6C
 * Callers:
...
__int64 __fastcall MiCompactServiceTable(__int64 a1)
{
  ...
  unsigned __int64 v74; // [rsp+C8h] [rbp+50h] BYREF
  unsigned __int64 v75; // [rsp+D0h] [rbp+58h]
  ...
  v66 = 0LL;
  v73 = 0;
  v3 = (int *)RtlImageDirectoryEntryToData(v1, 1, 0, &v73);
  v4 = v3;
  if ( v3 )
  {
    v5 = 0;
    ...
    while ( v8 >= v5 )
    {
      v9 = (v5 + v8) >> 1;
      v67 = v9;
      v10 = strcmp("W32pServiceTable", (const char *)(v1 + *(unsigned int *)(v6 + 4LL * v9)));
      if ( v10 >= 0 )
      {
        if ( v10 <= 0 )
        {
          if ( *(unsigned __int16 *)(v75 + 2 * v67) < (unsigned int)v4[5] )
          {
            v11 = (int *)(v1 + *(unsigned int *)(v1 + (unsigned int)v4[7] + 4LL * *(unsigned __int16 *)(v75 + 2 * v67)));
            v69 = v11;
            if ( v11 <= v4 || v11 >= (int *)((char *)v4 + v73) )
            {
              if ( v11 )
              {
                v12 = *(_QWORD *)(a1 + 48);
                v73 = 0;
                v13 = (unsigned int *)RtlImageDirectoryEntryToData(v12, 1, 0, &v73);
                v14 = v13;
                if ( v13 )
                {
                  v15 = 0;
                  ...
                  while ( v18 >= v15 )
                  {
                    v19 = (v15 + v18) >> 1;
                    v67 = v19;
                    v20 = strcmp("W32pServiceLimit", (const char *)(v12 + *(unsigned int *)(v16 + 4LL * v19)));
                    if ( v20 >= 0 )
                    {
                      if ( v20 <= 0 )
                      {
                        if ( *(unsigned __int16 *)(v75 + 2 * v67) < v14[5] )
                        {
                          v21 = (unsigned int *)(v12
                                               + *(unsigned int *)(v12
                                                                 + v14[7]
                                                                 + 4LL * *(unsigned __int16 *)(v75 + 2 * v67)));
                          v71 = v21;
                          if ( v21 <= v14 || v21 >= (unsigned int *)((char *)v14 + v73) )
                          {
                            if ( v21 )
                            {
                              v22 = *(_QWORD *)(a1 + 48);
                              v73 = 0;
                              v23 = (unsigned __int8 *)RtlImageDirectoryEntryToData(v22, 1, 0, &v73);
                              v24 = v23;
                              if ( v23 )
                              {
                                v25 = 0;
                                ...
                                while ( v28 >= v25 )
                                {
                                  ...
                                  v30 = strcmp(
                                          "W32pArgumentTable",
                                          (const char *)(v22 + *(unsigned int *)(v26 + 4LL * v29)));
                                  if ( v30 >= 0 )
                                  {
                                    if ( v30 <= 0 )
                                    {
                                      if ( (unsigned int)*(unsigned __int16 *)(v75 + 2 * v67) < *((_DWORD *)v24 + 5) )
                                      {
                                        v31 = (unsigned __int8 *)(v22
                                                                + *(unsigned int *)(v22
                                                                                  + *((unsigned int *)v24 + 7)
                                                                                  + 4LL
                                                                                  * *(unsigned __int16 *)(v75 + 2 * v67)));
                                        v72 = v31;
                                        if ( v31 <= v24 || v31 >= &v24[v73] )
                                        {
                                          if ( v31 )
                                          {
                                            v32 = *(_QWORD *)(a1 + 48);
                                            v73 = 0;
                                            v33 = (int *)RtlImageDirectoryEntryToData(v32, 1, 0, &v73);
                                            v34 = v33;
                                            if ( v33 )
                                            {
                                              v35 = 0;
                                              v36 = v32 + (unsigned int)v33[8];
                                              v37 = v33[6];
                                              v75 = v32 + (unsigned int)v33[9];
                                              v38 = v37 - 1;
                                              v74 = v36;
                                              while ( v38 >= v35 )
                                              {
                                                ...
                                                v40 = strcmp(
                                                        ...
                                                        (const char *)(v32 + *(unsigned int *)(v36 + 4LL * v39)));
                                                if ( v40 >= 0 )
                                                {
                                                  if ( v40 <= 0 )
                                                  {
                                                    if ( *(unsigned __int16 *)(v75 + 2 * v67) < (unsigned int)v34[5] )
                                                    {
                                                      v41 = (int *)(v32
                                                                  + *(unsigned int *)(v32
                                                                                    + (unsigned int)v34[7]
                                                                                    ...
                                                                                    * *(unsigned __int16 *)(v75 + 2 * v67)));
                                                      v70 = v41;
                                                      if ( v41 <= v34 || v41 >= (int *)((char *)v34 + v73) )
                                                      {
                                                        if ( v41 )
                                                        {
                                                          v42 = *(_QWORD *)(a1 + 48);
                                                          ...
                                                          if ( v43 )
                                                          {
                                                            ...
                                                            while ( v48 >= v45 )
                                                            {
                                                              ...
                                                              v50 = strcmp(
                                                                      ...
                                                                      (const char *)(v42
                                                                                   + *(unsigned int *)(v46 + 4LL * v49)));
                                                              if ( v50 >= 0 )
                                                              {
                                                                if ( v50 <= 0 )
                                                                {
                                                                  if ( *(unsigned __int16 *)(v75 + 2 * v67) < v44[5] )
                                                                  {
                                                                    v51 = (unsigned int *)(v42
                                                                                         + *(unsigned int *)(v42 + v44[7] + 4LL * *(unsigned __int16 *)(v75 + 2 * v67)));
                                                                    if ( v51 <= v44
                                                                      || v51 >= (unsigned int *)((char *)v44 + v73) )
                                                                    {
                                                                      if ( v51 )
                                                                      {
                                                                        v52 = *(_QWORD *)(a1 + 48);
                                                                          ...
                                                                          while ( v58 >= v57 )
                                                                          {
                                                                            ...
                                                                            if ( v60 >= 0 )
                                                                            {
                                                                              if ( v60 <= 0 )
                                                                              {
                                                                                ...
                                                                                {
                                                                                  v61 = (unsigned __int8 *)(*(unsigned int *)(v52 + *((unsigned int *)v54 + 7) + 4LL * *(unsigned __int16 *)(v67 + 2 * v68)) + v52);
                                                                                  if ( v61 <= v54
