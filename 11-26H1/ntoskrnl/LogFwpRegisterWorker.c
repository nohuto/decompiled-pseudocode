/*
 * XREFs of LogFwpRegisterWorker @ 0x140C53910
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v1 >= 0 )
    {
      Flink = (int)WheapPfaLock.ThreadListEntry.Flink;
      ZwClose(KeyHandle);
      RtlInitUnicodeString(&DestinationString, L"Resume");
      Data = (Flink & 0x100000) != 0;
      ...
      Data = *(_DWORD *)&WheapPfaLock.SchedulerApcFill5[76];
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = (int)WheapPfaLock.PropagateBoostsEntry.Next;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000LL * *(_QWORD *)&WheapPfaLock.AbWaitEntryCount / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"ProgressLow");
      Data = 1000000 * qword_140E0F1C8 / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"ProgressHigh");
      Data = 1000000 * (__int64)WheapPfaLock.SchedulerApc.NormalContext / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * (__int64)WheapPfaLock.MutantListHead.Blink / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"ProgressManual");
      Data = 1000000 * (__int64)WheapPfaLock.SuspendEvent.Header.WaitListHead.Flink / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"FadeProlog");
      Data = 1000000LL * *(_QWORD *)&WheapPfaLock.PriorityFloorCounts[8] / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = HIDWORD(WheapPfaLock.SchedulerSharedSystemSlot);
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"FadeCpu");
      Data = *(_DWORD *)&WheapPfaLock.SchedulerApcFill5[72];
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"FadeFrames");
      Data = WheapPfaLock.SuspendEvent.Header.Lock;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * qword_140E0F1D8 / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"FadeHigh");
      Data = 1000000LL * *(_QWORD *)&WheapPfaLock.SchedulerApcFill5[80] / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"FadeTotal");
      Data = 1000000 * (__int64)WheapPfaLock.SuspendEvent.Header.WaitListHead.Blink / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"AnimationTotal");
      Data = 1000000 * (__int64)WheapPfaLock.MutantListHead.Flink / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"CompressBitmaps");
      Data = 1000000 * qword_140E64F88 / qword_140E0F1D0;
      ZwSetValueKey(v9, &DestinationString, 0, 4u, &Data, 4u);
      v2 = v9;
    }
    return ZwClose(v2);
