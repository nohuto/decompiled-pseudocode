/*
 * XREFs of FsRtlIsFatDbcsLegal @ 0x140A58E90
 * Callers:
 *     FsRtlIsFatDbcsLegal @ 0x140A58E90 (FsRtlIsFatDbcsLegal.c)
 * Callees:
 *     FsRtlDissectDbcs @ 0x14078FFB0 (FsRtlDissectDbcs.c)
 *     FsRtlIsFatDbcsLegal @ 0x140A58E90 (FsRtlIsFatDbcsLegal.c)
 *     FsRtlDoesDbcsContainWildCards @ 0x140A59100 (FsRtlDoesDbcsContainWildCards.c)
 */
...
LABEL_4:
    ...
    if ( WildCardsPermissible && FsRtlDoesDbcsContainWildCards(DbcsName) )
    {
      for ( i = 0; i < DbcsName->Length; ++i )
      {
        ...
        else if ( (v16 & 0x80u) == 0LL && (*((_BYTE *)qword_140017750 + v16) & 9) == 0 )
        {
          return 0;
        }
      }
    ...
    if ( v10 <= 0xC )
    {
      for ( j = 0; j < v10; ++j )
      {
        ...
        {
          if ( (v8 & 0x80u) == 0LL
            && ((unsigned __int8)(WildCardsPermissible != 0 ? 9 : 1) & *((_BYTE *)qword_140017750 + v8)) == 0 )
          {
            return 0;
          }
