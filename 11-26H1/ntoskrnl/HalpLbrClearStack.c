/*
 * XREFs of HalpLbrClearStack @ 0x14041CF40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HalpLbrClearStack(__int64 a1, __int64 a2)
{
  ...
  if ( !dword_140F87654 || !dword_140F87658 )
    return 0;
  ...
  switch ( dword_140F87664 )
  {
    ...
    case 2:
      ...
      __writemsr(0x14CEu, (unsigned int)dword_140F8764C | 1LL);
      break;
    case 3:
