/*
 * XREFs of TtmiLogSessionDisplayRequiredPowerRequestUpdated @ 0x1407EA43C
 * Callers:
...
void TtmiLogSessionDisplayRequiredPowerRequestUpdated()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_140051115, 0LL, 0LL, 5u, &v7);
  }
}
