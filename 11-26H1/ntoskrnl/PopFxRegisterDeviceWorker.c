/*
 * XREFs of PopFxRegisterDeviceWorker @ 0x140B1BA40
 * Callers:
...
LABEL_51:
  ...
  v87 = v86 + 40 * v9;
  v83 = v87 + 24LL * v17;
  AcpiDeviceByUniqueId = PopFxFindAcpiDeviceByUniqueId(a2, (__int64 **)&v75, v86, j);
  v14 = v75;
...
LABEL_22:
          ...
          if ( (*(_QWORD *)v27 & 0x10) == 0 && ((*(_QWORD *)v27 & 8) != 0 || dword_140E67520) )
