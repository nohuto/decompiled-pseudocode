/*
 * XREFs of DifZwCreateThreadExWrapper @ 0x1406A2070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateThreadExWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a11)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(916);
...
LABEL_17:
  Thread = ZwCreateThreadEx(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
  if ( v16 )
  {
