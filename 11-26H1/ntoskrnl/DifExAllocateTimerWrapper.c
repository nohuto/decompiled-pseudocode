/*
 * XREFs of DifExAllocateTimerWrapper @ 0x140653D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExAllocateTimerWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  __int64 Timer; // [rsp+40h] [rbp-10h]
  _UNKNOWN *retaddr; // [rsp+78h] [rbp+28h]

  Timer = 0LL;
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(476);
  ...
  Timer = ExAllocateTimer(a1, a2, a3);
  if ( v8 )
  {
