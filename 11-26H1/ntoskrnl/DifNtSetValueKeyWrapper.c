/*
 * XREFs of DifNtSetValueKeyWrapper @ 0x14068E850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetValueKeyWrapper(__int64 a1, __int64 a2, int a3, int a4, __int64 a5, int a6)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(807);
...
LABEL_17:
  LODWORD(Size) = a6;
  LODWORD(v24) = NtSetValueKey(a1, a2, a3, a4, a5, Size);
  if ( v11 )
  {
