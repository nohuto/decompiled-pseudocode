/*
 * XREFs of DifNtQueryInformationTransactionWrapper @ 0x140687560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationTransactionWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(828);
  ...
  LODWORD(v21) = NtQueryInformationTransaction(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
