/*
 * XREFs of PopRecordBatteryPercentage @ 0x1409C1FD0
 * Callers:
...
__int64 __fastcall PopRecordBatteryPercentage(char a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  *((_BYTE *)&stru_140E67200.ReservedPreviousReadyTimeValue + 7) = a1 & 0x7F | *((_BYTE *)&stru_140E67200.ReservedPreviousReadyTimeValue
                                                                               + 7) & 0x80;
