/*
 * XREFs of DifZwWriteVirtualMemoryWrapper @ 0x1406C0090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWriteVirtualMemoryWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1076);
  ...
  LODWORD(v21) = ZwWriteVirtualMemory(a1, a2, a3, a4, a5);
  if ( v10 )
  {
