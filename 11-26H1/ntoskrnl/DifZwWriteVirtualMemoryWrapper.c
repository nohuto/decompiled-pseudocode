/*
 * XREFs of DifZwWriteVirtualMemoryWrapper @ 0x1406C3C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWriteVirtualMemoryWrapper(
        void *a1,
        void *a2,
        void *a3,
        SIZE_T a4,
        ULONG_PTR *NumberOfBytesWritten)
{
  ...
  LODWORD(v21) = ZwWriteVirtualMemory(a1, a2, a3, a4, NumberOfBytesWritten);
  if ( v10 )
  {
