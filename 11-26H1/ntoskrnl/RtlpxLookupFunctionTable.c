/*
 * XREFs of RtlpxLookupFunctionTable @ 0x1402E9A40
 * Callers:
 ...
 *     RtlLookupFunctionTableEx @ 0x140454CC0 (RtlLookupFunctionTableEx.c)
...
LABEL_44:
      if ( *((_BYTE *)RtlpInvertedFunctionTable + 12) )
      {
        ...
        v26 = *(_DWORD *)&stru_140E2D150.WaitBlockFill11[76] << 12;
        if ( PsLoadedModuleList )
        {
          while ( v25 != &PsLoadedModuleList )
          {
            ...
            if ( v27 == PsNtosImageBase || v27 == PsHalImageBase )
              ...
              SListFaultAddress_high = LODWORD(stru_140E36558.QuantumTarget) + HIDWORD(stru_140E36558.SListFaultAddress);
...
LABEL_59:
            if ( v30 )
              v34 = v30 + SListFaultAddress_high;
            else
LABEL_84:
              v34 = v27 + *((unsigned int *)v25 + 16);
            if ( a1 < v34 && a1 >= v27 )
            {
              v24 = v25[2];
              *(_QWORD *)a2 = v24;
              *(_DWORD *)(a2 + 16) = v34 - v27;
              *(_QWORD *)(a2 + 8) = v27;
...
LABEL_41:
    ...
    v17 = *(_DWORD *)&stru_140E2D150.WaitBlockFill11[76] << 12;
...
LABEL_21:
  ...
  v7 = 1;
  v8 = *(_DWORD *)&stru_140E2D150.WaitBlockFill11[76] << 12;
