/*
 * XREFs of DifZwSetInformationDebugObjectWrapper @ 0x1406BD6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationDebugObjectWrapper(
        void *a1,
        DEBUGOBJECTINFOCLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1125);
  ...
  LODWORD(v21) = ZwSetInformationDebugObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
