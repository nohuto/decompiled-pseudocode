/*
 * XREFs of MiReturnImageBase @ 0x140A7FE38
 * Callers:
...
void __fastcall MiReturnImageBase(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 12) )
  {
    ...
    {
      case 1:
        p_Blink = (unsigned __int8 *)&stru_140E2D150.Timer.Header.WaitListHead.Blink;
        break;
      case 2:
        p_Blink = &stru_140E2D150.ApcStateFill[32];
        v4 = &stru_140E2D150.Timer.Header.WaitListHead.Blink;
        break;
      case 3:
        p_Blink = &stru_140E2D150.ApcStateFill[32];
        break;
      default:
        p_Blink = (unsigned __int8 *)&stru_140E2D150.SystemCallNumber;
        v6 = 0x7FFFFFFF0000LL;
LABEL_8:
        MiZeroCfgSystemWideBitmap(a1, v6 - ((v1 + *(unsigned int *)(a1 + 8)) << 16));
        CurrentThread = KeGetCurrentThread();
        --CurrentThread->SpecialApcDisable;
        v9 = (AutoBoost *)KeAbPreAcquire((__int64)&stru_140E2D150.116 + 4, 0LL, 0LL, v8);
        v11 = _interlockedbittestandset64((volatile signed __int32 *)&stru_140E2D150.116 + 1, 0LL);
        v12 = v9;
        if ( v11 )
