/*
 * XREFs of DifNtQueryTimerResolutionWrapper @ 0x140686380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryTimerResolutionWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtQueryTimerResolution(a1, a2, a3);
  if ( v8 )
  {
