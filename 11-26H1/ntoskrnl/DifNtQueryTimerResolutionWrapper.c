/*
 * XREFs of DifNtQueryTimerResolutionWrapper @ 0x140689F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryTimerResolutionWrapper(PULONG MaximumTime, PULONG MinimumTime, PULONG CurrentTime)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(709);
  ...
  LODWORD(v19) = NtQueryTimerResolution(MaximumTime, MinimumTime, CurrentTime);
  if ( v8 )
  {
