/*
 * XREFs of TtmiLogCleanupCurrentSessionStart @ 0x140A39FAC
 * Callers:
...
void TtmiLogCleanupCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_140050E4F, 0LL, 0LL, 3u, &v4);
  }
}
