/*
 * XREFs of TtmiLogCleanupCurrentSessionStart @ 0x1409F5BAC
 * Callers:
...
void TtmiLogCleanupCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140FD68B8 > 5 && tlgKeywordOn((__int64)&dword_140FD68B8, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD68B8, (unsigned __int8 *)byte_140053271, 0LL, 0LL, 3u, &v4);
  }
}
