/*
 * XREFs of TtmiLogSessionPowerControlStop @ 0x1407F0138
 * Callers:
...
void TtmiLogSessionPowerControlStop()
{
  ...
  if ( (unsigned int)dword_140FD68B8 > 5 && tlgKeywordOn((__int64)&dword_140FD68B8, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD68B8, (unsigned __int8 *)byte_1400526E3, 0LL, 0LL, 3u, &v4);
  }
}
