/*
 * XREFs of DifNtCreateWnfStateNameWrapper @ 0x140675310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateWnfStateNameWrapper(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        char a4,
        ...
        __int64 a7)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(742);
...
LABEL_17:
  LOBYTE(v12) = a4;
  WnfStateName = NtCreateWnfStateName(a1, a2, a3, v12, a5, a6, a7);
  if ( v13 )
  {
