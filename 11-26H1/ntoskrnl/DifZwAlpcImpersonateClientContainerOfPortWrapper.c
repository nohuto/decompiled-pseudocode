/*
 * XREFs of DifZwAlpcImpersonateClientContainerOfPortWrapper @ 0x14069B170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcImpersonateClientContainerOfPortWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(962);
  ...
  LODWORD(v19) = ZwAlpcImpersonateClientContainerOfPort(a1, a2, a3);
  if ( v8 )
  {
