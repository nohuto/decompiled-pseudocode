/*
 * XREFs of DifZwAlpcImpersonateClientContainerOfPortWrapper @ 0x14069ED50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcImpersonateClientContainerOfPortWrapper(
        HANDLE PortHandle,
        ...
        ULONG Flags)
{
  ...
  LODWORD(v19) = ZwAlpcImpersonateClientContainerOfPort(PortHandle, Message, Flags);
  if ( v8 )
  {
