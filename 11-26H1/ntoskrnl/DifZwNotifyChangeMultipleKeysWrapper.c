/*
 * XREFs of DifZwNotifyChangeMultipleKeysWrapper @ 0x1406AAE00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwNotifyChangeMultipleKeysWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4,
...
LABEL_17:
  v38 = ZwNotifyChangeMultipleKeys(
          a1,
          a2,
          a3,
          a4,
