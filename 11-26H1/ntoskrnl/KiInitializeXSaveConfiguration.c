/*
 * XREFs of KiInitializeXSaveConfiguration @ 0x140BFA4A0
 * Callers:
 ...
 *     RtlUpdateXSaveSizeAndVolatileFeatures @ 0x14061C4BC (RtlUpdateXSaveSizeAndVolatileFeatures.c)
 *     RtlGetXSaveSupportedFeatures @ 0x140625C6C (RtlGetXSaveSupportedFeatures.c)
...
char __fastcall KiInitializeXSaveConfiguration(__int64 a1, int a2)
{
  ...
  unsigned __int16 v23; // [rsp+386h] [rbp+286h]
  unsigned __int16 v24; // [rsp+388h] [rbp+288h]
  char v25; // [rsp+38Ah] [rbp+28Ah]
  unsigned __int8 v26; // [rsp+38Ch] [rbp+28Ch]

  if ( !a2 )
    KiParseLoadOptions(*(_QWORD *)(a1 + 216));
  memset_0(BugCheckParameter1, 0, 0x358uLL);
  RtlGetXSaveSupportedFeatures((__int64)BugCheckParameter1);
  BugCheckParameter3[0] = 0LL;
  KiGetIptInfo((_DWORD *)BugCheckParameter3 + 1, (int *)BugCheckParameter3);
  if ( a2 )
  {
    if ( (BugCheckParameter1[0] & MEMORY[0xFFFFF780000003D8]) != MEMORY[0xFFFFF780000003D8]
      ...
      || v23 < MEMORY[0xFFFFF7800000071E]
      || (v26 & MEMORY[0xFFFFF78000000724]) != MEMORY[0xFFFFF78000000724]
      || v24 < MEMORY[0xFFFFF78000000720]
      || (v25 & 1) == 0 && (MEMORY[0xFFFFF78000000722] & 1) != 0 )
    {
