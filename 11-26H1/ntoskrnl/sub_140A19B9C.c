/*
 * XREFs of sub_140A19B9C @ 0x140A19B9C
 * Callers:
...
__int64 __fastcall sub_140A19B9C(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  unsigned int *v6; // rcx
  void **v7; // rax
  unsigned int i; // r9d
...
LABEL_55:
  ...
  {
    if ( v25 && (v35 = v25 - 1) != 0 && (unsigned int)(v35 - 1) <= 1 )
      v34 = 6LL;
    else
      LOBYTE(v34) = 0;
    ZwSetCachedSigningLevel(2LL, v34);
  }
  LODWORD(v52) = 0;
