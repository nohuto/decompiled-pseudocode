/*
 * XREFs of sub_140B6C624 @ 0x140B6C624
 * Callers:
...
__int64 __fastcall sub_140B6C624(int *a1, __int64 a2, __int64 a3)
{
  int v6; // r8d
  ...
  *(_DWORD *)(a3 + 48) = v6;
  *(_DWORD *)(a3 + 52) = a1[1];
  v9 = sub_140A847CC(v11, (_QWORD *)(a3 + 56));
  if ( v9 >= 0 )
  {
    ...
    v9 = sub_1409F0AF4(*(PVOID *)(a2 + 8), v11, 1);
    if ( v9 >= 0 )
    {
      v9 = sub_1409EEA18(*(UCHAR **)(a3 + 56), v11);
      if ( v9 >= 0 )
      {
...
LABEL_35:
        ...
        if ( v20 <= 0xFFFFFFFF )
        {
          ...
          if ( (unsigned int)Feature_WBAccessors__private_IsEnabledDeviceUsageNoInline() )
          {
            v9 = sub_140A847CC(v21, (_QWORD *)(a3 + 40));
            if ( v9 < 0 )
              goto LABEL_38;
