/*
 * XREFs of DifNtQueryBootEntryOrderWrapper @ 0x140681380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryBootEntryOrderWrapper(volatile void *Address, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(666);
  ...
  DWORD2(v16) = NtQueryBootEntryOrder(Address);
  if ( v6 )
  {
