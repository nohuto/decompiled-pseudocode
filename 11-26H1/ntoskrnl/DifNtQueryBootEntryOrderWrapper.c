/*
 * XREFs of DifNtQueryBootEntryOrderWrapper @ 0x140684F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryBootEntryOrderWrapper(PULONG Ids, PULONG Count)
{
  ...
  DWORD2(v16) = NtQueryBootEntryOrder(Ids, Count);
  if ( v6 )
  {
