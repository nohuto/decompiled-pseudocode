/*
 * XREFs of DifNtDuplicateTokenWrapper @ 0x14067A510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDuplicateTokenWrapper(
        void *a1,
        ACCESS_MASK a2,
...
LABEL_7:
  v14 = 0;
  *((_QWORD *)&v22 + 1) = a1;
  LODWORD(v21) = TokenType;
  *((_QWORD *)&v20 + 1) = NewTokenHandle;
  LODWORD(v22) = a2;
  *((_QWORD *)&v21 + 1) = a3;
  BYTE4(v21) = a4;
...
LABEL_17:
  LODWORD(v23) = NtDuplicateToken(a1, a2, a3, a4, TokenType, NewTokenHandle);
  if ( v11 )
  {
