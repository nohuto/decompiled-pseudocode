/*
 * XREFs of DifZwCreateCrossVmEventWrapper @ 0x1406A1F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateCrossVmEventWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
        ...
        __int64 a6)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1001);
...
LABEL_17:
  CrossVmEvent = ZwCreateCrossVmEvent(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
