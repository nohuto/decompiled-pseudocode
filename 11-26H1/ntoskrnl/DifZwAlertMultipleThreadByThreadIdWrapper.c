/*
 * XREFs of DifZwAlertMultipleThreadByThreadIdWrapper @ 0x14069CD00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlertMultipleThreadByThreadIdWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(923);
  ...
  DWORD2(v20) = ZwAlertMultipleThreadByThreadId(
                  a1,
                  a2,
                  a3,
                  a4,
