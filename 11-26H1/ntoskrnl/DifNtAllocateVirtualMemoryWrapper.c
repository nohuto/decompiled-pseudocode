/*
 * XREFs of DifNtAllocateVirtualMemoryWrapper @ 0x14066F600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAllocateVirtualMemoryWrapper(
        void *a1,
        PVOID *a2,
        ULONG_PTR a3,
        ULONG_PTR *a4,
        ...
        ULONG Protect)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(754);
...
LABEL_7:
  v14 = 0;
  *((_QWORD *)&v22 + 1) = a1;
  *((_QWORD *)&v20 + 1) = __PAIR64__(AllocationType, Protect);
  *(_QWORD *)&v22 = a2;
  *((_QWORD *)&v21 + 1) = a3;
  *(_QWORD *)&v21 = a4;
...
LABEL_17:
  LODWORD(v23) = NtAllocateVirtualMemory(a1, a2, a3, a4, AllocationType, Protect);
  if ( v11 )
  {
