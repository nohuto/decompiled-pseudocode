/*
 * XREFs of DifNtQueryInformationProcessWrapper @ 0x140686CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationProcessWrapper(
        void *a1,
        PROCESSINFOCLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(532);
  ...
  LODWORD(v21) = NtQueryInformationProcess(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
