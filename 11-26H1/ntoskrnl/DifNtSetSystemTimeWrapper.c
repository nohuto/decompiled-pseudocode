/*
 * XREFs of DifNtSetSystemTimeWrapper @ 0x140691980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemTimeWrapper(PLARGE_INTEGER SystemTime, PLARGE_INTEGER PreviousTime)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(708);
  ...
  DWORD2(v16) = NtSetSystemTime(SystemTime, PreviousTime);
  if ( v6 )
  {
