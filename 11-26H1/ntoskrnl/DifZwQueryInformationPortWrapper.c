/*
 * XREFs of DifZwQueryInformationPortWrapper @ 0x1406B52F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationPortWrapper(
        void *a1,
        PORT_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(958);
  ...
  LODWORD(v21) = ZwQueryInformationPort(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
