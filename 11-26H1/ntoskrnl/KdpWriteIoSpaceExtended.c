/*
 * XREFs of KdpWriteIoSpaceExtended @ 0x140C1B838
 * Callers:
...
__int64 __fastcall KdpWriteIoSpaceExtended(__int64 a1)
{
  __int64 v1; // r9
  int v2; // r8d
  int v3; // edx
  ...
  v3 = *(_DWORD *)(a1 + 24);
  *((_QWORD *)&v6 + 1) = a1;
  *(_DWORD *)(a1 + 8) = KdpSysWriteIoSpace(*(_DWORD *)(a1 + 20), v3, v2, v1, (unsigned __int8 *)(a1 + 40), v5, &v7);
