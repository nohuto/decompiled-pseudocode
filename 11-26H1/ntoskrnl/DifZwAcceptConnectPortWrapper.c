/*
 * XREFs of DifZwAcceptConnectPortWrapper @ 0x14069ACE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAcceptConnectPortWrapper(
        HANDLE *a1,
        void *a2,
        _PORT_MESSAGE *a3,
        BOOLEAN a4,
        _PORT_VIEW *ServerView,
        _REMOTE_PORT_VIEW *ClientView)
{
  ...
  BOOLEAN v21; // [rsp+48h] [rbp-28h]
  _PORT_MESSAGE *v22; // [rsp+50h] [rbp-20h]
  void *v23; // [rsp+58h] [rbp-18h]
  HANDLE *v24; // [rsp+60h] [rbp-10h]
  unsigned int v25; // [rsp+68h] [rbp-8h]
  void *retaddr; // [rsp+98h] [rbp+28h]

  memset_0(v20, 0, 0x40uLL);
  APIThunkContextById = DifGetAPIThunkContextById(949);
...
LABEL_17:
  v25 = ZwAcceptConnectPort(a1, a2, a3, a4, ServerView, ClientView);
  if ( v11 )
  {
