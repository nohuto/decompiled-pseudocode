/*
 * XREFs of DifZwAcceptConnectPortWrapper @ 0x140697100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAcceptConnectPortWrapper(__int64 a1, __int64 a2, __int64 a3, char a4, __int64 a5, __int64 a6)
{
...
LABEL_17:
  LOBYTE(v11) = a4;
  v28 = ZwAcceptConnectPort(a1, a2, a3, v11, a5, a6, v21, v22, v23, v24, v25, v26, v27);
  if ( v12 )
  {
