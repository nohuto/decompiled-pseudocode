/*
 * XREFs of TtmiLogTerminalHandleOpened @ 0x1407EB284
 * Callers:
...
void TtmiLogTerminalHandleOpened()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v14 = 8LL;
    v16 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_140051D47, 0LL, 0LL, 6u, &v8);
  }
}
