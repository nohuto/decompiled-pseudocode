/*
 * XREFs of KiRaiseSecurityCheckFailureShadow @ 0x140C5FD40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiRaiseSecurityCheckFailureShadow()
{
  ...
  if ( (v6.OffsetLow & 1) != 0 )
  {
    ...
    return ((__int64 (*)(void))KiRaiseSecurityCheckFailure)();
  }
  else
  {
    _mm_lfence();
