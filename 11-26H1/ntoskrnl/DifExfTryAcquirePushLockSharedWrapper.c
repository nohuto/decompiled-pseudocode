/*
 * XREFs of DifExfTryAcquirePushLockSharedWrapper @ 0x1406594D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExfTryAcquirePushLockSharedWrapper(signed __int64 *a1)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(375);
  ...
  LOBYTE(v14) = ExfTryAcquirePushLockSharedEx(a1, 0);
  if ( v4 )
  {
