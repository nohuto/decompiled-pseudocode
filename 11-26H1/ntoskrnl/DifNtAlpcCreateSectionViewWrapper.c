/*
 * XREFs of DifNtAlpcCreateSectionViewWrapper @ 0x140670400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreateSectionViewWrapper(
        HANDLE PortHandle,
        ULONG Flags,
        PALPC_DATA_VIEW_ATTR ViewAttributes)
{
  ...
  LODWORD(v19) = NtAlpcCreateSectionView(PortHandle, Flags, ViewAttributes);
  if ( v8 )
  {
