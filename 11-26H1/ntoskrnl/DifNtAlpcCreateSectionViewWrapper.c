/*
 * XREFs of DifNtAlpcCreateSectionViewWrapper @ 0x14066C820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreateSectionViewWrapper(HANDLE Handle, int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtAlpcCreateSectionView(Handle);
  if ( v8 )
  {
