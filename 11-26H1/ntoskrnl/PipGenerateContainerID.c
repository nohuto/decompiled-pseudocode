/*
 * XREFs of PipGenerateContainerID @ 0x140B0F3DC
 * Callers:
...
__int64 __fastcall PipGenerateContainerID(__int64 a1, __int64 a2, char a3, const WCHAR *a4, _QWORD *a5)
{
  ...
  UNICODE_STRING DestinationString; // [rsp+40h] [rbp-61h] BYREF
...
LABEL_3:
    v8 = RtlStringFromGUIDEx(&p_Guid->Data1, (__int64)&DestinationString, 1);
    goto LABEL_4;
  }
  if ( a4 )
  {
    v8 = RtlCreateUnicodeString(&DestinationString, a4) == 0 ? 0xC000009A : 0;
    goto LABEL_4;
  }
  if ( !a2 )
    goto LABEL_21;
  ...
  if ( DeviceRegProp < 0 || v18 != 1 || !RtlCreateUnicodeString(&DestinationString, SourceString) )
  {
LABEL_21:
