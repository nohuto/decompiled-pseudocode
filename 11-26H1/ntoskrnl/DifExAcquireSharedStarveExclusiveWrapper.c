/*
 * XREFs of DifExAcquireSharedStarveExclusiveWrapper @ 0x140652E20
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireSharedStarveExclusiveWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  BYTE8(v16) = ExAcquireSharedStarveExclusive(Resource, a2);
  if ( v6 )
  {
