/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x140CDF5B8
 * Callers:
...
LABEL_21:
        ...
        if ( v7 )
        {
          ...
          *((_QWORD *)&v11 + 1) = v1;
          ...
          {
            VfDriverLock();
            v9 = (_QWORD *)qword_140F089B8;
            if ( *(__int64 **)qword_140F089B8 != &VfXdvExcludedDriversList )
              __fastfail(3u);
            *v8 = &VfXdvExcludedDriversList;
            v8[1] = v9;
            *v9 = v8;
            qword_140F089B8 = (__int64)v8;
