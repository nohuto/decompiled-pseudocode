/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x140CE5950
 * Callers:
...
int VfXdvExcludeParseRegistryString()
{
  ...
  else
  {
    ...
    while ( v1 < v3 )
    {
      ...
      if ( (_DWORD)v4 == 9 || (unsigned int)v4 <= 0x20 && _bittest64(&v2, v4) || (_WORD)v4 == 12288 )
      {
      ...
      else
      {
        ...
        while ( v5 < v3 )
        {
          ...
          if ( (_DWORD)v6 == 9 || (unsigned int)v6 <= 0x20 && _bittest64(&v2, v6) )
            break;
          if ( (_WORD)v6 == 12288 )
            break;
          v5 = (__int64 *)((char *)v5 + 2);
...
LABEL_21:
        ...
        if ( v7 )
        {
          ...
          *((_QWORD *)&v11 + 1) = v1;
          ...
          {
            VfDriverLock();
            v9 = (_QWORD *)qword_140F08DC8;
            if ( *(__int64 **)qword_140F08DC8 != &VfXdvExcludedDriversList )
              __fastfail(3u);
            *v8 = &VfXdvExcludedDriversList;
            v8[1] = v9;
            *v9 = v8;
            qword_140F08DC8 = (__int64)v8;
