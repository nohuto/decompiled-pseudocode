/*
 * XREFs of DifZwQueryIoCompletionWrapper @ 0x1406B25C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryIoCompletionWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(985);
  ...
  LODWORD(v21) = ZwQueryIoCompletion(a1, a2, a3, a4, a5);
  if ( v10 )
  {
