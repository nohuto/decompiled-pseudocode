/*
 * XREFs of DifZwQueryIoCompletionWrapper @ 0x1406B61A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryIoCompletionWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = ZwQueryIoCompletion(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
