/*
 * XREFs of DifZwAddAtomExWrapper @ 0x14069C130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAddAtomExWrapper(WCHAR *a1, ULONG a2, USHORT *a3, ULONG a4)
{
  ...
  DWORD2(v20) = ZwAddAtomEx(a1, a2, a3, a4);
  if ( v9 )
  {
