/*
 * XREFs of DifZwAddAtomExWrapper @ 0x140698550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAddAtomExWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1041);
