/*
 * XREFs of DifNtCreateLowBoxTokenWrapper @ 0x140675750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateLowBoxTokenWrapper(
        HANDLE *a1,
        void *a2,
        ACCESS_MASK a3,
...
LABEL_17:
  LowBoxToken = NtCreateLowBoxToken(a1, a2, a3, a4, PackageSid, CapabilityCount, Capabilities, HandleCount, Handles);
  if ( v14 )
  {
