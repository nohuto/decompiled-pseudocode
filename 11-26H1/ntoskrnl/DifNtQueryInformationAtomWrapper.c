/*
 * XREFs of DifNtQueryInformationAtomWrapper @ 0x140686150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationAtomWrapper(
        RTL_ATOM a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(736);
  ...
  DWORD2(v21) = NtQueryInformationAtom(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
