/*
 * XREFs of DifNtQuerySystemEnvironmentValueExWrapper @ 0x140689770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQuerySystemEnvironmentValueExWrapper(
        UNICODE_STRING *a1,
        const GUID *a2,
        void *a3,
        ULONG *a4,
        ULONG *Attributes)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(660);
  ...
  LODWORD(v21) = NtQuerySystemEnvironmentValueEx(a1, a2, a3, a4, Attributes);
  if ( v10 )
  {
