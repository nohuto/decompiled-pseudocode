/*
 * XREFs of DifZwQueueApcThreadExWrapper @ 0x1406B9100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueueApcThreadExWrapper(
        void *a1,
        void *a2,
...
LABEL_17:
  v21 = ZwQueueApcThreadEx(a1, a2, a3, a4, ApcArgument2, ApcArgument3);
  if ( v11 )
  {
