/*
 * XREFs of MiFlushStrongCodeDriverLoadFailures @ 0x140CF4538
 * Callers:
...
_UNKNOWN **MiFlushStrongCodeDriverLoadFailures()
{
  ...
  if ( stru_140E36558.FirstArgument )
  {
    ...
    while ( 1 )
    {
      Flink = stru_140E2D150.SchedulerApc.ApcListEntry.Flink;
      if ( (unsigned __int8 *)stru_140E2D150.SchedulerApc.ApcListEntry.Flink == &stru_140E2D150.SchedulerApcFill5[16] )
        break;
      if ( (unsigned __int8 *)stru_140E2D150.SchedulerApc.ApcListEntry.Flink->Blink != &stru_140E2D150.SchedulerApcFill5[16]
        || (v3 = stru_140E2D150.SchedulerApc.ApcListEntry.Flink->Flink,
            stru_140E2D150.SchedulerApc.ApcListEntry.Flink->Flink->Blink != stru_140E2D150.SchedulerApc.ApcListEntry.Flink) )
      {
        __fastfail(3u);
      }
      stru_140E2D150.SchedulerApc.ApcListEntry.Flink = stru_140E2D150.SchedulerApc.ApcListEntry.Flink->Flink;
      v3->Blink = &stru_140E2D150.SchedulerApc.ApcListEntry;
        ...
        && tlgKeywordOn((__int64)stru_140E36558.FirstArgument, 0x400000004000LL) )
      {
        ...
        v9 = 0x1000000LL;
        v21 = 8LL;
        tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&byte_1400578EF, v4, 1u, v5, v6, 8u, &v10);
      }
