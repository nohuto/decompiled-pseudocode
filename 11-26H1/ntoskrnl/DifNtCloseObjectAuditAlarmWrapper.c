/*
 * XREFs of DifNtCloseObjectAuditAlarmWrapper @ 0x140672830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCloseObjectAuditAlarmWrapper(
        ...
        BOOLEAN GenerateOnClose)
{
  ...
  LODWORD(v19) = NtCloseObjectAuditAlarm(SubsystemName, HandleId, GenerateOnClose);
  if ( v8 )
  {
