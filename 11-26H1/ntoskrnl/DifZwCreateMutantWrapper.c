/*
 * XREFs of DifZwCreateMutantWrapper @ 0x1406A3F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateMutantWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, BOOLEAN a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1004);
  ...
  DWORD2(v20) = ZwCreateMutant(a1, a2, a3, a4);
  if ( v9 )
  {
