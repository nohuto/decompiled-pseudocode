/*
 * XREFs of DifZwCreateMutantWrapper @ 0x1406A0320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateMutantWrapper(__int64 a1, unsigned int a2, __int64 a3, char a4)
{
