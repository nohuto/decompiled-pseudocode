/*
 * XREFs of DifZwReadVirtualMemoryWrapper @ 0x1406B9E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReadVirtualMemoryWrapper(void *a1, void *a2, void *a3, SIZE_T a4, ULONG_PTR *NumberOfBytesRead)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1074);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v20 + 1) = a1;
    *((_QWORD *)&v18 + 1) = NumberOfBytesRead;
    *(_QWORD *)&v20 = a2;
    *((_QWORD *)&v19 + 1) = a3;
    *(_QWORD *)&v19 = a4;
  ...
  LODWORD(v21) = ZwReadVirtualMemory(a1, a2, a3, a4, NumberOfBytesRead);
  if ( v10 )
  {
