/*
 * XREFs of PopPowerAdapterReinitialize @ 0x1407DD830
 * Callers:
...
void __fastcall PopPowerAdapterReinitialize(__int64 a1)
{
  int v1; // r9d
  __int64 v3; // rcx
  NTSTATUS v4; // eax
  ...
  *(_DWORD *)(a1 + 172) = 0;
  ...
  v4 = IoSynchronousCallDriver(*(struct _DEVICE_OBJECT **)(a1 + 48), *(IRP **)(a1 + 56));
  if ( v4 >= 0 )
  {
    v5 = BYTE2(Buffer);
    *(_DWORD *)(a1 + 128) = 1;
    ...
    *(_BYTE *)(a1 + 216) = 0;
    ...
    if ( (unsigned int)dword_140E07560 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&byte_14004E80F,
        0LL,
        0LL,
        6u,
        &v44);
    ...
    if ( (unsigned int)dword_140E07560 > 5 && tlgKeywordOn((__int64)&dword_140E07560, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140E07560,
        (unsigned __int8 *)byte_14004E6D0,
        0LL,
        0LL,
        0xDu,
        &v22);
  ...
  else
  {
    ...
    *(_DWORD *)(a1 + 220) = 1;
    *(_DWORD *)(a1 + 228) = 0;
    PopPowerAdapterTraceFailure((_DWORD *)a1, 1, v4);
  }
}
