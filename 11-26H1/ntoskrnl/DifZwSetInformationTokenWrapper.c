/*
 * XREFs of DifZwSetInformationTokenWrapper @ 0x1406BE820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationTokenWrapper(void *a1, TOKEN_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(879);
  ...
  DWORD2(v20) = ZwSetInformationToken(a1, a2, a3, a4);
  if ( v9 )
  {
