/*
 * XREFs of WheapTrackPendingPage @ 0x14084A518
 * Callers:
...
char __fastcall WheapTrackPendingPage(struct _SINGLE_LIST_ENTRY *a1)
{
  ...
  if ( v2 > 0xA00000 )
    v2 = 10485760;
  if ( 16LL * *(int *)&CmpCallbackListLock.WaitBlockFill11[72] >= (unsigned __int64)v2 )
  {
    Src[0] = 1733060695;
    Src[1] = 1;
    Src[2] = 32;
  ...
  else
  {
    ...
    if ( Pool2 )
    {
      _InterlockedIncrement((volatile signed __int32 *)&CmpCallbackListLock.WaitBlockFill11[72]);
      Pool2[1].Next = a1;
