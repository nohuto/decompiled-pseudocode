/*
 * XREFs of AuthzBasepConvertRelativeToAbsoluteTokenAttribute @ 0x1404EA1F0
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  switch ( *((_WORD *)a1 + 2) )
  {
    ...
    case 3:
      v23 = 16 * v10;
      if ( (unsigned __int64)(16 * v10) > 0xFFFFFFFF || v23 + v18 < v18 )
        return (unsigned int)-1073741675;
      v18 += v23;
      for ( j = 0; j < a1[3]; ++j )
      {
...
LABEL_51:
      v27 = 8 * v10;
      if ( (unsigned __int64)(8 * v10) > 0xFFFFFFFF || v27 + v18 < v18 )
        return (unsigned int)-1073741675;
      v18 += v27;
...
LABEL_28:
  v19 = 16 * v10;
  if ( (unsigned __int64)(16 * v10) > 0xFFFFFFFF || v19 + v18 < v18 )
    return (unsigned int)-1073741675;
  v18 += v19;
