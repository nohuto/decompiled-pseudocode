/*
 * XREFs of DifZwCreatePartitionWrapper @ 0x1406A4450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePartitionWrapper(void *a1, HANDLE *a2, ACCESS_MASK a3, OBJECT_ATTRIBUTES *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(932);
  ...
  DWORD2(v20) = ZwCreatePartition(a1, a2, a3, a4, v18);
  if ( v9 )
  {
