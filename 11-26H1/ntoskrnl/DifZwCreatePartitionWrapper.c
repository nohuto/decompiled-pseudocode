/*
 * XREFs of DifZwCreatePartitionWrapper @ 0x1406A0870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePartitionWrapper(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
