/*
 * XREFs of TtmiLogSessionDisplayRequiredDereference @ 0x140ABCC3C
 * Callers:
...
void TtmiLogSessionDisplayRequiredDereference()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_1400524A7, 0LL, 0LL, 5u, &v6);
  }
}
