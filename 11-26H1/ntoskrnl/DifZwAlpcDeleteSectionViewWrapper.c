/*
 * XREFs of DifZwAlpcDeleteSectionViewWrapper @ 0x14069AFF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcDeleteSectionViewWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwAlpcDeleteSectionView(a1, a2, a3);
  if ( v8 )
  {
