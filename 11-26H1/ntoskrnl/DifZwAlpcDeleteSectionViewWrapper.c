/*
 * XREFs of DifZwAlpcDeleteSectionViewWrapper @ 0x14069EBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcDeleteSectionViewWrapper(HANDLE PortHandle, ULONG Flags, PVOID ViewBase)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(963);
  ...
  LODWORD(v19) = ZwAlpcDeleteSectionView(PortHandle, Flags, ViewBase);
  if ( v8 )
  {
