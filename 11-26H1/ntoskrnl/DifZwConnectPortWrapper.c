/*
 * XREFs of DifZwConnectPortWrapper @ 0x1406A15B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  v23 = ZwConnectPort(a1, a2, a3, a4, ServerView, MaxMessageLength, ConnectionInformation, ConnectionInformationLength);
  if ( v13 )
  {
