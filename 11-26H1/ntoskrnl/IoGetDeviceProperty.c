/*
 * XREFs of IoGetDeviceProperty @ 0x1409556D0
 * Callers:
        ...
        PULONG ResultLength)
{
  ...
  unsigned int v34; // [rsp+40h] [rbp-A8h] BYREF
  ...
  if ( v12 != 1 )
  {
    ...
    switch ( v12 )
    {
      ...
      case 11:
        ...
        if ( !Pool2 )
          return -1073741670;
        NameStringMode = ObQueryNameStringMode((__int64)DeviceObject, Pool2, v34, ResultLength, 0);
...
LABEL_19:
      ...
      case 15:
        ...
        goto LABEL_7;
      case 16:
        if ( (int)PpIrpQueryCapabilities(DeviceObject, v38) < 0 )
          return -1073741772;
        v23 = v39;
        if ( v39 == -1 )
          return -1073741772;
      ...
      case 19:
        *ResultLength = 4;
        if ( BufferLength < 4 )
          return -1073741789;
        LOBYTE(v9) = 1;
        PpHotSwapGetDevnodeRemovalPolicy(DeviceNode, v9, PropertyBuffer);
        return 0;
      case 20:
