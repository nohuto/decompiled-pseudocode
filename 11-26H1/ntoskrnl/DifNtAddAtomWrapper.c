/*
 * XREFs of DifNtAddAtomWrapper @ 0x14066DDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAddAtomWrapper(PWSTR AtomName, ULONG Length, PRTL_ATOM Atom)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(733);
  ...
  LODWORD(v19) = NtAddAtom(AtomName, Length, Atom);
  if ( v8 )
  {
