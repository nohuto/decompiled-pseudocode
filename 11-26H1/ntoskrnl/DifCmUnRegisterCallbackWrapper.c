/*
 * XREFs of DifCmUnRegisterCallbackWrapper @ 0x140651A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifCmUnRegisterCallbackWrapper(LARGE_INTEGER Cookie)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(427);
  ...
  LODWORD(v14) = CmUnRegisterCallback(Cookie);
  if ( v4 )
  {
