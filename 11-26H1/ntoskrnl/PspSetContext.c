/*
 * XREFs of PspSetContext @ 0x140A4D570
 * Callers:
 *     PspGetSetContextInternal @ 0x140A4CA50 (PspGetSetContextInternal.c)
 * Callees:
 *     RtlXRestoreS @ 0x1403D7DE0 (RtlXRestoreS.c)
 *     KiGetAllocatedXSaveArea @ 0x140473940 (KiGetAllocatedXSaveArea.c)
 *     RtlSanitizeDebugRegister @ 0x1404A5140 (RtlSanitizeDebugRegister.c)
...
__int64 __fastcall PspSetContext(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  if ( (v5 & 0x100040) == 0x100040 && a4 == 1 )
  {
    ...
    if ( AllocatedXSaveArea )
      RtlCopyXStateArea((__int64)AllocatedXSaveArea, MEMORY[0xFFFFF780000003E0] & 0xFFFFFFFFFFFFFFFCuLL, v17 + a3 + 720);
    else
      RtlXRestoreS(v17 + a3 + 720, (MEMORY[0xFFFFF780000003E0] | MEMORY[0xFFFFF78000000708]) & 0xFFFFFFFFFFFFFFFCuLL);
  }
  result = v5 & 0x100008;
  ...
  {
    *(_QWORD *)(a1 + 216) = RtlSanitizeDebugRegister(*(_QWORD *)(a3 + 72), a4);
    *(_QWORD *)(a1 + 224) = RtlSanitizeDebugRegister(*(_QWORD *)(a3 + 80), a4);
    *(_QWORD *)(a1 + 232) = RtlSanitizeDebugRegister(*(_QWORD *)(a3 + 88), a4);
    *(_QWORD *)(a1 + 240) = RtlSanitizeDebugRegister(*(_QWORD *)(a3 + 96), a4);
    *(_QWORD *)(a1 + 248) = 0LL;
    result = *(_QWORD *)(a3 + 112) & 0xFFFF0355LL;
