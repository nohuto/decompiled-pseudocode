/*
 * XREFs of DifZwApphelpCacheControlWrapper @ 0x14069FA80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwApphelpCacheControlWrapper(unsigned int a1, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1128);
  ...
  HIDWORD(v16) = ZwApphelpCacheControl(a1, a2);
  if ( v6 )
  {
