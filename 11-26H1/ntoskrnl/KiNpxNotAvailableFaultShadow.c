/*
 * XREFs of KiNpxNotAvailableFaultShadow @ 0x140C5F4C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall __noreturn KiNpxNotAvailableFaultShadow(__int64 a1, __int64 a2)
{
