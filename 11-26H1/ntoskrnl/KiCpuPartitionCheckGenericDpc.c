/*
 * XREFs of KiCpuPartitionCheckGenericDpc @ 0x1405F4330
 * Callers:
...
__int64 __fastcall KiCpuPartitionCheckGenericDpc(__int64 a1)
{
  ...
  result = *(_QWORD *)&stru_140FC01F0.WaitRegister.Flags;
  v2 = **(_WORD **)KiSystemCpuPartition;
  if ( v2 >= *(_WORD *)&stru_140FC01F0.WaitRegister.Flags )
  {
  ...
  {
    result = *(__int64 *)((char *)&stru_140FC01F0.116 + 8 * (unsigned __int16)i + 4);
