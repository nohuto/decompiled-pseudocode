/*
 * XREFs of BootApplicationPersistentDataInitialize @ 0x140CE3AA8
 * Callers:
...
void __fastcall BootApplicationPersistentDataInitialize(__int64 a1)
{
  ...
  qword_140E622C8 = &qword_140E622C0;
  qword_140E622C0 = (__int64)&qword_140E622C0;
    ...
    if ( *((_DWORD *)v3 + 6) )
    {
      ...
      *((_DWORD *)Pool2 + 6) = *((_DWORD *)v3 + 6);
      ...
      if ( *(__int64 **)qword_140E622C8 != &qword_140E622C0 )
        __fastfail(3u);
      *Pool2 = &qword_140E622C0;
      Pool2[1] = v6;
      *v6 = Pool2;
      qword_140E622C8 = Pool2;
    }
  }
}
