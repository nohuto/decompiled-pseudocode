/*
 * XREFs of DifNtQuerySecurityPolicyWrapper @ 0x140689290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQuerySecurityPolicyWrapper(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
...
LABEL_17:
  SecurityPolicy = NtQuerySecurityPolicy(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
