/*
 * XREFs of DifNtAllocateUserPhysicalPagesExWrapper @ 0x14066EF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAllocateUserPhysicalPagesExWrapper(
        void *a1,
        unsigned __int64 *a2,
        unsigned __int64 *a3,
        ...
        ULONG ExtendedParameterCount)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(779);
  ...
  LODWORD(v21) = NtAllocateUserPhysicalPagesEx(a1, a2, a3, a4, ExtendedParameterCount);
  if ( v10 )
  {
