/*
 * XREFs of DifNtAllocateUserPhysicalPagesExWrapper @ 0x14066B3B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAllocateUserPhysicalPagesExWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  LODWORD(v21) = NtAllocateUserPhysicalPagesEx(a1, a2, a3, a4, a5);
  if ( v10 )
  {
