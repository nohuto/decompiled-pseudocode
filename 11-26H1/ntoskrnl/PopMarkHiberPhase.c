/*
 * XREFs of PopMarkHiberPhase @ 0x140BFB160
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140F0FDB0, qword_140F0FDB8, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140F0FD78, (unsigned int)dword_140F0FD80, 0);
  v3 = (char *)(Address + 20);
