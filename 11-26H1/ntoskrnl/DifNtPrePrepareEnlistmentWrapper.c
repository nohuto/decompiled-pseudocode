/*
 * XREFs of DifNtPrePrepareEnlistmentWrapper @ 0x140683CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPrePrepareEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(835);
  ...
  DWORD2(v16) = NtPrePrepareEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
