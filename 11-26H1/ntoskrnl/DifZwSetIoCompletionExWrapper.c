/*
 * XREFs of DifZwSetIoCompletionExWrapper @ 0x1406BF010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetIoCompletionExWrapper(
        void *a1,
        void *a2,
        void *a3,
        void *a4,
...
LABEL_17:
  v26 = ZwSetIoCompletionEx(a1, a2, a3, a4, IoStatus, IoStatusInformation);
  if ( v11 )
  {
