/*
 * XREFs of DifZwSetIoCompletionExWrapper @ 0x1406BB430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetIoCompletionExWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, __int64 a6)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(987);
...
LABEL_17:
  v27 = ZwSetIoCompletionEx(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
