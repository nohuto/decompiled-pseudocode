/*
 * XREFs of DifNtOpenProcessWrapper @ 0x1406823C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenProcessWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, CLIENT_ID *a4)
{
  ...
  DWORD2(v20) = NtOpenProcess(a1, a2, a3, a4);
  if ( v9 )
  {
