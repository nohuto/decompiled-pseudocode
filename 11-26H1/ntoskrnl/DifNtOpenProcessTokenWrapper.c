/*
 * XREFs of DifNtOpenProcessTokenWrapper @ 0x140682240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenProcessTokenWrapper(HANDLE ProcessHandle, ACCESS_MASK DesiredAccess, PHANDLE TokenHandle)
{
  ...
  LODWORD(v19) = NtOpenProcessToken(ProcessHandle, DesiredAccess, TokenHandle);
  if ( v8 )
  {
