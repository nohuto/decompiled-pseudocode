/*
 * XREFs of DifZwPrePrepareEnlistmentWrapper @ 0x1406B24B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPrePrepareEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  DWORD2(v16) = ZwPrePrepareEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
