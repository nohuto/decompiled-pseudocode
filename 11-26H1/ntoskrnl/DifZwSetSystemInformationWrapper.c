/*
 * XREFs of DifZwSetSystemInformationWrapper @ 0x1406BBDB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetSystemInformationWrapper(unsigned int a1, __int64 a2, unsigned int a3)
{
  ...
  HIDWORD(v18) = ZwSetSystemInformation(a1, a2, a3);
  if ( v8 )
  {
