/*
 * XREFs of DifZwEnumerateKeyWrapper @ 0x1406A9050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateKeyWrapper(
        void *a1,
        ULONG a2,
        ...
        ULONG *ResultLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(104);
...
LABEL_17:
  LODWORD(v23) = ZwEnumerateKey(a1, a2, a3, a4, Length, ResultLength);
  if ( v11 )
  {
