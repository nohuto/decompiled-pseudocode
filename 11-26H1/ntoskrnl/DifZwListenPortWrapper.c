/*
 * XREFs of DifZwListenPortWrapper @ 0x1406AC550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwListenPortWrapper(HANDLE PortHandle, PPORT_MESSAGE ConnectionRequest)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(948);
  ...
  if ( APIThunkContextById )
  {
    ...
    *((_QWORD *)&v15 + 1) = ConnectionRequest;
  ...
  DWORD2(v16) = ZwListenPort(PortHandle, ConnectionRequest);
  if ( v6 )
  {
