/*
 * XREFs of TtmiLogSessionPowerRequestCreated @ 0x1407F0310
 * Callers:
...
void TtmiLogSessionPowerRequestCreated()
{
  ...
  if ( (unsigned int)dword_140FD68B8 > 5 && tlgKeywordOn((__int64)&dword_140FD68B8, 1LL) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD68B8, (unsigned __int8 *)&unk_140051E10, 0LL, 0LL, 5u, &v7);
  }
}
