/*
 * XREFs of MiEnumerateQuarantinedBadHugeRangePages @ 0x14052D548
 * Callers:
...
void __fastcall MiEnumerateQuarantinedBadHugeRangePages(__int64 a1)
{
  ...
  if ( qword_140E2EB68 )
  {
    while ( 1 )
    {
      ...
      v5 = ExAcquireSpinLockShared(&dword_140E2EB10);
      v6 = v5;
      if ( v1 >= qword_140E2EB68 )
        break;
      if ( v5 == 17 )
        ExReleaseSpinLockSharedFromDpcLevel(&dword_140E2EB10);
      else
        ExReleaseSpinLockShared(&dword_140E2EB10, v5);
