/*
 * XREFs of DifExEnterCriticalRegionAndAcquireSharedWaitForExclusiveWrapper @ 0x140655070
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifExEnterCriticalRegionAndAcquireSharedWaitForExclusiveWrapper(PERESOURCE Resource)
{
  ...
  v14 = ExEnterCriticalRegionAndAcquireSharedWaitForExclusive(Resource);
  if ( v4 )
  {
