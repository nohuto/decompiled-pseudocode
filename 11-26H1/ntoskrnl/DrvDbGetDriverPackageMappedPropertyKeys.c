/*
 * XREFs of DrvDbGetDriverPackageMappedPropertyKeys @ 0x14089E434
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  v11 = a5;
  *v6 = 0;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (__int64)&off_140E0A450, 0x10u, a4, v7, v36);
