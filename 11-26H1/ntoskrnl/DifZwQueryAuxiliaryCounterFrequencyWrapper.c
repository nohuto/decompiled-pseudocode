/*
 * XREFs of DifZwQueryAuxiliaryCounterFrequencyWrapper @ 0x1406B35A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryAuxiliaryCounterFrequencyWrapper(PLARGE_INTEGER AuxiliaryCounterFrequency)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1031);
  ...
  LODWORD(v14) = ZwQueryAuxiliaryCounterFrequency(AuxiliaryCounterFrequency);
  if ( v4 )
  {
