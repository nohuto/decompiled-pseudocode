/*
 * XREFs of DifZwQueryAuxiliaryCounterFrequencyWrapper @ 0x1406AF9C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryAuxiliaryCounterFrequencyWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = ZwQueryAuxiliaryCounterFrequency(a1);
  if ( v4 )
  {
