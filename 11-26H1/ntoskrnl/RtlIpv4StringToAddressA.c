/*
 * XREFs of RtlIpv4StringToAddressA @ 0x1404C3900
 * Callers:
  ...
  if ( !Strict )
  {
    ...
    if ( v21 )
    {
      ...
      if ( v27 <= 0xFF && v28 <= 0xFF && v29 <= 0xFFFF )
      {
        ...
        v18 = ((v27 << 8) | (unsigned __int8)v28) << 16;
        goto LABEL_27;
      }
    }
    else if ( v27 <= 0xFF && v28 <= 0xFFFFFF )
    {
      v18 = v27 << 24;
      v17 = v28 & 0xFFFFFF;
      goto LABEL_27;
...
LABEL_17:
  ...
  v16 = (_DWORD)v15 == 4;
LABEL_21:
  if ( !v16 || v27 > 0xFF || v28 > 0xFF || v29 > 0xFF || v30 > 0xFF )
    goto LABEL_17;
  v17 = (unsigned __int8)v30;
  v18 = ((unsigned __int8)v29 | (((v27 << 8) | (unsigned __int8)v28) << 8)) << 8;
LABEL_27:
  v19 = v17 | v18;
LABEL_28:
  *Terminator = S;
