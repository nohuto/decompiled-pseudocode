/*
 * XREFs of DifNtRollforwardTransactionManagerWrapper @ 0x14068DF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRollforwardTransactionManagerWrapper(
        ...
        PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(822);
  ...
  DWORD2(v16) = NtRollforwardTransactionManager(TransactionManagerHandle, TmVirtualClock);
  if ( v6 )
  {
