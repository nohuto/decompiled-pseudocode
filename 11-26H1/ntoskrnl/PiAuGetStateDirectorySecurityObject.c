/*
 * XREFs of PiAuGetStateDirectorySecurityObject @ 0x1407AB2C0
 * Callers:
...
__int64 __fastcall PiAuGetStateDirectorySecurityObject(char a1, _QWORD *a2)
{
  ...
  v7 = 2 * (RtlLengthSid(*(PSID *)((char *)&RtlpBootStatHandleLock.116 + 4)) + v6) + 56;
  ...
  if ( Pool2 )
  {
    ...
    if ( Acl >= 0 )
    {
      Acl = RtlpAddKnownAce((int)v9, 2, 3, 1245599, *(void **)((char *)&RtlpBootStatHandleLock.116 + 4), 0);
      if ( Acl >= 0 )
      {
        Acl = RtlpAddKnownAce((int)v9, 2, 2, 32, *(void **)((char *)&RtlpBootStatHandleLock.116 + 4), 0);
        if ( Acl >= 0 )
        {
