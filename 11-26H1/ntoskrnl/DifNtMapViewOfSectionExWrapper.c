/*
 * XREFs of DifNtMapViewOfSectionExWrapper @ 0x14067B990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtMapViewOfSectionExWrapper(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        int a9)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(763);
...
LABEL_17:
  v33 = NtMapViewOfSectionEx(a1, a2, a3, a4, a5, a6, a7, a8, a9);
  if ( v14 )
  {
