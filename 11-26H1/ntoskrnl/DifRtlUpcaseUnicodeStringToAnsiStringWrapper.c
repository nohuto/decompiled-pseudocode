/*
 * XREFs of DifRtlUpcaseUnicodeStringToAnsiStringWrapper @ 0x14069A530
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v19) = RtlUpcaseUnicodeStringToAnsiString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
