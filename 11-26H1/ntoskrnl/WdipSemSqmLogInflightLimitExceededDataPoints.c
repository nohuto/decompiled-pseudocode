/*
 * XREFs of WdipSemSqmLogInflightLimitExceededDataPoints @ 0x140AD8F0C
 * Callers:
        ...
        struct _KLOCK_ENTRIES *a4)
{
  ...
  v6 = (AutoBoost *)KeAbPreAcquire((__int64)&stru_140F066E8, 0LL, 0LL, a4);
  v9 = _interlockedbittestandset64(&stru_140F066E8.Header.Lock, 0LL);
  v10 = v6;
  if ( v9 )
    ExfAcquirePushLockExclusiveEx((unsigned __int64 *)&stru_140F066E8, v6, (__int64)&stru_140F066E8);
  if ( v10 )
  {
  ...
  v11 = (unsigned int)dword_140F066E0;
  if ( dword_140F066E0 )
  {
    v15 = WdipSemSqmIncrementDword(v8, dword_140F066E0);
    if ( v15 >= 0 )
      v5 = v15;
    if ( (_DWORD)v11 )
    {
      p_AffinityVersion = (__int64 *)&stru_140F060A8.AffinityVersion;
      do
      {
        v17 = *p_AffinityVersion;
        if ( (int)WdipSemGetGuidKey(*p_AffinityVersion, &v18) >= 0 )
        {
          v19[0] = v18;
