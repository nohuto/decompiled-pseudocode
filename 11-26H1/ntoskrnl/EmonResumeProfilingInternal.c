/*
 * XREFs of EmonResumeProfilingInternal @ 0x140598E3C
 * Callers:
 *     EmonResumeProfiling @ 0x140598E00 (EmonResumeProfiling.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall EmonResumeProfilingInternal(int a1, int a2)
{
  __int64 result; // rax
  __int64 v3; // r8
  int v4; // ecx
