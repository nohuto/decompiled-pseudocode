/*
 * XREFs of DifNtRecoverEnlistmentWrapper @ 0x14068BDC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRecoverEnlistmentWrapper(HANDLE EnlistmentHandle, PVOID EnlistmentKey)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(834);
  ...
  DWORD2(v16) = NtRecoverEnlistment(EnlistmentHandle, EnlistmentKey);
  if ( v6 )
  {
