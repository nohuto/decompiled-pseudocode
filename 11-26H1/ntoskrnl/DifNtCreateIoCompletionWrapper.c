/*
 * XREFs of DifNtCreateIoCompletionWrapper @ 0x140671010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateIoCompletionWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtCreateIoCompletion(
                  a1,
                  a2,
                  a3,
                  a4,
