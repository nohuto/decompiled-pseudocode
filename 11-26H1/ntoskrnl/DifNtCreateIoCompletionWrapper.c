/*
 * XREFs of DifNtCreateIoCompletionWrapper @ 0x140674BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateIoCompletionWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(644);
  ...
  DWORD2(v20) = NtCreateIoCompletion(a1, a2, a3, a4);
  if ( v9 )
  {
