/*
 * XREFs of DifNtSetInformationThreadWrapper @ 0x140690350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationThreadWrapper(void *a1, THREADINFOCLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(533);
  ...
  DWORD2(v20) = NtSetInformationThread(a1, a2, a3, a4);
  if ( v9 )
  {
