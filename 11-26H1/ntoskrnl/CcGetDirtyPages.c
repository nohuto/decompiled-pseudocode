/*
 * XREFs of CcGetDirtyPages @ 0x140258290
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Context2)
{
  ...
  while ( 1 )
  {
    ...
    if ( !NextPartitionUnsafe )
      return v16;
    v8 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&EmpParseLock.ReadOperationCount);
...
LABEL_6:
    ...
    KeReleaseSpinLock((PKSPIN_LOCK)&EmpParseLock.ReadOperationCount, v10);
    if ( v5 )
    {
