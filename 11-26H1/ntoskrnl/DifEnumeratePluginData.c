/*
 * XREFs of DifEnumeratePluginData @ 0x140640A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifEnumeratePluginData(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, unsigned int *a5)
{
  ...
  for ( i = 0LL; (unsigned int)i < dword_140F08D98; i = (unsigned int)(i + 1) )
  {
    v9 = 192 * i;
    ViAvlAcquireTableLockAtDpcLevelSafe(192 * i + qword_140F08D90, (__int64)&v15);
    for ( j = 1; ; j = 0 )
    {
      v12 = RtlEnumerateGenericTableAvl((PRTL_AVL_TABLE)(v9 + qword_140F08D90), j);
      if ( !v12 || v6 >= a2 )
        break;
      v11 = (_QWORD *)v12[8];
      if ( v11 )
    ...
    ViAvlReleaseTableLockFromDpcLevel(v9 + qword_140F08D90, (__int64)&v15);
  }
