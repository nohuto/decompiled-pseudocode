/*
 * XREFs of sub_140713090 @ 0x140713090
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsQueryThreadTerminationPort @ 0x14077FC00 (PsQueryThreadTerminationPort.c)
 *     KeRundownApcQueues @ 0x140955B24 (KeRundownApcQueues.c)
 */

void __fastcall __noreturn sub_140713090(__int64 a1, __int64 a2)
{
  ...
  *ThreadTerminationPort = 0LL;
  ...
  while ( 1 )
  {
    ...
    do
    {
      ...
      v26 = *(_QWORD *)v24;
      *(_QWORD *)v24 = v21
                     + ((unsigned __int64)stru_140FC01F0.WaitBlock[2].WaitListEntry.Flink ^ _byteswap_uint64(v22 ^ __ROL8__(KiWaitNever ^ *(_QWORD *)v24, KiWaitNever)))
                     + v23;
