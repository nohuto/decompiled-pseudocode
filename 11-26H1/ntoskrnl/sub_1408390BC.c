/*
 * XREFs of sub_1408390BC @ 0x1408390BC
 * Callers:
...
__int64 __fastcall sub_1408390BC(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  NTSTATUS v5; // edi
  char v6; // r15
  ...
  if ( *(_QWORD *)(a1 + 46832) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v5 = ZwSetValueKey(
             KeyHandle,
             (PUNICODE_STRING)&stru_140BD9C28,
             0,
             3u,
             *(PVOID *)(a1 + 46832),
             **(_DWORD **)(a1 + 46832));
