/*
 * XREFs of DifZwPrepareCompleteWrapper @ 0x1406B2620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPrepareCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  DWORD2(v16) = ZwPrepareComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
