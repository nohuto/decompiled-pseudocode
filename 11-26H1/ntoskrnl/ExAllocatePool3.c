/*
 * XREFs of ExAllocatePool3 @ 0x140C10010
 * Callers:
 ...
 *     ?StDmCombineRegion@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x140211BB0 (-StDmCombineRegion@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z.c)
 ...
 *     ?NpNodeAllocate@NP_CONTEXT@@SAPEAXPEAUNP_CTX@1@KK@Z @ 0x1403F1C5C (-NpNodeAllocate@NP_CONTEXT@@SAPEAXPEAUNP_CTX@1@KK@Z.c)
  ...
  *(_OWORD *)v27 = 0LL;
  ...
  while ( v17 < a5 )
  {
    ...
    if ( v19 == 4 )
    {
      ...
      if ( v20 )
      {
        v21 = (_DWORD *)((unsigned __int64)&dword_140E6BC60 ^ qword_140E6BCA8 ^ v20);
        if ( *v21 == -1347437123 )
          v11 = (__int64)v21;
      }
      v22 = v11 == 0;
...
LABEL_19:
  ...
  if ( v12 )
  {
    if ( *v12 && *(_DWORD *)((unsigned __int64)&dword_140E6BC60 ^ qword_140E6BCA8 ^ *v12) == -1381122884 )
    {
      v16 = -1073741670;
LABEL_7:
      if ( (v7 & 0x20) != 0 )
