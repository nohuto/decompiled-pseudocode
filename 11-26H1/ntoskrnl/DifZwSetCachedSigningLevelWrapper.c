/*
 * XREFs of DifZwSetCachedSigningLevelWrapper @ 0x1406BCA90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetCachedSigningLevelWrapper(
        ULONG a1,
        SE_SIGNING_LEVEL a2,
        HANDLE *a3,
        ULONG a4,
        HANDLE TargetFile)
{
  ...
  DWORD2(v21) = ZwSetCachedSigningLevel(a1, a2, a3, a4, TargetFile);
  if ( v10 )
  {
