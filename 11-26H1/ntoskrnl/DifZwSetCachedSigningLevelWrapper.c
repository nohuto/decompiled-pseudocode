/*
 * XREFs of DifZwSetCachedSigningLevelWrapper @ 0x1406B8EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetCachedSigningLevelWrapper(unsigned int a1, char a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(892);
  ...
  LOBYTE(v9) = a2;
  DWORD2(v21) = ZwSetCachedSigningLevel(a1, v9, a3, a4, a5);
  if ( v10 )
  {
