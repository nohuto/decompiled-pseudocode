/*
 * XREFs of DifNtAlertMultipleThreadByThreadIdWrapper @ 0x14066E830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlertMultipleThreadByThreadIdWrapper(
        volatile void *a1,
        unsigned int a2,
        volatile void *a3,
        int a4)
{
  ...
  DWORD2(v20) = NtAlertMultipleThreadByThreadId(a1, a2, a3);
  if ( v9 )
  {
