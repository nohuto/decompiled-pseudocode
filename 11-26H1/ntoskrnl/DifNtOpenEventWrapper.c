/*
 * XREFs of DifNtOpenEventWrapper @ 0x14067D020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenEventWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(677);
  ...
  LODWORD(v19) = NtOpenEvent(a1, a2, a3);
  if ( v8 )
  {
