/*
 * XREFs of DifZwCreateSectionExWrapper @ 0x1406A19A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateSectionExWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4,
        ...
        int a9)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1060);
...
LABEL_17:
  Section = ZwCreateSectionEx(a1, a2, a3, a4, a5, a6, a7, a8, a9);
  if ( v14 )
  {
