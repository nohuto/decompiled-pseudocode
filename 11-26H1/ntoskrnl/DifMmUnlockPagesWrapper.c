/*
 * XREFs of DifMmUnlockPagesWrapper @ 0x14066C260
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmUnlockPagesWrapper(PMDL MemoryDescriptorList)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(212);
