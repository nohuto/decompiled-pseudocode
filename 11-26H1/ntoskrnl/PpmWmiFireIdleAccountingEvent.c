/*
 * XREFs of PpmWmiFireIdleAccountingEvent @ 0x14060FAB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PpmWmiFireIdleAccountingEvent(__int64 a1)
{
  ...
  v1 = a1 + 34880;
  if ( *(_QWORD *)(a1 + 34880) && (v2 = *(_DWORD **)(a1 + 34888)) != 0LL && *(_DWORD *)(a1 + 35136) )
  {
    v3 = PpmAllocWmiEvent((PDEVICE_OBJECT)(a1 + 35128), (__int128 *)&PPM_IDLE_ACCOUNTING_EX_GUID, 416 * *v2 + 24);
    v4 = (void *)v3;
    if ( v3 )
    {
