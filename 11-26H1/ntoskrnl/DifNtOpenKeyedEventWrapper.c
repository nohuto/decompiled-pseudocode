/*
 * XREFs of DifNtOpenKeyedEventWrapper @ 0x140681880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyedEventWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(721);
  ...
  LODWORD(v19) = NtOpenKeyedEvent(KeyedEventHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
