/*
 * XREFs of DifNtOpenKeyedEventWrapper @ 0x14067DCA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyedEventWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenKeyedEvent(a1, a2, a3);
  if ( v8 )
  {
