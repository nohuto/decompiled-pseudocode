/*
 * XREFs of DifZwPssCaptureVaSpaceBulkWrapper @ 0x1406B3110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPssCaptureVaSpaceBulkWrapper(
        void *a1,
        void *a2,
        ...
        ULONG_PTR *ReturnLength)
{
  ...
  LODWORD(v21) = ZwPssCaptureVaSpaceBulk(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
