/*
 * XREFs of DifIofCallDriverWrapper @ 0x1406C40F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIofCallDriverWrapper(__int64 a1, ULONG_PTR a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(0x10000000);
  ...
  DWORD2(v16) = IopfCallDriver(a1, a2);
  if ( v6 )
  {
