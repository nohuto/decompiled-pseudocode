/*
 * XREFs of DifNtChangeProcessStateWrapper @ 0x1406724D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtChangeProcessStateWrapper(
        void *a1,
        void *a2,
...
LABEL_17:
  ...
  LODWORD(v25) = NtChangeProcessState(a1, a2, a3, a4, ExtendedInformationLength, Reserved);
  if ( v11 )
  {
