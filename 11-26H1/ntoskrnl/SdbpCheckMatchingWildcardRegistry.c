/*
 * XREFs of SdbpCheckMatchingWildcardRegistry @ 0x140889E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SdbpCheckMatchingWildcardRegistry(_DWORD *a1, __int64 a2, int a3, __int64 a4, int a5, __int64 a6)
{
  ...
  *a1 = 0;
  ...
  if ( (unsigned int)SdbpGetRegistryMatchingAttributes(
                       ...
                       (__int64)&v14) )
  {
    if ( (unsigned int)SdbpCheckMatchingWildcardRegistryEntry(v19, v18, v12, v17, v20, v16, v15, v14, (__int64)&v13) )
    {
      v7 = 1;
      *(_DWORD *)(a6 + 80) = 1;
      *a1 = v13;
