/*
 * XREFs of DifNtSetIoCompletionWrapper @ 0x14068D2C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetIoCompletionWrapper(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(647);
  ...
  LODWORD(v21) = NtSetIoCompletion(a1, a2, a3, a4, a5);
  if ( v10 )
  {
