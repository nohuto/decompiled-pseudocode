/*
 * XREFs of DifNtSetIoCompletionWrapper @ 0x140690EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetIoCompletionWrapper(
        void *a1,
        void *a2,
        void *a3,
        NTSTATUS a4,
        ULONG_PTR IoStatusInformation)
{
  ...
  LODWORD(v21) = NtSetIoCompletion(a1, a2, a3, a4, IoStatusInformation);
  if ( v10 )
  {
