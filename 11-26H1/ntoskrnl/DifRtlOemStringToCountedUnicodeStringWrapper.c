/*
 * XREFs of DifRtlOemStringToCountedUnicodeStringWrapper @ 0x1406998A0
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v19) = RtlOemStringToCountedUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
