  ...
  if ( IommuInterfaceStateChangeCallbackPushLock.PriorityFloorCounts[24] )
  {
    ...
    if ( ((_DWORD)a2
       || (MaximumRegisteredProcessorCount = HalpQueryMaximumRegisteredProcessorCount(),
           (int)KeAllocateProcessorProfileStructures(
                  ...
                  4096LL,
                  (_PROCESSOR_PROFILE_CONTROL_AREA **)&IommuInterfaceStateChangeCallbackPushLock.PriorityFloorCounts[8],
                  1) >= 0))
      && (v17 = (_PROCESSOR_PROFILE_CONTROL_AREA *)(*(_QWORD *)&IommuInterfaceStateChangeCallbackPushLock.PriorityFloorCounts[8]
                                                  + 160 * v2),
          (int)KeAllocateProcessorProfileStructures(0, 0LL, &v17, 0) >= 0) )
    {
      ...
      if ( IommuInterfaceStateChangeCallbackPushLock.PriorityFloorCounts[25] )
      {
        ...
        v11->PebsDsSaveArea.As32Bit.PebsGpCounterReset[2] = v14 + v7;
