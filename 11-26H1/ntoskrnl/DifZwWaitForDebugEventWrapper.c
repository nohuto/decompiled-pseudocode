/*
 * XREFs of DifZwWaitForDebugEventWrapper @ 0x1406BF180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWaitForDebugEventWrapper(__int64 a1, char a2, __int64 a3, __int64 a4)
{
  ...
  LOBYTE(v8) = a2;
  DWORD2(v20) = ZwWaitForDebugEvent(
                  a1,
                  v8,
                  a3,
                  a4,
