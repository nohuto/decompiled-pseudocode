/*
 * XREFs of _output_s @ 0x14053CEA0
 * Callers:
 ...
 *     write_multi_char_0 @ 0x14053A200 (write_multi_char_0.c)
 *     write_string_0 @ 0x14053A258 (write_string_0.c)
...
__int64 __fastcall output_s(FILE *a1, char *a2, unsigned __int16 *a3)
{
  ...
  int v43; // eax
  int v44; // edx
  char v46[4]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  do
  {
    ...
    if ( (unsigned __int8)(v9 - 32) > 0x5Au )
      ...
      v13 = *((_BYTE *)&_lookuptable_s[-4] + v9) & 0xF;
    v14 = (unsigned int)(v13 + v11 + 8 * v13);
    v11 = *((unsigned __int8 *)_lookuptable_s + v14) >> 4;
    v52 = v11;
    switch ( v11 )
    {
      case 8:
...
LABEL_154:
                  ...
                  {
                    v41 = 0x120820001LL;
                    if ( _bittest64(&v41, v14) )
                      goto LABEL_186;
                  }
                  v52 = 0;
LABEL_158:
                  v51 = 0;
                  write_char_0(v9, v3, &v48);
LABEL_185:
                  v11 = v52;
                  goto LABEL_186;
                }
...
LABEL_114:
                  ...
                  if ( (v5 & 0xC) == 0 )
                  {
                    write_multi_char_0(32, v34, v54, &v48);
                    v33 = v47;
                  }
                  write_string_0(v46, v33, v54, &v48);
                  v35 = v54;
                  if ( (v5 & 0xC) == 8 )
                    write_multi_char_0(48, v34, v54, &v48);
                  if ( v51 && (int)v10 > 0 )
                  {
                    LODWORD(v57) = 0;
                    ...
                    while ( 1 )
                    {
                      ...
                      if ( (unsigned int)safecrt_wctomb_s(&v57, v62, 6LL, v38) || !(_DWORD)v57 )
                        break;
                      write_string_0(v62, (int)v57, v54, &v48);
                      if ( !v37 )
                        goto LABEL_127;
                    }
                    v48 = -1;
LABEL_127:
                  ...
                  {
                    write_string_0(v7, v10, v35, &v48);
                  }
                  if ( v48 >= 0 && (v5 & 4) != 0 )
                  {
                    write_multi_char_0(32, v34, v35, &v48);
                    v6 = v49;
                  }
                  else
                  {
...
LABEL_50:
              ...
              a3 += 4;
              if ( *(_QWORD *)v12 && (v7 = (char *)*((_QWORD *)v17 + 1)) != 0LL )
              {
                v18 = *v17;
...
LABEL_89:
          ...
          v31 = (unsigned int)&v60 + 367 - (_DWORD)i;
          v49 = v6;
          v50 = v31;
          v7 = i + 1;
          LODWORD(v10) = v31;
