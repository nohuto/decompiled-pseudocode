/*
 * XREFs of DifZwSetIRTimerWrapper @ 0x1406BD390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetIRTimerWrapper(HANDLE TimerHandle, PLARGE_INTEGER DueTime)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1017);
  ...
  DWORD2(v16) = ZwSetIRTimer(TimerHandle, DueTime);
  if ( v6 )
  {
