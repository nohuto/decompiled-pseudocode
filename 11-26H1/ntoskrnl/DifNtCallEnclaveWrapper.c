/*
 * XREFs of DifNtCallEnclaveWrapper @ 0x140671A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCallEnclaveWrapper(LPVOID (__cdecl *a1)(LPVOID), void *a2, ULONG a3, PVOID *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(760);
  ...
  DWORD2(v20) = NtCallEnclave(a1, a2, a3, a4);
  if ( v9 )
  {
