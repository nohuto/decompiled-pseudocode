/*
 * XREFs of DifNtCallEnclaveWrapper @ 0x14066DE80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCallEnclaveWrapper(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
