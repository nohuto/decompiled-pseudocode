/*
 * XREFs of RtlQueryPackageIdentityEx @ 0x1404602F0
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  v21 = 0LL;
  v20 = 0LL;
  v10 = (_QWORD *)((unsigned __int64)&v21 & -(__int64)(a7 != 0LL));
  ...
  if ( a2 )
  {
    if ( a3 )
    {
      v14 = RtlStringCbPrintfExW(a2, *a3, &ppszDestEnd, &pcbRemaining, 0x800u, L"%wZ", *(_QWORD *)(v15 + 32));
      if ( v14 < 0 )
        return (unsigned int)v14;
      v15 = v27;
...
LABEL_14:
  ...
  {
    v16 = v23;
    v14 = RtlStringCbPrintfExW(a4, *v23, &v20, 0LL, 0x800u, L"%wZ", *(_QWORD *)(v15 + 32) + 16LL);
    if ( v14 < 0 )
      return (unsigned int)v14;
    v15 = v27;
    *v16 = (char *)v20 - (char *)a4 + 2;
  }
  if ( Guid )
  {
    *Guid = 0LL;
