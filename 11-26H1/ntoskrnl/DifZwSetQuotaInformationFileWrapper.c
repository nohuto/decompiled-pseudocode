/*
 * XREFs of DifZwSetQuotaInformationFileWrapper @ 0x1406BF370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetQuotaInformationFileWrapper(void *a1, struct _IO_STATUS_BLOCK *a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(970);
  ...
  DWORD2(v20) = ZwSetQuotaInformationFile(a1, a2, a3, a4);
  if ( v9 )
  {
