/*
 * XREFs of RtlCompressBufferDeflateInternal @ 0x140624B28
 * Callers:
 *     RtlCompressBufferDeflateRaw @ 0x140624C30 (RtlCompressBufferDeflateRaw.c)
 *     RtlCompressBufferDeflateZlib @ 0x140624C80 (RtlCompressBufferDeflateZlib.c)
 * Callees:
