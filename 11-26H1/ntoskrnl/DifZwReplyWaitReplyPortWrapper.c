/*
 * XREFs of DifZwReplyWaitReplyPortWrapper @ 0x1406B79A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplyWaitReplyPortWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwReplyWaitReplyPort(a1, a2);
  if ( v6 )
  {
