/*
 * XREFs of DifZwReplyWaitReplyPortWrapper @ 0x1406BB580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplyWaitReplyPortWrapper(HANDLE PortHandle, PPORT_MESSAGE ReplyMessage)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(952);
  ...
  DWORD2(v16) = ZwReplyWaitReplyPort(PortHandle, ReplyMessage);
  if ( v6 )
  {
