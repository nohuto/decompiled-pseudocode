/*
 * XREFs of _CmMergeFilterLists @ 0x140B54D7C
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  while ( 1 )
  {
    FilterListInflectionPoint = (const wchar_t *)CmFindFilterListInflectionPoint(v6, v7, a3);
    ...
    if ( !FilterListInflectionPoint )
      break;
    v23 = wcsicmp(FilterListInflectionPoint, Str2a);
    a3 = Str2a;
    v24 = v23 == 0;
    v6 = Str1a;
    if ( !v24 )
