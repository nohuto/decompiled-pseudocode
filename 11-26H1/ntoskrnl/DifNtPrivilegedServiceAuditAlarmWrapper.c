/*
 * XREFs of DifNtPrivilegedServiceAuditAlarmWrapper @ 0x140684470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPrivilegedServiceAuditAlarmWrapper(
        UNICODE_STRING *a1,
        UNICODE_STRING *a2,
        void *a3,
        ...
        BOOLEAN AccessGranted)
{
  ...
  LODWORD(v21) = NtPrivilegedServiceAuditAlarm(a1, a2, a3, a4, AccessGranted);
  if ( v10 )
  {
