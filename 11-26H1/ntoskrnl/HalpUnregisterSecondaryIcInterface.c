/*
 * XREFs of HalpUnregisterSecondaryIcInterface @ 0x140592240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpUnregisterSecondaryIcInterface(int a1, int a2, __int64 a3)
{
  ...
  HalpReleaseHighLevelLock(&SecondaryIcListSpinLock, v6);
  if ( v8 )
  {
    ...
    {
      LOBYTE(v10) = 1;
      HalpReleaseSecondaryIcEntryShared((__int64)v8, v10);
    }
  }
  else
  {
