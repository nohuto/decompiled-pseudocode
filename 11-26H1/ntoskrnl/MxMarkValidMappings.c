/*
 * XREFs of MxMarkValidMappings @ 0x140CFA428
 * Callers:
  ...
  if ( (unsigned __int64)a1 <= a2 )
  {
    ...
    do
    {
      ...
      if ( (*(_QWORD *)v7 & 1) != 0 )
      {
        ...
        if ( v12 != v8 )
        {
          IsRegularMemory = MxIsRegularMemory(a4, (*(_QWORD *)(v11 - 0x98000000000LL) >> 12) & 0xFFFFFFFFFFLL);
          if ( IsRegularMemory )
            *(_DWORD *)(IsRegularMemory + 28) |= 1u;
          v8 = v12;
        }
        v14 = 1LL;
        if ( !a3 )
