/*
 * XREFs of DifNtContinueExWrapper @ 0x140673180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtContinueExWrapper(PCONTEXT ContextRecord, PVOID ContinueArgument)
{
  ...
  DWORD2(v16) = NtContinueEx(ContextRecord, ContinueArgument);
  if ( v6 )
  {
