/*
 * XREFs of __asan_load4_volatile @ 0x1405E1850
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_load4_volatile(ULONG_PTR BugCheckParameter1)
{
  signed __int8 v2; // cl
  char v3; // dl
  char v4; // al
...
LABEL_14:
  ...
  if ( KcsaniValidationEnabled )
    KcsanValidateAddress(BugCheckParameter1, 4, 0, 1, retaddr);
}
