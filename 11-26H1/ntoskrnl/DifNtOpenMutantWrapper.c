/*
 * XREFs of DifNtOpenMutantWrapper @ 0x140681A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenMutantWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(687);
  ...
  LODWORD(v19) = NtOpenMutant(MutantHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
