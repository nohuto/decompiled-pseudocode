/*
 * XREFs of DifNtOpenMutantWrapper @ 0x14067DE20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenMutantWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenMutant(a1, a2, a3);
  if ( v8 )
  {
