/*
 * XREFs of sub_1409ED5D0 @ 0x1409ED5D0
 * Callers:
...
__int64 __fastcall sub_1409ED5D0(__int64 a1, __int64 a2, _QWORD *a3, struct _KLOCK_ENTRIES *a4)
{
...
LABEL_19:
  ...
  if ( v18 && ($7A85BAF4F1FA08634C1C4A3E45B775B3 *)v17->ApcState.ApcListHead[0].Flink != &v17->152 )
    KiCheckForKernelApcDelivery((__int64)v17, v16);
  if ( v15 == -1073741198 )
  {
    v15 = sub_1409EE290(a1, v28, &v27);
    if ( v15 < 0 )
    {
      v8 = v27;
      goto LABEL_28;
    ...
    v8 = v27;
    v15 = sub_1409EEB98((int)a1 + 88, (_DWORD)v27, v25, *v27, 8, -1);
    if ( v15 >= 0 )
      _InterlockedIncrement64(v8 + 1);
...
LABEL_28:
  if ( v8
    ...
    && (int)sub_1409ED8B0(a1, v8, 0xFFFFFFFFLL) >= 0 )
  {
    v21 = (void *)v8[3];
    if ( v21 )
