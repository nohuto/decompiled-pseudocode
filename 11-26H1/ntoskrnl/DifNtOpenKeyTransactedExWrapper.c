/*
 * XREFs of DifNtOpenKeyTransactedExWrapper @ 0x14067D7E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyTransactedExWrapper(__int64 a1, int a2, __int64 a3, int a4, HANDLE Handle)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(800);
  ...
  LODWORD(v21) = NtOpenKeyTransactedEx(a1, a2, a3, a4, Handle);
  if ( v10 )
  {
