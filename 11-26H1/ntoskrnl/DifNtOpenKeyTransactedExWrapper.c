/*
 * XREFs of DifNtOpenKeyTransactedExWrapper @ 0x1406813C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyTransactedExWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        HANDLE TransactionHandle)
{
  ...
  LODWORD(v21) = NtOpenKeyTransactedEx(a1, a2, a3, a4, TransactionHandle);
  if ( v10 )
  {
