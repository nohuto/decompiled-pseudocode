/*
 * XREFs of MiStopHugePageAccessor @ 0x14048E1B4
 * Callers:
...
_QWORD *__fastcall MiStopHugePageAccessor(ULONG_PTR *BugCheckParameter2, int a2)
{
  ...
  v2 = 0LL;
  v4 = ((__int64)BugCheckParameter2 - *(_QWORD *)((char *)&stru_140E2EB88.116 + 4)) >> 3;
  if ( !a2 )
  {
  ...
  ExAcquireSpinLockSharedAtDpcLevel(&dword_140E2EA70);
  v6 = (_QWORD *)qword_140E2EA78;
  v7 = 0LL;
  while ( v6 )
  {
    v7 = v6;
...
LABEL_33:
  ...
  *BugCheckParameter2 &= ~0x800000000000000uLL;
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140E2EA70);
  if ( v2 )
