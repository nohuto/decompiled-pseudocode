/*
 * XREFs of DifZwQueryInformationTransactionWrapper @ 0x1406B5B60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationTransactionWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = ZwQueryInformationTransaction(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
