/*
 * XREFs of DifNtSetDriverEntryOrderWrapper @ 0x14068AE60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetDriverEntryOrderWrapper(volatile void *Address, int a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(675);
  ...
  DWORD2(v16) = NtSetDriverEntryOrder(Address);
  if ( v6 )
  {
