/*
 * XREFs of DifNtSetDriverEntryOrderWrapper @ 0x14068EA40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetDriverEntryOrderWrapper(PULONG Ids, ULONG Count)
{
  ...
  DWORD2(v16) = NtSetDriverEntryOrder(Ids, Count);
  if ( v6 )
  {
