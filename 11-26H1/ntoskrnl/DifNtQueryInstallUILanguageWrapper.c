/*
 * XREFs of DifNtQueryInstallUILanguageWrapper @ 0x1406878C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInstallUILanguageWrapper(LANGID *InstallUILanguageId)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(729);
  ...
  if ( APIThunkContextById )
  {
    ...
    v6 = 0;
    *((_QWORD *)&v13 + 1) = InstallUILanguageId;
  ...
  LODWORD(v14) = NtQueryInstallUILanguage(InstallUILanguageId);
  if ( v4 )
  {
