/*
 * XREFs of DifNtQueryInstallUILanguageWrapper @ 0x140683CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInstallUILanguageWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = NtQueryInstallUILanguage(a1);
  if ( v4 )
  {
