/*
 * XREFs of DifNtAlpcDeleteSectionViewWrapper @ 0x140670700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcDeleteSectionViewWrapper(HANDLE PortHandle, ULONG Flags, PVOID ViewBase)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(605);
  ...
  LODWORD(v19) = NtAlpcDeleteSectionView(PortHandle, Flags, ViewBase);
  if ( v8 )
  {
