/*
 * XREFs of DifNtAlpcDeleteSectionViewWrapper @ 0x14066CB20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcDeleteSectionViewWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtAlpcDeleteSectionView(a1, a2, a3);
  if ( v8 )
  {
