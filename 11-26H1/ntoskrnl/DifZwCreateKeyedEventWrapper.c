/*
 * XREFs of DifZwCreateKeyedEventWrapper @ 0x14069FDE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateKeyedEventWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
