/*
 * XREFs of DifZwCreateKeyedEventWrapper @ 0x1406A39C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateKeyedEventWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1033);
  ...
  DWORD2(v20) = ZwCreateKeyedEvent(a1, a2, a3, a4);
  if ( v9 )
  {
