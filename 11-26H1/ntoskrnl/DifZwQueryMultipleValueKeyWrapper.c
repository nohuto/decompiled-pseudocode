/*
 * XREFs of DifZwQueryMultipleValueKeyWrapper @ 0x1406B6820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryMultipleValueKeyWrapper(
        void *a1,
        _KEY_VALUE_ENTRY *a2,
        ULONG a3,
        void *a4,
        ...
        ULONG *RequiredBufferLength)
{
  ...
  _KEY_VALUE_ENTRY *v22; // [rsp+58h] [rbp-18h]
  void *v23; // [rsp+60h] [rbp-10h]
  unsigned int MultipleValueKey; // [rsp+68h] [rbp-8h]
  void *retaddr; // [rsp+98h] [rbp+28h]

  memset_0(v20, 0, 0x40uLL);
  APIThunkContextById = DifGetAPIThunkContextById(1091);
...
LABEL_17:
  MultipleValueKey = ZwQueryMultipleValueKey(a1, a2, a3, a4, BufferLength, RequiredBufferLength);
  if ( v11 )
  {
