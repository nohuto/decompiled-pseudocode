/*
 * XREFs of DifNtReplyPortWrapper @ 0x14068CEC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplyPortWrapper(HANDLE PortHandle, PPORT_MESSAGE ReplyMessage)
{
  ...
  DWORD2(v16) = NtReplyPort(PortHandle, ReplyMessage);
  if ( v6 )
  {
