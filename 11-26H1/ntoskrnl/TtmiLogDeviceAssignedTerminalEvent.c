/*
 * XREFs of TtmiLogDeviceAssignedTerminalEvent @ 0x1407E8C20
 * Callers:
...
void __fastcall TtmiLogDeviceAssignedTerminalEvent(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v9 = a2;
    v16 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)&word_140051666, 0LL, 0LL, 5u, &v10);
  }
}
