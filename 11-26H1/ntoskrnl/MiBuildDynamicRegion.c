/*
 * XREFs of MiBuildDynamicRegion @ 0x1406F4FA0
 * Callers:
...
unsigned __int64 __fastcall MiBuildDynamicRegion(struct _KTHREAD *a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a1 == (struct _KTHREAD *)&stru_140E2D930.QueueListEntry.Blink )
    stru_140E2D930.KernelStack = (void *)a3;
  a1->QuantumTarget = a2;
  v4 = a3 >> 21;
  v5 = ExGenRandom(1, a2) & 0x7FFF;
  a1->SListFaultAddress = (void *)v5;
  if ( a1 == (struct _KTHREAD *)&stru_140E2D930.Teb )
  ...
  v9 = v7 >> 9;
  v10 = v8 & 0xFFF;
  if ( a1 == (struct _KTHREAD *)&stru_140E2D930.Teb && (Flink = a1->Header.WaitListHead.Flink) != 0LL )
  {
    v12 = 0LL;
  ...
  {
    result = MiReservePtes((__int64)&stru_140E36558.WaitBlockList, (unsigned int)v9 + (v10 != 0), v9, v6);
    v13 = result;
    if ( !result )
      return result;
    v12 = 1LL;
