/*
 * XREFs of DifNtSetInformationProcessWrapper @ 0x14068FE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationProcessWrapper(void *a1, PROCESSINFOCLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(541);
  ...
  DWORD2(v20) = NtSetInformationProcess(a1, a2, a3, a4);
  if ( v9 )
  {
