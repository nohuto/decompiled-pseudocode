/*
 * XREFs of DifNtSetInformationProcessWrapper @ 0x14068C2B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationProcessWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtSetInformationProcess(
                  a1,
                  a2,
                  a3,
                  a4,
