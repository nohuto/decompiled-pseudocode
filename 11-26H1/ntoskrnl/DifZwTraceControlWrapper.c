/*
 * XREFs of DifZwTraceControlWrapper @ 0x1406C1530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwTraceControlWrapper(
        ...
        ULONG *ReturnLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1127);
...
LABEL_17:
  HIDWORD(v23) = ZwTraceControl(a1, a2, a3, a4, OutputBufferLength, ReturnLength);
  if ( v11 )
  {
