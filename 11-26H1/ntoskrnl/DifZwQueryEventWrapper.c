/*
 * XREFs of DifZwQueryEventWrapper @ 0x1406B45E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryEventWrapper(
        void *a1,
        EVENT_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = ZwQueryEvent(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
