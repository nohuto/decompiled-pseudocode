/*
 * XREFs of SmInitSystem @ 0x140C7F2E8
 * Callers:
...
__int64 __fastcall SmInitSystem(int a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  if ( a1 )
  {
    ...
    {
      if ( EtwRegister(&SmEventProvider, (PETWENABLECALLBACK)SmEtwEnableCallback, 0LL, &stru_140E27B08.QuantumTarget) >= 0 )
      {
        LODWORD(stru_140E27B08.InitialStack) |= 1u;
        HIDWORD(stru_140E27B08.InitialStack) = 64;
      }
    }
  ...
  *(_QWORD *)&stru_140E27B08.Header.Lock = 0LL;
  qword_140E27B00 = (__int64)&qword_140E27AF8;
  qword_140E27AF8 = (__int64)&qword_140E27AF8;
  SmHwAcceleratorMgrInitialize((__int64)&PspTlsContext.WaitBlock[2].Object);
  stru_140E27B08.ApcState.ApcListHead[0].Flink = (struct _LIST_ENTRY *)PsInitialSystemProcess;
  LOBYTE(stru_140E27B08.ReadyTime) = 0;
  HIDWORD(stru_140E27B08.ThreadLock) = 6;
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
LABEL_14:
      LODWORD(stru_140E27B08.ThreadLock) = a1 + 1;
      return 0LL;
    }
  }
  return result;
