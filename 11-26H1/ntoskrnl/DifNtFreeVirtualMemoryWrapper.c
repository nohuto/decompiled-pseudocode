/*
 * XREFs of DifNtFreeVirtualMemoryWrapper @ 0x14067C070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFreeVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(755);
  ...
  DWORD2(v20) = NtFreeVirtualMemory(a1, a2, a3, a4);
  if ( v9 )
  {
