/*
 * XREFs of DifZwDeleteValueKeyWrapper @ 0x1406A7F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteValueKeyWrapper(HANDLE KeyHandle, PUNICODE_STRING ValueName)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(111);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = KeyHandle;
    *((_QWORD *)&v15 + 1) = ValueName;
  ...
  DWORD2(v16) = ZwDeleteValueKey(KeyHandle, ValueName);
  if ( v6 )
  {
