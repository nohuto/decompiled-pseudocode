/*
 * XREFs of DifZwAcquireProcessActivityReferenceWrapper @ 0x14069BFB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAcquireProcessActivityReferenceWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(931);
  ...
  LODWORD(v19) = ZwAcquireProcessActivityReference(a1, a2, a3);
  if ( v8 )
  {
