/*
 * XREFs of sub_1408809DC @ 0x1408809DC
 * Callers:
...
__int64 __fastcall sub_1408809DC(unsigned int *a1, __int64 a2, __int64 a3, unsigned int a4)
{
  unsigned int v6; // r9d
  __int64 v8; // rdx
  ...
  else
  {
    ...
    if ( a1[1] + 1 < v6 )
      ...
      v12 = (unsigned int)v9;
    v13 = sub_140B0071C(*((void **)a1 + 2), v12);
    if ( v13 >= 0 )
    {
      v14 = a1[2] + a1[6];
      v15 = a1[1];
