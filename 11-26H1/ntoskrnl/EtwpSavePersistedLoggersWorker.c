...
__int64 EtwpSavePersistedLoggersWorker()
{
  ...
  *(_QWORD *)(Pool2 + 8) = Pool2 + 4112;
  ...
  if ( v3 >= 0 )
  {
    ...
    {
      v5 = KsrQueryMetadata(EtwpKsrGuid, *(_QWORD *)(v2[1] + 8 * i), v2 + 2, 4096LL, &v7);
      if ( v5 >= 0 )
        EtwpSavePersistedLogger((__int64)(v2 + 2), *(_QWORD *)(v2[1] + 8 * i));
      else
        v3 = v5;
    }
  }
...
LABEL_9:
  ...
  return (unsigned int)_InterlockedExchange((volatile __int32 *)&PspSiloMonitorLock.SchedulerApcFill5[40], 2);
}
