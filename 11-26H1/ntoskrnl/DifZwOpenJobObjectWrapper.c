/*
 * XREFs of DifZwOpenJobObjectWrapper @ 0x1406ABCD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenJobObjectWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenJobObject(a1, a2, a3);
  if ( v8 )
  {
