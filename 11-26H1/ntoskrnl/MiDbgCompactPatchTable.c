/*
 * XREFs of MiDbgCompactPatchTable @ 0x1406FD354
 * Callers:
...
void __fastcall MiDbgCompactPatchTable(int a1)
{
  ...
  if ( dword_140E30790 == dword_140E30794 )
    return;
  if ( a1 )
    v2 = 17;
  else
    v2 = ExAcquireSpinLockExclusive(&dword_140E34798);
  v3 = dword_140E30794;
  if ( dword_140E30794 == dword_140E30790 )
    goto LABEL_23;
  do
  {
...
LABEL_15:
      ...
      {
        if ( dword_140E3479C == 512 )
          KeBugCheckEx(0x1Au, 0x2320AuLL, 0LL, 0LL, 0LL);
        v12 = &MiState + 6 * (unsigned int)dword_140E3479C + 4230;
        dword_140E3479C = v12[2] >> 2;
        *(_OWORD *)v12 = *(_OWORD *)(&MiState + 6 * v3 + 2692);
        *((_QWORD *)v12 + 2) = *((_QWORD *)&MiState + 3 * v3 + 1348);
        v12[2] &= ~1u;
        if ( (unsigned int)v4 < dword_140E347A0 )
          memmove(
            &MiState + 2 * (unsigned int)(v4 + 1) + 7302,
            &MiState + 2 * v4 + 7302,
            8LL * (unsigned int)(dword_140E347A0 - v4));
...
LABEL_13:
    ...
    {
      v19 = dword_140E347A0 - 1;
      dword_140E347A0 = v19;
      if ( v16 < v19 )
        memmove(v17, &MiState + 2 * v16 + 7304, 8LL * (v19 - v16));
      *(_DWORD *)(v18 + 8) |= 1u;
      *(_DWORD *)(v18 + 8) = (4 * dword_140E3479C) | *(_DWORD *)(v18 + 8) & 3;
      dword_140E3479C = (v18 - (__int64)&unk_140E30798) / 24;
    }
    else
    {
      *(_DWORD *)(v18 + 16) = v15;
...
LABEL_23:
  if ( !a1 )
  {
    if ( v2 == 17 )
      ...
      ExReleaseSpinLockExclusive(&dword_140E34798, v2);
  }
}
