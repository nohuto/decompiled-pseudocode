/*
 * XREFs of DifNtEnumerateDriverEntriesWrapper @ 0x14067A830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtEnumerateDriverEntriesWrapper(PVOID Buffer, PULONG BufferLength)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(673);
  ...
  DWORD2(v16) = NtEnumerateDriverEntries(Buffer, BufferLength);
  if ( v6 )
  {
