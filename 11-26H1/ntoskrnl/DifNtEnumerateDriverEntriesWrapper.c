/*
 * XREFs of DifNtEnumerateDriverEntriesWrapper @ 0x140676C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtEnumerateDriverEntriesWrapper(volatile void *Address, __int64 a2)
{
  ...
  DWORD2(v16) = NtEnumerateDriverEntries(Address);
  if ( v6 )
  {
