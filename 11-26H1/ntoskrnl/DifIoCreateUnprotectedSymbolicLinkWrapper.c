/*
 * XREFs of DifIoCreateUnprotectedSymbolicLinkWrapper @ 0x14065EF30
 * Callers:
 *     <none>
 * Callees:
        ...
        PUNICODE_STRING DeviceName)
{
  ...
  DWORD2(v16) = IoCreateUnprotectedSymbolicLink(SymbolicLinkName, DeviceName);
  if ( v6 )
  {
