/*
 * XREFs of DifNtOpenSessionWrapper @ 0x140682B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSessionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(762);
  ...
  LODWORD(v19) = NtOpenSession(SessionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
