/*
 * XREFs of DifNtOpenSessionWrapper @ 0x14067EFA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSessionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenSession(a1, a2, a3);
  if ( v8 )
  {
