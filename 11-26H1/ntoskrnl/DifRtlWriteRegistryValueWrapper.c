/*
 * XREFs of DifRtlWriteRegistryValueWrapper @ 0x140696F50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  v14 = 0;
  LODWORD(v23) = a1;
  *(_QWORD *)&v21 = ValueData;
  DWORD2(v20) = ValueLength;
  *((_QWORD *)&v22 + 1) = a2;
  *(_QWORD *)&v22 = a3;
  DWORD2(v21) = a4;
...
LABEL_17:
  HIDWORD(v23) = RtlWriteRegistryValue(a1, a2, a3, a4, ValueData, ValueLength);
  if ( v11 )
  {
