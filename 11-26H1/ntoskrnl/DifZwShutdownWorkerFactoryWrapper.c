/*
 * XREFs of DifZwShutdownWorkerFactoryWrapper @ 0x1406BCD30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwShutdownWorkerFactoryWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwShutdownWorkerFactory(a1, a2);
  if ( v6 )
  {
