/*
 * XREFs of DifZwShutdownWorkerFactoryWrapper @ 0x1406C0910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwShutdownWorkerFactoryWrapper(HANDLE WorkerFactoryHandle, LONG *PendingWorkerCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1120);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = WorkerFactoryHandle;
    *((_QWORD *)&v15 + 1) = PendingWorkerCount;
  ...
  DWORD2(v16) = ZwShutdownWorkerFactory(WorkerFactoryHandle, PendingWorkerCount);
  if ( v6 )
  {
