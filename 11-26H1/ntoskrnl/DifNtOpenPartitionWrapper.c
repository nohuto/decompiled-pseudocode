/*
 * XREFs of DifNtOpenPartitionWrapper @ 0x14067E1C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenPartitionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenPartition(a1, a2, a3);
  if ( v8 )
  {
