/*
 * XREFs of DifNtOpenPartitionWrapper @ 0x140681DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenPartitionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtOpenPartition(PartitionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
