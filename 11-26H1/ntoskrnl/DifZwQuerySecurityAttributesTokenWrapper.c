/*
 * XREFs of DifZwQuerySecurityAttributesTokenWrapper @ 0x1406B3950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQuerySecurityAttributesTokenWrapper(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int64 a6)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1133);
...
LABEL_17:
  SecurityAttributesToken = ZwQuerySecurityAttributesToken(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
