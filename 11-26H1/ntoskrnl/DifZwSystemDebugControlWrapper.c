/*
 * XREFs of DifZwSystemDebugControlWrapper @ 0x1406C1210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSystemDebugControlWrapper(
        SYSDBG_COMMAND a1,
        void *a2,
        ULONG a3,
        void *a4,
        ...
        ULONG *ReturnLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1134);
...
LABEL_17:
  HIDWORD(v23) = ZwSystemDebugControl(a1, a2, a3, a4, OutputBufferLength, ReturnLength);
  if ( v11 )
  {
