/*
 * XREFs of DifZwAlpcCreateSectionViewWrapper @ 0x14069E8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcCreateSectionViewWrapper(
        HANDLE PortHandle,
        ULONG Flags,
        PALPC_DATA_VIEW_ATTR ViewAttributes)
{
  ...
  LODWORD(v19) = ZwAlpcCreateSectionView(PortHandle, Flags, ViewAttributes);
  if ( v8 )
  {
