/*
 * XREFs of sub_140C79A90 @ 0x140C79A90
 * Callers:
...
__int64 __fastcall sub_140C79A90(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  __int64 v3; // rdx
  __int64 v4; // r8
          ...
          *(_DWORD *)(v2 + 2524) &= ~0x200000u;
          if ( v28 != *(_QWORD *)(v2 + 2688) )
          {
            ...
            *(_DWORD *)(v32 + 16) = v31;
            ...
            sub_140C7903C(v2, 0LL, v28, 256LL);
          }
        }
      }
    }
              ...
              *(_DWORD *)(v2 + 2524) &= ~0x200000u;
              if ( v84 != *(_QWORD *)(v2 + 2688) )
              {
                ...
                *(_DWORD *)(v88 + 16) = v87;
                ...
                sub_140C7903C(v2, 0LL, v84, 256LL);
              }
            }
          }
        }
