/*
 * XREFs of DifNtCreateJobSetWrapper @ 0x1406750B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateJobSetWrapper(unsigned int a1, __int64 a2, unsigned int a3)
{
  ...
  HIDWORD(v18) = xHalAllocatePmcCounterSet(a1, a2, a3);
  if ( v8 )
  {
