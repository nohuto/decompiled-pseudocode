/*
 * XREFs of __asan_load2_volatile @ 0x1405E1490
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_load2_volatile(ULONG_PTR BugCheckParameter1)
{
  signed __int8 v2; // cl
...
LABEL_12:
  ...
  if ( KcsaniValidationEnabled )
    KcsanValidateAddress(BugCheckParameter1, 2, 0, 1, retaddr);
}
