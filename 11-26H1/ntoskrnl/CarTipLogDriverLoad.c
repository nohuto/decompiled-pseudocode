/*
 * XREFs of CarTipLogDriverLoad @ 0x140649380
 * Callers:
...
void CarTipLogDriverLoad()
{
  ...
  if ( (VfRuleClasses & 0x400000) != 0 )
  {
    ...
    {
      if ( (unsigned int)dword_140E08EA8 > 5 && tlgKeywordOn((__int64)&dword_140E08EA8, 0x800000000000LL) )
      {
        v1 = *(_DWORD *)&stru_140F066E8.WaitBlockFill11[40];
        v7 = 4LL;
        v6 = &v1;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&byte_140052C8F,
          0LL,
          0LL,
          7u,
          &v5);
