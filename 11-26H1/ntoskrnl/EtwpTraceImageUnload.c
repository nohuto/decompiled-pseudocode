/*
 * XREFs of EtwpTraceImageUnload @ 0x14046F868
 * Callers:
        ...
        unsigned int a10)
{
  ...
  if ( a1 && *a1 && *((_QWORD *)a1 + 1) )
  {
    ...
    *(_OWORD *)v31 = 0LL;
      ...
      if ( v14 )
      {
        ...
        if ( v19 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( v22 && (*v22 & 4) != 0 )
              EtwpLogKernelEvent((__int64)v32, v19, *(unsigned __int8 *)(v19 + 2 * v21 + 4504), 3u, 0x1402u, v13);
          }
        }
      }
    }
    ...
    {
      EtwTraceKernelEvent((int)v32, 3, 4u, 5122, a10 != 0 ? 22026499 : 5249283);
    }
  }
}
