/*
 * XREFs of ExpPcwHostCallback @ 0x140847B90
 * Callers:
 *     <none>
 * Callees:
 *     PsIsDiskCountersEnabled @ 0x140617DB0 (PsIsDiskCountersEnabled.c)
  ...
  *(&Info.Version + 1) = 0;
  ...
  else
  {
    ...
    *(_QWORD *)&Info.CounterCount = 42LL;
    Info.Counters = (_PCW_COUNTER_DESCRIPTOR *)`PcwpInitRegistrationInformationSynchCounterSet'::`2'::Descriptors;
