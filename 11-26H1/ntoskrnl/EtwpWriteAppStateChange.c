/*
 * XREFs of EtwpWriteAppStateChange @ 0x14095549C
 * Callers:
...
NTSTATUS __fastcall EtwpWriteAppStateChange(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140E08F80 > 5 && (qword_140E08F90 & 0x200000000001LL) != 0 )
  {
    result = qword_140E08F98 & 1;
    if ( (qword_140E08F98 & 0x200000000001LL) == qword_140E08F98 )
    {
      ...
      *(_DWORD *)&EventDescriptor.Id = 184549376;
      ...
      v5 = 319;
      v6 = 1;
      return EtwWriteTransfer(qword_140E08FA0, &EventDescriptor, 0LL, 0LL, 3u, &UserData);
    }
  }
  return result;
}
