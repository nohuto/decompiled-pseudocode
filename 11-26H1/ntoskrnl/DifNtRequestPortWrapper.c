/*
 * XREFs of DifNtRequestPortWrapper @ 0x14068D4E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRequestPortWrapper(HANDLE PortHandle, PPORT_MESSAGE RequestMessage)
{
  ...
  DWORD2(v16) = NtRequestPort(PortHandle, RequestMessage);
  if ( v6 )
  {
