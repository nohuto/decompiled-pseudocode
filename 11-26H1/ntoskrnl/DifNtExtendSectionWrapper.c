/*
 * XREFs of DifNtExtendSectionWrapper @ 0x140677450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtExtendSectionWrapper(ULONG_PTR BugCheckParameter1, volatile void *Address)
{
  ...
  DWORD2(v16) = NtExtendSection(BugCheckParameter1, Address);
  if ( v6 )
  {
