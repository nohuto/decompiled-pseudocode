...
__int64 __fastcall KdSystemDebugControl(int a1, __m128i *a2, __int64 a3, __int64 a4, int a5, _DWORD *a6, char a7)
{
  ...
  if ( a1 > 14 )
  {
    ...
    if ( !v23 )
    {
      ...
      {
        LOBYTE(a3) = a7;
        v15 = ExLockUserBuffer(v44.m128i_i64[1], v30, a3, 0LL, &v32, &P);
        if ( v15 >= 0 )
        {
    ...
    if ( !v26 )
    {
      ...
      {
        LOBYTE(a3) = a7;
        v15 = ExLockUserBuffer(v42.m128i_i64[1], v29, a3, 1LL, &v32, &P);
        if ( v15 >= 0 )
        {
    ...
    if ( !v27 )
    {
      ...
      {
        LOBYTE(a3) = a7;
        v15 = ExLockUserBuffer(v40.m128i_i64[1], v28, a3, 0LL, &v32, &P);
        if ( v15 >= 0 )
        {
  ...
  if ( a1 == 14 )
  {
    ...
    {
      LOBYTE(a3) = a7;
      v15 = ExLockUserBuffer(v38.m128i_i64[1], v22, a3, 1LL, &v32, &P);
      if ( v15 >= 0 )
      {
  ...
  if ( !v9 )
  {
    ...
    {
      LOBYTE(a3) = a7;
      v15 = ExLockUserBuffer(v52.m128i_i64[1], (unsigned int)v53, a3, 1LL, &v32, &P);
      if ( v15 >= 0 )
      {
  ...
  if ( !v10 )
  {
    ...
    {
      LOBYTE(a3) = a7;
      v15 = ExLockUserBuffer(v50.m128i_i64[1], (unsigned int)v51, a3, 0LL, &v32, &P);
      if ( v15 >= 0 )
      {
  ...
  if ( !v11 )
  {
    ...
    {
      LOBYTE(a3) = a7;
      v15 = ExLockUserBuffer(v48.m128i_i64[1], (unsigned int)v49, a3, 1LL, &v32, &P);
      if ( v15 >= 0 )
      {
  ...
  if ( !v12 )
  {
    ...
    {
      LOBYTE(a3) = a7;
      v15 = ExLockUserBuffer(v46.m128i_i64[1], (unsigned int)v47, a3, 0LL, &v32, &P);
      if ( v15 >= 0 )
      {
  ...
  if ( v13 )
  {
    if ( v13 == 1 )
    {
      ...
      {
        LOBYTE(a3) = a7;
        v15 = ExLockUserBuffer(v34.m128i_i64[1], (unsigned int)v35, a3, 0LL, &v32, &P);
        if ( v15 >= 0 )
        {
...
LABEL_60:
  ...
  if ( !(_DWORD)v37 )
    goto LABEL_43;
  LOBYTE(a3) = a7;
  v15 = ExLockUserBuffer(v36.m128i_i64[1], (unsigned int)v37, a3, 1LL, &v32, &P);
  if ( v15 >= 0 )
  {
