/*
 * XREFs of RtlInitializeCorrelationVector @ 0x140B2B250
 * Callers:
 *     <none>
 * Callees:
 *     memset_0 @ 0x140742480 (memset_0.c)
 *     RtlpBase64Encode @ 0x140B2B2D0 (RtlpBase64Encode.c)
 */
...
DWORD __cdecl RtlInitializeCorrelationVector(PCORRELATION_VECTOR CorrelationVector, int Version, const GUID *Guid)
{
  ...
  if ( (unsigned __int8)(Version - 1) > 1u || !Guid )
    return -1073741811;
  memset_0(CorrelationVector->Vector, 0, sizeof(CorrelationVector->Vector));
