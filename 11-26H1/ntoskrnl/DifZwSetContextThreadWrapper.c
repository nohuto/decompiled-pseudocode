/*
 * XREFs of DifZwSetContextThreadWrapper @ 0x1406BCC30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetContextThreadWrapper(HANDLE ThreadHandle, PCONTEXT ThreadContext)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(920);
  ...
  DWORD2(v16) = ZwSetContextThread(ThreadHandle, ThreadContext);
  if ( v6 )
  {
