/*
 * XREFs of DifZwSetContextThreadWrapper @ 0x1406B9050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetContextThreadWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwSetContextThread(a1, a2);
  if ( v6 )
  {
