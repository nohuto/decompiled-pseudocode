/*
 * XREFs of Feature_CFR_Child_KM_C__private_ReportUsageFallback @ 0x1406E70F4
 * Callers:
...
void __fastcall Feature_CFR_Child_KM_C__private_ReportUsageFallback(__int64 a1, int a2)
{
  char v3; // bl
  ...
  if ( (a1 & 2) == 0 )
    v3 = wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState(
           &Feature_CFR_Child_KM_C__private_featureState,
           a1,
           (__int64)&Feature_CFR_Child_KM_C__private_descriptor);
  wil_details_FeatureReporting_ReportUsageToService((__int64)&Feature_CFR_Child_KM_C__private_descriptor, v3, a2);
