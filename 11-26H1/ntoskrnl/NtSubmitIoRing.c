/*
 * XREFs of NtSubmitIoRing @ 0x1404DCF60
 * Callers:
  ...
  if ( v10 >= 0 )
  {
    ...
    else
    {
      ...
      else
      {
        if ( a3 )
        {
          v10 = IopIoRingSetupCompletionWait((_DWORD)v7, v13, a3, 0, (__int64)&v24);
          if ( v10 < 0 )
            goto LABEL_13;
        }
        else
        ...
        {
          if ( !v19
            || (LOBYTE(v11) = 1, v10 = IopIoRingSetupCompletionWait((_DWORD)v7, 0, a3, v11, (__int64)&v24), v10 >= 0) )
          {
            if ( v24 )
            {
              v23 = a2;
