/*
 * XREFs of DifNtFlushVirtualMemoryWrapper @ 0x140678180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFlushVirtualMemoryWrapper(ULONG_PTR a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtFlushVirtualMemory(a1);
  if ( v9 )
  {
