/*
 * XREFs of DifNtFlushVirtualMemoryWrapper @ 0x14067BD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFlushVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, struct _IO_STATUS_BLOCK *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(772);
  ...
  DWORD2(v20) = NtFlushVirtualMemory(a1, a2, a3, a4);
  if ( v9 )
  {
