/*
 * XREFs of DifZwQuerySystemEnvironmentValueExWrapper @ 0x1406B7D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQuerySystemEnvironmentValueExWrapper(
        UNICODE_STRING *a1,
        const GUID *a2,
        void *a3,
        ULONG *a4,
        ULONG *Attributes)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(996);
  ...
  LODWORD(v21) = ZwQuerySystemEnvironmentValueEx(a1, a2, a3, a4, Attributes);
  if ( v10 )
  {
