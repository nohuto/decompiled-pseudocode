/*
 * XREFs of DifZwReleaseSemaphoreWrapper @ 0x1406BA610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReleaseSemaphoreWrapper(HANDLE SemaphoreHandle, LONG ReleaseCount, PLONG PreviousCount)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1013);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = SemaphoreHandle;
    LODWORD(v18) = ReleaseCount;
    *((_QWORD *)&v17 + 1) = PreviousCount;
  ...
  LODWORD(v19) = ZwReleaseSemaphore(SemaphoreHandle, ReleaseCount, PreviousCount);
  if ( v8 )
  {
