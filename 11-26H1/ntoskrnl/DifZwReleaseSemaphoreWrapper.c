/*
 * XREFs of DifZwReleaseSemaphoreWrapper @ 0x1406B6A30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReleaseSemaphoreWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwReleaseSemaphore(a1, a2, a3);
  if ( v8 )
  {
