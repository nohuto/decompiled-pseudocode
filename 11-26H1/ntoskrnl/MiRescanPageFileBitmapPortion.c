/*
 * XREFs of MiRescanPageFileBitmapPortion @ 0x14044CAE8
 * Callers:
  ...
  if ( (_DWORD)result )
  {
    ...
    do
    {
      ...
      if ( v13 > v15 )
      {
        ...
        {
          v21 = a1 + 112;
          RtlRbRemoveNode(a1 + 112, v9);
          RtlRbRemoveNode(a1 + 128, v9 + 24);
          v29 = *(_DWORD *)(a1 + 108);
          if ( v29 <= *(_DWORD *)(v9 + 52) )
            v29 = *(_DWORD *)(v9 + 52);
          *(_DWORD *)(a1 + 108) = v29;
...
LABEL_23:
        ...
        RtlRbInsertNodeEx(v21, v22, v23, v9);
        v25 = a1 + 128;
        v26 = *(_QWORD *)(a1 + 128);
...
LABEL_29:
        ...
        RtlRbInsertNodeEx(v25, v26, v27, v9 + 24);
        ++*(_DWORD *)(a1 + 96);
        v9 = *(_QWORD *)(a1 + 144);
        if ( v9 == a1 + 144 )
        {
