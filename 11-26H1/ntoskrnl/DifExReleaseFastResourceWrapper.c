/*
 * XREFs of DifExReleaseFastResourceWrapper @ 0x140657FC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReleaseFastResourceWrapper(struct _KTHREAD *a1, ULONG_PTR BugCheckParameter3)
{
  ...
  struct _KTHREAD *v15; // [rsp+30h] [rbp-28h]
  _UNKNOWN *retaddr; // [rsp+58h] [rbp+0h]

  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(451);
  ...
  ExReleaseFastResource(a1, BugCheckParameter3);
  if ( v6 )
  {
