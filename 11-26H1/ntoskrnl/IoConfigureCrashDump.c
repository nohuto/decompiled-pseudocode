/*
 * XREFs of IoConfigureCrashDump @ 0x1405C8CB0
 * Callers:
...
__int64 __fastcall IoConfigureCrashDump(__int64 a1, __int64 a2)
{
  int v2; // ebx
  ...
  if ( v2 )
  {
    if ( v2 == 1 )
    {
      ...
      else
      {
        ...
        if ( PageFileForCrashDump && RtlPrefixUnicodeString(&stru_14000BF08, &String2, 1u) )
        {
