/*
 * XREFs of IopLiveDumpTraceCaptureProcessorContextDuration @ 0x1405D45FC
 * Callers:
  ...
  if ( (_BYTE)v3 )
  {
    if ( !v4[106] )
    {
      ...
      if ( (v3 & 1) != 0 )
      {
        ...
        v10[0] = &v16;
        v5 = (v4[20] & 1) == 0;
        v6 = LIVEDUMP_EVENT_SIZING_WORKFLOW_SYSTEM_QUIESCED_CAPTURE_PROCESSOR_CONTEXT;
        if ( v5 )
          v6 = LIVEDUMP_EVENT_CAPTURE_PAGES_WORKFLOW_SYSTEM_QUIESCED_CAPTURE_PROCESSOR_CONTEXT;
        ...
        if ( (unsigned int)dword_140E06D90 > 5 )
        {
          ...
          if ( (_BYTE)v3 )
          {
            ...
            LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)byte_1400477E3,
                           (const GUID *)(a1 + 968),
                           (const GUID *)(a1 + 952),
                           4u,
                           &v11);
