/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x140614E40
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1404FEB80 (PoFxPlatformRequestHandler.c)
 * Callees:
 *     PopFxAcpiValidateParameters @ 0x1404F93D0 (PopFxAcpiValidateParameters.c)
