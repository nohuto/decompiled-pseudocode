/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x140612000
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x140505240 (PoFxPlatformRequestHandler.c)
 * Callees:
 *     PopFxAcpiValidateParameters @ 0x1404FFBE0 (PopFxAcpiValidateParameters.c)
