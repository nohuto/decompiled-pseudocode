/*
 * XREFs of DifNtAlpcOpenSenderThreadWrapper @ 0x140670D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcOpenSenderThreadWrapper(
        HANDLE *a1,
        void *a2,
        _PORT_MESSAGE *a3,
        ULONG a4,
        ...
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(611);
...
LABEL_17:
  LODWORD(v23) = NtAlpcOpenSenderThread(a1, a2, a3, a4, DesiredAccess, ObjectAttributes);
  if ( v11 )
  {
