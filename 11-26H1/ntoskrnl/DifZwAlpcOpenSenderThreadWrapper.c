/*
 * XREFs of DifZwAlpcOpenSenderThreadWrapper @ 0x14069F200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcOpenSenderThreadWrapper(
        HANDLE *a1,
        void *a2,
        _PORT_MESSAGE *a3,
        ULONG a4,
        ...
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(966);
...
LABEL_17:
  LODWORD(v23) = ZwAlpcOpenSenderThread(a1, a2, a3, a4, DesiredAccess, ObjectAttributes);
  if ( v11 )
  {
