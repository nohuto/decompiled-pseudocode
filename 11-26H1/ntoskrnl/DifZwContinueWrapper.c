/*
 * XREFs of DifZwContinueWrapper @ 0x1406A1900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwContinueWrapper(PCONTEXT ContextRecord, BOOLEAN a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(942);
  ...
  DWORD2(v16) = ZwContinue(ContextRecord, a2);
  if ( v6 )
  {
