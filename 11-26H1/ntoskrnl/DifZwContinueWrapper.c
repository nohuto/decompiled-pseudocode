/*
 * XREFs of DifZwContinueWrapper @ 0x14069DD20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwContinueWrapper(__int64 a1, char a2)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    *(_QWORD *)&v18 = a1;
      ...
      || (v10 = ExAcquireRundownProtection_0(&DifRebootlessRundown)) != 0 )
    {
      ...
      {
        if ( i != (__int128 *)16 )
          guard_dispatch_icall_no_overrides(&v17, v5);
      }
      if ( v10 )
  ...
  LOBYTE(v5) = a2;
  DWORD2(v18) = ZwContinue(a1, v5, v6, v7);
  if ( v8 )
  {
