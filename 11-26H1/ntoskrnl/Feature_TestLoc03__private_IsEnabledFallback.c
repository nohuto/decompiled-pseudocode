/*
 * XREFs of Feature_TestLoc03__private_IsEnabledFallback @ 0x1406E7920
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_TestLoc03__private_descriptor, 0);
}
