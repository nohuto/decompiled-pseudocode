/*
 * XREFs of DifNtOpenKeyExWrapper @ 0x140681230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyExWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(799);
  ...
  DWORD2(v20) = NtOpenKeyEx(a1, a2, a3, a4);
  if ( v9 )
  {
