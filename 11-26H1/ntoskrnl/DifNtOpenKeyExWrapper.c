/*
 * XREFs of DifNtOpenKeyExWrapper @ 0x14067D650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyExWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
