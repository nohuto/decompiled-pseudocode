/*
 * XREFs of __asan_store16_volatile @ 0x1405E2D20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_store16_volatile(ULONG_PTR BugCheckParameter1)
{
  char v2; // cl
  signed __int8 v3; // al
  char v4; // dl
...
LABEL_39:
  ...
  if ( KcsaniValidationEnabled )
    KcsanValidateAddress(BugCheckParameter1, 16, 1, 1, retaddr);
}
