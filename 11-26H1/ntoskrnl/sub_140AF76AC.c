/*
 * XREFs of sub_140AF76AC @ 0x140AF76AC
 * Callers:
...
__int64 __fastcall sub_140AF76AC(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
  unsigned int i; // r9d
  ...
  if ( (_DWORD)v17 )
    v19 = (__int64)v18;
  v20 = ExpPlatformBinaryLock.SchedulerSharedSystemSlot
