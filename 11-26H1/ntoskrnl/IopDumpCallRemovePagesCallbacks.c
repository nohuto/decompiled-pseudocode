/*
 * XREFs of IopDumpCallRemovePagesCallbacks @ 0x1405C8D68
 * Callers:
...
char __fastcall IopDumpCallRemovePagesCallbacks(int a1)
{
  ...
  {
    v12 = v3;
    LOBYTE(v1) = KeValidateBugCheckCallbackRecord(v3, 6LL, &v11);
    if ( (_BYTE)v1 )
    {
      *(_QWORD *)&v7 = 0LL;
      HIDWORD(v7) = a1;
      ...
      do
      {
        ...
        if ( v4 >= 0 )
        {
          if ( *((_QWORD *)&v8 + 1) )
          {
            ...
            v4 = v5;
            if ( v5 < 0 )
              IopLogCallbackError(17170433LL, (unsigned int)v5, v3);
          }
        }
      }
      while ( v10 );
