/*
 * XREFs of IovpCallDriver1 @ 0x140C2B2B8
 * Callers:
 ...
 *     VfPendingStartLogging @ 0x140C30158 (VfPendingStartLogging.c)
 ...
 *     IovpSessionDataReference @ 0x140C3A5C0 (IovpSessionDataReference.c)
