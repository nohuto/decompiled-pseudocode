/*
 * XREFs of DifNtSetThreadExecutionStateWrapper @ 0x14068DF10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetThreadExecutionStateWrapper(unsigned int a1, __int64 a2)
{
  ...
  HIDWORD(v16) = NtSetThreadExecutionState(a1, a2);
  if ( v6 )
  {
