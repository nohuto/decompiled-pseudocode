/*
 * XREFs of DifNtSetThreadExecutionStateWrapper @ 0x140691AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetThreadExecutionStateWrapper(EXECUTION_STATE NewFlags, EXECUTION_STATE *PreviousFlags)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(654);
  ...
  HIDWORD(v16) = NtSetThreadExecutionState(NewFlags, PreviousFlags);
  if ( v6 )
  {
