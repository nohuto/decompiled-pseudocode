/*
 * XREFs of DifNtSetSecurityObjectWrapper @ 0x1406911E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSecurityObjectWrapper(
        HANDLE Handle,
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  LODWORD(v19) = NtSetSecurityObject(Handle, SecurityInformation, SecurityDescriptor);
  if ( v8 )
  {
