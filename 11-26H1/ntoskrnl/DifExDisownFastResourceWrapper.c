/*
 * XREFs of DifExDisownFastResourceWrapper @ 0x140654C20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExDisownFastResourceWrapper(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(452);
  ...
  ExDisownFastResource(BugCheckParameter2, a2);
  if ( v6 )
  {
