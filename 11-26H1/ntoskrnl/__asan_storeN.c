/*
 * XREFs of __asan_storeN @ 0x1405E3D30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_storeN(ULONG_PTR BugCheckParameter1, ULONG_PTR a2)
{
...
LABEL_8:
    ...
    if ( KcsaniValidationEnabled )
      KcsanValidateAddress(BugCheckParameter1, a2, 1, 0, retaddr);
  }
}
