/*
 * XREFs of DifNtSetSystemEnvironmentValueWrapper @ 0x140691500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemEnvironmentValueWrapper(PUNICODE_STRING VariableName, PUNICODE_STRING VariableValue)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(659);
  ...
  DWORD2(v16) = NtSetSystemEnvironmentValue(VariableName, VariableValue);
  if ( v6 )
  {
