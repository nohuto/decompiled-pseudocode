/*
 * XREFs of DifNtSetSystemEnvironmentValueWrapper @ 0x14068D920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemEnvironmentValueWrapper(void *Src, void *a2)
{
  ...
  DWORD2(v16) = NtSetSystemEnvironmentValue(Src, a2);
  if ( v6 )
  {
