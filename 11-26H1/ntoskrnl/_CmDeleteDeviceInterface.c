/*
 * XREFs of _CmDeleteDeviceInterface @ 0x1409B846C
 * Callers:
...
__int64 __fastcall CmDeleteDeviceInterface(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v6; // rdi
  int v7; // eax
  unsigned int v8; // eax
  ...
  v8 = CmDeleteDeviceInterfaceWorker(a1, a2, v15);
  v9 = v8;
  if ( !v6 )
    return v9;
  v14[0] = v8;
