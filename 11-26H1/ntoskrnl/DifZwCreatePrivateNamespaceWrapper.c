/*
 * XREFs of DifZwCreatePrivateNamespaceWrapper @ 0x1406A4780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePrivateNamespaceWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        _OBJECT_BOUNDARY_DESCRIPTOR *a4)
{
  ...
  DWORD2(v20) = ZwCreatePrivateNamespace(a1, a2, a3, a4);
  if ( v9 )
  {
