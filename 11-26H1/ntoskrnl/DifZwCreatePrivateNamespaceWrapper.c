/*
 * XREFs of DifZwCreatePrivateNamespaceWrapper @ 0x1406A0BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePrivateNamespaceWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(906);
  ...
  DWORD2(v20) = ZwCreatePrivateNamespace(
                  a1,
                  a2,
                  a3,
                  a4,
