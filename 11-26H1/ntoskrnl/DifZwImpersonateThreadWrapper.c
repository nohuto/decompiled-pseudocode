/*
 * XREFs of DifZwImpersonateThreadWrapper @ 0x1406AC0A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwImpersonateThreadWrapper(
        ...
        PSECURITY_QUALITY_OF_SERVICE SecurityQos)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(925);
  ...
  LODWORD(v19) = ZwImpersonateThread(ServerThreadHandle, ClientThreadHandle, SecurityQos);
  if ( v8 )
  {
