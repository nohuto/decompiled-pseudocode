/*
 * XREFs of DifZwImpersonateThreadWrapper @ 0x1406A84C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwImpersonateThreadWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwImpersonateThread(a1, a2, a3);
  if ( v8 )
  {
