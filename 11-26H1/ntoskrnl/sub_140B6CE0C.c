/*
 * XREFs of sub_140B6CE0C @ 0x140B6CE0C
 * Callers:
...
__int64 __fastcall sub_140B6CE0C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // ebx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
        ...
        if ( *(_DWORD *)a1 > 3u )
        {
          ...
          if ( !v14 )
          {
            ...
            if ( v18 >= v8 )
            {
              ...
              if ( v33 < v24 )
                goto LABEL_60;
              if ( *(_QWORD *)&ExpPlatformBinaryLock.SchedulerApcFill5[80] )
              {
