/*
 * XREFs of DifNtCancelTimerWrapper @ 0x140672360
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCancelTimerWrapper(HANDLE TimerHandle, PBOOLEAN CurrentState)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(698);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = TimerHandle;
    *((_QWORD *)&v15 + 1) = CurrentState;
  ...
  DWORD2(v16) = NtCancelTimer(TimerHandle, CurrentState);
  if ( v6 )
  {
