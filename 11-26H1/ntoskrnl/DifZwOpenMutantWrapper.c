/*
 * XREFs of DifZwOpenMutantWrapper @ 0x1406B0200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenMutantWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = ZwOpenMutant(MutantHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
