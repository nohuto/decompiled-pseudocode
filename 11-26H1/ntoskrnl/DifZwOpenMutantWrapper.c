/*
 * XREFs of DifZwOpenMutantWrapper @ 0x1406AC620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenMutantWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1005);
  ...
  LODWORD(v19) = ZwOpenMutant(a1, a2, a3);
  if ( v8 )
  {
