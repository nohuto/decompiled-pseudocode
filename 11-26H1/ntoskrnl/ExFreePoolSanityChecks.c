/*
 * XREFs of ExFreePoolSanityChecks @ 0x140C4345C
 * Callers:
 ...
 *     KevSkipVerification @ 0x14071F3D8 (KevSkipVerification.c)
...
__int64 __fastcall ExFreePoolSanityChecks(ULONG_PTR a1, __int64 a2)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( !ExpSpecialAllocations || (result = ExIsSpecialPoolAddress(a1), !(_DWORD)result) )
    {
      ...
      if ( (a1 & 0xF) != 0 )
        CarReportRuleViolationFromNt(196, 22LL, 0x2530uLL, a1, 0LL, 0, a2);
      v6 = (unsigned int *)(a1 - 16);
      if ( (*(_BYTE *)(a1 - 16 + 3) & 3) == 0 )
        CarReportRuleViolationFromNt(196, 19LL, 0x253EuLL, a1 - 16, *v6, 0, a2);
      result = *((_BYTE *)v6 + 3) & 3;
      if ( (*((_BYTE *)v6 + 3) & 1) != 0 )
      {
        if ( CurrentIrql <= 1u )
...
LABEL_22:
      if ( (*((_BYTE *)v6 + 3) & 2) == 0 )
        return CarReportRuleViolationFromNt(196, 20LL, 0x2561uLL, a1 - 16, 0LL, 0, a2);
    }
  }
  return result;
}
