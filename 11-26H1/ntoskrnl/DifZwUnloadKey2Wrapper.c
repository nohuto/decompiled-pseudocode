/*
 * XREFs of DifZwUnloadKey2Wrapper @ 0x1406C1CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnloadKey2Wrapper(POBJECT_ATTRIBUTES TargetKey, ULONG Flags)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1093);
  ...
  DWORD2(v16) = ZwUnloadKey2(TargetKey, Flags);
  if ( v6 )
  {
