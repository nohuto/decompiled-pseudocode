/*
 * XREFs of DifZwQuerySemaphoreWrapper @ 0x1406B7A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQuerySemaphoreWrapper(
        void *a1,
        SEMAPHORE_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = ZwQuerySemaphore(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
