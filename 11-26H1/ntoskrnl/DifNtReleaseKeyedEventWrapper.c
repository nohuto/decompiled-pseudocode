/*
 * XREFs of DifNtReleaseKeyedEventWrapper @ 0x14068C0F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReleaseKeyedEventWrapper(void *a1, void *a2, BOOLEAN a3, LARGE_INTEGER *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(722);
  ...
  DWORD2(v20) = NtReleaseKeyedEvent(a1, a2, a3, a4);
  if ( v9 )
  {
