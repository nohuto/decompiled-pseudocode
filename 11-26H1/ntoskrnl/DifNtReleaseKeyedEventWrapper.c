/*
 * XREFs of DifNtReleaseKeyedEventWrapper @ 0x140688510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReleaseKeyedEventWrapper(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  ...
  LOBYTE(v9) = a3;
  DWORD2(v21) = NtReleaseKeyedEvent(
                  a1,
                  a2,
                  v9,
                  a4,
