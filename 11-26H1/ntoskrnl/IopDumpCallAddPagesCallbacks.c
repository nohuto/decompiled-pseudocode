/*
 * XREFs of IopDumpCallAddPagesCallbacks @ 0x1405CB4D8
 * Callers:
...
char __fastcall IopDumpCallAddPagesCallbacks(int a1)
{
  ...
  {
    v12 = Blink;
    LOBYTE(v1) = KeValidateBugCheckCallbackRecord(Blink, 4LL, &p_Blink);
    if ( (_BYTE)v1 )
    {
      *(_QWORD *)&v7 = 0LL;
      HIDWORD(v7) = a1;
      ...
      do
      {
        ...
        DWORD2(v7) = 0;
        v10 = 0;
        guard_dispatch_icall_no_overrides(4LL, Blink);
        if ( v4 >= 0 )
        {
          if ( *((_QWORD *)&v8 + 1) )
          {
            ...
            v4 = v5;
            if ( v5 < 0 )
              IopLogCallbackError(17235969LL, (unsigned int)v5, Blink);
          }
        }
      }
      while ( v10 );
