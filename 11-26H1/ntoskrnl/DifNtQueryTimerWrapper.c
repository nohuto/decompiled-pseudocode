/*
 * XREFs of DifNtQueryTimerWrapper @ 0x140686500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryTimerWrapper(ULONG_PTR a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(699);
  ...
  LODWORD(v21) = NtQueryTimer(a1, a5);
  if ( v10 )
  {
