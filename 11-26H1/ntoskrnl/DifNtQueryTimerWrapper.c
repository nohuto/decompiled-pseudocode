/*
 * XREFs of DifNtQueryTimerWrapper @ 0x14068A0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryTimerWrapper(
        void *a1,
        TIMER_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = NtQueryTimer(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
