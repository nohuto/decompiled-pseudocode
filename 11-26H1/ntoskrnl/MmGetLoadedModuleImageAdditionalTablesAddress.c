/*
 * XREFs of MmGetLoadedModuleImageAdditionalTablesAddress @ 0x1403F3B30
 * Callers:
...
unsigned __int64 __fastcall MmGetLoadedModuleImageAdditionalTablesAddress(__int64 a1, int *a2)
{
  ...
  if ( v2 == PsNtosImageBase || v2 == PsHalImageBase )
    ...
    SListFaultAddress_high = HIDWORD(stru_140E36558.SListFaultAddress) + LODWORD(stru_140E36558.QuantumTarget);
