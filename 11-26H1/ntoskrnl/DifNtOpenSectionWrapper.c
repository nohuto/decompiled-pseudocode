/*
 * XREFs of DifNtOpenSectionWrapper @ 0x140682880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSectionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(875);
  ...
  LODWORD(v19) = NtOpenSection(SectionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
