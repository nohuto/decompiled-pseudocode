/*
 * XREFs of DifNtOpenSectionWrapper @ 0x14067ECA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSectionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenSection(a1, a2, a3);
  if ( v8 )
  {
