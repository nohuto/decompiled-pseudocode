/*
 * XREFs of CmpLogHiveRundownEvent @ 0x14085B75C
 * Callers:
...
__int64 __fastcall CmpLogHiveRundownEvent(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 v4; // r9
  __int64 v6; // r8
  unsigned int v7; // edx
  ...
  v16[v12 - 1] = v14;
  v16[v12] = 2LL;
  return EtwTraceSiloDcEvent((__int64)&v15, v9 + 1, a2, a3, 0x927u, 0x501802u);
}
