/*
 * XREFs of HalpPmuArbiterQueryRegistryQuantum @ 0x140784378
 * Callers:
...
__int64 HalpPmuArbiterQueryRegistryQuantum()
{
  ...
  result = guard_dispatch_icall_no_overrides(2LL, (__int64)L"HAL\\PMU");
  if ( (int)result >= 0 )
  {
    result = v7;
    if ( v7 )
      HalpPmuArbiter.SystemCallNumber = v7;
  }
  return result;
}
