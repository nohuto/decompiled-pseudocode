/*
 * XREFs of MiMirrorOmitPagesFromCopy @ 0x140C037CC
 * Callers:
 ...
 *     MiBlackRemoveChildPartitionHugeRangesCallback @ 0x1406EF5A0 (MiBlackRemoveChildPartitionHugeRangesCallback.c)
 *     MiMirrorBlackRemoveChildPartitionPages @ 0x1406EFBB0 (MiMirrorBlackRemoveChildPartitionPages.c)
 ...
 *     RtlInterlockedClearBitRunEx @ 0x14044F340 (RtlInterlockedClearBitRunEx.c)
 */
...
char __fastcall MiMirrorOmitPagesFromCopy(__int64 *a1, int a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  v6 = a3;
  v7 = &stru_140E2EB88.WaitBlockFill5[32 * a2 + 48];
  v8 = a4;
  ...
  {
    LOBYTE(v9) = stru_140E2EB88.Timer.TimerListEntry.Flink;
