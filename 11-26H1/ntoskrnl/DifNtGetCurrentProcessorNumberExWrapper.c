/*
 * XREFs of DifNtGetCurrentProcessorNumberExWrapper @ 0x140678E60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetCurrentProcessorNumberExWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = NtGetCurrentProcessorNumberEx(a1);
  if ( v4 )
  {
