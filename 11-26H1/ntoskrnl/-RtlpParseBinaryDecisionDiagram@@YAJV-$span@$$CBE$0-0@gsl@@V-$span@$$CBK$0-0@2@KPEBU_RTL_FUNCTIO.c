/*
 * XREFs of ?RtlpParseBinaryDecisionDiagram@@YAJV?$span@$$CBE$0?0@gsl@@V?$span@$$CBK$0?0@2@KPEBU_RTL_FUNCTION_OVERRIDE_CAPABILITIES@@PEAU_RTL_FUNCTION_OVERRIDE_ENTRY@@PEBU_RTL_SYSTEM_OVERRIDE_INFORMATION@@K@Z @ 0x140A5EBFC
 * Callers:
        ...
        struct _RTL_SYSTEM_OVERRIDE_INFORMATION *a6)
{
  ...
  {
    v8 = a3;
    if ( *(_QWORD *)a1 - 8LL >= (unsigned __int64)a3 )
    {
      v9 = *((_QWORD *)a1 + 1);
      v10 = *(_QWORD *)a1;
      v11 = (_DWORD *)(v9 + a3);
                  ...
                  if ( (_WORD)v18 || *v19 )
                  {
                    if ( (_DWORD)v18 == v16 )
                    {
                      if ( (unsigned __int16)*v19 != v16 )
                        return 3221225595LL;
                      v20 = (unsigned __int64)*((unsigned int *)a1 + 1) < *a2;
                    }
                    else
                    {
                      ...
                      if ( (unsigned int)v23 <= v16 || v18 >= v15 )
                        return 3221225595LL;
                      v20 = v23 < v15;
                    }
                    if ( !v20 )
