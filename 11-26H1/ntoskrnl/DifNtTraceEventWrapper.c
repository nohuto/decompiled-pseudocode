/*
 * XREFs of DifNtTraceEventWrapper @ 0x14068F980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtTraceEventWrapper(void *a1, int a2, unsigned int a3, _QWORD *a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(863);
  ...
  LODWORD(v19) = NtTraceEvent(a1, a2, a3, a4);
  if ( v9 )
  {
