/*
 * XREFs of DifNtMapUserPhysicalPagesScatterWrapper @ 0x14067F270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtMapUserPhysicalPagesScatterWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(778);
  ...
  LODWORD(v19) = NtMapUserPhysicalPagesScatter(VirtualAddresses, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
