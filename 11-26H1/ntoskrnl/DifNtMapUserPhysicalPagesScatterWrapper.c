/*
 * XREFs of DifNtMapUserPhysicalPagesScatterWrapper @ 0x14067B690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtMapUserPhysicalPagesScatterWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtMapUserPhysicalPagesScatter(a1, a2, a3);
  if ( v8 )
  {
