/*
 * XREFs of DifExQueueWorkItemFromIoWrapper @ 0x140656DC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExQueueWorkItemFromIoWrapper(_QWORD *BugCheckParameter2, int a2)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(470);
  ...
  ExQueueWorkItemFromIo(BugCheckParameter2, a2);
  if ( v6 )
  {
