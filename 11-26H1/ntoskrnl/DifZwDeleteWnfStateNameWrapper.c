/*
 * XREFs of DifZwDeleteWnfStateNameWrapper @ 0x1406A8220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteWnfStateNameWrapper(PCWNF_STATE_NAME StateName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1050);
  ...
  LODWORD(v14) = ZwDeleteWnfStateName(StateName);
  if ( v4 )
  {
