/*
 * XREFs of DifZwRenameTransactionManagerWrapper @ 0x1406B7080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRenameTransactionManagerWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwRenameTransactionManager(a1, a2);
  if ( v6 )
  {
