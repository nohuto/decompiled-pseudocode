/*
 * XREFs of DifZwRenameTransactionManagerWrapper @ 0x1406BAC60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRenameTransactionManagerWrapper(
        ...
        LPGUID ExistingTransactionManagerGuid)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1102);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = LogFileName;
    *((_QWORD *)&v15 + 1) = ExistingTransactionManagerGuid;
  ...
  DWORD2(v16) = ZwRenameTransactionManager(LogFileName, ExistingTransactionManagerGuid);
  if ( v6 )
  {
