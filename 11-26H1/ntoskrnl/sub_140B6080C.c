/*
 * XREFs of sub_140B6080C @ 0x140B6080C
 * Callers:
 *     SPCall2ServerInternal @ 0x140A1AE00 (SPCall2ServerInternal.c)
 * Callees:
 *     StringCbLengthW @ 0x1404837EC (StringCbLengthW.c)
...
__int64 __fastcall sub_140B6080C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  const wchar_t *v4; // r8
  void *v7; // r15
  unsigned int *v8; // rax
...
LABEL_49:
      ...
      if ( ExpPlatformBinaryLock.SchedulerApc.Reserved[2] )
