/*
 * XREFs of DifCmRegisterCallbackWrapper @ 0x140651890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifCmRegisterCallbackWrapper(PEX_CALLBACK_FUNCTION Function, PVOID Context, PLARGE_INTEGER Cookie)
{
  ...
  LODWORD(v19) = CmRegisterCallback(Function, Context, Cookie);
  if ( v8 )
  {
