/*
 * XREFs of MmGetDumpRange @ 0x1406F6934
 * Callers:
...
void __fastcall MmGetDumpRange(__int64 a1, int a2, __int64 a3, char a4)
{
  ...
  if ( a2 )
  {
    ...
    for ( i = 0; i < *(_DWORD *)MmPhysicalMemoryBlock; ++i )
    {
      ...
      if ( (MiFlags & 0x10000) != 0 || qword_140E2D7B0 )
  ...
  while ( 2 )
  {
    v13 = *(_DWORD *)stru_140E2EB88.QuantumTarget - 1;
    v14 = (*(_DWORD *)(stru_140E2EB88.QuantumTarget + 8) & 4) != 0LL ? 0x20 : 0;
    v15 = v12 < *(_DWORD *)stru_140E2EB88.QuantumTarget ? v12 : 0;
    v16 = *(_QWORD *)(stru_140E2EB88.QuantumTarget + 8)
...
LABEL_25:
      if ( !v15 )
        goto LABEL_30;
      v22 = v12 + 1;
      if ( v12 + 1 > *(_DWORD *)stru_140E2EB88.QuantumTarget )
        v22 = *(_DWORD *)stru_140E2EB88.QuantumTarget;
      v13 = v22 - 1;
      v15 = 0;
    }
    v18 -= v14;
LABEL_30:
    ...
    {
      v12 = v18 + 1;
      v23 = *(_QWORD *)(stru_140E2EB88.ThreadLock + 8LL * v18);
      if ( (*(_DWORD *)(v23 + 4) & 2) != 0 )
      {
