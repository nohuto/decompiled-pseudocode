/*
 * XREFs of DifExReleaseResourceAndLeavePriorityRegionWrapper @ 0x140658290
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReleaseResourceAndLeavePriorityRegionWrapper(__int64 a1)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(386);
  ...
  ExReleaseResourceAndLeavePriorityRegion(a1);
  if ( v4 )
  {
