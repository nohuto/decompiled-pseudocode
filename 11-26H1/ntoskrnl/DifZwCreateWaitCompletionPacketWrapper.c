/*
 * XREFs of DifZwCreateWaitCompletionPacketWrapper @ 0x1406A33D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateWaitCompletionPacketWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwCreateWaitCompletionPacket(a1, a2, a3);
  if ( v8 )
  {
