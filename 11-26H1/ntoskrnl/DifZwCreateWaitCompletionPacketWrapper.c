/*
 * XREFs of DifZwCreateWaitCompletionPacketWrapper @ 0x1406A6FB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateWaitCompletionPacketWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(989);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = WaitCompletionPacketHandle;
  ...
  LODWORD(v19) = ZwCreateWaitCompletionPacket(WaitCompletionPacketHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
