/*
 * XREFs of DifZwReleaseMutantWrapper @ 0x1406BA4A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReleaseMutantWrapper(HANDLE MutantHandle, PLONG PreviousCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1007);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = MutantHandle;
    *((_QWORD *)&v15 + 1) = PreviousCount;
  ...
  DWORD2(v16) = ZwReleaseMutant(MutantHandle, PreviousCount);
  if ( v6 )
  {
