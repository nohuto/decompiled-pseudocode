/*
 * XREFs of PopFanSetupRpmBuckets @ 0x140B34E38
 * Callers:
...
LABEL_23:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    {
      *(_DWORD *)(a1 + 128) = v3;
      if ( (unsigned int)dword_140E07598 > 4 )
      {
        v20 = &v16;
        LOWORD(v15) = v3;
...
LABEL_24:
    v16 = a1;
    v21 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07598, (unsigned __int8 *)v13, 0LL, 0LL, v14, v19);
    return;
  }
  v7 = v6 - v4;
  v8 = 0;
