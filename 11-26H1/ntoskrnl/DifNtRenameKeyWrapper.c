/*
 * XREFs of DifNtRenameKeyWrapper @ 0x14068C8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRenameKeyWrapper(HANDLE KeyHandle, PUNICODE_STRING NewName)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(805);
  ...
  DWORD2(v16) = NtRenameKey(KeyHandle, NewName);
  if ( v6 )
  {
