/*
 * XREFs of DifZwCreatePortWrapper @ 0x1406A0A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePortWrapper(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4, unsigned int a5)
{
  ...
  DWORD2(v21) = ZwCreatePort(a1, a2, a3, a4, a5);
  if ( v10 )
  {
