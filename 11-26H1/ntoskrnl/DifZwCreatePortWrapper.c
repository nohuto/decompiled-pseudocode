/*
 * XREFs of DifZwCreatePortWrapper @ 0x1406A45E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePortWrapper(HANDLE *a1, OBJECT_ATTRIBUTES *a2, ULONG a3, ULONG a4, ULONG MaxPoolUsage)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(945);
  ...
  DWORD2(v21) = ZwCreatePort(a1, a2, a3, a4, MaxPoolUsage);
  if ( v10 )
  {
