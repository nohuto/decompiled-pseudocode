/*
 * XREFs of ?StDmpSinglePageInsert@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_IO_PARAMS@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x140211480
 * Callers:
...
LABEL_20:
          v24[1] += v21;
        if ( (BYTE4(stru_140E27B08.InitialStack) & 0x10) != 0 )
        {
          ...
          *(_QWORD *)&UserData.Size = 4LL;
          ...
          v40 = 2LL;
          v42 = 2LL;
          EtwWriteEx(stru_140E27B08.QuantumTarget, SmEtwDescriptorPtrs, 0LL, 1u, 0LL, 0LL, 5u, &UserData);
        }
        return 0LL;
      }
    }
