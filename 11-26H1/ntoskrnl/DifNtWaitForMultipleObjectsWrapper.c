/*
 * XREFs of DifNtWaitForMultipleObjectsWrapper @ 0x140695090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForMultipleObjectsWrapper(
        ULONG a1,
        HANDLE *a2,
        WAIT_TYPE a3,
        BOOLEAN a4,
        LARGE_INTEGER *Timeout)
{
  ...
  HIDWORD(v20) = NtWaitForMultipleObjects(a1, a2, a3, a4, Timeout);
  if ( v10 )
  {
