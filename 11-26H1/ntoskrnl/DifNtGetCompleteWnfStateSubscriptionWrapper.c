/*
 * XREFs of DifNtGetCompleteWnfStateSubscriptionWrapper @ 0x14067C720
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  LODWORD(v23) = NtGetCompleteWnfStateSubscription(a1, a2, a3, a4, NewDeliveryDescriptor, DescriptorSize);
  if ( v11 )
  {
