/*
 * XREFs of DifNtGetCompleteWnfStateSubscriptionWrapper @ 0x140678B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetCompleteWnfStateSubscriptionWrapper(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        int a6)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(750);
...
LABEL_17:
  LODWORD(Length) = a6;
  LODWORD(v24) = NtGetCompleteWnfStateSubscription(a1, a2, a3, a4, Address, Length);
  if ( v11 )
  {
