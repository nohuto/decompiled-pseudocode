/*
 * XREFs of DifZwSinglePhaseRejectWrapper @ 0x1406C0C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSinglePhaseRejectWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1111);
  ...
  DWORD2(v16) = ZwSinglePhaseReject(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
