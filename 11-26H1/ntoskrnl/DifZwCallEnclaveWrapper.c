/*
 * XREFs of DifZwCallEnclaveWrapper @ 0x14069FF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCallEnclaveWrapper(LPVOID (__cdecl *a1)(LPVOID), void *a2, ULONG a3, PVOID *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1065);
  ...
  DWORD2(v20) = ZwCallEnclave(a1, a2, a3, a4);
  if ( v9 )
  {
