/*
 * XREFs of DifZwCallEnclaveWrapper @ 0x14069C350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCallEnclaveWrapper(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
