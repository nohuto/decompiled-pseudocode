/*
 * XREFs of DifNtEnumerateBootEntriesWrapper @ 0x140676AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtEnumerateBootEntriesWrapper(volatile void *Address, __int64 a2)
{
  ...
  DWORD2(v16) = NtEnumerateBootEntries(Address);
  if ( v6 )
  {
