/*
 * XREFs of DifNtEnumerateBootEntriesWrapper @ 0x14067A6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtEnumerateBootEntriesWrapper(PVOID Buffer, PULONG BufferLength)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(665);
  ...
  DWORD2(v16) = NtEnumerateBootEntries(Buffer, BufferLength);
  if ( v6 )
  {
