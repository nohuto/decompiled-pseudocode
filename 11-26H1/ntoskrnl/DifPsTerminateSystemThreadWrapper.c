/*
 * XREFs of DifPsTerminateSystemThreadWrapper @ 0x140698B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifPsTerminateSystemThreadWrapper(NTSTATUS ExitStatus)
{
  ...
  v13 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(170);
  ...
  HIDWORD(v13) = PsTerminateSystemThread(ExitStatus);
  if ( v4 )
  {
