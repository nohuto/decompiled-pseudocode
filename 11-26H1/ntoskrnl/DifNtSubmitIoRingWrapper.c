/*
 * XREFs of DifNtSubmitIoRingWrapper @ 0x140692C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSubmitIoRingWrapper(void *a1, ULONG a2, ULONG a3, LARGE_INTEGER *a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(869);
  ...
  LODWORD(v19) = NtSubmitIoRing(a1, a2, a3, a4);
  if ( v9 )
  {
