/*
 * XREFs of RtlpHpVsContextInitialize @ 0x1404FB028
 * Callers:
        ...
        __int64 a8)
{
  ...
  *(_BYTE *)(a1 + 4) = *a7;
  if ( a8 )
    *(_WORD *)(a1 + 6) = a8 - a1;
  for ( i = 0LL; i < 4; ++i )
    *(_QWORD *)(a1 + 8 * i + 16) ^= a1 ^ *(_QWORD *)&PspTlsContext.Timer.Processor;
  v17 = *(_QWORD *)(a1 + 48);
  if ( v17 )
    *(_QWORD *)(a1 + 48) = a1 ^ *(_QWORD *)&PspTlsContext.Timer.Processor ^ v17;
  v18 = *(_QWORD *)(a1 + 56);
  if ( v18 )
    *(_QWORD *)(a1 + 56) = a1 ^ *(_QWORD *)&PspTlsContext.Timer.Processor ^ v18;
  v19 = *(_QWORD *)(a1 + 64);
  if ( v19 )
    *(_QWORD *)(a1 + 64) = a1 ^ *(_QWORD *)&PspTlsContext.Timer.Processor ^ v19;
