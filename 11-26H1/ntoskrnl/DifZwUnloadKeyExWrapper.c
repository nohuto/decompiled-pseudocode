/*
 * XREFs of DifZwUnloadKeyExWrapper @ 0x1406BE270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnloadKeyExWrapper(__int64 a1, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1094);
  ...
  DWORD2(v16) = ZwUnloadKeyEx(a1, a2);
  if ( v6 )
  {
