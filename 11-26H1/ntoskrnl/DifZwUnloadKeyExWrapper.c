/*
 * XREFs of DifZwUnloadKeyExWrapper @ 0x1406C1E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnloadKeyExWrapper(POBJECT_ATTRIBUTES TargetKey, HANDLE Event)
{
  ...
  DWORD2(v16) = ZwUnloadKeyEx(TargetKey, Event);
  if ( v6 )
  {
