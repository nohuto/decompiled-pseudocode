/*
 * XREFs of DifZwPrivilegeCheckWrapper @ 0x1406B2900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPrivilegeCheckWrapper(HANDLE ClientToken, PPRIVILEGE_SET RequiredPrivileges, PBOOLEAN Result)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(881);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = ClientToken;
    *(_QWORD *)&v18 = RequiredPrivileges;
    *((_QWORD *)&v17 + 1) = Result;
  ...
  LODWORD(v19) = ZwPrivilegeCheck(ClientToken, RequiredPrivileges, Result);
  if ( v8 )
  {
