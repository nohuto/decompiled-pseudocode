/*
 * XREFs of DifZwPrivilegeCheckWrapper @ 0x1406AED20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPrivilegeCheckWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwPrivilegeCheck(a1, a2, a3);
  if ( v8 )
  {
