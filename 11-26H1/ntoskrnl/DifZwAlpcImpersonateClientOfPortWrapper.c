/*
 * XREFs of DifZwAlpcImpersonateClientOfPortWrapper @ 0x14069EED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcImpersonateClientOfPortWrapper(HANDLE PortHandle, PPORT_MESSAGE Message, PVOID Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(961);
  ...
  LODWORD(v19) = ZwAlpcImpersonateClientOfPort(PortHandle, Message, Flags);
  if ( v8 )
  {
