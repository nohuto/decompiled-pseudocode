/*
 * XREFs of DifZwAlpcImpersonateClientOfPortWrapper @ 0x14069B2F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcImpersonateClientOfPortWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwAlpcImpersonateClientOfPort(a1, a2, a3);
  if ( v8 )
  {
