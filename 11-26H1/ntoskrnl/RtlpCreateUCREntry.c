/*
 * XREFs of RtlpCreateUCREntry @ 0x14061EB90
 * Callers:
        ...
        __int64 *a6)
{
  ...
  *(_DWORD *)(v6 + 8) = 65540;
  ...
  else
  {
    v11 = ((v6 - a2) >> 16) + 1;
    if ( v11 >= 0xFE )
      RtlpLogHeapFailure(3u, v10, a3 - 16, (struct _KLOCK_ENTRIES *)a2, 0LL, 0LL);
  }
  v12 = (signed int)RtlpBootStatHandleLock.CurrentRunTime < 1;
  *(_BYTE *)(v6 + 14) = v11;
  if ( v12 )
  {
    v13 = a5 == v6;
