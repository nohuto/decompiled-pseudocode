/*
 * XREFs of DifZwOpenSemaphoreWrapper @ 0x1406AD620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenSemaphoreWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenSemaphore(a1, a2, a3);
  if ( v8 )
  {
