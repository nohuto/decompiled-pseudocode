/*
 * XREFs of DifZwOpenSemaphoreWrapper @ 0x1406B1200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenSemaphoreWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1011);
  ...
  LODWORD(v19) = ZwOpenSemaphore(SemaphoreHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
