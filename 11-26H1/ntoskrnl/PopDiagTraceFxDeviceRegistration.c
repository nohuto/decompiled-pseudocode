/*
 * XREFs of PopDiagTraceFxDeviceRegistration @ 0x140AEE574
 * Callers:
        ...
        __int64 a8)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v25 = 4LL;
  v27 = 12LL;
  return EtwWrite(*(REGHANDLE *)&PopSleepstudySessionLock.PriorityFloorCounts[16], EventDescriptor, 0LL, 8u, &UserData);
}
