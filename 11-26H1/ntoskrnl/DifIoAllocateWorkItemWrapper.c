/*
 * XREFs of DifIoAllocateWorkItemWrapper @ 0x14065D310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoAllocateWorkItemWrapper(__int64 a1, __int64 a2)
{
  ...
  *((_QWORD *)&v16 + 1) = guard_dispatch_icall_no_overrides(a1, a2);
  if ( v6 )
  {
