/*
 * XREFs of DifExTryToConvertFastResourceSharedToExclusiveWrapper @ 0x140658B10
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExTryToConvertFastResourceSharedToExclusiveWrapper(
        struct _KTHREAD *a1,
        ULONG_PTR BugCheckParameter2)
{
  ...
  BYTE8(v16) = ExTryToConvertFastResourceSharedToExclusive(a1, BugCheckParameter2);
  if ( v6 )
  {
