/*
 * XREFs of DifZwCreateMailslotFileWrapper @ 0x1406A0150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateMailslotFileWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  unsigned __int64 v24; // [rsp+58h] [rbp-29h]
  ...
  APIThunkContextById = DifGetAPIThunkContextById(976);
...
LABEL_17:
  MailslotFile = ZwCreateMailslotFile(a1, a2, a3, a4, a5, a6, a7, a8, v22, v23, v24, v25, v26, v27, v28, v29);
  if ( v13 )
  {
