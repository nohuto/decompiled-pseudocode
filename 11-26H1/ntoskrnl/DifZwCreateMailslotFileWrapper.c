/*
 * XREFs of DifZwCreateMailslotFileWrapper @ 0x1406A3D30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  MailslotFile = ZwCreateMailslotFile(a1, a2, a3, a4, CreateOptions, MailslotQuota, MaximumMessageSize, ReadTimeout);
  if ( v13 )
  {
