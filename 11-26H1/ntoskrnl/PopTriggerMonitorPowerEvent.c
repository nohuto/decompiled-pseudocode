/*
 * XREFs of PopTriggerMonitorPowerEvent @ 0x140A3EF18
 * Callers:
...
__int64 __fastcall PopTriggerMonitorPowerEvent(char a1, int a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  if ( !v8 )
    return (unsigned int)-1073741823;
  PopAcquireRwLockExclusive((unsigned __int64 *)&PopWeakChargerLock.OtherOperationCount, j, a3, a4);
  LOBYTE(v9) = a1;
  ...
  *((_QWORD *)v8 + 5) = v11;
  v13 = 3 * v12;
  *((_DWORD *)&PopWeakChargerLock.QueuedScb + 2 * v13) = v6;
  PopPowerEventTraceCount = ((_BYTE)v12 + 1) & 0x1F;
  *((_DWORD *)&PopWeakChargerLock.ThreadTimerDelay + 2 * v13) = v15;
  *((_DWORD *)&PopWeakChargerLock.QueuedScb + 2 * v13 + 1) = v10;
  PopWeakChargerLock.TracingPrivate[v13] = v11;
  if ( v10 >= 0 )
  {
