/*
 * XREFs of DifNtFlushBuffersFileExWrapper @ 0x140677CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFlushBuffersFileExWrapper(__int64 a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtFlushBuffersFileEx(a1, a2, a3, a4, a5);
  if ( v10 )
  {
