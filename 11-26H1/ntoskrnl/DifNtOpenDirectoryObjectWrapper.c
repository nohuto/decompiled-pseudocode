/*
 * XREFs of DifNtOpenDirectoryObjectWrapper @ 0x140680750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenDirectoryObjectWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtOpenDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
