/*
 * XREFs of DifNtOpenDirectoryObjectWrapper @ 0x14067CB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenDirectoryObjectWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenDirectoryObject(a1, a2, a3);
  if ( v8 )
  {
