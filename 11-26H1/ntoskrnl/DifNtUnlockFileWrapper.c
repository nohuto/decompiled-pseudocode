/*
 * XREFs of DifNtUnlockFileWrapper @ 0x140693FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnlockFileWrapper(
        void *a1,
        ...
        ULONG Key)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(624);
  ...
  LODWORD(v21) = NtUnlockFile(a1, a2, a3, a4, Key);
  if ( v10 )
  {
