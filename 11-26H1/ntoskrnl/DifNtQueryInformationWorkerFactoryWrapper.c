/*
 * XREFs of DifNtQueryInformationWorkerFactoryWrapper @ 0x140687710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationWorkerFactoryWrapper(
        void *a1,
        WORKERFACTORYINFOCLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(856);
  ...
  LODWORD(v21) = NtQueryInformationWorkerFactory(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
