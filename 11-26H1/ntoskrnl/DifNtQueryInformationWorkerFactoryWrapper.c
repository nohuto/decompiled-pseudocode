/*
 * XREFs of DifNtQueryInformationWorkerFactoryWrapper @ 0x140683B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationWorkerFactoryWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtQueryInformationWorkerFactory(a1, a5);
  if ( v10 )
  {
