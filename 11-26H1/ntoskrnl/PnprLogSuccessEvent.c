/*
 * XREFs of PnprLogSuccessEvent @ 0x1407B2C28
 * Callers:
...
NTSTATUS PnprLogSuccessEvent()
{
  ...
  LOWORD(v26) = 0;
  v0 = *(_DWORD *)(PnprContext + 33332);
  v1 = *(_DWORD *)(PnprContext + 33336);
  v27 = *(_DWORD *)(PnprContext + 33344);
  v28 = v0 - *(_DWORD *)(PnprContext + 33328);
  v2 = v1 - v0;
  v3 = *(_QWORD ***)(PnprContext + 16);
  v29 = v2;
  LODWORD(v30) = *(_DWORD *)(PnprContext + 33340) - v1;
