/*
 * XREFs of DifZwPropagationCompleteWrapper @ 0x1406B2DD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPropagationCompleteWrapper(void *a1, ULONG a2, ULONG a3, void *a4)
{
  ...
  LODWORD(v19) = ZwPropagationComplete(a1, a2, a3, a4);
  if ( v9 )
  {
