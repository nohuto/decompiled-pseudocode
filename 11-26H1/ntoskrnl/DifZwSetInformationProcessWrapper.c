/*
 * XREFs of DifZwSetInformationProcessWrapper @ 0x1406BA600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationProcessWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = ZwSetInformationProcess(
                  a1,
                  a2,
                  a3,
                  a4,
