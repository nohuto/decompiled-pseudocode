/*
 * XREFs of MiCompensateForProcessorErrata @ 0x140D0162C
 * Callers:
...
__int64 __fastcall MiCompensateForProcessorErrata(__int64 a1)
{
  ...
  if ( (((MiFlags & 0xFFFFFFFFFE7FFFFFuLL | ((unsigned __int64)(KiKvaShadowMode & 3) << 23)) >> 23) & 3) != 0 )
  {
    ...
    {
      case 1uLL:
        WORD2(stru_140E2D930.Header.WaitListHead.Blink) = 0;
        break;
      case 2uLL:
        WORD2(stru_140E2D930.Header.WaitListHead.Blink) = 256;
        break;
      case 3uLL:
        WORD2(stru_140E2D930.Header.WaitListHead.Blink) = 1;
        break;
    }
    if ( SLODWORD(gLoadedDiffHivesLock.StackBase) > 0 )
    {
      byte_140E01333 = 4;
      qword_140E2D740 = 1LL << (LOBYTE(gLoadedDiffHivesLock.StackBase) - 1);
      byte_140E01332 = LOBYTE(gLoadedDiffHivesLock.StackBase) - 1;
      qword_140E2D748 = ~qword_140E2D740;
    }
  }
  else
  {
