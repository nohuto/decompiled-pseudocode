/*
 * XREFs of NormBuffer__ReplaceLastStartBase @ 0x1406223B8
 * Callers:
 ...
 *     Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x14080D558 (Normalization__GetSecondAndThirdDecomposedCharPlane0.c)
 */
...
char __fastcall NormBuffer__ReplaceLastStartBase(__int64 a1, int a2, char a3, char a4)
{
  ...
  *(_QWORD *)(a1 + 96) = 0LL;
  ...
  if ( !v8 || (result = NormBuffer__AppendAndSortDecomposed(a1, v8)) != 0 )
  {
    if ( v9 )
      return NormBuffer__AppendAndSortDecomposed(a1, v9);
    else
      return 1;
  }
  return result;
