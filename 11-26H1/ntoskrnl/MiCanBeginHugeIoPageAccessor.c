/*
 * XREFs of MiCanBeginHugeIoPageAccessor @ 0x14052EEFC
 * Callers:
...
LABEL_27:
    ...
    v2 = (((__int64)a1 - *(_QWORD *)((char *)&stru_140E2EB88.116 + 4)) >> 3) & 0x3FFFFF;
    *a1 = v4;
    if ( LODWORD(stru_140E2EB88.Timer.TimerListEntry.Flink) == 1 )
    {
      v5 = v2 & 0x1F;
      LOBYTE(v6) = 1;
      v7 = (volatile signed __int32 *)stru_140E2EB88.WaitBlock[2].WaitListEntry.Blink
    ...
    else if ( LODWORD(stru_140E2EB88.Timer.TimerListEntry.Flink) == 3 )
    {
      v10 = v2 & 0x1F;
      LOBYTE(v11) = 1;
      v12 = (volatile signed __int32 *)stru_140E2EB88.WaitBlock[2].WaitListEntry.Blink + (v2 >> 5);
      if ( v10 + 1 > 0x20 )
      {
        if ( (v2 & 0x1F) != 0 )
        {
