/*
 * XREFs of ?SmEvictKeys@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KPEAU?$SMKM_STORE@USM_TRAITS@@@@@Z @ 0x14053283C
 * Callers:
...
void SMKM_STORE_MGR<SM_TRAITS>::SmEvictKeys(__int64 a1, _DWORD *a2, int a3, ...)
{
  ...
  LODWORD(v3) = *a2;
  SMKM_STORE_MGR<SM_TRAITS>::SmFeStoreEvictKeys(a1, (unsigned int *)va, a3);
}
