/*
 * XREFs of DifKeReleaseInStackQueuedSpinLockFromDpcLevelWrapper @ 0x140666AF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeReleaseInStackQueuedSpinLockFromDpcLevelWrapper(PKLOCK_QUEUE_HANDLE LockHandle)
{
