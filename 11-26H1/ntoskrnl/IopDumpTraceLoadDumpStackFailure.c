/*
 * XREFs of IopDumpTraceLoadDumpStackFailure @ 0x1405CBDB8
 * Callers:
...
char __fastcall IopDumpTraceLoadDumpStackFailure(int a1)
{
  char result; // al
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    result = EtwWriteEx(
               IopDumpEtwRegHandle,
               &DUMP_EVENT_CRASHDUMP_LOAD_DUMP_STACK_FAILED,
               0LL,
               0,
               0LL,
               0LL,
  ...
  if ( (unsigned int)dword_140E06CD8 > 5 )
  {
    ...
    if ( result )
    {
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)&dword_1400471AC,
               0LL,
               0LL,
               4u,
               &v5);
