/*
 * XREFs of DifZwResumeThreadWrapper @ 0x1406BBE50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwResumeThreadWrapper(HANDLE ThreadHandle, PULONG PreviousSuspendCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(918);
  ...
  DWORD2(v16) = ZwResumeThread(ThreadHandle, PreviousSuspendCount);
  if ( v6 )
  {
