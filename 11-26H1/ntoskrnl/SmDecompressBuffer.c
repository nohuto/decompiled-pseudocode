/*
 * XREFs of SmDecompressBuffer @ 0x14046A1B4
 * Callers:
...
__int64 __fastcall SmDecompressBuffer(__int64 a1, unsigned int a2, _QWORD *a3, _DWORD *a4, _DWORD *a5)
{
  ...
  _DWORD v23[21]; // [rsp+44h] [rbp-54h] BYREF
  ...
  if ( v11 < 0 )
  {
    if ( v12 >= 4 )
    {
      ...
      if ( (unsigned int)crc32(v21, v13, v12) == *v19 )
      {
        v5 = 0;
        goto LABEL_5;
      }
...
LABEL_5:
  ...
  v16 = (void *)guard_dispatch_icall_no_overrides((unsigned int)v14, v9);
  if ( !v16 )
  ...
  if ( (_BYTE)v17 )
  {
    ...
    if ( v5 < 0 )
      goto LABEL_12;
    v5 = RtlDecompressBufferEx((unsigned __int16)v17, (_DWORD)v16, v14, (_DWORD)v13, v12, (__int64)&v24, 0LL);
    if ( v5 < 0 )
      goto LABEL_12;
    if ( (_DWORD)v14 == v24 )
    {
