/*
 * XREFs of DifZwUnlockFileWrapper @ 0x1406C2130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnlockFileWrapper(
        void *a1,
        ...
        ULONG Key)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(971);
  ...
  LODWORD(v21) = ZwUnlockFile(a1, a2, a3, a4, Key);
  if ( v10 )
  {
