/*
 * XREFs of DifNtCancelIoFileExWrapper @ 0x140671D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCancelIoFileExWrapper(
        HANDLE FileHandle,
        ...
        PIO_STATUS_BLOCK IoStatusBlock)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(628);
  ...
  LODWORD(v19) = NtCancelIoFileEx(FileHandle, IoRequestToCancel, IoStatusBlock);
  if ( v8 )
  {
