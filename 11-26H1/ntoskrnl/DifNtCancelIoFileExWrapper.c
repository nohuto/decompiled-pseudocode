/*
 * XREFs of DifNtCancelIoFileExWrapper @ 0x14066E190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCancelIoFileExWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtCancelIoFileEx(a1);
  if ( v8 )
  {
