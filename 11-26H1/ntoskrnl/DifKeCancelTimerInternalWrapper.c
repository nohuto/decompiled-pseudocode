/*
 * XREFs of DifKeCancelTimerInternalWrapper @ 0x1406643E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeCancelTimerInternalWrapper(__int64 a1, _QWORD *a2, _DWORD *a3, unsigned int *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(473);
  ...
  BYTE8(v20) = KeCancelTimerInternal(a1, a2, a3, a4);
  if ( v9 )
  {
