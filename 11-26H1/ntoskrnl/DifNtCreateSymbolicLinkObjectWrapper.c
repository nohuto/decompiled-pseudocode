/*
 * XREFs of DifNtCreateSymbolicLinkObjectWrapper @ 0x1406776D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateSymbolicLinkObjectWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        UNICODE_STRING *a4)
{
  ...
  DWORD2(v20) = NtCreateSymbolicLinkObject(a1, a2, a3, a4);
  if ( v9 )
  {
