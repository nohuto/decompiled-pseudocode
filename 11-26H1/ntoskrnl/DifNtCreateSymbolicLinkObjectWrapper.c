/*
 * XREFs of DifNtCreateSymbolicLinkObjectWrapper @ 0x140673AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateSymbolicLinkObjectWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtCreateSymbolicLinkObject(
                  a1,
                  a2,
                  a3,
                  a4,
