/*
 * XREFs of DrvDbGetDriverInfFileMappedPropertyKeys @ 0x14089E314
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  v9 = a1;
  v10 = a5;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (__int64)&off_140E0A3C0, 1u, a4, a5, a6);
