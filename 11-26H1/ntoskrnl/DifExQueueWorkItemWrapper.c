/*
 * XREFs of DifExQueueWorkItemWrapper @ 0x140656F30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExQueueWorkItemWrapper(PWORK_QUEUE_ITEM WorkItem, WORK_QUEUE_TYPE QueueType)
{
  ...
  PWORK_QUEUE_ITEM v15; // [rsp+30h] [rbp-28h]
  _UNKNOWN *retaddr; // [rsp+58h] [rbp+0h]

  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(468);
