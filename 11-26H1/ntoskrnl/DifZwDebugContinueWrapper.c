/*
 * XREFs of DifZwDebugContinueWrapper @ 0x1406A3AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDebugContinueWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = ZwDebugContinue(a1, a2, a3);
  if ( v8 )
  {
