/*
 * XREFs of DifZwQueryBootEntryOrderWrapper @ 0x1406B3710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryBootEntryOrderWrapper(PULONG Ids, PULONG Count)
{
  ...
  DWORD2(v16) = ZwQueryBootEntryOrder(Ids, Count);
  if ( v6 )
  {
