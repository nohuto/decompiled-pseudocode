/*
 * XREFs of DifNtLoadKey3Wrapper @ 0x14067A7B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLoadKey3Wrapper(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(796);
...
LABEL_17:
  Key3 = NtLoadKey3(a1, a2, a3, a4, a5, a6, a7, a8, v22, v23, v24, v25, v26, v27, v28, v29);
  if ( v13 )
  {
