/*
 * XREFs of DifZwOpenTransactionManagerWrapper @ 0x1406B1CC0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG OpenOptions)
{
  ...
  GUID *v22; // [rsp+40h] [rbp-30h]
  UNICODE_STRING *v23; // [rsp+48h] [rbp-28h]
  OBJECT_ATTRIBUTES *v24; // [rsp+50h] [rbp-20h]
  ACCESS_MASK v25; // [rsp+58h] [rbp-18h]
  HANDLE *v26; // [rsp+60h] [rbp-10h]
...
LABEL_17:
  v27 = ZwOpenTransactionManager(a1, a2, a3, a4, TmIdentity, OpenOptions);
  if ( v11 )
  {
