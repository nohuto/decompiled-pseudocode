/*
 * XREFs of CmpIsHiveEligibleForLazyReconcile @ 0x140AA8BCC
 * Callers:
  ...
  if ( CmpUserPresent )
  {
    ...
    if ( *(_DWORD *)(v2 + 180) < EffectiveLogSizeCapForHive )
    {
      ...
      if ( v4 != 1 )
      {
        ...
        while ( v6 < 2 );
        if ( v5 )
          return MEMORY[0xFFFFF78000000008] - MEMORY[0xFFFFF780000003B0] >= *(_QWORD *)(v2 + 4152)
                                                                          + 10000000
                                                                          * (unsigned __int64)(unsigned int)dword_140E02220;
      }
    }
  }
  return 1;
