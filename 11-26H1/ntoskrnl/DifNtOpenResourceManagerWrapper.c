/*
 * XREFs of DifNtOpenResourceManagerWrapper @ 0x1406826D0
 * Callers:
 *     <none>
 * Callees:
        ...
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(846);
  ...
  LODWORD(v21) = NtOpenResourceManager(a1, a2, a3, a4, ObjectAttributes);
  if ( v10 )
  {
