/*
 * XREFs of Feature_KernelPnP_DevFilterShortCircuitEval__private_IsEnabledFallback @ 0x140719C54
 * Callers:
...
__int64 __fastcall Feature_KernelPnP_DevFilterShortCircuitEval__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
