/*
 * XREFs of DifZwCancelIoFileExWrapper @ 0x1406A0240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCancelIoFileExWrapper(
        HANDLE FileHandle,
        ...
        PIO_STATUS_BLOCK IoStatusBlock)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(973);
  ...
  LODWORD(v19) = ZwCancelIoFileEx(FileHandle, IoRequestToCancel, IoStatusBlock);
  if ( v8 )
  {
