/*
 * XREFs of DifZwCancelIoFileExWrapper @ 0x14069C660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCancelIoFileExWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwCancelIoFileEx(a1, a2, a3);
  if ( v8 )
  {
