/*
 * XREFs of MiInitializeSystemChannelOrdering @ 0x140CFCE3C
 * Callers:
...
char __fastcall MiInitializeSystemChannelOrdering(__int64 a1, unsigned int a2)
{
  ...
  while ( v2 );
  for ( i = (char *)qword_140E2D6E8; *(_QWORD *)i != -1LL; i += 16 )
  {
    if ( *((unsigned __int16 *)i + 5) == a2 )
    {
      v7 = (unsigned __int8)i[12];
      if ( (unsigned __int8)v7 < (unsigned __int8)byte_140E2D718 )
      {
        if ( i[14] )
        {
  ...
  if ( result )
  {
    ...
    while ( v11 < (unsigned __int8)byte_140E2D718 );
  }
  v12 = 0;
  if ( result )
  {
    ...
    while ( v12 < (unsigned __int8)byte_140E2D718 );
  }
  return result;
}
