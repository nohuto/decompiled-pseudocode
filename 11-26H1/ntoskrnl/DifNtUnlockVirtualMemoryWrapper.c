/*
 * XREFs of DifNtUnlockVirtualMemoryWrapper @ 0x140694140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnlockVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(774);
  ...
  DWORD2(v20) = NtUnlockVirtualMemory(a1, a2, a3, a4);
  if ( v9 )
  {
