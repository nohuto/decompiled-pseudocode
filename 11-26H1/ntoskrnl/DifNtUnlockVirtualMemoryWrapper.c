/*
 * XREFs of DifNtUnlockVirtualMemoryWrapper @ 0x140690560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnlockVirtualMemoryWrapper(ULONG_PTR a1, __int64 a2, __int64 a3, int a4)
{
  ...
  DWORD2(v20) = NtUnlockVirtualMemory(a1);
  if ( v9 )
  {
