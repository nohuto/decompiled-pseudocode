/*
 * XREFs of MiValidateAndLockAweMapCountPage @ 0x14048033C
 * Callers:
...
__int64 __fastcall MiValidateAndLockAweMapCountPage(__int64 a1, unsigned __int64 a2, int a3, __int64 a4)
{
  ...
  *(_QWORD *)a4 = 0LL;
  ...
  {
    v11 = 0LL;
    v12 = *(_QWORD *)((char *)&stru_140E2EB88.116 + 4) + 8 * ((a2 >> 18) & 0x3FFFFF);
    v10 = 48 * a2;
  }
  else
  {
  ...
  if ( a3 )
  {
    ...
    if ( a2 <= qword_140E2D7A0 && ((*(_QWORD *)(v10 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
    {
      if ( !v11 )
        return 0LL;
      *(_QWORD *)a4 = v11;
      ...
      if ( v11 )
        ...
        _InterlockedAnd(
          (volatile signed __int32 *)(*(_QWORD *)&stru_140E2EB88.SystemCallNumber
                                    + 4
                                    * ((((v12 - *(_QWORD *)((char *)&stru_140E2EB88.116 + 4)) >> 3) & 0x3FFFFFuLL) >> 5)),
