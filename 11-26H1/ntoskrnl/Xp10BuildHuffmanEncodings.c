/*
 * XREFs of Xp10BuildHuffmanEncodings @ 0x1408114AC
 * Callers:
          ...
          if ( *((unsigned __int8 *)a1 + v54 + 38176) == v49 )
          {
            ...
            if ( v49 > 8 )
            {
              ...
              do
              {
                ...
                v55 -= 8;
                v56 >>= 8;
                v57 = *((unsigned __int8 *)qword_140035EA0 + v59) | (v57 << 8);
                --v58;
              }
              while ( v58 );
            }
            if ( v55 )
              v57 = (*((unsigned __int8 *)qword_140035EA0 + (unsigned __int8)v56) | (v57 << 8)) >> (8 - v55);
