/*
 * XREFs of DifZwGetContextThreadWrapper @ 0x1406A7500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetContextThreadWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwGetContextThread(a1, a2);
  if ( v6 )
  {
