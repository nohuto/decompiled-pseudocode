/*
 * XREFs of DifZwGetContextThreadWrapper @ 0x1406AB0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetContextThreadWrapper(HANDLE ThreadHandle, PCONTEXT ThreadContext)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(919);
  ...
  DWORD2(v16) = ZwGetContextThread(ThreadHandle, ThreadContext);
  if ( v6 )
  {
