/*
 * XREFs of DifZwAllocateLocallyUniqueIdWrapper @ 0x14069D170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAllocateLocallyUniqueIdWrapper(PLUID Luid)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1024);
  ...
  LODWORD(v14) = ZwAllocateLocallyUniqueId(Luid);
  if ( v4 )
  {
