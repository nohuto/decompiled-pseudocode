/*
 * XREFs of DifNtCreateKeyedEventWrapper @ 0x1406755C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateKeyedEventWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(720);
  ...
  DWORD2(v20) = NtCreateKeyedEvent(a1, a2, a3, a4);
  if ( v9 )
  {
