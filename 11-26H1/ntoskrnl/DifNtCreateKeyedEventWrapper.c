/*
 * XREFs of DifNtCreateKeyedEventWrapper @ 0x1406719E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateKeyedEventWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
