/*
 * XREFs of VfMiscPluginEntry @ 0x140C43630
 * Callers:
 *     <none>
 * Callees:
...
__int64 VfMiscPluginEntry()
{
  ...
  __int64 (__fastcall *v68)(__int64); // [rsp+218h] [rbp+110h]
  ...
  __int64 (__fastcall *v152)(__int64); // [rsp+4B8h] [rbp+3B0h]
  __int64 v153; // [rsp+4C0h] [rbp+3B8h]
  const char *v154; // [rsp+4C8h] [rbp+3C0h]
  int v155; // [rsp+4D0h] [rbp+3C8h]
  __int64 (__fastcall *v156)(__int64); // [rsp+4D8h] [rbp+3D0h]
  ...
  BOOLEAN (__fastcall *v168)(__int64); // [rsp+538h] [rbp+430h]
  ...
  __int64 (__fastcall *v212)(__int64); // [rsp+698h] [rbp+590h]
  ...
  const char *v274; // [rsp+888h] [rbp+780h]
  int v275; // [rsp+890h] [rbp+788h]
  __int64 v276; // [rsp+898h] [rbp+790h]
  __int64 v277; // [rsp+8A0h] [rbp+798h]
  const char *v278; // [rsp+8A8h] [rbp+7A0h]
  int v279; // [rsp+8B0h] [rbp+7A8h]
  __int64 v280; // [rsp+8B8h] [rbp+7B0h]
  __int64 v281; // [rsp+8C0h] [rbp+7B8h]

  LODWORD(v7) = 238;
  v9 = 0LL;
  qword_140F08528 = (__int64)VfMiscPluginUnload;
  ...
  v280 = 0LL;
  v281 = 0LL;
  v0 = DifRegisterPlugin((__int64)&v6, 0x45u, 0xBu, (__int64)&ViMiscSetting);
  if ( v0 >= 0 )
  {
    v1 = VfAvlInitializeTree(&ViLookasideAvl);
    v2 = &ViLookasideInitialized;
    if ( v1 < 0 )
      v2 = &ViLookasideAllocationFailures;
    _InterlockedExchange(v2, 1);
    v3 = VfAvlInitializeTree(&ViResourceAvl);
