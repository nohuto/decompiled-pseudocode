/*
 * XREFs of DifNtOpenSemaphoreWrapper @ 0x140682A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSemaphoreWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(693);
  ...
  LODWORD(v19) = NtOpenSemaphore(SemaphoreHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
