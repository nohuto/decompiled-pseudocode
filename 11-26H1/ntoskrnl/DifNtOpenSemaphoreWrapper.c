/*
 * XREFs of DifNtOpenSemaphoreWrapper @ 0x14067EE20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSemaphoreWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenSemaphore(a1, a2, a3);
  if ( v8 )
  {
