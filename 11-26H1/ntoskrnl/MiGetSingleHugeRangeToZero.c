/*
 * XREFs of MiGetSingleHugeRangeToZero @ 0x1404F2E34
 * Callers:
...
unsigned __int64 __fastcall MiGetSingleHugeRangeToZero(unsigned __int64 a1, __int64 a2, volatile signed __int32 *a3)
{
  ...
  *(_QWORD *)&v20 = *(_QWORD *)(*(_QWORD *)(a2 + 13896) + 17040LL)
                  + 8
                  * ((unsigned int)dword_140E2D780[0]
  ...
  while ( v11 < 2 )
  {
    ...
    do
    {
      ...
      if ( ((*(_QWORD *)(v14 + 8LL * Cache) >> 15) & 0x3FFFFF) == 0 )
        goto LABEL_9;
      if ( !_bittest64(*(const signed __int64 **)&stru_140E2EB88.WaitRegister.Flags, v15) )
        continue;
      v16 = (__int64 *)(*(_QWORD *)((char *)&stru_140E2EB88.116 + 4) + 8 * v15);
      if ( !v11
        && ((*(int *)(*(_QWORD *)&stru_140E2EB88.SystemCallNumber + 4 * ((((__int64)(8 * v15) >> 3) & 0x3FFFFFuLL) >> 5)) >> (((__int64)(8 * v15) >> 3) & 0x1F)) & 1) != 0 )
      {
        v8 = 1;
LABEL_9:
      ...
      MiLockHugePfnAtDpc(*(_QWORD *)((char *)&stru_140E2EB88.116 + 4) + 8 * v15);
      v17 = *v16;
        ...
        if ( (v17 & 0x800000000000000LL) == 0 && (unsigned int)MiBeginPageAccessor(a1, 0, (__int64)v16, 1) )
        {
          _InterlockedAnd(
            (volatile signed __int32 *)(*(_QWORD *)&stru_140E2EB88.SystemCallNumber
                                      + 4
                                      * (((((__int64)v16 - *(_QWORD *)((char *)&stru_140E2EB88.116 + 4)) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << (((__int64)v16 - *(_QWORD *)((char *)&stru_140E2EB88.116 + 4)) >> 3)));
          return v15;
        }
        _InterlockedAnd(
          (volatile signed __int32 *)(*(_QWORD *)&stru_140E2EB88.SystemCallNumber
