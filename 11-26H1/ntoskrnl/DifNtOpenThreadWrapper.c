/*
 * XREFs of DifNtOpenThreadWrapper @ 0x14067F5D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenThreadWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
