/*
 * XREFs of sub_140B699A8 @ 0x140B699A8
 * Callers:
...
__int64 __fastcall sub_140B699A8(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // ebx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
        ...
        if ( *(_DWORD *)a1 > 3u )
        {
          ...
          if ( !v14 )
          {
            ...
            if ( v18 >= v8 )
            {
              ...
              if ( (_DWORD)v26 )
                v28 = (__int64)(v24 + 1);
              v29 = ExpPlatformBinaryLock.SchedulerApc.SystemArgument1
