/*
 * XREFs of KseDriverUnloadImage @ 0x140A2501C
 * Callers:
...
__int64 __fastcall KseDriverUnloadImage(__int64 a1)
{
  ...
  if ( (unsigned int)KsepIsModuleShimmed(&KseEngine, *(_QWORD *)(a1 + 48), &v26) )
  {
    ...
    if ( v26 )
    {
      ...
      v6 = (AutoBoost *)KeAbPreAcquire((__int64)&stru_140E66B30, 0LL, 0LL, v3);
      v8 = _interlockedbittestandset64(&stru_140E66B30.Header.Lock, 0LL);
      v9 = v6;
      if ( v8 )
        ExfAcquirePushLockExclusiveEx((unsigned __int64 *)&stru_140E66B30, v6, (__int64)&stru_140E66B30);
      if ( v9 )
      {
        ...
        do
        {
          ...
          if ( !*((_DWORD *)v14 + 6) )
          {
            v15 = ((unsigned __int8)_InterlockedExchangeAdd(
                                      ...
                                      1u)
                 + 1) & 0x3F;
            *(_DWORD *)&AlpcpMessageLogLock.WaitBlockFill6[8 * v15 + 4] = -1073740768;
            *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v15) = 460180;
