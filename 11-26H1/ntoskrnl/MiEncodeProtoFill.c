/*
 * XREFs of MiEncodeProtoFill @ 0x140499E80
 * Callers:
...
__int64 __fastcall MiEncodeProtoFill(unsigned __int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v7 = 0LL;
  v8 = v4 + 8 * v5;
  v13 = MiLockWorkingSetShared((__int64)&unk_140E37080, v5, a3);
  v10 = v13;
  if ( v4 >= v8 )
    goto LABEL_15;
  do
  {
    if ( v7 )
    {
      if ( (v4 & 0xFFF) != 0 )
        goto LABEL_5;
      MiUnlockPageTableInternal((__int64)&unk_140E37080, v7);
    }
    v7 = ((v4 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    MiLockPageTableInternal((signed __int64)&unk_140E37080, v7, 0);
LABEL_5:
    v11 = *(_QWORD *)v4;
    if ( (*(_QWORD *)v4 & 1) != 0 )
      break;
...
LABEL_15:
  LOBYTE(v9) = v10;
  MiUnlockWorkingSetShared((__int64)&unk_140E37080, v9);
  return v6;
}
