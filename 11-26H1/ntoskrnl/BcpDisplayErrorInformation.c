/*
 * XREFs of BcpDisplayErrorInformation @ 0x14071BC28
 * Callers:
...
__int64 __fastcall BcpDisplayErrorInformation(int a1, int a2, __int64 a3, __int64 a4, __int64 a5, char a6)
{
  ...
  struct _LIST_ENTRY *v35; // [rsp+38h] [rbp-A1h]
  int Blink; // [rsp+40h] [rbp-99h] BYREF
  ...
  v39 = a4;
  v34 = a2;
  v33 = (int)WheapPfaLock.ThreadListEntry.Flink;
  v9 = (int *)((char *)&unk_140E0F0A0 + 84 * a1);
  WheapPfaLock.MutantListHead.Flink = (struct _LIST_ENTRY *)&v33;
  BcpDisplayCriticalString(&stru_140E3EAA8.216, v9[1], a3, a1);
  BcpDisplayCriticalString(&stru_140E3EAA8.Queue, v9[1], v10, a1);
  v11 = v9[11];
  v12 = (unsigned int)(v11 + LODWORD(WheapPfaLock.ThreadListEntry.Blink));
  v13 = v12 + v11;
  v32 = v12 + v11;
  BcpSetCursorPosition(Flink, v12, &v32);
  BcpDisplayCriticalString(&stru_140E3EAA8.InitialStack, *v9, v14, a1);
  v15 = v13 + v9[11];
  v32 = v15;
  BcpSetCursorPosition(Flink, v13, &v32);
  BcpDisplayCriticalString(&stru_140E3EAA8.WaitStatus, *v9, v16, a1);
  ...
  {
    v32 = v15 + v9[11];
    BcpSetCursorPosition(Flink, v15, &v32);
    BcpDisplayCriticalString(&stru_140E3EAA8.ApcStateFill[32], *v9, v21, a1);
  ...
  v35 = WheapPfaLock.ThreadListEntry.Flink;
  ...
  do
  {
    ...
    if ( WheapPfaLock.AbWaitEntryCount || (a6 & 8) != 0 && v34 == 317 )
    {
  ...
  while ( v28 );
  result = BcpSetCursorPosition((unsigned int)v35, HIDWORD(v35), &Blink);
  WheapPfaLock.MutantListHead.Flink = v31;
  return result;
}
