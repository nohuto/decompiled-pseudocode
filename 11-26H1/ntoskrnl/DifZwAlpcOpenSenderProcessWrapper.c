/*
 * XREFs of DifZwAlpcOpenSenderProcessWrapper @ 0x14069F050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcOpenSenderProcessWrapper(
        HANDLE *a1,
        void *a2,
        _PORT_MESSAGE *a3,
        ULONG a4,
        ...
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(965);
...
LABEL_7:
  v14 = 0;
  *((_QWORD *)&v22 + 1) = a1;
  *(_QWORD *)&v21 = __PAIR64__(a4, DesiredAccess);
...
LABEL_17:
  LODWORD(v23) = ZwAlpcOpenSenderProcess(a1, a2, a3, a4, DesiredAccess, ObjectAttributes);
  if ( v11 )
  {
