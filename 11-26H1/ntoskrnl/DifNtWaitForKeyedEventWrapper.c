/*
 * XREFs of DifNtWaitForKeyedEventWrapper @ 0x140694D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForKeyedEventWrapper(void *a1, void *a2, BOOLEAN a3, LARGE_INTEGER *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(723);
  ...
  DWORD2(v20) = NtWaitForKeyedEvent(a1, a2, a3, a4);
  if ( v9 )
  {
