/*
 * XREFs of DifNtWaitForKeyedEventWrapper @ 0x140691180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForKeyedEventWrapper(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  ...
  LOBYTE(v9) = a3;
  DWORD2(v21) = NtWaitForKeyedEvent(
                  a1,
                  a2,
                  v9,
                  a4,
