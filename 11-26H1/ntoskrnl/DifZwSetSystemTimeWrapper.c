/*
 * XREFs of DifZwSetSystemTimeWrapper @ 0x1406BFB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetSystemTimeWrapper(PLARGE_INTEGER SystemTime, PLARGE_INTEGER PreviousTime)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = SystemTime;
    *((_QWORD *)&v15 + 1) = PreviousTime;
  ...
  DWORD2(v16) = ZwSetSystemTime(SystemTime, PreviousTime);
  if ( v6 )
  {
