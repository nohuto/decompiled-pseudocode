  ...
  if ( v4 && (*(_DWORD *)(a1 + 116) & 0x400) == 0 )
  {
    ...
    if ( a1 == a2 || ExAcquireRundownProtection_0((PEX_RUNDOWN_REF)(a1 + 1416)) )
    {
      do
      {
        ...
        v13 = v6 != 0;
        v8 = v6 != 0;
        RtlWriteULongToUser(v4 + 1511, v8);
        RtlWriteULongToUser(v4 + 1530, 0);
        if ( *(_QWORD *)(v5 + 784) )
        {
          v9 = *(_WORD *)(v5 + 1772);
          if ( v9 == 332 || v9 == 452 )
          {
            RtlWriteULongToUser(v4 + 3047, v8);
            RtlWriteULongToUser(v4 + 3057, 0);
          }
        }
      ...
      if ( a1 != a2 )
        ExReleaseRundownProtection_0((PEX_RUNDOWN_REF)(a1 + 1416));
    }
    if ( v12 )
