/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1406D833C
 * Callers:
...
LABEL_28:
  ...
  else
  {
    ...
    if ( !dword_140EEEDBC )
      goto LABEL_35;
    v10 = 972 * dword_140EEEDBC + 12;
    if ( v10 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v34 = (__int64 *)qword_140EEEDC8;
    v35 = a3 + 3;
    v36 = 0;
    for ( i = 0; v34 != &qword_140EEEDC8; v34 = (__int64 *)*v34 )
    {
      if ( i >= dword_140EEEDBC )
        break;
      v38 = v35;
      v39 = v34 + 12;
      v40 = 7LL;
