/*
 * XREFs of sub_1407716AC @ 0x1407716AC
 * Callers:
...
__int64 __fastcall sub_1407716AC(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // rax
  __int64 i; // rdx
  __int64 v8; // r8
  ...
  v12 = *v10;
  if ( !ExpPlatformBinaryLock.SavedApcState.Process )
