/*
 * XREFs of ?KiAdvanceReadyQueueEnumeratorToNextRootScb@@YAJPEAU_KI_READY_QUEUE_ENUMERATOR@@@Z @ 0x1403AB3EC
 * Callers:
...
__int64 __fastcall KiAdvanceReadyQueueEnumeratorToNextRootScb(struct _KI_READY_QUEUE_ENUMERATOR *a1)
{
  ...
  v4 = *((_QWORD *)a1 + 6 * *((unsigned __int8 *)a1 + 10) + 8);
  v5 = *((_QWORD *)a1 + 6 * *((unsigned __int8 *)a1 + 10) + 9);
  if ( v5 && *(_QWORD *)(v5 + 448) == v4 )
    goto LABEL_3;
  v12 = *(_QWORD *)(v4 + 112);
  v13 = v4 + 104;
  if ( v12 )
...
LABEL_3:
  ...
  {
    v6 = v12 - 104;
    if ( *(_DWORD *)(v6 + 140) > *((_DWORD *)a1 + 2 * v3 + 20) )
      v6 = 0LL;
  }
  *((_QWORD *)a1 + v3 + 8) = v6;
  v7 = 0;
  ...
  do
  {
    ...
    if ( v10 && (!v8 || *(_DWORD *)(v8 + 140) < *(_DWORD *)(v10 + 140)) )
    {
      v7 = v9;
      v8 = *((_QWORD *)a1 + 6 * v9 + 8);
    }
