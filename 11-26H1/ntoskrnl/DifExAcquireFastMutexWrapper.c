/*
 * XREFs of DifExAcquireFastMutexWrapper @ 0x140652560
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExAcquireFastMutexWrapper(PKGUARDED_MUTEX Mutex)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(424);
