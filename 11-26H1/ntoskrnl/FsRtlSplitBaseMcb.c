...
LABEL_28:
    ...
    if ( v9 == v5 )
    {
      ...
      v10 = v20 - 1;
      v11 = Mapping[2 * v10 + 1];
      if ( v11 == -1 || (v20 != 1 ? (v12 = Mapping[2 * v20 - 4]) : (v12 = 0), v11 + Mapping[2 * v10] + ~v12 == -1) )
      {
        LODWORD(v7) = v20 - 1;
        goto LABEL_29;
      }
...
LABEL_17:
      ...
      else if ( FsRtlAddEntry((__int64)Mcb, v20, 2) )
      {
        ...
        *((_DWORD *)Mcb->Mapping + 2 * v15) = v5 + v3;
        v18 = 0;
        v19 = Mcb->Mapping;
        if ( !v17 )
          v18 = v19[2 * v7];
