/*
 * XREFs of DifZwUmsThreadYieldWrapper @ 0x1406C1A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUmsThreadYieldWrapper(PVOID SchedulerParam)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1048);
  ...
  LODWORD(v14) = ZwUmsThreadYield(SchedulerParam);
  if ( v4 )
  {
