/*
 * XREFs of DifNtWaitForAlertByThreadIdWrapper @ 0x140694A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForAlertByThreadIdWrapper(PVOID Address, PLARGE_INTEGER Timeout)
{
  ...
  DWORD2(v16) = NtWaitForAlertByThreadId(Address, Timeout);
  if ( v6 )
  {
