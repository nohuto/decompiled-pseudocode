/*
 * XREFs of DifNtWaitForAlertByThreadIdWrapper @ 0x140690E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForAlertByThreadIdWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtWaitForAlertByThreadId(a1, a2);
  if ( v6 )
  {
