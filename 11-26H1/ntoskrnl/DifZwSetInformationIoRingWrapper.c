/*
 * XREFs of DifZwSetInformationIoRingWrapper @ 0x1406B9FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationIoRingWrapper(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1131);
  ...
  LODWORD(v19) = ZwSetInformationIoRing(a1, a2, a3, a4, v17, *((_QWORD *)&v17 + 1), v18, *((_QWORD *)&v18 + 1), v19);
  if ( v9 )
  {
