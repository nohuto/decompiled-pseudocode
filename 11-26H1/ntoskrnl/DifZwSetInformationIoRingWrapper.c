/*
 * XREFs of DifZwSetInformationIoRingWrapper @ 0x1406BDBA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationIoRingWrapper(void *a1, ULONG a2, ULONG a3, void *a4)
{
  ...
  LODWORD(v19) = ZwSetInformationIoRing(a1, a2, a3, a4);
  if ( v9 )
  {
