/*
 * XREFs of RtlStringCbPrintfExA @ 0x140578B4C
 * Callers:
        ...
        ...)
{
  ...
  else
  {
    ...
    else if ( cbDest )
    {
      ...
      v13 = RtlStringVPrintfWorkerA(pszDest, cbDest, pcchNewDestLength, v10, argList);
      ...
      if ( v13 >= 0 )
      {
        if ( (dwFlags & 0x200) != 0 && v12 > 1 )
          RtlStringExHandleFillBehindNullA(&pszDest[v14], v12, dwFlags);
        goto LABEL_13;
      }
    }
    else
