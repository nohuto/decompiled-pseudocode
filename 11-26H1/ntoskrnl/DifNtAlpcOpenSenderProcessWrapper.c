/*
 * XREFs of DifNtAlpcOpenSenderProcessWrapper @ 0x140670B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcOpenSenderProcessWrapper(
        HANDLE *a1,
        void *a2,
        _PORT_MESSAGE *a3,
        ULONG a4,
...
LABEL_17:
  LODWORD(v23) = NtAlpcOpenSenderProcess(a1, a2, a3, a4, DesiredAccess, ObjectAttributes);
  if ( v11 )
  {
