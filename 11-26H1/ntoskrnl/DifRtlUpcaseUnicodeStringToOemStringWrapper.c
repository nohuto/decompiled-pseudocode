/*
 * XREFs of DifRtlUpcaseUnicodeStringToOemStringWrapper @ 0x14069A830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlUpcaseUnicodeStringToOemStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v19) = RtlUpcaseUnicodeStringToOemString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
