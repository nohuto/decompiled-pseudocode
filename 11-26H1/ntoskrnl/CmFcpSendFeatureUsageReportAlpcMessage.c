/*
 * XREFs of CmFcpSendFeatureUsageReportAlpcMessage @ 0x1404E9848
 * Callers:
...
__int64 __fastcall CmFcpSendFeatureUsageReportAlpcMessage(__int64 a1, __int64 a2, int a3)
{
  ...
  __int64 v13; // [rsp+88h] [rbp-1h] BYREF
  ...
  if ( v5 >= 0 )
  {
    ...
    DWORD2(v11) = 2;
    LODWORD(v12) = a3;
    v5 = ((__int64 (__fastcall *)(__int64, __int64, __int128 *, __int64 *, __int128 *, unsigned __int64 *, _QWORD, _QWORD))ZwAlpcSendWaitReceivePort)(
           a1,
           0x20000LL,
           &v9,
           &v13,
