/*
 * XREFs of _CmGetDeviceRegKeySecurityDescriptor @ 0x140B0B580
 * Callers:
...
__int64 __fastcall CmGetDeviceRegKeySecurityDescriptor(__int64 a1, int a2, PVOID *a3)
{
  PVOID v5; // rcx
  char v6; // r8
  unsigned int v7; // ebx
  ...
  else
  {
    *a3 = 0LL;
    ...
    if ( *(_DWORD *)a1 >= 0xA000000u && ((unsigned __int8)a2 == 17 || (unsigned __int8)a2 == 18 && *(_BYTE *)(a1 + 4)) )
      v6 = 1;
    LOBYTE(v8) = v6;
    RegKeySecurityDescriptor = CmGetRegKeySecurityDescriptor(v8, &P);
    v5 = P;
