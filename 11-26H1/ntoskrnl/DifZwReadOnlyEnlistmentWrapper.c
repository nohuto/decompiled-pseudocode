/*
 * XREFs of DifZwReadOnlyEnlistmentWrapper @ 0x1406B9980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReadOnlyEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1109);
  ...
  DWORD2(v16) = ZwReadOnlyEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
