/*
 * XREFs of DifNtOpenJobObjectWrapper @ 0x14067D4D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenJobObjectWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenJobObject(a1, a2, a3);
  if ( v8 )
  {
