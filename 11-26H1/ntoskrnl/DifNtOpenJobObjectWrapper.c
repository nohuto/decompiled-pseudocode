/*
 * XREFs of DifNtOpenJobObjectWrapper @ 0x1406810B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenJobObjectWrapper(
        PHANDLE JobHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtOpenJobObject(JobHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
