/*
 * XREFs of DifNtCommitCompleteWrapper @ 0x1406729B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCommitCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(841);
  ...
  DWORD2(v16) = NtCommitComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
