/*
 * XREFs of PopFanUpdateSpeed @ 0x1407DB0F0
 * Callers:
...
unsigned __int8 __fastcall PopFanUpdateSpeed(__int64 a1, unsigned int a2)
{
  ...
  unsigned int v14; // [rsp+3Ch] [rbp-95h] BYREF
  __int64 v15; // [rsp+40h] [rbp-91h] BYREF
  unsigned int v16; // [rsp+48h] [rbp-89h] BYREF
  unsigned int v17; // [rsp+4Ch] [rbp-85h] BYREF
  __int64 v18; // [rsp+50h] [rbp-81h] BYREF
  int v19; // [rsp+58h] [rbp-79h]
  int v20; // [rsp+5Ch] [rbp-75h]
  unsigned int v21; // [rsp+60h] [rbp-71h] BYREF
...
LABEL_33:
    if ( (unsigned int)dword_140E07598 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&byte_14004E487,
        0LL,
        0LL,
        7u,
        v24);
...
LABEL_13:
    ...
    {
      if ( unk_140F10EAC != v5 || unk_140F10EB0 != v6 )
      {
        if ( (unsigned int)dword_140E07598 > 5 )
        {
          v17 = unk_140F10EAC;
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140E07598,
            (unsigned __int8 *)byte_14004E893,
            0LL,
            0LL,
            8u,
            v24);
    ...
    else if ( unk_140F10EAC != v5 )
    {
      if ( (unsigned int)dword_140E07598 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140E07598,
          (unsigned __int8 *)word_14004E42A,
          0LL,
          0LL,
          5u,
          v24);
  ...
  else if ( (unsigned int)dword_140E07598 > 2 )
  {
    v18 = a1;
    v25 = &v18;
    LODWORD(v15) = dword_140F10EA8;
    v26 = 8LL;
    v27 = (unsigned int *)&v15;
    v28 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07598, (unsigned __int8 *)&unk_14004E3D0, 0LL, 0LL, 4u, v24);
  }
  ...
  if ( (unsigned int)dword_140E07598 > 5 )
  {
    ...
    v28 = 4LL;
    v30 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07598, (unsigned __int8 *)&dword_14004E4FC, 0LL, 0LL, 5u, v24);
    goto LABEL_33;
  }
  return v4;
}
