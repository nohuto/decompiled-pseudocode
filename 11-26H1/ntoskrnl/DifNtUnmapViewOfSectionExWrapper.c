/*
 * XREFs of DifNtUnmapViewOfSectionExWrapper @ 0x1406906F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnmapViewOfSectionExWrapper(ULONG_PTR BugCheckParameter1, __int64 a2, int a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(766);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = BugCheckParameter1;
    *(_QWORD *)&v18 = a2;
    DWORD2(v17) = a3;
  ...
  LODWORD(v19) = NtUnmapViewOfSectionEx(BugCheckParameter1);
  if ( v8 )
  {
