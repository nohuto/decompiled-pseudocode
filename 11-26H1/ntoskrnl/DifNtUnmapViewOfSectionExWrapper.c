/*
 * XREFs of DifNtUnmapViewOfSectionExWrapper @ 0x1406942D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnmapViewOfSectionExWrapper(HANDLE ProcessHandle, PVOID BaseAddress, ULONG Flags)
{
  ...
  LODWORD(v19) = NtUnmapViewOfSectionEx(ProcessHandle, BaseAddress, Flags);
  if ( v8 )
  {
