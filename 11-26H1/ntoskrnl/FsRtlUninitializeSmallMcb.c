/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x140C81490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(__int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 2080) )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(CompleteDev + 648))(CompleteDev + 2080, 0LL);
  ...
  v9 = (unsigned __int64 *)&loc_140C81516;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
