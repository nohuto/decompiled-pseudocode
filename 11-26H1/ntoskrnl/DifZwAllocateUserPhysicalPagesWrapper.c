/*
 * XREFs of DifZwAllocateUserPhysicalPagesWrapper @ 0x140699A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAllocateUserPhysicalPagesWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1082);
  ...
  LODWORD(v19) = ZwAllocateUserPhysicalPages(a1, a2, a3);
  if ( v8 )
  {
