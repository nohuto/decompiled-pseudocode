/*
 * XREFs of DifZwAllocateUserPhysicalPagesWrapper @ 0x14069D600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAllocateUserPhysicalPagesWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  LODWORD(v19) = ZwAllocateUserPhysicalPages(ProcessHandle, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
