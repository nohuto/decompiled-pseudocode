/*
 * XREFs of DifNtCreatePagingFileWrapper @ 0x1406722E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreatePagingFileWrapper(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
