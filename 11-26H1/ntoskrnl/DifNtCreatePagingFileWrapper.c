/*
 * XREFs of DifNtCreatePagingFileWrapper @ 0x140675EC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreatePagingFileWrapper(UNICODE_STRING *a1, LARGE_INTEGER *a2, LARGE_INTEGER *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(784);
  ...
  DWORD2(v20) = NtCreatePagingFile(a1, a2, a3, a4);
  if ( v9 )
  {
