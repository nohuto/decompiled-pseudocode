/*
 * XREFs of DifZwCreateWaitablePortWrapper @ 0x1406A7130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateWaitablePortWrapper(
        HANDLE *a1,
        ...
        ULONG MaxPoolUsage)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(946);
  ...
  DWORD2(v21) = ZwCreateWaitablePort(a1, a2, a3, a4, MaxPoolUsage);
  if ( v10 )
  {
