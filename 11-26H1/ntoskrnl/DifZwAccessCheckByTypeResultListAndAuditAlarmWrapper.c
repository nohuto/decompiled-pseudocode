/*
 * XREFs of DifZwAccessCheckByTypeResultListAndAuditAlarmWrapper @ 0x14069B5C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAccessCheckByTypeResultListAndAuditAlarmWrapper(
        UNICODE_STRING *a1,
        void *a2,
        UNICODE_STRING *a3,
        UNICODE_STRING *a4,
        ...
        BOOLEAN *GenerateOnClose)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(883);
...
LABEL_17:
  v45 = ZwAccessCheckByTypeResultListAndAuditAlarm(
          a1,
          a2,
          a3,
          a4,
