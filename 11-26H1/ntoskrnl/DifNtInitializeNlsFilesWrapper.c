/*
 * XREFs of DifNtInitializeNlsFilesWrapper @ 0x140679FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtInitializeNlsFilesWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtInitializeNlsFiles(a1, a2, a3);
  if ( v8 )
  {
