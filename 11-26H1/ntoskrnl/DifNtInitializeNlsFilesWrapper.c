/*
 * XREFs of DifNtInitializeNlsFilesWrapper @ 0x14067DBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtInitializeNlsFilesWrapper(
        PVOID *BaseAddress,
        ...
        PLARGE_INTEGER DefaultCasingTableSize)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(737);
  ...
  LODWORD(v20) = NtInitializeNlsFiles(BaseAddress, DefaultLocaleId, DefaultCasingTableSize, v8);
  if ( v9 )
  {
