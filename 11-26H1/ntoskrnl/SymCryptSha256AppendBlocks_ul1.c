/*
 * XREFs of SymCryptSha256AppendBlocks_ul1 @ 0x140555EC0
 * Callers:
...
__int64 __fastcall SymCryptSha256AppendBlocks_ul1(__m128i *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 *a4)
{
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      v65 = v58;
      v66 = v132;
      v67 = (char *)&xmmword_140023B40 + 8;
      v68 = v123
          + (__ROR4__(v63, 11) ^ __ROR4__(v63, 25) ^ __ROR4__(v63, 6))
          + (v115 ^ v63 & (v115 ^ v58))
          + v52
          - 1046744716;
      v114 = (char *)&xmmword_140023B40 + 8;
      v69 = v68 + v54;
      v70 = v123;
      v116 = v69;
      ...
      while ( (__int64)v67 < (__int64)((char *)&_xmm + 8) );
      v5 = a1;
