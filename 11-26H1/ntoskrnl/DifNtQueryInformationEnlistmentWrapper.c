/*
 * XREFs of DifNtQueryInformationEnlistmentWrapper @ 0x140686640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationEnlistmentWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(832);
  ...
  LODWORD(v21) = NtQueryInformationEnlistment(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
