/*
 * XREFs of DifZwUnmapViewOfSectionWrapper @ 0x1406C25E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnmapViewOfSectionWrapper(HANDLE ProcessHandle, PVOID BaseAddress)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1070);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = ProcessHandle;
    *((_QWORD *)&v15 + 1) = BaseAddress;
  ...
  DWORD2(v16) = ZwUnmapViewOfSection(ProcessHandle, BaseAddress);
  if ( v6 )
  {
