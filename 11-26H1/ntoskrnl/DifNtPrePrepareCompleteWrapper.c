/*
 * XREFs of DifNtPrePrepareCompleteWrapper @ 0x140683B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPrePrepareCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(839);
  ...
  DWORD2(v16) = NtPrePrepareComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
