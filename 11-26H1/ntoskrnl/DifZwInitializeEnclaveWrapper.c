/*
 * XREFs of DifZwInitializeEnclaveWrapper @ 0x1406AC220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwInitializeEnclaveWrapper(void *a1, void *a2, void *a3, ULONG a4, ULONG *EnclaveError)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1064);
  ...
  LODWORD(v21) = ZwInitializeEnclave(a1, a2, a3, a4, EnclaveError);
  if ( v10 )
  {
