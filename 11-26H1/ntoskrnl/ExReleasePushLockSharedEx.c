/*
 * XREFs of ExReleasePushLockSharedEx @ 0x140279820
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ExReleasePushLockSharedEx(unsigned __int64 a1, ULONG_PTR BugCheckParameter1)
{
  __int64 v2; // rdi
  char v3; // bl
  __int64 v5; // r14
...
LABEL_37:
      if ( (_DWORD)v2 )
        AutoBoost::KiAbpUnboostThread(*(_QWORD *)(v5 - 48LL * (*(_BYTE *)(v5 + 36) & 0x7F) - 16), a1, v2, 0LL);
    }
    else
    {
      ...
      v29 = 0;
      v30 = a1 & 0x7FFFFFFFFFFFFFFCLL;
      while ( v29 < (unsigned __int8)v28[12] )
      {
        v31 = (LegacyAutoBoost *)&v28[88 * v29 + 16];
        if ( (*(_QWORD *)v31 & 0x7FFFFFFFFFFFFFFCLL) == v30 && *((_BYTE *)v31 + 10) && (*(_QWORD *)v31 & 1) == 0 )
        {
          *((_BYTE *)v31 + 10) = 0;
          if ( v31 )
          {
      ...
      if ( v38 )
      {
        ...
        while ( v41 != v39 );
        if ( (v39 & 0x200000) != 0 )
          KiRemoveSystemWorkPriorityKick(v37, v40, v38, v30);
      }
      _enable();
    }
  }
