/*
 * XREFs of DifZwAllocateVirtualMemoryExWrapper @ 0x14069D910
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  VirtualMemory = ZwAllocateVirtualMemoryEx(a1, a2, a3, a4, PageProtection, ExtendedParameters, ExtendedParameterCount);
  if ( v12 )
  {
