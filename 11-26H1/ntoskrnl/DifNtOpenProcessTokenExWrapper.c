/*
 * XREFs of DifNtOpenProcessTokenExWrapper @ 0x1406820B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenProcessTokenExWrapper(void *a1, ACCESS_MASK a2, ULONG a3, HANDLE *a4)
{
  ...
  LODWORD(v19) = NtOpenProcessTokenEx(a1, a2, a3, a4);
  if ( v9 )
  {
