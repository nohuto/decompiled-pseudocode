/*
 * XREFs of PopFxLogSocSubsystemBlockingTimes @ 0x140A4383C
 * Callers:
...
__int64 __fastcall PopFxLogSocSubsystemBlockingTimes(__int64 a1, int a2)
{
  ...
  unsigned __int8 *v19; // [rsp+50h] [rbp-79h]
  ...
  unsigned __int8 *v24; // [rsp+80h] [rbp-49h]
  ...
  unsigned __int8 *v31; // [rsp+B0h] [rbp-19h]
  ...
  if ( v5 )
  {
    for ( i = 0; i < *((_DWORD *)v5 + 5); ++i )
    {
      ...
      v20 = 0LL;
      v21 = 0;
      if ( !(unsigned __int8)PopPluginQuerySocSubsystemBlockingTime(v4, *(unsigned int *)&v5[v7 + 60], &v16) )
