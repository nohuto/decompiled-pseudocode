/*
 * XREFs of DifNtGetDevicePowerStateWrapper @ 0x14067CBB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetDevicePowerStateWrapper(HANDLE Device, PDEVICE_POWER_STATE State)
{
  ...
  DWORD2(v16) = NtGetDevicePowerState(Device, State);
  if ( v6 )
  {
