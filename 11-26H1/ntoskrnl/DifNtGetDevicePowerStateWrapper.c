/*
 * XREFs of DifNtGetDevicePowerStateWrapper @ 0x140678FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetDevicePowerStateWrapper(HANDLE Handle, __int64 a2)
{
  ...
  DWORD2(v16) = NtGetDevicePowerState(Handle);
  if ( v6 )
  {
