/*
 * XREFs of DifNtPrepareEnlistmentWrapper @ 0x140683FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPrepareEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(836);
  ...
  DWORD2(v16) = NtPrepareEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
