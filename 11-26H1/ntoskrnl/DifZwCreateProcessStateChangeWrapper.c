/*
 * XREFs of DifZwCreateProcessStateChangeWrapper @ 0x1406A0F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateProcessStateChangeWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, int a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(934);
  ...
  LODWORD(v21) = ZwCreateProcessStateChange(a1, a2, a3, a4, a5);
  if ( v10 )
  {
