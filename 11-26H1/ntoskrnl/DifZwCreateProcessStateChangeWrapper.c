/*
 * XREFs of DifZwCreateProcessStateChangeWrapper @ 0x1406A4AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateProcessStateChangeWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        int a5)
{
  ...
  LODWORD(Reserved) = a5;
  LODWORD(v22) = ZwCreateProcessStateChange(a1, a2, a3, a4, Reserved);
  if ( v10 )
  {
