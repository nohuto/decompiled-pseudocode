/*
 * XREFs of MiTradePageMarkedPoisoned @ 0x1405193C8
 * Callers:
 ...
 *     MiAddMdlPageToTradeBlock @ 0x140472930 (MiAddMdlPageToTradeBlock.c)
 */
...
char __fastcall MiTradePageMarkedPoisoned(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 56) = 1;
  ...
  if ( (_DWORD)v6 == 2 )
  {
    ...
    if ( (_WORD)v6 )
    {
      _InterlockedAdd(&dword_140EF8DC0, 1u);
      *(_DWORD *)(a1 + 56) = 1;
LABEL_14:
      *(_BYTE *)(a1 + 9) = 1;
      return v6;
    ...
    else
    {
      ...
      _InterlockedAdd(&dword_140EF8DBC, 1u);
      *(_DWORD *)(a1 + 56) = 1;
      *(_BYTE *)(a1 + 9) = 1;
    }
  }
  ...
  {
    _InterlockedAdd(&dword_140EF8DD0, 1u);
    goto LABEL_14;
  }
  return v6;
}
