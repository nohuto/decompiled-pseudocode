/*
 * XREFs of DifObfReferenceObjectWithTagWrapper @ 0x140696610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifObfReferenceObjectWithTagWrapper(PVOID Object, ULONG Tag)
{
  ...
  *((_QWORD *)&v16 + 1) = ObfReferenceObjectWithTag(Object, Tag);
  if ( v6 )
  {
