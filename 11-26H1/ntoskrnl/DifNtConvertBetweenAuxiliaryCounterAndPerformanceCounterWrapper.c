/*
 * XREFs of DifNtConvertBetweenAuxiliaryCounterAndPerformanceCounterWrapper @ 0x140673460
 * Callers:
 *     <none>
 * Callees:
        ...
        LARGE_INTEGER *a4)
{
  ...
  HIDWORD(v19) = NtConvertBetweenAuxiliaryCounterAndPerformanceCounter(a1, a2, a3, a4);
  if ( v9 )
  {
