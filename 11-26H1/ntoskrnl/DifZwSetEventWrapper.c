/*
 * XREFs of DifZwSetEventWrapper @ 0x1406BD220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
  ...
  DWORD2(v16) = ZwSetEvent(EventHandle, PreviousState);
  if ( v6 )
  {
