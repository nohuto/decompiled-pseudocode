 ...
 *     PipIsDeviceInDeviceObjectList @ 0x140910838 (PipIsDeviceInDeviceObjectList.c)
 *     PnpProcessRelation @ 0x140913D04 (PnpProcessRelation.c)
 *     IopAddRelationToList @ 0x14091403C (IopAddRelationToList.c)
 *     PnpProcessBusRelations @ 0x140914184 (PnpProcessBusRelations.c)
 *     PnpProcessDependencyRelations @ 0x1409141F8 (PnpProcessDependencyRelations.c)
        ...
        unsigned int **BugCheckParameter3)
{
  ...
  v18 = *(_DWORD *)(a1 + 300);
  if ( v18 == 790 || (unsigned int)(v18 - 784) <= 1 )
  {
    *(_DWORD *)a4 = 13;
LABEL_24:
  ...
  if ( *(int *)(a1 + 656) > 0 || ((v18 - 787) & 0xFFFFFFFD) == 0 )
  {
    *(_DWORD *)a4 = 5;
    goto LABEL_24;
  }
...
LABEL_10:
      ...
      if ( a2 - 5 > 1 && (int)PnpQueryDeviceRelations(*(_QWORD *)(a1 + 32), 1, 0LL, (__int64)P) >= 0 )
      {
        ...
        if ( P[0] )
        {
          for ( j = 0; j < *v16; ++j )
          {
            ...
            v23 = PnpProcessRelation(v34, a2, 0, a4, v10);
  ...
  for ( k = 0; ; ++k )
  {
    ...
    v20 = *(_QWORD *)&v16[2 * k + 2];
    v21 = *(_QWORD *)(v20 + 312);
    if ( (*(_DWORD *)(v21 + 32) & 2) != 0 || (v22 = *(_QWORD *)(v21 + 40)) == 0 || !*(_QWORD *)(v22 + 16) )
    {
      IoAddTriageDumpDataBlock(v20, (PVOID)*(unsigned __int16 *)(v20 + 2));
      v24 = *(_QWORD *)(v20 + 8);
      if ( v24 )
      {
        IoAddTriageDumpDataBlock(v24, (PVOID)(unsigned int)*(__int16 *)(v24 + 2));
        v25 = (_WORD *)(*(_QWORD *)(v20 + 8) + 56LL);
        if ( *v25 )
        {
          IoAddTriageDumpDataBlock((ULONG)v25, (PVOID)2);
          IoAddTriageDumpDataBlock(
            *(_QWORD *)(*(_QWORD *)(v20 + 8) + 64LL),
            (PVOID)*(unsigned __int16 *)(*(_QWORD *)(v20 + 8) + 56LL));
        }
      }
      v27 = *(_QWORD *)(*(_QWORD *)(v20 + 312) + 40LL);
      if ( v27 )
      {
        ...
        v29 = (_WORD *)(*(_QWORD *)(*(_QWORD *)(v20 + 312) + 40LL) + 56LL);
        if ( *v29 )
        {
          IoAddTriageDumpDataBlock((ULONG)v29, (PVOID)2);
          IoAddTriageDumpDataBlock(
            *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v20 + 312) + 40LL) + 64LL),
            (PVOID)*(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(v20 + 312) + 40LL) + 56LL));
        }
        v30 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v20 + 312) + 40LL) + 16LL);
        if ( v30 && *(_WORD *)(v30 + 56) )
        {
          IoAddTriageDumpDataBlock(v30 + 56, (PVOID)2);
          v31 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v20 + 312) + 40LL) + 16LL);
          IoAddTriageDumpDataBlock(*(_QWORD *)(v31 + 64), (PVOID)*(unsigned __int16 *)(v31 + 56));
        }
      }
      KeBugCheckEx(0xCAu, 0xBuLL, v20, 3uLL, 0LL);
    }
    v23 = PnpProcessRelation(v22, a2, 0, a4, v10);
