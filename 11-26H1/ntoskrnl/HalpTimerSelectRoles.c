...
{
  unsigned int v2; // ebx
  ULONG_PTR IdealScalingSource; // rax
  ULONG_PTR v4; // rdi
  ULONG_PTR IdealClockSource; // rax
  ULONG_PTR v6; // rdi
  ULONG_PTR IdealPerformanceCounterSource; // rax
  __int64 v8; // rdi
  __int64 v9; // rcx
  ULONG_PTR Timer; // rax
  __int64 v11; // rdi
  ULONG_PTR BestAlwaysOnTimer; // rax
  ULONG_PTR v13; // rdi
  ULONG_PTR v14; // rcx
  __int64 v15; // rax
  int v16; // eax
  ...
  if ( (*(_DWORD *)(HalpClockTimer + 224) & 1) == 0 )
  {
    ...
    else
    {
      ...
      if ( v15 )
      {
        ...
        if ( v16 < 0 )
        {
          HalpTimerSetProblemEx(HalpClockTimer, 20, 2, (__int64)"minkernel\\hals\\lib\\timers\\common\\timer.c", 0xD5Eu);
          return (unsigned int)-1073741823;
        }
    ...
    HalpTimerSetProblemEx(v15, 20, 1, (__int64)"minkernel\\hals\\lib\\timers\\common\\timer.c", 0xD52u);
    return (unsigned int)-1073741823;
  }
LABEL_39:
