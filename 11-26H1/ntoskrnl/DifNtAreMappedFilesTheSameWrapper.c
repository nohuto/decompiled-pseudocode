/*
 * XREFs of DifNtAreMappedFilesTheSameWrapper @ 0x140671720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAreMappedFilesTheSameWrapper(PVOID File1MappedAsAnImage, PVOID File2MappedAsFile)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(768);
  ...
  DWORD2(v16) = NtAreMappedFilesTheSame(File1MappedAsAnImage, File2MappedAsFile);
  if ( v6 )
  {
