/*
 * XREFs of DifNtAreMappedFilesTheSameWrapper @ 0x14066DB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAreMappedFilesTheSameWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtAreMappedFilesTheSame(a1, a2);
  if ( v6 )
  {
