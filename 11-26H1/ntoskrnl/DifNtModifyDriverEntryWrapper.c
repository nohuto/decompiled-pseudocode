/*
 * XREFs of DifNtModifyDriverEntryWrapper @ 0x14067FAB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtModifyDriverEntryWrapper(PEFI_DRIVER_ENTRY DriverEntry)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(672);
  ...
  LODWORD(v14) = NtModifyDriverEntry(DriverEntry);
  if ( v4 )
  {
