/*
 * XREFs of DifNtMapUserPhysicalPagesWrapper @ 0x14067B810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtMapUserPhysicalPagesWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtMapUserPhysicalPages(a1, a2, a3);
  if ( v8 )
  {
