/*
 * XREFs of DifNtMapUserPhysicalPagesWrapper @ 0x14067F3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtMapUserPhysicalPagesWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(777);
  ...
  LODWORD(v19) = NtMapUserPhysicalPages(VirtualAddress, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
