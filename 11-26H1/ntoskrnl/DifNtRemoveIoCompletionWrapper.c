/*
 * XREFs of DifNtRemoveIoCompletionWrapper @ 0x14068C720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRemoveIoCompletionWrapper(
        void *a1,
        PVOID *a2,
        PVOID *a3,
        ...
        LARGE_INTEGER *Timeout)
{
  ...
  LODWORD(v21) = NtRemoveIoCompletion(a1, a2, a3, a4, Timeout);
  if ( v10 )
  {
