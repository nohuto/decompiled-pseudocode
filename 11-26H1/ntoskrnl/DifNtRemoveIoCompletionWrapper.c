/*
 * XREFs of DifNtRemoveIoCompletionWrapper @ 0x140688B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRemoveIoCompletionWrapper(void *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtRemoveIoCompletion(a1, a5);
  if ( v10 )
  {
