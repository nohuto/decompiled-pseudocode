/*
 * XREFs of DifNtImpersonateClientOfPortWrapper @ 0x14067D730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtImpersonateClientOfPortWrapper(HANDLE PortHandle, PPORT_MESSAGE Message)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(590);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = PortHandle;
    *((_QWORD *)&v15 + 1) = Message;
  ...
  DWORD2(v16) = NtImpersonateClientOfPort(PortHandle, Message);
  if ( v6 )
  {
