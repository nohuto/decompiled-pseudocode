/*
 * XREFs of DifNtImpersonateClientOfPortWrapper @ 0x140679B50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtImpersonateClientOfPortWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtImpersonateClientOfPort(a1, a2);
  if ( v6 )
  {
