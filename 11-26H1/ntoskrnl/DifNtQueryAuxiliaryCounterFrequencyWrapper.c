/*
 * XREFs of DifNtQueryAuxiliaryCounterFrequencyWrapper @ 0x140681210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryAuxiliaryCounterFrequencyWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = NtQueryAuxiliaryCounterFrequency(a1);
  if ( v4 )
  {
