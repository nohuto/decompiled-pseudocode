/*
 * XREFs of DifNtQueryAuxiliaryCounterFrequencyWrapper @ 0x140684DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryAuxiliaryCounterFrequencyWrapper(PLARGE_INTEGER AuxiliaryCounterFrequency)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(718);
  ...
  if ( APIThunkContextById )
  {
    ...
    v6 = 0;
    *((_QWORD *)&v13 + 1) = AuxiliaryCounterFrequency;
  ...
  LODWORD(v14) = NtQueryAuxiliaryCounterFrequency(AuxiliaryCounterFrequency);
  if ( v4 )
  {
