/*
 * XREFs of IopGetBootDiskInformation @ 0x140CBE678
 * Callers:
 *     IoGetBootDiskInformation @ 0x140796420 (IoGetBootDiskInformation.c)
 * Callees:
 ...
 *     IopVerifyDiskSignature @ 0x140795CDC (IopVerifyDiskSignature.c)
