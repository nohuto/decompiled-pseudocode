/*
 * XREFs of DifPoFxSetComponentLatencyWrapper @ 0x140697660
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxSetComponentLatencyWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  PoFxSetComponentLatency(a1, a2, a3);
  if ( v8 )
  {
