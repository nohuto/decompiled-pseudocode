/*
 * XREFs of DifZwOpenPartitionWrapper @ 0x1406B05A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenPartitionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(933);
  ...
  LODWORD(v19) = ZwOpenPartition(PartitionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
