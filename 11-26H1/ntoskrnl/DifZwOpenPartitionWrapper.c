/*
 * XREFs of DifZwOpenPartitionWrapper @ 0x1406AC9C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenPartitionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenPartition(a1, a2, a3);
  if ( v8 )
  {
