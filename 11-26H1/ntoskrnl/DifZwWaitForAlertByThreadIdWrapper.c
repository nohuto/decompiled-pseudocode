/*
 * XREFs of DifZwWaitForAlertByThreadIdWrapper @ 0x1406BF010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWaitForAlertByThreadIdWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwWaitForAlertByThreadId(a1, a2);
  if ( v6 )
  {
