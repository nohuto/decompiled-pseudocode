/*
 * XREFs of DifZwWaitForAlertByThreadIdWrapper @ 0x1406C2BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWaitForAlertByThreadIdWrapper(PVOID Address, PLARGE_INTEGER Timeout)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(924);
  ...
  DWORD2(v16) = ZwWaitForAlertByThreadId(Address, Timeout);
  if ( v6 )
  {
