/*
 * XREFs of sub_140C7F180 @ 0x140C7F180
 * Callers:
...
__int64 __fastcall sub_140C7F180(__int64 a1, __int64 a2)
{
  ...
  for ( i = *(_DWORD *)(a1 + 2520); (i & 0x20000000) == 0; i = *(_DWORD *)(a1 + 2520) )
  {
      ...
      *(_QWORD *)(a1 + 2680) = *((_QWORD *)&v2 + 1);
      while ( v7 != (_QWORD *)v8 )
      {
        *(_QWORD *)&v2 = *((_QWORD *)&v2 + 1) ^ *v7;
        v11 = v6 ^ *v7;
        *v7 = v2;
        *((_QWORD *)&v2 + 1) = (v11 + __ROR8__(*((_QWORD *)&v2 + 1), BYTE8(v2) & 0x3F)) ^ 0xF05;
        ++v7;
      }
    ...
    *((_QWORD *)&v2 + 1) = *(_QWORD *)(a1 + 2680);
    while ( v7 != (_QWORD *)v8 )
    {
      *v7 ^= *((_QWORD *)&v2 + 1);
      *(_QWORD *)&v2 = v6 ^ *v7;
      *((_QWORD *)&v2 + 1) = (v2 + __ROR8__(*((_QWORD *)&v2 + 1), BYTE8(v2) & 0x3F)) ^ 0xF05;
      ++v7;
    }
    *(_DWORD *)(a1 + 2524) &= ~0x200000u;
