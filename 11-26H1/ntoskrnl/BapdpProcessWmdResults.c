/*
 * XREFs of BapdpProcessWmdResults @ 0x140CE91D8
 * Callers:
...
void BapdpProcessWmdResults()
{
  ...
  if ( Pool2 )
  {
    ...
    v5 = v12;
    v6 = 0;
    while ( (int)BapdpQueryData(v0, v11, v3, Pool2, &v13, 0LL) >= 0 )
    {
      if ( v6 )
      {
        v7 = *(__m128i *)(Pool2 + 28);
    ...
    if ( v6 == 1 && (v4 == v3 || (int)BapdpQueryData(v0, v11, v4, Pool2, &v13, 0LL) >= 0) )
