/*
 * XREFs of DifIoBuildAsynchronousFsdRequestWrapper @ 0x140659A30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  v26 = guard_dispatch_icall_no_overrides(a1, a2);
  if ( v12 )
  {
