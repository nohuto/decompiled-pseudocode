/*
 * XREFs of EtwpEnumerateTraceGuids @ 0x14091379C
 * Callers:
...
__int64 __fastcall EtwpEnumerateTraceGuids(__int64 a1, __int64 a2, unsigned int a3, struct _KLOCK_ENTRIES *a4)
{
  unsigned int v4; // ebx
  unsigned int v6; // edi
  ...
  for ( i = a1; ; a1 = i )
  {
    NextGuidEntry = EtwpGetNextGuidEntry(a1, NextGuidEntry, 0, a4);
    v11 = v6;
    if ( !NextGuidEntry )
      break;
    if ( ++v6 > 0x71C71C7 )
