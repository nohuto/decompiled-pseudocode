/*
 * XREFs of DifNtOpenCpuPartitionWrapper @ 0x1406805D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenCpuPartitionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenCpuPartition(a1, a2, a3);
  if ( v8 )
  {
