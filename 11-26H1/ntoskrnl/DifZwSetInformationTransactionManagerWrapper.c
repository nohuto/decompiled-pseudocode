/*
 * XREFs of DifZwSetInformationTransactionManagerWrapper @ 0x1406BE9B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationTransactionManagerWrapper(
        void *a1,
        ...
        ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1104);
  ...
  DWORD2(v20) = ZwSetInformationTransactionManager(a1, a2, a3, a4);
  if ( v9 )
  {
