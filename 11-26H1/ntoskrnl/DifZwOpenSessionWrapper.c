/*
 * XREFs of DifZwOpenSessionWrapper @ 0x1406B1380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenSessionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1067);
  ...
  LODWORD(v19) = ZwOpenSession(SessionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
