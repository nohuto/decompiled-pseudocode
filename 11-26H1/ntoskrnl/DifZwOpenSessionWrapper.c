/*
 * XREFs of DifZwOpenSessionWrapper @ 0x1406AD7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenSessionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenSession(a1, a2, a3);
  if ( v8 )
  {
