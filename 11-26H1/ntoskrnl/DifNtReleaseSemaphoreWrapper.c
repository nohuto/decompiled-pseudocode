/*
 * XREFs of DifNtReleaseSemaphoreWrapper @ 0x140688810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReleaseSemaphoreWrapper(HANDLE Handle, int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtReleaseSemaphore(Handle);
  if ( v8 )
  {
