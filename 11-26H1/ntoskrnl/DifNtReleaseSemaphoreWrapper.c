/*
 * XREFs of DifNtReleaseSemaphoreWrapper @ 0x14068C3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReleaseSemaphoreWrapper(HANDLE SemaphoreHandle, LONG ReleaseCount, PLONG PreviousCount)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(695);
  ...
  LODWORD(v19) = NtReleaseSemaphore(SemaphoreHandle, ReleaseCount, PreviousCount);
  if ( v8 )
  {
