/*
 * XREFs of DifNtAllocateLocallyUniqueIdWrapper @ 0x14066B0C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAllocateLocallyUniqueIdWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = NtAllocateLocallyUniqueId(a1);
  if ( v4 )
  {
