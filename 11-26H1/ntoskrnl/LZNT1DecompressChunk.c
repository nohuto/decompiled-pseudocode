/*
 * XREFs of LZNT1DecompressChunk @ 0x140731700
 * Callers:
              ...
              while ( 1 )
              {
                while ( 1 )
                {
                  ...
                  while ( (unsigned __int64)v5 > v10 )
                  {
                    ...
                    v10 = (unsigned __int64)&a1[*((unsigned int *)qword_140023800 + v11)];
                  }
                  v13 = a3 + 1;
                  v14 = *(_WORD *)(a3 + 1);
                  v15 = v14;
                  v17 = dword_140023844[v11] & v14;
