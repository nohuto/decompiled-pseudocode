/*
 * XREFs of PopEsEvaluateNextStateV2 @ 0x140B7216C
 * Callers:
...
__int64 __fastcall PopEsEvaluateNextStateV2(__int64 a1, unsigned __int64 a2)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  if ( *(_BYTE *)a1 || v5 > dword_140F10710 )
  {
    v10 = 0;
    if ( *(_BYTE *)a1 )
    {
...
LABEL_13:
  ...
  if ( v15 == 2 && dword_140F10710 && *(_BYTE *)(a1 + 1) && *(_DWORD *)(a1 + 8) && v10 )
  {
    *v3 = 2;
    return v13;
  }
LABEL_27:
  if ( byte_140F10714 && dword_140F10710 && PopEsBgActivityPolicy == 1 )
  {
    v2 = 240;
    *v3 = 8;
  }
  else if ( LOBYTE(PopModernStandbyStateNotify.SchedulerSharedSystemSlot) )
  {
    *v3 = 16;
    return v13;
  }
