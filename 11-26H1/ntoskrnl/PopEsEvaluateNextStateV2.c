/*
 * XREFs of PopEsEvaluateNextStateV2 @ 0x140B77164
 * Callers:
...
__int64 __fastcall PopEsEvaluateNextStateV2(__int64 a1, unsigned __int64 a2)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  if ( *(_BYTE *)a1 || v5 > LODWORD(PpmIdlePolicyLock.GlobalForegroundListEntry.Flink) )
  {
    v8 = 0;
    if ( *(_BYTE *)a1 )
    {
...
LABEL_10:
  ...
  if ( v13 == 2
    && LODWORD(PpmIdlePolicyLock.GlobalForegroundListEntry.Flink)
    && *(_BYTE *)(a1 + 1)
    && *(_DWORD *)(a1 + 8)
    && v8 )
  {
