/*
 * XREFs of DifZwGetDevicePowerStateWrapper @ 0x1406A77E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetDevicePowerStateWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwGetDevicePowerState(a1, a2);
  if ( v6 )
  {
