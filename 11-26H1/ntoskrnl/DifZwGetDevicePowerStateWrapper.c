/*
 * XREFs of DifZwGetDevicePowerStateWrapper @ 0x1406AB3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetDevicePowerStateWrapper(HANDLE Device, PDEVICE_POWER_STATE State)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(992);
  ...
  DWORD2(v16) = ZwGetDevicePowerState(Device, State);
  if ( v6 )
  {
