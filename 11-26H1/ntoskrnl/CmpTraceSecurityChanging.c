/*
 * XREFs of CmpTraceSecurityChanging @ 0x1408BFC0C
 * Callers:
...
__int64 __fastcall CmpTraceSecurityChanging(__int64 a1, __int64 a2, int a3, __int64 a4, __int64 a5)
{
  ...
  if ( v8 >= 0 )
  {
    if ( RtlFindUnicodeSubstring(v17[0], (__int64)&KiSystemServiceTraceCallbackLock.QueuedScb) )
    {
      ...
      if ( (unsigned int)dword_140E09EE8 > 5 && tlgKeywordOn((__int64)&dword_140E09EE8, 2LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&word_14005668E,
          0LL,
          0LL,
          0xBu,
          &v18);
