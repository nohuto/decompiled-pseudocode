/*
 * XREFs of sub_140838310 @ 0x140838310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140838310(__int64 a1, _DWORD *a2, _DWORD *a3, struct _KLOCK_ENTRIES *a4, _DWORD *a5, _BYTE *a6)
{
...
LABEL_19:
  ...
  if ( v41 )
  {
    v30 = a5;
    *a6 = 1;
    return (unsigned int)sub_14083803C(v8, a3, v6, v30, 0);
  }
  else
  {
    v29 = -1073741772;
