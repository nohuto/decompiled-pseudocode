/*
 * XREFs of MiIsExtentDangling @ 0x1406FA730
 * Callers:
 *     FsRtlIsExtentDangling @ 0x14078FF00 (FsRtlIsExtentDangling.c)
...
ULONG_PTR __fastcall MiIsExtentDangling(ULONG_PTR a1, __int64 a2, int a3)
{
  ULONG_PTR v3; // rbp
  ...
  while ( v7 < v3 )
  {
    if ( v7 <= qword_140E2D7A0 && ((*v8 >> 54) & 1) != 0 && (*(_QWORD *)(v6 + 40) & 0x20000000000000LL) != 0 )
    {
      if ( a3 )
        goto LABEL_17;
      v10 = MiSafeLockPage(v7, a2);
      v11 = v10;
      if ( v10 != 17 )
      {
...
LABEL_19:
  ...
  if ( (a3 & 2) == 0 )
  {
    ...
    p_WaitType = &stru_140E2D150.WaitBlock[3].WaitType;
    do
    {
