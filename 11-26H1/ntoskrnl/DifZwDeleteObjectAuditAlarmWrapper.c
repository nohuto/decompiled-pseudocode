/*
 * XREFs of DifZwDeleteObjectAuditAlarmWrapper @ 0x1406A7DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteObjectAuditAlarmWrapper(
        ...
        BOOLEAN GenerateOnClose)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(887);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = SubsystemName;
    *(_QWORD *)&v18 = HandleId;
    BYTE8(v17) = GenerateOnClose;
  ...
  LODWORD(v19) = ZwDeleteObjectAuditAlarm(SubsystemName, HandleId, GenerateOnClose);
  if ( v8 )
  {
