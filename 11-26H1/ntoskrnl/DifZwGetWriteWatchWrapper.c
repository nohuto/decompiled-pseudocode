/*
 * XREFs of DifZwGetWriteWatchWrapper @ 0x1406ABD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetWriteWatchWrapper(
        void *a1,
        ULONG a2,
        void *a3,
        SIZE_T a4,
        ...
        ULONG *Granularity)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1084);
...
LABEL_17:
  v24 = ZwGetWriteWatch(a1, a2, a3, a4, UserAddressArray, EntriesInUserAddressArray, Granularity);
  if ( v12 )
  {
