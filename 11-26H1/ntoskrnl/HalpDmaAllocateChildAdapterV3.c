/*
 * XREFs of HalpDmaAllocateChildAdapterV3 @ 0x14078041C
 * Callers:
 ...
 *     HalpDmaIsThinDmaCapable @ 0x14058B358 (HalpDmaIsThinDmaCapable.c)
 *     HalpDmaIsThinDmarCapable @ 0x14058B74C (HalpDmaIsThinDmarCapable.c)
