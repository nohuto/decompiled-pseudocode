/*
 * XREFs of __asan_load16 @ 0x1405E0970
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_load16(ULONG_PTR BugCheckParameter1)
{
  char v2; // cl
  signed __int8 v3; // al
  char v4; // dl
...
LABEL_26:
  v6 = *(_BYTE *)(((BugCheckParameter1 + 0x800000000008LL) >> 3) + KasaniShadow);
  v3 = v6;
  ...
  if ( v6 && v6 < 8 )
    goto LABEL_55;
  v7 = *(_BYTE *)(((BugCheckParameter1 + 0x80000000000CLL) >> 3) + KasaniShadow);
  v3 = v7;
  if ( (((_BYTE)BugCheckParameter1 + 12) & 7u) <= 4 )
  {
    if ( !v7 || v7 >= 8 )
      goto LABEL_39;
    v9 = (char)(((BugCheckParameter1 + 15) & 7) + 1) <= v7;
    goto LABEL_38;
  }
  if ( v7 && v7 < 8 )
    goto LABEL_55;
  v8 = *(_BYTE *)(((BugCheckParameter1 + 0x80000000000ELL) >> 3) + KasaniShadow);
  v3 = v8;
  if ( (((_BYTE)BugCheckParameter1 + 14) & 7) != 7 )
  {
    if ( !v8 || v8 >= 8 )
      goto LABEL_39;
    v9 = (char)(((BugCheckParameter1 + 15) & 7) + 1) <= v8;
    goto LABEL_38;
  }
  if ( v8 && v8 < 8 )
LABEL_55:
    KasaniReport(BugCheckParameter1, 0x10uLL, 0, retaddr, v3);
  v3 = *(_BYTE *)(((BugCheckParameter1 + 0x80000000000FLL) >> 3) + KasaniShadow);
  if ( !v3 || v3 >= 8 )
    goto LABEL_39;
  v9 = (char)(((BugCheckParameter1 + 15) & 7) + 1) <= v3;
LABEL_38:
  if ( !v9 )
    goto LABEL_55;
LABEL_39:
  if ( v3 == 9 && KeGetCurrentIrql() >= 2u )
    KasaniReport(BugCheckParameter1, 0x10uLL, 0, retaddr, 9u);
  if ( KcsaniValidationEnabled )
    KcsanValidateAddress(BugCheckParameter1, 16, 0, 0, retaddr);
}
