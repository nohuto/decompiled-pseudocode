/*
 * XREFs of DifNtOpenEventPairWrapper @ 0x140680A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenEventPairWrapper(HANDLE EventPairHandle, int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(685);
