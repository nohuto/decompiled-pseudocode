/*
 * XREFs of DifZwLoadKey2Wrapper @ 0x1406ACA10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwLoadKey2Wrapper(POBJECT_ATTRIBUTES TargetKey, POBJECT_ATTRIBUTES SourceFile, ULONG Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1088);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = TargetKey;
    *(_QWORD *)&v18 = SourceFile;
    DWORD2(v17) = Flags;
  ...
  LODWORD(v19) = ZwLoadKey2(TargetKey, SourceFile, Flags);
  if ( v8 )
  {
