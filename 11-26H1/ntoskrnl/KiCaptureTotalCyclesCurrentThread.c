/*
 * XREFs of KiCaptureTotalCyclesCurrentThread @ 0x140225340
 * Callers:
  ...
  if ( *(_BYTE *)(a1 + 34524) )
  {
    ...
    if ( KiTickAccumulationFromAccountingPeriods )
    {
      ...
      if ( MEMORY[0xFFFFF78000000300] )
      {
        ...
        v23 = ((unsigned __int64)((a4 * (unsigned __int128)*(unsigned __int64 *)&stru_140FC01F0.SavedApcStateFill[40]) >> 64) >> KiMaximumIncrementShiftCount)
  ...
  if ( (v29 & 0xBE) != 0 )
  {
    ...
    if ( (v29 & 0x20) != 0 )
    {
      ...
      if ( v34 )
      {
        ...
        v41 = *(&KsepShimDbLock.ReservedPreviousReadyTimeValue + 1);
        *v40 += v9;
        v42 = *(_DWORD *)(v34 + 192);
        if ( v41 > v42 )
        {
          ...
          if ( v41 - v42 >= 0x20 )
            ...
            HIDWORD(v86) = (*(_DWORD *)(v34 + 196) << (v41 - v42)) | 1;
          *(_QWORD *)(v34 + 192) = v86;
        }
        else
        {
