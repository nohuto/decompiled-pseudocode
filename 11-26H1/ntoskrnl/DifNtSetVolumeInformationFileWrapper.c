/*
 * XREFs of DifNtSetVolumeInformationFileWrapper @ 0x1406925E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetVolumeInformationFileWrapper(
        void *a1,
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(623);
  ...
  DWORD2(v21) = NtSetVolumeInformationFile(a1, a2, a3, a4, FsInformationClass);
  if ( v10 )
  {
