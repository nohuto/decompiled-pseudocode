/*
 * XREFs of DifNtFreeUserPhysicalPagesWrapper @ 0x14067BEF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFreeUserPhysicalPagesWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  LODWORD(v19) = NtFreeUserPhysicalPages(ProcessHandle, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
