/*
 * XREFs of DifNtFreeUserPhysicalPagesWrapper @ 0x140678310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFreeUserPhysicalPagesWrapper(HANDLE Handle, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(781);
  ...
  LODWORD(v19) = NtFreeUserPhysicalPages(Handle);
  if ( v8 )
  {
