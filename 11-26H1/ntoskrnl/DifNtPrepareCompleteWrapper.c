/*
 * XREFs of DifNtPrepareCompleteWrapper @ 0x140683E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPrepareCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(840);
  ...
  DWORD2(v16) = NtPrepareComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
