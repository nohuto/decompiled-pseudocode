/*
 * XREFs of DifNtSetInformationDebugObjectWrapper @ 0x14068F360
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationDebugObjectWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = NtSetInformationDebugObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
