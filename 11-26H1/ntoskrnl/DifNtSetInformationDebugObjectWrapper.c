/*
 * XREFs of DifNtSetInformationDebugObjectWrapper @ 0x14068B780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationDebugObjectWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(862);
  ...
  LODWORD(v21) = NtSetInformationDebugObject(a1, a5);
  if ( v10 )
  {
