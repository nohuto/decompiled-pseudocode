/*
 * XREFs of IopInitializeBootLogging @ 0x1407977F0
 * Callers:
...
void __fastcall IopInitializeBootLogging(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(&SourceString.MaximumLength + 1) = 0;
  if ( !qword_140FD6028 )
  {
    ...
    qword_140FD6028 = (PUNICODE_STRING)Pool2;
    if ( Pool2 )
    {
      ...
      if ( RtlFindMessage(*(PVOID *)(v5 + 48), 0xBu, 0, 0xB5u, &MessageEntry) >= 0 )
      {
        ...
        RtlAnsiStringToUnicodeString(qword_140FD6028, &SourceString, 1u);
        v8 = qword_140FD6028;
        if ( qword_140FD6028->Length > 4u )
        {
          v9 = qword_140FD6028->Length - 4;
          qword_140FD6028->Length = v9;
      ...
      else
      {
        ...
        RtlAnsiStringToUnicodeString(qword_140FD6028 + 1, &SourceString, 1u);
        v10 = qword_140FD6028;
        Length = qword_140FD6028[1].Length;
        if ( Length > 4u )
        {
          v12 = Length - 4;
          qword_140FD6028[1].Length = v12;
