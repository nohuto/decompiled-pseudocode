/*
 * XREFs of DifZwOpenCpuPartitionWrapper @ 0x1406AEDD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenCpuPartitionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(938);
  ...
  LODWORD(v19) = ZwOpenCpuPartition(a1, a2, a3);
  if ( v8 )
  {
