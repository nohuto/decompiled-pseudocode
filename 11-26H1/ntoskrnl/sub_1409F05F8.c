/*
 * XREFs of sub_1409F05F8 @ 0x1409F05F8
 * Callers:
...
__int64 __fastcall sub_1409F05F8(__int64 *a1, int a2, _DWORD *a3)
{
  void *v6; // r14
  int v7; // ebx
  __int64 v8; // rdx
  ...
  char *v13; // rbx
  _BYTE v15[3]; // [rsp+41h] [rbp-117h] BYREF
  int v16; // [rsp+44h] [rbp-114h]
  char *v17; // [rsp+48h] [rbp-110h] BYREF
  PMDL Mdl; // [rsp+58h] [rbp-100h] BYREF
  int v19; // [rsp+60h] [rbp-F8h]
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v9 >= 0 )
      {
              ...
              v7 >= 0) )
        {
          ...
          v30 = *(_OWORD *)(v10 + 224);
          v13 = v17;
          sub_14042E230((__int64)&v20, (char *)v6, v17, v12, *(_QWORD *)(v10 + 72), v11, v15);
          v16 = 0;
          if ( !a2
            || (v7 = sub_1404A2E0C(
                       a1[5],
