/*
 * XREFs of DifNtSetInformationIoRingWrapper @ 0x14068F850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationIoRingWrapper(void *a1, ULONG a2, ULONG a3, void *a4)
{
  ...
  LODWORD(v19) = NtSetInformationIoRing(a1, a2, a3, a4);
  if ( v9 )
  {
