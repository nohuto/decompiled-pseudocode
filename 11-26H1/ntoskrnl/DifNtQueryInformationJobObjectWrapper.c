/*
 * XREFs of DifNtQueryInformationJobObjectWrapper @ 0x140686990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationJobObjectWrapper(
        void *a1,
        JOBOBJECTINFOCLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(561);
  ...
  LODWORD(v21) = NtQueryInformationJobObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
