/*
 * XREFs of HvpMappedViewConvertRegionFromLockedToCOWByPolicy @ 0x1408B5B6C
 * Callers:
...
__int64 __fastcall HvpMappedViewConvertRegionFromLockedToCOWByPolicy(ULONG_PTR a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    v11 = CmSiProtectViewOfSection(v13, *(void ***)(a1 + 24), v6, v5, 2u, (ULONG *)&v16);
    HvpViewMapReleaseChargesAndUnlockViewPages(v14, *(_QWORD *)(a1 + 24), v6, v5);
    while ( v8 < a4 )
    {
