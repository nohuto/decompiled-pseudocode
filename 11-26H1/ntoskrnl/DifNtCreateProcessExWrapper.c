/*
 * XREFs of DifNtCreateProcessExWrapper @ 0x140676510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateProcessExWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
...
LABEL_17:
  Process = NtCreateProcessEx(a1, a2, a3, a4, Flags, SectionHandle, DebugPort, TokenHandle, Reserved);
  if ( v14 )
  {
