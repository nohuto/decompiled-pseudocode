/*
 * XREFs of SepLinkLogonSessions @ 0x1404DA5DC
 * Callers:
...
LABEL_23:
  ...
  *(_QWORD *)&v17 = 0LL;
  ...
  if ( v9 < 0 )
    goto LABEL_17;
  *(_QWORD *)(*((_QWORD *)v19 + 27) + 56LL) = v19;
  *(_QWORD *)(*((_QWORD *)v19 + 27) + 16LL) = *(_QWORD *)(*((_QWORD *)v13 + 27) + 8LL);
  *(_DWORD *)(*((_QWORD *)v19 + 27) + 40LL) |= 2u;
  *(_QWORD *)(*((_QWORD *)v13 + 27) + 56LL) = v13;
  *(_QWORD *)(*((_QWORD *)v13 + 27) + 16LL) = *(_QWORD *)(*((_QWORD *)v19 + 27) + 8LL);
  *(_DWORD *)(*((_QWORD *)v13 + 27) + 40LL) |= 4u;
