/*
 * XREFs of DifZwQueryDefaultUILanguageWrapper @ 0x1406B3B60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryDefaultUILanguageWrapper(LANGID *DefaultUILanguageId)
{
  ...
  LODWORD(v14) = ZwQueryDefaultUILanguage(DefaultUILanguageId);
  if ( v4 )
  {
