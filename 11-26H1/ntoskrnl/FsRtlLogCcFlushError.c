...
LABEL_29:
  ...
  v11 = -2147221363;
LABEL_31:
  __incgsdword(0x897Cu);
  if ( (Flags & 1) == 0 )
    IoRaiseInformationalHardError(v10, FileName, 0LL);
  if ( (Flags & 2) == 0 )
  {
    if ( (unsigned __int64)((unsigned int)FileName->Length + 48) + 2 > 0xF0 )
      v13 = -16;
    else
    ...
    if ( ErrorLogEntry )
    {
      ...
      *((_WORD *)ErrorLogEntry + 3) = 48;
      ...
      {
        v21 = 2 * (v20 >> 2) - 4;
        memmove(v17, Buffer, (unsigned int)v21);
        *(_QWORD *)&v16[v21] = 0x20002E002E0020LL;
        v22 = v20 - (unsigned int)v21 - 8;
        v23 = &v16[v21 + 8];
        memmove(
          v23,
          (char *)FileName->Buffer + FileName->Length - (unsigned __int64)(unsigned int)v22,
          (unsigned int)v22);
        v24 = &v23[v22];
      }
      *(_WORD *)v24 = 0;
