/*
 * XREFs of HvAnalyzeLogFiles @ 0x140ADF748
 * Callers:
 ...
 *     HvpDetermineResultingLoggingState @ 0x140ADFEE8 (HvpDetermineResultingLoggingState.c)
    ...
    if ( (unsigned int)dword_140E09EE8 > 5 )
    {
      ...
      if ( (qword_140E09EF8 & 8) != 0 && (qword_140E09F00 & 8) == qword_140E09F00 )
      {
        ...
        *((_QWORD *)&v51 + 1) = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)word_1400572FA,
          0LL,
          0LL,
          3u,
          &v49);
      ...
      if ( v21 > 5 && (v22 & 0x400000000008LL) != 0 && (v23 & 0x400000000008LL) == v23 )
      {
        ...
        *(_QWORD *)&v52 = &v47;
        v47 = 0x1000000LL;
        *((_QWORD *)&v52 + 1) = 8LL;
        tlgWriteAgg((__int64)&dword_140E09EE8, (unsigned __int8 *)&qword_1400572B0, v22, 4u, &v49);
      }
    }
    return 3221225804LL;
  }
...
LABEL_10:
  ...
  if ( !v27 )
  {
    if ( (unsigned int)dword_140E09EE8 > 5 && tlgKeywordOn((__int64)&dword_140E09EE8, 0x400000000008LL) )
    {
      ...
      *(_QWORD *)&v51 = &v44;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140E09EE8,
        (unsigned __int8 *)byte_14005738B,
        0LL,
        0LL,
        3u,
        &v49);
  ...
  if ( (unsigned int)dword_140E09EE8 > 5 && (qword_140E09EF8 & 8) != 0 && (qword_140E09F00 & 8) == qword_140E09F00 )
  {
    ...
    v64 = 4LL;
    v66 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09EE8, (unsigned __int8 *)&word_14005732E, 0LL, 0LL, 7u, &v56);
  }
  LOBYTE(v8) = a3;
