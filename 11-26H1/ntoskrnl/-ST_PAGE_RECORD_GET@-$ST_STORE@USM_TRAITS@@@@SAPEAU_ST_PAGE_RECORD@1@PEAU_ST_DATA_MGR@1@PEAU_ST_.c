/*
 * XREFs of ?ST_PAGE_RECORD_GET@?$ST_STORE@USM_TRAITS@@@@SAPEAU_ST_PAGE_RECORD@1@PEAU_ST_DATA_MGR@1@PEAU_ST_PAGE_ENTRY@1@@Z @ 0x14047B6F0
 * Callers:
...
_DWORD *__fastcall ST_STORE<SM_TRAITS>::ST_PAGE_RECORD_GET(_DWORD *a1, __int64 a2)
{
  ...
  for ( i = v6 * (*(_DWORD *)(a2 + 4) & v5)
        ...
        ;
        i = v6 * (v5 & v12[2]) + *(_QWORD *)(*(_QWORD *)&a1[2 * v11 + 48] + 16 * (v10 ^ (unsigned int)(1 << v11))) )
  {
    v12 = (_DWORD *)(v7 + i);
    if ( *v12 != -1 )
      break;
    v10 = (unsigned int)(v12[2] >> v3);
