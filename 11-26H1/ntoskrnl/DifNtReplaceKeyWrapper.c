/*
 * XREFs of DifNtReplaceKeyWrapper @ 0x14068CBC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplaceKeyWrapper(POBJECT_ATTRIBUTES NewFile, HANDLE TargetHandle, POBJECT_ATTRIBUTES OldFile)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(804);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = NewFile;
    *(_QWORD *)&v18 = TargetHandle;
    *((_QWORD *)&v17 + 1) = OldFile;
  ...
  LODWORD(v19) = NtReplaceKey(NewFile, TargetHandle, OldFile);
  if ( v8 )
  {
