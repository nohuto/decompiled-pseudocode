/*
 * XREFs of DifZwPowerInformationWrapper @ 0x1406B21A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPowerInformationWrapper(
        ...
        ULONG OutputBufferLength)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(67);
  ...
  HIDWORD(v21) = ZwPowerInformation(a1, a2, a3, a4, OutputBufferLength);
  if ( v10 )
  {
