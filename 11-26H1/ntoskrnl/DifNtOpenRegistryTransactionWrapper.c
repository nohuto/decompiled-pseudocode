/*
 * XREFs of DifNtOpenRegistryTransactionWrapper @ 0x140682550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenRegistryTransactionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(816);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = RegistryTransactionHandle;
    LODWORD(v18) = DesiredAccess;
    *((_QWORD *)&v17 + 1) = ObjAttributes;
  ...
  LODWORD(v19) = NtOpenRegistryTransaction(RegistryTransactionHandle, DesiredAccess, ObjAttributes);
  if ( v8 )
  {
