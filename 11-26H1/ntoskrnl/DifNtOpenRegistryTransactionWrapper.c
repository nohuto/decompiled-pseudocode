/*
 * XREFs of DifNtOpenRegistryTransactionWrapper @ 0x14067E970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenRegistryTransactionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenRegistryTransaction(a1, a2, a3);
  if ( v8 )
  {
