/*
 * XREFs of DifZwSetInformationVirtualMemoryWrapper @ 0x1406BECD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationVirtualMemoryWrapper(
        void *a1,
        ...
        ULONG VmInformationLength)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1136);
...
LABEL_17:
  v27 = ZwSetInformationVirtualMemory(a1, a2, a3, a4, VmInformation, VmInformationLength);
  if ( v11 )
  {
