/*
 * XREFs of PiDevCfgLogDeviceConfigured @ 0x140AD1378
 * Callers:
...
void __fastcall PiDevCfgLogDeviceConfigured(__int64 a1, __int64 a2, __int64 a3, int a4, int a5, __int64 a6, __int64 a7)
{
  ...
  __int64 v127; // [rsp+98h] [rbp-C8h]
  __int64 v128; // [rsp+C8h] [rbp-98h]
  ...
  UNICODE_STRING v142; // [rsp+138h] [rbp-28h] BYREF
  ...
  UNICODE_STRING UnicodeString; // [rsp+190h] [rbp+30h] BYREF
  ...
  UNICODE_STRING v153; // [rsp+1D0h] [rbp+70h] BYREF
  TIME_FIELDS v154; // [rsp+1E0h] [rbp+80h]
  __int64 v155; // [rsp+1F0h] [rbp+90h]
  UNICODE_STRING v156; // [rsp+1F8h] [rbp+98h] BYREF
  UNICODE_STRING v157; // [rsp+208h] [rbp+A8h] BYREF
  __int128 v158; // [rsp+218h] [rbp+B8h] BYREF
  ...
  UNICODE_STRING *v166; // [rsp+268h] [rbp+108h]
  ...
  UNICODE_STRING *p_UnicodeString; // [rsp+290h] [rbp+130h]
...
LABEL_204:
  ...
  if ( v142.Buffer )
  {
    ...
    {
      v17 = 0;
      if ( (unsigned __int64)v142.Length >> 1 != 2 )
      {
        v18 = 0LL;
        do
        {
      ...
      v142.Length = Length - 2;
      goto LABEL_19;
    }
    ExFreePool(v142.Buffer);
    v142 = 0LL;
  }
  RtlInitUnicodeString(&v142, 0LL);
LABEL_19:
...
LABEL_203:
  ...
  if ( v80 != (__int64 *)(a3 + 208) )
  {
    ...
    do
    {
      ...
      if ( !*((_DWORD *)v80 + 105) )
        v82 = v81;
      PiDevCfgLogDeviceConfigured(v150, v139, (_DWORD)v80, v82, a5, v76, v155);
      memset_0(&v159, 0, 0xA0uLL);
      v83 = v80[2];
      v159 = (__int64 *)&DEVPKEY_DriverPackage_OriginalInfName;
      p_DestinationString = &v156;
      v164 = DEVPKEY_DriverPackage_ExtensionId;
      v166 = (UNICODE_STRING *)&v158;
      v162 = 6;
      ...
      if ( (int)PiDevCfgQueryObjectProperties(18, v84, 8, v83, (__int64)&v159, 4) >= 0 )
      {
        ...
        if ( v169 < 0 || (int)RtlStringFromGUIDEx((unsigned int *)&v158, (__int64)&v153, 1) < 0 )
          RtlInitUnicodeString(&v153, 0LL);
        if ( v174 < 0 )
          RtlInitUnicodeString(&UnicodeString, 0LL);
        if ( UnicodeString.Buffer && (v85 = UnicodeString.Length, UnicodeString.Length > 4u) )
        {
          v86 = 0;
          if ( (unsigned __int64)UnicodeString.Length >> 1 != 2 )
          {
            ...
            do
            {
              if ( !UnicodeString.Buffer[v87] )
              {
                UnicodeString.Buffer[v87] = 59;
                v85 = UnicodeString.Length;
              }
              v87 = ++v86;
            }
