/*
 * XREFs of DifKeSetTimer2Wrapper @ 0x1406680A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeSetTimer2Wrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(474);
  ...
  BYTE8(v20) = KeSetTimer2(a1, a2, a3, a4);
  if ( v9 )
  {
