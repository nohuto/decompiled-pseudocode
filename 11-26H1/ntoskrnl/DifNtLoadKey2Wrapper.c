/*
 * XREFs of DifNtLoadKey2Wrapper @ 0x14067E210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLoadKey2Wrapper(POBJECT_ATTRIBUTES TargetKey, POBJECT_ATTRIBUTES SourceFile, ULONG Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(794);
  ...
  LODWORD(v19) = NtLoadKey2(TargetKey, SourceFile, Flags);
  if ( v8 )
  {
