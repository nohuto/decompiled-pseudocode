/*
 * XREFs of DifNtLoadKey2Wrapper @ 0x14067A630
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NtLoadKey2 @ 0x140B388F0 (NtLoadKey2.c)
 */

__int64 __fastcall DifNtLoadKey2Wrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = NtLoadKey2(a1, a2, a3);
  if ( v8 )
  {
