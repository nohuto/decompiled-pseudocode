/*
 * XREFs of compress_block @ 0x14063955C
 * Callers:
...
__int64 __fastcall compress_block(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a1 + 5956) )
  {
    do
    {
      ...
      if ( v14 )
      {
        v22 = *((unsigned __int8 *)length_code + v13);
        ...
        *(_WORD *)(a1 + 5980) = v29;
        *v4 = v28;
        v30 = dword_140038420[v22];
        v58 = (_QWORD *)(a1 + 16);
        v57 = v15;
        if ( v30 )
        {
          v31 = v13 - word_1400383A0[2 * v22];
          v29 |= v31 << v28;
          *(_WORD *)(a1 + 5980) = v29;
          if ( v28 > 16 - v30 )
          {
        ...
        if ( v33 >= 0x100 )
          ...
          v34 = v33;
        v35 = *((unsigned __int8 *)dist_code + v34);
        v36 = v28;
        ...
        *(_WORD *)(a1 + 5980) = v45;
        *v4 = v44;
        v46 = dword_140037EA0[v35];
        if ( v46 )
        {
          v47 = v33 - word_1400384A0[2 * v35];
