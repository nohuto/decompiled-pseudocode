/*
 * XREFs of DifNtAlpcAcceptConnectPortWrapper @ 0x14066BBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcAcceptConnectPortWrapper(
        __int64 a1,
        __int64 a2,
        int a3,
        __int64 a4,
        ...
        char a9)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(597);
...
LABEL_17:
  v33 = NtAlpcAcceptConnectPort(a1, a2, a3, a4, a5, a6, a7, a8, a9);
  if ( v14 )
  {
