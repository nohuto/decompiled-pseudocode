/*
 * XREFs of DifExDeleteTimerWrapper @ 0x140654A90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExDeleteTimerWrapper(__int64 a1, char a2, char a3, unsigned int *a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(477);
  ...
  LOBYTE(v19) = ExDeleteTimer(a1, a2, a3, a4);
  if ( v9 )
  {
