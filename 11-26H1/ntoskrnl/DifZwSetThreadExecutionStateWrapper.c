/*
 * XREFs of DifZwSetThreadExecutionStateWrapper @ 0x1406BFC80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetThreadExecutionStateWrapper(EXECUTION_STATE NewFlags, EXECUTION_STATE *PreviousFlags)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(991);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    LODWORD(v16) = NewFlags;
    *((_QWORD *)&v15 + 1) = PreviousFlags;
  ...
  HIDWORD(v16) = ZwSetThreadExecutionState(NewFlags, PreviousFlags);
  if ( v6 )
  {
