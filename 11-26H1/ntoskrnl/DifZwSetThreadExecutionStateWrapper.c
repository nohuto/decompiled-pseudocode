/*
 * XREFs of DifZwSetThreadExecutionStateWrapper @ 0x1406BC0A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetThreadExecutionStateWrapper(unsigned int a1, __int64 a2)
{
  ...
  HIDWORD(v16) = ZwSetThreadExecutionState(a1, a2);
  if ( v6 )
  {
