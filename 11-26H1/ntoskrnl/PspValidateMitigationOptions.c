/*
 * XREFs of PspValidateMitigationOptions @ 0x140A78928
 * Callers:
...
__int64 __fastcall PspValidateMitigationOptions(__m128i *a1, char a2)
{
  ...
  while ( v8 < 0x28 )
  {
    ...
    v15 = v10;
    if ( !a2
      && (((unsigned __int64)v14.m128i_i64[(unsigned __int64)(4 * v8) >> 6] >> (4 * (unsigned __int8)v8)) & 4) != 0 )
    {
      return 3221225485LL;
    }
    ...
    else if ( (((unsigned __int64)v14.m128i_i64[(unsigned __int64)(4 * v8) >> 6] >> (4 * (unsigned __int8)v8)) & 0xF) == 3 )
    {
      return 3221225485LL;
    }
    ++v8;
  ...
  while ( v7 < 0x30 )
  {
    ...
    v14 = *a1;
    v15 = v11;
    if ( (((unsigned __int64)v14.m128i_i64[(unsigned __int64)(4 * v7) >> 6] >> (4 * (unsigned __int8)v7)) & 0xF) != 0 )
      return 3221225485LL;
    ++v7;
  }
