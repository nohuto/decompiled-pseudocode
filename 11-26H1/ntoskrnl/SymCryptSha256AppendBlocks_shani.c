/*
 * XREFs of SymCryptSha256AppendBlocks_shani @ 0x140555AFC
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      _XMM3 = _mm_shuffle_epi8(_mm_loadu_si128(a2 + 2), (__m128i)_xmm);
      _XMM8 = v9;
      __asm { sha256rnds2 xmm8, xmm10, xmm0 }
      _XMM4 = _mm_shuffle_epi8(_mm_loadu_si128(a2 + 3), (__m128i)_xmm);
      ...
      v32 = _mm_alignr_epi8(_XMM5, _XMM4, 4);
      __asm { sha256msg1 xmm4, xmm5 }
      _XMM1 = _mm_add_epi32(v32, _XMM2);
  ...
  v86 = _mm_shuffle_epi32(_XMM10, 27);
  v87 = _mm_shuffle_epi32(v9, 27);
  *a1 = _mm_unpacklo_epi64(v86, v87);
  a1[1] = _mm_unpackhi_epi64(v86, v87);
  *a4 = a3;
  return result;
}
