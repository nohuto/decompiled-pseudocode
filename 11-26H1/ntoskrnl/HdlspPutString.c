/*
 * XREFs of HdlspPutString @ 0x140C4D304
 * Callers:
 ...
 * Callees:
 *     HdlspUTF8Encode @ 0x1406CB820 (HdlspUTF8Encode.c)
...
LABEL_42:
    ...
    if ( (v5 & 0x80u) == 0 )
      goto LABEL_40;
    if ( (unsigned __int8)v5 > 0xC4u )
    {
      if ( (unsigned __int8)v5 > 0xDBu )
      {
        if ( v5 != 220 && v5 != 221 && (unsigned int)(v5 - 222) >= 2 )
          goto LABEL_34;
        goto LABEL_39;
      }
      if ( (_BYTE)v5 == 0xDB )
