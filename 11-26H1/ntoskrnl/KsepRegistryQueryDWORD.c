/*
 * XREFs of KsepRegistryQueryDWORD @ 0x1407BF038
 * Callers:
...
NTSTATUS __fastcall KsepRegistryQueryDWORD(HANDLE KeyHandle, PCWSTR SourceString, _DWORD *a3)
{
  ...
  if ( !KeyHandle )
  {
    ...
    *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v6) = 262788;
  ...
  if ( !a3 )
  {
    ...
    *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v7) = 262789;
    if ( ((__int64)stru_140E66B30.StackBase & 4) != 0 )
