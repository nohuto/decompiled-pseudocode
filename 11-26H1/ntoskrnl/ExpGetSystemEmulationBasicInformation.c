/*
 * XREFs of ExpGetSystemEmulationBasicInformation @ 0x1404BCD14
 * Callers:
...
__int64 __fastcall ExpGetSystemEmulationBasicInformation(void *a1, char a2)
{
  ...
  if ( (unsigned __int16)AffinityPrimaryGroup >= *(_WORD *)&stru_140FC01F0.WaitRegister.Flags )
    ...
    v7 = *(unsigned __int64 *)((char *)&stru_140FC01F0.116 + 8 * AffinityPrimaryGroup + 4);
  ...
  if ( *(_QWORD *)(*(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * Blink_high) + 22288LL) <= 0xFFFFFFFFuLL )
    v9 = *(_QWORD *)(*(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * Blink_high) + 22288LL);
  Src[3] = v9;
  v10 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * Blink_high) + 22272LL) <= 0xFFFFFFFFuLL )
    v10 = *(_QWORD *)(*(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * Blink_high) + 22272LL);
  Src[4] = v10;
  if ( *(_QWORD *)(*(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * Blink_high) + 22280LL) <= 0xFFFFFFFFuLL )
    v8 = *(_QWORD *)(*(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * Blink_high) + 22280LL);
  Src[5] = v8;
  if ( a2 )
