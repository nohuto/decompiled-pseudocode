/*
 * XREFs of DifZwNotifyChangeDirectoryFileWrapper @ 0x1406AE610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwNotifyChangeDirectoryFileWrapper(
        void *a1,
        void *a2,
        ...
        BOOLEAN WatchTree)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(977);
...
LABEL_17:
  v33 = ZwNotifyChangeDirectoryFile(a1, a2, a3, a4, IoStatusBlock, Buffer, Length, CompletionFilter, WatchTree);
  if ( v14 )
  {
