/*
 * XREFs of DifEtwUnregisterWrapper @ 0x140652290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifEtwUnregisterWrapper(REGHANDLE RegHandle)
{
  ...
  LODWORD(v14) = EtwUnregister(RegHandle);
  if ( v4 )
  {
