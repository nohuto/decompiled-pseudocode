/*
 * XREFs of DifNtQueryAttributesFileWrapper @ 0x1406810A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryAttributesFileWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtQueryAttributesFile(a1, a2);
  if ( v6 )
  {
