/*
 * XREFs of DifZwGetNlsSectionPtrWrapper @ 0x1406ABA00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetNlsSectionPtrWrapper(ULONG a1, ULONG a2, void *a3, PVOID *a4, ULONG *SectionSize)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1047);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v19 + 1) = SectionSize;
    *(_QWORD *)&v21 = __PAIR64__(a1, a2);
    *((_QWORD *)&v20 + 1) = a3;
    *(_QWORD *)&v20 = a4;
  ...
  DWORD2(v21) = ZwGetNlsSectionPtr(a1, a2, a3, a4, SectionSize);
  if ( v10 )
  {
