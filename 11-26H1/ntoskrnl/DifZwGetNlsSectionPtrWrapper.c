/*
 * XREFs of DifZwGetNlsSectionPtrWrapper @ 0x1406A7E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetNlsSectionPtrWrapper(unsigned int a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  DWORD2(v21) = ZwGetNlsSectionPtr(a1, a2, a3, a4, a5);
  if ( v10 )
  {
