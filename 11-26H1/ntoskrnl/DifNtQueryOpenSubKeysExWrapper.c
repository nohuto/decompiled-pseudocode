/*
 * XREFs of DifNtQueryOpenSubKeysExWrapper @ 0x140688730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryOpenSubKeysExWrapper(OBJECT_ATTRIBUTES *a1, ULONG a2, void *a3, ULONG *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(813);
  ...
  DWORD2(v20) = NtQueryOpenSubKeysEx(a1, a2, a3, a4);
  if ( v9 )
  {
