/*
 * XREFs of DifNtQueryOpenSubKeysExWrapper @ 0x140684B50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryOpenSubKeysExWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtQueryOpenSubKeysEx(
                  a1,
                  a2,
                  a3,
                  a4,
