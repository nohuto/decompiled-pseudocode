/*
 * XREFs of DifZwCreateEventPairWrapper @ 0x14069EF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateEventPairWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwCreateEventPair(a1, a2, a3);
  if ( v8 )
  {
