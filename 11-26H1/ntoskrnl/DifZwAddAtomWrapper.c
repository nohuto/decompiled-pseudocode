/*
 * XREFs of DifZwAddAtomWrapper @ 0x14069C2C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAddAtomWrapper(PWSTR AtomName, ULONG Length, PRTL_ATOM Atom)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1040);
  ...
  LODWORD(v19) = ZwAddAtom(AtomName, Length, Atom);
  if ( v8 )
  {
