/*
 * XREFs of DifRtlUnicodeStringToAnsiStringWrapper @ 0x14069A0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlUnicodeStringToAnsiStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  LODWORD(v19) = RtlUnicodeStringToAnsiString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
