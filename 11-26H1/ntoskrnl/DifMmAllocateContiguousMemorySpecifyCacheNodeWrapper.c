/*
 * XREFs of DifMmAllocateContiguousMemorySpecifyCacheNodeWrapper @ 0x140669000
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  v14 = 0;
  *((_QWORD *)&v22 + 1) = a1;
  *((_QWORD *)&v20 + 1) = __PAIR64__(CacheType, PreferredNode);
  *(PHYSICAL_ADDRESS *)&v22 = a2;
  *((PHYSICAL_ADDRESS *)&v21 + 1) = a3;
  *(PHYSICAL_ADDRESS *)&v21 = a4;
