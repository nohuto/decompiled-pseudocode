/*
 * XREFs of HalpHpetSetMatchValue @ 0x1404E860C
 * Callers:
 *     HalpHpetArmTimer @ 0x1404E85C0 (HalpHpetArmTimer.c)
 *     HalpHpetAcknowledgeInterrupt @ 0x1404F0BD0 (HalpHpetAcknowledgeInterrupt.c)
 * Callees:
