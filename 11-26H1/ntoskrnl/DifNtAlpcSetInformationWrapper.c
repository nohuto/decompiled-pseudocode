/*
 * XREFs of DifNtAlpcSetInformationWrapper @ 0x14066D840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcSetInformationWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtAlpcSetInformation(
                  a1,
                  a2,
                  a3,
                  a4,
