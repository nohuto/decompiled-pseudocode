/*
 * XREFs of DifNtAlpcSetInformationWrapper @ 0x140671420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcSetInformationWrapper(void *a1, ALPC_PORT_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(607);
  ...
  DWORD2(v20) = NtAlpcSetInformation(a1, a2, a3, a4);
  if ( v9 )
  {
