/*
 * XREFs of PopDiagTraceThermalRequest @ 0x140AC18EC
 * Callers:
        ...
        if ( v7 )
        {
          ...
          if ( Pool2 )
          {
            if ( (int)PoStoreDiagnosticContext(*(_QWORD *)(a1 + 24), Pool2, &v23) >= 0 )
            {
              ...
              v10 = (char *)v4 + v4[3];
              v11 = (char *)v4 + v4[4];
              v12 = (unsigned __int16)(v23 - *((_WORD *)v4 + 16));
              v13 = -1LL;
              v21 = v23 - *((_WORD *)v4 + 16);
              v14 = -1LL;
              do
              ...
              *(_QWORD *)&UserData.Size = 1LL;
              ...
              v48 = v12;
              v49 = 0;
              EtwWrite(*(REGHANDLE *)&PopSleepstudySessionLock.PriorityFloorCounts[16], a2, 0LL, 0xBu, &UserData);
            }
          }
        }
