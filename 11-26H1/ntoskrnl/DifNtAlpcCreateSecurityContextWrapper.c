/*
 * XREFs of DifNtAlpcCreateSecurityContextWrapper @ 0x14066C9A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreateSecurityContextWrapper(HANDLE Handle, int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtAlpcCreateSecurityContext(Handle);
  if ( v8 )
  {
