/*
 * XREFs of DifNtAlpcCreateSecurityContextWrapper @ 0x140670580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreateSecurityContextWrapper(
        HANDLE PortHandle,
        ULONG Flags,
        PALPC_SECURITY_ATTR SecurityAttribute)
{
  ...
  LODWORD(v19) = NtAlpcCreateSecurityContext(PortHandle, Flags, SecurityAttribute);
  if ( v8 )
  {
