/*
 * XREFs of DifNtCreateThreadStateChangeWrapper @ 0x140677A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateThreadStateChangeWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        int a5)
{
  ...
  LODWORD(Reserved) = a5;
  LODWORD(v22) = NtCreateThreadStateChange(a1, a2, a3, a4, Reserved);
  if ( v10 )
  {
