/*
 * XREFs of DifNtCreateThreadStateChangeWrapper @ 0x140673E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateThreadStateChangeWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, int a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(569);
  ...
  LODWORD(v21) = NtCreateThreadStateChange(a1, a2, a3, a4, a5);
  if ( v10 )
  {
