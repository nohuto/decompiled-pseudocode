/*
 * XREFs of InbvSetFunction @ 0x140531DE8
 * Callers:
...
__int64 __fastcall InbvSetFunction(int a1)
{
  ...
  result = (unsigned int)dword_140E65CEC;
  v3 = (unsigned int)(dword_140E65CEC - 3);
  if ( (unsigned int)v3 <= 1 )
  {
    ...
    dword_140E65CEC = 4 - (a1 != 4);
    if ( a1 != 4 )
      v4 = off_140E00DE0;
    qword_140E65CE0 = (__int64)v4;
  }
  return result;
}
