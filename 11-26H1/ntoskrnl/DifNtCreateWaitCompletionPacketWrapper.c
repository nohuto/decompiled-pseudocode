/*
 * XREFs of DifNtCreateWaitCompletionPacketWrapper @ 0x140674FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateWaitCompletionPacketWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtCreateWaitCompletionPacket(a1, a2, a3);
  if ( v8 )
  {
