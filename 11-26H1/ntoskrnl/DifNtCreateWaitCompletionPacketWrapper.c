/*
 * XREFs of DifNtCreateWaitCompletionPacketWrapper @ 0x140678BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateWaitCompletionPacketWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtCreateWaitCompletionPacket(WaitCompletionPacketHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
