/*
 * XREFs of PnpCmResourcesToIoResources @ 0x140AA0FBC
 * Callers:
...
LABEL_35:
        ...
        *(_DWORD *)(v19 + 12) = v21->u.Generic.Start.LowPart;
        *(_DWORD *)(v19 + 16) = v21->u.Generic.Start.HighPart - 1 + v21->u.Generic.Start.LowPart;
...
LABEL_37:
    ...
    {
      *(_DWORD *)(v19 + 12) = -2;
      v24 = ~v21->u.MessageInterrupt.Raw.MessageCount;
      *(_WORD *)(v19 + 16) = 4;
      *(_DWORD *)(v19 + 8) = v24;
      *(_DWORD *)(v19 + 20) = 0;
