/*
 * XREFs of DifZwCreateProfileExWrapper @ 0x1406A4E60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  Profile = ZwCreateProfileEx(a1, a2, a3, a4, BucketSize, Buffer, BufferSize, ProfileSource, GroupCount, GroupAffinity);
  if ( v15 )
  {
