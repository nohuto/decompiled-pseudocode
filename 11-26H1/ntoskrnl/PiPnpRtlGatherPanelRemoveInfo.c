/*
 * XREFs of PiPnpRtlGatherPanelRemoveInfo @ 0x14077B700
 * Callers:
...
__int64 __fastcall PiPnpRtlGatherPanelRemoveInfo(__int64 a1, __int64 a2, PVOID *a3)
{
  __int64 Pool2; // rax
...
LABEL_8:
  ...
  if ( (int)(Object + 0x80000000) >= 0 && Object != -1073741772 )
    goto LABEL_8;
  v8 = PiDmGetObject(6LL, a2, (char *)*a3 + 8);
  Object = v8;
  if ( v8 == -1073741772 )
  {
    return 0;
