/*
 * XREFs of DifNtGetMUIRegistryInfoWrapper @ 0x140679140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetMUIRegistryInfoWrapper(unsigned int a1, __int64 a2, __int64 a3)
{
  ...
  HIDWORD(v18) = NtGetMUIRegistryInfo(a1, a2, a3);
  if ( v8 )
  {
