/*
 * XREFs of DifNtQueryIoCompletionWrapper @ 0x140687BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryIoCompletionWrapper(
        void *a1,
        IO_COMPLETION_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = NtQueryIoCompletion(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
