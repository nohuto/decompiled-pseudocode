/*
 * XREFs of DifNtQueryIoCompletionWrapper @ 0x140683FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryIoCompletionWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtQueryIoCompletion(a1, a5);
  if ( v10 )
  {
