/*
 * XREFs of KiNpxNotAvailableFault @ 0x14073A200
 * Callers:
 *     KiNpxNotAvailableFaultShadow @ 0x140C5F4C0 (KiNpxNotAvailableFaultShadow.c)
 * Callees:
...
void __fastcall __noreturn KiNpxNotAvailableFault(__int64 a1, __int64 _RDX)
{
  ...
  if ( (v10 & 1) != 0 && (KeGetCurrentThread()->Header.Reserved1 & 0x80u) != 0 )
    KiSynchronizeUserIsolationDomainExit(a1, _RDX);
  if ( (KiTrapFeatures & 8) != 0 && ((v10 & 1) != 0 || (KiTrapFeatures & 2) != 0 && (*(_DWORD *)v11 & 0x40000) != 0) )
    __asm { stac }
  ...
  {
    if ( v6 )
      KiExceptionDispatch(268435472LL, 1LL, retaddr, v6);
  }
  v7 = __readcr4();
  v8 = __readcr0();
  KiBugCheckDispatch(127LL, 7LL, v8, v7);
}
