/*
 * XREFs of DifNtCreateRegistryTransactionWrapper @ 0x140673250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateRegistryTransactionWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtCreateRegistryTransaction(
                  a1,
                  a2,
                  a3,
                  a4,
