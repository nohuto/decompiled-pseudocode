/*
 * XREFs of DifNtCreateRegistryTransactionWrapper @ 0x140676E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateRegistryTransactionWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(815);
  ...
  DWORD2(v20) = NtCreateRegistryTransaction(a1, a2, a3, a4);
  if ( v9 )
  {
