/*
 * XREFs of DifZwRemoveIoCompletionWrapper @ 0x1406BA940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRemoveIoCompletionWrapper(
        void *a1,
        PVOID *a2,
        PVOID *a3,
        ...
        LARGE_INTEGER *Timeout)
{
  ...
  LODWORD(v21) = ZwRemoveIoCompletion(a1, a2, a3, a4, Timeout);
  if ( v10 )
  {
