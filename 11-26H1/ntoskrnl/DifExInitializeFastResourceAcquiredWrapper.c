/*
 * XREFs of DifExInitializeFastResourceAcquiredWrapper @ 0x140651BA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExInitializeFastResourceAcquiredWrapper(struct _KTHREAD *a1, int a2, __int64 a3)
{
