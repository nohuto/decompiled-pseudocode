...
LABEL_7:
  v12 = v5 - v10;
  v13 = &a3[v10];
  for ( i = (unsigned int)(*((_DWORD *)a1 + 8) + *((_DWORD *)a1 + 10) + *((_DWORD *)a1 + 11) - v8);
        v10 >= i;
        i = *((unsigned int *)v15 + 10) )
  {
    v15 = (__int64 *)*a1;
    if ( !*a1 )
      break;
    v10 -= i;
    v8 = v15[4] + *((unsigned int *)v15 + 11);
    a1 = (__int64 *)*a1;
  }
  v16 = i - v10;
  LODWORD(v8) = v10 + v8;
  ...
  while ( 1 )
  {
    MdlBufferSa = (void *)ViGetMdlBufferSa((int)a1, v8);
    if ( !MdlBufferSa )
      break;
    if ( !*a1 )
    {
