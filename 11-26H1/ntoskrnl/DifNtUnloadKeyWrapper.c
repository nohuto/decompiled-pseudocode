/*
 * XREFs of DifNtUnloadKeyWrapper @ 0x140693E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnloadKeyWrapper(POBJECT_ATTRIBUTES TargetKey)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(808);
  ...
  LODWORD(v14) = NtUnloadKey(TargetKey);
  if ( v4 )
  {
