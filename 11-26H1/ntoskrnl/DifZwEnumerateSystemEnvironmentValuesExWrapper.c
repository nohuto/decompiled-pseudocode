/*
 * XREFs of DifZwEnumerateSystemEnvironmentValuesExWrapper @ 0x1406A9200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateSystemEnvironmentValuesExWrapper(
        ...
        PULONG BufferLength)
{
  ...
  HIDWORD(v18) = ZwEnumerateSystemEnvironmentValuesEx(InformationClass, Buffer, BufferLength);
  if ( v8 )
  {
