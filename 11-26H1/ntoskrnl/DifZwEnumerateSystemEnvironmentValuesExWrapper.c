/*
 * XREFs of DifZwEnumerateSystemEnvironmentValuesExWrapper @ 0x1406A5620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateSystemEnvironmentValuesExWrapper(unsigned int a1, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(998);
  ...
  HIDWORD(v18) = ZwEnumerateSystemEnvironmentValuesEx(a1, a2, a3);
  if ( v8 )
  {
