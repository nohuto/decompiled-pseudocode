/*
 * XREFs of ?BTreeDeleteEx@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@SAJPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14020ECD0
 * Callers:
  ...
  else
  {
    if ( (unsigned __int16)*v6 < v11 )
    {
      ...
      else
      {
        ...
        {
          v21 = (__int64)*(v5 - 2);
          v22 = (unsigned __int64)*(v5 - 1) + 32 * !(v19 & 1) - 16;
          v23 = (void **)(v22 <= v21 + 16 ? v21 + 8 : v22 - 8);
          if ( **(_DWORD **)(a1 + 16) != -1 )
            NP_CONTEXT::NpLeafDerefInternal((struct NP_CONTEXT::NP_CTX *)(a1 + 16), v23);
        }
      }
    }
    v16 = v5[1];
