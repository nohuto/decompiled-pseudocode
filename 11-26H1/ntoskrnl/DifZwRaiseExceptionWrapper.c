/*
 * XREFs of DifZwRaiseExceptionWrapper @ 0x1406B9460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRaiseExceptionWrapper(
        ...
        BOOLEAN FirstChance)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(944);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = ExceptionRecord;
    *(_QWORD *)&v18 = ContextRecord;
    BYTE8(v17) = FirstChance;
  ...
  LODWORD(v19) = ZwRaiseException(ExceptionRecord, ContextRecord, FirstChance);
  if ( v8 )
  {
