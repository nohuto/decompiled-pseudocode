/*
 * XREFs of DifZwRaiseExceptionWrapper @ 0x1406B5880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRaiseExceptionWrapper(__int64 a1, __int64 a2, char a3)
{
  ...
  LODWORD(v19) = ZwRaiseException(a1);
  if ( v8 )
  {
