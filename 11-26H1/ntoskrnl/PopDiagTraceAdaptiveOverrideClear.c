/*
 * XREFs of PopDiagTraceAdaptiveOverrideClear @ 0x1407D59A4
 * Callers:
...
void PopDiagTraceAdaptiveOverrideClear()
{
  ...
  if ( (unsigned int)dword_140E07560 > 5 && tlgKeywordOn((__int64)&dword_140E07560, 0x400000000000LL) )
  {
    ...
    v4 = 0x1000000LL;
    v11 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07560, (unsigned __int8 *)word_14004D56A, 0LL, 0LL, 5u, &v5);
  }
}
