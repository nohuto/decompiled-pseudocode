/*
 * XREFs of PopDiagTraceAdaptiveOverrideClear @ 0x1407D2938
 * Callers:
...
void PopDiagTraceAdaptiveOverrideClear()
{
  ...
  if ( (unsigned int)dword_140E07598 > 5 && tlgKeywordOn((__int64)&dword_140E07598, 0x400000000000LL) )
  {
    ...
    v4 = 0x1000000LL;
    v11 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07598, (unsigned __int8 *)&dword_14004D0DC, 0LL, 0LL, 5u, &v5);
  }
}
