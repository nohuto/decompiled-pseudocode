/*
 * XREFs of MiSelectUserAddress @ 0x1409C4FA0
 * Callers:
        ...
        ...)
{
  ...
  int v27; // eax
  __int64 v28; // rcx
  unsigned __int64 **v32; // [rsp+D0h] [rbp+48h] BYREF
  va_list va; // [rsp+D0h] [rbp+48h]
  unsigned __int64 v34; // [rsp+D8h] [rbp+50h]
  va_list va1; // [rsp+E0h] [rbp+58h] BYREF

  va_start(va1, a8);
  va_start(va, a8);
  v32 = va_arg(va1, unsigned __int64 **);
    ...
    else
    {
      ...
      else
      {
        ...
        if ( v24 && v12 - a2 + 1 >= 0x40000000 )
        {
          v19[26] = v24;
          v19[23] = v12 >> 16;
          v26 = (struct _KLOCK_ENTRIES *)(v24 << 16);
          v19[24] = v12 + 1;
          v19[25] = (unsigned __int64)v26;
          v27 = MiInitializeVadCellBitMap(v19 + 18, 1, v12, v26);
          v14 = a4;
          v12 = a3;
          v28 = 0LL;
          if ( v27 >= 0 )
