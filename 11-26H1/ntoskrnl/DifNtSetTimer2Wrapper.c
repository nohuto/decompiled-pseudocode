/*
 * XREFs of DifNtSetTimer2Wrapper @ 0x140691C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetTimer2Wrapper(void *a1, LARGE_INTEGER *a2, LARGE_INTEGER *a3, _T2_SET_PARAMETERS_V0 *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(705);
  ...
  DWORD2(v20) = NtSetTimer2(a1, a2, a3, a4);
  if ( v9 )
  {
