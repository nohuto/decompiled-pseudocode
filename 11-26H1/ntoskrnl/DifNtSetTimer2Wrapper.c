/*
 * XREFs of DifNtSetTimer2Wrapper @ 0x14068E080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetTimer2Wrapper(void *a1, __int64 a2, __int64 a3, __int64 a4)
{
