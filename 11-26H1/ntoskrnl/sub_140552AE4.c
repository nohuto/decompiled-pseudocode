/*
 * XREFs of sub_140552AE4 @ 0x140552AE4
 * Callers:
...
char __fastcall sub_140552AE4(__int64 a1, int *a2)
{
        ...
        *(_DWORD *)(a1 + 2524) &= ~0x200000u;
        if ( v36 != *(_QWORD *)(a1 + 2688) )
        {
          ...
          *(_DWORD *)(v40 + 16) = v39;
          ...
          LOBYTE(j) = sub_140C7903C(a1, 0LL, v36, 256LL);
        }
      }
    }
  }
LABEL_45:
  ...
  if ( !(_DWORD)v41 )
    return j;
  sub_1405518EC(a1, *((_QWORD *)a2 + 1), v41, (__int64)v63);
  v42 = 16;
  v43 = a2 + 6;
  v44 = v63;
  while ( 1 )
      ...
      *(_DWORD *)(a1 + 2524) &= ~0x200000u;
      if ( v57 != *(_QWORD *)(a1 + 2688) )
      {
        ...
        *(_DWORD *)(v61 + 16) = v60;
        ...
        LOBYTE(j) = sub_140C7903C(a1, 0LL, v57, 256LL);
      }
    }
  }
LABEL_74:
