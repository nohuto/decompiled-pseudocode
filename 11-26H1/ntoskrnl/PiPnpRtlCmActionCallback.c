/*
 * XREFs of PiPnpRtlCmActionCallback @ 0x1409A2FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PiDmGetCmObjectListFromCache @ 0x140AB0BC0 (PiDmGetCmObjectListFromCache.c)
  ...
  switch ( a4 )
  {
    ...
    case 3:
      ...
      else if ( (_DWORD)a3 == 1 )
      {
        ...
        if ( *(int *)a6 >= 0 )
        {
          LOBYTE(Size) = byte_140EF3DCA & 0x10;
        ...
        {
          LOBYTE(Size) = byte_140EF3DCA & 0x20;
