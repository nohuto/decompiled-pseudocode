/*
 * XREFs of DifIoCreateNotificationEventWrapper @ 0x14065EAE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoCreateNotificationEventWrapper(PUNICODE_STRING EventName, PHANDLE EventHandle)
{
  ...
  *((_QWORD *)&v16 + 1) = IoCreateNotificationEvent(EventName, EventHandle);
  if ( v6 )
  {
