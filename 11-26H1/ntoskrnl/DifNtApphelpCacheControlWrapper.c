/*
 * XREFs of DifNtApphelpCacheControlWrapper @ 0x1406715B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtApphelpCacheControlWrapper(unsigned int a1, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(865);
  ...
  HIDWORD(v16) = NtApphelpCacheControl(a1, a2);
  if ( v6 )
  {
