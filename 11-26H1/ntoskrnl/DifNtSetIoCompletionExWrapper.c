/*
 * XREFs of DifNtSetIoCompletionExWrapper @ 0x140690CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetIoCompletionExWrapper(
        void *a1,
        void *a2,
        void *a3,
        void *a4,
...
LABEL_17:
  v26 = NtSetIoCompletionEx(a1, a2, a3, a4, IoStatus, IoStatusInformation);
  if ( v11 )
  {
