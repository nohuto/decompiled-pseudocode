/*
 * XREFs of DifKeReleaseGuardedMutexWrapper @ 0x140666830
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeReleaseGuardedMutexWrapper(PKGUARDED_MUTEX Mutex)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(266);
