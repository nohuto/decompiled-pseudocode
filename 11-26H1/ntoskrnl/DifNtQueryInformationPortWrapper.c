/*
 * XREFs of DifNtQueryInformationPortWrapper @ 0x140686B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationPortWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = NtQueryInformationPort(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
