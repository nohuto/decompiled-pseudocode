/*
 * XREFs of DifNtQueryInformationPortWrapper @ 0x140682F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationPortWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtQueryInformationPort(a1, a5);
  if ( v10 )
  {
