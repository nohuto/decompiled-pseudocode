/*
 * XREFs of MiDelayFaultingThread @ 0x1405053C4
 * Callers:
...
char __fastcall MiDelayFaultingThread(unsigned int a1)
{
  ...
  if ( (a1 & 0x10000) != 0 )
  {
    v4 = MiWaitForAvailablePages(
           *(_QWORD *)(stru_140E2EB88.ThreadLock + 8LL * HIWORD(Process[2].ProcessListEntry.Blink)),
           &Interval,
           BYTE2(a1) & 2);
    v5 = v4;
  }
  ...
  if ( v1 )
  {
    ...
    if ( stru_140E36558.FirstArgument )
    {
      ...
      {
        LOBYTE(v4) = tlgKeywordOn((__int64)stru_140E36558.FirstArgument, 1LL);
        if ( (_BYTE)v4 )
