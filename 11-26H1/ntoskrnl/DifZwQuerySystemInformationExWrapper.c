/*
 * XREFs of DifZwQuerySystemInformationExWrapper @ 0x1406B80B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQuerySystemInformationExWrapper(
        ...
        ULONG *ReturnLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1037);
...
LABEL_17:
  HIDWORD(v23) = ZwQuerySystemInformationEx(a1, a2, a3, a4, SystemInformationLength, ReturnLength);
  if ( v11 )
  {
