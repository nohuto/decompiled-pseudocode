...
LABEL_7:
    _InterlockedOr(v7, 0);
    off_140E00B28[0] = HalpTimerWatchdogStop;
    off_140E00B18[0] = HalpTimerWatchdogStart;
    off_140E00B30[0] = HalpTimerWatchdogGeneratedLastReset;
    off_140E00B38[0] = (__int64 (__fastcall *)())HalpTimerWatchdogTriggerSystemReset;
    off_140E00BC8[0] = HalpTimerWatchdogQueryDueTime;
    _InterlockedOr(v7, 0);
    HalpTimerWatchdogStart();
    _InterlockedOr(v7, 0);
    off_140E00B20[0] = HalpTimerWatchdogResetCountdown;
    return 0;
  }
  return result;
}
