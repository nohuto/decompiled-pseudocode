/*
 * XREFs of ??$RtlpVirtualPopShadowStack@PEAU_CONTEXT_FOR_STACKWALK@@@@YAXPEAU_CONTEXT_FOR_STACKWALK@@KK@Z @ 0x14044D9C0
 * Callers:
...
void __fastcall RtlpVirtualPopShadowStack<_CONTEXT_FOR_STACKWALK *>(__int64 a1, int a2)
{
  if ( a2 )
  {
    if ( (*(_BYTE *)(a1 + 56) & 1) != 0 )
      *(_QWORD *)(a1 + 64) += (unsigned int)(8 * a2);
  }
}
