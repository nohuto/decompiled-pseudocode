/*
 * XREFs of DifZwQueryDriverEntryOrderWrapper @ 0x1406B4290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryDriverEntryOrderWrapper(PULONG Ids, PULONG Count)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(54);
  ...
  DWORD2(v16) = ZwQueryDriverEntryOrder(Ids, Count);
  if ( v6 )
  {
