/*
 * XREFs of DifNtSetInformationTransactionWrapper @ 0x140690810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationTransactionWrapper(
        void *a1,
        ...
        ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(829);
  ...
  DWORD2(v20) = NtSetInformationTransaction(a1, a2, a3, a4);
  if ( v9 )
  {
