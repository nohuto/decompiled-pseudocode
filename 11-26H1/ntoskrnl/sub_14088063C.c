/*
 * XREFs of sub_14088063C @ 0x14088063C
 * Callers:
...
__int64 __fastcall sub_14088063C(__int64 a1, __int64 a2, _QWORD *a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  v13 = sub_1409EF598(a1, &v20, &v19, &v18);
  v15 = v13;
  if ( v13 )
  {
    if ( v13 == -1073741198 )
    {
      v15 = sub_1409EEB98((int)a1 + 136, a2, v14, (unsigned int)&v20, 16, v18);
      if ( v15 >= 0 )
        v15 = sub_1409EF9A4(a2);
    }
  }
  else if ( a3 )
  {
