/*
 * XREFs of DifZwSetTimerResolutionWrapper @ 0x1406C0110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetTimerResolutionWrapper(ULONG DesiredTime, BOOLEAN a2, ULONG *a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1023);
  ...
  DWORD2(v18) = ZwSetTimerResolution(DesiredTime, a2, a3);
  if ( v8 )
  {
