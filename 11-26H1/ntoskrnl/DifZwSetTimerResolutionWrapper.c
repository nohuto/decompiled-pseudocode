/*
 * XREFs of DifZwSetTimerResolutionWrapper @ 0x1406BC530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetTimerResolutionWrapper(unsigned int a1, char a2, __int64 a3)
{
  ...
  LOBYTE(v7) = a2;
  DWORD2(v18) = ZwSetTimerResolution(a1, v7, a3);
  if ( v8 )
  {
