/*
 * XREFs of RtlLoadString @ 0x1408024F0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  if ( a1 && a5 && (a4 & 0xFFFFFFFE) == 0 )
  {
    ...
    if ( v10 )
    {
      v13 = LdrpSearchResourceSection_U(a1, (unsigned int)v22, 4, 1, (__int64)&v20);
      if ( v13 < 0 )
    ...
    {
      v13 = LdrResSearchResource(a1, (unsigned int)v22, 4, 1, (__int64)&v19, (__int64)&v17, a7, a8);
      if ( v13 >= 0 && v17 > 0xFFFF )
        v13 = -1073741701;
    }
    if ( v13 >= 0 && v19 )
