/*
 * XREFs of DifNtUnmapViewOfSectionWrapper @ 0x140690870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnmapViewOfSectionWrapper(ULONG_PTR BugCheckParameter1, __int64 a2)
{
  ...
  DWORD2(v16) = NtUnmapViewOfSection(BugCheckParameter1);
  if ( v6 )
  {
