/*
 * XREFs of DifNtUnmapViewOfSectionWrapper @ 0x140694450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnmapViewOfSectionWrapper(HANDLE ProcessHandle, PVOID BaseAddress)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(765);
  ...
  DWORD2(v16) = NtUnmapViewOfSection(ProcessHandle, BaseAddress);
  if ( v6 )
  {
