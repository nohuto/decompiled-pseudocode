/*
 * XREFs of __asan_wrap_strlen @ 0x1405E4A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall _asan_wrap_strlen(ULONG_PTR BugCheckParameter1)
{
  ...
  do
  {
    if ( v2 + v3 + 0x800000000000LL == -1LL )
      break;
    if ( KasaniValidationEnabled && v3 >= 0xFFFF800000000000uLL )
    {
      v4 = *(_BYTE *)(((v3 + 0x800000000000LL) >> 3) + KasaniShadow);
      if ( v4 )
      {
        if ( v4 < 8 && (char)((v3 & 7) + 1) > v4 )
          KasaniReport(v3, 1uLL, 0, retaddr, v4);
        if ( v4 == 9 && KeGetCurrentIrql() >= 2u )
          KasaniReport(v3, 1uLL, 0, retaddr, 9u);
      }
