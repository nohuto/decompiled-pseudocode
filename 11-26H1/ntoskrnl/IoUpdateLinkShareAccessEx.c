/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x140A7F650
 * Callers:
 *     IoUpdateLinkShareAccess @ 0x140796DC0 (IoUpdateLinkShareAccess.c)
 *     IoUpdateShareAccess @ 0x140A7F630 (IoUpdateShareAccess.c)
 * Callees:
 *     <none>
 */
