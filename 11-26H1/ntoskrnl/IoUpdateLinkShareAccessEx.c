/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x140A854C0
 * Callers:
 *     IoUpdateLinkShareAccess @ 0x1407998F0 (IoUpdateLinkShareAccess.c)
 *     IoUpdateShareAccess @ 0x140A854A0 (IoUpdateShareAccess.c)
 * Callees:
 *     <none>
 */
