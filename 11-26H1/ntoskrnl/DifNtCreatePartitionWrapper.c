/*
 * XREFs of DifNtCreatePartitionWrapper @ 0x140676050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreatePartitionWrapper(void *a1, HANDLE *a2, ACCESS_MASK a3, OBJECT_ATTRIBUTES *a4)
{
  ...
  DWORD2(v20) = NtCreatePartition(a1, a2, a3, a4, v18);
  if ( v9 )
  {
