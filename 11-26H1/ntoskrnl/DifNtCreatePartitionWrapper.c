/*
 * XREFs of DifNtCreatePartitionWrapper @ 0x140672470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreatePartitionWrapper(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
