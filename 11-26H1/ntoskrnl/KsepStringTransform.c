/*
 * XREFs of KsepStringTransform @ 0x1409E5CF0
 * Callers:
...
__int64 __fastcall KsepStringTransform(__int64 a1, __int64 a2)
{
  ...
  if ( !a1 )
  {
    ...
    *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v8) = 197399;
  ...
  if ( !a2 )
  {
    ...
    *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v9) = 197400;
    if ( ((__int64)stru_140E66B30.StackBase & 4) != 0 )
