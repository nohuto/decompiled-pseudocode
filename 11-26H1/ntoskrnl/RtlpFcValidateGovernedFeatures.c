/*
 * XREFs of RtlpFcValidateGovernedFeatures @ 0x1406279F8
 * Callers:
...
__int64 __fastcall RtlpFcValidateGovernedFeatures(__int64 a1, __int64 a2)
{
  ...
  ULONGLONG v17; // [rsp+40h] [rbp+18h] BYREF
  ...
  if ( a1 )
  {
    ...
    if ( v4 && (v4 >= v3 || (v4 & 3) != 0)
      ...
      || RtlULongLongMult(*(unsigned int *)(v6 + 4), 4uLL, &v17) < 0 )
    {
      return (unsigned int)-1073741811;
    }
    v9 = pullResult + 24;
    ...
    v10 = v9 + v17;
    if ( v9 + v17 < v9 || v10 + 4 < v10 || v10 + 8 < v10 + 4 )
      return (unsigned int)-1073741675;
    if ( v10 + 8 > v8 )
      return (unsigned int)-1073741811;
    v11 = *v7;
    ...
    else
    {
      for ( i = v2; i < v12; ++i )
      {
        if ( (unsigned __int16)*(_DWORD *)(v4 + 4LL * i) >= (unsigned __int16)v11 )
          return (unsigned int)-1073741811;
      }
      for ( j = v2; j < (unsigned __int16)v11; ++j )
      {
        if ( (unsigned __int16)*(_DWORD *)(v5 + 16LL * j + 4) > v12 )
          return (unsigned int)-1073741811;
      }
    }
  }
