/*
 * XREFs of DifZwAlpcCancelMessageWrapper @ 0x14069A290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlpcCancelMessageWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwAlpcCancelMessage(a1, a2, a3);
  if ( v8 )
  {
