...
LABEL_8:
  ...
  else
  {
    ...
    v18 = DEVPKEY_DeviceClass_UpperFilterDefaultLevel;
    v19 = L"*Upper";
  }
  v29 = v17;
  v31 = v16;
  ...
  v24 = PnpGetObjectProperty(v12, a2, 2, a3, 0LL, (__int64)v18, (__int64)&v28 + 4, 0LL, 0, (__int64)&v28, 0);
  ObjectProperty = v24;
  if ( v24 != -1073741789 )
  {
    if ( v24 == -1073741275 )
...
LABEL_53:
  ...
  {
LABEL_29:
    DeclarativeFilterList = CmGetDeclarativeFilterList(v12, v35, (wchar_t *)v30, v13, (int)v19, 0LL, 0, (__int64)&v28);
