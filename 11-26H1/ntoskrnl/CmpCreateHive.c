/*
 * XREFs of CmpCreateHive @ 0x1408B5E6C
 * Callers:
        ...
        __int64 a13)
{
  ...
  unsigned int v63; // [rsp+88h] [rbp-78h] BYREF
  ...
  unsigned int *v80; // [rsp+170h] [rbp+70h]
...
LABEL_97:
      ...
      SetFailureLocation(a13, (int)v16, 1, -1073741811, v58);
...
LABEL_96:
    ...
    v61 = CmpAcquireShutdownRundown(v17, v16);
    if ( !v61 )
    ...
    if ( v22 )
    {
      ...
      else
      {
        ...
        if ( v26 )
        {
          ...
          v47 = *(_QWORD *)(v23 + 1576);
          v60 = 256;
          ZwSetInformationObject(v47, 4LL);
        }
        v27 = a6[2];
        if ( !v27 )
        {
LABEL_33:
          ...
          *(_QWORD *)a13 = v23;
          if ( v32 != 2 && v32 != 5 && (v32 || !a6 || !*a6) )
          {
            if ( a11 )
            {
              LODWORD(v73) = *(_DWORD *)(a11 + 112);
              *((_QWORD *)&v73 + 1) = *(_QWORD *)(a11 + 104);
              LODWORD(v74) = *(_DWORD *)(a11 + 128);
              v49 = &v74;
              *((_QWORD *)&v74 + 1) = *(_QWORD *)(a11 + 120);
              v48 = &v73;
            }
            else
            {
              ...
              if ( v39 == -2147483606 )
              {
                if ( (unsigned int)dword_140E09EE8 > 5 )
                {
                  ...
                  if ( tlgKeywordOn((__int64)&dword_140E09EE8, 0x400000000000LL) )
                  {
                    ...
                    v80 = &v63;
                    v82 = &v60;
                    v55 = *(unsigned __int16 *)(a13 + 8);
                    v56 = *(unsigned __int16 *)(a13 + 10);
                    v88 = a13 + 8;
                    v84 = &v64;
                    v90 = a13 + 12;
                    v57 = *(unsigned __int8 *)(a13 + 394);
                    v91 = 12 * v55;
                    v95 = a13 + 108;
                    v96 = 12 * v56;
                    v100 = a13 + 396;
                    ...
                    tlgWriteTransfer_EtwWriteTransfer(
                      ...
                      (unsigned __int8 *)&dword_140056837 + 2,
                      0LL,
                      0LL,
                      0xDu,
                      &v79);
...
LABEL_55:
            ...
            {
              v52 = *(_QWORD *)(v23 + 64);
              if ( *(_DWORD *)(v52 + 24) < 6u || (*(_DWORD *)(v52 + 144) & 2) == 0 )
              {
            ...
            if ( ContextForFile >= 0 )
            {
              ...
              else
              {
                ...
                if ( *(struct _KTHREAD **)PspSiloMonitorLock.WaitBlock[2].Thread != (struct _KTHREAD *)&PspSiloMonitorLock.WaitBlockFill11[112] )
                  __fastfail(3u);
                *v43 = &PspSiloMonitorLock.WaitBlockFill11[112];
                *(_QWORD *)(v23 + 1616) = Thread;
                *(_QWORD *)&Thread->Header.Lock = v43;
              ...
              *v44 = v23;
              ...
              if ( (DWORD2(PerfGlobalGroupMask) & 0x1000000) != 0 )
                CmpLogHiveInitializeEvent(v23, v35, v40, v66[0]);
              ContextForFile = 0;
LABEL_71:
...
LABEL_44:
      ...
      v29 = *v28;
      v60 = 256;
      ZwSetInformationObject(v29, 4LL);
      goto LABEL_33;
    }
  ...
  SetFailureLocation(a13, (int)v16, 1, ContextForFile, v45);
  if ( Pool2 )
  {
