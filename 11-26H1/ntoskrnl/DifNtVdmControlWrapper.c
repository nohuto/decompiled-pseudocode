/*
 * XREFs of DifNtVdmControlWrapper @ 0x1406948F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtVdmControlWrapper(HANDLE EventPairHandle, __int64 a2)
{
  ...
  v15 = 0LL;
  v2 = (unsigned int)EventPairHandle;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(858);
  ...
  HIDWORD(v16) = NtWaitLowEventPair((HANDLE)v2);
  if ( v6 )
  {
