/*
 * XREFs of DifNtDeleteWnfStateDataWrapper @ 0x140679A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDeleteWnfStateDataWrapper(PCWNF_STATE_NAME StateName, void *ExplicitScope)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(745);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = StateName;
    *((_QWORD *)&v15 + 1) = ExplicitScope;
  ...
  DWORD2(v16) = NtDeleteWnfStateData(StateName, ExplicitScope);
  if ( v6 )
  {
