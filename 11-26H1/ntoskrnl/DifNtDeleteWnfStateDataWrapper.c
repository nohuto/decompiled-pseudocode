/*
 * XREFs of DifNtDeleteWnfStateDataWrapper @ 0x140675E20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NtDeleteWnfStateData @ 0x14083F6A0 (NtDeleteWnfStateData.c)
 */

__int64 __fastcall DifNtDeleteWnfStateDataWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtDeleteWnfStateData(a1, a2);
  if ( v6 )
  {
