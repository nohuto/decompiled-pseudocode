/*
 * XREFs of DifNtFlushInstructionCacheWrapper @ 0x14067BBE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFlushInstructionCacheWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(785);
  ...
  LODWORD(v19) = xHalGetInterruptTranslator(a1, a2, a3);
  if ( v8 )
  {
