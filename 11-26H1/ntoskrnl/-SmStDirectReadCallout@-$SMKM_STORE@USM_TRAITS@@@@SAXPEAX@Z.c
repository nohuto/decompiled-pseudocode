/*
 * XREFs of ?SmStDirectReadCallout@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAX@Z @ 0x14020D330
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall SMKM_STORE<SM_TRAITS>::SmStDirectReadCallout(_QWORD *Parameter)
{
  ...
  *((_DWORD *)Parameter + 6) = 0;
  ...
  v5 = (union _SLIST_HEADER *)*Parameter;
  v6 = Issue;
  v7 = Parameter[2];
  ...
  if ( v6 != -1073741550 )
  {
    SMKM_STORE<SM_TRAITS>::SmStDirectReadComplete(*Parameter, (struct _SLIST_ENTRY *)Parameter[1], v6);
