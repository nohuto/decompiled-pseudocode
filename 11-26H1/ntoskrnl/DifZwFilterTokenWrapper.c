/*
 * XREFs of DifZwFilterTokenWrapper @ 0x1406A9C40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFilterTokenWrapper(
        void *a1,
        ULONG a2,
        ...
        HANDLE *NewTokenHandle)
{
  ...
  unsigned int v23; // [rsp+68h] [rbp-8h]
...
LABEL_7:
  v14 = 0;
  v22 = a1;
  v20[2] = RestrictedSids;
  v20[1] = NewTokenHandle;
  v21 = a2;
  v20[4] = a3;
  v20[3] = a4;
...
LABEL_17:
  v23 = ZwFilterToken(a1, a2, a3, a4, RestrictedSids, NewTokenHandle);
  if ( v11 )
  {
