/*
 * XREFs of DifZwFilterTokenWrapper @ 0x1406A6060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFilterTokenWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(878);
...
LABEL_17:
  v27 = ZwFilterToken(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
