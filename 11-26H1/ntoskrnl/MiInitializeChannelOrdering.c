/*
 * XREFs of MiInitializeChannelOrdering @ 0x140875F48
 * Callers:
 *     MiInitializeNuma @ 0x1406E3230 (MiInitializeNuma.c)
 * Callees:
 *     MiInitializeSystemChannelOrdering @ 0x140CFCE3C (MiInitializeSystemChannelOrdering.c)
 */
...
__int64 __fastcall MiInitializeChannelOrdering(__int64 a1, __int64 a2)
{
  ...
  if ( qword_140E2D6E8 )
  {
    ...
    {
      v5 = qword_140E37CD0;
      *(_WORD *)(v3 + v2 + 14149) = *(_WORD *)(v3 + qword_140E37CD0 + 14149);
