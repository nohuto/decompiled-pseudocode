/*
 * XREFs of DifNtWaitForWorkViaWorkerFactoryWrapper @ 0x1406953B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForWorkViaWorkerFactoryWrapper(
        void *a1,
        ...
        _WORKER_FACTORY_DEFERRED_WORK *DeferredWork)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(854);
  ...
  LODWORD(v21) = NtWaitForWorkViaWorkerFactory(a1, a2, a3, a4, DeferredWork);
  if ( v10 )
  {
