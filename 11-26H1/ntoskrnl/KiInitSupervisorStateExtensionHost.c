/*
 * XREFs of KiInitSupervisorStateExtensionHost @ 0x140CCA3AC
 * Callers:
...
void __fastcall KiInitSupervisorStateExtensionHost(__int64 a1, __int64 a2)
{
  ...
  if ( (KeFeatureBits & 0x800000) != 0 && KeEnabledSupervisorXStateFeatures || (_DWORD)KiIptMsrMask )
  {
    ...
    v4[3] = 0LL;
    v4[4] = 0LL;
    if ( (int)ExRegisterHost(&KiSupervisorXStateFeaturesLock.Header.WaitListHead.Blink, a2, (unsigned __int16 *)v4) < 0 )
      KiSupervisorXStateFeaturesLock.Header.WaitListHead.Blink = 0LL;
  }
}
