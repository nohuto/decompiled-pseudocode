/*
 * XREFs of SymCryptEcDhSecretAgreementSelftest @ 0x140562DAC
 * Callers:
...
__int64 SymCryptEcDhSecretAgreementSelftest()
{
  ...
  if ( !v2 )
    SymCryptFatal(1179209811LL);
  if ( (unsigned int)SymCryptEckeySetValue((__int64)qword_140024E80, 32LL, (__int64)eckey1, 64LL, 2u, 2, 8448, v2) )
    SymCryptFatal(1179209811LL);
  v4 = SymCryptEckeyAllocate(v1);
  v5 = v4;
  if ( !v4 )
    SymCryptFatal(1179209811LL);
  if ( (unsigned int)SymCryptEckeySetValue((__int64)qword_140025AD0, 32LL, (__int64)eckey2, 64LL, 2u, 2, 8448, v4) )
    SymCryptFatal(1179209811LL);
