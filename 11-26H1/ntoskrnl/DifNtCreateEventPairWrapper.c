/*
 * XREFs of DifNtCreateEventPairWrapper @ 0x140674550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateEventPairWrapper(HANDLE EventPairHandle, int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(684);
  ...
  LODWORD(v19) = NtWaitLowEventPair(EventPairHandle);
  if ( v8 )
  {
