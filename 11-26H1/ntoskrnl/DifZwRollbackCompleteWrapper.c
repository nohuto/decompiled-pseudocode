/*
 * XREFs of DifZwRollbackCompleteWrapper @ 0x1406BBFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRollbackCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1110);
  ...
  DWORD2(v16) = ZwRollbackComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
