/*
 * XREFs of DifNtSetInformationTransactionManagerWrapper @ 0x140690670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationTransactionManagerWrapper(
        void *a1,
        ...
        ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(824);
  ...
  DWORD2(v20) = NtSetInformationTransactionManager(a1, a2, a3, a4);
  if ( v9 )
  {
