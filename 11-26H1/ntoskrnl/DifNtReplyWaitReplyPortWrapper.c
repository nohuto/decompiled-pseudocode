/*
 * XREFs of DifNtReplyWaitReplyPortWrapper @ 0x140689790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplyWaitReplyPortWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtReplyWaitReplyPort(a1, a2);
  if ( v6 )
  {
