/*
 * XREFs of DifNtReplyWaitReplyPortWrapper @ 0x14068D370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplyWaitReplyPortWrapper(HANDLE PortHandle, PPORT_MESSAGE ReplyMessage)
{
  ...
  DWORD2(v16) = NtReplyWaitReplyPort(PortHandle, ReplyMessage);
  if ( v6 )
  {
