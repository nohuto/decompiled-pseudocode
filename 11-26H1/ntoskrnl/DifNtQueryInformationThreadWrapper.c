/*
 * XREFs of DifNtQueryInformationThreadWrapper @ 0x140687050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationThreadWrapper(
        void *a1,
        THREADINFOCLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = NtQueryInformationThread(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
