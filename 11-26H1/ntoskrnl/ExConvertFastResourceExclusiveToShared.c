/*
 * XREFs of ExConvertFastResourceExclusiveToShared @ 0x14041DE80
 * Callers:
...
__int64 __fastcall ExConvertFastResourceExclusiveToShared(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ULONG_PTR v2; // r8
  ...
  if ( (struct _KTHREAD *)(*(_QWORD *)(BugCheckParameter2 + 80) & 0xFFFFFFFFFFFFFFFEuLL) != CurrentThread )
    KeBugCheckEx(0x1C6u, 9uLL, v2, *(_QWORD *)(BugCheckParameter2 + 80) & 0xFFFFFFFFFFFFFFFEuLL, 0LL);
  ...
  v6 = *(_BYTE *)(BugCheckParameter2 + 101);
  if ( (v6 & 2) == 0 )
    KeBugCheckEx(0x1C6u, 0xBuLL, v2, ((unsigned __int64)(v6 & 2) << 15) | 1, 0LL);
  if ( *(int *)(BugCheckParameter2 + 96) > 1 )
    KeBugCheckEx(0x1C6u, 0x13uLL, BugCheckParameter2, 0LL, 0LL);
  return ExpConvertFastResourceExclusiveToShared(BugCheckParameter2, a2, v2);
}
