/*
 * XREFs of AdtpObjsInitialize @ 0x140896C50
 * Callers:
...
NTSTATUS AdtpObjsInitialize()
{
  ...
  gLoadedDiffHivesLock.Padding[2] = 0LL;
  SourceString = 0LL;
  ExInitializeResourceLite((PERESOURCE)&gLoadedDiffHivesLock.Spare35[1]);
  v3 = 0;
  for ( i = 0; i <= 6; ++i )
  {
    v5 = 16LL * i;
    *(_WORD *)((char *)&unk_140EF4702 + v5) = 24;
    *(_WORD *)((char *)&AdtpEventIdStringStandard + v5) = 0;
    *(_QWORD *)((char *)&unk_140EF4708 + v5) = (char *)&AdtpAccessIdsStringBuffer + 2 * v3;
  ...
  {
    v8 = 16LL * j;
    *(_WORD *)&gLoadedDiffHivesLock.PriorityFloorCounts[v8 + 10] = 24;
    *(_WORD *)&gLoadedDiffHivesLock.PriorityFloorCounts[v8 + 8] = 0;
    *(_QWORD *)&gLoadedDiffHivesLock.PriorityFloorCounts[v8 + 16] = (char *)&AdtpAccessIdsStringBuffer + 2 * v3;
    result = RtlIntegerToUnicodeString(
               j + 1552,
               0xAu,
               (PUNICODE_STRING)&gLoadedDiffHivesLock.PriorityFloorCounts[v8 + 8]);
    if ( result < 0 )
      return result;
    v3 += 12;
  }
  ...
  for ( k = 0; ; k = v30 + 1 )
  {
    ...
    if ( v9 == -1073741789 )
    {
      ...
      if ( v9 >= 0 )
      {
        ...
        if ( !v13 )
          return -1073741801;
        *v13 = gLoadedDiffHivesLock.Padding[2];
        gLoadedDiffHivesLock.Padding[2] = (unsigned __int64)v13;
        v13[3] = 0LL;
        v14 = v12[6];
        *((_WORD *)v1 + 4) = v14;
        *((_WORD *)v1 + 5) = v14 + 2;
    ...
    for ( m = 0; ; ++m )
    {
      ...
      if ( v18 == -1073741789 )
      {
        ...
        if ( v18 >= 0 )
        {
          v21 = (_QWORD *)ExAllocatePool2(0x100uLL);
          v22 = v21;
          if ( !v21 )
            return -1073741801;
          *v21 = v1[3];
