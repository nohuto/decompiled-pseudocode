/*
 * XREFs of DifNtNotifyChangeSessionWrapper @ 0x140680400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtNotifyChangeSessionWrapper(
        void *a1,
        ULONG a2,
        LARGE_INTEGER *a3,
        IO_SESSION_EVENT a4,
...
LABEL_17:
  v31 = NtNotifyChangeSession(a1, a2, a3, a4, NewState, PreviousState, Payload, PayloadSize);
  if ( v13 )
  {
