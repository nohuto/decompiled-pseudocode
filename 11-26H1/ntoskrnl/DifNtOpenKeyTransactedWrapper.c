/*
 * XREFs of DifNtOpenKeyTransactedWrapper @ 0x14067D990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyTransactedWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtOpenKeyTransacted(
                  a1,
                  a2,
                  a3,
                  a4,
