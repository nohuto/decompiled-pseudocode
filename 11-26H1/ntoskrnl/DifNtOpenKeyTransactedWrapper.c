/*
 * XREFs of DifNtOpenKeyTransactedWrapper @ 0x140681570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyTransactedWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, void *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(798);
  ...
  DWORD2(v20) = NtOpenKeyTransacted(a1, a2, a3, a4);
  if ( v9 )
  {
