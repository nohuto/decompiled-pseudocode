...
__int64 __fastcall PoStoreRequester(__int64 a1, __int64 a2, unsigned __int64 *a3, char a4)
{
  ...
  if ( *(_DWORD *)a1 )
  {
    ...
    v13 = *(char **)(a1 + 16);
    ResultLength = *(unsigned __int16 *)(a1 + 8);
    if ( a4 )
    {
...
LABEL_30:
      ...
      v23 = (unsigned int)p_DriverName->Length + 2;
      ResultLength = p_DriverName->Length + 2;
      if ( v11 && v4 >= v23 + 40 )
      {
        v11 = 1;
        RtlStringCbCopyUnicodeString((NTSTRSAFE_PWSTR)v10, (unsigned int)v23, p_DriverName);
      }
      else
      {
        v11 = 0;
    ...
    if ( DeviceNode )
    {
      ...
      {
        v11 = 1;
        RtlStringCbCopyUnicodeString((NTSTRSAFE_PWSTR)v10, v26, (PCUNICODE_STRING)(DeviceNode + 20));
        *(_QWORD *)(a2 + 24) = &v10[-a2];
      }
      else
      {
