/*
 * XREFs of PiDmaGuardProcessUpdateConsoleLockStateAction @ 0x1407B3F44
 * Callers:
...
LABEL_31:
  ...
  if ( v11 )
  {
    ...
    return (unsigned int)PipDmgSetIommuDomainPolicyAndNotifyHal(v14, *(unsigned int *)(v12 + 40), v13);
  }
  return v2;
}
