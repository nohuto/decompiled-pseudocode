/*
 * XREFs of ExpUpdateProductSuiteTypeInRegistry @ 0x140CE493C
 * Callers:
...
LABEL_10:
  LODWORD(v38) = v5;
  v7 = NtSetValueKey((__int64)Flink, (__int64)&DestinationString_8, 0LL, 1, v39.Buffer, v38);
  if ( v7 < 0 )
  ...
  LODWORD(v38) = 760 - v1;
  result = NtSetValueKey((__int64)Flink, (__int64)&DestinationString_8, 0LL, 7, v41, v38);
  if ( (int)result < 0 )
