/*
 * XREFs of DifZwSetValueKeyWrapper @ 0x1406C05C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetValueKeyWrapper(
        void *a1,
        UNICODE_STRING *a2,
        ULONG a3,
        ULONG a4,
        ...
        ULONG DataSize)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(7);
...
LABEL_17:
  LODWORD(v23) = ZwSetValueKey(a1, a2, a3, a4, Data, DataSize);
  if ( v11 )
  {
