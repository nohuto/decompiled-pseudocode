/*
 * XREFs of DifZwOpenThreadWrapper @ 0x1406B19B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenThreadWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, CLIENT_ID *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(73);
  ...
  DWORD2(v20) = ZwOpenThread(a1, a2, a3, a4);
  if ( v9 )
  {
