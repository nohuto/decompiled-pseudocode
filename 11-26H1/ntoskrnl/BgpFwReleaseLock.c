/*
 * XREFs of BgpFwReleaseLock @ 0x1404E157C
 * Callers:
...
__int64 BgpFwReleaseLock()
{
  ...
  {
    v1 = stru_140E3EAA8.WaitBlockFill7[146];
    if ( (BYTE6(PerfGlobalGroupMask) & 1) == 0
      || (result = (unsigned int)PopHibernateInProgress, PopHibernateInProgress) )
    {
      _InterlockedAnd64(&qword_140E64FD0, 0LL);
    }
    else
    {
      result = KiReleaseSpinLockInstrumented(&qword_140E64FD0, retaddr);
    }
