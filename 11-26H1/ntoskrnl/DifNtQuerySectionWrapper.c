/*
 * XREFs of DifNtQuerySectionWrapper @ 0x1406851A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQuerySectionWrapper(ULONG_PTR a1, int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(776);
  ...
  LODWORD(v21) = NtQuerySection(a1, a5);
  if ( v10 )
  {
