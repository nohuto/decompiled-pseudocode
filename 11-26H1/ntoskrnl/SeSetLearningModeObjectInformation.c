/*
 * XREFs of SeSetLearningModeObjectInformation @ 0x140430644
 * Callers:
...
void __fastcall SeSetLearningModeObjectInformation(__int64 a1)
{
  ...
  int v13; // ecx
  struct _OBJECT_NAME_INFORMATION *v14; // rax
...
LABEL_19:
      ...
      if ( Pool2 )
      {
        ...
        v14 = (struct _OBJECT_NAME_INFORMATION *)ExAllocatePool2(0x100uLL);
        v7 = v14;
        if ( v14 )
        {
