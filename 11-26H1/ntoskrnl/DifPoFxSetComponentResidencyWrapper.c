/*
 * XREFs of DifPoFxSetComponentResidencyWrapper @ 0x1406977E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxSetComponentResidencyWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  PoFxSetComponentResidency(a1, a2, a3);
  if ( v8 )
  {
