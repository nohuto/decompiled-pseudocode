/*
 * XREFs of DifZwAlpcSendWaitReceivePortWrapper @ 0x14069F710
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  v25 = ZwAlpcSendWaitReceivePort(a1, a2, a3, a4, ReceiveMessage, BufferLength, ReceiveMessageAttributes, Timeout);
  if ( v13 )
  {
