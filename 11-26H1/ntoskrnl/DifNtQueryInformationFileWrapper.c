/*
 * XREFs of DifNtQueryInformationFileWrapper @ 0x1406867F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationFileWrapper(
        void *a1,
        ...
        FILE_INFORMATION_CLASS FileInformationClass)
{
  ...
  DWORD2(v21) = NtQueryInformationFile(a1, a2, a3, a4, FileInformationClass);
  if ( v10 )
  {
