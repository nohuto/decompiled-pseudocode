/*
 * XREFs of KiSystemStartup @ 0x140BEF640
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiInitializeKernelShadowStacks @ 0x140BFCB00 (KiInitializeKernelShadowStacks.c)
...
NTSTATUS __stdcall __noreturn KiSystemStartup(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *MK_FP(43, &CurrentThread->WaitBlockFill11[70]) = 2;
  KiIdleLoop((__int64)CurrentThread);
}
