/*
 * XREFs of ExpSetProcessorMicrocodeUpdateInformation @ 0x140833208
 * Callers:
...
__int64 __fastcall ExpSetProcessorMicrocodeUpdateInformation(unsigned int *a1, unsigned int a2, KPROCESSOR_MODE a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( _InterlockedIncrement((volatile signed __int32 *)&ExpSysDbgLock.SuspendEvent.Header.WaitListHead.Blink) != 1 )
    {
      v6 = -1073741757;
      goto LABEL_21;
    }
...
LABEL_21:
  ...
  if ( a3 && v6 != -1073741727 )
    _InterlockedDecrement((volatile signed __int32 *)&ExpSysDbgLock.SuspendEvent.Header.WaitListHead.Blink);
  return v6;
}
