/*
 * XREFs of ?StCompactRegions@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEADK1KK@Z @ 0x1403921D8
 * Callers:
...
LABEL_68:
  B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT,ST_STORE<SM_TRAITS>::ST_REGION_ENTRY_COMPARATOR>::BTreeIteratorCleanup(
    &v58,
    a1 + 64);
  if ( v46 != -1073741802 && (WORD2(stru_140E27B08.InitialStack) & 0x200) != 0 )
    SmEtwLogCompactionOp(
      (unsigned int)&stru_140E27B08.QuantumTarget,
      15,
      a1,
      v62,
      v63,
