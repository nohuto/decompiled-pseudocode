/*
 * XREFs of DifNtCreateIoRingWrapper @ 0x140674D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateIoRingWrapper(HANDLE *a1, ULONG a2, void *a3, ULONG a4, PVOID OutputParameters)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(866);
  ...
  LODWORD(v21) = NtCreateIoRing(a1, a2, a3, a4, OutputParameters);
  if ( v10 )
  {
