/*
 * XREFs of ViTargetRemovingCheckEtwWmi @ 0x140C2F880
 * Callers:
...
void __fastcall ViTargetRemovingCheckEtwWmi(__int64 a1, ULONG_PTR a2)
{
  ...
  if ( v2 && (MmVerifierData & 0x800) != 0 )
    CarReportRuleViolationFromNt(0xC4u, 0xDAuLL, a2, v2, 0LL, 11, a2);
  v5 = (_QWORD **)(a1 + 16);
  v6 = *v5;
  if ( *v5 != v5 )
  {
    ...
    {
      CarReportRuleViolationFromNt(0xC4u, 0xDDuLL, v6[3], a2, v6[2], 11, a2);
      v6 = *v5;
    }
    do
    {
