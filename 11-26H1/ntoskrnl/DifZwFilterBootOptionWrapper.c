/*
 * XREFs of DifZwFilterBootOptionWrapper @ 0x1406A9850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFilterBootOptionWrapper(
        ...
        ULONG DataSize)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(895);
  ...
  HIDWORD(v20) = ZwFilterBootOption(a1, a2, a3, a4, DataSize);
  if ( v10 )
  {
