/*
 * XREFs of DifZwRecoverEnlistmentWrapper @ 0x1406BA000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRecoverEnlistmentWrapper(HANDLE EnlistmentHandle, PVOID EnlistmentKey)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1106);
  ...
  DWORD2(v16) = ZwRecoverEnlistment(EnlistmentHandle, EnlistmentKey);
  if ( v6 )
  {
