/*
 * XREFs of PspLookupProcessQuotaBlock @ 0x140AB8E5C
 * Callers:
 ...
 *     PspHashKeyValue @ 0x140AB91FC (PspHashKeyValue.c)
 *     PspSafeReferenceQuotaBlock @ 0x140AB9360 (PspSafeReferenceQuotaBlock.c)
 */
