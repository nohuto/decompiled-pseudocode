/*
 * XREFs of DifNtAlertThreadByThreadIdExWrapper @ 0x14066EB30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlertThreadByThreadIdExWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtAlertThreadByThreadIdEx(a1, a2);
  if ( v6 )
  {
