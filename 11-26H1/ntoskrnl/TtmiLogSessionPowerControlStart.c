/*
 * XREFs of TtmiLogSessionPowerControlStart @ 0x1407EA4FC
 * Callers:
...
void __fastcall TtmiLogSessionPowerControlStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v9 = a2;
    v16 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_140050DCF, 0LL, 0LL, 5u, &v10);
  }
}
