/*
 * XREFs of CmpVirtualBranchIsReplicated @ 0x1408B7C80
 * Callers:
...
bool __fastcall CmpVirtualBranchIsReplicated(__int64 a1, _WORD *a2, char *a3)
{
  ...
  *a3 = 0;
  ...
  if ( (int)CmpBlockTwoHiveWrites(v6, v7, a3) < 0 )
    return 0;
  PathByName = CmpFindPathByNameEx(a1, a2, &v20, 0LL, &v22, &BugCheckParameter3);
  v9 = BugCheckParameter3;
  v10 = PathByName;
  if ( BugCheckParameter3
    && ((*(_BYTE *)(BugCheckParameter3 + 140) & 1) == 0
      ? (CellPaged = HvpGetCellPaged(BugCheckParameter3))
      : (CellPaged = HvpGetCellFlat(BugCheckParameter3, v22, &v23)),
        CellPaged) )
  {
    if ( v10 )
    {
