/*
 * XREFs of MiGetPerfectFreeOrZeroHugeRange @ 0x1406F0B50
 * Callers:
...
_QWORD *__fastcall MiGetPerfectFreeOrZeroHugeRange(__int64 a1, int a2, int a3)
{
  __int64 *v3; // rax
  ...
  v5[2] = v3;
  v8 = a3;
  return MiGetPerfectColorHeadHugeRange((__int64)v5);
}
