/*
 * XREFs of DifNtListenPortWrapper @ 0x14067DD50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtListenPortWrapper(HANDLE PortHandle, PPORT_MESSAGE ConnectionRequest)
{
  ...
  DWORD2(v16) = NtListenPort(PortHandle, ConnectionRequest);
  if ( v6 )
  {
