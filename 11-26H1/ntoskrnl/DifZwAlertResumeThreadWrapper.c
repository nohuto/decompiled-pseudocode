/*
 * XREFs of DifZwAlertResumeThreadWrapper @ 0x1406992B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlertResumeThreadWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwAlertResumeThread(a1, a2);
  if ( v6 )
  {
