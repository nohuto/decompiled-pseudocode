/*
 * XREFs of DifZwAlertResumeThreadWrapper @ 0x14069CE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlertResumeThreadWrapper(HANDLE ThreadHandle, PULONG PreviousSuspendCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(921);
  ...
  DWORD2(v16) = ZwAlertResumeThread(ThreadHandle, PreviousSuspendCount);
  if ( v6 )
  {
