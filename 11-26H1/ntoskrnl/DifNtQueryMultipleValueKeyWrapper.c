/*
 * XREFs of DifNtQueryMultipleValueKeyWrapper @ 0x140688220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryMultipleValueKeyWrapper(
        void *a1,
        _KEY_VALUE_ENTRY *a2,
        ULONG a3,
        void *a4,
        ...
        ULONG *RequiredBufferLength)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(803);
...
LABEL_17:
  MultipleValueKey = NtQueryMultipleValueKey(a1, a2, a3, a4, BufferLength, RequiredBufferLength);
  if ( v11 )
  {
