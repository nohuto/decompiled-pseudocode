/*
 * XREFs of DifNtProtectVirtualMemoryWrapper @ 0x1406847B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtProtectVirtualMemoryWrapper(void *a1, PVOID *a2, ULONG_PTR *a3, ULONG a4, ULONG *OldProtect)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(775);
  ...
  LODWORD(v21) = NtProtectVirtualMemory(a1, a2, a3, a4, OldProtect);
  if ( v10 )
  {
