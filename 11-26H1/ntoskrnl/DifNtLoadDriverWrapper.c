/*
 * XREFs of DifNtLoadDriverWrapper @ 0x14067DEC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLoadDriverWrapper(PUNICODE_STRING DriverServiceName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(642);
  ...
  LODWORD(v14) = NtLoadDriver(DriverServiceName);
  if ( v4 )
  {
