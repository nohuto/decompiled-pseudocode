/*
 * XREFs of wil_details_FeatureStateCache_GetCachedFeatureEnabledState @ 0x14041C460
 * Callers:
 *     wil_details_AreDependenciesEnabled @ 0x140578F10 (wil_details_AreDependenciesEnabled.c)
