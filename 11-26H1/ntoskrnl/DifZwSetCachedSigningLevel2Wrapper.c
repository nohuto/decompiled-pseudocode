/*
 * XREFs of DifZwSetCachedSigningLevel2Wrapper @ 0x1406BC8E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetCachedSigningLevel2Wrapper(
        unsigned int a1,
        char a2,
        __int64 a3,
        unsigned int a4,
        ...
        __int64 a6)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1135);
...
LABEL_17:
  LOBYTE(v10) = a2;
  LODWORD(v23) = ZwSetCachedSigningLevel2(
                   a1,
                   v10,
                   a3,
                   a4,
