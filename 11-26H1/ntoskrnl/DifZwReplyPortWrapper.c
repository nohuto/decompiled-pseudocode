/*
 * XREFs of DifZwReplyPortWrapper @ 0x1406BB0D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReplyPortWrapper(HANDLE PortHandle, PPORT_MESSAGE ReplyMessage)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(951);
  ...
  DWORD2(v16) = ZwReplyPort(PortHandle, ReplyMessage);
  if ( v6 )
  {
