/*
 * XREFs of DifNtManageHotPatchWrapper @ 0x14067ED90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtManageHotPatchWrapper(unsigned int a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(876);
  ...
  HIDWORD(v19) = NtManageHotPatch(a1, a2, a3, a4, v17, *((_QWORD *)&v17 + 1), v18, *((_QWORD *)&v18 + 1), v19);
  if ( v9 )
  {
