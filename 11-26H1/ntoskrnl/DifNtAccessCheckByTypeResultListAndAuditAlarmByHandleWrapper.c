/*
 * XREFs of DifNtAccessCheckByTypeResultListAndAuditAlarmByHandleWrapper @ 0x14066CE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAccessCheckByTypeResultListAndAuditAlarmByHandleWrapper(
        UNICODE_STRING *a1,
        void *a2,
        void *a3,
        UNICODE_STRING *a4,
...
LABEL_17:
  v47 = NtAccessCheckByTypeResultListAndAuditAlarmByHandle(
          a1,
          a2,
          a3,
          a4,
