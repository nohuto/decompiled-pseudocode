/*
 * XREFs of DifIoWMIRegistrationControlWrapper @ 0x140662E60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoWMIRegistrationControlWrapper(PDEVICE_OBJECT DeviceObject, ULONG Action)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(304);
  ...
  DWORD2(v16) = IoWMIRegistrationControl(DeviceObject, Action);
  if ( v6 )
  {
