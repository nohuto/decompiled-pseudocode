/*
 * XREFs of DifNtQueryVolumeInformationFileWrapper @ 0x14068A5F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryVolumeInformationFileWrapper(
        void *a1,
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  DWORD2(v21) = NtQueryVolumeInformationFile(a1, a2, a3, a4, FsInformationClass);
  if ( v10 )
  {
