/*
 * XREFs of CcComputeNextScanTime @ 0x1404D60DC
 * Callers:
...
char __fastcall CcComputeNextScanTime(__int64 a1, __int64 a2, __int64 *a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v9 = (_DWORD *)(a2 + 708);
    v10 = 0x9896800uLL / (unsigned int)KeMaximumIncrement;
    if ( !CcEnablePerVolumeLazyWriter )
      v9 = (_DWORD *)(v7 + 780);
    v11 = *a3;
    if ( *a3 != 0x7FFFFFFFFFFFFFFFLL
      && (__int64)(v11 + 0x9896800uLL / (unsigned int)KeMaximumIncrement) > MEMORY[0xFFFFF78000000320] )
    {
      v12 = v11 - MEMORY[0xFFFFF78000000320];
      *v9 = 0;
      *v8 = v10 + v12;
    }
    result = (char)EmpParseLock.KernelShadowStackBase;
    if ( *v9 >= LODWORD(EmpParseLock.KernelShadowStackBase) )
    {
