/*
 * XREFs of DifNtRollbackEnlistmentWrapper @ 0x14068DDB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRollbackEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(838);
  ...
  DWORD2(v16) = NtRollbackEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
