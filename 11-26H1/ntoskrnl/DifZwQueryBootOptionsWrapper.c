/*
 * XREFs of DifZwQueryBootOptionsWrapper @ 0x1406B3880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryBootOptionsWrapper(PBOOT_OPTIONS BootOptions, PULONG BootOptionsLength)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(60);
  ...
  DWORD2(v16) = ZwQueryBootOptions(BootOptions, BootOptionsLength);
  if ( v6 )
  {
