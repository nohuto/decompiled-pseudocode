/*
 * XREFs of DifZwAllocateUserPhysicalPagesExWrapper @ 0x14069D460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAllocateUserPhysicalPagesExWrapper(
        void *a1,
        unsigned __int64 *a2,
        unsigned __int64 *a3,
        MEM_EXTENDED_PARAMETER *a4,
        ULONG ExtendedParameterCount)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1081);
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v20 + 1) = a1;
    DWORD2(v18) = ExtendedParameterCount;
    *(_QWORD *)&v20 = a2;
    *((_QWORD *)&v19 + 1) = a3;
    *(_QWORD *)&v19 = a4;
  ...
  LODWORD(v21) = ZwAllocateUserPhysicalPagesEx(a1, a2, a3, a4, ExtendedParameterCount);
  if ( v10 )
  {
