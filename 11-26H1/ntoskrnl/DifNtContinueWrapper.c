/*
 * XREFs of DifNtContinueWrapper @ 0x1406732F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtContinueWrapper(PCONTEXT ContextRecord, BOOLEAN a2)
{
  ...
  DWORD2(v16) = NtContinue(ContextRecord, a2);
  if ( v6 )
  {
