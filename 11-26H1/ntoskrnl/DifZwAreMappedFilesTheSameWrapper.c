/*
 * XREFs of DifZwAreMappedFilesTheSameWrapper @ 0x14069C010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAreMappedFilesTheSameWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwAreMappedFilesTheSame(a1, a2);
  if ( v6 )
  {
