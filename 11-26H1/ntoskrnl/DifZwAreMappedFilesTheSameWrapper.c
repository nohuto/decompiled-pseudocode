/*
 * XREFs of DifZwAreMappedFilesTheSameWrapper @ 0x14069FBF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAreMappedFilesTheSameWrapper(PVOID File1MappedAsAnImage, PVOID File2MappedAsFile)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1073);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = File1MappedAsAnImage;
    *((_QWORD *)&v15 + 1) = File2MappedAsFile;
  ...
  DWORD2(v16) = ZwAreMappedFilesTheSame(File1MappedAsAnImage, File2MappedAsFile);
  if ( v6 )
  {
