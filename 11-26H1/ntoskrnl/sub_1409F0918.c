/*
 * XREFs of sub_1409F0918 @ 0x1409F0918
 * Callers:
...
__int64 __fastcall sub_1409F0918(__int64 a1, unsigned int *a2)
{
  void *v4; // rsi
  ...
  v21 = 0LL;
  Mdl[0] = 0LL;
  UserDataPagesKernelWritable = sub_1409F0AF4(v4);
...
LABEL_7:
      ...
      v32 = v17;
      v33 = v18;
      sub_14052A0B0((__int64)&v23, (char *)v4, v21, v8 & 0xFFFFFFF, *(_QWORD *)(v7 + 72), v10, v20);
