/*
 * XREFs of DifNtSetInformationCpuPartitionWrapper @ 0x14068F1A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationCpuPartitionWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
...
LABEL_17:
  v28 = NtSetInformationCpuPartition(a1, a2, a3, a4, a5, a6, a7);
  if ( v12 )
  {
