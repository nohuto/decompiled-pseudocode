/*
 * XREFs of EtwpCoverageProvEnableCallback @ 0x140B2A2C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EtwpCoverageProvEnableCallback(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  if ( dword_140E08FB8 && (byte_140E08FC8 & 1) != 0 && (qword_140E08FD0 & 1) == qword_140E08FD0 )
  {
    v4 = 1;
    if ( !EtwpCoverageCoreTracingEnabled && (unsigned int)dword_140E09044 < MEMORY[0xFFFFF7800000037C] )
    {
      if ( !dword_140E09040 )
        dword_140E09040 = TelemetryCoverageStringHashInternal(off_140E09038, v11);
      EtwTelemetryCoverageReport(&off_140E09038);
    }
  }
  else
  {
