/*
 * XREFs of DifNtRaiseExceptionWrapper @ 0x140687430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRaiseExceptionWrapper(__int64 a1, __int64 a2, char a3)
{
  ...
  LOBYTE(v8) = a3;
  LODWORD(v20) = NtRaiseException(a1, a2, v8);
  if ( v9 )
  {
