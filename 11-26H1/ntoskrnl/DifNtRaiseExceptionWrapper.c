/*
 * XREFs of DifNtRaiseExceptionWrapper @ 0x14068B010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRaiseExceptionWrapper(
        ...
        BOOLEAN FirstChance)
{
  ...
  LODWORD(v19) = NtRaiseException(ExceptionRecord, ContextRecord, FirstChance);
  if ( v8 )
  {
