/*
 * XREFs of DifZwCreateCrossVmMutantWrapper @ 0x1406A2140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateCrossVmMutantWrapper(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
        ...
        __int64 a6)
{
  ...
  unsigned int CrossVmMutant; // [rsp+68h] [rbp-8h]
  void *retaddr; // [rsp+98h] [rbp+28h]

  memset_0(&v20, 0, 0x40uLL);
  APIThunkContextById = DifGetAPIThunkContextById(1008);
...
LABEL_17:
  CrossVmMutant = ZwCreateCrossVmMutant(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
