/*
 * XREFs of DifZwSetVolumeInformationFileWrapper @ 0x1406C0770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetVolumeInformationFileWrapper(
        void *a1,
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  DWORD2(v21) = ZwSetVolumeInformationFile(a1, a2, a3, a4, FsInformationClass);
  if ( v10 )
  {
