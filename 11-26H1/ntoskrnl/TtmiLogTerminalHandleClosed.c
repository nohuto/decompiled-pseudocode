/*
 * XREFs of TtmiLogTerminalHandleClosed @ 0x1407EB1A8
 * Callers:
...
void TtmiLogTerminalHandleClosed()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v14 = 8LL;
    v16 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_140051E23, 0LL, 0LL, 6u, &v8);
  }
}
