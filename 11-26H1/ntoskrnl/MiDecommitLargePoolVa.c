/*
 * XREFs of MiDecommitLargePoolVa @ 0x1403C3720
 * Callers:
...
__int64 __fastcall MiDecommitLargePoolVa(__int64 a1, ULONG_PTR a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)(48 * v7 - 0x220000000000LL) = 0LL;
  ...
  MiRewritePteWithLockBit((signed __int64)&unk_140E37440, 0, a2, *(__int64 *)&CLFS_LSN_NULL_EXT);
  ...
  _InterlockedAdd64((volatile signed __int64 *)&stru_140E36558.Timer.Dpc, -a3);
  return result;
}
