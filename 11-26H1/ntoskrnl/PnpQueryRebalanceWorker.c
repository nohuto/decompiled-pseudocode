/*
 * XREFs of PnpQueryRebalanceWorker @ 0x1407B3D7C
 * Callers:
 *     PnpQueryRebalance @ 0x1407B3CC8 (PnpQueryRebalance.c)
 * Callees:
...
LABEL_17:
  ...
  else
  {
    if ( StopDeviceNode == 281 )
      PipSetDevNodeFlags(BugCheckParameter2, 1024LL);
    v13 = *a3;
    ...
    *(_QWORD *)v15 = v14;
    v15[3] = 4;
    PnpGetResourceRequirementsForAssignTable(v15, a2 + ((unsigned __int64)(unsigned int)(v13 + 1) << 6), &v20);
