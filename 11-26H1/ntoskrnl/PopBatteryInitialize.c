/*
 * XREFs of PopBatteryInitialize @ 0x140B0831C
 * Callers:
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v10 = (_QWORD *)(a1 + 64);
    v11 = (_QWORD *)qword_140F0FE98;
    if ( *(__int64 **)qword_140F0FE98 != &qword_140F0FE90 )
      __fastfail(3u);
    v10[1] = qword_140F0FE98;
    *v10 = &qword_140F0FE90;
    *v11 = v10;
    ++dword_140F0FE74;
    ++dword_140F0FEEC;
    result = 0;
    qword_140F0FE98 = (__int64)v10;
    byte_140F0FE78 = 1;
  }
  return result;
}
