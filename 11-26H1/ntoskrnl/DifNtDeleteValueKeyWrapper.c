/*
 * XREFs of DifNtDeleteValueKeyWrapper @ 0x140679890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDeleteValueKeyWrapper(HANDLE KeyHandle, PUNICODE_STRING ValueName)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(788);
  ...
  DWORD2(v16) = NtDeleteValueKey(KeyHandle, ValueName);
  if ( v6 )
  {
