/*
 * XREFs of MiFreeThreadFaultClusterContext @ 0x1404AB658
 * Callers:
...
LABEL_6:
  ...
  *(_QWORD *)(a2 + 40) = v5 & 0xF000000000000000uLL | 1;
  ...
  if ( v26 && ($7A85BAF4F1FA08634C1C4A3E45B775B3 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
