/*
 * XREFs of DifZwCancelSynchronousIoFileWrapper @ 0x14069C950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCancelSynchronousIoFileWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwCancelSynchronousIoFile(a1, a2, a3);
  if ( v8 )
  {
