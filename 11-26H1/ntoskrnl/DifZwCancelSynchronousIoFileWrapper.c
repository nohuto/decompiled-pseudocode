/*
 * XREFs of DifZwCancelSynchronousIoFileWrapper @ 0x1406A0530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCancelSynchronousIoFileWrapper(
        HANDLE ThreadHandle,
        ...
        PIO_STATUS_BLOCK IoStatusBlock)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(974);
  ...
  LODWORD(v19) = ZwCancelSynchronousIoFile(ThreadHandle, IoRequestToCancel, IoStatusBlock);
  if ( v8 )
  {
