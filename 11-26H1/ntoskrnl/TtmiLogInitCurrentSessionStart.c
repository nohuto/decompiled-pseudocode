/*
 * XREFs of TtmiLogInitCurrentSessionStart @ 0x140A3A314
 * Callers:
...
void TtmiLogInitCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)word_140051FA2, 0LL, 0LL, 3u, &v4);
  }
}
