/*
 * XREFs of DifNtReadOnlyEnlistmentWrapper @ 0x14068B720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReadOnlyEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(842);
  ...
  DWORD2(v16) = NtReadOnlyEnlistment(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
