/*
 * XREFs of DifZwQueryOpenSubKeysExWrapper @ 0x1406B6D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryOpenSubKeysExWrapper(OBJECT_ATTRIBUTES *a1, ULONG a2, void *a3, ULONG *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1096);
  ...
  DWORD2(v20) = ZwQueryOpenSubKeysEx(a1, a2, a3, a4);
  if ( v9 )
  {
