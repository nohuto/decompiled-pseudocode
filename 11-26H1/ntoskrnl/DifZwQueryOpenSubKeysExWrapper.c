/*
 * XREFs of DifZwQueryOpenSubKeysExWrapper @ 0x1406B3150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryOpenSubKeysExWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = ZwQueryOpenSubKeysEx(
                  a1,
                  a2,
                  a3,
                  a4,
