/*
 * XREFs of DifNtQuerySecurityObjectWrapper @ 0x1406890E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQuerySecurityObjectWrapper(
        void *a1,
        ...
        ULONG *LengthNeeded)
{
  ...
  LODWORD(v21) = NtQuerySecurityObject(a1, a2, a3, a4, LengthNeeded);
  if ( v10 )
  {
