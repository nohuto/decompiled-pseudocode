/*
 * XREFs of ?StDmCombineRegion@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x140211BB0
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmCombineRegion(__int64 a1, int a2)
{
  ...
  {
    Pool3 = (_DWORD *)ExAllocatePool3(64LL, 4096LL, 1951624563LL, &stru_140E27B08.Header.WaitListHead.Blink, 1);
    v22 = Pool3;
    v2 = Pool3;
    if ( !Pool3 )
    {
