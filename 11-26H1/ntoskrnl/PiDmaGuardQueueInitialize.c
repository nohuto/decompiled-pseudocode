/*
 * XREFs of PiDmaGuardQueueInitialize @ 0x140CC7BBC
 * Callers:
...
__int64 PiDmaGuardQueueInitialize()
{
  ...
  ExpAddResourceToSystemResourceList((struct _SINGLE_LIST_ENTRY *)&PipDgqListLock);
  ...
  qword_140F82558 = (__int64)&PipDgqListHead;
