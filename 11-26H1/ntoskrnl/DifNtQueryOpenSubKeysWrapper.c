/*
 * XREFs of DifNtQueryOpenSubKeysWrapper @ 0x1406888C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryOpenSubKeysWrapper(POBJECT_ATTRIBUTES TargetKey, PULONG HandleCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(812);
  ...
  DWORD2(v16) = NtQueryOpenSubKeys(TargetKey, HandleCount);
  if ( v6 )
  {
