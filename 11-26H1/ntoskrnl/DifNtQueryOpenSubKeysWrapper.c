/*
 * XREFs of DifNtQueryOpenSubKeysWrapper @ 0x140684CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryOpenSubKeysWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtQueryOpenSubKeys(a1, a2);
  if ( v6 )
  {
