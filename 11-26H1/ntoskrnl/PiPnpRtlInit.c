/*
 * XREFs of PiPnpRtlInit @ 0x1407A7364
 * Callers:
 ...
 *     _PnpCtxSetNtPlugPlayRoutine @ 0x140896198 (_PnpCtxSetNtPlugPlayRoutine.c)
...
__int64 __fastcall PiPnpRtlInit(unsigned int a1)
{
  ...
  qword_140F83718 = (__int64)&PiPnpRtlActiveOperations;
