/*
 * XREFs of DifZwSetUuidSeedWrapper @ 0x1406C0450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetUuidSeedWrapper(PCHAR Seed)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1025);
  ...
  LODWORD(v14) = ZwSetUuidSeed(Seed);
  if ( v4 )
  {
