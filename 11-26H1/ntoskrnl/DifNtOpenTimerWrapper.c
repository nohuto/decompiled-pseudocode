/*
 * XREFs of DifNtOpenTimerWrapper @ 0x14067F760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenTimerWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenTimer(a1, a2, a3);
  if ( v8 )
  {
