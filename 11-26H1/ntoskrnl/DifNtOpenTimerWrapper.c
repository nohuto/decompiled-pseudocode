/*
 * XREFs of DifNtOpenTimerWrapper @ 0x140683340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenTimerWrapper(
        PHANDLE TimerHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(697);
  ...
  LODWORD(v19) = NtOpenTimer(TimerHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
