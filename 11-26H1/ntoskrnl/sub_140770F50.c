/*
 * XREFs of sub_140770F50 @ 0x140770F50
 * Callers:
...
__int64 __fastcall sub_140770F50(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // r8
  unsigned int *v8; // rax
  unsigned int i; // edx
  ...
  if ( (_DWORD)v16 == 4 )
  {
    ...
    if ( !*(_QWORD *)&ExpPlatformBinaryLock.PriorityFloorSummary )
    {
      v13 = -1073741637;
      goto LABEL_82;
    }
