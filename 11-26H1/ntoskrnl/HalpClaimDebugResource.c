/*
 * XREFs of HalpClaimDebugResource @ 0x140580AE8
 * Callers:
...
__int64 __fastcall HalpClaimDebugResource(ULONG_PTR a1, __int64 a2)
{
  ...
  *(_QWORD *)a1 = HalpAddressUsageList;
  result = *(_QWORD *)&HalpDeviceBlockUnblockPushLock.Timer.Header.Lock;
  *(_DWORD *)(a1 + 8) = 1;
  *(_BYTE *)(a1 + 12) = 33;
  *(_QWORD *)(a1 + 13) = a2;
  *(_QWORD *)(a1 + 21) = 8LL;
  ...
  *(_QWORD *)(a1 + 37) = 0LL;
  ...
  if ( result && *(_BYTE *)(result + 40) == 1 )
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( result == a2 )
      {
        v4 = (unsigned __int16)word_140029F7A[2 * i];
        v5 = (unsigned int)(v4 + 48);
        HalpIDTUsageFlags[v5] = 35;
        result = 5 * v5;
        HalpIDTUsage[result] = 15;
        *(_DWORD *)&byte_140FFBC11[result] = v4;
        return result;
      }
    }
  }
