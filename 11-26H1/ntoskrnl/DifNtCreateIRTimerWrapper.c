/*
 * XREFs of DifNtCreateIRTimerWrapper @ 0x140670E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateIRTimerWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = NtCreateIRTimer(a1, a2, a3);
  if ( v8 )
  {
