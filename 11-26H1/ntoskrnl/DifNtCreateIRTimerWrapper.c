/*
 * XREFs of DifNtCreateIRTimerWrapper @ 0x140674A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateIRTimerWrapper(PHANDLE TimerHandle, PVOID Reserved, ACCESS_MASK DesiredAccess)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(702);
  ...
  LODWORD(v19) = NtCreateIRTimer(TimerHandle, Reserved, DesiredAccess);
  if ( v8 )
  {
