/*
 * XREFs of DifZwVdmControlWrapper @ 0x1406C2A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwVdmControlWrapper(VDMSERVICECLASS Service, PVOID ServiceData)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1121);
  ...
  HIDWORD(v16) = ZwVdmControl(Service, ServiceData);
  if ( v6 )
  {
