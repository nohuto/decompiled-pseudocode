/*
 * XREFs of CmpAddToHiveFileList @ 0x140B05280
 * Callers:
...
__int64 __fastcall CmpAddToHiveFileList(__int64 a1)
{
  ...
  KeyHandle = 0LL;
  if ( !*(_QWORD *)&WheapPfaLock.Timer.Header.Lock )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( _InterlockedCompareExchange64(
           (volatile signed __int64 *)&WheapPfaLock.Timer.Header.Lock,
...
LABEL_6:
    ...
    v3 = ZwSetValueKey(*(HANDLE *)&WheapPfaLock.Timer.Header.Lock, (PUNICODE_STRING)(a1 + 1864), 0, 1u, v5, DataSize);
  }
