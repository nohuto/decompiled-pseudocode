/*
 * XREFs of DifNtAllocateReserveObjectWrapper @ 0x14066EE10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAllocateReserveObjectWrapper(
        ...
        MEMORY_RESERVE_TYPE Type)
{
  ...
  LODWORD(v19) = NtAllocateReserveObject(MemoryReserveHandle, ObjectAttributes, Type);
  if ( v8 )
  {
