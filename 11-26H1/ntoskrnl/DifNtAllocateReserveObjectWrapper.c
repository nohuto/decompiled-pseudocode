/*
 * XREFs of DifNtAllocateReserveObjectWrapper @ 0x14066B230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAllocateReserveObjectWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = NtAllocateReserveObject(a1, a2, a3);
  if ( v8 )
  {
