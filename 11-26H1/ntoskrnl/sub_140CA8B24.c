/*
 * XREFs of sub_140CA8B24 @ 0x140CA8B24
 * Callers:
...
__int64 __fastcall sub_140CA8B24(__int64 a1, int a2, __int64 a3, int a4)
{
  _DWORD *v5; // rax
  ...
  *(_QWORD *)(a1 + 2296) = v5;
  *(_QWORD *)(a1 + 2288) = 0x140000000LL + (unsigned int)v5[20];
  *(_DWORD *)(a1 + 2252) = dword_140FFB740;
  *(_DWORD *)(a1 + 2256) = dword_140FFB778;
  *(_DWORD *)(a1 + 2260) = KeIstStackSize;
  if ( (_DWORD)qword_140FFB748 != 8 )
    KeBugCheckEx(__ROR4__(-402653175, 123), 4uLL, 0LL, qword_140FFB748, 8uLL);
...
LABEL_126:
          ...
          if ( v69 )
          {
            ...
            v73 = (unsigned __int64 *)qword_140FFB080;
            *(_QWORD *)(qword_140FFB080 + 5144) = (unsigned __int64)PhysicalAddress.QuadPart >> 12;
            v74 = 512;
            v75 = 512;
            v76 = IdtBase;
            v77 = IdtBase;
            ...
            v79 = (unsigned __int64 *)(qword_140FFB080 + 512);
            do
            {
              *v79++ = v76->Alignment;
            ...
            v54 = qword_140FFB080;
            *(_WORD *)(qword_140FFB080 + 68) &= ~0x8000u;
            *(_WORD *)(v54 + 64) = v54;
