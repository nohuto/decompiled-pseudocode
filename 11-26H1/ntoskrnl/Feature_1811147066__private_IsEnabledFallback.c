/*
 * XREFs of Feature_1811147066__private_IsEnabledFallback @ 0x14061C6AC
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_1811147066__private_descriptor, 0);
}
