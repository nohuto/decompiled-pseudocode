/*
 * XREFs of DifNtGetNlsSectionPtrWrapper @ 0x140679610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetNlsSectionPtrWrapper(unsigned int a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(740);
  ...
  DWORD2(v21) = NtGetNlsSectionPtr(a1, a2, a3, a4, a5);
  if ( v10 )
  {
