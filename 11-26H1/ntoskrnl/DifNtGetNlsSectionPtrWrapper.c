/*
 * XREFs of DifNtGetNlsSectionPtrWrapper @ 0x14067D1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetNlsSectionPtrWrapper(ULONG a1, ULONG a2, void *a3, PVOID *a4, ULONG *SectionSize)
{
  ...
  DWORD2(v21) = NtGetNlsSectionPtr(a1, a2, a3, a4, SectionSize);
  if ( v10 )
  {
