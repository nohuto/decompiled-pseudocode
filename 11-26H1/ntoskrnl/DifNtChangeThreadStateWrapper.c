/*
 * XREFs of DifNtChangeThreadStateWrapper @ 0x140672680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtChangeThreadStateWrapper(
        void *a1,
        void *a2,
...
LABEL_17:
  ...
  LODWORD(v25) = NtChangeThreadState(a1, a2, a3, a4, ExtendedInformationLength, Reserved);
  if ( v11 )
  {
