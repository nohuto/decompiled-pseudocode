/*
 * XREFs of DifNtChangeThreadStateWrapper @ 0x14066EAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtChangeThreadStateWrapper(ULONG_PTR a1, ULONG_PTR a2, int a3, __int64 a4, int a5, int a6)
{
...
LABEL_17:
  LODWORD(v23) = NtChangeThreadState(a1, a2, a5, a6);
  if ( v11 )
  {
