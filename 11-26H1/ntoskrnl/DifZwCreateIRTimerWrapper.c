/*
 * XREFs of DifZwCreateIRTimerWrapper @ 0x14069F290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateIRTimerWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = ZwCreateIRTimer(a1, a2, a3);
  if ( v8 )
  {
