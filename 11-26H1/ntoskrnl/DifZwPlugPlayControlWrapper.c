/*
 * XREFs of DifZwPlugPlayControlWrapper @ 0x1406AE440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPlugPlayControlWrapper(unsigned int a1, __int64 a2, unsigned int a3)
{
  ...
  HIDWORD(v18) = ZwPlugPlayControl(a1, a2, a3);
  if ( v8 )
  {
