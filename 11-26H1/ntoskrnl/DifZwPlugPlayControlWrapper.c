/*
 * XREFs of DifZwPlugPlayControlWrapper @ 0x1406B2020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwPlugPlayControlWrapper(
        ...
        ULONG PnPControlDataLength)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1100);
  ...
  HIDWORD(v18) = ZwPlugPlayControl(PnPControlClass, PnPControlData, PnPControlDataLength);
  if ( v8 )
  {
