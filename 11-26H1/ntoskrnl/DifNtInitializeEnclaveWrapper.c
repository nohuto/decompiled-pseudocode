/*
 * XREFs of DifNtInitializeEnclaveWrapper @ 0x14067DA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtInitializeEnclaveWrapper(void *a1, void *a2, void *a3, ULONG a4, ULONG *EnclaveError)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(759);
  ...
  LODWORD(v21) = NtInitializeEnclave(a1, a2, a3, a4, EnclaveError);
  if ( v10 )
  {
