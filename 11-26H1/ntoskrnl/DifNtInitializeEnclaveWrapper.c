/*
 * XREFs of DifNtInitializeEnclaveWrapper @ 0x140679E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtInitializeEnclaveWrapper(ULONG_PTR a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtInitializeEnclave(a1, a5);
  if ( v10 )
  {
