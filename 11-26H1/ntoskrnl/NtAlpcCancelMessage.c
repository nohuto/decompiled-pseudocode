/*
 * XREFs of NtAlpcCancelMessage @ 0x140ACCC30
 * Callers:
...
__int64 __fastcall NtAlpcCancelMessage(HANDLE Handle, unsigned int a2, void *a3)
{
  ...
  else
  {
    ...
    if ( (a2 & 4) != 0 )
    {
      memset(v19, 0, 20);
      if ( PreviousMode )
        RtlCopyFromUser(v19, a3, 0x14uLL);
      else
        RtlCopyVolatileMemory(v19, a3, 0x14uLL);
      *(_QWORD *)((char *)&v18 + 4) = *(_QWORD *)&v19[3];
      *((_QWORD *)&v17 + 1) = v19[1];
    }
    else if ( PreviousMode )
    {
      RtlCopyFromUser(&v17, a3, 0x20uLL);
    }
    else
    {
      RtlCopyVolatileMemory(&v17, a3, 0x20uLL);
    }
    if ( DWORD1(v18) )
    {
      Object = 0LL;
      v7 = ObReferenceObjectByHandle(Handle, 1u, AlpcPortObjectType, PreviousMode, &Object, 0LL);
      if ( v7 >= 0 )
      {
        v9 = Object;
        ...
        if ( v7 >= 0 )
        {
          ...
          if ( v12 )
          {
                  ...
                  *((_QWORD *)&v17 + 1) == v14) )
            {
              ...
              {
                v7 = AlpcpCancelMessage(v9, BugCheckParameter2, a2);
              }
            }
            else
            {
