/*
 * XREFs of RtlpComputeCrcInternal @ 0x140481430
 * Callers:
 *     IopLiveDumpWriteDumpFile @ 0x140345D88 (IopLiveDumpWriteDumpFile.c)
 *     RtlCrc64 @ 0x140481410 (RtlCrc64.c)
...
unsigned __int64 __fastcall RtlpComputeCrcInternal(unsigned __int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  char v50; // al
  unsigned __int64 v51; // [rsp+58h] [rbp+10h]
  unsigned __int64 v52; // [rsp+60h] [rbp+18h]
  unsigned __int64 v53; // [rsp+68h] [rbp+20h]
  unsigned __int64 v54; // [rsp+68h] [rbp+20h]
  ...
  if ( a2 - v8 >= 0x40 )
  {
    ...
    if ( v5 < v52 )
    {
      ...
      do
      {
        ...
        v5 += 32LL;
        v4 = crc64Map32_[BYTE5(v16) + 512] ^ crc64Map32_[BYTE4(v16) + 768] ^ crc64Map32_[BYTE3(v16) + 1024] ^ crc64Map32_[BYTE2(v16) + 1280] ^ crc64Map32_[(unsigned __int8)v16 + 1792] ^ crc64Map32_[BYTE1(v16) + 1536] ^ crc64Map32_[HIBYTE(v16)] ^ crc64Map32_[BYTE6(v16) + 256];
    ...
    v25 = v11 ^ *(_QWORD *)(v5 + 8) ^ crc64Map1_[(unsigned __int8)v24] ^ (v24 >> 8);
    ...
    v33 = v12 ^ *(_QWORD *)(v5 + 16) ^ crc64Map1_[(unsigned __int8)v32] ^ (v32 >> 8);
  ...
  if ( a2 )
  {
    ...
    {
      v9 = *(_BYTE *)(v5 + v4++);
      v6 = crc64Map1_[(unsigned __int8)(v6 ^ v9)] ^ (v6 >> 8);
    }
    while ( v4 < a2 );
  }
  return ~v6;
