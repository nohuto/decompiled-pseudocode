/*
 * XREFs of AuthzBasepQueryTokenAttributeAndValues @ 0x1402FB610
 * Callers:
...
__int64 __fastcall AuthzBasepQueryTokenAttributeAndValues(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 36) = 0;
  ...
  if ( !v1 )
  {
    TokenAttribute = AuthzBasepFindTokenAttribute(a1 + 16);
    if ( !TokenAttribute )
      return (unsigned int)-1073741275;
    *(_QWORD *)(a1 + 56) = TokenAttribute;
    *(_WORD *)(a1 + 32) = *(_WORD *)(TokenAttribute + 12);
    if ( *(_DWORD *)(TokenAttribute + 8) == 1 )
    {
      v7 = (__int64 *)(a1 + 64);
      v8 = 2;
      v9 = 0;
    ...
    {
      if ( *(_DWORD *)(TokenAttribute + 8) == 2 )
      {
        SepCopyTokenIntegrity(*(_QWORD *)(a1 + 8), &v17);
        v7 = (__int64 *)(a1 + 64);
