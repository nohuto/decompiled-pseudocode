...
__int64 PnpShutdownDevices()
{
  ...
  v10 = &v11;
  LODWORD(v9) = 10485760;
  PipSetDevNodeUserFlags((__int64)IopRootDeviceNode, 0x10u);
  while ( 2 )
  {
...
LABEL_10:
        ...
        if ( *v3 )
          goto LABEL_12;
        v3 = (_QWORD *)v3[2];
        PipSetDevNodeUserFlags((__int64)v3, 0x20u);
      }
      else
      {
        if ( (v5 & 0x10) == 0 )
...
LABEL_12:
    ...
    if ( v3 )
    {
      ...
      if ( P != (PVOID)DeviceEventEntry && _InterlockedExchangeAdd((volatile signed __int32 *)P + 16, 0xFFFFFFFF) == 1 )
        ExFreePoolWithTag(P, 0x4B706E50u);
      continue;
    }
    break;
  }
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(DeviceEventEntry + 64), 0xFFFFFFFF) == 1 )
