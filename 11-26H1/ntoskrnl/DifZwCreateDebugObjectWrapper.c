/*
 * XREFs of DifZwCreateDebugObjectWrapper @ 0x14069E710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateDebugObjectWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = ZwCreateDebugObject(
                  a1,
                  a2,
                  a3,
                  a4,
