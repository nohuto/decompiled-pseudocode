/*
 * XREFs of DifZwEnumerateTransactionObjectWrapper @ 0x1406A57A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwEnumerateTransactionObjectWrapper(
        void *a1,
        KTMOBJECT_TYPE a2,
        struct _KTMOBJECT_CURSOR *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1105);
  ...
  LODWORD(v21) = ZwEnumerateTransactionObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
