/*
 * XREFs of DifNtUpdateWnfStateDataWrapper @ 0x140694730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUpdateWnfStateDataWrapper(
        ...
        LOGICAL CheckStamp)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(744);
...
LABEL_17:
  updated = NtUpdateWnfStateData(a1, a2, a3, a4, ExplicitScope, MatchingChangeStamp, CheckStamp);
  if ( v12 )
  {
