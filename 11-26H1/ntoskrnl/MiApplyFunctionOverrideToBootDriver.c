/*
 * XREFs of MiApplyFunctionOverrideToBootDriver @ 0x140CFF854
 * Callers:
...
__int64 __fastcall MiApplyFunctionOverrideToBootDriver(ULONG_PTR BugCheckParameter2)
{
  ...
  unsigned __int64 v23; // [rsp+1F8h] [rbp-80h]
  ...
  if ( v1 != PsNtosImageBase && v1 != PsHalImageBase )
  {
    ...
    else
    {
      ...
      v19[12] = v16;
      v20 = (int)v5;
      v4 = RtlApplyFunctionOverrideFixupsToImage(v1, v3, (__int64)&stru_140E2D150.WpsFeedback, v17, (__int64)v19);
    }
