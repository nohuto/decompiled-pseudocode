/*
 * XREFs of MiInitializeKernelCfg @ 0x140CFE970
 * Callers:
...
void __fastcall MiInitializeKernelCfg(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  {
    v4 = qword_140E37BF0;
    v5 = MiReservePtes((__int64)&stru_140E36558.WaitBlockList, 0x20u, a3, a4);
    if ( !v5
      || (int)VslInitializeSecureKernelCfg(v4, (__int64)(v5 << 25) >> 16) < 0
      || (stru_140E2D150.WaitBlock[0].SparePtr = (PVOID)v4,
          stru_140E2D150.WaitBlock[0].Object = (PVOID)0x100000000000LL,
    ...
    stru_140E2D150.WaitBlock[1].WaitListEntry.Flink = 0LL;
    ...
    guard_icall_bitmap = (__int64)stru_140E2D150.WaitBlock[0].SparePtr - 0x3FFFE0000000000LL;
  }
}
