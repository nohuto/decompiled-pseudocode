/*
 * XREFs of DifNtReadRequestDataWrapper @ 0x14068B8A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReadRequestDataWrapper(
        void *a1,
        _PORT_MESSAGE *a2,
        ULONG a3,
        void *a4,
...
LABEL_17:
  v24 = NtWriteRequestData(a1, a2, a3, a4, BufferSize, NumberOfBytesWritten);
  if ( v11 )
  {
