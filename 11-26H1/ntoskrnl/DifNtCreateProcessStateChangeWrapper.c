/*
 * XREFs of DifNtCreateProcessStateChangeWrapper @ 0x140672B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateProcessStateChangeWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, int a5)
{
  ...
  LODWORD(v21) = NtCreateProcessStateChange(a1, a2, a3, a4, a5);
  if ( v10 )
  {
