/*
 * XREFs of DifNtCreateProcessStateChangeWrapper @ 0x1406766F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateProcessStateChangeWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        int a5)
{
  ...
  LODWORD(Reserved) = a5;
  LODWORD(v22) = NtCreateProcessStateChange(a1, a2, a3, a4, Reserved);
  if ( v10 )
  {
