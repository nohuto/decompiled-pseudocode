/*
 * XREFs of DifNtWriteVirtualMemoryWrapper @ 0x140695AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWriteVirtualMemoryWrapper(
        void *a1,
        void *a2,
        void *a3,
        SIZE_T a4,
        ULONG_PTR *NumberOfBytesWritten)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v12 = 0;
    *((_QWORD *)&v20 + 1) = a1;
    *((_QWORD *)&v18 + 1) = NumberOfBytesWritten;
    *(_QWORD *)&v20 = a2;
    *((_QWORD *)&v19 + 1) = a3;
    *(_QWORD *)&v19 = a4;
  ...
  LODWORD(v21) = NtWriteVirtualMemory(a1, a2, a3, a4, NumberOfBytesWritten);
  if ( v10 )
  {
