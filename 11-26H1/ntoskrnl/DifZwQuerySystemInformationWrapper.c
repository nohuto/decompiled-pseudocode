/*
 * XREFs of DifZwQuerySystemInformationWrapper @ 0x1406B4680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQuerySystemInformationWrapper(unsigned int a1, __int64 a2, unsigned int a3, __int64 a4)
{
