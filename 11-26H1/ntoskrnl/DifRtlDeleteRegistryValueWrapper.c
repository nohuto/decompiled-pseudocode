/*
 * XREFs of DifRtlDeleteRegistryValueWrapper @ 0x140699420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlDeleteRegistryValueWrapper(ULONG RelativeTo, PCWSTR Path, PCWSTR ValueName)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    DWORD2(v18) = RelativeTo;
    *(_QWORD *)&v18 = Path;
    *((_QWORD *)&v17 + 1) = ValueName;
  ...
  HIDWORD(v18) = RtlDeleteRegistryValue(RelativeTo, Path, ValueName);
  if ( v8 )
  {
