/*
 * XREFs of DifZwOpenEventPairWrapper @ 0x1406AF280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenEventPairWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1003);
  ...
  LODWORD(v19) = ZwOpenEventPair(EventPairHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
