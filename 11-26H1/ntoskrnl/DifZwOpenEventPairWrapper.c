/*
 * XREFs of DifZwOpenEventPairWrapper @ 0x1406AB6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenEventPairWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenEventPair(a1, a2, a3);
  if ( v8 )
  {
