/*
 * XREFs of DifZwSetSystemEnvironmentValueExWrapper @ 0x1406BF680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetSystemEnvironmentValueExWrapper(
        UNICODE_STRING *a1,
        const GUID *a2,
        void *a3,
        ULONG a4,
        ULONG Attributes)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(997);
  ...
  DWORD2(v21) = ZwSetSystemEnvironmentValueEx(a1, a2, a3, a4, Attributes);
  if ( v10 )
  {
