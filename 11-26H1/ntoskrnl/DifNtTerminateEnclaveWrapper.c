/*
 * XREFs of DifNtTerminateEnclaveWrapper @ 0x140693240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtTerminateEnclaveWrapper(PVOID BaseAddress, ULONG Flags)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(761);
  ...
  DWORD2(v16) = NtTerminateEnclave(BaseAddress, Flags);
  if ( v6 )
  {
