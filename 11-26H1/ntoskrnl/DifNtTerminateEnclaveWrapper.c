/*
 * XREFs of DifNtTerminateEnclaveWrapper @ 0x14068F660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtTerminateEnclaveWrapper(__int64 a1, unsigned int a2)
{
  ...
  DWORD2(v16) = NtTerminateEnclave(a1, a2);
  if ( v6 )
  {
