/*
 * XREFs of DifZwSuspendThreadWrapper @ 0x1406C10A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSuspendThreadWrapper(HANDLE ThreadHandle, PULONG PreviousSuspendCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(917);
  ...
  DWORD2(v16) = ZwSuspendThread(ThreadHandle, PreviousSuspendCount);
  if ( v6 )
  {
