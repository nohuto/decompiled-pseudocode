/*
 * XREFs of DifNtDeleteWnfStateNameWrapper @ 0x140679B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDeleteWnfStateNameWrapper(PCWNF_STATE_NAME StateName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(743);
  ...
  LODWORD(v14) = NtDeleteWnfStateName(StateName);
  if ( v4 )
  {
