/*
 * XREFs of DifZwQueryAttributesFileWrapper @ 0x1406B3430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryAttributesFileWrapper(
        ...
        PFILE_BASIC_INFORMATION FileInformation)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(980);
  ...
  DWORD2(v16) = ZwQueryAttributesFile(ObjectAttributes, FileInformation);
  if ( v6 )
  {
