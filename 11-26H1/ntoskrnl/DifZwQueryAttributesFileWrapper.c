/*
 * XREFs of DifZwQueryAttributesFileWrapper @ 0x1406AF850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryAttributesFileWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwQueryAttributesFile(a1, a2);
  if ( v6 )
  {
