/*
 * XREFs of HalpDpPostReplace @ 0x140BEDF84
 * Callers:
...
void __fastcall HalpDpPostReplace(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    {
      HalpAcpiPmRegisterRead(0, HalpDeviceBlockUnblockPushLock.SavedApcStateFill[32] >> 1, (__int64)&v8, 2u, 0LL);
      v3 = v8;
      v9 = v8;
      if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      {
        HalpAcpiPmRegisterRead(3, HalpDeviceBlockUnblockPushLock.SavedApcStateFill[32] >> 1, (__int64)&v8, 2u, 0LL);
        v3 = v8 | v9;
      }
      v9 = v3 | 0x20;
      HalpAcpiPmRegisterWrite(0, HalpDeviceBlockUnblockPushLock.SavedApcStateFill[32] >> 1, (__int64)&v9, 2u, 0LL);
      if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
        HalpAcpiPmRegisterWrite(3, HalpDeviceBlockUnblockPushLock.SavedApcStateFill[32] >> 1, (__int64)&v9, 2u, 0LL);
    }
  }
}
