/*
 * XREFs of DifNtReadFileScatterWrapper @ 0x140687760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReadFileScatterWrapper(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        __int64 a5,
        union _FILE_SEGMENT_ELEMENT *a6,
        ULONG a7,
        __int64 a8,
        __int64 a9)
{
  ...
  union _FILE_SEGMENT_ELEMENT *v25; // [rsp+78h] [rbp-31h]
...
LABEL_17:
  FileScatter = NtReadFileScatter(a1, a2, a3, a4, a5, a6, a7, a8, a9);
  if ( v14 )
  {
