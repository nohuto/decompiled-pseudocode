/*
 * XREFs of DifNtLockProductActivationKeysWrapper @ 0x14067EA90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLockProductActivationKeysWrapper(ULONG *pPrivateVer, ULONG *pSafeMode)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(814);
  ...
  DWORD2(v16) = NtLockProductActivationKeys(pPrivateVer, pSafeMode);
  if ( v6 )
  {
