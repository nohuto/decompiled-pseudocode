/*
 * XREFs of DifNtLockProductActivationKeysWrapper @ 0x14067AEB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLockProductActivationKeysWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtLockProductActivationKeys(a1, a2);
  if ( v6 )
  {
