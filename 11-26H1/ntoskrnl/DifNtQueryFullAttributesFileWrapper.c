/*
 * XREFs of DifNtQueryFullAttributesFileWrapper @ 0x140685FE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryFullAttributesFileWrapper(
        ...
        PFILE_NETWORK_OPEN_INFORMATION FileInformation)
{
  ...
  DWORD2(v16) = NtQueryFullAttributesFile(ObjectAttributes, FileInformation);
  if ( v6 )
  {
