/*
 * XREFs of DifNtQueryFullAttributesFileWrapper @ 0x140682400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryFullAttributesFileWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtQueryFullAttributesFile(a1, a2);
  if ( v6 )
  {
