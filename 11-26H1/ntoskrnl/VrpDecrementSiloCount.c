/*
 * XREFs of VrpDecrementSiloCount @ 0x140B27A30
 * Callers:
...
void __fastcall VrpDecrementSiloCount(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  v5 = (AutoBoost *)KeAbPreAcquire((__int64)&gLoadedDiffHivesLock.InitialStack, 0LL, 0LL, a4);
  v7 = _interlockedbittestandset64((volatile signed __int32 *)&gLoadedDiffHivesLock.InitialStack, 0LL);
  v8 = v5;
  if ( v7 )
  ...
  if ( !--LODWORD(WheapPfaLock.TracingPrivate[0]) )
    CmUnRegisterCallback((LARGE_INTEGER)gLoadedDiffHivesLock.StackLimit);
