/*
 * XREFs of DifZwDelayExecutionWrapper @ 0x1406A7810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDelayExecutionWrapper(BOOLEAN a1, LARGE_INTEGER *a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(993);
  ...
  HIDWORD(v16) = ZwDelayExecution(a1, a2);
  if ( v6 )
  {
