/*
 * XREFs of DownLevelGetParentLanguageName @ 0x1406D8D50
 * Callers:
...
__int64 __fastcall DownLevelGetParentLanguageName(const void *a1, char *a2)
{
  ...
  if ( !a2 )
    return 0LL;
  v3 = bsearch(a1, &off_14000DD30, 0x1B3uLL, 8uLL, (int (__cdecl *)(const void *, const void *))CompareLangName);
  if ( !v3 )
    return 0LL;
  v4 = (char *)(&off_140002460)[2 * dword_14000246C[4 * word_14003A950[(v3 - (_BYTE *)&off_14000DD30) >> 3]]];
  v5 = -1LL;
  do
    ++v5;
  while ( *(_WORD *)&v4[2 * v5] );
