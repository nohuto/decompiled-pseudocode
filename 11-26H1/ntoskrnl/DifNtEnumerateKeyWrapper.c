/*
 * XREFs of DifNtEnumerateKeyWrapper @ 0x14067A9A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtEnumerateKeyWrapper(
        void *a1,
        ULONG a2,
        KEY_INFORMATION_CLASS a3,
        void *a4,
        ULONG Length,
        ULONG *ResultLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(789);
...
LABEL_17:
  LODWORD(v23) = NtEnumerateKey(a1, a2, a3, a4, Length, ResultLength);
  if ( v11 )
  {
