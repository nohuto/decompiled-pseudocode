/*
 * XREFs of Feature_50070238__private_IsEnabledFallback @ 0x14071D634
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_50070238__private_descriptor, 0);
}
