/*
 * XREFs of DifNtGetNextThreadWrapper @ 0x14067D040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtGetNextThreadWrapper(
        void *a1,
        void *a2,
        ACCESS_MASK a3,
        ULONG a4,
...
LABEL_17:
  LODWORD(v23) = NtGetNextThread(a1, a2, a3, a4, Flags, NewThreadHandle);
  if ( v11 )
  {
