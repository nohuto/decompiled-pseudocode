/*
 * XREFs of DifZwLoadKeyExWrapper @ 0x1406A9180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwLoadKeyExWrapper(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1089);
...
LABEL_17:
  Key = ZwLoadKeyEx(a1, a2, a3, a4, a5, a6, a7, a8, v22, v23, v24, v25, v26, v27, v28, v29, v30);
  if ( v13 )
  {
