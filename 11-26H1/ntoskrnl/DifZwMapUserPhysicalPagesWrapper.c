/*
 * XREFs of DifZwMapUserPhysicalPagesWrapper @ 0x1406ADBF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwMapUserPhysicalPagesWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1079);
  ...
  LODWORD(v19) = ZwMapUserPhysicalPages(VirtualAddress, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
