/*
 * XREFs of DifZwMapUserPhysicalPagesWrapper @ 0x1406AA010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwMapUserPhysicalPagesWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwMapUserPhysicalPages(a1, a2, a3);
  if ( v8 )
  {
