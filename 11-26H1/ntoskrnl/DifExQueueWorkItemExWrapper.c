/*
 * XREFs of DifExQueueWorkItemExWrapper @ 0x140656C40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExQueueWorkItemExWrapper(ULONG_PTR a1, unsigned int a2, int a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(469);
  ...
  BYTE8(v18) = ExQueueWorkItemEx(a1, a2, a3);
  if ( v8 )
  {
