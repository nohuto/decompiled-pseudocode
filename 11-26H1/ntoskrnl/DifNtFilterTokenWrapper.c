/*
 * XREFs of DifNtFilterTokenWrapper @ 0x14067B590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFilterTokenWrapper(
        void *a1,
        ULONG a2,
        ...
        HANDLE *NewTokenHandle)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(484);
...
LABEL_17:
  v23 = NtFilterToken(a1, a2, a3, a4, RestrictedSids, NewTokenHandle);
  if ( v11 )
  {
