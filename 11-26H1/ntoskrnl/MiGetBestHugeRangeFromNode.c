/*
 * XREFs of MiGetBestHugeRangeFromNode @ 0x1406F0244
 * Callers:
...
__int64 __fastcall MiGetBestHugeRangeFromNode(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( !result )
  {
    ...
    {
      v7 = a3 & 0xFFFFFFEF;
      v8 = (unsigned __int64 *)((a1 + 13952) & -(__int64)((a3 & 0x20) != 0));
    }
    else
    {
      v8 = (unsigned __int64 *)(a1 + 13968);
      v7 = a3 | 0x10;
    }
    if ( v8 )
    {
      ...
      for ( i = 0LL; (unsigned int)i < 4; i = (unsigned int)(i + 1) )
      {
        if ( *((_QWORD *)v12 + i) )
        {
          result = MiRemoveHugeRangeAnyColor(*(_QWORD *)(a1 + 13896), a2, a3);
          if ( result )
            return result;
          break;
        }
    ...
    if ( !result )
    {
      result = MiRemoveHugeRangeAnyColor(*(_QWORD *)(a1 + 13896), a2, a3);
      if ( !result )
        return MiRemoveHugeRangeAnyColor(*(_QWORD *)(a1 + 13896), a2, v7);
    }
  }
  return result;
}
