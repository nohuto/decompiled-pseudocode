/*
 * XREFs of DifNtQueryInformationTransactionManagerWrapper @ 0x1406873B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationTransactionManagerWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(823);
  ...
  LODWORD(v21) = NtQueryInformationTransactionManager(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
