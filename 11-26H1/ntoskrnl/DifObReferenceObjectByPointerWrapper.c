/*
 * XREFs of DifObReferenceObjectByPointerWrapper @ 0x140696190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifObReferenceObjectByPointerWrapper(
        void *a1,
        ACCESS_MASK a2,
        ...
        KPROCESSOR_MODE a4)
{
  ...
  DWORD2(v20) = ObReferenceObjectByPointerWithTag(a1, a2, a3, a4, 0x746C6644u);
  if ( v9 )
  {
