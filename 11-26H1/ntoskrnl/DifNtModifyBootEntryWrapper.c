/*
 * XREFs of DifNtModifyBootEntryWrapper @ 0x14067F940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtModifyBootEntryWrapper(PBOOT_ENTRY BootEntry)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(664);
  ...
  LODWORD(v14) = NtModifyBootEntry(BootEntry);
  if ( v4 )
  {
