/*
 * XREFs of DifNtCallbackReturnWrapper @ 0x140671BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCallbackReturnWrapper(PVOID OutputBuffer, ULONG OutputLength, unsigned int Status)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(478);
  ...
  DWORD2(v18) = NtCallbackReturn(OutputBuffer, OutputLength, Status);
  if ( v8 )
  {
