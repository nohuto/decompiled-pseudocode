/*
 * XREFs of DifNtCallbackReturnWrapper @ 0x14066E010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCallbackReturnWrapper(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  DWORD2(v18) = NtCallbackReturn(a1, a2, a3);
  if ( v8 )
  {
