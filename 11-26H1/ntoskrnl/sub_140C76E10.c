/*
 * XREFs of sub_140C76E10 @ 0x140C76E10
 * Callers:
...
__int64 __fastcall sub_140C76E10(
        __int64 *a1,
        unsigned int *a2,
        unsigned int a3,
        ULONG_PTR a4,
        ...
        *(_DWORD *)(v42 + 2524) &= ~0x200000u;
        if ( v174 != *(_QWORD *)(v42 + 2688) )
        {
          ...
          *(_DWORD *)(v178 + 16) = v177;
          ...
          sub_140C7903C(v42, 0LL, v174, 256LL);
        }
      }
    }
    if ( !v220 )
        ...
        *v98 &= ~0x200000u;
        if ( v124 != *(_QWORD *)(v14 + 2688) )
        {
          ...
          *(_DWORD *)(v127 + 16) = v126;
          ...
          sub_140C7903C(v14, 0LL, v124, 256LL);
        }
      }
    }
LABEL_203:
