/*
 * XREFs of DifZwCreateSectionWrapper @ 0x1406A5760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateSectionWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        HANDLE FileHandle)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(119);
...
LABEL_17:
  Section = ZwCreateSection(a1, a2, a3, a4, SectionPageProtection, AllocationAttributes, FileHandle);
  if ( v12 )
  {
