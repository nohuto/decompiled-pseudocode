/*
 * XREFs of DifExDeleteLookasideListExWrapper @ 0x140654500
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExDeleteLookasideListExWrapper(PLOOKASIDE_LIST_EX Lookaside)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(409);
