/*
 * XREFs of CmpCommitPreparedLightWeightTransaction @ 0x1408AE814
 * Callers:
...
void __fastcall CmpCommitPreparedLightWeightTransaction(__int64 a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140E09EE8 > 5 && (qword_140E09EF8 & 1) != 0 && (qword_140E09F00 & 1) == qword_140E09F00 )
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09EE8, (unsigned __int8 *)byte_140056801, 0LL, 0LL, 2u, v8);
    ...
    *(_DWORD *)(a1 + 48) |= 4u;
    ...
    if ( (unsigned int)dword_140E09EE8 > 5 && (qword_140E09EF8 & 1) != 0 && (qword_140E09F00 & 1) == qword_140E09F00 )
    {
      ...
      v9 = &v6;
      v10 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E09EE8, (unsigned __int8 *)byte_14005678D, 0LL, 0LL, 3u, v8);
    }
  }
}
