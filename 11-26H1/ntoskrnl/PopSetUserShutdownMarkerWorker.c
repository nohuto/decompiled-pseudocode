/*
 * XREFs of PopSetUserShutdownMarkerWorker @ 0x140B55E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopSetUserShutdownMarkerWorker(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  PopOkayToQueueNextWorkItem((__int64)&stru_140F12D20.SchedulerAssistPriorityFloor);
