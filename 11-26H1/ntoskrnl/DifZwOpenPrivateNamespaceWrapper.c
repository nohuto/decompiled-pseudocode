/*
 * XREFs of DifZwOpenPrivateNamespaceWrapper @ 0x1406ACB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenPrivateNamespaceWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(907);
  ...
  DWORD2(v20) = ZwOpenPrivateNamespace(
                  a1,
                  a2,
                  a3,
                  a4,
