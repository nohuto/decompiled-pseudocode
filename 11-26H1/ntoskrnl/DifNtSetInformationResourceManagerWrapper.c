/*
 * XREFs of DifNtSetInformationResourceManagerWrapper @ 0x140690020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationResourceManagerWrapper(
        void *a1,
        ...
        ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(849);
  ...
  DWORD2(v20) = NtSetInformationResourceManager(a1, a2, a3, a4);
  if ( v9 )
  {
