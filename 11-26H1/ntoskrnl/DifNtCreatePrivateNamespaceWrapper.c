/*
 * XREFs of DifNtCreatePrivateNamespaceWrapper @ 0x1406727A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreatePrivateNamespaceWrapper(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtCreatePrivateNamespace(
                  a1,
                  a2,
                  a3,
                  a4,
