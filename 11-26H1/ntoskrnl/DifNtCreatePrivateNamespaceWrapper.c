/*
 * XREFs of DifNtCreatePrivateNamespaceWrapper @ 0x140676380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreatePrivateNamespaceWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        OBJECT_ATTRIBUTES *a3,
        _OBJECT_BOUNDARY_DESCRIPTOR *a4)
{
  ...
  DWORD2(v20) = NtCreatePrivateNamespace(a1, a2, a3, a4);
  if ( v9 )
  {
