/*
 * XREFs of DifZwCreateThreadWrapper @ 0x1406A6000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateThreadWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        BOOLEAN CreateSuspended)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(915);
...
LABEL_17:
  Thread = ZwCreateThread(a1, a2, a3, a4, ClientId, ThreadContext, InitialTeb, CreateSuspended);
  if ( v13 )
  {
