/*
 * XREFs of MiInsertUnusedSubsectionInternal @ 0x14036E724
 * Callers:
...
__int64 __fastcall MiInsertUnusedSubsectionInternal(__int64 a1, __int64 a2)
{
  ...
  v6 = 8 * v5;
  v7 = *(_QWORD *)(stru_140E2EB88.ThreadLock + 8LL * (*(_DWORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
...
LABEL_4:
  ...
  *(_QWORD *)(v7 + 2440) += v9;
  _InterlockedAdd64((volatile signed __int64 *)&stru_140E2C7D0.Header.WaitListHead.Flink, v9);
