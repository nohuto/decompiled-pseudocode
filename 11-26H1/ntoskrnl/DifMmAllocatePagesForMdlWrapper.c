/*
 * XREFs of DifMmAllocatePagesForMdlWrapper @ 0x140669E70
 * Callers:
 *     <none>
 * Callees:
        ...
        SIZE_T a4)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v11 = 0;
    *(PHYSICAL_ADDRESS *)&v19 = LowAddress;
    *((PHYSICAL_ADDRESS *)&v18 + 1) = HighAddress;
    *(PHYSICAL_ADDRESS *)&v18 = SkipBytes;
    *((_QWORD *)&v17 + 1) = a4;
  ...
  *((_QWORD *)&v19 + 1) = MmAllocatePagesForMdl(LowAddress, HighAddress, SkipBytes, a4);
  if ( v9 )
  {
