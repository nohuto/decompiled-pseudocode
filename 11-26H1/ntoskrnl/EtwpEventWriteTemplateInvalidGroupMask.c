/*
 * XREFs of EtwpEventWriteTemplateInvalidGroupMask @ 0x14082572C
 * Callers:
...
NTSTATUS __fastcall EtwpEventWriteTemplateInvalidGroupMask(__int64 a1, __int64 a2, unsigned __int16 *a3, ULONGLONG a4)
{
  ...
  v5 = EtwpEventTracingProvRegHandle;
  v6 = 2;
  ...
  while ( v7 );
  return EtwWrite(v5, &ETW_EVENT_INVALID_GROUP_MASK, 0LL, v6, &UserData);
}
