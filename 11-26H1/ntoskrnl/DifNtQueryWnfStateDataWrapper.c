/*
 * XREFs of DifNtQueryWnfStateDataWrapper @ 0x140686BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryWnfStateDataWrapper(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a6)
{
  ...
  unsigned int WnfStateData; // [rsp+68h] [rbp-8h]
  void *retaddr; // [rsp+98h] [rbp+28h]

  memset_0(&v20, 0, 0x40uLL);
  APIThunkContextById = DifGetAPIThunkContextById(746);
...
LABEL_17:
  WnfStateData = NtQueryWnfStateData(a1, a2, a3, a4, a5, a6, v20, v21, v22, v23, v24, v25, v26);
  if ( v11 )
  {
