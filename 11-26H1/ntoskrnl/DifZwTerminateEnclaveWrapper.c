/*
 * XREFs of DifZwTerminateEnclaveWrapper @ 0x1406C13C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwTerminateEnclaveWrapper(PVOID BaseAddress, ULONG Flags)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1066);
  ...
  DWORD2(v16) = ZwTerminateEnclave(BaseAddress, Flags);
  if ( v6 )
  {
