/*
 * XREFs of DifZwTerminateEnclaveWrapper @ 0x1406BD7E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwTerminateEnclaveWrapper(__int64 a1, unsigned int a2)
{
  ...
  DWORD2(v16) = ZwTerminateEnclave(a1, a2);
  if ( v6 )
  {
