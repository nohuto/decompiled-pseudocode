/*
 * XREFs of DifNtSetInformationTokenWrapper @ 0x1406904E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationTokenWrapper(void *a1, TOKEN_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(486);
  ...
  DWORD2(v20) = NtSetInformationToken(a1, a2, a3, a4);
  if ( v9 )
  {
