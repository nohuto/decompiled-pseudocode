/*
 * XREFs of DifNtUnloadKey2Wrapper @ 0x140693B50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtUnloadKey2Wrapper(POBJECT_ATTRIBUTES TargetKey, ULONG Flags)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(809);
  ...
  DWORD2(v16) = NtUnloadKey2(TargetKey, Flags);
  if ( v6 )
  {
