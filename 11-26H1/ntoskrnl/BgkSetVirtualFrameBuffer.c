/*
 * XREFs of BgkSetVirtualFrameBuffer @ 0x1405C7F00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgGetIsColorOverridden @ 0x140C55A48 (BgGetIsColorOverridden.c)
 *     BgReleaseSpinLock @ 0x140C55B70 (BgReleaseSpinLock.c)
 */
