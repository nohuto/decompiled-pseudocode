/*
 * XREFs of DifNtFilterBootOptionWrapper @ 0x1406775C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFilterBootOptionWrapper(unsigned int a1, unsigned int a2, unsigned int a3, __int64 a4, int a5)
{
  ...
  HIDWORD(v20) = NtFilterBootOption(a1, a2, a3, a4, a5);
  if ( v10 )
  {
