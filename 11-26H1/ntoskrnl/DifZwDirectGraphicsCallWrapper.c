/*
 * XREFs of DifZwDirectGraphicsCallWrapper @ 0x1406A8580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDirectGraphicsCallWrapper(unsigned int a1, __int64 a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1059);
  ...
  HIDWORD(v21) = ZwDirectGraphicsCall(a1, a2, a3, a4, a5);
  if ( v10 )
  {
