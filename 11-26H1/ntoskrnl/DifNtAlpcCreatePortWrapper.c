/*
 * XREFs of DifNtAlpcCreatePortWrapper @ 0x1406700F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreatePortWrapper(
        PHANDLE PortHandle,
        ...
        PALPC_PORT_ATTRIBUTES PortAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(594);
  ...
  LODWORD(v19) = NtAlpcCreatePort(PortHandle, ObjectAttributes, PortAttributes);
  if ( v8 )
  {
