/*
 * XREFs of DifNtAlpcCreatePortWrapper @ 0x14066C510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreatePortWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtAlpcCreatePort(a1, a2, a3);
  if ( v8 )
  {
