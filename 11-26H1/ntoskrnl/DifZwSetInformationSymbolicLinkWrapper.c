/*
 * XREFs of DifZwSetInformationSymbolicLinkWrapper @ 0x1406BA920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationSymbolicLinkWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = ZwSetInformationSymbolicLink(
                  a1,
                  a2,
                  a3,
                  a4,
