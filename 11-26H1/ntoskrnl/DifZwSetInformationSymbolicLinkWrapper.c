/*
 * XREFs of DifZwSetInformationSymbolicLinkWrapper @ 0x1406BE500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetInformationSymbolicLinkWrapper(void *a1, SYMBOLIC_LINK_INFO_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(905);
  ...
  DWORD2(v20) = ZwSetInformationSymbolicLink(a1, a2, a3, a4);
  if ( v9 )
  {
