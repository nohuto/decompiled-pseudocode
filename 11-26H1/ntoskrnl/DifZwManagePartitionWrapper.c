/*
 * XREFs of DifZwManagePartitionWrapper @ 0x1406AD720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwManagePartitionWrapper(
        void *a1,
        void *a2,
        ...
        ULONG PartitionInformationLength)
{
  ...
  LODWORD(v21) = ZwManagePartition(a1, a2, a3, a4, PartitionInformationLength);
  if ( v10 )
  {
