/*
 * XREFs of DifZwManagePartitionWrapper @ 0x1406A9B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwManagePartitionWrapper(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, int a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(908);
  ...
  LODWORD(v21) = ZwManagePartition(a1, a2, a3, a4, a5);
  if ( v10 )
  {
