/*
 * XREFs of DifZwGetCurrentProcessorNumberExWrapper @ 0x1406AB250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetCurrentProcessorNumberExWrapper(PPROCESSOR_NUMBER ProcessorNumber)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(914);
  ...
  LODWORD(v14) = ZwGetCurrentProcessorNumberEx(ProcessorNumber);
  if ( v4 )
  {
