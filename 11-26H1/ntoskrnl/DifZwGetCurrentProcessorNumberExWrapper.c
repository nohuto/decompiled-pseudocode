/*
 * XREFs of DifZwGetCurrentProcessorNumberExWrapper @ 0x1406A7670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetCurrentProcessorNumberExWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = ZwGetCurrentProcessorNumberEx(a1);
  if ( v4 )
  {
