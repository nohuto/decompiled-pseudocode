/*
 * XREFs of TtmiLogDeviceDepartedTerminalEvent @ 0x1407E8CF8
 * Callers:
...
void __fastcall TtmiLogDeviceDepartedTerminalEvent(int a1)
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    v11 = 4LL;
    v10 = &v6;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)qword_140052120, 0LL, 0LL, 4u, &v7);
  }
}
