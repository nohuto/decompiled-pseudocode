/*
 * XREFs of TtmiLogDeviceDepartedTerminalEvent @ 0x1407EE858
 * Callers:
...
void __fastcall TtmiLogDeviceDepartedTerminalEvent(int a1)
{
  ...
  if ( (unsigned int)dword_140FD68B8 > 5 && tlgKeywordOn((__int64)&dword_140FD68B8, 1LL) )
  {
    ...
    v11 = 4LL;
    v10 = &v6;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD68B8, (unsigned __int8 *)byte_140052F27, 0LL, 0LL, 4u, &v7);
  }
}
