/*
 * XREFs of DifNtAcquireProcessActivityReferenceWrapper @ 0x14066DAE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAcquireProcessActivityReferenceWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  LODWORD(v19) = NtAcquireProcessActivityReference(a1, a2, a3);
  if ( v8 )
  {
