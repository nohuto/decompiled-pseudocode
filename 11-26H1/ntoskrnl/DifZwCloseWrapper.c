/*
 * XREFs of DifZwCloseWrapper @ 0x1406A0E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCloseWrapper(HANDLE Handle)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(131);
