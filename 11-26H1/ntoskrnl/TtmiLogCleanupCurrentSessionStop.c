/*
 * XREFs of TtmiLogCleanupCurrentSessionStop @ 0x140A3A040
 * Callers:
...
void TtmiLogCleanupCurrentSessionStop()
{
  ...
  if ( (unsigned int)dword_140FD58A8 > 5 && tlgKeywordOn((__int64)&dword_140FD58A8, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD58A8, (unsigned __int8 *)byte_140051C9B, 0LL, 0LL, 3u, &v4);
  }
}
