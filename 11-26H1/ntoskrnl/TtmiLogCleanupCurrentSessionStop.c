/*
 * XREFs of TtmiLogCleanupCurrentSessionStop @ 0x1409F5C40
 * Callers:
...
void TtmiLogCleanupCurrentSessionStop()
{
  ...
  if ( (unsigned int)dword_140FD68B8 > 5 && tlgKeywordOn((__int64)&dword_140FD68B8, 1LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140FD68B8, (unsigned __int8 *)word_1400529EA, 0LL, 0LL, 3u, &v4);
  }
}
