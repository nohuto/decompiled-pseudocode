/*
 * XREFs of DifExReleaseDisownedFastResourceExclusiveWrapper @ 0x1406539F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifExReleaseDisownedFastResourceExclusiveWrapper(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  ExReleaseDisownedFastResourceExclusive(BugCheckParameter2);
  if ( v6 )
  {
