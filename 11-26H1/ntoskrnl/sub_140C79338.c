...
int __fastcall sub_140C79338(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  unsigned __int8 v64; // [rsp+40h] [rbp-58h]
  unsigned __int64 v65; // [rsp+48h] [rbp-50h]
  char v66; // [rsp+A0h] [rbp+8h]
  __int64 v67; // [rsp+A8h] [rbp+10h] BYREF
  ...
  *(_DWORD *)(a1 + 2120) += a3;
  ...
  if ( a3 >> 7 )
  {
    ...
    do
    {
      ...
      v9 = ((unsigned __int8)(((v35 * (unsigned __int128)0x7010008004002001uLL) >> 64) ^ v35) ^ (unsigned __int8)v9) & 0x3F;
      if ( !v9 )
        LOBYTE(v9) = 1;
      v36 = v60-- == 1;
      v66 = v9;
  ...
  if ( v37 >= 8 )
  {
    ...
    do
    {
      ...
      if ( *v8 == 76 && v8[1] == 0x87 && !v8[2] && v8[3] == 0x98 && v8[4] == 0xC3 && (v39 == -112 || v39 == -15) )
      {
        ...
        v42 = __rdtsc();
        v43 = __ROR8__(v42, 3);
        v44 = ((unsigned __int8)(v43 ^ v42) ^ (unsigned __int8)(((v43 ^ v42) * (unsigned __int128)0x7010008004002001uLL) >> 64)) & 3;
  ...
  if ( ((unsigned __int16)v5 & 0xFFFu) <= 0xFF8 )
  {
    ...
    if ( *v8 == 76 && v8[1] == 0x87 && !v8[2] && v8[3] == 0x98 && v8[4] == 0xC3 && (v48 == -112 || v48 == -15) )
    {
      ...
      v50 = __rdtsc();
      v51 = __ROR8__(v50, 3);
      v52 = ((unsigned __int8)(v51 ^ v50) ^ (unsigned __int8)(((v51 ^ v50) * (unsigned __int128)0x7010008004002001uLL) >> 64)) & 3;
