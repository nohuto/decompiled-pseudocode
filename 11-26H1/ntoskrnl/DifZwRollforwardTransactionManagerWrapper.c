/*
 * XREFs of DifZwRollforwardTransactionManagerWrapper @ 0x1406BC2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwRollforwardTransactionManagerWrapper(
        ...
        PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1103);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = TransactionManagerHandle;
  ...
  DWORD2(v16) = ZwRollforwardTransactionManager(TransactionManagerHandle, TmVirtualClock);
  if ( v6 )
  {
