/*
 * XREFs of PiDevCfgResetDeviceDriverSettings @ 0x140B34F1C
 * Callers:
...
LABEL_41:
    ...
    if ( v23 < 0 )
      goto LABEL_51;
    v24 = PnpOpenObjectRegKey(*(__int64 *)&PiPnpRtlCtx, (__int64)GuidString.Buffer, 2, 131097, 0, (__int64)&v32);
    v25 = v30;
    if ( v24 >= 0 )
    {
