/*
 * XREFs of DifZwQueryMutantWrapper @ 0x1406B2DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryMutantWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1006);
  ...
  LODWORD(v21) = ZwQueryMutant(a1, a2, a3, a4, a5);
  if ( v10 )
  {
