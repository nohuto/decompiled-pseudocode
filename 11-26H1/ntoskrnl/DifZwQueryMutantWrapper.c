/*
 * XREFs of DifZwQueryMutantWrapper @ 0x1406B69D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryMutantWrapper(
        void *a1,
        MUTANT_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  LODWORD(v21) = ZwQueryMutant(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
