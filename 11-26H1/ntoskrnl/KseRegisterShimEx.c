/*
 * XREFs of KseRegisterShimEx @ 0x1407BCFE0
 * Callers:
 ...
 *     KsepValidateShimProviderAndData @ 0x1407BD7F0 (KsepValidateShimProviderAndData.c)
  ...
  if ( LoadedModulesList >= 0 )
  {
    if ( (unsigned int)KsepValidateShimProviderAndData(retaddr, v22, a1) )
    {
      ...
      if ( Paged )
      {
        ...
        v13 = (AutoBoost *)KeAbPreAcquire((__int64)&stru_140E66B30, 0LL, 0LL, v11);
        v16 = v13;
        if ( _interlockedbittestandset64((volatile signed __int32 *)&stru_140E66B30, 0LL) )
          ExfAcquirePushLockExclusiveEx((unsigned __int64 *)&stru_140E66B30, v13, (__int64)&stru_140E66B30);
        if ( v16 )
        {
        ...
        if ( (unsigned int)KsepIsShimRegistered(&KseEngine, *(_QWORD *)(a1 + 8), v15, 0LL) )
        {
          ...
          v18 = ((unsigned __int8)_InterlockedExchangeAdd(
                                    ...
                                    1u)
               + 1) & 0x3F;
          *(_DWORD *)&AlpcpMessageLogLock.WaitBlockFill6[8 * v18 + 4] = -1073741771;
          *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v18) = 131304;
        ...
        else
        {
          ...
          *((_DWORD *)Paged + 7) = a3;
          Paged[4] = a4;
          v19 = (_QWORD *)qword_140E66B18;
          if ( *(_UNKNOWN **)qword_140E66B18 != &unk_140E66B10 )
            __fastfail(3u);
          *Paged = &unk_140E66B10;
          Paged[1] = v19;
          *v19 = Paged;
          qword_140E66B18 = (__int64)Paged;
          ...
          KeLeaveCriticalRegion();
          LoadedModulesList = 0;
          *(_QWORD *)(a1 + 24) = &stru_140E66B30.Header.WaitListHead;
    ...
    else
    {
      ...
      v9 = ((unsigned __int8)_InterlockedExchangeAdd(
                               ...
                               1u)
          + 1) & 0x3F;
      *(_DWORD *)&AlpcpMessageLogLock.WaitBlockFill6[8 * v9 + 4] = -1073741823;
      *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v9) = 131271;
      if ( ((__int64)stru_140E66B30.StackBase & 2) != 0 )
