/*
 * XREFs of DifZwReleaseKeyedEventWrapper @ 0x1406B6730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReleaseKeyedEventWrapper(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  ...
  LOBYTE(v9) = a3;
  DWORD2(v21) = ZwReleaseKeyedEvent(
                  a1,
                  a2,
                  v9,
                  a4,
