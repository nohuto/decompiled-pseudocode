/*
 * XREFs of DifZwReleaseKeyedEventWrapper @ 0x1406BA310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwReleaseKeyedEventWrapper(void *a1, void *a2, BOOLEAN a3, LARGE_INTEGER *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1035);
  ...
  DWORD2(v20) = ZwReleaseKeyedEvent(a1, a2, a3, a4);
  if ( v9 )
  {
