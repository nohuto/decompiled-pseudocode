/*
 * XREFs of DifZwDeleteWnfStateDataWrapper @ 0x1406A80B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteWnfStateDataWrapper(PCWNF_STATE_NAME StateName, void *ExplicitScope)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1052);
  ...
  DWORD2(v16) = ZwDeleteWnfStateData(StateName, ExplicitScope);
  if ( v6 )
  {
