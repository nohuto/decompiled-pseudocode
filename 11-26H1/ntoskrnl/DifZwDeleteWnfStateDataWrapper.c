/*
 * XREFs of DifZwDeleteWnfStateDataWrapper @ 0x1406A44D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwDeleteWnfStateDataWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwDeleteWnfStateData(a1, a2);
  if ( v6 )
  {
