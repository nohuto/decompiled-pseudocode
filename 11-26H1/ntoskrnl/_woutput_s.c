...
__int64 __fastcall woutput_s(__int64 a1, unsigned __int16 *a2, unsigned __int16 *a3)
{
  ...
  do
  {
    ...
    if ( (unsigned __int16)(v10 - v13) > 0x5Au )
      ...
      v15 = *((_BYTE *)&_lookuptable_s[-4] + v10) & 0xF;
    v9 = *((unsigned __int8 *)_lookuptable_s + (unsigned int)(v15 + v9 + 8 * v15)) >> 4;
    v54 = v9;
    if ( v9 == 8 )
      goto LABEL_201;
    if ( v9 )
...
LABEL_116:
                    ...
                    {
                      do
                        write_char_1(32LL, v35, &v55);
                      while ( v55 != -1 && v38 > 0 );
                      v37 = v66;
                      v34 = v56;
                    }
                    write_string_1(v61, v34, v35, &v55);
                    v39 = v63;
                    v40 = 0;
                    if ( v37 == 8 && v36 > 0 )
                    {
                      do
                        write_char_1(48LL, v39, &v55);
                      while ( v55 != -1 && v41 > 0 );
                      v36 = (int)v67;
                    }
                    ...
                    {
                      write_string_1(v7, (unsigned int)v12, v39, &v55);
                      v8 = v63;
LABEL_134:
                      v11 = v55;
                    }
...
LABEL_89:
          ...
          v56 &= -(v26 != 0);
          v28 = v56;
          for ( j = (wchar_t *)&v71; ; j = (wchar_t *)((char *)j - 1) )
          {
            v30 = v6--;
            if ( v30 <= 0 && !v26 )
              break;
