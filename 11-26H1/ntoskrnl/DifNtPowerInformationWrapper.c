/*
 * XREFs of DifNtPowerInformationWrapper @ 0x1406839A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPowerInformationWrapper(
        POWER_INFORMATION_LEVEL a1,
        void *a2,
        ULONG a3,
        void *a4,
        ULONG OutputBufferLength)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(653);
  ...
  HIDWORD(v21) = NtPowerInformation(a1, a2, a3, a4, OutputBufferLength);
  if ( v10 )
  {
