/*
 * XREFs of DifNtOpenEnlistmentWrapper @ 0x1406808D0
 * Callers:
 *     <none>
 * Callees:
        ...
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(831);
  ...
  LODWORD(v21) = NtOpenEnlistment(a1, a2, a3, a4, ObjectAttributes);
  if ( v10 )
  {
