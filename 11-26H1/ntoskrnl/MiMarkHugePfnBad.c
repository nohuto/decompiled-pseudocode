/*
 * XREFs of MiMarkHugePfnBad @ 0x1406EC7AC
 * Callers:
...
__int64 __fastcall MiMarkHugePfnBad(unsigned __int64 a1, int a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  v7 = 0LL;
  v8 = 0LL;
  v9 = (_BYTE *)KeAbPreAcquire((__int64)&stru_140E2EB88, 0LL, 0LL, a4);
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&stru_140E2EB88, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&stru_140E2EB88.Header.Lock, 0, (LegacyAutoBoost *)v9, &stru_140E2EB88);
  v10 = 1LL;
  if ( v9 )
  {
  ...
  v11 = v5 & 0x3FFFFF;
  v47 = v11;
  v12 = (_QWORD *)(*(_QWORD *)((char *)&stru_140E2EB88.116 + 4) + 8 * v11);
  while ( 1 )
  {
  ...
  else
  {
    ...
    while ( 1 )
    {
      v21 = (__int64 *)(*(_QWORD *)((char *)&stru_140E2EB88.116 + 4) + 8 * v11);
      ...
      if ( v8 )
      {
        ...
        RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140E2EB60, (unsigned __int64)v28, v29, (_QWORD *)v8);
        v23 |= 8uLL;
        *v21 = v23;
LABEL_56:
        v33 = a1 & 0x3FFFF;
