/*
 * XREFs of DifNtDeleteObjectAuditAlarmWrapper @ 0x140679710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDeleteObjectAuditAlarmWrapper(
        ...
        BOOLEAN GenerateOnClose)
{
  ...
  LODWORD(v19) = NtDeleteObjectAuditAlarm(SubsystemName, HandleId, GenerateOnClose);
  if ( v8 )
  {
