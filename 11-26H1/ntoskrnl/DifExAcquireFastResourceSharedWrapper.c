/*
 * XREFs of DifExAcquireFastResourceSharedWrapper @ 0x1406529C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireFastResourceSharedWrapper(__int64 *BugCheckParameter2, ULONG_PTR a2, char a3)
{
  ...
  LOBYTE(v19) = ExAcquireFastResourceShared(BugCheckParameter2, a2, a3);
  if ( v8 )
  {
