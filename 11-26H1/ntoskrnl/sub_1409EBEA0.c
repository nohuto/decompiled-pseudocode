/*
 * XREFs of sub_1409EBEA0 @ 0x1409EBEA0
 * Callers:
...
__int64 __fastcall sub_1409EBEA0(__int64 a1, _QWORD *a2, void *a3, unsigned int a4)
{
  _DWORD *v7; // rdi
  __int64 v8; // rsi
  ...
  ContextThreadInternal = sub_1409ECA74(a2, a4, v41);
  if ( ContextThreadInternal < 0 )
    goto LABEL_13;
  ContextThreadInternal = sub_1409ECE3C(a1, v41, &v34);
  if ( ContextThreadInternal < 0 )
    goto LABEL_9;
  ContextThreadInternal = sub_1409ED5D0(a1, v10, &v37);
  if ( ContextThreadInternal < 0 )
  {
    v7 = v37;
    goto LABEL_9;
...
LABEL_7:
  ...
  if ( v7[4] + 1 >= v17 )
  {
    ContextThreadInternal = sub_140B0071C(*((void **)v7 + 3), v18);
    if ( ContextThreadInternal < 0 )
      goto LABEL_24;
    v7[5] += v7[8];
  }
  ...
  *(_DWORD *)(v22 + v21 + 24) = v16;
  ++v7[4];
  ContextThreadInternal = sub_1409ED958(v8);
LABEL_24:
  if ( ContextThreadInternal < 0 )
    goto LABEL_13;
  LODWORD(v33) = v38;
  ContextThreadInternal = sub_1407764BC((__int64)v41, v8, (__int64 *)&v35, v39, v40, v33);
  if ( ContextThreadInternal < 0 )
    goto LABEL_13;
...
LABEL_13:
  if ( v7
    ...
    && (int)sub_1409ED8B0(a1, v7, 0xFFFFFFFFLL) >= 0 )
  {
