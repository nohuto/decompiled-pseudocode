/*
 * XREFs of DifNtRollbackCompleteWrapper @ 0x14068DC30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRollbackCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(843);
  ...
  DWORD2(v16) = NtRollbackComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
