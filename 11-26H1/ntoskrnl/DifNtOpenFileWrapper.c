/*
 * XREFs of DifNtOpenFileWrapper @ 0x14067D1A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NtOpenFile @ 0x1409B39F0 (NtOpenFile.c)
 */
...
LABEL_7:
  v14 = 0;
  *((_QWORD *)&v22 + 1) = a1;
  *((_QWORD *)&v20 + 1) = __PAIR64__(ShareAccess, OpenOptions);
  LODWORD(v22) = a2;
  *((_QWORD *)&v21 + 1) = a3;
  *(_QWORD *)&v21 = a4;
...
LABEL_17:
  LODWORD(v23) = NtOpenFile(a1, a2, a3, a4, ShareAccess, OpenOptions);
  if ( v11 )
  {
