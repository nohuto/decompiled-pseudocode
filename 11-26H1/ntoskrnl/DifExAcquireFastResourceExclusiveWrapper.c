/*
 * XREFs of DifExAcquireFastResourceExclusiveWrapper @ 0x1406526C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireFastResourceExclusiveWrapper(struct _KTHREAD *a1, __int64 a2, char a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(441);
  ...
  LOBYTE(v19) = ExAcquireFastResourceExclusive(a1, a2, a3);
  if ( v8 )
  {
