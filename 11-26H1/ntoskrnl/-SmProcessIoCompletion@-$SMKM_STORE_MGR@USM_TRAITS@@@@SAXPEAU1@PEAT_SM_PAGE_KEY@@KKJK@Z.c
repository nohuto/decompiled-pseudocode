/*
 * XREFs of ?SmProcessIoCompletion@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KKJK@Z @ 0x14027ECC0
 * Callers:
...
LABEL_34:
  ...
  if ( v29 && ($7A85BAF4F1FA08634C1C4A3E45B775B3 *)v28->ApcState.ApcListHead[0].Flink != &v28->152 )
