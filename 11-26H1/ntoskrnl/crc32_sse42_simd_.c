/*
 * XREFs of crc32_sse42_simd_ @ 0x14047E0AC
 * Callers:
...
__int64 __fastcall crc32_sse42_simd_(const __m128i *a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v4 >= 0x40 )
  {
    _XMM4 = _mm_load_si128((const __m128i *)&xmmword_14001A340);
    v11 = v4 >> 6;
    v4 += -64LL * (v4 >> 6);
    do
    {
  ...
  _XMM4 = _mm_load_si128((const __m128i *)&xmmword_14001A330);
  _XMM1 = _XMM2;
  __asm
  {
    pclmulqdq xmm2, xmm4, 0
  ...
  if ( v4 >= 0x10 )
  {
    ...
    {
      _XMM1 = _XMM2;
      v42 = (__m128)_mm_loadu_si128(v8++);
      __asm
      {
        pclmulqdq xmm2, xmm4, 0
        pclmulqdq xmm1, xmm4, 11h
      }
      _XMM2 = (__m128i)_mm_xor_ps(_mm_xor_ps(_XMM1, v42), _XMM2);
      --v40;
    }
    while ( v40 );
  }
