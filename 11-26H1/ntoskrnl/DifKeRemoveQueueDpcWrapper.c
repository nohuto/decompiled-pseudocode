/*
 * XREFs of DifKeRemoveQueueDpcWrapper @ 0x140667950
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeRemoveQueueDpcWrapper(int *a1)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(253);
  ...
  LOBYTE(v14) = KeRemoveQueueDpcEx(a1, 0);
  if ( v4 )
  {
