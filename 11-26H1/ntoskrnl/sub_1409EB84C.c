/*
 * XREFs of sub_1409EB84C @ 0x1409EB84C
 * Callers:
...
__int64 __fastcall sub_1409EB84C(PUCHAR pbInput, ULONG cbInput, _QWORD *a3, _DWORD *a4)
{
  int v8; // ebx
  ...
  phHash = 0LL;
  if ( stru_140E3E928.Header.WaitListHead.Blink )
  {
    v8 = BCryptCreateHash(stru_140E3E928.Header.WaitListHead.Blink, &phHash, 0LL, 0, v13, v14, v15);
    if ( v8 >= 0 )
    {
      v8 = -1073741822;
      Blink = stru_140E3E928.Header.WaitListHead.Blink;
