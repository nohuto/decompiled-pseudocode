/*
 * XREFs of MiHotPatchProcess @ 0x140870248
 * Callers:
...
__int64 __fastcall MiHotPatchProcess(__int64 a1, unsigned int a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
...
LABEL_4:
    for ( i = (__int64)MiGetFirstVad(a1); ; i = MiGetNextVad(v12) )
    {
      ...
      if ( (MiReadVadFlags(i) & 0x1C) == 8 )
      {
        ...
        {
          v18 = (*(unsigned int *)(v12 + 24) | ((unsigned __int64)*(unsigned __int8 *)(v12 + 32) << 32)) << 12;
          ...
          v10 = MiInjectThreadForHotPatch(v18, a2, v9);
