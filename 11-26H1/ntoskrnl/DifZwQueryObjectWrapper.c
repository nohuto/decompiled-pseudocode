/*
 * XREFs of DifZwQueryObjectWrapper @ 0x1406B6B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryObjectWrapper(
        void *a1,
        OBJECT_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(39);
  ...
  LODWORD(v21) = ZwQueryObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
