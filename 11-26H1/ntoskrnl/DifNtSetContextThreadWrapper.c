/*
 * XREFs of DifNtSetContextThreadWrapper @ 0x14068ACF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetContextThreadWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtSetContextThread(a1, a2);
  if ( v6 )
  {
