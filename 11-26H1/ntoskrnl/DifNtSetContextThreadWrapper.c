/*
 * XREFs of DifNtSetContextThreadWrapper @ 0x14068E8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetContextThreadWrapper(HANDLE ThreadHandle, PCONTEXT ThreadContext)
{
  ...
  DWORD2(v16) = NtSetContextThread(ThreadHandle, ThreadContext);
  if ( v6 )
  {
