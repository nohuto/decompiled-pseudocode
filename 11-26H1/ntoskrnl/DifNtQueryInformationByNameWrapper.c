/*
 * XREFs of DifNtQueryInformationByNameWrapper @ 0x1406862F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationByNameWrapper(
        ...
        FILE_INFORMATION_CLASS FileInformationClass)
{
  ...
  DWORD2(v21) = NtQueryInformationByName(a1, a2, a3, a4, FileInformationClass);
  if ( v10 )
  {
