/*
 * XREFs of DifRtlOemStringToUnicodeStringWrapper @ 0x140699A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifRtlOemStringToUnicodeStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(160);
  ...
  LODWORD(v19) = RtlOemStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  if ( v8 )
  {
