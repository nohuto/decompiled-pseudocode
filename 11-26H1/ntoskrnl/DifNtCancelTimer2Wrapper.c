/*
 * XREFs of DifNtCancelTimer2Wrapper @ 0x1406721E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCancelTimer2Wrapper(HANDLE Handle, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(706);
  ...
  DWORD2(v16) = ExpSetTimer2(Handle, 0LL, 0LL, 0LL);
  if ( v6 )
  {
