/*
 * XREFs of Feature_MachineHiveCache__private_ReportDeviceUsage @ 0x1405276FC
 * Callers:
...
__int64 Feature_MachineHiveCache__private_ReportDeviceUsage()
{
  ...
  if ( (Feature_MachineHiveCache__private_featureState & 0x10) == 0 )
  {
    ...
    wil_details_FeatureReporting_ReportUsageToService(&Feature_MachineHiveCache__private_descriptor, v1, 3LL);
