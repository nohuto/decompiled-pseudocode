/*
 * XREFs of DifZwAddDriverEntryWrapper @ 0x14069C5B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAddDriverEntryWrapper(PEFI_DRIVER_ENTRY DriverEntry, PULONG Id)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(146);
  ...
  DWORD2(v16) = ZwAddDriverEntry(DriverEntry, Id);
  if ( v6 )
  {
