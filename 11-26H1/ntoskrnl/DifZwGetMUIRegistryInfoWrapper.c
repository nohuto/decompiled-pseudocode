/*
 * XREFs of DifZwGetMUIRegistryInfoWrapper @ 0x1406A7950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetMUIRegistryInfoWrapper(unsigned int a1, __int64 a2, __int64 a3)
{
  ...
  HIDWORD(v18) = ZwGetMUIRegistryInfo(a1, a2, a3);
  if ( v8 )
  {
