/*
 * XREFs of MiInitializeBootLoadedDriverPfns @ 0x140D002A4
 * Callers:
  ...
  for ( i = *(__int64 **)(a1 + 16); i != v1; i = (__int64 *)*i )
  {
    ...
    if ( (unsigned int)MI_IS_PHYSICAL_ADDRESS(v3) )
    {
      if ( (MiFlags & 0x20000) != 0 )
        MiActOnLargeKernelHalPages(v3);
      v6 = (unsigned __int64)HIDWORD(stru_140E36558.SListFaultAddress) >> 12;
      if ( v6 )
    ...
    else
    {
      ...
      if ( v3 == PsNtosImageBase || v3 == PsHalImageBase )
        SListFaultAddress_high = HIDWORD(stru_140E36558.SListFaultAddress);
      else
        SListFaultAddress_high = (unsigned int)(LODWORD(stru_140E36558.QuantumTarget)
      ...
      if ( v3 != PsNtosImageBase && v3 != PsHalImageBase && *(_DWORD *)&stru_140E2D150.WaitBlockFill11[72] )
      {
        v5 += *(unsigned int *)&stru_140E2D150.WaitBlockFill11[72];
        MiInitializeBootLoadedDriverPfnRange(v7, *(unsigned int *)&stru_140E2D150.WaitBlockFill11[72], 0);
      }
      if ( v8 )
      {
        if ( (int)MiAcquireNonPagedResources(&MiSystemPartition, v8, 0LL, 0LL) < 0 )
          return 0LL;
        _InterlockedAdd64((volatile signed __int64 *)&stru_140E36558.320, v8);
      }
      if ( v3 != PsNtosImageBase && v3 != PsHalImageBase )
      {
        _InterlockedAdd((volatile signed __int32 *)&stru_140E36558.WaitBlockFill11[16], v5);
        _InterlockedAdd64((volatile signed __int64 *)&stru_140E36558.320, -(__int64)v5);
      }
    }
  }
  return 1LL;
