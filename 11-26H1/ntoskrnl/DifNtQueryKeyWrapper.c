/*
 * XREFs of DifNtQueryKeyWrapper @ 0x1406842E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryKeyWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
