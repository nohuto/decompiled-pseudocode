/*
 * XREFs of DifNtQueryKeyWrapper @ 0x140687EC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryKeyWrapper(void *a1, KEY_INFORMATION_CLASS a2, void *a3, ULONG a4, ULONG *ResultLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(801);
  ...
  LODWORD(v21) = NtQueryKey(a1, a2, a3, a4, ResultLength);
  if ( v10 )
  {
