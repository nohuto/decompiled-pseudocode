/*
 * XREFs of DifZwFreeUserPhysicalPagesWrapper @ 0x1406A6B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFreeUserPhysicalPagesWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwFreeUserPhysicalPages(a1, a2, a3);
  if ( v8 )
  {
