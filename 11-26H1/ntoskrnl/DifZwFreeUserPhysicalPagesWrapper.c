/*
 * XREFs of DifZwFreeUserPhysicalPagesWrapper @ 0x1406AA710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFreeUserPhysicalPagesWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1083);
  ...
  LODWORD(v19) = ZwFreeUserPhysicalPages(ProcessHandle, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
