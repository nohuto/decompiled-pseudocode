/*
 * XREFs of DifNtSetEventWrapper @ 0x14068EEC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(681);
  ...
  DWORD2(v16) = NtSetEvent(EventHandle, PreviousState);
  if ( v6 )
  {
