/*
 * XREFs of DifNtAdjustGroupsTokenWrapper @ 0x14066E250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAdjustGroupsTokenWrapper(
        void *a1,
        BOOLEAN a2,
...
LABEL_17:
  v25 = NtAdjustGroupsToken(a1, a2, a3, a4, PreviousState, ReturnLength);
  if ( v11 )
  {
