/*
 * XREFs of ?BTreeInsert@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_REGION_ENTRY_COMPARATOR@2@@@SAJPEAU1@PEAU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@PEAUSEARCH_RESULT@1@@Z @ 0x14020E020
 * Callers:
        ...
        __int64 a3)
{
  ...
  else
  {
    ...
    if ( v8 < v7 )
    {
      ...
      if ( v44 > 0xFFFFFFFF )
        return 3221225626LL;
      Pool3 = ExAllocatePool3(64LL, (unsigned int)v44, 1916890483LL, &stru_140E27B08.Header.WaitListHead.Blink, 1);
      v46 = (void *)Pool3;
      if ( !Pool3 )
        return 3221225626LL;
      v47 = 16 * *(_DWORD *)(v4 + 28);
