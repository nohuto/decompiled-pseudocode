/*
 * XREFs of sub_140C7AA80 @ 0x140C7AA80
 * Callers:
 *     <none>
 * Callees:
 *     sub_140C7903C @ 0x140C7903C (sub_140C7903C.c)
 *     KeGuardDispatchICall @ 0x140C7B6F0 (KeGuardDispatchICall.c)
 *     RtlMinimalBarrier @ 0x140C7B8AC (RtlMinimalBarrier.c)
 */

__int64 __fastcall sub_140C7AA80(__int64 a1)
{
  _DWORD *v2; // rcx
  char *v3; // rax
  int v4; // ecx
