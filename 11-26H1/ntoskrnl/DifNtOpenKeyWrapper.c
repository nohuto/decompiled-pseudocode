/*
 * XREFs of DifNtOpenKeyWrapper @ 0x14067DB20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenKeyWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(797);
  ...
  LODWORD(v19) = NtOpenKey(a1, a2, a3);
  if ( v8 )
  {
