/*
 * XREFs of DifKeInsertByKeyDeviceQueueWrapper @ 0x1406656D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeInsertByKeyDeviceQueueWrapper(
        ...
        ULONG SortKey)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(277);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = DeviceQueue;
    *(_QWORD *)&v18 = DeviceQueueEntry;
    DWORD2(v17) = SortKey;
  ...
  LOBYTE(v19) = KeInsertByKeyDeviceQueue(DeviceQueue, DeviceQueueEntry, SortKey);
  if ( v8 )
  {
