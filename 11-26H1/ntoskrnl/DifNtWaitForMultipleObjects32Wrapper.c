/*
 * XREFs of DifNtWaitForMultipleObjects32Wrapper @ 0x140691310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtWaitForMultipleObjects32Wrapper(ULONG a1, void *a2, int a3, char a4, __int64 a5)
{
  ...
  HIDWORD(v20) = NtWaitForMultipleObjects32(a1, a2, a5);
  if ( v10 )
  {
