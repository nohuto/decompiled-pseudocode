/*
 * XREFs of PopFxComponentRelationsCleanup @ 0x14046A5D4
 * Callers:
...
void __fastcall PopFxComponentRelationsCleanup(__int64 a1)
{
  ...
  while ( (unsigned __int8)PopFxNextComponentChildRelationSafe(a1, 0LL, &P) )
  {
    v4 = (char *)P;
    *((_DWORD *)P + 4) &= ~4u;
    v5 = v4 + 32;
...
LABEL_22:
  ...
  v13 = a1 + 456;
  while ( (unsigned __int8)PopFxNextParentRelationSafe(v13, 0LL, &P) )
  {
    v14 = (char *)P;
    v15 = *((_QWORD *)P + 3);
    ...
    *v16 = v16;
    if ( KxTryToAcquireSpinLock((volatile signed __int32 *)(v15 + 128)) )
    {
      ...
      *((_QWORD *)v14 + 5) = v14 + 32;
      *v19 = v19;
      KxReleaseSpinLock((PKSPIN_LOCK)(v15 + 128));
      v22 = 1;
    }
    else
    {
    ...
    KxReleaseSpinLock((PKSPIN_LOCK)v14 + 1);
    if ( v22 )
