/*
 * XREFs of MiUpdateSecurePte @ 0x1404B0E7C
 * Callers:
...
unsigned __int64 __fastcall MiUpdateSecurePte(struct _LIST_ENTRY *BugCheckParameter2, __int16 a2, _QWORD *a3)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    {
      if ( (__int64)a3[5] >= 0
        || BugCheckParameter2 < stru_140E2D150.MutantListHead.Blink
        || (result = *(_QWORD *)&stru_140E2D150.AbWaitEntryCount,
            (unsigned __int64)BugCheckParameter2 >= *(_QWORD *)&stru_140E2D150.AbWaitEntryCount) )
      {
