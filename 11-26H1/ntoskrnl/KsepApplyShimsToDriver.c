/*
 * XREFs of KsepApplyShimsToDriver @ 0x1407BD8BC
 * Callers:
    ...
    if ( (*(_DWORD *)(v9 + 28) & 4) == 0 )
    {
      if ( *(_QWORD *)(*(_QWORD *)(v9 + 16) + 40LL) )
      {
        ...
        if ( v10 < 0 )
        {
          v13 = ((unsigned __int8)_InterlockedExchangeAdd(
                                    ...
                                    1u)
               + 1) & 0x3F;
          *(_DWORD *)&AlpcpMessageLogLock.WaitBlockFill6[8 * v13 + 4] = v10;
          *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v13) = 459390;
      ...
      if ( (v11 & 0x80000000) != 0 )
      {
        v14 = ((unsigned __int8)_InterlockedExchangeAdd(
                                  ...
                                  1u)
             + 1) & 0x3F;
        *(_DWORD *)&AlpcpMessageLogLock.WaitBlockFill6[8 * v14 + 4] = v11;
        *((_DWORD *)&AlpcpMessageLogLock.WaitBlock[0].WaitListEntry.Flink + 2 * v14) = 459409;
        if ( ((__int64)stru_140E66B30.StackBase & 2) != 0 )
