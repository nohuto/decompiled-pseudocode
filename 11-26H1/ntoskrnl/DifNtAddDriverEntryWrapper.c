/*
 * XREFs of DifNtAddDriverEntryWrapper @ 0x14066E0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAddDriverEntryWrapper(PEFI_DRIVER_ENTRY DriverEntry, PULONG Id)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(671);
  ...
  DWORD2(v16) = NtAddDriverEntry(DriverEntry, Id);
  if ( v6 )
  {
