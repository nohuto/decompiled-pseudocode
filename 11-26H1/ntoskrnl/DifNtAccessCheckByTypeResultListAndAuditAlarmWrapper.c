/*
 * XREFs of DifNtAccessCheckByTypeResultListAndAuditAlarmWrapper @ 0x14066D0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAccessCheckByTypeResultListAndAuditAlarmWrapper(
        UNICODE_STRING *a1,
        void *a2,
        UNICODE_STRING *a3,
        UNICODE_STRING *a4,
...
LABEL_17:
  v45 = NtAccessCheckByTypeResultListAndAuditAlarm(
          a1,
          a2,
          a3,
          a4,
