/*
 * XREFs of DifZwSignalAndWaitForSingleObjectWrapper @ 0x1406C0A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSignalAndWaitForSingleObjectWrapper(void *a1, void *a2, BOOLEAN a3, LARGE_INTEGER *a4)
{
  ...
  DWORD2(v20) = ZwSignalAndWaitForSingleObject(a1, a2, a3, a4);
  if ( v9 )
  {
