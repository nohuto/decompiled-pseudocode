/*
 * XREFs of DifZwFlushBuffersFileExWrapper @ 0x1406A9F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFlushBuffersFileExWrapper(
        void *a1,
        ULONG a2,
        void *a3,
        ULONG a4,
        struct _IO_STATUS_BLOCK *IoStatusBlock)
{
  ...
  LODWORD(v21) = ZwFlushBuffersFileEx(a1, a2, a3, a4, IoStatusBlock);
  if ( v10 )
  {
