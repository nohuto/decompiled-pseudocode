/*
 * XREFs of MiNextPhysicallyContiguousPfnWorthTrying @ 0x1404DFDE0
 * Callers:
...
__int64 __fastcall MiNextPhysicallyContiguousPfnWorthTrying(__int64 a1, unsigned int a2, int a3, ULONG_PTR a4)
{
  ...
  if ( (v10 & 0x70000) > 0x10000
    ...
    || *(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * ((*(_QWORD *)(v9 + 40) >> 43) & 0x3FFLL)) != *(_QWORD *)(a1 + 8) )
  {
    return 0LL;
  }
