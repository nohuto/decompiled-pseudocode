/*
 * XREFs of DifZwOpenKeyedEventWrapper @ 0x1406AC4A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenKeyedEventWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenKeyedEvent(a1, a2, a3);
  if ( v8 )
  {
