/*
 * XREFs of DifZwOpenKeyedEventWrapper @ 0x1406B0080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenKeyedEventWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1034);
  ...
  LODWORD(v19) = ZwOpenKeyedEvent(KeyedEventHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
