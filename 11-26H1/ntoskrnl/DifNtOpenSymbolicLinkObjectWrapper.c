/*
 * XREFs of DifNtOpenSymbolicLinkObjectWrapper @ 0x14067F120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSymbolicLinkObjectWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenSymbolicLinkObject(a1, a2, a3);
  if ( v8 )
  {
