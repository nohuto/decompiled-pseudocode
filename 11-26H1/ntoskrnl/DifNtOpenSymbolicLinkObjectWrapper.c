/*
 * XREFs of DifNtOpenSymbolicLinkObjectWrapper @ 0x140682D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenSymbolicLinkObjectWrapper(
        PHANDLE LinkHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtOpenSymbolicLinkObject(LinkHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
