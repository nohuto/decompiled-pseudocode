/*
 * XREFs of DifIoRegisterShutdownNotificationWrapper @ 0x140661B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoRegisterShutdownNotificationWrapper(PDEVICE_OBJECT DeviceObject)
{
  ...
  LODWORD(v14) = IoRegisterShutdownNotification(DeviceObject);
  if ( v4 )
  {
