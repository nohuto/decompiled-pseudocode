/*
 * XREFs of PspUnlockProcessThreadListShared @ 0x140271060
 * Callers:
...
__int64 __fastcall PspUnlockProcessThreadListShared(__int64 a1, void *a2)
{
  ULONG_PTR v3; // rbp
  __int64 v4; // rdi
  __int64 v5; // r14
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 1504), 0LL, 17LL) != 17 )
    ExfReleasePushLockShared(a1 + 1504);
