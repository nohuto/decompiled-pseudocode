/*
 * XREFs of DifZwLockFileWrapper @ 0x1406AD0A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwLockFileWrapper(
        void *a1,
        void *a2,
        ...
        BOOLEAN ExclusiveLock)
{
  ...
  BOOLEAN v26; // [rsp+61h] [rbp-40h]
  ULONG v27; // [rsp+64h] [rbp-3Dh]
  LARGE_INTEGER *v28; // [rsp+68h] [rbp-39h]
  LARGE_INTEGER *v29; // [rsp+70h] [rbp-31h]
  ...
  APIThunkContextById = DifGetAPIThunkContextById(967);
...
LABEL_17:
  v35 = ZwLockFile(a1, a2, a3, a4, IoStatusBlock, ByteOffset, Length, Key, FailImmediately, ExclusiveLock);
  if ( v15 )
  {
