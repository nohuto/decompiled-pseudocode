/*
 * XREFs of ViMapDoubleBuffer @ 0x140C27768
 * Callers:
        ...
        char a5)
{
  ...
  if ( !a4 )
  {
    ViHalPreprocessOptions(byte_140E0EAAC, "Driver is attempting to map a 0-length transfer.", 33LL, a1, 0LL, 0LL);
    Priority = byte_140E0EAAC;
    v9 = 0LL;
