/*
 * XREFs of MmProtectDriverSection @ 0x1406E6130
 * Callers:
...
__int64 __fastcall MmProtectDriverSection(ULONG_PTR BugCheckParameter2, __int64 a2, int a3)
{
  ...
  Flink = (unsigned __int64)v7[3].Flink;
  ...
  if ( (*(_DWORD *)(v8 + 104) & 0x80000) == 0 )
  {
    ...
    v13 = RtlImageDirectoryEntryToData(*(_QWORD *)(v8 + 48), 1, 0xCu, &v30);
    if ( !v13 || !(_DWORD)v30 || v13 > v11 || v13 + (unsigned int)(v30 - 1) < v12 )
    {
      ...
      if ( v27 == (_DWORD)v14 + 1 )
      {
        if ( (v32 & 1) == 0 )
        {
          ...
          if ( (int)VslpEnterIumSecureMode(2u, 0xDFu, 0, (__int64)v40) < 0 )
            KeBugCheckEx(0x1Au, 0x901uLL, Flink, 0LL, 0LL);
        }
