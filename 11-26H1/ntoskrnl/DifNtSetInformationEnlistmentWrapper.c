/*
 * XREFs of DifNtSetInformationEnlistmentWrapper @ 0x14068F510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationEnlistmentWrapper(void *a1, ENLISTMENT_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(833);
  ...
  DWORD2(v20) = NtSetInformationEnlistment(a1, a2, a3, a4);
  if ( v9 )
  {
