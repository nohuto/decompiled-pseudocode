/*
 * XREFs of DifNtLoadKeyWrapper @ 0x14067E730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLoadKeyWrapper(POBJECT_ATTRIBUTES TargetKey, POBJECT_ATTRIBUTES SourceFile)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(793);
  ...
  DWORD2(v16) = NtLoadKey(TargetKey, SourceFile);
  if ( v6 )
  {
