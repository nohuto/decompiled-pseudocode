/*
 * XREFs of HvpBuildMapForMemoryBackedHive @ 0x14086040C
 * Callers:
 ...
 *     HvpValidateLoadedBin @ 0x140A7D8C0 (HvpValidateLoadedBin.c)
        ...
        __int64 a5)
{
  ...
  if ( inited >= 0 )
  {
    ...
    while ( v12 < v13 )
    {
      ...
      {
        if ( (a3 & 0x20000) != 0 || !BYTE2(NlsMbOemCodePageTag) && (CmpCallbackListLock.ApcStateFill[28] & 6) == 0 )
        {
          inited = -1073741492;
