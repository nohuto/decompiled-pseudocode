/*
 * XREFs of PiDevCfgEnumDeviceKeys @ 0x1409887D8
 * Callers:
...
__int64 __fastcall PiDevCfgEnumDeviceKeys(__int64 a1, __int64 a2, void *a3, int a4, char a5, __int64 a6, __int64 a7)
{
  ...
  {
    v11 = 4LL * v10;
    v12 = &(&off_140BDB640)[v11];
    if ( (a4 & *(_DWORD *)(&off_140BDB640 + v11 + 1)) == 0 )
      goto LABEL_14;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( (_DWORD)v16 == 4 )
    {
      v16 = 4LL;
LABEL_16:
      DeviceRegProp = PnpCtxOpenContextBaseKey(v17, v16, v18, 983103, (__int64)&Handle);
      goto LABEL_17;
    }
    if ( (_DWORD)v16 == 6 )
      goto LABEL_28;
...
LABEL_17:
    ...
    if ( *((_DWORD *)v12 + 3) == 7 )
    {
      v21 = *(_QWORD *)(a2 + 8);
      v26 = 78;
      DeviceRegProp = CmGetDeviceRegProp(PiPnpRtlCtx, v21, 0, 9, (__int64)&v27, (__int64)v35, (__int64)&v26, 0);
      if ( DeviceRegProp >= 0 )
      {
        if ( v27 != 1 )
        {
