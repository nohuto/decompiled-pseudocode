/*
 * XREFs of DifZwQueryInformationResourceManagerWrapper @ 0x1406B54A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationResourceManagerWrapper(
        void *a1,
        RESOURCEMANAGER_INFORMATION_CLASS a2,
        void *a3,
        ULONG a4,
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(47);
  ...
  LODWORD(v21) = ZwQueryInformationResourceManager(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
