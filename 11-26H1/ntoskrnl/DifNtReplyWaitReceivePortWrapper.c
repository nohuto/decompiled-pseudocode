/*
 * XREFs of DifNtReplyWaitReceivePortWrapper @ 0x140689600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplyWaitReceivePortWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtReplyWaitReceivePort(
                  a1,
                  a2,
                  a3,
                  a4,
