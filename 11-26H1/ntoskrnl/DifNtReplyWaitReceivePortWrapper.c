/*
 * XREFs of DifNtReplyWaitReceivePortWrapper @ 0x14068D1E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplyWaitReceivePortWrapper(void *a1, PVOID *a2, _PORT_MESSAGE *a3, _PORT_MESSAGE *a4)
{
  ...
  DWORD2(v20) = NtReplyWaitReceivePort(a1, a2, a3, a4);
  if ( v9 )
  {
