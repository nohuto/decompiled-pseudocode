/*
 * XREFs of DifNtCreateCrossVmMutantWrapper @ 0x140673B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateCrossVmMutantWrapper(__int64 a1, int a2, __int64 a3, int a4, __int64 a5, __int64 a6)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(690);
...
LABEL_17:
  CrossVmMutant = NtCreateCrossVmMutant(a1, a2, a3, a4, a5, a6);
  if ( v11 )
  {
