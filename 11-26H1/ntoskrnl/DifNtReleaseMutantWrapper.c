/*
 * XREFs of DifNtReleaseMutantWrapper @ 0x14068C280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReleaseMutantWrapper(HANDLE MutantHandle, PLONG PreviousCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(689);
  ...
  DWORD2(v16) = NtReleaseMutant(MutantHandle, PreviousCount);
  if ( v6 )
  {
