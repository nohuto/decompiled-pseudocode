/*
 * XREFs of SecureDump_ValidateAmeCertChain @ 0x1405D7424
 * Callers:
 ...
 *     MincryptGetLeafKeyFromPolicy @ 0x1408A3CB0 (MincryptGetLeafKeyFromPolicy.c)
 *     MincryptGetRootKeyFromPolicy @ 0x1408A3CE0 (MincryptGetRootKeyFromPolicy.c)
 */
