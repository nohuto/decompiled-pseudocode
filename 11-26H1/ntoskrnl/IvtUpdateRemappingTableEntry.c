...
char __fastcall IvtUpdateRemappingTableEntry(__int64 a1, char a2, unsigned int a3, _DWORD *a4)
{
  ...
  ULONG_PTR v15; // [rsp+38h] [rbp-18h]
  ULONG_PTR BugCheckParameter4; // [rsp+40h] [rbp-10h] BYREF
  ULONG_PTR v17; // [rsp+48h] [rbp-8h]
  ...
  if ( (v8 & 0x10) != 0 )
  {
    ...
    BugCheckParameter3 = ((unsigned __int64)(unsigned int)a4[12] << 16) ^ (v12 ^ ((unsigned __int64)(unsigned int)a4[12] << 16)) & 0xFFFFFFFFFF00FFFFuLL;
    if ( a2 )
