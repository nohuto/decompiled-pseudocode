/*
 * XREFs of Xp10BuildHuffmanDecodeTable @ 0x14080B778
 * Callers:
            ...
            do
            {
              ...
              if ( v41 > 8 )
              {
                ...
                do
                {
                  ...
                  v31 -= 8;
                  v32 >>= 8;
                  v33 = *((unsigned __int8 *)qword_140035910 + v34) | (v33 << 8);
                  --v25;
                }
                while ( v25 );
              }
              if ( v31 )
                v33 = (*((unsigned __int8 *)qword_140035910 + (unsigned __int8)v32) | (v33 << 8)) >> (8 - v31);
