/*
 * XREFs of DifIoGetDmaAdapterWrapper @ 0x140660300
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG NumberOfMapRegisters)
{
  ...
  struct _DMA_ADAPTER *DmaAdapter; // [rsp+40h] [rbp-10h]
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = PhysicalDeviceObject;
    *(_QWORD *)&v18 = DeviceDescription;
    *((_QWORD *)&v17 + 1) = NumberOfMapRegisters;
