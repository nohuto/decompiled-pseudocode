/*
 * XREFs of ConvertDevpropcompkeyToString @ 0x140A3D128
 * Callers:
...
__int64 __fastcall ConvertDevpropcompkeyToString(__int64 a1, wchar_t *a2, __int64 a3, unsigned int *a4)
{
  size_t v4; // rbp
  int v8; // eax
  void *v9; // rsi
  ...
  if ( (unsigned int)a3 >= 2 )
    *a2 = 0;
  LOBYTE(a3) = 1;
  v8 = RtlStringFromGUIDEx(a1, &v20, a3);
  ...
  if ( v8 >= 0 )
  {
    ...
    v15 = (unsigned __int16)v20 + v12 + v14;
    if ( a4 )
      *a4 = v15;
    ...
    else
    {
      ...
      if ( v11 )
        v17 = L"User";
      v10 = RtlStringCbPrintfExW(a2, v4, 0LL, 0LL, 0x800u, L"[(%s %3d) %s %s]", v9, *(_DWORD *)(a1 + 16), v17, v16);
    }
  }
LABEL_16:
  if ( v9 )
