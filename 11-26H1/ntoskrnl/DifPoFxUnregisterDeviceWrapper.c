/*
 * XREFs of DifPoFxUnregisterDeviceWrapper @ 0x140697DB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifPoFxUnregisterDeviceWrapper(__int64 a1)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(179);
