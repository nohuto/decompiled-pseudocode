/*
 * XREFs of IopSetEaOrQuotaInformationFile @ 0x140795248
 * Callers:
        ...
        char a5)
{
  ...
  ULONG Flags; // eax
  ULONG v33; // eax
  struct _FILE_QUOTA_INFORMATION *Pool2; // rdi
  NTSTATUS v35; // eax
  __int64 v36; // r9
  bool v37; // zf
  PMDL Mdl; // rcx
...
LABEL_19:
        ...
        if ( (Flags & 4) != 0 )
        {
          ...
          if ( a4 )
          {
            Pool2 = (struct _FILE_QUOTA_INFORMATION *)ExAllocatePool2(0x63uLL);
