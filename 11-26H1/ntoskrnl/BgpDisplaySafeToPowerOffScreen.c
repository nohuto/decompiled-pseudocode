/*
 * XREFs of BgpDisplaySafeToPowerOffScreen @ 0x140717E40
 * Callers:
...
__int64 BgpDisplaySafeToPowerOffScreen()
{
  ...
  v2 = 21LL * DisplayType;
  *(_DWORD *)(*(_QWORD *)(*(_QWORD *)&stru_140E3E928.Timer.Processor + 24LL) + 40LL) = -16777216;
  BgpClearScreen(0xFF000000);
  BcpSetCursorPosition(dword_140E0F020[v2 + 4], dword_140E0F020[v2 + 5], &dword_140E0F020[v2 + 5]);
  BcpDisplayCriticalString(&stru_140E3E928.Timer.TimerListEntry.Blink, *(_DWORD *)(v2 * 4 + v3 + 8), v4, DisplayType);
  return 0LL;
}
