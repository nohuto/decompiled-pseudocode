/*
 * XREFs of MiReserveBootDriverPtes @ 0x140CF4994
 * Callers:
...
__int64 __fastcall MiReserveBootDriverPtes(__int64 a1, int a2)
{
  ...
  if ( v4 == PsNtosImageBase || v4 == PsHalImageBase )
    v5 = (HIDWORD(stru_140E36558.SListFaultAddress) >> 12) + ((WORD2(stru_140E36558.SListFaultAddress) & 0xFFF) != 0);
  else
    v5 = *(_DWORD *)&stru_140E2D150.WaitBlockFill11[72]
  ...
  SystemArgument1 = (const void **)stru_140E2D150.SchedulerApc.SystemArgument1;
  ...
  {
    v15 = *((_DWORD *)stru_140E2D150.SchedulerApc.SystemArgument1 + 4);
    v16 = ((a1 - *((_QWORD *)stru_140E2D150.SchedulerApc.SystemArgument1 + 1)) >> 3) / 16;
    if ( (int)v12 + (int)v16 <= v15 )
    {
      RtlSetBits((PRTL_BITMAP)stru_140E2D150.SchedulerApc.SystemArgument1 + 1, v16, v12);
      if ( v7 )
        *((_DWORD *)SystemArgument1 + 9) |= 2u;
      return 1LL;
    }
    if ( (unsigned int)v16 < v15 )
      v13 = *((_QWORD *)stru_140E2D150.SchedulerApc.SystemArgument1 + 1);
    else
      SystemArgument1 = 0LL;
  }
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v19->SizeOfBitMap = stru_140E2D150.SchedulerApc.SystemArgument1;
    result = 1LL;
    stru_140E2D150.SchedulerApc.SystemArgument1 = v19;
  }
  return result;
}
