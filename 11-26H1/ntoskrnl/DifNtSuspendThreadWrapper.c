/*
 * XREFs of DifNtSuspendThreadWrapper @ 0x14068F340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSuspendThreadWrapper(ULONG_PTR BugCheckParameter1, __int64 a2)
{
  ...
  DWORD2(v16) = NtSuspendThread(BugCheckParameter1);
  if ( v6 )
  {
