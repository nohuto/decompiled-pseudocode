/*
 * XREFs of DifNtSuspendThreadWrapper @ 0x140692F20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSuspendThreadWrapper(HANDLE ThreadHandle, PULONG PreviousSuspendCount)
{
  ...
  DWORD2(v16) = NtSuspendThread(ThreadHandle, PreviousSuspendCount);
  if ( v6 )
  {
