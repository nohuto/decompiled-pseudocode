/*
 * XREFs of DifNtRenameTransactionManagerWrapper @ 0x14068CA40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRenameTransactionManagerWrapper(
        ...
        LPGUID ExistingTransactionManagerGuid)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(821);
  ...
  DWORD2(v16) = NtRenameTransactionManager(LogFileName, ExistingTransactionManagerGuid);
  if ( v6 )
  {
