/*
 * XREFs of DifZwUnloadKeyWrapper @ 0x1406C1FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwUnloadKeyWrapper(POBJECT_ATTRIBUTES TargetKey)
{
  ...
  LODWORD(v14) = ZwUnloadKey(TargetKey);
  if ( v4 )
  {
