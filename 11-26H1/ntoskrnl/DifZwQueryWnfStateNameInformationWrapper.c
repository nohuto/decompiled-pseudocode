/*
 * XREFs of DifZwQueryWnfStateNameInformationWrapper @ 0x1406B8D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryWnfStateNameInformationWrapper(
        ...
        ULONG InfoBufferSize)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1054);
  ...
  LODWORD(v21) = ZwQueryWnfStateNameInformation(a1, a2, a3, a4, InfoBufferSize);
  if ( v10 )
  {
