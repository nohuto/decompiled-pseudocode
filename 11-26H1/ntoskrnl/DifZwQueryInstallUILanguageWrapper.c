/*
 * XREFs of DifZwQueryInstallUILanguageWrapper @ 0x1406B22E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInstallUILanguageWrapper(__int64 a1)
{
  ...
  LODWORD(v14) = ZwQueryInstallUILanguage(a1);
  if ( v4 )
  {
