/*
 * XREFs of DifZwOpenIoCompletionWrapper @ 0x1406ABB50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenIoCompletionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwOpenIoCompletion(a1, a2, a3);
  if ( v8 )
  {
