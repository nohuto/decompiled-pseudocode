/*
 * XREFs of DifZwOpenIoCompletionWrapper @ 0x1406AF730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenIoCompletionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(984);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = IoCompletionHandle;
  ...
  LODWORD(v19) = ZwOpenIoCompletion(IoCompletionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
