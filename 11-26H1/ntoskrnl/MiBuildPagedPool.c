/*
 * XREFs of MiBuildPagedPool @ 0x140CF9A9C
 * Callers:
...
__int64 MiBuildPagedPool()
{
  ...
  v1 = v0 >> 12;
  stru_140E36558.WaitStatus = v1;
  AnyMultiplexedVm = MiGetAnyMultiplexedVm(3);
  v3 = &qword_140E37800;
  if ( (*((_DWORD *)AnyMultiplexedVm + 46) & 0xF) != 1 )
    v3 = (__int64 *)(AnyMultiplexedVm + 192);
  *v3 = (__int64)&unk_140E2C640;
  if ( (int)MiInitializeSystemWorkingSetList((__int64)&MiSystemPartition, (__int64)AnyMultiplexedVm, 2, v1) < 0 )
    return 0LL;
  stru_140E36558.ApcState.ApcListHead[1].Blink = (struct _LIST_ENTRY *)stru_140E36558.WaitStatus;
  stru_140E36558.ApcState.ApcListHead[1].Flink = 0LL;
  qword_140E2C5A0 = 7680LL;
  if ( v1 < 0x9600 )
    qword_140E2C5A0 = v1 / 5;
  v4 = 2 * v1;
  qword_140E2C5A8 = 15360LL;
  if ( v4 < 0x12C00 )
    qword_140E2C5A8 = v4 / 5;
  return 1LL;
}
