/*
 * XREFs of DifNtSetBootEntryOrderWrapper @ 0x14068A6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetBootEntryOrderWrapper(volatile void *Address, int a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(667);
  ...
  DWORD2(v16) = NtSetBootEntryOrder(Address);
  if ( v6 )
  {
