/*
 * XREFs of DifNtSetBootEntryOrderWrapper @ 0x14068E2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetBootEntryOrderWrapper(PULONG Ids, ULONG Count)
{
  ...
  DWORD2(v16) = NtSetBootEntryOrder(Ids, Count);
  if ( v6 )
  {
