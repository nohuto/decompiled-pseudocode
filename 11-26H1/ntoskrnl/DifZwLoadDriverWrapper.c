/*
 * XREFs of DifZwLoadDriverWrapper @ 0x1406AC6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwLoadDriverWrapper(PUNICODE_STRING DriverServiceName)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(94);
  ...
  LODWORD(v14) = ZwLoadDriver(DriverServiceName);
  if ( v4 )
  {
