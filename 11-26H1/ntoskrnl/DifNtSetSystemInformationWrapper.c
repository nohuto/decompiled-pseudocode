/*
 * XREFs of DifNtSetSystemInformationWrapper @ 0x14068DA90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemInformationWrapper(unsigned int a1, __int64 a2, unsigned int a3)
{
  ...
  HIDWORD(v18) = NtSetSystemInformation(a1, a2, a3);
  if ( v8 )
  {
