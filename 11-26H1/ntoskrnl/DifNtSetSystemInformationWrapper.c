/*
 * XREFs of DifNtSetSystemInformationWrapper @ 0x140691670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemInformationWrapper(
        ...
        ULONG SystemInformationLength)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(726);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    DWORD2(v18) = SystemInformationClass;
    *(_QWORD *)&v18 = SystemInformation;
    DWORD2(v17) = SystemInformationLength;
  ...
  HIDWORD(v18) = NtSetSystemInformation(SystemInformationClass, SystemInformation, SystemInformationLength);
  if ( v8 )
  {
