/*
 * XREFs of IvtUpdateInterruptDestination @ 0x1404BB220
 * Callers:
...
LABEL_7:
  ...
  *BugCheckParameter3 = (unsigned int)*BugCheckParameter3 | (((unsigned int)BugCheckParameter4[3] | (unsigned __int64)(unsigned int)(BugCheckParameter4[2] << 16)) << 32);
