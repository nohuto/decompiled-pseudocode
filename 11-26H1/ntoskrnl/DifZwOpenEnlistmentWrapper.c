/*
 * XREFs of DifZwOpenEnlistmentWrapper @ 0x1406AF0D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenEnlistmentWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        void *a3,
        GUID *a4,
        OBJECT_ATTRIBUTES *ObjectAttributes)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(87);
  ...
  LODWORD(v21) = ZwOpenEnlistment(a1, a2, a3, a4, ObjectAttributes);
  if ( v10 )
  {
