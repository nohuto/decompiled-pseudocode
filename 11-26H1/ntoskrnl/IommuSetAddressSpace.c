/*
 * XREFs of IommuSetAddressSpace @ 0x14059CC00
 * Callers:
...
__int64 __fastcall IommuSetAddressSpace(__int64 a1, __int64 a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 8);
  v4 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&IommuInterfaceStateChangeCallbackPushLock.StateSaveArea);
  v9 = v4;
  ...
  KeReleaseSpinLock((PKSPIN_LOCK)&IommuInterfaceStateChangeCallbackPushLock.StateSaveArea, v4);
  return 0LL;
}
