/*
 * XREFs of DifIoGetDeviceObjectPointerWrapper @ 0x140660000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoGetDeviceObjectPointerWrapper(
        UNICODE_STRING *a1,
        ACCESS_MASK a2,
        PFILE_OBJECT *a3,
        PDEVICE_OBJECT *a4)
{
  ...
  DWORD2(v20) = IoGetDeviceObjectPointer(a1, a2, a3, a4);
  if ( v9 )
  {
