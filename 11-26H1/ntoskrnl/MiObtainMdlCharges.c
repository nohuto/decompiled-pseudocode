/*
 * XREFs of MiObtainMdlCharges @ 0x1404C3B1C
 * Callers:
...
LABEL_5:
  ...
  while ( 1 )
  {
    if ( (v3 & 0xC00) == 0 && (int)MiAcquireNonPagedResources(*(ULONG **)a1, v1, *(_QWORD *)(a1 + 40), v6) < 0 )
      goto LABEL_14;
    v7 = v1 / *(_QWORD *)(a1 + 48);
...
LABEL_14:
    ...
    if ( v13 <= v14 )
      return 3221225626LL;
    v15 = v13 - v14;
    v16 = *(_QWORD *)(*(_QWORD *)a1 + 23104LL);
    v17 = *(_QWORD *)(*(_QWORD *)a1 + 23448LL);
    if ( v16 < v17 )
    {
      v18 = v17 - v16;
      if ( v18 < v15 )
...
LABEL_10:
  ...
  *(_QWORD *)PoolMm = 0LL;
  *(_WORD *)(PoolMm + 10) = 0;
  *(_WORD *)(PoolMm + 8) = 8 * ((v9 >> 12) + 6);
  *(_QWORD *)(PoolMm + 32) = 0LL;
  *(_QWORD *)(PoolMm + 40) = (unsigned int)v9;
  v10 = *(_DWORD *)(a1 + 148);
  *(_QWORD *)(a1 + 32) = v1;
  *(_QWORD *)(a1 + 64) = PoolMm;
  if ( (v10 & 0x10) == 0 )
    _InterlockedAdd64((volatile signed __int64 *)(*(_QWORD *)a1 + 23488LL), v1);
  return 0LL;
}
