/*
 * XREFs of DifZwOpenDirectoryObjectWrapper @ 0x1406AEF50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenDirectoryObjectWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(88);
  ...
  LODWORD(v19) = ZwOpenDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
