/*
 * XREFs of DifZwQueryPerformanceCounterWrapper @ 0x1406B7030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryPerformanceCounterWrapper(
        ...
        PLARGE_INTEGER PerformanceFrequency)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1030);
  ...
  DWORD2(v16) = ZwQueryPerformanceCounter(PerformanceCounter, PerformanceFrequency);
  if ( v6 )
  {
