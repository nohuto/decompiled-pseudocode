/*
 * XREFs of DifZwQueryPerformanceCounterWrapper @ 0x1406B3450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryPerformanceCounterWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwQueryPerformanceCounter(a1, a2);
  if ( v6 )
  {
