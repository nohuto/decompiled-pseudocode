/*
 * XREFs of DifNtFreezeTransactionsWrapper @ 0x14067C200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFreezeTransactionsWrapper(PLARGE_INTEGER FreezeTimeout, PLARGE_INTEGER ThawTimeout)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(852);
  ...
  DWORD2(v16) = NtFreezeTransactions(FreezeTimeout, ThawTimeout);
  if ( v6 )
  {
