/*
 * XREFs of DifNtFreezeTransactionsWrapper @ 0x140678620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFreezeTransactionsWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtFreezeTransactions(a1, a2);
  if ( v6 )
  {
