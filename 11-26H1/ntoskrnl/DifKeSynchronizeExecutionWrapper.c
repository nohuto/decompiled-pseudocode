/*
 * XREFs of DifKeSynchronizeExecutionWrapper @ 0x140668550
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeSynchronizeExecutionWrapper(
        ...
        PVOID SynchronizeContext)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(246);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = Interrupt;
    *(_QWORD *)&v18 = SynchronizeRoutine;
    *((_QWORD *)&v17 + 1) = SynchronizeContext;
  ...
  LOBYTE(v19) = KeSynchronizeExecution(Interrupt, SynchronizeRoutine, SynchronizeContext);
  if ( v8 )
  {
