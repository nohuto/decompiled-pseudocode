/*
 * XREFs of DifZwFreezeTransactionsWrapper @ 0x1406AAA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFreezeTransactionsWrapper(PLARGE_INTEGER FreezeTimeout, PLARGE_INTEGER ThawTimeout)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1115);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = FreezeTimeout;
    *((_QWORD *)&v15 + 1) = ThawTimeout;
  ...
  DWORD2(v16) = ZwFreezeTransactions(FreezeTimeout, ThawTimeout);
  if ( v6 )
  {
