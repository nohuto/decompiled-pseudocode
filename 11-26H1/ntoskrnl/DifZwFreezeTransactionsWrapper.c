/*
 * XREFs of DifZwFreezeTransactionsWrapper @ 0x1406A6E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwFreezeTransactionsWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwFreezeTransactions(a1, a2);
  if ( v6 )
  {
