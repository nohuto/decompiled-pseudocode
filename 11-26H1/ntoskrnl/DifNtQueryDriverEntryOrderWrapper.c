/*
 * XREFs of DifNtQueryDriverEntryOrderWrapper @ 0x140685AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryDriverEntryOrderWrapper(PULONG Ids, PULONG Count)
{
  ...
  DWORD2(v16) = NtQueryDriverEntryOrder(Ids, Count);
  if ( v6 )
  {
