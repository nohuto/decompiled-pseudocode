/*
 * XREFs of DifNtQueryDriverEntryOrderWrapper @ 0x140681F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryDriverEntryOrderWrapper(volatile void *Address, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(674);
  ...
  DWORD2(v16) = NtQueryDriverEntryOrder(Address);
  if ( v6 )
  {
