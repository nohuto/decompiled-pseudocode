/*
 * XREFs of DifZwCommitCompleteWrapper @ 0x1406A0FE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCommitCompleteWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1108);
  ...
  DWORD2(v16) = ZwCommitComplete(EnlistmentHandle, TmVirtualClock);
  if ( v6 )
  {
