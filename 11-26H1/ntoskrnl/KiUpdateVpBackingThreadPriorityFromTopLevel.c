/*
 * XREFs of KiUpdateVpBackingThreadPriorityFromTopLevel @ 0x1403BFE80
 * Callers:
 ...
 *     KiPrcbArrayForIsolationWidth @ 0x14042FE00 (KiPrcbArrayForIsolationWidth.c)
        ...
        char a3)
{
  ...
  if ( Priority != v15 && (BYTE4(xmmword_140FBFC10) & 0x20) != 0 )
