/*
 * XREFs of DifNtQueryIntervalProfileWrapper @ 0x140687A30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryIntervalProfileWrapper(KPROFILE_SOURCE ProfileSource, PULONG Interval)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(716);
  ...
  HIDWORD(v16) = NtQueryIntervalProfile(ProfileSource, Interval);
  if ( v6 )
  {
