/*
 * XREFs of DifNtQueryIntervalProfileWrapper @ 0x140683E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryIntervalProfileWrapper(unsigned int a1, __int64 a2)
{
  ...
  HIDWORD(v16) = NtQueryIntervalProfile(a1, a2);
  if ( v6 )
  {
