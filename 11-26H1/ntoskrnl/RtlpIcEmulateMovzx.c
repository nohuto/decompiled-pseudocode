...
__int64 __fastcall RtlpIcEmulateMovzx(_BYTE *a1, __int64 a2, unsigned __int8 a3, int *a4)
{
  ...
  result = RtlpIcDecodeModRm((__int64)a1, a2, a4);
  if ( (int)result >= 0 )
  {
    if ( a2 )
    {
      ...
      v12[0] = 0;
      v11 = 0;
      RtlpIcDecodeModRmOperand((__int64)a1, a2, (__int64 *)&v14, v12, &v11);
      v13 = 0LL;
      result = RtlpIcAccessMemory(a2, &v13, v14, v12[0], v11, a3 >> 3, 0);
      if ( (int)result < 0 )
        return result;
      LOBYTE(v8) = (a1[25] & 4) != 0;
      RegisterAddressByIndex = (_WORD *)RtlpIcGetRegisterAddressByIndex(
                                          (_DWORD)a1,
                                          a2,
