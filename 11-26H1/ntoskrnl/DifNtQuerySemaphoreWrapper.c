/*
 * XREFs of DifNtQuerySemaphoreWrapper @ 0x140685860
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQuerySemaphoreWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(694);
  ...
  LODWORD(v21) = NtQuerySemaphore(a1, a5);
  if ( v10 )
  {
