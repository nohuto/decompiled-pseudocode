/*
 * XREFs of KiPublishProcessorFeatures @ 0x140CCB924
 * Callers:
...
__int64 __fastcall KiPublishProcessorFeatures(__int64 a1)
{
  ...
  v1 = KeFeatureBits2;
  stru_140FC01F0.AutoBoostThreadState = &stru_140FC01F0.IptSaveArea;
  *(_OWORD *)&stru_140FC01F0.IptSaveArea = 0LL;
  stru_140FC01F0.SchedulerSharedSwappablePage = (_KSWAPPABLE_PAGE *)128;
  *(_BYTE *)(MmWriteableSharedUserData + 661) = (KeFeatureBits2 & 2) != 0;
  if ( !_bittest((const signed __int32 *)(*(_QWORD *)(KeLoaderBlock_0 + 240) + 132LL), 0xDu) )
  {
    ...
    if ( (*(_QWORD *)&v1 & 0x800000LL) != 0 )
      *((_BYTE *)stru_140FC01F0.AutoBoostThreadState + 3) |= 2u;
  }
