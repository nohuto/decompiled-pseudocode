/*
 * XREFs of DifMmMapIoSpaceExWrapper @ 0x14066B000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifMmMapIoSpaceExWrapper(__int64 a1, __int64 a2, unsigned int a3)
{
