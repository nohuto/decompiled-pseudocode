/*
 * XREFs of DifNtReplacePartitionUnitWrapper @ 0x14068CD40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplacePartitionUnitWrapper(
        ...
        ULONG Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(818);
  ...
  LODWORD(v19) = NtReplacePartitionUnit(TargetInstancePath, SpareInstancePath, Flags);
  if ( v8 )
  {
