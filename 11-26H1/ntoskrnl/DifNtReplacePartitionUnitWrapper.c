/*
 * XREFs of DifNtReplacePartitionUnitWrapper @ 0x140689160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReplacePartitionUnitWrapper(volatile void *Address, volatile void *a2, int a3)
{
  ...
  LODWORD(v19) = NtReplacePartitionUnit(Address, a2);
  if ( v8 )
  {
