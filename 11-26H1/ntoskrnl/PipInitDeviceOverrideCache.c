/*
 * XREFs of PipInitDeviceOverrideCache @ 0x140CC2194
 * Callers:
...
LABEL_2:
      ...
      for ( i = 0; i < 3; ++i )
      {
        if ( HIDWORD(KeyInformation_8[2]) < 3 * *((_DWORD *)qword_14002E1C0 + i) )
        {
          PnpDeviceOverrideHashListSize = *((_DWORD *)qword_14002E1C0 + i);
          break;
        }
      }
