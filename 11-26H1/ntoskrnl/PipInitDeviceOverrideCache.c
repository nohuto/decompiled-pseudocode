/*
 * XREFs of PipInitDeviceOverrideCache @ 0x140CC8264
 * Callers:
...
LABEL_2:
      ...
      for ( i = 0; i < 3; ++i )
      {
        if ( HIDWORD(KeyInformation_8[2]) < 3 * *((_DWORD *)qword_14002DC60 + i) )
        {
          PnpDeviceOverrideHashListSize = *((_DWORD *)qword_14002DC60 + i);
          break;
        }
      }
      ...
      Pool2 = (_QWORD *)ExAllocatePool2(256LL, 16LL * v3, 0x6E697050u);
        ...
        for ( j = 0; ; ++j )
        {
          ...
          if ( v8 >= 0 )
          {
            if ( v20 <= 0x200 )
            {
              ...
              v9 = (UNICODE_STRING *)ExAllocatePool2(256LL, 0x20uLL, 0x6E697050u);
              v10 = v9;
              if ( !v9 )
                goto LABEL_16;
