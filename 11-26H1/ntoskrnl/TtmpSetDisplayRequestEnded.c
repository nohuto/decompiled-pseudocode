/*
 * XREFs of TtmpSetDisplayRequestEnded @ 0x1407ED28C
 * Callers:
...
void __fastcall TtmpSetDisplayRequestEnded(__int64 a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    *v4 = v6;
    ...
    if ( TerminalById < 0 )
    {
      TtmiLogError("TtmpSetDisplayRequestEnded", 735LL, (unsigned int)TerminalById, 0xFFFFFFFFLL);
      goto LABEL_13;
    }
    v9 = v13;
...
LABEL_13:
    ...
    {
      TtmiLogError("TtmpSetDisplayRequestEnded", 717LL, 3221225485LL, 0xFFFFFFFFLL);
    }
  }
  if ( v3 )
