/*
 * XREFs of Feature_ConfAccImp__private_IsEnabledFallback @ 0x1406E7768
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, (volatile signed __int32 **)&Feature_ConfAccImp__private_descriptor, 0);
}
