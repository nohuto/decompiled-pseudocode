/*
 * XREFs of PopBootStatUnlock @ 0x140773008
 * Callers:
...
__int64 __fastcall PopBootStatUnlock(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  v5 = (AutoBoost *)KeAbPreAcquire((__int64)&PopPdcDeviceListLock.ApcState.ApcListHead[0].Blink, 0LL, 0LL, a4);
  v7 = _interlockedbittestandset64((volatile signed __int32 *)&PopPdcDeviceListLock.ApcStateFill[8], 0LL);
  v8 = v5;
  if ( v7 )
