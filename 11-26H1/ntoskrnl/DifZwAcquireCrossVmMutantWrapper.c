/*
 * XREFs of DifZwAcquireCrossVmMutantWrapper @ 0x14069BE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAcquireCrossVmMutantWrapper(__int64 a1, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1009);
  ...
  DWORD2(v16) = ZwAcquireCrossVmMutant(a1, a2);
  if ( v6 )
  {
