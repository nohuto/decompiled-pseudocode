/*
 * XREFs of SepSetTokenBnoIsolation @ 0x140A2CC04
 * Callers:
        ...
        struct _KLOCK_ENTRIES *a5)
{
  ...
  if ( *(_QWORD *)(a1 + 1152) )
  {
    SepDereferenceCachedHandlesEntryInternal((struct _KTHREAD *)(*(_QWORD *)(a1 + 216) + 96LL));
    *(_QWORD *)(a1 + 1152) = 0LL;
  }
  if ( a2 )
  {
    ...
    v13[0] = 1;
    *(_OWORD *)&v13[2] = v12;
    return (unsigned int)SepSetTokenCachedHandles((_QWORD *)a1, v13, a4, v10);
  }
  return v5;
}
