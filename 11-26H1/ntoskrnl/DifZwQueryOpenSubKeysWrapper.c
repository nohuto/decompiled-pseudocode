/*
 * XREFs of DifZwQueryOpenSubKeysWrapper @ 0x1406B32E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryOpenSubKeysWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = ZwQueryOpenSubKeys(a1, a2);
  if ( v6 )
  {
