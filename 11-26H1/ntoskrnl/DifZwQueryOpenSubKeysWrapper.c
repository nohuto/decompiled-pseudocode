/*
 * XREFs of DifZwQueryOpenSubKeysWrapper @ 0x1406B6EC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryOpenSubKeysWrapper(POBJECT_ATTRIBUTES TargetKey, PULONG HandleCount)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1095);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = TargetKey;
    *((_QWORD *)&v15 + 1) = HandleCount;
  ...
  DWORD2(v16) = ZwQueryOpenSubKeys(TargetKey, HandleCount);
  if ( v6 )
  {
