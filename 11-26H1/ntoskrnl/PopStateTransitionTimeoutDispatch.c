/*
 * XREFs of PopStateTransitionTimeoutDispatch @ 0x140607880
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn PopStateTransitionTimeoutDispatch()
{
  ...
  *(_OWORD *)BugCheckParameter1 = 0LL;
  ...
  {
    v0 = 15LL;
    if ( dword_140F0FD14 == 2 )
      v0 = 241LL;
  }
  BugCheckParameter4 = KeGetCurrentThread();
  if ( (unsigned int)(dword_140F0FD14 - 1) <= 1 && (int)PopQueryLastStateTransitionInfo(BugCheckParameter1) >= 0 )
  {
    if ( *((_QWORD *)&v4 + 1) )
    {
      if ( (_DWORD)v4 == 1 )
      {
        guard_dispatch_icall_no_overrides((unsigned int)dword_140F0FD20, &BugCheckParameter1[1]);
      }
      else if ( (_DWORD)v4 == 2 )
      {
        guard_dispatch_icall_no_overrides((unsigned int)dword_140F0FD20, *((_QWORD *)&v3 + 1));
      }
    }
  ...
  KeBugCheckEx(0xA0u, v0, dword_140F0FB8C, unk_140F10F1C, (ULONG_PTR)BugCheckParameter4);
}
