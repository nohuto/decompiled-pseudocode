/*
 * XREFs of KeCheckForTimer @ 0x140344DA0
 * Callers:
      ...
      for ( i = 0; i < 2; ++i )
      {
        ...
        do
        {
          ...
          while ( v8 != v11 )
          {
            ...
            v5 = KiWaitNever;
            v14 = (unsigned __int64)stru_140FC01F0.WaitBlock[2].WaitListEntry.Flink ^ _byteswap_uint64(v13 ^ __ROL8__(KiWaitNever ^ *(_QWORD *)(v13 + 48), KiWaitNever));
            if ( v14 )
            {
