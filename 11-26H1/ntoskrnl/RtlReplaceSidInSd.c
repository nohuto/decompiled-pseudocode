  ...
  *NumChanges = 0;
  ...
  if ( result >= 0 )
  {
    if ( Owner )
    {
      ...
      {
        v10 = *((unsigned __int8 *)OldSid + 1);
        v11 = *((unsigned __int8 *)Owner + 1);
        if ( (_BYTE)v11 == (_BYTE)v10 || v11 == v10 + 1 )
        {
    ...
    if ( result >= 0 )
    {
      if ( Owner )
      {
        if ( *(_BYTE *)Owner == *(_BYTE *)OldSid )
        {
          ...
          if ( (_BYTE)v15 == (_BYTE)v14 || v15 == v14 + 1 )
          {
...
LABEL_29:
              if ( *v20 == *(_BYTE *)OldSid )
              {
                ...
                if ( (_BYTE)v22 == (_BYTE)v21 || v22 == v21 + 1 )
                {
                  ...
                  if ( !v23 )
                  {
                    v24 = v8;
                    v25 = v20 + 8;
                    if ( !memcmp(v20 + 8, (char *)OldSid + 8, v24) )
                    {
        ...
        if ( result >= 0 && DaclPresent && Owner )
        {
          ...
          if ( *((_WORD *)Owner + 2) )
          {
            while ( *v27 > 3u )
            {
              if ( *v27 == 4 )
              {
                v28 = (char *)&v27[RtlLengthSid(v27 + 12) + 12];
                goto LABEL_48;
              }
LABEL_56:
              v8 = v35;
...
LABEL_48:
            if ( *v28 == *(_BYTE *)OldSid )
            {
              v29 = *((unsigned __int8 *)OldSid + 1);
              v30 = (unsigned __int8)v28[1];
              if ( (_BYTE)v30 == (_BYTE)v29 || v30 == v29 + 1 )
              {
                v31 = *(_DWORD *)(v28 + 2) - *(_DWORD *)((char *)OldSid + 2);
                if ( !v31 )
                  v31 = *((unsigned __int16 *)v28 + 3) - *((unsigned __int16 *)OldSid + 3);
                if ( !v31 )
                {
                  v32 = v8;
                  v33 = v28 + 8;
                  if ( !memcmp(v28 + 8, (char *)OldSid + 8, v32) )
                  {
