/*
 * XREFs of DifZwContinueExWrapper @ 0x1406A1790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwContinueExWrapper(PCONTEXT ContextRecord, PVOID ContinueArgument)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(943);
  ...
  if ( APIThunkContextById )
  {
    ...
    v8 = 0;
    *(_QWORD *)&v16 = ContextRecord;
    *((_QWORD *)&v15 + 1) = ContinueArgument;
  ...
  DWORD2(v16) = ZwContinueEx(ContextRecord, ContinueArgument);
  if ( v6 )
  {
