/*
 * XREFs of DifNtQueryMutantWrapper @ 0x1406847F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryMutantWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtQueryMutant(a1, a5);
  if ( v10 )
  {
