/*
 * XREFs of DifNtQueryMutantWrapper @ 0x1406883D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryMutantWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(688);
  ...
  LODWORD(v21) = NtQueryMutant(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
