/*
 * XREFs of FsRtlpOplockFsctrlInternal @ 0x140AA2BF0
 * Callers:
 *     FsRtlUpperOplockFsctrl @ 0x14078EA50 (FsRtlUpperOplockFsctrl.c)
 *     FsRtlOplockFsctrl @ 0x140AA2BB0 (FsRtlOplockFsctrl.c)
 *     FsRtlOplockFsctrlEx @ 0x140AA2BD0 (FsRtlOplockFsctrlEx.c)
 * Callees:
 ...
 *     FsRtlCheckOplockEx @ 0x1403FB930 (FsRtlCheckOplockEx.c)
 ...
 *     IoIsOperationSynchronous @ 0x140478950 (IoIsOperationSynchronous.c)
 *     FsRtlpCallerIsAtomicRequestor @ 0x1404A2DCC (FsRtlpCallerIsAtomicRequestor.c)
