/*
 * XREFs of DifNtDisplayStringWrapper @ 0x14067A070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDisplayStringWrapper(PUNICODE_STRING String)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(731);
  ...
  LODWORD(v14) = NtDisplayString(String);
  if ( v4 )
  {
