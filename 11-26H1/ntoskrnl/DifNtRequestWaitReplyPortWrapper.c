/*
 * XREFs of DifNtRequestWaitReplyPortWrapper @ 0x140689A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRequestWaitReplyPortWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtRequestWaitReplyPort(a1, a2, a3);
  if ( v8 )
  {
