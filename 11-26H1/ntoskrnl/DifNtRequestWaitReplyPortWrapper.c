/*
 * XREFs of DifNtRequestWaitReplyPortWrapper @ 0x14068D650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRequestWaitReplyPortWrapper(
        HANDLE PortHandle,
        ...
        PPORT_MESSAGE ReplyMessage)
{
  ...
  LODWORD(v19) = NtRequestWaitReplyPort(PortHandle, RequestMessage, ReplyMessage);
  if ( v8 )
  {
