...
volatile signed __int64 *__fastcall MmUnlockPhysicalPagesByVa(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  _DWORD v12[2]; // [rsp+20h] [rbp-A9h] BYREF
  ...
  __int64 (__fastcall *v17)(__int64, unsigned __int64, int); // [rsp+C8h] [rbp-1h]
  ...
  v16 = v6 + (v4 << 12) - 1;
  v13 = MiLockWorkingSetShared((__int64)&Process[2].ReadyListHead.Blink, v7, v8);
  LOBYTE(v6) = v13;
  MiWalkPageTables((__int64)v12);
  LOBYTE(v9) = v6;
  MiUnlockWorkingSetShared((__int64)&Process[2].ReadyListHead.Blink, v9);
  LODWORD(v10) = KeGetPcr()->Prcb.Number;
  result = (volatile signed __int64 *)&Process[2].ActiveProcessors[2].StaticBitmap[8 * ((v10 >> 1) & 3) + 5];
