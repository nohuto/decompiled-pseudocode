/*
 * XREFs of sub_1409EDA0C @ 0x1409EDA0C
 * Callers:
...
__int64 __fastcall sub_1409EDA0C(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v4; // r14
  char *v5; // r13
  struct _MDL *v6; // r15
  ...
  v27 = 0;
  v28 = 0;
  Flink_low = LODWORD(stru_140E3E928.Header.WaitListHead.Flink);
  v7 = 0;
  ...
  if ( v7 >= 0 )
  {
    ...
    *(_QWORD *)(v33 + 80) = 1LL;
    ...
    v25 = 1;
    v7 = sub_1409F0AF4(*(PVOID *)(a2 + 328));
    if ( v7 >= 0 )
    {
      v7 = sub_1409EFF2C(a1, *(unsigned int *)(a2 + 320), &v34, &v31);
      if ( v7 >= 0 )
      {
        v7 = sub_140A847CC(*(unsigned int *)(a2 + 320), &Src);
        if ( v7 < 0 )
        {
          v5 = (char *)Src;
        }
...
LABEL_53:
                  ...
                  *(_QWORD *)(*(_QWORD *)(v4 + 40) + 8LL) = Flink_low;
                  v7 = ZwFlushInstructionCache(-1LL, *(_QWORD *)(v4 + 24));
                  if ( v7 >= 0 )
                  {
                    if ( !*(_QWORD *)(a2 + 296) || (v7 = ZwFlushInstructionCache(-1LL, *(_QWORD *)(v4 + 32)), v7 >= 0) )
                    {
                      if ( a3 )
                      {
                        *a3 = v4;
