/*
 * XREFs of DifZwGetCachedSigningLevelWrapper @ 0x1406AAD80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwGetCachedSigningLevelWrapper(
        void *a1,
        ULONG *a2,
        BYTE *a3,
        UCHAR *a4,
        ...
        ULONG *ThumbprintAlgorithm)
{
  ...
  unsigned int CachedSigningLevel; // [rsp+68h] [rbp-8h]
  void *retaddr; // [rsp+98h] [rbp+28h]

  memset_0(v20, 0, 0x40uLL);
  APIThunkContextById = DifGetAPIThunkContextById(893);
...
LABEL_17:
  CachedSigningLevel = ZwGetCachedSigningLevel(a1, a2, a3, a4, ThumbprintSize, ThumbprintAlgorithm);
  if ( v11 )
  {
