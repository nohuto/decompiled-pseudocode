/*
 * XREFs of sub_1409F0E8C @ 0x1409F0E8C
 * Callers:
...
__int64 __fastcall sub_1409F0E8C(__int64 a1, unsigned int *a2)
{
  unsigned int v2; // ebp
  unsigned int v4; // r8d
  unsigned int v5; // edx
  ...
  v12 = 0LL;
  Mdl = 0LL;
  v8 = sub_1409F0AF4(v7, v5 & 0xFFFFFFF, (v4 & 2) == 0);
  if ( v8 >= 0 )
  {
    v8 = sub_1409F0C04(v7, a2[2] & 0xFFFFFFF, (*a2 & 2) == 0, (__int64)&Mdl, (__int64)&v12);
    if ( v8 >= 0 )
    {
      v9 = v12;
      v8 = sub_140AB0700(
