/*
 * XREFs of DifNtEnumerateTransactionObjectWrapper @ 0x1406770F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtEnumerateTransactionObjectWrapper(
        void *a1,
        KTMOBJECT_TYPE a2,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(825);
  ...
  LODWORD(v21) = NtEnumerateTransactionObject(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
