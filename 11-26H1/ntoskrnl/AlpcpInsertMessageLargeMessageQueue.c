/*
 * XREFs of AlpcpInsertMessageLargeMessageQueue @ 0x140A821BC
 * Callers:
...
void __fastcall AlpcpInsertMessageLargeMessageQueue(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  v10 = *(_DWORD *)(a2 + 40);
  *(_QWORD *)(a2 + 16) = a1;
  *(_DWORD *)(a2 + 40) = v10 & 0xFFFFFF82 | (4 * (*(_DWORD *)(a1 + 416) & 6)) | 2;
