/*
 * XREFs of DifZwOpenKeyTransactedWrapper @ 0x1406AFD70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenKeyTransactedWrapper(HANDLE *a1, ACCESS_MASK a2, OBJECT_ATTRIBUTES *a3, void *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(81);
  ...
  DWORD2(v20) = ZwOpenKeyTransacted(a1, a2, a3, a4);
  if ( v9 )
  {
