/*
 * XREFs of DifZwConvertBetweenAuxiliaryCounterAndPerformanceCounterWrapper @ 0x1406A1A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwConvertBetweenAuxiliaryCounterAndPerformanceCounterWrapper(
        BOOLEAN a1,
        LARGE_INTEGER *a2,
        LARGE_INTEGER *a3,
        LARGE_INTEGER *a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1032);
  ...
  HIDWORD(v19) = ZwConvertBetweenAuxiliaryCounterAndPerformanceCounter(a1, a2, a3, a4);
  if ( v9 )
  {
