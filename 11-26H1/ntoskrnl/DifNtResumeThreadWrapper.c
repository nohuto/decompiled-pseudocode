/*
 * XREFs of DifNtResumeThreadWrapper @ 0x14068DAC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtResumeThreadWrapper(HANDLE ThreadHandle, PULONG PreviousSuspendCount)
{
  ...
  DWORD2(v16) = NtResumeThread(ThreadHandle, PreviousSuspendCount);
  if ( v6 )
  {
