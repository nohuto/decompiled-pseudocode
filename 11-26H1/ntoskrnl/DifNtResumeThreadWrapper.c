/*
 * XREFs of DifNtResumeThreadWrapper @ 0x140689EE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtResumeThreadWrapper(ULONG_PTR BugCheckParameter1, __int64 a2)
{
  ...
  DWORD2(v16) = NtResumeThread(BugCheckParameter1);
  if ( v6 )
  {
