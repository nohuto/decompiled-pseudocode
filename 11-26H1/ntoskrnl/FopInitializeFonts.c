/*
 * XREFs of FopInitializeFonts @ 0x140D19EB8
 * Callers:
...
__int64 __fastcall FopInitializeFonts(__int64 a1)
{
  ...
  __int64 v10; // rcx
  _QWORD *v11; // rcx
  unsigned __int32 v13; // [rsp+50h] [rbp+8h] BYREF
...
LABEL_14:
    ...
    *((_DWORD *)v6 + 10) = v2;
    ...
    if ( (v8 & 1) != 0 )
    {
      if ( (int)FioFwReadUlongAtOffset(*(_QWORD *)(a1 + 16), i, &v13) < 0 )
      {
LABEL_13:
        FopFreeFontData(v6);
        goto LABEL_14;
    ...
    *((_DWORD *)v6 + 11) = v7;
    ...
    v10 = *(_QWORD *)(a1 + 16);
    v13 = 0;
    if ( (int)FopGetTableOffsetAndSize(v10, v9, 1668112752, (unsigned __int32 *)v6 + 12, &v13) >= 0
