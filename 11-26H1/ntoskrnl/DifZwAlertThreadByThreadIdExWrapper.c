/*
 * XREFs of DifZwAlertThreadByThreadIdExWrapper @ 0x14069D000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwAlertThreadByThreadIdExWrapper(__int64 a1, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(922);
  ...
  DWORD2(v16) = ZwAlertThreadByThreadIdEx(a1, a2);
  if ( v6 )
  {
