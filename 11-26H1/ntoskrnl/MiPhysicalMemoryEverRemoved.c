/*
 * XREFs of MiPhysicalMemoryEverRemoved @ 0x1406E9EF4
 * Callers:
...
__int64 __fastcall MiPhysicalMemoryEverRemoved(unsigned __int64 a1, __int64 a2, int a3)
{
  ...
  v5 = (a1 + v3) >> 18;
  v7 = a1 >> 18;
  if ( v5 <= qword_140E2D7B8 )
  {
    v4 = v5;
  }
  else if ( v7 >= qword_140E2D7B8 )
  {
    return 0LL;
  }
  v8 = 0;
  ...
  if ( !a3 )
  {
    RtlSetBitsEx((__int64)&qword_140E2D7B8, a1 >> 18, v9);
    return 1LL;
  }
  if ( v7 >= qword_140E2D7B8 )
    return 1LL;
  if ( v9 <= 1 )
    return v9 != 1 || _bittest64((const signed __int64 *)(qword_140E2D7C0 + 8 * (a1 >> 24)), (a1 >> 18) & 0x3F);
  if ( qword_140E2D7B8 - v7 < v9 )
    return 1LL;
  v11 = (__int64 *)(qword_140E2D7C0 + 8 * (a1 >> 24));
  v12 = *v11;
  v13 = qword_140E2D7C0 + 8 * ((unsigned __int64)(v4 - 1) >> 6);
  if ( v11 != (__int64 *)v13 )
  {
