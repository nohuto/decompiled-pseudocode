/*
 * XREFs of sub_1409EBC70 @ 0x1409EBC70
 * Callers:
...
__int64 __fastcall sub_1409EBC70(__int64 a1, __int64 a2)
{
  int v3; // eax
  int v4; // r9d
  __int64 v5; // rbx
...
LABEL_13:
  if ( v5
    ...
    && (int)sub_1409ED8B0(a1, v5, 0xFFFFFFFFLL) >= 0 )
  {
