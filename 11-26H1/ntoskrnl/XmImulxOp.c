/*
 * XREFs of XmImulxOp @ 0x1405B0AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall XmImulxOp(int *a1)
{
  ...
  if ( v1 )
  {
    ...
    if ( v1 == 3 )
    {
      v15 = a1[27] * (__int64)a1[26];
      XmStoreResult((__int64)a1, a1[27] * a1[26]);
      *(_QWORD *)(v8 + 88) = v7;
    ...
    {
      XmStoreResult((__int64)a1, (unsigned __int16)(*((_WORD *)a1 + 54) * *((_WORD *)a1 + 52)));
      *(_QWORD *)(v12 + 88) = v7;
