/*
 * XREFs of DifNtRegisterProtocolAddressInformationWrapper @ 0x14068BF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtRegisterProtocolAddressInformationWrapper(
        void *a1,
        GUID *a2,
        ULONG a3,
        void *a4,
        ULONG CreateOptions)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(850);
  ...
  LODWORD(v21) = NtRegisterProtocolAddressInformation(a1, a2, a3, a4, CreateOptions);
  if ( v10 )
  {
