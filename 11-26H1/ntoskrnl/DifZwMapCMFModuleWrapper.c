/*
 * XREFs of DifZwMapCMFModuleWrapper @ 0x1406AD8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwMapCMFModuleWrapper(
        ULONG a1,
        ULONG a2,
        ULONG *a3,
        ULONG *a4,
        ...
        PVOID *BaseAddress)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1045);
...
LABEL_17:
  LODWORD(v23) = ZwMapCMFModule(a1, a2, a3, a4, ViewSizeOut, BaseAddress);
  if ( v11 )
  {
