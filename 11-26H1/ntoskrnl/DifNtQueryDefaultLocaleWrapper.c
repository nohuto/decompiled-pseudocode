/*
 * XREFs of DifNtQueryDefaultLocaleWrapper @ 0x140681660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryDefaultLocaleWrapper(char a1, __int64 a2)
{
  ...
  LOBYTE(v6) = a1;
  HIDWORD(v17) = NtQueryDefaultLocale(v6, a2);
  if ( v7 )
  {
