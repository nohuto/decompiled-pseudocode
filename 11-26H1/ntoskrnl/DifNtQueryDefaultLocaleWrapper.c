/*
 * XREFs of DifNtQueryDefaultLocaleWrapper @ 0x140685240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryDefaultLocaleWrapper(BOOLEAN a1, DWORD *a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(728);
  ...
  HIDWORD(v16) = NtQueryDefaultLocale(a1, a2);
  if ( v6 )
  {
