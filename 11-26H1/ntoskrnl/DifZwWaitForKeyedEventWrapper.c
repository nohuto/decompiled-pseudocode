/*
 * XREFs of DifZwWaitForKeyedEventWrapper @ 0x1406C2EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwWaitForKeyedEventWrapper(void *a1, void *a2, BOOLEAN a3, LARGE_INTEGER *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1036);
  ...
  DWORD2(v20) = ZwWaitForKeyedEvent(a1, a2, a3, a4);
  if ( v9 )
  {
