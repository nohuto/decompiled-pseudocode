/*
 * XREFs of DifNtQueueApcThreadEx2Wrapper @ 0x14068AAE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueueApcThreadEx2Wrapper(
        void *a1,
        void *a2,
        ULONG a3,
...
LABEL_17:
  v25 = NtQueueApcThreadEx2(a1, a2, a3, a4, ApcArgument1, ApcArgument2, ApcArgument3);
  if ( v12 )
  {
