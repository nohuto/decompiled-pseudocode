/*
 * XREFs of DifNtQuerySymbolicLinkObjectWrapper @ 0x140685A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQuerySymbolicLinkObjectWrapper(HANDLE Handle, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtQuerySymbolicLinkObject(Handle);
  if ( v8 )
  {
