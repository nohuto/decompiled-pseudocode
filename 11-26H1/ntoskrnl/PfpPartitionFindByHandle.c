/*
 * XREFs of PfpPartitionFindByHandle @ 0x140A53E50
 * Callers:
...
__int64 __fastcall PfpPartitionFindByHandle(__int64 *a1, __int64 *a2, __int64 a3, char a4)
{
  ...
  if ( (unsigned int)dword_140E07398 > 4 && (byte_140E073A8 & 1) != 0 && (qword_140E073B0 & 1) == qword_140E073B0 )
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07398, (unsigned __int8 *)qword_1400495A0, 0LL, 0LL, 2u, v16);
  LOBYTE(a3) = a4;
  ...
  if ( (unsigned int)dword_140E07398 > 4 && (byte_140E073A8 & 1) != 0 && (qword_140E073B0 & 1) == qword_140E073B0 )
  {
    ...
    v19 = &v14;
    v20 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140E07398, (unsigned __int8 *)&byte_14004953F, 0LL, 0LL, 4u, v16);
  }
  if ( v9 )
