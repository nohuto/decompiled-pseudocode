/*
 * XREFs of DifNtQueryEventWrapper @ 0x140682250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryEventWrapper(void *a1, int a2, __int64 a3, int a4, __int64 a5)
{
  ...
  LODWORD(v21) = NtQueryEvent(a1, a5);
  if ( v10 )
  {
