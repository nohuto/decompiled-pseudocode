/*
 * XREFs of DifNtQueryEventWrapper @ 0x140685E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryEventWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(679);
  ...
  LODWORD(v21) = NtQueryEvent(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
