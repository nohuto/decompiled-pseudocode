/*
 * XREFs of DifNtCreateDirectoryObjectWrapper @ 0x140670430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateDirectoryObjectWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtCreateDirectoryObject(a1, a2, a3);
  if ( v8 )
  {
