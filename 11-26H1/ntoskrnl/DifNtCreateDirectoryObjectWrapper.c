/*
 * XREFs of DifNtCreateDirectoryObjectWrapper @ 0x140674010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateDirectoryObjectWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtCreateDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
