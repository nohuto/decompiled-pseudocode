/*
 * XREFs of DifNtSetSystemPowerStateWrapper @ 0x14068DC10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemPowerStateWrapper(unsigned int a1, unsigned int a2, unsigned int a3)
{
  ...
  HIDWORD(v18) = NtSetSystemPowerState(a1, a2, a3);
  if ( v8 )
  {
