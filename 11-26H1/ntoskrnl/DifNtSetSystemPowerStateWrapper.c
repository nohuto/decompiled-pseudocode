/*
 * XREFs of DifNtSetSystemPowerStateWrapper @ 0x1406917F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetSystemPowerStateWrapper(
        POWER_ACTION SystemAction,
        unsigned __int32 LightestSystemState,
        ULONG Flags)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(655);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    LODWORD(v18) = SystemAction;
    *((_QWORD *)&v17 + 1) = __PAIR64__(LightestSystemState, Flags);
  ...
  HIDWORD(v18) = NtSetSystemPowerState(SystemAction, (SYSTEM_POWER_STATE)LightestSystemState, Flags);
  if ( v8 )
  {
