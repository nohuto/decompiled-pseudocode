/*
 * XREFs of DifNtCreateThreadWrapper @ 0x140674030
 * Callers:
 *     <none>
 * Callees:
        ...
        char a8)
{
  ...
  volatile void *v24; // [rsp+58h] [rbp-29h]
  volatile void *v25; // [rsp+60h] [rbp-21h]
  volatile void *v26; // [rsp+68h] [rbp-19h]
...
LABEL_17:
  Thread = NtCreateThread(a1, a2, a3, a4, Address, a6, a7, a8);
  if ( v13 )
  {
