/*
 * XREFs of KeCleanupImageTracepoints @ 0x140B38DA4
 * Callers:
...
void __fastcall KeCleanupImageTracepoints(__int64 a1, __int64 a2, __int64 a3, struct _KLOCK_ENTRIES *a4)
{
  ...
  if ( stru_140FC01F0.OtherOperationCount )
  ...
  if ( KsepShimDbLock.WaitBlock[2].WaitListEntry.Blink )
  {
    ...
    v8 = (AutoBoost *)KeAbPreAcquire((__int64)&KsepShimDbLock.WaitBlock[1].Object, 0LL, 0LL, a4);
    v10 = _interlockedbittestandset64((volatile signed __int32 *)&KsepShimDbLock.WaitBlockFill11[80], 0LL);
    v11 = v8;
    if ( v10 )
    ...
    v12 = (void **)(&KsepShimDbLock.WaitBlock[2].WaitListEntry.Blink->Flink + ((v5 >> 4) & 0x3FFF));
    v13 = (void **)(&KsepShimDbLock.WaitBlock[2].WaitListEntry.Blink->Flink + ((v7 >> 4) & 0x3FFF));
    while ( v12 <= v13 )
    {
      v14 = (void **)*v12;
      v15 = v12;
