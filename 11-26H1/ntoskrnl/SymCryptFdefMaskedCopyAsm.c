/*
 * XREFs of SymCryptFdefMaskedCopyAsm @ 0x1405715C0
 * Callers:
 *     SymCryptFdefIntConditionalCopy @ 0x140570A18 (SymCryptFdefIntConditionalCopy.c)
 *     SymCryptFdefIntMaskedCopy @ 0x140570CD8 (SymCryptFdefIntMaskedCopy.c)
