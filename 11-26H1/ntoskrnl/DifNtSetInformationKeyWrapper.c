/*
 * XREFs of DifNtSetInformationKeyWrapper @ 0x14068FB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationKeyWrapper(void *a1, KEY_SET_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(811);
  ...
  DWORD2(v20) = NtSetInformationKey(a1, a2, a3, a4);
  if ( v9 )
  {
