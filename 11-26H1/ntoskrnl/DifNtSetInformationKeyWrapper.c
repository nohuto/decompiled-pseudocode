/*
 * XREFs of DifNtSetInformationKeyWrapper @ 0x14068BF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetInformationKeyWrapper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  DWORD2(v20) = NtSetInformationKey(
                  a1,
                  a2,
                  a3,
                  a4,
