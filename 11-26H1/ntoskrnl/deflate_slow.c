    ...
    *((_DWORD *)a1 + 54) = 2;
    ...
    else
    {
      ...
      *(_BYTE *)((unsigned int)(*((_DWORD *)a1 + 1489))++ + a1[743]) = v24;
      ++*((_WORD *)a1 + 2 * *((unsigned __int8 *)length_code + v24) + 648);
      if ( v27 >= 0x100u )
        v28 = (v27 >> 7) + 256;
      else
        v28 = v27;
      ++*((_WORD *)a1 + 2 * *((unsigned __int8 *)dist_code + v28) + 1280);
      v29 = *((_DWORD *)a1 + 60);
      *((_DWORD *)a1 + 59) += 1 - v29;
      v30 = *((_DWORD *)a1 + 1489);
      v31 = *((_DWORD *)a1 + 1490);
