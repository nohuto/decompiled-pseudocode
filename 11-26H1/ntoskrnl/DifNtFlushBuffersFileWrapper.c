/*
 * XREFs of DifNtFlushBuffersFileWrapper @ 0x140677E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFlushBuffersFileWrapper(__int64 a1, __int64 a2)
{
  ...
  DWORD2(v16) = NtFlushBuffersFile(a1, a2);
  if ( v6 )
  {
