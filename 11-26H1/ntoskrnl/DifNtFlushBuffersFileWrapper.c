/*
 * XREFs of DifNtFlushBuffersFileWrapper @ 0x14067BA70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtFlushBuffersFileWrapper(HANDLE FileHandle, PIO_STATUS_BLOCK IoStatusBlock)
{
  ...
  DWORD2(v16) = NtFlushBuffersFile(FileHandle, IoStatusBlock);
  if ( v6 )
  {
