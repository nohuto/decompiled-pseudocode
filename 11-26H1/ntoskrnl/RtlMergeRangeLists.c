/*
 * XREFs of RtlMergeRangeLists @ 0x1408061A0
 * Callers:
 *     <none>
 * Callees:
    ...
    for ( i = *a3; ; i = *(_QWORD *)(v9 + 40) )
    {
      ...
      if ( (*(_BYTE *)(v9 + 34) & 1) != 0 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v9 == v11 + 24 )
            break;
          v12 = RtlpCopyRangeListEntry(v11);
          if ( !v12 )
            goto LABEL_16;
          v13 = a4 | 1;
          if ( (*(_BYTE *)(v11 + 33) & 2) == 0 )
            v13 = a4;
          v14 = RtlpAddRange(a1, v12, v13);
          v10 = *(_QWORD *)(v11 + 40);
          v7 = v14;
        }
      }
