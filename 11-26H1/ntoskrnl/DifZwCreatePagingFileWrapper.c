/*
 * XREFs of DifZwCreatePagingFileWrapper @ 0x1406A42C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePagingFileWrapper(UNICODE_STRING *a1, LARGE_INTEGER *a2, LARGE_INTEGER *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1086);
  ...
  DWORD2(v20) = ZwCreatePagingFile(a1, a2, a3, a4);
  if ( v9 )
  {
