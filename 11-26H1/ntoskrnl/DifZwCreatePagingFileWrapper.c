/*
 * XREFs of DifZwCreatePagingFileWrapper @ 0x1406A06E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreatePagingFileWrapper(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
