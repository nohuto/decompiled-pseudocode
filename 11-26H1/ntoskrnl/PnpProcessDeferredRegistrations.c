/*
 * XREFs of PnpProcessDeferredRegistrations @ 0x140A1A398
 * Callers:
...
__int64 **PnpProcessDeferredRegistrations()
{
  ...
  while ( 1 )
  {
    v0 = *(_QWORD **)&PspSiloMonitorLock.Spare36;
    if ( *(struct _KTHREAD **)&PspSiloMonitorLock.Spare36 == (struct _KTHREAD *)&PspSiloMonitorLock.Spare36 )
      break;
    if ( *(struct _KTHREAD **)(*(_QWORD *)&PspSiloMonitorLock.Spare36 + 8LL) != (struct _KTHREAD *)&PspSiloMonitorLock.Spare36
      || (v3 = **(_QWORD **)&PspSiloMonitorLock.Spare36,
          *(_QWORD *)(**(_QWORD **)&PspSiloMonitorLock.Spare36 + 8LL) != *(_QWORD *)&PspSiloMonitorLock.Spare36) )
    {
LABEL_17:
      __fastfail(3u);
    }
    *(_QWORD *)&PspSiloMonitorLock.Spare36 = **(_QWORD **)&PspSiloMonitorLock.Spare36;
    *(_QWORD *)(v3 + 8) = &PspSiloMonitorLock.Spare36;
    v4 = v0[2];
