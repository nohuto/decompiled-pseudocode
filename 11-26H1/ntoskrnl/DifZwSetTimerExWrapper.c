/*
 * XREFs of DifZwSetTimerExWrapper @ 0x1406BFF80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwSetTimerExWrapper(void *a1, TIMER_SET_INFORMATION_CLASS a2, void *a3, ULONG a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1015);
  ...
  DWORD2(v20) = ZwSetTimerEx(a1, a2, a3, a4);
  if ( v9 )
  {
