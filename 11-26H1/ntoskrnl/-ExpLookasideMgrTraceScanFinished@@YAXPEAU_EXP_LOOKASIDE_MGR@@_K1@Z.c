/*
 * XREFs of ?ExpLookasideMgrTraceScanFinished@@YAXPEAU_EXP_LOOKASIDE_MGR@@_K1@Z @ 0x140B2C7B8
 * Callers:
...
void __fastcall ExpLookasideMgrTraceScanFinished(struct _EXP_LOOKASIDE_MGR *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_140E09178 > 4 && (byte_140E09188 & 1) != 0 && (qword_140E09190 & 1) == qword_140E09190 )
  {
    v7 = *((_DWORD *)a1 + 4);
    v5 = a2;
    v4 = a3;
