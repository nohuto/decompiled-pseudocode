/*
 * XREFs of DifKeCancelTimer2Wrapper @ 0x140664270
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeCancelTimer2Wrapper(__int64 a1, __int64 a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(475);
