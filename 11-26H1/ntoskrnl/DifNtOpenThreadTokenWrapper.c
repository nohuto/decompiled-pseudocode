/*
 * XREFs of DifNtOpenThreadTokenWrapper @ 0x140683020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenThreadTokenWrapper(void *a1, ACCESS_MASK a2, BOOLEAN a3, HANDLE *a4)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(479);
  ...
  LODWORD(v19) = NtOpenThreadToken(a1, a2, a3, a4);
  if ( v9 )
  {
