/*
 * XREFs of DifKeResetEventWrapper @ 0x140667AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeResetEventWrapper(PRKEVENT Event)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(252);
  ...
  LODWORD(v14) = KeResetEvent(Event);
  if ( v4 )
  {
