/*
 * XREFs of DifZwAlpcCreateSecurityContextWrapper @ 0x14069EA50
 * Callers:
 *     <none>
 * Callees:
        ...
        PALPC_SECURITY_ATTR SecurityAttribute)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    *((_QWORD *)&v18 + 1) = PortHandle;
    LODWORD(v18) = Flags;
    *((_QWORD *)&v17 + 1) = SecurityAttribute;
  ...
  LODWORD(v19) = ZwAlpcCreateSecurityContext(PortHandle, Flags, SecurityAttribute);
  if ( v8 )
  {
