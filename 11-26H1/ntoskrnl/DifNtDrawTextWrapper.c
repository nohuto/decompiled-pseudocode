/*
 * XREFs of DifNtDrawTextWrapper @ 0x14067A1E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtDrawTextWrapper(PUNICODE_STRING Text)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(732);
