/*
 * XREFs of DifNtLockFileWrapper @ 0x14067E8A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtLockFileWrapper(
        void *a1,
        void *a2,
...
LABEL_17:
  v35 = NtLockFile(a1, a2, a3, a4, IoStatusBlock, ByteOffset, Length, Key, FailImmediately, ExclusiveLock);
  if ( v15 )
  {
