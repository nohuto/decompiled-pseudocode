/*
 * XREFs of _CmCreateInterfaceClassWorker @ 0x140AF5360
 * Callers:
...
__int64 __fastcall CmCreateInterfaceClassWorker(__int64 a1, __int64 a2, __int64 a3, HANDLE *a4, _BYTE *a5, __int16 a6)
{
  int v9; // ebx
  ...
  {
    v9 = CmOpenInterfaceClassRegKey(a1, a2, a3, (__int64)a4, a3, 1, a4, v11);
    if ( v9 >= 0 )
    {
      if ( v11[0] == 1 )
      {
