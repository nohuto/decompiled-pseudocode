/*
 * XREFs of DifMmUnsecureVirtualMemoryWrapper @ 0x14066C6A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifMmUnsecureVirtualMemoryWrapper(HANDLE SecureHandle)
{
  ...
  v12 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(209);
