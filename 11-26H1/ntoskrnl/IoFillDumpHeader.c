/*
 * XREFs of IoFillDumpHeader @ 0x1405C6688
 * Callers:
 ...
 *     KeInitializeCrashDumpHeader @ 0x1405CA4C0 (KeInitializeCrashDumpHeader.c)
        ...
        __int64 a8)
{
  ...
  *((_QWORD *)a1 + 5) = &PsAltSystemCallRegistrationLock.WaitBlock[0].Thread;
...
LABEL_26:
  ...
  *((_DWORD *)a1 + 1045) = MEMORY[0xFFFFF780000002C4];
  *((_DWORD *)a1 + 1044) = 0;
  if ( VslVsmEnabled )
    *((_DWORD *)a1 + 1044) = 2048;
  return result;
