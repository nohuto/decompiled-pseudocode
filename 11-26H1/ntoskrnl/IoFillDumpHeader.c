/*
 * XREFs of IoFillDumpHeader @ 0x1405C8F58
 * Callers:
 ...
 *     KeInitializeCrashDumpHeader @ 0x1405CCD90 (KeInitializeCrashDumpHeader.c)
        ...
        __int64 a8)
{
  ...
  *((_QWORD *)a1 + 5) = &PsAltSystemCallRegistrationLock.WaitBlock[2];
...
LABEL_26:
  ...
  *((_QWORD *)a1 + 482) = 0LL;
  ...
  a1[1045] = MEMORY[0xFFFFF780000002C4];
  a1[1044] = 0;
  if ( VslVsmEnabled )
    a1[1044] = 2048;
  return result;
