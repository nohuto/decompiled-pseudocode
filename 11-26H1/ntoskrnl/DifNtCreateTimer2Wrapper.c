/*
 * XREFs of DifNtCreateTimer2Wrapper @ 0x140674200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtCreateTimer2Wrapper(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(704);
  ...
  DWORD2(v21) = NtCreateTimer2(a1, a2, a3, a4, a5);
  if ( v10 )
  {
