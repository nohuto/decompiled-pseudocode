/*
 * XREFs of DifNtSetIRTimerWrapper @ 0x14068F030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetIRTimerWrapper(HANDLE Handle, _QWORD *a2)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(703);
  ...
  DWORD2(v16) = ExpSetTimer2(Handle, a2, 0LL, 0LL);
  if ( v6 )
  {
