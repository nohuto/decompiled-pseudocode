/*
 * XREFs of DifExRegisterCallbackWrapper @ 0x1406572F0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID CallbackContext)
{
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = CallbackObject;
    *(_QWORD *)&v18 = CallbackFunction;
    *((_QWORD *)&v17 + 1) = CallbackContext;
  ...
  v19 = ExRegisterCallback(CallbackObject, CallbackFunction, CallbackContext);
  if ( v8 )
  {
