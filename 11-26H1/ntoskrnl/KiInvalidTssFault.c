...
void __fastcall __noreturn KiInvalidTssFault(__int64 a1, __int64 _RDX)
{
  ...
  if ( (v9 & 1) != 0 && (KeGetCurrentThread()->Header.Reserved1 & 0x80u) != 0 )
    KiSynchronizeUserIsolationDomainExit(a1, _RDX);
  if ( (KiTrapFeatures & 8) != 0 && ((v9 & 1) != 0 || (KiTrapFeatures & 2) != 0 && (*(_DWORD *)v10 & 0x40000) != 0) )
    __asm { stac }
  if ( (*(_WORD *)v10 & 0x200) != 0 )
    _enable();
  v6 = (unsigned int)retaddr;
  v7 = __readcr0();
  KiBugCheckDispatch(127LL, 10LL, v7, v6);
}
