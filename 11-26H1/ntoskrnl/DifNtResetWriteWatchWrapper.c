/*
 * XREFs of DifNtResetWriteWatchWrapper @ 0x140689D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtResetWriteWatchWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtResetWriteWatch(a1, a2, a3);
  if ( v8 )
  {
