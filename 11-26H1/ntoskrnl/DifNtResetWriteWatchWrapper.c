/*
 * XREFs of DifNtResetWriteWatchWrapper @ 0x14068D940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtResetWriteWatchWrapper(HANDLE ProcessHandle, PVOID BaseAddress, SIZE_T RegionSize)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(783);
  ...
  LODWORD(v19) = NtResetWriteWatch(ProcessHandle, BaseAddress, RegionSize);
  if ( v8 )
  {
