/*
 * XREFs of ?ReadHeader@SC_GPT@@AEAAJKPEAVGPT_HEADER@@@Z @ 0x14071EAC0
 * Callers:
...
__int64 __fastcall SC_GPT::ReadHeader(SC_DISK **this, int a2, struct GPT_HEADER *a3)
{
  ...
  if ( Sectors >= 0 )
  {
      ...
      && *((_DWORD *)a3 + 21) == 128 )
    {
      ...
      if ( v7 )
      {
        if ( v7 <= 0x400 && *((_QWORD *)a3 + 3) == v5 )
        {
          v8 = *((_DWORD *)a3 + 4);
          *((_DWORD *)a3 + 4) = 0;
          v9 = crc32(0LL, (__int64)a3, 0x5Cu);
          *((_DWORD *)a3 + 4) = v8;
          if ( v9 == v8 )
            return *((_QWORD *)a3 + 5) < (unsigned __int64)(((((v7 << 7) + *((_DWORD *)*this + 59) - 1) & -*((_DWORD *)*this + 59)) >> *((_DWORD *)*this + 60))
                                                          + 2)
                 ? 0xC0000032
                 : 0;
        }
