/*
 * XREFs of DifZwCreateSymbolicLinkObjectWrapper @ 0x1406A5AC0
 * Callers:
 *     <none>
 * Callees:
        ...
        UNICODE_STRING *a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(118);
  ...
  DWORD2(v20) = ZwCreateSymbolicLinkObject(a1, a2, a3, a4);
  if ( v9 )
  {
