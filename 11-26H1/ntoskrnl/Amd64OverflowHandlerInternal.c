...
unsigned __int64 __fastcall Amd64OverflowHandlerInternal(int a1, unsigned int a2, __int64 a3)
{
  ...
  __int64 v37; // r8
  unsigned __int64 v38; // [rsp+20h] [rbp-78h]
...
LABEL_25:
          ...
          if ( result < 0xFFFF80000001LL )
          {
            v38 = __readmsr(v16);
            v23 = v38;
            __writemsr(v16, v38 & 0xFFFFFFFFFFAFFFFFuLL);
            if ( v12 )
            {
            ...
            else
            {
              ...
              if ( HalpTimerProfilingCallback )
                guard_dispatch_icall_no_overrides(v5, (v38 & 0xFFFFFFFFFFAFFFFFuLL) >> 32);
              else
