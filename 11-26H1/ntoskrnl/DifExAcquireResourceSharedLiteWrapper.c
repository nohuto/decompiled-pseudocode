/*
 * XREFs of DifExAcquireResourceSharedLiteWrapper @ 0x140652CB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifExAcquireResourceSharedLiteWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  BYTE8(v16) = ExAcquireResourceSharedLite(Resource, a2);
  if ( v6 )
  {
