/*
 * XREFs of DifZwOpenProcessTokenWrapper @ 0x1406B0A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenProcessTokenWrapper(HANDLE ProcessHandle, ACCESS_MASK DesiredAccess, PHANDLE TokenHandle)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(78);
  ...
  LODWORD(v19) = ZwOpenProcessToken(ProcessHandle, DesiredAccess, TokenHandle);
  if ( v8 )
  {
