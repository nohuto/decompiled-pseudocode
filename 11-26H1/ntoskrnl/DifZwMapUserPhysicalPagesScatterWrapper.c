/*
 * XREFs of DifZwMapUserPhysicalPagesScatterWrapper @ 0x1406ADA70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwMapUserPhysicalPagesScatterWrapper(
        ...
        PULONG_PTR UserPfnArray)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1080);
  ...
  if ( APIThunkContextById )
  {
    ...
    v10 = 0;
    *((_QWORD *)&v18 + 1) = VirtualAddresses;
    *(_QWORD *)&v18 = NumberOfPages;
    *((_QWORD *)&v17 + 1) = UserPfnArray;
  ...
  LODWORD(v19) = ZwMapUserPhysicalPagesScatter(VirtualAddresses, NumberOfPages, UserPfnArray);
  if ( v8 )
  {
