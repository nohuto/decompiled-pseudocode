/*
 * XREFs of DifZwMapUserPhysicalPagesScatterWrapper @ 0x1406A9E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwMapUserPhysicalPagesScatterWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwMapUserPhysicalPagesScatter(a1, a2, a3);
  if ( v8 )
  {
