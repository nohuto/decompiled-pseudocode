/*
 * XREFs of DifNtOpenIoCompletionWrapper @ 0x140680F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenIoCompletionWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  LODWORD(v19) = NtOpenIoCompletion(IoCompletionHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
