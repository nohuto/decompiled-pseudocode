/*
 * XREFs of DifNtOpenIoCompletionWrapper @ 0x14067D350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtOpenIoCompletionWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  LODWORD(v19) = NtOpenIoCompletion(a1, a2, a3);
  if ( v8 )
  {
