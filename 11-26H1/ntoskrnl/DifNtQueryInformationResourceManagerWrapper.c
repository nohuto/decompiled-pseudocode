/*
 * XREFs of DifNtQueryInformationResourceManagerWrapper @ 0x140686EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtQueryInformationResourceManagerWrapper(
        void *a1,
        ...
        ULONG *ReturnLength)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(848);
  ...
  LODWORD(v21) = NtQueryInformationResourceManager(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
