/*
 * XREFs of KiCommitThreadWait @ 0x1402229B0
 * Callers:
 ...
 *     KiInsertPrcbWaitEntry @ 0x140418340 (KiInsertPrcbWaitEntry.c)
 *     KiIncrementConcurrencyCount @ 0x140448040 (KiIncrementConcurrencyCount.c)
