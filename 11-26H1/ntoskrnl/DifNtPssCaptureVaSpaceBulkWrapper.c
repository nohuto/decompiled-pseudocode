/*
 * XREFs of DifNtPssCaptureVaSpaceBulkWrapper @ 0x140680D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPssCaptureVaSpaceBulkWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(751);
  ...
  LODWORD(v21) = NtPssCaptureVaSpaceBulk(a1, a2, a3, a4, a5);
  if ( v10 )
  {
