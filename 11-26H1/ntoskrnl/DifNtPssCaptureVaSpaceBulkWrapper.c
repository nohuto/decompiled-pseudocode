/*
 * XREFs of DifNtPssCaptureVaSpaceBulkWrapper @ 0x140684960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtPssCaptureVaSpaceBulkWrapper(
        void *a1,
        void *a2,
        _NTPSS_MEMORY_BULK_INFORMATION *a3,
        SIZE_T a4,
        ULONG_PTR *ReturnLength)
{
  ...
  LODWORD(v21) = NtPssCaptureVaSpaceBulk(a1, a2, a3, a4, ReturnLength);
  if ( v10 )
  {
