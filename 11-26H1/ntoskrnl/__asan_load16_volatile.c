/*
 * XREFs of __asan_load16_volatile @ 0x1405E0E80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_load16_volatile(ULONG_PTR BugCheckParameter1)
{
  char v2; // cl
  signed __int8 v3; // al
  char v4; // dl
...
LABEL_39:
  ...
  if ( KcsaniValidationEnabled )
    KcsanValidateAddress(BugCheckParameter1, 16, 0, 1, retaddr);
}
