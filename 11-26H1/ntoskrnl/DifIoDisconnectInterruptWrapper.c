/*
 * XREFs of DifIoDisconnectInterruptWrapper @ 0x14065F790
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifIoDisconnectInterruptWrapper(PKINTERRUPT InterruptObject)
{
