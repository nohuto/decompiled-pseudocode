/*
 * XREFs of DifZwCreateWorkerFactoryWrapper @ 0x1406A7490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateWorkerFactoryWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        SIZE_T StackCommit)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(1116);
...
LABEL_17:
  WorkerFactory = ZwCreateWorkerFactory(
                    a1,
                    a2,
                    a3,
                    a4,
