/*
 * XREFs of LdrpResSearchResourceMappedFile @ 0x1403DAAE8
 * Callers:
 ...
 *     LdrIsResItemExist @ 0x1403DC648 (LdrIsResItemExist.c)
        ...
        __int64 a9)
{
  ...
  __int64 v45; // rax
  int v46; // r11d
  unsigned __int16 v47; // [rsp+70h] [rbp-398h] BYREF
  int Key; // [rsp+78h] [rbp-390h] BYREF
  __int64 v49; // [rsp+80h] [rbp-388h]
  bool v50; // [rsp+88h] [rbp-380h]
  __int64 v51; // [rsp+90h] [rbp-378h] BYREF
  __int64 v52; // [rsp+98h] [rbp-370h] BYREF
  const wchar_t **v53; // [rsp+A0h] [rbp-368h]
  int v54; // [rsp+A8h] [rbp-360h]
  int v55; // [rsp+ACh] [rbp-35Ch]
  __int64 v56; // [rsp+B0h] [rbp-358h]
  ...
  __int64 v61; // [rsp+D8h] [rbp-330h] BYREF
  __int64 v62; // [rsp+E0h] [rbp-328h] BYREF
    ...
    if ( v15 >= 1 && v15 <= 3 )
    {
      ...
      if ( (a3 & 0x1000000) == 0
        && (((unsigned __int64)(*v53 - 8) & 0xFFFFFFFFFFFFFFF7uLL) != 0 && !v11
         ...
         || v35 == 3072) )
      {
        RCConfig = LdrResGetRCConfig(v49, v56, 0, a3, 1);
        ...
        {
          v17 = v49;
          v16 = v13 | LdrIsResItemExist(v49, v53, v39, 0LL);
        }
        goto LABEL_9;
      }
      a3 |= 0x10u;
...
LABEL_9:
  ...
  {
    result = LdrpResGetResourceDirectory(v17, v56, a3, (unsigned int)&v61, (__int64)&v59);
    if ( (int)result < 0 )
      return result;
  }
  MappingSize = 0;
...
LABEL_22:
  ...
  if ( !v51 )
  {
    MappingSize = LdrpResGetMappingSize(v52, &v51, 512LL, 0LL);
    v37 = v51;
  }
  if ( (a3 & 0x1000) != 0 && MappingSize < 0 )
    goto LABEL_50;
  MappingSize = LdrpResGetResourceDirectory(v52, v37, a3, (unsigned int)&v62, (__int64)&v60);
  if ( MappingSize < 0 )
    goto LABEL_48;
LABEL_23:
  ...
  {
    v41 = v63 ? *v63 : v57;
    MappingSize = LdrpFindMessageInAlternateModule(v52, *v58, v41, *((_DWORD *)v53 + 6), 1);
    if ( MappingSize < 0 )
    {
      *v58 = 0LL;
  ...
  {
    LOWORD(Key) = v47;
    v40 = (const unsigned __int16 **)bsearch(&Key, &off_140002460, 0x1B4uLL, 0x10uLL, CompareLangIDs);
    if ( v40 )
    {
      v44 = *v40;
      v42 = -1LL;
