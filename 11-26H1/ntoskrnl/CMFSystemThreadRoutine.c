/*
 * XREFs of CMFSystemThreadRoutine @ 0x140849290
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CMFGetLargePageSectionSize @ 0x140848CDC (CMFGetLargePageSectionSize.c)
...
LABEL_14:
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( (v9 & 0xC0000000) == 0xC0000000 )
      goto LABEL_14;
    v9 = ZwReadFile(FileHandle, EventHandle, 0LL, 0LL, &IoStatusBlock, v10, Length, &SectionOffset, 0LL);
    if ( v9 < 0 )
      goto LABEL_14;
