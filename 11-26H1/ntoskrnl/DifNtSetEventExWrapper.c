/*
 * XREFs of DifNtSetEventExWrapper @ 0x14068ED40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtSetEventExWrapper(HANDLE Handle, __int64 a2, __int64 a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(682);
  ...
  LODWORD(v19) = NtSetEventEx(Handle);
  if ( v8 )
  {
