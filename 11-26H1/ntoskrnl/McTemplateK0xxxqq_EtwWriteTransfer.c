/*
 * XREFs of McTemplateK0xxxqq_EtwWriteTransfer @ 0x1405B7B38
 * Callers:
 *     FsRtlDedupChangeLogWrite @ 0x14078FA00 (FsRtlDedupChangeLogWrite.c)
 *     FsRtlHeatLogIo @ 0x1407903A0 (FsRtlHeatLogIo.c)
 * Callees:
