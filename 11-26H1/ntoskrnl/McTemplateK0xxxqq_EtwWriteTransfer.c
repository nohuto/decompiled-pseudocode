/*
 * XREFs of McTemplateK0xxxqq_EtwWriteTransfer @ 0x1405BA3A8
 * Callers:
 *     FsRtlDedupChangeLogWrite @ 0x140792530 (FsRtlDedupChangeLogWrite.c)
 *     FsRtlHeatLogIo @ 0x140792ED0 (FsRtlHeatLogIo.c)
 * Callees:
