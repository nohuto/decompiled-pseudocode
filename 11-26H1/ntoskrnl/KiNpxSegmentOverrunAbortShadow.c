/*
 * XREFs of KiNpxSegmentOverrunAbortShadow @ 0x140C5F5C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall __noreturn KiNpxSegmentOverrunAbortShadow(__int64 a1, __int64 a2)
{
  ...
  if ( (v7.OffsetLow & 1) != 0 )
  {
    ...
    KiNpxSegmentOverrunAbort(a1, a2);
  }
  _mm_lfence();
  KiNpxSegmentOverrunAbort(a1, a2);
}
