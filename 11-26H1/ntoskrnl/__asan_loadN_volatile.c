/*
 * XREFs of __asan_loadN_volatile @ 0x1405E2050
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _asan_loadN_volatile(ULONG_PTR BugCheckParameter1, ULONG_PTR a2)
{
...
LABEL_8:
    ...
    if ( KcsaniValidationEnabled )
      KcsanValidateAddress(BugCheckParameter1, a2, 0, 1, retaddr);
  }
}
