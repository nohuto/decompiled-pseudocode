/*
 * XREFs of CcInitializeNumaNodeForVolume @ 0x1403E7414
 * Callers:
...
LABEL_4:
    ...
    *(_QWORD *)(PoolWithTagFromNode + 56) = *(_QWORD *)(a1 + 32);
  ...
  {
    v17 = ExAllocatePoolWithTagFromNode((__int64)v7, 0x50uLL, 0x71576343u, v13);
    v7 = (_QWORD *)v17;
    if ( !v17 )
      goto LABEL_4;
    *(_DWORD *)(v17 + 32) = 2;
  ...
  {
    v20 = ExAllocatePoolWithTagFromNode((__int64)v7, 0x50uLL, 0x71576343u, v13);
    v7 = (_QWORD *)v20;
    if ( !v20 )
      goto LABEL_4;
    *(_DWORD *)(v20 + 32) = 5;
