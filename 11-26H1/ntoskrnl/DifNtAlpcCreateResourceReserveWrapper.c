/*
 * XREFs of DifNtAlpcCreateResourceReserveWrapper @ 0x14066C690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtAlpcCreateResourceReserveWrapper(void *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  DWORD2(v20) = NtAlpcCreateResourceReserve(a1);
  if ( v9 )
  {
