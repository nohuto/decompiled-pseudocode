/*
 * XREFs of DifZwCreateDirectoryObjectWrapper @ 0x1406A2620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateDirectoryObjectWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(127);
  ...
  LODWORD(v19) = ZwCreateDirectoryObject(DirectoryHandle, DesiredAccess, ObjectAttributes);
  if ( v8 )
  {
