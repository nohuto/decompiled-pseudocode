/*
 * XREFs of DifZwQueueApcThreadWrapper @ 0x1406B92B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueueApcThreadWrapper(
        void *a1,
        void (__cdecl *a2)(PVOID, PVOID, PVOID),
        void *a3,
        void *a4,
        PVOID ApcArgument3)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(926);
  ...
  LODWORD(v21) = ZwQueueApcThread(a1, a2, a3, a4, ApcArgument3);
  if ( v10 )
  {
