/*
 * XREFs of MiUnlinkDecayClusterTimer @ 0x140462634
 * Callers:
...
unsigned __int64 __fastcall MiUnlinkDecayClusterTimer(__int64 a1)
{
  ...
  v5 = v3 >> 33;
  v6 = (v1 >> 22) & 3;
  v7 = *(_QWORD *)(stru_140E2EB88.ThreadLock + 8 * ((v2 >> 43) & 0x3FF));
  if ( v4 == 0x7FFFFFFF )
    *(_QWORD *)(v7 + 8 * v6 + 16448) ^= (v3 ^ *(_QWORD *)(v7 + 8 * v6 + 16448)) & 0xFFFFFFFE00000000uLL;
  else
    *(_QWORD *)(48 * (v4 + qword_140E347B0) - 0x220000000000LL + 8) ^= (v3 ^ *(_QWORD *)(48 * (v4 + qword_140E347B0)
                                                                                       - 0x220000000000LL
