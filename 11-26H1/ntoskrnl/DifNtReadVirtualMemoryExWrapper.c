/*
 * XREFs of DifNtReadVirtualMemoryExWrapper @ 0x14068BA50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifNtReadVirtualMemoryExWrapper(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  ...
  BOOLEAN v17; // di
  __int128 *j; // rbx
  PVOID v20; // [rsp+40h] [rbp-40h] BYREF
  ...
  APIThunkContextById = DifGetAPIThunkContextById(770);
...
LABEL_17:
  v27 = MiReadWriteVirtualMemory(a1, a2, a3, a4, a5, 16LL, a6);
  if ( v11 )
  {
