/*
 * XREFs of ExpGenuinePolicyPostProcess @ 0x14083E920
 * Callers:
 *     <none>
 * Callees:
        ...
        _BYTE *a6)
{
  ...
  *a6 = 0;
  ...
  if ( *a1 )
  {
    v9 = sub_14083E27C(a2, a3, a4, a5, 2);
    *a6 = 1;
...
LABEL_11:
  v9 = ZwQueryLicenseValue((PUNICODE_STRING)&stru_140BE0AC8, 0LL, &Data, 4u, &ResultDataSize);
  if ( v9 >= 0 && Data == 1 )
    return (unsigned int)v9;
  if ( !ExpPlatformBinaryLock.ThreadListEntry.Blink )
    return (unsigned int)-1073741637;
  v9 = guard_dispatch_icall_no_overrides((__int64)&v22, v12);
  if ( v9 < 0 )
    return (unsigned int)v9;
  if ( !ExpPlatformBinaryLock.SchedulerApc.NormalContext )
    return (unsigned int)-1073741637;
  v9 = ExpOsProductCacheProviderHelper(v13, &qword_140BDFD50, 0LL, 0LL, 0, &v20, v19);
  if ( v9 == -1073741789 )
  {
    v14 = v20;
    ...
    v9 = ExpOsProductCacheProviderHelper(v16, &qword_140BDFD50, 0LL, Pool2, v14, &v20, v19);
  }
  if ( v9 >= 0 )
  {
...
LABEL_26:
      if ( !v22 )
      {
        v9 = sub_14083E27C(a2, a3, a4, v24, 2);
        *a6 = 1;
      }
    }
  }
