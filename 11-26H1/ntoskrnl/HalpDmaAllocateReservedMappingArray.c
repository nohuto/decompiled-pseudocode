/*
 * XREFs of HalpDmaAllocateReservedMappingArray @ 0x140CB0424
 * Callers:
...
__int64 __fastcall HalpDmaAllocateReservedMappingArray(__int64 a1, unsigned int a2)
{
  ...
  if ( ((unsigned __int8)&stru_140E3E928.WaitBlockFill7[152] & 0xF) != 0 )
    RtlRaiseStatus(-2147483646);
  *(_OWORD *)&stru_140E3E928.WaitBlockFill11[152] = 0LL;
  stru_140E3E928.WaitBlock[3].Thread = 0LL;
  stru_140E3E928.QueueListEntry.Flink = (struct _LIST_ENTRY *)HalpMmAllocCtxAlloc(a1, 8LL * (unsigned int)a1);
  ...
  if ( stru_140E3E928.QueueListEntry.Flink )
  {
    ...
    if ( a2 )
    {
      ...
      do
      {
        ...
        Flink = stru_140E3E928.QueueListEntry.Flink;
        *(struct _LIST_ENTRY **)((char *)&stru_140E3E928.QueueListEntry.Flink->Flink + v6) = ReservedMapping;
        if ( !ReservedMapping )
          break;
        RtlpInterlockedPushEntrySList(
          (PSLIST_HEADER)&stru_140E3E928.WaitBlockFill11[152],
          (PSLIST_ENTRY)ReservedMapping);
        Flink = stru_140E3E928.QueueListEntry.Flink;
        ++v5;
        v8 = *(__int64 *)((char *)&stru_140E3E928.QueueListEntry.Flink->Flink + v6);
        v6 += 8LL;
        *(_DWORD *)(v8 + 28) = 1;
      }
      while ( v5 < a2 );
      if ( v5 )
      {
        *(_DWORD *)&stru_140E3E928.WaitBlockFill11[148] = v5;
        return 0LL;
      }
    }
