/*
 * XREFs of DifZwCreateEventWrapper @ 0x1406A2CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwCreateEventWrapper(
        HANDLE *a1,
        ACCESS_MASK a2,
        ...
        BOOLEAN InitialState)
{
  ...
  DWORD2(v21) = ZwCreateEvent(a1, a2, a3, a4, InitialState);
  if ( v10 )
  {
