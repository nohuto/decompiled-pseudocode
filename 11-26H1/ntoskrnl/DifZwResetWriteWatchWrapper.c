/*
 * XREFs of DifZwResetWriteWatchWrapper @ 0x1406BBB50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwResetWriteWatchWrapper(HANDLE ProcessHandle, PVOID BaseAddress, SIZE_T RegionSize)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(1085);
  ...
  LODWORD(v19) = ZwResetWriteWatch(ProcessHandle, BaseAddress, RegionSize);
  if ( v8 )
  {
