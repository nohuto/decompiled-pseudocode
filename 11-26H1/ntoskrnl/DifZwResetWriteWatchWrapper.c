/*
 * XREFs of DifZwResetWriteWatchWrapper @ 0x1406B7F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwResetWriteWatchWrapper(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v19) = ZwResetWriteWatch(a1, a2, a3);
  if ( v8 )
  {
