/*
 * XREFs of ?NpNodeAllocate@NP_CONTEXT@@SAPEAXPEAUNP_CTX@1@KK@Z @ 0x1403EB618
 * Callers:
 ...
 *     ?NpiGetReservedBuffer@NP_CONTEXT@@SAPEAXPEAU1@PEAUNP_CTX@1@@Z @ 0x14063FF6C (-NpiGetReservedBuffer@NP_CONTEXT@@SAPEAXPEAU1@PEAUNP_CTX@1@@Z.c)
...
void *__fastcall NP_CONTEXT::NpNodeAllocate(struct NP_CONTEXT::NP_CTX *a1, __int64 a2, char a3)
{
  ...
  v3 = *(_QWORD *)a1;
  Pool3 = ExAllocatePool3(64LL, 4096LL, 1884188019LL, &stru_140E27C48.Header.WaitListHead.Blink, 1);
