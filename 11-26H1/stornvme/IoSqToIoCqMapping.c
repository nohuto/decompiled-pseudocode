/*
 * XREFs of IoSqToIoCqMapping @ 0x140015574
 * Callers:
 ...
 *     NVMeGetCompletionQueueForAssignment @ 0x140017DE4 (NVMeGetCompletionQueueForAssignment.c)
 *     NVMeLogHeterogeneousQueueMappingFallback @ 0x1400185DC (NVMeLogHeterogeneousQueueMappingFallback.c)
 *     NVMeTelemetryHeterogeneousQueueMappingFallback @ 0x1400191AC (NVMeTelemetryHeterogeneousQueueMappingFallback.c)
 */
...
char __fastcall IoSqToIoCqMapping(__int64 a1)
{
  ...
  unsigned int v48; // [rsp+94h] [rbp+Bh]
  unsigned __int16 v49; // [rsp+F0h] [rbp+67h] BYREF
  int v50; // [rsp+F8h] [rbp+6Fh] BYREF
  int v51; // [rsp+100h] [rbp+77h] BYREF
  ...
  do
  {
    if ( !(unsigned int)StorPortExtendedFunction(116LL, a1, *(unsigned int *)(*(_QWORD *)(a1 + 264) + 72LL * v1), &v47)
      && v47 )
    {
      for ( i = 0; i < *v4; ++i )
      {
        v19 = *(_QWORD *)(a1 + 280);
        if ( *(_DWORD *)(v19 + 24LL * i) == v47 )
        {
