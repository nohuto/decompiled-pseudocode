/*
 * XREFs of NVMeGetFeatureIdentifiersSupportedLog @ 0x140005F30
 * Callers:
...
__int64 __fastcall NVMeGetFeatureIdentifiersSupportedLog(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( !*(_BYTE *)(a1 + 20) && (*(_BYTE *)(result + 261) & 0x20) != 0 )
  {
    ...
    {
      result = NVMeAllocateDmaBufferEx(a1, 0, 1, 1024, (__int64)v6, (__int64)&v11);
      v7 = *v6;
      if ( !*v6 )
        return result;
      v8 = v11;
    ...
    *(_BYTE *)(v4 + 4225) |= 3u;
    LOBYTE(v9) = 18;
    *(_WORD *)(v4 + 4212) = 0;
    BuildGetLogPageCommand(a1, v4, v9, 1024, v8, -1, 0LL, 0);
    *(_BYTE *)(v4 + 4225) |= 4u;
    *(_QWORD *)(v4 + 4160) = *v6;
    *(_QWORD *)(v4 + 4168) = v8;
    *(_DWORD *)(v4 + 4208) = 1024;
    ...
    {
      LOBYTE(v10) = 1;
      result = NVMeFreeDmaBufferEx(a1, 0, v10, 1024, (__int64)v6, *(_QWORD *)(a1 + 4264));
      *v6 = 0LL;
      *(_QWORD *)(a1 + 4264) = 0LL;
    }
  }
