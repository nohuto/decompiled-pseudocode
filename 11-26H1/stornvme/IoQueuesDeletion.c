/*
 * XREFs of IoQueuesDeletion @ 0x14000C4A0
 * Callers:
...
__int64 __fastcall IoQueuesDeletion(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_WORD *)(a1 + 330) )
  {
    ...
    do
    {
      v6 = NVMeIoSubmissionQueueDelete(a1, v13 + 1);
      if ( !v6 )
      {
        *(_DWORD *)(a1 + 28) = 15;
  ...
  do
  {
    v14 = NVMeIoCompletionQueueDelete(a1, (unsigned int)(v5 + 1));
    if ( !v14 )
    {
      *(_DWORD *)(a1 + 28) = 16;
      StorPortExtendedFunction(98LL, a1, 0LL, 10LL);
