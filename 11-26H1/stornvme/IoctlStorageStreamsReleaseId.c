/*
 * XREFs of IoctlStorageStreamsReleaseId @ 0x14001CC20
 * Callers:
...
LABEL_21:
  ...
  if ( (unsigned int)v6 < *(_DWORD *)(v4 + 224) && *(_QWORD *)(v4 + 8LL * v6 + 1672) )
  {
    _mm_lfence();
    v8 = *(unsigned int *)(*(_QWORD *)(v4 + 8LL * v6 + 1672) + 16LL);
  }
  else
  {
    v8 = 0LL;
  }
  result = NVMeDirectiveStreamsReleaseId(v4, v8, *((unsigned __int16 *)SrbDataBuffer + 18));
