/*
 * XREFs of GetRegistrySettingsForSpecificKey @ 0x14003020C
 * Callers:
 *     NVMeControllerValidateFirmwareActivateCapability @ 0x14001D550 (NVMeControllerValidateFirmwareActivateCapability.c)
 * Callees:
 *     ReadMultiSzRegistryValueAndCompareId @ 0x1400304D0 (ReadMultiSzRegistryValueAndCompareId.c)
 *     UlongToHex @ 0x1400308DC (UlongToHex.c)
