/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x140014220
 * Callers:
 ...
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x140014384 (wil_details_GetCurrentFeatureEnabledState.c)
