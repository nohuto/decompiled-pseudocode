/*
 * XREFs of __report_gsfailure @ 0x180002C10
 * Callers:
 *     __security_check_cookie @ 0x1800021F0 (__security_check_cookie.c)
 * Callees:
 *     __raise_securityfailure @ 0x180002BCC (__raise_securityfailure.c)
 *     capture_previous_context @ 0x180002CEC (capture_previous_context.c)
 */
