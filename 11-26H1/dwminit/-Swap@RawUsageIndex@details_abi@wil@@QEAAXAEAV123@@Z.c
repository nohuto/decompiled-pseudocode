/*
 * XREFs of ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x18000C398
 * Callers:
 *     ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x180007538 (--1FeatureStateData@details_abi@wil@@QEAA@XZ.c)
 *     ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x18000ABE4 (-RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
