/*
 * XREFs of ??0CallWithHangTimeout@@QEAA@W4TimeoutDuration@0@@Z @ 0x180007080
 * Callers:
  ...
  *((_QWORD *)a1 + 2) = 0LL;
  ...
  if ( !IsDebuggerPresent() )
  {
    ...
    ThreadpoolTimer = CreateThreadpoolTimer(
                        (PTP_TIMER_CALLBACK)`CallWithHangTimeout::CallWithHangTimeout'::`2'::_lambda_1_::_lambda_invoker_cdecl_,
                        a1,
                        0LL);
