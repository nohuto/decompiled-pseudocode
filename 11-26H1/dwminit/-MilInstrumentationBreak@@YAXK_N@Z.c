/*
 * XREFs of ?MilInstrumentationBreak@@YAXK_N@Z @ 0x18000F0BC
 * Callers:
 ...
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x18000F270 (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
...
void __fastcall MilInstrumentationBreak(const unsigned __int16 *a1, const unsigned __int16 *a2)
{
  ...
  if ( !g_fDisableInstrumentationBreaks )
  {
    ...
    if ( RegGetHKLMDword(a1, a2, &v4) && !v4 )
    {
      ...
      {
        if ( !byte_18001E64A )
          byte_18001E64A = NtQuerySystemInformation(SystemKernelDebuggerInformation, &byte_18001E648, 2u, 0LL) >= 0;
        if ( byte_18001E648 )
LABEL_10:
