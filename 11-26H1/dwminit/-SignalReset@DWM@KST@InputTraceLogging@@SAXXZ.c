/*
 * XREFs of ?SignalReset@DWM@KST@InputTraceLogging@@SAXXZ @ 0x1800108B4
 * Callers:
 *     ?Stop@CKstBase@@QEAAXXZ @ 0x180010B08 (-Stop@CKstBase@@QEAAXXZ.c)
 * Callees:
...
void InputTraceLogging::KST::DWM::SignalReset(void)
{
  ...
  if ( *(_DWORD *)v0 > 4u && (*((_BYTE *)v0 + 16) & 2) != 0 && (*((_QWORD *)v0 + 3) & 2LL) == *((_QWORD *)v0 + 3) )
    tlgWriteTransfer_EventWriteTransfer((__int64)v0, byte_180015B12, 0LL, 0LL, 2u, &v1);
}
