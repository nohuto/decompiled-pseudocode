/*
 * XREFs of dllmain_crt_process_attach @ 0x180003908
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x1800023B4 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x180002488 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x180002528 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x180002DB8 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180003CE0 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180003D08 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180003D2C (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x180003D3C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180003DC1 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180003DCD (_initterm_e_0.c)
