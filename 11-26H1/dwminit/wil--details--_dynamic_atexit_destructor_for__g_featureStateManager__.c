/*
 * XREFs of wil::details::_dynamic_atexit_destructor_for__g_featureStateManager__ @ 0x1800115E0
 * Callers:
 *     <none>
 * Callees:
...
void wil::details::_dynamic_atexit_destructor_for__g_featureStateManager__()
{
    ...
    || wil::details::g_pfnDllShutdownInProgress && (unsigned __int8)wil::details::g_pfnDllShutdownInProgress() )
  {
    ...
    if ( qword_18001A0C8 )
      wil::details_abi::ProcessLocalStorageData<wil::details_abi::FeatureStateData>::Release((char *)qword_18001A0C8);
  }
  else
  {
