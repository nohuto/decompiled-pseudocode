/*
 * XREFs of DwmpCreateSessionProcess @ 0x18000D9E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OneCoreSkipDwmLaunch@@YA_NXZ @ 0x18000A1F0 (-OneCoreSkipDwmLaunch@@YA_NXZ.c)
...
__int64 __fastcall DwmpCreateSessionProcess(PVOID Parameter)
{
  ...
  else if ( gDwmFirstLaunch )
  {
    ...
    if ( !Thread )
    {
      ...
      if ( v2 >= 0 )
        v2 = -2003304445;
      DoStackCaptureDirect(v2, 0x638u);
    }
  }
  else
  {
