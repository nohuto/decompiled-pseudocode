/*
 * XREFs of ?AddSidMappingToLsa@@YAJPEAU_UNICODE_STRING@@0PEAXPEAW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x180007DE4
 * Callers:
        ...
        enum _LSA_SID_NAME_MAPPING_OPERATION_ERROR *a4)
{
  ...
  *(_QWORD *)&v9[32] = a3;
  ...
  {
    v5 = v7 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(4u, &dword_180014D48, 3u, v7 | 0x10000000, 0x1E0u, 0LL);
  }
  if ( Buffer )
  {
    v6 = *(_DWORD *)Buffer;
