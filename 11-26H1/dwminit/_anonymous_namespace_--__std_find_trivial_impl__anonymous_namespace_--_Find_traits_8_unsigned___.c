/*
 * XREFs of _anonymous_namespace_::__std_find_trivial_impl__anonymous_namespace_::_Find_traits_8_unsigned___int64_ @ 0x180002060
 * Callers:
...
LABEL_9:
    ...
    _RAX = (char *)&unk_180013C10 - (v11 & 0xFFFFFFFC);
    __asm
    {
