/*
 * XREFs of ??$ReportFailure_Hr@$00@details@wil@@YAXPEAXIPEBD110JW4FailureFlags@1@@Z @ 0x180003FCC
 * Callers:
        ...
        wil::details *a7)
{
  ...
  v12[2] = 0;
  return wil::details::ReportFailure_Base<1,0>(v9, v7, v8, v9, v11, a6, (int)v12);
}
