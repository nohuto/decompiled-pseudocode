/*
 * XREFs of ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x180007620
 * Callers:
 ...
 *     ?Unsubscribe@SubscriptionList@details_abi@wil@@QEAAXAEAVsrwlock@3@PEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x18000C5E4 (-Unsubscribe@SubscriptionList@details_abi@wil@@QEAAXAEAVsrwlock@3@PEAUFEATURE_STATE_CHANGE_SUBSC.c)
...
void __fastcall wil::details::FeatureStateManager::~FeatureStateManager(wil::details::FeatureStateManager *this)
{
  ...
  *((_QWORD *)this + 32) = 0LL;
  ...
  if ( v4 && qword_18001A0D0 )
    wil::details_abi::SubscriptionList::Unsubscribe((LPCRITICAL_SECTION)&qword_18001A0D0[25], qword_18001A0D0, v4);
