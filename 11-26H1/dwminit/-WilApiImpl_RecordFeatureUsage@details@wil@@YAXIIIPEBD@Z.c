/*
 * XREFs of ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x18000CBF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_19:
  ...
  {
    wil::details_abi::SubscriptionList::OnSignaled((LPCRITICAL_SECTION)&qword_18001A0D0[25], qword_18001A0D0);
    wil::details_abi::FeatureStateData::RecordUsage(qword_18001A0D0);
  }
}
