/*
 * XREFs of StorpTelemetryNvmeSendNamespacePerfData @ 0x1400BF5B8
 * Callers:
...
__int64 __fastcall StorpTelemetryNvmeSendNamespacePerfData(__int64 a1)
{
  ...
  v3 = *(_QWORD *)(a1 + 608);
  v4 = (unsigned int)qword_1401730B0;
  Pool = 0LL;
  v6 = 0LL;
  v54 = 0LL;
  v55 = 0LL;
    ...
    if ( Pool
      && (RecommendedSharedDataAlignment = KeGetRecommendedSharedDataAlignment(),
          ...
          (v6 = (_QWORD *)RaidAllocatePool(
                            72LL,
                            -RecommendedSharedDataAlignment & (v9 + 24 * (_DWORD)v4 - 1),
                            1700028754LL,
                            *(_QWORD *)(a1 + 8))) != 0LL) )
    {
      if ( UseQPCTime )
      ...
      {
        v18 = (unsigned int)dword_1401730B8 * i;
        if ( (_DWORD)v4 )
        {
          v19 = Pool + 1;
          v20 = v4;
      ...
      if ( (_DWORD)v4 )
      {
        ...
        do
        {
          v26 = *(_QWORD *)&v24[(_QWORD)v23 - 8] - *(v23 - 1);
          *(_QWORD *)&v25[(_QWORD)v23 - 8] = v26;
          v27 = *(_QWORD *)&v24[(_QWORD)v23] - *v23;
          *(_QWORD *)&v25[(_QWORD)v23] = v27;
          *(_QWORD *)&v25[(_QWORD)v23 + 8] = *(_QWORD *)&v24[(_QWORD)v23 + 8] - v23[1];
          v23 += 3;
          v21 += v27 + v26;
          --v2;
        }
      ...
      memmove(*(void **)(*(_QWORD *)(a1 + 608) + 32LL), Pool, (unsigned int)dword_1401730B8);
      if ( v21 )
      {
        v99 = v2;
        if ( (_WORD)TelemetryPerfContext != (_WORD)v2 && WORD1(TelemetryPerfContext) != (_WORD)v2 )
        {
          ...
          if ( (_DWORD)v4 )
          {
            ...
            do
            {
              if ( v28 >= dword_14017304C && v28 < *((_DWORD *)&xmmword_140173070 + 3) )
              {
        ...
        if ( *(_QWORD *)(*(_QWORD *)(a1 + 608) + 48LL) != v2 )
        {
          ...
          if ( g_RaidNumberProcessors )
          {
            ...
            do
            {
              v40 = (unsigned int)(dword_1401730D0 * v37);
              v41 = *(_QWORD *)(*(_QWORD *)(a1 + 608) + 48LL);
              v42 = *(_QWORD *)(v40 + v41);
              *(_QWORD *)(v40 + v41) = v2;
              if ( v42 > v39 )
                v39 = v42;
              v38 += *(_QWORD *)(v40 + v41 + 8);
              v36 += *(_QWORD *)(v40 + v41 + 16);
              v37 = ++v35;
            }
            while ( v35 < v34 );
            v54.m128i_i64[0] = v39;
        ...
        if ( (byte_14017344A & 0x20) != 0 )
        {
          ...
          McTemplateK0qjzshqusssjqxuxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer(
            ...
            *(_QWORD *)(v48 + 128) + 1048LL,
            *(const wchar_t **)(*(_QWORD *)(v48 + 128) + 1032LL),
            *(const char **)(v48 + 792),
            *(_WORD *)(v48 + 4),
            *(_DWORD *)(a1 + 56),
            *(_BYTE *)(v48 + 744),
