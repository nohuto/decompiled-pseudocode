/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14006FB24
 * Callers:
 *     wil_details_IsEnabledFallback @ 0x140053138 (wil_details_IsEnabledFallback.c)
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14006FC88 (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14006FC88 (wil_details_GetCurrentFeatureEnabledState.c)
