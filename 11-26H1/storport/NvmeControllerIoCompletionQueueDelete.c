/*
 * XREFs of NvmeControllerIoCompletionQueueDelete @ 0x1400F6BE8
 * Callers:
...
__int64 __fastcall NvmeControllerIoCompletionQueueDelete(union _SLIST_HEADER *a1, __int16 a2)
{
  ...
  *(_BYTE *)(v8 + 4096) = 4;
  *(_WORD *)(v8 + 4136) = a2;
  v9 = NvmeControllerProcessCommandSync(a1, v7);
