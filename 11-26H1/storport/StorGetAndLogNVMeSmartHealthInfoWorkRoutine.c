/*
 * XREFs of StorGetAndLogNVMeSmartHealthInfoWorkRoutine @ 0x1400CA390
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall StorGetAndLogNVMeSmartHealthInfoWorkRoutine(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v2 + 6224) + 64LL) && *v5 )
  {
    do
    {
      v25 = v4;
      ...
      _interlockedbittestandreset(
        (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v2 + 6224) + 64LL)
