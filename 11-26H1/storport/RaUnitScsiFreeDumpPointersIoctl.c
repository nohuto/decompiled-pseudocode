/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x140056C08
 * Callers:
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)Pool = 7340288;
  *(_DWORD *)(Pool + 56) = *((_DWORD *)v54 + 6);
  *(_DWORD *)(Pool + 72) = *(_DWORD *)(v52 + 4);
  *(_DWORD *)(Pool + 76) = *(_DWORD *)(v52 + 8);
  *(_DWORD *)(Pool + 80) = *(_DWORD *)(v52 + 24);
  *(_DWORD *)(Pool + 84) = *(_DWORD *)(v52 + 28);
  *(_DWORD *)(Pool + 88) = *(_DWORD *)(v52 + 48);
  *(_DWORD *)(Pool + 92) = *(_DWORD *)(v52 + 52);
  *(_QWORD *)(Pool + 96) = *(_QWORD *)(v52 + 56);
  *(_BYTE *)(Pool + 104) = *(_BYTE *)(v52 + 72);
  *(_BYTE *)(Pool + 105) = *(_BYTE *)(v52 + 82);
  *(_BYTE *)(Pool + 106) = *(_BYTE *)(v52 + 89);
  *(_BYTE *)(Pool + 107) = *(_BYTE *)(v52 + 97);
  *(_QWORD *)(Pool + 64) = *(_QWORD *)(v52 + 64);
  Srb = (unsigned int *)RaidAllocateSrb(*(_QWORD *)(a1 + 8), 39, *(_BYTE *)(v52 + 98), 0);
  if ( Srb )
  {
    v15 = 316LL;
    if ( *(_DWORD *)v50 != 1314275652 )
      v15 = 524LL;
    ContiguousIoResources = StorAllocateContiguousIoResources(
                              ((*(_DWORD *)(v15 + v50) + 7) & 0xFFFFFFF8) + 1200,
                              v14,
                              (_QWORD *)v50);
    ...
    *(_QWORD *)(v8 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_25fa594137633db1985de5dda85c818b_Traceguids, v8, Srb);
    }
    if ( *(_BYTE *)(v50 + 4434) )
      v24 = RaidAdapterRaiseIrqlAndExecuteXrb(v50, (_QWORD *)v8);
    else
      v24 = RaidAdapterPostScatterGatherExecute(v50, v8);
...
LABEL_58:
    ...
    if ( *(_WORD *)(v26 + 5090) )
    {
      v27 = *(void (__fastcall **)(_QWORD))(v26 + 5112);
      if ( v27 )
        v27(*(_QWORD *)(v26 + 5096));
    }
    StorPortReleaseAdditionalCrashDumpArea(*(_QWORD *)(a1 + 24) + 896LL, v52);
    ExFreePoolWithTag(*((PVOID *)v54 + 1), 0x44436152u);
    memset_0(v54, 0, 0x68uLL);
    *(_QWORD *)(a2 + 56) = 0LL;
    if ( v55 )
    {
      RaidXrbDeallocateResources(v8, 0);
      StorFreeContiguousIoResources(v50, v55);
    }
    if ( !Srb )
    {
LABEL_25:
...
LABEL_98:
    ...
    else
    {
      ...
      if ( (unsigned int)(unsigned __int8)v31[7] + 8 <= v32 )
        v46 = (unsigned __int8)v31[7] + 8;
      v20 = (unsigned __int64)&v31[v46];
      if ( (unsigned __int64)v45 <= v20 )
        v34 = v31[12];
...
LABEL_117:
  ...
  while ( 1 )
  {
    v20 = *(unsigned int *)(v29 + 4 * v38 + 120);
    if ( (unsigned int)v20 >= 0x80 )
    {
      v39 = *(unsigned int *)(v29 + 16);
      if ( (unsigned int)v20 < (unsigned int)v39 )
        break;
    }
LABEL_89:
    v38 = (unsigned int)(v51 + 1);
    v51 = v38;
    if ( (unsigned int)v38 >= v53 )
      goto LABEL_95;
  }
  v40 = (unsigned int)v20;
  v41 = *(_DWORD *)(v29 + v20) - 64;
  if ( v41 )
  {
    LODWORD(v20) = v41 - 1;
    if ( (_DWORD)v20 )
    {
      if ( (_DWORD)v20 == 1 )
      {
        ...
        if ( v40 + 40 <= v39 )
        {
          if ( *(_DWORD *)(v29 + v40 + 12) )
            v37 = (char *)(v40 + v29 + 32);
          v31 = *(_BYTE **)(v29 + v40 + 24);
          goto LABEL_94;
        }
      }
    }
