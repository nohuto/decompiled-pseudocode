/*
 * XREFs of RaidAdapterStorageTcgSetLockingObjectMetadata @ 0x140087028
 * Callers:
...
__int64 __fastcall RaidAdapterStorageTcgSetLockingObjectMetadata(__int64 a1, __int64 a2)
{
  ...
  _OWORD v49[2]; // [rsp+100h] [rbp-50h] BYREF
...
LABEL_84:
    ...
    if ( !*(_DWORD *)(v17 + 20) )
    {
      ...
      if ( v46 )
      {
        do
        {
          v13 = *(unsigned int *)(v17 + 4 * v25 + 120);
