/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsCriticalData @ 0x1400BB180
 * Callers:
...
char __fastcall StorpTelemetryLogUnitDeviceStatisticsCriticalData(__int64 a1)
{
  _UNKNOWN **v1; // rax
  __int64 v2; // rcx
  __int64 v3; // rdx
  ...
  {
    LOBYTE(v1) = tlgKeywordOn(a1, 0x800000000000LL);
    if ( (_BYTE)v1 )
    {
      v3 = *(_QWORD *)(v2 + 24);
      v48 = 16LL;
      ...
      v114 = 1LL;
      v113 = &v34;
      LOBYTE(v1) = tlgWriteTransfer_EtwWriteTransfer(v27, (unsigned __int8 *)dword_140164CE2, v7, v8, 0x26u, &v46);
    }
  }
  return (char)v1;
}
