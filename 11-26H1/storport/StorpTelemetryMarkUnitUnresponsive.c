/*
 * XREFs of StorpTelemetryMarkUnitUnresponsive @ 0x1400BD510
 * Callers:
...
void __fastcall StorpTelemetryMarkUnitUnresponsive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 506) & 2) == 0 && (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v14 = v4;
      v37 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v5, (unsigned __int8 *)dword_140164289, v2, v3, 0xDu, &v15);
    }
  }
}
