/*
 * XREFs of RaidGetTcgLockingObjects @ 0x140094CAC
 * Callers:
...
__int64 __fastcall RaidGetTcgLockingObjects(int *a1, _QWORD *a2, char *a3)
{
  ...
  Pool = (char *)RaidAllocatePool(256LL, v10, 1129603410LL, *((_QWORD *)a1 + 1));
  v12 = Pool;
  if ( !Pool )
...
LABEL_22:
  ...
  if ( LockingObjects >= 0 )
  {
    for ( i = 0LL; (unsigned int)i < *(_DWORD *)(v7 + 128); *(_QWORD *)&v12[v14 + 56] *= *(unsigned int *)(v7 + 100) )
    {
      v14 = 80 * i;
      i = (unsigned int)(i + 1);
      *(_QWORD *)&v12[v14 + 48] *= *(unsigned int *)(v7 + 100);
    }
    *a2 = v12;
    v12 = 0LL;
  }
