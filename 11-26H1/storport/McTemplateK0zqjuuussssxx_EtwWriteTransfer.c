/*
 * XREFs of McTemplateK0zqjuuussssxx_EtwWriteTransfer @ 0x140098D28
 * Callers:
        ...
        char a15)
{
  ...
  v59 = &a15;
  v60 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v15, &EventSMRUnsupportedZoneSizeError, 0LL, 0xDu, &v31);
}
