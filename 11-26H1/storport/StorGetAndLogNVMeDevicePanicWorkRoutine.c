/*
 * XREFs of StorGetAndLogNVMeDevicePanicWorkRoutine @ 0x1400C9FF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall StorGetAndLogNVMeDevicePanicWorkRoutine(PDEVICE_OBJECT DeviceObject, _WORD *Context)
{
  ...
  if ( *(_QWORD *)(DeviceExtension[778] + 72LL) && *v5 )
  {
    do
    {
      v9 = v4++;
      _interlockedbittestandreset(
        (volatile signed __int32 *)(*(_QWORD *)(DeviceExtension[778] + 72LL)
