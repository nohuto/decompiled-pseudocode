/*
 * XREFs of NvmePnPPassToMiniPort @ 0x1400E2018
 * Callers:
...
__int64 NvmePnPPassToMiniPort(__int64 a1, int a2, __int64 a3, ...)
{
  ...
  {
    if ( !Srb )
      Srb = RaidAllocateSrb(*(_QWORD *)(v3 + 8), 37, *(_BYTE *)v15, 0);
    if ( !ContiguousIoResources )
      ContiguousIoResources = NVMeAllocateContiguousIoResources(v14 + 1200, v13, (_QWORD *)v3);
    if ( Srb && ContiguousIoResources )
    {
      ...
      *(_QWORD *)(ContiguousIoResources + 224) = *(_QWORD *)(Srb + 48);
      ...
      RaSrbSetMiniportContext((int *)v3, Srb, ContiguousIoResources + 1200);
      ...
      *(_QWORD *)(ContiguousIoResources + 704) = RaidXrbSignalCompletion;
      if ( (*(_DWORD *)(v3 + 144) & 0x1000LL) != 0 )
        v20 = NvmeAdapterRaiseIrqlAndExecuteXrb(v3, v19);
      else
        v20 = NvmeAdapterExecuteXrb(v3, v19);
      v21 = v20;
      if ( v20 >= 0 )
