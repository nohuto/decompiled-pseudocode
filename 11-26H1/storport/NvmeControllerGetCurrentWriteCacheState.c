/*
 * XREFs of NvmeControllerGetCurrentWriteCacheState @ 0x1400CF164
 * Callers:
...
__int64 __fastcall NvmeControllerGetCurrentWriteCacheState(union _SLIST_HEADER *a1, char a2)
{
  __int64 v4; // rbx
  unsigned int v5; // esi
  ...
  if ( (*(_BYTE *)(a1[37].Alignment + 525) & 1) != 0 )
  {
    ...
    if ( ExtendedCommand )
    {
      ...
      *(_BYTE *)(v8 + 4096) = 10;
      v5 = NvmeControllerProcessCommandSync(a1, v7);
    }
    else
    {
      v5 = -1073741670;
