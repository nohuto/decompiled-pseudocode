/*
 * XREFs of StorpMeasuresMiniportEventUnit @ 0x1400B938C
 * Callers:
...
char __fastcall StorpMeasuresMiniportEventUnit(__int64 a1, __int64 a2, __int64 a3, int *a4)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v53 = v30;
      v116 = 8LL;
      LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v30, (unsigned __int8 *)dword_140160CB9, v31, v32, v34, v35, 0x27u, &v55);
    }
  }
  return v4;
}
