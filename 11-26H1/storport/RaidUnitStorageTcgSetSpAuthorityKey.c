/*
 * XREFs of RaidUnitStorageTcgSetSpAuthorityKey @ 0x14008BF3C
 * Callers:
    ...
    if ( v6 )
    {
      ...
      if ( (byte_140173447 & 2) != 0 )
      {
        ...
        McTemplateK0quuujjzssszssdxxxxxxxx_EtwWriteTransfer(
          ...
          *(int *)(*(_QWORD *)&v55.Data1 + 16LL),
          *(int *)(*(_QWORD *)&v55.Data1 + 12LL),
          v16,
          v12,
          SBYTE1(v52),
          SBYTE2(v52),
...
LABEL_82:
      if ( byte_140173441 < 0 )
      {
        ...
        LODWORD(v42) = Irp->IoStatus.Status;
        McTemplateK0pduuuuup_EtwWriteTransfer(v19, SecurityContext, &v55, Irp, v42, v43, v44, pszDest, v46, v47, Irp);
      }
      goto LABEL_89;
    }
    v30 = 0LL;
