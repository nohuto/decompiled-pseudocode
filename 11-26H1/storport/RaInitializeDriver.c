/*
 * XREFs of RaInitializeDriver @ 0x140187E48
 * Callers:
 *     StorPortInitialize @ 0x140076DD0 (StorPortInitialize.c)
 * Callees:
 *     RaDuplicateUnicodeString @ 0x14005A7A0 (RaDuplicateUnicodeString.c)
 *     McGenEventRegister_EtwRegister @ 0x14007237C (McGenEventRegister_EtwRegister.c)
 *     RaidAddPortDriver @ 0x140076460 (RaidAddPortDriver.c)
