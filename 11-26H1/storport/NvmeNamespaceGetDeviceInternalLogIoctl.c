/*
 * XREFs of NvmeNamespaceGetDeviceInternalLogIoctl @ 0x1401A618C
 * Callers:
...
__int64 __fastcall NvmeNamespaceGetDeviceInternalLogIoctl(__int64 a1, __int64 a2)
{
  ...
  unsigned int DeviceInternalLogIoctl; // [rsp+68h] [rbp-60h]
  GUID v31; // [rsp+70h] [rbp-58h] BYREF

  v3 = 0;
  DeviceInternalLogIoctl = NvmeControllerGetDeviceInternalLogIoctl(*(union _SLIST_HEADER **)(a1 + 16), a2);
  ...
  if ( *(_BYTE *)v6 != 15 )
  {
    ...
    if ( *(_BYTE *)(v6 + 1) == 7 && !*(_DWORD *)(v6 + 8) )
    {
      if ( (byte_140173442 & 0x40) != 0 )
      {
        ...
        if ( v7 )
          v3 = *v7;
        McTemplateK0pqd_EtwWriteTransfer(v5, v6, &v31, a2, v3, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
...
LABEL_66:
    McTemplateK0pd_EtwWriteTransfer(v5, v8, &v31, a2, *(_DWORD *)(a2 + 48));
    goto LABEL_67;
  }
  if ( byte_140173441 >= 0 )
    goto LABEL_67;
...
LABEL_60:
    if ( byte_140173441 < 0 )
    {
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v5, v9, &v31, a2, *(_DWORD *)(a2 + 48), v23, v10, v13, v14, v15, a2);
    }
    goto LABEL_67;
  }
  v17 = 0LL;
