/*
 * XREFs of McTemplateK0qjzszhhsstqquuq_EtwWriteTransfer @ 0x1400C9970
 * Callers:
        ...
        char a18)
{
  ...
  int v71; // [rsp+170h] [rbp+68h] BYREF
  ...
  v68 = 1LL;
  v70 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v33, &EventIdentifyMFNDFailure, 0LL, 0x10u, &v36);
}
