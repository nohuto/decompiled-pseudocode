/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesCriticalData @ 0x1400BC6CC
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v102 = v11;
      v103 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_140163B31, v12, v8, 0x24u, &v39);
    }
  }
}
