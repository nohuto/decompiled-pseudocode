/*
 * XREFs of StorLogDLRMEffectivePowerModeCallback @ 0x14012E4F0
 * Callers:
...
void __fastcall StorLogDLRMEffectivePowerModeCallback(__int64 a1, char a2, char a3, char a4, char a5, char a6)
{
  __int64 v9; // rbx
  __int128 v10; // xmm0
  __int64 v11; // r8
    ...
    if ( a1 )
    {
      ...
      if ( v9 )
      {
        ...
        if ( v13 )
        {
          ...
          v25 = *(_OWORD *)(v13 + 40);
          v26 = *(_QWORD *)(v13 + 56);
          v19 = *(_QWORD *)(*(_QWORD *)(v9 + 6064) + 64LL);
          v14 = *(_QWORD *)(v9 + 6064);
          v21 = *(_OWORD *)(v14 + 4);
          v22 = *(_DWORD *)(v14 + 20);
        }
        if ( (byte_140173448 & 0x10) != 0 )
        {
          v15 = *(__int16 **)(v9 + 6064);
          if ( v15 )
          {
          ...
          McTemplateK0qjzshhssqtqqqq_EtwWriteTransfer(
            ...
            &EventDLRMEffectivePowerModeCallback,
            v11,
            *(_DWORD *)(v9 + 56),
            (__int64)&v18,
            *((const wchar_t **)&v17 + 1),
