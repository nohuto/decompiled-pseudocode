/*
 * XREFs of NvmeNamespacePowerCapIoctl @ 0x14010819C
 * Callers:
...
NTSTATUS __fastcall NvmeNamespacePowerCapIoctl(__int64 a1, __int64 a2)
{
  int v3; // ebx
  int v4; // esi
  __int64 v5; // r8
...
LABEL_71:
      if ( byte_140173441 < 0 )
      {
        ...
        McTemplateK0pduuuuup_EtwWriteTransfer(v9, v13, &v35, a2, *(_DWORD *)(a2 + 48), v27, v25, v16, v17, v18, a2);
      }
      goto LABEL_78;
    }
    v28 = *v14 & 0x7F;
