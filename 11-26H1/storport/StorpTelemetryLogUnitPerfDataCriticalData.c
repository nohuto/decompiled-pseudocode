/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x14005B190
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v40 = 1LL;
      v42 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v43, *(const wchar_t **)(v2 + 4784));
      tlgCreate1Sz_char((__int64)v44, (_BYTE *)(v3 + 168));
      tlgCreate1Sz_char((__int64)v45, (_BYTE *)(v4 + 177));
      tlgCreate1Sz_char((__int64)v46, (_BYTE *)(v5 + 242));
      v47 = &v25;
      v17 = *(_BYTE *)(v6 + 8);
      v49 = &v17;
      v26 = *(_QWORD *)(v6 + 360);
      ...
      tlgCreate1Sz_wchar_t((__int64)v68, *(const wchar_t **)(v8 + 16));
      ...
      v73 = &v18;
      v11 = v9[46];
      v18 = 3 * qword_1401730B0;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_1401730B0);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_1401730B0) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_1401632D7,
        v12,
        v13,
        0x1Du,
        &v30);
