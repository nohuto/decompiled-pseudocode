/*
 * XREFs of StorpTelemetrySendUnitPauseRequestCounters @ 0x14005A0C8
 * Callers:
...
void __fastcall StorpTelemetrySendUnitPauseRequestCounters(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 2272)
    || *(_DWORD *)(a1 + 2276)
    || *(_DWORD *)(a1 + 2280)
    || (v2 = *(_QWORD *)(a1 + 24), *(_DWORD *)(v2 + 5420))
    || *(_DWORD *)(v2 + 5416) )
  {
    if ( (unsigned int)dword_140172178 > 5 )
    {
      if ( tlgKeywordOn(a1, 0x400000000000LL) )
      {
        ...
        v37 = &v15;
        v38 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((__int64)v6, (unsigned __int8 *)dword_140164359, v4, v5, 0xDu, &v16);
      }
    }
    *(_QWORD *)(a1 + 2272) = 0LL;
    *(_DWORD *)(a1 + 2280) = 0;
