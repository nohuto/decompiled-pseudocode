/*
 * XREFs of NvmeAdapterSurpriseRemovalIrp @ 0x1401A0664
 * Callers:
...
NTSTATUS __fastcall NvmeAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  if ( v9 )
  {
    *(_QWORD *)(*(_QWORD *)(a1 + 1152) + 968LL) |= 0x8000uLL;
    a1 = *(_QWORD *)(a1 + 1152);
    *(_BYTE *)(a1 + 1228) = 1;
  }
  if ( (unsigned int)(v8 - 5) > 1 )
  {
    NvmeAdapterDisableDeviceInterface(v4);
  ...
  if ( (byte_14017344A & 0x10) != 0 )
  {
    ...
    McTemplateK0qjzzusqhtd_EtwWriteTransfer(
      ...
      *(_DWORD *)(v4 + 56),
      v4 + 1048,
      *(const wchar_t **)(v4 + 1032),
      *(const wchar_t **)(v4 + 1040),
      v14,
      v13,
      v12,
      v8,
  ...
  if ( (unsigned int)dword_140172178 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    ...
    v26 = v7;
    v45 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(v18, (unsigned __int8 *)dword_1401650FA, v19, v20, 0xBu, &v29);
  }
