/*
 * XREFs of StorAdapterNVMeInitializeEnumUnitIdentifyInfo @ 0x1401B6620
 * Callers:
...
__int64 __fastcall StorAdapterNVMeInitializeEnumUnitIdentifyInfo(__int64 a1, int a2, __int64 a3, _BYTE *a4, _BYTE *a5)
{
  ...
  *a5 = 0;
  ...
  if ( !v6[4 * (v6[26] & 0xF) + 130] && !*(_QWORD *)v6 )
    goto LABEL_5;
  *a4 = 1;
...
LABEL_15:
  ...
  else
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a3 + 8) + 3560LL) = v6;
    *(_QWORD *)(*(_QWORD *)(a3 + 8) + 3568LL) = v8;
  }
