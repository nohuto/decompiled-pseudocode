/*
 * XREFs of RaidUnitLogSenseCommandSrb @ 0x1400A863C
 * Callers:
    ...
    if ( v15 == 1 )
    {
      ...
      *((_DWORD *)Srb + 6) = 524626;
      ...
      if ( *(_DWORD *)v14 == 1094997074 && (*(_BYTE *)(v14 + 111) & 4) != 0 )
      {
        ...
        _InterlockedIncrement(*(volatile signed __int32 **)(*(_QWORD *)(v14 + 6232) + 8LL * LockArray_high));
        v17 = **(_QWORD **)(*(_QWORD *)(v14 + 6232) + 8LL * LockArray_high);
