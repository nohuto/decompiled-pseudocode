/*
 * XREFs of StorSetMFNDOperationPrivilege @ 0x1400CD8C8
 * Callers:
...
__int64 __fastcall StorSetMFNDOperationPrivilege(__int64 a1, char a2)
{
  ...
  if ( _interlockedbittestandset((volatile signed __int32 *)(*(_QWORD *)(a1 + 6224) + 8LL), 0) == 1 )
  {
    *(_DWORD *)(*(_QWORD *)(a1 + 6224) + 8LL) |= 8u;
    return 3221226614LL;
  }
  else
  {
