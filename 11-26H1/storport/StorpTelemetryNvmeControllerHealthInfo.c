/*
 * XREFs of StorpTelemetryNvmeControllerHealthInfo @ 0x1400BDA60
 * Callers:
...
void __fastcall StorpTelemetryNvmeControllerHealthInfo(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        _BYTE *a4,
        ...
        __int64 a14)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v39 = 4LL;
      v41 = 4LL;
      tlgCreate1Sz_wchar_t((__int64)v42, *(const wchar_t **)(v16 + 1032));
      v18 = *(_QWORD *)(v17 + 128);
      v19 = *(_BYTE *)(v18 + 144) & 1;
      v44 = 1LL;
      v24 = v19 != 0 ? 20 : 17;
      v43 = &v24;
      tlgCreate1Sz_wchar_t((__int64)v45, *(const wchar_t **)(v18 + 1040));
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        *(__int64 *)&g_SystemUptime_s,
        (unsigned __int8 *)dword_1401621EC,
        v23,
        v22,
        0x17u,
        &v35);
