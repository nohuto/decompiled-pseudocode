/*
 * XREFs of McTemplateK0qjzszhhsstqqqqqqqqq_EtwWriteTransfer @ 0x14007E14C
 * Callers:
        ...
        char a22)
{
  ...
  int v84; // [rsp+1A8h] [rbp+A8h] BYREF
  ...
  v81 = 4LL;
  v83 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v37, &EventPLDRRequestPowerIrpFailed, 0LL, 0x14u, &v40);
}
