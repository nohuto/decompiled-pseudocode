/*
 * XREFs of RaUnitHwBootPartitionActivateIoctl @ 0x14009C658
 * Callers:
...
NTSTATUS __fastcall RaUnitHwBootPartitionActivateIoctl(__int64 a1, __int64 a2)
{
  int v3; // ebx
  __int64 v5; // rax
  __int64 *v6; // rsi
