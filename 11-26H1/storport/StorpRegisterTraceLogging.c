/*
 * XREFs of StorpRegisterTraceLogging @ 0x14019020C
 * Callers:
...
char StorpRegisterTraceLogging()
{
  ...
  if ( (int)TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140172178) >= 0 )
    TelemetryProviderInitialized = 1;
  if ( (int)TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1401721B0) >= 0 )
    OnDemandDataProviderInitialized = 1;
  v0 = TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1401721E8);
  if ( v0 >= 0 )
