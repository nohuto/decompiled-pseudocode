/*
 * XREFs of NvmeNamespaceQueryIdIrp @ 0x1401A8648
 * Callers:
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( v8 )
      {
        ...
        InstanceId = NvmeNamespaceGetInstanceId(a1, &v38);
      }
      else
      {
        InstanceId = NvmeNamespaceGetCompatibleIds(a1, &v38);
      }
    }
    else if ( (*(_BYTE *)(*(_QWORD *)(a1 + 16) + 136LL) & 2) != 0 )
    {
      InstanceId = NvmeNamespaceGetHardwareIds(a1, &v38);
    }
    else
    {
      InstanceId = NvmeNamespaceGetHardwareIdsEx(a1, &v38);
    }
  }
  else if ( (*(_BYTE *)(*(_QWORD *)(a1 + 16) + 136LL) & 2) != 0 )
  {
    InstanceId = NvmeNamespaceGetDeviceId(a1, &v38);
  }
  else
  {
    InstanceId = NvmeNamespaceGetDeviceIdEx(a1, &v38);
  }
  v9 = InstanceId;
LABEL_15:
