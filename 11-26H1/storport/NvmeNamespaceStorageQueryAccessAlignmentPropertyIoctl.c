/*
 * XREFs of NvmeNamespaceStorageQueryAccessAlignmentPropertyIoctl @ 0x140183048
 * Callers:
...
__int64 __fastcall NvmeNamespaceStorageQueryAccessAlignmentPropertyIoctl(_DWORD *a1, __int64 a2)
{
  _DWORD *v2; // rsi
  __int64 v4; // rax
  int v5; // ebx
