/*
 * XREFs of NvmeAdapterSetLedStateByAcpiDsm @ 0x14008F3D4
 * Callers:
...
__int64 __fastcall NvmeAdapterSetLedStateByAcpiDsm(__int64 a1, __int64 a2)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( (*(_BYTE *)(*(_QWORD *)(v4 + 592) + 152LL) & 9) != 9 )
      return 3221225659LL;
    v6 = 4 * (*(_DWORD *)(a2 + 8) & 0x1FF);
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 592) + 152LL) & 2) != 0
      && (int)NvmeDsmGetSupportedLedState(a1) >= 0
      && (v6 & *(_DWORD *)(*(_QWORD *)(v4 + 592) + 156LL)) == 0 )
    {
      return 3221225659LL;
    }
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 592) + 152LL) & 4) != 0 )
    {
      v7 = 0;
