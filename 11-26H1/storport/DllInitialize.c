/*
 * XREFs of DllInitialize @ 0x1400ACAB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidpIsControlledWinPEEnvironment @ 0x1400AE404 (RaidpIsControlledWinPEEnvironment.c)
 *     RaidpIsCurrentOsInstallationUpgrade @ 0x1400AE4A4 (RaidpIsCurrentOsInstallationUpgrade.c)
 *     RaidDecodeSmRegistryBlob @ 0x1400C534C (RaidDecodeSmRegistryBlob.c)
 *     StorPortpInitializeDriverProxyInterfaces @ 0x140118FE8 (StorPortpInitializeDriverProxyInterfaces.c)
 *     GetCpuInformation @ 0x14011EB28 (GetCpuInformation.c)
 *     InitializeNumaNodeCompletionAffinity @ 0x14011F22C (InitializeNumaNodeCompletionAffinity.c)
 *     __security_check_cookie @ 0x140138590 (__security_check_cookie.c)
 *     memset_0 @ 0x140138980 (memset_0.c)
 *     StorpWheaAddErrorSource @ 0x140188940 (StorpWheaAddErrorSource.c)
 *     SpVerifierInitialization @ 0x14018FA88 (SpVerifierInitialization.c)
 *     StorpRegisterShim @ 0x140190648 (StorpRegisterShim.c)
 *     StorKsrInitialize @ 0x140196998 (StorKsrInitialize.c)
...
__int64 DllInitialize()
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  {
    StorpRegisterShim();
    qword_140173438 = (__int64)&EnclosureIdList;
    ...
    *(_QWORD *)&WPP_MAIN_CB.SectorSize = &WPP_MAIN_CB.SectorSize;
    ...
    qword_1401731D8 = (__int64)&NvmeIceList;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  if ( ZwOpenKey(DestinationString, 0x20019u, &ObjectAttributes) >= 0 )
  {
    ...
    if ( ZwQueryValueKey(
           ...
           ResultLength) < 0 )
    {
      LODWORD(v2) = 0x4000000;
      if ( (unsigned __int64)PhysicalMemorySize >> 6 >= 0x4000000 )
      {
        v2 = (unsigned __int64)PhysicalMemorySize >> 6;
        if ( (unsigned __int64)PhysicalMemorySize >> 6 > 0x40000000 )
          LODWORD(v2) = 0x40000000;
      }
      v1 = v2 & 0xFFFFF000;
      if ( (v2 & 0xFFF) == 0 )
        v1 = v2;
...
LABEL_38:
        ...
        RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"EnableSolitaryIO");
        if ( ZwQueryValueKey(
               DestinationString[0],
               (PUNICODE_STRING)&DestinationString[1],
               KeyValuePartialInformation,
