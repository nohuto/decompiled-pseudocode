/*
 * XREFs of McTemplateK0qjzshqusssjqxquuhqi_EtwWriteTransfer @ 0x1400B32A8
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzshqusssjqxquuhqi_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a22)
{
  ...
  v80 = 4LL;
  v82 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v36, &EventNVMeHighLatencyIo, 0LL, 0x14u, &v39);
}
