/*
 * XREFs of CreateNVMePrpListBufferPool @ 0x1401192A8
 * Callers:
  ...
  *(_QWORD *)(a1 + 880) = Pool;
  if ( !Pool
    || (v7 = *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8LL),
        v4 = g_RecommendedSharedDataAlignment
           * (((unsigned __int64)(unsigned int)(g_RecommendedSharedDataAlignment - 1) + 32)
            / (unsigned int)g_RecommendedSharedDataAlignment),
        v23 = v4,
        (v5 = (char *)RaidAllocatePool(72LL, g_MaximumProcessorCount * v4, 1296982354LL, v7)) == 0LL) )
  {
LABEL_15:
    v1 = -1073741670;
    if ( *(_QWORD *)(a1 + 880) )
...
LABEL_4:
  ...
  {
    *(_QWORD *)(*(_QWORD *)(a1 + 880) + 8 * v8) = &v5[v4 * (unsigned int)v8];
