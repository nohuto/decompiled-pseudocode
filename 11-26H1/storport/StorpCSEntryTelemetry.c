/*
 * XREFs of StorpCSEntryTelemetry @ 0x1400B7140
 * Callers:
...
void __fastcall StorpCSEntryTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    *(_QWORD *)(a1 + 5288) = 0LL;
    v4 = (unsigned __int64)(v3 - *(_QWORD *)(a1 + 5280)) * (unsigned __int128)0x346DC5D63886594BuLL;
    v5 = *(_QWORD *)(a1 + 5024);
    *(_QWORD *)(a1 + 5280) = v2;
    v6 = *((_QWORD *)&v4 + 1) >> 11;
    *(_QWORD *)(a1 + 5296) = 0LL;
    ...
    *(_QWORD *)(a1 + 5400) = 0LL;
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_140172178 > 5 && tlgKeywordOn(v5, 0x400000000000LL) )
      {
        v54 = 16LL;
        v53 = a1 + 5128;
        v23 = *(_DWORD *)(a1 + 56);
        ...
        v26 = v6;
        v58 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v8, (unsigned __int8 *)dword_1401645DD, v9, v10, 5u, &v52);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 8)) )
      {
        ...
        if ( (unsigned int)dword_140172178 > 5 )
        {
          if ( tlgKeywordOn(v13, 0x400000000000LL) )
          {
            ...
            v49 = 8LL;
            v51 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v14, (unsigned __int8 *)dword_140162CC4, v15, v16, 0xDu, &v29);
          }
        }
