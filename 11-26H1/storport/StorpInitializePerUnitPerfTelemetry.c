/*
 * XREFs of StorpInitializePerUnitPerfTelemetry @ 0x14018FFC0
 * Callers:
...
__int64 __fastcall StorpInitializePerUnitPerfTelemetry(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 2368) = 0;
  if ( (_DWORD)Size && g_RaidNumberProcessors )
  {
    ...
    *(_QWORD *)(a1 + 2376) = Pool;
    if ( Pool
      && (v4 = RaidAllocatePool(72LL, (unsigned int)dword_1401730B8, 1700028754LL, *(_QWORD *)(a1 + 8)),
          (*(_QWORD *)(a1 + 2400) = v4) != 0LL) )
    {
      ...
      *(LARGE_INTEGER *)(a1 + 2392) = PerformanceCounter;
      v7 = RaidAllocatePool(72LL, (unsigned int)dword_1401730D4, 1700028754LL, v6);
