/*
 * XREFs of NvmeAdapterMSIInterruptRoutine @ 0x1400D95F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall NvmeAdapterMSIInterruptRoutine(__int64 a1, _DWORD *a2)
{
  ...
  if ( StorEtwLoggingEnabled && (byte_140173443 & 8) != 0 )
  {
    ...
    {
      v12 = a2[14];
      McTemplateK0pqqx_EtwWriteTransfer(v14, v12, v10, NvmeAdapterMSIInterruptRoutine, v12, CurrentProcessorNumber, v14);
    }
  }
  return v6;
}
