/*
 * XREFs of StorQueryMFNDNamespacePageMap @ 0x1401940C4
 * Callers:
...
__int64 __fastcall StorQueryMFNDNamespacePageMap(__int64 *a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  if ( StorIsMFNDSupported((__int64)a1) )
  {
    ...
    if ( v5[4] == 1 && *((_DWORD *)v5 + 3) >= 0x20u )
    {
      v9 = *((_DWORD *)v5 + 4);
      if ( v9 )
      {
        if ( v9 < 3 && v5[10] && *((_DWORD *)v5 + 8) )
        {
          if ( !v5 )
          {
            v10 = -1073741811;
