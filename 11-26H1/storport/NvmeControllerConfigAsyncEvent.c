/*
 * XREFs of NvmeControllerConfigAsyncEvent @ 0x1400CEFFC
 * Callers:
...
__int64 __fastcall NvmeControllerConfigAsyncEvent(__int64 a1)
{
  ...
  *(_BYTE *)(v8 + 4136) = 11;
  *(_DWORD *)(v8 + 4140) = v7;
  v9 = NvmeControllerProcessCommandSync((PVOID)a1, (__int64)v4);
  if ( v9 >= 0 )
    *(_DWORD *)(a1 + 1224) = v7;
  NvmeControllerReclaimExtendedCommand((union _SLIST_HEADER *)a1, (__int64)v4);
