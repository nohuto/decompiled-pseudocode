/*
 * XREFs of NvmeAdapterRetrieveRegistrySettings @ 0x14019EE64
 * Callers:
...
__int64 __fastcall NvmeAdapterRetrieveRegistrySettings(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 1080) = NvmeDbgLogControl;
  ...
  *(_QWORD *)(a1 + 1088) = v7;
  ...
  if ( (int)PortRegistryReadDeviceKey(v8, (int)&DestinationString, (int)&v16, 4, (__int64)&p_Uuid, &KeyHandle) < 0 )
    ...
    *(_DWORD *)(a1 + 1072) = (v14 != 0) | *(_DWORD *)(a1 + 1072) & 0xFFFFFFFE;
  ...
  {
    result = (v15 != 0 ? 2 : 0) | *(_DWORD *)(a1 + 1072) & 0xFFFFFFFD;
