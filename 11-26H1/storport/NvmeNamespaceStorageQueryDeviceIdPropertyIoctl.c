/*
 * XREFs of NvmeNamespaceStorageQueryDeviceIdPropertyIoctl @ 0x1401AC0E0
 * Callers:
...
__int64 __fastcall NvmeNamespaceStorageQueryDeviceIdPropertyIoctl(__int64 a1, __int64 a2)
{
  ...
  int v6; // ecx
  __int64 v7; // rax
  int StorageDeviceIdProperty; // r13d
  bool v9; // zf
  ...
  {
    StorageDeviceIdProperty = NvmeNamespaceGetStorageDeviceIdProperty(a1, v4, &v35);
    v7 = v35;
