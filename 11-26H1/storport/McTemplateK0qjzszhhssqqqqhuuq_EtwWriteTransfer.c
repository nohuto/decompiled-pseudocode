/*
 * XREFs of McTemplateK0qjzszhhssqqqqhuuq_EtwWriteTransfer @ 0x14005DA78
 * Callers:
        ...
        char a20)
{
  ...
  int v77; // [rsp+190h] [rbp+88h] BYREF
  ...
  v74 = 1LL;
  v76 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v35, &EventReconfigureMFND, 0LL, 0x12u, &v38);
}
