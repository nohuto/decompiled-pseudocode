/*
 * XREFs of StorpTelemetryNvmeLogNamespacePerfDataCriticalData @ 0x1400BE338
 * Callers:
...
void __fastcall StorpTelemetryNvmeLogNamespacePerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v21 = v7 != 0 ? 20 : 17;
      v43 = &v21;
      tlgCreate1Sz_wchar_t((__int64)v45, *(const wchar_t **)(*(_QWORD *)(v6 + 128) + 1032LL));
      v46 = &v25;
      v16 = *(_BYTE *)(v8 + 8);
      v48 = &v16;
      v26 = *(_QWORD *)(v8 + 360);
      ...
      v68 = &v17;
      v14 = v12[46];
      v17 = 3 * qword_1401730B0;
      v70 = v14;
      v71 = 8 * (unsigned __int16)(3 * qword_1401730B0);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_1401730B0) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_140163D6E,
        v15,
        (__int64)v12,
        0x1Au,
        &v30);
