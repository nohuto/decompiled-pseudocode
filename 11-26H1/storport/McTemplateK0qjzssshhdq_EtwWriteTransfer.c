/*
 * XREFs of McTemplateK0qjzssshhdq_EtwWriteTransfer @ 0x1400E4158
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzssshhdq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a13)
{
  ...
  v49 = 4LL;
  v51 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v24, &EventNVMeoFConnectControllerQueueFailure, 0LL, 0xBu, &v27);
}
