/*
 * XREFs of NvmeFabricControllerQueueComputeCtrlAugmentedChallenge @ 0x1400FBFC8
 * Callers:
...
__int64 __fastcall NvmeFabricControllerQueueComputeCtrlAugmentedChallenge(__int64 a1, unsigned __int16 a2, UCHAR *a3)
{
  ULONG v4; // esi
  __int64 v6; // rdx
  int v7; // ebx
...
LABEL_13:
  ...
  if ( *(_DWORD *)v12 != v4 )
    goto LABEL_12;
  v7 = ComputeHash(v8, v4, (PUCHAR)(*(_QWORD *)(a1 + 96) + 1064LL), *(ULONG *)v12, (__int64)v14, (ULONG *)v13, a3);
  if ( v7 < 0 )
    goto LABEL_13;
  if ( *(_DWORD *)v13 != v4 )
  {
