/*
 * XREFs of NvmeControllerCreateAERExtendedCommandPool @ 0x1400F1C38
 * Callers:
...
__int64 __fastcall NvmeControllerCreateAERExtendedCommandPool(__int64 a1, unsigned __int16 a2)
{
  ...
  if ( a2 )
  {
    do
    {
      ...
      if ( !ExtendedCommand )
        break;
      *((_DWORD *)ExtendedCommand + 12) |= 4u;
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1416) + 8LL) + 8LL * v5) = ExtendedCommand;
      ExpInterlockedPushEntrySList((PSLIST_HEADER)(*(_QWORD *)(a1 + 1416) + 16LL), (PSLIST_ENTRY)ExtendedCommand + 1);
      ++v5;
    }
    while ( v5 < a2 );
  }
