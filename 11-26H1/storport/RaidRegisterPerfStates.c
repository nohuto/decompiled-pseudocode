/*
 * XREFs of RaidRegisterPerfStates @ 0x140051DCC
 * Callers:
        ...
        __int64 a7)
{
  ...
  if ( !a4 )
    return 3221225485LL;
  v14 = *a4;
  if ( !*a4 || !a5 || a6 || !(unsigned __int8)RaidValidatePerfSets(a5, v14) )
    return 3221225485LL;
  v15 = 48 * v14 + 56;
  v16 = (_DWORD *)(a5 + 24);
  v17 = v14;
  ...
  if ( *a4 )
  {
    do
    {
      ...
      else
      {
        ...
        {
          StorPoFxPerfState = RaidGetStorPoFxPerfState(v23, v27);
          v27 = v29 + 1;
          v22[1] = *(_QWORD *)(StorPoFxPerfState + 16);
          *v22 = *(_QWORD *)(StorPoFxPerfState + 8);
        }
      }
...
LABEL_30:
  ...
  while ( v40 );
  v10 = (char *)RaidAllocatePool(64LL, v38, 1330667858LL, a1);
  if ( v10 )
  {
...
LABEL_72:
    ...
    if ( RaidAdapter )
    {
      *(_QWORD *)(*((_QWORD *)RaidAdapter + 628) + 112LL) = v10;
      *(_DWORD *)(*((_QWORD *)RaidAdapter + 628) + 104LL) = *v55;
      *a6 = *(_QWORD *)(*((_QWORD *)RaidAdapter + 628) + 112LL);
      v53 = *(_DWORD *)(*((_QWORD *)RaidAdapter + 628) + 104LL);
      goto LABEL_72;
    }
LABEL_73:
    v35 = -1073741823;
