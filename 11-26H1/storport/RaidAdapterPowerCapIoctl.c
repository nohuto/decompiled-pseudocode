/*
 * XREFs of RaidAdapterPowerCapIoctl @ 0x140064324
 * Callers:
...
__int64 __fastcall RaidAdapterPowerCapIoctl(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rax
  __int64 v4; // rbp
  int v7; // esi
...
LABEL_15:
  ...
  v38 = *(_QWORD *)(v4 + 16);
  LOBYTE(a3) = v8 == 0;
  v7 = RaidAdapterSetMaxOperationalPower(a1, &v38, a3, 0LL);
  v11 = 0LL;
  if ( v7 >= 0 )
  {
    v11 = 24LL;
  ...
  *(_DWORD *)(a2 + 48) = v7;
  ...
  if ( *(_BYTE *)v14 != 15 )
  {
    ...
    if ( (byte_140173442 & 0x20) == 0 )
      goto LABEL_82;
    v16 = (const EVENT_DESCRIPTOR *)&EventPnpRequestComplete;
LABEL_81:
