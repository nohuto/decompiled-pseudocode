/*
 * XREFs of StorPortWorkItemRoutineInternal @ 0x14007C658
 * Callers:
 *     StorPortWorkItemRoutine @ 0x14007C640 (StorPortWorkItemRoutine.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1401385D0 (_guard_dispatch_icall.c)
 */

void __fastcall StorPortWorkItemRoutineInternal(__int64 a1, __int64 a2)
{
  __int64 v2; // rbx
  __int64 v3; // rsi
        ...
        _InterlockedExchange((volatile __int32 *)(a2 + 24), 0) == 2) )
  {
    ...
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v2 )
    {
      _InterlockedDecrement((volatile signed __int32 *)(v2 + 4952));
LABEL_15:
      v7 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(v2 + 336);
      goto LABEL_13;
    }
    _InterlockedDecrement((volatile signed __int32 *)(v3 + 1096));
  }
  else if ( v2 )
  {
    goto LABEL_15;
