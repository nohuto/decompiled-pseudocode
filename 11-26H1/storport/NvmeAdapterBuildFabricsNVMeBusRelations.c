/*
 * XREFs of NvmeAdapterBuildFabricsNVMeBusRelations @ 0x1400D312C
 * Callers:
...
__int64 __fastcall NvmeAdapterBuildFabricsNVMeBusRelations(__int64 a1, _QWORD *a2)
{
  ...
  v8 = (KSPIN_LOCK **)(*(_QWORD *)(v2 + 608) + 136LL);
  v9 = *v8;
  ...
  if ( Pool )
  {
    if ( v7 )
    {
      v11 = (_QWORD *)(*(_QWORD *)(v2 + 608) + 136LL);
      v12 = (_QWORD *)*v11;
      if ( (_QWORD *)*v11 != v11 )
      {
        do
        ...
        while ( v12 != (_QWORD *)(*(_QWORD *)(v2 + 608) + 136LL) );
        v6 = v21;
        v3 = 0;
      }
      v5 = a2;
