/*
 * XREFs of McTemplateK0qjzszhhsshqhhuuxqqbr17uuq_EtwWriteTransfer @ 0x1400C84F8
 * Callers:
        ...
        char a25)
{
  ...
  int v93; // [rsp+1E0h] [rbp+D8h] BYREF
  ...
  v90 = 1LL;
  v92 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v40, &EventMFNDQueryCCQoSStatisticsLog, 0LL, 0x17u, &v43);
}
