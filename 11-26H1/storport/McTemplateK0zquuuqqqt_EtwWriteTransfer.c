/*
 * XREFs of McTemplateK0zquuuqqqt_EtwWriteTransfer @ 0x1400796C0
 * Callers:
        ...
        char a12)
{
  ...
  v32 = 4LL;
  v34 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)L"NULL", &EventSetLunQueueDepthBtl8, 0LL, 0xAu, &v15);
}
