/*
 * XREFs of RaidAdapterHwBootPartitionDownloadIoctl @ 0x140061864
 * Callers:
...
__int64 __fastcall RaidAdapterHwBootPartitionDownloadIoctl(__int64 a1, __int64 a2)
{
  int v2; // ebx
  __int64 v4; // rcx
  PVOID v6; // r14
  ...
  if ( *(_QWORD *)(a1 + 608) && *(_QWORD *)(a1 + 616) )
  {
    ...
    if ( v8 < 0x28 || v8 < *(_DWORD *)(v4 + 4) )
    {
      v7 = -1073741820;
      goto LABEL_15;
    }
    if ( *(_QWORD *)(v4 + 24) > (unsigned __int64)*(unsigned int *)(a1 + 408) )
    {
LABEL_2:
      v7 = -1073741811;
      goto LABEL_15;
    }
    RaBuildHwBootPartitionDownloadBufferForMiniport(*(_QWORD *)(a1 + 8), a2, &P, &v40);
    v6 = P;
    if ( !P )
    {
      v7 = -1073741801;
  ...
  if ( *(_BYTE *)v11 != 15 )
  {
    ...
    if ( *(_BYTE *)(v11 + 1) == 7 && !*(_DWORD *)(v11 + 8) )
    {
      if ( (byte_140173442 & 0x40) != 0 )
      {
        ...
        LODWORD(v34) = v2;
        McTemplateK0pqd_EtwWriteTransfer(v10, v11, &v42, a2, v34, v35);
      }
      goto LABEL_81;
    }
