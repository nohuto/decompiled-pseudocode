/*
 * XREFs of RaidUnitPendingIrpDpcRoutine @ 0x140049A40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  for ( i = 0; i < MaximumProcessorCount; ++i )
  {
    ...
    if ( _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v4 + 40) + v14 + 4), 1, 0) )
    {
      for ( ; i; --i )
      {
        v14 -= 64LL;
        _InterlockedExchange((volatile __int32 *)(*(_QWORD *)(v4 + 40) + v14 + 4), 0);
      }
      goto LABEL_7;
    }
  }
  v15 = (*(_DWORD *)(*(_QWORD *)(v4 + 32) + 80LL) >> 1) & 3;
