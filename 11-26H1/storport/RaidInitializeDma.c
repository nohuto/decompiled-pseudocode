/*
 * XREFs of RaidInitializeDma @ 0x140187C24
 * Callers:
 ...
 *     RaidAreDriversDmarCompatible @ 0x1400721D4 (RaidAreDriversDmarCompatible.c)
...
__int64 __fastcall RaidInitializeDma(__int64 a1, struct _DEVICE_OBJECT *a2, __int64 a3, __int64 a4, char a5)
{
  ...
  if ( StorIsChildAdapterPdo(a2) )
    v6 = *(struct _DEVICE_OBJECT **)(*((_QWORD *)v6->DeviceExtension + 9) + 32LL);
...
LABEL_24:
  ...
  DmaAdapter = IoGetDmaAdapter(v6, &DeviceDescription, (PULONG)(a1 + 12));
  *(_QWORD *)a1 = DmaAdapter;
  if ( !DmaAdapter )
    return 3221225626LL;
  *(_BYTE *)(a1 + 8) = RaidAreDriversDmarCompatible(v6);
  return 0LL;
}
