/*
 * XREFs of RaidAdapterStorageTcgRevertConfig @ 0x140085F48
 * Callers:
  ...
  if ( *(_DWORD *)(&MasterIrp->Size + 1) == v9 && Options >= v9 )
  {
    ...
    else
    {
      ...
      if ( TcgProperties >= 0 )
      {
        ...
        TcgProperties = RaidRevertTcgConfiguration(a1, v11, HIDWORD(MasterIrp->MdlAddress), (int)MasterIrp + 16, v50);
      }
    ...
    if ( CurrentStackLocation->MajorFunction != 15 )
    {
      ...
      if ( CurrentStackLocation->MinorFunction == 7 && !CurrentStackLocation->Parameters.Read.Length )
      {
        if ( (byte_140173442 & 0x40) != 0 )
        {
          ...
          LODWORD(pszDest) = v2;
          McTemplateK0pqd_EtwWriteTransfer(v14, (__int64)CurrentStackLocation, &v48, Irp, pszDest, v38);
        }
        goto LABEL_87;
      }
...
LABEL_86:
      ...
      McTemplateK0pd_EtwWriteTransfer(v14, v17, &v48, Irp, pszDest);
      goto LABEL_87;
    }
    if ( byte_140173441 >= 0 )
      goto LABEL_87;
...
LABEL_80:
      if ( byte_140173441 < 0 )
      {
        ...
        LODWORD(pszDest) = Irp->IoStatus.Status;
        McTemplateK0pduuuuup_EtwWriteTransfer(v14, SecurityContext, &v48, Irp, pszDest, v38, v39, v40, v41, v42, Irp);
      }
      goto LABEL_87;
    }
    v25 = 0LL;
