/*
 * XREFs of StorpTelemetryLogNvmeNamespaceErrorDataCriticalData @ 0x1400BAC78
 * Callers:
...
void __fastcall StorpTelemetryLogNvmeNamespaceErrorDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v55[1] = 0;
      v55[0] = 104 * v10;
      tlgWriteTransfer_EtwWriteTransfer(v11, (unsigned __int8 *)dword_1401638A5, v8, v7, 0x16u, &v21);
    }
  }
}
