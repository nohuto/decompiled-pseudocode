/*
 * XREFs of RaidAdapterCreateDevmapEntry @ 0x14005B814
 * Callers:
 ...
 *     PortMapOpenKey @ 0x1400461B0 (PortMapOpenKey.c)
      ...
      if ( *(_BYTE *)(a1 + 456) )
      {
        do
        {
          if ( v2 >= 0xFF )
            break;
          LOBYTE(v4) = v2;
          InitiatorBusId = RaidAdapterGetInitiatorBusId(a1, v4, v5, a1 + 8 * (v2 + 268LL));
