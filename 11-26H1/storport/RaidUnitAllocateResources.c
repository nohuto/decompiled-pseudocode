/*
 * XREFs of RaidUnitAllocateResources @ 0x14002D7B4
 * Callers:
 ...
 *     StorCreateEventQueue @ 0x14002DFEC (StorCreateEventQueue.c)
...
LABEL_20:
  ...
  if ( v14 )
  {
    ...
    v15 = *(_QWORD *)(a1 + 32);
    *(_QWORD *)(v15 + 64) = IoAllocateWorkItem(*v12);
...
LABEL_19:
  ...
  if ( *v27 != 1314275652 )
    v29 = 131LL;
  v30 = ((v27[v29] + 7) & 0xFFFFFFF8) + 1200;
  v31 = ((v27[v29] + 7) & 0xFFFFFFF8) + 1344;
  if ( *(_BYTE *)(v2 + 482) != 1 )
    v31 = v30;
  ...
  *(_QWORD *)(a1 + 1832) = ContiguousIoResources + 1200;
  ...
  if ( *(_BYTE *)(v2 + 482) == 1 )
  {
    *(_DWORD *)(v34 + 792) = 144;
    ...
    if ( *v35 != 1314275652 )
      v28 = 131LL;
    *(_QWORD *)(v34 + 808) = v34 + ((v35[v28] + 7) & 0xFFFFFFF8) + 1200LL;
  }
