/*
 * XREFs of DlrmCheckAndScheduleScaleUp @ 0x14012CE6C
 * Callers:
...
char __fastcall DlrmCheckAndScheduleScaleUp(__int64 a1, int a2, int a3)
{
  char v3; // si
  ...
  if ( a1 )
  {
    ScaleThreshold = DlrmGetScaleThreshold(a2, *(_WORD *)(a1 + 4), 1);
    if ( a3 <= a2 || *(_QWORD *)(a1 + 24) / 1024LL < ScaleThreshold )
    {
