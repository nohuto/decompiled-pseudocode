/*
 * XREFs of RaUnitHwBootPartitionGetInfoIoctl @ 0x14009CE1C
 * Callers:
...
NTSTATUS __fastcall RaUnitHwBootPartitionGetInfoIoctl(__int64 a1, __int64 a2)
{
  int v3; // ebx
  __int64 v4; // rdx
  __int64 v5; // rax
...
LABEL_68:
      if ( byte_140173441 < 0 )
      {
        ...
        McTemplateK0pduuuuup_EtwWriteTransfer(v9, v13, &v35, a2, *(_DWORD *)(a2 + 48), v27, v14, v17, v18, v19, a2);
      }
      goto LABEL_75;
    }
    v28 = *v15 & 0x7F;
