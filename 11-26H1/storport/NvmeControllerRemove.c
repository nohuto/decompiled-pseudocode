/*
 * XREFs of NvmeControllerRemove @ 0x1400F9AE8
 * Callers:
 ...
 *     NvmeControllerPowerUninitialize2 @ 0x1400F8A88 (NvmeControllerPowerUninitialize2.c)
...
__int64 __fastcall NvmeControllerRemove(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 968) = v2;
  if ( (unsigned int)Feature_FixDeviceStopRestartForAzureStorageRepaveNode__private_IsEnabledDeviceUsageNoInline() )
    NvmeControllerPowerUninitialize2(a1, 0);
  else
