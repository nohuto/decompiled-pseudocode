/*
 * XREFs of NvmeNamespaceWmiSrb @ 0x140116460
 * Callers:
...
__int64 __fastcall NvmeNamespaceWmiSrb(__int64 a1, __int64 a2, __int64 a3)
{
  bool v3; // zf
  int v5; // ebx
  ...
  *(_BYTE *)(a2 + 3) = 48;
  if ( v3 )
    *(_DWORD *)(a2 + 44) = -1073741808;
  else
    *(_DWORD *)(a2 + 64) = -1073741808;
  v5 = 0;
  *(_BYTE *)(a3 + 141) = -84;
  v3 = StorEtwLoggingEnabled == 0;
  *(_DWORD *)(a3 + 48) = -1073741808;
  if ( v3 )
    goto LABEL_70;
  v32 = 0LL;
  ...
  if ( *(_BYTE *)v7 != 15 )
  {
    ...
    v29 = *(_DWORD *)(a3 + 48);
LABEL_69:
    McTemplateK0pd_EtwWriteTransfer(v6, v9, &v32, a3, v29);
    goto LABEL_70;
  }
  if ( byte_140173441 >= 0 )
    goto LABEL_70;
...
LABEL_63:
    if ( byte_140173441 < 0 )
    {
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v6, v10, &v32, a3, *(_DWORD *)(a3 + 48), v24, v11, v14, v15, v16, a3);
    }
    goto LABEL_70;
  }
  v18 = 0LL;
