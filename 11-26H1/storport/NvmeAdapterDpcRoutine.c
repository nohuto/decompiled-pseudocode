/*
 * XREFs of NvmeAdapterDpcRoutine @ 0x1400D4FF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v6 = 0;
  v7 = 0;
  if ( _InterlockedCompareExchange((volatile signed __int32 *)(v4 + 1112), 1, 0) != 1 )
  {
    v8 = *(_QWORD *)(v4 + 1136);
    if ( DpcCompletionLimit )
    {
      do
      {
        v9 = *(PSLIST_ENTRY *)(v4 + 1136);
        if ( !v9 )
        {
          if ( v7 )
            break;
          v9 = ExpInterlockedFlushSList((PSLIST_HEADER)(v4 + 1120));
          *(_QWORD *)(v4 + 1136) = v9;
          v7 = 1;
          if ( !v9 )
            break;
        }
        *(_QWORD *)(v4 + 1136) = v9->Next;
...
LABEL_16:
    ...
    if ( FirstEntrySList((PSLIST_HEADER)(v4 + 1120)) )
LABEL_19:
