/*
 * XREFs of RaidAdapterRestartQueues @ 0x140010F40
 * Callers:
 ...
 *     RaidAdapterRestartDpcRoutine @ 0x140065960 (RaidAdapterRestartDpcRoutine.c)
...
void __fastcall RaidAdapterRestartQueues(__int64 a1, char a2)
{
  ...
  __int128 i; // [rsp+48h] [rbp-60h] BYREF
  ...
  if ( *(_DWORD *)(a1 + 1032) )
  {
    do
    {
      v5 = (KSPIN_LOCK *)(*(_QWORD *)(a1 + 1024) + 320 * v4);
      v34 = 0LL;
      v35 = 0;
      for ( i = 0LL;
            ;
    ...
    while ( (unsigned int)v4 < *(_DWORD *)(a1 + 1032) );
  }
  if ( !v2 )
  ...
  if ( v8 != (__int64 *)(a1 + 144) )
  {
    while ( 1 )
    {
      ...
      if ( !v18 )
        goto LABEL_55;
      if ( (unsigned __int8)StorSubmitIoGatewayItem(v8[83], v18, &i) )
      {
        v25 = v8[83];
...
LABEL_53:
      ...
      {
        LOBYTE(v24) = 1;
        ((void (__fastcall *)(__int64, __int64, __int128 *, __int64))v8[81])(v8[80], v18 - 120, &i, v24);
      }
LABEL_55:
      if ( !v10 )
        KeLowerIrql(v9);
