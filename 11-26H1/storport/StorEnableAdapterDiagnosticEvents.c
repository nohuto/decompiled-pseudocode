/*
 * XREFs of StorEnableAdapterDiagnosticEvents @ 0x14000F8DC
 * Callers:
...
__int64 __fastcall StorEnableAdapterDiagnosticEvents(__int64 a1)
{
  ...
  v1 = StorMiniportDiagnosticEventsEnabled;
  if ( !a1 )
    return 3221225485LL;
  v3 = a1 + 376;
  if ( !(unsigned __int8)RaidIsAdapterControlSupported(a1 + 376, 20LL) )
    return 3221225659LL;
  if ( ((*(_BYTE *)(a1 + 110) & 0x20) != 0) == v1 )
    return 0LL;
  result = RaCallMiniportAdapterControl(v3);
  if ( (int)result >= 0 )
    *(_BYTE *)(a1 + 110) ^= (*(_BYTE *)(a1 + 110) ^ (32 * v1)) & 0x20;
  return result;
}
