/*
 * XREFs of RaUnitIgnorePnpIrp @ 0x140189560
 * Callers:
...
__int64 __fastcall RaUnitIgnorePnpIrp(__int64 a1, __int64 a2)
{
  ...
  GUID v32; // [rsp+70h] [rbp-48h] BYREF
  ...
  if ( *(_BYTE *)v6 != 15 )
  {
    ...
    if ( *(_BYTE *)(v6 + 1) == 7 && !*(_DWORD *)(v6 + 8) )
    {
      if ( (byte_140173442 & 0x40) != 0 )
      {
        ...
        if ( v7 )
          v2 = *v7;
        McTemplateK0pqd_EtwWriteTransfer(v5, v6, &v32, a2, v2, *(_DWORD *)(a2 + 48));
      }
      goto LABEL_67;
    }
    ...
    v28 = *(_DWORD *)(a2 + 48);
LABEL_66:
    McTemplateK0pd_EtwWriteTransfer(v5, v8, &v32, a2, v28);
    goto LABEL_67;
  }
  if ( byte_140173441 >= 0 )
    goto LABEL_67;
...
LABEL_60:
    if ( byte_140173441 < 0 )
    {
      ...
      McTemplateK0pduuuuup_EtwWriteTransfer(v5, v9, &v32, a2, *(_DWORD *)(a2 + 48), v23, v10, v13, v14, v15, a2);
    }
    goto LABEL_67;
  }
  v17 = 0LL;
