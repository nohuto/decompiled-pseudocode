/*
 * XREFs of NvmePnpAsyncStartComplete @ 0x1400E2620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NvmePnpAsyncStartComplete(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // r9
  __int64 *v4; // rsi
  int v5; // ebx
    ...
    if ( *(_BYTE *)*v4 != 15 )
    {
      ...
      if ( *(_BYTE *)(v10 + 1) == 7 && !*(_DWORD *)(v10 + 8) )
      {
        if ( (byte_140173442 & 0x40) != 0 )
        {
          ...
          LODWORD(v32) = v5;
          McTemplateK0pqd_EtwWriteTransfer(v9, v10, &v38, a2, v32, v33);
        }
        goto LABEL_73;
      }
...
LABEL_72:
      ...
      McTemplateK0pd_EtwWriteTransfer(v9, v12, &v38, a2, v32);
      goto LABEL_73;
    }
    if ( byte_140173441 >= 0 )
      goto LABEL_73;
...
LABEL_66:
      if ( byte_140173441 < 0 )
      {
        ...
        LODWORD(v32) = *(_DWORD *)(a2 + 48);
        McTemplateK0pduuuuup_EtwWriteTransfer(v9, v13, &v38, a2, v32, v33, v34, v35, v18, v19, a2);
      }
      goto LABEL_73;
    }
    v27 = *v15 & 0x7F;
...
LABEL_64:
  ...
  IoQueueWorkItem(*(PIO_WORKITEM *)a3, NvmePnpAsyncStartCompleteWorker, HyperCriticalWorkQueue, (PVOID)a3);
  return 3221225494LL;
}
