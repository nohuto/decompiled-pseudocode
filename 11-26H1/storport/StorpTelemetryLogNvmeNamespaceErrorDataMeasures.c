/*
 * XREFs of StorpTelemetryLogNvmeNamespaceErrorDataMeasures @ 0x1400BAEFC
 * Callers:
...
void __fastcall StorpTelemetryLogNvmeNamespaceErrorDataMeasures(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // rax
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v34 = &v15;
      v35 = 4LL;
      tlgCreate1Sz_wchar_t((__int64)v36, *(const wchar_t **)(*(_QWORD *)(v6 + 128) + 1032LL));
      v8 = *(_QWORD *)(v7 + 608);
      v10 = v9[1];
      v37 = &v20;
      ...
      v55[1] = 0;
      v55[0] = 104 * v10;
      tlgWriteTransfer_EtwWriteTransfer(v11, (unsigned __int8 *)dword_14016254D, v8, v7, 0x16u, &v21);
    }
  }
}
