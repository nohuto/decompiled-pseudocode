/*
 * XREFs of StorpTelemetrySendAdapterSurfaceUfsHealthInfo @ 0x1400C0CD0
 * Callers:
 ...
 *     StorpSwapUfsHealthDescriptorsVpdPage @ 0x1400B9940 (StorpSwapUfsHealthDescriptorsVpdPage.c)
...
__int64 __fastcall StorpTelemetrySendAdapterSurfaceUfsHealthInfo(__int64 a1)
{
  ...
  int v48; // [rsp+6Ch] [rbp-9Ch] BYREF
  int v49; // [rsp+70h] [rbp-98h] BYREF
  int v50; // [rsp+74h] [rbp-94h] BYREF
...
LABEL_6:
  ...
  *(_QWORD *)(v3 + 184) = v25;
  *(_QWORD *)(v3 + 224) = v5;
  RaSrbSetMiniportContext((int *)a1, Srb, v2 + 1200);
...
LABEL_52:
    ...
    if ( !v31 || *((_DWORD *)v4 + 5) < *((_DWORD *)v4 + 4) || *((_DWORD *)v4 + 9) < *((_DWORD *)v4 + 8) )
      goto LABEL_52;
    if ( (unsigned int)dword_140172178 > 5 && tlgKeywordOn(v29, 0x400000000000LL) )
    {
      v32 = *(const wchar_t **)(a1 + 4784);
      v61 = &v52;
      v52 = 0x1000000LL;
      v63 = a1 + 5128;
      v62 = 8LL;
      ...
      *(_QWORD *)v69 = 510LL;
      ...
      v111 = 4LL;
      v113 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v69, (unsigned __int8 *)dword_140161E27, v34, v35, 0x1Du, &v60);
    }
  }
LABEL_64:
