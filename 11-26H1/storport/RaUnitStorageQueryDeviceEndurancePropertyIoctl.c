/*
 * XREFs of RaUnitStorageQueryDeviceEndurancePropertyIoctl @ 0x1400A3DB4
 * Callers:
...
__int64 __fastcall RaUnitStorageQueryDeviceEndurancePropertyIoctl(__int64 a1, __int64 a2)
{
  _DWORD *v2; // r12
  int v3; // esi
  __int64 v4; // rax
...
LABEL_7:
  ...
  v10 = RaBuildQueryEnduranceInfoPropertyBufferForMiniport(*(_QWORD *)(a1 + 8), a2, (__int64 *)P, &v43);
