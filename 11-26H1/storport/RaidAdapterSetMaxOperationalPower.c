/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x14007F758
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x14007F4D0 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x14007F498 (RaidAdapterEffectiveMaxOperationalPower.c)
...
LABEL_11:
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(v15, 0x400000000000LL) )
    {
      ...
      v32 = v20;
      v60 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(v18, (unsigned __int8 *)dword_1401601EF, v19, v20, 0xEu, &v36);
    }
  }
