/*
 * XREFs of NvmeAdapterSetMaxOperationalPower @ 0x1401264A8
 * Callers:
 *     NvmeAdapterPowerCapIoctl @ 0x1400DA940 (NvmeAdapterPowerCapIoctl.c)
 *     NvmeAdapterPassiveCoolingCallback @ 0x140123E40 (NvmeAdapterPassiveCoolingCallback.c)
 *     NvmePowerSettingCallback @ 0x14012A580 (NvmePowerSettingCallback.c)
 * Callees:
 *     NvmeAdapterEffectiveMaxOperationalPower @ 0x14012385C (NvmeAdapterEffectiveMaxOperationalPower.c)
...
LABEL_10:
  ...
  *(_QWORD *)(v7 + 8LL * a4 + 40) = v5;
  ...
  {
    NvmeControllerMaxOperationalPower(*(_QWORD *)(v12 + 1152), v17);
    v11 = v18;
  }
  if ( a3 )
  {
