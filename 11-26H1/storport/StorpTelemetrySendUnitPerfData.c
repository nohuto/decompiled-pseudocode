/*
 * XREFs of StorpTelemetrySendUnitPerfData @ 0x14004FD38
 * Callers:
...
__int64 __fastcall StorpTelemetrySendUnitPerfData(__int64 a1)
{
  ...
  v2 = (unsigned int)qword_1401730B0;
  v3 = 0LL;
  v55 = 0LL;
  Pool = 0LL;
  v5 = 0LL;
    ...
    if ( Pool
      && (RecommendedSharedDataAlignment = KeGetRecommendedSharedDataAlignment(),
          ...
          (v5 = (_QWORD *)RaidAllocatePool(
                            72LL,
                            -RecommendedSharedDataAlignment & (v8 + 24 * (_DWORD)v2 - 1),
                            1700028754LL,
                            *(_QWORD *)(a1 + 8))) != 0LL) )
    {
      if ( UseQPCTime )
      ...
      *(LARGE_INTEGER *)(a1 + 2392) = v10;
      ...
      {
        v16 = (unsigned int)dword_1401730B8 * i;
        if ( (_DWORD)v2 )
        {
          v17 = Pool + 1;
          v18 = v2;
      ...
      if ( (_DWORD)v2 )
      {
        ...
        do
        {
          v25 = *(_QWORD *)&v22[(_QWORD)v21 - 8] - *(v21 - 1);
          *(_QWORD *)&v23[(_QWORD)v21 - 8] = v25;
          v26 = *(_QWORD *)&v22[(_QWORD)v21] - *v21;
          *(_QWORD *)&v23[(_QWORD)v21] = v26;
          *(_QWORD *)&v23[(_QWORD)v21 + 8] = *(_QWORD *)&v22[(_QWORD)v21 + 8] - v21[1];
          v21 += 3;
          v20 += v26 + v25;
          --v24;
        }
      ...
      memmove(*(void **)(a1 + 2400), Pool, (unsigned int)dword_1401730B8);
      if ( v20 )
      {
        v87 = 0LL;
        if ( (_WORD)TelemetryPerfContext )
        {
          if ( WORD1(TelemetryPerfContext) )
          {
            ...
            if ( (_DWORD)v2 )
            {
              ...
              do
              {
                if ( (unsigned int)v28 >= dword_14017304C && (unsigned int)v28 < *((_DWORD *)&xmmword_140173070 + 3) )
                {
        ...
        if ( *(_QWORD *)(a1 + 2416) )
        {
          ...
          if ( g_RaidNumberProcessors )
          {
            ...
            do
            {
              v38 = (unsigned int)(dword_1401730D0 * v36);
              v39 = *(_QWORD *)(a1 + 2416);
              ...
              *(_QWORD *)(v40 + v39) = 0LL;
              if ( v41 > v27 )
                v27 = v41;
              v37 += *(_QWORD *)(v40 + v39 + 8);
              v35 += *(_QWORD *)(v40 + v39 + 16);
              v36 = ++v34;
            }
            while ( v34 < v33 );
            v53.m128i_i64[0] = v27;
          ...
          v44 = v37 - *(_QWORD *)(a1 + 2432);
          v28 = v35 - *(_QWORD *)(a1 + 2440);
          *(__m128i *)(a1 + 2424) = v43;
          v91 = v28;
          *(_OWORD *)(a1 + 2440) = v42;
          v89 = v27;
        ...
        if ( v45 )
        {
          v3 = (const char *)(v45 + 90);
        }
        else
        {
          v46 = *(_QWORD *)(a1 + 152);
          if ( v46 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 608LL) + 184LL) & 0x40) != 0 )
            v3 = (const char *)(v46 + 41);
        }
        v88 = v5;
...
LABEL_63:
        ...
        if ( (byte_140173444 & 8) != 0 )
        {
          ...
          v49 = (const wchar_t *)&unk_140153274;
          if ( v3 )
            v48 = v3;
          if ( *(_QWORD *)(v47 + 5144) )
            v49 = *(const wchar_t **)(v47 + 5144);
      ...
      v50 = *(_QWORD *)(a1 + 24);
      if ( *(_DWORD *)(v50 + 4340) == 17 && v50 && (*(_BYTE *)(v50 + 113) & 3) == 2 && *(_QWORD *)(v50 + 6288) )
