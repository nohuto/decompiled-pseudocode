/*
 * XREFs of GatewayCheckWaitTimeout @ 0x14004C4D8
 * Callers:
 *     RaidAdapterCheckWaitTimeout @ 0x14004B9A8 (RaidAdapterCheckWaitTimeout.c)
 * Callees:
 *     StorGetPendingIoCount @ 0x14005636C (StorGetPendingIoCount.c)
 */
...
__int64 __fastcall GatewayCheckWaitTimeout(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( !v9 )
    return 0LL;
  while ( *(_QWORD *)(*(_QWORD *)(v5 + 1024) + 320 * v10 + 264) == *(_QWORD *)(v5 + 1024) + 320 * v10 + 264 )
  {
...
LABEL_29:
    ...
    while ( (unsigned int)v12 < *(_DWORD *)(*(_QWORD *)(a1 + 48) + 1032LL) );
    if ( v7 )
    {
      if ( PendingIoCount > *(_DWORD *)(v5 + 5412) )
        *(_DWORD *)(v5 + 5412) = PendingIoCount;
    }
  }
  return v6;
}
