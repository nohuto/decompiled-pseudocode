/*
 * XREFs of NvmeNamespaceStorageNotificationGetInfoIoctl @ 0x1401AAB88
 * Callers:
...
NTSTATUS __fastcall NvmeNamespaceStorageNotificationGetInfoIoctl(__int64 a1, __int64 a2)
{
  int v2; // ebx
  bool v4; // zf
