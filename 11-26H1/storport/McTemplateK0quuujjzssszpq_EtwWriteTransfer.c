/*
 * XREFs of McTemplateK0quuujjzssszpq_EtwWriteTransfer @ 0x14005F168
 * Callers:
...
NTSTATUS __fastcall McTemplateK0quuujjzssszpq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16)
{
  ...
  v63 = 8LL;
  v65 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v31, &EventNVMeUnlockPhysicalAddress, 0LL, 0xEu, &v34);
}
