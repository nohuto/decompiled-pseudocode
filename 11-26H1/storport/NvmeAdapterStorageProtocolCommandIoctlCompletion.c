/*
 * XREFs of NvmeAdapterStorageProtocolCommandIoctlCompletion @ 0x1400DFF80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NvmeAdapterStorageProtocolCommandIoctlCompletion(union _SLIST_HEADER *a1, __int64 a2, __int64 a3)
{
  int v3; // ebx
  __int64 v5; // rcx
  PIRP v7; // rbp
  ...
  GUID v61; // [rsp+B0h] [rbp-58h] BYREF
...
LABEL_31:
  ...
  *(_QWORD *)&MasterIrp->Flags = 1LL;
  ...
  v59 = 84;
  StorGetStorageProtocolCommandBufferTotalLength(MasterIrp, &v59);
  v22 = v59;
LABEL_32:
  v7->IoStatus.Information = v22;
  v23 = *(_QWORD *)(*(_QWORD *)a2 + 4160LL);
  if ( v23 )
    NvmeFreeDmaBuffer((_DWORD)a1, *(_DWORD *)(*(_QWORD *)a2 + 4248LL), v11, v23, *(_QWORD *)(*(_QWORD *)a2 + 4168LL));
  ...
  if ( *(_BYTE *)CurrentStackLocation != 15 )
  {
    ...
    if ( *(_BYTE *)(CurrentStackLocation + 1) == 7 && !*(_DWORD *)(CurrentStackLocation + 8) )
    {
      if ( (byte_140173442 & 0x40) != 0 )
      {
        ...
        LODWORD(v52) = v3;
        McTemplateK0pqd_EtwWriteTransfer(v24, CurrentStackLocation, &v61, v7, v52, v53);
      }
      goto LABEL_176;
    }
...
LABEL_175:
    ...
    McTemplateK0pd_EtwWriteTransfer(v24, v33, &v61, v7, v52);
    goto LABEL_176;
  }
  if ( byte_140173441 >= 0 )
    goto LABEL_176;
...
LABEL_169:
    if ( byte_140173441 < 0 )
    {
      ...
      LOBYTE(v53) = v48;
      LODWORD(v52) = p_IoStatus->Status;
      McTemplateK0pduuuuup_EtwWriteTransfer(v24, v34, &v61, v7, v52, v53, v54, v55, v56, v57, v7);
    }
    goto LABEL_176;
  }
  v42 = 0LL;
