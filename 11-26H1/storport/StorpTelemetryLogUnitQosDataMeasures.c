/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1400BC1B4
 * Callers:
...
void __fastcall StorpTelemetryLogUnitQosDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140172178 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v41 = 1LL;
      v43 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v44, *(const wchar_t **)(v2 + 4784));
      ...
      v75 = 4LL;
      v77 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v7, (unsigned __int8 *)dword_14016441B, v11, v6, 0x1Bu, &v31);
    }
  }
}
