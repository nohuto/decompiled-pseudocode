/*
 * XREFs of RaidUnitHierarchicalReset @ 0x1400A8384
 * Callers:
 ...
 *     RaUnitSetHierarchicalResetSrbTimeoutCountdown @ 0x1400A0118 (RaUnitSetHierarchicalResetSrbTimeoutCountdown.c)
  ...
  if ( v7 < 0 )
  {
    ...
    if ( v7 < 0 )
    {
      ...
      else
      {
        ...
        _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)v8 + 4752LL));
      }
    }
    else
    {
      ...
      _InterlockedIncrement((volatile signed __int32 *)(a1 + 1400));
      v8 = a1 + 24;
      _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(a1 + 24) + 4756LL));
    }
  }
  else
  {
    ...
    _InterlockedIncrement((volatile signed __int32 *)(a1 + 1400));
    v8 = a1 + 24;
    _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(a1 + 24) + 4760LL));
  }
  if ( *(_QWORD *)(a1 + 2376) )
  {
    if ( *(_QWORD *)(a1 + 2400) )
    {
      ...
      if ( Pool )
      {
        ...
        {
          v12 = (unsigned int)qword_1401730B0;
          if ( (_DWORD)qword_1401730B0 )
          {
            v13 = &v10[(unsigned int)dword_1401730B8 * i + 8];
            do
            {
              v1 += *((_QWORD *)v13 + 1);
              v3 += *(_QWORD *)v13;
        ...
        v14 = (unsigned int)qword_1401730B0;
        v15 = *(_QWORD **)(a1 + 2400);
        if ( (_DWORD)qword_1401730B0 )
        {
          do
...
LABEL_26:
  if ( byte_140173445 < 0 )
    McTemplateK0zqjuuujsssudxx_EtwWriteTransfer(
      ...
      a1 + 168,
      a1 + 2104,
      *(const wchar_t **)(*(_QWORD *)v8 + 4784LL),
