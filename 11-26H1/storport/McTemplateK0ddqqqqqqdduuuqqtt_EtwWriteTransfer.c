/*
 * XREFs of McTemplateK0ddqqqqqqdduuuqqtt_EtwWriteTransfer @ 0x1400784AC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0ddqqqqqqdduuuqqtt_EtwWriteTransfer(
        __int64 a1,
        ...
        char a20)
{
  ...
  v53 = 4LL;
  v55 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, 0LL, 0x12u, &v21);
}
