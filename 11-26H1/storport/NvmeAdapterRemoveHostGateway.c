/*
 * XREFs of NvmeAdapterRemoveHostGateway @ 0x1400DBF3C
 * Callers:
...
__int64 __fastcall NvmeAdapterRemoveHostGateway(__int64 a1, _DWORD *a2, char a3)
{
  ...
  else if ( (*(_BYTE *)(a1 + 144) & 1) != 0 && *(_QWORD *)(a1 + 608) )
  {
    if ( *a2 == 1314277447 )
    {
      v7 = *((_QWORD *)a2 + 6);
            ...
            *(_QWORD *)(v13 + 8) = v11;
            ...
            if ( (v15 & 0x10) == 0 )
            {
              *(_QWORD *)(v14 + 32) = v15 | 0x10;
              ...
              NvmeAdapterCleanupSubsystemPort(a1, 1, (PVOID *)&v18);
            }
          }
        }
