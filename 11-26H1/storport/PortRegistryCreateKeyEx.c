/*
 * XREFs of PortRegistryCreateKeyEx @ 0x140046078
 * Callers:
 *     PortMapBuildAdapterEntry @ 0x140045F5C (PortMapBuildAdapterEntry.c)
 *     RaidUnitRegisterInterfaces @ 0x1400A8BDC (RaidUnitRegisterInterfaces.c)
 *     PortMapBuildBusEntry @ 0x14012FB44 (PortMapBuildBusEntry.c)
 *     PortMapBuildLunEntry @ 0x14012FBC8 (PortMapBuildLunEntry.c)
 * Callees:
...
__int64 PortRegistryCreateKeyEx(void *a1, ULONG a2, void **a3, const wchar_t *a4, ...)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  if ( (unsigned int)_vsnwprintf(Dest, 0x3EuLL, a4, Args) >= 0x3E )
    Dest[62] = 0;
  Dest[63] = 0;
