/*
 * XREFs of NvmeControllerInitializeAdminQueue @ 0x1400F5F24
 * Callers:
...
LABEL_3:
  ...
  *(_QWORD *)(v2 + 16) = *(_QWORD *)(a1 + 920) + 4096LL + *(unsigned int *)(a1 + 1216);
  v15 = *(_DWORD *)(v1 + 124);
  v9 = NvmeAllocateDmaBuffer(a1, v15 << 6, v12, (void **)&v18, &v17, 1);
  if ( v9 < 0 )
    goto LABEL_3;
  if ( *(_BYTE *)(a1 + 1728) == 1 )
  {
  ...
  NvmeControllerSubmissionQueueInit(a1, v1, 0, v18, v17, 0LL, 0LL);
  v18 = 0LL;
  v17 = 0LL;
  StorInitOutstandingRequestBitmap(v1);
  v9 = NvmeAllocateDmaBuffer(a1, 16 * v15, v16, (void **)&v18, &v17, 1);
  if ( v9 < 0 )
    goto LABEL_3;
  NvmeControllerCompletionQueueInit(a1, v2, 0, v18, v17);
