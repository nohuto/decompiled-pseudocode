/*
 * XREFs of McTemplateK0pdtquuuddddt_EtwWriteTransfer @ 0x1400AFCB8
 * Callers:
...
NTSTATUS McTemplateK0pdtquuuddddt_EtwWriteTransfer(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventPassThroughProtocolCommand, a3, 0xDu, &v4);
}
