/*
 * XREFs of StorReset @ 0x140050A30
 * Callers:
...
__int64 __fastcall StorReset(__int64 a1, unsigned int a2, int a3, char a4)
{
  ...
  if ( (unsigned int)(a3 - 1) > 1
    || (v12 = *(_DWORD **)(a1 - 16), (v12[62] & 1) != 0)
    || (RaidAdapter = RaMiniportGetRaidAdapter(v12), (v6 = RaidAdapter) == 0) )
  {
    v11 = -1073741811;
    goto LABEL_65;
  }
  if ( v5 == 2 && *(_DWORD *)(RaidAdapter + 392) != 5 )
    goto LABEL_9;
  v15 = *(_QWORD *)(RaidAdapter + 5440);
  if ( !v15
    || !*(_QWORD *)(v15 + 8)
    || *(_WORD *)(v15 + 2) < v14
    || *(_WORD *)v15 < 0x50u
  ...
  if ( !StorIsIoGatewayPaused(*(_QWORD *)(v6 + 1024)) )
  {
    v11 = -1073741808;
    goto LABEL_65;
  }
  ...
  if ( _interlockedbittestandset((volatile signed __int32 *)(v6 + 128), 2u) )
  {
    v11 = -1073740682;
    goto LABEL_65;
  }
  ...
  if ( !v17 )
  {
    Pool = RaidAllocatePool(64LL, 80LL, 1163026770LL, *(_QWORD *)(v6 + 8));
    *(_QWORD *)(v6 + 6208) = Pool;
    v17 = Pool;
    if ( !Pool )
      goto LABEL_28;
  ...
  if ( v5 == 1 )
  {
    if ( (*(_DWORD *)v17 & 1) == 0 )
    {
      ...
      KeInitializeEvent((PRKEVENT)(*(_QWORD *)(v6 + 6208) + 56LL), SynchronizationEvent, 0);
      **(_DWORD **)(v6 + 6208) |= 1u;
      v17 = *(_QWORD *)(v6 + 6208);
    }
    if ( v10 == 1 )
    ...
    *(_DWORD *)(*(_QWORD *)(v6 + 6208) + 16LL) = 0;
    *(_DWORD *)(*(_QWORD *)(v6 + 6208) + 8LL) = 0;
    *(_DWORD *)(*(_QWORD *)(v6 + 6208) + 4LL) = 0;
    *(_DWORD *)(*(_QWORD *)(v6 + 6208) + 12LL) = 0;
    **(_DWORD **)(v6 + 6208) &= ~0x20u;
    **(_DWORD **)(v6 + 6208) &= ~0x80u;
  }
  v19 = (*(__int64 (__fastcall **)(_QWORD, unsigned int *, _QWORD))(*(_QWORD *)(v6 + 5440) + 56LL))(
          *(_QWORD *)(*(_QWORD *)(v6 + 5440) + 8LL),
          &v53,
          0LL);
  v11 = v19;
  if ( v19 != -1073741789 )
...
LABEL_9:
  ...
  v20 = RaidAllocatePool(64LL, 24LL * v53, 1163026770LL, *(_QWORD *)(v6 + 8));
  v52 = (_BYTE *)v20;
  v7 = (_BYTE *)v20;
  if ( !v20 )
  {
LABEL_28:
  ...
  v11 = (*(__int64 (__fastcall **)(_QWORD, unsigned int *, __int64))(*(_QWORD *)(v6 + 5440) + 56LL))(
          *(_QWORD *)(*(_QWORD *)(v6 + 5440) + 8LL),
          &v53,
          v20);
  if ( v11 < 0 )
...
LABEL_50:
    if ( v5 == 2 )
    {
      if ( (v7[24 * (unsigned int)i + 16] & 4) != 0 )
        goto LABEL_52;
    }
    else if ( !v5 )
    {
      if ( (v7[24 * (unsigned int)i + 16] & 1) != 0 )
      {
LABEL_52:
        v23 = (_DWORD *)(v6 + 6096);
        goto LABEL_60;
    ...
    if ( v5 == 1 && (v7[24 * (unsigned int)i + 16] & 2) != 0 )
    {
      v23 = (_DWORD *)(v6 + 6100);
LABEL_60:
      v24 = 200 * *v23;
      ...
      *(_QWORD *)&v56 = 0LL;
      v26 = 0;
      *(_QWORD *)&v58 = 0LL;
      v11 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *, __int128 *, __int128 *))(v25 + 72))(
              *(_QWORD *)(v25 + 8),
              v47,
              &v56,
              &v58);
      if ( v11 >= 0 )
      {
        ...
        if ( !(_BYTE)v54 )
        {
          LOBYTE(v30) = 1;
          v50 = 1;
          v31 = RaidRequestDIrpForAssociatedUnits(v6, v30);
          v11 = v31;
          if ( v31 == 259 )
          {
            KeWaitForSingleObject((PVOID)(*(_QWORD *)(v6 + 6208) + 32LL), Executive, 0, 0, 0LL);
            **(_DWORD **)(v6 + 6208) |= 0x20u;
          }
        ...
        v11 = RaCallMiniportAdapterControlSafe(v6 + 376, 27LL);
        if ( v11 >= 0 )
        {
LABEL_69:
          v55 = 0LL;
          ...
          v28 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *, __int64, __int64 *, _QWORD))(*(_QWORD *)(v6 + 5440) + 64LL))(
                  *(_QWORD *)(*(_QWORD *)(v6 + 5440) + 8LL),
                  &v52[24 * i],
                  v4,
                  &v55,
...
LABEL_78:
            ...
            while ( 1 )
            {
              v11 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *, __int128 *, __int128 *))(*(_QWORD *)(v6 + 5440) + 72LL))(
                      *(_QWORD *)(*(_QWORD *)(v6 + 5440) + 8LL),
                      v47,
                      &v56,
                      &v58);
          ...
          if ( (*(_BYTE *)(v6 + 111) & 0x20) != 0 )
          {
            KeWaitForSingleObject((PVOID)(v6 + 6168), Executive, 0, 0, 0LL);
            v11 = *(_DWORD *)(v6 + 88) != 1 ? 0xC0000184 : 0;
          }
        }
      }
LABEL_63:
    ...
    if ( v5 == 1 )
    {
      if ( v50 )
      {
        ...
        if ( v34 )
        {
          ...
          {
            v35 = RaidRequestDIrpForAssociatedUnits(v6, 0LL);
            v36 = v35;
            if ( v35 == 259 )
            {
              KeWaitForSingleObject((PVOID)(*(_QWORD *)(v6 + 6208) + 56LL), Executive, 0, 0, 0LL);
              v36 = 0;
            }
            else if ( v11 >= 0 && v35 < 0 )
            {
...
LABEL_120:
    ...
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( v8.QuadPart && v33.QuadPart )
      {
        ...
        {
          v42 = 1000 * (v44 % PerformanceFrequency.QuadPart) / PerformanceFrequency.QuadPart
              + 1000 * (v44 / PerformanceFrequency.QuadPart);
          v43 = 10000
              * (1000 * (v44 % PerformanceFrequency.QuadPart) % PerformanceFrequency.QuadPart)
