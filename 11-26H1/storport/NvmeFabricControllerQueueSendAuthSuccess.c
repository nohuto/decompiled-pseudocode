/*
 * XREFs of NvmeFabricControllerQueueSendAuthSuccess @ 0x1400FE598
 * Callers:
...
__int64 __fastcall NvmeFabricControllerQueueSendAuthSuccess(__int64 a1, __int64 a2)
{
  __int64 v2; // r14
  unsigned int v5; // r8d
  unsigned int i; // ecx
