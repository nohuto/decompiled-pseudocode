/*
 * XREFs of NvmeAdapterTransportReconnectFabricControllerQueue @ 0x1400EF304
 * Callers:
...
LABEL_5:
  ...
  if ( v10 < 0 )
  {
    if ( (byte_14017344A & 8) != 0 )
    {
      ...
      Object = v28;
      if ( v23.QuadPart <= 0 || v23.QuadPart >= v6.QuadPart )
        v29 = v23.QuadPart - v6.QuadPart;
      else
        v29 = v23.QuadPart - v6.QuadPart - 1;
      if ( UseQPCTime )
      {
        v30 = 0LL;
        if ( v33.QuadPart && v29 )
        {
          v31 = 1000 * (v29 % v33.QuadPart);
          v29 = v31 / v33.QuadPart + 1000 * (v29 / v33.QuadPart);
          v30 = 10000 * (v31 % v33.QuadPart) / v33.QuadPart + 10000 * v29;
        }
      }
      else
      {
  ...
  else if ( (byte_14017344A & 2) != 0 )
  {
    ...
    if ( UseQPCTime )
    {
      ...
      if ( v33.QuadPart && v24 )
      {
        v26 = 1000 * (v24 % v33.QuadPart);
        v24 = v26 / v33.QuadPart + 1000 * (v24 / v33.QuadPart);
        v25 = 10000 * (v26 % v33.QuadPart) / v33.QuadPart + 10000 * v24;
      }
    }
    else
    {
