/*
 * XREFs of RaidAdapterStorageTcgSetLockingObjectAuthKey @ 0x140086A78
 * Callers:
...
LABEL_85:
      if ( byte_140173441 < 0 )
      {
        ...
        LODWORD(v37) = Irp->IoStatus.Status;
        McTemplateK0pduuuuup_EtwWriteTransfer(v14, SecurityContext, &v48, Irp, v37, v38, pszDest, v40, v41, v42, Irp);
      }
      goto LABEL_92;
    }
    v25 = 0LL;
