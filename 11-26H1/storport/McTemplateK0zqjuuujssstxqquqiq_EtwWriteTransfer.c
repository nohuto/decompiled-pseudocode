/*
 * XREFs of McTemplateK0zqjuuujssstxqquqiq_EtwWriteTransfer @ 0x14002714C
 * Callers:
...
__int64 __fastcall McTemplateK0zqjuuujssstxqquqiq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a21)
{
  ...
  v72 = 8LL;
  v74 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v21, &EventHighLatencyIo, 0LL, 19LL, v34);
}
