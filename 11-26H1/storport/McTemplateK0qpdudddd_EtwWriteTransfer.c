/*
 * XREFs of McTemplateK0qpdudddd_EtwWriteTransfer @ 0x14007E46C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qpdudddd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a10)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v12; // [rsp+40h] [rbp-81h] BYREF
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventAdapterPowerRequest, a3, 9u, &v12);
}
