/*
 * XREFs of NvmeGetAutoPowerStateTransitionCompletion @ 0x1400D10D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall NvmeGetAutoPowerStateTransitionCompletion(__int64 a1, __int64 *a2, __int64 a3)
{
  int v3; // r10d
  __int64 result; // rax
