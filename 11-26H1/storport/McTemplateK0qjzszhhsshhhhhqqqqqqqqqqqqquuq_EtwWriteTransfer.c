/*
 * XREFs of McTemplateK0qjzszhhsshhhhhqqqqqqqqqqqqquuq_EtwWriteTransfer @ 0x1400C7B00
 * Callers:
        ...
        char a33)
{
  ...
  int v116; // [rsp+260h] [rbp+158h] BYREF
  ...
  v113 = 1LL;
  v115 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v48, &EventMFNDSetChildPFSettings, 0LL, 0x1Fu, &v51);
}
