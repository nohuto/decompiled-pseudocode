/*
 * XREFs of StorpInitializePerUnitIoSizeDistribution @ 0x14018FEF4
 * Callers:
...
__int64 __fastcall StorpInitializePerUnitIoSizeDistribution(__int64 a1)
{
  ...
  if ( (_DWORD)dword_1401730C4 && g_RaidNumberProcessors )
  {
    ...
    if ( v3 )
    {
      memset_0(v3, 0, (unsigned int)dword_1401730C4);
    }
    else
    {
      Pool = RaidAllocatePool(72LL, (unsigned int)dword_1401730C4, 1700028754LL, *(_QWORD *)(a1 + 8));
      *(_QWORD *)(a1 + 2384) = Pool;
      if ( !Pool )
        goto LABEL_9;
    }
    ...
    {
      v6 = RaidAllocatePool(72LL, (unsigned int)dword_1401730BC, 1700028754LL, *(_QWORD *)(a1 + 8));
      *(_QWORD *)(a1 + 2408) = v6;
      if ( !v6 )
      {
LABEL_9:
