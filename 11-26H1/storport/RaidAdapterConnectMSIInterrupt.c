/*
 * XREFs of RaidAdapterConnectMSIInterrupt @ 0x14018404C
 * Callers:
...
__int64 __fastcall RaidAdapterConnectMSIInterrupt(__int64 a1, unsigned __int8 a2)
{
  ...
  {
    KeInitializeSpinLock((PKSPIN_LOCK)(a1 + 4408));
    Parameters.FullySpecified.SpinLock = (PKSPIN_LOCK)(a1 + 4408);
  }
  ...
  *(_BYTE *)(a1 + 4433) = 1;
  v12 = (__int64 *)(a1 + 4416);
  v13 = *InterruptObject;
  *(_QWORD *)(a1 + 4416) = *InterruptObject;
  if ( !v8 )
  {
LABEL_9:
