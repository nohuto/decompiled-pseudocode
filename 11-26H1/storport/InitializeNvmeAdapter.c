/*
 * XREFs of InitializeNvmeAdapter @ 0x140196AC0
 * Callers:
        ...
        int a8)
{
  ...
  *(_DWORD *)(a1 + 184) = v21;
  ...
  if ( (int)result >= 0 )
  {
    PortGetDriverParameters(*(_QWORD *)(a1 + 16) + 40LL, a7, a1 + 912);
    RaidDriverGetName(a3, (__int64)&v24);
    *(_QWORD *)(a1 + 1032) = *((_QWORD *)&v24 + 1);
    RaidAllocateDeviceProperty(DeviceObject, v22, (_QWORD *)(a1 + 1040));
    NvmeAdapterRetrieveRegistrySettings(a1);
    if ( a8 == 20 )
      *v13 |= 1uLL;
    v23 = *(_QWORD *)(a1 + 16) + 40LL;
    *(_DWORD *)(a1 + 1108) = 0;
    PortGetIoTimeoutValue(v23);
    if ( !*(_DWORD *)(a1 + 1108) )
      *(_DWORD *)(a1 + 1108) = (*v18 & 1) != 0 ? 300 : 10;
    KeInitializeDpc(
