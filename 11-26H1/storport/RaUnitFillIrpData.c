/*
 * XREFs of RaUnitFillIrpData @ 0x140021950
 * Callers:
...
__int64 __fastcall RaUnitFillIrpData(__int64 a1, __int64 *a2)
{
  ...
  *((_DWORD *)a2 + 12) = v6 & 0x7FFFFFFF;
  ...
  if ( KeGetProcessorNumberFromIndex(v6 & 0x7FFFFFFF, &ProcNumber) >= 0 )
  {
    ...
    if ( *v11 )
    {
      ...
      {
        v14 = *v13;
        if ( ((_DWORD)v12[31] & 1) != 0 )
        {
          if ( v14 == 1314275652 )
            NvmeGetMessageNumberFromProcessorNumber(v13, &ProcNumber, (char *)a2 + 52);
        }
        else if ( v14 == 1094997074 )
        {
          if ( (v13[1181] & 2) == 0
            || ProcNumber.Group >= *((_WORD *)v13 + 2363)
            || (v15 = *(unsigned __int8 *)(ProcNumber.Number + (ProcNumber.Group << 6) + *((_QWORD *)v13 + 593)),
                *((_DWORD *)a2 + 13) = v15,
                v15 == 255) )
          {
            *((_DWORD *)a2 + 13) = 0;
  ...
  if ( *v2 == 3 )
  {
    ...
    *((_DWORD *)a2 + 11) = v18;
LABEL_20:
    a2[1] = *((_QWORD *)v2 + 3) + *(unsigned int *)(a1 + 56);
    *((_DWORD *)a2 + 4) = *((_DWORD *)v2 + 2) - *(_DWORD *)(a1 + 56);
    goto LABEL_21;
  }
  if ( *v2 == 4 )
  {
...
LABEL_21:
  if ( (*(_DWORD *)(a1 + 16) & 8) != 0 )
  {
    v19 = *(_QWORD *)(a1 + 24);
    if ( v19 )
      v2 = *(unsigned __int8 **)(v19 + 184);
  }
  result = *v2;
  if ( (_BYTE)result == 4 || (_BYTE)result == 3 )
  {
    result = *((unsigned int *)v2 + 4);
    *((_DWORD *)a2 + 5) = result;
    if ( (_DWORD)result )
    {
      result = (unsigned int)result & 0xFFFF0000;
      if ( (_DWORD)result == 1448280064 )
      {
        *((_DWORD *)a2 + 14) |= 0x40u;
      }
      else if ( *v2 == 4 )
