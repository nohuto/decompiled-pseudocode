/*
 * XREFs of RaidAdapterQuerySystemPowerCompletionRoutine @ 0x14000F980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterQuerySystemPowerCompletionRoutine(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 36LL, &WPP_1c5ab61e0b3334897529fa80e10aa52d_Traceguids, v5, a2, v6);
  }
