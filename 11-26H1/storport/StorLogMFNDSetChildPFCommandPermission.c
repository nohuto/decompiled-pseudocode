/*
 * XREFs of StorLogMFNDSetChildPFCommandPermission @ 0x1400CC998
 * Callers:
...
__int16 __fastcall StorLogMFNDSetChildPFCommandPermission(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v8; // xmm0
  __int64 v9; // rcx
  int v10; // eax
