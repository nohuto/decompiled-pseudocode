/*
 * XREFs of ACPIEcInitOpRegionHandler @ 0x14005FC00
 * Callers:
 *     ACPITableLoad @ 0x140049220 (ACPITableLoad.c)
 * Callees:
 *     AMLIGetNameSpaceObject @ 0x14001B500 (AMLIGetNameSpaceObject.c)
 *     RtlStringCchLengthA @ 0x140030AB0 (RtlStringCchLengthA.c)
 *     ACPIMapNamedTable @ 0x14003D2D0 (ACPIMapNamedTable.c)
 *     ACPIEcCreateEcData @ 0x14005FB08 (ACPIEcCreateEcData.c)
