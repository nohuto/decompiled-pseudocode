/*
 * XREFs of ACPIThermalQueryCoolingInterfaces @ 0x14006A3C8
 * Callers:
 ...
 * Callees:
 *     ACPIGetRootDeviceObject @ 0x140055208 (ACPIGetRootDeviceObject.c)
 */
        ...
        *(_QWORD *)(v7 + 48) = WorkItem;
        if ( WorkItem )
        {
          ...
          *(_BYTE *)(v7 + 41) = PoGetThermalRequestSupport(v16, 1LL);
          ...
          {
            *(_QWORD *)(a1 + 656) = v7;
            v11 = (__int64 *)qword_14008F878;
            if ( *(__int64 **)qword_14008F878 != &AcpiThermalClientList )
              __fastfail(3u);
