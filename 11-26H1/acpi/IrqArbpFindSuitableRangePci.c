/*
 * XREFs of IrqArbpFindSuitableRangePci @ 0x1400D2AC8
 * Callers:
...
LABEL_21:
    ...
    v17 = *(_QWORD *)(v15 + 40);
    v18 = a2[4];
    LOBYTE(v20) = *(_BYTE *)(*(_QWORD *)(v14 + 40) + 4LL) & 1;
    if ( (int)((__int64 (__fastcall *)(_QWORD, __int64, _QWORD, __int64, unsigned int, _DWORD, int, int))ProcessorFindIdtEntries)(
                *(_QWORD *)(v18 + 32),
                v17,
                a2[9],
                1LL,
