/*
 * XREFs of AcpiDiagTraceThermalZoneRundown @ 0x14002BCA4
 * Callers:
 *     AcpiDiagTraceControlCallback @ 0x140056170 (AcpiDiagTraceControlCallback.c)
 * Callees:
 *     AcpiDiagEnumCoolingDevices @ 0x14002C0DC (AcpiDiagEnumCoolingDevices.c)
