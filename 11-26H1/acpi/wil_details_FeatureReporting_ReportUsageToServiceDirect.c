/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x140064320
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x140064298 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x140064114 (wil_details_FeatureReporting_RecordUsageInCache.c)
