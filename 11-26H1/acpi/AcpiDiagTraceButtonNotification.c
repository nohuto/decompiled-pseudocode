/*
 * XREFs of AcpiDiagTraceButtonNotification @ 0x14002F7E4
 * Callers:
...
void __fastcall AcpiDiagTraceButtonNotification(__int64 a1, int a2, int a3)
{
  ...
  if ( *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters
    && EtwEventEnabled(*(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters, &ACPI_ETW_EVENT_BUTTON_NOTIFICATION)
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    EtwWrite(
      *(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters,
      &ACPI_ETW_EVENT_BUTTON_NOTIFICATION,
      0LL,
      4u,
      &UserData);
  }
