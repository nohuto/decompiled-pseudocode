/*
 * XREFs of AcpiDiagTraceTemperatureChange @ 0x14002A984
 * Callers:
...
void __fastcall AcpiDiagTraceTemperatureChange(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters
    && EtwEventEnabled(*(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters, &ACPI_ETW_EVENT_TEMPERATURE_CHANGE)
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    EtwWrite(
      *(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters,
      &ACPI_ETW_EVENT_TEMPERATURE_CHANGE,
      0LL,
      3u,
      &UserData);
  }
