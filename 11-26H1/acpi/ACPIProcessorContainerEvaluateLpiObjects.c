/*
 * XREFs of ACPIProcessorContainerEvaluateLpiObjects @ 0x1400678C0
 * Callers:
 *     ACPIProcessorContainerEvaluateLpiObjects @ 0x1400678C0 (ACPIProcessorContainerEvaluateLpiObjects.c)
