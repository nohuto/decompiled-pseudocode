/*
 * XREFs of ACPIBusIrpRemoveDevice @ 0x14005ADC0
 * Callers:
...
__int64 __fastcall ACPIBusIrpRemoveDevice(ULONG_PTR a1, IRP *a2)
{
  ...
  if ( (((*(_DWORD *)(v6 + 8) & 0x180) == 256LL) & !_bittest(&AcpiOverrideAttributes, 0x13u)) != 0
    && !*(_DWORD *)(v6 + 368) )
  {
    *(_DWORD *)(v6 + 368) = 5;
  ...
  if ( (v9 & 0x100) != 0 )
  {
    ...
    if ( (v9 & 0x80u) == 0LL )
    {
      v13 = *(_QWORD *)(v6 + 1008) & 0x8000LL;
      v14 = (*(_QWORD *)(v6 + 1008) & 0x8000) != 0;
