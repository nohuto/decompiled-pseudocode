/*
 * XREFs of LinkNodeGetPossibleResources @ 0x1400BC2C8
 * Callers:
...
__int64 __fastcall LinkNodeGetPossibleResources(__int64 a1, _QWORD *a2, _BYTE *a3)
{
  ...
  *a3 = 0;
  v10 = 0LL;
  P = 0LL;
  ACPIGet(v3, 1397903455, 335609864, 0LL, 0, 0LL, 0LL, (__int64)&P, 0LL);
  if ( P )
  {
    v6 = PnpBiosResourcesToNtResources(0LL, P, 0LL);
