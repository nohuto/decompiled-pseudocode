/*
 * XREFs of PciGetRootBusCapability @ 0x1400B3F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PciGetRootBusCapability(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 44) = CxlBusFeaturesSupported;
  *(_DWORD *)(a2 + 48) = CxlBusFeaturesControlRequest;
  *(_DWORD *)(a2 + 52) = *(_DWORD *)(a1 + 308);
  if ( _bittest64((const signed __int64 *)(a1 + 1008), 0x35u) )
    *(_BYTE *)(a2 + 36) = 1;
