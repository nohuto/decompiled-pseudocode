/*
 * XREFs of LoadFieldUnitDDB @ 0x14006CF10
 * Callers:
...
__int64 __fastcall LoadFieldUnitDDB(__int64 Entry, __int64 a2, __int64 a3)
{
  ...
  if ( !Object )
  {
    v8 = HeapAlloc((_QWORD *)gpheapGlobal, 1179992648, DWORD1(v20));
    v9 = (char *)v8;
    if ( !v8 )
    {
      DDB = -1073741670;
...
LABEL_15:
    ...
    *((_DWORD *)v8 + 8) = v22;
    ...
    else
    {
      if ( ghValidateTable )
      {
        v12 = ghValidateTable(v9, qword_14008EAC0);
        v13 = (const void *)v12;
        if ( v12 )
        {
          DDB = -1072431079;
