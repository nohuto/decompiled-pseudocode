/*
 * XREFs of AcpiExternalTranslateBiosToNtResources @ 0x1400AFA38
 * Callers:
        ...
        _OWORD *a5)
{
  ...
  __int64 v9; // rdi
  int v10; // ebx
  __int64 (__fastcall *v11)(_QWORD, ULONG_PTR, __int64, _QWORD, unsigned int, __int64, unsigned int *); // r12
