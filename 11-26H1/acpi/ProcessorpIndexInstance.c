/*
 * XREFs of ProcessorpIndexInstance @ 0x1400A9548
 * Callers:
 *     ProcessorAddInstance @ 0x1400BC8AC (ProcessorAddInstance.c)
 * Callees:
 *     ProcessorpIsPreferredInterruptTarget @ 0x1400BD620 (ProcessorpIsPreferredInterruptTarget.c)
 */
...
__int64 __fastcall ProcessorpIndexInstance(unsigned int a1, __int64 a2)
{
  ...
  if ( !v5 )
  {
    ...
    *(_QWORD *)(Pool2 + 16) = Pool2 + 16;
    v7 = (__int64 *)qword_14008F3F8;
    if ( *(__int64 **)qword_14008F3F8 != &ProcessorGroupListHead )
      goto LABEL_22;
    *(_QWORD *)(v5 + 8) = qword_14008F3F8;
