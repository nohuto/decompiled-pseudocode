/*
 * XREFs of AcpiDiagTraceDeviceActiveCooling @ 0x1400562B4
 * Callers:
...
void __fastcall AcpiDiagTraceDeviceActiveCooling(__int64 a1, char a2)
{
  ...
  if ( *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters
    && EtwEventEnabled(*(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters, &ACPI_ETW_EVENT_DEVICE_ACTIVE_COOLING)
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    EtwWrite(
      *(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters,
      &ACPI_ETW_EVENT_DEVICE_ACTIVE_COOLING,
      0LL,
      3u,
      &UserData);
  }
