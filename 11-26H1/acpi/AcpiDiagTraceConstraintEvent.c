/*
 * XREFs of AcpiDiagTraceConstraintEvent @ 0x14002CBF0
 * Callers:
        ...
        PEVENT_DATA_DESCRIPTOR a5)
{
  ...
  {
    if ( EtwEventEnabled(*(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters, a3) )
    {
      if ( (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 760), (__int64)&v14) >= 0 )
      {
        ...
        if ( (int)ACPIAmliBuildObjectPathnameUnicode(v8, (__int64)&DestinationString) >= 0 )
        {
          ...
          *(_QWORD *)&UserData[2].Size = 2LL;
          ...
          EtwWrite(*(REGHANDLE *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters, a3, 0LL, 5u, UserData);
        }
      }
    }
  }
