/*
 * XREFs of wil_details_GetCurrentFeatureEnabledState @ 0x140064574
 * Callers:
...
__int64 __fastcall wil_details_GetCurrentFeatureEnabledState(__int64 a1, _DWORD *a2)
{
  ...
  *a2 = 1;
  ...
  v19 = 0LL;
  v18 = 0LL;
  v6 = wil_RtlStagingConfig_QueryFeatureState(&v18, v5, v4);
  HIDWORD(v20) = 0;
  ...
  v9 = ((_DWORD)v19 != 0 ? 0x400 : 0) | (HIDWORD(v19) != 0 ? 0x800 : 0) | (v7 << 7) | v8;
  v10 = v9 | (v9 >> 6) & 1;
  LODWORD(v20) = v10;
  if ( ((v9 >> 6) & 1) != 0 )
  {
