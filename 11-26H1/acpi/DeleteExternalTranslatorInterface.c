/*
 * XREFs of DeleteExternalTranslatorInterface @ 0x1400AFCA8
 * Callers:
 *     AcpiExternalInterfaceUnload @ 0x1400AFA20 (AcpiExternalInterfaceUnload.c)
 *     NotifyExternalTranslationInterfaceChange @ 0x1400AFF30 (NotifyExternalTranslationInterfaceChange.c)
 * Callees:
 *     <none>
 */
