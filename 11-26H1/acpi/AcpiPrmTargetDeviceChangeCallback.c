/*
 * XREFs of AcpiPrmTargetDeviceChangeCallback @ 0x1400B6420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AcpiPrmTargetDeviceChangeCallback(__int64 a1)
{
  ...
  if ( !v1 )
  {
    ...
    ((void (__fastcall *)(_QWORD))qword_14008E850)(0LL);
  ...
  {
    v4 = qword_14008E830;
    v2 = AcpiAcquirePrmInterface(&stru_14008E878, 0, &unk_14008E838);
    if ( v2 >= 0 )
