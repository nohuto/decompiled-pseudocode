/*
 * XREFs of ACPIIsPhase3ListEmptyOfUnblockedItems @ 0x140018ADC
 * Callers:
...
bool ACPIIsPhase3ListEmptyOfUnblockedItems()
{
  ...
  if ( AcpiPowerCurrentPagingPathTransitions > 0 )
  {
    ...
    while ( v9 != &AcpiPowerPhase3List )
    {
      v10 = v9;
      v9 = (__int64 *)*v9;
      if ( !*((_DWORD *)v10 + 12) && (v10[7] & 0x2000000) != 0 )
        ACPIDevicePowerEnumerateAssociatedPowerNodes(v10, ACPIMarkPagingPathPowerNodeEnum, v10);
    }
  }
  ...
  if ( (__int64 *)AcpiPowerNodeList != &AcpiPowerNodeList )
  {
    ...
    if ( !v1 && v0 )
    {
      ...
      while ( v11 != &AcpiPowerPhase3List )
      {
        ...
        v11 = (__int64 *)*v11;
        if ( !*((_DWORD *)v12 + 12) )
          ACPIDevicePowerEnumerateAssociatedPowerNodes(v12, ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum, v12);
      }
    }
  }
