/*
 * XREFs of AcpiAddTriageAcpiDeviceExtension @ 0x14005EE94
 * Callers:
 *     AcpiAddTriagePowerRequestEntry @ 0x14005FA60 (AcpiAddTriagePowerRequestEntry.c)
 * Callees:
...
void __fastcall AcpiAddTriageAcpiDeviceExtension(__int64 a1)
{
  ...
  {
    ACPI_ADD_TRIAGE_DUMP_DATA((void *)a1, (PVOID)0x3F8);
    v2 = (PVOID *)(a1 + 608);
    if ( a1 != -608 )
    {
      v3 = -1LL;
