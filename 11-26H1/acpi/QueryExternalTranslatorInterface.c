/*
 * XREFs of QueryExternalTranslatorInterface @ 0x1400AFF64
 * Callers:
...
LABEL_28:
  ...
  *((_QWORD *)Pool2 + 10) = *(_QWORD *)(RootDeviceExtension + 768);
  AcpiGetDriverProxyWrappedEndpoint((_QWORD *)Pool2 + 11, (__int64)AcpiExternalInterfaceUnload);
  AcpiGetDriverProxyWrappedEndpoint((_QWORD *)Pool2 + 13, (__int64)AcpiAllocateGsivForSecondaryInterrupt);
  AcpiGetDriverProxyWrappedEndpoint((_QWORD *)Pool2 + 12, (__int64)&AcpiGetFullyQualifiedBiosName);
  AcpiGetDriverProxyWrappedEndpoint((_QWORD *)Pool2 + 14, (__int64)AcpiUpdateInterruptProperties);
  KeInitializeEvent(&Event, v6, 0);
