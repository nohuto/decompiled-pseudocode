/*
 * XREFs of RegRSAccess @ 0x140036D68
 * Callers:
...
__int64 __fastcall RegRSAccess(unsigned int a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // ebx
  const void *v5; // rbp
  char v6; // r15
  ...
  RSAccess = FindRSAccess(a1, a2, a3, a4);
  if ( !RSAccess )
  {
    ...
    if ( !RSAccess )
    {
      ...
      v12 = 169;
LABEL_17:
      PrintDebugMessage(v12, v11, 0LL, 0LL, 0LL);
      return v10;
    }
