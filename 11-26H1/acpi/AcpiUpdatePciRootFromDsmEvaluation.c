/*
 * XREFs of AcpiUpdatePciRootFromDsmEvaluation @ 0x1400B3C18
 * Callers:
 *     PciGetRootBusCapability @ 0x1400B3F30 (PciGetRootBusCapability.c)
 * Callees:
...
__int64 __fastcall AcpiUpdatePciRootFromDsmEvaluation(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 216) = 0;
  ...
  if ( !v2 || !strstr(v2, "PNP0A08") && !strstr(*(const char **)(a1 + 608), "ACPI0016") )
  {
    v3 = *(const char **)(a1 + 192);
    if ( !v3 || !strstr(v3, "PNP0A08") && !strstr(*(const char **)(a1 + 192), "ACPI0016") )
    {
