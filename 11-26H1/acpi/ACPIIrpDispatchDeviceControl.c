/*
 * XREFs of ACPIIrpDispatchDeviceControl @ 0x140021AD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIIoctlRegisterDeviceFirmwareLock @ 0x140062F70 (ACPIIoctlRegisterDeviceFirmwareLock.c)
 *     ACPIIoctlUnRegisterOpRegionHandler @ 0x140062FF4 (ACPIIoctlUnRegisterOpRegionHandler.c)
 *     ACPIIoctlUnregisterDeviceFirmwareLockHandler @ 0x14006305C (ACPIIoctlUnregisterDeviceFirmwareLockHandler.c)
...
NTSTATUS __fastcall ACPIIrpDispatchDeviceControl(ULONG_PTR BugCheckParameter3, PIRP Irp, __int64 a3, int a4)
{
  ...
  __int64 v26; // rax
  __int64 v27[2]; // [rsp+40h] [rbp-20h] BYREF
  ...
  {
    if ( (_DWORD)BugCheckParameter3 == 3325952 )
      goto LABEL_2;
    if ( (_DWORD)BugCheckParameter3 == 3325956 )
      goto LABEL_2;
    BugCheckParameter3 = (unsigned int)(BugCheckParameter3 - 3325976);
    if ( (unsigned int)BugCheckParameter3 <= 0x30 )
    {
      v23 = 0x1111100011111LL;
      if ( _bittest64(&v23, BugCheckParameter3) )
        goto LABEL_2;
    }
  ...
  if ( !RootDeviceExtension || v7 != *(_QWORD *)(RootDeviceExtension + 768) || (_DWORD)BugCheckParameter3 != 3325952 )
  {
    if ( (_DWORD)BugCheckParameter3 == 3325956 )
      goto LABEL_39;
    if ( (_DWORD)BugCheckParameter3 == 3325952 )
      goto LABEL_39;
    v25 = (unsigned int)(BugCheckParameter3 - 3325968);
    if ( (unsigned int)v25 <= 0x38 )
    {
      v26 = 0x111110001111111LL;
...
LABEL_59:
  ...
  if ( !SeSinglePrivilegeCheck(PrivilegeValue, RequestorMode) )
  {
LABEL_39:
    Status = -1073741637;
...
LABEL_3:
    ...
    switch ( LowPart )
    {
      case 0x32C01Cu:
        ...
        break;
      case 0x32C000u:
        v12 = ACPIIoctlEvalPreProcessingV1(v7, (__int64)v27, (__int64)&P, (__int64)&v30, (__int64)&PrivilegeValue);
        break;
      case 0x32C040u:
        v12 = ACPIIoctlEvalPreProcessingV2(v7, (__int64)v27, (__int64)&P, (__int64)&v30, (__int64)&PrivilegeValue);
        break;
      case 0x32C048u:
