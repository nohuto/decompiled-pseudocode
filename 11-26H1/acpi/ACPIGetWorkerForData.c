/*
 * XREFs of ACPIGetWorkerForData @ 0x14003DDE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ACPIGetWorkerForData(__int64 a1, int a2, __int64 a3, _DWORD *a4)
{
  ...
  if ( (*a4 & 0x10000000) == 0 )
  {
    ...
    v10 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink);
    v11 = *((_QWORD *)a4 + 1);
    if ( *(_DWORD **)(v11 + 8) != a4 + 2 || (v12 = (_QWORD *)*((_QWORD *)a4 + 2), (_DWORD *)*v12 != a4 + 2) )
      __fastfail(3u);
    *v12 = v11;
    *(_QWORD *)(v11 + 8) = v12;
    KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink, v10);
