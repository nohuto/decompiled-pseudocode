/*
 * XREFs of ACPIInitDeleteDeviceExtension @ 0x140061CBC
 * Callers:
 ...
 *     ACPIInternalInterruptPolarityCacheCleanup @ 0x14003C3D0 (ACPIInternalInterruptPolarityCacheCleanup.c)
...
void __fastcall ACPIInitDeleteDeviceExtension(volatile signed __int32 *Entry)
{
  ...
  {
LABEL_4:
    ACPIInitRemovePowerNodes((__int64)Entry);
...
LABEL_47:
  ...
  *((_DWORD *)Entry + 224) = *(_DWORD *)(**((_QWORD **)Entry + 95) + 40LL);
  v26 = (_QWORD *)qword_140090D08;
  if ( *(__int64 **)qword_140090D08 != &AcpiDevicesWhichMightNeedEnumerationList )
    goto LABEL_47;
  *v25 = &AcpiDevicesWhichMightNeedEnumerationList;
  *((_QWORD *)Entry + 111) = v26;
  *v26 = v25;
  qword_140090D08 = (__int64)(Entry + 220);
