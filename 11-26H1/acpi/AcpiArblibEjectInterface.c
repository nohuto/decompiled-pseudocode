/*
 * XREFs of AcpiArblibEjectInterface @ 0x1400AD42C
 * Callers:
...
__int64 __fastcall AcpiArblibEjectInterface(ULONG_PTR a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(v8 + 130) == 1 )
  {
    *(_DWORD *)v6 = 48;
    *(_QWORD *)(v6 + 8) = v8 + 136;
    AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v6 + 16), (__int64)AcpiArblibReferenceArbiter);
    AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v9 + 24), (__int64)AcpiArblibDereferenceArbiter);
    AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v10 + 32), (__int64)ArbArbiterHandler);
