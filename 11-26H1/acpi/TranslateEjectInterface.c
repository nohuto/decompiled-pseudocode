/*
 * XREFs of TranslateEjectInterface @ 0x1400BB8B8
 * Callers:
            ...
            if ( Pool2 )
            {
              ...
              *(_QWORD *)(Pool2 + 24) = v16;
              ...
              else
              {
                *(_DWORD *)v5 = 65584;
                *(_QWORD *)(v5 + 8) = v11;
                AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v5 + 16), (__int64)AcpiNullReference);
                AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v5 + 24), v12);
                AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v5 + 32), (__int64)TranslateBridgeResources);
                AcpiGetDriverProxyWrappedEndpoint((_QWORD *)(v5 + 40), (__int64)TranslateBridgeRequirements);
                v6 = 0;
              }
            }
            else
