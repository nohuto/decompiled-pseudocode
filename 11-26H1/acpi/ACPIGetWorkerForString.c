/*
 * XREFs of ACPIGetWorkerForString @ 0x14003A900
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ACPIGetWorkerForString(__int64 a1, unsigned int a2, __int64 a3, char *a4)
{
  ...
  *((_DWORD *)a4 + 18) = v11;
  ...
  if ( (*(_DWORD *)a4 & 0x10000000) == 0 )
  {
    ...
    v13 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink);
    v14 = (char **)*((_QWORD *)a4 + 1);
    if ( v14[1] != a4 + 8 || (v15 = (void **)*((_QWORD *)a4 + 2), *v15 != a4 + 8) )
      __fastfail(3u);
    *v15 = v14;
    v14[1] = (char *)v15;
    KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink, v13);
