/*
 * XREFs of wil_details_IsEnabledFallback @ 0x1400646CC
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x140064518 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
