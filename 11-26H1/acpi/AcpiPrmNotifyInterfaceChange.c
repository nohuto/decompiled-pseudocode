/*
 * XREFs of AcpiPrmNotifyInterfaceChange @ 0x1400B6330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AcpiPrmNotifyInterfaceChange(char *NotificationStructure, PVOID Context)
{
  ...
  if ( v2 )
  {
    ...
    if ( !v4 )
    {
      ...
      {
        ExFreePoolWithTag(stru_14008E878.Buffer, 0x46706341u);
  ...
  {
    v3 = AcpiAcquirePrmInterface(*((UNICODE_STRING **)NotificationStructure + 5), 1, &unk_14008E838);
    if ( v3 >= 0 )
    {
