/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1400B4E54
 * Callers:
  ...
  if ( Status >= 0 )
  {
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *(_QWORD *)&OutputBuffer[4] = *(_QWORD *)(RootDeviceExtension + 768);
      AcpiGetDriverProxyWrappedEndpoint((_QWORD *)&OutputBuffer[4] + 1, (__int64)AcpiReflectNativeObject);
      AcpiGetDriverProxyWrappedEndpoint(&OutputBuffer[5], (__int64)AcpiNativeNotifyEventHandler);
      AcpiGetDriverProxyWrappedEndpoint((_QWORD *)&OutputBuffer[5] + 1, (__int64)AcpiTranslatePepDeviceControlResources);
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_14008FA90 = OutputBuffer[1];
        unk_14008FAA0 = OutputBuffer[2];
        xmmword_14008FAB0 = OutputBuffer[3];
        xmmword_14008FAC0 = OutputBuffer[4];
        xmmword_14008FAD0 = OutputBuffer[5];
