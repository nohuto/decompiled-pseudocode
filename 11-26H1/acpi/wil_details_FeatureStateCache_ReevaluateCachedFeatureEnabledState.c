/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x140064410
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x140064574 (wil_details_GetCurrentFeatureEnabledState.c)
