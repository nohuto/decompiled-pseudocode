/*
 * XREFs of sub_140093C78 @ 0x140093C78
 * Callers:
...
__int64 __fastcall sub_140093C78(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rsi
  _QWORD *v7; // r12
  _QWORD *v8; // rax
  ...
  if ( a2 != a3 )
  {
    ...
    v28 = v8;
    v24 = v8;
    v9 = sub_140026BBC((__int64)a1, a2 + 16, 8uLL);
    v11 = 2 * (a1[6] & v9);
    ...
    *(_QWORD *)(v6 + 8 * v11 + 8) = v16;
    ...
    {
      v17 = sub_140026BBC(v15, i + 16, 8uLL);
      v18 = 2 * (a1[6] & v17);
