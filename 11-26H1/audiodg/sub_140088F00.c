/*
 * XREFs of sub_140088F00 @ 0x140088F00
 * Callers:
...
__int64 __fastcall sub_140088F00(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // ebx
  int v7; // edx
  _QWORD *v8; // rsi
...
LABEL_18:
  ...
  *(_DWORD *)(a4 + 16) = 68;
  ...
  if ( *v11 > 5u )
  {
    v25 = *(_DWORD *)(a4 + 24);
    v23[0] = 3;
    sub_140002614((__int64)v11, (__int64)&unk_1400D2B49, v9, v10, (__int64)v23, (__int64)&v25);
  }
  if ( (int)sub_1400B6010(*v8) < 0 )
  {
    ...
    if ( *v12 > 2u )
    {
      ...
      sub_140002614((__int64)v12, (__int64)&unk_1400D2A5E, v15, v16, (__int64)v23, (__int64)&v25);
    }
