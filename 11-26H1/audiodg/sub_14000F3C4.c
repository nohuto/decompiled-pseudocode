/*
 * XREFs of sub_14000F3C4 @ 0x14000F3C4
 * Callers:
...
__int64 __fastcall sub_14000F3C4(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return sub_14000FEC8(a1, &unk_1400C5350, a3, 6LL, v8);
}
