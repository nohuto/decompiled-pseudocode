/*
 * XREFs of sub_140093ADC @ 0x140093ADC
 * Callers:
...
__int64 __fastcall sub_140093ADC(_QWORD *a1, unsigned __int64 a2)
{
  ...
  {
    v9 = (_QWORD *)*v9;
    v10 = sub_140026BBC((__int64)v7, (__int64)(v8 + 2), 8uLL);
    v13 = a1[3];
    v14 = 2 * (a1[6] & v10);
