/*
 * XREFs of sub_1400A9A10 @ 0x1400A9A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1400A9A10(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, _QWORD *a5)
{
  ...
  if ( (v10 & 0xFFFFFF81) == 1 )
  {
    sub_1400A95C8(*(_QWORD *)(a1 + 728), (__int64)v15);
    v12 = v15[0];
    if ( v15[0] )
    {
      ...
      *(_QWORD *)(a2 + 32) = *(_QWORD *)(v12 + 72);
      if ( *(_BYTE *)(a1 + 1296) && (unsigned int)sub_14009D620((__int64 *)(a2 + 24)) )
        *(_BYTE *)(a1 + 1296) = 0;
      *(_OWORD *)a3 = *(_OWORD *)v12;
      *(_OWORD *)(a3 + 16) = *(_OWORD *)(v12 + 16);
      *(_QWORD *)(a3 + 32) = *(_QWORD *)(v12 + 32);
      if ( *(_BYTE *)(a1 + 1296) && (unsigned int)sub_14009D620((__int64 *)(a3 + 24)) )
        *(_BYTE *)(a1 + 1296) = 0;
      if ( (v11 & 0x10) != 0 )
      {
        *a4 = 0LL;
