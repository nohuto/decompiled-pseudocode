/*
 * XREFs of sub_14004B130 @ 0x14004B130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14004B130(__int64 a1, __int64 a2, int *a3)
{
  unsigned int v3; // ebx
  __int64 v6; // rax
  __m128i *v7; // rcx
  ...
  if ( a2 && a3 )
  {
    *a3 = 0;
    ...
    if ( v7 )
    {
      ...
      if ( v17 != v13
        || v7->m128i_i16[0] == -2
        && (*(_QWORD *)(v8 + 24) != v7[1].m128i_i64[1] || *(_QWORD *)(v8 + 32) != v7[2].m128i_i64[0]) )
      {
        return 1;
      }
      if ( v10 != v12 )
      ...
      *a3 = v20;
      v22 = *(_WORD **)(a1 + 16);
      if ( *v22 != 1 )
        v21 = (unsigned __int16)v22[8] + 18;
      if ( *(_WORD *)v8 != 1 )
        v18 = *(unsigned __int16 *)(v8 + 16) + 18;
      if ( v21 != v18 )
        return ((unsigned __int8)~*(_BYTE *)a3 >> 3) & 1;
      if ( memcmp(v22 + 9, (const void *)(v8 + 18), *(unsigned __int16 *)(v8 + 16)) )
        return 1;
      *a3 = v20 | 8;
    }
    return ((unsigned __int8)~*(_BYTE *)a3 >> 3) & 1;
