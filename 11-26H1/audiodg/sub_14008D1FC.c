/*
 * XREFs of sub_14008D1FC @ 0x14008D1FC
 * Callers:
...
__int64 __fastcall sub_14008D1FC(_QWORD *a1, __int64 a2, __int64 a3, int a4, _DWORD *a5)
{
  unsigned int v7; // ebx
  int v8; // edx
  _QWORD *v9; // rsi
...
LABEL_19:
  ...
  *a5 = 3;
  ...
  if ( *v13 > 5u )
  {
    v27 = v12[6];
    v25[0] = 3;
    sub_140002614((__int64)v13, (__int64)&unk_1400D30FA, v10, v11, (__int64)v25, (__int64)&v27);
  }
  if ( (int)sub_1400B6010(*v9) < 0 )
  {
    ...
    if ( *v14 > 2u )
    {
      ...
      sub_140002614((__int64)v14, (__int64)&unk_1400D30C3, v17, v18, (__int64)v25, (__int64)&v27);
    }
  ...
  if ( *v12 != 3 || v12[6] != 4 || *((_WORD *)v12 + 24) > 0x6Eu )
  {
    v7 = -2147024809;
    v8 = 70;
    goto LABEL_19;
