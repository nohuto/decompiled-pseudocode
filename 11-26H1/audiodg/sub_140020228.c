/*
 * XREFs of sub_140020228 @ 0x140020228
 * Callers:
 *     sub_14001FFB0 @ 0x14001FFB0 (sub_14001FFB0.c)
...
__int64 __fastcall sub_140020228(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  unsigned int v6; // edi
  _QWORD *i; // rbx
  _DWORD *v8; // rcx
