/*
 * XREFs of sub_14006CE88 @ 0x14006CE88
 * Callers:
...
__int64 __fastcall sub_14006CE88(int a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8, char a9)
{
  ...
  v22 = 4LL;
  v24 = 4LL;
  return sub_140014E60(a1, (unsigned int)&unk_1400C7E48, a3, 8, (__int64)v10);
}
