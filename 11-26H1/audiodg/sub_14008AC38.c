/*
 * XREFs of sub_14008AC38 @ 0x14008AC38
 * Callers:
 *     sub_14008C100 @ 0x14008C100 (sub_14008C100.c)
 * Callees:
...
__int64 __fastcall sub_14008AC38(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v6; // rcx
  _DWORD *v7; // rsi
  ...
  *(_DWORD *)(a2 + 16) = 36;
  ...
  {
    v20 = 5;
    sub_14000253C((__int64)v6, (__int64)&unk_1400D2F17, a3, a4, (__int64)&v20);
  }
  if ( (int)sub_1400B6010(a1[4]) < 0 )
  {
    ...
    if ( *v7 > 2u )
    {
      ...
      sub_140002614((__int64)v7, (__int64)&unk_1400D2E70, v10, v11, (__int64)&v21, (__int64)&v20);
    }
