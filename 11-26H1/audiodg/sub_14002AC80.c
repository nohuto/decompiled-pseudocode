/*
 * XREFs of sub_14002AC80 @ 0x14002AC80
 * Callers:
...
__int64 __fastcall sub_14002AC80(__int64 a1, __int64 a2, __int64 a3)
{
  int v5; // ebx
  ...
  if ( (int)sub_1400B6010(a3) >= 0 )
  {
    ...
    if ( v5 < 0 || (v5 = sub_1400B6010(0LL), v5 < 0) || (v5 = sub_1400B6010(a3), v5 < 0) )
    {
      ...
      {
        sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 48LL, &unk_1400C9A58);
      }
      sub_14005A470("CPipeInstance::InitializeLimiterInterface", 3870LL, (unsigned int)v5);
    }
  }
  else
  {
