/*
 * XREFs of sub_140040834 @ 0x140040834
 * Callers:
...
ULONG __fastcall sub_140040834(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  v14 = &a6;
  v15 = 4LL;
  return sub_14000FEC8(a1, &stru_1400C73A8, a3, 5u, &v7);
}
