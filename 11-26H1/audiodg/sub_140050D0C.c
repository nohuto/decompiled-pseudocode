/*
 * XREFs of sub_140050D0C @ 0x140050D0C
 * Callers:
...
__int64 __fastcall sub_140050D0C(__int64 a1)
{
  __int64 *v1; // rdi
  __int64 *v3; // rax
  __int64 *v4; // rax
  ...
  v13[13] = v13;
  v13[1] = v5;
  v7 = sub_14005069C(v5, (__int64)v12, v6, &v10);
  v8 = 0LL;
  if ( v7 >= 0 )
    v8 = v10;
  v10 = v8;
