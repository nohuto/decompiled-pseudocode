/*
 * XREFs of sub_140055560 @ 0x140055560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140055560(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rcx
  unsigned int v4; // ebx
  ...
  v2 = sub_140006470(a1);
  sub_140006980(&PerformanceCount, (LARGE_INTEGER)v2, "SrvSystemEffect_GetLatency", a1 + 132);
  v3 = *(_QWORD *)(a1 + 88);
  if ( v3 )
    v4 = sub_1400B6010(v3);
  else
