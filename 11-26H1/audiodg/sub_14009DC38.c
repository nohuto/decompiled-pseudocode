...
_QWORD *__fastcall sub_14009DC38(__int64 a1, _QWORD *a2)
{
  char v3; // al
  int v4; // eax
  int v5; // ebp
  ...
  *a2 = 0LL;
  v3 = unk_1400E97F8;
  *(_DWORD *)a2 = unk_1400E97F8;
  if ( (v3 & 6) != 6 )
  {
    v4 = sub_1400569C4();
    LODWORD(v14) = 0;
    v5 = v4;
    sub_14009E30C(v6, &v15, &v14);
    v7 = *(_DWORD *)a2;
    v8 = (__int16)v15;
    do
    {
      ...
      *(_DWORD *)a2 = v7;
      ...
      v7 = _InterlockedCompareExchange((volatile signed __int32 *)&unk_1400E97F8, v11, v7);
    }
    while ( v10 != v7 );
    if ( (v10 & 4) == 0 && dword_1400E7BC8 )
    {
      ...
      if ( !v5
        || v5 != dword_1400E7BE4
        || (v13[0] = 3LL, v13[1] = &unk_1400E97F8, !sub_140058B20(qword_1400E7C08, (__int64)v13, 0x10uLL)) )
      {
        _InterlockedAnd((volatile signed __int32 *)&unk_1400E97F8, 0xFFFFFFFB);
      }
      sub_14003A998(&v15);
    }
    if ( (*(_DWORD *)a2 & 2) == 0 )
