/*
 * XREFs of sub_1400A2CB8 @ 0x1400A2CB8
 * Callers:
...
ULONG __fastcall sub_1400A2CB8(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v10 = 4LL;
  v12 = 8LL;
  return sub_14000FEC8(a1, &stru_1400C7F88, a3, 4u, &v6);
}
