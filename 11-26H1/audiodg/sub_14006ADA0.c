/*
 * XREFs of sub_14006ADA0 @ 0x14006ADA0
 * Callers:
...
__int64 __fastcall sub_14006ADA0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  bool v6; // zf
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(v4 + 64) = 0LL;
    ...
    {
      sub_14000C2A8((int)retaddr, 931, (int)"avcore\\audiocore\\server\\audiodg\\exe\\processnode.cpp", v7);
      sub_1400B6010(v5);
      return v8;
    }
  }
  ...
  {
    sub_14000C2A8((int)retaddr, 927, (int)"avcore\\audiocore\\server\\audiodg\\exe\\processnode.cpp", -2147024882);
    return 2147942414LL;
  }
  return result;
}
