/*
 * XREFs of sub_14003B4D0 @ 0x14003B4D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14003B4D0(__int64 a1)
{
  int v2; // ebx
  ...
  if ( v2 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 14LL, &unk_1400CA7E8);
    }
    sub_14005A470("CSystemAudioDeviceOffloadGraph::GetMute", 299LL, (unsigned int)v2);
  }
  EtwEventActivityIdControl(4LL, &v4);
