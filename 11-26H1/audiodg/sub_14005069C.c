/*
 * XREFs of sub_14005069C @ 0x14005069C
 * Callers:
...
__int64 __fastcall sub_14005069C(__int64 a1, __int64 a2, int a3, _QWORD *a4)
{
  _QWORD *v6; // rax
  _QWORD *v7; // rdi
  __int64 v8; // r8
  ...
  *v6 = off_1400BB7D8;
  ...
  if ( v13 != -1 )
    goto LABEL_11;
  v18 = 0;
  v9 = NtQueryWnfStateData(&qword_1400C7DC0, 0LL, 0LL, &v13, 0LL, &v18);
  v10 = v9 | 0x10000000;
...
LABEL_11:
    ...
    v15 = 0LL;
    v16 = 1;
    v11 = RtlSubscribeWnfStateChangeNotification(&v15, 0x2821B2CA3BC5075LL, v8, sub_140050610, v7, 0LL, 0, 0);
    sub_14004CE60((__int64)&v14);
    if ( v11 >= 0 )
    {
      *a4 = v7;
      return 0LL;
    }
    v10 = sub_14004EF04((int)retaddr, 967, (int)"onecore\\internal\\sdk\\inc\\wil\\resource.h", (unsigned int)v11);
    goto LABEL_9;
  }
