...
__int64 __fastcall sub_140091A48(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v6; // rcx
  _DWORD *v7; // rsi
  ...
  *(_DWORD *)(a2 + 16) = 124;
  ...
  {
    v20 = 15;
    sub_14000253C((__int64)v6, (__int64)&unk_1400D3A01, a3, a4, (__int64)&v20);
  }
  if ( (int)sub_1400B6010(a1[4]) < 0 )
  {
    ...
    if ( *v7 > 2u )
    {
      ...
      sub_140002614((__int64)v7, (__int64)&unk_1400D39CA, v10, v11, (__int64)&v21, (__int64)&v20);
    }
  ...
  if ( *(_DWORD *)a2 == 15 && *(_WORD *)(a2 + 68) <= 0x36u )
  {
    v16 = *(_DWORD *)(a2 + 4);
    if ( v16 >= 0 )
      return 0LL;
  ...
  sub_14000C2A8((int)retaddr, v17, (int)"avcore\\audiocore\\server\\audiodg\\dspoffload\\client\\DspObjectBase.h", v16);
