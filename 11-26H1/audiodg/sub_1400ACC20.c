/*
 * XREFs of sub_1400ACC20 @ 0x1400ACC20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1400ACC20(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  v6 = (struct _RTL_CRITICAL_SECTION *)(a1 - 1352);
  EnterCriticalSection((LPCRITICAL_SECTION)(a1 - 1352));
  v47 = v6;
  sub_1400AC554(
    "CSpatialCrossProcessServerEndpoint<struct SpatialStaticControlData_V1,struct SpatialVolatileControlData_V0,struct Sp"
    "atialControlData_V1>::Initialize",
    39,
    v7,
    v8);
  v45 = 0LL;
...
LABEL_45:
  ...
  *(_QWORD *)(a1 - 1280) = v15;
  ...
  if ( !*(_QWORD *)(a2 + 96) )
  {
    ...
    v49 = 0LL;
    v50 = 1;
    v9 = sub_1400A29A8((a1 + 8) & -(__int64)(a1 != 1384), *(_DWORD *)(a2 + 88), &v49, &v52);
    ...
    if ( v31 >= 0 )
    {
      ...
      if ( v36 >= 0 )
      {
        ...
        if ( v41 )
        {
          ...
          *(_QWORD *)(a1 + 32) = v42;
          _InterlockedOr((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(a1 - 16) + 1344LL) + 64LL), 0x20u);
        }
