/*
 * XREFs of sub_14009BE40 @ 0x14009BE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14009BE40(__int64 a1, __int64 a2)
{
  __int64 *v2; // rsi
  __int64 v3; // r14
  __int64 v5; // rdx
...
LABEL_188:
    ...
    else
    {
      ...
      if ( v118 >= 5 )
      {
        ...
        v123 = *(_DWORD *)(v122 + v120) != 1;
        if ( v121[44] || v172 != 1 || HIDWORD(v14) != 2 )
          v123 |= 2u;
        v124 = v123 | 4;
        if ( *(_DWORD *)(v122 + v120 + 8) == 1 )
          v124 = v123;
        v125 = v124 | 8;
        if ( (*(_DWORD *)(v122 + v120 + 52) & 0xFFFFFFFC) == 0 )
          v125 = v124;
        if ( *(float *)(v122 + v120 + 48) != *(float *)&v14 )
          v125 |= 0x10u;
        v126 = *(unsigned int *)(v122 + v120 + 56);
        v127 = v162;
        v128 = v125 | 0x20;
        if ( (unsigned int)v126 < v121[28] )
          v128 = v125;
        v129 = v121[26] * *(_DWORD *)(v122 + v120 + 56);
        v110 = v128 | 0x40;
        if ( *(_DWORD *)(v122 + v120 + 4) + v129 == v162 )
          v110 = v128;
        if ( v126 + *(_QWORD *)(v122 + v120 + 16) != v15.m128i_i64[0] || v126 + *(_QWORD *)(v122 + v120 + 24) != v117 )
          v110 |= 0x80u;
        if ( !v110 )
        {
          v115 = v109;
