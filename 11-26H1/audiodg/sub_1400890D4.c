/*
 * XREFs of sub_1400890D4 @ 0x1400890D4
 * Callers:
...
__int64 __fastcall sub_1400890D4(_QWORD *a1, __int64 a2, __int64 a3, int a4, _DWORD *a5)
{
  unsigned int v7; // ebx
  int v8; // edx
  _QWORD *v9; // rsi
...
LABEL_18:
  ...
  *a5 = 3;
  ...
  if ( *v13 > 5u )
  {
    v27 = v12[6];
    v25[0] = 3;
    sub_140002614((__int64)v13, (__int64)&unk_1400D2B04, v10, v11, (__int64)v25, (__int64)&v27);
  }
  if ( (int)sub_1400B6010(*v9) < 0 )
  {
    ...
    if ( *v14 > 2u )
    {
      ...
      sub_140002614((__int64)v14, (__int64)&unk_1400D2B8D, v17, v18, (__int64)v25, (__int64)&v27);
    }
