/*
 * XREFs of sub_14009441C @ 0x14009441C
 * Callers:
 *     sub_1400947D0 @ 0x1400947D0 (sub_1400947D0.c)
 * Callees:
...
__int64 __fastcall sub_14009441C(
        _QWORD *a1,
        _QWORD *a2,
        _QWORD *a3,
        _DWORD *a4,
        ...
        __int64 *a11)
{
  ...
  *a1 = 0LL;
  ...
  if ( v14 )
  {
    ...
    v18 = 0LL;
    v15 = sub_140094E54(v16, *a2, *a3, *a4, *a5, *a6, *a7, *a8, *a9, *a10, *a11);
    if ( v15 >= 0 )
    {
