/*
 * XREFs of sub_140055610 @ 0x140055610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140055610(__int64 a1, __int64 a2, LPVOID *a3)
{
  __int64 v6; // rax
  int v7; // edx
  unsigned int v8; // ebx
  ...
  v6 = sub_140006470(a1);
  sub_140006980(&PerformanceCount, (LARGE_INTEGER)v6, "SrvSystemEffect_GetPreferredInputFormat", a1 + 140);
  if ( a3 )
  {
    *a3 = 0LL;
    if ( !a2 )
    ...
    if ( v10 < 0 )
    {
      sub_14000C2A8((int)retaddr, 546, (int)"avcore\\audiocore\\server\\audiodg\\exe\\apowrappersrv.cpp", v10);
LABEL_8:
      sub_140003238(&v16);
      goto LABEL_21;
    }
    ...
    if ( v11 )
    {
      ...
      if ( v18 )
      {
        ...
        if ( v12 < 0 )
        {
          sub_14000C2A8((int)retaddr, 554, (int)"avcore\\audiocore\\server\\audiodg\\exe\\apowrappersrv.cpp", v12);
          sub_140003238(&v18);
LABEL_13:
          sub_140003238(&v17);
          goto LABEL_8;
      ...
      if ( v17 )
      {
        ...
        if ( v14 < 0 )
        {
          sub_14000C2A8((int)retaddr, 564, (int)"avcore\\audiocore\\server\\audiodg\\exe\\apowrappersrv.cpp", v14);
          CoTaskMemFree(pv);
          goto LABEL_13;
        }
        *a3 = pv;
