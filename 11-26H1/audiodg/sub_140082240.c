/*
 * XREFs of sub_140082240 @ 0x140082240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140082240(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v8; // ebx
  int v9; // edx
  int v10; // eax
...
LABEL_16:
        v16 = 0LL;
        v11 = sub_140082034(a1, a3, a4, (__int64 *)(**(_QWORD **)(a1 + 776) + 48LL), &v16);
        v8 = v11;
        if ( v11 >= 0 )
        {
          v13 = v19;
    ...
    {
      sub_14000C2A8((int)retaddr, 2193, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v10);
    }
LABEL_19:
