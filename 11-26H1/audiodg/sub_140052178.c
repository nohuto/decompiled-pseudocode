/*
 * XREFs of sub_140052178 @ 0x140052178
 * Callers:
...
__int64 __fastcall sub_140052178(float *a1, __int64 a2, __int64 *a3, __int64 *a4)
{
  __int64 v8; // r15
  _QWORD *v9; // r14
  __int64 v10; // rcx
  ...
  *(_QWORD *)(v8 + 48) = *a4;
  ...
  else
  {
    ...
    if ( (float)(v15 / v17) > *a1 )
    {
      ...
      v22[0] = *(_OWORD *)sub_140046CB0(a1, v22, v9, v11);
    }
