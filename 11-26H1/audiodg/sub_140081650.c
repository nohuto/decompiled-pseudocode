/*
 * XREFs of sub_140081650 @ 0x140081650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140081650(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // rsi
  int v8; // edi
  int v9; // edx
...
LABEL_5:
    ...
    if ( v8 < 0 )
    {
      sub_14000C2A8((int)retaddr, 1674, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v8);
LABEL_41:
    ...
    if ( v11 < 0 )
    {
      sub_14000C2A8((int)retaddr, 1679, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v11);
LABEL_12:
...
LABEL_23:
    ...
    else
    {
      ...
      if ( (int)sub_140083ED8(v17, v27 + 120, v16, &v43) < 0 )
      {
        v21 = sub_140085804(v19, v18, v20, (_DWORD)v29, v27 + 152);
        v22 = v21;
        if ( v21 < 0 )
        {
          sub_14000C2A8((int)retaddr, 1708, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v21);
        ...
        try
        {
          v28 = sub_14000C330((_QWORD *)(v27 + 120), &v32);
        }
        ...
        try
        {
          ...
          v37 = 1;
          v33 = 0LL;
          v33 = sub_14000C4E4((_QWORD *)(v27 + 248), (_QWORD *)(v18 + 112));
        }
        catch ( ATL::CAtlException *v36 )
        {
          ...
          if ( (int)v43 < 0 )
          {
            sub_14000C2A8(
              ...
              (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp",
              v43);
            sub_14000C544((_QWORD *)(v27 + 120), v28);
LABEL_19:
            if ( lpCriticalSection )
              LeaveCriticalSection(lpCriticalSection);
            goto LABEL_12;
        ...
        *(_QWORD *)(v18 + 160) = v7;
        ...
        sub_14000C2A8((int)retaddr, 1724, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v23);
        sub_14000C448((_QWORD *)(v27 + 248), v33);
        sub_14000C544((_QWORD *)(v27 + 120), v28);
        goto LABEL_19;
      }
      v8 = -2147024809;
...
LABEL_18:
  ...
  v8 = -2147024809;
  sub_14000C2A8((int)retaddr, 1669, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", -2147024809);
  return (unsigned int)v8;
}
