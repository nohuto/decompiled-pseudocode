/*
 * XREFs of sub_140033500 @ 0x140033500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140033500(__int64 a1)
{
  int v1; // ebx
  ...
  if ( v1 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 20LL, &unk_1400CA218);
    }
    sub_14005A470("CAPOProcessNode::IsRightFormatSupported", 775LL, (unsigned int)v1);
  }
