/*
 * XREFs of sub_14007AFC0 @ 0x14007AFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14007AFC0(__int64 a1, __int64 *a2)
{
  ...
  *a2 = 0LL;
  if ( v2 >= 0 )
  {
    ...
    {
      *(_DWORD *)(v6 + 16) = v2;
      v9 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 48), (v6 >> 1) | 0x8000000000000000uLL, v2);
      v8 = v2 == v9;
      v2 = v9;
      if ( v8 )
        break;
