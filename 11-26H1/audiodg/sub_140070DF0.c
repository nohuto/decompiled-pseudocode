/*
 * XREFs of sub_140070DF0 @ 0x140070DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140070DF0(__int64 a1)
{
  int v2; // ebx
  ...
  if ( v2 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 0xBu, (__int64)&unk_1400CA7E8, v2);
    }
    sub_14005A470("CSystemAudioDeviceOffloadGraph::GetVolumeCoefficients", 160, v2);
  }
  EtwEventActivityIdControl(4LL, &v4);
