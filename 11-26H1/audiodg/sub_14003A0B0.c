/*
 * XREFs of sub_14003A0B0 @ 0x14003A0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14003A0B0(__int64 a1)
{
  int v2; // ebx
  ...
  if ( v2 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 12LL, &unk_1400CA7E8);
    }
    sub_14005A470("CSystemAudioDeviceOffloadGraph::SetVolumeCoefficients", 217LL, (unsigned int)v2);
  }
  EtwEventActivityIdControl(4LL, &v4);
