/*
 * XREFs of sub_140040A70 @ 0x140040A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140040A70(__int64 a1)
{
  int v2; // ebx
  ...
  if ( v2 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 17LL, &unk_1400CA7E8);
    }
    sub_14005A470("CSystemAudioDeviceOffloadGraph::GetMeterChannelCount", 439LL, (unsigned int)v2);
  }
  EtwEventActivityIdControl(4LL, &v4);
