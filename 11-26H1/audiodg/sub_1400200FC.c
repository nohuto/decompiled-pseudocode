/*
 * XREFs of sub_1400200FC @ 0x1400200FC
 * Callers:
 *     sub_1400200F0 @ 0x1400200F0 (sub_1400200F0.c)
...
__int64 __fastcall sub_1400200FC(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  unsigned int v6; // edi
  _QWORD *i; // rbx
  _DWORD *v8; // rcx
