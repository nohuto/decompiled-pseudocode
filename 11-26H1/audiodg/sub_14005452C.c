/*
 * XREFs of sub_14005452C @ 0x14005452C
 * Callers:
 *     sub_140052E0C @ 0x140052E0C (sub_140052E0C.c)
 * Callees:
 *     sub_140052F18 @ 0x140052F18 (sub_140052F18.c)
 *     sub_140053F38 @ 0x140053F38 (sub_140053F38.c)
 */

__int64 __fastcall sub_14005452C(_QWORD *a1, __int64 a2, __int64 a3)
{
  _QWORD *v6; // r12
  __int64 v7; // rsi
  _QWORD *v8; // r15
...
LABEL_6:
    ...
    for ( *(_QWORD *)(v7 + 8 * v11 + 8) = v6; ; *(_QWORD *)(v7 + 8 * v11 + 8) = v8 )
    {
      ...
      if ( v22 == a3 )
        break;
      v17 = sub_140052F18((_QWORD *)(v22 + 16));
      v11 = 2 * (a1[6] & v17);
