/*
 * XREFs of sub_1400722D0 @ 0x1400722D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1400722D0(__int64 a1)
{
  __int64 v2; // rcx
  int v3; // ebx
  ...
  if ( v3 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 0x16u, (__int64)&unk_1400C6808, v3);
    }
    sub_14005A470("CSystemAudioDeviceSharedBase::GetFormat", 439, v3);
  }
  sub_140018FF0(&v5);
  EtwEventActivityIdControl(4LL, &v7);
