/*
 * XREFs of sub_140071780 @ 0x140071780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140071780(__int64 a1)
{
  int v2; // ebx
  ...
  if ( v2 < 0 )
  {
    ...
    {
      sub_14005A040(*((_QWORD *)off_1400E73D8 + 2), 0xFu, (__int64)&unk_1400CA7E8, v2);
    }
    sub_14005A470("CSystemAudioDeviceOffloadGraph::SetMute", 342, v2);
  }
  EtwEventActivityIdControl(4LL, &v4);
