...
void __fastcall sub_140096938(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rcx
  unsigned __int64 v5; // rax
  int v6; // r8d

  *(_QWORD *)a1 = off_1400F56C0;
  *(_QWORD *)(a1 + 8) = off_1400F5688;
  v4 = *(_QWORD *)(a1 + 160);
  if ( v4 )
  {
