/*
 * XREFs of sub_140090100 @ 0x140090100
 * Callers:
 *     sub_140090F00 @ 0x140090F00 (sub_140090F00.c)
 * Callees:
...
__int64 __fastcall sub_140090100(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v6; // rcx
  _DWORD *v7; // rsi
  ...
  *(_DWORD *)(a2 + 16) = 28;
  ...
  {
    v20 = 25;
    sub_14000253C((__int64)v6, (__int64)&unk_1400D31F1, a3, a4, (__int64)&v20);
  }
  if ( (int)sub_1400B6010(a1[4]) < 0 )
  {
    ...
    if ( *v7 > 2u )
    {
      ...
      sub_140002614((__int64)v7, (__int64)&unk_1400D31BA, v10, v11, (__int64)&v21, (__int64)&v20);
    }
