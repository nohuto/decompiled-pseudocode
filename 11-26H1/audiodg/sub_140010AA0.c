/*
 * XREFs of sub_140010AA0 @ 0x140010AA0
 * Callers:
...
__int64 __fastcall sub_140010AA0(__int64 a1, __int64 i, unsigned int a3, int a4)
{
  __int64 v5; // r15
  int v6; // r14d
  __int64 v8; // rax
  ...
  if ( !*(_QWORD *)(a1 + 64) )
  {
    v8 = sub_140011318(a1 + 56, *(unsigned int *)(a1 + 52), 48LL);
    if ( !v8 )
      sub_14004639C(2147942414LL, 0LL);
    v9 = (unsigned int)(*(_DWORD *)(a1 + 52) - 1);
    for ( i = 48 * v9 + 8 + v8; (int)v9 >= 0; LODWORD(v9) = v9 - 1 )
    {
