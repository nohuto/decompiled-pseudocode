/*
 * XREFs of sub_140062080 @ 0x140062080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140062080(__int64 a1, void *a2, __int64 *a3)
{
  __int64 *v3; // r14
  __int64 v4; // rdi
  ...
  v11 = 0;
  v19 = 0;
  v7 = sub_140061328(v4 + 56, ProcessId, &v11, (unsigned int *)&v19, &v15);
  v8 = v7;
  if ( v7 )
  {
  ...
  try
  {
    v15 = 0LL;
    LODWORD(v15) = 1;
    v8 = sub_140062830(v4 + 56, ProcessId, &v15);
    v12 = v8;
  }
