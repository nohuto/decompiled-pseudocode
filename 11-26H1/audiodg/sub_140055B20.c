/*
 * XREFs of sub_140055B20 @ 0x140055B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140055B20(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rcx
  unsigned int v4; // ebx
  ...
  v2 = sub_140006470(a1);
  sub_140006980(&PerformanceCount, (LARGE_INTEGER)v2, "SrvSystemEffect_Reset", a1 + 132);
  v3 = *(_QWORD *)(a1 + 88);
  if ( v3 )
    v4 = sub_1400B6010(v3);
  else
