/*
 * XREFs of sub_140084B80 @ 0x140084B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_140084B80(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v8; // ebx
  int v9; // edx
  int v10; // eax
  ...
  if ( a3 )
  {
    ...
    if ( v10 < 0 )
    {
      sub_14000C2A8((int)retaddr, 1975, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v10);
LABEL_27:
    ...
    sub_1400B6010(v11);
    v25[0] = 0LL;
    v14 = sub_140083D0C(v12, 0LL, a3, v25);
    if ( v14 || (v25[0] = 0LL, (v14 = sub_140083D0C(v13, (_QWORD *)(a1 + 184), a3, v25)) != 0LL) )
    {
      ...
      {
        v25[0] = 0LL;
        v20 = sub_140083ED8(v17, v14 + 19, v16, v25);
        v22 = v20;
        if ( v20 < 0 )
        {
          sub_14000C2A8((int)retaddr, 1995, (int)"avcore\\audiocore\\engine\\core\\processor\\audioprocessor2.cpp", v20);
          if ( lpCriticalSection )
            LeaveCriticalSection(lpCriticalSection);
          v8 = v22;
          goto LABEL_27;
        }
        sub_14000C544(v21, (unsigned __int64)v25[0]);
        sub_14000C448(v14 + 35, (unsigned __int64)v25[0]);
        --*(_DWORD *)(v18 + 12);
        v23 = sub_140083CA0(a1, v18);
        v8 = v23;
        if ( v23 >= 0 )
        {
          if ( lpCriticalSection )
