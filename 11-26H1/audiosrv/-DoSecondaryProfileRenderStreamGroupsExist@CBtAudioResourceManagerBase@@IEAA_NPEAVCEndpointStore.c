/*
 * XREFs of ?DoSecondaryProfileRenderStreamGroupsExist@CBtAudioResourceManagerBase@@IEAA_NPEAVCEndpointStore@@@Z @ 0x1800E1F3C
 * Callers:
          ...
          if ( v11(this, &v16) )
          {
            if ( (_QWORD)v12 )
            {
              std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
                (__int64 *)v12,
                *((__int64 **)&v12 + 1));
              std::_Deallocate<16>((void *)v12, (struct std::nothrow_t *)((v13 - v12) & 0xFFFFFFFFFFFFFFF8uLL));
              v12 = 0LL;
              v13 = 0LL;
            }
            if ( (_QWORD)v14 )
