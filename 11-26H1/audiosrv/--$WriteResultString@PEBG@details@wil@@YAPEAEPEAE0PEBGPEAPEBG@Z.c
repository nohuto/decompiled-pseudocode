/*
 * XREFs of ??$WriteResultString@PEBG@details@wil@@YAPEAEPEAE0PEBGPEAPEBG@Z @ 0x1800B6950
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x1800B7C5C (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
