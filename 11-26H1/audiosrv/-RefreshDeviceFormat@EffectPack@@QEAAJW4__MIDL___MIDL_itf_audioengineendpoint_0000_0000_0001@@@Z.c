/*
 * XREFs of ?RefreshDeviceFormat@EffectPack@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x1800861B8
 * Callers:
        ...
        enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 a2)
{
  ...
  const wchar_t *v16; // [rsp+50h] [rbp-30h] BYREF
  ...
  {
    v15 = a2;
    v16 = *(const wchar_t **)(*((_QWORD *)this + 198) + 48LL);
  ...
  DeviceFormat = EffectPack::GetDeviceFormat((CEndpointCharacteristics **)this, 0LL, v8, v6, &v18[1]);
  if ( v19 )
