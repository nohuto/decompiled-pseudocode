/*
 * XREFs of ?AllowRawStreamCreation@EffectPack@@QEAA_NW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x18007A858
 * Callers:
...
char __fastcall EffectPack::AllowRawStreamCreation(EffectPack *this, unsigned int a2)
{
  ...
  IsConnectorModeSupported = EffectPack::IsConnectorModeSupported(this, a2, 0LL, &v9);
  v7 = 0;
  if ( IsConnectorModeSupported )
  {
    if ( v2 >= *((_QWORD *)this + 219) )
    {
      _o_terminate(v6, v5, 0LL);
      __debugbreak();
      JUMPOUT(0x18007A8C2LL);
    }
