/*
 * XREFs of ?IsDtsxHeadphonesEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x1801562AC
 * Callers:
 *     ?GetDeepLink@CSpatialAudioDtsxHeadphones@@UEBAPEBGPEBG@Z @ 0x180083FE0 (-GetDeepLink@CSpatialAudioDtsxHeadphones@@UEBAPEBGPEBG@Z.c)
 *     ?GetTechnologyLicenseResult@CSpatialAudioDtsxHeadphones@@UEBAJPEBG@Z @ 0x180147FE0 (-GetTechnologyLicenseResult@CSpatialAudioDtsxHeadphones@@UEBAJPEBG@Z.c)
 * Callees:
