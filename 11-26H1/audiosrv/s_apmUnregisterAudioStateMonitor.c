/*
 * XREFs of s_apmUnregisterAudioStateMonitor @ 0x1800740F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmUnregisterAudioStateMonitor(__int64 a1, __int64 a2)
{
  ...
  v11 = L"s_apmUnregisterAudioStateMonitor";
  v13 = 0;
  v14 = 0LL;
  ...
  v7 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64))(*(_QWORD *)g_PolicyManager + 296LL))(
         g_PolicyManager,
         a1,
         a2);
