...
char *__fastcall std::vector<std::unique_ptr<_ConnectorInfo>>::_Emplace_reallocate<std::unique_ptr<_ConnectorInfo>>(
        _QWORD *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *(_QWORD *)v17 = v14;
  ...
  if ( a2 != v18 )
  {
    std::_Uninitialized_move<std::unique_ptr<_ConnectorInfo> *,std::allocator<std::unique_ptr<_ConnectorInfo>>>(
      v19,
      a2,
      v13);
    v18 = a1[1];
  ...
  std::_Uninitialized_move<std::unique_ptr<_ConnectorInfo> *,std::allocator<std::unique_ptr<_ConnectorInfo>>>(
    ...
    v18,
    v16);
  std::vector<std::unique_ptr<_ConnectorInfo>>::_Change_array(a1, v15, v9, v3, v21, 0LL, v22, v23, v24);
  std::vector<std::unique_ptr<_ConnectorInfo>>::_Reallocation_guard::~_Reallocation_guard(&v21);
  return v17;
}
