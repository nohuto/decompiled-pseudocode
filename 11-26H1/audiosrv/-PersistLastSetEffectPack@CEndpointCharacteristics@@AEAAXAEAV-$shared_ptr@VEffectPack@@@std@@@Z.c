/*
 * XREFs of ?PersistLastSetEffectPack@CEndpointCharacteristics@@AEAAXAEAV?$shared_ptr@VEffectPack@@@std@@@Z @ 0x18013B230
 * Callers:
...
void __fastcall CEndpointCharacteristics::PersistLastSetEffectPack(__int64 a1, __int64 *a2)
{
  ...
  v2 = *a2;
  v9 = 0uLL;
  v9 = *(_OWORD *)*(_QWORD *)(v2 + 1568);
  v10 = *(_DWORD *)(*(_QWORD *)(v2 + 1568) + 1848LL);
  v4 = *(_DWORD *)(*(_QWORD *)(v2 + 1568) + 1852LL);
  v7 = 0LL;
  LOWORD(v7) = 65;
  v11 = v4;
  v5 = *(_QWORD *)(a1 + 72);
