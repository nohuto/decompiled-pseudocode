/*
 * XREFs of ?ClearEffectPackDeviceIdFromFxPropStore@CEndpointCharacteristics@@AEAAXPEAU_GUID@@I@Z @ 0x180137C94
 * Callers:
        ...
        unsigned int a3)
{
  ...
  const wchar_t *v12; // [rsp+38h] [rbp-48h] BYREF
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      *(_OWORD *)pvar = 0LL;
      ...
      if ( *v10 > 5u )
      {
        v12 = (const wchar_t *)*((_QWORD *)this + 6);
        v13 = lpsz;
