/*
 * XREFs of _lambda_3f48f908354d0a377503ef9be61a0c4e_::operator() @ 0x1800F9B04
 * Callers:
...
__int64 __fastcall lambda_3f48f908354d0a377503ef9be61a0c4e_::operator()(__int64 a1, char a2)
{
  unsigned int v2; // r9d
  __int64 v5; // rax
  unsigned int v6; // ecx
