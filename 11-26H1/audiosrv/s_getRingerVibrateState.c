/*
 * XREFs of s_getRingerVibrateState @ 0x18010A600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_getRingerVibrateState(__int64 a1, _DWORD *a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    *((struct _TP_TIMER **)v5 + 1),
    v4,
    (struct _TP_TIMER *)L"s_getRingerVibrateState",
    pftDueTime);
  *a2 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *))(*(_QWORD *)g_PolicyManager + 256LL))(g_PolicyManager);
