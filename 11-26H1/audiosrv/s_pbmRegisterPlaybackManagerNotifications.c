/*
 * XREFs of s_pbmRegisterPlaybackManagerNotifications @ 0x18010AB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmRegisterPlaybackManagerNotifications(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  {
    v8 = PbmRegisterPlaybackManagerNotifications(a1, a2, a3);
  }
  else if ( !a2 && g_PolicyManager )
  {
    ...
    v8 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64 *))(*(_QWORD *)g_PolicyManager + 32LL))(
           ...
           &v12);
    if ( v8 >= 0 )
      v8 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v12 + 328LL))(v12);
