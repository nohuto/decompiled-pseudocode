        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)v17 = v14;
  ...
  std::vector<Sarm::CSpatialAudioResourceManager::AppPolicyChangeSubscription>::_Change_array(
    ...
    v23,
    v24);
  std::vector<Sarm::CSpatialAudioResourceManager::AppPolicyChangeSubscription>::_Reallocation_guard::~_Reallocation_guard((__int64)&v21);
  return v17;
}
