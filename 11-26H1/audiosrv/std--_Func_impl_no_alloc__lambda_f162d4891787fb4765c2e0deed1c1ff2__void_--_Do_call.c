/*
 * XREFs of std::_Func_impl_no_alloc__lambda_f162d4891787fb4765c2e0deed1c1ff2__void_::_Do_call @ 0x1800CF760
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc__lambda_f162d4891787fb4765c2e0deed1c1ff2__void_::_Do_call(__int64 a1)
{
  int v1; // eax
