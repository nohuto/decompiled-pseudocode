/*
 * XREFs of ??1_Reallocation_guard@?$vector@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@V?$allocator@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800F0CC0
 * Callers:
...
void __fastcall std::vector<std::unique_ptr<_ConnectorInfo>>::_Reallocation_guard::~_Reallocation_guard(__int64 a1)
{
  if ( *(_QWORD *)(a1 + 8) )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<_ConnectorInfo>>>(*(_QWORD *)(a1 + 24), *(_QWORD *)(a1 + 32));
