/*
 * XREFs of ?SerializeForRPC@?$CSectionBasedCPClientMemory@UControlData_V2@@@@UEAAJPEAUCP_MEMORY_METADATA_BLOB@@@Z @ 0x18015F630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSectionBasedCPClientMemory<ControlData_V2>::SerializeForRPC(
        ...
        __int64 a2)
{
  ...
  *v6 = v14;
  v6[1] = v15;
  *((_QWORD *)v6 + 4) = v16;
  v17 = CSectionBasedCrossProcessMemory::SerializeForRPC(this, (struct STANDARD_CROSSPROCESS_MEMORY *)(a2 + 8));
  v18 = v17;
  if ( v17 >= 0 )
  {
    *(_DWORD *)a2 = 1;
