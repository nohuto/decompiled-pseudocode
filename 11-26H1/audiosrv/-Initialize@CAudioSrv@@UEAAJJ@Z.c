/*
 * XREFs of ?Initialize@CAudioSrv@@UEAAJJ@Z @ 0x1800D9110
 * Callers:
 *     <none>
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3@Z @ 0x180001DF0 (--$Write@U-$_tlgWrapperByVal@$03@@U1@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUI.c)
  ...
  if ( !a2 )
  {
    ...
    *((_QWORD *)this + 11) = v5;
    if ( !v5 )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, (__int64)&WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
      }
      a2 = -2147024882;
    }
  }
  ...
  if ( !a2 )
  {
    ...
    if ( v6 )
    {
      ...
      *(_QWORD *)&v7[3].LockCount = 0LL;
      ...
      g_ADGProcess = v7;
      v8 = (CPowerReferenceManager *)operator new(0x308uLL);
      v10 = v8;
      ppv = v8;
      if ( v8 )
      {
        memset_0(v8, 0, 0x308uLL);
      ...
      ppv = 0LL;
      std::unique_ptr<CPowerReferenceManager>::reset(v9, v11);
    ...
    else
    {
      ...
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, (__int64)&WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
      }
    }
  }
  ppv = 0LL;
    ...
    if ( !v13 )
    {
      ...
      *(_QWORD *)&EventAttributes.bInheritHandle = 0LL;
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
      }
             ...
             0LL) )
      {
        if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x12u, (__int64)&WPP_126de3733680384bb8fabd64a7dcaca6_Traceguids);
        }
