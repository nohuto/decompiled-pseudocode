/*
 * XREFs of ??$InternalCallback@W4_PO_STANDBY_AUDIO_POLICY@@@?$wnf_subscription_state@W4_PO_STANDBY_AUDIO_POLICY@@@details@wil@@QEAAXPEBW4_PO_STANDBY_AUDIO_POLICY@@K@Z @ 0x1800D68CC
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_cdb66e8b67df41bb0e9ce18a2f5d193f_@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x1800D6550 (-_lambda_invoker_cdecl_@_lambda_cdb66e8b67df41bb0e9ce18a2f5d193f_@@CAJU_WNF_STATE_NAME@@KPEAU_WN.c)
 * Callees:
