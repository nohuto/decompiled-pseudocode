/*
 * XREFs of ??$Make@VAtmosCheck@@$$V@Details@WRL@Microsoft@@YA?AV?$ComPtr@VAtmosCheck@@@12@XZ @ 0x1800AEAD4
 * Callers:
...
AtmosCheck **__fastcall Microsoft::WRL::Details::Make<AtmosCheck,>(AtmosCheck **a1)
{
  ...
  *a1 = 0LL;
  v2 = (AtmosCheck *)operator new[](0x2F8uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v2 )
  {
