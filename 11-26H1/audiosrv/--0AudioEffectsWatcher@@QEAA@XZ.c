/*
 * XREFs of ??0AudioEffectsWatcher@@QEAA@XZ @ 0x1800BEBB4
 * Callers:
...
AudioEffectsWatcher *__fastcall AudioEffectsWatcher::AudioEffectsWatcher(AudioEffectsWatcher *this)
{
  ...
  *(_OWORD *)((char *)this + 104) = xmmword_1801D5668;
  *(_OWORD *)((char *)this + 120) = xmmword_1801D5678;
  *(_OWORD *)((char *)this + 136) = xmmword_1801D5688;
  return this;
}
