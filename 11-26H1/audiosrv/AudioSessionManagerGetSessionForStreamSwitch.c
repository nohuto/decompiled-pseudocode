/*
 * XREFs of AudioSessionManagerGetSessionForStreamSwitch @ 0x180026D90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetDuckingOptOutPreference@CAudioSession@@QEAAJ_N@Z @ 0x1800ABC14 (-SetDuckingOptOutPreference@CAudioSession@@QEAAJ_N@Z.c)
...
__int64 __fastcall AudioSessionManagerGetSessionForStreamSwitch(__int64 *a1, const unsigned __int16 *a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  v27 = 0;
  v24 = 0;
  v11 = (const unsigned __int16 *)(*(_QWORD *)v7 + 16LL);
  if ( *(_QWORD *)(*(_QWORD *)v7 + 40LL) > 7uLL )
  ...
  if ( v12 >= 0 )
  {
    v13 = *(struct _RTL_CRITICAL_SECTION **)(*(_QWORD *)v7 + 96LL);
    v25 = 0LL;
