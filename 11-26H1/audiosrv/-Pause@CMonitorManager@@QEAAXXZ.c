/*
 * XREFs of ?Pause@CMonitorManager@@QEAAXXZ @ 0x18011F648
 * Callers:
 *     ?PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18011F710 (-PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
...
void __fastcall CMonitorManager::Pause(CMonitorManager *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, (__int64)&WPP_72c9fd82aa603dc17c55ee7407a1fef9_Traceguids);
  }
  if ( *((_QWORD *)this + 16) )
  {
