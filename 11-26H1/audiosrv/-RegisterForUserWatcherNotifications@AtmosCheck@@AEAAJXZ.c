/*
 * XREFs of ?RegisterForUserWatcherNotifications@AtmosCheck@@AEAAJXZ @ 0x180157574
 * Callers:
 ...
 *     ?IsMultiUserSKU@@YA_NXZ @ 0x1801565D8 (-IsMultiUserSKU@@YA_NXZ.c)
...
LABEL_7:
      ...
      v10 = lambda_f74592632540feccec9f4b5e07595a4c_::_lambda_f74592632540feccec9f4b5e07595a4c_(
              (__int64 *)&hstringHeader,
              &v16,
              (__int64)this);
      Microsoft::WRL::Callback_Microsoft::WRL::Implements_Microsoft::WRL::RuntimeClassFlags_2__Windows::Foundation::ITypedEventHandler_Windows::System::UserWatcher___Windows::System::UserChangedEventArgs____Microsoft::WRL::FtmBase___lambda_845333a8787d1c1be8cc0a92f929247d___(
        &v18,
        (__int64)v10);
