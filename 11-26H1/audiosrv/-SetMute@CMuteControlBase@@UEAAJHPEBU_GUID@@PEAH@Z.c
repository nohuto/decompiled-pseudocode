/*
 * XREFs of ?SetMute@CMuteControlBase@@UEAAJHPEBU_GUID@@PEAH@Z @ 0x18007ED50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qd_guid_ @ 0x180109824 (WPP_SF_qd_guid_.c)
...
__int64 __fastcall CMuteControlBase::SetMute(CMuteControlBase *this, unsigned int a2, const struct _GUID *a3, int *a4)
{
  ...
  const wchar_t *v21; // [rsp+60h] [rbp+8h] BYREF
  ...
  {
    v21 = (const wchar_t *)*((_QWORD *)this + 4);
    v22 = a2;
  ...
  v14 = (*(__int64 (__fastcall **)(CMuteControlBase *, _QWORD))(*(_QWORD *)this + 120LL))(this, a2);
  v15 = v14;
  if ( v14 < 0 )
  {
