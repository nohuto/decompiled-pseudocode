/*
 * XREFs of ?QueueOnDeviceWorkItem@CAudioSrv@@AEAAJPEBGW4ONDEVICE_WORK_ITEM_TYPE@@K@Z @ 0x180051C68
 * Callers:
 *     ?OnDeviceStateChanged@CAudioSrv@@UEAAJPEBGK@Z @ 0x180051C50 (-OnDeviceStateChanged@CAudioSrv@@UEAAJPEBGK@Z.c)
 *     ?OnDeviceAdded@CAudioSrv@@UEAAJPEBG@Z @ 0x1800D9740 (-OnDeviceAdded@CAudioSrv@@UEAAJPEBG@Z.c)
 *     ?OnDeviceRemoved@CAudioSrv@@UEAAJPEBG@Z @ 0x1800D9760 (-OnDeviceRemoved@CAudioSrv@@UEAAJPEBG@Z.c)
 * Callees:
