/*
 * XREFs of __tailMerge_api_ms_win_appmodel_identity_l1_2_0_dll @ 0x1800B3CF6
 * Callers:
 *     __imp_load_AppContainerDeriveSidFromMoniker @ 0x1800B3D75 (__imp_load_AppContainerDeriveSidFromMoniker.c)
 * Callees:
