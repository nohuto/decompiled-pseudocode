/*
 * XREFs of ??_E?$scoped_input_vector_view@Uguid@winrt@@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@Uguid@winrt@@@std@@@std@@@std@@@impl@winrt@@UEAAPEAXI@Z @ 0x1800EB0A0
 * Callers:
 *     <none>
 * Callees:
