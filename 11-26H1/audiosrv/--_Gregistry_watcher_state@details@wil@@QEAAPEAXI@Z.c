/*
 * XREFs of ??_Gregistry_watcher_state@details@wil@@QEAAPEAXI@Z @ 0x18011C030
 * Callers:
 ...
 *     ?ReleaseFromCallback@registry_watcher_state@details@wil@@QEAAX_N@Z @ 0x18011FA38 (-ReleaseFromCallback@registry_watcher_state@details@wil@@QEAAX_N@Z.c)
