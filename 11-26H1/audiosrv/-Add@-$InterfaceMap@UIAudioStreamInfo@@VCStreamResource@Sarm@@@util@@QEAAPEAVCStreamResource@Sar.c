/*
 * XREFs of ?Add@?$InterfaceMap@UIAudioStreamInfo@@VCStreamResource@Sarm@@@util@@QEAAPEAVCStreamResource@Sarm@@PEAUIAudioStreamInfo@@PEAPEAU__POSITION@@@Z @ 0x1801249F0
 * Callers:
 ...
 * Callees:
 *     ?GetKey@?$InterfaceMap@UIAudioStreamInfo@@VCStreamResource@Sarm@@@util@@AEAAPEAUIAudioStreamInfo@@PEAU3@@Z @ 0x1800734CC (-GetKey@-$InterfaceMap@UIAudioStreamInfo@@VCStreamResource@Sarm@@@util@@AEAAPEAUIAudioStreamInfo.c)
 ...
 *     ?Attach@?$ComPtr@UIAudioStreamInfo@@@WRL@Microsoft@@QEAAXPEAUIAudioStreamInfo@@@Z @ 0x1800AE3C0 (-Attach@-$ComPtr@UIAudioStreamInfo@@@WRL@Microsoft@@QEAAXPEAUIAudioStreamInfo@@@Z.c)
        ...
        __int64 *a3)
{
  ...
  Microsoft::WRL::ComPtr<IAudioStreamInfo>::Attach(&v13, Key);
  v7 = v13;
  if ( v13 )
  {
    v14 = v13;
            ...
            &v22) )
    {
      ...
      catch ( ATL::CAtlException *v23 )
      {
        ...
        if ( (int)v25 < 0 )
        {
          v5 = 0LL;
LABEL_9:
          Sarm::CStreamResource::~CStreamResource((Sarm::CStreamResource *)v15);
          goto LABEL_10;
        }
        v3 = a3;
        v9 = v12;
