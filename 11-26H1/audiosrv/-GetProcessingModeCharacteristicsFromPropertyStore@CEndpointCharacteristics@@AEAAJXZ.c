/*
 * XREFs of ?GetProcessingModeCharacteristicsFromPropertyStore@CEndpointCharacteristics@@AEAAJXZ @ 0x1800323FC
 * Callers:
        ...
        CEndpointCharacteristics *this)
{
  ...
  if ( *((_DWORD *)this + 64) )
  {
    ...
    if ( v2 < 0 )
      goto LABEL_15;
    v15 = 0;
    v3 = (unsigned __int64 *)((char *)this + 216);
    v4 = *((_QWORD *)&v13 + 1);
    while ( 1 )
    {
      v5 = gsl::span<CAudioSignalProcessingModeArray,-1>::operator[]((unsigned __int64 *)this + 27, 3uLL);
      if ( v15 >= *(_DWORD *)(v5 + 8) )
        break;
      v9 = this;
      v10 = &v15;
...
LABEL_7:
  ...
  if ( v2 >= 0 )
  {
    ...
    std::vector<std::unique_ptr<CConnectorProcessingModeCharacteristics>>::operator=((_QWORD *)this + 37, &v13);
    std::vector<std::unique_ptr<CConnectorProcessingModeCharacteristics>>::operator=((_QWORD *)this + 34, &v11);
  }
LABEL_15:
