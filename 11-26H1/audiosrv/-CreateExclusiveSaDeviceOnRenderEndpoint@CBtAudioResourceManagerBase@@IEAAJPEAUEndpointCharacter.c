        ...
        __int64 a8)
{
  ...
  struct _RTL_CRITICAL_SECTION *v28; // [rsp+58h] [rbp-30h] BYREF
  __int128 v29; // [rsp+60h] [rbp-28h] BYREF
  ...
  try
  {
    v12 = 0;
    v27 = 0LL;
    v13 = *(const unsigned __int16 **)(a1 + 64);
    if ( v13 )
    {
      v31 = 0LL;
      EndpointStore = CEndpointStoreCache::GetEndpointStore((RTL_SRWLOCK *)a1, v13, &v31);
      v15 = EndpointStore;
      if ( EndpointStore < 0 )
      {
        ...
        wil::com_ptr_t<CEndpointStore,wil::err_returncode_policy>::~com_ptr_t<CEndpointStore,wil::err_returncode_policy>((volatile signed __int32 **)&v31);
        wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>::~unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_RTL_CRITICAL_SECTION *,void (*)(_RTL_CRITICAL_SECTION *),&void LeaveCriticalSection(_RTL_CRITICAL_SECTION *),wistd::integral_constant<unsigned __int64,1>,_RTL_CRITICAL_SECTION *,_RTL_CRITICAL_SECTION *,0,std::nullptr_t>>>(&v27);
        return v15;
      }
      v18 = v31;
      v19 = (struct _RTL_CRITICAL_SECTION **)(*(__int64 (__fastcall **)(_QWORD, __int128 *))(**((_QWORD **)v31 + 13)
                                                                                           + 128LL))(
                                               *((_QWORD *)v31 + 13),
                                               &v29);
    ...
    v31 = 0LL;
    v21 = CEndpointStoreCache::GetEndpointStore((RTL_SRWLOCK *)a1, *(const unsigned __int16 **)(a1 + 56), &v31);
    v22 = v21;
    if ( v21 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
    ...
    (*(void (__fastcall **)(_QWORD, struct _RTL_CRITICAL_SECTION **))(**((_QWORD **)v31 + 13) + 128LL))(
      *((_QWORD *)v31 + 13),
      &v28);
    if ( v12 )
    {
      v29 = *(_OWORD *)(a3 + 48);
      if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int128 *))(*(_QWORD *)a1 + 152LL))(a1, &v29) )
      {
        wil::details::in1diag3::Return_Hr(
          retaddr,
          (void *)0x3FD,
      ...
      SaDeviceWrapper = CBtAudioResourceManagerBase::GetSaDeviceWrapper(a1, a2, a3, a4, a5, a6, a7, 0LL, 0LL, a8);
      v24 = SaDeviceWrapper;
    ...
    {
      v25 = CBtAudioResourceManagerBase::GetSaDeviceWrapper(a1, a2, a3, a4, a5, a6, a7, 0LL, 0LL, a8);
      v26 = v25;
      if ( v25 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
