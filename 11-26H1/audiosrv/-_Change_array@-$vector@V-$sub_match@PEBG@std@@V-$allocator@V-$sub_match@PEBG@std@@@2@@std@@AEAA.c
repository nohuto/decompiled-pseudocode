/*
 * XREFs of ?_Change_array@?$vector@V?$sub_match@PEBG@std@@V?$allocator@V?$sub_match@PEBG@std@@@2@@std@@AEAAXQEAV?$sub_match@PEBG@2@_K1@Z @ 0x18013EAE0
 * Callers:
        ...
        __int64 a4)
{
  ...
  v6 = *(void **)a1;
  if ( v6 )
    std::_Deallocate<16>(v6, (struct std::nothrow_t *)(24 * ((*(_QWORD *)(a1 + 16) - (_QWORD)v6) / 24LL)));
  *(_QWORD *)a1 = a2;
