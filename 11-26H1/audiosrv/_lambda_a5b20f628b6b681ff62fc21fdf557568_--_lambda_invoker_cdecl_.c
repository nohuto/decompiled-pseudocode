/*
 * XREFs of _lambda_a5b20f628b6b681ff62fc21fdf557568_::_lambda_invoker_cdecl_ @ 0x18010E6C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PTP_TIMER Timer)
{
  ...
  if ( !*((_DWORD *)Context + 8) )
    wil::com_ptr_t<IMMDevice,wil::err_returncode_policy>::reset(Context + 17);
