/*
 * XREFs of ?Trace@AtmosCheck@@AEAAXPEBDJ@Z @ 0x180065414
 * Callers:
 ...
 *     ?StaticClientAtmosCheckEventFired@AtmosCheck@@SAXPEAXE@Z @ 0x180157BE0 (-StaticClientAtmosCheckEventFired@AtmosCheck@@SAXPEAXE@Z.c)
...
void __fastcall AtmosCheck::Trace(AtmosCheck *this, const char *a2, __int64 a3, __int64 a4)
{
  ...
  else if ( (unsigned int)CallbackContext > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    ...
    EventWriteTransfer(qword_1801D3398, &EventDescriptor, 0LL, 0LL, 3u, &UserData);
  }
}
