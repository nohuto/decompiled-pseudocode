/*
 * XREFs of ?SetAllChannelVolumeLevelScalar@BluetoothVolume@BluetoothControls@@UEAAJIPEBMPEBU_GUID@@PEAH@Z @ 0x1800DE260
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      (__int64)v8,
                      &v11);
  LODWORD(v8) = (*(__int64 (__fastcall **)(__int64, _QWORD, const float *, const struct _GUID *, int *))(*(_QWORD *)*TargetedControl + 208LL))(
                  *TargetedControl,
                  a2,
                  a3,
                  a4,
