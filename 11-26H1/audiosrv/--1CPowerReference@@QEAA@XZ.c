/*
 * XREFs of ??1CPowerReference@@QEAA@XZ @ 0x180011640
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCPowerReference@@@std@@EEAAXXZ @ 0x180080630 (-_Destroy@-$_Ref_count_obj2@VCPowerReference@@@std@@EEAAXXZ.c)
 * Callees:
...
void __fastcall CPowerReference::~CPowerReference(CPowerReference *this)
{
  ...
  if ( *((_QWORD *)this + 8) )
  {
    ...
    v11[2] = v10[1];
    v11[7] = v11;
    CSerialWorkQueue::QueueWorkItem(v9 + 448, v11);
  }
