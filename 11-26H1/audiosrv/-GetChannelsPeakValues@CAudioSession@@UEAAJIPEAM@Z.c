/*
 * XREFs of ?GetChannelsPeakValues@CAudioSession@@UEAAJIPEAM@Z @ 0x1800CE390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetChannelsPeakValues(CAudioStream ***this, unsigned int a2, float *a3)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, (__int64)&WPP_ee85f21a7da73824226bb42893b0f656_Traceguids, 0LL);
  }
  if ( !a3 )
  {
    v6 = -2147467261;
LABEL_7:
  ...
  if ( (_DWORD)v4 != v17 )
  {
    ...
    {
      WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 31LL, &WPP_ee85f21a7da73824226bb42893b0f656_Traceguids);
    }
    v6 = -2147024809;
    goto LABEL_7;
  }
