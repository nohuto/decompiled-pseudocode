...
__int64 __fastcall PolicyConfigSetDeviceFormat(__int64 a1, __int128 *a2, const wchar_t *a3, unsigned __int16 *a4)
{
  ...
  const wchar_t *v26; // [rsp+78h] [rbp-59h] BYREF
  GUID *v27; // [rsp+80h] [rbp-51h] BYREF
  const wchar_t *v28; // [rsp+88h] [rbp-49h] BYREF
  ...
  v19 = (*(__int64 (__fastcall **)(CPolicyConfig *, const wchar_t *, unsigned __int16 *, _QWORD))(*(_QWORD *)g_PolicyConfig
                                                                                                + 48LL))(
          g_PolicyConfig,
          a3,
          a4,
