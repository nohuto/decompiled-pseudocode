/*
 * XREFs of ??$RegisterObjects@$01@Details@WRL@Microsoft@@YAJPEAVModuleBase@012@PEBG@Z @ 0x180036A38
 * Callers:
 *     ?ConnectCallback@ServiceModule@Internal@Windows@@UEAAJXZ @ 0x1800D7EC0 (-ConnectCallback@ServiceModule@Internal@Windows@@UEAAJXZ.c)
 * Callees:
