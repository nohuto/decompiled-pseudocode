        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_1801D7DD8 + 16 * (a4 & qword_1801D7DF0) + 8);
  if ( v4 == (_QWORD *)qword_1801D7DC8 )
  {
    *a2 = qword_1801D7DC8;
LABEL_3:
    a2[1] = 0LL;
  ...
  else
  {
    while ( 1 )
    {
      ...
      if ( !v5 )
        break;
      if ( v4 == *(_QWORD **)(qword_1801D7DD8 + 16 * (a4 & qword_1801D7DF0)) )
      {
        *a2 = v4;
        goto LABEL_3;
      }
