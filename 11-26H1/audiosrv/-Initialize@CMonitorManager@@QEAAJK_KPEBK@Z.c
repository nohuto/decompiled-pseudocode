/*
 * XREFs of ?Initialize@CMonitorManager@@QEAAJK_KPEBK@Z @ 0x18011DC34
 * Callers:
...
__int64 __fastcall CMonitorManager::Initialize(CMonitorManager *this, int a2, __int64 a3, const unsigned int *a4)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_72c9fd82aa603dc17c55ee7407a1fef9_Traceguids);
  }
  v39 = 0LL;
  v42 = 0LL;
  v43 = 0LL;
...
LABEL_27:
      ...
      if ( v15 < 0 )
      {
        ...
        v17 = 11;
LABEL_32:
        WPP_SF_d(v16[2], v17, (__int64)&WPP_72c9fd82aa603dc17c55ee7407a1fef9_Traceguids, v15);
LABEL_33:
...
LABEL_62:
      ...
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, (__int64)&WPP_72c9fd82aa603dc17c55ee7407a1fef9_Traceguids);
      }
      v19 = (unsigned __int16 *)&LocaleName;
      if ( !(_BYTE)v50 )
