/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_a5707e8136b0bf7dfeec04d35a40fcb5_@@X_N@std@@EEAAX$$QEA_N@Z @ 0x1800DEC80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc<_lambda_a5707e8136b0bf7dfeec04d35a40fcb5_,void,bool>::_Do_call(
        __int64 a1,
        char *a2)
{
  char v3; // di
