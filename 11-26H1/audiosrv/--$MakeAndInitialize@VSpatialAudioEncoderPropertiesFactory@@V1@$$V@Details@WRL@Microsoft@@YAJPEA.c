/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioEncoderPropertiesFactory@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioEncoderPropertiesFactory@@@Z @ 0x18003D0B0
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  *v3 = &SpatialAudioEncoderPropertiesFactory::`vftable'{for `ISpatialAudioEncoderPropertiesFactory'};
  ...
  ((void (__fastcall *)(_QWORD *))Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,CCrossProcessFileObjectBasedCrossProcessMemory>::AddRef)(v3);
  *a1 = v3;
