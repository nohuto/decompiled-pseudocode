/*
 * XREFs of ??1_Reallocation_guard@?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x1800D1DFC
 * Callers:
...
void __fastcall std::vector<Microsoft::WRL::WeakRef>::_Reallocation_guard::~_Reallocation_guard(__int64 a1)
{
  if ( *(_QWORD *)(a1 + 8) )
  {
