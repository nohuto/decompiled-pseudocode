/*
 * XREFs of ?GetVolumeStepInfo@BluetoothVolume@BluetoothControls@@UEAAJPEAI0@Z @ 0x1800DD060
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      (__int64)this,
                      &v7);
  LODWORD(a3) = (*(__int64 (__fastcall **)(__int64, unsigned int *, unsigned int *))(*(_QWORD *)*TargetedControl + 184LL))(
                  *TargetedControl,
                  a2,
                  a3);
