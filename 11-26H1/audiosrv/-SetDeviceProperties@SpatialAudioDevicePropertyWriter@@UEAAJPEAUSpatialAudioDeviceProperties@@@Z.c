/*
 * XREFs of ?SetDeviceProperties@SpatialAudioDevicePropertyWriter@@UEAAJPEAUSpatialAudioDeviceProperties@@@Z @ 0x180130400
 * Callers:
 *     <none>
 * Callees:
        ...
        BYTE *a2)
{
    ...
    *(_OWORD *)&v14.vt = 0LL;
    ...
    if ( v10 < 0 )
    {
      if ( (unsigned int)dword_1801D32E8 <= 2 )
        return v8;
      v15 = v10;
      v9 = (unsigned __int8 *)&unk_1801A9C4E;
      v16 = 372;
      goto LABEL_6;
    }
    if ( !*((_DWORD *)this + 24) )
  ...
  else
  {
    ...
    {
      v15 = -2147024809;
      v9 = (unsigned __int8 *)&unk_1801A9C80;
      v16 = 361;
LABEL_6:
