/*
 * XREFs of ??1?$ComPtr@VCEndpointStore@@@WRL@Microsoft@@QEAA@XZ @ 0x180104888
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_CEndpointStore_CEndpointStore_unsigned_short_const___&__::_1_::dtor$1 @ 0x18016713C (_Microsoft--WRL--Details--MakeAndInitialize_CEndpointStore_CEndpointStore_unsigned_short_const__.c)
 * Callees:
