/*
 * XREFs of ??$_Emplace_reallocate@AEBV?$function@$$A6AX_N@Z@std@@@?$vector@V?$function@$$A6AX_N@Z@std@@V?$allocator@V?$function@$$A6AX_N@Z@std@@@2@@std@@AEAAPEAV?$function@$$A6AX_N@Z@1@QEAV21@AEBV21@@Z @ 0x1800DFA74
 * Callers:
        ...
        __int64 a3)
{
  ...
  v20 = v8;
  v22 = v14 + 64;
  std::function<void (bool)>::function<void (bool)>(v14, a3);
  v21 = v14;
  v15 = a1[1];
  v16 = v13;
  v17 = *a1;
  ...
  std::vector<std::function<void (bool)>>::_Change_array(a1, v13, v9, v8, v19[0], 0LL, v20, v21, v22);
  std::vector<std::function<void (bool)>>::_Reallocation_guard::~_Reallocation_guard(v19);
  return v14;
}
