 ...
 *     std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_64f1d33ea67811168a6f1a76ade7d933___ @ 0x1800C3924 (std--for_each_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_Microsoft--_ea_1800C3924.c)
        ...
        __int64 a3)
{
  ...
  while ( v7 != v6 )
  {
    ...
    {
      v12 = (_QWORD *)lambda_f7a716bfe224096f553bb41568304cf0_::_lambda_f7a716bfe224096f553bb41568304cf0_(&v25, v7);
      std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_017e0802307bc1bbb043f8b0ed58258f___(
        &v26,
        v18,
        *((_QWORD *)&v18 + 1),
        *v12);
  ...
  if ( (_QWORD)v20 )
  {
    std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
      (__int64 *)v20,
      *((__int64 **)&v20 + 1));
    std::_Deallocate<16>((void *)v20, (struct std::nothrow_t *)((v21 - v20) & 0xFFFFFFFFFFFFFFF8uLL));
  }
  return a2;
}
