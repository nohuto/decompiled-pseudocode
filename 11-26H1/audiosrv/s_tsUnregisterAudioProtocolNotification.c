/*
 * XREFs of s_tsUnregisterAudioProtocolNotification @ 0x180077BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_tsUnregisterAudioProtocolNotification(__int64 a1, __int64 a2)
{
  ...
  v11 = L"s_tsUnregisterAudioProtocolNotification";
  v13 = 0;
  v14 = 0LL;
  ...
  v7 = TS_UnregisterAudioProtocolNotification(a1, a2);
