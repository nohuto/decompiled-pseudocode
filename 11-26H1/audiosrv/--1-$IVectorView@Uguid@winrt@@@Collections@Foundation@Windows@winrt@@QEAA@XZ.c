/*
 * XREFs of ??1?$IVectorView@Uguid@winrt@@@Collections@Foundation@Windows@winrt@@QEAA@XZ @ 0x1800E9F84
 * Callers:
 ...
 *     ??1BluetoothAudioSharingParameters@Internal@Interface@Audio@Bluetooth@Microsoft@winrt@@QEAA@XZ @ 0x1800EA004 (--1BluetoothAudioSharingParameters@Internal@Interface@Audio@Bluetooth@Microsoft@winrt@@QEAA@XZ.c)
