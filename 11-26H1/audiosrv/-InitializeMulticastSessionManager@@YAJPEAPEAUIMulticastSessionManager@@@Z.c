/*
 * XREFs of ?InitializeMulticastSessionManager@@YAJPEAPEAUIMulticastSessionManager@@@Z @ 0x1801080B4
 * Callers:
 ...
 *     ??$copy_to@UIMulticastSessionManager@@@?$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAUIMulticastSessionManager@@@Z @ 0x180107074 (--$copy_to@UIMulticastSessionManager@@@-$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_po.c)
