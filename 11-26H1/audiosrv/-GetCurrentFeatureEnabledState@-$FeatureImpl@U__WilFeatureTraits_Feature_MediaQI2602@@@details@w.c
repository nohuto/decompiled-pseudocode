/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2602@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800C868C
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2511@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800CC6DC (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2511@@@details@wil@@QEAA_N.c)
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_Ten2Loc@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800CC7CC (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_Ten2Loc@@@details@wil@@QEAA_NW4Re.c)
 */
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v11 | v12;
  ...
  v15 = (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2511>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_MediaQI2511>::GetImpl'::`2'::impl)
