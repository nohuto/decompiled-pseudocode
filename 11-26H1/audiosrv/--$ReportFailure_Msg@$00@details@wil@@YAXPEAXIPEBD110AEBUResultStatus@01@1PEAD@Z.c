/*
 * XREFs of ??$ReportFailure_Msg@$00@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@1PEAD@Z @ 0x180047D9C
 * Callers:
 ...
 *     ??$ReportFailure_Win32Msg@$00@details@wil@@YAJPEAXIPEBD110K1PEAD@Z @ 0x180132D44 (--$ReportFailure_Win32Msg@$00@details@wil@@YAJPEAXIPEBD110K1PEAD@Z.c)
 * Callees:
...
__int64 __fastcall wil::details::ReportFailure_Msg<1>(
        ...
        char *a9)
{
  char *v11; // [rsp+20h] [rbp-1058h]
  _BYTE v12[4096]; // [rsp+50h] [rbp-1028h] BYREF

  wil::details::PrintLoggingMessage((wil::details *)v12, a2, a8, a9, v11);
  return wil::details::ReportFailure_Base<1,0>(a1);
}
