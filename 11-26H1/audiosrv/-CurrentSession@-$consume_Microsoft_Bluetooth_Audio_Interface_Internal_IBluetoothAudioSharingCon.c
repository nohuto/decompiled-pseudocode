/*
 * XREFs of ?CurrentSession@?$consume_Microsoft_Bluetooth_Audio_Interface_Internal_IBluetoothAudioSharingController@UIBluetoothAudioSharingController@Internal@Interface@Audio@Bluetooth@Microsoft@winrt@@@impl@winrt@@QEBA@XZ @ 0x1800EB65C
 * Callers:
