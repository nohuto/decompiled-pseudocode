/*
 * XREFs of ?DeleteAudioSessionClientNotification@CAudioSessionManager@@UEAAJPEAUIAudioProcess@@@Z @ 0x1800D21A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProcess *a2)
{
  ...
  v11[0] = &v13;
  v11[1] = &v12;
  v6 = std::remove_if<std::_Vector_iterator<std::_Vector_val<std::_Simple_types<CLockedList_UniqueValuesOnly<CAudioSessionNotificationProcess,0>::LockedListEntry>>>,_lambda_a5fcd431b6a5ef671993691a41929e10_>(
         &v9,
         *((_QWORD *)v4 + 5),
         v5,
         (__int64)v11);
