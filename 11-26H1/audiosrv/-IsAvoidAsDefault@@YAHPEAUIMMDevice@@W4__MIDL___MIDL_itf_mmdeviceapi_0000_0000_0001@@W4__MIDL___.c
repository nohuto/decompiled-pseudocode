/*
 * XREFs of ?IsAvoidAsDefault@@YAHPEAUIMMDevice@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@@Z @ 0x1800525F4
 * Callers:
...
__int64 __fastcall IsAvoidAsDefault(__int64 a1, int a2, int a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( a1 )
  {
    ...
    if ( v7 >= 0 )
    {
      v7 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v11 + 40LL))(
             v11,
