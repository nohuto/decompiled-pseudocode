/*
 * XREFs of ?_Getcat@?$collate@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18014D5E4
 * Callers:
 ...
 *     ??0?$collate@G@std@@QEAA@AEBV_Locinfo@1@_K@Z @ 0x18014A474 (--0-$collate@G@std@@QEAA@AEBV_Locinfo@1@_K@Z.c)
