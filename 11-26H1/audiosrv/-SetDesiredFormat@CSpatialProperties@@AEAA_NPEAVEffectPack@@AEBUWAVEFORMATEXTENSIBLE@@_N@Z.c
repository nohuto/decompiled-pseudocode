/*
 * XREFs of ?SetDesiredFormat@CSpatialProperties@@AEAA_NPEAVEffectPack@@AEBUWAVEFORMATEXTENSIBLE@@_N@Z @ 0x1801441B0
 * Callers:
        ...
        char a4)
{
  ...
  const wchar_t *v38; // [rsp+A0h] [rbp-60h] BYREF
    ...
    && tlgKeywordOn(*(_QWORD *)&lpCriticalSection[1].LockCount, 16LL) )
  {
    ...
    v37 = (const wchar_t *)&v39;
    v16 = lpCriticalSection[1].DebugInfo;
    v39 = v15;
    v38 = *(const wchar_t **)&v16[1].Type;
  ...
  v18 = 1;
  v19 = EffectPack::SetDeviceFormatAndSpatialSettings(this, eHostProcessConnector, &a3->Format, v17, 0);
  if ( v19 < 0 && a3->dwChannelMask == 1599 )
  {
    ...
    *(_DWORD *)&v40[20] = 255;
    v41 = v21;
    v18 = EffectPack::SetDeviceFormatAndSpatialSettings(
            this,
  ...
  if ( *v22 > 4u && tlgKeywordOn((__int64)v22, 0x400000000010LL) )
  {
    ...
    nSamplesPerSec = v19;
    v27 = *v26;
    v38 = (const wchar_t *)&v39;
    v28 = lpCriticalSection[1].DebugInfo;
    v39 = v27;
    v37 = *(const wchar_t **)&v28[1].Type;
    p_SubFormat = 2048LL;
