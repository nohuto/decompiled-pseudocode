/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x18012CDE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISpatialAudioMetadataDictionaryData **a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( a3 )
  {
    *a3 = 0LL;
    ...
    if ( PropertyIndexForMetadataFormatID < 0 )
    {
      ...
      *(_DWORD *)v18 = 571;
      v11 = (unsigned __int8 *)&unk_1801A910A;
      goto LABEL_7;
    }
    ...
    if ( v13 < 0 )
    {
      ...
      v19 = v13;
      *(_DWORD *)v18 = 577;
      v11 = (unsigned __int8 *)&unk_1801A906C;
      goto LABEL_7;
    }
    if ( LOWORD(pvar[0]) != 65 )
    {
      ...
      if ( (unsigned int)dword_1801D32E8 <= 2 )
        goto LABEL_22;
      *(_DWORD *)v18 = 579;
      v11 = (unsigned __int8 *)&unk_1801A9032;
      goto LABEL_6;
    }
    v14 = v23;
    v15 = (int)pvar[1];
    ...
    if ( SpatialAudioMetadataDictionaryFromData < 0 )
    {
      ...
      *(_DWORD *)v18 = 585;
      v11 = (unsigned __int8 *)&unk_1801A909E;
      goto LABEL_7;
    }
  ...
  else
  {
    ...
    {
      *(_DWORD *)v18 = 566;
      v11 = (unsigned __int8 *)&unk_1801A90D0;
LABEL_6:
      v19 = v10;
LABEL_7:
