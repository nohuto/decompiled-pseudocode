        ...
        struct SystemAudioStream *a7)
{
  ...
  v18 = a4;
  v17 = a3;
  v9 = CBaseStreamGroupProxy::ValidateStreamForStreamGroup(a1, a2);
  v10 = v9;
  if ( v9 >= 0 )
  {
    v16 = 0LL;
    *(_QWORD *)v14 = (*(__int64 (__fastcall **)(struct IAudioStreamInfo *))(*(_QWORD *)a2 + 80LL))(a2);
    if ( v16 )
    ...
    if ( v11 >= 0 )
    {
      CAudioStream::SetAudioHandle((CAudioStream *)(((unsigned __int64)a2 - 8) & -(__int64)(a2 != 0LL)), a7, a5, v16);
      v11 = (*(__int64 (__fastcall **)(struct IStreamInstanceProxy *, struct IAudioStreamInfo *, unsigned __int64, __int64))(*(_QWORD *)v16 + 64LL))(
              v16,
              a2,
              (unsigned __int64)a1 & -(__int64)(a1 != (struct _RTL_CRITICAL_SECTION *)8),
              1LL);
      v10 = v11;
      if ( v11 >= 0 )
      {
