/*
 * XREFs of ?LogRequestDynamicObjects@CSpatialAudioResourceManagerTraceLogger@@QEAAX_JII@Z @ 0x180128C68
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_1801D32B0 > 4 )
  {
    ...
    v11 = 4LL;
    v9 = 8LL;
    tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801D32B0, byte_1801A83A3, 0LL, 0LL, 5u, &v7);
  }
}
