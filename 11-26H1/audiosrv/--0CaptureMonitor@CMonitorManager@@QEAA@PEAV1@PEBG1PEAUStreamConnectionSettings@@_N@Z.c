/*
 * XREFs of ??0CaptureMonitor@CMonitorManager@@QEAA@PEAV1@PEBG1PEAUStreamConnectionSettings@@_N@Z @ 0x18011B82C
 * Callers:
        ...
        bool a6)
{
  ...
  *((_BYTE *)this + 48) = 0;
  *((_BYTE *)this + 49) = a6;
  std::wstring::wstring((char **)this + 7, a3);
  std::wstring::wstring((char **)this + 11, a4);
  *((_QWORD *)this + 15) = 0LL;
  *((_DWORD *)this + 32) = 0;
