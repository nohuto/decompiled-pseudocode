/*
 * XREFs of AudioServerGetCurrentSharedModeEnginePeriod @ 0x180115590
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 v40; // r8d
  int v41; // eax
  EffectPack *v42; // rbx
  __int64 v43; // r8
  int v44; // eax
  ...
  struct _GUID v72; // [rsp+118h] [rbp+10h] BYREF
  __int64 **v73; // [rsp+128h] [rbp+20h]
  struct tWAVEFORMATEX *v74[2]; // [rsp+138h] [rbp+30h] BYREF
  __int64 **v75; // [rsp+148h] [rbp+40h]
  struct _GUID v76; // [rsp+158h] [rbp+50h] BYREF
  struct _TP_TIMER *pv[7]; // [rsp+168h] [rbp+60h] BYREF
  IID v78; // [rsp+1A0h] [rbp+98h]
  IID v79; // [rsp+1B0h] [rbp+A8h] BYREF
...
LABEL_11:
  ...
  {
    v74[1] = 0LL;
    v74[0] = (struct tWAVEFORMATEX *)&v61;
    v34 = *v64;
    LOBYTE(v75) = 1;
    v35 = (const struct tWAVEFORMATEX *)(*(__int64 (__fastcall **)(__int64 *))(v34 + 48))(v64);
    MixFormat = CloneWaveFormat(v35, &v74[1]);
    wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)v74);
    if ( MixFormat < 0 )
    {
      v36 = 4216LL;
LABEL_34:
    ...
    if ( v37 >= 0 )
    {
      v38 = (struct _RTL_CRITICAL_SECTION *)v69[1];
      *(_QWORD *)&v71.Data1 = 0LL;
      wil::com_ptr_t<IMMDevice,wil::err_returncode_policy>::reset((__int64 *)&v71);
      v39 = v76;
      v40 = *(_DWORD *)(a3 + 52);
      v72 = v76;
      v41 = EffectPack::DeriveDevicePipeFormatFromConnectorFormat(v38, &v72, v40, v62, (struct IAudioMediaType **)&v71);
      MixFormat = v41;
      if ( v41 >= 0 )
      {
        v42 = v69[1];
        ...
        v44 = EffectPack::DeriveMixFormatFromDevicePipeFormat(
                ...
                &v72,
                v43,
                *(struct IAudioMediaType **)&v71.Data1,
                ppIAudioMediaType,
                0LL);
        MixFormat = v44;
        if ( v44 >= 0 )
  ...
  v24 = *(_DWORD *)(a3 + 52);
  *(_QWORD *)&v72.Data1 = &pAudioFormat;
  v71 = *(struct _GUID *)ppIAudioMediaType;
  pAudioFormat = 0LL;
  *(_QWORD *)v72.Data4 = 0LL;
  LOBYTE(v73) = 1;
  MixFormat = EffectPack::GetMixFormat(v69[1], v24, &v71, (struct tWAVEFORMATEX **)v72.Data4);
  wil::details::out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>::~out_param_t<wistd::unique_ptr<_GUID,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>>((__int64)&v72);
  if ( MixFormat < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
...
LABEL_35:
    ...
    if ( (_QWORD)v59 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
        (__int64 *)v59,
        *((__int64 **)&v59 + 1));
      std::_Deallocate<16>((void *)v59, (struct std::nothrow_t *)((v60 - v59) & 0xFFFFFFFFFFFFFFF8uLL));
      v60 = 0LL;
      v59 = 0LL;
    }
...
LABEL_53:
  ...
  v55 = *((_DWORD *)Src + 1);
  if ( v55 != nSamplesPerSec )
    *a5 = TranslateFrameCountBetweenSamplingRates(*a5, nSamplesPerSec, v55);
