/*
 * XREFs of _dynamic_initializer_for__s_validSettingsForSchema__ @ 0x1800085A0
 * Callers:
 *     <none>
 * Callees:
...
int dynamic_initializer_for__s_validSettingsForSchema__()
{
  ...
  v1 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits>(size_of);
  *v1 = v1;
  v1[1] = v1;
  qword_1801D7DC8 = (__int64)v1;
  qword_1801D7DD8 = 0LL;
  xmmword_1801D7DE0 = 0LL;
  qword_1801D7DF0 = 7LL;
  qword_1801D7DF8 = 8LL;
  dword_1801D7DC0 = 1065353216;
