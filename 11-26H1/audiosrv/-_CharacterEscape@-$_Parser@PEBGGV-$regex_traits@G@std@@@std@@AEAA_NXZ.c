/*
 * XREFs of ?_CharacterEscape@?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@AEAA_NXZ @ 0x18014C79C
 * Callers:
 ...
 *     ?_IsIdentityEscape@?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@AEBA_NXZ @ 0x18014D828 (-_IsIdentityEscape@-$_Parser@PEBGGV-$regex_traits@G@std@@@std@@AEBA_NXZ.c)
