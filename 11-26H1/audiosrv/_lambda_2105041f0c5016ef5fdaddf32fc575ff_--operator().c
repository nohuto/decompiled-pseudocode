/*
 * XREFs of _lambda_2105041f0c5016ef5fdaddf32fc575ff_::operator() @ 0x1801357F0
 * Callers:
 ...
 *     ?StringCbCatW@@YAJPEAG_KPEBG@Z @ 0x180072198 (-StringCbCatW@@YAJPEAG_KPEBG@Z.c)
 *     __security_check_cookie @ 0x1800B1FF0 (__security_check_cookie.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x18016E010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

// Hidden C++ exception states: #wind=15
__int64 __fastcall lambda_2105041f0c5016ef5fdaddf32fc575ff_::operator()(_BYTE **a1)
{
  int v2; // ebx
  __int64 v3; // rax
  __int64 v4; // rbx
