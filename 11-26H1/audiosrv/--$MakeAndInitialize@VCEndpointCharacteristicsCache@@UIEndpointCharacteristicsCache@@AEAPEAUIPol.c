 ...
 *     ?RuntimeClassInitialize@CEndpointCharacteristicsCache@@QEAAJPEAUIPolicyConfigInternal@@PEAVEffectPackConfigurationManager@@PEAUIEndpointResourceManagerProvider@@PEBU_tlgProvider_t@@@Z @ 0x18013CC38 (-RuntimeClassInitialize@CEndpointCharacteristicsCache@@QEAAJPEAUIPolicyConfigInternal@@PEAVEffec.c)
