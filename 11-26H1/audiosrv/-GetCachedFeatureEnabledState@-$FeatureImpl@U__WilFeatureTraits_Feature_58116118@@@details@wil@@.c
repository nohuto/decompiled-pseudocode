/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_58116118@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800D87D8
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  *(_DWORD *)a2 = v2;
  if ( (v2 & 6) != 6 )
  {
    ...
    v14 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_58116118>::GetCurrentFeatureEnabledState(v7, &v15, &v14);
    v8 = *(_DWORD *)a2;
    v9 = v15;
    do
    {
