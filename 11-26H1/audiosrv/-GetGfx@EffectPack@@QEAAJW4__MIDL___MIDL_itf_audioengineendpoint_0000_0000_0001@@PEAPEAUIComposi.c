/*
 * XREFs of ?GetGfx@EffectPack@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUICompositeSystemEffect@@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x18007DA3C
 * Callers:
        ...
        struct IAudioProcessingObject **a4)
{
  ...
  if ( a4 )
    *a4 = 0LL;
  if ( a2 == 3 || (unsigned int)EffectPack::EndpointConnectorSupportsProcessingModes(this, a2, (__int64)a3) )
    return 0LL;
  ...
  v11 = v8;
  v9 = gsl::span<SystemEffectDescriptor,-1>::operator[]((unsigned __int64 *)this + 182, v4);
  return EffectPack::GetInitializedSystemEffectInterface(this, v9, 2LL, 1LL, &v11, 0, 0, v4, a3, a4, 0LL);
}
