/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapSz@G@@U2@U?$_tlgWrapperByRef@$0BA@@@U_tlgWrapperPtrSize@@U4@U4@U4@U4@U4@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapSz@G@@4AEBU?$_tlgWrapperByRef@$0BA@@@AEBU_tlgWrapperPtrSize@@66666@Z @ 0x1800059B4
 * Callers:
        ...
        __int64 *a14)
{
  ...
  const wchar_t *v26; // [rsp+60h] [rbp-99h]
  int v27; // [rsp+68h] [rbp-91h]
  int v28; // [rsp+6Ch] [rbp-8Dh]
  const wchar_t *v29; // [rsp+70h] [rbp-89h]
