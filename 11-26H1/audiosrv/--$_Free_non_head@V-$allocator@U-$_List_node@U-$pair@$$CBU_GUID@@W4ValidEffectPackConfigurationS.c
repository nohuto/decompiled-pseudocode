        ...
        _QWORD **a2)
{
  ...
  *a2[1] = 0LL;
  ...
  if ( *a2 )
  {
    ...
    {
      v3 = (_QWORD *)*v2;
      std::_Deallocate<16>(v2, (struct std::nothrow_t *)0x28);
      v2 = v3;
    }
    while ( v3 );
  }
