/*
 * XREFs of ?RuntimeClassInitialize@CVirtualAudioStream@@QEAAJPEAUIAudioProcess@@KPEBGW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x18011751C
 * Callers:
        ...
        enum __MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001 a5)
{
  ...
  const wchar_t *v19; // [rsp+78h] [rbp+20h] BYREF
