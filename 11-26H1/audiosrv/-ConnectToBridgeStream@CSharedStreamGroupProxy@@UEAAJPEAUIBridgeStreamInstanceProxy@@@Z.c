/*
 * XREFs of ?ConnectToBridgeStream@CSharedStreamGroupProxy@@UEAAJPEAUIBridgeStreamInstanceProxy@@@Z @ 0x1800FAA10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSharedStreamGroupProxy::ConnectToBridgeStream(
        ...
        struct IBridgeStreamInstanceProxy *a2)
{
  ...
  v7 = *(__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))(this + 104);
  v8 = *v7;
  v17 = 0LL;
...
LABEL_5:
  ...
  CPerfTracker::CPerfTracker(
    ...
    *((const struct _tlgProvider_t **)v10 + 1),
    "StreamGroup_ConnectToBridgeStream",
    0LL);
  v11 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v18 + 72LL))(v18, v17);
  v6 = v11;
  if ( v11 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
