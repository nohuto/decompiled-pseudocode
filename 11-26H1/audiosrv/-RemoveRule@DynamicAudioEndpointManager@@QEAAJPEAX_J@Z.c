/*
 * XREFs of ?RemoveRule@DynamicAudioEndpointManager@@QEAAJPEAX_J@Z @ 0x18012B560
 * Callers:
 *     PolicyConfigRemoveDynamicRoutingRule @ 0x18010D9C0 (PolicyConfigRemoveDynamicRoutingRule.c)
 * Callees:
