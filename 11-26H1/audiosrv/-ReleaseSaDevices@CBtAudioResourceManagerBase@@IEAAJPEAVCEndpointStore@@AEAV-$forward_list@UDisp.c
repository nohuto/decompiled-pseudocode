/*
 * XREFs of ?ReleaseSaDevices@CBtAudioResourceManagerBase@@IEAAJPEAVCEndpointStore@@AEAV?$forward_list@UDisplacedStreamGroup@@V?$allocator@UDisplacedStreamGroup@@@std@@@std@@@Z @ 0x1800E5F00
 * Callers:
  ...
  *(_OWORD *)v47 = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( *(_QWORD *)v47 != *(_QWORD *)&v47[2] )
    {
      do
      {
        if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)*v12 + 96LL))(*v12) == 1 )
    ...
    if ( v12 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v12, v13);
      std::_Deallocate<16>(*(void **)v47, (struct std::nothrow_t *)((v48 - *(_QWORD *)v47) & 0xFFFFFFFFFFFFFFF8uLL));
    }
      ...
      if ( v15 < 0 )
      {
        ...
        if ( v21 )
        {
          do
          {
            ...
            std::_Deallocate<16>(v21, (struct std::nothrow_t *)0x10);
            v21 = v22;
          }
          while ( v22 );
        }
        ...
        if ( v23 )
        {
          do
          {
            ...
            std::_Deallocate<16>(v23, (struct std::nothrow_t *)0x10);
            v23 = v24;
          }
          while ( v24 );
        }
      ...
      while ( v28 != v29 )
      {
        ...
        if ( (v6 & 0x80000000) != 0 )
        {
          ...
          if ( *(_QWORD *)v47 )
          {
            ...
            std::_Deallocate<16>(
              *(void **)v47,
              (struct std::nothrow_t *)((v48 - *(_QWORD *)v47) & 0xFFFFFFFFFFFFFFF8uLL));
            *(_OWORD *)v47 = 0LL;
            v48 = 0LL;
          }
          v39 = v58;
        ...
        if ( v32 < 0 )
        {
          ...
          if ( v35 )
          {
            do
            {
              ...
              std::_Deallocate<16>(v35, (struct std::nothrow_t *)0x10);
              v35 = v36;
            }
            while ( v36 );
          }
          ...
          if ( v37 )
          {
            do
            {
              ...
              std::_Deallocate<16>(v37, (struct std::nothrow_t *)0x10);
              v37 = v38;
            }
            while ( v38 );
          }
    ...
    if ( v43 )
    {
      do
      {
        ...
        std::_Deallocate<16>(v43, (struct std::nothrow_t *)0x10);
        v43 = v44;
      }
      while ( v44 );
    }
    ...
    if ( v45 )
    {
      do
      {
        ...
        std::_Deallocate<16>(v45, (struct std::nothrow_t *)0x10);
        v45 = v46;
      }
      while ( v46 );
    }
  ...
  else
  {
    ...
    if ( v7 )
    {
      do
      {
        ...
        std::_Deallocate<16>(v7, (struct std::nothrow_t *)0x10);
        v7 = v8;
      }
      while ( v8 );
    }
    ...
    if ( v9 )
    {
      do
      {
        ...
        std::_Deallocate<16>(v9, (struct std::nothrow_t *)0x10);
        v9 = v10;
      }
      while ( v10 );
    }
