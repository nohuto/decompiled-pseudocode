/*
 * XREFs of AudioSessionGetProcessId @ 0x18006D390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetProcessId(__int64 *a1, __int64 a2)
{
  ...
  v12 = L"AudioSessionGetProcessId";
  v14 = 0;
  v15 = 0LL;
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 136LL))(v2, a2);
  v8 = v7;
  if ( v7 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetProcessId", 1618, v7);
