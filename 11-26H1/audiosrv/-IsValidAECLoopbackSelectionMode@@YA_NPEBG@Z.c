/*
 * XREFs of ?IsValidAECLoopbackSelectionMode@@YA_NPEBG@Z @ 0x1800FE740
 * Callers:
...
char __fastcall IsValidAECLoopbackSelectionMode(unsigned __int16 *a1)
{
  char v1; // bl
  char v2; // di
  __int64 v3; // rcx
  ...
  void *v10[4]; // [rsp+40h] [rbp-38h] BYREF

  v1 = 0;
  v2 = 0;
  if ( a1 )
  {
    std::wstring::wstring((char **)v10, a1);
    v2 = 1;
