/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_53100197@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800DA150
 * Callers:
...
_UNKNOWN **wil::details::FeatureImpl<__WilFeatureTraits_Feature_53100197>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_53100197>::GetCachedFeatureEnabledState(a1, &v7);
    v7 = v3;
  }
  WORD2(v8) = 2;
  LODWORD(v8) = 0;
