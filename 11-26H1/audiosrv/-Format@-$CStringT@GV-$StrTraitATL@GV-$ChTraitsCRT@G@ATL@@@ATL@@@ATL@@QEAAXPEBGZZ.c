/*
 * XREFs of ?Format@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAXPEBGZZ @ 0x180017E20
 * Callers:
        ...
        ...)
{
  ...
  wchar_t *Format[10]; // [rsp+28h] [rbp-50h] BYREF
  ...
  v17 = *(_DWORD *)(v13 + 8);
  v14 = a2 - v9;
  v15 = *(_DWORD *)(v13 + 12) - v8;
  v16 = v15 | (unsigned int)(1 - *((_DWORD *)v9 - 2));
  if ( (v15 | (1 - *((_DWORD *)v9 - 2))) < 0 )
  {
