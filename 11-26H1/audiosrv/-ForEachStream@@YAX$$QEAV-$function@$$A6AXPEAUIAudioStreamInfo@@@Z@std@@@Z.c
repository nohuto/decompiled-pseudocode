/*
 * XREFs of ?ForEachStream@@YAX$$QEAV?$function@$$A6AXPEAUIAudioStreamInfo@@@Z@std@@@Z @ 0x18011177C
 * Callers:
 ...
 *     ??R?$_Func_class@XPEAUIAudioStreamInfo@@@std@@QEBAXPEAUIAudioStreamInfo@@@Z @ 0x18007ECA0 (--R-$_Func_class@XPEAUIAudioStreamInfo@@@std@@QEBAXPEAUIAudioStreamInfo@@@Z.c)
 */
  ...
  if ( g_VADServerList )
  {
    do
    {
      v3 = (struct _RTL_CRITICAL_SECTION *)*ATL::CAtlList<CVADServer *,ATL::CElementTraits<CVADServer *>>::GetNext(
                                              ...
                                              &v7);
      v6 = 0LL;
      if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>(&v3[13].SpinCount, &v6) >= 0 && v6 )
      {
