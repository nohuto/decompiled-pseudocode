/*
 * XREFs of ?IsInputFormatSupported@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x180063060
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioMediaType **a4)
{
  ...
  signed int v56; // [rsp+118h] [rbp+6Fh] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( v8 < 0 || v8 >= *((_DWORD *)v6 + 28) )
    {
      ...
      JUMPOUT(0x18006361BLL);
    }
    _mm_lfence();
    v16 = *(_QWORD *)(*((_QWORD *)v6 + 13) + 8LL * v56);
