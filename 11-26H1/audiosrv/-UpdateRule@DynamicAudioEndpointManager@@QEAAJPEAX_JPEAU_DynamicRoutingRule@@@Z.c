/*
 * XREFs of ?UpdateRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18012BD4C
 * Callers:
 *     PolicyConfigUpdateDynamicRoutingRule @ 0x18010E460 (PolicyConfigUpdateDynamicRoutingRule.c)
 * Callees:
