/*
 * XREFs of ?RuntimeClassInitialize@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@QEAAJPEAUIMMDevice@@PEAUIControlChangeNotify@@@Z @ 0x1800DDE30
 * Callers:
        ...
        __int64 a3)
{
  ...
  struct IControlChangeNotify *v23; // [rsp+38h] [rbp-80h]
  char v24; // [rsp+40h] [rbp-78h]
  PROPVARIANT pvar[2]; // [rsp+48h] [rbp-70h] BYREF
  __int64 v26; // [rsp+58h] [rbp-60h]
  void **v27; // [rsp+60h] [rbp-58h] BYREF
  struct IControlChangeNotify *v28; // [rsp+68h] [rbp-50h]
  __int128 v29; // [rsp+70h] [rbp-48h]
  void ***v30; // [rsp+98h] [rbp-20h]
  wil::details::in1diag3 *retaddr; // [rsp+B8h] [rbp+0h]
  struct IControlChangeNotifyVtbl *v32; // [rsp+C0h] [rbp+8h] BYREF
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  lpVtbl = a2->lpVtbl;
  v34 = 0LL;
  v7 = ((__int64 (__fastcall *)(struct IMMDevice *, _QWORD, __int64 *))lpVtbl->OpenPropertyStore)(a2, 0LL, &v34);
  if ( v7 < 0 )
    wil::details::in1diag3::_Throw_Hr(
      ...
      v21);
  v8 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v34 + 40LL))(
         v34,
  ...
  if ( (int)BluetoothControls::TryGetResourceManager((unsigned __int16 *)&a1[6]) >= 0 )
  {
    ...
    if ( IsEnabled )
    {
      std::shared_ptr<std::wstring>::shared_ptr<std::wstring>(&v22, v11);
      v27 = &std::_Func_impl_no_alloc<_lambda_69d42108dd5c64e5ae696b969e6cde78_,void,>::`vftable';
      v28 = a1;
      v29 = v22;
      v22 = 0LL;
      v30 = &v27;
    ...
    {
      std::shared_ptr<std::wstring>::shared_ptr<std::wstring>(&v22, v11);
      v27 = &std::_Func_impl_no_alloc<_lambda_a5707e8136b0bf7dfeec04d35a40fcb5_,void,bool>::`vftable';
      v28 = a1;
      v29 = v22;
      v22 = 0LL;
      v30 = &v27;
  ...
  if ( LOWORD(pvar[0]) == 31 )
  {
    v32 = (struct IControlChangeNotifyVtbl *)a1;
    wil::com_ptr_t<IMMDevice,wil::err_returncode_policy>::reset((__int64 *)&a1[13]);
    v18 = Microsoft::WRL::Details::MakeAndInitialize<BluetoothControls::BluetoothVolume,BluetoothControls::BluetoothVolume,unsigned short * &,BluetoothControls::BluetoothVolume *,IControlChangeNotify * &>((struct IControlChangeNotify **)&a1[13]);
    if ( v18 < 0 )
      wil::details::in1diag3::_Throw_Hr(
        retaddr,
        212LL,
