/*
 * XREFs of ?DiscoverProcessingModeCharacteristics@CEndpointCharacteristics@@AEAAJXZ @ 0x18013898C
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::DiscoverProcessingModeCharacteristics(CEndpointCharacteristics *this)
{
  ...
  const wchar_t *v20; // [rsp+70h] [rbp-90h] BYREF
  ...
  LARGE_INTEGER v25; // [rsp+98h] [rbp-68h] BYREF
