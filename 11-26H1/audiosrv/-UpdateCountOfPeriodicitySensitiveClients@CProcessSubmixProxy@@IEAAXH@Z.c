/*
 * XREFs of ?UpdateCountOfPeriodicitySensitiveClients@CProcessSubmixProxy@@IEAAXH@Z @ 0x180078C18
 * Callers:
...
void __fastcall CProcessSubmixProxy::UpdateCountOfPeriodicitySensitiveClients(__int64 this, int a2)
{
  ...
  *(_DWORD *)(this + 96) = v3 + a2;
  if ( v3 != v3 + a2 && (!v3 || !(v3 + a2)) )
    (*(void (__fastcall **)(_QWORD, __int64, __int64))(**(_QWORD **)(this + 200) + 328LL))(
      *(_QWORD *)(this + 200),
