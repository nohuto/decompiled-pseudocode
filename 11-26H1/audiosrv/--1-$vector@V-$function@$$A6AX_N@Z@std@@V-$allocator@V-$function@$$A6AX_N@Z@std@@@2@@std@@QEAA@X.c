/*
 * XREFs of ??1?$vector@V?$function@$$A6AX_N@Z@std@@V?$allocator@V?$function@$$A6AX_N@Z@std@@@2@@std@@QEAA@XZ @ 0x1800E0498
 * Callers:
 *     _CBtAudioResourceManagerBase::NotifyStreamChange_::_1_::dtor$0 @ 0x180168C8D (_CBtAudioResourceManagerBase--NotifyStreamChange_--_1_--dtor$0.c)
 * Callees:
