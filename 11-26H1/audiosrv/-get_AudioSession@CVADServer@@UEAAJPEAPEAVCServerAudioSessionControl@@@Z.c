/*
 * XREFs of ?get_AudioSession@CVADServer@@UEAAJPEAPEAVCServerAudioSessionControl@@@Z @ 0x180051130
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CServerAudioSessionControl **a2)
{
  ...
  __int64 v7; // r8
  CServerAudioSessionControl **v9; // [rsp+20h] [rbp-18h]
  ...
  if ( LODWORD(this[4].DebugInfo) )
  {
    ...
    if ( !this[3].OwningThread )
    {
      ...
      if ( !*p_OwningThread )
      {
        LOBYTE(v7) = 1;
        v9 = p_OwningThread;
        v2 = (***(__int64 (__fastcall ****)(_QWORD, _QWORD, __int64, HANDLE))&this[3].LockCount)(
      ...
      if ( v2 )
      {
        ...
        {
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 15LL, &WPP_55a927f0784e38de47faa537a644ca17_Traceguids, v2, v9);
        }
        goto LABEL_12;
      }
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
...
LABEL_12:
    if ( (v2 & 0x80000000) == 0 )
      return v2;
LABEL_26:
    AudSrvTraceLoggingErrorHelper("CVADServer::get_AudioSession", 1321, v2);
    return v2;
  }
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x100) != 0
