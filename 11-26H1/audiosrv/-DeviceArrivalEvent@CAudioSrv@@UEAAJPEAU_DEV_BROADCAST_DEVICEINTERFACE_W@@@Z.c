/*
 * XREFs of ?DeviceArrivalEvent@CAudioSrv@@UEAAJPEAU_DEV_BROADCAST_DEVICEINTERFACE_W@@@Z @ 0x180078E70
 * Callers:
 *     <none>
 * Callees:
 *     ?KsNotifications_AudioInterfaceArrival@@YAXPEBG@Z @ 0x180078EE0 (-KsNotifications_AudioInterfaceArrival@@YAXPEBG@Z.c)
 *     ?MME_AudioInterfaceArrival@@YAJPEBG@Z @ 0x180079024 (-MME_AudioInterfaceArrival@@YAJPEBG@Z.c)
 */
