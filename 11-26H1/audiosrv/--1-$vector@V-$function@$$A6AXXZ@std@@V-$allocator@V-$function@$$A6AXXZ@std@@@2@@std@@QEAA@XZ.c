/*
 * XREFs of ??1?$vector@V?$function@$$A6AXXZ@std@@V?$allocator@V?$function@$$A6AXXZ@std@@@2@@std@@QEAA@XZ @ 0x1800E0444
 * Callers:
 *     _CBtAudioResourceManagerBase::NotifyBidirectionalModeChanged_::_1_::dtor$0 @ 0x180168C69 (_CBtAudioResourceManagerBase--NotifyBidirectionalModeChanged_--_1_--dtor$0.c)
 * Callees:
