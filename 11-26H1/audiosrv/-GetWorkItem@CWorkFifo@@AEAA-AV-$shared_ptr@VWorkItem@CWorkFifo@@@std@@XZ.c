/*
 * XREFs of ?GetWorkItem@CWorkFifo@@AEAA?AV?$shared_ptr@VWorkItem@CWorkFifo@@@std@@XZ @ 0x180085F98
 * Callers:
...
_QWORD *__fastcall CWorkFifo::GetWorkItem(_QWORD *a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( !std::_Atomic_storage<bool,1>::load((__int64)(a1 + 17))
    && !std::_Atomic_storage<bool,1>::load((__int64)a1 + 137)
    && a1[16] )
  {
