/*
 * XREFs of _lambda_b274b6433de22a39075f813592169777_::operator() @ 0x180136E4C
 * Callers:
 *     wil::details::lambda_call__lambda_b274b6433de22a39075f813592169777___::_lambda_call__lambda_b274b6433de22a39075f813592169777___ @ 0x180135338 (wil--details--lambda_call__lambda_b274b6433de22a39075f813592169777___--_lambda_call__lambda_b274.c)
 * Callees:
...
void __fastcall lambda_b274b6433de22a39075f813592169777_::operator()(__int64 a1)
{
  __int64 v1; // r8
  __int64 v2; // r9
  __int64 v3; // r10
  ...
  const wchar_t *v10; // [rsp+70h] [rbp+37h] BYREF
  ...
  if ( **(_DWORD **)(*(_QWORD *)a1 + 2120LL) > 2u && tlgKeywordOn(*(_QWORD *)(*(_QWORD *)a1 + 2120LL), 16LL) )
  {
    ...
    v9 = &v11;
    v11 = v5;
    v10 = *(const wchar_t **)(*(_QWORD *)(v3 + 1584) + 48LL);
