/*
 * XREFs of ?SetPropertyValue@SpatialAudioIO@@IEAAJU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x180130D24
 * Callers:
 *     ?Store@SpatialAudioStateIO@@IEAAJXZ @ 0x180130D74 (-Store@SpatialAudioStateIO@@IEAAJXZ.c)
 *     ?SignalChange@SpatialAudioDeviceStateWriter@@UEAAJXZ @ 0x1801600D0 (-SignalChange@SpatialAudioDeviceStateWriter@@UEAAJXZ.c)
 * Callees:
