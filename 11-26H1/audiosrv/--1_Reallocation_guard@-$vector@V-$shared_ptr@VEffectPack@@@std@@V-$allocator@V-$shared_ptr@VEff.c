/*
 * XREFs of ??1_Reallocation_guard@?$vector@V?$shared_ptr@VEffectPack@@@std@@V?$allocator@V?$shared_ptr@VEffectPack@@@std@@@2@@std@@QEAA@XZ @ 0x1801032C0
 * Callers:
...
void __fastcall std::vector<std::shared_ptr<EffectPack>>::_Reallocation_guard::~_Reallocation_guard(__int64 a1)
{
  if ( *(_QWORD *)(a1 + 8) )
  {
    std::_Destroy_range<std::allocator<std::shared_ptr<EffectPack>>>(*(_QWORD *)(a1 + 24), *(_QWORD *)(a1 + 32));
