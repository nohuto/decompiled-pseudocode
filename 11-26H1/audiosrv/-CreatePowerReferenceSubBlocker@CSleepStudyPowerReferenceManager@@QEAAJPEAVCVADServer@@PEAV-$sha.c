/*
 * XREFs of ?CreatePowerReferenceSubBlocker@CSleepStudyPowerReferenceManager@@QEAAJPEAVCVADServer@@PEAV?$shared_ptr@VCSleepStudyPowerReference@@@std@@@Z @ 0x18001251C
 * Callers:
 ...
 *     ??$make_shared@VCSleepStudyPowerReference@@$$V@std@@YA?AV?$shared_ptr@VCSleepStudyPowerReference@@@0@XZ @ 0x1800711E4 (--$make_shared@VCSleepStudyPowerReference@@$$V@std@@YA-AV-$shared_ptr@VCSleepStudyPowerReference.c)
