/*
 * XREFs of _CCompositeSystemEffect::GetPreferredFormat_::_1_::dtor$0 @ 0x18016533B
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CCompositeSystemEffect::GetPreferredFormat_::_1_::dtor_0(__int64 a1, __int64 a2)
{
