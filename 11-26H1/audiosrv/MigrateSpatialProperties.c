/*
 * XREFs of MigrateSpatialProperties @ 0x18007A220
 * Callers:
...
char __fastcall MigrateSpatialProperties(_DWORD *a1, __int64 a2, const wchar_t *a3)
{
  char v6; // r15
  char v7; // r14
  char v8; // r13
