/*
 * XREFs of ??R?$default_delete@U_RecurringTask@@@std@@QEBAXPEAU_RecurringTask@@@Z @ 0x18001C238
 * Callers:
 ...
 *     ??1?$unique_ptr@U_RecurringTask@@U?$default_delete@U_RecurringTask@@@std@@@std@@QEAA@XZ @ 0x18007E648 (--1-$unique_ptr@U_RecurringTask@@U-$default_delete@U_RecurringTask@@@std@@@std@@QEAA@XZ.c)
 ...
 *     _dynamic_atexit_destructor_for__g_PoTimerCookie__ @ 0x18016CFB0 (_dynamic_atexit_destructor_for__g_PoTimerCookie__.c)
 * Callees:
