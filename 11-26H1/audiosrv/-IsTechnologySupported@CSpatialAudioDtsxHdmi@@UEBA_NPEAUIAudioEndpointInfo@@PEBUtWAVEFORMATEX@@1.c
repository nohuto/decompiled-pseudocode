/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDtsxHdmi@@UEBA_NPEAUIAudioEndpointInfo@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1801483C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct WAVEFORMATEXTENSIBLE *a8)
{
  ...
  __int64 v12; // rcx
  int v13; // eax
  struct _GUID v15; // [rsp+40h] [rbp-20h] BYREF
