/*
 * XREFs of ?RemoveClientReference@CAudioSession@@UEAAJ_N@Z @ 0x18001B240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::RemoveClientReference(CAudioSession *this, char a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)this + 82, 0xFFFFFFFF) == 1 )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 60LL, &WPP_ee85f21a7da73824226bb42893b0f656_Traceguids);
    }
LABEL_7:
    if ( this )
    ...
    *v10 = 0LL;
    ...
    if ( v13 )
    {
      ...
      *(_QWORD *)v13 = &std::_Ref_count_obj2<std::function<long (SystemEffectDescriptor *,SystemEffectChainDescriptor *)>>::`vftable';
      std::function<void (IAudioStreamInfo *)>::function<void (IAudioStreamInfo *)>(v13 + 4, v27);
    }
    else
    {
      v15 = 0LL;
...
LABEL_40:
  ...
  {
    v24 = *((_DWORD *)this + 82);
    WPP_SF_qdd(*((_QWORD *)WPP_GLOBAL_Control + 2), 61LL, &WPP_ee85f21a7da73824226bb42893b0f656_Traceguids, this);
  }
  if ( v3 )
    goto LABEL_7;
  return 0LL;
