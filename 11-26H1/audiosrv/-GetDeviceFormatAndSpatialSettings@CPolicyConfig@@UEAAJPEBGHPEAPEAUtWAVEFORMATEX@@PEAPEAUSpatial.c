/*
 * XREFs of ?GetDeviceFormatAndSpatialSettings@CPolicyConfig@@UEAAJPEBGHPEAPEAUtWAVEFORMATEX@@PEAPEAUSpatialAudioSettings@@PEAIPEAPEAUSpatialAudioEncoderDescriptor@@@Z @ 0x18010BB40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SpatialAudioEncoderDescriptor **a7)
{
  ...
  DeviceFormatHelper = CPolicyConfig::GetDeviceFormatHelper(this, a2, 0, a3, a4, a5, a6, a7);
