/*
 * XREFs of ?IsOutputFormatSupported@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x18014F7A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$ComPtr@UIAudioMediaType@@@WRL@Microsoft@@QEAAAEAV012@AEBV012@@Z @ 0x1800775B8 (--4-$ComPtr@UIAudioMediaType@@@WRL@Microsoft@@QEAAAEAV012@AEBV012@@Z.c)
        ...
        struct IAudioMediaType **a4)
{
  ...
  _QWORD v43[5]; // [rsp+78h] [rbp-21h] BYREF
    ...
    *(_QWORD *)&v41[1] = 0LL;
    ...
    if ( v20 == -2005073917 )
    {
      ...
      if ( !IsFixedFormatApo(*v22) )
      {
        ...
        {
          v44 = 0;
          lambda_d9c18f6fc2a9815de9706b623d63d839_::operator()((__int64)v43);
        }
        goto LABEL_47;
      }
      v37 = 0LL;
