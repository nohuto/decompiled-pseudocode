/*
 * XREFs of ?InitializeAPOs@?$BluetoothControl@VIMuteControlHandler@@VBluetoothMute@BluetoothControls@@@BluetoothControls@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x1800DD0C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      a1,
                      v9);
  LODWORD(a4) = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64))(*(_QWORD *)*TargetedControl + 80LL))(
                  *TargetedControl,
                  a2,
                  a3,
                  a4);
