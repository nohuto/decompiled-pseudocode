/*
 * XREFs of ??$MakeAndInitialize@VCAudioRenderEndpointChangeDelegator@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCAudioRenderEndpointChangeDelegator@@@Z @ 0x1800C2D98
 * Callers:
