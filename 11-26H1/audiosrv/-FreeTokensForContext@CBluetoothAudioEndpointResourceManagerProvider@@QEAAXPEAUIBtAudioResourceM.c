/*
 * XREFs of ?FreeTokensForContext@CBluetoothAudioEndpointResourceManagerProvider@@QEAAXPEAUIBtAudioResourceManager@@AEBVTokenEnumerator@?$TokenManager@VCBluetoothAudioEndpointResourceManagerProvider@@@@@Z @ 0x1800F7904
 * Callers:
 ...
 * Callees:
 *     ??$Write@U?$_tlgWrapperByRef@$0BA@@@U?$_tlgWrapSz@G@@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByRef@$0BA@@@AEBU?$_tlgWrapSz@G@@4@Z @ 0x180003430 (--$Write@U-$_tlgWrapperByRef@$0BA@@@U-$_tlgWrapSz@G@@U2@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvi.c)
        ...
        __int64 a3)
{
  ...
  const wchar_t *v14; // [rsp+68h] [rbp+2Fh] BYREF
  ...
  if ( v10 )
  {
    ...
    if ( *v6 > 4u && tlgKeywordOn(*((_QWORD *)v5 + 1), 0x4000LL) )
    {
      ...
      v14 = (const wchar_t *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v10 + 88LL))(v10);
