/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_2d57628cd8490ef0d12835f9ba011710___ @ 0x18007B8C8
 * Callers:
        ...
        __int64 a4)
{
    ...
    else
    {
      ...
      else
      {
        *(_OWORD *)pvar = 0LL;
        ...
        v7 = (char *)&unk_1801967D0;
        if ( !v13 )
          v7 = (char *)&unk_180196770;
      }
      v8 = 8LL;
    }
  }
  ...
  while ( v14 < v8 )
  {
    ...
    for ( i = 0; i < v6; ++i )
    {
      ...
      *(_WORD *)(v19 + 16) = 22;
      LOBYTE(v23) = 0;
      result = lambda_2d57628cd8490ef0d12835f9ba011710_::operator()(v30, v19, &v23);
      if ( (int)result < 0 )
        return result;
      if ( (_BYTE)v23 )
        return 0LL;
