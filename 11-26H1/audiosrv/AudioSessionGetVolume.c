/*
 * XREFs of AudioSessionGetVolume @ 0x180056960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetVolume(__int64 *a1, __int64 a2)
{
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 288LL))(v2, a2);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetVolume", 2033, v8);
