/*
 * XREFs of ?AcquirePowerReference@CVADServer@@QEAAXXZ @ 0x18005A6BC
 * Callers:
...
void __fastcall CVADServer::AcquirePowerReference(struct _RTL_CRITICAL_SECTION *this)
{
  ...
  {
    CPowerReferenceManager::AcquirePowerReferenceForStream(g_powerReferenceManager, &v6, (__int64)this);
    v3 = v6;
    v4 = v7;
    v6 = 0LL;
    v7 = 0LL;
