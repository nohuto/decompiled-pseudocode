/*
 * XREFs of ?UseSupportedConnectorMode@@YAJPEAUEndpointCharacteristicsDescriptor@@KW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@HAEA_N@Z @ 0x18007BF48
 * Callers:
        ...
        bool *a6)
{
  ...
  v29 = *a4;
  if ( (unsigned int)EffectPack::IsConnectorModeSupported(a1[1], a3, 0LL, &v29) )
  {
    *a6 = 1;
      ...
      if ( v16 < 0 )
      {
        ...
        if ( (_QWORD)v24 )
        {
          std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
            (__int64 *)v24,
            *((__int64 **)&v24 + 1));
          std::_Deallocate<16>((void *)v24, (struct std::nothrow_t *)((v25 - v24) & 0xFFFFFFFFFFFFFFF8uLL));
          v24 = 0LL;
          v25 = 0LL;
        }
      ...
      *(_QWORD *)v27.Data4 = a4;
      ...
      if ( !v22 )
      {
        ...
        if ( EffectPack::IsConnectorModeSupportedForSWAPOFallback(a1[1], a3, &v27) )
        {
          ...
          if ( v19 <= 1
            || (v27 = *a4,
                !(unsigned int)AreResourcesAvailableForStream(
