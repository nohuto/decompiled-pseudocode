/*
 * XREFs of ??$_Eqrange@U_GUID@@@?$_Tree@V?$_Tmap_traits@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@$0A@@std@@@std@@IEBA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@PEAX@std@@PEAU12@@1@AEBU_GUID@@@Z @ 0x180150154
 * Callers:
        ...
        __int128 *a3)
{
  ...
  if ( !*((_BYTE *)v7 + 25) )
  {
    ...
    {
      v15 = *((_OWORD *)v7 + 2);
      v10 = memcmp_0(&Buf1, &v15, 0x10uLL) < 0;
      v11 = (__int64 **)v7;
      if ( !v10 )
        v11 = v6;
      v6 = v11;
