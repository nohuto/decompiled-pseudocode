...
__int64 __fastcall lambda_a5ab363fcb9b7ea3ea21f546eba5c54f_::operator()(AtmosCheck **a1, __int64 a2, __int64 a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v6 >= 0 && (_BYTE)v14 && !v15 )
    {
      ...
      if ( (v8(a3, &v16) < 0 || AtmosCheck::IsUsefulPackage(v9, v16)) && AtmosCheck::IsLicenseEvaluationRequired(*a1) )
      {
        *((_DWORD *)*a1 + 46) = 4;
        v13 = 0;
