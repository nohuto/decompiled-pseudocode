/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00UIWeakReferenceSource@@UIInspectable@@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x18005E200
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( a2[1] != *(_DWORD *)&GUID_00000038_0000_0000_c000_000000000046.Data2
