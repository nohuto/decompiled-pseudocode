/*
 * XREFs of ?UpdatePMPOnStreamGroup@CSharedStreamGroupProxy@@UEAAJAEBVCProcessingModeParameters@@@Z @ 0x180100300
 * Callers:
 *     <none>
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapSz@G@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapSz@G@@3@Z @ 0x1800036EC (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapSz@G@@U1@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvide.c)
        ...
        const struct CProcessingModeParameters *a2)
{
  ...
  wchar_t *v15; // [rsp+80h] [rbp+40h] BYREF
  ...
  if ( *(_QWORD *)(this + 296) == *(_QWORD *)(this + 288) )
  {
    ...
    if ( v10 >= 0 )
    {
      CProcessingModeParameters::operator=(v2, (char **)a2);
      if ( (_DWORD)v14 != 1 )
      {
