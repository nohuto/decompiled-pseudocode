/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIEndpointResourceManagerProvider@@UIBluetoothResourceArbitrator@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800D7910
 * Callers:
 *     <none>
 * Callees:
