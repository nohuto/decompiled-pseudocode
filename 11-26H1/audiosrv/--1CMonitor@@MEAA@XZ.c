/*
 * XREFs of ??1CMonitor@@MEAA@XZ @ 0x180120D54
 * Callers:
 ...
 *     ??1?$CComPtrBase@VCMonitorNotification@CMonitor@@@ATL@@QEAA@XZ @ 0x18011BA4C (--1-$CComPtrBase@VCMonitorNotification@CMonitor@@@ATL@@QEAA@XZ.c)
 */
