/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioMetadataDictionary@@QEAAJAEBU_GUID@@GPEBGPEAEI@Z @ 0x180131990
 * Callers:
        ...
        size_t Size)
{
  ...
  const wchar_t *v26; // [rsp+48h] [rbp-18h] BYREF
  ...
  if ( Src )
  {
    if ( (Size & 1) != 0 )
    {
      ...
      v12 = (unsigned __int8 *)&unk_1801AA68B;
      LODWORD(v25) = 134;
      goto LABEL_19;
    }
  ...
  else
  {
    ...
    if ( Dictionary < 0 )
    {
      ...
      v12 = (unsigned __int8 *)&unk_1801AA5C3;
      LODWORD(v25) = 147;
LABEL_19:
      v26 = (const wchar_t *)"SpatialAudioMetadataDictionary::RuntimeClassInitialize";
