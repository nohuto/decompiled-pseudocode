/*
 * XREFs of ?Initialize@CMuteHardware@@QEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x180085938
 * Callers:
...
__int64 __fastcall CMuteHardware::Initialize(CMuteHardware *this, struct IMMDevice *a2, struct IPartsList *a3)
{
  ...
  else
  {
    ...
    {
LABEL_7:
      AudSrvTraceLoggingErrorHelper("CMuteHardware::Initialize", 500, MuteControlForEndpoint);
