/*
 * XREFs of ?StopStream@CStreamInstanceProxyImpl@@IEAAJXZ @ 0x180020794
 * Callers:
 *     ?StopStream@CBridgeStreamInstanceProxy@@UEAAJXZ @ 0x18007F990 (-StopStream@CBridgeStreamInstanceProxy@@UEAAJXZ.c)
 * Callees:
...
__int64 __fastcall CStreamInstanceProxyImpl::StopStream(CStreamInstanceProxyImpl *this)
{
  ...
  cbDest[1] = v2;
  StringCchPrintfExA(pszDest, 0x40uLL, &v11, cbDest, 0, "%s", "StreamInstance_Stop");
