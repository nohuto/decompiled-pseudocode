...
{
  __int64 v14; // rcx
  _BYTE v16[32]; // [rsp+30h] [rbp-C9h] BYREF
  ...
  v20 = 16LL;
  v18 = 8LL;
  return tlgWriteTransfer_EventWriteTransfer(&dword_1801D32B0, a2, 0LL, 0LL, 12, v16);
}
