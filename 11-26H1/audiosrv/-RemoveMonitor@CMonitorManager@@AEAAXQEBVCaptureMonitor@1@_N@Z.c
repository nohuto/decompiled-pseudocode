/*
 * XREFs of ?RemoveMonitor@CMonitorManager@@AEAAXQEBVCaptureMonitor@1@_N@Z @ 0x18011FB6C
 * Callers:
...
void __fastcall CMonitorManager::RemoveMonitor(CMonitorManager *this, CMonitorManager::CaptureMonitor *a2, char a3)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Cu, (__int64)&WPP_72c9fd82aa603dc17c55ee7407a1fef9_Traceguids);
  }
  if ( *((_QWORD *)this + 16) )
  {
