/*
 * XREFs of ?RegisterBidirectionalModeChangedCallback@CBtAudioResourceManagerBase@@UEAAJV?$function@$$A6AXXZ@std@@PEAI@Z @ 0x1800E5B70
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a3)
{
  ...
  try
  {
    ...
    *(_DWORD *)(a1 + 200) = v7 + 1;
    v13 = v7;
    v8 = (_QWORD *)std::map<unsigned __int64,std::function<void (void)>>::_Try_emplace<unsigned __int64,>(
                     (__int64 *)(a1 + 232),
                     (__int64)v15,
                     &v13);
    std::function<void (void)>::operator=(*v8 + 40LL, a2);
    *a3 = v7;
