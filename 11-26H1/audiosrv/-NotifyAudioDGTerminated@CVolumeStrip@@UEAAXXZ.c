/*
 * XREFs of ?NotifyAudioDGTerminated@CVolumeStrip@@UEAAXXZ @ 0x18007CF20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeStrip::NotifyAudioDGTerminated(CVolumeStrip *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_64ceff971abf396a2d7f0130c978516a_Traceguids);
  }
  v2 = *((_QWORD *)this + 20);
  if ( v2 )
