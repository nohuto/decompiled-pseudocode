/*
 * XREFs of ?StartStream@CSharedStreamGroupProxy@@UEAAJPEAUIStreamInstance@@@Z @ 0x18005B730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSharedStreamGroupProxy::StartStream(struct _RTL_CRITICAL_SECTION *this, struct IStreamInstance *a2)
{
