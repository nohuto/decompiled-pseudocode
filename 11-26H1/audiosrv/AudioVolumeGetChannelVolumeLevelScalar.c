/*
 * XREFs of AudioVolumeGetChannelVolumeLevelScalar @ 0x18006B8B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetChannelVolumeLevelScalar(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  v13 = L"AudioVolumeGetChannelVolumeLevelScalar";
  v15 = 0;
  v16 = 0LL;
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*a1 + 112LL))(*a1, a2, a3);
