/*
 * XREFs of ??$MakeAndInitialize@VCommunicationsRemapPolicyRule@@UIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Details@WRL@Microsoft@@YAJPEAPEAUIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Z @ 0x180129074
 * Callers:
        ...
        struct _DynamicRoutingRule **a3)
{
  ...
  int v8; // edi
  __int64 v9; // rax
  CommunicationsRemapPolicyRule *v11; // [rsp+40h] [rbp+8h] BYREF
  CommunicationsRemapPolicyRule *v12; // [rsp+58h] [rbp+20h]
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *((_BYTE *)v7 + 344) = 0;
    ...
    if ( v8 >= 0 )
    {
      v8 = (*(__int64 (__fastcall **)(CommunicationsRemapPolicyRule *, GUID *, _QWORD *))v9)(
             v7,
    ...
    {
      (*(void (__fastcall **)(CommunicationsRemapPolicyRule *))(v9 + 16))(v7);
    }
  }
  else
  {
