/*
 * XREFs of ?PropertyStoreGetValue@CAudioSession@@UEAAJAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x1800CEEE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tagPROPVARIANT *a3)
{
  ...
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSession::PropertyStoreGetValue", 4635, v6);
  return v7;
}
