/*
 * XREFs of ??1iterator@?$iterable_base@U?$scoped_input_vector_view@Uguid@winrt@@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@Uguid@winrt@@@std@@@std@@@std@@@impl@winrt@@Uguid@3@Uno_collection_version@23@@winrt@@UEAA@XZ @ 0x1800EA194
 * Callers:
 ...
 * Callees:
 *     ?unconditional_release_ref@?$com_ptr@U?$scoped_input_vector_view@Uguid@winrt@@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@Uguid@winrt@@@std@@@std@@@std@@@impl@winrt@@@winrt@@AEAAXXZ @ 0x1800EED0C (-unconditional_release_ref@-$com_ptr@U-$scoped_input_vector_view@Uguid@winrt@@V-$_Vector_const_i.c)
 */
