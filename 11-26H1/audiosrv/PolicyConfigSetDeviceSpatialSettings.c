        ...
        unsigned __int16 *a5)
{
  ...
  const wchar_t *v33; // [rsp+98h] [rbp-68h] BYREF
  GUID *v34; // [rsp+A0h] [rbp-60h] BYREF
  const wchar_t *v35; // [rsp+A8h] [rbp-58h] BYREF
  ...
  if ( a4 )
  {
    ...
    v23 = (*(__int64 (__fastcall **)(CPolicyConfig *, const wchar_t *, __int64, unsigned __int16 *))(*(_QWORD *)g_PolicyConfig + 280LL))(
            g_PolicyConfig,
            a3,
            a4,
            a5);
