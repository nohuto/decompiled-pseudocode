/*
 * XREFs of ?PublishCaptureAudioStatus@CCaptureNotifier@@AEAAXXZ @ 0x180076EC8
 * Callers:
 ...
 *     ?SerializeEventHeaderFromApplicationMap@CCaptureNotifier@@AEAAXPEAEK@Z @ 0x180076F8C (-SerializeEventHeaderFromApplicationMap@CCaptureNotifier@@AEAAXPEAEK@Z.c)
