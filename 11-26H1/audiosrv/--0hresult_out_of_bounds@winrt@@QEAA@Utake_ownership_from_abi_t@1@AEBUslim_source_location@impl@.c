/*
 * XREFs of ??0hresult_out_of_bounds@winrt@@QEAA@Utake_ownership_from_abi_t@1@AEBUslim_source_location@impl@1@@Z @ 0x1800E9D44
 * Callers:
...
__int64 __fastcall winrt::hresult_out_of_bounds::hresult_out_of_bounds(__int64 a1)
{
  winrt::hresult_error::hresult_error(a1, winrt::impl::error_out_of_bounds);
  return a1;
}
