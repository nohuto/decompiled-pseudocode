...
__int64 __fastcall lambda_5df9067949f64781414217de856cf4be_::operator()(AtmosCheck **a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_BYTE)v16 && !v18 )
  {
    ...
    if ( v8(a3, v14) < 0 || AtmosCheck::IsUsefulPackage(v9, v14[0]) )
    {
      *((_DWORD *)*a1 + 46) = 2;
      v17 = 0;
