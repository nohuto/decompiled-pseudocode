/*
 * XREFs of ?OnBidirectionalModeChanged@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@AEAAXXZ @ 0x1800DD45C
 * Callers:
        ...
        __int64 a1)
{
  ...
  v5[0] = (__int64)&std::_Func_impl_no_alloc<_lambda_200caaf72e590f0a6902e90b77a591f6_,void,>::`vftable';
  v5[1] = a1;
  v6 = v4;
  v4 = 0LL;
  v7 = v5;
