/*
 * XREFs of ?GetWatcher@AudioEffectsWatcherFactory@@YAJPEBGKHW4DiscoverySettings@@PEAPEAUIAudioEffectsWatcher@@@Z @ 0x1800BF148
 * Callers:
...
__int64 __fastcall AudioEffectsWatcherFactory::GetWatcher(__int64 *a1, int a2, int a3, int a4, struct IUnknown **a5)
{
  ...
  *a5 = 0LL;
  v22 = 0LL;
  EndpointStore = CEndpointStoreCache::GetEndpointStore((RTL_SRWLOCK *)a1, (const unsigned __int16 *)a1, &v22);
  v7 = EndpointStore;
  if ( EndpointStore < 0 )
  {
  ...
  v21 = v9;
  v10 = (__int64 *)((char *)v8 + 200);
  std::forward_list_Microsoft::WRL::WeakRef_std::allocator_Microsoft::WRL::WeakRef___::remove_if__lambda_a405cf70824d0724669728a8122b89b2___((__int64 **)v8 + 25);
  v19 = 0LL;
...
LABEL_12:
  ...
  std::forward_list<Microsoft::WRL::WeakRef>::push_front(v10, &v20);
  v16 = a5;
  a5 = 0LL;
