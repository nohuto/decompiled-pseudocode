/*
 * XREFs of ??$MakeAndInitialize@VCMulticastSessionManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCMulticastSessionManager@@@Z @ 0x180106E08
 * Callers:
 ...
 *     ??0CMulticastSessionManager@@QEAA@XZ @ 0x180107108 (--0CMulticastSessionManager@@QEAA@XZ.c)
