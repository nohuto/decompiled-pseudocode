/*
 * XREFs of ?SerializeForRPC@CCrossProcessFileObjectBasedCrossProcessMemory@@UEAAJPEAUCROSSPROCESSFILEOBJECT_CROSSPROCESS_MEMORY@@@Z @ 0x18015F7F0
 * Callers:
...
__int64 __fastcall CCrossProcessFileObjectBasedCrossProcessMemory::SerializeForRPC(
        CCrossProcessFileObjectBasedCrossProcessMemory *this,
        struct CROSSPROCESSFILEOBJECT_CROSSPROCESS_MEMORY *a2)
{
