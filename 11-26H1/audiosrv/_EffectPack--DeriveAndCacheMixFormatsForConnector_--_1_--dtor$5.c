/*
 * XREFs of _EffectPack::DeriveAndCacheMixFormatsForConnector_::_1_::dtor$5 @ 0x1801652BD
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall EffectPack::DeriveAndCacheMixFormatsForConnector_::_1_::dtor_5(__int64 a1, __int64 a2)
{
