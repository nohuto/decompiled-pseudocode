/*
 * XREFs of ?PopulateEndpointCharacteristicsCache@CEndpointCharacteristicsCache@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WORK@@@Z @ 0x18007F490
 * Callers:
 *     <none>
 * Callees:
        ...
        PTP_WORK Work)
{
  ...
  if ( CoInitializeEx(0LL, 0) >= 0 )
  {
    ...
    v7 = (_QWORD *)*((_QWORD *)&v11 + 1);
    for ( j = (_QWORD *)v11; j != v7; ++j )
    {
    ...
    if ( (_QWORD)v11 )
    {
      std::_Destroy_range<std::allocator<wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>>>(
        (__int64 *)v11,
        *((__int64 **)&v11 + 1));
      std::_Deallocate<16>((void *)v11, (struct std::nothrow_t *)((v12 - v11) & 0xFFFFFFFFFFFFFFF8uLL));
    }
  }
}
