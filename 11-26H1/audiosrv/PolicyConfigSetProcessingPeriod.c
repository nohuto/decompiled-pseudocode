/*
 * XREFs of PolicyConfigSetProcessingPeriod @ 0x18010E2B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigSetProcessingPeriod(__int64 a1, const wchar_t *a2, __int64 *a3)
{
  ...
  const wchar_t *v16; // [rsp+38h] [rbp-60h] BYREF
  ...
  v13 = (*(__int64 (__fastcall **)(CPolicyConfig *, const wchar_t *, __int64 *))(*(_QWORD *)g_PolicyConfig + 64LL))(
          g_PolicyConfig,
          a2,
          a3);
