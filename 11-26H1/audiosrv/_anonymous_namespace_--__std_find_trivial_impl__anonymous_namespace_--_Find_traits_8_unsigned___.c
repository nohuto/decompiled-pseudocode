/*
 * XREFs of _anonymous_namespace_::__std_find_trivial_impl__anonymous_namespace_::_Find_traits_8_unsigned___int64_ @ 0x1800B1990
 * Callers:
...
LABEL_9:
    ...
    _RAX = (char *)&unk_18018CEE0 - (v11 & 0xFFFFFFFC);
    __asm
    {
