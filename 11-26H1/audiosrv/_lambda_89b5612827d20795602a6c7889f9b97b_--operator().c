/*
 * XREFs of _lambda_89b5612827d20795602a6c7889f9b97b_::operator() @ 0x180136784
 * Callers:
...
void __fastcall lambda_89b5612827d20795602a6c7889f9b97b_::operator()(__int64 a1)
{
  __int64 v1; // r8
  _DWORD *v2; // r9
  __int64 v3; // rax
  ...
  const wchar_t *v13; // [rsp+70h] [rbp+7h] BYREF
