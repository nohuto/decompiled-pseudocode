/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7W4FailureFlags@2@PEAUFailureInfo@2@@Z @ 0x1800A9964
 * Callers:
 ...
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x18007C780 (-RecordReturn@details@wil@@YAHJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x1800A9C80 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x1800B0EEC (-RecordLog@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x1800B7A1C (-RecordException@details@wil@@YAHJ@Z.c)
        ...
        unsigned __int64 a16)
{
  ...
  *(_DWORD *)(a16 + 12) = a8[1];
  ...
  if ( a7 )
  {
    ...
    {
      case 1:
        v20 = wil::details::RecordReturn((wil::details *)v18);
        break;
      case 2:
        if ( (v18 & 0x80000000) == 0 )
        {
