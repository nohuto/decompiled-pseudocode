/*
 * XREFs of ?Initialize@CVolumeControlBase@@MEAAJPEAUIMMDevice@@@Z @ 0x180053490
 * Callers:
 ...
 *     ??4?$CComQIPtr@UIMMEndpoint@@$1?_GUID_1be09788_6894_4089_8586_9a2a6c265ac5@@3U__s_GUID@@B@ATL@@QEAAPEAUIMMEndpoint@@PEAUIUnknown@@@Z @ 0x18005358C (--4-$CComQIPtr@UIMMEndpoint@@$1-_GUID_1be09788_6894_4089_8586_9a2a6c265ac5@@3U__s_GUID@@B@ATL@@Q.c)
...
__int64 __fastcall CVolumeControlBase::Initialize(CVolumeControlBase *this, struct IMMDevice *a2)
{
  ...
  {
LABEL_4:
    AudSrvTraceLoggingErrorHelper("CVolumeControlBase::Initialize", 163, v5);
  }
  if ( v8 )
