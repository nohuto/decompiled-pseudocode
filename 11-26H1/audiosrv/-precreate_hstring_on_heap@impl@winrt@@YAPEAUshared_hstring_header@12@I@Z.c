/*
 * XREFs of ?precreate_hstring_on_heap@impl@winrt@@YAPEAUshared_hstring_header@12@I@Z @ 0x1800EE650
 * Callers:
 ...
 * Callees:
 *     WINRT_IMPL_HeapAlloc @ 0x1800B34AF (WINRT_IMPL_HeapAlloc.c)
 ...
 *     ??0invalid_argument@std@@QEAA@PEBD@Z @ 0x1800E9E44 (--0invalid_argument@std@@QEAA@PEBD@Z.c)
