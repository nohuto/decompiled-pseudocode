/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@U?$ITypedEventHandler@PEAVPackageCatalog@ApplicationModel@Windows@@PEAVPackageInstallingEventArgs@23@@Foundation@Windows@@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007FB40
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  if ( *a2 )
  {
    ...
    v4 = *(_DWORD *)&GUID_a8a900c6_da0b_5bcc_a71a_be0b9265d87a.Data4[4];
  }
  else
  {
