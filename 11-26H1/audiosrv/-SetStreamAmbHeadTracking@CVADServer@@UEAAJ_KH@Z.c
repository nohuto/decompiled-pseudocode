/*
 * XREFs of ?SetStreamAmbHeadTracking@CVADServer@@UEAAJ_KH@Z @ 0x180113CC0
 * Callers:
...
__int64 __fastcall CVADServer::SetStreamAmbHeadTracking(
...
LABEL_15:
  ...
  if ( v10 >= 0 )
  {
    v12 = *((_QWORD *)this[4].OwningThread + 25);
    if ( v12 )
    {
