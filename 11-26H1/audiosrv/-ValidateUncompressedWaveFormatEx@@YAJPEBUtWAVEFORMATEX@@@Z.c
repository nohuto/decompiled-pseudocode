/*
 * XREFs of ?ValidateUncompressedWaveFormatEx@@YAJPEBUtWAVEFORMATEX@@@Z @ 0x180010E04
 * Callers:
...
__int64 __fastcall ValidateUncompressedWaveFormatEx(const struct tWAVEFORMATEX *a1)
{
  ...
  if ( !a1 )
    return 2147500035LL;
  result = ValidateWaveFormatEx(a1);
  if ( (int)result >= 0 )
  {
    result = 1LL;
    if ( a1->wFormatTag == 1 || a1->wFormatTag == 3 )
      return 0LL;
    if ( a1->wFormatTag == 0xFFFE )
    {
      v3 = *(_QWORD *)&GUID_00000001_0000_0010_8000_00aa00389b71.Data1 - *(_QWORD *)((char *)&a1[1].nSamplesPerSec + 2);
      ...
      if ( !v3 )
        return 0LL;
      v4 = *(_QWORD *)&GUID_00000003_0000_0010_8000_00aa00389b71.Data1 - *(_QWORD *)((char *)&a1[1].nSamplesPerSec + 2);
