/*
 * XREFs of ?SetChannelVolumeLevel@CVolumeControlBase@@UEAAJIMPEBU_GUID@@PEAH@Z @ 0x180119790
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v11 = fmaxf(fminf(v10[1], v10[3]), v10[2]);
  ...
  v13[1] = fmaxf(fminf(a3, v13[5]), v13[2]);
  v14 = (*(__int64 (__fastcall **)(CVolumeControlBase *, _QWORD))(*(_QWORD *)this + 248LL))(this, (unsigned int)v6);
  v15 = v14;
  if ( v14 >= 0 )
  {
  ...
  else
  {
    ...
    v16[1] = fmaxf(fminf(v11, v16[5]), v16[2]);
  }
LABEL_12:
