/*
 * XREFs of ?ProviderFinalRelease@CVolumeStrip@@UEAAXXZ @ 0x18011AA20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CVolumeStrip::ProviderFinalRelease(unsigned __int64 this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_64ceff971abf396a2d7f0130c978516a_Traceguids);
  }
  v2 = *(_QWORD *)(this + 160);
  if ( v2 )
