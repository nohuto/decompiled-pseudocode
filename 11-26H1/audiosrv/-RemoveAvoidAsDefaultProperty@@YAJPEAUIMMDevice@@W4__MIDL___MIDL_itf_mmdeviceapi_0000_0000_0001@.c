/*
 * XREFs of ?RemoveAvoidAsDefaultProperty@@YAJPEAUIMMDevice@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@@Z @ 0x180085500
 * Callers:
...
__int64 __fastcall RemoveAvoidAsDefaultProperty(__int64 a1, int a2, unsigned int a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( a1 )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v10 + 40LL))(
             v10,
...
LABEL_15:
        ...
        v5 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v10 + 48LL))(
               v10,
               &PKEY_AudioEndpoint_AvoidSelection,
               pvar);
      }
