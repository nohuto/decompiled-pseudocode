/*
 * XREFs of ?HandleAppVolumePolicyChange@CSpatialAudioResourceManager@Sarm@@AEAAXK@Z @ 0x1801252EC
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_1d89632f3144689dba3d227faae4cbd9__void_::_Do_call @ 0x180127170 (std--_Func_impl_no_alloc__lambda_1d89632f3144689dba3d227faae4cbd9__void_--_Do_call.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v14 = v4;
  SarmTraceLoggingTracer("Sarm::CSpatialAudioResourceManager::HandleAppVolumePolicyChange", 778);
