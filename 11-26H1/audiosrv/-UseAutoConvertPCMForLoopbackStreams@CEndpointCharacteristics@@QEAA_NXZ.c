/*
 * XREFs of ?UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ @ 0x18006C57C
 * Callers:
...
char __fastcall CEndpointCharacteristics::UseAutoConvertPCMForLoopbackStreams(CEndpointCharacteristics *this)
{
  ...
  if ( (int)CEndpointCharacteristics::TryGetOverridingMixFormat(this, eHostProcessConnector, &v4, &v6) < 0 || !pv )
    v1 = 0;
