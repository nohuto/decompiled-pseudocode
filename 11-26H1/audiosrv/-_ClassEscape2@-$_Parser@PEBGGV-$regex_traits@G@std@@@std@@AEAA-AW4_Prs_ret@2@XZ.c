/*
 * XREFs of ?_ClassEscape2@?$_Parser@PEBGGV?$regex_traits@G@std@@@std@@AEAA?AW4_Prs_ret@2@XZ @ 0x18014CA10
 * Callers:
...
__int64 __fastcall std::_Parser<unsigned short const *,unsigned short,std::regex_traits<unsigned short>>::_ClassEscape2(
        __int64 a1)
{
  int v1; // eax
  __int64 v4; // rcx
  ...
  if ( (unsigned __int8)std::_Parser<unsigned short const *,unsigned short,std::regex_traits<unsigned short>>::_DecimalDigits2(
                          a1,
                          2LL,
                          0x7FFFFFFFLL) )
  {
