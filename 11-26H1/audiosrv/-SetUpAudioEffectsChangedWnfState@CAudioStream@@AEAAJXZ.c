/*
 * XREFs of ?SetUpAudioEffectsChangedWnfState@CAudioStream@@AEAAJXZ @ 0x1800D5CE0
 * Callers:
...
__int64 __fastcall CAudioStream::SetUpAudioEffectsChangedWnfState(CAudioStream *this)
{
  ...
  PSECURITY_DESCRIPTOR SecurityDescriptor; // [rsp+98h] [rbp+10h] BYREF
...
LABEL_7:
  ...
  WnfStateName = NtCreateWnfStateName((char *)this + 324, 3LL, 0LL);
  if ( WnfStateName < 0 )
  {
...
LABEL_10:
  ...
  v13[1] = this;
  v13[7] = v13;
  event_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__Uerr_returncode_policy_3__wil__QEAAJW4EventOptions_2_PEBGPEAU_SECURITY_ATTRIBUTES__PEA_N_Z = CSerialWorkQueue::QueueRecurringWaitItem(SerialWorkQueue, *((HANDLE *)this + 42), (__int64)v13, (__int64)this + 344);
  if ( event_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__Uerr_returncode_policy_3__wil__QEAAJW4EventOptions_2_PEBGPEAU_SECURITY_ATTRIBUTES__PEA_N_Z < 0 )
  {
    v9 = 1646LL;
    goto LABEL_10;
