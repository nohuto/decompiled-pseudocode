/*
 * XREFs of ?push_back@?$vector@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@V?$allocator@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@@2@@std@@QEAAX$$QEAV?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@2@@Z @ 0x1800F5A18
 * Callers:
...
char *__fastcall std::vector<std::unique_ptr<_ConnectorInfo>>::push_back(_QWORD *a1, __int64 *a2)
{
  char **v2; // r9
  char *result; // rax
