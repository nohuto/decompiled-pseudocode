/*
 * XREFs of PolicyConfigReportSpatialLicenseChanged @ 0x180026A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigReportSpatialLicenseChanged(__int64 a1, __int64 a2)
{
  ...
  pftDueTime.dwLowDateTime = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64))(*(_QWORD *)g_PolicyConfig + 256LL))(
                               g_PolicyConfig,
                               a2);
