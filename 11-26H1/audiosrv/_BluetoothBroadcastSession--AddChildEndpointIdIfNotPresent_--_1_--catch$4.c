/*
 * XREFs of _BluetoothBroadcastSession::AddChildEndpointIdIfNotPresent_::_1_::catch$4 @ 0x18016904D
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BluetoothBroadcastSession::AddChildEndpointIdIfNotPresent_::_1_::catch_4(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
