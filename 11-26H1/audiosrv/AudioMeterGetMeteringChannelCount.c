/*
 * XREFs of AudioMeterGetMeteringChannelCount @ 0x180013D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioMeterGetMeteringChannelCount(_QWORD *a1, __int64 a2)
{
  ...
  v15 = v2;
  v13 = CurrentThreadId;
  v14 = L"AudioMeterGetMeteringChannelCount";
  v16 = 0;
  v17 = 0LL;
  ...
  v8 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a1 + 168LL))(*a1, a2);
