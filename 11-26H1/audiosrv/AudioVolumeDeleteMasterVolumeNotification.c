/*
 * XREFs of AudioVolumeDeleteMasterVolumeNotification @ 0x180068BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeDeleteMasterVolumeNotification(__int64 *a1)
{
  ...
  v14 = L"AudioVolumeDeleteMasterVolumeNotification";
  v16 = 0;
  v17 = 0LL;
  ...
  {
    v8 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v5 + 256LL))(v5, Pid);
    v7 = v8;
    if ( v8 >= 0 )
    {
      v7 = 0;
