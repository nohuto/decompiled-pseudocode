/*
 * XREFs of ??1?$size_address_ptr@I@?$unique_any_array_ptr@U_GUID@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@Uempty_deleter@3@_K@wil@@QEAA@XZ @ 0x180154C10
 * Callers:
 ...
 *     _ScanForInstalledSpatialAudioSubtypeAppServices_::_1_::dtor$12 @ 0x180166A33 (_ScanForInstalledSpatialAudioSubtypeAppServices_--_1_--dtor$12.c)
 *     _wil::get_sr_entity_propset_Windows::Internal::StateRepository::IApplicationExtension__::_1_::dtor$1 @ 0x18016C0D8 (_wil--get_sr_entity_propset_Windows--Internal--StateRepository--IApplicationExtensi_ea_18016C0D8.c)
 * Callees:
 *     <none>
 */
