/*
 * XREFs of ??1?$ComPtr@VCMulticastSessionManager@@@WRL@Microsoft@@QEAA@XZ @ 0x180107174
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_CMulticastSessionManager_CMulticastSessionManager__::_1_::dtor$1 @ 0x18016A544 (_Microsoft--WRL--Details--MakeAndInitialize_CMulticastSessionManager_CMulticastSessionManager__-.c)
 * Callees:
