/*
 * XREFs of ??1?$_Tidy_guard@V?$_Builder@PEBGGV?$regex_traits@G@std@@@std@@@std@@QEAA@XZ @ 0x18014A5CC
 * Callers:
 ...
 *     _std::_Parser_unsigned_short_const___unsigned_short_std::regex_traits_unsigned_short___::_Compile_::_1_::dtor$0 @ 0x18016BE4F (_std--_Parser_unsigned_short_const___unsigned_short_std--regex_traits_unsigned_short___--_Compil.c)
 * Callees:
 *     ?_Destroy_node@std@@YAXPEAV_Node_base@1@0@Z @ 0x18014CD4C (-_Destroy_node@std@@YAXPEAV_Node_base@1@0@Z.c)
 */
