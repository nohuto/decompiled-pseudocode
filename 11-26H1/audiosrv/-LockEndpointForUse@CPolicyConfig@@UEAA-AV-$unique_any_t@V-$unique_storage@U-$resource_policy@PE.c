/*
 * XREFs of ?LockEndpointForUse@CPolicyConfig@@UEAA?AV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_RTL_CRITICAL_SECTION@@P6AXPEAU1@@Z$1?LeaveCriticalSection@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@PEBG@Z @ 0x18010C1C0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall CPolicyConfig::LockEndpointForUse(RTL_SRWLOCK *a1, _QWORD *a2, const unsigned __int16 *a3)
{
