/*
 * XREFs of ??$MakeAndInitialize@V?$CSectionBasedCPClientMemory@UControlData_V2@@@@UICrossProcessMemory@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUICrossProcessMemory@@@Z @ 0x18015EA10
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<CSectionBasedCPClientMemory<ControlData_V2>,ICrossProcessMemory,>(
        _QWORD *a1)
{
  void *v2; // rax
  void *v3; // rbx
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v3 = &CSectionBasedCPClientMemory<ControlData_V2>::`vftable';
    v6 = 0LL;
    v4 = ((__int64 (__fastcall *)(void *, GUID *, _QWORD *))CSectionBasedCPClientMemory<ControlData_V2>::`vftable')(
           v3,
