/*
 * XREFs of ??_E?$_Ref_count_obj2@V?$com_ptr_t@UICapabilityUsageSession@Management@CapabilityAccess@Internal@Windows@@Uerr_returncode_policy@wil@@@wil@@@std@@UEAAPEAXI@Z @ 0x1800803D0
 * Callers:
 *     <none>
 * Callees:
