/*
 * XREFs of _CMonitorManager::FindMonitor_::_1_::dtor$0 @ 0x18016AF02
 * Callers:
 *     <none>
 * Callees:
 *     ??1?$CComPtr@UICompositeSystemEffect@@@ATL@@QEAA@XZ @ 0x1800687DC (--1-$CComPtr@UICompositeSystemEffect@@@ATL@@QEAA@XZ.c)
 */
