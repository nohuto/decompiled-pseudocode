/*
 * XREFs of ?ForEachEntry@?$CLockedList_UniqueValuesOnly@VCMasterVolumeNotificationProcess@@$0A@@@QEAAJ$$QEAVCListWorker@1@@Z @ 0x18004FD34
 * Callers:
        ...
        void (__fastcall ***a2)(_QWORD, _QWORD))
{
  ...
  try
  {
    ...
    if ( v5 )
    {
      v9 = (const struct std::nothrow_t *)((v12 - (_QWORD)v5) & 0xFFFFFFFFFFFFFFF8uLL);
