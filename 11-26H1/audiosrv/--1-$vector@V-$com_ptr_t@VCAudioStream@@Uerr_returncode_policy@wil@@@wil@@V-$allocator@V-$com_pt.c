/*
 * XREFs of ??1?$vector@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180062BE8
 * Callers:
 ...
 *     ??1?$vector@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x1800B1238 (--1-$vector@V-$com_ptr_t@UIUnknown@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@V-$com_ptr_t@.c)
 ...
 *     _CAudioSession::Disconnect_::_1_::dtor$1 @ 0x1801650B2 (_CAudioSession--Disconnect_--_1_--dtor$1.c)
 *     _CAudioSession::DisconnectStreamList_::_1_::dtor$0 @ 0x180165106 (_CAudioSession--DisconnectStreamList_--_1_--dtor$0.c)
 *     _CEndpointCharacteristicsCache::PopulateEndpointCharacteristicsCache_::_1_::dtor$0 @ 0x180166A45 (_CEndpointCharacteristicsCache--PopulateEndpointCharacteristicsCache_--_1_--dtor$0.c)
 *     _CMulticastSessionManager::ActivateMulticastSession_::_1_::dtor$0 @ 0x18016A556 (_CMulticastSessionManager--ActivateMulticastSession_--_1_--dtor$0.c)
 * Callees:
