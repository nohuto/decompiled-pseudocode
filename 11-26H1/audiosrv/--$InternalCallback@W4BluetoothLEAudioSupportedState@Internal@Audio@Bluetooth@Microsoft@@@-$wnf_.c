/*
 * XREFs of ??$InternalCallback@W4BluetoothLEAudioSupportedState@Internal@Audio@Bluetooth@Microsoft@@@?$wnf_subscription_state@W4BluetoothLEAudioSupportedState@Internal@Audio@Bluetooth@Microsoft@@@details@wil@@QEAAXPEBW4BluetoothLEAudioSupportedState@Internal@Audio@Bluetooth@Microsoft@@K@Z @ 0x1800E8568
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_7cbdedfb44f57d0b0260c43b6dda9a65_@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x1800E8540 (-_lambda_invoker_cdecl_@_lambda_7cbdedfb44f57d0b0260c43b6dda9a65_@@CAJU_WNF_STATE_NAME@@KPEAU_WN.c)
 * Callees:
