/*
 * XREFs of ?HandleRevocationCompletion@CSpatialAudioResourceManager@Sarm@@AEAAX_J@Z @ 0x1801255AC
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_18871662051ef14e923fcf0c1dee16c7__void_::_Do_call @ 0x180127150 (std--_Func_impl_no_alloc__lambda_18871662051ef14e923fcf0c1dee16c7__void_--_Do_call.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  SarmTraceLoggingTracer("Sarm::CSpatialAudioResourceManager::HandleRevocationCompletion", 524);
  Stream = Sarm::CSpatialAudioResourceManager::FindStream(this, a2);
  if ( Stream )
    Sarm::CStreamResource::CompleteRevocation(Stream);
  else
    CSpatialAudioResourceManagerTraceLogger::LogStreamIdentifierExpired(v6, 0x211u, a2);
  if ( v2 )
