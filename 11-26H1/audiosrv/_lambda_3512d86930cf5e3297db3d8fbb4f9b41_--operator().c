/*
 * XREFs of _lambda_3512d86930cf5e3297db3d8fbb4f9b41_::operator() @ 0x180110EEC
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_3512d86930cf5e3297db3d8fbb4f9b41__void_::_Do_call @ 0x180114580 (std--_Func_impl_no_alloc__lambda_3512d86930cf5e3297db3d8fbb4f9b41__void_--_Do_call.c)
 * Callees:
...
void __fastcall lambda_3512d86930cf5e3297db3d8fbb4f9b41_::operator()(__int64 a1)
{
  __int64 v1; // rdx
  __int64 v2; // rcx
  CVADServer *v3; // rbx
  ...
  if ( g_VADServerList )
  {
    do
    {
      v3 = (CVADServer *)*ATL::CAtlList<CVADServer *,ATL::CElementTraits<CVADServer *>>::GetNext(v2, &v5);
      v4 = 0LL;
      if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>((_QWORD *)v3 + 69, &v4) >= 0 && v4 )
