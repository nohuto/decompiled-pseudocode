/*
 * XREFs of _GetProposedConnectorFormatForProcessingMode_::_1_::dtor$2 @ 0x180164180
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall GetProposedConnectorFormatForProcessingMode_::_1_::dtor_2(__int64 a1, __int64 a2)
{
