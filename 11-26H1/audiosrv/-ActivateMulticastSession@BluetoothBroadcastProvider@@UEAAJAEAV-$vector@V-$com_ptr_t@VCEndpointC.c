...
__int64 __fastcall BluetoothBroadcastProvider::ActivateMulticastSession(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_QWORD)v15 )
    std::_Deallocate<16>((void *)v15, (struct std::nothrow_t *)((v16 - v15) & 0xFFFFFFFFFFFFFFF0uLL));
  return v5;
}
