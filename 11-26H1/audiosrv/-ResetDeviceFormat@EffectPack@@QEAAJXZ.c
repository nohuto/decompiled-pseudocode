/*
 * XREFs of ?ResetDeviceFormat@EffectPack@@QEAAJXZ @ 0x18013BEC8
 * Callers:
...
__int64 __fastcall EffectPack::ResetDeviceFormat(EffectPack *this)
{
  ...
  EffectPack::GetDefaultConnectorProcessingModeConfiguration(this, eHostProcessConnector, &v15, 0LL, 0LL);
  v14 = 0LL;
  ...
  *(_QWORD *)v16.Data4 = 0LL;
  ...
  DeviceFormatAndSpatialSettings = EffectPack::GetDeviceFormatAndSpatialSettings(
                                     ...
                                     0,
                                     0LL,
                                     (struct tWAVEFORMATEX **)v16.Data4,
                                     0LL,
                                     0LL,
                                     0LL);
