/*
 * XREFs of ?reset@?$unique_ptr@UKSMULTIPLE_ITEM@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@QEAAXPEAUKSMULTIPLE_ITEM@@@Z @ 0x18002B5E0
 * Callers:
 ...
 *     ??1ApoRegistrationInfo@EffectPackConfiguration@@QEAA@XZ @ 0x1800ABCE0 (--1ApoRegistrationInfo@EffectPackConfiguration@@QEAA@XZ.c)
 ...
 *     _AudioEffectsWatcher::RebuildAndPublishFullEffectsListFromApos_::_2_::_unnamed_type_apoResults_::__unnamed_type_apoResults_ @ 0x1800BECF0 (_AudioEffectsWatcher--RebuildAndPublishFullEffectsListFromApos_--_2_--_unnamed_type_apoResults_-.c)
