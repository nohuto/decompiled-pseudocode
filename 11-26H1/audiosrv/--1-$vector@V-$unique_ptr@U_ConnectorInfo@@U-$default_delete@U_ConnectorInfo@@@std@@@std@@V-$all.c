/*
 * XREFs of ??1?$vector@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@V?$allocator@V?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800F0A34
 * Callers:
 *     _EndpointInfo::AddExtendedTopologyInfo_::_1_::dtor$0_0 @ 0x18016C3E5 (_EndpointInfo--AddExtendedTopologyInfo_--_1_--dtor$0_0.c)
 * Callees:
