/*
 * XREFs of ?AddOrVerifyTargetEndpointId@BluetoothBroadcastSession@@QEAAJPEBGPEA_N@Z @ 0x1800EB434
 * Callers:
...
__int64 __fastcall BluetoothBroadcastSession::AddOrVerifyTargetEndpointId(
        ...
        const char *a4)
{
  ...
  if ( v6 )
  {
    if ( (unsigned int)_o__wcsicmp(v6, a2) )
    {
      v7 = -2147418113;
      v8 = 81LL;
LABEL_4:
