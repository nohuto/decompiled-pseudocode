/*
 * XREFs of ?GetAudioSessionControl@CAudioSessionManager@@UEAAJK_NPEAVCAudioSession@@PEAPEAVCServerAudioSessionControl@@@Z @ 0x180051300
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CServerAudioSessionControl **a5)
{
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
  {
    ...
    if ( v9 != &WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_S(v9[2], 14LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids, 0LL);
        v9 = WPP_GLOBAL_Control;
      }
      if ( v9 != &WPP_GLOBAL_Control && (*((_BYTE *)v9 + 28) & 0x40) != 0 && *((_BYTE *)v9 + 25) >= 4u )
        WPP_SF_S(v9[2], 11LL, &WPP_26c2f811cba6303e2e635ec6759b9dab_Traceguids, 0LL);
    }
  }
