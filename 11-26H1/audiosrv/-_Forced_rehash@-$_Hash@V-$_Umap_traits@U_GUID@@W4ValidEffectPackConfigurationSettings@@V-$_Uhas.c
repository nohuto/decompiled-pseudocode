/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@U_GUID@@W4ValidEffectPackConfigurationSettings@@V?$_Uhash_compare@U_GUID@@U?$hash@U_GUID@@@std@@U?$equal_to@U_GUID@@@3@@std@@V?$allocator@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x18014D420
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<_GUID const,enum ValidEffectPackConfigurationSettings>>>>>>::_Assign_grow(
    (__int64)&qword_1801D7DD8,
    2 * v5,
    qword_1801D7DC8);
  v6 = v5 - 1;
  qword_1801D7DF0 = v5 - 1;
  qword_1801D7DF8 = v5;
  v7 = *(_QWORD **)qword_1801D7DC8;
  v8 = *(_QWORD **)qword_1801D7DC8;
  while ( v7 != (_QWORD *)v3 )
  {
    v9 = qword_1801D7DD8;
    v8 = (_QWORD *)*v8;
...
LABEL_7:
    ...
    {
      v18 = v12 + 1;
      if ( *(_QWORD **)(qword_1801D7DD8 + 8 * v11) == v12 )
        break;
      v12 = (_QWORD *)*v18;
