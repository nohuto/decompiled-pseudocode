        ...
        __int64 *a3)
{
  ...
  v14 = &v13[v5];
  v22 = v14 + 1;
  wil::com_ptr_t<IAudioProcess,wil::err_returncode_policy>::com_ptr_t<IAudioProcess,wil::err_returncode_policy>(v14, a3);
  v15 = a1[1];
  v16 = v13;
  v17 = *a1;
  v21 = v14;
