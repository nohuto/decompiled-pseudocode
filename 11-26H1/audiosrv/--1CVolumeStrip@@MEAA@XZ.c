/*
 * XREFs of ??1CVolumeStrip@@MEAA@XZ @ 0x18004F62C
 * Callers:
 ...
 *     ??1?$CLockedList_UniqueValuesOnly@VCMasterVolumeNotificationProcess@@$0A@@@QEAA@XZ @ 0x18004F6E8 (--1-$CLockedList_UniqueValuesOnly@VCMasterVolumeNotificationProcess@@$0A@@@QEAA@XZ.c)
