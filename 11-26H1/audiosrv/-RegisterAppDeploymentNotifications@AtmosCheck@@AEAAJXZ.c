/*
 * XREFs of ?RegisterAppDeploymentNotifications@AtmosCheck@@AEAAJXZ @ 0x1801570E8
 * Callers:
  ...
  if ( ActivationFactory >= 0 )
  {
    ...
    if ( ActivationFactory >= 0 )
    {
      ...
      Microsoft::WRL::Callback_Windows::Foundation::ITypedEventHandler_Windows::ApplicationModel::PackageCatalog___Windows::ApplicationModel::PackageUpdatingEventArgs_____lambda_a5ab363fcb9b7ea3ea21f546eba5c54f___(
        (__int64 *)&v19,
        (__int64)v12);
      Microsoft::WRL::ComPtr<Windows::Internal::StateRepository::IPackage>::~ComPtr<Windows::Internal::StateRepository::IPackage>((__int64)&v22);
      v13 = v23[0];
