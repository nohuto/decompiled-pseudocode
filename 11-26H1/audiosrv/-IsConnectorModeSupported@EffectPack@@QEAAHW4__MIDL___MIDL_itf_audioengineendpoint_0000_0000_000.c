/*
 * XREFs of ?IsConnectorModeSupported@EffectPack@@QEAAHW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@W4FXEnablementConsideration@@U_GUID@@@Z @ 0x18000FCE4
 * Callers:
...
__int64 __fastcall EffectPack::IsConnectorModeSupported(_QWORD *a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  unsigned int v4; // edi
