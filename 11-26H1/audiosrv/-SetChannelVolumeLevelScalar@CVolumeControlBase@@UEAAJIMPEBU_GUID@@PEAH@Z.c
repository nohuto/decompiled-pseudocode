/*
 * XREFs of ?SetChannelVolumeLevelScalar@CVolumeControlBase@@UEAAJIMPEBU_GUID@@PEAH@Z @ 0x180119930
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  *(_QWORD *)v20 = v8;
  if ( (unsigned int)v6 < *((_DWORD *)this + 29) )
  {
    ...
    v13 = fmaxf(fminf(v12[1], v12[3]), v12[2]);
    ...
    if ( v15 >= 0 )
    {
      ...
      if ( v16 >= 0 )
      {
        ...
        if ( a5 )
        {
          v18 = (float *)ATL::CAtlArray<CVolumeUnit,ATL::CElementTraits<CVolumeUnit>>::operator[](
                           (_QWORD *)this + 10,
                           v6);
          *a5 = v13 == fmaxf(fminf(v18[1], v18[3]), v18[2]);
        }
        v9 = 0;
      }
      else
      {
        ...
        v17[1] = fmaxf(fminf(v13, v17[5]), v17[2]);
      }
      goto LABEL_13;
    }
