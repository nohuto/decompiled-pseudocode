/*
 * XREFs of ??0?$_Matcher@PEBGGV?$regex_traits@G@std@@PEBG@std@@QEAA@PEBG0AEBV?$regex_traits@G@1@PEAV_Root_node@1@IW4syntax_option_type@regex_constants@1@W4match_flag_type@51@@Z @ 0x180134D48
 * Callers:
    ...
    if ( v10 > v11 )
    {
      if ( v10 <= *(__int64 *)(a1 + 144) >> 4 )
        *(_QWORD *)(a1 + 136) = std::_Uninitialized_value_construct_n<std::allocator<std::_Loop_vals_t>>(
        ...
        std::vector<std::_Loop_vals_t>::_Resize_reallocate<std::_Value_init_tag>((const void **)(a1 + 128), v10);
    }
  }
  else
  {
