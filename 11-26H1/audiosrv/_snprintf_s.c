/*
 * XREFs of _snprintf_s @ 0x1800B342C
 * Callers:
 *     ?DumpTraceWin32@@YAXPEBD00H@Z @ 0x180153998 (-DumpTraceWin32@@YAXPEBD00H@Z.c)
 * Callees:
 *     __local_stdio_printf_options @ 0x1800B1C14 (__local_stdio_printf_options.c)
 *     _o___stdio_common_vsnprintf_s_0 @ 0x1800B30D6 (_o___stdio_common_vsnprintf_s_0.c)
 */
