/*
 * XREFs of ?ReevaluateSaDeviceSettings@CAudioResourceManager@@IEAAXPEAVCEndpointStore@@_N@Z @ 0x180042F44
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_efe6a2a1125c0c889ee2664d28532957__void_::_Do_call @ 0x1800CC510 (std--_Func_impl_no_alloc__lambda_efe6a2a1125c0c889ee2664d28532957__void_--_Do_call.c)
 * Callees:
        ...
        char a3)
{
  ...
  *(_OWORD *)v53 = 0LL;
  ...
  if ( v5[3] > 7uLL )
    v6 = (_QWORD *)*v5;
  v36 = v53;
  v7 = (*(__int64 (__fastcall **)(PVOID, _QWORD *, _QWORD, _QWORD))(*(_QWORD *)g_pEndpointCharacteristicsCache + 40LL))(
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    if ( v5[3] > 7uLL )
      v5 = (_QWORD *)*v5;
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 22LL, &WPP_c1536f98adc13219c785ca614022e7d6_Traceguids, v5);
  }
  if ( v7 >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_P(*((_QWORD *)WPP_GLOBAL_Control + 2), 23LL, v11, (__int64)(*((_QWORD *)&v48 + 1) - v48) >> 3);
      }
      if ( v10 < 0 )
        goto LABEL_53;
      v12 = 0LL;
...
LABEL_49:
        ...
        v22 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*i + 96LL))(*i);
        v56 = v19;
        v57 = v20;
        v42 = v21;
        v23 = DeriveDeviceGraphFormatsForStream(
                (CEndpointCharacteristics **)v53,
                0,
                v22,
      ...
      *((_QWORD *)v40 + 3) = 0LL;
      ...
      if ( *(_QWORD *)&v42.Data1 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(
          *(_QWORD *)&v42.Data1,
          *(_QWORD *)v42.Data4);
        std::_Deallocate<16>(*(_QWORD *)&v42.Data1, (v43 - *(_QWORD *)&v42.Data1) & 0xFFFFFFFFFFFFFFF8uLL);
      }
LABEL_44:
      v12 = v41[0];
      if ( !v41[0] )
...
LABEL_53:
      if ( (_QWORD)v48 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v48, *((_QWORD *)&v48 + 1));
        std::_Deallocate<16>(v48, (v49 - v48) & 0xFFFFFFFFFFFFFFF8uLL);
      }
      if ( v10 < 0 || v9 )
      {
        v33 = a3;
...
LABEL_29:
    if ( v15 )
    {
      std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>(v15, *(_QWORD *)v42.Data4);
      std::_Deallocate<16>(*(_QWORD *)&v42.Data1, (v43 - *(_QWORD *)&v42.Data1) & 0xFFFFFFFFFFFFFFF8uLL);
    }
    goto LABEL_38;
  }
