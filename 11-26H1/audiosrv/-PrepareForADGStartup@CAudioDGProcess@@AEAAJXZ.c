/*
 * XREFs of ?PrepareForADGStartup@CAudioDGProcess@@AEAAJXZ @ 0x18007B6EC
 * Callers:
...
__int64 __fastcall CAudioDGProcess::PrepareForADGStartup(CAudioDGProcess *this, void *a2, __int64 a3)
{
  ...
  struct _SECURITY_ATTRIBUTES v14; // [rsp+30h] [rbp-28h] BYREF
  ...
  *(_QWORD *)&v14.nLength = 24LL;
  *(_QWORD *)&v14.bInheritHandle = 1LL;
  ...
  {
    v6 = _create___event_t_V__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__Uerr_returncode_policy_3__wil__QEAAJW4EventOptions_2_PEBGPEAU_SECURITY_ATTRIBUTES__PEA_N_Z(
           (wil::details **)this + 14,
           1,
           a3,
           &v14);
