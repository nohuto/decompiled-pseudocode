/*
 * XREFs of ?PopulateAudioHistoryForStream@CVADServer@@UEAAJ_J00@Z @ 0x180112CB0
 * Callers:
...
LABEL_7:
  ...
  if ( (v10 & 0x80000000) == 0 )
  {
    v17 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, __int64, int))(*(_QWORD *)v24 + 80LL))(
            v24,
            ((__int64)this[4].OwningThread + 8) & -(__int64)(this[4].OwningThread != 0LL),
            a2,
            a3,
            a4,
            (HIDWORD(this[6].DebugInfo) >> 22) & 1);
    v10 = v17;
    if ( v17 >= 0 )
    {
