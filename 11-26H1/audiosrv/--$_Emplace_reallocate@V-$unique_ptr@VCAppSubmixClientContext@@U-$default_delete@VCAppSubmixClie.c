        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)v17 = v14;
  ...
  std::_Uninitialized_move<std::unique_ptr<CAppSubmixClientContext> *,std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(
    ...
    v18,
    v16);
  std::vector<std::unique_ptr<CAppSubmixClientContext>>::_Change_array(a1, v15, v9, v3, v21, 0LL, v22, v23, v24);
  std::vector<std::unique_ptr<CAppSubmixClientContext>>::_Reallocation_guard::~_Reallocation_guard(&v21);
  return v17;
}
