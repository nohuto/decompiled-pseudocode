/*
 * XREFs of ??R?$_Conditionally_enabled_hash@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@$00@std@@SA_KAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@1@@Z @ 0x1800ABA18
 * Callers:
...
__int64 __fastcall std::_Conditionally_enabled_hash<std::wstring,1>::operator()(unsigned __int8 *a1)
{
  ...
  return std::_Fnv1a_append_bytes((__int64)a1, a1, 2 * v1);
}
