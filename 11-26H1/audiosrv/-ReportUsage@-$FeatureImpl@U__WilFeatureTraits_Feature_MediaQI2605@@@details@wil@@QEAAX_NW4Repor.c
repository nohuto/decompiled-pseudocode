/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2605@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800CF104
 * Callers:
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2605@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x1800CF824 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_MediaQI2605@@@details@wil@@QEAA_N.c)
 * Callees:
...
_UNKNOWN **wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2605>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_MediaQI2605>::GetCachedFeatureEnabledState(a1, &v7);
    v7 = v3;
  }
  WORD2(v8) = 1;
  LODWORD(v8) = 0;
