/*
 * XREFs of _lambda_034c87b344bb69cb11fef3b63041d359_::operator()_std::unique_ptr_CAppSubmixClient_std::default_delete_CAppSubmixClient____const__ @ 0x1800BA930
 * Callers:
 *     std::for_each_std::_Vector_const_iterator_std::_Vector_val_std::_Simple_types_std::unique_ptr_CAppSubmixClient_std::default_delete_CAppSubmixClient___________lambda_034c87b344bb69cb11fef3b63041d359___ @ 0x1800BB330 (std--for_each_std--_Vector_const_iterator_std--_Vector_val_std--_Simple_types_std--unique_ptr_CA.c)
 * Callees:
...
char __fastcall lambda_034c87b344bb69cb11fef3b63041d359_::operator()_std::unique_ptr_CAppSubmixClient_std::default_delete_CAppSubmixClient____const__(
        __int64 a1,
        _QWORD **a2)
{
  ...
  CAppSubmixClient::NotifySubmixClient(v5, v4, 1LL, v6);
