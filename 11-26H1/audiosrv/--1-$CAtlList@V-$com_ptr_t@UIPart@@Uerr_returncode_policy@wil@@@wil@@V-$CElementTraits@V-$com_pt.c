/*
 * XREFs of ??1?$CAtlList@V?$com_ptr_t@UIPart@@Uerr_returncode_policy@wil@@@wil@@V?$CElementTraits@V?$com_ptr_t@UIPart@@Uerr_returncode_policy@wil@@@wil@@@ATL@@@ATL@@QEAA@XZ @ 0x180122DFC
 * Callers:
 *     _CKsNotificationsMonitor::GetDeviceId_::_1_::dtor$3 @ 0x18016B115 (_CKsNotificationsMonitor--GetDeviceId_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
