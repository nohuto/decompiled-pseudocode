        ...
        unsigned int a3)
{
  ...
  const wchar_t *v14; // [rsp+68h] [rbp-8h] BYREF
  ...
  if ( *v6 > 4u && tlgKeywordOn((__int64)v6, 2LL) )
  {
    ...
    v10 = *((_DWORD *)this + 21);
    v11 = *((_DWORD *)this + 20);
    v14 = (const wchar_t *)*((_QWORD *)this + 9);
    v12 = a2;
    v13 = v3;
