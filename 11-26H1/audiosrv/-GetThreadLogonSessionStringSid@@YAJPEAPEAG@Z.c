/*
 * XREFs of ?GetThreadLogonSessionStringSid@@YAJPEAPEAG@Z @ 0x18005EEF8
 * Callers:
...
LABEL_10:
      ...
      v7 = v1 + 4;
      while ( (*v7 & 0xC0000000) != 0xC0000000 )
      {
...
LABEL_11:
  ...
  if ( v5 < 0 )
    AudSrvTraceLoggingErrorHelper("GetThreadLogonSessionStringSid", 399, v5);
