/*
 * XREFs of ??0CAPOWrapperClient@@QEAA@XZ @ 0x18006BBDC
 * Callers:
...
CAPOWrapperClient *__fastcall CAPOWrapperClient::CAPOWrapperClient(CAPOWrapperClient *this)
{
  ...
  *((_BYTE *)this + 170) = 0;
  ...
  {
    CAudioDGProcess::CancelADGTerminationTimer(v2);
