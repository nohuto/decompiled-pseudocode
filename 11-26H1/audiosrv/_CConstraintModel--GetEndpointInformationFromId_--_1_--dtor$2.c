/*
 * XREFs of _CConstraintModel::GetEndpointInformationFromId_::_1_::dtor$2 @ 0x180163912
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CConstraintModel::GetEndpointInformationFromId_::_1_::dtor_2(__int64 a1, __int64 a2)
{
