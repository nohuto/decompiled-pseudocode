/*
 * XREFs of ?AcquireSaDeviceResource@CAudioResourceManager@@UEAAJPEAUEndpointCharacteristicsDescriptor@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@KPEA_K@Z @ 0x1800C54B0
 * Callers:
 *     <none>
 * Callees:
