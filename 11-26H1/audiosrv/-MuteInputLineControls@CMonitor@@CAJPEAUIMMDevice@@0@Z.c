/*
 * XREFs of ?MuteInputLineControls@CMonitor@@CAJPEAUIMMDevice@@0@Z @ 0x180121520
 * Callers:
  ...
  if ( TopologyPartForDevice >= 0 )
  {
    ...
    else if ( v5 == -2147023728 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, (__int64)&WPP_755387bd23fa3df5d8dd9259737f5712_Traceguids);
      }
