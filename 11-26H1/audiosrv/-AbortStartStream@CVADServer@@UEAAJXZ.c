/*
 * XREFs of ?AbortStartStream@CVADServer@@UEAAJXZ @ 0x1801113D0
 * Callers:
...
__int64 __fastcall CVADServer::AbortStartStream(CVADServer *this)
{
  ...
  const wchar_t *v22; // [rsp+A8h] [rbp+58h] BYREF
    ...
    if ( *v4 )
    {
      ...
      if ( v6(v3 + 8, &v20) >= 0 )
      {
        ...
        if ( *v8 > 4u && tlgKeywordOn(*((_QWORD *)v7 + 1), 512LL) )
        {
          ...
          v10 = *v4;
          v19 = v9;
          v11 = (const wchar_t *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v10 + 8) + 64LL))(v10 + 8);
          v12 = *((_QWORD *)this + 22);
          v22 = v11;
