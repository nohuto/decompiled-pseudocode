/*
 * XREFs of ??$copy_to@UIMulticastSessionManager@@@?$com_ptr_t@VCMulticastSessionManager@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAUIMulticastSessionManager@@@Z @ 0x180107074
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  if ( v2 )
  {
    ...
    else if ( !InlineIsEqualGUID(v7, &GUID_bfad858f_c027_44b8_b1c4_5d5a571430bf) )
    {
