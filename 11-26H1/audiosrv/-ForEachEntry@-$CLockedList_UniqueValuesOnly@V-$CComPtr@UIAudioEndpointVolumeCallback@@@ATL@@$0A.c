/*
 * XREFs of ?ForEachEntry@?$CLockedList_UniqueValuesOnly@V?$CComPtr@UIAudioEndpointVolumeCallback@@@ATL@@$0A@@@QEAAJ$$QEAVCListWorker@1@@Z @ 0x18004FE38
 * Callers:
        ...
        void (__fastcall ***a2)(_QWORD, LPCRITICAL_SECTION *))
{
  ...
  try
  {
    ...
    for ( i = (__int64 *)v8; i != *((__int64 **)&v8 + 1); i += 2 )
    {
      v7 = **a2;
