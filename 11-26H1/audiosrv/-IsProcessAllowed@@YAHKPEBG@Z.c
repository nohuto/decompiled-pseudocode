/*
 * XREFs of ?IsProcessAllowed@@YAHKPEBG@Z @ 0x18001F318
 * Callers:
...
__int64 __fastcall IsProcessAllowed(DWORD dwProcessId, const unsigned __int16 *a2)
{
  ...
  *(_OWORD *)v19 = 0LL;
  ...
  if ( v7 )
  {
    ...
    if ( v8 < 0 )
    {
      AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 569, v8);
      goto LABEL_16;
    }
  }
  v5 = 1;
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( pSessionId && v6 && pSessionId != v6 )
      {
        ...
        {
          v11 = v6;
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_55a927f0784e38de47faa537a644ca17_Traceguids);
        }
        v4 = 0;
      }
      else
  ...
  if ( v5 )
  {
    ...
    if ( v9 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_55a927f0784e38de47faa537a644ca17_Traceguids, v9, v11);
      }
    }
  }
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 651, v8);
  if ( v13 )
