/*
 * XREFs of ?Initialize@CStreamResource@Sarm@@QEAAJPEAUIAudioStreamInfo@@KPEBU_GUID@@PEAU__POSITION@@PEBUSPATIAL_STREAM_PROPERTIES@@PEAVCEndpointResourcePool@2@@Z @ 0x180127DE4
 * Callers:
        ...
        struct Sarm::CEndpointResourcePool *a7)
{
  ...
  const wchar_t *v29; // [rsp+B0h] [rbp-9h] BYREF
  ...
  if ( v13 >= 0 )
  {
    ...
    *((_QWORD *)this + 1) = v11;
    ...
    {
      v28 = *((_QWORD *)this + 1);
      v29 = (const wchar_t *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v21 + 72LL))(v21);
      v22 = *((_DWORD *)this + 13);
      v34 = *((_BYTE *)this + 88);
      v23 = *((_DWORD *)this + 17);
      v24 = *((_DWORD *)this + 15);
