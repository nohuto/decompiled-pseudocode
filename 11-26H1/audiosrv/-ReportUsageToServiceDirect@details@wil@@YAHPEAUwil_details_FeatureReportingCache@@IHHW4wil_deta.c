/*
 * XREFs of ?ReportUsageToServiceDirect@details@wil@@YAHPEAUwil_details_FeatureReportingCache@@IHHW4wil_details_ServiceReportingKind@@I_KE@Z @ 0x18006FD40
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x18006FE7C (wil_details_FeatureReporting_RecordUsageInCache.c)
 *     ?EnsureSubscribedToUsageFlush@EnabledStateManager@details@wil@@QEAAXP6AXPEAX@Z@Z @ 0x18006FFFC (-EnsureSubscribedToUsageFlush@EnabledStateManager@details@wil@@QEAAXP6AXPEAX@Z@Z.c)
 ...
 *     ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x1800CC0C0 (-WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z.c)
