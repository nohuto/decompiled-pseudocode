/*
 * XREFs of ?SetUpAudioEffectsWatcher@CAudioStream@@AEAAJXZ @ 0x1800D5EB0
 * Callers:
...
__int64 __fastcall CAudioStream::SetUpAudioEffectsWatcher(CAudioStream *this)
{
  ...
  v2 = (((*((_DWORD *)this + 92) & 1) == 0) + 6) & 0xFFFFFFFD;
  if ( (*((_BYTE *)this + 368) & 2) == 0 )
    v2 = ((*((_DWORD *)this + 92) & 1) == 0) + 6;
  v3 = (struct IUnknown **)((char *)this + 352);
  v4 = *((_QWORD *)this + 44);
  *v3 = 0LL;
  if ( v4 )
