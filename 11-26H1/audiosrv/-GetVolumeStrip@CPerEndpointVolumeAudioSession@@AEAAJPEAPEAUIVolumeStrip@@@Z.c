/*
 * XREFs of ?GetVolumeStrip@CPerEndpointVolumeAudioSession@@AEAAJPEAPEAUIVolumeStrip@@@Z @ 0x18002FC24
 * Callers:
 ...
 *     ?Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ @ 0x18002FE80 (-Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ.c)
        ...
        struct IVolumeStrip **a2)
{
  ...
  if ( !*((_QWORD *)this + 121) )
  {
    ...
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 32LL, &WPP_ee85f21a7da73824226bb42893b0f656_Traceguids, this);
    }
...
LABEL_19:
      AudSrvTraceLoggingErrorHelper("CPerEndpointVolumeAudioSession::GetVolumeStrip", 1672, EndpointVolumeInformation);
      goto LABEL_31;
    }
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x200000) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_ee85f21a7da73824226bb42893b0f656_Traceguids, this);
    }
    EndpointVolumeInformation = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD))v13->lpVtbl[9].Release)(
                                  v13,
                                  ((unsigned __int64)this + 920) & ((unsigned __int128)-(__int128)(unsigned __int64)this >> 64));
    if ( EndpointVolumeInformation < 0 )
    {
      if ( v13 )
        ((void (__fastcall *)(struct IUnknown *))v13->lpVtbl->Release)(v13);
