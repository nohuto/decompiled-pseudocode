/*
 * XREFs of ?FillLevelsInDB@BluetoothVolume@BluetoothControls@@UEAAXIPEAM@Z @ 0x1800DCD70
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      (__int64)this,
                      &v6);
  (*(void (__fastcall **)(__int64, _QWORD, float *))(*(_QWORD *)*TargetedControl + 56LL))(*TargetedControl, a2, a3);
