/*
 * XREFs of ?unconditional_release_ref@?$com_ptr@U?$scoped_input_vector_view@Uguid@winrt@@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@Uguid@winrt@@@std@@@std@@@std@@@impl@winrt@@@winrt@@AEAAXXZ @ 0x1800EED0C
 * Callers:
