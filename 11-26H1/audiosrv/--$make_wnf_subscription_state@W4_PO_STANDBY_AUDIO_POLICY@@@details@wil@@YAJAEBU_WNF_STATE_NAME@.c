/*
 * XREFs of ??$make_wnf_subscription_state@W4_PO_STANDBY_AUDIO_POLICY@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBW4_PO_STANDBY_AUDIO_POLICY@@@Z@wistd@@KPEAPEAU?$wnf_subscription_state@W4_PO_STANDBY_AUDIO_POLICY@@@01@@Z @ 0x1800D6D38
 * Callers:
  ...
  *a4 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *v6 = &wil::details::wnf_subscription_state<enum Microsoft::Bluetooth::Audio::Internal::BluetoothLEAudioSupportedState>::`vftable';
    ...
    if ( v13 == -1 )
    {
      v9 = NtQueryWnfStateData(&WNF_PO_STANDBY_AUDIO_POLICY, 0LL, 0LL, &v13);
      v10 = v9 | 0x10000000;
