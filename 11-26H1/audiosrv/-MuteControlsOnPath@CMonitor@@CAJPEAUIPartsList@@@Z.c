/*
 * XREFs of ?MuteControlsOnPath@CMonitor@@CAJPEAUIPartsList@@@Z @ 0x1801212F0
 * Callers:
...
__int64 __fastcall CMonitor::MuteControlsOnPath(struct IPartsList *a1)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x36u, (__int64)&WPP_755387bd23fa3df5d8dd9259737f5712_Traceguids);
  }
  v6 = 0;
