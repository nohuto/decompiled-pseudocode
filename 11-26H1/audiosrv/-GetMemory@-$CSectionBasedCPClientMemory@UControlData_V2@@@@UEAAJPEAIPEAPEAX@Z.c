/*
 * XREFs of ?GetMemory@?$CSectionBasedCPClientMemory@UControlData_V2@@@@UEAAJPEAIPEAPEAX@Z @ 0x18015F310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSectionBasedCPClientMemory<ControlData_V2>::GetMemory(__int64 a1, _DWORD *a2, void **a3)
{
  unsigned int v6; // ebx
  __int64 v7; // rdx
  void *v8; // rcx
  ...
  if ( a3 )
  {
    ...
    *a2 = 0;
    ...
    if ( !*(_QWORD *)(a1 + 24) )
    {
      v10 = MapViewOfFile(v8, 0xF001Fu, 0, 0, 0x1ACuLL);
      v12 = v10;
      if ( !v10 )
      {
        v13 = 58LL;
