/*
 * XREFs of ?GetVpoContext@CBaseStreamGroupProxy@@UEAAJPEAPEAUIVpoContext@@@Z @ 0x1800FE1C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseStreamGroupProxy::GetVpoContext(CBaseStreamGroupProxy *this, LPVOID *a2)
{
  HRESULT v4; // eax
  unsigned int v5; // ebx
  __int64 v6; // rcx
  ...
  *a2 = 0LL;
  ...
  if ( v4 >= 0 )
  {
    v6 = *((_QWORD *)this + 14);
    v11 = 0LL;
    v7 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 56LL))(v6, &v11);
    v5 = v7;
    if ( v7 >= 0 )
    {
