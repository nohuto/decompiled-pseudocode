/*
 * XREFs of ?ApplicationInteractivityChanged@CApplicationTracker@@EEAAJPEBGW4AppInteractivity@@@Z @ 0x1800BE050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CApplicationTracker::ApplicationInteractivityChanged(__int64 a1, const wchar_t *a2, int a3)
{
  int v6; // eax
  __int64 v7; // rdx
  int v8; // ebx
...
LABEL_13:
  ...
  LOBYTE(v15) = a3 == 1;
  v8 = (*(__int64 (__fastcall **)(__int64, const wchar_t *, __int64))(*(_QWORD *)v20 + 104LL))(v20, a2, v15);
  if ( v8 < 0 )
  {
    v16 = 49LL;
    goto LABEL_13;
