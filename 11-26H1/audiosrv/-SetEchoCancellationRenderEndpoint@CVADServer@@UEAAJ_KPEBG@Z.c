/*
 * XREFs of ?SetEchoCancellationRenderEndpoint@CVADServer@@UEAAJ_KPEBG@Z @ 0x180113A50
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapSz@G@@U2@U?$_tlgWrapperByVal@$03@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapSz@G@@4AEBU?$_tlgWrapperByVal@$03@@@Z @ 0x1800776DC (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapSz@G@@U2@U-$_tlgWrapperByVal@$03@@@-$_tlgWriteTempl.c)
...
__int64 __fastcall CVADServer::SetEchoCancellationRenderEndpoint(CVADServer *this, __int64 a2, unsigned __int16 *a3)
{
  ...
  __int64 v24; // r8
  __int64 v25; // r9
  const wchar_t *v27; // [rsp+40h] [rbp-20h] BYREF
  const wchar_t *v28; // [rsp+48h] [rbp-18h] BYREF
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( v17(v16 + 8, &v33) >= 0 )
    {
      ...
      if ( *v19 > 4u && tlgKeywordOn(*((_QWORD *)v18 + 1), 512LL) )
      {
        ...
        v21 = *((_QWORD *)this + 18);
        v32 = v20;
        v22 = (const wchar_t *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v21 + 8) + 64LL))(v21 + 8);
        v23 = *((_QWORD *)this + 22);
        v27 = v22;
        v28 = a3;
