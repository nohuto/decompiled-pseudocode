/*
 * XREFs of ?BuildSecurityDescriptor@@YAPEAXKK@Z @ 0x180105E34
 * Callers:
...
__int64 __fastcall BuildSecurityDescriptor()
{
  ...
  *(_WORD *)&pIdentifierAuthority.Value[4] = 256;
  v2 = 0;
  v3 = HeapAlloc(g_hHeap, 0, 0x28uLL);
  v4 = v3;
  if ( !v3 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      v6 = 10;
LABEL_6:
      WPP_SF_(v5[2], v6, (__int64)&WPP_62e65b1aa5e43d79debbf88575ed7e0c_Traceguids);
      goto LABEL_54;
    }
    goto LABEL_54;
  }
  ...
  v11 = (struct _ACL *)HeapAlloc(g_hHeap, 0, v10);
  v1 = v11;
  if ( !v11 )
  {
    v5 = WPP_GLOBAL_Control;
...
LABEL_53:
  ...
  v12 = HeapAlloc(g_hHeap, 0, dwBufferLength);
