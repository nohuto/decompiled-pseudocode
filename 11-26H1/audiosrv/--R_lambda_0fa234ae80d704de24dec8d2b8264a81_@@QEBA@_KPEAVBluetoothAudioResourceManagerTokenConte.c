/*
 * XREFs of ??R_lambda_0fa234ae80d704de24dec8d2b8264a81_@@QEBA@_KPEAVBluetoothAudioResourceManagerTokenContext@CBluetoothAudioEndpointResourceManagerProvider@@@Z @ 0x1800F74EC
 * Callers:
...
_BYTE *__fastcall _lambda_0fa234ae80d704de24dec8d2b8264a81_::operator()(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  const wchar_t *v15; // [rsp+48h] [rbp-30h] BYREF
  ...
  if ( !(_BYTE)result )
  {
    ...
    {
      v8 = (const wchar_t *)(*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a3 + 16) + 96LL))(*(_QWORD *)(a3 + 16));
      v9 = *(_QWORD *)(a3 + 16);
      v14 = v8;
      v10 = (const wchar_t *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v9 + 88LL))(v9);
      v11 = *(_QWORD *)(a3 + 16);
      v15 = v10;
