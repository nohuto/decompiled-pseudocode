/*
 * XREFs of __tailMerge_ext_ms_onecore_appmodel_staterepository_internal_l1_1_3_dll @ 0x1800B63BE
 * Callers:
 *     __imp_load_SRDictionaryToPropertySet @ 0x1800B643D (__imp_load_SRDictionaryToPropertySet.c)
 * Callees:
