/*
 * XREFs of ?SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ @ 0x1800F54B4
 * Callers:
...
__int64 __fastcall CConstraintModelResourceManager::SetupKeywordDetectorPriority(CConstraintModelResourceManager *this)
{
  ...
  *((_DWORD *)this + 71) = 32;
  ...
  if ( v3 >= 0 )
  {
    v4 = RegSetValueExW(hKey, L"KeywordDetectorPriority", 0, 4u, v1, 4u);
    v3 = v4;
    if ( v4 > 0 )
