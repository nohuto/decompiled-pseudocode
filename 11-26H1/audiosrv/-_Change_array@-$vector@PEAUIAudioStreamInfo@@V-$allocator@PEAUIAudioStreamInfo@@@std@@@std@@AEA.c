/*
 * XREFs of ?_Change_array@?$vector@PEAUIAudioStreamInfo@@V?$allocator@PEAUIAudioStreamInfo@@@std@@@std@@AEAAXQEAPEAUIAudioStreamInfo@@_K1@Z @ 0x180078248
 * Callers:
...
__int64 __fastcall std::vector<IAudioStreamInfo *>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rcx
  __int64 result; // rax
