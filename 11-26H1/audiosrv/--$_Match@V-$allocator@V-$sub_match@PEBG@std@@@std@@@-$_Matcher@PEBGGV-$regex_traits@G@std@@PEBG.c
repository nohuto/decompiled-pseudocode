/*
 * XREFs of ??$_Match@V?$allocator@V?$sub_match@PEBG@std@@@std@@@?$_Matcher@PEBGGV?$regex_traits@G@std@@PEBG@std@@QEAA_NPEAV?$match_results@PEBGV?$allocator@V?$sub_match@PEBG@std@@@std@@@1@_N@Z @ 0x180133BE0
 * Callers:
  ...
  if ( result )
  {
    if ( a2 )
    {
      std::vector<std::sub_match<unsigned short const *>>::_Resize<std::_Value_init_tag>(
        a2 + 16,
        *(unsigned int *)(a1 + 196));
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 196); *(_QWORD *)(*(_QWORD *)(a2 + 16) + 8 * v14 + 8) = v16 )
      {
        v13 = *(_QWORD *)(a2 + 16);
        v14 = 3 * i;
