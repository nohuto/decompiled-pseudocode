/*
 * XREFs of ??$try_copy@UIApoAcousticEchoCancellation2@@@?$com_ptr_t@UIAudioProcessingObject@@Uerr_returncode_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIApoAcousticEchoCancellation2@@Uerr_returncode_policy@wil@@@1@XZ @ 0x1800C3DA8
 * Callers:
...
_QWORD *__fastcall wil::com_ptr_t<IAudioProcessingObject,wil::err_returncode_policy>::try_copy<IApoAcousticEchoCancellation2>(
        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  if ( v3 )
    (**v3)(v3, &GUID_f235855f_f06d_45b3_a63f_ee4b71509dc2, a2);
  return a2;
}
