        ...
        __int64 a4)
{
  ...
  if ( v6 )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CAppSubmixClientContext>>>((__int64)v6, *(_QWORD *)(a1 + 8));
    std::_Deallocate<16>(
      *(void **)a1,
