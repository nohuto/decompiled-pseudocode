/*
 * XREFs of ??$InternalCallback@G@?$wnf_array_subscription_state@G@details@wil@@QEAAXPEBGK@Z @ 0x1800AB4D4
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_2bd7833d1bf4bcca2b9a6ef873308bfb_@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x1800AB4B0 (-_lambda_invoker_cdecl_@_lambda_2bd7833d1bf4bcca2b9a6ef873308bfb_@@CAJU_WNF_STATE_NAME@@KPEAU_WN.c)
 * Callees:
