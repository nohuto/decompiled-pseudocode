...
void ***__fastcall std::_Format_default<unsigned short const *,std::allocator<std::sub_match<unsigned short const *>>,unsigned short const *,std::back_insert_iterator<std::wstring>>(
        void ***a1,
        _QWORD *a2,
        void **a3,
        unsigned __int16 *a4,
...
LABEL_9:
      ...
      case '&':
        ...
        goto LABEL_9;
      default:
        if ( (unsigned __int16)(*(_WORD *)v11 - 48) > 9u )
        {
          a6 = 36;
          v27 = a3;
...
LABEL_26:
        ...
        v18 = *(unsigned __int16 *)v11 - 48;
        if ( v6 == (unsigned __int16 *)a5 || (v19 = *v6, (unsigned __int16)(v19 - 48) > 9u) )
        {
          v20 = 0;
        }
        else
    ...
    v27 = a3;
    std::back_insert_iterator<std::wstring>::operator=(&v27, &a6, v12);
  }
  *a1 = a3;
  return a1;
}
