/*
 * XREFs of ??1CSpatialProperties@@QEAA@XZ @ 0x1800AE5F0
 * Callers:
...
void __fastcall CSpatialProperties::~CSpatialProperties(CSpatialProperties *this)
{
  ...
  *((_QWORD *)this + 5) = 0LL;
  ...
  wil::com_ptr_t<IAudioPumpDspResourceTrackerToken,wil::err_returncode_policy>::~com_ptr_t<IAudioPumpDspResourceTrackerToken,wil::err_returncode_policy>((char *)this + 64);
