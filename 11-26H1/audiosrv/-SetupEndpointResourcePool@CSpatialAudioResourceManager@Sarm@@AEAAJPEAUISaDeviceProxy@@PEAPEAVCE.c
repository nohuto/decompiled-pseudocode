/*
 * XREFs of ?SetupEndpointResourcePool@CSpatialAudioResourceManager@Sarm@@AEAAJPEAUISaDeviceProxy@@PEAPEAVCEndpointResourcePool@2@@Z @ 0x180126D4C
 * Callers:
        ...
        struct Sarm::CEndpointResourcePool **a3)
{
  ...
  SarmTraceLoggingTracer("Sarm::CSpatialAudioResourceManager::SetupEndpointResourcePool", 242);
  if ( !a2 )
