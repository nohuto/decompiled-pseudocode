/*
 * XREFs of ?SetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@AEBUtagPROPVARIANT@@@Z @ 0x1800676A4
 * Callers:
...
LABEL_14:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetPropertyStoreProperty", 2102, v6);
LABEL_9:
  if ( v9 )
