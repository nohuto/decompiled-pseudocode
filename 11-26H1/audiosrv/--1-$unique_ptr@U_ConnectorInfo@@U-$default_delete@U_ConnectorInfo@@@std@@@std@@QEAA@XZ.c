/*
 * XREFs of ??1?$unique_ptr@U_ConnectorInfo@@U?$default_delete@U_ConnectorInfo@@@std@@@std@@QEAA@XZ @ 0x1800F09D4
 * Callers:
 ...
 *     _EndpointInfo::AddExtendedTopologyInfo_::_1_::dtor$1 @ 0x180169A6B (_EndpointInfo--AddExtendedTopologyInfo_--_1_--dtor$1.c)
 *     _EndpointInfo::AddExtendedTopologyInfo_::_1_::dtor$1_0 @ 0x18016C3F7 (_EndpointInfo--AddExtendedTopologyInfo_--_1_--dtor$1_0.c)
 * Callees:
...
void __fastcall std::unique_ptr<_ConnectorInfo>::~unique_ptr<_ConnectorInfo>(void **a1)
{
  void *v1; // rbx
