/*
 * XREFs of ?RuntimeClassInitialize@CAudioSessionStore@@QEAAJPEAUIAudioSessionInfo@@@Z @ 0x18003FFE4
 * Callers:
...
__int64 __fastcall CAudioSessionStore::RuntimeClassInitialize(CAudioSessionStore *this, struct IAudioSessionInfo *a2)
{
  ...
  __int64 v10; // rdx
  __int64 result; // rax
  __int64 (__fastcall *v12)(struct IAudioPolicyManager *, struct IAudioSessionInfo *, char *); // rdi
  __int64 v13; // rcx
