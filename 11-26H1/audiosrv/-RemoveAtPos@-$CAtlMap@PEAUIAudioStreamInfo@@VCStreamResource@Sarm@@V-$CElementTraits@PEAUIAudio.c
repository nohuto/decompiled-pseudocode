/*
 * XREFs of ?RemoveAtPos@?$CAtlMap@PEAUIAudioStreamInfo@@VCStreamResource@Sarm@@V?$CElementTraits@PEAUIAudioStreamInfo@@@ATL@@V?$CElementTraits@VCStreamResource@Sarm@@@5@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x18012694C
 * Callers:
 ...
 *     _ATL::CAtlMap_IAudioStreamInfo___Sarm::CStreamResource_ATL::CElementTraits_IAudioStreamInfo____ATL::CElementTraits_Sarm::CStreamResource___::SetAt_::_1_::catch$0 @ 0x18016B42E (_ATL--CAtlMap_IAudioStreamInfo___Sarm--CStreamResource_ATL--CElementTraits_IAudioSt_ea_18016B42E.c)
 * Callees:
