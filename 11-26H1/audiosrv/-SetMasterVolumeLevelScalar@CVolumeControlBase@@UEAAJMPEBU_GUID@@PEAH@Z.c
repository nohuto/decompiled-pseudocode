/*
 * XREFs of ?SetMasterVolumeLevelScalar@CVolumeControlBase@@UEAAJMPEBU_GUID@@PEAH@Z @ 0x1800508D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qggg @ 0x18011A338 (WPP_SF_qggg.c)
        ...
        int *a4)
{
  ...
  if ( a2 != Wiper )
  {
    ...
    if ( v14 < *((_QWORD *)this + 11) )
    {
      v15 = fmaxf(
              fminf(
                *(float *)(((unsigned __int64)(unsigned int)v14 << 6) + *v9 + 4),
                *(float *)(((unsigned __int64)(unsigned int)v14 << 6) + *v9 + 12)),
              *(float *)(((unsigned __int64)(unsigned int)v14 << 6) + *v9 + 8));
      if ( v13 != &WPP_GLOBAL_Control && (*((_DWORD *)v13 + 7) & 0x10000) != 0 && *((_BYTE *)v13 + 25) >= 4u )
        WPP_SF_qdg(v13[2], 24LL, &WPP_d2cd8b4ef06a3deb09d49ba9c3c05c3d_Traceguids, this, v14, a2);
      ...
      if ( v16 < *((_QWORD *)this + 11) )
      {
        ...
        *((_DWORD *)this + 55) = v21;
        ...
        v36 = (*(__int64 (__fastcall **)(CVolumeControlBase *, _QWORD))(*(_QWORD *)this + 256LL))(this, 0LL);
        v18 = v36;
        if ( v36 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
