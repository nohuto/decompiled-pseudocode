/*
 * XREFs of ?SarmTraceLoggingTracer@@YAXPEBDI@Z @ 0x18005CCB0
 * Callers:
...
void __fastcall SarmTraceLoggingTracer(const char *a1, int a2)
{
  ...
  if ( (unsigned int)dword_1801D32B0 > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Level = 5;
    UserData.Ptr = (ULONGLONG)off_1801D32B8;
    v10 = a1;
    v12 = 0;
    EventDescriptor.Keyword = 0LL;
    *(_DWORD *)&EventDescriptor.Id = 184549376;
    UserData.Size = *(unsigned __int16 *)off_1801D32B8;
    v7 = &unk_1801A85E9;
    v9 = 1;
    UserData.Reserved = 2;
    v8 = 21;
    v4[1] = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EventWriteTransfer(qword_1801D32D0, &EventDescriptor, 0LL, 0LL, 4u, &UserData);
  }
}
