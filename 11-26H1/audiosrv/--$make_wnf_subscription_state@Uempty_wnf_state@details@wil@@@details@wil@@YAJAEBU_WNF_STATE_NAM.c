/*
 * XREFs of ??$make_wnf_subscription_state@Uempty_wnf_state@details@wil@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXXZ@wistd@@KPEAPEAU?$wnf_subscription_state@Uempty_wnf_state@details@wil@@@01@@Z @ 0x18008451C
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v14 != -1 )
    goto LABEL_9;
  v10 = NtQueryWnfStateData(a1, 0LL, 0LL, &v14);
  v11 = v10 | 0x10000000;
  if ( v10 >= 0 || v11 == -805306333 )
  {
    v9 = v14;
LABEL_9:
    v15 = v8 + 1;
