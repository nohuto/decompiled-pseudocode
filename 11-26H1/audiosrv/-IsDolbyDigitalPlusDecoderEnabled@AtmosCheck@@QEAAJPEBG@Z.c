/*
 * XREFs of ?IsDolbyDigitalPlusDecoderEnabled@AtmosCheck@@QEAAJPEBG@Z @ 0x18015623C
 * Callers:
 *     wistd::__function::__func__lambda_ec7260462f53004eb0edc67dd5e05be0__long___cdecl(void)_::operator() @ 0x180155690 (wistd--__function--__func__lambda_ec7260462f53004eb0edc67dd5e05be0__long___cdecl(void)_--operato.c)
 * Callees:
