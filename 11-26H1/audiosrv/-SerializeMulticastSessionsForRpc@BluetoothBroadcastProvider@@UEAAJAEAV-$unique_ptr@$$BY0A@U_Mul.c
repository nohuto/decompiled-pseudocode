/*
 * XREFs of ?SerializeMulticastSessionsForRpc@BluetoothBroadcastProvider@@UEAAJAEAV?$unique_ptr@$$BY0A@U_MulticastSessionConfiguration@@U?$function_deleter@P6AXPEAX@Z$1?MIDL_user_free@@YAX0@Z@wil@@@wistd@@PEAI@Z @ 0x1800ED520
 * Callers:
 *     <none>
 * Callees:
    ...
    while ( v8 != v9 )
    {
      if ( *(_QWORD *)(v8 + 16) )
      {
        ...
        *(_OWORD *)((char *)v30 + 8 * v12) = *(_OWORD *)v8;
        ...
        do
          ++v11;
        while ( *(_WORD *)(*(_QWORD *)(v8 + 16) + 2 * v11) );
        v13 = v11 + 1;
        v14 = MIDL_user_allocate(2 * (v11 + 1));
        *(_QWORD *)&v10[2 * v12 + 4] = v14;
        if ( !v14 )
        {
          v26 = 470LL;
          goto LABEL_25;
...
LABEL_25:
          ...
          while ( v17 != v18 )
          {
            ...
            v20 = v19 + 1;
            *(_QWORD *)(*(_QWORD *)&v10[2 * v12 + 8] + 8LL * (unsigned int)v10[2 * v12 + 6]) = MIDL_user_allocate(2 * (v19 + 1));
            v21 = *(_QWORD *)(*(_QWORD *)&v10[2 * v12 + 8] + 8LL * (unsigned int)v10[2 * v12 + 6]);
            if ( !v21 )
            {
              v23 = -2147024882;
              wil::details::in1diag3::Return_Hr(
