/*
 * XREFs of ?GetRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18012A9C4
 * Callers:
 *     PolicyConfigGetDynamicRoutingRule @ 0x18010D5A0 (PolicyConfigGetDynamicRoutingRule.c)
 * Callees:
