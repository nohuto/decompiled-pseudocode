/*
 * XREFs of ?GetEffectsList@CCompositeSystemEffect@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x1800699E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Add@?$CSimpleArray@PEAU_GUID@@V?$CSimpleArrayEqualHelper@PEAU_GUID@@@ATL@@@ATL@@QEAAHAEBQEAU_GUID@@@Z @ 0x1800AE3FC (-Add@-$CSimpleArray@PEAU_GUID@@V-$CSimpleArrayEqualHelper@PEAU_GUID@@@ATL@@@ATL@@QEAAHAEBQEAU_GU.c)
 *     ?Add@?$CSimpleArray@IV?$CSimpleArrayEqualHelper@I@ATL@@@ATL@@QEAAHAEBI@Z @ 0x1800AE4A4 (-Add@-$CSimpleArray@IV-$CSimpleArrayEqualHelper@I@ATL@@@ATL@@QEAAHAEBI@Z.c)
        ...
        void *a4)
{
  ...
  *a3 = 0;
  ...
  {
    v15 = 16LL * v7;
    v16 = (struct _GUID *)CoTaskMemAlloc(v15);
    v32 = v16;
    if ( !v16 )
    {
      if ( v14 )
