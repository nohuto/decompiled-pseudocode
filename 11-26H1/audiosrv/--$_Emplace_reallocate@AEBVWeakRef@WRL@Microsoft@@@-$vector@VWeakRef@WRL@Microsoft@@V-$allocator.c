/*
 * XREFs of ??$_Emplace_reallocate@AEBVWeakRef@WRL@Microsoft@@@?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@AEAAPEAVWeakRef@WRL@Microsoft@@QEAV234@AEBV234@@Z @ 0x180046EC0
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)v12 = *a3;
  ...
  std::vector<Microsoft::WRL::WeakRef>::_Reallocation_guard::~_Reallocation_guard(v18);
  return v12;
}
