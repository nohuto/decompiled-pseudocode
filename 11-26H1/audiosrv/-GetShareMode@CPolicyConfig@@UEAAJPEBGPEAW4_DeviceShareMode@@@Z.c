/*
 * XREFs of ?GetShareMode@CPolicyConfig@@UEAAJPEBGPEAW4_DeviceShareMode@@@Z @ 0x18010BEA0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _DeviceShareMode *a3)
{
  ...
  if ( PropertyStoreProperty < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetShareMode", 1259, PropertyStoreProperty);
