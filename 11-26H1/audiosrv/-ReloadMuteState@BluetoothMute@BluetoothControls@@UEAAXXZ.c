/*
 * XREFs of ?ReloadMuteState@BluetoothMute@BluetoothControls@@UEAAXXZ @ 0x1800DD840
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BluetoothControls::BluetoothMute::ReloadMuteState(BluetoothControls::BluetoothMute *this)
{
  ...
  TargetedControl = BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::GetTargetedControl(
                      (__int64)this,
                      &v2);
  (*(void (__fastcall **)(__int64))(*(_QWORD *)*TargetedControl + 48LL))(*TargetedControl);
