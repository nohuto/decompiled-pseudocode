/*
 * XREFs of _CConstraintModel::Initialize_::_1_::catch$21 @ 0x18016C619
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CConstraintModel::Initialize_::_1_::catch_21(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
  *(_DWORD *)(a2 + 68) = wil::details::in1diag3::Return_CaughtException(
                           *(wil::details::in1diag3 **)(a2 + 2056),
                           (void *)0x140,
