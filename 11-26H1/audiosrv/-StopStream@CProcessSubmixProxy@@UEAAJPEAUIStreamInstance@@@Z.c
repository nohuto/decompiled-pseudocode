/*
 * XREFs of ?StopStream@CProcessSubmixProxy@@UEAAJPEAUIStreamInstance@@@Z @ 0x180020590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcessSubmixProxy::StopStream(unsigned __int64 this, struct IStreamInstance *a2)
{
  ...
  cbDest[1] = v5;
  StringCchPrintfExA(pszDest, 0x40uLL, &v15, cbDest, 0, "%s", "ProcessSubmix_StreamStop");
