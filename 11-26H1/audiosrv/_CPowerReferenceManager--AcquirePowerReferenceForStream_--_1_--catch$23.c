/*
 * XREFs of _CPowerReferenceManager::AcquirePowerReferenceForStream_::_1_::catch$23 @ 0x180162DDD
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPowerReferenceManager::AcquirePowerReferenceForStream_::_1_::catch_23(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
