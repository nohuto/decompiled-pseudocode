/*
 * XREFs of ?OnVolumeChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@M_NPEBU_GUID@@@Z @ 0x180064800
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Sgd @ 0x1800D1428 (WPP_SF_Sgd.c)
 */
  ...
  if ( v10 )
  {
    ...
    if ( v14 )
    {
      ...
      *(GUID *)(v16 + 7) = v20;
      v16[6] = v12;
      *((_BYTE *)v16 + 52) = a4;
      v21 = *(_QWORD *)(*((_QWORD *)this + 9) + 656LL);
      if ( v18 )
      {
        v15 = 2147483646 - v18;
        v21 -= (__int64)v19;
