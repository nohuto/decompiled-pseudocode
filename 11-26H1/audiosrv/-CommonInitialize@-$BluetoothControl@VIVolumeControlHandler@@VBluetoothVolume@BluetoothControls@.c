/*
 * XREFs of ?CommonInitialize@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@AEAAXPEAUIMMDevice@@@Z @ 0x1800DCACC
 * Callers:
...
void __fastcall BluetoothControls::BluetoothControl<IVolumeControlHandler,BluetoothControls::BluetoothVolume>::CommonInitialize(
        __int64 a1,
        __int64 *a2)
{
  ...
  do
    ++v7;
  while ( v24[v7] );
  std::wstring::assign((char *)(a1 + 48), v24, v7);
