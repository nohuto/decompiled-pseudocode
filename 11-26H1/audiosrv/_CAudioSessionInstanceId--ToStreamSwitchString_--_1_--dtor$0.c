/*
 * XREFs of _CAudioSessionInstanceId::ToStreamSwitchString_::_1_::dtor$0 @ 0x1801633B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::ToStreamSwitchString_::_1_::dtor_0(__int64 a1, __int64 a2)
{
