/*
 * XREFs of ?VolumeStepUp@CVolumeControlBase@@UEAAJPEBU_GUID@@PEAH@Z @ 0x180080880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeControlBase::VolumeStepUp(CVolumeControlBase *this, const struct _GUID *a2, int *a3)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_d2cd8b4ef06a3deb09d49ba9c3c05c3d_Traceguids);
  }
  v6 = *(_QWORD *)this;
  v13 = 0.0;
