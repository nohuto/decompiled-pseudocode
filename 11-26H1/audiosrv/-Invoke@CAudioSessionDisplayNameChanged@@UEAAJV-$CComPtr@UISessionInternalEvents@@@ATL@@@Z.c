/*
 * XREFs of ?Invoke@CAudioSessionDisplayNameChanged@@UEAAJV?$CComPtr@UISessionInternalEvents@@@ATL@@@Z @ 0x1800CE930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSessionDisplayNameChanged::Invoke(_QWORD *a1, __int64 *a2)
{
  ...
  v3 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD))(*(_QWORD *)*a2 + 24LL))(
         *a2,
