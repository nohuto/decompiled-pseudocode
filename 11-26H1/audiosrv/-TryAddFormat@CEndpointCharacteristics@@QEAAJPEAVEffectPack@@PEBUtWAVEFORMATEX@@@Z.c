/*
 * XREFs of ?TryAddFormat@CEndpointCharacteristics@@QEAAJPEAVEffectPack@@PEBUtWAVEFORMATEX@@@Z @ 0x18013DEF8
 * Callers:
 ...
 *     ?GetOemEnginePeriodicity@CEndpointCharacteristics@@AEAA_JXZ @ 0x1800849EC (-GetOemEnginePeriodicity@CEndpointCharacteristics@@AEAA_JXZ.c)
