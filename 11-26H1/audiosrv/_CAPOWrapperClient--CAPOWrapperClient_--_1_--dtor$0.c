/*
 * XREFs of _CAPOWrapperClient::CAPOWrapperClient_::_1_::dtor$0 @ 0x18016616C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAPOWrapperClient::CAPOWrapperClient_::_1_::dtor_0(__int64 a1, __int64 a2)
{
