/*
 * XREFs of ?PopulateControllableEffects@AudioModeEffectsWatcher@@AEAAJPEAUEndpointCharacteristicsDescriptor@@@Z @ 0x18003FDBC
 * Callers:
        ...
        struct EndpointCharacteristicsDescriptor *a2)
{
  ...
  const wchar_t *v22; // [rsp+58h] [rbp-80h] BYREF
  ...
  *v4 = 0LL;
  ...
  ModeEffect = EffectPack::GetModeEffect(v3, (__m128i *)&v23, 1LL, 0, v4, &v19, 0LL);
  v7 = ModeEffect;
  if ( ModeEffect >= 0 )
  {
    ...
    if ( v10 != v9 )
    {
      std::_Destroy_range<std::allocator<wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>>>(v10, v9);
    ...
    if ( v13 >= 0 )
    {
      ...
      if ( *v15 > 4u && (unsigned __int8)tlgKeywordOn(v15, 256LL) )
      {
        ...
        v21 = (__int64)this + 48;
        v22 = (const wchar_t *)*((_QWORD *)this + 5);
        *(_QWORD *)&v23.Data1 = *v4;
