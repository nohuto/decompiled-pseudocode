/*
 * XREFs of ??$AcquireToken@PEAUIBtAudioResourceManager@@@?$TokenManager@VCBluetoothAudioEndpointResourceManagerProvider@@@@QEAAJAEBQEAUIBtAudioResourceManager@@W4TOKEN_ACQUIRE_OPTION@@PEAPEAUIUnknown@@@Z @ 0x1800F6600
 * Callers:
 *     ?AcquireToken@CBluetoothAudioEndpointResourceManagerProvider@@UEAAJPEAUIBtAudioResourceManager@@W4TOKEN_ACQUIRE_OPTION@@PEAPEAUIUnknown@@@Z @ 0x1800F77C0 (-AcquireToken@CBluetoothAudioEndpointResourceManagerProvider@@UEAAJPEAUIBtAudioResourceManager@@.c)
 * Callees:
