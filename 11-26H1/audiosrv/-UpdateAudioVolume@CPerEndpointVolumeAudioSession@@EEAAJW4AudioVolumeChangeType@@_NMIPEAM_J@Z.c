/*
 * XREFs of ?UpdateAudioVolume@CPerEndpointVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x18001F120
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( VolumeStrip >= 0 )
      {
        ...
        if ( a5 )
        {
          ...
          do
          {
            ...
            {
              WPP_SF_dg(v18[2], 70LL, &WPP_ee85f21a7da73824226bb42893b0f656_Traceguids, v15, (float)(a4 * *v17));
              v18 = WPP_GLOBAL_Control;
            }
            if ( v15 < v22 )
            {
