/*
 * XREFs of ?SignalSpatialRelatedChange@CSpatialProperties@@SAJPEBU_tlgProvider_t@@PEAUIPropertyStore@@W4SignalingKeySource@@@Z @ 0x180146DC4
 * Callers:
...
__int64 __fastcall CSpatialProperties::SignalSpatialRelatedChange(_DWORD *a1, __int64 a2, char a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  if ( *a1 > 4u && tlgKeywordOn((__int64)a1, 16LL) )
  {
    ...
    v16 = &v12;
    v17 = 2LL;
    tlgWriteTransfer_EtwEventWriteTransfer(v4, byte_1801AE240, 0LL, 0LL, 5, (__int64)v15);
  }
