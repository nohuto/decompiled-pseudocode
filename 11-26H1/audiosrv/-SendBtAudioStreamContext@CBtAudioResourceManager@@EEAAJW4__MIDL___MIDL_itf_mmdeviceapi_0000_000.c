/*
 * XREFs of ?SendBtAudioStreamContext@CBtAudioResourceManager@@EEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4BTAudio_StreamContext@@@Z @ 0x1800DF6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBtAudioResourceManager::SendBtAudioStreamContext(__int64 a1, int a2, int a3)
{
  ...
  if ( *(_DWORD *)(a1 + 516) && !a2 )
  {
    FileW = CreateFileW(*(LPCWSTR *)(a1 + 624), 0xC0000000, 3u, 0LL, 3u, 0x80u, 0LL);
    v10 = FileW;
