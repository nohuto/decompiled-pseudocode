/*
 * XREFs of UsbhGenDispatch @ 0x140024630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhGenDispatch(ULONG_PTR a1, IRP *a2)
{
  ...
  if ( v4 != 1329877064 )
  {
    ...
    if ( (unsigned __int8)MajorFunction <= 0x1Bu )
      return ((__int64 (__fastcall *)(ULONG_PTR, IRP *))*(&off_1400652B8 + 2 * MajorFunction))(a1, a2);
LABEL_9:
  ...
  if ( (unsigned __int8)v5 > 0x1Bu )
    goto LABEL_9;
  return funcs_140024669[2 * v5](a1, (ULONG_PTR)a2);
}
