/*
 * XREFs of UsbhExceptionTrace @ 0x140033C60
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( a3 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        {
          if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
            WPP_RECORDER_SF_qq(WPP_GLOBAL_Control->DeviceExtension, a2, a3, a4, v13, v5, a1);
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
              WPP_RECORDER_SF_ds(
              ...
              if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              {
                ...
                if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                {
                  ...
                  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                  {
                    ...
                    {
                      v7 = (__int128 *)log_xstr(v16, *(unsigned __int16 *)(v5 + 32), *(_QWORD *)(v5 + 40), a4);
                      v9 = *(_QWORD *)(v8 + 64);
                      v15 = *v7;
