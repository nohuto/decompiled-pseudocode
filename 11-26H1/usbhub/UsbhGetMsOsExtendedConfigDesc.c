/*
 * XREFs of UsbhGetMsOsExtendedConfigDesc @ 0x140042CA4
 * Callers:
 ...
 *     USBD_ValidateExtendedConfigurationDescriptor @ 0x140041F7C (USBD_ValidateExtendedConfigurationDescriptor.c)
