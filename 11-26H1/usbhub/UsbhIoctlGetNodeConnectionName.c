/*
 * XREFs of UsbhIoctlGetNodeConnectionName @ 0x140025250
 * Callers:
...
{
  char v6; // di
  unsigned __int16 *MasterIrp; // r12
  __int64 v8; // rdx
  __int64 v9; // rcx
  _DWORD *v10; // rax
  __int64 v11; // r8
  ...
  v10 = FdoExt(a1);
  v35 = (_QWORD *)UsbhIncHubBusy(a1, (__int64)(v10 + 434), (__int64)a2, 1430414185, 1);
  v11 = 4027383811LL;
  if ( v35 )
  {
    if ( (UsbhLogMask & 0x20) != 0 )
    ...
    *(_DWORD *)((char *)v16 + v18 + 40) = -267583485;
    ...
    if ( (HubPdoName & 0xC0000000) != 0xC0000000 )
    {
      ...
      if ( (HubPdoName & 0xC0000000) != 0xC0000000 )
      {
        v32 = UsbhLatchPdo(a1, *MasterIrp, (__int64)a2, 0x496C3033u);
        if ( v32 )
        {
          v33 = Size;
          v36 = 0;
          memset(MasterIrp, 0, (unsigned int)Size);
          HubPdoName = UsbhGetHubPdoName(a1, v32, MasterIrp + 2, v33 - 4, &v36);
          v34 = v36;
          if ( v36 >= 4 )
  ...
  {
    UsbhException(a1, 0, 91, &v38, 4u, HubPdoName, 0, usbfile_ioctl_c, 1740, 0, v35);
    v11 = 4027383811LL;
  }
  if ( v6 )
  {
