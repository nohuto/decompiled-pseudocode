/*
 * XREFs of UsbhPdoPnp_QueryDeviceText @ 0x1400352F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_QueryDeviceText(__int64 a1, IRP *a2)
{
  ...
  else
  {
    ...
    v3 = (__int64)(v10 + 540);
    Status = UsbhGetProductIdString(*((_QWORD *)v10 + 148), a1, Size, v10 + 540);
    if ( Status == -1073741637 && Size != 1033 )
      Status = UsbhGetProductIdString(*((_QWORD *)v10 + 148), *((_QWORD *)v10 + 105), 1033LL, v10 + 540);
