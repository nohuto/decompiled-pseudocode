/*
 * XREFs of UsbhLogStartFailure @ 0x14003D85C
 * Callers:
...
void __fastcall UsbhLogStartFailure(__int64 a1, int a2, int a3, __int64 a4, __int64 a5, _BYTE *Src)
{
  int v9; // edx
  int v10; // r8d
  int v11; // r9d
  ...
  while ( Src[v15] );
  v16 = v15 + 533;
  Pool2 = (_DWORD *)ExAllocatePool2(64LL, (unsigned int)(v15 + 533), 1112885333LL);
  v18 = Pool2;
  if ( Pool2 )
  {
    *Pool2 = v16;
    ...
    if ( *((_QWORD *)v14 + 111) )
    {
      ...
      {
        v22 = v14[221] & v20;
        v23 = (_OWORD *)(*((_QWORD *)v14 + 111) + 32LL * v22);
        v20 = v22 + 1;
        *v19 = *v23;
        v19[1] = v23[1];
        v19 += 2;
