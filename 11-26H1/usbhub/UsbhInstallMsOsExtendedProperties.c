/*
 * XREFs of UsbhInstallMsOsExtendedProperties @ 0x1400431A4
 * Callers:
 ...
 *     USBD_InstallExtPropDescSections @ 0x140041A9C (USBD_InstallExtPropDescSections.c)
 *     USBD_ValidateExtendedPropertyDescriptor @ 0x1400421CC (USBD_ValidateExtendedPropertyDescriptor.c)
