/*
 * XREFs of UsbhAddDevice @ 0x14004F580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhAddDevice(PDRIVER_OBJECT DriverObject, PDEVICE_OBJECT TargetDevice)
{
  ...
  v6 = IoCreateDevice(DriverObject, (dword_1400705E8 << 12) + 5288, 0LL, 0x8600u, 0x80u, 0, &SourceDevice);
  if ( v6 >= 0 )
  {
    if ( !SourceDevice )
      return 3221225473LL;
  ...
  *(__m128i *)(DeviceExtension + 1268) = si128;
  ...
  UsbhLogAlloc(SourceDevice, DeviceExtension + 880, (unsigned int)dword_1400705E8);
  v11 = SourceDevice;
