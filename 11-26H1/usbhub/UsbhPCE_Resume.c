/*
 * XREFs of UsbhPCE_Resume @ 0x140013878
 * Callers:
...
__int64 __fastcall UsbhPCE_Resume(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v7; // rdx
  __int64 v8; // r8
  ...
  if ( (_WORD)v4 )
  {
    ...
    if ( (unsigned __int16)v4 <= *(unsigned __int8 *)(result + 2938) )
    {
      ...
      if ( v24 )
      {
        ...
        if ( v25 )
          return UsbhDispatch_PortChangeQueueNullEvent(a1, v25, 3LL, a2);
      }
    }
  }
  return result;
