/*
 * XREFs of UsbhBuildContainerID @ 0x140059F30
 * Callers:
 ...
 *     RtlStringCopyWorkerW @ 0x140059A04 (RtlStringCopyWorkerW.c)
 *     RtlStringLengthWorkerW @ 0x140059A60 (RtlStringLengthWorkerW.c)
 */
