/*
 * XREFs of Usbh_PCE_HW_Stop_Action @ 0x140044DF8
 * Callers:
...
void __fastcall Usbh_PCE_HW_Stop_Action(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  KIRQL v37; // [rsp+58h] [rbp+10h] BYREF
  ...
  v8 = UsbhLockPcqWithTag(a1, a2, 17, &v37, 0);
...
LABEL_28:
    ...
    UsbhSetPcqEventStatus(a1, a2, 2, 30);
    v31 = *(unsigned int *)(a2 + 2400);
    *(_DWORD *)(a2 + 12) = v32 - 15;
    *(_DWORD *)(32 * v31 + a2 + 1384) = v32 - 15;
    UsbhFlushPortChangeQueue(a1, a2, v33, v32);
    KeSetEvent((PRKEVENT)(a2 + 472), 0, 0);
    UsbhiSignalResumeEvent(a1, a2, v34, v35);
    goto LABEL_29;
  }
  if ( v10 == 10 )
    goto LABEL_27;
...
LABEL_29:
  UsbhUnlockPcqWithTag(a1, a2, v37, 0);
}
