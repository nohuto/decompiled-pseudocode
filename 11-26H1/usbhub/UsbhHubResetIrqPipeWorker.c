/*
 * XREFs of UsbhHubResetIrqPipeWorker @ 0x1400475E0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( ((unsigned __int16)v8 & 0x1000) != 0 )
  {
    ...
    if ( (v9 & 0xC0000000) == 0xC0000000 )
    {
      ...
      else
      {
        ...
        KeSetEvent(v11, 0, 0);
        if ( !*((_BYTE *)v6 + 5268) )
          UsbhException((__int64)DeviceObject, 0, 7, 0LL, 0, v9, 0, usbfile_bus_c, 2768, 1);
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          goto LABEL_14;
        v13 = WPP_GLOBAL_Control;
        if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
...
LABEL_14:
    ...
    UsbhPostInterrupt(DeviceObject, v15, v16, v17);
