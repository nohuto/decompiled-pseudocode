/*
 * XREFs of Endpoint_SM_WasDoorbellRungSinceMappingStart @ 0x140032C1C
 * Callers:
 *     ESM_CheckingIfEndpointShouldBeStopped @ 0x140032C00 (ESM_CheckingIfEndpointShouldBeStopped.c)
 * Callees:
