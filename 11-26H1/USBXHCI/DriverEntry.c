/*
 * XREFs of DriverEntry @ 0x140079BD0
 * Callers:
 *     FxDriverEntryWorker @ 0x140056734 (FxDriverEntryWorker.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x140047574 (McGenEventRegister_EtwRegister.c)
 *     InitializeTelemetryAssertsKMByDriverObject @ 0x140057738 (InitializeTelemetryAssertsKMByDriverObject.c)
 ...
 *     wil_UninitializeFeatureStaging @ 0x14007A63C (wil_UninitializeFeatureStaging.c)
 *     Counter_Register @ 0x14007EC10 (Counter_Register.c)
