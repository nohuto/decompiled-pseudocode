/*
 * XREFs of UsbDevice_StopEndpointToOffloadedEndpointCompletion @ 0x140037500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbDevice_StopEndpointToOffloadedEndpointCompletion(__int64 a1, char a2, int a3, int a4)
{
  __int64 result; // rax
  __int64 v6; // rcx
