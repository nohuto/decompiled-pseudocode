/*
 * XREFs of Controller_PopulateDeviceFlagsFromRegistry @ 0x140076380
 * Callers:
...
__int64 __fastcall Controller_PopulateDeviceFlagsFromRegistry(__int64 *a1, int a2)
{
  ...
  {
    LOBYTE(v7) = 3;
    result = WPP_RECORDER_SF_d(a1[9], v7, 4, 168, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, result);
  }
  v8 = v14;
  if ( v14 )
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    {
      LOBYTE(v8) = 5;
      result = WPP_RECORDER_SF_d(a1[9], v8, 4, 169, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, a2);
    }
  }
  v9 = 0;
  v10 = a1 + 92;
