/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x14003279C
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x140046428 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x140032894 (wil_details_FeatureReporting_RecordUsageInCache.c)
