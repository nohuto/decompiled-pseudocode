/*
 * XREFs of XilCommand_SendAbortRingCommandRequest @ 0x14003FAA8
 * Callers:
...
void __fastcall XilCommand_SendAbortRingCommandRequest(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rax
  __int64 v3; // rcx
  ...
  if ( v4 >= 0 )
  {
    if ( v7 < 0 )
    {
      ...
      Debug_FreAssertMsg(
        (__int64)"IOCTL succeeded but CommandAbortRing failed in VTL-1 failed",
        0,
