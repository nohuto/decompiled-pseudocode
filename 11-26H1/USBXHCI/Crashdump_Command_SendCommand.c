/*
 * XREFs of Crashdump_Command_SendCommand @ 0x14005342C
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x1400537AC (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x14005412C (Crashdump_Endpoint_SetDequeuePointer.c)
...
__int64 __fastcall Crashdump_Command_SendCommand(__int64 a1, __int64 a2, _OWORD *a3)
{
  ...
  *(_DWORD *)(*(_QWORD *)(**(_QWORD **)(a1 + 8) + 48LL) & -(__int64)(*(_QWORD *)(**(_QWORD **)(a1 + 8) + 48LL) != 0LL)) = 0;
  _InterlockedOr(v14, 0);
  v8 = *(_QWORD *)a1;
