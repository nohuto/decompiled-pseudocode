/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x14007A020
 * Callers:
 *     InitializeTelemetryAssertsKMWorkerInternal @ 0x14005783C (InitializeTelemetryAssertsKMWorkerInternal.c)
