/*
 * XREFs of Controller_PopulatePciDeviceInformation @ 0x140076D3C
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v17 = a4;
    v15 = a3;
    WPP_RECORDER_SF_ddd(a1, 4u, 4u, 0x89u, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, a2, v15, v17);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
