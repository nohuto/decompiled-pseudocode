/*
 * XREFs of DriverCleanup @ 0x140079AF0
 * Callers:
 *     <none>
 * Callees:
 *     McGenEventUnregister_EtwUnregister @ 0x1400475A8 (McGenEventUnregister_EtwUnregister.c)
 *     UninitializeTelemetryAssertsKM @ 0x140058158 (UninitializeTelemetryAssertsKM.c)
