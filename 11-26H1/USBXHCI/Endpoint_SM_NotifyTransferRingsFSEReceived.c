/*
 * XREFs of Endpoint_SM_NotifyTransferRingsFSEReceived @ 0x14001D3A4
 * Callers:
 *     ESM_NotifyingTransferRingsFSEReceived @ 0x14001D380 (ESM_NotifyingTransferRingsFSEReceived.c)
 * Callees:
