/*
 * XREFs of ESM_RunStateMachine @ 0x140020FDC
 * Callers:
 ...
 *     ESM_GetNextEvent @ 0x1400219C0 (ESM_GetNextEvent.c)
              ...
              0LL) )
      {
        ...
        *a3 = result;
        ...
        if ( v17 != v15 )
        {
          ...
          while ( v17 != Context[948] );
        }
        *(_DWORD *)&Context[4 * (unsigned __int8)Context[948] + 884] = 1000;
