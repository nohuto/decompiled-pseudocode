/*
 * XREFs of Device_WdfEvtCleanupCallback @ 0x140044BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Device_WdfEvtCleanupCallback(__int64 a1)
{
  ...
  *(_QWORD *)(v2 + 16) = 0LL;
  if ( v4 )
  {
    result = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64 (__fastcall *)(), __int64, const char *))(WdfFunctions_01033 + 1648))(
               WdfDriverGlobals,
               *(_QWORD *)(v4 + 8),
