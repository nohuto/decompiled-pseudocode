/*
 * XREFs of RootHub_Create @ 0x14007D704
 * Callers:
...
__int64 __fastcall RootHub_Create(__int64 a1, __int64 a2, __int64 **a3)
{
  ...
  v11 = off_14006B0B0;
  v10[3] = 0x100000001LL;
  v7 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, _QWORD *, __int64 *))qword_14006BC28)(
         UcxDriverGlobals,
         v5,
         v12,
         v10,
  ...
  if ( v7 < 0 )
  {
    ...
    {
      LOBYTE(v6) = 2;
      WPP_RECORDER_SF_d(*(_QWORD *)(a2 + 72), v6, 11, 11, (__int64)&WPP_ae3f3dc960bf3cde3d0f419b97453dd4_Traceguids, v7);
    }
  }
  else
  {
