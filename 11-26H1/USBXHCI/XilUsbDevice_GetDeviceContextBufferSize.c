/*
 * XREFs of XilUsbDevice_GetDeviceContextBufferSize @ 0x14003D7E4
 * Callers:
...
__int64 __fastcall XilUsbDevice_GetDeviceContextBufferSize(__int64 a1, char a2, int a3, int a4)
{
  unsigned int v4; // ebx
  __int64 v5; // rax
