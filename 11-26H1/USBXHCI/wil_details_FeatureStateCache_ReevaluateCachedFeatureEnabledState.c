/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1400464B0
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x140046614 (wil_details_GetCurrentFeatureEnabledState.c)
