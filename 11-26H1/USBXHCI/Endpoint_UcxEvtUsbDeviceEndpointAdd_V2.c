/*
 * XREFs of Endpoint_UcxEvtUsbDeviceEndpointAdd_V2 @ 0x14007AA00
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  ((void (__fastcall *)(__int64, __int64, _QWORD *))qword_14006BC68)(UcxDriverGlobals, a7, v18);
  v10 = 0LL;
  ...
  if ( v11 < 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    v14 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01033 + 1616))(
            ...
            a1,
            off_14006B290);
    LODWORD(v17) = v12 + 2 * (*(_BYTE *)(a3 + 2) & 0x7F);
