/*
 * XREFs of Endpoint_SM_PurgeTransferRingQueuesIfNeeded @ 0x140035724
 * Callers:
 *     ESM_PurgingTransferRingQueuesIfNeeded @ 0x140035700 (ESM_PurgingTransferRingQueuesIfNeeded.c)
 * Callees:
