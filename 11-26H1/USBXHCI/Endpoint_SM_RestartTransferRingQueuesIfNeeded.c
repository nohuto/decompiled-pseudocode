/*
 * XREFs of Endpoint_SM_RestartTransferRingQueuesIfNeeded @ 0x140035824
 * Callers:
 *     ESM_RestartingTransferRingQueuesIfNeeded @ 0x140035800 (ESM_RestartingTransferRingQueuesIfNeeded.c)
 * Callees:
