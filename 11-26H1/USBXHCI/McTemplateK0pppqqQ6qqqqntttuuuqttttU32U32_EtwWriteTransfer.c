/*
 * XREFs of McTemplateK0pppqqQ6qqqqntttuuuqttttU32U32_EtwWriteTransfer @ 0x140003224
 * Callers:
...
__int64 McTemplateK0pppqqQ6qqqqntttuuuqttttU32U32_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        ...)
{
  ...
  v59 = 32LL;
  v61 = 32LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, a3, 25LL, v13);
}
