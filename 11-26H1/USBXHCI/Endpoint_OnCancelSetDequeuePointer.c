/*
 * XREFs of Endpoint_OnCancelSetDequeuePointer @ 0x14001E588
 * Callers:
...
__int64 __fastcall Endpoint_OnCancelSetDequeuePointer(__int64 a1, unsigned int a2)
{
  ...
  if ( *(_BYTE *)(a1 + 37) )
  {
    if ( (unsigned __int8)Endpoint_IsTransferRingEmpty(a1) && (*(_QWORD *)(v13 + 736) & 0x200000LL) == 0 )
...
LABEL_8:
  ...
  *(_DWORD *)(v5 + 36) = v7 ^ (v7 ^ (*(_DWORD *)(a1 + 152) << 16)) & 0x1F0000;
  v11 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 16) + 143LL);
  *(_BYTE *)(v5 + 39) = v11;
  if ( *(_BYTE *)(a1 + 37) )
    *(_WORD *)(v5 + 34) = a2;
  *(_QWORD *)(v5 + 72) = 0LL;
