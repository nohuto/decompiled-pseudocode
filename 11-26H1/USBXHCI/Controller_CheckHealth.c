/*
 * XREFs of Controller_CheckHealth @ 0x14000D2D0
 * Callers:
...
char __fastcall Controller_CheckHealth(__int64 a1, char a2)
{
  ...
  Ulong = XilRegister_ReadUlong(*(_QWORD *)(a1 + 88), (unsigned int *)(*(_QWORD *)(*(_QWORD *)(a1 + 88) + 32LL) + 4LL));
  if ( Ulong == -1 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v5) = 3;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v5, 4, 290, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids);
    }
    LOBYTE(v5) = 1;
