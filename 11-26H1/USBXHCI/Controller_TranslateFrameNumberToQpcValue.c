/*
 * XREFs of Controller_TranslateFrameNumberToQpcValue @ 0x1400162F8
 * Callers:
 ...
 *     Controller_GetQpcValueForFrameMicroFrameBoundary @ 0x1400410F4 (Controller_GetQpcValueForFrameMicroFrameBoundary.c)
