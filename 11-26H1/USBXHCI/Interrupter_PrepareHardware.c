/*
 * XREFs of Interrupter_PrepareHardware @ 0x14007B9B8
 * Callers:
 ...
 *     Interrupter_SetSecondaryInterrupterCount @ 0x1400499B0 (Interrupter_SetSecondaryInterrupterCount.c)
...
LABEL_4:
    LOBYTE(v8) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v3 + 72), v8, 9, v11, (__int64)&WPP_7655ebd4b6a53902724aa02c679740e3_Traceguids);
    return v10;
  }
  if ( *(_DWORD *)(v3 + 1036) == 1 )
  {
...
LABEL_66:
    LOBYTE(v20) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 72), v20, 9, v21, (__int64)&WPP_7655ebd4b6a53902724aa02c679740e3_Traceguids, v10);
    return v10;
  }
