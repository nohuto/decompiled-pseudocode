/*
 * XREFs of Crashdump_Cleanup @ 0x1400506A0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_SaveStateForHybridSleep @ 0x140052638 (Crashdump_Register_SaveStateForHybridSleep.c)
 *     Crashdump_Register_StopController @ 0x140052820 (Crashdump_Register_StopController.c)
 *     Crashdump_Register_SuspendPort @ 0x1400528E8 (Crashdump_Register_SuspendPort.c)
...
__int64 __fastcall Crashdump_Cleanup(__int64 a1)
{
  ...
  v7 = v2 - 1;
  for ( j = *(unsigned int *)(a1 + 4LL * v7 + 544); v7; j = *(unsigned int *)(a1 + 4LL * v7 + 544) )
  {
  ...
  v10 = Crashdump_Register_SuspendPort(a1, j);
  if ( v10 < 0 )
