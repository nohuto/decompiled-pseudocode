/*
 * XREFs of Controller_WdfEvtDeviceD0EntryPostInterruptsEnabled @ 0x1400444D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceD0EntryPostInterruptsEnabled(__int64 a1, int a2)
{
  ...
  if ( *(_DWORD *)(v4 + 864) && *(_QWORD *)(v4 + 1248) )
  ...
  if ( v9 >= 0 )
  {
    if ( (*(_BYTE *)(v4 + 736) & 0x10) != 0 )
    {
      ...
      {
        LOBYTE(v10) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(v4 + 72), v10, 4, 80, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids);
      }
    }
    else
    {
...
LABEL_13:
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v4 + 72), v10, 4, v14, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v9);
  }
LABEL_23:
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc & 8) != 0 )
  {
