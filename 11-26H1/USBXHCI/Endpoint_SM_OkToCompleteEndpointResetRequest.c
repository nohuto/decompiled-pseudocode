/*
 * XREFs of Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x1400488FC
 * Callers:
 ...
 *     ESM_WaitingForControllerResetCompletion @ 0x140056130 (ESM_WaitingForControllerResetCompletion.c)
 * Callees:
