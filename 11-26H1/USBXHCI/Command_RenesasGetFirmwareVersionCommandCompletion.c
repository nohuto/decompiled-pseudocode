/*
 * XREFs of Command_RenesasGetFirmwareVersionCommandCompletion @ 0x14003E4C0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall Command_RenesasGetFirmwareVersionCommandCompletion(__int64 a1)
{
  ...
  if ( v2 == 1 )
  {
    ...
    *(_QWORD *)(*(_QWORD *)(v3 + 8) + 728LL) = (unsigned __int8)*((_DWORD *)v1 + 10) | ((unsigned __int64)*((unsigned __int8 *)v1 + 41) << 8);
  }
