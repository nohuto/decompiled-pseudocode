/*
 * XREFs of Controller_DriverInstalledDueToCompatibleIdMatch @ 0x140075A5C
 * Callers:
...
char __fastcall Controller_DriverInstalledDueToCompatibleIdMatch(_QWORD *a1)
{
  ...
  {
    LOBYTE(v5) = 3;
    WPP_RECORDER_SF_d(a1[9], v5, 4, 149, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, DevicePropertyData);
  }
  return v2;
}
