/*
 * XREFs of XilUsbDevice_SendRequestToRingDoorbell @ 0x140038F28
 * Callers:
...
__int64 __fastcall XilUsbDevice_SendRequestToRingDoorbell(__int64 *a1, char a2, __int16 a3)
{
  ...
  GUID v11; // [rsp+38h] [rbp-40h] BYREF
  ...
  LODWORD(v14) = 32;
  WORD5(v14) = a3;
  result = SecureChannel_SendRequestSynchronously(v6, &v11, 48, (__int64)&v10, 4);
  if ( (int)result < 0 )
  {
