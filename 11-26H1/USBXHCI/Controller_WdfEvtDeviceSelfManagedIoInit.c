/*
 * XREFs of Controller_WdfEvtDeviceSelfManagedIoInit @ 0x140044750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceSelfManagedIoInit(__int64 a1)
{
  ...
  *(_BYTE *)(v3 + 16) = 1;
  ...
  {
    LOBYTE(v2) = 5;
    WPP_RECORDER_SF_q(*(_QWORD *)(v3 + 72), v2, 4, 55, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v1);
  }
  if ( Controller_InUseByDebugger((_QWORD *)v3) )
  {
    ...
    {
      LOBYTE(v4) = 4;
      WPP_RECORDER_SF_q(*(_QWORD *)(v3 + 72), v4, 4, 56, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v1);
    }
    ...
    {
      LOBYTE(v6) = 3;
      WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 72), v6, 4, 57, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v5);
    }
  }
  ...
  if ( _bittest64((const signed __int64 *)(v3 + 736), 0x22u) )
  {
    ...
    *(_QWORD *)(v3 + 856) = v7;
    ...
    {
      LOBYTE(v8) = 3;
      WPP_RECORDER_SF_q(*(_QWORD *)(v3 + 72), v8, 4, 58, (__int64)&WPP_aa3f12a561783a7e2659a97375f632db_Traceguids, v1);
    }
  }
  return 0LL;
}
