/*
 * XREFs of Bulk_WdfEvtRequestCancel @ 0x140020040
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_BYTE *)(v4 + 104) = v5;
  if ( *(_DWORD *)(v3 + 64) == 1 )
  {
    ...
    if ( (v6 & 0x20) != 0 )
    {
      ...
      {
        **(_QWORD **)(v4 + 416) = v12;
        *(_QWORD *)(*(_QWORD *)v11 + 8LL) = *(_QWORD *)(v4 + 416);
  ...
  *(_BYTE *)(v4 + 104) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v4 + 96));
  if ( *(_DWORD *)(v3 + 64) == 2 )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)v3 + 8LL) != v3
      || (v9 = *(_QWORD **)(v3 + 8), *v9 != v3)
      || (*v9 = v8, *(_QWORD *)(v8 + 8) = v9, v10 = *(__int64 **)(v4 + 416), *v10 != v4 + 408) )
    {
      __fastfail(3u);
    }
    *(_QWORD *)v3 = v4 + 408;
