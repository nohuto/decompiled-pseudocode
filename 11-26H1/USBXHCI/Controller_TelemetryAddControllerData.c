/*
 * XREFs of Controller_TelemetryAddControllerData @ 0x14007804C
 * Callers:
 ...
 *     XilDeviceSlot_GetNumberOfDeviceSlots @ 0x14003DB60 (XilDeviceSlot_GetNumberOfDeviceSlots.c)
...
char __fastcall Controller_TelemetryAddControllerData(_QWORD *a1, __int64 *a2)
{
  ...
  v20 = 0LL;
  if ( !a1
    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, a1, 0x500u),
            ...
            (int)UsbDeviceHandleArray >= 0) )
      {
              ...
              (int)UsbDeviceHandleArray >= 0) )
        {
                ...
                (int)UsbDeviceHandleArray >= 0) )
          {
            v7 = (const void *)a1[16];
            if ( !v7
              || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, v7, 0x60u),
                  (int)UsbDeviceHandleArray >= 0) )
            {
              v8 = (const void *)a1[17];
              if ( !v8
