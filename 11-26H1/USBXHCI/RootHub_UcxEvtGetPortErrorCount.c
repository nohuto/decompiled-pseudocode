/*
 * XREFs of RootHub_UcxEvtGetPortErrorCount @ 0x14004AE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RootHub_UcxEvtGetPortErrorCount(__int64 a1, __int64 a2)
{
  ...
  _OWORD v22[2]; // [rsp+78h] [rbp-70h] BYREF
...
LABEL_31:
  ...
  if ( *(_BYTE *)(120 * v11 + *(_QWORD *)(v4 + 48) + 13) != 3 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      v17 = *(unsigned __int8 *)(v8 + 133);
LABEL_30:
      WPP_RECORDER_SF_DDDDDDDD(*(_QWORD *)(*(_QWORD *)(v4 + 8) + 72LL), v16, v17, v15);
      goto LABEL_31;
    }
    goto LABEL_31;
  }
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_dD(
      *(_QWORD *)(*(_QWORD *)(v4 + 8) + 72LL),
      ...
      v10,
      Ulong);
  if ( v14 > 0xA && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LODWORD(v20) = v13;
    LODWORD(v19) = v10;
    WPP_RECORDER_SF_dD(
