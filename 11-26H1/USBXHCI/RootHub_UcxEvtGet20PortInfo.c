/*
 * XREFs of RootHub_UcxEvtGet20PortInfo @ 0x14004A7C0
 * Callers:
 *     <none>
 * Callees:
  ...
  while ( v12 < *(_WORD *)(v3 + 16) )
  {
    ...
    if ( *(_BYTE *)(120 * v13 + *(_QWORD *)(v3 + 48) + 13) == 2 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v8 + 8LL * v11) + 4LL) = v16;
      v17 = 116;
      if ( *(_BYTE *)(v14 + *(_QWORD *)(v3 + 48) + 16) != 1 )
        v17 = 102;
      *(_DWORD *)(*(_QWORD *)(v8 + 8LL * v11) + 8LL) = v17;
      if ( (*(_QWORD *)(*(_QWORD *)(v3 + 8) + 736LL) & 0x400000LL) != 0 )
        *(_BYTE *)(*(_QWORD *)(v8 + 8LL * v11) + 16LL) = 0;
      else
        *(_BYTE *)(*(_QWORD *)(v8 + 8LL * v11) + 16LL) = *(_BYTE *)(v14 + *(_QWORD *)(v3 + 48) + 19);
      ++v11;
      *(_BYTE *)(*(_QWORD *)(v8 + 8 * v15) + 2LL) = *(_BYTE *)(v14 + *(_QWORD *)(v3 + 48) + 12);
      *(_BYTE *)(*(_QWORD *)(v8 + 8 * v15) + 3LL) = *(_BYTE *)(v14 + *(_QWORD *)(v3 + 48) + 14);
      v10 = *(_WORD *)(v6 + 4);
    }
  }
  return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01033 + 2104))(
