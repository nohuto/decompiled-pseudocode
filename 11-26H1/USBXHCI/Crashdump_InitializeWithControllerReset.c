/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1400510C0
 * Callers:
 ...
 *     Crashdump_Register_ResetController @ 0x1400522B4 (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x140052384 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x140052754 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x140052974 (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1400550F4 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x14005534C (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x14005597C (Crashdump_UsbDevice_SetPortPower.c)
 */
