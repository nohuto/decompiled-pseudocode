/*
 * XREFs of Endpoint_Create @ 0x1400806CC
 * Callers:
 ...
 *     Etw_EndpointCreate @ 0x1400027A4 (Etw_EndpointCreate.c)
 ...
 *     XilRegister_GetContextSize @ 0x140035C94 (XilRegister_GetContextSize.c)
 *     TR_GetWdfQueue @ 0x140036CB8 (TR_GetWdfQueue.c)
 ...
 *     Endpoint_SetType @ 0x140081530 (Endpoint_SetType.c)
...
__int64 __fastcall Endpoint_Create(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, _QWORD *a6, _QWORD *a7)
{
  ...
  *(_QWORD *)&v51 = Endpoint_EvtDestroyCallback;
  ...
  if ( IsSecureDevice )
    v13 = v14;
  DWORD2(v51) = v13;
  ClearStallContext = qword_14006BC50(UcxDriverGlobals, a2, &v58, &v50, &v49);
...
LABEL_31:
      ...
      v19 = *(unsigned __int8 *)(v26 + 143);
      LODWORD(v47) = v25 + 2 * (*(_BYTE *)(a4 + 2) & 0x7F);
      goto LABEL_13;
    }
    v36 = *(_QWORD *)(v22 + 16);
    *(_QWORD *)(v22 + 272) = 0LL;
    if ( *(_DWORD *)(v36 + 20) == 3 && (*(_BYTE *)(v22 + 99) & 3) == 2 && (*(_BYTE *)(v22 + 114) & 0x1F) != 0 )
    {
      ...
      *(_BYTE *)(v22 + 37) = 1;
      if ( (*(_QWORD *)(v37 + 736) & 0x200000LL) != 0 )
      {
        ...
        if ( ContextSize != 1 )
          v40 = 1056;
        *(_QWORD *)(v22 + 272) = XilEndpoint_AcquireBuffer((_BYTE *)v22, v40, v22, 0x33747045u);
      }
    }
    else
    {
    ...
    if ( ClearStallContext >= 0 )
    {
      ...
      ((void (__fastcall *)(__int64, __int64, __int64))qword_14006BC78)(UcxDriverGlobals, v49, WdfQueue);
      if ( *(_DWORD *)(v22 + 152) == 1 )
...
LABEL_61:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    LODWORD(v47) = v16 + 2 * (*(_BYTE *)(a4 + 2) & 0x7F);
LABEL_13:
    LODWORD(v46) = v19;
    WPP_RECORDER_SF_ddd(
      *(_QWORD *)(v9 + 72),
