/*
 * XREFs of Command_PrepareHardware @ 0x14007390C
 * Callers:
 ...
 *     XilCommand_GetLinkTrbPointer @ 0x14003FA64 (XilCommand_GetLinkTrbPointer.c)
 *     XilCommand_GetMaxTrbIndex @ 0x14003FA88 (XilCommand_GetMaxTrbIndex.c)
