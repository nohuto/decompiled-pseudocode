/*
 * XREFs of Counter_CreateInterrupterInstance @ 0x14007EB00
 * Callers:
...
NTSTATUS __fastcall Counter_CreateInterrupterInstance(__int64 a1)
{
  ...
  if ( *(_BYTE *)(g_WdfDriverUsbXhciContext + 28) && !*(_QWORD *)(a1 + 88) )
  {
    ...
    Data = *(_DWORD *)(v2 + 176);
    if ( *(_DWORD *)(v2 + 644) == 1 )
      RtlStringCchPrintfW(pszDest, 0x10uLL, L"%04X.%u.%u", *(unsigned __int16 *)(v2 + 648), Data, v5);
    else
      RtlStringCchPrintfW(pszDest, 0x10uLL, L"%S.%u.%u", v2 + 704, Data, v5);
