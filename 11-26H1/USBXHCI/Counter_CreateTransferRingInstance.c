/*
 * XREFs of Counter_CreateTransferRingInstance @ 0x140081C54
 * Callers:
...
NTSTATUS __fastcall Counter_CreateTransferRingInstance(__int64 *a1, int a2, PPCW_INSTANCE *a3)
{
  ...
  if ( *(_BYTE *)(g_WdfDriverUsbXhciContext + 28) && !a3[4] )
  {
    ...
    v8 = *(unsigned __int16 *)(a1[2] + 132);
    Data = *(_DWORD *)(v6 + 176);
    if ( *(_DWORD *)(v6 + 644) == 1 )
      RtlStringCchPrintfW(pszDest, 0x15uLL, L"%04X.%u.%04X.%02X.%u", *(unsigned __int16 *)(v6 + 648), Data, v8, v9, a2);
    else
      RtlStringCchPrintfW(pszDest, 0x15uLL, L"%S.%u.%04X.%02X.%u", v6 + 704, Data, v8, v9, a2);
