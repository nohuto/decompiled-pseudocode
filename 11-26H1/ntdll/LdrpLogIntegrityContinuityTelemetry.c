/*
 * XREFs of LdrpLogIntegrityContinuityTelemetry @ 0x18015D848
 * Callers:
...
__int64 __fastcall LdrpLogIntegrityContinuityTelemetry(__int64 a1, int a2, int a3, int a4, char a5)
{
              ...
              0LL) >= 0 )
  {
    ...
    {
      v11 = (unsigned __int16 *)&unk_180172E18;
      v10 = -1;
    }
    LODWORD(SystemInformation) = 8;
    NtQuerySystemInformation(SystemCodeIntegrityInformation, &SystemInformation, 8u, 0LL);
    if ( (unsigned int)dword_1801C5958 > 5 && tlgKeywordOn((__int64)&dword_1801C5958, 0x800000000000LL) )
    {
      v13 = *(_QWORD *)(a1 + 56);
