/*
 * XREFs of deflate_slow @ 0x180154C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall deflate_slow(__int64 *a1, int a2)
{
  ...
  for ( i = (int *)a1 + 57; ; i = v6 )
  {
    ...
    *((_DWORD *)a1 + 54) = 2;
    if ( (_DWORD)v9 )
    {
      if ( v18 < *((_DWORD *)a1 + 62) && *v6 - (int)v9 <= (unsigned int)(*((_DWORD *)a1 + 37) - 262) )
      {
        ...
        *((_DWORD *)a1 + 54) = v21;
        ...
        {
          if ( *((_DWORD *)a1 + 64) == 1
            || v21 == 3 && (v19 = 3, (unsigned int)(*((_DWORD *)a1 + 57) - *((_DWORD *)a1 + 58)) > 0x1000) )
          {
            *((_DWORD *)a1 + 54) = 2;
            v19 = 2;
          }
    ...
    {
      v6 = (int *)a1 + 57;
      v23 = *((_DWORD *)a1 + 59) - 3 + *((_DWORD *)a1 + 57);
      v24 = (unsigned __int8)(v22 - 3);
      v25 = *((_WORD *)a1 + 114) + ~*((_WORD *)a1 + 110);
      *(_BYTE *)(*((unsigned int *)a1 + 1489) + a1[743]) = v25;
      v26 = HIBYTE(v25);
      ++*((_DWORD *)a1 + 1489);
      v27 = v25 - 1;
      *(_BYTE *)((unsigned int)(*((_DWORD *)a1 + 1489))++ + a1[743]) = v26;
      *(_BYTE *)((unsigned int)(*((_DWORD *)a1 + 1489))++ + a1[743]) = v24;
      ++*((_WORD *)a1 + 2 * length_code[v24] + 648);
      if ( v27 >= 0x100u )
        v28 = (v27 >> 7) + 256;
      else
        v28 = v27;
      ++*((_WORD *)a1 + 2 * dist_code[v28] + 1280);
      v29 = *((_DWORD *)a1 + 60);
      *((_DWORD *)a1 + 59) += 1 - v29;
      v30 = *((_DWORD *)a1 + 1489);
      v31 = *((_DWORD *)a1 + 1490);
