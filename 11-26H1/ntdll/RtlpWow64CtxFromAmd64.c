/*
 * XREFs of RtlpWow64CtxFromAmd64 @ 0x1800C0580
 * Callers:
 *     <none>
 * Callees:
 *     RtlFxToFnFrame @ 0x1800C0880 (RtlFxToFnFrame.c)
...
__int64 __fastcall RtlpWow64CtxFromAmd64(int a1, _DWORD *a2, int *a3)
{
  ...
  v16 = 65600;
  LOBYTE(v16) = (a1 & v5 & 0x10040) == 65600;
  if ( ((unsigned __int8)v16 & ((v3 & 0x100040) == 1048640)) != 0 )
    v4 = RtlpCopyXStateChunk(v16, (int)a3 + 716, (int)a3 + 716, (int)a2 + 1232, (__int64)(a2 + 308));
  if ( (a1 & 0x40000000) != 0 )
