/*
 * XREFs of RtlpHpTagAllocateHeap @ 0x180097930
 * Callers:
...
unsigned __int64 __fastcall RtlpHpTagAllocateHeap(_DWORD *a1, unsigned __int64 a2, unsigned int a3)
{
  int v5; // edi
  ...
  v5 = 0;
  v7 = 0;
  if ( a1[4] == -571548178 && a1 != (_DWORD *)qword_1801CB148[2 * (unsigned int)dword_18017C068[BYTE1(RtlpHpEnvHandle)]] )
  {
    v32 = 0LL;
    ...
    {
      if ( word_1801CCC04
        && (v9 = *(_QWORD *)(qword_1801CCBF8 + 8LL * (unsigned __int16)word_1801CCC04 - 8),
...
LABEL_9:
        if ( v11 )
          goto LABEL_12;
        if ( (unsigned int)dword_1801CCBEC >> 5 )
        {
          v12 = ((unsigned int)dword_1801CCBEC >> 5) - 1;
          v11 = qword_1801CCBF0
              + 8LL
...
LABEL_20:
  ...
  if ( a1[4] == -571548178 )
  {
    ...
    v26 = v15 | v5;
    Heap = RtlpHpAllocateHeap((__int64)a1, a2, (unsigned int)v26);
    if ( !Heap )
    {
      v28 = NtCurrentTeb();
      v28->LastStatusValue = -1073741801;
      v28->LastErrorValue = RtlNtStatusToDosErrorNoTeb(0xC0000017);
      if ( v26 < 0 || (int)a1[5] < 0 )
  ...
  {
    Heap = RtlpAllocateNTHeapInternal(a1, a2, a3);
  }
  if ( v7 )
  {
    if ( Heap )
      *(_WORD *)RtlpHpExtrasGet((__int64)a1, Heap, a1[5], 0LL) = v7;
    else
      _InterlockedAdd64((volatile signed __int64 *)(*(_QWORD *)(qword_1801CCBF8 + 8LL * v7 - 8) + 32LL), -(__int64)a2);
  }
  return Heap;
}
