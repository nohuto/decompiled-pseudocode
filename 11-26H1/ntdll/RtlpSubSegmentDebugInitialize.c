        ...
        __int64 a7)
{
  ...
  *(_DWORD *)(a3 + 24) = v30 ^ a3 ^ RtlpLFHKey ^ a1;
  ...
  *(_QWORD *)(a3 + 40) = a3 + 48;
  ...
  if ( (_DWORD)v16 )
  {
    ...
    do
    {
      v22 = RtlpLFHKey ^ *(_DWORD *)(a1 + 24) ^ (v19 >> 4) ^ (((_DWORD)v19 - (_DWORD)a3) << 12);
      *(_DWORD *)(v19 + 12) &= 0xFF0000FF;
      *(_DWORD *)(v19 + 12) |= (unsigned __int16)v20 << 8;
      *(_DWORD *)(v19 + 8) = v22;
      *(_BYTE *)(v19 + 15) = 0x80;
