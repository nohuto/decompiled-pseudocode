/*
 * XREFs of LdrpResMapFile @ 0x180109594
 * Callers:
...
__int64 __fastcall LdrpResMapFile(wchar_t *String2, wchar_t **a2, _QWORD *a3, int a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( (a4 & 0x400) != 0 )
  {
    ...
    *(_QWORD *)&v27 = &v21;
    v28 = 0LL;
    v11 = ZwCreateFile(&Handle, 2148532352LL, &v26, &v29, 0LL, 0, 5, 1, 0, 0LL, 0);
    if ( v14 )
    {
...
LABEL_11:
  ...
  {
LABEL_12:
    v11 = NtCreateSection(&v16, 983045LL, 0LL, 0LL, 2, 0x8000000, String2);
    if ( (~(_WORD)a4 & 0x800) != 0 )
      NtClose(Handle);
    if ( v11 >= 0 )
    {
