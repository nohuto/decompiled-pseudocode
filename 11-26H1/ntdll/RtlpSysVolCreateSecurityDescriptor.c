/*
 * XREFs of RtlpSysVolCreateSecurityDescriptor @ 0x1800C556C
 * Callers:
 ...
 *     RtlSetControlSecurityDescriptor @ 0x1800C5D70 (RtlSetControlSecurityDescriptor.c)
...
__int64 __fastcall RtlpSysVolCreateSecurityDescriptor(__int16 **a1, ACL **a2)
{
  ...
  v4 = (__int16 *)RtlpSysVolAllocate(0x28uLL);
  v5 = v4;
  if ( v4 )
  {
    Sid = 257;
    ...
    *((_QWORD *)v4 + 4) = 0LL;
    ...
    v14 = 1280;
    *(_BYTE *)v4 = 1;
    v6 = (ACL *)RtlpSysVolAllocate(0x1CuLL);
    v7 = v6;
    if ( !v6 )
    {
      Acl = -1073741670;
