/*
 * XREFs of RtlOverwriteFeatureConfigurationBuffer @ 0x180148AB0
 * Callers:
 *     <none>
 * Callees:
 *     ZwSetSystemInformation @ 0x1801626D0 (ZwSetSystemInformation.c)
 *     RtlpFcValidateFeatureConfigurationBuffer @ 0x18016F05C (RtlpFcValidateFeatureConfigurationBuffer.c)
 */
