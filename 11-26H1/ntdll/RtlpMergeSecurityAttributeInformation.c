/*
 * XREFs of RtlpMergeSecurityAttributeInformation @ 0x1800D9610
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( a1 )
      {
        ...
        for ( i = (_BYTE *)(a1 + 8); ; i += *((unsigned __int16 *)i + 1) )
        {
          ...
          if ( *i == 18 && (i[1] & 0x10) == 0 && !(unsigned __int8)RtlpIsAttributeAceInSacl(i, Heap_0, 0LL, &v28) )
          {
            ...
            {
              *(_WORD *)(Heap_0 + 2) += *((_WORD *)i + 1);
              if ( *(unsigned __int16 *)(Heap_0 + 2) > v11 )
              {
LABEL_68:
                v26 = -1073741705;
                RtlFreeHeap_0();
      ...
      if ( a1 )
      {
        ...
        while ( v21 < *(unsigned __int16 *)(a1 + 4) )
        {
          if ( *(_BYTE *)v22 != 18 )
          {
            *(_WORD *)(Heap_0 + 2) += v22[1];
            if ( *(unsigned __int16 *)(Heap_0 + 2) > v27 )
              goto LABEL_68;
