/*
 * XREFs of Xp10BitCopy @ 0x1800FAF48
 * Callers:
 *     Xp10ScatteredCopyBits @ 0x1800FAD44 (Xp10ScatteredCopyBits.c)
 * Callees:
...
void __fastcall Xp10BitCopy(char *a1, int a2, unsigned __int8 *a3, unsigned int a4, unsigned __int64 a5)
{
  ...
  if ( a5 )
  {
    ...
    if ( v22 )
    {
      ...
      *v8 = (((unsigned __int8)v23 & (unsigned __int8)byte_1801830A0[4 * v22]) << v7) | *v8 & ~(byte_1801830A0[4 * v22] << v7);
    }
  }
}
