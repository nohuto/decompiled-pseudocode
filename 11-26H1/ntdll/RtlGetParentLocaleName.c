/*
 * XREFs of RtlGetParentLocaleName @ 0x18004EDD0
 * Callers:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v8 = Flags & 4;
  if ( (Flags & 4) != 0
    || !RtlpIsCustomLocale((wchar_t *)LocaleName)
    || (LOBYTE(v22) = (v5 & 2) != 0,
        ...
        result < 0) )
  {
      ...
      if ( v13 )
      {
        ...
        if ( v15 )
        {
          ...
          else
          {
            ...
            {
              v19 = 2 * v16;
              memmove(ParentLocaleName->Buffer, v13, (unsigned __int16)(2 * v16));
    ...
    if ( v8 && RtlpIsCustomLocale((wchar_t *)LocaleName) )
    {
      LOBYTE(v21) = v10 != 0;
