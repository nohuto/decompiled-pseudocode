/*
 * XREFs of RtlSetBitsEx @ 0x180141610
 * Callers:
 *     RtlFindClearBitsAndSetEx @ 0x180140B10 (RtlFindClearBitsAndSetEx.c)
 * Callees:
...
LABEL_10:
    ...
    if ( v6 > 8 )
    {
      RtlSetVolatileMemory(v5, 255, v6 >> 3);
      v5 += v6 >> 3;
      v6 &= 7u;
    }
    if ( v6 )
