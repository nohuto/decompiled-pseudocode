/*
 * XREFs of _wsplitpath_s @ 0x180133600
 * Callers:
 *     <none>
 * Callees:
...
LABEL_47:
      ...
      {
        wcsncpy_s(Filename, FilenameCount, FullPath, v21);
        goto LABEL_47;
      }
LABEL_56:
      v13 = 0;
    ...
    if ( Filename )
    {
      ...
      if ( FilenameCount <= v23 )
        goto LABEL_56;
      wcsncpy_s(Filename, FilenameCount, FullPath, v23);
    }
    if ( Ext )
      *Ext = 0;
    return 0;
...
LABEL_39:
  ...
  if ( DirCount > v20 )
  {
    wcsncpy_s(Dir, DirCount, FullPath, v20);
    goto LABEL_39;
  }
LABEL_57:
  v12 = DriveCount;
