/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x18014FEC4
 * Callers:
...
LABEL_38:
        ...
        if ( v12 )
        {
          qword_1801C5128 = *(unsigned __int16 *)(a1 + 140) ^ (unsigned __int64)*(unsigned __int16 *)(v12 + 12);
          v20 = *v19;
        }
        if ( v13 )
        {
          ...
          qword_1801C5130 = (unsigned __int16)v24;
        }
        if ( *v21 )
        {
        ...
        if ( qword_1801C5128 == (unsigned __int16)result )
        {
          result = *(unsigned __int16 *)(a1 + 140);
          if ( qword_1801C5130 != (result ^ *(unsigned __int16 *)(v13 + 8 * v23 + 12)) )
            dword_1801C50E8 = 7;
        }
        else
        {
