/*
 * XREFs of SbUpdateSwitchContextBasedOnDll @ 0x180064160
 * Callers:
 ...
 *     SbGetContextDetailsById @ 0x180064664 (SbGetContextDetailsById.c)
...
__int64 __fastcall SbUpdateSwitchContextBasedOnDll(__int64 a1, __int64 a2)
{
  ...
  if ( CurrentSwitchContext != -64 )
  {
    ...
    {
      v12 = 32LL * i;
      v13 = *v10 - *(_QWORD *)((char *)&unk_180171884 + v12);
      if ( *v10 == *(_QWORD *)((char *)&unk_180171884 + v12) )
        v13 = v10[1] - *(_QWORD *)((char *)&unk_18017188C + v12);
      if ( !v13 )
      {
        v8 = (unsigned int *)((char *)&SbSupportedOsList + v12);
        break;
      }
    }
  }
  if ( (_DWORD)v6 )
  {
    ...
    {
      v21 = 32LL * j;
      v22 = *v19 - *(_QWORD *)((char *)&unk_180171884 + v21);
      if ( *v19 == *(_QWORD *)((char *)&unk_180171884 + v21) )
        v22 = v19[1] - *(_QWORD *)((char *)&unk_18017188C + v21);
      if ( !v22 )
      {
        v9 = (unsigned int *)((char *)&SbSupportedOsList + v21);
        break;
      }
    }
    v23 = *v9;
    ...
    {
      if ( *(_DWORD *)((char *)&SbDynamicContextDllCount + k) == (_DWORD)v23 )
      {
        if ( _InterlockedExchangeAdd(&dword_1801C6804[2 * v24], 0xFFFFFFFF) != 1 )
          return 1LL;
        break;
      }
      ++v24;
    ...
    if ( v8 != v9 )
      return 1LL;
    RtlAcquireSRWLockExclusive(&SbpContextLock, v23);
    v28 = dword_1801C6804;
    v30 = 0LL;
    do
    {
...
LABEL_49:
  ...
  result = SbpDetermineDllContext(*(_QWORD *)(a1 + 48), &v30, v6, 0LL);
  if ( !(_DWORD)result )
    return result;
  v15 = v30;
  v16 = 0LL;
  ...
  *(_QWORD *)(a1 + 192) = v30 + 4;
  while ( v16 < 0x28 )
  {
    ...
    {
      _InterlockedIncrement(&dword_1801C6804[2 * v3]);
      break;
    }
    ++v3;
    v16 += 8LL;
    ...
    && (*(unsigned __int16 *)(v15 + 22) | ((unsigned __int64)*(unsigned __int16 *)(v15 + 20) << 16)) >= *(_QWORD *)(v7 + 40) )
  {
    ...
    *(_OWORD *)v10 = *(_OWORD *)v17;
    ...
    v27 = (__int64)v17;
LABEL_42:
    SbpTraceContextUpdate(v26, v27, 1, *(_WORD *)(a1 + 72), *(_QWORD *)(a1 + 80));
LABEL_50:
    ++*(_QWORD *)v7;
