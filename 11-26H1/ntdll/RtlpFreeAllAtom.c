/*
 * XREFs of RtlpFreeAllAtom @ 0x180037E24
 * Callers:
...
int __fastcall RtlpFreeAllAtom(__int64 a1, __int64 a2)
{
  ...
  if ( ((a1 + 18) & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    ...
    while ( (_WORD)v4 )
    {
      ...
      if ( (unsigned __int16)v4 >= 0x61u )
      {
        if ( (unsigned __int16)v4 > 0x7Au )
          LOWORD(v4) = NLS_UPCASE(qword_1801C6038, (unsigned __int16)v4);
        else
          LOWORD(v4) = v4 - 32;
      }
    ...
    else
    {
      ...
      v9 = (const wchar_t **)(a2 + 72 + 8LL * (v6 % *(_DWORD *)(a2 + 64)));
      for ( i = *v9; i; i = *(const wchar_t **)i )
      {
