/*
 * XREFs of LdrpCnvrtShortToLongFileName @ 0x180113BA8
 * Callers:
...
__int64 __fastcall LdrpCnvrtShortToLongFileName(_WORD *a1, const WCHAR *a2, _QWORD *a3)
{
  ...
  *(_OWORD *)BaseAddress = 0LL;
  ...
  v6 = RtlpDosPathNameToRelativeNtPathName_U(2, a1, (int)BaseAddress, 0LL, (__int64)&RelativeName);
  if ( v6 >= 0 )
  {
    v5 = BaseAddress[1];
...
LABEL_12:
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v6 >= 0 )
    {
      Heap_0 = RtlAllocateHeap_0(NtCurrentPeb()->ProcessHeap, 8u, 0x410uLL);
      if ( Heap_0 )
      {
        ...
        if ( v6 >= 0 )
        {
          ...
          if ( v9 <= 0x104 )
          {
            v10 = RtlAllocateHeap_0(NtCurrentPeb()->ProcessHeap, 8u, v9 + 4);
            v11 = v10;
            if ( v10 )
            {
              memmove(v10, (char *)Heap_0 + 94, (unsigned int)Heap_0[15]);
              v11[(unsigned __int64)(unsigned int)Heap_0[15] >> 1] = 0;
              *a3 = v11;
            }
            else
            {
