/*
 * XREFs of AVrfpLoadAndInitializeProvider @ 0x180106D68
 * Callers:
...
char __fastcall AVrfpLoadAndInitializeProvider(__int64 a1)
{
  ...
  _DWORD *v14; // r15
  int v15; // ecx
  __int64 v17; // [rsp+38h] [rbp-E0h] BYREF
  _DWORD *v18; // [rsp+40h] [rbp-D8h] BYREF
  __int128 v19; // [rsp+48h] [rbp-D0h] BYREF
  ...
  *((_QWORD *)&v19 + 1) = &unk_1801C6FF0;
  ...
  v8 = *((_QWORD *)&v19 + 1);
  LdrpInitializeDllPath(0LL, *((__int64 *)&v19 + 1), (__int64)v21);
      ...
      *(_DWORD *)(*(_QWORD *)(a1 + 32) + 104LL) |= 0x400u;
      ...
      if ( LdrpCallInitRoutine(v13, *(_QWORD *)(v12 + 48), 4u, (__int64)&v18) && (v14 = v18) != 0LL )
      {
        if ( *v18 == 80 )
        {
          ...
          *((_QWORD *)v14 + 4) = *(_QWORD *)(qword_1801CB890 + 96);
