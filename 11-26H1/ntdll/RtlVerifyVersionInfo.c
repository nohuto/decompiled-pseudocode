/*
 * XREFs of RtlVerifyVersionInfo @ 0x180062750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlVerifyVersionInfo(__int64 a1, int a2, __int64 a3)
{
  ...
  _DWORD v19[68]; // [rsp+44h] [rbp-BCh] BYREF
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( (v4 & 2) != 0 )
    {
      ...
      v10 = (unsigned __int8)RtlpVerCompare(ConditionMask, *(_DWORD *)(a1 + 4), v19[0], (unsigned int)v17, 0) == 0;
      v8 = v17[0];
      if ( v10 )
      {
        if ( !v17[0] )
    ...
    v10 = (unsigned __int8)RtlpVerCompare(ConditionMask, *(_DWORD *)(a1 + 8), v19[1], (unsigned int)v17, 1) == 0;
    v8 = v17[0];
    if ( v10 )
    {
      if ( !v17[0] )
...
LABEL_14:
    ...
    if ( (v4 & 0x20) != 0 )
    {
      ...
      if ( !(unsigned __int8)RtlpVerCompare(ConditionMask, *(unsigned __int16 *)(a1 + 276), v20, (unsigned int)v17, 0) )
      {
        if ( !v17[0] )
          return 3221225561LL;
        goto LABEL_22;
...
LABEL_22:
      if ( (v4 & 0x10) != 0 )
      {
        ...
        if ( !(unsigned __int8)RtlpVerCompare(ConditionMask, *(unsigned __int16 *)(a1 + 278), v21, (unsigned int)v17, 1) )
          return 3221225561LL;
      }
    }
LABEL_27:
    if ( (v4 & 4) == 0
      || (a3 >= 0 ? (v11 = BYTE2(a3)) : (v11 = RtlpVerGetConditionMask(a3, 4LL)),
          (unsigned __int8)RtlpVerCompare(v11, *(_DWORD *)(a1 + 12), v19[2], (unsigned int)v17, 0)) )
    {
      if ( (v4 & 8) == 0
        || (a3 >= 0 ? (v12 = 0) : (v12 = RtlpVerGetConditionMask(a3, 8LL)),
            (unsigned __int8)RtlpVerCompare(v12, *(_DWORD *)(a1 + 16), v19[3], (unsigned int)v17, 0)) )
      {
        if ( v4 >= 0 )
          return 0LL;
        if ( a3 >= 0 )
        ...
        return (unsigned __int8)RtlpVerCompare(v13, *(unsigned __int8 *)(a1 + 282), v23, (unsigned int)v17, 0) == 0
             ? 0xC0000059
             : 0;
      }
    }
