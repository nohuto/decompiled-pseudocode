/*
 * XREFs of RtlSetProcessDebugInformation @ 0x18013A320
 * Callers:
  ...
  *(_DWORD *)(a3 + 64) = a2;
  ...
  if ( NtCurrentTeb()->ClientId.UniqueProcess == a1 )
  {
    if ( (a2 & 1) != 0 && (NtCurrentPeb()->NtGlobalFlag & 0x2000100) != 0 )
    {
      ...
      v19 = *v11;
      InformationThread = ((__int64 (__fastcall *)(_QWORD, int *))qword_1801C5640)(0LL, &v19);
  ...
  if ( InformationThread >= 0 )
  {
    ...
    {
      InformationThread = ZwQueryInformationThread(v8, 0LL, v15, 48LL, 0LL);
      if ( InformationThread >= 0 )
