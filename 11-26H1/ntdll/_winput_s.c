...
LABEL_179:
          ...
          if ( v28 == 123 )
          {
            v54 = ReadStringDelimited_1(v53, &v76, (wint_t *)&v59, &v60, (void **)&v72, v12, Stream, Src, &v70);
            v4 = v76;
          }
          else
          {
            v54 = ReadString_1(v53, 0LL, (wint_t *)&v59, &v60, (void **)&v72, v12, Stream, Src, &v70);
          }
          v5 = v59;
          if ( v54 )
            goto LABEL_209;
...
LABEL_196:
  ...
  {
    ++v60;
    v29 = fgetwc_nolock(Stream);
  }
  else
  {
    v29 = whiteout(&v60, Stream);
  }
  v5 = v29;
  LOWORD(v59) = v29;
  v64 = v29;
