/*
 * XREFs of LZ4_compress_HC_extStateHC_fastReset @ 0x180155C4C
 * Callers:
 *     LZ4_compress_HC_extStateHC @ 0x180155BEC (LZ4_compress_HC_extStateHC.c)
 * Callees:
 *     LZ4HC_compress_generic @ 0x1800ED8A8 (LZ4HC_compress_generic.c)
 *     LZ4_compressBound @ 0x1801207E0 (LZ4_compressBound.c)
 *     LZ4_resetStreamHC_fast @ 0x1801226D4 (LZ4_resetStreamHC_fast.c)
