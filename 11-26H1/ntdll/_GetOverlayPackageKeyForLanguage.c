/*
 * XREFs of _GetOverlayPackageKeyForLanguage @ 0x180032AC0
 * Callers:
...
__int64 __fastcall GetOverlayPackageKeyForLanguage(const wchar_t *a1, _QWORD *a2)
{
  size_t v4; // rax
  unsigned int v5; // edi
  char *v6; // rsi
  ...
  result = RtlGetPersistedStateLocation((wchar_t *)L"LanguageOverlayKeyName", String, 512, 0LL);
  if ( (int)result >= 0 )
  {
    v8 = wcslen(String);
    if ( v8 <= 0x7FFE )
              ...
              if ( v15 + (unsigned __int16)v20 <= WORD1(v20) )
              {
                ...
                if ( v17 <= 0x7FFE )
                {
                  ...
                  if ( v18 + (unsigned __int16)v20 <= WORD1(v20) )
                  {
                    ...
                    result = RtlAppendUnicodeToString((unsigned __int16 *)&v20, a1);
                    if ( (int)result >= 0 )
                    {
                      v22[0] = 48LL;
                      v22[2] = &v20;
