/*
 * XREFs of RtlpWow64SuspendProcess @ 0x180138CC8
 * Callers:
 *     RtlWow64ChangeProcessState @ 0x1801385A0 (RtlWow64ChangeProcessState.c)
 *     RtlWow64SuspendProcess @ 0x180138850 (RtlWow64SuspendProcess.c)
 * Callees:
 ...
 *     ZwSuspendProcess @ 0x180162910 (ZwSuspendProcess.c)
...
__int64 __fastcall RtlpWow64SuspendProcess(void *a1, __int64 a2, unsigned __int8 a3)
{
  ...
  if ( SharedInfoProcess >= 0 )
  {
    ...
    {
      if ( a2 )
        v12 = NtChangeProcessState(a2, a1);
      else
