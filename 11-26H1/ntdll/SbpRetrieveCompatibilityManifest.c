/*
 * XREFs of SbpRetrieveCompatibilityManifest @ 0x180084ADC
 * Callers:
...
__int64 __fastcall SbpRetrieveCompatibilityManifest(PACTIVATION_CONTEXT ActivationContext, void **a2, SIZE_T *a3)
{
  ...
  *a2 = 0LL;
  ...
  if ( (int)(v10 + 0x80000000) < 0 || v10 == -1073741789 )
  {
    ...
    if ( Size > *a3 )
    {
      ActivationContextInformation = RtlAllocateHeap_0(NtCurrentPeb()->ProcessHeap, 8u, Size);
    ...
    if ( ActivationContextInformation && ActivationContextInformation != v5 )
      RtlFreeHeap_0(NtCurrentPeb()->ProcessHeap, 0, ActivationContextInformation);
  }
  return v4;
}
