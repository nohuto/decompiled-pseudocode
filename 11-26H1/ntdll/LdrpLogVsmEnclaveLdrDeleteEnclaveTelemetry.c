/*
 * XREFs of LdrpLogVsmEnclaveLdrDeleteEnclaveTelemetry @ 0x18015DB44
 * Callers:
...
char __fastcall LdrpLogVsmEnclaveLdrDeleteEnclaveTelemetry(int a1)
{
  ...
  if ( v1->ProcessHeap )
  {
    ...
    {
      LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1801C59C8, 0x400000000000LL);
      if ( (_BYTE)v1 )
      {
        v10 = 17LL;
        v9 = "LdrDeleteEnclave";
        ...
        v11 = &v7;
        v12 = v5;
        LOBYTE(v1) = tlgWriteTransfer_EtwEventWriteTransfer(v3, byte_18019C471, v4, v5, v5, (__int64)v8);
      }
    }
  }
  return (char)v1;
