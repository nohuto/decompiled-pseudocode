/*
 * XREFs of RtlFindClearBits @ 0x180093D40
 * Callers:
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a2 > 0x7F )
      {
        ...
        while ( 1 )
        {
          v27 = ((unsigned int)(((__int64)v18 - v13) >> 3) << 6) - v38;
          if ( v27 > v14 )
            goto LABEL_36;
          v40 = a2 - v38;
          v41 = a2 - v38;
...
LABEL_75:
      ...
      if ( a2 <= 1 )
      {
        ...
        v27 = ((unsigned int)(((__int64)v18 - v13) >> 3) << 6) + v29;
        if ( v27 <= v14 )
        {
LABEL_38:
          if ( v27 != -1 )
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v21 )
          ...
          v32 = 63 - v31;
        v27 = (((unsigned int)(((__int64)v18 - v13) >> 3) + 1) << 6) - v32;
        if ( v27 > v14 )
          goto LABEL_27;
        v33 = a2 - v32;
        if ( a2 == v32 )
