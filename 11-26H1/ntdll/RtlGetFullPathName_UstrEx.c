/*
 * XREFs of RtlGetFullPathName_UstrEx @ 0x1800A6A60
 * Callers:
...
LABEL_11:
    LODWORD(a8) = v16;
    FullPathName_Ustr = RtlGetFullPathName_Ustr(a1, v16, v17, &v32, a6, (int *)&v34);
...
LABEL_37:
            ...
            if ( !Atom )
              break;
            v26 = RtlGetFullPathName_Ustr(a1, (int)v24 - 2, Atom, &v32, a6, (int *)&v34);
            v19 = v26;
            if ( !v26 )
              goto LABEL_23;
            if ( v26 <= (unsigned __int64)(unsigned __int16)a8 - 2 )
            {
              if ( v13 )
              {
                if ( v32 )
                  v30 = ((__int64)v32 - v15) >> 1;
                else
                  v30 = 0LL;
                *v13 = v30;
              }
