/*
 * XREFs of RtlGetFullPathName_UstrEx @ 0x1800A5B90
 * Callers:
...
LABEL_11:
    ...
    if ( FullPathName_Ustr )
    {
      if ( StaticString && FullPathName_Ustr < (unsigned int)BytesRequired )
      {
        ...
        {
          if ( v32 )
            v28 = (v32 - (char *)StaticString->Buffer) >> 1;
          else
            v28 = 0LL;
          *v13 = v28;
        }
...
LABEL_37:
            ...
            FilePartPrefixCch = v24;
            LOWORD(BytesRequired) = (_WORD)v24;
            Atom = (wchar_t *)RtlpAllocateAtom((unsigned int)v24);
            v15 = Atom;
            if ( !Atom )
              break;
            v26 = RtlGetFullPathName_Ustr(&FileName->Length, (int)v24 - 2, Atom, (int **)&v32, NameInvalid, (int *)&v34);
            v19 = v26;
            if ( !v26 )
              goto LABEL_23;
            if ( v26 <= (unsigned __int64)(unsigned __int16)BytesRequired - 2 )
            {
              if ( v13 )
              {
                if ( v32 )
              ...
              v27 = (unsigned __int16)FilePartPrefixCch;
...
LABEL_22:
  ...
  v22 = (char *)RtlpAllocateAtom(0x208uLL);
  v11 = v22;
  if ( v22 )
  {
    Buffer = (wchar_t *)v22;
