/*
 * XREFs of RtlRestoreContext @ 0x180126F90
 * Callers:
...
LABEL_6:
    if ( (*(&qword_1801E3500 + 1) & 0x1000000000000000LL) == 0
      && ((ContextRecord->ContextFlags & 0x100040) != 0x100040
       || (*(DWORD64 *)((_BYTE *)&ContextRecord[1].P2Home + SLODWORD(ContextRecord[1].P3Home)) & 0x800) == 0)
    ...
    if ( (unsigned int)ZwContinue(ContextRecord, 0LL) == -1073740278 )
      __fastfail(0x30u);
    return;
  }
