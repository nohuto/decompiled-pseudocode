/*
 * XREFs of RtlpResolveAssemblyStorageMapEntry @ 0x1800A28EC
 * Callers:
        ...
        __int64 a5)
{
  ...
  __m128i v54; // [rsp+110h] [rbp+10h] BYREF
  ...
  if ( a1 )
  {
    ...
    _mm_lfence();
    v12 = a2[6];
    v13 = *(unsigned int *)((char *)&a2[6 * v5 + 4] + *(unsigned int *)((char *)a2 + v12 + 12));
    v14 = (char *)a2 + *(unsigned int *)((char *)a2 + v12 + 16);
    v15 = *(unsigned int *)((char *)a2 + v13 + 80);
    if ( v15 > 0xFFFE )
    {
      DbgPrintEx(
        51,
    ...
    if ( (*((_BYTE *)a2 + v13 + 4) & 0x10) == 0 )
    {
      LOWORD(v48) = *(_WORD *)((char *)a2 + v13 + 80);
      WORD1(v48) = v48;
      v21 = *(unsigned int *)((char *)a2 + v13 + 84);
      v39 = a2;
...
LABEL_53:
    ...
    v35 = v50;
    v16 = (const wchar_t *)&v14[*(unsigned int *)((char *)a2 + v13 + 24)];
    if ( !v16 )
...
LABEL_16:
    ...
    {
      v54 = 0LL;
      if ( (int)RtlInitUnicodeStringEx(&v54, v35[1]) < 0
        || (int)RtlpDosPathNameToRelativeNtPathName(2, &v54, 0LL, (unsigned __int16 *)&v49, 0LL, 0LL, (__int64)&v52) < 0 )
      {
        DbgPrintEx(
          51,
          0,
