/*
 * XREFs of LdrpHandleInvalidUserCallTarget @ 0x180127640
 * Callers:
 ...
 *     LdrpDispatchUserCallTarget @ 0x1801277A0 (LdrpDispatchUserCallTarget.c)
 *     LdrpDispatchUserCallTargetES @ 0x1801277F0 (LdrpDispatchUserCallTargetES.c)
 * Callees:
