/*
 * XREFs of UcpFindOrCreateTelemetryRecord @ 0x180157B98
 * Callers:
...
__int64 __fastcall UcpFindOrCreateTelemetryRecord(__int64 a1)
{
  ...
  {
    if ( (unsigned int)dword_1801C56C8 > 4 )
    {
      if ( tlgKeywordOn((__int64)&dword_1801C56C8, 0x400000000000LL) )
      {
        v11 = v4;
        v13 = &v11;
        v14 = 8LL;
        tlgWriteTransfer_EtwEventWriteTransfer(v5, byte_18019BF92, v6, v4, 3, (__int64)v12);
        LODWORD(v4) = UcpTriggeredNodeCount;
      }
    }
