...
LABEL_5:
          ...
          {
            if ( v14 != 46 || v3 || v11 > 2 || v10 > 6 && !v5 || v10 > 7 )
              goto LABEL_16;
            ++v11;
          }
          v8 = 0;
LABEL_37:
          ...
          if ( v11 )
          {
            ...
            if ( v16 > 0xFF )
              return -1073741811;
            Addr->u.Byte[2 * v22 - 1 + v11] = v16;
          }
          else
          {
            if ( v12 > 4 )
              return -1073741811;
            Addr->u.Word[v22++] = __ROR2__(wcstol(v9, 0LL, 16), 8);
          }
          goto LABEL_54;
        }
        ++v12;
...
LABEL_19:
  ...
  if ( v8 == 1 )
  {
    if ( v11 )
    {
      ...
      if ( v17 > 0xFF )
        return -1073741811;
      Addr->u.Byte[2 * v22 + v11] = v17;
    }
    else
    {
      if ( v12 > 4 )
        return -1073741811;
      Addr->u.Word[v22] = __ROR2__(wcstol(String, 0LL, 16), 8);
    }
  }
  else
  {
