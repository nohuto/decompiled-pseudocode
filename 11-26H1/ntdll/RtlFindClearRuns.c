/*
 * XREFs of RtlFindClearRuns @ 0x1800D7970
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800D7920 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
...
LABEL_8:
    ...
    v14 = v15 - v13 + 8;
    for ( j = *((_BYTE *)&unk_18017CB00 - v13) | byte_18018B198[v17] | v16; ; j |= k )
    {
      v20 = v11;
      if ( j == 0xFF )
        break;
      ...
      v22 = *v21;
      v23 = 0;
      for ( k = byte_18018B198[v22]; ((unsigned __int8)k & j) != 0; ++v23 )
        k *= 2;
      ++v11;
      if ( v20 >= v5 )
        v11 = v20;
...
LABEL_44:
      ...
      {
        v36 = (int)v34;
        for ( n = (_QWORD *)(v4 + 8 * ((int)v34 + 1LL)); v36 >= 0 && *((_DWORD *)n - 1) < (unsigned int)v13; --n )
        {
          --v34;
          --v36;
          *n = *(n - 1);
      ...
      *(_DWORD *)(v4 + 8LL * (int)v34 + 12) = v13;
      *(_DWORD *)(v4 + 8LL * (int)v34 + 8) = v14;
    }
    else if ( *(_DWORD *)(v4 + 8LL * (v11 - 1) + 4) < (unsigned int)v13 )
    {
      goto LABEL_44;
    }
  }
