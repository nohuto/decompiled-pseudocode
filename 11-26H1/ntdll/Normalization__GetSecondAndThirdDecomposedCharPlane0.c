/*
 * XREFs of Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x1800AFEF4
 * Callers:
...
__int64 __fastcall Normalization__GetSecondAndThirdDecomposedCharPlane0(__int64 a1, int a2, _DWORD *a3, _DWORD *a4)
{
  ...
  *a3 = 0;
  ...
  {
    v15 = *(_QWORD *)(a1 + 80);
    result = *(unsigned __int16 *)(v15 + 2LL * (unsigned __int16)((v9 & 0x1FFF) + 1));
    *a3 = result;
    if ( v14 != 2 )
    {
      result = (unsigned __int16)((v9 & 0x1FFF) + 2);
