/*
 * XREFs of RtlFindSetBitsEx @ 0x1800E59D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_37:
      while ( 1 )
      {
        v14 = ((__int64)((__int64)v11 - v5) >> 3 << 6) - v24;
        if ( v14 > v9 )
          goto LABEL_12;
        v25 = &v11[(a2 - v24) >> 6];
        while ( ++v11 != v25 )
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( v19 )
            ...
            v35 = 63 - v34;
          v14 = ((((__int64)((__int64)v11 - v5) >> 3) + 1) << 6) - v35;
          if ( v14 > v9 )
            goto LABEL_12;
          v31 = a2 - v35;
          if ( a2 == v35 )
...
LABEL_32:
    ...
    v14 = ((__int64)((__int64)v11 - v5) >> 3 << 6) + v13;
LABEL_9:
    if ( v14 <= v9 )
      break;
LABEL_12:
