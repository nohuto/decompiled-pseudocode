/*
 * XREFs of LdrpGetModuleInfoFromVirtualMemory @ 0x1800E6C70
 * Callers:
        ...
        _BYTE *a7)
{
  ...
  v12 = -1LL;
  v13 = ZwQueryVirtualMemory(-1LL, a1, 2LL, Heap_0, v8, &v22);
  if ( v13 >= 0 )
  {
    v14 = -1LL;
    do
      ++v14;
    while ( *(_WORD *)(*(_QWORD *)(Heap_0 + 8) + 2 * v14) );
    v15 = 2 * v14 + 2;
    v22 = v15;
    if ( v15 >= v8 )
    {
    ...
    memmove(a2, *(const void **)(Heap_0 + 8), v15);
