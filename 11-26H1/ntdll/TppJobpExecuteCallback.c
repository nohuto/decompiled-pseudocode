/*
 * XREFs of TppJobpExecuteCallback @ 0x1800C0640
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall TppJobpExecuteCallback(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  TppBarrierAdjust((signed __int64 *)(a2 + 128), 1, 0);
...
LABEL_3:
    ...
    v17 = 0LL;
    if ( (int)LdrpFindLoadedDllByHandle(v11, &v17, &v19, v9) >= 0 )
    {
      Count = LdrpIncrementModuleLoadCount(v17, v15);
  ...
  TppBarrierAdjust((signed __int64 *)(v6 + 56), -1, 0);
