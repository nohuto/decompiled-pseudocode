/*
 * XREFs of RtlCaptureContext2 @ 0x180126BF0
 * Callers:
 *     RtlUnwindEx @ 0x180033EB0 (RtlUnwindEx.c)
 * Callees:
 *     RtlpSanitizeContextFlags @ 0x1800BD650 (RtlpSanitizeContextFlags.c)
 *     RtlpMergeContextXState @ 0x1800CA890 (RtlpMergeContextXState.c)
 */
