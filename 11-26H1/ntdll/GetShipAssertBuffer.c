/*
 * XREFs of GetShipAssertBuffer @ 0x1800D605C
 * Callers:
...
__int64 GetShipAssertBuffer()
{
  ...
  v4 = 0LL;
  v5 = 0LL;
  v0 = _InterlockedCompareExchange64(&qword_1801C7230, 255LL, 0LL);
  v1 = v0;
  if ( v0 )
  {
    if ( v0 == 255 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( ++v2 >= 5 )
        {
          ...
          {
            v1 = 238LL;
            _InterlockedCompareExchange64(&qword_1801C7230, 238LL, 255LL);
          }
          break;
        }
      }
  ...
  else
  {
    ...
    {
      _InterlockedExchange64(&qword_1801C7230, v4);
      return v4;
    }
  }
  if ( v4 )
