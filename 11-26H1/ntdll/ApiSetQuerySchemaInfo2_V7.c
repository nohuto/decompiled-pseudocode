/*
 * XREFs of ApiSetQuerySchemaInfo2_V7 @ 0x180117408
 * Callers:
 ...
 *     ApiSetpGetSemverKeyVersions @ 0x1801221F8 (ApiSetpGetSemverKeyVersions.c)
...
LABEL_19:
      ...
      v27 = 0LL;
      v28 = 0LL;
      if ( !ApiSetpGetContractKeyInfo(a2, v6, 0, (__int64)&v27) )
        return v5;
      if ( HIDWORD(v27) == 2 )
      {
        ...
        v25 = *(unsigned int *)(v4 + 56) + v21 * (unsigned __int64)*(unsigned __int8 *)(v4 + 64) - v24;
        LOBYTE(v22) = (*(_BYTE *)(v4 + 2) & 8) != 0;
        if ( *(_DWORD *)(v25 + v4) == (unsigned int)ApiSetpGetSearchKeyHash(
                                                      (unsigned int)&v27,
                                                      0,
                                                      v22,
                                                      v23,
                                                      *(_BYTE *)(v4 + 67)) )
        {
          if ( (*(_BYTE *)(v25 + v4 + 6) & 2) != 0 )
          {
            *a3 = 243;
            return v5;
          }
          v26 = *(unsigned int *)(v4 + 44)
              + *(unsigned __int8 *)(v4 + 52) * (unsigned __int64)*(unsigned __int16 *)(v25 + v4 + 4)
              - v24;
...
LABEL_37:
      ...
      else
      {
        ...
        v16 = *(unsigned int *)(v4 + 68) + v12 * (unsigned __int64)*(unsigned __int8 *)(v4 + 76) - v15;
        LOBYTE(v13) = (*(_BYTE *)(v4 + 2) & 8) != 0;
        if ( *(_DWORD *)(v16 + v4) == (unsigned int)ApiSetpGetSearchKeyHash(
                                                      (unsigned int)&v27,
                                                      0,
                                                      v13,
                                                      v14,
                                                      *(_BYTE *)(v4 + 79)) )
        {
          v18 = *(unsigned int *)(v4 + 44)
              + *(unsigned __int8 *)(v4 + 52) * (unsigned __int64)*(unsigned __int16 *)(v16 + v4 + 4);
          v30 = 0;
          v19 = v18 - v15;
          if ( !(unsigned __int8)ApiSetpGetSemverKeyVersions(&v27, v17, &v30) )
            return (unsigned int)-1073741811;
          if ( v30 <= *(_BYTE *)(v16 + v4 + 9) )
          {
