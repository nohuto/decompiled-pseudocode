/*
 * XREFs of RtlpSysVolTakeOwnership @ 0x1800C7F18
 * Callers:
 ...
 *     RtlCreateSecurityDescriptor @ 0x1800D9FC0 (RtlCreateSecurityDescriptor.c)
...
NTSTATUS __fastcall RtlpSysVolTakeOwnership(UNICODE_STRING *a1)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  if ( result >= 0 )
  {
    ...
    v11 = 1;
    v13 = 2;
    if ( (int)NtAdjustPrivilegesToken(Handle, 0LL, &v11, 16LL, 0LL, 0LL) >= 0 )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      {
        RtlCreateSecurityDescriptor(v8, 1LL);
        v15 = 0;
        v16 = 1280;
        v14 = 513;
        v17 = 32;
        v18 = 544;
        v3 = RtlSetOwnerSecurityDescriptor(v8, &v14, 0LL);
        v4 = FileHandle[0];
        if ( v3 >= 0 )
        {
