/*
 * XREFs of RtlFxToFnFrame @ 0x1800C31B0
 * Callers:
 *     RtlpWow64CtxFromAmd64 @ 0x1800C2EB0 (RtlpWow64CtxFromAmd64.c)
 * Callees:
 *     <none>
 */
...
unsigned __int16 __fastcall RtlFxToFnFrame(__int64 a1, unsigned __int16 *a2)
{
  ...
  *(_WORD *)(a1 + 36) = a2[20];
  if ( v5 < 0 )
  {
    v7 = 2;
    v35 = 8 * (v6 + 2LL);
    if ( (a2[v35 + 4] & 0x7FFF) != 0 )
    {
      if ( (a2[v35 + 4] & 0x7FFF) != 0x7FFF && *(__int64 *)&a2[v35] < 0 )
        v7 = 0;
    }
    else if ( !*(_QWORD *)&a2[v35] )
    {
      v7 = 1;
    }
  }
