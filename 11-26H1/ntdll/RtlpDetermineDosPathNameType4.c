/*
 * XREFs of RtlpDetermineDosPathNameType4 @ 0x1800A4A00
 * Callers:
 *     RtlpGetLengthWithoutLastPathElement @ 0x1800A48F4 (RtlpGetLengthWithoutLastPathElement.c)
 * Callees:
  ...
  *v14 = v12;
    ...
    && !RtlEqualUnicodeString((PUNICODE_STRING)&RtlpWin32NtUncRootSlash, a2, 1u) )
  {
    ...
    if ( !v10 )
    {
      ...
      LOWORD(v18[0]) -= 8;
      WORD1(v18[0]) -= 8;
      v17 = RtlDetermineDosPathNameType_Ustr(v18);
      v9 = v17 == 2;
      if ( v17 != 2 )
        *a4 |= 0x200u;
      goto LABEL_18;
