/*
 * XREFs of RtlNumberOfSetBits @ 0x1800E4390
 * Callers:
 *     TpSetPoolThreadCpuSets @ 0x1800855C0 (TpSetPoolThreadCpuSets.c)
 *     RtlNumberOfClearBits @ 0x1800E4370 (RtlNumberOfClearBits.c)
 * Callees:
 *     <none>
 */
...
ULONG __cdecl RtlNumberOfSetBits(PRTL_BITMAP BitMapHeader)
{
  ...
  for ( i = 0; v8; --v8 )
  {
    ...
    if ( i == v7 - 1 && v4 )
      v13 &= byte_18018A108[SizeOfBitMap & 7];
    ++i;
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( i == v18 && (SizeOfBitMap & 7) != 0 )
        v19 &= byte_18018A108[SizeOfBitMap & 7];
      ++i;
