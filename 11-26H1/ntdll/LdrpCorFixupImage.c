/*
 * XREFs of LdrpCorFixupImage @ 0x180100B5C
 * Callers:
...
__int64 __fastcall LdrpCorFixupImage(unsigned __int64 a1)
{
  ...
  unsigned __int64 v10; // [rsp+80h] [rbp+38h] BYREF
  unsigned int v11; // [rsp+88h] [rbp+40h] BYREF
  int v12; // [rsp+90h] [rbp+48h] BYREF
  _WORD *v13; // [rsp+98h] [rbp+50h] BYREF
  ...
  v2 = v13;
  if ( v13[12] != 267 || v13[2] != 332 || (v1[4] & 2) != 0 )
  {
    v8 = v13[2];
