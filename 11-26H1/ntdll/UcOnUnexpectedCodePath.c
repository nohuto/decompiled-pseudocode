/*
 * XREFs of UcOnUnexpectedCodePath @ 0x180157700
 * Callers:
 *     RtlLogUnexpectedCodepath @ 0x180148950 (RtlLogUnexpectedCodepath.c)
 * Callees:
    ...
    if ( v6 )
    {
      ...
      if ( (unsigned __int64)(unsigned int)v8 - *(_QWORD *)(v7 + 8) > 0xEA60 )
      {
        *(_QWORD *)(v7 + 8) = v8;
        ...
        if ( !(_BYTE)v13 )
        {
          if ( (unsigned int)dword_1801C46C8 > 4 && tlgKeywordOn((__int64)&dword_1801C46C8, 0x400000000000LL) )
          {
            v18 = *a1;
            ...
            tlgWriteTransfer_EtwEventWriteTransfer(
              v10,
              (unsigned __int8 *)dword_18019AFD7,
              v11,
              v12,
              7u,
