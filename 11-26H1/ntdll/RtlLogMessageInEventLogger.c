/*
 * XREFs of RtlLogMessageInEventLogger @ 0x180120700
 * Callers:
 *     LdrpLogEtwHotPatchStatus @ 0x18008FFAC (LdrpLogEtwHotPatchStatus.c)
 *     RtlWow64LogMessageInEventLogger @ 0x18015CAF0 (RtlWow64LogMessageInEventLogger.c)
 * Callees:
...
int __fastcall RtlLogMessageInEventLogger(__int16 a1, __int64 a2, unsigned int a3, __int64 a4, unsigned __int16 a5)
{
  ...
  {
    LODWORD(v5) = LdrLoadDll(0LL, 0LL, (PUNICODE_STRING)&stru_180171E98, &DllHandle);
    if ( (int)v5 >= 0 )
    {
      if ( LdrGetProcedureAddress(DllHandle, (PANSI_STRING)&stru_180171E68, 0, &ProcedureAddress) >= 0
        && LdrGetProcedureAddress(DllHandle, (PANSI_STRING)&stru_180171EA8, 0, &v16) >= 0
        && LdrGetProcedureAddress(DllHandle, (PANSI_STRING)&stru_180171E88, 0, &v15) >= 0 )
      {
