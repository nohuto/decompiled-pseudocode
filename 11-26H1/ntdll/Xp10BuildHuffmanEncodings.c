/*
 * XREFs of Xp10BuildHuffmanEncodings @ 0x180115970
 * Callers:
  ...
  if ( v8 > (unsigned __int64)(a1 + 6) )
  {
    ...
    if ( (_DWORD)v16 )
    {
      ...
      do
      {
        ...
        v21 = *((_WORD *)v18 + 8);
        v18 += 24;
        v22 = *((unsigned __int16 *)a1 + v20 + 16908);
        *((_WORD *)a1 + v20 + 16908) = v22 + 1;
          ...
          if ( *((unsigned __int8 *)a1 + v57 + 38176) == v52 )
          {
            ...
            if ( v52 > 8 )
            {
              ...
              do
              {
                ...
                v58 -= 8;
                v59 >>= 8;
                v60 = byte_180190890[v62] | (v60 << 8);
                --v61;
              }
              while ( v61 );
            }
            if ( v58 )
              v60 = (byte_180190890[(unsigned __int8)v59] | (v60 << 8)) >> (8 - v58);
