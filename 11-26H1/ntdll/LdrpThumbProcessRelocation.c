/*
 * XREFs of LdrpThumbProcessRelocation @ 0x1800D561C
 * Callers:
...
__int64 __fastcall LdrpThumbProcessRelocation(unsigned __int16 *a1, __int64 a2, int a3)
{
  ...
  if ( v3 == 7 )
  {
    ...
    v7 = v4[1];
    v8 = a3
       + ((unsigned __int8)v7 | (v7 >> 4) & 0x700 | (unsigned __int16)(2 * ((*v4 << 11) | *v4 & 0x400)) | ((((unsigned __int16)v4[3] >> 4) & 0x700 | (unsigned __int16)(2 * ((v6 << 11) | v6 & 0x400)) | (unsigned __int8)v4[3]) << 16));
