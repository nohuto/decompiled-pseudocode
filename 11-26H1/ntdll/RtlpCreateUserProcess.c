/*
 * XREFs of RtlpCreateUserProcess @ 0x1800FC408
 * Callers:
 *     RtlCreateUserProcessEx @ 0x1800FC350 (RtlCreateUserProcessEx.c)
 *     RtlCloneUserProcess @ 0x18015C500 (RtlCloneUserProcess.c)
 * Callees:
 *     NtCreateUserProcess @ 0x180160850 (NtCreateUserProcess.c)
