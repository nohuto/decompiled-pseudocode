...
__int64 __fastcall RtlpQueryExtendedInformationAllHeaps(__int64 a1)
{
  ...
  {
    RtlpEnumProcessHeaps((__int64 (__fastcall *)(__int64, _QWORD, __int64))RtlpLockUlockAllHeapsCallback, 1LL, 1);
    if ( *(_DWORD *)a1 == 0x80000000 )
      goto LABEL_3;
    v3 = RtlpEnumProcessHeaps(
           (__int64 (__fastcall *)(__int64, _QWORD, __int64))RtlpHeapQueryTotalReserveSize,
           (__int64)&v11,
           3);
    if ( v3 >= 0 )
    {
...
LABEL_3:
        v3 = RtlpEnumProcessHeaps(
               (__int64 (__fastcall *)(__int64, _QWORD, __int64))RtlpQueryExtendedInformationHeap,
               a1,
               3);
    }
    RtlpEnumProcessHeaps((__int64 (__fastcall *)(__int64, _QWORD, __int64))RtlpLockUlockAllHeapsCallback, 0LL, 1);
  }
  else
  {
