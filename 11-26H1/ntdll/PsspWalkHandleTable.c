/*
 * XREFs of PsspWalkHandleTable @ 0x1800B6540
 * Callers:
        ...
        __int64 a6)
{
  ...
  memset_thunk_772440563353939046(v22, 0, 0xA8uLL);
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      if ( (int)ZwDuplicateObject(v8, v12, -1LL, &Handle, 0, 0, 2) < 0 )
        goto LABEL_19;
      v13 = 4;
      if ( (int)ZwQueryObject(Handle, 2LL, v22, 168LL, 0LL) >= 0 )
        break;
      NtClose(Handle);
LABEL_21:
      ++v11;
    ...
    if ( (a4 & 8) != 0 )
    {
      memset_thunk_772440563353939046(v27, 0, 0x210uLL);
      v16 = 0;
      if ( wcsicmp(String1, L"File") && (int)ZwQueryObject(Handle, 1LL, v27, 528LL, 0LL) < 0 )
        v28 = 0;
    }
    else
    {
    ...
    if ( (a4 & 0x10) != 0 && (int)ZwQueryObject(Handle, 0LL, v24, 56LL, 0LL) >= 0 )
      v13 = 20;
    v17 = 0;
    if ( (a4 & 0x20) != 0 )
    {
      while ( v16 < 6 )
      {
        if ( !wcsicmp(String1, (&off_180171C80)[3 * v16]) )
        {
          if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *))*(&funcs_1800B6735 + 3 * v16))(
                 Handle,
                 v26,
                 64LL,
                 &v17) >= 0
          ...
          {
            v13 |= 0x20u;
            v14 = (char)(&off_180171C80)[3 * v16 + 1];
            goto LABEL_18;
          }
          break;
        }
...
LABEL_19:
    ...
    result = v20(
               ...
               *a2,
               v15,
               (unsigned __int64)v22 & -(__int64)((v13 & 4) != 0),
