/*
 * XREFs of ?EmitSetSuperDownSampleCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FD14
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetSuperDownSampleCommand(
