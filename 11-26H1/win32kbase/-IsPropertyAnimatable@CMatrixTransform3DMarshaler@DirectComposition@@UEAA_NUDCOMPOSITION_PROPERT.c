/*
 * XREFs of ?IsPropertyAnimatable@CMatrixTransform3DMarshaler@DirectComposition@@UEAA_NUDCOMPOSITION_PROPERTY_ID@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x14023D3E0
 * Callers:
 *     <none>
 * Callees:
