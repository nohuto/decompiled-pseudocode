/*
 * XREFs of ?Initialize@?$CSectionEntry@$0FAAA@$0FA@@NSInstrumentation@@AEAA_NXZ @ 0x1401DF128
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<20480,80>::Initialize(PVOID *a1)
{
