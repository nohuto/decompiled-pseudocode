/*
 * XREFs of ?RimDeviceExtendedProps@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1401AE388
 * Callers:
 ...
 *     ?LegacyFlagsToString@InputTraceLogging@@CAPEBDG@Z @ 0x1401B9290 (-LegacyFlagsToString@InputTraceLogging@@CAPEBDG@Z.c)
 */
...
void __fastcall InputTraceLogging::RIM::RimDeviceExtendedProps(const struct RIMDEV *a1)
{
  ...
  if ( (*((_DWORD *)a1 + 46) & 0x80u) == 0 )
  {
    ...
    if ( v3 )
    {
      if ( v3 == 1 && (unsigned int)dword_1402A9E40 > 4 && tlgKeywordOn((__int64)&dword_1402A9E40, 256LL) )
      {
        v6 = *(_DWORD *)(v8 + 476) & 1;
        v32 = v8;
        v31 = -v6;
    ...
    else if ( (unsigned int)dword_1402A9E40 > 4 && tlgKeywordOn((__int64)&dword_1402A9E40, 256LL) )
    {
      ...
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapSz<char>,_tlgWrapperByVal<2>>(
        ...
        (__int64)&v31);
         ...
         && tlgKeywordOn((__int64)&dword_1402A9E40, 256LL) )
  {
    v31 = v2[90];
    LODWORD(v32) = v2[89];
    LODWORD(v33) = v2[88];
