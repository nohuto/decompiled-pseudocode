/*
 * XREFs of ??_GCTransformGroupMarshaler@DirectComposition@@UEAAPEAXI@Z @ 0x14015EDB0
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall DirectComposition::CTransformGroupMarshaler::`scalar deleting destructor'(char *Buffer, char a2)
{
  ...
  DirectComposition::CMarshaledArray<unsigned int,1885946692,534,535,0>::~CMarshaledArray<unsigned int,1885946692,534,535,0>(Buffer + 72);
  if ( (a2 & 1) != 0 )
