/*
 * XREFs of ?Serialize@CIVTouchSerializer@@QEAAJPEAPEAU_IVRIMPOINTERRAWDATA@@PEBUCPointerRawData@@K_N@Z @ 0x140226930
 * Callers:
        ...
        bool a5)
{
  ...
  __int64 v12; // rcx
  __int64 v13; // r9
  struct _IVRIMPOINTERRAWDATA *v14; // r12
  __int64 i; // rsi
  char *v16; // r15
  ...
  if ( CIVSerializer::Ensure(this, v9) )
  {
    ...
    *a2 = v14;
    ...
    {
      v16 = (char *)v14 + 24 * i;
      *(_DWORD *)v16 = *((_DWORD *)a3 + 1);
      *((_DWORD *)v16 + 1) = *((_DWORD *)a3 + 2);
      *((_QWORD *)v16 + 2) = 0LL;
      if ( (int)CIVSerializer::Serialize(this, (void **)v16 + 1, *((void *const *)a3 + 2), *((_DWORD *)a3 + 2), 0) < 0 )
        return 3221225495LL;
      if ( (_DWORD)i )
        *((_QWORD *)v14 + 3 * (unsigned int)(i - 1) + 2) = (unsigned __int64)&v16[-*((_QWORD *)this + 2)] | 1;
      a3 = (const struct CPointerRawData *)*((_QWORD *)a3 + 3);
    }
