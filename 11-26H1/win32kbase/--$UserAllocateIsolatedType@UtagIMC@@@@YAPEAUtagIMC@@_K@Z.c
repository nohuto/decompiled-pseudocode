/*
 * XREFs of ??$UserAllocateIsolatedType@UtagIMC@@@@YAPEAUtagIMC@@_K@Z @ 0x1400B9D28
 * Callers:
...
__int64 __fastcall UserAllocateIsolatedType<tagIMC>(ULONG_PTR BugCheckParameter4, int a2, int a3)
{
  __int64 v4; // rdx
  __int64 result; // rax
  ...
  if ( *(_QWORD *)(v4 + 136) )
  {
    ...
    return NSInstrumentation::CTypeIsolation<20480,80>::Allocate();
  }
  return result;
}
