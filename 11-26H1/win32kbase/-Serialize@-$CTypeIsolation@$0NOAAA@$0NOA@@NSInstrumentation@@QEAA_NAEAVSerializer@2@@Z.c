/*
 * XREFs of ?Serialize@?$CTypeIsolation@$0NOAAA@$0NOA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401F0578
 * Callers:
...
char __fastcall NSInstrumentation::CTypeIsolation<909312,3552>::Serialize(
        __int64 a1,
        NSInstrumentation::Serializer *a2)
{
    ...
    && NSInstrumentation::Serializer::Serialize<bool>((__int64)a2, (_BYTE *)(a1 + 36)) )
  {
    ...
    {
      if ( !NSInstrumentation::CSectionEntry<909312,3552>::Serialize((__int64)i, a2) )
        goto LABEL_13;
    }
