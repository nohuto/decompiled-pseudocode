/*
 * XREFs of ?SecondaryHitTest@Pointer@InputTraceLogging@@SAXAEBTPOINTERINFOUNION@@_KHAEBVCInputDest@@AEBUtagPOINT@@@Z @ 0x1400CB448
 * Callers:
        ...
        const struct tagPOINT *a5)
{
  ...
  if ( dword_1402A9E40 )
  {
    if ( (qword_1402A9E50 & 0x20) != 0 && (qword_1402A9E58 & 0x20) == qword_1402A9E58 )
    {
      ...
      WindowDetails = InputTraceLogging::GetWindowDetails(v31, UserWindow);
