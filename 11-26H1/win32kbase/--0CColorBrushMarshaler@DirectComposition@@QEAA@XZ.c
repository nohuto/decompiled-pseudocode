/*
 * XREFs of ??0CColorBrushMarshaler@DirectComposition@@QEAA@XZ @ 0x14005614C
 * Callers:
...
_QWORD *__fastcall DirectComposition::CColorBrushMarshaler::CColorBrushMarshaler(
        DirectComposition::CColorBrushMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CSceneObjectMarshaler::CSceneObjectMarshaler((__int64)this, 19LL);
  result = v1;
  *v1 = &DirectComposition::CColorBrushMarshaler::`vftable';
  return result;
}
