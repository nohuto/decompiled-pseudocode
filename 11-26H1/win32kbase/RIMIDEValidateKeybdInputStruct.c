/*
 * XREFs of RIMIDEValidateKeybdInputStruct @ 0x1401BBC44
 * Callers:
...
__int64 __fastcall RIMIDEValidateKeybdInputStruct(__int16 *a1)
{
  ...
  if ( (v1 & 4) != 0 && (*a1 || (v1 & 0xFFFF7FC9) != 0) )
  {
    ...
    {
      UserSessionState = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, (_DWORD)a1, 0);
      LOBYTE(v5) = v3;
      LOBYTE(v6) = v2;
  ...
  if ( (v1 & 8) == 0 )
  {
    ...
    if ( (unsigned __int16)*a1 > 0xFEu )
    {
      ...
      {
        v10 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, (_DWORD)a1, 0);
        LOBYTE(v11) = v9;
        LOBYTE(v12) = v8;
        WPP_RECORDER_AND_TRACE_SF_d(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
    ...
    && *((_DWORD *)a1 + 2) > (unsigned int)((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24) )
  {
    ...
    if ( v13 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      v17 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, (_DWORD)a1, 0);
      LOBYTE(v18) = v14;
      LOBYTE(v19) = v13;
  ...
  if ( *((_QWORD *)a1 + 2) && (*((_DWORD *)a1 + 1) & 0x8000) == 0 )
  {
    ...
    {
      v22 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, (_DWORD)a1, 0);
      LOBYTE(v23) = v21;
      LOBYTE(v24) = v20;
      WPP_RECORDER_AND_TRACE_SF_i(*((_QWORD *)WPP_GLOBAL_Control + 3), v24, v23, *(_QWORD *)(v22 + 19368), 2);
    }
    return 0LL;
  }
  return 1LL;
