/*
 * XREFs of ?EmitSetPositionShiftQueueIdCommand@CInteractionTracker2Marshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E6DC
 * Callers:
...
char __fastcall DirectComposition::CInteractionTracker2Marshaler::EmitSetPositionShiftQueueIdCommand(
