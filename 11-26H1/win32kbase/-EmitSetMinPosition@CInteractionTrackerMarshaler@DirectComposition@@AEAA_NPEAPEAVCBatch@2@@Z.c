/*
 * XREFs of ?EmitSetMinPosition@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140146044
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x4000) == 0 )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v6) )
    {
      ...
      *((_DWORD *)v5 + 3) = *((_DWORD *)this + 29);
      *((_DWORD *)v5 + 4) = *((_DWORD *)this + 30);
