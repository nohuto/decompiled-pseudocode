/*
 * XREFs of ??0CPathGeometryMarshaler@DirectComposition@@QEAA@XZ @ 0x14005606C
 * Callers:
...
_QWORD *__fastcall DirectComposition::CPathGeometryMarshaler::CPathGeometryMarshaler(
        DirectComposition::CPathGeometryMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CGeometryMarshaler::CGeometryMarshaler(this, 90LL);
  result = v1;
  *v1 = &DirectComposition::CPathGeometryMarshaler::`vftable';
  return result;
}
