/*
 * XREFs of EditionPointerWindowHitTest @ 0x140164928
 * Callers:
        ...
        __int64 a12)
{
  ...
  v16 = *(__int64 (__fastcall **)(_OWORD *, __int64, __int64, _QWORD, int, __int64, __int64, __int64, __int64, __int64, __int64, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 5672LL);
  if ( v16 )
  {
