/*
 * XREFs of ??$UserAllocateIsolatedType@U_CALLPROCDATA@@@@YAPEAU_CALLPROCDATA@@_K@Z @ 0x1401B6F88
 * Callers:
...
__int64 __fastcall UserAllocateIsolatedType<_CALLPROCDATA>(ULONG_PTR BugCheckParameter4, int a2, int a3)
{
  __int64 v4; // rdx
  __int64 result; // rax
  __int64 *v6; // rcx
