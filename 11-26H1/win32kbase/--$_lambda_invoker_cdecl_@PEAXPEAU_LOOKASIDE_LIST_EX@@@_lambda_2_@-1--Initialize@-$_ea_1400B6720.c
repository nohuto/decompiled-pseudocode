/*
 * XREFs of ??$_lambda_invoker_cdecl_@PEAXPEAU_LOOKASIDE_LIST_EX@@@_lambda_2_@?1??Initialize@?$CLookAsideTypeIsolation@$0JAAA@$0JA@@NSInstrumentation@@QEAA_NXZ@SA?A_PPEAXPEAU_LOOKASIDE_LIST_EX@@@Z @ 0x1400B6720
 * Callers:
 *     <none>
 * Callees:
