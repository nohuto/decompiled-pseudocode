/*
 * XREFs of ??0CCompositionGlyphRunMarshaler@DirectComposition@@QEAA@XZ @ 0x14023B2FC
 * Callers:
...
_QWORD *__fastcall DirectComposition::CCompositionGlyphRunMarshaler::CCompositionGlyphRunMarshaler(
        DirectComposition::CCompositionGlyphRunMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CTextObjectMarshaler::CTextObjectMarshaler(this, 28LL);
  result = v1;
  *v1 = &DirectComposition::CCompositionGlyphRunMarshaler::`vftable';
  return result;
}
