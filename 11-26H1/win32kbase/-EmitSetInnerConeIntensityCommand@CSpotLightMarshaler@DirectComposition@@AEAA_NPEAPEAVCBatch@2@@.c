/*
 * XREFs of ?EmitSetInnerConeIntensityCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022CEC4
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetInnerConeIntensityCommand(
