/*
 * XREFs of McTemplateK0dddd_EtwWriteTransfer @ 0x1401B9468
 * Callers:
 *     EtwTraceTouchTargetingOffset @ 0x1401947B0 (EtwTraceTouchTargetingOffset.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x14001E680 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x14024BC30 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0dddd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite_EtwWriteTransfer(a1, (const EVENT_DESCRIPTOR *)"j", &W32kControlGuid, 5u, &v8);
}
