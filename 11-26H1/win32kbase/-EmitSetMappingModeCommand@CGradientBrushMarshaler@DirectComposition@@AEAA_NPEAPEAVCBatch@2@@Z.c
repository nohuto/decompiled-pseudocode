/*
 * XREFs of ?EmitSetMappingModeCommand@CGradientBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D204
 * Callers:
...
char __fastcall DirectComposition::CGradientBrushMarshaler::EmitSetMappingModeCommand(
