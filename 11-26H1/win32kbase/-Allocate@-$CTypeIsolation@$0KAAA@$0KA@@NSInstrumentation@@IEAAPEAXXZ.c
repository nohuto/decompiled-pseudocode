/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0KAAA@$0KA@@NSInstrumentation@@IEAAPEAXXZ @ 0x140033954
 * Callers:
 ...
 *     ?Create@?$CSectionEntry@$0KAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ @ 0x14015A934 (-Create@-$CSectionEntry@$0KAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ.c)
 *     memset @ 0x14024BD80 (memset.c)
 */

__int64 __fastcall NSInstrumentation::CTypeIsolation<40960,160>::Allocate(__int64 *a1)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v13 = NSInstrumentation::CSectionEntry<40960,160>::Create();
      v14 = (_QWORD *)v13;
      if ( v13 )
      {
        v3 = NSInstrumentation::CSectionBitmapAllocator<40960,160>::Allocate(*(_QWORD *)(v13 + 32));
        if ( v3 )
        {
