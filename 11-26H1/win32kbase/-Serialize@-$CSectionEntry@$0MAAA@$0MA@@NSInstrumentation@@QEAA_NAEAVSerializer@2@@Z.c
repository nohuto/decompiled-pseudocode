/*
 * XREFs of ?Serialize@?$CSectionEntry@$0MAAA@$0MA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401EFF18
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<49152,192>::Serialize(__int64 a1, NSInstrumentation::Serializer *a2)
{
  unsigned int v4; // ebp
  bool v5; // bl
  __int64 v6; // rsi
  ...
  if ( !NSInstrumentation::Serializer::SerializeBytes(a2, *(void **)(a1 + 24), v4)
    || !NSInstrumentation::Serializer::AdvanceBytes(a2, 49152 - v4) )
  {
    return 0;
  }
  v6 = *(_QWORD *)(a1 + 32);
  ...
  {
    v5 = NSInstrumentation::Serializer::SerializeBytes(a2, *(void **)(v8 + 8), 0x20uLL);
  }
