/*
 * XREFs of ?Serialize@CIVPnPCreateSerializer@@AEAAJPEAPEAU_IV_HIDP_LINK_COLLECTION_NODE@@PEBU_HIDP_LINK_COLLECTION_NODE@@K_K_N@Z @ 0x140226494
 * Callers:
    ...
    *v12 = v13;
    if ( (_DWORD)v10 )
    {
      ...
      do
      {
        ...
        *((_DWORD *)v14 - 6) = *((_DWORD *)p_Parent - 4) >> 9;
        *((_QWORD *)v14 - 2) = 0LL;
        --v10;
      }
      while ( v10 );
