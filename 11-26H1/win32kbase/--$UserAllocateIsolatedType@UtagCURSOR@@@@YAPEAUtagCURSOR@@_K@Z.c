/*
 * XREFs of ??$UserAllocateIsolatedType@UtagCURSOR@@@@YAPEAUtagCURSOR@@_K@Z @ 0x1400B9A7C
 * Callers:
...
__int64 __fastcall UserAllocateIsolatedType<tagCURSOR>(ULONG_PTR BugCheckParameter4, int a2, int a3)
{
  __int64 v4; // rdx
  __int64 result; // rax
  ...
  if ( *(_QWORD *)(v4 + 40) )
  {
    ...
    return NSInstrumentation::CTypeIsolation<81920,160>::Allocate();
  }
  return result;
}
