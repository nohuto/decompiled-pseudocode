/*
 * XREFs of ?SetWakeableInputTypesToRegistry@CInputGlobals@@QEAA_NKK@Z @ 0x1401B77D8
 * Callers:
...
bool __fastcall CInputGlobals::SetWakeableInputTypesToRegistry(CInputGlobals *this, int a2, int a3)
{
  ...
  v6 = 0;
  PointerDeviceConfigurationKey = (void *)ApiSetEditionGetPointerDeviceConfigurationKey(8LL, 0x20006u);
  if ( PointerDeviceConfigurationKey )
  {
    v8 = 0;
    v9 = (char *)&unk_140264730;
    do
    {
      if ( (*(_DWORD *)v9 & a2) != 0 )
      {
