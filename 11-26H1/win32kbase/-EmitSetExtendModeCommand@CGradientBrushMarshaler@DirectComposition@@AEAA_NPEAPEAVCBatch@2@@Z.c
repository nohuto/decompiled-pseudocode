/*
 * XREFs of ?EmitSetExtendModeCommand@CGradientBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14019FCA0
 * Callers:
...
char __fastcall DirectComposition::CGradientBrushMarshaler::EmitSetExtendModeCommand(
