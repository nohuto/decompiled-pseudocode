/*
 * XREFs of ?Create@?$CTypeIsolation@$0FAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1401EBC20
 * Callers:
...
void *NSInstrumentation::CTypeIsolation<20480,160>::Create()
{
  __int64 Pool2; // rax
  void *v1; // rbx
  ...
  *(_QWORD *)Pool2 = Pool2;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<20480,160>::Initialize(Pool2) )
  {
