/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0FAAA@$0KA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1401DD328
 * Callers:
...
__int64 __fastcall NSInstrumentation::CTypeIsolation<20480,160>::Allocate(__int64 *a1)
{
  __int64 v2; // rbp
  __int64 *i; // rsi
  __int64 v4; // r14
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v10 = NSInstrumentation::CSectionEntry<20480,160>::Create();
      v11 = (_QWORD *)v10;
      if ( v10 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<20480,160>::Allocate(*(_QWORD *)(v10 + 32));
        if ( v2 )
        {
    ...
    v4 = NSInstrumentation::CSectionBitmapAllocator<20480,160>::Allocate(i[4]);
    if ( v4 )
      break;
  }
  if ( i == (__int64 *)*a1 )
