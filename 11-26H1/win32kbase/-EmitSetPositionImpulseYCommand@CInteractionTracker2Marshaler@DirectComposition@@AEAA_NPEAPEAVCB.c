/*
 * XREFs of ?EmitSetPositionImpulseYCommand@CInteractionTracker2Marshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E660
 * Callers:
...
char __fastcall DirectComposition::CInteractionTracker2Marshaler::EmitSetPositionImpulseYCommand(
