/*
 * XREFs of ?Serialize@?$CSectionEntry@$0JAAA@$0JA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401EFD68
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<36864,144>::Serialize(__int64 a1, NSInstrumentation::Serializer *a2)
{
  unsigned int v4; // ebp
  bool v5; // bl
  __int64 v6; // rsi
  ...
  if ( !NSInstrumentation::Serializer::SerializeBytes(a2, *(void **)(a1 + 24), v4)
    || !NSInstrumentation::Serializer::AdvanceBytes(a2, 36864 - v4) )
  {
    return 0;
  }
  v6 = *(_QWORD *)(a1 + 32);
