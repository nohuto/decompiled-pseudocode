/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$01@@U2@U1@U1@U1@U1@U1@U1@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$01@@4333333AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x1400063C4
 * Callers:
        ...
        __int64 a16)
{
  ...
  v21 = 4LL;
  v19 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_1402A9F58, a2, 0LL, 0LL, 14, v17);
}
