/*
 * XREFs of ??$Serialize@_N@Serializer@NSInstrumentation@@QEAA_NAEA_N@Z @ 0x1401EE314
 * Callers:
...
bool __fastcall NSInstrumentation::Serializer::Serialize<bool>(__int64 a1, _BYTE *a2)
{
