/*
 * XREFs of ?ReleaseResource@CApplicationChannel@DirectComposition@@QEAAJI@Z @ 0x1400AC248
 * Callers:
...
__int64 __fastcall DirectComposition::CApplicationChannel::ReleaseResource(size_t *this, int a2)
{
  unsigned int v4; // ebx
  ...
  if ( v5 )
  {
    v7 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)v5 + 184LL))(v5);
    if ( v7 )
    {
      v11 = *(struct DirectComposition::CResourceMarshaler **)(v7 + 192);
      if ( v11 )
      {
        if ( (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)v11 + 120LL))(*(_QWORD *)(v7 + 192)) )
