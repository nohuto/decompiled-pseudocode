/*
 * XREFs of ?Create@?$CSectionEntry@$0BAAA@$0EA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1401DD894
 * Callers:
...
void *NSInstrumentation::CSectionEntry<4096,64>::Create()
{
  _QWORD *Pool2; // rax
  void *v1; // rbx
  ...
  Pool2[3] = 0LL;
  Pool2[4] = 0LL;
  if ( !(unsigned __int8)NSInstrumentation::CSectionEntry<4096,64>::Initialize(Pool2) )
  {
