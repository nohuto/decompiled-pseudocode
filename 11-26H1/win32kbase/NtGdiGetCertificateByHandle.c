/*
 * XREFs of NtGdiGetCertificateByHandle @ 0x140008EE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCertificateByHandle(void *a1, enum _DXGKMDT_CERTIFICATE_TYPE a2, void *a3, unsigned int a4)
{
  ...
  CertificateSize = COPM::GetCertificateSize(*(COPM **)(v14 + 3728), a1, a2, (unsigned int *)&Length);
  if ( CertificateSize >= 0 )
  {
    ...
    else
    {
      ...
      if ( Pool2 )
      {
        CertificateSize = COPM::GetCertificate(*(COPM **)(v14 + 3728), a1, a2, Pool2, Length);
        if ( CertificateSize >= 0 )
        {
