/*
 * XREFs of ?EmitOptions@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1401007FC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v5) )
  {
    ...
    *((_BYTE *)v4 + 12) = (*((_BYTE *)this + 324) & 0x10) != 0;
    *((_BYTE *)v4 + 13) = (*((_BYTE *)this + 324) & 8) != 0;
    *((_BYTE *)v4 + 14) = *((_BYTE *)this + 325) & 1;
    *((_BYTE *)v4 + 15) = (*((_BYTE *)this + 325) & 2) != 0;
