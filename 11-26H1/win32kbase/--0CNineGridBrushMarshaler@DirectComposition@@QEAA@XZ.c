/*
 * XREFs of ??0CNineGridBrushMarshaler@DirectComposition@@QEAA@XZ @ 0x1400560FC
 * Callers:
...
_QWORD *__fastcall DirectComposition::CNineGridBrushMarshaler::CNineGridBrushMarshaler(
        DirectComposition::CNineGridBrushMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CSceneObjectMarshaler::CSceneObjectMarshaler((__int64)this, 88LL);
  result = v1;
  *v1 = &DirectComposition::CNineGridBrushMarshaler::`vftable';
  return result;
}
