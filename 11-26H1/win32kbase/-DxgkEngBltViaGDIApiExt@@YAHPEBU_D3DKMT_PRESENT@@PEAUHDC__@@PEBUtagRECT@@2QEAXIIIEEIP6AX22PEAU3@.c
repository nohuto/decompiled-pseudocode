/*
 * XREFs of ?DxgkEngBltViaGDIApiExt@@YAHPEBU_D3DKMT_PRESENT@@PEAUHDC__@@PEBUtagRECT@@2QEAXIIIEEIP6AX22PEAU3@2II@ZP6AH4422@Z@Z @ 0x14015C410
 * Callers:
 *     <none>
 * Callees:
        ...
        int (*a13)(struct tagRECT *, struct tagRECT *, const struct tagRECT *, const struct tagRECT *))
{
  ...
  v16 = (int)a1;
  v17 = 0;
  v18 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 240LL);
  if ( v18 && v18() >= 0 )
