/*
 * XREFs of rimObsCheckForObservationPermissions @ 0x14020EE9C
 * Callers:
      ...
      && v30 )
    {
        ...
        && v30 )
      {
        ...
        if ( !v8 && WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          return 1LL;
        v12 = *(_QWORD *)(W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, v6, v7) + 69136);
        v26 = 78;
        goto LABEL_51;
      }
      ...
      if ( !v19 && WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        return 0LL;
      v28 = v24;
      v23 = *(_QWORD *)(W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, v6, v7) + 69136);
      v27 = 77;
    }
    else
    {
