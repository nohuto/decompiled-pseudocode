/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0FBAAA@$0FBA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1401DCD88
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<331776,1296>::Allocate(__int64 a1)
{
  ...
  v4 = 0LL;
  ClearBits = RtlFindClearBits(v3, 1u, *(_DWORD *)(a1 + 32) < 0xF3u ? *(_DWORD *)(a1 + 32) : 0);
  if ( ClearBits != -1 )
  {
    v6 = *(_DWORD *)(a1 + 36);
    v7 = ClearBits / 3;
    ...
    if ( ++*(_DWORD *)(a1 + 32) >= 0xF3u )
      *(_DWORD *)(a1 + 32) = 0;
    v4 = (unsigned int)v8 + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8)) + 1296 * (ClearBits % 3);
  }
LABEL_10:
