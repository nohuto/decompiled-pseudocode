/*
 * XREFs of ??$GreReleaseSemaphoreShared@$01$$V@@YAXAEAUSESSION_GLOBALS@Base@Gre@@@Z @ 0x14001D12C
 * Callers:
...
void __fastcall GreReleaseSemaphoreShared<2,>(struct _ERESOURCE **a1, __int64 a2, int a3)
{
  ...
  if ( HIDWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) && (Microsoft_Windows_Win32kEnableBits & 0x10) != 0 )
    McTemplateK0pz_EtwWriteTransfer((_DWORD)a1, (unsigned int)&LockRelease, a3, (_DWORD)v3 + 1144, (__int64)L"GreLock");
  ...
  GreReleaseSemaphoreSharedInternal(v3 + 11);
}
