/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0DAAA@$0DA@@NSInstrumentation@@IEAA_NXZ @ 0x1401EBF88
 * Callers:
...
char __fastcall NSInstrumentation::CTypeIsolation<12288,48>::Initialize(__int64 a1)
{
  _QWORD *Pool2; // rax
  ...
  *(_QWORD *)(a1 + 16) = Pool2;
  if ( Pool2 )
  {
    *Pool2 = 0LL;
    ...
    {
      v4 = NSInstrumentation::CSectionEntry<12288,48>::Create();
      if ( v4 )
      {
        v5 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 255;
