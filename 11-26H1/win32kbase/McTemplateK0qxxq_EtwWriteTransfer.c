/*
 * XREFs of McTemplateK0qxxq_EtwWriteTransfer @ 0x1401DC520
 * Callers:
 *     EtwTraceFlipManagerWaitForFrameFlipAway @ 0x1401DB280 (EtwTraceFlipManagerWaitForFrameFlipAway.c)
 *     EtwTraceFlipManagerWaitForFrameRenderingComplete @ 0x1401DB2C0 (EtwTraceFlipManagerWaitForFrameRenderingComplete.c)
 * Callees:
