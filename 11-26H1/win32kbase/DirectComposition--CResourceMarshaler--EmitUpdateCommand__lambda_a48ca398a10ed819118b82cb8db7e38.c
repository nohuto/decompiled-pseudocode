/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_a48ca398a10ed819118b82cb8db7e38e___ @ 0x140137D10
 * Callers:
        ...
        __int64 a3)
{
  ...
  *((_BYTE *)v5 + 12) = *(_DWORD *)(*(_QWORD *)a3 + 132LL) != 0;
  return 1;
}
