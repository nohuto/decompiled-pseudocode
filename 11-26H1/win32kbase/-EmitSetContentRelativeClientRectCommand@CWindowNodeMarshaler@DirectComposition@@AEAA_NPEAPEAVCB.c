/*
 * XREFs of ?EmitSetContentRelativeClientRectCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400FFC28
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v3 + 12) = *(_OWORD *)((char *)this + 356);
    *((_DWORD *)this + 84) &= ~2u;
    return 1;
  }
  return 0;
