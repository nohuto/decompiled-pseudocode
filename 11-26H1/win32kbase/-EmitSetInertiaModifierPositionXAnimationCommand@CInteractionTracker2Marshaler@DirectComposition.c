/*
 * XREFs of ?EmitSetInertiaModifierPositionXAnimationCommand@CInteractionTracker2Marshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022C9EC
 * Callers:
...
char __fastcall DirectComposition::CInteractionTracker2Marshaler::EmitSetInertiaModifierPositionXAnimationCommand(
