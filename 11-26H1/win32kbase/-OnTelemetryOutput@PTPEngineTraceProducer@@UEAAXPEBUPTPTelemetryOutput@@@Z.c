/*
 * XREFs of ?OnTelemetryOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x14013C680
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_1402A9E78 > 5 && (qword_1402A9E88 & 9) != 0 && (qword_1402A9E90 & 9) == qword_1402A9E90 )
  {
    v6 = a2;
    v7 = 32;
    v9 = *((_QWORD *)this + 23);
