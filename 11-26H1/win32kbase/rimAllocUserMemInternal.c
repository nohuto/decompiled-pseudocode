/*
 * XREFs of rimAllocUserMemInternal @ 0x140203CE4
 * Callers:
 *     rimProcessInput @ 0x1400A09DC (rimProcessInput.c)
 *     RIMAllocUserMem @ 0x140203C10 (RIMAllocUserMem.c)
 * Callees:
    ...
    if ( v7 )
    {
      ...
      if ( inserted )
      {
        if ( NewElement )
          return v6;
        v13 = 0x20000;
        MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 101);
        if ( NewElement )
          return v6;
      }
