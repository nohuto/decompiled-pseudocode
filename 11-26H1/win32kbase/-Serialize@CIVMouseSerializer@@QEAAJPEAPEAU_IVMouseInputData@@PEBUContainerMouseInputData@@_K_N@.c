/*
 * XREFs of ?Serialize@CIVMouseSerializer@@QEAAJPEAPEAU_IVMouseInputData@@PEBUContainerMouseInputData@@_K_N@Z @ 0x140225AD4
 * Callers:
        ...
        bool a5)
{
  ...
  else
  {
    ...
    if ( !CIVSerializer::Ensure(this, v7) )
      MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 255);
