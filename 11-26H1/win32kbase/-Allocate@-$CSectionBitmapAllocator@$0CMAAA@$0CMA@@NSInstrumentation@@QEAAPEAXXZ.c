/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1400B7D0C
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<180224,704>::Allocate(__int64 a1)
{
  ...
  ClearBits = RtlFindClearBits(v3, 1u, *(_DWORD *)(a1 + 32) < 0xDCu ? *(_DWORD *)(a1 + 32) : 0);
  v5 = 0LL;
  v6 = ClearBits;
  if ( ClearBits != -1
    && (unsigned __int8)NSInstrumentation::CSectionBitmapAllocator<180224,704>::CommitSlot(a1, ClearBits) )
  {
    RtlTestBit(v3, v6);
    RtlSetBit(v3, v6);
    if ( ++*(_DWORD *)(a1 + 32) >= 0xDCu )
      *(_DWORD *)(a1 + 32) = 0;
    v5 = ((v6 / 5) << 12) + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8)) + 704 * (v6 % 5);
  }
