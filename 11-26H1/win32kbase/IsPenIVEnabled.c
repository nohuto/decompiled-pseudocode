/*
 * XREFs of IsPenIVEnabled @ 0x1401C3EA8
 * Callers:
...
char __fastcall IsPenIVEnabled(int a1, int a2, int a3)
{
  int v3; // edx
  int v4; // ecx
  int v5; // r8d
  ...
  if ( UseVelocityToEnableIV(a1, a2, a3)
    || isChildPartition(v4, v3, v5) && *(_BYTE *)(W32GetUserSessionState(v8, v7, v9) + 19395) )
  {
    return 1;
  }
  return v6;
