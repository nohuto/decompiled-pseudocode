/*
 * XREFs of ?EmitSetMatrix21Command@CColorMatrixEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D3E0
 * Callers:
...
char __fastcall DirectComposition::CColorMatrixEffectMarshaler::EmitSetMatrix21Command(
