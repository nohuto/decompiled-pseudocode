/*
 * XREFs of ??$AllocateAllocator@UtagSMWP@@@UserTypeIsolationAllocators@@QEAA_NXZ @ 0x1401EB988
 * Callers:
...
bool __fastcall UserTypeIsolationAllocators::AllocateAllocator<tagSMWP>(__int64 a1)
{
  __int64 Pool2; // rax
  void *v3; // rbx
  ...
  *(_QWORD *)Pool2 = Pool2;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<12288,48>::Initialize(Pool2) )
  {
