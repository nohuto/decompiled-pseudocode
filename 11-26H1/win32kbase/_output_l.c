/*
 * XREFs of _output_l @ 0x1401C8708
 * Callers:
 ...
 *     _get_printf_count_output @ 0x1401C9064 (_get_printf_count_output.c)
 *     wctomb_s @ 0x1401C91E4 (wctomb_s.c)
...
LABEL_114:
                        ...
                        if ( v54 && SizeConverted > 0 )
                        {
                          ...
                          while ( 1 )
                          {
                            v39 = *v38++;
                            --v37;
                            if ( wctomb_s(v60, v62, 6uLL, v39) || !v60[0] )
                              break;
                            write_string_0(v62, (unsigned int)v60[0], v59, &v50);
                            if ( !v37 )
                              goto LABEL_128;
                          }
                          v12 = -1;
...
LABEL_89:
                ...
                v52 = v7;
                v32 = (unsigned int)&MbCh[144] + 367 - i;
                v9 = (char *)(i + 1);
                SizeConverted = v32;
                a4 += 4;
                v8 = v28;
