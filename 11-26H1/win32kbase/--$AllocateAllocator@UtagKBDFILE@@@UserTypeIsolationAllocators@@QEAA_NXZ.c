/*
 * XREFs of ??$AllocateAllocator@UtagKBDFILE@@@UserTypeIsolationAllocators@@QEAA_NXZ @ 0x1401EB900
 * Callers:
...
bool __fastcall UserTypeIsolationAllocators::AllocateAllocator<tagKBDFILE>(__int64 a1)
{
  __int64 Pool2; // rax
  void *v3; // rbx
  ...
  *(_QWORD *)Pool2 = Pool2;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<4096,128>::Initialize(Pool2) )
  {
