/*
 * XREFs of ?IsPropertyAnimatable@CKeyframeAnimationMarshaler@DirectComposition@@UEAA_NUDCOMPOSITION_PROPERTY_ID@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x140240790
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall DirectComposition::CKeyframeAnimationMarshaler::IsPropertyAnimatable(
        __int64 a1,
        unsigned int a2,
        int a3)
{
