/*
 * XREFs of ?EmitSetIntensityCommand@CPointLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022CF3C
 * Callers:
...
char __fastcall DirectComposition::CPointLightMarshaler::EmitSetIntensityCommand(
