/*
 * XREFs of ??$AllocateAllocator@UtagSVR_INSTANCE_INFO@@@UserTypeIsolationAllocators@@QEAA_NXZ @ 0x1401EBA10
 * Callers:
...
bool __fastcall UserTypeIsolationAllocators::AllocateAllocator<tagSVR_INSTANCE_INFO>(__int64 a1)
{
  __int64 Pool2; // rax
  void *v3; // rbx
  ...
  *(_QWORD *)Pool2 = Pool2;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<4096,64>::Initialize(Pool2) )
  {
