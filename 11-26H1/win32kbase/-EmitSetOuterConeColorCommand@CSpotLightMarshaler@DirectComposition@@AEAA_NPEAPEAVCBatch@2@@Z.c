/*
 * XREFs of ?EmitSetOuterConeColorCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E470
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetOuterConeColorCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v3 + 12) = *(_OWORD *)((char *)this + 188);
