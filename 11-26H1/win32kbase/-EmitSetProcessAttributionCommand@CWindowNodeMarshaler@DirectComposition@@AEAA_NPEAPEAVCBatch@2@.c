/*
 * XREFs of ?EmitSetProcessAttributionCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1401001EC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v4 + 12) = *(_OWORD *)((char *)this + 456);
    *((_DWORD *)this + 84) &= ~0x1000u;
    return 1;
  }
  return 0;
}
