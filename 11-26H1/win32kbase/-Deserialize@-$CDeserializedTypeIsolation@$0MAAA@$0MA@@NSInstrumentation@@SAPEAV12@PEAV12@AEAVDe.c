/*
 * XREFs of ?Deserialize@?$CDeserializedTypeIsolation@$0MAAA@$0MA@@NSInstrumentation@@SAPEAV12@PEAV12@AEAVDeserializer@2@@Z @ 0x1401EF28C
 * Callers:
...
__int64 __fastcall NSInstrumentation::CDeserializedTypeIsolation<49152,192>::Deserialize(
        __int64 a1,
...
LABEL_13:
  ...
  while ( v7 < v11 )
  {
    v8 = NSInstrumentation::CDeserializedSectionEntry<49152,192>::Deserialize(a2);
    if ( !v8 )
      return 0LL;
    v9 = *(_QWORD **)(a1 + 8);
    if ( *v9 != a1 )
