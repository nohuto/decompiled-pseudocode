/*
 * XREFs of rimSetContactKeepAliveState @ 0x1400FA6D4
 * Callers:
...
__int64 __fastcall rimSetContactKeepAliveState(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v4 = a2 + 2368;
  if ( !*(_QWORD *)(a1 + 792) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 1865LL);
  if ( (*(_DWORD *)(a2 + 32) & 2) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 1866LL);
  if ( (*(_DWORD *)(a2 + 32) & 4) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 1867LL);
  ...
  *(_DWORD *)(v4 + 76) = *(_DWORD *)(a2 + 2352);
  ...
  {
    result = RIMIsTouchPointerDevice(v9);
    if ( !(_DWORD)result )
      return result;
