/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0FAAA@$0KA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1401DCC4C
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<20480,160>::Allocate(__int64 a1)
{
  ...
  v4 = 0LL;
  ClearBits = RtlFindClearBits(v3, 1u, *(_DWORD *)(a1 + 32) < 0x7Du ? *(_DWORD *)(a1 + 32) : 0);
  if ( ClearBits != -1 )
  {
    v6 = *(_DWORD *)(a1 + 36);
    v7 = ClearBits / 0x19;
    ...
    if ( ++*(_DWORD *)(a1 + 32) >= 0x7Du )
      *(_DWORD *)(a1 + 32) = 0;
    v4 = (unsigned int)v8 + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8)) + 160 * (ClearBits % 0x19);
  }
LABEL_10:
