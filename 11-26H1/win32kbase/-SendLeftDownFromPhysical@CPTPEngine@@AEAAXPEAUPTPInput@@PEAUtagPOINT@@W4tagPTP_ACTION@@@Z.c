/*
 * XREFs of ?SendLeftDownFromPhysical@CPTPEngine@@AEAAXPEAUPTPInput@@PEAUtagPOINT@@W4tagPTP_ACTION@@@Z @ 0x14010637C
 * Callers:
...
__int64 __fastcall CPTPEngine::SendLeftDownFromPhysical(CPTPEngine *a1, __int64 a2, _QWORD *a3, int a4)
{
  ...
  *((_DWORD *)a1 + 768) |= 0x80u;
  ...
  if ( (result & 8) == 0 )
  {
    ...
    {
      *((_DWORD *)a1 + 768) = v9 | 8;
      return (__int64)CBasePTPEngine::SendMouseOutput((__int64)a1, 1, v8);
    }
  }
  return result;
}
