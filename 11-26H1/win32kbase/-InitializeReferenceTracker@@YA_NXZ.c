/*
 * XREFs of ?InitializeReferenceTracker@@YA_NXZ @ 0x140185BD4
 * Callers:
  ...
  *(_QWORD *)(v1 + 24) = Pool2;
  if ( Pool2 )
  {
    for ( i = 0LL; (unsigned int)i < 4; i = (unsigned int)(i + 1) )
    {
      ...
      if ( _bittest(&v4, i) )
      {
        v6 = NSInstrumentation::CReferenceTracker::CReferenceCountedType::Create(
               *(struct _LIST_ENTRY **)(v1 + 24),
               *(_DWORD *)(v1 + 16 * (i + 2)));
        if ( !v6 )
          return 0;
        *(_QWORD *)(v1 + 16LL * (unsigned int)i + 40) = v6;
      }
    }
    return 1;
  }
