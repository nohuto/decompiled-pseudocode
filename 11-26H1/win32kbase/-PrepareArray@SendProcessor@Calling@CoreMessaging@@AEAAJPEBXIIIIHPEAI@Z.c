/*
 * XREFs of ?PrepareArray@SendProcessor@Calling@CoreMessaging@@AEAAJPEBXIIIIHPEAI@Z @ 0x1400D9E28
 * Callers:
...
LABEL_25:
    ...
    if ( (int)result < 0 )
      return result;
    v15 = (unsigned int)a8 * (unsigned __int64)v13;
    if ( is_mul_ok((unsigned int)a8, v13) && v15 <= 0xFFFFFFFF )
      goto LABEL_25;
  }
LABEL_26:
  result = 2147942487LL;
