/*
 * XREFs of ?EmitHeatMapMode@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140100EC4
 * Callers:
...
char __fastcall DirectComposition::CVisualMarshaler::EmitHeatMapMode(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x24uLL, &v5) )
  {
    ...
    *((_DWORD *)v4 + 7) = *((_DWORD *)this + 79);
    *(_OWORD *)(v4 + 12) = *(_OWORD *)((char *)this + 300);
    *((_DWORD *)v4 + 8) = *((_DWORD *)this + 80);
