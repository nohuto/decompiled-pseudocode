/*
 * XREFs of ?GetTimerId@CAccessibilityTimer@@CA?AW4_ACCESSIBILITY_TIMERS@@P6AXPEAUtagWND@@I_K_J@Z@Z @ 0x1402190D0
 * Callers:
...
__int64 __fastcall CAccessibilityTimer::GetTimerId(void (__fastcall *a1)(struct tagWND *a1, int a2, int a3))
{
  unsigned int v1; // ebx
  ...
  if ( (char *)a1 != (char *)FKActivationTimer )
  {
    ...
    {
      MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 97);
    }
  }
  return v1;
}
