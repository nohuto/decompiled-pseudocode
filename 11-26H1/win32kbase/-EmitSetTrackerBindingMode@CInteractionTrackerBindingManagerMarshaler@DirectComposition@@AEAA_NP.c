/*
 * XREFs of ?EmitSetTrackerBindingMode@CInteractionTrackerBindingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14017DA88
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x80u) != 0 )
  {
    ...
    DirectComposition::CInteractionTrackerBindingManagerMarshaler::CleanUpListItemsPendingDeletion(
      this,
      (struct _RTL_GENERIC_TABLE *)(*a2)[1]);
    *((_DWORD *)this + 4) &= ~0x80u;
  }
  return 1;
}
