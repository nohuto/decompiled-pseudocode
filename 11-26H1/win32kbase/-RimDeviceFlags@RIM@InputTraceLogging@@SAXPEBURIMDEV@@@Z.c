/*
 * XREFs of ?RimDeviceFlags@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1400F1F18
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDeviceFlags(const struct RIMDEV *a1, __int64 a2, __int64 a3, int a4)
{
  int v5; // ecx
  int v6; // ecx
  int v7; // ecx
