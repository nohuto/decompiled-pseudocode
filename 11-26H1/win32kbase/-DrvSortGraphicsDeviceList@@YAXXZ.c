/*
 * XREFs of ?DrvSortGraphicsDeviceList@@YAXXZ @ 0x14017C770
 * Callers:
 *     DrvUpdateGraphicsDeviceList @ 0x140029C20 (DrvUpdateGraphicsDeviceList.c)
 * Callees:
 *     ?DrvMoveGraphicsDevice@@YAXPEAUtagGRAPHICS_DEVICE@@00@Z @ 0x14017C868 (-DrvMoveGraphicsDevice@@YAXPEAUtagGRAPHICS_DEVICE@@00@Z.c)
 */
...
void __fastcall DrvSortGraphicsDeviceList(__int64 a1)
{
  ...
  v2 = 0LL;
  v3 = 0LL;
  v4 = *(struct tagGRAPHICS_DEVICE **)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 1184LL);
  if ( v4 )
  {
    do
    {
