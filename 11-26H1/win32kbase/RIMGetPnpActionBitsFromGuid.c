/*
 * XREFs of RIMGetPnpActionBitsFromGuid @ 0x140090160
 * Callers:
...
LABEL_14:
    ...
    if ( !v17 )
    {
      ...
      {
        v20 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, a2, (_DWORD)a3);
        LOBYTE(v21) = v19;
        LOBYTE(v22) = v18;
        WPP_RECORDER_AND_TRACE_SF_qq(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
    ...
    {
      v30 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, a2, (_DWORD)a3);
      LOBYTE(v31) = v29;
      LOBYTE(v32) = v28;
  ...
  else
  {
    ...
    {
      v25 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, a2, (_DWORD)a3);
      LOBYTE(v26) = v24;
      LOBYTE(v27) = v23;
