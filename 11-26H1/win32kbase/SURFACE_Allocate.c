/*
 * XREFs of SURFACE_Allocate @ 0x140113EC0
 * Callers:
...
_QWORD *__fastcall SURFACE_Allocate(__int64 a1)
{
  ...
  v1 = **(_QWORD **)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 4384LL);
  if ( !v1 )
    return 0LL;
  v3 = ExAllocateFromLookasideListEx((PLOOKASIDE_LIST_EX)(v1 + 48));
  if ( !v3 )
    return 0LL;
  v4 = *(NSInstrumentation::CReferenceTracker::CReferenceCountedType **)(*(_QWORD *)(W32GetSessionState(v2) + 88) + 88LL);
  if ( v4 )
  {
