/*
 * XREFs of ?EmitSetPlaybackRate@CKeyframeAnimationMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140136F3C
 * Callers:
...
char __fastcall DirectComposition::CKeyframeAnimationMarshaler::EmitSetPlaybackRate(
