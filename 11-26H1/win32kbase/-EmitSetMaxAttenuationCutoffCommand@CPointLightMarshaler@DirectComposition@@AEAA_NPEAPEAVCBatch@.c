/*
 * XREFs of ?EmitSetMaxAttenuationCutoffCommand@CPointLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022DB60
 * Callers:
...
char __fastcall DirectComposition::CPointLightMarshaler::EmitSetMaxAttenuationCutoffCommand(
