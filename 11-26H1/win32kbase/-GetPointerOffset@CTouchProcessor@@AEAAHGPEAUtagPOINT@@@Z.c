/*
 * XREFs of ?GetPointerOffset@CTouchProcessor@@AEAAHGPEAUtagPOINT@@@Z @ 0x1400CB240
 * Callers:
...
__int64 __fastcall CTouchProcessor::GetPointerOffset(PERESOURCE *this, __int16 a2, struct tagPOINT *a3)
{
  char *v6; // rax
  PERESOURCE i; // rbx
  ...
  if ( !a3 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 11923LL);
  *a3 = (struct tagPOINT)i[1].SpinLock;
  return 1LL;
}
