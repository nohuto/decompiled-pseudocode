/*
 * XREFs of ?Serialize@?$CSectionEntry@$0IAAA@$0IA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401EFC90
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<32768,128>::Serialize(__int64 a1, NSInstrumentation::Serializer *a2)
{
  unsigned int v4; // ebp
  bool v5; // bl
  __int64 v6; // rsi
  ...
  if ( !NSInstrumentation::Serializer::SerializeBytes(a2, *(void **)(a1 + 24), v4)
    || !NSInstrumentation::Serializer::AdvanceBytes(a2, 0x8000 - v4) )
  {
    return 0;
  }
  v6 = *(_QWORD *)(a1 + 32);
