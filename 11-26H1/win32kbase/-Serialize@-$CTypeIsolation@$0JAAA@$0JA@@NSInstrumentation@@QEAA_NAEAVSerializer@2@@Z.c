/*
 * XREFs of ?Serialize@?$CTypeIsolation@$0JAAA@$0JA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401F0320
 * Callers:
...
char __fastcall NSInstrumentation::CTypeIsolation<36864,144>::Serialize(__int64 a1, NSInstrumentation::Serializer *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // rcx
  _QWORD *i; // rdi
    ...
    && NSInstrumentation::Serializer::Serialize<bool>((__int64)a2, (_BYTE *)(a1 + 36)) )
  {
    ...
    {
      if ( !NSInstrumentation::CSectionEntry<36864,144>::Serialize((__int64)i, a2) )
        goto LABEL_13;
    }
