/*
 * XREFs of NtDCompositionGetFrameIdFromBatchId @ 0x1400B3A50
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFrameIdFromBatchId@CApplicationChannel@DirectComposition@@QEBA_KK@Z @ 0x1400B3B04 (-GetFrameIdFromBatchId@CApplicationChannel@DirectComposition@@QEBA_KK@Z.c)
...
__int64 __fastcall NtDCompositionGetFrameIdFromBatchId(unsigned int a1, unsigned int a2, void *a3)
{
