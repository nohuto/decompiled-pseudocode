/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0HAGJEDEE@$0CAK@$0CAL@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x14023445C
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1885946692,522,523,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
