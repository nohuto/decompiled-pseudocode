/*
 * XREFs of ?SetReferenceProperty@CSceneNodeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@UDCOMPOSITION_PROPERTY_ID@@PEAVCResourceMarshaler@2@PEA_N@Z @ 0x140238390
 * Callers:
 *     <none>
 * Callees:
