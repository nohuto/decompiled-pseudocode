/*
 * XREFs of ??1CIVSerializer@@UEAA@XZ @ 0x1401B71EC
 * Callers:
 *     ??_GCIVTouchSerializer@@UEAAPEAXI@Z @ 0x14021C600 (--_GCIVTouchSerializer@@UEAAPEAXI@Z.c)
...
void __fastcall CIVSerializer::~CIVSerializer(CIVSerializer *this, __int64 a2, __int64 a3, __int64 a4)
{
  char *v4; // rcx
