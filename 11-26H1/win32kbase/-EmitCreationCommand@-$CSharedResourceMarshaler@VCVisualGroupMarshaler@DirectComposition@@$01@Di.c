/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCVisualGroupMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x14023BBB0
 * Callers:
 *     <none>
 * Callees:
