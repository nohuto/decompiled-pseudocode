/*
 * XREFs of NtGdiGetCOPPCompatibleOPMInformation @ 0x1401F42F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AcquireBufferSafe@?$COPMSimpleBufferPool@U_DXGKMDT_OPM_REQUESTED_INFORMATION@@@@QEAA?AVCAutoUnlockBuffer@1@XZ @ 0x14017C1FC (-AcquireBufferSafe@-$COPMSimpleBufferPool@U_DXGKMDT_OPM_REQUESTED_INFORMATION@@@@QEAA-AVCAutoUnl.c)
 *     ??1CAutoUnlockBuffer@?$COPMSimpleBufferPool@U_DXGKMDT_OPM_REQUESTED_INFORMATION@@@@QEAA@XZ @ 0x14017DA54 (--1CAutoUnlockBuffer@-$COPMSimpleBufferPool@U_DXGKMDT_OPM_REQUESTED_INFORMATION@@@@QEAA@XZ.c)
...
__int64 __fastcall NtGdiGetCOPPCompatibleOPMInformation(unsigned __int64 a1, void *a2, void *a3)
{
  __int64 v6; // rbp
  ...
  v7 = (PLOOKASIDE_LIST_EX *)(*(_QWORD *)(v6 + 3728) + 16LL);
