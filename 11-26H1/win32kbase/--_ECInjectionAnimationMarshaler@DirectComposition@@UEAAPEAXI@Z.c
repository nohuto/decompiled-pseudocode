/*
 * XREFs of ??_ECInjectionAnimationMarshaler@DirectComposition@@UEAAPEAXI@Z @ 0x14022A960
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)Buffer = &DirectComposition::CInjectionAnimationMarshaler::`vftable';
  DirectComposition::CBaseExpressionMarshaler::~CBaseExpressionMarshaler(Buffer, a2, a3, a4);
  if ( (v4 & 1) != 0 )
