/*
 * XREFs of ?EmitSetInertiaCenterpointXCommand@CInteractionTracker2Marshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022C8F0
 * Callers:
...
char __fastcall DirectComposition::CInteractionTracker2Marshaler::EmitSetInertiaCenterpointXCommand(
