/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x14013FF3C
 * Callers:
 *     EtwDevLockEndTightUpdate @ 0x14013FE80 (EtwDevLockEndTightUpdate.c)
 *     EtwDevLockEndUpdate @ 0x14013FEE0 (EtwDevLockEndUpdate.c)
 * Callees:
