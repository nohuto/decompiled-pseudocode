/*
 * XREFs of ?EmitSetOuterConeAngleCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E3F8
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetOuterConeAngleCommand(
