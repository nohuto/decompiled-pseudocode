/*
 * XREFs of ?bInitGdiInfo@@YAHPEAU_devicemodeW@@PEAU_GDIINFO@@@Z @ 0x1401524EC
 * Callers:
...
__int64 __fastcall bInitGdiInfo(struct _devicemodeW *a1, struct _GDIINFO *a2)
{
  ...
  if ( !IsEnabledDeviceUsageNoInline )
  {
    ...
    {
      v11 = (__int16 *)&unk_14027A242;
      while ( dmPelsWidth != *(v11 - 1)
           || a1->dmPelsHeight != *v11
           || a1->dmBitsPerPel != 32
...
LABEL_7:
  ...
  {
    v5 = *((__int16 *)&unk_14027A240 + 2 * v4);
    dmPelsHeight = *((__int16 *)&unk_14027A240 + 2 * v4 + 1);
