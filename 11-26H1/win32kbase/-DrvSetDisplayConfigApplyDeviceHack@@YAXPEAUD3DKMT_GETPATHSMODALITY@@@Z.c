/*
 * XREFs of ?DrvSetDisplayConfigApplyDeviceHack@@YAXPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x14017CB24
 * Callers:
...
void __fastcall DrvSetDisplayConfigApplyDeviceHack(struct D3DKMT_GETPATHSMODALITY *a1)
{
  ...
  if ( RtlQueryRegistryValues(3u, L"GRE_Initialize\\OverrideScreenLayout", &QueryTable, 0LL, 0LL) >= 0 )
  {
    ...
    {
      WdLogSingleEntry4(2LL, (int)v10, SDWORD1(v10), SDWORD2(v10), SHIDWORD(v10));
      WdLogGlobalForLineNumber = 15256;
    }
    else
    {
      v6 = 0;
