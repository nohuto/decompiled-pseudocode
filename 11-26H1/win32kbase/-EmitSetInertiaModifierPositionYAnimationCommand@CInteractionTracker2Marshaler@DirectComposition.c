/*
 * XREFs of ?EmitSetInertiaModifierPositionYAnimationCommand@CInteractionTracker2Marshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022CBDC
 * Callers:
...
char __fastcall DirectComposition::CInteractionTracker2Marshaler::EmitSetInertiaModifierPositionYAnimationCommand(
