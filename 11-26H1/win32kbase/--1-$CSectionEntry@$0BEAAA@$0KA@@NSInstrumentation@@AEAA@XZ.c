/*
 * XREFs of ??1?$CSectionEntry@$0BEAAA@$0KA@@NSInstrumentation@@AEAA@XZ @ 0x14015A314
 * Callers:
...
int __fastcall NSInstrumentation::CSectionEntry<81920,160>::~CSectionEntry<81920,160>(_QWORD *a1)
{
  void *v2; // rcx
  int result; // eax
  void *v4; // rcx
