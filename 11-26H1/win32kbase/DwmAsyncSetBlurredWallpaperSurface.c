/*
 * XREFs of DwmAsyncSetBlurredWallpaperSurface @ 0x14017C710
 * Callers:
...
__int64 __fastcall DwmAsyncSetBlurredWallpaperSurface(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 (__fastcall *v6)(__int64, __int64, __int64); // rax

  v6 = *(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 2760LL);
  if ( v6 )
    return v6(a1, a2, a3);
  else
    return 3221225659LL;
