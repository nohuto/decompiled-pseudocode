/*
 * XREFs of ?EmitSetBindingBroken@CBaseExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1401340F0
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  v3 = 1;
  if ( (*((_DWORD *)this + 4) & 0x200) == 0 && (*((_BYTE *)this + 128) & 4) != 0 )
  {
    v6 = 0LL;
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v6) )
    {
      ...
      *((_BYTE *)v5 + 12) = (*((_BYTE *)this + 128) & 8) != 0;
