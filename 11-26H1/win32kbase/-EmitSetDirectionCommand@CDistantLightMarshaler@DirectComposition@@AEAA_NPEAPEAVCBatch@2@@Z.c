/*
 * XREFs of ?EmitSetDirectionCommand@CDistantLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022C4FC
 * Callers:
...
char __fastcall DirectComposition::CDistantLightMarshaler::EmitSetDirectionCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v5) )
  {
    ...
    *(_QWORD *)((char *)v3 + 12) = *((_QWORD *)this + 17);
    *((_DWORD *)v3 + 5) = *((_DWORD *)this + 36);
