/*
 * XREFs of IsxxxSendMessageBSMSupported @ 0x14017EBA8
 * Callers:
...
__int64 __fastcall IsxxxSendMessageBSMSupported(__int64 a1)
{
  __int64 (*v1)(void); // rax

  v1 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 1912LL);
  if ( v1 )
    return v1();
  else
    return 3221225659LL;
