        ...
        __int64 *a11)
{
  __int64 v11; // rcx
  __int64 v12; // rcx
  _BYTE v14[32]; // [rsp+30h] [rbp-81h] BYREF
  ...
  v18 = 4LL;
  v16 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_1402AA150, a2, 0LL, 0LL, 9, v14);
}
