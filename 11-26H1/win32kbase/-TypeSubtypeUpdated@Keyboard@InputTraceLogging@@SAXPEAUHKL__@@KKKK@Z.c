/*
 * XREFs of ?TypeSubtypeUpdated@Keyboard@InputTraceLogging@@SAXPEAUHKL__@@KKKK@Z @ 0x1402177A4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( (unsigned int)dword_1402A9E40 > 4 && tlgKeywordOn((__int64)&dword_1402A9E40, 0x4000LL) )
  {
    v9 = a5;
    v10 = v6;
    v11 = v5;
