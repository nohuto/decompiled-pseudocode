/*
 * XREFs of ?Allocate@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_K0I@Z @ 0x14010EC3C
 * Callers:
...
LABEL_2:
  ...
  if ( v4 != 1 )
  {
    if ( v4 == 2 )
    {
      ...
      Pool2 = ExAllocatePool2(a2 | 2, v5, a4);
      if ( Pool2 )
      {
  ...
  if ( !NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(this, a4) || v5 + 16 < v5 )
    return 0LL;
  v11 = (unsigned __int64 *)ExAllocatePool2(a2 | 2, v5 + 16, (unsigned int)v6);
  Pool2 = (__int64)v11;
  if ( !v11
    || (_InterlockedIncrement64((volatile signed __int64 *)this + 14),
        *v11 = v6,
