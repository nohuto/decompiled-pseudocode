/*
 * XREFs of LookUpTableFlushComplete @ 0x1402D2DB0
 * Callers:
 *     TlgAggregateFlush @ 0x140196790 (TlgAggregateFlush.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1402D2A90 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1402D3970 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
 ...
 *     UpdateInternalStatsOnFlush @ 0x1402D315C (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( (_DWORD)v2 )
  {
    ...
    if ( v7 )
    {
      if ( (unsigned int)dword_1402AA188 > 5
        && (qword_1402AA198 & 0x200000000000LL) != 0
        && (qword_1402AA1A0 & 0x200000000000LL) == qword_1402AA1A0 )
      {
        v11 = 4;
        v34 = L"SummaryCount";
        v35 = 24;
