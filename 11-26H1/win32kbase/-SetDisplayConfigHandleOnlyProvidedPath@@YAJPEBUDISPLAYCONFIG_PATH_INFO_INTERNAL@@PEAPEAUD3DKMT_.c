/*
 * XREFs of ?SetDisplayConfigHandleOnlyProvidedPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@PEA_NPEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x14002CEA8
 * Callers:
    ...
    while ( 1 )
    {
        ...
        && *((_DWORD *)v14 + 21) == *((_DWORD *)a1 + 7) )
      {
        if ( (*((_DWORD *)v14 + 14) & 0x800LL) == 0 )
        {
          ...
          WdLogGlobalForLineNumber = 14242;
        }
        v9 = *((_QWORD *)v14 + 25);
        v17 = HIDWORD(v9);
        ...
        {
          WdLogSingleEntry0(1LL);
          WdLogGlobalForLineNumber = 14244;
        }
        v15 = *((_DWORD *)v14 + 60);
        v11 = v10;
