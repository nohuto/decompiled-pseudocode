/*
 * XREFs of ?Initialize@?$CSectionEntry@$0DAAA@$0DA@@NSInstrumentation@@AEAA_NXZ @ 0x1401DEF90
 * Callers:
 ...
 *     ?Initialize@?$CSectionBitmapAllocator@$0DAAA@$0DA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1401DE9A8 (-Initialize@-$CSectionBitmapAllocator@$0DAAA@$0DA@@NSInstrumentation@@AEAA_NPEAE@Z.c)
 */

bool __fastcall NSInstrumentation::CSectionEntry<12288,48>::Initialize(PVOID *a1)
{
  ...
  Section = (NSInstrumentation *)NSInstrumentation::PlatformCreateSection((NSInstrumentation *)0x3000);
  a1[2] = Section;
  if ( Section && NSInstrumentation::PlatformMapViewInSessionSpace(Section, a1 + 3, (void **)0x3000) >= 0 )
  {
    v3 = (__int64)a1[3];
    ...
    if ( Pool2 )
    {
      *Pool2 = 0LL;
      ...
      Pool2[3] = 0LL;
      Pool2[4] = 0LL;
      if ( NSInstrumentation::CSectionBitmapAllocator<12288,48>::Initialize(Pool2, v3) )
      {
LABEL_7:
        a1[4] = v5;
        return v5 != 0LL;
