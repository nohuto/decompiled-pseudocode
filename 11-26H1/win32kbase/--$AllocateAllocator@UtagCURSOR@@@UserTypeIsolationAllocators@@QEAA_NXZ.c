/*
 * XREFs of ??$AllocateAllocator@UtagCURSOR@@@UserTypeIsolationAllocators@@QEAA_NXZ @ 0x1401EB768
 * Callers:
...
bool __fastcall UserTypeIsolationAllocators::AllocateAllocator<tagCURSOR>(__int64 a1)
{
  __int64 Pool2; // rax
  void *v3; // rbx
  ...
  *(_QWORD *)Pool2 = Pool2;
  if ( !NSInstrumentation::CTypeIsolation<81920,160>::Initialize(Pool2) )
  {
