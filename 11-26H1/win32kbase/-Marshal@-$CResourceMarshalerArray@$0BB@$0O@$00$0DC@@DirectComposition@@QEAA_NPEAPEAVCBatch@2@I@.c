/*
 * XREFs of ?Marshal@?$CResourceMarshalerArray@$0BB@$0O@$00$0DC@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x14024046C
 * Callers:
...
bool __fastcall DirectComposition::CResourceMarshalerArray<17,14,1,50>::Marshal(
        ...
        int a3)
{
  ...
  v5 = DirectComposition::CResourceMarshalerArrayBase::ReferenceTypeMarshal(this, a2, a3, 17, 14);
  if ( v5 && *((_QWORD *)this + 1) )
