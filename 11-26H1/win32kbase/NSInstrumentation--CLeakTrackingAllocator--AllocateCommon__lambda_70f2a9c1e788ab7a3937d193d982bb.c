/*
 * XREFs of NSInstrumentation::CLeakTrackingAllocator::AllocateCommon__lambda_70f2a9c1e788ab7a3937d193d982bb8e___ @ 0x1401FC310
 * Callers:
 *     Win32AllocPoolWithPriorityZInit @ 0x1401EAA10 (Win32AllocPoolWithPriorityZInit.c)
 * Callees:
 ...
 *     NSInstrumentation::CLeakTrackingAllocator::MakeUntrackedAllocation__lambda_70f2a9c1e788ab7a3937d193d982bb8e__unsigned___int64_&_ @ 0x1401FC6B8 (NSInstrumentation--CLeakTrackingAllocator--MakeUntrackedAllocation__lambda_70f2a9c1e788ab7a3937d.c)
...
LABEL_3:
  ...
  if ( v4 == 1 )
  {
    if ( NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(a1, a3) && v7 + 16 >= v7 )
    {
      ...
      v13 = (unsigned __int64 *)ExAllocatePool3(
                                  *(_QWORD *)v12.m128i_i64[0] & 0xFFFFFFFFFFFFFFFDuLL,
                                  v7 + 16,
  ...
  else if ( v4 == 2 )
  {
    ...
    v17.m128i_i32[2] = *v19;
    v14 = ExAllocatePool3(
            *(_QWORD *)v16.m128i_i64[0] & 0xFFFFFFFFFFFFFFFDuLL,
            v7,
