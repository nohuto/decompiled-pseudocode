/*
 * XREFs of ??0CPrimitiveColorMarshaler@DirectComposition@@QEAA@XZ @ 0x140055794
 * Callers:
...
_QWORD *__fastcall DirectComposition::CPrimitiveColorMarshaler::CPrimitiveColorMarshaler(
        DirectComposition::CPrimitiveColorMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CResourceMarshaler::CResourceMarshaler(this, 93LL);
  result = v1;
  *v1 = &DirectComposition::CPrimitiveColorMarshaler::`vftable';
  return result;
}
