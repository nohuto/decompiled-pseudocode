/*
 * XREFs of ?CreateAndBindSharedSection@CApplicationChannel@DirectComposition@@QEAAJI_KPEAPEAX@Z @ 0x1400B44EC
 * Callers:
        ...
        void **a4)
{
  ...
  if ( v7
    && (v8 = (DirectComposition::CDCompMappedSharedSectionMarshaler *)(*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)v7 + 136LL))(v7),
        (v9 = v8) != 0LL) )
  {
