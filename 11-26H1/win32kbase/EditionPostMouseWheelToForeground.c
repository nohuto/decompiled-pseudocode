/*
 * XREFs of EditionPostMouseWheelToForeground @ 0x140178838
 * Callers:
        ...
        __int64 a9))(_QWORD, __int64, __int64, _QWORD, __int64, __int64, int, __int64, __int64)
{
  ...
  v12 = a1;
  result = *(__int64 (__fastcall **)(_QWORD, __int64, __int64, _QWORD, __int64, __int64, int, __int64, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 4440LL);
  if ( result )
