/*
 * XREFs of ??0CBackdropBrushMarshaler@DirectComposition@@QEAA@XZ @ 0x140055CF0
 * Callers:
...
_QWORD *__fastcall DirectComposition::CBackdropBrushMarshaler::CBackdropBrushMarshaler(
        DirectComposition::CBackdropBrushMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CSceneObjectMarshaler::CSceneObjectMarshaler((__int64)this, 8LL);
  result = v1;
