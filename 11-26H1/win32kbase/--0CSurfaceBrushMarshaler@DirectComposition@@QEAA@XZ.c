/*
 * XREFs of ??0CSurfaceBrushMarshaler@DirectComposition@@QEAA@XZ @ 0x140056240
 * Callers:
...
_QWORD *__fastcall DirectComposition::CSurfaceBrushMarshaler::CSurfaceBrushMarshaler(
        DirectComposition::CSurfaceBrushMarshaler *this)
{
  _QWORD *v1; // rcx
  _QWORD *result; // rax

  DirectComposition::CSceneObjectMarshaler::CSceneObjectMarshaler((__int64)this, 142LL);
  result = v1;
  *v1 = &DirectComposition::CSurfaceBrushMarshaler::`vftable';
  return result;
}
