/*
 * XREFs of McTemplateK0qqqqzzzzqx_EtwWriteTransfer @ 0x1400DE5C8
 * Callers:
        ...
        char a13)
{
  ...
  v45 = v24;
  v51 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v24, &ImmersiveMessageCheckDelayEvent, &W32kControlGuid, 0xBu, &v27);
}
