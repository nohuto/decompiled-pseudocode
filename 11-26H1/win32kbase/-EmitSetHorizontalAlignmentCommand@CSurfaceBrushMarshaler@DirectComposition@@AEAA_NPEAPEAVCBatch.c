/*
 * XREFs of ?EmitSetHorizontalAlignmentCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FE04
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetHorizontalAlignmentCommand(
