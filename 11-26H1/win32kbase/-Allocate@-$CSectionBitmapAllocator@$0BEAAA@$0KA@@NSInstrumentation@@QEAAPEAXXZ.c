/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0BEAAA@$0KA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1400B6A64
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<81920,160>::Allocate(__int64 a1, unsigned int a2)
{
  ...
  v5 = 0LL;
  ClearBits = RtlFindClearBits(v4, 1u, *(_DWORD *)(a1 + 32) < 0x1F4u ? *(_DWORD *)(a1 + 32) : 0);
  if ( ClearBits != -1 )
  {
    v8 = *(_DWORD *)(a1 + 36);
    v9 = ClearBits / 0x19;
    ...
    if ( ++*(_DWORD *)(a1 + 32) >= 0x1F4u )
      *(_DWORD *)(a1 + 32) = 0;
    v5 = (unsigned int)v10 + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8)) + 160 * (ClearBits % 0x19);
  }
LABEL_7:
