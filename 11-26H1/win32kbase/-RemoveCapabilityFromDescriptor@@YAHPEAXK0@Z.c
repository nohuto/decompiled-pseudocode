/*
 * XREFs of ?RemoveCapabilityFromDescriptor@@YAHPEAXK0@Z @ 0x1401BC2E4
 * Callers:
 ...
 * Callees:
 *     ?FindAceIndex@@YAHPEAU_ACL@@EEKPEAXPEAK@Z @ 0x1401D4C1C (-FindAceIndex@@YAHPEAU_ACL@@EEKPEAXPEAK@Z.c)
 */
