/*
 * XREFs of ?EmitSetLinearAttenuationCommand@CPointLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D09C
 * Callers:
...
char __fastcall DirectComposition::CPointLightMarshaler::EmitSetLinearAttenuationCommand(
