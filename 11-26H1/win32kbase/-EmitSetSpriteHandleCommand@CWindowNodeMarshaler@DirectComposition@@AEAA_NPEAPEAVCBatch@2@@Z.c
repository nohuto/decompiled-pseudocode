/*
 * XREFs of ?EmitSetSpriteHandleCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14010040C
 * Callers:
...
char __fastcall DirectComposition::CWindowNodeMarshaler::EmitSetSpriteHandleCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v5) )
  {
    ...
    *(_QWORD *)(v4 + 12) = *((_QWORD *)this + 63);
    *((_DWORD *)this + 84) &= ~0x10000u;
    return 1;
  }
  return 0;
}
