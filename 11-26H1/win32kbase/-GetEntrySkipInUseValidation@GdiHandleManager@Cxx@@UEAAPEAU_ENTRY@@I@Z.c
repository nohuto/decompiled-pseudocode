/*
 * XREFs of ?GetEntrySkipInUseValidation@GdiHandleManager@Cxx@@UEAAPEAU_ENTRY@@I@Z @ 0x1400FE590
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
struct _ENTRY *__fastcall Cxx::GdiHandleManager::GetEntrySkipInUseValidation(
