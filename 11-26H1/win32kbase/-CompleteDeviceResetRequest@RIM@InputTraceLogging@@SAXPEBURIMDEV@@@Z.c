/*
 * XREFs of ?CompleteDeviceResetRequest@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x140059B58
 * Callers:
...
void __fastcall InputTraceLogging::RIM::CompleteDeviceResetRequest(
