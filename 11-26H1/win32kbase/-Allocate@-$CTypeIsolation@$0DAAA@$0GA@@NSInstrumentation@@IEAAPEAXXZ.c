/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0DAAA@$0GA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1401DD1B4
 * Callers:
 ...
 *     ?Create@?$CSectionEntry@$0DAAA@$0GA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1401DD9D8 (-Create@-$CSectionEntry@$0DAAA@$0GA@@NSInstrumentation@@SAPEAV12@XZ.c)
 *     memset @ 0x14024BD80 (memset.c)
 */

__int64 __fastcall NSInstrumentation::CTypeIsolation<12288,96>::Allocate(__int64 *a1)
{
  __int64 v2; // rbp
  __int64 *i; // rsi
  __int64 v4; // r14
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v10 = NSInstrumentation::CSectionEntry<12288,96>::Create();
      v11 = (_QWORD *)v10;
      if ( v10 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<12288,96>::Allocate(*(_QWORD *)(v10 + 32));
        if ( v2 )
        {
    ...
    v4 = NSInstrumentation::CSectionBitmapAllocator<12288,96>::Allocate(i[4]);
    if ( v4 )
      break;
  }
  if ( i == (__int64 *)*a1 )
