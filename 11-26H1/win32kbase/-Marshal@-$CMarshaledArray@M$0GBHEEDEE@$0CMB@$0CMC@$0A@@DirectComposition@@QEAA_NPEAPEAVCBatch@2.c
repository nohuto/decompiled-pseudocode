/*
 * XREFs of ?Marshal@?$CMarshaledArray@M$0GBHEEDEE@$0CMB@$0CMC@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x140234538
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<float,1635009348,705,706,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
