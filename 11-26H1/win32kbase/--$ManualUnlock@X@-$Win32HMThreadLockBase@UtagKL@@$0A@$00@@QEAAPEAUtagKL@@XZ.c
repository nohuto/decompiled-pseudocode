/*
 * XREFs of ??$ManualUnlock@X@?$Win32HMThreadLockBase@UtagKL@@$0A@$00@@QEAAPEAUtagKL@@XZ @ 0x140189FA0
 * Callers:
...
__int64 __fastcall Win32HMThreadLockBase<tagKL,0,1>::ManualUnlock<void>(_QWORD *BugCheckParameter3, __int64 a2)
{
  struct tagTHREADINFO *v3; // rax
  __int64 result; // rax

  v3 = PtiCurrent((__int64)BugCheckParameter3, a2);
  result = Win32HM_UnlockFromThread<0>((ULONG_PTR)v3, BugCheckParameter3);
