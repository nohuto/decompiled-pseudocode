/*
 * XREFs of GreDeleteClientObj @ 0x140248BDC
 * Callers:
...
__int64 (__fastcall *__fastcall GreDeleteClientObj(__int64 a1))(__int64)
{
  __int64 (__fastcall *result)(__int64); // rax

  result = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 2424LL);
  if ( result )
