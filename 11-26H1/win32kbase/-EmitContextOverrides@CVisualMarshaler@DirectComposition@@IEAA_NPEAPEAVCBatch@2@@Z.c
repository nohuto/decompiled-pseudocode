/*
 * XREFs of ?EmitContextOverrides@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1401012DC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *((_DWORD *)v4 + 5) = *((_DWORD *)this + 31);
    *((_DWORD *)v4 + 6) = *((_DWORD *)this + 32);
