/*
 * XREFs of ?EmitSetQuadraticAttenuationCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E7D4
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetQuadraticAttenuationCommand(
