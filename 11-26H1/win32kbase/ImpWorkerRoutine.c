/*
 * XREFs of ImpWorkerRoutine @ 0x1400BEB90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ImpSetActualBasePriority @ 0x1400C0550 (ImpSetActualBasePriority.c)
...
void __fastcall ImpWorkerRoutine(PVOID StartContext)
{
  ...
  __int64 v3; // rcx
  __int64 v4; // r8
  __int64 InputMonitorSessionState; // r15
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 v8; // r8
  __int64 v9; // rdx
  ...
  *(_OWORD *)Object = 0LL;
  ...
  if ( *(_BYTE *)(InputMonitorSessionState + 48) )
  {
    ...
    if ( (int)ImpSetActualBasePriority(KeGetCurrentThread()) < 0
      && (unsigned int)dword_1402AA1C0 > 2
      && (unsigned __int8)tlgKeywordOn(&dword_1402AA1C0, 0x400000000000LL) )
    {
      v30 = v24;
      v43 = &v30;
      v44 = 4LL;
      ...
      v32 = 0x1000000LL;
      v46 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(&dword_1402AA1C0, &unk_14028EF44, 0LL, 0LL, 4, v42);
    }
      ...
      && (unsigned __int8)tlgKeywordOn(&dword_1402AA1C0, 0x400000000000LL) )
    {
      ...
      v32 = 0x1000000LL;
      v46 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(&dword_1402AA1C0, &unk_14028F0C6, 0LL, 0LL, 4, v42);
    }
...
LABEL_12:
    while ( 2 )
    {
        ...
        && (unsigned __int8)tlgKeywordOn(&dword_1402AA1C0, 0x400000000000LL) )
      {
        ...
        v32 = 0x1000000LL;
        v46 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(&dword_1402AA1C0, &unk_14028F0FC, 0LL, 0LL, 4, v42);
      }
      ImpAcquireLock(InputMonitorSessionState + 72);
      if ( *(_BYTE *)(InputMonitorSessionState + 48) )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(InputMonitorSessionState + 64) = v13;
          *(_QWORD *)v13 = v13;
        }
        ImpReleaseLock(InputMonitorSessionState + 72);
        v16 = 0;
          ...
          *(_QWORD *)(v20 + 8) = P_8;
          ...
          if ( v19 == 96 )
          {
            if ( (unsigned int)dword_1402AA1C0 > 2 && (unsigned __int8)tlgKeywordOn(&dword_1402AA1C0, 0x400000000000LL) )
            {
              ...
              v45 = &v32;
              v46 = 8LL;
              tlgWriteTransfer_EtwWriteTransfer(&dword_1402AA1C0, &unk_14028F084, 0LL, 0LL, 4, v42);
            }
            if ( i != 191 )
