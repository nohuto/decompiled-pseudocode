/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0FBAAA@$0FBA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1401DECE4
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<331776,1296>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *Pool2 = 0LL;
  ...
  if ( !v9 )
    return 0;
  RtlInitializeBitMap(v9, &v9[1].SizeOfBitMap, 0xF3u);
  RtlClearAllBits(v10);
  result = 1;
  v12 = a2 ^ a1[2];
