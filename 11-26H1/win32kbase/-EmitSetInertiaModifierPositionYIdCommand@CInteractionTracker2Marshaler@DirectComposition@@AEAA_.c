/*
 * XREFs of ?EmitSetInertiaModifierPositionYIdCommand@CInteractionTracker2Marshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022CC5C
 * Callers:
...
char __fastcall DirectComposition::CInteractionTracker2Marshaler::EmitSetInertiaModifierPositionYIdCommand(
