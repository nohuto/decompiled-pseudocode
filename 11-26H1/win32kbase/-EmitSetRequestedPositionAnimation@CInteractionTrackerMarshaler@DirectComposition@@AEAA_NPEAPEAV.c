/*
 * XREFs of ?EmitSetRequestedPositionAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140146578
 * Callers:
    ...
    || (*(unsigned __int8 (__fastcall **)(_DWORD *))(*(_QWORD *)v6 + 56LL))(v6) )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v10) )
    {
      ...
      *((_DWORD *)v7 + 2) = *((_DWORD *)this + 8);
      v7[16] = (*((_BYTE *)this + 428) & 1) == 0;
      *((_DWORD *)v7 + 6) = *((_DWORD *)this + 39);
      v8 = *((_QWORD *)this + 29);
      if ( v8 )
      {
        v9 = *(_QWORD *)(v8 + 16);
