/*
 * XREFs of ?EmitSetCoefficient4Command@CArithmeticCompositeEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022C484
 * Callers:
...
char __fastcall DirectComposition::CArithmeticCompositeEffectMarshaler::EmitSetCoefficient4Command(
