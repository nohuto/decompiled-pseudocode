/*
 * XREFs of ?DrvFunctionalizeBaseVidMode@@YAJAEBURETRY_MODE@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1401B8CE8
 * Callers:
...
__int64 __fastcall DrvFunctionalizeBaseVidMode(const struct RETRY_MODE *a1, struct D3DKMT_GETPATHSMODALITY *a2)
{
  ...
  if ( !a2 )
  {
    ...
    WdLogGlobalForLineNumber = 25555;
  }
  v5 = *((_DWORD *)a1 + 1);
  v6 = 0xFFFFFFFFLL;
  if ( v5 == -1 )
  ...
  if ( *((_DWORD *)a1 + 2) )
  {
    ...
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 25588;
    }
