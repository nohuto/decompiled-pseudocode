/*
 * XREFs of McTemplateK0qqxx_EtwWriteTransfer @ 0x140139EE8
 * Callers:
 *     EtwGdiSysMemToken @ 0x140139E70 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x140139EB0 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
