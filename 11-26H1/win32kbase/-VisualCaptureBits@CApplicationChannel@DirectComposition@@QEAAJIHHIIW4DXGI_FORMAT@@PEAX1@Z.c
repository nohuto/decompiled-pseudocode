/*
 * XREFs of ?VisualCaptureBits@CApplicationChannel@DirectComposition@@QEAAJIHHIIW4DXGI_FORMAT@@PEAX1@Z @ 0x14022AF74
 * Callers:
        ...
        PVOID a9)
{
  ...
  if ( *(int *)(a1 + 24) <= 2 )
  {
    v13 = DirectComposition::CApplicationChannel::LookupResourceMarshaler(
            ...
            a2);
    v14 = v13;
    if ( v13 && DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v13 + 9), 156) )
    {
