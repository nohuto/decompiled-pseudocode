/*
 * XREFs of ?PrepareMessageWorker@SendProcessor@Calling@CoreMessaging@@AEAAJPEAUIMessageCallSendHost@@GGPEBEPEADHIII@Z @ 0x1400D8EE8
 * Callers:
        ...
        unsigned int a8)
{
  ...
  *(_QWORD *)this = a5 + 1;
  *((_DWORD *)this + 20) = v11;
  if ( (unsigned __int8)v11 <= 0x10u && (a7 || !(_BYTE)v11 || a6) )
  {
    v12 = 8;
    *((_QWORD *)this + 1) = a5 + 1;
    *((_DWORD *)this + 31) = 0;
