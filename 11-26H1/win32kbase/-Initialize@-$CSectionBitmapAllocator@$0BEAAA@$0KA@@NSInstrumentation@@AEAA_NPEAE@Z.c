/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0BEAAA@$0KA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1401B75CC
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<81920,160>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v9 = (struct _RTL_BITMAP *)ExAllocatePool2(258LL, 80LL, 1869834581LL);
  v10 = v9;
  if ( !v9 )
    return 0;
  RtlInitializeBitMap(v9, &v9[1].SizeOfBitMap, 0x1F4u);
  RtlClearAllBits(v10);
  result = 1;
  v12 = a2 ^ a1[2];
