/*
 * XREFs of ?EmitSetExtendedBoundsCommand@CWindowNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400FFD24
 * Callers:
...
char __fastcall DirectComposition::CWindowNodeMarshaler::EmitSetExtendedBoundsCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v4 + 12) = *(_OWORD *)((char *)this + 396);
    *((_DWORD *)this + 84) &= ~0x10u;
    return 1;
  }
  return 0;
}
