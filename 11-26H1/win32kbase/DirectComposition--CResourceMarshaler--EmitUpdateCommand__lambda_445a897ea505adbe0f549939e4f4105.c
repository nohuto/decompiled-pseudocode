/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_445a897ea505adbe0f549939e4f41058___ @ 0x140166788
 * Callers:
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 7) = *(_DWORD *)(*(_QWORD *)a3 + 84LL);
  result = 1;
  *((_DWORD *)v5 + 8) = *(_DWORD *)(*(_QWORD *)a3 + 136LL);
  return result;
}
