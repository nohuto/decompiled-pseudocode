/*
 * XREFs of ?WaitingForEffectCompile@CBatch@DirectComposition@@AEAA_NXZ @ 0x1401B2F7C
 * Callers:
 ...
 * Callees:
 *     ?EffectHashesCompiled@CConnection@DirectComposition@@QEBA_NPEB_KI@Z @ 0x1401B2BEC (-EffectHashesCompiled@CConnection@DirectComposition@@QEBA_NPEB_KI@Z.c)
 */
