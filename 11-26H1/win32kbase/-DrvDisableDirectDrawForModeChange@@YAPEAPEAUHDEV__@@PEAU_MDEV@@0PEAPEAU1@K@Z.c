/*
 * XREFs of ?DrvDisableDirectDrawForModeChange@@YAPEAPEAUHDEV__@@PEAU_MDEV@@0PEAPEAU1@K@Z @ 0x140174280
 * Callers:
  ...
  *a3 = (HDEV)(unsigned int)v10;
  if ( (_DWORD)v10 )
  {
    ...
    do
    {
      LOBYTE(v10) = 1;
      v18 = *v16;
      GrepSuspendDirectDraw(&v18, 2LL, v10);
      ++v16;
      --v15;
    }
    while ( v15 );
