/*
 * XREFs of ?DrvLogDisplayDriverEvent@@YAXW4_DISP_DRIVER_LOG@@@Z @ 0x14002C914
 * Callers:
...
void __fastcall DrvLogDisplayDriverEvent(__int64 a1)
{
  ...
  if ( *(_DWORD *)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 2924LL) )
  {
    RtlInitUnicodeString(&DestinationString, &word_14026AF94);
    v2 = v1 - 1;
    if ( v2 )
    {
      v3 = v2 - 1;
    ...
    if ( DestinationString.Length )
    {
      ...
      ObjectAttributes.SecurityDescriptor = *(PVOID *)(v8 + 1824);
