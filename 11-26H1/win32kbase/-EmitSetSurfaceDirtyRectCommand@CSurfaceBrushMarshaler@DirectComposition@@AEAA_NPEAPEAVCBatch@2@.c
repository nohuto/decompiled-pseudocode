/*
 * XREFs of ?EmitSetSurfaceDirtyRectCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FE78
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetSurfaceDirtyRectCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *(_OWORD *)(v4 + 12) = *(_OWORD *)((char *)this + 60);
    *((_DWORD *)this + 4) &= ~0x80u;
