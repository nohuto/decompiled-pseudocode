/*
 * XREFs of ApiSetEditionMouseMoveShellResilience @ 0x14016F700
 * Callers:
...
__int64 (*__fastcall ApiSetEditionMouseMoveShellResilience(__int64 a1))(void)
{
  __int64 (*result)(void); // rax
  __int64 v3; // rcx

  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 4848LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v3) + 48) + 4856LL);
      if ( result )
