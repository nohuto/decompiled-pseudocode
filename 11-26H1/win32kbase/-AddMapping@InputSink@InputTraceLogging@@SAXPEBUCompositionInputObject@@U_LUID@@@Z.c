/*
 * XREFs of ?AddMapping@InputSink@InputTraceLogging@@SAXPEBUCompositionInputObject@@U_LUID@@@Z @ 0x140248524
 * Callers:
...
void __fastcall InputTraceLogging::InputSink::AddMapping(const struct CompositionInputObject *a1, struct _LUID a2)
{
  ...
  if ( (unsigned int)dword_1402A9E40 > 5 && tlgKeywordOn((__int64)&dword_1402A9E40, 4LL) )
  {
    v4 = v2;
    v5 = v3;
