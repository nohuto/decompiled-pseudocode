/*
 * XREFs of ?InputSpaceRegion@InputConfig@InputTraceLogging@@SAXPEBUINPUT_SPACE_REGION@@@Z @ 0x14008E750
 * Callers:
...
void __fastcall InputTraceLogging::InputConfig::InputSpaceRegion(const struct INPUT_SPACE_REGION *a1)
{
  ...
  else if ( (unsigned int)dword_1402A9E40 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1402A9E40, 2LL) )
  {
    v23 = *(_WORD *)(v1 + 22);
    v24 = *(_WORD *)(v1 + 20);
    v26 = *(_DWORD *)(v1 + 12);
