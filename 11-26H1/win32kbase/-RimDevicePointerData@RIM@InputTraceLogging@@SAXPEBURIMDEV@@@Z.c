/*
 * XREFs of ?RimDevicePointerData@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1400F3A98
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDevicePointerData(
        ...
        __int64 a4)
{
  ...
  unsigned __int16 *v37; // [rsp+190h] [rbp-20h] BYREF
  const char *v38; // [rsp+198h] [rbp-18h] BYREF
  const struct RIMDEV *v39; // [rsp+1A0h] [rbp-10h] BYREF
  const char *v40; // [rsp+1A8h] [rbp-8h] BYREF
  __int64 v41; // [rsp+1B0h] [rbp+0h] BYREF
  unsigned __int16 *v42; // [rsp+1B8h] [rbp+8h] BYREF
    ...
    && (qword_1402A9E58 & 0x100) == qword_1402A9E58 )
  {
    ...
    v36 = -__CFSHR__(v8, 2);
    v13 = -(v8 & 1);
    v40 = InputTraceLogging::PointerInjectionType(*(_DWORD *)(v6 + 364));
    v41 = *(_QWORD *)(v6 + 792);
    v42 = (unsigned __int16 *)(v6 + 904);
    v37 = (unsigned __int16 *)(v6 + 376);
    v14 = *(_DWORD *)(v6 + 152);
    v15 = *(_DWORD *)(v6 + 148);
    v16 = *(_DWORD *)(v6 + 144);
    v9 = *((_QWORD *)a1 + 56);
  ...
  if ( *(_DWORD *)(v6 + 156) && v4 > 4 && (qword_1402A9E50 & 0x100) != 0 && (v7 & 0x100) == v7 )
  {
