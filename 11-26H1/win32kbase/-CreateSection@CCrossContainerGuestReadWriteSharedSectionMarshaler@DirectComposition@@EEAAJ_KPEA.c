/*
 * XREFs of ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x14023F080
 * Callers:
 *     <none>
 * Callees:
 *     DCompositionIsVailContainer @ 0x140228844 (DCompositionIsVailContainer.c)
 *     CreateVmSharedMemorySection @ 0x14024B254 (CreateVmSharedMemorySection.c)
 */
