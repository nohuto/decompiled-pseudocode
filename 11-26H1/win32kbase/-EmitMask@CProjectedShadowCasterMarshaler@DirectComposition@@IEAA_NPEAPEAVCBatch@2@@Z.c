/*
 * XREFs of ?EmitMask@CProjectedShadowCasterMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140246028
 * Callers:
...
bool __fastcall DirectComposition::CProjectedShadowCasterMarshaler::EmitMask(
