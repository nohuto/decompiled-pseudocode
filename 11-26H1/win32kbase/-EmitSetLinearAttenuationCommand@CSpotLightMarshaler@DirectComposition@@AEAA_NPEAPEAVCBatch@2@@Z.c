/*
 * XREFs of ?EmitSetLinearAttenuationCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D114
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetLinearAttenuationCommand(
