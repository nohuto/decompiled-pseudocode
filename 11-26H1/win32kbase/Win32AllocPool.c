/*
 * XREFs of Win32AllocPool @ 0x1400B88C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Win32AllocPool(unsigned __int64 a1, unsigned int a2, int a3)
{
  ...
  {
LABEL_2:
    Pool2 = ExAllocatePool2(258LL, v4, (unsigned int)v3);
    if ( Pool2 )
  ...
  v9 = (unsigned __int64 *)ExAllocatePool2(258LL, v4 + 16, (unsigned int)v3);
  Pool2 = (__int64)v9;
  if ( !v9
    || (_InterlockedIncrement64((volatile signed __int64 *)(v5 + 112)),
        *v9 = v3,
