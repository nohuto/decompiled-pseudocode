/*
 * XREFs of RIMComputeSpecificHighMetricValue @ 0x140192F2C
 * Callers:
...
__int64 __fastcall RIMComputeSpecificHighMetricValue(int a1, __int64 a2)
{
  ...
  v7 = *(_DWORD *)(a2 + 36) & 0xF;
  if ( (unsigned int)v7 < 5 && (unsigned int)(dword_14027B9C0[v7] - 1) <= 1 && (unsigned int)v3 < 0xB )
  {
    v8 = RIMComputePower(word_140272798[2 * (unsigned int)v3 + 1], a2, v3, 0LL);
    if ( v10 >= 0 )
    {
      v12 = 2540;
      if ( v9 != 1 )
