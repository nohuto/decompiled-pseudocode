/*
 * XREFs of ?TraceObjectCalloutStop@Log@CoreMessagingK@@SAXJ@Z @ 0x1400D8414
 * Callers:
...
void __fastcall CoreMessagingK::Log::TraceObjectCalloutStop(int a1, __int64 a2, int a3, int a4)
{
