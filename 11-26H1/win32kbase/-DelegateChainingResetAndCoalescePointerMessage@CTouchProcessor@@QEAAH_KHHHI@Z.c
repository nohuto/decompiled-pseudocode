/*
 * XREFs of ?DelegateChainingResetAndCoalescePointerMessage@CTouchProcessor@@QEAAH_KHHHI@Z @ 0x1400654C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  if ( *((_DWORD *)v14 + 8) >= *((_DWORD *)v15 + 12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6047LL);
  v17 = *(_QWORD *)(v16 + 240) + 480LL * *((unsigned int *)v14 + 8);
  if ( !(unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v17) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6049LL);
  if ( *(_WORD *)(v17 + 172) != *((_WORD *)v14 + 8) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6050LL);
  if ( !a5 )
  {
    if ( a4 )
      goto LABEL_11;
