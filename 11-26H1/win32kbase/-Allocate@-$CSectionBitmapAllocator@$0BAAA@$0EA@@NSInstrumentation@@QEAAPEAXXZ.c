/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0BAAA@$0EA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1401DC8CC
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<4096,64>::Allocate(__int64 a1)
{
  ...
  ClearBits = RtlFindClearBits(v3, 1u, *(_DWORD *)(a1 + 32) < 0x40u ? *(_DWORD *)(a1 + 32) : 0);
  v5 = 0LL;
  v6 = ClearBits;
  if ( ClearBits != -1 )
  {
    ...
    if ( ++*(_DWORD *)(a1 + 32) >= 0x40u )
      *(_DWORD *)(a1 + 32) = 0;
    v5 = v7 + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8)) + ((unsigned __int8)(v6 & 0x3F) << 6);
  }
LABEL_8:
