/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0DAAA@$0DA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1401DE9A8
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<12288,48>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *Pool2 = 0LL;
  ...
  if ( !v9 )
    return 0;
  RtlInitializeBitMap(v9, &v9[1].SizeOfBitMap, 0xFFu);
  RtlClearAllBits(v10);
  result = 1;
  v12 = a2 ^ a1[2];
