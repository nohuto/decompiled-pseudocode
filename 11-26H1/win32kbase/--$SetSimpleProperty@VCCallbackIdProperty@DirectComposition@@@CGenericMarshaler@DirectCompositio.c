/*
 * XREFs of ??$SetSimpleProperty@VCCallbackIdProperty@DirectComposition@@@CGenericMarshaler@DirectComposition@@IEAAJUDCOMPOSITION_PROPERTY_ID@@IPEA_N@Z @ 0x14022A384
 * Callers:
 *     ?SetCallbackId@CGenericMarshaler@DirectComposition@@UEAAJIPEA_N@Z @ 0x14022AD80 (-SetCallbackId@CGenericMarshaler@DirectComposition@@UEAAJIPEA_N@Z.c)
 * Callees:
        ...
        _BYTE *a4)
{
  ...
  {
    v8 = DirectComposition::Memory::AllocateAndClear_0(0xCuLL, 0x70674344u, 1);
    v9 = v8;
    if ( !v8 )
      return 3221225495LL;
    *(_DWORD *)v8 = a2;
