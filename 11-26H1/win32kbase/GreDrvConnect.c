/*
 * XREFs of GreDrvConnect @ 0x1401FACD0
 * Callers:
...
__int64 __fastcall GreDrvConnect(_QWORD *a1)
{
  ...
  SEMOBJ<6>::SEMOBJ<6>((struct _ERESOURCE **)&v18, v2);
  SEMOBJ<10>::SEMOBJ<10>((struct _ERESOURCE **)&v17, v2);
  SEMOBJ<19>::SEMOBJ<19>(&v16, v2);
  for ( i = v2[227]; ; i = (struct _ERESOURCE *)i->SystemResourcesList.Flink )
  {
    v5 = 0;
    if ( !i )
      break;
