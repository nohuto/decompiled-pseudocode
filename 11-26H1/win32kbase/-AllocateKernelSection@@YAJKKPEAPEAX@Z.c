/*
 * XREFs of ?AllocateKernelSection@@YAJKKPEAPEAX@Z @ 0x1401BEC68
 * Callers:
 ...
 *     ??0SectionObj@Gre@@QEAA@PEAXPEAT_LARGE_INTEGER@@_NPEAPEAX@Z @ 0x14014C460 (--0SectionObj@Gre@@QEAA@PEAXPEAT_LARGE_INTEGER@@_NPEAPEAX@Z.c)
