/*
 * XREFs of EditionCommitMousePosAndMove @ 0x1400A24C8
 * Callers:
        ...
        __int64 a8))(__int64, __int64, __int64, __int64, int, __int64, int, __int64)
{
  ...
  result = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, __int64, int, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 6424LL);
  if ( result )
