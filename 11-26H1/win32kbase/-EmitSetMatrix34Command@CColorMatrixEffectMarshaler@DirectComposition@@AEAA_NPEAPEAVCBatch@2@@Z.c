/*
 * XREFs of ?EmitSetMatrix34Command@CColorMatrixEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D728
 * Callers:
...
char __fastcall DirectComposition::CColorMatrixEffectMarshaler::EmitSetMatrix34Command(
