/*
 * XREFs of ?EmitGeometry@CSpriteShapeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140137A20
 * Callers:
...
bool __fastcall DirectComposition::CSpriteShapeMarshaler::EmitGeometry(
