/*
 * XREFs of McTemplateK0pppqqqqpppqqqq_EtwWriteTransfer @ 0x140171D6C
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x140171CB0 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1401FA290 (EtwWindowRendering.c)
 * Callees:
