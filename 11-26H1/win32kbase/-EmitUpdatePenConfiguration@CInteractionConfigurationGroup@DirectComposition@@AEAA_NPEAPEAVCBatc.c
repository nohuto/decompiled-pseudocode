/*
 * XREFs of ?EmitUpdatePenConfiguration@CInteractionConfigurationGroup@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400B2360
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  v3 = (_DWORD *)((char *)this + 72);
  v5 = (_DWORD *)((char *)this + 80);
  while ( 1 )
  {
    v6 = v5;
    if ( (*((_DWORD *)this + 3) & 2) == 0 && *v5 >= *v3 )
      break;
    v8 = *a2;
