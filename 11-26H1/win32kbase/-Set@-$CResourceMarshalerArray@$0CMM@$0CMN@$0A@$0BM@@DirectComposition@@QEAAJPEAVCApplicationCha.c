/*
 * XREFs of ?Set@?$CResourceMarshalerArray@$0CMM@$0CMN@$0A@$0BM@@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEAPEAVCResourceMarshaler@2@_K@Z @ 0x1402355D4
 * Callers:
...
__int64 __fastcall DirectComposition::CResourceMarshalerArray<716,717,0,28>::Set(
        ...
        unsigned __int64 a4)
{
  ...
  if ( a4 )
  {
    ...
    {
      v7 = a3[v4];
      if ( !v7 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v7 + 9), 28) )
        return 3221225485LL;
      v4 = v8 + 1;
      if ( v4 >= a4 )
        goto LABEL_5;
