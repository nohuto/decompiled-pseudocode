/*
 * XREFs of ??1?$CTypeIsolation@$0BAAA@$0EA@@NSInstrumentation@@IEAA@XZ @ 0x1401EBB20
 * Callers:
...
void __fastcall NSInstrumentation::CTypeIsolation<4096,64>::~CTypeIsolation<4096,64>(__int64 a1)
{
