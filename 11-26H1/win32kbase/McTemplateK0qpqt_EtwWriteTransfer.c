/*
 * XREFs of McTemplateK0qpqt_EtwWriteTransfer @ 0x140137DCC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qpqt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite_EtwWriteTransfer(a1, &DCompCommitBatchEvent, &W32kControlGuid, 5u, &v8);
}
