/*
 * XREFs of ?DrvCheckRemoteSessionRemoteAdapterAccess@@YAJU_LUID@@@Z @ 0x140028CD8
 * Callers:
 *     ?DxgkEngCheckRemoteSessionRemoteAdapterAccess@@YAJU_LUID@@@Z @ 0x140028CC0 (-DxgkEngCheckRemoteSessionRemoteAdapterAccess@@YAJU_LUID@@@Z.c)
 * Callees:
...
__int64 __fastcall DrvCheckRemoteSessionRemoteAdapterAccess(struct _LUID a1)
{
  ...
  if ( ProductType != NtProductServer || (SuiteMask & 0x110) != 0x10 )
    return 0LL;
  if ( LowPart == *(_DWORD *)(v10 + 3004) )
    return *(_DWORD *)(v10 + 3008) != HighPart ? 0xC000000D : 0;
  return 3221225485LL;
}
