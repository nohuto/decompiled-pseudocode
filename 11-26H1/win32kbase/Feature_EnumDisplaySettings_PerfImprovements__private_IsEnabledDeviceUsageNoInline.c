/*
 * XREFs of Feature_EnumDisplaySettings_PerfImprovements__private_IsEnabledDeviceUsageNoInline @ 0x1401E0438
 * Callers:
 *     NtUserEnumDisplaySettings @ 0x1401AB540 (NtUserEnumDisplaySettings.c)
 * Callees:
 *     Feature_EnumDisplaySettings_PerfImprovements__private_IsEnabledFallback @ 0x1401E0474 (Feature_EnumDisplaySettings_PerfImprovements__private_IsEnabledFallback.c)
 */
