/*
 * XREFs of ?EmitResampleMode@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140100E4C
 * Callers:
...
char __fastcall DirectComposition::CVisualMarshaler::EmitResampleMode(
