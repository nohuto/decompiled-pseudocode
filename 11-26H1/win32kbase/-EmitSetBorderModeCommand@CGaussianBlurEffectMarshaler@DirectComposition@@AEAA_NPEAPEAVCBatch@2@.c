/*
 * XREFs of ?EmitSetBorderModeCommand@CGaussianBlurEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022BC40
 * Callers:
...
char __fastcall DirectComposition::CGaussianBlurEffectMarshaler::EmitSetBorderModeCommand(
