/*
 * XREFs of ?TraceCreatePortStop@Log@CoreMessagingK@@SAXJ@Z @ 0x1400DA368
 * Callers:
...
void __fastcall CoreMessagingK::Log::TraceCreatePortStop(int a1, __int64 a2, int a3, int a4)
{
