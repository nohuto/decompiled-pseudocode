/*
 * XREFs of ?EmitSetOuterConeIntensityCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E4F0
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetOuterConeIntensityCommand(
