/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0HAGJEDEE@$0CBN@$0CBO@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x14023450C
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1885946692,541,542,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
