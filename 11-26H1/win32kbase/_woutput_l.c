/*
 * XREFs of _woutput_l @ 0x1401C7CAC
 * Callers:
 ...
 *     write_char @ 0x1401C85E4 (write_char.c)
 *     write_multi_char @ 0x1401C863C (write_multi_char.c)
 *     write_string @ 0x1401C8694 (write_string.c)
...
LABEL_87:
              ...
              LODWORD(v12) = (unsigned int)&DstCh[64] + 383 - (_DWORD)j;
              v50 = v6;
              v7 = (wchar_t *)((char *)j + 1);
              if ( (v5 & 0x200) != 0 )
              {
