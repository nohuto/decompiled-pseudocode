/*
 * XREFs of ?TranslateMilCommandBatchHandleArray@CMilCommandBatchParser@CApplicationChannel@DirectComposition@@AEAAXPEAIIW4MIL_RESOURCE_TYPE@@_NPEAJ@Z @ 0x14014B5E8
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  if ( (unsigned __int64)a2 < v9 )
  {
    ...
    {
      v10 = v7++;
      DirectComposition::CApplicationChannel::CMilCommandBatchParser::TranslateMilCommandBatchHandle(a1, v10, a4, 0, a6);
    }
