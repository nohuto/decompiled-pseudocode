/*
 * XREFs of ?ActivateKeyboardLayout@Keyboard@InputTraceLogging@@SAXQEAUtagKL@@0W4_ChangeKbdTableReason@@@Z @ 0x14011B440
 * Callers:
...
void InputTraceLogging::Keyboard::ActivateKeyboardLayout()
{
  ...
  {
    v0 = tlgKeywordOn((__int64)&dword_1402A9E40, 0x4000LL);
    v4 = 0LL;
    if ( v0 )
    {
      if ( (_DWORD)v1 )
