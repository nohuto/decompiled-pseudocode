/*
 * XREFs of ?EmitProtection@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140100AB8
 * Callers:
...
char __fastcall DirectComposition::CVisualMarshaler::EmitProtection(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v5) )
  {
    ...
    *((_BYTE *)v4 + 12) = (*((_BYTE *)this + 324) & 0x20) != 0;
