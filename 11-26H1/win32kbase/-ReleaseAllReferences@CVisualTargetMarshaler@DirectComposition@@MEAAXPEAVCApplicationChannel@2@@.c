/*
 * XREFs of ?ReleaseAllReferences@CVisualTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1400A3DA0
 * Callers:
 *     <none>
 * Callees:
 *     ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCResourceMarshaler@DirectComposition@@$00@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400A3DF0 (-ReleaseAllReferences@-$CSharedResourceMarshaler@VCResourceMarshaler@DirectComposition@@$00@Dire.c)
