/*
 * XREFs of DrvGetDisplayDriverParameters @ 0x1400285D4
 * Callers:
...
__int64 __fastcall DrvGetDisplayDriverParameters(__int64 a1, struct _devicemodeW *a2, int a3, __int64 a4)
{
  ...
  WCHAR *RegistryHandleFromDeviceMap; // r14
  __int64 v21; // rcx
  ...
  __int128 v26; // xmm0
  _OWORD *v27; // rdx
  unsigned __int16 dmDriverExtra; // ax
      ...
      || (v25 = *(_OWORD **)(a1 + 264)) == 0LL )
    {
      ...
      while ( 1 )
      {
        ...
        if ( RegistryHandleFromDeviceMap )
        {
          ...
          if ( RegistryValues >= 0 )
          {
            SessionState = W32GetSessionState(v21);
            if ( v30
              && !a2->dmBitsPerPel
              && !a2->dmPelsWidth
              && !a2->dmPelsHeight
              ...
              && !a2->dmDisplayFlags
              && !*(_DWORD *)(*(_QWORD *)(SessionState + 88) + 1148LL) )
            {
