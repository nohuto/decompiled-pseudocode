/*
 * XREFs of ?EmitSetSnapToPixelsCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FD8C
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetSnapToPixelsCommand(
