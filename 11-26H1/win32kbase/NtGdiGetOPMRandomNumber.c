/*
 * XREFs of NtGdiGetOPMRandomNumber @ 0x140008620
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SafelyCopyKernelModeDataToUserModeData__DXGKMDT_OPM_RANDOM_NUMBER_ @ 0x1401F40C0 (SafelyCopyKernelModeDataToUserModeData__DXGKMDT_OPM_RANDOM_NUMBER_.c)
...
int __fastcall NtGdiGetOPMRandomNumber(void *a1, __int64 a2)
{
  ...
  result = COPM::GetRandomNumber(*(COPM **)(*(_QWORD *)(SessionState + 88) + 3728LL), a1, &v6);
  if ( result >= 0 )
  {
