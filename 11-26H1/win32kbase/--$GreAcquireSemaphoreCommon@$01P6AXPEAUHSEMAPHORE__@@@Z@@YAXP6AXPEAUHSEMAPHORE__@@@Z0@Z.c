/*
 * XREFs of ??$GreAcquireSemaphoreCommon@$01P6AXPEAUHSEMAPHORE__@@@Z@@YAXP6AXPEAUHSEMAPHORE__@@@Z0@Z @ 0x140057724
 * Callers:
...
__int64 __fastcall GreAcquireSemaphoreCommon<2,void (*)(HSEMAPHORE__ *)>(void (__fastcall *a1)(__int64), __int64 a2)
{
  ...
  {
    v8 = *v7;
    if ( (*v7 & 0xFFFFFFDFFFFFFFFCuLL) != 0 && (v8 & 4) == 0 )
    {
      v11 = 38;
      for ( i = 0LL; i < 0x40; ++i )
      {
    ...
    LOBYTE(i) = *(_BYTE *)(((v3 + 8) & -(__int64)(v3 != 0)) + 0xA);
    result = (unsigned int)(i + 1);
    *(_BYTE *)(((v3 + 8) & -(__int64)(v3 != 0)) + 0xA) = i + 1;
    if ( !(_BYTE)i )
      *v7 |= 4uLL;
  }
  return result;
