/*
 * XREFs of ?Deserialize@?$CDeserializedSectionEntry@$0BEAAA@$0BEA@@NSInstrumentation@@SAPEAV12@AEAVDeserializer@2@@Z @ 0x1401EE548
 * Callers:
...
_QWORD *__fastcall NSInstrumentation::CDeserializedSectionEntry<81920,320>::Deserialize(
        NSInstrumentation::Deserializer *this)
{
  ...
  v2 = NSInstrumentation::CSectionEntry<81920,320>::Create();
  v3 = v2;
  if ( v2 )
  {
    v4 = (void *)v2[3];
    ...
    Pool2 = (void *)ExAllocatePool2(258LL, 81920LL, 1869834581LL);
    v3[3] = Pool2;
    if ( Pool2 && NSInstrumentation::Deserializer::DeserializeBytes(this, Pool2, 0x14000uLL) )
    {
      v7 = v3 + 4;
      NSInstrumentation::CSectionBitmapAllocator<81920,160>::Destroy((PVOID)v3[4]);
      v8 = NSInstrumentation::CSectionBitmapAllocator<81920,320>::Create(v3[3]);
      v9 = v8;
      if ( v8 )
      {
