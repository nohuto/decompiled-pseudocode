/*
 * XREFs of ApiSetEditionUpdateRawMouseMode @ 0x140173C54
 * Callers:
...
__int64 (*__fastcall ApiSetEditionUpdateRawMouseMode(__int64 a1))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 6456LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v3) + 48) + 6464LL);
      if ( result )
