/*
 * XREFs of ?EmitSetSurfaceCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FB3C
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetSurfaceCommand(
