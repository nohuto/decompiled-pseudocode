/*
 * XREFs of rimConvertUserToKernelSemaphoreHandle @ 0x14005D8EC
 * Callers:
...
__int64 __fastcall rimConvertUserToKernelSemaphoreHandle(void *a1, void **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v3 < 0 )
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 980LL);
  }
  else
  {
    v5 = ObOpenObjectByPointer(Object, 0x200u, 0LL, 0x1F0003u, (POBJECT_TYPE)ExSemaphoreObjectType, 0, a2);
    if ( v5 < 0 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 992LL);
