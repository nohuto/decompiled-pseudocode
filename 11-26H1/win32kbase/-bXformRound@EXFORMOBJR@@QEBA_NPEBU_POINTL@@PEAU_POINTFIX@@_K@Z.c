/*
 * XREFs of ?bXformRound@EXFORMOBJR@@QEBA_NPEBU_POINTL@@PEAU_POINTFIX@@_K@Z @ 0x1400C1880
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  v5[1] = a4;
  v6 = 0;
  return ((__int64 (__fastcall *)(EXFORMOBJR *, _QWORD *, struct _POINTFIX *, __int64))EXFORMOBJR::bXformRound)(
           this,
           v5,
           a3,
           a4);
