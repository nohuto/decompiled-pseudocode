/*
 * XREFs of ?EmitSetMatrix53Command@CColorMatrixEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022DA70
 * Callers:
...
char __fastcall DirectComposition::CColorMatrixEffectMarshaler::EmitSetMatrix53Command(
