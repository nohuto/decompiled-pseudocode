/*
 * XREFs of ?IsPropertyAnimatable@CShadowEffectMarshaler@DirectComposition@@UEAA_NUDCOMPOSITION_PROPERTY_ID@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1402342F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CShadowEffectMarshaler::IsPropertyAnimatable(__int64 a1, int a2, int a3)
{
  if ( a2 == 10 || a2 == 11 || a2 == 12 || (unsigned int)(a2 - 13) < 2 )
    return a3 == 18;
  else
