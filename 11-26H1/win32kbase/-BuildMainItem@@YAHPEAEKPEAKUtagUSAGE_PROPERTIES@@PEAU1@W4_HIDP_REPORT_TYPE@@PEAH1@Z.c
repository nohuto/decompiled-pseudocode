/*
 * XREFs of ?BuildMainItem@@YAHPEAEKPEAKUtagUSAGE_PROPERTIES@@PEAU1@W4_HIDP_REPORT_TYPE@@PEAH1@Z @ 0x140209BAC
 * Callers:
 ...
 * Callees:
 *     ?BuildVendorDefinedCL@@YAHPEAEKPEAK@Z @ 0x14020A5D8 (-BuildVendorDefinedCL@@YAHPEAEKPEAK@Z.c)
 *     ?OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z @ 0x14020A6B4 (-OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z.c)
 *     ?SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z @ 0x14020A74C (-SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z.c)
 */
