/*
 * XREFs of ?DeliverSynthesizedMouseInput@@YAXPEBU_IVMouseInputPacket@@PEAX@Z @ 0x14021E300
 * Callers:
...
void __fastcall DeliverSynthesizedMouseInput(const struct _IVMouseInputPacket *a1, void *a2)
{
  ...
  v2 = *((_DWORD *)a1 + 8);
  v4 = *((_QWORD *)a1 + 3);
  v6 = Win32AllocPoolZInitImpl(256LL, (int)(28 * v2 + 36), 0x736D5649u);
  v8 = (_QWORD *)v6;
  if ( v6 )
  {
    *(_QWORD *)(v6 + 16) = a2;
    ...
    *(_QWORD *)(v6 + 24) = *((_QWORD *)a1 + 6);
    if ( v2 )
    {
      ...
      do
      {
        ...
        *(v7 - 13) = v11;
        *(v7 - 12) = *(v9 - 22);
        *(_DWORD *)(v7 - 11) = *((_DWORD *)v9 - 10);
        *(_DWORD *)(v7 - 9) = *((_DWORD *)v9 - 9);
        *(_DWORD *)(v7 - 7) = *((_DWORD *)v9 - 8);
        *(_DWORD *)(v7 - 5) = *((_DWORD *)v9 - 7);
        *(_DWORD *)(v7 - 3) = *((_DWORD *)v9 - 4);
        --v10;
      }
      while ( v10 );
    }
    ChildSubmitRootSynthesizedMouseInput(v8, (int)v7, (int)v8);
  }
}
