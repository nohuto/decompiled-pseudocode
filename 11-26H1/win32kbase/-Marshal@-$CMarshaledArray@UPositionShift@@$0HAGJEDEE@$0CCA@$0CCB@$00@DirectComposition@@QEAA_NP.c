/*
 * XREFs of ?Marshal@?$CMarshaledArray@UPositionShift@@$0HAGJEDEE@$0CCA@$0CCB@$00@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x1402345E8
 * Callers:
...
char __fastcall DirectComposition::CMarshaledArray<PositionShift,1885946692,544,545,1>::Marshal(
        char **this,
        __int64 a2,
        __int64 a3)
{
