/*
 * XREFs of ?EmitSetMinAttenuationCutoffCommand@CPointLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022DDC0
 * Callers:
...
char __fastcall DirectComposition::CPointLightMarshaler::EmitSetMinAttenuationCutoffCommand(
