/*
 * XREFs of ?EmitSetPropertySetCommand@CEffectBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1401A36CC
 * Callers:
...
char __fastcall DirectComposition::CEffectBrushMarshaler::EmitSetPropertySetCommand(
