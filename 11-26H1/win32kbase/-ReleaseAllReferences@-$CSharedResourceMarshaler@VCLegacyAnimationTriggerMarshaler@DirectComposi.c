/*
 * XREFs of ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCLegacyAnimationTriggerMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x14019FFF0
 * Callers:
 *     <none>
 * Callees:
