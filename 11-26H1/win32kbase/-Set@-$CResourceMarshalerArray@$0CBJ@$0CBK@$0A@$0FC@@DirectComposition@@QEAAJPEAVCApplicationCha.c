/*
 * XREFs of ?Set@?$CResourceMarshalerArray@$0CBJ@$0CBK@$0A@$0FC@@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEAPEAVCResourceMarshaler@2@_K@Z @ 0x14023541C
 * Callers:
 *     ?SetReferenceArrayProperty@CInteractionTracker2Marshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@UDCOMPOSITION_PROPERTY_ID@@PEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1402378F0 (-SetReferenceArrayProperty@CInteractionTracker2Marshaler@DirectComposition@@UEAAJPEAVCApplicatio.c)
 * Callees:
...
__int64 __fastcall DirectComposition::CResourceMarshalerArray<537,538,0,82>::Set(
        ...
        unsigned __int64 a4)
{
  ...
  if ( a4 )
  {
    ...
    {
      v7 = a3[v4];
      if ( !v7 || !DirectComposition::CResourceMarshaler::IsDerivedResourceType(*((_DWORD *)v7 + 9), 82) )
        return 3221225485LL;
      v4 = v8 + 1;
      if ( v4 >= a4 )
        goto LABEL_5;
