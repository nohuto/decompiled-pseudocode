/*
 * XREFs of ?Serialize@?$CSectionEntry@$0CMAAA@$0CMA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401EFBB8
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<180224,704>::Serialize(__int64 a1, NSInstrumentation::Serializer *a2)
{
  unsigned int v4; // ebp
  bool v5; // bl
  __int64 v6; // rsi
  ...
  if ( !NSInstrumentation::Serializer::SerializeBytes(a2, *(void **)(a1 + 24), v4)
    || !NSInstrumentation::Serializer::AdvanceBytes(a2, 180224 - v4) )
  {
    return 0;
  }
  v6 = *(_QWORD *)(a1 + 32);
