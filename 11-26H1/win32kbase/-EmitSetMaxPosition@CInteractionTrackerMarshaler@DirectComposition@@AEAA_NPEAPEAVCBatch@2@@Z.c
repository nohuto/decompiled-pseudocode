/*
 * XREFs of ?EmitSetMaxPosition@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x140146704
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x8000) == 0 )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v6) )
    {
      ...
      *((_DWORD *)v5 + 3) = *((_DWORD *)this + 31);
      *((_DWORD *)v5 + 4) = *((_DWORD *)this + 32);
