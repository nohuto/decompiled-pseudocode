/*
 * XREFs of ?NlsAlphanumericModeProc@@YAHPEAUtagKE@@_KK@Z @ 0x14021CD60
 * Callers:
...
__int64 __fastcall NlsAlphanumericModeProc(struct tagKE *a1, __int64 a2)
{
  ...
  *((_WORD *)a1 + 1) |= 0xF0u;
  if ( !*(_DWORD *)(W32GetUserSessionState(v6, v5, v7) + 14276) )
  {
    if ( (unsigned int)NlsTestKeyStateToggle(0x15u) )
      NlsKbdSendIMEProc(1LL);
  }
  return 1LL;
}
