/*
 * XREFs of RIMDirectPnpRemoveUserModeRimDevices @ 0x1400E8ED8
 * Callers:
 ...
 *     _lambda_73e2fc7e3e0c65abbb028759e33d66b1_::operator_void_(__cdecl_)(RawInputManagerObject___void__) @ 0x1401FE8A8 (_lambda_73e2fc7e3e0c65abbb028759e33d66b1_--operator_void_(__cdecl_)(RawInputManagerObject___void.c)
 */

__int64 __fastcall RIMDirectPnpRemoveUserModeRimDevices(__int64 a1, int a2, int a3)
{
  bool v3; // bl
  bool v4; // di
  ...
  v8 = lambda_73e2fc7e3e0c65abbb028759e33d66b1_::operator_void____cdecl___RawInputManagerObject___void___();
