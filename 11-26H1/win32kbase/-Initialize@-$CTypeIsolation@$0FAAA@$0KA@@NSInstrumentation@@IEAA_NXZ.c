/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0FAAA@$0KA@@NSInstrumentation@@IEAA_NXZ @ 0x1401EC24C
 * Callers:
 ...
 *     ?Create@?$CSectionEntry@$0FAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1401DDAB0 (-Create@-$CSectionEntry@$0FAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ.c)
 */

char __fastcall NSInstrumentation::CTypeIsolation<20480,160>::Initialize(__int64 a1)
{
  _QWORD *Pool2; // rax
  ...
  *(_QWORD *)(a1 + 16) = Pool2;
  if ( Pool2 )
  {
    *Pool2 = 0LL;
      ...
      *(_QWORD *)(a1 + 24) = v6;
      if ( v6 )
      {
        ExInitializePagedLookasideList(
          v6,
          (PALLOCATE_FUNCTION)`NSInstrumentation::CTypeIsolation<909312,3552>::Initialize'::`13'::_lambda_1_::_lambda_invoker_cdecl_<enum _POOL_TYPE,unsigned __int64,unsigned long>,
    ...
    {
      v4 = NSInstrumentation::CSectionEntry<20480,160>::Create();
      if ( v4 )
      {
        v5 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 125;
