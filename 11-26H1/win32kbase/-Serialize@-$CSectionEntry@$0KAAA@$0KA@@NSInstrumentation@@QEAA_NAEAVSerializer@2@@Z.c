/*
 * XREFs of ?Serialize@?$CSectionEntry@$0KAAA@$0KA@@NSInstrumentation@@QEAA_NAEAVSerializer@2@@Z @ 0x1401EFE40
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<40960,160>::Serialize(__int64 a1, NSInstrumentation::Serializer *a2)
{
  unsigned int v4; // ebp
  bool v5; // bl
  __int64 v6; // rsi
  ...
  if ( !NSInstrumentation::Serializer::SerializeBytes(a2, *(void **)(a1 + 24), v4)
    || !NSInstrumentation::Serializer::AdvanceBytes(a2, 40960 - v4) )
  {
    return 0;
  }
  v6 = *(_QWORD *)(a1 + 32);
