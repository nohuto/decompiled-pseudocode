/*
 * XREFs of ?EmitSetCoefficient2Command@CArithmeticCompositeEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022C394
 * Callers:
...
char __fastcall DirectComposition::CArithmeticCompositeEffectMarshaler::EmitSetCoefficient2Command(
