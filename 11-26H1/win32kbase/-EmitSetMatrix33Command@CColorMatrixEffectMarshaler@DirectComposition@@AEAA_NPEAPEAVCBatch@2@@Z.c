/*
 * XREFs of ?EmitSetMatrix33Command@CColorMatrixEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D6B0
 * Callers:
...
char __fastcall DirectComposition::CColorMatrixEffectMarshaler::EmitSetMatrix33Command(
