/*
 * XREFs of ?Settings@PTP@InputTraceLogging@@SAXAEBUtagTOUCHPAD_PARAMETERS_V3@@@Z @ 0x1401C476C
 * Callers:
...
void __fastcall InputTraceLogging::PTP::Settings(const struct tagTOUCHPAD_PARAMETERS_V3 *a1)
{
  ...
  if ( (unsigned int)dword_1402A9E40 > 4 && tlgKeywordOn((__int64)&dword_1402A9E40, 128LL) )
  {
    v3 = v1[11];
    v32 = -(v1[12] & 1);
    v33 = -__CFSHR__(v3, 3);
