/*
 * XREFs of ?PerformMarashlingCheck@MouseInterceptState@CMouseProcessor@@AEBA?AW4InterceptMarshalCheck@12@XZ @ 0x140223F3C
 * Callers:
...
__int64 __fastcall CMouseProcessor::MouseInterceptState::PerformMarashlingCheck(__int64 a1)
{
  ...
  if ( !*(_DWORD *)(a1 + 24) )
    MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 8561);
  CurrentThreadId = (unsigned int)PsGetCurrentThreadId();
  v3 = CurrentThreadId;
  if ( CurrentThreadId != *(_DWORD *)(a1 + 28) && CurrentThreadId != *(_DWORD *)(a1 + 24) )
    MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 8571);
  v4 = *(_DWORD *)(a1 + 24);
  if ( v3 == v4 )
    return 1LL;
  v6 = *(_DWORD *)(a1 + 28);
  if ( v3 != v6 )
    return 2LL;
  if ( v4 == v6 )
    MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 8591);
  return 0LL;
}
