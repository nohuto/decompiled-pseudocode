/*
 * XREFs of ?EmitSetTemplateCommand@CEffectBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14018C804
 * Callers:
...
char __fastcall DirectComposition::CEffectBrushMarshaler::EmitSetTemplateCommand(
