/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCRemoteAppRenderTargetMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1400A50B0
 * Callers:
 *     <none>
 * Callees:
