/*
 * XREFs of ??$UserAllocateIsolatedType@UtagKL@@@@YAPEAUtagKL@@_K@Z @ 0x1401DC744
 * Callers:
...
__int64 __fastcall UserAllocateIsolatedType<tagKL>(ULONG_PTR BugCheckParameter4, int a2, int a3)
{
  __int64 v4; // rdx
  __int64 result; // rax
