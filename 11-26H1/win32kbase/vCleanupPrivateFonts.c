/*
 * XREFs of vCleanupPrivateFonts @ 0x140023B80
 * Callers:
...
__int64 (*__fastcall vCleanupPrivateFonts(__int64 a1))(void)
{
  __int64 (*result)(void); // rax

  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 2392LL);
  if ( result )
