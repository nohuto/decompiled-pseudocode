/*
 * XREFs of ?GetRemoteScaleOverrideTestHook@@YAXPEBG_KPEAU_DPI_INFORMATION@@@Z @ 0x1401349AC
 * Callers:
 ...
 *     ?RtlStringCchCatW@@YAJPEAG_KPEBG@Z @ 0x140134C70 (-RtlStringCchCatW@@YAJPEAG_KPEBG@Z.c)
