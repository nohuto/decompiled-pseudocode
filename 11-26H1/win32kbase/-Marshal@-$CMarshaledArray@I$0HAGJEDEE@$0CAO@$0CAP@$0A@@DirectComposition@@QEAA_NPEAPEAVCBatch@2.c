/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0HAGJEDEE@$0CAO@$0CAP@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x140234488
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1885946692,526,527,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
