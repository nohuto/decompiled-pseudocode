/*
 * XREFs of ?EmitSetStartPointCommand@CLinearGradientBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022F654
 * Callers:
...
char __fastcall DirectComposition::CLinearGradientBrushMarshaler::EmitSetStartPointCommand(
