/*
 * XREFs of ?QueueFrame@RIM@TelemetryDebug@InputTraceLogging@@SAXAEBUTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x14016AB98
 * Callers:
        ...
        int a3)
{
  ...
  {
    if ( (unsigned int)dword_1402A9E40 > 7 && tlgKeywordOn((__int64)&dword_1402A9E40, 0x10000LL) )
    {
      v23 = *((_QWORD *)a1 + 17);
      v24 = *((_QWORD *)a1 + 16);
      v25 = *((_QWORD *)a1 + 15);
  ...
  else if ( (unsigned int)dword_1402A9E40 > 7 && tlgKeywordOn((__int64)&dword_1402A9E40, 0x10000LL) )
  {
    v23 = *((_QWORD *)a1 + 7);
    v24 = *((_QWORD *)a1 + 6);
    v25 = *((_QWORD *)a1 + 5);
