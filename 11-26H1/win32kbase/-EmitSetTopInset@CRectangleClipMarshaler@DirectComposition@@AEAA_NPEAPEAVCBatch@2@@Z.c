/*
 * XREFs of ?EmitSetTopInset@CRectangleClipMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400B0990
 * Callers:
...
char __fastcall DirectComposition::CRectangleClipMarshaler::EmitSetTopInset(
