/*
 * XREFs of ApiSetEditionDestroyEdgePalmRejectionZones @ 0x1402274EC
 * Callers:
...
__int64 __fastcall ApiSetEditionDestroyEdgePalmRejectionZones(__int64 a1)
{
  ...
  v2 = 0;
  v3 = *(int (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 6304LL);
  if ( v3 )
  {
    if ( v3() >= 0 )
    {
      v5 = *(unsigned int (__fastcall **)(__int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v4) + 48) + 6312LL);
      if ( v5 )
        return v5(a1);
    }
  }
