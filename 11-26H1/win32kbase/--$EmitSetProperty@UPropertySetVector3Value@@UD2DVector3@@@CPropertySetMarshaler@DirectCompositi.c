/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector3Value@@UD2DVector3@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@UDCOMPOSITION_PROPERTY_ID@@@Z @ 0x140241CE8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v10 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x28uLL, &v10);
  v7 = (char *)v10;
  *(_DWORD *)v10 = 40;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
  ...
  *((_DWORD *)v7 + 5) = PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::GetDataType(
  ...
  Property = PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::GetPropertyValue<D2DVector4>(
               a1 + 72,
               a3);
  *(_QWORD *)(v7 + 28) = *(_QWORD *)Property;
  *((_DWORD *)v7 + 9) = *(_DWORD *)(Property + 8);
