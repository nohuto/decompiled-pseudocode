/*
 * XREFs of ?Deserialize@?$CDeserializedSectionEntry@$0MAAA@$0MA@@NSInstrumentation@@SAPEAV12@AEAVDeserializer@2@@Z @ 0x1401EEB60
 * Callers:
...
_QWORD *__fastcall NSInstrumentation::CDeserializedSectionEntry<49152,192>::Deserialize(
        NSInstrumentation::Deserializer *this)
{
  ...
  v2 = NSInstrumentation::CSectionEntry<49152,192>::Create();
  v3 = v2;
  if ( v2 )
  {
    v4 = (void *)v2[3];
    ...
    Pool2 = (void *)ExAllocatePool2(258LL, 49152LL, 1869834581LL);
    v3[3] = Pool2;
    if ( Pool2 && NSInstrumentation::Deserializer::DeserializeBytes(this, Pool2, 0xC000uLL) )
    {
      v7 = v3 + 4;
      NSInstrumentation::CSectionBitmapAllocator<81920,160>::Destroy((PVOID)v3[4]);
      v8 = NSInstrumentation::CSectionBitmapAllocator<49152,192>::Create(v3[3]);
      v9 = v8;
      if ( v8 )
      {
