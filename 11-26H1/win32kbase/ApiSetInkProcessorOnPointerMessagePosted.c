/*
 * XREFs of ApiSetInkProcessorOnPointerMessagePosted @ 0x140199EB0
 * Callers:
...
__int64 (*__fastcall ApiSetInkProcessorOnPointerMessagePosted(__int64 a1, __int64 a2))(void)
{
  ...
  v3 = a1;
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 4256LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v5) + 48) + 4264LL);
      if ( result )
