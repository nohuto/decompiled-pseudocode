/*
 * XREFs of ?EmitUpdatePlaybackState@CKeyframeAnimationMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1400AF878
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x2000) == 0 )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x24uLL, &v6) )
    {
      ...
      *((_DWORD *)v4 + 3) = *((_DWORD *)this + 74);
      *(_QWORD *)(v4 + 20) = *((_QWORD *)this + 25);
      v4[28] = (*((_BYTE *)this + 320) & 2) == 0;
