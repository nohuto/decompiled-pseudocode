/*
 * XREFs of ?IsPropertyAnimatable@CPrimitiveColorMarshaler@DirectComposition@@UEAA_NUDCOMPOSITION_PROPERTY_ID@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x14023F6F0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall DirectComposition::CPrimitiveColorMarshaler::IsPropertyAnimatable(__int64 a1, unsigned int a2, int a3)
{
  if ( a2 == 1 || a2 == 2 || a2 - 3 < 2 )
    return a3 == 18;
  else
