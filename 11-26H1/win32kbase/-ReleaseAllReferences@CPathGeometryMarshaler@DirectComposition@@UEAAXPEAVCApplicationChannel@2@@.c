/*
 * XREFs of ?ReleaseAllReferences@CPathGeometryMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x140147160
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _RTL_GENERIC_TABLE *a2)
{
  ...
  DirectComposition::CGeometryMarshaler::ReleaseAllReferences(this, (struct DirectComposition::CApplicationChannel *)a2);
}
