/*
 * XREFs of ?EmitSetInputCountCommand@CEffectBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1401A3FB4
 * Callers:
...
char __fastcall DirectComposition::CEffectBrushMarshaler::EmitSetInputCountCommand(
