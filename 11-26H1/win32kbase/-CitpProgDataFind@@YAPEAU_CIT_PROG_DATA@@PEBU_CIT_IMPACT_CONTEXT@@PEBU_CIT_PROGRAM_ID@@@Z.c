/*
 * XREFs of ?CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z @ 0x140249F70
 * Callers:
 ...
 * Callees:
 *     ?CitpProgramIdIsEqual@@YAEPEBU_CIT_PROGRAM_ID@@0@Z @ 0x14024A300 (-CitpProgramIdIsEqual@@YAEPEBU_CIT_PROGRAM_ID@@0@Z.c)
 */
  ...
  if ( v2 >> 5 )
  {
    v7 = *((_QWORD *)a1 + 10)
       ...
       * (((v2 >> 5) - 1) & (HIBYTE(v8)
                           ...
                           + 37
                           * (BYTE6(v8)
                            + 37 * (BYTE5(v8) + 37 * (BYTE4(v8) + 37 * (BYTE3(v8) + 37 * (BYTE2(v8) + 37 * BYTE1(v8))))))));
LABEL_5:
    while ( 1 )
    {
      v7 = *(_QWORD *)v7;
