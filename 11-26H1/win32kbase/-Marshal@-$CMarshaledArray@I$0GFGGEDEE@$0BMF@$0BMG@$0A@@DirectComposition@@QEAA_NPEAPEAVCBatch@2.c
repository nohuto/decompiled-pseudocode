/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0GFGGEDEE@$0BMF@$0BMG@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x1402343D8
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1701200708,453,454,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
