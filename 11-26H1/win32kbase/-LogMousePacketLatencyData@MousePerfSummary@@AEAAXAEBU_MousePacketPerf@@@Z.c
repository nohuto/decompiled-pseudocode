/*
 * XREFs of ?LogMousePacketLatencyData@MousePerfSummary@@AEAAXAEBU_MousePacketPerf@@@Z @ 0x1400A01D0
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_1402A9E78 > 5 && (qword_1402A9E88 & 0x10) != 0 && (qword_1402A9E90 & 0x10) == qword_1402A9E90 )
  {
    v16 = *((_QWORD *)a2 + 5);
    v4 = *((_QWORD *)a2 + 4);
    v5 = *((_QWORD *)a2 + 3);
