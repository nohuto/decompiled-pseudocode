/*
 * XREFs of McTemplateK0qxttxx_EtwWriteTransfer @ 0x140168DEC
 * Callers:
 *     EtwTraceFlipManagerPresentIFlipCompleted @ 0x140168DA0 (EtwTraceFlipManagerPresentIFlipCompleted.c)
 * Callees:
