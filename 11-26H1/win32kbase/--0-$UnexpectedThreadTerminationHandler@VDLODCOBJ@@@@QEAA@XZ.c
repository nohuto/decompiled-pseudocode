/*
 * XREFs of ??0?$UnexpectedThreadTerminationHandler@VDLODCOBJ@@@@QEAA@XZ @ 0x1400C6DA0
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_OWORD *)(a1 + 16) = 0LL;
  if ( a1 )
  {
    ...
    *(_QWORD *)(a1 + 16) = v3;
    *(_QWORD *)(a1 + 24) = UnexpectedThreadTerminationHandler<DLODCOBJ>::OnUnexpectedThreadTerminationStatic;
