/*
 * XREFs of ?ulGetMatchFromPalentry@XEPALOBJ@@QEAAKUtagPALETTEENTRY@@@Z @ 0x14003366C
 * Callers:
 ...
 *     ?ulIndexedGetNearestFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1400337CC (-ulIndexedGetNearestFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
  ...
  if ( (int)v3 <= 5 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      switch ( (_DWORD)v3 )
      {
        ...
        case 2:
          return ulIndexedGetNearestFromPalentry((struct PALETTE *)v2, *(_DWORD *)&a2);
        case 3:
