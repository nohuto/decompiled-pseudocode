/*
 * XREFs of ?LoadApiSetHost@@YAJPEAU_Win32kApiSetHost@@PEAU_UNICODE_STRING@@@Z @ 0x140152A14
 * Callers:
 ...
 *     AddApiSetHostLoadRefCount @ 0x140152CA0 (AddApiSetHostLoadRefCount.c)
 */
  ...
  *(_OWORD *)P = 0LL;
  while ( 1 )
  {
    ...
    v8 = ((__int64 (__fastcall *)(PVOID *, _QWORD, _QWORD, __int64, char *, char *))MmLoadSystemImage)(
           ...
           (char *)a1 + 32);
    v2 = v8;
    if ( v8 == -1073741411 || v8 == -1073741554 )
    {
