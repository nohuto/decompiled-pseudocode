/*
 * XREFs of NtGdiSetOPMSigningKeyAndSequenceNumbers @ 0x140008B50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_ENCRYPTED_PARAMETERS_ @ 0x140008C00 (SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_ENCRYPTED_PARAMETERS_.c)
...
__int64 __fastcall NtGdiSetOPMSigningKeyAndSequenceNumbers(void *a1, __int64 a2)
{
  ...
  if ( Pool2 )
  {
    ...
    if ( v9 >= 0 )
      v9 = COPM::SetSigningKeyAndSequenceNumbers(*(COPM **)(v4 + 3728), a1, v8);
  }
  else
  {
    v9 = -1073741801;
