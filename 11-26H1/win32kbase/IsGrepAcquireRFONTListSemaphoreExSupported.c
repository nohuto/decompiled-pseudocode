/*
 * XREFs of IsGrepAcquireRFONTListSemaphoreExSupported @ 0x140192710
 * Callers:
...
__int64 __fastcall IsGrepAcquireRFONTListSemaphoreExSupported(__int64 a1)
{
  __int64 (*v1)(void); // rax

  v1 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 1904LL);
  if ( v1 )
    return v1();
  else
    return 3221225659LL;
