/*
 * XREFs of ?EmitSetAlphaModeCommand@CColorMatrixEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022B6B0
 * Callers:
...
char __fastcall DirectComposition::CColorMatrixEffectMarshaler::EmitSetAlphaModeCommand(
