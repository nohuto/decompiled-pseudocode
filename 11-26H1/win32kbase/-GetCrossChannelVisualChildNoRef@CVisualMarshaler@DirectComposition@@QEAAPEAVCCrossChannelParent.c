/*
 * XREFs of ?GetCrossChannelVisualChildNoRef@CVisualMarshaler@DirectComposition@@QEAAPEAVCCrossChannelParentVisualMarshaler@2@VResourceHandle@@@Z @ 0x1401C6CA0
 * Callers:
...
__int64 __fastcall DirectComposition::CVisualMarshaler::GetCrossChannelVisualChildNoRef(__int64 a1, unsigned int a2)
{
  ...
  {
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD *, _QWORD))(*i + 352LL))(i, a2) )
      return (*(__int64 (__fastcall **)(_QWORD *))(*i + 128LL))(i);
  }
  return 0LL;
}
