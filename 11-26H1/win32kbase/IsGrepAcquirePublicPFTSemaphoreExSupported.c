/*
 * XREFs of IsGrepAcquirePublicPFTSemaphoreExSupported @ 0x140192114
 * Callers:
...
__int64 __fastcall IsGrepAcquirePublicPFTSemaphoreExSupported(__int64 a1)
{
  __int64 (*v1)(void); // rax

  v1 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 1856LL);
  if ( v1 )
    return v1();
  else
    return 3221225659LL;
