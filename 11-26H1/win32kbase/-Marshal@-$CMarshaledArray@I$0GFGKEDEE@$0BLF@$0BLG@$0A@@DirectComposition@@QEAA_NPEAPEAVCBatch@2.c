/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0GFGKEDEE@$0BLF@$0BLG@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x140234430
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1701462852,437,438,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
