/*
 * XREFs of McTemplateK0qxxxxxi_EtwWriteTransfer @ 0x14014E1D8
 * Callers:
 *     EtwTraceFlipManagerPresentSkipped @ 0x14014DDC0 (EtwTraceFlipManagerPresentSkipped.c)
 *     EtwTraceFlipManagerPresentProcessed @ 0x14014DFD0 (EtwTraceFlipManagerPresentProcessed.c)
 *     EtwTraceFlipManagerPresentCanceled @ 0x1401DAE70 (EtwTraceFlipManagerPresentCanceled.c)
 *     EtwTraceFlipManagerPresentDeferred @ 0x1401DB060 (EtwTraceFlipManagerPresentDeferred.c)
 * Callees:
