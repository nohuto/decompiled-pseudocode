/*
 * XREFs of ?Commit@CApplicationChannel@DirectComposition@@QEAAJPEA_N_N1PEBUSynchronizationObject@2@PEAVCMilProtocolBlock@@PEAII@Z @ 0x1400A7400
 * Callers:
    ...
    if ( a4 )
    {
      ...
      *((_BYTE *)this + 264) |= 0x30u;
      ...
      if ( *(_DWORD *)(v20 + 148) )
      {
        v21 = *(_QWORD *)(v20 + 296);
        if ( v21 )
          (*(void (__fastcall **)(__int64))(*(_QWORD *)v21 + 176LL))(v21);
      }
...
LABEL_24:
      ...
      *((_QWORD *)this + 22) = v27;
      ...
      if ( *(_DWORD *)(v32 + 148) )
      {
        v33 = *(_QWORD *)(v32 + 296);
        if ( v33 )
          (*(void (__fastcall **)(__int64))(*(_QWORD *)v33 + 176LL))(v33);
      }
      ExReleaseResourceLite(*(PERESOURCE *)(*((_QWORD *)this + 5) + 16LL));
      KeLeaveCriticalRegion();
      if ( v28 )
