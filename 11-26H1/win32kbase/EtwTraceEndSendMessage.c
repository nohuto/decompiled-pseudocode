/*
 * XREFs of EtwTraceEndSendMessage @ 0x140107C00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EtwTraceEndSendMessage(__int64 a1, __int64 a2)
{
  ...
  if ( (Microsoft_Windows_Win32kEnableBits & 0x800) != 0 )
  {
    ...
    if ( CurrentThreadWin32Thread && (v6 = *CurrentThreadWin32Thread) != 0 )
      ...
      LOBYTE(v6) = -1;
    McTemplateK0cp_EtwWriteTransfer(v4, &EndSendMessage, v5, v6, a1);
  }
}
