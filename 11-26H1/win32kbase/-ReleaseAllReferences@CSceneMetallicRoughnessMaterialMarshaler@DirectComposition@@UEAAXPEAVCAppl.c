/*
 * XREFs of ?ReleaseAllReferences@CSceneMetallicRoughnessMaterialMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x140234F50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReleaseAllReferences@CScenePbrMaterialMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x140235020 (-ReleaseAllReferences@CScenePbrMaterialMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel.c)
 */
        ...
        struct _RTL_GENERIC_TABLE *a2)
{
  ...
  DirectComposition::CScenePbrMaterialMarshaler::ReleaseAllReferences(
    this,
