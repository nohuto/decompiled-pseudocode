/*
 * XREFs of IsGrepReleaseRFONTListSemaphoreExSupported @ 0x140193C20
 * Callers:
...
__int64 __fastcall IsGrepReleaseRFONTListSemaphoreExSupported(__int64 a1)
{
  __int64 (*v1)(void); // rax

  v1 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 1920LL);
  if ( v1 )
    return v1();
  else
    return 3221225659LL;
