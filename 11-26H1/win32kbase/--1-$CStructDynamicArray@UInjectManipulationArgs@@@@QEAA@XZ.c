/*
 * XREFs of ??1?$CStructDynamicArray@UInjectManipulationArgs@@@@QEAA@XZ @ 0x14016272C
 * Callers:
...
void __fastcall CStructDynamicArray<InjectManipulationArgs>::~CStructDynamicArray<InjectManipulationArgs>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
