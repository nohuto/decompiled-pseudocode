/*
 * XREFs of ??$AddProperty@UD2DMatrix@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBUD2DMatrix@@@Z @ 0x140199BC0
 * Callers:
...
__int64 __fastcall DirectComposition::CPropertySetMarshaler::AddProperty<D2DMatrix>(__int64 a1, _DWORD *a2, __int64 a3)
{
              ...
              &v13) >= 0 )
  {
    ...
    else
    {
      v10 = *(_DWORD *)(a1 + 80);
      v7 = -1073741811;
      if ( !v10 || (v11 = *(_DWORD *)(a1 + 96), v11 < 0x40) )
