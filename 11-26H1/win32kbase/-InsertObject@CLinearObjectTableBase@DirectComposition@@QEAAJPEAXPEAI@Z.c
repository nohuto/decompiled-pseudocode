/*
 * XREFs of ?InsertObject@CLinearObjectTableBase@DirectComposition@@QEAAJPEAXPEAI@Z @ 0x1400FE344
 * Callers:
  ...
  if ( v12 > v13 )
  {
    ...
    if ( is_mul_ok(v13, v18) )
    {
      v14 = (char *)(*((_BYTE *)this + 8)
                   ...
                   : Win32AllocPoolImpl(256LL, v17, 0x746C4344u));
      v15 = v14;
      if ( v14 )
      {
        v19 = *((_QWORD *)this + 3);
        ...
        if ( *(_QWORD *)this )
          GreDeleteFastMutex(*(char **)this, v20, v21, v22);
        *(_QWORD *)this = v15;
        *((_QWORD *)this + 2) = v13;
        goto LABEL_10;
      }
