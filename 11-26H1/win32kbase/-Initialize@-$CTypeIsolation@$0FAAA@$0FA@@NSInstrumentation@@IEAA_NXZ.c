/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0FAAA@$0FA@@NSInstrumentation@@IEAA_NXZ @ 0x1401EC160
 * Callers:
...
char __fastcall NSInstrumentation::CTypeIsolation<20480,80>::Initialize(__int64 a1)
{
  _QWORD *Pool2; // rax
