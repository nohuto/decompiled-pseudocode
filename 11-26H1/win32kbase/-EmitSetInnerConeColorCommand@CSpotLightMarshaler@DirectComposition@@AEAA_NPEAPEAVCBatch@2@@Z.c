/*
 * XREFs of ?EmitSetInnerConeColorCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022CE44
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetInnerConeColorCommand(
