/*
 * XREFs of ?bSetMagicColor@@YAHAEAVPDEVOBJ@@VXEPALOBJ@@KT_PAL_ULONG@@@Z @ 0x1401F24C8
 * Callers:
 *     GreSetMagicColors @ 0x14018C3B0 (GreSetMagicColors.c)
 * Callees:
 *     ?vUpdateTime@XEPALOBJ@@QEAAXXZ @ 0x1401341C0 (-vUpdateTime@XEPALOBJ@@QEAAXXZ.c)
 */
  ...
  if ( *(_DWORD *)(a2 + 60) == 20 && (*(_DWORD *)(a2 + 24) & 0x11000) == 0 )
  {
    ...
    *(_DWORD *)(v9 + 4 * v4) = v16;
    ...
    if ( (unsigned int)v4 <= 0xA )
      v12 = (unsigned int)v4;
    *(_DWORD *)(v8 + 4 * v12 + 3784) = v16;
    *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v8 + 3872) + 112LL) + 4 * v12) = v13;
  }
  return v7;
}
