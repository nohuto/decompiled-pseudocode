/*
 * XREFs of McTemplateK0pqqqq_EtwWriteTransfer @ 0x1400FF448
 * Callers:
 *     EtwDirtyRectUpdate @ 0x1400FF370 (EtwDirtyRectUpdate.c)
 *     EtwTraceInternalSetTimer @ 0x1400FF3B0 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1400FF400 (EtwTraceTimerProc.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1401F9E60 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1401F9EA0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1401FA1D0 (EtwTranslationUpdate.c)
 * Callees:
