/*
 * XREFs of ?EmitSetCoefficient3Command@CArithmeticCompositeEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022C40C
 * Callers:
...
char __fastcall DirectComposition::CArithmeticCompositeEffectMarshaler::EmitSetCoefficient3Command(
