/*
 * XREFs of ?SetReferenceProperty@CPositionedLightMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@UDCOMPOSITION_PROPERTY_ID@@PEAVCResourceMarshaler@2@PEA_N@Z @ 0x1402380B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CPositionedLightMarshaler::SetReferenceProperty(
        __int64 a1,
