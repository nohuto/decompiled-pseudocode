/*
 * XREFs of ?EmitSetOffsetCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E194
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetOffsetCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v5) )
  {
    ...
    *(_QWORD *)((char *)v3 + 12) = *(_QWORD *)((char *)this + 172);
