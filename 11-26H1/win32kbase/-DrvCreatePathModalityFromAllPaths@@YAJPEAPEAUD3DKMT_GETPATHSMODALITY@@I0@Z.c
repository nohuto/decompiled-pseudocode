/*
 * XREFs of ?DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z @ 0x1401F5174
 * Callers:
...
__int64 __fastcall DrvCreatePathModalityFromAllPaths(PVOID *a1, unsigned int a2, PVOID *a3)
{
  unsigned int i; // r15d
  __int64 v7; // rsi
  ...
  if ( a2 < 2 )
  {
    ...
    if ( PathsModality < 0 )
    {
      WdLogSingleEntry2(2LL, PathsModality, 25686LL);
      WdLogGlobalForLineNumber = 25686;
    }
    return v9;
  }
  if ( !*a1 )
  {
    if ( a2 != 2 )
    {
      ...
      WdLogGlobalForLineNumber = 25697;
    }
    v11 = GetPathsModality((__int64)a1, a1, 0x10u, 0);
    v12 = v11;
    if ( v11 < 0 )
    {
      WdLogSingleEntry2(2LL, v11, 25706LL);
      result = v12;
      WdLogGlobalForLineNumber = 25706;
      return result;
    }
    if ( !*a1 )
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 25711;
    }
  }
  v13 = a2 - 1;
  if ( !v13 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 25713;
  }
  v14 = 0;
  while ( v13 )
  {
  ...
  *a3 = v15;
  if ( !v15 )
  {
    ...
    WdLogGlobalForLineNumber = 25785;
    return v9;
  }
  *((_WORD *)v15 + 10) = 1;
  *((_DWORD *)*a3 + 8) = 8;
