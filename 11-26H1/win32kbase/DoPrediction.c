/*
 * XREFs of DoPrediction @ 0x1401618A8
 * Callers:
        ...
        __int64 a7))(__int64, __int64, __int64, _QWORD, __int64, __int64, __int64)
{
  ...
  result = *(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64, __int64, __int64))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48)
                                                                                                  + 4008LL);
  if ( result )
