/*
 * XREFs of ?doImmediateBoostAll@GroupedFGBoostProp@@AEAAXW4BoostFlag@@@Z @ 0x1400DDE5C
 * Callers:
 ...
 *     ?IsForegroundWindow@@YA_NPEBUtagWND@@@Z @ 0x1400DE1CC (-IsForegroundWindow@@YA_NPEBUtagWND@@@Z.c)
 */
