/*
 * XREFs of ?RedirectMouseToHwnd@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEAUHWND__@@PEBUtagMsgRoutingInfo@@KK@Z @ 0x140145750
 * Callers:
 ...
 *     ?SetMouseConfigHelper@DirectComposition@@YAXU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeMousePrimitiveType@@@@00PEAU2@@Z @ 0x140241F58 (-SetMouseConfigHelper@DirectComposition@@YAXU-$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeMouse.c)
...
LABEL_21:
  ...
  v12 = (DirectComposition::CInteractionMarshaler *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 144LL))(v8);
  v22 = v12;
  v13 = v12;
  if ( !v12 )
    goto LABEL_8;
