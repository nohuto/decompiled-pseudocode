/*
 * XREFs of ?TrackObjectReferenceInitialization@@YAXW4ReferenceTrackerCountedType@@PEAXI@Z @ 0x140116F8C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( a2 )
  {
    v7 = *(NSInstrumentation::CReferenceTracker::CReferenceCountedType **)(v6 + 16 * v5 + 40);
    if ( v7 )
    {
      if ( (_DWORD)v3 )
      {
