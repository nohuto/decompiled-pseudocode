/*
 * XREFs of ?AllocatePriority@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_K0IW4_EX_POOL_PRIORITY@@@Z @ 0x1401FC760
 * Callers:
 *     Win32AllocPoolWithPriority @ 0x1401EA9A0 (Win32AllocPoolWithPriority.c)
