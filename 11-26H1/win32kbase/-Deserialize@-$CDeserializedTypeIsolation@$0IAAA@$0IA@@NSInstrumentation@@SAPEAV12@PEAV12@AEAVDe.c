/*
 * XREFs of ?Deserialize@?$CDeserializedTypeIsolation@$0IAAA@$0IA@@NSInstrumentation@@SAPEAV12@PEAV12@AEAVDeserializer@2@@Z @ 0x1401EF010
 * Callers:
...
__int64 __fastcall NSInstrumentation::CDeserializedTypeIsolation<32768,128>::Deserialize(
        __int64 a1,
...
LABEL_13:
  ...
  while ( v7 < v11 )
  {
    v8 = NSInstrumentation::CDeserializedSectionEntry<32768,128>::Deserialize(a2);
    if ( !v8 )
      return 0LL;
    v9 = *(_QWORD **)(a1 + 8);
    if ( *v9 != a1 )
