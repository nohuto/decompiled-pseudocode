/*
 * XREFs of ?EnsureAlpcCallbackRegistered@ServerPorts@CoreMessagingK@@CAJXZ @ 0x1400D9928
 * Callers:
...
__int64 __fastcall CoreMessagingK::ServerPorts::EnsureAlpcCallbackRegistered(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v7 >= 0 )
  {
    v8 = ExRegisterCallback(*v5, CoreMessagingK::ServerPorts::PortSignaledCallback, 0LL);
    *(_QWORD *)(v4 + 72) = v8;
    if ( !v8 )
    {
