/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0BAAA@$0IA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1401DD03C
 * Callers:
...
__int64 __fastcall NSInstrumentation::CTypeIsolation<4096,128>::Allocate(__int64 *a1)
{
  __int64 v2; // rbp
  __int64 *i; // rsi
  __int64 v4; // r14
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v10 = NSInstrumentation::CSectionEntry<4096,128>::Create();
      v11 = (_QWORD *)v10;
      if ( v10 )
      {
        v2 = NSInstrumentation::CSectionBitmapAllocator<4096,128>::Allocate(*(_QWORD *)(v10 + 32));
        if ( v2 )
        {
    ...
    v4 = NSInstrumentation::CSectionBitmapAllocator<4096,128>::Allocate(i[4]);
    if ( v4 )
      break;
  }
  if ( i == (__int64 *)*a1 )
