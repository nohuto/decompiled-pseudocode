/*
 * XREFs of ?RegisterInputDispatcherObjects@LegacyInputDispatcher@@UEAAJPEAXIPEAUInputDispatcherObject@@@Z @ 0x14013F6A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputDispatcherObject *a4)
{
  ...
  {
    if ( !*((_QWORD *)this + 4) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3038LL);
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3034LL);
    return 3221225485LL;
  }
}
