/*
 * XREFs of ?DownlevelInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@AEBUtagPTP_DOWNLEVELED_INPUT@@_K@Z @ 0x1401743C4
 * Callers:
 ...
 *     ?PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z @ 0x1401A1F3C (-PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z.c)
 */
        ...
        __int64 a3)
{
  ...
  if ( *(_DWORD *)a2 && v3 != 1 )
  {
    if ( v3 == 2 && (unsigned int)dword_1402A9E40 > 4 && tlgKeywordOn((__int64)&dword_1402A9E40, 128LL) )
    {
      v18 = *((_DWORD *)a2 + 1);
      v14 = v5;
      v15 = InputTraceLogging::PTPDownlevelActionToString(v6);
      if ( v9 )
      {
        v8 = *(_QWORD *)(v9 + 216);
        v17 = *(_DWORD *)(v9 + 40);
