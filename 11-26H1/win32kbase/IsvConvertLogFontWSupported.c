/*
 * XREFs of IsvConvertLogFontWSupported @ 0x1400C93D4
 * Callers:
...
__int64 __fastcall IsvConvertLogFontWSupported(__int64 a1)
{
  __int64 (*v1)(void); // rax

  v1 = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 24) + 1744LL);
  if ( v1 )
    return v1();
  else
    return 3221225659LL;
