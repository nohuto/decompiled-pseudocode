/*
 * XREFs of ?ConvertDisplayConfigPathIntoExistingPathModalityAtIdx@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@II_N11PEAUD3DKMT_GETPATHSMODALITY@@PEA_N@Z @ 0x14002DE28
 * Callers:
 ...
 * Callees:
 *     ?ConvertDisplayConfigWireFormatToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x14002D084 (-ConvertDisplayConfigWireFormatToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@P.c)
        ...
        bool *a8)
{
  ...
  for ( i = *(_QWORD *)(*(_QWORD *)(W32GetSessionState(a1) + 88) + 1184LL); ; i = *(_QWORD *)(i + 128) )
  {
    if ( !i )
    {
      WdLogSingleEntry3(2LL, *((int *)a1 + 5));
  ...
  *((_QWORD *)v14 + 8) = *((_QWORD *)a1 + 1);
  ...
  if ( (*(_QWORD *)a1 & 0x8004700000000000uLL) != 0x8004700000000000uLL )
  {
    ...
    WdLogGlobalForLineNumber = 13859;
    return 3221225485LL;
  }
  ...
  v16 = *((_QWORD *)a1 + 1);
  if ( (v16 & 0xFFFFFE7FFE7DF470uLL) != 0 || (v16 & v15) != v16 )
  {
    WdLogSingleEntry2(2LL, v15, v16);
    WdLogGlobalForLineNumber = 13875;
    return 3221225485LL;
  }
  ...
  if ( TargetVirtualization < 0 )
  {
    ...
    result = v18;
    WdLogGlobalForLineNumber = 13890;
    return result;
  }
  v19 = v34;
  ...
  *((_QWORD *)v14 + 38) = 0LL;
  ...
  {
    WdLogSingleEntry1(2LL, v9);
    WdLogGlobalForLineNumber = 13934;
    return 3221225485LL;
  }
  if ( (*(_DWORD *)a1 & 0x1000000) != 0 )
  {
    ...
    {
      WdLogSingleEntry1(2LL, v9);
      WdLogGlobalForLineNumber = 13948;
      return 3221225485LL;
    }
    if ( !*((_DWORD *)a1 + 50) )
    {
      WdLogSingleEntry1(2LL, v9);
      WdLogGlobalForLineNumber = 13954;
      return 3221225485LL;
    }
  ...
  else
  {
    ...
    *((_DWORD *)v14 + 71) = v30;
    if ( (*((_WORD *)a1 + 37) & 0x3F) != 0 )
      *((_DWORD *)v14 + 71) = (*((_WORD *)a1 + 37) & 0x3F) * v30;
    *((_DWORD *)v14 + 74) = 1;
  }
  v26 |= 0x1000000uLL;
  *((_QWORD *)v14 + 7) = v26;
LABEL_28:
  ...
  v29 = ConvertDisplayConfigScalingToPathModalityForPath(a1, (struct D3DKMT_PATHMODALITY_DESCRIPTOR *)(v14 + 56), a8);
  if ( v29 < 0 )
  {
    WdLogSingleEntry1(2LL, v9);
    result = (unsigned int)v29;
    WdLogGlobalForLineNumber = 14043;
  }
  else
  {
    *((_DWORD *)v14 + 62) = 0;
    if ( (*(_BYTE *)a1 & 8) != 0
      && (v31 = ConvertDisplayConfigWireFormatToPathModalityForPath(
                  a1,
          ...
          v31 < 0) )
    {
      ...
      WdLogGlobalForLineNumber = 14054;
    }
    else
    {
      return 0LL;
