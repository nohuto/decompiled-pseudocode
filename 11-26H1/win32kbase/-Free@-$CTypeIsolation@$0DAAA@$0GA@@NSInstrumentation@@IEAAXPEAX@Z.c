/*
 * XREFs of ?Free@?$CTypeIsolation@$0DAAA@$0GA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1401DE110
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0DAAA@$0GA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1401DD61C (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0DAAA@$0GA@@NSInstrumentation@@QEAA-AW4Allocat.c)
 *     memset @ 0x14024BD80 (memset.c)
 */

void __fastcall NSInstrumentation::CTypeIsolation<12288,96>::Free(__int64 *a1, void *a2)
{
  __int64 *i; // rdi
  _QWORD *v5; // rbp
  int v6; // eax
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    ...
    v5 = (_QWORD *)i[4];
    v6 = NSInstrumentation::CSectionBitmapAllocator<12288,96>::CheckAllocationStatus(v5, (unsigned __int64)a2);
    if ( !v6 )
      continue;
    v7 = v6 - 1;
    if ( !v7 )
