/*
 * XREFs of ?ReAllocate@?$CSortedVector@PEAXPEAX@NSInstrumentation@@AEAA_N_K@Z @ 0x1401FD000
 * Callers:
 ...
 * Callees:
 *     ?ULongLongMult@@YAJ_K0PEA_K@Z @ 0x14013C568 (-ULongLongMult@@YAJ_K0PEA_K@Z.c)
