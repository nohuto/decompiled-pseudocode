/*
 * XREFs of rimOnPnpQueryRemove @ 0x14020BA78
 * Callers:
...
__int64 __fastcall rimOnPnpQueryRemove(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a2 + 168) & 2) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 674);
  if ( (*(_DWORD *)(a2 + 168) & 0x2000) != 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM((__int64)"IXPTelAssert", 0x20000, 675);
