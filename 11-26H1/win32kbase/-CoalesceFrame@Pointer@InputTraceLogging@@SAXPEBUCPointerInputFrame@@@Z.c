/*
 * XREFs of ?CoalesceFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x140184814
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::CoalesceFrame(
