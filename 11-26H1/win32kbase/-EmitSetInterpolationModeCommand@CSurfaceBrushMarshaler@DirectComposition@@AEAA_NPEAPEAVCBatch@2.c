/*
 * XREFs of ?EmitSetInterpolationModeCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FC2C
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetInterpolationModeCommand(
