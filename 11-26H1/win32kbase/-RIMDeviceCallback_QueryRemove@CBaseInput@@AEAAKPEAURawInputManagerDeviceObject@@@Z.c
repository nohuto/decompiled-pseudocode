/*
 * XREFs of ?RIMDeviceCallback_QueryRemove@CBaseInput@@AEAAKPEAURawInputManagerDeviceObject@@@Z @ 0x140218730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::RIMDeviceCallback_QueryRemove(
        CBaseInput *this,
