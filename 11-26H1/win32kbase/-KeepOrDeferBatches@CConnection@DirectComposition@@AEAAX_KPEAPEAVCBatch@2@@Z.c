/*
 * XREFs of ?KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z @ 0x1401078A4
 * Callers:
        ...
        struct DirectComposition::CBatch **a3)
{
  ...
  struct DirectComposition::CBatch *v15; // [rsp+30h] [rbp-10h]
  bool v16; // [rsp+80h] [rbp+40h] BYREF
  int v17; // [rsp+90h] [rbp+50h] BYREF
  int v18; // [rsp+98h] [rbp+58h] BYREF

  v3 = *a3;
  v4 = 0;
  v15 = (DirectComposition::CConnection *)((char *)this + 136);
  v16 = 0;
  v5 = a3;
  v8 = v3;
  if ( v3 )
        ...
        if ( *(_BYTE *)(v9 + 33) )
        {
          ...
          if ( !v10
            && (!DirectComposition::CBatch::ShouldDefer(
                   ...
                   *((_QWORD *)this + 20),
                   (bool *)&v17,
                   (enum DirectComposition::CBatch::DeferReason *)&v18)
             || v18 == 6) )
          {
      ...
      *((_QWORD *)v3 + 6) = a2;
        ...
        || *((_DWORD *)v3 + 5) == 5 )
      {
        ShouldDefer = DirectComposition::CBatch::ShouldDefer(
                        ...
                        *((_QWORD *)this + 20),
                        &v16,
                        (enum DirectComposition::CBatch::DeferReason *)&v17);
...
LABEL_20:
      ...
      *(_BYTE *)(v13 + 49) = 1;
      *v5 = *(struct DirectComposition::CBatch **)v3;
      v14 = (struct DirectComposition::CBatch **)v15;
      v15 = v3;
      *v14 = v3;
      *(_QWORD *)v3 = 0LL;
LABEL_27:
