/*
 * XREFs of ?EmitSetStretchModeCommand@CSurfaceBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14016FCA0
 * Callers:
...
char __fastcall DirectComposition::CSurfaceBrushMarshaler::EmitSetStretchModeCommand(
