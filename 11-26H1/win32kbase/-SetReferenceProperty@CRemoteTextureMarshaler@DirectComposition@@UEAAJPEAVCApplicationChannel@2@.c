/*
 * XREFs of ?SetReferenceProperty@CRemoteTextureMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@UDCOMPOSITION_PROPERTY_ID@@PEAVCResourceMarshaler@2@PEA_N@Z @ 0x140238110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CRemoteTextureMarshaler::SetReferenceProperty(
        __int64 a1,
