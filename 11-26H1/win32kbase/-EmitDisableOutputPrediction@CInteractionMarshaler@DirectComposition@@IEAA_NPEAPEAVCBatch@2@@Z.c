/*
 * XREFs of ?EmitDisableOutputPrediction@CInteractionMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1400B2A10
 * Callers:
...
char __fastcall DirectComposition::CInteractionMarshaler::EmitDisableOutputPrediction(
