/*
 * XREFs of ?TraceRegistrarConnect@Log@CoreMessagingK@@SAXJ@Z @ 0x1401C5D38
 * Callers:
...
void __fastcall CoreMessagingK::Log::TraceRegistrarConnect(int a1, __int64 a2, __int64 a3, __int64 a4)
{
