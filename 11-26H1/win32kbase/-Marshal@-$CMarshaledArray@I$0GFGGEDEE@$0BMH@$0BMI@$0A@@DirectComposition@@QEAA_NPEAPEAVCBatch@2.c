/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0GFGGEDEE@$0BMH@$0BMI@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x140234404
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1701200708,455,456,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
