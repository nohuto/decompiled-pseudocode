/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0BEAAA@$0BEA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1401360D4
 * Callers:
 ...
 *     ?Create@?$CSectionEntry@$0BEAAA@$0BEA@@NSInstrumentation@@SAPEAV12@XZ @ 0x14015B0AC (-Create@-$CSectionEntry@$0BEAAA@$0BEA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
__int64 __fastcall NSInstrumentation::CTypeIsolation<81920,320>::Allocate(__int64 *a1)
{
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    if ( i == a1 )
    {
      ...
      v11 = NSInstrumentation::CSectionEntry<81920,320>::Create();
      v12 = (_QWORD *)v11;
      if ( v11 )
      {
        v3 = NSInstrumentation::CSectionBitmapAllocator<81920,320>::Allocate(*(_QWORD *)(v11 + 32));
        if ( v3 )
        {
