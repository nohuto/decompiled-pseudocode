/*
 * XREFs of ?EmitSetMatrix43Command@CColorMatrixEffectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022D890
 * Callers:
...
char __fastcall DirectComposition::CColorMatrixEffectMarshaler::EmitSetMatrix43Command(
