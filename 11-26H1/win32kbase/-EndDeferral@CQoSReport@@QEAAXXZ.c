/*
 * XREFs of ?EndDeferral@CQoSReport@@QEAAXXZ @ 0x1401A8070
 * Callers:
 *     ?EndDeferReport@QualityOfService@@YAXXZ @ 0x1401A8030 (-EndDeferReport@QualityOfService@@YAXXZ.c)
 * Callees:
...
LABEL_4:
  ...
  while ( 1 )
  {
    ...
    *v2 = v5;
    ...
    v4[1] = v4;
    *v4 = v4;
    PsProcessWindowState = tagPROCESSINFO::GetPsProcessWindowState(v4 - 140, 0LL);
