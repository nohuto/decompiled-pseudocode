/*
 * XREFs of ??$AllocateAllocator@UtagHID_POINTER_DEVICE_INFO@@@UserTypeIsolationAllocators@@QEAA_NXZ @ 0x1401EB878
 * Callers:
...
bool __fastcall UserTypeIsolationAllocators::AllocateAllocator<tagHID_POINTER_DEVICE_INFO>(__int64 a1)
{
  __int64 Pool2; // rax
  void *v3; // rbx
  ...
  *(_QWORD *)Pool2 = Pool2;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<331776,1296>::Initialize(Pool2) )
  {
