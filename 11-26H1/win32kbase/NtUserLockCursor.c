/*
 * XREFs of NtUserLockCursor @ 0x1401E7A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserLockCursor(void *Src, int a2, int a3)
{
  ...
  v25 = 0LL;
  if ( (unsigned int)ApiSetCheckCursorClipAccess(2LL, 0) )
  {
    if ( Src )
    {
      v24 = 0LL;
      ...
      *(_QWORD *)&v24.left = GuessMonitorOverrideForCoordinateConversions(
      ...
      v24 = v25;
      CCursorClip::LockCursor(v21, &v24);
    }
    else
    {
