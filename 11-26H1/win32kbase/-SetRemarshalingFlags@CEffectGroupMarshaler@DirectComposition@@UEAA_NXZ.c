/*
 * XREFs of ?SetRemarshalingFlags@CEffectGroupMarshaler@DirectComposition@@UEAA_NXZ @ 0x140239240
 * Callers:
 *     <none>
 * Callees:
        ...
        DirectComposition::CEffectGroupMarshaler *this)
{
  ...
  if ( *((_QWORD *)this + 10) )
    *v1 |= 0x400u;
  if ( DirectComposition::CPropertyChangeResourceMarshaler::SetRemarshalingFlags(this) || (*v1 & 0x700) != 0 )
    return 1;
  return v2;
}
