/*
 * XREFs of ?EmitSetMaxAttenuationCutoffCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022DBD8
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetMaxAttenuationCutoffCommand(
