/*
 * XREFs of ?EmitSetMinAttenuationCutoffCommand@CSpotLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022DE38
 * Callers:
...
char __fastcall DirectComposition::CSpotLightMarshaler::EmitSetMinAttenuationCutoffCommand(
