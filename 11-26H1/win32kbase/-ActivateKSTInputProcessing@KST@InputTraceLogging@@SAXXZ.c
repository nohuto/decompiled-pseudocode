/*
 * XREFs of ?ActivateKSTInputProcessing@KST@InputTraceLogging@@SAXXZ @ 0x14019CE00
 * Callers:
...
void InputTraceLogging::KST::ActivateKSTInputProcessing(void)
{
