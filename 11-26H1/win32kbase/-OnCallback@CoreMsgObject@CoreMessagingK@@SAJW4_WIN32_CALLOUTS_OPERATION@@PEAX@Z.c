/*
 * XREFs of ?OnCallback@CoreMsgObject@CoreMessagingK@@SAJW4_WIN32_CALLOUTS_OPERATION@@PEAX@Z @ 0x1400D84B4
 * Callers:
 *     CoreMsgObjectCallout @ 0x1400D83A0 (CoreMsgObjectCallout.c)
 * Callees:
 *     ?Open@CoreMsgObject@CoreMessagingK@@CAJPEAU_WIN32_OPENMETHOD_PARAMETERS@@@Z @ 0x1400D9A08 (-Open@CoreMsgObject@CoreMessagingK@@CAJPEAU_WIN32_OPENMETHOD_PARAMETERS@@@Z.c)
