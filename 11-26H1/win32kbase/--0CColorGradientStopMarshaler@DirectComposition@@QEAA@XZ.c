/*
 * XREFs of ??0CColorGradientStopMarshaler@DirectComposition@@QEAA@XZ @ 0x1400560D4
 * Callers:
...
_QWORD *__fastcall DirectComposition::CColorGradientStopMarshaler::CColorGradientStopMarshaler(
        DirectComposition::CColorGradientStopMarshaler *this)
{
  ...
  result = v1;
  *v1 = &DirectComposition::CColorGradientStopMarshaler::`vftable';
  return result;
}
