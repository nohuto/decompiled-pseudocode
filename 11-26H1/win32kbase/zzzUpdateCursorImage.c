/*
 * XREFs of zzzUpdateCursorImage @ 0x140167748
 * Callers:
...
__int64 (*__fastcall zzzUpdateCursorImage(__int64 a1))(void)
{
  __int64 (*result)(void); // rax

  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 3448LL);
  if ( result )
