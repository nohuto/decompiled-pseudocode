/*
 * XREFs of ?Marshal@?$CMarshaledArray@I$0HAGJEDEE@$0CBC@$0CBD@$0A@@DirectComposition@@QEAA_NPEAPEAVCBatch@2@I@Z @ 0x1402344B4
 * Callers:
...
__int64 __fastcall DirectComposition::CMarshaledArray<unsigned int,1885946692,530,531,0>::Marshal(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
