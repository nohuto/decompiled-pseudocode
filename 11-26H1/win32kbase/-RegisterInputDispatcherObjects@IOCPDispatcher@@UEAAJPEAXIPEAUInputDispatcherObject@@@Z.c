/*
 * XREFs of ?RegisterInputDispatcherObjects@IOCPDispatcher@@UEAAJPEAXIPEAUInputDispatcherObject@@@Z @ 0x14011FD50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputDispatcherObject *a4)
{
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      v9 = 5LL * v12;
      *((_QWORD *)this + v9 + 3) = IOCPDispatcher::SetupIOCPForDispatcherHandle(this, 0LL, *v8, 0x80000000LL, v12);
      ++v7;
