/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0FBAAA@$0FBA@@NSInstrumentation@@IEAA_NXZ @ 0x1401EC338
 * Callers:
...
char __fastcall NSInstrumentation::CTypeIsolation<331776,1296>::Initialize(__int64 a1)
{
  _QWORD *Pool2; // rax
  ...
  *(_QWORD *)(a1 + 16) = Pool2;
  if ( Pool2 )
  {
    *Pool2 = 0LL;
    ...
    {
      v4 = NSInstrumentation::CSectionEntry<331776,1296>::Create();
      if ( v4 )
      {
        v5 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 243;
