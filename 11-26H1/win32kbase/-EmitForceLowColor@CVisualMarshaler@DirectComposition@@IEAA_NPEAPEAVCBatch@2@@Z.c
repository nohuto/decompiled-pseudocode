/*
 * XREFs of ?EmitForceLowColor@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x140101060
 * Callers:
...
char __fastcall DirectComposition::CVisualMarshaler::EmitForceLowColor(
