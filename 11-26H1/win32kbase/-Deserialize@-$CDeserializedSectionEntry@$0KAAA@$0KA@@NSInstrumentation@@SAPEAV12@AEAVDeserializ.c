/*
 * XREFs of ?Deserialize@?$CDeserializedSectionEntry@$0KAAA@$0KA@@NSInstrumentation@@SAPEAV12@AEAVDeserializer@2@@Z @ 0x1401EEA28
 * Callers:
...
_QWORD *__fastcall NSInstrumentation::CDeserializedSectionEntry<40960,160>::Deserialize(
        NSInstrumentation::Deserializer *this)
{
  ...
  v2 = NSInstrumentation::CSectionEntry<40960,160>::Create();
  v3 = v2;
  if ( v2 )
  {
    v4 = (void *)v2[3];
    ...
    Pool2 = (void *)ExAllocatePool2(258LL, 40960LL, 1869834581LL);
    v3[3] = Pool2;
    if ( Pool2 && NSInstrumentation::Deserializer::DeserializeBytes(this, Pool2, 0xA000uLL) )
    {
      v7 = v3 + 4;
      NSInstrumentation::CSectionBitmapAllocator<81920,160>::Destroy((PVOID)v3[4]);
      v8 = NSInstrumentation::CSectionBitmapAllocator<40960,160>::Create(v3[3]);
      v9 = v8;
      if ( v8 )
      {
