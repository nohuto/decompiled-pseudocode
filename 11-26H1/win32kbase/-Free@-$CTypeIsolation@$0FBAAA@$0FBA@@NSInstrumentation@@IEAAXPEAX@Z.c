/*
 * XREFs of ?Free@?$CTypeIsolation@$0FBAAA@$0FBA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1401DE504
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0FBAAA@$0FBA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1401DD7F0 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0FBAAA@$0FBA@@NSInstrumentation@@QEAA-AW4Alloc.c)
...
void __fastcall NSInstrumentation::CTypeIsolation<331776,1296>::Free(__int64 *a1, void *a2)
{
  __int64 *i; // rdi
  _QWORD *v5; // rbp
  int v6; // eax
  ...
  for ( i = (__int64 *)*a1; ; i = (__int64 *)*i )
  {
    ...
    v5 = (_QWORD *)i[4];
    v6 = NSInstrumentation::CSectionBitmapAllocator<331776,1296>::CheckAllocationStatus(v5, (unsigned __int64)a2);
    if ( !v6 )
      continue;
    v7 = v6 - 1;
    if ( !v7 )
  ...
  NSInstrumentation::CSectionBitmapAllocator<331776,1296>::Free((__int64)v5, a2);
  if ( i != (__int64 *)*a1 )
  {
    NSInstrumentation::CAutoReleasableSharedCReaderWriterLock<NSInstrumentation::CPlatformReaderWriterLock>::ReleaseShared((__int64)&v14);
