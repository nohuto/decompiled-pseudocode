/*
 * XREFs of _GetKeyboardLayoutList @ 0x14011C3D8
 * Callers:
...
struct tagKL *__fastcall GetKeyboardLayoutList(__int64 a1, _QWORD *a2)
{
  int v3; // edi
  unsigned int v4; // ebx
  ...
  v3 = a1;
  v4 = 0;
  ProcessWindowStation = (struct tagWINDOWSTATION *)ApiSetEditionGetProcessWindowStation(a1);
