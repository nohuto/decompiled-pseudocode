/*
 * XREFs of ?ReleaseAllReferences@CVisualBitmapMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400A30D0
 * Callers:
 *     ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCVisualBitmapMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1400A3080 (-ReleaseAllReferences@-$CSharedResourceMarshaler@VCVisualBitmapMarshaler@DirectComposition@@$01@.c)
 * Callees:
