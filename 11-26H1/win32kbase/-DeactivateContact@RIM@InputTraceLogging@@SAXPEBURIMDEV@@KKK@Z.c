/*
 * XREFs of ?DeactivateContact@RIM@InputTraceLogging@@SAXPEBURIMDEV@@KKK@Z @ 0x1401312FC
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeactivateContact(const struct RIMDEV *a1, int a2, int a3, int a4)
{
