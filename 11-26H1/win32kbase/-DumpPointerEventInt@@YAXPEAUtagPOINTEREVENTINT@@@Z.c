/*
 * XREFs of ?DumpPointerEventInt@@YAXPEAUtagPOINTEREVENTINT@@@Z @ 0x140076454
 * Callers:
...
void __fastcall DumpPointerEventInt(struct tagPOINTEREVENTINT *a1, int a2, int a3)
{
  bool v4; // di
  bool v5; // si
  __int64 v6; // rax
  ...
  if ( (*((_DWORD *)a1 + 5) & 0x80000) != 0 )
  {
    ...
    {
      v61 = W32GetUserSessionState((_DWORD)WPP_GLOBAL_Control, a2, a3);
      LOBYTE(v62) = v60;
      LOBYTE(v63) = v59;
      WPP_RECORDER_AND_TRACE_SF_s(
        *((_QWORD *)WPP_GLOBAL_Control + 3),
