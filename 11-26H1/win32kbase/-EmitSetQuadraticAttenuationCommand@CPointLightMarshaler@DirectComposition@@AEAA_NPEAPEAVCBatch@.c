/*
 * XREFs of ?EmitSetQuadraticAttenuationCommand@CPointLightMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x14022E75C
 * Callers:
...
char __fastcall DirectComposition::CPointLightMarshaler::EmitSetQuadraticAttenuationCommand(
