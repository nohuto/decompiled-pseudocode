/*
 * XREFs of ?SetReferenceProperty@CAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@UDCOMPOSITION_PROPERTY_ID@@PEAVCResourceMarshaler@2@PEA_N@Z @ 0x14023C520
 * Callers:
 *     <none>
 * Callees:
        ...
        _BYTE *a5)
{
  ...
  if ( !a3 )
    return DirectComposition::CResourceMarshaler::SetReferencePropertyHelper(
             ...
             1,
             a5);
  if ( a3 != 7 || *(_QWORD *)(a1 + 128) || *(_QWORD *)(a1 + 96) )
    return 3221225485LL;
  return DirectComposition::CResourceMarshaler::SetReferencePropertyHelper(
           a1,
           a2,
           (struct DirectComposition::CResourceMarshaler **)(a1 + 128),
           a4,
           0,
           72,
           (int *)(a1 + 16),
