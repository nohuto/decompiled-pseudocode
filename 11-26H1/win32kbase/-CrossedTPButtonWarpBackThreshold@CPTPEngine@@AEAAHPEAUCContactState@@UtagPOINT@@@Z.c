/*
 * XREFs of ?CrossedTPButtonWarpBackThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@@Z @ 0x140226D90
 * Callers:
        ...
        struct tagPOINT a3)
{
  return (*((_DWORD *)this + 821) & 0x200) == 0
       ...
       * (int)((*((_QWORD *)a2 + 6) - a3.x) * (*((_QWORD *)a2 + 6) - a3.x)) >= *((unsigned int *)this + 779)
