/*
 * XREFs of McTemplateK0qzppq_EtwWriteTransfer @ 0x1401027E0
 * Callers:
...
NTSTATUS McTemplateK0qzppq_EtwWriteTransfer(_DWORD a1, _DWORD a2, _DWORD a3, int a4, const wchar_t *a5, char a6, ...)
{
  ...
  v13 = v6;
  v21 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v6, &AuditApiSetWindowsHookEx, &W32kControlGuid, 6u, &v10);
}
