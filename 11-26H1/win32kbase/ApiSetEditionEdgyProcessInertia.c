/*
 * XREFs of ApiSetEditionEdgyProcessInertia @ 0x1401C1B14
 * Callers:
...
__int64 (*__fastcall ApiSetEditionEdgyProcessInertia(__int64 a1))(void)
{
  ...
  result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(a1) + 48) + 6272LL);
  if ( result )
  {
    result = (__int64 (*)(void))result();
    if ( (int)result >= 0 )
    {
      result = *(__int64 (**)(void))(*(_QWORD *)(W32GetWin32kBaseApiSetTable(v3) + 48) + 6280LL);
      if ( result )
