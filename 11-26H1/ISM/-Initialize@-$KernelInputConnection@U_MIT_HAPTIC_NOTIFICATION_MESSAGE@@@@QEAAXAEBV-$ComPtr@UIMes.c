/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_HAPTIC_NOTIFICATION_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_HAPTIC_NOTIFICATION_MESSAGE@@@Z@std@@@Z @ 0x1800F1B88
 * Callers:
...
__int64 __fastcall KernelInputConnection<_MIT_HAPTIC_NOTIFICATION_MESSAGE>::Initialize(
        _QWORD *a1,
        wil::details **a2,
        __int64 a3,
        __int64 a4)
  ...
  *((_DWORD *)a1 + 34) = 22;
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
      ...
      v17);
    v23 = (_DWORD)a1 + 16;
    v18 = v16(v15, KernelInputConnection<_MIT_HAPTIC_NOTIFICATION_MESSAGE>::s_OnKernelInputEventStatic, a1, *a1);
    if ( v18 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x43,
    ...
    if ( v19 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v23);
    v20 = NtMITCoreMsgKOpenConnectionTo(22LL, a1 + 3);
    if ( v20 < 0 )
