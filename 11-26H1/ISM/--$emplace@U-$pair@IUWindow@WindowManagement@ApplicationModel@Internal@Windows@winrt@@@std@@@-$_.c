...
LABEL_2:
    ...
    v20[0] = a1 + 2;
    v10 = std::_Allocate<16,std::_Default_allocate_traits>(32LL);
    v20[1] = v10;
    ...
    *(_QWORD *)(v10 + 24) = v11;
    ...
    if ( (float)(v13 / v15) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<unsigned int,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView>>,0>>::_Forced_rehash(
        a1,
        v19);
      v9 = *(_QWORD *)((__int64 (__fastcall *)(float *, _QWORD *, __int64, __int64))std::_Hash<std::_Umap_traits<unsigned int,winrt::Windows::Internal::ApplicationModel::WindowManagement::Window,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,winrt::Windows::Internal::ApplicationModel::WindowManagement::Window>>,0>>::_Find_last<unsigned int>)(
                        a1,
                        v20,
                        v10 + 16,
                        v6);
  ...
  {
    v17 = *(_QWORD *)(v7 + 16 * (v6 & *((_QWORD *)a1 + 6)));
