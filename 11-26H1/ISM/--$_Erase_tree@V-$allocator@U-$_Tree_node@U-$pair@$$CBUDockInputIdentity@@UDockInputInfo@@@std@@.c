 ...
 *     ??1?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UDockInputInfo@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UDockInputInfo@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x180182ED8 (--1-$_Tree@V-$_Tmap_traits@UDockInputIdentity@@UDockInputInfo@@U-$less@UDockInputIdentity@@@std@.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( !*(_BYTE *)(a3 + 25) )
  {
    do
    {
      ...
      v6 = v3;
      v3 = (_QWORD *)*v3;
      std::_Deallocate<16>(v6, (struct std::nothrow_t *)0x90);
    }
    while ( !*((_BYTE *)v3 + 25) );
  }
}
