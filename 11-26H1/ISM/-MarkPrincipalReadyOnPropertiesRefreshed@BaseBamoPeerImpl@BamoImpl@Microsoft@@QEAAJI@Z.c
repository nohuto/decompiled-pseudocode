/*
 * XREFs of ?MarkPrincipalReadyOnPropertiesRefreshed@BaseBamoPeerImpl@BamoImpl@Microsoft@@QEAAJI@Z @ 0x1800B716C
 * Callers:
 *     ?Thunk_MarkPrincipalReadyOnPropertiesRefreshed_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B9020 (-Thunk_MarkPrincipalReadyOnPropertiesRefreshed_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPee.c)
 * Callees:
