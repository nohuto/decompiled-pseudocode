/*
 * XREFs of ?LogSendTailButtonEventsEnabledChanged@BamoPenEventsClientProxyImpl@BamoImpl@@AEAAX_N@Z @ 0x18019983C
 * Callers:
...
void __fastcall BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonEventsEnabledChanged(
