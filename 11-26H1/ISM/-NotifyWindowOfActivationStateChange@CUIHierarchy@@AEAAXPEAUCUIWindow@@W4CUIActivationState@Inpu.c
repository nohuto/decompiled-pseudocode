/*
 * XREFs of ?NotifyWindowOfActivationStateChange@CUIHierarchy@@AEAAXPEAUCUIWindow@@W4CUIActivationState@Input@Internal@UI@Windows@@_K@Z @ 0x1800A83D8
 * Callers:
 *     ?PropagateActivationState@CUIHierarchy@@AEAA_NPEAUCUIWindow@@0_N@Z @ 0x1800A8CA4 (-PropagateActivationState@CUIHierarchy@@AEAA_NPEAUCUIWindow@@0_N@Z.c)
 * Callees:
...
void __fastcall CUIHierarchy::NotifyWindowOfActivationStateChange(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  if ( v16 != *(_BYTE *)(a2 + 49) )
  {
    *(_BYTE *)(a2 + 49) = v16;
    ...
    std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,ControllerProcessor *>>>>>>::~_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,ControllerProcessor *>>>>>>(v23);
  }
}
