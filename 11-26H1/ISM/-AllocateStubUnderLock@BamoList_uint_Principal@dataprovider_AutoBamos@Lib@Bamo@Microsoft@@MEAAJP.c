/*
 * XREFs of ?AllocateStubUnderLock@BamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_uint_Stub@2345@@Z @ 0x180102940
 * Callers:
 *     <none>
 * Callees:
