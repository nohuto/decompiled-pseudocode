/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoResizeContextualProcessorStubImpl@BamoImpl@@UEAAJXZ @ 0x180069040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoResizeContextualProcessorStubImpl::InitializeProxyUnderLockThunk(
