/*
 * XREFs of ?QueryInterface@BamoSystemContextEndpointProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143E70
 * Callers:
 *     ?QueryInterface@BamoSystemContextEndpointProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143EF0 (-QueryInterface@BamoSystemContextEndpointProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoSystemContextEndpointProxy *)-8LL )
    return (unsigned int)-2147467262;
