/*
 * XREFs of ?LogOnEventSubscriptionsChanging@BamoMPCInputObjectProxy@@AEAAXI@Z @ 0x18011AD34
 * Callers:
...
void __fastcall BamoMPCInputObjectProxy::LogOnEventSubscriptionsChanging(BamoMPCInputObjectProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
