/*
 * XREFs of ?UpdateVisualReferenceId@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18017C3F8
 * Callers:
 *     ?Thunk_UpdateVisualReferenceId_0@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017B850 (-Thunk_UpdateVisualReferenceId_0@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNav.c)
