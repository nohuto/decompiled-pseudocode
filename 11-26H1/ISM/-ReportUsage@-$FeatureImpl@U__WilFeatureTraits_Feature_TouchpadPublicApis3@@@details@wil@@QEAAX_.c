/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TouchpadPublicApis3@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18015D3D4
 * Callers:
        ...
        ...)
{
  ...
  v4 = a2;
  LODWORD(v5) = *(_DWORD *)Feature_TouchpadPublicApis3__descriptor;
  if ( (*(_DWORD *)Feature_TouchpadPublicApis3__descriptor & 4) == 0 )
  {
    v5 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_TouchpadPublicApis3>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v6);
    v6 = v5;
  }
