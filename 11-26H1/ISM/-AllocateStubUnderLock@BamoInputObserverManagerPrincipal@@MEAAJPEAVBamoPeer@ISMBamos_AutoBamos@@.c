/*
 * XREFs of ?AllocateStubUnderLock@BamoInputObserverManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputObserverManagerStub@@@Z @ 0x18006E470
 * Callers:
 *     <none>
 * Callees:
