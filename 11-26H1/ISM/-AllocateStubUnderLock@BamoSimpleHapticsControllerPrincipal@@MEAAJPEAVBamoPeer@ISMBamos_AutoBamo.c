/*
 * XREFs of ?AllocateStubUnderLock@BamoSimpleHapticsControllerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSimpleHapticsControllerStub@@@Z @ 0x180188B40
 * Callers:
 *     <none>
 * Callees:
