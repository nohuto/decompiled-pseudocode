/*
 * XREFs of ?CheckForTwoFingerTap@MagnifierRecognizer@@AEAAXXZ @ 0x1801B2EA8
 * Callers:
...
LABEL_17:
  ...
  while ( *((_BYTE *)v5 + 25) == v1 )
  {
    if ( (int)((v5[6] - v5[5]) * (v5[6] - v5[5]) + (HIDWORD(v5[6]) - HIDWORD(v5[5])) * (HIDWORD(v5[6]) - HIDWORD(v5[5]))) >= (unsigned __int64)(unsigned int)(*((_DWORD *)v2 + 13) * *((_DWORD *)v2 + 13)) )
      goto LABEL_17;
    std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned short const,enum WaveformFlags>>>,std::_Iterator_base0>::operator++(&v7);
    v5 = v7;
  }
}
