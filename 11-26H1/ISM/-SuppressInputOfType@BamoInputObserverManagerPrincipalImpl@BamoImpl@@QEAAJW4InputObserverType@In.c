/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x18013B6C0
 * Callers:
 *     ?Thunk_SuppressInputOfType_264@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013B8A0 (-Thunk_SuppressInputOfType_264@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
