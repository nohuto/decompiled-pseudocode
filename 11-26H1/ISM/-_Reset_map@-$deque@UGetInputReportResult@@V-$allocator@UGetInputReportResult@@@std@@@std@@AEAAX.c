/*
 * XREFs of ?_Reset_map@?$deque@UGetInputReportResult@@V?$allocator@UGetInputReportResult@@@std@@@std@@AEAAXXZ @ 0x1800DD5D0
 * Callers:
...
void __fastcall std::deque<GetInputReportResult>::_Reset_map(__int64 a1)
{
  _QWORD *v1; // rsi
  __int64 v3; // rdi
  void **v4; // rbx
