/*
 * XREFs of ??$CreateServer@VInputSystemServerConnection@@@BaseBamoConnection@Bamo@Microsoft@@SAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBGPEAPEAVInputSystemServerConnection@@@Z @ 0x180095A68
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  *v9 = &InputSystemServerConnection::`vftable';
  ...
  v10 = Microsoft::Bamo::BaseBamoConnection::JoinConversationAsServer(
          ...
          a2,
          &v13,
          (__int64)L"System\\InputSystemConversation");
  v11 = v10;
  if ( v10 >= 0 )
  {
    v15 = 0LL;
