/*
 * XREFs of ?DockableDeviceAttached@DeviceDock@InputTraceLogging@@SAXKAEBUDockableDeviceInfo@@@Z @ 0x1800DDF3C
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::DockableDeviceAttached(int a1, const struct DockableDeviceInfo *a2)
{
  ...
  if ( *(_DWORD *)v4 > 4u && tlgKeywordOn((__int64)v4, 512LL) )
  {
    ...
    v16 = 8LL;
    v14 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v5, byte_180215F5B, 0LL, 0LL, 7u, &v12);
  }
}
