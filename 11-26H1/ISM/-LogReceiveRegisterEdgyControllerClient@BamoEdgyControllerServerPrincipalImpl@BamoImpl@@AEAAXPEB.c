/*
 * XREFs of ?LogReceiveRegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@AEAAXPEBGPEAVBamoEdgyControllerClientProxy@@@Z @ 0x18015ABEC
 * Callers:
...
void __fastcall BamoImpl::BamoEdgyControllerServerPrincipalImpl::LogReceiveRegisterEdgyControllerClient(
        BamoImpl::BamoEdgyControllerServerPrincipalImpl *this,
        const unsigned __int16 *a2,
        struct BamoEdgyControllerClientProxy *a3)
{
  __int64 v3; // rbx
  __int64 v4; // r8
  int v5; // r9d
    ...
    && tlgKeywordOn((__int64)*(&ISMBamos_AutoBamos::BamoTraceLogging::s_providers + 1), 1LL) )
  {
    ...
    ItemId = Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_ActivatableEntityPrincipal_Principal::GetItemId((struct Microsoft::BamoImpl::ConnectionIndirector **)(v8 - 16));
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapSz<unsigned short>,_tlgWrapperByVal<4>>(
      v3,
      (__int64)&unk_180224E68,
      v9,
      v10,
      (__int64)&ItemId,
      (__int64)&v11,
