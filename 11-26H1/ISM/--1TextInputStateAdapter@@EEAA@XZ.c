/*
 * XREFs of ??1TextInputStateAdapter@@EEAA@XZ @ 0x1801D2258
 * Callers:
 ...
 *     ?Release@?$RefPtr@UIRemoteTextInputState@@@@QEAAXXZ @ 0x1801D3A20 (-Release@-$RefPtr@UIRemoteTextInputState@@@@QEAAXXZ.c)
 */
