/*
 * XREFs of ??1RawButtonProcessor@@UEAA@XZ @ 0x1801B6F88
 * Callers:
 ...
 *     ??1PrivateMessageSession@RawButtonProcessor@@QEAA@XZ @ 0x1801B6EE0 (--1PrivateMessageSession@RawButtonProcessor@@QEAA@XZ.c)
 */
