/*
 * XREFs of ?Thunk_Materialize_BamoLightDismissClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128E80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
