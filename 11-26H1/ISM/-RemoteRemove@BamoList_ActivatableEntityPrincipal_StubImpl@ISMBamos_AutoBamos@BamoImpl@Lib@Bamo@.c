/*
 * XREFs of ?RemoteRemove@BamoList_ActivatableEntityPrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJI@Z @ 0x180037C24
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v12 )
      Microsoft::BamoImpl::BaseBamoConnectionImpl::TrackError(
        *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(v12 + 16) + 32LL),
        -2018375660,
        0);
    v14 = 46255LL;
  }
