/*
 * XREFs of ?StopFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJXZ @ 0x180128860
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSimpleHapticsControllerProxyImpl::StopFeedback(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      BamoImpl::BamoSimpleHapticsControllerProxyImpl::LogSendStopFeedback(this);
      v11[0] = v13;
      v11[1] = v14;
