/*
 * XREFs of ?GetBamoDataSourceStub@AnimationDataProvider@@UEBA?AV?$ComPtr@VBamoDataSourceStub@@@WRL@Microsoft@@V?$ComPtr@VDataSourcePrincipal@@@34@@Z @ 0x18006B3F0
 * Callers:
 *     <none>
 * Callees:
...
{
  struct Microsoft::Bamo::BaseBamoPeer *v5; // rdi
  __int64 v6; // rbx
  bool v7; // r8
  ...
  *a2 = 0LL;
  v5 = *(struct Microsoft::Bamo::BaseBamoPeer **)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 32LL) + 16LL);
  v6 = *a3;
  ...
  Stub = Microsoft::BamoImpl::BamoPrincipalImpl::GetStub((Microsoft::BamoImpl::BamoPrincipalImpl *)(v6 + 16), v5, v7);
