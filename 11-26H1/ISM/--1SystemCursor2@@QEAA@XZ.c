/*
 * XREFs of ??1SystemCursor2@@QEAA@XZ @ 0x1800FA9CC
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VSystemCursor2@@@std@@EEAAXXZ @ 0x1800FD170 (-_Destroy@-$_Ref_count_obj2@VSystemCursor2@@@std@@EEAAXXZ.c)
 * Callees:
