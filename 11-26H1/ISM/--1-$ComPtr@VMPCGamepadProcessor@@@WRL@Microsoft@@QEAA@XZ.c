/*
 * XREFs of ??1?$ComPtr@VMPCGamepadProcessor@@@WRL@Microsoft@@QEAA@XZ @ 0x1801C2FD4
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_MPCGamepadProcessor_IInputProcessor_InputProcessorCreateParams___&__::_1_::dtor$2 @ 0x1801DD51F (_Microsoft--WRL--Details--MakeAndInitialize_MPCGamepadProcessor_IInputProcessor_InputProcessorCr.c)
 * Callees:
