/*
 * XREFs of ?SetCursorShellMagnification@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_KM@Z @ 0x1800F9620
 * Callers:
 *     ?Thunk_SetCursorShellMagnification_390@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F9AB0 (-Thunk_SetCursorShellMagnification_390@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
