/*
 * XREFs of ??$?0V?$tuple@AEB_K@std@@V?$tuple@$$V@1@$0A@$$Z$S@?$pair@$$CB_KV?$shared_ptr@VGestureHandler@@@std@@@std@@AEAA@AEAV?$tuple@AEB_K@1@AEAV?$tuple@$$V@1@U?$integer_sequence@_K$0A@@1@U?$integer_sequence@_K$S@1@@Z @ 0x1800F9CB0
 * Callers:
...
_QWORD *__fastcall ____0V__tuple_AEB_K_std__V__tuple___V_1__0A___Z_S___pair___CB_KV__shared_ptr_VGestureHandler___std___std__AEAA_AEAV__tuple_AEB_K_1_AEAV__tuple___V_1_U__integer_sequence__K_0A__1_U__integer_sequence__K_S_1__Z(
        _QWORD *a1,
        _QWORD **a2)
{
  _QWORD *result; // rax
