/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ClickToDoPenEdgy@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18015D344
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoPenEdgy>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  v4 = a2;
  LODWORD(v5) = *(_DWORD *)Feature_ClickToDoPenEdgy__descriptor;
  if ( (*(_DWORD *)Feature_ClickToDoPenEdgy__descriptor & 4) == 0 )
  {
    v5 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_ClickToDoPenEdgy>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v6);
    v6 = v5;
  }
