/*
 * XREFs of ?Materialize_BamoInputSiteManagerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180120D84
 * Callers:
 *     ?Thunk_Materialize_BamoInputSiteManagerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128E50 (-Thunk_Materialize_BamoInputSiteManagerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
