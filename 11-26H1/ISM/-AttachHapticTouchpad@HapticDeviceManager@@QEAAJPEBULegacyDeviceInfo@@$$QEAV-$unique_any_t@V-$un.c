...
__int64 __fastcall HapticDeviceManager::AttachHapticTouchpad(__int64 a1, __int64 a2)
{
  void *v3; // rbx
  struct ISMBamos_AutoBamos::BamoConnection *BamoServerConnection; // rax
  TouchpadHapticDevice *v5; // rax
  __int64 v6; // rbx
  int v7; // eax
  unsigned int v8; // edi
  int v10; // eax
  ...
  _QWORD *v14; // [rsp+70h] [rbp+40h] BYREF
  TouchpadHapticDevice *v15; // [rsp+78h] [rbp+48h] BYREF
  ...
  wil::com_ptr_t<BamoSimpleHapticsControllerPrincipal,wil::err_returncode_policy>::com_ptr_t<BamoSimpleHapticsControllerPrincipal,wil::err_returncode_policy>(
    &v14,
    *(void (__fastcall ****)(_QWORD))(a1 + 64));
  v3 = operator new(0x270uLL);
  v13 = v3;
  BamoServerConnection = ISMStatics::GetBamoServerConnection();
  v5 = TouchpadHapticDevice::TouchpadHapticDevice(
         (TouchpadHapticDevice *)v3,
         BamoServerConnection,
         (const struct LegacyDeviceInfo *)a2);
  v6 = (__int64)v5;
  v15 = v5;
  if ( v5 )
    (**(void (__fastcall ***)(TouchpadHapticDevice *))v5)(v5);
  v7 = TouchpadHapticDevice::Initialize(v6);
  v8 = v7;
  if ( v7 >= 0 )
  {
    ...
    {
      v13 = 0LL;
      tip2::tip_test<tip2::details::merged_data<_tip_HapticTouchpadAttachedTipTest_attributes,tip2::test_data_basic>>::start(
        &v13,
        v11);
      if ( v13 )
        tip2::details::shared_data<0,0,1>::complete_without_lock((__int64)v13 + 8);
      wil::com_ptr_t<tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>,wil::err_returncode_policy>::~com_ptr_t<tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>,wil::err_returncode_policy>(&v13);
    }
    InputTraceLogging::Haptics::HapticDeviceAdded(
      (enum tagINPUT_MESSAGE_DEVICE_TYPE)16,
      (const unsigned __int16 *)(a2 + 76));
    ...
    wil::com_ptr_t<Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerPrincipal_Principal,wil::err_returncode_policy>::~com_ptr_t<Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerPrincipal_Principal,wil::err_returncode_policy>((__int64 *)&v14);
    return 0LL;
  }
  else
  {
