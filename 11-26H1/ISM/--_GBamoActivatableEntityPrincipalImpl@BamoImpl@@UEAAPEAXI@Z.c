/*
 * XREFs of ??_GBamoActivatableEntityPrincipalImpl@BamoImpl@@UEAAPEAXI@Z @ 0x1800B05C0
 * Callers:
 *     <none>
 * Callees:
...
volatile signed __int32 **__fastcall BamoImpl::BamoActivatableEntityPrincipalImpl::`scalar deleting destructor'(
