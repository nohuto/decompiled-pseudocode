/*
 * XREFs of ??$_Construct@$0A@D@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXD_K@Z @ 0x1800C4938
 * Callers:
...
void *__fastcall std::string::_Construct<0,char>(_QWORD *a1, __int64 a2, size_t a3)
{
  ...
  if ( a3 > 0xF )
  {
    ...
    v7 = std::_Allocate<16,std::_Default_allocate_traits>(v6 + 1);
    *a1 = v7;
    a1[2] = a3;
    a1[3] = v6;
    v8 = v7;
