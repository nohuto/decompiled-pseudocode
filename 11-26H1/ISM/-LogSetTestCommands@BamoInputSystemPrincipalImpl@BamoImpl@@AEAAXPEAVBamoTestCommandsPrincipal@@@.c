/*
 * XREFs of ?LogSetTestCommands@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoTestCommandsPrincipal@@@Z @ 0x18013121C
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetTestCommands(
