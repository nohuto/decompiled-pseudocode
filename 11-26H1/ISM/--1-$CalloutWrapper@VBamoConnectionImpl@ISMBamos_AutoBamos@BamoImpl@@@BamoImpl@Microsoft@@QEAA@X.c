/*
 * XREFs of ??1?$CalloutWrapper@VBamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x1800383AC
 * Callers:
 ...
 *     ?SetBootstrapProxyCallout@BamoConnection@ISMBamos_AutoBamos@@EEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x180127C60 (-SetBootstrapProxyCallout@BamoConnection@ISMBamos_AutoBamos@@EEAAJPEAVBamoProxy@Bamo@Microsoft@@.c)
 *     _BamoImpl::ISMBamos_AutoBamos::BamoConnectionImpl::OnPeerRequestsConnectThunk_::_1_::dtor$0 @ 0x1801D642B (_BamoImpl--ISMBamos_AutoBamos--BamoConnectionImpl--OnPeerRequestsConnectThunk_--_1_--dtor$0.c)
 *     _ISMBamos_AutoBamos::BamoConnection::SetBootstrapProxyCallout_::_1_::dtor$0 @ 0x1801D643D (_ISMBamos_AutoBamos--BamoConnection--SetBootstrapProxyCallout_--_1_--dtor$0.c)
 * Callees:
