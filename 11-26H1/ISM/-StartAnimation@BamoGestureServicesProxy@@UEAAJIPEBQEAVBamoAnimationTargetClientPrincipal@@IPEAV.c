/*
 * XREFs of ?StartAnimation@BamoGestureServicesProxy@@UEAAJIPEBQEAVBamoAnimationTargetClientPrincipal@@IPEAVBamoDragManagerClientPrincipal@@W4GestureProcessorType@@@Z @ 0x180128350
 * Callers:
 *     <none>
 * Callees:
