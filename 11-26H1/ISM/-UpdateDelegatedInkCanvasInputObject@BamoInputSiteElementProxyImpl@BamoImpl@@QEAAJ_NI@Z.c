/*
 * XREFs of ?UpdateDelegatedInkCanvasInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003A2C4
 * Callers:
 *     ?Thunk_UpdateDelegatedInkCanvasInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003A2B0 (-Thunk_UpdateDelegatedInkCanvasInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
...
__int64 __fastcall BamoImpl::BamoInputSiteElementProxyImpl::UpdateDelegatedInkCanvasInputObject(
        ...
        unsigned int a3)
{
  ...
  struct BamoDelegatedInkCanvasInputObjectProxy *v7; // rsi
  __int64 v8; // rbx
  int v10; // eax
  int v11; // eax
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnDelegatedInkCanvasInputObjectChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1);
      v11 = (*(__int64 (__fastcall **)(char *, struct BamoDelegatedInkCanvasInputObjectProxy *))(*((_QWORD *)this - 2)
                                                                                               + 312LL))(
              (char *)this - 16,
              v7);
      if ( v11 < 0 )
    ...
    *((_QWORD *)this + 17) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoDelegatedInkCanvasInputObjectProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnDelegatedInkCanvasInputObjectChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        (__int64)v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        (void (__fastcall ***)(_QWORD))this,
        2);
      v10 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 320LL))((char *)this - 16);
      if ( v10 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x2A3D,
