/*
 * XREFs of ??_GHidLampMultiUpdateReportParser@@UEAAPEAXI@Z @ 0x1800EEFE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1HidLampMultiUpdateReportParser@@UEAA@XZ @ 0x1800EEE4C (--1HidLampMultiUpdateReportParser@@UEAA@XZ.c)
 */
