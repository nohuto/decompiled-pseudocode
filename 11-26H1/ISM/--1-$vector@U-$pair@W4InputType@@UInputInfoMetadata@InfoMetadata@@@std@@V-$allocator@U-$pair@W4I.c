/*
 * XREFs of ??1?$vector@U?$pair@W4InputType@@UInputInfoMetadata@InfoMetadata@@@std@@V?$allocator@U?$pair@W4InputType@@UInputInfoMetadata@InfoMetadata@@@std@@@2@@std@@QEAA@XZ @ 0x1801A818C
 * Callers:
 *     _InfoMetadata::InfoMetadata_::_1_::dtor$0 @ 0x1801D73AC (_InfoMetadata--InfoMetadata_--_1_--dtor$0.c)
 * Callees:
        ...
        __int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    std::_Deallocate<16>(
      *(void **)a1,
      (struct std::nothrow_t *)(392 * ((*(_QWORD *)(a1 + 16) - *(_QWORD *)a1) / 392LL)));
    *(_QWORD *)a1 = 0LL;
    *(_QWORD *)(a1 + 8) = 0LL;
    *(_QWORD *)(a1 + 16) = 0LL;
  }
