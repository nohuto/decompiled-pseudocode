/*
 * XREFs of ?StartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x180152A64
 * Callers:
 *     ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180152C60 (-Thunk_StartResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcess.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  BamoImpl::BamoResizeContextualProcessorPrincipalImpl::LogReceiveStartResize(this, a2, v11);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v9,
      (__int64)this);
    v18 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, struct BamoResizeControllerClientProxy *))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v22,
            a2,
            v11);
