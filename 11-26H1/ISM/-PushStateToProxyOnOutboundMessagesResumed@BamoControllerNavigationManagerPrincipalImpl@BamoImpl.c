/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180179BC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PushStateToProxy@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180050800 (-PushStateToProxy@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAXPEAVBamoStubImpl@2.c)
