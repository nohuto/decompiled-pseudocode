/*
 * XREFs of ?LogSendTipToGlass@BamoPenEventsClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x18019992C
 * Callers:
...
void __fastcall BamoImpl::BamoPenEventsClientProxyImpl::LogSendTipToGlass(BamoImpl::BamoPenEventsClientProxyImpl *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
