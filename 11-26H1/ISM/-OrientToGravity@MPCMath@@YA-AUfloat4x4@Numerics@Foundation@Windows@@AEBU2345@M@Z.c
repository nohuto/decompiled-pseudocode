/*
 * XREFs of ?OrientToGravity@MPCMath@@YA?AUfloat4x4@Numerics@Foundation@Windows@@AEBU2345@M@Z @ 0x1801C44BC
 * Callers:
 ...
 *     ?XMMatrixMultiply@DirectX@@YQ?AUXMMATRIX@1@U21@AEBU21@@Z @ 0x1801C57C0 (-XMMatrixMultiply@DirectX@@YQ-AUXMMATRIX@1@U21@AEBU21@@Z.c)
 */
...
__int128 *__fastcall MPCMath::OrientToGravity(__int128 *a1, float *a2, float a3)
{
  ...
  *(float *)&v44[40] = v8;
  v45[2] = *(_OWORD *)&v44[32];
  v40 = a1[1];
  *(double *)&v39 = DirectX::XMMatrixMultiply(v7, v45);
  *a1 = v39;
  result = a1;
  a1[1] = v40;
  a1[2] = v37;
