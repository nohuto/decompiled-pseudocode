/*
 * XREFs of ?LogSendOnForegroundTransferFromHost@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@AEAAXAEBUTransferForegroundInfo@@@Z @ 0x180134E4C
 * Callers:
...
void __fastcall BamoImpl::BamoCUIComponentInputObjectProxyImpl::LogSendOnForegroundTransferFromHost(
