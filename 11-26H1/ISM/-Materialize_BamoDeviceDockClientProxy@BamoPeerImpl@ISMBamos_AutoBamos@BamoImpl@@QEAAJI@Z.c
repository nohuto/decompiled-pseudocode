/*
 * XREFs of ?Materialize_BamoDeviceDockClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011FA48
 * Callers:
 *     ?Thunk_Materialize_BamoDeviceDockClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128CB0 (-Thunk_Materialize_BamoDeviceDockClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoDeviceDockClientProxy *v14; // [rsp+60h] [rbp+8h] BYREF
  ...
  v5 = CreateDeviceDockClientProxy(v4, &v14);
  if ( v5 < 0 )
  ...
  if ( !v14 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v6);
  v7 = (*(__int64 (__fastcall **)(struct BamoDeviceDockClientProxy *))(*(_QWORD *)v14 + 56LL))(v14);
