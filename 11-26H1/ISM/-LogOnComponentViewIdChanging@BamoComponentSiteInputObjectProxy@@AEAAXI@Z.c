/*
 * XREFs of ?LogOnComponentViewIdChanging@BamoComponentSiteInputObjectProxy@@AEAAXI@Z @ 0x18011A140
 * Callers:
...
void __fastcall BamoComponentSiteInputObjectProxy::LogOnComponentViewIdChanging(
