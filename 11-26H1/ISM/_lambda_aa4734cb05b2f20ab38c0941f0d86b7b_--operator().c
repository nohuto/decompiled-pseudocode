/*
 * XREFs of _lambda_aa4734cb05b2f20ab38c0941f0d86b7b_::operator() @ 0x1801C3078
 * Callers:
        ...
        const char *a4)
{
  ...
  _BYTE v13[8]; // [rsp+C0h] [rbp-40h] BYREF
  _BYTE v14[32]; // [rsp+C8h] [rbp-38h] BYREF
  _BYTE v15[8]; // [rsp+E8h] [rbp-18h] BYREF
  _BYTE v16[32]; // [rsp+F0h] [rbp-10h] BYREF
  _BYTE v17[8]; // [rsp+110h] [rbp+10h] BYREF
  ...
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    ...
    v7);
  v7[0] = 1088421888;
  std::wstring::wstring((__int64)v12, (__int64)L"ScrollingScale");
  std::variant<unsigned long,bool,float>::variant<unsigned long,bool,float>((__int64)v13, v7);
  v7[0] = 1022739087;
  std::wstring::wstring((__int64)v14, (__int64)L"ZoomingScale");
  std::variant<unsigned long,bool,float>::variant<unsigned long,bool,float>((__int64)v15, v7);
  v7[0] = 1025087898;
  std::wstring::wstring((__int64)v16, (__int64)L"PointScaleFactor");
  std::variant<unsigned long,bool,float>::variant<unsigned long,bool,float>((__int64)v17, v7);
  v7[0] = 1097859072;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v18,
