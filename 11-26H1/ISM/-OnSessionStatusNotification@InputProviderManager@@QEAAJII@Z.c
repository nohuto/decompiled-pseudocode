/*
 * XREFs of ?OnSessionStatusNotification@InputProviderManager@@QEAAJII@Z @ 0x18005E968
 * Callers:
 *     ?OnSessionStatusNotification@OneCoreUAPInputHost@@UEAAJII@Z @ 0x1800A1CB0 (-OnSessionStatusNotification@OneCoreUAPInputHost@@UEAAJII@Z.c)
 * Callees:
