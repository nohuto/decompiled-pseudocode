/*
 * XREFs of ??1?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x1801CEF48
 * Callers:
 *     _HotKeyProcessor::FindRegisteredHotKey_::_1_::dtor$1 @ 0x1801DD8F4 (_HotKeyProcessor--FindRegisteredHotKey_--_1_--dtor$1.c)
 *     _HotKeyProcessor::RegisterHotKey_::_1_::dtor$1 @ 0x1801DD92A (_HotKeyProcessor--RegisterHotKey_--_1_--dtor$1.c)
 * Callees:
