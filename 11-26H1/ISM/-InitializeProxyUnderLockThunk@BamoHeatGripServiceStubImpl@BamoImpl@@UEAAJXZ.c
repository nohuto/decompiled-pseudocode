/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoHeatGripServiceStubImpl@BamoImpl@@UEAAJXZ @ 0x180076300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoHeatGripServiceStubImpl::InitializeProxyUnderLockThunk(
