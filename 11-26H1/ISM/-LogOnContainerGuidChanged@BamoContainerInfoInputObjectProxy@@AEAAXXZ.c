/*
 * XREFs of ?LogOnContainerGuidChanged@BamoContainerInfoInputObjectProxy@@AEAAXXZ @ 0x18011A1A4
 * Callers:
...
void __fastcall BamoContainerInfoInputObjectProxy::LogOnContainerGuidChanged(BamoContainerInfoInputObjectProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
