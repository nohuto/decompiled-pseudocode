/*
 * XREFs of ?UpdateType@BamoResizeControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x1801305FC
 * Callers:
 *     ?Thunk_UpdateType_47@?$IResizeControllerClientProxy_Receive@VBamoResizeControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129910 (-Thunk_UpdateType_47@-$IResizeControllerClientProxy_Receive@VBamoResizeControllerClientProxyImpl.c)
