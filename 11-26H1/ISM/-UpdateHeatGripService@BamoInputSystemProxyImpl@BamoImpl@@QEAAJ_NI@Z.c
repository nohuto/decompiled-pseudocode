/*
 * XREFs of ?UpdateHeatGripService@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012C4FC
 * Callers:
 *     ?Thunk_UpdateHeatGripService_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801294B0 (-Thunk_UpdateHeatGripService_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@.c)
