/*
 * XREFs of ?LogReceiveRegisterInputAttemptedClient@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputAttemptedDeliveryClientProxy@@@Z @ 0x180160BEC
 * Callers:
...
void __fastcall BamoImpl::BamoInputDeliveryServerPrincipalImpl::LogReceiveRegisterInputAttemptedClient(
