/*
 * XREFs of ?SampleRandomPickStart@InputServiceProxy@@AEAAXIIGGG_K@Z @ 0x180161F10
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  {
    if ( (unsigned int)dword_180251328 > 5 && tlgKeywordOn((__int64)&dword_180251328, 0x400000000001LL) )
    {
      v17 = *((_QWORD *)this + 7);
      v24 = *(_QWORD *)(v17 + 40);
