/*
 * XREFs of ??1?$vector@V?$shared_ptr@ULegacyDeviceInfo@@@std@@V?$allocator@V?$shared_ptr@ULegacyDeviceInfo@@@std@@@2@@std@@QEAA@XZ @ 0x1800CEBE8
 * Callers:
 *     _MPCRawInputProvider::FlushQueuedDeviceChanges_::_1_::dtor$0 @ 0x1801D955E (_MPCRawInputProvider--FlushQueuedDeviceChanges_--_1_--dtor$0.c)
 * Callees:
