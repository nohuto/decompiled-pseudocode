/*
 * XREFs of ?InjectPan@ManipulationInjector@@QEAAXMMK@Z @ 0x180114D44
 * Callers:
 ...
 *     ?RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z @ 0x18011535C (-RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z.c)
