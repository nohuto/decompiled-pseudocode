/*
 * XREFs of ?LogOnPausedChanging@BamoControllerNavigationManagerProxy@@AEAAX_N@Z @ 0x18011C190
 * Callers:
...
void __fastcall BamoControllerNavigationManagerProxy::LogOnPausedChanging(BamoControllerNavigationManagerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
