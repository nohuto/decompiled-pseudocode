/*
 * XREFs of ?Initialize@CallControlDeviceCollection@@IEAAJPEAPEAX@Z @ 0x180045014
 * Callers:
        ...
        __int64 a4)
{
  ...
  v9 = 65555;
  v4 = HIDDeviceCollection::Initialize(this, (__int64)a2, (struct _RIM_USAGE_ANDPAGE *const)&v9, a4, 0x28u, a2);
  v5 = v4;
  if ( v4 >= 0 )
    return 0LL;
