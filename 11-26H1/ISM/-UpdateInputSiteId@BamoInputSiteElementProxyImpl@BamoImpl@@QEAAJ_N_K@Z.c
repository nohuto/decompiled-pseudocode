/*
 * XREFs of ?UpdateInputSiteId@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18003C4B4
 * Callers:
 *     ?Thunk_UpdateInputSiteId_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003C4A0 (-Thunk_UpdateInputSiteId_0@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoI.c)
