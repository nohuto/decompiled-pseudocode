/*
 * XREFs of ?CheckForShellGesture@ShellGesturesRecognizer@@AEAAXAEAURecognitionState@1@_N@Z @ 0x180063DBC
 * Callers:
        ...
        char a3)
{
  ...
  const WCHAR *v28; // [rsp+88h] [rbp+20h] BYREF
    ...
    if ( v12 == 2 )
    {
      if ( *((_DWORD *)this + 24) == 1 )
      {
        if ( a3 )
        {
          ...
          if ( (int)((v21[4] - v21[3]) * (v21[4] - v21[3])
                   + (HIDWORD(v21[4]) - HIDWORD(v21[3])) * (HIDWORD(v21[4]) - HIDWORD(v21[3]))) >= (unsigned __int64)(unsigned int)(dword_180253208 * dword_180253208) )
          {
            *((_DWORD *)a2 + 1) = 2;
LABEL_46:
            *(_DWORD *)a2 = 1;
      ...
      else if ( *((_DWORD *)this + 24) == 2 )
      {
        if ( a3 )
        {
          ...
          for ( k = (_QWORD *)*v17; k != v17; k = (_QWORD *)*k )
          {
            ...
            if ( *((_BYTE *)this + 216) )
            {
              if ( v19 >= 1000000 * qword_180253218 )
                goto LABEL_29;
            }
            else if ( v19 >= 1000000 * qword_180253210 )
            {
              *((_DWORD *)a2 + 1) = 3;
              goto LABEL_46;
            }
            v20 = k[3];
            if ( (int)((k[4] - v20) * (k[4] - v20) + (HIDWORD(k[4]) - HIDWORD(v20)) * (HIDWORD(k[4]) - HIDWORD(v20))) >= (unsigned __int64)(unsigned int)(dword_180253220 * dword_180253220) )
            {
              *((_DWORD *)a2 + 1) = 4;
              goto LABEL_46;
            }
...
LABEL_29:
    ...
    if ( (unsigned int)dword_180251248 > 5 && tlgKeywordOn((__int64)&dword_180251248, 0x200000000000LL) )
    {
      ...
      if ( (_DWORD)v23 )
      {
        ...
        if ( !(_DWORD)v23 )
        {
          v25 = L"GestureNotRecognized";
          goto LABEL_62;
        }
        v23 = (unsigned int)(v23 - 1);
        if ( !(_DWORD)v23 )
        {
          v25 = L"GestureRecognitionInProgress";
          goto LABEL_62;
        }
        v23 = (unsigned int)(v23 - 1);
        if ( !(_DWORD)v23 )
        {
          v25 = L"GestureRecognized";
          goto LABEL_62;
        }
        if ( (_DWORD)v23 == 1 )
        {
          v25 = L"GestureInProgress";
LABEL_62:
          v28 = v25;
          v26 = 0x1000000LL;
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapSz<unsigned short>,_tlgWrapperByVal<4>>(
            v22,
            (__int64)&unk_1802258EC,
            v23,
            v24,
            (__int64)&v26,
            &v28,
