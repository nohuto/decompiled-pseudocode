/*
 * XREFs of ?CreateWatcher@AppViewInProc@WindowManagement@ApplicationModel@Internal@Windows@winrt@@SA@XZ @ 0x180092998
 * Callers:
 ...
 *     ?CreateWatcher@?$consume_Windows_Internal_ApplicationModel_WindowManagement_IAppViewStatics@UIAppViewStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@impl@winrt@@QEBA@XZ @ 0x180092A10 (-CreateWatcher@-$consume_Windows_Internal_ApplicationModel_WindowManagement_IAppViewStatics@UIAp.c)
 */
...
{
  const struct winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics *(__fastcall *v3)(const struct winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics *, __int64); // [rsp+40h] [rbp+8h] BYREF

  v3 = (const struct winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics *(__fastcall *)(const struct winrt::Windows::Internal::ApplicationModel::WindowManagement::IAppViewStatics *, __int64))&qword_180253D28;
