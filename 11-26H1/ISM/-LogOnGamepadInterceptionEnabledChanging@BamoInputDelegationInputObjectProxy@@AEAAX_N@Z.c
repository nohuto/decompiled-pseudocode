/*
 * XREFs of ?LogOnGamepadInterceptionEnabledChanging@BamoInputDelegationInputObjectProxy@@AEAAX_N@Z @ 0x180135E10
 * Callers:
...
void __fastcall BamoInputDelegationInputObjectProxy::LogOnGamepadInterceptionEnabledChanging(
