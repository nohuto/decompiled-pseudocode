/*
 * XREFs of ?message@hresult_error@winrt@@QEBA?AUhstring@2@XZ @ 0x1800DEDC0
 * Callers:
 ...
 * Callees:
 *     FormatMessageW_0 @ 0x18009B4DC (FormatMessageW_0.c)
 *     SysStringLen_0 @ 0x18009D40D (SysStringLen_0.c)
