 ...
 *     ??4?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAAAEAV01@AEBV01@@Z @ 0x1801CF0B8 (--4-$list@V-$shared_ptr@UHotKeyInfo@@@std@@V-$allocator@V-$shared_ptr@UHotKeyInfo@@@std@@@2@@std.c)
...
__int64 __fastcall HotKeyProcessor::UnregisterHotKey(__int64 *a1, __int64 a2, int a3, int a4)
{
  ...
  struct HotkeyClientRegistration *v27; // [rsp+68h] [rbp-98h] BYREF
  _QWORD *v28[2]; // [rsp+70h] [rbp-90h] BYREF
  const unsigned __int16 *v29[2]; // [rsp+80h] [rbp-80h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v30; // [rsp+90h] [rbp-70h] BYREF
  int *v31; // [rsp+B0h] [rbp-50h]
  __int64 v32; // [rsp+B8h] [rbp-48h]
  const unsigned __int16 **v33; // [rsp+C0h] [rbp-40h]
  ...
  ULONG_PTR retaddr; // [rsp+148h] [rbp+48h]

  v25 = 0;
  v22 = ((unsigned __int16)a4 << 16) | a3 & 0xF;
  v27 = 0LL;
  ...
  if ( RegisteredClient >= 0 )
  {
    if ( v27 )
    {
      ...
      if ( v26 != a1[5] )
      {
        v11 = std::map<unsigned long,std::list<std::shared_ptr<HotKeyInfo>>>::_Try_emplace<unsigned long const &,>(
                a1 + 5,
                (__int64)v29,
                &v22);
        ...
        HotKeyProcessor::CleanupClientHotKeys(v12, (__int64)v27, v28, &v25);
        v13 = a1 + 5;
        if ( v28[1] )
        {
          v14 = (_QWORD *)std::map<unsigned long,std::list<std::shared_ptr<HotKeyInfo>>>::_Try_emplace<unsigned long const &,>(
                            v13,
                            (__int64)v29,
                            &v22);
          std::list<std::shared_ptr<HotKeyInfo>>::operator=(*v14 + 40LL, (_QWORD ***)v28);
        }
        else
        {
        ...
        **((_QWORD **)v28[0] + 1) = 0LL;
        ...
        std::_Deallocate<16>(v28[0], (struct std::nothrow_t *)0x20);
      }
    }
    if ( v25 )
    {
      if ( (unsigned int)dword_180251328 > 5 && tlgKeywordOn((__int64)&dword_180251328, 0x20000LL) )
      {
        v29[0] = *(const unsigned __int16 **)a2;
        v23 = *(_DWORD *)(a2 + 8);
        LODWORD(v26) = a4;
        v37 = &v26;
        v35 = &v24;
        ...
        v34 = 8LL;
        v32 = 4LL;
        tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180251328, byte_18022AAE1, 0LL, 0LL, 6u, &v30);
      }
    ...
    else
    {
      ...
      if ( (unsigned int)dword_180251328 > 5 && tlgKeywordOn((__int64)&dword_180251328, 0x20000LL) )
      {
        ...
        v29[0] = (const unsigned __int16 *)"UnregisterHotKey failed because the HotKey was not registered.";
        v23 = a4;
        v24 = a3;
