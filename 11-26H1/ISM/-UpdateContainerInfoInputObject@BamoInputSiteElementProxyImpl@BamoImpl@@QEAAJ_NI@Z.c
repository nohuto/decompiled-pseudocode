/*
 * XREFs of ?UpdateContainerInfoInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003B3E4
 * Callers:
 *     ?Thunk_UpdateContainerInfoInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003B3D0 (-Thunk_UpdateContainerInfoInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementPr.c)
...
__int64 __fastcall BamoImpl::BamoInputSiteElementProxyImpl::UpdateContainerInfoInputObject(
        ...
        __int64 a3)
{
  ...
  struct BamoContainerInfoInputObjectProxy *v7; // rsi
  __int64 v8; // rbx
  int v10; // eax
  int v11; // eax
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnContainerInfoInputObjectChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1);
      v10 = (*(__int64 (__fastcall **)(char *, struct BamoContainerInfoInputObjectProxy *))(*((_QWORD *)this - 2) + 248LL))(
              (char *)this - 16,
              v7);
      if ( v10 < 0 )
    ...
    *((_QWORD *)this + 13) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoContainerInfoInputObjectProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnContainerInfoInputObjectChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        (__int64)v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        (void (__fastcall ***)(_QWORD))this,
        2);
      v11 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 256LL))((char *)this - 16);
      if ( v11 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x2921,
