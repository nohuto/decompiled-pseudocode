/*
 * XREFs of ?LogOnInputDeliveryServerChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x18011B7FC
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnInputDeliveryServerChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
