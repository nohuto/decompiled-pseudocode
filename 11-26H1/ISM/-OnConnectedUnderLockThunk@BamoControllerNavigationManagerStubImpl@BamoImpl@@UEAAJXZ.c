/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x18006B330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoControllerNavigationManagerStubImpl::OnConnectedUnderLockThunk(
