/*
 * XREFs of ?get@?$static_lazy@VRawInputProvidersContinuousTracing@@@details@wil@@QEAAPEAVRawInputProvidersContinuousTracing@@P6AXXZ@Z @ 0x1800472DC
 * Callers:
        ...
        void (__cdecl *a2)())
{
    ...
    && v6 )
  {
    ...
    v8 = &qword_180254EB8;
    qword_180254EB8 = (__int64)&RawInputProvidersContinuousTracing::`vftable';
    qword_180254EC0 = 0LL;
    byte_180254EC8 = 0;
    dword_180254ECC = 0;
    qword_180254ED0 = (__int64)&`RawInputProvidersContinuousTracing::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
