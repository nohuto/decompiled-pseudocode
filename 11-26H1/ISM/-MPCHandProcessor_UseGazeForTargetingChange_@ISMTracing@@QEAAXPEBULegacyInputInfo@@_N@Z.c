/*
 * XREFs of ?MPCHandProcessor_UseGazeForTargetingChange_@ISMTracing@@QEAAXPEBULegacyInputInfo@@_N@Z @ 0x1800C0348
 * Callers:
        ...
        char a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && tlgKeywordOn((__int64)v5, 1LL) )
  {
    ...
    v17 = v8;
    v12 = a3;
    tlgWriteTransfer_EventWriteTransfer(v7, byte_180213CC1, 0LL, 0LL, 8u, &v15);
  }
}
