/*
 * XREFs of ?LogOnTipToGlassEventsRequiredChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x1801994B4
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTipToGlassEventsRequiredChanging(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
