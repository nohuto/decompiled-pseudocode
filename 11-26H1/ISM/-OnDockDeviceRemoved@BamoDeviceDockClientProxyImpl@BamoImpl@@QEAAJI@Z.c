/*
 * XREFs of ?OnDockDeviceRemoved@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180186D10
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnDockDeviceRemoved(this);
      v11[0] = v13;
      v11[1] = v14;
