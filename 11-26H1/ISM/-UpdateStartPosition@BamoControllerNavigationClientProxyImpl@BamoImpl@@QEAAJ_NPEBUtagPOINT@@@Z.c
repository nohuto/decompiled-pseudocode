/*
 * XREFs of ?UpdateStartPosition@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x18017C0B0
 * Callers:
 *     ?Thunk_UpdateStartPosition_23@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017B820 (-Thunk_UpdateStartPosition_23@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigati.c)
