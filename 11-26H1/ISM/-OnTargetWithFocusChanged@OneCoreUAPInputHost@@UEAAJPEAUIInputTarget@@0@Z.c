/*
 * XREFs of ?OnTargetWithFocusChanged@OneCoreUAPInputHost@@UEAAJPEAUIInputTarget@@0@Z @ 0x1800289F0
 * Callers:
 *     <none>
 * Callees:
 *     ?InternalRelease@?$ComPtr@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@WRL@Microsoft@@IEAAKXZ @ 0x18000C32C (-InternalRelease@-$ComPtr@U-$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@WRL@Micros.c)
 *     ?OnTargetWithFocusChanged@InputProviderManager@@QEAAXPEAUIInputTarget@@0@Z @ 0x180028B00 (-OnTargetWithFocusChanged@InputProviderManager@@QEAAXPEAUIInputTarget@@0@Z.c)
