/*
 * XREFs of ??$?0AEAY0BD@$$CBGM$0A@@?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@@std@@QEAA@AEAY0BD@$$CBG$$QEAM@Z @ 0x180092B7C
 * Callers:
        ...
        __int64 a3)
{
  ...
  std::variant<unsigned long,bool,float>::variant<unsigned long,bool,float>(a1 + 32, a3);
  return a1;
}
