/*
 * XREFs of ?UpdateInputDelegationInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180038434
 * Callers:
 *     ?Thunk_UpdateInputDelegationInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180038420 (-Thunk_UpdateInputDelegationInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElement.c)
...
__int64 __fastcall BamoImpl::BamoInputSiteElementProxyImpl::UpdateInputDelegationInputObject(
        ...
        unsigned int a3)
{
  ...
  struct BamoInputDelegationInputObjectProxy *v7; // rsi
  __int64 v8; // rbx
  int v10; // eax
  int v11; // eax
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnInputDelegationInputObjectChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        1LL);
      v10 = (*(__int64 (__fastcall **)(char *, struct BamoInputDelegationInputObjectProxy *))(*((_QWORD *)this - 2)
                                                                                            + 424LL))(
              (char *)this - 16,
              v7);
      if ( v10 < 0 )
    ...
    *((_QWORD *)this + 24) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoInputDelegationInputObjectProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnInputDelegationInputObjectChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        2LL);
      v11 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 432LL))((char *)this - 16);
      if ( v11 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x2C2E,
