/*
 * XREFs of ?Create@EdgyProcessorTarget@@SAJPEAVEdgyLegacyProcessor@@AEBUEdgyPointerInfo@@UtagMsgRoutingInfo@@PEAXPEAPEAV1@@Z @ 0x1801AFBF4
 * Callers:
 ...
 *     ??0EdgyProcessorTarget@@IEAA@PEAVEdgyLegacyProcessor@@@Z @ 0x1801AF6EC (--0EdgyProcessorTarget@@IEAA@PEAVEdgyLegacyProcessor@@@Z.c)
