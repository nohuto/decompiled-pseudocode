/*
 * XREFs of ?UpdateResizeControllerClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180039C74
 * Callers:
 *     ?Thunk_UpdateResizeControllerClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180039C60 (-Thunk_UpdateResizeControllerClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
...
__int64 __fastcall BamoImpl::BamoInputSiteElementProxyImpl::UpdateResizeControllerClient(
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnResizeControllerClientChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1);
      v11 = (*(__int64 (__fastcall **)(char *, struct BamoResizeControllerClientProxy *))(*((_QWORD *)this - 2) + 584LL))(
              (char *)this - 16,
              v7);
      if ( v11 < 0 )
    ...
    *((_QWORD *)this + 34) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoResizeControllerClientProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnResizeControllerClientChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        (__int64)v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        (void (__fastcall ***)(_QWORD))this,
        2);
      v10 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 592LL))((char *)this - 16);
      if ( v10 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x2EF4,
