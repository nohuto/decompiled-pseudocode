/*
 * XREFs of ?InitializeDefaultPlaceholderPeer@BamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@MEAAJPEAPEAVBaseBamoPeer@Bamo@Microsoft@@@Z @ 0x180119EB0
 * Callers:
 *     <none>
 * Callees:
 *     ?Initialize@BaseBamoPeerImpl@BamoImpl@Microsoft@@QEAAXPEAVBaseBamoConnectionImpl@23@III@Z @ 0x18002A100 (-Initialize@BaseBamoPeerImpl@BamoImpl@Microsoft@@QEAAXPEAVBaseBamoConnectionImpl@23@III@Z.c)
 *     ??2@YAPEAX_K@Z @ 0x18009ADFC (--2@YAPEAX_K@Z.c)
 *     _guard_dispatch_icall$thunk$10345483385596137414 @ 0x1801DE010 (_guard_dispatch_icall$thunk$10345483385596137414.c)
 */

__int64 __fastcall BamoImpl::ISMBamos_AutoBamos::BamoConnectionImpl::InitializeDefaultPlaceholderPeer(
        ...
        struct Microsoft::Bamo::BaseBamoPeer **a2)
{
  ...
  *((_QWORD *)v8 + 11) = 0LL;
  *((_QWORD *)v8 + 12) = 0LL;
  *((_QWORD *)v8 + 1) = &BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl::`vftable';
