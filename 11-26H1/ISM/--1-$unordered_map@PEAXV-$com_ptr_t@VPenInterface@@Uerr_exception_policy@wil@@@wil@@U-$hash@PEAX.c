/*
 * XREFs of ??1?$unordered_map@PEAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@U?$hash@PEAX@std@@U?$equal_to@PEAX@4@V?$allocator@U?$pair@QEAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x18018DB60
 * Callers:
 *     _HapticDeviceManager::HapticDeviceManager_::_1_::dtor$2 @ 0x1801DC434 (_HapticDeviceManager--HapticDeviceManager_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
