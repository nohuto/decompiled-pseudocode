/*
 * XREFs of ?QueryInterface@InputForwardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AC040
 * Callers:
 *     ?QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AC100 (-QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        InputForwardProcessor **a3)
{
  ...
  if ( !v6 )
  {
    (*(void (__fastcall **)(InputForwardProcessor *))(*(_QWORD *)this + 8LL))(this);
LABEL_11:
    *a3 = v4;
    return 0LL;
  }
  ...
  {
    (*(void (__fastcall **)(InputForwardProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (InputForwardProcessor *)(((unsigned __int64)v4 + 8) & -(__int64)(v4 != 0LL));
    goto LABEL_11;
  }
  return 2147500034LL;
}
