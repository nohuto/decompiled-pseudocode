/*
 * XREFs of ?OnCUIHostInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005B6B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UICUIHostInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005B724 (--$RemoveObject@UICUIHostInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<ICUIHostInputObjectProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 112LL))((char *)this + 8);
