/*
 * XREFs of ??$?MGU?$char_traits@G@std@@V?$allocator@G@1@@std@@YA_NAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@0@0@Z @ 0x180023014
 * Callers:
...
__int64 __fastcall std::operator<<unsigned short>(const wchar_t *a1, const wchar_t *a2)
{
  size_t v2; // rdi
  size_t v3; // rbx
  size_t v4; // r8
  ...
  if ( v2 >= v3 )
    v4 = v3;
  v5 = std::_WChar_traits<unsigned short>::compare(a1, a2, v4);
  if ( !v5 )
  {
    if ( v3 < v2 )
      v5 = -1;
