/*
 * XREFs of Microsoft::BamoImpl::Util::FindInterface_Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_PenDevicePrincipal_Stub_Microsoft::Bamo::Lib::ISMBamos_AutoBamos::IList_PenDevicePrincipal_Stub_ @ 0x18018CEFC
 * Callers:
 *     ?QueryInterface@BamoList_PenDevicePrincipal_Stub@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180190230 (-QueryInterface@BamoList_PenDevicePrincipal_Stub@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJAEB.c)
 * Callees:
 *     <none>
 */
