/*
 * XREFs of ?Slerp@MPCMath@@YA?AUfloat3@Numerics@Foundation@Windows@@U2345@0M@Z @ 0x1800C72BC
 * Callers:
...
float *__fastcall MPCMath::Slerp(float *a1, float *a2, float *a3, float a4)
{
  ...
  v8 = a3[2];
  v9 = FLOAT_N1_0;
  v10 = (float)((float)(a2[1] * v7) + (float)(*a2 * *a3)) + (float)(a2[2] * v8);
  if ( v10 >= -1.0 )
    v9 = (float)((float)(a2[1] * v7) + (float)(*a2 * *a3)) + (float)(a2[2] * v8);
  v11 = FLOAT_1_0;
  if ( v10 <= 1.0 )
    v11 = v9;
  v12 = acosf(v11) * a4;
