/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x18009E884
 * Callers:
 ...
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z @ 0x18009F4F0 (-MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z.c)
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x1800A1160 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 * Callees:
 *     memset_0 @ 0x18009AC08 (memset_0.c)
 *     __security_check_cookie @ 0x18009ACC0 (__security_check_cookie.c)
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x18009F204 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
