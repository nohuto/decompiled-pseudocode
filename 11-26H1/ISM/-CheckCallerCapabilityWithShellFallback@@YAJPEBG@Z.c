/*
 * XREFs of ?CheckCallerCapabilityWithShellFallback@@YAJPEBG@Z @ 0x18013BFDC
 * Callers:
...
__int64 __fastcall CheckCallerCapabilityWithShellFallback(const unsigned __int16 *a1)
{
  ...
  wil::details::in1diag3::Return_Hr(
    retaddr,
    (void *)0x1C,
    (int)"onecoreuap\\windows\\moderncore\\inputv2\\Components\\InputObservers\\inc\\InputObserverCapabilities.h",
