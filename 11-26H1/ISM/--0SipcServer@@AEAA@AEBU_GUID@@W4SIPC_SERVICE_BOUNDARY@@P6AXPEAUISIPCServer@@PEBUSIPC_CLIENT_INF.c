/*
 * XREFs of ??0SipcServer@@AEAA@AEBU_GUID@@W4SIPC_SERVICE_BOUNDARY@@P6AXPEAUISIPCServer@@PEBUSIPC_CLIENT_INFO@@PEAX@Z4@Z @ 0x180094E20
 * Callers:
...
__int64 __fastcall SipcServer::SipcServer(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(_DWORD *)(a1 + 40) = 1;
  *(_WORD *)(a1 + 44) = 2;
  *(_OWORD *)(a1 + 24) = xmmword_180201748;
  *(_QWORD *)(a1 + 48) = 0LL;
