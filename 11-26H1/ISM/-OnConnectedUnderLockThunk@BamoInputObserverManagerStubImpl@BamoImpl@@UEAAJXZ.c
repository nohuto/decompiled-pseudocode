/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoInputObserverManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180074880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputObserverManagerStubImpl::OnConnectedUnderLockThunk(
