/*
 * XREFs of ?OnMPCInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180040860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIMPCInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800408D8 (--$RemoveObject@UIMPCInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
