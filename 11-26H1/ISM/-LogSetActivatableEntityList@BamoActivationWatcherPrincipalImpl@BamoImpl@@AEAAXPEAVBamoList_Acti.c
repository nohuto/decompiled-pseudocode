/*
 * XREFs of ?LogSetActivatableEntityList@BamoActivationWatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoList_ActivatableEntityPrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x1800AF540
 * Callers:
...
void __fastcall BamoImpl::BamoActivationWatcherPrincipalImpl::LogSetActivatableEntityList(
