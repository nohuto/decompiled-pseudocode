/*
 * XREFs of _anonymous_namespace_::__std_find_last_of::_Impl_unsigned_short_ @ 0x18009BF70
 * Callers:
...
unsigned __int64 __fastcall anonymous_namespace_::__std_find_last_of::_Impl_unsigned_short_(
        const __m128i *Src,
        __int64 a2,
        const __m128i *a3,
        __int64 a4)
{
  ...
  if ( (unsigned __int64)(2 * a4) > 0x10 )
  {
    ...
    memcpy_0(&v36, v21, (unsigned int)v20);
...
LABEL_5:
      if ( v6
        && ((v15 = v6 >> 1, v4 < 0x10)
          ? (memcpy_0(Size, Src, v4), v16 = _mm_load_si128((const __m128i *)Size))
