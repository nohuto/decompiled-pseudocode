/*
 * XREFs of ?LogOnViewInstanceIdChanged@BamoInputAttemptedDeliveryClientProxy@@AEAAXXZ @ 0x1801606BC
 * Callers:
...
void __fastcall BamoInputAttemptedDeliveryClientProxy::LogOnViewInstanceIdChanged(
