/*
 * XREFs of ?LogOnTailButtonDoubleClickedEventsRequiredChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x18019934C
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTailButtonDoubleClickedEventsRequiredChanging(
