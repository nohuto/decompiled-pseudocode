/*
 * XREFs of _DWMInputRouter::GetTargetListFromHitTestResult_::_1_::dtor$0 @ 0x1801D44B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::GetTargetListFromHitTestResult_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  ...
  {
    *(_DWORD *)(a2 + 64) &= ~1u;
    return std::vector<Microsoft::WRL::ComPtr<IInputTarget>>::~vector<Microsoft::WRL::ComPtr<IInputTarget>>(*(__int64 ***)(a2 + 152));
  }
  return result;
}
