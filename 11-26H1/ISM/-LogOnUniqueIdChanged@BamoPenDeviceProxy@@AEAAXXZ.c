/*
 * XREFs of ?LogOnUniqueIdChanged@BamoPenDeviceProxy@@AEAAXXZ @ 0x18011D32C
 * Callers:
...
void __fastcall BamoPenDeviceProxy::LogOnUniqueIdChanged(BamoPenDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
