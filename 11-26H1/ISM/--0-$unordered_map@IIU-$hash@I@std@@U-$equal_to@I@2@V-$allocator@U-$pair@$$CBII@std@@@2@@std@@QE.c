/*
 * XREFs of ??0?$unordered_map@IIU?$hash@I@std@@U?$equal_to@I@2@V?$allocator@U?$pair@$$CBII@std@@@2@@std@@QEAA@XZ @ 0x18004D9AC
 * Callers:
...
__int64 __fastcall std::unordered_map<unsigned int,unsigned int>::unordered_map<unsigned int,unsigned int>(__int64 a1)
{
