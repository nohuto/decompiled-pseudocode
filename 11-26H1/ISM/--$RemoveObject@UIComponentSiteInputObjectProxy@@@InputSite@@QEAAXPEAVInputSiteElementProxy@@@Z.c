/*
 * XREFs of ??$RemoveObject@UIComponentSiteInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005B1A4
 * Callers:
...
void __fastcall InputSite::RemoveObject<IComponentSiteInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_76d0682c_efad_f6c3_6b01_5b4201df35b4, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
