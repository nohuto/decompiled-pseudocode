/*
 * XREFs of ?LogSetIsIntensitySupported@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAX_N@Z @ 0x180189C60
 * Callers:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::LogSetIsIntensitySupported(
