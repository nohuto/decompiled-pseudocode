/*
 * XREFs of ?CreateManualResizeAreaClientProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x180118E74
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *v6 = &ManualResizeAreaClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v6[1] = &ManualResizeAreaClientProxy::`vftable'{for `IManualResizeAreaClientProxy'};
