/*
 * XREFs of ?OnMessage@BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18018FD90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoHapticDeviceManagerPrincipalImpl::OnMessage(
