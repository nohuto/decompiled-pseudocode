/*
 * XREFs of ?OpenConfigRegKey@GestureSession@@SAJPEAPEAUHKEY__@@@Z @ 0x1801B7E74
 * Callers:
 *     ?StaticInitConfig@GestureRecognizer@@KAXXZ @ 0x1801BA9C4 (-StaticInitConfig@GestureRecognizer@@KAXXZ.c)
 * Callees:
 *     memset_0 @ 0x18009AC08 (memset_0.c)
 *     __security_check_cookie @ 0x18009ACC0 (__security_check_cookie.c)
 *     ?RefreshScreenSize@GestureSession@@SAJXZ @ 0x1801B8274 (-RefreshScreenSize@GestureSession@@SAJXZ.c)
 */
