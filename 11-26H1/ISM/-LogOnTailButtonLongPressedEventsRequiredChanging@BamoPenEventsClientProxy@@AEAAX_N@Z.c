/*
 * XREFs of ?LogOnTailButtonLongPressedEventsRequiredChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x180199400
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTailButtonLongPressedEventsRequiredChanging(
