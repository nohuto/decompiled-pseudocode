/*
 * XREFs of ?SetBooleanValue@BamoDataSourceStubImpl@BamoImpl@@QEAAJI_N@Z @ 0x1800503F0
 * Callers:
 *     ?SetBooleanValue@BamoDataSourceStub@@UEAAJI_N@Z @ 0x180050390 (-SetBooleanValue@BamoDataSourceStub@@UEAAJI_N@Z.c)
 *     ?CallSetBooleanValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@I_N@Z @ 0x180103CA0 (-CallSetBooleanValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@.c)
 * Callees:
