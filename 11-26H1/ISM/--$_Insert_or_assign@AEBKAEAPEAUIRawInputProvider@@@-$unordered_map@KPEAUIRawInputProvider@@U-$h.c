        ...
        _QWORD *a4)
{
  ...
  else
  {
    ...
    v19 = a1 + 1;
    v20 = *((_QWORD *)&v18 + 1);
    v10 = std::_Allocate<16,std::_Default_allocate_traits>((unsigned int)(DWORD2(v18) + 32));
    v20 = v10;
    ...
    *(_QWORD *)(v10 + 24) = *a4;
    ...
    if ( v13 < 0 )
    {
      v16 = a1[7] & 1LL | ((unsigned __int64)v13 >> 1);
