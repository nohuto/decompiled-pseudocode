/*
 * XREFs of ?GetItemAt@?$ListPrincipalDetails@UDisplayOcclusionRect@@VBamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@3@VBamoList_DisplayOcclusionRect_Stub@3456@$0A@$00$0A@@Bamo@Microsoft@@QEAAAEBUDisplayOcclusionRect@@I@Z @ 0x18013FEC8
 * Callers:
