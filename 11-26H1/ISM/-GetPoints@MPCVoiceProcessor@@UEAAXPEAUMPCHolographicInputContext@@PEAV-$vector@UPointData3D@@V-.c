/*
 * XREFs of ?GetPoints@MPCVoiceProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801BE380
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(a1 + 3640) )
  {
    if ( *(_BYTE *)(a1 + 3548) )
    {
      ...
      *((_QWORD *)&v21 + 1) = v17 | 0x300000000LL;
      ...
      v29 = v13;
      v30 = v12;
      std::vector<PointData3D>::_Emplace_one_at_back<PointData3D const &>(a3, &v21);
      DWORD1(v22) = 0;
      std::vector<PointData3D>::_Emplace_one_at_back<PointData3D const &>(a3, &v21);
      *(_BYTE *)(a1 + 3640) = 0;
    }
