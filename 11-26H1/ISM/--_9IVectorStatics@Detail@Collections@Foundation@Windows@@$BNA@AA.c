/*
 * XREFs of ??_9IVectorStatics@Detail@Collections@Foundation@Windows@@$BNA@AA @ 0x1801700AC
 * Callers:
...
__int64 __fastcall  Windows::Foundation::Collections::Detail::IVectorStatics::`vcall'{208,{flat}}(__int64 a1)
{
