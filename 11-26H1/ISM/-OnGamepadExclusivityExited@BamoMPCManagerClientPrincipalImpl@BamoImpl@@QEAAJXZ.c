/*
 * XREFs of ?OnGamepadExclusivityExited@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x18016B8B4
 * Callers:
 *     ?Thunk_OnGamepadExclusivityExited_41@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016C4D0 (-Thunk_OnGamepadExclusivityExited_41@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientP.c)
 * Callees:
