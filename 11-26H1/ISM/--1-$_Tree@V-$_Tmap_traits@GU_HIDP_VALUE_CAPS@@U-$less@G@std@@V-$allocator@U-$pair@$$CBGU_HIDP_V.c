/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@GU_HIDP_VALUE_CAPS@@U?$less@G@std@@V?$allocator@U?$pair@$$CBGU_HIDP_VALUE_CAPS@@@std@@@3@$0A@@std@@@std@@QEAA@XZ @ 0x180188794
 * Callers:
 ...
 *     ??1HapticsTrigger@@QEAA@XZ @ 0x1801888E8 (--1HapticsTrigger@@QEAA@XZ.c)
