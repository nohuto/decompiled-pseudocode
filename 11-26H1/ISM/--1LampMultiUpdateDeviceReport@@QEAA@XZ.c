/*
 * XREFs of ??1LampMultiUpdateDeviceReport@@QEAA@XZ @ 0x180021764
 * Callers:
 *     ??1HidLampMultiUpdateReportBuilder@@UEAA@XZ @ 0x180021658 (--1HidLampMultiUpdateReportBuilder@@UEAA@XZ.c)
 * Callees:
