/*
 * XREFs of ?LogSetShellHandwritingHostServer@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoShellHandwritingHostServerPrincipal@@@Z @ 0x180131190
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetShellHandwritingHostServer(
