/*
 * XREFs of ??$_Erase@_K@?$_Hash@V?$_Umap_traits@_KV?$shared_ptr@VGestureHandler@@@std@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@2@V?$allocator@U?$pair@$$CB_KV?$shared_ptr@VGestureHandler@@@std@@@std@@@2@$0A@@std@@@std@@AEAA_KAEB_K@Z @ 0x180144288
 * Callers:
 *     _lambda_80df7c2b76f58973f9ddec3659020abd_::operator() @ 0x18007B5E8 (_lambda_80df7c2b76f58973f9ddec3659020abd_--operator().c)
 * Callees:
