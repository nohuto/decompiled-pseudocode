/*
 * XREFs of ?LogSendBoundsCrossed@BamoControllerNavigationClientProxyImpl@BamoImpl@@AEAAXAEBUtagPOINT@@@Z @ 0x18017B314
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationClientProxyImpl::LogSendBoundsCrossed(
