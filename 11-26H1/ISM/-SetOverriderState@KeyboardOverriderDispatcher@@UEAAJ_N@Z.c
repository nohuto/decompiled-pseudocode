/*
 * XREFs of ?SetOverriderState@KeyboardOverriderDispatcher@@UEAAJ_N@Z @ 0x1800F6AF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)v4,
        (int)"onecoreuap\\windows\\moderncore\\inputv2\\systeminputhosts\\components\\win32kinterop\\lib\\keyboardoverrid"
             "erdispatcher.cpp",
