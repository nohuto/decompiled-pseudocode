/*
 * XREFs of ??1EdgyDragMessageInfo@EdgyProcessor@@QEAA@XZ @ 0x18015693C
 * Callers:
 ...
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKUEdgyDragMessageInfo@EdgyProcessor@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18015684C (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CBKUEdgyDragMessageInfo@EdgyPro.c)
 * Callees:
