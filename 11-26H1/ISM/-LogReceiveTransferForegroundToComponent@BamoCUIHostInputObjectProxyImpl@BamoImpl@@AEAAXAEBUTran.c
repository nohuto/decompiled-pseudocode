/*
 * XREFs of ?LogReceiveTransferForegroundToComponent@BamoCUIHostInputObjectProxyImpl@BamoImpl@@AEAAXAEBUTransferForegroundInfo@@@Z @ 0x1801340C4
 * Callers:
...
void __fastcall BamoImpl::BamoCUIHostInputObjectProxyImpl::LogReceiveTransferForegroundToComponent(
