/*
 * XREFs of ?ServerConnected@VirtualTouchpad@InputTraceLogging@@SAXPEBX_N1AEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x180139394
 * Callers:
        ...
        const struct Windows::UI::Internal::Input::VirtualTouchpadSize *a4)
{
  ...
  if ( *(_DWORD *)v8 > 4u && tlgKeywordOn((__int64)v8, 512LL) )
  {
    ...
    v23 = 1LL;
    v21 = 1LL;
    tlgWriteTransfer_EventWriteTransfer(v9, byte_180220ED7, 0LL, 0LL, 8u, &v17);
  }
}
