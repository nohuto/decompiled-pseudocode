/*
 * XREFs of ?GetDesktop@DragManagerClientProxy@@AEAAJXZ @ 0x18004D0A8
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAUHDESK__@@P6AHPEAU1@@Z$1?CloseDesktop@@YAH0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x18007D4B8 (--1-$unique_storage@U-$resource_policy@PEAUHDESK__@@P6AHPEAU1@@Z$1-CloseDesktop@@YAH0@ZU-$integr.c)
...
__int64 __fastcall DragManagerClientProxy::GetDesktop(DragManagerClientProxy *this)
{
  ...
  int lpnLengthNeeded; // [rsp+20h] [rbp-50h]
