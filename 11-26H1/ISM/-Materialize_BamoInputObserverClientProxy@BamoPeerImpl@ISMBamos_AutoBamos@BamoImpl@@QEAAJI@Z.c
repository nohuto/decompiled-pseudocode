/*
 * XREFs of ?Materialize_BamoInputObserverClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1801209D8
 * Callers:
 *     ?Thunk_Materialize_BamoInputObserverClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128E10 (-Thunk_Materialize_BamoInputObserverClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPe.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoInputObserverClientProxy *v14; // [rsp+60h] [rbp+8h] BYREF
  ...
  v5 = CreateInputObserverClientProxy(v4, &v14);
  if ( v5 < 0 )
  ...
  if ( !v14 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v6);
  v7 = (*(__int64 (__fastcall **)(struct BamoInputObserverClientProxy *))(*(_QWORD *)v14 + 56LL))(v14);
