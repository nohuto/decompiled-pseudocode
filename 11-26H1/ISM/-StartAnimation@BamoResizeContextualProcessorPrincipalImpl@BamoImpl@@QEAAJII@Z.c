/*
 * XREFs of ?StartAnimation@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1801528B0
 * Callers:
 *     ?Thunk_StartAnimation_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180152C40 (-Thunk_StartAnimation_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProc.c)
 * Callees:
