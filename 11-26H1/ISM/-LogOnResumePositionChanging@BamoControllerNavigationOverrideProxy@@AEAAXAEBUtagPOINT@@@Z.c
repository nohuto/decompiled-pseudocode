/*
 * XREFs of ?LogOnResumePositionChanging@BamoControllerNavigationOverrideProxy@@AEAAXAEBUtagPOINT@@@Z @ 0x18017B0AC
 * Callers:
...
void __fastcall BamoControllerNavigationOverrideProxy::LogOnResumePositionChanging(
