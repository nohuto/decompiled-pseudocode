/*
 * XREFs of ?UpdateEndpointId@BamoUIAHitTestInputObjectProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x18012B670
 * Callers:
 *     ?Thunk_UpdateEndpointId_47@?$IUIAHitTestInputObjectProxy_Receive@VBamoUIAHitTestInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129390 (-Thunk_UpdateEndpointId_47@-$IUIAHitTestInputObjectProxy_Receive@VBamoUIAHitTestInputObjectProxy.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoUIAHitTestInputObjectProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18012F660 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoUIAHitTestInputObjectProxyImpl@BamoImpl@@UEAAXPE.c)
 * Callees:
...
{
  char v4; // r14
  BamoUIAHitTestInputObjectProxy *v6; // rsi
  int v7; // eax
  int v8; // eax
