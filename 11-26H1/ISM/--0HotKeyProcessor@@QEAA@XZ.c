/*
 * XREFs of ??0HotKeyProcessor@@QEAA@XZ @ 0x1801CEA90
 * Callers:
...
HotKeyProcessor *__fastcall HotKeyProcessor::HotKeyProcessor(HotKeyProcessor *this)
{
  ...
  *((_QWORD *)this + 5) = 0LL;
  *((_QWORD *)this + 6) = 0LL;
  v4 = std::_Allocate<16,std::_Default_allocate_traits>(0x38uLL);
  *v4 = v4;
  v4[1] = v4;
  v4[2] = v4;
  *((_WORD *)v4 + 12) = 257;
  ...
  *((_QWORD *)this + 48) = 0LL;
  v11[0] = 0LL;
  v6 = std::_Allocate<16,std::_Default_allocate_traits>(0x38uLL);
  *v6 = v6;
  v6[1] = v6;
  v6[2] = v6;
  *((_WORD *)v6 + 12) = 257;
  ...
  *((_QWORD *)this + 39) = 0LL;
  memset_0((char *)this + 56, 0, 0x100uLL);
  v10[1] = 0LL;
  v7 = std::_Allocate<16,std::_Default_allocate_traits>(0x38uLL);
  *v7 = v7;
  v7[1] = v7;
  v7[2] = v7;
  *((_WORD *)v7 + 12) = 257;
