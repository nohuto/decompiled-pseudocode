/*
 * XREFs of ?CreateCUIHostInputObjectProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x1801184C0
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *v6 = &CUIHostInputObjectProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v6[1] = &CUIHostInputObjectProxy::`vftable'{for `ICUIHostInputObjectProxy'};
