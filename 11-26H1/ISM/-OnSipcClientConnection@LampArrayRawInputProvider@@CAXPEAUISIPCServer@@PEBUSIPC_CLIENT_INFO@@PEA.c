/*
 * XREFs of ?OnSipcClientConnection@LampArrayRawInputProvider@@CAXPEAUISIPCServer@@PEBUSIPC_CLIENT_INFO@@PEAX@Z @ 0x1800E4200
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1?$unique_ptr@ULampArrayClientListEntry@LampArrayRawInputProvider@@U?$default_delete@ULampArrayClientListEntry@LampArrayRawInputProvider@@@std@@@std@@QEAA@XZ @ 0x1800E332C (--1-$unique_ptr@ULampArrayClientListEntry@LampArrayRawInputProvider@@U-$default_delete@ULampArra.c)
        ...
        RTL_SRWLOCK *a3)
{
  ...
  v17 = v8;
  if ( (*(int (__fastcall **)(struct ISIPCServer *, __int64, void (__fastcall *)(BamoImpl::BamoMPCConstantManagerClientProxyImpl *, struct Microsoft::BamoImpl::BamoProxyImpl *), void (__fastcall *)(__int64, int, __int64), RTL_SRWLOCK *, RTL_SRWLOCK *))(*(_QWORD *)a1 + 24LL))(
         a1,
         Ptr_low,
         ...
         v8 + 2) >= 0 )
  {
    ...
    *((_QWORD *)v3 + 1) = v10;
    ...
    v14 = a3 + 9;
    for ( j = (LampArrayDevice *)a3[9].Ptr; j != (LampArrayDevice *)v14; j = *(LampArrayDevice **)j )
      LampArrayDevice::AddViewClient(*((LampArrayDevice **)j + 2), v11);
    if ( *((_DWORD *)a2 + 8) == LODWORD(a3[8].Ptr) )
    {
      for ( k = (struct LampArrayDevice *)v14->Ptr; k != (struct LampArrayDevice *)v14; k = *(struct LampArrayDevice **)k )
...
LABEL_16:
  ...
  std::unique_ptr<LampArrayRawInputProvider::LampArrayClientListEntry>::~unique_ptr<LampArrayRawInputProvider::LampArrayClientListEntry>(
    (LampArrayRawInputProvider::LampArrayClientListEntry **)&v17,
    v9);
}
