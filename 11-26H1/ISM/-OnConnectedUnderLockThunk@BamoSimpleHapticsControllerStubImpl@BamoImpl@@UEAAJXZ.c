/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoSimpleHapticsControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180189E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSimpleHapticsControllerStubImpl::OnConnectedUnderLockThunk(
