/*
 * XREFs of ??_ETapProcessor@@EEAAPEAXI@Z @ 0x1801B67A0
 * Callers:
 *     ??_ETapProcessor@@GBA@EAAPEAXI@Z @ 0x1801B6790 (--_ETapProcessor@@GBA@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1TapProcessor@@EEAA@XZ @ 0x1801B66F8 (--1TapProcessor@@EEAA@XZ.c)
 */
