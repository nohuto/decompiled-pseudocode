/*
 * XREFs of ??4PointerFrame@PointerInputMediator@@QEAAAEAU01@$$QEAU01@@Z @ 0x180062910
 * Callers:
 ...
 * Callees:
 *     ??4?$vector@IV?$allocator@I@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x18009677C (--4-$vector@IV-$allocator@I@std@@@std@@QEAAAEAV01@$$QEAV01@@Z.c)
