/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x18013B8F8
 * Callers:
 *     ?Thunk_UnregisterObserverClientOfType_264@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013B8C0 (-Thunk_UnregisterObserverClientOfType_264@-$IInputObserverManagerPrincipal_Receive@VBamoInputObs.c)
 * Callees:
