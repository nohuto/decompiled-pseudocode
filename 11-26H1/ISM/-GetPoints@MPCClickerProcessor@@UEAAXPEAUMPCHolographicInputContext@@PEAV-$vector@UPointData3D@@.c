/*
 * XREFs of ?GetPoints@MPCClickerProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801C8F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCClickerProcessor::GetPoints(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&v17 = v5;
  ...
  v25 = 0;
  v32 = v15;
  return std::vector<PointData3D>::_Emplace_one_at_back<PointData3D const &>(a3, &v17);
}
