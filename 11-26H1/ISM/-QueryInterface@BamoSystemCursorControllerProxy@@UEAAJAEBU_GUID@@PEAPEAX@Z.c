/*
 * XREFs of ?QueryInterface@BamoSystemCursorControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801254C0
 * Callers:
 *     ?QueryInterface@BamoSystemCursorControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180125540 (-QueryInterface@BamoSystemCursorControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoSystemCursorControllerProxy *)-8LL )
    return (unsigned int)-2147467262;
