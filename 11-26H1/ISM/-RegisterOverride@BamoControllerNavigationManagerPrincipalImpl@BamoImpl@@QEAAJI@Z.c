/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18017A39C
 * Callers:
 *     ?Thunk_RegisterOverride_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017A840 (-Thunk_RegisterOverride_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigat.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoControllerNavigationOverrideProxy *v10; // rbp
  ...
  BamoImpl::BamoControllerNavigationManagerPrincipalImpl::LogReceiveRegisterOverride(this, v10);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v8,
      (__int64)this);
    v17 = (*(__int64 (__fastcall **)(char *, __int64, struct BamoControllerNavigationOverrideProxy *))(*((_QWORD *)this - 2) + 120LL))(
            (char *)this - 16,
            v6,
            v10);
    v4 = v17;
