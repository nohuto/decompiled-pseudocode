/*
 * XREFs of ?GetConstant@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@PEBGI@Z @ 0x1800B3B8C
 * Callers:
 *     ?Thunk_GetConstant_16@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B51C0 (-Thunk_GetConstant_16@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClient.c)
 * Callees:
