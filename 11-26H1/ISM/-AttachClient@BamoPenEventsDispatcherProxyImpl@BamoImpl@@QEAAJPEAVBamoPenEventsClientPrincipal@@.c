/*
 * XREFs of ?AttachClient@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJPEAVBamoPenEventsClientPrincipal@@@Z @ 0x180117E50
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( *((_BYTE *)this + 31) )
      {
        v12 = (__int64 **)((char *)v17 - 16);
        if ( !v17 )
          v12 = 0LL;
        *((_BYTE *)v12 + 72) = 1;
        Microsoft::BamoImpl::BufferingMessageCallHost::AddPrincipalParameter(v12, a2);
      }
      BamoImpl::BamoPenEventsDispatcherProxyImpl::LogSendAttachClient(this, v8);
      v13[0] = v15;
      v13[1] = v16;
