/*
 * XREFs of ??0?$merged_data@U_tip_HapticTouchpadAttachedTipTest_attributes@@Vtest_data_basic@tip2@@@details@tip2@@QEAA@XZ @ 0x18018D774
 * Callers:
...
__int64 __fastcall tip2::details::merged_data<_tip_HapticTouchpadAttachedTipTest_attributes,tip2::test_data_basic>::merged_data<_tip_HapticTouchpadAttachedTipTest_attributes,tip2::test_data_basic>(
        __int64 a1)
{
  __int64 result; // rax
