/*
 * XREFs of ?OnWindowsMessageDeliveryChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180051250
 * Callers:
 *     <none>
 * Callees:
 *     ??$RemoveObject@UIWindowsMessageDeliveryProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800512C8 (--$RemoveObject@UIWindowsMessageDeliveryProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
