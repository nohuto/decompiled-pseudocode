        ...
        __int64 a16)
{
  ...
  const unsigned __int16 *v31; // [rsp+90h] [rbp-70h]
  ...
  v26 = 4LL;
  v24 = 8LL;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 14, v22);
}
