    ...
    else
    {
      ...
      if ( CanCastTo == -2147467262 )
      {
        ...
        if ( InlineIsEqualGUID(a2, &GUID_00000038_0000_0000_c000_000000000046)
          || (v10 += 8, InlineIsEqualGUID(v11, &GUID_92b02cd3_aa6e_573d_bc03_8d2309cba3eb)) )
        {
          *v8 = v10;
          CanCastTo = 0;
        }
