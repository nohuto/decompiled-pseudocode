        ...
        _DWORD *a3)
{
  ...
  _DWORD *v20; // [rsp+70h] [rbp+30h] BYREF
  int v21; // [rsp+80h] [rbp+40h] BYREF

  v21 = *a3;
  LODWORD(v20) = a3[1];
  v6 = std::_Conditionally_enabled_hash<enum TestCommandMessageType,1>::operator()((unsigned __int8 *)&v20);
  v7 = std::_Conditionally_enabled_hash<enum TestCommandMessageType,1>::operator()((unsigned __int8 *)&v21) ^ v6;
  ...
  else
  {
    ...
    v18 = a1 + 2;
    v19 = 0LL;
    v8 = (_QWORD *)std::_Allocate<16,std::_Default_allocate_traits>(64LL);
    v19 = v8;
    v20 = a3;
    ____0AEBUtagMsgRoutingInfo____Z__V___pair___CBUtagMsgRoutingInfo__PEAUIInputTarget___std__QEAA_Upiecewise_construct_t_1_V__tuple_AEBUtagMsgRoutingInfo___1_V__tuple___V_1__Z(
      v8 + 2,
      v9,
      &v20);
    v10 = *((_QWORD *)a1 + 2) + 1LL;
    ...
    if ( (float)(v11 / v13) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<tagMsgRoutingInfo,IInputTarget *,std::_Uhash_compare<tagMsgRoutingInfo,RoutingInfoHash,std::equal_to<tagMsgRoutingInfo>>,std::allocator<std::pair<tagMsgRoutingInfo const,IInputTarget *>>,0>>::_Forced_rehash(
        a1,
        v16);
      v17 = *(_OWORD *)std::_Hash<std::_Umap_traits<tagMsgRoutingInfo,IInputTarget *,std::_Uhash_compare<tagMsgRoutingInfo,RoutingInfoHash,std::equal_to<tagMsgRoutingInfo>>,std::allocator<std::pair<tagMsgRoutingInfo const,IInputTarget *>>,0>>::_Find_last<tagMsgRoutingInfo>(
                         a1,
                         &v18,
                         v8 + 2,
                         v7);
