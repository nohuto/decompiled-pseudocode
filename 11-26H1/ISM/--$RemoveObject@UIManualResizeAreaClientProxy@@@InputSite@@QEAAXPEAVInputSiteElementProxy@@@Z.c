/*
 * XREFs of ??$RemoveObject@UIManualResizeAreaClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003F3A8
 * Callers:
...
void __fastcall InputSite::RemoveObject<IManualResizeAreaClientProxy>(__int64 a1, __int64 a2)
{
  __int64 v4; // r12
  __int64 *v5; // r14
  __int64 *v6; // r15
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_cae9ba0c_34ca_09ed_6155_b69e3ed14be6, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
