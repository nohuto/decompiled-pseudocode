/*
 * XREFs of ?LogOnTouchpadRectsChanging@BamoSystemContextEndpointPrincipal@@AEAAXPEAVBamoSystemContextEndpointStub@@PEAVBamoList_VirtualTouchpadRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x1800A9E64
 * Callers:
...
void __fastcall BamoSystemContextEndpointPrincipal::LogOnTouchpadRectsChanging(
        struct Microsoft::BamoImpl::ConnectionIndirector **this,
        struct BamoSystemContextEndpointStub *a2,
        struct Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_VirtualTouchpadRect_Proxy *a3)
{
  __int64 v3; // rdi
  int v4; // ebx
  __int64 v7; // r8
