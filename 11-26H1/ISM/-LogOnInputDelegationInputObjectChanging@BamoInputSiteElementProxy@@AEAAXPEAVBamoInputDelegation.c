/*
 * XREFs of ?LogOnInputDelegationInputObjectChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoInputDelegationInputObjectProxy@@@Z @ 0x18008BB64
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnInputDelegationInputObjectChanging(
