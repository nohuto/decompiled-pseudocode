/*
 * XREFs of ??$RemoveObject@UIMagnifierControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18003EE00
 * Callers:
...
void __fastcall InputSite::RemoveObject<IMagnifierControllerProxy>(__int64 a1, __int64 a2)
{
  __int64 v4; // r12
  __int64 *v5; // r14
  __int64 *v6; // r15
