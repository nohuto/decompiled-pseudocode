/*
 * XREFs of ?LogSendTailButtonLongPressed@BamoPenEventsClientProxyImpl@BamoImpl@@AEAAX_N@Z @ 0x1801998B4
 * Callers:
...
void __fastcall BamoImpl::BamoPenEventsClientProxyImpl::LogSendTailButtonLongPressed(
