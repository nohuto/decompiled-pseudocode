/*
 * XREFs of wil::init_once_nothrow__lambda_2e51b86642a92e3b17e4afda222f3187___ @ 0x1801A60EC
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !__std_init_once_begin_initialize(&stru_180254CD8, 0, &fPending, 0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x36C, (int)"wil", v4);
  if ( fPending )
  {
    v6 = DisplayOcclusionContextProvider::Create(&qword_180255000);
    v7 = v6;
    if ( v6 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x371, (int)"wil", (const char *)(unsigned int)v6);
      InitOnceComplete(&stru_180254CD8, 4u, 0LL);
      return v7;
    }
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_180254CD8, 0, 0LL);
  }
  return 0LL;
}
