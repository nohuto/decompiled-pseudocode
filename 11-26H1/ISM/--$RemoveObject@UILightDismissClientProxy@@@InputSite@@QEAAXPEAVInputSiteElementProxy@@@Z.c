/*
 * XREFs of ??$RemoveObject@UILightDismissClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005A988
 * Callers:
...
void __fastcall InputSite::RemoveObject<ILightDismissClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_fb76c7b1_2a7b_dedb_3bb3_6fad8f50be6b, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
