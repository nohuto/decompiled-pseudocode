/*
 * XREFs of ??A?$unordered_map@_K_KU?$hash@_K@std@@U?$equal_to@_K@2@V?$allocator@U?$pair@$$CB_K_K@std@@@2@@std@@QEAAAEA_K$$QEA_K@Z @ 0x1800FABE4
 * Callers:
...
__int64 __fastcall std::unordered_map<unsigned __int64,unsigned __int64>::operator[](_QWORD *a1, unsigned __int8 *a2)
{
