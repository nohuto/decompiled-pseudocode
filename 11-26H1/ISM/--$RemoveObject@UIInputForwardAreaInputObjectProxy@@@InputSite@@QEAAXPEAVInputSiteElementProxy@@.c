/*
 * XREFs of ??$RemoveObject@UIInputForwardAreaInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005BE98
 * Callers:
...
void __fastcall InputSite::RemoveObject<IInputForwardAreaInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_9b6ce49a_112f_7a65_85c1_1bc9826244ec, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
