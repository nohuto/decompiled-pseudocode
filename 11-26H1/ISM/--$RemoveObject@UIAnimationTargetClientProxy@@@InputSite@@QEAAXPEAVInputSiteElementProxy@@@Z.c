/*
 * XREFs of ??$RemoveObject@UIAnimationTargetClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005A6F4
 * Callers:
...
void __fastcall InputSite::RemoveObject<IAnimationTargetClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_14a24c33_0307_d5c2_9e57_990b25f87532, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
