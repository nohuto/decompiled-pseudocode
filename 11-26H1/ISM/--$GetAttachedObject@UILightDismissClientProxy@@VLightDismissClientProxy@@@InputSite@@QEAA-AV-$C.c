/*
 * XREFs of ??$GetAttachedObject@UILightDismissClientProxy@@VLightDismissClientProxy@@@InputSite@@QEAA?AV?$ComPtr@VLightDismissClientProxy@@@WRL@Microsoft@@XZ @ 0x1801601A0
 * Callers:
 ...
 *     ??$As@UILightDismissClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UILightDismissClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18005A8BC (--$As@UILightDismissClientProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$ComPt.c)
