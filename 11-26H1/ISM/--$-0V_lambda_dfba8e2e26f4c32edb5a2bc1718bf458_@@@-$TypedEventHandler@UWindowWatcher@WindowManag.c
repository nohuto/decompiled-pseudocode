/*
 * XREFs of ??$?0V_lambda_dfba8e2e26f4c32edb5a2bc1718bf458_@@@?$TypedEventHandler@UWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UWindowChangedEventArgs@23456@@Foundation@Windows@winrt@@QEAA@V_lambda_dfba8e2e26f4c32edb5a2bc1718bf458_@@@Z @ 0x1800A5610
 * Callers:
        ...
        __int128 *a2)
{
  ...
  *(_QWORD *)v6 = &winrt::impl::delegate<winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Internal::ApplicationModel::WindowManagement::WindowWatcher,winrt::Windows::Internal::ApplicationModel::WindowManagement::WindowChangedEventArgs>,_lambda_2deb2f955f0614de05a4052d98264887_>::`vftable';
  *a1 = v6;
  return a1;
}
