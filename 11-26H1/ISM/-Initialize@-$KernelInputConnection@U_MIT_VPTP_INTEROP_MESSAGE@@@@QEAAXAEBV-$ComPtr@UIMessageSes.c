/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_VPTP_INTEROP_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_VPTP_INTEROP_MESSAGE@@@Z@std@@@Z @ 0x18004257C
 * Callers:
 ...
 *     ??4?$function@$$A6AXPEBU_MIT_PEN_EVENT_MESSAGE@@@Z@std@@QEAAAEAV01@AEBV01@@Z @ 0x180041BAC (--4-$function@$$A6AXPEBU_MIT_PEN_EVENT_MESSAGE@@@Z@std@@QEAAAEAV01@AEBV01@@Z.c)
...
__int64 __fastcall KernelInputConnection<_MIT_VPTP_INTEROP_MESSAGE>::Initialize(
        _QWORD *a1,
        _QWORD *a2,
        __int64 a3,
        __int64 a4)
  ...
  *((_DWORD *)a1 + 34) = 18;
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
      ...
      a1[1]);
    v21 = (_DWORD)a1 + 16;
    v16 = v15(v14, KernelInputConnection<_MIT_PEN_EVENT_MESSAGE>::s_OnKernelInputEventStatic, a1, *a1);
    if ( v16 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x43,
    ...
    if ( v17 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v21);
    v18 = NtMITCoreMsgKOpenConnectionTo(18LL, a1 + 3);
    if ( v18 < 0 )
