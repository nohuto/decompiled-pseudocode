/*
 * XREFs of ?AnimationEnded@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x1801472C0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDragManagerClientProxyImpl::AnimationEnded(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      BamoImpl::BamoDragManagerClientProxyImpl::LogSendAnimationEnded(this, a2);
      v12[0] = v14;
      v12[1] = v15;
