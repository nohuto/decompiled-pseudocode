/*
 * XREFs of ?LogSendDestroyCursorShape@BamoSystemCursorControllerProxyImpl@BamoImpl@@AEAAX_K0@Z @ 0x18011D970
 * Callers:
...
void __fastcall BamoImpl::BamoSystemCursorControllerProxyImpl::LogSendDestroyCursorShape(
