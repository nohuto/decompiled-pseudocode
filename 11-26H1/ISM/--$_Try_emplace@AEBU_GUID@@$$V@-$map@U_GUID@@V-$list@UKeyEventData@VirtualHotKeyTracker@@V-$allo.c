        ...
        const void *a3)
{
  ...
  _OWORD *v13; // [rsp+90h] [rbp+30h] BYREF
  ...
  if ( *((_BYTE *)v8 + 25) || memcmp_0(a3, v8 + 4, 0x10uLL) < 0 )
  {
    ...
    *(_QWORD *)&v11 = a1;
    v9 = std::_Allocate<16,std::_Default_allocate_traits>(0x40uLL);
    v13 = a3;
    ____0V__tuple_AEBU_GUID___std__V__tuple___V_1__0A___Z_S___pair___CBU_GUID__V__list_UKeyEventData_VirtualHotKeyTracker__V__allocator_UKeyEventData_VirtualHotKeyTracker___std___std___std__AEAA_AEAV__tuple_AEBU_GUID___1_AEAV__tuple___V_1_U__integer_sequence__K_0A__1_U__integer_sequence__K_S_1__Z(
      (__int64)(v9 + 4),
      &v13);
    *v9 = v6;
    v9[1] = v6;
