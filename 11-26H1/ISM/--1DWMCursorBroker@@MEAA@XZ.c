/*
 * XREFs of ??1DWMCursorBroker@@MEAA@XZ @ 0x1801CB8FC
 * Callers:
...
void __fastcall DWMCursorBroker::~DWMCursorBroker(DWMCursorBroker *this)
{
  ...
  *((_QWORD *)this + 3) = &DWMCursorBroker::`vftable'{for `RefCountedObject'};
  ...
  if ( v6 )
  {
    std::_Deallocate<16>(v6, (struct std::nothrow_t *)(8 * ((__int64)(*((_QWORD *)this + 62) - (_QWORD)v6) >> 3)));
    *((_QWORD *)this + 60) = 0LL;
    *((_QWORD *)this + 61) = 0LL;
    *((_QWORD *)this + 62) = 0LL;
  }
