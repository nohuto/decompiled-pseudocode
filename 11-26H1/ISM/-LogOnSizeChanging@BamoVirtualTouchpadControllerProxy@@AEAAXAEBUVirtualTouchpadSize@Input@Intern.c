/*
 * XREFs of ?LogOnSizeChanging@BamoVirtualTouchpadControllerProxy@@AEAAXAEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x180138428
 * Callers:
