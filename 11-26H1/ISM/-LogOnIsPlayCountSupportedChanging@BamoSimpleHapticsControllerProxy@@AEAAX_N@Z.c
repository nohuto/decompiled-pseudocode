/*
 * XREFs of ?LogOnIsPlayCountSupportedChanging@BamoSimpleHapticsControllerProxy@@AEAAX_N@Z @ 0x18011BE10
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsPlayCountSupportedChanging(
