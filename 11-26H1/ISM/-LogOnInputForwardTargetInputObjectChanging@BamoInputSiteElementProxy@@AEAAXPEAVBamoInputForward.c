/*
 * XREFs of ?LogOnInputForwardTargetInputObjectChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoInputForwardTargetInputObjectProxy@@@Z @ 0x18008C32C
 * Callers:
