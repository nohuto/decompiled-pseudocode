/*
 * XREFs of ?FindRegisteredHotKey@HotKeyProcessor@@AEAAJIIIIU_GUID@@PEAV?$shared_ptr@UHotKeyInfo@@@std@@PEAPEAVHotkeyClientRegistration@@@Z @ 0x1801D04B0
 * Callers:
        ...
        const unsigned __int16 *a8)
{
  ...
  _QWORD **v57; // [rsp+D0h] [rbp-19h] BYREF
  ...
  *(_OWORD *)v46 = 0LL;
  ...
  if ( (unsigned int)dword_180251328 > 5 && tlgKeywordOn((__int64)&dword_180251328, 393216LL) )
  {
  ...
  for ( i = *v57; ; i = (_QWORD *)*i )
  {
    ...
    std::shared_ptr<SystemCursorShapeBitmap2>::shared_ptr<SystemCursorShapeBitmap2>(v46, i + 2);
    *(_OWORD *)v56 = 0LL;
...
LABEL_60:
      std::_Deallocate<16>(v57, (struct std::nothrow_t *)0x20);
