/*
 * XREFs of ?LogSetInputSiteManager@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputSiteManagerPrincipal@@@Z @ 0x180090688
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetInputSiteManager(
