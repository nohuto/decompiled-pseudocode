/*
 * XREFs of ?ToggleDetected@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJAEBUPoint@Foundation@Windows@@@Z @ 0x18015B9A0
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoMagnifierControllerProxyImpl::LogSendToggleDetected(this, v9);
      v13 = *a2;
      v14[0] = v16;
      v14[1] = v17;
      v18 = v13;
