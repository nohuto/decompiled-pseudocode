/*
 * XREFs of ??R?$default_delete@VTestCommandHost@@@std@@QEBAXPEAVTestCommandHost@@@Z @ 0x18010CE10
 * Callers:
 *     ?Initialize@TestCommandHost@@SAXXZ @ 0x180099810 (-Initialize@TestCommandHost@@SAXXZ.c)
 *     _dynamic_atexit_destructor_for__TestCommandHost::m_instance__ @ 0x1801DDCD0 (_dynamic_atexit_destructor_for__TestCommandHost--m_instance__.c)
 * Callees:
