/*
 * XREFs of ?UpdateGestureServices@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012BE68
 * Callers:
 *     ?Thunk_UpdateGestureServices_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129430 (-Thunk_UpdateGestureServices_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@.c)
...
__int64 __fastcall BamoImpl::BamoInputSystemProxyImpl::UpdateGestureServices(
        ...
        __int64 a3)
{
  ...
  struct BamoGestureServicesProxy *v7; // rsi
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemProxy::LogOnGestureServicesChanging((BamoImpl::BamoInputSystemProxyImpl *)((char *)this - 16), v7);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      1);
    v12 = (*(__int64 (__fastcall **)(char *, struct BamoGestureServicesProxy *))(*((_QWORD *)this - 2) + 168LL))(
            (char *)this - 16,
            v7);
    if ( v12 < 0 )
  ...
  *((_QWORD *)this + 8) = v7;
  if ( v7 )
    (**(void (__fastcall ***)(struct BamoGestureServicesProxy *))v7)(v7);
  if ( v13 )
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoInputSystemProxy::LogOnGestureServicesChanged((BamoImpl::BamoInputSystemProxyImpl *)((char *)this - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v14 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 176LL))((char *)this - 16);
    if ( v14 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x405D,
