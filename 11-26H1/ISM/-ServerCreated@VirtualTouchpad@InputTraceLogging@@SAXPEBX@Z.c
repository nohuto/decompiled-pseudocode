/*
 * XREFs of ?ServerCreated@VirtualTouchpad@InputTraceLogging@@SAXPEBX@Z @ 0x1801394C0
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerCreated(const void *a1)
{
