/*
 * XREFs of ?Materialize_BamoMPCManagerProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B7850
 * Callers:
 *     ?Thunk_Materialize_BamoMPCManagerProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B90A0 (-Thunk_Materialize_BamoMPCManagerProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v11 = &BamoMPCManagerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v11[1] = &BamoMPCManagerProxy::`vftable'{for `IMPCManagerProxy'};
  *((_DWORD *)v11 + 6) = 0;
  v11[4] = 0LL;
  v11[5] = 0LL;
  v11[2] = &BamoImpl::BamoMPCManagerProxyImpl::`vftable';
  v11[6] = 0LL;
