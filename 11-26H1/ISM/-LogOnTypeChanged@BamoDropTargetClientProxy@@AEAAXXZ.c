/*
 * XREFs of ?LogOnTypeChanged@BamoDropTargetClientProxy@@AEAAXXZ @ 0x18011CD6C
 * Callers:
...
void __fastcall BamoDropTargetClientProxy::LogOnTypeChanged(BamoDropTargetClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
