/*
 * XREFs of ?UpdateGestureMinimumDistanceInHimetrics@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012B9FC
 * Callers:
 *     ?Thunk_UpdateGestureMinimumDistanceInHimetrics_8@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801293D0 (-Thunk_UpdateGestureMinimumDistanceInHimetrics_8@-$IEdgyGestureRecognitionConfigurationProxy_Rec.c)
