/*
 * XREFs of ?EnsureMouseCursorForDesktopPen@CursorNotificationProcessor@@AEAAJPEAUICursorBroker@@@Z @ 0x1800F5268
 * Callers:
        ...
        struct ICursorBroker *a2)
{
  ...
  __int64 v5; // r9
  __int64 v6; // rax
  __int64 (__fastcall *v7)(struct ICursorBroker *, int *, __int64, __int64 *); // rbx
  int v8; // eax
  unsigned int v9; // ebx
  ...
  v12 = 2LL;
  v11 = 0;
  v7 = *(__int64 (__fastcall **)(struct ICursorBroker *, int *, __int64, __int64 *))(v6 + 24);
  Microsoft::WRL::ComPtr<Windows::Foundation::Collections::IVector<HSTRING__ *>>::InternalRelease(v2);
  v8 = v7(a2, &v11, 1LL, v2);
  v9 = v8;
  if ( v8 >= 0 )
