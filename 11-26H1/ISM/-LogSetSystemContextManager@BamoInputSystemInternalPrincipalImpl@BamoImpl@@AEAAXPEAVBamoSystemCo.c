/*
 * XREFs of ?LogSetSystemContextManager@BamoInputSystemInternalPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemContextManagerPrincipal@@@Z @ 0x180091238
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemInternalPrincipalImpl::LogSetSystemContextManager(
