 ...
 *     ??$?0AEB_K$$Z$$V@?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@QEAA@Upiecewise_construct_t@1@V?$tuple@AEB_K@1@V?$tuple@$$V@1@@Z @ 0x180146F60 (--$-0AEB_K$$Z$$V@-$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@QEAA@Upiece.c)
 *     ?_Forced_rehash@?$_Hash@V?$_Umap_traits@_KUGestureAnimationData@Input@Internal@UI@Windows@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@@7@$0A@@std@@@std@@IEAAX_K@Z @ 0x180148C74 (-_Forced_rehash@-$_Hash@V-$_Umap_traits@_KUGestureAnimationData@Input@Internal@UI@Windows@@V-$_U.c)
 */
        ...
        unsigned __int8 *a3)
{
  ...
  unsigned __int8 *v20; // [rsp+60h] [rbp+20h] BYREF
  ...
  else
  {
    ...
    v18 = v8;
    v20 = a3;
    ____0AEB_K__Z__V___pair___CB_KUGestureAnimationData_Input_Internal_UI_Windows___std__QEAA_Upiecewise_construct_t_1_V__tuple_AEB_K_1_V__tuple___V_1__Z(
      (__int64)(v8 + 2),
      v9,
      (__int64)&v20);
    v10 = *((_QWORD *)a1 + 2) + 1LL;
    ...
    if ( (float)(v11 / v13) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<unsigned __int64,Windows::UI::Internal::Input::GestureAnimationData,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,Windows::UI::Internal::Input::GestureAnimationData>>,0>>::_Forced_rehash(
        a1,
        v15);
      v19 = *(_OWORD *)std::_Hash<std::_Umap_traits<unsigned __int64,Windows::UI::Internal::Input::GestureAnimationData,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,Windows::UI::Internal::Input::GestureAnimationData>>,0>>::_Find_last<unsigned __int64>(
                         a1,
                         &v19,
                         v8 + 2,
                         v6);
