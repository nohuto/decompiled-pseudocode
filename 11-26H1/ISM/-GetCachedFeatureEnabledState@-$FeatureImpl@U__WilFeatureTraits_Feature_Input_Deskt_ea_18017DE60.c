/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_MenuFix@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18017DE60
 * Callers:
  ...
  if ( (v3 & 6) != 6 )
  {
    ...
    if ( (v10 & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_180254D7C
        || (v13[0] = 3LL,
            v13[1] = Feature_Input_DesktopNavigationGamepad_MenuFix__descriptor,
