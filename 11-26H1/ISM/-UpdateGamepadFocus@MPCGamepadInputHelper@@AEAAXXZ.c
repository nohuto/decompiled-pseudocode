/*
 * XREFs of ?UpdateGamepadFocus@MPCGamepadInputHelper@@AEAAXXZ @ 0x18000C514
 * Callers:
...
void __fastcall MPCGamepadInputHelper::UpdateGamepadFocus(MPCGamepadInputHelper *this)
{
  const char *v2; // r9
  unsigned int v3; // ecx
  bool v4; // [rsp+50h] [rbp-28h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+78h] [rbp+0h]
  bool v6; // [rsp+88h] [rbp+10h] BYREF
  bool v7; // [rsp+90h] [rbp+18h] BYREF
  bool v8; // [rsp+98h] [rbp+20h] BYREF
