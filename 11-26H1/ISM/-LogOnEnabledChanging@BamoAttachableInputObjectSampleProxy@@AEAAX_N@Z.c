/*
 * XREFs of ?LogOnEnabledChanging@BamoAttachableInputObjectSampleProxy@@AEAAX_N@Z @ 0x18011AB04
 * Callers:
...
void __fastcall BamoAttachableInputObjectSampleProxy::LogOnEnabledChanging(BamoAttachableInputObjectSampleProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
