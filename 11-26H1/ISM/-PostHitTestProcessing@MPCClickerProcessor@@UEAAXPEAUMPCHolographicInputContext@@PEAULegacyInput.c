/*
 * XREFs of ?PostHitTestProcessing@MPCClickerProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAULegacyInputInfo@@@Z @ 0x1801C93B0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( IsPrimary )
  {
    *(_DWORD *)(this + 3644) = *((_DWORD *)a3 + 567);
    if ( *((_BYTE *)a3 + 240) )
    {
      ...
      MPCGestureHandlerManager::DownLevelTo2D(Instance, a3, v11, v12);
    }
  }
}
