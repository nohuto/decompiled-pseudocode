/*
 * XREFs of ?LogOnFeaturesChanged@BamoControllerNavigationOverrideProxy@@AEAAXXZ @ 0x18017AE90
 * Callers:
...
void __fastcall BamoControllerNavigationOverrideProxy::LogOnFeaturesChanged(
