/*
 * XREFs of ??$_Emplace_hint@AEBU?$pair@$$CBGW4WaveformFlags@@@std@@@?$_Tree@V?$_Tmap_traits@GW4WaveformFlags@@U?$less@G@std@@V?$allocator@U?$pair@$$CBGW4WaveformFlags@@@std@@@3@$0A@@std@@@std@@IEAAPEAU?$_Tree_node@U?$pair@$$CBGW4WaveformFlags@@@std@@PEAX@1@QEAU21@AEBU?$pair@$$CBGW4WaveformFlags@@@1@@Z @ 0x18019D6B4
 * Callers:
 ...
 *     ??$?0AEBU?$pair@$$CBGW4WaveformFlags@@@std@@@?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CBGW4WaveformFlags@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_Tree_node@U?$pair@$$CBGW4WaveformFlags@@@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CBGW4WaveformFlags@@@std@@PEAX@1@AEBU?$pair@$$CBGW4WaveformFlags@@@1@@Z @ 0x18019D20C (--$-0AEBU-$pair@$$CBGW4WaveformFlags@@@std@@@-$_Tree_temp_node@V-$allocator@U-$_Tree_node@U-$pai.c)
        ...
        _QWORD *a3)
{
  ...
  if ( (_BYTE)v11 )
    return v5;
  if ( qword_180254070 == 0x666666666666666LL )
