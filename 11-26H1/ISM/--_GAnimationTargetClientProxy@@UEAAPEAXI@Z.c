/*
 * XREFs of ??_GAnimationTargetClientProxy@@UEAAPEAXI@Z @ 0x18007C750
 * Callers:
 *     <none>
 * Callees:
...
AnimationTargetClientProxy *__fastcall AnimationTargetClientProxy::`scalar deleting destructor'(
