/*
 * XREFs of ?Materialize_BamoWindowsMessageDeliveryProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18004CEE0
 * Callers:
 *     ?Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004CED0 (-Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBam.c)
 * Callees:
...
__int64 __fastcall BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl::Materialize_BamoWindowsMessageDeliveryProxy(
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  v12 = 0LL;
  BamoImpl::CreateWindowsMessageDeliveryProxy(
