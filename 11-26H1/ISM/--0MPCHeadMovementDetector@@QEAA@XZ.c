/*
 * XREFs of ??0MPCHeadMovementDetector@@QEAA@XZ @ 0x1800D08D8
 * Callers:
 ...
 *     ?ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x180072C68 (-ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ.c)
 ...
 *     ??4?$com_ptr_t@UIPerceptionTimestampHelperStaticsInternal@Internal@Perception@Windows@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800C180C (--4-$com_ptr_t@UIPerceptionTimestampHelperStaticsInternal@Internal@Perception@Windows@@Uerr_exce.c)
