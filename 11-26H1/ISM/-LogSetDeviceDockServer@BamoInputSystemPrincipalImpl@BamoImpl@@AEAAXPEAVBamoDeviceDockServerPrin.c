/*
 * XREFs of ?LogSetDeviceDockServer@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoDeviceDockServerPrincipal@@@Z @ 0x180090348
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetDeviceDockServer(
