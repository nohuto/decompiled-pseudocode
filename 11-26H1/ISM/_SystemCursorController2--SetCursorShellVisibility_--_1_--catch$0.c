/*
 * XREFs of _SystemCursorController2::SetCursorShellVisibility_::_1_::catch$0 @ 0x1801DA84B
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorController2::SetCursorShellVisibility_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
