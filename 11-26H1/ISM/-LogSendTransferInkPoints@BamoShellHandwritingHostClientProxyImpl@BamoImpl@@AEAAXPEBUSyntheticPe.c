/*
 * XREFs of ?LogSendTransferInkPoints@BamoShellHandwritingHostClientProxyImpl@BamoImpl@@AEAAXPEBUSyntheticPenInfo@Input@Internal@UI@Windows@@I@Z @ 0x18015EBE4
 * Callers:
