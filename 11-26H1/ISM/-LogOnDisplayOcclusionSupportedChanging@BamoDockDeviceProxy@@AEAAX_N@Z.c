/*
 * XREFs of ?LogOnDisplayOcclusionSupportedChanging@BamoDockDeviceProxy@@AEAAX_N@Z @ 0x18011A8F0
 * Callers:
...
void __fastcall BamoDockDeviceProxy::LogOnDisplayOcclusionSupportedChanging(BamoDockDeviceProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
