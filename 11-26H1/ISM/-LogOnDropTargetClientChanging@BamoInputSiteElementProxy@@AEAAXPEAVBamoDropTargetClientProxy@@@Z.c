/*
 * XREFs of ?LogOnDropTargetClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoDropTargetClientProxy@@@Z @ 0x18008C75C
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnDropTargetClientChanging(
