/*
 * XREFs of ?ManualDragEnded@BamoManualDragAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18014B8D0
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoManualDragAreaClientProxyImpl::LogSendManualDragEnded(this);
      v11[0] = v13;
      v11[1] = v14;
