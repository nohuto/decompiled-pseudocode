/*
 * XREFs of ?QueryInterface@EdgyLegacyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AD440
 * Callers:
 *     ?QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AD500 (-QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
