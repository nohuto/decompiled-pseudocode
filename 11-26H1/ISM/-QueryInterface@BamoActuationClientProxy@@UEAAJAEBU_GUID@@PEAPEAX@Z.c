/*
 * XREFs of ?QueryInterface@BamoActuationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801240F0
 * Callers:
 *     ?QueryInterface@BamoActuationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180124170 (-QueryInterface@BamoActuationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoActuationClientProxy *)-8LL )
    return (unsigned int)-2147467262;
