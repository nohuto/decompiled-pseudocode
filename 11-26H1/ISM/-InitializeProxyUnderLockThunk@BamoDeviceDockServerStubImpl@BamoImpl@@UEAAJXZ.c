/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoDeviceDockServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180069C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDeviceDockServerStubImpl::InitializeProxyUnderLockThunk(
