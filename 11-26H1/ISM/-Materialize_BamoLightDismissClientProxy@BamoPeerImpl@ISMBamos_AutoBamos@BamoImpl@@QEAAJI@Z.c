/*
 * XREFs of ?Materialize_BamoLightDismissClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18004BC5C
 * Callers:
 *     ?Thunk_Materialize_BamoLightDismissClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128E80 (-Thunk_Materialize_BamoLightDismissClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPee.c)
 * Callees:
