/*
 * XREFs of ?SendMaterializeProxy@BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180191460
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoHapticDeviceManagerPrincipalImpl::SendMaterializeProxy(
