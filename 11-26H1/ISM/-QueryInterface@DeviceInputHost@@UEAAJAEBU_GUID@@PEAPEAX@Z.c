/*
 * XREFs of ?QueryInterface@DeviceInputHost@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A2100
 * Callers:
 *     ?QueryInterface@DeviceInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A21C0 (-QueryInterface@DeviceInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
