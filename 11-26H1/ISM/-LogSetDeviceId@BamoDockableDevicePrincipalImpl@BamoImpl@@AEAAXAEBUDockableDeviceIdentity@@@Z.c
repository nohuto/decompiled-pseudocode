/*
 * XREFs of ?LogSetDeviceId@BamoDockableDevicePrincipalImpl@BamoImpl@@AEAAXAEBUDockableDeviceIdentity@@@Z @ 0x1801836C0
 * Callers:
...
void __fastcall BamoImpl::BamoDockableDevicePrincipalImpl::LogSetDeviceId(
        ...
        const struct DockableDeviceIdentity *a2)
{
  ...
  __int64 v4; // r8
  __int64 v5; // r9
  const struct DockableDeviceIdentity *v6; // [rsp+48h] [rbp+10h] BYREF
