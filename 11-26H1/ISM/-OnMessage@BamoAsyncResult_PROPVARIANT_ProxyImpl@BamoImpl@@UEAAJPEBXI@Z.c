/*
 * XREFs of ?OnMessage@BamoAsyncResult_PROPVARIANT_ProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180168020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_PROPVARIANT_ProxyImpl::OnMessage(
