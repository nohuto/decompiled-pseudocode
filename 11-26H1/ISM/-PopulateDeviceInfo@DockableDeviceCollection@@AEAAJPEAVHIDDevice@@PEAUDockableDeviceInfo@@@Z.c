/*
 * XREFs of ?PopulateDeviceInfo@DockableDeviceCollection@@AEAAJPEAVHIDDevice@@PEAUDockableDeviceInfo@@@Z @ 0x1800DE564
 * Callers:
 ...
 *     ?_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800D355C (-_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??$call@AEAV_lambda_4e2f6834dae5c2d9676db4968b0ab11c_@@@?$factory_cache_entry@UThreadPool@Threading@System@Windows@winrt@@UIThreadPoolStatics@2345@@impl@winrt@@QEAA?A_PAEAV_lambda_4e2f6834dae5c2d9676db4968b0ab11c_@@@Z @ 0x1800DD8E0 (--$call@AEAV_lambda_4e2f6834dae5c2d9676db4968b0ab11c_@@@-$factory_cache_entry@UThreadPool@Thread.c)
 *     winrt::impl::make_delegate_winrt::Windows::System::Threading::WorkItemHandler__lambda_d47f631da3751d72c8a8e135519addbc___ @ 0x1800DDA78 (winrt--impl--make_delegate_winrt--Windows--System--Threading--WorkItemHandler__lambda_d47f631da3.c)
        ...
        struct DockableDeviceInfo *a3)
{
  ...
  struct _HIDP_CAPS *v16; // [rsp+40h] [rbp-C0h] BYREF
  USHORT ValueCapsLength; // [rsp+48h] [rbp-B8h] BYREF
  DockableDeviceCollection **v18; // [rsp+50h] [rbp-B0h] BYREF
  struct _HIDP_CAPS **v19; // [rsp+58h] [rbp-A8h] BYREF
...
LABEL_8:
  ...
  FeatureReportByteLength = v16->FeatureReportByteLength;
  v14 = *(_DWORD *)a3;
  if ( this )
