/*
 * XREFs of ?LogSendRegisterInputSiteElementWithHint@BamoInputSiteManagerProxyImpl@BamoImpl@@AEAAXIAEBUInputSiteId@@@Z @ 0x18011E2AC
 * Callers:
...
void __fastcall BamoImpl::BamoInputSiteManagerProxyImpl::LogSendRegisterInputSiteElementWithHint(
        ...
        const struct InputSiteId *a3)
{
  ...
  const struct InputSiteId *v9; // [rsp+70h] [rbp+18h] BYREF
