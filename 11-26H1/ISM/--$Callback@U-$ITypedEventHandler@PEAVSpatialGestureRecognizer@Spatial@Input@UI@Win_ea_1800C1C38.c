/*
 * XREFs of ??$Callback@U?$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAVSpatialManipulationCompletedEventArgs@2345@@Foundation@Windows@@V_lambda_20075cf9951aa9eeb8e3b219ad4a43a3_@@@WRL@Microsoft@@YA?AV?$ComPtr@U?$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAVSpatialManipulationCompletedEventArgs@2345@@Foundation@Windows@@@01@$$QEAV_lambda_20075cf9951aa9eeb8e3b219ad4a43a3_@@@Z @ 0x1800C1C38
 * Callers:
 ...
 *     ??0?$DelegateInvokeHelper@U?$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAVSpatialManipulationCompletedEventArgs@2345@@Foundation@Windows@@V_lambda_20075cf9951aa9eeb8e3b219ad4a43a3_@@$0?0PEAUISpatialGestureRecognizer@Spatial@Input@UI@3@PEAUISpatialManipulationCompletedEventArgs@6783@@?$DelegateArgTraits@P8?$ITypedEventHandler_impl@U?$AggregateType@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAUISpatialGestureRecognizer@2345@@Internal@Foundation@Windows@@U?$AggregateType@PEAVSpatialManipulationCompletedEventArgs@Spatial@Input@UI@Windows@@PEAUISpatialManipulationCompletedEventArgs@2345@@234@@Foundation@Windows@@EAAJPEAUISpatialGestureRecognizer@Spatial@Input@UI@3@PEAUISpatialManipulationCompletedEventArgs@5673@@Z@Details@WRL@Microsoft@@QEAA@$$QEAV_lambda_20075cf9951aa9eeb8e3b219ad4a43a3_@@@Z @ 0x1800C1FE0 (--0-$DelegateInvokeHelper@U-$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatia_ea_1800C1FE0.c)
 */

__int64 *__fastcall Microsoft::WRL::Callback<Windows::Foundation::ITypedEventHandler<Windows::UI::Input::Spatial::SpatialGestureRecognizer *,Windows::UI::Input::Spatial::SpatialManipulationCompletedEventArgs *>,_lambda_20075cf9951aa9eeb8e3b219ad4a43a3_>(
        __int64 *a1,
        __int64 a2)
{
  __int64 v4; // rbx
