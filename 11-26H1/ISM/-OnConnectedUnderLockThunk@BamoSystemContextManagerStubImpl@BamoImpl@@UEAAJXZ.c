/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoSystemContextManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180140BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemContextManagerStubImpl::OnConnectedUnderLockThunk(
