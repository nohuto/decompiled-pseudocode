/*
 * XREFs of ?UpdateLuid@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_NPEBU_LUID@@@Z @ 0x180075C50
 * Callers:
 *     ?Thunk_UpdateLuid_3@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180075C40 (-Thunk_UpdateLuid_3@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@Bamo.c)
