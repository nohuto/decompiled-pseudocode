/*
 * XREFs of ??1?$unique_ptr@UDeviceNotificationRegistrationData@Details@PnpApiWrapper@@U?$default_delete@UDeviceNotificationRegistrationData@Details@PnpApiWrapper@@@std@@@std@@QEAA@XZ @ 0x1800E7248
 * Callers:
