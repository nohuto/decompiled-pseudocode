/*
 * XREFs of __scrt_fastfail @ 0x18009A500
 * Callers:
 *     dllmain_crt_process_attach @ 0x180099CB8 (dllmain_crt_process_attach.c)
 *     dllmain_crt_process_detach @ 0x180099DD0 (dllmain_crt_process_detach.c)
 *     __scrt_initialize_onexit_tables @ 0x18009A2EC (__scrt_initialize_onexit_tables.c)
 *     __scrt_initialize_thread_safe_statics @ 0x18009AE40 (__scrt_initialize_thread_safe_statics.c)
 * Callees:
 *     __crt_debugger_hook @ 0x18009A4EC (__crt_debugger_hook.c)
