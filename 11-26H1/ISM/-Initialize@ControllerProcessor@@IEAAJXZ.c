/*
 * XREFs of ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x18017E658
 * Callers:
 ...
 *     ?UpdateControllerVirtualKeyMappingEnabled@ControllerProcessor@@AEAAXXZ @ 0x180180954 (-UpdateControllerVirtualKeyMappingEnabled@ControllerProcessor@@AEAAXXZ.c)
...
LABEL_5:
  ...
  if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_GamepadVKey_Initialize>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_GamepadVKey_Initialize>::GetImpl'::`2'::impl) )
    *((_DWORD *)this + 1953) = *((_DWORD *)ISMStatics::GetControllerNavigationManager() + 56);
  if ( IsEdition(8778LL) )
  {
    ...
    else
    {
      ...
      RegistryWatcher::Create(
        ...
        (HKEY)this,
        (void (*)(void *, HKEY))lambda_bd738f18749f600c93b8b250e5986654_::_lambda_invoker_cdecl_,
  ...
  v28 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 4) + 72LL))(*((_QWORD *)this + 4));
