/*
 * XREFs of ?SupportedInputUpdated@GazeProcessor@@UEAAJPEAUIDWMSupportedInputTarget@@@Z @ 0x1801BD740
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Emplace@AEBQEAUIDWMSupportedInputTarget@@@?$list@PEAUIDWMSupportedInputTarget@@V?$allocator@PEAUIDWMSupportedInputTarget@@@std@@@std@@QEAAPEAU?$_List_node@PEAUIDWMSupportedInputTarget@@PEAX@1@QEAU21@AEBQEAUIDWMSupportedInputTarget@@@Z @ 0x1801BCAF0 (--$_Emplace@AEBQEAUIDWMSupportedInputTarget@@@-$list@PEAUIDWMSupportedInputTarget@@V-$allocator@.c)
...
__int64 __fastcall GazeProcessor::SupportedInputUpdated(GazeProcessor *this, struct IDWMSupportedInputTarget *a2)
{
  __int64 v3; // rax
  int v5; // eax
  struct IDWMSupportedInputTarget ***v6; // rdx
  ...
  *(_QWORD *)&v16 = a2;
  ...
  if ( v5 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v15);
  v6 = (struct IDWMSupportedInputTarget ***)*((_QWORD *)this + 42);
  for ( i = *v6; i != (struct IDWMSupportedInputTarget **)v6; i = (struct IDWMSupportedInputTarget **)*i )
  {
    if ( i[2] == a2 )
    {
      if ( (v15 & 0x4000) == 0 )
      {
        ...
        *((_QWORD *)*i + 1) = i[1];
        --*((_QWORD *)this + 43);
        std::_Deallocate<16>(i, (struct std::nothrow_t *)0x18);
        if ( !*((_QWORD *)this + 43) )
        {
          v8 = *((_QWORD *)this + 5);
