/*
 * XREFs of ?AllocateStubUnderLock@BamoControllerNavigationManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoControllerNavigationManagerStub@@@Z @ 0x180070F70
 * Callers:
 *     <none>
 * Callees:
