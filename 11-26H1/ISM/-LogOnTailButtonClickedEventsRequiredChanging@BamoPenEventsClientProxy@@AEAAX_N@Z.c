/*
 * XREFs of ?LogOnTailButtonClickedEventsRequiredChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x180199298
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTailButtonClickedEventsRequiredChanging(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
