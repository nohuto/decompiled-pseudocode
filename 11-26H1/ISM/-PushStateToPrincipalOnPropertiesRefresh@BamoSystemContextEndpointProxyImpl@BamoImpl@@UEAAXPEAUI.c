/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoSystemContextEndpointProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x180143D50
 * Callers:
 *     <none>
 * Callees:
