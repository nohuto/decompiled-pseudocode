/*
 * XREFs of ?QueryInterface@BamoMPCConstantManagerClientPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B4700
 * Callers:
 *     ?QueryInterface@BamoMPCConstantManagerClientPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B4780 (-QueryInterface@BamoMPCConstantManagerClientPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoMPCConstantManagerClientPrincipal *)-8LL )
    return (unsigned int)-2147467262;
