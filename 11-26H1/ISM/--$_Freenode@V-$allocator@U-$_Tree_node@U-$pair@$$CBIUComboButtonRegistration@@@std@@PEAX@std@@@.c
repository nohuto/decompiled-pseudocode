/*
 * XREFs of ??$_Freenode@V?$allocator@U?$_Tree_node@U?$pair@$$CBIUComboButtonRegistration@@@std@@PEAX@std@@@std@@@?$_Tree_node@U?$pair@$$CBIUComboButtonRegistration@@@std@@PEAX@std@@SAXAEAV?$allocator@U?$_Tree_node@U?$pair@$$CBIUComboButtonRegistration@@@std@@PEAX@std@@@1@PEAU01@@Z @ 0x1801A9A08
 * Callers:
...
void __fastcall std::_Tree_node<std::pair<unsigned int const,ComboButtonRegistration>,void *>::_Freenode<std::allocator<std::_Tree_node<std::pair<unsigned int const,ComboButtonRegistration>,void *>>>(
        ...
        __int64 *a2)
{
  std::vector<Windows::UI::Color>::_Tidy(a2 + 6);
  std::_Deallocate<16>(a2, (struct std::nothrow_t *)0x70);
}
