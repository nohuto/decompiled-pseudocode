/*
 * XREFs of ?Create@InputConfigContextProvider@@CAJPEAPEAV1@@Z @ 0x18010C380
 * Callers:
  ...
  *a1 = 0LL;
  ...
  else
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x26,
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\utilities\\systemcontextprovider\\lib\\inputconfigcontextprovider.cpp",
