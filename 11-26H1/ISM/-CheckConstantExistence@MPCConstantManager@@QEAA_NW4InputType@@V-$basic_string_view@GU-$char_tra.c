/*
 * XREFs of ?CheckConstantExistence@MPCConstantManager@@QEAA_NW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x180025B7C
 * Callers:
...
bool __fastcall MPCConstantManager::CheckConstantExistence(__int64 a1, __int64 a2, __int64 a3)
{
  char v5; // bl
  _QWORD *v6; // rax
