/*
 * XREFs of _lambda_ebc29ddd5dd0a3c27fbc9fad58cec528_::operator() @ 0x180012F7C
 * Callers:
  ...
  if ( v4 != v2 )
  {
    ...
    if ( v4 != v2 )
    {
      for ( i = (const struct KeyboardProcessor::TargetingInfo *)(v4 + 384);
            i != (const struct KeyboardProcessor::TargetingInfo *)v2;
            i = (const struct KeyboardProcessor::TargetingInfo *)((char *)i + 384) )
      {
        ...
        if ( v16 != v17 )
        {
          KeyboardProcessor::TargetingInfo::operator=(v4, (__int64)i);
          v4 += 384LL;
        }
      }
      if ( v4 != v2 )
