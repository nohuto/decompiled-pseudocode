/*
 * XREFs of ?OnInput@MagnifierProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801B24F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContextualProcessorResponse *a4)
{
  ...
  *(_QWORD *)(v7 + 24) = *(_QWORD *)MagnifierRecognizer::TimeFromPerfCount(v7 + 32, &v16, *((_QWORD *)a2 + 2));
  ...
  else if ( *(_BYTE *)(v7 + 34) )
  {
    if ( !*(_QWORD *)(v7 + 112) )
    {
      InputTraceLogging::Magnifier::RecognizeTwoFingerPan();
