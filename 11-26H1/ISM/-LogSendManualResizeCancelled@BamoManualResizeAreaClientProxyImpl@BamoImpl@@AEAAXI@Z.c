/*
 * XREFs of ?LogSendManualResizeCancelled@BamoManualResizeAreaClientProxyImpl@BamoImpl@@AEAAXI@Z @ 0x180151AE4
 * Callers:
...
void __fastcall BamoImpl::BamoManualResizeAreaClientProxyImpl::LogSendManualResizeCancelled(
