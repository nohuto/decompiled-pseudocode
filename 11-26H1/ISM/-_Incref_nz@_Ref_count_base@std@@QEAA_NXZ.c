/*
 * XREFs of ?_Incref_nz@_Ref_count_base@std@@QEAA_NXZ @ 0x18006BD48
 * Callers:
 ...
 *     ?CustomCursor@SystemCursorService2@@UEAA?AV?$shared_ptr@VSystemCursor2@@@std@@XZ @ 0x1800FBA20 (-CustomCursor@SystemCursorService2@@UEAA-AV-$shared_ptr@VSystemCursor2@@@std@@XZ.c)
 * Callees:
 *     <none>
 */
