/*
 * XREFs of ?GetTouchpadRects@BamoSystemContextEndpointStub@@UEAAPEAVBamoList_VirtualTouchpadRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@XZ @ 0x1800A9BE0
 * Callers:
 *     <none>
 * Callees:
