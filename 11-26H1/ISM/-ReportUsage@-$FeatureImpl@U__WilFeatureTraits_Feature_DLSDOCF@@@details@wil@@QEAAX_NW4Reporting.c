/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DLSDOCF@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800E4AD0
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_DLSDOCF>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  v4 = a2;
  LODWORD(v5) = *(_DWORD *)Feature_DLSDOCF__descriptor;
  if ( (*(_DWORD *)Feature_DLSDOCF__descriptor & 4) == 0 )
  {
    v5 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_DLSDOCF>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v6);
    v6 = v5;
  }
