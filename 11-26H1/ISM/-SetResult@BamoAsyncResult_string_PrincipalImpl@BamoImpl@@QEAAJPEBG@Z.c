/*
 * XREFs of ?SetResult@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJPEBG@Z @ 0x180177B88
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180177C90 (-Thunk_SetResult_0@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl.c)
 * Callees:
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *))(*((_QWORD *)this - 2) + 80LL))(
           (char *)this - 16,
           v6,
           a2);
    v4 = v9;
