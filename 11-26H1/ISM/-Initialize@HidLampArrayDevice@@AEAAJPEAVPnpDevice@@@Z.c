/*
 * XREFs of ?Initialize@HidLampArrayDevice@@AEAAJPEAVPnpDevice@@@Z @ 0x1800EA82C
 * Callers:
...
__int64 __fastcall HidLampArrayDevice::Initialize(HidLampArrayDevice *this, struct PnpDevice *a2)
{
  ...
  unsigned __int64 v92; // [rsp+D0h] [rbp+7h]
...
LABEL_83:
                    ...
                    v70 = *((_WORD *)this + 270);
                    v71 = *((_WORD *)this + 269);
                    std::string::string(v90, "LampArrayAttributesReport: lamp ID does not match most recent request");
                    v80 = v69;
                    v6 = -2089418751;
                    LampArrayTelemetry::LogLampArrayHidReportFailure(
                      ...
                      v80);
                    if ( v92 > 0xF )
                      std::_Deallocate<16>(*(void **)v90, (struct std::nothrow_t *)(v92 + 1));
                    v7 = 157LL;
                  }
                  else
                  {
