/*
 * XREFs of ?UpdateRoutingMode@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@QEAAJ_NW4EdgyRoutingMode@Input@Internal@UI@Windows@@@Z @ 0x18012E8B0
 * Callers:
 *     ?Thunk_UpdateRoutingMode_16@?$IEdgyNotificationSourceClientProxy_Receive@VBamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129790 (-Thunk_UpdateRoutingMode_16@-$IEdgyNotificationSourceClientProxy_Receive@VBamoEdgyNotificationSo.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18012F1C0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@.c)
 * Callees:
        ...
        __int64 a3)
{
  unsigned int v3; // ebp
  char v4; // r14
  BamoEdgyNotificationSourceClientProxy *v6; // rsi
  int v7; // eax
  int v8; // eax
