/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800B69B0
 * Callers:
 *     ?Thunk_GiveSpatialDataToPID_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B9010 (-Thunk_GiveSpatialDataToPID_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
