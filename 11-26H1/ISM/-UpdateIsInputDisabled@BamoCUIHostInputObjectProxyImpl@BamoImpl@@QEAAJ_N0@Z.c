/*
 * XREFs of ?UpdateIsInputDisabled@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801349F8
 * Callers:
 *     ?Thunk_UpdateIsInputDisabled_11@?$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801347D0 (-Thunk_UpdateIsInputDisabled_11@-$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyI.c)
