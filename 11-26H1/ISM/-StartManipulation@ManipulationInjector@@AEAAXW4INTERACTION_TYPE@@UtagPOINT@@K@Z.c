/*
 * XREFs of ?StartManipulation@ManipulationInjector@@AEAAXW4INTERACTION_TYPE@@UtagPOINT@@K@Z @ 0x1801154D4
 * Callers:
 ...
 *     ?ValidateInjectionRectForPanZoom@ManipulationInjector@@QEAAXXZ @ 0x180115B98 (-ValidateInjectionRectForPanZoom@ManipulationInjector@@QEAAXXZ.c)
 */
...
LABEL_34:
  ...
  if ( *(_DWORD *)(a1 + 88) == 32 || *(_DWORD *)(a1 + 88) == 16 )
  {
