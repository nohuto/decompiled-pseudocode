/*
 * XREFs of ?AllocateStubUnderLock@BamoEdgyControllerServerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoEdgyControllerServerStub@@@Z @ 0x18006FFA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyControllerServerPrincipal::AllocateStubUnderLock(
