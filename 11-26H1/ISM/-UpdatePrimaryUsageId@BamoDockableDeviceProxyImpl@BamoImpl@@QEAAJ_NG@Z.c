/*
 * XREFs of ?UpdatePrimaryUsageId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NG@Z @ 0x18012E1A8
 * Callers:
 *     ?Thunk_UpdatePrimaryUsageId_80@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801296F0 (-Thunk_UpdatePrimaryUsageId_80@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoI.c)
