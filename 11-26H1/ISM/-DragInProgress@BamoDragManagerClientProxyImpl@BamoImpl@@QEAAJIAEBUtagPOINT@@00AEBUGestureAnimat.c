/*
 * XREFs of ?DragInProgress@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@00AEBUGestureAnimationProperties@@_KW4VirtualKeyModifiers@System@Windows@@2@Z @ 0x180147B4C
 * Callers:
...
LABEL_7:
  ...
  BamoImpl::BamoDragManagerClientProxyImpl::LogSendDragInProgress(a1, a2);
  v15 = *((_QWORD *)a6 + 2);
  v20 = *a6;
  v21 = v15;
  v16 = *a5;
