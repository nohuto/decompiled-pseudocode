/*
 * XREFs of ?_Change_array@?$vector@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$allocator@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@@std@@AEAAXQEAV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@_K1@Z @ 0x18010E2B0
 * Callers:
...
void __fastcall std::vector<std::wstring>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v6 )
  {
    std::_Destroy_range<std::allocator<std::wstring>>(v6, *(_QWORD **)(a1 + 8));
    std::_Deallocate<16>(
      *(void **)a1,
