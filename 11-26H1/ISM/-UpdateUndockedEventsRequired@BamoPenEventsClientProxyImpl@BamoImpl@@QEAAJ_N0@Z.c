/*
 * XREFs of ?UpdateUndockedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18019B09C
 * Callers:
 *     ?Thunk_UpdateUndockedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18019AA90 (-Thunk_UpdateUndockedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxy.c)
