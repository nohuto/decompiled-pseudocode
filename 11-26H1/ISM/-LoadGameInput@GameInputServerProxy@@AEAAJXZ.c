/*
 * XREFs of ?LoadGameInput@GameInputServerProxy@@AEAAJXZ @ 0x18006C7BC
 * Callers:
 ...
 *     ?OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z @ 0x18010EE80 (-OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z.c)
 * Callees:
 ...
 *     ?CreateServer@GameInputServerProxy@@AEAAJPEAVGameInputModule@@@Z @ 0x18006CB14 (-CreateServer@GameInputServerProxy@@AEAAJPEAVGameInputModule@@@Z.c)
