/*
 * XREFs of ??0?$_Hash@V?$_Umap_traits@KW4ContextualProcessorState@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorState@@@std@@@3@$0A@@std@@@std@@IEAA@$$QEAV01@@Z @ 0x18004D8D0
 * Callers:
        ...
        __int64 a2)
{
  ...
  *(_DWORD *)a1 = *(_DWORD *)a2;
  ...
  std::list<std::pair<unsigned long const,enum ContextualProcessorState>>::list<std::pair<unsigned long const,enum ContextualProcessorState>>(a1 + 8);
  *(_QWORD *)(a1 + 24) = 0LL;
  *(_QWORD *)(a1 + 32) = 0LL;
  *(_QWORD *)(a1 + 40) = 0LL;
