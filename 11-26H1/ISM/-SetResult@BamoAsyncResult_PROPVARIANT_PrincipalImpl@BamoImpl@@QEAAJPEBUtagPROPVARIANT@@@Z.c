/*
 * XREFs of ?SetResult@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJPEBUtagPROPVARIANT@@@Z @ 0x1801773E0
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801774E0 (-Thunk_SetResult_0@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Pri.c)
 * Callees:
