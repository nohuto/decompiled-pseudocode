/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIInputTarget@@UIInputDestComparable@@UIInputSiteTarget@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800F7570
 * Callers:
 *     <none>
 * Callees:
