/*
 * XREFs of ?LogOnGestureServicesChanged@BamoInputSystemProxy@@AEAAXXZ @ 0x18011B074
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnGestureServicesChanged(BamoInputSystemProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
