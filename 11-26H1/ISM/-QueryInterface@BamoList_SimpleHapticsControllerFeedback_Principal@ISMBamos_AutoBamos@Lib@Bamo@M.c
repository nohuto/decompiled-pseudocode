/*
 * XREFs of ?QueryInterface@BamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018A160
 * Callers:
 *     ?QueryInterface@BamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018A1A0 (-QueryInterface@BamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBam_ea_18018A1A0.c)
 * Callees:
 *     Microsoft::BamoImpl::Util::FindInterface_Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Principal_Microsoft::Bamo::Lib::ISMBamos_AutoBamos::IList_SimpleHapticsControllerFeedback_Principal_ @ 0x180188280 (Microsoft--BamoImpl--Util--FindInterface_Microsoft--Bamo--Lib--ISMBamos_AutoBamos--BamoList_Simp.c)
