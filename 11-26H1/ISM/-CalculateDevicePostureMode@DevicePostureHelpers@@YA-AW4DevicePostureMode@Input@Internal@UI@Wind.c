/*
 * XREFs of ?CalculateDevicePostureMode@DevicePostureHelpers@@YA?AW4DevicePostureMode@Input@Internal@UI@Windows@@W4DeviceConvertibility@1@@Z @ 0x180116130
 * Callers:
 ...
 *     ?GetCSMRegistryState@DevicePostureHelpers@@YA?AW4CSMRegistryState@1@XZ @ 0x180116590 (-GetCSMRegistryState@DevicePostureHelpers@@YA-AW4CSMRegistryState@1@XZ.c)
