/*
 * XREFs of ?UpdateInputForwardAreaInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800393F4
 * Callers:
 *     ?Thunk_UpdateInputForwardAreaInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800393E0 (-Thunk_UpdateInputForwardAreaInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElemen.c)
