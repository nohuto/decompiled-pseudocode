/*
 * XREFs of ?FailedToFindWaveformAndFallback@SystemOriginated@Haptics@InputTraceLogging@@SAXKK@Z @ 0x1800C818C
 * Callers:
...
void __fastcall InputTraceLogging::Haptics::SystemOriginated::FailedToFindWaveformAndFallback(int a1, int a2)
{
