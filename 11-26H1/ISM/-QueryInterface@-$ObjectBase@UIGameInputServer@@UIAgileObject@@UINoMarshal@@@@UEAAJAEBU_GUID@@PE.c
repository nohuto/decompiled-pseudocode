/*
 * XREFs of ?QueryInterface@?$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010EEE0
 * Callers:
 *     ?QueryInterface@?$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010EFD0 (-QueryInterface@-$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@W7EAAJAEBU_GUID@@P.c)
 *     ?QueryInterface@?$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010EFE0 (-QueryInterface@-$ObjectBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@WBA@EAAJAEBU_GUID@.c)
 * Callees:
