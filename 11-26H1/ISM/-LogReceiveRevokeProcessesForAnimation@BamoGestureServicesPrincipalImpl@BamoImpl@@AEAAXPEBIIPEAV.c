/*
 * XREFs of ?LogReceiveRevokeProcessesForAnimation@BamoGestureServicesPrincipalImpl@BamoImpl@@AEAAXPEBIIPEAVBamoDragManagerClientProxy@@@Z @ 0x1801459F0
 * Callers:
