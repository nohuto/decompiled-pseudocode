/*
 * XREFs of ?UpdateSize@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x180139E00
 * Callers:
 *     ?Thunk_UpdateSize_413@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180139930 (-Thunk_UpdateSize_413@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerPr.c)
