/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Bugfix_57240160@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800AC088
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Bugfix_57240160@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800AC1CC (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Bugfix_57240160@@@detai.c)
 */

_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Bugfix_57240160>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  v14 = a1;
  *a2 = 0LL;
  v3 = *(_DWORD *)Feature_Bugfix_57240160__descriptor;
  *(_DWORD *)a2 = *(_DWORD *)Feature_Bugfix_57240160__descriptor;
  if ( (v3 & 6) != 6 )
  {
    v4 = wil::details::EnsureSubscribedToFeatureConfigurationChanges(a1);
    LODWORD(v14) = 0;
    v5 = v4;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Bugfix_57240160>::GetCurrentFeatureEnabledState(v6, &v15, &v14);
    v7 = *(_DWORD *)a2;
    v8 = (__int16)v15;
    do
    {
      ...
      *(_DWORD *)a2 = v7;
      ...
      v7 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_Bugfix_57240160__descriptor, v11, v7);
    }
    while ( v10 != v7 );
    if ( (v10 & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_180254D7C
        || (v13[0] = 3LL,
            v13[1] = Feature_Bugfix_57240160__descriptor,
            !wil::details_abi::heap_buffer::push_back((void **)&unk_180254DB0, v13, 0x10uLL)) )
      {
        _InterlockedAnd((volatile signed __int32 *)Feature_Bugfix_57240160__descriptor, 0xFFFFFFFB);
      }
