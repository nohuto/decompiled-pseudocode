/*
 * XREFs of wil::init_once_nothrow__lambda_058a17f7b797e76983050a020a22a1d6___ @ 0x1800E8B4C
 * Callers:
        ...
        __int64 a3)
{
  ...
  v9 = HIDWORD(a3);
  fPending = 0;
  if ( !__std_init_once_begin_initialize(&stru_180254910, 0, &fPending, 0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x36C, (int)"wil", v3);
  if ( fPending )
  {
    ...
    if ( v5 < 0 )
    {
      ...
      InitOnceComplete(&stru_180254910, 4u, 0LL);
      return v6;
    }
    InitOnceComplete(&stru_180254910, 0, 0LL);
  }
  return 0LL;
}
