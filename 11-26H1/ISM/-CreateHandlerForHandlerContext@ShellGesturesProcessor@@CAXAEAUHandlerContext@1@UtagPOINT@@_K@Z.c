/*
 * XREFs of ?CreateHandlerForHandlerContext@ShellGesturesProcessor@@CAXAEAUHandlerContext@1@UtagPOINT@@_K@Z @ 0x18015C8DC
 * Callers:
        ...
        __int64 a3)
{
  ...
  v8 = GestureServices::CreateGestureHandler(v7, &v9, *(_DWORD *)a1, a2, a3);
