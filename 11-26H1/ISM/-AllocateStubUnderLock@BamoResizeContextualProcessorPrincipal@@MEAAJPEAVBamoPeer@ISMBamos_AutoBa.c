/*
 * XREFs of ?AllocateStubUnderLock@BamoResizeContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoResizeContextualProcessorStub@@@Z @ 0x18006CCF0
 * Callers:
 *     <none>
 * Callees:
