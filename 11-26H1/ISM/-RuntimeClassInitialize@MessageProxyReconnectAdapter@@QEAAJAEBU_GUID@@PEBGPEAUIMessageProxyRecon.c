...
LABEL_4:
  ...
  *((_QWORD *)this + 6) = a4;
  ...
  v12 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v19[0] + 56LL))(v19[0]);
  v7 = v12;
  if ( v12 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
