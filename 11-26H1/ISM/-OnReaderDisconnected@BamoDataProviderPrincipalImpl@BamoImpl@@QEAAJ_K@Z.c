/*
 * XREFs of ?OnReaderDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180104C9C
 * Callers:
 *     ?Thunk_OnReaderDisconnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180107540 (-Thunk_OnReaderDisconnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@Ba.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 104LL))(
           (char *)this - 16,
           v6,
           a2);
    v4 = v9;
