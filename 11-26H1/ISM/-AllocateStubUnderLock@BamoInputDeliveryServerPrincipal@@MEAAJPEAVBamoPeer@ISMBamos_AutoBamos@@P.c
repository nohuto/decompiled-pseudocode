/*
 * XREFs of ?AllocateStubUnderLock@BamoInputDeliveryServerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputDeliveryServerStub@@@Z @ 0x18006FDD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputDeliveryServerPrincipal::AllocateStubUnderLock(
