/*
 * XREFs of ?AllocateStubUnderLockThunk@BamoList_SimpleHapticsControllerFeedback_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAJPEAVBaseBamoPeerImpl@36@PEAPEAVBamoStub@56@@Z @ 0x180188BD0
 * Callers:
 *     <none>
 * Callees:
