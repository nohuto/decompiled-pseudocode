/*
 * XREFs of ?SetCursorVisibility@Cursor@InputTraceLogging@@SAX_N@Z @ 0x1800FCB74
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::SetCursorVisibility(unsigned __int8 a1)
{
  int v1; // ebx
