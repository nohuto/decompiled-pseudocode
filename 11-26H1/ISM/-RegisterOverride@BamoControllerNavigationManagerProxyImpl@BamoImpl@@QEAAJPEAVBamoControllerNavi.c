/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoControllerNavigationOverridePrincipal@@@Z @ 0x180126760
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      BamoImpl::BamoControllerNavigationManagerProxyImpl::LogSendRegisterOverride(this);
      v12[0] = v14;
      v12[1] = v15;
