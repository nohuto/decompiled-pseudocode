/*
 * XREFs of ??R?$default_delete@VDragGestureTracker@@@std@@QEBAXPEAVDragGestureTracker@@@Z @ 0x18014DC80
 * Callers:
 ...
 *     ??1DragGestureTracker@@QEAA@XZ @ 0x1801A4FE8 (--1DragGestureTracker@@QEAA@XZ.c)
 */
