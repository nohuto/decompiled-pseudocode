/*
 * XREFs of ?OnInputDelegationInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180050EB0
 * Callers:
 *     <none>
 * Callees:
 *     ??$RemoveObject@UIInputDelegationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180050F28 (--$RemoveObject@UIInputDelegationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@.c)
