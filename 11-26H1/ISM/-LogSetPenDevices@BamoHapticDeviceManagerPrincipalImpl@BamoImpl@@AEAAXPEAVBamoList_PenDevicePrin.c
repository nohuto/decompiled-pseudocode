/*
 * XREFs of ?LogSetPenDevices@BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@@Z @ 0x18018F98C
 * Callers:
...
void __fastcall BamoImpl::BamoHapticDeviceManagerPrincipalImpl::LogSetPenDevices(
