/*
 * XREFs of ?SetActivated@BamoActivationControllerProxy@@UEAAX_N@Z @ 0x1800B0370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateActivatedRemoteCache@BamoActivationControllerProxyImpl@BamoImpl@@AEAAXXZ @ 0x1800B044C (-UpdateActivatedRemoteCache@BamoActivationControllerProxyImpl@BamoImpl@@AEAAXXZ.c)
 */
