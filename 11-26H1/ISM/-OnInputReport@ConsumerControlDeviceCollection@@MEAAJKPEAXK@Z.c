/*
 * XREFs of ?OnInputReport@ConsumerControlDeviceCollection@@MEAAJKPEAXK@Z @ 0x1800DB050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( a4 < ReportLength )
    return 0LL;
  Usages = HidP_GetUsages(HidP_Input, 0xCu, 0, UsageList, &UsageLength, PreparsedData, Report, ReportLength);
  if ( Usages < 0 )
  {
    v25 = 228LL;
  }
