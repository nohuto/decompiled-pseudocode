/*
 * XREFs of ?LogOnIdChanged@BamoDragSourceClientProxy@@AEAAXXZ @ 0x18011B5E0
 * Callers:
...
void __fastcall BamoDragSourceClientProxy::LogOnIdChanged(BamoDragSourceClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
