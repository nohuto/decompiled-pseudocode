/*
 * XREFs of ??1?$unique_ptr@UDeviceRemovalEventArgs@ConsumerControlNexusDevice@@U?$default_delete@UDeviceRemovalEventArgs@ConsumerControlNexusDevice@@@std@@@std@@QEAA@XZ @ 0x1800E7694
 * Callers:
