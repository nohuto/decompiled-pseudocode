/*
 * XREFs of ?MPCSixDofProcessor_HomeEventTuneablesChanged_@ISMTracing@@QEAAXMMMMMMMMMMMMMMMMMMMK@Z @ 0x1801C0C68
 * Callers:
        ...
        unsigned int a21)
{
  ...
  v45 = a2;
  v44 = this;
  v21 = ISMTracing::Provider();
  if ( *(_DWORD *)v21 > 4u && tlgKeywordOn((__int64)v21, 0x400000000001LL) )
  {
    v25 = a19;
    v26 = a18;
    v27 = a17;
