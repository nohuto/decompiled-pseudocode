/*
 * XREFs of _lambda_2f33fc4b0ac679fd125de0d601496fc7_::operator() @ 0x1801C8D9C
 * Callers:
        ...
        const char *a4)
{
  ...
  void *v8[2]; // [rsp+40h] [rbp-69h] BYREF
  char v9[40]; // [rsp+50h] [rbp-59h] BYREF
  _BYTE v10[32]; // [rsp+78h] [rbp-31h] BYREF
  _BYTE v11[8]; // [rsp+98h] [rbp-11h] BYREF
  _BYTE v12[32]; // [rsp+A0h] [rbp-9h] BYREF
  _BYTE v13[8]; // [rsp+C0h] [rbp+17h] BYREF
  _BYTE v14[40]; // [rsp+C8h] [rbp+1Fh] BYREF
  ...
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    ...
    (__int64)v6);
  v6[0] = 1000593162;
  std::wstring::wstring((__int64)v10, (__int64)L"PointScaleFactorStick");
  std::variant<unsigned long,bool,float>::variant<unsigned long,bool,float>((__int64)v11, v6);
  v6[0] = 1077936128;
  std::wstring::wstring((__int64)v12, (__int64)L"DeadZoneAngle");
  std::variant<unsigned long,bool,float>::variant<unsigned long,bool,float>((__int64)v13, v6);
  v6[0] = 1036831949;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v14,
