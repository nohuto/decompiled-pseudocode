/*
 * XREFs of ??_EBamoMPCConstantManagerClientStubImpl@BamoImpl@@UEAAPEAXI@Z @ 0x1800B3540
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18009ADC0 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??1BamoMPCConstantManagerClientStubImpl@BamoImpl@@UEAA@XZ @ 0x1800B3354 (--1BamoMPCConstantManagerClientStubImpl@BamoImpl@@UEAA@XZ.c)
 */
