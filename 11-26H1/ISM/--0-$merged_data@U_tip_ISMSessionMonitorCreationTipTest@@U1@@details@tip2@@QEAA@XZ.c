/*
 * XREFs of ??0?$merged_data@U_tip_ISMSessionMonitorCreationTipTest@@U1@@details@tip2@@QEAA@XZ @ 0x1800A2D04
 * Callers:
 ...
 * Callees:
 *     ??0test_state@tip2@@QEAA@XZ @ 0x1800A2F5C (--0test_state@tip2@@QEAA@XZ.c)
 */
