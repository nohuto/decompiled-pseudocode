/*
 * XREFs of ?ProxyDisposed@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAVBaseBamoPeerImpl@23@I@Z @ 0x180035120
 * Callers:
 *     ?Thunk_ProxyDisposed_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800346E0 (-Thunk_ProxyDisposed_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBam.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  {
LABEL_22:
    v11 = Microsoft::BamoImpl::BaseBamoConnectionImpl::TrackError(this, -2018375668, 0);
    if ( v11 < 0 )
    {
      v12 = 1757LL;
      goto LABEL_24;
