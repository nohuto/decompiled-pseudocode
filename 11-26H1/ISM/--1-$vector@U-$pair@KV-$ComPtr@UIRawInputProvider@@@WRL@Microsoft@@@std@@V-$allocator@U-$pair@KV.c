/*
 * XREFs of ??1?$vector@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@@2@@std@@QEAA@XZ @ 0x180097158
 * Callers:
 *     _InputStateManager::SendDeviceCommand_::_1_::dtor$0 @ 0x1801D7BE1 (_InputStateManager--SendDeviceCommand_--_1_--dtor$0.c)
 * Callees:
