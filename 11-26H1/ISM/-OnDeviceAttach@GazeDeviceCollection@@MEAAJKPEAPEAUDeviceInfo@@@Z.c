/*
 * XREFs of ?OnDeviceAttach@GazeDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x1800DC4E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPreparsedData@HIDDevice@@QEAAJPEAPEAXPEAK@Z @ 0x1800DFEAC (-GetPreparsedData@HIDDevice@@QEAAJPEAPEAXPEAK@Z.c)
