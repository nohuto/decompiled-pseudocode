/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@std@@@std@@@std@@YAXPEAV?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@0@QEAV10@AEAV?$allocator@V?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@std@@@0@@Z @ 0x18008A660
 * Callers:
 ...
 *     ??1?$vector@V?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@std@@V?$allocator@V?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x180096714 (--1-$vector@V-$vector@VHidChannelValueInfo@@V-$allocator@VHidChannelValueInfo@@@std@@@std@@V-$al.c)
...
__int64 __fastcall std::_Destroy_range<std::allocator<std::vector<HidChannelValueInfo>>>(_QWORD *a1, _QWORD *a2)
{
  _QWORD *v3; // rbx
  __int64 result; // rax
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      if ( *v3 )
      {
        result = std::_Deallocate<16>(*v3, 8 * ((__int64)(v3[2] - *v3) >> 3));
        *v3 = 0LL;
        v3[1] = 0LL;
        v3[2] = 0LL;
      }
