/*
 * XREFs of ??1?$unique_ptr@VMPCCursorManager@@U?$default_delete@VMPCCursorManager@@@std@@@std@@QEAA@XZ @ 0x1800B9A14
 * Callers:
 *     _MPCHolographicInputManager::MPCHolographicInputManager_::_1_::dtor$9 @ 0x1801D75C5 (_MPCHolographicInputManager--MPCHolographicInputManager_--_1_--dtor$9.c)
 * Callees:
