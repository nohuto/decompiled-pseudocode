/*
 * XREFs of ?HitTestForTarget@EdgyProcessor@@AEAAJUtagPOINT@@W4InputType@@U_GUID@@PEAU2@PEA_K4@Z @ 0x180157C28
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  v25 = a6;
  v26 = a7;
  v10 = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))HitTestHelper::ConvertInputTypeToPointerType)(
          (unsigned int)a3,
          a2,
          a3);
  (*(void (__fastcall **)(__int64, bool *, __int64, _QWORD))(*(_QWORD *)v11 + 32LL))(v11, v27, v12, v10);
  InputETW::Edgy::HitTestForTarget(a2, v8, v13, v27[0]);
  v14 = 0;
  if ( v27[0] )
  {
    if ( a5 && a6 && a7 )
  ...
  HitTestResult::~HitTestResult((HitTestResult *)v27);
  return v14;
}
