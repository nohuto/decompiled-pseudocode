/*
 * XREFs of ?LogSetEnabled@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@AEAAX_N@Z @ 0x18008BBD4
 * Callers:
...
void __fastcall BamoImpl::BamoControllerNavigationManagerPrincipalImpl::LogSetEnabled(
