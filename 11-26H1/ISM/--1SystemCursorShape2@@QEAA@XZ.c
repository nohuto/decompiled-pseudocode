/*
 * XREFs of ??1SystemCursorShape2@@QEAA@XZ @ 0x1800FAAB0
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VSystemCursorShape2@@@std@@EEAAXXZ @ 0x1800FD180 (-_Destroy@-$_Ref_count_obj2@VSystemCursorShape2@@@std@@EEAAXXZ.c)
 * Callees:
