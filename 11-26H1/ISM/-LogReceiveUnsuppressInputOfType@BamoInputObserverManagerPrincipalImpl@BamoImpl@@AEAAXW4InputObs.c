/*
 * XREFs of ?LogReceiveUnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@AEAAXW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x18013B2A4
 * Callers:
