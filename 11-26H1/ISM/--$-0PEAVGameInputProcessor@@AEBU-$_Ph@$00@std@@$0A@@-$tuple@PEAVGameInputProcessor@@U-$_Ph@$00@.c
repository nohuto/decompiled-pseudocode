/*
 * XREFs of ??$?0PEAVGameInputProcessor@@AEBU?$_Ph@$00@std@@$0A@@?$tuple@PEAVGameInputProcessor@@U?$_Ph@$00@std@@@std@@QEAA@$$QEAPEAVGameInputProcessor@@AEBU?$_Ph@$00@1@@Z @ 0x180094390
 * Callers:
 ...
 * Callees:
 *     ??$?0U_Exact_args_t@std@@PEAVGameInputProcessor@@AEBU?$_Ph@$00@1@$0A@@?$tuple@PEAVGameInputProcessor@@U?$_Ph@$00@std@@@std@@QEAA@U_Exact_args_t@1@$$QEAPEAVGameInputProcessor@@AEBU?$_Ph@$00@1@@Z @ 0x1800943AC (--$-0U_Exact_args_t@std@@PEAVGameInputProcessor@@AEBU-$_Ph@$00@1@$0A@@-$tuple@PEAVGameInputProce.c)
 */
        ...
        __int64 a2)
{
  ...
  std::tuple<GameInputProcessor *,std::_Ph<1>>::tuple<GameInputProcessor *,std::_Ph<1>>(a1, a2, a2);
  return v2;
}
