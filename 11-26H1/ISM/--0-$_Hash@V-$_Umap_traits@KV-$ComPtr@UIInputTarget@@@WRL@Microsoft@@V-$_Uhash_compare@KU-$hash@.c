/*
 * XREFs of ??0?$_Hash@V?$_Umap_traits@KV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@@5@$0A@@std@@@std@@IEAA@$$QEAV01@@Z @ 0x18004D7F4
 * Callers:
        ...
        __int64 a2)
{
  ...
  *(_DWORD *)a1 = *(_DWORD *)a2;
  ...
  std::list<std::pair<unsigned long const,Microsoft::WRL::ComPtr<IInputTarget>>>::list<std::pair<unsigned long const,Microsoft::WRL::ComPtr<IInputTarget>>>(a1 + 8);
  *(_QWORD *)(a1 + 24) = 0LL;
  *(_QWORD *)(a1 + 32) = 0LL;
  *(_QWORD *)(a1 + 40) = 0LL;
