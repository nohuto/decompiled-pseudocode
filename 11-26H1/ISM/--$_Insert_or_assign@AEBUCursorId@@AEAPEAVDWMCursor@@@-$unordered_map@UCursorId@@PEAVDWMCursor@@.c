        ...
        _QWORD *a4)
{
  ...
  else
  {
    ...
    v18 = a1 + 2;
    v10 = std::_Allocate<16,std::_Default_allocate_traits>(0x20uLL);
    v19 = v10;
    v10[2] = *(_QWORD *)a3;
    v10[3] = *a4;
    v11 = *((_QWORD *)a1 + 2) + 1LL;
    ...
    if ( (float)(v12 / v14) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<unsigned int,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView>>,0>>::_Forced_rehash(
        (__int64)a1,
        v16);
      *(_OWORD *)v20 = *(_OWORD *)std::_Hash<std::_Umap_traits<CursorId,DWMCursor *,std::_Uhash_compare<CursorId,CursorIdHash,std::equal_to<CursorId>>,std::allocator<std::pair<CursorId const,DWMCursor *>>,0>>::_Find_last<CursorId>(
                                    a1,
                                    v20,
                                    (_DWORD *)v10 + 4,
                                    v8);
