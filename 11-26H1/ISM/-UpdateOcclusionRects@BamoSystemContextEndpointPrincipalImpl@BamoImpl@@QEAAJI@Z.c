/*
 * XREFs of ?UpdateOcclusionRects@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800AA710
 * Callers:
 *     ?Thunk_UpdateOcclusionRects_8@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800AA6F0 (-Thunk_UpdateOcclusionRects_8@-$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpoi.c)
 * Callees:
