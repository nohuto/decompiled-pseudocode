/*
 * XREFs of ?LogOnFeaturesChanging@BamoControllerNavigationOverrideProxy@@AEAAXI@Z @ 0x18017AF44
 * Callers:
...
void __fastcall BamoControllerNavigationOverrideProxy::LogOnFeaturesChanging(
