/*
 * XREFs of ??$RemoveObject@UIDragManagerClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005D098
 * Callers:
...
void __fastcall InputSite::RemoveObject<IDragManagerClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_5c15ce6c_0db0_fad1_7819_fe909f528890, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
