/*
 * XREFs of ??$_Try_emplace@AEBI$$V@?$_Hash@V?$_Umap_traits@IUTargetingInfo@ForegroundManager@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@U?$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@PEAU?$_List_node@U?$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@PEAX@std@@_N@1@AEBI@Z @ 0x18004A79C
 * Callers:
 ...
 *     ??1?$_Alloc_construct_ptr@V?$allocator@U?$_List_node@U?$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18007B49C (--1-$_Alloc_construct_ptr@V-$allocator@U-$_List_node@U-$pair@$$CBIUTargetingInfo@ForegroundManag.c)
 ...
 *     ??$?0AEBI$$Z$$V@?$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@QEAA@Upiecewise_construct_t@1@V?$tuple@AEBI@1@V?$tuple@$$V@1@@Z @ 0x1800AB200 (--$-0AEBI$$Z$$V@-$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@QEAA@Upiecewise_construct_t@.c)
 */
        ...
        unsigned __int8 *a3)
{
  ...
  else
  {
    ...
    v17 = v7;
    v19 = a3;
    ____0AEBI__Z__V___pair___CBIUTargetingInfo_ForegroundManager___std__QEAA_Upiecewise_construct_t_1_V__tuple_AEBI_1_V__tuple___V_1__Z(
      v7 + 2,
      v8,
      &v19);
    v9 = *((_QWORD *)a1 + 2) + 1LL;
    ...
    *(_QWORD *)a2 = std::_Hash<std::_Umap_traits<unsigned long,ConsumerControlDeviceCollection::UsageList,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,ConsumerControlDeviceCollection::UsageList>>,0>>::_Insert_new_node_before(
                      ...
                      v7);
    *(_BYTE *)(a2 + 8) = 1;
    std::_Alloc_construct_ptr<std::allocator<std::_List_node<std::pair<unsigned int const,ForegroundManager::TargetingInfo>,void *>>>::~_Alloc_construct_ptr<std::allocator<std::_List_node<std::pair<unsigned int const,ForegroundManager::TargetingInfo>,void *>>>(&v16);
  }
  return a2;
}
