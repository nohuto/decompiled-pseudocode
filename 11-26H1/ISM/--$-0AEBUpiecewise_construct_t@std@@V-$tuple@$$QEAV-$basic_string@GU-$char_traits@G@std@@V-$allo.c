...
_QWORD *__fastcall std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::wstring const,unsigned long>,void *>>>::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::wstring const,unsigned long>,void *>>>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  *a1 = a2;
  ...
  a1[1] = v6;
  std::wstring::wstring((__int64)v6 + 32);
  *(_DWORD *)(v7 + 32) = 0;
  *(_QWORD *)a1[1] = a3;
  *(_QWORD *)(a1[1] + 8LL) = a3;
  *(_QWORD *)(a1[1] + 16LL) = a3;
