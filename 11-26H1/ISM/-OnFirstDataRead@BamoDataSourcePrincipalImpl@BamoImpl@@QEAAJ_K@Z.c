/*
 * XREFs of ?OnFirstDataRead@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18009519C
 * Callers:
 *     ?Thunk_OnFirstDataRead_0@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801074E0 (-Thunk_OnFirstDataRead_0@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataSourcePrincipalImpl::OnFirstDataRead(
        ...
        __int64 a2)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 80LL))((char *)this - 16, v6, a2);
    v4 = v9;
    if ( v9 == -2018375668 )
    {
