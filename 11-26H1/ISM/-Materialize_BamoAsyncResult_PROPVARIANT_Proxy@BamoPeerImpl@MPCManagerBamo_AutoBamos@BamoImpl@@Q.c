/*
 * XREFs of ?Materialize_BamoAsyncResult_PROPVARIANT_Proxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B7384
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncResult_PROPVARIANT_Proxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B9050 (-Thunk_Materialize_BamoAsyncResult_PROPVARIANT_Proxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Rec.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v11 = &BamoAsyncResult_PROPVARIANT_Proxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v11[1] = &BamoAsyncResult_PROPVARIANT_Proxy::`vftable'{for `IAsyncResult_PROPVARIANT_Proxy'};
  *((_DWORD *)v11 + 6) = 0;
  v11[4] = 0LL;
  v11[5] = 0LL;
  v11[2] = &BamoImpl::BamoAsyncResult_PROPVARIANT_ProxyImpl::`vftable';
