/*
 * XREFs of ?LogOnComponentWindowIdChanging@BamoCUIComponentInputObjectProxy@@AEAAX_K@Z @ 0x180134BD0
 * Callers:
...
void __fastcall BamoCUIComponentInputObjectProxy::LogOnComponentWindowIdChanging(
