/*
 * XREFs of ?DestroyCursorShape@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_K1@Z @ 0x1800F88E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a4)
{
  ...
  SystemCursor2 *v20[2]; // [rsp+30h] [rbp-38h] BYREF
  __int64 v21; // [rsp+40h] [rbp-28h] BYREF
  std::_Ref_count_base *v22; // [rsp+48h] [rbp-20h]
    ...
    *(_OWORD *)v20 = 0LL;
    ...
    else
    {
      ...
      *(_QWORD *)v18 = a4;
      ...
      v15 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, int *))(**((_QWORD **)this + 10) + 104LL))(
                         *((_QWORD *)this + 10),
                         v18);
      std::shared_ptr<wil::unique_any_t<wil::details::unique_storage<wil::details::handle_null_resource_policy<long (*)(void *),&long NtCloseCompositionInputSink(void *)>>>>::operator=(
        v20,
