/*
 * XREFs of ?UpdateRouting@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18015A624
 * Callers:
 *     ?Thunk_UpdateRouting_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015A360 (-Thunk_UpdateRouting_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@B.c)
