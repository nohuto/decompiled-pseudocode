/*
 * XREFs of ?OnNotify@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_KW4DataProviderNotificationEventArg@@@Z @ 0x180104A60
 * Callers:
 *     ?Thunk_OnNotify_8@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180107500 (-Thunk_OnNotify_8@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SA.c)
 * Callees:
