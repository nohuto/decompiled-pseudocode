/*
 * XREFs of ?QueryInterface@BamoSystemContextManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180141820
 * Callers:
 *     ?QueryInterface@BamoSystemContextManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801418A0 (-QueryInterface@BamoSystemContextManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoSystemContextManagerPrincipal *)-8LL )
    return (unsigned int)-2147467262;
