/*
 * XREFs of ?LogSendOnForegroundTransferFromComponent@BamoCUIHostInputObjectProxyImpl@BamoImpl@@AEAAXAEBUTransferForegroundInfo@@@Z @ 0x1801341B8
 * Callers:
