/*
 * XREFs of ??$EnqueueItem@USuperWetInkBallpointPenPoint@@@CSharedCircularQueueProducer@@QEAAXAEBUSuperWetInkBallpointPenPoint@@@Z @ 0x1800AAC40
 * Callers:
 ...
 * Callees:
 *     ?terminate@details@gsl@@YAXXZ @ 0x1800994A8 (-terminate@details@gsl@@YAXXZ.c)
