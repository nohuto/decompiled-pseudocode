/*
 * XREFs of ??1?$unordered_map@GV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@U?$hash@G@2@U?$equal_to@G@2@V?$allocator@U?$pair@$$CBGV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x18019280C
 * Callers:
 *     _PenHapticInterface::PenHapticInterface_::_1_::dtor$2 @ 0x1801DC622 (_PenHapticInterface--PenHapticInterface_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
