/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_PTP_INTEROP_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_PTP_INTEROP_MESSAGE@@@Z@std@@@Z @ 0x1800F1F3C
 * Callers:
