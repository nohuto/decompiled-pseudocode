/*
 * XREFs of ?Create@RIMRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x180076BF0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IRawInputProvider **a3)
{
  ...
  v6 = (RIMRawInputProvider *)RefCountedObject::operator new(0x118uLL);
  if ( v6 )
