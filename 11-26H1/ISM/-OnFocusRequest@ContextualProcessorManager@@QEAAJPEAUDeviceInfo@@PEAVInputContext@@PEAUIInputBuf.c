/*
 * XREFs of ?OnFocusRequest@ContextualProcessorManager@@QEAAJPEAUDeviceInfo@@PEAVInputContext@@PEAUIInputBuffer@@PEAPEAUIInputTarget@@@Z @ 0x1800132CC
 * Callers:
        ...
        struct IInputTarget **a5)
{
  ...
  _QWORD *v17; // rax
  __int64 v18; // r9
  void (__fastcall *v19)(_QWORD *, _QWORD, int *); // r12
  __int64 v20; // rcx
