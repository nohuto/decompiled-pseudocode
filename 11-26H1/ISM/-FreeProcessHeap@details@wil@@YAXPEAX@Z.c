/*
 * XREFs of ?FreeProcessHeap@details@wil@@YAXPEAX@Z @ 0x18008E898
 * Callers:
 *     ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x18007D500 (--1UsageIndexes@details_abi@wil@@QEAA@XZ.c)
 *     ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x18007EDC4 (--1FeatureStateManager@details@wil@@QEAA@XZ.c)
 *     ??1RawUsageIndex@details_abi@wil@@QEAA@XZ @ 0x18008E830 (--1RawUsageIndex@details_abi@wil@@QEAA@XZ.c)
 *     ??1SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x18008E85C (--1SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ?RecordUsage@RawUsageIndex@details_abi@wil@@QEAA_NPEAX_K01I@Z @ 0x18009FA00 (-RecordUsage@RawUsageIndex@details_abi@wil@@QEAA_NPEAX_K01I@Z.c)
 ...
 *     ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x1800A0B68 (-Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z.c)
 * Callees:
 *     <none>
 */
