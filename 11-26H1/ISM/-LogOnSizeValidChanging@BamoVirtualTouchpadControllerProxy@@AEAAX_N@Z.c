/*
 * XREFs of ?LogOnSizeValidChanging@BamoVirtualTouchpadControllerProxy@@AEAAX_N@Z @ 0x1801384D0
 * Callers:
...
void __fastcall BamoVirtualTouchpadControllerProxy::LogOnSizeValidChanging(BamoVirtualTouchpadControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
