/*
 * XREFs of ?Thunk_SendHapticFeedbackForDuration_366@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018B3E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
