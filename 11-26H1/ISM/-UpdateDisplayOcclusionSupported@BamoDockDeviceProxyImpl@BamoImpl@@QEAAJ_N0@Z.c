/*
 * XREFs of ?UpdateDisplayOcclusionSupported@BamoDockDeviceProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012AFF0
 * Callers:
 *     ?Thunk_UpdateDisplayOcclusionSupported_11@?$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801292F0 (-Thunk_UpdateDisplayOcclusionSupported_11@-$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@Ba.c)
