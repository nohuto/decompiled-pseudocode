/*
 * XREFs of ?AllocateStubUnderLock@BamoMPCConstantManagerClientPrincipal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoMPCConstantManagerClientStub@@@Z @ 0x1800B3620
 * Callers:
 *     <none>
 * Callees:
