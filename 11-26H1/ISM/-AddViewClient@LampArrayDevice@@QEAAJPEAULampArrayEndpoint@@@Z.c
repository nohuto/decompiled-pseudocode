/*
 * XREFs of ?AddViewClient@LampArrayDevice@@QEAAJPEAULampArrayEndpoint@@@Z @ 0x1800E6924
 * Callers:
...
__int64 __fastcall LampArrayDevice::AddViewClient(LampArrayDevice *this, struct LampArrayEndpoint *a2)
{
  ...
  LampArrayDevice::ViewClientListEntry *v5; // rbx
  struct ISIPCEndpoint *v6; // rdi
  struct ISIPCEndpoint *v7; // rdx
  __int64 v8; // rcx
  ...
  *((_QWORD *)v4 + 2) = 0LL;
  v19 = v4;
  v6 = *(struct ISIPCEndpoint **)a2;
  v7 = (struct ISIPCEndpoint *)*((_QWORD *)v4 + 2);
  if ( v7 != *(struct ISIPCEndpoint **)a2 )
  {
    if ( v6 )
      (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v6 + 8LL))(*(_QWORD *)a2);
    v8 = *((_QWORD *)v5 + 2);
    *((_QWORD *)v5 + 2) = v6;
    v7 = v6;
    if ( v8 )
    {
      (*(void (__fastcall **)(__int64, struct ISIPCEndpoint *))(*(_QWORD *)v8 + 16LL))(v8, v6);
      v7 = (struct ISIPCEndpoint *)*((_QWORD *)v5 + 2);
    }
  }
