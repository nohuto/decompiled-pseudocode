/*
 * XREFs of ?OnDeviceChange@DWMInputRouter@@IEAAJPEAUDeviceInfo@@_N@Z @ 0x180031634
 * Callers:
 ...
 *     ?OnDeviceUpdate@DWMInputRouter@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801A3820 (-OnDeviceUpdate@DWMInputRouter@@UEAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
...
__int64 __fastcall DWMInputRouter::OnDeviceChange(DWMInputRouter *this, struct DeviceInfo *a2, char a3)
{
  ...
  if ( a3 )
  {
    if ( *(_QWORD *)std::_Hash<std::_Umap_traits<enum InputType,tagPOINT,std::_Uhash_compare<enum InputType,std::hash<enum InputType>,std::equal_to<enum InputType>>,std::allocator<std::pair<enum InputType const,tagPOINT>>,0>>::find(
                      v8,
                      &v19,
                      a2) == *((_QWORD *)this + 25) )
  ...
  while ( v9 != *((_QWORD **)this + 12) )
  {
    ...
    if ( v14 < 0 )
      v9 = *(_QWORD **)DWMInputRouter::RemoveTarget(this, v17, v9);
    else
      v9 = (_QWORD *)*v9;
    v15 = (__int64)v19;
    if ( v19 )
