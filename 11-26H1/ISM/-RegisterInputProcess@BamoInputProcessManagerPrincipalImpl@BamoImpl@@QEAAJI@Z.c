/*
 * XREFs of ?RegisterInputProcess@BamoInputProcessManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18019FD70
 * Callers:
 *     ?Thunk_RegisterInputProcess_8@?$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A0540 (-Thunk_RegisterInputProcess_8@-$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPr.c)
 * Callees:
