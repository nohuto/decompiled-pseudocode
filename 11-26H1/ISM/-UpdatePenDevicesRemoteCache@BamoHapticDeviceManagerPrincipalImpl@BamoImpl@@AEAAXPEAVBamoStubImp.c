/*
 * XREFs of ?UpdatePenDevicesRemoteCache@BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180191D9C
 * Callers:
...
void __fastcall BamoImpl::BamoHapticDeviceManagerPrincipalImpl::UpdatePenDevicesRemoteCache(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 64LL) )
  {
    ...
    if ( v4 < 0 || (v7[0] = v9, v7[1] = v10, LOWORD(v6) = 0, v4 = CoreUICallSend(v11, v7, 2LL), v4 < 0) )
    {
      if ( v4 != -2018375675 )
      {
