/*
 * XREFs of std::remove_if_std::_List_iterator_std::_List_val_std::_List_simple_types_std::shared_ptr_HotKeyInfo_________lambda_139f71076f5ab0ecef881a1ffc08c112___ @ 0x1801CE96C
 * Callers:
        ...
        __int64 a4)
{
  ...
  while ( a2 != a3 )
  {
    v8 = std::shared_ptr<SystemCursorShapeBitmap2>::shared_ptr<SystemCursorShapeBitmap2>(v13, a2 + 2);
  ...
  if ( a2 != a3 )
  {
    while ( 1 )
    {
      ...
      if ( v10 == a3 )
        break;
      v11 = std::shared_ptr<SystemCursorShapeBitmap2>::shared_ptr<SystemCursorShapeBitmap2>(v13, v10 + 2);
      if ( !(unsigned __int8)lambda_139f71076f5ab0ecef881a1ffc08c112_::operator()(a4, v11) )
      {
