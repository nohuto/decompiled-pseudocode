/*
 * XREFs of ?LogReceiveRegisterInputSiteElement@BamoInputSiteManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoInputSiteElementProxy@@@Z @ 0x18008BFA4
 * Callers:
...
void __fastcall BamoImpl::BamoInputSiteManagerPrincipalImpl::LogReceiveRegisterInputSiteElement(
        BamoImpl::BamoInputSiteManagerPrincipalImpl *this,
        struct BamoInputSiteElementProxy *a2)
{
  const struct _tlgProvider_t * near *v2; // rbx
  int v3; // r8d
  __int64 v4; // r9
  ...
  __int64 v7; // r8
  __int64 v8; // r9
  unsigned int v9[6]; // [rsp+40h] [rbp-18h] BYREF
  int v10; // [rsp+70h] [rbp+18h] BYREF
  int v11; // [rsp+78h] [rbp+20h] BYREF

  v2 = ISMBamos_AutoBamos::BamoTraceLogging::s_providers;
    ...
    && tlgKeywordOn((__int64)ISMBamos_AutoBamos::BamoTraceLogging::s_providers, 1LL) )
  {
    ...
    v9[0] = Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_ActivatableEntityPrincipal_Principal::GetItemId((Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_ActivatableEntityPrincipal_Principal *)(v6 - 16));
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
      (__int64)v2,
      (__int64)&unk_18021DF72,
      v7,
      v8,
      (__int64)v9,
      (__int64)&v11,
