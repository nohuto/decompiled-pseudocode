/*
 * XREFs of ?SetBootstrapProxy@InputSystemInternalClientConnection@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x180130C20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy *a2)
{
  ...
  if ( v11 != v10 )
  {
    std::_Destroy_range<std::allocator<std::function<void (Microsoft::WRL::ComPtr<DataProviderPrincipal> &)>>>(v11, v10);
