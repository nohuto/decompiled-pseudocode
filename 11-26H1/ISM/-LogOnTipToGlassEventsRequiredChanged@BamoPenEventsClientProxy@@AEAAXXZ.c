/*
 * XREFs of ?LogOnTipToGlassEventsRequiredChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x180199464
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnTipToGlassEventsRequiredChanged(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
