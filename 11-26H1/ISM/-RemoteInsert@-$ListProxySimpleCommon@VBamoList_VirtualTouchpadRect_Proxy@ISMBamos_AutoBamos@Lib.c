/*
 * XREFs of ?RemoteInsert@?$ListProxySimpleCommon@VBamoList_VirtualTouchpadRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UVirtualTouchpadRect@@AEBU6@@Bamo@Microsoft@@MEAAJIAEBUVirtualTouchpadRect@@@Z @ 0x18013E2C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( a2 <= 0xAAAAAAAAAAAAAAABuLL * ((__int64)(*((_QWORD *)this + 7) - *((_QWORD *)this + 6)) >> 3) )
  {
    ...
    try
    {
      ...
      std::vector<VirtualTouchpadRect>::emplace<VirtualTouchpadRect const &>(
        (__int64)v6,
        &v17,
        (char *)(*v6 + 24 * v4),
        a3);
