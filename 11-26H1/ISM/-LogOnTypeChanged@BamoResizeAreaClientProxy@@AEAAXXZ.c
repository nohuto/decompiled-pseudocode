/*
 * XREFs of ?LogOnTypeChanged@BamoResizeAreaClientProxy@@AEAAXXZ @ 0x18011CEAC
 * Callers:
...
void __fastcall BamoResizeAreaClientProxy::LogOnTypeChanged(BamoResizeAreaClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
