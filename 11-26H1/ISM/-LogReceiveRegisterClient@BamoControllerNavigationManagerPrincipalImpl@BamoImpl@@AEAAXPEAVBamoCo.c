/*
 * XREFs of ?LogReceiveRegisterClient@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoControllerNavigationClientProxy@@@Z @ 0x1801795A4
 * Callers:
