/*
 * XREFs of ?ParseInputBufferForReport@HidLampAttributesResponseReportParser@@QEAAJPEBEIPEAULampAttributesResponseDeviceReport@@@Z @ 0x180082430
 * Callers:
 ...
 *     ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800F0348 (-ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z.c)
 */
