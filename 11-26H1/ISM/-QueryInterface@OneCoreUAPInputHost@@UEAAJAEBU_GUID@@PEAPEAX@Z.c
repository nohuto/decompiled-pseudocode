/*
 * XREFs of ?QueryInterface@OneCoreUAPInputHost@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A1CE0
 * Callers:
 *     ?QueryInterface@OneCoreUAPInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A1E00 (-QueryInterface@OneCoreUAPInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@OneCoreUAPInputHost@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A1E10 (-QueryInterface@OneCoreUAPInputHost@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@OneCoreUAPInputHost@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A1E20 (-QueryInterface@OneCoreUAPInputHost@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
