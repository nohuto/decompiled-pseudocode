/*
 * XREFs of ?UpdateWindowsMessageDelivery@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003A704
 * Callers:
 *     ?Thunk_UpdateWindowsMessageDelivery_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003A6F0 (-Thunk_UpdateWindowsMessageDelivery_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
        ...
        unsigned int a3)
{
  ...
  struct BamoWindowsMessageDeliveryProxy *v7; // rsi
  __int64 v8; // rbx
  int v10; // eax
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnWindowsMessageDeliveryChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1);
      v12 = (*(__int64 (__fastcall **)(char *, struct BamoWindowsMessageDeliveryProxy *))(*((_QWORD *)this - 2) + 664LL))(
              (char *)this - 16,
              v7);
      if ( v12 < 0 )
    ...
    *((_QWORD *)this + 39) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoWindowsMessageDeliveryProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnWindowsMessageDeliveryChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        (__int64)v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        (void (__fastcall ***)(_QWORD))this,
        2);
      v10 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 672LL))((char *)this - 16);
      if ( v10 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x3057,
