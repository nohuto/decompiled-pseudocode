/*
 * XREFs of ?LogOnEatPolicyChanged@BamoActivationConfigurationInputObjectProxy@@AEAAXXZ @ 0x18008D4D8
 * Callers:
...
void __fastcall BamoActivationConfigurationInputObjectProxy::LogOnEatPolicyChanged(
