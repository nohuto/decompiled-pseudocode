/*
 * XREFs of ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x180115A24
 * Callers:
 *     ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x180115110 (-InjectZoom@ManipulationInjector@@QEAAXMK@Z.c)
 * Callees:
 *     ?UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z @ 0x180115B1C (-UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z.c)
 */
