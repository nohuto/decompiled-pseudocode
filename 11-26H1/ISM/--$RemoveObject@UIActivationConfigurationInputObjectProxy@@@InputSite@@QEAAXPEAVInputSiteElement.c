/*
 * XREFs of ??$RemoveObject@UIActivationConfigurationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005B514
 * Callers:
...
void __fastcall InputSite::RemoveObject<IActivationConfigurationInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_4753c172_9138_4064_8603_1556e98a010f, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
