/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@_KV?$set@PEAUHotKeyInfo@@U?$less@PEAUHotKeyInfo@@@std@@V?$allocator@PEAUHotKeyInfo@@@3@@std@@U?$less@_K@2@V?$allocator@U?$pair@$$CB_KV?$set@PEAUHotKeyInfo@@U?$less@PEAUHotKeyInfo@@@std@@V?$allocator@PEAUHotKeyInfo@@@3@@std@@@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x1801CEDA0
 * Callers:
