/*
 * XREFs of ?CustomCursor@DesktopSystemCursorService@@UEAA?AV?$shared_ptr@VSystemCursor2@@@std@@XZ @ 0x1800FD7A0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn DesktopSystemCursorService::CustomCursor()
{
