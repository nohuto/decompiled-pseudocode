/*
 * XREFs of ??$_Freenode@V?$allocator@U?$_List_node@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@PEAX@std@@@std@@@?$_List_node@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@PEAX@std@@@1@PEAU01@@Z @ 0x1800654C0
 * Callers:
...
__int64 __fastcall std::_List_node<std::pair<void * const,std::vector<unsigned int>>,void *>::_Freenode<std::allocator<std::_List_node<std::pair<void * const,std::vector<unsigned int>>,void *>>>(
        __int64 a1,
        __int64 a2)
{
  std::vector<Windows::UI::Color>::_Tidy((__int64 *)(a2 + 24));
  return std::_Deallocate<16>(a2, 48LL);
}
