/*
 * XREFs of ?SetIsPlayDurationSupported@BamoSimpleHapticsControllerPrincipal@@UEAAX_N@Z @ 0x18018B110
 * Callers:
        ...
        char a2)
{
  ...
  *((_BYTE *)v3 + 66) = a2;
  BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::LogSetIsPlayDurationSupported(v3);
