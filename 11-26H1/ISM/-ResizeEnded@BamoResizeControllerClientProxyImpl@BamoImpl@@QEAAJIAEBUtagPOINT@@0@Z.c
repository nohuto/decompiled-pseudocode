/*
 * XREFs of ?ResizeEnded@BamoResizeControllerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@0@Z @ 0x1801270BC
 * Callers:
        ...
        const struct tagPOINT *a4)
{
  ...
  else
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      BamoImpl::BamoResizeControllerClientProxyImpl::LogSendResizeEnded(this, a2, v12, v13);
