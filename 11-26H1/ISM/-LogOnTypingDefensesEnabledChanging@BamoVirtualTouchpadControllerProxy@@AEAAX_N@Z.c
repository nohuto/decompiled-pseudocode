/*
 * XREFs of ?LogOnTypingDefensesEnabledChanging@BamoVirtualTouchpadControllerProxy@@AEAAX_N@Z @ 0x180138584
 * Callers:
...
void __fastcall BamoVirtualTouchpadControllerProxy::LogOnTypingDefensesEnabledChanging(
