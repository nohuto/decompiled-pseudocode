/*
 * XREFs of ?DispatchNextCallback@SipcServer@@UEAAJXZ @ 0x180060180
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DispatchDisconnectCallback@SipcEndpoint@@QEAAXXZ @ 0x1801118A8 (-DispatchDisconnectCallback@SipcEndpoint@@QEAAXXZ.c)
...
LABEL_2:
  ...
  if ( GetQueuedCompletionStatus(v8, &NumberOfBytesTransferred, &CompletionKey, &Overlapped, 0) )
  {
    ...
    for ( i = (_QWORD *)*((_QWORD *)v1 + 3); ; i = (_QWORD *)*i )
    {
      if ( i == (_QWORD *)((char *)v1 + 24) )
        goto LABEL_2;
      if ( i == (_QWORD *)CompletionKey )
        break;
    }
...
LABEL_12:
    if ( v5 != (__int64 *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 7) + 40LL))(*((_QWORD *)this + 7)) )
    {
      ...
      if ( Callback < 0 || (Callback = AggregateWaitHandle::AddHandle(v1, v5), Callback < 0) )
      {
...
LABEL_17:
    v11 = AggregateWaitHandle::AddHandle(v1, v5);
    if ( v11 < 0 )
      return v11;
    return Callback;
  }
