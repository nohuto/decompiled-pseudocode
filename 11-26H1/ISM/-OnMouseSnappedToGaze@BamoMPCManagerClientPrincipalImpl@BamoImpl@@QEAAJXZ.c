/*
 * XREFs of ?OnMouseSnappedToGaze@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x18016C0B4
 * Callers:
 *     ?Thunk_OnMouseSnappedToGaze_41@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016C5C0 (-Thunk_OnMouseSnappedToGaze_41@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincip.c)
 * Callees:
