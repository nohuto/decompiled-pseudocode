/*
 * XREFs of ?LogSendRemoteReplace@BamoList_DisplayOcclusionRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXIAEBUDisplayOcclusionRect@@@Z @ 0x180140888
 * Callers:
...
void __fastcall Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_DisplayOcclusionRect_StubImpl::LogSendRemoteReplace(
        ...
        const struct DisplayOcclusionRect *a3)
{
  ...
  const struct DisplayOcclusionRect *v11; // [rsp+70h] [rbp+18h] BYREF
