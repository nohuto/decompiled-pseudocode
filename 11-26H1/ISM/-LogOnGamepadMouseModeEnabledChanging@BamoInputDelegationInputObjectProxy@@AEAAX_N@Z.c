/*
 * XREFs of ?LogOnGamepadMouseModeEnabledChanging@BamoInputDelegationInputObjectProxy@@AEAAX_N@Z @ 0x180135F78
 * Callers:
...
void __fastcall BamoInputDelegationInputObjectProxy::LogOnGamepadMouseModeEnabledChanging(
