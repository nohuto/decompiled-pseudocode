/*
 * XREFs of ?UpdateDeviceTransformsFromInputConfig@GazeProcessor@@IEAAJPEAUInputConfigContextMessage@@@Z @ 0x1801BD8CC
 * Callers:
 *     ?OnDeviceUpdate@GazeProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801BD290 (-OnDeviceUpdate@GazeProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 *     ?OnSystemContextNotification@GazeProcessor@@UEAAJPEAV?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@UMIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE@@@std@@@Z @ 0x1801BD630 (-OnSystemContextNotification@GazeProcessor@@UEAAJPEAV-$variant@Umonostate@std@@UInputConfigConte.c)
 * Callees:
 ...
 *     ?GetTransfromToOutputSpace@InputConfiguration@@YA?AUfloat3x2@Numerics@Foundation@Windows@@UINPUT_SPACE_REGION@@UtagRECT@@@Z @ 0x18010B930 (-GetTransfromToOutputSpace@InputConfiguration@@YA-AUfloat3x2@Numerics@Foundation@Windows@@UINPUT.c)
 */
...
__int64 __fastcall GazeProcessor::UpdateDeviceTransformsFromInputConfig(GazeProcessor *this, InputConfiguration **a2)
{
  ...
  __int128 v17; // xmm0
  __int64 v18; // rax
  __m128i *TransfromToOutputSpace; // rax
  ...
  *((_BYTE *)this + 96) = 0;
        ...
        DefaultRegionConfiguration >= 0) )
  {
    ...
    *(__m128i *)((char *)this + 100) = *TransfromToOutputSpace;
    *(_QWORD *)&v16 = TransfromToOutputSpace[1].m128i_i64[0];
    result = 0LL;
