/*
 * XREFs of ?Set3DFocusTarget@MPCInputRouter@@AEAAXPEAUIMPCFocusTarget@@@Z @ 0x180100408
 * Callers:
...
{
  struct IMPCFocusTarget **v4; // rdi
  struct IMPCFocusTarget **v5; // r14
  MPCHolographicInputManager *Instance; // rax
  struct IMPCFocusTarget *v7; // rbx
  struct IMPCFocusTarget *v8; // rbp
  ISMTracing *v9; // rcx
  __int64 v10; // rbx
  struct IMPCFocusTarget *v11; // [rsp+40h] [rbp+8h] BYREF
  ...
  if ( *v4 && *((_BYTE *)this + 752) )
  {
    v10 = *((_QWORD *)this + 95);
    if ( v10 == (*(__int64 (__fastcall **)(struct IMPCFocusTarget *))(*(_QWORD *)*v4 + 56LL))(*v4) )
