/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoInputSiteManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180133010
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::BamoInputSiteManagerStubImpl *this)
{
  ...
  if ( *(int *)(v3 + 8) > 0 )
  {
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteManagerPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoInputSiteManagerPrincipalImpl>((__int64)v6);
  }
  return v2;
}
