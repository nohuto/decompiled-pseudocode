/*
 * XREFs of ?LogReceiveRegisterSystemContextEndpoint@BamoSystemContextManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemContextEndpointProxy@@@Z @ 0x1801404C8
 * Callers:
