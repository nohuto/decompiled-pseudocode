/*
 * XREFs of ?LogOnIsInputDisabledChanging@BamoCUIComponentInputObjectProxy@@AEAAX_N@Z @ 0x180134C84
 * Callers:
...
void __fastcall BamoCUIComponentInputObjectProxy::LogOnIsInputDisabledChanging(BamoCUIComponentInputObjectProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
