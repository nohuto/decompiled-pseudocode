/*
 * XREFs of ?QueryInterface@CUIComponentInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180135570
 * Callers:
 *     ?QueryInterface@CUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180135640 (-QueryInterface@CUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CUIComponentInputObjectProxy@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180135650 (-QueryInterface@CUIComponentInputObjectProxy@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_14:
  ...
  *a3 = (char *)this + 8;
  if ( this == (CUIComponentInputObjectProxy *)-8LL )
    return (unsigned int)-2147467262;
  (**(void (__fastcall ***)(CUIComponentInputObjectProxy *))this)(this);
  return v6;
}
