/*
 * XREFs of ?DecrementThreadRecursionDepth@ComTaskPool@Internal@Windows@@SAXXZ @ 0x180171A9C
 * Callers:
...
void Windows::Internal::ComTaskPool::DecrementThreadRecursionDepth(void)
{
  __int64 v0; // rbx
