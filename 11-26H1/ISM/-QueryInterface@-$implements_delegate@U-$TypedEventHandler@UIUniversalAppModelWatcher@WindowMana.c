/*
 * XREFs of ?QueryInterface@?$implements_delegate@U?$TypedEventHandler@UIUniversalAppModelWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UUniversalPropertyChangedEventArgs@23456@@Foundation@Windows@winrt@@V_lambda_d7951b2d46f88de3e36d3c8b29e58ea6_@@@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800A8E10
 * Callers:
 *     <none>
 * Callees:
