/*
 * XREFs of ?GetInputSystemInternalServerConnection@ISMStatics@@SAPEAVInputSystemInternalServerConnection@@XZ @ 0x18004607C
 * Callers:
  ...
  if ( !ISMStatics::s_inputSystemInternalServerConnection )
  {
    ...
    if ( v1 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v6);
    v2 = InputSystemInternalServerConnection::Create(&v9, v8);
    v3 = *v2;
    *v2 = 0LL;
