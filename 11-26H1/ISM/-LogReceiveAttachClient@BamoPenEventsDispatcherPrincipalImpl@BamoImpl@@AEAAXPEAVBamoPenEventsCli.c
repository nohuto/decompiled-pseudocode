/*
 * XREFs of ?LogReceiveAttachClient@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoPenEventsClientProxy@@@Z @ 0x1800989A4
 * Callers:
...
void __fastcall BamoImpl::BamoPenEventsDispatcherPrincipalImpl::LogReceiveAttachClient(
