/*
 * XREFs of ?LogReceiveProcessResult@BamoGestureServicesPrincipalImpl@BamoImpl@@AEAAXIAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x180145944
 * Callers:
