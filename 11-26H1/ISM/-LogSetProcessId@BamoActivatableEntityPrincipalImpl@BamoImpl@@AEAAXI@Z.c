/*
 * XREFs of ?LogSetProcessId@BamoActivatableEntityPrincipalImpl@BamoImpl@@AEAAXI@Z @ 0x18008E958
 * Callers:
...
void __fastcall BamoImpl::BamoActivatableEntityPrincipalImpl::LogSetProcessId(
