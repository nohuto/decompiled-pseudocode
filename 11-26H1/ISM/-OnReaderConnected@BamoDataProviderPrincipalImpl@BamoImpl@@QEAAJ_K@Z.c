/*
 * XREFs of ?OnReaderConnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180104BAC
 * Callers:
 *     ?Thunk_OnReaderConnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180107520 (-Thunk_OnReaderConnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoI.c)
 * Callees:
