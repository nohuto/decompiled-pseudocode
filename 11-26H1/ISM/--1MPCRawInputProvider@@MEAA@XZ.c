/*
 * XREFs of ??1MPCRawInputProvider@@MEAA@XZ @ 0x1800CEC50
 * Callers:
...
void __fastcall MPCRawInputProvider::~MPCRawInputProvider(MPCRawInputProvider *this)
{
  ...
  *(_QWORD *)this = &MPCRawInputProvider::`vftable';
  ...
  if ( *((_QWORD *)this + 2) )
  {
    ...
    for ( i = (_QWORD *)*v7; i != v8; i += 2 )
      (*(void (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this + 2) + 64LL))(*((_QWORD *)this + 2), *i);
  }
  ...
  if ( v10 )
  {
    std::_Deallocate<16>(v10, (struct std::nothrow_t *)((__int64)(*((_QWORD *)this + 25) - (_QWORD)v10) >> 6 << 6));
    *((_QWORD *)this + 23) = 0LL;
    *((_QWORD *)this + 24) = 0LL;
    *((_QWORD *)this + 25) = 0LL;
  }
  std::vector<Windows::UI::Color>::_Tidy((__int64 *)this + 20);
  v11 = *((_QWORD *)this + 17);
  if ( v11 )
  {
