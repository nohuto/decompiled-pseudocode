/*
 * XREFs of ??$_Reallocate_grow_by@V_lambda_156f8c05752017390d6185e99ef4c093_@@_KPEBG_K@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEAAAEAV01@_KV_lambda_156f8c05752017390d6185e99ef4c093_@@_KPEBG2@Z @ 0x1800B2DFC
 * Callers:
        ...
        __int64 a6)
{
  ...
  else
  {
    ...
    std::_Deallocate<16>(v15, (struct std::nothrow_t *)(2 * v8 + 2));
  }
  *Src = v11;
  return Src;
}
