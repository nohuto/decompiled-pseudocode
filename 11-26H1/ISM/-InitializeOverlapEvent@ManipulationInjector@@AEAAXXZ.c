/*
 * XREFs of ?InitializeOverlapEvent@ManipulationInjector@@AEAAXXZ @ 0x180114360
 * Callers:
 ...
 *     ?CreateOverlapEvent@ManipulationInjector@@AEAAXXZ @ 0x180113BB8 (-CreateOverlapEvent@ManipulationInjector@@AEAAXXZ.c)
 */
