/*
 * XREFs of ?Add@?$ListPrincipalSimpleCommon@VBamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@VBamoList_uint_Stub@2345@II@Bamo@Microsoft@@QEAAJI@Z @ 0x1801026D0
 * Callers:
 ...
 *     std::for_each_std::_List_const_iterator_std::_List_val_std::_List_simple_types_unsigned_int_______lambda_1f06d20aa2c7b6f65f005431986a59fb___ @ 0x180149384 (std--for_each_std--_List_const_iterator_std--_List_val_std--_List_simple_types_unsigned_int_____.c)
 * Callees:
