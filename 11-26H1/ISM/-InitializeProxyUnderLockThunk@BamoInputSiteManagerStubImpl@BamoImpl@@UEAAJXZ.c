/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoInputSiteManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180070570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSiteManagerStubImpl::InitializeProxyUnderLockThunk(
