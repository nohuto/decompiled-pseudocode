/*
 * XREFs of ?LogOnIdChanged@BamoAnimationTargetClientProxy@@AEAAXXZ @ 0x180149040
 * Callers:
...
void __fastcall BamoAnimationTargetClientProxy::LogOnIdChanged(BamoAnimationTargetClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
