/*
 * XREFs of ??$?4V?$_Binder@U_Unforced@std@@P8GameInputProcessor@@EAAXPEAUDeviceInfo@@@_EPEAV3@AEBU?$_Ph@$00@2@@std@@$0A@@?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@QEAAAEAV01@$$QEAV?$_Binder@U_Unforced@std@@P8GameInputProcessor@@EAAXPEAUDeviceInfo@@@_EPEAV3@AEBU?$_Ph@$00@2@@1@@Z @ 0x1801B1450
 * Callers:
        ...
        __int128 *a2)
{
  ...
  std::_Func_class<void,>::~_Func_class<void,>((__int64)v12, v4);
  std::_Func_class<void,>::~_Func_class<void,>((__int64)&v7, v5);
  return a1;
}
