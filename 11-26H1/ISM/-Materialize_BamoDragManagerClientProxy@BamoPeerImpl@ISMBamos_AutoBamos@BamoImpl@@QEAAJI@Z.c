/*
 * XREFs of ?Materialize_BamoDragManagerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18004C670
 * Callers:
 *     ?Thunk_Materialize_BamoDragManagerClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004C660 (-Thunk_Materialize_BamoDragManagerClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  v12 = 0LL;
  v5 = (unsigned int)a2;
  BamoImpl::CreateDragManagerClientProxy(
