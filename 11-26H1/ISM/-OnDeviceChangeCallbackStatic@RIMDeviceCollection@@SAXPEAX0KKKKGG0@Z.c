/*
 * XREFs of ?OnDeviceChangeCallbackStatic@RIMDeviceCollection@@SAXPEAX0KKKKGG0@Z @ 0x180083360
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  else
  {
    ...
    if ( !*((_QWORD *)a9 + 10) )
      *((_QWORD *)a9 + 10) = a1;
    Device = RIMDeviceCollection::AttachDevice(v20, a1, a2, a5, (struct RIMDevice **)v22);
    if ( Device < 0 )
    {
      v15 = 328LL;
      goto LABEL_8;
