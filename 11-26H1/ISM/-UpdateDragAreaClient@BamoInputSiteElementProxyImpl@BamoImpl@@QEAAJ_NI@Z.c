/*
 * XREFs of ?UpdateDragAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003C824
 * Callers:
 *     ?Thunk_UpdateDragAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003C810 (-Thunk_UpdateDragAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@Ba.c)
...
__int64 __fastcall BamoImpl::BamoInputSiteElementProxyImpl::UpdateDragAreaClient(
        ...
        __int64 a3)
{
  ...
  struct BamoDragAreaClientProxy *v7; // rsi
  __int64 v8; // rbx
  int v10; // eax
  int v11; // eax
...
LABEL_2:
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnDragAreaClientChanging(
      ...
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1);
      v10 = (*(__int64 (__fastcall **)(char *, struct BamoDragAreaClientProxy *))(*((_QWORD *)this - 2) + 328LL))(
              (char *)this - 16,
              v7);
      if ( v10 < 0 )
    ...
    *((_QWORD *)this + 18) = v7;
    if ( v7 )
      (**(void (__fastcall ***)(struct BamoDragAreaClientProxy *))v7)(v7);
    if ( v8 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      BamoInputSiteElementProxy::LogOnDragAreaClientChanged((BamoImpl::BamoInputSiteElementProxyImpl *)((char *)this - 16));
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellGesturesClientProxyImpl>(
        (__int64)v15,
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        (void (__fastcall ***)(_QWORD))this,
        2);
      v11 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 336LL))((char *)this - 16);
      if ( v11 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0x2A84,
