/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoDeviceDockServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180070400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDeviceDockServerStubImpl::OnConnectedUnderLockThunk(
