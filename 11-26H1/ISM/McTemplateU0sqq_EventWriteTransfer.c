/*
 * XREFs of McTemplateU0sqq_EventWriteTransfer @ 0x1801A0CB4
 * Callers:
 *     ?QueryInterface@InputInfoValidator@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A0860 (-QueryInterface@InputInfoValidator@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 ...
 *     ?IsProxyInitialized@TextInputStateAdapter@@UEAAJPEA_N@Z @ 0x1801D28A0 (-IsProxyInitialized@TextInputStateAdapter@@UEAAJPEA_N@Z.c)
 ...
 *     ?SetInterestedProperty@TextInputStateAdapter@@UEAAJG_N@Z @ 0x1801D3C80 (-SetInterestedProperty@TextInputStateAdapter@@UEAAJG_N@Z.c)
 *     __lambda_4790bba48f35d5d527bba9490b41a1e9_::operator()_::_1_::catch$1 @ 0x1801DD81F (__lambda_4790bba48f35d5d527bba9490b41a1e9_--operator()_--_1_--catch$1.c)
 *     _HotKeyProcessor::RegisterHotKey_::_1_::catch$4 @ 0x1801DD93C (_HotKeyProcessor--RegisterHotKey_--_1_--catch$4.c)
 *     _HotKeyProcessor::RegisterHotKey_::_1_::catch$5 @ 0x1801DD98B (_HotKeyProcessor--RegisterHotKey_--_1_--catch$5.c)
 *     _HotKeyProcessor::RegisterHotKeyClient_::_1_::catch$2 @ 0x1801DD9DA (_HotKeyProcessor--RegisterHotKeyClient_--_1_--catch$2.c)
 * Callees:
 *     __security_check_cookie @ 0x18009ACC0 (__security_check_cookie.c)
 *     McGenEventWrite_EventWriteTransfer @ 0x1801A0C4C (McGenEventWrite_EventWriteTransfer.c)
 */
