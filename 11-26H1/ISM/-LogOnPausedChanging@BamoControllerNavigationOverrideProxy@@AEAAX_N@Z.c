/*
 * XREFs of ?LogOnPausedChanging@BamoControllerNavigationOverrideProxy@@AEAAX_N@Z @ 0x18017AFF8
 * Callers:
...
void __fastcall BamoControllerNavigationOverrideProxy::LogOnPausedChanging(BamoControllerNavigationOverrideProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
