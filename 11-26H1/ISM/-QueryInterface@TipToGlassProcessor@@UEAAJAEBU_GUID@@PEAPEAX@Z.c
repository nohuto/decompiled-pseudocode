/*
 * XREFs of ?QueryInterface@TipToGlassProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007F400
 * Callers:
 *     ?QueryInterface@TipToGlassProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B6ED0 (-QueryInterface@TipToGlassProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
