/*
 * XREFs of ?QueryInterface@MPCTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800963B0
 * Callers:
 *     ?QueryInterface@MPCFocusTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180096340 (-QueryInterface@MPCFocusTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180101D50 (-QueryInterface@MPCTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?QueryInterface@RefCountedObject@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A1E30 (-QueryInterface@RefCountedObject@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
