/*
 * XREFs of ??1GestureClient@GestureHandler@@QEAA@XZ @ 0x180144988
 * Callers:
 ...
 *     _GestureHandler::AddGestureClient_::_1_::dtor$3 @ 0x1801DB461 (_GestureHandler--AddGestureClient_--_1_--dtor$3.c)
 * Callees:
