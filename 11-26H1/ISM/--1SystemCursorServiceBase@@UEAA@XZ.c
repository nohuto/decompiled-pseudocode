/*
 * XREFs of ??1SystemCursorServiceBase@@UEAA@XZ @ 0x1800FAA94
 * Callers:
 *     _SystemCursorService2::SystemCursorService2_::_1_::dtor$1 @ 0x1801DA921 (_SystemCursorService2--SystemCursorService2_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
