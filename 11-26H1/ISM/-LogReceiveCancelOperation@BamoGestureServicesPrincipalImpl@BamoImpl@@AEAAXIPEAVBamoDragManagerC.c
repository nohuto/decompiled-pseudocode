/*
 * XREFs of ?LogReceiveCancelOperation@BamoGestureServicesPrincipalImpl@BamoImpl@@AEAAXIPEAVBamoDragManagerClientProxy@@W4GestureProcessorType@@@Z @ 0x18014587C
 * Callers:
