/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180141940
 * Callers:
 *     ?Thunk_RegisterSystemContextEndpoint_8@?$ISystemContextManagerPrincipal_Receive@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143660 (-Thunk_RegisterSystemContextEndpoint_8@-$ISystemContextManagerPrincipal_Receive@VBamoSystemConte.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoSystemContextEndpointProxy *v10; // rbp
  ...
  BamoImpl::BamoSystemContextManagerPrincipalImpl::LogReceiveRegisterSystemContextEndpoint(this, v10);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v8,
      (__int64)this);
    v17 = (*(__int64 (__fastcall **)(char *, __int64, struct BamoSystemContextEndpointProxy *))(*((_QWORD *)this - 2)
                                                                                              + 112LL))(
            (char *)this - 16,
            v6,
            v10);
