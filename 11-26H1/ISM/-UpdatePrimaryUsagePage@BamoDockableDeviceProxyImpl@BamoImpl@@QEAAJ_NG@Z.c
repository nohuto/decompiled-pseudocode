/*
 * XREFs of ?UpdatePrimaryUsagePage@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NG@Z @ 0x18012E2DC
 * Callers:
 *     ?Thunk_UpdatePrimaryUsagePage_80@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129710 (-Thunk_UpdatePrimaryUsagePage_80@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@Bam.c)
