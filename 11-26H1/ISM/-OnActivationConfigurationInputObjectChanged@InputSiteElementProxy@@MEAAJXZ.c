/*
 * XREFs of ?OnActivationConfigurationInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005B4A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActivationConfigurationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005B514 (--$RemoveObject@UIActivationConfigurationInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElement.c)
