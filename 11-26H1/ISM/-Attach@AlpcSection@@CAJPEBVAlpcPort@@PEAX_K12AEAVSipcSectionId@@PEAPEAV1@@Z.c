/*
 * XREFs of ?Attach@AlpcSection@@CAJPEBVAlpcPort@@PEAX_K12AEAVSipcSectionId@@PEAPEAV1@@Z @ 0x180110154
 * Callers:
  ...
  *((_OWORD *)a6 + 1) = *(_OWORD *)(v12 + 24);
  ...
  if ( DuplicateHandle(v15, a4, CurrentProcess, (LPHANDLE)&TargetHandle, 0, 0, 2u) )
  {
    ...
    if ( v18 )
    {
      ...
      *((_QWORD *)v18 + 14) = a5;
      TargetHandle = 0LL;
      SipcSection::ProtectExtraMemory((SipcSection *)v18);
      v17 = 0;
    }
    else
    {
