/*
 * XREFs of ?UpdateCallbacksRemoteCache@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@AEAAXXZ @ 0x18016AD7C
 * Callers:
 *     ?PushStateToPrincipal@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEAAXXZ @ 0x180168560 (-PushStateToPrincipal@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEAAXXZ.c)
