/*
 * XREFs of ??1InputProviderManager@@QEAA@XZ @ 0x1800967D0
 * Callers:
 *     _DeviceInputHost::DeviceInputHost_::_1_::dtor$4 @ 0x1801D7318 (_DeviceInputHost--DeviceInputHost_--_1_--dtor$4.c)
 * Callees:
