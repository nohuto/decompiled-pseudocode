/*
 * XREFs of ?UpdateWinKeyScenarioStatusAndLogLatency@WinKeyScenarioTelemetry@@CA_NXZ @ 0x180029AF4
 * Callers:
 ...
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$03@@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$03@@33@Z @ 0x180005BE8 (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapperByVal@$03@@U1@U1@@-$_tlgWriteTemplate@$$A6AJPEBU.c)
 *     _tlgKeywordOn @ 0x180047A20 (_tlgKeywordOn.c)
 *     ?GetTimeElapsedSec@WinKeyScenarioTelemetry@@CA_KXZ @ 0x18010D9F0 (-GetTimeElapsedSec@WinKeyScenarioTelemetry@@CA_KXZ.c)
 *     ?SetWinKeyScenarioStarted@WinKeyScenarioTelemetry@@CAX_N@Z @ 0x18010DC2C (-SetWinKeyScenarioStarted@WinKeyScenarioTelemetry@@CAX_N@Z.c)
 */
...
bool WinKeyScenarioTelemetry::UpdateWinKeyScenarioStatusAndLogLatency(void)
{
  ...
  if ( WinKeyScenarioTelemetry::s_winKeyScenarioStarted )
  {
    ...
    if ( TimeElapsedSec >= 5 )
    {
      if ( (unsigned int)dword_1802512B8 > 5
        && (unsigned __int8)tlgKeywordOn(&dword_1802512B8, 0x400000000000LL, TimeElapsedSec) )
      {
