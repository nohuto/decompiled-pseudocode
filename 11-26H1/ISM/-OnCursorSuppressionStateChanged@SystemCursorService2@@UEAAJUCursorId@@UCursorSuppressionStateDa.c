/*
 * XREFs of ?OnCursorSuppressionStateChanged@SystemCursorService2@@UEAAJUCursorId@@UCursorSuppressionStateData@@@Z @ 0x1800FC2E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v14 = v3;
  v9 = *(_QWORD *)std::unordered_map<unsigned __int64,unsigned __int64>::operator[](
                    (_QWORD *)(a1 + 184),
                    (unsigned __int8 *)&v14);
  v10 = *(_QWORD *)(a1 + 8);
  v15 = v9;
