/*
 * XREFs of ?SetDelegateInformation@InputDelegationInputObjectProxy@@UEAAXIII@Z @ 0x180136BD0
 * Callers:
 *     ?SetDelegateInformationEx@InputDelegationInputObjectProxy@@UEAAXI_KIII@Z @ 0x180136C90 (-SetDelegateInformationEx@InputDelegationInputObjectProxy@@UEAAXI_KIII@Z.c)
 * Callees:
