/*
 * XREFs of ?OnInput@TapProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801B6AE0
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a4 + 2) = 4;
  ...
  if ( (*(_DWORD *)a2 & 4) != 0 )
  {
    if ( (*((_BYTE *)a2 + 94) & 1) != 0 )
    {
      ...
      if ( v9 != 1
        && v9 != 2
        && (unsigned __int16)(v9 - 4) > 2u
        && *((_WORD *)a2 + 28) != 0xFFFD
        && *((_WORD *)a2 + 28) != 0xFFFE
        && *((_BYTE *)this + 64) )
      {
        InputModalityManager::SetLastUserInputModality((_DWORD *)this + 18, 4, 0, 0, *((_DWORD *)a2 + 1));
        InputModalityManager::SendInputModalityToInputService(v10, *((struct IInputServiceProxy **)this + 6));
      }
    }
  }
  else
