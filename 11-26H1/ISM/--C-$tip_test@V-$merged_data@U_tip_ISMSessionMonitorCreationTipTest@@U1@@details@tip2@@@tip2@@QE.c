/*
 * XREFs of ??C?$tip_test@V?$merged_data@U_tip_ISMSessionMonitorCreationTipTest@@U1@@details@tip2@@@tip2@@QEAA?AV?$test_data_control@V?$merged_data@U_tip_ISMSessionMonitorCreationTipTest@@U1@@details@tip2@@@1@XZ @ 0x1800A3220
 * Callers:
        ...
        struct _RTL_CRITICAL_SECTION **a2)
{
  ...
  *a2 = *v3;
  if ( v4 )
    _InterlockedIncrement((volatile signed __int32 *)&v4[7]);
  v5 = *a2;
