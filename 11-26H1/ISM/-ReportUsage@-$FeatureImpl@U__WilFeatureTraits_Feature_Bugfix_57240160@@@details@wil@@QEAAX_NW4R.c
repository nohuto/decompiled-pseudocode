/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Bugfix_57240160@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800AD250
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_Bugfix_57240160>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  v4 = a2;
  LODWORD(v5) = *(_DWORD *)Feature_Bugfix_57240160__descriptor;
  if ( (*(_DWORD *)Feature_Bugfix_57240160__descriptor & 4) == 0 )
  {
    v5 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_Bugfix_57240160>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v6);
    v6 = v5;
  }
