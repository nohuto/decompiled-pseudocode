/*
 * XREFs of ?LogOnTypeChanged@BamoWindowsMessageDeliveryProxy@@AEAAXXZ @ 0x18013A9EC
 * Callers:
...
void __fastcall BamoWindowsMessageDeliveryProxy::LogOnTypeChanged(BamoWindowsMessageDeliveryProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
