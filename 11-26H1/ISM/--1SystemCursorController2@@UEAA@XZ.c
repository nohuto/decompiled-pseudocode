/*
 * XREFs of ??1SystemCursorController2@@UEAA@XZ @ 0x1800F7E7C
 * Callers:
...
void __fastcall SystemCursorController2::~SystemCursorController2(SystemCursorController2 *this)
{
  __int64 v2; // rdx
  __int64 v3; // r8
  const char *v4; // r9
