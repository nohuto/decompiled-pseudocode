/*
 * XREFs of ?SetCursorShellVisibility@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K_N@Z @ 0x1800F97FC
 * Callers:
 *     ?Thunk_SetCursorShellVisibility_386@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F9AD0 (-Thunk_SetCursorShellVisibility_386@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursor.c)
 * Callees:
