/*
 * XREFs of ?ResendGamepadIsSupportedForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800B8320
 * Callers:
 *     ?Thunk_ResendGamepadIsSupportedForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B90C0 (-Thunk_ResendGamepadIsSupportedForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
