/*
 * XREFs of ?LogOnIsActiveChanging@BamoVirtualTouchpadControllerProxy@@AEAAX_N@Z @ 0x180138224
 * Callers:
...
void __fastcall BamoVirtualTouchpadControllerProxy::LogOnIsActiveChanging(BamoVirtualTouchpadControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
