/*
 * XREFs of ?Create@InputRedirectionTarget@@SAJK_KPEAUtagMsgRoutingInfo@@PEAPEAV1@W4InputType@@_N@Z @ 0x1801B4900
 * Callers:
        ...
        char a6)
{
  ...
  InputRedirectionTarget *v21; // [rsp+58h] [rbp+20h] BYREF
...
LABEL_8:
  ...
  v21 = (InputRedirectionTarget *)v12;
  if ( v12 )
  {
    v14 = *a3;
    v15 = a3[1];
