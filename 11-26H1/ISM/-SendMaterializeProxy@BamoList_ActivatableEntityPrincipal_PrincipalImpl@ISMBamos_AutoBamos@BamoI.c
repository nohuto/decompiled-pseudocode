/*
 * XREFs of ?SendMaterializeProxy@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@36@@Z @ 0x180034960
 * Callers:
 *     <none>
 * Callees:
