/*
 * XREFs of ??1?$_Hash@V?$_Umap_traits@_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x18013BEC8
 * Callers:
 *     ??1?$CBaseInputObserverServer@$0L@@@MEAA@XZ @ 0x18013BE9C (--1-$CBaseInputObserverServer@$0L@@@MEAA@XZ.c)
 *     ??1?$unordered_map@_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@U?$hash@_K@std@@U?$equal_to@_K@4@V?$allocator@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@@std@@@4@@std@@QEAA@XZ @ 0x18013BF94 (--1-$unordered_map@_KUInputObserverClient@-$CBaseInputObserverServer@$0L@@@U-$hash@_K@std@@U-$eq.c)
 * Callees:
        ...
        __int64 *a1)
{
  ...
  std::_List_node<std::pair<unsigned __int64 const,CBaseInputObserverServer<11>::InputObserverClient>,void *>::_Free_non_head<std::allocator<std::_List_node<std::pair<unsigned __int64 const,CBaseInputObserverServer<11>::InputObserverClient>,void *>>>(
    (__int64)v2,
    a1[1]);
  std::_Deallocate<16>((void *)a1[1], (struct std::nothrow_t *)0x28);
}
