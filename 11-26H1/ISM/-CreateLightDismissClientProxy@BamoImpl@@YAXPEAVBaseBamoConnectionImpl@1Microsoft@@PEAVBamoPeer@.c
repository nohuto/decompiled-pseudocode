/*
 * XREFs of ?CreateLightDismissClientProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x18009372C
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *((_QWORD *)v7 + 4) = 0LL;
  *((_QWORD *)v7 + 5) = 0LL;
  *((_QWORD *)v7 + 2) = &BamoImpl::BamoLightDismissClientProxyImpl::`vftable';
  *(_QWORD *)v7 = &LightDismissClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v7 + 1) = &LightDismissClientProxy::`vftable'{for `ILightDismissClientProxy'};
  if ( v11 && (v12 & 2) != 0 )
