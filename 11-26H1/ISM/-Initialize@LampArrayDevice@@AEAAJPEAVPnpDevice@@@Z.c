/*
 * XREFs of ?Initialize@LampArrayDevice@@AEAAJPEAVPnpDevice@@@Z @ 0x1800E6D9C
 * Callers:
...
LABEL_9:
    ...
    if ( v7 > v9 )
    {
      ...
      std::vector<Windows::UI::Color>::_Resize_reallocate<std::_Value_init_tag>((__int64 *)this + 21, v7);
    }
LABEL_10:
