/*
 * XREFs of ?Initialize@LampArrayRawInputProvider@@AEAAJPEAUIRawInputClient@@@Z @ 0x1800E3C48
 * Callers:
 ...
 *     ?OnSessionNotification@LampArrayRawInputProvider@@UEAAJII@Z @ 0x1800E41B0 (-OnSessionNotification@LampArrayRawInputProvider@@UEAAJII@Z.c)
 * Callees:
