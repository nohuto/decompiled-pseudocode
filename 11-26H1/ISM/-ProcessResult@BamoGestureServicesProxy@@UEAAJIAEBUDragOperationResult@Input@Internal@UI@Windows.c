/*
 * XREFs of ?ProcessResult@BamoGestureServicesProxy@@UEAAJIAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientPrincipal@@@Z @ 0x180123EC0
 * Callers:
 *     <none>
 * Callees:
