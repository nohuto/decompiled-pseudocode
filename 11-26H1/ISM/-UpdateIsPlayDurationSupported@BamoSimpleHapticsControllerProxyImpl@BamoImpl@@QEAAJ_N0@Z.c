/*
 * XREFs of ?UpdateIsPlayDurationSupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18012D980
 * Callers:
 *     ?Thunk_UpdateIsPlayDurationSupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129640 (-Thunk_UpdateIsPlayDurationSupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapti.c)
