/*
 * XREFs of ?QueryInterface@BamoEdgyControllerServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015AD40
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015ADC0 (-QueryInterface@BamoEdgyControllerServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoEdgyControllerServerPrincipal *)-8LL )
    return (unsigned int)-2147467262;
