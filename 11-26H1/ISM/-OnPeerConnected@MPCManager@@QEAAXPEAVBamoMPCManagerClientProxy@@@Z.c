/*
 * XREFs of ?OnPeerConnected@MPCManager@@QEAAXPEAVBamoMPCManagerClientProxy@@@Z @ 0x1800B7CB8
 * Callers:
...
void __fastcall MPCManager::OnPeerConnected(MPCManager *this, struct BamoMPCManagerClientProxy *a2)
{
  ...
  *(_QWORD *)(*(_QWORD *)v5 + 40LL) = v4;
  ...
  {
    v7 = *(__int64 (__fastcall **)(char *, __int64, _QWORD))(*(_QWORD *)v3 + 32LL);
