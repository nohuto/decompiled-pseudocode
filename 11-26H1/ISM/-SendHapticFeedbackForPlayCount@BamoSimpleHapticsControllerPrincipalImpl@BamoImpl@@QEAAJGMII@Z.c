/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMII@Z @ 0x18018A928
 * Callers:
 *     ?Thunk_SendHapticFeedbackForPlayCount_371@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018B400 (-Thunk_SendHapticFeedbackForPlayCount_371@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpl.c)
 * Callees:
