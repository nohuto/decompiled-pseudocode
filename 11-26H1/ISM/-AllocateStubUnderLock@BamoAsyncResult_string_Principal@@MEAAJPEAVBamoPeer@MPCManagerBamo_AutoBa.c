/*
 * XREFs of ?AllocateStubUnderLock@BamoAsyncResult_string_Principal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoAsyncResult_string_Stub@@@Z @ 0x1801775F0
 * Callers:
 *     <none>
 * Callees:
