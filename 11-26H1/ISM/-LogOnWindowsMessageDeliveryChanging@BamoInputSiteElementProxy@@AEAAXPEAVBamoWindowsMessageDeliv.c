/*
 * XREFs of ?LogOnWindowsMessageDeliveryChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoWindowsMessageDeliveryProxy@@@Z @ 0x18008F680
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnWindowsMessageDeliveryChanging(
