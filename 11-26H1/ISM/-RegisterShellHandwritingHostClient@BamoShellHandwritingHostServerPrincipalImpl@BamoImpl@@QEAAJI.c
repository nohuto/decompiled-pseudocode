/*
 * XREFs of ?RegisterShellHandwritingHostClient@BamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18015F1E0
 * Callers:
 *     ?Thunk_RegisterShellHandwritingHostClient_8@?$IShellHandwritingHostServerPrincipal_Receive@VBamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015F380 (-Thunk_RegisterShellHandwritingHostClient_8@-$IShellHandwritingHostServerPrincipal_Receive@VBamo.c)
 * Callees:
