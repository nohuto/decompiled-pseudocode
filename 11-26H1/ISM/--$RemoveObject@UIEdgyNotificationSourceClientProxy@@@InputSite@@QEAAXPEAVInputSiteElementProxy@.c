/*
 * XREFs of ??$RemoveObject@UIEdgyNotificationSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005A038
 * Callers:
...
void __fastcall InputSite::RemoveObject<IEdgyNotificationSourceClientProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v5 != v6 )
  {
    ...
    v10 = v9(v8, &GUID_2066a149_dd02_cdd2_a948_2c520fd9e943, &v12) >= 0;
    if ( v7 == a2 && v10 )
      break;
    v5 += 2;
  }
