/*
 * XREFs of ?AddOnDeviceRemovalCallback@DWMInputRouter@@UEAAXPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@Z @ 0x1801A2FC0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall DWMInputRouter::AddOnDeviceRemovalCallback(__int64 a1, __int64 a2)
{
  _QWORD *v2; // rcx
  _QWORD *result; // rax
  _QWORD *v4; // rdx
