/*
 * XREFs of ?UpdateIsShell@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18019ADB4
 * Callers:
 *     ?Thunk_UpdateIsShell_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18019AA50 (-Thunk_UpdateIsShell_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@.c)
