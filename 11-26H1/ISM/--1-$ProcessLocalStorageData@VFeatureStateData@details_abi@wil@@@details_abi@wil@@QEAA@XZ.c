/*
 * XREFs of ??1?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x18009DC98
 * Callers:
 ...
 * Callees:
 *     ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x18009DD74 (--1FeatureStateData@details_abi@wil@@QEAA@XZ.c)
