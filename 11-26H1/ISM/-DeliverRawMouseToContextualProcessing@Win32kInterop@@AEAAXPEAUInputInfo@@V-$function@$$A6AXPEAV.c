/*
 * XREFs of ?DeliverRawMouseToContextualProcessing@Win32kInterop@@AEAAXPEAUInputInfo@@V?$function@$$A6AXPEAVInputContext@@@Z@std@@V?$function@$$A6AXPEAUIInputTarget@@@Z@4@@Z @ 0x1800223E4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 + 192) )
  {
    ...
    if ( (*(int (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(**(_QWORD **)(a1 + 48) + 64LL))(
           ...
           *v8,
           (a1 + 8) & -(__int64)(a1 != 0)) >= 0 )
      Microsoft::WRL::ComPtr<IMPCFocusTarget>::operator=(a1 + 208, &v20);
    *(_BYTE *)(a1 + 192) = 0;
