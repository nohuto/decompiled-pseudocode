/*
 * XREFs of ?UpdateDeliveryMode@BamoManualDragAreaClientProxyImpl@BamoImpl@@QEAAJ_NW4InputDeliveryMode@Input@Internal@UI@Windows@@@Z @ 0x18014BCA0
 * Callers:
 *     ?Thunk_UpdateDeliveryMode_16@?$IManualDragAreaClientProxy_Receive@VBamoManualDragAreaClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18014BC70 (-Thunk_UpdateDeliveryMode_16@-$IManualDragAreaClientProxy_Receive@VBamoManualDragAreaClientProxy.c)
