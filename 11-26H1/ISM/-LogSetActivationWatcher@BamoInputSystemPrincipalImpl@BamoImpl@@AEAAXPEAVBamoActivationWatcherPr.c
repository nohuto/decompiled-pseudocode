/*
 * XREFs of ?LogSetActivationWatcher@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoActivationWatcherPrincipal@@@Z @ 0x18008FB78
 * Callers:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::LogSetActivationWatcher(
