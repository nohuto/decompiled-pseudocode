/*
 * XREFs of ?UpdateDeviceId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NPEBUDockableDeviceIdentity@@@Z @ 0x18012AB2C
 * Callers:
 *     ?Thunk_UpdateDeviceId_75@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129290 (-Thunk_UpdateDeviceId_75@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@.c)
        ...
        const struct DockableDeviceIdentity *a3)
{
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoDockableDeviceProxy::LogOnDeviceIdChanging((BamoImpl::BamoDockableDeviceProxyImpl *)((char *)this - 16), a2);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      1);
    v7 = (*(__int64 (__fastcall **)(BamoDockableDeviceProxy *, const struct DockableDeviceIdentity *))(*(_QWORD *)v6 + 120LL))(
           v6,
           a3);
    if ( v7 < 0 )
  ...
  *(_OWORD *)((char *)this + 40) = *(_OWORD *)a3;
  if ( *((_BYTE *)this + 28) )
  {
    BamoDockableDeviceProxy::LogOnDeviceIdChanged(v6);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v10,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      2);
    v8 = (*(__int64 (__fastcall **)(BamoDockableDeviceProxy *))(*(_QWORD *)v6 + 128LL))(v6);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0xBBA5,
