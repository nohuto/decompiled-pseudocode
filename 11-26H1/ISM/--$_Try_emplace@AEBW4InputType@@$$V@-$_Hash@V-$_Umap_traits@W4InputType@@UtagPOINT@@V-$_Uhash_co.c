 ...
 *     ??$?0AEBK$$Z$$V@?$pair@$$CBKUtagPOINT@@@std@@QEAA@Upiecewise_construct_t@1@V?$tuple@AEBK@1@V?$tuple@$$V@1@@Z @ 0x1800F7840 (--$-0AEBK$$Z$$V@-$pair@$$CBKUtagPOINT@@@std@@QEAA@Upiecewise_construct_t@1@V-$tuple@AEBK@1@V-$tu.c)
 */
        ...
        unsigned __int8 *a3)
{
  ...
  else
  {
    ...
    v17 = v7;
    v19 = a3;
    ____0AEBK__Z__V___pair___CBKUtagPOINT___std__QEAA_Upiecewise_construct_t_1_V__tuple_AEBK_1_V__tuple___V_1__Z(
      (__int64)(v7 + 4),
      v8,
      (__int64)&v19);
    v9 = *((_QWORD *)a1 + 2) + 1LL;
    ...
    if ( (float)(v10 / v12) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<unsigned int,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,winrt::Windows::Internal::ApplicationModel::WindowManagement::AppView>>,0>>::_Forced_rehash(
        (__int64)a1,
        v14);
      v18 = *(_OWORD *)std::_Hash<std::_Umap_traits<unsigned long,IRawInputProvider *,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,IRawInputProvider *>>,0>>::_Find_last<unsigned long>(
                         a1,
                         (__int64 **)&v18,
                         v7 + 4,
                         v6);
