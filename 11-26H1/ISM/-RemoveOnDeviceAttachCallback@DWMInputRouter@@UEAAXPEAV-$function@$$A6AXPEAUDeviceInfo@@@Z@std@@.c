/*
 * XREFs of ?RemoveOnDeviceAttachCallback@DWMInputRouter@@UEAAXPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@Z @ 0x1801A3D20
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall DWMInputRouter::RemoveOnDeviceAttachCallback(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // rbx
  ...
  v3 = std::_Find_vectorized<InputSite * const,InputSite *>(
         *(const __m128i **)(a1 + 472),
         *(const __m128i **)(a1 + 480),
         a2);
