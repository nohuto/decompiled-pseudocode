/*
 * XREFs of ??0MPCSlateDeadzoneHelper@@QEAA@MM@Z @ 0x1800C6194
 * Callers:
 ...
 *     ??$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA?AV?$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z @ 0x1800C6114 (--$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA-AV-$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z.c)
 */
