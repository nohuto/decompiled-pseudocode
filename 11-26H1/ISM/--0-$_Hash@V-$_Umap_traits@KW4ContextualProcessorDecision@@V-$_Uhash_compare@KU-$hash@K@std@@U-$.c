/*
 * XREFs of ??0?$_Hash@V?$_Umap_traits@KW4ContextualProcessorDecision@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@3@$0A@@std@@@std@@IEAA@$$QEAV01@@Z @ 0x1801A7300
 * Callers:
 *     ??0ContextualProcessorMetadata@ContextualProcessorBuffer@@QEAA@$$QEAU01@@Z @ 0x1801A73DC (--0ContextualProcessorMetadata@ContextualProcessorBuffer@@QEAA@$$QEAU01@@Z.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  *(_DWORD *)a1 = *(_DWORD *)a2;
  ...
  std::list<std::pair<unsigned long const,enum ContextualProcessorState>>::list<std::pair<unsigned long const,enum ContextualProcessorState>>((_QWORD *)(a1 + 8));
  *(_QWORD *)(a1 + 24) = 0LL;
  *(_QWORD *)(a1 + 32) = 0LL;
  *(_QWORD *)(a1 + 40) = 0LL;
