/*
 * XREFs of ?IsValidTabletDisplayConfig@DevicePostureHelpers@@YA_NXZ @ 0x18011698C
 * Callers:
 ...
 * Callees:
 *     ??1?$vector@VHidChannelValueInfo@@V?$allocator@VHidChannelValueInfo@@@std@@@std@@QEAA@XZ @ 0x18008B56C (--1-$vector@VHidChannelValueInfo@@V-$allocator@VHidChannelValueInfo@@@std@@@std@@QEAA@XZ.c)
 ...
 *     ??0?$vector@UDISPLAYCONFIG_PATH_INFO@@V?$allocator@UDISPLAYCONFIG_PATH_INFO@@@std@@@std@@QEAA@_KAEBV?$allocator@UDISPLAYCONFIG_PATH_INFO@@@1@@Z @ 0x180116004 (--0-$vector@UDISPLAYCONFIG_PATH_INFO@@V-$allocator@UDISPLAYCONFIG_PATH_INFO@@@std@@@std@@QEAA@_K.c)
 ...
 *     ?IsIgnoringDisplayConfig@DevicePostureHelpers@@YA_NXZ @ 0x180116918 (-IsIgnoringDisplayConfig@DevicePostureHelpers@@YA_NXZ.c)
 *     ?_Tidy@?$vector@UDISPLAYCONFIG_MODE_INFO@@V?$allocator@UDISPLAYCONFIG_MODE_INFO@@@std@@@std@@AEAAXXZ @ 0x180116D74 (-_Tidy@-$vector@UDISPLAYCONFIG_MODE_INFO@@V-$allocator@UDISPLAYCONFIG_MODE_INFO@@@std@@@std@@AEA.c)
 */
...
char __fastcall DevicePostureHelpers::IsValidTabletDisplayConfig(DevicePostureHelpers *this)
{
  ...
  {
    v6 = 0x8E38E38E38E38E39uLL * (((_BYTE *)v14 - (_BYTE *)pathArray) >> 3);
    ...
    {
      v14 = &pathArray[numPathArrayElements];
    }
    v7 = modeInfoArray;
