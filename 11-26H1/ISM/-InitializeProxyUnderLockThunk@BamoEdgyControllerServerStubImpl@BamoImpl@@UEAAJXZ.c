/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoEdgyControllerServerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800704C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoEdgyControllerServerStubImpl::InitializeProxyUnderLockThunk(
