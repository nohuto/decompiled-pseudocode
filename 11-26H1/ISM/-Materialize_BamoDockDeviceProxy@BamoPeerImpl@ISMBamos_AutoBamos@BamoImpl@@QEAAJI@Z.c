/*
 * XREFs of ?Materialize_BamoDockDeviceProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18011FC1C
 * Callers:
 *     ?Thunk_Materialize_BamoDockDeviceProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128CD0 (-Thunk_Materialize_BamoDockDeviceProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@IS.c)
 * Callees:
