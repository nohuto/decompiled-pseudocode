/*
 * XREFs of ?SetCursorClientOwner@SystemCursorService2@@UEAAJUCursorId@@@Z @ 0x1800FC7C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v12 = v3;
  v7 = *(_QWORD *)std::unordered_map<unsigned __int64,unsigned __int64>::operator[](
                    (_QWORD *)a1 + 22,
                    (unsigned __int8 *)&v12);
  v8 = *(_QWORD *)a1;
  v14 = v7;
  ...
  v9 = *(_QWORD *)(*(_QWORD *)std::_Hash<std::_Umap_traits<unsigned __int64,std::shared_ptr<SystemCursor2>,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,std::shared_ptr<SystemCursor2>>>,0>>::_Try_emplace<unsigned __int64 const &,>(
                                a1 + 12,
                                (__int64)v10,
                                (unsigned __int8 *)&v14)
                 + 24LL);
  result = 0LL;
  *(_QWORD *)(v9 + 184) = HIDWORD(v13);
  return result;
}
