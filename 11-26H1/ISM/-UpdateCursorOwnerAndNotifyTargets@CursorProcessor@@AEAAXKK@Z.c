/*
 * XREFs of ?UpdateCursorOwnerAndNotifyTargets@CursorProcessor@@AEAAXKK@Z @ 0x18014B34C
 * Callers:
 ...
 *     ?GenerateCursorOwnerMessage@CursorProcessor@@AEAAXKUCursorId@@_N@Z @ 0x18014AE64 (-GenerateCursorOwnerMessage@CursorProcessor@@AEAAXKUCursorId@@_N@Z.c)
