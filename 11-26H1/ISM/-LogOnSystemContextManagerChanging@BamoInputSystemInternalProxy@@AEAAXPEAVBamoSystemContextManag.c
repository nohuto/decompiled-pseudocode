/*
 * XREFs of ?LogOnSystemContextManagerChanging@BamoInputSystemInternalProxy@@AEAAXPEAVBamoSystemContextManagerProxy@@@Z @ 0x18011CADC
 * Callers:
...
void __fastcall BamoInputSystemInternalProxy::LogOnSystemContextManagerChanging(
