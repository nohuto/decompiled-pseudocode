/*
 * XREFs of ??$_Erase@_K@?$_Hash@V?$_Umap_traits@_KPEAUIMPCTarget@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KPEAUIMPCTarget@@@std@@@3@$0A@@std@@@std@@AEAA_KAEB_K@Z @ 0x1800FDDAC
 * Callers:
 *     ?RemoveMPCTargetForWindowId@MPCInputRouter@@UEAAX_K@Z @ 0x180100300 (-RemoveMPCTargetForWindowId@MPCInputRouter@@UEAAX_K@Z.c)
 * Callees:
