/*
 * XREFs of ?LogSetDeviceType@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAXW4HapticDeviceType@@@Z @ 0x180189B80
 * Callers:
...
void BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::LogSetDeviceType()
{
  __int64 v0; // rbx
  int v1; // r8d
