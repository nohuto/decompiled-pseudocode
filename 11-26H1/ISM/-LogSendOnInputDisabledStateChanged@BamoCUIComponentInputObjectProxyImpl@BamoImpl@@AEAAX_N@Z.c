/*
 * XREFs of ?LogSendOnInputDisabledStateChanged@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@AEAAX_N@Z @ 0x180134EC8
 * Callers:
...
void __fastcall BamoImpl::BamoCUIComponentInputObjectProxyImpl::LogSendOnInputDisabledStateChanged(
