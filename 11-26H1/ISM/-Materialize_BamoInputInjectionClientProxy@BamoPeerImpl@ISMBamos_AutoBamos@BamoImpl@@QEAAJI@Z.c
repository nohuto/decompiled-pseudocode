/*
 * XREFs of ?Materialize_BamoInputInjectionClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1801208D8
 * Callers:
 *     ?Thunk_Materialize_BamoInputInjectionClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128E00 (-Thunk_Materialize_BamoInputInjectionClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)v11 + 4) = 0LL;
  *((_QWORD *)v11 + 5) = 0LL;
  *((_QWORD *)v11 + 2) = &BamoImpl::BamoInputInjectionClientProxyImpl::`vftable';
  *((_QWORD *)v11 + 6) = 0LL;
  *(_QWORD *)v11 = &InputInjectionClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v11 + 1) = &InputInjectionClientProxy::`vftable'{for `IInputInjectionClientProxy'};
  *((_BYTE *)v11 + 56) = 0;
  ...
  v4 = (*(__int64 (__fastcall **)(_DWORD *))(*(_QWORD *)v11 + 56LL))(v11);
