/*
 * XREFs of ?RuntimeClassInitialize@MPCManagerClient@@QEAAJXZ @ 0x180169870
 * Callers:
 ...
 *     ??0MPCManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCManagerClient@@@Z @ 0x18016B424 (--0MPCManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCManagerClient@@@Z.c)
...
__int64 __fastcall MPCManagerClient::RuntimeClassInitialize(MPCManagerClient *this)
{
  ...
  *(_QWORD *)v16 = 0LL;
  v8 = Microsoft::Bamo::BaseBamoConnection::CreateClient<MPCManagerClientConnection>(
         ...
         v16,
         v3,
         (Microsoft::Bamo::BaseBamoConnection **)this + 203);
  if ( v8 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x21,
...
LABEL_17:
  if ( v12 )
    Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<3>,1,1,0,IMPCManager,Windows::Internal::Input::MPCManager::IMPCManagerClient,Windows::Internal::Input::MPCManager::IMPCManagerConnection>::Release(
      v12,
      v10);
