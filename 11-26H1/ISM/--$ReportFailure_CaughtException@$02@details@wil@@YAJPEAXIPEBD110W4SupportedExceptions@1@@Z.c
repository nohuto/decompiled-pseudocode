/*
 * XREFs of ??$ReportFailure_CaughtException@$02@details@wil@@YAJPEAXIPEBD110W4SupportedExceptions@1@@Z @ 0x1800A9500
 * Callers:
...
{
  int v6; // eax
  char v10; // [rsp+50h] [rbp-1018h] BYREF
  _BYTE v11[4104]; // [rsp+60h] [rbp-1008h] BYREF
