/*
 * XREFs of ??0Lock@Bamo@Microsoft@@QEAA@PEAVBaseBamoConnection@12@@Z @ 0x18002752C
 * Callers:
        ...
        struct Microsoft::Bamo::BaseBamoConnection *a2)
{
  ...
  *this = 0LL;
  ...
  v6 = *this;
  *this = (Microsoft::BamoImpl::BamoImplObject *)v5;
  if ( v5 )
    _InterlockedIncrement(v5 + 2);
  if ( v6 )
    Microsoft::BamoImpl::BamoImplObject::Release(v6);
  ...
  *((_BYTE *)this + 9) = 0;
  if ( !HasLock )
  {
    ...
    if ( *(_QWORD *)(v4 + 64) )
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(v4 + 56) + 96LL))(*(_QWORD *)(v4 + 56));
      if ( v8 < 0 )
  ...
  ++*(_DWORD *)(v4 + 188);
  return (Microsoft::Bamo::Lock *)this;
}
