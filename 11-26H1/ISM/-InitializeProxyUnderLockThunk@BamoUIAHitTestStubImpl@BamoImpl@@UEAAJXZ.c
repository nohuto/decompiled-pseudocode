/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoUIAHitTestStubImpl@BamoImpl@@UEAAJXZ @ 0x18006DE10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoUIAHitTestStubImpl::InitializeProxyUnderLockThunk(
