/*
 * XREFs of ?LogOnGamepadKeyRoutingEnabledChanging@BamoInputDelegationInputObjectProxy@@AEAAX_N@Z @ 0x180135EC4
 * Callers:
...
void __fastcall BamoInputDelegationInputObjectProxy::LogOnGamepadKeyRoutingEnabledChanging(
