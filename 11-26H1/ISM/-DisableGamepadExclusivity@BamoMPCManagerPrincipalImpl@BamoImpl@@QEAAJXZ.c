/*
 * XREFs of ?DisableGamepadExclusivity@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x1800B6540
 * Callers:
 *     ?Thunk_DisableGamepadExclusivity_41@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B8FE0 (-Thunk_DisableGamepadExclusivity_41@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@.c)
 * Callees:
