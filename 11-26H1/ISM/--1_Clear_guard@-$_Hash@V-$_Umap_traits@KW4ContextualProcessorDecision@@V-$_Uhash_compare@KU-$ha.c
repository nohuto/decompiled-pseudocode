/*
 * XREFs of ??1_Clear_guard@?$_Hash@V?$_Umap_traits@KW4ContextualProcessorDecision@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@3@$0A@@std@@@std@@QEAA@XZ @ 0x18009849C
 * Callers:
 *     _ContextualProcessorBuffer::MakeContextualProcessorDecision_::_1_::dtor$7 @ 0x1801D4880 (_ContextualProcessorBuffer--MakeContextualProcessorDecision_--_1_--dtor$7.c)
 *     _std::_Hash_std::_Umap_traits_unsigned_long_enum_ContextualProcessorDecision_std::_Uhash_compare_unsigned_long_std::hash_unsigned_long__std::equal_to_unsigned_long____std::allocator_std::pair_unsigned_long_const__enum_ContextualProcessorDecision____0___::operator__::_1_::dtor$0 @ 0x1801D4AA2 (_std--_Hash_std--_Umap_traits_unsigned_long_enum_ContextualProcessorDecision_std--_Uhash_compare.c)
 * Callees:
