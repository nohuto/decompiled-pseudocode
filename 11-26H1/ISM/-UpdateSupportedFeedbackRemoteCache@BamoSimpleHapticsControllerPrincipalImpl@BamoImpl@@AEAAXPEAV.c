/*
 * XREFs of ?UpdateSupportedFeedbackRemoteCache@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x18018BA40
 * Callers:
 ...
 *     ?UpdateSupportedFeedbackRemoteCacheStatic@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x18018BB20 (-UpdateSupportedFeedbackRemoteCacheStatic@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@CAJ.c)
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 64LL) )
  {
    ...
    if ( v4 < 0 || (v6[0] = v8, v6[1] = v9, LOWORD(v5) = 2, v4 = CoreUICallSend(v10, v6, 2LL), v4 < 0) )
    {
      if ( v4 != -2018375675 )
