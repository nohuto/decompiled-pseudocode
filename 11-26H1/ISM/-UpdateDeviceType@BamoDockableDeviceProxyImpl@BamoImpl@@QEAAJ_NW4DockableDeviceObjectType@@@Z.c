/*
 * XREFs of ?UpdateDeviceType@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NW4DockableDeviceObjectType@@@Z @ 0x18012AC5C
 * Callers:
 *     ?Thunk_UpdateDeviceType_16@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801292A0 (-Thunk_UpdateDeviceType_16@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@.c)
