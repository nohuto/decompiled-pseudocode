/*
 * XREFs of ?LogOnShellHandwritingHostServerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoShellHandwritingHostServerProxy@@@Z @ 0x18011C8A8
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnShellHandwritingHostServerChanging(
        BamoInputSystemProxy *this,
        struct BamoShellHandwritingHostServerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
