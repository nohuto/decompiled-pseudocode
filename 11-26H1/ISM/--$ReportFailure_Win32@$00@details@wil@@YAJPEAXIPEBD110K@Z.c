/*
 * XREFs of ??$ReportFailure_Win32@$00@details@wil@@YAJPEAXIPEBD110K@Z @ 0x180089AE4
 * Callers:
        ...
        wil::details *a7)
{
  ...
  wil::details::HrToNtStatus((wil::details *)v7);
  wil::details::ReportFailure_Base<1,0>(v10, v8, v9);
  return v7;
}
