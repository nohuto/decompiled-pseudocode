/*
 * XREFs of ?ProcessResult@GestureServices@@MEAAJPEAVBamoGestureServicesStub@@IAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x180145EE0
 * Callers:
 *     <none>
 * Callees:
