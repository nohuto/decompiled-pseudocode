/*
 * XREFs of ?CreateInputDelegationInputObjectProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x18004C4BC
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  const char *v9; // r9
  const char *v10; // r9
  struct BamoInputDelegationInputObjectProxy *v11; // rax
  ...
  struct BamoInputDelegationInputObjectProxy *v16; // [rsp+58h] [rbp+10h] BYREF
