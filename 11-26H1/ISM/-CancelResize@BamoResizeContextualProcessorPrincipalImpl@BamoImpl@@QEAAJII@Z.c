/*
 * XREFs of ?CancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x18015234C
 * Callers:
 *     ?Thunk_CancelResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180152C20 (-Thunk_CancelResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProces.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  struct BamoResizeControllerClientProxy *v11; // rbp
  ...
  BamoImpl::BamoResizeContextualProcessorPrincipalImpl::LogReceiveCancelResize(this, a2, v11);
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoActivationWatcherPrincipalImpl>(
      ...
      (__int64)v9,
      (__int64)this);
    v18 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, struct BamoResizeControllerClientProxy *))(*((_QWORD *)this - 2) + 120LL))(
            (char *)this - 16,
            v22,
            a2,
            v11);
