/*
 * XREFs of ?LogReceiveUnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@AEAAXW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x18013B1FC
 * Callers:
...
void BamoImpl::BamoInputObserverManagerPrincipalImpl::LogReceiveUnregisterObserverClientOfType()
{
  __int64 v0; // rbx
  __int64 v1; // r8
  int v2; // r9d
