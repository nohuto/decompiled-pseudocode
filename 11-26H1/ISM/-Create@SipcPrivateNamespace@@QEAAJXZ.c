/*
 * XREFs of ?Create@SipcPrivateNamespace@@QEAAJXZ @ 0x180110910
 * Callers:
 *     ?Reconnect@SipcEndpoint@@UEAAJ_K@Z @ 0x180112AE0 (-Reconnect@SipcEndpoint@@UEAAJ_K@Z.c)
 * Callees:
 *     ?GetBoundaryDescriptorAndInitializeName@SipcPrivateNamespace@@AEAAJPEAPEAX@Z @ 0x180111A00 (-GetBoundaryDescriptorAndInitializeName@SipcPrivateNamespace@@AEAAJPEAPEAX@Z.c)
...
LABEL_3:
  ...
  *(_QWORD *)&PrivateNamespaceAttributes.bInheritHandle = 0LL;
