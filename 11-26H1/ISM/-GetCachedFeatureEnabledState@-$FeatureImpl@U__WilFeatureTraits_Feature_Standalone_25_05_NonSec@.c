/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Standalone_25_05_NonSec@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800C8478
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Standalone_25_05_NonSec@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800C930C (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Standalone_25_05_NonSec.c)
 */

_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Standalone_25_05_NonSec>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v3; // eax
  ...
  v14 = a1;
  *a2 = 0LL;
  v3 = *(_DWORD *)Feature_Standalone_25_05_NonSec__descriptor;
  *(_DWORD *)a2 = *(_DWORD *)Feature_Standalone_25_05_NonSec__descriptor;
  if ( (v3 & 6) != 6 )
  {
    v4 = wil::details::EnsureSubscribedToFeatureConfigurationChanges(a1);
    LODWORD(v14) = 0;
    v5 = v4;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Standalone_25_05_NonSec>::GetCurrentFeatureEnabledState(
      v6,
      &v15,
      &v14);
    v7 = *(_DWORD *)a2;
    ...
    do
    {
      ...
      *(_DWORD *)a2 = v7;
      ...
      v7 = _InterlockedCompareExchange((volatile signed __int32 *)Feature_Standalone_25_05_NonSec__descriptor, v11, v7);
    }
    while ( v10 != v7 );
    if ( (v10 & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_180254D7C
        || (v13[0] = 3LL,
            v13[1] = Feature_Standalone_25_05_NonSec__descriptor,
            !wil::details_abi::heap_buffer::push_back((void **)&unk_180254DB0, v13, 0x10uLL)) )
      {
        _InterlockedAnd((volatile signed __int32 *)Feature_Standalone_25_05_NonSec__descriptor, 0xFFFFFFFB);
      }
