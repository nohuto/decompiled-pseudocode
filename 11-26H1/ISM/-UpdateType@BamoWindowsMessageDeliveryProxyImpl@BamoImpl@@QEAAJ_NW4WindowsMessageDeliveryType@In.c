/*
 * XREFs of ?UpdateType@BamoWindowsMessageDeliveryProxyImpl@BamoImpl@@QEAAJ_NW4WindowsMessageDeliveryType@Input@Internal@UI@Windows@@@Z @ 0x180070044
 * Callers:
 *     ?Thunk_UpdateType_16@?$IWindowsMessageDeliveryProxy_Receive@VBamoWindowsMessageDeliveryProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070030 (-Thunk_UpdateType_16@-$IWindowsMessageDeliveryProxy_Receive@VBamoWindowsMessageDeliveryProxyImpl.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoWindowsMessageDeliveryProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18013AAB0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoWindowsMessageDeliveryProxyImpl@BamoImpl@@UEAAXP.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoWindowsMessageDeliveryProxyImpl::UpdateType(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v3; // ebp
  char v4; // r14
  BamoWindowsMessageDeliveryProxy *v6; // rsi
  int v8; // eax
  int v9; // eax
