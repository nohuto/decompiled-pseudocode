/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x180113EA8
 * Callers:
...
void __fastcall ManipulationInjector::Initialize(ManipulationInjector *this, HMONITOR a2, const struct tagRECT *a3)
{
  ...
  *((_DWORD *)this + 184) = v9;
  ...
  {
    case 1:
      if ( !(unsigned int)InitializePointerDeviceInjection(2LL, 4LL, 0LL) )
      {
    ...
    case 2:
      ...
      dword_18025306C = (int)(float)((float)((float)((float)v13 * 100.0) / (float)*((int *)this + 194)) + 0.5);
      dword_18025308C = (int)v14;
      v29.x = *((_DWORD *)this + 5);
