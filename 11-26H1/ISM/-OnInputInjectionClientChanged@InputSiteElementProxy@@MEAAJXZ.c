/*
 * XREFs of ?OnInputInjectionClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180040C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIInputInjectionClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180040C98 (--$RemoveObject@UIInputInjectionClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
