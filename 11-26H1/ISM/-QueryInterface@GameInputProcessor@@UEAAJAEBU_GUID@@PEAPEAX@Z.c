/*
 * XREFs of ?QueryInterface@GameInputProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180064880
 * Callers:
 *     ?Initialize@DWMInputRouter@@IEAAJXZ @ 0x180055204 (-Initialize@DWMInputRouter@@IEAAJXZ.c)
 *     ?QueryInterface@GameInputProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B1620 (-QueryInterface@GameInputProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
