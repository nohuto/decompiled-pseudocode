/*
 * XREFs of ?AttachApplication2@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800F7F8C
 * Callers:
 *     ?Thunk_AttachApplication2_8@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F9A00 (-Thunk_AttachApplication2_8@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControll.c)
 * Callees:
