/*
 * XREFs of ?LogOnInputSinkDataChanged@BamoShellGesturesClientProxy@@AEAAXXZ @ 0x18015E2B4
 * Callers:
...
void __fastcall BamoShellGesturesClientProxy::LogOnInputSinkDataChanged(BamoShellGesturesClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
