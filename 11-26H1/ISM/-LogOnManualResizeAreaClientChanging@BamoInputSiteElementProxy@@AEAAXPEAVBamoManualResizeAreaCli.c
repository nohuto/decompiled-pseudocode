/*
 * XREFs of ?LogOnManualResizeAreaClientChanging@BamoInputSiteElementProxy@@AEAAXPEAVBamoManualResizeAreaClientProxy@@@Z @ 0x18008BAF4
 * Callers:
...
void __fastcall BamoInputSiteElementProxy::LogOnManualResizeAreaClientChanging(
