/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x18009F75C
 * Callers:
 ...
 *     _wil::details::ResultFromCaughtException_CppWinRt_::_1_::catch$5 @ 0x1801D9DD8 (_wil--details--ResultFromCaughtException_CppWinRt_--_1_--catch$5.c)
 * Callees:
