/*
 * XREFs of ?AllocateStubUnderLock@BamoSystemContextManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoSystemContextManagerStub@@@Z @ 0x18013EFC0
 * Callers:
 *     <none>
 * Callees:
