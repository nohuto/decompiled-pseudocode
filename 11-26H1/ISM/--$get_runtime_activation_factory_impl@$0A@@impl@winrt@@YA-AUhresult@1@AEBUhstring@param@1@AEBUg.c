/*
 * XREFs of ??$get_runtime_activation_factory_impl@$0A@@impl@winrt@@YA?AUhresult@1@AEBUhstring@param@1@AEBUguid@1@PEAPEAX@Z @ 0x18007CC78
 * Callers:
 ...
 *     WINRT_IMPL_GetProcAddress @ 0x18009B4F4 (WINRT_IMPL_GetProcAddress.c)
 *     WINRT_IMPL_FreeLibrary @ 0x18009B768 (WINRT_IMPL_FreeLibrary.c)
 *     RoGetActivationFactory_0 @ 0x18009B774 (RoGetActivationFactory_0.c)
 *     LoadLibraryExW_0 @ 0x18009CC86 (LoadLibraryExW_0.c)
 *     GetErrorInfo_0 @ 0x18009D401 (GetErrorInfo_0.c)
 *     SetErrorInfo_0 @ 0x18009D419 (SetErrorInfo_0.c)
 *     ??$_Traits_rfind_ch@U?$char_traits@G@std@@@std@@YA_KQEBG_K1G@Z @ 0x1800A586C (--$_Traits_rfind_ch@U-$char_traits@G@std@@@std@@YA_KQEBG_K1G@Z.c)
 ...
 *     ?resize@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAX_KG@Z @ 0x1800A6E78 (-resize@-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEAAX_KG@Z.c)
