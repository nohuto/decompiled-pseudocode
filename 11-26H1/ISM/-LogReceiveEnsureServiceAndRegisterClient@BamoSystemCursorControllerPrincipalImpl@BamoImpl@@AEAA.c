/*
 * XREFs of ?LogReceiveEnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoSystemCursorControllerClientProxy@@@Z @ 0x1800F915C
 * Callers:
