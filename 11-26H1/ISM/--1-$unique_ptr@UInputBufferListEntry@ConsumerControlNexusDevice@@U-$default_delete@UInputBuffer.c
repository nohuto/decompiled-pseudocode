/*
 * XREFs of ??1?$unique_ptr@UInputBufferListEntry@ConsumerControlNexusDevice@@U?$default_delete@UInputBufferListEntry@ConsumerControlNexusDevice@@@std@@@std@@QEAA@XZ @ 0x1800E76C4
 * Callers:
