/*
 * XREFs of ??1?$CalloutWrapper@VBamoActivationListenerInputObjectProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x1800619CC
 * Callers:
 ...
 *     ?OnPropertiesRefreshedCallout@BamoActivationListenerInputObjectProxy@@EEAAJXZ @ 0x180123B40 (-OnPropertiesRefreshedCallout@BamoActivationListenerInputObjectProxy@@EEAAJXZ.c)
 *     _BamoImpl::BamoActivationListenerInputObjectProxyImpl::UpdateHWND_::_1_::dtor$1 @ 0x1801D7892 (_BamoImpl--BamoActivationListenerInputObjectProxyImpl--UpdateHWND_--_1_--dtor$1.c)
 * Callees:
