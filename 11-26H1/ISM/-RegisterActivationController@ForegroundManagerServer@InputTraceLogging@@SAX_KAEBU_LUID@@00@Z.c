/*
 * XREFs of ?RegisterActivationController@ForegroundManagerServer@InputTraceLogging@@SAX_KAEBU_LUID@@00@Z @ 0x180068C98
 * Callers:
...
void __fastcall InputTraceLogging::ForegroundManagerServer::RegisterActivationController(
        __int64 a1,
