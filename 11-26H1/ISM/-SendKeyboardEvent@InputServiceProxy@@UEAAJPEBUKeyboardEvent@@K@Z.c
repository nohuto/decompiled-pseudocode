/*
 * XREFs of ?SendKeyboardEvent@InputServiceProxy@@UEAAJPEBUKeyboardEvent@@K@Z @ 0x180162160
 * Callers:
 *     <none>
 * Callees:
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$01@@U1@U1@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$01@@33AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x18000848C (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$01@@U1@U1@U-$_tlgWrapperByVal@$07@@.c)
        ...
        unsigned int a3)
{
  ...
  *(_DWORD *)v38 = 0;
  ...
  if ( (unsigned int)dword_180251328 > 5 && tlgKeywordOn((__int64)&dword_180251328, 0x40000LL) )
  {
      ...
      if ( !*((_DWORD *)a2 + 1) )
      {
        if ( *(_DWORD *)a2 )
        {
          if ( *(_DWORD *)a2 == 1 )
          {
            ...
            v20 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(**((_QWORD **)this + 4) + 32LL))(
                    *((_QWORD *)this + 4),
                    a3,
          ...
          else if ( *(_DWORD *)a2 == 2 )
          {
            ...
            if ( v17 < 0 )
              wil::details::in1diag3::FailFast_Hr(
                ...
                v22);
            LOWORD(v22) = *((_WORD *)a2 + 9);
            v18 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(**((_QWORD **)this + 4) + 40LL))(
                    *((_QWORD *)this + 4),
                    a3,
                    (unsigned __int16)(*((_WORD *)a2 + 4) | v5),
                    v6);
        ...
        {
          v23 = *((_DWORD *)a2 + 3) | v6;
          v21 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(**((_QWORD **)this + 4) + 24LL))(
                  *((_QWORD *)this + 4),
                  a3,
