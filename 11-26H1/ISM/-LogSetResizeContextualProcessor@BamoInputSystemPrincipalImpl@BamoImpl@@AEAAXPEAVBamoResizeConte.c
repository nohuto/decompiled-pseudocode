/*
 * XREFs of ?LogSetResizeContextualProcessor@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoResizeContextualProcessorPrincipal@@@Z @ 0x1800904F0
 * Callers:
