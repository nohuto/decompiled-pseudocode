/*
 * XREFs of ?QueryInterface@BamoList_uint_Stub@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180105560
 * Callers:
 *     ?QueryInterface@BamoList_uint_Stub@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801055E0 (-QueryInterface@BamoList_uint_Stub@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@W7EAAJAEBU_GUID@@P.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (Microsoft::Bamo::Lib::dataprovider_AutoBamos::BamoList_uint_Stub *)-8LL )
    return (unsigned int)-2147467262;
