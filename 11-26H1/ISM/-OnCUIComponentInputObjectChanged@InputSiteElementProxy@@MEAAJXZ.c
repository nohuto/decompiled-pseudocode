/*
 * XREFs of ?OnCUIComponentInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005C3C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UICUIComponentInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005C434 (--$RemoveObject@UICUIComponentInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
