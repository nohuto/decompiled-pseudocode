/*
 * XREFs of ?LogOnUndockedEventsRequiredChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x180199518
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnUndockedEventsRequiredChanged(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
