/*
 * XREFs of ?UpdateHaptics@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012C334
 * Callers:
 *     ?Thunk_UpdateHaptics_8@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129490 (-Thunk_UpdateHaptics_8@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAP.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoPenDeviceProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x18012F4C0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoPenDeviceProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyI.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenDeviceProxyImpl::UpdateHaptics(
        ...
        __int64 a3)
{
  ...
  struct BamoSimpleHapticsControllerProxy *v7; // rsi
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoPenDeviceProxy::LogOnHapticsChanging((BamoImpl::BamoPenDeviceProxyImpl *)((char *)this - 16), v7);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
      1);
    v12 = (*(__int64 (__fastcall **)(char *, struct BamoSimpleHapticsControllerProxy *))(*((_QWORD *)this - 2) + 120LL))(
            (char *)this - 16,
            v7);
    if ( v12 < 0 )
  ...
  *((_QWORD *)this + 6) = v7;
  if ( v7 )
    (**(void (__fastcall ***)(struct BamoSimpleHapticsControllerProxy *))v7)(v7);
  if ( v13 )
  ...
  if ( *((_BYTE *)this + 28) )
  {
    BamoPenDeviceProxy::LogOnHapticsChanged((BamoImpl::BamoPenDeviceProxyImpl *)((char *)this - 16));
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoCursorSuppressionPolicyObjectProxyImpl>(
      (__int64)v15,
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
      (void (__fastcall ***)(_QWORD))this,
