/*
 * XREFs of ?LogOnInputSiteManagerChanging@BamoInputSystemProxy@@AEAAXPEAVBamoInputSiteManagerProxy@@@Z @ 0x18011BA8C
 * Callers:
...
void __fastcall BamoInputSystemProxy::LogOnInputSiteManagerChanging(
        BamoInputSystemProxy *this,
        struct BamoInputSiteManagerProxy *a2)
{
  __int64 v2; // rcx
  __int64 v3; // r8
  __int64 v4; // r9
