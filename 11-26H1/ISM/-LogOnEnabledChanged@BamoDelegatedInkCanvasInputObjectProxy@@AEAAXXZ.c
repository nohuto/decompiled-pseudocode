/*
 * XREFs of ?LogOnEnabledChanged@BamoDelegatedInkCanvasInputObjectProxy@@AEAAXXZ @ 0x18011AAB4
 * Callers:
...
void __fastcall BamoDelegatedInkCanvasInputObjectProxy::LogOnEnabledChanged(
