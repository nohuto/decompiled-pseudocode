/*
 * XREFs of ?LogReceiveSetProcessIDDelegation@BamoInputDelegationInputObjectProxyImpl@BamoImpl@@AEAAXIW4DelegateInputMode@Input@Internal@UI@Windows@@@Z @ 0x180135FDC
 * Callers:
