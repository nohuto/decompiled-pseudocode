/*
 * XREFs of ?OnInputReport@ControllerProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180087280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdatePointerTimer@ControllerProcessor@@AEAAJXZ @ 0x180180CD8 (-UpdatePointerTimer@ControllerProcessor@@AEAAJXZ.c)
 */
...
__int64 __fastcall ControllerProcessor::OnInputReport(ControllerProcessor *this, struct InputInfo *a2)
{
  ...
  if ( (*(_BYTE *)a2 & 0x40) != 0 )
  {
    ...
    *((_BYTE *)this + 212) = *((_BYTE *)a2 + 80);
    v8 = ControllerProcessor::HandleTaskSwitcherChordedKey(this, &v19);
    if ( v8 < 0 )
      ...
      else
      {
        ...
        if ( v11 < 0 )
          wil::details::in1diag3::FailFast_Hr(
            ...
            v17);
        v12 = ControllerProcessor::SendGameControllerAsPointerMappings(this);
        if ( v12 < 0 )
          wil::details::in1diag3::FailFast_Hr(
            retaddr,
            (void *)0x2E2,
