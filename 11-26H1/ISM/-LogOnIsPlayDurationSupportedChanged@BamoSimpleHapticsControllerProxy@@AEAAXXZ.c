/*
 * XREFs of ?LogOnIsPlayDurationSupportedChanged@BamoSimpleHapticsControllerProxy@@AEAAXXZ @ 0x18011BE74
 * Callers:
...
void __fastcall BamoSimpleHapticsControllerProxy::LogOnIsPlayDurationSupportedChanged(
