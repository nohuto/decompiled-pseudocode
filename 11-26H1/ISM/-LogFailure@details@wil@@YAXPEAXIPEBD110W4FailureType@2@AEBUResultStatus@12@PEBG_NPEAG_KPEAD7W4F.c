/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7W4FailureFlags@2@PEAUFailureInfo@2@@Z @ 0x18009EEE8
 * Callers:
 ...
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x180080600 (-RecordLog@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x18009F810 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x18009F830 (-RecordFailFast@details@wil@@YAHJ@Z.c)
  ...
  if ( a7 )
  {
    switch ( a7 )
    {
      ...
      case 2:
        ...
        v20 = wil::details::RecordLog((wil::details *)v18);
        break;
      case 3:
