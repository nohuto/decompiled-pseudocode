/*
 * XREFs of ?QueryInterface@BamoControllerNavigationManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180179D80
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180179E00 (-QueryInterface@BamoControllerNavigationManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoControllerNavigationManagerStub *)-8LL )
    return (unsigned int)-2147467262;
