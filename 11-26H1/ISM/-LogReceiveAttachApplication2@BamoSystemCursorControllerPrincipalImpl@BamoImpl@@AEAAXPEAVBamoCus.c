/*
 * XREFs of ?LogReceiveAttachApplication2@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoCustomCursorControllerClient2Proxy@@@Z @ 0x1800F8EC0
 * Callers:
