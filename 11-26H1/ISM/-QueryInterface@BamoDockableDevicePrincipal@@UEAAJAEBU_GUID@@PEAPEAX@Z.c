/*
 * XREFs of ?QueryInterface@BamoDockableDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180184BC0
 * Callers:
 *     ?QueryInterface@BamoDockableDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180184C40 (-QueryInterface@BamoDockableDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoDockableDevicePrincipal *)-8LL )
    return (unsigned int)-2147467262;
