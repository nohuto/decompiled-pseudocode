/*
 * XREFs of ?Thunk_RegisterSystemContextEndpoint_8@?$ISystemContextManagerPrincipal_Receive@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180143660
 * Callers:
 *     <none>
 * Callees:
 *     <none>
