/*
 * XREFs of ?RemoteReplace@?$ListProxySimpleCommon@VBamoList_DisplayOcclusionRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UDisplayOcclusionRect@@AEBU6@@Bamo@Microsoft@@MEAAJIAEBUDisplayOcclusionRect@@@Z @ 0x18013D4E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int128 *a3)
{
  ...
  const char *v15; // r9
  int v16; // eax
  Microsoft::BamoImpl::BamoImplObject *v17[2]; // [rsp+20h] [rbp-1A8h] BYREF
  __int128 v18; // [rsp+30h] [rbp-198h] BYREF
  __int128 v19; // [rsp+40h] [rbp-188h]
  __int128 v20; // [rsp+50h] [rbp-178h]
  __int128 v21; // [rsp+60h] [rbp-168h]
  __int128 v22; // [rsp+70h] [rbp-158h]
  __int128 v23; // [rsp+80h] [rbp-148h]
  __int128 v24; // [rsp+90h] [rbp-138h]
  __int128 v25; // [rsp+A0h] [rbp-128h]
  __int128 v26; // [rsp+B0h] [rbp-118h]
  __int128 v27; // [rsp+C0h] [rbp-108h]
  __int128 v28; // [rsp+D0h] [rbp-F8h]
  __int128 v29; // [rsp+E0h] [rbp-E8h] BYREF
  __int128 v30; // [rsp+F0h] [rbp-D8h]
  __int128 v31; // [rsp+100h] [rbp-C8h]
  __int128 v32; // [rsp+110h] [rbp-B8h]
  __int128 v33; // [rsp+120h] [rbp-A8h]
  __int128 v34; // [rsp+130h] [rbp-98h]
  __int128 v35; // [rsp+140h] [rbp-88h]
  __int128 v36; // [rsp+150h] [rbp-78h]
  __int128 v37; // [rsp+160h] [rbp-68h]
  __int128 v38; // [rsp+170h] [rbp-58h]
  __int128 v39; // [rsp+180h] [rbp-48h]
  ...
  if ( a2 < (unsigned __int64)(0x2E8BA2E8BA2E8BA3LL * ((__int64)(*((_QWORD *)this + 7) - *((_QWORD *)this + 6)) >> 4)) )
  {
    ...
    try
    {
      ...
      Microsoft::Bamo::Lock::Lock(v17, Connection);
      if ( IsReady )
      {
    ...
    if ( IsReady )
    {
      ...
      v38 = v27;
      v39 = v28;
      v16 = (*(__int64 (__fastcall **)(Microsoft::Bamo::BamoProxy *, _QWORD, __int128 *))(*(_QWORD *)this + 160LL))(
              this,
              a2,
              &v29);
      if ( v16 < 0 )
