/*
 * XREFs of ?LogOnTypeChanged@BamoDragSourceClientProxy@@AEAAXXZ @ 0x18011CD1C
 * Callers:
...
void __fastcall BamoDragSourceClientProxy::LogOnTypeChanged(BamoDragSourceClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
