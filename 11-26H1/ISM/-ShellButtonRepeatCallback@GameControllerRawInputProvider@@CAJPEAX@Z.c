/*
 * XREFs of ?ShellButtonRepeatCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x18005E6B0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ @ 0x18005E760 (-GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ.c)
