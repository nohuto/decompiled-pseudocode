/*
 * XREFs of ?ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ @ 0x1801B6D00
 * Callers:
 *     ?Initialize@TapProcessor@@IEAAJXZ @ 0x1801B6920 (-Initialize@TapProcessor@@IEAAJXZ.c)
