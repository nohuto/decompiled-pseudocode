/*
 * XREFs of ?RegisterInputAttemptedClient@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180160E50
 * Callers:
 *     ?Thunk_RegisterInputAttemptedClient_8@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180161050 (-Thunk_RegisterInputAttemptedClient_8@-$IInputDeliveryServerPrincipal_Receive@VBamoInputDelivery.c)
 * Callees:
