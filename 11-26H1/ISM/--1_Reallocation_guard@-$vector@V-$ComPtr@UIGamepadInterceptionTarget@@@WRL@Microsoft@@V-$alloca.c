/*
 * XREFs of ??1_Reallocation_guard@?$vector@V?$ComPtr@UIGamepadInterceptionTarget@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIGamepadInterceptionTarget@@@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x180109A00
 * Callers:
...
void __fastcall std::vector<Microsoft::WRL::ComPtr<IGamepadInterceptionTarget>>::_Reallocation_guard::~_Reallocation_guard(
        __int64 a1)
{
  if ( *(_QWORD *)(a1 + 8) )
  {
