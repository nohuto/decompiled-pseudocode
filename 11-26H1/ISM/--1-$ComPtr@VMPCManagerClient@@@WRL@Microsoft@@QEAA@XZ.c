/*
 * XREFs of ??1?$ComPtr@VMPCManagerClient@@@WRL@Microsoft@@QEAA@XZ @ 0x1801649E0
 * Callers:
 *     _Microsoft::WRL::Details::MakeAndInitialize_MPCManagerClient_Windows::Internal::Input::MPCManager::IMPCManagerClient__::_1_::dtor$2 @ 0x1801DBDA8 (_Microsoft--WRL--Details--MakeAndInitialize_MPCManagerClient_Windows--Internal--Input--MPCManage.c)
 * Callees:
