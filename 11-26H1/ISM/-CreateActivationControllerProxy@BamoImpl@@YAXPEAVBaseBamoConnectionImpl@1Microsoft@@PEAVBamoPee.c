/*
 * XREFs of ?CreateActivationControllerProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x18004CB04
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *((_DWORD *)v5 + 6) = 0;
  v5[4] = 0LL;
  v5[5] = 0LL;
  v5[2] = &BamoImpl::BamoActivationControllerProxyImpl::`vftable';
  *((_BYTE *)v5 + 48) = 0;
  v5[7] = 0LL;
  v5[8] = 0LL;
  v5[9] = 0LL;
  *v5 = &ActivationControllerBamoProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v5[1] = &ActivationControllerBamoProxy::`vftable'{for `IActivationControllerProxy'};
  if ( v11 && (v12 & 2) != 0 )
