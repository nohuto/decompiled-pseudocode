/*
 * XREFs of ?WaitCallback@GameInputWatcher@@AEAAXXZ @ 0x180062D20
 * Callers:
 *     ?WaitCallback@GameInputWatcher@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x180062D00 (-WaitCallback@GameInputWatcher@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z.c)
 * Callees:
 *     _wcsicmp @ 0x18009AAF4 (_wcsicmp.c)
 */
