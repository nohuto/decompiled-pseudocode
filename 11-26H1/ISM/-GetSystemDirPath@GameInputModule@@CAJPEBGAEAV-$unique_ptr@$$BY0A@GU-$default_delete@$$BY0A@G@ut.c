/*
 * XREFs of ?GetSystemDirPath@GameInputModule@@CAJPEBGAEAV?$unique_ptr@$$BY0A@GU?$default_delete@$$BY0A@G@utl@@@utl@@PEA_K@Z @ 0x18008CFF0
 * Callers:
 ...
 *     _o_towlower_0 @ 0x18009ABCC (_o_towlower_0.c)
