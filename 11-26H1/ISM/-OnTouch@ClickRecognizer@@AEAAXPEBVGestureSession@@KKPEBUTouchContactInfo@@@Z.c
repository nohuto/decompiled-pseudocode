/*
 * XREFs of ?OnTouch@ClickRecognizer@@AEAAXPEBVGestureSession@@KKPEBUTouchContactInfo@@@Z @ 0x1801B9770
 * Callers:
 ...
 *     ?ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z @ 0x1801B943C (-ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z.c)
