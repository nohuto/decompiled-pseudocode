/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x18006CFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerStubImpl::InitializeProxyUnderLockThunk(
