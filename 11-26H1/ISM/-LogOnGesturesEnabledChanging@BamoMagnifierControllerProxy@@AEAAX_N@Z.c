/*
 * XREFs of ?LogOnGesturesEnabledChanging@BamoMagnifierControllerProxy@@AEAAX_N@Z @ 0x18015B0C0
 * Callers:
...
void __fastcall BamoMagnifierControllerProxy::LogOnGesturesEnabledChanging(BamoMagnifierControllerProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
