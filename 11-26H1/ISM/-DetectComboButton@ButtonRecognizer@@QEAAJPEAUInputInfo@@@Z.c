/*
 * XREFs of ?DetectComboButton@ButtonRecognizer@@QEAAJPEAUInputInfo@@@Z @ 0x1801AA630
 * Callers:
...
__int64 __fastcall ButtonRecognizer::DetectComboButton(ButtonRecognizer *this, struct InputInfo *a2)
{
  ...
  if ( !v5 )
  {
    ...
    *((_BYTE *)this + 16) = 0;
    if ( !v4 )
      return 0LL;
    std::vector<enum _Button>::emplace_back<enum _Button &>((__int64 *)this + 6, (int *)&v22);
    ...
    if ( v22 != **((__int64 ***)this + 4) )
    {
      ...
      *((_BYTE *)this + 80) = *((_BYTE *)v17 + 8);
      std::vector<enum _Button>::operator=((void **)this + 11, (__int64)(v17 + 2));
    ...
    *((_BYTE *)this + 18) = 0;
    ...
    if ( v22 != **((__int64 ***)this + 4) )
    {
      ...
      *((_BYTE *)this + 80) = *((_BYTE *)v15 + 8);
      std::vector<enum _Button>::operator=((void **)this + 11, (__int64)(v15 + 2));
