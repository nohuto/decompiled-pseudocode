/*
 * XREFs of ?OnPointerInfoFrame@EdgyRecognizer@@QEAAJPEAUPointerInputInfo@@AEAUtagPOINTER_INFO@@@Z @ 0x180159260
 * Callers:
 ...
 *     ?OnPointerInfoFrame@DragGestureTracker@@QEAAJAEAUtagPOINTER_INFO@@@Z @ 0x1801A5010 (-OnPointerInfoFrame@DragGestureTracker@@QEAAJAEAUtagPOINTER_INFO@@@Z.c)
        ...
        struct tagPOINTER_INFO *a3)
{
  ...
  if ( *((_QWORD *)this + 6) < *(_QWORD *)EdgyRecognizer::TimeFromPerfCount(this, &v19, *((_QWORD *)a2 + 2))
    && (*((_DWORD *)this + 2) == 2 || *((_DWORD *)this + 2) == 3) )
  {
    goto LABEL_18;
  }
