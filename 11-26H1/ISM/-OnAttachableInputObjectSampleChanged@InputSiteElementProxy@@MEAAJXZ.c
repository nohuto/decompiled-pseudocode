/*
 * XREFs of ?OnAttachableInputObjectSampleChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180040680
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x1800406F4 (--$RemoveObject@UIAttachableInputObjectSampleProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IAttachableInputObjectSampleProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 80LL))((char *)this + 8);
