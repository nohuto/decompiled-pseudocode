/*
 * XREFs of ?UpdateComponentWindowId@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x1801348CC
 * Callers:
 *     ?Thunk_UpdateComponentWindowId_0@?$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801347B0 (-Thunk_UpdateComponentWindowId_0@-$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxy.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoCUIHostInputObjectProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180134B30 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoCUIHostInputObjectProxyImpl@BamoImpl@@UEAAXPEAVB.c)
 * Callees:
...
{
  char v4; // r14
  BamoCUIHostInputObjectProxy *v6; // rsi
  int v7; // eax
  int v8; // eax
