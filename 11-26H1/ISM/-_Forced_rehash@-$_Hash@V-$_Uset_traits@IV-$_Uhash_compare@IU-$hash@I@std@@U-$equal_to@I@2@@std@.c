/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Uset_traits@IV?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@I@2@$0A@@std@@@std@@IEAAX_K@Z @ 0x180146D48
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 48) = v6 - 1;
  ...
  {
    v8 = (_QWORD *)*v8;
    v9 = std::_Conditionally_enabled_hash<enum TestCommandMessageType,1>::operator()((unsigned __int8 *)v7 + 16);
    v11 = *(_QWORD *)(a1 + 24);
...
LABEL_15:
  ...
  v28 = 0LL;
  return std::_Hash<std::_Uset_traits<unsigned int,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<unsigned int>,0>>::_Clear_guard::~_Clear_guard(&v28);
}
