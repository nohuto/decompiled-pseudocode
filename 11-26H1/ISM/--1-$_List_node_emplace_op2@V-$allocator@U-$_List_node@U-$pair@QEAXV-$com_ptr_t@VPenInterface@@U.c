/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@QEAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800D11F4
 * Callers:
 ...
 *     _std::_Hash_std::_Umap_traits_void___wil::com_ptr_t_PenInterface_wil::err_exception_policy__std::_Uhash_compare_void___std::hash_void____std::equal_to_void______std::allocator_std::pair_void___const_wil::com_ptr_t_PenInterface_wil::err_exception_policy______0___::emplace_void___&_wil::com_ptr_t_PenInterface_wil::err_exception_policy__&__::_1_::dtor$0 @ 0x1801D771D (_std--_Hash_std--_Umap_traits_void___wil--com_ptr_t_PenInterface_wil--err_exception_policy__std-.c)
 *     _std::_Hash_std::_Umap_traits_unsigned___int64_wil::com_ptr_t_IHeadEventHandler_wil::err_exception_policy__std::_Uhash_compare_unsigned___int64_std::hash_unsigned___int64__std::equal_to_unsigned___int64____std::allocator_std::pair_unsigned___int64_const__wil::com_ptr_t_IHeadEventHandler_wil::err_exception_policy______0___::_Try_emplace_unsigned___int64_const_&__::_1_::dtor$0 @ 0x1801D96D8 (_std--_Hash_std--_Umap_traits_unsigned___int64_wil--com_ptr_t_IHeadEventHandler_wil--err_excepti.c)
 * Callees:
...
__int64 __fastcall std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<void * const,wil::com_ptr_t<PenInterface,wil::err_exception_policy>>,void *>>>::~_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<void * const,wil::com_ptr_t<PenInterface,wil::err_exception_policy>>,void *>>>(
        __int64 a1)
{
  __int64 v2; // rcx
