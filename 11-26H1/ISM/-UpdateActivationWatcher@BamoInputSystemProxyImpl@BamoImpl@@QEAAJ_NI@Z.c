/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180129EE8
 * Callers:
 *     ?Thunk_UpdateActivationWatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129190 (-Thunk_UpdateActivationWatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
