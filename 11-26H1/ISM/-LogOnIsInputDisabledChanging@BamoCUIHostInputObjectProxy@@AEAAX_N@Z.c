/*
 * XREFs of ?LogOnIsInputDisabledChanging@BamoCUIHostInputObjectProxy@@AEAAX_N@Z @ 0x180134060
 * Callers:
...
void __fastcall BamoCUIHostInputObjectProxy::LogOnIsInputDisabledChanging(BamoCUIHostInputObjectProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
