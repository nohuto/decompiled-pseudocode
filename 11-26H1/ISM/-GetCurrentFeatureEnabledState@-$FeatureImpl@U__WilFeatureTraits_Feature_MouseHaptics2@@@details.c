/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MouseHaptics2@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800C9204
 * Callers:
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v11 | v12;
  ...
  v15 = (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_ISMResetCrashFix>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_ISMResetCrashFix>::GetImpl'::`2'::impl)
     && (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_UexTest7>::__private_IsEnabled(
