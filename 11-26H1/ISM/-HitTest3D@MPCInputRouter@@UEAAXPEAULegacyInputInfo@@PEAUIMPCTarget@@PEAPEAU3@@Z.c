/*
 * XREFs of ?HitTest3D@MPCInputRouter@@UEAAXPEAULegacyInputInfo@@PEAUIMPCTarget@@PEAPEAU3@@Z @ 0x1800FEF40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$CopyTo@UIMPCTarget@@@?$ComPtr@UIMPCFocusTarget@@@WRL@Microsoft@@QEBAJPEAPEAUIMPCTarget@@@Z @ 0x180098704 (--$CopyTo@UIMPCTarget@@@-$ComPtr@UIMPCFocusTarget@@@WRL@Microsoft@@QEBAJPEAPEAUIMPCTarget@@@Z.c)
        ...
        struct IMPCTarget **a4)
{
  ...
  v12 = !*((_BYTE *)a2 + 241)
     && (*(_DWORD *)a2 & 0x2600) != 0
     && (*((_DWORD *)a2 + 16) == 1 || *((_DWORD *)a2 + 16) == 2 || *((_DWORD *)a2 + 17) == 2);
  v32 = v12;
  v13 = *((_QWORD *)this + 3);
  v14 = 0;
  LOBYTE(lParam) = 0;
