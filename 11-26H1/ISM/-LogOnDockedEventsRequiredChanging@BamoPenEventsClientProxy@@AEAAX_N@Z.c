/*
 * XREFs of ?LogOnDockedEventsRequiredChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x180199130
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnDockedEventsRequiredChanging(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
