/*
 * XREFs of ?Disconnected@InputProcess@InputTraceLogging@@SAXXZ @ 0x1800CBE04
 * Callers:
 *     ?OnStubDisconnected@InputProcess@@MEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoInputProcessStub@@@Z @ 0x1800CC250 (-OnStubDisconnected@InputProcess@@MEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoInputProcessStub@@.c)
 * Callees:
