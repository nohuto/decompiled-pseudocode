/*
 * XREFs of ?LogOnIsShellChanged@BamoPenEventsClientProxy@@AEAAXXZ @ 0x180199194
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnIsShellChanged(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
