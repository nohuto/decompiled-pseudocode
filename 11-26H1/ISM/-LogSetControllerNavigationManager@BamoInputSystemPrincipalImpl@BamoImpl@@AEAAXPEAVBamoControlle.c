/*
 * XREFs of ?LogSetControllerNavigationManager@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoControllerNavigationManagerPrincipal@@@Z @ 0x1800982F4
 * Callers:
