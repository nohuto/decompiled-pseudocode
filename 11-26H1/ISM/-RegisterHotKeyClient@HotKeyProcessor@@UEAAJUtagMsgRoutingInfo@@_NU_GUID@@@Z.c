/*
 * XREFs of ?RegisterHotKeyClient@HotKeyProcessor@@UEAAJUtagMsgRoutingInfo@@_NU_GUID@@@Z @ 0x1801D11D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  v14 = (*(__int64 (__fastcall **)(struct IMessageProxy *, _QWORD))(*(_QWORD *)v21 + 56LL))(
          v21,
