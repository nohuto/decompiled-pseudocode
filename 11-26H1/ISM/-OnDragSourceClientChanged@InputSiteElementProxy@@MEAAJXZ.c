/*
 * XREFs of ?OnDragSourceClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005C000
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIDragSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005C078 (--$RemoveObject@UIDragSourceClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
