/*
 * XREFs of ?CacheReportSizes@HidLampArrayDevice@@AEAAJPEAUParsedHidReportDescriptor@@I@Z @ 0x1800EA570
 * Callers:
    ...
    if ( a3 )
    {
      ...
      do
      {
        *(_BYTE *)(v11 + *((_QWORD *)this + 79)) = *((_BYTE *)v14 - 4);
        ...
        v15 = *v14;
        v14 += 6;
        *(_DWORD *)(*((_QWORD *)this + 79) + v11 - 4) = (unsigned int)(*(_DWORD *)(*((_QWORD *)v14 - 2)
