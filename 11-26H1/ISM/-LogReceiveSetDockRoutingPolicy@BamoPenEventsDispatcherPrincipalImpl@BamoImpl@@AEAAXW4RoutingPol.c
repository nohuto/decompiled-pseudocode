/*
 * XREFs of ?LogReceiveSetDockRoutingPolicy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@AEAAXW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x1801995CC
 * Callers:
