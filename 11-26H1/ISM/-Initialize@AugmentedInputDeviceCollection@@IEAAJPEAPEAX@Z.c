/*
 * XREFs of ?Initialize@AugmentedInputDeviceCollection@@IEAAJPEAPEAX@Z @ 0x18007A8F4
 * Callers:
        ...
        __int64 a4)
{
  ...
  v13 = 130986;
  v5 = HIDDeviceCollection::Initialize(this, (__int64)a2, (struct _RIM_USAGE_ANDPAGE *const)&v13, a4, 8u, a2);
  v6 = 0;
  v7 = v5;
  if ( v5 >= 0 )
  {
