/*
 * XREFs of ?OnOcclusionRectAdded@DisplayOcclusionContextProvider@@QEAAJAEBUDockInputIdentity@@AEBUDisplayOcclusionRect@@@Z @ 0x1801A64F4
 * Callers:
...
LABEL_6:
  ...
  *(_QWORD *)&v16 = *((_QWORD *)a2 + 2);
  std::vector<DisplayOcclusionRect>::emplace_back<DisplayOcclusionRect &>((_QWORD *)this + 11, &v15);
