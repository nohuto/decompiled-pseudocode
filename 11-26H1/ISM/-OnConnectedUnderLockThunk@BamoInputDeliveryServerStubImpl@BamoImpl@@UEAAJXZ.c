/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoInputDeliveryServerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800699C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputDeliveryServerStubImpl::OnConnectedUnderLockThunk(
