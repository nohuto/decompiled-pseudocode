/*
 * XREFs of ?EnsureBamoCallbacks@MPCConstantManagerClient@@AEAAJXZ @ 0x180171B0C
 * Callers:
 ...
 *     ??0MPCConstantManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCConstantManagerClient@@@Z @ 0x180178370 (--0MPCConstantManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCConstantManage.c)
