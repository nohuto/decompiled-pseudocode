/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoHapticDeviceManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x18018FAB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoHapticDeviceManagerStubImpl::OnConnectedUnderLockThunk(
