/*
 * XREFs of ?OnDropTargetClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005AAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IDropTargetClientProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 160LL))((char *)this + 8);
