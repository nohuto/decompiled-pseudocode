/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputProcessPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputProcessPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1800CB890
 * Callers:
        ...
        int a4)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  if ( v7 && (*(_BYTE *)(a1 + 16) & 1) != 0 )
  {
    v8 = *(_QWORD *)(v7 + 40);
    if ( v8 )
      v9 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v8 + 56LL))(v8, v7 - 16);
    else
      v9 = 0;
    if ( v9 < 0 )
