/*
 * XREFs of ??$_Reallocate_grow_by@V_lambda_65e615be2a453ca0576c979606f46740_@@PEBD_K@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV_lambda_65e615be2a453ca0576c979606f46740_@@PEBD_K@Z @ 0x1800C49DC
 * Callers:
        ...
        size_t Size)
{
  ...
  v11 = (char *)std::_Allocate<16,std::_Default_allocate_traits>(v10 + 1);
  Src[2] = (void *)v9;
  Src[3] = (void *)v10;
  v12 = &v11[v5];
  if ( v8 <= 0xF )
  ...
  else
  {
    ...
    memcpy_0(v12, a4, Size);
    v12[Size] = 0;
    std::_Deallocate<16>(v13, (struct std::nothrow_t *)(v8 + 1));
  }
  *Src = v11;
  return Src;
}
