/*
 * XREFs of ?LogOnHwndChanging@BamoWindowsMessageDeliveryProxy@@AEAAX_K@Z @ 0x18013A988
 * Callers:
...
void __fastcall BamoWindowsMessageDeliveryProxy::LogOnHwndChanging(BamoWindowsMessageDeliveryProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
