/*
 * XREFs of ?XMMatrixRotationQuaternion@DirectX@@YQ?AUXMMATRIX@1@T__m128@@@Z @ 0x180047974
 * Callers:
...
__m128 __fastcall DirectX::XMMatrixRotationQuaternion(double a1)
{
  ...
  v4 = _mm_mul_ps(_mm_shuffle_ps(v1, v1, 201), _mm_shuffle_ps(*(__m128 *)&a1, *(__m128 *)&a1, 255));
