/*
 * XREFs of ?LogSendEdgyRecognized@BamoEdgyNotificationSourceClientProxyImpl@BamoImpl@@AEAAXAEBUPoint@Foundation@Windows@@@Z @ 0x18011DAE0
 * Callers:
