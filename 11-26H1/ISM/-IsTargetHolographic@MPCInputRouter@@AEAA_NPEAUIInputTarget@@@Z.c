/*
 * XREFs of ?IsTargetHolographic@MPCInputRouter@@AEAA_NPEAUIInputTarget@@@Z @ 0x1800FF5B8
 * Callers:
        ...
        __int64 (__fastcall ***a2)(struct IInputTarget *, GUID *, __int64 *))
{
  ...
  if ( ViewIdFromWindowId )
  {
    ...
    if ( !v11 )
    {
      ...
      v11 = (unsigned int)ViewHelper::GetPresentationModeFromViewId((__int64)v13, v12) == 1;
    }
  }
  else if ( v23 )
  {
