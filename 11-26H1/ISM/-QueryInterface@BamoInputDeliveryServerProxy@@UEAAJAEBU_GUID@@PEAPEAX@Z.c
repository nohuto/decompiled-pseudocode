/*
 * XREFs of ?QueryInterface@BamoInputDeliveryServerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180124AA0
 * Callers:
 *     ?QueryInterface@BamoInputDeliveryServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180124B20 (-QueryInterface@BamoInputDeliveryServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_10:
  ...
  *a3 = (char *)this + 8;
  if ( this == (BamoInputDeliveryServerProxy *)-8LL )
    return (unsigned int)-2147467262;
