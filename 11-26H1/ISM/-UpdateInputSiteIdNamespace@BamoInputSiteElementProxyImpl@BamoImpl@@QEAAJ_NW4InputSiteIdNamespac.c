/*
 * XREFs of ?UpdateInputSiteIdNamespace@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NW4InputSiteIdNamespace@@@Z @ 0x180066814
 * Callers:
 *     ?Thunk_UpdateInputSiteIdNamespace_16@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180066800 (-Thunk_UpdateInputSiteIdNamespace_16@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxy.c)
        ...
        __int64 a3)
{
  unsigned int v3; // ebp
  char v4; // r14
  BamoInputSiteElementProxy *v6; // rsi
  int v8; // eax
  int v9; // eax
