/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoInputSpacePayloadStubImpl@BamoImpl@@UEAAJXZ @ 0x180140150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSpacePayloadStubImpl::InitializeProxyUnderLockThunk(
