/*
 * XREFs of ?InternalRelease@?$ComPtr@VForegroundManager@@@WRL@Microsoft@@IEAAKXZ @ 0x1800A633C
 * Callers:
 ...
 *     ??1?$ComPtr@VForegroundManager@@@WRL@Microsoft@@QEAA@XZ @ 0x1800A5FE4 (--1-$ComPtr@VForegroundManager@@@WRL@Microsoft@@QEAA@XZ.c)
