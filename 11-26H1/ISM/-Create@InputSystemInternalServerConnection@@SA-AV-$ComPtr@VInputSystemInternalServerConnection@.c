/*
 * XREFs of ?Create@InputSystemInternalServerConnection@@SA?AV?$ComPtr@VInputSystemInternalServerConnection@@@WRL@Microsoft@@PEAUIMessageSession@@@Z @ 0x180045364
 * Callers:
...
Microsoft::Bamo::BaseBamoConnection **__fastcall InputSystemInternalServerConnection::Create(
        ...
        __int64 a2)
{
  ...
  Microsoft::Bamo::BaseBamoConnection *v11; // rsi
  __int64 v12; // rcx
  __int64 v13; // rcx
