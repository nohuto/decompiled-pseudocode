/*
 * XREFs of ??$As@UIShellGesturesClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIShellGesturesClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18003F4BC
 * Callers:
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_974ecfd8_5dae_f205_7c42_b9160ca196d3, a2);
}
