/*
 * XREFs of ??1BamoHapticDeviceManagerPrincipalImpl@BamoImpl@@UEAA@XZ @ 0x18018DB7C
 * Callers:
 *     ??1BamoHapticDeviceManagerPrincipal@@MEAA@XZ @ 0x18018DB6C (--1BamoHapticDeviceManagerPrincipal@@MEAA@XZ.c)
