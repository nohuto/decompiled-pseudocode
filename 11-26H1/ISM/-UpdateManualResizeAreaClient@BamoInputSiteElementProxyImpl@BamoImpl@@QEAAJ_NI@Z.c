/*
 * XREFs of ?UpdateManualResizeAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003B5F4
 * Callers:
 *     ?Thunk_UpdateManualResizeAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003B5E0 (-Thunk_UpdateManualResizeAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
