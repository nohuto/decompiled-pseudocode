        ...
        unsigned __int8 *a3)
{
  ...
  else
  {
    ...
    v15 = a1 + 2;
    v7 = std::_Allocate<16,std::_Default_allocate_traits>(0x58uLL);
    v16 = v7;
    v18 = a3;
    ____0V__tuple___QEAPEAUIInputTarget___std__V__tuple___V_1__0A___Z_S___pair_QEAUIInputTarget__V__unordered_set_KU__hash_K_std__U__equal_to_K_2_V__allocator_K_2__std___std__AEAA_AEAV__tuple___QEAPEAUIInputTarget___1_AEAV__tuple___V_1_U__integer_sequence__K_0A__1_U__integer_sequence__K_S_1__Z(
      v7 + 2,
      (_QWORD **)&v18);
    v8 = *((_QWORD *)a1 + 2) + 1LL;
    if ( v8 < 0 )
    ...
    *(_QWORD *)a2 = std::_Hash<std::_Umap_traits<unsigned long,ConsumerControlDeviceCollection::UsageList,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,ConsumerControlDeviceCollection::UsageList>>,0>>::_Insert_new_node_before(
                      ...
                      v7);
    *(_BYTE *)(a2 + 8) = 1;
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>,void *>>>::~_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<IInputTarget * const,std::unordered_set<unsigned long>>,void *>>>(&v15);
  }
  return a2;
}
