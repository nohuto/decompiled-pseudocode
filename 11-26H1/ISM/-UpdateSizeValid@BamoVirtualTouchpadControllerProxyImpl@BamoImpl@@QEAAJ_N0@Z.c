/*
 * XREFs of ?UpdateSizeValid@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180139F3C
 * Callers:
 *     ?Thunk_UpdateSizeValid_11@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180139910 (-Thunk_UpdateSizeValid_11@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControll.c)
