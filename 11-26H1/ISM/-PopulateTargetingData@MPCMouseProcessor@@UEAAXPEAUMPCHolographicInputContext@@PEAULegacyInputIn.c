/*
 * XREFs of ?PopulateTargetingData@MPCMouseProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAULegacyInputInfo@@@Z @ 0x1801C72D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?make_float4x4_from_quaternion@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBUquaternion@123@@Z @ 0x1801C815C (-make_float4x4_from_quaternion@Numerics@Foundation@Windows@@YA-AUfloat4x4@123@AEBUquaternion@123.c)
        ...
        struct LegacyInputInfo *a3)
{
  ...
  __m128 v72; // [rsp+80h] [rbp-80h] BYREF
  float v73; // [rsp+90h] [rbp-70h] BYREF
  float v74; // [rsp+94h] [rbp-6Ch] BYREF
  int v75[2]; // [rsp+98h] [rbp-68h] BYREF
  __int32 v76; // [rsp+A0h] [rbp-60h]
  unsigned __int64 v77; // [rsp+A8h] [rbp-58h] BYREF
  __int32 v78; // [rsp+B0h] [rbp-50h] BYREF
  int v79; // [rsp+B8h] [rbp-48h] BYREF
  __m128 v80; // [rsp+C0h] [rbp-40h] BYREF
  __int128 v81; // [rsp+D0h] [rbp-30h] BYREF
  unsigned __int64 v82; // [rsp+E0h] [rbp-20h]
  __int32 v83; // [rsp+E8h] [rbp-18h]
  __m128 v84; // [rsp+110h] [rbp+10h] BYREF
  ...
  *(_QWORD *)v75 = *(_QWORD *)((char *)a2 + 180);
  ...
  if ( *((_QWORD *)this + 1052) )
  {
    ...
    v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_ResetCursorDirectionThresholdSeconds");
    if ( (float)((double)(Ticks.LowPart - *((_DWORD *)this + 2104)) / (double)(int)qword_180253EC8) > (double)MPCConstantManager::GetConstant<float>(v21, (unsigned __int64)this & -(__int64)(this != (MPCMouseProcessor *)40), (__int128 *)&v72) )
    {
...
LABEL_14:
  ...
  if ( *((_DWORD *)this + 1339) || *((_DWORD *)this + 1340) )
  {
    ...
    MPCConstantManager::GetInstance(v25, v24, v26, v27);
    v72.m128_u64[0] = (unsigned __int64)L"MouseParams_ResetHorizontalAngleRadians";
    v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_ResetHorizontalAngleRadians");
    if ( COERCE_FLOAT(LODWORD(YawAngleBetweenTwoVectors) & _xmm) > MPCConstantManager::GetConstant<float>(
                                                                     ...
                                                                     (__int128 *)&v72)
      || (MPCConstantManager::GetInstance(v30, v29, v31, v32),
          v72.m128_u64[0] = (unsigned __int64)L"MouseParams_ResetVerticalAngleRadians",
          v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_ResetVerticalAngleRadians"),
    ...
    else if ( !*((_BYTE *)this + 5312) || !v71[0] )
    {
      ...
      if ( !*((_BYTE *)a2 + 3272) )
      {
        MPCConstantManager::GetInstance(v36, v35, v37, v38);
        v72.m128_u64[0] = (unsigned __int64)L"MouseParams_UseHitTestMouseReference";
        v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_UseHitTestMouseReference");
        ...
        v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_DeltaToRadiansRatio");
        v47 = (float)(v41
        ...
        MPCConstantManager::GetInstance(v50, v49, v51, v52);
        v72.m128_u64[0] = (unsigned __int64)L"MouseParams_DeltaToRadiansRatio";
        v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_DeltaToRadiansRatio");
        v58 = (float)(v48
                    / MPCConstantManager::GetConstant<float>(
        ...
        if ( !v40 )
        {
          MPCConstantManager::GetInstance(v55, v54, v56, v57);
          v72.m128_u64[0] = (unsigned __int64)L"MouseParams_DeltaToRadiansRatio_NoHitTestSensitivityCompensationFactor";
          v72.m128_u64[1] = std::_WChar_traits<unsigned short>::length((__int64)L"MouseParams_DeltaToRadiansRatio_NoHitTes"
                                                                                 "tSensitivityCompensationFactor");
        ...
        MPCMath::OrientToGravity(&v81, (float *)a2 + 4, 0.89999998);
        v80.m128_u64[0] = v81;
        v80.m128_i32[2] = DWORD2(v81);
        v72.m128_u64[0] = v82;
        v72.m128_i32[2] = v83;
        Windows::Foundation::Numerics::make_quaternion_from_axis_angle(v84.m128_f32, v80.m128_f32, v58);
        Windows::Foundation::Numerics::make_quaternion_from_axis_angle(v80.m128_f32, v72.m128_f32, v47);
        Windows::Foundation::Numerics::operator*(&v72, &v84, &v80);
        Windows::Foundation::Numerics::make_float4x4_from_quaternion(&v81, &v72);
        v61 = v75;
        if ( !v40 )
          v61 = (int *)((char *)this + 8424);
        v62 = Windows::Foundation::Numerics::transform_normal(v72.m128_f32, (float *)v61, (float *)&v81);
        v63 = *((_DWORD *)v62 + 2);
  ...
  *((_BYTE *)a3 + 89) = 0;
  ...
  if ( (*(int (__fastcall **)(_QWORD, _QWORD, __int64, const char *, __int128 *))(**((_QWORD **)this + 456) + 112LL))(
         *((_QWORD *)this + 456),
         ...
         v11,
         &v85) >= 0
    && (((_DWORD)v85 == DWORD2(v85)) == DWORD1(v85)) == HIDWORD(v85) )
  {
    v74 = 0.0;
    v73 = 0.0;
    v79 = 0;
