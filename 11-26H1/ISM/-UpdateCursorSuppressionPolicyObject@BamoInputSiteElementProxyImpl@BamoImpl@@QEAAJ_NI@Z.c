/*
 * XREFs of ?UpdateCursorSuppressionPolicyObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18003C074
 * Callers:
 *     ?Thunk_UpdateCursorSuppressionPolicyObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003C060 (-Thunk_UpdateCursorSuppressionPolicyObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
