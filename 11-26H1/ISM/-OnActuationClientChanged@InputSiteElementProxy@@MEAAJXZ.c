/*
 * XREFs of ?OnActuationClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18005AF50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActuationClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005AFC4 (--$RemoveObject@UIActuationClientProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
        ...
        const char *a4)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
  InputSite::RemoveObject<IActuationClientProxy>(v5, this);
  v6 = *((_QWORD *)this + 42);
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 64LL))((char *)this + 8);
