/*
 * XREFs of ?OnPeerConnected@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJIIIPEAPEAX@Z @ 0x180029EB4
 * Callers:
        ...
        void **a5)
{
  ...
  *a5 = 0LL;
  ...
  v20 = Microsoft::BamoImpl::BaseBamoConnectionImpl::TrackError(this, -2018375668, 0);
  v21 = v20;
  if ( v20 < 0 )
