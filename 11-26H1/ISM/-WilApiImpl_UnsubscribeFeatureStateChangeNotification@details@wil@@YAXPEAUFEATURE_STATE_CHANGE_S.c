/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x1800A0EA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  if ( ((unsigned int)this & 0x80000000) != 0 )
  {
    ...
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_180251788;
  }
  else
  {
    if ( !wil::details::g_featureStateManager )
      return;
    v2 = this;
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_180251738;
  }
  wil::details_abi::SubscriptionList::Unsubscribe(v3, &stru_180251710, v2);
}
