/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_PEN_EVENT_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_PEN_EVENT_MESSAGE@@@Z@std@@@Z @ 0x1800419DC
 * Callers:
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v17 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v21);
    v18 = NtMITCoreMsgKOpenConnectionTo(16LL, a1 + 3);
    if ( v18 < 0 )
