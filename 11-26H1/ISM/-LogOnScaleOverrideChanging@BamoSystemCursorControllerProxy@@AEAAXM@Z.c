/*
 * XREFs of ?LogOnScaleOverrideChanging@BamoSystemCursorControllerProxy@@AEAAXM@Z @ 0x18011C7F8
 * Callers:
...
void __fastcall BamoSystemCursorControllerProxy::LogOnScaleOverrideChanging(
        ...
        float a2)
{
  ...
  __int64 v3; // r8
  __int64 v4; // r9
  float v5; // [rsp+50h] [rbp+18h] BYREF
