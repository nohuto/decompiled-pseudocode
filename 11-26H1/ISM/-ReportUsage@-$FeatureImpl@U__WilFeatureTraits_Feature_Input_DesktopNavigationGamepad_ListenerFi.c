/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_ListenerFix@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800CDF80
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_ListenerFix>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  v4 = a2;
  LODWORD(v5) = *(_DWORD *)Feature_Input_DesktopNavigationGamepad_ListenerFix__descriptor;
  if ( (*(_DWORD *)Feature_Input_DesktopNavigationGamepad_ListenerFix__descriptor & 4) == 0 )
  {
    v5 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad_ListenerFix>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v6);
    v6 = v5;
  }
