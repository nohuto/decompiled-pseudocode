/*
 * XREFs of ?UpdateActivatedRemoteCache@BamoActivationControllerProxyImpl@BamoImpl@@AEAAXXZ @ 0x1800B044C
 * Callers:
 *     ?PushStateToPrincipal@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ @ 0x1800B01E0 (-PushStateToPrincipal@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ.c)
