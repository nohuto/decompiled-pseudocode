/*
 * XREFs of ?LogSetIsPlayDurationSupported@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAX_N@Z @ 0x180189D40
 * Callers:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::LogSetIsPlayDurationSupported(
