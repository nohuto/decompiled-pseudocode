/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoInputSiteManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x18006F950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSiteManagerStubImpl::OnConnectedUnderLockThunk(
