/*
 * XREFs of ?InputAttempted@BamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@QEAAJXZ @ 0x180160590
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      BamoImpl::BamoInputAttemptedDeliveryClientProxyImpl::LogSendInputAttempted(this);
      v11[0] = v13;
      v11[1] = v14;
