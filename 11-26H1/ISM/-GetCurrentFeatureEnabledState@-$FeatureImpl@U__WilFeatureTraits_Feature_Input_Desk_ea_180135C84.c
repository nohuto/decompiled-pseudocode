/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Input_DesktopNavigationGamepad@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180135C84
 * Callers:
  ...
  *(_DWORD *)a2 = v11 | v12;
  if ( (v14 & 0x400) != 0 && (unsigned int)v14 >= 0x800 || (v14 & 0x40) != 0 )
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_ValAccTest>::ReportUsage(
      (__int64)&`wil::Feature<__WilFeatureTraits_Feature_ValAccTest>::GetImpl'::`2'::impl,
      v14,
      v11);
    v15 = 1;
  }
