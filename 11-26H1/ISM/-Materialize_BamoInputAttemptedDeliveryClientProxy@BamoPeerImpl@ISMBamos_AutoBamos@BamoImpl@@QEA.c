/*
 * XREFs of ?Materialize_BamoInputAttemptedDeliveryClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18012054C
 * Callers:
 *     ?Thunk_Materialize_BamoInputAttemptedDeliveryClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128DC0 (-Thunk_Materialize_BamoInputAttemptedDeliveryClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receiv.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  struct BamoInputAttemptedDeliveryClientProxy *v14; // [rsp+60h] [rbp+8h] BYREF
  ...
  v5 = CreateInputAttemptedDeliveryClientProxy(v4, &v14);
  if ( v5 < 0 )
  ...
  if ( !v14 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v6);
  v7 = (*(__int64 (__fastcall **)(struct BamoInputAttemptedDeliveryClientProxy *))(*(_QWORD *)v14 + 56LL))(v14);
