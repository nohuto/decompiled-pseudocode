/*
 * XREFs of _anonymous_namespace_::__std_find_meow_of_bitmap_details::_Make_bitmap_unsigned_short_ @ 0x18009C2D0
 * Callers:
...
int __fastcall anonymous_namespace_::__std_find_meow_of_bitmap_details::_Make_bitmap_unsigned_short_(
        unsigned __int16 *a1,
        unsigned __int64 a2)
{
  ...
  if ( a2 > 0x14 )
  {
    memset_0((void *)((unsigned __int64)&v42 & 0xFFFFFFFFFFFFFFE0uLL), 0, 0x100uLL);
