/*
 * XREFs of ?Create@DockDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x1800DCBC0
 * Callers:
 ...
 *     ??0_Mutex_base@std@@QEAA@H@Z @ 0x18007C6C0 (--0_Mutex_base@std@@QEAA@H@Z.c)
        ...
        struct DockDeviceCollection **a4)
{
  ...
  {
    v16 = 0LL;
    v8 = (HIDDeviceCollection *)RefCountedObject::operator new(0xB50uLL);
    v9 = v8;
    if ( v8 )
    {
