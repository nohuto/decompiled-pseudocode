/*
 * XREFs of ??1?$unique_ptr@UDeviceAttachEventArgs@ConsumerControlNexusDevice@@U?$default_delete@UDeviceAttachEventArgs@ConsumerControlNexusDevice@@@std@@@std@@QEAA@XZ @ 0x1800E7664
 * Callers:
 ...
 *     ??1DeviceAttachEventArgs@ConsumerControlNexusDevice@@QEAA@XZ @ 0x1800E781C (--1DeviceAttachEventArgs@ConsumerControlNexusDevice@@QEAA@XZ.c)
 */
