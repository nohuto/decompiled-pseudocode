/*
 * XREFs of ??1?$pair@IUWindow@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@std@@QEAA@XZ @ 0x180049A64
 * Callers:
 *     _ViewHierarchyWithWindowManager::OnWindowAdded_::_1_::dtor$3 @ 0x1801D6ABC (_ViewHierarchyWithWindowManager--OnWindowAdded_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
