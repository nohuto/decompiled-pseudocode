/*
 * XREFs of ?DragInDeadZone@TwoFingerDragRecognizer@@AEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x1801BACE8
 * Callers:
 ...
 *     ?DeliverGesture@TwoFingerDragRecognizer@@AEAAX_NPEBUTouchContactInfo@@@Z @ 0x1801BAC90 (-DeliverGesture@TwoFingerDragRecognizer@@AEAAX_NPEBUTouchContactInfo@@@Z.c)
 */
        ...
        const struct TouchContactInfo *a6)
{
  ...
  else
  {
    ...
    v10.x = (*((_DWORD *)v7 + 1) + *((_DWORD *)v7 + 11)) / 2 - *((_DWORD *)this + 13);
