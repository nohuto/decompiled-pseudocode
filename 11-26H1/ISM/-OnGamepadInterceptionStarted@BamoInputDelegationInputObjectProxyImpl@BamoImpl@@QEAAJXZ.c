/*
 * XREFs of ?OnGamepadInterceptionStarted@BamoInputDelegationInputObjectProxyImpl@BamoImpl@@QEAAJXZ @ 0x180136670
 * Callers:
...
__int64 __fastcall BamoImpl::BamoInputDelegationInputObjectProxyImpl::OnGamepadInterceptionStarted(
        ...
        const char *a4)
{
  ...
  struct IMessageCallSendHost *v15; // [rsp+80h] [rbp+40h] BYREF
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoInputDelegationInputObjectProxyImpl::LogSendOnGamepadInterceptionStarted(this);
      v11[0] = v13;
      v11[1] = v14;
