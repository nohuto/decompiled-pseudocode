/*
 * XREFs of ?OnMessage@BamoSystemContextEndpointProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180143CA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemContextEndpointProxyImpl::OnMessage(
