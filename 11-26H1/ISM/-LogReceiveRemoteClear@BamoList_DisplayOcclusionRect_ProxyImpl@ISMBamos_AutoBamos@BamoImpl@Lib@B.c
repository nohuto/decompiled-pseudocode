/*
 * XREFs of ?LogReceiveRemoteClear@BamoList_DisplayOcclusionRect_ProxyImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXXZ @ 0x18013CD24
 * Callers:
