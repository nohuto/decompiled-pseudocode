/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1800A0D90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?wil_details_GetNtDllProcedureAddress@@YAP6A_JXZPEBD@Z @ 0x18008F654 (-wil_details_GetNtDllProcedureAddress@@YAP6A_JXZPEBD@Z.c)
 ...
 *     ?SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1800A0AD0 (-SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPT.c)
        ...
        void *a4)
{
  ...
  else
  {
    *this = 0LL;
    ...
    {
      AcquireSRWLockExclusive(&stru_180251710);
      v9 = &stru_180251710;
      if ( qword_180251780
            ...
            !v8) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_180251738,
          this,
          (void (*)(void *))a2,
          a3);
      }
