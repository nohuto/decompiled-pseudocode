/*
 * XREFs of ?OnConnectedUnderLockThunk@BamoInputProcessStubImpl@BamoImpl@@UEAAJXZ @ 0x1800CBFF0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::BamoInputProcessStubImpl *this)
{
  ...
  if ( !v5 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v4);
  v6 = (*(__int64 (__fastcall **)(__int64, __int64, char *))(*(_QWORD *)v5 + 16LL))(v5, v1 - 16, (char *)this - 16);
