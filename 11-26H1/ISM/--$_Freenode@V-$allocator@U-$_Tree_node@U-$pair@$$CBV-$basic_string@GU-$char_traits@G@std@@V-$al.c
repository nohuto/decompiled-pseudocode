...
__int64 __fastcall std::_Tree_node<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>,void *>::_Freenode<std::allocator<std::_Tree_node<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>,void *>>>(
        __int64 a1,
        __int64 a2)
{
  std::wstring::_Tidy_deallocate((_QWORD *)(a2 + 32));
  return std::_Deallocate<16>(a2, 72LL);
}
