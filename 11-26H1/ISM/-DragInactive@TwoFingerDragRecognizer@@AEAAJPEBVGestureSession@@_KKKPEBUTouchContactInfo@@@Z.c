/*
 * XREFs of ?DragInactive@TwoFingerDragRecognizer@@AEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x1801BAD9C
 * Callers:
        ...
        const struct TouchContactInfo *a6)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    if ( a5 <= 2 )
    {
      ...
      {
        *((_WORD *)this + 8) |= 4u;
        LODWORD(v16) = (*((_DWORD *)a6 + 11) + *((_DWORD *)a6 + 1)) / 2;
