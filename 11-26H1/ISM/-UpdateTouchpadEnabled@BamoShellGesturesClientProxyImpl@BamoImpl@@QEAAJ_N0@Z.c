/*
 * XREFs of ?UpdateTouchpadEnabled@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18008EEE4
 * Callers:
 *     ?Thunk_UpdateTouchpadEnabled_11@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18008EED0 (-Thunk_UpdateTouchpadEnabled_11@-$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProx.c)
