/*
 * XREFs of wil::details::_dynamic_initializer_for__g_enabledStateManager__ @ 0x18000A300
 * Callers:
 *     <none>
 * Callees:
 *     ??0EnabledStateManager@details@wil@@QEAA@XZ @ 0x1800826AC (--0EnabledStateManager@details@wil@@QEAA@XZ.c)
 */
