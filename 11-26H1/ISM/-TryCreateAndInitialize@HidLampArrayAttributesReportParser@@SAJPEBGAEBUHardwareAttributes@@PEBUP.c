/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayAttributesReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800EDCD8
 * Callers:
 ...
 *     ??0HidLampArrayAttributesReportParser@@AEAA@XZ @ 0x1800ED808 (--0HidLampArrayAttributesReportParser@@AEAA@XZ.c)
    ...
    if ( *(_DWORD *)a3 == 2 )
    {
      *((_BYTE *)v9 + 17) = 2;
      for ( i = 0LL; (unsigned int)i < *((_DWORD *)a3 + 2); i = (unsigned int)(i + 1) )
      {
        ...
        if ( v14 != 6 || *(_WORD *)(v13 + 72 * i + 8) != 89 )
        {
LABEL_23:
          if ( v14 == 7 && *(_WORD *)(v13 + 72 * i + 8) == 89 )
          {
          ...
          else if ( *(_WORD *)(v13 + 72 * i + 10) == 8 && *(_WORD *)(v13 + 72 * i + 8) == 89 )
          {
