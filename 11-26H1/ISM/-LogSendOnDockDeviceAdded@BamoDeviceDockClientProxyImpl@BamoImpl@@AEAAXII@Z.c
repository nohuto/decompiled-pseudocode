/*
 * XREFs of ?LogSendOnDockDeviceAdded@BamoDeviceDockClientProxyImpl@BamoImpl@@AEAAXII@Z @ 0x1801867A4
 * Callers:
...
void __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::LogSendOnDockDeviceAdded(
