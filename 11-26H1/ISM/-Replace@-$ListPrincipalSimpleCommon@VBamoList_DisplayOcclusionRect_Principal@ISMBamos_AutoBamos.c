/*
 * XREFs of ?Replace@?$ListPrincipalSimpleCommon@VBamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@VBamoList_DisplayOcclusionRect_Stub@2345@UDisplayOcclusionRect@@AEBU8@@Bamo@Microsoft@@QEAAJIAEBUDisplayOcclusionRect@@@Z @ 0x180142CD0
 * Callers:
        ...
        const struct DisplayOcclusionRect *a3)
{
  ...
  v8 = *(_QWORD *)(a1 + 56);
  if ( v4 >= 0x2E8BA2E8BA2E8BA3LL * ((*(_QWORD *)(a1 + 64) - v8) >> 4) )
