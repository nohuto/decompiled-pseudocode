/*
 * XREFs of ?LogSetIsReplayPauseIntervalSupported@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAX_N@Z @ 0x180189DB0
 * Callers:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::LogSetIsReplayPauseIntervalSupported(
