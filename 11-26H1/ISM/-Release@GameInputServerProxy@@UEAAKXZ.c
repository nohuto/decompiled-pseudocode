/*
 * XREFs of ?Release@GameInputServerProxy@@UEAAKXZ @ 0x18010F050
 * Callers:
 *     ?Release@GameInputServerProxy@@W7EAAKXZ @ 0x18010F0C0 (-Release@GameInputServerProxy@@W7EAAKXZ.c)
 *     ?Release@GameInputServerProxy@@WBA@EAAKXZ @ 0x18010F0D0 (-Release@GameInputServerProxy@@WBA@EAAKXZ.c)
 * Callees:
