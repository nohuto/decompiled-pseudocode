/*
 * XREFs of ?QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIPEAUwil_details_FeatureReportingCache@@@Z @ 0x1800ACDE4
 * Callers:
  ...
  if ( *(_DWORD *)pv && !wil::ProcessShutdownInProgress((wil *)pv) )
  {
    ...
    if ( *(_DWORD *)pv )
    {
      if ( !wil::ProcessShutdownInProgress(v6) )
      {
        ...
        v8[1] = 0;
        v9 = a3;
        wil::details_abi::heap_buffer::push_back((void **)pv + 6, v8, 0x10uLL);
        if ( !pv[24] )
        {
          if ( !*((_QWORD *)pv + 2) )
          {
