/*
 * XREFs of ?OnInputReport@CallControlDeviceCollection@@MEAAJKPEAXK@Z @ 0x1800DB9B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  UsageLength = 20;
  Usages = HidP_GetUsagesEx(HidP_Input, 0, &ButtonList, &UsageLength, PreparsedData, Report, ReportLength);
  if ( Usages < 0 )
  {
    v27 = 167LL;
