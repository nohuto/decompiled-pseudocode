/*
 * XREFs of ?QueryInterface@EdgyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180158AB0
 * Callers:
 *     ?QueryInterface@EdgyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180158B70 (-QueryInterface@EdgyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
