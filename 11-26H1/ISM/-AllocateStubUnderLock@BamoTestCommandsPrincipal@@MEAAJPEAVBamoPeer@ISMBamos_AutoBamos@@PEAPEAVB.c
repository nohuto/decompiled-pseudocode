/*
 * XREFs of ?AllocateStubUnderLock@BamoTestCommandsPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoTestCommandsStub@@@Z @ 0x180072D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoTestCommandsPrincipal::AllocateStubUnderLock(
