/*
 * XREFs of ?LogOnTypeChanging@BamoWindowsMessageDeliveryProxy@@AEAAXW4WindowsMessageDeliveryType@Input@Internal@UI@Windows@@@Z @ 0x18013AA3C
 * Callers:
...
void BamoWindowsMessageDeliveryProxy::LogOnTypeChanging()
{
  __int64 v0; // rcx
  __int64 v1; // r8
  __int64 v2; // r9
