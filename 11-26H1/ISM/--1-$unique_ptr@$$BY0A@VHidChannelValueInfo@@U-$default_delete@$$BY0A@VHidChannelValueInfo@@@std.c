/*
 * XREFs of ??1?$unique_ptr@$$BY0A@VHidChannelValueInfo@@U?$default_delete@$$BY0A@VHidChannelValueInfo@@@std@@@std@@QEAA@XZ @ 0x1800EA474
 * Callers:
 *     ??1ParsedHidReportDescriptor@@QEAA@XZ @ 0x1800EA4A0 (--1ParsedHidReportDescriptor@@QEAA@XZ.c)
 * Callees:
