/*
 * XREFs of ?UpdateTailButtonLongPressedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180076590
 * Callers:
 *     ?Thunk_UpdateTailButtonLongPressedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180092F40 (-Thunk_UpdateTailButtonLongPressedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEven.c)
