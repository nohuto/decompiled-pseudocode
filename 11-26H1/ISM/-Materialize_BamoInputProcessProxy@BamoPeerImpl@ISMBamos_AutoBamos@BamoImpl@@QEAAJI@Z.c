/*
 * XREFs of ?Materialize_BamoInputProcessProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180120C80
 * Callers:
 *     ?Thunk_Materialize_BamoInputProcessProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128E40 (-Thunk_Materialize_BamoInputProcessProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)v11 + 4) = 0LL;
  *((_QWORD *)v11 + 5) = 0LL;
  *((_QWORD *)v11 + 2) = &BamoImpl::BamoInputProcessProxyImpl::`vftable';
  *(_QWORD *)v11 = &InputProcessProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v11 + 1) = &InputProcessProxy::`vftable'{for `IInputProcessProxy'};
  ...
  v4 = (*(__int64 (__fastcall **)(_OWORD *))(*(_QWORD *)v11 + 56LL))(v11);
