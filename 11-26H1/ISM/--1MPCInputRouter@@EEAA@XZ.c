/*
 * XREFs of ??1MPCInputRouter@@EEAA@XZ @ 0x1800FE338
 * Callers:
...
void __fastcall MPCInputRouter::~MPCInputRouter(MPCInputRouter *this)
{
  ...
  *((_QWORD *)this + 80) = &MPCInputRouter::`vftable'{for `IMPCExclusiveModeStateManager'};
  ...
  Microsoft::WRL::ComPtr<Windows::Foundation::Collections::IVector<HSTRING__ *>>::InternalRelease((__int64 *)this + 85);
