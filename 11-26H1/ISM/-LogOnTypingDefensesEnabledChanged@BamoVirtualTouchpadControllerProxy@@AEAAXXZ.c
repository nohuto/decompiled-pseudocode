/*
 * XREFs of ?LogOnTypingDefensesEnabledChanged@BamoVirtualTouchpadControllerProxy@@AEAAXXZ @ 0x180138534
 * Callers:
...
void __fastcall BamoVirtualTouchpadControllerProxy::LogOnTypingDefensesEnabledChanged(
