/*
 * XREFs of ?AddEndpoint@DWMCursorBroker@@UEAAJUtagMsgRoutingInfo@@I_N@Z @ 0x1801CBB00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z @ 0x1801CC2BC (-GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z.c)
