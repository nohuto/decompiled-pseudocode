/*
 * XREFs of ?Thunk_UpdateData_28@?$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180149190
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        const struct Windows::UI::Internal::Input::GestureAnimationData *a2)
{
  ...
  v2 = *(const struct Windows::UI::Internal::Input::GestureAnimationData **)a2;
  LOBYTE(a2) = 1;
  return BamoImpl::BamoAnimationTargetClientProxyImpl::UpdateData(a1, a2, v2);
}
