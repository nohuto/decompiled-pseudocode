/*
 * XREFs of ?OnComponentWindowActivated@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180134290
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCUIHostInputObjectProxyImpl::OnComponentWindowActivated(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      BamoImpl::BamoCUIHostInputObjectProxyImpl::LogSendOnComponentWindowActivated(this);
      v11[0] = v13;
      v11[1] = v14;
