/*
 * XREFs of ?SendMaterializeProxy@BamoGestureServicesPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180034700
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoGestureServicesPrincipalImpl::SendMaterializeProxy(
