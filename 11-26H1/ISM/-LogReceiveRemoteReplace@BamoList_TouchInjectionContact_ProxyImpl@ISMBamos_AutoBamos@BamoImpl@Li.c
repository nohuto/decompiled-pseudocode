/*
 * XREFs of ?LogReceiveRemoteReplace@BamoList_TouchInjectionContact_ProxyImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@AEAAXIAEBUTouchInjectionContact@Input@Internal@UI@Windows@@@Z @ 0x1801A0F48
 * Callers:
