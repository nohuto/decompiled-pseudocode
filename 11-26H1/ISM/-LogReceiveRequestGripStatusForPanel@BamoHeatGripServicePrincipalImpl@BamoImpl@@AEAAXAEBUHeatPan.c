/*
 * XREFs of ?LogReceiveRequestGripStatusForPanel@BamoHeatGripServicePrincipalImpl@BamoImpl@@AEAAXAEBUHeatPanelInfo@@@Z @ 0x180195C40
 * Callers:
...
void __fastcall BamoImpl::BamoHeatGripServicePrincipalImpl::LogReceiveRequestGripStatusForPanel(
        ...
        const struct HeatPanelInfo *a2)
{
  ...
  __int64 v5; // r8
  __int64 v6; // r9
  const struct HeatPanelInfo *v7; // [rsp+48h] [rbp+10h] BYREF
  ...
  {
    LODWORD(v7) = *(_DWORD *)(*((_QWORD *)Microsoft::BamoImpl::BamoPrincipalImpl::GetCurrentCaller(v3) + 4) + 36LL);
