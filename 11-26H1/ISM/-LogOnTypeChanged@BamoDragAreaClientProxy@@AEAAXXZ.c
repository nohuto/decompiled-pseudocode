/*
 * XREFs of ?LogOnTypeChanged@BamoDragAreaClientProxy@@AEAAXXZ @ 0x18011CCCC
 * Callers:
...
void __fastcall BamoDragAreaClientProxy::LogOnTypeChanged(BamoDragAreaClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
