/*
 * XREFs of ?EnsureInterfaceAttached@HapticDeviceManager@@QEAAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@AEBU_GUID@@@Z @ 0x18018ED88
 * Callers:
 ...
 *     ?Add@?$ListPrincipalSimpleCommon@VBamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@VBamoConnection@2@VBamoList_PenDevicePrincipal_Stub@2345@V?$com_ptr_t@VBamoPenDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@PEAVBamoPenDevicePrincipal@@@Bamo@Microsoft@@QEAAJPEAVBamoPenDevicePrincipal@@@Z @ 0x18018DCBC (-Add@-$ListPrincipalSimpleCommon@VBamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@B.c)
...
__int64 __fastcall HapticDeviceManager::EnsureInterfaceAttached(__int64 a1, __int64 *a2, struct _GUID *a3)
{
  struct ISMBamos_AutoBamos::BamoConnection *BamoServerConnection; // r14
  PenDevice *v7; // rax
  PenDevice *v8; // rbx
  int v9; // eax
  __int64 v10; // rax
  ...
  _BYTE v15[24]; // [rsp+28h] [rbp-18h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+28h]
  PenDevice *v17; // [rsp+70h] [rbp+30h] BYREF
  __int64 *v18; // [rsp+78h] [rbp+38h]
  PenDevice *v19; // [rsp+88h] [rbp+48h] BYREF
  ...
  std::_Tree<std::_Tmap_traits<_GUID,wil::com_ptr_t<PenDevice,wil::err_exception_policy>,HapticDeviceManager::GUIDComparer,std::allocator<std::pair<_GUID const,wil::com_ptr_t<PenDevice,wil::err_exception_policy>>>,0>>::find(
    ...
    &v17,
    a3);
  if ( v17 == *(PenDevice **)(a1 + 80) )
  {
    v17 = (PenDevice *)operator new(0x70uLL);
    v7 = PenDevice::PenDevice(v17, BamoServerConnection, a3);
    wil::com_ptr_t<BamoInputSpacePayloadPrincipal,wil::err_exception_policy>::com_ptr_t<BamoInputSpacePayloadPrincipal,wil::err_exception_policy>(
      &v19,
      (void (__fastcall ***)(_QWORD))v7);
    std::_Tree<std::_Tmap_traits<_GUID,wil::com_ptr_t<PenDevice,wil::err_exception_policy>,HapticDeviceManager::GUIDComparer,std::allocator<std::pair<_GUID const,wil::com_ptr_t<PenDevice,wil::err_exception_policy>>>,0>>::_Emplace<_GUID const &,wil::com_ptr_t<PenDevice,wil::err_exception_policy> &>(
      (__int64 *)(a1 + 80),
      (__int64)v15,
      a3,
    ...
    if ( v9 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        (int)v14);
    if ( (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)v8 + 1) + 40LL))((__int64)v8 + 8) )
    {
      ...
      {
        v17 = 0LL;
        tip2::tip_test<tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>>::start(
          &v17,
          v15);
        if ( v17 )
          tip2::details::shared_data<0,0,1>::complete_without_lock((__int64)v17 + 8);
        wil::com_ptr_t<tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>,wil::err_returncode_policy>::~com_ptr_t<tip2::details::merged_data<_tip_HapticPenAttachedTipTest_attributes,tip2::test_data_basic>,wil::err_returncode_policy>((void **)&v17);
      }
      v10 = (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)v8 + 1) + 40LL))((__int64)v8 + 8);
      v11 = (const unsigned __int16 *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(v10 + 8) + 40LL))(v10 + 8);
      InputTraceLogging::Haptics::HapticDeviceAdded(IMDT_PEN, v11);
    }
  ...
  {
    v12 = (PenDevice *)*((_QWORD *)v17 + 6);
    wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v17, *a2);
    PenDevice::AttachInterface(v12);
  }
