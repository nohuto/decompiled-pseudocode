/*
 * XREFs of ??$RemoveObject@UIActivationListenerInputObjectProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x18005BC74
 * Callers:
...
void __fastcall InputSite::RemoveObject<IActivationListenerInputObjectProxy>(
        __int64 a1,
        __int64 (__fastcall ***a2)(_QWORD, GUID *, __int64 *))
{
  ...
  while ( v4 != v5 )
  {
    ...
    v9 = v8(v7, &GUID_a1cdc933_ea3a_72de_bea8_f0397564bae3, &v13) >= 0;
    if ( v6 == a2 && v9 )
      break;
    v4 += 2;
  }
