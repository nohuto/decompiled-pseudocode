/*
 * XREFs of ?OnActivationControllerChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180051600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveObject@UIActivationControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z @ 0x180051674 (--$RemoveObject@UIActivationControllerProxy@@@InputSite@@QEAAXPEAVInputSiteElementProxy@@@Z.c)
