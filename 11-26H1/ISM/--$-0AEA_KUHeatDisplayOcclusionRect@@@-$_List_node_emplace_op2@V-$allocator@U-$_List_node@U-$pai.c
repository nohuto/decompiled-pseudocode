/*
 * XREFs of ??$?0AEA_KUHeatDisplayOcclusionRect@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@PEAX@std@@@1@AEA_K$$QEAUHeatDisplayOcclusionRect@@@Z @ 0x1801960D0
 * Callers:
        ...
        __int64 a4)
{
  ...
  *a1 = a2;
  a1[1] = 0LL;
  v7 = (char *)std::_Allocate<16,std::_Default_allocate_traits>(0xB0uLL);
  a1[1] = v7;
  *((_QWORD *)v7 + 2) = *a3;
