/*
 * XREFs of ?InitializeProxyUnderLockThunk@BamoHapticDeviceManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x18018F1A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoHapticDeviceManagerStubImpl::InitializeProxyUnderLockThunk(
