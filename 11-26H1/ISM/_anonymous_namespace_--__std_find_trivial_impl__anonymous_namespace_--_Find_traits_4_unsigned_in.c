/*
 * XREFs of _anonymous_namespace_::__std_find_trivial_impl__anonymous_namespace_::_Find_traits_4_unsigned_int_ @ 0x18009C6B0
 * Callers:
 *     __std_find_trivial_4 @ 0x18009C8E0 (__std_find_trivial_4.c)
 * Callees:
 *     <none>
 */

const __m128i *__fastcall anonymous_namespace_::__std_find_trivial_impl__anonymous_namespace_::_Find_traits_4_unsigned_int_(
        const __m128i *a1,
        const __m128i *a2,
        unsigned int _R8D)
{
  ...
  if ( (((char *)a2 - (char *)a1) & 0xFFFFFFFFFFFFFFE0uLL) != 0 && (_isa_enabled & 0x20) != 0 )
  {
    ...
    do
    {
      __asm
      {
        vpcmpeqd ymm1, ymm3, ymmword ptr [rcx]
        vpmovmskb eax, ymm1
      }
      if ( _EAX )
        goto LABEL_10;
...
LABEL_9:
    ...
    _RAX = (char *)&unk_180202E30 - (v11 & 0xFFFFFFFC);
    __asm
    {
...
LABEL_10:
  ...
  else
  {
    ...
    if ( v19 && (_isa_enabled & 4) != 0 )
    {
      ...
      while ( 1 )
      {
        LODWORD(v22) = _mm_movemask_epi8(_mm_cmpeq_epi32(_mm_loadu_si128(a1), v21));
        if ( (_DWORD)v22 )
          break;
        if ( ++a1 == v20 )
          goto LABEL_16;
