/*
 * XREFs of ?UpdateId@BamoEdgyDragSourceClientProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18012CA54
 * Callers:
 *     ?Thunk_UpdateId_0@?$IEdgyDragSourceClientProxy_Receive@VBamoEdgyDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129530 (-Thunk_UpdateId_0@-$IEdgyDragSourceClientProxy_Receive@VBamoEdgyDragSourceClientProxyImpl@BamoIm.c)
...
{
  char v4; // r14
  BamoEdgyDragSourceClientProxy *v6; // rsi
  int v7; // eax
  int v8; // eax
