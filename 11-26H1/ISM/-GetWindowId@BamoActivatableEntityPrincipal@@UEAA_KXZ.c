/*
 * XREFs of ?GetWindowId@BamoActivatableEntityPrincipal@@UEAA_KXZ @ 0x1800B06C0
 * Callers:
 *     <none>
 * Callees:
...
struct Microsoft::BamoImpl::ConnectionIndirector *__fastcall BamoActivatableEntityPrincipal::GetWindowId(
