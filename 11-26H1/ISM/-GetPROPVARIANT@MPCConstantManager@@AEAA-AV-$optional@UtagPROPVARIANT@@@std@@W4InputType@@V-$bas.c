/*
 * XREFs of ?GetPROPVARIANT@MPCConstantManager@@AEAA?AV?$optional@UtagPROPVARIANT@@@std@@W4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@3@@Z @ 0x1800B41F0
 * Callers:
...
__int64 __fastcall MPCConstantManager::GetPROPVARIANT(__int64 a1, __int64 a2, unsigned int a3, __m128i *a4)
{
  ...
  v9 = std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::find<std::basic_string_view<unsigned short>,std::less<void>,0>(
         *v8 + 40LL,
         &v14,
         a4);
  MPCConstantManager::GetPROPVARIANTFromConstantValue(v10, a2, *(_QWORD *)(*v9 + 64));
  return a2;
}
