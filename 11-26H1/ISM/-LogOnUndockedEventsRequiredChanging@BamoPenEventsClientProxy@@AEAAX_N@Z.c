/*
 * XREFs of ?LogOnUndockedEventsRequiredChanging@BamoPenEventsClientProxy@@AEAAX_N@Z @ 0x180199568
 * Callers:
...
void __fastcall BamoPenEventsClientProxy::LogOnUndockedEventsRequiredChanging(BamoPenEventsClientProxy *this)
{
  __int64 v1; // rcx
  __int64 v2; // r8
  __int64 v3; // r9
