/*
 * XREFs of ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x180090DC0
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__MPC3DStateHelper::s_isInstanceCreatedEvent__ @ 0x1801DDD00 (_dynamic_atexit_destructor_for__MPC3DStateHelper--s_isInstanceCreatedEvent__.c)
 * Callees:
