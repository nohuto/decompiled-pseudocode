/*
 * XREFs of ?Thunk_Materialize_BamoMagnifierControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128EA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
