/*
 * XREFs of ?ResetForNewShellInstance@SystemCursorService2@@UEAAJK@Z @ 0x1800FC5E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorService2::ResetForNewShellInstance(SystemCursorService2 *this, int a2)
{
  ...
  v2 = (SystemCursorService2 *)((char *)this - 8);
  *((_DWORD *)this + 60) = a2;
  ...
  v8 = SystemCursorService2::EnumerateCursorsForShell(v2);
  v9 = v8;
  if ( v8 >= 0 )
    return 0LL;
  wil::details::in1diag3::Return_Hr(
