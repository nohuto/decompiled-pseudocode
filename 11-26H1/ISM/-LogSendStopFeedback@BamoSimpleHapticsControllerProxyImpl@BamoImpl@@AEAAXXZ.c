/*
 * XREFs of ?LogSendStopFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@AEAAXXZ @ 0x18011ED6C
 * Callers:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerProxyImpl::LogSendStopFeedback(
