/*
 * XREFs of ?UpdateHapticDeviceManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18012C164
 * Callers:
 *     ?Thunk_UpdateHapticDeviceManager_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180129470 (-Thunk_UpdateHapticDeviceManager_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
