/*
 * XREFs of ?GetOutline@CRoundedRectangleShape@@UEBAJPEAUID2D1GeometrySink@@@Z @ 0x1800510B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v3 = Outline;
  if ( Outline < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Outline, 0xFBu, 0LL);
  return v3;
}
