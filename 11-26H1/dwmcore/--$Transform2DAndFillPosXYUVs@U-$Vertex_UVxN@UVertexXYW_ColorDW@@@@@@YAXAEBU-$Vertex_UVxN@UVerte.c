/*
 * XREFs of ??$Transform2DAndFillPosXYUVs@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@YAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@IAEBVCMILMatrix@@PEAU0@PEAUD2D_POINT_2F@@@Z @ 0x180007B5C
 * Callers:
  ...
  *a6 = v12;
  ...
  if ( (_DWORD)v8 )
  {
    ...
    do
    {
      ...
      *(float *)((char *)result + v19 + 4) = (float)(v11 * *(float *)((char *)result + v17 + 4))
                                           + (float)(v18 * result[1]);
