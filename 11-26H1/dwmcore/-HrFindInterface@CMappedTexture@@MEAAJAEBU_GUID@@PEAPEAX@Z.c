/*
 * XREFs of ?HrFindInterface@CMappedTexture@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802B4790
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CMappedTexture::HrFindInterface(CMappedTexture *this, const struct _GUID *a2, void **a3)
{
  __int64 result; // rax
  __int64 v4; // rax
  __int64 v5; // rax
