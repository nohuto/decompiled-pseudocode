/*
 * XREFs of ?StartWorkerThread@CComputeScribbleScheduler@@AEAAJXZ @ 0x18025D220
 * Callers:
...
LABEL_3:
  ...
  Thread = CreateThread(
             0LL,
             0LL,
             (LPTHREAD_START_ROUTINE)CComputeScribbleScheduler::StartWorkerThread_::_2_::_lambda_1_::_lambda_invoker_cdecl_,
             this,
             4u,
             0LL);
