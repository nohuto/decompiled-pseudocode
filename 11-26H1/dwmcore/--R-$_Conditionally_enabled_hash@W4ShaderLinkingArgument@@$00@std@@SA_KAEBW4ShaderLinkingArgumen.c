/*
 * XREFs of ??R?$_Conditionally_enabled_hash@W4ShaderLinkingArgument@@$00@std@@SA_KAEBW4ShaderLinkingArgument@@@Z @ 0x18025F4F4
 * Callers:
...
__int64 __fastcall std::_Conditionally_enabled_hash<enum ShaderLinkingArgument,1>::operator()(unsigned __int8 *a1)
{
  return std::_Fnv1a_append_bytes((__int64)a1, a1, 2uLL);
}
