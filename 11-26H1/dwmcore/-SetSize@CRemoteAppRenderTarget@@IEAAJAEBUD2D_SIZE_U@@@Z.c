/*
 * XREFs of ?SetSize@CRemoteAppRenderTarget@@IEAAJAEBUD2D_SIZE_U@@@Z @ 0x1802063B4
 * Callers:
 *     ?ForceFullDirty@CRemoteAppRenderTarget@@UEAAXXZ @ 0x180206340 (-ForceFullDirty@CRemoteAppRenderTarget@@UEAAXXZ.c)
 *     ?ProcessSetSize@CRemoteAppRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_REMOTEAPPRENDERTARGET_SETSIZE@@@Z @ 0x180206398 (-ProcessSetSize@CRemoteAppRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_REMOTEAPPRENDERTA.c)
 * Callees:
