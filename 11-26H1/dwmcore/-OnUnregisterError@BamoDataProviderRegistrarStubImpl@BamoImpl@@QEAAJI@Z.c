/*
 * XREFs of ?OnUnregisterError@BamoDataProviderRegistrarStubImpl@BamoImpl@@QEAAJI@Z @ 0x180241A7C
 * Callers:
...
LABEL_7:
  ...
  v10[1] = v13;
  return CoreUICallSend(v14, v10, 2LL, 3LL, 1, &unk_180373365, a2, v9, v12);
}
