/*
 * XREFs of ?SetTopInset@?$CNineGridBrushGeneratedT@VCNineGridBrush@@VCBrush@@@@QEAAJM@Z @ 0x1801DCEA4
 * Callers:
...
__int64 __fastcall CNineGridBrushGeneratedT<CNineGridBrush,CBrush>::SetTopInset(float *a1, float a2)
{
  ...
  if ( a2 != a1[27] )
  {
    ...
    a1[27] = a2;
    CNineGridBrush::OnTopInsetChanged((CNineGridBrush *)a1);
  }
  return 0LL;
}
