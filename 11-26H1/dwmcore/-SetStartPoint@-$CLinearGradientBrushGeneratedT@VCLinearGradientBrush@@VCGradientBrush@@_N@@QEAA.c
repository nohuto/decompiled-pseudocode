/*
 * XREFs of ?SetStartPoint@?$CLinearGradientBrushGeneratedT@VCLinearGradientBrush@@VCGradientBrush@@_N@@QEAAJUD2D_POINT_2F@@@Z @ 0x1801DBFC4
 * Callers:
...
__int64 __fastcall CLinearGradientBrushGeneratedT<CLinearGradientBrush,CGradientBrush,bool>::SetStartPoint(
        _QWORD *a1,
        __int64 a2)
{
  _QWORD *v3; // rdx
  ...
  v7 = a2;
  if ( (unsigned __int8)operator!=(&v7, a1 + 31) )
  {
    v5 = a1[6] == 0LL;
    *v3 = a2;
    if ( !v5 )
