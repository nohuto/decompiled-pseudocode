/*
 * XREFs of ?ProcessBasicStateUpdate@CInk@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INK_BASICSTATEUPDATE@@@Z @ 0x18019A3F8
 * Callers:
        ...
        const struct tagMILCMD_INK_BASICSTATEUPDATE *a3)
{
  ...
  *((_DWORD *)this + 32) = *((_DWORD *)a3 + 2);
  ...
  for ( i = 0LL; (unsigned int)i < (unsigned int)v6; i = (unsigned int)(i + 1) )
  {
    ...
    ReleaseInterface<ID2D1Geometry>((__int64 *)&v11);
    ReleaseInterface<ID2D1Geometry>((__int64 *)&v12);
  }
