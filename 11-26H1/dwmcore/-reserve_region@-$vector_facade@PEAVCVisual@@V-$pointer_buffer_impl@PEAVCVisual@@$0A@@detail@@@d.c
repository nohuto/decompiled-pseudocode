/*
 * XREFs of ?reserve_region@?$vector_facade@PEAVCVisual@@V?$pointer_buffer_impl@PEAVCVisual@@$0A@@detail@@@detail@@IEAAPEAPEAVCVisual@@_K0@Z @ 0x18002655C
 * Callers:
...
unsigned __int64 __fastcall detail::vector_facade<CVisual *,detail::pointer_buffer_impl<CVisual *,0>>::reserve_region(
        __int64 *a1,
        __int64 a2)
{
  _QWORD *v4; // rbx
  ...
  detail::pointer_buffer_impl<CVisual *,0>::ensure_extra_capacity(a1, 1uLL);
  v17 = detail::vector_facade<CBlurredBackdropCache *,detail::pointer_buffer_impl<CBlurredBackdropCache *,0>>::size(a1);
  v4 = (_QWORD *)detail::pointer_buffer_impl<CVisual *,0>::last(a1);
