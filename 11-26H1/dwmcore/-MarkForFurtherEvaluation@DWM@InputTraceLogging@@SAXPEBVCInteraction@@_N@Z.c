/*
 * XREFs of ?MarkForFurtherEvaluation@DWM@InputTraceLogging@@SAXPEBVCInteraction@@_N@Z @ 0x180228420
 * Callers:
...
void __fastcall InputTraceLogging::DWM::MarkForFurtherEvaluation(const struct CInteraction *a1, unsigned __int8 a2)
{
  int v2; // edi
  ...
  _QWORD *v16; // [rsp+A8h] [rbp+1Fh] BYREF
