/*
 * XREFs of ?IsComputeScribbleSupported@CDDisplaySwapChain@@UEBA_NXZ @ 0x1801D0800
 * Callers:
...
bool __fastcall CDDisplaySwapChain::IsComputeScribbleSupported(CDDisplaySwapChain *this)
{
  __int64 v1; // r8
