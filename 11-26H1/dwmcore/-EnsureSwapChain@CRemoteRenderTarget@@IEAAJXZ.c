/*
 * XREFs of ?EnsureSwapChain@CRemoteRenderTarget@@IEAAJXZ @ 0x180254DC0
 * Callers:
...
__int64 __fastcall CRemoteRenderTarget::EnsureSwapChain(CRemoteRenderTarget *this)
{
  ...
  if ( !v4
    ...
    || *((_BYTE *)this + 2234) && *(_DWORD *)(*((_QWORD *)this + 3) + 6256LL) != 7 )
  {
...
LABEL_20:
    ...
    if ( *((_DWORD *)this + 30) && *((_DWORD *)this + 31) )
    {
      ...
      if ( Device < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, Device, 0x191u, 0LL);
      }
      else
      {
        wil::com_ptr_t<IDXGISwapChain1,wil::err_returncode_policy>::reset(v1);
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, LegacyRemotingSwapChain, 0x197u, 0LL);
        }
        else
        {
    ...
    {
      v3 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024809, 0x19Du, 0LL);
    }
  }
  return v3;
}
