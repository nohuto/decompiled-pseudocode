/*
 * XREFs of ?GetLastMonitorTime@CRemoteRenderTarget@@UEAA_NPEAVMonitorTime@@0_N@Z @ 0x180247620
 * Callers:
 *     <none>
 * Callees:
        ...
        struct MonitorTime *a3)
{
  ...
  v6 = *((_QWORD *)this + 4);
  if ( !v6 || (*(unsigned int (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v6 + 176LL))(v6, v11) )
    return 0;
  v7 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 4) + 168LL))(*((_QWORD *)this + 4));
  *(_QWORD *)a2 = v13;
  *((_DWORD *)a2 + 4) = v12;
  v8 = v15;
  *((_QWORD *)a2 + 1) = v7;
