/*
 * XREFs of ?NotifyCurrentPropertyValues@CRectangleGeometry@@MEBAJI@Z @ 0x180183930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRectangleGeometry::NotifyCurrentPropertyValues(CRectangleGeometry *this)
{
