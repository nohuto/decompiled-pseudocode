/*
 * XREFs of ??$IsPure2DUniformZ@$0A@@CMILMatrix@@AEBA_NXZ @ 0x180167050
 * Callers:
...
char __fastcall CMILMatrix::IsPure2DUniformZ<0>(__int64 a1)
{
  ...
  if ( (char)(16 * v1) >> 6 != 0xFE )
  {
    ...
    if ( (char)(4 * v1) >> 6 == 0xFE )
    {
      v3 = (float)(COERCE_FLOAT(*(_DWORD *)(a1 + 44) & _xmm) * 61440.0) == 0.0;
    }
    else
    {
      ...
      v3 = v2 & ((float)(COERCE_FLOAT(*(_DWORD *)(a1 + 44) & _xmm) * 61440.0) == 0.0);
    }
    if ( !v3 || *(float *)(a1 + 32) != 0.0 || *(float *)(a1 + 36) != 0.0 )
      return 0;
    ...
    if ( (char)(4 * v6) >> 6 != 1 )
    {
      if ( (char)(4 * v6) >> 6 != 0xFE )
      {
        if ( (float)((float)((float)(COERCE_FLOAT(*(_DWORD *)(a1 + 28) & _xmm) * 61440.0)
                   ...
                   + COERCE_FLOAT(*(_DWORD *)(a1 + 60) & _xmm)) != 1.0 )
          return 0;
        *(_BYTE *)(a1 + 65) = v6 & 0xCF ^ 0x20;
      }
      if ( *(float *)(a1 + 8) == 0.0 && *(float *)(a1 + 24) == 0.0 )
      {
        *(_BYTE *)(a1 + 64) = v5 & 0xF3 ^ 8;
        return 1;
      }
    }
    return 0;
