/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@UVertexConstantBufferData@@@@QEAAJPEAVCD3DDevice@@W4D3D11_USAGE@@@Z @ 0x18011ABC0
 * Callers:
...
__int64 __fastcall CTypedConstantBuffer<VertexConstantBufferData>::Initialize(__int64 a1, struct CD3DDevice *a2)
{
  ...
  if ( !*(_QWORD *)a1 )
  {
    *(_QWORD *)&v6.ByteWidth = 128LL;
    v5.pSysMem = (const void *)(a1 + 16);
    *(_QWORD *)&v6.BindFlags = 4LL;
    *(_QWORD *)&v6.MiscFlags = 0LL;
