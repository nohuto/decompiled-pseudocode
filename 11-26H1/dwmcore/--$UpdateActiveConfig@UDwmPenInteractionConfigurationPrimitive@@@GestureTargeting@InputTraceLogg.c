/*
 * XREFs of ??$UpdateActiveConfig@UDwmPenInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXAEBUDwmPenInteractionConfigurationPrimitive@@@Z @ 0x1801A63EC
 * Callers:
...
__int64 __fastcall InputTraceLogging::GestureTargeting::UpdateActiveConfig<DwmPenInteractionConfigurationPrimitive>(
        __int64 a1)
{
  __int64 result; // rax
  __int64 v3; // r9
