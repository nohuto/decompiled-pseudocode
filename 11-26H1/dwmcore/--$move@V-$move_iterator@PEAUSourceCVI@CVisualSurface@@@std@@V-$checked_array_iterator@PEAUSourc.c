/*
 * XREFs of ??$move@V?$move_iterator@PEAUSourceCVI@CVisualSurface@@@std@@V?$checked_array_iterator@PEAUSourceCVI@CVisualSurface@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAUSourceCVI@CVisualSurface@@@stdext@@V?$move_iterator@PEAUSourceCVI@CVisualSurface@@@0@0V12@@Z @ 0x1801B1CF8
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  while ( a2 != a3 )
  {
    wil::com_ptr_t<IBitmapLock,wil::err_returncode_policy>::operator=(v8, a2);
    v8[1] = a2[1];
    v8 += 2;
    a2 += 2;
  }
