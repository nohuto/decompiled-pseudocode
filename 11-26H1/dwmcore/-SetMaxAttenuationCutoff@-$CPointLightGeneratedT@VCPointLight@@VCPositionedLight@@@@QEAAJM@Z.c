/*
 * XREFs of ?SetMaxAttenuationCutoff@?$CPointLightGeneratedT@VCPointLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024C048
 * Callers:
...
__int64 __fastcall CPointLightGeneratedT<CPointLight,CPositionedLight>::SetMaxAttenuationCutoff(
