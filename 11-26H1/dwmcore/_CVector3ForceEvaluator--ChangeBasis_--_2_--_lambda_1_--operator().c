/*
 * XREFs of _CVector3ForceEvaluator::ChangeBasis_::_2_::_lambda_1_::operator() @ 0x18028E994
 * Callers:
...
struct D2DVector3 *__fastcall CVector3ForceEvaluator::ChangeBasis_::_2_::_lambda_1_::operator()(
        __int64 *a1,
        int *a2,
        int *a3,
        int *a4)
