/*
 * XREFs of ?CheckOcclusionState@CDDARenderTarget@@UEAAJ_N@Z @ 0x1801A4A70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !v3 || (int)CDDASwapChain::IsValid(v3) < 0 )
  {
    ...
    if ( *((_DWORD *)this + 6) )
    {
      if ( *((_DWORD *)this + 7) )
      {
        ...
        {
          wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::reset((__int64 *)&v9);
          ...
          if ( Device < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, Device, 0x7Bu, 0LL);
          }
          else
          {
            wil::com_ptr_t<CDDASwapChain,wil::err_returncode_policy>::reset(v1);
            ...
            if ( DDASwapChain < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, DDASwapChain, 0x81u, 0LL);
            else
