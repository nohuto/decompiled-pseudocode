/*
 * XREFs of ?TraceSwapChainTelemetry@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAXXZ @ 0x18012BF80
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  if ( *((_QWORD *)this + 36) )
  {
    ...
    if ( (unsigned int)dword_1803DC810 > 5
      && (qword_1803DC820 & 0x400000000000LL) != 0
      && (qword_1803DC828 & 0x400000000000LL) == qword_1803DC828 )
    {
      v12 = *((_DWORD *)this + 53);
      v5 = *((_QWORD *)this + 35);
      v6 = *((_QWORD *)this + 33);
