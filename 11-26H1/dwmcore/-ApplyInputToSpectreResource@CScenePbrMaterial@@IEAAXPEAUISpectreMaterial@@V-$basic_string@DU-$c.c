/*
 * XREFs of ?ApplyInputToSpectreResource@CScenePbrMaterial@@IEAAXPEAUISpectreMaterial@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCSceneSurfaceMaterialInput@@@Z @ 0x180280E00
 * Callers:
...
void __fastcall CScenePbrMaterial::ApplyInputToSpectreResource(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( v9 )
    {
      CSceneResourceManager::GetSpectreTexture(*(CSceneResourceManager **)(*(_QWORD *)(a1 + 24) + 672LL), v9, &v12);
      v4 = v12;
    }
    v8 = *(_QWORD *)(a4 + 80);
  }
