/*
 * XREFs of ?ProcessSetSharedSectionId@CCrossContainerGuestReadWriteSharedSection@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_CROSSCONTAINERGUESTREADWRITESHAREDSECTION_SETSHAREDSECTIONID@@@Z @ 0x18021F6DC
 * Callers:
