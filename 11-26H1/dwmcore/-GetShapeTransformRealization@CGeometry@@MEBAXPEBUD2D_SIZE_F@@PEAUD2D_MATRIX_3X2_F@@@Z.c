/*
 * XREFs of ?GetShapeTransformRealization@CGeometry@@MEBAXPEBUD2D_SIZE_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801860F0
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( a2 )
    v3 = (__int64)*a2;
  (*(void (__fastcall **)(_QWORD, __int64 *, struct D2D_MATRIX_3X2_F *))(**((_QWORD **)this + 10) + 216LL))(
    *((_QWORD *)this + 10),
    &v3,
    a3);
}
