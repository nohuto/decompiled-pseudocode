/*
 * XREFs of ?SetThickness@?$CCompositionTextLineGeneratedT@VCCompositionTextLine@@VCTextObject@@@@QEAAJM@Z @ 0x18024ED60
 * Callers:
...
__int64 __fastcall CCompositionTextLineGeneratedT<CCompositionTextLine,CTextObject>::SetThickness(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 104) )
  {
    *(float *)(a1 + 104) = a2;
