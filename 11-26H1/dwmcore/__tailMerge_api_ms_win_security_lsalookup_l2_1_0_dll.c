/*
 * XREFs of __tailMerge_api_ms_win_security_lsalookup_l2_1_0_dll @ 0x1802222EF
 * Callers:
 *     __imp_load_LookupPrivilegeValueW @ 0x18022236E (__imp_load_LookupPrivilegeValueW.c)
 * Callees:
