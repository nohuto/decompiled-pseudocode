/*
 * XREFs of ?SetCenterZ@?$CScaleTransform3DGeneratedT@VCScaleTransform3D@@VCTransform3D@@@@QEAAJM@Z @ 0x18024A618
 * Callers:
...
__int64 __fastcall CScaleTransform3DGeneratedT<CScaleTransform3D,CTransform3D>::SetCenterZ(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 180) )
  {
    *(float *)(a1 + 180) = a2;
