/*
 * XREFs of ?GetProperty@CLineGeometry@@UEAAJUDCOMPOSITION_PROPERTY_ID@@PEAVCExpressionValue@@@Z @ 0x18027A9A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLineGeometry::GetProperty(__int64 a1, int a2)
{
  unsigned int v2; // ebx
  ...
  v9[0] = 2LL;
  v9[1] = &CLineGeometry::k_rgAnimDef;
  v2 = 0;
