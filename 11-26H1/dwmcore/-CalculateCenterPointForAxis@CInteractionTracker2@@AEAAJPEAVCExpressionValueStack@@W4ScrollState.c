/*
 * XREFs of ?CalculateCenterPointForAxis@CInteractionTracker2@@AEAAJPEAVCExpressionValueStack@@W4ScrollState@@W4ScrollAxis@@PEAM@Z @ 0x180271EA8
 * Callers:
...
__int64 __fastcall CInteractionTracker2::CalculateCenterPointForAxis(
        __int64 a1,
        ...
        float *a5)
{
  ...
  if ( a3 == 1 )
  {
    SourceCenterpointModifierForActiveManipulation = InteractionSourceManager::GetSourceCenterpointModifierForActiveManipulation((InteractionSourceManager *)(a1 + 528));
  }
  else
  {
    if ( a3 != 2 )
...
LABEL_10:
    ...
    else if ( a3 == 1 && InteractionSourceManager::HasActiveManipulation((InteractionSourceManager *)(a1 + 528)) )
    {
...
LABEL_26:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x162Eu, 0LL);
  return v13;
}
