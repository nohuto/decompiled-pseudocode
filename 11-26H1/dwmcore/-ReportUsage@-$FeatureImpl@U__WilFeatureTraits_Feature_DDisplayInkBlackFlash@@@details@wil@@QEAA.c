/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DDisplayInkBlackFlash@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18025469C
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_DDisplayInkBlackFlash>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_DDisplayInkBlackFlash>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v7);
    v7 = v3;
  }
