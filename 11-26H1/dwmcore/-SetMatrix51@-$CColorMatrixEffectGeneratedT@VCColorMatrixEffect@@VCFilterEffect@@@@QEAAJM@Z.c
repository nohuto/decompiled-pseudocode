/*
 * XREFs of ?SetMatrix51@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BF08
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix51(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 416) )
  {
    *(float *)(a1 + 416) = a2;
