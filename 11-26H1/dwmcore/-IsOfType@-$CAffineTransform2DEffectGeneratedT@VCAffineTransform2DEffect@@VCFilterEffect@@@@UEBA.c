/*
 * XREFs of ?IsOfType@?$CAffineTransform2DEffectGeneratedT@VCAffineTransform2DEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180248CC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CAffineTransform2DEffectGeneratedT<CAffineTransform2DEffect,CFilterEffect>::IsOfType(
        __int64 a1,
        int a2)
{
  char v2; // al
