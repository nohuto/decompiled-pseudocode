/*
 * XREFs of ??1_Reallocation_guard@?$vector@V?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@V?$allocator@V?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1802A4FEC
 * Callers:
...
void __fastcall std::vector<std::unique_ptr<CAtlasTexture>>::_Reallocation_guard::~_Reallocation_guard(__int64 a1)
{
  if ( *(_QWORD *)(a1 + 8) )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CAtlasTexture>>>(*(_QWORD *)(a1 + 24), *(_QWORD *)(a1 + 32));
