/*
 * XREFs of ?RegGetDwmDwordHelper@@YA_NPEBGPEAKW4DwmRegistrySubkey@@@Z @ 0x1801CAAC8
 * Callers:
 *     _dynamic_initializer_for__CCommonRegistryData::GameAreaScreenRatio__ @ 0x1800079D0 (_dynamic_initializer_for__CCommonRegistryData--GameAreaScreenRatio__.c)
