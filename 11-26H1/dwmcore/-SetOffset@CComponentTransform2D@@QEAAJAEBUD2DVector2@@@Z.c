/*
 * XREFs of ?SetOffset@CComponentTransform2D@@QEAAJAEBUD2DVector2@@@Z @ 0x1801BBD10
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetOffset(CComponentTransform2D *this, const struct D2DVector2 *a2)
{
  return ((__int64 (__fastcall *)(CComponentTransform2D *, void *, const struct D2DVector2 *))off_1803DC068)(
           this,
