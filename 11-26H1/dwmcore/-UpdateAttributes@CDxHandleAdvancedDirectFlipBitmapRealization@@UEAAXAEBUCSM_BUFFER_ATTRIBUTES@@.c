/*
 * XREFs of ?UpdateAttributes@CDxHandleAdvancedDirectFlipBitmapRealization@@UEAAXAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x1801BD820
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSM_BUFFER_ATTRIBUTES *a2)
{
  ...
  v2 = *((_DWORD *)this - 44);
  v3 = (char *)this - 248;
  (*(void (__fastcall **)(char *, int *))(*((_QWORD *)this - 31) + 56LL))((char *)this - 248, &v11);
  ...
  if ( v6 )
  {
    ...
    v7 = (_DWORD *)(*(__int64 (__fastcall **)(char *, char *))(*(_QWORD *)v3 + 56LL))(v3, &v12);
    if ( v11 != *v7 )
    {
      v8 = *((_QWORD *)this + 10);
      v9 = *(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(v8 + 16) + 152LL);
      v10 = (unsigned int *)(*(__int64 (__fastcall **)(char *, char *))(*(_QWORD *)v3 + 56LL))(v3, &v12);
      v9(v8 + 16, *v10);
    }
  }
}
