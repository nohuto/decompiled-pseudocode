/*
 * XREFs of ?EnsureFlipAwayFenceForPlane@CLegacySwapChain@@UEAAJIPEAUtagCOMPOSITION_TARGET_FLIP_AWAY_FENCE@@@Z @ 0x1802A5BA0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tagCOMPOSITION_TARGET_FLIP_AWAY_FENCE *a3)
{
  ...
  const unsigned __int8 *v21; // [rsp+30h] [rbp-30h] BYREF
...
LABEL_6:
  ...
  *(_QWORD *)a3 = *(_QWORD *)(*(__int64 (__fastcall **)(CLegacySwapChain *, __int64 *))(*(_QWORD *)this + 232LL))(
                               this,
                               &v25);
