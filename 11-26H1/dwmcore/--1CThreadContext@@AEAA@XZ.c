/*
 * XREFs of ??1CThreadContext@@AEAA@XZ @ 0x18028C1D8
 * Callers:
...
{
  CObjectCache::Destroy((CThreadContext *)((char *)this + 432));
  CObjectCache::Destroy((CThreadContext *)((char *)this + 416));
  CObjectCache::Destroy((CThreadContext *)((char *)this + 400));
  ...
  detail::vector_facade<void const *,detail::pointer_buffer_impl<void const *,0>>::~vector_facade<void const *,detail::pointer_buffer_impl<void const *,0>>((__int64 *)this + 4);
}
