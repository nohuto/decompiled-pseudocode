/*
 * XREFs of ??1?$com_ptr_t@VCDrawListEntryBatch@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x180138778
 * Callers:
...
__int64 __fastcall wil::com_ptr_t<CDrawListEntryBatch,wil::err_returncode_policy>::~com_ptr_t<CDrawListEntryBatch,wil::err_returncode_policy>(
    ...
    if ( !v2 )
    {
      if ( _InterlockedAdd(v1 + 2, 1u) <= 0 )
        wil::details::in1diag3::Log_Hr(
          ...
          (const char *)0x8007029CLL,
          v5);
      result = (*(__int64 (__fastcall **)(volatile signed __int32 *))(*(_QWORD *)v1 + 40LL))(v1);
      ...
      if ( !v4 )
      {
        if ( _InterlockedDecrement(v1 + 2) < -1 )
          wil::details::in1diag3::Log_Hr(
            ...
            (const char *)0x8007029CLL,
            v5);
        return (*(__int64 (__fastcall **)(volatile signed __int32 *, __int64))(*(_QWORD *)v1 + 32LL))(v1, 1LL);
      }
    }
  }
  return result;
