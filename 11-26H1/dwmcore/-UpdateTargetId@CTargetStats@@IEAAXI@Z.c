/*
 * XREFs of ?UpdateTargetId@CTargetStats@@IEAAXI@Z @ 0x180149090
 * Callers:
  ...
  *((_DWORD *)this + 6) = a2;
  ...
  if ( v3 )
  {
    *((_QWORD *)this + 1) = *(_QWORD *)((*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v3 + 40LL))(v3, 0LL)
                                      + 944);
    *(_QWORD *)this = *(_QWORD *)(*(__int64 (__fastcall **)(_QWORD, char *))(**((_QWORD **)this + 4) + 232LL))(
                                   *((_QWORD *)this + 4),
                                   &v7);
    v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 4) + 240LL))(*((_QWORD *)this + 4));
    v6 = *((_QWORD *)this + 4);
    *((_DWORD *)this + 4) = v5;
    v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v6 + 248LL))(v6);
  }
  else
  {
    *((_QWORD *)this + 1) = 0LL;
