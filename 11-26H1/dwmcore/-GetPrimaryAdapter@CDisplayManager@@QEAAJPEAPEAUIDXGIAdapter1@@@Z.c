/*
 * XREFs of ?GetPrimaryAdapter@CDisplayManager@@QEAAJPEAPEAUIDXGIAdapter1@@@Z @ 0x180128E34
 * Callers:
...
__int64 __fastcall CDisplayManager::GetPrimaryAdapter(CDisplayManager *this, struct IDXGIAdapter1 **a2)
{
  ...
  *a2 = 0LL;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1802F59C0, 2u, v5, v7, 0LL);
