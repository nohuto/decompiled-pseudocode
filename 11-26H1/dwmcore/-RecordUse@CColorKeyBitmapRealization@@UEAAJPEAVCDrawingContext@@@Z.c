/*
 * XREFs of ?RecordUse@CColorKeyBitmapRealization@@UEAAJPEAVCDrawingContext@@@Z @ 0x1801B74C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorKeyBitmapRealization::RecordUse(CColorKeyBitmapRealization *this, struct CDrawingContext *a2)
{
  ...
  v4 = *(_QWORD *)this;
  v9 = 0LL;
  v5 = (*(__int64 (__fastcall **)(CColorKeyBitmapRealization *, __int64, __int64 *))(v4 + 104))(this, v3, &v9);
  v6 = v5;
  if ( v5 < 0 )
  {
