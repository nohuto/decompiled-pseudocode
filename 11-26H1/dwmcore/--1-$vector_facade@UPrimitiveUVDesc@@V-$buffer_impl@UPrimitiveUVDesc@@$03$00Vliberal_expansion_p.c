/*
 * XREFs of ??1?$vector_facade@UPrimitiveUVDesc@@V?$buffer_impl@UPrimitiveUVDesc@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA@XZ @ 0x18016CDE8
 * Callers:
        ...
        __int64 *a1)
{
  ...
  v1 = 0LL;
  v2 = a1;
  v3 = 0x6DB6DB6DB6DB6DB7LL * ((a1[1] - *a1) >> 3);
  if ( v3 )
  {
