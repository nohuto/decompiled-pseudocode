...
__int64 *__fastcall std::_Uninitialized_move<wil::com_ptr_t<ISwapChainRealization,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<ISwapChainRealization,wil::err_returncode_policy>>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
  ...
  std::_Destroy_range<std::allocator<wil::com_ptr_t<CCachedTexture,wil::err_returncode_policy>>>(a3, a3);
  return a3;
}
