/*
 * XREFs of ?SetCenterX@?$CScaleTransform3DGeneratedT@VCScaleTransform3D@@VCTransform3D@@@@QEAAJM@Z @ 0x18024A018
 * Callers:
...
__int64 __fastcall CScaleTransform3DGeneratedT<CScaleTransform3D,CTransform3D>::SetCenterX(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 172) )
  {
    *(float *)(a1 + 172) = a2;
