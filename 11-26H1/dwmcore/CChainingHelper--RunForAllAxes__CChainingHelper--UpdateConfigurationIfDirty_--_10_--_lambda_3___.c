/*
 * XREFs of CChainingHelper::RunForAllAxes__CChainingHelper::UpdateConfigurationIfDirty_::_10_::_lambda_3___ @ 0x18013BE08
 * Callers:
...
__int64 __fastcall CChainingHelper::RunForAllAxes__CChainingHelper::UpdateConfigurationIfDirty_::_10_::_lambda_3___(
        __int64 a1,
        __int64 *a2)
{
  int v2; // ebx
  ...
  do
  {
    ...
    TemporaryConfigurationAxis = anonymous_namespace_::GetTemporaryConfigurationAxis(
                                   ...
                                   *(unsigned int *)(v4 + *a2 + 4),
                                   v5);
    result = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)(v7 + 72) + 200LL))(
               v7 + 72,
