/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x18011E3A4
 * Callers:
        ...
        unsigned __int64 *a2)
{
  ...
  v10 = _mm_movelh_ps((__m128)a2[6], (__m128)_mm_load_si128((const __m128i *)&_xmm));
  if ( v5 )
  {
    do
    {
      ...
      *v16 = _mm_or_ps(
      ...
      if ( v8 )
      {
        ...
        do
        {
          *(_OWORD *)result = *(_OWORD *)(result + v20);
          result += 16LL;
          --v19;
        }
        while ( v19 );
