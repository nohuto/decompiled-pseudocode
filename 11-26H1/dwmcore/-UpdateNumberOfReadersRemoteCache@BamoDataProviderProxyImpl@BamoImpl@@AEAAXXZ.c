/*
 * XREFs of ?UpdateNumberOfReadersRemoteCache@BamoDataProviderProxyImpl@BamoImpl@@AEAAXXZ @ 0x180244D24
 * Callers:
 *     ?SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z @ 0x180244CD0 (-SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z.c)
 *     ?PushStateToPrincipal@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ @ 0x180251C10 (-PushStateToPrincipal@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ.c)
 * Callees:
        ...
        BamoImpl::BamoDataProviderProxyImpl *this)
{
  ...
  if ( !Microsoft::BamoImpl::BamoProxyImpl::IsDisconnected(this) )
  {
    ...
    v13[1] = v7;
    v10 = CoreUICallSend(v9, v13, 2LL, 0LL, 6, &unk_180373365, v6, v12, v8);
