/*
 * XREFs of ?SetBlueDisable@?$CTableTransferEffectGeneratedT@VCTableTransferEffect@@VCFilterEffect@@@@QEAAJ_N@Z @ 0x18024A270
 * Callers:
...
__int64 __fastcall CTableTransferEffectGeneratedT<CTableTransferEffect,CFilterEffect>::SetBlueDisable(
        __int64 a1,
        char a2)
{
  if ( a2 != *(_BYTE *)(a1 + 354) )
