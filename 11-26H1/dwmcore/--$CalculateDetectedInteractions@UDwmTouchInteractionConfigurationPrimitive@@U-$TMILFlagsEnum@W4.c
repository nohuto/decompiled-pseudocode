/*
 * XREFs of ??$CalculateDetectedInteractions@UDwmTouchInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@CInteractionProcessor@@QEAAJPEAV?$CInputTypeContext@UDwmTouchInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@PEAUIInteractionContextWrapper@@PEAUInteractionAxisGroup@@PEAH23@Z @ 0x18017D500
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  __int64 v40; // rax
  __int64 v41; // rsi
  const struct D2DMatrix *v42; // rcx
  ...
  *a7 = 0;
  ...
  if ( (v7[16] & 3) != 0 )
  {
    ...
    *(_QWORD *)&v63 = 1065353216LL;
    ...
    if ( v22 > *(_DWORD *)(a4 + 28) )
    {
      v48 = DynArrayImpl<0>::AddMultipleAndSet(a4 + 8, 16, 1, &v63);
      v9 = v48;
      if ( v48 < 0 )
      {
LABEL_93:
    ...
    {
      v13 = 2 * v21;
      *(_OWORD *)(*(_QWORD *)(a4 + 8) + 16LL * v21) = v63;
      *(_DWORD *)(a4 + 32) = v22;
    }
    v23 = v61;
    v19 = 1;
  ...
  if ( !v17 || (v7[16] & 8) != 0 )
  {
    ...
    *(_QWORD *)((char *)&v63 + 4) = 1065353216LL;
    if ( !(unsigned int)D2DMatrixIsIdentity((const struct D2DMatrix *)(a1 + 976)) )
    {
      v50 = D3DXVec3TransformCoord((struct D2DVector3 *)&v63, (const struct D2DVector3 *)v57, v24);
    ...
    if ( v25 + 1 >= v25 )
    {
      ...
      {
        v13 = 2 * v25;
        *(_OWORD *)(*(_QWORD *)(a4 + 8) + 16LL * v25) = v63;
        *(_DWORD *)(a4 + 32) = v26;
LABEL_19:
        v23 = v61;
        v27 = 1;
      ...
      *(_QWORD *)v57 = 3LL;
      ...
      while ( v19 )
      {
        ...
        if ( magic::VectorInsideAngleThreshold(
               (magic *)(v36 + 16LL * (unsigned int)v34),
               (const struct D2DVector3 *)(v36 + 16LL * (unsigned int)v60),
               (const struct D2DVector3 *)v14) )
        {
          *(_DWORD *)(a1 + 812) |= *(_DWORD *)(v36 + v35 + 12);
        }
        v19 = *(_DWORD *)(a1 + 812) != 7;
        if ( v27 )
          goto LABEL_49;
...
LABEL_54:
          v39 = *(_QWORD *)(a4 + 8);
          if ( magic::VectorInsideAngleThreshold(
                 (magic *)(v39 + 16LL * (unsigned int)v14),
                 (const struct D2DVector3 *)(v39 + 16LL * (unsigned int)v60),
                 (const struct D2DVector3 *)v14) )
          {
            *(_DWORD *)(a1 + 820) |= *(_DWORD *)(v39 + v35 + 12);
          }
...
LABEL_49:
      ...
      if ( magic::VectorInsideAngleThreshold(
             ...
             (const struct D2DVector3 *)v14) )
      {
        *(_DWORD *)(a1 + 816) |= *(_DWORD *)(v38 + v35 + 12);
      }
      v27 = *(_DWORD *)(a1 + 816) != 7;
      goto LABEL_52;
    }
...
LABEL_59:
  ...
  if ( !(unsigned int)D2DMatrixIsIdentity((const struct D2DMatrix *)(a1 + 976)) )
  {
    v51 = D3DXVec3TransformCoord((struct D2DVector3 *)&v63, (const struct D2DVector3 *)v59, v42);
  ...
  {
    v9 = 0;
    if ( v44 > *(_DWORD *)(v41 + 20) )
    {
      v46 = DynArrayImpl<0>::AddMultipleAndSet(v41, 16, 1, &v63);
      v9 = v46;
      if ( v46 < 0 )
      {
    ...
    {
      v13 = 2 * v43;
      *(_OWORD *)(*(_QWORD *)v41 + 16LL * v43) = v63;
      *(_DWORD *)(v41 + 24) = v44;
    }
    v31 = a7;
    ++*a7;
