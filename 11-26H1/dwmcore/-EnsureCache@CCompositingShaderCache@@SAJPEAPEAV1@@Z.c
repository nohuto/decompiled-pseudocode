/*
 * XREFs of ?EnsureCache@CCompositingShaderCache@@SAJPEAPEAV1@@Z @ 0x180153914
 * Callers:
...
{
  struct CCompositingShaderCache *v1; // rax
  __int64 v3; // rdx
  wil::details::in1diag3 *retaddr; // [rsp+28h] [rbp+0h]

  v1 = (struct CCompositingShaderCache *)g_spCompositingShaderCache;
  if ( g_spCompositingShaderCache )
    goto LABEL_8;
  v1 = (struct CCompositingShaderCache *)MIDL_user_allocate(0x20uLL);
  if ( v1 )
  {
    *((_QWORD *)v1 + 2) = 0LL;
    *(_QWORD *)v1 = 0LL;
