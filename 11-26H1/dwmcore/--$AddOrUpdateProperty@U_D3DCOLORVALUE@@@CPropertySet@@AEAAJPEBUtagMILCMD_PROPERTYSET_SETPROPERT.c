/*
 * XREFs of ??$AddOrUpdateProperty@U_D3DCOLORVALUE@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBU_D3DCOLORVALUE@@@Z @ 0x180168C58
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<_D3DCOLORVALUE>(__int64 a1, __int64 a2, __int64 a3)
{
  int updated; // eax
  unsigned int v6; // ebx
  int v8; // ebx
  ...
  if ( !*(_BYTE *)(a2 + 20) )
  {
    ...
    updated = CPropertySet::UpdateProperty<_D3DCOLORVALUE>(a1, *(unsigned int *)(a2 + 8));
    v6 = updated;
    if ( updated >= 0 )
      return 0;
    v9 = 338;
