/*
 * XREFs of ?ReleaseResource@?$CDeviceResourceTable@VCD3DPixelShader@@VCLinkedShader@@@@AEAAXPEBVIDeviceResource@@@Z @ 0x18014521C
 * Callers:
 *     ?NotifyInvalidResource@?$CDeviceResourceTable@VCD3DPixelShader@@VCLinkedShader@@@@EEAAXPEBVIDeviceResource@@@Z @ 0x180144FC0 (-NotifyInvalidResource@-$CDeviceResourceTable@VCD3DPixelShader@@VCLinkedShader@@@@EEAAXPEBVIDevi.c)
 * Callees:
...
__int64 __fastcall CDeviceResourceTable<CD3DPixelShader,CLinkedShader>::ReleaseResource(__int64 a1, __int64 a2)
{
  __int64 *v2; // rsi
  _QWORD *v4; // rbx
  __int64 v6; // rbx
