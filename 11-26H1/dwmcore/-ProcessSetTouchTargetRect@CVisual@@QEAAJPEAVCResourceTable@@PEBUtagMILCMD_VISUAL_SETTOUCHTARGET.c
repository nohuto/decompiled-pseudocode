/*
 * XREFs of ?ProcessSetTouchTargetRect@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETTOUCHTARGETRECT@@@Z @ 0x1801105B8
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETTOUCHTARGETRECT *a3)
{
  ...
  *(float *)&v18.m128i_i32[3] = v8;
  ...
  v9 = (struct CSparseStorage::AllocatedStorage **)((char *)this + 216);
  v10 = *((_QWORD *)this + 27);
  v11 = *(_DWORD *)(v10 + 4);
  if ( (v11 & 0x100000) != 0 )
  {
  ...
  if ( (v4.m128_f32[0] != v5 || v12 != v7 || v13 != v6 || v14 != v8)
    ...
    && ((v4.m128_f32[0] > -3.4028235e38 || v13 < 3.4028235e38) && (v12 > -3.4028235e38 || v14 < 3.4028235e38)
     || !TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::IsInfinite((float *)v18.m128i_i32)) )
  {
    v15 = v18.m128i_i64[0] - `CVisual::SetTouchTargetBounds'::`2'::sc_defaultValue;
    if ( v18.m128i_i64[0] == `CVisual::SetTouchTargetBounds'::`2'::sc_defaultValue )
