/*
 * XREFs of ?RevalidationCleanup@CManipulationContext@@CAXHPEAUMCCollections@@PEAV?$CQueue@PEAVCResource@@@@@Z @ 0x1801A4B58
 * Callers:
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(v8 + 28) & 4) != 0 )
      {
        ...
        else
        {
          ...
          {
            Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease((__int64 *)(v13 + 8LL * v3));
            v14 = *(_DWORD *)(v4 + 32);
            if ( v7 != v14 )
            {
