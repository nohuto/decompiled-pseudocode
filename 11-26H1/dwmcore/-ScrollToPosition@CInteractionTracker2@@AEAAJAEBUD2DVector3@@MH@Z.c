/*
 * XREFs of ?ScrollToPosition@CInteractionTracker2@@AEAAJAEBUD2DVector3@@MH@Z @ 0x180275544
 * Callers:
...
__int64 __fastcall CInteractionTracker2::ScrollToPosition(
        ...
        float a3)
{
  int v5; // xmm1_4
  __int64 v6; // rax
  __int64 (__fastcall *v7)(CInteractionTracker2 *, __int64, __int64, _DWORD *, _DWORD, struct CResource **); // rax
  int v8; // eax
  unsigned int v9; // edi
  ...
  *((_DWORD *)this + 131) = 0;
  ...
  v15[1] = v5;
  v16 = 0LL;
  v7 = *(__int64 (__fastcall **)(CInteractionTracker2 *, __int64, __int64, _DWORD *, _DWORD, struct CResource **))(v6 + 216);
  v14 = 0LL;
  v8 = v7(this, 66LL, 52LL, v15, LODWORD(a3), &v14);
  v9 = v8;
  if ( v8 >= 0 )
  {
    ...
    v12 = v14;
    v14 = 0LL;
    Microsoft::WRL::ComPtr<CScrollScaleKeyframeAnimation>::Attach((__int64 *)this + 98, (__int64)v12);
    v13 = v14;
    if ( v14 )
    {
      v14 = 0LL;
