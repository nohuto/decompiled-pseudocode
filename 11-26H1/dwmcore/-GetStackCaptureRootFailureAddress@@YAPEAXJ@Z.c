/*
 * XREFs of ?GetStackCaptureRootFailureAddress@@YAPEAXJ@Z @ 0x180219834
 * Callers:
...
__int64 __fastcall GetStackCaptureRootFailureAddress(int a1)
{
  ...
  if ( g_nCurrentStackCaptureIndex >= 0 )
  {
    ...
    do
    {
      if ( g_StackCaptureFrames[14 * v6] != a1 || g_StackCaptureFrames[14 * v6 + 1] != CurrentThreadId )
        break;
      v3 = v5;
      if ( v5 )
      {
    ...
    if ( v3 >= 0 )
      return *(_QWORD *)&g_StackCaptureFrames[14 * v3 + 6];
  }
  return v2;
}
