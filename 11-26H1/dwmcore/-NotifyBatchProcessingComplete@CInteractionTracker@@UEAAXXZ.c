/*
 * XREFs of ?NotifyBatchProcessingComplete@CInteractionTracker@@UEAAXXZ @ 0x18013B070
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CInteractionTracker::NotifyBatchProcessingComplete(CInteractionTracker *this)
{
  char *v1; // rbx
  __int64 *v2; // rsi
  ...
  if ( *((_BYTE *)this + 408) )
  {
    v2 = (__int64 *)((char *)this + 368);
    if ( *((_QWORD *)this + 50) > 1uLL )
    {
      v13 = 0LL;
      for ( i = 0LL; i < *((_QWORD *)this + 50); ++i )
      {
        v6 = (__int64 *)(*(_QWORD *)(*((_QWORD *)this + 47)
                                   + 8 * ((*((_QWORD *)this + 48) - 1LL) & ((i + *((_QWORD *)this + 49)) >> 1)))
                       + 8LL * (((_DWORD)i + *((_DWORD *)this + 98)) & 1));
        if ( *(_DWORD *)(*v6 + 428) == 2 )
        {
...
LABEL_16:
            ...
            v11[1] = 0LL;
            v11[2] = v9 + i;
            std::deque<wil::com_ptr_t<CManipulation,wil::err_returncode_policy>>::erase(v1 + 72, v12, v11);
      ...
      for ( i = 0LL; i < *((_QWORD *)v1 + 13); ++i )
      {
        v7 = (__int64 *)(*(_QWORD *)(*((_QWORD *)v1 + 10)
                                   + 8 * ((*((_QWORD *)v1 + 11) - 1LL) & ((i + *((_QWORD *)v1 + 12)) >> 1)))
                       + 8LL * (((_DWORD)i + *((_DWORD *)v1 + 24)) & 1));
        v8 = *(_DWORD *)(*v7 + 428);
...
LABEL_20:
    ...
    ActiveManipulation = InteractionSourceManager::TryGetActiveManipulation((InteractionSourceManager *)v1);
