/*
 * XREFs of ?IsMatchingColorSpace@?$IBitmapRealizationMethodsT@VCSectionBitmapRealization@@VIGDIBitmapRealization@@@@WBDI@EBA_NW4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x1802AA9D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
