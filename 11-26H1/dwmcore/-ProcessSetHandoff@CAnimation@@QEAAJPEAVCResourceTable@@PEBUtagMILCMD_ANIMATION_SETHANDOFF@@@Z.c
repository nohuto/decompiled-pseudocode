/*
 * XREFs of ?ProcessSetHandoff@CAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_ANIMATION_SETHANDOFF@@@Z @ 0x1802199D8
 * Callers:
        ...
        const struct tagMILCMD_ANIMATION_SETHANDOFF *a3)
{
  ...
  *((_QWORD *)this + 27) = *((_QWORD *)a3 + 2);
  ...
  if ( v6 )
  {
    Resource = CResourceTable::GetResource((__int64)a2, v6, 3u);
