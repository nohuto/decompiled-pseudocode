        ...
        unsigned int *a7)
{
  ...
  __int64 v39; // rax
  __int64 v40; // rsi
  const struct D2DMatrix *v41; // rcx
      ...
      *(_QWORD *)v57 = 3LL;
      ...
      while ( v19 )
      {
        ...
        if ( magic::VectorInsideAngleThreshold(
               (magic *)(v34 + 16LL * (unsigned int)v32),
               (const struct D2DVector3 *)(v34 + 16LL * (unsigned int)v60),
               (const struct D2DVector3 *)v14) )
        {
          *(_DWORD *)(a1 + 812) |= *(_DWORD *)(v34 + v33 + 12);
        }
        v19 = *(_DWORD *)(a1 + 812) != 7;
        if ( v27 )
          goto LABEL_37;
...
LABEL_42:
          v37 = *(_QWORD *)(a4 + 8);
          if ( magic::VectorInsideAngleThreshold(
                 (magic *)(v37 + 16LL * (unsigned int)v14),
                 (const struct D2DVector3 *)(v37 + 16LL * (unsigned int)v60),
                 (const struct D2DVector3 *)v14) )
          {
            *(_DWORD *)(a1 + 820) |= *(_DWORD *)(v37 + v33 + 12);
          }
...
LABEL_37:
      ...
      if ( magic::VectorInsideAngleThreshold(
             (magic *)(v36 + 16LL * v56),
             (const struct D2DVector3 *)(v36 + 16LL * v35),
             (const struct D2DVector3 *)v14) )
      {
        *(_DWORD *)(a1 + 816) |= *(_DWORD *)(v36 + v33 + 12);
      }
      v27 = *(_DWORD *)(a1 + 816) != 7;
      goto LABEL_40;
    }
...
LABEL_50:
  ...
  if ( !D2DMatrixIsIdentity((const struct D2DMatrix *)(a1 + 976)) )
  {
    v51 = D3DXVec3TransformCoord((struct D2DVector3 *)&v63, (const struct D2DVector3 *)v59, v41);
  ...
  v9 = 0;
  if ( v43 > *(_DWORD *)(v40 + 20) )
  {
    v46 = DynArrayImpl<0>::AddMultipleAndSet(v40, 16, 1, &v63);
    v9 = v46;
    if ( v46 < 0 )
    {
  ...
  {
    v13 = 2 * v42;
    *(_OWORD *)(*(_QWORD *)v40 + 16LL * v42) = v63;
    *(_DWORD *)(v40 + 24) = v43;
  }
  v44 = a7;
  ++*a7;
