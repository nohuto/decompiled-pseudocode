/*
 * XREFs of ?_GetRenderToManipulationMsgInfo@CManipulation@@AEAAJPEAPEAUIMessageCallSendHost@@PEA_K@Z @ 0x180152354
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  {
    v9 = (struct IMessageCallSendHost **)((char *)v12 + 64);
    *a2 = 0LL;
    if ( *((_QWORD *)v7 + 8)
      && (Microsoft::WRL::ComPtr<IMessageCallSendHost>::InternalAddRef((__int64 *)v7 + 8), (*a2 = *v9) != 0LL) )
    {
      v11 = *((_QWORD *)v7 + 4);
      *a3 = v11;
      if ( v11 )
