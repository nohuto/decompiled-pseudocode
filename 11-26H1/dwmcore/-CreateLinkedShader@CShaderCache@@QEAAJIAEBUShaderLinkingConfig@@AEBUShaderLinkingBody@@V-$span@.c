/*
 * XREFs of ?CreateLinkedShader@CShaderCache@@QEAAJIAEBUShaderLinkingConfig@@AEBUShaderLinkingBody@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAPEAVCLinkedShader@@@Z @ 0x1800FD884
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  volatile signed __int32 *v34[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  *(_QWORD *)&v35 = a5;
  ...
  if ( LinkedShader >= 0 )
  {
    ...
    if ( !v14 || (v15 = CLinkedShader::CLinkedShader(v14, v32, v13), (v16 = (volatile signed __int32 *)v15) == 0LL) )
    {
      v31 = 95;
LABEL_23:
      v19 = -2147024882;
      v12 = -2147024882;
LABEL_24:
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v19, v31, 0LL);
      goto LABEL_17;
    }
    CMILRefCountImpl::AddReference((CLinkedShader *)((char *)v15 + 8));
    *(_QWORD *)&v35 = 0LL;
    v34[0] = v16;
    Microsoft::WRL::ComPtr<CDrawListCache>::InternalRelease((volatile signed __int32 **)&v35);
LABEL_15:
...
LABEL_20:
  Microsoft::WRL::ComPtr<CDrawListCache>::InternalRelease(v34);
  return v6;
}
