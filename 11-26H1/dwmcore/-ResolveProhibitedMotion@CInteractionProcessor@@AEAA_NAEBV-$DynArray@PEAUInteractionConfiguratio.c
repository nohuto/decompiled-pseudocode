/*
 * XREFs of ?ResolveProhibitedMotion@CInteractionProcessor@@AEAA_NAEBV?$DynArray@PEAUInteractionConfigurationGroup@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x18017AFC4
 * Callers:
...
LABEL_7:
        ...
        goto LABEL_8;
      case 4:
        v11 = CInteractionProcessor::ResolveProhibitedMotion<DwmPenInteractionConfigurationPrimitive,enum DwmInteractionTypePenPrimitiveType::FlagsEnum>(
                a1,
    ...
    if ( *(_DWORD *)(a1 + 788) != 5 )
    {
      ...
      v11 = CInteractionProcessor::ResolveProhibitedMotion<DwmMousewheelInteractionConfigurationPrimitive,enum DwmInteractionTypeMousewheelPrimitiveType::FlagsEnum>(
              a1,
