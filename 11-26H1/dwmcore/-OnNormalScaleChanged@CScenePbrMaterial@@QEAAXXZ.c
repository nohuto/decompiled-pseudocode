/*
 * XREFs of ?OnNormalScaleChanged@CScenePbrMaterial@@QEAAXXZ @ 0x18028103C
 * Callers:
 *     ?SetNormalScale@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJM@Z @ 0x18024C310 (-SetNormalScale@-$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJM@Z.c)
