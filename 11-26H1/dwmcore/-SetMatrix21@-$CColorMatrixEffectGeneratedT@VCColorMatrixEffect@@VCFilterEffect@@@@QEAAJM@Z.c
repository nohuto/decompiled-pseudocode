/*
 * XREFs of ?SetMatrix21@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x180249D30
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix21(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 368) )
  {
    *(float *)(a1 + 368) = a2;
