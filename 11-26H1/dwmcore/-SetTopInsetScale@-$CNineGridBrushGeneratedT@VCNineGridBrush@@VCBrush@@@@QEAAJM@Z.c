/*
 * XREFs of ?SetTopInsetScale@?$CNineGridBrushGeneratedT@VCNineGridBrush@@VCBrush@@@@QEAAJM@Z @ 0x18024EE24
 * Callers:
...
__int64 __fastcall CNineGridBrushGeneratedT<CNineGridBrush,CBrush>::SetTopInsetScale(__int64 a1, float a2)
{
