/*
 * XREFs of ?reserve@?$vector@U_D3D11_PARAMETER_DESC@@V?$allocator@U_D3D11_PARAMETER_DESC@@@std@@@std@@QEAAX_K@Z @ 0x180148310
 * Callers:
...
unsigned __int64 __fastcall std::vector<_D3D11_PARAMETER_DESC>::reserve(_QWORD *a1, unsigned __int64 a2)
{
  ...
  if ( a2 > result )
  {
    ...
    return std::vector<_D3D11_PARAMETER_DESC>::_Reallocate<0>(a1, &v3);
  }
  return result;
}
