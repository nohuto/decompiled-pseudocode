/*
 * XREFs of ?DelayUnpinResources@CD3DDevice@@QEAAXV?$span@PEAVISwapChainRealization@@$0?0@gsl@@U_LUID@@II@Z @ 0x18029764C
 * Callers:
  ...
  for ( i = &v5[*a2]; v5 != i; ++v5 )
  {
    ...
    if ( (_BYTE)result )
    {
      v14 = (struct _LUID *)detail::vector_facade<CD3DDevice::CDelayUnpin,detail::buffer_impl<CD3DDevice::CDelayUnpin,7,1,detail::liberal_expansion_policy>>::reserve_region(
                              (__int64 *)(a1 + 1232),
                              0xAAAAAAAAAAAAAAABuLL * ((__int64)(*(_QWORD *)(a1 + 1240) - *(_QWORD *)(a1 + 1232)) >> 3),
                              v13);
