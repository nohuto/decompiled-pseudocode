/*
 * XREFs of ?SetMaxScaleInternal@CInteractionTracker2@@AEAAXM@Z @ 0x1802763A4
 * Callers:
...
void __fastcall CInteractionTracker2::SetMaxScaleInternal(CInteractionTracker2 *this, float a2)
{
  __int64 v2; // rdx
  __int64 v4; // rcx
  ...
  {
    *((float *)this + 122) = a2;
    CInteractionTracker2::EnsureScaleIsLessThanOrEqualToMax(this, v2);
    CInteractionTracker2::SetMinScaleInternal(this, fminf(*((float *)this + 121), *((float *)this + 122)));
    CInteractionTracker2::BigHammerInvalidateConsumingAnimations((__int64)this, 10LL);
