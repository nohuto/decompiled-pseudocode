/*
 * XREFs of ??$_Uninitialized_value_construct_n@V?$allocator@VCMilPoint2F@@@std@@@std@@YAPEAVCMilPoint2F@@PEAV1@_KAEAV?$allocator@VCMilPoint2F@@@0@@Z @ 0x18019A748
 * Callers:
 ...
 * Callees:
 *     ??$_Emplace_back@$$V@?$_Uninitialized_backout_al@V?$allocator@VCMilPoint2F@@@std@@@std@@QEAAXXZ @ 0x18019A784 (--$_Emplace_back@$$V@-$_Uninitialized_backout_al@V-$allocator@VCMilPoint2F@@@std@@@std@@QEAAXXZ.c)
 */
