/*
 * XREFs of ?SetInnerConeAngle@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024B4D0
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetInnerConeAngle(
