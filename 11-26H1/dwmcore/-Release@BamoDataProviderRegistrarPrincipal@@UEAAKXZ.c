/*
 * XREFs of ?Release@BamoDataProviderRegistrarPrincipal@@UEAAKXZ @ 0x180241DC0
 * Callers:
 *     ?Release@BamoDataSourceProxy@@W7EAAKXZ @ 0x180241DE0 (-Release@BamoDataSourceProxy@@W7EAAKXZ.c)
 * Callees:
 *     <none>
 */
