/*
 * XREFs of ?ReleaseCommandBatch@CChannel@@UEAAXXZ @ 0x180174C20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CChannel::ReleaseCommandBatch(CChannel *this)
{
  ...
  if ( v1 )
  {
    ...
    else
    {
      ...
      {
        if ( (_QWORD *)v3[1] != v1
          || (v4 = (_QWORD *)v1[1], (_QWORD *)*v4 != v1)
          || (*v4 = v3, v5 = v1 + 2, v3[1] = v4, *(_QWORD **)(v1[2] + 8LL) != v1 + 2)
          || (v6 = (_QWORD *)v1[3], (_QWORD *)*v6 != v5)
          || *(_QWORD **)(*v3 + 8LL) != v3
          || (_QWORD *)*v4 != v3 )
        {
          __fastfail(3u);
