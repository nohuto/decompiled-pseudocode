/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VILegacyRemotingSwapChain@@VCMilObjectDeleter@@@@IEAAKXZ @ 0x1802A2E64
 * Callers:
 ...
 *     ?Release@CLegacyRemotingSwapChain@@UEAAKXZ @ 0x1802A3170 (-Release@CLegacyRemotingSwapChain@@UEAAKXZ.c)
 * Callees:
...
__int64 __fastcall CMILRefCountBaseT<ILegacyRemotingSwapChain,CMilObjectDeleter>::InternalRelease(__int64 a1)
{
  ...
  if ( !v3 )
  {
    ...
    if ( !v3 )
    {
      ...
      (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)a1 + 248LL))(a1, 1LL);
    }
  }
  return v3;
}
