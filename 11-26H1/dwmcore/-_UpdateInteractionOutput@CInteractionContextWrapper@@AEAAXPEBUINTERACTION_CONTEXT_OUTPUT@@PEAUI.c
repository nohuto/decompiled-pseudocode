/*
 * XREFs of ?_UpdateInteractionOutput@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@PEAUInteractionOutput@@@Z @ 0x180115940
 * Callers:
        ...
        int a4)
{
  ...
  *((_DWORD *)a3 + 11) = *((_DWORD *)a2 + 4);
  v8 = *(_DWORD *)a2;
  if ( *(_DWORD *)a2 == 1 || ((v8 - 2) & 0xFFFFFFFD) == 0 )
  {
    *(_DWORD *)a3 = v8;
  ...
  v36 = 0LL;
  v37 = 0;
  if ( !CCommonRegistryData::m_cForceDisableInteractionOutputPrediction
    && !CCommonRegistryData::m_fDisableInteractionOutputPrediction
