...
__int64 *__fastcall std::vector<wil::com_ptr_t<CCachedTexture,wil::err_returncode_policy>>::_Emplace_reallocate<wil::com_ptr_t<CCachedTexture,wil::err_returncode_policy> &>(
        __int64 **a1,
        __int64 *a2,
        __int64 *a3)
{
  ...
  std::_Uninitialized_move<wil::com_ptr_t<Windows::Devices::Display::Core::IDisplaySurfacePrivate,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<Windows::Devices::Display::Core::IDisplaySurfacePrivate,wil::err_returncode_policy>>>(
    ...
    v19);
  v22[1] = 0LL;
  std::vector<wil::com_ptr_t<CSceneObject,wil::err_returncode_policy>>::_Change_array((__int64)a1, (__int64)v16, v9, v3);
  std::vector<wil::com_ptr_t<Windows::Devices::Display::Core::IDisplaySurfacePrivate,wil::err_returncode_policy>>::_Reallocation_guard::~_Reallocation_guard((__int64)v22);
  return v17;
}
