/*
 * XREFs of ?HrFindInterface@CBrush@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180199CC0
 * Callers:
 *     ?HrFindInterface@CMaskBrush@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180199C70 (-HrFindInterface@CMaskBrush@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
