/*
 * XREFs of ?SetRedDisable@?$CLinearTransferEffectGeneratedT@VCLinearTransferEffect@@VCFilterEffect@@@@QEAAJ_N@Z @ 0x18024E644
 * Callers:
...
__int64 __fastcall CLinearTransferEffectGeneratedT<CLinearTransferEffect,CFilterEffect>::SetRedDisable(
        __int64 a1,
        char a2)
{
  if ( a2 != *(_BYTE *)(a1 + 360) )
