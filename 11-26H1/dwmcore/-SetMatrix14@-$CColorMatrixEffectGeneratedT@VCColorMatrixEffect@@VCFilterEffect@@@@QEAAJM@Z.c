/*
 * XREFs of ?SetMatrix14@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024A1D4
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix14(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 364) )
  {
    *(float *)(a1 + 364) = a2;
