/*
 * XREFs of ?SetCenterZ@?$CRotateTransform3DGeneratedT@VCRotateTransform3D@@VCTransform3D@@@@QEAAJM@Z @ 0x18024A668
 * Callers:
...
__int64 __fastcall CRotateTransform3DGeneratedT<CRotateTransform3D,CTransform3D>::SetCenterZ(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 184) )
  {
    *(float *)(a1 + 184) = a2;
