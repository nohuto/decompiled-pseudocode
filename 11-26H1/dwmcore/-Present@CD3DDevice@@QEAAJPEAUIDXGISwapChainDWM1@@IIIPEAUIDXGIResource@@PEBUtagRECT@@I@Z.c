/*
 * XREFs of ?Present@CD3DDevice@@QEAAJPEAUIDXGISwapChainDWM1@@IIIPEAUIDXGIResource@@PEBUtagRECT@@I@Z @ 0x180056978
 * Callers:
...
__int64 __fastcall CD3DDevice::Present(CD3DDevice *this, struct IDXGISwapChainDWM1 *a2)
{
  ...
  else
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x3B5u, 0LL);
    }
    else
    {
      v6 = 0LL;
    ...
    && *((_DWORD *)this + 110) )
  {
    if ( v5 == -2005270523 )
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 68) + 312LL))(*((_QWORD *)this + 68));
      v9 = *((_DWORD *)this + 281);
      if ( v8 != -2005270480 )
      {
        if ( !v9 )
...
LABEL_12:
  ...
  if ( (unsigned __int8)TranslateDXGIorD3DErrorInContext((unsigned int)v5, 1LL, &v11) )
  {
    ...
    v5 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xB71u, 0LL);
  }
