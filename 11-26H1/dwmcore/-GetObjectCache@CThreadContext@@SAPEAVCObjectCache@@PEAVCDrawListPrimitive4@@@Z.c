/*
 * XREFs of ?GetObjectCache@CThreadContext@@SAPEAVCObjectCache@@PEAVCDrawListPrimitive4@@@Z @ 0x180009AF4
 * Callers:
...
struct CObjectCache *__fastcall CThreadContext::GetObjectCache(struct CDrawListPrimitive4 *a1)
{
  char *Value; // rbx
  ...
  return (struct CObjectCache *)(Value + 240);
}
