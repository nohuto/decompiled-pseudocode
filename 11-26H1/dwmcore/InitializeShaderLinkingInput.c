/*
 * XREFs of InitializeShaderLinkingInput @ 0x180147FD0
 * Callers:
 ...
 *     GetHlslNameAndSemantic @ 0x1801481AC (GetHlslNameAndSemantic.c)
 *     ?ResolveKey@VertexShaderDesc@@QEBAIXZ @ 0x1801486A8 (-ResolveKey@VertexShaderDesc@@QEBAIXZ.c)
...
__int64 __fastcall InitializeShaderLinkingInput(struct ID3D11Linker **ppLinker, char a2, VertexShaderDesc *a3)
{
  ...
  v17 = *((_OWORD *)&unk_1802DBA60 + VertexShaderDesc::ResolveKey(a3));
  v6 = v17;
  for ( i = v17; i; i = v8 )
  {
    v8 = i - 1;
  ...
  if ( v10 )
  {
    ...
    if ( i )
    {
      ...
      {
        v12 = 32LL * (unsigned int)v11;
        *(_WORD *)&v10[v12] = *(_WORD *)(*((_QWORD *)&v6 + 1) + 12 * v11);
        *(_QWORD *)&v10[v12 + 24] = *(_QWORD *)(*((_QWORD *)&v6 + 1) + 12 * v11 + 4);
        GetHlslNameAndSemantic(*(unsigned __int16 *)(*((_QWORD *)&v6 + 1) + 12 * v11), &v10[v12 + 8], &v10[v12 + 16]);
