/*
 * XREFs of ??$SetProperty@UD2DVector4@@@DataSourcePropertySet@@QEAAJUDCOMPOSITION_PROPERTY_ID@@PEBUD2DVector4@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18024269C
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector4>(__int64 a1, int a2, __m128i *a3)
{
  ...
  if ( v13 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DQuaternion>(v5, 69, a3, &v15);
    if ( v6 < 0 )
    {
      v7 = 37LL;
LABEL_4:
  ...
  {
    v9 = *(_DWORD *)(v13 + 20);
    if ( (unsigned int)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::GetDataType(v5, v9) != 69 )
    {
      v6 = -2147024809;
      v7 = 48LL;
      goto LABEL_4;
