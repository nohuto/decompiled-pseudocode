/*
 * XREFs of ?HrFindInterface@CScribbleSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801CC6F0
 * Callers:
 *     ?HrFindInterface@CConversionSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A77A0 (-HrFindInterface@CConversionSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?HrFindInterface@COverlaySwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801CC758 (-HrFindInterface@COverlaySwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
