/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_1017417018@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1802733A4
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_1017417018@@@details@wil@@QEAA_NXZ @ 0x180277A8C (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_1017417018@@@details@wil@@QEAA_NX.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_1017417018@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180273480 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_1017417018@@@details@wi.c)
 */

_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_1017417018>::GetCachedFeatureEnabledState(
        wil::details *a1,
        _QWORD *a2)
{
  int v2; // eax
  ...
  *(_DWORD *)a2 = v2;
  if ( (v2 & 6) != 6 )
  {
    ...
    v14 = 0;
    v6 = v5;
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_1017417018>::GetCurrentFeatureEnabledState(v7, &v15, &v14);
    v8 = *(_DWORD *)a2;
    v9 = v15;
    do
    {
