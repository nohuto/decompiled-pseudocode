/*
 * XREFs of ?IsComputeScribbleSupported@CLegacySwapChain@@UEBA_NXZ @ 0x1801D08A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
  ...
  if ( (*(unsigned int (__fastcall **)(char *))(*(_QWORD *)v2 + 96LL))(v2) < 2 )
  {
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x80000) == 0 )
      return 0;
    v4 = 13LL;
  ...
  if ( !(*(__int64 (__fastcall **)(char *))(*(_QWORD *)v2 + 312LL))(v2) )
