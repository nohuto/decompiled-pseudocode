/*
 * XREFs of ?SetMatrix33@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x180249ED8
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix33(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 392) )
  {
    *(float *)(a1 + 392) = a2;
