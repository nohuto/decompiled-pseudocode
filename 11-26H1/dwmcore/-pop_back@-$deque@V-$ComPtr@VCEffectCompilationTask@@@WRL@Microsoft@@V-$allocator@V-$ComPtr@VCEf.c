/*
 * XREFs of ?pop_back@?$deque@V?$ComPtr@VCEffectCompilationTask@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VCEffectCompilationTask@@@WRL@Microsoft@@@std@@@std@@QEAAXXZ @ 0x1801DE580
 * Callers:
...
__int64 __fastcall std::deque<Microsoft::WRL::ComPtr<CEffectCompilationTask>>::pop_back(__int64 a1)
{
  ...
  v4 = *(_QWORD *)(result
                 + 8
                 * ((*(_QWORD *)(a1 + 16) - 1LL) & ((unsigned __int64)(*(_QWORD *)(a1 + 24) - 1LL + *(_QWORD *)(a1 + 32)) >> 1)));
  v5 = *(_QWORD *)(v4 + 8 * v2);
  if ( v5 )
  {
    *(_QWORD *)(v4 + 8 * v2) = 0LL;
