/*
 * XREFs of ?SetQuadraticAttenuation@?$CPointLightGeneratedT@VCPointLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024C1EC
 * Callers:
...
__int64 __fastcall CPointLightGeneratedT<CPointLight,CPositionedLight>::SetQuadraticAttenuation(
