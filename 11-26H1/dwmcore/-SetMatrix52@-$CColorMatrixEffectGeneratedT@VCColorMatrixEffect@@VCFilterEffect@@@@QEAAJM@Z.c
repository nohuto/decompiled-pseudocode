/*
 * XREFs of ?SetMatrix52@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BF58
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix52(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 420) )
  {
    *(float *)(a1 + 420) = a2;
