/*
 * XREFs of ?EnsurePositionIsLessThanOrEqualToMax@CInteractionTracker@@AEAAXW4PropertyValueMask@1@@Z @ 0x180139AF0
 * Callers:
...
__int64 __fastcall CInteractionTracker::EnsurePositionIsLessThanOrEqualToMax(__int64 *a1, char a2)
{
  ...
  if ( !*((_DWORD *)a1 + 22) && (*((_BYTE *)a1 + 596) & 0x10) == 0 )
  {
    ...
    v6 = v2;
    if ( (a2 & 1) != 0 )
      LODWORD(v5) = fminf(*((float *)a1 + 46), *((float *)a1 + 52));
    if ( (a2 & 2) != 0 )
      HIDWORD(v5) = fminf(*((float *)a1 + 47), *((float *)a1 + 53));
    v3 = *a1;
    v6 = 0;
