/*
 * XREFs of ?Add@CExpressionValueStack@@QEAAJXZ @ 0x1801AC138
 * Callers:
    ...
    *((_DWORD *)this + 24) = v5;
    ...
    if ( v7 == *(_DWORD *)(v6 + 136) )
    {
      switch ( v7 )
      {
        ...
        case 52:
          v10 = *v8 + *(float *)v6;
          v11 = *(float *)(v6 + 76) + *(float *)(v6 + 4);
          v12 = *(float *)(v6 + 80) + *(float *)(v6 + 8);
          CExpressionValue::DestroyCurrent((CExpressionValue *)v6);
          *(_DWORD *)(v6 + 64) = 52;
          *(float *)v6 = v10;
          *(float *)(v6 + 4) = v11;
        ...
        case 104:
          v16 = *v8 + *(float *)v6;
          v17 = *(float *)(v6 + 76) + *(float *)(v6 + 4);
          v18 = *(float *)(v6 + 80) + *(float *)(v6 + 8);
          v19 = *(float *)(v6 + 84) + *(float *)(v6 + 12);
          v20 = *(float *)(v6 + 88) + *(float *)(v6 + 16);
          v21 = *(float *)(v6 + 92) + *(float *)(v6 + 20);
          CExpressionValue::DestroyCurrent((CExpressionValue *)v6);
          *(_DWORD *)(v6 + 64) = 104;
          *(float *)v6 = v16;
          *(float *)(v6 + 4) = v17;
          ...
          *(float *)(v6 + 20) = v21;
          return v2;
        case 265:
          v15 = (_OWORD *)D2DMatrix::operator+(v6, v24, v6 + 72);
          CExpressionValue::DestroyCurrent((CExpressionValue *)v6);
          *(_DWORD *)(v6 + 64) = 265;
          *(_OWORD *)v6 = *v15;
          *(_OWORD *)(v6 + 16) = v15[1];
