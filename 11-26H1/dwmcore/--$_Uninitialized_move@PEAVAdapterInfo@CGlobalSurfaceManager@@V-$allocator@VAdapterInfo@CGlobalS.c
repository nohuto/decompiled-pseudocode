/*
 * XREFs of ??$_Uninitialized_move@PEAVAdapterInfo@CGlobalSurfaceManager@@V?$allocator@VAdapterInfo@CGlobalSurfaceManager@@@std@@@std@@YAPEAVAdapterInfo@CGlobalSurfaceManager@@QEAV12@0PEAV12@AEAV?$allocator@VAdapterInfo@CGlobalSurfaceManager@@@0@@Z @ 0x18022DDA0
 * Callers:
...
char *__fastcall std::_Uninitialized_move<CGlobalSurfaceManager::AdapterInfo *>(_QWORD *a1, _QWORD *a2, char *a3)
{
  ...
  std::_Destroy_range<std::allocator<CGlobalSurfaceManager::AdapterInfo>>((__int64)a3, (__int64)a3);
  return a3;
}
