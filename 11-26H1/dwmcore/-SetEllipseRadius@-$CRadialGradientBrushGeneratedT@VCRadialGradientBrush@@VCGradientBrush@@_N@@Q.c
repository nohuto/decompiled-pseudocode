/*
 * XREFs of ?SetEllipseRadius@?$CRadialGradientBrushGeneratedT@VCRadialGradientBrush@@VCGradientBrush@@_N@@QEAAJUD2D_VECTOR_2F@@@Z @ 0x18024B008
 * Callers:
...
__int64 __fastcall CRadialGradientBrushGeneratedT<CRadialGradientBrush,CGradientBrush,bool>::SetEllipseRadius(
        __int64 a1,
        __int64 a2)
{
  _QWORD *v3; // rdx
  ...
  v7 = a2;
  if ( operator!=((float *)&v7, (float *)(a1 + 256)) )
  {
    v4 = *(_QWORD *)(a1 + 48) == 0LL;
    *v3 = a2;
    if ( !v4 )
