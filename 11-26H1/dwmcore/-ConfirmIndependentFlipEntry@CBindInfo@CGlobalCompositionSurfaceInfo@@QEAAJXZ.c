/*
 * XREFs of ?ConfirmIndependentFlipEntry@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJXZ @ 0x18021B360
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  if ( *((_DWORD *)this + 44) == 2 && !*((_BYTE *)this + 182) )
  {
    ...
    *((_BYTE *)this + 182) = 1;
    ...
    {
      v3 = v8 | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8 | 0x10000000, 0x520u, 0LL);
    }
  }
  return v3;
}
