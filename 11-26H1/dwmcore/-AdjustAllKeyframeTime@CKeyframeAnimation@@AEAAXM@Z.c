/*
 * XREFs of ?AdjustAllKeyframeTime@CKeyframeAnimation@@AEAAXM@Z @ 0x180279B04
 * Callers:
...
void __fastcall CKeyframeAnimation::AdjustAllKeyframeTime(CKeyframeAnimation *this, float a2, double a3)
{
  ...
  *(float *)v3.m128i_i32 = CKeyframeAnimation::GetAnimationTimeLength(this) * 1000.0;
  ...
  v8 = *(_QWORD *)(v4 + 304);
  for ( i = 0LL; (int)i < *(_DWORD *)(v8 + 104); v8 = *(_QWORD *)(v4 + 304) )
  {
    v10 = 3 * i;
    i = (unsigned int)(i + 1);
    *(_DWORD *)(*(_QWORD *)(v8 + 96) + 8 * v10) = (int)(float)((float)*(int *)(*(_QWORD *)(v8 + 96) + 8 * v10)
                                                             * (float)(a2 / (float)v6));
    *(_BYTE *)(v8 + 132) |= 4u;
  }
}
