/*
 * XREFs of ?SetMatrix44@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BEB8
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix44(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 412) )
  {
    *(float *)(a1 + 412) = a2;
