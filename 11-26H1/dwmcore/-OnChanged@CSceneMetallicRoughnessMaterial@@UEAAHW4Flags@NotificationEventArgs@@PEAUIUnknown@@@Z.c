/*
 * XREFs of ?OnChanged@CSceneMetallicRoughnessMaterial@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x180280B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSceneMetallicRoughnessMaterial::OnChanged(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( a3 && (a3 == *(_QWORD *)(a1 + 176) || a3 == *(_QWORD *)(a1 + 184)) )
  {
    v6 = **(_QWORD **)(a1 + 80);
    v8 = v6;
    while ( v6 != *(_QWORD *)(a1 + 80) )
    {
      ...
      std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<CSceneMeshRendererComponent * const,wil::com_ptr_t<ISpectreMaterial,wil::err_returncode_policy>>>>,std::_Iterator_base0>::operator++(&v8);
      v6 = v8;
    }
  }
