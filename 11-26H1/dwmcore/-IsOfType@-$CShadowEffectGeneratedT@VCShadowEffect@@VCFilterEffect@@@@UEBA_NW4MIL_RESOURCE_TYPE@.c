/*
 * XREFs of ?IsOfType@?$CShadowEffectGeneratedT@VCShadowEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180249160
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CShadowEffectGeneratedT<CShadowEffect,CFilterEffect>::IsOfType(__int64 a1, int a2)
{
  char v2; // al
  char v3; // cl
