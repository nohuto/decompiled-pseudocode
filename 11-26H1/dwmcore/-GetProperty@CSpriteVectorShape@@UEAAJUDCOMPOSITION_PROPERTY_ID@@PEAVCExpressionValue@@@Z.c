/*
 * XREFs of ?GetProperty@CSpriteVectorShape@@UEAAJUDCOMPOSITION_PROPERTY_ID@@PEAVCExpressionValue@@@Z @ 0x180282910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::GetProperty(__int64 a1, int a2)
{
  unsigned int v2; // ebx
  ...
  v8[0] = 3LL;
  v8[1] = &CSpriteVectorShape::k_rgAnimDef;
  v2 = 0;
  ...
  {
    v2 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, (unsigned int)v4, -2147024809, 0x46u, v4);
  }
  return v2;
}
