/*
 * XREFs of ?CaptureCurrentManipulation@CInteractionProcessor@@QEAAXI_K@Z @ 0x180227B90
 * Callers:
 *     ?CaptureCurrentManipulation@CInteraction@@UEAAXI_K@Z @ 0x18025F960 (-CaptureCurrentManipulation@CInteraction@@UEAAXI_K@Z.c)
 * Callees:
...
void __fastcall CInteractionProcessor::CaptureCurrentManipulation(CInteractionProcessor *this, int a2, __int64 a3)
{
  ...
  *((_QWORD *)this + 104) = a3;
  if ( (unsigned int)dword_1803DC880 > 4 && tlgKeywordOn((__int64)&dword_1803DC880, 2LL) )
  {
    ...
    v14 = 4LL;
    v12 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v3, byte_1803B1EE7, 0LL, 0LL, 5u, &v10);
  }
}
