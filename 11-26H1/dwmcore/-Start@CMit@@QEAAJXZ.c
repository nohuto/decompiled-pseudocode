/*
 * XREFs of ?Start@CMit@@QEAAJXZ @ 0x1801DA4B0
 * Callers:
...
__int64 __fastcall CMit::Start(HANDLE *this)
{
  ...
  {
    v2 = -2147467260;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180376C70, 2u, -2147467260, 0x61u, 0LL);
  }
  else
  {
    ThreadId = 0;
    ...
    {
      v2 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, &dword_180376C70, 2u, -2147024882, 0x73u, 0LL);
    }
  }
  return v2;
}
