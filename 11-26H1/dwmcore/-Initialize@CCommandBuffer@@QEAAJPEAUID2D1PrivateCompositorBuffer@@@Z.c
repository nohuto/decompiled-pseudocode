/*
 * XREFs of ?Initialize@CCommandBuffer@@QEAAJPEAUID2D1PrivateCompositorBuffer@@@Z @ 0x18001936C
 * Callers:
...
__int64 __fastcall CCommandBuffer::Initialize(CCommandBuffer *this, struct ID2D1PrivateCompositorBuffer *a2)
{
  ...
  if ( v4 == 144 * (v4 / 0x90uLL) )
  {
    ...
    v6 = (char *)operator new[](saturated_mul(v5, 0x90uLL));
    if ( v6 )
    {
      ...
      while ( 1 )
      {
        ...
        v11 = &v6[144 * v9];
        if ( *(_DWORD *)v11 > 3u || *((_DWORD *)v11 + 3) > 7u )
          break;
        v9 = (unsigned int)(v9 + 1);
      }
      if ( (unsigned int)dword_1803DC880 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1803DC880, 16LL, v11) )
      {
        v16 = *(_DWORD *)(v14 + 12);
        v17 = v5;
        v18 = v15;
