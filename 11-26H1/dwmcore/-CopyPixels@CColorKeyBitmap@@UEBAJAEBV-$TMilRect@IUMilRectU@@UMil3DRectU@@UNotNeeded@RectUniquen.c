/*
 * XREFs of ?CopyPixels@CColorKeyBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x1802B1000
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v17 = a2[3] - a2[1];
        v18 = a2[2] - *a2;
        v19 = (enum DXGI_FORMAT *)(*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v22 + 24LL))(v22, v28);
