/*
 * XREFs of ?IsOfType@?$CCompositeEffectGeneratedT@VCCompositeEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180248E10
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CCompositeEffectGeneratedT<CCompositeEffect,CFilterEffect>::IsOfType(__int64 a1, int a2)
{
  char v2; // al
  char v3; // cl
