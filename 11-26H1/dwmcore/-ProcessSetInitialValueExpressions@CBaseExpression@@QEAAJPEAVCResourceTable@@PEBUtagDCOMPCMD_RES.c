/*
 * XREFs of ?ProcessSetInitialValueExpressions@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_RESOURCE_SETCOLLECTIONPROPERTY@@PEBXI_N@Z @ 0x18027C838
 * Callers:
 *     ?ProcessMessage@CGlobalComposition@@EEAAJW4MILCMD@@PEBXIPEAVCChannelContext@@PEAVCResourceTable@@@Z @ 0x1801E7E80 (-ProcessMessage@CGlobalComposition@@EEAAJW4MILCMD@@PEBXIPEAVCChannelContext@@PEAVCResourceTable@.c)
 *     ?ProcessAppendInitialValueExpressions@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_RESOURCE_SETCOLLECTIONPROPERTY@@PEBXI@Z @ 0x1802497E8 (-ProcessAppendInitialValueExpressions@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_.c)
 * Callees:
...
__int64 __fastcall CBaseExpression::ProcessSetInitialValueExpressions(
