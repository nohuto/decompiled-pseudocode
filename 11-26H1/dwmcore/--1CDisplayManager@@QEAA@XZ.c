/*
 * XREFs of ??1CDisplayManager@@QEAA@XZ @ 0x18021E1C4
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DisplayManager__ @ 0x1802B9FC0 (_dynamic_atexit_destructor_for__g_DisplayManager__.c)
 * Callees:
