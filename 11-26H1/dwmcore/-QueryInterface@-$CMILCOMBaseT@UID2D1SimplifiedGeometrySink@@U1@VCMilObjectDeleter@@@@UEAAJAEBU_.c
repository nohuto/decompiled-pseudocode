/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@UID2D1SimplifiedGeometrySink@@U1@VCMilObjectDeleter@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180228DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<ID2D1SimplifiedGeometrySink,ID2D1SimplifiedGeometrySink,CMilObjectDeleter>::QueryInterface(
        __int64 a1,
        _QWORD *a2,
        _QWORD *a3)
{
