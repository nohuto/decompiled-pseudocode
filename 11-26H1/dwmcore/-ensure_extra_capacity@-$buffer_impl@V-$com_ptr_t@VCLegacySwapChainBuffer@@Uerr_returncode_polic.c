/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@V?$com_ptr_t@VCLegacySwapChainBuffer@@Uerr_returncode_policy@wil@@@wil@@$02$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x1801CBC1C
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( (v4 - v2) >> 3 < a2 )
  {
    ...
    std::uninitialized_move<std::move_iterator<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy> *>,stdext::checked_array_iterator<wil::com_ptr_t<CVisualTree,wil::err_returncode_policy> *>>(
      ...
      v9,
      &v15);
    detail::destruct_range<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy>>(*a1, a1[1]);
    v11 = (__int64 *)*a1;
    *a1 = (__int64)v8;
    v17 = 0LL;
    if ( v11 == a1 + 3 )
