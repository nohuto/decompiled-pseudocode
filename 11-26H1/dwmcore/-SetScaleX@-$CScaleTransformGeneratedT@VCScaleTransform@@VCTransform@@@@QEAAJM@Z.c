/*
 * XREFs of ?SetScaleX@?$CScaleTransformGeneratedT@VCScaleTransform@@VCTransform@@@@QEAAJM@Z @ 0x18021918C
 * Callers:
...
__int64 __fastcall CScaleTransformGeneratedT<CScaleTransform,CTransform>::SetScaleX(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 160) )
  {
    *(float *)(a1 + 160) = a2;
