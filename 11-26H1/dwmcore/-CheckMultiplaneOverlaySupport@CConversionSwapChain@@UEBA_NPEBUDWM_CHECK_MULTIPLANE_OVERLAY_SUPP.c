/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CConversionSwapChain@@UEBA_NPEBUDWM_CHECK_MULTIPLANE_OVERLAY_SUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x1802A7190
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??8@YA_NAEBUtagRECT@@0@Z @ 0x1801965BC (--8@YA_NAEBUtagRECT@@0@Z.c)
        ...
        bool *a4)
{
  ...
  *a4 = 0;
  ...
  {
    v4 = 1;
    for ( i = 0LL; (unsigned int)i < a3; i = (unsigned int)(v11 + 1) )
    {
      if ( *((_DWORD *)a2 + 36 * i + 6)
