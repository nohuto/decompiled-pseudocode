/*
 * XREFs of ?CalcDeviceTransformDelta@CFilterEffectLayer@@EEAAJPEAVCDrawingContext@@PEAVCMILMatrix@@@Z @ 0x180250360
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILMatrix *a3)
{
  ...
  __int64 v10; // r10
  __int128 v11; // xmm0
  __int64 v13; // [rsp+20h] [rbp-19h] BYREF
  ...
  v14 = _mm_cvtepi32_ps(v6).m128_f32[0];
  v15 = _mm_cvtepi32_ps(v4).m128_f32[0];
  v18 = v14 + v16;
  v19 = v15 + v17;
  CMILMatrix::InferAffineMatrix((__int64)v20, &v16, (float *)&v13);
  v7 = v20[1];
  v8 = v21;
  v9 = v20[2];
  *(_OWORD *)v10 = v20[0];
