/*
 * XREFs of ?UpdateActiveConfig@?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@QEAAXAEBUDwmTouchpadInteractionConfigurationPrimitive@@@Z @ 0x1801AEE8C
 * Callers:
 ...
 * Callees:
 *     ??$UpdateActiveConfig@UDwmTouchpadInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXAEBUDwmTouchpadInteractionConfigurationPrimitive@@@Z @ 0x1801AEF14 (--$UpdateActiveConfig@UDwmTouchpadInteractionConfigurationPrimitive@@@GestureTargeting@InputTrac.c)
 */
        ...
        __int64 *a2)
{
  ...
  *(_DWORD *)(v5 + 8) = v4;
  if ( v6 )
    InputTraceLogging::GestureTargeting::UpdateActiveConfig<DwmTouchpadInteractionConfigurationPrimitive>();
  *(_QWORD *)(a1 + 20) = 0LL;
  *(_QWORD *)(a1 + 28) = 0LL;
  *(_QWORD *)(a1 + 36) = 0LL;
  *(_QWORD *)(a1 + 44) = 0LL;
