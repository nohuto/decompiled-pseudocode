        ...
        _QWORD *a5)
{
  ...
  appended = std::_Fnv1a_append_bytes((__int64)a1, *a4, 4uLL);
  ...
  if ( !*((_QWORD *)&v24 + 1) )
  {
    ...
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned int const,CFlipAwayFence>,void *>>>::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned int const,CFlipAwayFence>,void *>>>(
      &v25,
      (__int64)(a1 + 2),
      v10,
      (__int64 *)a4,
    ...
    if ( (float)(v12 / v14) > *a1 )
    {
      ...
      std::_Hash<std::_Umap_traits<unsigned int,CFlipAwayFence,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,CFlipAwayFence>>,0>>::_Forced_rehash(
        a1,
        v17);
      v24 = *(_OWORD *)std::_Hash<std::_Umap_traits<unsigned int,CFlipAwayFence,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,CFlipAwayFence>>,0>>::_Find_last<unsigned int>(
                         a1,
                         &v24,
                         (_DWORD *)(v16 + 16),
                         appended);
    ...
    *(_QWORD *)(v18 + 8) = v16;
    v20 = *((_QWORD *)a1 + 3);
    v21 = 2 * (appended & *((_QWORD *)a1 + 6));
    v22 = *(_QWORD *)(v20 + 16 * (appended & *((_QWORD *)a1 + 6)));
    if ( v22 == *((_QWORD *)a1 + 1) )
    {
      *(_QWORD *)(v20 + 16 * (appended & *((_QWORD *)a1 + 6))) = v16;
LABEL_18:
    ...
    else if ( *(_QWORD **)(v20 + 16 * (appended & *((_QWORD *)a1 + 6)) + 8) == v19 )
    {
      goto LABEL_18;
    }
LABEL_19:
    *(_QWORD *)a2 = v16;
    *(_BYTE *)(a2 + 8) = 1;
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned int const,CFlipAwayFence>,void *>>>::~_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned int const,CFlipAwayFence>,void *>>>(&v25);
    return a2;
  }
