/*
 * XREFs of ?RegisterStrokeOnHost@CSuperWetInkManager@@AEAAJPEAUVailSuperWetStroke@1@PEA_N@Z @ 0x180230E6C
 * Callers:
        ...
        bool *a3)
{
  ...
  *a3 = 0;
  v10 = 0;
  v6 = CSuperWetInkManager::CheckHostComputeScribbleSupport(this, (CD3DDevice **)a2, &v10);
  if ( v6 < 0 )
  {
    v7 = 987LL;
LABEL_3:
