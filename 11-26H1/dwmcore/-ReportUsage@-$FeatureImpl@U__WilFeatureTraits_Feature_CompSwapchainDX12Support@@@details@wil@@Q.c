/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_CompSwapchainDX12Support@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800F7304
 * Callers:
...
__int64 wil::details::FeatureImpl<__WilFeatureTraits_Feature_CompSwapchainDX12Support>::ReportUsage(
        _DWORD *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_CompSwapchainDX12Support>::GetCachedFeatureEnabledState(
                      a1,
                      &v7);
    v7 = v3;
  }
