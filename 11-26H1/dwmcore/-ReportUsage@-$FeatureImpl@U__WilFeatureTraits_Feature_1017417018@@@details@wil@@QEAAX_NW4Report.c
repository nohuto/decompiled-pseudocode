/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_1017417018@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1802754BC
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_1017417018>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_1017417018>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v7);
    v7 = v3;
  }
