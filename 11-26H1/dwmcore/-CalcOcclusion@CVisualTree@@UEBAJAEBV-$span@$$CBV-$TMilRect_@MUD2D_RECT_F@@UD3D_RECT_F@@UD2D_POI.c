/*
 * XREFs of ?CalcOcclusion@CVisualTree@@UEBAJAEBV?$span@$$CBV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@$0?0@gsl@@PEAVCOcclusionContext@@M@Z @ 0x180170A30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisualTree::CalcOcclusion(struct CVisualTree *a1, __int64 a2, COcclusionContext *a3)
{
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v3, 0x155u, 0LL);
  return v4;
}
