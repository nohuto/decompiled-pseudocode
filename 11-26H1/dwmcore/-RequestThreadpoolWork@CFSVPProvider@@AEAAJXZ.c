/*
 * XREFs of ?RequestThreadpoolWork@CFSVPProvider@@AEAAJXZ @ 0x180252D10
 * Callers:
...
__int64 __fastcall CFSVPProvider::RequestThreadpoolWork(_QWORD *pv)
{
  ...
  ThreadpoolWork = CreateThreadpoolWork(
                     (PTP_WORK_CALLBACK)CFSVPProvider::EnsureThreadpoolTask_::_5_::_lambda_1_::_lambda_invoker_cdecl_,
                     pv,
                     0LL);
  pv[3] = ThreadpoolWork;
  if ( ThreadpoolWork )
