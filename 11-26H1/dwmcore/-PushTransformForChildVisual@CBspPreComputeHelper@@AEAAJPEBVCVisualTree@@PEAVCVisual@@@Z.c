/*
 * XREFs of ?PushTransformForChildVisual@CBspPreComputeHelper@@AEAAJPEBVCVisualTree@@PEAVCVisual@@@Z @ 0x1800D436C
 * Callers:
        ...
        const struct CVisual **a3)
{
  ...
  const struct CMILMatrix *v11; // r8
  int v12; // eax
...
LABEL_2:
  ...
  v19 = 0;
  if ( v9 && v10 < v9 )
    v11 = (const struct CMILMatrix *)(*((_QWORD *)this + 9) + 68LL * v10);
  CVisual::CalcTransform((CVisual *)a3, (CVisual **)a2, v11, &v22, (struct CMILMatrix *)v20, (struct CMILMatrix *)v18);
  v12 = CMatrixStack::Push((CBspPreComputeHelper *)((char *)this + 72), (const struct CMILMatrix *)v18, 0);
  v13 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0xF4u, 0LL);
  return v13;
}
