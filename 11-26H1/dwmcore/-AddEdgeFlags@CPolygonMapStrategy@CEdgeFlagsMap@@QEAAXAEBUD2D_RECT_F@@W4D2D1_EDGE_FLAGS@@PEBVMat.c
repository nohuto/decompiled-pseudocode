/*
 * XREFs of ?AddEdgeFlags@CPolygonMapStrategy@CEdgeFlagsMap@@QEAAXAEBUD2D_RECT_F@@W4D2D1_EDGE_FLAGS@@PEBVMatrix3x3@@M@Z @ 0x180143C38
 * Callers:
 ...
 *     ?DecomposeRectangleEdgeFlags@@YAXW4D2D1_EDGE_FLAGS@@PEAW41@111@Z @ 0x180143DDC (-DecomposeRectangleEdgeFlags@@YAXW4D2D1_EDGE_FLAGS@@PEAW41@111@Z.c)
 ...
 *     ?TransformHomogeneousPoint@Matrix3x3@@QEBA?AUD2D_POINT_2F@@U2@@Z @ 0x180144160 (-TransformHomogeneousPoint@Matrix3x3@@QEBA-AUD2D_POINT_2F@@U2@@Z.c)
        ...
        int a5)
{
  ...
  _BYTE v35[12]; // [rsp+64h] [rbp-1Ch] BYREF
  ...
  else
  {
    do
    {
      ...
      result = CConvexPolygonEdgeMap<unsigned int>::TryAddEdge(
                 a1,
                 (unsigned int)&unk_1802F3780 + 32 * v11,
