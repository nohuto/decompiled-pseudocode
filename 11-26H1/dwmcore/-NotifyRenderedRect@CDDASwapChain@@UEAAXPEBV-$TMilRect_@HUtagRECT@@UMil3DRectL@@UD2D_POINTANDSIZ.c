/*
 * XREFs of ?NotifyRenderedRect@CDDASwapChain@@UEAAXPEBV?$TMilRect_@HUtagRECT@@UMil3DRectL@@UD2D_POINTANDSIZE_L@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x1801BB580
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDDASwapChain::NotifyRenderedRect(__int64 a1, const struct tagRECT *a2)
{
  ...
  (*(void (__fastcall **)(_QWORD, int *))(**(_QWORD **)(a1 + 64) + 88LL))(*(_QWORD *)(a1 + 64), &v7);
  v4 = v7;
  v5 = v8;
  if ( a2 )
  {
