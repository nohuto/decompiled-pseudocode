/*
 * XREFs of ?PushNoOpLayer@CDrawingContext@@AEAAJPEBVCVisual@@@Z @ 0x1800FA610
 * Callers:
...
__int64 __fastcall CDrawingContext::PushNoOpLayer(CDrawingContext *this, const struct CVisual *a2)
{
  ...
  *((_QWORD *)&v3 + 1) = a2;
  *(_QWORD *)&v3 = 7LL;
  return CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Push((__int64)this + 256, &v3);
}
