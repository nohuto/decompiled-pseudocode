/*
 * XREFs of ??1CSectionBitmapRealization@@MEAA@XZ @ 0x1801B3AEC
 * Callers:
 ...
 *     ?UnmapSection@CSectionBitmapRealization@@AEAA_NXZ @ 0x1801B3B84 (-UnmapSection@CSectionBitmapRealization@@AEAA_NXZ.c)
 */
