/*
 * XREFs of ?UpdateDecodeBitmap@CDxHandleAdvancedDirectFlipBitmapRealization@@IEAAJXZ @ 0x1802AC16C
 * Callers:
        ...
        CDxHandleAdvancedDirectFlipBitmapRealization *this)
{
  ...
  struct tagRECT v11; // [rsp+48h] [rbp-29h] BYREF
  _DWORD v12[4]; // [rsp+58h] [rbp-19h] BYREF
  ...
  {
    (*(void (__fastcall **)(char *, _DWORD *))(*((_QWORD *)this + 10) + 32LL))((char *)this + 80, v12);
    v11.right = v12[0];
    v11.bottom = v12[1];
    *(_QWORD *)&v11.left = 0LL;
    CRegion::CRegion((CRegion *)v13, (const struct MilRectU *)&v11);
    CRegion::Subtract(
    ...
    v6 = *(_DWORD *)(v4 + 232);
    v7 = (struct ID3D11Texture2D *)(*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(v4 + 72) + 120LL))(
                                     v4 + 72,
                                     0LL);
