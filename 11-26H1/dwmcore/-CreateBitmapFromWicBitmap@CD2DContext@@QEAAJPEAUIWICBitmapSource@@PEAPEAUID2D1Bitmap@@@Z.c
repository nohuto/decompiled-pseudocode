/*
 * XREFs of ?CreateBitmapFromWicBitmap@CD2DContext@@QEAAJPEAUIWICBitmapSource@@PEAPEAUID2D1Bitmap@@@Z @ 0x1802984C0
 * Callers:
        ...
        struct ID2D1Bitmap **a3)
{
  ...
  v6 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803A2628, 0xAu, v4, 0xF4u, 0LL);
