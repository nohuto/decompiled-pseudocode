/*
 * XREFs of ?SetDirection@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJUD2D_VECTOR_3F@@@Z @ 0x18024AE64
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetDirection(
        ...
        const struct D2D_VECTOR_3F *a2)
{
  ...
  *(_QWORD *)&v7.x = 0LL;
  ...
  if ( operator!=(&v7.x, (float *)this + 61) )
  {
