/*
 * XREFs of ?reset@?$com_ptr_t@VCD3DDevice@@Uerr_returncode_policy@wil@@@wil@@QEAAXXZ @ 0x1800F36F0
 * Callers:
...
void __fastcall wil::com_ptr_t<CD3DDevice,wil::err_returncode_policy>::reset(__int64 *a1)
{
  __int64 v1; // rdi
  __int64 v2; // rdx
  CComposition *v3; // rcx
  ...
  *a1 = 0LL;
  if ( v1 )
  {
    if ( *(_DWORD *)(v1 + 8) == 2 )
    {
      ...
      *(_QWORD *)(v1 + 1480) = v2 + 5;
      if ( v3 && *((_BYTE *)v3 + 6465) )
        CComposition::ScheduleCompositionPass(v3, 1000LL, 0x20000LL);
    }
    v4 = _InterlockedDecrement((volatile signed __int32 *)(v1 + 8));
    if ( v4 < -1 )
    ...
    if ( !v4 )
    {
      if ( _InterlockedAdd((volatile signed __int32 *)(v1 + 8), 1u) <= 0 )
        wil::details::in1diag3::Log_Hr(
          retaddr,
          (void *)0x18,
          (unsigned int)"onecoreuap\\windows\\dwm\\common\\shared\\refcountbase.cpp",
      ...
      v5 = _InterlockedDecrement((volatile signed __int32 *)(v1 + 8));
      if ( v5 < -1 )
        wil::details::in1diag3::Log_Hr(
          retaddr,
          (void *)0x26,
      ...
      if ( !v5 )
      {
        if ( _InterlockedDecrement((volatile signed __int32 *)(v1 + 8)) < -1 )
          wil::details::in1diag3::Log_Hr(
            retaddr,
            (void *)0x26,
            (unsigned int)"onecoreuap\\windows\\dwm\\common\\shared\\refcountbase.cpp",
