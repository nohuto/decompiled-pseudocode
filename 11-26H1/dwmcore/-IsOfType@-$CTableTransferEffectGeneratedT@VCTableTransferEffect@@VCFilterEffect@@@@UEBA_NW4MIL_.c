/*
 * XREFs of ?IsOfType@?$CTableTransferEffectGeneratedT@VCTableTransferEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1802852F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CTableTransferEffectGeneratedT<CTableTransferEffect,CFilterEffect>::IsOfType(__int64 a1, int a2)
{
  char v2; // al
  char v3; // cl
