/*
 * XREFs of ?ProcessSetSourceSize@CVisualSurface@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALSURFACE_SETSOURCESIZE@@@Z @ 0x1801BEEBC
 * Callers:
        ...
        const struct tagMILCMD_VISUALSURFACE_SETSOURCESIZE *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(CVisualSurface *, void *, char *))off_1803DC968)(
         this,
