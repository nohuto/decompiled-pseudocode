/*
 * XREFs of ?InitializeShadowEffect@CTreeEffectLayer@@AEAAJPEAUID2D1Effect@@AEBUD2D_MATRIX_3X2_F@@@Z @ 0x180017024
 * Callers:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x4AEu, 0LL);
  }
  else
  {
    v7 = *(_QWORD *)a2;
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x4B1u, 0LL);
    }
    else
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x4B4u, 0LL);
      }
      else
      {
        v10 = *(_QWORD *)a2;
        ...
        v6 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x4B6u, 0LL);
      }
    }
  }
  return v6;
