/*
 * XREFs of ?ProcessSetCommonParameters@CNaturalAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_NATURALANIMATION_SETCOMMONPARAMETERS@@@Z @ 0x180211A68
 * Callers:
        ...
        const struct tagMILCMD_NATURALANIMATION_SETCOMMONPARAMETERS *a3)
{
  ...
  *((_DWORD *)this + 88) = *((_DWORD *)a3 + 4);
  *((_DWORD *)this + 89) = *((_DWORD *)a3 + 3);
