/*
 * XREFs of ?InternalGetDXGIOutput@CDisplayManager@@AEAAJPEAUIDXGIAdapter1@@U_LUID@@IPEAPEAUIDXGIOutputDWM@@@Z @ 0x18019D9C8
 * Callers:
...
LABEL_32:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( v8 < 0 )
        break;
      if ( HighPart == v25[1] && LowPart == v25[0] && a4 == v25[2] )
      {
