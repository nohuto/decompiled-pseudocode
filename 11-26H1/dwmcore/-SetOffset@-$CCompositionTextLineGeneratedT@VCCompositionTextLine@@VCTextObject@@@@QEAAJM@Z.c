/*
 * XREFs of ?SetOffset@?$CCompositionTextLineGeneratedT@VCCompositionTextLine@@VCTextObject@@@@QEAAJM@Z @ 0x18024C38C
 * Callers:
...
__int64 __fastcall CCompositionTextLineGeneratedT<CCompositionTextLine,CTextObject>::SetOffset(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 96) )
  {
    *(float *)(a1 + 96) = a2;
