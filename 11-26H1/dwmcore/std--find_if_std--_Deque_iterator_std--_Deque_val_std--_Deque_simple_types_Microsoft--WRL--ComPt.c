/*
 * XREFs of std::find_if_std::_Deque_iterator_std::_Deque_val_std::_Deque_simple_types_Microsoft::WRL::ComPtr_CEffectCompilationTask_________CEffectCompilationService::TryAddDeadTask_::_6_::_lambda_1___ @ 0x18014D5CC
 * Callers:
...
__int64 **__fastcall std::find_if_std::_Deque_iterator_std::_Deque_val_std::_Deque_simple_types_Microsoft::WRL::ComPtr_CEffectCompilationTask_________CEffectCompilationService::TryAddDeadTask_::_6_::_lambda_1___(
        __int64 **a1,
        __int64 a2,
        __int64 a3,
        _QWORD *a4)
