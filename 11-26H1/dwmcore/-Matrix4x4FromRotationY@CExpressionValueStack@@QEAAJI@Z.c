/*
 * XREFs of ?Matrix4x4FromRotationY@CExpressionValueStack@@QEAAJI@Z @ 0x180215FC0
 * Callers:
 ...
 *     ?D2DMatrixRotationY@@YAPEAUD2DMatrix@@PEAU1@MUD2DVector3@@@Z @ 0x1801B82C0 (-D2DMatrixRotationY@@YAPEAUD2DMatrix@@PEAU1@MUD2DVector3@@@Z.c)
 *     ?D2DMatrixRotationY@@YAPEAUD2DMatrix@@PEAU1@M@Z @ 0x1801BA290 (-D2DMatrixRotationY@@YAPEAUD2DMatrix@@PEAU1@M@Z.c)
 */
  ...
  if ( a2 != 1 )
  {
    if ( a2 == 2 )
    {
      ...
      if ( *((_DWORD *)v15 + 16) == 18 && *((_DWORD *)v15 + 34) == 52 )
      {
        ...
        v12 = *((_QWORD *)v15 + 9);
        v13 = v6;
        D2DMatrixRotationY((__int64)v14, v7, (float *)&v12);
        goto LABEL_9;
      }
    }
LABEL_10:
  ...
  if ( *((_DWORD *)v15 + 16) != 18 )
    goto LABEL_10;
  D2DMatrixRotationY((struct D2DMatrix *)v14, *(float *)v15);
LABEL_9:
