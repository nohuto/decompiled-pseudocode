/*
 * XREFs of ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x1802242B4
 * Callers:
 ...
 * Callees:
 *     ??0heap_buffer@details_abi@wil@@QEAA@$$QEAU012@@Z @ 0x180222834 (--0heap_buffer@details_abi@wil@@QEAA@$$QEAU012@@Z.c)
