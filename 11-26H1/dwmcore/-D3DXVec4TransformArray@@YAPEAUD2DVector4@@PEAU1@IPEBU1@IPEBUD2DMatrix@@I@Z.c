/*
 * XREFs of ?D3DXVec4TransformArray@@YAPEAUD2DVector4@@PEAU1@IPEBU1@IPEBUD2DMatrix@@I@Z @ 0x1801A2C48
 * Callers:
        ...
        const struct D2DMatrix *a5)
{
  ...
  v5 = (float)((float)((float)(*((float *)a3 + 1) * *((float *)a5 + 5)) + (float)(*(float *)a3 * *((float *)a5 + 1)))
             + (float)(*((float *)a3 + 2) * *((float *)a5 + 9)))
     + (float)(*((float *)a3 + 3) * *((float *)a5 + 13));
  v6 = *((float *)a3 + 2);
  v7 = (float)((float)((float)(*((float *)a3 + 1) * *((float *)a5 + 6)) + (float)(*(float *)a3 * *((float *)a5 + 2)))
             + (float)(v6 * *((float *)a5 + 10)))
     + (float)(*((float *)a3 + 3) * *((float *)a5 + 14));
  v8 = *((float *)a3 + 3);
  result = a1;
  v10 = (float)((float)((float)(*((float *)a3 + 1) * *((float *)a5 + 7)) + (float)(*(float *)a3 * *((float *)a5 + 3)))
