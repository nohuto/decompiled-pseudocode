/*
 * XREFs of ?ProcessUpdate@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_MAGNIFIERRENDERTARGET@@@Z @ 0x180213D20
 * Callers:
        ...
        const struct tagMILCMD_MAGNIFIERRENDERTARGET *a3)
{
  ...
  v3 = (_OWORD *)((char *)this + 2384);
  if ( *((_DWORD *)this + 596) <= 6u )
  {
