/*
 * XREFs of ?SetColor@?$CPointLightGeneratedT@VCPointLight@@VCPositionedLight@@@@QEAAJU_D3DCOLORVALUE@@@Z @ 0x18024A918
 * Callers:
...
__int64 __fastcall CPointLightGeneratedT<CPointLight,CPositionedLight>::SetColor(CPositionedLight *this, __int128 *a2)
{
  _OWORD *v3; // rdx
  _OWORD *v4; // r8
  bool v5; // zf
  ...
  v7 = *a2;
  if ( !operator==((float *)&v7, (float *)this + 60) )
  {
