/*
 * XREFs of ??$ResolveProhibitedMotion@UDwmTouchpadInteractionConfigurationPrimitive@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@CInteractionProcessor@@AEAA_NAEBV?$DynArray@UDwmTouchpadInteractionConfigurationPrimitive@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x1801B90E0
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  do
  {
    ...
    if ( v11 >= *(_DWORD *)(*a2 + 12 * v9) && v11 <= *(_DWORD *)(v10 + 12 * v9 + 4) )
    {
      ...
      *(_QWORD *)(a3 + 4) = v19;
      *(_DWORD *)(a3 + 12) = v15;
      if ( !magic::AxisContainsInteraction((magic *)a3, v16) )
      {
        v8 = 0;
        *a4 = *((_DWORD *)a1 + 196);
      }
