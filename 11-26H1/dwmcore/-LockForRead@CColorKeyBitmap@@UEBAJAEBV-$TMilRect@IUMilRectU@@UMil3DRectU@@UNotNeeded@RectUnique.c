/*
 * XREFs of ?LockForRead@CColorKeyBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x1800E24E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorKeyBitmap::LockForRead(CColorKeyBitmap *this, _DWORD *a2, __int64 a3)
{
    ...
    || *v6 <= v26[0] && a2[3] <= v26[1] )
  {
    v7 = *(_QWORD *)this;
    v22 = 0LL;
    v8 = (enum DXGI_FORMAT *)(*(__int64 (__fastcall **)(CColorKeyBitmap *, _BYTE *))(v7 + 24))(this, v28);
