/*
 * XREFs of ?CopyFrom@CAtlasTexture@@QEAAXPEBV1@PEAI@Z @ 0x180105264
 * Callers:
 ...
 *     ?IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x1801054DC (-IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 *     ?IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x180105508 (-IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
...
LABEL_13:
        ...
        v16 = (*(__int64 (__fastcall **)(struct IDeviceTexture *, _QWORD))(*(_QWORD *)v29 + 120LL))(v29, 0LL);
        v17 = (*(__int64 (__fastcall **)(struct IDeviceTexture *, _QWORD))(*(_QWORD *)v30 + 120LL))(v30, 0LL);
        CD3DDevice::CopySubresourceRegion(v15, v17, 0, (unsigned int)&v31, v16, 0, 0, v7, 1);
        v18 = this[1];
        v19 = *(void (__fastcall **)(__int64, FastRegion::CRegion **))(v18[1] + 80);
