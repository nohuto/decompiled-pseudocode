/*
 * XREFs of ?SetGreenDisable@?$CLinearTransferEffectGeneratedT@VCLinearTransferEffect@@VCFilterEffect@@@@QEAAJ_N@Z @ 0x18024B218
 * Callers:
...
__int64 __fastcall CLinearTransferEffectGeneratedT<CLinearTransferEffect,CFilterEffect>::SetGreenDisable(
        __int64 a1,
        char a2)
{
  if ( a2 != *(_BYTE *)(a1 + 372) )
