/*
 * XREFs of ?OnSignaled@SubscriptionList@details_abi@wil@@QEAAXAEAVsrwlock@3@@Z @ 0x1801CD694
 * Callers:
 *     ?FlushUsage@FeatureStateManager@details@wil@@QEAAXXZ @ 0x180099650 (-FlushUsage@FeatureStateManager@details@wil@@QEAAXXZ.c)
 *     ?_lambda_invoker_cdecl_@_lambda_1_@?4??EnsureSubscribedToProcessWideUsageFlushUnderLock@FeatureStateManager@details@wil@@AEAAXXZ@SA@PEAX@Z @ 0x1801CD640 (-_lambda_invoker_cdecl_@_lambda_1_@-4--EnsureSubscribedToProcessWideUsageFlushUnderLock@FeatureS.c)
 *     ?_lambda_invoker_cdecl_@_lambda_1_@?4??EnsureSubscribedToStateChangesUnderLock@FeatureStateManager@details@wil@@CAJAEAV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?UnregisterWilFeatureConfigurationChange@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@@5@PEAX@Z@SA@1@Z @ 0x1801CD670 (-_lambda_invoker_cdecl_@_lambda_1_@-4--EnsureSubscribedToStateChangesUnderLock@FeatureStateManag.c)
 * Callees:
