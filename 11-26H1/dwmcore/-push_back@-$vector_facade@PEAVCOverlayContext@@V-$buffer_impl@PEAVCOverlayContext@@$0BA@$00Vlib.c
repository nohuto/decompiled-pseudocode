/*
 * XREFs of ?push_back@?$vector_facade@PEAVCOverlayContext@@V?$buffer_impl@PEAVCOverlayContext@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAXAEBQEAVCOverlayContext@@@Z @ 0x180141AC8
 * Callers:
...
__int64 __fastcall detail::vector_facade<COverlayContext *,detail::buffer_impl<COverlayContext *,16,1,detail::liberal_expansion_policy>>::push_back(
        _QWORD *a1,
        __int64 *a2)
{
  _QWORD *v2; // r12
  ...
  v26 = v24;
  v12 = 8 * v11;
  if ( v6 != &v6[v12 / 0xFFFFFFFFFFFFFFF8uLL] )
  {
    v13 = &v6[v12 / 0xFFFFFFFFFFFFFFF8uLL];
    do
    {
      --v6;
      stdext::checked_array_iterator<CScopedClipStack::ClippingScopeState *>::operator--(&v25);
      *(_QWORD *)stdext::checked_array_iterator<wil::com_ptr_t<CBackdropVisualImage,wil::err_returncode_policy> *>::operator->(&v25) = *v6;
    }
    while ( v6 != v13 );
    v5 = a1 + 1;
  }
