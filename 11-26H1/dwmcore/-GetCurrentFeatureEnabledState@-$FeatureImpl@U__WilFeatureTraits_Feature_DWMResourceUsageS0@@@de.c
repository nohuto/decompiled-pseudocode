/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DWMResourceUsageS0@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180252E0C
 * Callers:
        ...
        int *a4)
{
  ...
  *(_DWORD *)a2 = v13;
  ...
  {
    v16 = `wil::Feature<__WilFeatureTraits_Feature_CadBugs>::GetImpl'::`2'::impl;
    if ( (`wil::Feature<__WilFeatureTraits_Feature_CadBugs>::GetImpl'::`2'::impl & 4) == 0 )
    {
      v20 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_CadBugs>::GetCachedFeatureEnabledState(
               (wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_CadBugs>::GetImpl'::`2'::impl,
               &v20);
      v16 = v20;
    }
    LODWORD(v19) = 0;
    ...
    wil::details::ReportUsageToService(
      (volatile signed __int32 *)&unk_1803DEBE0,
      0x2F83C81u,
      (v16 >> 10) & 1,
      (v16 >> 11) & 1,
      (__int64)&v19,
