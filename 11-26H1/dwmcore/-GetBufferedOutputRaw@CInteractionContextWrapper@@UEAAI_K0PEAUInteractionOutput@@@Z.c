/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x180294970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1801ACFD4 (_anonymous_namespace_--ResetInteractionOutput.c)
...
{
  struct InteractionOutput *v4; // r14
