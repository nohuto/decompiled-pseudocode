/*
 * XREFs of ??1?$CQueue@PEAVCResource@@@@QEAA@XZ @ 0x1801ACDEC
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__CManipulationManager::s_InteractionUpdateQueue__ @ 0x1802B9FE0 (_dynamic_atexit_destructor_for__CManipulationManager--s_InteractionUpdateQueue__.c)
 * Callees:
