/*
 * XREFs of ?EnsureRenderThreadCanSendInputThreadMessages@CInputManager@@IEAAJXZ @ 0x180226A5C
 * Callers:
...
__int64 __fastcall CInputManager::EnsureRenderThreadCanSendInputThreadMessages(CInputManager *this)
{
  _QWORD *v1; // rsi
  __int64 v4; // rdi
  __int64 (__fastcall *v5)(__int64, const wchar_t *, _QWORD, _QWORD *); // rbx
  int v6; // eax
  unsigned int v7; // ebx
  ...
  wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
    v1,
    *v1);
  v6 = v5(v4, L"EdgyConfigurationEndpoint", 0LL, v1 + 1);
  v7 = v6;
  if ( v6 < 0 )
