/*
 * XREFs of ??1CDxHandleYUVBitmapRealization@@MEAA@XZ @ 0x1800FAD5C
 * Callers:
...
void __fastcall CDxHandleYUVBitmapRealization::~CDxHandleYUVBitmapRealization(CDxHandleYUVBitmapRealization *this)
{
  ...
  *((_QWORD *)this + 43) = &CDxHandleYUVBitmapRealization::`vftable'{for `IOverlayPlaneResource'};
  ...
  wil::com_ptr_t<CD3DVidMemOnlyTexture,wil::err_returncode_policy>::~com_ptr_t<CD3DVidMemOnlyTexture,wil::err_returncode_policy>((__int64 *)this + 47);
