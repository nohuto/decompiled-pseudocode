/*
 * XREFs of ?SetIndexData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x18021E68C
 * Callers:
        ...
        struct CResource *a2)
{
  if ( a2 != a1[13] )
  {
    CResource::ReplaceNotifier<CSceneMaterialInput>((CResource *)a1, a1 + 13, a2);
