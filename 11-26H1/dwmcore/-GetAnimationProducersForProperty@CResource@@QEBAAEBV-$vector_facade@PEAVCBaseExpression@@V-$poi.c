/*
 * XREFs of ?GetAnimationProducersForProperty@CResource@@QEBAAEBV?$vector_facade@PEAVCBaseExpression@@V?$pointer_buffer_impl@PEAVCBaseExpression@@$0A@@detail@@@detail@@UDCOMPOSITION_PROPERTY_ID@@@Z @ 0x180178560
 * Callers:
...
void *__fastcall CResource::GetAnimationProducersForProperty(__int64 a1, unsigned int a2)
{
  __int64 v2; // r8
  __int64 v3; // rax
  __int64 v4; // rcx
