/*
 * XREFs of ?GetShapeDataCore@CCombinedGeometry@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x1801C7A30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CShapePtr *a3)
{
  ...
  v16 = 0;
  v19 = 0LL;
  *((_DWORD *)this + 10) = v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 4)) & 0xC;
