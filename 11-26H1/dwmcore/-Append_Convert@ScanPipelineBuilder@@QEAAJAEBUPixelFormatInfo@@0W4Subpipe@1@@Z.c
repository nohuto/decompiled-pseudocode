/*
 * XREFs of ?Append_Convert@ScanPipelineBuilder@@QEAAJAEBUPixelFormatInfo@@0W4Subpipe@1@@Z @ 0x1802B4FF0
 * Callers:
 ...
 *     ?GetNearestInterchangeFormat@@YA?AW4DXGI_FORMAT@@W41@@Z @ 0x1802B55DC (-GetNearestInterchangeFormat@@YA-AW4DXGI_FORMAT@@W41@@Z.c)
 *     ?GetOp_AlphaDivide@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z @ 0x1802B561C (-GetOp_AlphaDivide@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z.c)
 *     ?GetOp_IgnoreAlpha@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z @ 0x1802B5668 (-GetOp_IgnoreAlpha@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z.c)
 */
  ...
  else
  {
    ...
    if ( *(_DWORD *)a3 != v12 )
    {
      switch ( *(_DWORD *)a3 )
      {
        ...
        case 0x41:
          ...
          break;
        case 0x43:
          v18 = (void (*)(const struct PipelineParams *, const struct ScanOpParams *))Convert_999e5RGB_128bppABGR;
          break;
        default:
      ...
      && !IsNoAlphaFormOf((enum DXGI_FORMAT)*(_DWORD *)a2, NearestInterchangeFormat) )
    {
      ...
      else if ( *(_DWORD *)a2 != 28 )
      {
        if ( *(_DWORD *)a2 == 67 )
        {
          v17 = (void (*)(const struct PipelineParams *, const struct ScanOpParams *))Convert_128bppABGR_999e5RGB;
        }
        else
        {
