/*
 * XREFs of ?ShouldChainForAxis@CInteractionTracker2@@UEBA_NW4ScrollAxis@@PEBVCManipulation@@_N@Z @ 0x1801BD920
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CInteractionTracker2::ShouldChainForAxis(__int64 a1, int a2, __int64 a3, unsigned __int8 a4)
{
  __int128 v5; // xmm1
  char v6; // bl
  __int128 v7; // xmm0
...
LABEL_29:
  ...
  else if ( a4 | ((v26 & 0x100000000LL) == 0) || (_DWORD)v25 == 1 )
  {
    v19 = *(_DWORD *)(a3 + 472);
    if ( v19 )
    {
