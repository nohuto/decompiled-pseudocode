/*
 * XREFs of __GSHandlerCheck_SEH @ 0x1802B9590
 * Callers:
 *     <none>
 * Callees:
 *     __GSHandlerCheckCommon @ 0x180221144 (__GSHandlerCheckCommon.c)
 *     __C_specific_handler_0 @ 0x18022159C (__C_specific_handler_0.c)
 */
