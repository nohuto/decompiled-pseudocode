/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Capture_WindowExclusionBackport@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180257D38
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_Capture_WindowExclusionBackport>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_Capture_WindowExclusionBackport>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v7);
    v7 = v3;
  }
