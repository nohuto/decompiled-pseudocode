/*
 * XREFs of ?Initialize@CColorKeyBitmap@@IEAAJPEAVIBitmapRealization@@@Z @ 0x180158D4C
 * Callers:
  ...
  *v2 = 0LL;
         ...
         v2) >= 0 )
  {
    ...
    if ( inited < 0 )
      ...
      wil::com_ptr_t<CDeviceTexture,wil::err_returncode_policy>::operator=((__int64 *)this + 3, (__int64)a2);
  }
  else
  {
    v6 = -2003292287;
