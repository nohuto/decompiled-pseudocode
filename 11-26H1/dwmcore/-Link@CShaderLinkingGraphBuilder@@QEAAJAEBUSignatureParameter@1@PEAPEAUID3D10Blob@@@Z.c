/*
 * XREFs of ?Link@CShaderLinkingGraphBuilder@@QEAAJAEBUSignatureParameter@1@PEAPEAUID3D10Blob@@@Z @ 0x18014700C
 * Callers:
        ...
        struct ID3D10Blob **a3)
{
  ...
  __int64 v25; // rcx
  const CHAR *v26; // rax
  __int128 v27; // [rsp+40h] [rbp-69h]
  _BYTE v28[40]; // [rsp+50h] [rbp-59h]
  _QWORD v29[2]; // [rsp+80h] [rbp-29h] BYREF
  _OWORD v30[3]; // [rsp+90h] [rbp-19h] BYREF
  __int64 v31; // [rsp+C0h] [rbp+17h]
  struct ID3D10Blob *v32; // [rsp+110h] [rbp+67h] BYREF
  const struct CShaderLinkingGraphBuilder::SignatureParameter *v33; // [rsp+118h] [rbp+6Fh] BYREF
  ...
  *(_OWORD *)&v28[24] = 0LL;
  ...
  v32 = 0LL;
  v33 = 0LL;
  v31 = *(_OWORD *)&_mm_unpackhi_pd(*(__m128d *)&v28[24], *(__m128d *)&v28[24]);
  *(_QWORD *)v28 = 0x100000003LL;
  *(_DWORD *)&v28[8] = 1;
  *(_DWORD *)&v28[20] = 2;
  v30[1] = *(_OWORD *)v28;
  v30[2] = *(_OWORD *)&v28[16];
  ...
  v29[1] = &unk_1802DBA40;
  v29[0] = 1LL;
  v10 = CShaderLinkingGraphBuilder::FulfillInputs(this, v33, v29);
  v9 = v10;
  if ( v10 < 0 )
  {
