/*
 * XREFs of ?ProcessStartPointUpdate@CInk@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INK_STARTPOINTUPDATE@@@Z @ 0x18019A54C
 * Callers:
        ...
        const struct tagMILCMD_INK_STARTPOINTUPDATE *a3)
{
  ...
  *((_DWORD *)this + 45) = *((_DWORD *)a3 + 3);
  ...
  for ( i = 0LL; (unsigned int)i < (unsigned int)v6; i = (unsigned int)(i + 1) )
  {
    ...
    ReleaseInterface<ID2D1Geometry>((__int64 *)&v10);
  }
