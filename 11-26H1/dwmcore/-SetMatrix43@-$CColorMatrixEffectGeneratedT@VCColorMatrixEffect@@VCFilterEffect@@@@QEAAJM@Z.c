/*
 * XREFs of ?SetMatrix43@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BE68
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix43(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 408) )
  {
    *(float *)(a1 + 408) = a2;
