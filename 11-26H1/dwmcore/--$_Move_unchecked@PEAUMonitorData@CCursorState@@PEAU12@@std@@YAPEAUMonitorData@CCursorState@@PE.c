/*
 * XREFs of ??$_Move_unchecked@PEAUMonitorData@CCursorState@@PEAU12@@std@@YAPEAUMonitorData@CCursorState@@PEAU12@00@Z @ 0x18028FEE0
 * Callers:
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      ...
      *(_OWORD *)(v5 + 68) = *(_OWORD *)(v6 + 68);
      std::shared_ptr<CRegion>::operator=(v5 + 84, (__int64 *)(v6 + 84));
      v3 += 16;
