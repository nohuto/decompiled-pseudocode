/*
 * XREFs of ??$_Get_unwrapped_n@AEAV?$checked_array_iterator@PEAG@stdext@@_J@std@@YA?A_TAEAV?$checked_array_iterator@PEAG@stdext@@_J@Z @ 0x18000A74C
 * Callers:
...
__int64 __fastcall std::_Get_unwrapped_n<stdext::checked_array_iterator<unsigned short *> &,__int64>(_QWORD *a1)
{
