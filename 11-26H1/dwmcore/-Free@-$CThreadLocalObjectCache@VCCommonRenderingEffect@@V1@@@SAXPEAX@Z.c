/*
 * XREFs of ?Free@?$CThreadLocalObjectCache@VCCommonRenderingEffect@@V1@@@SAXPEAX@Z @ 0x18018769C
 * Callers:
...
int __fastcall CThreadLocalObjectCache<CCommonRenderingEffect,CCommonRenderingEffect>::Free(_QWORD *lpMem)
{
  _DWORD *Value; // rbx
  __int64 v3; // rax
  ...
  LODWORD(v3) = Value[68];
  if ( Value[69] < (unsigned int)v3 )
  {
    v3 = *((_QWORD *)Value + 35);
    *lpMem = v3;
    ++Value[69];
    *((_QWORD *)Value + 35) = lpMem;
  }
  else if ( lpMem )
  {
