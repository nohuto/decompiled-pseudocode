/*
 * XREFs of ?DistSquaredToLine@@YAMAEBUfloat2@Numerics@Foundation@Windows@@00@Z @ 0x1800D0D94
 * Callers:
 ...
 *     ?DoesPolygonHaveEdgeThatContainsAllPoints@CVisualDepthGeometry@@AEBA_NPEBUfloat3@Numerics@Foundation@Windows@@H@Z @ 0x18020E498 (-DoesPolygonHaveEdgeThatContainsAllPoints@CVisualDepthGeometry@@AEBA_NPEBUfloat3@Numerics@Founda.c)
 * Callees:
 *     <none>
 */
        ...
        const struct Windows::Foundation::Numerics::float2 *a3)
{
  ...
  v4 = (float)((float)((float)(*((float *)a1 + 1) - *((float *)a2 + 1)) * v3)
     ...
     / (float)((float)(v3 * v3) + (float)(*(float *)a3 * *(float *)a3));
  v5 = (float)((float)(v4 * v3) + *((float *)a2 + 1)) - *((float *)a1 + 1);
  v6 = (float)((float)(v4 * *(float *)a3) + *(float *)a2) - *(float *)a1;
