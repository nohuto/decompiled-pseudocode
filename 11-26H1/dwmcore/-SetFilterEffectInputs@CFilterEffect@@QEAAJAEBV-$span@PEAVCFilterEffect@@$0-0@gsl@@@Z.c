/*
 * XREFs of ?SetFilterEffectInputs@CFilterEffect@@QEAAJAEBV?$span@PEAVCFilterEffect@@$0?0@gsl@@@Z @ 0x18021B5F8
 * Callers:
...
__int64 __fastcall CFilterEffect::SetFilterEffectInputs(__int64 a1, __int64 a2)
{
  char **v2; // rcx
  char *v4; // rax
  char *v5; // rdx
