/*
 * XREFs of ?SelectInertiaModifierForAxis@CInteractionTracker2@@UEAAJW4ScrollAxis@@PEAVCExpressionValueStack@@PEAPEAUIScalarForce@@@Z @ 0x1802756A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteractionTracker2::SelectInertiaModifierForAxis(
        __int64 *a1,
        int a2,
        ...
        _QWORD *a4)
{
  ...
  __int64 (__fastcall ***v43)(_QWORD); // [rsp+30h] [rbp-30h] BYREF
  ...
  v7 = a3;
  v44 = 0LL;
  if ( !InteractionSourceManager::IsInertiaEnabledForAxis((InteractionSourceManager *)(a1 + 66)) )
    goto LABEL_41;
  v8 = 0;
  v9 = (CConditionalExpression *)(*(__int64 (__fastcall **)(__int64 *, _QWORD))(*a1 + 520))(a1, (unsigned int)v4);
  v10 = v9;
  if ( v9 )
  {
  ...
  {
    v13 = 3;
    if ( (*(__int64 (__fastcall **)(__int64 *, __int64))(*a1 + 512))(a1, 3LL) )
    {
      v10 = (CConditionalExpression *)(*(__int64 (__fastcall **)(__int64 *, __int64))(*a1 + 512))(a1, 3LL);
      LOBYTE(v45) = 0;
...
LABEL_41:
  ...
  v13 = *(_DWORD *)(a1[v4 + 92] + 4LL * *((int *)v10 + 87));
LABEL_15:
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v44);
  CInteractionTracker2::GetAnimationForAxis(a1, v4, &v44);
  v14 = v13 - 1;
  if ( !v14 )
  {
    LODWORD(v45) = 0;
    ...
    if ( IsAnyConditionSatisfied >= 0 )
    {
      ...
      {
        v12 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0xE21u, 0LL);
        goto LABEL_42;
      }
      *((_DWORD *)v32 + 2) = 0;
      ...
      *(_DWORD *)((*(__int64 (__fastcall **)(CScrollAnimation *))(*(_QWORD *)v39 + 264LL))(v39) + 32) = 1114636288;
      Microsoft::WRL::ComPtr<IScalarForce>::operator=<CScalarForce>((__int64 *)&v43, &v45);
      if ( v38 )
...
LABEL_60:
  ...
  if ( !v15 )
  {
    ...
    *(_DWORD *)((*(__int64 (__fastcall **)(CScrollAnimation *))(*(_QWORD *)v27 + 264LL))(v27) + 32) = 1101004800;
    ...
    {
      v12 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0xE44u, 0LL);
      goto LABEL_42;
    }
    goto LABEL_41;
  }
  if ( v15 == 1 )
  {
    ...
    IsEnabled = wil::details::FeatureImpl<__WilFeatureTraits_Feature_1017417018>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_1017417018>::GetImpl'::`2'::impl);
    v17 = v45;
    if ( IsEnabled )
    {
      if ( !v45
      ...
      Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease((__int64 *)&v43);
      v18 = v44;
      CScrollAnimation::GetVelocity(v44);
      ...
      if ( v8 == 1 )
      {
        ...
        if ( ForceForAxis < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, ForceForAxis, 0xE5Du, 0LL);
LABEL_25:
...
LABEL_26:
      ...
      else
      {
        ...
        if ( v20 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v20, 0xE66u, 0LL);
          goto LABEL_25;
        }
      }
    ...
    if ( v8 == 1 )
    {
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v22, 0xE78u, 0LL);
        goto LABEL_35;
      }
    }
    else
    {
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v23, 0xE81u, 0LL);
LABEL_35:
        if ( !v17 )
          goto LABEL_26;
        goto LABEL_25;
...
LABEL_39:
  ...
  v12 = -2147467259;
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147467259, 0xE8Du, 0LL);
LABEL_42:
  *v47 = v5;
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v44);
  Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease((__int64 *)&v43);
