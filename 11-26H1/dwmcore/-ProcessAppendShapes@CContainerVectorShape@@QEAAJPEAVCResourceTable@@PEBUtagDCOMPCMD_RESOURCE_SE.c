/*
 * XREFs of ?ProcessAppendShapes@CContainerVectorShape@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_RESOURCE_SETCOLLECTIONPROPERTY@@PEBXI@Z @ 0x180249854
 * Callers:
...
__int64 __fastcall CContainerVectorShape::ProcessAppendShapes(
