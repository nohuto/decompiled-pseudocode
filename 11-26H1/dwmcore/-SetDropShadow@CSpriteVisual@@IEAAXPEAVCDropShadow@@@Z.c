/*
 * XREFs of ?SetDropShadow@CSpriteVisual@@IEAAXPEAVCDropShadow@@@Z @ 0x180078ACC
 * Callers:
...
void __fastcall CSpriteVisual::SetDropShadow(CSpriteVisual *this, struct CDropShadow *a2)
{
  ...
  if ( a2 )
  {
    if ( v4 )
    {
      Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v2, 14LL);
      if ( Slot < *(_DWORD *)(v9 + 4) )
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((char *)this + 224, 14LL) = a2;
    }
  }
  else if ( v4 )
  {
    *v2 &= ~0x40000u;
    v5 = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v2, 14LL);
    if ( v5 < *(_DWORD *)(v6 + 4) )
      *(_BYTE *)(v5 + v6 + 8) = v7;
  }
}
