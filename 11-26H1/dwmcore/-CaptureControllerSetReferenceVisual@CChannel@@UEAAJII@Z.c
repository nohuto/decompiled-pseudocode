/*
 * XREFs of ?CaptureControllerSetReferenceVisual@CChannel@@UEAAJII@Z @ 0x180232730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetReferenceVisual(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle((__int64)this, a3, 156);
  v8[0] = 383;
  v8[1] = a2;
  v8[2] = a3;
