/*
 * XREFs of ?ProcessTrigger@CLegacyAnimationTrigger@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_LEGACYANIMATIONTRIGGER_TRIGGER@@@Z @ 0x18021A384
 * Callers:
...
{
  unsigned __int64 FrameTargetTime; // rsi
  unsigned int v4; // ebp
  __int64 i; // rdi
  _QWORD *v7; // rcx
  int v8; // eax
