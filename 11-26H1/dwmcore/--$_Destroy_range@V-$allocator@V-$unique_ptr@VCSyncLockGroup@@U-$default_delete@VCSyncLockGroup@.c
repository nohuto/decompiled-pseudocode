/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@std@@@std@@YAXPEAV?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@0@QEAV10@AEAV?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@0@@Z @ 0x180237A1C
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__CSyncLockGroup::g_syncLockGroups__ @ 0x1802B9920 (_dynamic_atexit_destructor_for__CSyncLockGroup--g_syncLockGroups__.c)
 * Callees:
