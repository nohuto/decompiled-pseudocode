/*
 * XREFs of ?CreateCompositionSwapChain@CD3DDevice@@QEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVCCompSwapChain@@@Z @ 0x18029904C
 * Callers:
        ...
        struct CCompSwapChain **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( !*((_DWORD *)this + 281) )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          DXGIFactory = v12(v11, *((_QWORD *)this + 68), v16, &v20, 0LL, &v17);
          v9 = DXGIFactory;
          if ( DXGIFactory < 0 )
          {
            v15 = 1016;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803A26B0, 2u, DXGIFactory, v15, 0LL);
    goto LABEL_16;
  }
  v9 = -2003304307;
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803A26B0, 2u, -2003304307, 0x3D6u, 0LL);
LABEL_16:
