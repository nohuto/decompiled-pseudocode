/*
 * XREFs of ?SetClampOutput@?$CLinearTransferEffectGeneratedT@VCLinearTransferEffect@@VCFilterEffect@@@@QEAAJ_N@Z @ 0x18024A720
 * Callers:
...
__int64 __fastcall CLinearTransferEffectGeneratedT<CLinearTransferEffect,CFilterEffect>::SetClampOutput(
        __int64 a1,
        char a2)
{
  if ( a2 != *(_BYTE *)(a1 + 397) )
