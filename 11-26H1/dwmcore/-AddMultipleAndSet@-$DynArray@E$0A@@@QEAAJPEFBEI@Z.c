/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@E$0A@@@QEAAJPEFBEI@Z @ 0x180125A30
 * Callers:
...
__int64 __fastcall DynArray<unsigned char,0>::AddMultipleAndSet(__int64 a1, void *a2, unsigned int a3)
{
  __int64 v3; // rax
  unsigned int v5; // esi
  unsigned int v6; // ebx
