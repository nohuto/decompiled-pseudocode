/*
 * XREFs of ?SetMatrix13@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024A184
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix13(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 360) )
  {
    *(float *)(a1 + 360) = a2;
