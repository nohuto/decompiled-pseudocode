/*
 * XREFs of ?GetBits@CRenderTargetBitmap@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x1801B5EA0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a5)
{
  ...
  __int64 v17; // rax
  __int64 v18; // rdi
  struct PixelFormatInfo *v19; // rbx
  struct ID3D11Texture2D *v20; // rax
  int v22; // r9d
  ...
  if ( v14 >= 0 )
  {
    ...
    {
      v16 = *(__int64 (__fastcall **)(char *, __int64, __int64 *))(*(_QWORD *)v5 + 104LL);
      ...
      else
      {
        ...
        v19 = (struct PixelFormatInfo *)(*(__int64 (__fastcall **)(char *, _BYTE *))(*(_QWORD *)v5 + 24LL))(v5, v27);
        v20 = (struct ID3D11Texture2D *)(*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v24 + 120LL))(v24, 0LL);
        v14 = CD3DDevice::CopyTexture2D(
                v18,
                v20,
                0,
                v19,
                v26,
                (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))a3,
                a4,
                a5);
        v15 = v14;
        if ( v14 >= 0 )
