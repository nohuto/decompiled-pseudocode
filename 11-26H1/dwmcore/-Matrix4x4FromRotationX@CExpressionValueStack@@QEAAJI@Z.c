/*
 * XREFs of ?Matrix4x4FromRotationX@CExpressionValueStack@@QEAAJI@Z @ 0x180215EA0
 * Callers:
 ...
 *     ?D2DMatrixRotationX@@YAPEAUD2DMatrix@@PEAU1@M@Z @ 0x1801B5570 (-D2DMatrixRotationX@@YAPEAUD2DMatrix@@PEAU1@M@Z.c)
 *     ?D2DMatrixRotationX@@YAPEAUD2DMatrix@@PEAU1@MUD2DVector3@@@Z @ 0x1801B7F8C (-D2DMatrixRotationX@@YAPEAUD2DMatrix@@PEAU1@MUD2DVector3@@@Z.c)
 */
  ...
  if ( a2 != 1 )
  {
    if ( a2 == 2 )
    {
      ...
      if ( *((_DWORD *)v15 + 16) == 18 && *((_DWORD *)v15 + 34) == 52 )
      {
        ...
        v12 = *((_QWORD *)v15 + 9);
        v13 = v6;
        D2DMatrixRotationX((__int64)v14, v7, (__int64)&v12);
        goto LABEL_9;
      }
    }
LABEL_10:
  ...
  if ( *((_DWORD *)v15 + 16) != 18 )
    goto LABEL_10;
  D2DMatrixRotationX((struct D2DMatrix *)v14, *(float *)v15);
LABEL_9:
