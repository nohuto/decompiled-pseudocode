/*
 * XREFs of ?Build@CProjectedShadowApproxBlurGraphBuilder@@SAJPEAVCBrush@@0PEAPEAVCBrushRenderingGraph@@PEAPEAUIEffectInstance@Composition@UI@Windows@@@Z @ 0x18028847C
 * Callers:
        ...
        struct Windows::UI::Composition::IEffectInstance **a4)
{
  ...
  CBrushRenderingGraph *v9; // rax
  struct CBrushRenderingGraph *v10; // rdi
  int v11; // eax
  unsigned int v12; // ebx
  CBrushRenderingGraph *v14; // [rsp+30h] [rbp-28h] BYREF
...
LABEL_7:
  ...
  (**(void (__fastcall ***)(CBrushRenderingGraph *))v9)(v9);
  v15 = v10;
  v16 = 0;
