/*
 * XREFs of ?GetSize@CCompressedSourceBitmap@@UEAAJPEAI0@Z @ 0x1800E0B20
 * Callers:
 *     ?GetSize@CCompressedSourceBitmap@@WCA@EAAJPEAI0@Z @ 0x180224A40 (-GetSize@CCompressedSourceBitmap@@WCA@EAAJPEAI0@Z.c)
 * Callees:
