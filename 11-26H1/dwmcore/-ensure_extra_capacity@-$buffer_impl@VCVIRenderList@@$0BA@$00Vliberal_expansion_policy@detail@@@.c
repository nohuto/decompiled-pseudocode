/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@VCVIRenderList@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x180170928
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  v2 = a1[1];
  v4 = a1[2];
  if ( 0xCCCCCCCCCCCCCCCDuLL * ((v4 - v2) >> 3) < a2 )
  {
    v5 = 0xCCCCCCCCCCCCCCCDuLL * ((v2 - *a1) >> 3);
    if ( v5 + a2 < v5 )
    {
      std::_Xoverflow_error("overflow");
      __debugbreak();
      JUMPOUT(0x1801709A9LL);
    }
    v6 = detail::liberal_expansion_policy::expand(
           (detail::liberal_expansion_policy *)(0xCCCCCCCCCCCCCCCDuLL * ((v4 - *a1) >> 3)),
           0xCCCCCCCCCCCCCCCDuLL * ((v4 - *a1) >> 3),
           v5 + a2);
    ...
    v14 = v12;
    v15 = v13;
    std::uninitialized_move<std::move_iterator<CVIRenderList *>,stdext::checked_array_iterator<CVIRenderList *>>(
      &v12,
      v9,
      v8,
      &v14);
