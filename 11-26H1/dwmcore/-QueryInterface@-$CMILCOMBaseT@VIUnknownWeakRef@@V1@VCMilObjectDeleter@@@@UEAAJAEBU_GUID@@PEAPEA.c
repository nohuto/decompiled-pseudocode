/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@VIUnknownWeakRef@@V1@VCMilObjectDeleter@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18022C070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<IUnknownWeakRef,IUnknownWeakRef,CMilObjectDeleter>::QueryInterface(
        __int64 a1,
        _QWORD *a2,
        _QWORD *a3)
{
