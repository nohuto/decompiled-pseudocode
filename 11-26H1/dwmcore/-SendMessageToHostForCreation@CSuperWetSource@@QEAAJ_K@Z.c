/*
 * XREFs of ?SendMessageToHostForCreation@CSuperWetSource@@QEAAJ_K@Z @ 0x1802639D8
 * Callers:
...
LABEL_3:
  ...
  LODWORD(v14) = 8;
  *((_QWORD *)&v14 + 1) = a2;
  v8 = *(_OWORD *)(v7[2] + 104LL);
  v15.m256i_i64[0] = v7[5];
  v9 = v7[3];
  v17[1] = v8;
  ...
  *(_OWORD *)((char *)&v15.m256i_u64[1] + 4) = v11;
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x80000) != 0 )
    McTemplateU0xx_EventWriteTransfer(v13, &EVTDESC_REGISTER_VAIL_STROKE_ON_HOST, this, a2);
  return 0LL;
}
