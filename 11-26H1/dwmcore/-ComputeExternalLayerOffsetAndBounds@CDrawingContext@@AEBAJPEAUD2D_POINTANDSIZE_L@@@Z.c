/*
 * XREFs of ?ComputeExternalLayerOffsetAndBounds@CDrawingContext@@AEBAJPEAUD2D_POINTANDSIZE_L@@@Z @ 0x1800C8498
 * Callers:
        ...
        struct D2D_POINTANDSIZE_L *a2)
{
  ...
  *(_OWORD *)v6 = 0LL;
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v3, 0xDF4u, 0LL);
  return v4;
}
