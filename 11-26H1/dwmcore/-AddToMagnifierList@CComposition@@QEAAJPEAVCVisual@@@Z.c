/*
 * XREFs of ?AddToMagnifierList@CComposition@@QEAAJPEAVCVisual@@@Z @ 0x18022A864
 * Callers:
...
__int64 __fastcall CComposition::AddToMagnifierList(CComposition *this, struct CVisual *a2)
{
  ...
  v2 = (CResource **)((char *)this + 6176);
  v4 = (CVisualGroup *)*((_QWORD *)this + 772);
  if ( v4 )
    goto LABEL_6;
...
LABEL_6:
    ...
    v7 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v8, 0xA43u, 0LL);
  }
  else
  {
    v7 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0xA40u, 0LL);
  }
  return v7;
}
