/*
 * XREFs of ?SetClampOutput@?$CTableTransferEffectGeneratedT@VCTableTransferEffect@@VCFilterEffect@@@@QEAAJ_N@Z @ 0x18024A76C
 * Callers:
...
__int64 __fastcall CTableTransferEffectGeneratedT<CTableTransferEffect,CFilterEffect>::SetClampOutput(
        __int64 a1,
        char a2)
{
  if ( a2 != *(_BYTE *)(a1 + 356) )
