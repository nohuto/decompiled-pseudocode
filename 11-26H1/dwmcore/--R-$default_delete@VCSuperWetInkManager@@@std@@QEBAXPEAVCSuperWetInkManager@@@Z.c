/*
 * XREFs of ??R?$default_delete@VCSuperWetInkManager@@@std@@QEBAXPEAVCSuperWetInkManager@@@Z @ 0x18022A3E0
 * Callers:
 *     ?Initialize@CComposition@@MEAAJXZ @ 0x1800779B0 (-Initialize@CComposition@@MEAAJXZ.c)
 *     ??1?$unique_ptr@VCSuperWetInkManager@@U?$default_delete@VCSuperWetInkManager@@@std@@@std@@QEAA@XZ @ 0x1802299D0 (--1-$unique_ptr@VCSuperWetInkManager@@U-$default_delete@VCSuperWetInkManager@@@std@@@std@@QEAA@X.c)
 * Callees:
