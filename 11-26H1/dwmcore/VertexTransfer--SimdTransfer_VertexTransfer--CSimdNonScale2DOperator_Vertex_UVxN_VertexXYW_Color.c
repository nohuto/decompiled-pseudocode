/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____1_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x180065E30
 * Callers:
        ...
        unsigned __int64 *a2)
{
  ...
  v9 = _mm_movelh_ps((__m128)a2[6], (__m128)_mm_load_si128((const __m128i *)&_xmm));
  if ( v4 )
  {
    do
    {
