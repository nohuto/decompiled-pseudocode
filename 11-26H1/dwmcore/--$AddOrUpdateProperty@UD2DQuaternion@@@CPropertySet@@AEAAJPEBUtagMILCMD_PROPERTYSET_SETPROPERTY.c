/*
 * XREFs of ??$AddOrUpdateProperty@UD2DQuaternion@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DQuaternion@@@Z @ 0x180167AEC
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DQuaternion>(__int64 a1, __int64 a2, __int64 a3)
{
  int updated; // eax
  unsigned int v6; // ebx
  int v8; // ebx
...
LABEL_10:
  ...
  updated = CPropertySet::UpdateProperty<D2DQuaternion>(a1, *(unsigned int *)(a2 + 8));
  v6 = updated;
  if ( updated < 0 )
  {
    v9 = 338;
