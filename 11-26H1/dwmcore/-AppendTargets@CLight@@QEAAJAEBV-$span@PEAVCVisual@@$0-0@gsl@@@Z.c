/*
 * XREFs of ?AppendTargets@CLight@@QEAAJAEBV?$span@PEAVCVisual@@$0?0@gsl@@@Z @ 0x180264440
 * Callers:
...
__int64 __fastcall CLight::AppendTargets(__int64 *a1, _QWORD *a2)
{
  __int64 *v2; // rbx
  __int64 *v4; // rsi
  _QWORD *v5; // rdi
