/*
 * XREFs of ?GetBounds@CGenericInk@@UEBAJAEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801249F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CGenericInk::GetBounds(__int64 a1, __int64 a2, float *a3)
{
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v6, 0x127u, 0LL);
    return v3;
  }
...
LABEL_7:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v7, 0x128u, 0LL);
  return v3;
}
