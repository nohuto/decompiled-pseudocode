/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1802431BC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      v13[1] = v16;
      return CoreUICallSend(v11, v13, 2LL, 4LL, 1, &unk_180373365, a2, v12, v15);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
