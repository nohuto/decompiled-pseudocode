/*
 * XREFs of ?SetMatrix54@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BFF8
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix54(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 428) )
  {
    *(float *)(a1 + 428) = a2;
