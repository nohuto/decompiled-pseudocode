/*
 * XREFs of ?IsOfType@?$CSaturationEffectGeneratedT@VCSaturationEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180249080
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CSaturationEffectGeneratedT<CSaturationEffect,CFilterEffect>::IsOfType(__int64 a1, int a2)
{
  char v2; // al
  char v3; // cl
