/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@ULightVSConstantBuffer@@@@QEAAJPEAVCD3DDevice@@W4D3D11_USAGE@@@Z @ 0x18011A870
 * Callers:
...
__int64 __fastcall CTypedConstantBuffer<LightVSConstantBuffer>::Initialize(__int64 *a1, __int64 a2)
{
  unsigned int v2; // edi
  int v5; // eax
  int v6; // ebx
  ...
  if ( !*a1 )
  {
    ...
    *a1 = 0LL;
    ...
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD *, _QWORD *, __int64 *))(**(_QWORD **)(a2 + 544) + 24LL))(
             *(_QWORD *)(a2 + 544),
             v10,
             v9,
             a1);
