/*
 * XREFs of ?UpdateClientInfo@CDesktopTree@@MEAAXXZ @ 0x180140BE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDesktopTree::UpdateClientInfo(CDesktopTree *this)
{
  ...
  v1 = (char *)this + 4056;
  detail::vector_facade<CResponseItemBase *,detail::buffer_impl<CResponseItemBase *,2,1,detail::liberal_expansion_policy>>::clear((__int64 *)this + 507);
  *((_QWORD *)this + 514) = 0LL;
