/*
 * XREFs of ?TranslateExecutePresentResult@CDDisplaySwapChain@@IEAAJW4DisplayPresentStatus@Core@Display@Devices@Windows@@W4DisplaySourceStatus@3456@PEA_N@Z @ 0x1801ACB94
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::TranslateExecutePresentResult(__int64 a1, int a2, int a3, _BYTE *a4)
{
  ...
  else
  {
    ...
    if ( !v9 )
    {
      v14 = *(void (__fastcall ****)(_QWORD, GUID *, __int64 *))(a1 + 424);
      v17 = 0;
      v16[0] = 0LL;
      (**v14)(v14, &GUID_3c27105f_c15d_59c7_9466_ab281cf08ab7, v16);
      v15 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v16[0] + 48LL))(v16[0], &v17);
      v4 = v15;
      if ( v15 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0x43Cu, 0LL);
      if ( v17 )
        v4 = -2003304442;
      else
        *a4 = 1;
LABEL_22:
    ...
    if ( v10 == 1 )
    {
      ...
      v17 = 0;
      v16[0] = 0LL;
      (**v11)(v11, &GUID_3c27105f_c15d_59c7_9466_ab281cf08ab7, v16);
      v12 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v16[0] + 48LL))(v16[0], &v17);
      v4 = v12;
      if ( v12 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x417u, 0LL);
      if ( !v17 )
      {
        v13 = v16[0];
        *a4 = 1;
      ...
      v4 = -2003304442;
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304442, 0x41Du, 0LL);
      goto LABEL_22;
    }
  }
