/*
 * XREFs of ?ResetDefaultInteractionForCurrentMC@CInteraction@@QEAAX_N@Z @ 0x1801D0A50
 * Callers:
...
void __fastcall CInteraction::ResetDefaultInteractionForCurrentMC(CInteraction *this)
{
  *((_BYTE *)this + 200) ^= (*((_BYTE *)this + 200) ^ (2 * *((_BYTE *)this + 200))) & 0x20;
