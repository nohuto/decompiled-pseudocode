...
void __fastcall CEnergyReporter::SendReportToE3(CEnergyReporter *this)
{
  ...
  v10 = v9;
  v3 = *(_QWORD *)(v1 + 8);
  v12 = std::_Func_impl_no_alloc__CEnergyReporter::SendReportToE3_::_2_::_lambda_1__void_void___unsigned_long_unsigned___int64_unsigned_short_const___enum_ProcessAttributionFlags_ProcessAttributionResourceCounters_const___::_Move(
          v9,
          v11);
  ...
  if ( *((_DWORD *)this + 10) )
  {
    ...
    if ( *((_BYTE *)this + 80) )
    {
      if ( *((_BYTE *)this + 81) )
      {
        if ( (unsigned int)dword_1803DC7D4 < MEMORY[0x7FFE037C] && !(unsigned __int8)EtwCheckCoverage(&off_1803DC7C8) )
          NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_1803DC7C8, 0x18u);
      }
    ...
    *((_DWORD *)this + 16) = 0;
    ...
    if ( v5 < 0
      && (unsigned int)dword_1803DC804 < MEMORY[0x7FFE037C]
      && !(unsigned __int8)EtwCheckCoverage(&off_1803DC7F8) )
    {
      NtSetInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, ProcessAffinityMask|0x40, &off_1803DC7F8, 0x18u);
    }
    *((_DWORD *)this + 10) = 0;
  }
}
