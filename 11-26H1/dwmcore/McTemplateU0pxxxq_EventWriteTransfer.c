/*
 * XREFs of McTemplateU0pxxxq_EventWriteTransfer @ 0x1801A8DAC
 * Callers:
...
ULONG McTemplateU0pxxxq_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  return McGenEventWrite_EventWriteTransfer(
           ...
           &CompositionSwapchain_NewFrameStatisticsInstance,
           v15,
           6u,
           &v3);
}
