/*
 * XREFs of ?Create@CDxHandleStereoBitmapRealization@@SAHW4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAPEAVISwapChainRealization@@@Z @ 0x1802AE954
 * Callers:
        ...
        __int64 *a5)
{
  ...
  if ( v9 )
  {
    v11 = (volatile signed __int32 *)CDxHandleStereoBitmapRealization::CDxHandleStereoBitmapRealization(
                                       v9,
                                       a1,
                                       a2,
                                       a3,
