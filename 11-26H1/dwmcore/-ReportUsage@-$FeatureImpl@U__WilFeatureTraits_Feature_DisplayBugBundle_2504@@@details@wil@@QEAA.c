/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DisplayBugBundle_2504@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18023D838
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisplayBugBundle_2504>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *wil::details::FeatureImpl<__WilFeatureTraits_Feature_DisplayBugBundle_2504>::GetCachedFeatureEnabledState(
            (wil::details *)a1,
            &v7);
    v7 = v3;
  }
