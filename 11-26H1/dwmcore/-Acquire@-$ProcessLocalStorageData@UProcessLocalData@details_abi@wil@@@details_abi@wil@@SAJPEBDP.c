/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x180222AEC
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v18 )
  {
    ...
    if ( Pointer < 0 )
    {
      v14 = 299LL;
LABEL_5:
      wil::details::in1diag3::Return_Hr(retaddr, (void *)v14, (int)"wil", (const char *)(unsigned int)Pointer);
