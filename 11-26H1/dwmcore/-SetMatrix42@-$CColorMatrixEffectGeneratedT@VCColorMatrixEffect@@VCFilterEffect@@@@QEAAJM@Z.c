/*
 * XREFs of ?SetMatrix42@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BE18
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix42(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 404) )
  {
    *(float *)(a1 + 404) = a2;
