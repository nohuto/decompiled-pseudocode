/*
 * XREFs of ?SetPositionInternal@CCursorState@@AEAAXMM_N@Z @ 0x18015F974
 * Callers:
 *     ?SetPosition@CCursorState@@UEAAXMM@Z @ 0x1801DDFF0 (-SetPosition@CCursorState@@UEAAXMM@Z.c)
 *     ?SetPosition@?$CCursorVisualGeneratedT@VCCursorVisual@@VCVisual@@@@QEAAJUtagPOINT@@@Z @ 0x18024C850 (-SetPosition@-$CCursorVisualGeneratedT@VCCursorVisual@@VCVisual@@@@QEAAJUtagPOINT@@@Z.c)
 * Callees:
