/*
 * XREFs of ?WriteWnfUsageBuffer@details_abi@wil@@YA_NPEBU__WIL__WNF_STATE_NAME@@KAEAVRawUsageIndex@12@@Z @ 0x1802244FC
 * Callers:
        ...
        struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  if ( *(_BYTE *)(a3 + 56) )
  {
    ...
    if ( updated == -1073741823 )
      return 0;
    if ( updated )
      wil_details_NtUpdateWnfStateData(v5, *(_QWORD *)(a3 + 24), *(_DWORD *)(a3 + 32) - *(_QWORD *)(a3 + 24), v7);
  }
  return 1;
}
