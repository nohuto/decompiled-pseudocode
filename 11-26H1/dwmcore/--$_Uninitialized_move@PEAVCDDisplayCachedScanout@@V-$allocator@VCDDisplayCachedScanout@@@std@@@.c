/*
 * XREFs of ??$_Uninitialized_move@PEAVCDDisplayCachedScanout@@V?$allocator@VCDDisplayCachedScanout@@@std@@@std@@YAPEAVCDDisplayCachedScanout@@QEAV1@0PEAV1@AEAV?$allocator@VCDDisplayCachedScanout@@@0@@Z @ 0x180299F30
 * Callers:
...
CDDisplayCachedScanout *__fastcall std::_Uninitialized_move<CDDisplayCachedScanout *>(
        __int64 a1,
        __int64 a2,
        CDDisplayCachedScanout *a3)
{
  __int64 v5; // r8
  char *v6; // r9
  __int64 v7; // rdx
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)&v6[v5] = v8;
      *(_QWORD *)a3 = v9;
      a3 = (CDDisplayCachedScanout *)((char *)a3 + 40);
      *(_QWORD *)&v6[v5 + 8] = v7;
      v10 = *(_QWORD *)(v5 + 16);
      *(_QWORD *)(v5 + 16) = 0LL;
      *(_QWORD *)&v6[v5 + 16] = v10;
