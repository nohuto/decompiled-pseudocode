/*
 * XREFs of McTemplateU0xxxq_EventWriteTransfer @ 0x18025D960
 * Callers:
...
ULONG McTemplateU0xxxq_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  return McGenEventWrite_EventWriteTransfer(
           ...
           &EVTDESC_COMPUTESCRIBBLE_GPUFINISHED,
           v13,
           5u,
           &v3);
}
