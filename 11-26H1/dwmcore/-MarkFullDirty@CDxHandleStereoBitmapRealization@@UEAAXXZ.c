/*
 * XREFs of ?MarkFullDirty@CDxHandleStereoBitmapRealization@@UEAAXXZ @ 0x1802AED00
 * Callers:
 *     ?MarkFullDirty@CDxHandleStereoBitmapRealization@@WBAA@EAAXXZ @ 0x1802AED40 (-MarkFullDirty@CDxHandleStereoBitmapRealization@@WBAA@EAAXXZ.c)
 * Callees:
