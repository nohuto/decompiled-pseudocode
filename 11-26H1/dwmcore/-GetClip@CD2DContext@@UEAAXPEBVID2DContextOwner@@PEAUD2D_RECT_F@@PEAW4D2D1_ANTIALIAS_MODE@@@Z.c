/*
 * XREFs of ?GetClip@CD2DContext@@UEAAXPEBVID2DContextOwner@@PEAUD2D_RECT_F@@PEAW4D2D1_ANTIALIAS_MODE@@@Z @ 0x180298820
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_ANTIALIAS_MODE *a4)
{
  ...
  v4 = CD2DTargetStack::Top((CD2DContext *)((char *)this + 320));
