/*
 * XREFs of ?Release@?$CMILCOMBaseT@UID2D1GeometrySink@@U1@VCMilObjectDeleter@@@@UEAAKXZ @ 0x1801406F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<ID2D1GeometrySink,ID2D1GeometrySink,CMilObjectDeleter>::Release(
