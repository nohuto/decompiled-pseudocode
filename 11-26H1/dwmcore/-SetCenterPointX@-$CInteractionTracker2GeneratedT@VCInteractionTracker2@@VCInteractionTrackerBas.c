/*
 * XREFs of ?SetCenterPointX@?$CInteractionTracker2GeneratedT@VCInteractionTracker2@@VCInteractionTrackerBase@@@@QEAAJM@Z @ 0x18024A528
 * Callers:
...
__int64 __fastcall CInteractionTracker2GeneratedT<CInteractionTracker2,CInteractionTrackerBase>::SetCenterPointX(
        __int64 a1,
        float a2)
{
  if ( a2 != *(float *)(a1 + 256) )
