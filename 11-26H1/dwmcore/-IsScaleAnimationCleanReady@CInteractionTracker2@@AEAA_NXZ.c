/*
 * XREFs of ?IsScaleAnimationCleanReady@CInteractionTracker2@@AEAA_NXZ @ 0x1802742FC
 * Callers:
...
char __fastcall CInteractionTracker2::IsScaleAnimationCleanReady(
  ...
  if ( (*((_BYTE *)this + 830) & 0x40) != 0 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 == *((_DWORD *)this + 68) )
        ...
        *(_QWORD *)(*((_QWORD *)this + 121) + 200LL) = this;
      if ( v7 != *((_DWORD *)this + 68) && v7 >= *((_DWORD *)this + 68) )
