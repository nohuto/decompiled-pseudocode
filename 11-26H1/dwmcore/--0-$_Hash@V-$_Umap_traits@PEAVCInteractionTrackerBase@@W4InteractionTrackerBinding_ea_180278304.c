        ...
        __int64 a2)
{
  ...
  *(_DWORD *)a1 = *(_DWORD *)a2;
  std::list<std::pair<CInteractionTrackerBase * const,enum InteractionTrackerBindingModeFlags>>::list<std::pair<CInteractionTrackerBase * const,enum InteractionTrackerBindingModeFlags>>(
    (_QWORD *)(a1 + 8),
    a2);
  *(_QWORD *)(a1 + 24) = 0LL;
  *(_QWORD *)(a1 + 32) = 0LL;
