/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VISwapChainBuffer@@V1@VCMilObjectDeleter@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A0194
 * Callers:
 *     ?QueryInterface@CLegacySwapChainBuffer@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A0F00 (-QueryInterface@CLegacySwapChainBuffer@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a1 + 232LL))(a1);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
