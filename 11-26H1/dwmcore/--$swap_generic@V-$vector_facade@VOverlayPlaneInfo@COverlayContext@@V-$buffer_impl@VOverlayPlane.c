        ...
        __int64 *a2)
{
  ...
  _BYTE v18[384]; // [rsp+50h] [rbp-B0h] BYREF

  v2 = a1[1];
  v4 = *a1;
  v5 = *a2;
  v7 = a2[1];
  if ( 0x7D6343EB1A1F58D1LL * ((v2 - *a1) >> 3) > (unsigned __int64)(0x7D6343EB1A1F58D1LL * ((v7 - v5) >> 3)) )
  {
    v15 = v7;
    v16 = v4;
    v13 = v5;
    ((void (__fastcall *)(__int64 *, __int64 *, __int64 *, __int64 *))std::_Swap_ranges_unchecked<detail::basic_iterator<COverlayContext::OverlayPlaneInfo>,detail::basic_iterator<COverlayContext::OverlayPlaneInfo>>)(
      &v14,
      &v13,
      &v15,
      &v16);
    ...
    v14 = a1[1];
    v13 = v12;
    return ((__int64 (__fastcall *)(__int64 *, __int64 *, __int64 *, __int64 *))detail::vector_facade<COverlayContext::OverlayPlaneInfo,detail::buffer_impl<COverlayContext::OverlayPlaneInfo,16,1,detail::liberal_expansion_policy>>::erase_unchecked)(
             a1,
             &v15,
             &v13,
             &v14);
  ...
  else
  {
    while ( v4 != v2 )
    {
      ...
      COverlayContext::OverlayPlaneInfo::operator=(v4, v5);
      COverlayContext::OverlayPlaneInfo::operator=(v5, v17);
      wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>(v18);
      v4 += 392LL;
      v5 += 392LL;
    }
    v8 = a2[1];
    for ( i = v5; i != v8; i += 392LL )
    {
      v11 = detail::vector_facade<COverlayContext::OverlayPlaneInfo,detail::buffer_impl<COverlayContext::OverlayPlaneInfo,16,1,detail::liberal_expansion_policy>>::reserve_region(
              a1,
              0x7D6343EB1A1F58D1LL * ((a1[1] - *a1) >> 3),
              1LL);
      COverlayContext::OverlayPlaneInfo::OverlayPlaneInfo(v11, i);
    }
    return detail::vector_facade<COverlayContext::OverlayPlaneInfo,detail::buffer_impl<COverlayContext::OverlayPlaneInfo,16,1,detail::liberal_expansion_policy>>::clear_region(
             a2,
             0x7D6343EB1A1F58D1LL * ((v5 - *a2) >> 3),
             0x7D6343EB1A1F58D1LL * ((a2[1] - v5) >> 3));
  }
}
