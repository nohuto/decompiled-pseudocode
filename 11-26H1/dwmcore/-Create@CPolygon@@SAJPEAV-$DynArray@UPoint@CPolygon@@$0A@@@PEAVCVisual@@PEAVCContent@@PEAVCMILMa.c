/*
 * XREFs of ?Create@CPolygon@@SAJPEAV?$DynArray@UPoint@CPolygon@@$0A@@@PEAVCVisual@@PEAVCContent@@PEAVCMILMatrix@@MIW4Enum@MilBitmapBorderMode@@W46MilCompositingMode@@W46MilBitmapInterpolationMode@@_N7PEAUD2D_VECTOR_4F@@PEAPEAV1@@Z @ 0x1801B7894
 * Callers:
...
LABEL_17:
  ...
  *(_DWORD *)(v36 + 40) = 0;
  ...
  v21 = DynArrayImpl<0>::AddMultipleAndSet(v36 + 16, 20, *(_DWORD *)(a1 + 24), *(void **)a1);
  v22 = v21;
  if ( v21 < 0 )
  {
    v33 = v21;
