/*
 * XREFs of ?push_back@?$vector_facade@PEAVCDrawListEntry@@V?$buffer_impl@PEAVCDrawListEntry@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAAX$$QEAPEAVCDrawListEntry@@@Z @ 0x18016C644
 * Callers:
...
__int64 __fastcall detail::vector_facade<CDrawListEntry *,detail::buffer_impl<CDrawListEntry *,4,1,detail::liberal_expansion_policy>>::push_back(
        __int64 *a1,
        __int64 *a2)
{
  _QWORD *v2; // rbx
