/*
 * XREFs of ?SetOffset@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJUD2D_VECTOR_3F@@@Z @ 0x18024C464
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetOffset(CPositionedLight *this, __int64 *a2)
{
  int v2; // eax
  __int64 v4; // rdx
  __int64 v5; // r8
  ...
  v9 = *a2;
  v10 = v2;
  if ( operator!=((float *)&v9, (float *)this + 73) )
  {
