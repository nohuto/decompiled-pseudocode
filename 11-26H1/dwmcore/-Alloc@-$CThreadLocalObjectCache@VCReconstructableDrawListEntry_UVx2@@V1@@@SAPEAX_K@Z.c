/*
 * XREFs of ?Alloc@?$CThreadLocalObjectCache@VCReconstructableDrawListEntry_UVx2@@V1@@@SAPEAX_K@Z @ 0x180188AA8
 * Callers:
...
_QWORD *CThreadLocalObjectCache<CReconstructableDrawListEntry_UVx2,CReconstructableDrawListEntry_UVx2>::Alloc()
{
  _DWORD *Value; // rbx
  int v1; // edx
  _QWORD *v2; // rcx
  ...
  if ( !v2 )
  {
    ...
    return HeapAlloc(ProcessHeap, 0, 0xD8uLL);
  }
  return v2;
}
