/*
 * XREFs of ?GetFirstTangent@?$CBezierFlattener@MVCMilPoint2F@@@@QEBAJAEAVCMilPoint2F@@@Z @ 0x1800546A0
 * Callers:
...
__int64 __fastcall CBezierFlattener<float,CMilPoint2F>::GetFirstTangent(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)a2 = _mm_unpacklo_ps(v2, v4).m128_u64[0];
  if ( (float)((float)(*(float *)(a2 + 4) * *(float *)(a2 + 4)) + (float)(*(float *)a2 * *(float *)a2)) <= *(float *)(a1 + 44) )
  {
    ...
    *(_QWORD *)a2 = _mm_unpacklo_ps(v5, v6).m128_u64[0];
    if ( (float)((float)(*(float *)(a2 + 4) * *(float *)(a2 + 4)) + (float)(*(float *)a2 * *(float *)a2)) <= *(float *)(a1 + 44) )
    {
      ...
      *(_QWORD *)a2 = _mm_unpacklo_ps(v7, v8).m128_u64[0];
      if ( *(float *)(a1 + 44) >= (float)((float)(*(float *)(a2 + 4) * *(float *)(a2 + 4))
                                        + (float)(*(float *)a2 * *(float *)a2)) )
        return 2147500037LL;
    }
  }
  return result;
