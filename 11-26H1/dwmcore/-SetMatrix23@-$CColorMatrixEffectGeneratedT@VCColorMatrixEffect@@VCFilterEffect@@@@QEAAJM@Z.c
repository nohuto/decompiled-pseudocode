/*
 * XREFs of ?SetMatrix23@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024A30C
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix23(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 376) )
  {
    *(float *)(a1 + 376) = a2;
