/*
 * XREFs of ?GetProperty@CDropShadow@@UEAAJUDCOMPOSITION_PROPERTY_ID@@PEAVCExpressionValue@@@Z @ 0x18026D3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDropShadow::GetProperty(__int64 a1, int a2)
{
  unsigned int v2; // ebx
  ...
  {
    v2 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, (unsigned int)v4, -2147024809, 0x5Du, v4);
  }
  return v2;
}
