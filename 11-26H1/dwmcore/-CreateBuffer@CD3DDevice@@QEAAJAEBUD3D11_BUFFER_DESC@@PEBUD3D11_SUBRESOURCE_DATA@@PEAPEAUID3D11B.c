/*
 * XREFs of ?CreateBuffer@CD3DDevice@@QEAAJAEBUD3D11_BUFFER_DESC@@PEBUD3D11_SUBRESOURCE_DATA@@PEAPEAUID3D11Buffer@@@Z @ 0x18011A4FC
 * Callers:
        ...
        struct ID3D11Buffer **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD, const struct D3D11_BUFFER_DESC *, const struct D3D11_SUBRESOURCE_DATA *))(**((_QWORD **)this + 68) + 24LL))(
           *((_QWORD *)this + 68),
           a2,
           a3);
    v6 = v5;
