/*
 * XREFs of ?SetOffset@?$CTurbulenceEffectGeneratedT@VCTurbulenceEffect@@VCFilterEffect@@@@QEAAJUD2D_POINT_2F@@@Z @ 0x18024C4F0
 * Callers:
...
__int64 __fastcall CTurbulenceEffectGeneratedT<CTurbulenceEffect,CFilterEffect>::SetOffset(__int64 a1, __int64 a2)
{
  _QWORD *v3; // rdx
  bool v4; // zf
  ...
  v7 = a2;
  if ( operator!=((float *)&v7, (float *)(a1 + 352)) )
  {
    v4 = *(_QWORD *)(a1 + 48) == 0LL;
    *v3 = a2;
    if ( !v4 )
