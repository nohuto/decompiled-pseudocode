/*
 * XREFs of CalculateDisplayBlankTime @ 0x1801DEDC4
 * Callers:
    ...
    if ( numPathArrayElements >= v8 )
    {
      if ( numPathArrayElements > v8 )
      {
        if ( numPathArrayElements <= 0x8E38E38E38E38E39uLL
          ...
          pathArray[1] = (DISPLAYCONFIG_PATH_INFO *)std::_Uninitialized_value_construct_n<std::allocator<DISPLAYCONFIG_PATH_INFO>>(pathArray[1]);
        else
...
LABEL_36:
    ...
    if ( v22[0] )
    {
      std::_Deallocate<16>(v22[0], (v23 - (unsigned __int64)v22[0]) & 0xFFFFFFFFFFFFFFC0uLL);
      v23 = 0LL;
      *(_OWORD *)v22 = 0LL;
    }
    if ( pathArray[0] )
      std::_Deallocate<16>(pathArray[0], 8 * ((signed __int64)(v25 - (unsigned __int64)pathArray[0]) >> 3));
    return v19;
  }
  v12 = v22[0];
  for ( i = 0; ; ++i )
...
LABEL_29:
  if ( v12 )
  {
    std::_Deallocate<16>(v12, (v23 - (_QWORD)v12) & 0xFFFFFFFFFFFFFFC0uLL);
    v23 = 0LL;
    *(_OWORD *)v22 = 0LL;
  }
  if ( pathArray[0] )
