/*
 * XREFs of ?HrFindInterface@CSwapChainRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802ADC40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CSwapChainRealization::HrFindInterface(
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v5 )
    {
      ...
      if ( v6 )
      {
        v7 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_462c710f_5601_454b_b804_03effd995c26.Data1;
        if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_462c710f_5601_454b_b804_03effd995c26.Data1 )
          v7 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_462c710f_5601_454b_b804_03effd995c26.Data4;
        if ( v7 )
        {
        ...
        this = (CSwapChainRealization *)(v8 & -(__int64)(this != 0LL));
      }
    }
    *a3 = this;
    return 0;
