/*
 * XREFs of ?HrFindInterface@CBitmapResource@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180262B60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CBitmapResource::HrFindInterface(CBitmapResource *this, const struct _GUID *a2, void **a3)
{
  __int64 result; // rax
  __int64 v4; // rax
  __int64 v5; // rax
