/*
 * XREFs of ?Transform@?$CSimdScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAQXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@T__m128@@2IPEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x180120450
 * Callers:
        ...
        __m128 *a7)
{
  ...
  v10 = v7;
  v11 = _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v9, v9, 85), a1[1]), _mm_mul_ps(_mm_shuffle_ps(v9, v9, 0), *a1));
