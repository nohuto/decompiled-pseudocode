/*
 * XREFs of ?SetMatrix32@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x180249F28
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix32(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 388) )
  {
    *(float *)(a1 + 388) = a2;
