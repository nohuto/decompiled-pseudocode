/*
 * XREFs of ?Copy@CRectanglesShape@@QEAAXAEBV1@@Z @ 0x1800BF6C0
 * Callers:
 *     ?GetDirtyRegion@CPrimitiveGroup@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z @ 0x1801A90A0 (-GetDirtyRegion@CPrimitiveGroup@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z.c)
 *     ?GetDirtyRegion@CGenericInk@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z @ 0x1801D7440 (-GetDirtyRegion@CGenericInk@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z.c)
 *     ?GetDirtyRegion@CCompositionDynamicTexture@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z @ 0x18026A830 (-GetDirtyRegion@CCompositionDynamicTexture@@UEBA_NAEBUD2D_SIZE_F@@PEAVCRectanglesShape@@@Z.c)
 * Callees:
...
void __fastcall CRectanglesShape::Copy(CRectanglesShape *this, const struct CRectanglesShape *a2)
{
  ...
  __int64 v35; // rsi
  __int128 v36; // [rsp+30h] [rbp-49h] BYREF
  _OWORD *v37; // [rsp+40h] [rbp-39h]
  __int128 v38; // [rsp+50h] [rbp-29h]
  _OWORD *v39; // [rsp+60h] [rbp-19h]
  __int128 v40; // [rsp+70h] [rbp-9h] BYREF
  _OWORD *v41; // [rsp+80h] [rbp+7h]
  unsigned __int64 v42; // [rsp+E0h] [rbp+67h] BYREF
  unsigned __int64 v43; // [rsp+E8h] [rbp+6Fh]
  __int64 v44; // [rsp+F0h] [rbp+77h]

  v2 = (_OWORD *)*((_QWORD *)a2 + 2);
  v4 = *((_QWORD *)a2 + 3);
  v5 = *((_QWORD *)this + 2);
  v6 = (v4 - (__int64)v2) >> 4;
  v7 = (*((_QWORD *)this + 3) - v5) >> 4;
  if ( v7 )
  {
    stdext::checked_array_iterator<_LUID *>::checked_array_iterator<_LUID *>(&v40, v5, v7);
    v7 = -16 * v8;
    *((_QWORD *)this + 3) += v7;
  }
  v9 = (detail::liberal_expansion_policy *)*((_QWORD *)this + 7);
  if ( v9 )
  {
...
LABEL_22:
  ...
  v11 = *((_QWORD *)this + 4);
  v12 = *((_QWORD *)this + 2);
  v13 = &v2[(unsigned int)v6];
  v14 = (*((_QWORD *)this + 3) - v12) >> 4;
  v15 = (v11 - *((_QWORD *)this + 3)) >> 4;
  *(_QWORD *)&v38 = v2;
  *((_QWORD *)&v38 + 1) = &v2[v10];
  v39 = v2;
  v43 = v14;
  if ( v15 < v10 )
  {
    if ( v10 + v14 >= v14 )
    {
      ...
      stdext::checked_array_iterator<_LUID *>::checked_array_iterator<_LUID *>(&v40, (__int64)v31, v14);
      v32 = *((_QWORD *)this + 3);
      ...
      *((_QWORD *)this + 2) = v31;
      ...
      if ( v34 == (CRectanglesShape *)((char *)this + 40) )
        v34 = 0LL;
      operator delete(v34);
      v35 = *((_QWORD *)this + 2) + 16 * v30;
      *((_QWORD *)this + 3) = *((_QWORD *)this + 2) + 16 * v14;
      *((_QWORD *)this + 4) = v35;
      std::unique_ptr<detail::aligned_storage_for<tagCOMPOSITION_TARGET_ID_AND_STATS> [0],std::default_delete<detail::aligned_storage_for<tagCOMPOSITION_TARGET_ID_AND_STATS> [0]>>::~unique_ptr<detail::aligned_storage_for<tagCOMPOSITION_TARGET_ID_AND_STATS> [0],std::default_delete<detail::aligned_storage_for<tagCOMPOSITION_TARGET_ID_AND_STATS> [0]>>((void **)&v42);
    }
    else
    {
  ...
  v16 = (_OWORD *)*((_QWORD *)this + 3);
  v44 = *((_QWORD *)this + 2);
  v17 = ((__int64)v16 - v44) >> 4;
  v18 = v17 - v14;
  v19 = 16 * v17;
  v42 = v18;
  stdext::checked_array_iterator<_LUID *>::checked_array_iterator<_LUID *>(&v40, 16 * v17 + v44, v10);
  v36 = v40;
  v37 = v41;
  ...
  if ( v16 != &v16[-v21] )
  {
    ...
    do
    {
      ...
      *(_OWORD *)stdext::checked_array_iterator<D2D_RECT_F *>::operator->(&v40) = *v16;
    }
    while ( v16 != v29 );
    v13 = &v2[v10];
    v20 = v42;
  ...
  {
    v22 = v44;
    stdext::checked_array_iterator<_LUID *>::checked_array_iterator<_LUID *>(&v40, v44, v17);
    v36 = v40;
    v37 = v41;
    stdext::checked_array_iterator<wil::com_ptr_t<CD2DBrush,wil::err_returncode_policy> *>::operator+=(&v36, v17);
    v23 = (const void *)(v22 + 16 * v43);
    v40 = v36;
    v24 = v19 - 16 * v10 - 16 * v43;
    v41 = v37;
    stdext::checked_array_iterator<char *>::_Verify_offset((__int64)&v40, -(v24 >> 4));
  ...
  *((_QWORD *)this + 3) += 16 * v10;
  ...
  for ( i = v27; ; ++i )
  {
    if ( v26 != __PAIR128__((unsigned __int64)v13, (unsigned __int64)v2) )
      goto LABEL_22;
    if ( i == v13 )
      break;
    if ( !(_QWORD)v26 )
    ...
    if ( !*((_QWORD *)&v26 + 1) )
      goto LABEL_22;
    if ( (unsigned __int64)v26 > (unsigned __int64)i )
      goto LABEL_22;
    if ( (unsigned __int64)i >= *((_QWORD *)&v26 + 1) )
      goto LABEL_22;
    *(_OWORD *)v7 = *i;
    if ( !i )
      goto LABEL_22;
