/*
 * XREFs of ?Create@CStereoRenderTargetBitmap@@SAJPEAVIDeviceTextureTarget@@PEAPEAVIStereoRenderTargetBitmap@@@Z @ 0x1802B0844
 * Callers:
...
LABEL_8:
  ...
  if ( v8 )
  {
    CRenderTargetBitmap::CRenderTargetBitmap(v8, 0);
    v10 = v14;
