/*
 * XREFs of ?GetWeakReference@?$CMILCOMBaseWeakRefSource@VCMilObjectDeleter@@@@UEAAJPEAPEAVIUnknownWeakRef@@@Z @ 0x1801A7FE0
 * Callers:
 *     <none>
 * Callees:
 *     MIDL_user_allocate @ 0x18007E170 (MIDL_user_allocate.c)
 *     ??0CMILCOMWeakRef@@QEAA@PEAUIUnknown@@@Z @ 0x1801A8080 (--0CMILCOMWeakRef@@QEAA@PEAUIUnknown@@@Z.c)
