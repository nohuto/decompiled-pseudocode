/*
 * XREFs of ?SetColor@?$CAmbientLightGeneratedT@VCAmbientLight@@VCLight@@@@QEAAJU_D3DCOLORVALUE@@@Z @ 0x18024A808
 * Callers:
...
__int64 __fastcall CAmbientLightGeneratedT<CAmbientLight,CLight>::SetColor(__int64 a1, __int128 *a2)
{
  _OWORD *v3; // rdx
  _OWORD *v4; // r8
  bool v5; // zf
  ...
  v7 = *a2;
  if ( !operator==((float *)&v7, (float *)(a1 + 232)) )
  {
    v5 = *(_QWORD *)(a1 + 48) == 0LL;
    *v3 = *v4;
    if ( !v5 )
