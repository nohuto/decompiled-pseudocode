/*
 * XREFs of ?ProcessSetInertiaCenterpointY@CInteractionTracker2@@AEAAXXZ @ 0x180274DC0
 * Callers:
...
void __fastcall CInteractionTracker2::ProcessSetInertiaCenterpointY(CInteractionTracker2 *this)
{
  __int64 *v1; // rdi
  CExpressionManager *v3; // rcx

  v1 = (__int64 *)((char *)this + 952);
  Microsoft::WRL::ComPtr<CConditionalExpression>::operator=((__int64 *)this + 87, (__int64 *)this + 119);
