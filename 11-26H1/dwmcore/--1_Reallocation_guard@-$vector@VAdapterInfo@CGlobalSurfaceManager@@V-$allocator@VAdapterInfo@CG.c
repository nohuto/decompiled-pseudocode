/*
 * XREFs of ??1_Reallocation_guard@?$vector@VAdapterInfo@CGlobalSurfaceManager@@V?$allocator@VAdapterInfo@CGlobalSurfaceManager@@@std@@@std@@QEAA@XZ @ 0x18022DFA8
 * Callers:
...
void __fastcall std::vector<CGlobalSurfaceManager::AdapterInfo>::_Reallocation_guard::~_Reallocation_guard(__int64 a1)
{
  if ( *(_QWORD *)(a1 + 8) )
  {
    std::_Destroy_range<std::allocator<CGlobalSurfaceManager::AdapterInfo>>(*(_QWORD *)(a1 + 24), *(_QWORD *)(a1 + 32));
