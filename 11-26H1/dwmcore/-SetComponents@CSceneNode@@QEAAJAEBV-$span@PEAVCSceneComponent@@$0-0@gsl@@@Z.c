/*
 * XREFs of ?SetComponents@CSceneNode@@QEAAJAEBV?$span@PEAVCSceneComponent@@$0?0@gsl@@@Z @ 0x1802096D0
 * Callers:
...
__int64 __fastcall CSceneNode::SetComponents(struct CSceneNode *a1, __int64 *a2)
{
  ...
  v2 = (CSceneComponent **)*((_QWORD *)a1 + 13);
  v4 = (CSceneComponent **)*((_QWORD *)a1 + 14);
  while ( v2 != v4 )
  {
    v6 = a2[1];
    v18 = *v2;
    ...
    v15 = v14;
    v16[1] = v14;
    std::find<gsl::details::span_iterator<CSceneNode *>,CSceneNode *>(v17, v16, &v13, &v18);
    v8 = a2[1];
    if ( v17[0] != v8 || (v9 = v8 + 8 * *a2, v17[1] != v9) )
    {
      ((void (*)(void))`gsl::details::get_terminate_handler'::`2'::handler)();
      __debugbreak();
    }
    if ( v17[2] == v9 )
      CSceneComponent::DehydrateSpectreResources(v18, a1);
    ++v2;
  }
  appended = CSceneNodeGeneratedT<CSceneNode,CSceneObject>::SetOrAppendComponents(a1);
  v11 = appended;
  if ( appended < 0 )
