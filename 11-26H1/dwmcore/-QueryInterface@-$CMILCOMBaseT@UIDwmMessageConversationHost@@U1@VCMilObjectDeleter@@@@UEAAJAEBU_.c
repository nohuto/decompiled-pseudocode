/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@UIDwmMessageConversationHost@@U1@VCMilObjectDeleter@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802082E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<IDwmMessageConversationHost,IDwmMessageConversationHost,CMilObjectDeleter>::QueryInterface(
        __int64 a1,
        _QWORD *a2,
        _QWORD *a3)
{
