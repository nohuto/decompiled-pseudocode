/*
 * XREFs of ?GetPoint@?$CBezier@MVCMilPoint2F@@@@QEBAXMAEAVCMilPoint2F@@@Z @ 0x18020F070
 * Callers:
...
void __fastcall CBezier<float,CMilPoint2F>::GetPoint(float *a1, float a2, _QWORD *a3)
{
  ...
  v7 = (float)(a2 * a2) * a2;
  v5.m128_f32[0] = (float)((float)((float)(v5.m128_f32[0] * a1[1]) + (float)(v4.m128_f32[0] * a1[3]))
                         + (float)(v3.m128_f32[0] * a1[5]))
                 + (float)(v7 * a1[7]);
  v6.m128_f32[0] = (float)(v6.m128_f32[0] + (float)(v3.m128_f32[0] * a1[4])) + (float)(v7 * a1[6]);
  *a3 = _mm_unpacklo_ps(v6, v5).m128_u64[0];
}
