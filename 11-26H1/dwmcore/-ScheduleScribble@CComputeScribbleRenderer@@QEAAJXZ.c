/*
 * XREFs of ?ScheduleScribble@CComputeScribbleRenderer@@QEAAJXZ @ 0x18013110C
 * Callers:
...
__int64 __fastcall CComputeScribbleRenderer::ScheduleScribble(CComputeScribbleRenderer *this)
{
  ...
  v5 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *, _OWORD *))(*(_QWORD *)OverlaySwapChain + 144LL))(
         OverlaySwapChain,
         v15);
  v6 = v5;
  if ( v5 >= 0 )
  {
    v7 = DWORD2(v15[0]) + 2;
    v8 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)v4 + 104LL))(v4);
    v9 = v8;
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x80000) != 0 )
    {
      v12 = v8 > LODWORD(v15[0]);
      v13 = (*(__int64 (__fastcall **)(struct IOverlaySwapChain *))(*(_QWORD *)v4 + 208LL))(v4);
