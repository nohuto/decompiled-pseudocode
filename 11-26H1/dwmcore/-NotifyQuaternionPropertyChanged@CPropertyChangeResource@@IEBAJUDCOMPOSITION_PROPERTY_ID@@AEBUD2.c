/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJUDCOMPOSITION_PROPERTY_ID@@AEBUD2DQuaternion@@@Z @ 0x180267FD4
 * Callers:
        ...
        __int128 *a3)
{
         ...
         9LL) )
  {
    ...
    v13[1] = a1[18];
    v14 = v9;
    v11 = CoreUICallSend(v10, v13, 2LL, 9LL, 6, &unk_1802F5B47, a2, &v14, ChannelCallbackId);
    if ( v11 != -2018375675 )
      v6 = v11;
    if ( v6 < 0 )
