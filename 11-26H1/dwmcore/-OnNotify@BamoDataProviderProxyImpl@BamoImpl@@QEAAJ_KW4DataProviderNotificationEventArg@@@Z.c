/*
 * XREFs of ?OnNotify@BamoDataProviderProxyImpl@BamoImpl@@QEAAJ_KW4DataProviderNotificationEventArg@@@Z @ 0x180244520
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDataProviderProxyImpl::OnNotify(__int64 a1, int a2, int a3)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      return CoreUICallSend(v11, v14, 2LL, 0LL, 5, &unk_180373368, a2, v13, v16);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
