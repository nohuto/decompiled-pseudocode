/*
 * XREFs of _anonymous_namespace_::ScreenOnStudySessionStateTracker::Start @ 0x1802176E8
 * Callers:
...
__int64 __fastcall anonymous_namespace_::ScreenOnStudySessionStateTracker::Start(__int64 a1)
{
  ...
  *(_BYTE *)a1 = 1;
  result = (unsigned int)RtlSubscribeWnfStateChangeNotification(
                           ...
                           0LL,
                           anonymous_namespace_::ScreenOnStudySessionStateTracker::WnfCallback) | 0x10000000;
  if ( (int)result < 0 )
  {
    *(_QWORD *)(a1 + 16) = 0LL;
