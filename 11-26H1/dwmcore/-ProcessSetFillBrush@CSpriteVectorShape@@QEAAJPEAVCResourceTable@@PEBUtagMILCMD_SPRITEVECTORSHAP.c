/*
 * XREFs of ?ProcessSetFillBrush@CSpriteVectorShape@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SPRITEVECTORSHAPE_SETFILLBRUSH@@@Z @ 0x180282984
 * Callers:
        ...
        const struct tagMILCMD_SPRITEVECTORSHAPE_SETFILLBRUSH *a3)
{
  ...
  if ( ResourceWithoutType != v6 )
  {
    ...
    *((_QWORD *)this + 14) = v7;
    CSpriteVectorShape::UpdateFillBrush(this);
