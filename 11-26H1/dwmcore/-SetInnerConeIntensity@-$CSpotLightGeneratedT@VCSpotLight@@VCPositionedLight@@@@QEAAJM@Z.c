/*
 * XREFs of ?SetInnerConeIntensity@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024B590
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetInnerConeIntensity(
