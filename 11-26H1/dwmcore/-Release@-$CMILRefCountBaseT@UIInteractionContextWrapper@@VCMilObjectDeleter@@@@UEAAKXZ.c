/*
 * XREFs of ?Release@?$CMILRefCountBaseT@UIInteractionContextWrapper@@VCMilObjectDeleter@@@@UEAAKXZ @ 0x1800E2DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILRefCountBaseT<IInteractionContextWrapper,CMilObjectDeleter>::Release(__int64 a1)
{
