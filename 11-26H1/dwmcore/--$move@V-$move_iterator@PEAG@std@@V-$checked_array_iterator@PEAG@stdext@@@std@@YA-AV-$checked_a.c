/*
 * XREFs of ??$move@V?$move_iterator@PEAG@std@@V?$checked_array_iterator@PEAG@stdext@@@std@@YA?AV?$checked_array_iterator@PEAG@stdext@@V?$move_iterator@PEAG@0@0V12@@Z @ 0x1801C096C
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  v8 = (void *)std::_Get_unwrapped_n<stdext::checked_array_iterator<unsigned short *> &,__int64>(a4);
