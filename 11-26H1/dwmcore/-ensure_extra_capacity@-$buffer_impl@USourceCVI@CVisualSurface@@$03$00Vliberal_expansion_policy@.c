/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@USourceCVI@CVisualSurface@@$03$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x18009C410
 * Callers:
 ...
 *     ??$_Uninitialized_move_unchecked@V?$move_iterator@PEAUSourceCVI@CVisualSurface@@@std@@PEAUSourceCVI@CVisualSurface@@@std@@YAPEAUSourceCVI@CVisualSurface@@V?$move_iterator@PEAUSourceCVI@CVisualSurface@@@0@V30@PEAU12@@Z @ 0x180212D6C (--$_Uninitialized_move_unchecked@V-$move_iterator@PEAUSourceCVI@CVisualSurface@@@std@@PEAUSource.c)
 */
        ...
        unsigned __int64 a2)
{
  ...
  if ( ((char *)v4 - (char *)v2) >> 4 < a2 )
  {
    ...
    if ( v5 + a2 < v5 )
    {
      ...
      __debugbreak();
      JUMPOUT(0x18009C543LL);
    }
    v6 = detail::liberal_expansion_policy::expand(
           (detail::liberal_expansion_policy *)(((char *)v4 - (char *)*a1) >> 4),
           ((char *)v4 - (char *)*a1) >> 4,
           v5 + a2);
    v7 = (__int64 *)operator new[](saturated_mul(v6, 0x10uLL));
    stdext::checked_array_iterator<_LUID *>::checked_array_iterator<_LUID *>(&v13, (__int64)v7, v5);
    v8 = a1[1];
    v9 = *a1;
    v15 = v13;
    v16 = v14;
    v10 = std::_Get_unwrapped_n<stdext::checked_array_iterator<TMilRect_<float,D2D_RECT_F,D3D_RECT_F,D2D_POINTANDSIZE_F,RectUniqueness::NotNeeded> *> &,__int64>(&v15);
    std::_Uninitialized_move_unchecked<std::move_iterator<CVisualSurface::SourceCVI *>,CVisualSurface::SourceCVI *>(
      v9,
      v8,
      v10);
    detail::destruct_range<CVisualSurface::SourceCVI>(*a1, a1[1]);
    v11 = *a1;
    *a1 = v7;
    if ( v11 == (__int64 *)(a1 + 3) )
      v11 = 0LL;
