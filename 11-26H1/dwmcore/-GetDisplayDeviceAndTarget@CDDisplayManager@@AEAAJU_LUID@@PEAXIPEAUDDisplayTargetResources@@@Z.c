/*
 * XREFs of ?GetDisplayDeviceAndTarget@CDDisplayManager@@AEAAJU_LUID@@PEAXIPEAUDDisplayTargetResources@@@Z @ 0x18029EABC
 * Callers:
        ...
        struct DDisplayTargetResources *a5)
{
  ...
  v48 = 0LL;
  v9 = (*(__int64 (__fastcall **)(__int64, __int64 **))(v8 + 48))(g_DDisplayManager, &v48);
  v10 = v9;
  if ( v9 < 0 )
  {
    v36 = 317;
...
LABEL_74:
  ...
  if ( v51 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v15, 0x148u, 0LL);
        goto LABEL_71;
      }
      if ( a4 == v39[0] )
      {
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v17, 0x151u, 0LL);
          goto LABEL_68;
        }
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v18, 0x152u, 0LL);
          goto LABEL_68;
        }
        v49[1] = v49[0];
        *(_QWORD *)&v50.Data1 = __PAIR64__(HighPart, LowPart);
        if ( __PAIR64__(HighPart, LowPart) == v49[0] )
        {
          ...
          *(_QWORD *)&v41 = 0LL;
          ...
          if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_DDisplay_AggCheckMpo>::__private_IsEnabled((wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_DDisplay_AggCheckMpo>::GetImpl'::`2'::impl) )
          {
            v23 = *((_QWORD *)&v41 + 1);
            *((_QWORD *)&v41 + 1) = 0LL;
            if ( v23 )
...
LABEL_68:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v14, 0x147u, 0LL);
LABEL_71:
    wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v37);
  }
  else
...
LABEL_13:
    v10 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304442, 0x195u, 0LL);
  }
LABEL_75:
