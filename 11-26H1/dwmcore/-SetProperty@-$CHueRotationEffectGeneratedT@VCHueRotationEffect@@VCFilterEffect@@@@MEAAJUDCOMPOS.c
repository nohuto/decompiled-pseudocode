/*
 * XREFs of ?SetProperty@?$CHueRotationEffectGeneratedT@VCHueRotationEffect@@VCFilterEffect@@@@MEAAJUDCOMPOSITION_PROPERTY_ID@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18024D580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHueRotationEffectGeneratedT<CHueRotationEffect,CFilterEffect>::SetProperty(
        __int64 a1,
        int a2,
        int a3,
        float *a4)
