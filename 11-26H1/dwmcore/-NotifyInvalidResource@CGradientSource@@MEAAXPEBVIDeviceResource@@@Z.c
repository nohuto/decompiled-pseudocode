/*
 * XREFs of ?NotifyInvalidResource@CGradientSource@@MEAAXPEBVIDeviceResource@@@Z @ 0x18027E760
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CGradientSource::NotifyInvalidResource(unsigned __int64 this, const struct IDeviceResource *a2)
{
  ...
  for ( i = *(_QWORD **)(this + 16); i != *(_QWORD **)(this + 24); ++i )
  {
    ...
    {
      (*(void (__fastcall **)(_QWORD, unsigned __int64))(*(_QWORD *)*i + 80LL))(*i, this & -(__int64)(this != 8));
