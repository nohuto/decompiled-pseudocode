/*
 * XREFs of ?SetMatrix11@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x180249F78
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix11(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 352) )
  {
    *(float *)(a1 + 352) = a2;
