/*
 * XREFs of ??$ResolveProhibitedMotion@UDwmTouchInteractionConfigurationPrimitive@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@CInteractionProcessor@@AEAA_NAEBV?$DynArray@UDwmTouchInteractionConfigurationPrimitive@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x1801B9948
 * Callers:
...
char __fastcall CInteractionProcessor::ResolveProhibitedMotion<DwmTouchInteractionConfigurationPrimitive,enum DwmInteractionTypeTouchPrimitiveType::FlagsEnum>(
        __int64 *a1,
        __int64 *a2,
        __int64 a3,
        _DWORD *a4)
