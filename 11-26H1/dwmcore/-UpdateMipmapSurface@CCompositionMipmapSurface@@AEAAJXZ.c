/*
 * XREFs of ?UpdateMipmapSurface@CCompositionMipmapSurface@@AEAAJXZ @ 0x18026B298
 * Callers:
      ...
      else
      {
        for ( i = 0; i < *((_DWORD *)this + 34); ++i )
        {
          ...
          if ( v8 && *(_BYTE *)(v6 + v7 + 24) )
          {
            ...
            v18 = *((_QWORD *)this + 15);
            v24 = 0LL;
            v12 = *(__int64 (__fastcall **)(__int64, __int64 *, __int64 *))(*(_QWORD *)v23 + 112LL);
...
LABEL_13:
            ...
            v16 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v24 + 120LL))(v24, 0LL);
