/*
 * XREFs of ?IsCompatibleTransform@CRectangleMapStrategy@CEdgeFlagsMap@@SA_NPEBVMatrix3x3@@@Z @ 0x180143BC0
 * Callers:
 ...
 *     ?Is2DAffine@Matrix3x3@@QEBA_NXZ @ 0x1801442EC (-Is2DAffine@Matrix3x3@@QEBA_NXZ.c)
 */
