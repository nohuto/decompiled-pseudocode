/*
 * XREFs of ?HrWicPfToMil@@YAJAEBU_GUID@@PEAW4Enum@MilPixelFormat@@@Z @ 0x1800E164C
 * Callers:
...
__int64 __fastcall HrWicPfToMil(const struct _GUID *a1, enum MilPixelFormat::Enum *a2)
{
  ...
  {
    v5 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat40bppCMYKAlpha.Data1;
    if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat40bppCMYKAlpha.Data1 )
      v5 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat40bppCMYKAlpha.Data4;
    if ( v5 )
    {
      v6 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat80bppCMYKAlpha.Data1;
      if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat80bppCMYKAlpha.Data1 )
        v6 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat80bppCMYKAlpha.Data4;
      if ( v6 )
      {
        v7 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat8bppAlpha.Data1;
        if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat8bppAlpha.Data1 )
          v7 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat8bppAlpha.Data4;
        if ( v7 )
        {
          v8 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat32bppRGBA.Data1;
          if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat32bppRGBA.Data1 )
            v8 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat32bppRGBA.Data4;
          if ( v8 )
          {
            v9 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat32bppPRGBA.Data1;
            if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat32bppPRGBA.Data1 )
              v9 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat32bppPRGBA.Data4;
            if ( v9 )
            {
              v10 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat32bppBGRA.Data1;
              if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat32bppBGRA.Data1 )
                v10 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat32bppBGRA.Data4;
              if ( v10 )
              {
                v11 = *(_QWORD *)&a1->Data1 - *(_QWORD *)&GUID_WICPixelFormat32bppPBGRA.Data1;
                if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat32bppPBGRA.Data1 )
                  v11 = *(_QWORD *)a1->Data4 - *(_QWORD *)GUID_WICPixelFormat32bppPBGRA.Data4;
                if ( v11 )
                {
                                        ...
                                        if ( v23 )
                                        {
                                          ...
                                          if ( v24 )
                                          {
                                            ...
                                            if ( v25 )
                                            {
                                              ...
                                              {
                                                v27 = *(_QWORD *)&a1->Data1
                                                    - *(_QWORD *)&GUID_WICPixelFormat8bppDepth.Data1;
                                                if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat8bppDepth.Data1 )
                                                  v27 = *(_QWORD *)a1->Data4
                                                      - *(_QWORD *)GUID_WICPixelFormat8bppDepth.Data4;
                                                if ( v27 )
                                                {
                                                  v28 = *(_QWORD *)&a1->Data1
                                                      - *(_QWORD *)&GUID_WICPixelFormat8bppGain.Data1;
                                                  if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat8bppGain.Data1 )
                                                    v28 = *(_QWORD *)a1->Data4
                                                        - *(_QWORD *)GUID_WICPixelFormat8bppGain.Data4;
                                                  if ( v28 )
                                                  {
                                                    v29 = *(_QWORD *)&a1->Data1
                                                        - *(_QWORD *)&GUID_WICPixelFormat24bppRGBGain.Data1;
                                                    if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat24bppRGBGain.Data1 )
                                                      v29 = *(_QWORD *)a1->Data4
                                                          - *(_QWORD *)GUID_WICPixelFormat24bppRGBGain.Data4;
                                                    if ( v29 )
                                                    {
                                                      v30 = *(_QWORD *)&a1->Data1
                                                          - *(_QWORD *)&GUID_WICPixelFormat32bppBGRGain.Data1;
                                                      if ( *(_QWORD *)&a1->Data1 == *(_QWORD *)&GUID_WICPixelFormat32bppBGRGain.Data1 )
                                                        v30 = *(_QWORD *)a1->Data4
                                                            - *(_QWORD *)GUID_WICPixelFormat32bppBGRGain.Data4;
                                                      if ( !v30 )
                                                        v2 = 86;
                                                    }
                                                    else
