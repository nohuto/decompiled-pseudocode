/*
 * XREFs of ?SetLinearAttenuation@?$CPointLightGeneratedT@VCPointLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024BBD8
 * Callers:
...
__int64 __fastcall CPointLightGeneratedT<CPointLight,CPositionedLight>::SetLinearAttenuation(
