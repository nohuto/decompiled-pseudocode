/*
 * XREFs of ?D3DXQuaternionRotationMatrix@@YAPEAUD2DQuaternion@@PEAU1@PEBUD2DMatrix@@@Z @ 0x180121B74
 * Callers:
...
struct D2DQuaternion *__fastcall D3DXQuaternionRotationMatrix(struct D2DQuaternion *a1, const struct D2DMatrix *a2)
{
  ...
  if ( v7 <= 0.0 )
  {
    ...
    v16 = (float)(v2 - v4) - v5;
    v15 = (float)(v4 - v2) - v5;
    v17 = (float)(COERCE_FLOAT(LODWORD(v4) ^ _xmm) - v2) + v5;
    v10 = v15 < v16;
    if ( *(&v15 + v10) < v17 )
      v10 = 2LL;
