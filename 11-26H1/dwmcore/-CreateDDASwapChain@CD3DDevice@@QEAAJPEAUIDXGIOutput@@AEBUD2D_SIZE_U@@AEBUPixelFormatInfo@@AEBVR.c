/*
 * XREFs of ?CreateDDASwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCDDASwapChain@@@Z @ 0x1801E09B4
 * Callers:
        ...
        struct CDDASwapChain **a6)
{
  ...
  *a6 = 0LL;
  ...
  {
    v9 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803739D0, 2u, -2003304307, 0x2CAu, 0LL);
    goto LABEL_16;
  }
  v25 = *a3;
  v26 = *(_DWORD *)a4;
  v27 = 0;
  v28 = 1LL;
  v10 = CD3DDevice::UseSwapchainAsShaderInput(this) == 0;
  v30 = v12;
  v32 = *((_DWORD *)a4 + 1);
  lpVtbl = a2->lpVtbl;
  if ( !v10 )
  ...
  else
  {
    ...
    else
    {
      ...
      v14 = v18(v17, *((_QWORD *)this + 68), &v25, a2, &v22);
      v9 = v14;
      if ( v14 < 0 )
      {
        v21 = 746;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(20, &dword_1803739D0, 2u, v14, v21, 0LL);
LABEL_16:
  v19 = CD3DDevice::TranslateDXGIorD3DErrorInContext((__int64)this, v9, 2u);
  if ( v22 )
    (*(void (__fastcall **)(struct IDXGISwapChainDWM1 *))(*(_QWORD *)v22 + 16LL))(v22);
  if ( v23 )
    (*(void (__fastcall **)(__int64))(*(_QWORD *)v23 + 16LL))(v23);
  if ( v24 )
