/*
 * XREFs of ?TotalContactsCapturedUnderVisual@CManipulationContext@@SAIPEBUMCCollections@@PEAVCVisual@@PEAPEAVCInteraction@@@Z @ 0x1800A78B0
 * Callers:
        ...
        struct CInteraction **a3)
{
  ...
  if ( CVisual::GetInteractionInternal(a2) )
  {
    ...
    Microsoft::WRL::ComPtr<CBaseExpression>::operator=(&v18, *((_QWORD *)InteractionInternal + 28));
  ...
  else
  {
    ...
    Microsoft::WRL::ComPtr<CBaseExpression>::operator=(&v18, ClosestInteractionAncestor);
    v11 = v18;
    if ( v18 )
    {
      for ( i = (CInteraction *)*((_QWORD *)v18 + 31); i; i = (CInteraction *)*((_QWORD *)i + 29) )
      {
