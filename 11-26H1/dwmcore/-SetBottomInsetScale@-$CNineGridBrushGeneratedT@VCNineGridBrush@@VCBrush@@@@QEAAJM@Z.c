/*
 * XREFs of ?SetBottomInsetScale@?$CNineGridBrushGeneratedT@VCNineGridBrush@@VCBrush@@@@QEAAJM@Z @ 0x18024A43C
 * Callers:
...
__int64 __fastcall CNineGridBrushGeneratedT<CNineGridBrush,CBrush>::SetBottomInsetScale(__int64 a1, float a2)
{
