/*
 * XREFs of ?SetChildren@CSceneNode@@QEAAJAEBV?$span@PEAVCSceneNode@@$0?0@gsl@@@Z @ 0x180209514
 * Callers:
...
__int64 __fastcall CSceneNode::SetChildren(CResource *this, __int64 *a2)
{
  ...
  while ( v2 != v4 )
  {
    ...
    if ( *((CResource **)v17 + 17) == this )
    {
      ...
      v14 = v13;
      v15[1] = v13;
      std::find<gsl::details::span_iterator<CSceneNode *>,CSceneNode *>(v16, v15, &v12, &v17);
      v7 = a2[1];
      if ( v16[0] != v7 || (v8 = v7 + 8 * *a2, v16[1] != v8) )
      {
  ...
  appended = CSceneNodeGeneratedT<CSceneNode,CSceneObject>::SetOrAppendChildren(this);
  v10 = appended;
  if ( appended < 0 )
