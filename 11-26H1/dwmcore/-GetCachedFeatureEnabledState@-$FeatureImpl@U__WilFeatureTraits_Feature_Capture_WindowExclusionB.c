/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Capture_WindowExclusionBackport@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180257078
 * Callers:
