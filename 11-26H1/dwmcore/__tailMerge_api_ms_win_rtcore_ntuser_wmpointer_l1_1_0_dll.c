/*
 * XREFs of __tailMerge_api_ms_win_rtcore_ntuser_wmpointer_l1_1_0_dll @ 0x180221EC2
 * Callers:
 *     __imp_load_GetPointerDeviceRects @ 0x180221F41 (__imp_load_GetPointerDeviceRects.c)
 * Callees:
