        ...
        __int64 *a3)
{
  ...
  *v18 = v15;
  ...
  std::_Uninitialized_move<std::unique_ptr<CAtlasTexture> *,std::allocator<std::unique_ptr<CAtlasTexture>>>(
    ...
    v17);
  v22[1] = 0LL;
  std::vector<std::unique_ptr<CAtlasTexture>>::_Change_array((__int64)a1, v16, v9, v3);
  std::vector<std::unique_ptr<CAtlasTexture>>::_Reallocation_guard::~_Reallocation_guard(v22);
  return v18;
}
