/*
 * XREFs of ?SetOuterConeIntensity@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024C770
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetOuterConeIntensity(
