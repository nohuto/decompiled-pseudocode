        ...
        __int64 a2)
{
  ...
  if ( (unsigned __int64)(v6 - a2) > 1 )
  {
    ...
    v18 = v16;
    v19 = v17;
    std::move_backward<std::move_iterator<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy> *>,stdext::checked_array_iterator<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy> *>>(
      v20,
      v14,
      v4 - 8 + 8 * v6,
      &v18);
  ...
  if ( v7 + v4 >= (unsigned __int64)(8 * a2 + 8 + v4) )
    v7 = 8 * a2 + 8;
  detail::destruct_range<wil::com_ptr_t<CLegacySwapChainBuffer,wil::err_returncode_policy>>(v14, v4 + v7);
  v3[1] += 8LL;
  return v14;
}
