/*
 * XREFs of ??1MCCollections@@QEAA@XZ @ 0x180294804
 * Callers:
...
void __fastcall MCCollections::~MCCollections(MCCollections *this)
{
  ...
  *((_DWORD *)this + 14) = 0;
  ...
  {
    for ( i = 0; i < *v4; ++i )
      Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease((__int64 *)(*((_QWORD *)this + 3) + 8LL * i));
  ...
  *((_DWORD *)this + 9) = 0;
  if ( *(_QWORD *)this )
  {
    for ( j = 0; j < *((_DWORD *)this + 4); ++j )
      Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease((__int64 *)(*((_QWORD *)this + 1) + 8LL * j));
