/*
 * XREFs of ?DebugInspectTexture@@YAJPEAUID3D11Texture2D@@I@Z @ 0x18028CF2C
 * Callers:
 ...
 *     ?LockAndRead@?$CDeviceTextureT@VICrossAdapterTexture@@@@UEBAXPEBVID2DContextOwner@@@Z @ 0x1802B8270 (-LockAndRead@-$CDeviceTextureT@VICrossAdapterTexture@@@@UEBAXPEBVID2DContextOwner@@@Z.c)
 * Callees:
