/*
 * XREFs of ?GetSize@CDxHandleYUVBitmapRealization@@UEBA?AUD2D_SIZE_U@@XZ @ 0x1801A1FD0
 * Callers:
 ...
 *     ?GetSize@CDxHandleYUVBitmapRealization@@WBAA@EBA?AUD2D_SIZE_U@@XZ @ 0x1802AF3D0 (-GetSize@CDxHandleYUVBitmapRealization@@WBAA@EBA-AUD2D_SIZE_U@@XZ.c)
 * Callees:
