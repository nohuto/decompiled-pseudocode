/*
 * XREFs of ?SetMatrix34@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BD78
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix34(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 396) )
  {
    *(float *)(a1 + 396) = a2;
