/*
 * XREFs of ?SignalSEBWorker@CFSVPProvider@@AEAAXXZ @ 0x1801C8C04
 * Callers:
 ...
 *     _CFSVPProvider::EnsureThreadpoolTask_::_5_::_lambda_1_::_lambda_invoker_cdecl_ @ 0x180252D00 (_CFSVPProvider--EnsureThreadpoolTask_--_5_--_lambda_1_--_lambda_invoker_cdecl_.c)
 * Callees:
