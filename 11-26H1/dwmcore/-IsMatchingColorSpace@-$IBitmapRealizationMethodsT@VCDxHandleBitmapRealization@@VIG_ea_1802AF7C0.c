/*
 * XREFs of ?IsMatchingColorSpace@?$IBitmapRealizationMethodsT@VCDxHandleBitmapRealization@@VIGDIBitmapRealization@@@@WBEA@EBA_NW4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x1802AF7C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
