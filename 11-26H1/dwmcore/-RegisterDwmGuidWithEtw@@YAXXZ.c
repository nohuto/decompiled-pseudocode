/*
 * XREFs of ?RegisterDwmGuidWithEtw@@YAXXZ @ 0x1801D4168
 * Callers:
 *     DllMain @ 0x1801BC54C (DllMain.c)
 * Callees:
 *     ??$Write@U?$_tlgWrapperByRef@$0BA@@@U?$_tlgWrapSz@G@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByRef@$0BA@@@AEBU?$_tlgWrapSz@G@@@Z @ 0x1800054E4 (--$Write@U-$_tlgWrapperByRef@$0BA@@@U-$_tlgWrapSz@G@@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider.c)
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1800795B8 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 *     _tlgKeywordOn @ 0x1800982C0 (_tlgKeywordOn.c)
 *     TraceLoggingRegisterEx_EventRegister_EventSetInformation @ 0x1801D4348 (TraceLoggingRegisterEx_EventRegister_EventSetInformation.c)
 *     McGenEventRegister_EventRegister @ 0x18021F0A4 (McGenEventRegister_EventRegister.c)
...
void __fastcall RegisterDwmGuidWithEtw(__int64 a1, __int64 a2)
{
  ...
  McGenEventRegister_EventRegister(
    ...
    Microsoft_Windows_Dwm_Compositor_Context);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803DC880);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803DC8F0);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803DC810);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803DC848);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803DC8B8);
