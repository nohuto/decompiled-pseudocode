/*
 * XREFs of ?ProcessSetInertiaCenterpointX@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETINERTIACENTERPOINTX@@@Z @ 0x180218AE4
 * Callers:
        ...
        const struct tagMILCMD_INTERACTIONTRACKER_SETINERTIACENTERPOINTX *a3)
{
  ...
  Microsoft::WRL::ComPtr<CBaseExpression>::operator=((__int64 *)this + 57, Resource);
