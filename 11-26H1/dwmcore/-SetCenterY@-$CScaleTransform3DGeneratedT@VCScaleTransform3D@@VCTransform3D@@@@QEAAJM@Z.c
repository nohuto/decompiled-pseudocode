/*
 * XREFs of ?SetCenterY@?$CScaleTransform3DGeneratedT@VCScaleTransform3D@@VCTransform3D@@@@QEAAJM@Z @ 0x18024A5C8
 * Callers:
...
__int64 __fastcall CScaleTransform3DGeneratedT<CScaleTransform3D,CTransform3D>::SetCenterY(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 176) )
  {
    *(float *)(a1 + 176) = a2;
