/*
 * XREFs of ??$move_backward_uninitialized@V?$basic_iterator@V?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@detail@@V?$checked_array_iterator@PEAV?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@stdext@@@detail@@YAXV?$basic_iterator@V?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@0@0V?$checked_array_iterator@PEAV?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@stdext@@@Z @ 0x180145500
 * Callers:
...
__int64 *__fastcall detail::move_backward_uninitialized<detail::basic_iterator<wil::com_ptr_t<CD3DPixelShader,wil::err_returncode_policy>>,stdext::checked_array_iterator<wil::com_ptr_t<CD3DPixelShader,wil::err_returncode_policy> *>>(
        __int64 **a1,
        __int64 **a2,
        _QWORD *a3)
{
