/*
 * XREFs of ?SetInnerConeColor@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJU_D3DCOLORVALUE@@@Z @ 0x18024B514
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetInnerConeColor(
        ...
        __int128 *a2)
{
  ...
  v7 = *a2;
  if ( !operator==((float *)&v7, (float *)this + 65) )
  {
