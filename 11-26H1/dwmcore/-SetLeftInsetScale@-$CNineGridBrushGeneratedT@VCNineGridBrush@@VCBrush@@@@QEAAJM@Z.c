/*
 * XREFs of ?SetLeftInsetScale@?$CNineGridBrushGeneratedT@VCNineGridBrush@@VCBrush@@@@QEAAJM@Z @ 0x18024BB60
 * Callers:
...
__int64 __fastcall CNineGridBrushGeneratedT<CNineGridBrush,CBrush>::SetLeftInsetScale(__int64 a1, float a2)
{
