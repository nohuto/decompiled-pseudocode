/*
 * XREFs of ?SetColorData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x18021A058
 * Callers:
        ...
        struct CResource *a2)
{
  if ( a2 != a1[18] )
  {
    CResource::ReplaceNotifier<CSceneMaterialInput>((CResource *)a1, a1 + 18, a2);
