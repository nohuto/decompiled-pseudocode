/*
 * XREFs of ?OnContentSizeChanged@CCaptureController@@IEAAXXZ @ 0x18026A3A0
 * Callers:
 *     ?SetContentSize@?$CCaptureControllerGeneratedT@VCCaptureController@@VCResource@@@@QEAAJUD2D_SIZE_F@@@Z @ 0x18024ABD8 (-SetContentSize@-$CCaptureControllerGeneratedT@VCCaptureController@@VCResource@@@@QEAAJUD2D_SIZE.c)
 * Callees:
        ...
        struct Windows::Foundation::Numerics::float4x4 *a3)
{
  ...
  v3 = (COffScreenRenderTarget **)*((_QWORD *)this + 21);
  v4 = (COffScreenRenderTarget **)*((_QWORD *)this + 20);
  if ( v4 != v3 )
  {
