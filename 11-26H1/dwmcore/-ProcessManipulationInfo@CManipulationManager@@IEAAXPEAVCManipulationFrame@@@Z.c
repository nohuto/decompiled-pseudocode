/*
 * XREFs of ?ProcessManipulationInfo@CManipulationManager@@IEAAXPEAVCManipulationFrame@@@Z @ 0x180113030
 * Callers:
 ...
 *     ?Update@ManipulationThreadTelemetryData@@QEAAXAEBUtagPOINTER_INFO@@AEBUtagTELEMETRY_POINTER_FRAME_TIMES@@I@Z @ 0x180113E94 (-Update@ManipulationThreadTelemetryData@@QEAAXAEBUtagPOINTER_INFO@@AEBUtagTELEMETRY_POINTER_FRAM.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$07@@U2@U2@U2@U2@U2@U2@U2@U2@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$07@@444444443@Z @ 0x1801B8AB0 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$07@@U2@U2@U2@U2@U2@U2@U2@U2@U1@@-$_.c)
 */
        ...
        struct CManipulationFrame *a2)
{
  ...
  v2 = (int *)((char *)a2 + 368);
  v4 = *((_DWORD *)a2 + 94);
  v5 = (unsigned int *)((char *)this + 268);
  if ( *((_DWORD *)this + 66) != v4 )
  {
    ++*v5;
    *((_DWORD *)this + 66) = v4;
  }
  v7 = *v5;
  v8 = (__int128 *)((char *)a2 + 32);
  v9 = *((_OWORD *)a2 + 3);
  v90 = *((_OWORD *)a2 + 2);
  v10 = *((_OWORD *)a2 + 4);
  v91 = v9;
