/*
 * XREFs of ?HrFindInterface@CConversionSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A77A0
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CScribbleSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801CC6F0 (-HrFindInterface@CScribbleSwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
