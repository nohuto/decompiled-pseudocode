/*
 * XREFs of ?CheckAndRegisterReadyReaders@DataProviderManager@@QEAAXPEAVBamoDataProviderProxy@@PEAVBamoDataSourceProxy@@@Z @ 0x18022E55C
 * Callers:
        ...
        struct BamoDataSourceProxy *a3)
{
  ...
  {
    v10 = *v7;
    if ( *((_QWORD *)*v7 + 9) == Unique && *((_QWORD *)v10 + 10) == v8 )
    {
