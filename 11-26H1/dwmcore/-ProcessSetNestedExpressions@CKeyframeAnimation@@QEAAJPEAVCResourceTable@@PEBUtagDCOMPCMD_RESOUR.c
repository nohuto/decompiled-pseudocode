/*
 * XREFs of ?ProcessSetNestedExpressions@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_RESOURCE_SETCOLLECTIONPROPERTY@@PEBXI_N@Z @ 0x180279DDC
 * Callers:
 *     ?ProcessMessage@CGlobalComposition@@EEAAJW4MILCMD@@PEBXIPEAVCChannelContext@@PEAVCResourceTable@@@Z @ 0x1801E7E80 (-ProcessMessage@CGlobalComposition@@EEAAJW4MILCMD@@PEBXIPEAVCChannelContext@@PEAVCResourceTable@.c)
 *     ?ProcessAppendNestedExpressions@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_RESOURCE_SETCOLLECTIONPROPERTY@@PEBXI@Z @ 0x18024980C (-ProcessAppendNestedExpressions@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagDCOMPCMD_RES.c)
 * Callees:
...
__int64 __fastcall CKeyframeAnimation::ProcessSetNestedExpressions(
