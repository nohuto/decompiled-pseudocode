/*
 * XREFs of ?SetTransformParentDataInternal@CVisual@@QEAAXPEAUTransformParentData@@@Z @ 0x18014AFD0
 * Callers:
...
void __fastcall CVisual::SetTransformParentDataInternal(CVisual *this, struct TransformParentData *a2)
{
  ...
  if ( a2 )
  {
    if ( v4 )
    {
      Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v2, 6);
      if ( Slot < *(_DWORD *)(v9 + 4) )
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((char **)this + 28, 6) = a2;
    }
  }
  else if ( v4 )
  {
    *v2 &= ~0x4000000u;
    v5 = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v2, 6);
    if ( v5 < *(_DWORD *)(v6 + 4) )
      *(_BYTE *)(v5 + v6 + 8) = v7;
  }
}
