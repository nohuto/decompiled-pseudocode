/*
 * XREFs of ??$SetProperty@UD2DQuaternion@@@DataSourcePropertySet@@QEAAJUDCOMPOSITION_PROPERTY_ID@@PEBUD2DQuaternion@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1802423E0
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DQuaternion>(__int64 a1, int a2, __m128i *a3)
{
  __int64 v5; // rcx
  int v6; // ebx
  __int64 v7; // rdx
  ...
  if ( v13 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DQuaternion>(v5, 71, a3, &v15);
    if ( v6 < 0 )
    {
      v7 = 37LL;
LABEL_4:
  ...
  {
    v9 = *(_DWORD *)(v13 + 20);
    if ( (unsigned int)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::GetDataType(v5, v9) != 71 )
    {
      v6 = -2147024809;
      v7 = 48LL;
      goto LABEL_4;
