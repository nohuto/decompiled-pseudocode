/*
 * XREFs of ?GetD2DBitmap@CD2DBitmap@@UEAAJPEAPEAUID2D1Bitmap1@@_N@Z @ 0x1801026C0
 * Callers:
 *     ?GetD2DBitmap@?$IDeviceSurfaceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@WKI@EAAJPEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802A9E00 (-GetD2DBitmap@-$IDeviceSurfaceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@WKI@EAAJPEAPEAUID2D.c)
 *     ?GetD2DBitmap@?$IDeviceSurfaceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@WLI@EAAJPEAPEAUID2D1Bitmap1@@_N@Z @ 0x1802A9E20 (-GetD2DBitmap@-$IDeviceSurfaceMethodsT@VCD2DBitmap@@VIDeviceTextureTarget@@@@WLI@EAAJPEAPEAUID2D.c)
 * Callees:
...
__int64 __fastcall CD2DBitmap::GetD2DBitmap(CD2DBitmap *this, struct ID2D1Bitmap1 **a2, char a3)
{
  ...
  *a2 = 0LL;
  ...
  if ( a3 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v11, 0x92u, 0LL);
      return v7;
    }
