/*
 * XREFs of ?SetMaxAttenuationCutoff@?$CSpotLightGeneratedT@VCSpotLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024C08C
 * Callers:
...
__int64 __fastcall CSpotLightGeneratedT<CSpotLight,CPositionedLight>::SetMaxAttenuationCutoff(
