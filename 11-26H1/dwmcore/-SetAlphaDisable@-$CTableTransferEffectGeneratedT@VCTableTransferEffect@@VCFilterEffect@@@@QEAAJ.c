/*
 * XREFs of ?SetAlphaDisable@?$CTableTransferEffectGeneratedT@VCTableTransferEffect@@VCFilterEffect@@@@QEAAJ_N@Z @ 0x180249DF0
 * Callers:
...
__int64 __fastcall CTableTransferEffectGeneratedT<CTableTransferEffect,CFilterEffect>::SetAlphaDisable(
        __int64 a1,
        char a2)
{
  if ( a2 != *(_BYTE *)(a1 + 355) )
