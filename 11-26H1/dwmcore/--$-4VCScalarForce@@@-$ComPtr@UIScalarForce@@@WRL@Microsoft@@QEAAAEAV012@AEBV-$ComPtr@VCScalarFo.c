/*
 * XREFs of ??$?4VCScalarForce@@@?$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@AEBV?$ComPtr@VCScalarForce@@@12@@Z @ 0x1802181C8
 * Callers:
...
__int64 *__fastcall Microsoft::WRL::ComPtr<IScalarForce>::operator=<CScalarForce>(__int64 *a1, _QWORD *a2)
{
