/*
 * XREFs of ?ContainsPoint@CVisualDepthGeometry@@AEBA_NAEBUfloat2@Numerics@Foundation@Windows@@_N@Z @ 0x1800D0E08
 * Callers:
        ...
        char a3)
{
  ...
  v5 = 0LL;
  v6 = 1;
  v7 = (float *)((char *)this + 84);
  while ( v5 < 4 )
  {
    if ( !v4 && !v6 )
      return result;
    v8 = (float)((float)(*((float *)a2 + 1) - v7[1]) * v7[2]) - (float)((float)(*(float *)a2 - *v7) * v7[3]);
    if ( v4 && v8 < 0.0 )
      v4 = 0;
    if ( v6 && v8 > 0.0 )
      v6 = 0;
