/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VID2DBitmapCacheSource@@VCMilObjectDeleter@@@@IEAAKXZ @ 0x1800F5710
 * Callers:
 ...
 *     ?Release@CSecondarySysmemBitmap@@UEAAKXZ @ 0x1800F5700 (-Release@CSecondarySysmemBitmap@@UEAAKXZ.c)
