/*
 * XREFs of ?PartitionSwitchRemotingMode@CChannel@@UEAAJW4Enum@DwmRemotingMode@@I@Z @ 0x180118F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::PartitionSwitchRemotingMode(CChannel *a1, int a2, int a3)
{
  __int64 v3; // r14
  unsigned int v7; // ebx
