  ...
  *((_QWORD *)this + 13) = v11;
  ...
  if ( *((_QWORD *)this + 13) )
  {
    ...
    for ( i = 0LL; i < v24[0]; v13 = v24[0] )
    {
      v15 = *(_WORD *)(v24[1] + 2 * i);
      v18 = v15 & 0xFF00;
      if ( (v15 & 0xFF00) == 0x200 || v18 == 256 || v18 == 1024 )
      {
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2147024882, 0x22Fu, 0LL);
  }
  return v6;
}
