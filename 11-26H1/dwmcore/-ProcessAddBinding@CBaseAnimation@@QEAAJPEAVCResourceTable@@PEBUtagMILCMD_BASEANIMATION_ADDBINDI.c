/*
 * XREFs of ?ProcessAddBinding@CBaseAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEANIMATION_ADDBINDING@@@Z @ 0x180151CE8
 * Callers:
...
LABEL_5:
  ...
  v11 = (*(__int64 (__fastcall **)(CBaseAnimation *, __int128 *))(*(_QWORD *)this + 192LL))(this, &v14);
  v10 = v11;
  if ( v11 < 0 )
