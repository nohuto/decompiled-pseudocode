/*
 * XREFs of ?GetContentBounds@CRedirectVisual@@UEAAJPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801BC430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRedirectVisual::GetContentBounds(__int64 a1, _QWORD *a2)
{
  ...
  if ( v2 )
  {
    ...
    v5 = 0LL;
    (*(void (__fastcall **)(__int64, __int64 *, _QWORD *))(*(_QWORD *)v2 + 192LL))(v2, &v5, a2);
  }
  else
  {
    a2[1] = 0LL;
