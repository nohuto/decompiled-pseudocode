/*
 * XREFs of ?SetBottomInset@?$CNineGridBrushGeneratedT@VCNineGridBrush@@VCBrush@@@@QEAAJM@Z @ 0x18024A3C4
 * Callers:
...
__int64 __fastcall CNineGridBrushGeneratedT<CNineGridBrush,CBrush>::SetBottomInset(__int64 a1, float a2)
{
