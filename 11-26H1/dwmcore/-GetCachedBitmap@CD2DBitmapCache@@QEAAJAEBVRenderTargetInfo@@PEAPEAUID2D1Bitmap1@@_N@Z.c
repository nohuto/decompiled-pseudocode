/*
 * XREFs of ?GetCachedBitmap@CD2DBitmapCache@@QEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1801C6690
 * Callers:
 *     ?GetD2DBitmap@CWICBitmapRealization@@UEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z @ 0x1801C6680 (-GetD2DBitmap@CWICBitmapRealization@@UEAAJAEBVRenderTargetInfo@@PEAPEAUID2D1Bitmap1@@_N@Z.c)
        ...
        char a4)
{
  ...
  *a3 = 0LL;
  ...
  else if ( (_BYTE)v22 )
  {
    ...
    {
      LOBYTE(v20) = a4;
      v21 = (*(__int64 (__fastcall **)(__int64, const struct RenderTargetInfo *, struct ID2D1Bitmap1 **, __int64))(*(_QWORD *)v22 + 120LL))(
              v22,
              a2,
              a3,
              v20);
  ...
  {
    LOBYTE(v12) = a4;
    v15 = (*(__int64 (__fastcall **)(__int64, struct ID2D1Bitmap1 **, __int64))(*(_QWORD *)v23 + 168LL))(v23, a3, v12);
    v14 = v15;
    if ( v15 < 0 )
