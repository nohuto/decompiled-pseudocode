/*
 * XREFs of ?SetTexCoord1Data@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x18021A09C
 * Callers:
        ...
        struct CResource *a2)
{
  if ( a2 != a1[17] )
  {
    CResource::ReplaceNotifier<CSceneMaterialInput>((CResource *)a1, a1 + 17, a2);
