/*
 * XREFs of ?SetBlurredWallpaperSurface@CVisual@@QEAAXPEAVCVisualSurface@@@Z @ 0x1801D6BA4
 * Callers:
...
void __fastcall CVisual::SetBlurredWallpaperSurface(CVisual *this, struct CVisualSurface *a2)
{
  ...
  if ( a2 )
  {
    if ( v4 )
    {
      Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v2, 15);
      if ( Slot < *(_DWORD *)(v9 + 4) )
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((char **)this + 28, 15) = a2;
    }
  }
  else if ( v4 )
  {
    *v2 &= ~0x20000u;
    v5 = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v2, 15);
    if ( v5 < *(_DWORD *)(v6 + 4) )
      *(_BYTE *)(v5 + v6 + 8) = v7;
  }
}
