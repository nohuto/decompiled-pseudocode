/*
 * XREFs of ?_Calculate_growth@?$vector@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@2@@std@@AEBA_K_K@Z @ 0x180237D24
 * Callers:
...
__int64 __fastcall std::vector<std::unique_ptr<CSyncLockGroup>>::_Calculate_growth(__int64 a1, unsigned __int64 a2)
{
  ...
  v3 = (*((_QWORD *)&xmmword_1803E26A0 + 1) - CSyncLockGroup::g_syncLockGroups) >> 3;
  v4 = v3 >> 1;
