/*
 * XREFs of ??$ResolveProhibitedMotion@UDwmPenInteractionConfigurationPrimitive@@W4FlagsEnum@DwmInteractionTypePenPrimitiveType@@@CInteractionProcessor@@AEAA_NAEBV?$DynArray@UDwmPenInteractionConfigurationPrimitive@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x1801B9518
 * Callers:
...
char __fastcall CInteractionProcessor::ResolveProhibitedMotion<DwmPenInteractionConfigurationPrimitive,enum DwmInteractionTypePenPrimitiveType::FlagsEnum>(
        __int64 *a1,
        __int64 *a2,
        __int64 a3,
        _DWORD *a4)
