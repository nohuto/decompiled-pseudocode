/*
 * XREFs of ??2CInteractionTrackerScaleAnimation@@SAPEAX_K@Z @ 0x18013E968
 * Callers:
...
LPVOID __fastcall CInteractionTrackerScaleAnimation::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0x218uLL);
  if ( !result )
