/*
 * XREFs of ?SetProperty@?$CBrightnessEffectGeneratedT@VCBrightnessEffect@@VCFilterEffect@@@@MEAAJUDCOMPOSITION_PROPERTY_ID@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18024CC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBrightnessEffectGeneratedT<CBrightnessEffect,CFilterEffect>::SetProperty(
        __int64 a1,
        int a2,
        int a3,
        float *a4)
