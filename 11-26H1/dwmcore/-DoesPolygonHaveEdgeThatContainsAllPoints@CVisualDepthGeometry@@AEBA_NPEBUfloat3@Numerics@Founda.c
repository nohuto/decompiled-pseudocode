/*
 * XREFs of ?DoesPolygonHaveEdgeThatContainsAllPoints@CVisualDepthGeometry@@AEBA_NPEBUfloat3@Numerics@Foundation@Windows@@H@Z @ 0x18020E498
 * Callers:
...
char __fastcall CVisualDepthGeometry::DoesPolygonHaveEdgeThatContainsAllPoints(
        ...
        int a3)
{
  const struct Windows::Foundation::Numerics::float3 *v3; // r11
  __int64 v5; // rdi
  int v6; // r9d
