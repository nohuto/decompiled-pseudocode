/*
 * XREFs of ?Partition_SetCurrentMmTask@CComposition@@IEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUtagMILCMD_PARTITION_SETCURRENTMMTASK@@@Z @ 0x1801319E0
 * Callers:
        ...
        const struct tagMILCMD_PARTITION_SETCURRENTMMTASK *a4)
{
  ...
  v15[8] = v11;
  v12 = CMmcssTask::Set((struct _RTL_CRITICAL_SECTION *)((char *)this + 728), (const struct DWM_MMTASK *)v15, 1);
  v13 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v12, 0x434u, 0LL);
  else
