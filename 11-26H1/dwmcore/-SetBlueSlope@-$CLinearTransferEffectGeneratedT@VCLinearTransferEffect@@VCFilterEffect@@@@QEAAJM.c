/*
 * XREFs of ?SetBlueSlope@?$CLinearTransferEffectGeneratedT@VCLinearTransferEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024A2BC
 * Callers:
...
__int64 __fastcall CLinearTransferEffectGeneratedT<CLinearTransferEffect,CFilterEffect>::SetBlueSlope(
        __int64 a1,
        float a2)
{
  if ( a2 != *(float *)(a1 + 380) )
