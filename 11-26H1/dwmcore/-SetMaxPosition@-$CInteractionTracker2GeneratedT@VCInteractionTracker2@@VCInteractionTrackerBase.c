/*
 * XREFs of ?SetMaxPosition@?$CInteractionTracker2GeneratedT@VCInteractionTracker2@@VCInteractionTrackerBase@@@@QEAAJUD2D_POINT_2F@@@Z @ 0x18024C0D0
 * Callers:
...
__int64 __fastcall CInteractionTracker2GeneratedT<CInteractionTracker2,CInteractionTrackerBase>::SetMaxPosition(
        __int64 a1,
        __int64 a2)
{
  _QWORD *v2; // rdx
  ...
  v6 = a2;
  if ( operator!=((float *)&v6, (float *)(a1 + 228)) )
  {
    *(_BYTE *)(v3 + 830) |= 4u;
    *v2 = a2;
  }
