/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1802449AC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v13[1] = v16;
      return CoreUICallSend(v10, v13, 2LL, 0LL, 4, &unk_180373365, a2, v12, v15);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
