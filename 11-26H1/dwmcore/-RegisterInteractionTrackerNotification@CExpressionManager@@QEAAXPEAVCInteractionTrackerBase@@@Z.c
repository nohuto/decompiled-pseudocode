/*
 * XREFs of ?RegisterInteractionTrackerNotification@CExpressionManager@@QEAAXPEAVCInteractionTrackerBase@@@Z @ 0x180107A68
 * Callers:
        ...
        struct CInteractionTrackerBase *a2)
{
  ...
  unsigned int v6; // ecx
  int v7; // eax
  struct CInteractionTrackerBase *v8; // [rsp+48h] [rbp+10h] BYREF
  ...
  {
    if ( a2 == *(struct CInteractionTrackerBase **)(v4 + 8 * v3) )
      return;
  ...
  {
    v7 = DynArrayImpl<1>::AddMultipleAndSet(v2, 8LL, v5, &v8);
    if ( v7 < 0 )
