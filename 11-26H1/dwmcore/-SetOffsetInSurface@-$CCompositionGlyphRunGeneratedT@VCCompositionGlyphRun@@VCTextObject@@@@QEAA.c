/*
 * XREFs of ?SetOffsetInSurface@?$CCompositionGlyphRunGeneratedT@VCCompositionGlyphRun@@VCTextObject@@@@QEAAJUD2D_VECTOR_2F@@@Z @ 0x18024C564
 * Callers:
        ...
        __int64 a2)
{
  ...
  v7 = a2;
  if ( operator!=((float *)&v7, (float *)(a1 + 96)) )
  {
    v4 = *(_QWORD *)(a1 + 48) == 0LL;
    *v3 = a2;
    if ( !v4 )
