/*
 * XREFs of ?ActiveAnimationsTelemetry@CComposition@@IEAAXXZ @ 0x18002E200
 * Callers:
...
void __fastcall CComposition::ActiveAnimationsTelemetry(CComposition *this, __int64 a2, __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 6457) )
  {
    ...
    {
      v5 = *(_DWORD **)(*((_QWORD *)this + 104) + 8LL * i);
      if ( v5 )
      {
        v6 = (unsigned int)v5[33];
        if ( (_DWORD)v6 || v5[31] )
        {
          ...
          dword_1803DE410 += v5[33];
          dword_1803DE414 += v5[31];
          v5[33] = 0;
          v5[31] = 0;
        }
      }
