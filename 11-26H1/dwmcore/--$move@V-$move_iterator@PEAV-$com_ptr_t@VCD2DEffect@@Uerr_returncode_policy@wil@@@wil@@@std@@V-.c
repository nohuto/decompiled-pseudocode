/*
 * XREFs of ??$move@V?$move_iterator@PEAV?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@@std@@V?$checked_array_iterator@PEAV?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAV?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@@stdext@@V?$move_iterator@PEAV?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@@0@0V12@@Z @ 0x180196AE0
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  while ( v4 != a3 )
    wil::com_ptr_t<IBitmapLock,wil::err_returncode_policy>::operator=(v8++, v4++);
  result = a1;
