/*
 * XREFs of ?GetCachedEffectNoRef@CD2DContext@@UEAAJW4D2DEffect@@PEAPEAUID2D1Effect@@@Z @ 0x1801029C0
 * Callers:
...
__int64 __fastcall CD2DContext::GetCachedEffectNoRef(__int64 a1, unsigned int a2, __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v6 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003304307, 0x4A9u, 0LL);
    goto LABEL_6;
  }
  v6 = 0;
  v7 = a1 + 8LL * a2;
  ...
  if ( !v8 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v10, 0x4AEu, 0LL);
      goto LABEL_6;
    }
    v8 = v11;
    *(_QWORD *)(v7 + 216) = v11;
