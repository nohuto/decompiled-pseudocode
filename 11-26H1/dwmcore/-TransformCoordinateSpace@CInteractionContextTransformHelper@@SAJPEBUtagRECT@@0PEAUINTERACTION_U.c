/*
 * XREFs of ?TransformCoordinateSpace@CInteractionContextTransformHelper@@SAJPEBUtagRECT@@0PEAUINTERACTION_UPDATE@@1@Z @ 0x18010708C
 * Callers:
 ...
 * Callees:
 *     TransformPoint @ 0x1801071D4 (TransformPoint.c)
 */
