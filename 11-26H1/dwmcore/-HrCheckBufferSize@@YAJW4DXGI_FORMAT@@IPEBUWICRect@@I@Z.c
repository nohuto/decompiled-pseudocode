/*
 * XREFs of ?HrCheckBufferSize@@YAJW4DXGI_FORMAT@@IPEBUWICRect@@I@Z @ 0x1800E5FC0
 * Callers:
...
__int64 __fastcall HrCheckBufferSize(enum DXGI_FORMAT a1, __int64 a2, const struct WICRect *a3, unsigned int a4)
{
...
LABEL_8:
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v9, 0x6A0u, 0LL);
    return v10;
  }
  if ( v13 > a4 )
  {
