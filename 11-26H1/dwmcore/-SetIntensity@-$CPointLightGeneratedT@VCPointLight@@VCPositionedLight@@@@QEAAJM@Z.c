/*
 * XREFs of ?SetIntensity@?$CPointLightGeneratedT@VCPointLight@@VCPositionedLight@@@@QEAAJM@Z @ 0x18024B6B4
 * Callers:
...
__int64 __fastcall CPointLightGeneratedT<CPointLight,CPositionedLight>::SetIntensity(CPositionedLight *this, float a2)
{
  if ( a2 != *((float *)this + 65) )
  {
    *((float *)this + 65) = a2;
