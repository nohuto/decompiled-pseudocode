/*
 * XREFs of ?SetInertiaCenterpointX@CInteractionTracker2@@QEAAJPEAVCConditionalExpression@@@Z @ 0x18021E148
 * Callers:
...
__int64 __fastcall CInteractionTracker2::SetInertiaCenterpointX(
        CInteractionTracker2 *this,
        struct CConditionalExpression *a2)
{
  Microsoft::WRL::ComPtr<CBaseExpression>::operator=((__int64 *)this + 118, (__int64)a2);
