/*
 * XREFs of ?DxFlipConsumedTelemetry@CWindowNode@@AEBAXPEAVCDrawingContext@@PEAVCCompositionSurfaceBitmap@@@Z @ 0x1800E31E0
 * Callers:
        ...
        struct CCompositionSurfaceBitmap *a3)
{
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
  {
    if ( *((_BYTE *)a2 + 184) )
    {
      v5 = *((_QWORD *)a3 + 12);
      v6 = *((_DWORD *)a2 + 45);
      v26 = *(_QWORD *)((char *)a2 + 172);
      v7 = *(__m128i *)((char *)a2 + 156);
      v27 = 0LL;
      if ( v5 )
      {
        if ( (unsigned __int8)TMilRect<unsigned int,MilRectU,Mil3DRectU,RectUniqueness::NotNeeded>::IsEmpty(v5 + 48) )
        {
          v10 = 0;
        }
        else
