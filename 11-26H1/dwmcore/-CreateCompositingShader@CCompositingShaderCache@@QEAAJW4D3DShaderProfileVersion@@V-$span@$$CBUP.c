/*
 * XREFs of ?CreateCompositingShader@CCompositingShaderCache@@QEAAJW4D3DShaderProfileVersion@@V?$span@$$CBUPixelFormatInfo@@$0?0@gsl@@W4DXGI_COLOR_SPACE_TYPE@@PEAPEAVCLinkedShader@@@Z @ 0x1802B3C20
 * Callers:
        ...
        volatile signed __int32 **a5)
{
  ...
  CLinkedShader *v17; // [rsp+30h] [rbp-20h] BYREF
  ...
  v10 = LinkCompositingShader(a2, (__int64)&CompositingShaderLookupKey, a4, &v19);
  v11 = v10;
  if ( v10 < 0 )
  {
    v16 = 59;
  ...
  CompositingShaderLookupKey = (unsigned __int64)CCompositingShaderCache::GetCompositingShaderLookupKey(
                                                   ...
                                                   v6);
  v10 = CShaderCache::AddLinkedShader(a1, (__int64)&CompositingShaderLookupKey, v14);
  v11 = v10;
  if ( v10 < 0 )
  {
    v16 = 67;
