/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAU_WNF_USER_SUBSCRIPTION@@P6AJPEAU1@@Z$1?RtlUnsubscribeWnfStateChangeNotification@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x1802299F0
 * Callers:
        ...
        __int64 *a1)
{
  ...
  v1 = *a1;
  if ( v1 )
    return RtlUnsubscribeWnfStateChangeNotification(v1);
  return result;
}
