/*
 * XREFs of ?SendProxyDisposed@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x180240A50
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v7 = v2;
  v4 = CoreUICallSend(*(_QWORD *)(v3 + 72), &v7, 2LL, 7LL, 9, &unk_180373365, a2, v6, v2.m128i_i32[0]);
  if ( v4 < 0 )
