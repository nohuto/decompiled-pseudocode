/*
 * XREFs of ?EnsurePositionIsGreaterThanOrEqualToMin@CInteractionTracker2@@AEAAXW4PropertyValueMask@1@@Z @ 0x180273148
 * Callers:
...
__int64 __fastcall CInteractionTracker2::EnsurePositionIsGreaterThanOrEqualToMin(__int64 *a1, char a2)
{
  int v2; // eax
  __int64 v3; // rax
  __int64 result; // rax
  ...
  if ( !*((_DWORD *)a1 + 22) && (*((_BYTE *)a1 + 828) & 0x20) == 0 )
  {
    ...
    v6 = v2;
    if ( (a2 & 1) != 0 )
      LODWORD(v5) = fmaxf(*((float *)a1 + 106), *((float *)a1 + 109));
    if ( (a2 & 2) != 0 )
      HIDWORD(v5) = fmaxf(*((float *)a1 + 107), *((float *)a1 + 110));
    v3 = *a1;
    v6 = 0;
