/*
 * XREFs of ?SetMatrix53@?$CColorMatrixEffectGeneratedT@VCColorMatrixEffect@@VCFilterEffect@@@@QEAAJM@Z @ 0x18024BFA8
 * Callers:
...
__int64 __fastcall CColorMatrixEffectGeneratedT<CColorMatrixEffect,CFilterEffect>::SetMatrix53(__int64 a1, float a2)
{
  if ( a2 != *(float *)(a1 + 424) )
  {
    *(float *)(a1 + 424) = a2;
