 ...
 *     ??$move_backward_uninitialized@V?$basic_iterator@V?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@detail@@V?$checked_array_iterator@PEAV?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@stdext@@@detail@@YAXV?$basic_iterator@V?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@0@0V?$checked_array_iterator@PEAV?$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_policy@wil@@@wil@@@stdext@@@Z @ 0x180145500 (--$move_backward_uninitialized@V-$basic_iterator@V-$com_ptr_t@VCD3DPixelShader@@Uerr_returncode_.c)
        ...
        __int64 *a3)
{
  ...
  v7 = ((__int64)v6 - *a1) >> 3;
  v8 = (__int64 *)(*a1 + 8 * v7);
  stdext::checked_array_iterator<_LUID *>::checked_array_iterator<_LUID *>(&v14, (__int64)v8, 1LL);
  v12 = v14;
  v13 = v15;
  ...
  v15 = v13;
  v17 = &v6[-v10];
  detail::move_backward_uninitialized<detail::basic_iterator<wil::com_ptr_t<CD3DPixelShader,wil::err_returncode_policy>>,stdext::checked_array_iterator<wil::com_ptr_t<CD3DPixelShader,wil::err_returncode_policy> *>>(
    &v17,
    &v18,
    &v14);
  if ( (unsigned __int64)(v7 - a2) > 1 )
  ...
  if ( (unsigned __int64)v8 >= v5 + 8 * (a2 + 1) )
    v8 = (__int64 *)(v5 + 8 * (a2 + 1));
