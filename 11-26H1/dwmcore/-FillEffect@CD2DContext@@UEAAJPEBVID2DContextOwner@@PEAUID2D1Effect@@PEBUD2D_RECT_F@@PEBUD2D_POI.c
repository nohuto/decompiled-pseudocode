/*
 * XREFs of ?FillEffect@CD2DContext@@UEAAJPEBVID2DContextOwner@@PEAUID2D1Effect@@PEBUD2D_RECT_F@@PEBUD2D_POINT_2F@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_COMPOSITE_MODE@@@Z @ 0x1800AEC70
 * Callers:
        ...
        enum D2D1_COMPOSITE_MODE a7)
{
  ...
  v11 = CD2DTargetStack::Top((CD2DTargetStack *)(this + 40));
  v19 = 0LL;
  v18 = 0LL;
