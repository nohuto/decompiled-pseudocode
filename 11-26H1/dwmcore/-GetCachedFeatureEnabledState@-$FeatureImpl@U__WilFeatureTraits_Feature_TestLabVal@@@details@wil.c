/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TestLabVal@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800993D8
 * Callers:
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UnpinForNoFlip@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18029AAE4 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_UnpinForNoFlip@@@detail.c)
 * Callees:
  ...
  if ( (v2 & 6) != 6 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)a2 = v10;
      ...
      if ( !v11 && (v10 & 2) == 0 )
      {
        v13 = (v10 ^ ((unsigned __int16)v10 ^ (unsigned __int16)v9) & 0x180 ^ (v9 ^ v10 ^ ((unsigned __int16)v10 ^ (unsigned __int16)v9) & 0x180) & 0x40 | 1) ^ ((unsigned __int16)v9 ^ ((unsigned __int16)(v10 ^ (v10 ^ v9) & 0x180 ^ (v9 ^ v10 ^ (v10 ^ v9) & 0x180) & 0x40) | 1)) & 0x800 | 2;
        *(_DWORD *)a2 = v13;
      }
      if ( (v10 & 4) == 0 )
      {
