/*
 * XREFs of ?IsOfType@?$CBrightnessEffectGeneratedT@VCBrightnessEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180248DB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CBrightnessEffectGeneratedT<CBrightnessEffect,CFilterEffect>::IsOfType(__int64 a1, int a2)
{
  char v2; // al
  char v3; // cl
