/*
 * XREFs of ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1801E26FC
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_1_@?4??EnsureSubscribedToFeatureConfigurationChangesImpl@EnabledStateManager@details@wil@@AEAAIXZ@SA@PEAX@Z @ 0x180222710 (-_lambda_invoker_cdecl_@_lambda_1_@-4--EnsureSubscribedToFeatureConfigurationChangesImpl@Enabled.c)
 * Callees:
