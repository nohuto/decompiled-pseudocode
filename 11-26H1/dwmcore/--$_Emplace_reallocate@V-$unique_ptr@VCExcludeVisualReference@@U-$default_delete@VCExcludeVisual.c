        ...
        __int64 *a3)
{
  ...
  *v18 = v15;
  ...
  std::_Uninitialized_move<std::unique_ptr<CExcludeVisualReference> *,std::allocator<std::unique_ptr<CExcludeVisualReference>>>(
    ...
    v17);
  v22[1] = 0LL;
  std::vector<std::unique_ptr<CExcludeVisualReference>>::_Change_array((__int64)a1, v16, v9, v3);
  std::vector<std::unique_ptr<CExcludeVisualReference>>::_Reallocation_guard::~_Reallocation_guard(v22);
  return v18;
}
