/*
 * XREFs of ?FlattenToLineSegments@CRoundedRectangleShape@@UEBAJMPEAPEAVCShape@@@Z @ 0x1800DE4E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CShape **a3)
{
  ...
  if ( *(float *)(v3 + 64) > 0.0 )
  {
    ...
    v6 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v13, 0x2BFu, 0LL);
  }
  else
  {
    ...
    if ( v10 )
    {
      ...
      *((_QWORD *)v10 + 2) = CRoundedRectangleShape::SharedData::Create((const struct CRoundedRectangleGeometryData *)v14);
      Microsoft::WRL::ComPtr<IInteractionContextWrapper>::InternalAddRef((__int64 (__fastcall ****)(_QWORD))v11 + 2);
      *a3 = v11;
    }
    else
    {
