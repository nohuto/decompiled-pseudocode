/*
 * XREFs of ?CaptureControllerSetSwapChainHostVisual@CChannel@@UEAAJII@Z @ 0x180232900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetSwapChainHostVisual(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle((__int64)this, a3, 160);
  v8[0] = 388;
  v8[1] = a2;
  v8[2] = a3;
