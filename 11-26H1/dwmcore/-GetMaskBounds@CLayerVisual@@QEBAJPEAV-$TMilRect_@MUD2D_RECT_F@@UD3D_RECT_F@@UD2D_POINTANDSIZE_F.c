/*
 * XREFs of ?GetMaskBounds@CLayerVisual@@QEBAJPEAV?$TMilRect_@MUD2D_RECT_F@@UD3D_RECT_F@@UD2D_POINTANDSIZE_F@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180015660
 * Callers:
...
__int64 __fastcall CLayerVisual::GetMaskBounds(__int64 a1, _OWORD *a2)
{
  ...
  *a2 = TMilRect<float,D2D_RECT_F,D3D_RECT_F,RectUniqueness::NotNeeded>::sc_rcEmpty;
  ...
  if ( v3 )
  {
    ...
    {
      v10 = *(float *)(v6 + 144);
      if ( *(float *)(v6 + 140) != 0.0 && v10 != 0.0 )
      {
        v11 = *(_QWORD *)MaskForLayerVisualNoRef;
        v13 = *(_DWORD *)(v6 + 140);
        v14 = v10;
        v12 = (*(__int64 (__fastcall **)(struct CBrush *, int *, __int64))(v11 + 192))(v7, &v13, v5);
        v2 = v12;
        if ( v12 < 0 )
    ...
    {
      BoundsWithLayerEffect = CLayerVisual::GetBoundsWithLayerEffect(v6);
