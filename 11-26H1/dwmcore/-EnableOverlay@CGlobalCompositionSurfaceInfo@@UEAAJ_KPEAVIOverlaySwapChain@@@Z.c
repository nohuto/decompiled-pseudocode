/*
 * XREFs of ?EnableOverlay@CGlobalCompositionSurfaceInfo@@UEAAJ_KPEAVIOverlaySwapChain@@@Z @ 0x1801BF7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IOverlaySwapChain *a3)
{
  ...
  {
    v4 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, -2003292412, 0x15Fu, 0LL);
  }
  else
  {
    ...
    v4 = v3;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v3, 0x15Bu, 0LL);
  }
  return v4;
}
