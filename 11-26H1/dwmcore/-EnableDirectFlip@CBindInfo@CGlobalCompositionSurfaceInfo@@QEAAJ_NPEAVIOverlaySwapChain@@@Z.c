/*
 * XREFs of ?EnableDirectFlip@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_NPEAVIOverlaySwapChain@@@Z @ 0x1801DC4FC
 * Callers:
        ...
        struct IOverlaySwapChain *a3)
{
  ...
  {
    v6 = v5 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(20, 0LL, 0, v5 | 0x10000000, 0x492u, 0LL);
  }
  return (unsigned int)v6;
}
