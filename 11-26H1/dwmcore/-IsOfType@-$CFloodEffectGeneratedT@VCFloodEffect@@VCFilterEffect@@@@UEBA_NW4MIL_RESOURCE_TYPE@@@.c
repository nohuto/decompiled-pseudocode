/*
 * XREFs of ?IsOfType@?$CFloodEffectGeneratedT@VCFloodEffect@@VCFilterEffect@@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x180248EE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CFloodEffectGeneratedT<CFloodEffect,CFilterEffect>::IsOfType(__int64 a1, int a2)
{
  char v2; // al
  char v3; // cl
