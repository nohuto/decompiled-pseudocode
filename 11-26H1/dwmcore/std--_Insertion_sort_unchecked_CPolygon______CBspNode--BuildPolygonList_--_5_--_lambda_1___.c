/*
 * XREFs of std::_Insertion_sort_unchecked_CPolygon______CBspNode::BuildPolygonList_::_5_::_lambda_1___ @ 0x180265600
 * Callers:
...
char *__fastcall std::_Insertion_sort_unchecked_CPolygon______CBspNode::BuildPolygonList_::_5_::_lambda_1___(
        char *Src,
        char *a2)
{
  char *v4; // r15
