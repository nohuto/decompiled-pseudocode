/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIBitmapSource@@V1@VCMilObjectDeleter@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AAD5C
 * Callers:
 *     ?QueryInterface@CMappedTexture@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AAD50 (-QueryInterface@CMappedTexture@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
