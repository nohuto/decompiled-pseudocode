/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x1801D4D10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  v5 = CoreUICallSend(v4, &v8, 2LL, 7LL, 6, &unk_180373371, a2, v7, v8.m128i_i32[0]);
  if ( v5 < 0 )
