  ...
  if ( v11 )
  {
    ...
    *a5 = 0LL;
    while ( v13 )
    {
      ...
      {
        v15 = *(_QWORD *)v13 - *(_QWORD *)a2;
        if ( *(_QWORD *)v13 == *(_QWORD *)a2 )
          v15 = *(_QWORD *)(v13 + 8) - *((_QWORD *)a2 + 1);
        if ( !v15 )
        {
          *a5 = v12;
          *a6 = v13;
