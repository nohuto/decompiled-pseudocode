/*
 * XREFs of ??$UpdateActiveConfig@UDwmTouchpadInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXAEBUDwmTouchpadInteractionConfigurationPrimitive@@@Z @ 0x1801AEF14
 * Callers:
...
__int64 __fastcall InputTraceLogging::GestureTargeting::UpdateActiveConfig<DwmTouchpadInteractionConfigurationPrimitive>(
        __int64 a1)
{
  __int64 result; // rax
  __int64 v3; // r9
