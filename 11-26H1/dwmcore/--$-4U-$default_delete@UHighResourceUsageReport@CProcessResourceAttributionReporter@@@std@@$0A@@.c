/*
 * XREFs of ??$?4U?$default_delete@UHighResourceUsageReport@CProcessResourceAttributionReporter@@@std@@$0A@@?$unique_ptr@UHighResourceUsageReport@CProcessResourceAttributionReporter@@U?$default_delete@UHighResourceUsageReport@CProcessResourceAttributionReporter@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x180199A2C
 * Callers:
        ...
        _QWORD *a2)
{
  ...
  *a1 = v2;
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      std::_Deallocate<16>(v6, 8 * ((__int64)(v4[4] - (_QWORD)v6) >> 3));
      v4[2] = 0LL;
      v4[3] = 0LL;
      v4[4] = 0LL;
    }
