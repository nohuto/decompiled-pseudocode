 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x180001714 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x1800018A4 (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x1800018D0 (__scrt_uninitialize_crt.c)
 *     __scrt_fastfail @ 0x180001924 (__scrt_fastfail.c)
 *     _RTC_Terminate @ 0x180001ADC (_RTC_Terminate.c)
 */
