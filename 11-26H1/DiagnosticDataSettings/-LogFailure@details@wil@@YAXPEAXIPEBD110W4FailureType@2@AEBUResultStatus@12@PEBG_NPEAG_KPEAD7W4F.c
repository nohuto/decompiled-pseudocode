/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7W4FailureFlags@2@PEAUFailureInfo@2@@Z @ 0x180002FCC
 * Callers:
 ...
 * Callees:
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x180002570 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?HrToNtStatus@details@wil@@YAJJ@Z @ 0x180002E08 (-HrToNtStatus@details@wil@@YAJJ@Z.c)
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x18000335C (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x18000337C (-RecordLog@details@wil@@YAHJ@Z.c)
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x18000339C (-RecordReturn@details@wil@@YAHJ@Z.c)
 *     ?_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x1800039DC (-_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
