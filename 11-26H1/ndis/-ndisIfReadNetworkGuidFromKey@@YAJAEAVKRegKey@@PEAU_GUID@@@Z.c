/*
 * XREFs of ?ndisIfReadNetworkGuidFromKey@@YAJAEAVKRegKey@@PEAU_GUID@@@Z @ 0x1400CED8C
 * Callers:
 ...
 *     ??0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z @ 0x140138E90 (--0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z.c)
