/*
 * XREFs of ndisMiniportDeviceReadyNotification @ 0x14016DDF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisFindMiniportByPdo @ 0x140062160 (ndisFindMiniportByPdo.c)
...
__int64 __fastcall ndisMiniportDeviceReadyNotification(char *NotificationStructure, PVOID Context)
{
  ...
  if ( *(_WORD *)v3 < 0x80u )
  {
    xmmword_14011ED50 = 0LL;
    xmmword_14011ED60 = 0LL;
    xmmword_14011ED70 = 0LL;
    xmmword_14011ED80 = 0LL;
    xmmword_14011ED90 = 0LL;
    xmmword_14011EDA0 = 0LL;
    xmmword_14011EDB0 = 0LL;
    xmmword_14011EDC0 = 0LL;
    memmove(&xmmword_14011ED50, v3[1], *(unsigned __int16 *)v3);
  }
  else
  {
    v4 = (__int128 *)v3[1];
    xmmword_14011ED50 = *v4;
    xmmword_14011ED60 = v4[1];
    xmmword_14011ED70 = v4[2];
    xmmword_14011ED80 = v4[3];
    xmmword_14011ED90 = v4[4];
    xmmword_14011EDA0 = v4[5];
    xmmword_14011EDB0 = v4[6];
    xmmword_14011EDC0 = v4[7];
  }
