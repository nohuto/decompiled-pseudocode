/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_PROTOCOL_BLOCK@@@@SAJPEAU_NDIS_PROTOCOL_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_PROTOCOL_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x1400BAF64
 * Callers:
        ...
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  while ( v7 < 4 );
  v11 = ObjectTriageData<_NDIS_PROTOCOL_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, &v21);
  if ( v11 )
    goto LABEL_17;
  v12 = 16LL * v9;
