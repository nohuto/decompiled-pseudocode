/*
 * XREFs of NdisLWMRegisterMiniportDriver @ 0x140094F30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisValidateLWMiniportDriverCharacteristicsHeader@@YAHPEBU_NDIS_LWM_DRIVER_CHARACTERISTICS@@PEAE@Z @ 0x14013A858 (-ndisValidateLWMiniportDriverCharacteristicsHeader@@YAHPEBU_NDIS_LWM_DRIVER_CHARACTERISTICS@@PEA.c)
 */
        ...
        _NDIS_M_DRIVER_BLOCK **a3)
{
  ...
  *a3 = 0LL;
  LOBYTE(v15) = 0;
  v6 = ndisValidateLWMiniportDriverCharacteristicsHeader(v4, (unsigned __int8 *)&v15);
  if ( v6 )
    goto LABEL_12;
...
LABEL_12:
  ...
  if ( !v6 )
    v6 = ndisInternalRegisterMiniportDriver(0LL, v15, a1, &v14, (void **)a3);
  wistd::unique_ptr<_UNICODE_STRING,KFreePool<_UNICODE_STRING>>::reset((void **)&v15, 0LL);
  if ( v6 )
    goto LABEL_12;
LABEL_14:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
