/*
 * XREFs of McTemplateK0jqxjqxdd_EtwWriteTransfer @ 0x14008C5A0
 * Callers:
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, (const EVENT_DESCRIPTOR *)",'", a3, 9u, &v12);
}
