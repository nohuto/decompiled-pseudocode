/*
 * XREFs of ?ndisFIndicateTimestampChange@@YAEPEAU_NDIS_FILTER_BLOCK@@HPEAXK@Z @ 0x1400C8108
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( a2 == 1074073600 )
  {
    ...
    if ( HwTimestampCapabilities )
      goto LABEL_13;
    HwTimestampCapabilities = (_NDIS_TIMESTAMP_CAPABILITIES *)ExAllocatePool2(64LL, 56LL, 1936999502LL);
