/*
 * XREFs of ?FindActionForEvent@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAAXGPEAUEVENT_ACTION@123@@Z @ 0x14005F8E0
 * Callers:
 ...
 * Callees:
 *     ?FindActionForEventOnState@StateMachineEngineImpl@StateMachineEngine@SmFx@@CAXAEBUSTATE_SPECIFICATION@3@GPEAUEVENT_ACTION@123@@Z @ 0x14005FA60 (-FindActionForEventOnState@StateMachineEngineImpl@StateMachineEngine@SmFx@@CAXAEBUSTATE_SPECIFIC.c)
 */
        ...
        struct SmFx::StateMachineEngine::StateMachineEngineImpl::EVENT_ACTION *a3)
{
  ...
  const struct SmFx::STATE_SPECIFICATION *v8; // r14
