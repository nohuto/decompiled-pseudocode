/*
 * XREFs of ?ndisDetachFilterInner@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_FILTER_BLOCK@@@Z @ 0x14017A580
 * Callers:
 ...
 *     ?ndisFilterWaitForPnPComplete@@YAXPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x140169840 (-ndisFilterWaitForPnPComplete@@YAXPEAU_NDIS_FILTER_BLOCK@@@Z.c)
 */
...
void __fastcall ndisDetachFilterInner(struct _NDIS_MINIPORT_BLOCK *a1, _NDIS_FILTER_BLOCK *this)
{
  ...
  if ( ndisReferenceFilterByHandle(v2, v6) && (v4 = 1, (unsigned __int8)ndisReferenceMiniportByHandle(a1, 0, 0x29u)) )
  {
    ...
    ndisMakeWatchdog(
      ...
      (__int64)v2,
      20,
      (__int64)v2->FilterDriver->DefaultFilterCharacteristics.DetachHandler,
