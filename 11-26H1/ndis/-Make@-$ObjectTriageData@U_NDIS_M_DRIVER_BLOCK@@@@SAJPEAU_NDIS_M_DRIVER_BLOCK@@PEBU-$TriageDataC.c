/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_M_DRIVER_BLOCK@@@@SAJPEAU_NDIS_M_DRIVER_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_M_DRIVER_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x1400940A8
 * Callers:
...
__int64 __fastcall ObjectTriageData<_NDIS_M_DRIVER_BLOCK>::Make(
        __int64 a1,
        _DWORD *a2,
        TriageData *a3,
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  while ( v7 < 5 );
  v11 = ObjectTriageData<_NDIS_M_DRIVER_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, &v21);
  if ( v11 )
    goto LABEL_17;
  v12 = 16LL * v9;
...
LABEL_11:
      ...
      if ( Pool2 )
      {
        ...
        *(_QWORD *)(Pool2 + 80) = ObjectTriageData<_NDIS_M_DRIVER_BLOCK>::Callback;
