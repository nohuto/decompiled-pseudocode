/*
 * XREFs of ?EthCreateFilter@@YAEIPEBEPEAPEAU_X_FILTER@@@Z @ 0x140054100
 * Callers:
...
unsigned __int8 __fastcall EthCreateFilter(unsigned int a1, const unsigned __int8 *a2, struct _X_FILTER **a3)
{
  ...
  *a3 = 0LL;
  if ( !is_mul_ok(6u, a1) )
    return 0;
  Pool2 = ExAllocatePool2(64LL, 408LL, 1718633550LL);
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(v7 + 288) = RWLock;
    if ( RWLock )
    {
      ...
      if ( !v9 )
        return 1;
      v10 = ExAllocatePool2(66LL, (unsigned int)(6 * v9), 1634092110LL);
      *(_QWORD *)(v7 + 376) = v10;
      if ( v10 )
      {
        v11 = ExAllocatePool2(66LL, (unsigned int)(6 * *(_DWORD *)(v7 + 344)), 1634092110LL);
        *(_QWORD *)(v7 + 392) = v11;
        if ( !v11 )
        {
          v12 = *(void **)(v7 + 376);
LABEL_8:
        ...
        v14 = ExAllocatePool2(66LL, (unsigned int)(6 * *(_DWORD *)(v7 + 344)), 1634092110LL);
        *(_QWORD *)(v7 + 352) = v14;
        if ( !v14 )
        {
          v15 = *(void **)(v7 + 376);
LABEL_14:
        ...
        v16 = ExAllocatePool2(66LL, (unsigned int)(6 * *(_DWORD *)(v7 + 344)), 1634092110LL);
        *(_QWORD *)(v7 + 360) = v16;
        if ( !v16 )
        {
