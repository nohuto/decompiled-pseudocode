/*
 * XREFs of ndisEtwCaptureMiniportProtocolList @ 0x140098BD0
 * Callers:
 ...
 *     ?GetAllBindContexts@BindState@Ndis@@QEAAAEAV?$KArray@PEAX$00@Rtl@@XZ @ 0x140138E60 (-GetAllBindContexts@BindState@Ndis@@QEAAAEAV-$KArray@PEAX$00@Rtl@@XZ.c)
