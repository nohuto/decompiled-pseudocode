/*
 * XREFs of ?ndisRegisterPDCounterSets@@YAXXZ @ 0x1400A7440
 * Callers:
...
void ndisRegisterPDCounterSets(void)
{
  ...
  *(_QWORD *)&Info.CounterCount = 4LL;
  Info.Counters = (PPCW_COUNTER_DESCRIPTOR)&`ndisInitRegistrationInformationPDTxQueueCounterSet'::`2'::Descriptors;
  v1 = 0LL;
