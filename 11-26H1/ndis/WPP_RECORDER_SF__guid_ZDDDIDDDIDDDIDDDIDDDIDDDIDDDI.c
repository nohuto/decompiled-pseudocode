/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI @ 0x1400C7434
 * Callers:
...
LABEL_7:
  ...
  v38 = (const wchar_t *)*((_QWORD *)a7 + 1);
LABEL_8:
  v39 = a7;
  if ( !a7 )
    v39 = L"\b";
  ndisWppFastTraceMessage(
    &WPP_63e371e5a248373aa5c809d99c379eef_Traceguids,
    0x2Du,
    a6,
    16LL,
    v39,
...
LABEL_11:
  if ( !a7 )
    v35 = L"\b";
  LOWORD(v41) = 45;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_63e371e5a248373aa5c809d99c379eef_Traceguids, v41, a6, 16LL, v35);
}
