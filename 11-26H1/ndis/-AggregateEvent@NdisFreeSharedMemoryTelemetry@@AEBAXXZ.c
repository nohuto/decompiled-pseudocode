/*
 * XREFs of ?AggregateEvent@NdisFreeSharedMemoryTelemetry@@AEBAXXZ @ 0x1400CBC24
 * Callers:
...
void __fastcall NdisFreeSharedMemoryTelemetry::AggregateEvent(NdisFreeSharedMemoryTelemetry *this)
{
  ...
  v24 = *((_DWORD *)this + 10);
  v25 = *((_DWORD *)this + 11);
  if ( (unsigned int)dword_14011C6C0 > 4 && tlgKeywordOn((__int64)&dword_14011C6C0, 2048LL) )
  {
    v21 = *(_DWORD *)(v2 + 192);
    v19 = &v24;
    v22 = *(_DWORD *)(v2 + 32);
