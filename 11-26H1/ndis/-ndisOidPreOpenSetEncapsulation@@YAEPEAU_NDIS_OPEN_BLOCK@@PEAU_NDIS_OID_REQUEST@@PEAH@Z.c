/*
 * XREFs of ?ndisOidPreOpenSetEncapsulation@@YAEPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1400751C0
 * Callers:
 *     ?ndisOidPreSetOffloadEncapsulation@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x14008E5D0 (-ndisOidPreSetOffloadEncapsulation@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
...
unsigned __int8 __fastcall ndisOidPreOpenSetEncapsulation(
      ...
      if ( a1->Offload || (*a3 = ndisAllocateOpenOffload(a1), a1->Offload) )
      {
        ...
        else
        {
          ...
          *(_QWORD *)&v11->TopMergedEncapsulation.IPv6.Enabled = InformationBuffer[2];
          ...
          NDIS_ACQUIRE_MINIPORT_SPIN_LOCK(MiniportHandle, &v16);
