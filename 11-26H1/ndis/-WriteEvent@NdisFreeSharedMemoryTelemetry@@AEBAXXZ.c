/*
 * XREFs of ?WriteEvent@NdisFreeSharedMemoryTelemetry@@AEBAXXZ @ 0x1400CBEBC
 * Callers:
...
void __fastcall NdisFreeSharedMemoryTelemetry::WriteEvent(NdisFreeSharedMemoryTelemetry *this)
{
  ...
  if ( (unsigned int)dword_14011C6C0 > 4 && tlgKeywordOn((__int64)&dword_14011C6C0, 64LL) )
  {
    v18 = v10;
    v17 = v21;
    v12 = v11;
