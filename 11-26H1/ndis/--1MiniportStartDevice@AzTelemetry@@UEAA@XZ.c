/*
 * XREFs of ??1MiniportStartDevice@AzTelemetry@@UEAA@XZ @ 0x1400E6E80
 * Callers:
...
void __fastcall AzTelemetry::MiniportStartDevice::~MiniportStartDevice(LARGE_INTEGER *this)
{
  ...
  this->QuadPart = (LONGLONG)&AzTelemetry::MiniportStartDevice::`vftable';
