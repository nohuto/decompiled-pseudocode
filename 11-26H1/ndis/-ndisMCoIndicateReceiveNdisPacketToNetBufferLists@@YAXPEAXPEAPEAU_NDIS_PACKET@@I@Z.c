/*
 * XREFs of ?ndisMCoIndicateReceiveNdisPacketToNetBufferLists@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1400D87B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NDIS_ACQUIRE_MINIPORT_RECV_SPIN_LOCK@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAE@Z @ 0x140061AF0 (-NDIS_ACQUIRE_MINIPORT_RECV_SPIN_LOCK@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAE@Z.c)
...
void __fastcall ndisMCoIndicateReceiveNdisPacketToNetBufferLists(_QWORD *a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  *(_QWORD *)v30 = 0LL;
  ...
  do
  {
    ...
    *(_DWORD *)(v6 + 2012) += v10;
    *(_QWORD *)(v6 + 2016) = 0LL;
    KeReleaseSpinLock((PKSPIN_LOCK)(v6 + 2000), v12);
    ndisMCoIndicateReceiveNetBufferListsToNetBufferLists(v5, v8, v30[0], v30[1]);
    if ( (v30[1] & 2) != 0 )
    {
      do
      {
        v13 = (struct _NET_BUFFER_LIST *)v8->Link.Alignment;
        v14 = ndisXlateReturnNetBufferListToPacket(v8);
        if ( *(unsigned int *)((char *)&v14->Private.Count + v14->Private.NdisPacketOobOffset) != -1073741670 )
        {
          if ( (v14[-1].Reserved[1] & 1) != 0 && *(_DWORD *)&v14[-1].ProtocolReserved[4] == -1 )
            ...
            (*(void (__fastcall **)(_QWORD, struct _NDIS_PACKET *))(v6 + 2160))(*(_QWORD *)(v6 + 24), v14);
        }
        v8 = v13;
      }
      while ( v13 );
      NDIS_ACQUIRE_MINIPORT_RECV_SPIN_LOCK((struct _NDIS_MINIPORT_BLOCK *)v6, &NewIrql);
      v15 = *(_DWORD *)(v6 + 2012) - v10;
      v16 = *(_DWORD *)(v6 + 2008) == 5;
      *(_DWORD *)(v6 + 2012) = v15;
      if ( v16 && !v15 )
      {
        v18 = NewIrql;
