/*
 * XREFs of ?ndisXlateAddPacketPatternToWolPatternOid@@YAHPEAU_NDIS_OID_REQUEST@@PEAE@Z @ 0x1400B9680
 * Callers:
...
__int64 __fastcall ndisXlateAddPacketPatternToWolPatternOid(struct _NDIS_OID_REQUEST *a1, unsigned __int8 *a2)
{
  ...
  _DWORD *v21; // [rsp+78h] [rbp+10h] BYREF
    ...
    if ( v11 >= v8 )
    {
      ...
      if ( !(unsigned int)NdisConvertNtStatusToNdisStatus(v11 + v12 < v11 ? 0xC0000095 : 0) )
      {
        if ( a1->DATA.QUERY_INFORMATION.InformationBufferLength >= v13 )
        {
          ...
          {
            LODWORD(P) = 0;
            MakeExtendedPoolPtr<_NDIS_PM_WOL_PATTERN>(&v21, v14, v7, &P);
            v16 = v21;
            if ( v21 )
            {
              *v21 = 12845440;
              ...
              memmove((char *)v16 + v18, InformationBuffer + 6, (unsigned int)InformationBuffer[2]);
              memmove(
