/*
 * XREFs of ?Initialize@KnobNamespace@@QEAAXPEAU_DRIVER_OBJECT@@PEAU_CONFIG_KNOB_NAMESPACE@@@Z @ 0x140168AB0
 * Callers:
        ...
        struct _CONFIG_KNOB_NAMESPACE *a3)
{
  ...
  *(_DWORD *)&this->m_id.ObjectId.Data4[4] = v3;
  ...
  ExAcquirePushLockExclusiveEx(&stru_14011EA48, 0LL);
  v6 = (_LIST_ENTRY *)qword_14011EA58;
  p_m_globalLinkage = &this->m_globalLinkage;
  if ( *(__int64 **)qword_14011EA58 != &qword_14011EA50 )
    __fastfail(3u);
  p_m_globalLinkage->Flink = (_LIST_ENTRY *)&qword_14011EA50;
  this->m_globalLinkage.Blink = v6;
  v6->Flink = p_m_globalLinkage;
  qword_14011EA58 = (__int64)&this->m_globalLinkage;
  ExReleasePushLockExclusiveEx(&stru_14011EA48, 0LL);
