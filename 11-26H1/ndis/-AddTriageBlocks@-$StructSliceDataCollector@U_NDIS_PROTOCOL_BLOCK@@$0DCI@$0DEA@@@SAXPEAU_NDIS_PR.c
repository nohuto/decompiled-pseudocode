/*
 * XREFs of ?AddTriageBlocks@?$StructSliceDataCollector@U_NDIS_PROTOCOL_BLOCK@@$0DCI@$0DEA@@@SAXPEAU_NDIS_PROTOCOL_BLOCK@@PEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x1400BA9B0
 * Callers:
 *     <none>
 * Callees:
