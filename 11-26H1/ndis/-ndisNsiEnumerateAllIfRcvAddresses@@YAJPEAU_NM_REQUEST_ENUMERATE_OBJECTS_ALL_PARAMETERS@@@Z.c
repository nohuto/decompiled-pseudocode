/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddresses@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1400D2170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfRcvAddresses(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  v5 = v3;
  if ( v4 && (v6 = *((_DWORD *)a1 + 6), v6 != 8) && v6 != 40 || *((_QWORD *)a1 + 7) && *((_DWORD *)a1 + 16) < 6u )
  {
    v2 = -1073741306;
  }
  else if ( v4 )
