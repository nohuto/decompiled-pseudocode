/*
 * XREFs of ?ndisQueryReenumerateSelfInterface@@YAJPEAU_DEVICE_OBJECT@@PEAPEAU_DEVICE_RESET_INTERFACE_STANDARD@@@Z @ 0x14013A050
 * Callers:
...
__int64 __fastcall ndisQueryReenumerateSelfInterface(PDEVICE_OBJECT DeviceObject, PVOID *a2)
{
  ...
  Pool2 = (struct _DEVICE_RESET_INTERFACE_STANDARD *)ExAllocatePool2(64LL, 80LL, 1768047694LL);
  *a2 = Pool2;
  if ( !Pool2 )
    return 3221225626LL;
