/*
 * XREFs of NdisGetRoutineAddress @ 0x1400C97E0
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1400C9410 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1400C96E4 (FindExportedRoutineByName.c)
