/*
 * XREFs of ndisNsiEnumerateAllIfRcvAddressesInOneInterface @ 0x1400D22B8
 * Callers:
...
__int64 __fastcall ndisNsiEnumerateAllIfRcvAddressesInOneInterface(struct _NDIS_IF_BLOCK *a1, __int64 a2)
{
  ...
  bool v5; // zf
  unsigned int v6; // ebp
  unsigned int ifRcvAddressCount; // r8d
  __int64 v8; // r11
  __int64 v9; // r10
  unsigned int v10; // ecx
  _QWORD *v11; // rdi
  struct _NDIS_IF_RCV_ADDRESS *ifRcvAddressTable; // r9
