/*
 * XREFs of ?AddTriageDumpDataArray@TriageData@@IEAAXPEAU_KBUGCHECK_TRIAGE_DUMP_DATA@@@Z @ 0x1400E7B78
 * Callers:
 *     ?BugcheckReasonCallbackRoutine@TriageData@@KAXW4_KBUGCHECK_CALLBACK_REASON@@PEAU_KBUGCHECK_REASON_CALLBACK_RECORD@@PEAXK@Z @ 0x1400E7C20 (-BugcheckReasonCallbackRoutine@TriageData@@KAXW4_KBUGCHECK_CALLBACK_REASON@@PEAU_KBUGCHECK_REASO.c)
 * Callees:
