/*
 * XREFs of WPP_RECORDER_SF_DDLc @ 0x14006D680
 * Callers:
...
__int64 WPP_RECORDER_SF_DDLc(__int64 a1, _DWORD a2, _BYTE a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_64b491f4d22c35747c5821aad1f382d9_Traceguids,
      0x18u,
      va,
      4LL,
      va1,
