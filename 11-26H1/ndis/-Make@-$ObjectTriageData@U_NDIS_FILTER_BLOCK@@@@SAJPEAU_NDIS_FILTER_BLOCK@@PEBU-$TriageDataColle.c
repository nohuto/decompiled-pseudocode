/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_FILTER_BLOCK@@@@SAJPEAU_NDIS_FILTER_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_FILTER_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x14009A3B0
 * Callers:
...
__int64 __fastcall ObjectTriageData<_NDIS_FILTER_BLOCK>::Make(__int64 a1, _DWORD *a2, TriageData *a3, TriageData **a4)
{
  unsigned int v6; // r9d
  ...
  *a4 = 0LL;
  ...
  while ( v7 < 8 );
  v11 = ObjectTriageData<_NDIS_FILTER_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, &v21);
  if ( v11 )
    goto LABEL_17;
  v12 = 16LL * v9;
