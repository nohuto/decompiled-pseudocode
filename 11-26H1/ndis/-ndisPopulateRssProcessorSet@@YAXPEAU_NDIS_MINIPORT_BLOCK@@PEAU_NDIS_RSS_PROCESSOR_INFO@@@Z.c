/*
 * XREFs of ?ndisPopulateRssProcessorSet@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RSS_PROCESSOR_INFO@@@Z @ 0x1400A1CCC
 * Callers:
...
void __fastcall ndisPopulateRssProcessorSet(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_RSS_PROCESSOR_INFO *a2)
{
  ...
  __int64 v6; // rbx
  unsigned int i; // esi
  struct _PROCESSOR_NUMBER v8; // r10d
  __int64 v9; // r8
  __int64 v10; // r9
  _PROCESSOR_NUMBER v11; // r10d
  ...
  for ( i = 0; i < (unsigned int)ndisRssCpuCount; ++i )
  {
    if ( (!v4 || !*((_WORD *)ndisRssProcessors + 2 * i))
      ...
      && (!v4 || !v11.Group && *(_BYTE *)(v10 + 4 * v9 + 2) < 0x20u) )
    {
