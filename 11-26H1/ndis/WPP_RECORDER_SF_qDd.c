/*
 * XREFs of WPP_RECORDER_SF_qDd @ 0x14000EB10
 * Callers:
 ...
 *     ?ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x140063290 (-ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 ...
 *     ?ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1400CD070 (-ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 * Callees:
