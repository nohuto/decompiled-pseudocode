/*
 * XREFs of NdisMSetMiniportAttributes @ 0x140080DC0
 * Callers:
        ...
        PNDIS_MINIPORT_ADAPTER_ATTRIBUTES MiniportAttributes)
{
  ...
  UINT v46; // [rsp+30h] [rbp-58h]
  size_t v47; // [rsp+38h] [rbp-50h]
  ...
  switch ( Type )
  {
    ...
    case 160:
      ...
      if ( !(_DWORD)DefaultTcpConnectionOffloadConfiguration && dword_14011C6F8 )
    ...
    case 161:
      ...
      else
      {
        ...
        {
          *((_QWORD *)NdisMiniportHandle + 96) = v48;
        }
      }
      goto LABEL_53;
    case 164:
      ...
      *((_DWORD *)NdisMiniportHandle + 31) &= ~0x40000000u;
      if ( MiniportAddDeviceContext )
      {
          ...
          && *((_WORD *)MiniportAddDeviceContext + 1) >= 0x18u )
        {
          ...
          v27 = (char *)NdisMiniportHandle + 4264;
          *((_QWORD *)NdisMiniportHandle + 533) = v26;
          if ( v26 )
          {
            ...
            v25 = 0;
            if ( (!v33 || v34 != 1) && (MiniportAddDeviceContext[2] & 1) != 0 )
            {
            ...
            **(_BYTE **)v27 = 0x80;
            *(_BYTE *)(*(_QWORD *)v27 + 1LL) = 1;
            *(_WORD *)(*(_QWORD *)v27 + 2LL) = 28;
            *(_DWORD *)(*(_QWORD *)v27 + 4LL) = MiniportAddDeviceContext[1];
            *(_DWORD *)(*(_QWORD *)v27 + 8LL) = MiniportAddDeviceContext[2];
            *(_DWORD *)(*(_QWORD *)v27 + 12LL) = MiniportAddDeviceContext[3];
            *(_DWORD *)(*(_QWORD *)v27 + 16LL) = 0;
            *(_DWORD *)(*(_QWORD *)v27 + 20LL) = MiniportAddDeviceContext[4];
            *(_DWORD *)(*(_QWORD *)v27 + 24LL) = MiniportAddDeviceContext[5];
          }
          else
          {
            v25 = -1073741670;
...
LABEL_53:
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LODWORD(v47) = (_DWORD)DefaultTcpConnectionOffloadConfiguration;
        WPP_RECORDER_SF_qLL(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
          v22,
          1u,
