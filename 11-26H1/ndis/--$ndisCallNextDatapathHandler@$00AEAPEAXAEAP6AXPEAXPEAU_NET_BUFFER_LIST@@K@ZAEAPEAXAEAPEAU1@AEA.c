/*
 * XREFs of ??$ndisCallNextDatapathHandler@$00AEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@ZAEAPEAXAEAPEAU1@AEAKAEAKAEAK@@YAXAEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z0AEAPEAU0@AEAK55@Z @ 0x14004B7C0
 * Callers:
 *     ??$ndisDataPathExpandStackCallback@$00$$A6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z@@YAXPEAX@Z @ 0x14008EAE0 (--$ndisDataPathExpandStackCallback@$00$$A6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z@@YAXPEAX@Z.c)
 * Callees:
