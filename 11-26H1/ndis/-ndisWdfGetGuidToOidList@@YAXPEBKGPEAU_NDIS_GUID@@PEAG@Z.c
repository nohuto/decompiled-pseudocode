/*
 * XREFs of ?ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z @ 0x1400B3414
 * Callers:
 *     NdisWdfGetGuidToOidMap @ 0x140096800 (NdisWdfGetGuidToOidMap.c)
 * Callees:
 *     ndisWmiMapOids @ 0x140052880 (ndisWmiMapOids.c)
 */
