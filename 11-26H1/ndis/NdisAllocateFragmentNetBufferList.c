/*
 * XREFs of NdisAllocateFragmentNetBufferList @ 0x14002AEB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisAllocateMdlInternal@@YAPEAU_MDL@@PEAK@Z @ 0x14002B830 (-ndisAllocateMdlInternal@@YAPEAU_MDL@@PEAK@Z.c)
        ...
        ULONG AllocateFragmentFlags)
{
  ...
  __int128 v44; // xmm0
  __int64 v45; // rax
  int DataOffset; // [rsp+20h] [rbp-60h]
  ...
  *(_QWORD *)(v8 + 48) = OriginalNetBufferList;
  *(_QWORD *)(v8 + 32) = 0LL;
  if ( !MaximumLength )
    return 0LL;
...
LABEL_47:
        ...
        *(_DWORD *)v8 = v18;
        if ( v17->MdlChain )
        {
          **(_QWORD **)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = v29;
        }
        else
        {
...
LABEL_35:
            ...
            v14 = (const struct _EVENT_DESCRIPTOR *)*(unsigned int *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL)
                                                                    + 4);
            v18 = 0;
            v17->Link.Alignment = (unsigned __int64)v31;
            *(_DWORD *)v8 = 0;
            v17 = v31;
          }
        }
...
LABEL_48:
    ...
    *(_DWORD *)v8 = 0;
    if ( v35 < DataOffsetDelta )
    {
      *(_DWORD *)v8 = DataBackFill + DataOffsetDelta - v35;
      MdlInternal = ndisAllocateMdlInternal((PULONG)((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL));
      if ( !MdlInternal )
      {
        for ( k = v33->FirstNetBuffer; k != j; k = (struct _NET_BUFFER *)k->Link.Alignment )
          NdisAdvanceNetBufferDataStart(k, DataOffsetDelta, 1u, ndisFreeMdlInternal);
        v21 = v33;
        goto LABEL_17;
      }
      ...
      j->DataOffset += v39 - DataOffsetDelta;
      v36 = j->DataOffset;
  ...
  v38 = *(_QWORD **)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x30);
  v33->NetBufferListInfo[16] = (void *)v38[34];
  if ( (v38[28] & 0xFFFFFFFFFFFFFFFCuLL) != 0 && (v38[28] & 1) == 0 )
  {
    LOBYTE(DataOffset) = 1;
    WfpNblInfoClone(v38, v33, 0LL, 0LL, DataOffset);
  }
  if ( byte_14011F740 )
  {
  ...
  else if ( Microsoft_Windows_Networking_CorrelationEnabled )
  {
    ...
    *(_QWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = 0LL;
    *(_QWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = v43;
    v44 = *(_OWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x30);
    v45 = (__int64)v33->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
    *(_QWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = 0LL;
    *(_QWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = v45;
    LODWORD(v45) = Microsoft_Windows_Networking_CorrelationEnabled;
    *(_OWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = v44;
    *(_OWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = *(_OWORD *)(((unsigned __int64)&BufferSize & 0xFFFFFFFFFFFFFFC0uLL)
                                                                                            + 0x30);
    if ( (_DWORD)v45 )
      EtwEx_tidActivityInfoTransfer(
        0x7FFFFFFFFFFFFFFFuLL,
        v14,
        (const struct _GUID *)(v8 + 64),
        (const struct _GUID *)(v8 + 48),
        DataOffset,
        DataLength,
        2u);
  }
