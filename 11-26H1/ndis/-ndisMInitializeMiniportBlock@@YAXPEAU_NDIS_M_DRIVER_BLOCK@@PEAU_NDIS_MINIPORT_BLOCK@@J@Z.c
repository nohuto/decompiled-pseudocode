/*
 * XREFs of ?ndisMInitializeMiniportBlock@@YAXPEAU_NDIS_M_DRIVER_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x14007FA50
 * Callers:
 ...
 *     ??0BindEngine@Ndis@@QEAA@XZ @ 0x14016B2D0 (--0BindEngine@Ndis@@QEAA@XZ.c)
