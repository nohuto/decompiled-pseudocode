/*
 * XREFs of ?ndisNsiEnumerateAllNetworks@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1400D33E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllNetworks(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  v3 = qword_14011E9E8;
  v4 = v2;
  for ( i = 0; (__int64 *)v3 != &qword_14011E9E8; i = v9 )
  {
  ...
  *((_DWORD *)a1 + 22) = i;
  if ( v10 )
  {
    ...
    do
    {
      if ( (__int64 *)v15 == &qword_14011E9E8 )
        break;
