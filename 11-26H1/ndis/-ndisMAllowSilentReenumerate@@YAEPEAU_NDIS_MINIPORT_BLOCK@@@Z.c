/*
 * XREFs of ?ndisMAllowSilentReenumerate@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1401417B0
 * Callers:
...
bool __fastcall ndisMAllowSilentReenumerate(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( IoOpenDeviceRegistryKey(PhysicalDeviceObject, 2u, 0xC2000000, &v6) >= 0 )
  {
    wil::details::unique_storage<wil::details::resource_policy<void *,long (*)(void *),&long ZwClose(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::reset(
      &v5.m_ptr,
      v6);
    if ( (int)KRegKey::QueryValueUlong(&v5, &stru_1400F6D80, &v4) >= 0 )
    {
      if ( v4 )
        v2 = KRegKey::SetValueUlong(&v5, (struct _UNICODE_STRING *)&stru_1400F6D80, v4 - 1) >= 0;
    }
  }
