/*
 * XREFs of ?ndisMCoSendCompleteToNetBufferLists@@YAXHPEAXPEAU_NDIS_PACKET@@@Z @ 0x1400D8E40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMCoSendCompleteToNetBufferLists(int a1, _QWORD *a2, struct _NDIS_PACKET *a3)
{
  ...
  if ( (v6->Flags & 0x40) != 0 && *(unsigned __int64 *)((char *)a3->Reserved + a3->Private.NdisPacketOobOffset) )
    ndisMFreeSGList(*(struct _NDIS_MINIPORT_BLOCK **)(v3 + 120), a3, (__int64)a3);
  if ( !a1 )
  ...
  *((_DWORD *)v9 + 2) = 0;
  ...
  if ( v8 )
    (*(void (__fastcall **)(_QWORD, struct _NET_BUFFER_LIST *, _QWORD))(v3 + 64))(*(_QWORD *)(v3 + 24), v8, 0LL);
}
