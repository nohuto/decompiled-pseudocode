/*
 * XREFs of ?NdisSetJobObjectCompartmentId@@YAJPEAU_EJOB@@I@Z @ 0x140146684
 * Callers:
 *     ?ndisNsiSetAllJobInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1400CDAC0 (-ndisNsiSetAllJobInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z.c)
 * Callees:
 *     ?ndisCmCreateStateObject@@YAJPEAPEAU_NDIS_CM_STATE@@@Z @ 0x14003EFD0 (-ndisCmCreateStateObject@@YAJPEAPEAU_NDIS_CM_STATE@@@Z.c)
 ...
 *     ndisIfSetCompartmentJobObject @ 0x1400CD964 (ndisIfSetCompartmentJobObject.c)
...
__int64 __fastcall NdisSetJobObjectCompartmentId(struct _EJOB *a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    ...
    v3 = ndisCmValidateCompartmentChange(JobObjectCompartmentId, a2, v7, v8);
    if ( !v3 )
    {
  ...
  if ( JobProperty )
  {
    v10 = JobProperty[1];
    if ( v10 )
      StateObject = ndisIfSetCompartmentJobObject(v10, a1, 1);
  }
  if ( v3 )
  {
