/*
 * XREFs of ndisGetLogicalProcessorInformation @ 0x14018F2F4
 * Callers:
...
__int64 __fastcall ndisGetLogicalProcessorInformation(__int64 a1)
{
  ...
  __int64 Pool2; // [rsp+30h] [rbp-38h]
  ULONG v53; // [rsp+38h] [rbp-30h]
  NTSTATUS v54; // [rsp+3Ch] [rbp-2Ch]
  _DWORD *v55; // [rsp+40h] [rbp-28h]
  _SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX *v56; // [rsp+48h] [rbp-20h]
  ...
  if ( Pool2 )
  {
    ...
    if ( v7
      && (memset(v7, 255, 4LL * ndisMaxNumberOfProcessors),
          ...
          (v10 = v9) != 0LL) )
    {
      v54 = KeQueryLogicalProcessorRelationship(0LL, RelationAll, v9, &Length);
      v6 = v54;
      if ( v54 >= 0 )
      {
        v11 = 0;
