/*
 * XREFs of ?ndisIfGetRcvAddressFromMiniport@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x14001E020
 * Callers:
...
__int64 __fastcall ndisIfGetRcvAddressFromMiniport(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  __int64 Pool2; // rax
  unsigned int *p_ifRcvAddressCount; // r9
  unsigned int *v6; // rdx
...
LABEL_7:
    ...
    *v6 = MiniportNumAddresses + 1;
    if ( MiniportNumAddresses )
    {
      ...
      while ( (unsigned int)v8 < *p_ifRcvAddressCount - 1 );
    }
    v13 = 5 * v8;
