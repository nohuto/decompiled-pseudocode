/*
 * XREFs of ?ndisNotifyWmiAdapterArrival@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x140057FF0
 * Callers:
 *     NdisWdfNotifyWmiAdapterArrival @ 0x140096A10 (NdisWdfNotifyWmiAdapterArrival.c)
