/*
 * XREFs of ??1NdisFreeSharedMemoryTelemetry@@QEAA@XZ @ 0x140065800
 * Callers:
...
void __fastcall NdisFreeSharedMemoryTelemetry::~NdisFreeSharedMemoryTelemetry(NdisFreeSharedMemoryTelemetry *this)
{
  ...
  {
    _InterlockedIncrement64(&qword_14011EF48);
    _InterlockedAdd64(&qword_14011EF50, *((unsigned int *)this + 8));
  }
  if ( *(_BYTE *)this )
  {
    v2 = *((_BYTE *)this + 80) == 0;
