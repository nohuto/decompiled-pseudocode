/*
 * XREFs of ?NdisPDRemoveProviderFromBMGroup@@YAXPEAUNDIS_PD_PROVIDER_HANDLE__@@@Z @ 0x14013EEE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      (char)a1);
  KLockThisExclusive::KLockThisExclusive(&v6, qword_14011EE98);
  v3 = i + 4;
  v4 = *((_QWORD *)i + 2);
  if ( !v4 )
    ndisBugCheckEx(0x23uLL, 6uLL, 0LL, (ULONG_PTR)a1);
  v5 = (_QWORD *)*((_QWORD *)i + 3);
  if ( (_QWORD *)v4 == v5 && *(_QWORD *)(v4 - 24 + 40) != v4 - 24 + 40 )
