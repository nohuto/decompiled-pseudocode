/*
 * XREFs of ?ndisValidatePDCapsBuffer@@YAEKPEBU_NDIS_PD_CAPABILITIES@@@Z @ 0x1400A78C0
 * Callers:
 *     ?ndisValidatePDConfigBuffer@@YAEKPEBU_NDIS_PD_CONFIG@@@Z @ 0x1400A7A9C (-ndisValidatePDConfigBuffer@@YAEKPEBU_NDIS_PD_CONFIG@@@Z.c)
 * Callees:
 *     ?ndisValidateGFPExactMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_EXACT_MATCH_PROFILE@@@Z @ 0x1400A76A0 (-ndisValidateGFPExactMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_EXACT_MATCH_PROFILE@@@Z.c)
 *     ?ndisValidateGFPWildcardMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_WILDCARD_MATCH_PROFILE@@@Z @ 0x1400A779C (-ndisValidateGFPWildcardMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_WILDCARD_MATCH_PROFILE@@@Z.c)
...
unsigned __int8 __fastcall ndisValidatePDCapsBuffer(unsigned int a1, const struct _NDIS_PD_CAPABILITIES *a2)
{
  ...
  unsigned int ExactMatchProfileArrayOffset; // r12d
  unsigned int ExactMatchProfileArrayElementSize; // r15d
  const struct _NDIS_OBJECT_HEADER *v12; // rdx
  unsigned int WildcardMatchProfileArrayNumElements; // r13d
  unsigned int i; // esi
  unsigned int j; // esi
