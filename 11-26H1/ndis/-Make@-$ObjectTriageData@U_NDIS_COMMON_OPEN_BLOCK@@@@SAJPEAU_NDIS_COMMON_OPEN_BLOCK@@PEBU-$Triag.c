/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_COMMON_OPEN_BLOCK@@@@SAJPEAU_NDIS_COMMON_OPEN_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_COMMON_OPEN_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x1400BAD44
 * Callers:
...
__int64 __fastcall ObjectTriageData<_NDIS_COMMON_OPEN_BLOCK>::Make(
        __int64 a1,
        _DWORD *a2,
        TriageData *a3,
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  while ( v7 < 7 );
  v11 = ObjectTriageData<_NDIS_COMMON_OPEN_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, &v21);
  if ( v11 )
    goto LABEL_17;
  v12 = 16LL * v9;
...
LABEL_11:
      ...
      if ( Pool2 )
      {
        ...
        *(_QWORD *)(Pool2 + 80) = ObjectTriageData<_NDIS_COMMON_OPEN_BLOCK>::Callback;
        ...
        if ( !v16 )
        {
          ...
          *a4 = v18;
          ...
          wistd::unique_ptr<_KTRIAGE_DUMP_DATA_ARRAY,KFreePoolNP<_KTRIAGE_DUMP_DATA_ARRAY>>::reset(
            ...
            0LL);
          wil::unique_any_array_ptr<TriageDataCollector<_NDIS_M_DRIVER_BLOCK>,ObjectTriageData<_NDIS_M_DRIVER_BLOCK>::TriageDataCollectorArrayDeleter,wil::empty_deleter,unsigned __int64>::reset((__int64)&v21);
          return 0LL;
        }
        goto LABEL_11;
      }
