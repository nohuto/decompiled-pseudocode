/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockWrite@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1400C5CA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockWrite @ 0x1400C5F60 (NdisTryAcquireRWLockWrite.c)
 */
