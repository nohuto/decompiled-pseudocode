/*
 * XREFs of ?ndisNsiSetAllJobInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1400CDAC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall ndisNsiSetAllJobInformation(struct _NM_REQUEST_SET_ALL_PARAMETERS *a1)
{
  ...
  if ( !*((_DWORD *)a1 + 12) )
  {
    ...
    if ( v3 )
    {
      v4 = (HANDLE *)*((_QWORD *)a1 + 2);
      Object = 0LL;
      result = ObReferenceObjectByHandle(*v4, 4u, (POBJECT_TYPE)PsJobType, 1, &Object, 0LL);
      v5 = Object;
      if ( result < 0 )
        return result;
