/*
 * XREFs of ?ndisSendSystemPowerStateIndication@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_SYSTEM_POWER_STATE@@@Z @ 0x1400AB8DC
 * Callers:
...
void __fastcall ndisSendSystemPowerStateIndication(struct _NDIS_MINIPORT_BLOCK *a1, enum _SYSTEM_POWER_STATE a2)
{
  ...
  ndisIndicateStatusInternal(a1, (_LIST_ENTRY *)&v5);
