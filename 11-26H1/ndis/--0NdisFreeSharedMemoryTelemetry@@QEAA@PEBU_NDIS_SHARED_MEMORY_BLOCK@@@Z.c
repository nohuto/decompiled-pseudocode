/*
 * XREFs of ??0NdisFreeSharedMemoryTelemetry@@QEAA@PEBU_NDIS_SHARED_MEMORY_BLOCK@@@Z @ 0x1400656C0
 * Callers:
        ...
        __int64 a4)
{
  ...
  v6 = (a2->Flags & 0x10) != 0
    && (unsigned int)dword_14011C6C0 > 4
    && (unsigned __int8)tlgKeywordOn(&dword_14011C6C0, 2112LL, a3, a4);
  *(_BYTE *)this = v6;
  Flags = a2->Flags;
