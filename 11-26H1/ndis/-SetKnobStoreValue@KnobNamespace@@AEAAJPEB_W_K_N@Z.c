/*
 * XREFs of ?SetKnobStoreValue@KnobNamespace@@AEAAJPEB_W_K_N@Z @ 0x14014F978
 * Callers:
...
__int64 __fastcall KnobNamespace::SetKnobStoreValue(KnobNamespace *this, const wchar_t *a2, __int64 a3, char a4)
{
  ...
  {
    v9 = v14;
    v10 = (*(__int64 (__fastcall **)(struct KnobCollection *, struct KnobDescriptor *, __int64))(*(_QWORD *)v14 + 16LL))(
            v14,
            v17,
            a3);
    v12 = v15;
