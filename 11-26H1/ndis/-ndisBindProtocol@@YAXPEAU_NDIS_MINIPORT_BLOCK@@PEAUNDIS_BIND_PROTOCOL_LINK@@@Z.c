/*
 * XREFs of ?ndisBindProtocol@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@@Z @ 0x140157420
 * Callers:
 *     ?Iterate@BindEngine@Ndis@@AEAA_NAEBU_GUID@@@Z @ 0x140158AF0 (-Iterate@BindEngine@Ndis@@AEAA_NAEBU_GUID@@@Z.c)
 * Callees:
 *     ?resize@?$KArray@PEAX$00@Rtl@@QEAA_N_K@Z @ 0x14005ADA0 (-resize@-$KArray@PEAX$00@Rtl@@QEAA_N_K@Z.c)
...
void __fastcall ndisBindProtocol(struct _NDIS_MINIPORT_BLOCK *a1, Ndis::BindState *this)
{
  ...
  else
  {
    *((_BYTE *)m_AdditionalContext + 1) = 1;
    ...
    if ( v7 )
    {
      ...
      if ( Ndis::BindState::SetSource(this, RemoveBindSource, UnsolicitedOpen) && (unsigned __int8)byte_14011EAD3 >= 4u )
      {
        v14 = this->Miniport;
  ...
  if ( v12 )
  {
    LOBYTE(v13) = m_pauseReasons != 0;
    LOBYTE(v9) = v11 != 0;
    if ( v13 != v9 || !this->Miniport )
    {
      ...
      v12 = (unsigned __int8)byte_14011EAD3 < 4u;
