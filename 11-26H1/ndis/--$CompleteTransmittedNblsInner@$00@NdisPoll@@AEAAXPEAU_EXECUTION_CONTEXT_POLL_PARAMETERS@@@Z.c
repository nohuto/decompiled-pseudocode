/*
 * XREFs of ??$CompleteTransmittedNblsInner@$00@NdisPoll@@AEAAXPEAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z @ 0x140003510
 * Callers:
 *     ?EvtCompleteTransmittedNblsThunkWithVerifier@NdisPoll@@CAXPEAXPEAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z @ 0x140003670 (-EvtCompleteTransmittedNblsThunkWithVerifier@NdisPoll@@CAXPEAXPEAU_EXECUTION_CONTEXT_POLL_PARAME.c)
 * Callees:
