/*
 * XREFs of ?ethAllocateOpenMulticastBuffer@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@@Z @ 0x14006A6B0
 * Callers:
...
__int64 __fastcall ethAllocateOpenMulticastBuffer(struct _X_FILTER *a1, struct _NDIS_OPEN_BLOCK *a2)
{
  ...
  a2->NumAddresses = 0;
  Pool2 = (_ETH_MULTICAST_WRAPPER *)ExAllocatePool2(66LL, 12 * MaxMulticastAddresses, 1634092110LL);
  a2->MCastAddressBuf = Pool2;
  if ( Pool2 )
  {
    v5 = (_ETH_MULTICAST_WRAPPER *)ExAllocatePool2(66LL, 12LL * a2->MaxMulticastAddresses, 1634092110LL);
