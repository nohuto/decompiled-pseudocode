/*
 * XREFs of ?ndisCollectSingleStatisticForIoctl@@YAJPEBUNDIS_COLLECT_SINGLE_STATISTIC_IN@@PEAUNDIS_COLLECT_SINGLE_STATISTIC_OUT@@AEA_K@Z @ 0x140141EE8
 * Callers:
 *     ?ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z @ 0x1401832D0 (-ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z.c)
 * Callees:
 *     memset @ 0x1400EA4C0 (memset.c)
 *     ?ndisGetGlobalStatisticName@@YAPEB_WW4NDIS_GLOBAL_STATISTIC@@@Z @ 0x140141FA0 (-ndisGetGlobalStatisticName@@YAPEB_WW4NDIS_GLOBAL_STATISTIC@@@Z.c)
 */
