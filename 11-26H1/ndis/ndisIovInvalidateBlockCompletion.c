/*
 * XREFs of ndisIovInvalidateBlockCompletion @ 0x140148DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisIovInvalidateBlockCompletion(__int64 a1, _IRP *a2, struct _NDIS_MINIPORT_BLOCK *a3)
{
  ...
  struct _NDIS_OID_REQUEST v10; // [rsp+30h] [rbp-D0h] BYREF
  _QWORD v11[2]; // [rsp+130h] [rbp+30h] BYREF

  v3 = a2->IoStatus.Status < 0;
  v11[0] = 0LL;
  if ( v3 || a3->InvalidateBlockCancelling )
  {
  ...
  else
  {
    ...
    v11[1] = a3->InvalidateBlockVfParams.BlockMask;
    ...
    *(_QWORD *)&v10.RequestType = 12LL;
    v10.DATA.QUERY_INFORMATION.InformationBufferLength = 16;
    v10.DATA.QUERY_INFORMATION.Oid = 66153;
    *(_QWORD *)&v10.DATA.METHOD_INFORMATION.OutputBufferLength = 16LL;
    ndisQuerySetMiniport(a3, 0LL, &v10, 0, 0LL);
    ...
    v8[-1].CompletionRoutine = (int (__fastcall *)(_DEVICE_OBJECT *, _IRP *, void *))&ndisIovInvalidateBlockCompletion;
    v8[-1].Context = a3;
    v8[-1].Control = -32;
