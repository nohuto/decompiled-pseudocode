/*
 * XREFs of ?Make@?$ObjectTriageData@U_NDIS_FILTER_DRIVER_BLOCK@@@@SAJPEAU_NDIS_FILTER_DRIVER_BLOCK@@PEBU?$TriageDataCollector@U_NDIS_FILTER_DRIVER_BLOCK@@@@_KPEAPEAVTriageData@@@Z @ 0x14009C1D4
 * Callers:
        ...
        TriageData **a4)
{
  ...
  *a4 = 0LL;
  ...
  while ( v7 < 3 );
  v11 = ObjectTriageData<_NDIS_FILTER_DRIVER_BLOCK>::DuplicateCollectorsArray(a2, (size_t)a2, &v21);
  if ( v11 )
    goto LABEL_17;
  v12 = 16LL * v9;
