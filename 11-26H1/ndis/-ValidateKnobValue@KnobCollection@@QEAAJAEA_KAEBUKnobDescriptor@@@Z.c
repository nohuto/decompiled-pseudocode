/*
 * XREFs of ?ValidateKnobValue@KnobCollection@@QEAAJAEA_KAEBUKnobDescriptor@@@Z @ 0x140163A60
 * Callers:
        ...
        const struct KnobDescriptor *a3)
{
  ...
  if ( *(_OWORD *)&a3->MinimumValue != 0LL )
  {
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_Siii(*((_QWORD *)WPP_GLOBAL_Control + 8), v10, MinimumValue, (__int64)this, v14, a3->Name);
      return 3221227787LL;
    }
  }
