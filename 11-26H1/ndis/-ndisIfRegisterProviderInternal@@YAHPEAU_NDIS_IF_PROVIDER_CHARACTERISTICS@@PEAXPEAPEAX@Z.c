/*
 * XREFs of ?ndisIfRegisterProviderInternal@@YAHPEAU_NDIS_IF_PROVIDER_CHARACTERISTICS@@PEAXPEAPEAX@Z @ 0x1400760C0
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v7 >= 0x58u && (Pool2 = (_WORD *)ExAllocatePool2(64LL, v7, 1718174798LL), (v9 = Pool2) != 0LL) )
  {
    ...
    *v12 = v12;
    ...
    v13 = KeAcquireSpinLockRaiseToDpc(&qword_14011E9C0);
    v14 = qword_14011E9B0;
    v15 = v9 + 1;
    if ( *(__int64 **)(qword_14011E9B0 + 8) != &qword_14011E9B0 )
      __fastfail(3u);
    *v15 = qword_14011E9B0;
    v9[2] = &qword_14011E9B0;
    *(_QWORD *)(v14 + 8) = v15;
    qword_14011E9B0 = (__int64)(v9 + 1);
    KeReleaseSpinLock(&qword_14011E9C0, v13);
    *a3 = v9;
  }
  else
  {
