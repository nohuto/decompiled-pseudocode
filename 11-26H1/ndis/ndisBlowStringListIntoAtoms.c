/*
 * XREFs of ndisBlowStringListIntoAtoms @ 0x14014DEEC
 * Callers:
...
__int64 __fastcall ndisBlowStringListIntoAtoms(NetSetupPropertyBag *a1, const struct _NETSETUPPROPKEY *a2, __int64 a3)
{
  ...
  {
    v8 = HIDWORD(v17);
    if ( Rtl::KArray<Rtl::_KStringAtom *,1>::reserve((unsigned int *)a3, HIDWORD(v17)) )
    {
      ...
      *(_DWORD *)(a3 + 4) = v8;
      for ( i = 0LL; ; ++i )
      {
        ...
        Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_14011F6E0, *(_WORD **)(*((_QWORD *)P + i) + 8LL));
