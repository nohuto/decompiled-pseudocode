/*
 * XREFs of NdisMRegisterWdiMiniportDriver @ 0x1401459A0
 * Callers:
 *     <none>
 * Callees:
 *     ?TryAcquire@KRundownBase@@QEAA_NXZ @ 0x1400034EC (-TryAcquire@KRundownBase@@QEAA_NXZ.c)
 ...
 *     ??1KRundownHolder@@QEAA@XZ @ 0x1401455BC (--1KRundownHolder@@QEAA@XZ.c)
...
LABEL_6:
  ...
  if ( !v13 )
  {
    ...
    if ( *v6 )
    {
      ...
      *((_BYTE *)v14 + 900) = 1;
      NdisMiniportDriverHandle = 0LL;
      wistd::unique_ptr<_UNICODE_STRING,KFreePool<_UNICODE_STRING>>::reset((void **)v14 + 44, v12);
  ...
  v7 = v13;
LABEL_15:
  wistd::unique_ptr<_UNICODE_STRING,KFreePool<_UNICODE_STRING>>::reset((void **)&NdisMiniportDriverHandle, 0LL);
  return v7;
}
