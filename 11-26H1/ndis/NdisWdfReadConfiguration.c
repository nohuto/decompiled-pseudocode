/*
 * XREFs of NdisWdfReadConfiguration @ 0x14001FCC0
 * Callers:
 *     <none>
 * Callees:
 *     NdisReadConfiguration @ 0x140020C40 (NdisReadConfiguration.c)
 *     ndisIsWdfMiniportConfigurationKeywordDeprecated @ 0x140021280 (ndisIsWdfMiniportConfigurationKeywordDeprecated.c)
