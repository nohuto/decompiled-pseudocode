/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1400E7EE4
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
  ...
  if ( Pool2 )
  {
    ...
    qword_14011F808 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140136040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&unk_140136008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140136078);
