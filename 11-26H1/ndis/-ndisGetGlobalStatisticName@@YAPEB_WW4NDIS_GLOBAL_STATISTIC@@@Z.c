/*
 * XREFs of ?ndisGetGlobalStatisticName@@YAPEB_WW4NDIS_GLOBAL_STATISTIC@@@Z @ 0x140141FA0
 * Callers:
...
__int64 __fastcall ndisGetGlobalStatisticName(unsigned int a1)
{
  _QWORD v2[24]; // [rsp+0h] [rbp-69h]
