/*
 * XREFs of ?ndisMFinishClose@@_Y2PAGENPNP@@AXPEAU_NDIS_OPEN_BLOCK@@@Z @ 0x14017F330
 * Callers:
 ...
 *     ?ndisMCoFreeResources@@YAXPEAU_NDIS_OPEN_BLOCK@@@Z @ 0x1400677B0 (-ndisMCoFreeResources@@YAXPEAU_NDIS_OPEN_BLOCK@@@Z.c)
