/*
 * XREFs of _lambda_4865fb945cd28a177f845da523c8204e_::operator() @ 0x140169950
 * Callers:
...
__int64 __fastcall lambda_4865fb945cd28a177f845da523c8204e_::operator()(__int64 a1, _DWORD *a2, unsigned int a3)
{
  char *v4; // r10
  __int64 i; // r8
  __int64 v6; // r11
  ...
  if ( v13[v12 + 15] || v13[v12 + 14] )
    return 3221225534LL;
  **(_DWORD **)a1 = *(_DWORD *)((char *)a2 + (unsigned int)a2[3] + 4);
  memmove((void *)(*(_QWORD *)a1 + 4LL), v13 + 16, v12);
  return 0LL;
}
