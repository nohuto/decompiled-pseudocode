/*
 * XREFs of ?ndisPDPcwUtilizationCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x14006CBD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  Data.Data = (const void *)(i + 56);
  Data.Size = 64;
  v18 = PcwAddInstance(v17, (PCUNICODE_STRING)(i + 40), v16, 1u, &Data);
