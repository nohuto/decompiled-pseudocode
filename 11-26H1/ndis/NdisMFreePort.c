/*
 * XREFs of NdisMFreePort @ 0x1400AADB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisFindPortByPortNumber@@YAPEAU_NDIS_PORT_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@K@Z @ 0x140072390 (-ndisFindPortByPortNumber@@YAPEAU_NDIS_PORT_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@K@Z.c)
 */
...
NDIS_STATUS __stdcall NdisMFreePort(NDIS_HANDLE NdisMiniportHandle, NDIS_PORT_NUMBER PortNumber)
{
  ...
  if ( PortByPortNumber )
  {
    if ( PortByPortNumber->PortPnPState == NdisPortPnPStateAllocated )
    {
      ...
      if ( v8
        ...
        && (v10 = *(unsigned __int8 *)(v9 + v8), v11 = (unsigned int)v9, v12 = PortNumber & 7, _bittest(&v10, v12)) )
      {
        *(_BYTE *)(v11 + v8) = v10 & ~(1 << v12);
        Flink = v7->Link.Flink;
  ...
  *((_QWORD *)NdisMiniportHandle + 65) = 0LL;
  KeReleaseSpinLock((PKSPIN_LOCK)NdisMiniportHandle + 12, v15);
  if ( !v2 )
