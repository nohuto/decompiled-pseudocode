/*
 * XREFs of ?ndisCreateNdisSupportedOidList@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1400723C0
 * Callers:
  ...
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(Pool2 + 176) = *((_DWORD *)&ndisHandledNdis5Ndis6GenOids + 44);
    if ( a1->MajorNdisVersion >= 6u )
    {
      ...
      *(_OWORD *)(ndisSupportedOidList + 49) = xmmword_14018CAF0;
      *(_OWORD *)(ndisSupportedOidList + 53) = xmmword_14018CB00;
      *(_OWORD *)(ndisSupportedOidList + 57) = xmmword_14018CB10;
      *(_OWORD *)(ndisSupportedOidList + 61) = xmmword_14018CB20;
      *(_OWORD *)(ndisSupportedOidList + 65) = xmmword_14018CB30;
      *(_OWORD *)(ndisSupportedOidList + 69) = xmmword_14018CB40;
      *(_OWORD *)(ndisSupportedOidList + 73) = xmmword_14018CB50;
      *(_OWORD *)(ndisSupportedOidList + 77) = xmmword_14018CB60;
      *(_QWORD *)(ndisSupportedOidList + 81) = qword_14018CB70;
    }
    if ( a1->MediaType == NdisMedium802_3 )
    {
