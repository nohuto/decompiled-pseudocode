/*
 * XREFs of ?PurgeEventsForCurrentState@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEAAXXZ @ 0x1400E9B48
 * Callers:
        ...
        SmFx::StateMachineEngine::StateMachineEngineImpl *this)
{
  ...
  if ( (*(_BYTE *)(16LL * CurrentStateIndex + *(_QWORD *)(v4 + 24) + 4) & 0x20) != 0 )
  {
    SlotIndexForSlotType = SmFx::StateMachineEngine::StateMachineEngineImpl::GetSlotIndexForSlotType(
                             v3,
                             (const struct SmFx::STATE_SPECIFICATION *)(16LL * CurrentStateIndex + *(_QWORD *)(v4 + 24)),
                             32);
