/*
 * XREFs of ?ndisIfSetIfDescr@@YAHPEAU_NDIS_IF_DESCR_INFORMATION@@@Z @ 0x1400D1D10
 * Callers:
  ...
  *(_QWORD *)&String2.Length = 0LL;
  ...
  if ( a1 )
  {
    ...
    if ( InterfaceByNetLuid )
    {
      ...
      if ( p_ifDescr->Length )
      {
        RtlInitUnicodeString(&DestinationString, (PCWSTR)p_ifDescr->String);
      ...
      if ( v3 )
      {
        ...
        p_ifDescr->Length = v9;
        if ( a1[4] )
          memmove(p_ifDescr->String, a1 + 5, v9);
      }
    }
    else
    {
