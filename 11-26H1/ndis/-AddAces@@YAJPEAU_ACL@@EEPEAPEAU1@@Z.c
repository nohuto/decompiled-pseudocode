/*
 * XREFs of ?AddAces@@YAJPEAU_ACL@@EEPEAPEAU1@@Z @ 0x14018FC60
 * Callers:
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x14018FEC4 (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 * Callees:
