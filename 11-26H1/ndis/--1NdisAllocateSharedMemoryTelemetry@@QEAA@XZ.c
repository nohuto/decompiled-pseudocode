/*
 * XREFs of ??1NdisAllocateSharedMemoryTelemetry@@QEAA@XZ @ 0x14008F1E0
 * Callers:
 ...
 *     ?GetElapsedTimeInMicroseconds@KStopwatch@@QEBA_KXZ @ 0x1400CBDC4 (-GetElapsedTimeInMicroseconds@KStopwatch@@QEBA_KXZ.c)
...
void __fastcall NdisAllocateSharedMemoryTelemetry::~NdisAllocateSharedMemoryTelemetry(LARGE_INTEGER *this)
{
  ...
  if ( this[25].LowPart )
  {
    _InterlockedIncrement64(&qword_14011EF30);
    LowPart = this[4].LowPart;
    if ( this[25].LowPart == 1 )
      _InterlockedAdd64(&qword_14011EF38, LowPart);
    else
      _InterlockedAdd64(&qword_14011EF40, LowPart);
  }
