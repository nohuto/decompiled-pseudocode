/*
 * XREFs of ?NdisReadConfigShimHook@@YAXPEAHPEAPEAU_NDIS_CONFIGURATION_PARAMETER@@PEAXPEAU_UNICODE_STRING@@W4_NDIS_PARAMETER_TYPE@@@Z @ 0x1400B1730
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _NDIS_PARAMETER_TYPE a5)
{
  ...
  {
    if ( RtlEqualUnicodeString(a4, &stru_14011C5D0, 1u) )
    {
