/*
 * XREFs of ?ndisSSUpdateOidCacheValue@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x140050F70
 * Callers:
 *     ?ndisOidPostStatistics@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x140050F30 (-ndisOidPostStatistics@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
