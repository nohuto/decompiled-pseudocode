/*
 * XREFs of ?ndisCollectHistogramsForIoctl@@YAJW4NDIS_HISTOGRAM_TYPE@@_NPEAEKAEAK@Z @ 0x14013B6CC
 * Callers:
...
__int64 __fastcall ndisCollectHistogramsForIoctl(int a1, char a2, wchar_t *a3, unsigned int a4, unsigned int *a5)
{
  ...
  *a5 = 320;
  KLockThisExclusive::KLockThisExclusive(&v27, &stru_14011E828);
  v11 = qword_14011EE68;
  if ( !qword_14011EE68 )
  {
...
LABEL_13:
  ...
  v12 = 2LL * *((unsigned int *)qword_14011EE68 + 8);
  if ( v12 > 0xFFFFFFFF
    ...
    || (v14 = (v12 + 583) & 0xFFFFFED8,
        v15 = *((unsigned int *)qword_14011EE68 + 4) * (unsigned __int64)v14,
        v15 > 0xFFFFFFFF) )
  {
LABEL_35:
    KLockHolder::~KLockHolder(&v27);
  ...
  *a5 = v16;
  if ( v16 <= (unsigned int)v6 )
  {
    ...
    *((_QWORD *)a3 + 2) = (unsigned int)v11[7];
    ...
    v17 = qword_14011EE68;
    v18 = 0;
    for ( i = *(_QWORD **)qword_14011EE68; i != (_QWORD *)v17 && v18 < v17[4]; i = (_QWORD *)*i )
    {
      v20 = v14 * v18++;
    ...
    if ( a2 )
    {
      ...
      if ( *(_DWORD **)v17 != v17 )
      {
        ...
        *(v22 - 2) = MEMORY[0xFFFFF78000000008];
        v24 = qword_14011EE68;
        v25 = *(_QWORD *)qword_14011EE68;
        if ( *(void **)(*(_QWORD *)qword_14011EE68 + 8LL) != qword_14011EE68 )
LABEL_33:
          __fastfail(3u);
        *v22 = v25;
        v22[1] = v24;
