/*
 * XREFs of ?netsetupBuildObjectPath@@YAXW4_NETSETUP_OBJECT_TYPE@@AEBU_GUID@@W4NetSetupStoreType@@W4NetSetupSubkeyType@@PEA_W@Z @ 0x1401603F0
 * Callers:
 ...
 *     ?netsetupGetSubkeyPath@@YAPEB_WW4NetSetupStoreType@@W4NetSetupSubkeyType@@@Z @ 0x140160630 (-netsetupGetSubkeyPath@@YAPEB_WW4NetSetupStoreType@@W4NetSetupSubkeyType@@@Z.c)
 */
...
int __fastcall netsetupBuildObjectPath(__int64 a1, int *a2, unsigned int a3, unsigned int a4, wchar_t *Dst)
{
  ...
  if ( *((_BYTE *)qword_14011F6E0 + 96) && a4 == 3 )
  {
