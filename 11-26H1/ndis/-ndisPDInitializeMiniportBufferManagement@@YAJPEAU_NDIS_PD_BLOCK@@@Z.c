/*
 * XREFs of ?ndisPDInitializeMiniportBufferManagement@@YAJPEAU_NDIS_PD_BLOCK@@@Z @ 0x14014050C
 * Callers:
 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1401404D8 (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x140140CA0 (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
...
__int64 __fastcall ndisPDInitializeMiniportBufferManagement(struct _NDIS_PD_BLOCK *a1)
{
  ...
  *((_QWORD *)&v20 + 1) = v2;
  if ( !*((_DWORD *)a1 + 4) )
    goto LABEL_7;
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v21, qword_14011EE98);
...
LABEL_23:
    ...
    v14 = qword_14011EE98 + 1030;
    Value = (KPushLockBase **)qword_14011EE98[1031].m_Lock.Value;
    if ( *Value != &qword_14011EE98[1030] )
      goto LABEL_35;
    *v13 = v14;
