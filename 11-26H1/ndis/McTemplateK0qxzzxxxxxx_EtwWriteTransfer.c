/*
 * XREFs of McTemplateK0qxzzxxxxxx_EtwWriteTransfer @ 0x1400480A0
 * Callers:
        ...
        char a13)
{
  ...
  v42 = 8LL;
  v44 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, (const EVENT_DESCRIPTOR *)"S(", a3, 0xBu, &v22);
}
