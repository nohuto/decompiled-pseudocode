/*
 * XREFs of ?ndisSetMiniportRSSv1ParametersForMiniportV2@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1400B0520
 * Callers:
        ...
        int a4)
{
  ...
  struct _PROCESSOR_NUMBER v18; // ecx
  ...
  struct _NDIS_VPORT_BLOCK *v38; // [rsp+78h] [rbp-1h] BYREF
  void *v39; // [rsp+80h] [rbp+7h]
  struct _PROCESSOR_NUMBER *v40; // [rsp+88h] [rbp+Fh]
  struct _PROCESSOR_NUMBER *v41; // [rsp+90h] [rbp+17h]
  ...
  v42 = 1;
  if ( (Flags & 4) != 0
    || (v8 = InformationBuffer->IndirectionTableSize >> 2) != 0 && ((unsigned __int16)(v8 - 1) & v8) == 0 )
  {
LABEL_11:
...
LABEL_14:
    ...
    v18 = v32;
    if ( *(_DWORD *)&v32 <= v17 )
      v18 = (struct _PROCESSOR_NUMBER)v17;
    LODWORD(Size) = v18;
    ...
    if ( v42 )
    {
      ...
      if ( (v22 & 4) == 0 )
      {
        v41 = (struct _PROCESSOR_NUMBER *)(&v19->Header.Type + v19->IndirectionTableOffset);
    ...
    if ( v42 )
    {
      ...
      v11 = ndisInternalSetRSSv2IndirectionTable(a1, a2, v33, v41, DefaultProcessorNumber, v8, v40, v26);
      if ( v11 )
        goto LABEL_51;
      if ( v29 )
      {
...
LABEL_50:
    ...
    ndisSetCombinedRSSParameters(a1, a2, v38, v36);
    v27 = NewIrql;
    a1->MiniportThread = 0LL;
  ...
  v11 = -1073741811;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_dqqL(*((_QWORD *)WPP_GLOBAL_Control + 8), InformationBuffer->IndirectionTableSize, (_DWORD)a3, a4);
LABEL_51:
  result = 1;
