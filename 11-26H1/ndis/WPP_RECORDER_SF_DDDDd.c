/*
 * XREFs of WPP_RECORDER_SF_DDDDd @ 0x1400B1378
 * Callers:
...
__int64 WPP_RECORDER_SF_DDDDd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(
      &WPP_256b6576a69d332ac22b9d11e7f9e0fb_Traceguids,
      a4,
      va,
      4LL,
      va1,
