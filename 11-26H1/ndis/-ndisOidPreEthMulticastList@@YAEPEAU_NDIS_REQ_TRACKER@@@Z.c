/*
 * XREFs of ?ndisOidPreEthMulticastList@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x140022630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisOidPreEthMulticastList(struct _NDIS_REQ_TRACKER *a1, char a2)
{
