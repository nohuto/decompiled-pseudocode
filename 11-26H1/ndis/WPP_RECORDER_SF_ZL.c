/*
 * XREFs of WPP_RECORDER_SF_ZL @ 0x140090870
 * Callers:
...
LABEL_8:
  ...
  if ( !a6 )
    v12 = L"\b";
  ndisWppFastTraceMessage(&WPP_1e356a0c3ca735481fb26761a46e734e_Traceguids, a4, v12, 2LL, v11, v10, va, 4LL, 0LL);
LABEL_11:
  if ( a6 )
  {
    if ( *a6 )
  ...
  LOWORD(v14) = a4;
  return WppAutoLogTrace(a1, 4LL, 5LL, &WPP_1e356a0c3ca735481fb26761a46e734e_Traceguids, v14, v7, 2LL, v6);
}
