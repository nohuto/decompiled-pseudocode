/*
 * XREFs of ?ndisPcwCollectPhysicalData@@YAJPEAU_PCW_BUFFER@@@Z @ 0x140068B60
 * Callers:
 *     ndisPhysicalNicPcwProviderCallback @ 0x1401427B0 (ndisPhysicalNicPcwProviderCallback.c)
 * Callees:
 ...
 *     ?ndisPcwUpdatePhysicalMiniportCounters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_K@Z @ 0x140138B70 (-ndisPcwUpdatePhysicalMiniportCounters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_K@Z.c)
