/*
 * XREFs of ?ndisIovFinalizeNicSwitch@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_NIC_SWITCH_PARAMETERS@@PEAU_NDIS_NIC_SWITCH_BLOCK@@PEAU_NDIS_PF_BLOCK@@PEAU_NDIS_VPORT_BLOCK@@@Z @ 0x1400E0A04
 * Callers:
        ...
        struct _NDIS_VPORT_BLOCK *a5)
{
  ...
  __int128 v10; // xmm1
  __int64 result; // rax
  struct _NDIS_VPORT_BLOCK *v12; // rdi
  _LIST_ENTRY *v13; // rax
  __int64 v14; // rcx
