/*
 * XREFs of ?RtlUnicodeStringCopy@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x14005CD20
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x14005CDF0 (RtlUnicodeStringValidateWorker_0.c)
 */
