/*
 * XREFs of ndisNsiGetInterfaceRosInformation @ 0x1401544F0
 * Callers:
...
__int64 __fastcall ndisNsiGetInterfaceRosInformation(struct _NDIS_IF_BLOCK *a1, struct _NDIS_IF_BLOCK *a2, __int64 a3)
{
  ...
  unsigned int v29[22]; // [rsp+40h] [rbp-58h] BYREF
  struct _NDIS_IF_BLOCK *v31; // [rsp+A8h] [rbp+10h]
