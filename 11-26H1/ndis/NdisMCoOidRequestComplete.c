/*
 * XREFs of NdisMCoOidRequestComplete @ 0x140041B80
 * Callers:
        ...
        NDIS_STATUS Status)
{
  ...
  v4 = *(unsigned int *)&Request->NdisReserved[16];
  if ( (v4 & 0x220) != 0 )
  {
    ...
    else
    {
      ...
      {
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, PNDIS_OID_REQUEST, NDIS_STATUS))(v6 + 1160))(
          *(_QWORD *)(v6 + 32),
      ...
      LOBYTE(v4) = 6;
      ndisMDereferenceOpenUnlocked(v6, v4);
    }
  }
  else if ( (v4 & 8) != 0 )
  {
