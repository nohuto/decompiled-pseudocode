/*
 * XREFs of ?ndisStackExpansionFallbackWorker@@YAXPEAX@Z @ 0x14009D4F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisStackExpansionFallbackWorker(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  *(_OWORD *)&a1->StackExpansionFallback.PendingWork.DevicePnPEvents = 0LL;
  ...
  v12 = (struct _NET_BUFFER_LIST *)P[1];
  while ( v12 )
  {
    v13 = (_SLIST_HEADER *)v12;
    v22 = v12;
    v12 = (struct _NET_BUFFER_LIST *)v12->NdisReserved[1];
    Alignment = (struct _KEVENT *)v13[2].Alignment;
    v13[2].Alignment = 0LL;
    ndisFNetPnPEventInternal(Parameter);
    *((_DWORD *)&v13[2].HeaderX64 + 2) = Parameter[0];
    KeSetEvent(Alignment, 0, 0);
  }
  v15 = NetBufferList[0];
  while ( v15 )
  {
