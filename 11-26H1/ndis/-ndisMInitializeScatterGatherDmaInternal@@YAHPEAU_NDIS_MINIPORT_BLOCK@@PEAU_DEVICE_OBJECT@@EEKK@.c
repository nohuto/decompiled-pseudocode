/*
 * XREFs of ?ndisMInitializeScatterGatherDmaInternal@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_DEVICE_OBJECT@@EEKK@Z @ 0x1400CA45C
 * Callers:
 *     ndisRegisterScatterGatherDmaForMiniport @ 0x1400CAA68 (ndisRegisterScatterGatherDmaForMiniport.c)
 *     NdisMInitializeScatterGatherDma @ 0x1400DB370 (NdisMInitializeScatterGatherDma.c)
 * Callees:
 ...
 *     PplpCreateLookasideListEx @ 0x1400CB2F0 (PplpCreateLookasideListEx.c)
