/*
 * XREFs of ?ndisInvokeNextSendCompleteHandler@@YAXPEAU_NET_BUFFER_LIST@@KPEAU_NDIS_OBJECT_HEADER@@1PEAXP6AX20K@Z@Z @ 0x14002C9F0
 * Callers:
    ...
    if ( v18 )
    {
      do
      {
          ...
          do
          {
            ...
            *(_DWORD *)(v20 + 132) = 0;
            if ( v27 && v7->Type == 5 && *(_QWORD *)&v7[194].Type )
              (*((void (__fastcall **)(void *, unsigned __int64, _QWORD))v27 + 13))(v19, v20, 0LL);
            else
          ...
          do
          {
            ...
            *(_DWORD *)(v23 + 132) = 0;
            if ( v24 && v7->Type == 5 && *(_QWORD *)&v7[194].Type )
              (*((void (__fastcall **)(void *, unsigned __int64, _QWORD))v24 + 13))(v19, v23, 0LL);
            else
        ...
        *(_BYTE *)(v22 + 40) = 0;
        ...
        v17 = *(void (**)(void *, struct _NET_BUFFER_LIST *, unsigned int))&v21[116].Type;
        v19 = *(void **)&v21[118].Type;
      }
      while ( v7->Type == 5 );
    }
    v30 = *p_LowLimit;
      ...
      do
      {
        ...
        *(_DWORD *)(v30 + 132) = 0;
        if ( v31 && v7->Type == 5 && *(_QWORD *)&v7[194].Type )
          (*((void (__fastcall **)(void *, unsigned __int64, _QWORD))v31 + 13))(v19, v30, 0LL);
        else
