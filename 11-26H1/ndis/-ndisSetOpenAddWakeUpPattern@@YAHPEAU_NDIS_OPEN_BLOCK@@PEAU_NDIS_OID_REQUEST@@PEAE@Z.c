/*
 * XREFs of ?ndisSetOpenAddWakeUpPattern@@YAHPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAE@Z @ 0x1400B8CE8
 * Callers:
...
__int64 __fastcall ndisSetOpenAddWakeUpPattern(struct _NDIS_OPEN_BLOCK *a1, struct _NDIS_OID_REQUEST *a2, char *a3)
{
  ...
  int v8; // ebp
  struct _NDIS_PM_PACKET_PATTERN *InformationBuffer; // r14
