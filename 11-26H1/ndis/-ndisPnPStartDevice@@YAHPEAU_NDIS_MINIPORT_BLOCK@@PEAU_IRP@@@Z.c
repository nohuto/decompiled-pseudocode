/*
 * XREFs of ?ndisPnPStartDevice@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x14007B620
 * Callers:
...
__int64 __fastcall ndisPnPStartDevice(struct _NDIS_MINIPORT_BLOCK *a1, struct _IRP *a2)
{
  ...
  MmUnlockPagableImageSection(qword_14011C028);
  _InterlockedDecrement((volatile signed __int32 *)&dword_14011C018);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v10) = 4;
    WPP_RECORDER_SF_q(
  ...
  if ( !v11 )
  {
      ...
      && (a1->Flags & 0x80u) == 0 )
    {
      ...
      v28 = 0LL;
      v23 = PoFxEnableDStateReporting(DeviceObject, &v28);
      if ( v23 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
      ...
      InputBuffer[1] = a1->PhysicalDeviceObject;
      InputBuffer[0] = 58LL;
      InputBuffer[2] = 6LL;
