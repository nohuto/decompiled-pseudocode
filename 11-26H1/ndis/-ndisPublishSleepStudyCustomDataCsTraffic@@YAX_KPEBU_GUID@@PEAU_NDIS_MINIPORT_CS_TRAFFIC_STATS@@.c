/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsTraffic@@YAX_KPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@2@Z @ 0x140165F60
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_TRAFFIC_STATS *a4)
{
  __int64 v6; // rbx
  __int64 v7; // rdi
  unsigned __int64 v8[12]; // [rsp+20h] [rbp-78h]
  ...
  do
  {
    ndisPublishSleepStudyCustomData(a1, a2, off_1400F4F80[v6], v8[v6]);
    ++v6;
    --v7;
  }
  while ( v7 );
