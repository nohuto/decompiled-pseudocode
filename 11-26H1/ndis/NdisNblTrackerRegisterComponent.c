/*
 * XREFs of NdisNblTrackerRegisterComponent @ 0x140054300
 * Callers:
...
__int64 __fastcall NdisNblTrackerRegisterComponent(__int16 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(int *)ndisNblTrackerMode < 2 )
    return a2 | 2;
  Pool2 = ExAllocatePool2(64LL, 72LL, 1802781774LL);
  v7 = Pool2;
  if ( !Pool2 )
    return a2 | 2;
  *(_QWORD *)(Pool2 + 32) = a3;
  ...
  *(_QWORD *)Pool2 = Pool2;
  ...
  v13 = (__int64 *)qword_14011E5A0;
  if ( *(struct _NDIS_NBL_TRACKER ***)qword_14011E5A0 != &ndisNblTrackerList )
    __fastfail(3u);
