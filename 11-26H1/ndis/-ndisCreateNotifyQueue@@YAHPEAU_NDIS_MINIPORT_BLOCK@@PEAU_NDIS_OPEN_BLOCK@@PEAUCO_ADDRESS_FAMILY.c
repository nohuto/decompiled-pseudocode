/*
 * XREFs of ?ndisCreateNotifyQueue@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@PEAUCO_ADDRESS_FAMILY@@PEAPEAU_NDIS_AF_NOTIFY@@@Z @ 0x1401774D0
 * Callers:
      ...
      if ( *a4 )
      {
        do
        {
          ...
          *a4 = *(struct _NDIS_AF_NOTIFY **)v17;
          ...
          ndisMDereferenceOpenLocked((__int64)v18, 0xEu);
          v17 = *a4;
        }
        while ( *a4 );
        goto LABEL_12;
