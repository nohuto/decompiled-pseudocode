/*
 * XREFs of ndisHandleProtocolReconfigNotification @ 0x140174EC4
 * Callers:
        ...
        int a5)
{
  ...
  int v22; // edx
  KIRQL v23; // [rsp+40h] [rbp-C0h]
  struct _NDIS_MINIPORT_BLOCK *v24; // [rsp+48h] [rbp-B8h]
  struct _NDIS_PROTOCOL_BLOCK *v25; // [rsp+50h] [rbp-B0h] BYREF
  ...
  if ( SourceString->Length )
  {
    ...
    v9 = 1;
    v24 = *(struct _NDIS_MINIPORT_BLOCK **)(v7 + 16);
    if ( v13->MajorNdisVersion < 6u && !v13->PnPEventHandler )
    {
      RELEASE_PROT_MUTEX(v13);
      v17 = v24;
      v11 = -1073741823;
...
LABEL_22:
  ...
  if ( !v7 )
    goto LABEL_22;
  v20 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v7 + 232));
  v23 = v20;
  if ( (*(_DWORD *)(v7 + 224) & 0x80000) == 0 )
  {
    *(_DWORD *)(v7 + 224) &= ~0x10u;
    v21 = *(struct _KEVENT **)(v7 + 912);
    if ( v21 )
    {
      KeSetEvent(v21, 0, 0);
      *(_QWORD *)(v7 + 912) = 0LL;
  ...
  KeReleaseSpinLock((PKSPIN_LOCK)(v7 + 232), v20);
  v17 = v24;
  if ( v24 && v19 && v13->MajorNdisVersion <= 6u && (v13->MajorNdisVersion != 6 || v13->MinorNdisVersion < 0x28u) )
  {
