/*
 * XREFs of ?ndisSplitStatisticsOids@@YAHPEAU_NDIS_USER_OPEN_CONTEXT@@PEAKK@Z @ 0x14005D500
 * Callers:
 ...
 *     ndisIsQueryAllStatsOid @ 0x14005D760 (ndisIsQueryAllStatsOid.c)
 */
...
__int64 __fastcall ndisSplitStatisticsOids(struct _NDIS_USER_OPEN_CONTEXT *a1, unsigned int *a2, unsigned int a3)
{
  ...
  v16 = v10 + a3;
  Pool2 = ExAllocatePool2(66LL, 4LL * (unsigned int)(v16 + v5) + 24, 1634681934LL);
  *((_QWORD *)a1 + 2) = Pool2;
  if ( Pool2 )
  {
    *(_DWORD *)(Pool2 + 4) = v16;
    ...
    **((_DWORD **)a1 + 2) = v5;
    ...
    {
      if ( v18 >= a3 )
        v19 = (unsigned int *)(*(_QWORD *)(v3 + 3400) + 4LL * (v18 - a3));
      else
        v19 = v8;
