/*
 * XREFs of ?ndisScheduleStartDeviceWorkItem@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1400AA3E8
 * Callers:
...
__int64 __fastcall ndisScheduleStartDeviceWorkItem(_LIST_ENTRY *a1, _LIST_ENTRY *a2)
{
  ...
  Pool2 = (struct _WORK_QUEUE_ITEM *)ExAllocatePool2(64LL, 48LL, 538985550LL);
  if ( !Pool2 )
    return 3221225626LL;
