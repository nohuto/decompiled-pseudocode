/*
 * XREFs of ?ndisOidPostEnableWakeUp@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1400B6590
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostEnableWakeUp(struct _NDIS_OID_REQUEST **a1)
{
  ...
  if ( !*((_DWORD *)a1 + 10) && a1[4]->RequestType == NdisRequestSetInformation && !a1[3] )
  {
    v1 = *a1;
    if ( *a1 )
    {
      if ( LOBYTE(v1->DATA.QUERY_INFORMATION.Oid) > 6u
