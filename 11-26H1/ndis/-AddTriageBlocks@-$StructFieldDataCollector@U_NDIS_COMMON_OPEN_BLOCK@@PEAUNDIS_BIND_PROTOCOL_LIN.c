/*
 * XREFs of ?AddTriageBlocks@?$StructFieldDataCollector@U_NDIS_COMMON_OPEN_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@$0DFI@@@SAXPEAU_NDIS_COMMON_OPEN_BLOCK@@PEAVTriageDataArray@@PEBUBugcheckParameters@@@Z @ 0x1400BA8F0
 * Callers:
 *     <none>
 * Callees:
