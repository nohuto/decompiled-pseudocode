/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDDDDDDDDDDDDDDDDDDDDDD @ 0x1400C6F10
 * Callers:
...
LABEL_11:
  ...
  if ( v36 )
    v31 = L"\b";
  LOWORD(v38) = 46;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_63e371e5a248373aa5c809d99c379eef_Traceguids, v38, a6, 16LL, v31);
}
