/*
 * XREFs of ?ndisReadProtocolById@@YAJW4NetSetupStoreType@@AEBU_GUID@@@Z @ 0x14014EDB4
 * Callers:
        ...
        if ( !v3 )
        {
          ...
          if ( !v3 )
          {
            ...
            if ( Rtl::KArray<ProtocolBindProperties,1>::grow(
                   (unsigned int *)qword_14011F6E0 + 6,
                   (unsigned int)(*((_DWORD *)qword_14011F6E0 + 7) + 1)) )
            {
