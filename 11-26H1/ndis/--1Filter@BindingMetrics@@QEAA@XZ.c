/*
 * XREFs of ??1Filter@BindingMetrics@@QEAA@XZ @ 0x14005F2C0
 * Callers:
...
void __fastcall BindingMetrics::Filter::~Filter(BindingMetrics::Filter *this)
{
  ...
  if ( *((_BYTE *)this + 17) )
  {
    ...
    if ( !v2 )
      v3 = (unsigned __int16 *)&unk_1400F4F70;
    if ( (unsigned int)dword_14011C6C0 > 4
      && (qword_14011C6D0 & 0x20) != 0
      && (qword_14011C6D8 & 0x20) == qword_14011C6D8 )
    {
