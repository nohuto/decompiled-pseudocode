/*
 * XREFs of ?ndisVerifierInitialization@@YAEXZ @ 0x14008E0B0
 * Callers:
...
{
  if ( (int)DifRegisterClassDriverPlugin(21LL, &off_1400F50C0, 400LL, 0LL) < 0 )
    return 0;
  ...
  qword_14011E528 = (__int64)&ndisMiniportTrackAllocList;
  ndisMiniportTrackAllocList.Flink = &ndisMiniportTrackAllocList;
  qword_14011E518 = (__int64)&ndisDriverTrackAllocList;
