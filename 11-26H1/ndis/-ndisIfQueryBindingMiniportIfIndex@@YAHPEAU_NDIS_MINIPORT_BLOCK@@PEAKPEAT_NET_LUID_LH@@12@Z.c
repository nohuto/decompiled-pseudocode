/*
 * XREFs of ?ndisIfQueryBindingMiniportIfIndex@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAKPEAT_NET_LUID_LH@@12@Z @ 0x140156FE0
 * Callers:
        ...
        union _NET_LUID_LH *a5)
{
  ...
  *a4 = 0;
  ...
  {
    *a4 = a1->BaseMiniport->$C3F5B02AF062A0EFF68E2EFF66ED9DE4::IfIndex;
