/*
 * XREFs of ndisIfCreateNetworkBlock @ 0x1400D298C
 * Callers:
 ...
 *     ndisIfGetUniqueSiteId @ 0x1400D2C80 (ndisIfGetUniqueSiteId.c)
 */
...
__int64 __fastcall ndisIfCreateNetworkBlock(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  {
    Pool2 = ExAllocatePool2(64LL, 616LL, 1718174798LL);
    v13 = (_QWORD *)Pool2;
    if ( Pool2 )
    {
      v14 = *v8;
      ...
      *((_DWORD *)v13 + 19) = 1;
      ...
      while ( v11 );
      v25 = (__int64 *)qword_14011E9E8;
      *v17 = *(_OWORD *)a3;
      while ( v25 != &qword_14011E9E8 )
      {
