/*
 * XREFs of ?ReStartTemporaryPause@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x14015AF20
 * Callers:
        ...
        struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  NDIS_BIND_FILTER_LINK *value; // rsi
  struct NDIS_BIND_FILTER_LINK **p_value; // r14
  __int64 v9; // rbp
  unsigned __int64 j; // rbx
  wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK> > *v11; // rax
  NDIS_BIND_PROTOCOL_LINK *v12; // rsi
...
LABEL_30:
  ...
  v9 = this->Bindings.Protocols.m_numElements;
  for ( j = 0LL; j != v9; ++j )
  {
    if ( j >= this->Bindings.Protocols.m_numElements )
      goto LABEL_30;
    v11 = this->Bindings.Protocols._p;
    v12 = v11[j].__ptr_.__value_;
    v13 = &v11[j];
    if ( v12->BindState.m_actualPauseState == DatapathPaused )
    {
      v15 = v12->BindState.m_pauseReasons;
      v12->BindState.m_pauseReasons = v15 & 0xFFFFFFDF;
      if ( (v15 != 0) != ((v15 & 0xFFFFFFDF) != 0) || !v12->BindState.Miniport )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && *((_WORD *)WPP_GLOBAL_Control + 36) )
        {
        ...
        v12->BindState.Miniport->BindEngine.m_isDirty = 1;
        if ( !v16 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          WPP_RECORDER_SF_Zq(
            *((_QWORD *)WPP_GLOBAL_Control + 8),
            ...
            (struct _GUID *)&WPP_065a33821845343ef30f5566aa9547e7_Traceguids,
            p_Length,
            v13->__ptr_.__value_->BindState.Miniport);
        }
      }
    }
  }
