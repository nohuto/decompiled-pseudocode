/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAX_KPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@@Z @ 0x14016A5B0
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX *a4)
{
  ...
  v5 = (const wchar_t **)off_1400F4FF0;
  v9 = 15LL;
  do
  {
    if ( *(_DWORD *)a3 )
  ...
  while ( v9 );
  v10 = (const wchar_t **)off_1400F5068;
  v11 = 5LL;
  do
  {
    if ( *(_DWORD *)a4 )
