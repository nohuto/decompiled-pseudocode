/*
 * XREFs of ?insertSorted@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@QEAA_N$$QEAV?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@P6A_NAEBV34@1@Z@Z @ 0x14014C8B4
 * Callers:
 ...
 *     Ndis::sortProtocolsByPointer @ 0x14016BDC0 (Ndis--sortProtocolsByPointer.c)
 */

__int64 __fastcall Rtl::KArray<wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>,1>::insertSorted(
        __int64 a1,
        __int64 a2)
{
  unsigned __int64 i; // rbx

  for ( i = 0LL; i < *(unsigned int *)(a1 + 4); ++i )
  {
    if ( !(unsigned __int8)Ndis::sortProtocolsByPointer(*(_QWORD *)(a1 + 8) + 8 * i, a2) )
