/*
 * XREFs of ?ndisSetupWmiNode@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEBU_UNICODE_STRING@@KPEAXPEAPEAUtagWNODE_SINGLE_INSTANCE@@@Z @ 0x140058560
 * Callers:
        ...
        struct tagWNODE_SINGLE_INSTANCE **a5)
{
  ...
  {
    Pool2 = (unsigned int *)ExAllocatePool2(64LL, v11, 863454286LL);
    v13 = Pool2;
    if ( Pool2 )
    {
