/*
 * XREFs of ndisImmediateReadWritePort @ 0x1400DA178
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1400DA4D0 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1400DA4F0 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1400DA510 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1400DA550 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1400DA580 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1400DA5B0 (NdisImmediateWritePortUshort.c)
 * Callees:
