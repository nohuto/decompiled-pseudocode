/*
 * XREFs of ?ndisFQueueOidRequest@@YAHPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x140043860
 * Callers:
...
{
  struct _NDIS_OID_REQUEST *v2; // r9
  struct _NDIS_FILTER_BLOCK *v3; // r10
...
LABEL_22:
    ...
    if ( *(_QWORD *)&v2->NdisReserved[24] )
      TraceLoggingWriteOidRequestQueuedActivity<0,_NDIS_FILTER_BLOCK>(v3, v2);
    else
      TraceLoggingWriteOidRequestQueuedActivity<1,_NDIS_FILTER_BLOCK>(v3, v2);
    goto LABEL_22;
  }
