/*
 * XREFs of ??$MakeSizedPoolPtr@VInterfaceProfileKnobCollection@@@@YA?AV?$unique_ptr@VInterfaceProfileKnobCollection@@U?$KFreePool@VInterfaceProfileKnobCollection@@@@@wistd@@K_K@Z @ 0x14014FC58
 * Callers:
...
_QWORD *__fastcall MakeSizedPoolPtr<InterfaceProfileKnobCollection>(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 Pool2; // rax
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)(Pool2 + 88) = 0LL;
    *(_OWORD *)(Pool2 + 8) = 0LL;
    *(_QWORD *)Pool2 = &InterfaceProfileKnobCollection::`vftable';
    *(_QWORD *)(Pool2 + 24) = 0LL;
    *(_QWORD *)(Pool2 + 32) = 0LL;
    *(_QWORD *)(Pool2 + 40) = 0LL;
    *(_QWORD *)(Pool2 + 48) = 0LL;
