/*
 * XREFs of ??1MiniportDevicePnPEventNotify@AzTelemetry@@UEAA@XZ @ 0x1400745C0
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)this = &AzTelemetry::MiniportDevicePnPEventNotify::`vftable';
  if ( (unsigned int)dword_14011C6C0 > 5 )
  {
    ...
    {
      v5 = KStopwatch::Stop((AzTelemetry::MiniportDevicePnPEventNotify *)((char *)this + 24));
      v6 = *((_QWORD *)this + 2);
      v10 = v5;
      v9 = *((_DWORD *)this + 12);
