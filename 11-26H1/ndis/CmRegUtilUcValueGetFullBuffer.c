/*
 * XREFs of CmRegUtilUcValueGetFullBuffer @ 0x140151C9C
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  *a5 = 0LL;
  Length = v8;
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, v8, 0x62527050u);
  v11 = PoolWithTag;
  if ( !PoolWithTag )
    return 3221225626LL;
  ...
  if ( v12 < 0 )
  {
    ...
    v14 = ExAllocatePoolWithTag(NonPagedPoolNx, ResultLength, 0x62527050u);
    v11 = v14;
    if ( v14 )
    {
