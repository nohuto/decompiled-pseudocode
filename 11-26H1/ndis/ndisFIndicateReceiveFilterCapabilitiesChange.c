/*
 * XREFs of ndisFIndicateReceiveFilterCapabilitiesChange @ 0x14009C5AC
 * Callers:
...
char __fastcall ndisFIndicateReceiveFilterCapabilitiesChange(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v4; // r11d
  unsigned int v5; // ecx
  ...
  v8 = *v7;
  if ( (_BYTE)v8 != 0x80 || (LODWORD(a2) = *((unsigned __int16 *)v7 + 1), (unsigned __int16)a2 < 0x38u) || !v7[1] )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_dDDDq(*((_QWORD *)WPP_GLOBAL_Control + 8), a2, v8, 56);
    return 0;
  }
  v9 = 1248LL;
  if ( v4 != 1073872928 )
