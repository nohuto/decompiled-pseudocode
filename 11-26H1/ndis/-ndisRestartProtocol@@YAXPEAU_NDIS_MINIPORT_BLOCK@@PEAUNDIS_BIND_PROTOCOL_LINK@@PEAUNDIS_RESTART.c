/*
 * XREFs of ?ndisRestartProtocol@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x140158470
 * Callers:
        ...
        struct NDIS_RESTART_INFORMATION *a3)
{
  ...
  KPushLock *p_m_lock; // rsi
  __int64 v12; // r8
  int v13; // r15d
  Ndis::BindEngine *v14; // rcx
  int v15; // r8d
...
LABEL_18:
  ...
  v14 = &a1->BindEngine;
LABEL_19:
  Ndis::BindEngine::EndPolicyUpdates(v14);
}
