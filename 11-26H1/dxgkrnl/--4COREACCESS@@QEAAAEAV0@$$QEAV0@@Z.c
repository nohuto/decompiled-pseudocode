/*
 * XREFs of ??4COREACCESS@@QEAAAEAV0@$$QEAV0@@Z @ 0x14001695C
 * Callers:
...
__int64 __fastcall COREACCESS::operator=(__int64 a1, unsigned __int64 a2)
{
  __int64 v4; // rcx
  ...
  if ( *(_QWORD *)(a1 + 16) )
  {
    ...
    DXGADAPTER::ReleaseReference(*(DXGADAPTER **)(a1 + 16), a2);
  }
  v4 = *(_QWORD *)(a2 + 16);
  *(_QWORD *)(a1 + 16) = v4;
