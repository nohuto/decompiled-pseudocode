/*
 * XREFs of ?GetCddInterface@ADAPTER_DISPLAY@@QEBAPEBU_CDDDXGK_INTERFACE@@I@Z @ 0x14006C2C8
 * Callers:
...
const struct _CDDDXGK_INTERFACE *__fastcall ADAPTER_DISPLAY::GetCddInterface(ADAPTER_DISPLAY *this, unsigned int a2)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    WdLogGlobalForLineNumber = 6454;
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceSharedOwner()", 6454LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( (unsigned int)v2 >= *((_DWORD *)this + 24) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 6455;
  ...
  return *(const struct _CDDDXGK_INTERFACE **)(4024 * v2 + *((_QWORD *)this + 16) + 80);
}
