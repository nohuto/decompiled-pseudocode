/*
 * XREFs of ?_GetMonitorEldInformation@DXGMONITOR@@QEBAJPEAU_MONITOR_PACKED_ELD_INFORMATION@@@Z @ 0x140408A2C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_GetMonitorEldInformation(DXGMONITOR *this, struct _MONITOR_PACKED_ELD_INFORMATION *a2)
{
  ...
  __int64 (__fastcall ***HashValue)(_QWORD, __int64); // [rsp+60h] [rbp+30h] BYREF
  ...
  if ( v6 )
  {
    (*(void (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, __int64)))(*(_QWORD *)v6 + 24LL))(v6, &HashValue);
    if ( !HashValue )
    {
      WdLogSingleEntry0(6LL);
      WdLogGlobalForLineNumber = 3083;
      wistd::unique_ptr<CFlipManagerSignal,wistd::default_delete<CFlipManagerSignal>>::reset(&HashValue, 0LL);
      return 3221225495LL;
    }
    v7 = (_WORD *)((char *)a2 + 10);
    v8 = (_WORD *)((char *)a2 + 8);
    v9 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, __int64), char *, char *))(*HashValue)[14])(
           HashValue,
           (char *)a2 + 8,
           (char *)a2 + 10);
    wistd::unique_ptr<CFlipManagerSignal,wistd::default_delete<CFlipManagerSignal>>::reset(&HashValue, 0LL);
...
LABEL_12:
    ...
    if ( CCDMonitorID != -2147483643 && CCDMonitorID != -1073741789 )
    {
      if ( CCDMonitorID >= 0 )
      {
        ...
        v13 = RtlHashUnicodeString(&DestinationString, 1u, 0, (PULONG)&HashValue);
        if ( v13 < 0 )
        {
          WdLogSingleEntry0(1LL);
