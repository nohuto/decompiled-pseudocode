/*
 * XREFs of DxgkIddGetAdapterSessionDiagnostics @ 0x1401C7774
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  DXGADAPTER *v17[3]; // [rsp+58h] [rbp-20h] BYREF
...
LABEL_9:
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)v12, v9, 0LL, 0LL, 0LL, 0LL);
    goto LABEL_14;
  }
  v13 = (DXGDIAGNOSTICS *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 121);
  if ( !v13 )
  {
    v9 = -1073741436LL;
    WdLogSingleEntry1(2LL);
