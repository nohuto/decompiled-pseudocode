/*
 * XREFs of ?RestoreManagedPrimaryState@MANAGEDPRIMARIESTRACKER@@QEAAJH@Z @ 0x14018EE28
 * Callers:
...
__int64 __fastcall MANAGEDPRIMARIESTRACKER::RestoreManagedPrimaryState(MANAGEDPRIMARIESTRACKER *this, int a2)
{
  ...
  if ( !*(_QWORD *)this )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_pDisplayCore != NULL", 143LL, 0LL, 0LL, 0LL, 0LL);
  }
  v4 = *((_DWORD *)this + 104);
  if ( (v4 & 4) != 0 )
  {
                    ...
                    if ( (unsigned int)DXGDEVICE::IsAllocationPinnableOrNoNeedPin((DXGDEVICE *)v6, v5, v7) )
                    {
                      if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + v5 + 18) + 48LL) + 4LL) & 1) != 0 )
                      {
                        ...
                        if ( !ADAPTER_DISPLAY::IsVidPnSourceVisible(*(ADAPTER_DISPLAY **)this, v5)
                          || ((unsigned __int8)BYTE1(*(_DWORD *)(v6 + 4LL * v5 + 1240)) & (unsigned __int8)(*(_DWORD *)(v6 + 4LL * v5 + 1240) >> 9) & 1) == 0 )
                        {
