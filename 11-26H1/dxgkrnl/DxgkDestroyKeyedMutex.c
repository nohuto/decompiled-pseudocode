/*
 * XREFs of DxgkDestroyKeyedMutex @ 0x1401FF680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkDestroyKeyedMutex(unsigned int *a1)
{
  unsigned int v2; // ebx
  __int64 v3; // rcx
  ...
  unsigned int ULongFromUser; // [rsp+58h] [rbp+10h]
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v5, 2053);
  ULongFromUser = RtlReadULongFromUser(a1);
  v2 = DXGKEYEDMUTEX::DestroyLocal(ULongFromUser);
