/*
 * XREFs of ?VmBusSendDdiGetStandardAllocationDriverData@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAU_DXGKARG_GETSTANDARDALLOCATIONDRIVERDATA@@@Z @ 0x140398708
 * Callers:
    ...
    *(_DWORD *)(v6 + 28) = a3->AllocationPrivateDriverDataSize;
    if ( a3->StandardAllocationType != D3DKMDT_STANDARDALLOCATION_SHAREDPRIMARYSURFACE )
    {
      ...
      if ( a3->StandardAllocationType != D3DKMDT_STANDARDALLOCATION_GDISURFACE )
      {
        ...
        WdLogGlobalForLineNumber = 11947;
...
LABEL_12:
    ...
    if ( v12 )
    {
      ...
      if ( v14 < 0 || (v14 = -1073741823, v20[0] < v11) || (v14 = *v13, *v13 < 0) )
      {
        ...
        WdLogGlobalForLineNumber = 12011;
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
...
LABEL_31:
  ...
  WdLogSingleEntry0(2LL);
  WdLogGlobalForLineNumber = 11917;
  DxgkLogInternalTriageEvent(
    0LL,
    0x40000,
    -1,
