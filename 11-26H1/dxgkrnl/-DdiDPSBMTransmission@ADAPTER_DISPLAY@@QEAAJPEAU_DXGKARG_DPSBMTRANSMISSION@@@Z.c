/*
 * XREFs of ?DdiDPSBMTransmission@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DPSBMTRANSMISSION@@@Z @ 0x1401AD440
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDPSBMTransmission(ADAPTER_DISPLAY *this, struct _DXGKARG_DPSBMTRANSMISSION *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_DPSBMTRANSMISSION *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5153);
  ...
  if ( v9 && (v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_DPSBMTRANSMISSION *))(v9 + 64)) != 0LL )
        ...
        v11 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"The driver failed DxgkDdiDPSBMTransmission. Status: 0x%I64x",
      v11,
      0LL,
      0LL,
      0LL,
