/*
 * XREFs of ?CopyInstance@MonitorColorState@DxgMonitor@@QEBA?AV?$unique_ptr@VMonitorColorState@DxgMonitor@@U?$default_delete@VMonitorColorState@DxgMonitor@@@wistd@@@wistd@@AEAVIMonitorComponentParent@2@AEAVIMonitorRegistry@2@@Z @ 0x14027BE98
 * Callers:
        ...
        struct DxgMonitor::IMonitorRegistry *a4)
{
  ...
  v8 = (DxgMonitor::MonitorColorState *)operator new(0x220uLL, 0x4D677844u, 256LL);
  if ( v8 && (v9 = DxgMonitor::MonitorColorState::MonitorColorState(v8, a3, a4), (v10 = v9) != 0) )
  {
    ...
    *(_DWORD *)(v10 + 480) = *(_DWORD *)(a1 + 480);
    if ( (unsigned int)Feature_AddDisplayHDR12CertificationTier__private_IsEnabledDeviceUsageNoInline() )
      *(_DWORD *)(v10 + 484) = *(_DWORD *)(a1 + 484);
    v26 = *(_DWORD *)(a1 + 512);
    v27 = *(_QWORD *)(a1 + 504);
    *(_OWORD *)(v10 + 488) = *(_OWORD *)(a1 + 488);
    *(_QWORD *)(v10 + 504) = v27;
    *(_DWORD *)(v10 + 512) = v26;
    ...
    *(_BYTE *)(v10 + 517) = *(_BYTE *)(a1 + 517);
    *(_BYTE *)(v10 + 518) = *(_BYTE *)(a1 + 518);
    *(_BYTE *)(v10 + 519) = *(_BYTE *)(a1 + 519);
    *(_BYTE *)(v10 + 520) = *(_BYTE *)(a1 + 520);
    *(_DWORD *)(v10 + 524) = *(_DWORD *)(a1 + 524);
    *(_BYTE *)(v10 + 528) = *(_BYTE *)(a1 + 528);
    *(_DWORD *)(v10 + 532) = *(_DWORD *)(a1 + 532);
    *(_DWORD *)(v10 + 536) = *(_DWORD *)(a1 + 536);
    *(_BYTE *)(v10 + 540) = *(_BYTE *)(a1 + 540);
    *a2 = v10;
  }
  else
  {
