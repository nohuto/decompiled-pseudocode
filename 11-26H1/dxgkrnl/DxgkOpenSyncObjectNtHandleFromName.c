/*
 * XREFs of DxgkOpenSyncObjectNtHandleFromName @ 0x1401EC450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenSyncObjectNtHandleFromName(char *Src)
{
  __int64 v2; // r8
  int v3; // edi
  __int64 v4; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v6, 2204);
  v9 = 0LL;
  v10 = 0LL;
  RtlCopyFromUser(&v9, Src, 0x18uLL);
  Srca = 0LL;
  LOBYTE(v2) = 1;
  v3 = ObOpenObjectByName(*((_QWORD *)&v9 + 1), g_pDxgkSharedSyncObjectType, v2, 0LL, v9, 0LL, &Srca);
  if ( v3 >= 0 )
