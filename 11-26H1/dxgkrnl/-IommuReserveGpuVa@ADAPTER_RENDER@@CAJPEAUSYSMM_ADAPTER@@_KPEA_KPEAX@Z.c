/*
 * XREFs of ?IommuReserveGpuVa@ADAPTER_RENDER@@CAJPEAUSYSMM_ADAPTER@@_KPEA_KPEAX@Z @ 0x1401A95F0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a4)
{
  ...
  if ( v7 )
  {
    ...
    result = VIDMM_EXPORT::VidMmReserveGpuVirtualAddress(v8, v7, *((struct DXGPROCESS **)Global + 173), 0LL, &v11);
    if ( (int)result >= 0 )
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"VIDMM_GLOBAL is not initialized",
      5521LL,
      0LL,
      0LL,
      0LL,
