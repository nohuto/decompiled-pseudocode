/*
 * XREFs of ?CheckMultiPlaneOverlayInternal3@@YAJIPEAVADAPTER_RENDER@@PEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x140434008
 * Callers:
 ...
 *     Feature_DDisplay_AggCheckMpo__private_IsEnabledDeviceUsageNoInline @ 0x140075B60 (Feature_DDisplay_AggCheckMpo__private_IsEnabledDeviceUsageNoInline.c)
...
__int64 __fastcall CheckMultiPlaneOverlayInternal3(
        ...
        int *a4,
        struct DXGK_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO::$3235B0AF7BF3D9B607A1C4FD103E9694::$7E5D53739D5A0755634D9029F4E2827E *a5)
{
  __int64 v6; // rax
  __int64 v7; // r14
  unsigned int v8; // ebx
  ...
  struct ADAPTER_DISPLAY *v46; // [rsp+68h] [rbp-98h]
  ...
  *(_QWORD *)v44 = PagedPoolZeroedArray<_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3,3>::AllocateElements(
  ...
  if ( !*(_QWORD *)v44 )
  {
    ...
    WdLogGlobalForLineNumber = 10409;
LABEL_37:
    if ( v62 != v63 )
    {
      if ( v62 )
  ...
  if ( !v12 )
  {
    ...
    WdLogGlobalForLineNumber = 10433;
LABEL_5:
    if ( P != v66 && P )
  ...
  if ( !v15 )
  {
    ...
    WdLogGlobalForLineNumber = 10445;
    if ( v52 != v53 && v52 )
...
LABEL_24:
  ...
  *(_QWORD *)v43 = PagedPoolZeroedArray<_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE,3>::AllocateElements(
  ...
  if ( !*(_QWORD *)v43 )
  {
    ...
    WdLogGlobalForLineNumber = 10469;
    if ( v68 != v69 && v68 )
  ...
  if ( !v30 )
    v33 = v51;
  ADAPTER_DISPLAY::GetCheckMultiPlaneOverlayArgsUnsafe(v46, v33, v8, v18, v43, v32, v44, v31);
  v34 = v43[0];
  if ( v43[0] > v8 )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 10521;
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"ActualPlaneCount <= MaxPlanes", 10521LL, 0LL, 0LL, 0LL, 0LL);
  }
  v35 = v44[0];
  ...
  else if ( (unsigned int)v34 > *(_DWORD *)(v40 + 2984) )
  {
    v42 = Elements;
  }
  else
  ...
  if ( !(unsigned int)Feature_DDisplay_AggCheckMpo__private_IsEnabledDeviceUsageNoInline()
    ...
    && !*(_BYTE *)(*((_QWORD *)v47 + 2) + 3091LL) )
  {
    *a4 = 0;
    *a5 = (struct DXGK_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO::$3235B0AF7BF3D9B607A1C4FD103E9694::$7E5D53739D5A0755634D9029F4E2827E)(*(_DWORD *)a5 & 0xFFFFFFE0 | 0x10);
  }
  LogCheckMutiplaneOverlaySupport(
    0LL,
    (D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES3 *)(unsigned int)*a4,
    v34,
    v42,
    v15,
    v35,
