/*
 * XREFs of ?IsTdrAdapterUsedInSessionCallback@CTDR_GDI_RESET_THREAD@@KAEPEAXW4_SESSION_CALLBACK_REASON@@K@Z @ 0x1401D89D0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall CTDR_GDI_RESET_THREAD::IsTdrAdapterUsedInSessionCallback(__int64 a1, int a2, unsigned int a3)
{
  ...
  if ( (unsigned int)Feature_SavePairedAdapterInRemoteSession__private_IsEnabledDeviceUsageNoInline() )
  {
    ...
    DXGSESSIONMGR::GetPairedRenderAdapterInRemoteSession(*((DXGSESSIONMGR **)Global + 123), (unsigned int)&v16);
    v7 = *(_QWORD *)(a1 + 32);
    if ( v7 )
    {
      v8 = *(_QWORD *)(v7 + 412);
  ...
  SessionDataForSpecifiedSession = DXGSESSIONMGR::GetSessionDataForSpecifiedSession(*((DXGSESSIONMGR **)v11 + 123), a3);
