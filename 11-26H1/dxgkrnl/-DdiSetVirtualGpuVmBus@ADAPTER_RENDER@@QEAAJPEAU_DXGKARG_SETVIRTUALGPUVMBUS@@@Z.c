/*
 * XREFs of ?DdiSetVirtualGpuVmBus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPUVMBUS@@@Z @ 0x14021B81C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiSetVirtualGpuVmBus(ADAPTER_RENDER *this, struct _DXGKARG_SETVIRTUALGPUVMBUS *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5104);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPUVMBUS *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1064LL)
                                                                           + 120LL))(
