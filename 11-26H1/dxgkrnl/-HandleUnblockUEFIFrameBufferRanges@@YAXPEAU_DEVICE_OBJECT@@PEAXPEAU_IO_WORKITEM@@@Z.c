/*
 * XREFs of ?HandleUnblockUEFIFrameBufferRanges@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x140199210
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HandleUnblockUEFIFrameBufferRanges(PVOID IoObject, struct _LUID *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  __int64 v13; // rcx
  _QWORD *v14; // rax
  unsigned __int64 v15; // [rsp+30h] [rbp-C8h] BYREF
  _BYTE v16[144]; // [rsp+40h] [rbp-B8h] BYREF

  Global = DXGGLOBAL::GetGlobal();
  v6 = DXGGLOBAL::ReferenceAdapterByLuid(Global, *Context, &v15);
  v9 = v6;
  if ( v6 )
  {
    COREADAPTERACCESS::COREADAPTERACCESS((COREADAPTERACCESS *)v16, v6, 0LL);
    v11 = COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v16, 0LL);
    ...
    if ( v11 >= 0 )
    {
      ...
      (*(void (__fastcall **)(_QWORD, struct _LUID *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v9 + 396) + 760LL) + 8LL)
                                                     + 1128LL))(
        *(_QWORD *)(*((_QWORD *)v9 + 396) + 768LL),
        Context + 1);
    }
    else
    {
