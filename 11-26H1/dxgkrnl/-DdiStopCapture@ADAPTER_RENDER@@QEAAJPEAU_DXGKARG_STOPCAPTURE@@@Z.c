/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1404173AC
 * Callers:
 *     ADAPTER_RENDER_DdiStopCapture @ 0x140063710 (ADAPTER_RENDER_DdiStopCapture.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopCapture(ADAPTER_RENDER *this, struct _DXGKARG_STOPCAPTURE *a2)
{
  ...
  __int64 v11; // rcx
  KIRQL v12; // al
  struct _DXGKARG_STOPCAPTURE *v13; // rax
  __int64 v14; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5039);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_STOPCAPTURE *))(*((_QWORD *)this + 2) + 688LL))(
  ...
  v13 = (struct _DXGKARG_STOPCAPTURE *)WdLogNewEntry5_WdTrace(v11, v10);
  v13[3].hAllocation = (HANDLE)v9;
  v13[4].hAllocation = *(HANDLE *)(*((_QWORD *)this + 2) + 288LL);
  v13[5].hAllocation = a2->hAllocation;
