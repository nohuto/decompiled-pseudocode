/*
 * XREFs of ??$WriteData@K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBGK@Z @ 0x14027EDA0
 * Callers:
 *     ?WriteBool@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_N@Z @ 0x14027F5E0 (-WriteBool@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_N@Z.c)
 ...
 *     ?WriteDWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBGK@Z @ 0x14027F690 (-WriteDWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBGK@Z.c)
