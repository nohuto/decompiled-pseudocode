/*
 * XREFs of ?GetVendorAndDevice@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVENDORANDDEVICE@@@Z @ 0x1403F3504
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetVendorAndDevice(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4)
{
  unsigned int v5; // ebx
  ...
  {
    v9 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 80LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
