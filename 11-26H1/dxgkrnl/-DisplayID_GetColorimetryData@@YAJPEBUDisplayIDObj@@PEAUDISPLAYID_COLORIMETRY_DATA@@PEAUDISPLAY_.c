/*
 * XREFs of ?DisplayID_GetColorimetryData@@YAJPEBUDisplayIDObj@@PEAUDISPLAYID_COLORIMETRY_DATA@@PEAUDISPLAY_COLOR_DEPTHS@@@Z @ 0x14009F4BC
 * Callers:
 ...
 *     ?GetColorimetryData@DisplayIdMonitorDescriptor@DxgMonitor@@UEBAJAEAUDISPLAY_COLORIMETRY_DATA@@AEAUDISPLAY_COLOR_DEPTHS@@@Z @ 0x140281A40 (-GetColorimetryData@DisplayIdMonitorDescriptor@DxgMonitor@@UEBAJAEAUDISPLAY_COLORIMETRY_DATA@@AE.c)
 *     ?IsEotf2084Supported@DisplayIdMonitorDescriptor@DxgMonitor@@UEBA_NXZ @ 0x140281DD0 (-IsEotf2084Supported@DisplayIdMonitorDescriptor@DxgMonitor@@UEBA_NXZ.c)
 * Callees:
