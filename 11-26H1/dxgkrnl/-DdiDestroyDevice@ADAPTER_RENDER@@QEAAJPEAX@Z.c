/*
 * XREFs of ?DdiDestroyDevice@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1403CA1F4
 * Callers:
 *     ADAPTER_RENDER_DdiDestroyDevice @ 0x140074BF0 (ADAPTER_RENDER_DdiDestroyDevice.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyDevice(ADAPTER_RENDER *this, void *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5027);
  ...
  v11 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 712LL))(a2);
  if ( v19[0] )
