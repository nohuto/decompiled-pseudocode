/*
 * XREFs of ?SendVmBusMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAXI0PEAI@Z @ 0x1402212E4
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( *((_BYTE *)this + 68) )
  {
    ...
    {
      v9 = ((__int64 (__fastcall *)(struct _KTHREAD *, void *, _QWORD, _QWORD, int, void *, unsigned int *, _QWORD))qword_1401684B0)(
             this[1],
             a2,
             a3,
             0LL,
