/*
 * XREFs of ?SysMmCreateAdl@@YAJPEAUSYSMM_ADAPTER_OBJECT@@_K1IPEAPEAU_DXGK_ADL@@@Z @ 0x140040E10
 * Callers:
 ...
 *     SmmDetermineAdlType @ 0x1400411F0 (SmmDetermineAdlType.c)
 *     SmmValidateParameters @ 0x140041250 (SmmValidateParameters.c)
        ...
        struct _DXGK_ADL **a5)
{
  ...
  if ( (*((_DWORD *)v5 + 11) & 1) == 0 && !*((_DWORD *)v5 + 12) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"Creating ADL against unlocked memory",
      (__int64)a1,
      0LL,
      0LL,
      0LL,
