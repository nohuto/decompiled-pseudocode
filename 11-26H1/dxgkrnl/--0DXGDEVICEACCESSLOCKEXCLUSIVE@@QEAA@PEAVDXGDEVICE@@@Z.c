/*
 * XREFs of ??0DXGDEVICEACCESSLOCKEXCLUSIVE@@QEAA@PEAVDXGDEVICE@@@Z @ 0x140017CB8
 * Callers:
        ...
        struct DXGDEVICE *a2)
{
  ...
  *((_DWORD *)this + 2) = 0;
  if ( a2 )
  {
    ...
    if ( !ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v5 + 136), 0) )
    {
      DXGADAPTER::TryWakeUpFromD3State(*(DXGADAPTER **)(*(_QWORD *)(v5 + 16) + 16LL));
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v7, (__int64)"g");
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v5 + 136), 1u);
