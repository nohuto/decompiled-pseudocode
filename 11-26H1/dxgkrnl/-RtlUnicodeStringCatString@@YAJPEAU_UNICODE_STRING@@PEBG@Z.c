/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x14006F64C
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1400555E4 (RtlUnicodeStringValidateDestWorker.c)
 */
