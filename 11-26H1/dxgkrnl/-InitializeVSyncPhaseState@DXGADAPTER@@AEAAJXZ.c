/*
 * XREFs of ?InitializeVSyncPhaseState@DXGADAPTER@@AEAAJXZ @ 0x14019CA30
 * Callers:
...
__int64 __fastcall DXGADAPTER::InitializeVSyncPhaseState(DXGADAPTER *this)
{
  ...
  if ( !is_mul_ok(v2, 4uLL) )
    v3 = -1LL;
  *((_QWORD *)this + 544) = operator new[](v3, 0x4B677844u, 64LL);
  v4 = (unsigned __int64)v2 << 6;
  if ( !is_mul_ok(v2, 0x40uLL) )
    v4 = -1LL;
  *((_QWORD *)this + 545) = operator new[](v4, 0x4B677844u, 64LL);
  v5 = (unsigned __int64)v2 << 6;
  if ( !is_mul_ok(v2, 0x40uLL) )
    v5 = -1LL;
  *((_QWORD *)this + 546) = operator new[](v5, 0x4B677844u, 64LL);
  v6 = 32LL * v2;
  if ( !is_mul_ok(v2, 0x20uLL) )
    v6 = -1LL;
  *((_QWORD *)this + 547) = operator new[](v6, 0x4B677844u, 64LL);
  v7 = 16LL * v2;
  if ( !is_mul_ok(v2, 0x10uLL) )
    v7 = -1LL;
  *((_QWORD *)this + 548) = operator new[](v7, 0x4B677844u, 64LL);
  v8 = 4LL * v2;
  if ( !is_mul_ok(v2, 4uLL) )
    v8 = -1LL;
  *((_QWORD *)this + 549) = operator new[](v8, 0x4B677844u, 64LL);
  v9 = 8LL * v2;
  if ( !is_mul_ok(v2, 8uLL) )
    v9 = -1LL;
  *((_QWORD *)this + 556) = operator new[](v9, 0x4B677844u, 64LL);
  v10 = 8LL * v2;
  if ( !is_mul_ok(v2, 8uLL) )
    v10 = -1LL;
  *((_QWORD *)this + 555) = operator new[](v10, 0x4B677844u, 64LL);
  v11 = 112LL * v2;
  ...
  *((_QWORD *)this + 557) = v14;
  ...
  if ( v2 )
  {
    ...
    do
    {
      *(_DWORD *)(v17 + *((_QWORD *)this + 544)) = 0;
      KeInitializeTimer((PKTIMER)(v13 + *((_QWORD *)this + 545)));
      *(_QWORD *)(v19 + *((_QWORD *)this + 548)) = this;
      *(_DWORD *)(v19 + *((_QWORD *)this + 548) + 8) = v15;
      KeInitializeDpc(
        (PRKDPC)(v13 + *((_QWORD *)this + 546)),
        (PKDEFERRED_ROUTINE)DxgkpVSyncPhaseTimerDpc,
        (PVOID)(v20 + *((_QWORD *)this + 548)));
      v21 = *((_QWORD *)this + 547);
      v19 += 16LL;
      v22 = v20 + *((_QWORD *)this + 548);
      ++v15;
      v13 += 64LL;
      v20 += 16LL;
      ...
      *(_QWORD *)(v18 + v21) = 0LL;
      v18 += 32LL;
      v24 += 4LL;
      *(LARGE_INTEGER *)(v25 + *((_QWORD *)this + 557)) = PerformanceCounter;
      v25 += 112LL;
    }
    while ( v15 < v2 );
  }
