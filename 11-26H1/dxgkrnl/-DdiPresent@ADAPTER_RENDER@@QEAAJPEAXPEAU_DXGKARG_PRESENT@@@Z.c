/*
 * XREFs of ?DdiPresent@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_PRESENT@@@Z @ 0x1402F4940
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiPresent(ADAPTER_RENDER *this, void *a2, struct _DXGKARG_PRESENT *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 5031);
...
LABEL_7:
  ...
  v19 = (*(int (__fastcall **)(void *, struct _DXGKARG_PRESENT *))(*((_QWORD *)this + 2) + 744LL))(a2, a3);
  if ( v35[0] )
