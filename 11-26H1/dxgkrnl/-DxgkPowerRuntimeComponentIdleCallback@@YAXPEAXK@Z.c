/*
 * XREFs of ?DxgkPowerRuntimeComponentIdleCallback@@YAXPEAXK@Z @ 0x140012D30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkPowerRuntimeComponentIdleCallback(DXGADAPTER *this, unsigned int a2)
{
  ...
  PoFxCompleteIdleCondition(*((_QWORD *)this + 409), a2);
}
