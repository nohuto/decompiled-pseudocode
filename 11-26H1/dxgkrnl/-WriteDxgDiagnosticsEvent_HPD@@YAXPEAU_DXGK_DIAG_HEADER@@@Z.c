/*
 * XREFs of ?WriteDxgDiagnosticsEvent_HPD@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1400475C4
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_HPD(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304896) )
  {
    if ( (unsigned int)dword_1401665F0 > 1
      && (unsigned __int8)tlgKeywordOn(&dword_1401665F0, 0x200000000002LL)
      && (unsigned __int8)tlgKeywordOn(&dword_1401665F0, v6) )
    {
      v5 = &unk_14014339D;
      goto LABEL_7;
    }
         ...
         && (qword_140166600 & 0x200000000002LL) != 0
         && (qword_140166608 & 0x200000000002LL) == qword_140166608 )
  {
    v5 = &unk_140143371;
LABEL_7:
    v8 = *((_WORD *)a1 + 2);
