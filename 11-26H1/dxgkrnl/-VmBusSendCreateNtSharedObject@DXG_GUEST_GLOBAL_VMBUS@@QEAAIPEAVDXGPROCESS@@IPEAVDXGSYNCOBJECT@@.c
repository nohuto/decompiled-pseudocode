/*
 * XREFs of ?VmBusSendCreateNtSharedObject@DXG_GUEST_GLOBAL_VMBUS@@QEAAIPEAVDXGPROCESS@@IPEAVDXGSYNCOBJECT@@PEAVDXGDEVICESYNCOBJECT@@PEAVDXGRESOURCE@@@Z @ 0x14022D650
 * Callers:
        ...
        struct DXGRESOURCE *a6)
{
  ...
  if ( !a4 && !a5 && !a6 )
  {
    ...
    WdLogGlobalForLineNumber = 14117;
  ...
  if ( v18[0] )
  {
    ...
    *((_DWORD *)v10 + 6) = HostHandle;
    ...
    if ( v13 < 0 || (v13 = -1073741823, (unsigned int)v17 < 4) )
    {
      ...
      WdLogGlobalForLineNumber = 14137;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
