/*
 * XREFs of ?LiveMigrationTransferDirtyContent@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@IW4_DXGK_GPUP_MIGRATIONTYPE@@PEA_K@Z @ 0x140214F24
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( a2 )
  {
    ...
    WdLogGlobalForLineNumber = 2652;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
      (__int64)L"LiveMigrationTransferDirtyContent called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v9,
      v18,
