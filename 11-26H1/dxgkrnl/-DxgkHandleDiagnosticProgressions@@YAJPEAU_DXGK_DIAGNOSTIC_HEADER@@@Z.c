/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x14007A290
 * Callers:
...
__int64 __fastcall DxgkHandleDiagnosticProgressions(struct _DXGK_DIAGNOSTIC_HEADER *a1)
{
  ...
  __int64 v3; // rax
  const wchar_t *v4; // r9
  struct _DXGK_DIAGNOSTIC_HEADER::$09C6252679EB7C7BF0B7CC5E744C86DA::$FF47BB92492B9E237D26C816A8818E09 v6; // eax
  __int64 v7; // rdx
  char v8; // r10
  __int64 v9; // rcx
  __int64 v10; // r8
...
LABEL_3:
  ...
  if ( *(_WORD *)&v6 < 0x18u )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"SyncLock Resync diagnostic reported with incorrect size 0x%I64x, should be at least 0x%I64x. (%d)",
      v13,
      24LL,
      0LL,
      0LL,
  ...
  if ( (unsigned int)dword_140166548 > 4 && tlgKeywordOn((__int64)&dword_140166548, 1LL) )
  {
    if ( (v8 & 1) != 0 )
    {
    ...
    if ( tlgKeywordOn((__int64)&dword_140166548, v7) )
    {
      LOBYTE(v11) = v11 & 1;
      v12 = &unk_14014238C;
      v14 = v11;
