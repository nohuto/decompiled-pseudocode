/*
 * XREFs of ?DdiSetFlipQueueLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1401B1284
 * Callers:
 *     ADAPTER_RENDER_DdiSetFlipQueueLogBuffer @ 0x140074D70 (ADAPTER_RENDER_DdiSetFlipQueueLogBuffer.c)
 * Callees:
        ...
        const struct _DXGKARG_SETFLIPQUEUELOGBUFFER *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, const struct _DXGKARG_SETFLIPQUEUELOGBUFFER *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5154);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETFLIPQUEUELOGBUFFER *))(v9 + 1408);
  if ( v10 )
