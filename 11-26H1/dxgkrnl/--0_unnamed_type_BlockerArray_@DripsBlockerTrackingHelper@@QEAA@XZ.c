/*
 * XREFs of ??0_unnamed_type_BlockerArray_@DripsBlockerTrackingHelper@@QEAA@XZ @ 0x14007B8B0
 * Callers:
 *     <none>
 * Callees:
        ...
        DripsBlockerTrackingHelper::_unnamed_type_BlockerArray_ *this)
{
  ...
  *((_DWORD *)this + 27) = 0;
  `vector constructor iterator'(
    ...
    72LL,
    64LL,
    (void (__fastcall *)(char *))DripsBlockerTrackingHelper::_unnamed_type_BlockerArray_::_unnamed_type_Activations_::_unnamed_type_Activations_);
  return this;
}
