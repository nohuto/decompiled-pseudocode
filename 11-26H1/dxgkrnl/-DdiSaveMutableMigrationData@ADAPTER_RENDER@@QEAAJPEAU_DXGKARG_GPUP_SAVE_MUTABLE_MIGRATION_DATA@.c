/*
 * XREFs of ?DdiSaveMutableMigrationData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_SAVE_MUTABLE_MIGRATION_DATA@@@Z @ 0x14021B090
 * Callers:
 *     ?SaveMutableMigrationData@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GPUP_SAVE_MUTABLE_MIGRATION_DATA@@@Z @ 0x14021F480 (-SaveMutableMigrationData@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GPUP_SAVE_MUTABLE_MIGRATION_D.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiSaveMutableMigrationData(
        ADAPTER_RENDER *this,
        struct _DXGKARG_GPUP_SAVE_MUTABLE_MIGRATION_DATA *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5185);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_SAVE_MUTABLE_MIGRATION_DATA *))(*((_QWORD *)this + 2) + 1624LL))(
