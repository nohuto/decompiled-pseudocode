...
__int64 __fastcall VIDSCH_EXPORT::VidSchCreateSyncObject(
        ...
        __int64 a13)
{
  return (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64, _QWORD, int, __int64, __int64, __int64, __int64, __int64))(*(_QWORD *)(a1 + 8) + 632LL))(
           a2,
           a3,
           a4,
           a5,
