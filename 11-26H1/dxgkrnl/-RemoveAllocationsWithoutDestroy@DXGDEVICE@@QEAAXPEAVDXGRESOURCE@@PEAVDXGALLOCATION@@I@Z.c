/*
 * XREFs of ?RemoveAllocationsWithoutDestroy@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@PEAVDXGALLOCATION@@I@Z @ 0x1401C3694
 * Callers:
        ...
        int a4)
{
  ...
  __int64 v10; // rcx
  __int64 v11; // rax
  DXGFASTMUTEX *v12; // [rsp+20h] [rbp-38h] BYREF
  ...
  if ( a2 )
  {
    DXGAUTOMUTEX::Initialize(&v12, (struct DXGRESOURCE *)((char *)a2 + 80), 1);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)&v12);
  }
  else
  {
    DXGAUTOPUSHLOCK::AcquireExclusive((DXGAUTOPUSHLOCK *)v14);
  }
