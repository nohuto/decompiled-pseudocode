/*
 * XREFs of ?DdiSetVideoProtectedRegion@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETVIDEOPROTECTEDREGION@@@Z @ 0x14041BB2C
 * Callers:
 *     ADAPTER_RENDER_DdiSetVideoProtectedRegion @ 0x140074DD0 (ADAPTER_RENDER_DdiSetVideoProtectedRegion.c)
 * Callees:
        ...
        const struct _DXGKARG_SETVIDEOPROTECTEDREGION *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5069);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETVIDEOPROTECTEDREGION *))(*((_QWORD *)this + 2) + 1016LL))(
