/*
 * XREFs of ?LogMuxPairingStateTelemetry@DISPLAY_MUX_PAIRING@@AEBAXW4DISPLAYCONFIG_DISPLAYMUX_PAIRING_STATUS@@J_N@Z @ 0x14008D120
 * Callers:
        ...
        char a4)
{
  ...
  else if ( (unsigned int)dword_1401665B8 > 5 && tlgKeywordOn((__int64)&dword_1401665B8, 0x400000000200LL) )
  {
    v18 = *((_QWORD *)a1 + 3);
    if ( v18 )
    {
