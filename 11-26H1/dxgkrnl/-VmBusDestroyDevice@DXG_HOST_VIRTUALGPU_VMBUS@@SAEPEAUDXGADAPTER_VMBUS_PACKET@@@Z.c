/*
 * XREFs of ?VmBusDestroyDevice@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1402258B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyDevice(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  _D3DKMT_DESTROYDEVICE v8; // [rsp+80h] [rbp+8h] BYREF
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 10) + 173LL) )
  {
    ...
    if ( v4 )
    {
      v8.hDevice = *(_DWORD *)(v4 + 24);
      v5 = DxgkDestroyDeviceImpl(&v8, 0);
