/*
 * XREFs of DxgkAcquireAdapterCoreSync @ 0x14030D100
 * Callers:
...
__int64 __fastcall DxgkAcquireAdapterCoreSync(__int64 a1, int a2)
{
  ...
  if ( a1 )
  {
    if ( (_DWORD)v2 == 1 || (_DWORD)v2 == 2 || (_DWORD)v2 == 3 || (_DWORD)v2 == 4 || (_DWORD)v2 == 6 )
    {
      DXGADAPTER::AcquireCoreSync(a1, (unsigned int)v2);
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"Invalid adapter synchronization level 0x%I64x",
      v2,
      0LL,
      0LL,
      0LL,
