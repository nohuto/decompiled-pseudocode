/*
 * XREFs of ??1DXGPROTECTEDSESSION@@QEAA@XZ @ 0x1400809E8
 * Callers:
...
void __fastcall DXGPROTECTEDSESSION::~DXGPROTECTEDSESSION(DXGPROTECTEDSESSION *this)
{
  ...
  if ( *((_DWORD *)this + 20) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"0 == m_cReference", 44LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_QWORD *)this + 19) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 45;
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NULL == m_hDriverHandle", 45LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_DWORD *)this + 6) != 3 )
  {
    WdLogSingleEntry0(1LL);
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      -1,
      (__int64)L"EXECUTION_STOPPED == m_ExecutionState",
      46LL,
      0LL,
      0LL,
      0LL,
  ...
  if ( *((_BYTE *)this + 144) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"false == m_bDelaySignal", 47LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_QWORD *)this + 15) )
  {
