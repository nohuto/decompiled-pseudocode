/*
 * XREFs of DxgLogEtwEventCb @ 0x140079820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgLogEtwEventCb(_QWORD *a1, int a2, unsigned __int16 a3, __int64 a4)
{
  ...
  else if ( a3 == 568 )
  {
    ...
    if ( a4 != -16 && wcsnlen((const wchar_t *)(a4 + 16), 0xFFuLL) >= 0xFF )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        262146,
        -1,
        (__int64)L"wcsnlen_s(eventNotification->EventDescription, DXGKDDI_PARTITION_EVENT_DESCRIPTION_MAX) < DXGKDDI_PARTI"
                  "TION_EVENT_DESCRIPTION_MAX",
        304LL,
        0LL,
        0LL,
        0LL,
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      -1,
      (__int64)L"EventBufferSize == sizeof(DXGKDDICB_PARTITIONING_EVENT_NOTIFICATION)",
      294LL,
      0LL,
      0LL,
      0LL,
    ...
    return DxgkLogInternalTriageEvent(
             ...
             0x40000,
             -1,
             (__int64)L"Driver requested partitioning event with wrong event size: %d",
             v6,
             0LL,
             0LL,
             0LL,
