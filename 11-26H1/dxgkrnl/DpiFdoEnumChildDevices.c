/*
 * XREFs of DpiFdoEnumChildDevices @ 0x1404290E4
 * Callers:
  ...
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(v1 + 2704); i = ++v36 )
  {
    ...
    if ( v15 == 1 )
    {
      ...
      *(_DWORD *)(v1 + 3620) = v6[v13 + 6];
      if ( *(_BYTE *)(*(_QWORD *)(v1 + 168) + 108LL) == (_BYTE)v11
        && (*(_BYTE *)(v1 + 1153) == (_BYTE)v11 || *(_BYTE *)(v1 + 480) == (_BYTE)v11)
        && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 40LL) + 28LL) >= 0x4000u
        && *(_BYTE *)(v1 + 2716) == (_BYTE)v11 )
      {
        ChildDescriptor = -1073741637;
        WdLogSingleEntry1(2LL);
...
LABEL_42:
    ...
    else
    {
      if ( v15 == 3 )
      {
        ...
        {
          ChildDescriptor = -1073741637;
          WdLogSingleEntry2(2LL, (unsigned int)v6[7 * v9 + 6], (unsigned int)v6[v13 + 6]);
          ...
          && (*(_BYTE *)(v1 + 1153) == (_BYTE)v11 || *(_BYTE *)(v1 + 480) == (_BYTE)v11) )
        {
          if ( *(_BYTE *)(v1 + 2716) == (_BYTE)v11 )
          {
            if ( *(_BYTE *)(v1 + 6393) == (_BYTE)v11 )
            {
              ChildDescriptor = -1073741637;
              WdLogSingleEntry1(2LL);
              WdLogGlobalForLineNumber = 6007;
              goto LABEL_85;
            }
            goto LABEL_54;
          }
...
LABEL_54:
          if ( *(_BYTE *)(v1 + 2716) == (_BYTE)v11
            && byte_140168DD9 == (_BYTE)v11
            && *(_BYTE *)(v1 + 6393) == (_BYTE)v11
            && v10 != -1 )
          {
            ChildDescriptor = -1073741637;
            WdLogSingleEntry1(2LL);
