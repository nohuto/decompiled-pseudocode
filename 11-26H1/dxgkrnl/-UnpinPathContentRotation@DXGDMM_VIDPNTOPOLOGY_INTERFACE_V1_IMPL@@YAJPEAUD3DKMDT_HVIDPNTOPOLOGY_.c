/*
 * XREFs of ?UnpinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1403EA3A0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v21, 6029);
