/*
 * XREFs of ?DdiCreateContext@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_CREATECONTEXT@@@Z @ 0x1403C18B8
 * Callers:
 *     ADAPTER_RENDER_DdiCreateContext @ 0x140074B50 (ADAPTER_RENDER_DdiCreateContext.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateContext(ADAPTER_RENDER *this, void *a2, struct _DXGKARG_CREATECONTEXT *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5041);
  ...
  if ( (_BYTE)v9 != KeGetCurrentIrql() )
  {
    ...
    WdLogSingleEntry5(0LL, 275LL, 16LL, this, v9, v16);
