/*
 * XREFs of ?Clear@?$DoublyLinkedList@VDMMVIDPN@@U?$DoubleLinkedListElementDeleter@VDMMVIDPN@@@@@@QEAAXXZ @ 0x14006841C
 * Callers:
 ...
 *     ?Clear@?$Queue@VDMMVIDPN@@@@UEAAXXZ @ 0x1400964F0 (-Clear@-$Queue@VDMMVIDPN@@@@UEAAXXZ.c)
 * Callees:
