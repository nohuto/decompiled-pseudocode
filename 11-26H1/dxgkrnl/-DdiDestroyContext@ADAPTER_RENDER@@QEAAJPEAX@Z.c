/*
 * XREFs of ?DdiDestroyContext@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1403A6B6C
 * Callers:
 *     ADAPTER_RENDER_DdiDestroyContext @ 0x140074BD0 (ADAPTER_RENDER_DdiDestroyContext.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyContext(ADAPTER_RENDER *this, void *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5042);
  ...
  v11 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 784LL))(a2);
  if ( v19[0] )
