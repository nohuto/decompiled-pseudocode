/*
 * XREFs of ?FillMdmStatus@DISPLAY_MUX_MGR@@QEAAXPEAU_DISPLAYCONFIG_DISPLAYMUX_STATUS@@@Z @ 0x140015204
 * Callers:
 *     DpiGetMdmStatus @ 0x1400151E4 (DpiGetMdmStatus.c)
 * Callees:
 *     ??0DXGAUTOMUTEX@@QEAA@QEAVDXGFASTMUTEX@@E@Z @ 0x14000D6A0 (--0DXGAUTOMUTEX@@QEAA@QEAVDXGFASTMUTEX@@E@Z.c)
 *     ?Acquire@DXGAUTOMUTEX@@QEAAXXZ @ 0x14000E0B0 (-Acquire@DXGAUTOMUTEX@@QEAAXXZ.c)
 *     ?DoesSystemSupportDynamicMdmNow@DISPLAY_MUX_MGR@@QEBAEXZ @ 0x14001537C (-DoesSystemSupportDynamicMdmNow@DISPLAY_MUX_MGR@@QEBAEXZ.c)
