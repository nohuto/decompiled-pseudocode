/*
 * XREFs of ?DxgkpStopRenderAndSessionDisplayAdapters@@YAJAEAW4_DXGK_DIAG_BDD_FALLBACK_STAGE@@@Z @ 0x140198854
 * Callers:
...
__int64 __fastcall DxgkpStopRenderAndSessionDisplayAdapters(enum _DXGK_DIAG_BDD_FALLBACK_STAGE *a1)
{
  ...
  v2 = *((_QWORD *)DXGGLOBAL::GetGlobal() + 126);
  if ( v2 == *((_QWORD *)DXGGLOBAL::GetGlobal() + 124) )
  {
