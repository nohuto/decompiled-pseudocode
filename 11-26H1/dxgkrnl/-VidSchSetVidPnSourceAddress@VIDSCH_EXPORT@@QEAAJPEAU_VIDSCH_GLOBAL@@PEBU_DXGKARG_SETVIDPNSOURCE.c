/*
 * XREFs of ?VidSchSetVidPnSourceAddress@VIDSCH_EXPORT@@QEAAJPEAU_VIDSCH_GLOBAL@@PEBU_DXGKARG_SETVIDPNSOURCEADDRESS@@@Z @ 0x140063508
 * Callers:
...
{
  return (*(__int64 (__fastcall **)(struct _VIDSCH_GLOBAL *, const struct _DXGKARG_SETVIDPNSOURCEADDRESS *))(*((_QWORD *)this + 1) + 840LL))(
           a2,
           a3);
}
