/*
 * XREFs of DxgkReserveGpuVirtualAddressRangeCB @ 0x1403F45B0
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    if ( DXGADAPTER::IsGpuVaIoMmuGlobalSupported(DxgAdapter) )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000,
        -1,
        (__int64)L"Reserving GPU VA ranges is not supported with GpuVaIoMmuGlobal",
        358LL,
        0LL,
        0LL,
        0LL,
    ...
    else
    {
      ...
      else
      {
        ...
        v10 = (*(__int64 (__fastcall **)(_QWORD, __int128 *))(*(_QWORD *)(*(_QWORD *)(v7 + 760) + 8LL) + 784LL))(
                *(_QWORD *)(v7 + 768),
                v8);
