/*
 * XREFs of ?AddWakeUpToProcessEntry@DripsBlockerTrackingHelper@@QEAAJ_KPEAU_EPROCESS@@W4_DXGKETW_PROFILER_TYPE@@@Z @ 0x1403BDA94
 * Callers:
...
__int64 __fastcall DripsBlockerTrackingHelper::AddWakeUpToProcessEntry(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( ProcessEntry >= 0 && !v10[0] )
  {
    ...
    *(_DWORD *)(v7 + 72LL * v12[0] + 168) = v8;
    if ( a4 == 2018 && v8 > 0x64 && !_InterlockedCompareExchange(&dword_140168A48, 1, 0) )
