/*
 * XREFs of ?DdiStopDirtyTracking@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401B2DC0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopDirtyTracking(ADAPTER_RENDER *this, void *const a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5179);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1592LL))(
  ...
  {
    WdLogSingleEntry1(2LL);
    WdLogGlobalForLineNumber = 5411;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
      (__int64)L"The driver failed DxgkDdiStopDirtyTracking. Status: 0x%I64x",
      v9,
      0LL,
      0LL,
      0LL,
