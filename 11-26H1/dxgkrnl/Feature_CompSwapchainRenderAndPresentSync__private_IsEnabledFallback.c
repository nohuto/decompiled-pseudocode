/*
 * XREFs of Feature_CompSwapchainRenderAndPresentSync__private_IsEnabledFallback @ 0x1400678E4
 * Callers:
...
__int64 __fastcall Feature_CompSwapchainRenderAndPresentSync__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
