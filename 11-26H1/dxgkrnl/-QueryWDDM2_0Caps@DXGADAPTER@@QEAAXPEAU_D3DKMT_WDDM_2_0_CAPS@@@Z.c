/*
 * XREFs of ?QueryWDDM2_0Caps@DXGADAPTER@@QEAAXPEAU_D3DKMT_WDDM_2_0_CAPS@@@Z @ 0x1403E67EC
 * Callers:
...
void __fastcall DXGADAPTER::QueryWDDM2_0Caps(DXGADAPTER *this, struct _D3DKMT_WDDM_2_0_CAPS *a2)
{
  ...
  v7 = v4 | v6;
  a2->Value = v7;
  if ( (*((_BYTE *)this + 2508) & 0xA0) == 0xA0 )
    v2 = 4;
  v8 = v7 | v2;
  a2->Value = v8;
  v9 = v8 | (*((_DWORD *)this + 753) > 1u ? 8 : 0);
  a2->Value = v9;
  v10 = v9 | (16 * (*((_DWORD *)this + 754) & 1));
  a2->Value = v10;
  a2->Value = v10 | (32 * (*((_BYTE *)this + 3008) & 1));
}
