/*
 * XREFs of ?InitializeDriverWorkarounds@DXGADAPTER@@AEAAXXZ @ 0x14019BD70
 * Callers:
...
void __fastcall DXGADAPTER::InitializeDriverWorkarounds(DXGADAPTER *this)
{
  ...
  v1 = (char *)this + 3048;
  DxgkInitializeBlockList(*((_QWORD *)this + 27), *((unsigned int *)this + 694), (char *)this + 3048);
...
LABEL_7:
  ...
  if ( *((int *)this + 694) >= 0x2000 )
  {
    ...
    if ( v7 == 4098 || v7 == 4318 )
    {
      *((_DWORD *)this + 625) |= 0x40u;
    }
    else if ( v7 == 32902 && (*((_DWORD *)this + 625) & 0x40) != 0 )
    {
      Key = *((_DWORD *)this + 106);
      if ( bsearch(&Key, &unk_1400D0CC0, 0x18uLL, 4uLL, UintCompareFunc) )
      {
        v8 = (const wchar_t *)*((_QWORD *)this + 255);
        if ( v8 )
        {
          v9 = wcsrchr(v8, 0x2Eu);
          if ( v9 )
  ...
  if ( *((int *)this + 694) >= 9216 && (*((_DWORD *)this + 111) & 0x100) == 0 )
    *((_DWORD *)this + 625) |= 8u;
  if ( *((_DWORD *)this + 105) != 4318 || *((_DWORD *)this + 580) > 0x10004u )
    **(_DWORD **)v1 |= 0x10000000u;
  if ( *((_DWORD *)this + 105) == 1297040209 )
  {
    if ( *((int *)this + 761) <= 2000 )
    {
      **(_DWORD **)v1 |= 0x10u;
    ...
    if ( *((int *)this + 761) <= 1300 )
    {
      **(_DWORD **)v1 |= 1u;
      **(_DWORD **)v1 |= 2u;
      **(_DWORD **)v1 |= 8u;
    }
    if ( *((_DWORD *)this + 694) == 4608 )
      **(_DWORD **)v1 |= 4u;
  ...
  if ( *((int *)this + 694) <= 9216 && *((_DWORD *)this + 105) == 32902 )
  {
    v11 = (const wchar_t *)*((_QWORD *)this + 255);
    if ( v11 )
    {
  ...
  if ( *((_DWORD *)this + 694) == 8960 && *((_DWORD *)this + 105) == 4098 )
    **(_DWORD **)v1 |= 0x400000u;
  if ( *((int *)this + 694) <= 9728 && *((_DWORD *)this + 105) == 4098 )
    **(_DWORD **)v1 |= 0x800000u;
  if ( (*((_DWORD *)this + 754) & 8) != 0 && *((_DWORD *)this + 105) == 1297040209 )
  {
    v13 = 0x20000000;
  }
  else
  ...
  if ( v14 )
  {
    if ( v14 == 2 )
      ...
      **(_DWORD **)v1 ^= (**(_DWORD **)v1 ^ ((unsigned __int8)(*((_DWORD *)this + 754) >> 3) << 30)) & 0x40000000;
  }
  else
  {
    **(_DWORD **)v1 &= ~0x40000000u;
  ...
  if ( v15 )
  {
    if ( v15 == 2 )
      ...
      *(_DWORD *)(*(_QWORD *)v1 + 4LL) ^= ((unsigned __int8)*(_DWORD *)(*(_QWORD *)v1 + 4LL) ^ (unsigned __int8)(2 * (*((_DWORD *)this + 754) >> 3))) & 2;
  }
  else
  {
    *(_DWORD *)(*(_QWORD *)v1 + 4LL) &= ~2u;
  ...
  if ( !v18 )
  {
    **(_DWORD **)v1 = **(_DWORD **)v1 & 0x7FFFFFFF | ((unsigned __int8)(*((_DWORD *)this + 754) >> 3) << 31);
    goto LABEL_93;
  }
  if ( v18 != 1 )
  {
LABEL_92:
    **((_DWORD **)this + 381) &= ~0x80000000;
    goto LABEL_93;
  }
  **(_DWORD **)v1 |= 0x80000000;
LABEL_93:
  *(_DWORD *)(*((_QWORD *)this + 381) + 4LL) = v4 | *(_DWORD *)(*((_QWORD *)this + 381) + 4LL) & 0xFFFFFFFE;
}
