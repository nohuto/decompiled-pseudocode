/*
 * XREFs of ?CreatePlaneLiveDumpAtPassive@@YAXIIPEBU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOCKDRIVERSTATE_PLANE@@@Z @ 0x1401E644C
 * Callers:
        ...
        struct _MOCKDRIVERSTATE_PLANE *a5)
{
  ...
  *((_QWORD *)v9 + 328) = *((_QWORD *)a3 + 6);
  ...
  if ( (unsigned int)dword_140166660 > 5 && tlgKeywordOn((__int64)&dword_140166660, 0x400000020000LL) )
  {
    LOBYTE(v10) = 1;
    ...
    v30 = *((_DWORD *)a4 + 814);
    v14 = *((unsigned __int8 *)a4 + 3093);
    v15 = *((_DWORD *)v9 + 655);
    v16 = *((_DWORD *)v9 + 654);
    v27 = *((_WORD *)a4 + 1522);
    v23 = *((_QWORD *)a4 + 256);
    v24 = (void *)*((_QWORD *)a4 + 255);
    v17 = *((_DWORD *)a4 + 109);
    v18 = *((_DWORD *)a4 + 108);
    v19 = *((_DWORD *)a4 + 107);
    v20 = *((_DWORD *)a4 + 106);
