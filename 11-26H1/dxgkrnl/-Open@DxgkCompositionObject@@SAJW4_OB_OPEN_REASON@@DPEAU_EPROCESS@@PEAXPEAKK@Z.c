/*
 * XREFs of ?Open@DxgkCompositionObject@@SAJW4_OB_OPEN_REASON@@DPEAU_EPROCESS@@PEAXPEAKK@Z @ 0x140031BA0
 * Callers:
 *     <none>
 * Callees:
    ...
    || (v11 = PsGetProcessSessionIdEx(a3), v11 != -1) && v11 == *(_DWORD *)(a4 + 8) )
  {
    ...
    if ( v12 >= 0 )
    {
        ...
        if ( *CurrentThreadWin32Thread )
        {
                ...
                ProcessSessionId == (unsigned int)PsGetProcessSessionIdEx(CurrentThreadProcess)) )
          {
            if ( *(_DWORD *)(*v16 + 368LL) )
            {
              ...
              if ( (*(int (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304968LL) + 8LL))(*v16) <= 1 )
              {
                WdLogSingleEntry0(1LL);
      ...
      else if ( v32[0] )
      {
        ...
        (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)&DXGGLOBAL::m_pGlobal + 304968LL) + 16LL))(v32[0]);
      }
    }
  }
  else
