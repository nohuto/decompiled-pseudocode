/*
 * XREFs of ?VidMmGetAllocationGpuVirtualAddress@VIDMM_EXPORT@@QEAA_KPEBUVIDMM_MULTI_ALLOC@@_NI@Z @ 0x140046E90
 * Callers:
        ...
        unsigned int a4)
{
  ...
  v4 = a2;
  LOBYTE(a2) = a3;
  return (*(__int64 (__fastcall **)(const struct VIDMM_MULTI_ALLOC *, const struct VIDMM_MULTI_ALLOC *, _QWORD))(*((_QWORD *)this + 1) + 232LL))(
           v4,
           a2,
           a4);
}
