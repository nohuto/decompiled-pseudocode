/*
 * XREFs of ?VmBusSendSetRedirectedFlipFenceValue@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAU_DXGSHAREDSYNCOBJECT@@_K@Z @ 0x14018D4F4
 * Callers:
  ...
  if ( P[0] )
  {
    ...
    *((_QWORD *)v8 + 4) = a4;
    ...
    if ( v12 < 0 )
    {
      ...
      WdLogGlobalForLineNumber = 12211;
