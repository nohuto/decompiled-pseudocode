/*
 * XREFs of ?DpiBrightnessNotifyMonitorDimming@@YAJPEAU_DEVICE_OBJECT@@KE@Z @ 0x14024E434
 * Callers:
...
__int64 __fastcall DpiBrightnessNotifyMonitorDimming(struct _DEVICE_OBJECT *a1, int a2)
{
  ...
  if ( a2 == -1 )
  {
    v4 = *((_DWORD *)DeviceExtension + 905);
    if ( v4 == -1 )
      return (unsigned int)-1073741637;
  }
  KeEnterCriticalRegion();
  v6 = (struct _ERESOURCE *)(DeviceExtension + 3440);
  ExAcquireResourceSharedLite((PERESOURCE)(DeviceExtension + 3440), 1u);
  v7 = (_QWORD **)(DeviceExtension + 3600);
  v8 = *v7;
  while ( 1 )
  {
    v9 = v8;
    ...
    v10 = v8 - 4;
    v8 = (_QWORD *)*v8;
    if ( *v10 == 1 && *((_DWORD *)v9 - 2) == v4 )
    {
      v11 = (struct _DEVICE_OBJECT *)v9[2];
      if ( v11 )
