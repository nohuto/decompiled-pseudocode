/*
 * XREFs of ?SysMmCreateSectionPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKPEAU_OBJECT_ATTRIBUTES@@KPEAXW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x140287488
 * Callers:
 *     DxgkCreatePhysicalMemoryObjectCB @ 0x14003EF60 (DxgkCreatePhysicalMemoryObjectCB.c)
 *     SysMmTestCreateSectionPhysicalObject @ 0x14009D5D0 (SysMmTestCreateSectionPhysicalObject.c)
 * Callees:
        ...
        __int64 a11)
{
  ...
  {
    _InterlockedIncrement(&dword_140169714);
