/*
 * XREFs of ?Initialize@CContentResource@@IEAAJPEAUPresentationSurfaceInfo@@@Z @ 0x1400451FC
 * Callers:
 ...
 *     ??$FindProperty@UFlipContentHCompSurf@@@CFlipPropertySetBase@@QEAAXPEAPEAUFlipContentHCompSurf@@@Z @ 0x140045338 (--$FindProperty@UFlipContentHCompSurf@@@CFlipPropertySetBase@@QEAAXPEAPEAUFlipContentHCompSurf@@.c)
 ...
 *     ??$FindProperty@UPresentationSurfaceInfo@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentationSurfaceInfo@@@Z @ 0x1400A4A28 (--$FindProperty@UPresentationSurfaceInfo@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentationSurface.c)
 */
