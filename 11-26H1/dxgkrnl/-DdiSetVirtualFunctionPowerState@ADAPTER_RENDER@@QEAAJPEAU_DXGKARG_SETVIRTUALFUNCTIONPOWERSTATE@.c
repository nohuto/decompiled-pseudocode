/*
 * XREFs of ?DdiSetVirtualFunctionPowerState@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x14021B590
 * Callers:
 *     ?SetVirtualFunctionPowerState@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x14021F4A0 (-SetVirtualFunctionPowerState@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERST.c)
 * Callees:
        ...
        struct _DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5094);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                                 + 1048LL)
                                                                                     + 96LL))(
