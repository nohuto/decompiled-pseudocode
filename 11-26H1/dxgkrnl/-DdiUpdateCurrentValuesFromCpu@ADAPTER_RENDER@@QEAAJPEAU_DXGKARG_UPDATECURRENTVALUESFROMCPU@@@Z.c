/*
 * XREFs of ?DdiUpdateCurrentValuesFromCpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_UPDATECURRENTVALUESFROMCPU@@@Z @ 0x140072FA4
 * Callers:
 *     ADAPTER_RENDER_DdiUpdateCurrentValuesFromCpu @ 0x140074E30 (ADAPTER_RENDER_DdiUpdateCurrentValuesFromCpu.c)
 * Callees:
        ...
        struct _DXGKARG_UPDATECURRENTVALUESFROMCPU *a2)
{
  ...
  int v8; // esi
  __int64 (__fastcall *v9)(struct _DXGKARG_UPDATECURRENTVALUESFROMCPU *); // rax
  int v10; // edi
  KIRQL v11; // al
  __int64 v12; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v14, 5173);
  ...
  v9 = *(__int64 (__fastcall **)(struct _DXGKARG_UPDATECURRENTVALUESFROMCPU *))(*((_QWORD *)this + 2) + 1520LL);
  if ( v9 )
    v10 = v9(a2);
  else
    v10 = -1073741822;
