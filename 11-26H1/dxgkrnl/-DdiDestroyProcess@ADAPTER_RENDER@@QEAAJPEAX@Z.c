/*
 * XREFs of ?DdiDestroyProcess@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1403DF694
 * Callers:
 *     ADAPTER_RENDER_DdiDestroyProcess @ 0x140074C30 (ADAPTER_RENDER_DdiDestroyProcess.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyProcess(ADAPTER_RENDER *this, void *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5065);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 984LL))(
