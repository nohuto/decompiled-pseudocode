/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x14006FE34
 * Callers:
 *     wil_details_IsEnabledFallback @ 0x140067A54 (wil_details_IsEnabledFallback.c)
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14006FF3C (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x14006FF3C (wil_details_GetCurrentFeatureEnabledState.c)
