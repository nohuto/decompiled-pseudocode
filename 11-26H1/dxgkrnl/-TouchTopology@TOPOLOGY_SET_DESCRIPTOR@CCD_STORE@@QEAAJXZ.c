/*
 * XREFs of ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x140403C38
 * Callers:
 ...
 *     _anonymous_namespace_::_UpdateTimestampTopologySetCallback @ 0x140403C20 (_anonymous_namespace_--_UpdateTimestampTopologySetCallback.c)
 * Callees:
 *     <none>
 */
