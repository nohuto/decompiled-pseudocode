/*
 * XREFs of ?UpdateTrackedWorkload@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEBU_D3DKMT_UPDATETRACKEDWORKLOAD@@_K@Z @ 0x14020B2AC
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  __int64 v16; // rsi
  UINT64 FenceSubmissionValue; // r10
  UINT BeginTrackedWorkloadIndex; // r15d
  __int64 v19; // rdx
  char v20; // al
  ...
  if ( VBlankOffsetHundredsNS >= v8
    || (AbsoluteQPC_high = HIDWORD(a3->FinishDeadline.AbsoluteQPC), AbsoluteQPC_high >= v8)
...
LABEL_29:
  DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)v24, -1073741811LL, 0LL, 0LL, 0LL, 0LL);
LABEL_30:
