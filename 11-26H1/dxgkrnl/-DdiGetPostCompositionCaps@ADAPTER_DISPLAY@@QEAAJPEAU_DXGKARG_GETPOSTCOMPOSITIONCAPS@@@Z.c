/*
 * XREFs of ?DdiGetPostCompositionCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETPOSTCOMPOSITIONCAPS@@@Z @ 0x140392DA8
 * Callers:
        ...
        struct _DXGKARG_GETPOSTCOMPOSITIONCAPS *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5085);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETPOSTCOMPOSITIONCAPS *))(*((_QWORD *)this + 2) + 1232LL))(
