/*
 * XREFs of ?DdiQueryDiagnosticTypesSupport@DXGADAPTER@@QEAAJPEAU_DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT@@@Z @ 0x1401B0814
 * Callers:
        ...
        struct _DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5128);
  ...
  v10 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT *))this + 166))(
          *((_QWORD *)this + 36),
          a2);
  ...
  v14[6] = a2->NoninvasiveTypes.Notifications.Value;
  v14[7] = a2->InvasiveTypes.Notifications.Value;
