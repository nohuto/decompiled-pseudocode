/*
 * XREFs of ??0MONITOR_MGR@@QEAA@PEAVADAPTER_DISPLAY@@@Z @ 0x140005A40
 * Callers:
  ...
  *((_QWORD *)this + 86) = v6;
  if ( v6 )
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 86) + 20LL) = 0;
    ...
    v8 = (_QWORD *)qword_140168708;
    v9 = (_QWORD *)*((_QWORD *)this + 86);
    if ( *(struct _LIST_ENTRY **)qword_140168708 != &MONITOR_MGR::_MonitorPendingEventTraceHead )
      __fastfail(3u);
    v9[1] = qword_140168708;
    *v9 = &MONITOR_MGR::_MonitorPendingEventTraceHead;
    *v8 = v9;
    qword_140168708 = (__int64)v9;
