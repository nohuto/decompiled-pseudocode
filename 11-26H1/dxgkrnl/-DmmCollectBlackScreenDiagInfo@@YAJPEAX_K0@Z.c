/*
 * XREFs of ?DmmCollectBlackScreenDiagInfo@@YAJPEAX_K0@Z @ 0x14025970C
 * Callers:
...
__int64 __fastcall DmmCollectBlackScreenDiagInfo(DXGADAPTER *a1, size_t a2, void *a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( *((_QWORD *)a1 + 395) )
    {
      ...
      v7 = *(VIDPN_MGR **)(*((_QWORD *)a1 + 395) + 104LL);
      if ( v7 )
      {
        v9 = 0LL;
        v8 = VIDPN_MGR::AcquireDiagInfo(v7, (struct _KTHREAD **)a3, 0x2000uLL, 1, 0LL, &v9);
        if ( v8 == -2147483643 )
        {
          WdLogSingleEntry2(3LL, 0x2000LL, v9);
          result = 2147483653LL;
          WdLogGlobalForLineNumber = 13181;
        }
        else
        {
          if ( v8 < 0 )
