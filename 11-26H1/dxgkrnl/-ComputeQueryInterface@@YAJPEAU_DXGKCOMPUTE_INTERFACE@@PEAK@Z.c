/*
 * XREFs of ?ComputeQueryInterface@@YAJPEAU_DXGKCOMPUTE_INTERFACE@@PEAK@Z @ 0x140078930
 * Callers:
...
__int64 __fastcall ComputeQueryInterface(struct _DXGKCOMPUTE_INTERFACE *a1, unsigned int *a2)
{
  ...
  else if ( (_DWORD)v4 != 2 || *(_WORD *)a1 != 616 )
  {
LABEL_3:
    if ( (_WORD)v4 != 3 )
      v2 = 616LL;
    v5 = 3LL - ((_WORD)v4 != 3);
    WdLogSingleEntry4(1LL, v4, *(unsigned __int16 *)a1, v5, v2);
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      -1,
      (__int64)L"Interface mismatch between caller (0x%I64x, 0x%I64x) and Dxgkrnl (0x%I64x, 0x%I64x).",
      v7,
      v8,
      v5,
      v2,
  ...
  *((_QWORD *)a1 + 8) = NtDxgkResizeRingBuffer;
  ...
  *((_QWORD *)a1 + 15) = NtDxgkResizeRingBuffer;
