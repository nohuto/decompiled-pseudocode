/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14007B3A0
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1401665F0 > 4 && tlgKeywordOn((__int64)&dword_1401665F0, 0x200000000400LL) )
  {
    if ( tlgKeywordOn((__int64)&dword_1401665F0, v1) )
    {
      v6 = *(_WORD *)(v4 + 4);
      v7 = *(_DWORD *)(v4 + 40);
      v5 = v4;
