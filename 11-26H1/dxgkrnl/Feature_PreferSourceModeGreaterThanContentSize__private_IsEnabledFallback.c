/*
 * XREFs of Feature_PreferSourceModeGreaterThanContentSize__private_IsEnabledFallback @ 0x140067A1C
 * Callers:
...
__int64 __fastcall Feature_PreferSourceModeGreaterThanContentSize__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
