/*
 * XREFs of ?DdiSetNativeFenceLogBuffer@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETNATIVEFENCELOGBUFFER@@@Z @ 0x140072A68
 * Callers:
 *     ADAPTER_RENDER_DdiSetNativeFenceLogBuffer @ 0x140074D90 (ADAPTER_RENDER_DdiSetNativeFenceLogBuffer.c)
 * Callees:
        ...
        struct _DXGKARG_SETNATIVEFENCELOGBUFFER *a2)
{
  ...
  int v8; // esi
  __int64 (__fastcall *v9)(struct _DXGKARG_SETNATIVEFENCELOGBUFFER *); // rax
  int v10; // edi
  KIRQL v11; // al
  __int64 v12; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v14, 5174);
  ...
  v9 = *(__int64 (__fastcall **)(struct _DXGKARG_SETNATIVEFENCELOGBUFFER *))(*((_QWORD *)this + 2) + 1696LL);
  if ( v9 )
    v10 = v9(a2);
  else
    v10 = -1073741822;
