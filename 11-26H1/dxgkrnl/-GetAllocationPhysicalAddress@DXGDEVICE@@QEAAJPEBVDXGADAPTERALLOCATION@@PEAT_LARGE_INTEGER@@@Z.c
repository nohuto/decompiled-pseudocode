/*
 * XREFs of ?GetAllocationPhysicalAddress@DXGDEVICE@@QEAAJPEBVDXGADAPTERALLOCATION@@PEAT_LARGE_INTEGER@@@Z @ 0x1401C2E74
 * Callers:
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  if ( !ExIsResourceAcquiredSharedLite(*((PERESOURCE *)this + 17)) )
  {
    ...
    WdLogGlobalForLineNumber = 12094;
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockSharedOwner()", 12094LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  else
  {
    ...
    WdLogGlobalForLineNumber = 12107;
  }
  return v7;
}
