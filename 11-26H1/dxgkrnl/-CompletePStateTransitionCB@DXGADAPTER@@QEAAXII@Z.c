/*
 * XREFs of ?CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z @ 0x14006E854
 * Callers:
 ...
 *     ?RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z @ 0x140080208 (-RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z.c)
 */
...
void __fastcall DXGADAPTER::CompletePStateTransitionCB(DXGADAPTER *this, unsigned int a2, unsigned int a3)
{
  ...
  if ( *((_QWORD *)this + 409) )
  {
    v4 = (unsigned __int16)a2 + (unsigned int)*((unsigned __int16 *)this + ((unsigned __int64)a2 >> 16) + 1640);
    v5 = *(_QWORD *)(520 * v4 + *((_QWORD *)this + 408) + 512);
    if ( bTracingEnabled )
    {
