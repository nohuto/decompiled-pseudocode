/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1401B1500
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiSetPalette(ADAPTER_DISPLAY *this, const struct _DXGKARG_SETPALETTE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5017);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 552LL))(
