/*
 * XREFs of ?CollectDbgInfo@DXGADAPTER@@QEAAJPEAU_TDR_RECOVERY_CONTEXT@@PEAPEAXPEAI@Z @ 0x14019731C
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 10522LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *a4 < 0x438 )
    return 2147483653LL;
  v8 = (char *)*a3;
  ...
  *v11 = *v9;
  ...
  if ( v13 )
  {
    for ( i = 0LL;
          ...
          *(_OWORD *)&v8[8 * v16 + 824] = *(_OWORD *)(v15 + *(_QWORD *)&v13[1].ActiveCount + 628) )
    {
      v15 = 4024LL * (unsigned int)i;
      v16 = 2LL * (unsigned int)i;
      *(_QWORD *)&v8[8 * i + 600] = *(_QWORD *)(v15 + *(_QWORD *)&v13[1].ActiveCount + 728);
      *(_DWORD *)&v8[4 * i + 728] = *(_DWORD *)(v15 + *(_QWORD *)&v13[1].ActiveCount + 736);
      i = (unsigned int)(i + 1);
    }
  }
  v17 = this[396];
