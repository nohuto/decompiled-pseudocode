/*
 * XREFs of ?EnsureServerVmBusInterface@@YAJXZ @ 0x14041CCC8
 * Callers:
...
__int64 EnsureServerVmBusInterface(void)
{
  ...
  PDEVICE_OBJECT DeviceObject; // [rsp+C0h] [rbp+67h] BYREF
  PFILE_OBJECT FileObject; // [rsp+C8h] [rbp+6Fh] BYREF

  Global = DXGGLOBAL::GetGlobal();
  DXGPUSHLOCK::AcquireExclusive((struct DXGGLOBAL *)((char *)Global + 936));
  v1 = 0;
  if ( g_VgpuVmBusInterfaceRefCount )
  {
    ((void (__fastcall *)(__int64))qword_1401683F0)(qword_1401683E8);
    ++g_VgpuVmBusInterfaceRefCount;
    v2 = DXGGLOBAL::GetGlobal();
    *((_QWORD *)v2 + 118) = 0LL;
    ExReleasePushLockExclusiveEx((char *)v2 + 936, 0LL);
  }
  else
  {
    ...
    if ( DeviceObjectPointer >= 0 )
    {
      ...
      if ( v5 )
      {
        ...
        else
        {
          ...
          WdLogGlobalForLineNumber = 17074;
          DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"IoCallDriver failed: 0x%I64x", v9, 0LL, 0LL, 0LL, 0LL);
        }
      }
      else
      {
        WdLogSingleEntry1(2LL);
        WdLogGlobalForLineNumber = 17046;
    ...
    {
      WdLogSingleEntry1(2LL);
      WdLogGlobalForLineNumber = 17023;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
    ...
    *((_QWORD *)v10 + 118) = 0LL;
    ExReleasePushLockExclusiveEx((char *)v10 + 936, 0LL);
    v1 = v4;
  }
