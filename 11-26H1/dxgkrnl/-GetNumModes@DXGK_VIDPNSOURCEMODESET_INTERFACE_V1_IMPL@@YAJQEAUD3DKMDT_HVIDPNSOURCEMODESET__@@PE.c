/*
 * XREFs of ?GetNumModes@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEA_K@Z @ 0x1403E47C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 7000);
