/*
 * XREFs of ?DdiSetupPriorityBands@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1401B2894
 * Callers:
 *     ADAPTER_RENDER_DdiSetupPriorityBands @ 0x140074DF0 (ADAPTER_RENDER_DdiSetupPriorityBands.c)
 * Callees:
        ...
        const struct _DXGKARG_SETUPPRIORITYBANDS *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, const struct _DXGKARG_SETUPPRIORITYBANDS *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5115);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETUPPRIORITYBANDS *))(v9 + 1264);
  if ( v10 )
