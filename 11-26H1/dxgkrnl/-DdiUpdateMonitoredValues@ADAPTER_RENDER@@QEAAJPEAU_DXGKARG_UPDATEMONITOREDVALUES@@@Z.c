/*
 * XREFs of ?DdiUpdateMonitoredValues@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_UPDATEMONITOREDVALUES@@@Z @ 0x1400731F8
 * Callers:
 *     ADAPTER_RENDER_DdiUpdateMonitoredValues @ 0x140074E50 (ADAPTER_RENDER_DdiUpdateMonitoredValues.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiUpdateMonitoredValues(
        ADAPTER_RENDER *this,
        struct _DXGKARG_UPDATEMONITOREDVALUES *a2)
{
  ...
  int v8; // esi
  __int64 (__fastcall *v9)(struct _DXGKARG_UPDATEMONITOREDVALUES *); // rax
  int v10; // edi
  KIRQL v11; // al
  __int64 v12; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v14, 5172);
  ...
  v9 = *(__int64 (__fastcall **)(struct _DXGKARG_UPDATEMONITOREDVALUES *))(*((_QWORD *)this + 2) + 1512LL);
  if ( v9 )
    v10 = v9(a2);
  else
    v10 = -1073741822;
