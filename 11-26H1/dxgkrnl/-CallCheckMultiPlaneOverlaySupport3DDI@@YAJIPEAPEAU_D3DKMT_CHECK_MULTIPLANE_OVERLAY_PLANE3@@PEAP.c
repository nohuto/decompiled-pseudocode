/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport3DDI@@YAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1402A9514
 * Callers:
...
__int64 __fastcall CallCheckMultiPlaneOverlaySupport3DDI(
        ...
        int *a7,
        struct DXGK_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO::$3235B0AF7BF3D9B607A1C4FD103E9694::$7E5D53739D5A0755634D9029F4E2827E *a8)
{
  __int64 v8; // r13
  ...
  struct _D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3 *v15; // r14
...
LABEL_33:
    ...
    WdLogGlobalForLineNumber = 10106;
LABEL_34:
    if ( v41 != v42 && v41 )
