/*
 * XREFs of ?DdiQueryVirtualFunctionLuid@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z @ 0x14021A4A0
 * Callers:
 *     ?QueryVirtualFunctionLuid@DXGK_VIRTUAL_GPU_GPUP@@UEAAXPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z @ 0x14021F130 (-QueryVirtualFunctionLuid@DXGK_VIRTUAL_GPU_GPUP@@UEAAXPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z.c)
 * Callees:
        ...
        struct _DXGKARG_QUERYVIRTUALFUNCTIONLUID *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v12, 5096);
