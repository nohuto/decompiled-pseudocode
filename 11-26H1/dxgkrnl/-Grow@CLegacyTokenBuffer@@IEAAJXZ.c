/*
 * XREFs of ?Grow@CLegacyTokenBuffer@@IEAAJXZ @ 0x14003B290
 * Callers:
 ...
 * Callees:
 *     ?Create@TokenBlock@CLegacyTokenBuffer@@SAJAEAU12@PEAPEAU12@@Z @ 0x14003B2E4 (-Create@TokenBlock@CLegacyTokenBuffer@@SAJAEAU12@PEAPEAU12@@Z.c)
 */
