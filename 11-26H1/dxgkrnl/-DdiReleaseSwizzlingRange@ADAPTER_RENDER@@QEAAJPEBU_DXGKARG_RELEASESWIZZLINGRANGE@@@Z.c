/*
 * XREFs of ?DdiReleaseSwizzlingRange@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RELEASESWIZZLINGRANGE@@@Z @ 0x14040ABE8
 * Callers:
 *     ADAPTER_RENDER_DdiReleaseSwizzlingRange @ 0x1400636F0 (ADAPTER_RENDER_DdiReleaseSwizzlingRange.c)
 * Callees:
        ...
        const struct _DXGKARG_RELEASESWIZZLINGRANGE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5007);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_RELEASESWIZZLINGRANGE *))(*((_QWORD *)this + 2) + 512LL))(
