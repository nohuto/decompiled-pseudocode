/*
 * XREFs of ?LiveMigrationGetTransferSize@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@PEA_K@Z @ 0x140214DB4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::LiveMigrationGetTransferSize(__int64 a1, int a2, struct _LUID *a3, __int64 a4)
{
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"LiveMigrationGetTransferSize called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v7,
      v16,
