/*
 * XREFs of ?TriggerLowBoxActiveContextWNF@OUTPUTDUPL_SESSION_MGR@@AEAAJXZ @ 0x1401EF038
 * Callers:
...
__int64 __fastcall OUTPUTDUPL_SESSION_MGR::TriggerLowBoxActiveContextWNF(OUTPUTDUPL_SESSION_MGR *this)
{
  ...
  updated = ZwUpdateWnfStateData(&WNF_DX_MODERN_OUTPUTDUPLICATION_CONTEXTS, (char *)this + 128, 392LL);
  v3 = updated;
  if ( updated < 0 )
  {
