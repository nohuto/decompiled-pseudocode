/*
 * XREFs of ?_SerializeMonitorPresentEvent@MONITOR_MGR@@QEAAJPEA_KPEAU_DMM_MONITORPRESENCEEVENTSET_SERIALIZATION@@@Z @ 0x14027590C
 * Callers:
        ...
        struct _DMM_MONITORPRESENCEEVENTSET_SERIALIZATION *a3)
{
  ...
  v7 = *((_DWORD *)this + 50);
  v8 = 20;
  if ( v7 > 0x14 || (v8 = *((_DWORD *)this + 50), v7) )
    v9 = 24LL * (v8 - 1) + 32;
  else
    v9 = 32LL;
  if ( v9 <= *a2 && a3 )
    ...
    *(_BYTE *)a3 = v8;
    if ( v8 )
    {
      ...
      do
      {
        v11 = v3 - v8;
        ++v3;
        v12 = 3LL * ((*((_DWORD *)this + 50) + v11) % 0x14u);
        *v10 = *(_OWORD *)((char *)this + 8 * v12 + 208);
        v10 = (_OWORD *)((char *)v10 + 24);
        *((_QWORD *)v10 - 1) = *((_QWORD *)this + v12 + 28);
      }
      while ( v3 < v8 );
    }
    return 0LL;
