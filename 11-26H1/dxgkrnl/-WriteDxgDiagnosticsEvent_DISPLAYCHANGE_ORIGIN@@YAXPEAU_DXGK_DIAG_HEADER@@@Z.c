/*
 * XREFs of ?WriteDxgDiagnosticsEvent_DISPLAYCHANGE_ORIGIN@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x140061C50
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_DISPLAYCHANGE_ORIGIN(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1401665F0 > 4
    && (qword_140166600 & 0x200000000004LL) != 0
    && (qword_140166608 & 0x200000000004LL) == qword_140166608 )
  {
    if ( tlgKeywordOn((__int64)&dword_1401665F0, 0x200000000004LL) )
    {
      v5 = *(_WORD *)(v3 + 4);
      v6 = *(_DWORD *)(v3 + 40);
      v4 = v3;
