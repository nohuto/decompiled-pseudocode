/*
 * XREFs of ?ReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x140215914
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::ReadVirtualFunctionConfigBlock(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v5; // ebx
  ...
  {
    v9 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)VirtualGpuByIndex + 72LL))(VirtualGpuByIndex, a3);
  }
  else
  {
