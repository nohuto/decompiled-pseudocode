/*
 * XREFs of ?DdiDPI2CIoTransmission@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DPI2CIOTRANSMISSION@@@Z @ 0x1401AD170
 * Callers:
        ...
        struct _DXGKARG_DPI2CIOTRANSMISSION *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_DPI2CIOTRANSMISSION *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5152);
  ...
  if ( v9 && (v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_DPI2CIOTRANSMISSION *))(v9 + 56)) != 0LL )
