/*
 * XREFs of ?CollectIntrusiveDriverData@DRIVERWHITEBOXINFO@@QEAAJPEAVDXGADAPTER@@@Z @ 0x1401C9E60
 * Callers:
...
__int64 __fastcall DRIVERWHITEBOXINFO::CollectIntrusiveDriverData(DRIVERWHITEBOXINFO *this, ADAPTER_DISPLAY **a2)
{
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pDisplayAdapter != nullptr", 1610LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  for ( ; NextTarget; NextTarget = DMMVIDEOPRESENTTARGETSET::GetNextTarget((DMMVIDEOPRESENTTARGETSET *)v5, NextTarget) )
  {
    ...
    {
      v9 = 264LL * v7++;
      *(_DWORD *)((char *)this + v9 + 228) = *((_DWORD *)NextTarget + 6);
