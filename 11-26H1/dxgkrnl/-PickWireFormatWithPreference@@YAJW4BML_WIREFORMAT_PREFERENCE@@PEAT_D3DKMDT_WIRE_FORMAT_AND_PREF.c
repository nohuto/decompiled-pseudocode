/*
 * XREFs of ?PickWireFormatWithPreference@@YAJW4BML_WIREFORMAT_PREFERENCE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@11@Z @ 0x1403D7920
 * Callers:
...
__int64 __fastcall PickWireFormatWithPreference(int a1, _DWORD *a2, _DWORD *a3, int *a4)
{
  ...
  if ( *a4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pPickedWireFormat->Value == 0", 5724LL, 0LL, 0LL, 0LL, 0LL);
  }
  v13 = 0;
  v15 = 0;
  v17 = 0;
