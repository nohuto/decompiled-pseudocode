/*
 * XREFs of ?GetNumTargets@DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEA_K@Z @ 0x140263340
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v10, 6044);
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
