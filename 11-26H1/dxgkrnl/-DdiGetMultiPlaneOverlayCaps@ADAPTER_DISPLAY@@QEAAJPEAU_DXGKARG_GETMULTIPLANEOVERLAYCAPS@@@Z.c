/*
 * XREFs of ?DdiGetMultiPlaneOverlayCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETMULTIPLANEOVERLAYCAPS@@@Z @ 0x140393064
 * Callers:
        ...
        struct _DXGKARG_GETMULTIPLANEOVERLAYCAPS *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5084);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETMULTIPLANEOVERLAYCAPS *))(*((_QWORD *)this + 2) + 1224LL))(
  ...
  WdLogSingleEntry2(4LL, v9, a2->MaxPlanes);
