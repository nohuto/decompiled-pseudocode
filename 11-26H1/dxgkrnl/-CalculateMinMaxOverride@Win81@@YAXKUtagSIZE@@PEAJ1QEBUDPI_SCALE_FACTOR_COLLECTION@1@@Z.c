/*
 * XREFs of ?CalculateMinMaxOverride@Win81@@YAXKUtagSIZE@@PEAJ1QEBUDPI_SCALE_FACTOR_COLLECTION@1@@Z @ 0x1401E444C
 * Callers:
...
void __fastcall Win81::CalculateMinMaxOverride(Win81 *this, __int64 a2, struct tagSIZE a3, int *a4)
{
  ...
  *a4 = 0;
  ...
  {
    if ( dword_140108E50[i] == (_DWORD)this )
    {
      *(_DWORD *)a3.cx = -(int)i;
      for ( j = 4; j > (unsigned int)i; j = v8 - 1 )
      {
        v7 = dword_140108E50[j];
        LODWORD(v11) = 100 * v4 / v7;
        HIDWORD(v11) = 100 * v10 / v7;
        v12 = v11;
        if ( Win81::operator>=(&v12, dword_1400AC438) )
        {
          *v9 = v8 - i;
          return;
        }
