/*
 * XREFs of ?AcquireDdiSync@DXGADAPTER@@QEAAXW4DXGADAPTERDDISYNC_LEVEL@@@Z @ 0x14002F850
 * Callers:
...
char __fastcall DXGADAPTER::AcquireDdiSync(__int64 a1, int a2)
{
  ...
  if ( !v2
    || !*(_QWORD *)(v2 + 744)
    || (LOBYTE(CurrentThread) = (*(__int64 (**)(void))(*(_QWORD *)(*(_QWORD *)(v2 + 736) + 8LL) + 80LL))(),
        !(_BYTE)CurrentThread)
    && (CurrentThread = KeGetCurrentThread(), *(struct _KTHREAD **)(a1 + 3176) != CurrentThread) )
  {
