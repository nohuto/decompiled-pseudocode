/*
 * XREFs of ?DisplayID_GetVideoModeFromType7Desc@@YAJAEBU_DISPLAYID_DETAILED_TIMING_DESCRIPTOR@@AEAU_VideoModeDescriptor@@@Z @ 0x14009FB14
 * Callers:
...
LABEL_14:
            v16 = v3 / v15;
            a2->VerticalRefreshRateNumerator = v3 / v15;
            v17 = v13;
            v18 = v3;
            v19 = v17 / v15;
            v20 = v12;
            ...
            v20 = v18;
LABEL_20:
            a2->HorizontalRefreshRateNumerator = v3 / v20;
            a2->HorizontalRefreshRateDenominator = v12 / v20;
            if ( v4 != 1920 )
              return 0LL;
            if ( v5 != 540 )
              return 0LL;
