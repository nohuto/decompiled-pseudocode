/*
 * XREFs of ?DdiResetVirtualFunction@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETVIRTUALFUNCTION@@@Z @ 0x14021A92C
 * Callers:
        ...
        struct _DXGKARG_RESETVIRTUALFUNCTION *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5093);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETVIRTUALFUNCTION *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1048LL)
                                                                             + 88LL))(
