/*
 * XREFs of ?DdiConnectDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CONNECTDOORBELL@@@Z @ 0x1401ABA60
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiConnectDoorbell(ADAPTER_RENDER *this, struct _DXGKARG_CONNECTDOORBELL *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5163);
  ...
  v9 = (*(int (__fastcall **)(struct _DXGKARG_CONNECTDOORBELL *))(*((_QWORD *)this + 2) + 1536LL))(a2);
  ...
  if ( (_DWORD)v9 != -1073741822 && (_DWORD)v9 != -1073741801 && (_DWORD)v9 )
  {
