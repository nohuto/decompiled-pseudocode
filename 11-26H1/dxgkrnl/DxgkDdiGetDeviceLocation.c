/*
 * XREFs of DxgkDdiGetDeviceLocation @ 0x140216FA0
 * Callers:
...
void __fastcall DxgkDdiGetDeviceLocation(_QWORD *a1, __int64 a2, unsigned __int16 a3, _WORD *a4, _BYTE *a5, _BYTE *a6)
{
  __int64 v7; // rcx
  int v9; // ebp
  bool v10; // zf
  ...
  v16 = 0LL;
  LODWORD(v16) = a3;
  ADAPTER_RENDER::GetDeviceLocation(v7, a2, (unsigned int *)&v16, (__int64)a4);
