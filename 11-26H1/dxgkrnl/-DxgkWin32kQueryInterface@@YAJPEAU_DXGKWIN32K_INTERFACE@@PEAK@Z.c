/*
 * XREFs of ?DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z @ 0x1403C804C
 * Callers:
...
__int64 __fastcall DxgkWin32kQueryInterface(struct _DXGKWIN32K_INTERFACE *a1, unsigned int *a2)
{
  ...
  v2 = (unsigned __int16 *)((char *)a1 + 2);
  if ( *(_DWORD *)a1 == 3212088 )
  {
    *((_QWORD *)a1 + 2) = 0LL;
    ...
    *((_QWORD *)a1 + 87) = DxgkDDisplayEnumInternalLegacy;
    ...
    *((_QWORD *)a1 + 99) = &DxgkLogAndUpdateQDCCacheForDatabaseQuery;
    *((_QWORD *)a1 + 100) = DxgkQueryDatabaseFromQDCCache;
    *((_QWORD *)a1 + 101) = DxgkGetCurrentRapidHPDState;
    if ( (unsigned int)Feature_EnumDisplaySettings_PerfImprovements__private_IsEnabledDeviceUsageNoInline() )
      *((_QWORD *)a1 + 102) = DxgkPrepareModeListCache;
    *a2 = 824;
    return 0LL;
  }
  else
  {
    WdLogSingleEntry4(1LL, *v2, *(unsigned __int16 *)a1, 49LL, 824LL);
