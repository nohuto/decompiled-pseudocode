/*
 * XREFs of ?CheckMcdmDdiSubmission@DXGADAPTER@@AEAAJXZ @ 0x14007E5AC
 * Callers:
...
__int64 __fastcall DXGADAPTER::CheckMcdmDdiSubmission(DXGADAPTER *this)
{
  ...
  if ( v9 )
  {
    if ( !v16 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"DxgkDdiPatch is required.", 269LL, 0LL, 0LL, 0LL, 0LL);
      v10 = 0LL;
      v3 = 1;
    }
    if ( *((_QWORD *)this + 92) == v10 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"DxgkDdiRender is required.", 270LL, 0LL, 0LL, 0LL, 0LL);
      ++v3;
      v10 = 0LL;
    }
  ...
  else
  {
    if ( v16 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"DxgkDdiPatch is not used.", 275LL, 0LL, 0LL, 0LL, 0LL);
      v10 = 0LL;
    }
    if ( *((_QWORD *)this + 92) != v10 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"DxgkDdiRender is not used.", 276LL, 0LL, 0LL, 0LL, 0LL);
    }
