/*
 * XREFs of ?Cancel@DXGDEADLOCK_TRACKER@@QEAAXXZ @ 0x1402FE8A8
 * Callers:
...
void __fastcall DXGDEADLOCK_TRACKER::Cancel(DXGDEADLOCK_TRACKER *this)
{
  ...
  if ( _InterlockedCompareExchange((volatile signed __int32 *)this + 9, 0, 1) == 1 )
  {
    ...
    if ( (*((_BYTE *)this + 32) || *((_BYTE *)this + 33)) && (unsigned int)dword_140166660 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140166660, 0x400000004000LL) )
      {
        ...
        v10 = *(_DWORD *)(v6 + 3256);
        v11 = *(unsigned __int8 *)(v6 + 3093);
        v12 = *((unsigned __int8 *)this + 33);
        v13 = *(_DWORD *)(v6 + 4968);
        v14 = *(_DWORD *)(v6 + 4964);
        v25 = v7;
        v15 = *(unsigned __int8 *)(v6 + 209);
        v16 = *(unsigned __int8 *)(v6 + 2988);
        v17 = *(unsigned __int8 *)(v6 + 2983);
        v18 = *(_DWORD *)(v6 + 296);
        v31 = *(_WORD *)(v6 + 3044);
        v26 = *(_QWORD *)(v6 + 2048);
        v27 = *(void **)(v6 + 2040);
