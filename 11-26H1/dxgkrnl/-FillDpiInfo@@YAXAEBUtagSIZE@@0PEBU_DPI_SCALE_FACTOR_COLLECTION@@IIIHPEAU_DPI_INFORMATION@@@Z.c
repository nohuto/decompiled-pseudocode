/*
 * XREFs of ?FillDpiInfo@@YAXAEBUtagSIZE@@0PEBU_DPI_SCALE_FACTOR_COLLECTION@@IIIHPEAU_DPI_INFORMATION@@@Z @ 0x14005EE90
 * Callers:
 ...
 *     ?GetOptimalZoomPercentage@DpiInternal@@YA?AUtagSIZE@@IAEBU2@JPEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x14005F3F4 (-GetOptimalZoomPercentage@DpiInternal@@YA-AUtagSIZE@@IAEBU2@JPEBU_DPI_SCALE_FACTOR_COLLECTION@@@.c)
...
LABEL_20:
  ...
  DxgkLogInternalTriageEvent(
    ...
    262146,
    -1,
    (__int64)L"((Win8StyleDpiOverride != 0) && (PreferredScaleFactor == 0)) || ((Win8StyleDpiOverride == 0) && (PreferredS"
              "caleFactor != 0))",
    903LL,
    0LL,
    0LL,
