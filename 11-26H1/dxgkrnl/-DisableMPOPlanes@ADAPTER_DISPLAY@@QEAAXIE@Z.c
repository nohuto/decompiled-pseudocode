/*
 * XREFs of ?DisableMPOPlanes@ADAPTER_DISPLAY@@QEAAXIE@Z @ 0x140330244
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::DisableMPOPlanes(ADAPTER_DISPLAY *this, unsigned int a2, char a3)
{
  ...
  v4 = a2;
  v6 = *(_QWORD *)(*((_QWORD *)this + 2) + 3168LL);
  if ( v6 )
  {
    v7 = *(_QWORD *)(v6 + 16);
    for ( i = a3 == 0; i < *(_DWORD *)(v7 + 2984); ++i )
    {
      if ( ADAPTER_DISPLAY::IsPlaneEnabled(this, v4, i) )
      {
        ...
        *(_OWORD *)&v21.VidPnSourceId = 0LL;
        ...
        if ( (int)VIDSCH_EXPORT::VidSchSetVidPnSourceAddressWithMultiPlaneOverlay3(
                    *(VIDSCH_EXPORT **)(*(_QWORD *)(v12 + 3168) + 736LL),
                    *(struct _VIDSCH_GLOBAL **)(*(_QWORD *)(v12 + 3168) + 744LL),
                    &v21) < 0 )
        {
          WdLogSingleEntry3(2LL, i, v4, *((_QWORD *)this + 2));
          v15 = *((_QWORD *)this + 2);
          WdLogGlobalForLineNumber = 11134;
      ...
      v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 3168LL) + 16LL);
    }
    if ( a3 )
    {
    ...
    else if ( ADAPTER_DISPLAY::GetVidPnSourceOwner(this, v4) )
    {
      ...
      v14 = *((_QWORD *)VidPnSourceOwner + 237);
      if ( v14 == *(_QWORD *)(*((_QWORD *)VidPnSourceOwner + 2) + 16LL) )
        ADAPTER_DISPLAY::DisableOverlayPlanes(*(ADAPTER_DISPLAY **)(v14 + 3160), v4);
    }
  }
}
