/*
 * XREFs of ?DdiRecommendFunctionalVidPn@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDFUNCTIONALVIDPN@@@Z @ 0x1403EFBFC
 * Callers:
        ...
        struct _DXGKARG_RECOMMENDFUNCTIONALVIDPN *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5024);
  ...
  v11 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDFUNCTIONALVIDPN *))(*((_QWORD *)this + 2) + 624LL))(
  ...
  if ( a2->NumberOfVidPnTargets )
    v13 = *a2->pVidPnTargetPrioritizationVector;
  else
    v13 = 0;
  WdLogSingleEntry5(
    4LL,
  ...
  if ( (_DWORD)v11 != -1073741801
    && (_DWORD)v11 != -1071774941
    && (_DWORD)v11 != -1071774920
    && (_DWORD)v11 != -1071774664
    && (_DWORD)v11 )
  {
