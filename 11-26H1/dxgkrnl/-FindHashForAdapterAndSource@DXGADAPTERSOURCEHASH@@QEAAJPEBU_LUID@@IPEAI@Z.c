/*
 * XREFs of ?FindHashForAdapterAndSource@DXGADAPTERSOURCEHASH@@QEAAJPEBU_LUID@@IPEAI@Z @ 0x14032078C
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  v9 = AUTOEXPANDALLOCATION::GetActualBufferSize((DXGADAPTERSOURCEHASH *)((char *)v8 + 48)) >> 4;
  v10 = 1 << *((_DWORD *)v8 + 17);
  ...
  {
    v11 = 0;
    v12 = (struct DXGADAPTERSOURCEHASH::ADAPTERSOURCEHASH_ENTRY *)*((_QWORD *)v8 + 6);
  ...
  Entry = DXGADAPTERSOURCEHASH::FindEntry(v8, 0, 1, a2, 0LL);
  if ( Entry )
  {
    v12 = DXGADAPTERSOURCEHASH::AddEntry(v8, a2, a3, (*((_DWORD *)Entry + 3) >> 1) & 1);
    if ( v12 )
LABEL_25:
      *a4 = ((__int64)v12 - *((_QWORD *)v8 + 6)) >> 4;
    else
      v4 = -1073741801;
  }
  else
