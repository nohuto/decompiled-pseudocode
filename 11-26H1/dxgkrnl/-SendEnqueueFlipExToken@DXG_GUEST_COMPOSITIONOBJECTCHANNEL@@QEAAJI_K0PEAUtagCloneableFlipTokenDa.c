/*
 * XREFs of ?SendEnqueueFlipExToken@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@QEAAJI_K0PEAUtagCloneableFlipTokenData@@@Z @ 0x1401C0914
 * Callers:
        ...
        struct tagCloneableFlipTokenData *a5)
{
  ...
  signed __int64 v27; // [rsp+60h] [rbp-A8h] BYREF
  __int64 v28; // [rsp+68h] [rbp-A0h]
  _DWORD v29[4]; // [rsp+70h] [rbp-98h] BYREF
  __int64 v30; // [rsp+80h] [rbp-88h]
  __int64 v31; // [rsp+88h] [rbp-80h]
  _BYTE v32[456]; // [rsp+90h] [rbp-78h] BYREF
  ...
  *v10 = *(_OWORD *)a5;
  ...
  v10[3] = v21;
  *((_QWORD *)v10 + 8) = v22;
  v23 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *, __int64, signed __int64 *, unsigned int *))(**((_QWORD **)this + 1)
                                                                                               + 32LL))(
          *((_QWORD *)this + 1),
          v29,
          488LL,
...
LABEL_7:
  ...
  if ( (_DWORD)v28 != 10 )
  {
    WdLogSingleEntry2(3LL, (int)v28, -1073741823LL);
  ...
  if ( v27 < 0 )
  {
    WdLogSingleEntry2(3LL, SHIDWORD(v27), this);
