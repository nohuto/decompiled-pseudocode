/*
 * XREFs of ?DdiResumeContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RESUMECONTEXT@@@Z @ 0x1403BD1D0
 * Callers:
 *     ADAPTER_RENDER_DdiResumeContext @ 0x14005ECE0 (ADAPTER_RENDER_DdiResumeContext.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiResumeContext(ADAPTER_RENDER *this, const struct _DXGKARG_RESUMECONTEXT *a2)
{
  ...
  int v8; // r14d
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, const struct _DXGKARG_RESUMECONTEXT *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5119);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_RESUMECONTEXT *))(v9 + 1296);
  if ( v10 )
