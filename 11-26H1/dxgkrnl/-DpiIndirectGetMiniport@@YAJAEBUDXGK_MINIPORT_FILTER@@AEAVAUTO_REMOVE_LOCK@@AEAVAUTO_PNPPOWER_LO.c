/*
 * XREFs of ?DpiIndirectGetMiniport@@YAJAEBUDXGK_MINIPORT_FILTER@@AEAVAUTO_REMOVE_LOCK@@AEAVAUTO_PNPPOWER_LOCK@@PEAPEAU_FDO_CONTEXT@@@Z @ 0x140426148
 * Callers:
        ...
        struct _FDO_CONTEXT **a4)
{
  ...
  v8 = qword_140168E08;
  v9 = 0;
  if ( (__int64 *)qword_140168E08 == &qword_140168E08 )
    goto LABEL_33;
  do
  {
...
LABEL_26:
  ...
  while ( (__int64 *)v8 != &qword_140168E08 );
  v4 = v15;
