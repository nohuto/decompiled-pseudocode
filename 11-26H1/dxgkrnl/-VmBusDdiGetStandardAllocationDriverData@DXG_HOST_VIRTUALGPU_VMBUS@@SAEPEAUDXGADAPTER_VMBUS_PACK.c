/*
 * XREFs of ?VmBusDdiGetStandardAllocationDriverData@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x140225260
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_DWORD *)(v10 + 200) == 1 )
  {
    if ( v4[7] || (v16 = 0, v4[8]) )
    {
      ...
      *v7 = StandardAllocationDriverData;
      ...
      v16 = v4[7];
      if ( v24.AllocationPrivateDriverDataSize > v16 || v24.ResourcePrivateDriverDataSize > v4[8] )
      {
        WdLogSingleEntry0(3LL);
    ...
    v20 = ADAPTER_RENDER::DdiGetStandardAllocationDriverData(*(ADAPTER_RENDER **)(v10 + 3168), &v24);
    *v7 = v20;
    if ( v20 >= 0 )
    {
