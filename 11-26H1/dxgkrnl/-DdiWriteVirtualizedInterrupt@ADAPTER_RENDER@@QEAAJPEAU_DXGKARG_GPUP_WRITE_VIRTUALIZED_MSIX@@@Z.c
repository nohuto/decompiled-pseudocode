/*
 * XREFs of ?DdiWriteVirtualizedInterrupt@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_WRITE_VIRTUALIZED_MSIX@@@Z @ 0x1403C13E0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiWriteVirtualizedInterrupt(
        ADAPTER_RENDER *this,
        struct _DXGKARG_GPUP_WRITE_VIRTUALIZED_MSIX *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5187);
  ...
  v8 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_WRITE_VIRTUALIZED_MSIX *))(*((_QWORD *)this + 2) + 1656LL))(
  ...
  if ( (_DWORD)v8 != -1073741823 && (_DWORD)v8 != -1073741811 && (_DWORD)v8 )
  {
