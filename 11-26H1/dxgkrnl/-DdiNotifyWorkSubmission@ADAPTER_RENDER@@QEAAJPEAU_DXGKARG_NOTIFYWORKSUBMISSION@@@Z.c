/*
 * XREFs of ?DdiNotifyWorkSubmission@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_NOTIFYWORKSUBMISSION@@@Z @ 0x1401AFE18
 * Callers:
        ...
        struct _DXGKARG_NOTIFYWORKSUBMISSION *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5166);
  ...
  v9 = (*(int (__fastcall **)(struct _DXGKARG_NOTIFYWORKSUBMISSION *))(*((_QWORD *)this + 2) + 1560LL))(a2);
