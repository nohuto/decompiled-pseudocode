/*
 * XREFs of ?InitializeInterface@DXGK_VIDPNTARGETMODESET_INTERFACE_V2_IMPL@@YAXPEAU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x140266818
 * Callers:
...
void __fastcall DXGK_VIDPNTARGETMODESET_INTERFACE_V2_IMPL::InitializeInterface(
        ...
        struct _DXGK_VIDPNTARGETMODESET_INTERFACE *a2)
{
  ...
  *((_QWORD *)this + 6) = DXGK_VIDPNTARGETMODESET_INTERFACE_V2_IMPL::AddMode;
