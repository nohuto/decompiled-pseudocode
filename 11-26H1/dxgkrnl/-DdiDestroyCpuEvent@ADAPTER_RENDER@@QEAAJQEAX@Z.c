/*
 * XREFs of ?DdiDestroyCpuEvent@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401AD710
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyCpuEvent(ADAPTER_RENDER *this, void *const a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5159);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1480LL))(
