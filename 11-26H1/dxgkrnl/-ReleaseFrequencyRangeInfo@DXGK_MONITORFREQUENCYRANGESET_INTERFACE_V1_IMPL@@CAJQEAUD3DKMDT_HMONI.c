/*
 * XREFs of ?ReleaseFrequencyRangeInfo@DXGK_MONITORFREQUENCYRANGESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORFREQUENCYRANGESET__@@QEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x140273240
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _D3DKMDT_MONITOR_FREQUENCY_RANGE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 7026);
  ...
  *(_QWORD *)(v6 + 32) = a2;
  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      v13 = DxgMonitor::MonitorModes::_ReleaseMonitorFreqRangeEnumerator((DxgMonitor::MonitorModes *)v12, a2);
