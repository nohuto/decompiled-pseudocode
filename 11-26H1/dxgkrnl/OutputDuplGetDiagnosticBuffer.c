/*
 * XREFs of OutputDuplGetDiagnosticBuffer @ 0x14042A324
 * Callers:
...
__int64 __fastcall OutputDuplGetDiagnosticBuffer(struct DXGADAPTER *this, struct _D3DKMT_OUTPUTDUPL_DIAGNOSTICS *a2)
{
  ...
  unsigned int DiagnosticBuffer; // ebx
