/*
 * XREFs of ?FlushScheduler@ADAPTER_RENDER@@QEAAJW4DXGADAPTER_FLUSHSCHEDULER_REASON@@IH@Z @ 0x14030E4E4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::FlushScheduler(__int64 a1, int a2, unsigned int a3, int a4)
{
  ...
  v7 = a2;
  if ( *(_BYTE *)(v6 + 209) )
    return DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendFlushAdapter((struct DXG_VMBUS_CHANNEL_BASE *)(v6 + 4712), a2, a3);
  if ( *(int *)(v6 + 2776) >= 0x2000 || (v9 = 0, *(_BYTE *)(v6 + 3076)) )
    v9 = 1;
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
  {
    v24 = a3;
    v23 = a2;
    McTemplateK0pqq_EtwWriteTransfer(a1, (__int64)&Dxgk_FlushScheduler);
  }
...
LABEL_27:
    ...
    {
      LOBYTE(v10) = a4 != 0;
      (*(void (__fastcall **)(_QWORD, __int64, _QWORD, __int64, int, unsigned int))(*(_QWORD *)(*(_QWORD *)(a1 + 736)
                                                                                              + 8LL)
                                                                                  + 800LL))(
        *(_QWORD *)(a1 + 744),
        1LL,
...
LABEL_44:
  ...
  DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"Invalid flush reason!", 3002LL, 0LL, 0LL, 0LL, 0LL);
LABEL_45:
  ...
  v19 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(a1 + 736) + 8LL) + 48LL))(
          *(_QWORD *)(a1 + 744),
          v11);
  v20 = v19;
  if ( v11 >= 8 && v19 < 0 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NT_SUCCESS(Status)", 3025LL, 0LL, 0LL, 0LL, 0LL);
  }
  return v20;
}
