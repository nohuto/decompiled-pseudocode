/*
 * XREFs of DpiInitializeInternal @ 0x140085C18
 * Callers:
 *     DpiInitialize @ 0x140085C00 (DpiInitialize.c)
 *     DpiInitializeWin8 @ 0x140085CF0 (DpiInitializeWin8.c)
 * Callees:
