/*
 * XREFs of ??0DXGDEVICE@@QEAA@PEAVADAPTER_RENDER@@PEAUDXGK_VIRTUAL_GPU_PARAV@@PEAPEAUDXG_SET_GUEST_DATA@@U_D3DKMT_CREATEDEVICEFLAGS@@PEAVDXGPROCESS@@W4DXGDEVICECLIENT_TYPE@@PEAVDXGADAPTER@@EE@Z @ 0x140370E7C
 * Callers:
        ...
        char a10)
{
  ...
  *(_QWORD *)(a1 + 840) = a1 + 840;
  v18 = *(_QWORD *)(a1 + 1896);
  if ( v18 || (v18 = *(_QWORD *)(a2 + 16), *(_QWORD *)(v18 + 3160)) && (*(_QWORD *)(a1 + 1896) = v18) != 0LL )
  {
    if ( !*(_QWORD *)(v18 + 3160) )
    {
    ...
    *(_DWORD *)(a1 + 1904) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1896) + 3160LL) + 96LL);
  }
  *(_BYTE *)(a1 + 1916) = (*(_DWORD *)(a6 + 408) & 4) != 0;
  if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 16LL) + 3083LL) )
  {
    v19 = *(_QWORD *)(a1 + 40);
    *(_BYTE *)(a1 + 1919) = 1;
    *(_BYTE *)(v19 + 337) = 1;
