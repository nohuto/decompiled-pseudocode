/*
 * XREFs of ?Initialize@CAdapter@@IEAAJAEBUCSM_TOKEN_ADAPTER_INFO@@@Z @ 0x140036D6C
 * Callers:
...
__int64 __fastcall CAdapter::Initialize(CAdapter *this, const struct CSM_TOKEN_ADAPTER_INFO *a2)
{
  ...
  *((_QWORD *)this + 3) = *(_QWORD *)a2;
  ...
  if ( PresentHistoryReadyEvent >= 0 )
  {
    *((_DWORD *)this + 10) = v9;
    v7 = (void *)*((_QWORD *)a2 + 1);
    if ( !v7 || (PresentHistoryReadyEvent = CAdapter::UpdateRenderFence(this, v7), PresentHistoryReadyEvent >= 0) )
    {
