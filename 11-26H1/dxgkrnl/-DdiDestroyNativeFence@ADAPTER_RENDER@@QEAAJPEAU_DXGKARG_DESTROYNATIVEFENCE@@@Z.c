/*
 * XREFs of ?DdiDestroyNativeFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYNATIVEFENCE@@@Z @ 0x1401ADE80
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyNativeFence(ADAPTER_RENDER *this, struct _DXGKARG_DESTROYNATIVEFENCE *a2)
{
  ...
  int v8; // ebp
  __int64 (__fastcall *v9)(struct _DXGKARG_DESTROYNATIVEFENCE *); // rax
  int v10; // edi
  KIRQL v11; // al
  __int64 v12; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v14, 5171);
  ...
  v9 = *(__int64 (__fastcall **)(struct _DXGKARG_DESTROYNATIVEFENCE *))(*((_QWORD *)this + 2) + 1504LL);
  if ( v9 )
    v10 = v9(a2);
  else
    v10 = -1073741822;
