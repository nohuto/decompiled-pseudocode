/*
 * XREFs of ?DdiCancelFlips@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CANCELFLIPS@@@Z @ 0x140071120
 * Callers:
 *     ADAPTER_DISPLAY_DdiCancelFlips @ 0x140074A90 (ADAPTER_DISPLAY_DdiCancelFlips.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiCancelFlips(ADAPTER_DISPLAY *this, struct _DXGKARG_CANCELFLIPS *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_CANCELFLIPS *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5160);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_CANCELFLIPS *))(v9 + 1488);
  if ( v10 )
