/*
 * XREFs of DpiFdoWaitConnectionChangeComplete @ 0x140192278
 * Callers:
...
__int64 __fastcall DpiFdoWaitConnectionChangeComplete(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    {
      v3 = 1;
      if ( IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v2 + 64), DxgkQueryConnectionChanges, File, 1u, 0x20u) >= 0 )
      {
        ...
        if ( v3 )
        {
          ...
          WdLogGlobalForLineNumber = 18545;
        }
        else
        {
  ...
  else
  {
    v1 = -1073741811;
    WdLogSingleEntry1(2LL);
    WdLogGlobalForLineNumber = 18501;
  }
  return v1;
}
