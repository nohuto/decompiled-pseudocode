/*
 * XREFs of ?VidMmQueryProcessAdapterStatistics@VIDMM_EXPORT@@QEAAJPEAVVIDMM_GLOBAL@@GPEAVDXGPROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION@@@Z @ 0x140074340
 * Callers:
        ...
        struct _D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION *a5)
{
  ...
  return (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, _QWORD, __int64, struct _D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION *))(*((_QWORD *)this + 1) + 296LL))(
           a2,
           a3,
           v7,
           a5);
