/*
 * XREFs of ?NotifyDeferredDestructionComplete@ADAPTER_RENDER@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z @ 0x1403891A8
 * Callers:
 *     ADAPTER_RENDER_NotifyDeferredDestructionComplete @ 0x14004D4A0 (ADAPTER_RENDER_NotifyDeferredDestructionComplete.c)
 * Callees:
 *     <none>
 */
