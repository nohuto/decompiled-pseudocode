/*
 * XREFs of ?_GetMonitorDiagInfo@DXGMONITOR@@QEBAJPEAU_DXGK_DIAG_MONITOR_MGR_EXTRA_INFO@@@Z @ 0x1403E1C6C
 * Callers:
 ...
 *     ??$DxgkSafeConvertUnicodeToAnsi@$0O@@@YAXAEAY0O@$$CBGAEAY0O@D@Z @ 0x140190F20 (--$DxgkSafeConvertUnicodeToAnsi@$0O@@@YAXAEAY0O@$$CBGAEAY0O@D@Z.c)
 *     ??$DxgkSafeConvertUnicodeToAnsi@$04@@YAXAEAY04$$CBGAEAY04D@Z @ 0x140191638 (--$DxgkSafeConvertUnicodeToAnsi@$04@@YAXAEAY04$$CBGAEAY04D@Z.c)
 *     ??$DxgkSafeConvertUnicodeToAnsi@$03@@YAXAEAY03$$CBGAEAY03D@Z @ 0x14019182C (--$DxgkSafeConvertUnicodeToAnsi@$03@@YAXAEAY03$$CBGAEAY03D@Z.c)
 */
...
__int64 __fastcall DXGMONITOR::_GetMonitorDiagInfo(DXGMONITOR *this, struct _DXGK_DIAG_MONITOR_MGR_EXTRA_INFO *a2)
{
  ...
  *(_DWORD *)a2 = *((_DWORD *)this + 70);
  ...
  wistd::unique_ptr<DxgMonitor::IMonitorDescriptor,wistd::default_delete<DxgMonitor::IMonitorDescriptor>>::unique_ptr<DxgMonitor::IMonitorDescriptor,wistd::default_delete<DxgMonitor::IMonitorDescriptor>>(
    ...
    v5);
  if ( v7 )
    wistd::unique_ptr<CFlipManagerSignal,wistd::default_delete<CFlipManagerSignal>>::reset(v12, 0LL);
  if ( v6 )
  {
  ...
  *(_OWORD *)SourceString = 0LL;
  if ( v14[0] )
  {
    v11 = *(_QWORD *)(*((_QWORD *)this + 27) + 128LL) == 0LL;
    v14[1] = v17;
    v14[0] = 0x80000LL;
    *((_DWORD *)a2 + 1) = !v11;
