/*
 * XREFs of Feature_PreferSourceModeGreaterThanContentSize__private_IsEnabledDeviceUsageNoInline @ 0x14005B4BC
 * Callers:
 *     BmlCompareSourceModesWithContentRes @ 0x1402DF274 (BmlCompareSourceModesWithContentRes.c)
 * Callees:
 *     Feature_PreferSourceModeGreaterThanContentSize__private_IsEnabledFallback @ 0x140067A1C (Feature_PreferSourceModeGreaterThanContentSize__private_IsEnabledFallback.c)
 */
