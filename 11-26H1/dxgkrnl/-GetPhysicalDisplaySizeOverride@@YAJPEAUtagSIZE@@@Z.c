/*
 * XREFs of ?GetPhysicalDisplaySizeOverride@@YAJPEAUtagSIZE@@@Z @ 0x1401D48C0
 * Callers:
...
__int64 __fastcall GetPhysicalDisplaySizeOverride(struct tagSIZE *a1)
{
  ...
  if ( !a1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pPhysicalSizeOverride != NULL", 1202LL, 0LL, 0LL, 0LL, 0LL);
  }
  v3 = 0;
  v6 = 292;
  v9 = 67108868;
