/*
 * XREFs of ?AcquireTargetSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXPEAPEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEAPEBU_DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE@@@Z @ 0x1402621A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE **a4)
{
  ...
  __int64 v10; // rcx
  __int64 v11; // rdx
  struct D3DKMDT_HVIDEOPRESENTTARGETSET__ *v12; // r8
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v14, 6050);
  if ( !a2 )
  {
...
LABEL_19:
  ...
  v11 = *(_QWORD *)(v9 + 104);
  v12 = *(struct D3DKMDT_HVIDEOPRESENTTARGETSET__ **)(v11 + 472);
  _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v11 + 120) + 72LL));
  *a2 = *(_QWORD *)(v11 + 120) & -(__int64)(*(_QWORD *)(v11 + 120) != -112LL);
  *a3 = v12;
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v14);
  if ( v16 && (Microsoft_Windows_DxgKrnlEnableBits & 0x10000) != 0 )
