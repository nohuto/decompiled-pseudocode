/*
 * XREFs of DxgkAttemptOpmVmBusRedirect @ 0x1403BCA7C
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  v10 = 0;
  v17[0] = 0;
  v20 = *(_OWORD *)lambda_af43cb63713906f6ee9ac5c062dc4f06_::_lambda_af43cb63713906f6ee9ac5c062dc4f06_(
                     &v18,
                     (__int64)&v22,
                     (__int64)v17);
  DXGKCALLONEXIT__lambda_3fd80416dc5fb353b19afec3729b8d79_((__int64)v21, &v20);
  v12 = a8;
  *a8 = -1073741823;
  Global = DXGGLOBAL::GetGlobal();
  if ( DXGGLOBAL::IsVmConnectedToHost(Global) )
  {
    v14 = (DXG_GUEST_GLOBAL_VMBUS *)*((_QWORD *)DXGGLOBAL::GetGlobal() + 212);
    if ( v14 )
    {
      *(_QWORD *)&v20 = a1;
      v18 = 0LL;
