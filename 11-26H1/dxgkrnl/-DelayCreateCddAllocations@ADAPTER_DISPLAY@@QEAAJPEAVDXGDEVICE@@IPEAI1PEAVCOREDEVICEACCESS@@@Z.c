/*
 * XREFs of ?DelayCreateCddAllocations@ADAPTER_DISPLAY@@QEAAJPEAVDXGDEVICE@@IPEAI1PEAVCOREDEVICEACCESS@@@Z @ 0x1401A2764
 * Callers:
        ...
        struct COREDEVICEACCESS *a6)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceSharedOwner()", 1564LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(*((PERESOURCE **)this + 2)) )
  {
    if ( !a6 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pCoreAccess != NULL", 1585LL, 0LL, 0LL, 0LL, 0LL);
    }
  ...
  v15 = *(ADAPTER_DISPLAY **)(*((_QWORD *)this + 2) + 3160LL);
