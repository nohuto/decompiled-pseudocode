/*
 * XREFs of ?FindCopyProtection@ADAPTER_DISPLAY@@QEAAPEAVDXGCOPYPROTECTION@@IIPEAVDXGPROCESS@@@Z @ 0x1401A331C
 * Callers:
        ...
        struct DXGPROCESS *a4)
{
  ...
  for ( i = (struct DXGCOPYPROTECTION *)*((_QWORD *)this + 10); ; i = *(struct DXGCOPYPROTECTION **)i )
  {
    result = 0LL;
    if ( i != v4 )
      result = i;
