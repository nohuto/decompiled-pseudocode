/*
 * XREFs of ?LogDisplayTelemetryDiagData@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@W4DxgkrnlLiveDumpFailureReason@@@Z @ 0x1401CBB44
 * Callers:
...
void __fastcall DISPLAYSTATECHECKER::LogDisplayTelemetryDiagData(int *a1, struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a2)
{
  ...
  if ( (unsigned int)dword_140166660 > 5 && tlgKeywordOn((__int64)&dword_140166660, 0x400000000400LL) )
  {
    v5 = *a1;
    v17 = (const CHAR *)(a1 + 1);
    v15 = v4;
