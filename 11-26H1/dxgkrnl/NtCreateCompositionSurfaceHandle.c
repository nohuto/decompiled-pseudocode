/*
 * XREFs of NtCreateCompositionSurfaceHandle @ 0x14004DAC0
 * Callers:
 *     <none>
 * Callees:
 *     ?ObjectInit@CompositionSurfaceObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x14004DC60 (-ObjectInit@CompositionSurfaceObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionO.c)
...
__int64 __fastcall NtCreateCompositionSurfaceHandle(__int64 a1, ACCESS_MASK a2, void *a3)
{
  ...
  LOBYTE(v6) = 1;
  LOBYTE(v7) = 1;
  LocallyUniqueId = ObCreateObject(v7, g_pDxgkCompositionObjectType, a1, v6, 0LL, 208, 0, 0, &Object);
