/*
 * XREFs of ?_ReevaluateColorAndLuminanceSources@MonitorColorState@DxgMonitor@@AEAA_NXZ @ 0x140362598
 * Callers:
 ...
 *     ?SetMetadataOverrideForFlavor@MonitorColorState@DxgMonitor@@AEAAXW4_DISPLAYCONFIG_HDR_FLAVOR@@@Z @ 0x14027D684 (-SetMetadataOverrideForFlavor@MonitorColorState@DxgMonitor@@AEAAXW4_DISPLAYCONFIG_HDR_FLAVOR@@@Z.c)
 ...
 *     ??8CachedLuminanceData@MonitorColorState@DxgMonitor@@QEBA_NAEBU012@@Z @ 0x140362904 (--8CachedLuminanceData@MonitorColorState@DxgMonitor@@QEBA_NAEBU012@@Z.c)
 ...
 *     ??8CachedColorData@MonitorColorState@DxgMonitor@@QEBA_NAEBU012@@Z @ 0x140362EA4 (--8CachedColorData@MonitorColorState@DxgMonitor@@QEBA_NAEBU012@@Z.c)
 ...
 *     ??8CachedWireFormatData@MonitorColorState@DxgMonitor@@QEBA_NAEBU012@@Z @ 0x140363268 (--8CachedWireFormatData@MonitorColorState@DxgMonitor@@QEBA_NAEBU012@@Z.c)
...
LABEL_36:
  DxgMonitor::MonitorColorState::GetColorPrimariesType(v1 + 4);
  if ( DxgMonitor::MonitorColorState::EdidSupportsHDR(this) )
  {
    if ( v29 <= 1 )
  ...
  if ( !(unsigned __int8)DxgMonitor::MonitorColorState::CachedLuminanceData::operator==(&v33, v5) )
    DxgMonitor::MonitorColorState::SetLuminanceValuesWithBrightnessCompensation(this, 0xFFFFFFFF);
  if ( (unsigned __int8)DxgMonitor::MonitorColorState::CachedColorData::operator==(v34, v1)
    && (unsigned __int8)DxgMonitor::MonitorColorState::CachedLuminanceData::operator==(&v33, v5)
    && (unsigned __int8)DxgMonitor::MonitorColorState::CachedWireFormatData::operator==(v36, v3) )
  {
    return 0;
  }
