/*
 * XREFs of McTemplateK0pqxxpxx_EtwWriteTransfer @ 0x140068538
 * Callers:
...
NTSTATUS McTemplateK0pqxxpxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(SysMmControlGuid_Context, (const EVENT_DESCRIPTOR *)"\v", a3, 8u, &v4);
}
