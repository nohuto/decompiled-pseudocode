/*
 * XREFs of ?Invalidate@DXGDISPLAYMANAGEROBJECT@@QEAAXXZ @ 0x1403CD468
 * Callers:
...
void __fastcall DXGDISPLAYMANAGEROBJECT::Invalidate(DXGDISPLAYMANAGEROBJECT *this)
{
  ...
  _BYTE v3[16]; // [rsp+50h] [rbp-18h] BYREF

  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v3, (DXGDISPLAYMANAGEROBJECT *)((char *)this + 16), 0);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v3);
  if ( !*((_QWORD *)this + 9) )
  {
    WdLogSingleEntry0(1LL);
    WdLogGlobalForLineNumber = 606;
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_Object != nullptr", 606LL, 0LL, 0LL, 0LL, 0LL);
  }
  *((_QWORD *)this + 9) = 0LL;
  *((_BYTE *)this + 64) = 0;
  while ( *((DXGDISPLAYMANAGEROBJECT **)this + 13) != (DXGDISPLAYMANAGEROBJECT *)((char *)this + 104) )
  {
    v2 = (void (__fastcall ***)(_QWORD, __int64))Set<DXGTARGETENTRY>::Remove((__int64)this + 80);
    if ( !v2 )
    {
      WdLogSingleEntry0(1LL);
      WdLogGlobalForLineNumber = 614;
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pEntry", 614LL, 0LL, 0LL, 0LL, 0LL);
    }
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v3);
    DXGDISPLAYMANAGEROBJECT::ExchangeTargetOwnershipDmm(v2, 0LL, this, 0LL, 0);
    if ( v2 )
      (**v2)(v2, 1LL);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v3);
  }
  (*(void (__fastcall **)(char *))(*((_QWORD *)this + 10) + 24LL))((char *)this + 80);
