/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CCD_DATABASE_ACCESS@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1400611C8
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_CCD_DATABASE_ACCESS(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1401665F0 > 4
    && (qword_140166600 & 0x200000000040LL) != 0
    && (qword_140166608 & 0x200000000040LL) == qword_140166608 )
  {
    if ( tlgKeywordOn((__int64)&dword_1401665F0, 0x200000000040LL) )
    {
      v5 = *(_WORD *)(v3 + 4);
      v6 = *(_DWORD *)(v3 + 40);
      v4 = v3;
