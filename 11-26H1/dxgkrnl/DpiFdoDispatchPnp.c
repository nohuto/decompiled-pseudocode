/*
 * XREFs of DpiFdoDispatchPnp @ 0x1402408C0
 * Callers:
 *     <none>
 * Callees:
...
{
  __int64 DeviceExtension; // [rsp+30h] [rbp-78h]
  char v4; // [rsp+38h] [rbp-70h]
  int Status; // [rsp+3Ch] [rbp-6Ch]
  UCHAR MinorFunction; // [rsp+40h] [rbp-68h]
  POWER_STATE State; // [rsp+50h] [rbp-58h] BYREF
  unsigned int v8; // [rsp+54h] [rbp-54h]
  unsigned int v9; // [rsp+58h] [rbp-50h]
  POWER_STATE v10; // [rsp+5Ch] [rbp-4Ch]
  struct _IO_STACK_LOCATION *CurrentStackLocation; // [rsp+60h] [rbp-48h]
  ...
  switch ( MinorFunction )
  {
    case 0u:
      ...
      *(_DWORD *)(DeviceExtension + 280) = 1;
      v10.SystemState = PoSetPowerState(a1, DevicePowerState, State).SystemState;
    ...
    case 1u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_140168DD1 && (struct _DEVICE_OBJECT *)qword_140169080 == a1 || *(_BYTE *)(DeviceExtension + 480) )
      {
        v4 = 1;
        Status = -1073741823;
        WdLogSingleEntry3(2LL, a1, (unsigned __int8)byte_140168DD1, *(unsigned __int8 *)(DeviceExtension + 480));
    ...
    case 5u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_140168DD1 && !*(_BYTE *)(DeviceExtension + 481) || *(_BYTE *)(DeviceExtension + 480) )
      {
        v4 = 1;
        Status = -1073741823;
      }
    ...
    case 6u:
      ...
      {
        *(_DWORD *)(DeviceExtension + 236) = *(_DWORD *)(DeviceExtension + 240);
        v8 = *(_DWORD *)(DeviceExtension + 276) - 1;
        *(_DWORD *)(DeviceExtension + 276) = v8;
        *(_DWORD *)(DeviceExtension + 240) = *(_DWORD *)(DeviceExtension + 4LL * (v8 % 8) + 244);
      }
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiEnableD3Requests(*(_QWORD *)(DeviceExtension + 24));
      goto LABEL_81;
    case 9u:
        ...
        && (*(_DWORD *)(DeviceExtension + 20) == 2 || *(_DWORD *)(DeviceExtension + 20) == 3) )
      {
        ...
        IoForwardIrpSynchronously(*(PDEVICE_OBJECT *)(DeviceExtension + 160), a2);
        Status = a2->IoStatus.Status;
        qmemcpy((void *)(DeviceExtension + 1320), CurrentStackLocation->Parameters.Create.SecurityContext, 0x40uLL);
      }
      break;
    case 0x14u:
      v4 = 1;
