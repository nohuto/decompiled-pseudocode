/*
 * XREFs of ?Create@CDWMBackchannelManager@@SAJPEAU_KEVENT@@PEAPEAV1@@Z @ 0x140061130
 * Callers:
 *     ?Initialize@CFlipManager@@IEAAJPEAX@Z @ 0x14005E0A0 (-Initialize@CFlipManager@@IEAAJPEAX@Z.c)
 * Callees:
 *     ??2?$DXGQUOTAALLOCATOR@$0BAA@$0GNGCEDEG@@@SAPEAX_K@Z @ 0x14006119C (--2-$DXGQUOTAALLOCATOR@$0BAA@$0GNGCEDEG@@@SAPEAX_K@Z.c)
 *     ??0CBackchannelManager@@IEAA@PEAU_KEVENT@@@Z @ 0x1400A48FC (--0CBackchannelManager@@IEAA@PEAU_KEVENT@@@Z.c)
 */
