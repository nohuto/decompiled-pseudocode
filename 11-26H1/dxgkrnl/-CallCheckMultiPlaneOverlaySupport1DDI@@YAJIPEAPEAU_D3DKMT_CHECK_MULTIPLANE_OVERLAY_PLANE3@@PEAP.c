/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport1DDI@@YAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXPEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1403DC0BC
 * Callers:
...
LABEL_26:
    ...
    v20 = P;
    v21 = P == v26;
    WdLogGlobalForLineNumber = 10318;
    goto LABEL_18;
  }
  if ( (_DWORD)v8 )
  {
