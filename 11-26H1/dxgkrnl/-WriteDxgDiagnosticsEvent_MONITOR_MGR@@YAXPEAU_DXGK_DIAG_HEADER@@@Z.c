/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_MGR@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x14005C798
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_MGR(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304896) )
  {
    if ( (unsigned int)dword_1401665F0 > 1
      && tlgKeywordOn((__int64)&dword_1401665F0, 0x200000000020LL)
      && tlgKeywordOn((__int64)&dword_1401665F0, v6) )
    {
      v5 = &unk_140142CCD;
      goto LABEL_8;
    }
         ...
         && (qword_140166600 & 0x200000000020LL) != 0
         && (qword_140166608 & 0x200000000020LL) == qword_140166608
         && tlgKeywordOn((__int64)&dword_1401665F0, 0x200000000020LL) )
  {
    v5 = &unk_140142C99;
LABEL_8:
