/*
 * XREFs of ?SetVirtualFunctionPowerState@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x14021653C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::SetVirtualFunctionPowerState(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4)
{
  unsigned int v5; // ebx
  ...
  {
    v9 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 96LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
