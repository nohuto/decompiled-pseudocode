/*
 * XREFs of ?DdiSetPointerShape@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1402CEA60
 * Callers:
        ...
        const struct _DXGKARG_SETPOINTERSHAPE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5018);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPOINTERSHAPE *))(*((_QWORD *)this + 2) + 568LL))(
  ...
  v12[3] = v9;
  v12[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 288LL);
  v12[5] = a2->Flags.Value;
  v12[6] = a2->Width;
  v12[7] = a2->Height;
  WdLogGlobalForLineNumber = 2423;
  if ( (_DWORD)v9 != -1073741801 && (_DWORD)v9 != -1073741637 && (_DWORD)v9 )
  {
