/*
 * XREFs of DxgkPresentMultiPlaneOverlay @ 0x1401E7AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay(struct D3DKMT_PRESENT_MULTIPLANE_OVERLAY *Src)
{
  __int64 v2; // rcx
  __int64 v3; // rcx
  ...
  struct D3DKMT_MULTIPLANE_OVERLAY *v56[2]; // [rsp+90h] [rbp-78h] BYREF
  ...
  D3DKMT_PRESENT_MULTIPLANE_OVERLAY v65; // [rsp+148h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)v53, 2092);
  ...
  *(_OWORD *)v56 = 0LL;
  v52 = CapturePresentMultiPlaneOverlayArgs(Src, &v65, v56, (struct tagRECT **)&v56[1]);
  if ( v52 < 0 )
  {
...
LABEL_8:
  ...
  if ( v65.VidPnSourceId >= 0x10 )
  {
    ...
    v12 = v52;
    v14 = L"Invalid VidPnSoureId 0x%I64x specified in DxgkPresentMultiPlaneOverlay, returning 0x%I64x";
...
LABEL_53:
  ...
  if ( v52 >= 0 )
  {
    ...
    {
      v52 = DXGCONTEXT::PresentMultiPlaneOverlay(
              (DXGCONTEXT *)v16,
              &v65,
