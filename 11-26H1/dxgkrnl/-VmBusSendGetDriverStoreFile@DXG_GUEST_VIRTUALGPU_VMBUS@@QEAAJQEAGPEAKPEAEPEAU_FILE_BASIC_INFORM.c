/*
 * XREFs of ?VmBusSendGetDriverStoreFile@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJQEAGPEAKPEAEPEAU_FILE_BASIC_INFORMATION@@@Z @ 0x14022F3BC
 * Callers:
...
LABEL_12:
    ...
    WdLogGlobalForLineNumber = 13139;
    goto LABEL_13;
  }
  v11 = v18;
  if ( v18 < 0 )
