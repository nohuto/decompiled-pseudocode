/*
 * XREFs of ?VmBusQueryStatistics@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x14022AA70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 10) + 173LL) )
  {
    ...
    if ( v4 && !*(_QWORD *)(v4 + 40) )
    {
      *(_QWORD *)(v4 + 28) = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 10) + 16LL) + 412LL);
      ...
      StatisticsInternal = DxgkQueryStatisticsInternal((void *)(v5 + 24));
      v7 = 6LL;
