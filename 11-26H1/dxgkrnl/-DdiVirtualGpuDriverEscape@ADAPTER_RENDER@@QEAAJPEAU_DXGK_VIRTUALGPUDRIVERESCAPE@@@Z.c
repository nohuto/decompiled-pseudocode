/*
 * XREFs of ?DdiVirtualGpuDriverEscape@ADAPTER_RENDER@@QEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x14021BAB0
 * Callers:
 *     ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x14021F960 (-VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z.c)
 * Callees:
        ...
        struct _DXGK_VIRTUALGPUDRIVERESCAPE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5105);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGK_VIRTUALGPUDRIVERESCAPE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1064LL)
                                                                            + 112LL))(
