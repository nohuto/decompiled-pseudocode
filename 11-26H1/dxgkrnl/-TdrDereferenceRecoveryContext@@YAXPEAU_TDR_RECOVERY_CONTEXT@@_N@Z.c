/*
 * XREFs of ?TdrDereferenceRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1401D9128
 * Callers:
 ...
 *     ?Worker@CTDR_SUBMIT_REPORT_THREAD@@MEAAXXZ @ 0x1401DA350 (-Worker@CTDR_SUBMIT_REPORT_THREAD@@MEAAXXZ.c)
 * Callees:
 ...
 *     ?Start@CVP_SYSTEM_THREAD@@QEAAJXZ @ 0x1401D8AC0 (-Start@CVP_SYSTEM_THREAD@@QEAAJXZ.c)
