/*
 * XREFs of ?GetUniqueModes@MODE_UNION_LIST@@QEAAJ_KPEAU_D3DKMT_DISPLAYMODE@@PEAI@Z @ 0x140427760
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  __int64 result; // rax
  ULONG UserTime; // [rsp+70h] [rbp+8h] BYREF
  ...
  UserTime = 0;
  v11 = v10;
  v12 = KeQueryRuntimeThread(KeGetCurrentThread(), &UserTime);
  v13 = v12 - v11;
  if ( v11 > v12 )
    v13 = v12 - v11 - 1;
