/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333@Z @ 0x140001438
 * Callers:
        ...
        __int64 a8)
{
  ...
  v13 = 4LL;
  v11 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_1401665F0, a2, 0LL, 0LL, 6, v9);
}
