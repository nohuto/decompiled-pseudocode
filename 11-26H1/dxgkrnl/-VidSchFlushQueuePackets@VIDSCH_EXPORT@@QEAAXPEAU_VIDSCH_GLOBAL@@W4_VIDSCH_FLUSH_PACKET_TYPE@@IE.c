/*
 * XREFs of ?VidSchFlushQueuePackets@VIDSCH_EXPORT@@QEAAXPEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_PACKET_TYPE@@IE@Z @ 0x140055CB8
 * Callers:
...
__int64 __fastcall VIDSCH_EXPORT::VidSchFlushQueuePackets(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, char a5)
{
  ...
  v5 = a4;
  LOBYTE(a4) = a5;
  return (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)(a1 + 8) + 800LL))(a2, a3, v5, a4);
}
