/*
 * XREFs of Feature_DpiSetAdjustedColorimetryCoreAccess__private_IsEnabledFallback @ 0x1400679E4
 * Callers:
...
__int64 __fastcall Feature_DpiSetAdjustedColorimetryCoreAccess__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
