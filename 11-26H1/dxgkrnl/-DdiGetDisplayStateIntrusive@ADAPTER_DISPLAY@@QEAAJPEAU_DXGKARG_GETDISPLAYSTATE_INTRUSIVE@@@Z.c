/*
 * XREFs of ?DdiGetDisplayStateIntrusive@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDISPLAYSTATE_INTRUSIVE@@@Z @ 0x1401AF878
 * Callers:
        ...
        struct _DXGKARG_GETDISPLAYSTATE_INTRUSIVE *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_GETDISPLAYSTATE_INTRUSIVE *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5148);
  ...
  if ( v9 && (v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETDISPLAYSTATE_INTRUSIVE *))(v9 + 40)) != 0LL )
        ...
        v11 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"The driver failed DdiGetDisplayStateIntrusive. Status: 0x%I64x",
      v11,
      0LL,
      0LL,
      0LL,
