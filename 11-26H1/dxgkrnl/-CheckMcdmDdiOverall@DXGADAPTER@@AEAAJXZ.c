/*
 * XREFs of ?CheckMcdmDdiOverall@DXGADAPTER@@AEAAJXZ @ 0x14007CAE4
 * Callers:
  ...
  if ( (*((_DWORD *)this + 754) & 8) != 0 )
  {
    ...
    if ( (v2 & 8) == 0 && (v2 & 0x4000) == 0 )
    {
      ...
      if ( *((_QWORD *)this + 93) )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"DxgkDdiPresent is not used.", 143LL, 0LL, 0LL, 0LL, 0LL);
      }
      if ( *((_QWORD *)this + 169) )
      {
        WdLogSingleEntry0(2LL);
