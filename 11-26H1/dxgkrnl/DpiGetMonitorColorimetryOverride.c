/*
 * XREFs of DpiGetMonitorColorimetryOverride @ 0x140255CF8
 * Callers:
 *     ?GetDriverColorimetryOverride@KernelDriver@@UEBAJAEAU_DXGK_COLORIMETRY@@@Z @ 0x14027E8A0 (-GetDriverColorimetryOverride@KernelDriver@@UEBAJAEAU_DXGK_COLORIMETRY@@@Z.c)
 * Callees:
...
__int64 __fastcall DpiGetMonitorColorimetryOverride(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  *(_DWORD *)(a3 + 48) = 0;
  ...
  if ( !v9 )
  {
    ...
    v14.pInputData = &v15;
    v15 = a2;
    *(_QWORD *)&v14.Type = 19LL;
    *(_QWORD *)&v14.InputDataSize = 4LL;
