/*
 * XREFs of ??0DMMVIDPNPRESENTPATH@@QEAA@PEAVDMMVIDPNSOURCE@@PEAVDMMVIDPNTARGET@@W4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@G@Z @ 0x14004BDA4
 * Callers:
        ...
        unsigned __int16 a5)
{
  ...
  *((_DWORD *)this + 40) = 0;
  ...
  else
  {
    ...
    v12[3] = v5;
    v12[4] = *((unsigned int *)a2 + 6);
    v12[5] = *((unsigned int *)a3 + 6);
    v12[6] = -1071774908LL;
