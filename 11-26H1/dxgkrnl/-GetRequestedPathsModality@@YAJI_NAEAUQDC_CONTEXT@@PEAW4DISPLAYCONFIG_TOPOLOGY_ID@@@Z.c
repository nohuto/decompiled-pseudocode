/*
 * XREFs of ?GetRequestedPathsModality@@YAJI_NAEAUQDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x14031AF4C
 * Callers:
        ...
        enum DISPLAYCONFIG_TOPOLOGY_ID *a4)
{
  ...
  v26 = 0LL;
  v27 = 0LL;
  CCD_TOPOLOGY::Reserve((CCD_TOPOLOGY *)&v16, (unsigned __int16)v4);
  if ( v22 )
    v9 = *((_WORD *)v22 + 11);
  else
    v9 = 0;
