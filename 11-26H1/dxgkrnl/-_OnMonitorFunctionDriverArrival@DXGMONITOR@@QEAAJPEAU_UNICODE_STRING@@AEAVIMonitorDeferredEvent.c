/*
 * XREFs of ?_OnMonitorFunctionDriverArrival@DXGMONITOR@@QEAAJPEAU_UNICODE_STRING@@AEAVIMonitorDeferredEventSource@DxgMonitor@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1403E2194
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a4)
{
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(this, SourceString) + 24) = this;
  ...
  v7 = (struct _ERESOURCE *)*((_QWORD *)this + 27);
  LOBYTE(v22) = 0;
  ...
  *((_BYTE *)this + 177) = v12;
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 21) + 80LL))(*((_QWORD *)this + 21)) )
  {
    ...
    v15 = *((_QWORD *)this + 26);
    LODWORD(v22) = v14;
    if ( DxgMonitor::MonitorDataStore::TryReadData<unsigned long>(v15, 1LL, (__int64)L"PreferredScaleFactor", &v22) )
      v14 = (int)v22;
