/*
 * XREFs of ??0DXGAUTOADAPTERLISTLOCK@@QEAA@AEAVDXGADAPTERLISTLOCK@@@Z @ 0x14007B94C
 * Callers:
...
DXGAUTOADAPTERLISTLOCK *__fastcall DXGAUTOADAPTERLISTLOCK::DXGAUTOADAPTERLISTLOCK(
        DXGAUTOADAPTERLISTLOCK *this,
        struct DXGADAPTERLISTLOCK *a2)
{
  DXGAUTOADAPTERLISTLOCK *result; // rax
