/*
 * XREFs of ?GetMonitorIdFromTargetId@DpiPersistence@@YAJIAEBU_LUID@@PEAVVIDPN_MGR@@GPEAG@Z @ 0x140348140
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  {
    WdLogSingleEntry4(2LL, ConnectedMonitorHandle, v6, (int)a2[1], *a2);
    v17 = *a2;
    v16 = (int)a2[1];
  ...
  if ( v13 >= 0 )
  {
    if ( (int)v10 < 0 )
    {
      WdLogSingleEntry5(2LL, (int)v10, v6, v12, (int)a2[1], *a2);
      v21 = *a2;
      v19 = (int)a2[1];
  ...
  WdLogSingleEntry5(1LL, v13, v6, v12, (int)a2[1], *a2);
  v20 = *a2;
  v18 = (int)a2[1];
