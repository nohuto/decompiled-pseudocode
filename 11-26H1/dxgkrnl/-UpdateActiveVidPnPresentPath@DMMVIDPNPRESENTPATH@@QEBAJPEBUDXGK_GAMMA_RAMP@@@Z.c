/*
 * XREFs of ?UpdateActiveVidPnPresentPath@DMMVIDPNPRESENTPATH@@QEBAJPEBUDXGK_GAMMA_RAMP@@@Z @ 0x140385038
 * Callers:
 ...
 *     ?IsTargetCurrentActive@DMMVIDEOPRESENTTARGET@@QEBAEXZ @ 0x14005D5BC (-IsTargetCurrentActive@DMMVIDEOPRESENTTARGET@@QEBAEXZ.c)
        ...
        const struct DXGK_GAMMA_RAMP *a2)
{
  ...
  __int64 result; // rax
  _D3DKMDT_VIDPN_PRESENT_PATH v27; // [rsp+20h] [rbp-2F8h] BYREF
  _DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH v28; // [rsp+190h] [rbp-188h] BYREF
  ...
  if ( !DMMVIDEOPRESENTTARGET::IsTargetCurrentActive(*(DMMVIDEOPRESENTTARGET **)(*((_QWORD *)this + 12) + 96LL)) )
    return 0LL;
  memset(&v28.VidPnPresentPathInfo.VidPnTargetId, 0, 0x164uLL);
  memset(&v27, 0, sizeof(v27));
  DMMVIDPNPRESENTPATH::Serialize(this, &v27);
  v7 = &v28;
  v8 = (D3DDDI_GAMMA_RAMP_RGB256x3x16 *)*((_QWORD *)a2 + 4);
  v9 = &v27;
  *(_OWORD *)&v27.GammaRamp.Type = *((_OWORD *)a2 + 1);
  v27.GammaRamp.Data.pRgb256x3x16 = v8;
  v10 = 2LL;
  do
  {
  ...
  *(_QWORD *)&v7->VidPnPresentPathInfo.CopyProtection.OEMCopyProtection[20] = v23;
  v28.VidPnPresentPathInfo.ContentTransformation.Rotation = DMMVIDPNPRESENTPATH::GetContentRotationHw(this);
  updated = ADAPTER_DISPLAY::DdiUpdateActiveVidPnPresentPath(v6, &v28);
  v25 = updated;
  if ( updated >= 0 )
    return 0LL;
