/*
 * XREFs of ?CreatePagingQueue@DXGDEVICE@@QEAAJIW4D3DDDI_PAGINGQUEUE_PRIORITY@@PEAPEAVDXGPAGINGQUEUE@@@Z @ 0x140350624
 * Callers:
        ...
        struct DXGPAGINGQUEUE **a4)
{
  ...
  if ( !*((_BYTE *)this + 72) && !ExIsResourceAcquiredExclusiveLite(*((PERESOURCE *)this + 17)) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockExclusiveOwner()", 8455LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( !a4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"PagingQueue != NULL", 8457LL, 0LL, 0LL, 0LL, 0LL);
  }
...
LABEL_11:
      ...
      *(_OWORD *)v21 = 0LL;
      ...
      LODWORD(v10) = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendCreatePagingQueue(
                       (DXG_GUEST_VIRTUALGPU_VMBUS *)(v10 + 4712),
                       HostProcess,
                       v16,
                       &v20,
