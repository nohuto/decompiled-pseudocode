/*
 * XREFs of Feature_HdrBrightnessPolicy__private_IsEnabledFallback @ 0x140067894
 * Callers:
...
__int64 __fastcall Feature_HdrBrightnessPolicy__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
