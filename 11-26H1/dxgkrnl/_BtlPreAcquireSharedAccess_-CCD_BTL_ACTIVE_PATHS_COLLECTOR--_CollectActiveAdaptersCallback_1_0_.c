/*
 * XREFs of _BtlPreAcquireSharedAccess_&CCD_BTL_ACTIVE_PATHS_COLLECTOR::_CollectActiveAdaptersCallback_1_0_ @ 0x1404055A0
 * Callers:
 *     <none>
 * Callees:
        ...
        CCD_BTL_ACTIVE_PATHS_COLLECTOR *a2)
{
  ...
  if ( !v5 || !*(_QWORD *)(v5 + 432) || *((_DWORD *)this + 50) != 1 )
    goto LABEL_2;
  v7 = *(VIDPN_MGR **)(*((_QWORD *)this + 395) + 104LL);
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64 *)&v21, (__int64)v7);
...
LABEL_2:
  ...
  v9 = COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v26, 0LL);
  if ( v9 < 0 )
  {
    if ( v9 == -1073741130 )
    {
  ...
  v21 = 0LL;
  ClientVidPnFromLastClientCommitedVidPn = VIDPN_MGR::CreateClientVidPnFromLastClientCommitedVidPn(v13, (__int64 *)&v21);
  v15 = ClientVidPnFromLastClientCommitedVidPn;
  if ( ClientVidPnFromLastClientCommitedVidPn < 0 )
  {
    v18 = *((unsigned int *)VIDPN_MGR::GetContainingAdapter(v13) + 103);
    ContainingAdapter = VIDPN_MGR::GetContainingAdapter(v13);
    WdLogSingleEntry5(2LL, v15, v13, *(_QWORD *)(*(_QWORD *)a2 + 64LL), *((int *)ContainingAdapter + 104), v18);
  ...
  v16 = v21;
  LODWORD(v15) = CCD_BTL_ACTIVE_PATHS_COLLECTOR::_ProcessVidPn(a2, v21, 1);
  if ( (int)v15 < 0 )
  {
  ...
  if ( v16 )
  {
    v17 = (struct DMMVIDPN *)((char *)v16 + 24);
LABEL_17:
