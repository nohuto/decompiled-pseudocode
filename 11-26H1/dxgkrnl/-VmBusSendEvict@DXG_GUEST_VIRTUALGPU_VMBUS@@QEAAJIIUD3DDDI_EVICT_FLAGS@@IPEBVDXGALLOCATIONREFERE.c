/*
 * XREFs of ?VmBusSendEvict@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIUD3DDDI_EVICT_FLAGS@@IPEBVDXGALLOCATIONREFERENCE@@PEA_K@Z @ 0x14022ED2C
 * Callers:
        ...
        unsigned __int64 *a7)
{
  ...
  if ( a5 - 1 > 0x7FFF )
  {
    ...
    WdLogGlobalForLineNumber = 12229;
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"NumAllocation is invalid", 12229LL, 0LL, 0LL, 0LL, 0LL);
    return 0LL;
  }
  else
  {
    ...
    if ( (_QWORD)v19 )
    {
      ...
      *(_DWORD *)(v11 + 32) = a5;
      ...
      if ( v17 < 0 || (v17 = -1073741823, v18[0] < 8) )
      {
        ...
        WdLogGlobalForLineNumber = 12262;
    ...
    else
    {
      ...
      WdLogGlobalForLineNumber = 12237;
      DxgkLogInternalTriageEvent(
        0LL,
        262145,
        -1,
