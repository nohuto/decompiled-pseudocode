/*
 * XREFs of TdrTimedOperationAllowToDebugTimeout @ 0x14007AC2C
 * Callers:
 ...
 * Callees:
 *     ?TdrValidateDebugMode@@YAXXZ @ 0x14007ABEC (-TdrValidateDebugMode@@YAXXZ.c)
 */
...
__int64 __fastcall TdrTimedOperationAllowToDebugTimeout(struct _DXGK_TIMED_OPERATION *a1)
{
  ...
  if ( (byte_140168AD4 || (unsigned __int8)WdQueryDebugFlag(0LL)) && !g_TdrDebugMode )
  {
    if ( v7 )
