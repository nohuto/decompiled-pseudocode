/*
 * XREFs of ?DdiCancelQueuedFlips@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CANCELQUEUEDFLIPS@@@Z @ 0x14007137C
 * Callers:
 *     ADAPTER_DISPLAY_DdiCancelQueuedFlips @ 0x140074AB0 (ADAPTER_DISPLAY_DdiCancelQueuedFlips.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiCancelQueuedFlips(ADAPTER_DISPLAY *this, struct _DXGKARG_CANCELQUEUEDFLIPS *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5156);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CANCELQUEUEDFLIPS *))(*((_QWORD *)this + 2) + 1424LL))(
