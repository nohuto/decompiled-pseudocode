/*
 * XREFs of ?GetMonitorAndLinkHdrCapable@MonitorColorState@DxgMonitor@@QEBAXAEBU_DXGK_MONITORLINKINFO@@AEATMONITOR_AND_LINK_HDR_CAPS@@PEAW4MonitorAndLinkHDRIncapableReason@@@Z @ 0x140362FC8
 * Callers:
        ...
        enum MonitorAndLinkHDRIncapableReason *a4)
{
  ...
  bool v17; // zf
  DXGK_MONITORLINKINFO_CAPABILITIES v18; // r10d
  BOOL v19; // ebp
  int v20; // ecx
  int v21; // r10d
  ...
  if ( (*(int (__fastcall **)(__int64))(*(_QWORD *)v8 + 8LL))(v8) < 2500 )
  {
    ...
    v11 = 4;
    v19 = (*(_BYTE *)&v18.0 & 4) != 0 && DxgMonitor::MonitorColorState::EdidSupportsHDR(this);
    v16 = (v19 | *(_DWORD *)a3 & 0xFFFFFFFE) ^ ((v19 | *(_BYTE *)a3 & 0xFE) ^ *((_BYTE *)&v18.0 + 1)) & 2;
    v17 = (*(_WORD *)&v18.0 & 0x400) == 0;
    goto LABEL_12;
  }
  v9 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)this + 32LL))(*(_QWORD *)this);
  (*(void (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v9 + 40LL))(v9, &v22);
  v10 = v22;
  v11 = 4;
  if ( (v22 & 4) == 0 && (v22 & 8) == 0 || (*(_BYTE *)&a2->Capabilities.0 & 4) == 0 )
    goto LABEL_4;
