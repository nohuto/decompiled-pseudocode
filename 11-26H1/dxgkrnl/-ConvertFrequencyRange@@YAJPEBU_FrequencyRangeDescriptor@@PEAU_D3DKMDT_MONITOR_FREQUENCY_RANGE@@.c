/*
 * XREFs of ?ConvertFrequencyRange@@YAJPEBU_FrequencyRangeDescriptor@@PEAU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x140060984
 * Callers:
 ...
 *     ConvertMonitorFrequencyRangeType @ 0x14006CBB4 (ConvertMonitorFrequencyRangeType.c)
