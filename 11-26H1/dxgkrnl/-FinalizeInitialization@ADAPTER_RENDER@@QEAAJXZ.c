/*
 * XREFs of ?FinalizeInitialization@ADAPTER_RENDER@@QEAAJXZ @ 0x1401A7344
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::FinalizeInitialization(ADAPTER_RENDER *this)
{
  ...
  v4 = DXGPROCESS::OpenAdapter(*((DXGPROCESS **)Global + 173), this, 1);
  if ( v4 >= 0 )
  {
    result = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 95) + 8LL) + 808LL))(*((_QWORD *)this + 96));
    v4 = result;
    if ( (int)result >= 0 )
      return result;
