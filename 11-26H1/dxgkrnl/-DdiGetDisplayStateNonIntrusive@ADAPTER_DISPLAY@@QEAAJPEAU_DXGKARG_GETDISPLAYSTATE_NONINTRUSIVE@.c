/*
 * XREFs of ?DdiGetDisplayStateNonIntrusive@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE@@@Z @ 0x1401AFB48
 * Callers:
        ...
        struct _DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5147);
  ...
  v9 = *(_QWORD *)(*((_QWORD *)this + 2) + 1448LL);
  if ( v9 && (v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE *))(v9 + 32)) != 0LL )
