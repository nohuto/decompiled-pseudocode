/*
 * XREFs of ?_CopyMonitorInformation@DXGMONITOR@@QEAAJAEBVMONITOR_REF_ACCESSOR@@@Z @ 0x14018D950
 * Callers:
...
__int64 __fastcall DXGMONITOR::_CopyMonitorInformation(DXGMONITOR *this, const struct MONITOR_REF_ACCESSOR *a2)
{
  ...
  __int64 v9; // rdx
  void *v10; // rcx
  DxgMonitor::MonitorModes *v11; // rcx
  struct _ERESOURCE **v12; // rax
  struct _ERESOURCE *v13; // rdx
  DxgMonitor::MonitorModes *v15; // [rsp+30h] [rbp+8h] BYREF
