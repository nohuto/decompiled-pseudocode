/*
 * XREFs of _lambda_eaecb3877008d04769bbc086d157a70f_::operator() @ 0x1401A9EF4
 * Callers:
 *     _DXGKCALLONEXIT__lambda_eaecb3877008d04769bbc086d157a70f____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT @ 0x140070FA0 (_DXGKCALLONEXIT__lambda_eaecb3877008d04769bbc086d157a70f____--_2_--DXGKCALLONEXIT--_DXGKCALLONEX.c)
 * Callees:
...
char __fastcall lambda_eaecb3877008d04769bbc086d157a70f_::operator()(unsigned int **a1)
{
  ...
  v1 = *a1;
  if ( **a1 == 2303131 && (unsigned int)dword_1401665B8 > 5 )
  {
    LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1401665B8, 0x400000000400LL);
    v3 = 0LL;
    if ( (_BYTE)v1 )
    {
