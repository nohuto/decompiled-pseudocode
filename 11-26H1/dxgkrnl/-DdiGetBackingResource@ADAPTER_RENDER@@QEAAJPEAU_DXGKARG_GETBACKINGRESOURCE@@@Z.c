/*
 * XREFs of ?DdiGetBackingResource@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETBACKINGRESOURCE@@@Z @ 0x140219044
 * Callers:
 *     ?GetBackingResource@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETBACKINGRESOURCE@@@Z @ 0x14021E730 (-GetBackingResource@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETBACKINGRESOURCE@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiGetBackingResource(ADAPTER_RENDER *this, struct _DXGKARG_GETBACKINGRESOURCE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5137);
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETBACKINGRESOURCE *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                           + 1072LL)
                                                                               + 32LL))(
