/*
 * XREFs of ?DdiQueryDependentEngineGroup@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYDEPENDENTENGINEGROUP@@@Z @ 0x140071F8C
 * Callers:
 *     ADAPTER_RENDER_DdiQueryDependentEngineGroup @ 0x140074CB0 (ADAPTER_RENDER_DdiQueryDependentEngineGroup.c)
 * Callees:
        ...
        struct _DXGKARG_QUERYDEPENDENTENGINEGROUP *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5049);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDEPENDENTENGINEGROUP *))(*((_QWORD *)this + 2) + 808LL))(
  ...
  v13[6] = a2->DependentNodeOrdinalMask;
