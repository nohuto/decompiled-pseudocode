/*
 * XREFs of DpiLiveMigrationWaitForFence @ 0x14008697C
 * Callers:
...
__int64 __fastcall DpiLiveMigrationWaitForFence(void *a1, struct _IRP *a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( v7 < 0 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"LiveMigrationWaitForFence failed - kernel event object creation failed. Status = 0x%I64p",
      v8,
      0LL,
      0LL,
      0LL,
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( (int)v8 < 0 )
      {
        ...
        DxgkLogInternalTriageEvent(
          ...
          0x40000,
          -1,
          (__int64)L"Failed to wait for the Live Migration Fence",
          3592LL,
          0LL,
          0LL,
          0LL,
