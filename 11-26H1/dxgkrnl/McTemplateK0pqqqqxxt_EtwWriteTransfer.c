/*
 * XREFs of McTemplateK0pqqqqxxt_EtwWriteTransfer @ 0x140055DBC
 * Callers:
...
NTSTATUS McTemplateK0pqqqqxxt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 8LL;
  v20 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &DevicePresentStateEvent, a3, 9u, &v4);
}
