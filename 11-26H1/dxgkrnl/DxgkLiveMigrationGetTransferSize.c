/*
 * XREFs of DxgkLiveMigrationGetTransferSize @ 0x140218798
 * Callers:
...
__int64 __fastcall DxgkLiveMigrationGetTransferSize(_QWORD *a1, int a2, struct _LUID *a3, __int64 *a4)
{
  ...
  TransferSize = (int)ADAPTER_RENDER::LiveMigrationGetTransferSize(a1[396], a2, a3, (__int64)a4);
  if ( bTracingEnabled )
  {
    LowPart = a3->LowPart;
    ...
    DxgkLogInternalTriageEvent(
      ...
      196629,
      -1,
      (__int64)L"DxgkLiveMigrationGetTransferSize called with status %1 and transfer size %2",
      TransferSize,
      *a4,
      0LL,
      0LL,
