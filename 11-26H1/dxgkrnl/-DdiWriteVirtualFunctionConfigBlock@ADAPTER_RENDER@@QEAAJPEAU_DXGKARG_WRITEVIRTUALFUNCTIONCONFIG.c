/*
 * XREFs of ?DdiWriteVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x14021BFEC
 * Callers:
 *     ?WriteVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x14021F9A0 (-WriteVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_WRITEVIRTUALFUNCTIONCO.c)
 * Callees:
        ...
        struct _DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5088);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1048LL)
                                                                                        + 56LL))(
