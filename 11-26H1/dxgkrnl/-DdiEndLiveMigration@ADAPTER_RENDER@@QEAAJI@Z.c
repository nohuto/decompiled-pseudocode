/*
 * XREFs of ?DdiEndLiveMigration@ADAPTER_RENDER@@QEAAJI@Z @ 0x1403FAA44
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiEndLiveMigration(ADAPTER_RENDER *this, unsigned int a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5182);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)this + 2) + 1632LL))(
