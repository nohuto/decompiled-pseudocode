/*
 * XREFs of ?DdiUpdateMonitorLinkInfo@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z @ 0x1401B3070
 * Callers:
 *     ?UpdateMonitorLinkInfo@KernelDriver@@UEAAJAEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z @ 0x14027EB00 (-UpdateMonitorLinkInfo@KernelDriver@@UEAAJAEAU_DXGKARG_UPDATEMONITORLINKINFO@@@Z.c)
 * Callees:
        ...
        struct _DXGKARG_UPDATEMONITORLINKINFO *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5072);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_UPDATEMONITORLINKINFO *))(*((_QWORD *)this + 2) + 1088LL))(
  ...
  v13[3] = v9;
  v13[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 288LL);
  v13[5] = a2->VideoPresentTargetId;
  v13[6] = a2->MonitorLinkInfo.UsageHints.Value;
  v13[7] = a2->MonitorLinkInfo.Capabilities.Value;
  WdLogGlobalForLineNumber = 4451;
  if ( (_DWORD)v9 != -1073741801 && (_DWORD)v9 != -1073741637 && (_DWORD)v9 )
  {
    WdLogSingleEntry1(2LL);
    WdLogGlobalForLineNumber = 4453;
