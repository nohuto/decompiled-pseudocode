/*
 * XREFs of ?DdiSetSchedulingLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1401B19E4
 * Callers:
 *     ADAPTER_RENDER_DdiSetSchedulingLogBuffer @ 0x140074DB0 (ADAPTER_RENDER_DdiSetSchedulingLogBuffer.c)
 * Callees:
        ...
        const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5114);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *))(v9 + 1256);
  if ( v10 )
