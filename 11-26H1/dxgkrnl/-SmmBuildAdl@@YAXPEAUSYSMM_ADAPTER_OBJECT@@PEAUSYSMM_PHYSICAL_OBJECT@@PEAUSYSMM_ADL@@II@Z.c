/*
 * XREFs of ?SmmBuildAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADL@@II@Z @ 0x14006963C
 * Callers:
 ...
 *     SmmBuildAdlFromAddress @ 0x1400696D4 (SmmBuildAdlFromAddress.c)
 *     SmmBuildAdlFromMdl @ 0x14009C8F8 (SmmBuildAdlFromMdl.c)
 */
