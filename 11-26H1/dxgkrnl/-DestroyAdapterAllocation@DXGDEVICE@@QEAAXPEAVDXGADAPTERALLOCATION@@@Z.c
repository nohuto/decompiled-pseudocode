/*
 * XREFs of ?DestroyAdapterAllocation@DXGDEVICE@@QEAAXPEAVDXGADAPTERALLOCATION@@@Z @ 0x14038BD00
 * Callers:
...
void __fastcall DXGDEVICE::DestroyAdapterAllocation(DXGDEVICE *this, struct DXGADAPTERALLOCATION *a2, __int64 a3)
{
  ...
  int v5; // [rsp+48h] [rbp-D0h]
  int v6; // [rsp+50h] [rbp-C8h]
  int v7; // [rsp+58h] [rbp-C0h]
  int v8; // [rsp+60h] [rbp-B8h]
  int v9; // [rsp+68h] [rbp-B0h]
  int v10; // [rsp+70h] [rbp-A8h]
  int v11; // [rsp+78h] [rbp-A0h]
  int v12; // [rsp+88h] [rbp-90h]
  int v13; // [rsp+90h] [rbp-88h]
  int v14; // [rsp+98h] [rbp-80h]
  int v15; // [rsp+A0h] [rbp-78h]
  int v16; // [rsp+A8h] [rbp-70h]
  int v17; // [rsp+B0h] [rbp-68h]
  int v18; // [rsp+B8h] [rbp-60h]
  int v19; // [rsp+C0h] [rbp-58h]
  int v20; // [rsp+C8h] [rbp-50h]
  int v21; // [rsp+D0h] [rbp-48h]
  int v22; // [rsp+D8h] [rbp-40h]
  int v23; // [rsp+E0h] [rbp-38h]
  int v24; // [rsp+E8h] [rbp-30h]
