/*
 * XREFs of ?DdiBeginExclusiveAccess@ADAPTER_RENDER@@QEAAJXZ @ 0x1401AAB30
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiBeginExclusiveAccess(ADAPTER_RENDER *this)
{
  __int64 v2; // rcx
  __int64 v3; // rdi
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v14, 5130);
  v2 = *((_QWORD *)this + 2);
  LODWORD(v3) = 0;
  if ( *(_QWORD *)(v2 + 1312) )
  {
    DXGADAPTER::AcquireDdiSync(v2, 2);
    ...
    v9 = *((_QWORD *)this + 2);
    v13 = 0;
    v3 = (*(int (__fastcall **)(_QWORD, int *))(v9 + 1312))(*(_QWORD *)(v9 + 288), &v13);
