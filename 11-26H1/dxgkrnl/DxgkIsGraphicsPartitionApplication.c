/*
 * XREFs of DxgkIsGraphicsPartitionApplication @ 0x1401F55CC
 * Callers:
...
char __fastcall DxgkIsGraphicsPartitionApplication(PEPROCESS Process)
{
  ...
  if ( ExGetPreviousMode() != 1 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"ExGetPreviousMode() == UserMode", 1556LL, 0LL, 0LL, 0LL, 0LL);
  }
