/*
 * XREFs of ?AcquireNextModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@PEAPEBU3@@Z @ 0x1403BF760
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a4)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 7002);
  ...
  if ( a3 )
  {
    *(_QWORD *)&a3->Id = 0LL;
    ...
    if ( v11 )
    {
      v12 = (_DWORD *)((unsigned __int64)(a2 - 4) & -(__int64)(a2 != 0LL));
      if ( v12 && *v12 == 305419896 )
      {
        v13 = *(_QWORD *)(((unsigned __int64)(a2 - 4) & -(__int64)(a2 != 0LL)) + 8);
        if ( !v13 )
        {
        ...
        {
          DWORD2(v30) = 0;
          *(_QWORD *)&v30 = DMMVIDPNSOURCEMODESET::GetNextMode;
          HIDWORD(v30) = HIDWORD(v28);
          v31 = v13;
          v32 = v30;
          v34 = 0LL;
          v33 = v13;
          v14 = DMMVIDPNSOURCEMODESET::AcquireDdiEnumeratorCachedModeInfo<KM_STL::binder2nd<KM_STL::mem_fun1_t<DMMVIDPNSOURCEMODE *,DMMVIDPNSOURCEMODESET,DMMVIDPNSOURCEMODE const *>>>(
                  v11,
                  &v32,
                  &v34);
          v17 = v14;
