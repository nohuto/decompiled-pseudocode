/*
 * XREFs of ?AddChunkListToTail@MIRACAST_CHUNK_LIST@@QEAAXPEAV1@@Z @ 0x14006D698
 * Callers:
 *     ?MiracastProcessPendingDPCChunks@@YAEPEAX@Z @ 0x14006D5A0 (-MiracastProcessPendingDPCChunks@@YAEPEAX@Z.c)
 *     DpiMiracastMoveChunkList @ 0x140088960 (DpiMiracastMoveChunkList.c)
 * Callees:
 *     <none>
 */
...
void __fastcall MIRACAST_CHUNK_LIST::AddChunkListToTail(MIRACAST_CHUNK_LIST *this, struct MIRACAST_CHUNK_LIST *a2)
{
  ...
  if ( *(struct MIRACAST_CHUNK_LIST **)a2 != a2 )
  {
    if ( v2[1] != a2
      ...
      || (v4 = (MIRACAST_CHUNK_LIST **)*((_QWORD *)this + 1), *v4 != this)
