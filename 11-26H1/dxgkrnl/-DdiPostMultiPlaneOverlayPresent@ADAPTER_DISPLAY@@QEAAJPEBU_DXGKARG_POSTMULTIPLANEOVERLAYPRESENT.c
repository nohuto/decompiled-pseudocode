/*
 * XREFs of ?DdiPostMultiPlaneOverlayPresent@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_POSTMULTIPLANEOVERLAYPRESENT@@@Z @ 0x140071844
 * Callers:
 *     ADAPTER_DISPLAY_DdiPostMultiPlaneOverlayPresent @ 0x140074AF0 (ADAPTER_DISPLAY_DdiPostMultiPlaneOverlayPresent.c)
 * Callees:
        ...
        const struct _DXGKARG_POSTMULTIPLANEOVERLAYPRESENT *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5123);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_POSTMULTIPLANEOVERLAYPRESENT *))(*((_QWORD *)this + 2)
                                                                                           + 1040LL))(
