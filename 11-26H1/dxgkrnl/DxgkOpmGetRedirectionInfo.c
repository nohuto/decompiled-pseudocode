/*
 * XREFs of DxgkOpmGetRedirectionInfo @ 0x1401AA1AC
 * Callers:
...
__int64 __fastcall DxgkOpmGetRedirectionInfo(ADAPTER_DISPLAY **a1, unsigned int a2, unsigned __int64 *a3, __int64 a4)
{
  ...
  result = ADAPTER_DISPLAY::DodGetOpmMftContext(a1[395], (unsigned int)v5, a3);
...
LABEL_10:
      ...
      DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo(a1[395], Numerator);
      if ( !DisplayModeInfo )
      {
