/*
 * XREFs of ?RemoveSourceViewFromSession@DXGSESSIONDATA@@QEAAJAEBU_LUID@@IE@Z @ 0x140386FCC
 * Callers:
 ...
 *     ?RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ @ 0x140364F1C (-RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ.c)
