/*
 * XREFs of Feature_CompTexturesNoRedirectionFix__private_IsEnabledFallback @ 0x140067794
 * Callers:
...
__int64 __fastcall Feature_CompTexturesNoRedirectionFix__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
