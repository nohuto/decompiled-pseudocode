/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1401B0AC4
 * Callers:
 *     ?QueryDriverRecommendedMonitorModes@KernelDriver@@UEBAJXZ @ 0x14027EA40 (-QueryDriverRecommendedMonitorModes@KernelDriver@@UEBAJXZ.c)
 * Callees:
        ...
        struct _DXGKARG_RECOMMENDMONITORMODES *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5037);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDMONITORMODES *))(*((_QWORD *)this + 2) + 672LL))(
