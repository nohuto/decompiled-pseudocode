/*
 * XREFs of DpiIndirectOpenDevice @ 0x140250980
 * Callers:
 *     DpiFdoOpenDeviceFileObjectIfNeeded @ 0x140245058 (DpiFdoOpenDeviceFileObjectIfNeeded.c)
 * Callees:
 *     ?DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x1402501BC (-DpiIndirectGetObjectName@@YAJPEAXPEAPEAU_OBJECT_NAME_INFORMATION@@@Z.c)
 */
