/*
 * XREFs of ?DdiCloseNativeFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CLOSENATIVEFENCE@@@Z @ 0x1401AB53C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCloseNativeFence(ADAPTER_RENDER *this, struct _DXGKARG_CLOSENATIVEFENCE *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_CLOSENATIVEFENCE *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5170);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_CLOSENATIVEFENCE *))(v9 + 1688);
  if ( v10 )
