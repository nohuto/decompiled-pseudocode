/*
 * XREFs of ?DdiDestroyVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYVIRTUALGPU@@@Z @ 0x140218DC0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyVirtualGpu(ADAPTER_RENDER *this, struct _DXGKARG_DESTROYVIRTUALGPU *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5102);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_DESTROYVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1064LL)
                                                                          + 88LL))(
