/*
 * XREFs of ??_EEdidMonitorDescriptor@DxgMonitor@@UEAAPEAXI@Z @ 0x1400613C0
 * Callers:
 *     ??_EEdidMonitorDescriptor@DxgMonitor@@W7EAAPEAXI@Z @ 0x1400996C0 (--_EEdidMonitorDescriptor@DxgMonitor@@W7EAAPEAXI@Z.c)
