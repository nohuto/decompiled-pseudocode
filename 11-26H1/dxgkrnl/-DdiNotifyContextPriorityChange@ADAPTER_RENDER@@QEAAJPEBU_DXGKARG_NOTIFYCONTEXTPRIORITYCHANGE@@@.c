/*
 * XREFs of ?DdiNotifyContextPriorityChange@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_NOTIFYCONTEXTPRIORITYCHANGE@@@Z @ 0x1403FC3FC
 * Callers:
 *     ADAPTER_RENDER_DdiNotifyContextPriorityChange @ 0x140063750 (ADAPTER_RENDER_DdiNotifyContextPriorityChange.c)
 * Callees:
        ...
        const struct _DXGKARG_NOTIFYCONTEXTPRIORITYCHANGE *a2)
{
  ...
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, const struct _DXGKARG_NOTIFYCONTEXTPRIORITYCHANGE *); // rax
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5189);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_NOTIFYCONTEXTPRIORITYCHANGE *))(v9 + 1728);
  if ( v10 )
