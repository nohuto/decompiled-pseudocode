/*
 * XREFs of DxgkHandleVideoParameters @ 0x140235530
 * Callers:
 *     DpiGdoHandleVideoParameters @ 0x140257C28 (DpiGdoHandleVideoParameters.c)
 * Callees:
...
__int64 __fastcall DxgkHandleVideoParameters(DXGADAPTER ***a1, unsigned int a2, char *Source1)
{
  ...
  if ( Current )
  {
    ...
    {
      if ( (unsigned int)v4 < *((_DWORD *)a1[395] + 24) )
      {
        if ( RtlCompareMemory(Source1, &GUID_VIDEO_PARAMETERS, 0x10uLL) != 16 )
        {
          ...
          DxgkLogInternalTriageEvent(
            ...
            0x40000,
            -1,
            (__int64)L"Specified GUID does not match VIDEOPARAMETERS GUID, returning 0x%I64x.",
            -1073741811LL,
            0LL,
            0LL,
            0LL,
        ...
        else if ( v10 == 2 )
        {
          ...
          if ( (*((_DWORD *)Source1 + 6) & 0x100) != 0 )
          {
            ...
            {
              case 1:
                v16 = *((_DWORD *)Source1 + 24);
                if ( (unsigned int)(v16 - 1) > 2 )
                {
                  v8 = -1073741811;
                  WdLogSingleEntry2(3LL, *((unsigned int *)Source1 + 24), -1073741811LL);
                ...
                CopyProtection = ADAPTER_DISPLAY::CreateCopyProtection(a1[395], v4, v16, (unsigned int *)Source1 + 23);
                break;
              case 2:
                CopyProtection = ADAPTER_DISPLAY::DestroyCopyProtection(a1[395], v4, *((_DWORD *)Source1 + 23));
                break;
              case 4:
      ...
      else
      {
        ...
        DxgkLogInternalTriageEvent(
          ...
          0x40000,
          -1,
          (__int64)L"Caller specified VidPn source 0x%I64x is not valid on  adapter 0x%I64x, returning 0x%I64x.",
          v4,
          (__int64)a1,
          -1071774975LL,
          0LL,
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000,
        -1,
        (__int64)L"DxgkHandleVideoParameters is called on a render only or display only adapter 0x%I64x, returning 0x%I64x.",
        (__int64)a1,
        -1073741637LL,
        0LL,
        0LL,
