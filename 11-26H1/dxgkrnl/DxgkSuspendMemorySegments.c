/*
 * XREFs of DxgkSuspendMemorySegments @ 0x1401AA9DC
 * Callers:
...
__int64 __fastcall DxgkSuspendMemorySegments(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    ADAPTER_RENDER::FlushScheduler(*(_QWORD *)(a1 + 3168), 6LL, 0xFFFFFFFFLL);
    v2 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(v3 + 760) + 8LL) + 88LL))(*(_QWORD *)(v3 + 768));
    if ( v2 < 0 )
