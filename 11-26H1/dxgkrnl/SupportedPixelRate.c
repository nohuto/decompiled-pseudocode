/*
 * XREFs of SupportedPixelRate @ 0x140394420
 * Callers:
...
bool __fastcall SupportedPixelRate(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int64)(unsigned int)(v11 * *(_DWORD *)(a1 + 12) * v12) > *(_QWORD *)(a2 + 40)
    ...
    || v12 - *(_DWORD *)(a2 + 12) / *(_DWORD *)(a2 + 16) > 0 && v12 - 61 > 0 )
  {
    return 0;
  }
  v13 = v11 * (unsigned int)*(_QWORD *)(a1 + 20) / (unsigned int)HIDWORD(*(_QWORD *)(a1 + 20));
  if ( (int)(v13 - *(_DWORD *)(a2 + 20) / *(_DWORD *)(a2 + 24)) < 0 && v12 - 60 < 0 )
    return 0;
  if ( (int)(v13 - *(_DWORD *)(a2 + 28) / *(_DWORD *)(a2 + 32)) > 0 )
    return v12 - 61 <= 0;
  return 1;
}
