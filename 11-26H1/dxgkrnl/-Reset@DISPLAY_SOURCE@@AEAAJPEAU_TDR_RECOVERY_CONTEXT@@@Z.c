/*
 * XREFs of ?Reset@DISPLAY_SOURCE@@AEAAJPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1401A4928
 * Callers:
...
__int64 __fastcall DISPLAY_SOURCE::Reset(DISPLAY_SOURCE *this, struct _TDR_RECOVERY_CONTEXT *a2)
{
  ...
  *(_QWORD *)((char *)this + 1108) = 0LL;
  ...
  if ( v6 )
  {
    memset(v6, 0, 4 * *(unsigned int *)(v4 + 2464) * (unsigned __int64)*(unsigned int *)(v4 + 2468));
    v7 = (char *)this + 8;
  }
  else
  {
  ...
  if ( v8 )
  {
    memset(v8, 0, 4 * *(unsigned int *)(v4 + 2464) * (unsigned __int64)*(unsigned int *)(v4 + 2468));
    v2 = v7;
  }
  v9 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v2 + 16LL) + 3168LL);
  if ( v9 )
