/*
 * XREFs of ?InvalidateActiveVidPnDisplayModeListCache@ADAPTER_DISPLAY@@QEAAXIQEBU_DMM_COMMITVIDPNREQUEST_DIAGINFO@@@Z @ 0x14018D0F4
 * Callers:
        ...
        const struct _DMM_COMMITVIDPNREQUEST_DIAGINFO *const a3)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 2994LL, 0LL, 0LL, 0LL, 0LL);
  }
  LODWORD(v6) = 0;
  if ( *((_DWORD *)this + 24) )
  {
