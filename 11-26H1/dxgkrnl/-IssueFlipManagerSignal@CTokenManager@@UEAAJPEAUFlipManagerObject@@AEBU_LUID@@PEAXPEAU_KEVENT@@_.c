/*
 * XREFs of ?IssueFlipManagerSignal@CTokenManager@@UEAAJPEAUFlipManagerObject@@AEBU_LUID@@PEAXPEAU_KEVENT@@_K@Z @ 0x1400A1380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTokenManager::IssueFlipManagerSignal(
        ...
        unsigned __int64 a6)
{
  return CAdapterCollection::IssueFlipManagerSignal((CTokenManager *)((char *)this + 104), a2, a3, a4, Event, a6);
}
