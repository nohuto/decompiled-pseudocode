/*
 * XREFs of ?DdiGetResourceForBar@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x140425964
 * Callers:
 *     ?GetResourceForBar@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1401966D0 (-GetResourceForBar@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiGetResourceForBar(ADAPTER_RENDER *this, struct _DXGKARG_GETRESOURCEFORBAR *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5095);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETRESOURCEFORBAR *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1048LL)
                                                                          + 104LL))(
