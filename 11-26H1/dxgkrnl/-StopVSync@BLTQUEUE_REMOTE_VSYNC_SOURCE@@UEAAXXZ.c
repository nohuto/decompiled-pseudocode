/*
 * XREFs of ?StopVSync@BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAAXXZ @ 0x140284AA0
 * Callers:
 *     ??1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ @ 0x14028468C (--1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ.c)
 * Callees:
