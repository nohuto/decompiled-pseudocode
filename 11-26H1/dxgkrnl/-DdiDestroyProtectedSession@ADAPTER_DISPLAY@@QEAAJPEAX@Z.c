/*
 * XREFs of ?DdiDestroyProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAX@Z @ 0x1401AE364
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDestroyProtectedSession(ADAPTER_DISPLAY *this, void *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5109);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 1248LL))(
