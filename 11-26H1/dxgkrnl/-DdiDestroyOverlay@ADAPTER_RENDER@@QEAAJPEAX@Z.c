/*
 * XREFs of ?DdiDestroyOverlay@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1401AE0EC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyOverlay(ADAPTER_RENDER *this, void *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5035);
  ...
  v9 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 768LL))(a2);
