/*
 * XREFs of ?LogCddDatabaseAccessPacket@@YAXHJPEAUD3DKMT_GETPATHSMODALITY@@PEAU_STRING@@I@Z @ 0x14040F438
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v10 )
  {
    ...
    *(_DWORD *)(v12 + 64) = v14 - v12;
    DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v12, v15, v16, v17);
