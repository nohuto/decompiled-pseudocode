/*
 * XREFs of ?PresentCddPrimary@ADAPTER_DISPLAY@@QEAAJPEAVDXGCONTEXT@@IPEAVCOREDEVICEACCESS@@@Z @ 0x1401A3F3C
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( !a4 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pCoreAccess != NULL", 1656LL, 0LL, 0LL, 0LL, 0LL);
  }
