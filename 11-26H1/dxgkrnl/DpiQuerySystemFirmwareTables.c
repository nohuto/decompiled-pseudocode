/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x14024BEC8
 * Callers:
 *     DpiEnumSystemFirmwareTables @ 0x14024B560 (DpiEnumSystemFirmwareTables.c)
 *     DpiReadSystemFirmwareTable @ 0x14024C100 (DpiReadSystemFirmwareTable.c)
 * Callees:
    ...
    if ( a6 )
    {
      ...
      if ( a4 + 16 <= 0x80 || (Pool2 = (_DWORD *)ExAllocatePool2(256LL, v12, 1953656900LL)) != 0LL )
      {
        ...
        *Pool2 = a2;
        Pool2[2] = a3;
        Pool2[3] = a4;
        v11 = ZwQuerySystemInformation(SystemFirmwareTableInformation, Pool2, v12, ReturnLength);
        if ( v11 < 0 )
        {
          if ( v11 == -1073741789 && ReturnLength[0] >= 0x10 )
          {
            *a6 = Pool2[3];
          }
          else
