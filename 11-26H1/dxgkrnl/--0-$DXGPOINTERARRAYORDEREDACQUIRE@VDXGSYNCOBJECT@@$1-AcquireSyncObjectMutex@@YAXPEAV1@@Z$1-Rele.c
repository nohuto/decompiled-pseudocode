/*
 * XREFs of ??0?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGSYNCOBJECT@@$1?AcquireSyncObjectMutex@@YAXPEAV1@@Z$1?ReleaseSyncObjectMutex@@YAX0@Z$01@@QEAA@PEAPEAVDXGSYNCOBJECT@@IEE@Z @ 0x14000D910
 * Callers:
        ...
        if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v9 + 40, 0LL) )
        {
          if ( bTracingEnabled )
          {
            ...
            if ( (_DWORD)v12 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
              McTemplateK0q_EtwWriteTransfer(v10, "g", v11, v12);
          }
