/*
 * XREFs of ?ProcessPresent@OUTPUTDUPL_CONTEXT@@QEAAJPEAVDXGCONTEXT@@U_D3DKMT_OUTPUTDUPLPRESENTFLAGS@@IKPEAU_D3DKMT_PRESENT_RGNS@@PEBUDXGK_PRESENT_PARAMS@@PEAVAUTOEXPANDALLOCATION@@PEAPEAV2@@Z @ 0x1402B0B58
 * Callers:
        ...
        struct DXGCONTEXT **a9)
{
  ...
  struct _D3DKMT_OUTPUTDUPLPRESENTFLAGS::$A409EE896D278F5C017A650FBAD844EC::$1BE8774737E2D873D5DADE2689676029 v21; // [rsp+70h] [rbp-19h]
...
LABEL_4:
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"OpenForDevice() Failed 0x%I64x", v18, 0LL, 0LL, 0LL, 0LL);
