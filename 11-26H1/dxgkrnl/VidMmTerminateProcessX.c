/*
 * XREFs of VidMmTerminateProcessX @ 0x1402E70F0
 * Callers:
...
struct DXGGLOBAL *__fastcall VidMmTerminateProcessX(__int64 a1)
{
  __int64 v2; // rbx
  __int64 v3; // rdi
  ...
  do
  {
    ...
    if ( *(_QWORD *)((char *)result + v2) )
    {
      ...
      if ( v5 )
      {
        ...
        if ( *(_QWORD *)(v5 + 8LL * (_QWORD)result) )
        {
          (*(void (**)(void))(*(_QWORD *)(v6 + 8) + 352LL))();
          result = *(struct DXGGLOBAL **)(a1 + 64);
          *((_QWORD *)result + (unsigned int)(*(_DWORD *)v6 - 1)) = 0LL;
        }
      }
    }
    v2 += 8LL;
