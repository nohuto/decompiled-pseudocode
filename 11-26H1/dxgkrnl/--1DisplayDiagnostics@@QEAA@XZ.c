/*
 * XREFs of ??1DisplayDiagnostics@@QEAA@XZ @ 0x14007BC2C
 * Callers:
 *     ??1DXGGLOBAL@@EEAA@XZ @ 0x1401DBF5C (--1DXGGLOBAL@@EEAA@XZ.c)
 * Callees:
 *     ??1?$unique_storage@U?$resource_policy@PEAX$$A6AJPEAX@Z$1?PoUnregisterPowerSettingCallback@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAA@XZ @ 0x14007BB20 (--1-$unique_storage@U-$resource_policy@PEAX$$A6AJPEAX@Z$1-PoUnregisterPowerSettingCallback@@YAJ0.c)
