/*
 * XREFs of ?DdiCreateDevice@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEDEVICE@@@Z @ 0x140372000
 * Callers:
 *     ADAPTER_RENDER_DdiCreateDevice @ 0x140074B70 (ADAPTER_RENDER_DdiCreateDevice.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateDevice(ADAPTER_RENDER *this, struct _DXGKARG_CREATEDEVICE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5001);
  ...
  v11 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEDEVICE *))(*((_QWORD *)this + 2) + 464LL))(
  ...
  if ( (_DWORD)v11 != -1073741801 && (_DWORD)v11 != -1073741670 && (_DWORD)v11 )
  {
