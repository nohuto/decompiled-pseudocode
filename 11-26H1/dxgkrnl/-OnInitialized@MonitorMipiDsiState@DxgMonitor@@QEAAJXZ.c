/*
 * XREFs of ?OnInitialized@MonitorMipiDsiState@DxgMonitor@@QEAAJXZ @ 0x140425668
 * Callers:
...
__int64 __fastcall DxgMonitor::MonitorMipiDsiState::OnInitialized(DxgMonitor::MonitorMipiDsiState *this)
{
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v4 + 72LL))(v4, (char *)this + 8);
  MUTEX_LOCK::~MUTEX_LOCK((MUTEX_LOCK *)&v6);
  if ( v5 < 0 )
  {
