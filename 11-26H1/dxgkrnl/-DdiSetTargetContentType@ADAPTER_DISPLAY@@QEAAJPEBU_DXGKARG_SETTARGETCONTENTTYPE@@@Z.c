/*
 * XREFs of ?DdiSetTargetContentType@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETCONTENTTYPE@@@Z @ 0x1401B20D4
 * Callers:
        ...
        const struct _DXGKARG_SETTARGETCONTENTTYPE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5078);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETCONTENTTYPE *))(*((_QWORD *)this + 2) + 1176LL))(
  ...
  WdLogSingleEntry2(4LL, v9, a2->TargetId);
