/*
 * XREFs of ?SetGivenPathDataFromActivePath@CCD_TOPOLOGY@@QEAAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@PEBV1@@Z @ 0x140269420
 * Callers:
          ...
          if ( (v8 & 0x1000000) != 0 )
          {
            if ( (v9 & 0x800000000LL) != 0 )
            {
              ...
              if ( v12 * (unsigned __int64)*(unsigned int *)(v7 + v5 + 288) > v11
                ...
                || v12 * (unsigned __int64)PresentationVSync.Numerator < v11
          ...
          if ( v13 <= *(_DWORD *)(v7 + v5 + 100) )
          {
            ...
            if ( v14 <= *(_DWORD *)(v7 + v5 + 104) && *(_DWORD *)(v7 + v5 + 188) == 1 )
            {
              ...
              if ( v15 == 2 || v15 == 4 )
              {
                if ( v13 < *((_DWORD *)a2 + 39) )
                  return;
                v16 = v14 < *((_DWORD *)a2 + 38);
              }
              else
              {
                if ( v13 < *((_DWORD *)a2 + 38) )
                  return;
                v16 = v14 < *((_DWORD *)a2 + 39);
              }
              if ( !v16 )
              {
                if ( (v8 & 0x100) != 0 )
                ...
                *((_DWORD *)a2 + 12) = *(_DWORD *)(v7 + v5 + 104);
                ...
                v19 = v18 | 0x10000000000101LL;
                *((_QWORD *)a2 + 1) = v17 | 0x101;
                *(_QWORD *)a2 = v19;
                v20 = v19 | *(_DWORD *)(v7 + v5 + 56) & 0x400;
                *(_QWORD *)a2 = v20;
                if ( (v20 & 0x1000000) == 0 )
                {
                  *((_QWORD *)a2 + 28) = *(_QWORD *)(v7 + v5 + 280);
                  *((_DWORD *)a2 + 60) = *(_DWORD *)(v7 + v5 + 296);
                  *(_QWORD *)a2 = v20 | 0x1000000;
                }
              }
            }
          }
