/*
 * XREFs of SmmCreatePhysicalObjectInternal @ 0x140040160
 * Callers:
        ...
        char a7)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(v13 + 48) = 0;
    ...
    _InterlockedAdd64(&qword_1401696E0, *(_QWORD *)v13);
    v19 = (volatile signed __int64 *)&unk_1401696F0;
    if ( (*(_DWORD *)(v13 + 44) & 1) == 0 )
      v19 = (volatile signed __int64 *)&unk_1401696E8;
