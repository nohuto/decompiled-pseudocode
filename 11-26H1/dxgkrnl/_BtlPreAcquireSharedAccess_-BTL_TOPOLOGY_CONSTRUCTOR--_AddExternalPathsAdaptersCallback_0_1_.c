/*
 * XREFs of _BtlPreAcquireSharedAccess_&BTL_TOPOLOGY_CONSTRUCTOR::_AddExternalPathsAdaptersCallback_0_1_ @ 0x14026B730
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    v4 = BTL_TOPOLOGY_CONSTRUCTOR::_AddExternalPathsAdaptersCallback(v9, a2);
    goto LABEL_8;
  }
LABEL_9:
