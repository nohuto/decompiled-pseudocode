/*
 * XREFs of ?DdiResetHwEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETHWENGINE@@@Z @ 0x140072444
 * Callers:
 *     ADAPTER_RENDER_DdiResetHwEngine @ 0x140074CF0 (ADAPTER_RENDER_DdiResetHwEngine.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiResetHwEngine(ADAPTER_RENDER *this, struct _DXGKARG_RESETHWENGINE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5132);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETHWENGINE *))(*((_QWORD *)this + 2) + 1128LL))(
