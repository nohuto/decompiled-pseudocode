/*
 * XREFs of ?DdiDisconnectDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DISCONNECTDOORBELL@@@Z @ 0x1401AE5E4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDisconnectDoorbell(ADAPTER_RENDER *this, struct _DXGKARG_DISCONNECTDOORBELL *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5164);
  ...
  v9 = (*(int (__fastcall **)(struct _DXGKARG_DISCONNECTDOORBELL *))(*((_QWORD *)this + 2) + 1544LL))(a2);
  ...
  if ( (_DWORD)v9 != -1073741822 && (_DWORD)v9 )
  {
