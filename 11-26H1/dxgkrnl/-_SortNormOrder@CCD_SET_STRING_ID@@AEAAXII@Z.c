/*
 * XREFs of ?_SortNormOrder@CCD_SET_STRING_ID@@AEAAXII@Z @ 0x14033DE50
 * Callers:
...
void __fastcall CCD_SET_STRING_ID::_SortNormOrder(CCD_SET_STRING_ID *this, __int64 a2, unsigned int a3)
{
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      {
        v12 = *((_QWORD *)this + 3);
        v9 = *(unsigned __int16 *)(v12 + v3 + 6);
        v10 = *(unsigned __int16 *)(v12 + 8LL * i + 6);
        v11 = CCD_SET_STRING_ID::_CompareDescriptors(this, v9, v10);
        if ( v11 > 0 || !v11 && v9 > v10 )
        {
          *(_WORD *)(v12 + v3 + 6) = v10;
