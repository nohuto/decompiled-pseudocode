/*
 * XREFs of ?IssueFlipManagerWaitForFlipAway@CTokenManager@@UEAAJPEAUFlipManagerObject@@AEBUtagCOMPOSITION_TARGET_FLIP_AWAY_FENCE@@_K@Z @ 0x1400A13B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTokenManager::IssueFlipManagerWaitForFlipAway(
        ...
        unsigned __int64 a4)
{
  return CAdapterCollection::IssueFlipManagerWaitForFlipAway((CTokenManager *)((char *)this + 104), a2, a3, a4);
}
