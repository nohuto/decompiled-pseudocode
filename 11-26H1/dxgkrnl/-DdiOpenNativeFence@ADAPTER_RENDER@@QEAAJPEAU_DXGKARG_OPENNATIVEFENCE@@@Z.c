/*
 * XREFs of ?DdiOpenNativeFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_OPENNATIVEFENCE@@@Z @ 0x1401B0078
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiOpenNativeFence(ADAPTER_RENDER *this, struct _DXGKARG_OPENNATIVEFENCE *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_OPENNATIVEFENCE *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5169);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_OPENNATIVEFENCE *))(v9 + 1680);
  if ( v10 )
