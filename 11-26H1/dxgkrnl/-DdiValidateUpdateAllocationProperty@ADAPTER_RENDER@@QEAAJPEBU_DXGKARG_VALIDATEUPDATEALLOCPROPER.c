/*
 * XREFs of ?DdiValidateUpdateAllocationProperty@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_VALIDATEUPDATEALLOCPROPERTY@@@Z @ 0x1401B35AC
 * Callers:
        ...
        const struct _DXGKARG_VALIDATEUPDATEALLOCPROPERTY *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5073);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_VALIDATEUPDATEALLOCPROPERTY *))(*((_QWORD *)this + 2)
                                                                                          + 1096LL))(
