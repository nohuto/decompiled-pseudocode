/*
 * XREFs of ?GetMonitorFrequencyRangeSet@DXGK_MONITOR_INTERFACE_V1_IMPL@@KAJQEAXIPEAPEAUD3DKMDT_HMONITORFREQUENCYRANGESET__@@PEAPEBU_DXGK_MONITORFREQUENCYRANGESET_INTERFACE@@@Z @ 0x140272780
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_MONITORFREQUENCYRANGESET_INTERFACE **a4)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 7054);
...
LABEL_19:
  ...
  else if ( MonitorHandle >= 0 )
  {
    ...
    *a3 = (struct D3DKMDT_HMONITORFREQUENCYRANGESET__ *)v21;
