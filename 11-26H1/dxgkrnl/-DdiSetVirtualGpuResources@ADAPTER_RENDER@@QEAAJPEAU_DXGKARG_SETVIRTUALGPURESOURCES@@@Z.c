/*
 * XREFs of ?DdiSetVirtualGpuResources@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPURESOURCES@@@Z @ 0x1403E9904
 * Callers:
        ...
        struct _DXGKARG_SETVIRTUALGPURESOURCES *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5101);
  ...
  v8 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPURESOURCES *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                           + 1064LL)
                                                                               + 80LL))(
