/*
 * XREFs of ?DdiCreateProcess@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEPROCESS@@@Z @ 0x140371C54
 * Callers:
 *     ADAPTER_RENDER_DdiCreateProcess @ 0x140074BB0 (ADAPTER_RENDER_DdiCreateProcess.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateProcess(ADAPTER_RENDER *this, struct _DXGKARG_CREATEPROCESS *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5064);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEPROCESS *))(*((_QWORD *)this + 2) + 976LL))(
