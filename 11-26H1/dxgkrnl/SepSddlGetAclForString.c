/*
 * XREFs of SepSddlGetAclForString @ 0x1403DF2B8
 * Callers:
 ...
 *     SepSddlParseWideStringUlong @ 0x140236500 (SepSddlParseWideStringUlong.c)
 */
...
__int64 __fastcall SepSddlGetAclForString(wchar_t *Str1, const void **a2, wchar_t **a3)
{
  ...
  _WORD *v30; // rcx
  unsigned __int16 *v31; // [rsp+40h] [rbp-18h] BYREF
  PSID Sid[2]; // [rsp+48h] [rbp-10h] BYREF
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)v18 + 1) = 0;
      ...
      while ( v19 < v20 )
      {
        ...
        while ( *v22 == 32 )
          ++v22;
        if ( wcsnicmp_0(v22, L"A", 1uLL) )
          goto LABEL_69;
        for ( j = (unsigned __int16 *)(v22 + 2); *j == 32; ++j )
          ;
        if ( *j != 59 )
        {
LABEL_69:
...
LABEL_72:
        ...
        while ( *j != 59 )
        {
          for ( ; *j == 32; ++j )
            ;
          if ( (unsigned int)SepSddlLookupAccessMaskInTable(j, &v35, &v31) )
          {
            AccessMask |= v35;
            j = v31;
          ...
          {
            SepSddlParseWideStringUlong(j, &v31, (unsigned int *)&v33);
            if ( v31 == j )
              goto LABEL_69;
            j = v31;
        ...
        while ( *v24 == 32 )
          ++v24;
        v33 = 0LL;
        SidForString = SepSddlGetSidForString(v24, Sid, &v33);
        if ( SidForString )
          break;
        v28 = v33;
        if ( !v33 )
...
LABEL_60:
        ...
        if ( Sid[0] )
        {
          SidForString = SepSddlAddAceToAcl(a2, &v36, v26, v27, AccessMask, v20 - v34, Sid[0]);
          if ( SidForString )
            goto LABEL_70;
        }
        if ( *v5 == 40 )
