/*
 * XREFs of ?OutputDuplPreIndirectPresent@@YAJPEAVDXGDEVICE@@IPEAPEAVDXGADAPTER@@PEA_K@Z @ 0x140405140
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v13 >= 0 )
  {
    if ( (*(_DWORD *)(v5 + 444) & 0x40000) != 0
      && (v17 = 0, (int)DmmGetMostImportantClientVidPnPathTargetsFromSource((_QWORD *)v5, v7, &v17) >= 0)
      && (v19 = 0LL,
          v18 = 0LL,
          (int)DXGADAPTER::GetVirtualMonitorInfo((DXGADAPTER *)v5, v17, (struct _DXGK_IDD_VIRTUAL_MONITOR_INFO *)&v18) >= 0)
      && DWORD1(v18) == 1
      || (VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwner(*(ADAPTER_DISPLAY **)(v5 + 3160), v7)) != 0LL
