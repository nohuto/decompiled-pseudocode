/*
 * XREFs of Feature_DisplayIDValidationRelaxed__private_IsEnabledDeviceUsageNoInline @ 0x14009F298
 * Callers:
 *     ?DisplayID_Initialize@@YAXPEAUDisplayIDObj@@PEBXI@Z @ 0x14009EEB8 (-DisplayID_Initialize@@YAXPEAUDisplayIDObj@@PEBXI@Z.c)
 * Callees:
 *     Feature_DisplayIDValidationRelaxed__private_IsEnabledFallback @ 0x14009F2D4 (Feature_DisplayIDValidationRelaxed__private_IsEnabledFallback.c)
 */
