/*
 * XREFs of ?GetLaptopSpecialCaseFlags@@YAIAEBVCCD_TOPOLOGY@@AEBU_LUID@@IW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@AEBUMONITORSCOUNT_CALLBACK_CONTEXT@@@Z @ 0x1403AEA14
 * Callers:
        ...
        const struct MONITORSCOUNT_CALLBACK_CONTEXT *a5)
{
  ...
  if ( !PathDescriptor )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pPath != NULL", 3404LL, 0LL, 0LL, 0LL, 0LL);
  }
