/*
 * XREFs of ?ChangeVideoMemoryReservation@ADAPTER_RENDER@@QEAAJPEAVDXGPROCESS@@PEBU_D3DKMT_CHANGEVIDEOMMEMORYRESERVATION@@@Z @ 0x1401A5BB0
 * Callers:
        ...
        const struct _D3DKMT_CHANGEVIDEOMMEMORYRESERVATION *a3)
{
  ...
  if ( *(_BYTE *)(v3 + 209) )
    return DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendChangeVideoMemoryReservation(
             (DXG_GUEST_VIRTUALGPU_VMBUS *)(v3 + 4712),
             a2,
  ...
  return (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, UINT64))(*(_QWORD *)(v7 + 8) + 1016LL))(
           v8,
           v5,
