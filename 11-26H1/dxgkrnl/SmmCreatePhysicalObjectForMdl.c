/*
 * XREFs of SmmCreatePhysicalObjectForMdl @ 0x14003FBD0
 * Callers:
 ...
 *     SysMmTestCreatePhysicalObjectForExistingMdl @ 0x14009D540 (SysMmTestCreatePhysicalObjectForExistingMdl.c)
 * Callees:
