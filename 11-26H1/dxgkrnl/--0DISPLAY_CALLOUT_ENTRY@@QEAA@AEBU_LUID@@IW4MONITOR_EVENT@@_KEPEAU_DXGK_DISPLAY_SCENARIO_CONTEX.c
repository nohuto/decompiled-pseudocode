/*
 * XREFs of ??0DISPLAY_CALLOUT_ENTRY@@QEAA@AEBU_LUID@@IW4MONITOR_EVENT@@_KEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x14018F200
 * Callers:
 ...
 *     ??0CDisplayScenarioContextCarrier@@QEAA@QEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x14006CB74 (--0CDisplayScenarioContextCarrier@@QEAA@QEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z.c)
 */
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a7)
{
  ...
  *(_DWORD *)(a1 + 36) = a4;
  if ( !v11 )
    _InterlockedIncrement((volatile signed __int32 *)DXGGLOBAL::GetGlobal() + 474);
  return a1;
}
