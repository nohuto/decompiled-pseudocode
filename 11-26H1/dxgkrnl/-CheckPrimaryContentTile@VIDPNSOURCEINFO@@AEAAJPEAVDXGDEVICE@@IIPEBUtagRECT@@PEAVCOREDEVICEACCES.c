/*
 * XREFs of ?CheckPrimaryContentTile@VIDPNSOURCEINFO@@AEAAJPEAVDXGDEVICE@@IIPEBUtagRECT@@PEAVCOREDEVICEACCESS@@PEAI3@Z @ 0x1402B8570
 * Callers:
        ...
        unsigned int *a8)
{
  ...
  _D3DKMT_UNLOCK v19; // [rsp+20h] [rbp-58h] BYREF
