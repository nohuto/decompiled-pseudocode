/*
 * XREFs of ?DdiRestoreMutableMigrationData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_RESTORE_MUTABLE_MIGRATION_DATA@@@Z @ 0x14021AE24
 * Callers:
 *     ?RestoreMutableMigrationData@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GPUP_RESTORE_MUTABLE_MIGRATION_DATA@@@Z @ 0x14021F230 (-RestoreMutableMigrationData@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GPUP_RESTORE_MUTABLE_MIGRA.c)
 * Callees:
        ...
        struct _DXGKARG_GPUP_RESTORE_MUTABLE_MIGRATION_DATA *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5186);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_RESTORE_MUTABLE_MIGRATION_DATA *))(*((_QWORD *)this + 2)
                                                                                            + 1648LL))(
