/*
 * XREFs of ?GetCddDisplayMode@ADAPTER_DISPLAY@@QEBAAEBU_D3DKMT_DISPLAYMODE@@I@Z @ 0x14006C170
 * Callers:
...
const struct _D3DKMT_DISPLAYMODE *__fastcall ADAPTER_DISPLAY::GetCddDisplayMode(ADAPTER_DISPLAY *this, unsigned int a2)
{
  ...
  if ( !ADAPTER_DISPLAY::IsCoreResourceSharedOwner(this) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceSharedOwner()", 5886LL, 0LL, 0LL, 0LL, 0LL);
  }
