/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U2@U?$_tlgWrapSz@D@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBX1IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteAgg@@YAJ011I2@ZPEBX@@SAJPEBU_tlgProvider_t@@PEBX1AEBU?$_tlgWrapperByVal@$07@@2AEBU?$_tlgWrapperByVal@$03@@3AEBU?$_tlgWrapSz@D@@@Z @ 0x1400570A8
 * Callers:
        ...
        const CHAR **a8)
{
  ...
  const CHAR *v21; // [rsp+90h] [rbp+17h]
  ...
  v16 = 8LL;
  v14 = 8LL;
  return tlgWriteAgg((int)&dword_1401665B8, a2, 0, 7, &v12);
}
