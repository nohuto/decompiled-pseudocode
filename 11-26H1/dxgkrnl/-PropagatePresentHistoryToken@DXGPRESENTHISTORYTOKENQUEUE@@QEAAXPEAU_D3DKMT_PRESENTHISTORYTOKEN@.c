/*
 * XREFs of ?PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@@_N111111PEAX@Z @ 0x1400841B0
 * Callers:
  ...
  *((_DWORD *)SpinLock + 2) = v10;
  if ( v10 == *((_DWORD *)SpinLock + 3) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      262146,
      -1,
      (__int64)L"m_PresentHistoryHead != m_PresentHistoryTail",
      3683LL,
      0LL,
      0LL,
      0LL,
