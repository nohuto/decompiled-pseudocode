/*
 * XREFs of ?PostProcessUMDFileName@@YAJW4_KMTQUERYADAPTERINFOTYPE@@PEAXI@Z @ 0x140192658
 * Callers:
...
__int64 __fastcall PostProcessUMDFileName(enum _KMTQUERYADAPTERINFOTYPE a1, char *a2, unsigned int a3)
{
  ...
  if ( a3 < 0x228 )
    return (unsigned int)-1073741811;
  if ( !*((_DWORD *)a2 + 135) && ((*((_DWORD *)a2 + 1) & 1) != 0 || *(_DWORD *)a2 == 2 || *(_DWORD *)a2 == 3) )
  {
    v7 = *(_DWORD *)a2;
    v8 = (((unsigned __int64)a3 - 552) >> 1) + 1;
    if ( v7 == 2 || v7 == 3 || *((_DWORD *)a2 + 132) != 7 )
