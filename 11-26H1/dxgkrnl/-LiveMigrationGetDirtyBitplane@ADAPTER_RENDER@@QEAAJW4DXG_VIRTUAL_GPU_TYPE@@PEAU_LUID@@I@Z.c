/*
 * XREFs of ?LiveMigrationGetDirtyBitplane@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@I@Z @ 0x140214C44
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::LiveMigrationGetDirtyBitplane(__int64 a1, int a2, struct _LUID *a3, __int64 a4)
{
  unsigned int v4; // ebx
  __int64 v7; // rbx
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"LiveMigrationGetDirtyBitplane called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v7,
      v16,
  ...
  else
  {
    ...
    if ( VirtualGpuByLuid )
    {
      v11 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, _QWORD))(*(_QWORD *)VirtualGpuByLuid + 224LL))(
              VirtualGpuByLuid,
              v4);
    }
    else
