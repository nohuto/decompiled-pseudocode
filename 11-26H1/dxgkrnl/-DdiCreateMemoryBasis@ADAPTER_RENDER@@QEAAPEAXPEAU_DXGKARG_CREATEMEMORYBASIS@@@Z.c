/*
 * XREFs of ?DdiCreateMemoryBasis@ADAPTER_RENDER@@QEAAPEAXPEAU_DXGKARG_CREATEMEMORYBASIS@@@Z @ 0x1401AC778
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateMemoryBasis(ADAPTER_RENDER *this, struct _DXGKARG_CREATEMEMORYBASIS *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5176);
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_CREATEMEMORYBASIS *))(*((_QWORD *)this + 2) + 1568LL))(
