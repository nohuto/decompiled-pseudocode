/*
 * XREFs of ?InvalidateDisplayModeListCacheOnSource@ADAPTER_DISPLAY@@QEAAXI@Z @ 0x140365238
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::InvalidateDisplayModeListCacheOnSource(PERESOURCE **this, unsigned int a2)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 3026LL, 0LL, 0LL, 0LL, 0LL);
  }
