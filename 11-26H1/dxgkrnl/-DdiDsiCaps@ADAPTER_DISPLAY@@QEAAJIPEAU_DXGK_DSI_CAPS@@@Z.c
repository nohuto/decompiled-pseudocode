/*
 * XREFs of ?DdiDsiCaps@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_CAPS@@@Z @ 0x1401AE844
 * Callers:
 *     ?DdiDsiCaps@KernelDriver@@UEBAJPEAU_DXGK_DSI_CAPS@@@Z @ 0x14027E740 (-DdiDsiCaps@KernelDriver@@UEBAJPEAU_DXGK_DSI_CAPS@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDsiCaps(ADAPTER_DISPLAY *this, unsigned int a2, struct _DXGK_DSI_CAPS *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5144);
