/*
 * XREFs of ?VidMmMakeResident@VIDMM_EXPORT@@QEAAJPEAVVIDMM_GLOBAL@@PEAUVIDMM_PAGING_QUEUE@@PEAPEAUVIDMM_MULTI_ALLOC@@IKPEA_K3@Z @ 0x140046468
 * Callers:
...
__int64 __fastcall VIDMM_EXPORT::VidMmMakeResident(
        ...
        unsigned __int64 *a8)
{
  return (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, struct VIDMM_PAGING_QUEUE *, struct VIDMM_MULTI_ALLOC **, _QWORD, unsigned int, unsigned __int64 *, unsigned __int64 *))(*((_QWORD *)this + 1) + 728LL))(
           a2,
           a3,
           a4,
           a5,
