/*
 * XREFs of SmmClosePhysicalObject @ 0x14003F43C
 * Callers:
 ...
 *     DxgkClosePhysicalMemoryObjectCB @ 0x14003F330 (DxgkClosePhysicalMemoryObjectCB.c)
 ...
 *     SmmRemoveObjectFromAdapter @ 0x14003F644 (SmmRemoveObjectFromAdapter.c)
...
void __fastcall SmmClosePhysicalObject(struct SYSMM_ADAPTER_OBJECT *a1, __int64 a2, __int64 a3)
{
  char *v3; // rsi
  __int64 v4; // rdi
  ...
  if ( (Microsoft_Windows_DxgKrnl_SysMmEnableBits & 1) != 0 )
    McTemplateK0ppp_EtwWriteTransfer(
      ...
      (const EVENT_DESCRIPTOR *)"\b",
      a3,
      v4,
      (char *)a1 - 64,
      a1);
  if ( (dword_1401696C0 & 0x20) != 0 && **((_QWORD **)v3 + 3) != *((_QWORD *)v3 + 3) )
  {
  ...
  if ( (v7 & 4) != 0 )
  {
    if ( *((_BYTE *)a1 + 36) )
    {
      ...
      (*(void (__fastcall **)(__int64, unsigned __int64, _QWORD))(v4 + 328))(v4, LogicalAddress, *(_QWORD *)(v4 + 336));
      *((_BYTE *)a1 + 36) = 0;
    }
    if ( *((_BYTE *)a1 + 37) )
    {
  ...
  else if ( (v7 & 1) != 0 && (dword_1401696C0 & 0x18) == 0 )
  {
    SmmFreeLogicalAddress(*(struct SYSMM_LOGICAL_ALLOCATOR **)(v4 + 352), *((struct SYSMM_LOGICAL_BLOCK **)a1 + 3));
  }
