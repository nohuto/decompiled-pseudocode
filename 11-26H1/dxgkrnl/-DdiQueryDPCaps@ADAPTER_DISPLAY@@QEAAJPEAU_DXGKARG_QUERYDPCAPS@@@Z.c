/*
 * XREFs of ?DdiQueryDPCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_QUERYDPCAPS@@@Z @ 0x1401B0544
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiQueryDPCaps(ADAPTER_DISPLAY *this, struct _DXGKARG_QUERYDPCAPS *a2)
{
  ...
  int v8; // ebp
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, struct _DXGKARG_QUERYDPCAPS *); // rax
  int v11; // edi
  KIRQL v12; // al
  __int64 v13; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5149);
  ...
  if ( v9 && (v10 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDPCAPS *))(v9 + 32)) != 0LL )
