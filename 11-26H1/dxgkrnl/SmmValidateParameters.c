/*
 * XREFs of SmmValidateParameters @ 0x140041250
 * Callers:
...
char __fastcall SmmValidateParameters(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, int a4)
{
  char v4; // bl
  ...
  else
  {
    ...
    if ( (v4 & 1) == 0 || (((*(_DWORD *)(a1 + 44) & 0x1E) - 6) & 0xFFFFFFFB) == 0 )
      return 1;
    WdLogSingleEntry1(3LL);
