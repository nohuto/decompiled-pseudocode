/*
 * XREFs of McTemplateK0ppqpttqpqp_EtwWriteTransfer @ 0x140057CFC
 * Callers:
 *     TraceDxgkDevice @ 0x140057BA0 (TraceDxgkDevice.c)
...
NTSTATUS McTemplateK0ppqpttqpqp_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v22 = 4LL;
  v24 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, a2, a3, 0xBu, &v4);
}
