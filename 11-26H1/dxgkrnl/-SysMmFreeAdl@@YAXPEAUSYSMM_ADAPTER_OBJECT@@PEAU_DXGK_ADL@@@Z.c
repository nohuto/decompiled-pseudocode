/*
 * XREFs of ?SysMmFreeAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAU_DXGK_ADL@@@Z @ 0x1400533B0
 * Callers:
 ...
 * Callees:
 *     SmmFreeAdl @ 0x140053478 (SmmFreeAdl.c)
...
void __fastcall SysMmFreeAdl(struct SYSMM_ADAPTER_OBJECT *a1, struct _DXGK_ADL *a2)
{
  ...
  v4 = (*((_DWORD *)a1 + 8))-- == 1;
  if ( v4 && (dword_1401696C0 & 0x18) == 0x10 )
  {
    SmmFreeLogicalAddress(
      *(struct SYSMM_LOGICAL_ALLOCATOR **)(*((_QWORD *)a1 + 2) + 352LL),
