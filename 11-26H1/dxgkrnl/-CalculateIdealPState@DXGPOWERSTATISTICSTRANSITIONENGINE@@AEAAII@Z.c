/*
 * XREFs of ?CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z @ 0x14007FCDC
 * Callers:
        ...
        unsigned int a2)
{
  ...
  v4 = -1LL;
  v5 = *v2;
  v6 = a2 * (unsigned __int64)v2[*((unsigned int *)this + 14) + 1] / *(unsigned int *)(*(_QWORD *)this + 4700LL);
  while ( 1 )
  {
    if ( !v5 )
      return 0LL;
