/*
 * XREFs of ?AddEdid@EDIDCACHE@DxgMonitor@@UEAAXU_LUID@@IEPEBEW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@@Z @ 0x1402704C0
 * Callers:
  ...
  if ( EdidInCache == -1 )
  {
    ...
    if ( v13 >= 4 )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        262146,
        -1,
        (__int64)L"EarliestSysTimeIdx < NUM_EDIDS_TO_CACHE",
        349LL,
        0LL,
        0LL,
        0LL,
