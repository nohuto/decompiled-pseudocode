/*
 * XREFs of ?DdiQueryCurrentFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x140071CFC
 * Callers:
 *     ADAPTER_RENDER_DdiQueryCurrentFence @ 0x140074C90 (ADAPTER_RENDER_DdiQueryCurrentFence.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiQueryCurrentFence(ADAPTER_RENDER *this, struct _DXGKARG_QUERYCURRENTFENCE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v16, 5015);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYCURRENTFENCE *))(*((_QWORD *)this + 2) + 608LL))(
  ...
  v13[3] = v9;
  v13[4] = a2->CurrentFence;
  v13[5] = a2->NodeOrdinal;
  v13[6] = a2->EngineOrdinal;
