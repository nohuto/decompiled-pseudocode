/*
 * XREFs of ?RestoreMutableMigrationData@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@PEAU_DXGKARG_GPUP_RESTORE_MUTABLE_MIGRATION_DATA@@@Z @ 0x140215F50
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::RestoreMutableMigrationData(__int64 a1, int a2, struct _LUID *a3, _DWORD *a4)
{
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"RestoreMutableMigrationData called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v7,
      v16,
