/*
 * XREFs of ?AcquireFirstDescriptorInfo@DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORDESCRIPTORSET__@@PEAPEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x140415CE0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_MONITOR_DESCRIPTOR **a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 7028);
    ...
    *a2 = 0LL;
    ...
    else
    {
      ...
      FirstMonitorDescriptorEnumerator = DxgMonitor::MonitorDescriptorState::_GetFirstMonitorDescriptorEnumerator(
                                           (DxgMonitor::MonitorDescriptorState *)v12,
                                           a2);
