/*
 * XREFs of ?SerializeToBuffer@EdidMonitorDescriptor@DxgMonitor@@UEBAXPEAU_DMM_MONITORDESCRIPTORSET_SERIALIZATION@@I@Z @ 0x140281050
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetSerializationSizeInBytes@EdidMonitorDescriptor@DxgMonitor@@UEBAIXZ @ 0x140280ED0 (-GetSerializationSizeInBytes@EdidMonitorDescriptor@DxgMonitor@@UEBAIXZ.c)
 */
