/*
 * XREFs of ?DestroyActivePairing@DISPLAY_MUX_PAIRING@@AEAAXW4DISPLAY_MUX_PAIRING_DESTROYED_REASON@@@Z @ 0x14008BA7C
 * Callers:
...
void __fastcall DISPLAY_MUX_PAIRING::DestroyActivePairing(__int64 a1, int a2)
{
  ...
  if ( *(_DWORD *)a1 == 2 )
  {
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_1401665B8, 0x400000000200LL) )
      {
        v7 = *(_QWORD *)(a1 + 24);
        v11 = a2;
        v19 = (void *)(v7 + 32);
