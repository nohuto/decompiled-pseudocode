/*
 * XREFs of ?IsOutputDuplAllowedForVidPn@OUTPUTDUPL_MGR@@AEAAJIHHPEAW4_D3DKMT_VIDPNSOURCEOWNER_TYPE@@@Z @ 0x14018FE94
 * Callers:
  ...
  else
  {
    ...
    *a5 = VidPnSourceOwnerType;
    if ( VidPnSourceOwnerType != D3DKMT_VIDPNSOURCEOWNER_SHARED )
    {
      ...
      if ( (v12 & 1) == 0 )
      {
        v16 = WdLogNewEntry5_WdTrace(a5, v14);
        *(_QWORD *)(v16 + 24) = v6;
        *(_QWORD *)(v16 + 32) = v15;
