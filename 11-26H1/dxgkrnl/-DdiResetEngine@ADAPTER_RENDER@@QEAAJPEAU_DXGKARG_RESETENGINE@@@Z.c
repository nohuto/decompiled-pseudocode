/*
 * XREFs of ?DdiResetEngine@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETENGINE@@@Z @ 0x14007221C
 * Callers:
 *     ADAPTER_RENDER_DdiResetEngine @ 0x140074CD0 (ADAPTER_RENDER_DdiResetEngine.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiResetEngine(ADAPTER_RENDER *this, struct _DXGKARG_RESETENGINE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5051);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETENGINE *))(*((_QWORD *)this + 2) + 824LL))(
