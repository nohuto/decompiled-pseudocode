/*
 * XREFs of ?DpiFdoInitializePanelBufferControl@@YAJPEAU_DEVICE_OBJECT@@@Z @ 0x140085E00
 * Callers:
...
__int64 __fastcall DpiFdoInitializePanelBufferControl(struct _DEVICE_OBJECT *a1)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  ResultLength = 0;
  DpiIsFeatureEnabled(a1, 46LL, 0LL, &ResultLength);
  if ( (ResultLength & 0x10000) == 0 && !v3 )
    return 0LL;
  ...
  WdLogGlobalForLineNumber = 13993;
  memset(v4, 0, 0x40uLL);
  return 3221225485LL;
}
