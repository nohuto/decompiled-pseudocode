/*
 * XREFs of ?Serialize@DMMVIDPNSOURCEMODESET@@QEBAJPEAV?$AutoBuffer@U_DMM_VIDPNSOURCEMODESET_SERIALIZATION@@@DMM@@@Z @ 0x140267818
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *(_BYTE *)a2[4] = *((_BYTE *)this + 64);
      v11 = (DMMVIDPNSOURCEMODESET *)*((_QWORD *)this + 6);
      if ( v11 != (DMMVIDPNSOURCEMODESET *)((char *)this + 48) )
        NextMode = (DMMVIDPNSOURCEMODESET *)((char *)v11 - 8);
      for ( ; NextMode; NextMode = DMMVIDPNSOURCEMODESET::GetNextMode(this, NextMode) )
        DMMVIDPNSOURCEMODE::Serialize(NextMode, (struct _D3DKMDT_VIDPN_SOURCE_MODE *const)(a2[4] + 4LL + 40LL * v10++));
      if ( v10 != *(_BYTE *)a2[4] )
      {
        WdLogSingleEntry0(1LL);
