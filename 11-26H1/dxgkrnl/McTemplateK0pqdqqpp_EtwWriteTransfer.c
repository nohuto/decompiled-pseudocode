/*
 * XREFs of McTemplateK0pqdqqpp_EtwWriteTransfer @ 0x1400822F4
 * Callers:
...
NTSTATUS McTemplateK0pqdqqpp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
