/*
 * XREFs of ?VmBusSendChangeVideoMemoryReservation@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@IW4_D3DKMT_MEMORY_SEGMENT_GROUP@@_K@Z @ 0x14022B8D8
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  *((_DWORD *)v9 + 12) = a3;
  ...
  if ( v11 < 0 )
  {
    ...
    WdLogGlobalForLineNumber = 13098;
