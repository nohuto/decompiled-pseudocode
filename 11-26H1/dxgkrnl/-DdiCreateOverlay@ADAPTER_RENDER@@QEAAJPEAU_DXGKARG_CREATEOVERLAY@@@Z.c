/*
 * XREFs of ?DdiCreateOverlay@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEOVERLAY@@@Z @ 0x1401AC974
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateOverlay(ADAPTER_RENDER *this, struct _DXGKARG_CREATEOVERLAY *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5032);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEOVERLAY *))(*((_QWORD *)this + 2) + 704LL))(
