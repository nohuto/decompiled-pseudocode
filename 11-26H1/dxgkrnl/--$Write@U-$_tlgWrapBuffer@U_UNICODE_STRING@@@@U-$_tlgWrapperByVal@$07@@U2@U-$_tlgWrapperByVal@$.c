        ...
        __int64 a12)
{
  ...
  int v13; // ecx
  _BYTE v15[32]; // [rsp+30h] [rbp-A9h] BYREF
  ...
  v19[0] = v13;
  v19[1] = 0;
  return tlgWriteTransfer_EtwWriteTransfer(&dword_140166660, a2, 0LL, 0LL, 11, v15);
}
