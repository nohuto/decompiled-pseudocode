/*
 * XREFs of ?RtlStringCbCatA@@YAJPEAD_KPEBD@Z @ 0x140078760
 * Callers:
 ...
 * Callees:
 *     RtlStringCopyWorkerA @ 0x14004B7A4 (RtlStringCopyWorkerA.c)
 *     RtlStringLengthWorkerA @ 0x14004D63C (RtlStringLengthWorkerA.c)
 */
