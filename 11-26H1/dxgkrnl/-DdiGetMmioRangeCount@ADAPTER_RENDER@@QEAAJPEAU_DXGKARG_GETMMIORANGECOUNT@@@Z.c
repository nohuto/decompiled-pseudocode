/*
 * XREFs of ?DdiGetMmioRangeCount@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETMMIORANGECOUNT@@@Z @ 0x1402194DC
 * Callers:
 *     ?GetMmioRangeCount@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETMMIORANGECOUNT@@@Z @ 0x14021E7C0 (-GetMmioRangeCount@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETMMIORANGECOUNT@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiGetMmioRangeCount(ADAPTER_RENDER *this, struct _DXGKARG_GETMMIORANGECOUNT *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5138);
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETMMIORANGECOUNT *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                          + 1072LL)
                                                                              + 40LL))(
