/*
 * XREFs of ?DdiSetTargetGamma@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETGAMMA@@@Z @ 0x1402DBABC
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiSetTargetGamma(ADAPTER_DISPLAY *this, const struct _DXGKARG_SETTARGETGAMMA *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5077);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETGAMMA *))(*((_QWORD *)this + 2) + 1168LL))(
  ...
  if ( (_DWORD)v9 != -1073741801 && (_DWORD)v9 != -1071774904 && (_DWORD)v9 )
  {
