/*
 * XREFs of ?DdiPrepareLiveMigration@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_PREPARE_LIVE_MIGRATION@@@Z @ 0x140425E6C
 * Callers:
        ...
        struct _DXGKARG_GPUP_PREPARE_LIVE_MIGRATION *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5181);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_PREPARE_LIVE_MIGRATION *))(*((_QWORD *)this + 2) + 1608LL))(
