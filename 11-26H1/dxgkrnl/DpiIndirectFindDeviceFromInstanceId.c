/*
 * XREFs of DpiIndirectFindDeviceFromInstanceId @ 0x140250698
 * Callers:
...
__int64 __fastcall DpiIndirectFindDeviceFromInstanceId(PCUNICODE_STRING String2, __int64 a2, _QWORD *a3)
{
  ...
  ULONG Type[2]; // [rsp+48h] [rbp-71h] BYREF
  ULONG RequiredSize; // [rsp+50h] [rbp-69h] BYREF
  ...
  v15 = Data;
  *(_QWORD *)Type = 0LL;
  AUTO_FREE_POOL<IDD_COMPLETION_CONTEXT *>::Free((void **)Type);
  if ( Data )
  {
    ...
    if ( *(_QWORD *)v10 != v10 )
    {
      ...
      while ( *(_QWORD *)v10 != qword_140168E08 );
    }
