/*
 * XREFs of ?DdiCheckMultiPlaneOverlaySupport2@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT2@@@Z @ 0x1401AB2A4
 * Callers:
        ...
        struct _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT2 *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5067);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT2 *))(*((_QWORD *)this + 2) + 992LL))(
