/*
 * XREFs of ?DdiUnmapCpuHostAperture@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_UNMAPCPUHOSTAPERTURE@@@Z @ 0x1402F9170
 * Callers:
 *     ADAPTER_RENDER_DdiUnmapCpuHostAperture @ 0x14004A2A0 (ADAPTER_RENDER_DdiUnmapCpuHostAperture.c)
 * Callees:
        ...
        const struct _DXGKARG_UNMAPCPUHOSTAPERTURE *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5062);
  ...
  v8 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_UNMAPCPUHOSTAPERTURE *))(*((_QWORD *)this + 2) + 968LL))(
