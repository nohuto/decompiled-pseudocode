/*
 * XREFs of Feature_CompSwapchainDX12Support__private_IsEnabledFallback @ 0x140067A38
 * Callers:
...
__int64 __fastcall Feature_CompSwapchainDX12Support__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
