/*
 * XREFs of ?LiveMigrationWaitForFence@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@_KPEAU_KEVENT@@W4_DXGK_GPUP_MIGRATIONTYPE@@@Z @ 0x1402150A4
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( a2 )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"LiveMigrationWaitForFence called for non GPUP vGPU. Luid: %d %d vGPU Type: %d Adapter: %d",
      HighPart,
      LowPart,
      v10,
      v18,
