/*
 * XREFs of ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1403C31A8
 * Callers:
 *     ADAPTER_RENDER_DdiSetContextSchedulingProperties @ 0x14005BDA0 (ADAPTER_RENDER_DdiSetContextSchedulingProperties.c)
 * Callees:
        ...
        const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *a2)
{
  ...
  int v8; // r14d
  __int64 v9; // rcx
  __int64 (__fastcall *v10)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *); // rax
  int v11; // edi
  __int64 v12; // rcx
  KIRQL v14; // al
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 5117);
  ...
  v9 = *((_QWORD *)this + 2);
  v10 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *))(v9 + 1280);
  if ( v10 )
