/*
 * XREFs of ?DdiUpdateActiveVidPnPresentPath@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH@@@Z @ 0x140385F9C
 * Callers:
        ...
        const struct _DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5012);
  ...
  v8 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH *))(*((_QWORD *)this + 2)
                                                                                           + 664LL))(
  ...
  WdLogSingleEntry2(4LL, v8, a2);
  WdLogGlobalForLineNumber = 1348;
  if ( (_DWORD)v8 != -1073741801 && (_DWORD)v8 != -1071774906 && (_DWORD)v8 != -1071774904 && (_DWORD)v8 )
  {
