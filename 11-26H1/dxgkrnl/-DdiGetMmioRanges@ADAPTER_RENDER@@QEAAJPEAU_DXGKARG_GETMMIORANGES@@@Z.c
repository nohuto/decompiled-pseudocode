/*
 * XREFs of ?DdiGetMmioRanges@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETMMIORANGES@@@Z @ 0x1402196E0
 * Callers:
 *     ?GetMmioRanges@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETMMIORANGES@@@Z @ 0x14021E7E0 (-GetMmioRanges@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETMMIORANGES@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiGetMmioRanges(ADAPTER_RENDER *this, struct _DXGKARG_GETMMIORANGES *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5139);
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETMMIORANGES *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1072LL)
                                                                          + 48LL))(
