/*
 * XREFs of ?DdiCheckMultiPlaneOverlaySupport@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT@@@Z @ 0x1403DC38C
 * Callers:
 *     ADAPTER_DISPLAY_DdiCheckMultiPlaneOverlaySupport @ 0x140074AD0 (ADAPTER_DISPLAY_DdiCheckMultiPlaneOverlaySupport.c)
        ...
        struct _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5055);
