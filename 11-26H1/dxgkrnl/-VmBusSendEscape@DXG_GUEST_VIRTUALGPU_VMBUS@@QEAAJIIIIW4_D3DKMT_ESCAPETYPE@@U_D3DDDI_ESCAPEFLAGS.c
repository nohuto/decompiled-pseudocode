/*
 * XREFs of ?VmBusSendEscape@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIIIW4_D3DKMT_ESCAPETYPE@@U_D3DDDI_ESCAPEFLAGS@@IPEAE@Z @ 0x14022EAE8
 * Callers:
...
LABEL_14:
    ...
    WdLogGlobalForLineNumber = 12553;
    goto LABEL_15;
  }
  WdLogSingleEntry0(6LL);
  WdLogGlobalForLineNumber = 12518;
  DxgkLogInternalTriageEvent(
    0LL,
    262145,
    -1,
