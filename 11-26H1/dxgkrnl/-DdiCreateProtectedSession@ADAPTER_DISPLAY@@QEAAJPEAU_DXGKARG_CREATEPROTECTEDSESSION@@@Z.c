/*
 * XREFs of ?DdiCreateProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CREATEPROTECTEDSESSION@@@Z @ 0x1401ACC0C
 * Callers:
        ...
        struct _DXGKARG_CREATEPROTECTEDSESSION *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5108);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEPROTECTEDSESSION *))(*((_QWORD *)this + 2) + 1240LL))(
