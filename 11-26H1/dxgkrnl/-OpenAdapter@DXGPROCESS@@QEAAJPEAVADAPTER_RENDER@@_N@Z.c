/*
 * XREFs of ?OpenAdapter@DXGPROCESS@@QEAAJPEAVADAPTER_RENDER@@_N@Z @ 0x140371584
 * Callers:
...
__int64 __fastcall DXGPROCESS::OpenAdapter(DXGPROCESS *this, struct ADAPTER_RENDER *a2, char a3)
{
  ...
  *((_QWORD *)a2 + 10) = KeGetCurrentThread();
  ...
  if ( a3 )
  {
    v4 = DXGPROCESS_RENDER_ADAPTER_INFO::Initialize((DXGPROCESS_RENDER_ADAPTER_INFO *)v8, this, a2);
    if ( v4 < 0 )
    {
