/*
 * XREFs of ?DdiGetDeviceLocation@ADAPTER_RENDER@@QEAAXPEAU_DXGKARG_GETDEVICELOCATION@@@Z @ 0x1403F845C
 * Callers:
 *     ?GetDeviceLocation@DXGK_VIRTUAL_GPU_GPUP@@UEAAXPEAU_DXGKARG_GETDEVICELOCATION@@@Z @ 0x1403F8440 (-GetDeviceLocation@DXGK_VIRTUAL_GPU_GPUP@@UEAAXPEAU_DXGKARG_GETDEVICELOCATION@@@Z.c)
 * Callees:
...
void __fastcall ADAPTER_RENDER::DdiGetDeviceLocation(ADAPTER_RENDER *this, struct _DXGKARG_GETDEVICELOCATION *a2)
{
  ...
  _BYTE v14[8]; // [rsp+48h] [rbp-11h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v11, 5092);
