/*
 * XREFs of ?RestoreAnyFlagsModifiedBeforeCallingBML@CCD_TOPOLOGY@@QEAAHPEBU_LUID@@@Z @ 0x14026938C
 * Callers:
  ...
  for ( i = 0; i < *(unsigned __int16 *)(v2 + 20); ++i )
  {
    ...
    if ( *(_DWORD *)(v6 + v2 + 72) == a2->LowPart && *(_DWORD *)(v6 + v2 + 76) == a2->HighPart )
    {
      ...
      if ( (v7 & 0x10000000000000LL) != 0 )
      {
        ...
        *(_QWORD *)(v6 + *((_QWORD *)this + 8) + 64) &= 0xFFFFFFFFFFFFFEFEuLL;
        *(_QWORD *)(v6 + *((_QWORD *)this + 8) + 56) &= ~0x10000000000000uLL;
      }
    }
    v2 = *((_QWORD *)this + 8);
  }
