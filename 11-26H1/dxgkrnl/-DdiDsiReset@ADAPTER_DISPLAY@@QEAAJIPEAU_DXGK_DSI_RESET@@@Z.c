/*
 * XREFs of ?DdiDsiReset@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_RESET@@@Z @ 0x1401AEB18
 * Callers:
 *     ?DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z @ 0x14027E790 (-DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDsiReset(ADAPTER_DISPLAY *this, unsigned int a2, struct _DXGK_DSI_RESET *a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 5146);
