/*
 * XREFs of ?QueueDurationViolationWorkItem@@YAXPEAVDXGADAPTER@@IPEAU_MOCKDRIVERSTATE_DURATION@@@Z @ 0x14007F114
 * Callers:
        ...
        struct _MOCKDRIVERSTATE_DURATION *a3)
{
  ...
  DxgkLogInternalTriageEvent(
    ...
    0x40000,
    -1,
    (__int64)L"Setting different durations on different planes of VidPnSourceId:0x%I64x. See ?? (dxgkrnl!MOCKDRIVERSTATE_D"
              "URATION*)(0x%I64x) for details",
    v5,
    (__int64)a3,
    0LL,
    0LL,
