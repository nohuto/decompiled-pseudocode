/*
 * XREFs of ?AcquireCPU@DXGDXGIKEYEDMUTEX@@QEAAJ_KHPEAT_LARGE_INTEGER@@PEAVDXGCONTEXT@@W4_OUTPUTDUPL_MUTEX_TYPE@@@Z @ 0x1402B1F10
 * Callers:
        ...
        int a6)
{
  ...
  v8 = *(_QWORD *)(a1 + 24LL * a6 + 32);
  if ( v8 != PsGetCurrentProcess(a1) )
  {
    WdLogSingleEntry0(1LL);
