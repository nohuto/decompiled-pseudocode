/*
 * XREFs of DpiMiracastHandlePowerCallback @ 0x140410650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiMiracastHandlePowerCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      if ( *Value )
      {
        if ( byte_140168DDA && KeCancelTimer(&Timer) )
        {
          _InterlockedIncrement(&dword_1401692B8);
          v13 = 0LL;
          v8 = 6;
          v10 = 0LL;
          v9 = 64;
      ...
      {
        byte_140168DDA = 1;
        if ( dword_1401692A0 && byte_140168DD8 )
        {
