/*
 * XREFs of ?VailRegisterCompositionSurfaceProxy@DXGSESSIONDATA@@QEAAJPEAVDXGCOMPOSITIONSURFACEPROXY@@@Z @ 0x14020ECA8
 * Callers:
        ...
        struct DXGCOMPOSITIONSURFACEPROXY *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v5 && ExAcquireRundownProtection(v5 + 8) )
    {
      ...
      {
        DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v11, (struct DXGFASTMUTEX *const)&this[2372][2], 0);
        DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v11);
