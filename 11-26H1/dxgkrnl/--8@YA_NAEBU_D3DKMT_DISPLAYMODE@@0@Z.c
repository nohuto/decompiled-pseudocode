/*
 * XREFs of ??8@YA_NAEBU_D3DKMT_DISPLAYMODE@@0@Z @ 0x1403170F0
 * Callers:
...
char __fastcall operator==(unsigned int *a1, __int64 a2)
{
  ...
  v9 = a1 + 5;
  v10 = (_DWORD *)(a2 + 20);
  if ( a1[4] != *(_DWORD *)(a2 + 16) || *v9 != *v10 )
  {
    WdLogSingleEntry4(7LL, v4, v6, v7, v8);
    WdLogGlobalForLineNumber = 2022;
    WdLogSingleEntry4(7LL, a1[4], (unsigned int)*v9, *(unsigned int *)(a2 + 16), (unsigned int)*v10);
