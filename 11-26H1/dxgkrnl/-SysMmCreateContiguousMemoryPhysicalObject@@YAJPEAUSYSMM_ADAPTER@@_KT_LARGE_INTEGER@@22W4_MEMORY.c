/*
 * XREFs of ?SysMmCreateContiguousMemoryPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KT_LARGE_INTEGER@@22W4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@PEAPEAX@Z @ 0x14003F8CC
 * Callers:
 ...
 *     SysMmTestCreateContiguousMemoryPhysicalObject @ 0x14009D410 (SysMmTestCreateContiguousMemoryPhysicalObject.c)
 * Callees:
...
LABEL_7:
    ...
    {
      _InterlockedIncrement(&dword_140169720);
      ...
      DxgkLogInternalTriageEvent(
        ...
        262145,
        -1,
        (__int64)L"Failed to allocate contiguous memory from MmAllocateContiguousMemorySpecifyCache, Size=%I64u, CacheType=%u",
        a2,
        v13,
        0LL,
        0LL,
