/*
 * XREFs of ?SmmOpenPhysicalObject@@YAJPEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADAPTER@@@Z @ 0x140040410
 * Callers:
 *     ?SysMmOpenPhysicalObject@@YAJPEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADAPTER@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x14003F1A0 (-SysMmOpenPhysicalObject@@YAJPEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADAPTER@@PEAPEAUSYSMM_ADAPTER_.c)
 ...
 *     SmmAddObjectToAdapter @ 0x140040740 (SmmAddObjectToAdapter.c)
...
__int64 __fastcall SmmOpenPhysicalObject(struct SYSMM_PHYSICAL_OBJECT *a1, struct SYSMM_ADAPTER *a2)
{
  ...
  if ( (v5 & 4) != 0 )
  {
    v10 = (__int64 (__fastcall *)(struct SYSMM_ADAPTER *, unsigned __int64, unsigned __int64 *, __int64))*((_QWORD *)a2 + 40);
    v11 = *(_QWORD *)a1;
    if ( v10 )
    {
      v12 = *((_QWORD *)a2 + 42);
      ...
      *((_BYTE *)a1 + 100) = 1;
      ...
      {
        (*((void (__fastcall **)(struct SYSMM_ADAPTER *, unsigned __int64, _QWORD))a2 + 41))(
          a2,
          v20,
          *((_QWORD *)a2 + 42));
        goto LABEL_35;
  ...
  else if ( (v5 & 1) == 0 || (dword_1401696C0 & 0x18) != 0 )
  {
    LogicalAddressAt = 0;
  }
  else
...
LABEL_35:
  ...
  if ( v18 )
  {
    SmmFreeLogicalAddress(*((struct SYSMM_LOGICAL_ALLOCATOR **)a2 + 44), v18);
    *((_QWORD *)a1 + 11) = 0LL;
  }
LABEL_11:
  ...
  if ( LogicalAddressAt >= 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnl_SysMmEnableBits & 1) != 0 )
      McTemplateK0ppp_EtwWriteTransfer(
        SysMmControlGuid_Context,
        (const EVENT_DESCRIPTOR *)"\a",
        v8,
        a2,
        a1,
        (char *)a1 + 64);
