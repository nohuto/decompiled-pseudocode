/*
 * XREFs of ?DdiCreateVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEVIRTUALGPU@@@Z @ 0x140218B50
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCreateVirtualGpu(ADAPTER_RENDER *this, struct _DXGKARG_CREATEVIRTUALGPU *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5100);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1064LL)
                                                                         + 64LL))(
