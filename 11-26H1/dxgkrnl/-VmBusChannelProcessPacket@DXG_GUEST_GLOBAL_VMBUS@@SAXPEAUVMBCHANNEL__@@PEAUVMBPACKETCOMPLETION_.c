/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x140084450
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v13 )
    {
      ...
      else
      {
        ...
        if ( v15 )
        {
          ...
          v16[3].WorkerRoutine = (PWORKER_THREAD_ROUTINE)((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_140168448)(a1);
          LODWORD(v16[4].Parameter) = *((_DWORD *)DXGGLOBAL::GetGlobal() + 438);
          ExQueueWorkItem(v16, CustomPriorityWorkQueue|MaximumWorkQueue|0x8);
          goto LABEL_28;
        }
        WdLogSingleEntry0(6LL);
        WdLogGlobalForLineNumber = 15372;
