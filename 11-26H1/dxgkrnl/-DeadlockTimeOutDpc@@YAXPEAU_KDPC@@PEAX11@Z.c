/*
 * XREFs of ?DeadlockTimeOutDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x14006EC00
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v28 = *(_QWORD *)(v4 + 412);
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4936), UnbiasedInterruptTime, 0LL) )
  {
    ...
    if ( (unsigned int)dword_140166660 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140166660, 0x400000004000LL) )
      {
        ...
        v15 = *(_DWORD *)(v4 + 3256);
        v16 = *(unsigned __int8 *)(v4 + 3093);
        v17 = *(_DWORD *)(v4 + 4968);
        v18 = *(_DWORD *)(v4 + 4964);
        v19 = *(unsigned __int8 *)(v4 + 209);
        v8 = UnbiasedInterruptTime - *(_QWORD *)DeferredContext;
        v20 = *(unsigned __int8 *)(v4 + 2988);
        v21 = *(unsigned __int8 *)(v4 + 2983);
        v22 = *(_DWORD *)(v4 + 296);
        v35 = *(_WORD *)(v4 + 3044);
        v30 = *(_QWORD *)(v4 + 2048);
        v31 = *(void **)(v4 + 2040);
