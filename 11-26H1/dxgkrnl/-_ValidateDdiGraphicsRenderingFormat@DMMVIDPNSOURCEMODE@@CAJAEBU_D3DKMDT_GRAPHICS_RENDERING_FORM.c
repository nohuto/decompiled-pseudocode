/*
 * XREFs of ?_ValidateDdiGraphicsRenderingFormat@DMMVIDPNSOURCEMODE@@CAJAEBU_D3DKMDT_GRAPHICS_RENDERING_FORMAT@@@Z @ 0x1400417E0
 * Callers:
        ...
        const struct _D3DKMDT_GRAPHICS_RENDERING_FORMAT *a1)
{
  ...
  else
  {
    ...
    p_cy = &a1->VisibleRegionSize.cy;
    if ( (unsigned int)v2 < 0x64 || *p_cy < 0x64 )
    {
      WdLogSingleEntry3(2LL, v2, *p_cy, a1);
      result = 3223192379LL;
