/*
 * XREFs of ?DeadlockPulseDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x14006E8F0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( UnbiasedInterruptTime - v6 > 10000 * (unsigned __int64)(v8 - *((_DWORD *)DeferredContext + 4))
    && v6 == _InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4944), UnbiasedInterruptTime, v6) )
  {
    if ( (unsigned int)dword_140166660 > 5 && tlgKeywordOn((__int64)&dword_140166660, 0x400000004000LL) )
    {
      LOBYTE(v10) = 1;
      v15 = DeferredContext[240];
      IsDebuggerPresent = (unsigned __int8)WdIsDebuggerPresent(v10);
      v17 = *(_DWORD *)(v4 + 3256);
      v18 = *(unsigned __int8 *)(v4 + 3093);
      v19 = *(_DWORD *)(v4 + 4968);
      v20 = *(_DWORD *)(v4 + 4964);
      v21 = *(unsigned __int8 *)(v4 + 209);
      v22 = *(unsigned __int8 *)(v4 + 2988);
      v23 = *(unsigned __int8 *)(v4 + 2983);
      v24 = *(_DWORD *)(v4 + 296);
      v37 = *(_WORD *)(v4 + 3044);
      v32 = *(_QWORD *)(v4 + 2048);
      v33 = *(void **)(v4 + 2040);
