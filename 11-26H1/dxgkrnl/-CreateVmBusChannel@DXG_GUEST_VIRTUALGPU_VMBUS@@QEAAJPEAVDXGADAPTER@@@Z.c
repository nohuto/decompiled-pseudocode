/*
 * XREFs of ?CreateVmBusChannel@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGADAPTER@@@Z @ 0x1403BE250
 * Callers:
...
__int64 __fastcall DXG_GUEST_VIRTUALGPU_VMBUS::CreateVmBusChannel(struct VMBCHANNEL__ **this, struct DXGADAPTER *a2)
{
  ...
  {
    v12 = (struct VMBCHANNEL__ *)operator new(0x18uLL, 0x4B677844u, 64LL);
    this[7] = v12;
    if ( !v12 )
      return 3221225495LL;
    KeInitializeEvent((PRKEVENT)v12, NotificationEvent, 0);
  }
  v5 = *((_QWORD *)a2 + 27);
  v27 = *(_DWORD *)L"t";
  *(_QWORD *)&v17.Length = 2359330LL;
  ...
  v25 = 0LL;
  Timeout[0].LowPart = 0;
  v6 = DpReadDeviceSpace(v5, 0LL, &v25, 0xC0u, 0x10u, (ULONG *)Timeout);
  v7 = v6;
  if ( v6 >= 0 && Timeout[0].LowPart == 16 )
  {
    v8 = (struct _DEVICE_OBJECT *)*((_QWORD *)a2 + 27);
    v9 = v25;
    *(_QWORD *)((char *)a2 + 4820) = v25;
    *(_OWORD *)&Timeout[0].LowPart = v9;
    v24 = (struct _GUID)DxgkPerVirtualGpuVmBusChannelType;
    v10 = CreateClientVmBusChannel(
            a2,
            v8,
            &v24,
    ...
    {
      WdLogSingleEntry1(2LL);
      WdLogGlobalForLineNumber = 13631;
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
  ...
  {
    WdLogSingleEntry1(2LL);
    WdLogGlobalForLineNumber = 13597;
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
