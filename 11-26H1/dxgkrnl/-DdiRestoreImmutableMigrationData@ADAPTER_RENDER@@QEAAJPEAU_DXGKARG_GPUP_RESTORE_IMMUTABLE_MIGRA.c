/*
 * XREFs of ?DdiRestoreImmutableMigrationData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA@@@Z @ 0x14021ABB8
 * Callers:
        ...
        struct _DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5184);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GPUP_RESTORE_IMMUTABLE_MIGRATION_DATA *))(*((_QWORD *)this + 2)
                                                                                              + 1640LL))(
