/*
 * XREFs of ?DdiStartDirtyTracking@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1401B2B10
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiStartDirtyTracking(ADAPTER_RENDER *this, void *const a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5178);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1584LL))(
        ...
        (int)v9 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"The driver failed DxgkDdiStartDirtyTracking. Status: 0x%I64x",
      v9,
      0LL,
      0LL,
      0LL,
