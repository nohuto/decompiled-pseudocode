/*
 * XREFs of ?VidMmQueryProcessSegmentGroupStatistics@VIDMM_EXPORT@@QEAAJPEAVVIDMM_GLOBAL@@GW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEAVDXGPROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_GROUP_INFORMATION@@@Z @ 0x14007438C
 * Callers:
        ...
        struct _D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_GROUP_INFORMATION *a6)
{
  ...
  return (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, _QWORD, _QWORD, __int64, struct _D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_GROUP_INFORMATION *))(*((_QWORD *)this + 1) + 320LL))(
           a2,
           a3,
           a4,
           v7,
