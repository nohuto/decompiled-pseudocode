/*
 * XREFs of ?AcquireFirstFrequencyRangeInfo@DXGK_MONITORFREQUENCYRANGESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORFREQUENCYRANGESET__@@PEAPEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x1402710F0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_MONITOR_FREQUENCY_RANGE **a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v17, 7024);
