/*
 * XREFs of ?DisablePrimaryAllocation@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@PEAVDXGALLOCATION@@@Z @ 0x1402D0A10
 * Callers:
        ...
        struct DXGALLOCATION *a3)
{
  ...
  bool v13; // bl
  struct DXGADAPTERALLOCATION *v14; // rbx
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pDevice != NULL", 3517LL, 0LL, 0LL, 0LL, 0LL);
  }
  v7 = (char *)a3 + 48;
  if ( !a3 || !*(_QWORD *)v7 )
  {
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(this[2]) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 3521LL, 0LL, 0LL, 0LL, 0LL);
  }
    ...
    && (*(_DWORD *)(*((_QWORD *)a3 + 6) + 4LL) & 0x10) == 0 )
  {
    ...
    else
    {
      ...
      {
        v14 = (struct DXGADAPTERALLOCATION *)*((_QWORD *)a3 + 6);
        v13 = ADAPTER_DISPLAY::GetCddPrimaryAllocation((ADAPTER_DISPLAY *)this, v8, 0) == v14;
      }
      ...
      if ( v13 )
      {
        ...
        DXGADAPTER::DecrementVSyncWaiter(*(DXGADAPTER **)(*((_QWORD *)VidPnSourceOwner + 2) + 16LL), v8);
      ...
      v16 = *((_DWORD *)VidPnSourceOwner + 116);
      if ( v16 != 2 )
      {
        if ( v16 )
        {
          DXGDEVICE::UnpinPrimaryAllocations(VidPnSourceOwner, v8);
          if ( *(int *)(*(_QWORD *)(*((_QWORD *)VidPnSourceOwner + 2) + 16LL) + 3044LL) < 2200 )
            DXGDEVICE::UnpinAllDirectFlipAllocations(VidPnSourceOwner, v8, v17, v18);
        }
        else
        {
