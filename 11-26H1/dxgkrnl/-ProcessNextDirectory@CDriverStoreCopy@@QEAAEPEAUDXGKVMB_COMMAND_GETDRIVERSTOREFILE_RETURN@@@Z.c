/*
 * XREFs of ?ProcessNextDirectory@CDriverStoreCopy@@QEAAEPEAUDXGKVMB_COMMAND_GETDRIVERSTOREFILE_RETURN@@@Z @ 0x1401D7994
 * Callers:
        ...
        struct DXGKVMB_COMMAND_GETDRIVERSTOREFILE_RETURN *a2)
{
  ...
  *((_QWORD *)v7 + 1) = v5;
  if ( v6 == v5 )
    return 0;
  *((_DWORD *)a2 + 4) = RtlStringCbCopyW((char *)a2 + 60, 0x208uLL, (char *)v6 - 520);
