/*
 * XREFs of Feature_IdSwapChainUserModeSync__private_IsEnabledFallback @ 0x140067938
 * Callers:
...
__int64 __fastcall Feature_IdSwapChainUserModeSync__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
