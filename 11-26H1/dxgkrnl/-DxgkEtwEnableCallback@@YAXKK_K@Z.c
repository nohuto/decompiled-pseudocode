/*
 * XREFs of ?DxgkEtwEnableCallback@@YAXKK_K@Z @ 0x14005ABCC
 * Callers:
...
void __fastcall DxgkEtwEnableCallback(int a1, char a2, __int64 a3, int a4)
{
  ...
  if ( a1 == 2 && bTracingEnabled )
  {
    ...
    else
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0qxq_EtwWriteTransfer(2, a2, a3, a4, qword_1401664C0, a2);
      DxgkReportGlobalState();
    }
    goto LABEL_7;
  }
  if ( qword_1401664C0 == g_OldAnyKeywords )
    goto LABEL_7;
  v7 = 4096LL;
  v8 = (qword_1401664C0 & 0x1000) != 0 && (qword_1401664C0 & 0x2000) == 0;
  if ( (g_OldAnyKeywords & 0x1000) != 0 )
  {
    if ( (qword_1401664C0 & 0x1000) == 0 )
      DxgkDisableStablePowerState();
  }
  else if ( (qword_1401664C0 & 0x1000) != 0 && v8 )
  {
  ...
  LOBYTE(v7) = a2;
  DpiControlEtwLogging(v9, qword_1401664C0 & 0x3000, v7);
LABEL_28:
  if ( _bittest64((const signed __int64 *)&g_OldAnyKeywords, 0xEu) )
  {
    if ( !_bittest64(&qword_1401664C0, 0xEu) )
    {
  ...
  else if ( _bittest64(&qword_1401664C0, 0xEu) )
  {
...
LABEL_33:
  ...
  {
    LOBYTE(v11) = *((_BYTE *)DXGGLOBAL::GetGlobal() + 305736);
    v16 = qword_1401664C8;
    v14 = (unsigned __int8)byte_1401664D8;
    v17 = qword_1401664C0;
    v19 = v11;
    v15 = 1;
    v20 = 2;
...
LABEL_7:
  if ( (qword_1401664C0 & 0x461C8ED7) == 0 || (qword_1401664C8 & 0xFFFFFFFFB9E37128uLL) != 0 )
    v4 = 0;
  bTracingEnabled = v4;
  g_OldAnyKeywords = qword_1401664C0;
}
