/*
 * XREFs of ?AddDriverWhiteboxInfo@DISPLAYDIAGNOSTICADAPTERDATA@@AEAAJXZ @ 0x1401C9160
 * Callers:
...
__int64 __fastcall DISPLAYDIAGNOSTICADAPTERDATA::AddDriverWhiteboxInfo(struct DXGADAPTER **this)
{
  ...
  if ( !ADAPTER_DISPLAY::IsDisplayDiagnosticsInterfaceSupported(*((ADAPTER_DISPLAY **)*this + 395)) )
    return 3221225659LL;
