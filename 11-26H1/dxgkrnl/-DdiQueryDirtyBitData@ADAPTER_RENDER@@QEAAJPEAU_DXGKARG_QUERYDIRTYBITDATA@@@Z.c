/*
 * XREFs of ?DdiQueryDirtyBitData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYDIRTYBITDATA@@@Z @ 0x1404253AC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiQueryDirtyBitData(ADAPTER_RENDER *this, struct _DXGKARG_QUERYDIRTYBITDATA *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5180);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDIRTYBITDATA *))(*((_QWORD *)this + 2) + 1600LL))(
  ...
  if ( (_DWORD)v9 == -1073741823
    || (_DWORD)v9 == -1073741811
    || (_DWORD)v9
    && (WdLogSingleEntry1(2LL),
        WdLogGlobalForLineNumber = 5433,
        ...
        (int)v9 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"The driver failed DxgkDdiQueryDirtyBitData. Status: 0x%I64x",
      v9,
      0LL,
      0LL,
      0LL,
