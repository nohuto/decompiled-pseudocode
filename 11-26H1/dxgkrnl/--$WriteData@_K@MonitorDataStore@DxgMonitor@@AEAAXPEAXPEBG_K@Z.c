/*
 * XREFs of ??$WriteData@_K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBG_K@Z @ 0x14027EE24
 * Callers:
 *     ?WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_K@Z @ 0x14027F740 (-WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_K@Z.c)
