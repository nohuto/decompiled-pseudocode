/*
 * XREFs of DpExcludeAdapterAccess @ 0x140237630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpExcludeAdapterAccess(PDEVICE_OBJECT DeviceObject, int a2, __int64 a3, __int64 a4)
{
  ...
  Blink = (int)DeviceExtension[128].Common.RemoveEvent.Header.WaitListHead.Blink;
  if ( Blink == 1 || Blink == 5 )
  {
    v9 = -1073741661;
    WdLogSingleEntry1(2LL);
  ...
  Pool2 = (_QWORD *)ExAllocatePool2(256LL, 32LL, 1953656900LL);
  if ( !Pool2 )
  {
    v9 = -1073741801;
    WdLogSingleEntry1(6LL);
...
LABEL_30:
  ...
  *Pool2 = a3;
  Pool2[1] = a4;
  *((_DWORD *)Pool2 + 4) = a2;
  Pool2[3] = (unsigned __int64)&Event & -(__int64)(v11 != 0);
  v9 = IoAcquireRemoveLockEx(DeviceExtension + 2, WorkItem, File, 1u, 0x20u);
  if ( (v9 & 0x80000000) != 0 )
  {
    WdLogSingleEntry1(3LL);
