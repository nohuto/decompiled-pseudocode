/*
 * XREFs of ?GetMmioRanges@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETMMIORANGES@@@Z @ 0x1402149F0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetMmioRanges(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4)
{
  unsigned int v5; // ebx
