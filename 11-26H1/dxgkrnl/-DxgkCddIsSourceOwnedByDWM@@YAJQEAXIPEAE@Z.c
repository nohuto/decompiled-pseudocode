/*
 * XREFs of ?DxgkCddIsSourceOwnedByDWM@@YAJQEAXIPEAE@Z @ 0x14040ED60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddIsSourceOwnedByDWM(DXGADAPTER *a1, unsigned int a2, bool *a3)
{
  ...
  if ( *((_DWORD *)a1 + 50) == 1 )
  {
    v7 = (ADAPTER_DISPLAY *)*((_QWORD *)a1 + 395);
    if ( v7 )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000,
        -1,
        (__int64)L"Adapter 0x%I64x does not have VidPn source 0x%I64x, returning 0x%I64x.",
        (__int64)a1,
        v4,
        -1073741811LL,
        0LL,
    ...
    else
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0x40000,
        -1,
        (__int64)L"Adapter 0x%I64x is not a display adapter, returning 0x%I64x.",
        (__int64)a1,
        -1073741811LL,
        0LL,
        0LL,
  ...
  else
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"Adapter 0x%I64x has been stopped, returning 0x%I64x.",
      (__int64)a1,
      -1073741130LL,
      0LL,
      0LL,
