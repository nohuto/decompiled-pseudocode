/*
 * XREFs of ?LogMdmStatusTelemetry@DISPLAY_MUX_MGR@@AEBAXW4DISPLAYCONFIG_DISPLAYMUX_RUNTIME_STATUS@@J_N@Z @ 0x14008CF20
 * Callers:
...
char __fastcall DISPLAY_MUX_MGR::LogMdmStatusTelemetry(__int64 a1, int a2, int a3, char a4)
{
  ...
  if ( a4 )
  {
    ...
    {
      LOBYTE(v4) = tlgKeywordOn((__int64)&dword_1401665B8, 512LL);
      if ( (_BYTE)v4 )
      {
        v32 = v8[8];
        v31 = *v8;
...
LABEL_8:
  ...
  else if ( (unsigned int)dword_1401665B8 > 5 )
  {
    LOBYTE(v4) = tlgKeywordOn((__int64)&dword_1401665B8, 0x400000000200LL);
    if ( (_BYTE)v4 )
    {
      v32 = v15[8];
      v31 = *v15;
