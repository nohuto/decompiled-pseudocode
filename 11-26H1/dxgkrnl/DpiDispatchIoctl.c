/*
 * XREFs of DpiDispatchIoctl @ 0x1403B3580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDispatchIoctl(__int64 a1, IRP *a2)
{
  ...
  v10 = *(__int64 (__fastcall **)(__int64, IRP *))(v8 + 120);
  v2 = 1;
  if ( !v10 )
  {
...
LABEL_9:
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
    McTemplateK0pt_EtwWriteTransfer((__int64)&DxgkControlGuid_Context, (__int64)&EventExitDpiDispatchIoctl);
