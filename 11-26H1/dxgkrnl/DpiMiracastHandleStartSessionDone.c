/*
 * XREFs of DpiMiracastHandleStartSessionDone @ 0x14024C928
 * Callers:
...
__int64 __fastcall DpiMiracastHandleStartSessionDone(char *P, __int64 a2, __int64 a3)
{
  ...
  *(_OWORD *)((char *)&v42[53] + 8) = v39;
  v42[55] = v40;
  return DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v42, 0x200000000uLL);
}
