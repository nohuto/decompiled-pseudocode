/*
 * XREFs of ?FindTokenQueue@CTokenManager@@IEAAJPEAVCompositionSurfaceObject@@PEAPEAVCTokenQueue@@@Z @ 0x140046CCC
 * Callers:
        ...
        struct CTokenQueue **a3)
{
  ...
  Buffer[0] = a2;
  Buffer[1] = 0LL;
  v4 = RtlLookupElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 192), Buffer);
  v5 = 0LL;
  if ( v4 )
