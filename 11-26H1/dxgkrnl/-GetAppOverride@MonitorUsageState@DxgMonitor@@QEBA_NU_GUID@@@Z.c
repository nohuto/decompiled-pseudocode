/*
 * XREFs of ?GetAppOverride@MonitorUsageState@DxgMonitor@@QEBA_NU_GUID@@@Z @ 0x140424120
 * Callers:
...
LABEL_3:
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64, wchar_t *, __int64 *))(*(_QWORD *)v6 + 72LL))(
          ...
          GuidString.Buffer,
          &v11)
    || (p_GuidString = 0LL, (int)DxgMonitor::MonitorUsageState::_GetAppOverrideKey(this, &GuidString, &p_GuidString) < 0) )
  {
    v9 = &GuidString;
