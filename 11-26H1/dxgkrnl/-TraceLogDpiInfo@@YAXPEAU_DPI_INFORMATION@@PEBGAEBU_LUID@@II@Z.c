/*
 * XREFs of ?TraceLogDpiInfo@@YAXPEAU_DPI_INFORMATION@@PEBGAEBU_LUID@@II@Z @ 0x14040EAC4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_140166660, 0x200000000001LL) )
    {
      v9 = *((_DWORD *)a1 + 23);
      v34 = (void *)a2;
      v11 = (v9 >> 10) & 1;
