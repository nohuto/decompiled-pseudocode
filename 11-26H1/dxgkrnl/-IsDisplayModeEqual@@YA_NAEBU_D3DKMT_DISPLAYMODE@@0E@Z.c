/*
 * XREFs of ?IsDisplayModeEqual@@YA_NAEBU_D3DKMT_DISPLAYMODE@@0E@Z @ 0x14005E620
 * Callers:
...
char __fastcall IsDisplayModeEqual(const struct _D3DKMT_DISPLAYMODE *a1, const struct _D3DKMT_DISPLAYMODE *a2, char a3)
{
  ...
  if ( !a3 )
  {
    ...
    Flags = (int)a1->Flags;
    v6 = (int)a2->Flags;
    if ( (((unsigned __int8)v6 ^ *(_BYTE *)&a1->Flags) & 1) != 0
      || (((unsigned __int8)Flags ^ (unsigned __int8)v6) & 2) != 0
  ...
  v10 = *((_DWORD *)&a1->Flags + 1);
  if ( (((unsigned __int8)v10 ^ (unsigned __int8)v9) & 0x10) != 0
    || (((unsigned __int8)v10 ^ (unsigned __int8)v9) & 0x20) != 0 )
  {
    return 0;
  }
  return v4;
