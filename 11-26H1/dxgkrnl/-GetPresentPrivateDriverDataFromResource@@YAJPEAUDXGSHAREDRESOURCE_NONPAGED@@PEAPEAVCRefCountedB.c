/*
 * XREFs of ?GetPresentPrivateDriverDataFromResource@@YAJPEAUDXGSHAREDRESOURCE_NONPAGED@@PEAPEAVCRefCountedBuffer@@PEAU_D3DDDI_GETRESOURCEPRESENTPRIVATEDRIVERDATA@@@Z @ 0x140054870
 * Callers:
        ...
        struct _D3DDDI_GETRESOURCEPRESENTPRIVATEDRIVERDATA *a3)
{
  ...
  if ( v8 )
  {
    ...
    if ( PrivateDriverDataSize < v10 )
    {
      ...
      v8 = 0LL;
      WdLogGlobalForLineNumber = 13996;
    }
    else
    {
