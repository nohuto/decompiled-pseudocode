/*
 * XREFs of ?_AddExternalPathsAdaptersCallback@BTL_TOPOLOGY_CONSTRUCTOR@@CAJPEAVDXGADAPTER@@PEAX@Z @ 0x14026BAC4
 * Callers:
        ...
        BTL_TOPOLOGY_CONSTRUCTOR *a2)
{
  ...
  v3 = *((_QWORD *)a1 + 395);
  if ( v3 && (!*((_BYTE *)a2 + 10) || *(_BYTE *)(v3 + 290)) )
    return BTL_TOPOLOGY_CONSTRUCTOR::_AddExternalPathsToTopology(a2, a1);
  else
    return 0LL;
}
