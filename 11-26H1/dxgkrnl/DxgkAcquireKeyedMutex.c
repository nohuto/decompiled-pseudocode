/*
 * XREFs of DxgkAcquireKeyedMutex @ 0x1401FE890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAcquireKeyedMutex(void *Src)
{
  __int64 v2; // rcx
  ...
  unsigned int v10[4]; // [rsp+68h] [rbp-30h] BYREF
  __int128 v11; // [rsp+78h] [rbp-20h] BYREF
  __int64 ULong64FromUser; // [rsp+A8h] [rbp+10h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v7, 2054);
