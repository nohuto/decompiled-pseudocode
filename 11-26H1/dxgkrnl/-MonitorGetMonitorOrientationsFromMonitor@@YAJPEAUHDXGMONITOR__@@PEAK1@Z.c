/*
 * XREFs of ?MonitorGetMonitorOrientationsFromMonitor@@YAJPEAUHDXGMONITOR__@@PEAK1@Z @ 0x14039588C
 * Callers:
 ...
 *     ?_GetMonitorOrientation@DXGMONITOR@@QEBAJPEAK0@Z @ 0x140395934 (-_GetMonitorOrientation@DXGMONITOR@@QEBAJPEAK0@Z.c)
 */
