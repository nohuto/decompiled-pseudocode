/*
 * XREFs of ?DdiSetTargetAnalogCopyProtection@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETANALOGCOPYPROTECTION@@@Z @ 0x1401B1E4C
 * Callers:
        ...
        const struct _DXGKARG_SETTARGETANALOGCOPYPROTECTION *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 5079);
  ...
  v9 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETANALOGCOPYPROTECTION *))(*((_QWORD *)this + 2)
                                                                                            + 1184LL))(
