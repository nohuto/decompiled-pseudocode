/*
 * XREFs of ?NotifyInterrupt@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@@Z @ 0x14005FD98
 * Callers:
        ...
        struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *a3)
{
  ...
  {
    v5 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(a2[395], a3->DmaCompleted.SubmissionFenceId);
    if ( v5 != -1 )
