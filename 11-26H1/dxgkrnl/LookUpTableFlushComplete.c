/*
 * XREFs of LookUpTableFlushComplete @ 0x1403FC990
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x140422260 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 * Callees:
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *(_QWORD *)(v5 + 288) )
    {
      if ( (unsigned int)dword_140167078 > 5 && tlgKeywordOn((__int64)&dword_140167078, 0x200000000000LL) )
      {
        v11 = 4;
        v37 = 42;
        v34 = L"SummaryCount";
