/*
 * XREFs of DpiSetTargetAdjustedColorimetry @ 0x140193BEC
 * Callers:
 *     ?SetTargetAdjustedColorimetry@KernelDriver@@UEAAJU_DXGK_COLORIMETRY@@I@Z @ 0x140405CD0 (-SetTargetAdjustedColorimetry@KernelDriver@@UEAAJU_DXGK_COLORIMETRY@@I@Z.c)
 * Callees:
