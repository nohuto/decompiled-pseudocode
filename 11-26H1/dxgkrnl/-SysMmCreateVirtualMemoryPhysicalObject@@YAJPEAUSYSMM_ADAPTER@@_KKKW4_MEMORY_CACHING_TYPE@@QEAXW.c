/*
 * XREFs of ?SysMmCreateVirtualMemoryPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKKW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x140287694
 * Callers:
 *     SysMmTestCreateVirtualMemoryPhysicalObject @ 0x14009D640 (SysMmTestCreateVirtualMemoryPhysicalObject.c)
 * Callees:
        ...
        __int64 a9)
{
  ...
  {
    _InterlockedIncrement(&dword_140169718);
