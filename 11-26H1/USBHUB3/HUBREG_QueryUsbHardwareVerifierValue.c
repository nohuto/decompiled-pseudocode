/*
 * XREFs of HUBREG_QueryUsbHardwareVerifierValue @ 0x14008A250
 * Callers:
...
LABEL_13:
    v15 = v23;
    LODWORD(v20) = v13;
    WPP_RECORDER_SF_d(v23, 2u, 5u, v14, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v20);
LABEL_44:
    *a7 = 0;
    if ( v11 != -1073741772 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v20) = v11;
      WPP_RECORDER_SF_d(v15, 2u, 5u, 0x11u, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v20);
    }
    goto LABEL_49;
  }
...
LABEL_47:
  ...
  {
    LODWORD(v20) = *a7;
    WPP_RECORDER_SF_d(v23, 2u, 5u, 0x12u, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v20);
  }
LABEL_49:
  if ( v21 )
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1848))(WdfDriverGlobals);
