/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedEndpointCompanionDescriptor @ 0x14003B28C
 * Callers:
  ...
  *a3 = v13;
  if ( !v12 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x4Au, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v11);
    v14 = 40LL;
LABEL_11:
    v15 = *(_QWORD *)(a2 + 40);
LABEL_12:
...
LABEL_24:
    if ( *a1 > 6u )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LODWORD(v35) = v11;
        LODWORD(v34) = *a1;
        WPP_RECORDER_SF_DDD(v10, 2u, v19, 0x4Du, v20, v34, v35, v36);
      }
    ...
    if ( (v22 & 4) == 0 )
    {
      ...
      {
        LODWORD(v34) = v11;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x4Eu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34);
      }
    ...
    *(_DWORD *)(a2 + 256) = v16;
    if ( *a3 > v37 )
    {
      if ( (unsigned __int8)HUBDESC_ShouldEnforceWin8ValidationImmutable(a2, v16, a3) )
        *v6 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LODWORD(v34) = v11;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x4Fu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34);
      }
      v14 = 44LL;
      goto LABEL_11;
    }
      ...
      case 0:
        if ( a1[2] )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[2];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x50u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( a1[3] )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[3];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x51u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LODWORD(v34) = v11;
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x52u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
        }
        v14 = 39LL;
        goto LABEL_11;
      case 1:
        ...
        *(_DWORD *)(a2 + 256) = v16 | (a1[3] >> 4) & 0xFFFFFF8;
        if ( a1[2] > 0xFu )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[2];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x5Bu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( (*(_DWORD *)(a2 + 256) & 8) == 0 && (a1[3] & 3) == 3 )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[3] & 3;
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x5Du, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( (a1[3] & 0x7C) != 0 )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[3];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x5Eu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
          v33 = (_BYTE *)(a2 + 40);
          (*(void (__fastcall **)(_QWORD, __int64, unsigned int *, __int64))(a2 + 24))(
            *(_QWORD *)(a2 + 40),
        ...
        if ( (*(_DWORD *)(a2 + 256) & 8) != 0 )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = *((unsigned __int16 *)a1 + 2);
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x60u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
            v33 = a6;
          }
          v15 = *(_QWORD *)v33;
          v14 = 204LL;
        ...
        v17 = 1;
        LODWORD(v16) = (a1[2] + 1) * *(unsigned __int16 *)(*(_QWORD *)(a2 + 192) + 4LL) * ((a1[3] & 3) + 1);
        if ( *((unsigned __int16 *)a1 + 2) > (unsigned int)v16 )
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      ...
      case 2:
        if ( a1[2] > 0xFu )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[2];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x53u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( (a1[3] & 0x1Fu) > 0x10 )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            ...
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x54u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( a1[3] >= 0x20u )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[3];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x55u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
          (*(void (__fastcall **)(_QWORD, __int64, unsigned int *, __int64))(a2 + 24))(
            *(_QWORD *)(a2 + 40),
            33LL,
        ...
        if ( *((_WORD *)a1 + 2) )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = *((unsigned __int16 *)a1 + 2);
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x56u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
      ...
      case 3:
        if ( a1[2] > 0xFu )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[2];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x57u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
        ...
        if ( a1[3] )
        {
          ...
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LODWORD(v35) = a1[3];
            LODWORD(v34) = v11;
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x59u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v34, v35);
          }
          (*(void (__fastcall **)(_QWORD, __int64, unsigned int *, __int64))(a2 + 24))(
            *(_QWORD *)(a2 + 40),
            47LL,
...
LABEL_34:
  ...
  {
    LOBYTE(v16) = 2;
    WPP_RECORDER_SF_(v10, v16, 5, 97, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  return v17;
}
