/*
 * XREFs of HUBDTX_DisarmDeviceForWakeUsingControlTransfer @ 0x14002B120
 * Callers:
 *     HUBDSM_DisarmingDeviceForWakeOnD0Entry @ 0x1400220C0 (HUBDSM_DisarmingDeviceForWakeOnD0Entry.c)
 *     HUBDSM_DisarmingDeviceForWakeOnPortResumed @ 0x1400220F0 (HUBDSM_DisarmingDeviceForWakeOnPortResumed.c)
 * Callees:
