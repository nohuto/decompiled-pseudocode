/*
 * XREFs of HUBUCX_EnableDisableEndpointsUsingUCXIoctl @ 0x140027134
 * Callers:
 ...
 *     HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency @ 0x140021D70 (HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency.c)
    ...
    if ( !*(_DWORD *)(a1 + 112) )
    {
      ...
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2560))(
        ...
        *(_QWORD *)(a1 + 2424),
        0LL);
      v2 = 4028;
      return (_UNKNOWN **)HUBSM_AddEvent(a1 + 512, v2);
    }
    if ( (*(_DWORD *)(a1 + 1644) & 0x8000) != 0 )
    {
      ...
      for ( i = *v4; ; i = (_QWORD *)*i )
      {
        ...
        {
          if ( LODWORD(v7[10 * j + 6]) == 3 )
            LODWORD(v7[10 * j + 6]) = 6;
        }
      }
      *(_DWORD *)(a1 + 1572) = -2147481856;
      *(_DWORD *)(a1 + 1568) = -1073741823;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(
          *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1432LL),
          4,
  ...
  *(_QWORD *)(v8 + 64) = *(_QWORD *)(a1 + 136);
  if ( *(_QWORD *)(a1 + 48) != -32LL )
  {
    *(_BYTE *)(v8 + 80) = *(_BYTE *)(*(_QWORD *)(a1 + 48) + 37LL);
    ...
    {
      for ( k = 0LL; k < 2; ++k )
        *(_BYTE *)(k + v8 + 81) = *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 32LL) + k + 2);
    }
  }
