/*
 * XREFs of HUBDESC_InternalValidateHighSpeedIsochEndpointCompanionDescriptor @ 0x140039000
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( (unsigned __int16)v9 > 0xDFu )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      LOWORD(v9) = WPP_RECORDER_SF_d(a5, 3u, 5u, 0x6Bu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v11);
    goto LABEL_39;
  }
  v15 = *(_DWORD *)(a2 + 4) == 2;
  v16 = *a1;
  *a3 = v16;
  if ( !v15 )
  {
    *v5 = 2;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x6Cu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v11);
...
LABEL_17:
    if ( *a1 > 8u )
    {
      *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_DDD(v10, 2u, v14, 0x6Fu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
    ...
    if ( (*(_DWORD *)(a2 + 256) & 0x10) == 0 )
    {
      *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x70u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v11);
      v18 = 267LL;
LABEL_25:
    ...
    if ( *a3 > v23 )
    {
      *v5 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x71u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v11);
      v18 = 270LL;
      goto LABEL_25;
    }
    v9 = *((_DWORD *)a1 + 1);
...
LABEL_38:
  ...
  *v5 = 2;
  ...
  if ( v12 >= 8 )
  {
    *a3 = 8;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DDDD(v10, 2u, 5u, 0x6Eu, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
    v13 = &WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids;
    goto LABEL_17;
  }
  *v5 = 1;
...
LABEL_39:
  ...
  {
    LOBYTE(v13) = 2;
    LOWORD(v9) = WPP_RECORDER_SF_(v10, (_DWORD)v13, 5, 115, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  return v9;
}
