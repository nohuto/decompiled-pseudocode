/*
 * XREFs of HUBPSM20_EngagingSDM845HighSpeedWorkaround @ 0x1400129C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_EngagingSDM845HighSpeedWorkaround(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v6 = v4;
    WPP_RECORDER_SF_d(v3[179], 4u, 5u, 0x7Eu, (__int64)&WPP_dde998bf8bb3310d95d4227a99ba80b7_Traceguids, v6);
  }
  return 3013LL;
}
