/*
 * XREFs of HUBPSM30_SettingU2TImeOut @ 0x1400146D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM30_SettingU2TImeOut(__int64 a1)
{
  ...
  *(_BYTE *)(v1 + 173) = *(_BYTE *)(*(_QWORD *)(v1 + 1328) + 2221LL);
  *(_BYTE *)(v1 + 172) = *(_BYTE *)(v1 + 200);
  *(_WORD *)(v1 + 174) = 0;
  v3 = (__int64 *)(v1 + 1432);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v8 = *(unsigned __int8 *)(*(_QWORD *)(v1 + 1328) + 2221LL);
    v6 = *(unsigned __int16 *)(v1 + 200);
    WPP_RECORDER_SF_dD(*v3, 4u, 4u, 0x3Eu, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v6, v8);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x3Fu, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v7);
    }
