/*
 * XREFs of HUBREG_ValidateAndPopulateEndpointPriorities @ 0x14003559C
 * Callers:
...
char __fastcall HUBREG_ValidateAndPopulateEndpointPriorities(__int64 a1, __int64 a2)
{
  ...
  NTSTRSAFE_PCWSTR pszSrc[2]; // [rsp+B0h] [rbp-50h] BYREF
  NTSTRSAFE_PCWSTR v34[2]; // [rsp+C0h] [rbp-40h]
  NTSTRSAFE_PCWSTR v35[2]; // [rsp+D0h] [rbp-30h]
  wchar_t *Str[2]; // [rsp+E0h] [rbp-20h] BYREF
