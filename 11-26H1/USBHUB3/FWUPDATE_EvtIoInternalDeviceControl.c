/*
 * XREFs of FWUPDATE_EvtIoInternalDeviceControl @ 0x140041CF0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall FWUPDATE_EvtIoInternalDeviceControl(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( *(_BYTE *)(v11 + 24) == 1 )
  {
    ...
    {
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(v12 + 2536), v10, 3, 23, (__int64)&WPP_2fd11ae104fa34a9334eddada324a17a_Traceguids);
    }
    v7 = -1073741810;
    goto LABEL_81;
  }
  *(_QWORD *)&v34 = 0x800000010LL;
  if ( a5 != 2228227 )
  {
    if ( a5 == 2228243 )
    {
  ...
  *(_DWORD *)(*((_QWORD *)&v31 + 1) + 4LL) = 0;
  switch ( v18 )
  {
    case 0:
      ...
      {
        LOBYTE(v18) = 4;
        WPP_RECORDER_SF_(*(_QWORD *)(v12 + 2536), v18, 3, 27, (__int64)&WPP_2fd11ae104fa34a9334eddada324a17a_Traceguids);
      }
      goto LABEL_63;
    case 1:
      if ( *(_WORD *)v8 != 56
...
LABEL_78:
      ...
      if ( *(_BYTE *)(v8 + 131) == 1 )
      {
        ...
        *((_WORD *)v20 + 4) = *(_WORD *)(v12 + 2480);
        *((_WORD *)v20 + 5) = *(_WORD *)(v12 + 2482);
        *((_WORD *)v20 + 6) = *(_WORD *)(v12 + 2484);
        *((_WORD *)v20 + 1) = *(_WORD *)(v12 + 2474);
        *((_BYTE *)v20 + 7) = *(_BYTE *)(v12 + 2479);
      }
      else
      {
        if ( *(_BYTE *)(v8 + 131) != 2 )
...
LABEL_50:
  ...
  *(_DWORD *)(v8 + 4) = -2147482880;
  ...
  {
    LOBYTE(v18) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v12 + 2536), v18, 3, 30, (__int64)&WPP_2fd11ae104fa34a9334eddada324a17a_Traceguids);
  }
LABEL_81:
  result = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
             WdfDriverGlobals,
