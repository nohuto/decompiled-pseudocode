/*
 * XREFs of HUBDTX_SetDeviceInterfaceUsingControlTransfer @ 0x14002BFF4
 * Callers:
 *     HUBDSM_SettingDeviceInterfaceInSettingInterfaceOnFailureForCompat @ 0x1400245C0 (HUBDSM_SettingDeviceInterfaceInSettingInterfaceOnFailureForCompat.c)
 * Callees:
