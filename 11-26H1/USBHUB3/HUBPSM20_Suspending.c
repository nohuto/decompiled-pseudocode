/*
 * XREFs of HUBPSM20_Suspending @ 0x140013660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_Suspending(__int64 a1)
{
  ...
  *(_DWORD *)(v1 + 172) = *(unsigned __int16 *)(v1 + 200);
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x42u, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v6);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x43u, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v7);
    }
