/*
 * XREFs of HUBHTX_Get30PortChangeEvent @ 0x140003AF0
 * Callers:
 ...
 *     HUBPSM30_EnablingInterruptsAndGettingPortEventInNoChange @ 0x140013C50 (HUBPSM30_EnablingInterruptsAndGettingPortEventInNoChange.c)
 * Callees:
...
__int64 __fastcall HUBHTX_Get30PortChangeEvent(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *((_WORD *)v3 + 96) = v6;
  ...
  if ( (v8 & 8) != 0 )
  {
    ...
    if ( _bittest((const signed __int32 *)(a1 + 2608), 9u) )
      HUBMISC_VerifierDbgBreak("HubHwVerifierPortOverCurrent", v3 + 34);
    if ( (byte_140070D4A & 1) != 0 )
      McTemplateK0qhhhqhhh_EtwWriteTransfer(
        a1,
        ...
        || *(_BYTE *)(*v3 + 240LL) )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_dD(
            ...
            (v6 >> 5) & 0xF,
            v6 & 1);
        if ( _bittest((const signed __int32 *)(*v3 + 2608LL), 8u) )
