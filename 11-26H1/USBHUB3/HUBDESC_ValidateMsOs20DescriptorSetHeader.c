/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSetHeader @ 0x14003F710
 * Callers:
...
char __fastcall HUBDESC_ValidateMsOs20DescriptorSetHeader(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( (*(_BYTE *)v3 & 2) != 0 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_(*v7, a2, 5, 319, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
    }
  ...
  {
    LOBYTE(a2) = 2;
    WPP_RECORDER_SF_(*v7, a2, 5, 321, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  return v4;
}
