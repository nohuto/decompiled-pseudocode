/*
 * XREFs of HUBDESC_ValidateMsOs20FunctionSubset @ 0x14003F830
 * Callers:
 *     <none>
 * Callees:
...
LABEL_36:
    ...
    LOBYTE(v9) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), v9, 5, v18, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
    goto LABEL_36;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_d(
...
LABEL_38:
  ...
  {
    LOBYTE(v9) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), v9, 5, 337, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  return v7;
}
