/*
 * XREFs of HUBPDO_ReleaseWdfPowerReferenceOnHub @ 0x14001A888
 * Callers:
 *     HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure @ 0x140023950 (HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure.c)
 * Callees:
...
void __fastcall HUBPDO_ReleaseWdfPowerReferenceOnHub(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 1644) & 0x100) != 0 )
  {
    ...
    KeLowerIrql(v2);
    _InterlockedAnd((volatile signed __int32 *)(a1 + 1644), 0xFFFFFEFF);
  }
}
