/*
 * XREFs of HUBPSM30_EnablingRemoteWakeOnPort @ 0x140013C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM30_EnablingRemoteWakeOnPort(__int64 a1)
{
  ...
  *(_WORD *)(v1 + 174) = 0;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x36u, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v6);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x37u, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v7);
    }
