/*
 * XREFs of HUBDTX_GetBOSDescriptorUsingControlTransfer @ 0x14002B328
 * Callers:
 *     HUBDSM_GettingAlternateBOSDescriptor @ 0x140022600 (HUBDSM_GettingAlternateBOSDescriptor.c)
 * Callees:
