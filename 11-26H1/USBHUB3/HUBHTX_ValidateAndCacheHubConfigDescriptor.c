/*
 * XREFs of HUBHTX_ValidateAndCacheHubConfigDescriptor @ 0x140006504
 * Callers:
 *     HUBHSM_ValidatingHubConfigurationDescriptor @ 0x14000A3E0 (HUBHSM_ValidatingHubConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBHTX_ValidateAndCacheHubConfigDescriptor(__int64 a1)
{
  ...
  {
LABEL_7:
    v9 = *(unsigned __int16 *)(a1 + 2620);
    v10 = *(_QWORD *)(a1 + 1272);
    if ( (unsigned __int16)v9 >= *(_WORD *)(v10 + 2) )
