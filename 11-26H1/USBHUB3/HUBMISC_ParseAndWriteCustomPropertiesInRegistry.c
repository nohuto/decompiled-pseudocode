/*
 * XREFs of HUBMISC_ParseAndWriteCustomPropertiesInRegistry @ 0x140086E00
 * Callers:
 *     HUBDSM_WritingCustomPropertiesInRegistry @ 0x140026220 (HUBDSM_WritingCustomPropertiesInRegistry.c)
 * Callees:
