/*
 * XREFs of HUBHTX_DisablePortUsingControlTransfer @ 0x1400035EC
 * Callers:
 *     HUBPSM20_DisablingPortOnPortCycleWithTimer @ 0x140012880 (HUBPSM20_DisablingPortOnPortCycleWithTimer.c)
 * Callees:
