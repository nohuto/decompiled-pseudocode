/*
 * XREFs of HUBFDO_PowerSettingCallback @ 0x14000ECE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_PowerSettingCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  _DWORD v21[6]; // [rsp+40h] [rbp-58h] BYREF
  ...
  if ( *Value != *((_DWORD *)Context + 648) )
  {
    if ( ((unsigned int)Feature_RH1S__private_IsEnabledDeviceUsageNoInline()
      ...
      && *Value < *((_DWORD *)Context + 649) )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_LL(*((_QWORD *)Context + 317), v12, v13, v14);
    }
    else
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
