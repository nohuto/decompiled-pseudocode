/*
 * XREFs of HUBPARENT_GetInfoFromParentUsingParentIoctl @ 0x1400075CC
 * Callers:
 *     HUBHSM_GettingAdditionalInfoFromParent @ 0x140008EB0 (HUBHSM_GettingAdditionalInfoFromParent.c)
 * Callees:
...
LABEL_8:
    ...
    return HUBSM_AddEvent(a1 + 1280, 2038LL);
  }
  v16[1] = a1 + 2464;
  LOBYTE(v16[0]) = 15;
