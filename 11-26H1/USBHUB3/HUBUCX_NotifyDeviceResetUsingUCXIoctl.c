/*
 * XREFs of HUBUCX_NotifyDeviceResetUsingUCXIoctl @ 0x1400286F4
 * Callers:
 *     HUBDSM_NotifyingDeviceResetToUCXAfterReset2 @ 0x140023430 (HUBDSM_NotifyingDeviceResetToUCXAfterReset2.c)
 * Callees:
