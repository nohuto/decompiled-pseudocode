/*
 * XREFs of HUBDTX_GetConfigDescriptorWithDefaultSizeUsingControlTransfer @ 0x14002B42C
 * Callers:
 *     HUBDSM_GettingConfigDescriptorWhileRenuemrating @ 0x140022660 (HUBDSM_GettingConfigDescriptorWhileRenuemrating.c)
 * Callees:
...
__int64 __fastcall HUBDTX_GetConfigDescriptorWithDefaultSizeUsingControlTransfer(_QWORD *a1)
{
  ...
  a1[253] = 0LL;
  a1[252] = 0LL;
  result = HUBDTX_GetDescriptor((_DWORD)a1, (int)a1 + 1740, 255, 2, 0, 0);
  if ( (int)result < 0 )
  {
