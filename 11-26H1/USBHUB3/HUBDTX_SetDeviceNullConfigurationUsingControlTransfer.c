/*
 * XREFs of HUBDTX_SetDeviceNullConfigurationUsingControlTransfer @ 0x14002C108
 * Callers:
 *     HUBDSM_DeConfiguringDeviceOnClientRequest @ 0x1400217D0 (HUBDSM_DeConfiguringDeviceOnClientRequest.c)
 * Callees:
