/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpQueryDeviceTextPreprocess @ 0x140017F18
 * Callers:
...
LABEL_33:
  ...
  if ( !Length && *(_BYTE *)(v6 + 2011) && (*(_DWORD *)(v6 + 1652) & 1) == 0 )
  {
    a2->IoStatus.Information = 0LL;
    Size = CurrentStackLocation->Parameters.QueryInterface.Size;
    if ( Size )
    {
      v12 = *(unsigned __int8 **)(v6 + 2032);
      if ( v12 )
      {
        v13 = *v12;
...
LABEL_22:
    if ( Size != *(_WORD *)(v6 + 2048) )
    {
      ...
      *(_QWORD *)(v6 + 2040) = 0LL;
      KeClearEvent((PRKEVENT)(v6 + 480));
      HUBSM_AddEvent(v6 + 512, 4087);
      HUBMISC_WaitForSignal((PVOID)(v6 + 480));
    }
    v19 = *(unsigned __int8 **)(v6 + 2040);
    if ( v19
      || Size != 1033
      && (*(_WORD *)(v6 + 2048) = 1033,
          KeClearEvent((PRKEVENT)(v6 + 480)),
          HUBSM_AddEvent(v6 + 512, 4087),
          HUBMISC_WaitForSignal((PVOID)(v6 + 480)),
          (v19 = *(unsigned __int8 **)(v6 + 2040)) != 0LL) )
    {
      v20 = (unsigned __int16)((((unsigned __int64)*v19 - 2) >> 1) + 1);
      v21 = (wchar_t *)ExAllocatePool2(64LL, 2 * v20, 1681082453LL);
      Pool2 = v21;
      if ( !v21 )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      ...
      memmove(v21, (const void *)(*(_QWORD *)(v6 + 2040) + 2LL), 2 * v20 - 2);
      Pool2[v20 - 1] = 0;
      goto LABEL_33;
    }
  }
