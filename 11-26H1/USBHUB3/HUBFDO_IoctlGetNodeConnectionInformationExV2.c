/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInformationExV2 @ 0x14007E274
 * Callers:
 ...
 *     HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher @ 0x140030EC8 (HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher.c)
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionInformationExV2(__int64 a1, __int64 a2, size_t a3, int a4)
{
  ...
  if ( v10 >= 0 )
  {
    v10 = HUBFDO_IoctlValidateParameters(v9, 16, a4, (_DWORD)v28, 16LL, a3);
    if ( v10 >= 0 )
    {
...
LABEL_12:
  if ( (byte_140070D49 & 4) != 0 )
  {
    ...
    ActivityIdIrp = HUBMISC_GetActivityIdIrp(v14, (__int64)&v29);
    if ( (byte_140070D49 & 4) != 0 )
    {
      v17 = (const GUID *)&v29;
      LODWORD(v27) = v10;
