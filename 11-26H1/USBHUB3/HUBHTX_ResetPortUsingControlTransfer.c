/*
 * XREFs of HUBHTX_ResetPortUsingControlTransfer @ 0x140005A90
 * Callers:
 *     HUBPSM20_InitiatingResetPort @ 0x140012B50 (HUBPSM20_InitiatingResetPort.c)
 * Callees:
...
__int64 __fastcall HUBHTX_ResetPortUsingControlTransfer(__int64 a1)
{
  ...
  *(_WORD *)(a1 + 174) = 0;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x2Eu, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v5);
  }
  ...
  if ( (int)result < 0 )
  {
    ...
    {
      LODWORD(v6) = result;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x2Fu, (__int64)&WPP_70469c384dd13630d566350a6f2705ad_Traceguids, v6);
    }
