/*
 * XREFs of HUBPDO_PublishBillboardDetails @ 0x1400849C8
 * Callers:
  ...
  *(_QWORD *)&BitMapHeader.SizeOfBitMap = 0LL;
  ...
  if ( Pool2 )
  {
    *Pool2 = *(_BYTE *)(v5 + 4);
    ...
    v15[1] = &DEVPKEY_Device_UsbBillboardInfo;
    v15[0] = 24LL;
    v16 = 0LL;
    DeviceInterfaceForBillboard = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *, __int64, unsigned int, _WORD *))(WdfFunctions_01015 + 3480))(
                                    WdfDriverGlobals,
                                    v4,
                                    v15,
                                    4099LL,
