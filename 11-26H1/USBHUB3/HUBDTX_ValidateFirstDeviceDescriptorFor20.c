/*
 * XREFs of HUBDTX_ValidateFirstDeviceDescriptorFor20 @ 0x14002DC0C
 * Callers:
 *     HUBDSM_ValidatingDeviceDescriptorInReEnumAtZero @ 0x140025390 (HUBDSM_ValidatingDeviceDescriptorInReEnumAtZero.c)
 * Callees:
