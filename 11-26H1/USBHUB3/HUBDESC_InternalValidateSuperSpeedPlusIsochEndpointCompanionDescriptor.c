/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedPlusIsochEndpointCompanionDescriptor @ 0x14003C5E4
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v13;
  if ( !v12 || !*(_DWORD *)(a2 + 16) )
  {
    ...
    {
      v24 = v11;
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x62u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v24);
    }
...
LABEL_48:
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DDDD(v10, 2u, 5u, 0x64u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  if ( *a1 > 8u )
  {
  ...
  if ( (v18 & 8) != 0 )
  {
    *(_DWORD *)(v8 + 256) = v18 & 0xFFFFFFB7 | 0x40;
    if ( *a3 <= v27 )
    {
      if ( *((_WORD *)a1 + 1) )
      {
        if ( *(_BYTE *)(v8 + 15) )
          *a4 = 2;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x68u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
        (*(void (__fastcall **)(_QWORD, __int64))(v8 + 24))(*(_QWORD *)(v8 + 40), 210LL);
      }
      result = *((unsigned int *)a1 + 1);
      if ( (unsigned int)result >= 0xC001 && (unsigned int)result <= 0xFFFFFF )
        goto LABEL_48;
      if ( *(_BYTE *)(v8 + 15) )
        *a4 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    {
      if ( (unsigned __int8)HUBDESC_ShouldEnforceWin8ValidationImmutable(v8, a2, a3) )
        *a4 = 2;
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        v23 = v11;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x67u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v23);
      }
      v19 = 209LL;
    }
  ...
  {
    v22 = v11;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0x66u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v22);
  }
...
LABEL_49:
  ...
  {
    LOBYTE(a2) = 2;
    return WPP_RECORDER_SF_(v10, a2, 5, 106, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  return result;
}
