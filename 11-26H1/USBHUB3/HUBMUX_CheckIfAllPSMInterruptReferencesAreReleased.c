/*
 * XREFs of HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased @ 0x1400109BC
 * Callers:
 ...
 *     HUBHSM_CheckingPSMInterruptReferencesOnStop @ 0x140008CC0 (HUBHSM_CheckingPSMInterruptReferencesOnStop.c)
 * Callees:
 *     <none>
 */
