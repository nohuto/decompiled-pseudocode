/*
 * XREFs of HUBFDO_EvtDeviceReleaseHardware @ 0x14007C540
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HUBFDO_UnregisterSleepstudyBlockerReasons @ 0x140080A80 (HUBFDO_UnregisterSleepstudyBlockerReasons.c)
...
__int64 __fastcall HUBFDO_EvtDeviceReleaseHardware(__int64 a1)
{
  ...
  KeResetEvent((PRKEVENT)(v2 + 1168));
  HUBSM_AddHsmEvent(v2, 2035);
  v5 = (const void *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 1632))(
                       WdfDriverGlobals,
                       v2);
  HUBMISC_WaitForSignal((PVOID)(v2 + 1168), "Hub FDO PnpCallback", v5);
  v6 = *(_DWORD *)(v2 + 1192);
  (*(void (__fastcall **)(_QWORD, char *))(v2 + 576))(*v3, &v15);
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    *(_QWORD *)(v8 + 32),
    0LL);
  v9 = *(_QWORD *)(v2 + 2448);
  if ( *(_QWORD *)(v9 + 8) != v2 + 2448 || (v10 = *(_QWORD **)(v2 + 2456), *v10 != v2 + 2448) )
    __fastfail(3u);
  *v10 = v9;
  *(_QWORD *)(v9 + 8) = v10;
  ...
  RtlInitUnicodeString((PUNICODE_STRING)(v2 + 2560), 0LL);
  if ( (Microsoft_Windows_USB_USBHUB3EnableBits & 2) != 0 )
  {
    LODWORD(v14) = v6;
