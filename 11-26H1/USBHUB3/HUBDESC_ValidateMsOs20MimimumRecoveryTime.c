/*
 * XREFs of HUBDESC_ValidateMsOs20MimimumRecoveryTime @ 0x14003FB30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20MimimumRecoveryTime(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  v3 = *(_BYTE *)a2;
  v4 = (__int64 *)(a2 + 96);
  v6 = &WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids;
  v9 = 1;
  if ( v3 >= 0 )
  {
    v10 = (_QWORD *)(a1 + 40);
  ...
  else
  {
    ...
    {
      LOBYTE(v6) = 2;
      WPP_RECORDER_SF_(*v4, (_DWORD)v6, 5, 352, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
    }
    v10 = (_QWORD *)(a1 + 40);
  ...
  if ( *a3 == 6 )
  {
    ...
    if ( !v14 || v14 > 0x14u )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_d(*v12, 2u, 5u, 0x163u, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids, v15);
        v4 = (__int64 *)(a2 + 96);
      }
  ...
  {
    LOBYTE(v6) = 2;
    WPP_RECORDER_SF_(*v4, (_DWORD)v6, 5, 356, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
  }
  return v9;
}
