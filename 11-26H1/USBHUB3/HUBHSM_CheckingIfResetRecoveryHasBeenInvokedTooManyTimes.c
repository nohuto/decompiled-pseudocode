/*
 * XREFs of HUBHSM_CheckingIfResetRecoveryHasBeenInvokedTooManyTimes @ 0x140008B00
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (__int64)(MEMORY[0xFFFFF78000000014] - *(_QWORD *)(v1 + 64)) <= 600000000 )
  {
    ...
    *(_WORD *)(v1 + 54) = v5;
    if ( v5 >= 0xAu )
    {
      v6 = *(_DWORD *)(v1 + 2608);
      v2 = 2057;
      *(_DWORD *)(v1 + 2612) = 1073872899;
      if ( (v6 & 1) != 0 )
        HUBMISC_VerifierDbgBreak("HubHwVerifierTooManyResets", v1 + 1280);
