/*
 * XREFs of McTemplateK0ppqq_EtwWriteTransfer @ 0x14001CDA0
 * Callers:
 *     HUBMISC_LogDescriptorValidationErrorForDevice @ 0x140030F10 (HUBMISC_LogDescriptorValidationErrorForDevice.c)
 *     HUBMISC_LogDescriptorValidationErrorForHub @ 0x140030FB0 (HUBMISC_LogDescriptorValidationErrorForHub.c)
 *     HUBMISC_LogDescriptorValidationWarningForDevice @ 0x140031000 (HUBMISC_LogDescriptorValidationWarningForDevice.c)
 *     HUBMISC_LogDescriptorValidationWarningForHub @ 0x1400310A0 (HUBMISC_LogDescriptorValidationWarningForHub.c)
