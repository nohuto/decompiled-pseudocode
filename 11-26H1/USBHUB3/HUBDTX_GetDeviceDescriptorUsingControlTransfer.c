/*
 * XREFs of HUBDTX_GetDeviceDescriptorUsingControlTransfer @ 0x14002B900
 * Callers:
 *     HUBDSM_GettingAlternateDeviceDescriptor @ 0x1400226C0 (HUBDSM_GettingAlternateDeviceDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_GetDeviceDescriptorUsingControlTransfer(__int64 a1)
{
  ...
  result = HUBDTX_GetDescriptor(a1, a1 + 1740, 18, 1, 0, 0);
  if ( (int)result < 0 )
  {
