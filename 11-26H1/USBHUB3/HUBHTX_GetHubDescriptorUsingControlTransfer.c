/*
 * XREFs of HUBHTX_GetHubDescriptorUsingControlTransfer @ 0x140004928
 * Callers:
 *     HUBHSM_GettingHubDescriptor @ 0x140009170 (HUBHSM_GettingHubDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBHTX_GetHubDescriptorUsingControlTransfer(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) == 1 || *(_DWORD *)(a1 + 256) == 2 )
  {
    ...
    v4 = 71;
LABEL_7:
    result = HUBHTX_GetDescriptor(a1, a1 + 1196, v4, v3, v5, 1);
    if ( (int)result >= 0 )
      return result;
    goto LABEL_8;
  }
