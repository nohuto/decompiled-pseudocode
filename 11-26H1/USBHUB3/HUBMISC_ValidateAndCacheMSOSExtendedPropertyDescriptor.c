/*
 * XREFs of HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor @ 0x140033EEC
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedPropertyDescriptor @ 0x140025BC0 (HUBDSM_ValidatingMSOSExtendedPropertyDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor(unsigned int *a1)
{
  ...
  if ( a1[66] == a1[435] )
  {
    if ( RtlCompareMemory(a1 + 435, *((const void **)a1 + 265), 0xAuLL) == 10 )
    {
      if ( *v2 <= 0x1000u )
      {
...
LABEL_29:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(v6 + 1432), 2, 5, v7, (__int64)&WPP_dde998bf8bb3310d95d4227a99ba80b7_Traceguids);
LABEL_31:
