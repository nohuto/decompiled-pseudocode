/*
 * XREFs of HUBDSM_ComputingU1U2TimeoutsAndExitLatency @ 0x140021430
 * Callers:
 *     <none>
 * Callees:
 *     HUBMISC_ComputeU1Timeout @ 0x14002E8DC (HUBMISC_ComputeU1Timeout.c)
 *     HUBMISC_ComputeU2Timeout @ 0x14002EB44 (HUBMISC_ComputeU2Timeout.c)
 */
...
__int64 __fastcall HUBDSM_ComputingU1U2TimeoutsAndExitLatency(__int64 a1)
{
  ...
  if ( v6 || v5 )
  {
    v8 = (unsigned __int16 *)(v1 + 2212);
    if ( !v5 )
      v8 = (unsigned __int16 *)(v1 + 2210);
    v9 = 1000 * *v8;
    v11 = 2100;
    if ( v9 > 0x834 )
      v11 = v9;
