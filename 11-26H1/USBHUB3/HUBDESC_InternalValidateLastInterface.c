/*
 * XREFs of HUBDESC_InternalValidateLastInterface @ 0x140039EA8
 * Callers:
...
char __fastcall HUBDESC_InternalValidateLastInterface(__int64 a1, int *a2, __int64 a3)
{
  ...
  if ( (v6 & 1) != 0 )
  {
    ...
    {
      if ( (unsigned __int8)HUBDESC_ShouldEnforceWin8ValidationImmutable(a1, a2, v8) || *(_BYTE *)(a1 + 13) )
        *v4 = 2;
  ...
  if ( *v4 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_(a3, (_DWORD)a2, 5, 31, (__int64)&WPP_217391fd10f630c6cddebdfb4f852f5f_Traceguids);
    }
  }
  return v7;
}
