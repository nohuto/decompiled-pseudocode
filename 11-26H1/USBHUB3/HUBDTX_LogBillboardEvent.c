/*
 * XREFs of HUBDTX_LogBillboardEvent @ 0x14002BDFC
 * Callers:
 *     HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried @ 0x140020400 (HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried.c)
