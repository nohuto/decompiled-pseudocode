/*
 * XREFs of HUBPDO_ReturnDeviceConfigInfo @ 0x14001B864
 * Callers:
 ...
 *     HUBID_FreeID @ 0x14001F6D8 (HUBID_FreeID.c)
...
LABEL_44:
  ...
  v5 = 0;
  *(_OWORD *)(v3 + 44) = 0LL;
  if ( *(_QWORD *)(v9 + 2176) && *(_DWORD *)(v9 + 2172) )
  {
    *(_OWORD *)(v3 + 44) = *(_OWORD *)(v9 + 2168);
    Pool2 = (void *)ExAllocatePool2(64LL, *(unsigned int *)(v9 + 2172), 1681082453LL);
    *(_QWORD *)(v3 + 52) = Pool2;
    if ( Pool2 )
      memmove(Pool2, *(const void **)(v9 + 2176), *(unsigned int *)(v9 + 2172));
    else
      v5 = -1073741670;
  }
  if ( v5 < 0 )
