/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x140011B2C
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x140009990 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
...
_QWORD *__fastcall HUBMUX_QueueStopAfterSuspendToAllDSMs(__int64 a1)
{
  ...
  if ( v2 + 64 != v5 )
  {
    ...
    {
      ++v6;
      _InterlockedOr((volatile signed __int32 *)(v7 + 248), 4u);
      v8 = v17;
      ++v4;
      v9 = (_QWORD *)(v7 + 216);
      if ( *v17 != &v16 )
  ...
  *(_DWORD *)(v2 + 12) = v6;
  ...
  if ( !v4 )
    return (_QWORD *)HUBSM_AddEvent(a1 + 1280, 2022);
  v12 = (__int64)(v16 - 27);
  result = v16;
  while ( 1 )
  {
