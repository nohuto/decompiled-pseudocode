/*
 * XREFs of HUBPDO_EvtDeviceReleaseHardware @ 0x1400836F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPDO_EvtDeviceReleaseHardware(const void *a1)
{
  ...
  *(_BYTE *)v5 = 1;
  ...
  (*(void (__fastcall **)(_QWORD, _BYTE *))(v6 + 568))(*(_QWORD *)(v6 + 248), v15);
  ...
  else
  {
    ...
    v10 = *(_QWORD *)(v3 + 8);
    if ( _bittest((const signed __int32 *)(v10 + 204), 0xBu) )
    {
      v12 = *(_DWORD *)(v3 + 2732);
      if ( v12 == 2 || v12 == 4 )
