/*
 * XREFs of HUBREG_ReadUsb4HostNameStringFromDeviceHardwareKey @ 0x14008BFB8
 * Callers:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      result = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int128 *))(WdfFunctions_01015 + 2472))(
                 ...
                 &v13);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        result = WPP_RECORDER_SF_Sq(a1[317], v8, v9, v10, v11, *((const wchar_t **)&v13 + 1));
    }
    else
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LODWORD(v12) = v6;
        WPP_RECORDER_SF_d(a1[317], 2u, 5u, 0x9Du, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v12);
      }
...
LABEL_4:
    LODWORD(v12) = result;
    result = WPP_RECORDER_SF_d(a1[317], 2u, 5u, v4, (__int64)&WPP_6348287eaa4439ce1c5af6747761b290_Traceguids, v12);
  }
LABEL_14:
  if ( v19 )
