/*
 * XREFs of HUBUCX_ForwardRequestToUCX @ 0x140027464
 * Callers:
 *     HUBDSM_FowardingStreamsRequestToUcxInConfiguredSuspendedWithSpecialFile @ 0x140022440 (HUBDSM_FowardingStreamsRequestToUcxInConfiguredSuspendedWithSpecialFile.c)
 * Callees:
...
__int64 __fastcall HUBUCX_ForwardRequestToUCX(_QWORD *a1)
{
  ...
  if ( !(_BYTE)result )
  {
    ...
    return HUBSM_AddEvent((__int64)(a1 + 64), 4016);
  }
  return result;
}
