/*
 * XREFs of HUBDSM_Setting30Speed @ 0x1400242E0
 * Callers:
 *     <none>
 * Callees:
 *     HUBMISC_ComputeDelayInNanoSecondsFromSpeedAttr @ 0x14002E86C (HUBMISC_ComputeDelayInNanoSecondsFromSpeedAttr.c)
 */
