/*
 * XREFs of HUBPDO_EvtWorkItemDripsWatchDogCallback @ 0x140083CF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_39:
  ...
  if ( v8 != 1 )
  {
    if ( v8 == 12 )
    {
      if ( (byte_140070D4B & 4) != 0 )
      {
        v23 = *(_QWORD *)(v4 + 24);
        LOWORD(v29) = *(_WORD *)(v23 + 2008);
        LOWORD(v28) = *(_WORD *)(v23 + 2006);
        LOWORD(v27) = *(_WORD *)(v23 + 2004);
        LODWORD(Handle) = 12;
        McTemplateK0pqhhh_EtwWriteTransfer(
          v6,
