/*
 * XREFs of HUBDSM_ValidatingAndLoggingBillboardStringDescriptor @ 0x140025210
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_WORD *)((char *)&v13 + 5) = (v5 & 0x20) != 0;
  ...
  if ( (unsigned __int8)HUBDESC_InternalValidateStringDescriptor(
                          ...
                          *(_QWORD *)(v7 + 1432),
                          (__int64)v11) )
  {
    HUBDTX_LogBillboardEvent(v1, v1 + 1740);
  }
  else
  {
    *(_DWORD *)(v1 + 2440) = 1073807391;
    v2 = 4065;
