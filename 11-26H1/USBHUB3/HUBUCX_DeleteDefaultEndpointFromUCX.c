/*
 * XREFs of HUBUCX_DeleteDefaultEndpointFromUCX @ 0x140026C08
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30 @ 0x140021A70 (HUBDSM_DeletingUCXDefaultEndpointOnOperationFailureFor30.c)
 * Callees:
