/*
 * XREFs of HUBDTX_ValidateAndCacheDeviceDescriptor @ 0x14002D22C
 * Callers:
 *     HUBDSM_ValidatingAlternateDeviceDescriptor @ 0x140025060 (HUBDSM_ValidatingAlternateDeviceDescriptor.c)
 * Callees:
