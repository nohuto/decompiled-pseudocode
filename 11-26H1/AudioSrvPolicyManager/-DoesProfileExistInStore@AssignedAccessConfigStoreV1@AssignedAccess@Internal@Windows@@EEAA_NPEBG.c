/*
 * XREFs of ?DoesProfileExistInStore@AssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@EEAA_NPEBG@Z @ 0x180016950
 * Callers:
 *     <none>
 * Callees:
        ...
        const unsigned __int16 *a2)
{
  ...
  v4[2] = &v5;
  v5 = 0;
  if ( (int)lambda_d1e543e32deb761d4b0a6b2d9b3a008a_::operator()(v4) >= 0 )
    return v5 != 0;
  return v2;
}
