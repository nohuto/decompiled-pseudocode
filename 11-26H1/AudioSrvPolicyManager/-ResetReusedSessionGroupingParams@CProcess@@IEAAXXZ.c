/*
 * XREFs of ?ResetReusedSessionGroupingParams@CProcess@@IEAAXXZ @ 0x180039C6C
 * Callers:
 *     ?SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ @ 0x18003A030 (-SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ.c)
 * Callees:
