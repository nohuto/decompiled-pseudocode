/*
 * XREFs of ?RegisterTrackStateNotificationClient@CApplicationManager@@QEAAJPEAVCProcess@@W4__MIDL___MIDL_itf_audiosrv_0000_0000_0003@@@Z @ 0x18003CD24
 * Callers:
        ...
        int a3)
{
  ...
  v8 = v7;
  if ( v7 < 0 )
    AudPolicyLogError("CApplicationManager::RegisterTrackStateNotificationClient", 536, v7);
  else
