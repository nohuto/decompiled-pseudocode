/*
 * XREFs of ??1CWin32Heap@ATL@@UEAA@XZ @ 0x18002EDB4
 * Callers:
 *     ??_ECWin32Heap@ATL@@UEAAPEAXI@Z @ 0x18004ABF0 (--_ECWin32Heap@ATL@@UEAAPEAXI@Z.c)
 *     ATL::_dynamic_atexit_destructor_for__g_strheap__ @ 0x18004E960 (ATL--_dynamic_atexit_destructor_for__g_strheap__.c)
 * Callees:
 *     <none>
 */
