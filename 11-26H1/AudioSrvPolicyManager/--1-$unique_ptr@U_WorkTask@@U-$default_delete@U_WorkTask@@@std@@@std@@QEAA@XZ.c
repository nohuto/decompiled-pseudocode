/*
 * XREFs of ??1?$unique_ptr@U_WorkTask@@U?$default_delete@U_WorkTask@@@std@@@std@@QEAA@XZ @ 0x18003EFFC
 * Callers:
 ...
 *     _CSerialWorkQueue::QueueWorkItem_::_1_::dtor$2 @ 0x18004E258 (_CSerialWorkQueue--QueueWorkItem_--_1_--dtor$2.c)
 * Callees:
