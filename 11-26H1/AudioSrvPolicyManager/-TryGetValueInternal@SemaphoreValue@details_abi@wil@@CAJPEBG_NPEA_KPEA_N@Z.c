/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x1800356BC
 * Callers:
 ...
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1800350D8 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
 *     StringCopyWorkerW @ 0x1800351A8 (StringCopyWorkerW.c)
 */
    ...
    if ( ValueFromSemaphore >= 0 )
    {
      ...
      if ( v16 >= 0 )
      {
        __1__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__QEAA_XZ(
          &v22,
          v17);
        v8 = (void *)(v21[1] | (unsigned __int64)((__int64)v21[0] << 31));
