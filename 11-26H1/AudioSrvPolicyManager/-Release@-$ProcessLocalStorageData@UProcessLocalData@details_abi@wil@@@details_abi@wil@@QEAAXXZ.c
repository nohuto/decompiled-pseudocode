/*
 * XREFs of ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x180034744
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x18004E7E0 (wil--details--_dynamic_atexit_destructor_for__g_processLocalData__.c)
 * Callees:
 ...
 *     ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x180032750 (-Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ.c)
