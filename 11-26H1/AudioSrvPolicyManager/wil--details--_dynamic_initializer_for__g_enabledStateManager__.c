/*
 * XREFs of wil::details::_dynamic_initializer_for__g_enabledStateManager__ @ 0x180001970
 * Callers:
 *     <none>
 * Callees:
 *     ??0EnabledStateManager@details@wil@@QEAA@XZ @ 0x18002E88C (--0EnabledStateManager@details@wil@@QEAA@XZ.c)
 */
