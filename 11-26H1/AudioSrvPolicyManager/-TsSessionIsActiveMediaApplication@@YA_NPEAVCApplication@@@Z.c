/*
 * XREFs of ?TsSessionIsActiveMediaApplication@@YA_NPEAVCApplication@@@Z @ 0x180029EDC
 * Callers:
...
bool __fastcall TsSessionIsActiveMediaApplication(struct CApplication *a1)
{
  ...
  else
  {
    ...
    v5 = _std_find_trivial_8(*(_QWORD *)(v4 + 48), *(_QWORD *)(v4 + 56), a1) != *(_QWORD *)(v4 + 56);
    if ( v2 )
