/*
 * XREFs of PbmAllowMediaPlaybackForApp @ 0x1800419C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PbmAllowMediaPlaybackForApp(void *a1, const void *a2, __int64 a3)
{
  unsigned int v4; // eax
  __int64 result; // rax
  int v6; // eax
  ...
  const void *v17; // [rsp+B8h] [rbp+10h] BYREF
