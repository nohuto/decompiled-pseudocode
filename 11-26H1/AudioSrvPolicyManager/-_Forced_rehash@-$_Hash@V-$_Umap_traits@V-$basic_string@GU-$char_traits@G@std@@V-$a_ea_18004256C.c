             ...
             (const __m128i **)v14 + 2) )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>::operator()<std::wstring,std::wstring>(
                  ...
                  (const __m128i **)*v21 + 2) )
          {
            v22 = (const __m128i *)*v14;
            v23 = (_QWORD *)v8[1];
            *v23 = v9;
            v24 = (const __m128i **)v9[1];
            *v24 = v22;
            v25 = (_QWORD *)v22->m128i_i64[1];
            *v25 = v8;
            v22->m128i_i64[1] = (__int64)v24;
            v9[1] = v23;
            v8[1] = v25;
            goto LABEL_16;
          }
...
LABEL_16:
  ...
  v31 = 0LL;
  return std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CStreamClassPolicyGains>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CStreamClassPolicyGains>>>,0>>::_Clear_guard::~_Clear_guard(&v31);
}
