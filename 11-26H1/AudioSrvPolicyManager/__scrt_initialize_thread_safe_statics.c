/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x18002FDC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_180067FA8, 0xFA0u);
  ...
  if ( ProcAddress && v2 )
  {
    qword_180067FD0 = (__int64)ProcAddress;
    qword_180067FD8 = (__int64)v2;
    goto LABEL_7;
  }
