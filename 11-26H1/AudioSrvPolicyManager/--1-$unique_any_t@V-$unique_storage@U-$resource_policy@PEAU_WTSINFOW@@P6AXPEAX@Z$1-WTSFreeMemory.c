/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1?WTSFreeMemory@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x180043308
 * Callers:
 *     _TSSession::TSSession_::_1_::dtor$1 @ 0x18004D86F (_TSSession--TSSession_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
