/*
 * XREFs of ?DoesProfileExistInStore@AssignedAccessConfigStoreV0@AssignedAccess@Internal@Windows@@EEAA_NPEBG@Z @ 0x180027CB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const unsigned __int16 *a2)
{
  ...
  v4[2] = &v5;
  v5 = 0;
  if ( (int)lambda_5a51ce284699f0acc741bd28450f0086_::operator()(v4) >= 0 )
    return v5 != 0;
  return v2;
}
