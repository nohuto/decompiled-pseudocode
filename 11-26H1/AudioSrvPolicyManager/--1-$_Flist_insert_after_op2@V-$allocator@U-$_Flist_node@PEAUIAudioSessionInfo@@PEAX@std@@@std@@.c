/*
 * XREFs of ??1?$_Flist_insert_after_op2@V?$allocator@U?$_Flist_node@PEAUIAudioSessionInfo@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18003EF60
 * Callers:
  ...
  if ( v1 )
  {
    *v1 = 0LL;
    ...
    while ( v2 )
    {
      v3 = v2;
      v2 = (_QWORD *)*v2;
      std::_Deallocate<16>(v3, (const struct std::nothrow_t *)0x10);
    }
  }
}
