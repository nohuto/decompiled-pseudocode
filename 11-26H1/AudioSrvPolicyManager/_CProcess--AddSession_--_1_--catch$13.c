/*
 * XREFs of _CProcess::AddSession_::_1_::catch$13 @ 0x18004CFEC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcess::AddSession_::_1_::catch_13(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
