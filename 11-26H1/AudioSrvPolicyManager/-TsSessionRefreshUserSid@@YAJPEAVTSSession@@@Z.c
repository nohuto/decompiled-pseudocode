/*
 * XREFs of ?TsSessionRefreshUserSid@@YAJPEAVTSSession@@@Z @ 0x18002642C
 * Callers:
...
__int64 __fastcall TsSessionRefreshUserSid(struct TSSession *a1)
{
  ...
  if ( *(_WORD *)(v1 + 96) )
  {
    ...
    v4 = StringCchPrintfW(v34, 0x2FuLL, L"%s\\%s");
    if ( (v4 & 0x80000000) != 0 )
    {
      v5 = 629LL;
LABEL_4:
...
LABEL_30:
  ...
  if ( !v21 || !EqualSid(v7, v21) )
  {
    *((_BYTE *)a1 + 1092) = 0;
    ...
    v31 = v24;
    memcpy_0(v24, v7, (unsigned int)LengthSid);
    if ( v20 != &v31 )
    {
      v25 = *v20;
      v31 = 0LL;
