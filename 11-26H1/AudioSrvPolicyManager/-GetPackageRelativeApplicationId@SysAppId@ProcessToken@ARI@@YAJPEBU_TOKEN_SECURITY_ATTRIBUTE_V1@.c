/*
 * XREFs of ?GetPackageRelativeApplicationId@SysAppId@ProcessToken@ARI@@YAJPEBU_TOKEN_SECURITY_ATTRIBUTE_V1@@IPEAIPEAG@Z @ 0x18002E270
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  v5 = *((_QWORD *)this + 4);
  v6 = *(unsigned __int16 *)(v5 + 16) >> 1;
  *a3 = v6 + 1;
  if ( (unsigned int)a2 < (int)v6 + 1 )
    return 122LL;
  v8 = 2 * v6;
  memcpy_0(a4, *(const void **)(v5 + 24), 2 * v6);
  result = 0LL;
  *(_WORD *)((char *)a4 + v8) = 0;
  return result;
}
