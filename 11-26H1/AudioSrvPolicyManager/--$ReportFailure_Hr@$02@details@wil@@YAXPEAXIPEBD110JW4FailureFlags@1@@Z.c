/*
 * XREFs of ??$ReportFailure_Hr@$02@details@wil@@YAXPEAXIPEBD110JW4FailureFlags@1@@Z @ 0x180031830
 * Callers:
 *     ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x180032930 (-FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
        ...
        __int64 a6)
{
  ...
  v10[2] = 0;
  wil::details::ReportFailure_Base<3,0>(v8, v6, v7, v8, v9, a6, (__int64)v10, 0LL);
}
