/*
 * XREFs of ?ReleaseEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x180048B60
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  _QWORD v19[4]; // [rsp+40h] [rbp-78h] BYREF
