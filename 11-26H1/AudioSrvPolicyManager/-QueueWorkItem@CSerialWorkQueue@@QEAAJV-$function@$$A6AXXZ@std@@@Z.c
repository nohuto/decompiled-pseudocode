/*
 * XREFs of ?QueueWorkItem@CSerialWorkQueue@@QEAAJV?$function@$$A6AXXZ@std@@@Z @ 0x1800403A4
 * Callers:
 ...
 *     ?Initialize@CSerialWorkQueue@@AEAAJXZ @ 0x18003F9F0 (-Initialize@CSerialWorkQueue@@AEAAJXZ.c)
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( v8 )
      {
        ...
        *((_QWORD *)v8 + 2) = this;
        ...
        v12 = *(_QWORD *)v8;
        std::_Func_class<void,>::~_Func_class<void,>(v9, v11);
