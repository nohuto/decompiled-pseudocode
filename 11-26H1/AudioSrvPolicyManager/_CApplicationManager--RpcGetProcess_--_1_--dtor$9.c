/*
 * XREFs of _CApplicationManager::RpcGetProcess_::_1_::dtor$9 @ 0x18004BF70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
BOOL __fastcall CApplicationManager::RpcGetProcess_::_1_::dtor_9(__int64 a1, __int64 a2)
{
