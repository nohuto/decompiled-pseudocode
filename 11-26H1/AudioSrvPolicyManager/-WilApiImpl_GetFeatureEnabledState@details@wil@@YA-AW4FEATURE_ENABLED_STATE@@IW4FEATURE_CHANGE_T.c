/*
 * XREFs of ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x1800359B0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  v12 = 0LL;
  v11 = 0LL;
  IsFeatureConfigured = wil::details::IsFeatureConfigured((wil::details *)&v11, (unsigned int)this, v5, v6, a3);
  v9 = 0;
