/*
 * XREFs of _anonymous_namespace_::__std_find_trivial_impl__anonymous_namespace_::_Find_traits_4_unsigned_int_ @ 0x18002EFD0
 * Callers:
...
LABEL_9:
    ...
    _RAX = (char *)&unk_180056FD0 - (v11 & 0xFFFFFFFC);
    __asm
    {
