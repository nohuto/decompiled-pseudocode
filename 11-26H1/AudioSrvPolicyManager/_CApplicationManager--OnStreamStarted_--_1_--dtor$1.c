/*
 * XREFs of _CApplicationManager::OnStreamStarted_::_1_::dtor$1 @ 0x18004C450
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CApplicationManager::OnStreamStarted_::_1_::dtor_1(__int64 a1, __int64 a2)
{
