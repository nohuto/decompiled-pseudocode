/*
 * XREFs of ?FindAppFromProcessId@CApplicationManager@@QEAAPEAVCApplication@@K@Z @ 0x18003B790
 * Callers:
...
struct CApplication *__fastcall CApplicationManager::FindAppFromProcessId(CApplicationManager *this, int a2)
{
  ...
  while ( v6 )
  {
    v8 = *ATL::CAtlList<CProcess *,ATL::CElementTraits<CProcess *>>::GetNext(v5, &v15);
