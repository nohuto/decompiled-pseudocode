/*
 * XREFs of wil::details::lambda_call__lambda_fff9119fb840d357cf7d24802c9bd62a___::_lambda_call__lambda_fff9119fb840d357cf7d24802c9bd62a___ @ 0x180029DC8
 * Callers:
 *     _CApplicationManager::OnStreamStopped_::_1_::dtor$0 @ 0x18004C760 (_CApplicationManager--OnStreamStopped_--_1_--dtor$0.c)
 * Callees:
    ...
    if ( *(_DWORD *)(v2 + 424) )
    {
      if ( Microsoft_Windows_AudioEnableBits < 0 )
        return (__int64 *)McTemplateU0zqq_EventWriteTransfer(
                            (__int64)a1[2],
                            (__int64)&EVT_PBM_STREAM_STOPPED,
