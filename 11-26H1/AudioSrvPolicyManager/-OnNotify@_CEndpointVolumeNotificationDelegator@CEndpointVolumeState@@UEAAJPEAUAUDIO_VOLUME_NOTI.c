/*
 * XREFs of ?OnNotify@_CEndpointVolumeNotificationDelegator@CEndpointVolumeState@@UEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x1800489F0
 * Callers:
 *     <none>
 * Callees:
 *     _o_log10_0 @ 0x1800309C8 (_o_log10_0.c)
 */
