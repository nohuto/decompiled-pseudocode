/*
 * XREFs of PbmReportApplicationState @ 0x18002B400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PbmReportApplicationState(void *a1, const void *a2, __int64 a3, const char *a4)
{
  int v4; // ebx
  unsigned int v6; // eax
  __int64 result; // rax
  ...
  const void *v20; // [rsp+B8h] [rbp+10h] BYREF
  ...
  catch ( ... )
  {
    return (unsigned int)wil::details::in1diag3::Return_CaughtException(
                           retaddr,
                           (void *)0x25B,
                           (unsigned int)"clientcore\\multimedia\\audiocore\\server\\audiosrv\\windowspolicymanager\\play"
                                         "backmanagerrpc.cpp",
                           a4);
  }
  return result;
