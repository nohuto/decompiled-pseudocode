/*
 * XREFs of ?RegisterAppVolumePolicyChange@CApplication@@QEAAJPEAUIAudioAppVolumePolicyChange@@@Z @ 0x1800394F0
 * Callers:
        ...
        struct IAudioAppVolumePolicyChange *a2)
{
  ...
  try
  {
    v11 = v3;
    v5 = 0;
    v6 = ATL::CAtlList<CHostedAppInteractivity *,ATL::CElementTraits<CHostedAppInteractivity *>>::NewNode(
           (__int64)this + 120,
           (__int64 *)&v10,
           v4,
           *((_QWORD *)this + 15));
