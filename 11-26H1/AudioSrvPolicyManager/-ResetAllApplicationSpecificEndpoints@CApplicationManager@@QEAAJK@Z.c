/*
 * XREFs of ?ResetAllApplicationSpecificEndpoints@CApplicationManager@@QEAAJK@Z @ 0x18003CEF8
 * Callers:
...
__int64 __fastcall CApplicationManager::ResetAllApplicationSpecificEndpoints(CApplicationManager *this, int a2)
{
  ...
  while ( v10 )
  {
    Next = (CApplication **)ATL::CAtlList<CProcess *,ATL::CElementTraits<CProcess *>>::GetNext((__int64)v5, &v10);
    v5 = *Next;
