/*
 * XREFs of ??1?$unique_ptr@UAUDIOPROTOCOLNOTIFY@@U?$default_delete@UAUDIOPROTOCOLNOTIFY@@@std@@@std@@QEAA@XZ @ 0x18002A594
 * Callers:
 ...
 *     ??1?$forward_list@V?$unique_ptr@UAUDIOPROTOCOLNOTIFY@@U?$default_delete@UAUDIOPROTOCOLNOTIFY@@@std@@@std@@V?$allocator@V?$unique_ptr@UAUDIOPROTOCOLNOTIFY@@U?$default_delete@UAUDIOPROTOCOLNOTIFY@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x180043258 (--1-$forward_list@V-$unique_ptr@UAUDIOPROTOCOLNOTIFY@@U-$default_delete@UAUDIOPROTOCOLNOTIFY@@@s.c)
 *     ??1TSSession@@QEAA@XZ @ 0x1800433FC (--1TSSession@@QEAA@XZ.c)
 *     _TsSessionIdAddNotify_::_1_::dtor$1 @ 0x18004CACC (_TsSessionIdAddNotify_--_1_--dtor$1.c)
 * Callees:
