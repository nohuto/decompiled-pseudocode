/*
 * XREFs of ?GetPolicyVolumeForAudioStream@@YAXPEAUIAudioPolicyManager@@PEAUIAudioStreamPolicyVolumeClient@@PEBU_tlgProvider_t@@PEAMPEA_JW4GPV_REASON@@@Z @ 0x180012D90
 * Callers:
...
__int64 __fastcall GetPolicyVolumeForAudioStream(__int64 a1, __int64 *a2, __int64 a3, float *a4)
{
  ...
  __int64 v19; // rax
  unsigned int (__fastcall *v20)(__int64, _QWORD); // rbx
  unsigned int v21; // eax
  __int64 v22; // rbx
  float (__fastcall *v23)(__int64, __int64); // rdi
  __int64 v24; // rax
  float v25; // xmm0_4
  float v26; // xmm0_4
  __int64 result; // rax
  ...
  *a4 = v12;
  ...
  if ( *a4 > 0.0 && (*(unsigned int (__fastcall **)(__int64 *))(*a2 + 56))(a2) != 24 )
  {
    v14 = (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a1 + 272LL))(a1)
       && !(*(unsigned __int8 (__fastcall **)(__int64 *))(*a2 + 64))(a2)
       && dword_1800596B0[(*(unsigned int (__fastcall **)(__int64 *))(*a2 + 56))(a2)]
        ? 0.0
        : FLOAT_1_0;
    *a4 = v14 * *a4;
    v15 = (*(unsigned int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)a1 + 72LL))(a1, a2)
        ? (*(float (__fastcall **)(__int64))(*(_QWORD *)v34 + 208LL))(v34)
        : FLOAT_1_0;
    *a4 = v15 * *a4;
    ...
    *a4 = v16;
    if ( v16 > 0.0 )
    {
      if ( (*(__int64 (__fastcall **)(__int64 *))(*a2 + 40))(a2) )
      {
        ...
        *a4 = v17(a1, v19, v18) * *a4;
        v20 = *(unsigned int (__fastcall **)(__int64, _QWORD))(*(_QWORD *)a1 + 80LL);
        v21 = (*(__int64 (__fastcall **)(__int64 *))(*a2 + 56))(a2);
        if ( v20(a1, v21) )
        {
          v25 = FLOAT_1_0;
        }
        ...
        {
          v22 = v34;
          v23 = *(float (__fastcall **)(__int64, __int64))(*(_QWORD *)v34 + 216LL);
        ...
        *a4 = v26;
        ...
        {
          v31 = v34;
          v32 = *(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v34 + 224LL);
