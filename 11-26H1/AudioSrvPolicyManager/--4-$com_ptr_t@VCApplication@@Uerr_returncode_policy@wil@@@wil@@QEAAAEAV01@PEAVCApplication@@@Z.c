/*
 * XREFs of ??4?$com_ptr_t@VCApplication@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVCApplication@@@Z @ 0x18002B0DC
 * Callers:
...
volatile signed __int32 **__fastcall wil::com_ptr_t<CApplication,wil::err_returncode_policy>::operator=(
