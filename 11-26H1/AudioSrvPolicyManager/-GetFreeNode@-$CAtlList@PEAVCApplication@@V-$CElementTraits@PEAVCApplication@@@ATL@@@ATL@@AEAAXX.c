/*
 * XREFs of ?GetFreeNode@?$CAtlList@PEAVCApplication@@V?$CElementTraits@PEAVCApplication@@@ATL@@@ATL@@AEAAXXZ @ 0x1800275A0
 * Callers:
...
void __fastcall ATL::CAtlList<CApplication *,ATL::CElementTraits<CApplication *>>::GetFreeNode(__int64 a1)
{
