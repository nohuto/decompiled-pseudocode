/*
 * XREFs of _CProcess::ForEachSession_IAudioSessionPolicyControl__::_1_::catch$9 @ 0x18004C690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcess::ForEachSession_IAudioSessionPolicyControl__::_1_::catch_9(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
