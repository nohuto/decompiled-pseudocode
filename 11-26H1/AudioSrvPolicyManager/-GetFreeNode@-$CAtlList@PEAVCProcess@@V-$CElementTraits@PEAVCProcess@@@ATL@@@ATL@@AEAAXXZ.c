/*
 * XREFs of ?GetFreeNode@?$CAtlList@PEAVCProcess@@V?$CElementTraits@PEAVCProcess@@@ATL@@@ATL@@AEAAXXZ @ 0x18001A7B8
 * Callers:
...
void __fastcall ATL::CAtlList<CProcess *,ATL::CElementTraits<CProcess *>>::GetFreeNode(__int64 a1)
{
