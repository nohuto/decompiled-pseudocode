/*
 * XREFs of ?Add@?$CSimpleMap@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@PEAIV?$CSimpleMapEqualHelper@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@PEAI@ATL@@@ATL@@QEAAHAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEBQEAI@Z @ 0x180037FBC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)(a1 + 8) = v7;
  v8 = *(int *)(a1 + 16);
  if ( *(_QWORD *)a1 + 32 * v8 )
    std::wstring::wstring(*(_QWORD *)a1 + 32 * v8, a2);
