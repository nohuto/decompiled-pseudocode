/*
 * XREFs of ?DetermineLowRightsKeySecurityDescriptor@@YAJPEAUHKEY__@@PEAPEAX@Z @ 0x18001C708
 * Callers:
 ...
 *     ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x1800269B0 (-Clear@CSecurityDesc@ATL@@MEAAXXZ.c)
...
__int64 __fastcall DetermineLowRightsKeySecurityDescriptor(HKEY hKey, void **a2)
{
  ...
  void **v23; // [rsp+80h] [rbp-158h] BYREF
  void *v24; // [rsp+88h] [rbp-150h]
  char v25; // [rsp+90h] [rbp-148h]
  int v26; // [rsp+94h] [rbp-144h]
  __int128 v27; // [rsp+98h] [rbp-140h] BYREF
  __int64 v28; // [rsp+A8h] [rbp-130h]
  int v29; // [rsp+B0h] [rbp-128h]
  PACL pDacl[2]; // [rsp+B8h] [rbp-120h] BYREF
  ...
  struct _SID_IDENTIFIER_AUTHORITY v39; // [rsp+110h] [rbp-C8h] BYREF
    ...
    if ( v6 )
    {
      ...
      else
      {
        ...
        *(_WORD *)&v39.Value[4] = 1280;
        ...
        if ( v8 && GetSecurityDescriptorDacl(v8, &bDaclPresent, pDacl, &bDaclDefaulted) )
        {
          if ( bDaclPresent )
          {
            ...
            if ( pDacl[0] )
            {
              ...
              ATL::CDacl::Copy((ATL::CDacl *)&v23, v9);
            }
            else
            {
              ATL::CAcl::SetNull((ATL::CAcl *)&v23);
            }
          }
          else
          {
            ATL::CAcl::SetEmpty((ATL::CAcl *)&v23);
          }
        }
        PACL = (struct _ACL *)ATL::CAcl::GetPACL((ATL::CAcl *)&v23);
        ...
        v11 = (const struct ATL::CSid *)ATL::CSid::CSid((ATL::CSid *)v40, &v39, 6u);
        ...
        if ( (_BYTE)PACL )
        {
          ...
          free(Block);
          v23 = &ATL::CDacl::`vftable';
          ATL::CDacl::RemoveAllAces((ATL::CDacl *)&v23);
          ATL::CAtlArray<ATL::CAutoPtr<ATL::CDacl::CAccessAce>,ATL::CAutoPtrElementTraits<ATL::CDacl::CAccessAce>>::~CAtlArray<ATL::CAutoPtr<ATL::CDacl::CAccessAce>,ATL::CAutoPtrElementTraits<ATL::CDacl::CAccessAce>>(&v27);
          v23 = &ATL::CAcl::`vftable';
          free(v24);
