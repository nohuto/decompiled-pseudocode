/*
 * XREFs of ??1?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x18002E558
 * Callers:
 *     _dynamic_atexit_destructor_for__TsSessionList__ @ 0x18004E920 (_dynamic_atexit_destructor_for__TsSessionList__.c)
 * Callees:
        ...
        __int64 a1)
{
  ...
  std::_List_node<std::pair<unsigned long const,std::unique_ptr<TSSession>>,void *>::_Free_non_head<std::allocator<std::_List_node<std::pair<unsigned long const,std::unique_ptr<TSSession>>,void *>>>(
    v2,
    *(_QWORD *)(a1 + 8));
  std::_Deallocate<16>(*(void **)(a1 + 8), (const struct std::nothrow_t *)0x20);
}
