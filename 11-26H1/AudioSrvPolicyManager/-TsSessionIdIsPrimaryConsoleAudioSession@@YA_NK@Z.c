/*
 * XREFs of ?TsSessionIdIsPrimaryConsoleAudioSession@@YA_NK@Z @ 0x180008D28
 * Callers:
...
char __fastcall TsSessionIdIsPrimaryConsoleAudioSession(DWORD a1)
{
...
LABEL_3:
    v5 = (unsigned int)TSSession::IsPrimaryConsoleAudioSession(v4) != 0;
    if ( v2 )
