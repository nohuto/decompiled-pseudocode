/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIAudioPolicyManager@@UISessionInternalEvents@@UIAudioPolicyNotificationManager@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x180046100
 * Callers:
 *     <none>
 * Callees:
