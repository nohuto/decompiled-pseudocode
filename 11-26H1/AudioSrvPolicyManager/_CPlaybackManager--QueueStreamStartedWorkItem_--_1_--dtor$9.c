/*
 * XREFs of _CPlaybackManager::QueueStreamStartedWorkItem_::_1_::dtor$9 @ 0x18004C220
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CPlaybackManager::QueueStreamStartedWorkItem_::_1_::dtor_9(__int64 a1, __int64 a2)
{
