/*
 * XREFs of ??1?$vector@ULockedListEntry@?$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@V?$allocator@ULockedListEntry@?$CLockedList_UniqueValuesOnly@VCDuckingNotification@@$0A@@@@std@@@std@@QEAA@XZ @ 0x18003F040
 * Callers:
 *     _CLockedList_UniqueValuesOnly_CDuckingNotification_0_::ForEachEntry_::_1_::dtor$0 @ 0x18004E14C (_CLockedList_UniqueValuesOnly_CDuckingNotification_0_--ForEachEntry_--_1_--dtor$0.c)
 * Callees:
