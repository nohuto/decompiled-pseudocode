/*
 * XREFs of ?SendBackgroundStreamStateChangedNotifiction@CApplicationManager@@QEAAXXZ @ 0x18003D238
 * Callers:
  ...
  if ( *((_QWORD *)this + 11) )
  {
    ...
    if ( v5 )
    {
      ...
      if ( v6 )
      {
        ...
        do
        {
          v9 = *ATL::CAtlList<CProcess *,ATL::CElementTraits<CProcess *>>::GetNext((__int64)v6, &v11);
          v12 = v9;
          if ( v9 )
