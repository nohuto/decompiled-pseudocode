/*
 * XREFs of ?bSrcCopySRLE4D16@@YAHPEAUBLTINFO@@@Z @ 0x14020EE10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( v21 )
        {
          ...
          {
            v27 = *v2++;
            v28 = *(_WORD *)(v46 + 4 * (v27 & 0xF));
            *v26 = *(_WORD *)(v46 + 4 * (v27 >> 4));
            v26[1] = v28;
            v26 += 2;
            --v21;
          }
        ...
        {
          v22 = v9++;
          *(_WORD *)(v3 + 2 * v22) = *(_WORD *)(v11 + 4 * ((unsigned __int64)*v2 >> 4));
