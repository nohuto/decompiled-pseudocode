/*
 * XREFs of ?QueueAndGenerateInput@InteractiveControlDevice@@QEAAJPEAXK@Z @ 0x140258CA4
 * Callers:
 *     ?OnInputReport@InteractiveControlManager@@QEAAJPEAURawInputManagerDeviceObject@@PEAXK@Z @ 0x140258BF8 (-OnInputReport@InteractiveControlManager@@QEAAJPEAURawInputManagerDeviceObject@@PEAXK@Z.c)
 * Callees:
        ...
        __int64 a4)
{
  ...
  else
  {
    ...
    while ( a2 < v10 )
    {
      if ( !v7 )
      {
        v11 = (InteractiveControlInput *)Win32AllocPool(96LL, 1819440195LL, a3);
        if ( !v11 )
