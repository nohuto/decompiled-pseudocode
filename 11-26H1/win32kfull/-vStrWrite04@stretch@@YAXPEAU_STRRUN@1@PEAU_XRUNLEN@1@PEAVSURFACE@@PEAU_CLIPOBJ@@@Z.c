/*
 * XREFs of ?vStrWrite04@stretch@@YAXPEAU_STRRUN@1@PEAU_XRUNLEN@1@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1401BD660
 * Callers:
            ...
            do
            {
              ...
              if ( v40 < v41 )
              {
                ...
                do
                {
                  ...
                  {
                    XCLIPOBJ::vFindSegment(a4, &si128, v40);
                    v47 = v61;
                    v46 = v65;
                    v41 = v59;
                  }
                  if ( v40 >= si128.left && v40 < si128.right )
                    v45 = v45 & ~dword_140370F20[v47] | dword_140370F20[v47] & (*v46 << dword_140370F40[v47]);
                  ++v47;
                  ++v46;
                  ++v42;
                  v61 = v47;
      ...
      for ( i = v8; v5 != (int *)a2; v62 = (char *)v5 )
      {
        ...
        if ( *v5 < *v5 + v5[1] )
        {
          ...
          if ( (unsigned __int64)v10 < *((_QWORD *)a3 + 9) + (unsigned __int64)*((unsigned int *)a3 + 16) )
          {
            ...
            do
            {
              v17 = dword_140370F20[v15];
              ++v12;
              v18 = *v14;
              ++v9;
              v19 = dword_140370F40[v15];
              ++v14;
              ++v15;
          ...
          *v11 = v13;
          ...
          if ( v20 > 1 )
          {
            ...
            if ( v21 == v24 )
            {
              v48 = 1;
              v49 = *v10;
              v50 = (__int64)(&aulMsk)[v25] & ~*((_DWORD *)&aulMsk + v26);
              do
              {
