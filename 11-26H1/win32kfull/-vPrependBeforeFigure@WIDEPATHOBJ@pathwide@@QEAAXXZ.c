/*
 * XREFs of ?vPrependBeforeFigure@WIDEPATHOBJ@pathwide@@QEAAXXZ @ 0x140108D1C
 * Callers:
...
void __fastcall pathwide::WIDEPATHOBJ::vPrependBeforeFigure(pathwide::WIDEPATHOBJ *this)
{
  __int64 v1; // rbx
  __int64 v3; // r9
  __int64 v4; // rdx
