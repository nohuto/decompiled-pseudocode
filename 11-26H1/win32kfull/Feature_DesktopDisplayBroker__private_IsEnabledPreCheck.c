/*
 * XREFs of Feature_DesktopDisplayBroker__private_IsEnabledPreCheck @ 0x140243C0C
 * Callers:
...
__int64 Feature_DesktopDisplayBroker__private_IsEnabledPreCheck()
{
  unsigned __int8 v1; // [rsp+30h] [rbp+8h]

  if ( (Feature_DesktopDisplayBroker__private_featureState & 0x10) == 0 )
  {
    v1 = Feature_DesktopDisplayBroker__private_featureState | 1;
