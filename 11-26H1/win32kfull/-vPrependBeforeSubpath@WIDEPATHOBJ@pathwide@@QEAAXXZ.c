/*
 * XREFs of ?vPrependBeforeSubpath@WIDEPATHOBJ@pathwide@@QEAAXXZ @ 0x1401077F8
 * Callers:
...
void __fastcall pathwide::WIDEPATHOBJ::vPrependBeforeSubpath(pathwide::WIDEPATHOBJ *this)
{
  __int64 v1; // rbx
  __int64 v3; // r10
  __int64 v4; // rdx
