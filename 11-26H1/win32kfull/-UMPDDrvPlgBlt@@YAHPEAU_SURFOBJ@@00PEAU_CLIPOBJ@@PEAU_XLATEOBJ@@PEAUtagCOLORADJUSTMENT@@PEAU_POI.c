/*
 * XREFs of ?UMPDDrvPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x14034BEA0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct _POINTFIX *v41; // [rsp+118h] [rbp+8h]
  ...
  if ( v37 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), &v46, v13)
        ...
        || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, &v53, 0x18u)
