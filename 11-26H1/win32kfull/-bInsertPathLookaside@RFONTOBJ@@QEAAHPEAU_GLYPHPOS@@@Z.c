/*
 * XREFs of ?bInsertPathLookaside@RFONTOBJ@@QEAAHPEAU_GLYPHPOS@@@Z @ 0x1402440B4
 * Callers:
...
__int64 __fastcall RFONTOBJ::bInsertPathLookaside(struct _FONTOBJ **this, struct _GLYPHPOS *a2)
{
  ...
  if ( v13 )
  {
    ...
    {
      v7 = EPATHOBJ::cjSize((EPATHOBJ *)&v12) + 488;
      if ( (unsigned int)RFONTOBJ::bEnsureAuxCacheBuffer((RFONTOBJ *)this, v7) )
      {
        v8 = *(GLYPHDEF **)&(*this)[9].ulStyleSize;
        EPATHFONTOBJ::vInit((EPATHFONTOBJ *)&v8[8], v7 - 64);
