/*
 * XREFs of ?PanBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x140321430
 * Callers:
 *     ?PanCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1403216A0 (-PanCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z.c)
 * Callees:
        ...
        ROP4 rop4)
{
  ...
  {
    right = prclTrg->right;
    v17 = prclTrg->left - right;
    x = pptlSrc->x;
    y = pptlSrc->y;
    v20 = right - prclTrg->left;
