/*
 * XREFs of ?GrepScaleWindowExtEx@@YAHAEAVXDCOBJ@@HHHHPEAUtagSIZE@@@Z @ 0x14020716C
 * Callers:
...
__int64 __fastcall GrepScaleWindowExtEx(DC **a1, int a2, int a3, int a4, int a5, struct tagSIZE *a6)
{
  ...
  if ( a3 )
  {
    if ( a5 )
    {
      ...
      {
        v11 = v9[80] * a4;
        if ( (v11 != 0x80000000 || a5 != -1) && v10 / a3 && v11 / a5 )
        {
          v9[79] = v10 / a3;
          *(_DWORD *)(*((_QWORD *)*a1 + 122) + 320LL) = v11 / a5;
          DC::MirrorWindowOrg(*a1);
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v12 + 976LL) + 340LL) |= 0x4090u;
          return 1;
        }
      }
    }
