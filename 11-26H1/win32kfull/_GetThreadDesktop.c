/*
 * XREFs of _GetThreadDesktop @ 0x1401C6C14
 * Callers:
 *     EditionGetThreadDesktopEntryPoint @ 0x1401C6BD0 (EditionGetThreadDesktopEntryPoint.c)
 * Callees:
...
HANDLE __fastcall GetThreadDesktop(__int64 a1)
{
  ...
  if ( v2 )
  {
    result = *(HANDLE *)(v2 + 624);
    Handle = result;
    v6 = *(PRKPROCESS **)(v4 + 456);
  }
  else
  {
...
LABEL_7:
  ...
  if ( (unsigned int)SetHandleFlag(v8, 1LL) )
    return Handle;
  return 0LL;
}
