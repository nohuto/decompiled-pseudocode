/*
 * XREFs of ?TouchTargetingLayerHitTest@@YAHPEAUtagWND@@UtagPOINT@@HPEBUtagTOUCHTARGETINGCONTACT@@PEAUtagRECT@@PEAGPEAU2@W4tagTARGETING_PROPERTY@@@Z @ 0x140264828
 * Callers:
        ...
        int a8)
{
  ...
  struct tagPOINT v20; // [rsp+B0h] [rbp+38h]
  struct tagPOINT v21; // [rsp+B0h] [rbp+38h]
