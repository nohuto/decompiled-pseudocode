/*
 * XREFs of ?xxxDestroyWindow_Prologue@@YAHPEAUtagWND@@PEAUtagTHREADINFO@@PEAHPEA_N@Z @ 0x14027BDC8
 * Callers:
...
__int64 __fastcall xxxDestroyWindow_Prologue(struct tagTHREADINFO **a1, struct tagTHREADINFO *a2, int *a3, bool *a4)
{
  ...
  *a3 = v9;
  ...
  if ( *a3 && (_InterlockedCompareExchange((volatile signed __int32 *)a2 + 130, 0, 0) & 0x10000000) == 0 )
  {
    *a4 = 1;
    _InterlockedOr((volatile signed __int32 *)a2 + 130, 0x10000000u);
  }
  v10 = *((_DWORD *)a1 + 95);
  if ( (v10 & 0x400000) != 0 )
  {
  ...
  if ( *a3 || (_InterlockedCompareExchange((volatile signed __int32 *)a2 + 130, 0, 0) & 1) != 0 )
    return 1LL;
  if ( (unsigned int)Feature_Bugfix_58999946__private_IsEnabledDeviceUsageNoInline() )
  {
    if ( (**(_DWORD **)(W32GetUserSessionState(v12, v11) + 19904) & 4) != 0
      && a1 == *((struct tagTHREADINFO ***)a2 + 102) )
    {
      v13 = 1;
LABEL_21:
      v15 = v13;
LABEL_29:
    ...
    if ( (*((_DWORD *)a1 + 95) & 0x10000000) != 0 && *((_DWORD *)a2 + 235) == 1 )
      v13 |= 2u;
    if ( v13 )
      goto LABEL_21;
  }
...
LABEL_30:
  if ( ((*((_BYTE *)a2 + 712) | *(_BYTE *)(**((_QWORD **)a2 + 62) + 16LL)) & 0x40) != 0 )
  {
