/*
 * XREFs of SetIconMetrics @ 0x1400CE144
 * Callers:
...
__int64 __fastcall SetIconMetrics(struct _UNICODE_STRING *a1, struct tagICONMETRICSW *a2)
{
  ...
  __int64 v37; // rax
  __int64 v39; // rax
  _BYTE v40[4]; // [rsp+40h] [rbp-78h] BYREF
  int TWIPSMetricById; // [rsp+44h] [rbp-74h]
  int v42; // [rsp+48h] [rbp-70h]
  int v43; // [rsp+4Ch] [rbp-6Ch]
  ...
  v11 = *(_QWORD *)(W32GetUserSessionState(v5, v4) + 19904);
  v12 = *((_DWORD *)a2 + 1);
  if ( v12 <= *(_DWORD *)(v11 + 2304) )
  {
    v11 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19904);
    v12 = *(_DWORD *)(v11 + 2304);
  }
  *((_DWORD *)a2 + 1) = v12;
  v14 = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 19904);
  v15 = *((_DWORD *)a2 + 2);
  if ( v15 <= *(_DWORD *)(v14 + 2308) )
    v15 = *(_DWORD *)(*(_QWORD *)(W32GetUserSessionState(v14, v13) + 19904) + 2308LL);
  v16 = *((unsigned int *)a2 + 1);
  *((_DWORD *)a2 + 2) = v15;
  SetDpiDepSysMet(18LL, v16);
  SetDpiDepSysMet(19LL, *((unsigned int *)a2 + 2));
  v19 = *(_QWORD *)(W32GetUserSessionState(v18, v17) + 19904);
  v20 = *(unsigned __int16 *)(v19 + 6998);
  UserSessionState = W32GetUserSessionState(v19, v21);
  v23 = EngMulDiv(*(_DWORD *)(*(_QWORD *)(UserSessionState + 19904) + 2356LL), 96, v20);
  v26 = *(_QWORD *)(W32GetUserSessionState(v25, v24) + 19904);
  *(_DWORD *)(v26 + 2476) = v23;
  v28 = *(_QWORD *)(W32GetUserSessionState(v26, v27) + 19904);
  v29 = *(unsigned __int16 *)(v28 + 6998);
  v31 = W32GetUserSessionState(v28, v30);
  v32 = EngMulDiv(*(_DWORD *)(*(_QWORD *)(v31 + 19904) + 2360LL), 96, v29);
  v36 = *(_QWORD *)(W32GetUserSessionState(v34, v33) + 19904);
  *(_DWORD *)(v36 + 2480) = v32;
  if ( *((_DWORD *)a2 + 3) )
  {
    v37 = W32GetUserSessionState(v36, v35);
    *(_DWORD *)(v37 + 66792) |= 0x200000u;
  }
  else
  {
    v39 = W32GetUserSessionState(v36, v35);
    *(_DWORD *)(v39 + 66792) &= ~0x200000u;
  }
  return 1LL;
}
