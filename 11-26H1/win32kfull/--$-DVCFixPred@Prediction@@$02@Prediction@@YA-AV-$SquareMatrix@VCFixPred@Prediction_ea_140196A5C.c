/*
 * XREFs of ??$?DVCFixPred@Prediction@@$02@Prediction@@YA?AV?$SquareMatrix@VCFixPred@Prediction@@$02@0@AEBV10@AEBVCFixPred@0@@Z @ 0x140196A5C
 * Callers:
        ...
        __int64 *a3)
{
  ...
  do
  {
    ...
    {
      v10 = *a3;
      v11 = (*a3 ^ *(_QWORD *)((char *)v7 + v6)) >> 63;
      v12 = -*(_QWORD *)((char *)v7 + v6);
      if ( *(__int64 *)((char *)v7 + v6) > 0 )
        v12 = *(_QWORD *)((char *)v7 + v6);
      v13 = -v10;
      if ( v10 > 0 )
        v13 = *a3;
