/*
 * XREFs of GreNotifyHwndDpiDirty @ 0x1400D3F38
 * Callers:
...
void __fastcall GreNotifyHwndDpiDirty(unsigned __int64 a1, __int64 a2, __int64 a3)
{
  __int16 v3; // si
  const void *v5; // rbx
  __int64 SessionState; // rax
  __int64 v7; // rdi
  BOOLEAN HwndDpiBucket; // al
  NSInstrumentation::CPointerHashTable *v9; // rcx
  void *v10; // [rsp+40h] [rbp+8h] BYREF
  void *v11; // [rsp+50h] [rbp+18h] BYREF

  v3 = a2;
  v5 = (const void *)((a1 >> 1) & 0x3FFF);
  SessionState = W32GetSessionState(a1, a2, a3);
  v10 = 0LL;
  v7 = *(_QWORD *)(SessionState + 96);
  if ( v3 )
  {
    HwndDpiBucket = GrepGetHwndDpiBucket(*(const struct Gre::Full::SESSION_GLOBALS **)(SessionState + 96), a1, &v10);
    v9 = *(NSInstrumentation::CPointerHashTable **)(v7 + 4832);
    LOWORD(v10) = v3;
    if ( HwndDpiBucket )
    {
      v11 = 0LL;
    ...
    {
      RtlSetBit((PRTL_BITMAP)(v7 + 4840), (ULONG)v5);
    }
  }
  else
  {
    NSInstrumentation::CPointerHashTable::Remove(
      *(NSInstrumentation::CPointerHashTable **)(v7 + 4832),
      (unsigned int)v5,
      &v10);
    RtlClearBit((PRTL_BITMAP)(v7 + 4840), (ULONG)v5);
  }
}
