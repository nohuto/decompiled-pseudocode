/*
 * XREFs of GetScaledLogFontForDpi @ 0x1401D087C
 * Callers:
...
_BOOL8 __fastcall GetScaledLogFontForDpi(int a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v27; // r8
  int v28; // eax
  Gre::Base *v29; // [rsp+78h] [rbp+20h] BYREF
  ...
  if ( !a1 )
  {
    ...
    {
      v24 = *(Gre::Base **)(DPIMETRICSForDpiUnsafe + 64);
      goto LABEL_15;
    }
  ...
  if ( !v11 )
  {
    if ( DPIMETRICSForDpiUnsafe )
    {
      v24 = *(Gre::Base **)(DPIMETRICSForDpiUnsafe + 32);
      goto LABEL_15;
    }
  ...
  if ( !v12 )
  {
    if ( DPIMETRICSForDpiUnsafe )
    {
      v24 = *(Gre::Base **)DPIMETRICSForDpiUnsafe;
      goto LABEL_15;
    }
  ...
  if ( !v13 )
  {
    if ( DPIMETRICSForDpiUnsafe )
    {
      v24 = *(Gre::Base **)(DPIMETRICSForDpiUnsafe + 56);
      goto LABEL_15;
    }
...
LABEL_29:
  ...
  if ( v14 )
  {
    if ( v14 == 1 )
    {
      v15 = *(_QWORD *)(W32GetUserSessionState(v9, a2) + 19904);
      ...
      *(_DWORD *)(a3 + 88) = *(_DWORD *)(v15 + 5092);
      v19 = *(_QWORD *)(W32GetUserSessionState(v17, v16) + 19904);
      if ( v4 != *(unsigned __int16 *)(v19 + 6998) )
      {
        ...
        *(_DWORD *)a3 = EngMulDiv(*(_DWORD *)a3, v4, *(unsigned __int16 *)(*(_QWORD *)(v23 + 19904) + 6998LL));
      }
      return 1;
    }
    return v7;
  }
  v24 = *(Gre::Base **)(GetDpiServerInfoForDpi(v4) + 8);
LABEL_15:
  if ( v24 )
    v7 = GreExtGetObjectW(v24, 92, (_WORD *)a3) != 0;
  if ( v10 )
