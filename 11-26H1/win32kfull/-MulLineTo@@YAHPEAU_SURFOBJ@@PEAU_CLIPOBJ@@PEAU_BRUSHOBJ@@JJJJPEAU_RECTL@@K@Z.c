/*
 * XREFs of ?MulLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x140067810
 * Callers:
 *     <none>
 * Callees:
        ...
        MIX mix)
{
  ...
  SURFOBJ *v28; // [rsp+D0h] [rbp-30h]
  struct _CLIPOBJ *v29; // [rsp+D8h] [rbp-28h]
  ...
  {
    MULTIBRUSH::LoadElement((MULTIBRUSH *)&v19, v27, (struct SURFACE *)&v28[-1].pvScan0);
    if ( ((__int64)v28[1].hsurf & 0x100) != 0 )
      v18 = *(BOOL (__stdcall **)(SURFOBJ *, CLIPOBJ *, BRUSHOBJ *, LONG, LONG, LONG, LONG, RECTL *, MIX))(*((_QWORD *)v27 + 7) + 2928LL);
    else
      v18 = EngLineTo;
    v14 &= OffLineTo(
             (__int64 (__fastcall *)(SURFOBJ *, struct _CLIPOBJ *, BRUSHOBJ *, _QWORD, int, int, int, RECTL *, MIX))v18,
             v30,
             v28,
             v29,
             pbo,
