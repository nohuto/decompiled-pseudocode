/*
 * XREFs of ?Grow@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@IEAAJI@Z @ 0x14013E6F4
 * Callers:
...
__int64 __fastcall CDynamicArray<IInputQueue *,2003858261>::Grow(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v4; // esi
  unsigned int v5; // ebx
  void *v6; // rax
