/*
 * XREFs of DxgkEngColorFillViaGDI @ 0x140348650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngColorFillViaGDI(HDC a1, _DWORD *a2, __int64 a3, unsigned int a4, int a5)
{
  ...
  _QWORD v16[14]; // [rsp+30h] [rbp-88h] BYREF
      ...
      if ( SolidBrush )
      {
        ...
        if ( (_DWORD)v6 )
        {
          ...
          else
          {
            do
            {
              v14 = GrepPatBlt((struct XDCOBJ *)v16, *(v12 - 1), *v12, v12[1] - *(v12 - 1), v12[2] - *v12, 0xF00021u);
              v12 += 4;
              v5 = v14;
              --v6;
            }
