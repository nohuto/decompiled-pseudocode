/*
 * XREFs of ?_GetCursorInfo@@YAXPEAUtagCURSORINFO@@@Z @ 0x1401B48A8
 * Callers:
...
void __fastcall _GetCursorInfo(struct tagCURSORINFO *a1)
{
  ...
  *((_QWORD *)a1 + 2) = LogicalCursorPosFromDpiAwarenessContext(CurrentThreadDpiAwarenessContext);
  ...
  {
    v4 = *(_QWORD *)(W32GetUserSessionState(v4, v3) + 36360) != 0LL;
    *((_DWORD *)a1 + 1) = v4;
  }
  if ( *(_QWORD *)(W32GetUserSessionState(v4, v3) + 36352) )
    v5 = **(_QWORD **)(W32GetUserSessionState(v7, v6) + 36352);
  *((_QWORD *)a1 + 1) = v5;
}
