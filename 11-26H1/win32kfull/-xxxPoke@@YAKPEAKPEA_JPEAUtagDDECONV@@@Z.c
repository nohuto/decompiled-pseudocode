/*
 * XREFs of ?xxxPoke@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1402CD704
 * Callers:
  ...
  else if ( v6 == 2 )
  {
    ...
    if ( (*((_WORD *)v15 + 36) & 0x2000) != 0 )
    {
      ...
      v10 = (unsigned int)GiveObject(
                            ...
                            *((void **)v8 + 6),
                            *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 6) + 16LL) + 456LL) + 56LL)) == 0;
      v11 = v17;
      if ( !v10 )
        v11 = v17 | 0x4000;
      v12 = v11 | 0x400;
    ...
    else
    {
      v10 = (unsigned int)AddPublicObject(
                            ...
                            *((void **)v15 + 6),
                            *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 5) + 16LL) + 456LL) + 56LL)) == 0;
      v12 = v17;
      if ( !v10 )
        v12 = v17 | 0x2000;
    }
