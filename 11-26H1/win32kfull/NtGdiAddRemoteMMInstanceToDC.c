/*
 * XREFs of NtGdiAddRemoteMMInstanceToDC @ 0x140312150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiAddRemoteMMInstanceToDC(HDC a1, void *Src, size_t Size)
{
  ...
  if ( v24[0] )
  {
    ...
    {
      GreProbeForReadFromUntrustedVa(Src, v3, 1uLL);
      memmove(v25, Src, v3);
      if ( v27 <= 0x10 )
      {
        SessionState = W32GetSessionState(v9, v8);
        SEMOBJ<17>::SEMOBJ<17>(&v18, *(_QWORD *)(SessionState + 96) + 4864LL);
        if ( (unsigned int)GreGetBaseUFIBits((struct _UNIVERSAL_FONT_ID *)v25, (struct FONTFILEVIEW *)v20) )
        {
          v13 = W32GetSessionState(v12, v11);
          PUBLIC_PFTOBJ::PUBLIC_PFTOBJ((PUBLIC_PFTOBJ *)v19, *(struct PFT **)(*(_QWORD *)(v13 + 96) + 20392LL));
