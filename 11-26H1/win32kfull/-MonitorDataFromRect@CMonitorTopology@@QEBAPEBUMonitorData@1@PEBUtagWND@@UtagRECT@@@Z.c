/*
 * XREFs of ?MonitorDataFromRect@CMonitorTopology@@QEBAPEBUMonitorData@1@PEBUtagWND@@UtagRECT@@@Z @ 0x14015FB64
 * Callers:
        ...
        struct tagRECT *a3)
{
  ...
  if ( v7 )
  {
    ...
    if ( WPP_GLOBAL_Control == (struct MOVESIZEDATA *)&WPP_GLOBAL_Control
      || (v6 = *((unsigned int *)WPP_GLOBAL_Control + 11), (v6 & 0x40) == 0)
  ...
  else
  {
    ...
    {
      v13 = W32GetUserSessionState(WPP_GLOBAL_Control, v5);
      LOBYTE(v14) = v12;
      LOBYTE(v15) = v11;
      WPP_RECORDER_AND_TRACE_SF_dddddd(
        *((_QWORD *)WPP_GLOBAL_Control + 3),
        ...
        *(_QWORD *)(v13 + 69152),
        ...
        a3->right,
        a3->bottom,
        LOBYTE(a3->right) - LOBYTE(a3->left),
        LOBYTE(a3->bottom) - LOBYTE(a3->top));
    }
  }
  return v7;
}
