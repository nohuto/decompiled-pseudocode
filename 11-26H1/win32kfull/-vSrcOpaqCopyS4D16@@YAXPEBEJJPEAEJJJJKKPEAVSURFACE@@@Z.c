/*
 * XREFs of ?vSrcOpaqCopyS4D16@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x14030F6A0
 * Callers:
 *     <none>
 * Callees:
 *     ?GreGetCurrentThreadCrossSessionCheck@@YAPEAU_GRETHREAD@@XZ @ 0x140071590 (-GreGetCurrentThreadCrossSessionCheck@@YAPEAU_GRETHREAD@@XZ.c)
 *     ??0?$SEMOBJ@$0BI@@@QEAA@AEAUGLOBALS@Font@Gre@@@Z @ 0x1400EF238 (--0-$SEMOBJ@$0BI@@@QEAA@AEAUGLOBALS@Font@Gre@@@Z.c)
 *     ?vSrcOpaqCopyS4D16Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x14030F7AC (-vSrcOpaqCopyS4D16Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z.c)
 */
        ...
        struct SURFACE *a11)
{
  ...
  SEMOBJ<24>::SEMOBJ<24>(&v19, *(_QWORD *)(SessionState + 96) + 4864LL);
  vSrcOpaqCopyS4D16Unsafe(a1, v13, a3, a4, a5, a6, a7, a8, a9, a10, a11);
  v16 = v19;
  if ( v19 )
  {
