/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1402FBA58
 * Callers:
 ...
 *     ?OnDeviceOpened@RimBackedDeviceBase@@UEAAXXZ @ 0x1402FE940 (-OnDeviceOpened@RimBackedDeviceBase@@UEAAXXZ.c)
 */
