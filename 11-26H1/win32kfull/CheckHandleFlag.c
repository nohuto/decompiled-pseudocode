/*
 * XREFs of CheckHandleFlag @ 0x1401BB438
 * Callers:
 *     zzzSetDesktop @ 0x140059C20 (zzzSetDesktop.c)
 *     _GetUserObjectInformation @ 0x14005A700 (_GetUserObjectInformation.c)
 *     OkayToCloseDesktop @ 0x1401BB310 (OkayToCloseDesktop.c)
 *     OkayToCloseWindowStation @ 0x1401BB3B0 (OkayToCloseWindowStation.c)
 * Callees:
...
__int64 __fastcall CheckHandleFlag(PRKPROCESS PROCESS, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( PROCESS )
  {
    if ( (unsigned int)PsGetProcessSessionIdEx(PROCESS) != v4 )
    {
  ...
  if ( v11 && v8 < *(_DWORD *)(v11 + 704) && _bittest64(*(const signed __int64 **)(v11 + 712), v8) )
    v6 = 1;
  if ( v7 )
