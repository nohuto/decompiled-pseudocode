/*
 * XREFs of ?vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z @ 0x140322CA8
 * Callers:
...
void __fastcall vDeleteSemaphores(struct _PANDEV *a1)
{
  ...
  v4 = (Gre::Semaphore *)*((_QWORD *)a1 + 98);
  if ( v4 )
  {
    Gre::Semaphore::Uninitialize(v4);
    if ( *(_QWORD *)(*((_QWORD *)a1 + 98) + 32LL) )
    {
      GreDeleteFastMutex();
      *(_QWORD *)(*((_QWORD *)a1 + 98) + 32LL) = 0LL;
    }
    EngFreeMem(*((PVOID *)a1 + 98));
  }
