/*
 * XREFs of ?_PostEdgyInertia@Edgy@@YAXPEAUHWND__@@W4tagEDGY_LOCATION@@K@Z @ 0x1402C37F4
 * Callers:
...
__int64 __fastcall Edgy::_PostEdgyInertia(__int64 a1, unsigned __int16 a2, unsigned __int16 a3)
{
  __int64 result; // rax
  __int64 v6; // rcx
