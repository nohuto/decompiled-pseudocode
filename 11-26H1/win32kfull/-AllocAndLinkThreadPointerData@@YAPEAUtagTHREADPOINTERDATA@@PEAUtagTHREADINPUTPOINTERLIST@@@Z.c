/*
 * XREFs of ?AllocAndLinkThreadPointerData@@YAPEAUtagTHREADPOINTERDATA@@PEAUtagTHREADINPUTPOINTERLIST@@@Z @ 0x1402183A8
 * Callers:
 *     EditionAllocAndLinkThreadPointerData @ 0x140218390 (EditionAllocAndLinkThreadPointerData.c)
 * Callees:
 *     <none>
 */
