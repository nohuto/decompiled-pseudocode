/*
 * XREFs of ?PostWindowAction@@YA_NPEAUtagWND@@PEBU_WINDOW_ACTION@@PEAVCMonitorTopology@@@Z @ 0x1402E298C
 * Callers:
...
char __fastcall PostWindowAction(PETHREAD **a1, const struct _WINDOW_ACTION *a2, struct CMonitorTopology *a3)
{
  ...
  *v6 = *(_OWORD *)a2;
  ...
  if ( !PostEventMessageWindow((struct tagTHREADINFO **)a1, 0x1Fu, (unsigned __int64)a3, (__int64)v8) )
  {
    if ( WPP_GLOBAL_Control == (struct MOVESIZEDATA *)&WPP_GLOBAL_Control
      || (*((_DWORD *)WPP_GLOBAL_Control + 11) & 8) == 0
      || *((_BYTE *)WPP_GLOBAL_Control + 41) < 2u )
