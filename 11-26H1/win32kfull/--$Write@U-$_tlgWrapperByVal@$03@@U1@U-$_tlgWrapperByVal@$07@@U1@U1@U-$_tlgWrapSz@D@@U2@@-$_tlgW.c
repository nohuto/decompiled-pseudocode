/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U?$_tlgWrapperByVal@$07@@U1@U1@U?$_tlgWrapSz@D@@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3AEBU?$_tlgWrapperByVal@$07@@33AEBU?$_tlgWrapSz@D@@4@Z @ 0x140093AC4
 * Callers:
        ...
        __int64 a11)
{
  ...
  v19 = 4LL;
  v17 = 4LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1403AAA30, a2, 0LL, 0LL, 9u, &v15);
}
