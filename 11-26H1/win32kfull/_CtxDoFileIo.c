/*
 * XREFs of _CtxDoFileIo @ 0x14034DE9C
 * Callers:
 *     EngFileWrite @ 0x140349320 (EngFileWrite.c)
 * Callees:
 *     <none>
 */
...
NTSTATUS __fastcall CtxDoFileIo(__int64 a1, struct _FILE_OBJECT *a2, void *a3, ULONG a4)
{
  ...
  union _LARGE_INTEGER StartingOffset; // [rsp+48h] [rbp+10h] BYREF
  ...
  v10 = IoBuildAsynchronousFsdRequest(4u, RelatedDeviceObject, a3, a4, &StartingOffset, &IoStatusBlock);
  v11 = v10;
  if ( !v10 )
    return -1073741670;
  v10->Flags |= 4u;
