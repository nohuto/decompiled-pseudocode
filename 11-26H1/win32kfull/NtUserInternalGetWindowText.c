/*
 * XREFs of NtUserInternalGetWindowText @ 0x14001F890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserInternalGetWindowText(__int64 a1, _WORD *a2, int a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v9 )
    {
      ...
      HIDWORD(Src[0]) = v12;
      v13 = *(_QWORD *)(v7 + 24);
      if ( (((unsigned __int8)v11 | (unsigned __int8)v12) & 1) != 0 || v11 >= (v12 & 0x7FFFFFFFu) )
      ...
      v6 = *(_QWORD *)(v13 + 136);
      if ( v9 < v6 || (v16 = *(unsigned int *)(v13 + 144) + v6, v9 >= v16) )
    ...
    if ( (_DWORD)v3 )
    {
      ...
      *a2 = 0;
      v6 = *(unsigned int *)(*(_QWORD *)(v7 + 40) + 184LL);
      if ( (_DWORD)v6 )
      {
        *(_OWORD *)Src = 0LL;
        Src[1] = *(void **)(v7 + 184);
        LODWORD(Src[0]) = v6;
        HIDWORD(Src[0]) = *(_DWORD *)(*(_QWORD *)(v7 + 40) + 188LL) ^ (*(_DWORD *)(*(_QWORD *)(v7 + 40) + 188LL) ^ *(_DWORD *)(*(_QWORD *)(v7 + 40) + 188LL) & 0x7FFFFFFF) & 0x7FFFFFFF;
        v18 = (unsigned int)v6 >> 1;
        if ( (unsigned int)v18 >= (int)v3 - 1 )
          v18 = (unsigned int)(v3 - 1);
        v19 = v18;
        v20 = v18;
        memmove(a2, Src[1], 2 * v18);
        a2[v20] = 0;
        v8 = v19;
      }
    }
