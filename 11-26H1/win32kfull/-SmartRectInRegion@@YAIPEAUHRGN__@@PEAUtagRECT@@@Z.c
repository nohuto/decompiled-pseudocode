/*
 * XREFs of ?SmartRectInRegion@@YAIPEAUHRGN__@@PEAUtagRECT@@@Z @ 0x14002F9B0
 * Callers:
...
__int64 __fastcall SmartRectInRegion(HRGN a1, struct tagRECT *a2)
{
  ...
  SetRectRgnIndirect(*(_QWORD *)(UserSessionState + 63360), a2);
  v19 = *(_QWORD *)(W32GetUserSessionState(v18, v17) + 63360);
  v22 = W32GetUserSessionState(v21, v20);
  v23 = GreCombineRgn(*(_QWORD *)(v22 + 63360), v19, a1, 1LL) - 1;
  if ( !v23 )
    return 0LL;
  if ( v23 != 1 )
    return 1LL;
  v26 = W32GetUserSessionState(v25, v24);
  if ( !(unsigned int)GreGetRgnBox(*(_QWORD *)(v26 + 63360), &v28) )
    return 3LL;
