/*
 * XREFs of ?vSrcTranCopyS8D16New@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@P6AX011JPEAPEAG@Z1@Z @ 0x140310204
 * Callers:
        ...
        unsigned __int8 *a13)
{
  ...
  SEMOBJ<24>::SEMOBJ<24>((HSEMAPHORE *)&a12, *(_QWORD *)(SessionState + 96) + 4864LL);
