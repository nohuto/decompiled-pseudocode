/*
 * XREFs of ??0InkProcessor@@AEAA@XZ @ 0x1402FB748
 * Callers:
...
InkProcessor *__fastcall InkProcessor::InkProcessor(InkProcessor *this)
{
  ...
  *((_QWORD *)this + 12) = (char *)this + 96;
  if ( IsCurrentSessionHostServiceSession((__int64)this) )
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1403AAAD8);
  *(_QWORD *)this = 0LL;
