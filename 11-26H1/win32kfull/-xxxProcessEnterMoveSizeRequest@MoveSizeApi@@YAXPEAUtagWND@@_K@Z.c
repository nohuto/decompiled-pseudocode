/*
 * XREFs of ?xxxProcessEnterMoveSizeRequest@MoveSizeApi@@YAXPEAUtagWND@@_K@Z @ 0x1402C75E0
 * Callers:
...
void __fastcall MoveSizeApi::xxxProcessEnterMoveSizeRequest(MoveSizeApi *this, struct tagWND *a2)
{
  ...
  if ( v5 )
  {
    if ( (_InterlockedCompareExchange((volatile signed __int32 *)(v5 + 520), 0, 0) & 1) != 0 )
    {
      ...
      {
        v33 = *(_DWORD *)a2;
        v11 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v6) + 69152);
        v32 = 129;
        goto LABEL_9;
      }
    }
      ...
      if ( (v12 & 0x8000000000LL) != 0 )
      {
        ...
        if ( v14 || !IsTopLevelWindow((__int64)this) )
        {
          ...
          if ( v24 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
          {
            ...
            LOBYTE(v28) = v25;
            LOBYTE(v29) = v24;
            v30 = *(_QWORD *)(UserSessionState + 69152);
        ...
        else
        {
          if ( (unsigned __int8)IsCapturedByThread(&v34) )
          {
            ...
            {
              v18 = *(_DWORD *)a2;
              v19 = W32GetUserSessionState(WPP_GLOBAL_Control, v15);
              LOBYTE(v20) = v17;
              LOBYTE(v21) = v16;
            ...
            v22 = (__int128 *)INPUTDEST_FROM_PWND(v35, (__int64)this);
            v36 = *v22;
            v37 = v22[1];
            v38 = v22[2];
            v39 = v22[3];
            ...
            v42 = v22[6];
            ForceCapture(2LL);
            *(_BYTE *)(*(_QWORD *)(v2 + 464) + 280LL) |= 4u;
            *(_BYTE *)(v34[58] + 280LL) &= ~4u;
          }
          *(_QWORD *)(v2 + 800) = v34[100];
          v23 = v34;
          *(_QWORD *)(v2 + 788) = *(_QWORD *)((char *)v34 + 788);
          *(_DWORD *)(v2 + 796) = *((_DWORD *)v23 + 199);
