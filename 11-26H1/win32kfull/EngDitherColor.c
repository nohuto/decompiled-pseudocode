/*
 * XREFs of EngDitherColor @ 0x140291900
 * Callers:
 ...
 * Callees:
 *     ?vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z @ 0x14031A81C (-vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z.c)
 *     ?vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x14031AAB0 (-vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
 *     ?vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x14031ADA4 (-vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
    ...
    if ( iMode == 2 )
    {
      ...
      *((_OWORD *)pul + 1) = 0LL;
      ...
      if ( v10 )
      {
        ...
        do
        {
          v12 = byte_14036FEA0[v11 + 63];
          pul[v12] |= byte_14036FEA0[--v11];
          --v10;
        }
        while ( v10 );
      }
