/*
 * XREFs of ReadTiltCalibrationData @ 0x140298F18
 * Callers:
...
__int64 __fastcall ReadTiltCalibrationData(__int64 a1, struct _UNICODE_STRING *a2)
{
  ...
  unsigned __int8 **v19[4]; // [rsp+60h] [rbp-A0h]
  unsigned int *v20[4]; // [rsp+80h] [rbp-80h]
  _DWORD v21[4]; // [rsp+A0h] [rbp-60h] BYREF
  struct _UNICODE_STRING v22; // [rsp+B0h] [rbp-50h] BYREF
  struct _UNICODE_STRING v23; // [rsp+C0h] [rbp-40h] BYREF
  ...
  *(_DWORD *)&v17.Length = 45875200;
  ...
  TiltKeyName = RtlUnicodeStringCopy(
                  &v17,
                  (const struct _UNICODE_STRING *)(*(_QWORD *)(UserSessionState + 63512) + 168LL));
  if ( TiltKeyName >= 0 )
  {
    v8 = 1;
    ...
    if ( TiltKeyName >= 0 )
    {
      ...
      do
      {
        *(_QWORD *)&v15.Length = 91750400LL;
        ...
        TiltKeyName = RtlUnicodeStringCatString(&v15, off_14035BE48[v11]);
        if ( TiltKeyName >= 0 )
        {
          v13 = v19[v11];
          v14 = v20[v11];
          ...
          TiltKeyName = ReadCalibrationDataImp(&v23, &v22, v14, v13);
