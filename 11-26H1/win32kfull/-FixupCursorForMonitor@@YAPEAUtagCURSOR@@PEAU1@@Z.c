/*
 * XREFs of ?FixupCursorForMonitor@@YAPEAUtagCURSOR@@PEAU1@@Z @ 0x14002AB0C
 * Callers:
...
struct tagCURSOR *__fastcall FixupCursorForMonitor(struct tagCURSOR *a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    CurrentCursorSize = CCursorSizes::GetCurrentCursorSize(*(CCursorSizes **)(UserSessionState + 36376));
    v7 = *((_QWORD *)v2 + 6);
