/*
 * XREFs of zzzActiveCursorTracking @ 0x1402A0BB8
 * Callers:
...
char __fastcall zzzActiveCursorTracking(__int64 a1, __int64 a2)
{
        ...
        (_DWORD)ActiveTrackPwnd == 4) )
  {
    ...
    {
      if ( !*(_QWORD *)(W32GetUserSessionState(v10, v9) + 36288)
        || (v13 = W32GetUserSessionState(v12, v11),
            (ActiveTrackPwnd = GetActiveTrackPwnd(*(const struct tagWND **)(v13 + 36288), v14)) != 0LL) )
      {
        v15 = *(_DWORD **)(a1 + 40);
        ...
        CCursorClip::BoundPoint(*(_QWORD *)(v18 + 36272), &v24, v22, 0LL, 2, &v22);
        v23 = v22;
        if ( (unsigned int)IsWindowDesktopComposed(a1) )
