/*
 * XREFs of GreDeleteSpriteDelayDelete @ 0x140344DC0
 * Callers:
...
__int64 __fastcall GreDeleteSpriteDelayDelete(Gre::Base *a1, Gre::Base *a2, HSPRITE a3, int a4)
{
  unsigned int v4; // edi
  int v9; // r14d
  Gre::Base *v10; // rcx
  ...
  v4 = 0;
  v9 = 1;
  v11 = (__int64 *)Gre::Base::Globals(a1);
  if ( !a4 || !IsDwmActive(v10) )
    return (unsigned int)GdiDeleteSpriteDelayDelete((HDEV)a1, (HWND)a2, a3);
