/*
 * XREFs of ?CancelForegroundActivate@CForegroundLaunch@@QEAAXXZ @ 0x14028F1B4
 * Callers:
...
void __fastcall CForegroundLaunch::CancelForegroundActivate(CForegroundLaunch *this)
{
  ...
  if ( (*(_DWORD *)(W32GetUserSessionState(v3, v2) + 66792) & 0x8000000) != 0 )
  {
    v6 = 1;
