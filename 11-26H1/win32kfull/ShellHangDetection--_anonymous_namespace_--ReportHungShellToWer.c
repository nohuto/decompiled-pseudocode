/*
 * XREFs of ShellHangDetection::_anonymous_namespace_::ReportHungShellToWer @ 0x1402894D8
 * Callers:
...
void __fastcall ShellHangDetection::_anonymous_namespace_::ReportHungShellToWer(__int64 a1)
{
  ...
  if ( !(unsigned int)IsShellProcess(*(_QWORD *)(a1 + 456)) )
  {
    LODWORD(ThreadHandle) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2397LL);
  }
  v2 = (_DWORD *)Win32AllocPoolNonPagedZInit(12LL, 1163359061LL);
  StartContext = v2;
  if ( v2 )
  {
    *v2 = *(_DWORD *)(*(_QWORD *)(a1 + 456) + 56LL);
