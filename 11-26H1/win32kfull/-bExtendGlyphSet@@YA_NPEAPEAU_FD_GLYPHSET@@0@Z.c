/*
 * XREFs of ?bExtendGlyphSet@@YA_NPEAPEAU_FD_GLYPHSET@@0@Z @ 0x140260378
 * Callers:
...
char __fastcall bExtendGlyphSet(struct _FD_GLYPHSET **a1, struct _FD_GLYPHSET **a2)
{
  ...
  if ( v5 > 0x100 )
    return 0;
  if ( (unsigned __int16)(*(_WORD *)(16LL * (unsigned int)(v4 - 1) + v2 + 16)
                        + *(_WORD *)(16LL * (unsigned int)(v4 - 1) + v2 + 18)
                        - 1) >= 0xF020u
    && *(_WORD *)(v2 + 16) <= 0xF0FFu )
  {
    v6 = 0;
...
LABEL_9:
  ...
  if ( v8 )
  {
    ...
    if ( (unsigned int)ConvertToAndFromWideChar(v17, v42, 2 * v5, v41, 0x100u, 0) == -1 )
    {
      Win32FreePool(v8);
      return 0;
    }
