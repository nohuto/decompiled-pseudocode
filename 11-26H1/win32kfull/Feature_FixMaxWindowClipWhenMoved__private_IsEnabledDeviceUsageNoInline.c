/*
 * XREFs of Feature_FixMaxWindowClipWhenMoved__private_IsEnabledDeviceUsageNoInline @ 0x140299838
 * Callers:
 *     ?FixupMonitorRgn@@YAXPEAUtagWND@@_N@Z @ 0x14026F7C4 (-FixupMonitorRgn@@YAXPEAUtagWND@@_N@Z.c)
 * Callees:
 *     Feature_FixMaxWindowClipWhenMoved__private_IsEnabledFallback @ 0x140299874 (Feature_FixMaxWindowClipWhenMoved__private_IsEnabledFallback.c)
 */
