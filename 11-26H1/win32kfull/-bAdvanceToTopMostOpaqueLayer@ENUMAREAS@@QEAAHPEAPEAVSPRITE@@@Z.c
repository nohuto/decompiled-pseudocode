/*
 * XREFs of ?bAdvanceToTopMostOpaqueLayer@ENUMAREAS@@QEAAHPEAPEAVSPRITE@@@Z @ 0x140167160
 * Callers:
...
__int64 __fastcall ENUMAREAS::bAdvanceToTopMostOpaqueLayer(ENUMAREAS *this, struct SPRITE **a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(W32GetSessionState(this, a2, v2) + 96) + 4816LL) )
  {
    while ( 1 )
    {
      v9 = *(_QWORD *)(v4 + 8);
      if ( (*(_DWORD *)v9 & 8) != 0 )
      {
        v10 = *(_DWORD **)(v9 + 184);
        if ( !v10
          || (unsigned int)REGION_CORE::get_sizeScan((REGION_CORE *)(v10 + 6)) <= 0x38
          && v10[13] <= *(_DWORD *)v4
          && v10[15] >= *(_DWORD *)(v4 + 4)
