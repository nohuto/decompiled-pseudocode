/*
 * XREFs of ?TryRecordParentPidLegacyPolicy@CForegroundLaunch@@QEAAXPEAUtagPROCESSINFO@@@Z @ 0x1402140B4
 * Callers:
 *     EditionPushExitingAppForegroundPolicy @ 0x140214080 (EditionPushExitingAppForegroundPolicy.c)
 * Callees:
