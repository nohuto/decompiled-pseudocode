/*
 * XREFs of NtUserfnINOUTLPWINDOWPOS @ 0x1401C4700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserfnINOUTLPWINDOWPOS(__int64 a1, unsigned int a2, __int64 a3, __int128 *a4, __int64 a5, char a6)
{
  __int64 v10; // rdx
  __int64 v11; // rcx
