/*
 * XREFs of ??$AllocAndCopyRegistryEntries@U_FONTMAPPERFAMILYFALLBACK@@$0EGEGENEH@@@YAJPEAKPEAPEAU_FONTMAPPERFAMILYFALLBACK@@0PEBU0@@Z @ 0x1403430E0
 * Callers:
        ...
        _OWORD *a4)
{
  ...
  v10 = (v6 + 32) << 7;
  if ( *a2 )
    v11 = (__int64)PREALLOCMEM2(*a2, (unsigned int)(v6 << 7), v10, 0x46464D47u);
  else
    v11 = PALLOCMEM(v10, 1179012423LL);
  if ( v11 )
  {
    *a2 = (void *)v11;
    *a3 = v9;
