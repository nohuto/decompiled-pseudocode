/*
 * XREFs of RedistributeDeferredMsgsOnQueue @ 0x14021C7E0
 * Callers:
 ...
 * Callees:
 *     ?DeferMessage@@YAXPEAUtagMLIST@@PEAUtagQMSG@@@Z @ 0x14016ED98 (-DeferMessage@@YAXPEAUtagMLIST@@PEAUtagQMSG@@@Z.c)
...
void __fastcall RedistributeDeferredMsgsOnQueue(__int64 a1)
{
  ...
  if ( v1 )
  {
    ...
    {
      v3 = *(_QWORD *)(v1 + 8);
      if ( *(_QWORD *)(*(_QWORD *)(v1 + 104) + 464LL) != v2 )
      {
        RemoveQMsgFromDeferList((struct tagMLIST *)(v2 + 24), (struct tagQMSG *)v1);
        DeferMessage((struct tagMLIST *)(*(_QWORD *)(*(_QWORD *)(v4 + 104) + 464LL) + 24LL), (struct tagQMSG *)v4);
      }
      v1 = v3;
    }
    while ( v3 );
