/*
 * XREFs of ??0?$SEMOBJEXORSHARED@$05@@QEAA@AEAUSESSION_GLOBALS@Base@Gre@@_N@Z @ 0x14001B724
 * Callers:
...
{
  __int64 v4; // rdx
  void (*v5)(HSEMAPHORE); // rcx

  v4 = *a2 + 1040LL;
  *(_BYTE *)(a1 + 8) = a3;
  *(_QWORD *)a1 = v4;
  v5 = GreAcquireSemaphoreSharedInternal;
  if ( !a3 )
    v5 = GreAcquireSemaphoreInternal;
