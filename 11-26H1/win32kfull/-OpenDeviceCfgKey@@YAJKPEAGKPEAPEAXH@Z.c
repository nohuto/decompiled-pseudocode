/*
 * XREFs of ?OpenDeviceCfgKey@@YAJKPEAGKPEAPEAXH@Z @ 0x14013F240
 * Callers:
 *     ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x14013EB3C (-GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z.c)
 *     EditionGetPointerDeviceConfigurationKey @ 0x14027B890 (EditionGetPointerDeviceConfigurationKey.c)
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker @ 0x14013F5E4 (RtlUnicodeStringValidateWorker.c)
...
__int64 __fastcall OpenDeviceCfgKey(unsigned int a1, unsigned __int16 *a2, ACCESS_MASK a3, void **a4, int a5)
{
  ...
  if ( a1 <= 0x15E )
  {
    *(_QWORD *)&v29.Length = 45875200LL;
    ...
    if ( v22 )
    {
      if ( *(_QWORD *)(W32GetUserSessionState(v24, v23) + 63512) )
      {
        UserSessionState = W32GetUserSessionState(v26, v25);
        v9 = RtlUnicodeStringCopy(&v29, (const struct _UNICODE_STRING *)(*(_QWORD *)(UserSessionState + 63512) + 168LL));
      }
      else
      {
        v9 = -1073741595;
