/*
 * XREFs of ?DestroyPhysicalMonitor@CMonitorAPI@@QEAAJPEAX@Z @ 0x14028A858
 * Callers:
 *     DestroyPhysicalMonitor @ 0x14028A820 (DestroyPhysicalMonitor.c)
 *     NtGdiDestroyPhysicalMonitor @ 0x1403460C0 (NtGdiDestroyPhysicalMonitor.c)
 * Callees:
