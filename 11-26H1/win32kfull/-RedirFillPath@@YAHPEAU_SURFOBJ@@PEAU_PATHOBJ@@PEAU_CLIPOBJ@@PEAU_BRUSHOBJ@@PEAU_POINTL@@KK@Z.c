/*
 * XREFs of ?RedirFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x14030D710
 * Callers:
 *     <none>
 * Callees:
        ...
        FLONG a7)
{
  ...
  __int64 v19; // [rsp+40h] [rbp-E8h] BYREF
  _BYTE v20[8]; // [rsp+48h] [rbp-E0h] BYREF
  struct SURFACE *v21[2]; // [rsp+50h] [rbp-D8h] BYREF
  _BYTE v22[160]; // [rsp+60h] [rbp-C8h] BYREF
