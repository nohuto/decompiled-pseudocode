/*
 * XREFs of ?FillGradient@@YAXPEAUHDC__@@PEBUtagRECT@@KK@Z @ 0x14022E224
 * Callers:
...
void __fastcall FillGradient(Gre::Base *a1, const struct tagRECT *a2, int a3, int a4)
{
  ...
  GreGradientFill(a1, &v6, 2u, (char *)(UserSessionState + 56996), 1u, 0);
}
