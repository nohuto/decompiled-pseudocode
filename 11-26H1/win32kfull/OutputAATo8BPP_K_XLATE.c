/*
 * XREFs of OutputAATo8BPP_K_XLATE @ 0x140307F00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall OutputAATo8BPP_K_XLATE(
        __int64 a1,
        __int64 a2,
        unsigned __int64 a3,
        _BYTE *a4,
      ...
      if ( v9[3] )
      {
        ...
        if ( v20 < v13 )
        {
          ...
          if ( v20 < v21 )
          {
            v22 = *a6;
            if ( v20 < v22 )
              v14 = *(_BYTE *)((((v21 - DWORD1(v24)) & (v17 - v21) & 0x38000 | (v13 - DWORD2(v24)) & (v15 - v13) & 0x1C0000 | (unsigned __int64)((unsigned __int16)(v22 - v24) & (unsigned __int16)(v19 - v22) & 0x7000)) >> 12)
                             + a9);
          }
        }
        *a4 = v14;
