/*
 * XREFs of ?bSpDwmUpdateMaskCursor@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@3PEAU_RECTL@@PEAKPEAPEAV3@@Z @ 0x14019C5C4
 * Callers:
 ...
 *     ?vSpDwmMaskToARGB@@YAXPEAU_SURFOBJ@@0PEAH@Z @ 0x14019C908 (-vSpDwmMaskToARGB@@YAXPEAU_SURFOBJ@@0PEAH@Z.c)
        ...
        struct SFMLOGICALSURFACE **a8)
{
  ...
  XLATEOBJ *v28; // [rsp+68h] [rbp-98h] BYREF
  ...
  v38 = (unsigned int)v9;
  v40 = 0LL;
  DIB = SURFMEM::bCreateDIB((SURFMEM *)&v34, (struct _DEVBITMAPINFO *)v37, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0);
  if ( DIB )
  {
    if ( !a5
      || (v38 >>= 1,
          (DIB = SURFMEM::bCreateDIB((SURFMEM *)&v31, (struct _DEVBITMAPINFO *)v37, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0)) != 0) )
    {
      v12 = *((_QWORD *)v10 + 488);
      v13 = (Gre::Base *)*((_QWORD *)v10 + 484);
      v14 = *((_QWORD *)v10 + 485);
      ...
      if ( v31
        && (unsigned int)EXLATEOBJ::bInitXlateObj(
                           ...
                           0) )
      {
        DIB = EngCopyBits(v16, a5, 0LL, v28, &prclDest, (POINTL *)&prclDest);
      }
      inited = EXLATEOBJ::bInitXlateObj((Gre::Base *)&pxlo, 0LL, 0, v12, v14, (__int64)v13, v13, 0, 0xFFFFFF, 0, 0);
      v20 = psoSrc;
      if ( inited )
      {
        prclDest.bottom += psoSrc->sizlBitmap.cy >> 1;
        DIB = EngCopyBits((SURFOBJ *)v15, psoSrc, 0LL, pxlo, &prclDest, (POINTL *)&prclDest);
      }
      if ( DIB )
      {
        v27 = 0;
        ...
        v22 = v44;
        v23 = (Gre::Base *)v45;
        *((_DWORD *)v42 + 34) = (v27 != 0 ? 4 : 0) | *((_DWORD *)v42 + 34) & 0xFFFFFFFB;
      ...
      EXLATEOBJ::vAltUnlock((Gre::Base **)&v28, v18, v19);
      EXLATEOBJ::vAltUnlock((Gre::Base **)&pxlo, v24, v25);
    }
  }
