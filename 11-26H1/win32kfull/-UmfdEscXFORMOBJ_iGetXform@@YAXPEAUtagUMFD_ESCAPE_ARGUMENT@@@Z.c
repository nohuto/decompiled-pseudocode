/*
 * XREFs of ?UmfdEscXFORMOBJ_iGetXform@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1400CEFD8
 * Callers:
...
void __fastcall UmfdEscXFORMOBJ_iGetXform(void **a1)
{
  int *v2; // rdi
  ...
  __int64 v5; // rax
  __int64 v6; // rsi
  struct _XFORML v7; // [rsp+40h] [rbp-28h] BYREF
  ...
  if ( v3 && (v5 = *((_QWORD *)v3 + 5)) != 0 )
  {
    ...
    *v2 = v4;
    GreProbeAndWriteToUntrustedVa(a1[2], 0x18uLL, &v7, 0x18uLL, 4uLL);
  }
  else
  {
    *v2 = -1;
