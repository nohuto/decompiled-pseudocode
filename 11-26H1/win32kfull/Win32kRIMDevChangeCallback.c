/*
 * XREFs of Win32kRIMDevChangeCallback @ 0x140222790
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsPublicPointerDevice @ 0x1402A9148 (IsPublicPointerDevice.c)
 *     UpdatePointerDeviceCount @ 0x1402A9170 (UpdatePointerDeviceCount.c)
 ...
 *     ?InkProcessorOnInkDeviceOpened@@YAXPEAURawInputManagerDeviceObject@@@Z @ 0x1402CF668 (-InkProcessorOnInkDeviceOpened@@YAXPEAURawInputManagerDeviceObject@@@Z.c)
...
void __fastcall Win32kRIMDevChangeCallback(__int64 a1)
{
  ...
  v5 = 0;
  v6 = *(_DWORD *)(W32GetUserSessionState(a1, v1 + 72) + 16680);
