/*
 * XREFs of ?vFillGRectDIB1@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x14033E760
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v3 < v5 )
    {
      ...
      do
      {
        ...
        {
          v19 = (_BYTE *)(v6 + v13 / 8);
          v40 = (char *)&unk_1403711B0 + 16 * (((_BYTE)v3 + (_BYTE)v11) & 0xFu);
          v20 = v13 + v45;
          v21 = v12;
          do
          {
            v22 = (unsigned __int8)(2 * v40[v20 & 0xF]);
            v23 = (v22 + (unsigned int)BYTE6(v16) >= 0xFF ? 0x1F : 0) | (unsigned __int64)(v22
                                                                                         + (unsigned int)BYTE6(v15) >= 0xFF
                                                                                         ? 0x3E0
                                                                                         : 0);
            v15 += v34;
            v16 += v35;
            v24 = v22 + (unsigned int)BYTE6(v14) >= 0xFF ? 0x7C00 : 0;
            v14 += v33;
            ++v20;
            v25 = v18 + 1;
            *v19 = *v19 & ~(1 << (7 - v18)) | (byte_140367280[Xlate555[v24 | v23]] << (7 - v18));
            v26 = v19 + 1;
            if ( v18 != 7 )
              v26 = v19;
            v19 = v26;
