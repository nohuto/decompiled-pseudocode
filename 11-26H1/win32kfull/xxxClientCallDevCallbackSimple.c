/*
 * XREFs of xxxClientCallDevCallbackSimple @ 0x1402617D0
 * Callers:
 *     EditionInputExtensibilityCallout @ 0x1402AA250 (EditionInputExtensibilityCallout.c)
 * Callees:
...
__int64 __fastcall xxxClientCallDevCallbackSimple(__int64 a1, __int128 *a2)
{
  ...
  if ( *((_DWORD *)a2 + 1) == 1 )
  {
    ...
    v10 = 0LL;
    v11 = 0;
    RtlCopyFromUser(&v10, v5, 0x14uLL);
