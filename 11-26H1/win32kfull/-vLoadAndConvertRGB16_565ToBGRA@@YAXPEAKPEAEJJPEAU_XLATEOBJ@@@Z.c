/*
 * XREFs of ?vLoadAndConvertRGB16_565ToBGRA@@YAXPEAKPEAEJJPEAU_XLATEOBJ@@@Z @ 0x140337630
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vLoadAndConvertRGB16_565ToBGRA(unsigned int *a1, unsigned __int8 *a2, int a3, int a4)
{
  ...
  {
    v9 = *(_DWORD *)v6;
    v10 = (*(_DWORD *)v6 >> 1) & 0xE0000;
    v11 = *(_DWORD *)v6 & 0xE01F1FFF;
    v12 = *(_DWORD *)v6 & 0x6000000;
    *a1 = (((*(_DWORD *)v6 >> 1) & 0xE | *(_DWORD *)v6 & 0x600u) >> 1) | (8
                                                                        * (*(_DWORD *)v6 & 0xE01F | (4 * (*(_DWORD *)v6 & 0x7E0 | (8 * (*(_DWORD *)v6 & 0xF800 | 0xFFFF0000))))));
    a1[1] = ((v9 & 0xF80000FF | ((v9 & 0x7E00000 | ((v11 | ((v10 | (unsigned int)v12) >> 4)) >> 2)) >> 3)) >> 8) | 0xFF000000;
    a1 += 2;
    v6 += 4;
  }
  if ( (v4 & 1) != 0 )
