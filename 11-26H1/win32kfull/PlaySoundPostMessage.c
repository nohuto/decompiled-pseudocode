/*
 * XREFs of PlaySoundPostMessage @ 0x1403E3070
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1400FC84C (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     I_PlaySoundkPostMessage @ 0x140206CE0 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x14020BC80 (PlaySndClient_midl_user_allocate.c)
 *     ??$_lambda_invoker_cdecl_@PEAX@_lambda_2_@?N@??Initialize@?$CTypeIsolation@$0DKAAA@$0DKA@@NSInstrumentation@@IEAA_NXZ@SA?A_PPEAX@Z @ 0x14025FEE0 (--$_lambda_invoker_cdecl_@PEAX@_lambda_2_@-N@--Initialize@-$CTypeIsolation@$0DKAAA@$0DKA@@NSInst.c)
 */
