/*
 * XREFs of ?bSrcCopySRLE4D32@@YAHPEAUBLTINFO@@@Z @ 0x140211C40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( v29 )
        {
          ...
          {
            v32 = *v2++;
            v33 = *(_DWORD *)(v47 + 4 * (v32 & 0xF));
            *v31 = *(_DWORD *)(v47 + 4 * (v32 >> 4));
            v31[1] = v33;
            v31 += 2;
            --v29;
          }
        ...
        {
          v37 = v11++;
          *(_DWORD *)(v3 + 4 * v37) = *(_DWORD *)(v12 + 4 * ((unsigned __int64)*v2 >> 4));
