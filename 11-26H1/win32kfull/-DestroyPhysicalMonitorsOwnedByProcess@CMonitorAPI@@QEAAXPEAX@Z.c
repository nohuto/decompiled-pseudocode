/*
 * XREFs of ?DestroyPhysicalMonitorsOwnedByProcess@CMonitorAPI@@QEAAXPEAX@Z @ 0x1401DE368
 * Callers:
 *     MonitorAPIProcessTerminating @ 0x1401DE330 (MonitorAPIProcessTerminating.c)
 * Callees:
