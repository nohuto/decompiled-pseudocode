/*
 * XREFs of GetDPITransformationMonitor @ 0x14008BDAC
 * Callers:
 *     EditionDoPointerDPITransforms @ 0x14008BD30 (EditionDoPointerDPITransforms.c)
...
__int64 __fastcall GetDPITransformationMonitor(__int64 a1, __int64 a2)
{
  ...
  if ( TopLevelWindow )
  {
    ...
    if ( v9 )
    {
      ...
      if ( (unsigned int)PtInRect(*(_QWORD *)(a2 + 40) + 88LL, v8) )
        return v9;
    }
    v2 = v7;
  }
