/*
 * XREFs of NtGdiPatBlt @ 0x1400ACCD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiPatBlt(Gre::Base *a1, int a2, int a3, int a4, int a5, int a6)
{
  ...
  v34 = 0LL;
  v32 = 0;
  UnexpectedThreadTerminationHandler<DCOBJ>::UnexpectedThreadTerminationHandler<DCOBJ>(&v35);
  LOBYTE(v11) = 1;
