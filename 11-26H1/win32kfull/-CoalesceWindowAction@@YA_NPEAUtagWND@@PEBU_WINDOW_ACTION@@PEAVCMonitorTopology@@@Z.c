/*
 * XREFs of ?CoalesceWindowAction@@YA_NPEAUtagWND@@PEBU_WINDOW_ACTION@@PEAVCMonitorTopology@@@Z @ 0x1402E1CC0
 * Callers:
...
char __fastcall CoalesceWindowAction(struct tagWND *a1, const struct _WINDOW_ACTION *a2, struct CMonitorTopology *a3)
{
  ...
  if ( (*(_DWORD *)a2 & 0xFFFFFFE0) != 0 )
    return 0;
  v5 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 464LL) + 32LL);
  if ( !v5 )
    return 0;
  if ( *(_DWORD *)(v5 + 96) != 31 )
    return 0;
  ...
  v9 = *((_DWORD *)a2 + 1);
  if ( ((v9 ^ v8) & 0x400) != 0
    || ((unsigned __int8)v7 & (unsigned __int8)v3 & 0x10) != 0 && (((unsigned __int8)v8 ^ (unsigned __int8)v9) & 8) != 0 )
  {
    return 0;
  }
  if ( ((unsigned __int8)v7 & (unsigned __int8)v3 & 8) != 0 && (((unsigned __int8)v8 ^ (unsigned __int8)v9) & 0x10) != 0 )
    return 0;
