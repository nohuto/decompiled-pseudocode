/*
 * XREFs of ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x1401348EC
 * Callers:
...
__int64 __fastcall CoalesceMousePromotionEntry(const struct tagPOINTER_INFO *a1, __int64 a2)
{
  ...
  v2 = a2;
  v6 = *(_QWORD *)(W32GetUserSessionState(a1, a2) + 16432);
  if ( !v6
    || *(_DWORD *)(v6 + 20) != *((_DWORD *)a1 + 3)
    || *((_DWORD *)a1 + 2) <= *(_DWORD *)(v6 + 36)
    || *(_QWORD *)(W32GetUserSessionState(v5, v4) + 16656) != *((_QWORD *)a1 + 3) )
  {
    return 0LL;
  }
