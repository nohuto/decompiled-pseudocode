/*
 * XREFs of EditionForegroundQAccessibleToMouseProducer @ 0x1401E2640
 * Callers:
 *     <none>
 * Callees:
 *     ?MSGLUA_GPQFOREGROUND@@YAXXZ @ 0x1401736A8 (-MSGLUA_GPQFOREGROUND@@YAXXZ.c)
 *     ?WakeInjectedFlushWaiter@@YAXXZ @ 0x14020F290 (-WakeInjectedFlushWaiter@@YAXXZ.c)
 */
