/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1402282B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct tagCOLORADJUSTMENT *v39; // [rsp+108h] [rbp-8h]
  struct _POINTL *v40; // [rsp+110h] [rbp+0h]
  struct _RECTL *v41; // [rsp+118h] [rbp+8h]
  struct _RECTL *v42; // [rsp+120h] [rbp+10h]
  ...
  if ( v37 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), &v46, v13)
        ...
        || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, &v51, 0x18u)
        || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, &v52, 8u)
        || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, &v53, 0x10u)
        || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, &v54, 0x10u)
        || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, &v55, 8u)
        || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v16, v44, 0x80u, &v21, Size) == -1)
        || (v12 = 1, !v21) )
      {
        v12 = 0;
      }
