/*
 * XREFs of NtUserRemoteRedrawScreen @ 0x1402BAAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 NtUserRemoteRedrawScreen()
{
  ...
  {
    if ( *(_DWORD *)(W32GetUserSessionState(v4, v3) + 68896) || *(_DWORD *)(W32GetUserSessionState(v4, v6) + 68748) )
    {
      UserSessionState = W32GetUserSessionState(v4, v6);
      v5 = RemoteRedrawScreen((void **)(UserSessionState + 19184), v8);
    }
    else
    {
      v5 = -1073741823;
