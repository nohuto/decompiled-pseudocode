/*
 * XREFs of ShrinkDIB_CX @ 0x1401A8D80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    if ( *v15 )
    {
      ...
      do
      {
        ...
        if ( (v25 & 0x4000) != 0 )
        {
          ...
          *a3 = v30;
          v31 = (6 * *(_DWORD *)&v40[16] - (v11 + v43) - *(_DWORD *)&v40[4]) >> 15;
          if ( (v31 & 0xFF00) != 0 )
            LOBYTE(v31) = ~HIBYTE(v31);
          a3[1] = v31;
          v32 = (6 * *(_DWORD *)&v40[12] - (v29 + v10) - *(_DWORD *)v40) >> 15;
          if ( (v32 & 0xFF00) != 0 )
          ...
          *(_OWORD *)v40 = *(_OWORD *)&v40[12];
          v10 = *(_DWORD *)(v27 + 4LL * v26[1]) - v29;
          HIDWORD(v42) = v38 + v9;
          LODWORD(v42) = v11 + v43;
          *(_QWORD *)&v40[16] = v42;
          v23 = v38 + v9;
          v24 = _mm_cvtsi128_si32(_mm_srli_si128(*(__m128i *)v40, 8));
          v11 = *(_DWORD *)(v27 + 4LL * *v26) - v43;
          v9 = *(_DWORD *)(v27 + 4LL * *(v26 - 1)) - v38;
        }
        else
        {
          v10 += *(_DWORD *)(v27 + 4LL * v26[1]);
          v11 += *(_DWORD *)(v27 + 4LL * *v26);
          v9 += *(_DWORD *)(v27 + 4LL * *(v26 - 1));
        }
        v25 = (unsigned __int16)*v15;
        v26 += 3;
      }
