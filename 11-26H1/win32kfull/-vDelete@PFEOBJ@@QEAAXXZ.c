/*
 * XREFs of ?vDelete@PFEOBJ@@QEAAXXZ @ 0x1400D3AD4
 * Callers:
 *     ?vPFFC_Delete@PFFOBJ@@QEAAXPEAVPFFCLEANUP@@@Z @ 0x1400D3914 (-vPFFC_Delete@PFFOBJ@@QEAAXPEAVPFFCLEANUP@@@Z.c)
 *     ?vDeletePFE@@YAXPEAVPFE@@@Z @ 0x14033DE20 (-vDeletePFE@@YAXPEAVPFE@@@Z.c)
 * Callees:
...
void __fastcall PFEOBJ::vDelete(PFEOBJ *this)
{
  ...
  else
  {
    ...
    if ( v4 )
    {
      v9 = *(void (__fastcall **)(__int64, _QWORD))(v3 + 3016);
      if ( v9 )
        v9(v4, *(_QWORD *)(v1 + 24));
    }
  }
  v5 = *(void (__fastcall **)(_QWORD, _QWORD))(v3 + 3016);
  if ( v5 )
  {
    v5(*(_QWORD *)(*(_QWORD *)this + 32LL), *(_QWORD *)(*(_QWORD *)this + 40LL));
    v6 = *(void **)(*(_QWORD *)this + 48LL);
    if ( v6 != &unk_14035EB38 )
      (*(void (__fastcall **)(void *, _QWORD))(v3 + 3016))(v6, *(_QWORD *)(*(_QWORD *)this + 56LL));
  }
