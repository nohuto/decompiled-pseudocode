/*
 * XREFs of ?xxxDoLocalTSFWork@@YAXKPEAUtagWND@@JJKKPEAUtagTHREADINFO@@K@Z @ 0x140044B4C
 * Callers:
        ...
        unsigned int a8)
{
  ...
  if ( (v15 & 4) != 0
    || a7 != v12
    || !*((_QWORD *)v12 + 61)
    || (v16 = 0, (_InterlockedCompareExchange((volatile signed __int32 *)v12 + 130, 0, 0) & 0x1000000C) != 0) )
  {
    v16 = 1;
  }
  v17 = *(_DWORD *)(*((_QWORD *)a7 + 60) + 24LL) & a6;
  if ( (v17 & 0x1700) != 0 && v17 && (v17 & 0xFFFFE8FC) == 0 )
  {
    if ( (v15 & 2) != 0 )
    {
      Notify = CreateNotify(0LL, v11, a2, a3, a4, a7, a8, 1);
      if ( Notify )
        *((_QWORD *)Notify + 8) = a7;
    }
    else if ( v16 )
