/*
 * XREFs of GetLocalMachineRegistryDWORDValues @ 0x14016E7E0
 * Callers:
 *     EditionOverrideUserTouchGestureSettings @ 0x14016E790 (EditionOverrideUserTouchGestureSettings.c)
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x14016EB1C (RtlUnicodeStringValidateWorker_0.c)
...
LABEL_28:
        ...
        LOWORD(SourceString.Buffer) = 2 * (v15 + v14);
        if ( PointerDeviceCfgDWORDSetting >= 0 )
        {
