/*
 * XREFs of ?ApplyEnd@ApplyWindowAction@InputTraceLogging@@SAXPEAUHWND__@@PEBGUtagRECT@@PEBDH@Z @ 0x1402E72D8
 * Callers:
        ...
        int a5)
{
  ...
  const wchar_t *v15; // [rsp+78h] [rbp+37h] BYREF
  void *v16; // [rsp+80h] [rbp+3Fh] BYREF
