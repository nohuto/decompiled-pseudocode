/*
 * XREFs of ?RetrieveMessage@Pointer@TelemetryDebug@InputTraceLogging@@SAXAEBUTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x1401E8310
 * Callers:
        ...
        const struct TELEMETRY_POINTER_FRAME_TIMES *a1)
{
  ...
  {
    if ( (unsigned int)dword_1403AA9C0 > 7 && tlgKeywordOn((__int64)&dword_1403AA9C0, 0x10000LL) )
    {
      v21 = *((_QWORD *)a1 + 17);
      v22 = *((_QWORD *)a1 + 16);
      v23 = *((_QWORD *)a1 + 15);
  ...
  else if ( (unsigned int)dword_1403AA9C0 > 7
         && (qword_1403AA9D0 & 0x10000) != 0
         && (qword_1403AA9D8 & 0x10000) == qword_1403AA9D8 )
  {
    v21 = *((_QWORD *)a1 + 7);
    v22 = *((_QWORD *)a1 + 6);
    v23 = *((_QWORD *)a1 + 5);
