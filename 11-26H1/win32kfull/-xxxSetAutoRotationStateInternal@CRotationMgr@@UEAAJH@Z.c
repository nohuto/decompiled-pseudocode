/*
 * XREFs of ?xxxSetAutoRotationStateInternal@CRotationMgr@@UEAAJH@Z @ 0x14029A1CC
 * Callers:
...
__int64 __fastcall CRotationMgr::xxxSetAutoRotationStateInternal(CRotationMgr *this, int a2)
{
  ...
  {
    *((_DWORD *)this + 2) = a2;
    if ( (unsigned int)dword_1403AAA30 > 5 && tlgKeywordOn((__int64)&dword_1403AAA30, 0x400000000001LL) )
    {
      v8 = 0;
      v9 = a2;
