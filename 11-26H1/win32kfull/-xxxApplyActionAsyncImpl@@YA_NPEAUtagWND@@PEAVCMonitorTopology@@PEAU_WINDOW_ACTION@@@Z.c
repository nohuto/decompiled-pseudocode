/*
 * XREFs of ?xxxApplyActionAsyncImpl@@YA_NPEAUtagWND@@PEAVCMonitorTopology@@PEAU_WINDOW_ACTION@@@Z @ 0x1402E4C80
 * Callers:
...
char __fastcall xxxApplyActionAsyncImpl(struct tagWND *a1, struct CMonitorTopology *a2, struct _WINDOW_ACTION *a3)
{
  ...
  if ( (*((_DWORD *)a1 + 96) & 0x10) != 0 )
  {
    ...
    {
      if ( _bittest((const signed __int32 *)(*(_QWORD *)(W32GetUserSessionState(a1, a2) + 19176) + 48LL), 0xAu) )
      {
        v34 = 1;
        v35 = 0LL;
        v36 = 0LL;
  ...
  if ( !v7 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
    return 0;
  v13 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v24) + 69152);
  v32 = 134;
LABEL_50:
  LOBYTE(v12) = v10;
  LOBYTE(v11) = v7;
