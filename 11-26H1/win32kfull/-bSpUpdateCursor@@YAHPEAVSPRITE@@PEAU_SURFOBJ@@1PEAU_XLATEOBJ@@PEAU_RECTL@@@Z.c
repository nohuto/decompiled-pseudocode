/*
 * XREFs of ?bSpUpdateCursor@@YAHPEAVSPRITE@@PEAU_SURFOBJ@@1PEAU_XLATEOBJ@@PEAU_RECTL@@@Z @ 0x140314D04
 * Callers:
        ...
        struct _RECTL *a5)
{
  ...
  char v21; // [rsp+58h] [rbp-49h]
  int v22; // [rsp+5Ch] [rbp-45h]
  struct _POINTL v23; // [rsp+68h] [rbp-39h] BYREF
  struct _SURFOBJ *v24; // [rsp+70h] [rbp-31h]
  struct _XLATEOBJ *v25; // [rsp+78h] [rbp-29h]
  _QWORD *v26; // [rsp+80h] [rbp-21h]
  __int128 v27; // [rsp+88h] [rbp-19h] BYREF
  ...
  *((struct _RECTL *)a1 + 6) = v8;
  ...
  if ( !psoSrc )
  {
    ...
    *((_DWORD *)a1 + 50) = 33488896;
    bSpCreateShape(a1, &v23, a3, 0LL, a5, *((struct PALETTE **)v12 + 485), 6u, 1u, 0LL);
...
LABEL_7:
    ...
    DWORD2(v28) = 1;
    *(_QWORD *)&v28 = 0LL;
    if ( SURFMEM::bCreateDIB((SURFMEM *)&v20, (struct _DEVBITMAPINFO *)&v27, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0) )
    {
      v21 |= 1u;
