/*
 * XREFs of ?CoalesceWindowAction@AdvancedWindowPos@@YA_NPEAUtagWND@@PEBUWindowAction@1@@Z @ 0x1402E7658
 * Callers:
        ...
        const struct AdvancedWindowPos::WindowAction *a3)
{
  ...
  if ( (*(_DWORD *)a2 & 0xFFFFFFE0) != 0 )
    return 0;
  v5 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 18) + 464LL) + 32LL);
  if ( !v5 )
    return 0;
  if ( *(_DWORD *)(v5 + 96) != 28 )
    return 0;
  ...
  v9 = *((_DWORD *)a2 + 1);
  if ( ((v9 ^ v8) & 0x200) != 0
    || ((unsigned __int8)v7 & (unsigned __int8)v3 & 0x10) != 0 && (((unsigned __int8)v8 ^ (unsigned __int8)v9) & 4) != 0 )
  {
    return 0;
  }
  if ( ((unsigned __int8)v7 & (unsigned __int8)v3 & 8) != 0 && (((unsigned __int8)v8 ^ (unsigned __int8)v9) & 8) != 0 )
    return 0;
  if ( (v3 & 2) != 0 )
  {
    *v6 = v7 | 2;
