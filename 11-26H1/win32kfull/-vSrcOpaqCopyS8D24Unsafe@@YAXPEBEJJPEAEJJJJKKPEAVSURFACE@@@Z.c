/*
 * XREFs of ?vSrcOpaqCopyS8D24Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1400EE89C
 * Callers:
        ...
        struct SURFACE *a11)
{
  ...
  __int64 v21; // rcx
  _BYTE *v22; // rdx
  _BYTE v23[104]; // [rsp+40h] [rbp-68h] BYREF

  v12 = a3;
  v13 = a2;
  memset_0(v23, 0, 0x40uLL);
  v15 = pvFillOpaqTableCT(4u, a9, a10, a11, (struct BLENDINFO *)v23, 0);
  v16 = &a1[v13];
  v17 = &a4[3 * a5];
  while ( a8 )
  {
