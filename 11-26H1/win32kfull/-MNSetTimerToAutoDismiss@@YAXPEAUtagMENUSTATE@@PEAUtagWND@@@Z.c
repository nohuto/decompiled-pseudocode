/*
 * XREFs of ?MNSetTimerToAutoDismiss@@YAXPEAUtagMENUSTATE@@PEAUtagWND@@@Z @ 0x140235D08
 * Callers:
...
void __fastcall MNSetTimerToAutoDismiss(struct tagMENUSTATE *a1, struct tagWND *a2)
{
  ...
  if ( (v2 & 0x800) != 0 && (v2 & 0x1000) == 0 )
  {
    ...
    if ( InternalSetTimer((__int64)a2, 65529LL, 16 * *(_DWORD *)(UserSessionState + 66024), 0LL, 0, 16) )
      *((_DWORD *)a1 + 2) |= 0x1000u;
  }
}
