/*
 * XREFs of ??$?GVCFixPred@Prediction@@$02@Prediction@@YA?AV?$SquareMatrix@VCFixPred@Prediction@@$02@0@AEBV10@0@Z @ 0x140196310
 * Callers:
  ...
  do
  {
    ...
    do
    {
      if ( v9 != (Prediction::CFixPred *)&v12 )
        *(_QWORD *)v9 = *(_QWORD *)((char *)v9 + v8 + v6) - *(_QWORD *)((char *)v9 + v8);
