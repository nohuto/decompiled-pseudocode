/*
 * XREFs of ?_FindExistingCursorIcon@@YAPEAUtagCURSOR@@GPEAU_UNICODE_STRING@@PEAU1@PEAUtagCURSORFIND@@@Z @ 0x14001E2C8
 * Callers:
 *     NtUserFindExistingCursorIcon @ 0x14001FB40 (NtUserFindExistingCursorIcon.c)
 * Callees:
 *     ?ResStrCmp@@YAHREAU_UNICODE_STRING@@PEAU1@@Z @ 0x14001E4A8 (-ResStrCmp@@YAHREAU_UNICODE_STRING@@PEAU1@@Z.c)
 */
        ...
        struct tagCURSORFIND *a4)
{
  ...
  if ( *((_DWORD *)a4 + 2) && (_WORD)a1 )
  {
    ...
    if ( (*(_DWORD *)(v11 + 1360) & 0x8000000) != 0 )
      v11 = *(_QWORD *)(v11 + 1680);
    for ( i = *(_QWORD *)(*(_QWORD *)(v11 + 456) + 720LL); i; i = *(_QWORD *)(i + 32) )
    {
    ...
    for ( i = *(_QWORD *)(W32GetUserSessionState(v11, v10) + 36312); i; i = *(_QWORD *)(i + 32) )
    {
      if ( a3 && (struct tagCURSOR *)i == a3 )
        return a3;
      if ( v8 == *(_WORD *)(i + 72)
