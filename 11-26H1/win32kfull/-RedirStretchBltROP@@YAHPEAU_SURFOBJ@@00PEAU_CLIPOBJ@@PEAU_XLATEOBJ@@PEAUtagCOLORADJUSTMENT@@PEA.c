/*
 * XREFs of ?RedirStretchBltROP@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAU_BRUSHOBJ@@K@Z @ 0x14030E390
 * Callers:
 *     <none>
 * Callees:
        ...
        DWORD rop4)
{
  ...
  _BYTE v29[160]; // [rsp+A8h] [rbp-60h] BYREF
  __int64 HDEV; // [rsp+178h] [rbp+70h] BYREF
