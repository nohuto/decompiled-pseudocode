/*
 * XREFs of ?LogFontLoadAttempt@@YAXPEAXW4FontSource@@PEBG_N@Z @ 0x140218D64
 * Callers:
...
LABEL_9:
  ...
  if ( ProcessImageFileName )
    v12 = *(const wchar_t **)(ProcessImageFileName + 8);
  result = EtwFontLoadAttemptEvent(v12, v11, a3, v4);
  if ( (unsigned int)dword_1403AAA30 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_1403AAA30, 0x200000000000LL);
    if ( result )
    {
      v17 = v4;
      v16 = v11;
