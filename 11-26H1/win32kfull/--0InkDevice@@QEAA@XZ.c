/*
 * XREFs of ??0InkDevice@@QEAA@XZ @ 0x1402FDF0C
 * Callers:
...
InkDevice *__fastcall InkDevice::InkDevice(InkDevice *this, __int64 a2)
{
  ...
  *(_QWORD *)this = &RimBackedDeviceBase::`vftable';
  v4 = (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(W32GetUserSessionState(this, a2) + 16824));
  if ( !(_DWORD)v4 )
    LODWORD(v4) = _InterlockedIncrement((volatile signed __int32 *)(W32GetUserSessionState(v4, v3) + 16824));
  *((_DWORD *)this + 2) = v4;
  *((_BYTE *)this + 12) = 0;
  *((_QWORD *)this + 2) = 0LL;
  *((_QWORD *)this + 3) = 0LL;
