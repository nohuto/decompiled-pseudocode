/*
 * XREFs of ?CheckOnTop@@YAHPEAUtagTHREADINFO@@PEAUtagWND@@I@Z @ 0x1402A06E8
 * Callers:
...
__int64 __fastcall CheckOnTop(struct tagTHREADINFO *a1, struct tagWND *a2, int a3)
{
  ...
  if ( a2 != *(struct tagWND **)(*((_QWORD *)a1 + 58) + 128LL) )
    return 0LL;
  v5 = a3 - 513;
  if ( v5 )
  {
  ...
  if ( (*(_BYTE *)(*((_QWORD *)a2 + 5) + 24LL) & 8) == 0
    && (WindowWorker = GetWindowWorker(a2, 3), WindowWorker == (struct tagWND *)CalcForegroundInsertAfter((__int64)a2)) )
  {
    return 0LL;
  }
  else
