/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1401F5084
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1401F5050 (DestroyProcessInfoEditionRundown.c)
 * Callees:
