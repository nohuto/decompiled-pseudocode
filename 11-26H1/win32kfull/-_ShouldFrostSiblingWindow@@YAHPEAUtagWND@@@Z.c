/*
 * XREFs of ?_ShouldFrostSiblingWindow@@YAHPEAUtagWND@@@Z @ 0x1402CAB3C
 * Callers:
...
__int64 __fastcall _ShouldFrostSiblingWindow(struct tagWND *a1)
{
  ...
  if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 30LL) & 0xC0) == 0xC0
    ...
    && *(_QWORD *)(v2 + 488) == *(_QWORD *)(W32GetUserSessionState(v6, v5) + 19176)
    && !IsGhostWindowClass(a1, v7)
    && !GetGhostProp(a1, v8)
    && !GetFrostProp(a1, v9)
    && (*(_DWORD *)(*(_QWORD *)(v2 + 456) + 12LL) & 0x8000000) == 0
    && *v4 != *(_QWORD *)(W32GetUserGdiSessionState(v10) + 40)
    && !(unsigned int)IsProcessDwm(*v4)
    && (*(_DWORD *)(v2 + 664) > 0x9900u || (*(_DWORD *)(v2 + 680) & 0x80000) == 0)
    && a1 != (struct tagWND *)GetDesktopWindow((__int64)a1)
    && a1 != *(struct tagWND **)(*(_QWORD *)(v2 + 496) + 168LL) )
  {
    return 1;
  }
  return v1;
