/*
 * XREFs of bDrvDisplayIOCtl @ 0x140336358
 * Callers:
...
__int64 __fastcall bDrvDisplayIOCtl(Gre::Base *a1, __int64 a2, unsigned int a3)
{
  ...
  Gre::Base *v21; // [rsp+88h] [rbp+38h] BYREF
  ...
  PDEVOBJ::vSync(
    (PDEVOBJ *)&v21,
    (struct _SURFOBJ *)((*((_QWORD *)v21 + 318) + 24LL) & -(__int64)(*((_QWORD *)v21 + 318) != 0LL)),
    0LL,
    0);
  v7 = (__int64 (__fastcall *)(__int64, _QWORD))*((_QWORD *)v21 + 419);
  if ( v7 )
    v5 = v7(a2, a3);
  v8 = v20;
  if ( v20 )
