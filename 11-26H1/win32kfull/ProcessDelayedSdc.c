/*
 * XREFs of ProcessDelayedSdc @ 0x1402635B0
 * Callers:
...
__int64 __fastcall ProcessDelayedSdc(__int64 a1)
{
  ...
  if ( *(_DWORD *)(W32GetUserGdiSessionState(a1) + 16) && !*(_WORD *)(W32GetUserSessionState(v3, v2) + 68744) )
  {
    v5 = *(_QWORD *)(W32GetUserSessionState(v3, v4) + 19176);
