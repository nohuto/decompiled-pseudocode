/*
 * XREFs of ?psSetupDstSurface@@YAPEAVSURFACE@@PEAV1@PEAU_RECTL@@AEAVSURFMEM@@HH@Z @ 0x140061578
 * Callers:
...
struct SURFACE *__fastcall psSetupDstSurface(__int64 **a1, struct _RECTL *a2, struct SURFMEM *a3, int a4, int a5)
{
  ...
  _DWORD v18[4]; // [rsp+58h] [rbp-19h] BYREF
  __int64 v19; // [rsp+68h] [rbp-9h]
  int v20; // [rsp+70h] [rbp-1h]
  int v21; // [rsp+74h] [rbp+3h]
  struct _RECTL v22; // [rsp+78h] [rbp+7h] BYREF
  ...
  if ( a4 || *((_WORD *)a1 + 50) )
  {
    ...
    if ( v11 )
      v19 = *v11;
    if ( !SURFMEM::bCreateDIB(a3, (struct _DEVBITMAPINFO *)v18, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0) )
      return 0LL;
    v14 = *(Gre::Base **)a3;
