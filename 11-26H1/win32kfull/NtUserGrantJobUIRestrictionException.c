/*
 * XREFs of NtUserGrantJobUIRestrictionException @ 0x1402B5E40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Feature_GrantJobUIRestrictionException__private_IsEnabledDeviceUsageNoInline @ 0x1402AF19C (Feature_GrantJobUIRestrictionException__private_IsEnabledDeviceUsageNoInline.c)
 */
...
__int64 __fastcall NtUserGrantJobUIRestrictionException(HANDLE Handle, HANDLE a2, int a3)
{
  ...
  if ( (a3 & 0xFFFFFFFE) == 0 )
  {
    ...
    else
    {
      ...
      if ( v7 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      {
        v10 = W32GetUserSessionState(&WPP_GLOBAL_Control, WPP_GLOBAL_Control);
        LOBYTE(v11) = v9;
        LOBYTE(v12) = v7;
        WPP_RECORDER_AND_TRACE_SF_d(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
