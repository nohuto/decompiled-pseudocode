/*
 * XREFs of ?vPlgWriteOR@rotate@@YAXPEAU_PLGRUN@1@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x140342C00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SURFACE *a4)
{
  ...
  LONG v36; // [rsp+44h] [rbp-64h]
  struct _RECTL si128; // [rsp+48h] [rbp-60h] BYREF
  int v38; // [rsp+58h] [rbp-50h]
  int v39[2]; // [rsp+60h] [rbp-48h]
  rotate *v40; // [rsp+68h] [rbp-40h]
          ...
          for ( i = v22 == 0; ; i = v22 == 0 )
          {
            *(_QWORD *)v39 = v23;
            ...
            if ( v21 >= si128.top && v21 < si128.bottom )
            {
              ...
              v29 = *((_BYTE *)&dword_1403717B0 + (*(_DWORD *)v5 & 7));
              if ( *(int *)v5 < 0
                || v25 >= *((_DWORD *)a3 + 14)
                || (unsigned __int64)v28 < v4
                || (unsigned __int64)v28 > v34 )
              {
                v31 = 0;
                v30 = 0;
              }
                ...
                do
                {
                  ...
                  if ( !v29 )
                  {
                    if ( v31 )
                      *v28 = v30;
                    ++v28;
                    v29 = *((_BYTE *)&dword_1403717B0 + (v25 & 7));
                    if ( v25 < 0
                      || v25 >= *((_DWORD *)a3 + 14)
                      || (unsigned __int64)v28 < v4
    ...
    else if ( this < a2 )
    {
      ...
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v11; v10; --v10 )
        {
          ...
          v15 = *((_DWORD *)v5 + 1);
          v16 = (char *)(j + (v14 >> 3));
          v17 = *((_BYTE *)&dword_1403717B0 + (*(_DWORD *)v5 & 7));
          if ( (unsigned __int64)v16 < v4 || (unsigned __int64)v16 > v34 )
            v18 = 0;
          else
            v18 = *v16;
          while ( v15 >= 0 )
            ...
            if ( !v17 )
            {
              *v16++ = v18;
              if ( (unsigned __int64)v16 < v4 || (unsigned __int64)v16 > v34 )
                ...
                v18 = *v16;
              v17 = *((_BYTE *)&dword_1403717B0 + (v14 & 7));
            }
          }
          if ( (unsigned __int64)v16 >= v4 && (unsigned __int64)v16 <= v34 )
            *v16 = v18;
