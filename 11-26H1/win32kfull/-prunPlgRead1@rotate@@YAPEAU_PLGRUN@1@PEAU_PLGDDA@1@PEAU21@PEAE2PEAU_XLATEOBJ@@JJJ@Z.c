/*
 * XREFs of ?prunPlgRead1@rotate@@YAPEAU_PLGRUN@1@PEAU_PLGDDA@1@PEAU21@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x140341660
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( (v26 & dword_140361820[v27]) != 0 )
        {
          v28 = v13;
          if ( (v11 & dword_140361820[v15]) == 0 )
            v28 = v12;
          *(_DWORD *)a2 = v28;
