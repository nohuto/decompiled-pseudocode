/*
 * XREFs of ?InitializeContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x140196F64
 * Callers:
        ...
        struct tagPOINT *a6)
{
  ...
  *((_DWORD *)a4 + 502) = 3;
  ...
  v16 = 0LL;
  v15 = 0LL;
  Prediction::tagRlsFilter::Filter(a4, &v18, (__int64)&v15, (__int64)&v16, &v17);
  v16 = 0LL;
  v15 = 0LL;
  Prediction::tagRlsFilter::Filter((_QWORD *)a4 + 54, &v18, (__int64)&v15, (__int64)&v16, &v17);
  v16 = 0LL;
  v15 = 0LL;
  Prediction::tagRlsFilter::Filter((_QWORD *)a4 + 108, &v18, (__int64)&v15, (__int64)&v16, &v17);
  v16 = 0LL;
  v15 = 0LL;
  Prediction::tagRlsFilter::Filter((_QWORD *)a4 + 162, &v18, (__int64)&v15, (__int64)&v16, &v17);
  *a5 = a2;
  *a6 = a3;
}
