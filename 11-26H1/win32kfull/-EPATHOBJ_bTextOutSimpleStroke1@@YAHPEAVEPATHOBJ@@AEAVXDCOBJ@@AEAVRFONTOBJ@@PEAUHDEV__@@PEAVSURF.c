/*
 * XREFs of ?EPATHOBJ_bTextOutSimpleStroke1@@YAHPEAVEPATHOBJ@@AEAVXDCOBJ@@AEAVRFONTOBJ@@PEAUHDEV__@@PEAVSURFACE@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x140318DAC
 * Callers:
        ...
        struct _POINTL *a8)
{
  ...
  struct _BRUSHOBJ *v25; // [rsp+68h] [rbp-71h]
  struct _CLIPOBJ *v26; // [rsp+70h] [rbp-69h]
