/*
 * XREFs of ?AddSasKey@@YAHII@Z @ 0x140297BF8
 * Callers:
...
__int64 __fastcall AddSasKey(__int64 a1, __int64 a2)
{
  ...
  {
    if ( !*(_DWORD *)(W32GetUserSessionState(a1, a2) + 8 * i + 14012) )
    {
      *(_DWORD *)(W32GetUserSessionState(a1, a2) + 8 * i + 14012) = v3;
      *(_DWORD *)(W32GetUserSessionState(v6, v5) + 8 * i + 14008) = v2;
      return 1LL;
    }
  }
  return 0LL;
