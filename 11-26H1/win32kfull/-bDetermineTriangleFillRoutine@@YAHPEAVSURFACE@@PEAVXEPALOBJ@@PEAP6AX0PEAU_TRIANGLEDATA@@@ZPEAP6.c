/*
 * XREFs of ?bDetermineTriangleFillRoutine@@YAHPEAVSURFACE@@PEAVXEPALOBJ@@PEAP6AX0PEAU_TRIANGLEDATA@@@ZPEAP6AX0PEAU_GRADIENTRECTDATA@@@Z@Z @ 0x140062120
 * Callers:
        ...
        void (**a4)(struct SURFACE *, struct _GRADIENTRECTDATA *))
{
  ...
  switch ( *((_DWORD *)a1 + 24) )
  {
    case 1:
      ...
      v6 = (void (*)(struct SURFACE *, struct _TRIANGLEDATA *))vGradientFill1;
      break;
    case 2:
      v5 = (void (*)(struct SURFACE *, struct _GRADIENTRECTDATA *))vFillGRectDIB4;
      v6 = (void (*)(struct SURFACE *, struct _TRIANGLEDATA *))vGradientFill4;
      break;
    case 3:
      v5 = (void (*)(struct SURFACE *, struct _GRADIENTRECTDATA *))vFillGRectDIB8;
      v6 = (void (*)(struct SURFACE *, struct _TRIANGLEDATA *))vGradientFill8;
      break;
    case 4:
