/*
 * XREFs of TouchTargetingRankForRectDeep @ 0x14026E0C4
 * Callers:
 ...
 *     TouchTargetingRank @ 0x14026A040 (TouchTargetingRank.c)
 ...
 *     TouchTargetingSnapToSegment @ 0x140303230 (TouchTargetingSnapToSegment.c)
    ...
    && DWORD1(v25) != HIDWORD(v25) )
  {
    ...
    if ( (unsigned int)_TTIntersectLine(v10, v21, (const struct tagTOUCHTARGETINGCONTACT *)a2, &v23, &v22) )
    {
      ...
      if ( PtInRect(&v25, *(_QWORD *)&v21) )
      {
        v17 = *(_QWORD *)(a2 + 32);
        v25 = *(_OWORD *)v8;
        v18 = TouchTargetingRank(v17, v15, &v25, v16);
        v19 = v15 - *(_DWORD *)(a2 + 32);
        v9 = v18;
