/*
 * XREFs of ?SetDeviceFocus@InteractiveControlManager@@QEAAJKW4tagINTERACTIVECTRL_PROMOTION_TYPE@@PEAUtagWND@@@Z @ 0x140261B54
 * Callers:
...
__int64 __fastcall InteractiveControlManager::SetDeviceFocus(__int64 *a1, int a2, __int64 a3, void *a4)
{
  ...
  void *v13; // [rsp+48h] [rbp-18h] BYREF
  void *v14[2]; // [rsp+50h] [rbp-10h] BYREF
  ...
  {
    v12 = a2;
    v14[0] = "InteractiveControlManager::SetDeviceFocus entry";
    v13 = a4;
    v15 = a3;
  ...
  {
    v15 = 0;
    v14[0] = "InteractiveControlManager::SetDeviceFocus exit";
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
      (__int64)&dword_1403AAA68,
      (__int64)&unk_140378B7D,
      a3,
      (__int64)a4,
      v14,
      (__int64)&v15);
