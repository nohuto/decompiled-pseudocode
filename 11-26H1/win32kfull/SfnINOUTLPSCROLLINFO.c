/*
 * XREFs of SfnINOUTLPSCROLLINFO @ 0x1401E03E0
 * Callers:
        ...
        __int64 a8)
{
  ...
  _QWORD v26[5]; // [rsp+38h] [rbp-110h] BYREF
  void *Src; // [rsp+60h] [rbp-E8h] BYREF
  __int128 v28; // [rsp+68h] [rbp-E0h] BYREF
  __int64 v29; // [rsp+78h] [rbp-D0h]
  int v30; // [rsp+80h] [rbp-C8h]
  __int64 v31; // [rsp+88h] [rbp-C0h]
  ULONG_PTR BugCheckParameter3[6]; // [rsp+90h] [rbp-B8h] BYREF
  __int64 v33; // [rsp+C0h] [rbp-88h] BYREF
  int v34; // [rsp+C8h] [rbp-80h]
  __int64 v35; // [rsp+D0h] [rbp-78h]
  __int128 v36; // [rsp+D8h] [rbp-70h]
  __int64 v37; // [rsp+E8h] [rbp-60h]
  int v38; // [rsp+F0h] [rbp-58h]
  __int64 v39; // [rsp+F8h] [rbp-50h]
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 64) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(19LL, &v33, 72LL, &Src, &v25);
  ...
  *(_QWORD *)(v19 + 80) = v31;
  if ( v18 >= 0 && v25 == 24 )
  {
    ...
    if ( a8 && (*(_DWORD *)(a8 + 84) & 5) != 0 || (a7 & 2) != 0 )
      return v21;
    v23 = *((_QWORD *)PtiCurrent(v20) + 68);
    if ( !v23 || (*(_DWORD *)(v23 + 84) & 1) == 0 || *(__int128 **)(v23 + 96) != a4 )
    {
      v24 = (void *)*((_QWORD *)Src + 2);
      v28 = 0LL;
      v29 = 0LL;
      v30 = 0;
      RtlCopyFromUser(&v28, v24, 0x1CuLL);
      *a4 = v28;
      *((_QWORD *)a4 + 2) = v29;
      *((_DWORD *)a4 + 6) = v30;
      return v21;
