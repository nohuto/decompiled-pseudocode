/*
 * XREFs of ?vSrcOpaqCopyS4D32@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1400EEA00
 * Callers:
 *     <none>
 * Callees:
 *     ?GreGetCurrentThreadCrossSessionCheck@@YAPEAU_GRETHREAD@@XZ @ 0x140071590 (-GreGetCurrentThreadCrossSessionCheck@@YAPEAU_GRETHREAD@@XZ.c)
 *     ??$GrepAcquireLockValidate@$0BI@@@YAXXZ @ 0x1400EF45C (--$GrepAcquireLockValidate@$0BI@@@YAXXZ.c)
 *     ?vSrcOpaqCopyS4D32Unsave@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1400EFDD4 (-vSrcOpaqCopyS4D32Unsave@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z.c)
 */
        ...
        struct SURFACE *a11)
{
  ...
  vSrcOpaqCopyS4D32Unsave(a1, v13, v12, a4, a5, a6, a7, a8, a9, a10, a11);
  if ( v15 )
  {
