/*
 * XREFs of ?StartLoop@MoveSize@InputTraceLogging@@SAXPEAUtagWND@@PEBD@Z @ 0x14005EE6C
 * Callers:
...
void __fastcall InputTraceLogging::MoveSize::StartLoop(struct tagWND *a1, const char *a2)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1403AA9C0, 0x80000LL) )
    {
