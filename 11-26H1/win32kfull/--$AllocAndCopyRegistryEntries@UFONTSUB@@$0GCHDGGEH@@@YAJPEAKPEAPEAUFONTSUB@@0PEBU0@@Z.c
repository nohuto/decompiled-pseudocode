/*
 * XREFs of ??$AllocAndCopyRegistryEntries@UFONTSUB@@$0GCHDGGEH@@@YAJPEAKPEAPEAUFONTSUB@@0PEBU0@@Z @ 0x140229844
 * Callers:
...
__int64 __fastcall AllocAndCopyRegistryEntries<FONTSUB,1651729991>(unsigned int *a1, void **a2, _DWORD *a3, _OWORD *a4)
{
  ...
  if ( *a2 )
    v15 = (__int64)PREALLOCMEM2(*a2, (unsigned int)(196 * v4), v14, 0x62736647u);
  else
    v15 = PALLOCMEM(v14, 1651729991LL);
  if ( v15 )
  {
    *a2 = (void *)v15;
    *a3 = v13;
