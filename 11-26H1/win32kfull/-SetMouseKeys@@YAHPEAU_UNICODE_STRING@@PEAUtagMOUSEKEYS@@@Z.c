/*
 * XREFs of ?SetMouseKeys@@YAHPEAU_UNICODE_STRING@@PEAUtagMOUSEKEYS@@@Z @ 0x1402AD1A8
 * Callers:
...
__int64 __fastcall SetMouseKeys(struct _UNICODE_STRING *a1, struct tagMOUSEKEYS *a2)
{
  ...
  v5 = v4 & FastWriteProfileStringW(a1, 16LL, L"MaximumSpeed", v7);
  RtlStringCchPrintfW(v7, 40LL, L"%d", *((unsigned int *)a2 + 3));
