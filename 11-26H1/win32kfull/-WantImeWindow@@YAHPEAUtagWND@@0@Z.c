/*
 * XREFs of ?WantImeWindow@@YAHPEAUtagWND@@0@Z @ 0x140178BD0
 * Callers:
...
__int64 __fastcall WantImeWindow(struct tagWND *a1, struct tagWND *a2)
{
  ...
  v3 = a1;
  if ( (_InterlockedCompareExchange((volatile signed __int32 *)PtiCurrent((__int64)a1) + 130, 0, 0) & 0x2000000) != 0 )
    return 0LL;
  if ( (*(_BYTE *)(*((_QWORD *)a2 + 5) + 18LL) & 4) != 0 )
    return 0LL;
  v5 = *(__int16 **)(*((_QWORD *)a2 + 17) + 8LL);
  v6 = *v5;
  if ( v6 == *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v5, v4) + 19904) + 898LL) )
    return 0LL;
  ...
  if ( v3 )
  {
    while ( v3 && v8 == *((_QWORD *)v3 + 3) )
    {
      ...
      v11 = *v10;
      if ( v11 == *(_WORD *)(*(_QWORD *)(W32GetUserSessionState(v10, v7) + 19904) + 898LL)
