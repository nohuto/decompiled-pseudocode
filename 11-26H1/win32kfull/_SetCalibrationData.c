/*
 * XREFs of _SetCalibrationData @ 0x14029AD18
 * Callers:
 *     NtUserSetCalibrationData @ 0x1402BBC40 (NtUserSetCalibrationData.c)
 * Callees:
 *     GetPointerDeviceKey @ 0x140230F84 (GetPointerDeviceKey.c)
 *     UpdateTiltCalData @ 0x140299158 (UpdateTiltCalData.c)
 *     ValidateCalibrationData @ 0x1402992B4 (ValidateCalibrationData.c)
