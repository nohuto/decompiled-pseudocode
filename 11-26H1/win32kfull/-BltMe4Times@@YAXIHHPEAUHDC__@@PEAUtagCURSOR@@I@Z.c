/*
 * XREFs of ?BltMe4Times@@YAXIHHPEAUHDC__@@PEAUtagCURSOR@@I@Z @ 0x1401BFE18
 * Callers:
...
void __fastcall BltMe4Times(unsigned int a1, int a2, unsigned int a3, HDC a4, struct tagCURSOR *a5, char a6)
{
  ...
  if ( v12 )
  {
    v31 = a6 & 0x10;
    if ( v31 )
      v13 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v11, v10) + 19904) + 4856LL);
    else
      v13 = *(HBRUSH *)(*(_QWORD *)(W32GetUserSessionState(v11, v10) + 19904) + 4712LL);
    v26 = 2LL;
    v25 = (int)(a2 - a3) / 2;
    do
    {
