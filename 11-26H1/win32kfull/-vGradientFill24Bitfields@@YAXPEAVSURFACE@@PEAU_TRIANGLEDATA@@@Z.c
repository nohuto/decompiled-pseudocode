/*
 * XREFs of ?vGradientFill24Bitfields@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x14033FEC0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vGradientFill24Bitfields(struct SURFACE *a1, struct _TRIANGLEDATA *a2)
{
  ...
  v20 = v6;
  v21 = v7;
  v8 = *((_QWORD *)a1 + 10) + v3 * *((_DWORD *)a1 + 22);
  v29 = *((_QWORD *)a2 + 4);
  v22 = v8;
  if ( v5 >= *((_DWORD *)a2 + 29) )
    v5 = *((_DWORD *)a2 + 29);
    ...
    do
    {
      ...
      if ( v9 < v10 )
      {
        ...
        if ( (unsigned __int64)v15 < v16 )
        {
          ...
          do
          {
            v19 = XEPALOBJ::ulDispatchGFPEFunction(v24, *(unsigned int *)(*(_QWORD *)v24 + 100LL));
            *v17 = v19;
            v11 += v20;
            v12 += v21;
            v13 += v29;
