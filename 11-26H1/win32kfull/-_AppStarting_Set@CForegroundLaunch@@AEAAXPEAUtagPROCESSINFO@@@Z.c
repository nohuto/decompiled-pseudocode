/*
 * XREFs of ?_AppStarting_Set@CForegroundLaunch@@AEAAXPEAUtagPROCESSINFO@@@Z @ 0x1402AB138
 * Callers:
...
void __fastcall CForegroundLaunch::_AppStarting_Set(CForegroundLaunch *this, struct tagPROCESSINFO *a2)
{
  ...
  if ( *(_QWORD *)(W32GetUserGdiSessionState(this) + 40) && *(_QWORD *)(W32GetUserSessionState(v5, v4) + 57568) )
  {
    if ( *((_BYTE *)this + 416) )
    {
      if ( *((_BYTE *)a2 + 1200) != 1 )
