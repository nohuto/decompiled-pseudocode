/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1402D1FD8
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1403AAA30, 0x800000000000LL) )
    {
      v37 = *((_QWORD *)v8 + 10);
      v10 = v8[3];
      v18 = v8[19];
