/*
 * XREFs of ?ipfdDevMaxGet@XDCOBJ@@QEAAJXZ @ 0x1403344E4
 * Callers:
...
__int64 __fastcall XDCOBJ::ipfdDevMaxGet(XDCOBJ *this)
{
  ...
  int v8; // eax
  struct _RECTL v10; // [rsp+30h] [rbp-B8h] BYREF
  _BYTE v11[160]; // [rsp+40h] [rbp-A8h] BYREF
  __int64 v12; // [rsp+F0h] [rbp+8h] BYREF
