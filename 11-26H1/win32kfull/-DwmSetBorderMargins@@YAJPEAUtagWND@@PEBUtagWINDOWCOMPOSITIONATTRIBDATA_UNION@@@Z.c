/*
 * XREFs of ?DwmSetBorderMargins@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1402CB6EC
 * Callers:
...
__int64 __fastcall DwmSetBorderMargins(struct tagWND *a1, const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  if ( *((struct tagTHREADINFO **)a1 + 2) == PtiCurrent((__int64)a1) )
  {
    v11 = *(_QWORD *)a2;
    v12 = 0;
    v19 = v11;
      ...
      || (v4 = HIWORD(v11), (v11 & 0x8000000000000000uLL) != 0LL) )
    {
      ...
      {
        v18 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v4) + 69152);
        WPP_RECORDER_AND_TRACE_SF_dddd(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
          ...
          0x15u,
          0xBu,
          (__int64)&WPP_23500adfc3a93acdbe8b59abf0208d94_Traceguids,
          (__int16)v11,
          SWORD2(v19),
          SWORD1(v19),
          SHIWORD(v19));
...
LABEL_24:
      ...
      {
        v15 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, v4) + 69152);
        WPP_RECORDER_AND_TRACE_SF_dddd(
          *((_QWORD *)WPP_GLOBAL_Control + 3),
          v13,
          v14,
