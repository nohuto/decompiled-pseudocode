/*
 * XREFs of ?xxxSetAutoRotationDocked@CRotationMgr@@QEAAXH@Z @ 0x1400F9740
 * Callers:
...
void __fastcall CRotationMgr::xxxSetAutoRotationDocked(CRotationMgr *this, int a2, __int64 a3, __int64 a4)
{
