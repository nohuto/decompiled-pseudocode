/*
 * XREFs of ?PostCOMPOSITEDInvalidateAPC@@YAHQEAUtagWND@@PEBUtagRECT@@@Z @ 0x14011F6B8
 * Callers:
...
__int64 __fastcall PostCOMPOSITEDInvalidateAPC(struct tagWND *const a1, const struct tagRECT *a2)
{
  ...
  *(struct tagRECT *)&v4.m256i_u64[1] = *a2;
  return ((__int64 (__fastcall *)(struct _KTHREAD *, void (__fastcall *)(struct BLTINFO *), __int64 (__fastcall *)(), void (__fastcall *)(char *, void *, void *), __int128 *, int))UserPostNKAPCBuffer)(
           KeGetCurrentThread(),
           vSrcCopyDummy,
