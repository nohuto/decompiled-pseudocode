/*
 * XREFs of ?SetWindowCompositionVideoOverlayActive@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1402CBA78
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( -__CFSHR__(v6[0], 8) == v3 )
    {
      return 0;
    }
    else
    {
      LODWORD(v6[0]) = v6[0] & 0xFFFFFF7F | (v3 << 7);
