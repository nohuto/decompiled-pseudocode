/*
 * XREFs of ?vGradientFill16_565@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x14033F870
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vGradientFill16_565(struct SURFACE *a1, struct _TRIANGLEDATA *a2)
{
  ...
  v37 = v4;
  v33 = (char *)a2 + 168;
  v7 = *((_QWORD *)a1 + 10) + v4 * *((_DWORD *)a1 + 22);
  v30 = *((_QWORD *)a2 + 2);
  v31 = *((_QWORD *)a2 + 3);
  v32 = *((_QWORD *)a2 + 4);
  v28 = *((_DWORD *)a2 + 32);
    ...
    do
    {
      ...
      if ( *((_QWORD *)v3 + 9) <= (unsigned __int64)(v15 + v7) && v15 < v10 )
      {
        ...
        if ( (unsigned __int64)v17 < v18 )
        {
          ...
          {
            v21 = v19++;
            v22 = *(_DWORD *)(0x140000000LL + 16LL * (v9 & 3) + 3609264 + 4LL * (v21 & 3));
            v23 = HIDWORD(v14);
            v14 += v30;
            v24 = byte_1403713F0[(unsigned __int64)(v22 + ((unsigned int)v23 >> 11)) >> 16];
            v25 = HIDWORD(v13);
            v13 += v31;
            v26 = byte_1403713F0[((unsigned __int64)(v22 + ((unsigned int)v25 >> 10)) >> 16) + 64] | (unsigned __int16)(v24 << 6);
            v27 = HIDWORD(v12);
            v12 += v32;
            *v17++ = byte_1403713F0[(unsigned __int64)(v22 + ((unsigned int)v27 >> 11)) >> 16] | (unsigned __int16)(32 * v26);
          }
