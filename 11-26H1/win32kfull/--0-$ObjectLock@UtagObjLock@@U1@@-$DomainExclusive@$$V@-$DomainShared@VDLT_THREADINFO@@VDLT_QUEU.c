/*
 * XREFs of ??0?$ObjectLock@UtagObjLock@@U1@@?$DomainExclusive@$$V@?$DomainShared@VDLT_THREADINFO@@VDLT_QUEUE@@@@QEAA@AEAUtagObjLock@@0@Z @ 0x140055E78
 * Callers:
        ...
        tagObjLock *a3)
{
  ...
  *((_QWORD *)Base + 4) = UserSessionState + 42384;
  *((_OWORD *)Base + 3) = 0LL;
  *((_QWORD *)Base + 8) = 0LL;
  Base[72] = 0;
