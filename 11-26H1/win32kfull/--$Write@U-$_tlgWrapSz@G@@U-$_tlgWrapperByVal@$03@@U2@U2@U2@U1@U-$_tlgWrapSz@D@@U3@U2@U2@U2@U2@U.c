        ...
        __int64 a25)
{
  ...
  const wchar_t *v44; // [rsp+50h] [rbp-B0h]
  ...
  const wchar_t *v55; // [rsp+A0h] [rbp-60h]
  ...
  v45 = v37;
  v46 = 0;
  return tlgWriteTransfer_EtwWriteTransfer(a1, a2, 0LL, 0LL, 23, v43);
}
