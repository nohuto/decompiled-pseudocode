/*
 * XREFs of ?AddInitialFonts@UmfdHostLifeTimeManager@@SA_NXZ @ 0x1400CBA10
 * Callers:
 *     NtGdiAddInitialFonts @ 0x14025CCC0 (NtGdiAddInitialFonts.c)
 * Callees:
...
char __fastcall UmfdHostLifeTimeManager::AddInitialFonts(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( KeReadStateEvent(*(PRKEVENT *)(v3 + 24216)) )
    return 1;
  v4 = KeWaitForSingleObject(*(PVOID *)(v3 + 24224), Executive, 1, 0, 0LL);
  if ( v4 < 0 || v4 == 192 )
  {
