/*
 * XREFs of NtUserfnTOUCHHITTESTING @ 0x1402C2050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserfnTOUCHHITTESTING(__int64 a1, unsigned int a2, __int64 a3, void *a4, __int64 a5, char a6)
{
  __int64 v10; // rdx
  __int64 v11; // rcx
