/*
 * XREFs of ?ValidatePropWindow@@YAPEAUtagWND@@PEAUHWND__@@W4ValidatePropWindowKind@@@Z @ 0x14027C710
 * Callers:
...
__int64 __fastcall ValidatePropWindow(__int64 a1, char a2)
{
  ...
  {
    v8 = *(_QWORD *)(v4 + 16);
    if ( (_InterlockedCompareExchange((volatile signed __int32 *)(v8 + 520), 0, 0) & 0xC) == 0 )
      return v4;
  }
  ...
  v11 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(v4 + 16) + 456LL) + 764LL);
  if ( *(_DWORD *)(v10 + 764) == (_DWORD)v11 )
  {
    v12 = PsGetCurrentProcessWin32Process(v11);
    if ( v12 )
      v12 &= -(__int64)(*(_QWORD *)v12 != 0LL);
    if ( *(_DWORD *)(v12 + 768) == *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 16) + 456LL) + 768LL) )
      return v4;
  }
  UserSetLastError(5);
  return 0LL;
