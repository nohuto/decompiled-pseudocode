/*
 * XREFs of Feature_NoEndTaskCriticalProcess__private_IsEnabledDeviceUsageNoInline @ 0x1402AF1F4
 * Callers:
 *     NtUserCheckWindowThreadDesktop @ 0x1402B01C0 (NtUserCheckWindowThreadDesktop.c)
 * Callees:
 *     Feature_NoEndTaskCriticalProcess__private_IsEnabledFallback @ 0x1402AF230 (Feature_NoEndTaskCriticalProcess__private_IsEnabledFallback.c)
 */
