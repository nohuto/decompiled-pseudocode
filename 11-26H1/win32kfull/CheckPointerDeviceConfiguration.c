/*
 * XREFs of CheckPointerDeviceConfiguration @ 0x140249038
 * Callers:
  ...
  *(_DWORD *)(W32GetUserSessionState(v5, v4) + 328) = v3;
  ...
  for ( i = CBaseInput::TmpGetDeviceList(*(CBaseInput **)(v12 + 16832)); i; i = (struct DEVICEINFO *)*((_QWORD *)i + 7) )
  {
    ...
    if ( (*v16 & 0x80u) != 0 && *(_DWORD *)(*((_QWORD *)i + 57) + 24LL) == 7 )
    {
      ...
      if ( (*v16 & 0x400) != 0 )
      {
        if ( (*(_DWORD *)(v18 + 16776) & 2) != 0 )
          v20 = *(unsigned int *)(v18 + 16788);
        else
          v20 = 0LL;
        RIMConfigureDeviceFeedback(i, v20);
      }
      if ( (*v16 & 0x800) != 0 )
        RIMConfigureTouchpadClickForceSensitivity(i, *(unsigned int *)(v19 + 16792));
    }
  }
