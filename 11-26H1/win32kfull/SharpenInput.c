/*
 * XREFs of SharpenInput @ 0x14013A360
 * Callers:
  ...
  else
  {
    ...
    *(_BYTE *)(v10 + 2) = *(_BYTE *)(v10 - 1);
    if ( a4 < v10 )
    {
      ...
      do
      {
        v16 = (12 * (unsigned __int8)v13[v15] - *(v12 - 2) - *(v14 - 2) - *(v11 - 6) - *v11) >> 3;
        if ( (v16 & 0xFF00) != 0 )
          LOBYTE(v16) = ~HIBYTE(v16);
        *(v13 - 2) = v16;
        v17 = (12 * *(v11 - 2) - *(v14 - 1) - *(v11 - 5) - v11[1] - *(v12 - 1)) >> 3;
        if ( (v17 & 0xFF00) != 0 )
      ...
      while ( (unsigned __int64)&v13[v15] < v10 );
    }
  }
  *(_WORD *)(v8 - 3) = *(_WORD *)v8;
