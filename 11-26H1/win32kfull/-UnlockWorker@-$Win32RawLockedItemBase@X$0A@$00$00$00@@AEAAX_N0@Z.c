/*
 * XREFs of ?UnlockWorker@?$Win32RawLockedItemBase@X$0A@$00$00$00@@AEAAX_N0@Z @ 0x140219988
 * Callers:
...
void __fastcall Win32RawLockedItemBase<void,0,1,1,1>::UnlockWorker(_QWORD *BugCheckParameter2, char a2, char a3)
{
