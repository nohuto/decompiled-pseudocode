        ...
        void **a14)
{
  ...
  _BYTE v26[32]; // [rsp+30h] [rbp-C9h] BYREF
  ...
  const wchar_t *v33; // [rsp+80h] [rbp-79h]
  ...
  const wchar_t *v44; // [rsp+D0h] [rbp-29h]
  ...
  v30 = 4LL;
  v28 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(a1, a2, 0LL, 0LL, 12, v26);
}
