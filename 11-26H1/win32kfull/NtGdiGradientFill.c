/*
 * XREFs of NtGdiGradientFill @ 0x14007EFF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGradientFill(
        Gre::Base *a1,
        const void *a2,
        unsigned int a3,
        const void *a4,
...
LABEL_20:
  ...
  if ( v12 )
  {
    v13 = (struct _TRIVERTEX *)Win32AllocPool(v12, 1886221383LL, a2);
    v7 = a2;
  }
  else
  {
  ...
  if ( v13 )
  {
    ...
    v14 = GreGradientFill(a1, v13, a3, (char *)&v13[v8 / 0x10], a5, a6);
    Win32FreePool(v13);
  }
  else
  {
