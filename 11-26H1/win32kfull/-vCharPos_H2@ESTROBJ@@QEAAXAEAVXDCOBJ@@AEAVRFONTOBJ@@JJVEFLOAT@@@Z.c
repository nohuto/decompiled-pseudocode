/*
 * XREFs of ?vCharPos_H2@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJVEFLOAT@@@Z @ 0x140211FC4
 * Callers:
...
struct _GLYPHDATA *__fastcall ESTROBJ::vCharPos_H2(
        unsigned int *a1,
        struct XDCOBJ *a2,
        RFONTOBJ *a3,
        int a4,
        ...
        unsigned int a6)
{
  ...
  v16 = 16 * v15 * v14;
  a1[28] = v16;
  result = (struct _GLYPHDATA *)RFONTOBJ::bGetGlyphMetricsPlus(a3, v13, v6, v10, &a5, a2, (struct ESTROBJ *)a1);
  if ( (_DWORD)result )
  {
    v18 = a1[58];
    if ( (v18 & 0x1400) != 0 )
