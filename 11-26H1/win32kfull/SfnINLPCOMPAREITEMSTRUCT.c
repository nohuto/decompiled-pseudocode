/*
 * XREFs of SfnINLPCOMPAREITEMSTRUCT @ 0x140216FF0
 * Callers:
...
ULONG_PTR __fastcall SfnINLPCOMPAREITEMSTRUCT(__int64 *a1, int a2, __int64 a3, __int128 *a4, ULONG_PTR a5, __int64 a6)
{
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 64) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(9LL, &v21, 96LL, &Src, &v31);
