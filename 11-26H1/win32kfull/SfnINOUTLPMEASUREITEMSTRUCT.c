/*
 * XREFs of SfnINOUTLPMEASUREITEMSTRUCT @ 0x140205810
 * Callers:
        ...
        __int64 a8)
{
  ...
  __int64 v32; // [rsp+C0h] [rbp-88h] BYREF
  int v33; // [rsp+C8h] [rbp-80h]
  __int64 v34; // [rsp+D0h] [rbp-78h]
  __int128 v35; // [rsp+D8h] [rbp-70h]
  __int128 v36; // [rsp+E8h] [rbp-60h]
  __int64 v37; // [rsp+F8h] [rbp-50h]
  __int64 v38; // [rsp+100h] [rbp-48h]
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 64) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(16LL, &v32, 72LL, &Src, &v25);
  ...
  *(_QWORD *)(v19 + 80) = v28;
  if ( v18 >= 0 && v25 == 24 )
  {
    ...
    if ( !v23 || (*(_DWORD *)(v23 + 84) & 1) == 0 || *(__int128 **)(v23 + 96) != a4 )
    {
      ...
      v29 = 0LL;
      v30 = 0LL;
      RtlCopyFromUser(&v29, v24, 0x20uLL);
      *a4 = v29;
      a4[1] = v30;
      return v21;
    }
