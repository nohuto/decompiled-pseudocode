/*
 * XREFs of ?ApplyForegroundPolicyConsole@CForegroundLaunch@@QEAAXPEAUtagPROCESSINFO@@@Z @ 0x1401A5358
 * Callers:
...
void __fastcall CForegroundLaunch::ApplyForegroundPolicyConsole(CForegroundLaunch *this, struct tagPROCESSINFO *a2)
{
  ...
  bool v51; // [rsp+B0h] [rbp+18h]
  char v52; // [rsp+B0h] [rbp+18h]
  bool v53; // [rsp+B0h] [rbp+18h]
  bool v54; // [rsp+B0h] [rbp+18h]
  bool v55; // [rsp+B8h] [rbp+20h]
  bool v56; // [rsp+B8h] [rbp+20h]
  ...
  else
  {
    ...
    if ( (*((_DWORD *)a2 + 3) & 1) == 0 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 555LL);
    ...
    if ( v10 || *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      v41 = "set";
      v42 = *((_DWORD *)v19 + 14);
      if ( (*((_DWORD *)v19 + 3) & 0x100) == 0 )
        v41 = "NOT set";
      v43 = W32GetUserSessionState(WPP_GLOBAL_Control, 0LL);
      LOBYTE(v44) = v39;
      LOBYTE(v45) = v10;
