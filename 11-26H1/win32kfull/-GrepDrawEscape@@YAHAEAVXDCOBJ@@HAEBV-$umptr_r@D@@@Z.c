/*
 * XREFs of ?GrepDrawEscape@@YAHAEAVXDCOBJ@@HAEBV?$umptr_r@D@@@Z @ 0x140310A4C
 * Callers:
...
__int64 __fastcall GrepDrawEscape(XDCOBJ *this, unsigned int a2, _QWORD *a3)
{
  ...
  __int64 v10; // rax
  __int64 v11; // rbx
  __int64 (__fastcall *v12)(__int64, _QWORD, _BYTE *, struct _RECTL *, unsigned int, _QWORD); // r13
  __int64 v13; // r10
  __int64 v14; // rax
...
LABEL_14:
  ...
  v12 = *(__int64 (__fastcall **)(__int64, _QWORD, _BYTE *, struct _RECTL *, unsigned int, _QWORD))(v11 + 2880);
  if ( v12 )
  {
    if ( a2 != 8 )
    {
      ...
      ECLIPOBJ::ECLIPOBJ((ECLIPOBJ *)v23, v15, (struct ERECTL *)&v20, 0);
    ...
    {
      v9 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, unsigned int, _QWORD))(v11 + 2880))(
