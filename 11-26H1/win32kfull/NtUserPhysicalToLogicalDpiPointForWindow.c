/*
 * XREFs of NtUserPhysicalToLogicalDpiPointForWindow @ 0x1402B8FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserPhysicalToLogicalDpiPointForWindow(__int64 a1, volatile void *a2)
{
  __int64 v4; // rcx
  ...
  if ( v5 )
  {
    ...
    v6 = PhysicalToLogicalInPlaceRectWithSubpixel(v5, (int *)v8, 0LL);
    if ( v6 == 1 )
    {
