/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$03@@U2@U1@U1@U2@U?$_tlgWrapperByVal@$01@@U3@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$03@@4334AEBU?$_tlgWrapperByVal@$01@@53@Z @ 0x14023EA40
 * Callers:
        ...
        __int64 a13)
{
  ...
  v18 = 4LL;
  v16 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1403AAA30, a2, 0LL, 0LL, 0xBu, &v14);
}
