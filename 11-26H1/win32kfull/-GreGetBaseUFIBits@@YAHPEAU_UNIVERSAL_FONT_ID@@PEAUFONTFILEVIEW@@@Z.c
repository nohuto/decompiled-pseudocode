/*
 * XREFs of ?GreGetBaseUFIBits@@YAHPEAU_UNIVERSAL_FONT_ID@@PEAUFONTFILEVIEW@@@Z @ 0x140310704
 * Callers:
...
__int64 __fastcall GreGetBaseUFIBits(struct _UNIVERSAL_FONT_ID *a1, struct FONTFILEVIEW *a2)
{
  __int64 result; // rax
  _OWORD **v5; // rcx
  _OWORD *v6; // rax
