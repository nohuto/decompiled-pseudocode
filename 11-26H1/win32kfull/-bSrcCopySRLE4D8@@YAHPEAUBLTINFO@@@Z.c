/*
 * XREFs of ?bSrcCopySRLE4D8@@YAHPEAUBLTINFO@@@Z @ 0x14033D540
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE4D8(struct BLTINFO *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( v13 )
    {
      if ( v6 < v48 && v9 < v7 && (int)(v13 + v9) > (int)v8 )
      {
        if ( v9 < (int)v8 )
        {
          v13 += v9 - v8;
...
LABEL_48:
    ...
    else if ( (_DWORD)v15 )
    {
      ...
      if ( (_DWORD)v15 != 2 )
      {
        ...
        if ( v6 >= v48 || v9 >= v7 || (int)v15 + v9 <= (int)v8 )
        {
          v9 += v15;
        ...
        else
        {
          ...
          if ( v22 )
          {
            ...
            {
              v25 = *v2++;
              v26 = *(_BYTE *)(v44 + 4 * (v25 & 0xF));
              *v24 = *(_BYTE *)(v44 + 4 * (v25 >> 4));
              v24[1] = v26;
              v24 += 2;
              --v22;
            }
          ...
          {
            v27 = v9++;
            *(_BYTE *)(v27 + v3) = *(_BYTE *)(v11 + 4 * ((unsigned __int64)*v2 >> 4));
