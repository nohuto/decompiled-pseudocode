/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qDDDD @ 0x1402E6750
 * Callers:
 *     ?CoalesceWindowAction@@YA_NPEAUtagWND@@PEBU_WINDOW_ACTION@@PEAVCMonitorTopology@@@Z @ 0x1402E1CC0 (-CoalesceWindowAction@@YA_NPEAUtagWND@@PEBU_WINDOW_ACTION@@PEAVCMonitorTopology@@@Z.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x14034FDB0 (_guard_dispatch_icall.c)
 */

__int64 WPP_RECORDER_AND_TRACE_SF_qDDDD(
        __int64 a1,
        char a2,
        char a3,
        __int64 a4,
        ...
        ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_915619942c3b30d864344f6052e6503f_Traceguids,
               125LL,
               (__int64 *)va,
               8LL,
               (__int64 *)va1,
