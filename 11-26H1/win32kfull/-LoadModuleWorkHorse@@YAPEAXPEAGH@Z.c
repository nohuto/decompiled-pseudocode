/*
 * XREFs of ?LoadModuleWorkHorse@@YAPEAXPEAGH@Z @ 0x14031BE44
 * Callers:
 *     EngLoadModule @ 0x14031C120 (EngLoadModule.c)
 *     EngLoadModuleForWrite @ 0x14031C140 (EngLoadModuleForWrite.c)
 * Callees:
