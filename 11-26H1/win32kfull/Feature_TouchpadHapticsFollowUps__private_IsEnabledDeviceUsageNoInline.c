/*
 * XREFs of Feature_TouchpadHapticsFollowUps__private_IsEnabledDeviceUsageNoInline @ 0x1402EF60C
 * Callers:
 *     xxxTrackMouseMove @ 0x14027D0C8 (xxxTrackMouseMove.c)
 * Callees:
 *     Feature_TouchpadHapticsFollowUps__private_IsEnabledFallback @ 0x1402EF648 (Feature_TouchpadHapticsFollowUps__private_IsEnabledFallback.c)
 */
