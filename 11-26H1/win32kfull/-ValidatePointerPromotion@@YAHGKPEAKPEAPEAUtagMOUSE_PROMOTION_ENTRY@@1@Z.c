/*
 * XREFs of ?ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1401366EC
 * Callers:
 ...
 *     ?FindMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagMOUSE_PROMOTION_QUEUE@@K@Z @ 0x140136904 (-FindMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagMOUSE_PROMOTION_QUEUE@@K@Z.c)
        ...
        struct tagMOUSE_PROMOTION_ENTRY **a5)
{
  ...
  if ( !CacheById
    || CacheById == (struct tagMOUSE_PROMOTION_CACHE *)(W32GetUserSessionState(v10, v9) + 16416)
    && (*(_DWORD *)(W32GetUserSessionState(v13, v12) + 16672) & 2) != 0 )
  {
    return 0LL;
  }
  ...
  if ( v5 == 0x10000000 )
  {
    ...
    if ( v5 == v23 )
    {
      if ( CacheById == (struct tagMOUSE_PROMOTION_CACHE *)(W32GetUserSessionState(v17, v16) + 16416) )
      {
        *a3 = 0x10000000;
        goto LABEL_17;
      }
  ...
  if ( !v19 )
  {
    if ( v20 )
      return 0LL;
    v24 = CacheById == (struct tagMOUSE_PROMOTION_CACHE *)(W32GetUserSessionState(v17, v16) + 16416);
    goto LABEL_28;
  }
  if ( v20 )
  {
