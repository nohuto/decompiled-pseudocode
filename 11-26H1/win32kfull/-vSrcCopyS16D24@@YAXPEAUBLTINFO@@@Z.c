/*
 * XREFs of ?vSrcCopyS16D24@@YAXPEAUBLTINFO@@@Z @ 0x140133690
 * Callers:
...
void __fastcall vSrcCopyS16D24(struct BLTINFO *a1)
{
  ...
  while ( 1 )
  {
    for ( i = v5; i; --i )
    {
      v11 = ((__int64 (__fastcall *)(__int64, _QWORD))v6)(v2, *v3);
      *(_BYTE *)v4 = v11;
      ++v3;
    ...
    if ( v8 )
    {
      ...
      do
      {
        v13 = ((__int64 (__fastcall *)(__int64, _QWORD))v6)(v2, *v3);
        v14 = ((__int64 (__fastcall *)(__int64, _QWORD))v6)(v2, v3[1]);
        *(_DWORD *)v4 = v13 | (v14 << 24);
        v15 = ((__int64 (__fastcall *)(__int64, _QWORD))v20)(v2, v3[2]);
        *(_DWORD *)(v4 + 4) = (v15 << 16) | (v14 >> 8);
        v6 = v20;
        v16 = ((__int64 (__fastcall *)(__int64, _QWORD))v20)(v2, v3[3]);
        v3 += 4;
