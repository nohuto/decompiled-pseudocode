/*
 * XREFs of ?ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z @ 0x1402311B8
 * Callers:
 *     RetrieveCalibrationData @ 0x140230F10 (RetrieveCalibrationData.c)
 * Callees:
...
LABEL_25:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  v20 = v23;
  v6 = ReadLinearityDataImp(v18, &v20, 1LL, v10, v9);
  if ( v17 )
    ZwClose(KeyHandle);
  if ( v6
    || (v22 = 0LL,
  ...
  if ( v7 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    if ( ZwOpenKey(&KeyHandle, 0x20019u, &ObjectAttributes) >= 0 )
    {
      ...
      v27 = v20;
      v6 = ReadLinearityDataImp(KeyHandle, &v27, 2LL, v10, v9);
      ZwClose(KeyHandle);
    }
    goto LABEL_21;
  }
