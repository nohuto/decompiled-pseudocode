/*
 * XREFs of ?RapidHpdComplete@DesktopRecalc@InputTraceLogging@@SAXW4InputTracing_DesktopRecalcRapidHpdResult@@IIIIU_GUID@@I@Z @ 0x1402952F8
 * Callers:
 ...
 *     ?RapidHpdToString@InputTraceLogging@@SAPEBDW4InputTracing_DesktopRecalcRapidHpdResult@@@Z @ 0x140266C04 (-RapidHpdToString@InputTraceLogging@@SAPEBDW4InputTracing_DesktopRecalcRapidHpdResult@@@Z.c)
 */
        ...
        int a7)
{
  ...
  const char *v19; // [rsp+80h] [rbp+2Fh] BYREF
  ...
  if ( (unsigned int)dword_1403AA9C0 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_1403AA9C0, 0x80000LL) )
    {
      ...
      v16 = v9;
      v17 = v10;
      v19 = InputTraceLogging::RapidHpdToString(a1);
