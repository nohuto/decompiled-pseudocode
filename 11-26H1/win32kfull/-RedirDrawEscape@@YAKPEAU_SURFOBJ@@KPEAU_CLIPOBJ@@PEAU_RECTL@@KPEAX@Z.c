/*
 * XREFs of ?RedirDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x14030D3A0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a6)
{
  ...
  __int64 v13; // r9
  __int64 v14; // r9
  __int64 v16; // [rsp+40h] [rbp-E8h] BYREF
  _BYTE v17[8]; // [rsp+48h] [rbp-E0h] BYREF
  struct SURFACE *v18[2]; // [rsp+50h] [rbp-D8h] BYREF
  _BYTE v19[160]; // [rsp+60h] [rbp-C8h] BYREF
