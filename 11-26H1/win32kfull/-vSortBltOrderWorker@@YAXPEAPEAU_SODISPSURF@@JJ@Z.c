/*
 * XREFs of ?vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z @ 0x14032944C
 * Callers:
 *     ??0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z @ 0x14028CE94 (--0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z.c)
 * Callees:
 *     ?isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z @ 0x1403291E8 (-isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z.c)
 */
