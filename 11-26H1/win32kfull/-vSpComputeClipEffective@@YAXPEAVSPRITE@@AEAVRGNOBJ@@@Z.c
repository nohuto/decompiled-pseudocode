/*
 * XREFs of ?vSpComputeClipEffective@@YAXPEAVSPRITE@@AEAVRGNOBJ@@@Z @ 0x1403163E8
 * Callers:
          ...
          if ( v5 || v7 )
          {
            ...
            if ( v21 && v18 && v20 )
            {
              ...
              if ( v5 )
              {
                ...
                vSpUpdatePerPixelAlphaFromColorKey(*((struct _SURFOBJ **)a1 + 16), *((_DWORD *)a1 + 51), &v32, &v33);
              }
              v8 = 0;
              v9 = *((_QWORD *)a1 + 16);
              v10 = *(_DWORD *)(v9 + 32);
              ...
              {
                v32 = (struct _RECTL)*((_OWORD *)a1 + 6);
                vSpDeletePerPixelAlphaFromColorKey(*((struct _SURFOBJ **)a1 + 16), *((_DWORD *)a1 + 51), &v32, v33);
              }
