/*
 * XREFs of ?SortTouchContacts@@YAHPEAUtagPOINTER_TOUCH_INFO@@I@Z @ 0x14024BC7C
 * Callers:
...
LABEL_40:
    ...
    {
      UserSessionState = W32GetUserSessionState(WPP_GLOBAL_Control, i);
      v28 = v23;
      LOBYTE(v8) = v24;
      v9 = *(_QWORD *)(UserSessionState + 69152);
      v27 = 18;
      goto LABEL_35;
    }
  }
