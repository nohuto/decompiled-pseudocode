/*
 * XREFs of ?_ReadSettingsFromRegKey@PalmRejection@@YAXXZ @ 0x1402C2BA8
 * Callers:
...
void __fastcall PalmRejection::_ReadSettingsFromRegKey(PalmRejection *this)
{
  ...
  v10 = v20 < 0x5DC;
  *(_DWORD *)(UserSessionState + 17364) = v6;
  v11 = 1500;
  if ( v10 )
    v11 = v20;
  ...
  if ( v23 < 0x5DC )
    v5 = v23;
  *(_DWORD *)(v12 + 17368) = v11;
  *(_DWORD *)(W32GetUserSessionState(v14, v13) + 17372) = v5;
}
