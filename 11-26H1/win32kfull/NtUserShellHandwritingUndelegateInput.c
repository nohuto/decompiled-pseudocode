/*
 * XREFs of NtUserShellHandwritingUndelegateInput @ 0x1401E8FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserShellHandwritingUndelegateInput(unsigned int a1, unsigned int a2)
{
  ...
  v9 = v7;
  if ( !v7 || !_bittest64((const signed __int64 *)(v7 + 1360), 0x25u) || a2 - 1 > 1 )
    goto LABEL_2;
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v8);
  if ( CurrentProcessWin32Process )
    CurrentProcessWin32Process &= -(__int64)(*(_QWORD *)CurrentProcessWin32Process != 0LL);
  if ( *(_QWORD *)(v9 + 456) == CurrentProcessWin32Process )
  {
