/*
 * XREFs of ?AltF4Callback@@YA?AW4tagHotKeyCallBackResult@@_K_J@Z @ 0x14029B000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AltF4Callback(__int64 a1, __int64 a2)
{
  ...
  v5 = 0;
  if ( !_GetShellWindow(*(struct tagDESKTOP **)(UserSessionState + 19176)) )
    return 1LL;
  v8 = *(_QWORD *)(W32GetUserSessionState(v4, v3) + 18928);
  if ( !v8 )
    return 1LL;
  v9 = *(struct tagWND **)(v8 + 128);
  if ( !v9 )
    return 1LL;
  if ( *(_DWORD *)(W32GetUserSessionState(v7, v6) + 66084) )
  {
