/*
 * XREFs of ?SendHapticFeedbackOutput@SimpleHapticsController@@QEAAJAEBU_SIMPLEHAPTICCTRL_FEEDBACK_DATA@@@Z @ 0x140300E18
 * Callers:
        ...
        _BYTE *a4)
{
  ...
  const char *v20; // [rsp+B0h] [rbp+50h] BYREF
  ...
  if ( (unsigned int)dword_1403AAAA0 > 4 )
  {
    ...
    v18 = "SimpleHapticsController::GetReportInfo entry";
...
LABEL_21:
  if ( (unsigned int)dword_1403AAAA0 > 4 )
  {
    ...
    v20 = "SimpleHapticsController::SendHapticFeedbackOutput exit";
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
      (__int64)&dword_1403AAAA0,
      (__int64)&unk_14037A65F,
      a3,
      (__int64)a4,
      (void **)&v20,
      (__int64)&ByteOffset);
