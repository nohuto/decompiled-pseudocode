/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1401365C0
 * Callers:
 *     EditionUnlinkAndFreeThreadPointerData @ 0x140136030 (EditionUnlinkAndFreeThreadPointerData.c)
