/*
 * XREFs of ?UmfdEscEngUnmapFontFileFD@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1400C29D0
 * Callers:
...
void __fastcall UmfdEscEngUnmapFontFileFD(struct tagUMFD_ESCAPE_ARGUMENT *a1, __int64 a2, __int64 a3)
{
  ...
  v4 = (struct W32_PUSH_LOCK *)(*(_QWORD *)(W32GetSessionState(a1, a2, a3) + 96) + 24232LL);
  GreAcquirePushLockShared(v4);
  v5 = 0LL;
  v9 = *(_QWORD *)(W32GetSessionState(v7, v6, v8) + 96);
  v10 = *(NSInstrumentation::CPrioritizedWriterLock **)(v9 + 24152);
  if ( v10 )
  {
    v11 = *((_DWORD *)a1 + 2);
    NSInstrumentation::CPrioritizedWriterLock::AcquireShared(*(NSInstrumentation::CPrioritizedWriterLock **)(v9 + 24152));
    v12 = *((_QWORD *)v10 + 5);
    if ( !v12 )
      goto LABEL_8;
    v13 = *((_QWORD *)v10 + 6);
