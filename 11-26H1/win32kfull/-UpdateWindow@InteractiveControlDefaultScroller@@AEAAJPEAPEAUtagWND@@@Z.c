/*
 * XREFs of ?UpdateWindow@InteractiveControlDefaultScroller@@AEAAJPEAPEAUtagWND@@@Z @ 0x1402940FC
 * Callers:
        ...
        struct tagWND **a2)
{
  ...
  if ( *(_QWORD *)(UserSessionState + 18928) )
    v5 = *(struct tagWND **)(*(_QWORD *)(W32GetUserSessionState(0LL, v4) + 18928) + 120LL);
  *a2 = v5;
