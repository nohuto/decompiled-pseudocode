/*
 * XREFs of SfnINOUTLPSIZE @ 0x140228930
 * Callers:
        ...
        __int64 a8)
{
  ...
  *(_QWORD *)(*((_QWORD *)v13 + 64) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(126LL, &v26, 48LL, &Src, &v36);
  ...
  *(_QWORD *)(v19 + 80) = a6;
  if ( v18 >= 0 && v36 == 24 )
  {
    ...
    if ( !v23 || (*(_DWORD *)(v23 + 84) & 1) == 0 || *(__int64 **)(v23 + 96) != a4 )
    {
      v24 = (void *)*((_QWORD *)Src + 2);
      a5 = 0LL;
      RtlCopyFromUser(&a5, v24, 8uLL);
      *a4 = a5;
      return v21;
    }
  }
