/*
 * XREFs of ?QueryNameString@FileQueryObj@Gre@@QEBA_NPEAU_OBJECT_NAME_INFORMATION@@K@Z @ 0x1400CF244
 * Callers:
...
bool __fastcall Gre::FileQueryObj::QueryNameString(void **this, struct _OBJECT_NAME_INFORMATION *a2, ULONG a3)
{
  ...
  v3 = *this;
  Object = 0LL;
  v5 = ObReferenceObjectByHandle(v3, 1u, (POBJECT_TYPE)IoFileObjectType, 0, &Object, 0LL);
  v6 = Object;
  v7 = v5;
  if ( v5 >= 0 )
  {
