/*
 * XREFs of _lambda_315ad92e5be98155a16179dc024b8a3c_::operator() @ 0x140164974
 * Callers:
 *     _lambda_315ad92e5be98155a16179dc024b8a3c_::_lambda_invoker_cdecl_ @ 0x140163430 (_lambda_315ad92e5be98155a16179dc024b8a3c_--_lambda_invoker_cdecl_.c)
...
bool __fastcall lambda_315ad92e5be98155a16179dc024b8a3c_::operator()(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( v4 <= *(_DWORD *)(v6 + 136) )
  {
    ...
    {
      v10 = *(_QWORD *)(W32GetUserSessionState(v8, v7) + 63432);
      if ( (unsigned __int8)v4 <= *(_BYTE *)(v10 + v3 + 12)
        && (unsigned __int8)v4 <= *(_BYTE *)(*(_QWORD *)(W32GetUserSessionState(v10, v9) + 63432) + v3 + 20) )
      {
        return 1;
      }
    }
