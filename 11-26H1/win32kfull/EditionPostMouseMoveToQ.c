/*
 * XREFs of EditionPostMouseMoveToQ @ 0x1402773C0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)result )
  {
    if ( (unsigned int)Feature_TouchpadHaptics__private_IsEnabledDeviceUsageNoInline() )
    {
      if ( *a7 )
        ...
        v12 = 0LL;
      return PostInputMessage(v17, v16, 0x200u, 0LL, a2, a3, a4, a5, 0, v7, v12, a7[1], v14, v13, v15);
    }
    else
    {
      return PostInputMessage(v17, v16, 0x200u, 0LL, a2, a3, a4, a5, 0, v7, 0LL, 0LL, v14, v13, v15);
    }
  }
  return result;
}
