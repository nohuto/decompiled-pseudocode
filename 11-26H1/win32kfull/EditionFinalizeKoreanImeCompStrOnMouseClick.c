/*
 * XREFs of EditionFinalizeKoreanImeCompStrOnMouseClick @ 0x14020F200
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EditionFinalizeKoreanImeCompStrOnMouseClick(__int64 a1, __int64 a2)
{
  ...
  v3 = a2;
  if ( (**(_DWORD **)(W32GetUserSessionState(a1, a2) + 19904) & 4) != 0 && !v3 && (GetActiveHKL() & 0x3FF) == 0x12 )
  {
    v4 = *(_QWORD *)(*((_QWORD *)v2 + 17) + 8LL);
    if ( (*(_BYTE *)(v4 + 10) & 1) == 0 )
    {
      if ( *(_QWORD *)(W32GetUserSessionState(1023LL, v4) + 18928) )
