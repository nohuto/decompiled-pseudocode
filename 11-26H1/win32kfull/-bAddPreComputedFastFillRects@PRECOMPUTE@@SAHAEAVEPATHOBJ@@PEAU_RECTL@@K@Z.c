/*
 * XREFs of ?bAddPreComputedFastFillRects@PRECOMPUTE@@SAHAEAVEPATHOBJ@@PEAU_RECTL@@K@Z @ 0x14033D88C
 * Callers:
...
__int64 __fastcall PRECOMPUTE::bAddPreComputedFastFillRects(struct EPATHOBJ *a1, struct _RECTL *a2, __int64 a3)
{
  _DWORD *v3; // rsi
  __int64 v4; // r15
  unsigned int v5; // eax
