/*
 * XREFs of ?IsHotKey@@YAPEAUtagHOTKEY@@II@Z @ 0x140203980
 * Callers:
 ...
 *     EditionIsHotKey @ 0x1402A7C60 (EditionIsHotKey.c)
 * Callees:
...
struct tagHOTKEY *__fastcall IsHotKey(__int64 a1, __int64 a2)
{
  ...
  v2 = a2;
  v3 = a1;
  for ( i = *(_BYTE **)(W32GetUserSessionState(a1, a2) + 8 * (a2 & 0x7F) + 12944); ; i = (_BYTE *)*((_QWORD *)i + 6) )
  {
    if ( !i )
  ...
  v7 = *(_QWORD *)i;
  if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)i + 520LL), 0, 0) & 0xC) != 0 )
    return (struct tagHOTKEY *)i;
  UserSessionState = W32GetUserSessionState(v7, v4);
  if ( GetDesktopView(*(_QWORD *)(*(_QWORD *)i + 456LL), *(_QWORD *)(UserSessionState + 19176)) )
  {
    if ( (i[32] & 0xB) == 0 )
    {
      if ( *(_QWORD *)(W32GetUserSessionState(v10, v9) + 18928) )
      {
        if ( (unsigned int)(v2 - 173) > 6 && v2 != 7 )
        {
          ...
          if ( !UIPrivilegeIsolation::CheckAccess(
                  (UIPrivilegeIsolation *)(*(_QWORD *)(*(_QWORD *)i + 456LL) + 864LL),
                  (const struct tagUIPI_INFO *)(*(_QWORD *)(v13 + 18928) + 472LL),
                  v14) )
          {
            v17 = *(_QWORD *)(W32GetUserSessionState(v16, v15) + 18928);
            v18 = *(_DWORD *)(v17 + 480);
            v34 = *(_QWORD *)(v17 + 472);
            v20 = W32GetUserSessionState(v17, v19);
            v21 = *(_QWORD *)i;
            v32 = v34;
            v22 = *(_QWORD *)(v20 + 18928);
            v33 = v18;
            ...
            {
              W32GetUserSessionState(WPP_GLOBAL_Control, v23);
