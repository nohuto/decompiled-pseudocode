/*
 * XREFs of _InitializeTouchInjectionWorker @ 0x14029DF4C
 * Callers:
 ...
 *     CleanupInjectedTouchProcess @ 0x14025FF00 (CleanupInjectedTouchProcess.c)
...
LABEL_12:
    ...
    *(_QWORD *)(v11 + 8) = a3;
    v15 = *(_QWORD *)(W32GetUserSessionState(v13, v12) + 19296);
    *v14 = v15;
    *(_QWORD *)(W32GetUserSessionState(v15, v16) + 19296) = v14;
  }
  *(_QWORD *)(a3 + 880) = v9;
  v21[0] = v9 + 16;
