/*
 * XREFs of SfnINWPARAMCHAR @ 0x14021F710
 * Callers:
...
__int64 __fastcall SfnINWPARAMCHAR(__int64 *a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  ...
  void *Src; // [rsp+F8h] [rbp+20h] BYREF
  ...
  if ( (a7 & 1) != 0 )
  {
    if ( a2 == 47 || a2 == 288 )
    {
      ...
      v31 = (WORD1(v31) << 16) | (unsigned __int16)v29;
    }
    else
    {
      RtlWCSMessageWParamCharToMB(a2, (__int64)&v31);
    }
  }
  v23 = v31;
  v24 = a4;
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 64) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(2LL, &v20, 48LL, &Src, &v30);
