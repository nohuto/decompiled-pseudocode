/*
 * XREFs of ?xxxShowWindowPolicyHandler@CallShell@@YA_NPEAUtagWND@@IPEAU_SHELL_WINDOWMANAGEMENT_CALLOUT_INFO@@@Z @ 0x1402DCA30
 * Callers:
        ...
        struct _SHELL_WINDOWMANAGEMENT_CALLOUT_INFO *a4)
{
  ...
  *((_DWORD *)this + 96) |= 2u;
  ...
  v7 = anonymous_namespace_::xxxCallIAMWindowManagementHandler(a3, 0);
  v8 = 0;
  v9 = v7;
  if ( v7 )
    v8 = *(_DWORD *)(a3 + 20);
