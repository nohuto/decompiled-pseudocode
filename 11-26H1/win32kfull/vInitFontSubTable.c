/*
 * XREFs of vInitFontSubTable @ 0x1403FB77C
 * Callers:
...
__int64 __fastcall vInitFontSubTable(int a1, __int64 a2)
{
  ...
  *(_DWORD *)(v3 + 19680) = 0;
  ...
  v4 = *(void **)(v3 + 19656);
  result = *(unsigned int *)(v3 + 19672);
  if ( v4 )
  {
    if ( Context <= (unsigned int)result )
      goto LABEL_4;
    result = (__int64)PREALLOCMEM2(v4, (unsigned int)(196 * result), (unsigned int)(196 * result), 0x62736647u);
    if ( !result )
      goto LABEL_4;
  }
  else
  ...
  *(_QWORD *)(v3 + 19656) = result;
LABEL_4:
  v6 = *(_QWORD *)(v3 + 19656);
  if ( v6 )
  {
    *(_OWORD *)v6 = xmmword_140366200;
    *(_OWORD *)(v6 + 16) = xmmword_140366210;
    *(_DWORD *)(v6 + 32) = 6684777;
    *(_WORD *)(v6 + 36) = 0;
    v7 = *(_QWORD *)(v3 + 19656);
    *(_OWORD *)(v7 + 64) = xmmword_140366228;
    *(_OWORD *)(v7 + 80) = xmmword_140366238;
    *(_DWORD *)(v7 + 96) = 4587593;
    *(_WORD *)(v7 + 100) = 0;
    v8 = *(_QWORD *)(v3 + 19656);
    *(_OWORD *)(v8 + 130) = xmmword_140366250;
    *(_QWORD *)(v8 + 146) = 0x49005200450053LL;
    *(_DWORD *)(v8 + 154) = 70;
    for ( i = 0LL; i < 2; ++i )
      *(_BYTE *)(*(_QWORD *)(v3 + 19656) + i + 128) = 1;
    do
    {
      result = *(_QWORD *)(v3 + 19656);
