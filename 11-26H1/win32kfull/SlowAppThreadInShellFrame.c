/*
 * XREFs of SlowAppThreadInShellFrame @ 0x14020BCAC
 * Callers:
 ...
 *     ?OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z @ 0x14020BFB8 (-OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z.c)
 */
        ...
        int a4)
{
  ...
  if ( v10 )
  {
    ...
    if ( v11 )
    {
      if ( (unsigned int)IsDebuggerAttached(*(_QWORD *)(v11 + 456)) )
        return 0LL;
      a4 = v27;
      a3 = v26;
    }
  ...
  if ( v13 )
  {
    if ( v13 == a2 && v13 != a1 )
    {
      ...
      if ( v19 )
      {
        if ( a3 == v19 )
        {
          if ( (unsigned int)IsDebuggerAttached(*((_QWORD *)v13 + 57)) )
            return 0LL;
          ...
          if ( (int)v9 - *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 72) + 480LL) + 20LL) >= v12 )
            return v13;
        }
      }
    }
  ...
  {
    v14 = v27;
    if ( (v27 || (*(_DWORD *)(*((_QWORD *)a1 + 60) + 8LL) & 0x1084) != 0)
      && ((int)v9 - *(_DWORD *)(v8 + 48) >= v12 || (unsigned int)(*(_DWORD *)(v4 + 40) + *((_DWORD *)v13 + 214)) > 0x100) )
    {
      return v13;
    }
  }
...
LABEL_9:
  ...
  if ( v14
    && ((int)v9 - *(_DWORD *)(*((_QWORD *)v13 + 60) + 20LL) >= v12
     || (unsigned int)(*(_DWORD *)(v4 + 40) + *((_DWORD *)v13 + 214)) > 0x100) )
  {
    return v13;
  }
LABEL_11:
  v15 = (_DWORD *)*((_QWORD *)a1 + 88);
