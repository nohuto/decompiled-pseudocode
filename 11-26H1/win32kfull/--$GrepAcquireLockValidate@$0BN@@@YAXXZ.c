/*
 * XREFs of ??$GrepAcquireLockValidate@$0BN@@@YAXXZ @ 0x14029630C
 * Callers:
...
__int64 GrepAcquireLockValidate<29>()
{
  __int64 result; // rax
  ...
  {
    v3 = *(_QWORD *)result;
    result = 0xFFFFFFDFE0000000uLL;
    if ( (v3 & 0xFFFFFFDFE0000000uLL) != 0 && (v3 & 0x20000000) == 0 )
    {
      v4 = 38;
      do
      {
      ...
      while ( v1 < 0x40 );
      if ( (int)result > 29 && (_DWORD)result != 38 )
