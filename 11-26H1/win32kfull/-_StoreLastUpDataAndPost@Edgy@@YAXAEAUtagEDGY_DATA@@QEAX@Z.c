/*
 * XREFs of ?_StoreLastUpDataAndPost@Edgy@@YAXAEAUtagEDGY_DATA@@QEAX@Z @ 0x1402C3910
 * Callers:
...
void __fastcall Edgy::_StoreLastUpDataAndPost(Edgy *this, struct tagEDGY_DATA *a2, void *const a3)
{
  ...
  Edgy **v12; // rax
  Edgy *v13; // [rsp+40h] [rbp-38h]
  __int64 v14[3]; // [rsp+48h] [rbp-30h] BYREF
  ...
  if ( *((_DWORD *)this + 4) != 2 )
  {
    ...
    for ( i = 0; i < v5; ++i )
    {
      ...
      PointerInfo = CTouchProcessor::GetPointerInfo(*(CTouchProcessor **)(UserSessionState + 3256), a2, i);
      v9 = PointerInfo;
      if ( PointerInfo )
      {
        if ( (*((_DWORD *)PointerInfo + 3) & 0x40000) != 0 )
        {
          ...
          {
            PointerDeviceType = GetPointerDeviceType(*((_QWORD *)v9 + 2));
            v12 = (Edgy **)Edgy::_HitTestEdgyRegion(
                             v14,
                             (unsigned int *)v4,
                             *((_QWORD *)v9 + 2),
                             *((_QWORD *)v9 + 5),
