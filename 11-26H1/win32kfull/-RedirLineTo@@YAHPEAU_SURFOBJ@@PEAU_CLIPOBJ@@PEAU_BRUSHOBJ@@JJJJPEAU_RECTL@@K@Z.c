/*
 * XREFs of ?RedirLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x14030DAA0
 * Callers:
 *     <none>
 * Callees:
        ...
        MIX a9)
{
  ...
  __int64 v21; // [rsp+50h] [rbp-E8h] BYREF
  _BYTE v22[8]; // [rsp+58h] [rbp-E0h] BYREF
  struct SURFACE *v23[2]; // [rsp+60h] [rbp-D8h] BYREF
  _BYTE v24[160]; // [rsp+70h] [rbp-C8h] BYREF
