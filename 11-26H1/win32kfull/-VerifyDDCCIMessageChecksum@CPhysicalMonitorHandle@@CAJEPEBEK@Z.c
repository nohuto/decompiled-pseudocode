/*
 * XREFs of ?VerifyDDCCIMessageChecksum@CPhysicalMonitorHandle@@CAJEPEBEK@Z @ 0x14022E364
 * Callers:
...
LABEL_27:
  ...
  if ( v6 - 6 > 0x20 )
    return 3223192970LL;
LABEL_28:
  v15 = CPhysicalMonitorHandle::ComputeDDCCIMessageChecksum(0x6Fu, a2, v6 - 1);
