/*
 * XREFs of UpdateSpriteArea @ 0x14020440C
 * Callers:
        ...
        int a11)
{
  ...
  if ( !v18 && a2 )
  {
    ...
    GreBitBltInternal(
      ...
      0);
    if ( v24 )
      GreConvertRedirectionToMemDC((HDC)a4);
    v27 = *((_QWORD *)a1 + 5);
