/*
 * XREFs of ?xxxFullscreenRestore@CRecalcState@@QEAAXPEAUtagWND@@AEBVCMonitorTopology@@PEAVCRecalcContext@@@Z @ 0x1402DF660
 * Callers:
        ...
        struct CRecalcContext *a4)
{
  ...
  __m128i v45[4]; // [rsp+50h] [rbp-48h] BYREF
  ...
  if ( (*((_BYTE *)v7 + 20) & 0x40) != 0 )
  {
    ...
    if ( WPP_GLOBAL_Control == (struct MOVESIZEDATA *)&WPP_GLOBAL_Control
      || (v14 = *((unsigned int *)WPP_GLOBAL_Control + 11), (v14 & 0x40) == 0)
    ...
    v21 = a4;
    AdvancedWindowPos::xxxMigrateWindow((__int64)a2, v46, (__int64)a3, 0LL, 0LL, 2, (int *)a4 + 1, 0LL);
  }
  else
  {
    v23 = W32GetUserSessionState(v7, v6);
    v15 = 1;
    Prop = GetProp((__int64)a2, *(unsigned __int16 *)(v23 + 41374), 1u);
    v25 = 0;
    ...
    v21 = a4;
    v37 = v25;
    v38 = *(__m128i *)((char *)this + 28);
    v39 = *((_QWORD *)this + 9);
    v44 = *(struct tagRECT *)((char *)this + 44);
    v45[0] = v38;
    AdvancedWindowPos::xxxRestoreToPosAndState((__int64)a2, v39, v37, v45, &v44, v31, (unsigned int *)a4 + 1);
  }
