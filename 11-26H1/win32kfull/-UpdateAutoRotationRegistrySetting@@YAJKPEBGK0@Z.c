/*
 * XREFs of ?UpdateAutoRotationRegistrySetting@@YAJKPEBGK0@Z @ 0x140265650
 * Callers:
 *     ?xxxSetSensorPresence@CRotationMgr@@UEAAXH@Z @ 0x140265610 (-xxxSetSensorPresence@CRotationMgr@@UEAAXH@Z.c)
