/*
 * XREFs of ?UnselectRedirectionBitmapsInDCEs@@YAXQEAUtagWND@@@Z @ 0x1402A427C
 * Callers:
 ...
 *     ?WindowMatchesDCE@@YAHQEAUtagWND@@PEBUtagDCE@@@Z @ 0x1401AC0A0 (-WindowMatchesDCE@@YAHQEAUtagWND@@PEBUtagDCE@@@Z.c)
 */

void __fastcall UnselectRedirectionBitmapsInDCEs(struct tagWND *const a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // rdx
  ...
  if ( v7 != (struct tagWND *)v9 )
  {
    do
    {
      ...
      if ( (*((_DWORD *)v7 + 12) & 0x4404800) == 0x4000
        ...
        && !(unsigned int)GreSelectRedirectionBitmap(*((Gre::Base **)v7 + 2), 0LL) )
      {
