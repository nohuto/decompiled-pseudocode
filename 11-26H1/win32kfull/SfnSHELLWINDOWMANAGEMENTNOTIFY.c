/*
 * XREFs of SfnSHELLWINDOWMANAGEMENTNOTIFY @ 0x1401FF420
 * Callers:
        ...
        __int64 a6)
{
  ...
  _QWORD v20[5]; // [rsp+38h] [rbp-120h] BYREF
  void *Src; // [rsp+60h] [rbp-F8h] BYREF
  __int64 v22; // [rsp+68h] [rbp-F0h]
  ULONG_PTR BugCheckParameter3[4]; // [rsp+70h] [rbp-E8h] BYREF
  __int128 v24; // [rsp+90h] [rbp-C8h]
  __int64 v25; // [rsp+A0h] [rbp-B8h] BYREF
  int v26; // [rsp+A8h] [rbp-B0h]
  __int64 v27; // [rsp+B0h] [rbp-A8h]
  __int128 v28; // [rsp+B8h] [rbp-A0h]
  __int128 v29; // [rsp+C8h] [rbp-90h]
  __int128 v30; // [rsp+D8h] [rbp-80h]
  __int128 v31; // [rsp+E8h] [rbp-70h]
  __int128 v32; // [rsp+F8h] [rbp-60h]
  __int64 v33; // [rsp+108h] [rbp-50h]
  __int64 v34; // [rsp+110h] [rbp-48h]
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 64) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(54LL, &v25, 120LL, &Src, &v19);
