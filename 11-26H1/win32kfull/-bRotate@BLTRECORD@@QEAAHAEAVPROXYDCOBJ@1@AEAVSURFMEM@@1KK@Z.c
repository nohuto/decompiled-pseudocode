/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVPROXYDCOBJ@1@AEAVSURFMEM@@1KK@Z @ 0x14031E140
 * Callers:
        ...
        ULONG iMode)
{
  ...
  SURFMEM::bCreateDIB(a3, (struct _DEVBITMAPINFO *)&v20, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0);
  if ( !*(_QWORD *)a3 )
    return 0LL;
  v12 = 16 * x;
  v13 = 16 * y;
  pptfx.x = *((_DWORD *)this + 24) - v12;
  pptfx.y = *((_DWORD *)this + 25) - v13;
  v28 = *((_DWORD *)this + 26) - v12;
  v29 = *((_DWORD *)this + 27) - v13;
  v30 = *((_DWORD *)this + 28) - v12;
  v31 = *((_DWORD *)this + 29) - v13;
  v32 = *((_DWORD *)this + 30) - v12;
  v33 = *((_DWORD *)this + 31) - v13;
  BLTRECORD::vMirror(this, &pptfx);
  ERECTL::bOffsetAdd(
    (BLTRECORD *)((char *)this + 152),
  ...
  *((_DWORD *)this + 38) = -*(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1016);
  result = 1LL;
  *((_DWORD *)this + 39) = -*(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1020);
  *((_DWORD *)this + 40) = v21 - *(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1016);
  *((_DWORD *)this + 41) = v22 - *(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1020);
  return result;
}
