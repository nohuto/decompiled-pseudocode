/*
 * XREFs of ?UMPDDrvTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1400D5BD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  v58 = a1;
  if ( v11
    && (unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), &v58, v41[0])
    && (unsigned int)UMPDOBJ::pstro(v14, &v59)
    && (unsigned int)UMPDOBJ::pfo(v14, (__m128i **)&v60)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 112), &v61, 0x18u, 0LL)
    && (unsigned int)UMPDOBJ::ThunkMemBlock(v14, &v62, v16)
    && (unsigned int)UMPDOBJ::ThunkMemBlock(v14, &v63, 0x10u)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 144), &v64, 0x18u, 0LL)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v14, (UMPDOBJ *)((char *)v14 + 160), &v65, 0x18u, 0LL)
