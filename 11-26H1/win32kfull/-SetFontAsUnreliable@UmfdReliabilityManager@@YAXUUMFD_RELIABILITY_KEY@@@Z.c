/*
 * XREFs of ?SetFontAsUnreliable@UmfdReliabilityManager@@YAXUUMFD_RELIABILITY_KEY@@@Z @ 0x14034E208
 * Callers:
...
char __fastcall UmfdReliabilityManager::SetFontAsUnreliable(int a1, __int64 a2)
{
  ...
  v6 = 0;
  v7 = a1;
  v4 = *(NSInstrumentation::CPrioritizedWriterLock **)(*(_QWORD *)(SessionState + 96) + 24280LL);
