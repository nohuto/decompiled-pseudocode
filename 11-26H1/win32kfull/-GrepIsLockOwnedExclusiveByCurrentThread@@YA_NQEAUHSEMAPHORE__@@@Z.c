/*
 * XREFs of ?GrepIsLockOwnedExclusiveByCurrentThread@@YA_NQEAUHSEMAPHORE__@@@Z @ 0x1400D5794
 * Callers:
 ...
 *     GrepIsRFONTListSemaphoreOwnedByCurrentThread @ 0x1403282F0 (GrepIsRFONTListSemaphoreOwnedByCurrentThread.c)
 * Callees:
 *     <none>
 */
