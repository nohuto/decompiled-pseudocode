/*
 * XREFs of FreezeThawProcessTimers @ 0x1402A7E80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  while ( v3 != v2 );
  if ( v5 && !*(_BYTE *)(W32GetUserSessionState(v3, v7) + 18712) )
  {
    if ( *(_BYTE *)(W32GetUserSessionState(v10, v9) + 62712) )
    {
      *(_BYTE *)(W32GetUserSessionState(v12, v11) + 18713) = 1;
    }
    else
    {
      v13 = CRitTimerScanWakeSystem::SignalRitTimerScanWakeEvent(v12, v11);
      *(_BYTE *)(W32GetUserSessionState(v15, v14) + 18712) = v13;
      if ( *(_BYTE *)(W32GetUserSessionState(v17, v16) + 18712) != 1 )
