/*
 * XREFs of ?xxxEnsureDpiCursorsForSysCur@@YAXI@Z @ 0x140151F68
 * Callers:
...
void __fastcall xxxEnsureDpiCursorsForSysCur(__int64 a1, __int64 a2)
{
  ...
  v3 = 0LL;
  v4 = 33024;
  v5 = *(struct tagCURSOR **)(W32GetUserSessionState(a1, a2) + v2 + 21912);
  if ( *(_QWORD *)(W32GetUserSessionState(v7, v6) + v2 + 21928) )
  {
    v3 = (struct _UNICODE_STRING *)(W32GetUserSessionState(v9, v8) + v2 + 21920);
