/*
 * XREFs of _lambda_9c8951c187b4be4d23fed8f94aee3ae8_::operator() @ 0x14024200C
 * Callers:
 ...
 *     _lambda_9c8951c187b4be4d23fed8f94aee3ae8_::_lambda_invoker_cdecl_ @ 0x140241FF0 (_lambda_9c8951c187b4be4d23fed8f94aee3ae8_--_lambda_invoker_cdecl_.c)
 * Callees:
 *     <none>
 */
...
bool __fastcall lambda_9c8951c187b4be4d23fed8f94aee3ae8_::operator()(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( v4 <= *(_DWORD *)(v6 + 136) )
  {
    ...
    if ( (unsigned __int8)v4 <= *(_BYTE *)(v8 + v3 + 20)
