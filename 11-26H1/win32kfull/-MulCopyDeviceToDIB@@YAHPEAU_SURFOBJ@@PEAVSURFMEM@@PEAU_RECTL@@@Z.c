/*
 * XREFs of ?MulCopyDeviceToDIB@@YAHPEAU_SURFOBJ@@PEAVSURFMEM@@PEAU_RECTL@@@Z @ 0x140063050
 * Callers:
...
__int64 __fastcall MulCopyDeviceToDIB(struct _SURFOBJ *a1, struct SURFMEM *a2, struct _RECTL *a3)
{
  ...
  *(_QWORD *)&v33.left = 0LL;
  ...
  SURFMEM::bCreateDIB(a2, (struct _DEVBITMAPINFO *)v29, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0);
  if ( *(_QWORD *)a2 )
  {
    v26 = Gre::Base::Globals(v25);
    if ( (unsigned int)MulBitBlt(
                         (struct _SURFOBJ *)((*(_QWORD *)a2 + 24LL) & -(__int64)(*(_QWORD *)a2 != 0LL)),
                         a1,
                         0LL,
                         0LL,
                         (XLATEOBJ *)((char *)v26 + 4664),
                         &v33,
                         &v28,
                         0LL,
                         0LL,
