/*
 * XREFs of ?bSpTransferShape@@YAHPEAVSPRITE@@0@Z @ 0x140314B20
 * Callers:
...
__int64 __fastcall bSpTransferShape(struct SPRITE *a1, struct SPRITE *a2)
{
  ...
  __int64 v11; // r8
  __int64 result; // rax
  struct _RECTL *v13; // [rsp+20h] [rbp-58h]
  Gre::Base *v14; // [rsp+28h] [rbp-50h]
  struct _XLATEOBJ *v15; // [rsp+80h] [rbp+8h] BYREF
  ...
  *(_DWORD *)a1 |= *(_DWORD *)a2 & 0x10;
  ...
  if ( v6 )
  {
    ...
    else
    {
      ...
      v9 = *((_QWORD *)a2 + 18);
      v14 = (Gre::Base *)*((_QWORD *)v8 + 484);
      v13 = *(struct _RECTL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 32LL) + 104LL);
      v15 = 0LL;
      v7 = (_OWORD *)((char *)a2 + 96);
      if ( (unsigned int)EXLATEOBJ::bInitXlateObj(
        ...
        bSpCreateShape(
          ...
          *(struct PALETTE **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 32LL) + 104LL),
          ...
          1u,
          0LL);
      EXLATEOBJ::vAltUnlock((Gre::Base **)&v15, v10, v11);
    }
    if ( *((_QWORD *)a1 + 16) )
    {
