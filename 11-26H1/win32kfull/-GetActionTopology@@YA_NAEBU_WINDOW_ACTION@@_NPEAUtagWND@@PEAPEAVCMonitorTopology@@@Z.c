/*
 * XREFs of ?GetActionTopology@@YA_NAEBU_WINDOW_ACTION@@_NPEAUtagWND@@PEAPEAVCMonitorTopology@@@Z @ 0x1402E1FFC
 * Callers:
  ...
  if ( (*(_DWORD *)a1 & 0x200) != 0 )
  {
    ...
    if ( !(_DWORD)a1 && (v4 & 0xFFFFFDFF) != 0 )
    {
      ...
      if ( !v9 && *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        return 0;
      v13 = *(_QWORD *)(W32GetUserSessionState(WPP_GLOBAL_Control, a2) + 69152);
      v33 = 99;
LABEL_59:
      LOBYTE(v12) = v10;
      LOBYTE(v11) = v9;
