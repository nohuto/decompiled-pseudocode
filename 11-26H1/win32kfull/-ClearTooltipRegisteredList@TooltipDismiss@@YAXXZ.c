/*
 * XREFs of ?ClearTooltipRegisteredList@TooltipDismiss@@YAXXZ @ 0x140295E50
 * Callers:
...
void __fastcall TooltipDismiss::ClearTooltipRegisteredList(TooltipDismiss *this, __int64 a2)
{
  ...
  v4 = *(_QWORD **)(W32GetUserSessionState(this, a2) + 71184);
  while ( v4 )
  {
    v5 = v4;
    v4 = (_QWORD *)v4[1];
  ...
  *(_QWORD *)(W32GetUserSessionState(v3, v2) + 71184) = 0LL;
}
