/*
 * XREFs of ?RescaleNonClientMetrics@@YAXPEAUtagNONCLIENTMETRICSW@@@Z @ 0x14028C294
 * Callers:
...
void __fastcall RescaleNonClientMetrics(struct tagNONCLIENTMETRICSW *a1)
{
  ...
  v5 = *(_QWORD *)(W32GetUserSessionState(v4, v3) + 19904);
