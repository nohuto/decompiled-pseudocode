/*
 * XREFs of _SetDoubleClickTime @ 0x1402461CC
 * Callers:
 *     xxxSystemParametersInfoWorker @ 0x1401CB418 (xxxSystemParametersInfoWorker.c)
 *     NtUserSetDoubleClickTime @ 0x1402BCAF0 (NtUserSetDoubleClickTime.c)
 * Callees:
...
__int64 __fastcall SetDoubleClickTime(unsigned int a1)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    *(_DWORD *)(W32GetUserSessionState(v4, v3) + 14712) = a1;
    ...
    *(_DWORD *)(v7 + 4980) = 4 * a1;
    ...
    v12 = *(_QWORD *)(W32GetUserSessionState(v9, v10) + 19904);
    result = 1LL;
    *(_DWORD *)(v12 + 4976) = v11;
  }
  return result;
