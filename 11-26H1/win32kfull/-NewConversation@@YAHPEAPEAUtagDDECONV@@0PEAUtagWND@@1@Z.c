/*
 * XREFs of ?NewConversation@@YAHPEAPEAUtagDDECONV@@0PEAUtagWND@@1@Z @ 0x1402CC930
 * Callers:
        ...
        struct tagWND *a4)
{
  ...
  v4 = a3;
  LOBYTE(a3) = 10;
  v8 = (struct tagDDECONV *)HMAllocObject(*((_QWORD *)v4 + 2), 0LL, a3, 96LL);
  if ( !v8 )
    return 0LL;
  LOBYTE(v9) = 10;
  v11 = (struct tagDDECONV *)HMAllocObject(*((_QWORD *)a4 + 2), 0LL, v9, 96LL);
  v12 = v11;
  if ( !v11 )
  {
    HMFreeObject(v8);
