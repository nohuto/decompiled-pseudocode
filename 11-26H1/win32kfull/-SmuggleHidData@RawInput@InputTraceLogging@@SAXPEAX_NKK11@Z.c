/*
 * XREFs of ?SmuggleHidData@RawInput@InputTraceLogging@@SAXPEAX_NKK11@Z @ 0x140262668
 * Callers:
        ...
        bool a6)
{
  ...
  if ( (unsigned int)dword_1403AA9C0 > 5 && tlgKeywordOn((__int64)&dword_1403AA9C0, 0x40000LL) )
  {
    v11 = "Posted";
    v13 = v8;
    if ( !a6 )
