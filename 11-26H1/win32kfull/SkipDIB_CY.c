/*
 * XREFs of SkipDIB_CY @ 0x1400F4320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SkipDIB_CY(__int128 *a1)
{
  ...
  void (__fastcall *v32)(__int64, __int64, __int64, __int64, int); // [rsp+178h] [rbp+70h]
  ...
  *((_QWORD *)v3 + 10) = v17;
  ...
  while ( v27 )
  {
    ...
    v19 = *v18++;
    while ( --v19 > 0 )
      GetFixupScan((unsigned int *)v25, 0LL);
    FixupScan = GetFixupScan((unsigned int *)v25, v47);
