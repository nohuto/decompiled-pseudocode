/*
 * XREFs of ?ValidateIFIMETRICS@@YA_NPEAU_IFIMETRICS@@@Z @ 0x1401C3600
 * Callers:
  ...
  if ( (_DWORD)dpFontSim )
  {
    ...
    if ( v19 )
    {
      if ( v19 < 0xC )
        return 0;
      v20 = dpFontSim + v19;
      if ( (unsigned int)dpFontSim + v19 < (unsigned int)dpFontSim || v20 + 20 < v20 || v20 + 20 > (unsigned int)cjThis )
        return 0;
    }
    ...
    if ( v21 )
    {
      if ( v21 < 0xC )
        return 0;
      v22 = dpFontSim + v21;
      if ( (unsigned int)dpFontSim + v21 < (unsigned int)dpFontSim || v22 + 20 < v22 || v22 + 20 > (unsigned int)cjThis )
        return 0;
    }
