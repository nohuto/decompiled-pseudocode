/*
 * XREFs of ??0ENUMAREAS@@QEAA@PEAU_SPRITESTATE@@PEAU_RECTL@@K1@Z @ 0x140169ED4
 * Callers:
        ...
        struct _RECTL *a5)
{
  ...
  *((_DWORD *)this + 4) = bottom;
  ...
  if ( (a4 & 1) != 0 )
  {
    for ( i = (LONG *)(v13 + *(_QWORD *)(v13 + 8) - 16LL); *i >= right; i -= 4 )
      ;
  }
  else
  {
  ...
  *((_QWORD *)this + 6) = v13;
  ...
  for ( j = *(_QWORD *)(*((_QWORD *)this + 11) + 1128LL); j; j = *(_QWORD *)(j + 24) )
  {
