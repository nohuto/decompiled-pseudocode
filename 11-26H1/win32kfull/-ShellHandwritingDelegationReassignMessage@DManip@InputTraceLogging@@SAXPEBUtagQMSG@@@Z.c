/*
 * XREFs of ?ShellHandwritingDelegationReassignMessage@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1401E97C4
 * Callers:
...
void __fastcall InputTraceLogging::DManip::ShellHandwritingDelegationReassignMessage(
