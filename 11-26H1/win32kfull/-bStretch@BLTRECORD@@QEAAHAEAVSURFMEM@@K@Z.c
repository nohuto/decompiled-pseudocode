/*
 * XREFs of ?bStretch@BLTRECORD@@QEAAHAEAVSURFMEM@@K@Z @ 0x14031E808
 * Callers:
 ...
 *     ?vMirror@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1401E07A4 (-vMirror@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
...
__int64 __fastcall BLTRECORD::bStretch(BLTRECORD *this, struct SURFMEM *a2, ULONG a3)
{
  ...
  *(_QWORD *)&prclDest.left = 0LL;
  ...
  SURFMEM::bCreateDIB(a2, (struct _DEVBITMAPINFO *)&v15, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0);
  if ( !*(_QWORD *)a2 )
    return 0LL;
  pptlHTOrg = 0LL;
