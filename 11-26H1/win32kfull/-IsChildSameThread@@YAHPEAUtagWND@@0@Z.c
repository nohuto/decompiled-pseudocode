/*
 * XREFs of ?IsChildSameThread@@YAHPEAUtagWND@@0@Z @ 0x1402A0DB8
 * Callers:
...
__int64 __fastcall IsChildSameThread(struct tagWND *a1, struct tagWND *a2)
{
  ...
  for ( i = (struct tagWND *)*((_QWORD *)a1 + 14); i; i = (struct tagWND *)*((_QWORD *)i + 11) )
  {
    if ( (*(_BYTE *)(*((_QWORD *)i + 5) + 31LL) & 0xC0) != 0x40 )
    {
      ...
      v7 = *v6;
      a1 = *(struct tagWND **)(W32GetUserSessionState(v6, a2) + 19904);
      if ( v7 == *((_WORD *)a1 + 453) )
        continue;
      while ( v5 )
      {
        ...
        if ( (v8[5] & 1) != 0 )
          goto LABEL_25;
        v9 = *v8;
        a1 = *(struct tagWND **)(W32GetUserSessionState(a1, a2) + 19904);
        if ( v9 == *((_WORD *)a1 + 449) )
          goto LABEL_25;
    ...
    if ( i != a2 && *((_QWORD *)i + 2) == v2 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (v13[5] & 1) != 0
          || (v14 = *v13, a1 = *(struct tagWND **)(W32GetUserSessionState(a1, a2) + 19904), v14 == *((_WORD *)a1 + 449)) )
        {
          v12 = 1;
        }
