/*
 * XREFs of ?MulUpdateColors@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@@Z @ 0x140328CE8
 * Callers:
...
__int64 __fastcall MulUpdateColors(struct _SURFOBJ *a1, struct _CLIPOBJ *a2, struct _XLATEOBJ *a3)
{
  ...
  if ( *(_QWORD *)dhpdev )
  {
    ...
    {
      v9 = v8[6];
      if ( (*(_DWORD *)(v9 + 2156) & 0x100) != 0 && bIntersect(&v18, (const struct _RECTL *)((char *)v8 + 28), &v17) )
      {
        v10 = v17;
        a2->rclBounds = v17;
        v11 = *(_QWORD *)(v9 + 2544);
        ...
        if ( v13 )
          ...
          v14 = *(int (**)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(v9 + 2832);
        v7 &= OffCopyBitsInternal(v14, (struct _POINTL *)v8 + 9, v12, (struct _POINTL *)v8 + 9, v12, a2, a3, &v17, &v16);
      }
      v8 = (__int64 *)*v8;
    }
    while ( v8 );
