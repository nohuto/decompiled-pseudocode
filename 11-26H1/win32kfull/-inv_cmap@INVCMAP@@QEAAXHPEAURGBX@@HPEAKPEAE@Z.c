/*
 * XREFs of ?inv_cmap@INVCMAP@@QEAAXHPEAURGBX@@HPEAKPEAE@Z @ 0x1401578F8
 * Callers:
 *     ?inv_cmap@@YAXHPEAURGBX@@HPEAKPEAE@Z @ 0x140157898 (-inv_cmap@@YAXHPEAURGBX@@HPEAKPEAE@Z.c)
 * Callees:
 *     ?redloop@INVCMAP@@QEAAHXZ @ 0x140157A94 (-redloop@INVCMAP@@QEAAHXZ.c)
        ...
        unsigned __int8 *a6)
{
  ...
  *((_DWORD *)this + 25) = 1024;
  ...
  v9 = 0;
  for ( *((_DWORD *)this + 29) = 0; v9 < a2; v9 = *((_DWORD *)this + 29) )
  {
    v10 = *((_DWORD *)this + 26);
    ...
    *((_DWORD *)this + 2) = v13;
    v14 = v10 / -2 + *((unsigned __int8 *)a3 + 4 * v9) - v10 * v11;
    *((_DWORD *)this + 6) = v14;
