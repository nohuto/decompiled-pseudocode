/*
 * XREFs of ?SizeRect@@YAHPEAUMOVESIZEDATA@@KPEAUtagMONITOR@@PEAK@Z @ 0x14027B068
 * Callers:
...
__int64 __fastcall SizeRect(struct MOVESIZEDATA *a1, __int64 a2, struct tagMONITOR *a3, unsigned int *a4)
{
  ...
  if ( (*((_DWORD *)a1 + 50) & 0x100) != 0 )
  {
    ...
    Prop = (struct CHECKPOINT *)GetProp(*((_QWORD *)a1 + 2), *(unsigned __int16 *)(v16 + 41374), 1u);
    if ( !Prop )
      return 0LL;
    *(_QWORD *)((char *)a1 + 252) = v37;
  }
  v18 = dword_140369BE0[*((int *)a1 + 44)];
  if ( (int)v18 >= 0 )
  {
    *((_DWORD *)a1 + v18 + 10) = v4;
    v19 = v18;
...
LABEL_29:
  ...
  v27 = *((int *)a1 + 44);
  v28 = dword_140369BB0[v27];
  if ( (int)v28 >= 0 )
  {
    v29 = (__int16)v6;
    v30 = dword_140369BB0[v27];
