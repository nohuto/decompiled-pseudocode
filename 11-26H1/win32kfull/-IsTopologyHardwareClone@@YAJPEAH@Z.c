/*
 * XREFs of ?IsTopologyHardwareClone@@YAJPEAH@Z @ 0x14024C9E4
 * Callers:
 *     ?CacheRotationInfo@CRotationMgr@@UEAAXXZ @ 0x14024C980 (-CacheRotationInfo@CRotationMgr@@UEAAXXZ.c)
 * Callees:
...
__int64 __fastcall IsTopologyHardwareClone(int *a1)
{
  ...
  v2 = 0;
  *a1 = 0;
  result = ((__int64 (__fastcall *)(__int64, int *, _BYTE *, _QWORD))DrvQueryDisplayConfig)(3221225474LL, v5, v6, 0LL);
  if ( (int)result >= 0 )
  {
    if ( v5[0] )
    {
