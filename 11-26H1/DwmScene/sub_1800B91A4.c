/*
 * XREFs of sub_1800B91A4 @ 0x1800B91A4
 * Callers:
...
__int64 __fastcall sub_1800B91A4(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rdx
  ...
  v7 = 0LL;
  v5[0] = &std::_Func_impl_no_alloc<_lambda_8063c925c9079455a8b5523fef35cede_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v5[7] = v5;
