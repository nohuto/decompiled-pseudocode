/*
 * XREFs of sub_1800D668C @ 0x1800D668C
 * Callers:
...
__int64 __fastcall sub_1800D668C(
        __int64 *a1,
        unsigned int a2,
        __int64 *a3,
        unsigned int a4,
        ...
        _QWORD *a9)
{
  ...
  v11 = a2;
  if ( (unsigned __int8)sub_1800D79B0(a2, "ComputeNormals") )
  {
    *(_QWORD *)&v28 = v11;
    ...
    *(_OWORD *)v30 = 0LL;
    ...
    try
    {
      ...
      if ( a5 )
      {
        ...
        {
          sub_1800D7840(a4, a6);
          sub_1800D5780(v21, v11, *a3, a4, a6, a9, (__int64)v30[0]);
        }
        else
        {
          sub_1800D78F8((unsigned int)v11, a6);
          sub_1800D61D8(v21, v11, a6, a9, (__int64)v30[0]);
        }
      }
      else
      {
        sub_1800D7840(a4, a6);
        sub_1800D55F0(v21, v11, *a3, a4, a6, a9, (__int64)v30[0]);
      }
    }
    ...
    {
      sub_1800148EC((__int64)v29 + 16);
      sub_18001DCFC(&qword_1801BD648, 3);
      v28 = 0LL;
      sub_1800D612C(a7, (__int64)&v28);
      if ( *((_QWORD *)&v28 + 1) )
...
LABEL_31:
    ...
    if ( (_DWORD)v11 )
    {
      ...
      do
      {
        sub_18003C524((unsigned __int64 *)((char *)v30[0] + v22));
        v22 = v23 + 12;
      }
      while ( v24 != 1 );
    }
    v13 = a7;
    result = sub_1800D612C(a7, (__int64)v30);
    v16 = v30[1];
  }
  else
  {
    v28 = 0LL;
    v13 = a7;
    result = sub_1800D612C(a7, (__int64)&v28);
