/*
 * XREFs of sub_180022350 @ 0x180022350
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180022350(__int64 a1, int a2, void *a3)
{
  char result; // al
  ...
  if ( (unsigned int)dword_1801BD1C0 > 5 )
  {
    ...
    if ( result )
    {
      ...
      return sub_180001918(v8, byte_1801A17A1, v9, v10, (void **)&v15, (__int64)&v12, &v14, (__int64)&v11, &v13);
    }
  }
  return result;
}
