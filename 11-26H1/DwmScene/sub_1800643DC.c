/*
 * XREFs of sub_1800643DC @ 0x1800643DC
 * Callers:
...
__int64 __fastcall sub_1800643DC(__int64 a1)
{
  __int64 v2; // rcx
  ...
  sub_180033D14(a1, 1);
  v7 = 0LL;
  v6[0] = &std::_Func_impl_no_alloc<_lambda_718c83fccd190710b454871d75af9a8f_,void,std::wstring const &>::`vftable';
