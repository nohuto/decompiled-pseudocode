/*
 * XREFs of sub_180038ECC @ 0x180038ECC
 * Callers:
...
__int64 __fastcall sub_180038ECC(__int64 a1, const __m128i *a2)
{
  __int64 v2; // r8
  __m128 v3; // xmm2
  __int64 result; // rax
  ...
  result = (unsigned int)_mm_movemask_ps(_mm_cmpneq_ps(v3, *(__m128 *)(v2 + 14516)));
  if ( (_DWORD)result )
  {
