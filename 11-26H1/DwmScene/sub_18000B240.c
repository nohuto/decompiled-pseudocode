...
const __m128i *__fastcall sub_18000B240(const __m128i *a1, const __m128i *a2, unsigned __int64 _R8)
{
  ...
  v4 = (char *)a2 - (char *)a1;
  if ( (((char *)a2 - (char *)a1) & 0xFFFFFFFFFFFFFFE0uLL) != 0 && (dword_1801C7B44 & 0x20) != 0 )
  {
    __asm
    {
      vmovq   xmm3, r8
...
LABEL_9:
    ...
    _RAX = (char *)&unk_1800F9BE0 - (v11 & 0xFFFFFFFC);
    __asm
    {
