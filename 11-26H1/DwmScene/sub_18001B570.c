/*
 * XREFs of sub_18001B570 @ 0x18001B570
 * Callers:
...
__m128 __fastcall sub_18001B570(__m128 *a1, double a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm9
  __m128 v6; // xmm13
  ...
  v16 = _mm_sub_ps(
          _mm_mul_ps(_mm_shuffle_ps(_mm_shuffle_ps(v14, v15, 93), v14, 50), _mm_shuffle_ps(v12, v12, 73)),
          _mm_mul_ps(_mm_shuffle_ps(v14, _mm_shuffle_ps(v14, v15, 4), 147), _mm_shuffle_ps(v12, v12, 158)));
  v17 = _mm_shuffle_ps(v14, v15, 74);
  v18 = _mm_mul_ps(_mm_shuffle_ps(v17, v17, 44), _mm_shuffle_ps(v12, v12, 51));
  v19 = _mm_shuffle_ps(_mm_add_ps(v18, v16), _mm_sub_ps(v16, v18), 216);
  ...
  if ( a1 )
    *a1 = v24;
  return _mm_mul_ps(_mm_div_ps((__m128)xmmword_1800FA310, v24), v20);
}
