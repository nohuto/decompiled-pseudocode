/*
 * XREFs of sub_1800CAA90 @ 0x1800CAA90
 * Callers:
...
__int64 __fastcall sub_1800CAA90(__int64 a1, __int128 *a2)
{
  __int128 v2; // xmm0
  __int128 v4; // xmm1
  __int64 v5; // rdx
  ...
  v10 = v4;
  v14 = 0LL;
  sub_180027428((__int64)v13, (__int64)&v8);
  sub_180027428((__int64)&v8, a1);
  sub_180027428(a1, (__int64)v13);
  sub_180013494((__int64)v13, v5);
  sub_180013494((__int64)&v8, v6);
  return a1;
}
