/*
 * XREFs of sub_180083594 @ 0x180083594
 * Callers:
 *     sub_180084020 @ 0x180084020 (sub_180084020.c)
 * Callees:
...
_QWORD *__fastcall sub_180083594(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  __int64 v8; // rax
  __int64 v9; // rcx
