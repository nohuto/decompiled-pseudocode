/*
 * XREFs of sub_180096A70 @ 0x180096A70
 * Callers:
...
__int64 __fastcall sub_180096A70(__int64 a1, __int64 a2)
{
  char v4; // cl
  unsigned int v5; // esi
  _QWORD *v6; // rdi
  ...
  do
  {
    ...
    {
      sub_180013540((__int64 *)(16LL * v5 + a1 + 136), (_QWORD *)(16LL * v5 + a1 + 8));
      v4 = 1;
    }
    ++v5;
    v6 += 2;
  ...
  {
    sub_180013540((__int64 *)(a1 + 408), v7);
LABEL_11:
