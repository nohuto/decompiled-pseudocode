/*
 * XREFs of sub_1800B94B0 @ 0x1800B94B0
 * Callers:
...
__int64 __fastcall sub_1800B94B0(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rdx
  ...
  v7 = 0LL;
  v5[0] = &std::_Func_impl_no_alloc<_lambda_d7f4d8d432685ceaae68a7b31eb4d631_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v5[7] = v5;
