/*
 * XREFs of sub_1800D40A8 @ 0x1800D40A8
 * Callers:
...
__int64 __fastcall sub_1800D40A8(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // r14
  _QWORD *v7; // rsi
  __int64 v8; // rcx
  ...
  {
    sub_1800D3994((__int64)a1);
    v14 = a3;
    v11 = a1 + 1;
    v7 = (_QWORD *)sub_180011790(0xB0uLL);
    v12 = v7;
    sub_1800D2620(v8, v7 + 2, v9, &v14);
