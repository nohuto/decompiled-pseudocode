/*
 * XREFs of sub_1800C56C0 @ 0x1800C56C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800C56C0(__int64 a1, _QWORD *a2, __int64 a3)
{
  __int64 *v5; // rax
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  v5 = (__int64 *)sub_1800C5D7C(*a2, v11, *(unsigned int *)(a1 + 88));
  sub_1800160E4(&v9, (__int64)v5, *v5);
  v7 = *(_QWORD *)(v6 + 8);
  if ( v7 )
    sub_180010EC8(v7);
  sub_1800C2504(v9, &v12);
