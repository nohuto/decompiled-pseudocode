/*
 * XREFs of sub_1800D78F8 @ 0x1800D78F8
 * Callers:
...
__int64 __fastcall sub_1800D78F8(unsigned int a1, int a2)
{
  __int64 result; // rax
  ...
  if ( a2 )
  {
    if ( a2 == 1 && a1 < 3 )
    {
      sub_180011CC4(v3, "Number of vertices is less than three");
  ...
  else
  {
    ...
    if ( a1 != (_DWORD)result )
    {
      sub_180011CC4(v3, "Number of vertices is not a multiple of three");
      sub_1800D60D8(pExceptionObject, (__int64)v3);
      throw (Spectre::Framework::GeometryProcessingException *)pExceptionObject;
    }
  }
