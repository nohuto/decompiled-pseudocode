/*
 * XREFs of sub_18003D5B8 @ 0x18003D5B8
 * Callers:
...
__int64 __fastcall sub_18003D5B8(__int64 a1)
{
  __int64 v1; // r9
  __m128 v2; // xmm4
  __m128 v3; // xmm3
  ...
  sub_18003B444((__int64)v24, (unsigned __int64 *)(a1 + 144));
  v2 = *(__m128 *)(v1 + 156);
  v3 = _mm_add_ps(v2, v2);
  v4 = _mm_mul_ps(v3, v2);
  v5 = _mm_mul_ps(_mm_shuffle_ps(v3, v3, 230), _mm_shuffle_ps(v2, v2, 208));
  v6 = _mm_sub_ps(
         _mm_sub_ps((__m128)xmmword_1800FC260, _mm_and_ps(_mm_shuffle_ps(v4, v4, 193), (__m128)xmmword_1800FA2A0)),
         _mm_and_ps(_mm_shuffle_ps(v4, v4, 218), (__m128)xmmword_1800FA2A0));
  v7 = _mm_mul_ps(_mm_shuffle_ps(v2, v2, 255), _mm_shuffle_ps(v3, v3, 201));
  v8 = _mm_add_ps(v7, v5);
  v9 = _mm_sub_ps(v5, v7);
  ...
  v22[3] = xmmword_1800FA2E0;
  sub_18003B3D4((__int64)v23, (unsigned int *)(v1 + 172));
  v15 = sub_18001896C((__int64)v25, v23, v22);
  v16 = sub_18001896C((__int64)v26, v15, v24);
  v17 = v16[2];
  v18 = v16[3];
  v19 = *v16;
