/*
 * XREFs of sub_18003B444 @ 0x18003B444
 * Callers:
...
__int64 __fastcall sub_18003B444(__int64 a1, unsigned __int64 *a2)
{
  __int64 result; // rax
  __m128 v3; // xmm2
  __m128 v4; // xmm3
  ...
  *(_DWORD *)(a1 + 60) = 1065353216;
  ...
  v4 = (__m128)*a2;
  *(_OWORD *)a1 = xmmword_1800FA180;
  *(_OWORD *)(a1 + 16) = xmmword_1800FA110;
  *(_OWORD *)(a1 + 32) = xmmword_1800FA1B0;
