/*
 * XREFs of sub_18008A780 @ 0x18008A780
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_18008A780(__int64 a1, _OWORD *a2, __int64 a3, _QWORD *a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  _QWORD *v10; // rax
