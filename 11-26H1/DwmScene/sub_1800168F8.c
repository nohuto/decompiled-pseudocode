/*
 * XREFs of sub_1800168F8 @ 0x1800168F8
 * Callers:
...
_QWORD *__fastcall sub_1800168F8(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rax
  _QWORD *v9; // rax
  __int64 v10; // r10
  ...
  v8 = sub_18001C514(4136LL);
  if ( v8 )
  {
    v9 = sub_180012C40(&v15, (_QWORD *)(a1 + 464));
    v8 = sub_180050B20(v10, a1, v9);
  }
  sub_1800161F4(v14, v8);
  v11 = v14[0];
  sub_180029C10(v14[0] + 24LL, v17);
  sub_180026AA0(v11, a3, a4);
