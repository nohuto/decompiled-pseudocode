/*
 * XREFs of sub_18000D4CC @ 0x18000D4CC
 * Callers:
...
__int64 __fastcall sub_18000D4CC(_DWORD *a1)
{
  __int64 v2; // rdx
  ...
  *a1 = ++dword_1801C7BD0;
  *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + v2) + 16LL) = dword_1801C7BD0;
