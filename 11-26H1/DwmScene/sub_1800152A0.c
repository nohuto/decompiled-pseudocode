...
__int64 __fastcall sub_1800152A0(__int64 a1, __int64 a2)
{
  __int64 v3; // rax
  __int64 v4; // rcx
  __int128 *v5; // rax
  ...
  try
  {
    ...
    sub_180012C40(&v10, (_QWORD *)(v3 + 32));
    v4 = *(_QWORD *)sub_18001367C(v10, &v12) + 16LL;
    sub_180029C50(v4, v18);
    if ( *((_QWORD *)&v12 + 1) )
      sub_180010EC8(*((__int64 *)&v12 + 1));
    sub_180014ED4(v10, &v13);
    if ( a2 )
    {
      v5 = (__int128 *)sub_180012C40(&v16, (_QWORD *)(a2 + 16));
      v6 = 1;
    }
    else
    {
