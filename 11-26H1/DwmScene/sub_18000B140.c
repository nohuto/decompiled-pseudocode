/*
 * XREFs of sub_18000B140 @ 0x18000B140
 * Callers:
...
const __m128i *__fastcall sub_18000B140(const __m128i *a1, const __m128i *a2, __int16 a3)
{
...
LABEL_9:
    ...
    _RAX = (char *)&unk_1800F9BE0 - (v15 & 0xFFFFFFFC);
    __asm
    {
