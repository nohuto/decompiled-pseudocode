/*
 * XREFs of sub_180050564 @ 0x180050564
 * Callers:
...
__int64 __fastcall sub_180050564(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rdx
  ...
  v7 = 0LL;
  v5[0] = &std::_Func_impl_no_alloc<_lambda_76eddb9b03c24eac3632c1cece1b494c_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v5[7] = v5;
