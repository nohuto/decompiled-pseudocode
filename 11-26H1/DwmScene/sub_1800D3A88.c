/*
 * XREFs of sub_1800D3A88 @ 0x1800D3A88
 * Callers:
...
unsigned __int64 __fastcall sub_1800D3A88(_QWORD *a1, unsigned __int64 a2)
{
  _QWORD *v2; // rsi
  ...
  sub_180041860((__int64)(v2 + 3), 2 * v7, v4);
  v2[7] = v7;
  v2[6] = v7 - 1;
  v8 = *(_QWORD **)v2[1];
  v9 = v8;
