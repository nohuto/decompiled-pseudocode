/*
 * XREFs of sub_1800C195C @ 0x1800C195C
 * Callers:
...
_QWORD *__fastcall sub_1800C195C(_QWORD *a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  _QWORD *v4; // rdi
  __int64 v6; // r10
  __int64 v10; // r10
  ...
  {
    sub_1800BEF34((__int64)a1, (__int64)a1, v4[1]);
    v4[1] = v4;
    *v4 = v4;
    v4[2] = v4;
    a1[1] = 0LL;
