/*
 * XREFs of sub_1800B8CC4 @ 0x1800B8CC4
 * Callers:
...
__int64 __fastcall sub_1800B8CC4(__int64 a1)
{
  __int64 v2; // rdx
  __int64 v3; // rdx
  ...
  v7 = 0LL;
  v5[0] = &std::_Func_impl_no_alloc<_lambda_1bf4f65eb3aa0df8ad84d0734f8c2df8_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v5[7] = v5;
