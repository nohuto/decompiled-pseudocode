/*
 * XREFs of sub_180023BE0 @ 0x180023BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180023BE0(__int64 a1, __int64 *a2, void *a3)
{
  ...
  if ( (unsigned int)dword_1801BD1C0 > 5 && sub_180001530((__int64)&dword_1801BD1C0, 0x400000000000LL) )
  {
    ...
    sub_180001B4C(v8, byte_1801A1641, v9, v10, (void **)&v17, (__int64)&v13, &v16, &v15, &v14);
  }
