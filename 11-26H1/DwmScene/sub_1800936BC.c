/*
 * XREFs of sub_1800936BC @ 0x1800936BC
 * Callers:
 *     sub_1800907C0 @ 0x1800907C0 (sub_1800907C0.c)
 * Callees:
 *     sub_18006F430 @ 0x18006F430 (sub_18006F430.c)
 *     sub_180093380 @ 0x180093380 (sub_180093380.c)
 */

__int64 __fastcall sub_1800936BC(_QWORD *a1, __int64 a2, __int64 a3)
{
  _QWORD *v6; // r12
  __int64 v7; // rsi
  _QWORD *v8; // r15
