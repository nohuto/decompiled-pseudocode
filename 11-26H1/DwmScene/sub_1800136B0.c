/*
 * XREFs of sub_1800136B0 @ 0x1800136B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800136B0(__int64 a1, _OWORD *a2)
{
  _QWORD *v4; // rax
  __int128 v5; // xmm1
  __int128 v6; // xmm2
  ...
  v4 = (_QWORD *)sub_18001367C(*(_QWORD *)(a1 + 16), &v9);
  sub_180029C50(*v4 + 16LL, v11);
  if ( v10 )
    sub_180010EC8(v10);
  sub_18003BCCC(*(_QWORD *)(a1 + 16), v12);
  v5 = v12[1];
  v6 = v12[2];
  v7 = v12[3];
  *a2 = v12[0];
