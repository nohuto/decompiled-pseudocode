/*
 * XREFs of sub_180087FE0 @ 0x180087FE0
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_180087FE0(__int64 a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  _QWORD *v10; // rax
