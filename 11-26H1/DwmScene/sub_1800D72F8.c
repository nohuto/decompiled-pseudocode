/*
 * XREFs of sub_1800D72F8 @ 0x1800D72F8
 * Callers:
...
__int64 __fastcall sub_1800D72F8(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        unsigned int a4,
        ...
        __int64 a8)
{
  ...
  v10 = (__m128)*(unsigned int *)(a2 + 8LL * a5 + 4);
  result = a3;
  v9 = a4;
  v10.m128_f32[0] = v10.m128_f32[0] - *(float *)(a2 + 8 * result + 4);
  v11 = *(float *)(a2 + 8LL * a4 + 4);
  v12 = 3 * result;
  v13 = 3LL * a4;
  v15 = (__m128)*(unsigned int *)(a2 + 8 * v9);
  v14 = v11 - *(float *)(a2 + 8 * result + 4);
  v15.m128_f32[0] = v15.m128_f32[0] - *(float *)(a2 + 8 * result);
  v16 = *(float *)(a2 + 8LL * a5) - *(float *)(a2 + 8 * result);
  v17 = *(float *)(a1 + 4 * v13 + 8) - *(float *)(a1 + 12 * result + 8);
  v18 = *(float *)(a1 + 12LL * a5 + 8) - *(float *)(a1 + 12 * result + 8);
  v43 = *(_QWORD *)(a1 + 12 * result);
  *(_QWORD *)v45 = *(_QWORD *)(a1 + 4 * v13);
  v19 = v45[0] - *(float *)&v43;
  v20 = v45[1] - *((float *)&v43 + 1);
  v46 = *(_QWORD *)(a1 + 12LL * a5);
  v21 = *(float *)&v46 - *(float *)&v43;
  v22 = *((float *)&v46 + 1) - *((float *)&v43 + 1);
  v23 = (float)(v10.m128_f32[0] * v15.m128_f32[0]) - (float)(v14 * v16);
  if ( v23 != 0.0 )
  {
    v28 = v10;
    v24 = 1.0 / v23;
    v26 = v10;
    v28.m128_f32[0] = v10.m128_f32[0] * v20;
    v26.m128_f32[0] = (float)(v10.m128_f32[0] * v19) - (float)(v14 * v21);
    v25 = (float)(v10.m128_f32[0] * v17) - (float)(v14 * v18);
    ...
    v35 = _mm_add_ps(
            ...
            v34);
    *(_QWORD *)(a7 + 4 * v12) = v35.m128_u64[0];
    *(_DWORD *)(a7 + 4 * v12 + 8) = _mm_shuffle_ps(v35, v35, 170).m128_u32[0];
    v36 = _mm_add_ps(
            _mm_movelh_ps((__m128)*(unsigned __int64 *)(a7 + 4 * v13), (__m128)*(unsigned int *)(a7 + 4 * v13 + 8)),
            v34);
    *(_QWORD *)(a7 + 4 * v13) = v36.m128_u64[0];
    *(_DWORD *)(a7 + 4 * v13 + 8) = _mm_shuffle_ps(v36, v36, 170).m128_u32[0];
    v37 = _mm_add_ps(
    ...
    *(_DWORD *)(a7 + 12LL * a5 + 8) = _mm_shuffle_ps(v37, v37, 170).m128_u32[0];
    result = a8;
    v40 = _mm_add_ps(
            _mm_movelh_ps((__m128)*(unsigned __int64 *)(a8 + 4 * v12), (__m128)*(unsigned int *)(a8 + 4 * v12 + 8)),
            v39);
    *(_QWORD *)(a8 + 4 * v12) = v40.m128_u64[0];
    *(_DWORD *)(a8 + 4 * v12 + 8) = _mm_shuffle_ps(v40, v40, 170).m128_u32[0];
    v41 = _mm_add_ps(
            _mm_movelh_ps(
              (__m128)*(unsigned __int64 *)(result + 4 * v13),
              (__m128)*(unsigned int *)(result + 4 * v13 + 8)),
            v39);
    *(_QWORD *)(a8 + 4 * v13) = v41.m128_u64[0];
    *(_DWORD *)(a8 + 4 * v13 + 8) = _mm_shuffle_ps(v41, v41, 170).m128_u32[0];
    v42 = _mm_add_ps(
