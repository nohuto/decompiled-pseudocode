/*
 * XREFs of sub_18000CBFC @ 0x18000CBFC
 * Callers:
 *     __report_gsfailure @ 0x18000CB20 (__report_gsfailure.c)
 * Callees:
 *     <none>
 */

struct _IMAGE_RUNTIME_FUNCTION_ENTRY *__fastcall sub_18000CBFC(PCONTEXT ContextRecord)
{
  ULONG64 Rip; // rsi
  int i; // edi
