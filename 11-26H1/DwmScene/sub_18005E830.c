/*
 * XREFs of sub_18005E830 @ 0x18005E830
 * Callers:
...
_QWORD *__fastcall sub_18005E830(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
  ...
  sub_18003D758(a1);
  v4 = *(_QWORD *)sub_18005F5F4(a1, &v10);
  if ( v11 )
    sub_180010EC8(v11);
  if ( v4 )
  {
