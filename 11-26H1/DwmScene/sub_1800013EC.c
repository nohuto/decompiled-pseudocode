/*
 * XREFs of sub_1800013EC @ 0x1800013EC
 * Callers:
...
__int64 __fastcall sub_1800013EC(_QWORD *CallbackContext)
{
  _QWORD *v1; // rsi
  bool v2; // zf
  signed int v4; // eax
  ...
  v4 = EventRegister(&ProviderId, EnableCallback, CallbackContext, CallbackContext + 4);
  v5 = v4;
  if ( v4 )
  {
    if ( v4 > 0 )
