/*
 * XREFs of sub_1800D5780 @ 0x1800D5780
 * Callers:
...
__int64 __fastcall sub_1800D5780(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  int v9; // r11d
  _QWORD *v10; // r9
  ...
  while ( (unsigned int)v13 < v16 )
  {
    ...
    {
      sub_180011CC4(v24, "Index out of range while computing normals");
      sub_1800D60D8(pExceptionObject, v24);
    ...
    v20 = v11 && (v13 & 1) != 0;
    result = sub_1800D64F4(v9, v17, v18, v19, v20, a7);
