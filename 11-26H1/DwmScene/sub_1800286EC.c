/*
 * XREFs of sub_1800286EC @ 0x1800286EC
 * Callers:
...
__int64 __fastcall sub_1800286EC(__int64 *a1, __int64 *a2)
{
  __int64 v2; // r10
  __int64 v4; // rbx
  __int64 v5; // rax
  ...
  {
    sub_1800276EC((__int64)a1, (__int64)a1, *(__int64 **)(v7 + 8));
    *(_QWORD *)(v7 + 8) = v7;
    *(_QWORD *)v7 = v7;
    *(_QWORD *)(v7 + 16) = v7;
    a1[1] = 0LL;
  ...
  else
  {
    while ( v2 != v4 )
    {
      ...
      v12 = (_QWORD *)sub_1800287AC(a1, v11);
