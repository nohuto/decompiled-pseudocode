/*
 * XREFs of sub_1800BBFC0 @ 0x1800BBFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800BBFC0(__int64 a1, unsigned int *a2, _DWORD *a3)
{
  __int64 result; // rax
  int v7; // r9d
  unsigned int v8; // ebx
  ...
  *a3 = 0;
  ...
  if ( v7 != 1 )
  {
    ...
    {
      v13 = 0;
      v11 = (_QWORD *)sub_1800BC108(a1, &v14);
