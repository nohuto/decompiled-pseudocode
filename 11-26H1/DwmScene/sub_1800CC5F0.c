/*
 * XREFs of sub_1800CC5F0 @ 0x1800CC5F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800CC5F0(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // r8
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    sub_180011CC4(&v20, "GeometryShaderD3D11::Load() -- this function can only be called once per shader instance");
    v4 = sub_180011CC4(
           &v18,
  ...
  if ( !sub_18004F174((__int64)a2) )
  {
    ...
    if ( v10 < 0 )
    {
      sub_18001DCFC(&qword_1801BD588, 5);
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
