/*
 * XREFs of sub_18004CBA4 @ 0x18004CBA4
 * Callers:
...
_QWORD *__fastcall sub_18004CBA4(_QWORD *a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  __int64 v8; // rax
  __int64 v9; // rbx
  _QWORD *v10; // rax
