/*
 * XREFs of sub_18008AA30 @ 0x18008AA30
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_18008AA30(__int64 a1, __int64 a2)
{
  __int64 v4; // rdx
  bool result; // al

  result = 0;
  if ( sub_180058C70(a1, a2) )
  {
    v4 = _RTDynamicCast(
           a2,
           0LL,
    ...
    if ( (_mm_movemask_ps(
            _mm_cmpeq_ps(
              _mm_movelh_ps((__m128)*(unsigned __int64 *)(a1 + 1800), (__m128)*(unsigned int *)(a1 + 1808)),
              _mm_movelh_ps((__m128)*(unsigned __int64 *)(v4 + 1800), (__m128)*(unsigned int *)(v4 + 1808)))) & 7) == 7
