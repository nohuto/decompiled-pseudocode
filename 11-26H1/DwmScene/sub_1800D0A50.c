/*
 * XREFs of sub_1800D0A50 @ 0x1800D0A50
 * Callers:
 *     sub_1800D3740 @ 0x1800D3740 (sub_1800D3740.c)
 * Callees:
...
__int64 __fastcall sub_1800D0A50(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( (unsigned __int8)sub_1800D4380(v9, v10) )
  {
    ...
    else
    {
      ...
      v13 = (_DWORD *)sub_1800D4270(v9, v12);
      v14 = (__int64)v13;
      if ( *v13 == 5 )
      {
        ...
        if ( (unsigned __int8)sub_1800D4380(v14, v16)
          && (v17 = sub_180013440(v22, (__int64)v24), v18 = (_DWORD *)sub_1800D4270(v14, v17), *v18 == 1) )
        {
          if ( v18[10] != a3 )
          {
            v19 = sub_180013440(v22, (__int64)v24);
            sub_1800D09C0(v14, (__int64)v19, a3);
            v11 = 1;
          }
        }
        else
      ...
      else if ( *v13 == 1 )
      {
        if ( v13[10] != a3 )
        {
          ...
          sub_1800D09C0(v9, (__int64)v15, a3);
          v11 = 1;
        }
      }
      else
  ...
  else if ( (unsigned int)(a4 - 1) <= 1 )
  {
    ...
    sub_1800D09C0(v9, (__int64)v20, a3);
    v11 = 0;
  }
  else
  {
