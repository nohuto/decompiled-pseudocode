/*
 * XREFs of sub_18003FE98 @ 0x18003FE98
 * Callers:
...
void __fastcall sub_18003FE98(__int64 a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm5
  __m128 v4; // xmm6
  __m128 v5; // xmm4
  ...
  v9 = _mm_mul_ps(_mm_sub_ps(v8, v7), (__m128)xmmword_1801915F0);
  v10 = _mm_mul_ps(_mm_add_ps(v8, v7), (__m128)xmmword_1801915F0);
