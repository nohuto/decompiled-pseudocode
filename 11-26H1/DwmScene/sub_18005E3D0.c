/*
 * XREFs of sub_18005E3D0 @ 0x18005E3D0
 * Callers:
...
__int64 __fastcall sub_18005E3D0(__int64 *a1, __int64 *a2)
{
  __int64 v2; // r10
  __int64 v4; // rbx
  __int64 v5; // rax
  ...
  {
    sub_18005C418((__int64)a1, (__int64)a1, *(__int64 **)(v7 + 8));
    *(_QWORD *)(v7 + 8) = v7;
    *(_QWORD *)v7 = v7;
    *(_QWORD *)(v7 + 16) = v7;
    a1[1] = 0LL;
