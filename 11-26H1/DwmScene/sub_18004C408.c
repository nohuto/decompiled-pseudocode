/*
 * XREFs of sub_18004C408 @ 0x18004C408
 * Callers:
...
__int64 __fastcall sub_18004C408(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rbx
  __int64 v7; // rcx
  __int64 v8; // rbx
  ...
  else
  {
    ...
    v16 = *a1;
    *(_QWORD *)&v13 = a1;
    v8 = sub_180011790(0x50uLL);
    *((_QWORD *)&v13 + 1) = v8;
    sub_18004C794(v9, v8 + 32, v10, &v12);
