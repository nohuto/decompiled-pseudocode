/*
 * XREFs of sub_18007EE1C @ 0x18007EE1C
 * Callers:
...
_QWORD *__fastcall sub_18007EE1C(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  __int64 v6; // r9
  __int64 v7; // rdx
  _QWORD *v8; // rax
  ...
  {
    sub_180011CC4(v20, "ShaderPropertyBlock::SetTexture() -- Cannot set the value of an imported property");
    v16 = sub_180011CC4(
            v21,
            "onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine\\shader"
            "propertyblock.cpp");
  ...
  result = sub_180011F5C((_QWORD *)(*(_QWORD *)(a1 + 56) + 40LL * *(unsigned int *)(v12 + v13 + 40)), a3);
  v19 = a3[1];
  if ( v19 )
