/*
 * XREFs of sub_18002F858 @ 0x18002F858
 * Callers:
...
__int64 __fastcall sub_18002F858(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // r8
  __int64 v6; // rbx
  __int64 v7; // rcx
  ...
  if ( *(_BYTE *)(v13 + 25) || *(_QWORD *)(v5 + 8) < *(_QWORD *)(v13 + 40) )
  {
    ...
    v6 = sub_180011790(0x40uLL);
    sub_18002FB6C(v7, v6 + 32, v8, &v10);
