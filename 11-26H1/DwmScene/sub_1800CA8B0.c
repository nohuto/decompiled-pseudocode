...
char __fastcall sub_1800CA8B0(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // r8
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    sub_180011CC4(&v21, "PixelShaderD3D11::Load() -- this function can only be called once per shader instance");
    v4 = sub_180011CC4(
           &v19,
