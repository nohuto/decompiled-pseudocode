/*
 * XREFs of RegisterXsdDomain @ 0x140037AA4
 * Callers:
...
char __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1400155D8,
    0LL);
  for ( i = qword_140015628; (__int64 *)i != &qword_140015628; i = *(_QWORD *)i )
  {
    if ( *(_DWORD *)(i + 36) == v1[3] )
    {
      if ( v4 != *(_BYTE *)(i + 48) )
...
LABEL_19:
  ...
  if ( Pool2 )
  {
    ...
    v10[1] = v10;
    *v10 = v10;
    v11 = (__int64 *)qword_140015630;
    if ( *(__int64 **)qword_140015630 == &qword_140015628 )
    {
      *(_QWORD *)i = &qword_140015628;
      *(_QWORD *)(i + 8) = v11;
      *v11 = i;
      qword_140015630 = i;
      *(_DWORD *)(i + 36) = v1[3];
