/*
 * XREFs of WriteIoMemRawHidden @ 0x140003A60
 * Callers:
...
__int64 __fastcall WriteIoMemRawHidden(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  if ( *(_BYTE *)a2 == 1 )
  {
    ...
    return ((__int64 (__fastcall *)(__int64, _QWORD, __int64, _QWORD, unsigned int))qword_1400159C0)(
             a1,
             (unsigned __int16)v5,
             v8,
             v4,
  ...
  {
    return ((__int64 (__fastcall *)(__int64, _QWORD, __int64, _QWORD))qword_1400159B0)(a1, (unsigned int)v5, a3, a4);
  }
  return result;
}
