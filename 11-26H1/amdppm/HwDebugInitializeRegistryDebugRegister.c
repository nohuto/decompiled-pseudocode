/*
 * XREFs of HwDebugInitializeRegistryDebugRegister @ 0x14003A2E4
 * Callers:
...
LABEL_17:
      ...
      *(_QWORD *)a3 = v7;
      ...
      v8 = HIDWORD(v30[0]);
      if ( HIDWORD(v30[0]) && HIDWORD(v30[0]) <= 0xFF )
      {
        ...
        if ( (_DWORD)v8 )
        {
          do
          {
            v19 = HwDebugInitializeRegistryDebugParameter(KeyHandlea, v18, (__int64)&v6[2 * v17]);
            v20 = v17 + 1;
            if ( v19 < 0 )
              v20 = v17;
            ++v18;
