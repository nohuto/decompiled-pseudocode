/*
 * XREFs of ProcLibTraceBiosPStatesRundown @ 0x14003FFC4
 * Callers:
...
LABEL_9:
          ...
          v11 = 0;
          v35 = v9;
          for ( i = 0; v11 < v15; v1[v13 + 5] = *(_QWORD *)&v7[12 * v12 + 12] )
          {
            v12 = v11++;
            v13 = 6 * v12;
            LODWORD(v1[v13]) = v7[12 * v12 + 2];
            HIDWORD(v1[v13]) = v7[12 * v12 + 3];
            LODWORD(v1[v13 + 1]) = v7[12 * v12 + 4];
            HIDWORD(v1[v13 + 1]) = v7[12 * v12 + 5];
            v1[v13 + 2] = *(_QWORD *)&v7[12 * v12 + 6];
            v1[v13 + 3] = *(_QWORD *)&v7[12 * v12 + 8];
            v1[v13 + 4] = *(_QWORD *)&v7[12 * v12 + 10];
          }
        }
      }
      v18 = (char *)a1 + 188;
