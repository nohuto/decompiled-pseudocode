/*
 * XREFs of ProcLibTraceQueryCapabilities @ 0x140040A7C
 * Callers:
...
char __fastcall ProcLibTraceQueryCapabilities(__int64 a1, char a2)
{
  ...
  LOBYTE(ProcessorNumber) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, v3);
    ...
    if ( *(_QWORD *)(a1 + 1120) )
    {
      ...
      if ( ProcessorNumber >= 0 )
      {
        ...
        *(_QWORD *)&UserData.Size = 2LL;
        ...
        v21 = 4LL;
        v23 = 1LL;
        LOBYTE(ProcessorNumber) = EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, v3, 0LL, (ULONG)7, &UserData);
      }
    }
  }
