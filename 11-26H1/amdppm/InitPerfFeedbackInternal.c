/*
 * XREFs of InitPerfFeedbackInternal @ 0x140034294
 * Callers:
 *     RegisterKernelPerfFeedback @ 0x140036A40 (RegisterKernelPerfFeedback.c)
 *     RegisterHvPerfFeedbackCounters @ 0x14003E310 (RegisterHvPerfFeedbackCounters.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *))
{
  ...
  LODWORD(v23) = 0;
  v3(WdfDriverGlobals, qword_1400155D8, 0LL);
        ...
        (v4 = (_QWORD *)inited) != 0LL) )
  {
    ...
    *(_WORD *)(inited + 6) = 1;
    *(_BYTE *)(inited + 52) = 2;
    *(_BYTE *)(inited + 14) = byte_140015B78;
    *(_QWORD *)(inited + 456) = PerfSelectionFeedback;
    *(_QWORD *)(inited + 480) = AcpiCStateIdleComplete;
    ...
    if ( *v9 )
    {
      ...
      *(_WORD *)(v12 + 16) = 257;
      ...
      if ( !(unsigned int)EnumerateNextDevice((__int64 *)v21, &v24) )
      {
        ...
        {
          v16 = v24;
          InitCommonPerfStateContext(v24, (_QWORD *)v14 - 13, v15, 100, 0);
          a1[27] = v14 - 26;
          v14[116] = *v9;
