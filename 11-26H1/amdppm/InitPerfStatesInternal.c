/*
 * XREFs of InitPerfStatesInternal @ 0x1400345C8
 * Callers:
 *     RegisterKernelPerfStates @ 0x140036A60 (RegisterKernelPerfStates.c)
 *     RegisterHvPerfStatesCounters @ 0x14003E330 (RegisterHvPerfStatesCounters.c)
 * Callees:
 ...
 *     CalculatePercentageCap @ 0x140032468 (CalculatePercentageCap.c)
...
__int64 __fastcall InitPerfStatesInternal(__int64 a1, int (__fastcall *a2)(__int64))
{
    ...
    && (inited = AllocateAndInitKernelPerfStatesRegistration(a1, PerfDomain, 1)) != 0 )
  {
    ...
    *(_BYTE *)(inited + 52) = 0;
    v48 = v12;
    if ( dword_140015EF8 == 1 || v12 == 252 || (v13 = v12 == 1, v14 = PerfControlPTStatesHidden, v13) )
...
LABEL_28:
      ...
      *(_DWORD *)(v39 + 8) = v41;
      ...
      if ( !(unsigned int)EnumerateNextDevice((__int64 *)v53, &v49) )
      {
        ...
        {
          v45 = v49;
          v46 = CalculatePercentageCap((__int64)v7, *(_DWORD *)(v49 + 464), *(_DWORD *)(v49 + 512));
          InitCommonPerfStateContext(v45, v43 - 44, v44, v46, v46 < 0x64 ? 2 : 0);
