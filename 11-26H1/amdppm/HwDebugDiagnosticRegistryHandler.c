/*
 * XREFs of HwDebugDiagnosticRegistryHandler @ 0x14000C870
 * Callers:
 *     HwDebugRegistryHandlerWrapper @ 0x14000CB90 (HwDebugRegistryHandlerWrapper.c)
 * Callees:
...
__int64 HwDebugDiagnosticRegistryHandler()
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1400155F0,
    0LL);
  KeInitializeEnumerationContext(&v15, &unk_140015A18);
  for ( i = KeEnumerateNextProcessor(&v14, &v15); !i; i = KeEnumerateNextProcessor(&v14, &v15) )
  {
    v1 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Blink->Flink + v14);
    v2 = *(_QWORD *)(v1 + 216);
    if ( v2 )
    {
  ...
  while ( (__int64 *)qword_140015608 != &qword_140015608 )
  {
    v5 = P;
    if ( *(__int64 **)P != &qword_140015608 || (v6 = (PVOID *)*((_QWORD *)P + 1), *v6 != P) )
      __fastfail(3u);
    P = (PVOID)*((_QWORD *)P + 1);
    *v6 = &qword_140015608;
  ...
  if ( byte_140015F18 )
  {
    ...
    do
    {
      v8 = (PVOID *)qword_140015F20;
      v9 = 0;
      v10 = (char *)qword_140015F20 + 40 * v7;
      if ( v10[16] )
      {
        do
    ...
    while ( (unsigned int)v7 < (unsigned __int8)byte_140015F18 );
    ExFreePoolWithTag(qword_140015F20, (ULONG)1919119952);
    byte_140015F18 = 0;
  }
  ...
  {
    v11 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Blink->Flink + v14);
    v12 = *(_QWORD *)(v11 + 216);
    if ( v12 )
