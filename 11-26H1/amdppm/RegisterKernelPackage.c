/*
 * XREFs of RegisterKernelPackage @ 0x140035ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1400159C8)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_140015638;
  ...
  while ( (__int64 *)v4 != &qword_140015638 );
  if ( !v5 )
  {
LABEL_8:
    ...
    *(_DWORD *)(Pool2 + 32) = v3;
    v8 = ((__int64 (__fastcall *)(_QWORD))qword_1400159D0)(v3);
    *(_DWORD *)(v5 + 36) = v8;
    ...
    *(_QWORD *)(v5 + 320) = v5 + 320;
    v9 = (__int64 *)qword_140015640;
    if ( *(__int64 **)qword_140015640 != &qword_140015638 )
LABEL_17:
      __fastfail(3u);
    *(_QWORD *)v5 = &qword_140015638;
    *(_QWORD *)(v5 + 8) = v9;
    *v9 = v5;
    qword_140015640 = v5;
  }
