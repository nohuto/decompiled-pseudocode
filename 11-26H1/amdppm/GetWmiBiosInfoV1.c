/*
 * XREFs of GetWmiBiosInfoV1 @ 0x140008740
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  ...
  *(_DWORD *)(a3 + 16) = *(_DWORD *)(v10 + 56);
  do
  {
    v14 = *((unsigned __int8 *)v11 + v13++ + 424);
    *v12++ = v14;
  }
  while ( v13 < 4 );
  v15 = (_DWORD *)(a3 + 48);
  *(_QWORD *)(a3 + 40) = *(_QWORD *)((char *)v11 + 428);
  for ( i = 0LL; i < 4; ++i )
  {
    v17 = *((unsigned __int8 *)v11 + i + 436);
    *v15++ = v17;
  }
  *(_QWORD *)(a3 + 64) = v11[55];
  ...
  *(_DWORD *)(a3 + 72) = v19;
  if ( (_DWORD)v19 )
  {
    ...
    do
    {
      v23 = v11[56];
      v20 += 48LL;
      *(v22 - 1) = *(_DWORD *)(v20 + v23 - 40);
      *v22 = *(_DWORD *)(v20 + v23 - 36);
      v22 += 6;
      *(v22 - 5) = *(_DWORD *)(v20 + v23 - 32);
      *(v22 - 4) = *(_DWORD *)(v20 + v23 - 28);
      *(v22 - 3) = *(_DWORD *)(v20 + v23 - 24);
      *(v22 - 2) = *(_DWORD *)(v20 + v23 - 16);
      --v21;
    }
    while ( v21 );
  }
