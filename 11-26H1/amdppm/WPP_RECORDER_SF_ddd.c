/*
 * XREFs of WPP_RECORDER_SF_ddd @ 0x14000AD1C
 * Callers:
 *     ValidateCoordinatedDependencyOptionsPlatform @ 0x1400306A0 (ValidateCoordinatedDependencyOptionsPlatform.c)
 *     ValidateCoordinatedDependencyOptionsProcessor @ 0x1400307F8 (ValidateCoordinatedDependencyOptionsProcessor.c)
 * Callees:
