/*
 * XREFs of AcquirePccInterface @ 0x1400273AC
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v3 >= 0 )
    {
      v3 = ValidatePccHeader(qword_140015BD8);
      if ( v3 < 0 )
      {
        ((void (__fastcall *)(__int64))qword_140015BA8)(qword_140015B98);
        memset(&unk_140015B90, 0, 0x80uLL);
      }
    }
  }
