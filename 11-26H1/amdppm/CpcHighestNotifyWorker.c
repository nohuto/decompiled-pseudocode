/*
 * XREFs of CpcHighestNotifyWorker @ 0x140042A28
 * Callers:
 *     CpcNativeInterruptWorker @ 0x140026F20 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x140027B40 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
...
LABEL_12:
      ...
      *(_DWORD *)(v6 + 100) = v15;
      ...
      {
        if ( !byte_140015B70 || (v17 = *(_QWORD *)(v5 + 1080)) == 0 || *(_DWORD *)(v17 + 36) <= 1u )
        {
...
LABEL_39:
          ...
          ((void (__fastcall *)(__int64 *))qword_140015900)(&v22);
