/*
 * XREFs of LpiIdleExecute @ 0x14000E360
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( v10 )
  {
    ...
    while ( a6 )
    {
      ...
      if ( *(_QWORD *)(v14 + qword_140015CB0) )
      {
        v10 = *(void (__fastcall **)(__int128 *, __int64, __int128 *))(v14 + qword_140015CB0 + 40);
        v9 = (__int128 *)(v14 + qword_140015CB0 + 8);
        v11 = *(__int64 (__fastcall **)(__int128 *, _QWORD))(v14 + qword_140015CB0);
        if ( !v10 )
          return v11(v9, a5);
        v12 = *(_QWORD *)(v14 + qword_140015CB0 + 32);
      }
      else
      {
        v12 += *(_QWORD *)(v14 + qword_140015CB0 + 32);
