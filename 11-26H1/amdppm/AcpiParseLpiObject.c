/*
 * XREFs of AcpiParseLpiObject @ 0x14002AA00
 * Callers:
...
LABEL_101:
    ...
    v34 = &v23[v31 + 12];
    if ( *v34 != 127 )
      AcpiTranslateAccessSize(v34, v32);
    v35 = &v23[v31 + 15];
    if ( *v35 != 127 )
      AcpiTranslateAccessSize(v35, v32);
    v36 = &v23[v31 + 18];
    if ( *v36 != 127 )
      AcpiTranslateAccessSize(v36, v32);
    v24 = *((unsigned __int16 *)v27 + 1);
    v21 = v46;
