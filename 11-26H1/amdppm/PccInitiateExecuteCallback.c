/*
 * XREFs of PccInitiateExecuteCallback @ 0x14000E000
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    v3 = qword_140015658;
    v4 = 0;
    while ( (__int64 *)v3 != &qword_140015658 )
    {
    ...
    if ( v4 )
    {
      LOBYTE(word_140015C64) = 1;
      if ( !HIBYTE(word_140015C64) )
      {
        HIBYTE(word_140015C64) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_140015C50);
    if ( v11 )
      IoQueueWorkItem(qword_140015C58, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
