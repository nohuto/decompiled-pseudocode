/*
 * XREFs of DeregisterKernelIdleDomains @ 0x1400325B8
 * Callers:
 ...
 *     DeregisterIdleDomain @ 0x1400324A4 (DeregisterIdleDomain.c)
...
__int64 __fastcall DeregisterKernelIdleDomains(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( v10 )
    {
      ...
      do
      {
        *(_QWORD *)(88 * v11 + *(_QWORD *)(a1 + 712) + 128) = 0LL;
