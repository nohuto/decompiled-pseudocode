/*
 * XREFs of HUBUCX_StartDeviceIoUsingUCXIoctl @ 0x1C00291DC
 * Callers:
 *     HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake @ 0x1C00205A0 (HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake.c)
 * Callees:
