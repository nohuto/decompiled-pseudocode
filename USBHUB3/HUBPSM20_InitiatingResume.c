/*
 * XREFs of HUBPSM20_InitiatingResume @ 0x1C0011EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_InitiatingResume(__int64 a1)
{
  ...
  *(_DWORD *)(v1 + 172) = *(unsigned __int16 *)(v1 + 200);
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x38u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v6);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x39u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v7);
    }
