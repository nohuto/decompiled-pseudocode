/*
 * XREFs of HUBPSM30_InitiatingWarmResetPort @ 0x1C0013150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM30_InitiatingWarmResetPort(__int64 a1)
{
  ...
  *(_WORD *)(v1 + 174) = 0;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x30u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v6);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x31u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v7);
    }
