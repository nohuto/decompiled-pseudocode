/*
 * XREFs of HUBHSM_SendingAckForHubChange @ 0x1C0008F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_SendingAckForHubChange(__int64 a1)
{
  ...
  *(_DWORD *)(v1 + 956) = 0;
  ...
  {
    v7 = v3;
    WPP_RECORDER_SF_d(*v4, 4u, 3u, 0xCu, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v7);
  }
  ...
  if ( v5 < 0 )
  {
    ...
    {
      LODWORD(v8) = v5;
      WPP_RECORDER_SF_d(*v4, 2u, 3u, 0xDu, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v8);
    }
