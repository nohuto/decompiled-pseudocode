/*
 * XREFs of HUBPSM30_EnablingRemoteWakeOnPort @ 0x1C0013E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM30_EnablingRemoteWakeOnPort(__int64 a1)
{
  __int64 v1; // rbx
  char v2; // al
  __int64 *v3; // rdi
  ...
  *(_WORD *)(v1 + 174) = 0;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x36u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v6);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x37u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v7);
    }
