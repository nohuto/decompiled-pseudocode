/*
 * XREFs of HUBDTX_ValidateAndCacheLanguageIdStringDescriptor @ 0x1C002C414
 * Callers:
 *     HUBDSM_ValidatingLanguageIdStringDescriptor @ 0x1C0021670 (HUBDSM_ValidatingLanguageIdStringDescriptor.c)
 * Callees:
