/*
 * XREFs of ?QueryProbedBars@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_QUERYPROBEDBARS@@@Z @ 0x1C0364418
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::QueryProbedBars(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v11 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v10 + 32LL))(v10, a3);
  }
  else
  {
