/*
 * XREFs of ?VmBusChannelSuspend@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@@Z @ 0x1C03751E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GuestPaused@HOSTVMMONITORMAPPING@@QEAAXXZ @ 0x1C005729C (-GuestPaused@HOSTVMMONITORMAPPING@@QEAAXXZ.c)
