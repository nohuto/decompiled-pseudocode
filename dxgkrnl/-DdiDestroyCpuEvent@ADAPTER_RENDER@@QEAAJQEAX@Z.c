/*
 * XREFs of ?DdiDestroyCpuEvent@ADAPTER_RENDER@@QEAAJQEAX@Z @ 0x1C02C1794
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyCpuEvent(ADAPTER_RENDER *this, void *const a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5159);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, void *const))(*((_QWORD *)this + 2) + 1472LL))(
