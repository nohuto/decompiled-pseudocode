/*
 * XREFs of ?DxgkDestroySynchronizationObjectImpl@@YAJPEBU_D3DKMT_DESTROYSYNCHRONIZATIONOBJECT@@H@Z @ 0x1C018667C
 * Callers:
 ...
 *     DxgkDestroySynchronizationObject @ 0x1C01DD330 (DxgkDestroySynchronizationObject.c)
