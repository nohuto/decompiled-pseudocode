/*
 * XREFs of ?DdiUpdateOverlay@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_UPDATEOVERLAY@@@Z @ 0x1C02C83EC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiUpdateOverlay(ADAPTER_RENDER *this, void *a2, struct _DXGKARG_UPDATEOVERLAY *a3)
{
  ...
  _BYTE v19[8]; // [rsp+68h] [rbp-21h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5033);
  ...
  v11 = (*(int (__fastcall **)(void *, struct _DXGKARG_UPDATEOVERLAY *))(*((_QWORD *)this + 2) + 744LL))(a2, a3);
  if ( v19[0] )
