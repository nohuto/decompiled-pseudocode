/*
 * XREFs of ?DdiReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C03689CC
 * Callers:
 *     ?ReadVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C036CF70 (-ReadVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONF.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5089);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1040LL)
                                                                                        + 48LL))(
