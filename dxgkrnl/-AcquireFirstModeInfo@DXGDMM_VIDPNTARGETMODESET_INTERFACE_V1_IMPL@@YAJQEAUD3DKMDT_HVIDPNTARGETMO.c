/*
 * XREFs of ?AcquireFirstModeInfo@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C02087E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_TARGET_MODE **a3)
{
  ...
  __int64 v9; // rcx
  __int64 v10; // r8
  struct DMMVIDPNTARGETMODE *(__fastcall *v12)(DMMVIDPNTARGETMODESET *); // [rsp+20h] [rbp-30h] BYREF
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v5 )
    {
      v13 = 0;
      v17 = 0LL;
      v12 = DMMVIDPNTARGETMODESET::GetFirstMode;
