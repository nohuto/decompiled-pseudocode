/*
 * XREFs of McTemplateK0xqdqq_EtwWriteTransfer @ 0x1C006DA84
 * Callers:
...
NTSTATUS McTemplateK0xqdqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           ...
           &BltQueuePresentDisplayOnlyComplete,
           a3,
           6u,
           &v4);
}
