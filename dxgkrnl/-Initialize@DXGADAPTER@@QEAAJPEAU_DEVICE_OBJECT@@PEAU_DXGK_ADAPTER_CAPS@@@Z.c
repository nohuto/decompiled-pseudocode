/*
 * XREFs of ?Initialize@DXGADAPTER@@QEAAJPEAU_DEVICE_OBJECT@@PEAU_DXGK_ADAPTER_CAPS@@@Z @ 0x1C01EDF54
 * Callers:
 ...
 *     ?GetPhysicalAdapterCapsSizeFromDdiVersion@@YAII@Z @ 0x1C021AA70 (-GetPhysicalAdapterCapsSizeFromDdiVersion@@YAII@Z.c)
