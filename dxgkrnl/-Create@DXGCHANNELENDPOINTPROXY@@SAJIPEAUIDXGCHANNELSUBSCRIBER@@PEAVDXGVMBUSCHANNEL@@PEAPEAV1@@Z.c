/*
 * XREFs of ?Create@DXGCHANNELENDPOINTPROXY@@SAJIPEAUIDXGCHANNELSUBSCRIBER@@PEAVDXGVMBUSCHANNEL@@PEAPEAV1@@Z @ 0x1C03614A8
 * Callers:
 ...
 *     ??0DXGCHANNELENDPOINTPROXY@@IEAA@XZ @ 0x1C0360D10 (--0DXGCHANNELENDPOINTPROXY@@IEAA@XZ.c)
 */
