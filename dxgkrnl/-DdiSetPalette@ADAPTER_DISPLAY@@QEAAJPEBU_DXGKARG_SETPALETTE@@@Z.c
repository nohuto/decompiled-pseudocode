/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C02C63AC
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5017);
  }
  else
  {
    v22 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v20, 5017);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 544LL))(
  ...
  v16[3] = v10;
  v16[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 280LL);
  v16[5] = a2->FirstEntry;
  v16[6] = a2->NumEntries;
