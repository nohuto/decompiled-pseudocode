/*
 * XREFs of DxgkGetAllocationPriority @ 0x1C02D5060
 * Callers:
 *     <none>
 * Callees:
...
{
  _D3DKMT_GETALLOCATIONPRIORITY *v3; // rbx
  __int64 v4; // rcx
  ...
  __int64 v13; // r9
  int v14; // eax
  unsigned int AllocationPriority; // ebx
  __int64 v16; // rcx
  __int64 v17; // r8
  ...
  _BYTE v23[16]; // [rsp+78h] [rbp-F0h] BYREF
  _D3DKMT_GETALLOCATIONPRIORITY v24; // [rsp+88h] [rbp-E0h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v19, 2138);
...
LABEL_17:
  ...
  DXGDEVICEACCESSLOCKSHARED::DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)v23, v22);
  ...
  AllocationPriority = DXGDEVICE::GetAllocationPriority(v10, &v24, 1);
  COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)v25);
  DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)v23);
  if ( v18 && _InterlockedExchangeAdd64((volatile signed __int64 *)v18 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    ADAPTER_RENDER::DestroyDeviceNoLocks(*((ADAPTER_RENDER **)v18 + 2), v18);
