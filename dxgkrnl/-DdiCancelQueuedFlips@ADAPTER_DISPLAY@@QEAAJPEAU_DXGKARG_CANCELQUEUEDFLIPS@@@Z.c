/*
 * XREFs of ?DdiCancelQueuedFlips@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CANCELQUEUEDFLIPS@@@Z @ 0x1C0042630
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiCancelQueuedFlips@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_CANCELQUEUEDFLIPS@@@Z @ 0x1C00479B0 (-ADAPTER_DISPLAY_DdiCancelQueuedFlips@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_CANCELQUEUEDFLIPS@@@.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5156);
  }
  else
  {
    v21 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v19, 5156);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CANCELQUEUEDFLIPS *))(*((_QWORD *)this + 2) + 1416LL))(
