/*
 * XREFs of DxgkSetYieldPercentage @ 0x1C0343050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetYieldPercentage(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 2139);
  ...
  {
    if ( (DWORD2(v21) & 0xFFFFFFFE) == 0 && !DWORD1(v21) )
    {
      ApplyResourceManagerPolicyToRenderAdapters(0, (__int64)&v21);
      DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v17);
      if ( v19 && (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
