/*
 * XREFs of ?WriteDxgDiagnosticsEvent_DRIVER_RECOMMEND_VIDPN@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0050414
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_DRIVER_RECOMMEND_VIDPN(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C013A8E0 > 4 && tlgKeywordOn((__int64)&dword_1C013A8E0, 0x200000000100LL) )
  {
