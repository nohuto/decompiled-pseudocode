/*
 * XREFs of DxgkOpenNtHandleFromName @ 0x1C0324250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenNtHandleFromName(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v11, 2075);
  v5 = a1;
  ...
  v16 = 0LL;
  LOBYTE(v4) = 1;
  v6 = ObOpenObjectByName(*((_QWORD *)&v14 + 1), g_pDxgkSharedAllocationObjectType, v4, 0LL, v14, 0LL, &v16);
  if ( v6 >= 0 )
  {
    v7 = (_QWORD *)(a1 + 16);
