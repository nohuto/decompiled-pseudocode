/*
 * XREFs of ?DdiDsiReset@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_RESET@@@Z @ 0x1C02C2A60
 * Callers:
 *     ?DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z @ 0x1C03CA370 (-DdiDsiReset@KernelDriver@@UEAAJPEAU_DXGK_DSI_RESET@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDsiReset(ADAPTER_DISPLAY *this, unsigned int a2, struct _DXGK_DSI_RESET *a3)
{
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, (__int64)a3, 5146);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5146);
        ...
        v13 < 0) )
  {
    ...
    DxgkLogInternalTriageEvent(
      ...
      0x40000,
      -1,
      (__int64)L"The driver failed DxgkDdiDsiReset. Status: 0x%I64x",
      v13,
      0LL,
      0LL,
      0LL,
