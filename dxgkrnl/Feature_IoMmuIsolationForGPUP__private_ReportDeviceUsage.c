/*
 * XREFs of Feature_IoMmuIsolationForGPUP__private_ReportDeviceUsage @ 0x1C00265AC
 * Callers:
...
void Feature_IoMmuIsolationForGPUP__private_ReportDeviceUsage()
{
  __int64 v0; // [rsp+30h] [rbp+8h]

  v0 = (unsigned int)Feature_IoMmuIsolationForGPUP__private_featureState;
  if ( (Feature_IoMmuIsolationForGPUP__private_featureState & 0x10) == 0 )
  {
    LODWORD(v0) = Feature_IoMmuIsolationForGPUP__private_featureState | 1;
