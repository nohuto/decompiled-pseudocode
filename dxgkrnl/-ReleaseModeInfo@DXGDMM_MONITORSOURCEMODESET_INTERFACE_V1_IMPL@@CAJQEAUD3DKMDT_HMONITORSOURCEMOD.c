/*
 * XREFs of ?ReleaseModeInfo@DXGDMM_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORSOURCEMODESET__@@QEBU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C03C26A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v12, 6001);
  if ( !a2 )
  ...
  else
  {
    ...
    RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>::RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>(
      ...
      *(struct _ERESOURCE **)&v7[2].ActiveCount,
      1);
    v8 = Resource;
    v6 = DxgMonitor::MonitorModes::_ReleaseMonitorModeEnumerator((DxgMonitor::MonitorModes *)Resource, a2);
    if ( v8 )
    {
