/*
 * XREFs of ?DxgkNotifyWorkSubmissionInternal@@YAJPEAU_D3DKMT_NOTIFY_WORK_SUBMISSION@@_N@Z @ 0x1C0313C48
 * Callers:
 *     NtDxgkNotifyWorkSubmission @ 0x1C031BA60 (NtDxgkNotifyWorkSubmission.c)
 * Callees:
