/*
 * XREFs of DxgkAcquireKeyedMutex2 @ 0x1C034D6E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAcquireKeyedMutex2(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 2068);
  if ( DXGPROCESS::GetCurrent(v4) )
  {
    ...
    *(_OWORD *)v22 = v8[2];
    ...
    if ( (_QWORD)v21 )
    {
      ...
      v23 = *v10;
      v9 = (union _LARGE_INTEGER *)&v23;
    }
    v16[0] = (unsigned int)v22[1];
