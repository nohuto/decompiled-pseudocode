/*
 * XREFs of ?DxgkCreateSynchronizationObjectImpl@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@HPEAX2@Z @ 0x1C018768C
 * Callers:
 *     DxgkCreateSynchronizationObject @ 0x1C01D8950 (DxgkCreateSynchronizationObject.c)
 *     ?DxgkCddCreateSynchronizationObject@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@@Z @ 0x1C01DB1B0 (-DxgkCddCreateSynchronizationObject@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@@Z.c)
 *     DxgkCreateSynchronizationObjectInternal @ 0x1C034E17C (DxgkCreateSynchronizationObjectInternal.c)
 *     DxgkWslCreateSynchronizationObject @ 0x1C034FCB0 (DxgkWslCreateSynchronizationObject.c)
