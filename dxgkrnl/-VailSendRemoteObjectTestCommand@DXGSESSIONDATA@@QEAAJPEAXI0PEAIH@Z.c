/*
 * XREFs of ?VailSendRemoteObjectTestCommand@DXGSESSIONDATA@@QEAAJPEAXI0PEAIH@Z @ 0x1C035F2E8
 * Callers:
...
__int64 __fastcall DXGSESSIONDATA::VailSendRemoteObjectTestCommand(
        DXGSESSIONDATA *this,
        void *a2,
        __int64 a3,
        void *a4,
        ...
        int a6)
{
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 17011);
  }
  else
  {
    v26 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v24, 17011);
  ...
  if ( v12 )
  {
    ...
    if ( ExAcquireRundownProtection(v12 + 8) )
    {
      if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)(v12[9].Count + 64)) )
      {
        ...
        {
          WdLogSingleEntry1(2LL, 2856LL);
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            -1,
            (__int64)L"Unable to get VAIL remote object interface",
            2856LL,
            0LL,
            0LL,
            0LL,
