...
void TdrInit(void)
{
  ...
  if ( dword_1C013BA74 != v8 )
    WdLogSingleEntry2(3LL, v8, (unsigned int)dword_1C013BA74);
  v2 = v9;
  if ( v9 )
  {
    if ( v9 > 0x384 )
  ...
  if ( dword_1C013BA78 != v9 )
    WdLogSingleEntry2(3LL, v9, (unsigned int)dword_1C013BA78);
  v3 = v10;
  if ( v10 )
  {
    if ( v10 > 0x384 )
  ...
  if ( dword_1C013BA7C != v10 )
    WdLogSingleEntry2(3LL, v10, (unsigned int)dword_1C013BA7C);
  v4 = v11;
  if ( v11 )
  {
    if ( v11 > 0x384 )
  ...
  if ( dword_1C013BA80 != v11 )
    WdLogSingleEntry2(3LL, v11, (unsigned int)dword_1C013BA80);
  v5 = v14;
  if ( v14 > 0x20 )
  {
    dword_1C013BA88 = 32;
  ...
  if ( dword_1C013BA88 != v14 )
    WdLogSingleEntry2(3LL, v14, (unsigned int)dword_1C013BA88);
  v6 = v15;
  v7 = 3600LL;
  if ( v15 > 0xE10 )
  {
    dword_1C013BA8C = 3600;
  }
  else
  {
    if ( v15 < 5 )
  ...
  if ( dword_1C013BA8C != v15 )
    WdLogSingleEntry2(3LL, v15, (unsigned int)dword_1C013BA8C);
  LOBYTE(v7) = 1;
  byte_1C013BA84 = (unsigned __int8)WdIsDebuggerPresent(v7) != 0;
  if ( v12 >= 2 && v12 - 2 > 1 )
    g_TdrDebugMode = 2;
  else
    g_TdrDebugMode = v12;
