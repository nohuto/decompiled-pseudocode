/*
 * XREFs of ?VmBusSendDestroyProcess@DXG_GUEST_GLOBAL_VMBUS@@QEAAXI@Z @ 0x1C0383ABC
 * Callers:
...
void __fastcall DXG_GUEST_GLOBAL_VMBUS::VmBusSendDestroyProcess(DXG_GUEST_GLOBAL_VMBUS *this, int a2)
{
