/*
 * XREFs of ?DxgkCddMakeResident@@YAJIEPEAUD3DDDI_MAKERESIDENT@@PEAD@Z @ 0x1C01D5280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddMakeResident(__int64 a1, char a2, struct D3DDDI_MAKERESIDENT *a3, char *a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v39, 3060);
  v43[0] = 0LL;
  v44 = 0;
  if ( !a2 )
    goto LABEL_4;
