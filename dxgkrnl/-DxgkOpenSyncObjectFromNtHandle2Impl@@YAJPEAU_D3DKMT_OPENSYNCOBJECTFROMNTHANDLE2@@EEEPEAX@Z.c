/*
 * XREFs of ?DxgkOpenSyncObjectFromNtHandle2Impl@@YAJPEAU_D3DKMT_OPENSYNCOBJECTFROMNTHANDLE2@@EEEPEAX@Z @ 0x1C01DF048
 * Callers:
 *     DxgkOpenSyncObjectFromNtHandle2Internal @ 0x1C01DEFF0 (DxgkOpenSyncObjectFromNtHandle2Internal.c)
 *     DxgkOpenSyncObjectFromNtHandle2 @ 0x1C0223770 (DxgkOpenSyncObjectFromNtHandle2.c)
 *     DxgkWslOpenSyncObjectFromNtHandle @ 0x1C0324D40 (DxgkWslOpenSyncObjectFromNtHandle.c)
 * Callees:
