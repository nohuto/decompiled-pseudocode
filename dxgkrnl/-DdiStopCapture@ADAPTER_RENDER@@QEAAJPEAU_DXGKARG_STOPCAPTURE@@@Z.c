/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C02C7CD8
 * Callers:
 *     ?ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C0047E30 (-ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopCapture(ADAPTER_RENDER *this, struct _DXGKARG_STOPCAPTURE *a2, __int64 a3)
{
  ...
  __int64 v14; // r9
  KIRQL v15; // al
  struct _DXGKARG_STOPCAPTURE *v16; // rax
  __int64 v17; // rcx
  __int64 v18; // r8
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v20, 5039);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_STOPCAPTURE *))(*((_QWORD *)this + 2) + 680LL))(
  ...
  v16 = (struct _DXGKARG_STOPCAPTURE *)WdLogNewEntry5_WdTrace(v12, v11, v13, v14);
  v16[3].hAllocation = (HANDLE)v10;
  v16[4].hAllocation = *(HANDLE *)(*((_QWORD *)this + 2) + 280LL);
  v16[5].hAllocation = a2->hAllocation;
  if ( (_DWORD)v10 )
  {
