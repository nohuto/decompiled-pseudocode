/*
 * XREFs of ?DdiSetFlipQueueLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1C02C6160
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetFlipQueueLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1C0047D90 (-ADAPTER_RENDER_DdiSetFlipQueueLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETFLIPQUEUELOGBUF.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  int v9; // r14d
  __int64 v10; // rcx
  __int64 (__fastcall *v11)(_QWORD, const struct _DXGKARG_SETFLIPQUEUELOGBUFFER *); // rax
  int v12; // edi
  KIRQL v13; // al
  __int64 v14; // rcx
  __int64 v15; // rcx
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5154);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5154);
  ...
  v10 = *((_QWORD *)this + 2);
  v11 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETFLIPQUEUELOGBUFFER *))(v10 + 1400);
  if ( v11 )
