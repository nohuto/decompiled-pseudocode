/*
 * XREFs of ?DdiRestartFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C02C5834
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRestartFromTimeout(ADAPTER_RENDER *this, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v15, 5021);
  ...
  v9 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 576LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 280LL));
  if ( v18[0] )
