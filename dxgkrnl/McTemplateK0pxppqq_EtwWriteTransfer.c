/*
 * XREFs of McTemplateK0pxppqq_EtwWriteTransfer @ 0x1C005A770
 * Callers:
...
NTSTATUS McTemplateK0pxppqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventReportVirtualGpu, a3, 7u, &v4);
}
