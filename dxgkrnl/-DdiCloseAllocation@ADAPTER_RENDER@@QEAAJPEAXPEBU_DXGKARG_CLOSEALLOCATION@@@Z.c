/*
 * XREFs of ?DdiCloseAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_CLOSEALLOCATION@@@Z @ 0x1C02BF418
 * Callers:
        ...
        const struct _DXGKARG_CLOSEALLOCATION *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v23, 5029);
  ...
  v13 = (*(int (__fastcall **)(void *, const struct _DXGKARG_CLOSEALLOCATION *))(*((_QWORD *)this + 2) + 720LL))(a2, a3);
  if ( v27[0] )
  ...
  v19[3] = v13;
  v19[4] = a2;
  v19[5] = a3->NumAllocations;
  v19[6] = *a3->pOpenHandleList;
  if ( (_DWORD)v13 )
  {
