/*
 * XREFs of DxgkSubmitWaitForSyncObjectsToHwQueueInternal @ 0x1C02231E8
 * Callers:
 *     DxgkSubmitWaitForSyncObjectsToHwQueue @ 0x1C031B9E0 (DxgkSubmitWaitForSyncObjectsToHwQueue.c)
