/*
 * XREFs of ?DdiQueryVirtualFunctionLuid@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z @ 0x1C03685A0
 * Callers:
 *     ?QueryVirtualFunctionLuid@DXGK_VIRTUAL_GPU_GPUP@@UEAAXPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z @ 0x1C036CF30 (-QueryVirtualFunctionLuid@DXGK_VIRTUAL_GPU_GPUP@@UEAAXPEAU_DXGKARG_QUERYVIRTUALFUNCTIONLUID@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v15, 5096);
  ...
  (*(void (__fastcall **)(_QWORD, struct _DXGKARG_QUERYVIRTUALFUNCTIONLUID *))(*(_QWORD *)(*((_QWORD *)this + 2) + 1040LL)
                                                                             + 112LL))(
