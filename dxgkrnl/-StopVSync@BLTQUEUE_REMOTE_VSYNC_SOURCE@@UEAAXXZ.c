/*
 * XREFs of ?StopVSync@BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAAXXZ @ 0x1C03D0D20
 * Callers:
 *     ??1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ @ 0x1C03D0974 (--1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ.c)
 * Callees:
