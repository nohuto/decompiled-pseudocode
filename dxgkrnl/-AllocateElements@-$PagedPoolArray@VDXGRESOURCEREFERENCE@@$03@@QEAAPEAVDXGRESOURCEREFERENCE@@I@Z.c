/*
 * XREFs of ?AllocateElements@?$PagedPoolArray@VDXGRESOURCEREFERENCE@@$03@@QEAAPEAVDXGRESOURCEREFERENCE@@I@Z @ 0x1C02E1C10
 * Callers:
...
__int64 __fastcall PagedPoolArray<DXGRESOURCEREFERENCE,4>::AllocateElements(__int64 *a1, __int64 a2)
{
  unsigned int v2; // esi
  __int64 result; // rax
  __int64 v5; // rax
