/*
 * XREFs of ?ReleaseModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C019E6B0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE *const a3)
{
  ...
  __int64 v9; // r9
  __int64 v10; // rax
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v11; // rbx
  char *v12; // rcx
  DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *v13; // rax
  char *v14; // rax
  DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *v15; // rax
  __int64 v16; // r8
  int v18; // eax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v19, 7004);
...
LABEL_23:
  ...
  {
    v13 = this[6];
    if ( v13 == (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)(this + 6) || (v14 = (char *)v13 - 8) == 0LL )
    {
LABEL_20:
    ...
    while ( v14 != v12 )
    {
      v15 = (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)*((_QWORD *)v14 + 1);
      if ( v15 != (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)(this + 6) )
      {
        v14 = (char *)v15 - 8;
        if ( v14 )
          continue;
