/*
 * XREFs of ?_IsModeInPixelRateRange@MonitorModes@DxgMonitor@@AEBAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@PEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C03C8CBC
 * Callers:
 ...
 * Callees:
 *     SupportedPixelRate @ 0x1C03C821C (SupportedPixelRate.c)
 */
