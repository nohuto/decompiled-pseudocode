/*
 * XREFs of ?SetVirtualFunctionPowerState@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x1C0364E24
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::SetVirtualFunctionPowerState(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v11 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v10 + 96LL))(v10, a3);
  }
  else
  {
