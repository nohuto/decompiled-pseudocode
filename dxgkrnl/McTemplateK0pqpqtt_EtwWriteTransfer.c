/*
 * XREFs of McTemplateK0pqpqtt_EtwWriteTransfer @ 0x1C0029FF8
 * Callers:
...
NTSTATUS McTemplateK0pqpqtt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventFlip, a3, 7u, &v4);
}
