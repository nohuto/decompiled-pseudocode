/*
 * XREFs of ?DdiCollectDiagnosticInfo@DXGADAPTER@@QEAAJPEAU_DXGKARG_COLLECTDIAGNOSTICINFO@@@Z @ 0x1C02BF68C
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5141);
  ...
  v11 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_COLLECTDIAGNOSTICINFO *))this + 173))(
          *((_QWORD *)this + 27),
          a2);
  if ( v19[0] )
