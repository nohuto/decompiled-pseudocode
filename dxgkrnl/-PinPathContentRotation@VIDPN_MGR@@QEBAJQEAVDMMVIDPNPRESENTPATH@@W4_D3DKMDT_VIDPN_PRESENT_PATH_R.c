/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C03AAD8C
 * Callers:
 ...
 *     ?GetContainer@?$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ @ 0x1C0068864 (-GetContainer@-$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ.c)
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a3)
{
  ...
  v14 = VIDPN_MGR::FormalizeVidPnChange((__int64)this, (D3DKMDT_HVIDPN)(v11 & -(__int64)(v11 != -88)), 9, v12, &v15);
  v7 = v14;
  if ( v14 < 0 )
  {
    v8 = v3;
