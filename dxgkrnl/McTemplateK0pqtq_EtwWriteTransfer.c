/*
 * XREFs of McTemplateK0pqtq_EtwWriteTransfer @ 0x1C0040634
 * Callers:
...
NTSTATUS McTemplateK0pqtq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventAdapterFeatureState, a3, 5u, &v4);
}
