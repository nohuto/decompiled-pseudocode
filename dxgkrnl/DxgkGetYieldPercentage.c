/*
 * XREFs of DxgkGetYieldPercentage @ 0x1C0215840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetYieldPercentage(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v24, 2142);
  if ( CheckTokenForResourceManagerAccess() )
  {
    ...
    if ( v27 >= 0x10 )
    {
      ...
      else
      {
        ...
        v13 = (*((_DWORD *)v12 + 76117) ^ DWORD2(v29)) & 1 ^ DWORD2(v29);
        DWORD2(v29) = v13;
        v14 = *((_DWORD *)v12 + 76114);
        HIDWORD(v29) = v14;
