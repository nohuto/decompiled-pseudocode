/*
 * XREFs of ?DdiCreateDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEDOORBELL@@@Z @ 0x1C02C0354
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5162);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5162);
  ...
  v12 = (*(int (__fastcall **)(struct _DXGKARG_CREATEDOORBELL *))(*((_QWORD *)this + 2) + 1520LL))(a2);
  if ( v22[0] )
  ...
  if ( (_DWORD)v12 != -1073741822 && (_DWORD)v12 != -1073741801 && (_DWORD)v12 )
  {
