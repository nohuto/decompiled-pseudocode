/*
 * XREFs of McTemplateK0xqqxx_EtwWriteTransfer @ 0x1C005D274
 * Callers:
...
NTSTATUS McTemplateK0xqqxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &VailFrameStatistics, a3, 6u, &v4);
}
