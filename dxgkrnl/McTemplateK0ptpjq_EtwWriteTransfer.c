/*
 * XREFs of McTemplateK0ptpjq_EtwWriteTransfer @ 0x1C00645E8
 * Callers:
...
NTSTATUS McTemplateK0ptpjq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 16LL;
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventOPMGetInformation, a3, 6u, &v4);
}
