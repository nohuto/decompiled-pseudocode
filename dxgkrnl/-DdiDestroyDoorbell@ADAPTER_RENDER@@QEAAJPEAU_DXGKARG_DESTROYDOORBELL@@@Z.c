/*
 * XREFs of ?DdiDestroyDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYDOORBELL@@@Z @ 0x1C02C19C8
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyDoorbell(
        ADAPTER_RENDER *this,
        struct _DXGKARG_DESTROYDOORBELL *a2,
        __int64 a3)
{
  __int64 v5; // rcx
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5165);
  }
  else
  {
    v20 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5165);
  ...
  v12 = (*(int (__fastcall **)(struct _DXGKARG_DESTROYDOORBELL *))(*((_QWORD *)this + 2) + 1544LL))(a2);
  if ( v22[0] )
  ...
  if ( (_DWORD)v12 != -1073741822 && (_DWORD)v12 )
  {
