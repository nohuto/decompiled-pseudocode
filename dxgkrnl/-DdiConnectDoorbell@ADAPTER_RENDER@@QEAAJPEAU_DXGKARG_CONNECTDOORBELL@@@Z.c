/*
 * XREFs of ?DdiConnectDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CONNECTDOORBELL@@@Z @ 0x1C02BFC58
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C013A870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5163);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5163);
  ...
  v10 = (*(int (__fastcall **)(struct _DXGKARG_CONNECTDOORBELL *))(*((_QWORD *)this + 2) + 1528LL))(a2);
  if ( v19[0] )
