/*
 * XREFs of KeyboardToggleWaitWake @ 0x1C00050EC
 * Callers:
 *     KeyboardClassWaitWakeComplete @ 0x1C0004F30 (KeyboardClassWaitWakeComplete.c)
 *     KeyboardClassSetWmiDataBlock @ 0x1C000E7B0 (KeyboardClassSetWmiDataBlock.c)
 *     KeyboardClassSetWmiDataItem @ 0x1C000E840 (KeyboardClassSetWmiDataItem.c)
 * Callees:
