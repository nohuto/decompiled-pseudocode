 ...
 *     KeyboardCallAllPorts @ 0x1C0004060 (KeyboardCallAllPorts.c)
...
__int64 __fastcall KeyboardClassDeviceControl(__int64 a1, __int64 a2)
{
  ...
  v8 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v5 + 32), (PVOID)v2, &byte_1C000D4E0, 1u, 0x20u);
  v9 = v8;
  if ( v8 < 0 )
  {
    *(_DWORD *)(v2 + 48) = v8;
...
LABEL_10:
        ...
        *(_BYTE *)(*(_QWORD *)(v2 + 184) - 72LL) = 15;
        if ( v4 )
        {
          if ( IoAcquireRemoveLockEx(v7, (PVOID)v2, &byte_1C000D4E0, 1u, 0x20u) < 0 )
