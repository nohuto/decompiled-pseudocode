/*
 * XREFs of WPP_RECORDER_SF_qqdL @ 0x1C0005E44
 * Callers:
...
__int64 WPP_RECORDER_SF_qqdL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, _DWORD *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      WPP_GLOBAL_Control->AttachedDevice,
      43LL,
      &WPP_6ff944f7951fb8a8caac54bc3f6ce333_Traceguids,
      24LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
