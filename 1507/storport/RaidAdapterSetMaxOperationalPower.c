/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x1C002ABF4
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x1C002A8F0 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x1C002A8C4 (RaidAdapterEffectiveMaxOperationalPower.c)
 */
...
LABEL_12:
  ...
  if ( (unsigned int)dword_1C0044050 > 5 )
  {
    if ( TlgKeywordOn(v15, 0x400000000000uLL) )
    {
      ...
      v56 = 8LL;
      v58 = 8LL;
      TlgWrite(v18, &unk_1C003CCA8, v19, v20, 0xEu, &pData);
    }
  }
