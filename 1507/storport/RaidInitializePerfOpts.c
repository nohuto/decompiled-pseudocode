/*
 * XREFs of RaidInitializePerfOpts @ 0x1C0024268
 * Callers:
...
__int64 __fastcall RaidInitializePerfOpts(__int64 a1, char a2, unsigned int *a3, __int64 a4)
{
  ...
  if ( !a1 )
  {
    ...
    v12 = 22LL;
LABEL_6:
    WPP_SF_(v11->AttachedDevice, v12, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, a4);
LABEL_7:
    v10 = -1056964602;
    goto LABEL_84;
  }
  ...
  if ( (~v17 & (unsigned int)v18) != 0 )
  {
    ...
    v15 = 25LL;
LABEL_18:
    WPP_SF_(v14->AttachedDevice, v15, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, a4);
LABEL_19:
    v10 = -1056964607;
    goto LABEL_84;
  }
      ...
      if ( v9 && (a3[2] & 4) != 0 )
      {
        ...
        if ( v20 > v23 || v23 > v22 )
        {
          if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
            ...
            && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
          {
            WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 26LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, a4);
          }
          v10 = -1056964607;
          goto LABEL_84;
        }
