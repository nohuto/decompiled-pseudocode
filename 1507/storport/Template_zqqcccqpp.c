/*
 * XREFs of Template_zqqcccqpp @ 0x1C00255B0
 * Callers:
...
NTSTATUS __fastcall Template_zqqcccqpp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a12)
{
  ...
  v30 = 8LL;
  v32 = 8LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventTargetedReenumeration, 0LL, 9u, &UserData);
}
