/*
 * XREFs of RaidUnitSetDevicePowerIrp @ 0x1C00062EC
 * Callers:
...
__int64 __fastcall RaidUnitSetDevicePowerIrp(struct _SLIST_ENTRY *Context, _SLIST_ENTRY *Irp)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 50LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, Context, Irp);
  }
  if ( *((_DWORD *)&Context[11].Next + 3) == 4 && *(_DWORD *)(*((_QWORD *)&Irp[11].Next + 1) + 24LL) == 1 )
  {
    ...
    if ( *(int *)(v2 + 268) > 1 )
    {
      *((_BYTE *)&Context[100].Next + 9) = 1;
      Context[101].Next = Irp;
      RaUnitAcquireRemoveLock((__int64)Context);
      *(_BYTE *)(*((_QWORD *)&Irp[11].Next + 1) + 3LL) |= 1u;
      ExpInterlockedPushEntrySList((PSLIST_HEADER)(v2 + 5072), Context + 102);
