/*
 * XREFs of RaidAdapterQuerySystemPowerCompletionRoutine @ 0x1C00076B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterQuerySystemPowerCompletionRoutine(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
  ...
  if ( v6 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v6->Timer) & 4) != 0 && BYTE1(v6->Timer) >= 4u )
    WPP_SF_qqD(v6->AttachedDevice, 35LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v2, a2, v4);
