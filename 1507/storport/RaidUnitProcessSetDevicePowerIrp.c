/*
 * XREFs of RaidUnitProcessSetDevicePowerIrp @ 0x1C0006890
 * Callers:
...
__int64 __fastcall RaidUnitProcessSetDevicePowerIrp(char *Context, PIRP Irp)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 52LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, Context, Irp);
  }
  ...
  if ( (unsigned __int8)RaidIsUnitControlSupported(Context, 3LL) )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 53LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v8);
    }
  }
