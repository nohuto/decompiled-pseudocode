/*
 * XREFs of Template_qqqqqqqqxxxxx @ 0x1C00269E0
 * Callers:
...
NTSTATUS __fastcall Template_qqqqqqqqxxxxx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v39 = 8LL;
  v41 = 8LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventHwInitData, 0LL, 0xDu, &UserData);
}
