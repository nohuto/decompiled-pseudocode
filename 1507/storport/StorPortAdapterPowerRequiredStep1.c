/*
 * XREFs of StorPortAdapterPowerRequiredStep1 @ 0x1C002C7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall StorPortAdapterPowerRequiredStep1(unsigned __int64 Context, unsigned __int64 a2, int a3)
{
  ...
  v3 = (_QWORD *)Context;
  if ( *(_QWORD *)(Context + 5344) )
  {
    LODWORD(a2) = *(_DWORD *)(*(_QWORD *)(Context + 5088) + 20LL);
    if ( (a2 & 8) != 0 || *(char *)(Context + 108) < 0 )
    {
      Context = MEMORY[0xFFFFF78000000008] - *(_QWORD *)(Context + 5344);
      a2 = Context / 0x2710;
      v3[669] += Context / 0x2710;
