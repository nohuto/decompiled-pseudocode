/*
 * XREFs of StorpGetExtendedTable @ 0x1C00294DC
 * Callers:
...
__int128 *__fastcall StorpGetExtendedTable(__int64 a1, __int64 *a2)
{
  ...
  if ( a2 )
  {
    if ( a1 )
    {
      ...
      *(_OWORD *)(v6 + 16) = xmmword_1C00444D0;
      *(_OWORD *)(v6 + 32) = xmmword_1C00444E0;
      *(_OWORD *)(v6 + 48) = xmmword_1C00444F0;
      *(_OWORD *)(v6 + 64) = xmmword_1C0044500;
      *(_QWORD *)(v6 + 80) = qword_1C0044510;
      *a2 = v6;
    }
    else
    {
