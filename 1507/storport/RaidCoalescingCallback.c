/*
 * XREFs of RaidCoalescingCallback @ 0x1C00236F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidCoalescingCallback(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_DWORD)result && *(_QWORD *)(a3 + 5096) && *(_QWORD *)(a3 + 5112) )
  {
    ...
    if ( a1 == 1 )
    {
      ...
      *(_QWORD *)(a3 + 5320) = MEMORY[0xFFFFF78000000008];
    }
    else if ( a1 == 2 )
    {
      *(_BYTE *)(a3 + 109) &= ~1u;
      ...
      if ( *(_QWORD *)(a3 + 5320) )
      {
        v18 = MEMORY[0xFFFFF78000000008] - *(_QWORD *)(a3 + 5320);
        result = 0x346DC5D63886594BLL * v18;
        *(_QWORD *)(a3 + 5328) += v18 / 0x2710;
        *(_QWORD *)(a3 + 5320) = 0LL;
      }
    }
  }
