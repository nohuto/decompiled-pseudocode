/*
 * XREFs of RaidAdapterPowerUpDeviceCompletion @ 0x1C0006E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterPowerUpDeviceCompletion(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 29LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v2, a2);
  }
...
LABEL_13:
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 31LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v2, a2, v6);
  }
  return 3221225494LL;
}
