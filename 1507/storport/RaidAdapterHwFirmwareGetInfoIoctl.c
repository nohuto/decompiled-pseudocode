/*
 * XREFs of RaidAdapterHwFirmwareGetInfoIoctl @ 0x1C00218C8
 * Callers:
...
__int64 __fastcall RaidAdapterHwFirmwareGetInfoIoctl(_QWORD *a1, IRP *a2)
{
...
LABEL_5:
    ...
    RaBuildHwFirmwareGetInfoBufferForMiniport(a1[1], a2, &P, &v10);
    v3 = P;
    if ( !P )
    {
      a2->IoStatus.Information = 0LL;
    ...
    InfoFromMiniport = RaidAdapterHwFirmwareGetInfoFromMiniport((__int64)a1, (int)a2, (__int64)P, v10);
