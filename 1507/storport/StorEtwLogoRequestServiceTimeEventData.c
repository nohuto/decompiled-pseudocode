/*
 * XREFs of StorEtwLogoRequestServiceTimeEventData @ 0x1C0035600
 * Callers:
...
unsigned __int64 __fastcall StorEtwLogoRequestServiceTimeEventData(_QWORD *a1, char a2, __int64 a3)
{
  ...
  if ( v12.QuadPart <= 0 || (v13 = a1[85], v12.QuadPart >= v13) )
    result = v12.QuadPart - a1[85];
  else
