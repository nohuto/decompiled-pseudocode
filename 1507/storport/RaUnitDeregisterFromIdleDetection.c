/*
 * XREFs of RaUnitDeregisterFromIdleDetection @ 0x1C002A55C
 * Callers:
...
void __fastcall RaUnitDeregisterFromIdleDetection(__int64 a1)
{
  ...
  {
    if ( *(_QWORD *)(a1 + 24)
      && (*(_DWORD *)(*(_QWORD *)(a1 + 1440) + 32LL) & 4) != 0
    ...
    KeReleaseInStackQueuedSpinLock(&LockHandle);
    v5 = *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 104LL);
    if ( v5 )
    {
      PoUnregisterCoalescingCallback(v5, v3, v4);
      *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 104LL) = 0LL;
    }
    v6 = *(void **)(*(_QWORD *)(a1 + 1440) + 112LL);
    if ( v6 )
    {
      PoUnregisterPowerSettingCallback(v6);
      *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 112LL) = 0LL;
    }
    v7 = *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 120LL);
    if ( v7 )
    {
      LOBYTE(v3) = 1;
      ExDeleteTimer(v7, v3, 0LL, 0LL, v12, v13, v14);
      *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 120LL) = 0LL;
    }
    v8 = *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 128LL);
    if ( v8 )
    {
      LOBYTE(v3) = 1;
      v9 = ExDeleteTimer(v8, v3, 0LL, 0LL, v12, v13, v14);
      *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 128LL) = 0LL;
      if ( v9 )
      {
        if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1440) + 148LL) & 1) != 0 )
          RaidUnitPoFxIdleComponent(a1, 0, 0, 0LL);
      }
    }
    v10 = *(struct _EX_RUNDOWN_REF_CACHE_AWARE **)(a1 + 1432);
    *(_BYTE *)(a1 + 145) &= ~0x80u;
