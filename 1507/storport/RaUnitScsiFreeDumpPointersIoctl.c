/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C0012530
 * Callers:
    ...
    *(_QWORD *)(v7 + 160) = Srb;
    ...
    else
    {
      ...
      *((_DWORD *)Srb + 3) = v19;
      ...
      Srb[6] = *(_BYTE *)(a1 + 89);
      Srb[7] = *(_BYTE *)(a1 + 90);
      *((_QWORD *)Srb + 7) = v15 + 1040;
      *((_QWORD *)Srb + 6) = v7;
    }
    KeInitializeEvent((PRKEVENT)(v7 + 656), NotificationEvent, 0);
    *(_QWORD *)(v7 + 648) = RaidXrbSignalCompletion;
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) != 0
      && BYTE1(WPP_GLOBAL_Control->Timer) )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 38LL, &WPP_0a9d81cc67956adf3a94d0464afc2bb3_Traceguids, v7, Srb);
    }
    if ( *(_BYTE *)(v2 + 4450) )
    ...
    if ( v20 >= 0 )
    {
      KeWaitForSingleObject((PVOID)(v7 + 656), Executive, 0, 0, 0LL);
