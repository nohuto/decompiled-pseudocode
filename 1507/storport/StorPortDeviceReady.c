/*
 * XREFs of StorPortDeviceReady @ 0x1C0027CF0
 * Callers:
 *     StorPortDeviceReadyVrfy @ 0x1C0056140 (StorPortDeviceReadyVrfy.c)
 * Callees:
...
char __fastcall StorPortDeviceReady(__int64 a1, unsigned __int8 a2, unsigned __int8 a3, unsigned __int8 a4)
{
  ...
  if ( !Unit )
    return 0;
  v10 = Unit + 1232;
  if ( _InterlockedCompareExchange((volatile signed __int32 *)(Unit + 1248), 134684676, 134684677) != 134684677 )
    v10 = 0LL;
  if ( !v10 )
  {
