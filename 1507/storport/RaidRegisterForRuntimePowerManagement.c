/*
 * XREFs of RaidRegisterForRuntimePowerManagement @ 0x1C002AEEC
 * Callers:
 ...
 *     RaidGetStorPoFxFState @ 0x1C00270DC (RaidGetStorPoFxFState.c)
 */
        ...
        const unsigned __int16 *a4)
{
  ...
  unsigned __int16 *p_Data2; // [rsp+80h] [rbp-80h]
  ...
  *((_QWORD *)v19 + 7) = v37;
  ...
  if ( v39 >= 0 )
  {
    ...
    if ( (_DWORD)v40 == 1 )
    {
      ...
      if ( (unsigned int)dword_1C0044050 > 5 )
      {
        if ( TlgKeywordOn(v40, 0x400000000000uLL) )
        {
          ...
          p_Data2 = (unsigned __int16 *)(v46 + 5412);
          v64 = &v55;
          Data4 = v43[104].Data4;
    ...
    else if ( !(_DWORD)v40 )
    {
      ...
      if ( (unsigned int)dword_1C0044050 > 5 && TlgKeywordOn(v47, 0x400000000000uLL) )
      {
        v52 = a2[2];
