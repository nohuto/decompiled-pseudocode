/*
 * XREFs of RaidUnitGetDeviceParameters @ 0x1C004F668
 * Callers:
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( (unsigned int)*v4 > 0x64 )
        *v4 = 25;
      if ( (unsigned int)dword_1C0044050 > 5 && TlgKeywordOn(v7, 0x400000000000uLL) )
      {
        v10 = *(_QWORD *)(a1 + 24);
        v24 = *(_DWORD *)(v10 + 56);
        v16 = *(_BYTE *)(a1 + 88);
        ...
        v48 = 4LL;
        v50 = 4LL;
        TlgWrite((TraceLoggingHProvider)v10, &unk_1C003CF7E, v8, v9, 0xDu, &v28);
      }
