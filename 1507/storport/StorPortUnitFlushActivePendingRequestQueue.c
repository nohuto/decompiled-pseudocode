/*
 * XREFs of StorPortUnitFlushActivePendingRequestQueue @ 0x1C002CB00
 * Callers:
...
void __fastcall StorPortUnitFlushActivePendingRequestQueue(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    while ( 1 )
    {
      v2 = (_QWORD *)(*(_QWORD *)(a1 + 1440) + 72LL);
      if ( (_QWORD *)*v2 == v2 )
        break;
      v3 = *(_QWORD **)(*(_QWORD *)(a1 + 1440) + 80LL);
      v4 = (_QWORD *)v3[1];
      if ( (_QWORD *)*v3 != v2 || (_QWORD *)*v4 != v3 )
        __fastfail(3u);
      *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 80LL) = v4;
      *v4 = v2;
      v5 = v3[2];
      ...
      {
        v7 = KfRaiseIrql(2u);
        RaUnitStartResetIo(*(_QWORD *)(a1 + 8), v5, a1 + 1392);
        KeLowerIrql(v7);
      }
