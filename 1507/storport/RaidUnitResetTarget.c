/*
 * XREFs of RaidUnitResetTarget @ 0x1C003346C
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C00364E4 (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0044050 > 5 )
      {
        ...
        v41 = 1LL;
        v43 = 8LL;
        TlgWrite((TraceLoggingHProvider)8, &unk_1C003D125, v18, v19, 8u, &pData);
      }
