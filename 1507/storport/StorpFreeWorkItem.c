/*
 * XREFs of StorpFreeWorkItem @ 0x1C0029234
 * Callers:
...
__int64 __fastcall StorpFreeWorkItem(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    if ( !*(_QWORD *)a2 )
    {
      ...
      v6 = 65;
LABEL_26:
      WPP_SF_((__int64)v5->AttachedDevice, v6, (__int64)&WPP_8a1d37565fd3ed53073ecf5f585bed2d_Traceguids);
      return (unsigned int)-1056964607;
    }
    if ( *(_QWORD *)(a2 + 8) )
    {
    ...
    else if ( KeGetCurrentIrql() <= 2u )
    {
      ...
      else
      {
        ...
        *(_QWORD *)a2 = 0LL;
        ...
        _InterlockedDecrement((volatile signed __int32 *)(v4 + 4984));
      }
    }
    else
    {
