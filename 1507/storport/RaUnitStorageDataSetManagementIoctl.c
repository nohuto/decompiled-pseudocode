/*
 * XREFs of RaUnitStorageDataSetManagementIoctl @ 0x1C004F39C
 * Callers:
    ...
    if ( Srb )
    {
      ...
      if ( ContiguousIoResources )
      {
        ...
        *(_QWORD *)(v9 + 216) = a1;
        ...
        RaSrbSetMiniportContext(v3, (__int64)Srb, (__int64)v22 + 1040);
        KeInitializeEvent((PRKEVENT)(v9 + 656), NotificationEvent, 0);
        ...
        if ( v24 >= 0 )
        {
          KeWaitForSingleObject((PVOID)(v9 + 656), Executive, 0, 0, 0LL);
