/*
 * XREFs of RaidAdapterPostScatterGatherExecute @ 0x1C00043C0
 * Callers:
 ...
 *     RaAllocateConcurrentChannelToken @ 0x1C0020D14 (RaAllocateConcurrentChannelToken.c)
...
LABEL_11:
  ...
  {
    if ( g_StorpTraceLoggingPerformanceHighResolutionTimer && LOBYTE(WPP_MAIN_CB.DeviceObjectExtension) )
      goto LABEL_11;
LABEL_55:
...
LABEL_12:
  *(LARGE_INTEGER *)(a2 + 680) = PerformanceCounter;
  if ( *(_BYTE *)(v7 + 4450) )
  {
    if ( (qword_1C0044010 & 1) != 0 )
    {
      *(_QWORD *)v2 = 0LL;
    ...
    if ( v22 )
      v23 = v22(*(_QWORD *)(v21 + 536) + 16LL, *(_QWORD *)(a2 + 160));
    else
      v23 = 1;
    if ( StorEtwLoggingEnabled
      && (((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x100) != 0 || ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x2000000) != 0) )
    {
      ...
      *(LARGE_INTEGER *)(a2 + 688) = v36;
    }
    if ( !v23 )
      return 0LL;
    v24 = *(_QWORD *)(a2 + 216);
    *(_QWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = *(_QWORD *)(a2 + 152);
    if ( v24 )
  ...
  *(_BYTE *)(a2 + 16) = *(_BYTE *)(a2 + 16) & 0xE3 | 0xC;
  ...
  if ( (qword_1C0044010 & 4) != 0 && *(_DWORD *)(v7 + 5060) && *(_QWORD *)(v7 + 5064) )
  {
