/*
 * XREFs of StorpInitializeWorkItem @ 0x1C001266C
 * Callers:
...
__int64 __fastcall StorpInitializeWorkItem(__int64 a1, PIO_WORKITEM **a2)
{
  ...
  if ( a1 && a2 )
  {
    ...
    {
      WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 60LL, &WPP_8a1d37565fd3ed53073ecf5f585bed2d_Traceguids, a1);
    }
    return 3238002696LL;
  }
  else
  {
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 59LL, &WPP_8a1d37565fd3ed53073ecf5f585bed2d_Traceguids, a1, a2);
    }
    return 3238002694LL;
  }
}
