/*
 * XREFs of RaidpBuildAdapterBusRelations @ 0x1C0009738
 * Callers:
 ...
 *     RaidUnitSetEnumerated @ 0x1C0009948 (RaidUnitSetEnumerated.c)
...
__int64 __fastcall RaidpBuildAdapterBusRelations(__int64 a1, _QWORD *a2)
{
  ...
  {
    WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 40LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, a1);
  }
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 41LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, v6);
    v9 = WPP_GLOBAL_Control;
  }
  for ( i = *(_QWORD **)(a1 + 120); i != (_QWORD *)(a1 + 120); i = (_QWORD *)*i )
  {
    ...
    if ( (i[12] & 4) != 0 )
    {
      ...
      if ( v8 > (unsigned int)v3 )
      {
        ...
        {
          WPP_SF_DD(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, v8, v3);
          v9 = WPP_GLOBAL_Control;
        }
        break;
      }
    ...
    else
    {
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        v19 = 42LL;
LABEL_36:
        WPP_SF_q(v9->AttachedDevice, v19, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, i - 6);
        v9 = WPP_GLOBAL_Control;
        continue;
      }
    }
  ...
  if ( v9 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v9->Timer) & 0x4000) != 0 && BYTE1(v9->Timer) >= 5u )
    WPP_SF_(v9->AttachedDevice, 45LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, v6);
LABEL_15:
  v14 = *(_QWORD **)(a1 + 200);
  while ( 2 )
  {
    if ( v14 != (_QWORD *)(a1 + 200) )
    {
      ...
      WPP_SF_q(v22->AttachedDevice, v23, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, v14 - 6);
LABEL_54:
      v14 = (_QWORD *)*v14;
      continue;
    }
  ...
  *(_QWORD *)(a1 + 4456) = v16;
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
  {
    ...
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 49LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, a1);
LABEL_21:
      v17 = WPP_GLOBAL_Control;
    }
    if ( v17 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v17->Timer) & 0x4000) != 0 && BYTE1(v17->Timer) >= 5u )
      WPP_SF_qD(v17->AttachedDevice, 50LL, &WPP_a0eb401ed86ffacb5c89201c01d8a335_Traceguids, a1, v4);
  }
  return v4;
}
