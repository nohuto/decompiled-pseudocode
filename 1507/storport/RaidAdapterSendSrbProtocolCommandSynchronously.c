/*
 * XREFs of RaidAdapterSendSrbProtocolCommandSynchronously @ 0x1C0022EE8
 * Callers:
...
__int64 __fastcall RaidAdapterSendSrbProtocolCommandSynchronously(__int64 a1, IRP *a2, char a3)
{
  ...
  v10 = ((*(_DWORD *)(a1 + 444) + 7) & 0xFFFFFFF8) + 1040;
  v11 = *(_QWORD *)(a1 + 8);
  v12 = 0LL;
    ...
    if ( v18 >= 0 )
    {
      ...
      if ( *(_BYTE *)(a1 + 402) == 1 )
      {
        ...
        *(_WORD *)&Srb[v22 + 8] = 0;
        ...
        v17 = v32;
        *(_QWORD *)(v4 + 160) = Srb;
        *(_QWORD *)(v4 + 176) = *((_QWORD *)Srb + 8);
        *(_QWORD *)(v4 + 168) = *((_QWORD *)Srb + 12);
      }
      else
      {
        *((_DWORD *)Srb + 3) = v20;
        ...
        *(_WORD *)(Srb + 5) = 0;
        Srb[7] = 0;
        *(_QWORD *)(v4 + 160) = Srb;
        *(_QWORD *)(v4 + 176) = *((_QWORD *)Srb + 3);
        *(_QWORD *)(v4 + 168) = a2;
      }
      RaSrbSetMiniportContext(a1, (__int64)Srb, (__int64)v17 + 1040);
      if ( v21 )
        *(_BYTE *)(v4 + 17) |= 8u;
      KeInitializeEvent((PRKEVENT)(v4 + 656), NotificationEvent, 0);
      *(_QWORD *)(v4 + 648) = RaidXrbSignalCompletion;
      if ( v21
      ...
      else
      {
        ...
        v18 = v26;
        KeWaitForSingleObject((PVOID)(v4 + 656), Executive, 0, 0, 0LL);
        if ( v33 )
        {
          v27 = KfRaiseIrql(2u);
        ...
        if ( (*(_BYTE *)(v4 + 17) & 1) != 0 )
        {
          RaidAdapterPoFxIdleComponentFromMiniport(a1, *(unsigned int *)(v4 + 732));
          *(_BYTE *)(v4 + 17) &= ~1u;
        }
        if ( *(_QWORD *)(a1 + 5088) )
