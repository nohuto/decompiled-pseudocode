/*
 * XREFs of RaidAdapterScsiMiniportIoctlWithAddress @ 0x1C000E438
 * Callers:
  ...
  else
  {
    ...
    if ( !Srb
      || (ContiguousNodeMemory = (char *)MmAllocateContiguousNodeMemory(
                                           ((*(_DWORD *)(a1 + 444) + 7) & 0xFFFFFFF8) + 1040,
                                           *(_QWORD *)(a1 + 4392),
                                           *(_QWORD *)(a1 + 4400),
                                           *(_QWORD *)(a1 + 4384),
                                           4,
...
LABEL_21:
    ...
    v26 = (char *)BaseAddress + 1040;
    *((_QWORD *)v11 + 22) = v25;
    RaSrbSetMiniportContext(a1, Srb, v26, v18);
    KeInitializeEvent((PRKEVENT)(v11 + 656), NotificationEvent, 0);
    *((_QWORD *)v11 + 81) = RaidXrbSignalCompletion;
    if ( *(_QWORD *)(a1 + 5088) )
    ...
    if ( v27 >= 0 )
    {
      KeWaitForSingleObject(v11 + 656, Executive, 0, 0, 0LL);
      LOBYTE(v30) = Srb[3];
      v13 = RaidSrbStatusToNtStatus(v30);
    }
    if ( (v11[17] & 1) != 0 )
    {
      RaidAdapterPoFxIdleComponentFromMiniport(a1, *((unsigned int *)v11 + 183), v28, v29);
      v11[17] &= ~1u;
    }
    if ( (v11[17] & 2) != 0 )
    {
      ...
      if ( !v37 )
      {
        if ( v9 )
        {
          RaidUnitPoFxIdleComponentFromMiniport(v9, *((unsigned int *)v11 + 183));
          v11[17] &= ~2u;
          if ( a6 != 1 )
