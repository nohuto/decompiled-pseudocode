/*
 * XREFs of RaAdapterStartPowerIo @ 0x1C0007088
 * Callers:
...
__int64 __fastcall RaAdapterStartPowerIo(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(_QWORD *)(v5 + 208) = v7;
  ...
  {
    v10 = a3;
    *(_QWORD *)(v5 + 168) = *(_QWORD *)(a3 + 80);
    *(_QWORD *)(v5 + 176) = *(_QWORD *)(a3 + 64);
    *(_QWORD *)(a3 + 96) = v5;
    *(_QWORD *)(a3 + 80) = a2;
  }
  else
  {
    *(_QWORD *)(v5 + 168) = *(_QWORD *)(a3 + 48);
    *(_QWORD *)(v5 + 176) = *(_QWORD *)(a3 + 24);
    *(_QWORD *)(a3 + 48) = v5;
  }
  ...
  *(_QWORD *)(v5 + 648) = a5;
  ...
  if ( v13 < 0 )
  {
    if ( *(_BYTE *)(a3 + 2) == 40 )
    {
      *(_QWORD *)(v10 + 64) = *(_QWORD *)(v5 + 176);
    }
    else
    {
      *(_QWORD *)(a3 + 48) = *(_QWORD *)(v5 + 168);
      *(_QWORD *)(a3 + 24) = *(_QWORD *)(v5 + 176);
    }
