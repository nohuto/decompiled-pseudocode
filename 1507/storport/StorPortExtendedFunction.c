/*
 * XREFs of StorPortExtendedFunction @ 0x1C0005260
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidAdapterCacheOperationalPowerRange @ 0x1C0026FD8 (RaidAdapterCacheOperationalPowerRange.c)
 ...
 *     StorpAllocateContiguousMemorySpecifyCacheNode @ 0x1C0028B48 (StorpAllocateContiguousMemorySpecifyCacheNode.c)
 ...
 *     StorpFlushDataBufferMdl @ 0x1C0028F14 (StorpFlushDataBufferMdl.c)
 ...
 *     StorpGetActiveNodeCount @ 0x1C00293F4 (StorpGetActiveNodeCount.c)
 *     StorpGetDataInSgList @ 0x1C0029474 (StorpGetDataInSgList.c)
 *     StorpGetOriginalMdl @ 0x1C0029690 (StorpGetOriginalMdl.c)
 *     StorpGetRequestInfo @ 0x1C0029708 (StorpGetRequestInfo.c)
  ...
  if ( v10 != 15 )
  {
    ...
    switch ( v10 )
    {
      ...
      case 1u:
        ...
        {
          WPP_SF_(v13->AttachedDevice, 30LL, &WPP_8a1d37565fd3ed53073ecf5f585bed2d_Traceguids, a4);
...
LABEL_36:
        WPP_SF_(v13->AttachedDevice, v19, &WPP_8a1d37565fd3ed53073ecf5f585bed2d_Traceguids, a4);
        return (unsigned int)-1056964602;
      case 9u:
...
LABEL_201:
        ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v32 + 1432));
        return v12;
      case 0x35u:
        v51 = **(_QWORD **)(v11 - 16);
        v52 = a9;
        *(_QWORD *)&v92.Length = a8;
        ...
        if ( v96 )
        {
          ...
          {
            v55 = PoFxPowerControl(**(_QWORD **)(v54 + 1440), v97, a5, a6, a7, *(_QWORD *)&v92.Length, v52);
            v12 = RaidNtStatusToStorStatus(v55);
            ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v54 + 1432));
            return v12;
          }
        }
        else
...
LABEL_270:
      ...
      default:
        if ( v13 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v13->Timer) & 0x10) != 0 && BYTE1(v13->Timer) >= 2u )
          WPP_SF_D(v13->AttachedDevice, 80LL, &WPP_8a1d37565fd3ed53073ecf5f585bed2d_Traceguids, v10);
        return v12;
    }
  }
