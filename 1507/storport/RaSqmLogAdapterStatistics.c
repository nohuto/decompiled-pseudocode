/*
 * XREFs of RaSqmLogAdapterStatistics @ 0x1C0026118
 * Callers:
 ...
 *     StorSqmCreateStringStreamEntry @ 0x1C003B674 (StorSqmCreateStringStreamEntry.c)
 */

KSPIN_LOCK *RaSqmLogAdapterStatistics()
{
  ...
  if ( result )
  {
    KeAcquireInStackQueuedSpinLock(result + 3, &LockHandle);
    v2 = v1 + 1;
    ...
    return (KSPIN_LOCK *)RaidReleasePortData(v1);
  }
  return result;
}
