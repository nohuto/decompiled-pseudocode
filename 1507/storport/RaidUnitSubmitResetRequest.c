/*
 * XREFs of RaidUnitSubmitResetRequest @ 0x1C0034010
 * Callers:
...
__int64 __fastcall RaidUnitSubmitResetRequest(__int64 a1, IRP *a2)
{
  ...
  if ( (_DWORD)CurrentStackLocation == 16 )
  {
    ContiguousNodeMemory = MmAllocateContiguousNodeMemory(
                             ((*(_DWORD *)(*(_QWORD *)(a1 + 24) + 444LL) + 7) & 0xFFFFFFF8) + 1040,
    ...
    if ( ContiguousNodeMemory )
    {
      ...
      *((_QWORD *)&v18 + 1) = ContiguousNodeMemory + 784;
      *((_QWORD *)&v17 + 1) = ContiguousNodeMemory + 1040;
      RaidZeroXrb(ContiguousNodeMemory + 16, ContiguousNodeMemory + 784, 0, 0LL);
      LODWORD(v17) = -1;
      goto LABEL_9;
    }
LABEL_24:
  ...
  if ( _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 1424), 1, 0) )
    goto LABEL_24;
  v7 = *(_OWORD *)(a1 + 1408);
  v17 = *(_OWORD *)(a1 + 1392);
  v18 = v7;
...
LABEL_23:
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1440) + 32LL) & 2) != 0
  ...
  Pool[2] = a2;
  v11 = (__int64 *)(*(_QWORD *)(a1 + 1440) + 72LL);
  v12 = *v11;
  *Pool = *v11;
  Pool[1] = v11;
