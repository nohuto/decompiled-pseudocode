/*
 * XREFs of RaidSelectDeviceDumpCollectionMode @ 0x1C000D564
 * Callers:
 ...
 *     RaidRegGetDeviceDumpSupportLevel @ 0x1C000DE1C (RaidRegGetDeviceDumpSupportLevel.c)
 *     RaidRegGetDeviceDumpMaxSize @ 0x1C000DE88 (RaidRegGetDeviceDumpMaxSize.c)
