/*
 * XREFs of RaCallMiniportFindAdapter @ 0x1C0007E88
 * Callers:
  ...
  *((_BYTE *)a1 + 248) &= ~1u;
  if ( v7 == 1 && (!*((_BYTE *)v6 + 90) || !*((_BYTE *)v6 + 91) || !*((_BYTE *)v6 + 81) || !*((_BYTE *)v6 + 82)) )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 10LL, &WPP_8b94a8023d17ea1b6cc505053ff983f2_Traceguids, a4);
        v19 = WPP_GLOBAL_Control;
      }
      if ( v19 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v19->Timer) & 2) != 0 && BYTE1(v19->Timer) >= 2u )
        WPP_SF_(v19->AttachedDevice, 11LL, &WPP_8b94a8023d17ea1b6cc505053ff983f2_Traceguids, a4);
    }
LABEL_36:
    v4 = -1073741438;
    goto LABEL_18;
