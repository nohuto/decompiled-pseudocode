/*
 * XREFs of StorpSetUnitAttributes @ 0x1C0029DF4
 * Callers:
...
__int64 __fastcall StorpSetUnitAttributes(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( !Unit )
    return 3238002694LL;
  *(_DWORD *)(Unit + 1520) ^= (*(_DWORD *)(Unit + 1520) ^ (2 * a3)) & 2;
  v5 = *(_DWORD *)(Unit + 1520) ^ ((unsigned __int8)*(_DWORD *)(Unit + 1520) ^ (unsigned __int8)(2 * a3)) & 4;
  *(_DWORD *)(Unit + 1520) = v5;
  *(_DWORD *)(Unit + 1520) = v5 ^ ((unsigned __int8)v5 ^ (unsigned __int8)(2 * a3)) & 8;
  return 0LL;
}
