/*
 * XREFs of RaidUnitMaintenanceTime @ 0x1C002B9DC
 * Callers:
...
void __fastcall RaidUnitMaintenanceTime(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
      ...
      && !_interlockedbittestandset((volatile signed __int32 *)(v3 + 148), 0) )
    {
      ...
      {
        if ( !*(_QWORD *)(v5 + 128) )
          *(_QWORD *)(*(_QWORD *)(a1 + 1440) + 128LL) = ExAllocateTimer(RaidUnitEndMaintenanceTime, a1, 0LL);
        v6 = *(_QWORD *)(a1 + 1440);
        if ( *(_QWORD *)(v6 + 128) )
        {
          ...
          *(_DWORD *)(*(_QWORD *)(a1 + 1440) + 144LL) = 0;
          ExSetTimer(*(_QWORD *)(*(_QWORD *)(a1 + 1440) + 128LL), -600000000LL, 0LL, 0LL);
        }
        else
        {
          *(_DWORD *)(v6 + 148) &= ~1u;
