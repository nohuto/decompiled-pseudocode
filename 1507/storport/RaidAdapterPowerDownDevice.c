/*
 * XREFs of RaidAdapterPowerDownDevice @ 0x1C0006D38
 * Callers:
...
__int64 __fastcall RaidAdapterPowerDownDevice(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 23LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, a1, a2);
  }
  ...
  *(_BYTE *)(*(_QWORD *)(a2 + 184) + 3LL) |= 1u;
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 24LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, a1, a2, v4);
  }
  return 259LL;
}
