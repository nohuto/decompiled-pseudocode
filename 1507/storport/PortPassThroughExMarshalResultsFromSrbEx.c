/*
 * XREFs of PortPassThroughExMarshalResultsFromSrbEx @ 0x1C003A290
 * Callers:
 *     PortpCompleteRequestIrp @ 0x1C003A9FC (PortpCompleteRequestIrp.c)
 * Callees:
 *     memmove @ 0x1C0012FC0 (memmove.c)
 *     PortPassThroughExApplyNormalizedRequest @ 0x1C003A10C (PortPassThroughExApplyNormalizedRequest.c)
