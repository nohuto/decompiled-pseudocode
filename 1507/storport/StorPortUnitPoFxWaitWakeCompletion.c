/*
 * XREFs of StorPortUnitPoFxWaitWakeCompletion @ 0x1C002D1E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PIO_STATUS_BLOCK IoStatus)
{
  ...
  {
    *(_QWORD *)(*(_QWORD *)(Context + 1440) + 64LL) = 0LL;
    if ( Status >= 0 )
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(Context + 32), &LockHandle);
      v7 = *(_QWORD *)(Context + 1440);
      *(_DWORD *)(Context + 528) = 2;
      *(_DWORD *)(v7 + 32) |= 0x10u;
      KeReleaseInStackQueuedSpinLock(&LockHandle);
    }
    if ( (*(_DWORD *)(Context + 188) != 1 || (*(_BYTE *)(Context + 145) & 1) != 0)
      && !_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(Context + 1440) + 36LL), 1, 0) )
    {
