/*
 * XREFs of RaidCreateUnit @ 0x1C000DEF0
 * Callers:
...
NTSTATUS __fastcall RaidCreateUnit(__int64 a1, _QWORD *a2)
{
  ...
  result = IoCreateDevice(*(PDRIVER_OBJECT *)(*(_QWORD *)(a1 + 8) + 8LL), 0x940u, 0LL, 0x2Du, 0x180u, 0, &DeviceObject);
  if ( result >= 0 )
  {
    ...
    *(_WORD *)(DeviceExtension + 1429) = 256;
    DeviceExtension[1431] = 1;
    ...
    *((_DWORD *)DeviceExtension + 10) = 0;
    ...
    else
    {
      ...
      *((_QWORD *)DeviceExtension + 180) = 0LL;
      ...
      *((_DWORD *)DeviceExtension + 374) = 10;
      result = 0;
      *((_DWORD *)DeviceExtension + 375) = 25;
      *((_DWORD *)DeviceExtension + 376) = 125;
      *a2 = DeviceExtension;
    }
  }
  return result;
