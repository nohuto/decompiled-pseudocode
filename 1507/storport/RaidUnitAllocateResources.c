/*
 * XREFs of RaidUnitAllocateResources @ 0x1C000E10C
 * Callers:
 ...
 *     StorCreateEventQueue @ 0x1C000F29C (StorCreateEventQueue.c)
...
__int64 __fastcall RaidUnitAllocateResources(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 624) = 1;
  ...
  KeInitializeDpc((PRKDPC)(a1 + 896), RaidUnitRestartQueueDpcRoutine, *(PVOID *)(a1 + 8));
  KeInitializeDpc((PRKDPC)(a1 + 704), (PKDEFERRED_ROUTINE)RaidUnitPendingDpcRoutine, *(PVOID *)(a1 + 8));
  KeInitializeTimer((PKTIMER)(a1 + 640));
  KeInitializeTimer((PKTIMER)(a1 + 768));
  KeInitializeDpc((PRKDPC)(a1 + 832), RaidUnitPauseTimerDpcRoutine, *(PVOID *)(a1 + 8));
  KeSetCoalescableTimer((PKTIMER)(a1 + 640), (LARGE_INTEGER)-20000000LL, 0x7D0u, 0x12Cu, (PKDPC)(a1 + 704));
  EventQueue = StorCreateEventQueue(a1 + 200, 0LL);
  if ( EventQueue < 0 )
    goto LABEL_20;
  v4 = (_QWORD *)(a1 + 256);
  ...
  KeInitializeSpinLock((PKSPIN_LOCK)(a1 + 1488));
  v5 = *(_QWORD *)(a1 + 8);
  v6 = *(_QWORD *)(a1 + 24);
  v7 = *(_DWORD *)(v1 + 512);
  *(_DWORD *)(a1 + 512) = 0;
...
LABEL_6:
  ...
  {
    *(_DWORD *)(a1 + 1392) = v10;
    v11 = ((*(_DWORD *)(*(_QWORD *)(a1 + 24) + 444LL) + 7) & 0xFFFFFFF8) + 1040;
    if ( *(_BYTE *)(v1 + 402) == 1 )
      v11 = ((*(_DWORD *)(*(_QWORD *)(a1 + 24) + 444LL) + 7) & 0xFFFFFFF8) + 1184;
    ...
    {
      *(_QWORD *)(a1 + 1408) = ContiguousNodeMemory + 16;
      *(_QWORD *)(a1 + 1416) = ContiguousNodeMemory + 784;
      *(_QWORD *)(a1 + 1400) = ContiguousNodeMemory + 1040;
      RaidZeroXrb(ContiguousNodeMemory + 16, v13, 0LL, 0LL);
      if ( *(_BYTE *)(v1 + 402) == 1 )
      {
        *(_DWORD *)(v14 + 744) = 144;
        *(_QWORD *)(v14 + 760) = v14 + ((*(_DWORD *)(*(_QWORD *)(a1 + 24) + 444LL) + 7) & 0xFFFFFFF8) + 1040LL;
      }
      WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(a1 + 8));
      *(_QWORD *)(a1 + 1544) = WorkItem;
      if ( WorkItem )
      {
        ...
        if ( v16 )
        {
          ...
          *(_QWORD *)(a1 + 1584) = v18;
          if ( v18 )
          {
            ...
            *(_QWORD *)(a1 + 1432) = CacheAwareRundownProtection;
