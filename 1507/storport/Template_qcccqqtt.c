/*
 * XREFs of Template_qcccqqtt @ 0x1C002E1D8
 * Callers:
...
NTSTATUS __fastcall Template_qcccqqtt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v24 = 4LL;
  v26 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventUnitIdleTimeoutValue, 0LL, 8u, &UserData);
}
