/*
 * XREFs of RaidUnitResetUnit @ 0x1C00336F4
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C0036490 (StorpAggregateHierarchicalResetLun.c)
 */
...
__int64 __fastcall RaidUnitResetUnit(__int64 a1)
{
  ...
  char v21; // r12
  __int64 v22; // rax
  __int16 v24; // [rsp+48h] [rbp-C0h] BYREF
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0044050 > 5 )
      {
        ...
        v45 = 1LL;
        v47 = 8LL;
        TlgWrite((TraceLoggingHProvider)(v22 + 5412), &unk_1C003D0A5, v17, v18, 0xAu, &pData);
      }
