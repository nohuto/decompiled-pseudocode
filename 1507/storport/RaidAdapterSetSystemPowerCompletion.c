/*
 * XREFs of RaidAdapterSetSystemPowerCompletion @ 0x1C0007170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 42LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v2, a2);
    v5 = WPP_GLOBAL_Control;
  }
  v6 = *(_QWORD *)(a2 + 184);
  v7 = *(int *)(v6 + 24);
...
LABEL_6:
  ...
  if ( v5 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v5->Timer) & 4) != 0 && BYTE1(v5->Timer) >= 4u )
    WPP_SF_qqD(v5->AttachedDevice, 43LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, v2, a2, v11);
