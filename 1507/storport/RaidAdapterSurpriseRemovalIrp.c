/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C0053420
 * Callers:
 ...
 *     RaidAdapterMarkChildrenMissing @ 0x1C0021B54 (RaidAdapterMarkChildrenMissing.c)
...
NTSTATUS __fastcall RaidAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 88) = 5;
  ...
  if ( (unsigned int)dword_1C0044050 > 5 && TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
  {
    v21 = 0;
    v24 = 0;
    v27 = 0;
    ...
    v29 = 1;
    v32 = 4;
    TlgWrite((TraceLoggingHProvider)4, &unk_1C003CC1B, v9, v10, 7u, &pData);
  }
