/*
 * XREFs of StorPortInitialize @ 0x1C0007C00
 * Callers:
 *     StorPortInitializeVrfy @ 0x1C0054830 (StorPortInitializeVrfy.c)
 * Callees:
...
__int64 __fastcall StorPortInitialize(PDRIVER_OBJECT DriverObject, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v8 = 0;
  if ( !*((_BYTE *)&WPP_MAIN_CB.Reserved + 8) )
  {
    _security_init_cookie();
    *((_BYTE *)&WPP_MAIN_CB.Reserved + 8) = 1;
  }
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqqq(
      ...
      10LL,
      &WPP_872bee7d305160f9e2f0de378efd3d40_Traceguids,
      DriverObject,
      a2,
      a3,
      a4);
