/*
 * XREFs of Template_pqtqcccqqqqt @ 0x1C003605C
 * Callers:
...
NTSTATUS Template_pqtqcccqqqqt(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v24 = 4LL;
  v26 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventPassThroughProtocolCommand, a3, 0xCu, &UserData);
}
