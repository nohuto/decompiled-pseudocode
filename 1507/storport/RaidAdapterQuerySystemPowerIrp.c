/*
 * XREFs of RaidAdapterQuerySystemPowerIrp @ 0x1C0006674
 * Callers:
...
__int64 __fastcall RaidAdapterQuerySystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 32LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, a1, a2);
  }
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.QueryDeviceRelations + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.QueryDeviceRelations
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 33LL, &WPP_e109923e46317c4616adabc68839fe07_Traceguids, a1, a2, 259);
  }
  return 259LL;
}
