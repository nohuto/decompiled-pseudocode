/*
 * XREFs of RaUnitScsiGetDumpPointersIoctl @ 0x1C000B640
 * Callers:
 ...
 *     StorPortGetAdditionalCrashDumpArea @ 0x1C0008F80 (StorPortGetAdditionalCrashDumpArea.c)
 *     RaidQueryCrashdumpFunctions @ 0x1C000902C (RaidQueryCrashdumpFunctions.c)
 *     RaidDriverGetName @ 0x1C00090F8 (RaidDriverGetName.c)
 *     RtlStringCbPrintfW @ 0x1C000D9D8 (RtlStringCbPrintfW.c)
...
__int64 __fastcall RaUnitScsiGetDumpPointersIoctl(__int64 a1, IRP *a2)
{
  ...
  struct _KEVENT *BaseAddress; // [rsp+C8h] [rbp+20h]
...
LABEL_70:
  ...
  *(_OWORD *)&v9[4].StartVa = *(_OWORD *)(v2 + 512);
  ...
  {
    if ( (int)PoFxRegisterCrashdumpDevice(**(_QWORD **)(a1 + 1440)) >= 0 )
    {
      *(_BYTE *)p_ByteCount = 1;
      v6 = 1;
      v9[6].Next = **(_MDL ***)(a1 + 1440);
    }
...
LABEL_13:
  v16 = 0;
  *(_QWORD *)&v9[6].Size = a1 + 1430;
  v17 = *(_QWORD *)(a1 + 24) + 4989LL;
  v9[6].Process = (struct _EPROCESS *)(a1 + 1431);
  ...
  *(_DWORD *)(&MasterIrp->Size + 1) = 104;
  ...
  MasterIrp->UserEvent = (_KEVENT *)(a1 + 1431);
...
LABEL_67:
  ...
  if ( !v22
    ...
    || (ContiguousNodeMemory = MmAllocateContiguousNodeMemory(
                                 ((*(_DWORD *)(v2 + 444) + 7) & 0xFFFFFFF8) + 1040,
                                 *(_QWORD *)(v2 + 4392),
                                 *(_QWORD *)(v2 + 4400),
                                 *(_QWORD *)(v2 + 4384),
                                 4,
                                 0x80000000),
        BaseAddress = (struct _KEVENT *)ContiguousNodeMemory,
...
LABEL_138:
  ...
  p_Blink = ContiguousNodeMemory + 16;
  RaidZeroXrb(ContiguousNodeMemory + 16, v25, 0LL, 0LL);
  *(_BYTE *)(p_Blink + 17) |= 8u;
  *(_QWORD *)(p_Blink + 168) = a2;
  *(_QWORD *)(p_Blink + 176) = v23;
  *(_QWORD *)(p_Blink + 160) = Srb;
  if ( *(_BYTE *)(v2 + 402) == 1 )
  {
    *((_QWORD *)Srb + 10) = a2;
    *((_DWORD *)Srb + 6) = 256;
    v43 = *((_DWORD *)Srb + 6);
    *((_QWORD *)Srb + 12) = p_Blink;
    *((_DWORD *)Srb + 5) = 38;
    *((_QWORD *)Srb + 8) = v23;
    *((_DWORD *)Srb + 15) = 112;
    v29 = *(_BYTE *)(v2 + 4450) == 0;
  ...
  RaSrbSetMiniportContext(v2, Srb, v26 + 1040, v27);
  KeInitializeEvent((PRKEVENT)(p_Blink + 656), NotificationEvent, 0);
  *(_QWORD *)(p_Blink + 648) = RaidXrbSignalCompletion;
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) != 0
    && BYTE1(WPP_GLOBAL_Control->Timer) )
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 30LL, &WPP_0a9d81cc67956adf3a94d0464afc2bb3_Traceguids, p_Blink, Srb);
  }
  if ( *(_BYTE *)(v2 + 4450) )
    v30 = RaidAdapterRaiseIrqlAndExecuteXrb(v2, p_Blink);
  else
    v30 = RaidAdapterExecuteXrb(v2, p_Blink);
  v16 = v30;
  if ( v30 >= 0 )
  {
    KeWaitForSingleObject((PVOID)(p_Blink + 656), Executive, 0, 0, 0LL);
    LOBYTE(v31) = Srb[3];
  ...
  if ( v16 < 0 )
  {
    if ( !*(_BYTE *)(v2 + 4450) )
    {
      if ( v32 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v32->Timer) & 0x100) != 0 && BYTE1(v32->Timer) )
        WPP_SF_qD(v32->AttachedDevice, 32LL, &WPP_0a9d81cc67956adf3a94d0464afc2bb3_Traceguids, p_Blink, v16);
      goto LABEL_136;
    }
    v16 = 0;
    goto LABEL_67;
...
LABEL_49:
  ...
  if ( v45 )
  {
    ...
    *((_WORD *)v47 + 14) = 2;
    ...
    if ( Srb )
    {
      v33 = BaseAddress;
      if ( BaseAddress
        || (BaseAddress = (struct _KEVENT *)MmAllocateContiguousNodeMemory(
                                              ((*(_DWORD *)(v2 + 444) + 7) & 0xFFFFFFF8) + 1040,
                                              *(_QWORD *)(v2 + 4392),
                                              *(_QWORD *)(v2 + 4400),
                                              *(_QWORD *)(v2 + 4384),
            ...
            (v33 = BaseAddress) != 0LL) )
      {
        p_Blink = (__int64)&v33->Header.WaitListHead.Blink;
        RaidZeroXrb(&v33->Header.WaitListHead.Blink, v48, 0LL, 0LL);
        v33[7].Header.WaitListHead.Blink = (_LIST_ENTRY *)a2;
        *(_QWORD *)&v33[8].Header.Lock = v47;
        v33[7].Header.WaitListHead.Flink = (_LIST_ENTRY *)Srb;
        if ( *(_BYTE *)(v2 + 402) == 1 )
        {
        ...
        RaSrbSetMiniportContext(v2, Srb, &v33[43].Header.WaitListHead, v49);
        KeInitializeEvent(v33 + 28, NotificationEvent, 0);
        v33[27].Header.WaitListHead.Blink = (_LIST_ENTRY *)RaidXrbSignalCompletion;
        if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) != 0
          && BYTE1(WPP_GLOBAL_Control->Timer) )
        {
        ...
        v51 = RaidAdapterRaiseIrqlAndExecuteXrb(v2, p_Blink);
        if ( v51 >= 0 )
        {
          KeWaitForSingleObject(&v33[28], Executive, 0, 0, 0LL);
          LOBYTE(v52) = Srb[3];
  ...
  else
  {
    ...
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 35LL, &WPP_0a9d81cc67956adf3a94d0464afc2bb3_Traceguids, v46);
  }
  v32 = WPP_GLOBAL_Control;
LABEL_128:
  v16 = (int)v33;
LABEL_50:
  ...
  if ( v32 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v32->Timer) & 0x100) != 0 && BYTE1(v32->Timer) )
    WPP_SF_D(v32->AttachedDevice, 37LL, &WPP_0a9d81cc67956adf3a94d0464afc2bb3_Traceguids, (unsigned int)v16);
LABEL_136:
  v41 = a2;
LABEL_56:
  if ( v16 < 0 )
...
LABEL_57:
  if ( BaseAddress )
  {
    RaidXrbDeallocateResources(p_Blink, 0LL);
