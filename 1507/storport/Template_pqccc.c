/*
 * XREFs of Template_pqccc @ 0x1C002A0C4
 * Callers:
...
NTSTATUS Template_pqccc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 1LL;
  v12 = 1LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventPortResumeDevice, 0LL, 5u, &UserData);
}
