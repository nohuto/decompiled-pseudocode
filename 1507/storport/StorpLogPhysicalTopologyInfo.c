/*
 * XREFs of StorpLogPhysicalTopologyInfo @ 0x1C00375D4
 * Callers:
 ...
 *     _TlgCreateWsz @ 0x1C001000C (_TlgCreateWsz.c)
...
char __fastcall StorpLogPhysicalTopologyInfo(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (unsigned int)dword_1C0044050 > 5 && TlgKeywordOn(v8, 0x400000000000uLL) )
  {
    hProvider.LevelPlus1 = v11;
    hProvider.AnnotationFunc = (void (*)(...))(a1 + 5412);
    v37 = v6;
    v38 = v7;
    v40 = 16LL;
    ...
    v45 = 4LL;
    v47 = 4LL;
    TlgWrite(&hProvider, &unk_1C003DF84, v12, v13, 7u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAll);
  }
