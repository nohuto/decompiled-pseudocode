/*
 * XREFs of QueryFeatureOverride @ 0x1C002F23C
 * Callers:
 *     EvaluateCurrentStateFromRegistry @ 0x1C002F1B8 (EvaluateCurrentStateFromRegistry.c)
 * Callees:
...
__int64 __fastcall QueryFeatureOverride(ULONG a1, _DWORD *a2)
{
  ...
  *(_DWORD *)&String.Length = 0x200000;
  v5 = 0;
  String.Buffer = (unsigned __int16 *)&v9;
