/*
 * XREFs of ?ProcessRangeInCache@@YAXPEAUtagMOUSE_PROMOTION_CACHE@@PEAUtagMOUSE_PROMOTION_ENTRY@@1HH@Z @ 0x1C023A404
 * Callers:
        ...
        int a5)
{
  ...
  *(_OWORD *)v14 = 0LL;
  ...
  if ( v10 )
    AppendMousePromotionQueue((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0322CA0, v10, v9);
}
