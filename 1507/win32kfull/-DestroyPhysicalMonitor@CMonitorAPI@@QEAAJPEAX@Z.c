/*
 * XREFs of ?DestroyPhysicalMonitor@CMonitorAPI@@QEAAJPEAX@Z @ 0x1C025C420
 * Callers:
 *     DestroyPhysicalMonitor @ 0x1C025C7B0 (DestroyPhysicalMonitor.c)
 *     NtGdiDestroyPhysicalMonitor @ 0x1C025CA30 (NtGdiDestroyPhysicalMonitor.c)
 * Callees:
