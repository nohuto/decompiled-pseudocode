/*
 * XREFs of ?UpdateTPContactState@@YAXIPEAUtagTPSTATE@@PEAUtagPOINTERINFONODE@@@Z @ 0x1C01F2E7C
 * Callers:
...
void __fastcall UpdateTPContactState(unsigned int a1, struct tagTPSTATE *a2, struct tagPOINTERINFONODE *a3)
{
  ...
  if ( v3 )
  {
    if ( (v3 & 0x40000) != 0 )
    {
      if ( (*((_DWORD *)v4 + 42) & 0x200) != 0 )
        *((_DWORD *)a2 + 316) &= ~0x20000u;
      if ( *((_DWORD *)a2 + 270) == 2 && a1 == *((_DWORD *)a2 + 264) )
        *((_DWORD *)a2 + 316) &= ~0x4000000u;
      v5 = *((_DWORD *)v4 + 42);
      if ( (v5 & 0x10000) != 0 )
      {
        v6 = v5 & 0xFFFEFFFF;
      ...
      *((_DWORD *)v4 + 42) = v6;
      v7 = *((_DWORD *)a2 + 270);
      if ( (v7 == 3 || v7 == 6) && a1 == *((_DWORD *)a2 + 265) )
        *((_DWORD *)a2 + 316) &= ~0x400u;
    }
    else
    {
