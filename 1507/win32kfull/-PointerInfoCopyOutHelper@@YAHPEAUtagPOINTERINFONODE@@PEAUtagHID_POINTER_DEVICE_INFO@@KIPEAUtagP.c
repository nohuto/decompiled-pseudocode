/*
 * XREFs of ?PointerInfoCopyOutHelper@@YAHPEAUtagPOINTERINFONODE@@PEAUtagHID_POINTER_DEVICE_INFO@@KIPEAUtagPOINTER_INFO@@@Z @ 0x1C01F8F08
 * Callers:
 *     ?GetPointerData@@YAH_KKIPEAUtagPOINTER_INFO@@@Z @ 0x1C01F7E04 (-GetPointerData@@YAH_KKIPEAUtagPOINTER_INFO@@@Z.c)
 *     ?GetPointerDataWithHistory@@YAH_KKKPEAIPEAE@Z @ 0x1C01F8034 (-GetPointerDataWithHistory@@YAH_KKKPEAIPEAE@Z.c)
 *     ?GetPointerFrameData@@YAHPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@KIPEAIPEAE@Z @ 0x1C01F81FC (-GetPointerFrameData@@YAHPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@KIPEAIPEAE@Z.c)
        ...
        struct tagPOINTER_INFO *a5)
{
  ...
  v15 = *(_DWORD *)(ThreadWin32Thread + 1080) & 0x2000;
  if ( (*(_DWORD *)(ThreadWin32Thread + 1080) & 0x2000) != 0 )
    v11 = 0;
  if ( a3 == 2 || a3 == 5 )
  {
    v32 = *((__m128i *)a1 + 10);
  ...
  if ( (*(_DWORD *)(PsGetCurrentProcessWin32Process(v15) + 776) & 0x4000) == 0 )
  {
    ...
    if ( *(_DWORD *)(gpDispInfo + 80LL) > 1u
      && *(_QWORD *)&v12
      && ((*(_DWORD *)(*(_QWORD *)&v12 + 236LL) & 8) != 0 || *(_DWORD *)(*(_QWORD *)&v12 + 24LL) == 7) )
    {
...
LABEL_43:
  if ( v23 )
  {
    if ( *((_DWORD *)a1 + 14) == 5 )
    {
      ...
      if ( (*(_BYTE *)(W32GetThreadWin32Thread((__int64)CurrentThread) + 1082) & 1) == 0 )
        *((_QWORD *)a5 + 2) = -2LL;
    }
    if ( v11 )
    {
