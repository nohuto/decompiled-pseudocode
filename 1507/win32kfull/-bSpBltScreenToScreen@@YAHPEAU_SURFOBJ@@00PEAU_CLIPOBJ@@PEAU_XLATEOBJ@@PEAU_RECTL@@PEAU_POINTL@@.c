/*
 * XREFs of ?bSpBltScreenToScreen@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C026F850
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bRedo@UNDOW32THREADPIDLOCKS@@QEAAHXZ @ 0x1C014CD90 (-bRedo@UNDOW32THREADPIDLOCKS@@QEAAHXZ.c)
        ...
        unsigned int a11)
{
  ...
  LONG v46; // [rsp+8Ch] [rbp-7Ch]
  int v47; // [rsp+90h] [rbp-78h]
  int v48; // [rsp+94h] [rbp-74h]
  struct _POINTL v49[2]; // [rsp+98h] [rbp-70h] BYREF
  struct _RECTL v50; // [rsp+A8h] [rbp-60h] BYREF
  HDEV hdev; // [rsp+B8h] [rbp-50h] BYREF
  int v52[2]; // [rsp+C0h] [rbp-48h]
  struct REGION *v53; // [rsp+C8h] [rbp-40h] BYREF
  __int64 v54; // [rsp+D0h] [rbp-38h] BYREF
  int v55[2]; // [rsp+D8h] [rbp-30h]
  struct SPRITE *v56; // [rsp+E0h] [rbp-28h] BYREF
  int v57; // [rsp+E8h] [rbp-20h]
  struct _SPRITESTATE *v58; // [rsp+F0h] [rbp-18h]
  int v59; // [rsp+F8h] [rbp-10h]
  int v60; // [rsp+FCh] [rbp-Ch]
  struct _SURFOBJ *v61; // [rsp+100h] [rbp-8h]
  __int64 v62; // [rsp+108h] [rbp+0h] BYREF
  struct SPRITE *v63; // [rsp+110h] [rbp+8h] BYREF
  __int64 v64; // [rsp+118h] [rbp+10h]
  struct _SURFOBJ *v65; // [rsp+120h] [rbp+18h]
  struct SPRITE *v66; // [rsp+128h] [rbp+20h] BYREF
  __int64 v67; // [rsp+130h] [rbp+28h]
  struct _POINTL *v68; // [rsp+138h] [rbp+30h]
  __int64 v69; // [rsp+140h] [rbp+38h]
  _BYTE v70[16]; // [rsp+148h] [rbp+40h] BYREF
  ...
  v17 = v12->left - a7->x;
  v18 = v12->top - a7->y;
  v58 = (struct _SPRITESTATE *)(hdev + 24);
  v45 = v17;
  v59 = v18;
  if ( v17 <= 0 )
  {
...
LABEL_22:
  ...
  do
  {
    v60 = ENUMAREAS::bEnum((ENUMAREAS *)v74, &v56, &v50);
    ...
    do
    {
      if ( v56 )
      {
        v26 = (struct _SURFOBJ *)*((_QWORD *)v56 + 20);
        *(_QWORD *)v52 = (char *)v56 + 168;
      }
      else
      {
        v26 = v61;
      ...
      do
      {
        v57 = ENUMAREAS::bEnum((ENUMAREAS *)v76, &v63, &v80);
        if ( (unsigned int)ENUMAREAS::bEnumLayers((ENUMAREAS *)v76, &v66) )
        {
          do
          {
            v27 = v66;
        ...
        *(_QWORD *)v55 = v29;
        ...
        {
          v54 = SURFOBJ_TO_SURFACE_NOT_NULL(v26);
          GreLockDisplayDevice(*(_QWORD *)(v54 + 48));
        }
        v30 = 0LL;
        if ( v28
        ...
        if ( !v42 )
        {
          ...
          if ( ThreadWin32Thread )
          {
            if ( *(_BYTE *)(ThreadWin32Thread + 328) == 1 )
            {
              ...
              v34 = (XCLIPOBJ *)(*(_QWORD *)v33 + 2184LL);
              v53 = XDCOBJ::prgnEffRao(v33);
              if ( (*(_DWORD *)(v35 + 56) & 0x20000) != 0 )
              {
                v49[0].x = -v46;
                v49[0].y = -v44;
                RGNOBJ::bOffset((RGNOBJ *)&v53, v49);
                v48 = 1;
              }
        ...
        if ( NEEDDDILOCK::bRender((NEEDDDILOCK *)&v54, &v42) )
        {
          if ( a11 == 52428 )
          {
...
LABEL_89:
          ...
          if ( v68 )
          {
            LODWORD(v62) = v79.left + v68->x - v12->left;
            HIDWORD(v62) = v79.top + v68->y - v12->top;
          }
          if ( v26->iType != 1 )
            goto LABEL_108;
          if ( bAllowShareAccess(v26)
...
LABEL_120:
      ...
      v40 = ENUMAREAS::bEnumLayers((ENUMAREAS *)v74, &v56);
      v16 = v58;
      v25 = &gptlZero;
      v19 = v43;
    }
