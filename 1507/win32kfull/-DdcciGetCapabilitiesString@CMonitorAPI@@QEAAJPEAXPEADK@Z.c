/*
 * XREFs of ?DdcciGetCapabilitiesString@CMonitorAPI@@QEAAJPEAXPEADK@Z @ 0x1C025B750
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesString @ 0x1C025C7C0 (NtGdiDDCCIGetCapabilitiesString.c)
 * Callees:
...
__int64 __fastcall CMonitorAPI::DdcciGetCapabilitiesString(CMonitorAPI *this, void *a2, char *a3, unsigned int a4)
{
  ...
  v11 = this;
  v4 = qword_1C03234C0;
  CAutoMutex::CAutoMutex((CAutoMutex *)v10, (struct CMutex *)qword_1C03234C0);
