/*
 * XREFs of ?vFillGRectDIB16_565@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02C95C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vFillGRectDIB16_565(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
  ...
  unsigned __int64 v33; // [rsp+0h] [rbp-C8h]
  char v34; // [rsp+8h] [rbp-C0h]
  unsigned __int64 v35; // [rsp+10h] [rbp-B8h]
  int v36; // [rsp+18h] [rbp-B0h]
  unsigned __int64 v37; // [rsp+20h] [rbp-A8h]
  ...
  if ( v4 < v6 )
  {
    ...
    do
    {
      ...
      v18 = v9;
      v19 = v10;
      v42 = 0x1C0000000LL + 16LL * v17 + 3282080;
      v20 = v11;
      if ( (_DWORD)v16 )
      {
        v18 = v9 + v5 * v16;
