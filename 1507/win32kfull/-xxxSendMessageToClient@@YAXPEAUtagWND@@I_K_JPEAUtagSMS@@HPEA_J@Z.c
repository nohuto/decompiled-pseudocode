/*
 * XREFs of ?xxxSendMessageToClient@@YAXPEAUtagWND@@I_K_JPEAUtagSMS@@HPEA_J@Z @ 0x1C006D340
 * Callers:
...
LABEL_10:
  ...
  v16 = 2LL * (v13 - 666);
  v17 = gSharedInfo[v16 + 6];
  if ( !v17
    || v8 <= LODWORD(gSharedInfo[v16 + 5])
  ...
  v19 = xxxDefWindowProc(a1, v8, v7, a4);
  v21 = a7;
  *a7 = v19;
  if ( v18 )
