/*
 * XREFs of NtGdiSetPixelFormat @ 0x1C02B4C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiSetPixelFormat(__int64 *a1, int a2)
{
  ...
  ULONG v20; // ecx
  struct _RECTL *v22[6]; // [rsp+20h] [rbp-79h] BYREF
  struct _RECTL v23; // [rsp+50h] [rbp-49h] BYREF
  _BYTE v24[32]; // [rsp+60h] [rbp-39h] BYREF
  _BYTE v25[112]; // [rsp+80h] [rbp-19h] BYREF
