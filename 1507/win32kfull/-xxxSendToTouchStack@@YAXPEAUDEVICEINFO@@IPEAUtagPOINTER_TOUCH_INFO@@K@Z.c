/*
 * XREFs of ?xxxSendToTouchStack@@YAXPEAUDEVICEINFO@@IPEAUtagPOINTER_TOUCH_INFO@@K@Z @ 0x1C01DC4A8
 * Callers:
...
void __fastcall xxxSendToTouchStack(struct DEVICEINFO *a1, unsigned int a2, struct tagPOINTER_TOUCH_INFO *a3, ULONG a4)
{
  ...
  *((_DWORD *)a1 + 64) = 0;
  v4 = 0;
  v6 = (int)a3;
  for ( *((_QWORD *)a1 + 33) = *(unsigned __int16 *)(*((_QWORD *)a1 + 50) + 44LL); v4 < a2; v4 += 4 )
  {
    if ( v4 )
    ...
    else if ( gbDIT && *((_DWORD *)a1 + 79) && gulAnyInputSinkInSubtree )
    {
      *((_DWORD *)a1 + 24) |= 0x80u;
