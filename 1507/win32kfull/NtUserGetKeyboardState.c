/*
 * XREFs of NtUserGetKeyboardState @ 0x1C00417D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetKeyboardState(_BYTE *a1)
{
  ...
  v3 = *(_QWORD *)(ThreadWin32Thread + 416) == grpdeskRitInput;
  if ( gpqForeground )
  {
    v4 = *(_QWORD *)(gpqForeground + 372LL);
    v5 = *(_QWORD *)(ThreadWin32Thread + 384);
    v6 = *(_QWORD *)(v5 + 832);
    if ( gbEnforceUIPI )
    {
  ...
  *v9 = *v9;
  v9[255] = v9[255];
  v12 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 392);
  v13 = 0;
  v14 = a1;
  while ( v13 < 256 )
  {
