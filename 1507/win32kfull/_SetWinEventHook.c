/*
 * XREFs of _SetWinEventHook @ 0x1C004D474
 * Callers:
 ...
 *     CategoryMaskFromEventRange @ 0x1C004D640 (CategoryMaskFromEventRange.c)
...
LABEL_19:
  ...
  if ( a7 )
  {
    ...
    if ( !v19 || (*(_DWORD *)(v19 + 448) & 0x1000000) == 0 )
    {
      v20 = 1444LL;
      goto LABEL_19;
    }
  ...
  LOBYTE(a3) = 15;
  v12 = (_DWORD *)HMAllocObject(gptiCurrent, 0LL, a3, 88LL);
  v13 = v12;
  if ( !v12 )
    return 0LL;
  v12[8] = a1;
