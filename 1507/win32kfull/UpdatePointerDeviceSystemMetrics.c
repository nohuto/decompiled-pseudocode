/*
 * XREFs of UpdatePointerDeviceSystemMetrics @ 0x1C0145DF0
 * Callers:
 ...
 *     ?GetPointerDeviceType@@YAXAEAKPEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C0146058 (-GetPointerDeviceType@@YAXAEAKPEAUtagHID_POINTER_DEVICE_INFO@@@Z.c)
...
__int64 __fastcall UpdatePointerDeviceSystemMetrics(struct tagHID_POINTER_DEVICE_INFO *a1)
{
  ...
  else
  {
    ...
    while ( v9 )
    {
      if ( *((_DWORD *)v9 + 79) )
      {
        if ( *((char *)v9 + 66) >= 0 && (*((_DWORD *)v9 + 46) & 0x100) == 0 )
        {
          v10 = *((_QWORD *)v9 + 52);
          if ( *(_DWORD *)(v10 + 24) != 8 )
          {
