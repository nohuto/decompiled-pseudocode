/*
 * XREFs of ?TraceLoggingTouchInjection@@YAXHHHK@Z @ 0x1C0224DC8
 * Callers:
...
void __fastcall TraceLoggingTouchInjection(const struct _TlgProvider_t *a1, int a2, int a3)
{
  ...
  if ( (_DWORD)a1 == 1 )
  {
    if ( (unsigned int)dword_1C031D7B0 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
    {
...
LABEL_8:
      ...
      v12 = 4LL;
      v10 = 4LL;
      TlgWrite((TraceLoggingHProvider)v6, &unk_1C02EA629, v3, v4, 6u, &pData);
    }
  }
  else if ( (unsigned int)dword_1C031D7B0 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
  {
