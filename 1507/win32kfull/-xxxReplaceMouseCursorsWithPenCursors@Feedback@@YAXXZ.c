/*
 * XREFs of ?xxxReplaceMouseCursorsWithPenCursors@Feedback@@YAXXZ @ 0x1C01DB4A4
 * Callers:
...
LABEL_4:
  if ( IsDPIDWMSysMet(0x28uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v4 = 0)
      : (v4 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                        + 260LL) & 1),
        v4) )
  {
...
LABEL_20:
  ...
  do
  {
    ...
    if ( Image )
    {
      zzzSetSystemImage((struct tagCURSOR *)Image, *(_QWORD *)&gasyscur[8 * *v9 + 4]);
      UpdateSystemCursorPath(*v9, &v15);
      xxxSetMonitorIcoCurIndex((int)&v15, 0, *v9, 1);
    }
    v9 += 3;
    --v10;
  }
