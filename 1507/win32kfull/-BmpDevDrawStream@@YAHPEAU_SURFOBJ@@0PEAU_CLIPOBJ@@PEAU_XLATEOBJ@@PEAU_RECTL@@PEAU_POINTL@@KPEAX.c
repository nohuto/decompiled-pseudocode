/*
 * XREFs of ?BmpDevDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C028C560
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
  ...
  HDEV hdev; // rbx
  __int64 v15; // rdx
  __int64 (__fastcall *v16)(__int64, __int64, __int64, __int64, int, int *, unsigned int, __int64, struct _DSSTATE *); // r10
  __int64 v17; // rax
  ...
  if ( a1 )
  {
    ...
    v16 = (__int64 (__fastcall *)(__int64, __int64, __int64, __int64, int, int *, unsigned int, __int64, struct _DSSTATE *))EngDrawStream;
    if ( *(_QWORD *)(*(_QWORD *)(v15 + 48) + 3440LL) )
      v16 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, int *, unsigned int, __int64, struct _DSSTATE *))(*(_QWORD *)(v15 + 48) + 3440LL);
    if ( *(int *)(v15 + 112) >= 0 && (((_DWORD)hdev[14] & 0x20000) == 0 || *(_WORD *)(v15 + 100) != 3) )
      v16 = (__int64 (__fastcall *)(__int64, __int64, __int64, __int64, int, int *, unsigned int, __int64, struct _DSSTATE *))EngDrawStream;
    v13 = v16((__int64)a1, (__int64)a2, (__int64)a3, (__int64)a4, (int)a5, (int *)a6, a7, (__int64)a8, a9);
    v17 = UserGetHDEV();
    if ( v17 )
    {
