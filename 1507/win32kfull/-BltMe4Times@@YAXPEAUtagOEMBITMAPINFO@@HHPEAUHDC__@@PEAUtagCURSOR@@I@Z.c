/*
 * XREFs of ?BltMe4Times@@YAXPEAUtagOEMBITMAPINFO@@HHPEAUHDC__@@PEAUtagCURSOR@@I@Z @ 0x1C02357A0
 * Callers:
...
void __fastcall BltMe4Times(struct tagOEMBITMAPINFO *a1, int a2, int a3, HDC a4, struct tagCURSOR *a5, char a6)
{
  HBRUSH v9; // r9
  _DWORD *v10; // r14
  int v11; // r13d
  ...
  do
  {
    ...
    {
      v22 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
