/*
 * XREFs of sbit_GetMetrics @ 0x1C0110D58
 * Callers:
 *     fs_FindBitMapSize @ 0x1C00B3C18 (fs_FindBitMapSize.c)
 * Callees:
 *     GetSbitMetrics @ 0x1C01107A4 (GetSbitMetrics.c)
 *     SScaleX @ 0x1C01112F0 (SScaleX.c)
 *     SScaleY @ 0x1C0111308 (SScaleY.c)
 *     UScaleY @ 0x1C0111320 (UScaleY.c)
 *     UScaleX @ 0x1C0111334 (UScaleX.c)
 *     UIntMult @ 0x1C01DC8F0 (UIntMult.c)
 *     RowBytesAlign32 @ 0x1C02D9D9C (RowBytesAlign32.c)
 */
