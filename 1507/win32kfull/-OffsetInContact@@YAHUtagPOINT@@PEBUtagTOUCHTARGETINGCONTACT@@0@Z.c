/*
 * XREFs of ?OffsetInContact@@YAHUtagPOINT@@PEBUtagTOUCHTARGETINGCONTACT@@0@Z @ 0x1C022AE5C
 * Callers:
 ...
 * Callees:
 *     TouchTargetingIntersectSegment @ 0x1C024BD2C (TouchTargetingIntersectSegment.c)
 */
