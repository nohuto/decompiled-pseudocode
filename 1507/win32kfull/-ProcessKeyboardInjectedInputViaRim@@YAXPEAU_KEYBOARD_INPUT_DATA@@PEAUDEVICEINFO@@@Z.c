/*
 * XREFs of ?ProcessKeyboardInjectedInputViaRim@@YAXPEAU_KEYBOARD_INPUT_DATA@@PEAUDEVICEINFO@@@Z @ 0x1C01D7D14
 * Callers:
...
LABEL_36:
    ...
    LODWORD(v18[3]) = 0;
    xxxProcessKeyEvent((struct tagKE *)v18, 0LL, 1u, 0, (__int64)v2 + 384);
  }
}
