/*
 * XREFs of xxxInternalActivateKeyboardLayout @ 0x1C013A750
 * Callers:
...
__int64 __fastcall xxxInternalActivateKeyboardLayout(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( (a2 & 0x100) != 0 || a1 != *(_QWORD *)(gptiCurrent + 400LL) )
  {
    *(_WORD *)(a1 + 74) = 0;
    ...
    *(_QWORD *)(gptiCurrent + 376LL) = v20;
    ...
    if ( v6 )
      ++*(_DWORD *)(v6 + 8);
    if ( (*(_DWORD *)(gptiCurrent + 448LL) & 8) != 0 )
    {
      HMAssignmentLock(gptiCurrent + 400LL, a1);
      v9 = *(unsigned __int16 *)(a1 + 72);
      *(_WORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 152LL) = v9;
    }
    else
    {
      v9 = gpsi;
      ...
      if ( (a2 & 0x100) != 0 )
      {
        if ( (v10 & 4) != 0 )
        {
          v13 = (unsigned int)xxxImmActivateThreadsLayout(
                                *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 296LL),
                                0LL,
                                a1) == 0;
        }
        else
        {
          ...
          {
            v9 = i + 400;
            if ( *(_QWORD *)(i + 400) != a1 && (*(_DWORD *)(i + 448) & 1) == 0 )
            {
              HMAssignmentLock(v9, a1);
              *(_WORD *)(*(_QWORD *)(i + 440) + 152LL) = *(_WORD *)(a1 + 72);
              v9 = *(_QWORD *)(a1 + 40);
              *(_QWORD *)(*(_QWORD *)(i + 440) + 144LL) = v9;
              v12 = 1LL;
            }
          }
          v13 = (_DWORD)v12 == 0;
      ...
      else
      {
        ...
        {
          *(_WORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 152LL) = *(_WORD *)(a1 + 72);
          v9 = *(_QWORD *)(a1 + 40);
          *(_QWORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 144LL) = v9;
        }
      }
    }
    if ( gptiForeground )
    {
      if ( *(_QWORD *)(gptiForeground + 384LL) == *(_QWORD *)(gptiCurrent + 384LL) )
      {
      ...
      if ( (*(_DWORD *)(gptiCurrent + 448LL) & 8) == 0 )
      {
        if ( (*(_WORD *)(a1 + 42) & 0xF000) == 0xE000 || (v9 = gpsi, (*gpsi & 4) != 0) )
        {
          ...
          *(_QWORD *)(gptiCurrent + 376LL) = &v21;
          v22 = v12;
          ++*(_DWORD *)(v12 + 8);
          xxxSendMessage(*(struct tagWND **)(gptiCurrent + 704LL), 0x287u, 0x1FuLL, v7);
