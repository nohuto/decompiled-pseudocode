/*
 * XREFs of ?xxxGetPTPFrameContactCount@@YAJPEAUDEVICEINFO@@KPEAEPEAH2PEAK33PEAT_LARGE_INTEGER@@@Z @ 0x1C01CE970
 * Callers:
        ...
        union _LARGE_INTEGER *a9)
{
  ...
  *a9 = PerformanceCounter;
  v15 = *(unsigned int **)(v10 + 696);
  v16 = *(_DWORD *)(v10 + 704) - 1;
...
LABEL_17:
  ...
  if ( v18 )
  {
    ...
    {
      *a7 = v18;
      *(union _LARGE_INTEGER *)(v10 + 1448) = *v14;
      v19 = *UsageValue;
      v20 = v15[10];
      if ( *UsageValue > v20 )
      {
  ...
  if ( *v15 )
  {
    ...
    *a4 = 1;
    *a8 = v21;
    *v14 = *(union _LARGE_INTEGER *)(v10 + 1448);
    v22 = *v15;
    *a5 = 1;
    v23 = v15[10];
    if ( v22 <= v23 )
