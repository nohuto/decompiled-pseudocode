/*
 * XREFs of ?xxxCreateDisconnectDesktop@@YAHPEAUHWINSTA__@@PEAUtagWINDOWSTATION@@@Z @ 0x1C0152ED8
 * Callers:
...
__int64 __fastcall xxxCreateDisconnectDesktop(HWINSTA a1, struct tagWINDOWSTATION *a2)
{
  ...
  if ( EmptyRgnPublic )
  {
    ...
    v12 = 192;
    v13 = 0LL;
    if ( (int)xxxCreateDesktopEx((__int64)&v9, 0, 0x2000000LL, 0, &Handle, 1) < 0 )
    {
      GreDeleteObject(EmptyRgnPublic);
    }
    else if ( (int)SetDisconnectDesktopSecurity((HDESK)Handle) < 0
           || (v5 = ObReferenceObjectByHandle(Handle, 0, 0LL, 1, &Object, 0LL), gspdeskDisconnect = Object, v5 < 0) )
    {
      GreDeleteObject(EmptyRgnPublic);
