/*
 * XREFs of ?ProbeAndReadFD_KERNINGPAIR@@YAPEAU_FD_KERNINGPAIR@@PEBU1@H_K@Z @ 0x1C029C5F0
 * Callers:
 ...
 *     ??9@YA_NAEBU_FD_KERNINGPAIR@@0@Z @ 0x1C029C04C (--9@YA_NAEBU_FD_KERNINGPAIR@@0@Z.c)
 */
