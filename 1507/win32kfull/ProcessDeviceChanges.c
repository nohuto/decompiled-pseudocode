/*
 * XREFs of ProcessDeviceChanges @ 0x1C01DFB10
 * Callers:
...
void __fastcall ProcessDeviceChanges(int a1)
{
  int v1; // r13d
  int v2; // edi
  int v3; // esi
  ...
  if ( !aDeviceTemplate[142 * a1 + 24] )
  {
    ...
    if ( a1 == 1 )
    {
      ...
      dword_1C031B0F8 = 65536030;
      unk_1C031B0F0 = 0xFA00020000LL;
    }
    if ( !a1 )
      ghMouseDevice = -1LL;
