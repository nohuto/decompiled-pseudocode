/*
 * XREFs of ?ApplyElasticDragModeDeltas@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAUtagTPCONTACTSTATE@@PEAUtagPOINTER_INFO@@PEAUtagPOINT@@@Z @ 0x1C01F0CC8
 * Callers:
        ...
        struct tagPOINT *a4)
{
  ...
  v9 = dword_1C0323694
     ...
     * ((unsigned __int64)(1000LL * (*((_QWORD *)a3 + 10) - *((_QWORD *)a2 + 6)))
      / gliQpcFreq.QuadPart);
  if ( (int)v4 <= dword_1C0323698 )
  {
    v10 = *((_DWORD *)a2 + 20);
    if ( (v10 & 2) == 0 && *((_DWORD *)a2 + 2) > dword_1C0323698 )
      *((_DWORD *)a2 + 20) = v10 | 2;
    if ( (*((_DWORD *)a2 + 20) & 2) != 0 )
    {
      a4->x -= v9;
  ...
  v13 = dword_1C032369C;
  v14 = HIDWORD(v4);
  if ( (int)v14 <= dword_1C032369C )
  {
    v15 = *((_DWORD *)a2 + 20);
    if ( (v15 & 4) == 0 && *((_DWORD *)a2 + 3) > dword_1C032369C )
      *((_DWORD *)a2 + 20) = v15 | 4;
    if ( (*((_DWORD *)a2 + 20) & 4) != 0 )
    {
      a4->y -= v9;
