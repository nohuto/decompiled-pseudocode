/*
 * XREFs of xxxTranslateMessage @ 0x1C00DA330
 * Callers:
...
__int64 __fastcall xxxTranslateMessage(__int64 a1, int a2)
{
  ...
  v23 = v4;
  LOBYTE(v7) = *(_BYTE *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 1092);
  EtwTraceBeginTranslateMessage(v7, v23);
  v8 = *(_QWORD *)(gptiCurrent + 536LL);
  ...
  v11 = xxxInternalToUnicode(
          *(unsigned __int16 *)(a1 + 16),
          WORD1(v10),
          *(_QWORD *)(gptiCurrent + 392LL) + 184LL,
          v24,
          16,
          v9,
          &v22,
  ...
  if ( v11 )
  {
    ...
    if ( v16 )
    {
      ...
      while ( v12 > 0 )
      {
        ...
        if ( v12 > 1 )
          v18 = 0x2000000;
        v19 = _PostTransformableMessageExtended(
                v16,
                v15,
                (unsigned __int16)*v17,
                (struct _LARGE_STRING *)(v13 | v18),
                0LL,
                1);
        *v17++ = 0;
        if ( v19 >= (unsigned __int64)MmSystemRangeStart
          && *(_DWORD *)(v19 + 24) == 258
          && (*(_DWORD *)(gptiCurrent + 1184LL) & 1) != 0 )
        {
