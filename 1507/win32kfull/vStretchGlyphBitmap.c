/*
 * XREFs of vStretchGlyphBitmap @ 0x1C024880C
 * Callers:
 *     vStretchCvtToBitmap @ 0x1C0248710 (vStretchCvtToBitmap.c)
 * Callees:
 *     memmove @ 0x1C015D180 (memmove.c)
 *     vEmboldenItalicizeLine @ 0x1C0248654 (vEmboldenItalicizeLine.c)
 */
          ...
          switch ( a7 )
          {
            ...
            case 4:
              *v22 = awStretch4[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[1] = byte_1C0320651[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[2] = awStretch4[2 * (*a2 & 0xF)];
              v22[3] = byte_1C0320651[2 * (*a2 & 0xF)];
              v22 += 4;
              break;
            case 5:
              *v22 = awStretch5W1[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[1] = byte_1C0320631[2 * ((unsigned __int64)(unsigned __int8)*a2 >> 4)];
              v22[2] = awStretch5W2[2 * (((unsigned __int64)(unsigned __int8)*a2 >> 1) & 0xF)];
              v22[3] = byte_1C0320671[2 * (((unsigned __int64)(unsigned __int8)*a2 >> 1) & 0xF)];
