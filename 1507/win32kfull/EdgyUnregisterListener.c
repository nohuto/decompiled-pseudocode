/*
 * XREFs of EdgyUnregisterListener @ 0x1C0130454
 * Callers:
...
__int64 __fastcall EdgyUnregisterListener(__int64 a1)
{
  ...
  if ( !a1 )
    return 0LL;
  v3 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 232LL);
  if ( v3 )
  {
    Listener = (struct tagEDGY_DATA *)Edgy::_FindListener(v3, *(_QWORD *)a1, *(_DWORD *)(a1 + 16));
    if ( Listener )
    {
