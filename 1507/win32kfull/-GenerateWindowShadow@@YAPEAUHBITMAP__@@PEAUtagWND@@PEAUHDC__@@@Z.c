/*
 * XREFs of ?GenerateWindowShadow@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@@Z @ 0x1C0104838
 * Callers:
 ...
 *     ?DrawRoundedRectangularShadow@@YAXPEAXJJH@Z @ 0x1C0105F28 (-DrawRoundedRectangularShadow@@YAXPEAXJJH@Z.c)
 *     ?DrawRegionalShadow@@YAXPEAXJJ@Z @ 0x1C01060B8 (-DrawRegionalShadow@@YAXPEAXJJ@Z.c)
  ...
  *(_QWORD *)&v21[3] = 2097153LL;
  ...
  if ( (unsigned int)DrawWindowShadow(v19, a2, v6, v7, &v17) )
  {
    if ( !v17 || v7 )
      ...
      DrawRoundedRectangularShadow(v18, v10, v11, v6);
    v5 = 1;
  }
