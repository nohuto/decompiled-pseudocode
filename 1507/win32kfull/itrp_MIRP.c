/*
 * XREFs of itrp_MIRP @ 0x1C00BE9A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     itrp_RoundOffSP @ 0x1C00C09A0 (itrp_RoundOffSP.c)
...
__int64 __fastcall itrp_MIRP(__int64 a1, char a2)
{
  ...
  v4 = (_QWORD *)qword_1C0323128;
  qword_1C0323148 -= 4LL;
  v3 = qword_1C0323148;
  v5 = (_QWORD *)LocalGS;
  v74 = *(_DWORD *)qword_1C0323148;
  if ( *(_DWORD *)qword_1C0323148 >= (int)*(unsigned __int16 *)(qword_1C0323160 + 360)
    || *(int *)qword_1C0323148 < 0
    || (qword_1C0323160 ^ *(_QWORD *)(qword_1C0323160 + 16) ^ MEMORY[0xFFFFF78000000330] ^ (unsigned __int64)*(unsigned __int16 *)(qword_1C0323160 + 360)) != *(_QWORD *)(qword_1C0323160 + 368) )
  {
    result = qword_1C03231B8;
...
LABEL_206:
  ...
  v12 = 4;
LABEL_15:
  if ( qword_1C0323128 == qword_1C0323158 + 112 )
  {
    if ( v8 <= (unsigned __int16)v9 )
    ...
    v18 = *(_WORD *)(qword_1C0323128 + 80);
    if ( v18 < 1
      || v18 > v14
      && (unsigned int)(*(_DWORD *)(qword_1C0323128 + 104) + 12 * (v16 + 8) - *(_DWORD *)(qword_1C0323128 + 64)) < (unsigned __int64)(2LL * (v18 - 1)) )
    {
      goto LABEL_198;
    }
    v11 = 0;
  }
  v19 = *(_WORD *)(qword_1C0323128 + 80);
  if ( v19 >= 1 && v19 <= v77 && (int)v7 >= *(__int16 *)(*(_QWORD *)(qword_1C0323128 + 64) + 2LL * v19 - 2) + v12 + 1 )
    goto LABEL_198;
  v20 = (int)qword_1C0323170;
  ...
  {
    if ( (int)qword_1C0323170 >= (unsigned __int16)v6[8] || (int)qword_1C0323170 < 0 )
      goto LABEL_198;
  }
  else
  {
  ...
  if ( v29 >= 1
    && v29 <= v23
    && (int)qword_1C0323170 >= *(__int16 *)(*(_QWORD *)(LocalGS + 64) + 2LL * v29 - 2) + v11 + 1 )
  {
LABEL_198:
    result = qword_1C03231B8;
    dword_1C03231B0 = 4370;
  ...
  HIDWORD(qword_1C0323170) = qword_1C0323170;
  dword_1C0323178 = v7;
  if ( qword_1C0323128 == qword_1C0323158 || *(_BYTE *)(qword_1C0323160 + 333) != 2 )
  {
    v31 = a2;
    goto LABEL_110;
  }
  v30 = word_1C03231D4;
  v31 = a2;
  if ( word_1C03231D4 && (*(_BYTE *)(qword_1C0323160 + 452) & 2) != 0 )
  {
    v41 = DoubleCheckLinkColor(qword_1C0323128, (unsigned int)qword_1C0323170, (unsigned int)v7, a2 & 3);
...
LABEL_110:
  ...
  if ( !word_1C03231AC )
  {
    v46 = InvokeGetCVTEntry((unsigned int)dword_1C032319C, v74);
    v48 = v46;
    if ( *(_DWORD *)(v2 + 108) )
      v48 = itrp_CheckSingleWidth(v46, v47);
    if ( v4 == (_QWORD *)qword_1C0323158 )
    {
      v71 = 4 * v7;
      *(_DWORD *)(v71 + v4[2]) = *(_DWORD *)(v5[2] + 4 * v20)
                               + ((unsigned __int64)(v48 * (__int64)(__int16)dword_1C0323138) >> 32 << 18)
                               + ((((unsigned int)(v48 * (__int16)dword_1C0323138) >> 13) + 1) >> 1);
      *(_DWORD *)(v71 + *v4) = *(_DWORD *)(4 * v7 + v4[2]);
      *(_DWORD *)(v71 + v4[3]) = *(_DWORD *)(v5[3] + 4 * v20)
                               + ((unsigned __int64)(v48 * (__int64)SHIWORD(dword_1C0323138)) >> 32 << 18)
                               + ((((unsigned int)(v48 * SHIWORD(dword_1C0323138)) >> 13) + 1) >> 1);
      *(_DWORD *)(v71 + v4[1]) = *(_DWORD *)(4 * v7 + v4[3]);
    }
    v49 = 4 * v20;
    if ( dword_1C0323194 == 3 )
    {
      v78 = 4 * v7;
...
LABEL_137:
    ...
    InvokeMovePoint((unsigned int)dword_1C032318C, v4, (unsigned int)v7, (unsigned int)(v55 - v59));
    goto LABEL_79;
  }
  v32 = *(_DWORD *)(*(_QWORD *)(v2 + 16) + 4LL * (int)v74);
  if ( word_1C03231AC == 1 )
  {
    v38 = *(_DWORD *)(v4[2] + 4 * v7) - *(_DWORD *)(v5[2] + 4 * v20);
    if ( (v32 ^ v38) < 0 && *(_BYTE *)(v2 + 156) )
      v32 = -v32;
    if ( v30 )
    {
      v43 = *(_WORD *)(v2 + 120) & 4;
  ...
  v33 = *(_DWORD *)(v4[3] + 4 * v7) - *(_DWORD *)(v5[3] + 4 * v20);
