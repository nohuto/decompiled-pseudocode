...
unsigned __int64 __fastcall Do5225(_BYTE *a1, unsigned __int8 *a2, unsigned __int8 *a3, unsigned __int8 *a4, int a5)
{
  ...
  for ( i = a5 & 3; v8; --v8 )
  {
    *a1 = (*a2 + *a4 + 2 * (*a3 + 2 * (*a2 + *a3 + *a4 + 4 * (*a3 + 1)))) >> 5;
    a1[1] = (a2[1] + a4[1] + 2 * (a3[1] + 2 * (a2[1] + a3[1] + a4[1] + 4 * (a3[1] + 1)))) >> 5;
    a1[2] = (a2[2] + a4[2] + 2 * (a3[2] + 2 * (a2[2] + a3[2] + a4[2] + 4 * (a3[2] + 1)))) >> 5;
    v12 = a3[3];
    a3 += 4;
    v13 = a4[3];
    a4 += 4;
