/*
 * XREFs of ?MulDestroyFont@@YAXPEAU_FONTOBJ@@@Z @ 0x1C0296020
 * Callers:
 *     <none>
 * Callees:
 *     ?DestroyFont@PDEVOBJ@@QEAAXPEAU_FONTOBJ@@@Z @ 0x1C0126458 (-DestroyFont@PDEVOBJ@@QEAAXPEAU_FONTOBJ@@@Z.c)
 *     ??0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z @ 0x1C02943C8 (--0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z.c)
 *     ??1MULTIFONT@@QEAA@XZ @ 0x1C029455C (--1MULTIFONT@@QEAA@XZ.c)
 *     ?DestroyTable@MULTIFONT@@QEAAXXZ @ 0x1C0294664 (-DestroyTable@MULTIFONT@@QEAAXXZ.c)
 */
...
void __fastcall MulDestroyFont(struct _FONTOBJ *a1)
{
  ...
  if ( a1->pvConsumer )
  {
    MULTIFONT::MULTIFONT((MULTIFONT *)&v6, a1, -1, 0LL);
    v2 = v7;
    v3 = *((_DWORD *)*v7 + 4);
    v4 = **v7;
    if ( v3 )
