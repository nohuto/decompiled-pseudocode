/*
 * XREFs of xxxSBWndProc @ 0x1C0233E70
 * Callers:
 *     ?xxxWrapSBWndProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C01E39F0 (-xxxWrapSBWndProc@@YA_JPEAUtagWND@@I_K_J1@Z.c)
 * Callees:
 ...
 *     ?SBSetParms@@YAHPEAUtagSBDATA@@PEAUtagSCROLLINFO@@PEAHPEAJ@Z @ 0x1C00D5844 (-SBSetParms@@YAHPEAUtagSBDATA@@PEAUtagSCROLLINFO@@PEAHPEAJ@Z.c)
 ...
 *     _SBGetParms @ 0x1C02334A8 (_SBGetParms.c)
...
unsigned __int64 __fastcall xxxSBWndProc(struct tagWND *a1, unsigned int a2, _DWORD *a3, int *a4)
{
  ...
  if ( v8 != 666 )
  {
    ...
    if ( *((_DWORD *)a1 + 58) + 376 < (unsigned int)*(unsigned __int16 *)(gpsi + 328LL) )
      return 0LL;
    *((_WORD *)a1 + 33) = 666;
    v7 = (struct tagSCROLLINFO *)&v138;
  }
      ...
      if ( v11 <= 0x14 )
      {
        if ( v11 != 20 )
        {
          if ( v11 != 1 )
          {
            ...
            {
              case 5u:
                if ( *(struct tagWND **)(*(_QWORD *)(gptiCurrent + 392LL) + 72LL) != a1 )
                  return 0LL;
                zzzDestroyCaret();
                break;
              case 7u:
              ...
              case 0xAu:
                ...
                return xxxSendTransformableMessageTimeout(a1, 0xE4u, a3 == 0LL ? 3 : 0, 0LL, 0, 0, 0LL, 1, 1);
              default:
                v16 = v11 == 15;
                goto LABEL_305;
            }
...
LABEL_65:
              xxxCreateCaret((__int64 *)a1, (HSURF)1, v26, v27 - 2 * *v35);
              zzzSetSBCaretPos(a1);
              zzzShowCaret(a1);
              return 0LL;
            }
...
LABEL_116:
                if ( IsDPIDWMSysMet(3uLL)
                  ...
                  && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                    ? (v53 = 0)
                    : (v53 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread())
                                                               + 416)
                                                   + 8LL)
                                       + 260LL) & 1),
                      v53) )
...
LABEL_136:
                if ( IsDPIDWMSysMet(2uLL)
                  ...
                  && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                    ? (v61 = 0)
                    : (v61 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread())
                                                               + 416)
                                                   + 8LL)
                                       + 260LL) & 1),
                      v61) )
...
LABEL_197:
              if ( IsDPIDWMSysMet(2uLL)
                ...
                && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                  ? (v88 = 0)
                  : (v88 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread())
                                                             + 416)
                                                 + 8LL)
                                     + 260LL) & 1),
                    v88) )
...
LABEL_219:
              if ( IsDPIDWMSysMet(3uLL)
                ...
                && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                  ? (v96 = 0)
                  : (v96 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread())
                                                             + 416)
                                                 + 8LL)
                                     + 260LL) & 1),
                    v96) )
          ...
          if ( (unsigned int)IsDPIAbsoluteSysMet(3uLL) )
          {
              ...
              || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v102) + 776) & 0x4000) != 0 )
            {
              goto LABEL_239;
                 ...
                 || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                   ? (v107 = 0)
                   : (v107 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread())
                                                               + 416)
                                                   + 8LL)
                                       + 260LL) & 1),
                     !v107) )
...
LABEL_318:
        ...
        v119 = *((_QWORD *)a1 + 11);
        v120 = (struct _LARGE_STRING *)((unsigned __int16)v130 | (WORD2(v130) << 16));
