/*
 * XREFs of bGetFastAdvanceWidth @ 0x1C00B2928
 * Callers:
...
__int64 __fastcall bGetFastAdvanceWidth(__int64 a1, unsigned int a2, unsigned int *a3)
{
    ...
    && (unsigned int)IsFullWidthCharacter(v23, a2, a3, v7) )
  {
    ...
    else
    {
      ...
      v12 = v9[24];
      v13 = v11 + v9[8];
      if ( (_DWORD)v12 && (unsigned __int64)*(unsigned int *)(v10 + 552) + 4 <= v9[25] )
        v14 = v11 + v12;
      else
        v14 = 0LL;
      v15 = (unsigned __int16)__ROR2__(*(_WORD *)(v11 + v9[6] + 34), 8);
      v16 = __ROR2__(*(_WORD *)(v13 + 4LL * (v15 - 1)), 8);
      if ( (*(_DWORD *)(v7 + 116) & 0x10) == 0
        || (*(_BYTE *)(v9[4] + v11 + 17) & 0x14) == 0
        || (*(_DWORD *)(v10 + 400) & 0x10000000) != 0
        && (unsigned int)IsFullWidthCharacter(*(_QWORD *)(v7 + 8), (unsigned int)v5, v10, v7) )
      {
        v8 = 0;
      }
      if ( v8 && (!v14 || *(_DWORD *)(v7 + 124) < (int)*(unsigned __int8 *)(v5 + v14 + 4)) )
      {
        *v6 = -1;
        return 0;
      }
      else
      {
        if ( (unsigned int)v5 >= v15 )
          ...
          v18 = (unsigned __int16)__ROR2__(*(_WORD *)(v13 + 4 * v5), 8);
        v19 = *(_DWORD *)(v7 + 80);
        if ( v19 <= 0 )
        ...
        if ( (*(_DWORD *)(v20 + 400) & 0x10000000) != 0
          && (unsigned int)IsFullWidthCharacter(v20, (unsigned int)v5, v10, v7)
          && !gbJpn98FixPitch
          && *v22
