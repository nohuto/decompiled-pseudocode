/*
 * XREFs of ReadDigitizerToMonitorMappings @ 0x1C01CC2C0
 * Callers:
...
int __fastcall ReadDigitizerToMonitorMappings(const UNICODE_STRING *a1, __int64 a2)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    if ( v5 )
    {
      ReadSingleDigitizerToMonitorMappings(a1, KeyHandle, 0xAu, v6, v5, v9, (unsigned __int16 *)(a2 + 1144));
      ReadSingleDigitizerToMonitorMappings(a1, KeyHandle, 0x14u, v8, v7, v10, (unsigned __int16 *)(a2 + 888));
      Win32FreePool(v7);
    }
