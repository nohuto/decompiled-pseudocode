/*
 * XREFs of ?ZOrderByOwner2@@YAPEAUtagSMWP@@PEAU1@H@Z @ 0x1C0083CBC
 * Callers:
...
struct tagSMWP *__fastcall ZOrderByOwner2(struct tagSMWP *a1, __int64 a2)
{
  __int64 v2; // rbp
  ...
  PWInsertAfter(*(_QWORD *)(v4 + v2 + 8), a2);
  v7 = *(_QWORD *)(v6 + 88);
