/*
 * XREFs of ?xxxPromotePointer@PointerPromotion@@YAHGKK@Z @ 0x1C023AD40
 * Callers:
...
__int64 __fastcall PointerPromotion::xxxPromotePointer(PointerPromotion *this, unsigned int a2, unsigned int a3)
{
  ...
  if ( !word_1C0322D00 )
    goto LABEL_12;
  if ( word_1C0322D00 != v5 || (v7 = v13, dword_1C0322D04 != *((_DWORD *)v13 + 8)) )
  {
...
LABEL_13:
  ...
  if ( (v12 & 0x80000) == 0 )
  {
    v9 = ((dword_1C0322D10 != 0) + 1) | 0x1000000 | v12 & 0xFFFF00;
    goto LABEL_13;
  }
  LOBYTE(v8) = v12;
  if ( dword_1C0322D10 )
