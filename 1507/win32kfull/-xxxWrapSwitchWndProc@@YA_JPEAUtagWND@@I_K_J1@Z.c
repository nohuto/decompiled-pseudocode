/*
 * XREFs of ?xxxWrapSwitchWndProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C01E3A50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxWrapSwitchWndProc(struct tagWND *a1, unsigned int a2, unsigned __int64 a3, __int64 a4)
{
