/*
 * XREFs of HT_HalftoneBitmap @ 0x1C00A3910
 * Callers:
 *     EngHTBlt @ 0x1C00A30B4 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C00A3BA4 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C00A4ED0 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C00A57C8 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C024D68C (CheckABInfo.c)
 */
