/*
 * XREFs of MNEraseBackground @ 0x1C023F9D4
 * Callers:
...
__int64 __fastcall MNEraseBackground(HDC a1, __int64 a2, LONG a3, LONG a4, int a5, int a6)
{
  ...
  LONG v85; // [rsp+80h] [rbp+18h]
  LONG v86; // [rsp+88h] [rbp+20h]
...
LABEL_112:
        if ( IsDPIDWMSysMet(0x2DuLL)
          ...
          && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
            ? (v60 = 0)
            : (v60 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                           + 8LL)
                               + 260LL) & 1),
              v60) )
        {
...
LABEL_150:
            if ( IsDPIDWMSysMet(0x2EuLL)
              ...
              && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                ? (v76 = 0)
                : (v76 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                               + 8LL)
                                   + 260LL) & 1),
                  v76) )
            {
