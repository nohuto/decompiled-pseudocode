/*
 * XREFs of itrp_ISECT @ 0x1C00BFF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_ISECT(__int64 a1)
{
  ...
  if ( (qword_1C0323160 ^ *(_QWORD *)qword_1C0323160 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0323160 + 424)) != *(_QWORD *)(qword_1C0323160 + 432)
    || (unsigned __int64)((qword_1C0323148 - *(_QWORD *)qword_1C0323160) >> 2) < 5 )
  {
    dword_1C03231B0 = 4368;
    return qword_1C03231B8;
  }
  v2 = *(_WORD **)(qword_1C0323160 + 344);
  v3 = *(int *)(qword_1C0323148 - 4);
  v68 = 4;
  v63 = qword_1C0323148 - 8;
  LOWORD(v4) = v2[4];
  v5 = v2[6];
  v6 = *(int *)(qword_1C0323148 - 8);
          ...
          if ( v22 < 1 || v22 > v20 || v61 < v21 + *(__int16 *)(v71[8] + 2LL * v22 - 2) + 1 )
          {
            ...
            if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, (__int64)v71) )
            {
              ...
              if ( v22 < 1 || v22 > v24 || v25 < v26 + *(__int16 *)(v71[8] + 2LL * v22 - 2) + 1 )
              {
                ...
                if ( v70 == 2 && (*(_BYTE *)(v66 + 452) & 2) != 0 )
                {
                  v51 = Mul26Dot6((unsigned int)v31, (unsigned int)v15, v27);
                  if ( v51 < 0 )
                    v51 = -v51;
                  v53 = Mul26Dot6((unsigned int)v29, (unsigned int)v16, v52);
                  if ( v53 < 0 )
                    v53 = -v53;
                  if ( v51 > v53 )
                  {
                ...
                {
LABEL_68:
                  if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, qword_1C0323130) )
                  {
                          ...
                          (int)v32 < (int)v35 + v68 + 1) )
                    {
                      ...
                      *(_BYTE *)(*(_QWORD *)(v34 + 72) + v32) |= 3u;
                      v37 = *(_QWORD *)qword_1C0323130;
                      v38 = *(_QWORD *)(qword_1C0323130 + 8);
                      if ( v16 )
                      {
                        if ( v15 )
                        {
                          ...
                          if ( v39 >= v40 )
                          {
                            v41 = v73 - v56 - CompDiv((unsigned int)v15, v16 * (__int64)(v72 - v57));
                            v43 = CompDiv((unsigned int)v15, v55 * v29) - v31;
                          }
                          else
                          {
                            v41 = CompDiv((unsigned int)v16, v15 * (__int64)(v73 - v56)) + v57 - v72;
                            v43 = v29 - CompDiv((unsigned int)v16, v42 * v31);
                          }
                          v44 = v56;
                          v45 = v73;
                          goto LABEL_85;
...
LABEL_86:
                          if ( v43 )
                          {
                            *(_DWORD *)(v37 + 4 * v36) = v72 + CompDiv(v43, v41 * (__int64)v29);
                            *(_DWORD *)(v38 + 4 * v36) = v73 + CompDiv(v48, v49 * v31);
                          }
                          else
                          {
                            *(_DWORD *)(v37 + 4 * v36) = (v47 + (v29 >> 1) + v46 + (v15 >> 1)) >> 1;
                            *(_DWORD *)(v38 + 4 * v36) = (v44 + v45 + (v31 >> 1) + (v16 >> 1)) >> 1;
                          }
                          return a1;
                        }
