/*
 * XREFs of DestroyTask @ 0x1C01E9990
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DestroyTask(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_BYTE *)(v4 + 34) & 1) != 0 )
  {
    v5 = *(_QWORD *)(*(_QWORD *)(a2 + 424) + 160LL);
    if ( v5 )
      PostMessage(v5, 0x45Au, 0LL, 0LL);
  }
  v6 = *(_QWORD **)(v4 + 24);
  if ( v6 )
  {
...
LABEL_16:
  *(_DWORD *)(gpsi + 3988LL) -= *(_DWORD *)(v4 + 8);
  v11 = (_QWORD *)(v2 + 16);
  ...
  if ( *(_QWORD *)(v2 + 8) == a2 )
  {
    *(_QWORD *)(v2 + 8) = 0LL;
    ...
    if ( v13 )
    {
      ...
      v14 = *(struct _KEVENT **)(*((_QWORD *)v13 + 2) + 656LL);
LABEL_30:
      KeSetEvent(v14, 1, 0);
    }
  }
