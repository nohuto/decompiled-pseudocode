/*
 * XREFs of ?PostHidInput@@YAHPEAUDEVICEINFO@@PEAUtagQ@@PEAUtagWND@@_K@Z @ 0x1C01D2970
 * Callers:
...
__int64 __fastcall PostHidInput(struct DEVICEINFO *a1, struct tagQ *a2, LARGE_INTEGER *a3, __int64 a4)
{
  unsigned int v5; // edi
  ...
  if ( v5 % v9 )
    return 0LL;
  if ( !(*((_DWORD *)a1 + 66) / (unsigned int)*(unsigned __int16 *)(*((_QWORD *)a1 + 50) + 44LL)) )
    return 0LL;
  if ( v5 >= 0xFFFFFFF8 )
    return 0LL;
  ...
  if ( !(unsigned int)PostInputMessage((__int64)a2, a3, 0xFFu, a4, *v11, 0, 0LL, 0LL, 0, 0LL, 0LL, 0LL) )
  {
