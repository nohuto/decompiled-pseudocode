/*
 * XREFs of ?BasicTargetingWindowHitTest@@YAHPEAUtagWND@@UtagPOINT@@PEBUtagPNTRWINDOWHITTTESTARGS@@PEAHUtagRECT@@3PEAIPEAU2@W4tagTARGETING_PROPERTY@@K@Z @ 0x1C022AAF8
 * Callers:
        ...
        int a10)
{
  ...
  __int64 result; // rax
  char v19; // cl
  unsigned __int16 v20; // [rsp+90h] [rbp+18h] BYREF

  v14 = 0;
  if ( !IsCompositionInputWindow((struct tagWND *)a1) || (v15 = 1, (*(_DWORD *)(a3 + 36) & 8) == 0) )
    v15 = 0;
