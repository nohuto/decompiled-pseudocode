/*
 * XREFs of AddToActiveDevices @ 0x1C01C72BC
 * Callers:
 ...
 *     ?InsertInListByRank@@YAXPEAU_LIST_ENTRY@@0@Z @ 0x1C01C5690 (-InsertInListByRank@@YAXPEAU_LIST_ENTRY@@0@Z.c)
 */
    ...
    if ( Flink == &gActivePointerDeviceList )
    {
      ...
      if ( v5 )
      {
        *(_QWORD *)v5 = a1;
        ...
        v3 = 1;
        if ( ++dword_1C0324790 == 1 )
          gtmridPointerDeviceTimer = SetRITTimer(0, 100, (int)xxxAssessPointerContactStateTimerCallback, 0);
      }
      return v3;
    }
