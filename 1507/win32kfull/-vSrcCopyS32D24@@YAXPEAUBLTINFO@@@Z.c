/*
 * XREFs of ?vSrcCopyS32D24@@YAXPEAUBLTINFO@@@Z @ 0x1C0101870
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vSrcCopyS32D24(struct BLTINFO *a1)
{
  ...
  int j; // ecx
  unsigned int (*v18)(struct _XLATEOBJ *, unsigned int); // r14
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      do
      {
        v20 = ((__int64 (__fastcall *)(XLATE *, _QWORD))v18)(v2, *v4);
        *(_BYTE *)v6 = v20;
        ++v4;
        *(_BYTE *)(v6 + 1) = BYTE1(v20);
        *(_BYTE *)(v6 + 2) = BYTE2(v20);
        v6 += 3LL;
        --v19;
      }
      while ( v19 );
