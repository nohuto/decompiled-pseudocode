/*
 * XREFs of ?MulStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02973A0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
  ...
  if ( a2->iType != 1 || !v18 || (*(_DWORD *)(v18 + 56) & 0x20000) == 0 )
    goto LABEL_8;
  if ( (unsigned int)MulCopyDeviceToDIB(a2, (struct SURFMEM *)&v75, &v95) )
  {
    if ( !v75 )
    {
      v11 = 1;
    ...
    prclSrc = &v95;
    psoSrc = (SURFOBJ *)(v75 + 24);
    v17 = SURFOBJ_TO_SURFACE_NOT_NULL(v75 + 24);
    v62 = v17;
LABEL_8:
    right = a8->right;
    v71 = 0LL;
    ...
    if ( v41 )
    {
      ...
      {
        v69 = 0LL;
        v70 = SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v88);
...
LABEL_79:
        ...
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v88) + 112) & 2) != 0 )
          v55 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, RECTL *, RECTL *, POINTL *, ULONG))(*((_QWORD *)v87 + 7) + 2880LL);
        else
          v55 = EngStretchBlt;
        v56 = v92;
        if ( v92->iType == 1 && *(_QWORD *)(v36 + 48) != *(_QWORD *)(v70 + 48) )
          v55 = EngStretchBlt;
        if ( iMode == 4 && (*(_BYTE *)(*(_QWORD *)(v70 + 48) + 1848LL) & 0x10) == 0 )
          v55 = EngStretchBlt;
        v57 = v93;
