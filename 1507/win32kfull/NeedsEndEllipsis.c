/*
 * XREFs of NeedsEndEllipsis @ 0x1C024B614
 * Callers:
...
__int64 __fastcall NeedsEndEllipsis(HDC a1, __m128i *a2, int *a3, __int64 a4, int a5, __int64 a6)
{
  int v6; // esi
  int v7; // edi
  int v12; // ebp
  ...
  if ( (int)DT_GetExtentMinusPrefixes(a1, a2, v6, a5, v17, a6, -1) <= v12
    || !(unsigned int)GreGetTextExtentW(a1, (__m128i *)L"...", 3u, &v19, 1) )
  {
    return 0LL;
  }
  v14 = v13 - v19.cx + v12;
