/*
 * XREFs of ?IsCandidateTransformOwner@@YAHPEAUtagWND@@0@Z @ 0x1C00EC108
 * Callers:
...
_BOOL8 __fastcall IsCandidateTransformOwner(struct tagWND *a1, struct tagWND *a2)
{
  ...
  if ( !(unsigned int)IsTitleWindow(a1, 1LL)
    || *(_QWORD *)(v6 + 392) != *(_QWORD *)(v7 + 392) && *(_QWORD *)(v6 + 384) != *(_QWORD *)(v7 + 384) )
  {
    return 0LL;
  }
  if ( !(unsigned int)SameCoordinateSpace(*(_QWORD *)(v6 + 384), *(_QWORD *)(v7 + 384)) )
    return 0LL;
  if ( !v3 && !v5 )
    return 1LL;
  ...
  if ( !v5 || v12 )
    return 1LL;
  if ( !(unsigned int)UnionRect(v14, &v10->left, &v9->left) )
    return 0LL;
