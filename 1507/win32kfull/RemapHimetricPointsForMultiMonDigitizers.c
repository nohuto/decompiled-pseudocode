/*
 * XREFs of RemapHimetricPointsForMultiMonDigitizers @ 0x1C01E54E4
 * Callers:
...
LABEL_104:
  ...
  {
    v54 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
...
LABEL_121:
  if ( IsDPIDWMSysMet(0x4CuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v64 = 0)
      : (v64 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                         + 260LL) & 1),
        v64) )
  {
...
LABEL_143:
  ...
  {
    v68 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
       && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                    + 260LL) & 1;
    if ( (_DWORD)v68 )
      goto LABEL_143;
...
LABEL_151:
  if ( IsDPIDWMSysMet(0x4DuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v74 = 0)
      : (v74 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                         + 260LL) & 1),
        v74) )
  {
