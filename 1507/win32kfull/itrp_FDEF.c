/*
 * XREFs of itrp_FDEF @ 0x1C00C4AD0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall itrp_FDEF(unsigned __int64 a1)
{
  ...
  if ( (qword_1C0323160 ^ *(_QWORD *)qword_1C0323160 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0323160 + 424)) != *(_QWORD *)(qword_1C0323160 + 432)
    || (v3 = qword_1C0323148, !((qword_1C0323148 - *(_QWORD *)qword_1C0323160) >> 2)) )
  {
  ...
  qword_1C0323148 -= 4LL;
  v4 = *(int *)(v3 - 4);
  if ( (int)v4 >= *(unsigned __int16 *)(*(_QWORD *)(qword_1C0323160 + 344) + 20LL) || (int)v4 < 0 )
  {
  ...
  if ( v5 >= 2u )
  {
    dword_1C03231B0 = 4360;
    return qword_1C03231B8;
  }
  v6 = *(_QWORD *)(qword_1C0323160 + 160);
  v7 = a1;
  *(_WORD *)(v6 + 8 * v4 + 6) = v5;
...
LABEL_7:
  ...
  v9 = qword_1C03231B8;
  if ( a1 >= qword_1C03231C0 && a1 + 4 <= qword_1C03231B8 && a1 + 4 >= a1 && *(_DWORD *)a1 == 1480791728 )
  {
    *(_WORD *)(qword_1C0323160 + 454) |= 0x100u;
    v8 = qword_1C03231C0;
    goto LABEL_7;
  }
LABEL_8:
  if ( ((unsigned int)v4 <= 2 || (_DWORD)v4 == 4 || (unsigned int)(v4 - 7) <= 1) && a1 >= v8 )
  {
    ...
    if ( a1 + 6 <= v9 && a1 + 6 >= a1 )
    {
      ...
      {
LABEL_61:
        *(_WORD *)(qword_1C0323160 + 454) |= 0x200u;
        v8 = qword_1C03231C0;
        v9 = qword_1C03231B8;
      }
    }
  ...
  if ( !(_DWORD)v4 )
  {
    ...
    if ( v21 )
      goto LABEL_13;
    *(_WORD *)(qword_1C0323160 + 454) |= 0x400u;
    v8 = qword_1C03231C0;
    v9 = qword_1C03231B8;
  }
  if ( (_DWORD)v4 == 58 )
  {
    ...
    if ( a1 + 10 <= v9 && a1 + 10 >= a1 )
    {
      ...
      if ( !v22 )
      {
        *(_WORD *)(qword_1C0323160 + 454) |= 0x800u;
        v8 = qword_1C03231C0;
        v9 = qword_1C03231B8;
      }
    }
...
LABEL_13:
  ...
  if ( a1 + 1 <= v9 && (unsigned __int64)v10 >= a1 && *(_BYTE *)a1 == 75 )
  {
    ...
    if ( a1 + 13 <= v9 && a1 + 13 >= a1 )
    {
      ...
      {
LABEL_48:
        v17 = *(_WORD *)(qword_1C0323160 + 456);
        if ( v17 < 4u )
        {
          *(_WORD *)(qword_1C0323160 + 2LL * v17 + 458) = v4;
          ++*(_WORD *)(qword_1C0323160 + 456);
          v8 = qword_1C03231C0;
          v9 = qword_1C03231B8;
        }
      }
...
LABEL_90:
    ...
    switch ( v12 )
    {
      case 0:
        goto LABEL_25;
      case 21:
        if ( (unsigned __int64)v10 < qword_1C03231C0 || (unsigned __int64)(v10 + 1) > qword_1C03231B8 || v10 + 1 < v10 )
          goto LABEL_90;
        v12 = *v10 + 1;
        break;
      case 22:
    ...
    a1 = v13;
    if ( v13 < qword_1C03231C0 )
    {
      dword_1C03231B0 = 4363;
    }
    else if ( v13 <= qword_1C03231B8 )
    {
      goto LABEL_25;
    }
LABEL_97:
