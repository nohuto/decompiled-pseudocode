/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YAHUtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C02054EC
 * Callers:
 ...
 *     ?ComputeSizeOutcome@@YA?AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C0204C5C (-ComputeSizeOutcome@@YA-AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@.c)
 ...
 *     ?PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C0205B1C (-PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
 */
        ...
        enum eTHRESHOLD_MARGIN_DIRECTION *a4)
{
  ...
  {
    if ( !v9 )
      v9 = gWinArrGlobal[dword_1C02E4BA4[4 * v8]];
    if ( !v10 )
      v10 = gWinArrGlobal[dword_1C02E4BA8[4 * v8]];
    if ( !v11 )
      v11 = gWinArrGlobal[dword_1C02E4BAC[4 * v8]];
  }
  v12 = v22;
