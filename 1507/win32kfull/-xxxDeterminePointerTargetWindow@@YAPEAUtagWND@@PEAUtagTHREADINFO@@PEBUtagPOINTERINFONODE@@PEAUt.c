/*
 * XREFs of ?xxxDeterminePointerTargetWindow@@YAPEAUtagWND@@PEAUtagTHREADINFO@@PEBUtagPOINTERINFONODE@@PEAUtagQ@@HPEAHPEAUtagPOINT@@@Z @ 0x1C01F98B4
 * Callers:
        ...
        struct tagPOINT *a6)
{
  ...
  v11 = 0LL;
  v12 = *(_QWORD *)(*(_QWORD *)(gptiRit + 416LL) + 8LL);
  v33 = 0LL;
  v13 = *(_QWORD *)(v12 + 16);
...
LABEL_22:
  ...
  if ( v34 )
  {
    if ( a3 && *(struct tagQ **)(*((_QWORD *)v34 + 2) + 392LL) != a3 )
      result = 0LL;
    if ( result )
      *a5 = v37;
  }
