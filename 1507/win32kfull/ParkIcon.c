...
__int64 __fastcall ParkIcon(__int64 a1, unsigned int *a2)
{
  ...
  SystemMetricsForWindow = GetSystemMetricsForWindow(a1, 47LL);
  v4 = SystemMetricsForWindow;
  v65 = GetSystemMetricsForWindow(a1, 48LL);
  v5 = v65;
  ...
  if ( (GetSystemMetricsForWindow(a1, 56LL) & 1) == 0 )
  {
...
LABEL_12:
    ...
    if ( (unsigned int)IsDPIDWMSysMet(57LL)
      ...
      && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
        ? (v33 = 0)
        : (v33 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                           + 260LL) & 1),
          v33) )
    {
  ...
  v52 = v58 - v4;
LABEL_13:
  if ( (GetSystemMetricsForWindow(a1, 56LL) & 2) != 0 )
  {
...
LABEL_80:
      ...
      else if ( !(unsigned int)IsDPIDWMSysMet(v42)
...
LABEL_15:
  ...
  v62 = v16;
  v53 = v16;
  if ( (GetSystemMetricsForWindow(a1, 56LL) & 4) != 0 )
  {
    v18 = 0;
    v19 = v15 / v5;
    if ( v15 / v5 < 1 )
  ...
  do
  {
    ...
    do
    {
      ...
      ++v20;
      if ( (unsigned int)IntersectRect(&v56, &v56, &v52) )
        break;
LABEL_21:
      v21 = *(_QWORD *)(v21 + 72);
    }
