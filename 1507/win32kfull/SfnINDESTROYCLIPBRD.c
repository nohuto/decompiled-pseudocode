/*
 * XREFs of SfnINDESTROYCLIPBRD @ 0x1C020F360
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnINDESTROYCLIPBRD(__int64 *a1, int a2, __int64 a3, __int64 a4, __int64 a5, unsigned __int64 a6)
{
  __int64 v10; // rsi
  __int64 v11; // rdx
  __int64 v12; // rax
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 80LL) = v14;
  ...
  v15 = KeUserModeCallback(25LL, v23, 48LL, &a6, &v24);
