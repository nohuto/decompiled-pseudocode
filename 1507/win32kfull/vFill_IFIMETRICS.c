...
__int64 __fastcall vFill_IFIMETRICS(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4)
{
  ...
  *(_DWORD *)(a2 + 168) = v16;
  ...
  {
    *(_WORD *)(a2 + 172) = 2;
    v64 = __ROR2__(v8[22], 8);
    *(_DWORD *)(a2 + 176) = 0;
    *(_WORD *)(a2 + 180) = 0;
    v55 = (*(_DWORD *)(a2 + 48) & 0x400000) != 0;
    *(_BYTE *)(a2 + 174) = (v64 & 1) != 0 ? 8 : 5;
    *(_BYTE *)(a2 + 175) = v55 ? 9 : 0;
    *(_WORD *)(a2 + 46) = ausIFIMetrics2WinWeight[(unsigned __int8)((v64 & 1) != 0 ? 8 : 5)];
  }
  *(_DWORD *)(a2 + 36) = v16;
  if ( (*(_DWORD *)(a1 + 300) & 2) == 0 )
  {
      ...
      || (v27 = IsBogusSignature(v26, a1), LOBYTE(v16) = 0, v27) )
    {
      ...
      {
        v65 = *(_QWORD *)(a1 + 88);
        if ( (unsigned int)bContainGlyphSet(65393LL, v65)
          && (unsigned int)bContainGlyphSet(65394LL, v65)
          && (unsigned int)bContainGlyphSet(65395LL, v65)
          && (unsigned int)bContainGlyphSet(65396LL, v65)
          && (unsigned int)bContainGlyphSet(65397LL, v65) )
        {
          *(_BYTE *)(a2 + 44) = 0x80;
          *(_DWORD *)(a1 + 288) = 932;
        }
        else if ( (unsigned int)bContainGlyphSet(25044LL, v65) && (unsigned int)bContainGlyphSet(40674LL, v65) )
        {
          *(_BYTE *)(a2 + 44) = -122;
          *(_DWORD *)(a1 + 288) = 936;
        }
        else if ( (unsigned int)bContainGlyphSet(40856LL, v65) && (unsigned int)bContainGlyphSet(40825LL, v65) )
        {
          *(_BYTE *)(a2 + 44) = -120;
          *(_DWORD *)(a1 + 288) = 950;
        }
        else if ( (unsigned int)bContainGlyphSet(44032LL, v65) && (unsigned int)bContainGlyphSet(54616LL, v65) )
        {
          *(_BYTE *)(a2 + 44) = -127;
          *(_DWORD *)(a1 + 288) = 949;
        }
        else if ( (unsigned int)bContainGlyphSet(57344LL, v65) && (unsigned int)IsCurrentCodePageDBCS() )
        {
          EngGetCurrentCodePage(&OemCodePage, (PUSHORT)&AnsiCodePage);
          v66 = (unsigned __int16)AnsiCodePage;
...
LABEL_54:
  ...
  *(_DWORD *)(a2 + 140) = (__int16)__ROR2__(v73[9], 8);
  ...
  if ( (unsigned __int8)(*(_BYTE *)(a2 + 44) + 0x80) <= 1u )
  {
    ...
    else
    {
      v72 = *(_BYTE *)(a2 + 173);
      if ( v72 < 0x10u )
        *(_BYTE *)(a2 + 45) = byte_1C02EC220[v72];
      else
        *(_BYTE *)(a2 + 45) = 0;
    }
    if ( *(_BYTE *)(a2 + 175) == 9 )
  ...
  *(_DWORD *)(a2 + 24) = v43;
  ...
  v48 = v42[21];
  *(_DWORD *)(a2 + 40) = v48;
  vFillIFICharsets(a1, a2, a2 + v48, v74[0], v12, v79);
  v49 = (int)v42[22];
  *(_DWORD *)(a2 + 196) = v49;
  if ( (_DWORD)v49 )
  {
