/*
 * XREFs of ?bEndDocInternal@@YAHPEAUHDC__@@KG@Z @ 0x1C0269108
 * Callers:
 *     NtGdiAbortDoc @ 0x1C026AA50 (NtGdiAbortDoc.c)
 *     NtGdiEndDoc @ 0x1C026AE70 (NtGdiEndDoc.c)
  ...
  else
  {
      ...
      || *(_QWORD *)(v9 + 2992) )
    {
      if ( v11 )
        ...
        v14 = 0LL;
      v13 = (*(__int64 (__fastcall **)(char *, _QWORD))(v9 + 2992))(v14, a2);
    }
    else
    {
      if ( gfUMPDDebug )
