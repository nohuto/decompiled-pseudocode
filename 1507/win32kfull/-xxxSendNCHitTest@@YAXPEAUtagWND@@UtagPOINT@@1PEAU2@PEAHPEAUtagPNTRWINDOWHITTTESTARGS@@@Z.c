/*
 * XREFs of ?xxxSendNCHitTest@@YAXPEAUtagWND@@UtagPOINT@@1PEAU2@PEAHPEAUtagPNTRWINDOWHITTTESTARGS@@@Z @ 0x1C022C2F4
 * Callers:
 ...
 *     ?NlsNullProc@@YAHPEAUtagKE@@_KK@Z @ 0x1C0157580 (-NlsNullProc@@YAHPEAUtagKE@@_KK@Z.c)
 */
    ...
    if ( *((_QWORD *)a1 + 2) == gptiCurrent )
    {
      ...
      if ( !*((_DWORD *)v14 + 21) || !v6 )
      {
        ...
        *v15 = xxxSendTransformableMessageTimeout(
                 ...
                 0x84u,
                 0LL,
                 (struct _LARGE_STRING *)(LOWORD(v25.x) | (LOWORD(v25.y) << 16)),
                 0,
                 0,
                 0LL,
                 1,
