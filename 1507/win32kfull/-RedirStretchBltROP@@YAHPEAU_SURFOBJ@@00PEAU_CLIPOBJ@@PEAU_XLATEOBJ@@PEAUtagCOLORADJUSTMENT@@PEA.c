/*
 * XREFs of ?RedirStretchBltROP@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAU_BRUSHOBJ@@K@Z @ 0x1C028FAB0
 * Callers:
 *     <none>
 * Callees:
        ...
        DWORD rop4)
{
  ...
  struct SURFACE *v27; // [rsp+70h] [rbp-89h] BYREF
  __int64 v28; // [rsp+78h] [rbp-81h] BYREF
  struct SURFACE *v29; // [rsp+80h] [rbp-79h] BYREF
  struct SURFACE *v30; // [rsp+88h] [rbp-71h] BYREF
  _BYTE v31[32]; // [rsp+90h] [rbp-69h] BYREF
  _BYTE v32[128]; // [rsp+B0h] [rbp-49h] BYREF
  __int64 HDEV; // [rsp+140h] [rbp+47h] BYREF
  CLIPOBJ *v34; // [rsp+158h] [rbp+5Fh]
