/*
 * XREFs of NtGdiBRUSHOBJ_pvAllocRbrush @ 0x1C02AAD90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?BRUSHOBJ_pvAllocRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@K@Z @ 0x1C025AC64 (-BRUSHOBJ_pvAllocRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@K@Z.c)
