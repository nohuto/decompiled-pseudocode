/*
 * XREFs of ValidateInertiaInfo @ 0x1C0239A30
 * Callers:
 *     NtUserReportInertia @ 0x1C0009820 (NtUserReportInertia.c)
 * Callees:
 *     sqrt_0 @ 0x1C015D126 (sqrt_0.c)
 *     memset @ 0x1C015D4C0 (memset.c)
 *     ?D3DXMatrixDeterminant@@YAHPEAMPEBU_D3DMATRIX@@@Z @ 0x1C01E3AA4 (-D3DXMatrixDeterminant@@YAHPEAMPEBU_D3DMATRIX@@@Z.c)
 */
...
__int64 __fastcall ValidateInertiaInfo(__int64 a1, _DWORD *a2, struct _D3DMATRIX *a3, double *a4)
{
  ...
  _DWORD *v15; // [rsp+A8h] [rbp+10h]
  struct _D3DMATRIX *v16; // [rsp+B0h] [rbp+18h]
  double *v17; // [rsp+B8h] [rbp+20h]
