/*
 * XREFs of ?FindInputDeviceForConfig@@YAHPEAUtagHIDDESC@@PEAUDEVICEINFO@@PEAH2PEAPEAU2@@Z @ 0x1C01D2564
 * Callers:
    ...
    if ( *(_DWORD *)(i + 316) )
    {
      ...
      if ( *(_DWORD *)(v11 + 24) == 8 || (unsigned int)(*(_DWORD *)(v11 + 24) - 1) <= 4 )
      {
                             ...
                             *(_WORD *)(*(_QWORD *)(i + 400) + 112LL)) )
        {
          v12 = *(_QWORD *)(i + 416);
          v5 = 1;
          *a3 = -__CFSHR__(*(_DWORD *)(v12 + 236), 13);
          if ( a5 )
            *a5 = (struct DEVICEINFO *)i;
          if ( *(_DWORD *)(i + 316) && (unsigned int)(*(_DWORD *)(v12 + 24) - 1) <= 4 )
            *a4 = 1;
          return v5;
        }
      }
