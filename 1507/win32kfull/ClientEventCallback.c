/*
 * XREFs of ClientEventCallback @ 0x1C020DC44
 * Callers:
...
unsigned __int8 *__fastcall ClientEventCallback(__int64 a1, __int64 a2)
{
  ...
  if ( result )
  {
    ...
    *((_QWORD *)v6 + 5) = a1;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v6, (char *)a2, v4, (void **)v6 + 6) >= 0
