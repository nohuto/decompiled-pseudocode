/*
 * XREFs of bBmfdLoadFont @ 0x1C0148294
 * Callers:
 *     BmfdLoadFontFileTE @ 0x1C0147960 (BmfdLoadFontFileTE.c)
 * Callees:
 *     bConvertFontRes @ 0x1C0147A10 (bConvertFontRes.c)
 *     bBMFDIFIMETRICS @ 0x1C014812C (bBMFDIFIMETRICS.c)
 *     bInitWinResData @ 0x1C01485F0 (bInitWinResData.c)
 *     bGetFntResource @ 0x1C01487AC (bGetFntResource.c)
 *     bVerifyFNTQuick @ 0x1C0148930 (bVerifyFNTQuick.c)
  ...
  if ( v10 )
  {
    while ( 1 )
    {
      ...
      if ( !(unsigned int)bVerifyFNTQuick(&v37, a2, a3, v8) )
        return 0LL;
      if ( !(unsigned int)bBMFDIFIMETRICS(v40, v7, 0LL, &v37, &v39) )
        return 0LL;
      v15 = 2LL * v39;
      if ( v15 > 0xFFFFFFFF )
        return 0LL;
  ...
  *((_QWORD *)v17 + 2) = v41;
  ...
  if ( v10 )
  {
    while ( 1 )
    {
      ...
      *(_OWORD *)v27 = v24;
      *(_QWORD *)(v27 + 16) = v25;
      if ( !(unsigned int)bConvertFontRes(v26, v7, &v37, v27) )
        break;
      ++v19;
      ...
      if ( LOWORD(v18[22 * v19]) )
      {
        ...
        *(_OWORD *)v33 = v30;
        *(_QWORD *)(v33 + 16) = v31;
        if ( !(unsigned int)bConvertFontRes(v32, v7, &v37, v33) )
          break;
        ++v19;
        v21 += *(unsigned int *)v21;
      }
