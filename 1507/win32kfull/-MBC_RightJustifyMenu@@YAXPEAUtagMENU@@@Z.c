  ...
  if ( (v7 & 0x20) != 0 )
  {
    ...
    if ( (int)v2 > 0 )
    {
      while ( !v9 )
      {
        if ( (*(_DWORD *)v8 & 4) == 0 )
        {
          v10 = MNIsOwnerDrawItem(v4, v8, v3, v6);
          goto LABEL_11;
        }
...
LABEL_23:
      ...
      else
      {
        if ( (*v15 & 4) != 0 )
          goto LABEL_21;
        v14 = MNIsOwnerDrawItem(v4, v15, v3, v6);
      }
      if ( !v14 )
        goto LABEL_23;
LABEL_21:
