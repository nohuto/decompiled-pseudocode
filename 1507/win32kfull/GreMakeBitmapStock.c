/*
 * XREFs of GreMakeBitmapStock @ 0x1C01494EC
 * Callers:
 *     NtGdiSetBitmapAttributes @ 0x1C01494E0 (NtGdiSetBitmapAttributes.c)
 * Callees:
...
__int64 __fastcall GreMakeBitmapStock(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    if ( !(unsigned int)SURFACE::bDIBSection(v4) || !*(_WORD *)(v6 + 100) && *(_DWORD *)(v6 + 212) )
    {
      if ( (a1 & 0x800000) != 0
        || *((_DWORD *)v5 + 40)
