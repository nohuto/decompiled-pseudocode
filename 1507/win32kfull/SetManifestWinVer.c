/*
 * XREFs of SetManifestWinVer @ 0x1C00DE690
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C00DE744 (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C00DE794 (SbGetContextDetailsByGuid.c)
 */
...
__int64 SetManifestWinVer()
{
  ...
  if ( v1 )
  {
    ...
    if ( ProcessWow64Process )
      ...
      v3 = *(_QWORD *)(PsGetProcessPeb(**(_QWORD **)(gptiCurrent + 384LL)) + 728);
