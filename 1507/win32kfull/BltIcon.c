...
__int64 __fastcall BltIcon(HDC a1, LONG a2, LONG a3, int a4, int a5, HDC a6, __int64 a7, int a8, int a9)
{
  LONG v9; // esi
  __int64 v14; // rdi
...
LABEL_2:
  ...
  if ( a8 == 3 )
  {
    ...
    HIWORD(v17) = 511;
    NtGdiAlphaBlend(a1, a2, a3, a4, a5, (__int64)a6, 0, v9, *(_DWORD *)(a7 + 140), *(_DWORD *)(a7 + 144) >> 1, v17);
  }
  else
  {
