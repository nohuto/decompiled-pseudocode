/*
 * XREFs of ?CanCoalesceNodeWithPrevious@@YAHPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@PEAUtagQMSG@@PEAUtagPOINTERQFRAME@@PEAW4tagPOINTERCOALESCE@@@Z @ 0x1C022E090
 * Callers:
        ...
        enum tagPOINTERCOALESCE *a5)
{
  ...
  if ( (*(_DWORD *)a2 & 1) != 0 )
  {
    ...
    v12 = *((_QWORD *)a1 + 10) + 40LL * *((unsigned int *)ValidNodeInFrame + 2);
    if ( !*((_QWORD *)a4 + 4) )
      *((_QWORD *)a4 + 4) = v12;
    v13 = *(_DWORD *)(v12 + 20);
    if ( (v13 & 1) == 0 )
    ...
    if ( (*(_DWORD *)a2 & 0x400000) != 0
      ...
      || (v14 & 0x40000000) != 0
      || (*((_DWORD *)a2 + 1) & 4) != 0
      || (v15 = *(_DWORD *)v11, (*(_DWORD *)v11 & 0x400000) != 0)
      || (v15 & 0x4000000) != 0
      || (v15 & 0x40000000) != 0
      || (*((_DWORD *)v11 + 1) & 4) != 0 )
    {
LABEL_37:
    ...
    if ( (v15 & 0x80000) == 0 || (v15 & 0x200000) != 0 )
    {
      if ( *((_DWORD *)v11 + 17) == *((_DWORD *)a2 + 17) )
      {
        ...
        {
          v16 = *(struct tagQ **)(*(_QWORD *)(*(_QWORD *)(LODWORD(gSharedInfo[2])
                                                        * (unsigned int)(unsigned __int16)*((_DWORD *)a2 + 20)
                                                        + gSharedInfo[1])
                                            + 16LL)
                                + 392LL);
