/*
 * XREFs of ?vTransparentCopyS16D16Identity@@YAXPEAUBLTINFO@@@Z @ 0x1C02848C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vTransparentCopyS16D16Identity(struct BLTINFO *a1)
{
  ...
  v1 = *((_DWORD *)a1 + 7);
  v2 = *((_DWORD *)a1 + 8);
  v3 = *(_QWORD *)(*((_QWORD *)a1 + 9) + 120LL);
  if ( v3 )
    v4 = **(_DWORD **)(v3 + 128) | *(_DWORD *)(*(_QWORD *)(v3 + 128) + 4LL) | *(_DWORD *)(*(_QWORD *)(v3 + 128) + 8LL);
  else
    LOWORD(v4) = -1;
