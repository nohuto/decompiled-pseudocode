/*
 * XREFs of TransformCoordinates @ 0x1C01C2534
 * Callers:
 *     ApplyTransforms @ 0x1C01C1EC0 (ApplyTransforms.c)
 * Callees:
 *     AdjustLinearity @ 0x1C01C1A50 (AdjustLinearity.c)
 */
...
LABEL_18:
  ...
  *v4 = v17;
  ...
  {
    v30 = 2400LL * v40;
    *(_DWORD *)(v30 + *(_QWORD *)(a2 + 680) + 2308) = v16;
    *(_DWORD *)(v30 + *(_QWORD *)(a2 + 680) + 2312) = *v4;
    v31 = (_DWORD *)(2400 * v29 + *(_QWORD *)(a2 + 680) + 2392);
    *v31 |= 0x80u;
  ...
  else
  {
    ...
    if ( (result & 0x80u) != 0LL )
    {
      *(_DWORD *)(v34 + v33 + 2392) = result | 0x100;
      v35 = *(_DWORD *)(v34 + *(_QWORD *)(a2 + 680) + 2308);
      if ( v35 <= v13 && v35 )
      {
        v12 = v36;
        v13 = v14;
