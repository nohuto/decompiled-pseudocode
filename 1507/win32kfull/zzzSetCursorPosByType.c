/*
 * XREFs of zzzSetCursorPosByType @ 0x1C003A608
 * Callers:
 *     zzzSetCursorPos @ 0x1C003A600 (zzzSetCursorPos.c)
 * Callees:
        ...
        (unsigned int)IsImmersiveAppRestricted(CurrentProcessWin32Process)) )
  {
    ...
    if ( !v5 || v5 == grpdeskRitInput )
    {
      if ( !gpqForeground
        ...
        || (_DWORD)v8 == (_DWORD)v7
        && ((v9 = HIDWORD(v8), v10 = HIDWORD(v7), (_DWORD)v9 == (_DWORD)v10) || (_DWORD)v9 == -1 || (_DWORD)v10 == -1)
        || *(int *)(v6 + 12) < 0
