/*
 * XREFs of ?xxxMKButtonSetState@@YAHG@Z @ 0x1C01EE330
 * Callers:
 *     ?xxxMKButtonClick@@YAHG@Z @ 0x1C01EE2D0 (-xxxMKButtonClick@@YAHG@Z.c)
...
__int64 __fastcall xxxMKButtonSetState(unsigned __int16 a1)
{
  ...
  v4 = gliQpcFreq.QuadPart * (unsigned __int64)(unsigned int)v3 / 0x3E8;
  if ( a1 )
  ...
  if ( (((unsigned __int8)v5 ^ v2) & 2) != 0 )
    xxxButtonEvent(2u, gptCursorAsync, 0LL, a1, v3, v4, 0LL, 0LL, 0LL, 0, 0, 0, 0, 0, 0LL, (__int64)&v8);
  gwMKButtonState = v5;
  v6 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(grpdeskRitInput + 24LL) + 24LL) + 16LL);
  PostEventMessageEx(v6, *(_QWORD *)(v6 + 392), 0xDu, 0LL, 0, (LARGE_INTEGER)11LL, (LARGE_INTEGER)3LL, 0LL);
  return 0LL;
}
