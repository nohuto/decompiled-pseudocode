/*
 * XREFs of InitializeWin32PoolTracking @ 0x1C0156450
 * Callers:
 *     <none>
 * Callees:
 *     ?IsWin32kRefreshed@@YA_NXZ @ 0x1C015B304 (-IsWin32kRefreshed@@YA_NXZ.c)
 *     ?StopWin32PoolTracking@@YAXXZ @ 0x1C015B630 (-StopWin32PoolTracking@@YAXXZ.c)
 *     ?LoadWin32PoolTrackingSettings@@YAXXZ @ 0x1C01F6774 (-LoadWin32PoolTrackingSettings@@YAXXZ.c)
 */
...
__int64 InitializeWin32PoolTracking()
{
  ...
  {
    gpLeakTrackingAllocator = &unk_1C02E19B0;
    return 0LL;
  }
}
