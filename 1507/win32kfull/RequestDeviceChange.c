/*
 * XREFs of RequestDeviceChange @ 0x1C01E0174
 * Callers:
 ...
 *     DeviceNotify @ 0x1C01DF790 (DeviceNotify.c)
 * Callees:
...
struct DEVICEINFO *__fastcall RequestDeviceChange(struct DEVICEINFO *a1, __int16 a2, int a3)
{
  ...
  v6 = a1;
  if ( v3 == 3 )
    v7 = &aDeviceTemplate[284];
  else
    v7 = &aDeviceTemplate[142 * v3];
  if ( !a3 )
  ...
  *((_WORD *)v6 + 33) |= a2;
  ...
  if ( (a2 & 0x100) != 0 )
  {
    ...
    *((_QWORD *)v6 + 40) = KeGetCurrentThread();
    v10 = SetDeviceEvent((struct tagDEVICE_TEMPLATE *)v7);
  ...
  {
    *((_QWORD *)v6 + 40) = 0LL;
    SetDeviceEvent((struct tagDEVICE_TEMPLATE *)v7);
  }
  return v6;
}
