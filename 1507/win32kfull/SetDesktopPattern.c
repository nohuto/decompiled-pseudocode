/*
 * XREFs of SetDesktopPattern @ 0x1C0152980
 * Callers:
 ...
 *     ?SetGlobalDesktopPattern@@YAHPEAUHBITMAP__@@@Z @ 0x1C01FEF88 (-SetGlobalDesktopPattern@@YAHPEAUHBITMAP__@@@Z.c)
 */
...
__int64 __fastcall SetDesktopPattern(__int64 a1, const wchar_t *a2)
{
  ...
  if ( !a2 )
  {
    if ( !(unsigned int)FastGetProfileStringFromIDW(a1, 4LL, 2LL, &qword_1C015E270, v17, 260, 0) )
      return v3;
    v2 = v17;
  }
