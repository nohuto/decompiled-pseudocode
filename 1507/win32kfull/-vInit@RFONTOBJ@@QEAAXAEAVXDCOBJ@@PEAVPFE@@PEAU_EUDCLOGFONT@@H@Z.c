/*
 * XREFs of ?vInit@RFONTOBJ@@QEAAXAEAVXDCOBJ@@PEAVPFE@@PEAU_EUDCLOGFONT@@H@Z @ 0x1C010FB9C
 * Callers:
...
void __fastcall RFONTOBJ::vInit(struct _FD_XFORM **this, struct XDCOBJ *a2, struct PFE *a3, struct _EUDCLOGFONT *a4)
{
  __int64 v5; // rdx
  __int64 v9; // rdi
  int v10; // eax
  ...
  struct LFONT *v33; // [rsp+78h] [rbp-88h] BYREF
  ...
  struct _FD_XFORM v40; // [rsp+C0h] [rbp-40h] BYREF
  ...
  GreAcquireSemaphore(*(_QWORD *)&(*this)[33].eXX);
  *(_DWORD *)(*(_QWORD *)a2 + 264LL) &= ~1u;
LABEL_23:
  PFFREFOBJ::~PFFREFOBJ((PFFREFOBJ *)&v38);
LABEL_24:
  LFONTOBJ::~LFONTOBJ(&v33);
}
