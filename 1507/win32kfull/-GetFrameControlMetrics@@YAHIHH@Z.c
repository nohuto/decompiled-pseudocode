/*
 * XREFs of ?GetFrameControlMetrics@@YAHIHH@Z @ 0x1C0056220
 * Callers:
...
__int64 __fastcall GetFrameControlMetrics(unsigned int a1, int a2, int a3)
{
  ...
  v5 = 0;
  v7 = 0;
  v8 = *((_WORD *)&unk_1C02E2060 + 2 * a1 + 1);
  v9 = gpsi + 5748LL;
  if ( !a3 )
    v9 = gpsi + 4260LL;
  v10 = v9 + 16LL * a1;
  switch ( *((_WORD *)&unk_1C02E2060 + 2 * a1) )
  {
    case 1:
      if ( (v8 & 0x80u) != 0 )
      {
...
LABEL_20:
  ...
  if ( *((_WORD *)&unk_1C02E2060 + 2 * a1) != 4 )
  {
    if ( *((_WORD *)&unk_1C02E2060 + 2 * a1) != 5 )
    {
      if ( *((unsigned __int16 *)&unk_1C02E2060 + 2 * a1) != 0xFFFF )
        goto LABEL_14;
      if ( (v8 & 1) == 0 )
      {
