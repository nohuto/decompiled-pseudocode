/*
 * XREFs of ?UMPDDrvPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C029EF10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct _POINTFIX *v41; // [rsp+108h] [rbp-8h]
