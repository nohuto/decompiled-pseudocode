/*
 * XREFs of ?xxxDrawMenuItemText@@YAXPEAUtagMENU@@PEAUtagITEM@@PEAUHDC__@@HHPEAGHH@Z @ 0x1C023ECF4
 * Callers:
...
{
  __int64 v11; // rax
  __m128i *SourceString; // rbx
  int PrefixCount; // r12d
  __int64 ThreadWin32Thread; // [rsp+58h] [rbp-270h]
  ...
  if ( a7 < 255 )
  {
    SourceString = (__m128i *)v18;
  }
  else
  {
    v11 = Win32AllocPool(2LL * (a7 + 1), 1953657685LL);
    SourceString = (__m128i *)v11;
    if ( !v11 )
      return;
  ...
  {
    GreExtTextOutWInternal(a3, a4, a5, 0, 0LL, (unsigned __int16 *)SourceString, a7 - HIWORD(PrefixCount), 0LL, 0LL, 0);
    goto LABEL_10;
  }
  xxxClientExtTextOutW(a3, a4, a5, 0, 0LL, (PCWSTR)SourceString, a7 - HIWORD(PrefixCount));
  if ( (unsigned int)MNGetpItemIndex((__int64)a1, (__int64)a2) != -1 && v16 == *((_QWORD *)a2 + 7) )
  {
LABEL_10:
    if ( a8
