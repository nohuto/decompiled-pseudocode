/*
 * XREFs of GetPointerDeviceFrameScanTime @ 0x1C01CB93C
 * Callers:
 ...
 * Callees:
 *     ?DivideToCeilingOrNearestInt@@YAHKKHPEAK@Z @ 0x1C01C46C0 (-DivideToCeilingOrNearestInt@@YAHKKHPEAK@Z.c)
 */
...
LABEL_19:
  ...
  *a6 = UsageValue;
  ...
  if ( v12 < *(_DWORD *)(a1 + 1428) % *(_DWORD *)(a1 + 1472) )
    ++*(_DWORD *)(a1 + 1444);
  v14 = *(_DWORD *)(a1 + 1428);
  v15 = v12 + *(_DWORD *)(a1 + 1472) * *(_DWORD *)(a1 + 1444);
  if ( v15 <= v14 )
  {
    v18 = *(_DWORD *)(a1 + 1436);
    if ( v18 && v11 >= 5 )
      ...
      v19 = v14 + 80;
    *(_DWORD *)(a1 + 1428) = v19;
    *(_DWORD *)(a1 + 1468) = v13 | 1;
  }
  else
  {
    *(_DWORD *)(a1 + 1428) = v15;
    v16 = v11 - 1;
    v17 = v15 - *(_DWORD *)(a1 + 1432);
    if ( v17 )
      *(_DWORD *)(a1 + 1436) = (v17 - 1) / v16 + 1;
  }
LABEL_20:
  if ( *(_DWORD *)(a1 + 1440) != 1 )
  {
    v21 = *(_DWORD *)(a1 + 1428) - *(_DWORD *)(a1 + 1432);
    LODWORD(a7) = 0;
    v22 = DivideToCeilingOrNearestInt(v21, 0xAu, 0, (unsigned int *)&a7);
    v24 = (unsigned int)a7;
    if ( !v22 )
      v24 = v23 + 8;
    *v10 = v24 + *(_DWORD *)(a1 + 1416);
    *v9 = *(_QWORD *)(a1 + 1456) + gliQpcFreq.QuadPart * v24 / 1000;
  }
