/*
 * XREFs of CalcForegroundInsertAfter @ 0x1C008143C
 * Callers:
 ...
 *     ?GetLastNonBottomMostWindow@@YAPEAUtagWND@@PEAU1@H@Z @ 0x1C00EC0D8 (-GetLastNonBottomMostWindow@@YAPEAUtagWND@@PEAU1@H@Z.c)
 */
...
struct tagWND *__fastcall CalcForegroundInsertAfter(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 55) & 0xC0) == 0x40
    || (v4 = *(_QWORD *)(a1 + 16), (*(_DWORD *)(v4 + 448) & 0x20) == 0)
    && (*(_DWORD *)(*(_QWORD *)(v4 + 384) + 12LL) & 0x80100) == 0 )
  {
    if ( gpqForeground )
    {
      v6 = *(_QWORD *)(a1 + 16);
      if ( *(_QWORD *)(v6 + 392) != gpqForeground )
      {
