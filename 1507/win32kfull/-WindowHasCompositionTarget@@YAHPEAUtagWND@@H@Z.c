/*
 * XREFs of ?WindowHasCompositionTarget@@YAHPEAUtagWND@@H@Z @ 0x1C00E9AD4
 * Callers:
 *     WindowHasAnyCompositionTargetWithInputSink @ 0x1C0007AB4 (WindowHasAnyCompositionTargetWithInputSink.c)
 *     ?TestWindowForCompositionTarget@@YAJPEAUHWND__@@H@Z @ 0x1C00E9A04 (-TestWindowForCompositionTarget@@YAJPEAUHWND__@@H@Z.c)
 * Callees:
