/*
 * XREFs of DxgkEngGetRedirBitmapSharedHandle @ 0x1C0264C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngGetRedirBitmapSharedHandle(HDC a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  return UnexpectedThreadTerminationHandler<DWMSPRITEREF>::~UnexpectedThreadTerminationHandler<DWMSPRITEREF>(v7);
}
