/*
 * XREFs of ComputeHTCell @ 0x1C00A6068
 * Callers:
...
__int64 __fastcall ComputeHTCell(unsigned __int16 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 != 18 )
  {
    v7 = ComputeChecksum(&v31, 1213485891LL, 2LL);
    LOBYTE(v30[1]) = 1;
    v8 = a1 >> 1;
    LODWORD(v9) = v30[0];
    v8 *= 2LL;
...
LABEL_6:
  ...
  v31 = v11;
  HIWORD(v30[1]) = v10 * (7 / (unsigned __int16)v10 + 1);
  v32 = (unsigned __int16)(HIWORD(v30[1]) + 7);
  LOWORD(v30[2]) = HIWORD(v30[1]) + 7;
  v14 = 6 * v11 * v32;
  HIDWORD(v30[2]) = v14;
  if ( !a3 )
    return ComputeChecksum(v30, v7, 32LL);
  if ( (v30[1] & 1) != 0 )
  {
    v30[3] = 0LL;
LABEL_9:
  ...
  if ( v27 )
  {
    if ( (unsigned int)GenerateWORDPat(v9, v12, v13, (_DWORD)v27, v29, v32, v31) )
      goto LABEL_9;
    EngFreeMem(v28);
  }
  return 4294967294LL;
