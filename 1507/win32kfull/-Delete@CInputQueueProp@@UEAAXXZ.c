/*
 * XREFs of ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C00E9D60
 * Callers:
 *     <none>
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C00E9E74 (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
