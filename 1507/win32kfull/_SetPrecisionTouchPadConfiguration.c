/*
 * XREFs of _SetPrecisionTouchPadConfiguration @ 0x1C0225E2C
 * Callers:
 ...
 *     ?BuildTouchpadAccelerationCurve@@YAXPEAUtagMONITOR@@@Z @ 0x1C00F7954 (-BuildTouchpadAccelerationCurve@@YAXPEAUtagMONITOR@@@Z.c)
...
__int64 __fastcall SetPrecisionTouchPadConfiguration(_DWORD *a1)
{
  ...
  if ( !a1 || *a1 )
    return 0LL;
  dword_1C031B4FC = DWORD2(gTouchPadParameters);
  dword_1C031B56C = qword_1C0323098;
  if ( a1[2] <= 4u )
  {
    dword_1C031B4FC = a1[2];
    DWORD2(gTouchPadParameters) = a1[2];
  }
  v2 = a1[4];
  if ( (unsigned int)(v2 - 1) <= 0x13 )
    dword_1C031B56C = v2;
  dword_1C031B50C = -__CFSHR__(a1[3], 3);
  dword_1C031B51C = -__CFSHR__(a1[3], 4);
  dword_1C031B52C = -__CFSHR__(a1[3], 8);
  dword_1C031B53C = -__CFSHR__(a1[3], 9);
  dword_1C031B54C = -__CFSHR__(a1[3], 10);
  dword_1C031B55C = -__CFSHR__(a1[3], 11);
  dword_1C031B57C = -(a1[5] & 1);
  dword_1C031B58C = -__CFSHR__(a1[5], 2);
  dword_1C031B59C = -__CFSHR__(a1[5], 3);
  ...
  if ( v3 )
  {
    ...
    v5 = a1[4];
    if ( (_DWORD)qword_1C0323098 != v5 && (unsigned int)(v5 - 1) <= 0x13 )
    {
      LODWORD(qword_1C0323098) = a1[4];
    ...
    HIDWORD(qword_1C0323098) ^= (a1[5] ^ HIDWORD(qword_1C0323098)) & 1;
    HIDWORD(qword_1C0323098) ^= (a1[5] ^ HIDWORD(qword_1C0323098)) & 2;
    HIDWORD(qword_1C0323098) ^= (a1[5] ^ HIDWORD(qword_1C0323098)) & 4;
  }
