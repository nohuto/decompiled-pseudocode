/*
 * XREFs of fs__NewTransformation @ 0x1C00AAC30
 * Callers:
 ...
 *     sbit_NewTransform @ 0x1C00AB8A0 (sbit_NewTransform.c)
 *     fsg_QueryPPEMXY @ 0x1C00AB910 (fsg_QueryPPEMXY.c)
 *     fsg_UpdatePrivateSpaceAddresses @ 0x1C00AB990 (fsg_UpdatePrivateSpaceAddresses.c)
 *     fsg_CopyFontProgramResults @ 0x1C00ABC50 (fsg_CopyFontProgramResults.c)
...
__int64 __fastcall fs__NewTransformation(__int64 a1, __int64 a2)
{
  ...
  *(_WORD *)(v10 + 1076) = 0;
  ...
  if ( (*(_BYTE *)(a1 + 152) & 4) != 0 )
    *(_WORD *)(v10 + 1076) |= 4u;
  if ( (*(_BYTE *)(a1 + 152) & 1) != 0 && !*(_DWORD *)(v10 + 320) )
    *(_WORD *)(v10 + 1076) ^= 4u;
  if ( (*(_BYTE *)(a1 + 152) & 8) != 0 )
    *(_WORD *)(v10 + 1076) |= 8u;
  v20 = *(_WORD *)(v10 + 1076);
