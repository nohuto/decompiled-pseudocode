/*
 * XREFs of ?RemoteSyncToggleKeys@@YAXK@Z @ 0x1C01D8640
 * Callers:
...
void __fastcall RemoteSyncToggleKeys(int a1)
{
  ...
  {
    v2 = (v1 >> 14) & 1;
    if ( (((unsigned __int8)~(_BYTE)a1 >> 2) & 1) != (((unsigned __int8)~byte_1C03230D5 >> 1) & 1) )
    {
      v4[0] = 58;
      v5 = 20;
    ...
    v3 = byte_1C03230F4;
    if ( (((unsigned __int8)~(_BYTE)v1 >> 1) & 1) != (((unsigned __int8)~byte_1C03230F4 >> 1) & 1) )
    {
      v4[0] = 69;
      v5 = 144;
      xxxProcessKeyEvent((struct tagKE *)v4, 0LL, v2, 0, 0LL);
    ...
    if ( (GetActiveHKL() & 0x3FF) == 0x11
      && (((unsigned __int8)~(_BYTE)gSetLedReceived >> 3) & 1) != (((unsigned __int8)~byte_1C03230D5 >> 3) & 1) )
    {
      v4[0] = 112;
      v5 = 21;
      xxxProcessKeyEvent((struct tagKE *)v4, 0LL, v2, 0, 0LL);
