/*
 * XREFs of ?bBitBltFromScreen@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C0298A7C
 * Callers:
        ...
        unsigned int a11)
{
  ...
  struct _RECTL *v42; // [rsp+88h] [rbp-78h]
  ...
  struct _XLATEOBJ *v48; // [rsp+B0h] [rbp-50h]
  ...
  v20 = v42;
  v21 = a1;
  MULTISURF::MULTISURF((MULTISURF *)v58, a1, v42);
...
LABEL_37:
          ...
          {
            v40 = *(_QWORD *)(v56 + 4);
            LODWORD(v62[0]) = v43 + *(_DWORD *)(v56 + 4);
            LODWORD(v62[1]) = v43 + *(_DWORD *)(v56 + 12);
            HIDWORD(v62[0]) = v44 + *(_DWORD *)(v56 + 8);
            HIDWORD(v62[1]) = v44 + *(_DWORD *)(v56 + 16);
          }
          else
          {
            v35 = *v20;
          ...
          if ( v19 == 52428 )
          {
            if ( (*((_DWORD *)v36 + 28) & 0x400) != 0 )
              v37 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*((_QWORD *)v54 + 7) + 2872LL);
            else
              v37 = EngCopyBits;
            v15 &= OffCopyBits(
          ...
          else
          {
            ...
            if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v55) + 112) & 1) != 0 )
              v38 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *, POINTL *, BRUSHOBJ *, POINTL *, ROP4))(*((_QWORD *)v54 + 7) + 2864LL);
            else
              v38 = EngBitBlt;
            v15 &= OffBitBlt(
