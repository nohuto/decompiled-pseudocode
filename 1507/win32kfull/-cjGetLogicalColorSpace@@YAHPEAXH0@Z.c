/*
 * XREFs of ?cjGetLogicalColorSpace@@YAHPEAXH0@Z @ 0x1C02B0970
 * Callers:
...
__int64 __fastcall cjGetLogicalColorSpace(HCOLORSPACE a1, int a2, char *a3)
{
  unsigned int v3; // ebx
  ...
  v3 = 0;
  v4 = a2;
  if ( (unsigned __int64)a2 >= 0x24C && a3 )
  {
