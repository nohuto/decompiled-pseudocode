/*
 * XREFs of ?GrePatBltLockedDC@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVERECTL@@KPEAVSURFACE@@KKKK@Z @ 0x1C0086F64
 * Callers:
        ...
        unsigned int a9)
{
  ...
  if ( (v13 & 0x800) != 0 )
  {
    v14 = UserSurfaceAccessCheck(*((_QWORD *)a5 + 74));
  }
  else
  {
    if ( (v13 & 0x10000000) == 0 )
      goto LABEL_10;
    v14 = UserScreenAccessCheck(this);
  }
  if ( !v14 )
  {
LABEL_45:
...
LABEL_27:
              if ( (((unsigned __int8)v9 ^ (unsigned __int8)(16 * v9)) & 0xF0) != 0 )
              {
                ...
                v30 = *(_QWORD *)v11 + 1584LL;
                if ( (*(_DWORD *)(v25 + 8) & 1) != 0
                  || (*(_DWORD *)(*(_QWORD *)v11 + 332LL) & 1) != 0
                  || (v31 = *(_DWORD *)(*(_QWORD *)v11 + 1712LL), (v31 & 1) != 0)
                  && *(_DWORD *)(*(_QWORD *)v11 + 1632LL) != a6
                  || (v31 & 2) != 0 && *(_DWORD *)(*(_QWORD *)v11 + 1636LL) != a7 )
                {
                  v32 = *(_DWORD *)(v25 + 40);
                  v33 = *(_DWORD *)(v25 + 32);
                  v34 = *(_DWORD *)(v25 + 44);
                  ...
                  *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v11 + 80LL) + 36LL) = a9;
                  EBRUSHOBJ::vInitBrush(v30, *(_QWORD *)v11, *(_QWORD *)(*(_QWORD *)v11 + 144LL), v36, v40);
                  v11 = v42;
