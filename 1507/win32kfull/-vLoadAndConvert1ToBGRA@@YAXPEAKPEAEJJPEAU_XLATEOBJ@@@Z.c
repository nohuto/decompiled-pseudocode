/*
 * XREFs of ?vLoadAndConvert1ToBGRA@@YAXPEAKPEAEJJPEAU_XLATEOBJ@@@Z @ 0x1C02BD8E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  if ( (a5->flXlate & 2) != 0 )
  {
    ...
    if ( v9 )
    {
      ...
      do
      {
        ...
        --v10;
        *a1++ = *((_DWORD *)&a5[3].iSrcType + v12) | 0xFF000000;
      }
      while ( v9 );
    }
    if ( a4 >= 8 )
      ...
      do
      {
        ...
        *a1 = v18 | 0xFF000000;
        ...
        if ( v34 > v35 )
          v34 %= v35;
        v36 = v16 & 1;
        a1[6] = *((_DWORD *)&a5[3].iSrcType + v34) | 0xFF000000;
        v37 = a5->cEntries;
        if ( v36 > v37 )
          v36 %= v37;
        ++v8;
        a1[7] = *((_DWORD *)&a5[3].iSrcType + v36) | 0xFF000000;
        a1 += 8;
        --v14;
      }
      while ( v14 );
    ...
    if ( a4 )
    {
      ...
      do
      {
        ...
        --v6;
        *a1++ = *((_DWORD *)&a5[3].iSrcType + v39) | 0xFF000000;
        --a4;
      }
      while ( a4 );
    }
