/*
 * XREFs of NtGdiGetETM @ 0x1C02B3C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetETM(HDC a1, _BYTE *a2)
{
  ...
  __int64 v9; // r9
  _BYTE *v10; // r9
  __int64 v12; // [rsp+20h] [rbp-338h]
  __int64 v13; // [rsp+28h] [rbp-330h]
  struct _FONTOBJ *v14; // [rsp+50h] [rbp-308h] BYREF
  int v15; // [rsp+58h] [rbp-300h] BYREF
  ULONG_PTR v16; // [rsp+60h] [rbp-2F8h] BYREF
  PVOID pvConsumer; // [rsp+68h] [rbp-2F0h] BYREF
  _QWORD v18[6]; // [rsp+70h] [rbp-2E8h] BYREF
  _BYTE Src[64]; // [rsp+A0h] [rbp-2B8h] BYREF
  _BYTE v20[608]; // [rsp+E0h] [rbp-278h] BYREF
