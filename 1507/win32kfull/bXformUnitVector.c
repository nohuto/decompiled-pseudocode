/*
 * XREFs of bXformUnitVector @ 0x1C00A8750
 * Callers:
 *     bComputeMaxGlyph @ 0x1C00A9D18 (bComputeMaxGlyph.c)
 *     bInitXform @ 0x1C011F6A0 (bInitXform.c)
 * Callees:
 *     ??4EPOINTQF@@QEAAXAEAVEPOINTFL@@@Z @ 0x1C0008114 (--4EPOINTQF@@QEAAXAEAVEPOINTFL@@@Z.c)
...
__int64 __fastcall bXformUnitVector(__int64 a1, float *a2, float *a3, float *a4, __int64 a5, float *a6)
{
  ...
  v22 = v11;
  v23 = v7;
  if ( EFLOAT::bIsZero((EFLOAT *)&v22) && EFLOAT::bIsZero((EFLOAT *)&v23) )
  {
    v16 = v10 * v14;
    v15 = v9 * v13;
  }
  ...
  *a4 = v19;
  ...
  if ( v18 )
  {
    *(float *)&a6 = v19 * 16.0;
    *((float *)&a6 + 1) = v20 * 16.0;
    EPOINTQF::operator=(v18, (__int64)&a6);
  }
  return 1LL;
}
