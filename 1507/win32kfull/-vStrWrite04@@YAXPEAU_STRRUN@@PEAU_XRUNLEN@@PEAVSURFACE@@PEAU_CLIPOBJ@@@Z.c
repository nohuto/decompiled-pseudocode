/*
 * XREFs of ?vStrWrite04@@YAXPEAU_STRRUN@@PEAU_XRUNLEN@@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02BC000
 * Callers:
 *     <none>
 * Callees:
            ...
            do
            {
              ...
              if ( v45 < *v5 + v5[1] )
              {
                ...
                do
                {
                  ...
                  if ( v45 >= si128.left && v45 < si128.right )
                    v48 = v48 & ~dword_1C02E7080[v51] | dword_1C02E7080[v51] & (*v50 << dword_1C02E7060[v51]);
                  ++v51;
                  ++v50;
                  ++v46;
                  v53 = v51;
      ...
      for ( i = v9; v5 != a2; v59 = v5 )
      {
        ...
        if ( *v5 < v11 )
        {
          ...
          if ( (unsigned __int64)v12 < *((_QWORD *)a3 + 9) + (unsigned __int64)*((unsigned int *)a3 + 16) )
          {
            ...
            do
            {
              v18 = dword_1C02E7080[v17];
              ++v14;
              v19 = *v16;
              ++v10;
              v20 = dword_1C02E7060[v17];
              ++v16;
              ++v17;
