/*
 * XREFs of bLoadNtFon @ 0x1C015B154
 * Callers:
...
LABEL_22:
          ...
          else
          {
            ...
            while ( 1 )
            {
              ...
              *(v19 - 8) = 0LL;
              *v19 = v16;
              if ( !(unsigned int)bConvertFontRes(v20, v23, &v38, (__int64)&v15[11 * v17 + 5]) )
                break;
              ...
              if ( (unsigned __int16)v24 <= 8u )
              {
                ...
                if ( _bittest(&v25, v24) )
                {
                  ...
                  *(_OWORD *)v30 = v27;
                  *(_QWORD *)(v30 + 16) = 0LL;
                  if ( !(unsigned int)bConvertFontRes(v29, v28, &v38, v30) )
                    break;
                  ++v41;
                  v16 = (unsigned int *)((char *)v16 + **v19);
                  LODWORD(v7) = v7 + 1;
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)&v38 = *((_QWORD *)pv + v3);
      ...
      if ( !bVerifyFNTQuick((__int64 *)&v38) )
        break;
      if ( !(unsigned int)bBMFDIFIMETRICS(v36, v35, 0LL, &v38, &v32) )
        break;
      ++v10;
      if ( v9 + v32 < v9 )
        break;
