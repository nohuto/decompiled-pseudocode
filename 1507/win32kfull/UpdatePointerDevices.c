/*
 * XREFs of UpdatePointerDevices @ 0x1C0100A40
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( gpDeviceInfoList )
    {
      ...
      do
      {
        if ( *(_DWORD *)(v4 + 316) )
        {
          ...
          {
            *(_OWORD *)(*(_QWORD *)(v6 + 264) + 44LL) = *(_OWORD *)(*(_QWORD *)v5 + 120LL);
            *(_OWORD *)(*(_QWORD *)(v6 + 264) + 60LL) = *(_OWORD *)(*(_QWORD *)v5 + 136LL);
            v3 = *(_QWORD *)(v6 + 264);
            *(_OWORD *)(v3 + 28) = *(_OWORD *)(*(_QWORD *)v5 + 104LL);
            *(_OWORD *)(v6 + 124) = *(_OWORD *)(*(_QWORD *)(v6 + 264) + 28LL);
          }
