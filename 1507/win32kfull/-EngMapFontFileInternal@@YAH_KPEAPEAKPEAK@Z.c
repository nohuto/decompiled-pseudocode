/*
 * XREFs of ?EngMapFontFileInternal@@YAH_KPEAPEAKPEAK@Z @ 0x1C027DEF4
 * Callers:
 *     EngMapFontFile @ 0x1C027EBE0 (EngMapFontFile.c)
 * Callees:
...
__int64 __fastcall EngMapFontFileInternal(__int64 a1, unsigned int **a2, unsigned int *a3)
{
  ...
  else if ( *(_QWORD *)(a1 + 80) )
  {
    ...
    {
      ViewSize = 0LL;
      if ( Win32MapViewInSessionSpace(v9, (PVOID *)(a1 + 8), &ViewSize) < 0 )
        v6 = 0;
      else
        *(_DWORD *)(a1 + 96) = 1;
      v7 = 0;
