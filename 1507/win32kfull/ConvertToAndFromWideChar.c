/*
 * XREFs of ConvertToAndFromWideChar @ 0x1C0124EE8
 * Callers:
 ...
 *     EngMultiByteToWideChar @ 0x1C026BEF0 (EngMultiByteToWideChar.c)
 *     EngWideCharToMultiByte @ 0x1C026BF10 (EngWideCharToMultiByte.c)
 ...
 *     ConvertToAndFromWideCharSymCP @ 0x1C026BC14 (ConvertToAndFromWideCharSymCP.c)
    ...
    if ( !p_CodePageTable )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( ZwQueryInformationFile(FileHandle, &IoStatusBlock, FileInformation, 0x18u, FileStandardInformation) >= 0 )
      {
        ...
        if ( Length )
        {
          v16 = (USHORT *)PALLOCMEM2(Length, 1668768583LL, 1);
          v11 = v16;
          if ( v16 )
          {
