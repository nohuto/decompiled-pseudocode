/*
 * XREFs of ?PassedCurtainMoveThresholds@@YAH_K0PEAUtagTPSTATE@@PEAUtagTPCONTACTSTATE@@@Z @ 0x1C01F1D0C
 * Callers:
        ...
        struct tagTPCONTACTSTATE *a4)
{
  ...
  v4 = 0;
  if ( !gliQpcFreq.QuadPart || a2 - a1 > gliQpcFreq.QuadPart * (unsigned __int64)(unsigned int)dword_1C03236E0 / 0x3E8 )
    return 0LL;
  v6 = *((_QWORD *)a3 + 143);
  LOBYTE(v4) = (int)((HIDWORD(v6) - HIDWORD(*((_QWORD *)a4 + 1))) * (HIDWORD(v6) - HIDWORD(*((_QWORD *)a4 + 1)))
                   + (v6 - *((_QWORD *)a4 + 1)) * (v6 - *((_QWORD *)a4 + 1))) > (unsigned __int64)(unsigned int)dword_1C03236E4;
  return v4;
}
