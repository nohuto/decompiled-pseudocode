/*
 * XREFs of ?bGetDEVICEMETRICS@RFONTOBJ@@QEAAHPEAU_FD_DEVICEMETRICS@@@Z @ 0x1C002C64C
 * Callers:
...
__int64 __fastcall RFONTOBJ::bGetDEVICEMETRICS(POINTL **this, struct _FD_DEVICEMETRICS *a2)
{
  ...
  POINTL v11; // [rsp+50h] [rbp+8h] BYREF
  ...
  else
  {
    ...
    if ( ((*this)[1].y & 0x10000000) != 0 )
      (*this)[44].x = (((*this)[43].y * ((*this)[42].x + 2) + 3) & 0xFFFFFFFC) + 16;
