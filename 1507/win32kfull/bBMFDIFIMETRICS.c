/*
 * XREFs of bBMFDIFIMETRICS @ 0x1C014812C
 * Callers:
 ...
 *     bMappedViewStrlen @ 0x1C01488B8 (bMappedViewStrlen.c)
 */
...
__int64 __fastcall bBMFDIFIMETRICS(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, unsigned int *a5)
{
  ...
  if ( !v8 )
    v8 = *a4
       + ((*(unsigned __int8 *)(*a4 + 108LL) << 24) | (unsigned __int64)(*(unsigned __int8 *)(*a4 + 105LL) | (*(unsigned __int16 *)(*a4 + 106LL) << 8)));
