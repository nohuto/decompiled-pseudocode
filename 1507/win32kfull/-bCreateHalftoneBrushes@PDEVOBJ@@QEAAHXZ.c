/*
 * XREFs of ?bCreateHalftoneBrushes@PDEVOBJ@@QEAAHXZ @ 0x1C0114618
 * Callers:
 *     PDEVOBJ_bCreateHalftoneBrushesWrap @ 0x1C0114560 (PDEVOBJ_bCreateHalftoneBrushesWrap.c)
 * Callees:
...
LABEL_9:
    ...
    if ( (int)v2 >= 6 )
    {
      SETFLAG(1, (volatile unsigned int *)(*(_QWORD *)this + 56LL), 0x100u);
      return 1LL;
    }
    v2 = (int)v2;
    if ( (int)v2 > 0 )
