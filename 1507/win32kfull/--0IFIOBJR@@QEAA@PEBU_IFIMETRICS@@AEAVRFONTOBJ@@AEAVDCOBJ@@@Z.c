/*
 * XREFs of ??0IFIOBJR@@QEAA@PEBU_IFIMETRICS@@AEAVRFONTOBJ@@AEAVDCOBJ@@@Z @ 0x1C00385A4
 * Callers:
  ...
  switch ( v8 )
  {
    ...
    case 8192:
      if ( (a2->fsSelection & 1) == 0 )
      {
        v20 = *v6;
LABEL_15:
        *((_OWORD *)this + 1) = *(_OWORD *)((char *)v6 + v20);
        *((_DWORD *)this + 8) = *(int *)((char *)v6 + v20 + 16);
        break;
      }
      goto LABEL_16;
    case 16384:
...
LABEL_16:
  ...
  *((_DWORD *)this + 9) = v9;
  v10 = (unsigned int)(__int16)IFIOBJ::fwdExternalLeading(this);
  *((_DWORD *)this + 12) = v10;
  *((_DWORD *)this + 11) = (__int16)(*(_WORD *)(v13 + 60) + *(_WORD *)(v13 + 62) - *(_WORD *)(v13 + 56));
  if ( (*(_DWORD *)(v13 + 48) & 0x3000010) == 0 )
  {
    v18 = *(_DWORD *)(*(_QWORD *)v11 + 672LL);
    if ( v18 > 1 )
    {
      *((_DWORD *)this + 10) = v18 * v12;
      *((_DWORD *)this + 9) = v18 * v14;
    }
    v19 = *(_DWORD *)(*(_QWORD *)v11 + 676LL);
    if ( v19 > 1 )
    {
      v10 = (unsigned int)(v19 * v10);
      v21 = v19 * *((_DWORD *)this + 11);
      *((_DWORD *)this + 12) = v10;
      *((_DWORD *)this + 11) = v21;
    }
  }
  ...
  {
    v22 = *(_QWORD *)(*(_QWORD *)a4 + 48LL);
    *((_DWORD *)this + 13) = PDEVOBJ::ulLogPixelsY((PDEVOBJ *)&v22, v10, v11);
    *((_DWORD *)this + 14) = PDEVOBJ::ulLogPixelsX((PDEVOBJ *)&v22, v15, v16);
  }
  else
  {
