/*
 * XREFs of ?vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z @ 0x1C0013C0C
 * Callers:
...
void __fastcall XEPALOBJ::vFill_rgbquads(XEPALOBJ *this, struct tagRGBQUAD *a2, unsigned int a3, int a4)
{
  ...
  {
    *a2 = **(struct tagRGBQUAD **)(v5 + 128);
    a2[1] = *(struct tagRGBQUAD *)(*(_QWORD *)(*(_QWORD *)this + 128LL) + 4LL);
    a2[2] = *(struct tagRGBQUAD *)(*(_QWORD *)(*(_QWORD *)this + 128LL) + 8LL);
  }
  else if ( (v6 & 4) != 0 )
  {
  ...
  else
  {
    ...
    if ( a3 < v7 )
    {
      ...
      do
      {
        v10 = *(_DWORD *)(v8 + *(_QWORD *)(*(_QWORD *)this + 128LL));
        v11.rgbRed = v10;
        v8 += 4LL;
