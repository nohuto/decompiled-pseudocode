/*
 * XREFs of ?AdjustProcessPriorityForDrag@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C02049B0
 * Callers:
 *     xxxMoveSize @ 0x1C020D52C (xxxMoveSize.c)
 * Callees:
 *     SetForegroundPriority @ 0x1C0046FC0 (SetForegroundPriority.c)
 *     ?IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z @ 0x1C0205754 (-IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z.c)
 */
...
void __fastcall AdjustProcessPriorityForDrag(struct tagWND **a1)
{
  ...
  if ( (v3 & 0x100000) != 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 384) + 776LL) & 0xC0000) == 0
      && (*(_DWORD *)(*(_QWORD *)(gptiForeground + 384LL) + 776LL) & 0xC0000) != 0 )
    {
      v5 = 1;
LABEL_8:
