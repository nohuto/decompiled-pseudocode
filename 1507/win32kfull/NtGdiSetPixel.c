/*
 * XREFs of NtGdiSetPixel @ 0x1C0018B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiSetPixel(HDC a1, unsigned int a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( v36[0] && (*(_DWORD *)(v36[0] + 36LL) & 0x10000) == 0 )
  {
    ...
    *(_QWORD *)&v54 = __PAIR64__(a3, a2);
    ...
    if ( (unsigned int)XDCOBJ::bHasSurface((XDCOBJ *)v36) )
    {
      ...
      if ( DEVLOCKOBJ::bLock((DEVLOCKOBJ *)&v50, (struct XDCOBJ *)v36, 0) )
      {
        ...
        if ( (unsigned __int64)(v15 + SDWORD1(v54) + 0x80000000LL) > 0xFFFFFFFF
          || (unsigned __int64)(v15 + SHIDWORD(v54) + 0x80000000LL) > 0xFFFFFFFF
          || (v16 = v14 + v54,
              LODWORD(v54) = v16,
              v17 = *(_DWORD *)v12 + DWORD2(v54),
              v18 = *(_DWORD *)(v12 + 4) + DWORD1(v54),
              *(_QWORD *)((char *)&v54 + 4) = __PAIR64__(v17, v18),
...
LABEL_28:
            ...
            || (v12 = 512LL, (*(_WORD *)(v13 + 102) & 0x200) == 0) )
          {
            ...
            if ( (v22 & 0x800) != 0 )
            {
              v23 = UserSurfaceAccessCheck(*(_QWORD *)(v13 + 592));
            }
            else
            {
              if ( (v22 & 0x10000000) == 0 )
