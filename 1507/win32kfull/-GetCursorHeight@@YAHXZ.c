/*
 * XREFs of ?GetCursorHeight@@YAHXZ @ 0x1C0120E0C
 * Callers:
...
__int64 GetCursorHeight(void)
{
  ...
  v0 = 16;
  v10 = 0;
  v1 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 392LL) + 320LL);
  if ( v1 && (unsigned int)InternalGetIconInfo(v1, (__int64)v11, 0LL, 0LL, 0LL, 0) )
  {
    if ( (unsigned int)GreExtGetObjectW(v13, 32, v15) && (unsigned int)GreGetBitmapBits(v13, 0x100u, v18, &v10) )
    {
