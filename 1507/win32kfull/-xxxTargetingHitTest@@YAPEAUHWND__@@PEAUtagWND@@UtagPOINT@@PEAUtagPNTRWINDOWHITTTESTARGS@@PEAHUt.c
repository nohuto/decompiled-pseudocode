/*
 * XREFs of ?xxxTargetingHitTest@@YAPEAUHWND__@@PEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@PEAHUtagRECT@@KW4tagTARGETING_PROPERTY@@@Z @ 0x1C022C4C8
 * Callers:
  ...
  *(struct tagRECT *)&v59[0].x = *a5;
  if ( !(unsigned int)BasicTargetingWindowHitTest(
                        ...
                        *(_QWORD *)&a2,
                        ...
                        a6) )
    return v13;
  if ( IsCompositionInputWindow((struct tagWND *)v12) )
  {
...
LABEL_66:
  ...
  *(_QWORD *)(gptiCurrent + 376LL) = &v51;
  ...
  if ( *(_DWORD *)(a3 + 84) )
  {
    ...
    v28 = GetMonitorFlags(*(_QWORD *)(v27 + 384));
