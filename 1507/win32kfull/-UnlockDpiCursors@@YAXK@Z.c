/*
 * XREFs of ?UnlockDpiCursors@@YAXK@Z @ 0x1C0130F74
 * Callers:
  ...
  do
  {
    ...
    if ( v7 )
    {
      ...
      if ( v14 )
      {
        ...
        v13 = *(_DWORD **)(v7 + 40);
        if ( (*(_BYTE *)(LODWORD(gSharedInfo[2]) * (unsigned int)(unsigned __int16)*v13 + gSharedInfo[1] + 17LL) & 1) == 0 )
