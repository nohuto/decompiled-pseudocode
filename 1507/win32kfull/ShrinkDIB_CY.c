/*
 * XREFs of ShrinkDIB_CY @ 0x1C02593B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ShrinkDIB_CY(__int64 a1)
{
  ...
  unsigned __int64 v79; // [rsp+80h] [rbp-88h]
  ...
  *((_QWORD *)v4 + 10) = v16;
  ...
  if ( v34 )
  {
    ...
    {
      v75 = v34 - 1;
      v35 = (__int16 *)GetFixupScan((__int64)v84, v106);
      v79 = (unsigned __int64)&v22[v20];
      v36 = *v77++;
      if ( (v36 & 0x4000) != 0 )
      {
        v37 = v36 & 0x3FFF;
        v38 = -v37;
        v39 = v18;
        v40 = *(_DWORD *)(v78 + 4) + ((v36 >> 15) & 1) - v37;
        v41 = v37 - (*(_DWORD *)(v78 + 4) + ((v36 >> 15) & 1));
        do
        {
          v38 += v37;
          v41 += v40;
        ...
        if ( v42 <= 0 )
        {
          ...
          {
            v51 = *v35;
            v35 = (__int16 *)((char *)v35 + 3);
            v52 = *((unsigned __int8 *)v35 - 1);
            ...
            *(v48 - 1) = v54;
            v55 = (6 * *(v47 - 1) - *(_DWORD *)((char *)v47 + v49 - 4) - *(_DWORD *)((char *)v47 + v50 - 4)) >> 15;
            if ( (v55 & 0xFF00) != 0 )
              LOBYTE(v55) = ~HIBYTE(v55);
            *v48 = v55;
            v48 += 3;
            *(_DWORD *)((char *)v47 + v49 - 4) = v18[v52 + 256];
            *(_DWORD *)((char *)v47 + v49) = v18[HIBYTE(v51) + 256];
            *(_DWORD *)((char *)v47 + v49 + 4) = v18[(unsigned __int8)v51 + 256];
            v47 += 3;
          }
          while ( (unsigned __int64)v47 + v50 - 4 < v79 );
        ...
        else
        {
          ...
          do
          {
            ...
            *v44 += v18[*v43];
            v44[1] += v18[*(v43 - 1)];
            *(_DWORD *)((char *)v44 + v45 - 4) = v18[v43[1] + 256];
            v46 = *v43;
            v43 += 3;
            *(_DWORD *)((char *)v44 + v45) = v18[v46 + 256];
            v44 += 3;
            *(_DWORD *)((char *)v44 + v45 - 8) = v18[*(v43 - 4) + 256];
          }
          while ( (unsigned __int64)(v44 - 1) < v79 );
          if ( v74 )
          {
            memmove(v21, v22, v20);
            v74 = 0;
      ...
      {
        v60 = v22 + 8;
        v61 = (unsigned __int8 *)v35 + 1;
        v62 = v78 + (((unsigned __int64)(unsigned __int16)v36 >> 5) & 0x400);
        do
        {
