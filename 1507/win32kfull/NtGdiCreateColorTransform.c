/*
 * XREFs of NtGdiCreateColorTransform @ 0x1C02B0E00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a8)
{
  ...
  HANDLE v16; // [rsp+68h] [rbp-2E0h]
  char *v17; // [rsp+70h] [rbp-2D8h]
  HANDLE v18; // [rsp+78h] [rbp-2D0h]
  HANDLE SecureHandle; // [rsp+80h] [rbp-2C8h]
  char *v20; // [rsp+88h] [rbp-2C0h]
  ...
  *(_DWORD *)&v10->lcsFilename[2] = *(_DWORD *)(a2 + 72);
  ...
  if ( Address && Size )
  {
    if ( (unsigned __int64)&Address[Size] > W32UserProbeAddress || &Address[Size] < Address )
      *W32UserProbeAddress = 0;
    v18 = MmSecureVirtualMemory(Address, Size, 2u);
    if ( v18 )
      v17 = Address;
    else
      v14 = 1;
  ...
  if ( a7 && a8 )
  {
    if ( (unsigned __int64)&a7[a8] > W32UserProbeAddress || &a7[a8] < a7 )
      *W32UserProbeAddress = 0;
    v16 = MmSecureVirtualMemory(a7, a8, 2u);
    if ( v16 )
      v20 = a7;
    else
      v14 = 1;
  ...
  v12 = 0LL;
  if ( !v14 )
    v12 = GreCreateColorTransform(a1, &v22, v15, a4, v17, Size, v20, a8);
  if ( SecureHandle )
