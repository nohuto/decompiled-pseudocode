/*
 * XREFs of ?BltOldRedirectionBitsToNewBitmap@@YAHPEAUtagWND@@PEAUHBITMAP__@@1PEBUtagBITMAP@@2HH@Z @ 0x1C000ADB8
 * Callers:
        ...
        int a7)
{
  ...
  if ( v11 )
  {
    v16 = *(HBRUSH *)(*((_QWORD *)a1 + 19) + 128LL);
    if ( v16 )
    {
      if ( (unsigned __int64)v16 <= 0x1F )
        v16 = *(HBRUSH *)(gpsi + 8LL * (_QWORD)v16 + 3688);
