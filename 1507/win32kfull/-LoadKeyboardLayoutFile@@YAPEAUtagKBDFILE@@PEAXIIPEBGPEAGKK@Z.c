/*
 * XREFs of ?LoadKeyboardLayoutFile@@YAPEAUtagKBDFILE@@PEAXIIPEBGPEAGKK@Z @ 0x1C013BB3C
 * Callers:
 ...
 *     ?PrepareFallbackKeyboardFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@@Z @ 0x1C01DD300 (-PrepareFallbackKeyboardFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@@Z.c)
 */
        ...
        unsigned int a7)
{
  ...
  if ( v11 )
  {
    if ( a1 )
    {
      wcsncpycch((_WORD *)(v11 + 56), (__int64)Str2, 32);
      *(_WORD *)(v7 + 118) = 0;
