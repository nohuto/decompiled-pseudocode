/*
 * XREFs of ?FindFrameById@@YAPEAUtagPOINTERINPUTFRAME@@K@Z @ 0x1C022F1B4
 * Callers:
 ...
 *     ?GetPointerDataQPCTimeList@@YAH_KIPEA_KPEAH@Z @ 0x1C01F7F4C (-GetPointerDataQPCTimeList@@YAH_KIPEA_KPEAH@Z.c)
 ...
 *     ?IsPointerMsgRedirected@@YAH_KPEAH@Z @ 0x1C01F8B84 (-IsPointerMsgRedirected@@YAH_KPEAH@Z.c)
