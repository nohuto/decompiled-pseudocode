/*
 * XREFs of ?xxxGetDummyBitmap@@YAPEAXPEAUtagWINDOWSTATION@@PEAUtagGETCLIPBDATA@@@Z @ 0x1C01F0308
 * Callers:
  ...
  else
  {
    ...
    if ( v2 && (v9 = HMValidateHandleNoRip((__int64)v2, 6)) != 0 )
    {
      ...
      *(_QWORD *)(gptiCurrent + 376LL) = v16;
      ...
      v10 = *(_DWORD *)(v9 + 16);
      ++*(_DWORD *)(v9 + 8);
      v13 = xxxDIBtoBMP((struct tagBITMAPINFO *)(v9 + 20), (__int64)ClipboardData, v10);
      if ( v13 )
      {
