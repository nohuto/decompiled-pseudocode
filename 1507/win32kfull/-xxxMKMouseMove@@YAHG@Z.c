/*
 * XREFs of ?xxxMKMouseMove@@YAHG@Z @ 0x1C01EE4F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxMKMouseMove(__int64 a1, __int64 a2)
{
  ...
  if ( (gdwPUDFlags & 0x2000) == 0 || !gtmridMKMoveCursor )
  {
    ...
    {
      v3 = 4 * gMKDeltaY * (unsigned __int8)byte_1C03235F2;
      v4 = 4 * gMKDeltaX * (unsigned __int8)byte_1C03235F2;
    }
    else
    {
      v3 = gMKDeltaY;
    ...
    xxxMoveEvent(v4, v3, 0, 0LL, v8, 0LL, 0LL, 0LL, 0LL, 0, v9, 1);
    ...
    QueueMouseEvent(
      ...
      *(_QWORD *)&gptCursorAsync,
      ...
      0LL);
    EnterCrit(1LL);
    if ( !HIDWORD(xmmword_1C0323934) || (gdwPUDFlags & 0x2000) != 0 )
    {
      v6 = xxxMKMoveConstCursorTimer;
      if ( gMouseCursor[0] )
        v6 = xxxMKMoveAccelCursorTimer;
      giMouseMoveTable = 0;
      gtmridMKMoveCursor = SetRITTimer(gtmridMKMoveCursor, 50, (int)v6, 0);
    }
  }
  return 0LL;
}
