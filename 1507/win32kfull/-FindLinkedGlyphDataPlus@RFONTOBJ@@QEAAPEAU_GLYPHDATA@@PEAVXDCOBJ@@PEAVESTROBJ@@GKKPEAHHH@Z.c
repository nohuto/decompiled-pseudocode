/*
 * XREFs of ?FindLinkedGlyphDataPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@PEAVXDCOBJ@@PEAVESTROBJ@@GKKPEAHHH@Z @ 0x1C002EEAC
 * Callers:
        ...
        int a9)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a2 + 320LL) )
  {
    if ( a8 )
    {
      ...
      {
        if ( a4 >= gqlTTSystem && a4 <= (unsigned __int16)word_1C03233D2 )
        {
          v14 = (struct RFONTOBJ *)((a4 - gqlTTSystem) / 32);
          a3 = (struct ESTROBJ *)(0x80000000 >> ((a4 - gqlTTSystem) % 32));
          if ( ((unsigned int)a3 & *(_DWORD *)(qword_1C03233D8 + 4LL * (_QWORD)v14)) != 0 )
          {
