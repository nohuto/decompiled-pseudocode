...
__int64 __fastcall itrp_IF(unsigned __int8 *a1)
{
  ...
  {
    qword_1C0323148 -= 4LL;
    if ( !*(_DWORD *)qword_1C0323148 )
    {
      v1 = 1;
      while ( 1 )
      {
        v2 = a1 == (unsigned __int8 *)qword_1C03231B8;
...
LABEL_16:
            ...
            break;
          default:
            v4 = byte_1C02E2640[v3];
            if ( byte_1C02E2640[v3] )
            {
              if ( v4 == 21 )
              {
                if ( (unsigned __int64)a1 < qword_1C03231C0
                  || (unsigned __int64)(a1 + 1) > qword_1C03231B8
                  || a1 + 1 < a1 )
                {
                  goto LABEL_36;
                }
