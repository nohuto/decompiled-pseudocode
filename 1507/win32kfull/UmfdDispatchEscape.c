/*
 * XREFs of UmfdDispatchEscape @ 0x1C02A47DC
 * Callers:
 ...
 *     ?UmfdEscEngFntCacheLookUp@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1C02A3D28 (-UmfdEscEngFntCacheLookUp@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z.c)
