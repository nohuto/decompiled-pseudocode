/*
 * XREFs of FreePointerDevice @ 0x1C01CA8D0
 * Callers:
 ...
 *     ?RemoveFromCurrentPointerDevicesList@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01C5F98 (-RemoveFromCurrentPointerDevicesList@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@@Z.c)
 ...
 *     FreePointerDeviceCalData @ 0x1C01CAAC0 (FreePointerDeviceCalData.c)
  ...
  if ( !v15 )
  {
    ...
    if ( (_DWORD)result )
    {
      ...
      if ( v8 )
      {
        ...
        {
          Win32FreePool(v9);
          a1[43].Blink[1].Blink = 0LL;
        }
        v10 = a1[43].Blink[2].Flink;
        if ( v10 )
        {
          Win32FreePool(v10);
          a1[43].Blink[2].Flink = 0LL;
        }
        v11 = a1[43].Blink;
        if ( v11[3].Flink )
        {
      ...
      if ( (unsigned int)(LODWORD(a1[1].Blink) - 7) <= 1 || (HIDWORD(a1[14].Blink) & 8) != 0 )
      {
        v13 = a1[16].Blink;
        if ( v13 )
        {
      ...
      if ( (HIDWORD(a1[14].Blink) & 0x400) != 0 )
        gulPointerDeviceContactCount -= LODWORD(a1[44].Flink);
