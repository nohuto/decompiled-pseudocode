/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C013ECC4
 * Callers:
        ...
        int a10)
{
  ...
  _QWORD v38[4]; // [rsp+48h] [rbp-79h] BYREF
  WCHAR v39[32]; // [rsp+68h] [rbp-59h] BYREF
  ...
  *(_DWORD *)(*(_QWORD *)this + 88LL) = _InterlockedIncrement(&dword_1C03289E4);
  v17 = IFIOBJ::lfOrientation((IFIOBJ *)&v37);
  v18 = v37;
  *(_DWORD *)(*(_QWORD *)this + 68LL) = v17;
  ...
  PushThreadGuardedObject(v38, v21, vDeletePFE);
  v22 = bComputeGISET(a6, *(struct PFE **)this, (struct _GISET **)(*(_QWORD *)this + 80LL));
  PopThreadGuardedObject(v38, v23, v24, v25);
  if ( v22 )
  {
    *(_DWORD *)(*(_QWORD *)this + 136LL) = 0;
    ...
    {
      v26 = (char *)gpfsTable;
      v27 = (char *)gpfsTable + 196 * gcfsTable;
      cCapString(v39, (WCHAR *)(v18 + *v36), 32);
      if ( v26 < v27 )
      {
        v28 = v39[0];
        v29 = v26 + 195;
        do
        {
          if ( !(*v29 | *(v29 - 66)) )
          {
            ...
            if ( v28 == *(_WORD *)(v29 - 65) )
            {
              ...
              {
                v32 = *++v30;
                if ( *v30 != *(WCHAR *)((char *)v30 + v29 - &v40) )
                  goto LABEL_31;
              }
              *(_BYTE *)((unsigned int)(*(_DWORD *)(*(_QWORD *)this + 136LL))++ + *(_QWORD *)this + 144LL) = (char)((_BYTE)v29 - (_BYTE)gpfsTable + 61) / -60;
              v28 = v39[0];
            }
          }
LABEL_31:
