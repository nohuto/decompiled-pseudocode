/*
 * XREFs of ?vPlgWriteAND@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02D0120
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( v40 )
          {
            do
            {
              ...
              if ( v24 >= si128.top && v24 < si128.bottom )
              {
                ...
                v38 = v28;
                v29 = (char *)(v26 + (v27 >> 3));
                v30 = byte_1C02E71A0[*(_DWORD *)v25 & 7];
                if ( (int)v27 >= 0
    ...
    else if ( a1 != a2 )
    {
      do
      {
        ...
        for ( i = *((_QWORD *)a3 + 10) + *((_DWORD *)a3 + 22) * v10; v11; --v11 )
        {
          v13 = *(_DWORD *)v9;
          v14 = *((_DWORD *)v9 + 1);
          v15 = byte_1C02E71A0[*(_DWORD *)v9 & 7];
