/*
 * XREFs of ?pSpConvertSpriteFromMeta@@YAPEAVSPRITE@@PEAUHDEV__@@0PEAU_METASPRITE@@@Z @ 0x1C0272910
 * Callers:
...
struct SPRITE *__fastcall pSpConvertSpriteFromMeta(HDEV a1, _QWORD *a2, struct _METASPRITE *a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v9 )
    {
      ...
      do
      {
        if ( *(_QWORD *)v12 && v11 < *(_DWORD *)(**(_QWORD **)(*(_QWORD *)v12 + 16LL) + 2132LL) )
        {
          v10 = *(_QWORD *)v12;
          v11 = *(_DWORD *)(**(_QWORD **)(*(_QWORD *)v12 + 16LL) + 2132LL);
        }
        v12 += 8;
        --v13;
      }
      ...
      if ( v10 )
      {
        ...
        if ( Sprite )
        {
          ...
          *((_QWORD *)v8 + 24) = *(_QWORD *)(v10 + 192);
          v15 = *(_QWORD *)(v10 + 16);
          *(_QWORD *)(v10 + 192) = 0LL;
          v16 = *(_DWORD *)(*(_QWORD *)v15 + 2612LL) + *(_DWORD *)(v10 + 116);
          v21.x = *(_DWORD *)(*(_QWORD *)v15 + 2608LL) + *(_DWORD *)(v10 + 112);
          v21.y = v16;
