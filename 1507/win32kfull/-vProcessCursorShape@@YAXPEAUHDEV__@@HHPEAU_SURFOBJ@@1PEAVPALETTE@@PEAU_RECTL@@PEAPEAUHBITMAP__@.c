/*
 * XREFs of ?vProcessCursorShape@@YAXPEAUHDEV__@@HHPEAU_SURFOBJ@@1PEAVPALETTE@@PEAU_RECTL@@PEAPEAUHBITMAP__@@@Z @ 0x1C00A2268
 * Callers:
        ...
        HBITMAP *a8)
{
  ...
  LONG v28; // [rsp+88h] [rbp-59h]
  int v29; // [rsp+8Ch] [rbp-55h]
