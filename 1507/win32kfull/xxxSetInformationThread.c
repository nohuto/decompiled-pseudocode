/*
 * XREFs of xxxSetInformationThread @ 0x1C007D080
 * Callers:
            ...
            if ( a2 <= 16 )
            {
              ...
              if ( a2 == 15 )
              {
                if ( *(_DWORD *)a3 )
                  ...
                  *(_DWORD *)(gpsi + 2220LL) &= ~8u;
                RtlLoadStringOrError(629LL, v38, 40LL, 0LL);
              ...
              else
              {
                if ( *(_DWORD *)a3 )
                  ...
                  *(_DWORD *)(gpsi + 2220LL) &= ~0x10u;
                RtlLoadStringOrError(630LL, v38, 40LL, 0LL);
      ...
      if ( !v8 )
      {
        if ( ThreadWin32Thread )
        {
          if ( (_DWORD)v31 == 8 && (*(_DWORD *)a3 & 0x20000) == *(_DWORD *)a3 )
          {
            v16 = v30;
            if ( *(_DWORD *)a3 )
              *(_DWORD *)(ThreadWin32Thread + 448) |= 0x20000u;
            else
              *(_DWORD *)(ThreadWin32Thread + 448) &= ~0x20000u;
            goto LABEL_16;
          }
