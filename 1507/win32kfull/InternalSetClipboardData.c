/*
 * XREFs of InternalSetClipboardData @ 0x1C0120A30
 * Callers:
 ...
 *     ?PasteScreenPalette@@YAXPEAUtagWINDOWSTATION@@@Z @ 0x1C01F0114 (-PasteScreenPalette@@YAXPEAUtagWINDOWSTATION@@@Z.c)
 * Callees:
...
__int64 __fastcall InternalSetClipboardData(__int64 a1, unsigned int a2, __int64 a3, int a4, int a5)
{
