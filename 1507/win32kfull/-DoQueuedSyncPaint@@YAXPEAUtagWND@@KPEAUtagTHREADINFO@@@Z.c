/*
 * XREFs of ?DoQueuedSyncPaint@@YAXPEAUtagWND@@KPEAUtagTHREADINFO@@@Z @ 0x1C00D52D0
 * Callers:
...
void __fastcall DoQueuedSyncPaint(struct tagWND *a1, unsigned int a2, struct tagTHREADINFO *a3)
{
  ...
  if ( v5 == a3 || (*((_BYTE *)a1 + 41) & 0xA) != 0xA || (*((_BYTE *)a1 + 55) & 0x10) == 0 )
    goto LABEL_5;
  v8 = (_QWORD **)((char *)v5 + 480);
  v9 = *v8;
  if ( *v8 == v8 )
    goto LABEL_16;
  do
...
LABEL_5:
    if ( (a2 & 0x20) != 0 || (a2 & 4) != 0 && (*((_BYTE *)a1 + 55) & 2) != 0 )
    {
      ...
      {
        if ( (*(_BYTE *)(i + 55) & 0x40) == 0 || a3 == *(struct tagTHREADINFO **)(i + 16) )
