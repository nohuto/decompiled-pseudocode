/*
 * XREFs of MagContextThreadCallout @ 0x1C01FD210
 * Callers:
 *     xxxSetThreadDesktop @ 0x1C007EA90 (xxxSetThreadDesktop.c)
 *     MagContextDestroy @ 0x1C0132CF0 (MagContextDestroy.c)
  ...
  if ( (a3 || (ThreadContext = MagpFindThreadContext(a1, a2)) != 0LL) && (_DWORD)a4 == 1 )
  {
    ...
    while ( v6 != ThreadContext + 5 )
    {
      ...
      *(_QWORD *)(v8 + 8) = v9;
      if ( v7[3] == -1LL )
      {
        if ( *(_QWORD **)(*(_QWORD *)(ThreadContext[2] + 416LL) + 224LL) == v7 )
        {
          v11 = (void *)ReferenceDwmApiPort(v8, a2, a3, a4);
          DwmAsyncMagnSetDesktopColorTransform(v11);
          v8 = *(_QWORD *)(ThreadContext[2] + 416LL);
          *(_QWORD *)(v8 + 224) = 0LL;
        }
        if ( *(_QWORD **)(*(_QWORD *)(ThreadContext[2] + 416LL) + 216LL) == v7 )
        {
          v12 = (void *)ReferenceDwmApiPort(v8, a2, a3, a4);
          DwmAsyncMagnSetDesktopTransform(v12, 0);
          *(_QWORD *)(*(_QWORD *)(ThreadContext[2] + 416LL) + 216LL) = 0LL;
        }
      }
      else
      {
