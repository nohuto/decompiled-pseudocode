/*
 * XREFs of ?xxxWindowHitTestWithTargeting@@YAPEAUHWND__@@PEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@UtagRECT@@W4tagTARGETING_PROPERTY@@@Z @ 0x1C022CF64
 * Callers:
...
HWND __fastcall xxxWindowHitTestWithTargeting(__int64 a1, struct tagPOINT a2, __int64 a3, struct tagRECT *a4, int a5)
{
  ...
  v36[0] = *(_QWORD *)(gptiCurrent + 376LL);
  *(_QWORD *)(gptiCurrent + 376LL) = v36;
  v36[1] = 0LL;
LABEL_47:
  if ( v12 && !v10 )
  {
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(a3 + 56) && !*(_DWORD *)(a3 + 64) )
        break;
      if ( !IsCompositionInputWindow((struct tagWND *)v12) && (*(_BYTE *)(v12 + 55) & 0x10) == 0
      ...
      v17 = 0;
      v31 = 0;
      if ( *(_DWORD *)(a3 + 88) || IsCompositionInputWindow((struct tagWND *)v12) )
      {
