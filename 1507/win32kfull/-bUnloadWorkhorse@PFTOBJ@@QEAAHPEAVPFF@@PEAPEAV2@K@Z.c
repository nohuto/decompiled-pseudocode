/*
 * XREFs of ?bUnloadWorkhorse@PFTOBJ@@QEAAHPEAVPFF@@PEAPEAV2@K@Z @ 0x1C0129894
 * Callers:
 ...
 *     PFTOBJ_bUnloadWorkhorseWrap @ 0x1C025E150 (PFTOBJ_bUnloadWorkhorseWrap.c)
...
LABEL_32:
  ...
  else if ( (unsigned int)bKillPFFOBJ((PFFOBJ *)v16, (struct PFFCLEANUP *)v17) )
  {
    EtwTraceGreLockReleaseSemaphore(L"ghsemPublicPFT", ghsemPublicPFT);
    GreReleaseSemaphoreInternal(ghsemPublicPFT);
