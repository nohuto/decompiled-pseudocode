/*
 * XREFs of ?xxxSmoothRotateScreen@@YAJPEAUDISPLAYCONFIG_PATH_INFO@@PEAUDISPLAYCONFIG_MODE_INFO@@H@Z @ 0x1C01D092C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( (unsigned int)dword_1C031D7B0 > 5 && TlgKeywordOn(v23, 0x200000000000uLL) )
  {
    v34 = 0;
    v37 = 0;
    v40 = 0;
    ...
    v39 = 4;
    v42 = 4;
    TlgWrite((TraceLoggingHProvider)4, &unk_1C02EA351, v24, v25, 6u, &pData);
  }
  return v28;
}
