/*
 * XREFs of ?xxxAdjustPushState@@YAXPEAUtagTHREADINFO@@EEPEAUtagKL@@1@Z @ 0x1C01DD3D8
 * Callers:
        ...
        struct tagKL *a5)
{
  ...
  if ( a2 )
  {
    ...
    if ( ((unsigned __int8)v12 & gafRawKeyState[v11]) != 0
      || ((unsigned __int8)v12 & *(_BYTE *)(v11 + *(_QWORD *)gafAsyncKeyState)) != 0
      || (*(_BYTE *)(*((_QWORD *)a1 + 49) + v11 + 184) & (unsigned __int8)v12) != 0 )
    {
      ...
      {
        if ( !v14 )
          xxxKeyEvent(a2 | 0x8000, v13 | 0x200, 0, 0LL, 0LL, 0LL, 0, 0, 0LL);
      }
    }
  }
  if ( a3 )
  {
    ...
    if ( ((unsigned __int8)v16 & gafRawKeyState[v15]) != 0
      || ((unsigned __int8)v16 & gafAsyncKeyState[(unsigned __int64)a3 >> 2]) != 0
      || (*(_BYTE *)(*((_QWORD *)a1 + 49) + v15 + 184) & (unsigned __int8)v16) != 0 )
    {
      ...
      {
        if ( !v18 )
          xxxKeyEvent(a3 | 0x8000, v17 | 0x200, 0, 0LL, 0LL, 0LL, 0, 0, 0LL);
      }
    }
  }
}
