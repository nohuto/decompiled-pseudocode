/*
 * XREFs of ?vTransparentCopyS16D16@@YAXPEAUBLTINFO@@@Z @ 0x1C02847A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vTransparentCopyS16D16(struct BLTINFO *a1)
{
  ...
  int v10; // r15d
  int v11; // edx
  unsigned int (__fastcall *v12)(struct _XLATEOBJ *, unsigned int); // [rsp+20h] [rbp-58h]
  ...
  v4 = *(_QWORD *)(*((_QWORD *)a1 + 9) + 120LL);
  if ( v4 )
    v5 = **(_DWORD **)(v4 + 128) | *(_DWORD *)(*(_QWORD *)(v4 + 128) + 4LL) | *(_DWORD *)(*(_QWORD *)(v4 + 128) + 8LL);
  else
    LOWORD(v5) = -1;
