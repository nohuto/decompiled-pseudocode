/*
 * XREFs of NtUserUpdateLayeredWindow @ 0x1C0058BB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
      ...
      {
        if ( v13 && *(_QWORD *)(v17 + 88) && (unsigned int)IsTopLevelOrLayeredChildWindow(v17) )
          IsTopLevelWindow(v17);
        v24 = ValidateHmonitorNoRip(*(_QWORD *)(v17 + 352));
        v42 = *(_OWORD *)(v17 + 112);
        updated = zzzUpdateLayeredWindow((struct tagWND *)v17, *(__int64 *)&v43.left, v32, a7, v34, a9, (__int64)v14);
        if ( updated < 0 )
        {
          v21 = 0;
