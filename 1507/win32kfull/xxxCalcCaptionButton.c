/*
 * XREFs of xxxCalcCaptionButton @ 0x1C0236794
 * Callers:
...
LABEL_44:
  if ( IsDPIDWMSysMet(5uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v34 = 0)
      : (v34 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                           + 8LL)
                               + 260LL)),
        v34) )
  {
...
LABEL_63:
      ...
      if ( *(_QWORD *)(ThreadWin32Thread + 416) )
        v43 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                          + 8LL)
                              + 260LL);
      if ( v43 )
...
LABEL_76:
  ...
  else
  {
    ...
    v48 = 0;
    if ( *(_QWORD *)(v47 + 416) )
      v48 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                            + 260LL);
    if ( !v48 )
      goto LABEL_63;
  }
...
LABEL_82:
      if ( IsDPIDWMSysMet(0x34uLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
          ? (v54 = 0)
          : (v54 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                               + 8LL)
                                   + 260LL)),
            v54) )
      {
...
LABEL_120:
  if ( IsDPIDWMSysMet(0x1EuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v71 = 0)
      : (v71 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                           + 8LL)
                               + 260LL)),
        v71) )
  {
...
LABEL_139:
  if ( IsDPIDWMSysMet(0x1FuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v79 = 0)
      : (v79 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                           + 8LL)
                               + 260LL)),
        v79) )
  {
...
LABEL_165:
        ...
        v90 = 0;
        if ( *(_QWORD *)(v89 + 416) )
          v90 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                            + 8LL)
                                + 260LL);
        if ( v90 )
...
LABEL_179:
    ...
    else
    {
      ...
      v95 = 0;
      if ( *(_QWORD *)(v94 + 416) )
        v95 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                          + 8LL)
                              + 260LL);
      if ( !v95 )
        goto LABEL_165;
...
LABEL_195:
  if ( IsDPIDWMSysMet(0x2EuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v103 = 0)
      : (v103 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                            + 8LL)
                                + 260LL)),
        v103) )
  {
...
LABEL_214:
  if ( IsDPIDWMSysMet(6uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v112 = 0)
      : (v112 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                            + 8LL)
                                + 260LL)),
        v112) )
  {
...
LABEL_233:
  ...
  else
  {
    ...
    v124 = 0;
    if ( *(_QWORD *)(v123 + 416) )
      v124 = v11 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
                                         + 8LL)
                             + 260LL);
    if ( !v124 )
      goto LABEL_233;
