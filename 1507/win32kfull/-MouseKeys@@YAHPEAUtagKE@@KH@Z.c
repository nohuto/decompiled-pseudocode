/*
 * XREFs of ?MouseKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C01ED910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseKeys(struct tagKE *a1)
{
  ...
  {
    if ( (xmmword_1C0323904 & 4) != 0 && v1 == gNumLockVk && (*((_WORD *)a1 + 1) & 0x8000) == 0 && v3 == 17 )
    {
      gMKPreviousVk = *((_BYTE *)a1 + 2);
      if ( (xmmword_1C0323904 & 0x10) != 0 )
      {
        v4 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(grpdeskRitInput + 24LL) + 24LL) + 16LL);
        PostEventMessageEx(v4, *(_QWORD *)(v4 + 392), 0xEu, 0LL, 0, 0LL, 0LL, 0LL);
      }
  ...
  else
  {
    ...
    gMKPreviousVk = v1;
    return off_1C02EB230[v8](word_1C02EBAB0[v8]);
  }
}
