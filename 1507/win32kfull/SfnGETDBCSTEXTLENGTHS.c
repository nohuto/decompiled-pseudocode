/*
 * XREFs of SfnGETDBCSTEXTLENGTHS @ 0x1C00E2BA0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  v44 = a7 & 1;
  v12 = *(_QWORD *)(a1 + 144);
  v13 = a1 - *(_QWORD *)(gptiCurrent + 432LL);
  ...
  v55[3] = a5;
  v55[4] = a6;
  v56[0] = *(_QWORD *)(gptiCurrent + 376LL);
  *(_QWORD *)(gptiCurrent + 376LL) = v56;
  v56[1] = a1;
  ++*(_DWORD *)(a1 + 8);
  ...
  v46 = *(_QWORD *)(v14 + 80);
  *(_QWORD *)(v14 + 72) = v13;
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 64LL) = *(_QWORD *)a1;
  v15 = *(_QWORD *)(a1 + 264);
...
LABEL_26:
  ...
  v25 = v21 + 1;
  v26 = v21 + 1;
  v27 = a1 - *(_QWORD *)(gptiCurrent + 432LL);
  *(_DWORD *)(gptiCurrent + 448LL) = v24 | 0x4000000;
  if ( (a7 & 1) == 0 )
    v26 = 2 * v25;
  v28 = AllocCallbackMessage(96, 1u, v26, v60, 0, 0x200uLL);
  v29 = v28;
  *(_QWORD *)&v51 = v28;
  if ( !v28 )
    return 0LL;
  ...
  *((_QWORD *)v29 + 8) = a5;
  *((_QWORD *)v29 + 9) = a6;
  if ( (int)AllocateCallbackData((struct _CAPTUREBUF *)v29, v26, (void **)v29 + 10) < 0 )
    goto LABEL_49;
  *((_DWORD *)v29 + 22) = v26;
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 64LL) = *(_QWORD *)a1;
  v34 = *(_QWORD *)(a1 + 264);
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 80LL) = v34;
  ...
  *(_QWORD *)(v38 + 80) = RegionSize;
  ...
  if ( v47 == 24 )
  {
    ...
    if ( (!a8 || (*(_DWORD *)(a8 + 84) & 5) == 0) && (int)v40 > 0 )
    {
      ...
      v53 = *(_OWORD *)v41;
      v54 = v42;
      v40 = (unsigned int)CalcOutputStringSize((struct _CALLBACKSTATUS *)&v53, v40, v49, v44);
      RegionSize = v40;
    }
    *(_DWORD *)(gptiCurrent + 448LL) &= ~0x4000000u;
  }
  else
  {
LABEL_49:
