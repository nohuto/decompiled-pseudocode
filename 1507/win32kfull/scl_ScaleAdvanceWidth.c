/*
 * XREFs of scl_ScaleAdvanceWidth @ 0x1C00E4A90
 * Callers:
...
__int64 __fastcall scl_ScaleAdvanceWidth(__int64 a1, __int64 a2, __int16 a3, int a4, __int16 a5, int *a6)
{
  __int64 result; // rax
  _DWORD *v7; // r10
  __int64 v8; // r11
  ...
  if ( !a4 )
  {
    ...
    *(_DWORD *)v10 = v9;
    ...
    {
      if ( !v9 || !*(_WORD *)(v11 + 446) )
        return mth_FixXYMul((unsigned int *)v10, (int *)(v10 + 4), a6);
      v16 = v9 + 0x10000;
    }
    *(_DWORD *)v10 = v16;
    return mth_FixXYMul((unsigned int *)v10, (int *)(v10 + 4), a6);
