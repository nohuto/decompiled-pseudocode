/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0047BD8
 * Callers:
 ...
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C01EC43C (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
