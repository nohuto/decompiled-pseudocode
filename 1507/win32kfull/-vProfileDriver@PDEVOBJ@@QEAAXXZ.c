/*
 * XREFs of ?vProfileDriver@PDEVOBJ@@QEAAXXZ @ 0x1C0140EC0
 * Callers:
 *     PDEVOBJ_vProfileDriverWrap @ 0x1C0142C20 (PDEVOBJ_vProfileDriverWrap.c)
 * Callees:
    ...
    if ( CompatibleSurface )
    {
      ...
      if ( v39 )
      {
        ...
        if ( (*(_DWORD *)(v4 + 112) & 0x8000) != 0 )
          v18 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, RECTL *, ULONG, ULONG))(*(_QWORD *)this + 3312LL);
        else
