/*
 * XREFs of xInsertMetricsPlusRFONTOBJ @ 0x1C0034014
 * Callers:
...
__int64 __fastcall xInsertMetricsPlusRFONTOBJ(RFONTOBJ *this, struct _GLYPHDATA **a2, unsigned __int16 a3)
{
  ...
  struct _GLYPHBITS *v13; // rax
  struct _GLYPHDATA *v14; // rcx
  struct _GLYPHBITS *v15; // r13
  ...
  {
    v20 = a3;
    RFONTOBJ::vXlatGlyphArray(this, &v20, 1, &v21, 0, 0);
    v8 = v21;
  }
  else
  {
  ...
  if ( *(_DWORD *)(*(_QWORD *)this + 72LL) != 2 )
  {
    ...
    v13 = (struct _GLYPHBITS *)RFONTOBJ::pgbCheckGlyphCache(this, (unsigned int)v12);
    v14 = &v23;
    v15 = v13;
