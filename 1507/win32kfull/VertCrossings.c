/*
 * XREFs of VertCrossings @ 0x1C00AEA98
 * Callers:
...
__int64 __fastcall VertCrossings(int a1, __int16 a2)
{
  ...
  if ( a1 >= dword_1C0322EEC || a1 < dword_1C0322EE8 )
    return 0LL;
  v3 = 0;
  v4 = a1 - dword_1C0322EE8;
  v5 = *(_WORD **)(qword_1C0322F58 + 8LL * v4);
  v6 = *(_WORD **)(qword_1C0322F60 + 8LL * v4);
  v7 = *(_QWORD *)(qword_1C0322F68 + 8LL * v4);
