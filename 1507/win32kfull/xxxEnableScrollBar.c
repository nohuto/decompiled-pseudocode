/*
 * XREFs of xxxEnableScrollBar @ 0x1C0124078
 * Callers:
...
LABEL_11:
      ...
      return xxxSendTransformableMessageTimeout((struct tagWND *)a1, 0xE4u, (unsigned int)v6, 0LL, 0, 0, 0LL, 1, 1);
    }
...
LABEL_13:
  *(_DWORD *)(v7 + 380) = v10;
  if ( (unsigned int)xxxEnableWindow((struct tagWND *)a1, v11, v6) )
