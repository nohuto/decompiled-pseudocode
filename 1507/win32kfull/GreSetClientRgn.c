/*
 * XREFs of GreSetClientRgn @ 0x1C027CFBC
 * Callers:
...
void __fastcall GreSetClientRgn(struct EWNDOBJ *a1, HRGN a2, unsigned int *a3)
{
  ...
  _QWORD v28[7]; // [rsp+68h] [rbp-51h] BYREF
  __int64 v29; // [rsp+A0h] [rbp-19h] BYREF
        ...
        *((_QWORD *)&v23 + 1) = __PAIR64__(v12, v11);
        if ( v7 )
        {
          ...
          if ( v24[0] )
          {
            if ( v25[0] )
            {
              ...
              RGNOBJ::bCopy((RGNOBJ *)v24, (struct RGNOBJ *)v28);
              RGNOBJAPI::iCombine((RGNOBJAPI *)v28, (struct RGNOBJ *)v24, (struct RGNOBJ *)v25, 1);
              if ( RGNOBJ::iCombine((RGNOBJ *)v24, (struct RGNOBJ *)v28, (struct RGNOBJ *)v25, 1) )
                RGNOBJAPI::bSwap((RGNOBJAPI *)v28, (struct RGNOBJ *)v24);
            }
          }
          RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v25);
          RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v24);
        }
        if ( RGNOBJ::bEqual((RGNOBJ *)&v34, (struct RGNOBJ *)v28)
          && *((_DWORD *)a1 + 8) == v9
          && *((_DWORD *)a1 + 10) == v11
          && *((_DWORD *)a1 + 9) == v10
          && *((_DWORD *)a1 + 11) == v12 )
        ...
        else
        {
          ...
          if ( (*((_DWORD *)a1 + 46) & 0x200) != 0 && v26[0] )
            v16 = RGNOBJ::bCopy((RGNOBJ *)v26, (struct RGNOBJ *)v28) != 0;
          v27 = ghsemWndobj;
          ...
          if ( v16 )
          {
            ...
            if ( v33 )
            {
              RGNOBJ::bSwap((RGNOBJ *)v26, (struct RGNOBJ *)&v33);
              *((_QWORD *)a1 + 24) = v33;
            }
          }
          v17 = v23;
          if ( (*((_DWORD *)a1 + 46) & 1) != 0 )
          {
            ...
            if ( (_QWORD)v23 && RGNOBJ::iCombine((RGNOBJ *)&v23, (struct RGNOBJ *)v28, (struct RGNOBJ *)&v34, 4) )
            {
          ...
          RGNOBJAPI::bSwap((RGNOBJAPI *)v28, (struct EWNDOBJ *)((char *)a1 + 56));
          v20 = *v8;
