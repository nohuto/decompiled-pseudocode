/*
 * XREFs of CheckEasPolicyChange @ 0x1C01D1D1C
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032F158 != KeyInformation[0] )
  {
    qword_1C032F158 = KeyInformation[0];
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032F150 != KeyInformation[0] )
  {
    qword_1C032F150 = KeyInformation[0];
    return 1;
  }
  return v0;
}
