/*
 * XREFs of SetMinMetrics @ 0x1C01335D4
 * Callers:
...
__int64 __fastcall SetMinMetrics(__int64 a1, char *a2)
{
  ...
  __int64 v81; // rcx
  int v83; // ecx
  int v84; // [rsp+30h] [rbp-30h]
  int v85; // [rsp+34h] [rbp-2Ch]
  int v86; // [rsp+38h] [rbp-28h]
  int v87; // [rsp+3Ch] [rbp-24h]
...
LABEL_55:
  ...
  if ( IsDPIDWMSysMet(7uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v51 = 0)
      : (v51 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                         + 260LL) & 1),
        v51) )
  {
...
LABEL_135:
  ...
  if ( IsDPIDWMSysMet(0x2FuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v71 = 0)
      : (v71 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                         + 260LL) & 1),
        v71) )
  {
...
LABEL_183:
  ...
  if ( IsDPIDWMSysMet(0x38uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
      ? (v83 = 0)
      : (v83 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                         + 260LL) & 1),
        v83) )
  {
