/*
 * XREFs of UseLastContactPosition @ 0x1C01CCD90
 * Callers:
...
__int64 __fastcall UseLastContactPosition(__int64 a1, _QWORD *a2, unsigned int *a3, unsigned int a4)
{
  ...
  a2[5] = *(_QWORD *)(*(_QWORD *)(a1 + 680) + 2400 * v4 + 2252);
  a2[6] = *(_QWORD *)(*(_QWORD *)(a1 + 680) + 2400 * v4 + 2260);
  a2[7] = *(_QWORD *)(*(_QWORD *)(a1 + 680) + 2400 * v4 + 2268);
