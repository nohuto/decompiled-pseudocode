/*
 * XREFs of ?EnsureUmfdHost@UmfdHostLifeTimeManager@@SA_NXZ @ 0x1C02B9644
 * Callers:
 *     UmfdLoadFontFileView @ 0x1C025D370 (UmfdLoadFontFileView.c)
 *     cMapRemoteFonts @ 0x1C027EF80 (cMapRemoteFonts.c)
 *     AtmDrvFontManagementRedirector @ 0x1C02A4690 (AtmDrvFontManagementRedirector.c)
...
char UmfdHostLifeTimeManager::EnsureUmfdHost(void)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    {
      if ( (unsigned int)dword_1C031D7B0 > 5 && TlgKeywordOn(v6, 0x200000000000uLL) )
        goto LABEL_14;
      goto LABEL_15;
    }
LABEL_11:
  ...
  if ( (unsigned int)dword_1C031D7B0 > 5 && TlgKeywordOn(v0, 0x200000000000uLL) )
LABEL_14:
    TlgWrite(v3, &unk_1C02EAEAD, v4, v5, 2u, &pData);
LABEL_15:
