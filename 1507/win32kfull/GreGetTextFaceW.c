/*
 * XREFs of GreGetTextFaceW @ 0x1C002FB84
 * Callers:
...
__int64 __fastcall GreGetTextFaceW(HDC a1, int a2, void *a3, int a4)
{
  ...
  int j; // r12d
  __int64 v21; // rax
  struct LFONT *v23; // [rsp+38h] [rbp-29h] BYREF
  ...
  _QWORD v29[6]; // [rsp+68h] [rbp+7h] BYREF
...
LABEL_40:
  ...
  {
    v11 = 0;
    if ( (v24 & 2) == 0 || (v12 = (const wchar_t *)((char *)v9 + 304), !*((_WORD *)v9 + 152)) )
    {
      v13 = *((_QWORD *)v10 + 4);
    ...
    if ( a3 )
    {
      if ( v4 >= 1 )
      {
        ...
        if ( a4 && v11 )
        {
          ...
          {
            if ( !_wcsicmp((const wchar_t *)v9 + 152, v15) )
              break;
            v17 = -1LL;
            do
              ++v17;
    ...
    else
    {
      ...
      if ( a4 && v11 )
      {
        ...
        {
          if ( !_wcsicmp((const wchar_t *)v9 + 152, v19) )
            break;
          v21 = -1LL;
          do
            ++v21;
