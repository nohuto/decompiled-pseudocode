/*
 * XREFs of ?ConvertHandleAndVerifyLoc@@YAPEAXPEAX@Z @ 0x1C013A2C0
 * Callers:
 *     xxxSafeLoadKeyboardLayoutEx @ 0x1C0139C54 (xxxSafeLoadKeyboardLayoutEx.c)
 * Callees:
 *     GetWindowsDirectoryDevicePath @ 0x1C013A4F4 (GetWindowsDirectoryDevicePath.c)
    ...
    if ( Handle )
    {
      ...
      if ( v4 >= 0 && ObQueryNameString(Object, &ObjectNameInfo, 0x218u, &ReturnLength) >= 0 )
      {
        ...
        *(_DWORD *)&Destination.Length = 34078720;
        ...
        {
          v5 = L"\\SysWOW64\\";
          if ( (*(_DWORD *)(gptiCurrent + 448LL) & 0x100) == 0 )
            v5 = L"\\system32\\";
