/*
 * XREFs of ?RedirDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x1C028EA80
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a6)
{
  ...
  __int64 v14; // r9
  __int64 v15; // r9
  struct SURFACE *v17; // [rsp+40h] [rbp-A8h] BYREF
  __int64 v18; // [rsp+48h] [rbp-A0h] BYREF
  _BYTE v19[32]; // [rsp+50h] [rbp-98h] BYREF
  _BYTE v20[80]; // [rsp+70h] [rbp-78h] BYREF
  __int64 HDEV; // [rsp+F0h] [rbp+8h] BYREF

  REDIROPEN::REDIROPEN((REDIROPEN *)&v17, a1);
  if ( a1 )
  {
