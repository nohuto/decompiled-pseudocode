/*
 * XREFs of xxxWindowHitTest2 @ 0x1C00DF44C
 * Callers:
...
__int64 __fastcall xxxWindowHitTest2(struct tagWND *a1, unsigned __int64 a2, int *a3, char a4)
{
  ...
  v8 = 17;
  if ( !a1
    || !IsCompositionInputWindow(a1) && (*((_BYTE *)v7 + 55) & 0x10) == 0
    || !IsCompositionInputWindow(v7) && !PtInRect((_DWORD *)v7 + 28, v6) )
  {
    return 0LL;
  }
  v9 = *((_QWORD *)v7 + 25);
  ...
  if ( !IsCompositionInputWindow(v7) && (v10 & 0x20) == 0 && PtInRect((_DWORD *)v7 + 32, v6) )
  {
    v11 = *((_QWORD *)v7 + 12);
  ...
  if ( IsCompositionInputWindow(v7) || *((_QWORD *)v7 + 2) != gptiCurrent )
  {
    v15 = 1;
    goto LABEL_19;
  }
  ...
  v15 = xxxSendTransformableMessageTimeout(
          ...
          0x84u,
          0LL,
          (struct _LARGE_STRING *)((unsigned __int16)a2 | (WORD2(a2) << 16)),
          0,
          0,
          0LL,
          1,
