/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02A0A60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct _RECTL *v41; // [rsp+108h] [rbp-8h]
  ...
  struct tagCOLORADJUSTMENT *v46; // [rsp+130h] [rbp+20h]
        ...
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v16, (UMPDOBJ *)((char *)v16 + 112), (const void **)&Src[6], 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v16, (struct _XLATEOBJ **)&Src[7]) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[8], 0x18u) )
            {
              ...
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[10], 0x10u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[11], 0x10u) )
                  {
                    ...
                    {
                      LODWORD(Size) = 4;
                      if ( (unsigned int)UMPDOBJ::Thunk(v16, Src, 0x80u, &v23, Size) != -1 )
                      {
                        if ( v23 )
                          v20 = 1;
                      }
