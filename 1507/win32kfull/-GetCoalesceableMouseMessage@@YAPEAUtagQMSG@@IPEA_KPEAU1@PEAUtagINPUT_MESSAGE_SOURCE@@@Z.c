/*
 * XREFs of ?GetCoalesceableMouseMessage@@YAPEAUtagQMSG@@IPEA_KPEAU1@PEAUtagINPUT_MESSAGE_SOURCE@@@Z @ 0x1C00EE8A8
 * Callers:
        ...
        struct tagINPUT_MESSAGE_SOURCE *a4)
{
  ...
  if ( !a3
    || (*((_DWORD *)a3 + 23) & 2) != 0
    || *((_DWORD *)a3 + 6) != a1
    || !(unsigned int)IsEqualInputSource((char *)a3 + 112, a4, a3) )
  {
    return 0LL;
  }
