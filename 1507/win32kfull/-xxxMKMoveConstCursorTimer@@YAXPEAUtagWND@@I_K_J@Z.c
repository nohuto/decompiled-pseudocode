/*
 * XREFs of ?xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01EE830
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveConstCursorTimer(struct tagWND *a1, __int64 a2)
{
  ...
  if ( (v2 & 3) == 0 )
  {
    if ( (v2 & 0xC) != 0 )
    {
      v3 = 4 * (unsigned __int8)byte_1C03235F2[0];
      goto LABEL_7;
    }
LABEL_6:
    v4 = giMouseMoveTable % (unsigned int)(unsigned __int8)byte_1C03235F1;
    a1 = (struct tagWND *)byte_1C03235F2;
    v3 = (unsigned __int8)byte_1C03235F2[v4];
    a2 = v4 + 1;
    giMouseMoveTable = a2;
    if ( !v3 )
      return;
...
LABEL_7:
  ...
  xxxMoveEvent(v3 * gMKDeltaX, v3 * gMKDeltaY, 0, 0LL, v6, 0LL, 0LL, 0LL, 0LL, 0, v7, 1);
