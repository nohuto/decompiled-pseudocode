/*
 * XREFs of itrp_DeltaEngine @ 0x1C00BC474
 * Callers:
 *     itrp_DELTAP3 @ 0x1C00BA7E0 (itrp_DELTAP3.c)
 *     itrp_DELTAC2 @ 0x1C00BAB90 (itrp_DELTAC2.c)
 *     itrp_DELTAP2 @ 0x1C00BB9D0 (itrp_DELTAP2.c)
 *     itrp_DELTAC1 @ 0x1C00BC420 (itrp_DELTAC1.c)
 *     itrp_DELTAP1 @ 0x1C00BC450 (itrp_DELTAP1.c)
 *     itrp_DELTAC3 @ 0x1C00BFB80 (itrp_DELTAC3.c)
 * Callees:
...
__int64 __fastcall itrp_DeltaEngine(__int64 a1, unsigned int a2, __int16 a3, char a4)
{
  ...
  v4 = qword_1C0323160;
  v7 = a1;
  if ( (*(_QWORD *)(qword_1C0323160 + 424) ^ qword_1C0323160 ^ *(_QWORD *)qword_1C0323160 ^ MEMORY[0xFFFFF78000000330]) == *(_QWORD *)(qword_1C0323160 + 432)
    && (qword_1C0323148 - *(_QWORD *)qword_1C0323160) >> 2
    && (v8 = (_DWORD *)(qword_1C0323148 - 4),
        qword_1C0323148 = (__int64)v8,
        v9 = 2 * *v8,
        (*(_QWORD *)(qword_1C0323160 + 424) ^ qword_1C0323160 ^ *(_QWORD *)qword_1C0323160 ^ MEMORY[0xFFFFF78000000330]) == *(_QWORD *)(qword_1C0323160 + 432))
    && (v43 = v9, v9 <= (unsigned __int64)(((__int64)v8 - *(_QWORD *)qword_1C0323160) >> 2)) )
  {
    v10 = (__int64)&v8[-v9];
    qword_1C0323148 = v10;
    v11 = *(unsigned __int16 *)(qword_1C0323160 + 24);
    ...
    else
    {
      ...
      if ( v14 < v9 )
      {
        ...
        v17 = LocalGS;
        v18 = v14;
        v19 = HIWORD(dword_1C0323138);
        v20 = a4;
        v40 = a4;
        v21 = 4 * v18 + 4;
        v42 = v18;
        v38 = HIWORD(dword_1C0323138);
        v39 = dword_1C0323138;
        do
        {
