/*
 * XREFs of ?bFill@@YAHAEAVEPATHOBJ@@PEAU_RECTL@@KP6AX1KPEAX@Z2@Z @ 0x1C00CFE4C
 * Callers:
    ...
    if ( a2 )
    {
      ...
      for ( i = 0; i < *((_DWORD *)a1 + 12); ++i )
      {
          ...
          || a2->bottom <= *(_DWORD *)(v8 + 16LL * i + 12) )
        {
          ...
          if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)v38) )
            _guard_dispatch_icall_fptr();
        }
        else
        {
    ...
    if ( a2 )
    {
      ...
      for ( j = 0; j < *((_DWORD *)a1 + 16); ++j )
      {
          ...
          || a2->bottom <= *(_DWORD *)(v12 + 16LL * j + 12) )
        {
          ...
          if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)v37) )
            _guard_dispatch_icall_fptr();
        }
        else
        {
