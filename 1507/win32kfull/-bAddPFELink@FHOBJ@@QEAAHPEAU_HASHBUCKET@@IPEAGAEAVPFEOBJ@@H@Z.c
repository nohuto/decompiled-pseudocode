/*
 * XREFs of ?bAddPFELink@FHOBJ@@QEAAHPEAU_HASHBUCKET@@IPEAGAEAVPFEOBJ@@H@Z @ 0x1C0140ABC
 * Callers:
 ...
 *     ?efstyCompute@PFEOBJ@@QEAA?AW4_ENUMFONTSTYLE@@XZ @ 0x1C012618C (-efstyCompute@PFEOBJ@@QEAA-AW4_ENUMFONTSTYLE@@XZ.c)
 */
        ...
        int a6)
{
  ...
  *v11 = 0LL;
  ...
  {
    if ( (unsigned int)PFEOBJ::efstyCompute((__int64)a5) || (*((_DWORD *)a2 + 8) & 4) != 0 )
    {
      **((_QWORD **)a2 + 2) = v12;
      *((_QWORD *)a2 + 2) = v12;
    }
  ...
  if ( v13 )
  {
    ...
    *(_QWORD *)(*((_QWORD *)this + 1) + 8 * v7 + 40) = v19;
    ...
    if ( !(unsigned int)PFEOBJ::efstyCompute((__int64)a5) )
      *(_DWORD *)(v23 + 32) |= 4u;
    return v6;
  }
  Win32FreePool(v12);
