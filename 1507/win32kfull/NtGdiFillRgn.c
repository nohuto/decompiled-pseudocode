/*
 * XREFs of NtGdiFillRgn @ 0x1C0105250
 * Callers:
...
LABEL_9:
      ...
      if ( !(unsigned int)XDCOBJ::bHasSurface((XDCOBJ *)v24) )
      {
LABEL_44:
        v6 = 1;
LABEL_45:
...
LABEL_41:
        ...
        if ( (*((_DWORD *)v18 + 12) & 0x100) == 0 )
        {
          ...
          XDCOBJ::vAccumulateTight((XDCOBJ *)v24, v17, &rclBounds);
        }
      }
      if ( v18 )
      {
        bSyncBrushObj(v18);
        EBRUSHOBJ::vInitBrush(&pbo, v24[0], v18, v16, v15);
        v34 = (char *)v24[0] + 240;
        if ( (*((_DWORD *)v18 + 12) & 0x100) == 0 )
        {
