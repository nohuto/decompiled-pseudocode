/*
 * XREFs of ?bFoundForcedMatch@MAPPER@@QEAAHPEAU_UNIVERSAL_FONT_ID@@@Z @ 0x1C0286EC4
 * Callers:
...
__int64 __fastcall MAPPER::bFoundForcedMatch(MAPPER *this, struct _UNIVERSAL_FONT_ID *a2)
{
  ...
  {
    v28 = gpPFTDevice;
    v5 = DEVICE_PFTOBJ::pPFFGet((DEVICE_PFTOBJ *)&v28, *(_QWORD *)(**(_QWORD **)this + 48LL), 0LL);
    if ( !v5 )
      return 0LL;
    v6 = (_QWORD *)((char *)v5 + 112);
    if ( !v6 )
      return 0LL;
    v26[0] = v6;
    v26[1] = *v6;
    ...
    do
    {
      if ( *((_DWORD *)PFEFromUFI + 23) == v8
        && *((_DWORD *)PFEFromUFI + 24) == *((_DWORD *)a2 + 1)
