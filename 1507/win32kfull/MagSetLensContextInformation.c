/*
 * XREFs of MagSetLensContextInformation @ 0x1C01FDB8C
 * Callers:
 ...
 *     ?MagpUpdateInputTransfrom@@YAJPEAU_MAGN_INPUT_TRANSFORM@@@Z @ 0x1C01FD1F4 (-MagpUpdateInputTransfrom@@YAJPEAU_MAGN_INPUT_TRANSFORM@@@Z.c)
...
LABEL_153:
    ...
    case 1:
      ...
      *(_QWORD *)(v83 + 8) = v84;
      ...
      if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 216LL) == v6 )
      {
        v89 = (void *)ReferenceDwmApiPort(v83, v80, v81, v82);
        v90 = DwmAsyncMagnSetDesktopTransform(v89, 0);
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 216LL) = 0LL;
      }
      else
      {
        v90 = 0;
...
LABEL_155:
    ...
    case 2:
      ...
      if ( (v9 & 0x80000000) != 0 )
        return v9;
      if ( (*(_DWORD *)(v74[3] + 288) & 0x80u) == 0 || (v75 = *(_WORD *)(gpDispInfo + 176LL), v75 <= 0x60u) )
      {
        v76 = Buf1;
        if ( (v74[2] & 2) == 0 )
        {
...
LABEL_109:
    ...
    case 3:
      ...
      if ( v57 )
      {
        ...
        v62 = *(__int64 **)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 216LL);
        if ( !v43 )
        {
          if ( v62 )
          {
          ...
          else
          {
            ...
            if ( (v9 & 0x80000000) != 0 )
              return v9;
            *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 216LL) = v56;
          }
          goto LABEL_97;
        }
        if ( v62 )
...
LABEL_97:
    ...
    case 5:
      ...
      if ( a3 == -1 )
      {
        ...
        v48 = *(__int64 **)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 224LL);
        if ( v43 )
        {
          if ( v48 )
          {
            ...
            if ( (v9 & 0x80000000) != 0 )
              return v9;
            *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 224LL) = 0LL;
LABEL_63:
            if ( (v9 & 0x80000000) != 0 )
              return v9;
...
LABEL_62:
        ...
        if ( !v48 )
        {
          ...
          if ( (v9 & 0x80000000) != 0 )
            return v9;
          *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 224LL) = v42;
          goto LABEL_63;
        }
        if ( v48 != v42 )
          return v9;
