/*
 * XREFs of AddAndInitRimClient @ 0x1C01503F4
 * Callers:
...
__int64 AddAndInitRimClient()
{
  ...
  while ( 1 )
  {
    ...
    v30 = ZwCreateEvent((PHANDLE)&aDeviceTemplate[186], 0x1F0003u, 0LL, SynchronizationEvent, 0);
    ...
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 136) = Object;
    v11 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 160),
            ...
            &v35,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 176) = v35;
    v12 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 200),
            ...
            &v25,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 216) = v25;
    v13 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 240),
            ...
            &v26,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 256) = v26;
    v31 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 304),
            ...
            &v27,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 320) = v27;
    v33 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 352),
            ...
            &v28,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 368) = v28;
    v14 = ObReferenceObjectByHandle(
            *(HANDLE *)(v2 + aDeviceTemplate[0] + 400),
            ...
            &v29,
            0LL);
    *(_QWORD *)(v2 + aDeviceTemplate[0] + 416) = v29;
    if ( v10 < 0 )
      return 3221225473LL;
    if ( v11 < 0 )
      return 3221225473LL;
