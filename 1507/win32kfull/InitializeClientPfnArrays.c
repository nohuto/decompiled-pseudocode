/*
 * XREFs of InitializeClientPfnArrays @ 0x1C0151CA4
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C0151BC0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1, a2) == gpepCSRSS )
  {
    ...
    *(_QWORD *)(gpsi + 840LL) = *(_QWORD *)(a3 + 80);
    ...
    qword_1C0323818 = *(_QWORD *)(gpsi + 608LL);
    qword_1C0323820 = *(_QWORD *)(gpsi + 688LL);
    qword_1C0323828 = *(_QWORD *)(gpsi + 672LL);
    qword_1C0323838 = *(_QWORD *)(gpsi + 640LL);
    qword_1C03238A0 = *(_QWORD *)(gpsi + 656LL);
    qword_1C03238B8 = *(_QWORD *)(gpsi + 584LL);
    qword_1C0323840 = *(_QWORD *)(gpsi + 680LL);
    qword_1C0323848 = *(_QWORD *)(gpsi + 648LL);
    qword_1C0323898 = 1LL;
    qword_1C03238A8 = 3LL;
    qword_1C03238B0 = 2LL;
    qword_1C03238C0 = 5LL;
