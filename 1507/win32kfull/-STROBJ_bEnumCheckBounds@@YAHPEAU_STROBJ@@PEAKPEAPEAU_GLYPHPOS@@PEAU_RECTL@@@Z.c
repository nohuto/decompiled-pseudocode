/*
 * XREFs of ?STROBJ_bEnumCheckBounds@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@PEAU_RECTL@@@Z @ 0x1C02B5904
 * Callers:
 *     EngTextOut @ 0x1C009BA80 (EngTextOut.c)
 * Callees:
 *     STROBJ_bEnum @ 0x1C01002D0 (STROBJ_bEnum.c)
 *     ?bGlyphOutOfBounds@@YAHPEAVESTROBJ@@PEAU_GLYPHPOS@@PEAU_RECTL@@K@Z @ 0x1C02B6018 (-bGlyphOutOfBounds@@YAHPEAVESTROBJ@@PEAU_GLYPHPOS@@PEAU_RECTL@@K@Z.c)
 *     vGetPosInfo @ 0x1C02B747C (vGetPosInfo.c)
 */
