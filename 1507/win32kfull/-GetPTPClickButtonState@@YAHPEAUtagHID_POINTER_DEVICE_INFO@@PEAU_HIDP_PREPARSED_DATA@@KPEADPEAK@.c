/*
 * XREFs of ?GetPTPClickButtonState@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAU_HIDP_PREPARSED_DATA@@KPEADPEAK@Z @ 0x1C01CE218
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  v7 = 0LL;
  v8 = 0;
  v9 = (USHORT *)*((_QWORD *)a1 + 175);
  v10 = (_DWORD *)(*((_QWORD *)a1 + 85) + 2400LL * v23);
...
LABEL_22:
      ...
      {
        case 1u:
          *(_DWORD *)(*((_QWORD *)a1 + 87) + 4LL) |= 4u;
          break;
        case 2u:
          *(_DWORD *)(*((_QWORD *)a1 + 87) + 4LL) |= 8u;
          break;
        case 3u:
          *(_DWORD *)(*((_QWORD *)a1 + 87) + 4LL) |= 0x10u;
          break;
      }
      goto LABEL_28;
    }
