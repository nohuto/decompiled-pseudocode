/*
 * XREFs of ?FindOrAssignPrimary@@YAPEAUtagPOINTERINFONODE@@PEBUtagPOINTERINPUTFRAME@@PEAUtagTPSTATE@@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01F12C4
 * Callers:
        ...
        struct tagHID_POINTER_DEVICE_INFO *a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v7 )
    {
      v10 = (unsigned int)*(unsigned __int16 *)(v7 + 48) % *((_DWORD *)a2 + 267);
