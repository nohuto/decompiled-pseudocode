/*
 * XREFs of NtGdiWidenPath @ 0x1C02A5C90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vReComputeBounds@EPATHOBJ@@QEAAXXZ @ 0x1C02C87D4 (-vReComputeBounds@EPATHOBJ@@QEAAXXZ.c)
 */
...
LABEL_18:
      ...
      if ( (*((_DWORD *)v7[0] + 46) & 1) == 0 )
      {
        if ( (*(_DWORD *)(*((_QWORD *)v7[0] + 19) + 48LL) & 0x800) == 0 )
          goto LABEL_10;
        v3 = (struct _LINEATTRS *)&unk_1C031D2F0;
      }
