/*
 * XREFs of ?DdcciGetCapabilitiesString@CPhysicalMonitorHandle@@QEAAJPEADK@Z @ 0x1C025B7D0
 * Callers:
 ...
 *     ?RtlStringCbCopyA@@YAJPEAD_KPEBD@Z @ 0x1C025C664 (-RtlStringCbCopyA@@YAJPEAD_KPEBD@Z.c)
 */
