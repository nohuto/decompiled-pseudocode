/*
 * XREFs of ?xxxSizeOrMoveRect@@YAHPEAU_MOVESIZEDATA@@KPEAKPEAUtagRECT@@PEAPEAUtagCHECKPOINT@@@Z @ 0x1C0209C0C
 * Callers:
 ...
 *     ?SetDragOutThresholdAlways@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C0205C24 (-SetDragOutThresholdAlways@@YAXPEAU_MOVESIZEDATA@@@Z.c)
        ...
        struct tagCHECKPOINT **a5)
{
  ...
  __int64 v86; // [rsp+58h] [rbp-31h]
  struct tagMONITOR *v87; // [rsp+60h] [rbp-29h] BYREF
  _DWORD *v88; // [rsp+68h] [rbp-21h]
  struct tagMONITOR *v89; // [rsp+70h] [rbp-19h]
  ...
  if ( !v85 || v5 == *((_DWORD *)a1 + 69) && v9 == *((_DWORD *)a1 + 70) )
    return 0LL;
  v10 = ComputeMoveOutcome(__PAIR64__(v9, v5), (__int64)a1, &v87, &v92);
  v11 = *((_DWORD *)a1 + 45);
  v12 = v10;
      ...
      switch ( v12 )
      {
        case 3:
            ...
            && ((*((_DWORD *)a1 + 45) >> 15) & 7u) - 4 <= 1 )
          {
            ...
            v92 = (struct tagMONITOR *)*((_QWORD *)a1 + 26);
            do
            {
              ...
              if ( IsDockTargetActive((__int64)a1, (__int64)v27, 3)
                && *(_DWORD *)v14 <= (int)v84
                && (int)v84 < *(_DWORD *)(v14 + 8) )
              {
                v25 = v14;
                v86 = v29;
              }
            ...
            if ( !v32 )
            {
              if ( v88 )
              {
                ...
                v34 = v89;
                if ( (unsigned int)VerticalSizeRectFromHitTarget((__int64)a1, (__int64)v89, 0, v86, v84) )
                {
                  *((_DWORD *)a1 + 54) = 0;
...
LABEL_13:
      ...
      *(_QWORD *)(gptiCurrent + 376LL) = &v90;
      ...
      if ( v76 )
        ++*((_DWORD *)v76 + 2);
      xxxSizeRectFromHitTarget(a1, v76, v16, v14);
      if ( v16 )
      {
        if ( v16 == 1 )
        {
