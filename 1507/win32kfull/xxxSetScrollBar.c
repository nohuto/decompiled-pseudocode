/*
 * XREFs of xxxSetScrollBar @ 0x1C00D55C0
 * Callers:
...
__int64 __fastcall xxxSetScrollBar(struct tagWND *a1, unsigned int a2, __int64 a3, int a4)
{
  ...
  if ( v5 == 2 )
  {
    ...
    return xxxSendTransformableMessageTimeout(a1, 0xE9u, v6, (struct _LARGE_STRING *)a3, 0, 0, 0LL, 1, 1);
  }
  if ( v5 )
  {
    v8 = 1;
