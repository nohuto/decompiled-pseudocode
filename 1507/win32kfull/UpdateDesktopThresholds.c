/*
 * XREFs of UpdateDesktopThresholds @ 0x1C0039024
 * Callers:
 ...
 *     ?UpdateDesktopMonitorNavigationOrder@@YAXPEAUtagMONITOR_MARGIN@@@Z @ 0x1C00392E0 (-UpdateDesktopMonitorNavigationOrder@@YAXPEAUtagMONITOR_MARGIN@@@Z.c)
 */
...
__int64 UpdateDesktopThresholds()
{
  ...
  do
  {
    ...
    if ( v16 )
    {
      v5 = (unsigned int)dword_1C02E4BA0[v4];
      v6 = (__int64 *)((char *)v1 + 16);
      v7 = (unsigned int)dword_1C02E4BB0[v4];
      v8 = v4;
      v9 = (unsigned int)dword_1C02E4BC0[v4];
      v10 = v16;
      v11 = (unsigned int)dword_1C02E4BD0[v8];
      v12 = (unsigned int)dword_1C02E4BE0[v8];
      v13 = (unsigned int)dword_1C02E4BF0[v8];
      do
      {
        v14 = *v6;
        v6 += 3;
