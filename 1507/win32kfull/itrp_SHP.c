...
__int64 __fastcall itrp_SHP(int a1, char a2)
{
  ...
  if ( (a2 & 1) == 0 )
  {
    ...
    {
      if ( dword_1C0323178 >= (unsigned __int16)v20[8] )
        goto LABEL_54;
      v12 = 0;
      if ( dword_1C0323178 < 0 )
        goto LABEL_54;
      v25 = 0;
    }
    else
    {
      if ( dword_1C0323178 >= *(_DWORD *)(qword_1C0323160 + 440) )
        goto LABEL_54;
      v12 = 0;
      if ( dword_1C0323178 < 0 )
        goto LABEL_54;
  ...
  {
    if ( SHIDWORD(qword_1C0323170) >= (unsigned __int16)v7[8] )
      goto LABEL_54;
    v12 = 0;
    if ( qword_1C0323170 < 0 )
      goto LABEL_54;
    v13 = 0;
  }
  else
  {
    if ( SHIDWORD(qword_1C0323170) >= *(_DWORD *)(qword_1C0323160 + 440) )
      goto LABEL_54;
    v12 = 0;
    if ( qword_1C0323170 < 0 )
      goto LABEL_54;
...
LABEL_15:
  ...
  if ( word_1C0323188 == 0x4000 )
  {
    if ( (_WORD)dword_1C032313C )
      v17 = ((unsigned __int64)(v15 * (__int64)(__int16)dword_1C032313C) >> 32 << 18)
          + ((((unsigned int)(v15 * (__int16)dword_1C032313C) >> 13) + 1) >> 1);
    if ( HIWORD(dword_1C032313C) )
      v12 = ((unsigned __int64)(v15 * (__int64)SHIWORD(dword_1C032313C)) >> 32 << 18)
          + ((((unsigned int)(v15 * SHIWORD(dword_1C032313C)) >> 13) + 1) >> 1);
  }
  else
  {
    if ( (_WORD)dword_1C032313C )
    {
      v27 = CompDiv((unsigned int)word_1C0323188, v15 * (__int64)(__int16)dword_1C032313C);
      v16 = word_1C0323188;
      v17 = v27;
    }
    if ( HIWORD(dword_1C032313C) )
      v12 = CompDiv((unsigned int)v16, v18 * SHIWORD(dword_1C032313C));
  }
