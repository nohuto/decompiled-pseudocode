/*
 * XREFs of sfac_GetMultiGlyphIDs @ 0x1C02D8840
 * Callers:
...
__int64 sfac_GetMultiGlyphIDs(__int64 a1, __int64 a2, unsigned __int16 a3, ...)
{
  ...
  __int16 *v10; // [rsp+60h] [rbp+28h]
  va_list va1; // [rsp+68h] [rbp+30h] BYREF

  va_start(va1, a3);
  va_start(va, a3);
  v8 = va_arg(va1, _QWORD);
  v10 = va_arg(va1, __int16 *);
  ...
  if ( !(_DWORD)result )
  {
    ...
    {
      v7 = InvokeGlyphMappingF(*(_DWORD *)(a1 + 212), (_WORD *)(v8 + *(unsigned int *)(a1 + 20)), a3, (_WORD *)a1);
      *v10 = v7;
    }
    else
    {
