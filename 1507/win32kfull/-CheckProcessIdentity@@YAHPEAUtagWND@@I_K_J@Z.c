/*
 * XREFs of ?CheckProcessIdentity@@YAHPEAUtagWND@@I_K_J@Z @ 0x1C007C150
 * Callers:
 ...
 *     ?xxxWrapDesktopWndProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C0132070 (-xxxWrapDesktopWndProc@@YA_JPEAUtagWND@@I_K_J1@Z.c)
...
__int64 __fastcall CheckProcessIdentity(struct tagWND *a1, unsigned int a2, unsigned __int64 a3, __int64 a4)
{
      ...
      if ( gbEnforceUIPI )
      {
        if ( (unsigned int)v17 <= v15 )
        {
          if ( (_DWORD)v17 != v15 || (v18 = HIDWORD(v17), (_DWORD)v18 != v16) && (_DWORD)v18 != -1 && v16 != -1 )
          {
            ...
            {
              v19 = *((_QWORD *)a1 + 2);
              if ( *(struct tagWND **)(v19 + 1232) == a1 && *(_QWORD *)(v19 + 392) == *(_QWORD *)(gptiCurrent + 392LL) )
                return 1LL;
            }
