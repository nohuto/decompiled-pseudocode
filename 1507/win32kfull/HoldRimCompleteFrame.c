/*
 * XREFs of HoldRimCompleteFrame @ 0x1C02309FC
 * Callers:
  ...
  if ( HoldingFrameForDevice )
  {
    ...
    *((_DWORD *)HoldingFrameForDevice + 10) = *(_DWORD *)(a1 + 28);
    ...
    while ( 1 )
    {
      ...
      if ( !v41 )
        break;
      v42 = (void *)Win32AllocPool(*(unsigned int *)(v40 + 4), 1685222229LL);
      *(_QWORD *)(v41 + 16) = v42;
      if ( !v42 )
        break;
...
LABEL_44:
  ...
  {
    v7 = (struct tagTPSTATE *)Win32AllocPoolZInit(1312LL, 1886679893LL);
    if ( !v7 )
    {
LABEL_15:
...
LABEL_28:
  ...
  v23 = qword_1C03253E8;
  *(_QWORD *)HoldingFrameForDevice = qword_1C03253E8;
  *((_QWORD *)HoldingFrameForDevice + 1) = &qword_1C03253E8;
  if ( *((struct tagPOINTERHOLDINGFRAME ***)v23 + 1) != &qword_1C03253E8 )
    __fastfail(3u);
  *((_QWORD *)v23 + 1) = HoldingFrameForDevice;
  qword_1C03253E8 = HoldingFrameForDevice;
  return HoldingFrameForDevice;
}
