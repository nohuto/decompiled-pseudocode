/*
 * XREFs of fsc_OverscaleToBold @ 0x1C02DBCA0
 * Callers:
 *     fs_ContourScan @ 0x1C00AF620 (fs_ContourScan.c)
 * Callees:
 *     __security_check_cookie @ 0x1C015BB90 (__security_check_cookie.c)
 *     EmboldenOverscaleConst @ 0x1C02DB9E0 (EmboldenOverscaleConst.c)
 *     FindNext @ 0x1C02DBAB4 (FindNext.c)
 */
          ...
          do
          {
            while ( 1 )
            {
              ...
              if ( !*v17 || v18 == -1 && ((unsigned __int8)*v16 >> 7 == 1 || v16 == &v52) )
                break;
              v19 = byte_1C02EE1C0[(unsigned __int8)(v18 & (((unsigned __int8)*v16 >> 7 == 0) | (2 * (~v18 & ~*v15))))
                                 + 272];
              if ( v19 == 8 )
                break;
              v20 = v17;
              ...
              while ( 1 )
              {
                ...
                do
                {
                  ...
                  if ( v20 <= &v23[v14 - 1] )
                  {
                    v28 = (unsigned __int8)byte_1C02EE1C0[v27 + 16];
              ...
              if ( v22 )
              {
                ...
                do
                {
                  ...
                  if ( v43 )
                  {
                    v45 = (unsigned __int8)byte_1C02EE1C0[(unsigned __int8)(*v32 & StartMask[v51 + 1]) + 16];
                    v42 = v58;
                    *v32 |= v43 & EndMask[v45];
                  }
                  if ( v44 && (_BYTE)v45 == 8 && v42 < v37 )
                    v32[1] |= v44 & EndMask[(unsigned __int8)byte_1C02EE1C0[(unsigned __int8)v32[1] + 16]];
                  if ( v34 < v33 - 1 )
                    v32 += v40[1] - v58;
                  v37 += v14;
                  ++v34;
