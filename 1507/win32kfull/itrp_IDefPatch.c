/*
 * XREFs of itrp_IDefPatch @ 0x1C02DCE80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_IDefPatch(__int64 a1, char a2)
{
  ...
  v8 = *(_QWORD *)(qword_1C0323160 + 16LL * v7 + 200);
  v9 = v8 + *v6;
  if ( v9 < v8
    || (v10 = v9 + *((unsigned __int16 *)v6 + 2), v10 > v8 + *(unsigned int *)(qword_1C0323160 + 16 * (v7 + 13LL)))
    || v10 < v9 )
  {
    dword_1C03231B0 = 4363;
    return v2;
  }
  v11 = dword_1C03231CC == 1;
  v12 = --dword_1C03231CC;
  if ( v11 )
  {
  ...
  {
    InvokeInterpreter(dword_1C0323198, v9, v9 + *((unsigned __int16 *)v6 + 2));
  }
  ++dword_1C03231CC;
  qword_1C03231B8 = v2;
  if ( dword_1C03231B0 )
