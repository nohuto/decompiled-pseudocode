/*
 * XREFs of xxxRemotePassthruEnable @ 0x1C0203600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxRemotePassthruEnable(__int64 a1)
{
  ...
  if ( PsGetCurrentProcess(v3, v2) != gpepCSRSS )
    return 3221225506LL;
  dword_1C032F2A8 = gapulCvt_VK != (_UNKNOWN *)&gapulCvt_VK_84;
  ZwDeviceIoControlFile(ghRemoteKeyboardChannel, 0LL, 0LL, 0LL, &IoStatusBlock, 0x38080Fu, &dword_1C032F2A8, 4u, 0LL, 0);
  if ( guKbdTblSize )
