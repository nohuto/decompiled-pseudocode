/*
 * XREFs of ?bSpGetSpriteClipRgns@@YAHPEAUHDEV__@@AEAVRGNOBJAPI@@@Z @ 0x1C0270924
 * Callers:
    ...
    if ( *(_QWORD *)a2 && v5 && v9[0] && v10[0] )
    {
      ...
      for ( i = a1[14]; ; i = *(_QWORD *)(i + 24) )
      {
        ...
        if ( (*(_DWORD *)i & 1) == 0 )
        {
          ...
          if ( RGNOBJ::bMerge((RGNOBJ *)v9, (struct RGNOBJ *)&v11, v7, BYTE2(gafjRgnOp)) )
            RGNOBJ::bSwap((RGNOBJ *)&v11, (struct RGNOBJ *)v9);
          else
            RGNOBJ::vSet((RGNOBJ *)v9);
        }
      }
