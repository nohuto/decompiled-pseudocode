/*
 * XREFs of xxxClientAddFontResourceW @ 0x1C013B7E4
 * Callers:
...
unsigned __int8 *__fastcall xxxClientAddFontResourceW(char **a1, unsigned int a2, __int64 a3)
{
  ...
  result = AllocCallbackMessage(136, 1u, *((unsigned __int16 *)a1 + 1), v18, 1, 0x200uLL);
  v7 = result;
