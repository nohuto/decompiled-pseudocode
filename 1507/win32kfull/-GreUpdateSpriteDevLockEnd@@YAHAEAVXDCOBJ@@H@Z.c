/*
 * XREFs of ?GreUpdateSpriteDevLockEnd@@YAHAEAVXDCOBJ@@H@Z @ 0x1C001BB50
 * Callers:
...
LABEL_18:
          ...
          while ( 1 )
          {
            ...
            if ( !v13 )
              break;
LABEL_33:
            v13 = XCLIPOBJ::bEnum((XCLIPOBJ *)v20, 0x144u, &v28, 0LL);
            v15 = v13;
          }
          break;
        case 0:
...
LABEL_7:
  v8 = *(struct REGION **)(*(_QWORD *)a1 + 1568LL);
  if ( v8 && v8 != prgnDefault )
