/*
 * XREFs of RenderNineGridInternal @ 0x1C00C1EE0
 * Callers:
 ...
 *     DNG_InitStretch @ 0x1C00C2FA8 (DNG_InitStretch.c)
        ...
        int a8)
{
  ...
  if ( (*a6 & 0x20) != 0 )
  {
    ...
    do
    {
      v110 = (const void *)(v107 + 4 * v146);
      v111 = (char *)(v106 + 4 * v146);
      if ( v109 <= 0 )
        break;
      v112 = &v111[v109];
      if ( v112 <= v111 )
        break;
      v17 = (unsigned __int64)v110 + v109;
      if ( v17 <= (unsigned __int64)v110 || v21 > (unsigned __int64)v111 || (unsigned __int64)v112 > v23 )
        break;
      if ( (v17 > v23 || v21 > (unsigned __int64)v110) && (v192 > (unsigned __int64)v110 || v17 > v193) )
        break;
...
LABEL_68:
  ...
  if ( v144 > v138 )
  {
    ...
    else
    {
      ...
      {
        v81 = (unsigned int)v79 + v76 * (unsigned __int64)(unsigned int)v78;
        LODWORD(v79) = v79 + v76 * v78;
        LODWORD(v80) = HIDWORD(v81) + v76 * HIDWORD(v78) + v80;
      }
      v82 = v143;
      v83 = 1;
      v84 = v24 * v76;
        ...
        do
        {
          ...
          else
          {
            ...
            if ( v17 <= (unsigned __int64)v92 )
              break;
            v94 = &v93[v91];
            if ( v94 <= v93 || v21 > (unsigned __int64)v92 || v17 > v23 )
              break;
            if ( (v21 > (unsigned __int64)v93 || (unsigned __int64)v94 > v23)
