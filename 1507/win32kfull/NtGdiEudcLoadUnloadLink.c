/*
 * XREFs of NtGdiEudcLoadUnloadLink @ 0x1C028BBF0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a7)
{
  ...
  __int64 v18; // r8
  __int64 v19; // r9
  _WORD v21[40]; // [rsp+50h] [rbp-98h] BYREF
  ...
  if ( a2 <= 0x20 && a3 && a4 - 1 <= 0x122 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( ((unsigned __int8)a3 & 1) != 0 )
        ExRaiseDatatypeMisalignment();
      if ( (unsigned __int64)&a3[v7] > W32UserProbeAddress || &a3[v7] < a3 )
        *W32UserProbeAddress = 0;
      memmove(v12, a3, 2 * v7);
      *((_WORD *)v12 + v7) = 0;
      if ( a7 )
