/*
 * XREFs of ?MulStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1C0297EB0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v26[0] )
  {
    ...
    for ( i = MSURF::bFindSurface((MSURF *)v21, a1, a3, &v29); i; i = MSURF::bNextSurface((MSURF *)v21) )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x20) != 0 )
        v17 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, POINTL *, LINEATTRS *, MIX))(*((_QWORD *)v22 + 7) + 2832LL);
      else
        v17 = EngStrokePath;
      v11 &= OffStrokePath(
