/*
 * XREFs of _ChildWindowFromPointEx @ 0x1C011A1EC
 * Callers:
 *     NtUserChildWindowFromPointEx @ 0x1C011A190 (NtUserChildWindowFromPointEx.c)
...
__int64 __fastcall ChildWindowFromPointEx(__int64 a1, unsigned __int64 a2, char a3)
{
  ...
  if ( a1 )
  {
    if ( (*(_BYTE *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 440) + 224LL) & 1) == 0 )
    {
      ...
      if ( !(unsigned int)SameCoordinateSpace(CurrentProcessWin32Process, *(_QWORD *)(v5 + 384)) )
