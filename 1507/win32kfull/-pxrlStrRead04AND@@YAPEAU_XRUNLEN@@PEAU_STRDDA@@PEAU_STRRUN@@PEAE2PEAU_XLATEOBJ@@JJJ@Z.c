/*
 * XREFs of ?pxrlStrRead04AND@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C02BA8B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_14:
      ...
      while ( 1 )
      {
        v23 = a5->pulXlate[(unsigned __int64)(v22 & (unsigned int)dword_1C02E7080[v11]) >> LOBYTE(dword_1C02E7060[v11])];
        v24 = *v21++;
        if ( (_DWORD)v24 )
        {
          v8 += v24;
