/*
 * XREFs of NtGdiCLIPOBJ_bEnum @ 0x1C02AAF80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z @ 0x1C0285FAC (--$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z.c)
