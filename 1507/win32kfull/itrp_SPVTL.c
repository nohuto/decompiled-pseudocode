/*
 * XREFs of itrp_SPVTL @ 0x1C00C0660
 * Callers:
 *     <none>
 * Callees:
...
LABEL_25:
      if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, qword_1C0323128) )
      {
        ...
        if ( v18 < 1 || v18 > v8 || (int)v5 < v17 + *(__int16 *)(*(_QWORD *)(v16 + 64) + 2LL * v18 - 2) + 1 )
        {
          ...
          {
            v19 = dword_1C0323138;
            LOWORD(dword_1C0323138) = -HIWORD(dword_1C0323138);
            HIWORD(dword_1C0323138) = v19;
          }
          itrp_ComputeAndCheck_PF_Proj();
          dword_1C032318C = 1;
          dword_1C0323190 = 1;
          v20 = *(_WORD *)(qword_1C0323160 + 452);
          if ( (v20 & 1) == 0 )
            goto LABEL_32;
          if ( (v20 & 4) != 0 )
          {
            if ( (_WORD)dword_1C0323138 != 0x4000 )
              goto LABEL_37;
            v22 = HIWORD(dword_1C0323138) == 0;
          }
          else
          {
            if ( HIWORD(dword_1C0323138) != 0x4000 )
              goto LABEL_37;
            v22 = (_WORD)dword_1C0323138 == 0;
          }
          if ( v22 )
          {
LABEL_32:
