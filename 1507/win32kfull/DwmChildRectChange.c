/*
 * XREFs of DwmChildRectChange @ 0x1C00916A8
 * Callers:
...
__int64 __fastcall DwmChildRectChange(__int64 a1)
{
  ...
  if ( !(unsigned int)IsRectEmptyInl(&v26) )
  {
    v8 = *(_QWORD *)(a1 + 16);
    if ( *(_DWORD *)(v8 + 560) > 0x9900u )
      v9 = 0;
    else
      v9 = *(_DWORD *)(v8 + 576);
    v10 = *(_DWORD *)(a1 + 288);
    ...
    v26.left -= v27;
    v26.top -= DWORD1(v27);
    if ( !(unsigned int)IsRectEmptyInl((const struct tagRECT *)(a1 + 128)) )
    {
      v14 = *(_DWORD *)(a1 + 132);
      if ( (int)v4 >= *v12 )
        v4 = (unsigned int)*v12;
