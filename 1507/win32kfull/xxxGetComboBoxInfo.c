/*
 * XREFs of xxxGetComboBoxInfo @ 0x1C011397C
 * Callers:
 ...
 *     unsafe_cast_fnid_or_class_to_PLBWND_COMBOLISTBOX @ 0x1C0113A70 (unsafe_cast_fnid_or_class_to_PLBWND_COMBOLISTBOX.c)
...
LABEL_10:
  ...
  v9 = *(PRKPROCESS **)(*(_QWORD *)(a1 + 16) + 384LL);
  v31 = v9;
