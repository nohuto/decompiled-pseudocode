...
__int64 __fastcall itrp_IP(__int64 a1)
{
  ...
  v4 = qword_1C0323130;
  v5 = qword_1C0323158;
  v6 = SHIDWORD(qword_1C0323170);
  v90 = dword_1C0323180 + 1;
  v64 = dword_1C0323178;
  ...
  {
    if ( SHIDWORD(qword_1C0323170) >= (unsigned __int16)v7[8] || qword_1C0323170 < 0 )
      goto LABEL_163;
    v96 = 0;
  }
  else
  {
    if ( SHIDWORD(qword_1C0323170) >= *(_DWORD *)(qword_1C0323160 + 440) || qword_1C0323170 < 0 )
      goto LABEL_163;
    v96 = 4;
  }
...
LABEL_163:
  ...
  v16 = (unsigned int *)qword_1C0323148;
  v68 = dword_1C032318C;
  v75 = dword_1C0323190;
  if ( (v1 ^ *(_QWORD *)v1 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(v1 + 424)) != *(_QWORD *)(v1 + 432)
    || v90 > (unsigned __int64)((qword_1C0323148 - *(_QWORD *)v1) >> 2) )
  {
  ...
  v65 = InvokeProject(dword_1C0323194, *(_DWORD *)(4LL * v64 + v18) - v20, *(_DWORD *)(4LL * v64 + v19) - v21);
  if ( v65 )
  {
    v22 = v68;
    if ( v68 == 2 )
    {
      ...
      if ( v90 )
      {
        ...
        do
        {
          ...
          {
            if ( (int)v36 >= *(_DWORD *)(qword_1C0323160 + 440) || (int)v36 < 0 )
              goto LABEL_163;
            v67 = 4;
          }
          ...
          if ( word_1C03231D4 && v4 != v83 && *(_BYTE *)(v34 + 333) == 2 && (*(_BYTE *)(v34 + 452) & 2) != 0 )
            AddProportion(v40, v4, v6, v36, v13);
          *(_DWORD *)(*(_QWORD *)v4 + 4 * v36) = CompDiv(v33, v70 * (__int64)(*(_DWORD *)(v78 + 4 * v36) - v76)) + v97;
      ...
      if ( v68 == 3 )
      {
        ...
        if ( v90 )
        {
          ...
          do
          {
            ...
            if ( word_1C03231D4 && v4 != v79 && *(_BYTE *)(v25 + 333) == 2 && (*(_BYTE *)(v25 + 452) & 2) != 0 )
              AddProportion(v31, v4, v6, v27, v13);
            *(_DWORD *)(*(_QWORD *)(v4 + 8) + 4 * v27) = CompDiv(v24, v69 * (__int64)(*(_DWORD *)(v82 + 4 * v27) - v21))
                                                       + v94;
      ...
      else
      {
        ...
        if ( v90 )
        {
          ...
          while ( 1 )
          {
            ...
            {
              if ( (int)v44 >= *(_DWORD *)(qword_1C0323160 + 440) || (int)v44 < 0 )
                goto LABEL_163;
              v71 = 4;
            }
            if ( !(unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND(&LocalGS, v4) )
            ...
            if ( v4 != v85 && word_1C03231D4 && *(_BYTE *)(v87 + 333) == 2 && (*(_BYTE *)(v87 + 452) & 2) != 0 )
              AddProportion(v48, v4, v6, v44, v13);
            v49 = 4 * v44;
            v50 = InvokeProject(v41, *(_DWORD *)(v49 + v78) - v76, *(_DWORD *)(v49 + v82) - v42);
  ...
  else
  {
    ...
    if ( v90 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          if ( (int)v56 >= *(_DWORD *)(qword_1C0323160 + 440) || (int)v56 < 0 )
            goto LABEL_163;
          v72 = 4;
        }
        if ( !(unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND(&LocalGS, v4) )
        ...
        if ( v4 != v88 && word_1C03231D4 && *(_BYTE *)(v86 + 333) == 2 && (*(_BYTE *)(v86 + 452) & 2) != 0 )
          AddProportion(v60, v4, v6, v56, v13);
        v61 = 4 * v56;
        v62 = InvokeProject(v75, *(_DWORD *)(v61 + v78) - v76, *(_DWORD *)(v61 + v82) - v21);
