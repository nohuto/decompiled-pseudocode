/*
 * XREFs of ReadPointerDeviceSettings @ 0x1C003C944
 * Callers:
...
__int64 __fastcall ReadPointerDeviceSettings(int a1, __int64 a2, unsigned __int16 *a3, unsigned int a4)
{
  ...
  if ( !(_DWORD)v6 )
  {
    ...
    v24 = off_1C031B228;
    GetLocalMachineRegistryDWORDValues(v6, L"\\Software\\Microsoft\\Wisp\\Touch", off_1C031B228);
    ...
    *(_DWORD *)(a2 + 52) = v38;
    if ( v13 )
      GetDWORDSettingValues(v39, 0x48u, L"\\Software\\Microsoft\\Wisp\\MultiTouch", 1u);
  ...
  if ( !v8 )
  {
    v41 = off_1C031EF38;
    if ( !gModeMonitor )
      GetDWORDSettingValues(off_1C031EF38, 0x60u, L"\\Software\\Microsoft\\Wisp\\Pen\\SysEventParameters", 7u);
    v42 = *((_DWORD *)v41 + 3);
    if ( v42 == -1 )
      v42 = *((_DWORD *)v41 + 2);
    *(_DWORD *)a2 = v42;
  ...
  if ( v49 == 2 )
  {
    ...
    {
      if ( (int)CreatePredictionSettings(off_1C031B068, a2, a3, a4) < 0 )
      {
        v50 = gPredictionMonitor;
      }
      else
    ...
    {
      v51 = off_1C031B068;
      GetPredictionSettings(off_1C031B068, a2, a3);
      v52 = *((_DWORD *)v51 + 3);
      v53 = 60;
      if ( v52 == -1 )
      {
