/*
 * XREFs of ?DdcciReceiveDataFromMonitorDevice@CPhysicalMonitorHandle@@AEAAJ_JPEAXK@Z @ 0x1C025C0A4
 * Callers:
 ...
 *     ?VerifyDDCCIMessageChecksum@CPhysicalMonitorHandle@@CAJEQEAEK@Z @ 0x1C025C6CC (-VerifyDDCCIMessageChecksum@CPhysicalMonitorHandle@@CAJEQEAEK@Z.c)
 */
