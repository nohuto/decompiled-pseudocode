/*
 * XREFs of KmfdLoadFontFileView @ 0x1C01415E4
 * Callers:
...
__int64 *__fastcall KmfdLoadFontFileView(
        unsigned __int16 *a1,
        unsigned int a2,
...
LABEL_29:
      ...
      {
        a11 = (unsigned int *)v18;
        if ( (*((_DWORD *)v18 + 14) & 0x2000) == 0 || v18 == (struct PDEV *)qword_1C032F1C8 )
          goto LABEL_39;
        PDEVOBJ::vReferencePdev((PDEVOBJ *)&a11);
        EtwTraceGreLockReleaseSemaphore(L"ghsemDriverMgmt", ghsemDriverMgmt);
        GreReleaseSemaphoreInternal(ghsemDriverMgmt);
