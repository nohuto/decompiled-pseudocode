/*
 * XREFs of ?TPAAPOnKeyEvent@@YAXQEAUtagKE@@@Z @ 0x1C0008D54
 * Callers:
...
LABEL_8:
      if ( v2 )
        v10 = ~v9 & dword_1C0322E00;
      else
        v10 = v9 | dword_1C0322E00;
      dword_1C0322E00 = v10;
      if ( (_BYTE)v10 )
      {
        _InterlockedExchange64(&qword_1C0322DF0, 0LL);
        _InterlockedExchange64(&qword_1C0322DF8, 0LL);
      }
      return;
    }
    if ( v8 == 1 )
  ...
  v15 = 0LL;
  if ( !(_BYTE)dword_1C0322E00 && (!v2 || _InterlockedCompareExchange64(&qword_1C0322DF0, 0LL, 0LL)) )
  {
