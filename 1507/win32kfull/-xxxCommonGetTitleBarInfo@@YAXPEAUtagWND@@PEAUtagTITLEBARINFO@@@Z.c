/*
 * XREFs of ?xxxCommonGetTitleBarInfo@@YAXPEAUtagWND@@PEAUtagTITLEBARINFO@@@Z @ 0x1C0093D50
 * Callers:
...
LABEL_68:
  ...
  if ( (unsigned int)IsDPIDWMSysMet(v28)
    ...
    && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL) + 260LL) & 1) != 0 )
  {
    goto LABEL_68;
  }
LABEL_60:
