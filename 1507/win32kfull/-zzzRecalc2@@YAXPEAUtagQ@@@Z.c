/*
 * XREFs of ?zzzRecalc2@@YAXPEAUtagQ@@@Z @ 0x1C0043DB0
 * Callers:
 ...
 *     ?zzzAddAttachment@@YAXPEAUtagTHREADINFO@@PEAUtagQ@@PEAH@Z @ 0x1C0043EA0 (-zzzAddAttachment@@YAXPEAUtagTHREADINFO@@PEAUtagQ@@PEAH@Z.c)
...
void __fastcall zzzRecalc2(struct tagQ *a1)
{
  ...
  do
  {
    ...
    do
    {
      ...
      if ( RecalcPtiFromListEntry && *((struct tagQ **)RecalcPtiFromListEntry + 73) == a1 )
      {
