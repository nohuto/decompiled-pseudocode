/*
 * XREFs of SearchFntCacheNewLink @ 0x1C0159F0C
 * Callers:
 ...
 *     bFntCacheCreateHLink @ 0x1C0159FA0 (bFntCacheCreateHLink.c)
 */
...
unsigned int *__fastcall SearchFntCacheNewLink(unsigned int a1)
{
  ...
  v1 = qword_1C0323DF0;
  v6 = 0LL;
  SearchFNTCacheHlink(a1, (__int64 *)&v6, *(_QWORD *)qword_1C0323DF0);
  v4 = v6;
  if ( !v6 )
  {
