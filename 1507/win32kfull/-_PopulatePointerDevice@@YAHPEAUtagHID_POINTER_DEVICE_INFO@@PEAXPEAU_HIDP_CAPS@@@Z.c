/*
 * XREFs of ?_PopulatePointerDevice@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAXPEAU_HIDP_CAPS@@@Z @ 0x1C01DE340
 * Callers:
        ...
        struct _HIDP_CAPS *a3)
{
  ...
  while ( v10 );
  ValueCaps = (struct _HIDP_VALUE_CAPS *)Win32AllocPool(72LL * ValueCapsLength, 1953067861LL);
  if ( !ValueCaps )
  {
    UserSetLastError(14);
    return 0LL;
  }
  if ( HidP_GetSpecificValueCaps(HidP_Input, 0, *((_WORD *)a1 + 358), 0, ValueCaps, &ValueCapsLength, v3) >= 0 )
  {
    v14 = 0;
    v15 = 0;
    if ( ValueCapsLength )
    {
      do
      {
        ...
        {
          v20 = 60LL * v15;
          *(_WORD *)((char *)a1 + v20 + 320) = v19;
          *(_WORD *)((char *)a1 + v20 + 332) = *(&ValueCaps->Range.UsageMin + 4 * v18);
          *(_DWORD *)((char *)a1 + v20 + 324) = *(&ValueCaps->ReportID + 8 * v18);
          *(_WORD *)((char *)a1 + v20 + 330) = *(&ValueCaps->LinkUsagePage + 4 * v18);
          *(_DWORD *)((char *)a1 + v20 + 336) = *(&ValueCaps->HasNull + 8 * v18);
          *(_DWORD *)((char *)a1 + v20 + 352) = *(&ValueCaps->LogicalMin + 2 * v18);
          *(_DWORD *)((char *)a1 + v20 + 356) = *(&ValueCaps->LogicalMax + 2 * v18);
          *((_DWORD *)a1 + 15 * v15 + 90) = *(&ValueCaps->PhysicalMin + 2 * v18);
          *(_DWORD *)((char *)a1 + v20 + 364) = *(&ValueCaps->PhysicalMax + 2 * v18);
          *(_WORD *)((char *)a1 + v20 + 376) = *(&ValueCaps->BitSize + 4 * v18);
          v21 = 16LL * v15;
          *((_DWORD *)a1 + 4 * v15 + 8) = v15;
          *(_WORD *)((char *)a1 + v21 + 28) = *(&ValueCaps->UsagePage + 4 * v18);
          *(_WORD *)((char *)a1 + v21 + 30) = *(&ValueCaps->Range.UsageMin + 4 * v18);
          v22 = *(_OWORD *)(&ValueCaps->HasNull + 8 * v18);
          v25[0] = *(_OWORD *)(&ValueCaps->UsagePage + 4 * v18);
          v23 = *(_OWORD *)&ValueCaps->Reserved2[4 * v18 + 5];
          v25[1] = v22;
          v24 = *(_OWORD *)(&ValueCaps->PhysicalMin + 2 * v18);
          v25[2] = v23;
          v26 = *((_QWORD *)&ValueCaps->NotRange.DesignatorIndex + v18);
          v25[3] = v24;
