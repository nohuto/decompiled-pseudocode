/*
 * XREFs of ?CreateAndReferenceMsgData@PointerList@@YA_KGKKIH@Z @ 0x1C01FBF3C
 * Callers:
 ...
 * Callees:
 *     ?AssignPointerCaptureData@@YAXPEAUtagINPUTPOINTERNODE@@PEAUtagPOINTERMSGDATA@@@Z @ 0x1C01FBE08 (-AssignPointerCaptureData@@YAXPEAUtagINPUTPOINTERNODE@@PEAUtagPOINTERMSGDATA@@@Z.c)
