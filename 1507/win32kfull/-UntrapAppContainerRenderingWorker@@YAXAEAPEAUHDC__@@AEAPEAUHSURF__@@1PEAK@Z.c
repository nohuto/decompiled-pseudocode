/*
 * XREFs of ?UntrapAppContainerRenderingWorker@@YAXAEAPEAUHDC__@@AEAPEAUHSURF__@@1PEAK@Z @ 0x1C001A0A0
 * Callers:
 *     UntrapAppContainerRenderingWrap @ 0x1C001A090 (UntrapAppContainerRenderingWrap.c)
