/*
 * XREFs of _UserTestForWinStaAccess @ 0x1C00DBB80
 * Callers:
      ...
      if ( v10 )
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          if ( grpWinStaList )
          {
            ...
            {
              v12 = v10[2];
              if ( v12 == *(_DWORD *)(grpWinStaList + 152LL) && v10[3] == *(_DWORD *)(grpWinStaList + 156LL)
            ...
            else if ( v10[2] == *(_DWORD *)(grpWinStaList + 152LL) && v10[3] == *(_DWORD *)(grpWinStaList + 156LL) )
            {
              v8 = 0;
            }
          }
