/*
 * XREFs of ?MulAssociateSharedSurface@@YAHPEAU_SURFOBJ@@PEAX1UtagSIZE@@@Z @ 0x1C0294EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MulAssociateSharedSurface(struct _SURFOBJ *a1, void *a2, void *a3, struct tagSIZE a4)
{
  ...
  v6 = *(unsigned int (__fastcall **)(__int64, void *, void *, struct tagSIZE))(*(_QWORD *)(v5 + 24) + 3488LL);
  if ( v6 )
