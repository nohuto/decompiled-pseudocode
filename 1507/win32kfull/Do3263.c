...
__int64 __fastcall Do3263(_BYTE *a1, unsigned __int8 *a2, unsigned __int8 *a3, unsigned __int8 *a4, int a5)
{
  ...
  for ( i = a5 & 3; v7; --v7 )
  {
    *a1 = (*a2 + 16 + *a4 + 2 * (*a2 + *a4 + 13 * *a3)) >> 5;
    a1[1] = (a2[1] + 16 + a4[1] + 2 * (a2[1] + a4[1] + 13 * a3[1])) >> 5;
    a1[2] = (a2[2] + 16 + a4[2] + 2 * (a2[2] + a4[2] + 13 * a3[2])) >> 5;
    v10 = a4[3];
    a4 += 4;
    v11 = a2[3];
    a2 += 4;
  ...
  if ( (a5 & 3) != 0 )
  {
    ...
    do
    {
      result = (unsigned int)((*a2 + a2[v15] + 2 * (*a2 + a2[v15] + 13 * a2[v14] + 8)) >> 5);
      (a2++)[v16] = result;
      --i;
    }
    while ( i );
