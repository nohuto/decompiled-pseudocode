/*
 * XREFs of CleanupHidRequestList @ 0x1C0132640
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *CleanupHidRequestList()
{
  ...
  while ( 1 )
  {
    result = LODWORD(aDeviceTemplate[154]) ? &RawInputManagerObject::gHidRequestTable[2] : &qword_1C0328800;
    if ( (_QWORD *)*result == result )
      break;
    v4 = qword_1C0328800;
    *((_DWORD *)qword_1C0328800 + 5) = 0;
