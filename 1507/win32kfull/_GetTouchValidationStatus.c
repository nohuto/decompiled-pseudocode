/*
 * XREFs of _GetTouchValidationStatus @ 0x1C01E0650
 * Callers:
...
__int64 __fastcall GetTouchValidationStatus(__int64 a1)
{
  ...
  else
  {
    ...
    while ( v4 )
    {
      if ( *((_BYTE *)v4 + 48) == 2 && (*((_BYTE *)v4 + 64) & 0x40) == 0 && (*((_DWORD *)v4 + 46) & 0x800) == 0 )
      {
        v5 = *((_QWORD *)v4 + 50);
        if ( *(_WORD *)(v5 + 42) == 13 && *(_WORD *)(v5 + 40) == 4 )
        {
          if ( (*(_DWORD *)(*((_QWORD *)v4 + 52) + 236LL) & 0x100) != 0 )
          {
            v1 = 1;
            break;
          }
