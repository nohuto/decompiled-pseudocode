/*
 * XREFs of ?xxxApplyArrangeAction@@YAHPEAUtagWND@@W4_WARR_STATES@@W4_WARR_ACTIONS@@JPEAU_MOVESIZEDATA@@@Z @ 0x1C0206950
 * Callers:
...
__int64 __fastcall xxxApplyArrangeAction(__int64 a1, int a2, int a3, int a4, struct _MOVESIZEDATA *a5)
{
  ...
  v7 = 1;
  *(_OWORD *)v55 = 0LL;
  v8 = a5 && !IsRectEmptyInl((const struct tagRECT *)a5 + 14);
  if ( !a3 )
  {
    v48 = 2;
...
LABEL_35:
                if ( a2 == 1 )
                {
                  *((_DWORD *)a5 + 40) = 3;
                  ...
                  v24 = *(_DWORD *)(a1 + 344);
                  if ( v24
                    || (v19 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 416LL) + 8LL) + 260LL),
                        (v19 & 1) == 0) )
                  {
                    if ( v24 == 1
                      && (v19 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 416LL) + 8LL) + 260LL),
  ...
  do
  {
    ...
    {
      v34 = *(_DWORD *)(a1 + 344);
      if ( v34 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 416LL) + 8LL) + 260LL) & 1) == 0 )
      {
        if ( v34 != 1
          || (v35 = (_OWORD *)(v33 + 108),
  ...
  {
    v43 = *(_DWORD *)(a1 + 344);
    if ( v43 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 416LL) + 8LL) + 260LL) & 1) == 0 )
    {
      if ( v43 != 1
        || (v44 = v39 + 108, (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 416LL) + 8LL) + 260LL) & 1) == 0) )
      {
        v44 = v39 + 76;
      }
    }
