/*
 * XREFs of fnHkINLPCWPEXSTRUCT @ 0x1C00690C0
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      ...
      else
      {
        if ( (*(_DWORD *)(v12 + 64) & 1) != 0 )
          goto LABEL_9;
        v12 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 8LL * *(int *)(v12 + 48) + 40);
      }
      if ( !v12 )
        goto LABEL_9;
    }
...
LABEL_9:
  ...
  while ( 1 )
  {
    ...
    if ( (*(_DWORD *)(v13 + 64) & 1) != 0 )
      break;
    v13 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 8LL * *(int *)(v13 + 48) + 40);
LABEL_14:
