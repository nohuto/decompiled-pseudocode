/*
 * XREFs of SfnINSTRINGNULL @ 0x1C0059F90
 * Callers:
        ...
        char a7)
{
  ...
  _BYTE v37[24]; // [rsp+88h] [rbp-2B0h] BYREF
  ...
  if ( v11 )
  {
    result = (unsigned __int8 *)AllocCallbackMessage(0x58u, v11, (unsigned int)v12, v39, 1, 0x200uLL);
    v9 = result;
    v31 = result;
    if ( !result )
      return result;
...
LABEL_33:
  ...
  *((_QWORD *)v9 + 2) = 0LL;
  v24 = KeUserModeCallback(27LL, v9, *(unsigned int *)v9, v34, &v32);
