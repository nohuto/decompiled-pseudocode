/*
 * XREFs of RotationRequired @ 0x1C01D0AD0
 * Callers:
...
_BOOL8 __fastcall RotationRequired(__int64 a1, unsigned int *a2)
{
  ...
  if ( dword_1C0323048 )
  {
    if ( (v7 & 0xBFFFFFFF) != 0 )
    {
      ...
      {
        v8 = dword_1C0323034;
        if ( !(_DWORD)a1 || _bittest((const int *)&a1, ((_BYTE)dword_1C0323034 + 1) & 3) )
          goto LABEL_39;
LABEL_16:
        if ( (a1 & 2) == 0 )
        {
  ...
  else if ( (v7 & 0xBFFFFFFF) != 0 )
  {
    ...
    {
      v8 = dword_1C0323034;
      if ( !(_DWORD)a1 || _bittest((const int *)&a1, dword_1C0323034) )
        goto LABEL_39;
    }
    else
    {
