/*
 * XREFs of ?DxLddmSharedPrimaryUnLockNotification@@YAJU_LUID@@I@Z @ 0x1C02637B4
 * Callers:
 *     NtGdiDdDDISharedPrimaryUnLockNotification @ 0x1C0265150 (NtGdiDdDDISharedPrimaryUnLockNotification.c)
 * Callees:
...
__int64 __fastcall DxLddmSharedPrimaryUnLockNotification(struct _LUID a1, int a2)
{
  ...
  if ( v4 )
  {
    ...
    v15 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 8LL) + 16LL);
