/*
 * XREFs of GetInheritedMonitor @ 0x1C005C590
 * Callers:
 ...
 *     ?IsAdjacentRect@@YAHPEBUtagRECT@@0@Z @ 0x1C0115C30 (-IsAdjacentRect@@YAHPEBUtagRECT@@0@Z.c)
...
__int64 __fastcall GetInheritedMonitor(struct tagWND *a1)
{
  ...
  if ( i || (i = *(_QWORD *)(v23 + 8)) != 0 )
    i &= -(__int64)((unsigned int)IntersectRect(v30, (char *)a1 + 112, i + 112) != 0);
  if ( *((_DWORD *)a1 + 86) != 1 || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 384LL) + 776LL) & 0x4000) == 0 )
  {
LABEL_14:
    if ( i )
    {
      ...
      do
      {
        if ( v9 )
        {
          ...
          if ( (*(_BYTE *)(v9 + 55) & 0x10) != 0
            ...
            && !(unsigned int)IsRectEmptyInl((const struct tagRECT *)(v9 + 128))
            && ((*(_BYTE *)(v9 + 50) & 8) == 0 || (*(_BYTE *)(v9 + 51) & 0x20) != 0)
            && (*(_QWORD *)(v16 + 392) == *(_QWORD *)(v15 + 392) || *(_QWORD *)(v16 + 384) == *(_QWORD *)(v15 + 384))
            && (unsigned int)SameCoordinateSpace(*(_QWORD *)(v16 + 384), *(_QWORD *)(v15 + 384)) )
          {
            if ( !v11 && !v12 )
              goto LABEL_34;
            ...
            v26 = v25;
            if ( !v11 || v25 || (unsigned int)IntersectRect(v31, (char *)a1 + 112, v9 + 112) )
            {
              if ( !v28 || v26 )
                goto LABEL_34;
...
LABEL_34:
      ...
      if ( (*(_BYTE *)(j + 55) & 0x10) != 0
        ...
        && !(unsigned int)IsRectEmptyInl((const struct tagRECT *)(j + 128))
        && ((*(_BYTE *)(j + 50) & 8) == 0 || (*(_BYTE *)(j + 51) & 0x20) != 0)
        && (*(_QWORD *)(v18 + 392) == *(_QWORD *)(v17 + 392) || *(_QWORD *)(v18 + 384) == *(_QWORD *)(v17 + 384)) )
      {
        if ( (unsigned int)SameCoordinateSpace(*(_QWORD *)(v18 + 384), *(_QWORD *)(v17 + 384)) )
        {
          if ( !v13 && !v14 )
            break;
          ...
          v21 = v20;
          if ( !v13 || v20 || (unsigned int)IntersectRect(v30, (char *)a1 + 112, j + 112) )
          {
            if ( !v29 || v21 )
              break;
