/*
 * XREFs of ?InternalSpritesCollision@@YAHPEAUHDEV__@@PEAUHWND__@@PEAUHRGN__@@@Z @ 0x1C02639A0
 * Callers:
 *     DxgkEngDetectGDIPath @ 0x1C0264B10 (DxgkEngDetectGDIPath.c)
 * Callees:
            ...
            if ( v13 )
            {
                     ...
                     *((_DWORD *)a1 + 39)) )
              {
                ...
                *(_QWORD *)&prcl.left = *((_QWORD *)a1 + 100);
                if ( v25[0] && v24[0] )
                  v21 = RGNOBJAPI::iCombine((RGNOBJAPI *)v25, (struct RGNOBJ *)v24, (struct RGNOBJ *)&prcl, 4);
                RGNOBJAPI::~RGNOBJAPI((RGNOBJAPI *)v24);
