/*
 * XREFs of PlaySoundPostMessage @ 0x1C0363000
 * Callers:
 *     PostPlaySoundMessage @ 0x1C00EBE50 (PostPlaySoundMessage.c)
 * Callees:
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00E7E30 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 *     I_PlaySoundkPostMessage @ 0x1C00EBE78 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00EBEC0 (PlaySndClient_midl_user_allocate.c)
 */
