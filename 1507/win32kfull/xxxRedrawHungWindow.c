/*
 * XREFs of xxxRedrawHungWindow @ 0x1C0124828
 * Callers:
...
LABEL_10:
      ...
      *(_QWORD *)(gptiCurrent + 376LL) = v32;
      ...
      if ( gihmodUserApiHook < 0 )
      {
        ...
        v9 = DCEx;
        v10 = (*((_BYTE *)a1 + 40) & 0x40) != 0 && *(_QWORD *)(*((_QWORD *)a1 + 2) + 392LL) == gpqForeground;
        xxxDrawWindowFrame((__int64)a1, DCEx, v10 | 0x2000);
        _ReleaseDC(v9);
      }
      xxxInternalInvalidate(a1, (HRGN)v7, 0x485u);
      v34 = (RECT)*((_OWORD *)a1 + 7);
      xxxCalcClientRect((__int64)a1, &v34, 1);
...
LABEL_42:
            ...
            if ( a1 == *(struct tagWND **)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 8LL) + 176LL) )
            {
              ...
              *(_QWORD *)(gptiCurrent + 376LL) = v31;
              ...
              xxxInternalPaintDesktop(DesktopWindow, v15, 1LL);
