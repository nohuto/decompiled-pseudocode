/*
 * XREFs of ?InitiateWin32kCleanup@@YAHXZ @ 0x1C012C708
 * Callers:
 ...
 *     ?SetWaitForWinstaRundown@@YAXXZ @ 0x1C012CCE0 (-SetWaitForWinstaRundown@@YAXXZ.c)
...
__int64 InitiateWin32kCleanup(void)
{
  ...
  gbInSMSCleanup = 0;
  while ( qword_1C03253E8 != (struct tagPOINTERHOLDINGFRAME *)&qword_1C03253E8 )
    UnlinkAndFreeHoldingFrame(qword_1C03253E8);
  if ( qword_1C032CA38 )
  {
  ...
  v5 = (__int64 *)qword_1C03253D8;
  while ( v5 != &qword_1C03253D8 )
  {
  ...
  while ( v8 );
  EmptyMousePromotionQueue((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0322CA0);
  v9 = (struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C0322C30;
  v10 = 5LL;
  do
  {
  ...
  result = 1LL;
  *(_DWORD *)(gptiCurrent + 448LL) &= ~0x800u;
