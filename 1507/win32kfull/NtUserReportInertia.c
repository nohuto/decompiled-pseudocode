/*
 * XREFs of NtUserReportInertia @ 0x1C0009820
 * Callers:
 *     <none>
 * Callees:
 *     InvalidateInertiaInfo @ 0x1C00098D0 (InvalidateInertiaInfo.c)
    ...
    if ( a4 )
    {
        ...
        && (gptiCurrent == *(_QWORD *)(v10 + 16) || gptiCurrent == *(_QWORD *)(v10 + 312)) )
      {
        if ( (unsigned int)((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24)
           - *(_DWORD *)(gptiCurrent + 1128LL) > 0x7D0 )
        {
          v15 = 5LL;
          goto LABEL_12;
        }
        v16 = (*(_DWORD *)(gptiCurrent + 1080LL) >> 17) & 1;
