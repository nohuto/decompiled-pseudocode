/*
 * XREFs of ?SpDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C026E100
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
  ...
  struct _POINTL v17; // [rsp+70h] [rbp-90h] BYREF
  ...
  else
  {
    ...
    while ( (unsigned int)ENUMUNDERLAYS::bEnum(v22, &v15, &v17, &v16) )
    {
      v13 = 0LL;
      v18 = 0LL;
      if ( v15
