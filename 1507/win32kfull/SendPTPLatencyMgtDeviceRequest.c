/*
 * XREFs of SendPTPLatencyMgtDeviceRequest @ 0x1C01D3B98
 * Callers:
...
__int64 __fastcall SendPTPLatencyMgtDeviceRequest(struct _UNICODE_STRING *a1, __int64 a2, int a3)
{
  ...
  *(_DWORD *)UsageList = a3;
  ...
  if ( !KernelEvent )
    return 3221225628LL;
  DeviceObjectPointer = GetDeviceObjectPointer(a1 + 13, 0, 3u, &Handle, (PVOID *)UsageLength, &DeviceObject);
