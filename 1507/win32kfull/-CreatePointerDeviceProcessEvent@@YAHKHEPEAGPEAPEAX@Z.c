/*
 * XREFs of ?CreatePointerDeviceProcessEvent@@YAHKHEPEAGPEAPEAX@Z @ 0x1C014651C
 * Callers:
 *     CreatePointerDeviceProcessEvents @ 0x1C01464C8 (CreatePointerDeviceProcessEvents.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C01467E8 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
        ...
        void **a5)
{
  ...
  struct _SID_IDENTIFIER_AUTHORITY v26; // [rsp+88h] [rbp-78h] BYREF
  struct _SID_IDENTIFIER_AUTHORITY IdentifierAuthority; // [rsp+90h] [rbp-70h] BYREF
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( v14 )
    {
      *RtlSubAuthoritySid(v14, 0) = 0;
      v11 = RtlInitializeSid(v15, &v26, 1u);
    }
    if ( v11 >= 0 )
    {
