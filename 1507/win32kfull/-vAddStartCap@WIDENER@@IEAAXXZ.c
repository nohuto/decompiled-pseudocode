/*
 * XREFs of ?vAddStartCap@WIDENER@@IEAAXXZ @ 0x1C02C84B4
 * Callers:
 ...
 *     ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C02C8368 (-vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z.c)
...
void __fastcall WIDENER::vAddStartCap(WIDENER *this)
{
  ...
  else
  {
    if ( (*((_DWORD *)this + 10) & 0x10) != 0 )
      v16 = WIDENER::vecOutDraw(this, &v17);
    else
