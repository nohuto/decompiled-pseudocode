...
__int64 __fastcall itrp_IUP(__int64 a1, char a2)
{
  ...
  v4 = qword_1C0323130;
  v87 = qword_1C0323130;
  v5 = *(_BYTE *)(qword_1C0323160 + 333);
  if ( v5 == 2 )
  {
    v6 = qword_1C0323158;
    v77 = qword_1C0323158;
    if ( qword_1C0323130 != qword_1C0323158 )
    {
      v7 = *(_WORD *)(qword_1C0323160 + 452);
      if ( (v7 & 3) == 3 && (v7 & 4) != (v3 & 1) && !*(_DWORD *)(qword_1C0323130 + 96) )
      {
        ExecutePhaseControl(&LocalGS, qword_1C0323130);
        v6 = qword_1C0323158;
        v2 = qword_1C0323160;
        v4 = v87;
        v3 = a2;
  ...
  else if ( v5 || (v6 = qword_1C0323158, v77 = qword_1C0323158, qword_1C0323158 != qword_1C0323130) )
  {
