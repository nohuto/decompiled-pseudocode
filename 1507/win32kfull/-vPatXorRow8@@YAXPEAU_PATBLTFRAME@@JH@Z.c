/*
 * XREFs of ?vPatXorRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02C0110
 * Callers:
 *     <none>
 * Callees:
 *     vFetchAndMerge @ 0x1C00F32D0 (vFetchAndMerge.c)
 *     vFetchShiftAndMerge @ 0x1C02D1F18 (vFetchShiftAndMerge.c)
 */
...
void __fastcall vPatXorRow8(struct _PATBLTFRAME *a1, int a2, int a3)
{
  ...
  if ( a3 )
  {
    do
    {
      ...
      {
        v19 = v14;
        *(_DWORD *)(v10 + v6) ^= v12 & v23 & *(_DWORD *)(v14 + v9);
      }
      else
      {
        ...
        {
          v19 = v14;
          *(_DWORD *)(v10 + v6) ^= v12 & *(_DWORD *)(v14 + v9);
          LODWORD(v10) = v10 + 4;
          v14 += 4;
        }
        ...
        if ( v24 )
          *(_DWORD *)(v11 + v6) ^= v23 & *(_DWORD *)(((int)v14 + 4 * (unsigned __int64)v15) % *((unsigned int *)a1 + 10)
                                                   + v9);
      }
      if ( ++v8 == *((_DWORD *)a1 + 11) )
      {
