/*
 * XREFs of ?AllocatePagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_KIII@Z @ 0x1C014F974
 * Callers:
 *     Win32AllocPagedLookasideListImpl @ 0x1C014F8F0 (Win32AllocPagedLookasideListImpl.c)
 * Callees:
