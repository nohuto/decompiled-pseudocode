/*
 * XREFs of ?DdcciGetVCPFeature@CMonitorAPI@@QEAAJPEAXKPEAW4_MC_VCP_CODE_TYPE@@PEAK2@Z @ 0x1C025BED0
 * Callers:
 *     NtGdiDDCCIGetVCPFeature @ 0x1C025C890 (NtGdiDDCCIGetVCPFeature.c)
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  v13 = this;
  v6 = qword_1C03234C0;
  CAutoMutex::CAutoMutex((CAutoMutex *)v12, (struct CMutex *)qword_1C03234C0);
