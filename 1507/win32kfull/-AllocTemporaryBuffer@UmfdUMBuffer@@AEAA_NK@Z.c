/*
 * XREFs of ?AllocTemporaryBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1C02D5C2C
 * Callers:
 *     ?CommitBuffer@UmfdUMBuffer@@QEAAPEAXK@Z @ 0x1C02D5D20 (-CommitBuffer@UmfdUMBuffer@@QEAAPEAXK@Z.c)
 * Callees:
 *     ?AlignSizeTo@UmfdUMBuffer@@CA_NKKPEAK@Z @ 0x1C02D5C10 (-AlignSizeTo@UmfdUMBuffer@@CA_NKKPEAK@Z.c)
 */
