/*
 * XREFs of ?xxxSendMenuDrawItemMessage@@YAXPEAUHDC__@@IPEAUtagMENU@@PEAUtagITEM@@HHPEAUtagWND@@@Z @ 0x1C0051984
 * Callers:
 ...
 *     ?MNInitDrawItemStruct@@YAXPEAUHDC__@@IPEAUtagMENU@@PEAUtagITEM@@HHPEAUtagDRAWITEMSTRUCT@@@Z @ 0x1C0051B5C (-MNInitDrawItemStruct@@YAXPEAUHDC__@@IPEAUtagMENU@@PEAUtagITEM@@HHPEAUtagDRAWITEMSTRUCT@@@Z.c)
        ...
        struct tagWND *a7)
{
  ...
  if ( v14 && ((*(_DWORD *)a4 & 0x100) != 0 || *((_QWORD *)a4 + 13) == -1LL) )
  {
    ...
    *(_QWORD *)(gptiCurrent + 376LL) = &v19;
    ...
    ++*(_DWORD *)(v14 + 8);
    xxxSendMessage(*((_QWORD *)a3 + 9), 43LL, 0LL);
