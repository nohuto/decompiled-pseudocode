/*
 * XREFs of ?xxxDWP_DoCancelMode@@YAXPEAUtagWND@@@Z @ 0x1C00FABEC
 * Callers:
...
void __fastcall xxxDWP_DoCancelMode(struct tagWND *a1)
{
  ...
  v2 = *(struct tagWND **)(*(_QWORD *)(gptiCurrent + 392LL) + 64LL);
  v3 = *(_QWORD *)(*((_QWORD *)a1 + 2) + 536LL);
  if ( v3 )
  {
