/*
 * XREFs of _GetClientRect @ 0x1C00E5834
 * Callers:
...
LABEL_67:
        ...
        goto LABEL_9;
           ...
           && (*(_DWORD *)(PsGetCurrentProcessWin32Process(v7) + 776) & 0x4000) == 0 )
    {
      v7 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
...
LABEL_75:
        ...
        goto LABEL_14;
           ...
           && (*(_DWORD *)(PsGetCurrentProcessWin32Process(v10) + 776) & 0x4000) == 0 )
    {
      v10 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416)
         && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 416) + 8LL)
                      + 260LL) & 1;
      if ( v10 )
        goto LABEL_75;
