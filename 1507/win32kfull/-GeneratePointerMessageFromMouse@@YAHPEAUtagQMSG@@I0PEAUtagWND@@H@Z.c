/*
 * XREFs of ?GeneratePointerMessageFromMouse@@YAHPEAUtagQMSG@@I0PEAUtagWND@@H@Z @ 0x1C0006310
 * Callers:
        ...
        int a5)
{
  ...
  if ( !*(_QWORD *)(gptiCurrent + 1120LL) )
  {
    v27 = Win32AllocPoolZInit(128LL, 1347253077LL);
    if ( !v27 )
      goto LABEL_31;
    *(_QWORD *)(gptiCurrent + 1120LL) = v27;
  }
  if ( a5 )
  {
    v9 = *(_DWORD **)(gptiCurrent + 1120LL);
    if ( (*v9 & 0x10) != 0 )
    {
      *v9 &= ~0x10u;
      **(_DWORD **)(gptiCurrent + 1120LL) &= ~4u;
    }
  }
  if ( (unsigned int)IsMiPMouseMessage(*((_DWORD *)a3 + 6)) )
  {
    ...
    *(_DWORD *)&v30[12] = GetPointerFlagsFromMouse(
    ...
    if ( *(_DWORD *)&v30[12] )
    {
      if ( (**(_DWORD **)(gptiCurrent + 1120LL) & 4) == 0 )
      {
      ...
      *(_OWORD *)(v18 + 88) = v22;
      *(_OWORD *)(v18 + 104) = v23;
      **(_DWORD **)(gptiCurrent + 1120LL) |= 1u;
      if ( a5 )
      {
        if ( ((*v14 - 579) & 0xFFFFFFFB) == 0 )
        {
          v26 = *(_DWORD **)(gptiCurrent + 1120LL);
          if ( (*v26 & 4) != 0 )
          {
            *v26 |= 0x10u;
            **(_DWORD **)(gptiCurrent + 1120LL) &= ~2u;
          }
        }
      }
      v24 = *v14;
      ...
      {
        *(_QWORD *)(*(_QWORD *)(gptiCurrent + 1120LL) + 120LL) = *((_QWORD *)a1 + 5);
