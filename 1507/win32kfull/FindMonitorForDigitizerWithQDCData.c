/*
 * XREFs of FindMonitorForDigitizerWithQDCData @ 0x1C01CA400
 * Callers:
        ...
        int *a4)
{
  ...
  do
  {
    ...
    if ( (int)DrvDisplayConfigGetDeviceInfo(v61) >= 0 && v64[0] )
    {
      ...
      do
      {
        v18 = *(unsigned __int16 *)((char *)v17
                                  + (struct tagHID_POINTER_DEVICE_INFO *)((char *)a1 + 1144)
      ...
      do
      {
        v21 = *(unsigned __int16 *)((char *)v20
                                  + (struct tagHID_POINTER_DEVICE_INFO *)((char *)a1 + 888)
                                  - (struct tagHID_POINTER_DEVICE_INFO *)v64);
        v22 = *v20 - v21;
        if ( v22 )
          break;
    ...
    v23 = *(_QWORD *)((char *)a1 + 244) - v59;
    if ( !v23 )
      v23 = *(_QWORD *)((char *)a1 + 252) - v60;
    if ( v23 )
    {
      v14 = v46;
LABEL_26:
    ...
    v24 = v56 - *(_QWORD *)((char *)a1 + 244);
    if ( v56 == *(_QWORD *)((char *)a1 + 244) )
      v24 = v56 - *(_QWORD *)((char *)a1 + 252);
    v14 = v46;
    if ( !v24 )
      goto LABEL_26;
    v14 = ++v46;
