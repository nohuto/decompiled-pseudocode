/*
 * XREFs of ?FindOrCreateHoldingFrameForDevice@@YAPEAUtagPOINTERHOLDINGFRAME@@PEAX@Z @ 0x1C022F2E0
 * Callers:
  ...
  if ( !result )
  {
    ...
    if ( v3 )
    {
      *(_QWORD *)(v3 + 16) = a1;
      ...
      v6 = qword_1C03253E8;
      *(_QWORD *)v4 = qword_1C03253E8;
      *(_QWORD *)(v4 + 8) = &qword_1C03253E8;
      if ( *((struct tagPOINTERHOLDINGFRAME ***)v6 + 1) != &qword_1C03253E8 )
        __fastfail(3u);
      *((_QWORD *)v6 + 1) = v4;
      qword_1C03253E8 = (struct tagPOINTERHOLDINGFRAME *)v4;
    }
