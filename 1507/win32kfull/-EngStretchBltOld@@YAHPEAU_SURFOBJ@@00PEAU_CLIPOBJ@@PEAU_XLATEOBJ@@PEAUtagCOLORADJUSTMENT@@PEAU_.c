/*
 * XREFs of ?EngStretchBltOld@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAH@Z @ 0x1C028040C
 * Callers:
...
LABEL_190:
          ...
          *v128 = 1;
          ...
          v146[1] = qword_1C02E4290[LODWORD(v111[1].dhpdev)];
          if ( v96 )
            *(_DWORD *)&v77->caColorfulness = (v92 != 1) - 1;
          pso = (SURFOBJ *)qword_1C02E42F0[3 * *(unsigned int *)(*(_QWORD *)&v17 + 96LL) - 1 + v92];
          v126 = pso;
          ...
          {
            v83 = (HSURF)AllocFreeTmpBuffer(v81);
            hsurf = v83;
            if ( v83 )
            {
              v84 = *(_QWORD *)(*(_QWORD *)&v17 + 80LL) + *(_DWORD *)(*(_QWORD *)&v17 + 88LL) * v149.top;
              v115 = v84;
              if ( v112 )
              {
                LODWORD(v128) = v149.left + *(_DWORD *)v123[0] - **(_DWORD **)&v122.left;
                v82 = (unsigned int)(*(_DWORD *)(v125 + 88)
                                   * (v149.top + *((_DWORD *)v123[0] + 1) - *(_DWORD *)(*(_QWORD *)&v122.left + 4LL)));
                v85 = (struct _SURFOBJ *)(*(_QWORD *)(v125 + 80) + (int)v82);
              }
              else
              {
                v85 = 0LL;
              ...
              if ( v96 )
              {
                ...
                if ( v92 == 1 )
                  v87 = -1;
                v101 = v87;
                vInitBuffer((struct _STRRUN *)v83, &v151, v87);
                v86 = v96;
              }
              *(_DWORD *)v83 = *(_DWORD *)(HSURF)&v77->caIlluminantIndex;
              v88 = (unsigned int)v149.top;
              for ( i = 0LL; ; i = (unsigned int)(i + 1) )
              {
                v95 = i;
                v93 = v88;
                if ( (int)v88 >= v149.bottom )
                  break;
                v82 = *(unsigned int *)(*(_QWORD *)&v77[1].caSize + 4LL * (int)i);
                *((_DWORD *)v83 + 1) = v82;
                if ( (_DWORD)v82 )
                {
                  _guard_dispatch_icall_fptr();
                  ...
                  if ( v96 )
                  {
                    vInitBuffer((struct _STRRUN *)v83, &v151, v101);
                    LODWORD(v88) = v93;
                    v86 = v96;
                  }
                  LODWORD(i) = v95;
                ...
                *(_DWORD *)v83 += *((_DWORD *)v83 + 1);
                if ( v85 )
                {
                  v85 = (struct _SURFOBJ *)((char *)v85 + *(int *)(v125 + 88));
                  v112 = v85;
                }
                v88 = (unsigned int)(v88 + 1);
              }
              FreeTmpBuffer(v83, v82, v88, i);
              Win32FreePool(v77);
              v75 = v151.bottom;
              v73 = v151.right;
              v74 = v151.top;
