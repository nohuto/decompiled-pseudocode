/*
 * XREFs of itrp_IDEF @ 0x1C02DCC90
 * Callers:
 *     <none>
 * Callees:
 *     itrp_FindIDef @ 0x1C02DCC60 (itrp_FindIDef.c)
 *     itrp_SkipPushData @ 0x1C02DDA04 (itrp_SkipPushData.c)
 */
...
unsigned __int64 __fastcall itrp_IDEF(__int16 a1)
{
  ...
  v1 = *(unsigned __int8 *)(qword_1C0323160 + 333);
  if ( *(unsigned __int8 *)(qword_1C0323160 + 333) < 2u )
  {
    v3 = *(_QWORD *)(qword_1C0323160 + 16 * v1 + 200);
    ...
    v4 = (int *)(qword_1C0323148 - 4);
    qword_1C0323148 = (__int64)v4;
    v5 = *v4;
    if ( (*v4 & 0xFFFFFF00) != 0 )
    {
      dword_1C03231B0 = 4375;
      return qword_1C03231B8;
    }
    ...
    *(_DWORD *)IDef = (_DWORD)v7 - v3;
    ...
    if ( (unsigned __int64)v7 >= qword_1C03231C0 )
    {
      v13 = v7 + 1;
      if ( (unsigned __int64)(v7 + 1) <= qword_1C03231B8 && v13 >= v7 )
      {
        v14 = 45;
        while ( *v7 != v14 )
        {
