/*
 * XREFs of ?PostRawMouseInput@@YAHPEAUtagQ@@KPEAXPEAU_MOUSE_INPUT_DATA@@@Z @ 0x1C004B55C
 * Callers:
...
__int64 __fastcall PostRawMouseInput(struct tagQ *a1, int a2, void *a3, struct _MOUSE_INPUT_DATA *a4)
{
  ...
  if ( a1 )
  {
    ...
    if ( v10 )
      ...
      v11 = *((_QWORD *)a1 + 6);
    v12 = *(_QWORD *)(*(_QWORD *)(v11 + 384) + 784LL);
  }
  else
  {
    v12 = 0LL;
  ...
  if ( v29 )
    ...
    v30 = *((_QWORD *)v7 + 6);
  v31 = *(_QWORD *)(*(_QWORD *)(v30 + 384) + 784LL);
  v32 = *(_QWORD *)(v31 + 64);
  if ( v32 )
    v7 = *(struct tagQ **)(*(_QWORD *)(v32 + 16) + 392LL);
      ...
      if ( v16 != &RawInputManagerObject::gHidRequestTable[4] )
      {
        while ( 1 )
        {
          ...
          if ( !gbEnforceUIPI
            ...
            || (_DWORD)v24 == v14 && ((v25 = HIDWORD(v24), (_DWORD)v25 == v15) || (_DWORD)v25 == -1 || v15 == -1)
            || *(int *)(v23 + 12) < 0 )
          {
    ...
    while ( 1 )
    {
        ...
        || *(int *)(v43 + 12) < 0 )
      {
        ...
        *(_DWORD *)(v46 + 76) = a4->ExtraInformation;
        if ( !(unsigned int)PostInputMessage(
                              *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v35 + 8) + 16LL) + 392LL),
                              *((_QWORD *)v35 + 8),
                              255LL,
                              1LL,
                              v48,
...
LABEL_78:
      ...
      if ( v35 == (struct tagPROCESS_HID_TABLE *)&qword_1C0328810 )
        goto LABEL_17;
    }
  }
  return 0LL;
