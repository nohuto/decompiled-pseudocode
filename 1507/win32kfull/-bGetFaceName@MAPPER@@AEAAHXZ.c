/*
 * XREFs of ?bGetFaceName@MAPPER@@AEAAHXZ @ 0x1C0028E7C
 * Callers:
 ...
 *     ?FindFaceName@@YAPEAGK@Z @ 0x1C00E5C50 (-FindFaceName@@YAPEAGK@Z.c)
 */
...
__int64 __fastcall MAPPER::bGetFaceName(MAPPER *this)
{
  ...
  *((_DWORD *)this + 63) |= 0x20000u;
  ...
  FaceName = FindFaceName(v4 | 0x1000);
  if ( (unsigned int)MAPPER::bFindBitmapFont(this, FaceName)
    || (FaceName = FindFaceName(v4 | 0x800), (unsigned int)MAPPER::bFindBitmapFont(this, FaceName)) )
  {
