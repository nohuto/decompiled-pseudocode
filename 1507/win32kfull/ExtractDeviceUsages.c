/*
 * XREFs of ExtractDeviceUsages @ 0x1C01C995C
 * Callers:
 ...
 *     ?ExtractGeometryPoints@@YAXGPEAUtagHPD_CONTACT_GEOMETRY@@PEAJPEAEK@Z @ 0x1C01C4798 (-ExtractGeometryPoints@@YAXGPEAUtagHPD_CONTACT_GEOMETRY@@PEAJPEAEK@Z.c)
 ...
 *     ?InsertInPointerDeviceFrameContactIdMgr@@YAHKPEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01C56F0 (-InsertInPointerDeviceFrameContactIdMgr@@YAHKPEAUtagHID_POINTER_DEVICE_INFO@@@Z.c)
 ...
 *     ExtractData @ 0x1C01C98A4 (ExtractData.c)
  ...
  if ( *(_DWORD *)(v13 + 712) )
  {
    ...
    if ( UsageValueArray >= 0 )
    {
      ...
      if ( UsageValueArray >= 0 )
      {
        ...
        if ( v46 != 1 || (*(_DWORD *)(v13 + 236) & 0x20) != 0 )
        {
