/*
 * XREFs of ?vGradientFill16_565@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02CB470
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vGradientFill16_565(struct SURFACE *a1, struct _TRIANGLEDATA *a2)
{
  ...
  if ( v2 < v10 )
  {
    ...
    do
    {
      ...
      v18 = *((_QWORD *)v3 + 3);
      v19 = *((_QWORD *)v3 + 2);
      v40 = 0x1C0000000LL + 16LL * (v13 & 3) + 3282080;
      if ( *((_DWORD *)v3 + 1) < v14 )
        v14 = *((_DWORD *)v3 + 1);
      v20 = *((_QWORD *)v3 + 1);
      if ( v15 > v16 )
      ...
      if ( *((_QWORD *)v6 + 9) <= (unsigned __int64)(v7 + v17) && v17 < v14 )
      {
        ...
        if ( v24 )
        {
          ...
          do
          {
            ...
            v31 = HIDWORD(v19);
            v19 += v38;
            v32 = Saturation16_6[(unsigned __int64)(v28 + ((unsigned int)v31 >> 10)) >> 16] | (unsigned __int16)(v30 << 6);
            v33 = HIDWORD(v18);
            v18 += v37;
