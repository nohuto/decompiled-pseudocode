/*
 * XREFs of GreSetPointer @ 0x1C00913EC
 * Callers:
...
void __fastcall GreSetPointer(HDEV a1, struct _CURSINFO *a2, unsigned int a3, unsigned int a4, unsigned int a5)
{
  ...
  if ( a2 )
  {
    xmmword_1C0322858 = *(_OWORD *)a2;
    xmmword_1C0322868 = *((_OWORD *)a2 + 1);
    xmmword_1C0322878 = *((_OWORD *)a2 + 2);
    qword_1C0322888 = *((_QWORD *)a2 + 6);
  }
  else
  {
    memset(&xmmword_1C0322858, 0, 0x38uLL);
  }
  v13 = a5;
  dword_1C0322898 = a5;
  dword_1C0322890 = a3;
