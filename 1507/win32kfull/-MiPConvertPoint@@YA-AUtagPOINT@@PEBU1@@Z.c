/*
 * XREFs of ?MiPConvertPoint@@YA?AUtagPOINT@@PEBU1@@Z @ 0x1C00065DC
 * Callers:
    ...
    if ( (unsigned int)IsDPIAbsoluteSysMet(78LL) )
    {
        ...
        || (*(_DWORD *)(PsGetCurrentProcessWin32Process() + 776) & 0x4000) != 0 )
      {
        goto LABEL_7;
           ...
           || (*(_DWORD *)(PsGetCurrentProcessWin32Process() + 776) & 0x4000) != 0
           || (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
             ? (v5 = 0)
             : (v5 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL)
                               + 260LL) & 1),
               !v5) )
    {
LABEL_7:
      if ( (unsigned int)IsDPIDWMSysMet(78LL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
          ? (v4 = 0)
          : (v4 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL) + 260LL) & 1),
            v4) )
      {
        v6 = (INT *)(gpsi + 2968LL);
      }
      ...
      if ( (unsigned int)IsDPIAbsoluteSysMet(76LL) )
      {
          ...
          || (*(_DWORD *)(PsGetCurrentProcessWin32Process() + 776) & 0x4000) != 0 )
        {
          goto LABEL_26;
             ...
             || (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
               ? (v9 = 0)
               : (v9 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL)
                                 + 260LL) & 1),
                 !v9) )
      {
LABEL_26:
        if ( (unsigned int)IsDPIDWMSysMet(76LL)
          ...
          && (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
            ? (v8 = 0)
            : (v8 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL)
                              + 260LL) & 1),
              v8) )
        {
        ...
        if ( (unsigned int)IsDPIAbsoluteSysMet(79LL) )
        {
            ...
            || (*(_DWORD *)(PsGetCurrentProcessWin32Process() + 776) & 0x4000) != 0 )
          {
            goto LABEL_45;
               ...
               || (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
                 ? (v13 = 0)
                 : (v13 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL)
                                    + 260LL) & 1),
                   !v13) )
        {
LABEL_45:
          if ( (unsigned int)IsDPIDWMSysMet(79LL)
            ...
            && (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
              ? (v12 = 0)
              : (v12 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL)
                                 + 260LL) & 1),
                v12) )
          {
            v14 = (INT *)(gpsi + 2972LL);
          ...
          if ( (unsigned int)IsDPIAbsoluteSysMet(77LL) )
          {
              ...
              || (*(_DWORD *)(PsGetCurrentProcessWin32Process() + 776) & 0x4000) != 0 )
            {
              goto LABEL_64;
                 ...
                 || (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
                   ? (v17 = 0)
                   : (v17 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
                                                  + 8LL)
                                      + 260LL) & 1),
                     !v17) )
          {
LABEL_64:
            if ( (unsigned int)IsDPIDWMSysMet(77LL)
              ...
              && (!*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416)
                ? (v16 = 0)
                : (v16 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 416) + 8LL)
                                   + 260LL) & 1),
                  v16) )
            {
