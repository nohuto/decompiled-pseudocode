/*
 * XREFs of ?NtUserfnHkINLPMSG@@YA_JHK_KPEAUtagMSG@@@Z @ 0x1C0068E80
 * Callers:
...
__int64 __fastcall NtUserfnHkINLPMSG(int a1, int a2, int a3, struct tagMSG *a4)
{
  ...
  {
    v11 = gptiCurrent;
    *((_QWORD *)&v15 + 1) = *(_QWORD *)(gptiCurrent + 624LL);
    *(_QWORD *)&v15 = *(_QWORD *)(gptiCurrent + 632LL);
  }
  else
  {
    v11 = gptiCurrent;
  }
  result = *(_QWORD *)(*(_QWORD *)v11 + 616LL);
  if ( !result )
    goto LABEL_13;
  while ( 1 )
  {
    ...
    if ( (*(_DWORD *)(result + 64) & 1) != 0 )
      break;
    result = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v11 + 424LL) + 8LL * *(int *)(result + 48) + 40);
LABEL_10:
