/*
 * XREFs of ?PromotePointerInternal@@YAHGKPEAUtagMOUSE_PROMOTION_ENTRY@@0@Z @ 0x1C023A4D8
 * Callers:
 ...
 *     ?FindCacheById@@YAPEAUtagMOUSE_PROMOTION_CACHE@@GPEAK@Z @ 0x1C0239EFC (-FindCacheById@@YAPEAUtagMOUSE_PROMOTION_CACHE@@GPEAK@Z.c)
 *     ?ProcessDownOnly@@YAXPEAUtagMOUSE_PROMOTION_CACHE@@PEAUtagMOUSE_PROMOTION_ENTRY@@H@Z @ 0x1C023A360 (-ProcessDownOnly@@YAXPEAUtagMOUSE_PROMOTION_CACHE@@PEAUtagMOUSE_PROMOTION_ENTRY@@H@Z.c)
 ...
 *     ?ValidateDoubleClick@@YAHAEBUtagTAP_INFO@@KKH@Z @ 0x1C023A7CC (-ValidateDoubleClick@@YAHAEBUtagTAP_INFO@@KKH@Z.c)
 */
        ...
        struct tagMOUSE_PROMOTION_ENTRY *a4)
{
  ...
  if ( (dword_1C0322D28 & 8) != 0
    && CacheById == (struct tagMOUSE_PROMOTION_CACHE *)word_1C0322C28
  ...
  if ( ((v4 >> 18) & 1) != 0
    && (unsigned int)ValidateDoubleClick((const struct tagTAP_INFO *)&qword_1C0322CE0, v22, *((_DWORD *)a3 + 4), v11) )
  {
    *((_QWORD *)a3 + 1) = qword_1C0322CEC;
  }
  v12 = *((_DWORD *)a3 + 4);
  v13 = v9 + 1;
  v14 = *((_QWORD *)a3 + 1);
  ...
  if ( (unsigned int)v13 < 5 )
  {
    ...
    v16 = (struct tagMOUSE_PROMOTION_QUEUE *)((char *)&unk_1C0322C30 + 24 * v13);
    do
    {
  ...
  else
  {
    ...
    {
      if ( v11 )
        v17 = dword_1C0322D28 | 4;
      else
        v17 = dword_1C0322D28 & 0xFFFFFFFB;
      dword_1C0322D28 = v17 | 2;
    }
  }
  if ( v10 )
  {
    word_1C0322CE8 = a1;
    qword_1C0322CE0 = gptiCurrent;
    qword_1C0322CEC = v14;
    dword_1C0322CF4 = v12;
    dword_1C0322CF8 = v11;
  }
  ...
  {
    memset(&qword_1C0322CE0, 0, 0x20uLL);
  }
  return 1LL;
}
