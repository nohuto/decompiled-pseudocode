...
__int64 __fastcall itrp_MD(__int64 a1, char a2)
{
  ...
  v5 = 4;
  v32 = (int *)(qword_1C0323148 - 8);
  v6 = v3[4];
  LOWORD(v7) = v3[6];
  v8 = *(int *)(qword_1C0323148 - 8);
  v9 = v6;
  if ( ((a2 - 1) & 1) != 0 )
  {
...
LABEL_36:
                ...
                v28 = (unsigned int)InvokeGlobalGSScale(
                                      *(_DWORD *)(v2 + 184),
                                      (int *)(v2 + 264),
                                      *(_DWORD *)(*(_QWORD *)(qword_1C0323128 + 32) + 4 * v8)
                                    - *(_DWORD *)(*(_QWORD *)(LocalGS + 32) + 4 * v4));
                v29 = v27;
              }
              v18 = InvokeProject((unsigned int)dword_1C0323194, v28, v29);
              goto LABEL_35;
            }
          }
        }
  ...
  else
  {
    ...
    {
      if ( (int)v8 >= *(_DWORD *)(qword_1C0323160 + 440) || (int)v8 < 0 )
        goto LABEL_78;
      v37 = 4;
    }
    if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND(&LocalGS, LocalGS) )
      ...
      if ( v23 < 1 || v23 > v35 || (int)v8 < *(__int16 *)(*(_QWORD *)(v22 + 64) + 2LL * v23 - 2) + v37 + 1 )
      {
        ...
        if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND(&LocalGS, qword_1C0323128) )
        {
          ...
          if ( v26 < 1 || v26 > v7 || (int)v4 < v5 + *(__int16 *)(*(_QWORD *)(v25 + 64) + 2LL * v26 - 2) + 1 )
          {
            ...
            if ( (*(_BYTE *)(qword_1C0323160 + 454) & 0xB) == 0xB && v19 == 64 )
              v19 = 65;
            goto LABEL_36;
          }
        }
