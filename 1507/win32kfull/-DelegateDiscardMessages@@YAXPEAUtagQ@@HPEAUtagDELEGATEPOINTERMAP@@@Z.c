/*
 * XREFs of ?DelegateDiscardMessages@@YAXPEAUtagQ@@HPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1C01E09A4
 * Callers:
...
LABEL_11:
        ...
        if ( v5 )
        {
          ...
          {
            v9 = *(_QWORD *)v5;
            if ( (unsigned int)IsPointerInputMessage(*(_DWORD *)(v5 + 24)) )
            {
              if ( (*(_DWORD *)(v5 + 92) & 0x40) != 0 )
              {
                v11 = *(_QWORD *)(v5 + 40);
                if ( *(_WORD *)(v5 + 32) == *(_WORD *)a3 )
                {
                  ...
                  if ( (unsigned int)GetPointerMessageInfo(v11, 0, &v14, 0LL, 0LL, 0LL, 0LL) )
                    v13 = ValidateHwnd(v14);
                  else
                    v13 = 0LL;
                  if ( v13 == *((_QWORD *)a3 + 1) )
                  {
                    if ( *(_DWORD *)(v5 + 24) == 583 )
                      v8 = 1;
                    DelQEntry((__int64)a1, (__int64 *)v5, 1LL, v12);
                    if ( *((_QWORD *)a1 + 5) == v5 )
                      *((_QWORD *)a1 + 5) = 0LL;
                  }
                }
