/*
 * XREFs of ?MulBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C0294EE0
 * Callers:
        ...
        ROP4 rop4)
{
  ...
  v55 = a6;
  v15 = 0;
  v56 = IsMetaDevBitmapForMirroring(a1);
  v59 = pxlo;
  ...
  {
    return bBitBltFromScreen(a1, v57, psoMask, a4, pxlo, &v61, a7, pptlMask, pbo, pptlBrush, rop4);
  }
  dhpdev = a1->dhpdev;
  LODWORD(v49) = 1;
  if ( iType && (unsigned int)MSURF::bFindSurface((MSURF *)v62, v54, a4, a6) )
  {
    v20 = 1;
  ...
  {
    MULTISURF::MULTISURF((MULTISURF *)v77, v54, v55);
    v28 = rop4;
    ...
    do
    {
      ...
      if ( Source )
      {
        ...
        if ( !pulXlate )
        {
          ...
          {
            v38 = SURFOBJ_TO_SURFACE_NOT_NULL(v54);
...
LABEL_69:
          ...
          if ( v28 == 52428 )
          {
            if ( (*((_DWORD *)v46 + 28) & 0x400) != 0 )
              v47 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*((_QWORD *)v66 + 7) + 2872LL);
            else
              v47 = EngCopyBits;
            v29 &= OffCopyBits(
          ...
          else
          {
            ...
            if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v67) + 112) & 1) != 0 )
              v48 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *, POINTL *, BRUSHOBJ *, POINTL *, ROP4))(*((_QWORD *)v66 + 7) + 2864LL);
            else
              v48 = EngBitBlt;
            v29 &= OffBitBlt(
