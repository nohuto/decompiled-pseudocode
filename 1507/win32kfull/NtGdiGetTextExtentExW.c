/*
 * XREFs of NtGdiGetTextExtentExW @ 0x1C0029F30
 * Callers:
 *     <none>
 * Callees:
        ...
        char a8)
{
  ...
  unsigned int v36; // [rsp+168h] [rbp+20h]
  ...
  if ( (_DWORD)a3 )
  {
    LOBYTE(v14) = (unsigned int)a3 <= 0x10;
    v24 = v14;
    if ( Src )
    {
      if ( v14 )
      ...
      {
        if ( (unsigned int)a3 <= 0x682AAA )
        {
          v13 = (_BYTE *)AllocFreeTmpBuffer((unsigned int)(6 * a3));
          v25 = v13;
        }
