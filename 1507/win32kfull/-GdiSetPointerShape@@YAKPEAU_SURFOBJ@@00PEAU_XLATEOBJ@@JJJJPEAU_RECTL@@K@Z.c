/*
 * XREFs of ?GdiSetPointerShape@@YAKPEAU_SURFOBJ@@00PEAU_XLATEOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C026D600
 * Callers:
        ...
        unsigned int a10)
{
  ...
  if ( psoSrc || a3 )
  {
    ...
    {
      v22 = *((_QWORD *)hdev + 149);
      *((_QWORD *)hdev + 149) = *(_QWORD *)(v22 + 24);
      vSpDeleteSprite((struct SPRITE *)v22);
      --*((_DWORD *)hdev + 300);
    }
    v23 = *((_QWORD *)hdev + 148) == 0LL;
    *((_DWORD *)hdev + 302) = v16;
    if ( !v23 )
    {
      v24 = *((_QWORD *)hdev + 149);
      ...
      v27 = a6;
      *((_DWORD *)hdev + 294) = a5 - v26->left;
      *((_DWORD *)hdev + 295) = v27 - v26->top;
    }
