/*
 * XREFs of itrp_MIAP @ 0x1C00BC8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_MIAP(__int64 a1, char a2)
{
  ...
  v6 = 4;
  v7 = (int *)(qword_1C0323148 - 4);
  qword_1C0323148 = (__int64)v7;
  v8 = *v7;
  if ( (int)v8 >= *(unsigned __int16 *)(qword_1C0323160 + 360)
    || (int)v8 < 0
    || (v9 = *(_QWORD *)(qword_1C0323160 + 16),
        (qword_1C0323160 ^ v9 ^ MEMORY[0xFFFFF78000000330] ^ (unsigned __int64)*(unsigned __int16 *)(qword_1C0323160 + 360)) != *(_QWORD *)(qword_1C0323160 + 368)) )
  {
  ...
  else
  {
    if ( dword_1C032319C == 3 )
    {
      ...
      fixed = FixMul(*(_DWORD *)(*(_QWORD *)(qword_1C0323160 + 16) + 4 * v8), CVTScale);
    }
    else
    {
    ...
    v7 = (int *)qword_1C0323148;
  }
  qword_1C0323148 = (__int64)(v7 - 1);
  v11 = *(v7 - 1);
  v12 = *(_WORD **)(v2 + 344);
  v13 = v12[4];
  v14 = v12[6];
...
LABEL_44:
  ...
  LODWORD(qword_1C0323170) = v11;
  HIDWORD(qword_1C0323170) = v11;
  if ( v3 == v17 )
  {
    *(_DWORD *)(*(_QWORD *)v3 + 4 * v11) = ((unsigned __int64)((int)fixed * (__int64)(__int16)dword_1C0323138) >> 32 << 18)
                                         + ((((fixed * (__int16)dword_1C0323138) >> 13) + 1) >> 1);
    *(_DWORD *)(*(_QWORD *)(v3 + 16) + 4 * v11) = *(_DWORD *)(*(_QWORD *)v3 + 4 * v11);
    *(_DWORD *)(*(_QWORD *)(v3 + 8) + 4 * v11) = ((unsigned __int64)((int)fixed * (__int64)SHIWORD(dword_1C0323138)) >> 32 << 18)
                                               + ((((fixed * SHIWORD(dword_1C0323138)) >> 13) + 1) >> 1);
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v22 > *v5 )
      fixed = v19;
    fixed = InvokeRoundValue((unsigned int)v5[6], fixed, *(unsigned int *)(qword_1C0323160 + 32));
  }
  v23 = fixed - v21;
  switch ( dword_1C032318C )
  {
    ...
    case 3:
      ...
      *(_BYTE *)(*(_QWORD *)(v3 + 72) + v11) |= 2u;
      break;
    case 4:
      *(_DWORD *)(*(_QWORD *)(qword_1C0323160 + 16) + 4 * v11) += v23;
      break;
    case 5:
