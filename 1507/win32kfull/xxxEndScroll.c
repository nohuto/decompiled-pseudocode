/*
 * XREFs of xxxEndScroll @ 0x1C02336E4
 * Callers:
  ...
  *(_DWORD *)(v5 + 56) = 0;
  ...
  if ( (char *)v7 != (char *)xxxTrackThumb )
  {
    if ( v7 == xxxTrackBox )
    {
      ...
      HIDWORD(v15) = *(__int16 *)(gptiCurrent + 688LL) - *((_DWORD *)a1 + 29);
    ...
    if ( v5 == *(_QWORD *)(result + 640) )
    {
            ...
            v5 == *(_QWORD *)(result + 640)) )
      {
        ...
        if ( v5 == *(_QWORD *)(result + 640) )
        {
          ...
          if ( !v14 || (zzzShowCaret(v14), result = *((_QWORD *)a1 + 2), v5 == *(_QWORD *)(result + 640)) )
          {
            *(_QWORD *)(v5 + 48) = 0LL;
