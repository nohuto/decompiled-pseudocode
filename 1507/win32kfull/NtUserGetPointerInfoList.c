/*
 * XREFs of NtUserGetPointerInfoList @ 0x1C00048E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  if ( a1 == 1 )
  {
    v25 = *(_DWORD **)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 1120);
    v26 = 0LL;
    if ( !v25 || (*v25 & 1) == 0 )
    {
      v11 = 0;
...
LABEL_55:
    ...
    if ( v17 )
    {
      v26 = *(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 1120);
