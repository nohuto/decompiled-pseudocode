/*
 * XREFs of ValidateDeviceSignature @ 0x1C0150A80
 * Callers:
 *     CreatePointerDeviceInfo @ 0x1C01C7A40 (CreatePointerDeviceInfo.c)
 * Callees:
 *     ?_SqmTHQA@@YAXGGK@Z @ 0x1C0150CC4 (-_SqmTHQA@@YAXGGK@Z.c)
 *     ?CheckForSegmentedSignatureBlob@@YAJPEAXGPEAU_HIDP_VALUE_CAPS@@PEAG@Z @ 0x1C01C4498 (-CheckForSegmentedSignatureBlob@@YAJPEAXGPEAU_HIDP_VALUE_CAPS@@PEAG@Z.c)
