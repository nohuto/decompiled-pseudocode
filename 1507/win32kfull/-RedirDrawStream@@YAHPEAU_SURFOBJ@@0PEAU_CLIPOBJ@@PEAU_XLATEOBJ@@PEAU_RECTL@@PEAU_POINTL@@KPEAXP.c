/*
 * XREFs of ?RedirDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C028EC10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
        ...
        if ( (*(_DWORD *)(v13 + 56) & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v13 + 1824); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v15 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v15 + 1816) + 784LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *, unsigned int, void *, struct _DSSTATE *))(v17 + 784))(
                    v19,
                    DevBitmap,
                    a3,
                    a4,
  ...
  EngDrawStream((__int64)a1, (__int64)a2, (__int64)a3, (__int64)a4, (int)a5, (int *)a6, a7, (__int64)a8, a9);
