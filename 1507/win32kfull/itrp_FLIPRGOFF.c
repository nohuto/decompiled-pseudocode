/*
 * XREFs of itrp_FLIPRGOFF @ 0x1C02DCA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_FLIPRGOFF(__int64 a1)
{
  ...
  v4 = 4;
  v5 = (int *)(qword_1C0323148 - 4);
  qword_1C0323148 = (__int64)v5;
  ...
  {
    if ( v7 >= *(_DWORD *)(qword_1C0323160 + 440) || v7 < 0 )
      goto LABEL_14;
    v12 = 4;
  }
