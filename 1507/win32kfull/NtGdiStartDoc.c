/*
 * XREFs of NtGdiStartDoc @ 0x1C026B460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiStartDoc(HDC a1, __int64 a2, int *a3, unsigned int a4)
{
  ...
  if ( v28.lpszDocName )
    FreeThreadBufferWithTag(v28.lpszDocName);
  if ( v28.lpszOutput )
    FreeThreadBufferWithTag(v28.lpszOutput);
  if ( v28.lpszDatatype )
    FreeThreadBufferWithTag(v28.lpszDatatype);
  return started;
}
