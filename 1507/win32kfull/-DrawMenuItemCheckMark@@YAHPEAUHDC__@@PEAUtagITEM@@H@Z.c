/*
 * XREFs of ?DrawMenuItemCheckMark@@YAHPEAUHDC__@@PEAUtagITEM@@H@Z @ 0x1C023E3A4
 * Callers:
...
__int64 __fastcall DrawMenuItemCheckMark(HDC a1, struct tagITEM *a2, LONG a3)
{
...
LABEL_11:
  ...
  v15 = *((_DWORD *)a2 + 1) & 8;
  if ( (_DWORD)v15 )
    v16 = (HSURF)*((_QWORD *)a2 + 3);
  else
    v16 = (HSURF)*((_QWORD *)a2 + 4);
  if ( v16 )
  {
    ...
    if ( v17 )
    {
      ...
      if ( (*(_DWORD *)a2 & 0x2000) != 0 )
        a3 = *((_DWORD *)a2 + 20) - v12[2];
      if ( (unsigned int)GreExtGetObjectW(v16, 104, v30) == 104 && v30[23] == 32 && !v31 )
      {
        LOBYTE(v27) = 0;
        HIWORD(v27) = 511;
        ...
        if ( (Layout & 1) != 0 )
          v20 = 0x80;
        BYTE1(v27) = v20;
        NtGdiAlphaBlend(a1, a3, v28, v12[3], v12[3], ghdcMem2, 0, 0, v12[2], v12[3], v27);
      }
      else
      {
        NtGdiBitBltInternal(a1, a3, v28, v12[2], v12[3], ghdcMem2, 0, 0, 0xB8074Au, 0xFFFFFF, 0);
      }
...
LABEL_41:
  ...
  FixHDCBITSBmp(v25);
  BltColor(a1, 0LL, *(HDC *)(gpDispInfo + 32LL), a3, v14, v12[2], v12[3], *v12, v12[1], v5);
  return v3;
}
