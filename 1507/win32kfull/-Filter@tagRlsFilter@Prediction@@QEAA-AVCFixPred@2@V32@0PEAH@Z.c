/*
 * XREFs of ?Filter@tagRlsFilter@Prediction@@QEAA?AVCFixPred@2@V32@0PEAH@Z @ 0x1C01C4950
 * Callers:
 ...
 *     ??$?DVCFixPred@Prediction@@$02@Prediction@@YA?AV?$Vector@VCFixPred@Prediction@@$02@0@AEBV10@AEBVCFixPred@0@@Z @ 0x1C01C3C7C (--$-DVCFixPred@Prediction@@$02@Prediction@@YA-AV-$Vector@VCFixPred@Prediction@@$02@0@AEBV10@AEBV.c)
 *     ??$?DVCFixPred@Prediction@@$02@Prediction@@YA?AV?$Vector@VCFixPred@Prediction@@$02@0@AEBV?$SquareMatrix@VCFixPred@Prediction@@$02@0@AEBV10@@Z @ 0x1C01C3CE4 (--$-DVCFixPred@Prediction@@$02@Prediction@@YA-AV-$Vector@VCFixPred@Prediction@@$02@0@AEBV-$Squar.c)
 *     ??$?DVCFixPred@Prediction@@$02@Prediction@@YA?AVCFixPred@0@AEBV?$Vector@VCFixPred@Prediction@@$02@0@0@Z @ 0x1C01C3D6C (--$-DVCFixPred@Prediction@@$02@Prediction@@YA-AVCFixPred@0@AEBV-$Vector@VCFixPred@Prediction@@$0.c)
 ...
 *     ??$?HVCFixPred@Prediction@@$02@Prediction@@YA?AV?$Vector@VCFixPred@Prediction@@$02@0@AEBV10@0@Z @ 0x1C01C3E48 (--$-HVCFixPred@Prediction@@$02@Prediction@@YA-AV-$Vector@VCFixPred@Prediction@@$02@0@AEBV10@0@Z.c)
 ...
 *     ??4?$SquareMatrix@VCFixPred@Prediction@@$02@Prediction@@QEAAAEAV01@AEBV01@@Z @ 0x1C01C4134 (--4-$SquareMatrix@VCFixPred@Prediction@@$02@Prediction@@QEAAAEAV01@AEBV01@@Z.c)
 *     ??4?$Vector@VCFixPred@Prediction@@$02@Prediction@@QEAAAEAV01@AEBV01@@Z @ 0x1C01C416C (--4-$Vector@VCFixPred@Prediction@@$02@Prediction@@QEAAAEAV01@AEBV01@@Z.c)
 ...
 *     ?diag@?$SquareMatrix@VCFixPred@Prediction@@$02@Prediction@@QEAAXAEBVCFixPred@2@@Z @ 0x1C01C6B80 (-diag@-$SquareMatrix@VCFixPred@Prediction@@$02@Prediction@@QEAAXAEBVCFixPred@2@@Z.c)
 */
...
_QWORD *__fastcall Prediction::tagRlsFilter::Filter(__int64 *a1, _QWORD *a2, __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  _QWORD v79[10]; // [rsp+150h] [rbp+50h] BYREF
  char v80[80]; // [rsp+1A0h] [rbp+A0h] BYREF
  ...
  *a5 = 0;
  ...
  v37 = Prediction::operator-<Prediction::CFixPred,3>(v80, (__int64)(a1 + 18), (__int64)v36);
  v38 = Prediction::operator*<Prediction::CFixPred,3>(v78, (__int64)v37, a1 + 49);
  v39 = Prediction::Tri<Prediction::CFixPred,3>(v79, (__int64)v38);
  ...
  if ( v35 != v44 )
    *v35 = *v44;
  v45 = Prediction::operator^<Prediction::CFixPred,3>((char *)v79, (__int64)(a1 + 9), (__int64)(a1 + 9));
  v46 = Prediction::operator^<Prediction::CFixPred,3>(v78, (__int64)a1, (__int64)(a1 + 9));
  v47 = (__int64 *)Prediction::operator-<Prediction::CFixPred,3>(v80, (__int64)(a1 + 36), (__int64)v46);
  ...
  v50 = (__int64 *)Prediction::operator*<Prediction::CFixPred,3>((__int64)v86, v49, a1 + 27);
  v51 = Prediction::operator*<Prediction::CFixPred,3>((__int64)v85, v50, v47);
  ...
  while ( v55 );
  v57 = Prediction::operator-<Prediction::CFixPred,3>(v82, (__int64)v75, (__int64)(a1 + 18));
  v58 = Prediction::operator*<Prediction::CFixPred,3>(v81, (__int64)v57, a1 + 49);
  ...
  v62 = Prediction::operator^<Prediction::CFixPred,3>(v81, (__int64)(a1 + 9), (__int64)a1);
  v63 = Prediction::operator-<Prediction::CFixPred,3>(v82, (__int64)(a1 + 36), (__int64)v62);
  v64 = Prediction::operator*<Prediction::CFixPred,3>(v77, (__int64)v63, a1 + 15);
  v65 = Prediction::operator+<Prediction::CFixPred,3>(v76, (__int64)v64, (__int64)v61);
