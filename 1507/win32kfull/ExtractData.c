/*
 * XREFs of ExtractData @ 0x1C01C98A4
 * Callers:
...
__int64 __fastcall ExtractData(__int64 a1, __int16 a2, __int16 a3, int a4, _DWORD *a5)
{
  ...
  v11 = 60 * v10;
  v12 = 2LL * v7;
  v5 = *(_DWORD *)(60 * v10 + a1 + 372);
  v13 = *(_DWORD *)(a1 + 16LL * v7 + 40);
  v14 = *(_DWORD *)(a1 + 8 * v12 + 36);
  if ( v13 != v14 )
  {
    v15 = *(_DWORD *)(v11 + a1 + 356);
    v16 = *(_DWORD *)(v11 + a1 + 352);
    if ( v15 != v16 )
    {
      if ( (int)v5 >= v16 )
      {
