/*
 * XREFs of vInitFontsDirectoryNameInformation @ 0x1C01552B0
 * Callers:
 *     <none>
 * Callees:
 *     PALLOCMEM2 @ 0x1C0033FC4 (PALLOCMEM2.c)
 *     ?QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z @ 0x1C00AD010 (-QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z.c)
...
int vInitFontsDirectoryNameInformation()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)v0 >= 0 )
  {
    ...
    if ( v4 )
    {
      if ( (unsigned int)bAppendSysDirectory(v4, (WCHAR *)&qword_1C015E270) )
      {
        v5 = -1LL;
        do
          ++v5;
