/*
 * XREFs of NtUserPostThreadMessage @ 0x1C0090EE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  v11 = v10[52];
  if ( *(_QWORD *)(gptiCurrent + 416LL) != v11
    && (*(_DWORD *)(gptiCurrent + 448LL) & 8) == 0
    && !GetDesktopView(*(_QWORD *)(gptiCurrent + 384LL), v11) )
  {
...
LABEL_9:
    ...
    if ( gbEnforceUIPI )
    {
      ...
      if ( (unsigned int)v22 <= (unsigned int)i )
      {
        ...
        {
          UserSetLastError(1444);
          EtwTraceUIPIMsgError(*(_QWORD *)(gptiCurrent + 384LL), v10[48], a2, a3, a4);
          goto LABEL_6;
        }
      }
    }
                          ...
                          0) )
    {
      ...
      else
      {
        ...
        if ( gbEnforceUIPI )
        {
          ...
          {
            if ( (_DWORD)v19 != v17 || (v20 = HIDWORD(v19), (_DWORD)v20 != v18) && (_DWORD)v20 != -1 && v18 != -1 )
            {
              v16 = 0;
...
LABEL_5:
  v8 = PostThreadMessage((__int64)v10, a2, (LARGE_INTEGER)a3, (LARGE_INTEGER)a4);
LABEL_6:
