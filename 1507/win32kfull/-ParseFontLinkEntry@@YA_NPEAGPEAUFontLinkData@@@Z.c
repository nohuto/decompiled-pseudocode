/*
 * XREFs of ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C013F8DC
 * Callers:
 *     bAddFlEntry @ 0x1C013F410 (bAddFlEntry.c)
 *     bDeleteFlEntry @ 0x1C028B194 (bDeleteFlEntry.c)
 * Callees:
 *     ?ParseFontScaleFactor@@YA_NPEBGPEAJ@Z @ 0x1C0140DCC (-ParseFontScaleFactor@@YA_NPEBGPEAJ@Z.c)
 */
