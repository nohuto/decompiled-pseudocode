/*
 * XREFs of ?FindNodeQueuedMessage@@YAPEAUtagQMSG@@PEBUtagPOINTERINFONODE@@HPEAPEAUtagQ@@@Z @ 0x1C022F258
 * Callers:
...
struct tagQMSG *__fastcall FindNodeQueuedMessage(const struct tagPOINTERINFONODE *a1, __int64 a2, struct tagQ **a3)
{
  ...
  if ( v8 )
  {
    do
    {
      if ( (unsigned int)IsPointerInputMessage(*(_DWORD *)(v8 + 24))
        && *(_QWORD *)(v8 + 40) == *((_QWORD *)a1 + 2)
        && (unsigned int)(v10 - 585) > 1 )
      {
        break;
      }
      v8 = *(_QWORD *)(v8 + 8);
