/*
 * XREFs of ApplyPTPTranslation @ 0x1C01CEC60
 * Callers:
 ...
 * Callees:
 *     ?TransformPTPLogicalUnitsToPhysical@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@PEAU2@@Z @ 0x1C01CE858 (-TransformPTPLogicalUnitsToPhysical@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@PEAU2@@Z.c)
 */
  ...
  *(_QWORD *)(a2 + 48) = *(_QWORD *)(a2 + 64);
  TransformPTPLogicalUnitsToPhysical(
    ...
    *(struct tagPOINT *)(a4 + 3),
    (struct tagPOINT *)(2400 * v5 + *((_QWORD *)a1 + 85) + 2316LL));
  v8 = a4[6];
  if ( v8 )
  {
    v9 = a4[7];
    if ( v9 )
    {
      ...
      *(struct tagPOINT *)(*((_QWORD *)a1 + 85) + 2400 * v5 + 2324) = v11;
    }
  }
