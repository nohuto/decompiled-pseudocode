/*
 * XREFs of ?CanForceForeground2@@YAHPEBUtagPROCESSINFO@@@Z @ 0x1C0080A78
 * Callers:
...
__int64 __fastcall CanForceForeground2(const struct tagPROCESSINFO *a1)
{
  ...
  if ( !v2 )
    return 1LL;
  v3 = *(const struct tagPROCESSINFO **)(v2 + 384);
  if ( v3 == a1
    || !gptiForeground
    || *(const struct tagPROCESSINFO **)(gptiForeground + 384LL) == a1
    || (*((_DWORD *)a1 + 3) & 0x80100) != 0
    || a1 == (const struct tagPROCESSINFO *)gppiInputProvider
    || !gpqForeground
    || !gfDebugForegroundIgnoreDebugPort
    && (PsGetProcessDebugPort(*(_QWORD *)v3) || PsGetProcessDebugPort(**(_QWORD **)(gptiForeground + 384LL))) )
  {
    return 1LL;
  }
