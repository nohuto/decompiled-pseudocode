/*
 * XREFs of ?MulStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C0297BE0
 * Callers:
 *     <none>
 * Callees:
        ...
        FLONG flOptions)
{
  ...
  SURFOBJ *v26; // [rsp+108h] [rbp+8h]
  CLIPOBJ *v27; // [rsp+110h] [rbp+10h]
