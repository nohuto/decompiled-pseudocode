/*
 * XREFs of ?xxxPoke@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C01EB41C
 * Callers:
  ...
  if ( v6 == 2 )
  {
    if ( (*((_WORD *)v7 + 36) & 0x2000) != 0 )
    {
      ...
      v10 = (unsigned int)GiveObject(
                            *((unsigned __int16 *)v7 + 37),
                            v8,
                            *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 6) + 16LL) + 384LL) + 56LL)) == 0;
      v11 = v15;
      if ( !v10 )
        v11 = v15 | 0x4000;
      v12 = v11 | 0x400;
    ...
    else
    {
      v10 = (unsigned int)AddPublicObject(
                            *((unsigned __int16 *)v7 + 37),
                            *((void **)v7 + 6),
                            *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 5) + 16LL) + 384LL) + 56LL)) == 0;
      v12 = v15;
      if ( !v10 )
        v12 = v15 | 0x2000;
    }
