/*
 * XREFs of ?HighContrastHotKey@@YAHPEAUtagKE@@KH@Z @ 0x1C01ED4A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HighContrastHotKey(struct tagKE *a1)
{
  ...
  if ( (v4 & 1) != 0 )
  {
    if ( (v4 & 4) != 0 && v1 == 44 && !v2 && v3 == 17 )
    {
      ...
      if ( (v7 & 0x10) != 0 )
      {
        ...
        PostEventMessageEx(v8, *(_QWORD *)(v8 + 392), 0xEu, 0LL, 1u, 0LL, 0LL, 0LL);
      }
  ...
  if ( (v4 & 0x10) != 0 )
  {
    ...
    PostEventMessageEx(v5, *(_QWORD *)(v5 + 392), 0xEu, 0LL, 0, 0LL, 0LL, 0LL);
  }
