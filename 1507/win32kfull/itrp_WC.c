...
__int64 __fastcall itrp_WC(__int64 a1)
{
  ...
  else if ( (int)v7 >= *(_DWORD *)(qword_1C0323160 + 440) || (int)v7 < 0 )
  {
    goto LABEL_23;
  }
...
LABEL_23:
  ...
  v13 = InvokeProject(dword_1C0323190, *(_DWORD *)(*(_QWORD *)v3 + 4 * v7), *(_DWORD *)(*(_QWORD *)(v3 + 8) + 4 * v7));
  InvokeMovePoint(dword_1C032318C, (_QWORD *)v3, v7, v5 - v13);
  if ( v3 == qword_1C0323158 )
  {
