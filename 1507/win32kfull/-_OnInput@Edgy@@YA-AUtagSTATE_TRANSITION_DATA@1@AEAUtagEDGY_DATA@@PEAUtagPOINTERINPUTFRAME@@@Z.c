/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAUtagPOINTERINPUTFRAME@@@Z @ 0x1C0229D94
 * Callers:
 *     ?ProcessInput@Edgy@@YAHPEAUtagPOINTERINPUTFRAME@@PEAPEBU2@@Z @ 0x1C02293B0 (-ProcessInput@Edgy@@YAHPEAUtagPOINTERINPUTFRAME@@PEAPEBU2@@Z.c)
 * Callees:
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v6 = *(int *)(a2 + 16);
  v7 = 4LL;
  v8 = dword_1C02EBE80[v6];
  v9 = *(_OWORD *)(ArcData + 16);
  v10 = dword_1C02EBE80[v6 + 1];
  ...
  if ( v8 < v10 )
  {
    v12 = (_DWORD *)((char *)&unk_1C02EBD0C + 16 * v8);
