/*
 * XREFs of ?vSrcCopyS24D16@@YAXPEAUBLTINFO@@@Z @ 0x1C02C3A30
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v8 & 0x400000) != 0 )
  {
    while ( 1 )
    {
      ...
      if ( v10 >= 0 )
      {
        ...
        {
          v12 = v6[2] & 0xF8;
          v13 = (8 * (v6[1] | ((v6[3] | (v6[5] << 11)) << 10))) ^ ((*v6 >> 3) ^ (8
                                                                               * (v6[1] | ((v6[3] | (v6[5] << 11)) << 10)))) & 0x7E0F81F;
          v14 = v6[4] & 0xFC;
          v6 += 6;
          *(_DWORD *)v4 = ((v12 | (v14 << 11)) << 8) | v13;
          v4 += 2;
          --v11;
        }
        while ( v11 );
...
LABEL_22:
  ...
  while ( 1 )
  {
    ...
    if ( v16 >= 0 )
    {
      ...
      do
      {
        v18 = (v6[1] | (v6[3] << 11)) & 0x1F07C0F8 | ((v6[4] & 0xF8 | (32 * (v6[5] & 0xF8))) << 16);
        v19 = *v6 >> 3;
        v20 = v6[2];
        v6 += 6;
        *(_DWORD *)v4 = (v19 | ((v20 & 0x7C0F8) << 7)) & 0x3E07C1F | (4 * v18);
        v4 += 2;
        --v17;
      }
      while ( v17 );
