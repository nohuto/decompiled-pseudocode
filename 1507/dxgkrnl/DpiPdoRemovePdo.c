/*
 * XREFs of DpiPdoRemovePdo @ 0x1C016DFB0
 * Callers:
  ...
  else
  {
    ...
    *((_BYTE *)v9 + 476) = 0;
    if ( v15 && !*((_BYTE *)v9 + 479) )
    {
      ...
      if ( (int)v5 >= 0 )
      {
        v16 = MonitorRemovePhysicalMonitor(*(DXGADAPTER **)(v4 + 2504), *((_DWORD *)v9 + 118));
        v18 = v16;
        if ( v16 < 0 )
        {
        ...
        v20 = DmmResetBaseVideoOutputTechnology(*(void *const *)(v4 + 2504), *((_DWORD *)v9 + 118));
        v5 = v20;
        if ( v20 < 0 )
        {
    ...
    KeWaitForSingleObject((PVOID)(v4 + 2040), Executive, 0, 0, 0LL);
    *(_QWORD *)(a2 + 40) = 0LL;
    KeReleaseMutex((PRKMUTEX)(v4 + 2040), 0);
    v26 = (void *)v9[112];
    if ( v26 )
    {
    ...
    *(_QWORD *)(v27 + 32) = v9[3];
    ...
    {
      v28 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)v9 + 2, (PVOID)a2, &byte_1C00E2920, 1u, 0x20u);
      v5 = v28;
      if ( v28 >= 0 )
      {
        IoReleaseRemoveLockAndWaitEx((PIO_REMOVE_LOCK)v9 + 2, (PVOID)a2, 0x20u);
        IoQueueWorkItem((PIO_WORKITEM)v9[115], (PIO_WORKITEM_ROUTINE)DpiPdoDestroyPdo, DelayedWorkQueue, 0LL);
      }
      else
      {
