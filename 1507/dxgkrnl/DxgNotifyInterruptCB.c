/*
 * XREFs of DxgNotifyInterruptCB @ 0x1C00090A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgNotifyInterruptCB(__int64 a1, struct _DXGKARGCB_NOTIFY_INTERRUPT_DATA *a2)
{
  ...
  else if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 2520LL), 0, 0) & 2) != 0 )
  {
    v4 = *(struct DXGADAPTER **)(*(_QWORD *)(a1 + 64) + 2504LL);
    if ( v4 )
    {
      v5 = *((_QWORD *)v4 + 248);
      if ( v5 )
      ...
      {
        v7 = *(DXGDODPRESENT **)(*((_QWORD *)v4 + 247) + 248LL);
        if ( v7 )
