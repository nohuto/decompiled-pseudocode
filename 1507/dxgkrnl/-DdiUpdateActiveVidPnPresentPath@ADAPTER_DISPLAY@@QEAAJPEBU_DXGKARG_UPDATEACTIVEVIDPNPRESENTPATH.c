/*
 * XREFs of ?DdiUpdateActiveVidPnPresentPath@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH@@@Z @ 0x1C00B54FC
 * Callers:
...
LABEL_11:
  ...
  v20 = WdLogNewEntry5_WdEvent(v19, v15, v17, v18);
  *(_QWORD *)(v20 + 24) = v16;
  *(_QWORD *)(v20 + 32) = a2;
