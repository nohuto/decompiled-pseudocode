/*
 * XREFs of DpiAppendNumberToString @ 0x1C00D6C90
 * Callers:
  ...
  *(_DWORD *)&String.Length = 1441792;
  ...
  if ( PoolWithTag )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      {
        v7 = -1073741801;
        v13 = (_QWORD *)WdLogNewEntry5_WdLowResource(v10);
        v13[3] = DpiAppendNumberToString;
  ...
  {
    v7 = -1073741801;
    v12 = (_QWORD *)WdLogNewEntry5_WdLowResource(v6);
    v12[3] = DpiAppendNumberToString;
