/*
 * XREFs of ?LogCddDatabaseAccessPacket@@YAXHJPEAU_D3DKMT_GETPATHSMODALITY@@PEAU_STRING@@I@Z @ 0x1C017D96C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v10 )
  {
    ...
    *((_QWORD *)v12 + 3) = 0LL;
    ...
    DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v12, v16, v17, v18);
    operator delete(v12);
  }
}
