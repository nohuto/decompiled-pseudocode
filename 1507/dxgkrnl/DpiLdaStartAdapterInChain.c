/*
 * XREFs of DpiLdaStartAdapterInChain @ 0x1C016FD80
 * Callers:
  ...
  if ( (_DWORD)v7 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)(*(_DWORD *)(v8 + 236) - 1) > 1 )
        goto LABEL_22;
      v13 = *(_BYTE *)(v10 + 1484) || *(_DWORD *)(v10 + 1028) != *(_DWORD *)(v8 + 1028);
...
LABEL_14:
  ...
  if ( (unsigned int)v7 > 1 )
  {
    while ( 1 )
    {
      v15 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 1472) + 8LL * v14) + 64LL);
      if ( *(_DWORD *)(v15 + 236) == 1 )
      {
