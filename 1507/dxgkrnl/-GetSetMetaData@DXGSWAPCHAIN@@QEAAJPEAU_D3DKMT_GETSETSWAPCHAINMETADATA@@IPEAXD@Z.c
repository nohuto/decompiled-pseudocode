/*
 * XREFs of ?GetSetMetaData@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_GETSETSWAPCHAINMETADATA@@IPEAXD@Z @ 0x1C0161DE4
 * Callers:
 ...
 *     ?GetMetaDataInternal@DXGSWAPCHAIN@@AEAAJPEAVAUTOEXPANDALLOCATION@@IPEAXAEAUSWAPCHAIN_METADATA_ETW_INFO@1@DPEAI@Z @ 0x1C0161C7C (-GetMetaDataInternal@DXGSWAPCHAIN@@AEAAJPEAVAUTOEXPANDALLOCATION@@IPEAXAEAUSWAPCHAIN_METADATA_ET.c)
        ...
        char a5)
{
  ...
  __int64 v17; // rcx
  __int64 v18; // r8
  struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *v19; // rsi
  __int64 v20; // rcx
  UINT v21; // esi
...
LABEL_20:
    ...
    {
      v19 = (struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *)(this + 16);
      if ( !bProducer )
        v19 = (struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *)(this + 9);
      DXGSWAPCHAIN::GetClientSurfaceInfo((DXGSWAPCHAIN *)this, v19, **((unsigned int **)v19 + 4), &v30, &v31);
