/*
 * XREFs of ?CacheDisplayModeChangeRequest@VIDPN_MGR@@QEAAXIPEBU_D3DKMT_DISPLAYMODE@@W4_DMM_CLIENT_TYPE@@JW4_DMM_DISPMODECHANGE_TYPE@@IQEBE@Z @ 0x1C000B738
 * Callers:
        ...
        __int64 a8)
{
  ...
  v12 = operator new[](0x218uLL, 0x4E506456u, PagedPool);
  if ( v12 )
