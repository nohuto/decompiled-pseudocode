/*
 * XREFs of ?GetClientSurfaceInfo@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@IPEAPEAUSWAPCHAIN_SURF_INFO@1@PEAPEAUSWAPCHAIN_CLIENT_SURF_INFO@1@@Z @ 0x1C002253C
 * Callers:
        ...
        struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_SURF_INFO **a5)
{
  ...
  v6 = (unsigned int)a3;
  if ( (unsigned int)a3 >= *((_DWORD *)this + 10) )
  {
