/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@PEAU_D3DKMT_OUTPUTDUPL_RELEASE_FRAME@@@@SAJPEAVDXGADAPTER@@IPEAU_D3DKMT_OUTPUTDUPL_RELEASE_FRAME@@P6AJPEAVOUTPUTDUPL_MGR@@1@Z@Z @ 0x1C015519C
 * Callers:
        ...
        __int64 (__fastcall *a4)(struct OUTPUTDUPL_MGR *, __int64))
{
  ...
  OutputDuplManager = FindOutputDuplManager(a1, (unsigned int)a2, &v25, &v22, &v23);
