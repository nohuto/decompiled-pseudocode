/*
 * XREFs of ?AddSource@DMMVIDEOPRESENTSOURCESET@@QEAAJV?$auto_ptr@VDMMVIDEOPRESENTSOURCE@@@@@Z @ 0x1C00C48B8
 * Callers:
...
__int64 __fastcall DMMVIDEOPRESENTSOURCESET::AddSource(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rax
  __int64 v7; // r9
  __int64 v8; // rcx
  ...
  v6 = IndexedSet<DMMVIDEOPRESENTSOURCE>::FindById(a1, *(_DWORD *)(*a2 + 24LL));
  if ( v6 )
    LODWORD(v8) = v6 != v7;
  else
