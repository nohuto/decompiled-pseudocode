/*
 * XREFs of ??0DISPMODECHANGEREQUEST@VIDPN_MGR@@QEAA@IAEBU_D3DKMT_DISPLAYMODE@@W4_DMM_CLIENT_TYPE@@JKW4_DMM_DISPMODECHANGE_TYPE@@QEBE@Z @ 0x1C000B7D8
 * Callers:
