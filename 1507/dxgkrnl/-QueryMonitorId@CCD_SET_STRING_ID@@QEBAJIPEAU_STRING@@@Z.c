/*
 * XREFs of ?QueryMonitorId@CCD_SET_STRING_ID@@QEBAJIPEAU_STRING@@@Z @ 0x1C0066F34
 * Callers:
 ...
 *     ?FindPathByMonitorId@CCD_SET_STRING_ID@@QEBAJAEBU_STRING@@PEAI@Z @ 0x1C017D5A8 (-FindPathByMonitorId@CCD_SET_STRING_ID@@QEBAJAEBU_STRING@@PEAI@Z.c)
...
__int64 __fastcall CCD_SET_STRING_ID::QueryMonitorId(
        ...
        __int64 a4)
{
  ...
  v5 = (unsigned int)a2;
  if ( (unsigned int)a2 >= *((unsigned __int16 *)this + 16) )
  {
