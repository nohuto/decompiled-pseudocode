/*
 * XREFs of ?CopyPresentArgs@DXGPRESENT@@QEAAJPEAVDXGCONTEXT@@PEAU_D3DKMT_PRESENT@@@Z @ 0x1C0069A30
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v15 > 0xFFFFFFFF )
  {
    ...
    *(_QWORD *)(v30 + 24) = 8562LL;
    goto LABEL_66;
  }
  if ( (int)v15 + (int)v13 < (unsigned int)v15 )
  {
    v30 = WdLogNewEntry5_WdWarning(v33, a2, a3, a4);
    *(_QWORD *)(v30 + 24) = 8570LL;
LABEL_66:
