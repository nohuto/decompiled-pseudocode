/*
 * XREFs of DpiPdoDispatchPower @ 0x1C000C890
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  if ( Options == 1 )
  {
    ...
    v8.SystemState = *(_DWORD *)(DeviceExtension + 248);
    ...
    if ( DeviceExtension[451] )
      _InterlockedDecrement((volatile signed __int32 *)(*(_QWORD *)(*((_QWORD *)DeviceExtension + 3) + 64LL) + 2680LL));
  ...
  else
  {
    if ( Options )
      goto LABEL_13;
    *((POWER_STATE *)DeviceExtension + 61) = v7;
    v10 = 0;
  }
  if ( v10 != -1073741637 )
    goto LABEL_12;
