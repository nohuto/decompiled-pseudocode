/*
 * XREFs of ?RenderTelemetry@ADAPTER_RENDER@@QEAAXPEAU_UNICODE_STRING@@W4_TELEMETRY_INVENTORY_TRIGGER@@PEAU_GUID@@@Z @ 0x1C00940F4
 * Callers:
...
void __fastcall ADAPTER_RENDER::RenderTelemetry(__int64 a1, unsigned __int16 *a2, int a3, const GUID *a4)
{
  ...
  v14 = 0LL;
  v12 = 0LL;
  v5 = *(struct VIDMM_GLOBAL **)(a1 + 408);
  v7 = *(VIDMM_EXPORT **)(a1 + 400);
  v13 = 0LL;
  ...
  if ( (unsigned int)dword_1C0046830 > 5 )
  {
    if ( TlgKeywordOn(v9, 0x400000000000uLL) )
    {
      ...
      v11 = a3;
      v31 = 4;
      TlgWrite((TraceLoggingHProvider)8, &unk_1C002FB65, a4, v10, 8u, &pData);
    }
  }
}
