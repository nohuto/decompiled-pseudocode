/*
 * XREFs of ?DxgkCddMakeResident@@YAJIEPEAUD3DDDI_MAKERESIDENT@@@Z @ 0x1C01318A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddMakeResident(__int64 a1, char a2, struct D3DDDI_MAKERESIDENT *a3)
{
  __int64 v4; // r15
...
LABEL_25:
    ...
    DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v44);
LABEL_26:
    LODWORD(v8) = DxgkMakeResidentInternal(a3, 0);
    goto LABEL_27;
  }
  LODWORD(v8) = -1073741811;
