/*
 * XREFs of ?AdapterObjectSignalFence@DXGADAPTERSYNCOBJECT@@QEAAJPEAVDXGSYNCOBJECT@@_K@Z @ 0x1C008340C
 * Callers:
        ...
        __int64 a3)
{
  ...
  else
  {
    ...
    v10 = *((_QWORD *)this + 2);
    v19 = a3;
    v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64 *, _DWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(v10 + 376) + 8LL)
                                                                                           + 544LL))(
            0LL,
            0LL,
            1LL,
