/*
 * XREFs of ?_IsSupportedModeInternal@DXGMONITOR@@AEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@EPEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C0097D64
 * Callers:
 ...
 *     ?_IsModeSupportedByMonitorMode@DXGMONITOR@@AEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@EPEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C0186C40 (-_IsModeSupportedByMonitorMode@DXGMONITOR@@AEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUN.c)
 */
        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  ...
  if ( !v6 )
  {
    ...
    if ( *a6 )
    {
      v25 = WdLogNewEntry5_WdAssertion(v12, v23, v24, v14);
  ...
  if ( IsModeSupportedByMonitorMode >= 0 )
  {
    ...
    if ( *a6 )
    {
      v27 = WdLogNewEntry5_WdAssertion(v12, v23, v24, v14);
    ...
    if ( IsModeInActiveSizeRange >= 0 )
    {
      if ( !*a5 )
      {
        if ( *a6 )
        {
          v29 = WdLogNewEntry5_WdAssertion(v12, v23, v24, v14);
...
LABEL_27:
      if ( !*a6 )
      {
        v30 = WdLogNewEntry5_WdAssertion(v12, v23, v24, v14);
