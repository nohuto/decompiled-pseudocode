/*
 * XREFs of ?CacheVidPnToBeComitted@VIDPN_MGR@@QEAAJQEAVDMMVIDPN@@IAEBU_DMM_COMMITVIDPNREQUEST_DIAGINFO@@AEAV?$AutoBuffer@U_DMM_COMMITVIDPNREQUEST_HWCAPS@@@DMM@@@Z @ 0x1C000E028
 * Callers:
...
LABEL_15:
  ...
  *(_QWORD *)(a5 + 40) = 0LL;
  v26[0] = 0LL;
  Queue<VIDPN_MGR::DISPMODECHANGEREQUEST>::Enqueue((_QWORD *)(a1 + 160), v16);
LABEL_9:
