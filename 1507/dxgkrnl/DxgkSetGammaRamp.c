/*
 * XREFs of DxgkSetGammaRamp @ 0x1C0138D70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_34:
  ...
  v25 = *(unsigned int *)(*(_QWORD *)(v14 + 1976) + 80LL);
  if ( (_DWORD)v25 != *((_DWORD *)v12 + 4678) )
  {
    v26 = WdLogNewEntry5_WdAssertion(v25, v21, v22, v23);
    *(_QWORD *)(v26 + 24) = 3390LL;
    WdLogEvent5_WdAssertion(v26);
  }
  v27 = v36[1];
  if ( *((_DWORD *)v12 + 4678) <= v36[1] )
  {
...
LABEL_32:
  ...
  if ( ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v14 + 1976), v12, v27)
    || ADAPTER_DISPLAY::IsEmulatedVidPnSourceOwner(*(DXGADAPTER ***)(v14 + 1976), v12, v27)
    && (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*(DXGADAPTER ***)(v14 + 1976), v27) <= 1
    && !(unsigned int)_guard_dispatch_icall_fptr() )
  {
    v5 = ADAPTER_DISPLAY::SetGammaRamp(*(PERESOURCE ***)(v14 + 1976), v27, v12);
    if ( v5 < 0 )
