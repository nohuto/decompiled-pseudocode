/*
 * XREFs of Template_pqcctttq @ 0x1C001B740
 * Callers:
...
NTSTATUS Template_pqcctttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v16 = 4LL;
  v18 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventInvalidateModeCache, 0LL, 8u, &UserData);
}
