/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C00D54F0
 * Callers:
 ...
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C00D517C (CmRegUtilUcValueGetFullBuffer.c)
 *     CmRegUtilWstrValueGetDword @ 0x1C00D567C (CmRegUtilWstrValueGetDword.c)
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00D5844 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 */
