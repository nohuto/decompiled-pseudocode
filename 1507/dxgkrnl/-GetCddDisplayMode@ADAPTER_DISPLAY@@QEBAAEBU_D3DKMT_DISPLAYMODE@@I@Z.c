/*
 * XREFs of ?GetCddDisplayMode@ADAPTER_DISPLAY@@QEBAAEBU_D3DKMT_DISPLAYMODE@@I@Z @ 0x1C000E1CC
 * Callers:
...
const struct _D3DKMT_DISPLAYMODE *__fastcall ADAPTER_DISPLAY::GetCddDisplayMode(DXGADAPTER **this, unsigned int a2)
{
  ...
  return (const struct _D3DKMT_DISPLAYMODE *)((char *)this[14] + 1008 * v3 + 856);
}
