/*
 * XREFs of ?GetBroadcastPresentSyncObject@DXGDEVICE@@QEAAPEAU_VIDSCH_SYNC_OBJECT@@XZ @ 0x1C0136024
 * Callers:
...
struct _VIDSCH_SYNC_OBJECT *__fastcall DXGDEVICE::GetBroadcastPresentSyncObject(DXGDEVICE *this)
{
  ...
  if ( !*((_QWORD *)this + 2342) )
  {
    ...
    v3 = *((_QWORD *)this + 2);
    v5[0] = 3;
    if ( (*(int (__fastcall **)(_QWORD, _QWORD, _DWORD *, _QWORD, _QWORD, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(v3 + 376) + 8LL)
                                                                                         + 520LL))(
           *(_QWORD *)(v3 + 384),
           0LL,
           v5,
  ...
  *((_QWORD *)v1 + 1) = 0LL;
  ...
  return (struct _VIDSCH_SYNC_OBJECT *)*((_QWORD *)this + 2342);
}
