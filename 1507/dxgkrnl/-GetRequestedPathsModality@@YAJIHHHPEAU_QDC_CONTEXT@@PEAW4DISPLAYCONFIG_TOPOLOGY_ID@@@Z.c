/*
 * XREFs of ?GetRequestedPathsModality@@YAJIHHHPEAU_QDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C0060F28
 * Callers:
        ...
        enum DISPLAYCONFIG_TOPOLOGY_ID *a6)
{
  ...
  if ( !*((_DWORD *)a5 + 1) )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(a1, a2, a3, a4) + 24) = 1684LL;
    return 3221225507LL;
  }
  if ( (a1 & 0x200000) != 0 )
  {
  ...
  else
  {
    ...
    if ( PathsModality >= 0 )
    {
      PathsModality = ConvertPathModalityToDisplayConfig(v25, (v9 & 0xF) == 15, v10, v8, v7, (v9 & 0x200000) != 0, v6);
      if ( PathsModality >= 0 )
