/*
 * XREFs of ?DpiMiracastCbReportChunkInfo@@YAJPEAXPEAUDXGK_MIRACAST_CHUNK_INFO@@0I@Z @ 0x1C0023D50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_28:
  ...
  if ( !a1 || *((_DWORD *)a1 + 4) != 1953656900 || *((_DWORD *)a1 + 5) != 14 || !*((_QWORD *)a1 + 38) )
  {
    v7 = (_QWORD *)WdLogNewEntry5_WdError(a1);
    v7[4] = a1;
    v8 = -1073741585LL;
  ...
  if ( CurrentIrql > 2u )
  {
    v11 = MIRACAST_CHUNK_LIST::RemoveHead(*((MIRACAST_CHUNK_LIST **)a1 + 48));
    if ( v11 )
    {
    ...
    else
    {
      ...
      *(_QWORD *)(v19 + 32) = a1;
      ...
      v4 = -1073741801;
      _InterlockedExchange((volatile __int32 *)a1 + 114, 1);
    }
    KeInsertQueueDpc((PRKDPC)(a1 + 392), 0LL, 0LL);
  }
  else
  {
    if ( CurrentIrql == 2 )
