/*
 * XREFs of ?Reset@DISPLAY_SOURCE@@AEAAJPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C01287C0
 * Callers:
...
__int64 __fastcall DISPLAY_SOURCE::Reset(DISPLAY_SOURCE *this, struct _TDR_RECOVERY_CONTEXT *a2)
{
  ...
  *((_QWORD *)this + 123) = 0LL;
  ...
  if ( v4 )
    memset(v4, 0, 4 * *(unsigned int *)(v3 + 1336) * (unsigned __int64)*(unsigned int *)(v3 + 1340));
  v5 = (void *)*((_QWORD *)this + 97);
  if ( v5 )
    memset(v5, 0, 4 * *(unsigned int *)(v3 + 1336) * (unsigned __int64)*(unsigned int *)(v3 + 1340));
  return 0LL;
}
