/*
 * XREFs of ?DisableStablePowerState@DXGADAPTER@@QEAAXXZ @ 0x1C0123BDC
 * Callers:
 ...
 *     ?DisableStablePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C001EC48 (-DisableStablePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
  ...
  if ( *((_BYTE *)this + 2447) )
  {
    for ( i = 0; i < *((_DWORD *)this + 538); ++i )
    {
      ...
      if ( !*(_DWORD *)(v3 + v4 + 208) )
      {
        ...
        DXGADAPTER::SetPowerComponentIdleCBInternal(this, i);
      }
    }
    v6 = (ADAPTER_RENDER *)*((_QWORD *)this + 248);
    if ( v6 )
