/*
 * XREFs of DxgkConfirmToken @ 0x1C0132FD0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkConfirmToken(struct DXGADAPTER *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  if ( v11 >= 0 )
  {
    (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, __int64, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 248) + 376LL)
                                                                                          + 8LL)
                                                                              + 296LL))(
      *(_QWORD *)(*((_QWORD *)a1 + 248) + 384LL),
      v8,
      v7,
      a4,
      a5,
