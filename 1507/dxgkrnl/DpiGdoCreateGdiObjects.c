/*
 * XREFs of DpiGdoCreateGdiObjects @ 0x1C00D6940
 * Callers:
...
__int64 __fastcall DpiGdoCreateGdiObjects(__int64 a1, unsigned int a2, ULONG *a3)
{
  ...
  Mutex = (PRKMUTEX)(v3 + 2192);
  KeWaitForSingleObject((PVOID)(v3 + 2192), Executive, 0, 0, 0LL);
  v8 = 0;
  if ( v6 )
  {
    while ( 1 )
        ...
        else
        {
          ...
          *((_DWORD *)DeviceExtension + 39) = v8;
          ...
          else if ( v6 == 1 )
          {
            ...
            DmmSetViewState(*(DXGADAPTER **)(v3 + 2504), *((_DWORD *)DeviceExtension + 39), 1);
          ...
          else
          {
            ...
            *((_QWORD *)DeviceExtension + 23) = v18;
            ...
            {
              v21 = *(char ***)(v3 + 2184);
              *(_QWORD *)DeviceExtension = v3 + 2176;
              *((_QWORD *)DeviceExtension + 1) = v21;
              if ( *v21 != (char *)(v3 + 2176) )
                __fastfail(3u);
              *v21 = DeviceExtension;
              *(_QWORD *)(v3 + 2184) = DeviceExtension;
              v22 = DeviceObject;
              ++*(_DWORD *)(v3 + 2248);
              v32 = 1;
              v22->Flags |= 4u;
