/*
 * XREFs of DpiFdoConnectInterrupt @ 0x1C00C6F90
 * Callers:
...
__int64 __fastcall DpiFdoConnectInterrupt(_QWORD *a1)
{
  ...
  if ( *(_DWORD *)(v1 + 472) )
    ...
    InterruptIrqlForChain = DpiFdoGetInterruptIrql(*(_QWORD *)(v1 + 1064), &v20);
  LODWORD(v6) = InterruptIrqlForChain;
  if ( InterruptIrqlForChain < 0 )
  {
    if ( !*(_BYTE *)(v1 + 448) && !*(_BYTE *)(v1 + 1439) && !*(_BYTE *)(v1 + 1062) && !*(_BYTE *)(v1 + 1440) )
    {
  ...
  if ( *(_QWORD *)(v3 + 184) )
  {
    ...
    *(_QWORD *)(v12 + 32) = v13;
    ...
    Parameters.FullySpecified.InterruptObject = (PKINTERRUPT *)(v1 + 1144);
    Parameters.FullySpecified.ServiceRoutine = (PKSERVICE_ROUTINE)DpiFdoMessageInterruptRoutine;
    Parameters.FullySpecified.SpinLock = *(PKSPIN_LOCK *)(v1 + 1232);
    ...
    *(_WORD *)&Parameters.MessageBased.SynchronizeIrql = (unsigned __int8)v13;
    ...
    {
      *(_DWORD *)(v1 + 1136) = Parameters.Version;
      *(_QWORD *)(v1 + 1152) = *Parameters.FullySpecified.InterruptObject;
    }
    return (unsigned int)v6;
  }
  if ( *(_BYTE *)(v1 + 1058) )
