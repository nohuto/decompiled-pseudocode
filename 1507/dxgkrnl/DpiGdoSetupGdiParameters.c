/*
 * XREFs of DpiGdoSetupGdiParameters @ 0x1C00D6D90
 * Callers:
 ...
 *     DpiGdoCreateServiceEntry @ 0x1C00D72F0 (DpiGdoCreateServiceEntry.c)
 *     DpiFdoGetAdapterUniqueGUID @ 0x1C00D74A0 (DpiFdoGetAdapterUniqueGUID.c)
 */
...
LABEL_31:
      ...
      else if ( Disposition == 1 )
      {
        ...
        v15 = ZwSetValueKey(v38, &ValueName, 0, 6u, *(PVOID *)(v6 + 504), *(unsigned __int16 *)(v6 + 496));
        v10 = v15;
        if ( v15 < 0 )
        {
