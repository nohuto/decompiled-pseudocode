/*
 * XREFs of ?_IsSupportedMode@DXGMONITOR@@QEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@EPEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C0097FB0
 * Callers:
...
LABEL_16:
  ...
  if ( (_DWORD)v11 != 3 )
  {
    v20 = WdLogNewEntry5_WdAssertion(v10, a2, v11, a4);
    WdLogEvent5_WdAssertion(v20);
  }
  LOBYTE(a4) = a3;
  result = DXGMONITOR::_IsSupportedModeInternal((__int64)this, (__int64)a2, 2LL, (__int64)a4, &v30, v29);
  if ( (int)result >= 0 )
  {
    LOBYTE(v14) = a3;
    result = DXGMONITOR::_IsSupportedModeInternal((__int64)this, (__int64)a2, 1LL, v14, v27, &v28);
    if ( (int)result >= 0 )
    {
      v16 = v27[0];
      v17 = v29[0];
