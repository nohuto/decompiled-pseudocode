/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@P8OUTPUTDUPL_MGR@@EAAXI@ZI@@SAJPEAVDXGADAPTER@@IP8OUTPUTDUPL_MGR@@EAAXI@ZIP6AJPEAV3@1I@Z@Z @ 0x1C00DB07C
 * Callers:
 *     DxgkDesktopSwitch @ 0x1C00DB050 (DxgkDesktopSwitch.c)
 * Callees:
        ...
        __int64 (__fastcall *a5)(struct OUTPUTDUPL_MGR *, void (__fastcall *)(OUTPUTDUPL_MGR *this, unsigned int a2), _QWORD))
{
        ...
        v18 >= 0) )
  {
    ...
    {
      v18 = a5(RemoteOutputDuplMgr, OUTPUTDUPL_MGR::ProcessDesktopSwitch, v8);
    }
  }
