/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x1C00DC730
 * Callers:
 *     DpiReadSystemFirmwareTable @ 0x1C00DC6C0 (DpiReadSystemFirmwareTable.c)
 *     DpiEnumSystemFirmwareTables @ 0x1C016B8A0 (DpiEnumSystemFirmwareTables.c)
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  if ( KeGetCurrentIrql() )
  {
    ...
    v18[6] = 0LL;
    v18[5] = DpiQuerySystemFirmwareTables;
    v18[3] = 275LL;
    v18[4] = 21LL;
    v18[7] = -1073741811LL;
  ...
  else if ( (a5 || !a4) && a6 )
  {
      ...
      if ( v13 < 0 )
      {
        ...
        else
        {
          *a6 = 0;
          ...
          v21[3] = DpiQuerySystemFirmwareTables;
          v21[4] = ZwQuerySystemInformation;
          v21[5] = v15;
    ...
    else
    {
      ...
      v20[3] = DpiQuerySystemFirmwareTables;
  ...
  else
  {
    ...
    v19[3] = DpiQuerySystemFirmwareTables;
    v19[4] = 0LL;
    v19[5] = -1073741811LL;
