/*
 * XREFs of ?_DispatchInternalIOCtrl@DXGMONITOR@@QEAAJKKPEAXK0PEA_K@Z @ 0x1C00BA7FC
 * Callers:
...
LABEL_21:
          ...
          if ( v39 >= 0 )
          {
            LODWORD(v11) = DxgkConvertStringToWideString(SourceString, 0x20uLL, v38, v29);
            if ( (int)v11 < 0 )
              return (unsigned int)v11;
            ...
            else
            {
              if ( v40 < 0 )
                goto LABEL_81;
              LODWORD(v11) = DxgkConvertStringToWideString(SourceString, 0x20uLL, v38 + 16, v29);
              if ( (int)v11 < 0 )
                return (unsigned int)v11;
            }
            ...
            if ( v41 >= 0 )
            {
              LODWORD(v11) = DxgkConvertStringToWideString(SourceString, 0x20uLL, v38 + 32, v29);
              if ( (int)v11 < 0 )
                return (unsigned int)v11;
              ...
              if ( v48 >= 0 )
              {
                LODWORD(v11) = DxgkConvertStringToWideString(SourceString, 0x1CuLL, v38 + 51, v29);
                if ( (int)v11 < 0 )
                  return (unsigned int)v11;
                v38[50] = 13;
                goto LABEL_21;
