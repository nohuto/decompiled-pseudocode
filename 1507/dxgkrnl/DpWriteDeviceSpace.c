/*
 * XREFs of DpWriteDeviceSpace @ 0x1C0022ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpWriteDeviceSpace(__int64 a1, __int64 a2, void *a3, ULONG Offset, ULONG Length, ULONG *a6)
{
  ...
  *a6 = 0;
  ...
  if ( (_DWORD)a2 != -2147483647 )
  {
    ...
    v13 = *(__int64 (__fastcall **)(_QWORD, __int64, void *, _QWORD, ULONG))(a1 + 576);
    if ( v13 )
    {
      v12 = v13(*(_QWORD *)(a1 + 536), a2, a3, Offset, Length);
      goto LABEL_22;
    }
    v14 = -1073741823LL;
LABEL_24:
...
LABEL_25:
  ...
  v10 = *(__int64 (__fastcall **)(_QWORD, void *, _QWORD, _QWORD))(a1 + 1592);
  if ( v10 )
  {
    v12 = v10(*(_QWORD *)(a1 + 1560), a3, Offset, Length);
LABEL_22:
    *a6 = v12;
