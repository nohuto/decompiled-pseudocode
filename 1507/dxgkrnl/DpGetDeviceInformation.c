/*
 * XREFs of DpGetDeviceInformation @ 0x1C00D9F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpGetDeviceInformation(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
    ...
    && (unsigned int)(*(_DWORD *)(v6 + 20) - 2) <= 1 )
  {
    if ( KeGetCurrentIrql() )
    {
      ...
      *(_QWORD *)(v8 + 24) = &DpGetDeviceInformation;
    ...
    *a2 = *(_QWORD *)(v6 + 48);
    ...
    a2[5] = DpGlobals;
    a2[6] = *(&DpGlobals + 1);
    *((_OWORD *)a2 + 1) = *(_OWORD *)(v6 + 496);
    a2[7] = *(_QWORD *)(v6 + 736);
    a2[8] = *(_QWORD *)(v6 + 728);
    if ( *(_DWORD *)(*(_QWORD *)(v6 + 40) + 28LL) >= 0x104Eu && *(_BYTE *)(v6 + 1060) == 1 )
    {
