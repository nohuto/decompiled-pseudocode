/*
 * XREFs of DpiSuspendAdapterDpc @ 0x1C00239D0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v5[4] = *((int *)DeferredContext + 678);
  v5[5] = *((int *)DeferredContext + 679);
  WdLogEvent5_WdTrace(v5);
  if ( *((_DWORD *)DeferredContext + 678) != 4 && *((_DWORD *)DeferredContext + 679) == 1 )
