/*
 * XREFs of ?FlipOverlay@DXGOVERLAY@@QEAAJPEAU_D3DKMT_FLIPOVERLAY@@@Z @ 0x1C0142498
 * Callers:
...
__int64 __fastcall DXGOVERLAY::FlipOverlay(DXGOVERLAY *this, struct _D3DKMT_FLIPOVERLAY *a2)
{
  ...
  __int64 v36; // r8
  __int64 v37; // r9
  _DXGKARG_FLIPOVERLAY v38; // [rsp+30h] [rbp-38h] BYREF
  struct _EX_RUNDOWN_REF *v39; // [rsp+80h] [rbp+18h] BYREF
  ...
  DXGPROCESS::GetAllocationSafe(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 40LL), (DXGALLOCATIONREFERENCE *)&v39, a2->hSource);
  if ( !v39 )
    goto LABEL_28;
  v18 = *(_QWORD *)(v3 + 16);
  v17 = *(_QWORD *)(*(_QWORD *)(v39[1].Count + 16) + 16LL);
  v19 = *(_QWORD *)(v18 + 16);
...
LABEL_30:
    DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v39, v21, v22, v23);
    return (unsigned int)v3;
  }
  Count = v39[6].Count;
  v16 = *(unsigned int *)(Count + 4);
  if ( (v16 & 8) == 0 || (v39[9].Count & 0x100) == 0 )
  {
LABEL_28:
...
LABEL_29:
    ...
    v31 = v38.PrivateDriverDataSize;
    pPrivateDriverData = a2->pPrivateDriverData;
    v33 = (ULONG64)pPrivateDriverData + v38.PrivateDriverDataSize;
  ...
  v34 = ADAPTER_RENDER::DdiFlipOverlay(
          *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 16LL) + 16LL) + 1984LL),
          *(void **)(v3 + 40),
          &v38);
  if ( v34 >= 0 )
    *(_QWORD *)(v3 + 48) = v39;
  operator delete(v38.pPrivateDriverData);
  DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v39, v35, v36, v37);
