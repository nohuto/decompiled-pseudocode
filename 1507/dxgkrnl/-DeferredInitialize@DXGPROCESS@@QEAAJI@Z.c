/*
 * XREFs of ?DeferredInitialize@DXGPROCESS@@QEAAJI@Z @ 0x1C00857B8
 * Callers:
...
__int64 __fastcall DXGPROCESS::DeferredInitialize(DXGPROCESS *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = 0LL;
  if ( *(_QWORD *)(*((_QWORD *)this + 9) + 8 * v4 + 16) )
  {
  ...
  *(_QWORD *)(v12 + 8 * v13 + 16) = v9;
  ...
  v16 = (*(__int64 (__fastcall **)(DXGPROCESS *))(*(_QWORD *)(v15 + 8) + 336LL))(this);
  v12 = *((_QWORD *)this + 9);
