/*
 * XREFs of ?PinPathContentScaling@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C00998D0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a5)
{
  ...
  enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING v18; // ebp
  int v19; // eax
  __int64 v20; // rcx
  ...
  enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING v63; // [rsp+24h] [rbp-34h]
  ...
  v18 = *((_DWORD *)Path + 28);
  v63 = v18;
  v19 = DMMVIDPNPRESENTPATH::PinContentScaling(Path, (enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING)v6);
  v5 = v19;
  if ( v19 < 0 )
  {
...
LABEL_23:
    ...
    v30 = VIDPN_MGR::_EnumVidPnCofuncModality(v26, (__int64)v27, 7, v64);
    v5 = v30;
    if ( v30 >= 0 )
    {
LABEL_14:
...
LABEL_39:
  if ( v18 == D3DKMDT_VPPS_UNPINNED )
    v58 = DMMVIDPNPRESENTPATH::UnpinContentScaling(v17);
  else
    v58 = DMMVIDPNPRESENTPATH::PinContentScaling(v17, v18);
  if ( v58 < 0 )
  {
...
LABEL_17:
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v32, &EventProfilerExit, v33, 6026);
