/*
 * XREFs of DxgkSetModeFlags @ 0x1C00DE290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetModeFlags(struct _LUID *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rsi
  char v5; // bp
  ...
  __int64 v27; // rax
  __int64 v28; // rax
  _QWORD v29[8]; // [rsp+20h] [rbp-48h] BYREF
...
LABEL_17:
  ...
  else
  {
    ...
    if ( !v30 )
    {
      ...
      *(_QWORD *)(v26 + 24) = 25367LL;
      WdLogEvent5_WdAssertion(v26);
    }
    COREADAPTERACCESS::COREADAPTERACCESS((COREADAPTERACCESS *)v29, v16, 0LL);
    PairingAdapters = (int)COREADAPTERACCESS::AcquireExclusive(v29);
    ...
    else
    {
      ...
      {
        if ( (v5 & 1) != 0 )
          ADAPTER_DISPLAY::MarkCommitVidPnOnModeChange((PERESOURCE **)v21, v4, 1);
        LODWORD(PairingAdapters) = 0;
      }
    }
