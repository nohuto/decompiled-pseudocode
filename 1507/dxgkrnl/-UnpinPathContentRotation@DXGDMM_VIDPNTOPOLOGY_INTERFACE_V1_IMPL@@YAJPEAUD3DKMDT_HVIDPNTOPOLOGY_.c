/*
 * XREFs of ?UnpinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C00DE8E0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  if ( a4 )
  {
    v25 = VIDPN_MGR::_EnumVidPnCofuncModality(v23, v24, 10, v42);
    v6 = v25;
    if ( v25 < 0 )
    {
...
LABEL_15:
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v27, &EventProfilerExit, v28, 6029);
