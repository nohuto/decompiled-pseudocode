/*
 * XREFs of ??0ApplyPermissionWithinThisScope@@IEAA@QEAVProtectableFromChange@@EW4ActionPermission_T@1@E_KE@Z @ 0x1C00973C8
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  *(_BYTE *)(a1 + 9) = _bittest(&v9, v6);
  if ( (unsigned __int64)v6 >= *(_QWORD *)(a2 + 40) )
  {
    v15 = WdLogNewEntry5_WdAssertion(v6, a2, a3, a4);
    WdLogEvent5_WdAssertion(v15);
  }
  LOBYTE(v10) = *(_BYTE *)(v6 + *(_QWORD *)(a2 + 48));
  *(_BYTE *)(a1 + 11) = v10;
  if ( (unsigned __int64)v6 >= *(_QWORD *)(a2 + 80) )
  {
    v16 = WdLogNewEntry5_WdAssertion(v10, a2, a3, a4);
    WdLogEvent5_WdAssertion(v16);
  }
  v11 = *(_BYTE *)(a1 + 9) == 0;
  v12 = *(_QWORD *)(*(_QWORD *)(a2 + 88) + 8LL * v6);
  *(_QWORD *)(a1 + 16) = v12;
  if ( v11 )
  {
    if ( (*(_BYTE *)(a1 + 11) & 0xF) != 0 )
    {
      v17 = WdLogNewEntry5_WdAssertion(v12, a2, a3, a4);
      WdLogEvent5_WdAssertion(v17);
    }
    if ( *(_QWORD *)(a1 + 16) )
    {
      v18 = WdLogNewEntry5_WdAssertion(v12, a2, a3, a4);
      WdLogEvent5_WdAssertion(v18);
    }
    if ( !*(_BYTE *)(a1 + 9) )
      ProtectableFromChange::AllowModifyingAction((ProtectableFromChange *)a2, v6, a6, a4);
  }
  return a1;
}
