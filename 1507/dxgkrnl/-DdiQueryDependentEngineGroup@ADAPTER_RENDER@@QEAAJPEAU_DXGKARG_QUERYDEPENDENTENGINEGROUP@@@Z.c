/*
 * XREFs of ?DdiQueryDependentEngineGroup@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYDEPENDENTENGINEGROUP@@@Z @ 0x1C00185C4
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryDependentEngineGroup@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYDEPENDENTENGINEGROUP@@@Z @ 0x1C001CE00 (-ADAPTER_RENDER_DdiQueryDependentEngineGroup@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYDEPENDENT.c)
 * Callees:
...
LABEL_13:
  ...
  v11 = *(_DWORD *)(v6 + 136);
LABEL_14:
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDEPENDENTENGINEGROUP *))(*((_QWORD *)this + 2) + 664LL))(
  ...
  v17[6] = DependentNodeOrdinalMask;
  if ( (_DWORD)v12 )
  {
    v19 = WdLogNewEntry5_WdError(DependentNodeOrdinalMask);
    *(_QWORD *)(v19 + 24) = v12;
    WdLogEvent5_WdError(v19);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v20, &EventProfilerExit, v21, 5049);
