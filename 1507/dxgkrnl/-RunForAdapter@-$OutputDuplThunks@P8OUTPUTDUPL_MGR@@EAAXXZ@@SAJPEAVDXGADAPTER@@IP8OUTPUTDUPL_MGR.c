/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@P8OUTPUTDUPL_MGR@@EAAXXZ@@SAJPEAVDXGADAPTER@@IP8OUTPUTDUPL_MGR@@EAAXXZP6AJPEAV3@1@Z@Z @ 0x1C0155068
 * Callers:
 *     ?ProcessLockScreenAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C0154C90 (-ProcessLockScreenAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z.c)
 * Callees:
        ...
        __int64 (__fastcall *a4)(struct OUTPUTDUPL_MGR *, void (__fastcall *)(OUTPUTDUPL_MGR *this)))
{
  ...
  if ( a1 )
  {
    OutputDuplManager = FindOutputDuplManager(a1, 0LL, &v25, &v24, &v22);
  ...
  {
    RemoteOutputDuplMgr = FindRemoteOutputDuplMgr(0LL, a2, a3, (__int64)a4);
