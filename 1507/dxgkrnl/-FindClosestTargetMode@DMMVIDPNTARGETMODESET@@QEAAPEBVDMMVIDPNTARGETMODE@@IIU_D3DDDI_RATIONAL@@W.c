/*
 * XREFs of ?FindClosestTargetMode@DMMVIDPNTARGETMODESET@@QEAAPEBVDMMVIDPNTARGETMODE@@IIU_D3DDDI_RATIONAL@@W4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@EEE@Z @ 0x1C002BF84
 * Callers:
 ...
 *     ??$DIFF@I@@YAIII@Z @ 0x1C0008614 (--$DIFF@I@@YAIII@Z.c)
