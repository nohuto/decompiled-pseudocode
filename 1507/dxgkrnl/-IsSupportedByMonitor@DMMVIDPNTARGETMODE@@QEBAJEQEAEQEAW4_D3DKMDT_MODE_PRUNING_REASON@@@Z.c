/*
 * XREFs of ?IsSupportedByMonitor@DMMVIDPNTARGETMODE@@QEBAJEQEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C00976F8
 * Callers:
        ...
        enum _D3DKMDT_MODE_PRUNING_REASON *const a4)
{
  ...
  if ( !a3 )
  {
    v16 = WdLogNewEntry5_WdAssertion(this, a2, 0LL, a4);
...
LABEL_14:
  ...
  v11 = *(_QWORD *)(*(_QWORD *)(v10 + 96) + 96LL);
  if ( v11 )
  {
    v23 = D3DKMDT_MPR_UNINITIALIZED;
    v22 = 0;
    LOBYTE(a3) = v6;
    IsSupportedMode = MonitorIsSupportedMode(v11, (char *)this + 72, a3, &v22, &v23);
    v14 = IsSupportedMode;
