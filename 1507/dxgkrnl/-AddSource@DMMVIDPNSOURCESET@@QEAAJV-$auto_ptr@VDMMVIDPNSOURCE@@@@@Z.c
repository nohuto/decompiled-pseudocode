/*
 * XREFs of ?AddSource@DMMVIDPNSOURCESET@@QEAAJV?$auto_ptr@VDMMVIDPNSOURCE@@@@@Z @ 0x1C0097684
 * Callers:
...
__int64 __fastcall DMMVIDPNSOURCESET::AddSource(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  v6 = IndexedSet<DMMVIDPNSOURCE>::FindById(a1, *(_DWORD *)(*a2 + 24LL));
  if ( v6 )
    LODWORD(v8) = v6 != v7;
  else
    LODWORD(v8) = Set<DMMVIDPNSOURCE>::Add(a1, v7) != 0 ? 2 : 0;
  v8 = (unsigned int)v8;
  if ( (_DWORD)v8 )
  {
