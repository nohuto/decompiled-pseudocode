/*
 * XREFs of OutputDuplGetDiagnosticBuffer @ 0x1C0156310
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( a1 )
  {
    ...
    RemoteOutputDuplMgr = (DXGDIAGNOSTICSWITHMUTEX **)v21;
  }
  else
  {
    RemoteOutputDuplMgr = (DXGDIAGNOSTICSWITHMUTEX **)FindRemoteOutputDuplMgr(0LL, (__int64)a2, a3, a4);
  }
  ...
  else
  {
    ...
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v13, v12, v14, v15) + 24) = 2739LL;
  }
LABEL_9:
  if ( v19 )
