/*
 * XREFs of ?DpiBrightnessQueryInterface@@YAJPEAU_DEVICE_OBJECT@@PEAU_QUERY_INTERFACE@@@Z @ 0x1C00C5290
 * Callers:
...
__int64 __fastcall DpiBrightnessQueryInterface(_QWORD *Object, struct _QUERY_INTERFACE *a2)
{
    ...
    && a2->Size == 88 )
  {
    ...
    if ( !v6 )
      return 3221225659LL;
    memmove(a2->Interface, (const void *)(v2 + 2984), v6);
  }
  else
  {
    ...
    *(_OWORD *)&Interface->Size = *(_OWORD *)(v2 + 3072);
    *(_OWORD *)&Interface->InterfaceReference = *(_OWORD *)(v2 + 3088);
    *(_OWORD *)&Interface[1].Size = *(_OWORD *)(v2 + 3104);
    Interface[1].InterfaceReference = *(PINTERFACE_REFERENCE *)(v2 + 3120);
  }
