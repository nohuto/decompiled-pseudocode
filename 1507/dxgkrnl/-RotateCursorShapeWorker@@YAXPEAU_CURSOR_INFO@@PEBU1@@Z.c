/*
 * XREFs of ?RotateCursorShapeWorker@@YAXPEAU_CURSOR_INFO@@PEBU1@@Z @ 0x1C01465BC
 * Callers:
 ...
 * Callees:
 *     ?GetRotatedPoint@@YAXIIPEAI0W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@II@Z @ 0x1C01462D4 (-GetRotatedPoint@@YAXIIPEAI0W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@II@Z.c)
 */

void __fastcall RotateCursorShapeWorker(struct _CURSOR_INFO *a1, const struct _CURSOR_INFO *a2)
{
