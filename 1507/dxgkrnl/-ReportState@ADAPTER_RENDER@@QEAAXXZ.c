/*
 * XREFs of ?ReportState@ADAPTER_RENDER@@QEAAXXZ @ 0x1C0127ED4
 * Callers:
 *     ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C0127FA4 (-ReportState@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0010930 (_guard_dispatch_icall_nop.c)
 *     ?ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ @ 0x1C0134EB8 (-ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ.c)
...
void __fastcall ADAPTER_RENDER::ReportState(ADAPTER_RENDER *this)
{
  ...
  (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 50) + 8LL) + 48LL))(*((_QWORD *)this + 51));
  (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 47) + 8LL) + 56LL))(*((_QWORD *)this + 48));
}
