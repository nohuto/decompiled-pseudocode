/*
 * XREFs of ?NotifyContextCreation@DXGADAPTER@@QEAAXPEAVDXGCONTEXT@@EI@Z @ 0x1C000239C
 * Callers:
...
void __fastcall DXGADAPTER::NotifyContextCreation(DXGADAPTER *this, struct DXGCONTEXT *a2, char a3, int a4)
{
  ...
  if ( *((_DWORD *)a2 + 32) != 2 )
  {
    ...
    {
      v10 = *((_QWORD *)this + 251) + 520LL * i;
      if ( !*(_DWORD *)(v10 + 208)
        && (a4 == *(_DWORD *)(v10 + 212) && *((_DWORD *)a2 + 82) == *(unsigned __int16 *)(v10 + 6)
         || *(_BYTE *)(v10 + 358)) )
      {
        DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v23, (DXGADAPTER *)((char *)this + 2472), 1u);
        if ( a3 )
        {
          if ( ++*(_DWORD *)(v10 + 416) == 1 )
          {
            v11 = *(_DWORD *)(v10 + 4);
            *(_DWORD *)(v10 + 384) = 0;
            DXGADAPTER::SetPowerComponentLatencyCB(this, v11, **((_QWORD **)this + 287));
            if ( *(int *)(v10 + 388) > 0 )
            {
              v12 = MEMORY[0xFFFFF78000000320];
              *(_QWORD *)(v10 + 392) = MEMORY[0xFFFFF78000000320];
              *(_QWORD *)(v10 + 392) = v12 + *(_QWORD *)(*((_QWORD *)this + 287) + 8LL);
              v13 = (_QWORD *)(v10 + 400);
              if ( !*v13 )
              {
                v14 = *((_QWORD *)this + 307);
                *v13 = v14;
                v13[1] = (char *)this + 2456;
                if ( *(DXGADAPTER **)(v14 + 8) != (DXGADAPTER *)((char *)this + 2456) )
                  __fastfail(3u);
                *(_QWORD *)(v14 + 8) = v13;
                *((_QWORD *)this + 307) = v13;
              }
              if ( !*((_BYTE *)this + 2444) )
              {
                v15 = *((_QWORD *)this + 248);
                *((_BYTE *)this + 2444) = 1;
                v16 = *(_QWORD *)(*(_QWORD *)(v15 + 376) + 8LL);
                v17 = *(void (__fastcall **)(_QWORD, __int64))(v16 + 752);
                LOBYTE(v16) = 1;
                v17(*(_QWORD *)(v15 + 384), v16);
              }
            }
          }
        }
        else if ( (*(_DWORD *)(v10 + 416))-- == 1 )
        {
          v19 = *(_DWORD *)(v10 + 4);
          *(_DWORD *)(v10 + 384) = 2;
          DXGADAPTER::SetPowerComponentLatencyCB(this, v19, *(_QWORD *)(*((_QWORD *)this + 287) + 32LL));
          v20 = (_QWORD *)(v10 + 400);
          if ( *v20 )
          {
            v21 = *v20;
    ...
    if ( a3 )
      v9 = _InterlockedIncrement((volatile signed __int32 *)this + 541);
    else
      v9 = _InterlockedExchangeAdd((volatile signed __int32 *)this + 541, 0xFFFFFFFF);
    if ( v9 == 1 )
    {
      if ( *((_QWORD *)this + 252) )
