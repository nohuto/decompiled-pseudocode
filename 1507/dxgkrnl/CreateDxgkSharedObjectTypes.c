/*
 * XREFs of CreateDxgkSharedObjectTypes @ 0x1C00DCD50
 * Callers:
...
__int64 CreateDxgkSharedObjectTypes()
{
  ...
  if ( g_pDxgkSharedAllocationObjectType
    || (v1 = (_GENERIC_MAPPING)xmmword_1C002FA50,
        ...
        (int)result >= 0) )
  {
    ...
    {
      v1 = (_GENERIC_MAPPING)xmmword_1C002FA40;
      result = CreateSharedObject(
    ...
    {
      v1 = (_GENERIC_MAPPING)xmmword_1C002FA30;
