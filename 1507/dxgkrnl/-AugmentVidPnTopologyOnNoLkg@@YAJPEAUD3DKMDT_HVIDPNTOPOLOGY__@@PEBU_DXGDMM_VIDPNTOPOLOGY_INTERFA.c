/*
 * XREFs of ?AugmentVidPnTopologyOnNoLkg@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@PEAXPEBU_DXGDMM_INTERFACE@@IW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@GEQEA_KQEAI@Z @ 0x1C013A5E8
 * Callers:
    ...
    if ( v28 == -1071774925 )
    {
      ...
      *(_QWORD *)(v31 + 32) = a5;
      ...
      if ( v32 >= 0 )
      {
        if ( a7 == -1 )
        {
          v38 = WdLogNewEntry5_WdAssertion(v29, v33, v34, v35);
          *(_QWORD *)(v38 + 24) = 2809LL;
