/*
 * XREFs of DpiLdaLinkDeviceToChain @ 0x1C016F870
 * Callers:
...
__int64 __fastcall DpiLdaLinkDeviceToChain(__int64 a1)
{
  ...
  if ( *(_QWORD *)v4 != v4 )
  {
    do
    {
      ...
      if ( *(_BYTE *)(v9 + 476) == 1 || *(_DWORD *)(v8 + 1480) >= *(_DWORD *)(v8 + 472) )
      {
        v2 = -1071774666;
      ...
      *(_QWORD *)(v9 + 1472) = *(_QWORD *)(v8 + 24);
      *(_DWORD *)(v9 + 1480) = *(_DWORD *)(v8 + 1480);
      *(_QWORD *)(*(_QWORD *)(v8 + 1472) + 8LL * (unsigned int)(*(_DWORD *)(v8 + 1480))++) = *(_QWORD *)(v9 + 24);
      if ( *(_BYTE *)(v9 + 1056) )
        *(_BYTE *)(v8 + 1057) = 1;
      if ( *(_BYTE *)(v4 + 451) )
