/*
 * XREFs of DxgkQueryClockCalibration @ 0x1C012B090
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  *(_DWORD *)(((unsigned __int64)&v46 & 0xFFFFFFFFFFFFFFC0uLL) + 0x68) = *(_DWORD *)(v11 + 32);
  ...
  if ( v25 >= 0 )
  {
    v33 = (ADAPTER_RENDER *)*((_QWORD *)v24 + 248);
    v34 = *((_QWORD *)v33 + 2);
    if ( *(_QWORD *)(v34 + 768) && *(int *)(v34 + 1648) >= 0x2000 )
    {
