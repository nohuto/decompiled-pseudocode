/*
 * XREFs of ?FindClosestTargetMode@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJPEBU_D3DKMT_DISPLAYMODE@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@EEEPEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C0178B10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _D3DKMDT_VIDPN_TARGET_MODE *a6)
{
  ...
  __int64 v28; // rax
  __int64 v29; // rax
  struct _D3DKMDT_VIDPN_TARGET_MODE *v30; // rbx
  __int64 v31; // rax
  __int64 v32; // rax
  ...
  if ( a6 && this )
  {
    *(_QWORD *)&a6->Id = 0LL;
    ...
    else
    {
      ...
      v29 = WdLogNewEntry5_WdDmmEvent(v19);
      *(_QWORD *)(v29 + 24) = v13;
  ...
  {
    v32 = WdLogNewEntry5_WdError(this);
    *(_QWORD *)(v32 + 24) = a2;
