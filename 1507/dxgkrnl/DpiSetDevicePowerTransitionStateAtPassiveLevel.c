/*
 * XREFs of DpiSetDevicePowerTransitionStateAtPassiveLevel @ 0x1C002391C
 * Callers:
...
void __fastcall DpiSetDevicePowerTransitionStateAtPassiveLevel(__int64 a1, int a2, char a3)
{
  ...
  if ( (_DWORD)v3 != 5 || *(_DWORD *)(a1 + 2712) == 4 )
  {
  ...
  if ( a3 && !*(_DWORD *)(a1 + 2716) )
  {
    ...
    DxgkReportDevicePoweredOn(*(_QWORD *)(a1 + 2504));
  }
