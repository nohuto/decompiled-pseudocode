/*
 * XREFs of DpiGdoDispatchCreate @ 0x1C00A92D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiGdoDispatchCreate(__int64 a1, IRP *a2)
{
  ...
  else if ( *(_BYTE *)(v3 + 1058) && *(_BYTE *)(v3 + 448) )
  {
    v6 = dword_1C0046F30 != 4 ? 0xC0000001 : 0;
  }
  else
  {
    KeEnterCriticalRegion();
    v4 = (struct _ERESOURCE *)(v3 + 2400);
    ExAcquireResourceExclusiveLite((PERESOURCE)(v3 + 2400), 1u);
    v5 = *(_DWORD *)(v3 + 236);
