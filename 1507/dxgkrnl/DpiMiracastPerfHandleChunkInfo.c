/*
 * XREFs of DpiMiracastPerfHandleChunkInfo @ 0x1C0029AAC
 * Callers:
...
void __fastcall DpiMiracastPerfHandleChunkInfo(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( *(_BYTE *)(a1 + 712) && !*(_BYTE *)(a1 + 714) && (unsigned int)(*(_DWORD *)a3 - 2) <= 2 )
  {
    if ( !a2 )
    ...
    if ( *(_BYTE *)(a1 + 714) )
      goto LABEL_32;
    v6 = (_QWORD *)(a3 + 8);
    if ( (*(_QWORD *)(a3 + 8) & 0xFFFFFFFFFFuLL) <= *(_QWORD *)(a1 + 952) )
      goto LABEL_32;
    ...
    else if ( *(_DWORD *)a3 == 3 )
    {
      if ( (*v6 & 0xFFFFFF0000000000uLL) == 0 )
      {
        ...
        if ( !*(_QWORD *)(v9 + a1) )
        {
          ...
          *(_QWORD *)(v9 + a1) = v10;
          *(_QWORD *)(a1 + 944) = v10;
          *(_DWORD *)(32 * v8 + a1 + 968) = MEMORY[0xFFFFF78000000008] / 0x2710uLL;
          goto LABEL_32;
        }
      }
      v11 = 2;
    ...
    {
      v12 = 32LL * v17;
      if ( *(_BYTE *)(v12 + a1 + 986) || *(_BYTE *)(v12 + a1 + 985) )
        goto LABEL_32;
      if ( *(_DWORD *)a3 != 2 )
      {
        v13 = 32 * (v17 + 30LL);
        if ( !*(_QWORD *)(v13 + a1) )
        {
          ...
          *(_QWORD *)(v13 + a1) = v14;
          *(_QWORD *)(a1 + 944) = v14;
          *(_DWORD *)(v12 + a1 + 968) = MEMORY[0xFFFFF78000000008] / 0x2710uLL;
        }
        *(_BYTE *)(v12 + a1 + 986) = 1;
        *(_DWORD *)(v12 + a1 + 972) = 0;
        *(_DWORD *)(v12 + a1 + 976) = 0;
...
LABEL_32:
      ...
      if ( *(_QWORD *)(32 * (v17 + 30LL) + a1) )
      {
        ++*(_DWORD *)(v12 + a1 + 976);
        if ( (*v6 & 0xFFFFFF0000000000uLL) == 0 )
        {
          *(_BYTE *)(v12 + a1 + 984) = 1;
          *(_DWORD *)(v12 + a1 + 972) = MEMORY[0xFFFFF78000000008] / 0x2710uLL - *(_DWORD *)(v12 + a1 + 968);
        }
        goto LABEL_32;
      }
      v11 = 4;
