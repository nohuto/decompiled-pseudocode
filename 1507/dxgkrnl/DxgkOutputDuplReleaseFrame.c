/*
 * XREFs of DxgkOutputDuplReleaseFrame @ 0x1C0156040
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(((unsigned __int64)v10 & 0xFFFFFFFFFFFFFFC0uLL) + 8) = *(_DWORD *)(v5 + 8);
  v7 = OutputDuplThunks<_D3DKMT_OUTPUTDUPL_GET_POINTER_SHAPE_DATA *>::RunThunk(
         ...
         *(_DWORD *)(((unsigned __int64)v10 & 0xFFFFFFFFFFFFFFC0uLL) + 4),
         ...
         (__int64 (__fastcall *)(struct OUTPUTDUPL_MGR *, __int64))lambda_935e771f49f42b8b8f09f155a2ae6f70_::_helper_func_cdecl_);
  if ( v7 >= 0 )
  {
    v8 = (_DWORD *)(a1 + 8);
