/*
 * XREFs of ??RCCD_BTL_CONNECTIVITY_COLLECTOR@@QEAAJXZ @ 0x1C00632C4
 * Callers:
  ...
  do
  {
    ...
    *((_WORD *)a1 + 5) = v2;
    ...
    v7 = DXGGLOBAL::IterateAdaptersWithCallback(
           Global,
           BtlPreAcquireSharedAccess__CCD_BTL_CONNECTIVITY_COLLECTOR::_AppendConnectedSetAdaptersCallback_,
           a1,
           1LL);
    v11 = v7;
  }
