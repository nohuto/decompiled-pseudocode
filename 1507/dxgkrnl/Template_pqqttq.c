/*
 * XREFs of Template_pqqttq @ 0x1C002155C
 * Callers:
...
NTSTATUS Template_pqqttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 4LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventOutputDuplicationReleaseFrame, 0LL, 6u, &UserData);
}
