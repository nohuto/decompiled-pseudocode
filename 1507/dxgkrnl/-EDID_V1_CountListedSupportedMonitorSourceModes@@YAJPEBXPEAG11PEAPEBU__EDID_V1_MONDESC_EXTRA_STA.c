/*
 * XREFs of ?EDID_V1_CountListedSupportedMonitorSourceModes@@YAJPEBXPEAG11PEAPEBU__EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS@@1@Z @ 0x1C000C250
 * Callers:
 ...
 *     ?DenseOnesBitCount@@YAEE@Z @ 0x1C000C378 (-DenseOnesBitCount@@YAEE@Z.c)
 */
