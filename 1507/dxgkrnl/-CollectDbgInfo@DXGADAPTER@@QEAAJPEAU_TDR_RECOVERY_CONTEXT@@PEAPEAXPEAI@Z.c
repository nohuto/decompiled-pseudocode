/*
 * XREFs of ?CollectDbgInfo@DXGADAPTER@@QEAAJPEAU_TDR_RECOVERY_CONTEXT@@PEAPEAXPEAI@Z @ 0x1C011FAD8
 * Callers:
 ...
 *     ?CollectDbgInfo@ADAPTER_DISPLAY@@QEAAJPEAUDXGADAPTERDBGINFO@@@Z @ 0x1C011FA74 (-CollectDbgInfo@ADAPTER_DISPLAY@@QEAAJPEAUDXGADAPTERDBGINFO@@@Z.c)
 */
        ...
        unsigned int *a4)
{
  ...
  *v16 = *v14;
  ...
  v16[2] = v14[2];
  v16[3] = v14[3];
  v18 = (ADAPTER_DISPLAY *)this[247];
  if ( v18 )
    ADAPTER_DISPLAY::CollectDbgInfo(v18, (struct DXGADAPTERDBGINFO *)v13);
  v19 = this[248];
  if ( v19 )
  {
    *(_OWORD *)(v13 + 776) = *(_OWORD *)&v19[4].ExclusiveWaiters;
    *(_OWORD *)(v13 + 792) = *(_OWORD *)&v19[4].OwnerEntry.0;
  }
  *a3 = (char *)*a3 + 1064;
  *a4 -= 1064;
  return 0LL;
