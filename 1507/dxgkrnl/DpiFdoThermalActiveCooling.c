/*
 * XREFs of DpiFdoThermalActiveCooling @ 0x1C016B0F0
 * Callers:
...
void __fastcall DpiFdoThermalActiveCooling(__int64 a1, unsigned __int8 a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 64);
  v5 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v2 + 64), DpiFdoThermalActiveCooling, &byte_1C00E2920, 1u, 0x20u);
  v7 = v5;
  if ( v5 >= 0 )
  {
    ...
    else
    {
      ...
      LOBYTE(v9) = a2;
      (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(v2 + 3296) + 48LL))(
        *(_QWORD *)(*(_QWORD *)(v2 + 3296) + 16LL),
        v9);
      DpiReleaseCoreSyncAccessSafe(a1, 0);
    }
    *(_BYTE *)(*(_QWORD *)(v2 + 3296) + 2LL) = a2;
    if ( *(_BYTE *)(v2 + 451) )
