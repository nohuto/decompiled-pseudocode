/*
 * XREFs of ?DdiSetVidPnSourceVisibility@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETVIDPNSOURCEVISIBILITY@@@Z @ 0x1C00B5660
 * Callers:
...
LABEL_25:
  v14 = 0;
LABEL_12:
  v16 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETVIDPNSOURCEVISIBILITY *))(*((_QWORD *)this + 2) + 488LL))(
  ...
  {
    v22 = *((_QWORD *)this + 14);
    *(_BYTE *)(1008LL * a2->VidPnSourceId + v22 + 697) = a2->Visible;
  }
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
