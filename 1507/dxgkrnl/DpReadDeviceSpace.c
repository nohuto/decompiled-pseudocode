/*
 * XREFs of DpReadDeviceSpace @ 0x1C000F310
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
    ...
    v14 = *(__int64 (__fastcall **)(_QWORD, void *, _QWORD, _QWORD))(a1 + 1584);
    if ( v14 )
    {
      BusDataByOffset = v14(*(_QWORD *)(a1 + 1560), a3, Offset, Length);
      goto LABEL_12;
    }
LABEL_24:
    v6 = -1073741823;
  ...
  v9 = *(__int64 (__fastcall **)(_QWORD, __int64, void *, _QWORD, ULONG))(a1 + 584);
  if ( !v9 )
    goto LABEL_24;
  BusDataByOffset = v9(*(_QWORD *)(a1 + 536), a2, a3, Offset, Length);
LABEL_12:
  *a6 = BusDataByOffset;
