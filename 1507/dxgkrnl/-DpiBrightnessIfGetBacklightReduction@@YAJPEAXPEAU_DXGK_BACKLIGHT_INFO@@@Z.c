/*
 * XREFs of ?DpiBrightnessIfGetBacklightReduction@@YAJPEAXPEAU_DXGK_BACKLIGHT_INFO@@@Z @ 0x1C016C470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightnessIfGetBacklightReduction(_QWORD *a1, struct _DXGK_BACKLIGHT_INFO *a2)
{
  ...
  if ( *(_QWORD *)(v2 + 3160) )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGK_BACKLIGHT_INFO *))(v2 + 3208))(*(_QWORD *)(v2 + 3136), a2);
