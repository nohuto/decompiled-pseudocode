/*
 * XREFs of ?GetSavedCursor@DISPLAY_SOURCE@@QEAAPEAU_DXGKARG_SETPOINTERSHAPE@@XZ @ 0x1C01266E0
 * Callers:
...
struct _DXGKARG_SETPOINTERSHAPE *__fastcall DISPLAY_SOURCE::GetSavedCursor(DISPLAY_SOURCE *this)
{
  ...
  if ( !*((_QWORD *)this + 92) )
  {
    ...
    if ( !is_mul_ok((unsigned int)(*(_DWORD *)(v7 + 1336) * *(_DWORD *)(v7 + 1340)), 4uLL) )
      v8 = -1LL;
    *((_QWORD *)this + 92) = operator new[](v8, 0x4B677844u, PagedPool);
  }
