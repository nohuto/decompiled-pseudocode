/*
 * XREFs of DxgkInternalDeviceIoctl @ 0x1C00AE840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z @ 0x1C00D8D58 (-DxgkWin32kQueryInterface@@YAJPEAU_DXGKWIN32K_INTERFACE@@PEAK@Z.c)
 *     DxgkCaptureQueryInterface @ 0x1C013142C (DxgkCaptureQueryInterface.c)
...
LABEL_60:
  ...
  switch ( (_DWORD)v7 )
  {
    case 0x232063:
      ...
      goto LABEL_42;
    case 0x23E057:
      if ( (unsigned int)v9 < 0x6D0 || (unsigned int)v8 < 0x6D0 )
      {
        v29 = (_QWORD *)WdLogNewEntry5_WdAssertion(a1, a2, a3, a4);
      ...
      goto LABEL_11;
    case 0x23E05B:
      if ( (unsigned int)v9 >= 0x1C8 && (unsigned int)v8 >= 0x1C8 )
      {
