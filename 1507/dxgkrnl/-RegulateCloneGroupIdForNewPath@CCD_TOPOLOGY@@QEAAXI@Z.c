/*
 * XREFs of ?RegulateCloneGroupIdForNewPath@CCD_TOPOLOGY@@QEAAXI@Z @ 0x1C017DBC0
 * Callers:
        ...
        __int64 a4)
{
  ...
  v4 = a2;
  *((_DWORD *)CCD_TOPOLOGY::GetPathDescriptor((CCD_TOPOLOGY *)this, a2, a3, a4) + 50) = -1;
  ...
  if ( (_WORD)v11 )
  {
    ...
    do
    {
      ...
      if ( (*(_DWORD *)v18 & 0x40000) == 0 )
      {
        ...
        *(_QWORD *)(v19 + 24) = 6107LL;
        WdLogEvent5_WdAssertion(v19);
      }
      PrimaryPathInCloneGroup = GetPrimaryPathInCloneGroup(this[8], v13--);
      *((_DWORD *)v18 + 50) = PrimaryPathInCloneGroup | 0xFE558000;
      --v12;
    }
    while ( v12 );
  }
