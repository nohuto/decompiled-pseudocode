/*
 * XREFs of DpiAcpiExposeInfo @ 0x1C00D4360
 * Callers:
...
__int64 __fastcall DpiAcpiExposeInfo(__int64 a1)
{
  ...
  *(_DWORD *)&Source.Length = 65537;
  Source.Buffer = (PCHAR)&byte_1C00E2920;
    ...
    if ( *(_DWORD *)Buffer == 1198089537 && *((_DWORD *)Buffer + 1) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        if ( *((_DWORD *)v7 + 1) > 1u )
        {
          ...
          while ( v8 < *((_DWORD *)v1[119].Buffer + 1) );
        }
        ...
        if ( Destination.Length )
        {
          ...
          *(_DWORD *)&DestinationString.Length = 0;
          ...
          ObjectAttributes.ObjectName = v1 + 30;
      ...
      {
        v3 = -1073741801;
        v10 = (_QWORD *)WdLogNewEntry5_WdLowResource(v6);
        v10[3] = DpiAcpiExposeInfo;
        v10[4] = ExAllocatePoolWithTag;
        v10[5] = -1073741801LL;
