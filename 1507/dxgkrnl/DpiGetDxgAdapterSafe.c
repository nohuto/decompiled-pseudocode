/*
 * XREFs of DpiGetDxgAdapterSafe @ 0x1C00949E0
 * Callers:
      ...
      if ( *(_QWORD *)v7 != v7 )
      {
        do
        {
          ...
          if ( *(_DWORD *)(v7 + 16) == 1953656900 && *(_DWORD *)(v7 + 20) == 2 )
          {
            ...
            if ( v2 )
              goto LABEL_24;
            KeWaitForSingleObject((PVOID)(v7 + 2192), Executive, 0, 0, 0LL);
            v10 = *(_QWORD **)(v7 + 2176);
            v11 = v10;
            ...
            KeReleaseMutex((PRKMUTEX)(v7 + 2192), 0);
            if ( v2 )
              goto LABEL_24;
            KeEnterCriticalRegion();
            ExAcquireResourceSharedLite((PERESOURCE)(v7 + 1936), 1u);
            v13 = *(_QWORD **)(v7 + 2256);
            v14 = v13;
            ...
            ExReleaseResourceLite((PERESOURCE)(v7 + 1936));
...
LABEL_24:
    ...
    while ( *(_QWORD *)v6 != qword_1C0046C78 );
  }
