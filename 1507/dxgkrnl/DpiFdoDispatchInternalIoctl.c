/*
 * XREFs of DpiFdoDispatchInternalIoctl @ 0x1C00D8B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiFdoDispatchInternalIoctl(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  if ( v11 )
  {
    ...
    if ( (unsigned int)Options >= 0x10 && p_NamedPipeType )
    {
      ...
      v14 = (struct _ERESOURCE *)(v6 + 1936);
      ExAcquireResourceSharedLite((PERESOURCE)(v6 + 1936), 1u);
      for ( i = *(int **)(v6 + 1928); i; i += 30 )
      {
        v16 = *i;
        if ( !*i )
          break;
...
LABEL_28:
  ...
  if ( (unsigned int)Options < 0x10 || !p_NamedPipeType )
    goto LABEL_28;
  KeWaitForSingleObject((PVOID)(v6 + 2192), Executive, 0, 0, 0LL);
  v18 = p_NamedPipeType[1];
  v7 = 0;
  v19 = *p_NamedPipeType;
  for ( j = 0; j < *(_DWORD *)(v6 + 1428); ++j )
  {
  ...
  KeReleaseMutex((PRKMUTEX)(v6 + 2192), 0);
LABEL_23:
