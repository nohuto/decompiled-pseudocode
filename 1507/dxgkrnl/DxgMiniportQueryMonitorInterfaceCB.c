/*
 * XREFs of DxgMiniportQueryMonitorInterfaceCB @ 0x1C00DEAE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgMiniportQueryMonitorInterfaceCB(__int64 a1, int a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( KeGetCurrentIrql() )
  {
    v19 = *(_QWORD *)(*((_QWORD *)DxgAdapter + 22) + 64LL);
  ...
  {
    v21 = WdLogNewEntry5_WdAssertion(v8, v11, v12, v13);
    WdLogEvent5_WdAssertion(v21);
  }
  if ( !*((_QWORD *)DxgAdapter + 247) )
  {
LABEL_14:
