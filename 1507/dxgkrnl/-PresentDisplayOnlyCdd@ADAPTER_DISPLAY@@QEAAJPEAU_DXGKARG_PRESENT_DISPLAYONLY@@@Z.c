/*
 * XREFs of ?PresentDisplayOnlyCdd@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C0127320
 * Callers:
        ...
        struct _DXGKARG_PRESENT_DISPLAYONLY *a2)
{
  ...
  if ( v2
    ...
    && (v4 = *(_QWORD *)(v2 + 8)) != 0 )
  {
    return BLTQUEUE::PresentDisplayOnly((BLTQUEUE *)(v4 + 2384 * VidPnSourceId), a2);
  }
  else
  {
    return 3221225485LL;
