/*
 * XREFs of DpiMiracastCbSendUserModeMessage @ 0x1C0168D40
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v8 = a3;
  v9 = Size;
  if ( P && P[4] == 1953656900 && P[5] == 14 && *((_QWORD *)P + 38) )
  {
    ...
    LODWORD(Sizea) = v9;
    v12 = DpiMiracastSendAsyncUserModeRequest(v11, 0, 2295820, v8, Sizea, a5, a4, a6, a7, 0LL);
    v15 = v12;
    if ( v12 < 0 )
    {
