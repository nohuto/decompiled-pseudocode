/*
 * XREFs of ?FillScalingIntent@CCD_TOPOLOGY@@QEAAX_N@Z @ 0x1C0065090
 * Callers:
...
void __fastcall CCD_TOPOLOGY::FillScalingIntent(CCD_TOPOLOGY *this)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    {
      v6 = *((_DWORD *)PathDescriptor + 31);
      v7 = *((_DWORD *)PathDescriptor + 32);
      if ( v6 != v7 && (unsigned int)(v7 - 4) <= 1 )
      {
        if ( v6 == 1 )
          DxgkGetAdapterDefaultScaling(
            (struct _LUID *)PathDescriptor + 1,
            (enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING *)PathDescriptor + 32);
        else
          *((_DWORD *)PathDescriptor + 32) = v6;
      }
      EnforceDriverModelScalingPolicy((struct _LUID *)PathDescriptor + 1, (__int64)PathDescriptor + 128);
    }
    else
    {
      if ( (*(_DWORD *)PathDescriptor & 0x400) != 0 && (v8 = *((_DWORD *)PathDescriptor + 31), v8 >= 2) && v8 <= 5 )
      {
        *((_DWORD *)PathDescriptor + 32) = v8;
        EnforceDriverModelScalingPolicy((struct _LUID *)PathDescriptor + 1, (__int64)PathDescriptor + 128);
      }
      else
      {
