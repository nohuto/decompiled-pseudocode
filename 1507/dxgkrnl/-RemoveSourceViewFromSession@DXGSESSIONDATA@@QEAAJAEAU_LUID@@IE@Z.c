/*
 * XREFs of ?RemoveSourceViewFromSession@DXGSESSIONDATA@@QEAAJAEAU_LUID@@IE@Z @ 0x1C00BE00C
 * Callers:
 ...
 *     ?RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ @ 0x1C008F020 (-RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ.c)
 ...
 *     ?RemoveDisplaySource@SESSION_VIEW@@QEAAJPEAVDISPLAY_SOURCE@@PEAE@Z @ 0x1C01569F0 (-RemoveDisplaySource@SESSION_VIEW@@QEAAJPEAVDISPLAY_SOURCE@@PEAE@Z.c)
 */
        ...
        char a4)
{
  ...
  v5 = a3;
  v17[0] = 0;
  OwnedDisplaySource = DXGSESSIONDATA::GetOwnedDisplaySource(this, a2);
