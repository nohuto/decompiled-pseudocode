/*
 * XREFs of ?GetCurrentSourceResolution@DpiInternal@@YAJQEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEBU_D3DKMDT_VIDPN_PRESENT_PATH@@PEAU_D3DKMDT_2DREGION@@@Z @ 0x1C00AC250
 * Callers:
        ...
        const struct _D3DKMDT_VIDPN_PRESENT_PATH *a4)
{
  ...
  DXGDMM::AutoRelease<_D3DKMDT_VIDPN_PRESENT_PATH const *,long (*)(D3DKMDT_HVIDPNTOPOLOGY__ *,_D3DKMDT_VIDPN_PRESENT_PATH const *),D3DKMDT_HVIDPNTOPOLOGY__ *>::Own(
    ...
    *((_QWORD *)a2 + 2),
    (__int64)this);
  v28 = 0LL;
  v12 = (*(__int64 (__fastcall **)(__int64, __int64 *))(v22 + 24))(v29, &v28);
  v11 = v12;
  if ( v12 >= 0 )
  {
    v16 = *(_DWORD *)(v28 + 4);
...
LABEL_7:
      ...
      v21 = WdLogNewEntry5_WdAssertion(v13, v28, v14, v15);
      *(_QWORD *)(v21 + 24) = v28;
