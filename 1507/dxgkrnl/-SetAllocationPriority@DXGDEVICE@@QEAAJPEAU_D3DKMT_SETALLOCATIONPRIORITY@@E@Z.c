/*
 * XREFs of ?SetAllocationPriority@DXGDEVICE@@QEAAJPEAU_D3DKMT_SETALLOCATIONPRIORITY@@E@Z @ 0x1C012DD54
 * Callers:
        ...
        __int64 a4)
{
  ...
  struct _EX_RUNDOWN_REF *v33; // [rsp+68h] [rbp+10h] BYREF
  ...
  if ( (_DWORD)hResource )
  {
    ...
    v15 = *pPriorities;
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v32, (struct DXGFASTMUTEX *const)&v33[10]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v32);
    for ( i = v33[3].Count; i; i = *(_QWORD *)(i + 64) )
  ...
  else if ( a2->AllocationCount )
  {
    for ( j = 0LL; (unsigned int)j < a2->AllocationCount; j = (unsigned int)(j + 1) )
    {
      ...
      v21 = *v20;
      DXGPROCESS::GetAllocationSafe(*((_QWORD *)this + 5), (DXGALLOCATIONREFERENCE *)&v33, v19);
      if ( !v33 )
      {
        ...
        DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v33, v26, v27, v28);
        return 3221225485LL;
      }
      VIDMM_EXPORT::VidMmSetAllocationPriority(
        *(VIDMM_EXPORT **)(*((_QWORD *)this + 2) + 400LL),
        *(struct VIDMM_GLOBAL **)(*((_QWORD *)this + 2) + 408LL),
        (struct _VIDMM_MULTI_ALLOC *)v33[3].Count,
        v21);
      DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v33, v29, v30, v31);
    }
  }
  return 0LL;
}
