/*
 * XREFs of ?DpiBrightnessSetupAggregateEvents@@YAXPEAU_DEVICE_OBJECT@@@Z @ 0x1C016CA84
 * Callers:
...
void __fastcall DpiBrightnessSetupAggregateEvents(struct _DEVICE_OBJECT *a1)
{
  ...
  memset(DeviceExtension + 358, 0, 0x30uLL);
  v3 = 2LL;
  DeviceExtension[360] = &WNF_SEB_SYSTEM_AC;
  DeviceExtension[363] = &WNF_SEB_FULL_SCREEN_VIDEO_PLAYBACK;
  v4 = DeviceExtension + 359;
  do
  {
