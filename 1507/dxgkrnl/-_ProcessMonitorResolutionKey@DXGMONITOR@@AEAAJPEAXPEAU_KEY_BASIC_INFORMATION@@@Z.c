/*
 * XREFs of ?_ProcessMonitorResolutionKey@DXGMONITOR@@AEAAJPEAXPEAU_KEY_BASIC_INFORMATION@@@Z @ 0x1C00C932C
 * Callers:
 ...
 *     ?IsValidFrequencyRange@@YAJAEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x1C00DD46C (-IsValidFrequencyRange@@YAJAEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z.c)
        ...
        struct _KEY_BASIC_INFORMATION *a3)
{
  ...
  v44.Buffer = a3->Name;
  if ( !(unsigned __int8)ParseResolutionKeyName((const void **)&v44, (int)&v39, (int)&v38) )
  {
  ...
  while ( 1 )
  {
    ...
    v40 = 0;
    v41 = 0;
    v23 = ParseFreqRangeValue((_DWORD)v42, (unsigned int)&v38, (unsigned int)&v39, (unsigned int)&v40, (__int64)&v41);
    operator delete(v42);
    if ( !v23 )
      break;
    ...
    v25->RangeLimits.MinVSyncFreq.Numerator = v38;
    v25->RangeLimits.MaxVSyncFreq.Numerator = v39;
