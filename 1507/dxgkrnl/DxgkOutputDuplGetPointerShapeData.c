/*
 * XREFs of DxgkOutputDuplGetPointerShapeData @ 0x1C0155DD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOutputDuplGetPointerShapeData(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v16; // rcx
  __int64 v17; // r8
  __int64 v18; // [rsp+60h] [rbp+0h] BYREF

  v3 = (_QWORD *)((unsigned __int64)&v18 & 0xFFFFFFFFFFFFFFC0uLL);
  v4 = a1;
  *(_DWORD *)(((unsigned __int64)&v18 & 0xFFFFFFFFFFFFFFC0uLL) + 8) = 2065;
  ...
  *(_QWORD *)(((unsigned __int64)&v18 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = *(_QWORD *)(v5 + 48);
  v6 = operator new[](
         *(unsigned int *)(((unsigned __int64)&v18 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18),
         0x674D444Fu,
         PagedPool);
  v8 = v6;
  *v3 = v6;
    ...
    *(_QWORD *)(((unsigned __int64)&v18 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = v6;
    v14 = OutputDuplThunks<_D3DKMT_OUTPUTDUPL_GET_POINTER_SHAPE_DATA *>::RunThunk(
            ...
            *(_DWORD *)(((unsigned __int64)&v18 & 0xFFFFFFFFFFFFFFC0uLL) + 0x14),
            (__int64)(v3 + 2),
            (__int64 (__fastcall *)(struct OUTPUTDUPL_MGR *, __int64))lambda_fce76266551b59e9a3f34e2a2ec09b2d_::_helper_func_cdecl_);
