/*
 * XREFs of ?_GetMonitorCCDMonitorID@DXGMONITOR@@QEAAJEKPEAG@Z @ 0x1C00980C8
 * Callers:
...
LABEL_21:
  ...
  v18 = *(_QWORD *)&this[30].Length;
  if ( v18 && !*(_DWORD *)(v18 + 16) )
  {
    v30 = WdLogNewEntry5_WdAssertion(v14, v13, v15, v16);
    WdLogEvent5_WdAssertion(v30);
  }
  if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)&this[1].Length + 8LL) + 16LL) + 284LL) & 0x10) == 0 )
  {
    v19 = *(_QWORD *)&this[30].Length;
    if ( v19 )
    {
      if ( *(_DWORD *)(v19 + 16) <= 1u )
        return 0LL;
  ...
  v31 = RtlAppendUnicodeStringToString(&Destination, this + 29);
  v36 = v31;
  if ( v31 >= 0 )
    return 0LL;
