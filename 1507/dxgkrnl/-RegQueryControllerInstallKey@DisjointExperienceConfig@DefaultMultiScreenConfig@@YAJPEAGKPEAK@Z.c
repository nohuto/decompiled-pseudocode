/*
 * XREFs of ?RegQueryControllerInstallKey@DisjointExperienceConfig@DefaultMultiScreenConfig@@YAJPEAGKPEAK@Z @ 0x1C002029C
 * Callers:
 ...
 *     KappxParsePackageFullNameFromToken @ 0x1C01658D8 (KappxParsePackageFullNameFromToken.c)
 */
        ...
        unsigned int *a4)
{
  ...
  _WORD v30[4]; // [rsp+90h] [rbp-70h] BYREF
  wchar_t *v31; // [rsp+98h] [rbp-68h]
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v16 >= 0 )
  {
    ...
    *(_DWORD *)&v33.Length = 1835034;
    ...
    while ( 1 )
    {
      v18 = ZwEnumerateKey(KeyHandle, v17, KeyBasicInformation, KeyInformation, 0x220u, &v27);
      v16 = v18;
      if ( v18 == -2147483622 )
        break;
      if ( v18 >= 0 )
      {
        ...
        *(_DWORD *)&String1.Length = 34078720;
        ...
        v24.Buffer = (wchar_t *)&v46;
        *(_DWORD *)&v24.Length = 34078720;
        v16 = KappxParsePackageFullNameFromToken(v30, &String1, &v24);
        if ( v16 >= 0 && !RtlCompareUnicodeString(&String1, &String2, 1u) && !RtlCompareUnicodeString(&v24, &v33, 1u) )
        {
