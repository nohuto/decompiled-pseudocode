/*
 * XREFs of ?DuplicateSurfacesForCreate@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_CREATESWAPCHAIN@@@Z @ 0x1C0161930
 * Callers:
...
__int64 __fastcall DXGSWAPCHAIN::DuplicateSurfacesForCreate(DXGSWAPCHAIN *this, struct _D3DKMT_CREATESWAPCHAIN *a2)
{
  ...
  if ( *((_DWORD *)this + 10) )
  {
    while ( 1 )
    {
      ...
      v20 = 56 * v6;
      *(_QWORD *)(56 * v6 + 16 * (!a2->bProducer + 2LL) + *((_QWORD *)this + 6)) = v27;
      *(_DWORD *)(v20 + *((_QWORD *)this + 6) + 4) = 0;
      *(_DWORD *)(v20 + *((_QWORD *)this + 6)) = 0;
...
LABEL_13:
    if ( (int)v4 < 0 )
    {
      v22 = (DXGSWAPCHAIN *)((char *)this + 128);
      if ( !a2->bProducer )
        v22 = (DXGSWAPCHAIN *)((char *)this + 72);
