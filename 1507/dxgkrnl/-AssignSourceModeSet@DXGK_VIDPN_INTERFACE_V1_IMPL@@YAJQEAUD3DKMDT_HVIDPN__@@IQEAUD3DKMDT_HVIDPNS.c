/*
 * XREFs of ?AssignSourceModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@@Z @ 0x1C00AD410
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ *const a4)
{
  ...
  __int64 v24; // rax
  _QWORD *v25; // rax
  DMMVIDPNSOURCEMODESET *v26; // [rsp+40h] [rbp+8h] BYREF
  ...
  if ( ExposedViaHandle<DMMVIDPN,D3DKMDT_HVIDPN__ *>::GetFromHandle((__int64)this) )
  {
    ...
    if ( v11 )
    {
      ...
      if ( v13 )
      {
        v27 = 0LL;
        v26 = v11;
        v4 = (int)DMMVIDPNSOURCE::SetCofuncModeSet(v13, &v26);
        auto_rc<DMMVIDPNSOURCEMODESET>::reset(&v27, 0LL);
        if ( (int)v4 < 0 )
        {
          if ( (_DWORD)v4 != -1071774958 )
          {
            v24 = WdLogNewEntry5_WdAssertion(v17, v16, v18, v19);
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v17, &EventProfilerExit, v18, 7046);
