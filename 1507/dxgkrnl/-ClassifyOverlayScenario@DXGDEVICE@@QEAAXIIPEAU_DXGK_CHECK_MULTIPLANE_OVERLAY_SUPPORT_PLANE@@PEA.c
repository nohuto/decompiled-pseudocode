/*
 * XREFs of ?ClassifyOverlayScenario@DXGDEVICE@@QEAAXIIPEAU_DXGK_CHECK_MULTIPLANE_OVERLAY_SUPPORT_PLANE@@PEAI11@Z @ 0x1C0134C48
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  do
  {
    if ( v7 == 3 )
      goto LABEL_26;
    if ( (unsigned int)DXGDEVICE::IsYUVAllocation(v12, *(void **)&p_SrcRect[-1].left) )
      v7 = 3;
    if ( v7 != 3 )
    {
      if ( v7 != 2 )
