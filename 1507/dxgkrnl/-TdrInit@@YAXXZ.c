/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1C00D5BC8
 * Callers:
...
void TdrInit(void)
{
  ...
  _BYTE v101[32]; // [rsp+250h] [rbp+148h] BYREF
  ...
  if ( dword_1C00470E4 != v31 )
  {
    v20 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v20 + 24) = v31;
    *(_QWORD *)(v20 + 32) = (unsigned int)dword_1C00470E4;
  ...
  if ( dword_1C00470E8 != v33 )
  {
    v21 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v21 + 24) = v33;
    *(_QWORD *)(v21 + 32) = (unsigned int)dword_1C00470E8;
  ...
  if ( dword_1C00470EC != v28 )
  {
    v22 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v22 + 24) = v28;
    *(_QWORD *)(v22 + 32) = (unsigned int)dword_1C00470EC;
  ...
  if ( dword_1C00470F0 != v29 )
  {
    v23 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v23 + 24) = v29;
    *(_QWORD *)(v23 + 32) = (unsigned int)dword_1C00470F0;
  ...
  if ( dword_1C00470F8 != v30 )
  {
    v24 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v24 + 24) = v30;
    *(_QWORD *)(v24 + 32) = (unsigned int)dword_1C00470F8;
  ...
  if ( dword_1C00470FC != v32 )
  {
    v25 = WdLogNewEntry5_WdWarning(3600LL, v2, v4, v5);
    *(_QWORD *)(v25 + 24) = v32;
    *(_QWORD *)(v25 + 32) = (unsigned int)dword_1C00470FC;
    WdLogEvent5_WdWarning(v25);
  }
  LOBYTE(v13) = 1;
  byte_1C00470F4 = (unsigned __int8)WdIsDebuggerPresent(v13) != 0;
  if ( v27 <= 3 )
    v0 = v27;
  g_TdrDebugMode = v0;
  if ( v0 != v27 )
