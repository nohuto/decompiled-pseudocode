/*
 * XREFs of ?CreateSyncObject@DXGGLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAVDXGDEVICE@@IPEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@PEAVDXGPAGINGQUEUE@@PEAPEAVDXGSYNCOBJECT@@PEAPEAVDXGDEVICESYNCOBJECT@@PEAI@Z @ 0x1C00C3020
 * Callers:
 ...
 *     ??0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z @ 0x1C008320C (--0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z.c)
 *     ?Destroy@DXGSYNCOBJECT@@QEAAXXZ @ 0x1C00837A8 (-Destroy@DXGSYNCOBJECT@@QEAAXXZ.c)
 *     ??0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@@Z @ 0x1C0083840 (--0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@@Z.c)
...
LABEL_16:
  if ( v15 )
  {
    ...
    {
LABEL_19:
      DXGSYNCOBJECT::Destroy(v15, v20, v22, v23);
    }
    else
    {
      ...
      v24 = *((_QWORD *)this + 37);
      *(_QWORD *)v15 = v24;
      *((_QWORD *)v15 + 1) = (char *)this + 296;
      if ( *(DXGGLOBAL **)(v24 + 8) != (DXGGLOBAL *)((char *)this + 296) )
        __fastfail(3u);
      *(_QWORD *)(v24 + 8) = v15;
      *((_QWORD *)this + 37) = v15;
