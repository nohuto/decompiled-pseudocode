/*
 * XREFs of ?DxgkpCreateDodPresent@@YAPEAVDXGDODPRESENT@@PEAVADAPTER_DISPLAY@@E@Z @ 0x1C00D2844
 * Callers:
...
struct DXGDODPRESENT *__fastcall DxgkpCreateDodPresent(struct ADAPTER_DISPLAY *a1, char a2)
{
  ...
  v4 = (char *)operator new[](2384LL * *((unsigned int *)a1 + 20) + 136, 0x4B677844u, (POOL_TYPE)512);
  if ( v4 )
  {
    v6 = DXGDODPRESENT::DXGDODPRESENT((DXGDODPRESENT *)v4, a1, (BLTQUEUE *)(v4 + 136), a2);
    v7 = 0;
    v8 = v6;
    if ( !*(_DWORD *)v6 )
      return v8;
    while ( (int)BLTQUEUE::Startup((PVOID)(*((_QWORD *)v8 + 1) + 2384LL * v7)) >= 0 )
    {
      if ( ++v7 >= *(_DWORD *)v8 )
        return v8;
    }
