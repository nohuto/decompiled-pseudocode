/*
 * XREFs of ?CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z @ 0x1C001EB08
 * Callers:
        ...
        unsigned int a2)
{
  ...
  v3 = -1LL;
  v4 = *v2;
  v5 = a2 * (unsigned __int64)v2[*((unsigned int *)this + 14) + 1] / *(unsigned int *)(*(_QWORD *)this + 3124LL);
  v6 = *v2;
  if ( !*v2 )
    return 0LL;
  while ( 1 )
