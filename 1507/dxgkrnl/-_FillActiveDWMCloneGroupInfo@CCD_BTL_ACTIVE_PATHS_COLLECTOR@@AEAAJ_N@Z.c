/*
 * XREFs of ?_FillActiveDWMCloneGroupInfo@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@AEAAJ_N@Z @ 0x1C0063694
 * Callers:
...
__int64 __fastcall CCD_BTL_ACTIVE_PATHS_COLLECTOR::_FillActiveDWMCloneGroupInfo(CCD_TOPOLOGY **this, char a2)
{
  ...
  unsigned int j; // ebp
  __int64 v20; // rax
  const struct _D3DKMT_PATHMODALITY_DESCRIPTOR *v21; // rdx
  int v22; // eax
  unsigned int k; // ebp
  __int64 v24; // rax
    ...
    if ( v8 )
    {
      for ( i = 0; ; ++i )
      {
        ...
        if ( (*(_DWORD *)PathDescriptor & 0x40000) == 0 )
        {
          if ( v13 < 0 )
          {
            v15 = (SESSION_VIEW *)*((_QWORD *)PathDescriptor + 24);
            if ( v15 )
            {
              PrimaryDisplaySource = SESSION_VIEW::GetPrimaryDisplaySource(v15);
              v17 = *((unsigned int *)PathDescriptor + 4);
              if ( *((_DWORD *)PrimaryDisplaySource + 4) == (_DWORD)v17 )
              {
                ...
                *((_DWORD *)PathDescriptor + 50) = i | 0xFE590000;
                for ( j = 0; ; ++j )
                {
                  ...
                  v22 = *(_DWORD *)v21;
                  if ( (*(_DWORD *)v21 & 0x80040000) == 0x80000000
                    && *((_QWORD *)PathDescriptor + 24) == *((_QWORD *)v21 + 24) )
                  {
                    *((_DWORD *)v21 + 50) = i | 0xFE590000;
                    *(_DWORD *)v21 = v22 | 0x40800;
                    *(_QWORD *)((char *)v21 + 132) = *(_QWORD *)((char *)PathDescriptor + 132);
                  }
                }
              }
            }
