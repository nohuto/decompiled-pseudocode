/*
 * XREFs of ?AcquireAdapterOrdinal@DXGGLOBAL@@QEAAKXZ @ 0x1C00C3B98
 * Callers:
...
__int64 __fastcall DXGGLOBAL::AcquireAdapterOrdinal(DXGGLOBAL *this)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v10, (DXGGLOBAL *)((char *)this + 432));
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v10);
  ClearBitsAndSet = RtlFindClearBitsAndSet((PRTL_BITMAP)((char *)this + 472), 1u, 0);
  v7 = -1;
  if ( ClearBitsAndSet == -1 )
  {
    v9 = WdLogNewEntry5_WdWarning(v4, v3, v5, v6);
    *(_QWORD *)(v9 + 24) = *((unsigned int *)this + 196);
