/*
 * XREFs of ??0DXGMONITOR@@AEAA@PEAVMONITOR_MGR@@@Z @ 0x1C00C9FE4
 * Callers:
...
DXGMONITOR *__fastcall DXGMONITOR::DXGMONITOR(char *Tag, struct MONITOR_MGR *a2, __int64 a3, __int64 a4)
{
  ...
  *((_DWORD *)Tag + 122) = 0;
  if ( !a2 )
  {
    v9 = WdLogNewEntry5_WdAssertion(0xFFFFFFFFLL, 0LL, a3, a4);
  ...
  *((_DWORD *)Tag + 6) ^= (*((_DWORD *)Tag + 6) ^ ((*((_BYTE *)a2 + 5) != 0) << 6)) & 0x40;
  *((_QWORD *)Tag + 1) = Tag;
  *(_QWORD *)Tag = Tag;
  ...
  *((_QWORD *)Tag + 59) = 0LL;
  *((_DWORD *)Tag + 116) = 0;
  IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(Tag + 344), Tag, &byte_1C00E2920, 1u, 0x20u);
