/*
 * XREFs of ?PinMode@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@I_N@Z @ 0x1C00D4290
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( v6 )
  {
    ...
    if ( v11 < 0 )
    {
      v21 = WdLogNewEntry5_WdTrace(v10, v9, v12, v13);
      *(_QWORD *)(v21 + 24) = v4;
      *(_QWORD *)(v21 + 32) = this;
    }
    else
    {
      ...
      if ( !v14 )
      {
        v22 = WdLogNewEntry5_WdAssertion(v10, v9, v12, v13);
        WdLogEvent5_WdAssertion(v22);
      }
      if ( !*(_QWORD *)(v14 + 40) )
      {
        v23 = WdLogNewEntry5_WdAssertion(v10, v9, v12, v13);
        WdLogEvent5_WdAssertion(v23);
      }
      Container = ContainedBy<DMMVIDPN>::GetContainer(*(_QWORD *)(v14 + 40) + 64LL);
      LOBYTE(v16) = v3;
      v11 = VIDPN_MGR::PinVidPnTargetMode(*(VIDPN_MGR **)(Container + 48), v8, (unsigned int)v4, v16);
      if ( v11 < 0 )
      {
        v24 = WdLogNewEntry5_WdDmmEvent(v17);
        *(_QWORD *)(v24 + 24) = v4;
        *(_QWORD *)(v24 + 32) = this;
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v17, &EventProfilerExit, v18, 6014);
