/*
 * XREFs of ?DdiUpdateOverlay@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_UPDATEOVERLAY@@@Z @ 0x1C0123194
 * Callers:
...
LABEL_13:
  ...
  v16 = *(_DWORD *)(v11 + 136);
LABEL_14:
  v18 = (*(int (__fastcall **)(void *, struct _DXGKARG_UPDATEOVERLAY *))(*((_QWORD *)this + 2) + 600LL))(a2, a3);
  ...
  v26[3] = v18;
  v26[4] = a3->OverlayInfo.hAllocation;
  v26[5] = a2;
