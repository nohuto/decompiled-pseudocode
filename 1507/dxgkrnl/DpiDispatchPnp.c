/*
 * XREFs of DpiDispatchPnp @ 0x1C00AF270
 * Callers:
 *     <none>
 * Callees:
 *     DpiGdoDispatchGdiPnp @ 0x1C000F100 (DpiGdoDispatchGdiPnp.c)
 *     __security_check_cookie @ 0x1C000FC20 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1C0010930 (_guard_dispatch_icall_nop.c)
 *     Template_xq @ 0x1C001B6CC (Template_xq.c)
 *     LoadEtwStackLocation @ 0x1C001DC64 (LoadEtwStackLocation.c)
...
__int64 __fastcall DpiDispatchPnp(__int64 a1, IRP *a2)
{
  ...
  v7 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v5 + 64), a2, &byte_1C00E2920, 1u, 0x20u);
  v12 = v7;
  if ( v7 < 0 )
  {
