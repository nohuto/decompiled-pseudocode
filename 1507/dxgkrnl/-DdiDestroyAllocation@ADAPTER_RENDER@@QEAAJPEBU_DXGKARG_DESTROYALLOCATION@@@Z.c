/*
 * XREFs of ?DdiDestroyAllocation@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_DESTROYALLOCATION@@@Z @ 0x1C00932EC
 * Callers:
...
LABEL_17:
  ...
  v21 = *(_DWORD *)(v17 + 136);
LABEL_18:
  v23 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_DESTROYALLOCATION *))(*((_QWORD *)this + 2) + 320LL))(
  ...
  v27 = (_QWORD *)WdLogNewEntry5_WdTrace(v26, v22, v24, v25);
  v27[3] = v23;
  ...
  if ( (_DWORD)v23 )
  {
    v38 = WdLogNewEntry5_WdError(pAllocationList);
    *(_QWORD *)(v38 + 24) = v23;
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v29, &EventProfilerExit, v30, 5005);
