/*
 * XREFs of MonitorDestroySimulatedMonitor @ 0x1C01822FC
 * Callers:
...
__int64 __fastcall MonitorDestroySimulatedMonitor(PERESOURCE *this, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v6; // rax
  __int64 v7; // rdx
  ...
  *(_QWORD *)(v6 + 32) = this;
  ...
  v16 = MONITOR_MGR::_HandleRemoveSimulatedMonitor((struct _FAST_MUTEX *)v12->SpinLock, (unsigned int)v4, v9, v10);
  MONITOR_MGR::_LogMonitorPresentEvent(SpinLock, 1073741826LL, (unsigned int)v4, v16, 0LL);
  return v16;
}
