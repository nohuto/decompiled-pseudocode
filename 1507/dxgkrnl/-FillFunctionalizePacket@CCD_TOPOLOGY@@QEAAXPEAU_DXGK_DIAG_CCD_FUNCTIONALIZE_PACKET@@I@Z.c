/*
 * XREFs of ?FillFunctionalizePacket@CCD_TOPOLOGY@@QEAAXPEAU_DXGK_DIAG_CCD_FUNCTIONALIZE_PACKET@@I@Z @ 0x1C0065C48
 * Callers:
  ...
  *((_DWORD *)a2 + 12) = *(unsigned __int16 *)(*((_QWORD *)this + 8) + 20LL);
  ...
  if ( *(_WORD *)(v7 + 20) )
  {
    do
    {
      ...
      *(_DWORD *)((char *)a2 + v9 + 76) = *(_DWORD *)(216 * v8 + v7 + 176);
      *(_QWORD *)((char *)a2 + v9 + 80) = *(_QWORD *)(216 * v8 + v7 + 188);
      *(_OWORD *)((char *)a2 + v9 + 88) = *(_OWORD *)(216 * v8 + v7 + 204);
