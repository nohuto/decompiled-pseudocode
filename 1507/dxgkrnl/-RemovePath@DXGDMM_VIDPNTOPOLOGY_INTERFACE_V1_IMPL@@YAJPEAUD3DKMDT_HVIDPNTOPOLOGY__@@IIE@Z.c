/*
 * XREFs of ?RemovePath@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIE@Z @ 0x1C0179B20
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  if ( v8 )
  {
    ...
    v15 = VIDPN_MGR::RemovePathFromVidPnTopology(
            *(VIDPN_MGR **)(Container + 48),
            v10,
            (enum _D3DKMDT_MODE_PREFERENCE)v7,
            v5,
            a4);
    v6 = v15;
    if ( v15 >= 0 )
