/*
 * XREFs of DpiGetMonitorDescriptor @ 0x1C00C8010
 * Callers:
...
__int64 __fastcall DpiGetMonitorDescriptor(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  DxgkAcquireAdapterDdiSync(*(_QWORD *)(v6 + 2504), 1);
  LODWORD(v5) = DpiDxgkDdiQueryDeviceDescriptor(v5, *(_QWORD *)(v4 + 48), *(unsigned int *)(v4 + 472), v8);
  DxgkReleaseAdapterDdiSync(*(DXGADAPTER **)(v6 + 2504));
