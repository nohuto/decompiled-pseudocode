/*
 * XREFs of ?AddPath@DXGK_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEAU_D3DKMDT_VIDPN_PRESENT_PATH@@@Z @ 0x1C017B910
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( v12 )
    {
      ...
      v32 = 0LL;
      v33 = 0LL;
      v19 = DMMVIDPNTOPOLOGY::CreateNewPath(v12, (const struct _D3DKMDT_VIDPN_PRESENT_PATH *)a2, &v33, v14);
      v24 = v19;
