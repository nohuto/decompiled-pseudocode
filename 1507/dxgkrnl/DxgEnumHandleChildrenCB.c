/*
 * XREFs of DxgEnumHandleChildrenCB @ 0x1C0137980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgEnumHandleChildrenCB(unsigned int *a1)
{
  ...
  DXGRESOURCEREFERENCE::DXGRESOURCEREFERENCE((DXGRESOURCEREFERENCE *)&v23, v8);
  v13 = v23;
  if ( v23 )
  {
    if ( KeGetCurrentIrql() >= 2u )
    {
      v15 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v23[1].Count + 16) + 16LL) + 176LL) + 64LL);
      v16 = *(_QWORD *)(v15 + 40);
      if ( *(_DWORD *)(v16 + 28) >= 0x2003u )
      {
        ...
        v17[3] = 275LL;
        v17[4] = 20LL;
        v17[5] = *(_QWORD *)(*(_QWORD *)(v23[1].Count + 16) + 16LL);
        v17[6] = 0LL;
        v17[7] = 0LL;
...
LABEL_16:
  ...
  DXGHANDLETABLELOCKSHARED::~DXGHANDLETABLELOCKSHARED((DXGHANDLETABLELOCKSHARED *)v22);
  return v3;
}
