/*
 * XREFs of ?DdiSetPointerShape@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1C009585C
 * Callers:
...
LABEL_23:
  v14 = 0;
LABEL_12:
  v16 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPOINTERSHAPE *))(*((_QWORD *)this + 2) + 408LL))(
  ...
  {
    v30 = WdLogNewEntry5_WdError(Height);
    *(_QWORD *)(v30 + 24) = v16;
    WdLogEvent5_WdError(v30);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v22, &EventProfilerExit, v23, 5018);
