/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C012247C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q((__int64)this, &EventProfilerEnter, a3, 5017);
...
LABEL_13:
  ...
  v15 = *(_DWORD *)(v10 + 136);
LABEL_14:
  v17 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 392LL))(
  ...
  v25[3] = v17;
  v25[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 224LL);
  v25[5] = a2->FirstEntry;
  v25[6] = a2->NumEntries;
  ...
  if ( (_DWORD)v17 )
  {
    v27 = WdLogNewEntry5_WdError(VidPnSourceId);
    *(_QWORD *)(v27 + 24) = v17;
    WdLogEvent5_WdError(v27);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v28, &EventProfilerExit, v29, 5017);
