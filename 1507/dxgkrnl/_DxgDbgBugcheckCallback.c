/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C001D9B0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C0047D58 )
    {
      v4 = (unsigned int)(dword_1C0047D54 - 1);
      if ( dword_1C0047D54 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C0047D58) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C0047098;
      ReasonSpecificData[4] = qword_1C0047D58;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C0047098;
      if ( v5 )
      {
