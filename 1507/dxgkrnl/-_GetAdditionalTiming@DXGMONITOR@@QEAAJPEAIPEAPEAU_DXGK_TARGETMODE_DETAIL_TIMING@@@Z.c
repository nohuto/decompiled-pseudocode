/*
 * XREFs of ?_GetAdditionalTiming@DXGMONITOR@@QEAAJPEAIPEAPEAU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C0184764
 * Callers:
        ...
        __int64 a4)
{
  ...
  *a2 = 0;
  v9 = (unsigned int *)((char *)this + 408);
  *a3 = 0LL;
  v10 = *((_DWORD *)this + 102) != -1;
  ...
  result = pGetAdditionalTiming(*((unsigned int *)this + 8), (char *)this + 408, (char *)this + 416);
  if ( (int)result >= 0 )
  {
    v10 = *v9 != -1;
LABEL_10:
    ...
    ++*((_DWORD *)this + 106);
    *a2 = *v9;
    *a3 = (struct _DXGK_TARGETMODE_DETAIL_TIMING *)*((_QWORD *)this + 52);
    return 0LL;
  }
  return result;
}
