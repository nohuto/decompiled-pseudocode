/*
 * XREFs of ?EnumPathTargetsFromSource@DXGK_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@I_KPEAI@Z @ 0x1C017BDE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( a4 )
  {
    *a4 = -1;
    ...
    {
      v24 = -1;
      v17 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v13, (unsigned int)v6, a3, &v24);
      v7 = v17;
      if ( v17 >= 0 )
      {
        v21 = v24;
        ...
        {
          v22 = WdLogNewEntry5_WdAssertion(v11, v18, v12, v19);
