/*
 * XREFs of EDIDV1_ObtainSupportedMonitorSourceModes @ 0x1C000B958
 * Callers:
 ...
 *     ?FindMonitorSourceMode@@YA_KPEAU_VideoModeDescriptor@@_K0@Z @ 0x1C000BCC8 (-FindMonitorSourceMode@@YA_KPEAU_VideoModeDescriptor@@_K0@Z.c)
 ...
 *     ?EDID_V1_PopulateSupportedMonitorSourceModeFromDetailedTimingBlock@@YAJPEBU_EDID_V1_DETAILED_TIMING@@W4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@PEAU_VideoModeDescriptor@@@Z @ 0x1C000C388 (-EDID_V1_PopulateSupportedMonitorSourceModeFromDetailedTimingBlock@@YAJPEBU_EDID_V1_DETAILED_TIM.c)
 *     ?EDID_V1_PopulateSupportedMonitorSourceModesFromEstablishedTimingsBlock@@YAJPEBT_EDID_V1_ESTABLISHED_TIMING@@GG_KW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@PEAU_VideoModeDescriptor@@@Z @ 0x1C000C69C (-EDID_V1_PopulateSupportedMonitorSourceModesFromEstablishedTimingsBlock@@YAJPEBT_EDID_V1_ESTABLI.c)
