/*
 * XREFs of ?AcquireDdiSync@DXGADAPTER@@QEAAXW4DXGADAPTERDDISYNC_LEVEL@@@Z @ 0x1C0002310
 * Callers:
...
BOOLEAN __fastcall DXGADAPTER::AcquireDdiSync(__int64 a1, int a2)
{
  __int64 v2; // rax
  __int64 v4; // rdi
  BOOLEAN result; // al
  ...
  if ( !v2
    || !*(_QWORD *)(v2 + 384)
    || (result = (*(__int64 (**)(void))(*(_QWORD *)(*(_QWORD *)(v2 + 376) + 8LL) + 72LL))()) == 0 )
  {
    ...
    if ( (_DWORD)v4 == 1 )
    {
      return ExAcquireResourceSharedLite(*(PERESOURCE *)(a1 + 216), 1u);
    }
    else if ( (_DWORD)v4 == 2 )
    {
      return ExAcquireResourceExclusiveLite(*(PERESOURCE *)(a1 + 216), 1u);
    }
    else
    {
