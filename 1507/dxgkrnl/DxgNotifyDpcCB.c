/*
 * XREFs of DxgNotifyDpcCB @ 0x1C0008F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgNotifyDpcCB(__int64 a1)
{
  ...
  if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 2520LL), 0, 0) & 1) != 0 )
  {
    v2 = *(struct DXGADAPTER **)(*(_QWORD *)(a1 + 64) + 2504LL);
    if ( v2 )
    {
      v3 = *((_QWORD *)v2 + 248);
      if ( v3 )
      ...
      {
        v6 = *(DXGDODPRESENT **)(*((_QWORD *)v2 + 247) + 248LL);
        if ( v6 )
