/*
 * XREFs of ?DdiQueryCurrentFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x1C00183C0
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryCurrentFence@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x1C001CDF0 (-ADAPTER_RENDER_DdiQueryCurrentFence@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYCURRENTFENCE@@@Z.c)
 * Callees:
...
LABEL_13:
  ...
  v11 = *(_DWORD *)(v6 + 136);
LABEL_14:
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYCURRENTFENCE *))(*((_QWORD *)this + 2) + 448LL))(
  ...
  v17[3] = v12;
  v17[4] = a2->CurrentFence;
  v17[5] = a2->NodeOrdinal;
  EngineOrdinal = a2->EngineOrdinal;
  v17[6] = EngineOrdinal;
  if ( (_DWORD)v12 )
  {
    v19 = WdLogNewEntry5_WdError(EngineOrdinal);
    *(_QWORD *)(v19 + 24) = v12;
    WdLogEvent5_WdError(v19);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v20, &EventProfilerExit, v21, 5015);
