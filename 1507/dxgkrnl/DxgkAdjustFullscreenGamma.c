/*
 * XREFs of DxgkAdjustFullscreenGamma @ 0x1C01299D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  if ( (unsigned int)v29 >= *(_DWORD *)(v28 + 80) )
  {
LABEL_24:
  ...
  if ( (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType((DXGADAPTER **)v28, v29) == 2
    || (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*(DXGADAPTER ***)(v15 + 1976), v29) == 3 )
  {
    VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwner(*(DXGADAPTER ***)(v15 + 1976), v29);
  }
  else
  {
    if ( !ADAPTER_DISPLAY::IsVidPnSourceOwnerEmulated(*(DXGADAPTER ***)(v15 + 1976), v29) )
      goto LABEL_31;
    VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwnerEmulated(*(DXGADAPTER ***)(v15 + 1976), v29);
  }
...
LABEL_31:
  ...
  if ( (int)v23 >= 0 )
  {
    ...
    LODWORD(v23) = ADAPTER_DISPLAY::SetGammaRamp(*(PERESOURCE ***)(v15 + 1976), v29, v31);
  }
LABEL_57:
  COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)(v3 + 48));
  DXGADAPTERBYHANDLE::~DXGADAPTERBYHANDLE((DXGADAPTER **)((unsigned __int64)&v45 & 0xFFFFFFFFFFFFFFC0uLL));
