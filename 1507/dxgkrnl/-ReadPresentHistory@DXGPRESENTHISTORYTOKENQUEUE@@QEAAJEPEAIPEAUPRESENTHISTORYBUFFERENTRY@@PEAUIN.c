/*
 * XREFs of ?ReadPresentHistory@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJEPEAIPEAUPRESENTHISTORYBUFFERENTRY@@PEAUINDEPENDENTFLIPBITS@@@Z @ 0x1C0008C90
 * Callers:
        ...
        struct INDEPENDENTFLIPBITS *a5)
{
  ...
  if ( a3 && a4 )
  {
    ...
    *((_DWORD *)this + 4) = ((_WORD)v13 + (_WORD)v22 + (_WORD)v8) & 0x7FF;
    *a3 = v13 + v22;
