/*
 * XREFs of Template_ppp @ 0x1C0022660
 * Callers:
...
NTSTATUS Template_ppp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndirectSwapChainMarkAbandoned, 0LL, 3u, &UserData);
}
