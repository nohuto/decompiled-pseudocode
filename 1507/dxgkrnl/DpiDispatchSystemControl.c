/*
 * XREFs of DpiDispatchSystemControl @ 0x1C016CF20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDispatchSystemControl(__int64 a1, IRP *a2)
{
  ...
  v9 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v2 + 64), a2, &byte_1C00E2920, 1u, 0x20u);
  v14 = v9;
  if ( v9 >= 0 )
  {
  ...
  else
  {
    ...
    *(_QWORD *)(v15 + 24) = &DpiDispatchSystemControl;
    *(_QWORD *)(v15 + 32) = v14;
