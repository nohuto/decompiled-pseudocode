/*
 * XREFs of ?CalculateMinMaxOverride@DpiInternal@@YAXKUtagSIZE@@PEAJ1QEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x1C000A60C
 * Callers:
  ...
  if ( v10 )
  {
    ...
    *(_DWORD *)a3.cx = -(int)v9;
    ...
    if ( (unsigned int)v11 > (unsigned int)v9 )
    {
      ...
      while ( 1 )
      {
        LODWORD(a5) = v13 / *(_DWORD *)(v12 + 4 * v11);
        HIDWORD(a5) = v14 / *(_DWORD *)(v12 + 4 * v11);
        v17 = a5;
        if ( (unsigned __int8)DpiInternal::operator>=(&v17, v8) )
          break;
