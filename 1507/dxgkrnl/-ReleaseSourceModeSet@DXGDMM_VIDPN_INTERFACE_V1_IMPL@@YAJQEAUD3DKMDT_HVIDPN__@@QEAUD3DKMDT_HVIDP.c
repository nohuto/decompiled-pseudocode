/*
 * XREFs of ?ReleaseSourceModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNSOURCEMODESET__@@@Z @ 0x1C00AFE30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ *const a3)
{
  ...
  __int64 v12; // r8
  __int64 v13; // r9
  struct DMMVIDPNSOURCEMODESET *v14; // rbp
  __int64 v15; // rsi
  __int64 v16; // rcx
  __int64 v17; // rcx
  __int64 v18; // r8
  ...
  if ( v5 )
  {
    ...
    else
    {
      ...
      v14 = (struct DMMVIDPNSOURCEMODESET *)v9;
      if ( v9 )
      {
        v15 = *(_QWORD *)(v9 + 112);
        if ( !v15 )
        ...
        if ( ContainedBy<DMMVIDPN>::GetContainer(*(_QWORD *)(v15 + 40) + 64LL) == v8 )
        {
          ...
          DMMVIDPNSOURCE::ReleaseModeSet((struct DMMVIDPNSOURCEMODESET **)v15, v14);
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v17, &EventProfilerExit, v18, 6035);
  return v7;
}
