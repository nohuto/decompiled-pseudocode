/*
 * XREFs of DpiFdoDispatchSystemControl @ 0x1C0167510
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiFdoDispatchSystemControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( DeviceExtension[2328] == 1 )
  {
    v3 = WmiSystemControl((PWMILIB_CONTEXT)(DeviceExtension + 2336), DeviceObject, Irp, &IrpDisposition);
    if ( IrpDisposition )
    {
