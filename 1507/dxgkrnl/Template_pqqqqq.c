/*
 * XREFs of Template_pqqqqq @ 0x1C001C7C0
 * Callers:
...
NTSTATUS Template_pqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 4LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventCddStandardAllocationShadowSurface, 0LL, 6u, &UserData);
}
