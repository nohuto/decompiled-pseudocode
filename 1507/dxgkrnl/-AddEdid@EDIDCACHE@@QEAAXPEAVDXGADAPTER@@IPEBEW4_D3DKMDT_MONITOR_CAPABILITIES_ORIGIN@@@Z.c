/*
 * XREFs of ?AddEdid@EDIDCACHE@@QEAAXPEAVDXGADAPTER@@IPEBEW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@@Z @ 0x1C00DBF78
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CAPABILITIES_ORIGIN a5)
{
  ...
  {
    v15 = -2;
    DxgkQueryMonitorTypeLockHeld(a2, a3, (__int64)&v15, 0LL, 0LL, 0LL);
