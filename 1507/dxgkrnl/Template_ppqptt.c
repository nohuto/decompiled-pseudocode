/*
 * XREFs of Template_ppqptt @ 0x1C001D4CC
 * Callers:
 *     TraceDxgkDevice @ 0x1C001D8C0 (TraceDxgkDevice.c)
...
NTSTATUS Template_ppqptt(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
