/*
 * XREFs of ?ProcessMiracastAPIChunk@@YAJPEAU_MIRACAST_DEVICE_CONTEXT@@PEAU_FDO_CONTEXT@@PEAKPEAUD3DKMT_MIRACAST_CHUNK_DATA@@2@Z @ 0x1C0024048
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  {
    v12 = (MIRACAST_CHUNK_LIST *)*((_QWORD *)a1 + 45);
    v13 = *(_QWORD *)v12;
