/*
 * XREFs of TraceLoggingWriteMiracastSessionStart @ 0x1C002A394
 * Callers:
  ...
  *(_DWORD *)&DestinationString.Length = 4063232;
  ...
  if ( (unsigned int)dword_1C0046830 > 5 )
  {
    ...
    if ( (_BYTE)v9 )
    {
      ...
      TlgCreateWsz(&v79, (LPCWSTR)(a1 + 624));
      v15 = *(_DWORD *)(a1 + 692);
      v80 = &v26;
      v27 = *(_QWORD *)(a1 + 488) >> 16;
      v82 = &v27;
      v29 = *(_QWORD *)(a1 + 496) >> 16;
      v84 = &v29;
      v31 = *(_QWORD *)(a1 + 504) >> 16;
      v86 = &v31;
      v88 = a1 + 480;
      v26 = v15;
      v16 = *(_DWORD *)(a1 + 480);
      ...
      v37 = (int)v17;
      v95 = 4LL;
      LOBYTE(v9) = TlgWrite(v17, &unk_1C00303F9, v19, v18, 0x21u, &v43);
    }
  }
  return v9;
}
