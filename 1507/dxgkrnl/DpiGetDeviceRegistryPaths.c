...
LABEL_5:
    ...
    if ( RegistryPathFromPDO >= 0 )
    {
      if ( v6 )
      {
        *(struct _UNICODE_STRING *)(v3 + 496) = UnicodeString;
        v6 = 2;
      }
      else
      {
        *(struct _UNICODE_STRING *)(v3 + 480) = UnicodeString;
        v6 = 1;
      }
    }
  ...
  RtlFreeUnicodeString((PUNICODE_STRING)(v3 + 480));
  RtlFreeUnicodeString((PUNICODE_STRING)(v3 + 496));
  return v9;
}
