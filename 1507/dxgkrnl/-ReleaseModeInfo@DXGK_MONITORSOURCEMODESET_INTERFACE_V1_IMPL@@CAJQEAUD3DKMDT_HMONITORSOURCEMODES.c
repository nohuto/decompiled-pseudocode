/*
 * XREFs of ?ReleaseModeInfo@DXGK_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORSOURCEMODESET__@@QEBU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C0184080
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(v6 + 32) = a1;
  if ( a2 )
  {
    ...
    else
    {
      ...
      v26 = DXGMONITOR::_ReleaseMonitorModeEnumerator(v19, a2);
