/*
 * XREFs of ?ProcessComponentIdleList@DXGADAPTER@@QEAAXXZ @ 0x1C001A158
 * Callers:
 *     ?DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00193B0 (-DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessComponentIdleList(KSPIN_LOCK *this)
{
  ...
  if ( !*((_BYTE *)this + 2446) )
  {
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 318, &LockHandle);
    v17[1] = v17;
    v3 = (char *)(this + 312);
    v17[0] = v17;
    v4 = (char *)this[312];
    ...
    for ( i = (_QWORD *)v17[0]; i != v17; i = (_QWORD *)*i )
    {
      ...
      PoFxIdleComponent(this[252], v14, 0LL);
    }
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 318, &LockHandle);
    *((_BYTE *)this + 2445) = 0;
    if ( *(char **)v3 != v3 )
