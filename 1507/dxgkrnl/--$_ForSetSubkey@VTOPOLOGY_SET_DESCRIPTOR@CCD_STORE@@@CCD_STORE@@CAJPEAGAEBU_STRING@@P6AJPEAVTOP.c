/*
 * XREFs of ??$_ForSetSubkey@VTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGAEBU_STRING@@P6AJPEAVTOPOLOGY_SET_DESCRIPTOR@0@PEAX@Z3_N@Z @ 0x1C009DB4C
 * Callers:
        ...
        char a5)
{
  ...
  *(_DWORD *)((char *)&v30.Buffer + 2) = 0;
  ...
  if ( v11 < 0 )
    goto LABEL_9;
  v27 = 2;
  v10 = CcdOpenRegistrySubkey_0(&Handle, 0xF003Fu, v29, &v30, (PULONG)((unsigned __int64)&v27 & -(__int64)(a5 != 0)));
...
LABEL_9:
  ...
  CCD_STORE::TOPOLOGY_SET_DESCRIPTOR::TOPOLOGY_SET_DESCRIPTOR(
    (CCD_STORE::TOPOLOGY_SET_DESCRIPTOR *)v32,
    Handle,
    a2,
    v16);
  v10 = a3(v32, a4);
