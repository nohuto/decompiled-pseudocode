/*
 * XREFs of ?CheckMultiPlaneOverlaySupport2@DXGDEVICE@@QEAAJIPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE2@@_NPEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C0133E80
 * Callers:
        ...
        if ( v10 >= 0 )
        {
          ...
          if ( v49 )
          {
            ...
            *(_QWORD *)&p_SrcRect[-2].bottom = *(_QWORD *)(v31 + 16);
            v36 = *p_VidPnSourceId;
            if ( (_DWORD)v36 == ((*(_DWORD *)(v31 + 4) >> 6) & 0xF) && (unsigned int)v36 < *((_DWORD *)this + 4678) )
            {
              if ( v47
                && !ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(*((_QWORD *)this + 2338) + 1976LL), this, v36) )
              {
              ...
              *p_SrcRect = *(RECT *)(p_VidPnSourceId + 3);
              ...
              if ( !*(p_VidPnSourceId - 2) && !*(p_VidPnSourceId - 1)
                || (v43 = *((_QWORD *)this + 2),
                    ...
                    LODWORD(v54) = 0,
                    LODWORD(v56) = 0,
                    (*(void (__fastcall **)(_QWORD, _QWORD, LUID *, __int64, char *, int *, __int64 *, unsigned int *, char *, __int64 *))(*(_QWORD *)(*(_QWORD *)(v43 + 376) + 8LL) + 320LL))(
                      *(_QWORD *)(v43 + 384),
