/*
 * XREFs of ?DdiDestroyOverlay@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C0120E60
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyOverlay(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q((__int64)this, &EventProfilerEnter, a3, 5035);
...
LABEL_13:
  ...
  v15 = *(_DWORD *)(v10 + 136);
LABEL_14:
  v17 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 616LL))(a2);
  ...
  v25 = WdLogNewEntry5_WdEvent(v20, v16, v18, v19);
  *(_QWORD *)(v25 + 24) = v17;
  *(_QWORD *)(v25 + 32) = a2;
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v28, &EventProfilerExit, v29, 5035);
