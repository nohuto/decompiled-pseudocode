/*
 * XREFs of DpiLdaPowerDownAllAdaptersInChain @ 0x1C016FA30
 * Callers:
...
__int64 __fastcall DpiLdaPowerDownAllAdaptersInChain(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    if ( !v11 )
    {
      ...
      if ( v4 < 0 )
      {
        ...
        *(_QWORD *)(v16 + 24) = DpiLdaPowerDownAllAdaptersInChain;
        *(_QWORD *)(v16 + 32) = v9;
  ...
  if ( *(_DWORD *)(v7 + 1480) )
  {
    ...
    while ( 1 )
    {
      v21 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 1472) + 8 * v17) + 64LL);
      v4 = DpiFdoSetAdapterPowerState(
             *(PDEVICE_OBJECT *)(v21 + 24),
             *(POWER_STATE *)(v21 + 4 * v18 + 1088),
             v20,
             v19,
             v8);
      if ( v4 < 0 )
        break;
      if ( *(_DWORD *)(v21 + 236) != 2 && v5 )
      {
        v4 = -1071774666;
        v25 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v23, v22, v24);
        v25[6] = 0LL;
        v25[5] = DpiLdaPowerDownAllAdaptersInChain;
        goto LABEL_16;
      }
      v17 = (unsigned int)(v17 + 1);
      if ( (unsigned int)v17 >= *(_DWORD *)(v7 + 1480) )
        return (unsigned int)v4;
      v8 = v27;
    }
    v4 = -1071774666;
    v25 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v23, v22, v24);
    v25[5] = DpiLdaPowerDownAllAdaptersInChain;
    v25[6] = DpiFdoSetAdapterPowerState;
LABEL_16:
    v25[3] = 275LL;
    v25[4] = 21LL;
    v25[7] = -1071774666LL;
