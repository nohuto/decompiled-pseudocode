/*
 * XREFs of _pGetAdditionalTiming @ 0x1C01848C4
 * Callers:
 ...
 * Callees:
 *     _pGetAdditionalModeEntry @ 0x1C018488C (_pGetAdditionalModeEntry.c)
...
__int64 __fastcall pGetAdditionalTiming(__int64 a1, _DWORD *a2, _QWORD *a3, __int64 a4)
{
  ...
  else
  {
    ...
    ExAcquirePushLockSharedEx(&qword_1C0047E58, 0LL);
    AdditionalModeEntry = pGetAdditionalModeEntry((unsigned int)v4, v12, v13, v14);
    if ( !AdditionalModeEntry )
    {
      ExReleasePushLockEx(&qword_1C0047E58, 0LL);
      ExAcquirePushLockExclusiveEx(&qword_1C0047E58, 0LL);
