/*
 * XREFs of ?GetCachedModeList@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_GETDISPLAYMODELIST@@@Z @ 0x1C0095A9C
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::GetCachedModeList(DXGADAPTER **this, struct _D3DKMT_GETDISPLAYMODELIST *a2)
{
  ...
  else if ( *((_BYTE *)this + 132) && *((_BYTE *)this[14] + 1008 * VidPnSourceId + 980) )
  {
    v9 = WdLogNewEntry5_WdEvent(1008 * VidPnSourceId, v4, v6, v7);
    *(_QWORD *)(v9 + 24) = 22412LL;
    WdLogEvent5_WdEvent(v9);
    v10 = 1008LL * a2->VidPnSourceId;
    a2->pModeList = *(D3DKMT_DISPLAYMODE **)((char *)this[14] + v10 + 968);
    result = 0LL;
    a2->ModeCount = *(_DWORD *)((char *)this[14] + v10 + 976);
  }
  else
  {
    return 3221226021LL;
