/*
 * XREFs of ?PinPathContentScaling@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C01734A0
 * Callers:
...
LABEL_8:
  ...
  if ( IsSupportedVidPn >= 0 )
  {
    ...
    v42 = VIDPN_MGR::_EnumVidPnCofuncModality((__int64)this, (__int64)v21, 7, &v47);
    v14 = v42;
    if ( v42 >= 0 )
    {
      LODWORD(v14) = 0;
