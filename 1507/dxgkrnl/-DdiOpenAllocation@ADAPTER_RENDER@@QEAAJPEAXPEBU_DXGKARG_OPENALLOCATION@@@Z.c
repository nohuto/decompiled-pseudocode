/*
 * XREFs of ?DdiOpenAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_OPENALLOCATION@@@Z @ 0x1C011E978
 * Callers:
...
LABEL_14:
  ...
  if ( !a3->pOpenAllocation->hDeviceSpecificAllocation && (int)v19 >= 0 )
  {
    ...
    *(_QWORD *)(v34 + 24) = 28189LL;
    WdLogEvent5_WdAssertion(v34);
  }
  DXGAUTOPUSHLOCK::Release((DXGAUTOPUSHLOCK *)v38);
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v35, &EventProfilerExit, v36, 5028);
