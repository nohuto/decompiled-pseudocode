/*
 * XREFs of ?RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z @ 0x1C001EEFC
 * Callers:
 *     ?CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z @ 0x1C0017D34 (-CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z.c)
 * Callees:
 *     <none>
 */
