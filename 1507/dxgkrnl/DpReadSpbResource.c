/*
 * XREFs of DpReadSpbResource @ 0x1C016EDF0
 * Callers:
 *     <none>
 * Callees:
 *     DpiValidateSpbResource @ 0x1C016F48C (DpiValidateSpbResource.c)
 */
        ...
        PIO_STATUS_BLOCK a7)
{
  ...
  if ( !a4 && (_DWORD)a3 )
  {
    ...
    *(_QWORD *)(v10 + 24) = &DpReadSpbResource;
  ...
  if ( !a7 )
  {
    ...
    *(_QWORD *)(v13 + 32) = 0LL;
    *(_QWORD *)(v13 + 24) = &DpReadSpbResource;
