/*
 * XREFs of ?ConfigureSharedResourceHelper@DXGDEVICE@@QEAAJEPEAXPEAVDXGSHAREDRESOURCE@@EH@Z @ 0x1C0079FA4
 * Callers:
        ...
        int a6)
{
  ...
  if ( !*((_DWORD *)this + 18) && !ExIsResourceAcquiredExclusiveLite(this[10]) )
  {
    ...
    *(_QWORD *)(v21 + 24) = 4457LL;
    WdLogEvent5_WdAssertion(v21);
  }
  if ( !a4 )
  {
    v22 = (_QWORD *)WdLogNewEntry5_WdWarning(this, a2, a3, a4);
    v22[4] = 0LL;
    v22[3] = this;
LABEL_26:
    v22[5] = -1073741811LL;
  ...
  if ( v8
    || (v23 = ObReferenceObjectByHandle(a3, 0x1000u, (POBJECT_TYPE)PsProcessType, 1, &Object, 0LL),
        ...
        v23 >= 0) )
  {
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v32, (struct DXGFASTMUTEX *const)(v10 + 8));
...
LABEL_31:
    ...
    else if ( v14 )
    {
      ...
      if ( v30[1] != (DXGPROCESSSHAREDACCESS *)((char *)v14 + 8) || *v31 != (DXGPROCESSSHAREDACCESS *)((char *)v14 + 8) )
        __fastfail(3u);
