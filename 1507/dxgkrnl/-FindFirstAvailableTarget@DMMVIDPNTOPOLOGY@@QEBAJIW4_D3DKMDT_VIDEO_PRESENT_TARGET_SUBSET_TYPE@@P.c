/*
 * XREFs of ?FindFirstAvailableTarget@DMMVIDPNTOPOLOGY@@QEBAJIW4_D3DKMDT_VIDEO_PRESENT_TARGET_SUBSET_TYPE@@PEAIPEAW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@@Z @ 0x1C017A3A8
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  if ( !a4 )
  {
    v9 = WdLogNewEntry5_WdAssertion(a1, a2, a3, 0LL);
  ...
  if ( NextTarget )
  {
    ...
    while ( 1 )
    {
      if ( v17 )
      {
        ...
        if ( *(_QWORD *)(v21 + 96)
          && (v7 != 2 || IsInternalVideoOutput(*(_DWORD *)(v21 + 72)))
