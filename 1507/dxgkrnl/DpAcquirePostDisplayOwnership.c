/*
 * XREFs of DpAcquirePostDisplayOwnership @ 0x1C00DEA20
 * Callers:
...
__int64 __fastcall DpAcquirePostDisplayOwnership(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( KeGetCurrentThread() != (struct _KTHREAD *)qword_1C0046F38 || a1 != qword_1C0046F40 )
  {
    v6 = -1073741811;
    v11 = (_QWORD *)WdLogNewEntry5_WdError(a1);
...
LABEL_22:
  ...
  if ( qword_1C0046E80 == a1 )
  {
    memmove(v4, &dword_1C0046E90, 0x20uLL);
  }
  else
  {
