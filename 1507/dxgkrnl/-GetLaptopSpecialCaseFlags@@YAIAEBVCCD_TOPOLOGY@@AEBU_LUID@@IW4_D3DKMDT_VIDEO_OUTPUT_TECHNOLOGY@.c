/*
 * XREFs of ?GetLaptopSpecialCaseFlags@@YAIAEBVCCD_TOPOLOGY@@AEBU_LUID@@IW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@AEBUMONITORSCOUNT_CALLBACK_CONTEXT@@@Z @ 0x1C0150764
 * Callers:
        ...
        const struct MONITORSCOUNT_CALLBACK_CONTEXT *a5)
{
  ...
  if ( !PathDescriptor )
  {
    ...
    *(_QWORD *)(v14 + 24) = 3405LL;
    WdLogEvent5_WdAssertion(v14);
  }
  if ( *((_DWORD *)PathDescriptor + 5) == v7
