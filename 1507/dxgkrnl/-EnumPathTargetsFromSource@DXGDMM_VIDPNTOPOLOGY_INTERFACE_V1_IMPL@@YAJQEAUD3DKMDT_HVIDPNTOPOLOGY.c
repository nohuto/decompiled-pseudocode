/*
 * XREFs of ?EnumPathTargetsFromSource@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@I_KPEAI@Z @ 0x1C00B0380
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( a4 )
  {
    *a4 = -1;
    ...
    {
      v22 = -1;
      v11 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v8, (unsigned int)v6, a3, &v22);
      v7 = v11;
      if ( v11 < 0 )
      {
