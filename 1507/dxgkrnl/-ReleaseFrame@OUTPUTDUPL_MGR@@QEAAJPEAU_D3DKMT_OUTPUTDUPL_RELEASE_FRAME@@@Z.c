/*
 * XREFs of ?ReleaseFrame@OUTPUTDUPL_MGR@@QEAAJPEAU_D3DKMT_OUTPUTDUPL_RELEASE_FRAME@@@Z @ 0x1C0154FD8
 * Callers:
 *     _lambda_935e771f49f42b8b8f09f155a2ae6f70_::_helper_func_cdecl_ @ 0x1C01521E0 (_lambda_935e771f49f42b8b8f09f155a2ae6f70_--_helper_func_cdecl_.c)
 * Callees:
...
__int64 __fastcall OUTPUTDUPL_MGR::ReleaseFrame(OUTPUTDUPL_MGR *this, struct _D3DKMT_OUTPUTDUPL_RELEASE_FRAME *a2)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v10, *v4);
