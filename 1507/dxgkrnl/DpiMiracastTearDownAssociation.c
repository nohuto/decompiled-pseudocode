/*
 * XREFs of DpiMiracastTearDownAssociation @ 0x1C0025B74
 * Callers:
 ...
 *     DpIndicateChildStatus @ 0x1C0022B50 (DpIndicateChildStatus.c)
...
void __fastcall DpiMiracastTearDownAssociation(char *P, int a2, int a3, unsigned int a4, char a5)
{
  ...
  if ( v9 )
  {
    ...
    *((_DWORD *)P + 74) = a3;
    ...
    DpiMiracastDdiMiracastDestroyContext(v11, *((_QWORD *)P + 40));
    DpiMiracastEtwLogStopMiracastSessionStage((__int64)P, 1, v12);
    if ( !P[462] && (Microsoft_Windows_DxgKrnlEnableBits & 0x400000) != 0 )
      Template_qqzz(
        v13,
    ...
    *((_QWORD *)P + 48) = 0LL;
    ...
    v23 = (struct _KEVENT *)*((_QWORD *)P + 44);
    if ( v23 )
      KeSetEvent(v23, 0, 0);
    ...
    *((_QWORD *)P + 65) = MEMORY[0xFFFFF78000000014];
    v25 = (v24 - *((_QWORD *)P + 64)) / 10000000;
    if ( DxgkSqmOptedIn() )
    {
      ...
      v38[10] = *((_DWORD *)P + 136);
      v38[14] = *((_DWORD *)P + 137);
      v38[18] = dword_1C0046FE0 - *((_DWORD *)P + 138);
      v38[22] = *((_DWORD *)P + 139);
      v38[26] = *((_DWORD *)P + 132);
      v38[30] = *((_QWORD *)P + 61) >> 16;
      v38[34] = *((_QWORD *)P + 62) >> 16;
      v38[38] = *((_QWORD *)P + 63) >> 16;
      v38[42] = *((_DWORD *)P + 120);
      v27 = *((_DWORD *)P + 135);
      v38[0] = 1;
      v38[4] = 1;
      ...
      v52 = *((_DWORD *)P + 140);
      v54 = *((_DWORD *)P + 141);
      v29 = (unsigned __int16)*((_DWORD *)P + 142);
      v58 = *((_DWORD *)P + 144);
      v30 = *((_DWORD *)P + 176);
      v56 = v29 + (v28 << 16);
      v60 = v30;
      ...
      DxgkSqmCreateStringStreamEntry((__int64)v73, *(const wchar_t **)(v11 + 3256));
    ...
    if ( !a5 )
    {
      *((_QWORD *)P + 11) = 0LL;
      ...
      if ( *(_BYTE *)(v11 + 451) )
        _InterlockedDecrement((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v11 + 24) + 64LL) + 2680LL));
