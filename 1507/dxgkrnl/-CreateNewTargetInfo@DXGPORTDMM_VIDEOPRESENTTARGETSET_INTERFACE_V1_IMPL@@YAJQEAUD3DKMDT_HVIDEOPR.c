/*
 * XREFs of ?CreateNewTargetInfo@DXGPORTDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEAPEAU_D3DKMDT_VIDEO_PRESENT_TARGET@@@Z @ 0x1C00CB860
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  __int64 v14; // rax
  __int64 v15; // rax
  struct _D3DKMDT_VIDEO_PRESENT_TARGET *v16; // [rsp+30h] [rbp+8h] BYREF
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  {
    v16 = 0LL;
    result = DMMVIDEOPRESENTTARGETSET::AcquireRawDdiEnumeratorCachedTargetInfo(v11, &v16);
    if ( (int)result < 0 )
    {
