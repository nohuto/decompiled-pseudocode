/*
 * XREFs of ?AcquireNextTargetInfo@DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEBU_D3DKMDT_VIDEO_PRESENT_TARGET@@PEAPEBU3@@Z @ 0x1C0177F70
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDEO_PRESENT_TARGET **a4)
{
  ...
  __int64 v16; // r9
  __int64 v17; // rax
  struct D3DKMDT_HVIDEOPRESENTTARGETSET__ *v18; // rdi
  __int64 v19; // r14
  __int64 v20; // rax
  __int64 v21; // rcx
  __int64 v22; // rax
...
LABEL_27:
  ...
  *(_QWORD *)&a3->Id = 0LL;
  ...
  if ( !DoublyLinkedList<DMMVIDEOPRESENTTARGET>::ContainsByReference(v14 + 8, v19) )
  {
  ...
  v38 = 0LL;
  v36 = v19;
  v25 = DMMVIDEOPRESENTTARGETSET::AcquireDdiEnumeratorCachedTargetInfo<KM_STL::binder2nd<KM_STL::mem_fun1_t<DMMVIDEOPRESENTTARGET *,DMMVIDEOPRESENTTARGETSET,DMMVIDEOPRESENTTARGET const *>>>(
          v14,
          &v34,
          &v38);
  if ( v25 == -1071774971 )
