/*
 * XREFs of DxgkUnpinDirectFlipResources @ 0x1C0139190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkUnpinDirectFlipResources(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v4 = (_OWORD *)a1;
  *(_DWORD *)(((unsigned __int64)&v33 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = 2080;
...
LABEL_31:
  ...
  if ( v23 >= 0 )
  {
    v8 = DXGDEVICE::UnpinDirectFlipResources(
           v20,
           v17,
           (const unsigned int *)v3 + 36,
           v15,
           (struct COREDEVICEACCESS *)(v3 + 8));
  ...
  *(_QWORD *)(v29 + 32) = v28;
  ...
  DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v33 & 0xFFFFFFFFFFFFFFC0uLL));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v30, &EventProfilerExit, v31, 2080);
