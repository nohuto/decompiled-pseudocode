/*
 * XREFs of ?_OpenMonitorDataStore@DXGMONITOR@@AEAAJEPEAPEAX@Z @ 0x1C00C95E8
 * Callers:
...
__int64 __fastcall DXGMONITOR::_OpenMonitorDataStore(UNICODE_STRING *this, __int64 a2, void **a3, __int64 a4)
{
  char v5; // si
  ...
  Length = this[27].Length;
  if ( Length )
  {
    Destination.Length = 0;
    Destination.MaximumLength = Length + 170;
    v8 = (wchar_t *)operator new[]((unsigned __int16)(Length + 170), 0x4D677844u, PagedPool);
    ...
    if ( v8 )
    {
      ...
      RtlAppendUnicodeStringToString(&Destination, this + 27);
