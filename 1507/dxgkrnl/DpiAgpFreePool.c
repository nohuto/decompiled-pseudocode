/*
 * XREFs of DpiAgpFreePool @ 0x1C016E7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiAgpFreePool(__int64 a1, __int64 a2)
{
  ...
  KeWaitForSingleObject((PVOID)(v5 + 1344), Executive, 0, 0, 0LL);
  v6 = *(unsigned int **)(v5 + 1328);
  v7 = v6;
  v8 = *(unsigned int **)v6;
  if ( *(unsigned int **)v6 != v6 )
  {
    ...
    (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(v5 + 704))(
      *(_QWORD *)(v5 + 648),
      *((_QWORD *)v6 + 3),
      ((v6[14] & 0xFFF) != 0) + (v6[14] >> 12),
      0LL);
    IoFreeMdl(*((PMDL *)v6 + 6));
    (*(void (__fastcall **)(_QWORD, _QWORD))(v5 + 688))(*(_QWORD *)(v5 + 648), *((_QWORD *)v6 + 3));
    v12 = *(unsigned int **)v6;
...
LABEL_11:
  KeReleaseMutex((PRKMUTEX)(v5 + 1344), 0);
  if ( !v3 )
  {
LABEL_12:
    v2 = -1073741811;
