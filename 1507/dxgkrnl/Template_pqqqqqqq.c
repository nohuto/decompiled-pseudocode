/*
 * XREFs of Template_pqqqqqqq @ 0x1C001C87C
 * Callers:
...
NTSTATUS Template_pqqqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v16 = 4LL;
  v18 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, a2, 0LL, 8u, &UserData);
}
