/*
 * XREFs of ?AcquireSourceSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXPEAPEAUD3DKMDT_HVIDEOPRESENTSOURCESET__@@PEAPEBU_DXGDMM_VIDEOPRESENTSOURCESET_INTERFACE@@@Z @ 0x1C0178190
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 && a3 )
  {
    ...
    *a3 = 0LL;
    if ( this )
    {
      ...
      {
        v9 = *(_QWORD *)(v16 + 88);
        v19 = *(struct D3DKMDT_HVIDEOPRESENTSOURCESET__ **)(v9 + 408);
