/*
 * XREFs of ?Win32kNtUserCleanupInternal@@YAXXZ @ 0x1C006BD14
 * Callers:
 *     ?Win32kNtUserCleanup@@YAHXZ @ 0x1C006BA54 (-Win32kNtUserCleanup@@YAHXZ.c)
 * Callees:
 *     IsCleanupPointerInputSupported_0 @ 0x1C0002500 (IsCleanupPointerInputSupported_0.c)
 *     CleanupPointerInput_0 @ 0x1C0002508 (CleanupPointerInput_0.c)
 *     IsFreeImeHotKeysSupported_0 @ 0x1C0002510 (IsFreeImeHotKeysSupported_0.c)
 *     FreeImeHotKeys_0 @ 0x1C0002518 (FreeImeHotKeys_0.c)
 *     IsGetgpastrSetupExeSupported_0 @ 0x1C0002520 (IsGetgpastrSetupExeSupported_0.c)
 *     GetgpastrSetupExe_0 @ 0x1C0002528 (GetgpastrSetupExe_0.c)
 *     IsGetglpSetupProgramsSupported_0 @ 0x1C0002530 (IsGetglpSetupProgramsSupported_0.c)
 *     GetglpSetupPrograms_0 @ 0x1C0002538 (GetglpSetupPrograms_0.c)
 *     IsGetpbwlCacheSupported_0 @ 0x1C0002540 (IsGetpbwlCacheSupported_0.c)
 *     GetpbwlCache_0 @ 0x1C0002548 (GetpbwlCache_0.c)
 *     IsFreeTimerSupported_0 @ 0x1C0002550 (IsFreeTimerSupported_0.c)
 *     FreeTimer_0 @ 0x1C0002560 (FreeTimer_0.c)
 *     IsCleanupDesktopsMonitorsAndWindowsSnapShotSupported_0 @ 0x1C0002568 (IsCleanupDesktopsMonitorsAndWindowsSnapShotSupported_0.c)
 *     CleanupDesktopsMonitorsAndWindowsSnapShot_0 @ 0x1C0002570 (CleanupDesktopsMonitorsAndWindowsSnapShot_0.c)
 *     IsCleanupModuleAllocationsSupported_0 @ 0x1C0002578 (IsCleanupModuleAllocationsSupported_0.c)
 *     CleanupModuleAllocations_0 @ 0x1C0002580 (CleanupModuleAllocations_0.c)
 *     IsCleanupHidRequestListSupported_0 @ 0x1C0002588 (IsCleanupHidRequestListSupported_0.c)
 *     CleanupHidRequestList_0 @ 0x1C0002590 (CleanupHidRequestList_0.c)
 *     IsFreeDeviceInfoSupported_0 @ 0x1C0002598 (IsFreeDeviceInfoSupported_0.c)
 *     FreeDeviceInfo_0 @ 0x1C00025A0 (FreeDeviceInfo_0.c)
 *     IsCleanupFeedbackDataSupported_0 @ 0x1C00025A8 (IsCleanupFeedbackDataSupported_0.c)
 *     CleanupFeedbackData_0 @ 0x1C00025B0 (CleanupFeedbackData_0.c)
 *     IsFreeSMSSupported_0 @ 0x1C00025B8 (IsFreeSMSSupported_0.c)
 *     FreeSMS_0 @ 0x1C00025C0 (FreeSMS_0.c)
 *     IsGetSMSLookasideSupported_0 @ 0x1C00025C8 (IsGetSMSLookasideSupported_0.c)
 *     GetSMSLookaside_0 @ 0x1C00025D0 (GetSMSLookaside_0.c)
 *     IsCleanupKeyboardLayoutsSupported_0 @ 0x1C00025D8 (IsCleanupKeyboardLayoutsSupported_0.c)
 *     CleanupKeyboardLayouts_0 @ 0x1C00025E0 (CleanupKeyboardLayouts_0.c)
...
void Win32kNtUserCleanupInternal(void)
{
  ...
  while ( (__int64)v0 <= (__int64)dword_1C00FEF60 );
  if ( gpresUser )
  {
  ...
  if ( (int)IsFreeSMSSupported_0() >= 0 )
  {
    ...
    qword_1C01041D8 = (__int64)&gsmsList;
    gsmsList = &gsmsList;
  }
