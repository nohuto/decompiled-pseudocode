/*
 * XREFs of WPP_RECORDER_SF_qi @ 0x1C00C7B80
 * Callers:
...
__int64 WPP_RECORDER_SF_qi(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_6c94d55ff2a354cdce5d424b790ce363_Traceguids,
      a4,
      (__int64 *)va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 3LL, 5LL, &WPP_6c94d55ff2a354cdce5d424b790ce363_Traceguids, v8, (__int64 *)va);
}
