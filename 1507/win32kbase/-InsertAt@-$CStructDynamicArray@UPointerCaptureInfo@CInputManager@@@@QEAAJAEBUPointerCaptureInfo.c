/*
 * XREFs of ?InsertAt@?$CStructDynamicArray@UPointerCaptureInfo@CInputManager@@@@QEAAJAEBUPointerCaptureInfo@CInputManager@@I@Z @ 0x1C00DE718
 * Callers:
 *     ?UpdatePointerCapture@CInputManager@@SAJII@Z @ 0x1C00DE878 (-UpdatePointerCapture@CInputManager@@SAJII@Z.c)
 * Callees:
