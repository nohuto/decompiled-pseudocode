/*
 * XREFs of ?bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C00B42C0
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C0025898 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C00265B4 (-vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 *     ?vInit@HFDBASIS64@@QEAAXJJJJ@Z @ 0x1C0085F78 (-vInit@HFDBASIS64@@QEAAXJJJJ@Z.c)
 *     ?bIntersect@@YAHPEAU_RECTFX@@0@Z @ 0x1C00B4290 (-bIntersect@@YAHPEAU_RECTFX@@0@Z.c)
 *     ?vError@HFDBASIS64@@QEAAXPEA_J@Z @ 0x1C00B4780 (-vError@HFDBASIS64@@QEAAXPEA_J@Z.c)
 *     ?vParentError@HFDBASIS64@@QEAAXPEA_J@Z @ 0x1C00B4900 (-vParentError@HFDBASIS64@@QEAAXPEA_J@Z.c)
 *     ?vUntransform@HFDBASIS64@@QEAAXPEAJ@Z @ 0x1C00B4978 (-vUntransform@HFDBASIS64@@QEAAXPEAJ@Z.c)
 */
