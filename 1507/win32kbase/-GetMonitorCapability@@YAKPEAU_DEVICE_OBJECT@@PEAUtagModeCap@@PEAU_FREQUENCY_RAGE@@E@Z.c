/*
 * XREFs of ?GetMonitorCapability@@YAKPEAU_DEVICE_OBJECT@@PEAUtagModeCap@@PEAU_FREQUENCY_RAGE@@E@Z @ 0x1C006532C
 * Callers:
 ...
 *     ?GetMonitorCapability2@@YAKPEAU_EDID2@@PEAUtagModeCap@@PEAU_FREQUENCY_RAGE@@E@Z @ 0x1C00BA198 (-GetMonitorCapability2@@YAKPEAU_EDID2@@PEAUtagModeCap@@PEAU_FREQUENCY_RAGE@@E@Z.c)
 */
