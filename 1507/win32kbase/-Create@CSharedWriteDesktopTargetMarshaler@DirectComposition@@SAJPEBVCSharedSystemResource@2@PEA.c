/*
 * XREFs of ?Create@CSharedWriteDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00838F4
 * Callers:
 *     CreateSharedWriteDesktopTargetMarshaler @ 0x1C00838C0 (CreateSharedWriteDesktopTargetMarshaler.c)
 * Callees:
