/*
 * XREFs of ?ReplacePreferredScaling@@YAJPEBU_D3DKMT_GETPATHSMODALITY@@PEAU1@@Z @ 0x1C00BA808
 * Callers:
...
__int64 __fastcall ReplacePreferredScaling(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  __int16 v4; // ax
  ...
  while ( 1 )
  {
    ...
    if ( v13 )
    {
      ...
      while ( 1 )
      {
        ...
        v14 = (_DWORD *)(a1 + v6 + 48);
        if ( v14[5] == *(_DWORD *)(v11 + v5 + 68) && v14[2] == *v13 && v14[3] == v13[1] )
          break;
    ...
    *(_DWORD *)(v11 + v5 + 172) = v14[31];
    v17 = v14[32];
    *(_DWORD *)(v11 + v5 + 48) |= 0x10400u;
    *(_DWORD *)(v11 + v5 + 176) = v17;
LABEL_22:
    if ( ++v10 >= *(unsigned __int16 *)(v5 + 20) )
      return 0LL;
  }
LABEL_14:
  v7 = WdLogNewEntry5_WdError(a1, a2, v13, a4);
