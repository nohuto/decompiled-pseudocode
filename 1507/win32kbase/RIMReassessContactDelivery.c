/*
 * XREFs of RIMReassessContactDelivery @ 0x1C00CBEA0
 * Callers:
 *     RIMGetPointerDeviceContactState @ 0x1C00CB12C (RIMGetPointerDeviceContactState.c)
 * Callees:
 *     IsIsPointerNodeInContactSupported_0 @ 0x1C0002E88 (IsIsPointerNodeInContactSupported_0.c)
 *     IsPointerNodeInContact_0 @ 0x1C0002E90 (IsPointerNodeInContact_0.c)
...
__int64 __fastcall RIMReassessContactDelivery(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  if ( (unsigned int)(*(_DWORD *)(a2 + 24) - 1) > 4
    || (unsigned int)RIMABIsDeviceAllowed(
                       a1,
                       a2,
                       *(_DWORD *)(2400 * v6 + *(_QWORD *)(a2 + 680) + 2340),
                       (*(_DWORD *)(a4 + 12) >> 14) & 1,
                       v6) )
  {
    if ( (_DWORD)a5 || (v11 = 2400 * v6, (*(_DWORD *)(*(_QWORD *)(a2 + 680) + 2400 * v6 + 2392) & 0x80u) != 0) )
    {
      v14 = *(_DWORD *)(a4 + 12);
      v15 = (v14 & 0x40004) != 0;
      v16 = v14 & 0xFFF8FFF9;
      *(_DWORD *)(a4 + 12) = v16;
      ...
      v17 = (_DWORD *)(*(_QWORD *)(a2 + 680) + 2400 * v6 + 2392);
      *v17 &= ~0x200u;
      *(_DWORD *)(*(_QWORD *)(a2 + 680) + 2400 * v6 + 2392) |= 0x20u;
      *(_DWORD *)(*(_QWORD *)(a2 + 680) + 2400 * v6 + 2392) &= ~0x100u;
      WPP_RECORDER_SF_d(
        (__int64)WPP_GLOBAL_Control->DeviceExtension,
        v9,
        5u,
    ...
    if ( (v12 & 4) != 0 )
    {
      *(_DWORD *)(a4 + 12) = v12 & 0xFFF9FFFF;
      ...
      {
        *(_DWORD *)(*(_QWORD *)(a2 + 680) + v11 + 2392) |= 0x200u;
        ApiSetDwmAsyncNotifyDigitizerActiveContacts(0LL, (unsigned int)++*(_DWORD *)(a1 + 556));
    ...
    *(_DWORD *)(*(_QWORD *)(a2 + 680) + v11 + 2392) &= ~0x20u;
LABEL_24:
    v10 = 38;
