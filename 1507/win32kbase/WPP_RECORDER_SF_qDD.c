/*
 * XREFs of WPP_RECORDER_SF_qDd @ 0x1C00C2CB4
 * Callers:
...
__int64 WPP_RECORDER_SF_qDd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_dd9f0c7a0f42e4329fa71b586c89d33f_Traceguids,
      13LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 2LL, 2LL, &WPP_dd9f0c7a0f42e4329fa71b586c89d33f_Traceguids, v7, (__int64 *)va);
}
