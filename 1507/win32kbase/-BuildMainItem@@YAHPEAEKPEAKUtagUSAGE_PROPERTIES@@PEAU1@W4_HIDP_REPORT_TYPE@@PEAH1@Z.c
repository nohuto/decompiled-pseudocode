/*
 * XREFs of ?BuildMainItem@@YAHPEAEKPEAKUtagUSAGE_PROPERTIES@@PEAU1@W4_HIDP_REPORT_TYPE@@PEAH1@Z @ 0x1C00C6FF8
 * Callers:
 ...
 *     ?OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z @ 0x1C00C776C (-OpenCollection@@YAHPEAEKW4tagHID_IDE_COL_TYPE@@PEAK@Z.c)
 *     ?SetCollectionLabel@@YAHPEAEKPEAK@Z @ 0x1C00C77D0 (-SetCollectionLabel@@YAHPEAEKPEAK@Z.c)
 *     ?SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z @ 0x1C00C7838 (-SetMultiByteValue@@YAHPEAEKPEAKPEAHK1@Z.c)
 */
