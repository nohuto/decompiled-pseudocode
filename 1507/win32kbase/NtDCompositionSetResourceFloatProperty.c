/*
 * XREFs of NtDCompositionSetResourceFloatProperty @ 0x1C002CBA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionSetResourceFloatProperty(unsigned int a1, unsigned int a2, unsigned int a3, int a4)
{
  int v6; // edi
  unsigned int v7; // r8d
