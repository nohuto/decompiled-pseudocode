/*
 * XREFs of WinSqmStartSession @ 0x1C007B558
 * Callers:
...
__int64 WinSqmStartSession()
{
  ...
  if ( (dword_1C01001A0 & 2) == 0 && (unsigned int)IsSessionDisabled(&Win32kSQMSession, 0x62004u) )
  {
    dword_1C01001A0 |= 2u;
  }
  else
    ...
    if ( v0 )
    {
      ...
      *(GUID *)(v0 + 24) = Win32kSQMSession;
      if ( RegHandle || !RegisterWinSqmProvider() )
      {
        ...
        UserData[1].Ptr = (ULONGLONG)&unk_1C0106558;
