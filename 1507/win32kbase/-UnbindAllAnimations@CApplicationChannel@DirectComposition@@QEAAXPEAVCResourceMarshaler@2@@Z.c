/*
 * XREFs of ?UnbindAllAnimations@CApplicationChannel@DirectComposition@@QEAAXPEAVCResourceMarshaler@2@@Z @ 0x1C002E0B4
 * Callers:
 *     ?SetRectangleHelper@CRectangleClipMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@PEBUD2D_RECT_F@@PEA_N@Z @ 0x1C0026AF0 (-SetRectangleHelper@CRectangleClipMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@PE.c)
 ...
 *     ?SetMatrixHelper@CAffineTransform2DEffectMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBUD2D_MATRIX_3X2_F@@PEA_N@Z @ 0x1C00DD700 (-SetMatrixHelper@CAffineTransform2DEffectMarshaler@DirectComposition@@QEAAJPEAVCApplicationChann.c)
