/*
 * XREFs of DrvQueryDisplayConfig @ 0x1C001E870
 * Callers:
...
__int64 __fastcall DrvQueryDisplayConfig(unsigned int a1, _DWORD *a2, __int64 a3, __int64 a4, __int64 a5, _DWORD *a6)
{
  ...
  *(_QWORD *)(v10 + 24) = v7;
  ...
  {
    if ( (_DWORD)v7 == 4 && (unsigned __int8)((__int64 (*)(void))qword_1C01015A8)() )
    {
      v11 = 1;
      LODWORD(v7) = 2;
      v12 = 0LL;
    ...
    v13 = ((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64, __int64, __int64, _DWORD *))qword_1C0101328)(
            (unsigned int)v7,
            a2,
            a3,
            a4,
