/*
 * XREFs of RIMICAnalyzeUserPalmCluster @ 0x1C00D2940
 * Callers:
...
__int64 __fastcall RIMICAnalyzeUserPalmCluster(__int64 a1, __int64 a2)
{
  ...
  v6 = 0;
  v7 = 0;
  v8 = *(_QWORD *)(*(_QWORD *)(a2 + 680) + 2276LL);
  v9 = a1;
    ...
    if ( v3 != v2 )
    {
      do
      {
          ...
          && *(_DWORD *)(v14 + 704) )
        {
          ...
          {
            v17 = 2400LL * v16;
            v11 = v17 + *(_QWORD *)(v14 + 680);
            if ( *(_DWORD *)(v11 + 2336) && (*(_DWORD *)(v11 + 2392) & 0x10000) == 0 )
            {
              RIMICEClassifyContact(*(_DWORD **)(v15 + 680), v11, v12);
              v18 = *(_QWORD *)(v14 + 680);
