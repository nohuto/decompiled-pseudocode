/*
 * XREFs of Template_pqqqqqq @ 0x1C00BEB40
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C000EC40 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C0012B40 (EtwDevLockEndTightUpdate.c)
 * Callees:
