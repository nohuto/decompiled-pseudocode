/*
 * XREFs of ?DxgkEngGetRgnDataApiExt@@YAIPEAUHRGN__@@IPEAU_RGNDATA@@@Z @ 0x1C00B5AF0
 * Callers:
 *     <none>
 * Callees:
 *     IsDxgkEngGetRgnDataSupported_0 @ 0x1C0001500 (IsDxgkEngGetRgnDataSupported_0.c)
 *     DxgkEngGetRgnData_0 @ 0x1C0001508 (DxgkEngGetRgnData_0.c)
 */
