/*
 * XREFs of RIMAssessPointerContactState @ 0x1C00C9EAC
 * Callers:
...
LABEL_25:
      ...
      while ( 1 )
      {
        ...
        if ( !*(_DWORD *)(v15 + v8 + 2336) )
          goto LABEL_23;
        v16 = (unsigned int)(v4 - *(_DWORD *)(v15 + v8 + 2248)) > *(_DWORD *)(v9 + 864);
        if ( *(_DWORD *)(v15 + v8 + 2340) )
        {
          if ( (unsigned int)(v4 - *(_DWORD *)(v15 + v8 + 2248)) > *(_DWORD *)(v9 + 864)
