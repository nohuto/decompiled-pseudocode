/*
 * XREFs of ?NotifyDirty@CCompositionBuffer@@QEAAXAEBVCRegion@@PEBUScrollOptimization@@@Z @ 0x1C004A2C0
 * Callers:
        ...
        const struct ScrollOptimization *a3)
{
  ...
  if ( *((_DWORD *)this + 74) )
  {
    CCompositionBuffer::AddScrollAsDirty(this, (CCompositionBuffer *)((char *)this + 296));
    *(_DWORD *)v3 = 0;
    *((_BYTE *)this + 324) = 1;
  }
  if ( a3 && *(_DWORD *)a3 )
  ...
  if ( v7 )
  {
    ...
    {
      CRegion::Combine(*((_QWORD *)this + 36), a2, 2LL);
      *((_BYTE *)this + 324) = 1;
    }
  }
}
