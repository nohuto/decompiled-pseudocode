/*
 * XREFs of ?EmitOptions@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00297A0
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x14uLL, &v5) )
  {
    ...
    *((_DWORD *)v4 + 3) = (*((unsigned __int8 *)this + 228) >> 3) & 1;
    *((_DWORD *)v4 + 4) = (*((unsigned __int8 *)this + 228) >> 2) & 1;
