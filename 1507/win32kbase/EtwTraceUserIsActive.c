/*
 * XREFs of EtwTraceUserIsActive @ 0x1C00134B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  if ( ((unsigned __int64)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine & 0x8000000000020000uLL) != 0
    ...
    && (qword_1C00FEA40 & 0x8000000000020000uLL) != 0
    && (qword_1C00FEA48 & 0x8000000000020000uLL) == qword_1C00FEA48
