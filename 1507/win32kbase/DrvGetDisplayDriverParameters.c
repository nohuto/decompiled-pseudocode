/*
 * XREFs of DrvGetDisplayDriverParameters @ 0x1C0060040
 * Callers:
...
__int64 __fastcall DrvGetDisplayDriverParameters(__int64 a1, __int128 *a2, int a3, int a4, __int64 a5)
{
  ...
  __int64 (__fastcall *v154)(unsigned __int16 *, __int64, void *, unsigned __int16, void *, _WORD *); // [rsp+4C0h] [rbp+3C0h]
  ...
  __int64 v163; // [rsp+508h] [rbp+408h]
  _BYTE v164[32]; // [rsp+510h] [rbp+410h] BYREF
...
LABEL_16:
  ...
  if ( v6 )
  {
    UpdateMonitorDevices(p_Name, v15);
    v32 = a2[1];
    v60 = *a2;
    v33 = a2[2];
    v61 = v32;
