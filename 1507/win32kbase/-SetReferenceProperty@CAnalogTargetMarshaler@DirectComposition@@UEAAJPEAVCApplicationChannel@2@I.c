/*
 * XREFs of ?SetReferenceProperty@CAnalogTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00DB9C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CAnalogTargetMarshaler::SetReferenceProperty(
        ...
        bool *a5)
{
  ...
  if ( v9 )
  {
    if ( v9 == 1
      && (!a4
       || (*(unsigned int (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)a4 + 16LL))(a4) == 79) )
    {
