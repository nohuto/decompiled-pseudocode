/*
 * XREFs of ?SetClipRectangleHelper@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEAX_KPEA_N@Z @ 0x1C0029FE0
 * Callers:
        ...
        bool *a5)
{
  ...
  v7 = 0;
  if ( !v6
    || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v6 + 112LL))(v6, 63LL)
  ...
  {
    v7 = 1;
    v15 = DirectComposition::CApplicationChannel::CreateInternalResource(a2, 0x3Fu, &v16);
    v11 = v16;
    v13 = v15;
    if ( v15 < 0 )
      goto LABEL_10;
  }
  v12 = DirectComposition::CApplicationChannel::SetResourceBufferProperty(a2, v11, 0xCu, a3, a4);
  v13 = v12;
  if ( v7 )
  {
    if ( v12 >= 0 )
