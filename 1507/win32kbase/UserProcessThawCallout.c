/*
 * XREFs of UserProcessThawCallout @ 0x1C00075B4
 * Callers:
 ...
 *     IsResumeThreadQueueSupported_0 @ 0x1C0001FF8 (IsResumeThreadQueueSupported_0.c)
 *     ResumeThreadQueue_0 @ 0x1C0002000 (ResumeThreadQueue_0.c)
