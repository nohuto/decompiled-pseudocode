/*
 * XREFs of ?EmitUpdateCommands@CMatrixTransformMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0028FF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CMatrixTransformMarshaler::EmitUpdateCommands(
