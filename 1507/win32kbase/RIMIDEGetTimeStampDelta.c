/*
 * XREFs of RIMIDEGetTimeStampDelta @ 0x1C00C5AF0
 * Callers:
 ...
 *     RIMIDEGetQpcBasedTouchStackTime @ 0x1C00C5A74 (RIMIDEGetQpcBasedTouchStackTime.c)
 *     RIMIDEValidateInjectionQpcCount @ 0x1C00C6CA8 (RIMIDEValidateInjectionQpcCount.c)
 *     RIMIDEValidateInjectionTime @ 0x1C00C6D54 (RIMIDEValidateInjectionTime.c)
 */
