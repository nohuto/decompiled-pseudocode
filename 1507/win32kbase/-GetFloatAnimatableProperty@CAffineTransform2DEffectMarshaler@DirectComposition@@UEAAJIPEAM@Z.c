/*
 * XREFs of ?GetFloatAnimatableProperty@CAffineTransform2DEffectMarshaler@DirectComposition@@UEAAJIPEAM@Z @ 0x1C00DD570
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        float *a3)
{
  ...
  {
    v4 = *((_DWORD *)this + 2 * ((unsigned int)(a2 - 4) >> 1) + (a2 & 1) + 26);
LABEL_6:
    *(_DWORD *)a3 = v4;
    return v3;
  }
