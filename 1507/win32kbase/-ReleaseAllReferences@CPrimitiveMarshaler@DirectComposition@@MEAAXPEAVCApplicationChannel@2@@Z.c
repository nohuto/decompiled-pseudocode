/*
 * XREFs of ?ReleaseAllReferences@CPrimitiveMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00D6320
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DirectComposition::CPrimitiveMarshaler::ReleaseAllReferences(
