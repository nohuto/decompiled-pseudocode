/*
 * XREFs of ?ReferenceHandleAndLock@CChannel@DirectComposition@@SAJIPEAPEAV12@@Z @ 0x1C002D268
 * Callers:
        ...
        __int64 a4)
{
  ...
  v6 = 0;
  v7 = 0LL;
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(a1, a2, a3, a4, Buffer, v16);
