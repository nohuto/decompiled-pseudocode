/*
 * XREFs of ?HMGrowHandleTable@@YAHXZ @ 0x1C0012D1C
 * Callers:
...
__int64 HMGrowHandleTable(void)
{
  ...
  if ( *((_QWORD *)gpsi + 1) == 65534LL )
    return 0LL;
  v0 = qword_1C01003E8 + *((unsigned int *)gpsi + 212);
  ...
  *((_QWORD *)gpsi + 1) = *((unsigned int *)gpsi + 212) / 0x18uLL;
  ...
  v2 = gHandlePages;
  memset((void *)(qword_1C01003E8 + 24LL * gHandlePages), 0, 24LL * (v1[1] - gHandlePages));
  v3 = gpsi;
  v4 = *((_QWORD *)gpsi + 1) - 1LL;
  v5 = qword_1C01003E8 + 24 * v4;
  if ( v4 >= v2 )
  {
    do
    {
      *(_WORD *)(v5 + 18) = 1;
      if ( (v4 & 1) != 0 )
      {
        *(_QWORD *)v5 = qword_1C0100040;
        qword_1C0100040 = v4;
      }
      else
      {
        *(_QWORD *)v5 = qword_1C0100038;
        qword_1C0100038 = v4;
      }
      --v4;
      v5 -= 24LL;
