/*
 * XREFs of ??$CitpBaseUseDataMerge@U_CIT_SYSTEM_DATA@@@@YAXPEAU_CIT_SYSTEM_DATA@@PEBU0@@Z @ 0x1C00E2474
 * Callers:
 ...
 *     ?CitpBitmapMerge@@YAXPEAU_CIT_BITMAP@@PEBU1@@Z @ 0x1C00E2C7C (-CitpBitmapMerge@@YAXPEAU_CIT_BITMAP@@PEBU1@@Z.c)
 */
