/*
 * XREFs of ?EmitSetComponents@CManipulationTransformMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00267A8
 * Callers:
  ...
  if ( (*((_DWORD *)this + 4) & 0x40) == 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x3CuLL, &v7) )
    {
      ...
      *v5 = 176;
      ...
      v5[11] = *((_DWORD *)this + 19);
      v5[12] = *((_DWORD *)this + 20);
      v5[13] = *((_DWORD *)this + 21);
      *((_DWORD *)this + 4) |= 0x40u;
    }
    else
    {
