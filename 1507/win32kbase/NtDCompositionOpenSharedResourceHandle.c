/*
 * XREFs of NtDCompositionOpenSharedResourceHandle @ 0x1C00144A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionOpenSharedResourceHandle(unsigned int a1, unsigned int a2, _QWORD *a3)
{
  int v5; // ebx
