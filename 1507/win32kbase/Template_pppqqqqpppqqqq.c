/*
 * XREFs of Template_pppqqqqpppqqqq @ 0x1C00A9774
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C0018CA0 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C00BEA10 (EtwWindowRendering.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0085840 (__security_check_cookie.c)
 */

NTSTATUS Template_pppqqqqpppqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  __int64 v55; // [rsp+1A8h] [rbp+A8h] BYREF
  va_list va12; // [rsp+1A8h] [rbp+A8h]
