/*
 * XREFs of CitSessionConnectChange @ 0x1C006F7A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CitSessionConnectChange(char a1, char a2)
{
  ...
  v2 = qword_1C0101FE0;
  if ( !qword_1C0101FE0 || ((*((_BYTE *)qword_1C0101FE0 + 432) & 8) != 0) == a1 )
    return;
  v5 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( a1 )
  {
    ++*((_WORD *)qword_1C0101FE0 + 217);
...
LABEL_11:
  ...
  CitpStatIncrement((unsigned __int16 *)qword_1C0101FE0 + 105, 1);
...
LABEL_6:
  *((_BYTE *)v2 + 432) = *((_BYTE *)v2 + 432) & 0xD7 | (8 * (a1 & 1 | (4 * (v6 & 1))));
  ...
  CIT_DESKTOP_ACTIVE_TRACKER::UpdateActive((struct _CIT_IMPACT_CONTEXT *)((char *)v2 + 544), IsUserDesktopActive, v5);
