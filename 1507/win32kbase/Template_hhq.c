/*
 * XREFs of Template_hhq @ 0x1C00A9694
 * Callers:
 *     EtwTracePointerCoalesce @ 0x1C00A7910 (EtwTracePointerCoalesce.c)
 *     EtwTracePointerNoCoalesce @ 0x1C00A7B90 (EtwTracePointerNoCoalesce.c)
 * Callees:
