/*
 * XREFs of ?ReleaseAllReferences@CVisualMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C002ABA0
 * Callers:
 *     ?ReleaseAllReferences@CHostVisualMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00032F0 (-ReleaseAllReferences@CHostVisualMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z.c)
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  v9 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)this + 22);
  if ( v9 )
  {
  ...
  v10 = *(_QWORD *)this;
  v11 = 0;
  (*(void (__fastcall **)(DirectComposition::CVisualMarshaler *, struct DirectComposition::CApplicationChannel *, char *))(v10 + 232))(
    this,
    a2,
    &v11);
}
