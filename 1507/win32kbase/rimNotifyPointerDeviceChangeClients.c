/*
 * XREFs of rimNotifyPointerDeviceChangeClients @ 0x1C00CEAEC
 * Callers:
 *     rimSetPointerDeviceDisplayConfig @ 0x1C001A170 (rimSetPointerDeviceDisplayConfig.c)
 * Callees:
 *     IsPostPointerEventMessageSupported_0 @ 0x1C0002E98 (IsPostPointerEventMessageSupported_0.c)
 *     PostPointerEventMessage_0 @ 0x1C0002EA0 (PostPointerEventMessage_0.c)
...
__int64 __fastcall rimNotifyPointerDeviceChangeClients(_DWORD *a1, __int64 a2, unsigned int *a3, int a4)
{
  ...
  if ( a1[197] != a3[3] || a1[198] != a3[4] )
    v5 |= 0x400u;
  result = *a3;
  if ( a1[194] != (_DWORD)result || (result = a3[1], a1[195] != (_DWORD)result) )
    v5 |= 0x200u;
  if ( a4 )
    v5 |= 0x100u;
  if ( v5 )
