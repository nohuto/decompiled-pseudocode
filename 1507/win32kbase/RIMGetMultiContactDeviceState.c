/*
 * XREFs of RIMGetMultiContactDeviceState @ 0x1C00CABDC
 * Callers:
 *     RIMExtractDeviceUsages @ 0x1C00CA2A0 (RIMExtractDeviceUsages.c)
 * Callees:
 *     IsApplyPTPTranslationSupported_0 @ 0x1C0002CF0 (IsApplyPTPTranslationSupported_0.c)
 *     ApplyPTPTranslation_0 @ 0x1C0002CF8 (ApplyPTPTranslation_0.c)
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      if ( *(_DWORD *)(v14 + v17) == *a8 && *(_DWORD *)(v14 + v17 + 2336) )
      {
        ...
        v21 = 1;
        v22 = (int)a1;
        *v11 = *(_WORD *)(v19 + *(_QWORD *)(v8 + 680) + 2332);
        goto LABEL_24;
      }
    ...
    *(_DWORD *)(v8 + 688) = v18;
    if ( v18 > v13 )
      WPP_RECORDER_SF_dd(
        ...
        v13,
        v18);
    if ( (*(_DWORD *)(v8 + 236) & 0x20) != 0 && *(_DWORD *)(v8 + 688) > 1u )
    {
      v23 = 2400LL * v9;
      *(_DWORD *)(v23 + *(_QWORD *)(v8 + 680) + 2392) |= 0x20u;
      *(_DWORD *)(v23 + *(_QWORD *)(v8 + 680) + 2392) &= ~0x100u;
      LODWORD(v32) = v9;
      WPP_RECORDER_SF_d(
        (__int64)WPP_GLOBAL_Control->DeviceExtension,
        v14,
    ...
    v24 = 2400LL * v9;
    *(_DWORD *)(v24 + *(_QWORD *)(v8 + 680) + 2392) &= ~4u;
    *(_DWORD *)(v24 + *(_QWORD *)(v8 + 680)) = *(_DWORD *)v15;
    *(_DWORD *)(v24 + *(_QWORD *)(v8 + 680) + 2336) = 1;
    *(_DWORD *)(v24 + *(_QWORD *)(v8 + 680) + 2332) = RIMGetNextFreeCursor(v8);
    *v11 = *(_WORD *)(v24 + *(_QWORD *)(v8 + 680) + 2332);
    *(_DWORD *)(v24 + *(_QWORD *)(v8 + 680) + 2348) = (MEMORY[0xFFFFF78000000320]
...
LABEL_24:
    if ( *(_DWORD *)(v8 + 24) == 8 )
    {
      ...
      v30 = 2400LL * v16;
      *(_QWORD *)(v30 + *(_QWORD *)(v8 + 680) + 2260) = *((_QWORD *)v11 + 6);
      *(_QWORD *)(v30 + *(_QWORD *)(v8 + 680) + 2276) = *((_QWORD *)v11 + 8);
      *(_QWORD *)(v30 + *(_QWORD *)(v8 + 680) + 2284) = *(_QWORD *)(v15 + 12);
    }
    else
    {
      ...
      *(_QWORD *)(2400LL * v16 + *(_QWORD *)(v8 + 680) + 2292) = *((_QWORD *)v11 + 8);
...
LABEL_38:
  ...
  {
    v26 = (__int64 **)(*(_QWORD *)(*(_QWORD *)(v8 + 696) + 48LL)
                     + 8LL * (unsigned int)(*(_DWORD *)v15 % *(_DWORD *)(v8 + 704)));
