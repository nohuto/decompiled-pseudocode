/*
 * XREFs of ?HasAnimations@CResourceMarshaler@DirectComposition@@QEAA_NI@Z @ 0x1C002B8CC
 * Callers:
 *     ?SetFloatProperty@CVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C002A700 (-SetFloatProperty@CVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z.c)
 * Callees:
