/*
 * XREFs of ?Create@CSharedReadDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00DE2F4
 * Callers:
 *     CreateSharedReadDesktopTargetMarshaler @ 0x1C00DE390 (CreateSharedReadDesktopTargetMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadDesktopTargetMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadDesktopTargetMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 208LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
