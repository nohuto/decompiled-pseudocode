/*
 * XREFs of ?InsertObject@CLinearHandleTableBase@DirectComposition@@QEAAJPEAXPEAI@Z @ 0x1C0031290
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  {
    v8 = v5;
    v4 = DirectComposition::CDCompDynamicArrayBase::Grow(this, 1LL, 0x746C4344u);
    if ( v4 < 0 )
