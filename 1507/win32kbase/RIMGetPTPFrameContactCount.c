/*
 * XREFs of RIMGetPTPFrameContactCount @ 0x1C00D0A88
 * Callers:
        ...
        LARGE_INTEGER *a10)
{
  ...
  *a10 = KeQueryPerformanceCounter(0LL);
  v15 = *(unsigned int **)(v13 + 696);
  v35 = *(_DWORD *)(v13 + 704) - 1;
