/*
 * XREFs of ?vLock@XDCOBJ@@IEAAXPEAUHDC__@@@Z @ 0x1C00AF2A0
 * Callers:
 ...
 *     ?bSaveAttributes@XDCOBJ@@AEAAHXZ @ 0x1C003BA40 (-bSaveAttributes@XDCOBJ@@AEAAHXZ.c)
...
void __fastcall XDCOBJ::vLock(XDCOBJ *this, HDC a2)
{
  ...
  v3 = HmgLockEx((int)a2, 1, *((_DWORD *)this + 3));
  *(_QWORD *)this = v3;
  if ( v3 )
  {
