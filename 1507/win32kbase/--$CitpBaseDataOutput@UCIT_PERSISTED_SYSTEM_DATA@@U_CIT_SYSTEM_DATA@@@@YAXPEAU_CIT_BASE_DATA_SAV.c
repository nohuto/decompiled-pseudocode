/*
 * XREFs of ??$CitpBaseDataOutput@UCIT_PERSISTED_SYSTEM_DATA@@U_CIT_SYSTEM_DATA@@@@YAXPEAU_CIT_BASE_DATA_SAVE_CONTEXT@@PEAUCIT_PERSISTED_SYSTEM_DATA@@PEBU_CIT_SYSTEM_DATA@@@Z @ 0x1C00E2270
 * Callers:
 ...
 *     ?AdvanceToNext@?$CIT_PERSISTED_SECTION@U_CIT_PERSISTED_BITMAP@@@@QEAAXXZ @ 0x1C00E2804 (-AdvanceToNext@-$CIT_PERSISTED_SECTION@U_CIT_PERSISTED_BITMAP@@@@QEAAXXZ.c)
 */
