/*
 * XREFs of NtUserInitialize @ 0x1C007A990
 * Callers:
 *     <none>
 * Callees:
 *     IsVerifyTcbPrivilegesSupported_0 @ 0x1C0002AB0 (IsVerifyTcbPrivilegesSupported_0.c)
 *     VerifyTcbPrivileges_0 @ 0x1C0002AB8 (VerifyTcbPrivileges_0.c)
 *     IsInitializeMediaChangeSupported_0 @ 0x1C0002AC0 (IsInitializeMediaChangeSupported_0.c)
 *     InitializeMediaChange_0 @ 0x1C0002AC8 (InitializeMediaChange_0.c)
...
__int64 __fastcall NtUserInitialize(__int64 a1, __int64 a2)
{
  ...
  if ( (int)result >= 0 )
  {
    dword_1C00FFEF8 = IsCustomAdbAlgorithmSet();
