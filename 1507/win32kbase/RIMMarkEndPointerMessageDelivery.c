/*
 * XREFs of RIMMarkEndPointerMessageDelivery @ 0x1C00C40FC
 * Callers:
 *     RIMAssessPointerContactState @ 0x1C00C9EAC (RIMAssessPointerContactState.c)
 * Callees:
 *     IsSqmPenDownCountSupported_0 @ 0x1C0002D30 (IsSqmPenDownCountSupported_0.c)
 *     SqmPenDownCount_0 @ 0x1C0002D38 (SqmPenDownCount_0.c)
        ...
        int a7)
{
  ...
  *(_DWORD *)(v12 + *(_QWORD *)(a2 + 680) + 2340) = 0;
