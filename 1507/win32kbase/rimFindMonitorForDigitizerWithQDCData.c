/*
 * XREFs of rimFindMonitorForDigitizerWithQDCData @ 0x1C0019D50
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  do
  {
    v59 = 0LL;
    v60 = 0LL;
    if ( (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, __int64 *))qword_1C01014A8)(
                *(_QWORD *)(v7 + 8) + 20LL + 72LL * v6,
                *(unsigned int *)(*(_QWORD *)(v7 + 8) + 72LL * v6 + 28),
                &Object,
                &v56) >= 0 )
    {
      RIMGetContainerId(v56, &v59, 0LL);
    ...
    do
    {
      v19 = *(unsigned __int16 *)((char *)v18 + v8 + 1144 - (_QWORD)v64);
      v20 = *v18 - v19;
      if ( v20 )
        break;
      ++v18;
    ...
    do
    {
      v22 = *(unsigned __int16 *)((char *)v21 + v8 + 888 - (_QWORD)v64);
      v23 = *v21 - v22;
      if ( v23 )
        break;
      ++v21;
...
LABEL_17:
    ...
    v24 = *(_QWORD *)(v8 + 244) - v59;
    if ( !v24 )
      v24 = *(_QWORD *)(v8 + 252) - v60;
    if ( v24 )
    {
      v15 = v44;
    }
    ...
    {
      v42 = v53 - *(_QWORD *)(v8 + 244);
      if ( v53 == *(_QWORD *)(v8 + 244) )
        v42 = v53 - *(_QWORD *)(v8 + 252);
      v15 = v44;
      if ( v42 )
      {
        v15 = ++v44;
