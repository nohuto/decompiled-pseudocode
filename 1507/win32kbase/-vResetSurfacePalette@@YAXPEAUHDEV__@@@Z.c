/*
 * XREFs of ?vResetSurfacePalette@@YAXPEAUHDEV__@@@Z @ 0x1C005E7C4
 * Callers:
...
void __fastcall vResetSurfacePalette(_QWORD *a1)
{
  ...
  if ( (*((_DWORD *)a1 + 549) & 0x100) != 0 )
  {
    ...
    if ( *(_DWORD *)(v2 + 60) == 20 && (*(_DWORD *)(v2 + 24) & 0x11000) == 0 )
    {
      ...
      while ( 1 )
      {
        v7 = *(_DWORD *)(v4 + *((_QWORD *)v3 + 16));
        HIBYTE(v7) = 48;
        *(_DWORD *)(v4 + *(_QWORD *)(v2 + 128)) = v7;
        v4 += 4LL;
        if ( v4 >= 40 )
          break;
        v2 = v9;
      ...
      {
        v8 = *(_DWORD *)(i + *((_QWORD *)v3 + 16) - 944);
        HIBYTE(v8) = 48;
        *(_DWORD *)(i + *(_QWORD *)(v9 + 128)) = v8;
      }
      v2 = v9;
    }
    if ( (a1[7] & 0x400) == 0 )
    {
      v6 = (void (__fastcall *)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))a1[362];
      if ( v6 )
