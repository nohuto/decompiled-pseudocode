/*
 * XREFs of WinSqmAddToStream @ 0x1C00AE330
 * Callers:
 *     ?W32kCddSqmAddToStream@@YAXKKPEAX@Z @ 0x1C00B5EF0 (-W32kCddSqmAddToStream@@YAXKKPEAX@Z.c)
 * Callees:
