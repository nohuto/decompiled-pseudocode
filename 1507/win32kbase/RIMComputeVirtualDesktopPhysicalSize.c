/*
 * XREFs of RIMComputeVirtualDesktopPhysicalSize @ 0x1C00CDC94
 * Callers:
...
unsigned __int64 __fastcall RIMComputeVirtualDesktopPhysicalSize(_DWORD *a1, _DWORD *a2, __int64 a3)
{
  ...
  {
    DeviceCaps = GreGetDeviceCaps(*(HDC *)(gpDispInfo + 24), 4);
    v8 = gpDispInfo;
    *a1 = (DeviceCaps + 5) / 10;
    v9 = GreGetDeviceCaps(*(HDC *)(v8 + 24), 6) + 5;
...
LABEL_63:
  ...
  if ( (int)GetMonitorPhysicalDimensions(*(_QWORD *)(v12 + 160), &v49, &v36, &v42) < 0 )
  {
    ...
    {
      v14 = GreGetDeviceCaps(*(HDC *)(gpDispInfo + 24), 4);
      v15 = *(HDC *)(gpDispInfo + 24);
      v16 = (v14 + 5) / 10;
      v49 = v16;
...
LABEL_31:
  ...
  if ( *(_DWORD *)(gpDispInfo + 80) == 1 && v12 == *(_QWORD *)(gpDispInfo + 96) )
  {
    ...
    if ( !v49 || (v17 = v36) == 0 )
    {
      v18 = GreGetDeviceCaps(*(HDC *)(gpDispInfo + 24), 4);
      v19 = *(HDC *)(gpDispInfo + 24);
      v16 = (v18 + 5) / 10;
      v49 = v16;
