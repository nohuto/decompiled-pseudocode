/*
 * XREFs of ?GreGetRandomRgnApiExt@@YAHPEAUHDC__@@PEAUHRGN__@@H@Z @ 0x1C00B5C90
 * Callers:
 *     <none>
 * Callees:
 *     IsGreGetRandomRgnSupported_0 @ 0x1C00015A8 (IsGreGetRandomRgnSupported_0.c)
 *     GreGetRandomRgn_0 @ 0x1C00015B0 (GreGetRandomRgn_0.c)
 */
