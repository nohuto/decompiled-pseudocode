/*
 * XREFs of rimConfigurationChange @ 0x1C00C356C
 * Callers:
 *     RIMRevokeConfigurationChange @ 0x1C00C3430 (RIMRevokeConfigurationChange.c)
 *     RIMUnRevokeConfigurationChange @ 0x1C00C3440 (RIMUnRevokeConfigurationChange.c)
 * Callees:
...
__int64 __fastcall rimConfigurationChange(__int64 a1, __int64 a2, int a3)
{
  ...
  v5 = a2;
  v6 = RIMGetDeviceObjectPointer((struct _UNICODE_STRING *)(a1 + 208), a2, 3u, &Handle, &v10, (PDEVICE_OBJECT *)&Object);
  if ( v6 >= 0 )
  {
