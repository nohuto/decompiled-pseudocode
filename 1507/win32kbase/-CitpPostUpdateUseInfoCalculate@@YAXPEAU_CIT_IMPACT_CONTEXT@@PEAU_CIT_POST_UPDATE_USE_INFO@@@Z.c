/*
 * XREFs of ?CitpPostUpdateUseInfoCalculate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_POST_UPDATE_USE_INFO@@@Z @ 0x1C00187A0
 * Callers:
...
void __fastcall CitpPostUpdateUseInfoCalculate(struct _CIT_IMPACT_CONTEXT *a1, struct _CIT_POST_UPDATE_USE_INFO *a2)
{
  ...
  *(_OWORD *)a2 = *(_OWORD *)((char *)a1 + 600);
  *((_OWORD *)a2 + 1) = *(_OWORD *)((char *)a1 + 616);
  *((_OWORD *)a2 + 2) = *(_OWORD *)((char *)a1 + 632);
  *((_OWORD *)a2 + 3) = *(_OWORD *)((char *)a1 + 648);
  *((_OWORD *)a2 + 4) = *(_OWORD *)((char *)a1 + 664);
  v4 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  v5 = MEMORY[0xFFFFF780000003B0];
  v6 = MEMORY[0xFFFFF78000000008];
  CIT_USER_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 496), v4);
  v7 = *((_QWORD *)a1 + 64);
  CIT_USER_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 520), v4);
  CIT_DESKTOP_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 544), v4);
  v9 = *(_DWORD *)(v8 + 12);
  v10 = -1;
  ...
  *((_DWORD *)a2 + 9) += ((int)v4 - dword_1C0102028) / 0x3E8u;
  if ( (v6 - qword_1C0102018 - v5) / 0x2710uLL <= 0xFFFFFFFF )
    v10 = (v6 - qword_1C0102018 - v5) / 0x2710uLL;
  *((_DWORD *)a2 + 10) += v10 / 0x3E8;
  *((_DWORD *)a2 + 11) += *((unsigned __int16 *)a1 + 290);
  *((_DWORD *)a2 + 12) += *((unsigned __int16 *)a1 + 292);
  *((_DWORD *)a2 + 13) += *((unsigned __int16 *)a1 + 291);
  *((_DWORD *)a2 + 14) += *((unsigned __int16 *)a1 + 294);
  *((_DWORD *)a2 + 15) += *((_DWORD *)a1 + 149) / 0x3E8u;
