/*
 * XREFs of ?EnumerateObjects@CLinearHandleTableBase@DirectComposition@@QEAAPEAXPEA_K@Z @ 0x1C0031388
 * Callers:
...
void *__fastcall DirectComposition::CLinearHandleTableBase::EnumerateObjects(
