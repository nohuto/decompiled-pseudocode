/*
 * XREFs of ?createrec@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@PEAU_POINTFIX@@@Z @ 0x1C0025C98
 * Callers:
 ...
 *     ?vInclude@ERECTFX@@QEAAXAEAU_POINTFIX@@@Z @ 0x1C0026204 (-vInclude@ERECTFX@@QEAAXAEAU_POINTFIX@@@Z.c)
 ...
 *     ?reinit@EPATHOBJ@@IEAAXXZ @ 0x1C00B0180 (-reinit@EPATHOBJ@@IEAAXXZ.c)
 *     ?vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z @ 0x1C00B020C (-vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z.c)
 */
        ...
        struct _POINTFIX *a4)
{
  ...
  *(_QWORD *)(v19 + 8) = *(_QWORD *)(*((_QWORD *)this + 1) + 40LL);
  ...
  {
    EXFORMOBJ::bXformRound(v6, (struct _POINTL *)v22, (struct _POINTFIX *)(v19 + 8 * (v13 + 3LL)), (unsigned int)v10);
  }
  else
  {
    memmove((void *)(v19 + 8 * (v13 + 3LL)), v22, 8LL * (unsigned int)v10);
  }
  *((_DWORD *)a3 + 1) -= v10;
  *((_QWORD *)a3 + 1) += 8LL * (unsigned int)v10;
  *(_DWORD *)a3 &= 0xFFFFFFFA;
  v23 = (struct _POINTFIX *)(v19 + 24);
  v24 = *((_QWORD *)this + 1);
  if ( !*(_QWORD *)(v24 + 40) )
  {
    *(_DWORD *)(v24 + 56) = v23->x;
