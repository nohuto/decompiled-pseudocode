/*
 * XREFs of DrvSetPruneFlag @ 0x1C00BC528
 * Callers:
...
__int64 __fastcall DrvSetPruneFlag(UNICODE_STRING *a1, unsigned __int8 a2, int a3)
{
  ...
  if ( DrvIsPermanentSettingChangesDisabled() )
    return 4294967293LL;
  Data = a2;
  RegistryHandleFromDeviceMap = DrvGetRegistryHandleFromDeviceMap(v6, 0LL, 0LL, 0LL, 0, 0LL, gProtocolType);
  ...
  if ( (*((_DWORD *)v6 + 40) & 0x800000) != 0
    && (LOBYTE(v10) = a2 == 0, (int)((__int64 (__fastcall *)(__int64))qword_1C01013C0)(v10) < 0) )
  {
    return 0xFFFFFFFFLL;
  }
  else
