/*
 * XREFs of ?FindAnimationBindings@CResourceMarshaler@DirectComposition@@QEAAXIPEAPEAVCAnimationBinding@2@00@Z @ 0x1C002B86C
 * Callers:
 *     ?HasAnimations@CResourceMarshaler@DirectComposition@@QEAA_NI@Z @ 0x1C002B8CC (-HasAnimations@CResourceMarshaler@DirectComposition@@QEAA_NI@Z.c)
