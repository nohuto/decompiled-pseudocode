/*
 * XREFs of AllocQueue @ 0x1C004CEE0
 * Callers:
 *     xxxCreateThreadInfo @ 0x1C004D110 (xxxCreateThreadInfo.c)
 * Callees:
 *     IsIsKeyStateCachedSupported_0 @ 0x1C0001D70 (IsIsKeyStateCachedSupported_0.c)
 *     IsKeyStateCached_0 @ 0x1C0001D78 (IsKeyStateCached_0.c)
...
__int64 __fastcall AllocQueue(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(v3 + 360) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  ...
  {
    if ( *((_QWORD *)gptiCurrent + 52) != grpdeskRitInput )
    {
      do
      {
    ...
    *(_OWORD *)(v3 + 200) = xmmword_1C01067D0;
    *(_OWORD *)(v3 + 216) = xmmword_1C01067E0;
    v9 = xmmword_1C01067F0;
  }
  *(_OWORD *)(v3 + 232) = v9;
LABEL_9:
  if ( (gdwGTERMFlags & 1) == 0 )
    --*(_DWORD *)(v3 + 328);
  HMAssignmentLock(v3 + 320, qword_1C00FF248);
  return v3;
}
