/*
 * XREFs of ?EmitUpdatePlaybackState@CKeyframeAnimationMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00D69C4
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x800) == 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v6) )
    {
      ...
      *((_QWORD *)v4 + 2) = *((_QWORD *)this + 19);
      *((_DWORD *)v4 + 6) = (*((_BYTE *)this + 168) & 1) == 0;
