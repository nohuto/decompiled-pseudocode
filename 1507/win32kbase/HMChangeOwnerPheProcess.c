/*
 * XREFs of HMChangeOwnerPheProcess @ 0x1C0069DC0
 * Callers:
...
__int64 __fastcall HMChangeOwnerPheProcess(__int64 *a1, __int64 a2)
{
  ...
  v4 = *a1;
  --*(_DWORD *)(v2 + 68);
  if ( *((_BYTE *)a1 + 16) == 3 && (*(_DWORD *)(v4 + 80) & 8) == 0 && v2 != *(_QWORD *)(a2 + 384) )
  {
    if ( *(_QWORD *)(v4 + 88) )
    {
      GreDecQuotaCount(v2);
      GreIncQuotaCount(*(_QWORD *)(a2 + 384));
    }
    if ( *(_QWORD *)(v4 + 96) )
    {
      GreDecQuotaCount(v2);
  ...
  *(_DWORD *)(v4 + 16) = 0;
  if ( (*((_BYTE *)&unk_1C00E9F6C + 16 * *((unsigned __int8 *)a1 + 16)) & 4) != 0 )
    *(_QWORD *)(v4 + 24) = *(_QWORD *)(a2 + 384);
