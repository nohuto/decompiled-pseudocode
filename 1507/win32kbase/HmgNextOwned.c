/*
 * XREFs of HmgNextOwned @ 0x1C005C050
 * Callers:
...
LABEL_9:
  ...
  {
    a1 = 3 * v7;
    v8 = *(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement + 24 * v7 + 8;
    while ( 1 )
    {
      if ( *(_BYTE *)(v8 + 6) )
      {
