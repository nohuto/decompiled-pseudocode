/*
 * XREFs of Template_qpqxxq @ 0x1C00A9E3C
 * Callers:
 *     EtwTraceDCompDeferBatchEvent @ 0x1C0019270 (EtwTraceDCompDeferBatchEvent.c)
 *     NtDCompositionBeginFrame @ 0x1C0045E30 (NtDCompositionBeginFrame.c)
 *     ?ShouldDefer@CBatch@DirectComposition@@QEAA_N_JPEAVCEvent@2@@Z @ 0x1C00A3C88 (-ShouldDefer@CBatch@DirectComposition@@QEAA_N_JPEAVCEvent@2@@Z.c)
 * Callees:
