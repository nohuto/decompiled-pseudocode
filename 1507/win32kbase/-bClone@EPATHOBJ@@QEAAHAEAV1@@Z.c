/*
 * XREFs of ?bClone@EPATHOBJ@@QEAAHAEAV1@@Z @ 0x1C00AFF60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EPATHOBJ::bClone(EPATHOBJ *this, struct EPATHOBJ *a2)
{
  ...
  *(_DWORD *)(*((_QWORD *)this + 1) + 72LL) = *(_DWORD *)(*((_QWORD *)a2 + 1) + 72LL);
...
LABEL_16:
  ...
  while ( (unsigned int)EPATHOBJ::newpathrec(this, &v13, &v12, v5) )
  {
    ...
    *(_QWORD *)(*((_QWORD *)this + 1) + 40LL) = v8;
    ...
    v5 -= v10;
    v6 += 8 * v10;
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 24LL) + 8LL) = (char *)v8 + 8 * v10 + 24;
    if ( !v5 )
      goto LABEL_16;
  }
  return 0LL;
