/*
 * XREFs of ?DrvProbeAndCaptureDevmode@@YAJPEAUtagGRAPHICS_DEVICE@@PEAPEAU_devicemodeW@@PEAH2PEAU2@HHHHH3@Z @ 0x1C005F214
 * Callers:
 ...
 *     ?AreEquivalentDevModes@@YAHQEBU_devicemodeW@@0@Z @ 0x1C0060D98 (-AreEquivalentDevModes@@YAHQEBU_devicemodeW@@0@Z.c)
 *     ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x1C006D910 (-GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z.c)
    ...
    else
    {
      ...
      *(_QWORD *)&v88->dmReserved2 = *(_QWORD *)&v17->dmReserved2;
      ...
      else if ( v14->dmPelsWidth || v14->dmPelsHeight )
      {
        ...
        {
          v68 = WdLogNewEntry5_WdWarning(&v17->dmFormName[13]);
...
LABEL_65:
        ...
        if ( !v17->dmBitsPerPel && !v17->dmPelsWidth && !v17->dmPelsHeight && !v17->dmDisplayOrientation )
        {
          ...
          else
          {
            ...
            {
              v17->dmPelsWidth = dword_1C00EE500[2 * !v69];
              v17->dmPelsHeight = dword_1C00EE500[2 * !v69 + 1];
            }
          }
          goto LABEL_70;
        }
...
LABEL_89:
          ...
          || !v17->dmDisplayFrequency )
        {
          if ( v87 )
          {
            ...
            v46 = 0;
            v66 = v65;
            if ( v65 || (v74 = GetClosestMode(v29, v17, a7, 0), v46 = 0, (v66 = v74) != 0LL) )
            {
...
LABEL_121:
            ...
            if ( (*((_DWORD *)v29 + 40) & 0x800000) != 0 && v59 + v41->dmSize == 244 )
              ((void (__fastcall *)(struct _devicemodeW *, struct _devicemodeW *))qword_1C0101348)(v41, v41);
            if ( v90 )
            {
