/*
 * XREFs of RIMConfigurePointerDevice @ 0x1C00817D0
 * Callers:
...
__int64 __fastcall RIMConfigurePointerDevice(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned int)RIMFindConfigDeviceForInput(a1, a3, a2, &Object)
    && (v7 = Object,
        v8 = 2,
        (int)RIMGetDeviceObjectPointer((struct _UNICODE_STRING *)Object + 13, v5, 2u, &Handle, &Object, &v14) >= 0) )
  {
    if ( *(_WORD *)(a3 + 40) == 4 )
    {
      *((_DWORD *)v7 + 46) |= 0x200u;
