/*
 * XREFs of ?CheckBinding@CCompositionSurface@@QEBA_N_KPEAW4CompositionBufferType@@PEAPEAUHWND__@@@Z @ 0x1C0048F1C
 * Callers:
        ...
        HWND *a4)
{
  ...
  *a4 = 0LL;
  ...
  v9 = ActiveBuffer;
  if ( ActiveBuffer && *((_QWORD *)ActiveBuffer + 1) == v7 )
  {
    *(_DWORD *)a3 = (*(__int64 (__fastcall **)(struct CCompositionBuffer *))(*(_QWORD *)ActiveBuffer + 8LL))(ActiveBuffer);
    *a4 = (HWND)(*(__int64 (__fastcall **)(struct CCompositionBuffer *))(*(_QWORD *)v9 + 16LL))(v9);
    return 1;
  }
  return v8;
}
