/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00DDFF0
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C00DE180 (CreateSharedReadScalarMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadScalarMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(_QWORD *, const struct DirectComposition::CSharedSystemResource *))(*((_QWORD *)v5 + 2) + 208LL))(
           (_QWORD *)v5 + 2,
           a1);
    if ( v6 < 0 )
    {
