/*
 * XREFs of ?Create@CSharedMatrixTransform3DMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00DDC3C
 * Callers:
 *     CreateSharedMatrixTransform3DMarshaler @ 0x1C00DDD50 (CreateSharedMatrixTransform3DMarshaler.c)
 * Callees:
