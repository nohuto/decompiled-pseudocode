/*
 * XREFs of ?EmitBeginInteractionCommands@CTelemetryInfo@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0030E88
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  *((_QWORD *)v5 + 1) = this;
  if ( *((DirectComposition::CTelemetryInfo **)v8 + 1) != this )
    __fastfail(3u);
  *((_QWORD *)v8 + 1) = v5;
  *(_QWORD *)this = v5;
  if ( v5 == this )
