/*
 * XREFs of ?MulEnableDriver@@YAHKKPEAUtagDRVENABLEDATA@@@Z @ 0x1C00B4B30
 * Callers:
 *     <none>
 * Callees:
 *     IsMulGetAdditionalFunctionTableSupported_0 @ 0x1C00013F8 (IsMulGetAdditionalFunctionTableSupported_0.c)
 *     MulGetAdditionalFunctionTable_0 @ 0x1C0001400 (MulGetAdditionalFunctionTable_0.c)
 */
  ...
  if ( RtlRunOnceBeginInitialize(&gMulEnableDriverInit, 0, 0LL) == 259 )
  {
    if ( (int)IsMulGetAdditionalFunctionTableSupported_0() >= 0 )
    {
      ...
      if ( v7 )
      {
        ...
        do
        {
          *(_OWORD *)((char *)v4 + &unk_1C00FF4E0 - (_UNKNOWN *)v8) = *v4;
          ++v4;
          --v5;
        }
        while ( v5 );
