/*
 * XREFs of ?UserGetRedirectedWindowOriginApiExt@@YAHQEAUHDC__@@PEAUtagPOINT@@@Z @ 0x1C00B5E30
 * Callers:
 *     <none>
 * Callees:
 *     IsUserGetRedirectedWindowOriginSupported_0 @ 0x1C00015C8 (IsUserGetRedirectedWindowOriginSupported_0.c)
