/*
 * XREFs of WmsgpPostMessage @ 0x1C0125074
 * Callers:
 *     PostWinlogonMessage @ 0x1C0019A20 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C0019A84 (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C0019AC0 (WMsg_midl_user_allocate.c)
 *     WMsg_midl_user_free @ 0x1C00D31A0 (WMsg_midl_user_free.c)
 */
