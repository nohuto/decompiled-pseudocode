/*
 * XREFs of ?ValidateRange@CIT_DATA_READER@@QEAA_NIII@Z @ 0x1C00E49AC
 * Callers:
 ...
 *     ??$ValidateRange@$$CBU_CIT_PERSISTED_BITMAP@@@CIT_DATA_READER@@QEAA_NPEAPEBU_CIT_PERSISTED_BITMAP@@IIIIPEAI@Z @ 0x1C00E277C (--$ValidateRange@$$CBU_CIT_PERSISTED_BITMAP@@@CIT_DATA_READER@@QEAA_NPEAPEBU_CIT_PERSISTED_BITMA.c)
 ...
 *     ?ValidateString@CIT_DATA_READER@@QEAA_NPEAPEBGII@Z @ 0x1C00E49D8 (-ValidateString@CIT_DATA_READER@@QEAA_NPEAPEBGII@Z.c)
 * Callees:
 *     <none>
 */
