/*
 * XREFs of ?GetInformation@COPMProtectedOutput@@QEAAJQEAU_DXGKMDT_OPM_GET_INFO_PARAMETERS@@PEAU_DXGKMDT_OPM_REQUESTED_INFORMATION@@@Z @ 0x1C0067E88
 * Callers:
        ...
        PRKMUTEX *a3)
{
  ...
  else
  {
    ...
    InputBuffer[1] = &unk_1C01020E0;
    v5 = CallMonitor(v4, 0x232497u, InputBuffer, 0x10u, &unk_1C01030F0, 0x1000u);
  }
