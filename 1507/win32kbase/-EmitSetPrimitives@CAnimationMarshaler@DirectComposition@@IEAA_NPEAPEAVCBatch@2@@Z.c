/*
 * XREFs of ?EmitSetPrimitives@CAnimationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C002C198
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  v3 = 1;
  if ( (*((_DWORD *)this + 8) & 0x80u) == 0 && *((_QWORD *)this + 11) && *((_QWORD *)this + 13) )
  {
