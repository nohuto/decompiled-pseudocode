/*
 * XREFs of ?SetDPIinSetup@@YAJXZ @ 0x1C0085664
 * Callers:
 *     ?UserInitialize@@YAJXZ @ 0x1C007C5BC (-UserInitialize@@YAJXZ.c)
 * Callees:
 *     IsGetDpiSettingSupported_0 @ 0x1C0002948 (IsGetDpiSettingSupported_0.c)
 *     GetDpiSetting_0 @ 0x1C0002950 (GetDpiSetting_0.c)
 *     IsSetDpiSettingSupported_0 @ 0x1C0002958 (IsSetDpiSettingSupported_0.c)
 *     SetDpiSetting_0 @ 0x1C0002960 (SetDpiSetting_0.c)
 *     IsSetDpiScalingSettingSupported_0 @ 0x1C0002968 (IsSetDpiScalingSettingSupported_0.c)
 *     SetDpiScalingSetting_0 @ 0x1C0002970 (SetDpiScalingSetting_0.c)
 ...
 *     GreReinitializeStockFonts @ 0x1C00BCDB0 (GreReinitializeStockFonts.c)
 */
