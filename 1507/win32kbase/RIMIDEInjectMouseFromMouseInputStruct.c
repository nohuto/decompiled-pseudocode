/*
 * XREFs of RIMIDEInjectMouseFromMouseInputStruct @ 0x1C00C652C
 * Callers:
 ...
 *     RIMIDEBuildButtonFlagsFromRawButtonsAndMouseInputStruct @ 0x1C00C4BF4 (RIMIDEBuildButtonFlagsFromRawButtonsAndMouseInputStruct.c)
 *     RIMIDEBuildRawButtonsFromMouseInputStruct @ 0x1C00C4C90 (RIMIDEBuildRawButtonsFromMouseInputStruct.c)
 *     RIMIDEInjectMouseInput @ 0x1C00C6758 (RIMIDEInjectMouseInput.c)
 *     RIMIDEValidateMouseInputStruct @ 0x1C00C6DBC (RIMIDEValidateMouseInputStruct.c)
 */
