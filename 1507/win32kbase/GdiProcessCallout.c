/*
 * XREFs of GdiProcessCallout @ 0x1C005B5D0
 * Callers:
 *     <none>
 * Callees:
 *     IsMonitorAPIProcessTerminatingSupported_0 @ 0x1C0001898 (IsMonitorAPIProcessTerminatingSupported_0.c)
 *     MonitorAPIProcessTerminating_0 @ 0x1C00018A0 (MonitorAPIProcessTerminating_0.c)
    ...
    *(_QWORD *)(a1 + 208) = a1 + 208;
    ...
    if ( ProcessPeb
      && (*(_DWORD *)(ProcessPeb + 264) = 20,
          ...
          LOBYTE(v16) = a2,
          (int)((__int64 (__fastcall *)(__int64, void *, __int64))qword_1C01010A0)(
                 a1 + 248,
                 ...
                 v16) >= 0) )
    {
      ...
      if ( v17 < 0 )
        ((void (__fastcall *)(__int64, void *, _QWORD))qword_1C01010A0)(a1 + 248, &gDxgkWin32kEngInterface, 0LL);
