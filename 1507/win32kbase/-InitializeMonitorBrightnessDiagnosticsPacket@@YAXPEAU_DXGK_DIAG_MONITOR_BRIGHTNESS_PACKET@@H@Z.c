/*
 * XREFs of ?InitializeMonitorBrightnessDiagnosticsPacket@@YAXPEAU_DXGK_DIAG_MONITOR_BRIGHTNESS_PACKET@@H@Z @ 0x1C008441C
 * Callers:
...
void __fastcall InitializeMonitorBrightnessDiagnosticsPacket(struct _DXGK_DIAG_MONITOR_BRIGHTNESS_PACKET *a1, int a2)
{
  ...
  *((_DWORD *)a1 + 14) = dword_1C00FFFA8;
  *((_DWORD *)a1 + 15) = dword_1C00FFF94;
  *((_DWORD *)a1 + 16) = dword_1C00FFF9C;
  *((_DWORD *)a1 + 17) = a2;
}
