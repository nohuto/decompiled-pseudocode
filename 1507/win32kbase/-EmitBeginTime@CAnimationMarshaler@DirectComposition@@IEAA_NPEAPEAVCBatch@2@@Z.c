/*
 * XREFs of ?EmitBeginTime@CAnimationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C002C22C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( !*((_QWORD *)this + 13) || !*((_QWORD *)this + 14) || (*((_DWORD *)this + 8) & 0x100) != 0 )
    return 1;
