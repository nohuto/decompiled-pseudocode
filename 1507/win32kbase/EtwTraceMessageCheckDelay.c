/*
 * XREFs of EtwTraceMessageCheckDelay @ 0x1C0050760
 * Callers:
 ...
 *     ?EtwpGetClassName@@YAJQEAUtagWND@@PEAU_UNICODE_STRING@@@Z @ 0x1C00A6E64 (-EtwpGetClassName@@YAJQEAUtagWND@@PEAU_UNICODE_STRING@@@Z.c)
...
void __fastcall EtwTraceMessageCheckDelay(struct tagTHREADINFO *a1)
{
  ...
  if ( ((unsigned __int64)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine & 0x8001000000040000uLL) != 0
    && (unsigned __int8)(byte_1C00FEA58 - 1) > 2u
    && (qword_1C00FEA40 & 0x8001000000040000uLL) != 0
    && (qword_1C00FEA48 & 0x8001000000040000uLL) == qword_1C00FEA48 )
  {
    ...
    if ( v3 )
    {
      ...
      if ( (int)v2 - v3 >= W32kEtwMessageCheckDelayTimeoutMs )
      {
          ...
          && ((ThreadInfoFlags & 0x200) == 0 || v4 >= gdwHungAppTimeout) )
        {
          ...
          v9 = 0LL;
          v29 = 0LL;
          v10 = (struct tagWND *)ValidateHwndEx(*((void **)a1 + 129), 1LL, 0);
          v25 = v10;
          if ( v10 )
          {
          ...
          EtwpGetLastInputProcessTime(*((struct tagQ *const *)a1 + 49), v2, &v23, &v24);
          v12 = *((_DWORD *)a1 + 260);
          LODWORD(v25) = v12;
          v32 = *((_QWORD *)a1 + 131);
          v33 = v32;
          ...
          else
          {
            ...
            if ( v22 >= (unsigned __int64)W32UserProbeAddress
              || (unsigned __int16)v20 > HIWORD(v27)
              || (v20 & 1) != 0
              || v22 <= v21 )
            {
            ...
            if ( &v36 )
              v7 = v37;
            if ( (Microsoft_Windows_Win32kEnableBits & 0x100) != 0 )
              Template_qqqqzzzqx(v20, v22, v32, v6, v4, v23, v24, (__int64)Buffer, (__int64)v9, v7, v12, v32);
          }
          if ( Buffer )
