/*
 * XREFs of ?SetFullRegion@CRegion@@QEAAXXZ @ 0x1C004A794
 * Callers:
 ...
 *     ?NotifyOfDwmTermination@CCompositionBuffer@@UEAAXXZ @ 0x1C00DF8D0 (-NotifyOfDwmTermination@CCompositionBuffer@@UEAAXXZ.c)
