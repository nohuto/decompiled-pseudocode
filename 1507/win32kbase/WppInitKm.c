/*
 * XREFs of WppInitKm @ 0x1C0125310
 * Callers:
...
void __fastcall WppInitKm(__int64 a1, __int64 a2)
{
  ...
  void (__fastcall *v5)(struct _DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, PVPB *); // rax
  ...
  if ( WPP_GLOBAL_Control != &WPP_MAIN_CB )
  {
    ...
    if ( WPPTraceSuite == 4 )
    {
      do
      {
        v5 = (void (__fastcall *)(struct _DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, PVPB *))pfnEtwRegisterClassicProvider;
        v2->Vpb = 0LL;
