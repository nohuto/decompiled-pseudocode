/*
 * XREFs of RIMSetContactBoundary @ 0x1C00CE2A4
 * Callers:
 ...
 * Callees:
 *     IsApplyMagInputTransformSupported_0 @ 0x1C0002EA8 (IsApplyMagInputTransformSupported_0.c)
 *     ApplyMagInputTransform_0 @ 0x1C0002EB0 (ApplyMagInputTransform_0.c)
