/*
 * XREFs of GreCreateBitmap @ 0x1C0044870
 * Callers:
 *     bInitBMOBJ @ 0x1C0137ECC (bInitBMOBJ.c)
 *     bInitBRUSHOBJ @ 0x1C0138530 (bInitBRUSHOBJ.c)
 * Callees:
 *     IsGreSetBitmapBitsSupported_0 @ 0x1C0001918 (IsGreSetBitmapBitsSupported_0.c)
 *     GreSetBitmapBits_0 @ 0x1C0001920 (GreSetBitmapBits_0.c)
  ...
  else
  {
    ...
    if ( v10 )
    {
      *(_DWORD *)(v10 + 112) |= 0x4000000u;
      ...
      v11 |= 1u;
      GreSetBitmapOwnerEx(*(_QWORD *)(v8 + 32), -2147483646);
      v5 = *(_QWORD *)(v8 + 32);
    }
