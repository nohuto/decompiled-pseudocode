/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x1C0060834
 * Callers:
 *     DrvUpdateDisplayDriverParameters @ 0x1C0060740 (DrvUpdateDisplayDriverParameters.c)
 * Callees:
 *     ?DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z @ 0x1C0060CE0 (-DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z.c)
    ...
    if ( a4 )
    {
      ...
      if ( v10 >= 0 )
      {
        do
        {
          if ( v16 >= v19 )
            break;
          v17 = RtlWriteRegistryValue(0x40000000u, a3, off_1C00E9EF0[v16], 4u, &v23[v16], 4u);
          ++v16;
          v10 = v17;
        }
        while ( v17 >= 0 );
