/*
 * XREFs of GrePtInRegion @ 0x1C000FB90
 * Callers:
 *     NtGdiPtInRegion @ 0x1C000FB80 (NtGdiPtInRegion.c)
 * Callees:
 *     EngSetLastError @ 0x1C0013020 (EngSetLastError.c)
 *     ?bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z @ 0x1C003FA00 (-bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z.c)
