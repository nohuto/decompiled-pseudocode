/*
 * XREFs of ?EmitRectangle@CRectangleClipMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0026DC0
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  *v4 = 92;
  ...
  v4[8] = *((_DWORD *)this + 18);
  v4[9] = *((_DWORD *)this + 19);
  v4[10] = *((_DWORD *)this + 20);
  v4[11] = *((_DWORD *)this + 21);
  v4[12] = *((_DWORD *)this + 22);
  v4[13] = *((_DWORD *)this + 23);
  v4[14] = *((unsigned __int8 *)this + 96);
  return 1;
}
