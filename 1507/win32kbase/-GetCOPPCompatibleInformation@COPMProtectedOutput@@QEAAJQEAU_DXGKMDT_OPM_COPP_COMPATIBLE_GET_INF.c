/*
 * XREFs of ?GetCOPPCompatibleInformation@COPMProtectedOutput@@QEAAJQEAU_DXGKMDT_OPM_COPP_COMPATIBLE_GET_INFO_PARAMETERS@@PEAU_DXGKMDT_OPM_REQUESTED_INFORMATION@@@Z @ 0x1C00C029C
 * Callers:
        ...
        PRKMUTEX *a3)
{
  ...
  else
  {
    ...
    InputBuffer[1] = &unk_1C0106C00;
    v4 = CallMonitor(v5, 0x23249Bu, InputBuffer, 0x10u, &unk_1C0107C00, 0x1000u);
  }
