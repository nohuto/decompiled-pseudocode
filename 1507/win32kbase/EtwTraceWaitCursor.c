/*
 * XREFs of EtwTraceWaitCursor @ 0x1C0013CF0
 * Callers:
 *     <none>
 * Callees:
 *     ?EtwpGetWaitCursorType@@YAKQEAUtagCURSOR@@@Z @ 0x1C00A6FAC (-EtwpGetWaitCursorType@@YAKQEAUtagCURSOR@@@Z.c)
...
void EtwTraceWaitCursor()
{
    ...
    && (qword_1C00FEA48 & 0x8000000000040000uLL) == qword_1C00FEA48 )
  {
    ...
    if ( gpqCursor )
    {
      ...
      W32kEtwWaitCursorProcessId = *(_DWORD *)(*(_QWORD *)(v5 + 384) + 56LL);
    }
    else
    {
