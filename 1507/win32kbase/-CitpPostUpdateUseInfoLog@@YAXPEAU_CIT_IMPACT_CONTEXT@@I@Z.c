/*
 * XREFs of ?CitpPostUpdateUseInfoLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x1C0017F7C
 * Callers:
...
void __fastcall CitpPostUpdateUseInfoLog(struct _CIT_IMPACT_CONTEXT *a1, int a2)
{
  ...
  if ( *((_WORD *)a1 + 304) )
  {
    CitpStatIncrement((unsigned __int16 *)a1 + 305, 1u);
    ...
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
    {
      ...
      v124 = 4LL;
      v126 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00EB34C, 0LL, v3, 0x29u, &pData);
    }
    CitpPostUpdateUseInfoSave(a1, &Data_8);
    v23 = v44;
    *(_OWORD *)((char *)a1 + 680) = Data_8;
    v24 = v45;
    *(_OWORD *)((char *)a1 + 696) = v23;
    v25 = v46;
    *(_OWORD *)((char *)a1 + 712) = v24;
    v26 = v47;
    *(_OWORD *)((char *)a1 + 728) = v25;
    *(_OWORD *)((char *)a1 + 744) = v26;
  }
}
