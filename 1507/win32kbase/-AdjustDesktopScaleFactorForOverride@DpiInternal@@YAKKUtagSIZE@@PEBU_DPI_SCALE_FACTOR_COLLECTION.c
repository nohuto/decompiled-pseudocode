/*
 * XREFs of ?AdjustDesktopScaleFactorForOverride@DpiInternal@@YAKKUtagSIZE@@PEBU_DPI_SCALE_FACTOR_COLLECTION@@H@Z @ 0x1C00B7B28
 * Callers:
        ...
        const struct _DPI_SCALE_FACTOR_COLLECTION *a4)
{
  ...
  return DpiInternal::SatisfyMinResolutionBarForScaleIdx((DpiInternal *)v9, v4, a2, a3, v12);
}
