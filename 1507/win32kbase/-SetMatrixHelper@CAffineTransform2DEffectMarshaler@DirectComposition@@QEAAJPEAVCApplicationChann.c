/*
 * XREFs of ?SetMatrixHelper@CAffineTransform2DEffectMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBUD2D_MATRIX_3X2_F@@PEA_N@Z @ 0x1C00DD700
 * Callers:
...
__int64 __fastcall DirectComposition::CAffineTransform2DEffectMarshaler::SetMatrixHelper(
        ...
        bool *a4)
{
  ...
  v5 = *a4;
  v6 = *((_QWORD *)this + 13) - *(_QWORD *)a3;
  if ( !v6 )
  {
    v6 = *((_QWORD *)this + 14) - *((_QWORD *)a3 + 1);
    if ( !v6 )
      v6 = *((_QWORD *)this + 15) - *((_QWORD *)a3 + 2);
  }
  if ( v6 )
  {
    v5 = 1;
