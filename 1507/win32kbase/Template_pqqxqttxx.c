/*
 * XREFs of Template_pqqxqttxx @ 0x1C00A9AD0
 * Callers:
 *     ?TraceStateChanged@CFlipToken@@AEBAXXZ @ 0x1C0047B34 (-TraceStateChanged@CFlipToken@@AEBAXXZ.c)
 *     EtwTraceTokenStateChangedEvent @ 0x1C00A7E80 (EtwTraceTokenStateChangedEvent.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0085840 (__security_check_cookie.c)
 */

NTSTATUS Template_pqqxqttxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 8LL;
  v20 = 8LL;
  return EtwWrite(Microsoft_Windows_Win32kHandle, &TokenStateChangedEvent, &W32kControlGuid, 9u, &UserData);
}
