/*
 * XREFs of ?FindRealization@CCompositionBuffer@@QEBAJAEBUCSM_REALIZATION_INFO@@PEAPEAVCBufferRealization@@@Z @ 0x1C004A220
 * Callers:
 ...
 *     ?RemoveRealization@CCompositionBuffer@@MEAAJAEBUCSM_REALIZATION_INFO@@PEAPEAVCBufferRealization@@@Z @ 0x1C00DF920 (-RemoveRealization@CCompositionBuffer@@MEAAJAEBUCSM_REALIZATION_INFO@@PEAPEAVCBufferRealization@.c)
 * Callees:
 *     <none>
 */
        ...
        struct CBufferRealization **a3)
{
  ...
  *a3 = 0LL;
  v3 = -1073741275;
  if ( !*((_DWORD *)this + 70)
    || (v4 = (CCompositionBuffer *)*((_QWORD *)this + 33), v4 == (CCompositionBuffer *)((char *)this + 264)) )
  {
LABEL_15:
    *a3 = 0LL;
    return v3;
...
LABEL_14:
    ...
    if ( v4 == (CCompositionBuffer *)((char *)this + 264) )
      goto LABEL_15;
  }
  if ( v5 != 3 )
    goto LABEL_14;
