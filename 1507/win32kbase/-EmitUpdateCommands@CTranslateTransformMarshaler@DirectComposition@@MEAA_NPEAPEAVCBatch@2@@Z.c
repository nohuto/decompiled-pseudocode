/*
 * XREFs of ?EmitUpdateCommands@CTranslateTransformMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C002AF60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  *((_DWORD *)v3 + 2) = *((_DWORD *)this + 6);
  result = 1;
  *(double *)(v3 + 12) = *((float *)this + 10);
  *(double *)(v3 + 20) = *((float *)this + 11);
  return result;
}
