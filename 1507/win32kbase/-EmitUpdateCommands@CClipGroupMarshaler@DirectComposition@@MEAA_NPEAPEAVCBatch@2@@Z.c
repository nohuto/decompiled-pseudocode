/*
 * XREFs of ?EmitUpdateCommands@CClipGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00D8E40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 15) < *((_DWORD *)this + 14); *((_DWORD *)this + 15) += v5 )
  {
    ...
    if ( v4 < 0x18 )
    {
      if ( !DirectComposition::CBatch::AllocateNewFragment(a2, &v12) )
        return *((_DWORD *)this + 15) == *((_DWORD *)this + 14);
      v4 = v12;
    }
    v5 = (v4 - 20) >> 2;
    if ( (unsigned int)(*((_DWORD *)this + 14) - *((_DWORD *)this + 15)) < v5 )
      LODWORD(v5) = *((_DWORD *)this + 14) - *((_DWORD *)this + 15);
    ...
    *((_DWORD *)v6 + 4) = *((_DWORD *)this + 15) != 0;
    ...
    if ( (_DWORD)v5 )
    {
      ...
      {
        v10 = v8++;
        *v7++ = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 6) + 8 * v10) + 24LL);
        --v9;
      }
      while ( v9 );
    }
