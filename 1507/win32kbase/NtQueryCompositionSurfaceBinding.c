/*
 * XREFs of NtQueryCompositionSurfaceBinding @ 0x1C00113C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtQueryCompositionSurfaceBinding(CInputSink *a1, unsigned __int64 *a2, _OWORD *a3)
{
  _OWORD *v3; // rdi
  ...
  unsigned __int64 v14; // [rsp+38h] [rbp-400h]
