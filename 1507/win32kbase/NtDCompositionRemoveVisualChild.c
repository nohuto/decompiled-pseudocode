/*
 * XREFs of NtDCompositionRemoveVisualChild @ 0x1C00111D0
 * Callers:
 *     NtDCompositionRemoveCrossDeviceVisualChild @ 0x1C0014720 (NtDCompositionRemoveCrossDeviceVisualChild.c)
 * Callees:
...
__int64 __fastcall NtDCompositionRemoveVisualChild(unsigned int a1, unsigned int a2, unsigned int a3)
{
  int v5; // edi
  unsigned int v6; // r8d
