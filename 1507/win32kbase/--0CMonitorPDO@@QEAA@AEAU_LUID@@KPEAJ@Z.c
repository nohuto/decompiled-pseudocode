/*
 * XREFs of ??0CMonitorPDO@@QEAA@AEAU_LUID@@KPEAJ@Z @ 0x1C00684A0
 * Callers:
 ...
 *     ??0CMutex@@QEAA@PEAJ@Z @ 0x1C0069ED0 (--0CMutex@@QEAA@PEAJ@Z.c)
...
CMonitorPDO *__fastcall CMonitorPDO::CMonitorPDO(CMonitorPDO *this, struct _LUID *a2, unsigned int a3, int *a4)
{
  ...
  *((_QWORD *)this + 1) = v4;
  ...
  DeviceInterfaces = ((__int64 (__fastcall *)(struct _LUID *, _QWORD, PVOID *, PVOID *))qword_1C01014A8)(
                       a2,
                       v17,
                       &EventCategoryData,
                       v5);
