/*
 * XREFs of ?EmitAddTimeEvents@CAnimationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C002BE6C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 63) < *((_DWORD *)this + 62); *((_DWORD *)this + 63) += v5 )
  {
    ...
    v5 = (v4 - 12) >> 4;
    if ( (unsigned int)(*((_DWORD *)this + 62) - *((_DWORD *)this + 63)) < v5 )
      LODWORD(v5) = *((_DWORD *)this + 62) - *((_DWORD *)this + 63);
