/*
 * XREFs of ?FilteredBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C00B0B00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  if ( a11 == 52428 || a11 == 61680 && a9->iSolidColor != -1 )
    v11 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *, POINTL *, BRUSHOBJ *, POINTL *, ROP4))*((_QWORD *)a1->hdev + 328);
