/*
 * XREFs of ?SetReferenceArrayProperty@CRenderTargetGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C0016870
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      *((_DWORD *)this + 12) = a5;
      v13 = 0LL;
      *((_QWORD *)this + 5) = a4;
      for ( *a6 = 1; (unsigned int)v13 < *((_DWORD *)this + 12); v13 = (unsigned int)(v13 + 1) )
