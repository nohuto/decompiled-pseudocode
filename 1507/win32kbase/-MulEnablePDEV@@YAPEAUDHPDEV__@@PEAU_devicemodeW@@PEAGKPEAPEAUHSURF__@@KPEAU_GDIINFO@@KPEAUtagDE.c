/*
 * XREFs of ?MulEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAU_GDIINFO@@KPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C00B4BE0
 * Callers:
 *     <none>
 * Callees:
 *     vSpEnableMultiMon_0 @ 0x1C00013E8 (vSpEnableMultiMon_0.c)
 ...
 *     ?pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ @ 0x1C00B54C0 (-pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ.c)
 *     bIntersect @ 0x1C00B54F0 (bIntersect.c)
 */
