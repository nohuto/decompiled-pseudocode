/*
 * XREFs of IsPDEVOBJ_bCreateDefaultBrushesSupported_0 @ 0x1C0001150
 * Callers:
...
// attributes: thunk
__int64 IsPDEVOBJ_bCreateDefaultBrushesSupported_0()
{
  return IsPDEVOBJ_bCreateDefaultBrushesSupported();
}
