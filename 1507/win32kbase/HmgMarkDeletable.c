/*
 * XREFs of HmgMarkDeletable @ 0x1C000F5A0
 * Callers:
 *     GreMarkDeletableBitmap @ 0x1C000F570 (GreMarkDeletableBitmap.c)
...
__int64 __fastcall HmgMarkDeletable(int a1, char a2)
{
  ...
  if ( (unsigned __int16)a1 < (unsigned int)gcMaxHmgr )
  {
    ...
    HANDLELOCK::vLockHandle((HANDLELOCK *)v7, (struct _ENTRY *)v5, 0, (unsigned __int16)a1, 0);
