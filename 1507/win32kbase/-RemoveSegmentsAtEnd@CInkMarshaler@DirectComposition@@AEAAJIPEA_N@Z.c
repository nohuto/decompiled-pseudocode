/*
 * XREFs of ?RemoveSegmentsAtEnd@CInkMarshaler@DirectComposition@@AEAAJIPEA_N@Z @ 0x1C00D5D98
 * Callers:
 *     ?SetIntegerProperty@CInkMarshaler@DirectComposition@@UEAAJI_JPEA_N@Z @ 0x1C00D5FA0 (-SetIntegerProperty@CInkMarshaler@DirectComposition@@UEAAJI_JPEA_N@Z.c)
 * Callees:
