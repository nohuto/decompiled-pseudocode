/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAUHDEV__@@K@Z @ 0x1C00B02CC
 * Callers:
...
PDEVOBJ *__fastcall PDEVOBJ::PDEVOBJ(PDEVOBJ *this, char *a2)
{
  ...
  _BYTE v36[32]; // [rsp+20h] [rbp-88h] BYREF
  ...
  *(_QWORD *)this = 0LL;
  ...
  {
    DEVLOCKOBJ::DEVLOCKOBJ((DEVLOCKOBJ *)v36, (struct PDEVOBJ *)&v38);
    v4 = gdwDirectDrawContext + 3588;
