/*
 * XREFs of Template_hh @ 0x1C00A9620
 * Callers:
 *     EtwTraceBeginPointerMessageGeneration @ 0x1C00A7220 (EtwTraceBeginPointerMessageGeneration.c)
 *     EtwTraceEndPointerMessageGeneration @ 0x1C00A7710 (EtwTraceEndPointerMessageGeneration.c)
 * Callees:
