/*
 * XREFs of ?OnProcessCreation@CProcessData@DirectComposition@@SAJPEAU_W32PROCESS@@@Z @ 0x1C0024564
 * Callers:
 *     DCompositionProcessCallout @ 0x1C0024520 (DCompositionProcessCallout.c)
 * Callees:
