/*
 * XREFs of Win32AllocateFromPagedLookasideListImpl_0 @ 0x1C0002C10
 * Callers:
...
// attributes: thunk
__int64 Win32AllocateFromPagedLookasideListImpl_0()
{
  return Win32AllocateFromPagedLookasideListImpl();
}
