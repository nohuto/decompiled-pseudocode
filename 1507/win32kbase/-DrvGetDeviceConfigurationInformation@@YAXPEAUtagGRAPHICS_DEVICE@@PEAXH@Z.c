/*
 * XREFs of ?DrvGetDeviceConfigurationInformation@@YAXPEAUtagGRAPHICS_DEVICE@@PEAXH@Z @ 0x1C007F188
 * Callers:
...
LABEL_11:
  ...
  GreDeviceIoControlEx(Context[17], 0x23203Bu, 0LL, 0, InputBuffer, 0x30u, &v29, 1u);
  ...
  if ( !LODWORD(InputBuffer[3]) || !InputBuffer[2] )
  {
    ...
    GreDeviceIoControlEx(v12, 0x23203Fu, InputBuffer, 0x30u, 0LL, 0, &v29, 1u);
    goto LABEL_13;
  }
