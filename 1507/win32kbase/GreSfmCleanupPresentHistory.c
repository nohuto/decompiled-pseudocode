/*
 * XREFs of GreSfmCleanupPresentHistory @ 0x1C0080334
 * Callers:
...
_DWORD *__fastcall GreSfmCleanupPresentHistory(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v10 = 0LL;
  LOBYTE(a3) = 1;
  result = (_DWORD *)((__int64 (__fastcall *)(unsigned int *, _QWORD, __int64, _QWORD))qword_1C01010C8)(
                       &v9,
                       0LL,
                       a3,
                       0LL);
  if ( (int)result >= 0 )
  {
    ...
    if ( v9 )
    {
      if ( v9 <= 8 || (result = PALLOCMEM2(20 * v9, 1886221383LL, 1), (v3 = result) != 0LL) )
      {
        ...
        v10 = v3;
        LOBYTE(v6) = 1;
        if ( (int)((__int64 (__fastcall *)(unsigned int *, _QWORD, __int64, _QWORD))qword_1C01010C8)(&v9, 0LL, v6, 0LL) >= 0
          && v9
          && v9 <= (unsigned int)v5 )
        {
          v7 = 0LL;
          do
          {
            ...
            v8 = 0;
            v8 = v10[5 * v7];
            ((void (__fastcall *)(int *, _QWORD))qword_1C01010E0)(&v8, 0LL);
