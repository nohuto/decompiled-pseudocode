/*
 * XREFs of ?EmitRoot@CAnalogTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00DB700
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CAnalogTargetMarshaler::EmitRoot(
