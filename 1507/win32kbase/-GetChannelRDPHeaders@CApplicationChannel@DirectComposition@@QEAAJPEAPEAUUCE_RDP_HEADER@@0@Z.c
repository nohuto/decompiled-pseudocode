/*
 * XREFs of ?GetChannelRDPHeaders@CApplicationChannel@DirectComposition@@QEAAJPEAPEAUUCE_RDP_HEADER@@0@Z @ 0x1C0030094
 * Callers:
        ...
        struct UCE_RDP_HEADER **a3)
{
  ...
  v5 = *((_QWORD *)this + *((unsigned int *)this + 166) + 81);
  result = DirectComposition::CBatchSharedMemoryPool::GetUserModeViewAtOffset(
             *((DirectComposition::CBatchSharedMemoryPool **)this + 80),
             v5,
             (void **)a3);
  if ( (int)result >= 0 )
  {
    v7 = *(_QWORD *)(*((_QWORD *)this + 80) + 56LL);
    ++*((_DWORD *)this + 166);
