/*
 * XREFs of ?BuildReportDescriptor@@YAHGGPEAUtagUSAGE_PROPERTIES@@KKPEAU_HIDP_DEVICE_DESC@@@Z @ 0x1C00C732C
 * Callers:
 ...
 *     ?BuildDeviceHeader@@YAHPEAEKPEAKGG@Z @ 0x1C00C6F7C (-BuildDeviceHeader@@YAHPEAEKPEAKGG@Z.c)
