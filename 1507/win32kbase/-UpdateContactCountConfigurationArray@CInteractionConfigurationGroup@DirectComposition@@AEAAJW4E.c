/*
 * XREFs of ?UpdateContactCountConfigurationArray@CInteractionConfigurationGroup@DirectComposition@@AEAAJW4Enum@InteractionProperty@@UContactRangeConfiguration@12@PEAV?$CStructDynamicArray@UContactRangeConfiguration@CInteractionConfigurationGroup@DirectComposition@@@@PEA_N@Z @ 0x1C00D7F64
 * Callers:
 ...
 *     ?ApplyConfigOperation@CInteractionConfigurationGroup@DirectComposition@@CAIIIW4Enum@InteractionProperty@@PEA_N@Z @ 0x1C00D7D24 (-ApplyConfigOperation@CInteractionConfigurationGroup@DirectComposition@@CAIIIW4Enum@InteractionP.c)
...
LABEL_49:
    ...
    if ( v38 )
    {
      ...
      if ( v38 != v40[2] )
        goto LABEL_55;
      *v37 = *v40;
      CStructDynamicArray<CInputManager::PointerCaptureInfo>::RemoveAt(a4, v39);
      LODWORD(v10) = v10 - 1;
    }
    else
    {
      CStructDynamicArray<CInputManager::PointerCaptureInfo>::RemoveAt(a4, v10);
      LODWORD(v10) = v10 - 1;
    }
    *a5 = 1;
    --v11;
