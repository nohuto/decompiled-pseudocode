/*
 * XREFs of EtwTraceInputProcessDelay @ 0x1C0050350
 * Callers:
...
void __fastcall EtwTraceInputProcessDelay(struct tagTHREADINFO *a1)
{
  ...
  v6 = 0LL;
  v25 = 0LL;
  v7 = (struct tagWND *)ValidateHwndEx(*((void **)a1 + 129), 1LL, 0);
  v8 = v7;
  if ( v7 )
  {
...
LABEL_24:
  ...
  else
  {
    ...
    if ( v22 >= (unsigned __int64)W32UserProbeAddress
      || (unsigned __int16)v20 > HIWORD(v26)
      || (v20 & 1) != 0
      || v22 <= v21 )
    {
    ...
    if ( &v32 )
      v12 = v33;
    if ( (Microsoft_Windows_Win32kEnableBits & 0x100) != 0 )
      Template_qqqzzzqx(v20, v22, v21, v4, v24[0], v23, (__int64)Buffer, (__int64)v6, v12, v10, v11);
  }
  if ( Buffer )
