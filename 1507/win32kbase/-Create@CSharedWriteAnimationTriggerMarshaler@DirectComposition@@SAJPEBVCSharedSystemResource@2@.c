/*
 * XREFs of ?Create@CSharedWriteAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0018AB4
 * Callers:
 *     CreateSharedWriteAnimationTriggerMarshaler @ 0x1C0018A80 (CreateSharedWriteAnimationTriggerMarshaler.c)
 * Callees:
