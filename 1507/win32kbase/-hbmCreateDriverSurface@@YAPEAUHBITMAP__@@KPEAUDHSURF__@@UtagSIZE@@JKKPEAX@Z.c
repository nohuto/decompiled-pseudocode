/*
 * XREFs of ?hbmCreateDriverSurface@@YAPEAUHBITMAP__@@KPEAUDHSURF__@@UtagSIZE@@JKKPEAX@Z @ 0x1C0011DA4
 * Callers:
 *     EngCreateDeviceBitmap @ 0x1C0003750 (EngCreateDeviceBitmap.c)
 *     EngCreateDeviceSurface @ 0x1C0011CF0 (EngCreateDeviceSurface.c)
 *     EngCreateBitmap @ 0x1C0011D40 (EngCreateBitmap.c)
 *     EngCreateRedirectionDeviceBitmap @ 0x1C0011D70 (EngCreateRedirectionDeviceBitmap.c)
 * Callees:
