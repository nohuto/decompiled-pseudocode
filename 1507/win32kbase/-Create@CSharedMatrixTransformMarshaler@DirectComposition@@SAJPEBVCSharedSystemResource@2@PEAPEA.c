/*
 * XREFs of ?Create@CSharedMatrixTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0003DD4
 * Callers:
 *     CreateSharedMatrixTransformMarshaler @ 0x1C0003DA0 (CreateSharedMatrixTransformMarshaler.c)
 * Callees:
