/*
 * XREFs of IsWin32FreeToPagedLookasideListImplSupported_0 @ 0x1C0002C18
 * Callers:
...
// attributes: thunk
__int64 IsWin32FreeToPagedLookasideListImplSupported_0()
{
  return IsWin32FreeToPagedLookasideListImplSupported();
}
