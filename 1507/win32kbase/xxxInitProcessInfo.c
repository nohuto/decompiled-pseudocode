/*
 * XREFs of xxxInitProcessInfo @ 0x1C0051B44
 * Callers:
 *     xxxUserProcessCallout @ 0x1C0051410 (xxxUserProcessCallout.c)
 * Callees:
 *     IsCheckAllowForegroundSupported_0 @ 0x1C0002018 (IsCheckAllowForegroundSupported_0.c)
 *     CheckAllowForeground_0 @ 0x1C0002020 (CheckAllowForeground_0.c)
 ...
 *     SetAppStarting @ 0x1C0051DD0 (SetAppStarting.c)
 *     xxxSetProcessInitState @ 0x1C0051E40 (xxxSetProcessInitState.c)
 *     ?MarkImmersiveProcess@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@@Z @ 0x1C0051F24 (-MarkImmersiveProcess@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@@Z.c)
 *     ?CheckProcessAndSessionState@@YAJPEAU_W32PROCESS@@@Z @ 0x1C0052024 (-CheckProcessAndSessionState@@YAJPEAU_W32PROCESS@@@Z.c)
