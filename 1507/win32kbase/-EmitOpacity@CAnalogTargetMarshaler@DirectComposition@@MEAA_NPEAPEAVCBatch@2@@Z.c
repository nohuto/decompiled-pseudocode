/*
 * XREFs of ?EmitOpacity@CAnalogTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00DB690
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CAnalogTargetMarshaler::EmitOpacity(
