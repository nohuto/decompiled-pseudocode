/*
 * XREFs of MiUseLowIoPriorityForModifiedPages @ 0x14014B610
 * Callers:
...
_BOOL8 __fastcall MiUseLowIoPriorityForModifiedPages(__int64 a1)
{
  ...
  result = 0;
  if ( !*(_DWORD *)(a1 + 696) && !*(_DWORD *)(a1 + 1040) )
  {
    v3 = *(_QWORD *)(a1 + 5328);
    AvailablePagesBelowPriority = MiGetAvailablePagesBelowPriority((_QWORD *)a1, 6u);
    v5 = v3 >> 2;
    if ( *(_QWORD *)(a1 + 5744) < 3 * v5 && (AvailablePagesBelowPriority > 0x40000 || AvailablePagesBelowPriority > v5) )
    {
