/*
 * XREFs of PipChangeDeviceObjectFromRegistryProperties @ 0x1404E47C4
 * Callers:
...
__int64 __fastcall PipChangeDeviceObjectFromRegistryProperties(__int64 a1, ACL *a2, __int64 a3, __int64 a4, char a5)
{
  ...
  PACL Sacl; // [rsp+68h] [rbp-49h] BYREF
  ACL *v48; // [rsp+70h] [rbp-41h] BYREF
...
LABEL_10:
    ...
    v33 = v43;
    v35 = IopCreateDefaultDeviceSecurityDescriptor(v43, v25, v34, v51, &v48, (__int64)&Owner, &v42);
    v9 = v48;
    v27 = v35;
    v11 = Owner;
    if ( !v35 )
