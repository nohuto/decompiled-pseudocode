/*
 * XREFs of PopEstimateChargeTime @ 0x1406B70DC
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  unsigned __int64 v14; // [rsp+50h] [rbp-71h] BYREF
  __int64 v15; // [rsp+58h] [rbp-69h] BYREF
  unsigned __int64 v16; // [rsp+60h] [rbp-61h] BYREF
  ...
  {
    for ( i = qword_14032E9B0; (__int64 *)i != &qword_14032E9B0; i = *(_QWORD *)i )
    {
      v8 = *(_DWORD *)(i + 64);
      v9 = *(_DWORD *)(i + 88);
      if ( v8 != -1 && v9 != -1 && v9 < v8 )
  ...
  if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
  {
    ...
    v32 = 8;
    v35 = 4;
    TlgWrite(&pCallbackContext, &unk_1402A4821, 0LL, 0LL, 8u, &pData);
  }
  return v0;
}
