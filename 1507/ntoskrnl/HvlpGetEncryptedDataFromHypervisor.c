/*
 * XREFs of HvlpGetEncryptedDataFromHypervisor @ 0x1401EF7AC
 * Callers:
...
__int64 __fastcall HvlpGetEncryptedDataFromHypervisor(__int64 a1, _OWORD *a2, unsigned int a3, _DWORD *a4, __int64 *a5)
{
  ...
  *v5 = 0LL;
  ...
  if ( v14 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(8 * (((unsigned __int64)qword_14034D0A0 >> 12) & 0xFFFFFFFFFLL) - 0x98000000000LL) = v25;
      KeFlushCurrentTbImmediately();
      v20 = (_OWORD *)qword_14034D0A0;
      v21 = 32LL;
      v22 = a2;
      do
      {
  ...
  *v5 = v11;
  *a4 = v14 << 12;
  dword_14034D0D0 = v10 - v14;
  qword_14034D0C8 = v11 + v14;
  return 0LL;
}
