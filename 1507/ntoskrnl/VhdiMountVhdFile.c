/*
 * XREFs of VhdiMountVhdFile @ 0x1407FCE1C
 * Callers:
...
__int64 __fastcall VhdiMountVhdFile(wchar_t *Src)
{
  ...
  UNICODE_STRING v23; // [rsp+A0h] [rbp-68h] BYREF
  ...
  _QWORD InputBuffer[4]; // [rsp+158h] [rbp+50h] BYREF
  _OWORD EaBuffer[7]; // [rsp+178h] [rbp+70h] BYREF
...
LABEL_11:
  ...
  RtlInitUnicodeString(&v23, (PCWSTR)v13);
