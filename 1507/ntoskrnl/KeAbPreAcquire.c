/*
 * XREFs of KeAbPreAcquire @ 0x14004E900
 * Callers:
...
__int64 __fastcall KeAbPreAcquire(ULONG_PTR BugCheckParameter2, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
...
LABEL_14:
              if ( v8 )
              {
                v12 = (unsigned int)++CurrentThread->SpecialApcDisable;
                if ( !(_WORD)v12
                  && ($CD287064E7C9F7953DE243E927CFCB99 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
                {
                  KiCheckForKernelApcDelivery(v12, a2, a3);
                }
              }
              return v4;
            }
LABEL_10:
            if ( BugCheckParameter2 + 0x70000000000LL <= 0x7FFFFFFFFFLL )
              SessionId = MmGetSessionIdEx(CurrentThread->ApcState.Process, a2);
            else
              SessionId = -1;
        ...
        v4 = (__int64)&CurrentThread->LockEntries[v10];
        goto LABEL_9;
      }
