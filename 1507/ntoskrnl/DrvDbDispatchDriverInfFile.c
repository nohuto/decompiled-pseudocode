/*
 * XREFs of DrvDbDispatchDriverInfFile @ 0x14054FC98
 * Callers:
 *     <none>
 * Callees:
 *     _PnpCtxGetObjectContext @ 0x1404DD5F4 (_PnpCtxGetObjectContext.c)
...
LABEL_11:
  ...
  v21 = *a5;
  LODWORD(v22[0]) = 0;
  LODWORD(v9) = DrvDbOpenObjectRegKey(v10, 0LL, 3u, a2, v21, 1, a5 + 2, v22);
  if ( (int)v9 >= 0 )
