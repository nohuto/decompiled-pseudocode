/*
 * XREFs of SymCryptSha256AppendBlocks_ul1 @ 0x14016A704
 * Callers:
 *     SymCryptSha256Result @ 0x14015F11C (SymCryptSha256Result.c)
 *     SymCryptSha256Append @ 0x14015F1E8 (SymCryptSha256Append.c)
 *     SymCryptSha256AppendBlocks @ 0x14026B2D8 (SymCryptSha256AppendBlocks.c)
 *     SymCryptParallelSha256AppendBytes_serial @ 0x14026C700 (SymCryptParallelSha256AppendBytes_serial.c)
 * Callees:
...
__int64 __fastcall SymCryptSha256AppendBlocks_ul1(int *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 *a4)
{
  ...
  _DWORD *v111; // [rsp+8h] [rbp-F8h]
  unsigned __int32 v112; // [rsp+10h] [rbp-F0h]
  unsigned __int32 v113; // [rsp+18h] [rbp-E8h]
  unsigned __int32 v114; // [rsp+20h] [rbp-E0h]
  unsigned __int32 v115; // [rsp+30h] [rbp-D0h]
  int v116; // [rsp+40h] [rbp-C0h]
  unsigned __int32 v117; // [rsp+40h] [rbp-C0h]
  int v118; // [rsp+50h] [rbp-B0h]
  unsigned __int32 v119; // [rsp+50h] [rbp-B0h]
  unsigned __int32 v120; // [rsp+60h] [rbp-A0h]
  unsigned __int32 v121; // [rsp+70h] [rbp-90h]
  unsigned __int32 v122; // [rsp+80h] [rbp-80h]
  int v123; // [rsp+90h] [rbp-70h]
  unsigned __int32 v124; // [rsp+90h] [rbp-70h]
  unsigned __int32 v125; // [rsp+A0h] [rbp-60h]
  unsigned __int32 v126; // [rsp+B0h] [rbp-50h]
  unsigned __int32 v127; // [rsp+B4h] [rbp-4Ch]
  unsigned __int32 v128; // [rsp+B8h] [rbp-48h]
  unsigned int *v129; // [rsp+C0h] [rbp-40h]
  unsigned __int32 v130; // [rsp+C8h] [rbp-38h]
  int v131; // [rsp+CCh] [rbp-34h]
  int v132; // [rsp+D0h] [rbp-30h]
  int v133; // [rsp+D4h] [rbp-2Ch]
  int v134; // [rsp+D8h] [rbp-28h]
  int v135; // [rsp+DCh] [rbp-24h]
  int v136; // [rsp+E0h] [rbp-20h]
  int v137; // [rsp+E4h] [rbp-1Ch]
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      do
      {
        v114 += ((v117 >> 10) ^ __ROR4__(v117, 17) ^ __ROR4__(v117, 19))
              + v130
        ...
        v112 += ((v115 >> 3) ^ __ROR4__(v115, 7) ^ __ROR4__(v115, 18))
              + v122
        ...
        v115 += ((v125 >> 3) ^ __ROR4__(v125, 7) ^ __ROR4__(v125, 18))
              + v121
        ...
        v125 += ((v126 >> 3) ^ __ROR4__(v126, 7) ^ __ROR4__(v126, 18))
              + v127
              + ((v112 >> 10) ^ __ROR4__(v112, 17) ^ __ROR4__(v112, 19));
        v76 = v125
            + v111[2]
            + (v68 ^ v74 & (v71 ^ v68))
        ...
        v103 = v110 + v111[13] + (v62 ^ v56 & (v53 ^ v62)) + (__ROR4__(v56, 6) ^ __ROR4__(v56, 11) ^ __ROR4__(v56, 25));
        v111 += 16;
        v104 = v103 + v98;
        v60 = v104 + v99;
      ...
      while ( (__int64)v111 < (__int64)WHEA_RECORD_CREATOR_GUID.Data4 );
      v4 = v138 + v60;
      v6 = v135 + v56;
      v8 = v137 + v53;
      v11 = v136 + v54;
