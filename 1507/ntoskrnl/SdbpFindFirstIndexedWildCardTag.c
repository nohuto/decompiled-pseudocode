/*
 * XREFs of SdbpFindFirstIndexedWildCardTag @ 0x140577324
 * Callers:
 ...
 *     AslStringPatternMatchA @ 0x1405774B4 (AslStringPatternMatchA.c)
 *     SdbpKeyToAnsiString @ 0x14057756C (SdbpKeyToAnsiString.c)
