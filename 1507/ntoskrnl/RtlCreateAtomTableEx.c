/*
 * XREFs of RtlCreateAtomTableEx @ 0x14010BE40
 * Callers:
 *     RtlCreateAtomTable @ 0x140522C78 (RtlCreateAtomTable.c)
 * Callees:
 *     memset @ 0x140195A80 (memset.c)
 *     RtlpAllocateAtom @ 0x140416BA8 (RtlpAllocateAtom.c)
 *     RtlpFreeAtom @ 0x140504D9C (RtlpFreeAtom.c)
 *     RtlpInitializeLockAtomTable @ 0x140522C84 (RtlpInitializeLockAtomTable.c)
