/*
 * XREFs of BiVerifyBootPartition @ 0x14057129C
 * Callers:
...
LABEL_5:
  ...
  v10 = v16 + 24;
  v21 = (int *)((char *)a1 + v16 + 24);
  if ( v20 < (unsigned __int64)(v16 + 44) + 16 || (unsigned int)v20 < v10 + v21[2] || *v21 || v21[4] != 5 )
    return (unsigned int)-1073741811;
  v22 = BiConvertBootEnvironmentDeviceToNt(v21, 0, 0LL, v30, &v31);
  v7 = (void *)v30[0];
  v17 = v22;
  if ( v22 >= 0 )
  {
