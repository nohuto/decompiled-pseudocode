/*
 * XREFs of ?BTreeIteratorFromSearchResult@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@@@SAXPEAU1@PEAUITERATOR@1@PEAUSEARCH_RESULT@1@@Z @ 0x140142B20
 * Callers:
...
char *__fastcall B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeIteratorFromSearchResult(
        char **a1,
        char **a2,
        __int64 a3)
{
    ...
    if ( v9 )
    {
      ...
      if ( v9 != *a1 )
      {
        if ( v5 == -1 )
        {
          ...
          v18 = alloca(v17);
          v19 = alloca(v17);
          B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultInit(v24, 2);
          v20 = *(_DWORD *)(v13 + 16);
          v25 = 0;
          v24[0] = v24;
          v26 = v14;
        ...
        result = a1[2];
        if ( *(_DWORD *)result != -1 )
          result = (char *)NP_CONTEXT::NpLeafRefInternal((struct NP_CONTEXT::NP_CTX *)(a1 + 2), v12, 3u);
      }
    }
  }
  a2[1] -= 16;
