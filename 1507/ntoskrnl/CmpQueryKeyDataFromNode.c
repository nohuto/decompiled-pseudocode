/*
 * XREFs of CmpQueryKeyDataFromNode @ 0x1404C7460
 * Callers:
 ...
 *     CmGetVisibleValueCount @ 0x1404F06D0 (CmGetVisibleValueCount.c)
 *     CmGetVisibleMaxValueNameLenAndDataLen @ 0x1404F0770 (CmGetVisibleMaxValueNameLenAndDataLen.c)
        ...
        __int64 a8)
{
  ...
  int v42; // [rsp+38h] [rbp-60h] BYREF
  int v43; // [rsp+3Ch] [rbp-5Ch] BYREF
...
LABEL_19:
  ...
  v31 = a8;
  result = CmGetVisibleMaxNameLenAndClassLen(v16, a2, a8, (unsigned int)&v41, (__int64)&v42);
  if ( (int)result >= 0 )
  {
    result = CmGetVisibleMaxValueNameLenAndDataLen(v16, a2, v31, (unsigned int)&v43, (__int64)&v44);
    v49 = result;
    if ( (int)result >= 0 )
    {
