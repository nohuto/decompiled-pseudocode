/*
 * XREFs of IopSetupArbiterAndTranslators @ 0x14059D6A4
 * Callers:
 *     IopResourceRequirementsListToReqList @ 0x14059D140 (IopResourceRequirementsListToReqList.c)
 * Callees:
 *     ExAllocatePoolWithTag @ 0x140288E60 (ExAllocatePoolWithTag.c)
 *     IopFindResourceHandlerInfo @ 0x14059DA98 (IopFindResourceHandlerInfo.c)
 *     IopFindLegacyBusDeviceNode @ 0x14059DB24 (IopFindLegacyBusDeviceNode.c)
 *     IopCallArbiter @ 0x14059DB80 (IopCallArbiter.c)
  ...
  while ( 1 )
  {
    if ( LegacyBusDeviceNode != IopRootDeviceNode || v6 || v9 )
    {
      ...
      if ( (unsigned __int8)v7 > 0xFu )
        ...
        v20 = 1 << v7;
      v21 = IopQueryResourceHandlerInterface(2LL, v11, a3, &v37);
...
LABEL_23:
          ...
          if ( (unsigned __int8)v7 > 0xFu )
            ...
            v18 = 1 << v7;
          v19 = IopQueryResourceHandlerInterface(1LL, *(_QWORD *)(LegacyBusDeviceNode + 32), a3, &v37);
...
LABEL_20:
          ...
          PoolWithTag = (unsigned __int64)ExAllocatePoolWithTag((POOL_TYPE)257, 0x28uLL, 0x20207050u);
          if ( !PoolWithTag )
            return 3221225626LL;
      ...
      v22 = (char *)ExAllocatePoolWithTag((POOL_TYPE)257, 0x70uLL, 0x20207050u);
