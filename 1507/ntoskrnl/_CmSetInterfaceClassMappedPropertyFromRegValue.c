/*
 * XREFs of _CmSetInterfaceClassMappedPropertyFromRegValue @ 0x14071963C
 * Callers:
        ...
        ULONG a7)
{
  ...
  if ( v7 == 2 )
  {
    ...
    if ( !v17 )
    {
      if ( !a3 )
      {
        v8 = CmOpenInterfaceClassRegKey(a1, a2, v15, a4, 1, 0, (__int64)v22, 0LL);
        if ( v8 < 0 )
        {
LABEL_24:
          if ( v22[0] )
      ...
      v8 = PnpOpenPropertiesKey(a1, a3, 0LL, 2u, 1, v21, &Handle);
      if ( v8 >= 0 )
      {
