...
__int64 __fastcall MmDuplicateMemory(__int64 a1)
{
  ...
  *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30) = CurrentThread;
  ...
  RtlSetAllBitsEx((_QWORD *)qword_14034F160);
      ...
      if ( *(_QWORD *)v17 )
      {
        ...
        do
        {
          ...
          *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x18) = v20;
          if ( v15 == 2 && MI_IS_DECAY_PFN(v18) )
          {
            ...
            if ( v21 != v18 )
            {
              do
              {
                ...
                if ( _bittest64(*(const signed __int64 **)(qword_14034F160 + 8), v21) )
                {
                  RtlInterlockedClearBitRunEx(qword_14034F160, v21, 1uLL);
                  v19 = 0x58000000000LL;
                  _bittestandset64(*(signed __int64 **)(qword_14034F158 + 8), v21);
                }
          ...
          else if ( _bittest64(*(const signed __int64 **)(qword_14034F160 + 8), v18) )
          {
            RtlInterlockedClearBitRunEx(qword_14034F160, v18, 1uLL);
            v19 = 0x58000000000LL;
            _bittestandset64(*(signed __int64 **)(qword_14034F158 + 8), v18);
          }
...
LABEL_56:
    ...
    do
    {
      ...
      {
        if ( _bittest64(*(const signed __int64 **)(qword_14034F160 + 8), i) )
        {
          RtlInterlockedClearBitRunEx(qword_14034F160, i, 1uLL);
          _bittestandset64(*(signed __int64 **)(qword_14034F158 + 8), i);
        }
      }
      v24 += 5;
      --v25;
    ...
    if ( qword_140354510 != 0xFFFFFFFFFLL )
    {
      do
      {
        if ( _bittest64(*(const signed __int64 **)(qword_14034F160 + 8), v27) )
        {
          RtlInterlockedClearBitRunEx(qword_14034F160, v27, 1uLL);
          _bittestandset64(*(signed __int64 **)(qword_14034F158 + 8), v27);
        }
    ...
    *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20) = 0LL;
    ...
    do
    {
      SetBits = RtlFindSetBitsEx((unsigned __int64 *)qword_14034F158, 1uLL, v28);
      v32 = SetBits;
      if ( SetBits < v28 || SetBits == -1LL )
        break;
      NextForwardRunClear = RtlFindNextForwardRunClearEx(qword_14034F158, SetBits, (unsigned __int64 *)(v1 + 56));
      *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x18) = NextForwardRunClear;
      v34 = NextForwardRunClear;
      if ( NextForwardRunClear )
        v35 = *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38);
      else
        v35 = *(_QWORD *)qword_14034F158;
      v36 = v35 - v32;
      if ( (v2 & 8) == 0 )
        goto LABEL_102;
      if ( v29 == 1 )
      {
        RtlInterlockedSetBitRunEx(qword_14034F160, v32, v36);
        v28 = v32 + v34 + v36;
        continue;
      }
      if ( v36 > 0x100 )
      ...
      *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x18) = 0LL;
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v39 + 24) &= 0xC000000000000000uLL;
        if ( !locked )
          break;
        RtlInterlockedClearBitRunEx(qword_14034F160, v28, 1uLL);
        MiUnlockPage(v39, v41);
        if ( v38 == -1 )
          v38 = v28;
LABEL_96:
...
LABEL_107:
    ...
    while ( v28 < *(_QWORD *)qword_14034F158 );
...
LABEL_123:
  ...
  if ( *(_QWORD *)(a1 + 24) )
    RtlSetAllBitsEx((_QWORD *)qword_14034F158);
    ...
    if ( v55 != 0xFFFFFFFFFLL )
    {
      do
      {
        ...
        *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48) = v56;
        if ( v52 == 2 && MI_IS_DECAY_PFN(v55) )
        {
          ...
          if ( v58 != v55 )
          {
            do
            {
              ...
              RtlInterlockedClearBitRunEx(qword_14034F160, v58, 1uLL);
              if ( *(_QWORD *)(a1 + 24) )
                _bittestandreset64(*(signed __int64 **)(qword_14034F158 + 8), v58);
              v57 = 0x58000000000LL;
        ...
        {
          RtlInterlockedClearBitRunEx(qword_14034F160, v55, 1uLL);
          if ( *(_QWORD *)(a1 + 24) )
            _bittestandreset64(*(signed __int64 **)(qword_14034F158 + 8), v55);
        }
...
LABEL_157:
  ...
  do
  {
    ...
    if ( v63 != v62 )
    {
      RtlInterlockedClearBitRunEx(qword_14034F160, v62, v63 - v62);
      if ( *(_QWORD *)(v49 + 24) )
        RtlClearBitsEx(qword_14034F158, v62, v63 - v62);
      v60 = MmPhysicalMemoryBlock;
    }
  ...
  {
    RtlInterlockedClearBitRunEx(qword_14034F160, v62, qword_14034EC10 - v62 + 1);
    if ( *(_QWORD *)(v49 + 24) )
      RtlClearBitsEx(qword_14034F158, v62, qword_14034EC10 - v62 + 1);
  }
  v65 = (unsigned __int64 *)qword_14034F160;
  v66 = 0LL;
  do
  {
    ...
    if ( v67 < v66 || v67 == -1LL )
      break;
    v69 = RtlFindNextForwardRunClearEx(qword_14034F160, v67, (unsigned __int64 *)(v1 + 56));
    if ( v69 )
      v70 = *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38);
    else
      v70 = *(_QWORD *)qword_14034F160;
    v71 = v70 - v68;
    v11 = (*(__int64 (__fastcall **)(unsigned __int64, __int64))(v49 + 16))(v68 << 12, v71 << 12);
    if ( v11 < 0 )
    {
LABEL_180:
      qword_14034F148 = 0LL;
  ...
  while ( v66 < *(_QWORD *)qword_14034F160 );
  if ( *(_QWORD *)(v49 + 24) )
  {
    v72 = (unsigned __int64 *)qword_14034F158;
    v73 = 0LL;
    do
    {
      ...
      if ( v74 < v73 || v74 == -1LL )
        break;
      v76 = RtlFindNextForwardRunClearEx(qword_14034F158, v74, (unsigned __int64 *)(v1 + 56));
      if ( v76 )
        v77 = *(_QWORD *)(((unsigned __int64)&v80 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38);
      else
        v77 = *(_QWORD *)qword_14034F158;
      v78 = v77 - v75;
      v11 = (*(__int64 (__fastcall **)(unsigned __int64, __int64))(v49 + 24))(v75 << 12, v78 << 12);
      if ( v11 < 0 )
        goto LABEL_180;
      v72 = (unsigned __int64 *)qword_14034F158;
      v73 = v75 + v76 + v78;
    }
    while ( v73 < *(_QWORD *)qword_14034F158 );
  }
