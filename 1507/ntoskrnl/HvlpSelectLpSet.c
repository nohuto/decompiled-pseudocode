/*
 * XREFs of HvlpSelectLpSet @ 0x1401E6DE4
 * Callers:
...
__int64 __fastcall HvlpSelectLpSet(unsigned int a1, __int64 a2)
{
  ...
  unsigned int v44; // [rsp+2Ch] [rbp-6Ch]
  int v45; // [rsp+30h] [rbp-68h]
  int v46; // [rsp+34h] [rbp-64h]
  _WORD v47[2]; // [rsp+38h] [rbp-60h] BYREF
  int v48; // [rsp+3Ch] [rbp-5Ch]
      ...
      else
      {
        ...
        *(v7 - 1) = v41[0];
        ...
        if ( v12 >= 0 )
        {
          ...
          {
            ProximityNode = HvlpQueryProximityNode(v49, v47);
            v11 = v41[0];
          }
          else
          {
...
LABEL_54:
    ...
    if ( a1 )
    {
      ...
      v46 = KeNumprocSpecified;
      v43 = KeBootprocSpecified;
    }
    v30 = -1;
    v31 = 0;
    if ( a1 )
