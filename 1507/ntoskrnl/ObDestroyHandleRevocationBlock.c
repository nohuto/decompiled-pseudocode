/*
 * XREFs of ObDestroyHandleRevocationBlock @ 0x14052E61C
 * Callers:
...
int __fastcall ObDestroyHandleRevocationBlock(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v7 = KeAbPreAcquire(a1 + 16, 0LL, 0LL, a4);
  v10 = v7;
  ...
  while ( v11 != (_QWORD *)a1 )
  {
    ...
    LOBYTE(v9) = 1;
    v11 = (_QWORD *)*v11;
    ObpHandleRevocationBlockRemoveInsertedObject(v18, a1, 0LL, v9);
  }
  _m_prefetchw(v6);
  v12 = *v6;
  v13 = *v6 - 16;
  ...
  v17 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 24), 1LL, 0LL);
  if ( v17 >= 2 )
    LODWORD(v17) = ExfWaitForRundownProtectionRelease((volatile signed __int64 *)(a1 + 24), v17);
  return v17;
}
