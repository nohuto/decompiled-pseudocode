/*
 * XREFs of RtlDecompressBufferXpressHuff @ 0x1400D7E90
 * Callers:
 *     <none>
 * Callees:
 *     XpressBuildHuffmanDecodingTable @ 0x1400D83CC (XpressBuildHuffmanDecodingTable.c)
 */
...
LABEL_52:
          ...
          if ( v37 <= 0 )
          {
            ...
            do
            {
              ...
              v18 *= 2;
              v37 = *(_WORD *)(v9 + 2LL * (__int16)(v42 - v37) + 3104);
            }
            while ( v37 <= 0 );
          }
          else
          ...
          do
          {
            while ( 1 )
            {
              ...
              if ( v20 <= 0 )
              {
                ...
                {
                  --v15;
                  v30 = (unsigned __int64)v18 >> 31;
                  v18 *= 2;
                  v20 = *(_WORD *)(v9 + 2LL * (__int16)(v30 - v20) + 3104);
                }
                while ( v20 <= 0 );
              }
              else
