/*
 * XREFs of DrvDbDeleteObjectSubKey @ 0x14071A84C
 * Callers:
...
__int64 __fastcall DrvDbDeleteObjectSubKey(__int64 **a1, char *a2, const WCHAR *a3, unsigned int a4)
{
  ...
  if ( a4 <= 1 )
  {
    v10 = PnpCtxRegDeleteTree((__int64)*a1, (__int64)a2, (__int64)a3);
    InfoKey = v10;
    goto LABEL_3;
  }
  if ( *a1 )
    ...
    v12 = 0LL;
  v10 = SysCtxRegOpenKey(v12, a2, a3, 0, 0x3001Fu, &Handle);
  InfoKey = v10;
  if ( v10 < 0 )
  {
LABEL_3:
  ...
  for ( i = PnpGetGenericStorePropertyKeys(*a1, (char *)Handle, 0LL, 0, 0LL, 0, &v41);
        ;
        i = PnpGetGenericStorePropertyKeys(*a1, (char *)Handle, 0LL, 0, (__int64)PoolWithTag, v14, &v41) )
  {
    InfoKey = i;
    if ( i != -1073741789 )
      break;
  ...
  if ( InfoKey != -1073741275 )
  {
    ...
    {
      v16 = PnpDeletePropertyWorker(*a1, (char *)Handle, 0LL, (__int64)PoolWithTag + 20 * j, 0, dwFlags, 0);
      InfoKey = v16;
...
LABEL_33:
  ...
  for ( k = (char *)Handle; ; k = 0LL )
  {
    if ( !k )
    {
      ...
      if ( *a1 )
        v21 = **a1;
      v22 = SysCtxRegOpenKey(v21, v8, v6, 0, 0x3001Fu, &Handle);
      InfoKey = v22;
      if ( v22 < 0 )
      {
        v27 = v22 == -1073741444;
