/*
 * XREFs of PiAuCreateStandardSecurityObject @ 0x1407DE1E4
 * Callers:
...
LABEL_42:
  ...
  if ( PoolWithTag )
  {
    ...
    if ( Acl >= 0 )
    {
      Acl = RtlAddAccessAllowedAceEx(v2, 2u, 0, 0x200E7u, a1[2]);
      if ( Acl >= 0 )
      {
        Acl = RtlAddAccessDeniedAceEx(v2, 2u, 0, 0xF00FFu, a1[3]);
        if ( Acl >= 0 )
        {
          Acl = RtlAddAccessAllowedAceEx(v2, 2u, 0, 0xF00FFu, *a1);
          if ( Acl >= 0 )
          {
            Acl = RtlAddAccessAllowedAceEx(v2, 2u, 0, 0x20025u, a1[4]);
            if ( Acl >= 0 )
            {
