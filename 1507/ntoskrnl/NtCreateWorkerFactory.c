...
LABEL_25:
  ...
  v17 = ObOpenObjectByPointer(v33, 0x200u, 0LL, 0x2Au, (POBJECT_TYPE)PsProcessType, 0, &v29);
  if ( v17 < 0 )
  {
LABEL_24:
...
LABEL_23:
  ...
  v17 = ObCreateObject(v22, (_DWORD)ExpWorkerFactoryObjectType, a3, v21, 0, 416, 0, 0, (__int64)&v30);
  if ( v17 < 0 )
  {
    v28 = *(_QWORD *)(v16 + 16);
    *(_QWORD *)(v28 + 56) = 0LL;
  ...
  *((_DWORD *)v23 + 86) = 1;
  ...
  result = ObInsertObject(v23, 0LL, a2, 0, 0LL, &v32);
  v27 = result;
  if ( result >= 0 )
  {
    *v13 = v32;
