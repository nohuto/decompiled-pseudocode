/*
 * XREFs of ViThunkRecoverPristines @ 0x1407451CC
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1407449E0 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x140745574 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1407455DC (ViThunkReplaceSpecialPristine.c)
 */
