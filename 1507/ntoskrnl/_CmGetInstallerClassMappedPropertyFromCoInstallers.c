/*
 * XREFs of _CmGetInstallerClassMappedPropertyFromCoInstallers @ 0x14058C574
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  *v7 = 0;
  ...
  LODWORD(v16) = v12;
  CachedContextBaseKey = PnpCtxRegQueryValue(v14, v17, (__int64)a2, (__int64)&a7, v9, (__int64)&v16);
