/*
 * XREFs of SepSetAuditInfoForObjectType @ 0x140584C38
 * Callers:
 *     SepExamineSaclEx @ 0x140584948 (SepExamineSaclEx.c)
 * Callees:
 *     SepAuditTypeList @ 0x140584CF8 (SepAuditTypeList.c)
 */
      ...
      *a10 = 1;
      if ( a5 )
      {
        ...
        *(_WORD *)(a4 + 48LL * a7 + 2) |= 1u;
        if ( a6 )
          return SepAuditTypeList(a4, a5, a8, a7, (__int64)a10, (__int64)a11);
      }
    }
