/*
 * XREFs of ?wcstoxlX@@YAKPEAUlocaleinfo_struct@@PEBGPEAPEBGHHH@Z @ 0x140173E84
 * Callers:
 *     wcstol @ 0x140174090 (wcstol.c)
 *     wcstolX @ 0x1401740B8 (wcstolX.c)
 *     wcstoul @ 0x1401740E0 (wcstoul.c)
 * Callees:
 *     PopPoCoalescinCallback @ 0x140139F40 (PopPoCoalescinCallback.c)
 *     _iswctype_l @ 0x14017478C (_iswctype_l.c)
 *     _wchartodigit @ 0x140175FC4 (_wchartodigit.c)
 */
