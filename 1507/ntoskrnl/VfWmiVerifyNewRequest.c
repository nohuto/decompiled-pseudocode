/*
 * XREFs of VfWmiVerifyNewRequest @ 0x14074DEFC
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VfWmiVerifyNewRequest(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, const void *a6)
{
  const void *v6; // rdi
  int v7; // esi
  ...
  if ( v7 != -1073741637 )
  {
    ViErrorDisplayDescription(528);
    if ( RtlStringCbPrintfA(pszDest, 0x40uLL, "CulpritAddress = %p, Irp = %p.\n", a6, v6) >= 0 )
      VfUtilDbgPrint(pszDest);
    ViErrorFinishReport(528, (ULONG_PTR)a6, (ULONG_PTR)v6, 0LL);
    if ( v7 < 0 )
