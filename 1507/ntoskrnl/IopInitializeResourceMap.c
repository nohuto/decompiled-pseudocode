/*
 * XREFs of IopInitializeResourceMap @ 0x1407D5960
 * Callers:
 *     IopInitializePlugPlayServices @ 0x1407BF6F0 (IopInitializePlugPlayServices.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x140047FE0 (RtlInitUnicodeString.c)
 *     RtlCmEncodeMemIoResource @ 0x140163FE4 (RtlCmEncodeMemIoResource.c)
  ...
  do
  {
    if ( v2 )
    {
      if ( v2 == 1 )
      {
        ...
        RtlInitUnicodeString(&v27, L".Translated");
        v17 = 0;
        v18 = 0LL;
        do
        {
      ...
      else
      {
        ...
        RtlInitUnicodeString(&v27, L".Raw");
        v3 = 0;
        v4 = 0LL;
        do
        {
...
LABEL_20:
    ...
    {
      IopWriteResourceList(Handle, &DestinationString, &v26, &v27, v12, v10);
      ZwClose(Handle);
    }
