/*
 * XREFs of IopParseFile @ 0x14052F910
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _FILE_OBJECT **a10)
{
  ...
  if ( a2 != IoFileObjectType || !a8 || *(_WORD *)a8 != 8 || *(_WORD *)(a8 + 2) != 184 )
    return 3221225508LL;
  RelatedDeviceObject = (unsigned int *)IoGetRelatedDeviceObject(a1);
  *(_QWORD *)(a8 + 40) = a1;
  return IopParseDevice(RelatedDeviceObject, a2, a3, a4, a5, a6, a7, (void **)a8, a9, a10);
}
