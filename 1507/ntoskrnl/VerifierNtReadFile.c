/*
 * XREFs of VerifierNtReadFile @ 0x1407543A8
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall VerifierNtReadFile(
        HANDLE FileHandle,
        HANDLE Event,
        ...
        ULONG *Key)
{
  ...
  return pXdvNtReadFile(FileHandle, Event, ApcRoutine, ApcContext, IoStatusBlock, Buffer, Length, ByteOffset, Key);
}
