/*
 * XREFs of DrvDbLoadDatabaseNode @ 0x1404DDF80
 * Callers:
...
__int64 __fastcall DrvDbLoadDatabaseNode(_QWORD **a1, __int64 a2)
{
  ...
  if ( (v2 & 1) == 0 )
  {
    ...
    if ( !*(_QWORD *)(a2 + 80) )
    {
      ...
      v25 = *a1 ? **a1 : 0LL;
      CachedContextBaseKey = SysCtxRegOpenKey(v25, v4, *(const WCHAR **)(a2 + 48), 0, 0x2000000u, (HANDLE *)(a2 + 80));
      if ( CachedContextBaseKey < 0 )
      {
LABEL_7:
        if ( v6 )
...
LABEL_28:
  ...
  if ( *a1 )
    ...
    v15 = 0LL;
  v16 = SysCtxRegOpenKey(v15, v4, *(const WCHAR **)(a2 + 48), 0, 0x2000000u, v10);
