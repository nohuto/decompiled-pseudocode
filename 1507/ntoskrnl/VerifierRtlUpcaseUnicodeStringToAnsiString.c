/*
 * XREFs of VerifierRtlUpcaseUnicodeStringToAnsiString @ 0x140752ED4
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall VerifierRtlUpcaseUnicodeStringToAnsiString(STRING *a1, const UNICODE_STRING *a2, BOOLEAN a3)
{
  int result; // eax
