/*
 * XREFs of GetPrintableOperandValue @ 0x14070AA38
 * Callers:
        ...
        char a8)
{
  ...
  wchar_t *v59; // [rsp+50h] [rbp-B0h] BYREF
...
LABEL_41:
                ...
                for ( i = v21; ; v23 = i )
                {
                  ...
                  if ( PrintableOperandValue )
                    goto LABEL_82;
                  v61 += *a4;
                  if ( (int)ULongAddStringSize((unsigned int)v66, v59, &v62) < 0 )
                    goto LABEL_22;
                  v25 = v62 + 4;
                  v63 = v25;
                  ...
                  *a3 = v28;
                  ...
                  if ( RtlStringCchPrintfW(
                         ...
                         (unsigned __int64)(v63 - (unsigned int)v66 + 4) >> 1,
                         L"%ls, ",
                         v59) < 0 )
                    goto LABEL_71;
                  SddlpFree(v59);
        ...
        case 0x51u:
          if ( (unsigned int)(a2 - 1) >= 4 )
          {
            ...
            *a4 = 5;
            ...
            {
              memmove(Sid, a1 + 5, Size);
              PrintableOperandValue = LocalGetStringForSid(Sid, &v59, v12);
              if ( PrintableOperandValue )
                goto LABEL_82;
              *a4 += Size;
              v13 = -1LL;
...
LABEL_22:
              ...
              *a3 = v16;
              if ( v16 )
              {
                if ( RtlStringCchPrintfW(v16, v15 >> 1, L"SID(%ls)", v59) >= 0 )
                  goto LABEL_82;
                goto LABEL_71;
              }
LABEL_62:
