/*
 * XREFs of PopRequestRead @ 0x1403F5BC4
 * Callers:
 *     PopRestoreHiberContext @ 0x1403F4F20 (PopRestoreHiberContext.c)
 *     PopDecompressCallback @ 0x1403F5BB0 (PopDecompressCallback.c)
 * Callees:
  ...
  while ( *(_QWORD *)(BugCheckParameter3 + 408) )
  {
    ...
    if ( (_DWORD)v7 )
    {
      if ( (_DWORD)v7 != 1 )
      {
        ...
        v20 = __rdtsc();
        qword_14032ECF8 += v20 - *(_QWORD *)(BugCheckParameter3 + 344);
        ...
        v21 = __rdtsc();
        qword_14032ED28 += (((unsigned __int64)HIDWORD(v21) << 32) | (unsigned int)v21) - v20;
      ...
      v19 = __rdtsc();
      qword_14032ED20 += (((unsigned __int64)HIDWORD(v19) << 32) | (unsigned int)v19) - v16;
...
LABEL_33:
      ...
      v30 = __rdtsc();
      qword_14032ED20 += (((unsigned __int64)HIDWORD(v30) << 32) | (unsigned int)v30)
