...
__int64 __fastcall sub_1404DB5DC(PDEVICE_OBJECT Pdo, __int64 a2, const DEVPROPKEY *a3, int a4, __int64 Type)
{
  char v5; // r14
  ...
  v11 = Type;
  if ( *(unsigned __int16 *)(Type + 2) < v10 && (v20 = sub_140559BD8(Type, v10), v14 = (unsigned int)v20, v20 < 0) )
  {
LABEL_29:
    sub_1404DBACC(v11, v13, v14);
  }
  else
  {
    while ( 1 )
