/*
 * XREFs of PopActionRetrieveInitialState @ 0x14014800C
 * Callers:
...
__int64 __fastcall PopActionRetrieveInitialState(_DWORD *a1, _DWORD *a2, _DWORD *a3, _BYTE *a4)
{
  ...
  else if ( (_DWORD)qword_14032E644 == 7 )
  {
    *a2 = 5;
  ...
  v11 = dword_14032E64C;
  *a4 = 1;
  if ( v10 || v11 < 0 && (unsigned int)(dword_14032E654 - 1) <= 1 )
    *a4 = 0;
  if ( (unsigned __int8)PopFastS4Check() )
  {
    *a1 = *a2;
    v12 = dword_14032E64C & 0xEFFFFFFF;
    dword_14032E64C &= ~0x10000000u;
  }
  if ( (v12 & 0x10000000) != 0 )
