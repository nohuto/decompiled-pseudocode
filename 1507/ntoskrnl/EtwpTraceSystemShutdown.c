/*
 * XREFs of EtwpTraceSystemShutdown @ 0x1406E56E0
 * Callers:
...
char EtwpTraceSystemShutdown()
{
  ...
  {
    result = TlgKeywordOn(&stru_140320BE0, 0x200000000000uLL);
    if ( result )
    {
      v8 = 0;
      v11 = 0;
      ...
      v7 = 4;
      v10 = 8;
      result = TlgWrite(&stru_140320BE0, &unk_1402A4FDB, 0LL, 0LL, 4u, &pData);
    }
  }
