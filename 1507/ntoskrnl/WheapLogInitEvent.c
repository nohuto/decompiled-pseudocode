/*
 * XREFs of WheapLogInitEvent @ 0x1405BA4F8
 * Callers:
...
void WheapLogInitEvent()
{
  ...
  v8 = 1064 * dword_140356CC4;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(1064 * dword_140356CC4), 0x61656857u);
  if ( PoolWithTag )
  {
    v1 = (__int64 *)qword_140356CC8;
    for ( i = 0; v1 != &qword_140356CC8; v1 = (__int64 *)*v1 )
    {
      v3 = 8LL;
      v4 = v1;
    ...
    UserData.Ptr = (ULONGLONG)&dword_140356CC4;
