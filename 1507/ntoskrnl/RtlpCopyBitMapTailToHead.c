/*
 * XREFs of RtlpCopyBitMapTailToHead @ 0x1400EFA08
 * Callers:
...
void __fastcall RtlpCopyBitMapTailToHead(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( (a3 & 7) != 0 )
  {
    ...
    for ( i = v11 - 1; v9; --v9 )
    {
      *v10 = ((~((1 << (32 - v7)) - 1) & (unsigned int)*i) >> (32 - v7)) | *v10 & ~((1 << v7) - 1);
      --v10;
      v16 = *i--;
      *v10 = ((((1 << (32 - v7)) - 1) & v16) << v7) | *v10 & ((1 << v7) - 1);
    }
  }
  else
  {
    ...
    if ( (a4 & 7) != 0 )
    {
      v19 = (_BYTE *)(v5 + v17 + *(_QWORD *)(a2 + 8));
      *v19 &= ~((1 << v18) - 1);
      *v19 |= (unsigned __int8)((1 << v18) - 1) & *(_BYTE *)(v17 + *(_QWORD *)(a1 + 8));
    }
    if ( v17 )
