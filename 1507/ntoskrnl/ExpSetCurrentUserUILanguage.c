/*
 * XREFs of ExpSetCurrentUserUILanguage @ 0x14056C694
 * Callers:
 *     NtSetDefaultUILanguage @ 0x14056C464 (NtSetDefaultUILanguage.c)
 * Callees:
...
NTSTATUS __fastcall ExpSetCurrentUserUILanguage(PCWSTR SourceString, unsigned __int16 a2)
{
  ...
  v3 = a2;
  *(_WORD *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x1C0) = 0;
  memset((void *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 450), 0, 0xA8uLL);
  v5 = v3;
  *(_QWORD *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30) = 0LL;
  *(_QWORD *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x90) = 0LL;
  ...
  *(_BYTE *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 2) = 0;
  result = OpenGlobalizationUserSettingsKey(
             ...
             v10,
             v11,
             (PHANDLE)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 136));
  if ( result < 0 )
    return result;
        ...
        if ( v23 + 12 < 0x100 )
        {
          ...
          *(_OWORD *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68) = 0LL;
          if ( ZwOpenKey((PHANDLE)(v2 + 144), 0x40000000u, (POBJECT_ATTRIBUTES)(v2 + 72)) >= 0
            && ZwQueryValueKey(
                 *(HANDLE *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x90),
...
LABEL_23:
  ...
  v17 = *(void **)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x90);
  if ( v17 )
  {
    if ( ZwEnumerateValueKey(v17, 0, KeyValueBasicInformation, 0LL, 0, (PULONG)(v2 + 8)) == -2147483622 )
      ZwDeleteKey(*(HANDLE *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x90));
    ZwClose(*(HANDLE *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x90));
  }
  if ( *(_QWORD *)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20) )
  {
  ...
  if ( v20 )
    ZwClose(v20);
  CloseGlobalizationUserSettingsKey(*(char **)(((unsigned __int64)&v36 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88));
  if ( v8 == 1 )
  {
