/*
 * XREFs of ViCheckPadding @ 0x14073D8A0
 * Callers:
 ...
 *     ViHasBufferBeenTouched @ 0x14073E970 (ViHasBufferBeenTouched.c)
 */
    ...
    if ( a4 )
    {
      ...
      if ( HasBufferBeenTouched )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)4);
        VfReportIssueWithOptions(230, 15, 4, v4, HasBufferBeenTouched, byte_14032311C);
      }
      ...
      if ( v12 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)0x1000000F,
          (const void *)5);
        VfReportIssueWithOptions(230, 15, 5, v4, v12, byte_140323120);
      }
    }
    else
    {
      ...
      if ( v6 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)0x1000000F);
        VfReportIssueWithOptions(230, 15, 3, v7, 0LL, &dword_140323128);
      }
    }
  }
}
