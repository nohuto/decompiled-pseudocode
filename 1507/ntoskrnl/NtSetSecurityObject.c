/*
 * XREFs of NtSetSecurityObject @ 0x1404D2930
 * Callers:
 ...
 *     SeSetSecurityAccessMask @ 0x1404D2C34 (SeSetSecurityAccessMask.c)
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  PVOID v25; // [rsp+88h] [rbp-21h] BYREF
  ACCESS_MASK DesiredAccess; // [rsp+90h] [rbp-19h] BYREF
  PVOID P; // [rsp+98h] [rbp-11h] BYREF
  PVOID Object; // [rsp+A0h] [rbp-9h] BYREF
  _BYTE *v29; // [rsp+A8h] [rbp-1h] BYREF
  __int64 v30; // [rsp+B0h] [rbp+7h] BYREF
  struct _OBJECT_HANDLE_INFORMATION v31; // [rsp+B8h] [rbp+Fh] BYREF
  ...
  v35 = PreviousMode;
  v9 = ObReferenceObjectByHandle(v8, DesiredAccess, 0LL, PreviousMode, &Object, &v31);
  if ( v9 < 0 )
    return v9;
...
LABEL_31:
  ...
  v12 = v29;
  if ( (v29[2] & 0x10) == 0 && (v5 & 0x10000) != 0 )
    v5 &= 0xFFFFFF07;
  if ( ((v5 & 1) == 0 || *((_DWORD *)v29 + 1)) && ((v5 & 2) == 0 || *((_DWORD *)v29 + 2)) )
  {
    if ( (v31.HandleAttributes & 4) == 0 )
      v6 &= 0xFFF3FFFF;
    if ( v6 )
    {
    ...
    if ( v9 >= 0 )
    {
      ...
      {
        v9 = ObpAllocateAndQuerySecurityDescriptorInfo(v11, 64LL, &v25);
      }
      v13 = v23;
      if ( v9 < 0 )
        goto LABEL_20;
