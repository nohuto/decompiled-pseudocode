/*
 * XREFs of Normalization__IsNormalized @ 0x1406CE644
 * Callers:
 ...
 *     Normalization__CanCombineWithStartBase @ 0x1406CE288 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x1406CE2CC (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x1406CE3A4 (Normalization__GetLastChar.c)
 */
...
LABEL_19:
  ...
  v12 = *(_BYTE *)((v9 & 0x7F) + ((unsigned __int64)v11 << 7) + *(_QWORD *)(a1 + 40) - 128);
  if ( !v12 )
    goto LABEL_91;
  v13 = v12 & 0xC0;
  v24 = v12 & 0xC0;
