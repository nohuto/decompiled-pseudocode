/*
 * XREFs of EtwpValidatePayloadFilter @ 0x1406EB054
 * Callers:
            ...
            if ( v15 == v17 )
            {
              ...
              if ( v53 == v19 )
              {
                  ...
                  && (v15 & 3) == 0 )
                {
                  ...
                  v57 = (_WORD *)(a2 + (unsigned __int16)v56);
                            ...
                            while ( 1 )
                            {
                              ...
                              if ( v41 == 1 )
                              {
                                if ( *((_QWORD *)v30 + 1) != v63 || *((_QWORD *)v30 + 2) )
                                  return 3221225485LL;
                                v42 = v57;
                                v43 = a2 + (unsigned int)*(unsigned __int16 *)(a2 + 46) + v56;
                                v7 = v55;
                                if ( *v57 )
                                {
                                  do
...
LABEL_60:
                            ...
                            if ( *((_QWORD *)v30 + 1) != v24 || *((_QWORD *)v30 + 2) )
                              return 3221225485LL;
                            v45 = v58;
                            for ( i = a2 + (unsigned int)(v53 + v51); *v45; ++v45 )
                            {
