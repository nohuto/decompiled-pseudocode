/*
 * XREFs of ExpSetProcessorMicrocodeUpdateInformation @ 0x1406EF050
 * Callers:
 *     NtSetSystemInformation @ 0x140453DF8 (NtSetSystemInformation.c)
 * Callees:
 *     ExpMicrocodeInformationLoad_0 @ 0x1400012A8 (ExpMicrocodeInformationLoad_0.c)
 *     ExpMicrocodeInformationUnload_0 @ 0x1400012B0 (ExpMicrocodeInformationUnload_0.c)
 */
