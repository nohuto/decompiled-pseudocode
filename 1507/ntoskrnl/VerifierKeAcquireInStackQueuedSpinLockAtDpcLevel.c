/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockAtDpcLevel @ 0x1407477EC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierKeAcquireInStackQueuedSpinLockAtDpcLevel(KSPIN_LOCK *a1, struct _KLOCK_QUEUE_HANDLE *a2)
{
