/*
 * XREFs of LdrResSearchResource @ 0x14046391C
 * Callers:
 *     PspLocateInPEManifest @ 0x140463840 (PspLocateInPEManifest.c)
 *     LdrResFindResource @ 0x14058114C (LdrResFindResource.c)
 *     LdrResFindResourceDirectory @ 0x14058E5AC (LdrResFindResourceDirectory.c)
 ...
 *     KeHwPolicyLocateResource @ 0x1407DB7D4 (KeHwPolicyLocateResource.c)
 * Callees:
...
LABEL_56:
  if ( (v8 & 0x300) == 0 )
    return LdrpResSearchResourceMappedFile(v11, v15, v8, (__int64)v19, v9, (unsigned int **)v18, a6, a7, v17);
  v11 = a1;
