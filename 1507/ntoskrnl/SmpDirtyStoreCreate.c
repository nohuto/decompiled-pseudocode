/*
 * XREFs of SmpDirtyStoreCreate @ 0x1404F9E70
 * Callers:
...
__int64 __fastcall SmpDirtyStoreCreate(__int64 a1, unsigned int a2, int a3, _DWORD *a4)
{
  ...
  v9 = 0;
  if ( a3 )
    v10 = (dword_140352D28 & 0xC) == 8;
  else
    v10 = (dword_140352D28 & 3) == 2;
  LOBYTE(v9) = v10;
  v8 = v14[2] & 0xFFFEFF00 | ((dword_140352D28 & 0x10 | 0x40) << 12);
  ...
  if ( v12 >= 0x40000 )
    LODWORD(v12) = 0x40000;
  v14[5] = v12;
  result = SmProcessCreateRequest(a1, (ULONG64)v14, 88, 0);
  if ( (int)result >= 0 )
  {
    *a4 = v14[20];
    return 0LL;
