/*
 * XREFs of KsepDsEventDevicePowerIrp @ 0x14020CF34
 * Callers:
 *     KseDsCallbackHookIrpPowerFunction @ 0x14020C934 (KseDsCallbackHookIrpPowerFunction.c)
 * Callees:
...
char __fastcall KsepDsEventDevicePowerIrp(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  if ( KseEtwHandle )
  {
    ...
    if ( (_BYTE)v7 )
    {
      ...
      v24 = 4;
      v27 = 4;
      LOBYTE(v7) = EtwWrite(v8, &KseDsEventDevicePowerIrp, 0LL, 7u, &UserData);
    }
  }
  return (char)v7;
}
