/*
 * XREFs of ConstraintEval @ 0x140547464
 * Callers:
 ...
 *     SimplifyFilter @ 0x140547734 (SimplifyFilter.c)
 */
...
__int64 __fastcall ConstraintEval(unsigned int a1, _DWORD *a2, __int64 a3, int a4, __int64 a5)
{
  ...
  *v17 ^= 0x10000u;
  v34 = v35;
  v33 = 1;
  v13 = FilterEval((int)GetPropertyFromPropArray, (int)&v33, v6, v10, (__int64)&v31);
  if ( v13 < 0 )
    goto LABEL_28;
  if ( !v31 )
  {
