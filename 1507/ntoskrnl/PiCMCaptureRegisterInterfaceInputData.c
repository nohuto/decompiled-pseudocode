/*
 * XREFs of PiCMCaptureRegisterInterfaceInputData @ 0x140691880
 * Callers:
...
__int64 __fastcall PiCMCaptureRegisterInterfaceInputData(ULONG64 a1, unsigned int a2, int a3, char *a4)
{
