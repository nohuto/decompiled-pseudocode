/*
 * XREFs of MiFindEmptyAddressRangeInTree @ 0x140521520
 * Callers:
...
LABEL_28:
  ...
  while ( 1 )
  {
    ...
    if ( !i )
      break;
    v17 = v7 + (((unsigned __int64)*(unsigned __int8 *)(v14 + 33) << 32) | *(unsigned int *)(v14 + 28));
    if ( (v10 & (v17 - 1)) < v11 )
    {
    ...
    if ( v19 > v18 && v6 <= v19 - v18 && v6 <= v12 - v18 )
    {
      *a6 = v18 << 12;
      return 0LL;
    }
LABEL_15:
  ...
  if ( (char *)MmHighestUserAddress - 0x10000 <= (char *)0x7FFE0000 )
    v22 = (ULONG64)MmHighestUserAddress - 0xFFFF;
  else
    v22 = MmUserProbeAddress;
  v23 = v22 >> 12;
  if ( v12 < v23 )
    v23 = a5 >> 12;
  v24 = v10 & (v7 + (*(unsigned int *)(v14 + 28) | ((unsigned __int64)*(unsigned __int8 *)(v14 + 33) << 32)));
  if ( v23 > v24 && v6 <= v23 - v24 )
  {
    *a6 = v24 << 12;
    return 0LL;
  }
