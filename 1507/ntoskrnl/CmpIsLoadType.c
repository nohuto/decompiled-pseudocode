/*
 * XREFs of CmpIsLoadType @ 0x1407BB548
 * Callers:
...
char __fastcall CmpIsLoadType(__int64 BugCheckParameter3, __int64 a2, int a3, __int64 a4, __int64 a5, int a6)
{
  ...
  if ( a5 )
  {
    ...
    if ( NodeName )
    {
      ...
      {
        SubKeyByName = CmpFindSubKeyByName(BugCheckParameter3, a5, &DestinationString.Length);
        if ( SubKeyByName != -1 )
        {
    ...
    v24 = CmpFindSubKeyByName(BugCheckParameter3, a5, (unsigned __int16 *)v23);
    if ( v24 != -1 )
    {
