/*
 * XREFs of NtLockProductActivationKeys @ 0x1405AD7FC
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtLockProductActivationKeys(PULONG pPrivateVer, PULONG pSafeMode)
{
  ...
  KeyHandle = 0LL;
  *(_OWORD *)SourceString = xmmword_1402A0560;
  v31 = xmmword_1402A0570;
  v32 = xmmword_1402A0580;
  ...
  if ( KeGetCurrentThread()->PreviousMode )
  {
    if ( pPrivateVer )
    {
      ...
      *v20 = *v20;
      *pPrivateVer = *pPrivateVer >= 0x2BEA ? 0x7AA9 : 0;
    }
    if ( pSafeMode )
    {
      v21 = pSafeMode;
