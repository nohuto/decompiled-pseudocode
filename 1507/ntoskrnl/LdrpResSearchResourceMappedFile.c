...
LABEL_40:
  ...
  if ( (v15 & 0xA0000) != 0 || (v10 & 0x10) != 0 || !v36 || !PnPBootDriversInitialized )
    goto LABEL_39;
  v22 = 1;
  v31 = LdrLoadAlternateResourceModuleEx(v49, v36, &ullAugenda, (__int64 *)&v40, v15 | 0x1000u);
  MappingSize = v31;
  if ( v31 < 0 )
  {
...
LABEL_20:
  ...
  {
    v33 = v45 ? *v45 : v46;
    MappingSize = LdrpFindMessageInAlternateModule((void *)ullAugenda, *v43, v33, *(_DWORD *)(a4 + 24), 1);
    if ( MappingSize < 0 )
    {
      *v43 = 0LL;
