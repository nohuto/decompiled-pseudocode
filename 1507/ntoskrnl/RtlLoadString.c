/*
 * XREFs of RtlLoadString @ 0x1406CAE84
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  if ( a1 && a5 && (a4 & 0xFFFFFFFE) == 0 )
  {
    ...
    if ( v10 )
    {
      v13 = LdrResSearchResource((ULONGLONG)a1, v22, 4u, 1u, (__int64)&v18, &v17, a7, a8);
      if ( v13 >= 0 && v17 > 0xFFFF )
        v13 = -1073741701;
    }
    else
    {
      v13 = LdrpSearchResourceSection_U(a1, v22, 4u, 1, (__int64 *)&v20);
      if ( v13 < 0 )
        return (unsigned int)v13;
      v13 = LdrpAccessResourceData((unsigned __int64)a1, v20);
    }
    if ( v13 >= 0 && v18 )
    {
      v14 = 0;
