/*
 * XREFs of PopDiagTraceIdleCheck @ 0x1400D0710
 * Callers:
...
char __fastcall PopDiagTraceIdleCheck(__int64 a1, int a2, int a3)
{
  ...
  BOOL v8; // [rsp+48h] [rbp-39h] BYREF
  int v9; // [rsp+4Ch] [rbp-35h] BYREF
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    {
      v9 = 0;
      v6 = dword_14032E1A8 >= (unsigned int)dword_14032E1AC;
      UserData.Size = 4;
      UserData.Reserved = 0;
      v13 = 0;
      v16 = 0;
