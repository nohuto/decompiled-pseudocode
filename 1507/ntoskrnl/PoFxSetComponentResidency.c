/*
 * XREFs of PoFxSetComponentResidency @ 0x1401713A4
 * Callers:
 *     VerifierPoFxSetComponentResidency @ 0x1407423C8 (VerifierPoFxSetComponentResidency.c)
 * Callees:
...
__int64 __fastcall PoFxSetComponentResidency(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_COMPONENT_RESIDENCY) )
    {
      ...
      v17 = 8;
      v14 = 4;
      EtwWrite(v7, &POP_ETW_EVENT_COMPONENT_RESIDENCY, 0LL, 3u, &UserData);
    }
  }
