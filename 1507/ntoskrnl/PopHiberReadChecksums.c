/*
 * XREFs of PopHiberReadChecksums @ 0x1403F3B20
 * Callers:
...
void __fastcall PopHiberReadChecksums(ULONG_PTR BugCheckParameter3)
{
  ...
  if ( v1 )
  {
    ...
    for ( i = (2 * v6 + 4095) & 0xFFFFFFFFFFFFF000uLL; i; i -= v12 )
    {
      ...
      *(_WORD *)(v5 + 10) = 1;
      if ( (v12 + (v13 & 0xFFF) + 4095LL) >> 12 )
      {
        ...
        {
          ++v14;
          *(_QWORD *)(v5 + 8 * v2 + 48) = MmGetPhysicalAddress((PVOID)(*(_QWORD *)(BugCheckParameter3 + 144) + (v2 << 12))).QuadPart >> 12;
          v2 = v14;
        }
        while ( v14 < v15 );
        v1 = v23;
    ...
    *(_QWORD *)(BugCheckParameter3 + 424) = *(_QWORD *)(v4 + 128);
    v18 = __rdtsc();
    qword_14032ED40 += (((unsigned __int64)HIDWORD(v18) << 32) | (unsigned int)v18) - v22;
  }
}
