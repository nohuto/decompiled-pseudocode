/*
 * XREFs of SmcVolumePnpNotification @ 0x1406DC518
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
    ...
    {
      v7 = i | (16 * (*v5 & 0xFFF));
      v8.Count = SmcCacheReference((__int64)&unk_140352D68, v7).Count;
      Count = v8.Count;
      if ( v8.Count )
      {
        if ( *(_QWORD *)(v8.Count + 48) != NotificationStructure[3] )
          Count = 0LL;
        SmcCacheDereference((__int64)&unk_140352D68, v7);
        if ( Count )
          SmcCacheDelete((__int64)&unk_140352D68);
      }
      v5 += 8;
    }
  }
