/*
 * XREFs of CmpQueryKeyDataFromCache @ 0x1404F0520
 * Callers:
...
__int64 __fastcall CmpQueryKeyDataFromCache(__int64 a1, int a2, __int64 a3, unsigned int a4, _DWORD *a5, __int64 a6)
{
  ...
  _DWORD v18[7]; // [rsp+3Ch] [rbp-1Ch] BYREF
  ...
  if ( a2 == 4 )
  {
    ...
    {
      VisibleMaxNameLenAndClassLen = CmGetVisibleMaxValueNameLenAndDataLen(a1, 0, a6, (unsigned int)&v17, (__int64)v18);
      if ( VisibleMaxNameLenAndClassLen >= 0 )
      {
        *a5 = 40;
        if ( a4 < 0x28 )
