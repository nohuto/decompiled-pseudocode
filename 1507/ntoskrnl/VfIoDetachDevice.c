/*
 * XREFs of VfIoDetachDevice @ 0x140743140
 * Callers:
 *     IovDetachDevice @ 0x1407352B8 (IovDetachDevice.c)
 * Callees:
...
__int64 __fastcall VfIoDetachDevice(_QWORD *a1, const void *a2, __int64 a3)
{
  char pszDest[80]; // [rsp+30h] [rbp-68h] BYREF

  if ( !a1[3] )
  {
    ViErrorDisplayDescription(514LL, a2, a3);
