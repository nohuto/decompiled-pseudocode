/*
 * XREFs of CcReleaseByteRangeFromWrite @ 0x1400F1EC4
 * Callers:
...
void __fastcall CcReleaseByteRangeFromWrite(__int64 a1, _QWORD *a2, unsigned int a3, _WORD *a4, char a5)
{
  ...
  {
    if ( *a4 != 765 )
      KeBugCheckEx(0x34u, 0x1403uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
    v9 = v14;
    do
    {
      v10 = v5[2];
    ...
    if ( a3 )
    {
      do
      {
        if ( (v12 & 0xFFFFFFFFFE000000uLL) < ((v12 + v6 - 1LL) & 0xFFFFFFFFFE000000uLL) )
          ...
          v13 = v6;
        if ( v13 > 0x2000000 )
          KeBugCheckEx(0x34u, 0x13F0uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
