/*
 * XREFs of PopFxRemoveAcpiDevice @ 0x140238CF0
 * Callers:
...
void __fastcall PopFxRemoveAcpiDevice(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v10 = *(_QWORD *)(a2 + 176);
  v11 = *(_QWORD **)(a2 + 184);
  if ( *(_QWORD *)(v10 + 8) != a2 + 176 || *v11 != a2 + 176 )
    __fastfail(3u);
  *v11 = v10;
  *(_QWORD *)(v10 + 8) = v11;
