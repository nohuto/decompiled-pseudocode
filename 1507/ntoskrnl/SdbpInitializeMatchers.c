/*
 * XREFs of SdbpInitializeMatchers @ 0x140574450
 * Callers:
...
__int64 (__fastcall *__fastcall SdbpInitializeMatchers(__int64 a1))(int, int, int, int, int, __int64)
{
  __int64 v1; // rax
  bool v2; // zf
  __int64 (__fastcall *v3)(int, int, int, int, int); // rax
  __int64 (__fastcall *result)(int, int, int, int, int, __int64); // rax
