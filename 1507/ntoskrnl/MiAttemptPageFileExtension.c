/*
 * XREFs of MiAttemptPageFileExtension @ 0x1406A4E8C
 * Callers:
...
unsigned __int64 __fastcall MiAttemptPageFileExtension(__int64 a1, unsigned __int64 a2)
{
  ...
  unsigned __int64 FileInformation; // [rsp+30h] [rbp-58h] BYREF
  ULONG v12; // [rsp+38h] [rbp-50h] BYREF
  _QWORD v13[2]; // [rsp+40h] [rbp-48h] BYREF
  int v14; // [rsp+50h] [rbp-38h]
  int v15; // [rsp+54h] [rbp-34h]

  v4 = *(struct _KEVENT **)(a1 + 216);
  if ( *(_QWORD *)a1 != *(_QWORD *)(a1 + 8)
    && IoQueryVolumeInformation(*(PFILE_OBJECT *)(a1 + 64), FileFsSizeInformation, 0x18u, v13, &v12) >= 0 )
  {
    for ( i = 0x4000LL; ; i = 4096LL )
    {
      ...
      if ( v8 > v6 )
        v8 = v6;
      if ( (*(_BYTE *)(a1 + 164) & 0x10) != 0 && v8 < a2 )
        break;
      v9 = *(struct _FILE_OBJECT **)(a1 + 64);
