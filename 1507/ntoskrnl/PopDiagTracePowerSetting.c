/*
 * XREFs of PopDiagTracePowerSetting @ 0x1404E5768
 * Callers:
 *     PopTracePowerSettingChange @ 0x1404E5750 (PopTracePowerSettingChange.c)
...
char __fastcall PopDiagTracePowerSetting(char a1, ULONGLONG a2, int a3, __int64 a4)
{
  ...
  v22 = a3;
  v4 = (const EVENT_DESCRIPTOR *)&POP_ETW_EVENT_POWER_SETTING_RUNDOWN;
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v17 = a3;
      v20 = 4;
      LOBYTE(v5) = EtwWrite(v9, v4, 0LL, 4u, &UserData);
    }
  }
  return (char)v5;
}
