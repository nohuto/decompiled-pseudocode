/*
 * XREFs of CmpAllocatePostBlock @ 0x14042C258
 * Callers:
  ...
  if ( PoolWithQuotaTag )
  {
    ...
    if ( ((a2 | a1) & 0x10000) != 0 )
    {
      *((_QWORD *)PoolWithQuotaTag + 6) = 0LL;
      ...
      if ( (unsigned int)(a1 - 3) > 1 )
        v9 = 512;
      v10 = (struct _KEVENT *)ExAllocatePoolWithQuotaTag((POOL_TYPE)(v9 | 8), 0x70uLL, 0x34344D43u);
    ...
    else
    {
      *((_QWORD *)PoolWithQuotaTag + 8) = *(_QWORD *)(a4 + 64);
      v13 = ExAllocatePoolWithQuotaTag((POOL_TYPE)265, 0x18uLL, 0x35344D43u);
