/*
 * XREFs of BcpDisplayCriticalCharacter @ 0x14026EE94
 * Callers:
...
__int64 __fastcall BcpDisplayCriticalCharacter(unsigned __int16 a1, int a2)
{
  ...
  *(_DWORD *)(qword_140356660 + 8) = a2;
  result = BgpDisplayCharacterEx(a1, (__int64 *)qword_140356660, v6, v5, *(_DWORD *)(v2 + 40), -1, &v10, &v11, v8);
  if ( (int)result >= 0 )
  {
    if ( v3 < v4 + v11 )
      v3 = v4 + v11;
