/*
 * XREFs of MmGetPageFileInformation @ 0x140556774
 * Callers:
...
__int64 __fastcall MmGetPageFileInformation(__int64 a1, unsigned int a2, int a3, unsigned int *a4)
{
  ...
  *(_DWORD *)(a1 + 4) = 0;
  ...
  while ( v10 < v9 )
  {
    v13 = *(int **)&MiSystemPartition[4 * v10 + 2672];
    v14 = *((_BYTE *)v13 + 164);
    if ( (v14 & 0x10) == 0 && (v14 & 0x40) == 0 )
    {
      ...
      *(_DWORD *)(v12 + 12) = v18;
      ...
      WORD3(v22) = 0;
      LOWORD(v22) = *(_WORD *)(*(_QWORD *)&MiSystemPartition[4 * v10 + 2672] + 112LL);
      ...
      *(_OWORD *)(v12 + 16) = v22;
      ...
      memmove(
        (void *)(v12 + v8),
        *(const void **)(*(_QWORD *)&MiSystemPartition[4 * v10 + 2672] + 120LL),
