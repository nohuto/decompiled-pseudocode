/*
 * XREFs of IoWriteDeferredLiveDumpData @ 0x1406771E4
 * Callers:
...
__int64 __fastcall IoWriteDeferredLiveDumpData(__int64 P)
{
  ...
  if ( stru_140320EC0.LevelPlus1 > 5 && TlgKeywordOn(&stru_140320EC0, 0x400000000000uLL) )
  {
    ...
    v12 = &v6;
    v13 = 8;
    TlgWrite(&stru_140320EC0, &unk_1402A3E09, (LPCGUID)(P + 608), (LPCGUID)(P + 592), 4u, &pData);
  }
  EtwActivityIdControl(2u, (LPGUID)(P + 592));
