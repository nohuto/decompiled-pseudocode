/*
 * XREFs of MmCreatePeb @ 0x140465AC4
 * Callers:
...
__int64 __fastcall MmCreatePeb(_KPROCESS *a1, char *a2, __int64 *a3, _QWORD *a4)
{
  ...
  _BYTE v61[48]; // [rsp+160h] [rbp-78h] BYREF
  ...
  *a4 = 0LL;
  ...
  v26 = v6;
  *((_WORD *)a4 + 4) = v6;
  KiStackAttachProcess(a1, 0, (__int64)v61);
  ...
  if ( PebOrTeb < 0 )
    goto LABEL_27;
  PebOrTeb = MiCreatePebOrTeb((__int64)a1, 0LL, 0x388u, (unsigned __int64 *)&v27);
  if ( PebOrTeb < 0 )
    goto LABEL_27;
  ...
  v40 = NtGlobalFlag;
  v43 = qword_14034EB40;
  v45 = (unsigned int)dword_1403D0104;
  v46 = qword_1403D0118;
  v47 = qword_1403D0110;
  v48 = *a2;
  v49 = a2[3];
  ...
  {
    v21 = _InterlockedExchangeAdd(&dword_14034EB38, 1u) + 1;
    do
    {
      v22 = v21 & 0x3F;
      v23 = 1LL << v22;
  ...
  *(_QWORD *)(v10 + 192) = qword_14034EB40;
  *(_QWORD *)(v10 + 792) = (unsigned int)dword_1403D0104;
  *(_QWORD *)(v10 + 240) = v44;
  *(_QWORD *)(v10 + 216) = qword_1403D0118;
  *(_QWORD *)(v10 + 224) = qword_1403D0110;
  *(_DWORD *)(v10 + 236) = 399;
  ...
  *(_QWORD *)(v10 + 176) = v54;
  ...
  {
LABEL_27:
    KiUnstackDetachProcess((struct _KTHREAD *)v61, 0);
