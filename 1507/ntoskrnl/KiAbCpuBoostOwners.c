/*
 * XREFs of KiAbCpuBoostOwners @ 0x140122E4C
 * Callers:
...
_QWORD *__fastcall KiAbCpuBoostOwners(__int64 a1, char a2, __int64 a3, __int64 a4, __int64 a5)
{
  _QWORD *result; // rax
  ...
  {
    KiAbSetMinimumThreadPriority(v6, &v14, a3, a4, v8);
    v12 = *(_QWORD **)(v6 + 8);
    result = (_QWORD *)v6;
    *(_BYTE *)(v6 + 48) = a2;
    if ( v12 )
  ...
  if ( (*(_BYTE *)(a1 + 25) & 1) == 0 )
    return (_QWORD *)KiAbSetMinimumThreadPriority(a1, &v14, a3, a4, v8);
  return result;
}
