/*
 * XREFs of RtlpCallQueryRegistryRoutine @ 0x1404AA8D8
 * Callers:
        ...
        char a7)
{
  ...
  *a4 = 0;
  ...
  if ( !v12 || (v15 = a3[2], v15 == -1) || (v16 = a3[3]) == 0 && v12 == v10 )
  {
    if ( !v10 )
    {
      v28 = (*(_BYTE *)(a2 + 8) & 4) != 0;
...
LABEL_7:
  ...
  if ( (*(_DWORD *)(a2 + 8) & 0x20) != 0 )
  {
    ...
    else if ( (v20 & 0x80u) != 0LL && (v10 - 1 <= 1 || v10 == 7) )
    {
      v28 = (v20 & 4) != 0;
      return v28 ? 0xC0000034 : 0;
    }
  ...
  if ( v10 == 7 )
  {
    ...
    if ( v18 < v32 )
    {
      do
      {
        ...
        {
          if ( a7 )
            RtlpValidateKeyTrust(a1, v34, 0LL);
  ...
  if ( v10 != 2 || (v38 = v19 - 2, v19 - 2 > 0xFFFA) || (v39 = v18, v19 == 2) )
  {
LABEL_13:
    if ( (_DWORD)v21 )
    {
      if ( a7 )
        RtlpValidateKeyTrust(a1, v20, v21);
