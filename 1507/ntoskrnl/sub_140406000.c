/*
 * XREFs of sub_140406000 @ 0x140406000
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall sub_140406000(PKDPC Dpc)
{
  _QWORD *v1; // r9
  ...
  if ( v13 != Dpc[2].DeferredRoutine )
  {
    ...
    v23 = 0x5891C8B4E8A3CAB9LL;
    CcAdjustBcbDepth(
      (unsigned int)__ROR4__(8480, 133),
