/*
 * XREFs of ExpAcquireSpinLockSharedAtDpcLevelInstrumented @ 0x140264154
 * Callers:
...
char __fastcall ExpAcquireSpinLockSharedAtDpcLevelInstrumented(_DWORD *a1)
{
  ...
  _m_prefetchw(a1);
  v9 = *a1 & 0x7FFFFFFF;
  v8 = _InterlockedCompareExchange(a1, v9 + 1, v9);
  if ( v9 != v8 )
  {
    v8 = ExpWaitForSpinLockSharedAndAcquire(a1);
  ...
  {
    v10 = __rdtsc();
    LOBYTE(v8) = PerfLogSpinLockAcquire((__int64)a1, v10, v10 - v7, v2, InterruptCount, 2);
  }
  return v8;
}
