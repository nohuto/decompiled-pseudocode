/*
 * XREFs of ExpInsertPoolTracker @ 0x140149414
 * Callers:
...
void __fastcall ExpInsertPoolTracker(int a1, unsigned __int64 a2, unsigned int a3, int a4)
{
  unsigned int v5; // esi
  __int64 v7; // rax
  int v8; // r13d
  ...
  if ( (BYTE4(PerfGlobalGroupMask) & 0x41) != 0 )
    v7 = EtwTracePool(3616, a3, v5, a4, a2);
  if ( (a3 & 0x20) != 0 )
  {
  ...
  v15 = v9;
  v11 = v8 & ((40543 * v5) ^ ((40543 * (unsigned __int64)v5) >> 32));
  v12 = v11;
  while ( 1 )
  {
...
LABEL_10:
      ...
      if ( v11 == v12 )
      {
        ExpInsertPoolTrackerExpansion(v5, a2, a3);
        return;
      }
    }
    else
    {
      if ( (a3 & 0x20) == 0 )
      {
        ...
        v12 = v8 & ((40543 * v5) ^ ((40543 * (unsigned __int64)v5) >> 32));
      }
      if ( v11 == v9 - 1 )
        goto LABEL_10;
      if ( (a3 & 0x20) != 0 )
      {
        _InterlockedCompareExchange((volatile signed __int32 *)(v10 + 40LL * v11), v5, 0);
      }
      else
      {
        ...
        {
          *(_DWORD *)(PoolTrackTable + 40LL * v11) = v5;
          *(_DWORD *)(v10 + 40LL * v11) = v5;
        }
