/*
 * XREFs of KxInitializeProcessorState @ 0x14059A9C8
 * Callers:
        ...
        __int64 a13)
{
  ...
  *(_QWORD *)(a3 + 25624) = a13;
  *(_QWORD *)(v24 + 4) = a11;
  v28 = (__int64 *)(0x140000000LL + 8LL * a6 + 4080704);
  v29 = (_OWORD *)((char *)&KiNodeInit + 256 * (unsigned __int64)a6);
  v30 = *v28;
  if ( (_OWORD *)*v28 == v29 )
  {
    v30 = v27 + 1984;
  ...
  if ( (*(_BYTE *)(v30 + 173) & 4) == 0 )
    KiCommitNodeAssignment(v30);
