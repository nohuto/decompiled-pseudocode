/*
 * XREFs of PoFxSetComponentLatency @ 0x14017154C
 * Callers:
 *     VerifierPoFxSetComponentLatency @ 0x1407423C0 (VerifierPoFxSetComponentLatency.c)
 * Callees:
...
__int64 __fastcall PoFxSetComponentLatency(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_COMPONENT_LATENCY) )
    {
      ...
      v17 = 8;
      v14 = 4;
      EtwWrite(v7, &POP_ETW_EVENT_COMPONENT_LATENCY, 0LL, 3u, &UserData);
    }
  }
