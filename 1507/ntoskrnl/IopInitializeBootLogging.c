/*
 * XREFs of IopInitializeBootLogging @ 0x140671954
 * Callers:
  ...
  if ( !qword_14077E018 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( RtlFindMessage(*(PVOID *)(v6 + 48), 0xBu, 0, 0xB5u, &MessageResourceEntry) >= 0 )
      {
        ...
        RtlAnsiStringToUnicodeString(qword_14077E018, &SourceString, 1u);
        if ( qword_14077E018->Length > 4u )
        {
          v9 = (unsigned __int16)(qword_14077E018->Length - 4);
          Buffer = qword_14077E018->Buffer;
          qword_14077E018->Length = v9;
          Buffer[v9 >> 1] = 0;
        }
      }
      ...
      else
      {
        ...
        RtlAnsiStringToUnicodeString(qword_14077E018 + 1, &SourceString, 1u);
        v11 = qword_14077E018;
        Length = qword_14077E018[1].Length;
        if ( Length > 4u )
        {
          v13 = (unsigned __int16)(Length - 4);
          v14 = qword_14077E018[1].Buffer;
          qword_14077E018[1].Length = v13;
          v14[v13 >> 1] = 0;
        }
      }
