/*
 * XREFs of ?strtoxq@@YA_KPEAUlocaleinfo_struct@@PEBDPEAPEBDHH@Z @ 0x1401720D4
 * Callers:
 *     _strtoi64 @ 0x140172304 (_strtoi64.c)
 *     _strtoui64 @ 0x140172328 (_strtoui64.c)
 * Callees:
 *     PopPoCoalescinCallback @ 0x140139F40 (PopPoCoalescinCallback.c)
 *     __pctype_func @ 0x140175B88 (__pctype_func.c)
 */

unsigned __int64 __fastcall strtoxq(struct localeinfo_struct *a1, const char *a2, const char **a3, int a4, int a5)
{
  int v5; // r14d
  int v8; // ebp
  const char *v9; // rdi
