/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x140150614
 * Callers:
...
LABEL_15:
  ...
  if ( (int)result >= 0 )
  {
    ...
    v28 = 1;
LABEL_25:
    v13 = ((__int64 (__fastcall *)(unsigned __int64 *, _DWORD *, _QWORD))qword_140323CA0)(&v27, a2, 0LL);
    if ( v24 && v24 != v33 )
