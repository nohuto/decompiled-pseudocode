/*
 * XREFs of KxContextToKframes @ 0x140020C1C
 * Callers:
...
char __fastcall KxContextToKframes(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  if ( (a4 & 0x100010) == 0x100010 )
  {
    ...
    {
      v15 = 0LL;
      if ( v14 <= (unsigned __int64)MmHighestUserAddress )
        v15 = *(_QWORD *)(a3 + 72);
      v14 = v15;
    }
    *(_QWORD *)(a1 + 216) = v14;
    ...
    *(_QWORD *)(a1 + 224) = v16;
    ...
    {
      v19 = 0LL;
      if ( v18 <= (unsigned __int64)MmHighestUserAddress )
        v19 = *(_QWORD *)(a3 + 88);
      v18 = v19;
    }
    *(_QWORD *)(a1 + 232) = v18;
    ...
    {
      v21 = 0LL;
      if ( v20 <= (unsigned __int64)MmHighestUserAddress )
        v21 = *(_QWORD *)(a3 + 96);
      v20 = v21;
    }
    *(_QWORD *)(a1 + 248) = 0LL;
