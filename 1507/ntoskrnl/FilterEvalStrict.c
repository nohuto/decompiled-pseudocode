/*
 * XREFs of FilterEvalStrict @ 0x14043F314
 * Callers:
 ...
 *     FindFilterOperatorClose @ 0x14043F9F0 (FindFilterOperatorClose.c)
 */
...
LABEL_13:
  ...
  {
    result = a1(a2, v12 + 2, &v24, &v23, &v28);
    v8 = result;
    if ( (_DWORD)result == -1073741275 )
      return 3221225473LL;
    if ( !(_DWORD)result )
    {
      PropertyEval(v24, v28, v23, *v12, v12[10], *((_QWORD *)v12 + 6), v12[11], a5);
      v12 += 14;
      --v13;
LABEL_50:
      *a5 = *a5 == 0;
