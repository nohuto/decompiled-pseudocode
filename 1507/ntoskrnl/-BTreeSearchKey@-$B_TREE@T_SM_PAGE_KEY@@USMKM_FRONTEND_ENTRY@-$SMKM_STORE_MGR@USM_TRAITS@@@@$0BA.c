/*
 * XREFs of ?BTreeSearchKey@?$B_TREE@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@$0BAAA@UB_TREE_DUMMY_NODE_POOL@@@@SAJPEAU1@T_SM_PAGE_KEY@@PEAUSEARCH_RESULT@1@@Z @ 0x14013F74C
 * Callers:
...
__int64 __fastcall B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeSearchKey(
        __int64 *a1,
        __int64 a2,
        __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    else if ( (unsigned __int16)*(_DWORD *)v11 )
    {
      do
      {
        if ( (unsigned int)a2 < *(_DWORD *)(v11 + 16LL * ((v14 + v13) >> 1) + 16) )
          v14 = (v14 + v13) >> 1;
        else
          v13 = (v14 + v13) >> 1;
      }
