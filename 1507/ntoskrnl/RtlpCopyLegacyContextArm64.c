/*
 * XREFs of RtlpCopyLegacyContextArm64 @ 0x14024B164
 * Callers:
 *     RtlpCopyLegacyContext @ 0x14002065C (RtlpCopyLegacyContext.c)
 * Callees:
 *     <none>
 */
  ...
  *(_DWORD *)a2 = a3 & 0x67FFFFFF;
  if ( a1 )
  {
    ...
    if ( (a3 & 0x400002) == 0x400002 )
    {
      ...
      *(_OWORD *)(a2 + 152) = *(_OWORD *)(a4 + 152);
      *(_OWORD *)(a2 + 168) = *(_OWORD *)(a4 + 168);
      *(_OWORD *)(a2 + 184) = *(_OWORD *)(a4 + 184);
      *(_OWORD *)(a2 + 200) = *(_OWORD *)(a4 + 200);
      *(_OWORD *)(a2 + 216) = *(_OWORD *)(a4 + 216);
      *(_QWORD *)(a2 + 232) = *(_QWORD *)(a4 + 232);
