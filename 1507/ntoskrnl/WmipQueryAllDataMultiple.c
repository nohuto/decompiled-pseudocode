/*
 * XREFs of WmipQueryAllDataMultiple @ 0x1406E0ABC
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  void *v38; // [rsp+58h] [rbp-D0h]
  _BYTE *v39; // [rsp+60h] [rbp-C8h]
  IRP *v40; // [rsp+68h] [rbp-C0h]
  _DWORD *v41; // [rsp+70h] [rbp-B8h]
  __int64 v42; // [rsp+78h] [rbp-B0h]
  signed __int64 v43; // [rsp+80h] [rbp-A8h]
  ...
  do
  {
    ...
    *(_DWORD *)v20 = 48;
    ...
    {
      *((_QWORD *)v20 + 2) = *(void **)((char *)v24 + v43);
      v27 = v38;
    }
    if ( (int)WmipQueryAllData(v27, v40, a4, (unsigned int *)v20, v25, (unsigned int *)&v34) < 0 )
      goto LABEL_23;
    v28 = *((_DWORD *)v20 + 11);
    if ( (v28 & 0x100) != 0 )
      goto LABEL_23;
