/*
 * XREFs of PopNotifyDevice @ 0x1403EEB1C
 * Callers:
...
void __fastcall PopNotifyDevice(__int64 a1, __int64 a2)
{
  ...
  v7 = PopMapInternalActionToIrpAction(qword_14032E1E8, *(_DWORD *)(a1 + 4), v4);
  if ( v7 == 7 && *v6 == *(_QWORD *)(a2 + 64) && *(_BYTE *)a1 == 2 )
    *v6 = 0LL;
  v8 = *(_DWORD *)(a1 + 4);
  PopAllocateIrp(*(PDEVICE_OBJECT *)(a2 + 48), v5, *(_BYTE *)a1, 0, v8, 1, 0, 0LL, 0LL, &Irp, &v14);
  v9 = v14;
  v10 = Irp;
  *(_QWORD *)(v14 + 216) = a2;
  *(_BYTE *)(v9 + 224) = 0;
