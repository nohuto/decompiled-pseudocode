/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x14059C47C
 * Callers:
 *     PnpFindBestConfiguration @ 0x14059C42C (PnpFindBestConfiguration.c)
 * Callees:
 *     IopSaveRestoreConfiguration @ 0x14058CD4C (IopSaveRestoreConfiguration.c)
 *     IopRetestConfiguration @ 0x14058E858 (IopRetestConfiguration.c)
 *     IopSelectNextConfiguration @ 0x14059BDC4 (IopSelectNextConfiguration.c)
 *     IopTestConfiguration @ 0x14059C600 (IopTestConfiguration.c)
