/*
 * XREFs of KiVerifyPdata @ 0x1407DA35C
 * Callers:
...
__int64 __fastcall KiVerifyPdata(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( BugCheckParameter2 < *(&xmmword_14031EF70 + 1)
    || BugCheckParameter2 >= *(&xmmword_14031EF70 + 1) + (unsigned int)qword_14031EF80 )
  {
    v2 = (unsigned int *)RtlpxLookupFunctionTable(BugCheckParameter2, &v7);
  }
  else
  {
    v2 = (unsigned int *)xmmword_14031EF70;
    BugCheckParameter3 = qword_14031EF80;
  }
  result = v9;
  if ( v2 )
  {
