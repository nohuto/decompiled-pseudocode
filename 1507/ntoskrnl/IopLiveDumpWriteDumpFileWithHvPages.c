 ...
 *     IopLiveDumpGetHvMergePages @ 0x140677DCC (IopLiveDumpGetHvMergePages.c)
...
__int64 __fastcall IopLiveDumpWriteDumpFileWithHvPages(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 512) = 0LL;
  *(_QWORD *)(a1 + 520) = 0LL;
  IopLiveDumpGetNtMergePages(a1, (__int64)v48, &v33, &v31, &v36);
  v5 = (__int64 *)v48;
...
LABEL_14:
    ...
    {
      v15 = v35;
      ExFreePoolWithTag(*(PVOID *)(*(_QWORD *)(a1 + 536) + 8 * v35), 0x706D644Cu);
      *(_QWORD *)(*(_QWORD *)(a1 + 536) + 8 * v15) = 0LL;
      CurrentThread = v40;
      v27 = 0;
    }
  }
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        RtlMergeBitMapsEx((unsigned __int64 *)(a1 + 368), (unsigned __int64 *)(a1 + 424));
...
LABEL_35:
  IopLiveDumpFreeDumpBuffers(a1 + 472);
