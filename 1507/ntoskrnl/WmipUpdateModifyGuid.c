/*
 * XREFs of WmipUpdateModifyGuid @ 0x1406E226C
 * Callers:
 ...
 *     WmipIsEqualInstanceSets @ 0x1406E1D9C (WmipIsEqualInstanceSets.c)
        ...
        volatile signed __int64 **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( ISInDSByGuid )
  {
    ...
    {
      v22 = *(_OWORD *)ISInDSByGuid;
      v25 = *((_OWORD *)ISInDSByGuid + 1);
      v24 = *((_OWORD *)ISInDSByGuid + 2);
      v21 = *((_OWORD *)ISInDSByGuid + 3);
      v23 = *((_OWORD *)ISInDSByGuid + 4);
      ...
      *(_QWORD *)(v14 + 8) = v15;
      ...
      if ( v16 < 0 )
      {
        ...
        *(_OWORD *)ISInDSByGuid = v22;
        *((_OWORD *)ISInDSByGuid + 1) = v25;
        *((_OWORD *)ISInDSByGuid + 2) = v24;
        *((_OWORD *)ISInDSByGuid + 3) = v21;
        *((_OWORD *)ISInDSByGuid + 4) = v23;
        *((_OWORD *)ISInDSByGuid + 5) = v13;
      }
      v18 = (volatile signed __int64 *)(*((_QWORD *)ISInDSByGuid + 7) + 56LL);
      v19 = *v18;
      *ISInDSByGuid = *v18;
      *((_QWORD *)ISInDSByGuid + 1) = v18;
      if ( *(volatile signed __int64 **)(v19 + 8) != v18 )
        __fastfail(3u);
      *(_QWORD *)(v19 + 8) = ISInDSByGuid;
      *v18 = (volatile signed __int64)ISInDSByGuid;
      if ( v16 >= 0 )
      {
        if ( *((_QWORD *)&v13 + 1) )
