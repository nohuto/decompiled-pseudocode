/*
 * XREFs of sub_1406FF424 @ 0x1406FF424
 * Callers:
...
__int64 __fastcall sub_1406FF424(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  unsigned int *v4; // r8
  PVOID v7; // r13
  signed int v8; // ebx
...
LABEL_93:
  ...
  if ( qword_14077E3A8 )
  {
    ...
    v88 = v44;
    v15 = (void *)pcbLength;
    v55 = qword_14077E3A8(v95, pcbLength, v38, v37, v45, v88, v54, v51, &v89);
  }
  else
  {
    v15 = (void *)pcbLength;
