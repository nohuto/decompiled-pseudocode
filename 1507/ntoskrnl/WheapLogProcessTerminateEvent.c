/*
 * XREFs of WheapLogProcessTerminateEvent @ 0x140267774
 * Callers:
...
NTSTATUS __fastcall WheapLogProcessTerminateEvent(int a1, __int64 a2, int a3)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  v10 = 2LL;
  return EtwWrite((REGHANDLE)WheapDispatchPtr.NextDevice, &EVENT_WHEA_PROCESS_TERMINATE, 0LL, 3u, &UserData);
}
