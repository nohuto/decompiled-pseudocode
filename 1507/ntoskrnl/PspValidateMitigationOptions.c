/*
 * XREFs of PspValidateMitigationOptions @ 0x140553B58
 * Callers:
...
__int64 __fastcall PspValidateMitigationOptions(__int64 a1, __int64 a2)
{
  ...
  result = 3221225485LL;
  if ( (a1 & 0x30000000000LL) != 0x30000000000LL && (a1 & 0x300000000000LL) != 0x300000000000LL )
    return 0LL;
  return result;
}
