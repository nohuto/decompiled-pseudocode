/*
 * XREFs of PiCreateDriverSwDeviceCallback @ 0x1406968A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiCreateDriverSwDeviceCallback(__int64 *a1, char *a2, const WCHAR *a3, __int64 *a4)
{
  __int64 *v4; // rdi
  ULONG v5; // r15d
  wchar_t *v6; // r14
  ...
  *(_DWORD *)((char *)&v61.Buffer + 2) = 0;
  ...
  if ( a1 )
    ...
    v10 = 0LL;
  RegistryValues = SysCtxRegOpenKey(v10, a2, a3, 0, 0x20019u, &Handle);
  if ( RegistryValues < 0 )
    goto LABEL_133;
...
LABEL_90:
    v28 = v66;
    for ( i = PnpGetGenericStorePropertyKeys(v66, Handle, 0LL, 0LL);
          ;
