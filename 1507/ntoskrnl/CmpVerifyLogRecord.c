/*
 * XREFs of CmpVerifyLogRecord @ 0x14065D6C8
 * Callers:
 *     CmpRmReDoPhase @ 0x14065D354 (CmpRmReDoPhase.c)
 * Callees:
 *     HvBufferCheckSum @ 0x1404F2724 (HvBufferCheckSum.c)
 *     CmpVerifyCreateOrDeleteKeyLogRecord @ 0x14065D668 (CmpVerifyCreateOrDeleteKeyLogRecord.c)
 *     CmpVerifyRenameKeyLogRecord @ 0x14065D788 (CmpVerifyRenameKeyLogRecord.c)
 *     CmpVerifySetOrDeleteValueLogRecord @ 0x14065D7D0 (CmpVerifySetOrDeleteValueLogRecord.c)
 *     CmpVerifySetSecurityDescriptorLogRecord @ 0x14065D838 (CmpVerifySetSecurityDescriptorLogRecord.c)
 */
