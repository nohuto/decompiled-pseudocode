/*
 * XREFs of MxComputeFreeNodeDescriptorRequirements @ 0x1407C6010
 * Callers:
 ...
 *     MxComputePfnPagesNeeded @ 0x1407C6188 (MxComputePfnPagesNeeded.c)
 */
...
__int64 __fastcall MxComputeFreeNodeDescriptorRequirements(__int64 a1, void *a2)
{
  ...
  if ( v7 != (__int64 *)(a1 + 32) )
  {
    ...
    {
      v8 = *((int *)v7 + 4);
      if ( (unsigned int)v8 > 0x20 || (v9 = 0x1C0C00048LL, !_bittest64(&v9, v8)) )
      {
        v10 = v7[4];
        v11 = v7[3];
        if ( v10 )
