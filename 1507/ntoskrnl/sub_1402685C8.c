/*
 * XREFs of sub_1402685C8 @ 0x1402685C8
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsQueryThreadTerminationPort @ 0x140406224 (PsQueryThreadTerminationPort.c)
 *     KeRundownApcQueues @ 0x140421134 (KeRundownApcQueues.c)
 */

void __fastcall __noreturn sub_1402685C8(__int64 a1)
{
