/*
 * XREFs of _CmGetInstallerClassMappedPropertyKeys @ 0x14071842C
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  const WCHAR *v36; // [rsp+98h] [rbp+10h]
...
LABEL_19:
  ...
  while ( 2 )
  {
    ...
    if ( !a4 )
    {
      result = CmGetInstallerClassMappedPropertyFromRegValue(v35, (__int64)v36, v37, *v18, v34, 0LL, 0, (int *)&a7);
      if ( (_DWORD)result == -1073741789 || !(_DWORD)result )
      {
        v20 = 1;
      }
