/*
 * XREFs of ?SmStEtwFillStoreStatsEvent@?$SMKM_STORE@USM_TRAITS@@@@SAKPEAU1@PEAU_SMKM_EVENT_DESCRIPTOR@@@Z @ 0x140259618
 * Callers:
 *     SmKmEtwLogStoreStats @ 0x1406DC848 (SmKmEtwLogStoreStats.c)
 * Callees:
 *     StLcBucketsCopy @ 0x1400DA448 (StLcBucketsCopy.c)
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStEtwFillStoreStatsEvent(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 1160) )
  {
    ...
    *v10 = v9;
    ...
    ++*(_DWORD *)(a2 + 16);
    *(_DWORD *)(a2 + 24) += 1348;
    ST_STORE<SM_TRAITS>::StCopyIoStats(v9, a1 + 2760);
    StLcBucketsCopy(v9 + 321, v11, *(_QWORD **)(a1 + 4080), *(_DWORD *)(a1 + 4072));
    return 1;
  }
  return v2;
}
