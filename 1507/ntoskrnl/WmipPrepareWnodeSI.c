/*
 * XREFs of WmipPrepareWnodeSI @ 0x14057AFF4
 * Callers:
 ...
 *     WmipIsNumber @ 0x14057C64C (WmipIsNumber.c)
 */
...
__int64 __fastcall WmipPrepareWnodeSI(__int64 a1, __int64 a2, unsigned int *a3, void **a4, _BYTE *a5, _BYTE *a6)
{
  ...
  void *v32; // [rsp+48h] [rbp-41h] BYREF
            ...
            do
            {
              ...
              if ( (v15 & 0x89000) == 0 )
              {
                ...
                else
                {
                  ...
                  v11 = WmipAddProviderIdToPIList((const void **)&v32, &v30, &v33, v31, v14);
                  LOBYTE(v8) = v11 < 0;
                }
              }
LABEL_12:
