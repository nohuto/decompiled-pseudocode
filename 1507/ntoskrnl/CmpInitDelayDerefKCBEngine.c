/*
 * XREFs of CmpInitDelayDerefKCBEngine @ 0x1405A27F8
 * Callers:
...
__int64 CmpInitDelayDerefKCBEngine()
{
  ...
  qword_14034D9B8 = (__int64)&CmpDelayDerefKCBListHead;
  ...
  qword_14034DA10 = (__int64)CmpDelayDerefKCBWorker;
  if ( !qword_14034E410 )
  {
    v0 = __rdtsc();
    ...
    v9 = 4 * xmmword_1403D17D0;
    v10 = KeServiceDescriptorTable + (unsigned int)(4 * xmmword_1403D17D0);
    qword_14034E428 = v5;
