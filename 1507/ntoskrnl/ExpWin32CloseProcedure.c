/*
 * XREFs of ExpWin32CloseProcedure @ 0x140421738
 * Callers:
 *     <none>
 * Callees:
...
POBJECT_TYPE *__fastcall ExpWin32CloseProcedure(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  {
    v6 = 29LL;
    return (POBJECT_TYPE *)PsInvokeWin32Callout(v6, v7, 1LL);
  }
