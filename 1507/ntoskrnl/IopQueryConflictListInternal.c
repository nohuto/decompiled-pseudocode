/*
 * XREFs of IopQueryConflictListInternal @ 0x140697A64
 * Callers:
 ...
 *     IopQueryConflictFillConflicts @ 0x1406974A8 (IopQueryConflictFillConflicts.c)
 */
...
LABEL_14:
  ...
  *(_DWORD *)(a2 + 4) = v12;
  ...
  if ( v13 == -1 && (!v10 || (v13 = *(_DWORD *)(v10 + 8), v13 == -1)) )
    ...
    *(_DWORD *)(a2 + 8) = v13;
  v14 = PnpCmResourcesToIoResources(v10, (_DWORD *)a2, 0);
  if ( !v14 )
    return (unsigned int)-1073741811;
