/*
 * XREFs of BcpDisplayErrorInformation @ 0x14026F254
 * Callers:
 ...
 *     BcpSanitizeDriverName @ 0x14026F818 (BcpSanitizeDriverName.c)
        ...
        char a6)
{
  ...
  v9 = a3;
  v10 = (int *)((char *)&unk_14031E760 + 56 * a1);
  v11 = v10[3] + v10[7];
  v12 = *v10;
  HIDWORD(BcpCursor) = v10[10] + dword_140386298;
  LODWORD(BcpCursor) = v11;
  BcpDisplayCriticalString((__int16 *)&stru_1403565D0, v12, (unsigned int)a3, a1);
...
LABEL_18:
    if ( BcpDisplayParameters != (_BYTE)v15 || (a6 & 8) != 0 && a2 == 317 )
    {
      ...
      v15 = 0;
      LODWORD(BcpCursor) = 0;
      HIDWORD(BcpCursor) = dword_140386298;
    }
    ++v18;
    v19 += 8;
    ++v9;
