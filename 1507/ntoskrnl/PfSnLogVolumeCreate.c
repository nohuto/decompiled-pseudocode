/*
 * XREFs of PfSnLogVolumeCreate @ 0x14054C294
 * Callers:
...
__int64 __fastcall PfSnLogVolumeCreate(__int64 a1)
{
  ...
  v4 = 0;
  v5 = PfSnLogHelper(*(_QWORD *)a1, v3, &v13);
  if ( v5 )
  {
    v6 = v13;
    DestinationString.Length = 0;
    DestinationString.MaximumLength = v2;
    *v13 = (8LL * (unsigned int)(v3 - 1)) | 5;
    v6[1] = *(_QWORD *)(a1 + 8);
    ...
    *(_WORD *)(v7 + 2LL * *(unsigned __int16 *)(a1 + 30) + 56) = 0;
    _m_prefetchw(&v5[45]);
    v9 = v5[45].Count & 0xFFFFFFFFFFFFFFFEuLL;
    if ( v9 != _InterlockedCompareExchange64((volatile signed __int64 *)&v5[45], v9 - 2, v9) )
      ExfReleaseRundownProtection(v5 + 45);
  }
  else
  {
