/*
 * XREFs of GxpReadFrameBufferPixels @ 0x14075CDC4
 * Callers:
...
__int64 __fastcall GxpReadFrameBufferPixels(int *a1)
{
  ...
  if ( (_BYTE)BgInternal )
  {
    ...
    v13 = (char *)qword_140323CA0 + v11 * ((_DWORD)v6 * v9 + *v4);
  ...
  {
    v18 = xmmword_140323C90;
    v20 = *((_QWORD *)a1 + 3);
    HIDWORD(v17) = v7;
    LOBYTE(v7) = 1;
    LODWORD(v17) = v8;
    v19 = v10;
    return (unsigned int)((__int64 (__fastcall *)(__int64 *, _DWORD *, __int64, __int64))qword_140323CA0)(
                           &v17,
                           v4,
                           v7,
                           v6);
