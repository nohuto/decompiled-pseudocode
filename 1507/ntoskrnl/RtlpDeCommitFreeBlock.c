/*
 * XREFs of RtlpDeCommitFreeBlock @ 0x140109420
 * Callers:
 ...
 *     RtlpUpdateHeapRates @ 0x140248930 (RtlpUpdateHeapRates.c)
...
__int64 __fastcall RtlpDeCommitFreeBlock(unsigned __int64 a1, _WORD *a2, unsigned __int64 a3)
{
  ...
  v9 = a3 + *(_QWORD *)(a1 + 192);
  if ( v9 < *(_QWORD *)(a1 + 184) || v9 < *(_QWORD *)(a1 + 536) >> (*(_BYTE *)(a1 + 648) + 4) )
  {
LABEL_88:
    a1 = v6;
    return RtlpInsertFreeBlock(a1, a2, a3);
