/*
 * XREFs of _CmDeleteDeviceRegKeyWorker @ 0x140713210
 * Callers:
...
__int64 __fastcall CmDeleteDeviceRegKeyWorker(__int64 *a1, __int64 a2, unsigned int a3, int a4, char a5)
{
  ...
  if ( PoolWithTag )
  {
    while ( 1 )
    {
      ...
      DeviceRegKeyPath = CmGetDeviceRegKeyPath((__int64)a1, v7, a3, a4, 0, PoolWithTag, v20, (__int64)&v21);
...
LABEL_53:
  ...
  v12 = PoolWithTag + 25;
  DeviceRegKeyPath = PnpCtxGetCachedContextBaseKey(a1, 4, &v22);
  if ( DeviceRegKeyPath < 0 )
    goto LABEL_54;
  v13 = (char *)v22;
LABEL_22:
