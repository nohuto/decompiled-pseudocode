/*
 * XREFs of ?StLazyWorkMgrRunExpiredWork@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_LAZY_WORK_MGR@1@_K@Z @ 0x1401446A0
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StLazyWorkMgrRunExpiredWork(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  if ( a1 < a1 + 144 )
  {
    ...
    {
      v7 = v6[1];
      if ( v7 != -1LL && (*v6 <= *(_QWORD *)(a1 + 160) || v7 <= a2) )
      {
        *v6 = -1LL;
        v3 |= 1 << v4;
        v6[1] = -1LL;
    ...
    while ( (unsigned __int64)v6 < a1 + 144 );
  }
  ...
  *(_DWORD *)(a1 + 200) |= 1u;
  ...
  while ( v3 )
  {
    ...
    v11[4] = v10;
    v3 &= ~(1 << v10);
    ST_STORE<SM_TRAITS>::StWorkItemProcess(a1 - 4224, (__int64)v11 + 1);
  }
  *(_DWORD *)(a1 + 200) &= ~1u;
