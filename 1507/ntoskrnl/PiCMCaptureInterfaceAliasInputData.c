/*
 * XREFs of PiCMCaptureInterfaceAliasInputData @ 0x14055ED48
 * Callers:
...
__int64 __fastcall PiCMCaptureInterfaceAliasInputData(ULONG64 a1, unsigned int a2, int a3, char *a4)
{
  int v5; // r15d
