/*
 * XREFs of DrvDbDeleteObjectRegKey @ 0x14071A6EC
 * Callers:
...
__int64 __fastcall DrvDbDeleteObjectRegKey(__int64 a1, int a2, wchar_t *a3, unsigned int a4)
{
  ...
  int v14; // eax
  __int64 v15; // r8
  HANDLE v17; // [rsp+20h] [rbp-10h] BYREF
  ...
  if ( ObjectDatabaseNode >= 0 )
  {
    if ( v18 )
    {
      v12 = DrvDbAcquireDatabaseNodeBaseKey((__int64 **)a1, v18, a2, &v17);
      v11 = v12;
      if ( v12 >= 0 )
      {
...
LABEL_20:
  if ( v17 )
    DrvDbReleaseDatabaseNodeBaseKey(a1, v10, v9, v17);
