/*
 * XREFs of BgpTxtDisplayString @ 0x140761D5C
 * Callers:
 ...
 *     BgpFoGetAdvanceWidth @ 0x14026ED10 (BgpFoGetAdvanceWidth.c)
 ...
 *     TxtpJustifyRectangle @ 0x140761F74 (TxtpJustifyRectangle.c)
  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      if ( (_DWORD)v8 )
      {
        ...
        while ( 1 )
        {
          AdvanceWidth = BgpFoGetAdvanceWidth(v11, *v12, &v28, a4, 0LL);
          if ( AdvanceWidth < 0 )
            break;
          v9 += v28;
          v11 = a1 + 40;
...
LABEL_13:
        ...
        if ( AdvanceWidth >= 0 )
        {
          ...
          if ( !v14 )
            v9 = *(_DWORD *)(a1 + 8);
          v26[0] = v9;
          v15 = BgpGxRectangleCreate(v26, 32, &v27);
          v16 = v27;
          AdvanceWidth = v15;
          if ( v15 >= 0 )
          {
            BgpGxFillRectangle(v27, *(_DWORD *)(a1 + 40));
            v17 = 0;
            v18 = 0;
            v19 = 0;
            v29 = 0LL;
            if ( (_DWORD)v8 )
            {
              while ( 1 )
              {
                v20 = BgpRasPrintGlyph(v16, a1 + 40, *v6, v17, v18, 0, &v28, v25, 0LL);
                AdvanceWidth = v20;
                if ( v20 == -2147483643 )
                  break;
                if ( v20 < 0 )
            ...
            v21 = *(_QWORD *)(a1 + 24);
            v27 = 0LL;
            v22 = BgpGxBlendRectangle(v21, v16, &v29, &v27);
            v23 = v27;
            AdvanceWidth = v22;
            if ( v22 >= 0 )
            {
