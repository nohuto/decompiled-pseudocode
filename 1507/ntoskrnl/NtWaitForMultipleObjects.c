/*
 * XREFs of NtWaitForMultipleObjects @ 0x14051FF30
 * Callers:
 *     <none>
 * Callees:
        ...
        PLARGE_INTEGER Time)
{
  ...
  if ( PreviousMode )
  {
    ...
    v11 = Count;
    if ( v11 * 8 && ((unsigned __int64)&Object[v11] > MmUserProbeAddress || &Object[v11] < Object) )
      *(_BYTE *)MmUserProbeAddress = 0;
  }
  memmove(v13, Object, 8LL * Count);
  return ObWaitForMultipleObjects(Count, v13, PreviousMode, WaitType, PreviousMode, Alertable, v10);
}
