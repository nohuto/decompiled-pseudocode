/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockFromDpcLevel @ 0x1407486E4
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VerifierKeReleaseInStackQueuedSpinLockFromDpcLevel(struct _KLOCK_QUEUE_HANDLE *a1)
{
