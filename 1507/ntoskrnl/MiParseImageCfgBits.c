/*
 * XREFs of MiParseImageCfgBits @ 0x140442CC0
 * Callers:
 ...
 *     MiCompressRvaList @ 0x1404B8F40 (MiCompressRvaList.c)
 */

__int64 __fastcall MiParseImageCfgBits(__int64 a1, __int64 a2, unsigned int a3, __int64 *a4, int a5, PVOID *a6)
{
  __int64 v9; // r11
  char *v10; // rsi
  __int64 v11; // r8
