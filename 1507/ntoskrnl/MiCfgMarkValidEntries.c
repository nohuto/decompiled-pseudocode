/*
 * XREFs of MiCfgMarkValidEntries @ 0x1404FBBC8
 * Callers:
...
LABEL_11:
  if ( !MiIsProcessCfgEnabled() )
    return 3221225541LL;
  v17 = (_QWORD *)MiSelectCfgBitMap(v16, a2, 0LL);
  ...
  else
  {
    ...
    v24 = a4;
    v25 = v7;
    v21 = MiPopulateCfgBitMap(v17, (unsigned __int64)&v23, a2, (v20 + 4095) & 0xFFFFFFFFFFFFF000uLL, 1);
    if ( v21 >= 0 )
      v21 = 0;
  }
