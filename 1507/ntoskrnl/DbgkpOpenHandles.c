/*
 * XREFs of DbgkpOpenHandles @ 0x140667048
 * Callers:
  ...
  switch ( *(_DWORD *)a1 )
  {
    ...
    case 3:
      ...
      if ( v5 )
      {
        ...
        if ( (int)ObDuplicateObject((ULONG_PTR)Process, v5, (ULONG_PTR)Process, (__int64 *)(a1 + 48), 0, 0, 2, 0) < 0 )
          *(_QWORD *)(a1 + 48) = 0LL;
        goto LABEL_14;
      }
      break;
    case 9:
      ...
      if ( v5 )
      {
        ...
        if ( (int)ObDuplicateObject((ULONG_PTR)v6, v5, (ULONG_PTR)v6, (__int64 *)(a1 + 24), 0, 0, 2, 0) < 0 )
          *(_QWORD *)(a1 + 24) = 0LL;
LABEL_14:
        ObCloseHandle(v5, 0);
      }
