/*
 * XREFs of PiNormalizeDeviceText @ 0x14054F2C8
 * Callers:
 ...
 *     _wcstoi64 @ 0x1401744FC (_wcstoi64.c)
...
__int64 __fastcall PiNormalizeDeviceText(const WCHAR *Src, wchar_t **a2)
{
  ...
  size_t pcbRemaining; // [rsp+60h] [rbp-49h] BYREF
  wchar_t *EndPtr; // [rsp+68h] [rbp-41h] BYREF
  void *v23; // [rsp+70h] [rbp-39h]
  UNICODE_STRING DestinationString; // [rsp+78h] [rbp-31h] BYREF
  PVOID P; // [rsp+88h] [rbp-21h]
  ULONG MessageId[2]; // [rsp+90h] [rbp-19h]
