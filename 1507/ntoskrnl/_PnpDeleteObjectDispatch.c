/*
 * XREFs of _PnpDeleteObjectDispatch @ 0x140715BB0
 * Callers:
 *     _PnpDeleteObject @ 0x140715A98 (_PnpDeleteObject.c)
 * Callees:
 *     memset @ 0x140195A80 (memset.c)
 *     _PnpCtxGetObjectDispatchCallback @ 0x14043A890 (_PnpCtxGetObjectDispatchCallback.c)
 *     _PnpObjectRaiseDeleteEvent @ 0x140716C8C (_PnpObjectRaiseDeleteEvent.c)
 */
