/*
 * XREFs of sub_140261938 @ 0x140261938
 * Callers:
...
char __fastcall sub_140261938(unsigned __int16 *a1, int a2, __int64 a3, const char *a4, unsigned int a5, bool *a6)
{
  const char *v6; // rdi
  char v10; // r15
  __int16 v11; // r12
  ...
  if ( !v12 )
  {
    if ( !(unsigned __int8)sub_140261EEC(a4, a5, &v41) )
      return 0;
    v39 = *(_QWORD *)(a3 + 8);
    v40 = *(_QWORD *)(a3 + 16);
    if ( !v11 )
...
LABEL_120:
  ...
  if ( !v13 )
  {
    if ( !(unsigned __int8)sub_140261E88(a4, a5, &v41, a5) )
      return 0;
    if ( !v11 )
    {
      v19 = v41 == *(_QWORD *)(a3 + 8);
