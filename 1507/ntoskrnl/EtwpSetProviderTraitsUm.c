/*
 * XREFs of EtwpSetProviderTraitsUm @ 0x1404D2CA0
 * Callers:
...
__int64 __fastcall EtwpSetProviderTraitsUm(__int64 a1, unsigned int a2, unsigned int *a3)
{
  _QWORD *v6; // rsi
  int v7; // ebx
  char v8; // al
            ...
            if ( (unsigned __int64)i <= v17 )
            {
              ...
              if ( v7 >= 0 && !v6[5] )
              {
                ...
                if ( ProviderGroupFromTraits )
                {
                  ...
                  v7 = EtwpAddRegEntryToGroup((__int64)v6, &v23, a1, a2, a3);
                }
              }
            }
            else
