/*
 * XREFs of SdbpScanIndexes @ 0x140577AE4
 * Callers:
...
_UNKNOWN **__fastcall SdbpScanIndexes(_DWORD *a1)
{
  ...
  if ( !a1[333] || a1[4] )
  {
    ...
    if ( FirstChild )
    {
      ...
      {
        a1[11] = 0;
        for ( result = (_UNKNOWN **)SdbFindFirstTag(a1, v4, 30723LL);
              ;
              result = (_UNKNOWN **)SdbFindNextTag((__int64)a1, v4, v5) )
        {
          ...
          LOWORD(a1[10 * a1[11] + 13]) = SdbReadWORDTag((__int64)a1, FirstTag, 0);
          ...
          HIWORD(a1[10 * a1[11] + 13]) = SdbReadWORDTag((__int64)a1, v7, 0);
