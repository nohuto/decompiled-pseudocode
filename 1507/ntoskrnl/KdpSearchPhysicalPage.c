/*
 * XREFs of KdpSearchPhysicalPage @ 0x14072BB98
 * Callers:
...
__int64 __fastcall KdpSearchPhysicalPage(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, char a4, int a5)
{
  ...
  if ( KdpSearchPfnValue )
  {
    ...
    while ( 1 )
    {
      if ( (int)MmDbgCopyMemory((char *)(v5 + v9), v18, 8u, 8u, a5 | 2u) >= 0 && ((v18[0] >> 12) & 0xFFFFFFFFFLL) == a2 )
      {
  ...
  else
  {
    ...
    while ( 1 )
    {
      if ( (int)MmDbgCopyMemory((char *)(v5 + v13), &v17, v11, 0, a5 | 2u) >= 0 )
      {
        if ( v17 >= a2 && v17 <= a3 )
          goto LABEL_24;
        if ( !v10 )
