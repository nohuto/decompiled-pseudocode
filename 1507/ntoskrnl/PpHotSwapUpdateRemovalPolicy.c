/*
 * XREFs of PpHotSwapUpdateRemovalPolicy @ 0x140553DE4
 * Callers:
 *     PiProcessNewDeviceNode @ 0x1404D7558 (PiProcessNewDeviceNode.c)
 * Callees:
 *     _CmGetDeviceRegProp @ 0x14043C46C (_CmGetDeviceRegProp.c)
 *     PiHotSwapGetDetachableNode @ 0x140553EE4 (PiHotSwapGetDetachableNode.c)
...
LABEL_10:
  ...
  *(_BYTE *)(a1 + 467) = v5;
  v6 = *(_QWORD *)(a1 + 48);
  v10 = 4;
  result = CmGetDeviceRegProp(*(__int64 *)&PiPnpRtlCtx, v6, 0LL, 34, (__int64)&v9, (__int64)&v8, (__int64)&v10);
  if ( (int)result >= 0 )
  {
    if ( v9 != 4 )
      result = 3221225712LL;
