/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1406B3808
 * Callers:
...
LABEL_18:
        ...
        {
          v2 = EtwRegister(&SLEEPSTUDY_ETW_PROVIDER, 0LL, 0LL, &PopDiagSleepStudyHandle);
          if ( v2 >= 0 )
      ...
      if ( v2 )
        goto LABEL_32;
      v19 = (__int64 **)qword_14032F3B8;
      *v4 = &SocSubsystemsList;
      v4[1] = v19;
      if ( *v19 != &SocSubsystemsList )
        __fastfail(3u);
      *v19 = v4;
      qword_14032F3B8 = (__int64)v4;
    }
    else
    {
