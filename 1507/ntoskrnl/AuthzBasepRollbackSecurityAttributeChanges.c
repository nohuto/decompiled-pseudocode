/*
 * XREFs of AuthzBasepRollbackSecurityAttributeChanges @ 0x140269D98
 * Callers:
 *     AuthzBasepFinaliseSecurityAttributesList @ 0x140015A10 (AuthzBasepFinaliseSecurityAttributesList.c)
 * Callees:
 *     AuthzBasepRemoveSecurityAttributeValueFromLists @ 0x1400062D4 (AuthzBasepRemoveSecurityAttributeValueFromLists.c)
