/*
 * XREFs of KiSwInterruptDispatch @ 0x14017C0E8
 * Callers:
 *     KiSwInterrupt @ 0x14018CF90 (KiSwInterrupt.c)
 * Callees:
 *     KiGetTrapFrameMode @ 0x14001F5E0 (KiGetTrapFrameMode.c)
 *     KiReadKernelDr7 @ 0x1401FF7F0 (KiReadKernelDr7.c)
...
char __fastcall KiSwInterruptDispatch(__int64 a1)
{
  ...
  v1 = qword_1403D11C0;
  v2 = a1;
  v3 = *(_QWORD *)(qword_1403D11C0 + 1864);
  v4 = __rdtsc();
  v5 = 0;
  v6 = __ROR8__(v4, 3);
  ...
  if ( PoolWithTag )
  {
    ...
    *v19 = *v20;
    ...
    v23 = __rdtsc();
    *((_DWORD *)v17 + 364) = 0;
    v24 = *((unsigned int *)v17 + 357);
    v25 = (__ROR8__(v23, 3) ^ v23) * (unsigned __int128)0x7010008004002001uLL;
    v152 = *((_QWORD *)&v25 + 1);
    *((_DWORD *)v17 + 362) = (*((_QWORD *)&v25 + 1) ^ (unsigned __int64)v25) % v24;
    v26 = *((_DWORD *)v17 + 359);
    v27 = __rdtsc();
    v28 = __ROR8__(v27, 3);
    v29 = v17[234];
    ...
    *((_DWORD *)v17 + 366) = v151 ^ v30;
    ...
    if ( v32 != qword_1403D11C8 )
    {
      ...
      *(_DWORD *)(v38 + 16) = v34;
      if ( !*((_DWORD *)v17 + 392) )
      {
        *(_QWORD *)(v17[149] + 24LL) = qword_1403D11C8 ^ v32;
        if ( !*((_DWORD *)v17 + 392) )
        {
          v17[198] = 0LL;
          v17[197] = v17 - 0xB8BF814EDC6E95FLL;
          v17[199] = 273LL;
          v17[200] = v32;
          *((_DWORD *)v17 + 392) = 1;
        }
    ...
    if ( *((_DWORD *)v17 + 357) )
    {
      while ( 1 )
      {
        ...
        if ( v18[230] )
          v42 = (_QWORD *)v18[230];
        v44 = (int *)((char *)v42 + *((unsigned int *)v42 + 348));
...
LABEL_67:
        ...
        if ( ((*v44 - 1) & 0xFFFFFFDF) == 0 )
        {
          ...
          __writecr8(0xFuLL);
          ((void (__fastcall *)(__int64))v18[40])(v83);
          v86 = (unsigned int *)v18[133];
...
LABEL_120:
          ((void (__fastcall *)(_QWORD, __int64, __int64, __int64 *))v18[48])(v18[136], v85, v88, v89);
...
LABEL_125:
      ...
      if ( (unsigned int)v54 >= 8 )
      {
        ...
        do
        {
          ...
          v56 = __ROL8__(*v53++ ^ v56, *((_DWORD *)v18 + 351));
          --v58;
        }
        while ( v58 );
      }
      if ( (_DWORD)v57 )
      {
        do
        {
          ...
          v56 = __ROL8__(v59 ^ v56, *((_DWORD *)v18 + 351));
          v74 = (_DWORD)v57 == 1;
      ...
      *((_DWORD *)v18 + 356) += v54;
      for ( i = v56; ; v56 = (unsigned int)i ^ (unsigned int)v56 )
      {
        i >>= 31;
        if ( !i )
          break;
      ...
      if ( (_DWORD)v56 != (_DWORD)v61 )
      {
        if ( !*((_DWORD *)v18 + 384) )
          *(_QWORD *)(v18[145] + 24LL) = v61 ^ (unsigned int)v56;
        v62 = *((_QWORD *)v44 + 1);
        if ( !*((_DWORD *)v18 + 384) )
        {
          v18[193] = v18 - 0xB8BF814EDC6E963LL;
          v18[194] = (char *)v44 - 0x4C48B4211BBACBEBLL;
          v18[195] = *v44;
          v18[196] = v62;
          *((_DWORD *)v18 + 384) = 1;
        }
      ...
      __writecr8(0xFuLL);
      ((void (__fastcall *)(__int64, unsigned __int64, _QWORD *, __int64))v18[40])(v63, v56, v53, v57);
      v67 = (unsigned int *)v18[133];
...
LABEL_94:
      ((void (__fastcall *)(_QWORD, __int64, __int64, __int64 *))v18[48])(v18[136], v66, v69, v70);
      __writecr8(v65);
      if ( v5 && *((_QWORD *)v44 + 3) == 1LL )
      {
        v5 = 0;
      ...
      __writecr8(0xFuLL);
      ((void (__fastcall *)(__int64))v18[40])(v76);
      v79 = 0LL;
      v80 = v77 + 24LL * *(unsigned int *)v18[133];
      while ( 1 )
      {
        v77 += 24LL;
        if ( v77 >= v80 )
      ...
      ((void (__fastcall *)(_QWORD))v18[48])(v18[136]);
      __writecr8(v78);
      v41 = v155;
      if ( v77 == v80 )
        goto LABEL_125;
...
LABEL_127:
    if ( *((_DWORD *)v18 + 384) )
    {
      ...
      if ( *((_DWORD *)v18 + 396) && KeGetCurrentIrql() < 2u )
        __writecr8(2uLL);
      v116 = *((_DWORD *)v18 + 396);
      if ( v116 )
      {
        ...
        if ( v117 )
        {
          ...
          if ( v118 )
          {
            ...
            if ( v119 )
            {
              ...
              {
                if ( v120 == 1 )
                  _interlockedbittestandset(&KeGetCurrentThread()->Header.Lock, (*((_DWORD *)v18 + 418) >> 10) & 0x1F);
                else
                  _InterlockedOr64((volatile signed __int64 *)(v18[150] + 832LL), 1uLL);
              }
              else
              {
                _interlockedbittestandset(
                  &KeGetCurrentThread()->ApcState.Process->Header.Lock,
                  (*((_DWORD *)v18 + 418) >> 10) & 0x1F);
              }
              goto LABEL_184;
            }
            v121 = (volatile signed __int32 *)v18[140];
          }
          else
          {
        ...
        {
          v121 = (volatile signed __int32 *)v18[137];
        }
...
LABEL_184:
      ...
      SdbpCheckDll(265, v98, v97, v96, v95, v18[41], (__int64)DpcStack);
      JUMPOUT(0x14017CE7ELL);
    }
    v122 = *((_DWORD *)v18 + 49);
    *((_DWORD *)v18 + 49) = 0;
    v123 = v18;
    ...
    if ( v18 < v18 + 156 )
    {
      ...
      while ( v124 < (const char *)v18 + 1248 );
    }
    v125 = v18[176];
    v126 = *((_DWORD *)v18 + 351);
    v127 = 1248;
    ...
    {
      v127 -= 8;
      v125 = __ROL8__(*v123++ ^ v125, v126);
      --v128;
    }
    while ( v128 );
    for ( ; v127; --v127 )
    {
      v129 = *(unsigned __int8 *)v123;
      v123 = (_QWORD *)((char *)v123 + 1);
      v125 = __ROL8__(v129 ^ v125, v126);
    }
    *((_DWORD *)v18 + 356) += 1248;
    *((_DWORD *)v18 + 49) = v122;
    v18[226] = v125;
    ((void (__fastcall *)(_QWORD *, __int64, __int64, _QWORD *))v18[32])(v17, 1LL, v125, v123);
  }
