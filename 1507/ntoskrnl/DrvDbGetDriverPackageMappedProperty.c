/*
 * XREFs of DrvDbGetDriverPackageMappedProperty @ 0x1404DD708
 * Callers:
        ...
        unsigned int *a8)
{
  ...
  void *v40; // [rsp+50h] [rbp-28h] BYREF
...
LABEL_13:
    if ( *((_DWORD *)v18 + 8) )
    {
      ...
      if ( v9 )
        v25 = v9;
      Value = PnpCtxRegQueryValue(v23, v25, (__int64)L"Version", (__int64)&v39, (__int64)PoolWithTag, (__int64)&v46);
    ...
    else
    {
      ...
      if ( v9 )
        v19 = v9;
      RegValueMappedProperty = DrvDbGetRegValueMappedProperty((__int64)v19, v19, (__int64)v18, v11, pszDest, a7, a8);
