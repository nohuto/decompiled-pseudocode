/*
 * XREFs of IopConnectMessageBasedInterrupt @ 0x14057CB44
 * Callers:
...
LABEL_12:
  ...
  if ( PoolWithTag )
  {
    ...
    *(_BYTE *)v10 = v11;
    ...
    {
      v19 = (_QWORD *)(80 * v18 + 8);
      if ( (unsigned int)(*(_DWORD *)(80 * v18 + 8) - 1) <= 2 )
      {
        v20 = v11;
        if ( !v11 )
          v20 = *((_BYTE *)v19 + 8);
        ...
        *(_QWORD *)&v10[2 * v21 + 2] = v19[8];
        v10[2 * v21 + 8] = *((_DWORD *)v19 + 18);
        *(_QWORD *)&v10[2 * v21 + 4] = v19[3];
        *(_QWORD *)&v10[2 * v21 + 6] = v24 + 104;
