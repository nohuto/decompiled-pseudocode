/*
 * XREFs of IoReportTargetDeviceChangeAsynchronous @ 0x140026540
 * Callers:
 *     PnpDeviceActionWorker @ 0x14002604C (PnpDeviceActionWorker.c)
 *     FsRtlNotifyVolumeEventEx @ 0x14040F42C (FsRtlNotifyVolumeEventEx.c)
 *     VerifierIoReportTargetDeviceChangeAsynchronous @ 0x140742030 (VerifierIoReportTargetDeviceChangeAsynchronous.c)
 * Callees:
