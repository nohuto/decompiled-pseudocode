/*
 * XREFs of _PnpDispatchInterfaceClass @ 0x140458418
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _CmGetInterfaceClassMappedPropertyLocales @ 0x140718BA8 (_CmGetInterfaceClassMappedPropertyLocales.c)
...
__int64 __fastcall PnpDispatchInterfaceClass(__int64 *a1, const WCHAR *a2, __int64 a3, int a4, __int64 a5)
{
  ...
  {
    InterfaceClassMappedProperty = CmValidateInstallerClassName((__int64)a1, a2);
  }
