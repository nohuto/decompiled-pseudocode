/*
 * XREFs of AslStringUpcaseToMultiByteN @ 0x1405782C0
 * Callers:
...
__int64 __fastcall AslStringUpcaseToMultiByteN(char *a1, __int64 a2, const WCHAR *a3)
{
  ...
  STRING v12; // [rsp+40h] [rbp-20h] BYREF
  ...
  *(_QWORD *)&SourceString.Length = 0LL;
  ...
  {
    v6 = -1073741801;
    AslLogCallPrintf(1, (unsigned int)"AslStringUpcaseToMultiByteN", 714, (unsigned int)"Out of memory");
    goto LABEL_5;
  }
