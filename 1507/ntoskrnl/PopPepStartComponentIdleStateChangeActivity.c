/*
 * XREFs of PopPepStartComponentIdleStateChangeActivity @ 0x140139630
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopPluginNotifyIdleState @ 0x140239E0C (PopPluginNotifyIdleState.c)
 */
...
char __fastcall PopPepStartComponentIdleStateChangeActivity(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(a2 + 176) = *(_DWORD *)(*(_QWORD *)(a2 + 64) + 8LL);
  v7 = *(_QWORD *)(a2 + 64);
  if ( !*(_DWORD *)(v7 + 12) )
  {
    if ( *(_BYTE *)(a1 + 124) )
