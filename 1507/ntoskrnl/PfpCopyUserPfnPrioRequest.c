/*
 * XREFs of PfpCopyUserPfnPrioRequest @ 0x14048AB10
 * Callers:
...
__int64 __fastcall PfpCopyUserPfnPrioRequest(ULONG64 a1, unsigned int a2, int a3, _QWORD *a4, char a5, int a6)
{
  ...
  if ( a5 && a2 )
  {
    ...
    v11 = a2 + a1;
    if ( v11 > MmUserProbeAddress || v11 < a1 )
