/*
 * XREFs of SepLogTokenSidManagement @ 0x1406D7694
 * Callers:
 ...
 *     RtlConvertLuidToUlonglong @ 0x140195E40 (RtlConvertLuidToUlonglong.c)
 *     SepGetSidValuesDump @ 0x1402506C0 (SepGetSidValuesDump.c)
 *     ExFreePoolWithTag @ 0x140288010 (ExFreePoolWithTag.c)
 *     SepGetSidManagementActionName @ 0x1406D7520 (SepGetSidManagementActionName.c)
 */
...
void __fastcall SepLogTokenSidManagement(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  ULONGLONG v40; // [rsp+68h] [rbp-98h] BYREF
  ...
  if ( EtwKernelProvRegHandle && SepTokenSidManagementLoggingEnabled )
  {
    if ( a4 )
    {
      v40 = RtlConvertLuidToUlonglong((LUID)(a4 + 16));
      v37 = RtlConvertLuidToUlonglong((LUID)(v7 + 24));
      v30 = v8[48];
      v32 = v8[49];
      v29 = v8[50];
    }
    ...
    UserData.Ptr = (ULONGLONG)SepGetSidManagementActionName(v6, &v35);
    v10 = 2;
    UserData.Size = v35;
    UserData.Reserved = 0;
    ...
    if ( a2 && v17 )
    {
      SidValuesDump = SepGetSidValuesDump((_DWORD *)a2, &v34);
      v66 = v34;
      v18 = 12;
      v65 = SidValuesDump;
      v67 = 0;
    ...
    v20 = 2LL * v18;
    v21 = v18 + 1;
    *(&UserData.Ptr + v20) = (ULONGLONG)&v39;
