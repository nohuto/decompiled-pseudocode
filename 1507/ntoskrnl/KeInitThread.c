/*
 * XREFs of KeInitThread @ 0x1403EB280
 * Callers:
 ...
 *     KeAbInitializeThreadState @ 0x140021564 (KeAbInitializeThreadState.c)
        ...
        int a9)
{
  ...
  *(_DWORD *)(a1 + 480) = 16909313;
  v16 = *(_QWORD *)(a1 + 264);
  *(_QWORD *)(a1 + 464) = v16;
  *(_QWORD *)(a1 + 472) = a1 + 264;
  if ( *(_QWORD *)(v16 + 8) != a1 + 264 )
    __fastfail(3u);
  *(_QWORD *)(v16 + 8) = v15;
  *(_QWORD *)(a1 + 264) = v15;
  *(_QWORD *)(a1 + 240) = a7;
  *(_BYTE *)a1 = 6;
  if ( !KernelStack )
  {
    ...
    v18 = a9 ? a9 - 1 : *(_WORD *)(a8 + 2LL * Group + 528);
    KernelStack = MmCreateKernelStack(8, v18, a1);
    if ( !KernelStack )
      return 3221225626LL;
  }
  ...
  *(_QWORD *)(a1 + 1424) = v19;
  KiInitializeContextThread(v20, a3, a4, a5, a6);
  return 0LL;
}
