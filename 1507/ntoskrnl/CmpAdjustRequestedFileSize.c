/*
 * XREFs of CmpAdjustRequestedFileSize @ 0x1404AF748
 * Callers:
...
unsigned __int64 __fastcall CmpAdjustRequestedFileSize(__int64 a1, int a2, unsigned __int64 a3, unsigned __int64 a4)
{
