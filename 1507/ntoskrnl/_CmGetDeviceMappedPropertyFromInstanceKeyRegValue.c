/*
 * XREFs of _CmGetDeviceMappedPropertyFromInstanceKeyRegValue @ 0x1405B8298
 * Callers:
  ...
  *v10 = 0;
  ...
  if ( *(_DWORD *)(a4 + 16) == 2 )
  {
    ...
    if ( !v22 )
    {
      ...
      if ( a3 )
        v9 = a3;
      if ( (int)PnpCtxRegQueryValue(a1, v9, v21, (__int64)&v26, (__int64)&a6, (__int64)&a5) >= 0
        && v26 == 4
        && (_DWORD)a5 == 4 )
      {
        v23 = a6;
...
LABEL_44:
  ...
  if ( a3 )
    v9 = a3;
  Value = PnpCtxRegQueryValue(a1, v9, v21, (__int64)&v26, v13, (__int64)&a5);
