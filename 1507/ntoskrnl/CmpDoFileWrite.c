/*
 * XREFs of CmpDoFileWrite @ 0x14044ACA4
 * Callers:
 *     CmpFileWrite @ 0x14044BD9C (CmpFileWrite.c)
 *     CmpWriteOffsetArrayToFile @ 0x14065CA3C (CmpWriteOffsetArrayToFile.c)
 * Callees:
 *     CmpSetRespectIoPriorityThread @ 0x14001B140 (CmpSetRespectIoPriorityThread.c)
...
LABEL_55:
    CmRegistryIODebug = 2;
    qword_14077EDB0 = (__int64)a3;
    dword_14077EDB8 = Event;
    if ( v16 > 0 )
