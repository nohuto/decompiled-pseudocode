/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x140111394
 * Callers:
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    if ( (Status & 0xFF0000) != 0x70000 || ((HIBYTE(Status) - 128) & 0xFFFFFFBF) != 0 )
    {
      ...
      do
      {
        ...
        {
          if ( v6 < (unsigned __int8)byte_140297914[8 * v4] )
          {
            v7 = (unsigned __int16)word_140297916[4 * v4];
            if ( byte_140297915[8 * v4] == 1 )
