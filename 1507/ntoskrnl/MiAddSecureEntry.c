/*
 * XREFs of MiAddSecureEntry @ 0x1404B5A90
 * Callers:
 ...
 *     MiLocateExclusiveSecure @ 0x140125564 (MiLocateExclusiveSecure.c)
...
_DWORD *__fastcall MiAddSecureEntry(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  if ( (*(_DWORD *)(a1 + 48) & 0x4000) != 0 && (a5 == 1 || MiLocateExclusiveSecure(a1)) )
    return 0LL;
  result = ExAllocatePoolWithTag(NonPagedPoolNx, 0x28uLL, 0x65536D4Du);
  v10 = result;
  if ( result )
  {
    result[4] = 0;
