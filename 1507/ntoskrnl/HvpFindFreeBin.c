/*
 * XREFs of HvpFindFreeBin @ 0x1404AF27C
 * Callers:
        ...
        if ( (*(_DWORD *)(v9 + 24) & 1) == 0 )
        {
          ...
          if ( v14 + *(_DWORD *)(v9 + 16) <= *(_DWORD *)(BugCheckParameter2 + v4 + 1400) )
          {
            ...
            if ( v15 )
            {
              do
              {
                if ( !HvpGetCellMap(BugCheckParameter2, *(_DWORD *)(v9 + 20) - 4096) )
                ...
                *v19 = v18;
                ...
                {
                  CellMap = (_QWORD *)HvpGetCellMap(BugCheckParameter2, v20 + v17[5]);
                  if ( !CellMap )
            ...
            while ( (unsigned int)(*(_DWORD *)(v9 + 20) + *(_DWORD *)(v9 + 16)) < *(_DWORD *)(BugCheckParameter2
                                                                                            ...
                                                                                            + 1400) )
            {
              if ( !HvpGetCellMap(BugCheckParameter2, *(_DWORD *)(v9 + 16) + *(_DWORD *)(v9 + 20)) )
              ...
              *v30 = v29;
              ...
              {
                v32 = (_QWORD *)HvpGetCellMap(BugCheckParameter2, v31 + *(_DWORD *)(v28 + 20));
                if ( !v32 )
