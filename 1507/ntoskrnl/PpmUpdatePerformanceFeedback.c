/*
 * XREFs of PpmUpdatePerformanceFeedback @ 0x1400AA580
 * Callers:
 ...
 *     PpmHvGetRuntimesForProcessor @ 0x140241D40 (PpmHvGetRuntimesForProcessor.c)
 */
...
char __fastcall PpmUpdatePerformanceFeedback(__int64 a1, unsigned __int8 a2, char a3, char a4, __int64 *a5)
{
  ...
  {
    v10 = 1;
    v11 = *(_QWORD *)(*(_QWORD *)(a1 + 24592) + 8LL * DWORD2(xmmword_140383008)) >> 1;
  }
  else
  {
    v10 = 0;
