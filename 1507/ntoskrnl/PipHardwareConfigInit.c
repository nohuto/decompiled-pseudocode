/*
 * XREFs of PipHardwareConfigInit @ 0x1407B6A40
 * Callers:
...
__int64 __fastcall PipHardwareConfigInit(GUID *Guid)
{
  ...
  HANDLE v24; // [rsp+78h] [rbp-90h] BYREF
  LARGE_INTEGER Data; // [rsp+80h] [rbp-88h] BYREF
  ...
  *(_DWORD *)&DestinationString.Length = 1441812;
  ...
  if ( v6 >= 0 )
  {
    v8 = IopCreateRegistryKeyEx(&v24, v7, &PnpCurrentHardwareConfigurationGuidString, 0xF003Fu, 0, &v26);
    v3 = v24;
    v6 = v8;
    if ( v8 >= 0 )
    {
      RegistryValue = IopGetRegistryValue(v24, L"Id", 0, &P);
      v6 = -1073741823;
      if ( RegistryValue >= 0 )
      {
...
LABEL_14:
            ...
            *(_DWORD *)&DestinationString.Length = 1048590;
            ZwSetValueKey(v24, &DestinationString, 0, 3u, &Data, 8u);
            v7 = KeyHandle;
