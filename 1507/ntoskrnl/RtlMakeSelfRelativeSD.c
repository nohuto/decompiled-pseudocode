/*
 * XREFs of RtlMakeSelfRelativeSD @ 0x140561D40
 * Callers:
 ...
 *     RtlpQuerySecurityDescriptor @ 0x140561E80 (RtlpQuerySecurityDescriptor.c)
 */
        ...
        PULONG BufferLength)
{
  ...
  else if ( SelfRelativeSD )
  {
    ...
    *(_DWORD *)SelfRelativeSD = *(_DWORD *)AbsoluteSD;
    if ( (_DWORD)v8 )
    {
      memmove((char *)SelfRelativeSD + 20, v13, v8);
      *((_DWORD *)SelfRelativeSD + 3) = 20;
      v10 += v8;
    }
    else
    {
      *((_DWORD *)SelfRelativeSD + 3) = 0;
    }
    if ( (_DWORD)Size )
    {
      v11 = (unsigned int)Size;
      memmove(v10, Src, (unsigned int)Size);
      *((_DWORD *)SelfRelativeSD + 4) = (_DWORD)v10 - (_DWORD)SelfRelativeSD;
      v10 += v11;
    }
    else
    {
      *((_DWORD *)SelfRelativeSD + 4) = 0;
    }
    if ( (_DWORD)v6 )
    {
      memmove(v10, v15, v6);
