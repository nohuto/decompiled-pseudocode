/*
 * XREFs of KiUpdateSpeculationControl @ 0x140208FA0
 * Callers:
 ...
 *     KiUpdateSpecCtrlEnhancedIBRS @ 0x140208E38 (KiUpdateSpecCtrlEnhancedIBRS.c)
 */
...
__int64 __fastcall KiUpdateSpeculationControl(__int64 a1)
{
  ...
  result = (unsigned int)dword_1403D123C;
  if ( (dword_1403D123C & 0x10) == 0 )
    return result;
  ...
  if ( (dword_1403D123C & 0x800) != 0 )
    CurrentPrcb->BpbKernelSpecCtrl |= 2u;
  if ( (dword_1403D123C & 0x400000) != 0 )
    CurrentPrcb->BpbKernelSpecCtrl |= 0x400u;
  if ( (dword_1403D123C & 0x20) == 0 )
  {
    if ( *(_QWORD *)(a1 + 1952) )
    {
      if ( ((KiSpeculationFeatures & 0x8000) == 0 || (dword_1403D123C & 0x1000) != 0 || (dword_1403D123C & 0x2000) != 0)
        && ((KiSpeculationFeatures & 0x200000) == 0
         || (dword_1403D123C & 0x8000) != 0
         || (dword_1403D123C & 0x10000) != 0) )
      {
  ...
  if ( *(_QWORD *)(a1 + 1952) && (dword_1403D123C & 0x80) != 0 )
  {
    CurrentPrcb->BpbKernelSpecCtrl |= 4u;
    BpbCurrentSpecCtrl |= 4u;
  }
  if ( (KiSpeculationFeatures & 0x42) == 0x42 && ((dword_1403D123C & 1) != 0 || (*(_DWORD *)(a1 + 1716) & 0x1000) != 0) )
    CurrentPrcb->BpbUserSpecCtrl |= 2u;
  if ( (dword_1403D123C & 0x800) != 0 )
    CurrentPrcb->BpbUserSpecCtrl |= 2u;
  if ( (dword_1403D123C & 0x80) != 0 && (*(_DWORD *)(a1 + 1716) & 0x2000) != 0 )
    CurrentPrcb->BpbUserSpecCtrl |= 4u;
  if ( (dword_1403D123C & 0x400000) != 0 )
    CurrentPrcb->BpbUserSpecCtrl |= 0x400u;
  result = CurrentPrcb->TrappedSecurityDomain;
  if ( result && result != *(_QWORD *)(a1 + 1952) )
  {
