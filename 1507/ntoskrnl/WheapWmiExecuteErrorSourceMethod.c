/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1402678C0
 * Callers:
...
LABEL_28:
  ...
  else
  {
    if ( !dword_140356CC4 )
      goto LABEL_35;
    v7 = 972 * dword_140356CC4 + 12;
    if ( v7 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v34 = (__int64 *)qword_140356CC8;
    v35 = a3 + 3;
    v36 = 0;
    for ( i = 0; v34 != &qword_140356CC8; v34 = (__int64 *)*v34 )
    {
      if ( i >= dword_140356CC4 )
        break;
      v38 = v35;
      v39 = (char *)v34 + 89;
      v40 = 7LL;
