/*
 * XREFs of sub_140409614 @ 0x140409614
 * Callers:
...
__int64 __fastcall sub_140409614(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
  unsigned int i; // edx
...
LABEL_49:
  ...
  if ( (v14 & 0x80000000) == 0 )
  {
    if ( v7 && *(_DWORD *)a1 > 4u )
    {
      ...
      if ( !*v7 )
        v18 = 0LL;
      v19 = qword_14077E360 ? qword_14077E360(v18) : -1073741637;
      v20 = *(_DWORD *)(a2 + 32);
