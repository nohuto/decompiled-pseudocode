/*
 * XREFs of ExpUpdateComPlusPackage @ 0x1406EF464
 * Callers:
...
__int64 __fastcall ExpUpdateComPlusPackage(int a1)
{
  ...
  Data = a1;
  v1 = ZwOpenKey(&KeyHandle, 0x40000000u, &stru_1403231D8);
  if ( v1 == -1073741772 )
    v1 = ZwCreateKey(&KeyHandle, 0x40000000u, &stru_1403231D8, 0, 0LL, 0, &Disposition);
  if ( v1 >= 0 )
  {
    v1 = ZwSetValueKey(KeyHandle, &stru_14031EE90, 0, 4u, &Data, 4u);
    ZwClose(KeyHandle);
  }
