/*
 * XREFs of PpmInfoAdjustSetting @ 0x140500A2C
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x1404FF554 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x14015D3AC (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x140500AE4 (PpmInfoWriteData.c)
 */
