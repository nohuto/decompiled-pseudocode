/*
 * XREFs of FstubVerifyPartitionTableEFI @ 0x14066F990
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( v12 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( Sectors < 0 )
            break;
          Sectors = FstubWriteSector(*(PDEVICE_OBJECT *)a1, *(_DWORD *)(a1 + 8));
          if ( Sectors < 0 )
            break;
          if ( ++v15 + v18 >= v12 )
            goto LABEL_24;
...
LABEL_24:
        ...
        Sectors = FstubWriteHeaderEFI(a1, v12, (unsigned int)&v23, v19, (__int64)Buffer, v21, v22, (_DWORD)v24);
      }
      goto LABEL_25;
    }
    goto LABEL_14;
