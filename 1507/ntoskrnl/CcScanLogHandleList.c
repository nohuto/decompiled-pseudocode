/*
 * XREFs of CcScanLogHandleList @ 0x140067FF4
 * Callers:
...
void __fastcall CcScanLogHandleList(_DWORD *a1, unsigned int a2, __int64 *a3)
{
  KIRQL v6; // al
  __int64 *v7; // rdi
  KIRQL v8; // bp
...
LABEL_9:
      ...
      *((_DWORD *)v9 + 28) = (3 * v14) >> 2;
      v15 = CcCalculatePagesToWrite(a2, v9 + 8, v9 + 11, 1LL);
      v16 = *(_QWORD *)v11;
      v9[9] = *(_QWORD *)v11;
      if ( v15 > v16 >> 3 )
      {
