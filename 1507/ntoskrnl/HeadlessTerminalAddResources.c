/*
 * XREFs of HeadlessTerminalAddResources @ 0x14059BCEC
 * Callers:
...
__int64 __fastcall HeadlessTerminalAddResources(void *Src, size_t Size, char a3, _QWORD *a4, _DWORD *a5)
{
  ...
  if ( (*(_DWORD *)(HeadlessGlobals + 48) & 0x1000) != 0 )
  {
    *a4 = 0LL;
    result = 0LL;
  }
    ...
    if ( (int)Size + 36 >= (unsigned int)Size )
    {
      ...
      *a4 = PoolWithTag;
      if ( PoolWithTag )
      {
        ...
        v11 = *(PHYSICAL_ADDRESS *)(HeadlessGlobals + 64);
        if ( a3 )
        {
          AddressSpace = 1;
        ...
        {
          TranslatedAddress = *(LARGE_INTEGER *)(HeadlessGlobals + 64);
        }
        v12 = (_DWORD *)*a4;
        ++*v12;
