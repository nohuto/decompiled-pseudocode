/*
 * XREFs of KiReleaseSpinLockInstrumented @ 0x1402010EC
 * Callers:
 ...
 *     KdReleaseDebuggerLock @ 0x1401FDF04 (KdReleaseDebuggerLock.c)
 ...
 *     KeReleaseSpinLockForDpc @ 0x140200E54 (KeReleaseSpinLockForDpc.c)
