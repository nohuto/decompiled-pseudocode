/*
 * XREFs of PopFanUpdateRunningState @ 0x1406BB248
 * Callers:
...
void __fastcall PopFanUpdateRunningState(char a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( PopFanTracking )
  {
    ...
    {
      byte_14032DFC4 = 1;
      qword_14032DFC8 = MEMORY[0xFFFFF78000000008];
    }
  }
  else if ( byte_14032DFC4 )
  {
    if ( byte_14032DFC5 )
