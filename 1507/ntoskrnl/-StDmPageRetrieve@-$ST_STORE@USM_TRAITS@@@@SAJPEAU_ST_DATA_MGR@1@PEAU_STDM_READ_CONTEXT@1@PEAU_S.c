/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x140140BD0
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageRetrieve(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)v29 = (unsigned __int8)v3;
  ...
  {
    SmWdWorkItemRegister(&unk_140351B48, *(unsigned int *)(*(_QWORD *)(a1 + 152) + 4480LL), a3, 1LL);
    v28 = 1;
  }
  v10 = (unsigned __int64)v9;
  v11 = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, v8, (unsigned int)&v32, a3, (__int64)v9);
  if ( v11 < 0 )
  {
LABEL_40:
    v14 = v28;
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)(unsigned __int8)v13 >= *(_DWORD *)v29 )
        break;
      LODWORD(v33) = ++v12;
      v11 = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, v31, (unsigned int)&v32, a3, v10);
      if ( v11 < 0 )
        goto LABEL_40;
    }
...
LABEL_18:
  ...
  if ( v14 )
  {
    SmWdWorkItemUpdate(&unk_140351B48, *(_QWORD *)(a1 + 152), a3, (unsigned int)v11);
    return 259;
  }
