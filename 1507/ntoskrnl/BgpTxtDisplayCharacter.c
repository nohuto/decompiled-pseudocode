/*
 * XREFs of BgpTxtDisplayCharacter @ 0x140150300
 * Callers:
 ...
 *     TxtpGetCacheEntry @ 0x140150520 (TxtpGetCacheEntry.c)
...
LABEL_5:
    ...
    if ( (v36 & 1) != 0 || (dword_140323CF0 & 0x1000000) != 0 || (v14 = BgpGxDrawRectangle(v11, &v28), v14 >= 0) )
    {
      if ( v12 )
