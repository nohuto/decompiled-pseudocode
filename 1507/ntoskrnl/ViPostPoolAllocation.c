/*
 * XREFs of ViPostPoolAllocation @ 0x140736B44
 * Callers:
...
__int64 __fastcall ViPostPoolAllocation(unsigned __int64 a1, char a2)
{
  ...
  {
    if ( (v5 & 0xFFF) > 0xFC0 || v5 >= 0x10000 )
    {
      v10 = (v5 + 4095) & 0xFFFFFFFFFFFFF000uLL;
      goto LABEL_8;
    }
    v9 = v5 + 15;
  }
...
LABEL_18:
  ...
  *(_QWORD *)(a1 + 16) = v10;
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v14 > *(_DWORD *)(v8 + 88) )
      *(_DWORD *)(v8 + 88) = v14;
    v15 = v10 + _InterlockedExchangeAdd64(&qword_140331D50, v10);
    if ( v15 > qword_140331D60 )
      qword_140331D60 = v15;
    v16 = _InterlockedIncrement(&dword_140331D40);
    if ( v16 > dword_140331D48 )
      dword_140331D48 = v16;
  }
  else
  {
    ...
    if ( v18 > *(_DWORD *)(v8 + 92) )
      *(_DWORD *)(v8 + 92) = v18;
    v19 = v10 + _InterlockedExchangeAdd64(&qword_140331D58, v10);
    if ( v19 > qword_140331D68 )
      qword_140331D68 = v19;
    v20 = _InterlockedIncrement(&dword_140331D44);
    if ( v20 > dword_140331D4C )
      dword_140331D4C = v20;
  }
  result = v2;
  *v12 = a1;
