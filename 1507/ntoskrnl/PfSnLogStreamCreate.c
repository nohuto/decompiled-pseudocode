/*
 * XREFs of PfSnLogStreamCreate @ 0x140443320
 * Callers:
...
__int64 __fastcall PfSnLogStreamCreate(__int64 a1)
{
  ...
  else
  {
    ...
    v6 = 0;
    v7 = (struct _EX_RUNDOWN_REF *)PfSnLogHelper(*(_QWORD *)a1, (unsigned int)v5, &v17);
    if ( v7 )
    {
      v8 = v17;
      DestinationString.Length = 0;
      *v17 = (8LL * (unsigned int)(v5 - 1)) | 5;
      ...
      *(_WORD *)(v9 + 2 * v4 + 44) = 0;
      _m_prefetchw(&v7[45]);
      v13 = v7[45].Count & 0xFFFFFFFFFFFFFFFEuLL;
      if ( v13 != _InterlockedCompareExchange64((volatile signed __int64 *)&v7[45], v13 - 2, v13) )
