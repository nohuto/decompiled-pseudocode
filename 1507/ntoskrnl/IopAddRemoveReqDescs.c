/*
 * XREFs of IopAddRemoveReqDescs @ 0x14059DF6C
 * Callers:
 *     IopSelectNextConfiguration @ 0x14059BDC4 (IopSelectNextConfiguration.c)
 *     PnpFindBestConfigurationWorker @ 0x14059C47C (PnpFindBestConfigurationWorker.c)
 *     PnpSelectFirstConfiguration @ 0x14059C724 (PnpSelectFirstConfiguration.c)
 *     IopBootAllocation @ 0x14059DEA0 (IopBootAllocation.c)
 * Callees:
 *     <none>
 */
