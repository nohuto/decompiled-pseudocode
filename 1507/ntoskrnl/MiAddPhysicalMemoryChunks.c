/*
 * XREFs of MiAddPhysicalMemoryChunks @ 0x1406A197C
 * Callers:
 *     MmAddPhysicalMemory @ 0x1406A2278 (MmAddPhysicalMemory.c)
 *     MiHotAddPartitionMemory @ 0x1406A3DD4 (MiHotAddPartitionMemory.c)
 * Callees:
 *     MiAddPhysicalMemory @ 0x1402123C8 (MiAddPhysicalMemory.c)
 */

__int64 __fastcall MiAddPhysicalMemoryChunks(__int16 *a1, __int64 *a2, signed __int64 *a3)
{
