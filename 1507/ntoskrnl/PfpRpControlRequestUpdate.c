/*
 * XREFs of PfpRpControlRequestUpdate @ 0x140455444
 * Callers:
...
__int64 __fastcall PfpRpControlRequestUpdate(__int64 a1, _DWORD *a2)
{
  ...
  if ( (_DWORD)v3 )
  {
    do
    {
      ...
      *v7++ = v11;
      ...
      {
        v15 = Process;
        if ( *(_DWORD *)&Process[1].BasePriority == (_DWORD)v11 )
        {
          if ( v4 < a2[1] )
  ...
  if ( (int)result >= 0 )
  {
          ...
          (int)result >= 0) )
    {
      ...
      {
        result = PfpRpCHashDeleteEntries(a1, (__m128i *)(a1 + 56), (unsigned __int64 *)(a1 + 88), v14, v9);
        if ( (int)result < 0 )
          return result;
        *(_QWORD *)(a1 + 80) = 0LL;
      }
