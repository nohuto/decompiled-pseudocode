/*
 * XREFs of DrvDbGetObjectSubKeyCallback @ 0x14071B63C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DrvDbGetObjectSubKeyCallback(__int64 *a1, char *a2, const WCHAR *a3, __int64 a4)
{
  ...
  v4 = (const wchar_t **)&off_14029A120;
  Handle = 0LL;
  v5 = 0LL;
  v33 = 0;
  v6 = 0;
...
LABEL_10:
        if ( RtlStringCchCopyW(v14, v11, a3) >= 0 )
        {
          ...
          if ( a1 )
            v17 = *a1;
          if ( (int)SysCtxRegOpenKey(v17, a2, a3, 8, 0x20019u, &Handle) >= 0
