/*
 * XREFs of PipGetRegistrySecurityWithFallback @ 0x1404E6788
 * Callers:
...
__int64 __fastcall PipGetRegistrySecurityWithFallback(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  bool v8; // di
