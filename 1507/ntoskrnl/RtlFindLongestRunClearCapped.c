/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x14024749C
 * Callers:
...
LABEL_39:
      ...
      v20 = byte_140297800[RtlpBitsClearLow[v16]] | *(_BYTE *)(&unk_140295408 - (_UNKNOWN *)v15);
      while ( 1 )
      {
        v16 |= v20;
