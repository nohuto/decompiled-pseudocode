/*
 * XREFs of SeLogAccessFailure @ 0x140124240
 * Callers:
...
void __fastcall SeLogAccessFailure(__int64 a1, __int64 a2, __int64 a3, ULONGLONG a4, ULONGLONG a5, char a6, char a7)
{
  ...
  if ( !byte_140356AA4 || CurrentIrql >= 2u || !EtwKernelProvRegHandle )
    return;
  if ( a1 )
  {
    v103 = *(_DWORD *)(a1 + 192);
  ...
  v18 = KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.Bitmap[14];
  if ( v18 )
  {
