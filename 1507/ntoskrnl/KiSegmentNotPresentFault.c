/*
 * XREFs of KiSegmentNotPresentFault @ 0x140190480
 * Callers:
 *     KiSegmentNotPresentFaultShadow @ 0x140274580 (KiSegmentNotPresentFaultShadow.c)
 * Callees:
...
void __noreturn KiSegmentNotPresentFault()
{
  ...
  if ( (v10 & 1) != 0 )
  {
    ...
    v1 = *(_QWORD *)&CurrentThread->Process[2].ThreadSeed[12];
    __writegsqword(0x2EA8u, v1);
