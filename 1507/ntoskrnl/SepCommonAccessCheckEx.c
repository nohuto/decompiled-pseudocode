...
LABEL_99:
  ...
  if ( v68 )
  {
    ScopedPolicySid = (void *)SepGetScopedPolicySid(v68, v66, 0x8000LL);
    if ( ScopedPolicySid )
    {
...
LABEL_167:
  ...
  while ( 1 )
  {
    ...
    if ( *(_QWORD *)(v94 + 24) )
    {
      if ( !v149 )
      {
        v95 = AuthzBasepInitializeResourceClaimsFromSacl(v164, (__int64)&v149);
