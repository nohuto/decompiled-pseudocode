/*
 * XREFs of _CmDeleteDeviceInterfaceMappedPropertyFromRegValue @ 0x1407171CC
 * Callers:
...
__int64 __fastcall CmDeleteDeviceInterfaceMappedPropertyFromRegValue(__int64 *a1, __int64 a2, char *a3, __int64 a4)
{
  ...
  if ( v13 )
  {
    if ( a3 || (v5 = CmOpenDeviceInterfaceRegKey(a1, a2, 0x30u, (__int64)v12, 1, 0, (__int64)v25, 0LL), v5 >= 0) )
    {
      v15 = *(_DWORD *)(a4 + 16);
      if ( v15 != 2 )
        goto LABEL_40;
...
LABEL_41:
      ...
      else
      {
        ...
        if ( a1 )
          ...
          v18 = 0LL;
        v19 = SysCtxRegOpenKey(v18, v17, L"Device Parameters", 0, 2u, &Handle);
