/*
 * XREFs of PpDevCfgProcessDeviceExtensions @ 0x14068CF4C
 * Callers:
...
__int64 __fastcall PpDevCfgProcessDeviceExtensions(__int64 a1)
{
  ...
  UNICODE_STRING v31; // [rsp+C0h] [rbp-48h] BYREF
  UNICODE_STRING v32; // [rsp+D0h] [rbp-38h] BYREF
  UNICODE_STRING UnicodeString; // [rsp+E0h] [rbp-28h] BYREF
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  do
  {
    ...
    else
    {
      ...
      if ( *(_QWORD *)(v5 + 312) )
      {
        inited = PiDevCfgAppendMultiSz(&v31, 0LL, (const void **)(v5 + 304), 0);
        if ( inited < 0 )
          goto LABEL_61;
      }
      if ( *(_QWORD *)(v5 + 328) )
      {
        inited = PiDevCfgAppendMultiSz(&v34, 0LL, (const void **)(v5 + 320), 0);
        if ( inited < 0 )
          goto LABEL_61;
      }
      if ( *(_QWORD *)(v5 + 344) )
      {
        inited = PiDevCfgAppendMultiSz(&v32, 0LL, (const void **)(v5 + 336), 0);
        if ( inited < 0 )
          goto LABEL_61;
      }
      HIDWORD(v23) |= *(_DWORD *)(v5 + 368);
      inited = PiDevCfgAppendMultiSz(&v29, (unsigned __int16 *)(v5 + 40), 0LL, 0);
      if ( inited < 0 )
        goto LABEL_61;
      v7 = 0;
      v8 = &v28;
    }
    inited = PiDevCfgAppendMultiSz(v8, (unsigned __int16 *)(v5 + 376), 0LL, v7);
    if ( inited < 0 )
      goto LABEL_61;
LABEL_26:
    v5 = *(_QWORD *)v5;
  ...
  if ( inited >= 0 )
  {
    ...
    else
    {
      ...
      if ( HIDWORD(v23) )
      {
        ...
        LODWORD(v23) = v15 | v18;
        PiDevCfgSetDeviceRegProp(v17, (__int64)v36, 0xBu, 4u, (__int64)&v23, 4u);
      }
    }
  }
LABEL_61:
