/*
 * XREFs of ExpCreateRestrictedFastCacheRegistryKey @ 0x1406ECC64
 * Callers:
      ...
      if ( Acl >= 0 )
      {
        ...
        if ( Acl >= 0 )
        {
          ...
          if ( Acl >= 0 )
          {
            ...
            if ( Acl >= 0 )
            {
              if ( !RtlCompareUnicodeString(String1, &stru_140721EB0, 0) )
                goto LABEL_11;
              ...
              ObjectAttributes.ObjectName = (PUNICODE_STRING)&stru_140721EB0;
