/*
 * XREFs of IoAssignResources @ 0x14067A81C
 * Callers:
 *     <none>
 * Callees:
        ...
        PCM_RESOURCE_LIST *AllocatedResources)
{
  ...
  v16 = (struct _DEVICE_OBJECT *)RequestedResources;
  ...
  return IopLegacyResourceAllocation(
           (PUNICODE_STRING)2,
           (PUNICODE_STRING)DriverObject,
           (PDRIVER_OBJECT)DeviceObject,
           v16,
           (PIO_RESOURCE_REQUIREMENTS_LIST)AllocatedResources,
           AllocatedResources);
}
