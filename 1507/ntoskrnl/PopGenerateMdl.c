/*
 * XREFs of PopGenerateMdl @ 0x14014D604
 * Callers:
...
PMDL __fastcall PopGenerateMdl(__int64 a1)
{
  ...
  if ( PagesForMdl )
  {
    PagesForMdl->Next = *(struct _MDL **)(qword_14032E680 + 128);
    *(_QWORD *)(qword_14032E680 + 128) = PagesForMdl;
    *(_QWORD *)(qword_14032E680 + 136) += a1;
  }
  v5 = __rdtsc();
  qword_14032EBF0 += (((unsigned __int64)HIDWORD(v5) << 32) | (unsigned int)v5) - v2;
  return v4;
}
