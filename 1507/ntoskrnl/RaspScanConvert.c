/*
 * XREFs of RaspScanConvert @ 0x140151030
 * Callers:
 *     RaspRasterize @ 0x140152018 (RaspRasterize.c)
 * Callees:
 *     RaspTestIntersection @ 0x140151450 (RaspTestIntersection.c)
 *     BgpFmRoundUp @ 0x140151818 (BgpFmRoundUp.c)
 *     BgpFmRoundDefault @ 0x140151830 (BgpFmRoundDefault.c)
        ...
        __int64 a8)
{
  ...
  if ( v11 )
  {
    v26 = qword_14081FAB0;
    v52 = qword_14081FAB0;
    SegmentList = BgpGxInitializeRectangle(v53, 1LL, qword_14081FAB0, 3140LL);
    if ( SegmentList < 0 )
      goto LABEL_28;
  }
  else
