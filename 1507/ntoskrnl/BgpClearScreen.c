/*
 * XREFs of BgpClearScreen @ 0x14026E1F8
 * Callers:
...
__int64 __fastcall BgpClearScreen(int a1)
{
  ...
  result = BgpGxInitializeRectangle((int *)&v12, BitsPerPixel, (__int64)&unk_1403840C0, 0x2000u);
  if ( (int)result >= 0 )
  {
    BgpGxFillRectangle((__int64)&unk_1403840C0, a1);
    v11 = 0;
    for ( i = 0; v11 < v4; i = v11 )
    {
      ...
      if ( v3 )
      {
        do
        {
          BgpGxDrawRectangle((__int64)&unk_1403840C0, (__int64)&v15);
          if ( (byte_1403840D0 & 0x10) != 0 )
            BgpGxFillRectangle((__int64)&unk_1403840C0, a1);
          v15 += v9;
        }
        while ( v15 < v3 );
