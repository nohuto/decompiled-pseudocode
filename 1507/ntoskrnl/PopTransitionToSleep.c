/*
 * XREFs of PopTransitionToSleep @ 0x1403F045C
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PopTransitionToSleep(struct _KEVENT *StartContext)
{
  ...
  qword_14032E970 = (__int64)KeGetCurrentThread();
  v8 = 0;
  if ( Lock == 3 || Lock == 6 )
  {
  ...
  else
  {
    ...
    v5 = PopInvokeSystemStateHandler(Lock, qword_14032E680);
  }
  v6 = v5;
  qword_14032ECD8 = __rdtsc();
