/*
 * XREFs of EtwpSysModuleRunDown @ 0x14051CC04
 * Callers:
...
__int64 __fastcall EtwpSysModuleRunDown(unsigned int a1, char a2)
{
  ...
  ULONG_PTR *v17; // [rsp+98h] [rbp+17h] BYREF
  ...
  if ( !a2 )
  {
    v18 = 8LL;
    v17 = &PsNtosImageBase;
    EtwpLogKernelEvent((__int64)&v17, a1, 1u, 0x1421u, 4200450);
    if ( !(unsigned int)HvlQueryConnection(&v9) )
    {
      v18 = 8LL;
      v17 = (ULONG_PTR *)&v9;
      EtwpLogKernelEvent((__int64)&v17, a1, 1u, 0x1422u, 4200450);
    }
  }
  v7 = a1;
  v6[1] = &v17;
  ...
  v18 = 56LL;
  v20 = 2LL;
  return MmEnumerateSystemImages((__int64 (__fastcall *)(PVOID *, __int64))EtwpSystemImageEnumCallback, (__int64)v6);
}
