/*
 * XREFs of VfDeadlockAcquireResource @ 0x14074EDC4
 * Callers:
 ...
 *     VerifierExEnterPriorityRegionAndAcquireResourceExclusive @ 0x14074C188 (VerifierExEnterPriorityRegionAndAcquireResourceExclusive.c)
 ...
 *     ViDeadlockSimilarNode @ 0x1407518E0 (ViDeadlockSimilarNode.c)
      ...
      if ( *(_DWORD *)v20 != (_DWORD)v5 )
      {
        if ( ((unsigned int)(v5 - 3) > 1 || (unsigned int)(v22 - 3) > 1) && (v22 != 7 || (unsigned int)(v5 - 5) > 1) )
        {
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1008);
          VfReportIssueWithOptions(196, 4104, a1, *(_DWORD *)v20, v5, byte_140323198);
LABEL_36:
          v18 = v51;
          v19 = 0;
LABEL_80:
      ...
      if ( v23 )
      {
        if ( v25 > 1u )
        {
          ...
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1000);
          VfReportIssueWithOptions(196, 4096, a1, v20, v9, &dword_14032319C);
          goto LABEL_36;
        }
        v26 = a4;
        v27 = (_QWORD *)(v23 + 8);
