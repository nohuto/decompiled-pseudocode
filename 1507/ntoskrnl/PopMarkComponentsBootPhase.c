/*
 * XREFs of PopMarkComponentsBootPhase @ 0x1403F1A14
 * Callers:
 ...
 *     FirstEntrySList @ 0x14018B430 (FirstEntrySList.c)
 *     VfIsVerifierExtensionEnabled @ 0x140195E60 (VfIsVerifierExtensionEnabled.c)
