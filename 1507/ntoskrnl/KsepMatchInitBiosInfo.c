/*
 * XREFs of KsepMatchInitBiosInfo @ 0x1407E1D2C
 * Callers:
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  KeyHandle = 0LL;
  memset(&qword_14036BDC0, 0, 0x38uLL);
  v0 = -1;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_140356700, 520LL, (__int64)&v15);
      word_140356906 = 0;
      v5 = 0LL;
      v6 = &unk_140356700;
      while ( *v6 != 32 )
...
LABEL_11:
  ...
  {
    qword_14036BDC0 = (__int64)&unk_140356700;
    dword_14036BDE8 = v0;
  }
