/*
 * XREFs of MmGetSessionMappedViewInformation @ 0x1406A0A34
 * Callers:
 ...
 *     MiGetSystemPteStatistics @ 0x1406A8808 (MiGetSystemPteStatistics.c)
 */
  ...
  for ( i = 0LL; ; i = v13 )
  {
    ...
    if ( *v21 == -1 || SessionId == *v21 )
    {
      if ( (int)MmAttachSession(v13, (__int64)v24) >= 0 )
      {
        ...
        {
          MmDetachSession((__int64)v13, (struct _KTHREAD *)v24);
