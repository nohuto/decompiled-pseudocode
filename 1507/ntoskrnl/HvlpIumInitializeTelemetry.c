/*
 * XREFs of HvlpIumInitializeTelemetry @ 0x1407F922C
 * Callers:
...
char HvlpIumInitializeTelemetry()
{
  ...
  result = TraceLoggingRegisterEx(&stru_14031E8B0, 0LL, 0LL);
  if ( (*(_DWORD *)(KeLoaderBlock_0 + 264) & 1) != 0 )
  {
    if ( stru_14031E8B0.LevelPlus1 <= 5 )
      goto LABEL_8;
    result = TlgKeywordOn(&stru_14031E8B0, 0x400000000000uLL);
    if ( result )
    {
      v3 = *(_QWORD *)(v2 + 240);
      v6[0] = (v1 >> 3) & 1;
      ...
      v12[0] = v4;
      v14 = 4;
      result = TlgWrite(&stru_14031E8B0, &unk_1402A3C98, 0LL, 0LL, 5u, &pData);
    }
  }
  if ( stru_14031E8B0.LevelPlus1 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v8 = v6;
      result = TlgWrite(&stru_14031E8B0, &unk_1402A3C73, 0LL, 0LL, 3u, &pData);
    }
  }
LABEL_8:
  if ( (HvlpFlags & 0x2000) == 0 )
  {
    result = EtwUnregister(stru_14031E8B0.RegHandle);
    stru_14031E8B0.RegHandle = 0LL;
    stru_14031E8B0.LevelPlus1 = 0;
  }
  return result;
}
