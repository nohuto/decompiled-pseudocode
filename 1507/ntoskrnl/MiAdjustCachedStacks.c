/*
 * XREFs of MiAdjustCachedStacks @ 0x140012A34
 * Callers:
...
__int64 MiAdjustCachedStacks()
{
  ...
  do
  {
    ...
    do
    {
      v3 = qword_14034EB70;
      v4 = 2 * (result + v1);
      v5 = *((_DWORD *)&qword_14034EB70[v4 + 8].HeaderX64 + 1);
      v6 = v5 - *((_DWORD *)&qword_14034EB70[v4 + 8].HeaderX64 + 2);
      if ( v6 )
      {
        Alignment = qword_14034EB70[v4 + 8].Alignment;
        ...
        *((_DWORD *)&qword_14034EB70[v4 + 8].HeaderX64 + 2) = v5;
        if ( !v13 )
          v13 = 1;
        v14 = v13 + Alignment;
        if ( v14 > 256 )
      ...
      else if ( !*((_DWORD *)&qword_14034EB70[v4 + 8].HeaderX64 + 3) )
      {
        v7 = qword_14034EB70[v4 + 8].Alignment;
        v8 = v7 / 20;
        if ( !(v7 / 20) )
          v8 = v7 != 0;
        v9 = v7 - v8;
        if ( v1 != 1 && v9 < 5 )
          v9 = 5;
        LODWORD(qword_14034EB70[v4 + 8].Alignment) = v9;
        if ( v1 == 1 )
        {
          v10 = 16;
          v11 = 8;
