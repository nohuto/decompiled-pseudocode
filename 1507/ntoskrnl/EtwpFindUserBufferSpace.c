/*
 * XREFs of EtwpFindUserBufferSpace @ 0x1404A257C
 * Callers:
 *     EtwpRealtimeInjectEtwBuffer @ 0x1404A2364 (EtwpRealtimeInjectEtwBuffer.c)
 * Callees:
 *     RtlFindNextAlignedForwardRunClear @ 0x140063858 (RtlFindNextAlignedForwardRunClear.c)
 *     RtlInterlockedSetClearRun @ 0x1400654D8 (RtlInterlockedSetClearRun.c)
