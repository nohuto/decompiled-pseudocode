/*
 * XREFs of PpmSnapPerformanceAccumulation @ 0x1400A7330
 * Callers:
        ...
        LARGE_INTEGER *a5)
{
  ...
  if ( a3 )
  {
    ...
    if ( QuadPart )
    {
      ...
      {
        v26 = a1[3074];
        v9.QuadPart = *(_QWORD *)(v26.QuadPart + 8LL * DWORD2(xmmword_140383008)) >> 1;
        if ( (*(_QWORD *)(v26.QuadPart + 8LL * DWORD2(xmmword_140383008)) & 1) == 0 )
          v9.QuadPart = 0LL;
      }
    }
    if ( !v9.QuadPart )
  ...
  if ( result )
  {
    ...
    if ( v20 )
    {
      if ( a1[3003].LowPart == 3 )
      {
        v20 = *(_QWORD *)(a1[3074].QuadPart + 8LL * DWORD2(xmmword_140383008)) >> 1;
        if ( (*(_QWORD *)(a1[3074].QuadPart + 8LL * DWORD2(xmmword_140383008)) & 1) == 0 )
          v20 = 0LL;
      }
    }
    if ( v9.QuadPart == v20 )
