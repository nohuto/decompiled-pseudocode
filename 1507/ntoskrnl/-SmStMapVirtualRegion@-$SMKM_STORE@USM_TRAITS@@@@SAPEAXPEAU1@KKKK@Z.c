/*
 * XREFs of ?SmStMapVirtualRegion@?$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z @ 0x1401476BC
 * Callers:
        ...
        unsigned __int8 a5)
{
    ...
    else if ( (a5 & 2) == 0 )
    {
      ...
      if ( (*v9 & 0x1FFF) != 0x1FFF )
      {
        while ( 1 )
        {
          ...
          if ( (v11 & 0x1FFF) == 0 )
          {
            v12 = SmAcquireReleaseCharges(v7, 1, 0LL);
            if ( !v12 )
            {
              if ( KeGetCurrentThread() != *(struct _KTHREAD **)(a1 + 4936) )
                return 2LL;
  ...
  if ( v18 && !(unsigned int)SMKM_STORE<SM_TRAITS>::SmStCheckLockInProgressRegionComplete(a1, v18, 0LL) )
    return v16;
  VirtualLockedRegion = SMKM_STORE<SM_TRAITS>::SmStFindVirtualLockedRegion(a1, a5 >> 5, 0LL);
  *(_QWORD *)(a1 + 5024) = v9;
  v20 = VirtualLockedRegion;
  memset(v23, 0, 0x28uLL);
  v23[1] = v24;
  v23[0] = v10;
  if ( !*(_BYTE *)(a1 + 4487) || (LODWORD(v23[2]) = 6, (unsigned __int8)(a5 >> 5) >= 6u) )
    LODWORD(v23[2]) = a5 >> 5;
  if ( (a5 & 1) != 0 )
    HIDWORD(v23[2]) |= 1u;
  v21 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, __int64))SMKM_STORE<SM_TRAITS>::SmStHelperSendCommand)(
          a1,
          4LL,
          v23,
          4LL);
