/*
 * XREFs of PiPnpRtlServiceFilterCallback @ 0x140680078
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall PiPnpRtlServiceFilterCallback(__int64 a1, const WCHAR *a2, unsigned int a3, __int64 a4)
{
  ...
  unsigned int NumberOfBytes; // [rsp+40h] [rbp-99h] BYREF
  char NumberOfBytes_4; // [rsp+44h] [rbp-95h] BYREF
  int v29; // [rsp+48h] [rbp-91h] BYREF
  int v30; // [rsp+4Ch] [rbp-8Dh]
  unsigned int v31; // [rsp+50h] [rbp-89h]
  __int64 v32; // [rsp+58h] [rbp-81h]
  int v33; // [rsp+60h] [rbp-79h]
  const WCHAR *v34; // [rsp+68h] [rbp-71h]
  _DWORD v35[2]; // [rsp+70h] [rbp-69h] BYREF
  _DWORD *v36; // [rsp+78h] [rbp-61h]
  _DWORD v37[2]; // [rsp+80h] [rbp-59h] BYREF
  UNICODE_STRING DestinationString; // [rsp+88h] [rbp-51h] BYREF
  _BYTE v39[76]; // [rsp+A0h] [rbp-39h] BYREF
  __int16 v40; // [rsp+ECh] [rbp+13h]
  ...
  while ( 1 )
  {
    ...
    DeviceRegProp = CmGetDeviceRegProp(v8, v7, 0LL, 5, (__int64)&v29, *(_QWORD *)(a4 + 16), (__int64)&NumberOfBytes);
...
LABEL_16:
      ...
      while ( 1 )
      {
        ...
        {
          NumberOfBytes = 78;
          DeviceRegProp = CmGetDeviceRegProp(v8, v7, 0LL, 9, (__int64)&v29, (__int64)v39, (__int64)&NumberOfBytes);
