/*
 * XREFs of _PnpSetObjectProperty @ 0x1404D8694
 * Callers:
 ...
 *     _CmDeleteDeviceMappedPropertyForAllDriverKeyRegValues @ 0x1407173DC (_CmDeleteDeviceMappedPropertyForAllDriverKeyRegValues.c)
