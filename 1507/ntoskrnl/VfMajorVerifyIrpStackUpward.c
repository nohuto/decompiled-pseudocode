/*
 * XREFs of VfMajorVerifyIrpStackUpward @ 0x140744024
 * Callers:
        ...
        int a5))(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD)
{
  ...
  result = qword_140764898;
  if ( qword_140764898 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD))qword_140764898(
                                                                                     a1,
                                                                                     a2,
                                                                                     *(_QWORD *)(a3 + 8),
                                                                                     a3,
