/*
 * XREFs of SdbpCheckMatchingTextEntry @ 0x140702DFC
 * Callers:
 ...
 *     AslStringSearchA @ 0x140705204 (AslStringSearchA.c)
 *     AslStringSearchW @ 0x140705294 (AslStringSearchW.c)
        ...
        _DWORD *a9)
{
  ...
  _QWORD *v39; // [rsp+38h] [rbp-40h] BYREF
  ...
  *a9 = 0;
  ...
  while ( 1 )
  {
    ...
    v16 = v38;
    v21 = AslFileMappingCreate((__int64 *)&v39, v38, 0LL, 0LL, 0LL);
    v11 = v39;
    v22 = v21;
    if ( v21 >= 0 )
