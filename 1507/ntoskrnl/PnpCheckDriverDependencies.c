/*
 * XREFs of PnpCheckDriverDependencies @ 0x14067DE50
 * Callers:
    ...
    for ( ; *Str1; Str1 += v17 + 1 )
    {
      ...
      if ( !v6 )
      {
        if ( !v20 )
        {
          ...
          v9 = SysCtxRegOpenKey(v8, v21, L"Control\\FirmwareResources", 0, 0x20019u, &v20);
...
LABEL_39:
        ...
        v11 = SysCtxRegOpenKey(v10, (char *)v20, Str1, 0, 1u, &Handle);
        ...
        if ( v11 < 0 )
          goto LABEL_33;
        v22 = 4;
        Value = PnpCtxRegQueryValue(v12, Handle, (__int64)L"Phase", (__int64)v18, (__int64)&v23, (__int64)&v22);
        ...
        if ( v23 != 2 )
          break;
        v22 = 4;
        v15 = PnpCtxRegQueryValue(
                v14,
                Handle,
                (__int64)L"LastAttemptStatus",
                (__int64)v18,
                (__int64)&v24,
                (__int64)&v22);
