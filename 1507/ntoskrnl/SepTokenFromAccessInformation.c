/*
 * XREFs of SepTokenFromAccessInformation @ 0x1400CF4B0
 * Callers:
 *     SeAccessCheckFromState @ 0x1400CF390 (SeAccessCheckFromState.c)
 *     SeTokenFromAccessInformation @ 0x1400CF7A0 (SeTokenFromAccessInformation.c)
 * Callees:
...
__int64 __fastcall SepTokenFromAccessInformation(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 792) = *(_QWORD *)(*(_QWORD *)(a1 + 64) + 8LL);
  ...
  if ( v12 )
    *(_QWORD *)(a2 + 1104) = v12;
  v13 = *(_DWORD *)(a2 + 124);
  *(_DWORD *)(a2 + 200) = *(_DWORD *)(a1 + 44);
  *(_DWORD *)(a2 + 208) = -1;
  *(_DWORD *)(a2 + 212) = *(_DWORD *)(a1 + 40);
  if ( v13 )
  {
    v14 = (_DWORD *)(*(_QWORD *)(a2 + 152) + 8LL);
    do
    {
      if ( (*v14 & 0x40) != 0 && *(_DWORD *)(a2 + 208) == -1 )
        *(_DWORD *)(a2 + 208) = v6;
      ++v6;
      v14 += 4;
    }
