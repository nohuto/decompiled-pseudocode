/*
 * XREFs of MiInitializeNuma @ 0x140597144
 * Callers:
...
__int64 __fastcall MiInitializeNuma(__int64 a1)
{
  ...
  if ( KeNumberNodes )
  {
    ...
    do
    {
      ...
      *v6 = 0LL;
      v6[3] = 0LL;
      *((_DWORD *)v6 - 20) = v4 << byte_14034EB89;
      ...
      if ( qword_14034EB90 )
      {
        ...
        if ( (__int16 *)a1 == MiSystemPartition )
        {
          ...
          for ( i = qword_14034EB90; *(_QWORD *)i != -1LL; i += 16LL )
          {
        ...
        {
          v18 = qword_140353D28;
          *(_DWORD *)((char *)v17 + 1321) = *(_DWORD *)(v16 + qword_140353D28 + 1321);
