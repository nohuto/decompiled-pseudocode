/*
 * XREFs of KiEmulateAtlThunk @ 0x14020BE38
 * Callers:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v24 = (unsigned int)*a2;
  v23 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$AF8612CD83A736763F879D38CB10FD36::$24B86187094815B389AF40DF8BA8CE4C::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
