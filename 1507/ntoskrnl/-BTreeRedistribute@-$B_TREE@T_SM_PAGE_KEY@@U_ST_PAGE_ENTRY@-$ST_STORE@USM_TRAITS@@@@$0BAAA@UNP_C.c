/*
 * XREFs of ?BTreeRedistribute@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@@@SAPEAUNODE@?$B_TREE_HEADER@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@PEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x140143064
 * Callers:
        ...
        __int64 a2)
{
  ...
  else
  {
    ...
    if ( **(_DWORD **)a1 == -1 )
      ...
      v26 = NP_CONTEXT::NpLeafRefInternal(a1, v7, 0);
    *v8 = v26;
    if ( !v26 )
      return 0LL;
  }
