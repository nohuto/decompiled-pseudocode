/*
 * XREFs of PopDiagTraceFirmwareS3Stats @ 0x140403C20
 * Callers:
...
void PopDiagTraceFirmwareS3Stats()
{
  ...
  int NumberOfBytes_4; // [rsp+3Ch] [rbp-15h] BYREF
  int v8; // [rsp+40h] [rbp-11h] BYREF
  unsigned int v9; // [rsp+44h] [rbp-Dh] BYREF
  ...
  int *p_NumberOfBytes_4; // [rsp+78h] [rbp+27h]
  __int64 v16; // [rsp+80h] [rbp+2Fh]

  if ( (unsigned int)off_140321B18() == -1073741820 )
  {
    if ( NumberOfBytes )
    {
