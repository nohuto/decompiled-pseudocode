/*
 * XREFs of ViGetMdlBufferSa @ 0x14073E4D4
 * Callers:
...
__int64 __fastcall ViGetMdlBufferSa(__int64 a1, const void *a2)
{
  ...
  {
    ViHalPreprocessOptions(byte_140323118, "Virtual address %p out of bounds of MDL %p", (const void *)0x1B, a2);
    VfReportIssueWithOptions(230, 27, (int)a2, a1, 0LL, byte_140323118);
  }
  else
  {
    if ( (*(_BYTE *)(a1 + 10) & 5) != 0 )
    ...
    ViHalPreprocessOptions(&dword_140323114, "Dma MDL %p not mapped in system VA.", (const void *)0x22);
    VfReportIssueWithOptions(230, 34, a1, 0, 0LL, &dword_140323114);
  }
  return 0LL;
}
