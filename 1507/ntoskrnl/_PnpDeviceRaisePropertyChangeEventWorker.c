/*
 * XREFs of _PnpDeviceRaisePropertyChangeEventWorker @ 0x1404DF600
 * Callers:
 ...
 *     _PnpHasDerivedKeys @ 0x1404DF944 (_PnpHasDerivedKeys.c)
        ...
        void (__fastcall *a6)(__int64, __int64, __int64))
{
  ...
  wchar_t v26[40]; // [rsp+C0h] [rbp-40h] BYREF
...
LABEL_22:
  ...
  *(_QWORD *)&v18[16] = a5;
  a6(a1, a2, 1LL);
  PnpNotifyDerivedKeys(a1, a2, 1, a5, (__int64)&off_140291380, 9, (__int64)v18, (__int64)a6);
  HasDerivedKeys = PnpHasDerivedKeys(a5, &off_140291320, 3LL);
  v13 = HasDerivedKeys;
  if ( v11 || HasDerivedKeys )
  {
    ...
    if ( ObjectProperty != -1073741275 && ObjectProperty != -1073741772 )
    {
      if ( ObjectProperty < 0 )
        goto LABEL_31;
      if ( RtlCompareMemory(&unk_140291458, Source2, 0x10uLL) == 16 )
        goto LABEL_7;
      if ( PnpStringFromGuid(Source2, v26) < 0 )
      {
LABEL_31:
        *(_QWORD *)v18 = 0LL;
      ...
      {
        *(_QWORD *)v18 = 0LL;
        ((void (__fastcall *)(__int64, wchar_t *, __int64, __int64, _BYTE *))a6)(a1, v26, 5LL, 5LL, v18);
      }
      if ( v13 )
      {
        *(_OWORD *)v18 = 0LL;
        PnpNotifyDerivedKeys(a1, (unsigned int)v26, 5, a5, (__int64)&off_140291320, 3, (__int64)v18, (__int64)a6);
      }
    }
  }
LABEL_7:
  result = PnpHasDerivedKeys(a5, &off_140291368, 1LL);
  if ( v11 || (_BYTE)result )
  {
    v20 = a6;
    BYTE4(v23) = v11;
