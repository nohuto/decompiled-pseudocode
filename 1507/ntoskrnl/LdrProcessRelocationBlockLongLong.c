/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x140597884
 * Callers:
 *     LdrRelocateImage @ 0x1405977B4 (LdrRelocateImage.c)
 * Callees:
 *     LdrpGenericProcessRelocation @ 0x14015FD54 (LdrpGenericProcessRelocation.c)
 *     LdrpArmProcessRelocation @ 0x14024A2C4 (LdrpArmProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x14024A394 (LdrpThumbProcessRelocation.c)
 */
