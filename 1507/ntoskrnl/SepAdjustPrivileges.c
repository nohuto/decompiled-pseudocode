        ...
        _BYTE *a9)
{
  ...
  __int64 v49; // rcx
  __int64 v50; // rcx
  bool v52; // [rsp+31h] [rbp-CFh] BYREF
  bool v53; // [rsp+32h] [rbp-CEh] BYREF
  ...
  *a9 = 0;
  ...
  v14 = (char *)Buf1;
  result = RtlSidDominates((char *)Buf1, (char *)SeHighMandatorySid, &v52);
  v57 = result;
  if ( (int)result < 0 )
    return result;
  v15 = 1;
  if ( !v52 )
  {
    result = RtlSidDominates(v14, *(char **)&SeMediumMandatorySid, &v53);
    v57 = result;
    if ( (int)result < 0 )
      return result;
