/*
 * XREFs of RtlpNameprepAsciiWorker @ 0x1406CCEB4
 * Callers:
 *     RtlIdnToAscii @ 0x1406CCB68 (RtlIdnToAscii.c)
 *     RtlIdnToNameprepUnicode @ 0x1406CCB88 (RtlIdnToNameprepUnicode.c)
 * Callees:
 ...
 *     FindEmailAt @ 0x140249974 (FindEmailAt.c)
 *     RtlpValidateAsciiStd3AndLength @ 0x1406CD280 (RtlpValidateAsciiStd3AndLength.c)
...
LABEL_49:
                  ...
                  result = punycode_encode(DestinationString, v33, v14);
