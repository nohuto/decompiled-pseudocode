/*
 * XREFs of IopTranslateAndAdjustReqDesc @ 0x14059E330
 * Callers:
...
__int64 __fastcall IopTranslateAndAdjustReqDesc(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( !v5 )
    return 3221225485LL;
  *a3 = 0LL;
  PoolWithTag = (char *)ExAllocatePoolWithTag((POOL_TYPE)257, 8LL * v5, 0x20207050u);
  v10 = PoolWithTag;
  if ( !PoolWithTag )
    return 3221225626LL;
  memset(PoolWithTag, 0, 8LL * (unsigned int)*v3);
  v11 = ExAllocatePoolWithTag((POOL_TYPE)257, 4LL * (unsigned int)*v3, 0x20207050u);
  P = v11;
  v12 = v11;
  if ( !v11 )
  {
...
LABEL_32:
    v4 = v8;
  v16 = ExAllocatePoolWithTag((POOL_TYPE)257, 32LL * v6, 0x20207050u);
  if ( v16 )
  {
    v17 = ExAllocatePoolWithTag((POOL_TYPE)257, 0x128uLL, 0x20207050u);
    v34 = v17;
    v18 = v17;
    if ( v17 )
    {
