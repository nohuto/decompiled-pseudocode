/*
 * XREFs of CmpDeleteTree @ 0x14066483C
 * Callers:
...
char __fastcall CmpDeleteTree(ULONG_PTR a1, unsigned int a2)
{
  ...
  for ( i = a2; ; i = v6 )
  {
    while ( 1 )
    {
      v5 = (_DWORD *)(*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, int *))(a1 + 8))(a1, i, &v13);
      if ( !v5 )
        return 0;
      v6 = v5[4];
      if ( !(v5[5] + v5[6]) )
        break;
      SubKeyByNumber = CmpFindSubKeyByNumber(a1, v5, 0, &v12);
      (*(void (__fastcall **)(ULONG_PTR, int *))(a1 + 16))(a1, &v13);
      if ( SubKeyByNumber < 0 )
        return 0;
      if ( v12 == -1 )
        return 0;
      v8 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, int *))(a1 + 8))(a1, v12, &v13);
      if ( !v8 )
        return 0;
      ...
      else if ( (int)CmpFreeKeyByCell(a1, v12, 1, v10) < 0 )
      {
        return 0;
      }
    }
