/*
 * XREFs of _RtlpMuiRegAddBaseLanguage @ 0x14072046C
 * Callers:
...
__int64 __fastcall RtlpMuiRegAddBaseLanguage(__int64 a1, _WORD *a2, unsigned int a3, __int64 a4, wchar_t *a5)
{
  ...
  __int64 v24; // rdx
  _WORD *v25; // rcx
  char v27; // [rsp+30h] [rbp-71h] BYREF
  char v28; // [rsp+31h] [rbp-70h]
  __int16 v29[2]; // [rsp+34h] [rbp-6Dh] BYREF
  char v30; // [rsp+38h] [rbp-69h] BYREF
  char v31; // [rsp+39h] [rbp-68h]
  int v32; // [rsp+3Ch] [rbp-65h] BYREF
  int v33; // [rsp+40h] [rbp-61h]
  wchar_t *Str2; // [rsp+48h] [rbp-59h]
  int inited; // [rsp+50h] [rbp-51h]
  __int64 v36; // [rsp+58h] [rbp-49h]
  signed int v37; // [rsp+60h] [rbp-41h]
  _WORD *v38; // [rsp+68h] [rbp-39h]
  UNICODE_STRING DestinationString; // [rsp+70h] [rbp-31h] BYREF
  _WORD v40[2]; // [rsp+80h] [rbp-21h] BYREF
  __int16 v41; // [rsp+84h] [rbp-1Dh]
  __int16 v42; // [rsp+86h] [rbp-1Bh]
  __int16 v43; // [rsp+88h] [rbp-19h]
  _WORD v44[10]; // [rsp+8Ch] [rbp-15h] BYREF
    ...
    *(_WORD *)(a4 + 2 * v10 + 20) = 0;
    ...
    if ( v28 )
    {
      ...
      *(_WORD *)(a4 + 2 * v10 + 20) = v32;
      ...
      {
        LanguageSpec = RtlpMuiRegGetLanguageSpec(v36, Str2, &v30, v13, (__int16 *)&v32);
        v17 = v30;
        if ( LanguageSpec < 0 )
        {
      ...
      if ( v9 )
      {
        ...
        do
        {
          if ( !*v9 || v19 >= 8 )
            break;
          v20 = RtlpMuiRegGetLanguageSpec(v36, v9, &v27, v13, v29);
          v8 = v27;
          v5 = v29[0];
...
LABEL_43:
          v24 = v37;
          v25 = v38;
          v38[4] = v38[4] & ~(3 << (2 * v37)) | ((v8 & 3) << (2 * v37));
          v25[v24 + 6] = v5;
          return (unsigned int)v14;
        }
        v5 = v42;
    ...
    if ( !v28 )
      goto LABEL_43;
    v40[0] &= ~0x20u;
    v14 = RtlpMuiRegGetOrAddLangInfo((__int64 *)(v36 + 24), (__int64)v40, v29);
    if ( v14 >= 0 )
    {
      v5 = v29[0];
      v8 = 2;
