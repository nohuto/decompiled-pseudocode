/*
 * XREFs of RtlCmDecodeMemIoResource @ 0x14012D89C
 * Callers:
 *     PnpIsRangeWithin @ 0x14059B4D0 (PnpIsRangeWithin.c)
 ...
 *     IopGenericUnpackResource @ 0x14067F6B8 (IopGenericUnpackResource.c)
