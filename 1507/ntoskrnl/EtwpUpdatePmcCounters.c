/*
 * XREFs of EtwpUpdatePmcCounters @ 0x1406E6E30
 * Callers:
...
__int64 __fastcall EtwpUpdatePmcCounters(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a3 - 1 > 3 || *(_DWORD *)(a1 + 316) == 1 )
    return 3221225485LL;
  if ( *(_QWORD *)(a1 + 864) || (result = EtwpAllocatePmcData(a1), !(_DWORD)result) )
  {
    v7 = *(_QWORD *)(a1 + 864);
    if ( *(_DWORD *)(v7 + 28) )
    {
    ...
    else
    {
      ...
      if ( v9 )
      {
        ...
        {
          off_1403219A0(*(POPLOCK *)(v7 + 8 * k + 32));
