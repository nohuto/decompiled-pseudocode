/*
 * XREFs of EtwpApplyScopeFilters @ 0x1404CECE4
 * Callers:
    ...
    do
    {
      ...
      if ( *(_DWORD *)(v10 + v8 + 112) )
      {
        if ( !a2 || (result = *(unsigned __int16 *)(v8 + 72), *(_WORD *)(v10 + v8 + 118) == (_WORD)result) )
        {
          ...
          if ( !v11 )
            goto LABEL_10;
          result = *(_DWORD *)(v11 + 72 * v9) & 0x80000004;
          if ( (_DWORD)result != -2147483644 )
            goto LABEL_29;
          v12 = 0;
          v13 = 0LL;
          result = *(_QWORD *)(v11 + 72 * v9 + 8);
          if ( *(_DWORD *)result )
          {
...
LABEL_22:
          ...
          {
LABEL_29:
            if ( (*(_DWORD *)(v11 + 72 * v9) & 0x80000008) == 0x80000008 )
            {
              result = EtwpApplyExeFilter(a1, *(_QWORD *)(v11 + 72 * v9 + 16));
              v12 = result;
            }
            if ( v12 )
            {
              v14 = *(_QWORD *)(v8 + 368);
              if ( (*(_DWORD *)(v14 + 72 * v9) & 0x80000010) == 0x80000010
                || (result = *(_DWORD *)(v14 + 72 * v9) & 0x80000020, (_DWORD)result == -2147483616) )
              {
                result = EtwpApplyPackageIdFilter(a1, *(_QWORD *)(v14 + 72 * v9 + 24), *(_QWORD *)(v14 + 72 * v9 + 32));
                v12 = result;
              }
              if ( v12 )
              {
