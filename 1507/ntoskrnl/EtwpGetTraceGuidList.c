/*
 * XREFs of EtwpGetTraceGuidList @ 0x14054E108
 * Callers:
...
__int64 __fastcall EtwpGetTraceGuidList(_OWORD *a1, _DWORD *a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  unsigned int v5; // ebp
  unsigned int v6; // edi
  ...
  {
    NextGuidEntry = EtwpGetNextGuidEntry(i, 0, a3, a4);
    if ( !NextGuidEntry )
      break;
    if ( ++v6 > 0xFFFFFFF )
    {
