          ...
          if ( a3 )
          {
            ...
            else if ( a5 )
            {
              if ( (v11 & 0x100000) != 0 )
                ...
                v21 = v12;
              v13 = AlpcpProcessSynchronousRequest((__int64)v16, v11, a3, a4, a5, a6, Address, a8, v12, v21);
            }
            else
            {
              v13 = -1073740027;
...
LABEL_6:
            if ( a5 )
              v13 = AlpcpReceiveMessage(v32, a5, a6, Address, a8);
          ...
          else
          {
            ...
            v33 = 0LL;
            v35 = 0LL;
            v13 = AlpcpSendMessage(v32, a3, a4, v12);
            if ( v13 >= 0 )
              goto LABEL_6;
          }
        }
