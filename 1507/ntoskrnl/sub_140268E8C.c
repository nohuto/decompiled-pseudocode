/*
 * XREFs of sub_140268E8C @ 0x140268E8C
 * Callers:
...
__int64 __fastcall sub_140268E8C(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  unsigned int *v4; // r8
...
LABEL_39:
    if ( v9 >= 0 )
    {
      ...
      if ( qword_14077E3B0 )
      {
        ...
        if ( v29 )
          v30 = 0LL;
        v31 = qword_14077E3B0(v22, v21, v30, v28, &v66);
      }
      else
      {
        v31 = -1073741637;
