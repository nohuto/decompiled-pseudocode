/*
 * XREFs of DbgkpLkmdSnapObject @ 0x1401E14B8
 * Callers:
 *     DbgkpLkmdSnapPendingIrps @ 0x140669F44 (DbgkpLkmdSnapPendingIrps.c)
 * Callees:
 *     <none>
 */
...
LABEL_11:
  result = (*(__int64 (__fastcall **)(__int64, _WORD *, __int64, _QWORD, _QWORD, _QWORD))(a1 + 5184))(
             a1 + 5120,
             a2,
             v7,
             0LL,
