/*
 * XREFs of PopBatteryUpdateCompositeInformation @ 0x1406B6F28
 * Callers:
...
__int64 PopBatteryUpdateCompositeInformation()
{
  ...
  *(__m128i *)((char *)&qword_14032E9E0 + 4) = v10[1];
  ...
  PopChangeCapability(&unk_14032E53F, 0LL);
