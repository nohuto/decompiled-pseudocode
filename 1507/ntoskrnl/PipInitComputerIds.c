/*
 * XREFs of PipInitComputerIds @ 0x1407B6E78
 * Callers:
 ...
 *     PipSmBiosFindStruct @ 0x1407B7C18 (PipSmBiosFindStruct.c)
 */
...
__int64 __fastcall PipInitComputerIds(__int64 a1)
{
  ...
  UNICODE_STRING *v60; // rsi
  __int64 v61; // rdi
  HANDLE v62; // rdi
  __int64 v64; // rdx
  UNICODE_STRING *v65; // rcx
  UNICODE_STRING **v66; // rax
  __int64 v67; // rdx
  ...
  if ( ComputerId >= 0 )
  {
    ...
    *(_DWORD *)&RemainingString.Length = 1572886;
    ...
    if ( ComputerId >= 0 )
    {
      ...
      {
        LODWORD(v70) = v4;
        ComputerId = RtlStringCchPrintfW(pszDest, 8uLL, L"%02x&%02x", v73, v70);
        if ( ComputerId < 0 )
          goto LABEL_107;
      ...
      if ( v72 )
      {
        ComputerId = RtlStringCchPrintfW(&SourceString, 4uLL, L"%x", v72);
        if ( ComputerId < 0 )
          goto LABEL_107;
...
LABEL_98:
          v56 = 112 * v5 + 2;
          PoolWithTag = (wchar_t *)ExAllocatePoolWithTag(PagedPool, v56, 0x6E697050u);
          v58 = PoolWithTag;
          if ( PoolWithTag )
          {
            RemainingString.Buffer = PoolWithTag;
            v59 = 0;
            RemainingString.MaximumLength = v56;
            if ( v5 )
            {
              while ( 1 )
              {
