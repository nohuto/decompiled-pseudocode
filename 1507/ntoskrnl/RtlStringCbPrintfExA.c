/*
 * XREFs of RtlStringCbPrintfExA @ 0x1401DC21C
 * Callers:
        ...
        ...)
{
  ...
  v9 = sub_14016FDA0((__int64)pszDest, cbDest, (__int64)ppszDestEnd, dwFlags);
  if ( v9 < 0 )
  {
    if ( cbDest )
      *pszDest = 0;
  ...
  else
  {
    ...
    {
      v16[0] = 0LL;
      v9 = sub_1401632BC(pszDest, cbDest, v16, v12, va);
      v13 = v16[0];
      v11 = cbDest - v16[0];
      v16[0] = cbDest - v16[0];
      v10 = &pszDest[v13];
...
LABEL_15:
    ...
    {
      sub_1401DC3D0(pszDest, cbDest, 0LL, &v15, v16, dwFlags);
      v10 = v15;
      v11 = v16[0];
    }
