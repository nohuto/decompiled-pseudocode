/*
 * XREFs of CmpFreeDriverList @ 0x1407BA940
 * Callers:
...
__int64 __fastcall CmpFreeDriverList(__int64 a1, _QWORD *a2)
{
  ...
  if ( (_QWORD *)*a2 != a2 )
  {
    do
    {
      ...
      v6 = (_QWORD *)*v2;
      if ( v5 )
        (*(void (__fastcall **)(__int64, _QWORD))(a1 + 32))(v5, *((unsigned __int16 *)v2 + 48));
      v7 = v2[5];
      if ( v7 )
      ...
      result = (*(__int64 (__fastcall **)(_QWORD *, __int64))(a1 + 32))(v2, 120LL);
      v2 = v6;
    }
    while ( v6 != a2 );
  }
