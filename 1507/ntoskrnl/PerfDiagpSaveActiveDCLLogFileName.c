...
void PerfDiagpSaveActiveDCLLogFileName()
{
  ...
  if ( ValueData )
  {
    memset(dword_14032B230, 0, 0xB0uLL);
    wcscpy(&xmmword_14032B1EC, L"WdiContextLog");
    dword_14032B25C = 0x20000;
    RtlInitUnicodeString(&DestinationString, &xmmword_14032B1EC);
    qword_14032B2B8 = (__int64)ValueData;
    word_14032B2B2 = 520;
    dword_14032B230[0] = 176;
    if ( (int)NtTraceControl(3u, dword_14032B230, 0xB0u, dword_14032B230, 0xB0u, (ULONG64)&v2) < 0
