/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x140470BC0
 * Callers:
 ...
 *     ObpCheckDuplicateEntries @ 0x14046FE00 (ObpCheckDuplicateEntries.c)
 *     ObpCompareEntryLevel1 @ 0x140470D80 (ObpCompareEntryLevel1.c)
