/*
 * XREFs of PipCommitPendingService @ 0x1407FA2AC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PipCommitPendingService(__int64 a1, char *a2, void *a3)
{
  char *v4; // rdi
  __int64 v6; // rcx
  ...
  if ( !a3 )
  {
    CachedContextBaseKey = PnpCtxRegOpenKey(*(_QWORD **)&PiPnpRtlCtx, (int)v4, a1, 0, 131097, (__int64)&v18);
    if ( CachedContextBaseKey < 0 )
      goto LABEL_28;
    a3 = v18;
  }
  ...
  {
    v9 = PnpCtxRegOpenKey(*(_QWORD **)&PiPnpRtlCtx, (int)v13, a1, 0, 131097, (__int64)&v14);
        ...
        if ( CachedContextBaseKey >= 0 )
        {
            ...
            && (!v14 || (CachedContextBaseKey = PiDevCfgCopyDeviceKeys(v14, v16, 1, 0LL), CachedContextBaseKey >= 0)) )
          {
            ...
            if ( CachedContextBaseKey >= 0 )
            {
              if ( v14 )
              {
                CachedContextBaseKey = PnpCtxRegDeleteTree(*(__int64 *)&PiPnpRtlCtx, (__int64)v13, a1);
                if ( CachedContextBaseKey < 0 )
                  goto LABEL_28;
                LODWORD(v20) = 0;
