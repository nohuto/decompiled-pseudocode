/*
 * XREFs of _CmEnumSubkeyCallback @ 0x1405A9344
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CmEnumSubkeyCallback(__int64 *a1, char *a2, const wchar_t *a3, __int64 a4)
{
  wchar_t *v8; // r14
  ...
  if ( PoolWithTag )
  {
    ...
    if ( v15 >= 0 )
    {
      if ( *(_DWORD *)a4 < 3u )
      {
        if ( a1 )
          v16 = *a1;
        if ( (int)SysCtxRegOpenKey(v16, a2, a3, 8, 0x20019u, &Handle) < 0 )
          goto LABEL_16;
