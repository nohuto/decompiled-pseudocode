/*
 * XREFs of _CmCreateDeviceInterfaceWorker @ 0x14058B644
 * Callers:
        ...
        __int16 a6)
{
  ...
  {
    DeviceInterfaceClassGuidString = CmGetDeviceInterfaceClassGuidString((__int64)a1, a2, v15);
    if ( DeviceInterfaceClassGuidString >= 0 )
    {
      DeviceInterfaceClassGuidString = CmCreateInterfaceClass((_DWORD)a1, (unsigned int)v15, 0, 0, 0LL, 0);
      if ( DeviceInterfaceClassGuidString >= 0 )
      {
