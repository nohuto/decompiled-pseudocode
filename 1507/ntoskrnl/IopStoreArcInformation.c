/*
 * XREFs of IopStoreArcInformation @ 0x1407E19C0
 * Callers:
...
__int64 __fastcall IopStoreArcInformation(__int64 a1)
{
  ...
  v4 = 0;
  qword_14077EC58 = (__int64)&IoArcTableListHead;
  v5 = (_QWORD *)*v1;
  if ( (_QWORD *)*v1 == v1 )
  {
LABEL_17:
    if ( v3 != &IoArcTableListHead )
    {
      do
      {
        if ( !*((_BYTE *)v3 + 36) && !*((_BYTE *)v3 + 72) )
        {
          ...
          {
            if ( !*((_BYTE *)i + 36) && !*((_BYTE *)i + 72) && v13 == *((_DWORD *)i + 8) )
            {
              *((_BYTE *)v3 + 72) = 1;
              *((_BYTE *)i + 72) = 1;
            }
...
LABEL_41:
    while ( 1 )
    {
      v16 = (PVOID *)IoArcTableListHead;
      if ( IoArcTableListHead == &IoArcTableListHead )
        break;
      v17 = *(_QWORD *)IoArcTableListHead;
      if ( *((PVOID **)IoArcTableListHead + 1) != &IoArcTableListHead || *(PVOID *)(v17 + 8) != IoArcTableListHead )
        __fastfail(3u);
      IoArcTableListHead = *(PVOID *)IoArcTableListHead;
      *(_QWORD *)(v17 + 8) = &IoArcTableListHead;
      ExFreePoolWithTag(v16[3], 0);
