/*
 * XREFs of AdtpBuildPrivilegeAuditString @ 0x14070C314
 * Callers:
 ...
 *     AdtpLookupKnownPrivilegeNameQuickly @ 0x14026DEB4 (AdtpLookupKnownPrivilegeNameQuickly.c)
