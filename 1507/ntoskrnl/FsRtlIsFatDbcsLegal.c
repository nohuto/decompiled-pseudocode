/*
 * XREFs of FsRtlIsFatDbcsLegal @ 0x14053D828
 * Callers:
 *     FsRtlIsFatDbcsLegal @ 0x14053D828 (FsRtlIsFatDbcsLegal.c)
 * Callees:
 *     FsRtlIsFatDbcsLegal @ 0x14053D828 (FsRtlIsFatDbcsLegal.c)
 *     FsRtlDissectDbcs @ 0x14066D970 (FsRtlDissectDbcs.c)
 *     FsRtlDoesDbcsContainWildCards @ 0x14066DA44 (FsRtlDoesDbcsContainWildCards.c)
 */
  ...
  if ( !PathNamePermissible )
  {
    if ( WildCardsPermissible && FsRtlDoesDbcsContainWildCards(DbcsName) )
    {
      for ( i = 0; i < DbcsName->Length; ++i )
      {
        ...
        else if ( (v20 & 0x80u) == 0 && (byte_140295380[v20] & 9) == 0 )
        {
          return 0;
        }
      }
    ...
    if ( DbcsName->Length <= 0xCu )
    {
      ...
      do
      {
        ...
        {
          if ( (v12 & 0x80u) == 0
            && (((WildCardsPermissible != 0 ? 8 : 0) | 1) & byte_140295380[(unsigned __int8)v11[v10]]) == 0 )
          {
            return 0;
          }
          if ( v12 == 46 || v12 == 34 )
