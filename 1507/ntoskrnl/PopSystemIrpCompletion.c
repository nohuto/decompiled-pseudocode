/*
 * XREFs of PopSystemIrpCompletion @ 0x1403EF484
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopPrepChildWake @ 0x1403EF784 (PopPrepChildWake.c)
 *     PopReadyParentSleep @ 0x1403EF7DC (PopReadyParentSleep.c)
 *     PopReadyChildWake @ 0x1403EF850 (PopReadyChildWake.c)
...
__int64 __fastcall PopSystemIrpCompletion(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(v6 - 16) != IopRootDeviceNode )
    v8 = *(v6 - 16);
  v30 = 0;
  v13 = (char *)qword_14032E1F0 + 48;
  v31 = v8;
  if ( (unsigned __int8)(*(_BYTE *)qword_14032E1F0 - 2) <= 1u && *((int *)qword_14032E1F0 + 1) > 1 )
  {
