/*
 * XREFs of WheaReportHwError @ 0x1402666C8
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WheapApplyThresholdChecks @ 0x140266AA4 (WheapApplyThresholdChecks.c)
 *     WheapAttemptErrorRecovery @ 0x140266B80 (WheapAttemptErrorRecovery.c)
...
__int64 __fastcall WheaReportHwError(__int64 a1)
{
  ...
  *(_DWORD *)(v11 + 24) ^= (*(_DWORD *)(v11 + 24) ^ (*(_DWORD *)(a1 + 12) >> 2)) & 8;
  v15 = (*((__int64 (__fastcall **)(__int64, __int64, __int64, __int64, _QWORD))&unk_14036C970 + 6 * *(int *)(v10 + 40)))(
          v10 + 89,
          a1,
          v11 + 40,
          v14,
