/*
 * XREFs of MiContractWsSwapPageFile @ 0x1404FB15C
 * Callers:
...
void __fastcall MiContractWsSwapPageFile(__int64 a1)
{
  ...
  if ( (unsigned int)MiNumberWsSwapPagefiles(a1) )
  {
    ...
    v4 = *(_QWORD **)(v3 + 8LL * v2 + 5344);
    if ( v4[3] >= 0x10000uLL
      && v4[6] >= 0x10000uLL
      && (unsigned __int64)(*v4 - 0x10000LL) >= v4[2]
      && !_InterlockedCompareExchange((volatile signed __int32 *)(v3 + 1008), 1, 0) )
    {
      ExQueueWorkItem((PWORK_QUEUE_ITEM)(v3 + 976), NormalWorkQueue);
    }
  }
}
