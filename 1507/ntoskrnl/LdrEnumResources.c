/*
 * XREFs of LdrEnumResources @ 0x1406CB374
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
  ...
  if ( (v20 & 0x80000000) != 0 )
  {
    ...
    if ( !v17 )
    {
      do
      {
        if ( v7 <= 1 || (v26 = LdrpCompareResourceNamesWithValidation(v18, v10, v8[1], v11, v23, v41), v10 = v38, !v26) )
        {
