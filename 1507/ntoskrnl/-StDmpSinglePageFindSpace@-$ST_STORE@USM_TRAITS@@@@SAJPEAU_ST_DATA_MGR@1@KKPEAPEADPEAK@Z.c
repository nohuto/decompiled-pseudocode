/*
 * XREFs of ?StDmpSinglePageFindSpace@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KKPEAPEADPEAK@Z @ 0x140141F44
 * Callers:
 ...
 *     ?StRegionFindCompact@?$ST_STORE@USM_TRAITS@@@@SAPEAT_ST_REGION_STATE@1@PEAU_ST_DATA_MGR@1@KK@Z @ 0x1401436C0 (-StRegionFindCompact@-$ST_STORE@USM_TRAITS@@@@SAPEAT_ST_REGION_STATE@1@PEAU_ST_DATA_MGR@1@KK@Z.c)
...
LABEL_3:
  ...
  while ( 1 )
  {
    if ( (unsigned __int8)*(_DWORD *)(a1 + 128) == 1 )
    {
      ...
      {
        v14 = ST_STORE<SM_TRAITS>::StDmCheckForCompaction(a1, 0);
        if ( v14 )
        {
      ...
      if ( v20 != -1 )
        v21 = v20;
      Repurpose = ST_STORE<SM_TRAITS>::StRegionFindRepurpose(a1, v21);
    }
    else
    {
