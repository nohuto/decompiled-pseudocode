/*
 * XREFs of AlpcpAllocateSnapshotMessageLog @ 0x14069E7C0
 * Callers:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v3 + 8) = v4;
    ...
    while ( *v5 != (__int64 *)v5 )
    {
      ...
      *v5 = (__int64 *)v7;
      *(_QWORD *)(v7 + 8) = v5;
      v8 = (__int64 **)qword_1403322E8;
      *v6 = (__int64)&AlpcpFreeMessageSnapshotListHead;
      v6[1] = (__int64)v8;
      if ( *v8 != &AlpcpFreeMessageSnapshotListHead )
        __fastfail(3u);
      *v8 = v6;
      qword_1403322E8 = (__int64)v6;
    }
    v9 = (__int64 **)qword_1403322B8;
    *(_QWORD *)v1 = &AlpcpFreeMessageLogListHead;
    *(_QWORD *)(v1 + 8) = v9;
    if ( *v9 != &AlpcpFreeMessageLogListHead )
      __fastfail(3u);
    *v9 = (__int64 *)v1;
    qword_1403322B8 = v1;
  }
