/*
 * XREFs of PopPepCompleteComponentIdleState @ 0x14023B284
 * Callers:
...
char __fastcall PopPepCompleteComponentIdleState(unsigned int *a1, int a2)
{
  ...
  v4 = PopPepLockActivityLink((__int64)a1, (volatile signed __int32 *)v2, 6u, 1u, &v12);
  v5 = *(_QWORD *)(v2 + 64);
  v6 = v4;
  if ( *(_DWORD *)(v5 + 12) == 1 )
  {
    ...
    **(_DWORD **)(v2 + 64) |= 8u;
    ...
    return PopPepReleaseActivityLink((__int64)a1, (_DWORD *)v2, v6, v12);
  }
  else
  {
    PopPepReleaseActivityLink((__int64)a1, (_DWORD *)v2, v4, v12);
    return PopPepProcessEvent((__int64)a1, v2, 1, 6u, v11, 0LL);
  }
}
