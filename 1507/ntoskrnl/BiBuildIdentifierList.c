/*
 * XREFs of BiBuildIdentifierList @ 0x14070EDBC
 * Callers:
 ...
 *     BiLookupObjectByIdentifierAndBootEntry @ 0x140710880 (BiLookupObjectByIdentifierAndBootEntry.c)
 */
...
__int64 __fastcall BiBuildIdentifierList(_QWORD *a1, __int64 a2, _QWORD *a3)
{
  ...
  char **v52; // [rsp+58h] [rbp-31h] BYREF
  ...
  *a3 = a3;
  ...
  if ( v6 >= 0 )
  {
    v6 = BiEnumerateSubKeys(Handle, &v52, (ULONG *)&v53);
    if ( v6 < 0 )
      goto LABEL_57;
    v7 = (unsigned int)v53;
    v8 = 0LL;
    if ( (_DWORD)v53 )
    {
      ...
      do
      {
        RtlInitUnicodeString(&DestinationString, (PCWSTR)v9[v8]);
