/*
 * XREFs of EtwpTraceIo @ 0x14011AA10
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall EtwpTraceIo(int a1, int a2, __int64 a3)
{
  __int64 v4; // r8
  __int64 v5; // rsi
...
LABEL_14:
  ...
  if ( (dword_1403277E0 & 0x100) != 0 )
  {
    ...
    if ( (unsigned int)IoGetActivityIdIrp(a3, &v18) )
      ...
      v17 = &v18;
    return (void *)EtwpDiskProvTraceDisk(v6, &v30, v5, v17);
  }
  return result;
}
