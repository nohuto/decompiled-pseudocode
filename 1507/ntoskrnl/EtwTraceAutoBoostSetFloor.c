/*
 * XREFs of EtwTraceAutoBoostSetFloor @ 0x14025CD44
 * Callers:
...
void *__fastcall EtwTraceAutoBoostSetFloor(__int64 a1, __int64 a2, char a3, char a4, char a5, char a6, int a7, int a8)
{
