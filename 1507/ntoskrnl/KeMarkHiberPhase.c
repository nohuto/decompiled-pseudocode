/*
 * XREFs of KeMarkHiberPhase @ 0x1403F1FBC
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( *(_DWORD *)(v1 + 36) )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      Address,
      ((((((_DWORD)KeNumberProcessors_0 << 6) + 32831) & 0xFFFFFFC0) + 40128) & 0xFFFFF000) + 28672,
      0x6370654Bu);
  }
  else
  {
  ...
  PoSetHiberRange(0LL, 0x10000u, *(PVOID *)(v1 + 25216), v6, 0x7873654Bu);
  v7 = *(void **)(v1 + 23808);
  if ( v7 )
    PoSetHiberRange(0LL, 0x10000u, v7, 0x418uLL, 0x7349654Bu);
  if ( qword_140332AF8 )
    PoSetHiberRange(0LL, 0x10000u, qword_140332AF8, 16 * (unsigned int)(unsigned __int8)qword_140332AE8, 0x7272744Du);
  if ( qword_140332B00 )
    PoSetHiberRange(0LL, 0x10000u, qword_140332B00, 0x58uLL, 0x7272744Du);
  v8 = *(_QWORD **)(v1 + 8);
  v9 = (void *)((v8[6] + 4095LL) & 0xFFFFFFFFFFFFF000uLL);
  v10 = v8[7] - (_QWORD)v9;
  PoSetHiberRange(0LL, 0x10000u, v8, 0x7C0uLL, 0x6874654Bu);
