/*
 * XREFs of _CmMoveBaseContainer @ 0x140715420
 * Callers:
...
__int64 __fastcall CmMoveBaseContainer(__int64 a1, const WCHAR *a2, const WCHAR *a3, __int64 a4)
{
  __int64 v4; // r14
  ...
  if ( DevicesInBaseContainerList >= 0 )
  {
    for ( i = P; *i; i += v12 + 1 )
    {
      ...
      if ( v10 < 0 )
        break;
      v10 = CmAddDeviceToContainer(v4, a4, (__int64)a2, (__int64)i, 0LL);
      if ( v10 < 0 )
        break;
      v12 = -1LL;
      do
