/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x14024A198
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x140249BFC (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x140249C80 (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x1405C7564 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x1405C7574 (Normalization__TableLookup.c)
 */
