/*
 * XREFs of HvlGetPpmStatsForProcessor @ 0x1401ECB90
 * Callers:
...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  {
    v6 = HIDWORD(xmmword_140383008);
    StatisticsPage = a1->StatisticsPage;
    do
    {
      v8 = StatisticsPage[v6];
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_140383018];
    }
    while ( v8 != StatisticsPage[v6] );
    v9 = DWORD1(xmmword_140383018);
  ...
  {
    ReferenceTime = HvlGetReferenceTime();
    v12 = (unsigned int)xmmword_140383018;
    *a2 = ReferenceTime - a1->StatisticsPage[DWORD1(xmmword_140383008)];
