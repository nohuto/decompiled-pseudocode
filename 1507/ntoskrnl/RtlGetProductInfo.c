/*
 * XREFs of RtlGetProductInfo @ 0x14016CA9C
 * Callers:
 *     ExpUpdateProductSuiteType @ 0x1407DFE10 (ExpUpdateProductSuiteType.c)
 * Callees:
 *     sub_14016CBD4 @ 0x14016CBD4 (sub_14016CBD4.c)
        ...
        PULONG ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = *(_OWORD *)Type_8;
  v17 = xmmword_1402A0950;
  if ( (int)sub_14016CBD4(Type_8, &v17) < 0 )
    return 0;
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_140293520, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
