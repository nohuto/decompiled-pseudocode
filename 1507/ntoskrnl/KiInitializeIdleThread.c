/*
 * XREFs of KiInitializeIdleThread @ 0x1403F9B84
 * Callers:
...
unsigned __int64 __fastcall KiInitializeIdleThread(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_BYTE *)(a1 + 195) = 127;
  if ( !*(_DWORD *)(a4 + 36) )
  {
    qword_1403E4EC8 = (__int64)&qword_1403E4EC0;
    qword_1403E4EC0 = (__int64)&qword_1403E4EC0;
  }
  ...
  *(_QWORD *)(a1 + 1824) = 0LL;
  v8 = (__int64 *)(a1 + 1680);
  v9 = (__int64 **)qword_1403E4EC8;
  *v8 = (__int64)&qword_1403E4EC0;
  v8[1] = (__int64)v9;
  if ( *v9 != &qword_1403E4EC0 )
    __fastfail(3u);
  *v9 = v8;
  qword_1403E4EC8 = (__int64)v8;
