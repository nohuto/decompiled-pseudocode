/*
 * XREFs of _CmDeleteCommonClassRegKey @ 0x140712638
 * Callers:
 *     _CmDeleteInstallerClassRegKey @ 0x140713BC0 (_CmDeleteInstallerClassRegKey.c)
 *     _CmDeleteInterfaceClassRegKey @ 0x140713F7C (_CmDeleteInterfaceClassRegKey.c)
 * Callees:
...
__int64 __fastcall CmDeleteCommonClassRegKey(__int64 a1, __int64 a2, int a3, int a4, char a5)
{
  ...
  v10 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, int, _DWORD *))(a1 + 320);
  v17[7] = 0;
  v17[5] = a4;
  v17[4] = a3;
  LOBYTE(v17[6]) = a5;
