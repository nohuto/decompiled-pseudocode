/*
 * XREFs of sub_1406FE610 @ 0x1406FE610
 * Callers:
...
__int64 __fastcall sub_1406FE610(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  unsigned int *v4; // r8
  PVOID v7; // r11
  signed int v8; // ebx
...
LABEL_47:
  if ( v8 >= 0 )
  {
    ...
    if ( qword_14077E3E0 )
    {
      ...
      if ( v34 )
        v35 = 0LL;
      v36 = qword_14077E3E0(v21, v20, v27, v26, v35, v33, &v74);
    }
    else
    {
      v36 = -1073741637;
