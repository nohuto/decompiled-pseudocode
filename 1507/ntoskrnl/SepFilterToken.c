        ...
        _QWORD *a11)
{
  ...
  struct _SID_AND_ATTRIBUTES *v46; // rsi
  int v47; // eax
  unsigned int v48; // ecx
  int v49; // r15d
  struct _SID_AND_ATTRIBUTES *v50; // r15
  int v51; // eax
  __int64 v52; // r8
  int v53; // r14d
  ...
  ULONG v57; // r8d
  NTSTATUS v58; // eax
  struct _SID_AND_ATTRIBUTES *v59; // rsi
  char **v60; // r12
  unsigned int i; // ebx
    ...
    else
    {
      ...
      if ( v20 >= 0 )
      {
        ...
        *((_QWORD *)v30 + 136) = 0LL;
        v109 = v30 + 1088;
        *((_QWORD *)v30 + 99) = 0LL;
        v104 = (__int64 **)(v30 + 792);
        *((_QWORD *)v30 + 98) = 0LL;
        v107 = (unsigned int *)(v30 + 800);
        *((_DWORD *)v30 + 200) = 0;
        v105 = v30 + 808;
...
LABEL_112:
        ...
        v46 = (struct _SID_AND_ATTRIBUTES *)(v30 + 1144);
        v47 = ((_BYTE)v30 + 120) & 7;
        if ( (((_BYTE)v30 + 120) & 7) != 0 )
        {
          v46 = (struct _SID_AND_ATTRIBUTES *)((char *)v46 + (unsigned int)(8 - v47));
          pulResult[0] -= 8 - v47;
        }
        v48 = a8;
        v49 = *((_DWORD *)a1 + 31);
          ...
          *((_DWORD *)v30 + 31) = *((_DWORD *)a1 + 31);
          v58 = RtlCopySidAndAttributesArray(
                  ...
                  *((PSID_AND_ATTRIBUTES *)a1 + 19),
                  ...
                  &RemainingSidArea,
                  pulResult);
          v50 = (struct _SID_AND_ATTRIBUTES *)RemainingSidArea;
          v53 = v58;
          v52 = 0LL;
        }
        v59 = (struct _SID_AND_ATTRIBUTES *)((char *)v46 + (unsigned int)(16 * *((_DWORD *)a1 + 31)));
        v100 = (__int64 **)(v30 + 160);
        *((_QWORD *)v30 + 20) = v59;
        if ( a8 )
        {
          v60 = (char **)a9;
          for ( i = 0; i < a8; ++i )
          {
            ...
            if ( !v62 || SepSidInSidAndAttributes(*((unsigned __int8 ***)a1 + 20), v62, v52, *v60) )
            {
              ...
              ++v59;
              v50 = (struct _SID_AND_ATTRIBUTES *)RemainingSidArea;
              LODWORD((*v100)[2 * *((unsigned int *)v101 + 32) + 1]) = 7;
              ++*((_DWORD *)v64 + 32);
            }
            v60 += 2;
          }
          ...
          if ( v53 >= 0 )
          {
            ...
            if ( v82 >= 0 )
            {
              ...
              *((_QWORD *)Object + 21) = &v68[v75];
              ...
              RtlSidHashInitialize(*v99, v87[31], (_QWORD *)v87 + 29);
              RtlSidHashInitialize(*v100, *((_DWORD *)v71 + 32), (_QWORD *)v87 + 63);
              ...
              SeReleaseSubjectContext(&SubjectContext);
              if ( *v104 )
                RtlSidHashInitialize(*v104, *v107, v105);
              *a11 = v87;
              return (unsigned int)v37;
            }
            ExReleaseResourceLite(v83);
