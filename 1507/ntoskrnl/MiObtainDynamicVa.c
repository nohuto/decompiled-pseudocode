/*
 * XREFs of MiObtainDynamicVa @ 0x140066E20
 * Callers:
...
LABEL_31:
  ...
  RtlSetBitsEx((__int64)v6, v30, a2);
  v31 = v78;
  if ( v78 == 15 )
  {
    v31 = 9;
  ...
  if ( a2 == 1 )
    v4[3] = v30 + 1;
  if ( v4 == &qword_14034EDE0 )
  {
    qword_14034EC48 -= (unsigned __int64)a2 << 21;
    MiReclaimSystemVa(0LL);
  }
  _InterlockedExchangeAdd64(&qword_140350178[v31], a2);
  KeReleaseInStackQueuedSpinLock(&LockHandle);
  return v4[4] + (v30 << 21);
}
