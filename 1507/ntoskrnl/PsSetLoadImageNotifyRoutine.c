/*
 * XREFs of PsSetLoadImageNotifyRoutine @ 0x1405A6F6C
 * Callers:
 *     VerifierPsSetLoadImageNotifyRoutine @ 0x14074249C (VerifierPsSetLoadImageNotifyRoutine.c)
 * Callees:
...
NTSTATUS __stdcall PsSetLoadImageNotifyRoutine(PLOAD_IMAGE_NOTIFY_ROUTINE NotifyRoutine)
{
  ...
  v2 = (struct _EX_RUNDOWN_REF *)ExAllocateCallBack(NotifyRoutine, 0LL);
  if ( v2 )
  {
    v3 = 0LL;
