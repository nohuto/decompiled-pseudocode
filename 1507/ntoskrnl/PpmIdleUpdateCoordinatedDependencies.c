/*
 * XREFs of PpmIdleUpdateCoordinatedDependencies @ 0x1406BE394
 * Callers:
...
__int64 __fastcall PpmIdleUpdateCoordinatedDependencies(_DWORD *a1)
{
  ...
  v1 = 0;
  if ( (((unsigned int)HvlpFlags >> 2) & 1) != 0 && (HvlEnlightenments & 0x400) != 0
    || (((unsigned int)HvlpFlags >> 2) & 1) == 0 && (HvlpFlags & 1) != 0 )
  {
    v3 = 0;
