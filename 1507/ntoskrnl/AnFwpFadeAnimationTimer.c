/*
 * XREFs of AnFwpFadeAnimationTimer @ 0x14075DF88
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140356CF6 )
  {
    ...
    v58 = qword_14031E720;
    v56 = qword_14031E750;
    v10 = 10 * (dword_14031E6D0 - dword_14031E6D0 / (unsigned int)(dword_140323CF4 - dword_14031E6D4));
    v14 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v5 )
      {
        ...
        v32 = 0;
        v33 = *(_QWORD *)(v12 + 24);
        for ( i = *(_QWORD *)(qword_14031E718 + 24); v32 < *(_DWORD *)(v31 + 12); ++v32 )
        {
          v35 = *(_BYTE *)(v32 + i);
          if ( v35 )
          {
    ...
    else
    {
      if ( !v5 )
      {
        ...
        v16 = 0;
        v17 = *(_QWORD *)(v12 + 24);
        v18 = *(_QWORD *)(qword_14031E718 + 24);
        if ( *(_DWORD *)(qword_14031E718 + 12) )
        {
          do
          {
            if ( *(_DWORD *)(v16 + v18) )
    ...
    if ( !v6 )
    {
      if ( !v54 && !v4 || (BgpGxDrawRectangle(v55, (__int64)&xmmword_14031E6F0), !v4) )
        v6 = 1;
    }
    if ( !v7 )
    {
      if ( v54 || v4 )
        BgpGxDrawRectangle(v56, (__int64)&xmmword_14031E728);
      if ( !v30 )
        v7 = 1;
    }
    ...
    if ( v14 || v30 || v4 )
    {
      byte_14031E6E0 = v6;
      byte_14031E6E1 = v7;
      dword_14031E6D0 = v10 / 0xA;
      dword_14031E6D4 = v54 + 1;
      byte_14031E6E2 = v5;
    }
    else
    {
      byte_140356CF6 = 0;
      KeCancelTimer(&stru_14036C6A0);
      KeSetEvent(&stru_14036C680, 0, 0);
    }
  }
  BgpFwReleaseLock();
}
