/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x1404A8598
 * Callers:
 ...
 *     RtlQueryTimeZoneInformation @ 0x1406CC058 (RtlQueryTimeZoneInformation.c)
 * Callees:
...
__int64 __fastcall RtlpQueryTimeZoneInformationWorker(char *a1, size_t Size)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_DWORD *)a1 + 38) = -16;
    ...
    RegistryValues = RtlpQueryRegistryValues(0x40000000LL, Handle, v14, 0LL);
