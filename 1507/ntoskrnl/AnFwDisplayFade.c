/*
 * XREFs of AnFwDisplayFade @ 0x14075D0A8
 * Callers:
...
__int64 __fastcall AnFwDisplayFade(__int64 a1, __int64 a2)
{
  ...
  v45 = 0LL;
  v46 = 0LL;
  if ( (dword_140323CF0 & 0x2000) != 0 )
    goto LABEL_36;
  if ( (dword_140323CF0 & 0x200000) != 0 )
  {
LABEL_69:
  ...
  RegionContext = BgpTxtGetRegionContext(qword_140323D80);
  v8 = BgpTxtGetRegionContext(qword_140323D88);
  v9 = v8;
  if ( !RegionContext || !v8 )
  {
  ...
  xmmword_14031E6F0 = *(_OWORD *)RegionContext;
  qword_14031E700 = *(_QWORD *)(RegionContext + 16);
  dword_14031E708 = *(_DWORD *)(RegionContext + 24);
  xmmword_14031E728 = *(_OWORD *)v8;
  qword_14031E738 = *(_QWORD *)(v8 + 16);
  dword_14031E740 = *(_DWORD *)(v8 + 24);
  ...
  v38 = 0;
  v13 = BgpGxParseBitmap((__int64)Src, &v40);
  v3 = v40;
  SubRectangle = v13;
  if ( v13 < 0 )
    goto LABEL_36;
  ...
  a2 = (unsigned int)qword_140323D4C;
  v18 = qword_140323D4C + dword_140323D54;
  v19 = HIDWORD(qword_140323D4C) + dword_140323D58;
  v20 = xmmword_14031E6F0 + DWORD2(xmmword_14031E6F0);
  LODWORD(v40) = qword_140323D4C;
  v21 = v16 + ((v17 + 15) & 0xFFFFFFF0) + 32 + 2 * (((v17 + 15) & 0xFFFFFFF0) + 32);
  a1 = DWORD1(xmmword_14031E6F0);
  v22 = DWORD1(xmmword_14031E6F0) + HIDWORD(xmmword_14031E6F0);
  v43 = v21;
  if ( (unsigned int)xmmword_14031E6F0 <= (int)qword_140323D4C + dword_140323D54
    && (unsigned int)xmmword_14031E6F0 >= (unsigned int)qword_140323D4C
    && DWORD1(xmmword_14031E6F0) >= HIDWORD(qword_140323D4C)
    && DWORD1(xmmword_14031E6F0) <= v19 )
  {
    if ( v20 < (unsigned int)qword_140323D4C || v20 > v18 || v22 < HIDWORD(qword_140323D4C) || v22 > v19 )
      goto LABEL_52;
    v36 = 1;
  }
  a2 = (unsigned int)xmmword_14031E728;
  v23 = xmmword_14031E728 + DWORD2(xmmword_14031E728);
  a1 = DWORD1(xmmword_14031E728);
  v24 = DWORD1(xmmword_14031E728) + HIDWORD(xmmword_14031E728);
  if ( (unsigned int)xmmword_14031E728 >= (unsigned int)v40
    && (unsigned int)xmmword_14031E728 <= v18
    && DWORD1(xmmword_14031E728) >= HIDWORD(qword_140323D4C)
    && DWORD1(xmmword_14031E728) <= v19 )
  {
    if ( v23 >= (unsigned int)v40 && v23 <= v18 && v24 >= HIDWORD(qword_140323D4C) && v24 <= v19 )
    {
      v37 = 1;
      goto LABEL_12;
    }
...
LABEL_12:
  ...
  {
LABEL_13:
    Rectangle = BgpGxReadRectangle(v44, (__int64)&xmmword_14031E6F0);
  ...
  if ( !v37 )
  {
    v27 = BgpGxReadRectangle(&v45, (__int64)&xmmword_14031E728);
    v4 = (unsigned int *)v45;
    SubRectangle = v27;
    if ( v27 < 0 )
      goto LABEL_36;
  ...
  if ( !v36 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      {
        LODWORD(xmmword_14031E6F0) = (_DWORD)v40 + xmmword_14031E6F0;
        DWORD1(xmmword_14031E6F0) += HIDWORD(v40);
        v2 = (unsigned int *)v44[0];
      }
    }
  }
  if ( !v37 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      {
        LODWORD(xmmword_14031E728) = (_DWORD)v40 + xmmword_14031E728;
        DWORD1(xmmword_14031E728) += HIDWORD(v40);
...
LABEL_35:
    ...
    dword_14031E6D0 = 100;
    qword_14031E6D8 = v29;
    qword_14031E6E8 = (__int64)v2;
    qword_14031E718 = (__int64)v3;
    qword_14031E748 = (__int64)v4;
    KeResetEvent(&stru_14036C680);
    KeInitializeTimerEx(&stru_14036C6A0, NotificationTimer);
    KeInitializeDpc(&stru_14036C6E0, AnFwpFadeAnimationTimer, 0LL);
    byte_140356CF6 = 1;
    LogFwStat(1LL, 7LL, 0LL);
    KeSetCoalescableTimer(&stru_14036C6A0, 0LL, 0x1Eu, 0, &stru_14036C6E0);
