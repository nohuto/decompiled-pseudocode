/*
 * XREFs of KiOpRetrieveRegMemAddress @ 0x14016F9C0
 * Callers:
 *     KiOp_Div @ 0x14016F8D4 (KiOp_Div.c)
 *     KiOp_SGDTSIDT @ 0x14020AA54 (KiOp_SGDTSIDT.c)
 *     KiOp_SLDTSTR @ 0x14020AB7C (KiOp_SLDTSTR.c)
 * Callees:
 *     KiOpComputeLinearAddress @ 0x14020A61C (KiOpComputeLinearAddress.c)
 */
