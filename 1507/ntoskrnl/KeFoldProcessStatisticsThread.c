/*
 * XREFs of KeFoldProcessStatisticsThread @ 0x1400EE4C4
 * Callers:
...
signed __int64 __fastcall KeFoldProcessStatisticsThread(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 600) += *(unsigned int *)(a1 + 340);
  _InterlockedExchangeAdd64((volatile signed __int64 *)(v1 + 1200), *(_QWORD *)(a1 + 1440));
  ...
  result = _InterlockedExchangeAdd64((volatile signed __int64 *)(v1 + 1240), *(_QWORD *)(a1 + 1480));
  v3 = *(_QWORD *)(a1 + 1952);
  if ( v3 )
  {
    v4 = *(_QWORD **)(v1 + 1816);
