/*
 * XREFs of MiFillMapFileInfo @ 0x1406A0750
 * Callers:
  ...
  *(_QWORD *)(a2 + 16) = 0LL;
  ...
  if ( *(_QWORD *)(v6 + 64) )
  {
    ...
    *(_QWORD *)(a2 + 8) = *(_QWORD *)(v10 + 24);
    MI_DEREFERENCE_CONTROL_AREA_FILE(v6, v10);
    MiGetProtoPteAddress(a1, v9, 0, &v18);
    SessionId = MmGetSessionIdEx((struct _KPROCESS *)v7);
    *(_QWORD *)(a2 + 16) ^= (MiStartingOffset((__int64 *)v18, *(_QWORD *)(a1 + 80), SessionId) ^ *(_QWORD *)(a2 + 16)) & 0xFFFFFFFFFFFFLL;
    v12 = *(_QWORD *)(a2 + 16);
    if ( v5 == 2 )
    {
