/*
 * XREFs of _CmDeleteDeviceInterfaceWorker @ 0x140712E68
 * Callers:
...
__int64 __fastcall CmDeleteDeviceInterfaceWorker(__int64 *a1, __int64 a2, __int16 a3, __int64 a4)
{
  ...
  else
  {
    ...
    {
      v9 = *v7;
      v10 = CmDeleteDeviceInterfaceRegKey((__int64)a1, a2, *v7 | 0x30u, a4, 1);
      if ( v10 )
      {
        if ( v10 != -1073741772 && v10 != -1073741811 && v10 != -1073741637 )
          break;
      }
      v10 = CmDeleteDeviceInterfaceRegKey((__int64)a1, a2, v9 | 0x31u, a4, 0);
      if ( v10 )
      {
...
LABEL_36:
    if ( v4 >= 0 )
    {
      DeviceInterfaceMappedPropertyKeys = CmDeleteDeviceInterfaceRegKey((__int64)a1, a2, 48, a4, 1);
      ...
      DeviceInterfaceMappedPropertyKeys = CmDeleteDeviceInterfaceRegKey((__int64)a1, a2, 49, v17, 0);
      if ( DeviceInterfaceMappedPropertyKeys )
      {
