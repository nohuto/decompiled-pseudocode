/*
 * XREFs of MiPfAllocateMdls @ 0x14049E7C0
 * Callers:
...
__int64 __fastcall MiPfAllocateMdls(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  unsigned int v39; // [rsp+54h] [rbp-74h]
...
LABEL_17:
  ...
  v33 = v10 - 1;
LABEL_18:
  v41 = *v7 & 0xFFFFFFFFFFFFFFFCuLL;
  v13 = *v8 & 0xFFFFFFFFFFFFFFFCuLL;
  v14 = ((__int64)(v41 - v13) >> 3) + 1;
  ...
  *((_QWORD *)v15 + 30) = 0LL;
  MiSetInPagePriority((__int64)v15, v39, v38);
  if ( v14 <= 0x10 )
  {
    v19 = v14 << 12;
    Mdl = (PMDL)(v17 + 256);
...
LABEL_21:
    ...
    while ( 1 )
    {
      ...
      if ( v13 >= v23 && v13 < v23 + 8LL * *(unsigned int *)(v20 + 44) )
        break;
      if ( (*(_BYTE *)(v20 + 34) & 2) != 0 && (*(_DWORD *)(v36 + 56) & 0x4000000) != 0 )
      {
        if ( *(_QWORD *)(v20 + 24) )
        {
          ...
          if ( SharedProtos )
          {
            ...
            if ( v13 >= v29 && v13 < v29 + 8LL * *(unsigned int *)(v20 + 44) )
              break;
          }
        }
      }
    ...
    v5 = v43;
    *((_QWORD *)v42 + 12) = v24;
    if ( (*(_BYTE *)v7 & 1) != 0 && (*(_DWORD *)(v36 + 56) & 0x20) != 0 )
    {
