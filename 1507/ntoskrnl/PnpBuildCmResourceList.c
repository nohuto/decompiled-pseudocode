/*
 * XREFs of PnpBuildCmResourceList @ 0x14059CAA8
 * Callers:
 ...
 *     IopParentToRawTranslation @ 0x14059D0C4 (IopParentToRawTranslation.c)
...
LABEL_43:
  ...
  v11 = ExAllocatePoolWithTag(PagedPool, (unsigned int)v40, 0x20207050u);
  v12 = v11;
  if ( !v11 )
  {
    ...
    if ( (_DWORD)v37 )
    {
      ...
      if ( (int)v6 >= 0 )
      {
        ...
        if ( v28 >= 0 )
        {
          ...
          v31 = v40;
          if ( (int)IopWriteResourceList(v29, v38, P, &Destination_8, v12, v40) >= 0 )
          {
            Destination_8 = v43;
            RtlAppendUnicodeToString(&Destination_8, L".Translated");
            IopWriteResourceList(v29, v38, P, &Destination_8, v10, v31);
          }
        }
