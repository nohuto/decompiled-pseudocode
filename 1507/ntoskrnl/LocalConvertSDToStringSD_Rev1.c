/*
 * XREFs of LocalConvertSDToStringSD_Rev1 @ 0x1407097E4
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  unsigned int v61; // [rsp+38h] [rbp-79h]
...
LABEL_19:
    ...
    if ( v11 )
    {
      StringForSid = LocalGetStringForSid(v11);
      if ( StringForSid )
        goto LABEL_24;
    }
    if ( v12 )
    {
      StringForSid = LocalGetStringForSid(v12);
      if ( StringForSid )
        goto LABEL_24;
    }
    v24 = Control;
