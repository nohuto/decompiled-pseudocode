/*
 * XREFs of _CmEnumDevicesInContainerWithCallback @ 0x140714C34
 * Callers:
 *     PiDcResetChildDeviceContainers @ 0x140681488 (PiDcResetChildDeviceContainers.c)
 *     _CmGetContainerBooleanProperty @ 0x140714FE0 (_CmGetContainerBooleanProperty.c)
 * Callees:
...
__int64 __fastcall CmEnumDevicesInContainerWithCallback(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  _QWORD v17[12]; // [rsp+30h] [rbp-59h] BYREF

  LODWORD(v17[0]) = 0;
  memset(&v17[1], 0, 0x50uLL);
  v9 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, _QWORD *))(a1 + 320);
  LODWORD(v17[5]) = 0;
  v17[2] = a3;
  v17[3] = a4;
  v17[4] = a5;
