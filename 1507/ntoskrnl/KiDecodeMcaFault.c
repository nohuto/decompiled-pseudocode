/*
 * XREFs of KiDecodeMcaFault @ 0x14017B51C
 * Callers:
 *     KiMachineCheckControl @ 0x14018D670 (KiMachineCheckControl.c)
 * Callees:
 *     KeTestSpinLock @ 0x1401031E0 (KeTestSpinLock.c)
...
__int64 KiDecodeMcaFault()
{
  ...
  if ( !KeTestSpinLock((PKSPIN_LOCK)CompleteDev + 173) )
    return (*((__int64 (__fastcall **)(_BYTE *, _QWORD))CompleteDev + 70))(CompleteDev + 1384, 0LL);
  v2 = *((unsigned int *)CompleteDev + 339);
  v3 = *((_QWORD *)CompleteDev + 166);
  v4 = (__int64 (__fastcall *)(__int64, __int64, _QWORD, __int64))*((_QWORD *)CompleteDev + 30);
  v5 = *((unsigned int *)CompleteDev + 334);
