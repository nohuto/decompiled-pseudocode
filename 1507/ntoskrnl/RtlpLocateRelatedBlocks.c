/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x14024E64C
 * Callers:
...
LABEL_70:
    ...
    v25 = 2LL * v24;
    if ( v14 )
      word_140322840 = *(_WORD *)(a1 + 140) ^ *(_WORD *)(v14 + 12);
    if ( v15 )
    {
      if ( *(_DWORD *)(a1 + 124) )
      {
    ...
    if ( word_140322840 == (_WORD)result )
    {
      if ( word_140322844 != (*(_WORD *)(a1 + 140) ^ *(_WORD *)(v15 + 8 * v25 + 12)) )
        dword_1403227E8 = 7;
    }
    else
    {
