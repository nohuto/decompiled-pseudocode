/*
 * XREFs of PopQueueQuerySetIrp @ 0x14013733C
 * Callers:
...
LABEL_21:
  ...
  if ( v2 )
  {
    v13 = (__int64 **)qword_14032E268;
    v1->Tail.Overlay.ListEntry.Blink = (struct _LIST_ENTRY *)qword_14032E268;
    ...
    *v13 = (__int64 *)&v1->Tail.Overlay.ListEntry;
    qword_14032E268 = (__int64)&v1->Tail.Overlay.ListEntry;
  }
  Flink = v8[1];
  if ( Flink )
  {
