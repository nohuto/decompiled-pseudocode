/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x14024B9CC
 * Callers:
 *     RtlScrubMemory @ 0x14024B380 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14024B4B0 (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x14024BEC0 (RtlpTestMemoryRandomUp.c)
 */
