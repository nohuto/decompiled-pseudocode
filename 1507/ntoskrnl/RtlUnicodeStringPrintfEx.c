/*
 * XREFs of RtlUnicodeStringPrintfEx @ 0x14015B488
 * Callers:
        ...
        ...)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v18 = (NTSTRSAFE_PCWSTR)&word_140196B30;
      if ( pszFormat )
        v18 = pszFormat;
      v7 = v18;
    }
...
LABEL_17:
    ...
    {
      sub_1401F9F70((_DWORD)Buffer, v9, v6, (unsigned int)&v19, (__int64)&v21, (__int64)v22, dwFlags);
      v13 = v21;
      LOWORD(v14) = v22[0];
      LOWORD(v15) = v19;
    }
