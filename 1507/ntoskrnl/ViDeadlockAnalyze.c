/*
 * XREFs of ViDeadlockAnalyze @ 0x140750548
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x1407501D0 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x140750548 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x140750858 (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)v13 + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(196, 4097, a1, a2, 0LL, byte_1403231A8);
      return 0LL;
    }
    v6 = 0;
LABEL_33:
