/*
 * XREFs of ExRaiseHardError @ 0x1406F78B0
 * Callers:
...
__int64 __fastcall ExRaiseHardError(int a1, unsigned int a2, int a3, char *a4, int a5, int *a6)
{
  ...
  ULONG_PTR RegionSize; // [rsp+58h] [rbp-130h] BYREF
  unsigned int v23; // [rsp+60h] [rbp-128h]
  int v24; // [rsp+68h] [rbp-120h]
  int v25; // [rsp+70h] [rbp-118h]
  char *v26; // [rsp+78h] [rbp-110h]
  PVOID v27; // [rsp+80h] [rbp-108h]
  int *v28; // [rsp+88h] [rbp-100h]
  const void *v29; // [rsp+90h] [rbp-F8h]
