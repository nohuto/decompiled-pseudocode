/*
 * XREFs of AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x140708A50
 * Callers:
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x140708BE8 (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
 * Callees:
 *     <none>
 */
