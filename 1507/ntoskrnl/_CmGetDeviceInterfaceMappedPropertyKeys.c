/*
 * XREFs of _CmGetDeviceInterfaceMappedPropertyKeys @ 0x140717C04
 * Callers:
        ...
        __int64 a7)
{
  ...
  _DWORD pcbLength[18]; // [rsp+40h] [rbp-48h] BYREF
  __int64 v29; // [rsp+90h] [rbp+8h]
  const wchar_t *v30; // [rsp+98h] [rbp+10h]

  v30 = a2;
  v29 = a1;
  v7 = (unsigned int *)a7;
  v8 = (__int64 *)&off_140721C78;
  v9 = 0;
  v11 = (char *)a3;
  *(_DWORD *)a7 = 0;
  v12 = 0;
