/*
 * XREFs of RtlpHeapExceptionFilter @ 0x140248508
 * Callers:
 ...
 *     RtlpHpFreeWithExceptionProtection @ 0x140246B80 (RtlpHpFreeWithExceptionProtection.c)
...
__int64 __fastcall RtlpHeapExceptionFilter(int a1, __int64 a2)
{
  ...
  if ( a1 == -1073741571 || a1 == -1073741420 || a1 == -1073741801 )
    return 0LL;
  v2 = *(_OWORD **)a2;
  unk_140322950 = *(_OWORD *)*(_QWORD *)a2;
  *((_OWORD *)&unk_140322950 + 1) = v2[1];
  *((_OWORD *)&unk_140322950 + 2) = v2[2];
  *((_OWORD *)&unk_140322950 + 3) = v2[3];
  *((_OWORD *)&unk_140322950 + 4) = v2[4];
  *((_OWORD *)&unk_140322950 + 5) = v2[5];
  *((_OWORD *)&unk_140322950 + 6) = v2[6];
  *((_OWORD *)&unk_140322950 + 7) = v2[7];
  *((_OWORD *)&unk_140322950 + 8) = v2[8];
  *((_QWORD *)&unk_140322950 + 18) = *((_QWORD *)v2 + 18);
  v3 = &unk_1403229F0;
  v4 = *(_OWORD **)(a2 + 8);
  v5 = 9LL;
  do
