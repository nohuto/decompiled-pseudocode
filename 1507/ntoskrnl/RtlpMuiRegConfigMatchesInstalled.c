/*
 * XREFs of RtlpMuiRegConfigMatchesInstalled @ 0x14071F650
 * Callers:
 *     RtlpMuiRegValidateConfigNode @ 0x140272D4C (RtlpMuiRegValidateConfigNode.c)
 * Callees:
...
LABEL_4:
  ...
  if ( a2 && a4 )
  {
    ...
    else
    {
      ...
      {
        v22 = (wchar_t *)sub_14015E11C(a1, 0x55u);
        v10 = v22;
        if ( v22 )
        {
