/*
 * XREFs of SymCryptParallelHashSetNextWork @ 0x14026CDFC
 * Callers:
 *     SymCryptParallelHashProcess @ 0x14026C988 (SymCryptParallelHashProcess.c)
 * Callees:
 *     memmove @ 0x140195740 (memmove.c)
 *     SymCryptParallelSha256Result1 @ 0x14026C848 (SymCryptParallelSha256Result1.c)
 *     SymCryptParallelSha256Result2 @ 0x14026C8D0 (SymCryptParallelSha256Result2.c)
