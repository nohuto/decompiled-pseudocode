/*
 * XREFs of ExpAcquireFastMutexContended @ 0x1400F2E54
 * Callers:
 ...
 *     FsRtlAcquireHeaderMutex @ 0x14004E880 (FsRtlAcquireHeaderMutex.c)
 ...
 *     KeAcquireGuardedMutex @ 0x140102D90 (KeAcquireGuardedMutex.c)
 ...
 *     ExEnterCriticalRegionAndAcquireFastMutexUnsafe @ 0x140107640 (ExEnterCriticalRegionAndAcquireFastMutexUnsafe.c)
 ...
 *     KeAcquireGuardedMutexUnsafe @ 0x14017DFD4 (KeAcquireGuardedMutexUnsafe.c)
  ...
  do
  {
    while ( (result & 1) == 0 )
    {
      ...
      if ( v8 == (_DWORD)result )
      {
        ...
        v5 = 2;
        if ( a2 )
          a2 = KeAbPreAcquire(BugCheckParameter2, a2, 0LL, v9);
        goto LABEL_2;
      }
    }
    v7 = result;
