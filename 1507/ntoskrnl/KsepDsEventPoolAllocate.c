/*
 * XREFs of KsepDsEventPoolAllocate @ 0x14020D5C4
 * Callers:
 *     KseDsHookExAllocatePool @ 0x14020CA88 (KseDsHookExAllocatePool.c)
 *     KseDsHookExAllocatePoolWithTag @ 0x14020CAD4 (KseDsHookExAllocatePoolWithTag.c)
 * Callees:
