/*
 * XREFs of ObCheckActiveHandles @ 0x1405469D4
 * Callers:
...
bool __fastcall ObCheckActiveHandles(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v7 = KeAbPreAcquire(a1 - 32, 0LL, 0LL, a4);
  v10 = v7;
