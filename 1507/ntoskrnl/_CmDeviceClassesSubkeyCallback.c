/*
 * XREFs of _CmDeviceClassesSubkeyCallback @ 0x1405A8E28
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CmDeviceClassesSubkeyCallback(__int64 *a1, char *a2, const wchar_t *a3, __int64 a4)
{
  unsigned int v5; // r8d
  ...
  if ( v5 >= 3 && (v5 != 3 || !*(_BYTE *)(a4 + 1428))
    || (!a1 ? (v22 = 0LL) : (v22 = *a1), (int)SysCtxRegOpenKey(v22, a2, a3, 8, 0x20019u, &Handle) >= 0) )
  {
    v13 = *(_DWORD *)a4;
    if ( *(_DWORD *)a4 >= 3u )
    {
