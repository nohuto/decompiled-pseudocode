/*
 * XREFs of ExEnterPriorityRegionAndAcquireResourceExclusive @ 0x1400C88C0
 * Callers:
 ...
 *     VerifierExEnterPriorityRegionAndAcquireResourceExclusiveNoReboot @ 0x14074C1D0 (VerifierExEnterPriorityRegionAndAcquireResourceExclusiveNoReboot.c)
 * Callees:
