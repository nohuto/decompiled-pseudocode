/*
 * XREFs of CmpCopySyncTree2 @ 0x1405850E0
 * Callers:
        ...
        int a7)
{
  ...
  _DWORD *v70; // [rsp+A0h] [rbp-19h]
  unsigned int v71; // [rsp+A8h] [rbp-11h] BYREF
  int v72; // [rsp+ACh] [rbp-Dh] BYREF
  unsigned __int16 v73[36]; // [rsp+B0h] [rbp-9h] BYREF
...
LABEL_5:
  ...
  while ( 1 )
  {
    ...
    v16 = (_DWORD *)(*(__int64 (__fastcall **)(__int64, _QWORD, int *))(a4 + 8))(a4, *v14, &v65);
    v70 = v16;
    v15 = v16;
    if ( !v16 )
      break;
    ...
    if ( v72 == -1 || !v54 && v72 < 0 )
    {
      if ( v76 && a7 != 2 )
      {
        ...
        if ( v54 )
          ...
          v33 = 0;
        if ( *(_DWORD *)(v30 + 20) + *(_DWORD *)(v30 + 24) > (unsigned int)(v15[5] + v33) )
          CmpSyncSubKeysAfterDelete(a4, (_DWORD)v15, BugCheckParameter2, v30, (__int64)P);
    ...
    if ( v76 )
    {
      ...
      CmpInitializeKeyNameString(v18);
...
LABEL_44:
      ...
      if ( (v14[4] & 2) == 0 )
      {
        if ( HvpMarkCellDirty(BugCheckParameter2, v14[1], 0, 0LL) )
        {
          *((_BYTE *)v14 + 16) |= 2u;
          goto LABEL_46;
        }
...
LABEL_46:
      if ( !CmpAddSubKeyEx(BugCheckParameter2, v14[1], v20, v70[(v17 >> 31) + 5]) )
        goto LABEL_63;
      v40 = v14[1];
      v63 = -1;
      v59 = -1;
