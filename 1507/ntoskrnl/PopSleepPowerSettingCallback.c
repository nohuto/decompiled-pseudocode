/*
 * XREFs of PopSleepPowerSettingCallback @ 0x14059905C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopSleepPowerSettingCallback(__int64 *a1, int *a2, int a3)
{
  ...
  if ( !v20 && a3 == 4 && a2 )
  {
    v21 = *a2;
    HIDWORD(v30) = *a2;
    if ( HIBYTE(word_14032E524) || byte_14032E523 || (_BYTE)word_14032E524 )
      LODWORD(v30) = 2;
    v6 = 0;
  }
  else
  ...
  {
    LOBYTE(v22) = 1;
    v6 = PopApplyPolicy(v22, 0LL, v29, 232LL);
  }
