/*
 * XREFs of PnpProcessRelation @ 0x140535938
 * Callers:
 ...
 *     PnpProcessBusRelations @ 0x140535B78 (PnpProcessBusRelations.c)
 * Callees:
        ...
        ULONG_PTR BugCheckParameter3)
{
  ...
  {
    v9 = *(_DWORD *)(a1 + 300);
    if ( v9 == 788 || (unsigned int)(v9 - 782) <= 1 )
      return 3221225473LL;
    if ( *(int *)(a1 + 656) > 0 || ((v9 - 785) & 0xFFFFFFFD) == 0 )
    {
      *a4 = 5;
      RtlCopyUnicodeString(DestinationString, (PCUNICODE_STRING)(a1 + 40));
      return 3221225473LL;
    }
    if ( (unsigned int)(v9 - 778) <= 1 )
      return 3221225488LL;
  }
  v10 = IopAddRelationToList(BugCheckParameter3, *(_QWORD *)(a1 + 32), a3, 0LL);
      ...
      if ( v72 )
      {
        ...
        if ( v76 )
        {
          ...
          if ( v75 )
            ...
            LODWORD(v77) = 0;
          IoAddTriageDumpDataBlock(v77, 712);
          if ( *(_WORD *)(v95 + 40) )
          {
      ...
      if ( v52 )
      {
        ...
        if ( v56 )
        {
          ...
          if ( v55 )
            ...
            LODWORD(v58) = 0;
          IoAddTriageDumpDataBlock(v58, 712);
          if ( *(_WORD *)(v57 + 40) )
          {
      ...
      for ( i = 0; (unsigned int)v16 < *(_DWORD *)P[0]; i = v16 )
      {
        ...
        if ( (*(_DWORD *)(v17 + 32) & 2) != 0 )
        {
          ...
          if ( v28 )
          {
            ...
            IoAddTriageDumpDataBlock(v28, 712);
            if ( *v29 )
            {
        ...
        if ( !v18 || !*(_QWORD *)(v18 + 16) )
        {
          ...
          if ( v21 )
          {
            ...
            IoAddTriageDumpDataBlock(v21, 712);
            if ( *v22 )
            {
          ...
          while ( 1 )
          {
            ...
            if ( (*(_DWORD *)(v34 + 32) & 2) != 0 )
            {
              ...
              if ( v45 )
              {
                ...
                IoAddTriageDumpDataBlock(v45, 712);
                if ( *v46 )
                {
            ...
            if ( !v35 || !*(_QWORD *)(v35 + 16) )
            {
              ...
              if ( v38 )
              {
                ...
                IoAddTriageDumpDataBlock(v38, 712);
                if ( *v39 )
                {
...
LABEL_67:
  ...
  result = PnpProcessDependencyRelations(a1, v14, v98 != 0, a4, DestinationString, BugCheckParameter3);
  if ( (int)result < 0 )
    return result;
