/*
 * XREFs of VfThunkAddSpecialDriverThunks @ 0x1407449E0
 * Callers:
 ...
 *     ViThunkFindNextSpecialTable @ 0x14074517C (ViThunkFindNextSpecialTable.c)
 *     ViThunkRecoverPristines @ 0x1407451CC (ViThunkRecoverPristines.c)
 */
