/*
 * XREFs of PopInvokeSystemStateHandler @ 0x1403F2FAC
 * Callers:
 ...
 *     KeRebaselineSystemTime @ 0x14014C9EC (KeRebaselineSystemTime.c)
...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    qword_1403538F8 = (__int64)v7;
    qword_140353910 = (__int64)&PopPowerStateNotifyHandler;
    v12 = &PopHibernateSystemContext;
    byte_14035391C = BYTE4(DeferredContext[5]);
    dword_140353920 = DeferredContext[6];
    qword_140353900 = v8;
    qword_140353908 = v6;
    dword_140353918 = v2;
    dword_14035392C = KeNumberProcessors_0;
    dword_140353928 = DeferredContext[7];
  ...
  if ( SLODWORD(v28[4].Next) >= 0 )
  {
    *((_BYTE *)v12 + 44) = 1;
    ...
    if ( a2 )
    {
      ...
      MmInvalidateDumpAddresses(xmmword_14032E8C8, 0xDuLL);
      v18 = *(_QWORD *)(a2 + 312);
      if ( v18 )
  ...
  if ( a2 )
  {
    if ( Next == -1073741632 )
    {
      ...
      *(_BYTE *)a2 = 1;
LABEL_52:
      v20 = qword_14032E4E0 == 0;
      *v12 = (__int64)&unk_14032E4D8;
      v12[3] = 0LL;
      if ( !v20 )
        PopIssueNextState(v12, v28, 5LL);
  ...
  if ( Next >= 0 )
  {
    if ( dword_14032E660 != 4 || PoResumeFromHibernate )
    {
      v21 = 0;
    ...
    if ( v21 )
      qword_14032EBB8 = PopQpcFrequency / 0x3E8uLL * (v24.QuadPart / (1000 * (unsigned __int64)KeGetCurrentPrcb()->MHz))
  ...
  if ( a2 )
  {
    if ( Next == 1073742484 && !byte_14032E8E1 && byte_1403538D0 )
