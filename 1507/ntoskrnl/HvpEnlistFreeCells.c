/*
 * XREFs of HvpEnlistFreeCells @ 0x1404A0490
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( (int)v10 >= 0 )
      {
        if ( (unsigned int)v10 > (unsigned int)v3 || (unsigned __int64)v4 + v10 > v9 || (v10 & 7) != 0 || !(_DWORD)v10 )
        {
          ...
          v12 = v3 - (_DWORD)v4 + a2;
          *v4 = v12;
          memset(v4 + 1, 0, v12 - 4LL);
          LODWORD(v10) = *v4;
          *(_DWORD *)(*(_QWORD *)(BugCheckParameter2 + 64) + 4088LL) |= 4u;
        }
        HvpEnlistFreeCell(BugCheckParameter2, (unsigned int)(a3 + (_DWORD)v4 - a2), v10, 0, 0);
      ...
      else
      {
          ...
          || !(_DWORD)v10 )
        {
          ...
          v13 = v3 - (_DWORD)v4 + a2;
          *v4 = v13;
          memset(v4 + 1, 0, v13 - 4LL);
          LODWORD(v10) = *v4;
          HvpEnlistFreeCell(BugCheckParameter2, (unsigned int)(a3 + (_DWORD)v4 - a2), *v4, 0, 0);
          *(_DWORD *)(*(_QWORD *)(BugCheckParameter2 + 64) + 4088LL) |= 4u;
          *(_DWORD *)(BugCheckParameter2 + 132) += v10;
        }
