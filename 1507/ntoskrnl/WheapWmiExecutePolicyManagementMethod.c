/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x140267DC8
 * Callers:
 *     WheapWmiExecuteMethod @ 0x140267CA8 (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapGetAllPolicyBufferSize @ 0x1405C759C (WheapGetAllPolicyBufferSize.c)
 *     WheapCommitPolicy @ 0x1406FCD10 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyValues @ 0x1406FCDF4 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x1406FCE34 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x1406FCEB8 (WheapSetPolicyValue.c)
 */
