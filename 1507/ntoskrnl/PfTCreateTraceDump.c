/*
 * XREFs of PfTCreateTraceDump @ 0x1404F87C0
 * Callers:
...
__int64 __fastcall PfTCreateTraceDump(_QWORD *a1)
{
  ...
  v5 = 0;
  v6 = 0;
  for ( i = 0; (__int64 *)v2 != &qword_140350258; v2 = *(_QWORD *)v2 )
    i += *(_DWORD *)(v2 + 32);
  v8 = 2LL * i;
  ...
  *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 8) = PoolWithTag;
  ...
  v10 = qword_140350260;
  v11 = &qword_140350230;
  *(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 2) = *(_WORD *)(qword_140350260 + 36);
  do
  {
    v11 = (__int64 *)v11[1];
    v12 = 0;
    *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40) = v11;
    if ( !*((_DWORD *)v11 + 4) )
      continue;
      ...
      do
      {
        ...
        if ( v18 != 0xFFFF )
        {
          ...
          if ( v18 < v19 || v18 >= (unsigned int)v19 + *(_DWORD *)(v3 + 32) )
          {
            ...
            {
              v69 = *(_QWORD *)(v69 + 8);
              if ( (__int64 *)v69 == &qword_140350258 )
                v69 = v10;
              if ( v69 == v3 )
                break;
              v70 = *(_WORD *)(v69 + 36);
...
LABEL_16:
      ...
      while ( v17 );
      v11 = *(__int64 **)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40);
...
LABEL_24:
  ...
  while ( v11 != (__int64 *)qword_140350230 );
  if ( v5 )
  {
    v26 = 16 * v5;
    v27 = 32 * v6;
    ...
    *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58) = v29;
    v30 = v29;
    if ( v29 )
    {
      *v1 = 0;
      ...
      *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40) = v38;
      *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0xB8) = v38;
      v30[8] = 24;
      *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48) = v37;
      while ( 1 )
      {
        v33 = (__int64 *)v33[1];
        *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x60) = v33;
        if ( *((_DWORD *)v33 + 4) )
        {
          v40 = ((unsigned __int64)v33 + 31) & 0xFFFFFFFFFFFFFFF8uLL;
          *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68) = v40;
          do
          {
              ...
              do
              {
                ...
                if ( v48 != 0xFFFF )
                {
                  ...
                  if ( v48 < v49 || v48 >= (unsigned int)v49 + *(_DWORD *)(v3 + 32) )
                  {
                    ...
                    {
                      v67 = *(_QWORD *)(v67 + 8);
                      if ( (__int64 *)v67 == &qword_140350258 )
                        v67 = v45;
                      if ( v67 == v3 )
                        break;
                      v68 = *(_WORD *)(v67 + 36);
...
LABEL_51:
              ...
              v52 = *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48);
              if ( v51 )
              {
                v53 = *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 8);
                v54 = (unsigned __int16)(*(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x10)
                                       - *(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 2));
                LOWORD(v55) = *(_WORD *)(v53 + 2 * v54);
                if ( (_WORD)v55 == 0xFFFF )
                {
                  v55 = (unsigned __int16)*v1;
                  v63 = *v1 + 1;
                  *(_WORD *)(v53 + 2 * v54) = v55;
                  v64 = 32LL * v55;
                  *v1 = v63;
              ...
              v56 = *(_OWORD **)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38);
              if ( v56 )
              {
                v57 = *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 8);
                v58 = (unsigned __int16)(*(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x28)
                                       - *(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 2));
                LOWORD(v59) = *(_WORD *)(v57 + 2 * v58);
                if ( (_WORD)v59 == 0xFFFF )
                {
                  v59 = (unsigned __int16)*v1;
                  v65 = *v1 + 1;
                  *(_WORD *)(v57 + 2 * v58) = v59;
                  v66 = 32LL * v59;
                  *v1 = v65;
            ...
            v33 = *(__int64 **)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x60);
            v32 = v31 + 24;
            v37 = *(char **)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48);
            ++v4;
            v40 = *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68);
          }
          while ( v4 < *((_DWORD *)v33 + 4) );
        }
        if ( v33 == (__int64 *)qword_140350230 )
          break;
        v4 = 0;
      }
      v60 = *(_DWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0xB8) - *((_DWORD *)v31 + 4) - (_DWORD)v31;
      *((_WORD *)v31 + 7) = *(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC6);
      v61 = 0;
      *((_DWORD *)v31 + 5) = v60;
      *a1 = *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58);
    }
    else
    {
      v61 = -1073741670;
...
LABEL_63:
  PfTFreeBufferList(&unk_140350218);
  PfTFreeBufferList(&unk_140350240);
  return v61;
}
