/*
 * XREFs of ExFreePoolSanityChecks @ 0x140758D44
 * Callers:
 ...
 *     KevSkipVerification @ 0x140272778 (KevSkipVerification.c)
 */
...
__int64 ExFreePoolSanityChecks()
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( !ExpSpecialAllocations || (result = MmIsSpecialPoolAddress(v1), !(_DWORD)result) )
    {
      ...
      {
        if ( (v1 & 0xF) != 0 )
          KeBugCheckEx(0xC4u, 0x16uLL, 0x1E3BuLL, v1, v2);
        v5 = (unsigned int *)(v1 - 16);
        v6 = *(_BYTE *)(v1 - 16 + 3);
        if ( (v6 & 3) == 0 )
          KeBugCheckEx(0xC4u, 0x13uLL, 0x1E45uLL, (ULONG_PTR)v5, *v5);
        ...
        if ( (v6 & 2) == 0 )
          KeBugCheckEx(0xC4u, 0x14uLL, 0x1E62uLL, (ULONG_PTR)v5, v2);
      }
      else
      {
