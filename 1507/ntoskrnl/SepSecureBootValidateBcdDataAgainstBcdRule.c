/*
 * XREFs of SepSecureBootValidateBcdDataAgainstBcdRule @ 0x1406D6E14
 * Callers:
 ...
 *     SepSecureBootGetQWordPolicyValue @ 0x1406D6C54 (SepSecureBootGetQWordPolicyValue.c)
 */
    ...
    switch ( *(_BYTE *)(a1 + 7) & 0xF )
    {
      ...
      case 5:
        if ( a3 != 8 )
          return (unsigned int)-1069350910;
        v7 = *a2;
        v8 = qword_1403861E0 + *(unsigned int *)(a1 + 8);
        v10 = *a2;
