/*
 * XREFs of PnpFilterResourceRequirementsList @ 0x14059F0BC
 * Callers:
 ...
 *     RtlIoDecodeMemIoResource @ 0x140164278 (RtlIoDecodeMemIoResource.c)
...
__int64 __fastcall PnpFilterResourceRequirementsList(_DWORD *Src, _DWORD *a2, char **a3, _DWORD *a4)
{
  unsigned int v4; // ebx
  ...
  unsigned int v69; // [rsp+28h] [rbp-89h]
  int v70; // [rsp+2Ch] [rbp-85h]
  int v71; // [rsp+30h] [rbp-81h]
  int v72; // [rsp+38h] [rbp-79h]
  __int16 v73; // [rsp+3Ch] [rbp-75h]
  unsigned int v74; // [rsp+40h] [rbp-71h]
  unsigned __int64 Start; // [rsp+48h] [rbp-69h] BYREF
  unsigned __int64 Alignment; // [rsp+50h] [rbp-61h] BYREF
  unsigned __int64 MaximumAddress; // [rsp+58h] [rbp-59h] BYREF
  int v78; // [rsp+60h] [rbp-51h]
  unsigned __int64 MinimumAddress; // [rsp+68h] [rbp-49h] BYREF
  int v80; // [rsp+70h] [rbp-41h]
  struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *v81; // [rsp+78h] [rbp-39h]
  unsigned int v82; // [rsp+80h] [rbp-31h]
  unsigned __int64 v83; // [rsp+88h] [rbp-29h]
  int v84; // [rsp+90h] [rbp-21h]
  int v85; // [rsp+94h] [rbp-1Dh]
  int v86; // [rsp+98h] [rbp-19h]
  _DWORD *v87; // [rsp+A0h] [rbp-11h]
  ULONGLONG v88; // [rsp+A8h] [rbp-9h]
  __int64 v89; // [rsp+B0h] [rbp-1h]
  _DWORD *v90; // [rsp+B8h] [rbp+7h]
  unsigned int *v91; // [rsp+C0h] [rbp+Fh]
  int v92; // [rsp+118h] [rbp+67h]
...
LABEL_79:
  ...
  {
    *a3 = PnpCmResourcesToIoResources(0xFFFFLL, (_DWORD *)Vector, 1);
  }
  ExFreePoolWithTag(v10, 0);
  return v4;
}
