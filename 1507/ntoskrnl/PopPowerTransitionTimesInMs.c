/*
 * XREFs of PopPowerTransitionTimesInMs @ 0x140148B80
 * Callers:
...
unsigned __int64 __fastcall PopPowerTransitionTimesInMs(_DWORD *a1, __int64 a2, _DWORD *a3, _DWORD *a4, __int64 a5)
{
  ...
  if ( a1 )
  {
    result = PopQpcTimeInMs(&qword_14032EB88, &qword_14032EB90);
    *a1 = result;
  }
  if ( v8 )
  {
    result = PopQpcTimeInMs(&qword_14032EB98, &qword_14032EBA0);
    *v11 = result;
  }
  if ( a5 )
  {
    v14 = 0LL;
    result = PopQpcTimeInMs(&v14, &qword_14032EBB8);
    v13 = PoResumeFromHibernate == 0;
    *v12 = result;
    if ( !v13 )
    {
      result = (unsigned int)(dword_14032EC28 + result);
      *v12 = result;
    }
  }
  if ( a3 )
  {
    result = qword_14032EBF8 / v10;
    *a3 = qword_14032EBF8 / v10;
  }
  if ( a4 )
  {
    result = (qword_14032ED18 + qword_14032EC60) / v10;
    *a4 = result;
  }
  return result;
}
