/*
 * XREFs of ?StDmPageMove@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@T_SM_PAGE_KEY@@K@Z @ 0x140255040
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageMove(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  __int64 v20; // rax
  int v21; // r9d
  unsigned int v22; // [rsp+40h] [rbp-48h] BYREF
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( (int)result >= 0 )
      {
        ...
        *(_DWORD *)(a1 + 16 * v20 + 652) += v17;
        ...
        {
          SmEtwLogStoreOp((unsigned int)&qword_140353088, 1, (unsigned int)&v22, v13, v11, a1, 0, 0);
          SmEtwLogStoreOp((unsigned int)&qword_140353088, 0, (unsigned int)&v22, v21, a3, a1, *(_BYTE *)(v9 + 8), 0);
        }
