/*
 * XREFs of ArbShareDriverExclusive @ 0x1405C4DA4
 * Callers:
 *     ArbFindSuitableRange @ 0x1405A01C4 (ArbFindSuitableRange.c)
 * Callees:
 *     __security_check_cookie @ 0x1401716B0 (__security_check_cookie.c)
 *     _wcsicmp @ 0x1401723FC (_wcsicmp.c)
 *     IoGetDeviceProperty @ 0x1404E2C80 (IoGetDeviceProperty.c)
 *     RtlGetNextRange @ 0x1405A057C (RtlGetNextRange.c)
...
char __fastcall ArbShareDriverExclusive(__int64 a1, __int64 a2)
{
  ...
  _RANGE_LIST_ITERATOR Iterator; // [rsp+40h] [rbp-40h] BYREF
