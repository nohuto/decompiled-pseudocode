/*
 * XREFs of PiPnpRtlGatherInstallerClassChangeInfo @ 0x14058DD9C
 * Callers:
...
__int64 __fastcall PiPnpRtlGatherInstallerClassChangeInfo(__int64 a1, wchar_t *a2, PVOID *a3)
{
  ...
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, 0x18uLL, 0x47706E50u);
  *a3 = PoolWithTag;
  if ( !PoolWithTag )
  {
    Object = -1073741670;
  ...
  *PoolWithTag = 0LL;
  ...
  else
  {
    ...
    if ( Object < 0 )
      goto LABEL_12;
    Object = PiDmGetObject(2LL, (__int64)v13, (_QWORD *)*a3 + 1);
