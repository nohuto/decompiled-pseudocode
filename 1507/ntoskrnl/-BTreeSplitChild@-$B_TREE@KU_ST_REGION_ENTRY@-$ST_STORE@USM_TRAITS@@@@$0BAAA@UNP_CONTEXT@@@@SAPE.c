/*
 * XREFs of ?BTreeSplitChild@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@@@SAPEAUNODE@?$B_TREE_HEADER@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@PEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x140143BF8
 * Callers:
...
unsigned __int8 *__fastcall B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSplitChild(
        ...
        __int64 a2)
{
  ...
  unsigned __int8 *v30; // [rsp+88h] [rbp+20h]
  ...
  *(_WORD *)v7 = v28;
  ...
  {
    v22 = B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeNewNode(a1, 0, v6[2] + 1);
    v5 = v22;
    if ( v22 )
    {
  ...
  {
    --*(_DWORD *)(a2 + 24);
    v16 = B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeInsertEx(a1, a2, &v27);
    v17 = ++*(_DWORD *)(a2 + 24);
    if ( v16 >= 0 )
    {
LABEL_17:
