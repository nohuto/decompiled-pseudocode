/*
 * XREFs of KiDoubleFaultAbort @ 0x14018FC40
 * Callers:
 *     KiDoubleFaultAbortShadow @ 0x140274400 (KiDoubleFaultAbortShadow.c)
 * Callees:
...
void __fastcall __noreturn KiDoubleFaultAbort(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int16 v35; // [rsp+178h] [rbp+F8h]
  __int64 v36; // [rsp+180h] [rbp+100h]
  ...
  if ( (v34 & 1) != 0 )
  {
    ...
    v14 = *(_QWORD *)&CurrentThread->Process[2].ThreadSeed[12];
    __writegsqword(0x2EA8u, v14);
  ...
  if ( (v35 & 0x200) != 0 )
    _enable();
  KiBugCheckDispatch(127LL, 8LL, v18, v36);
}
