/*
 * XREFs of WdipSemLoadNextEndEvent @ 0x1405AE0B4
 * Callers:
...
__int64 __fastcall WdipSemLoadNextEndEvent(HANDLE KeyHandle, ULONG Index, GUID *Guid)
{
  ...
  _DWORD KeyInformation[38]; // [rsp+68h] [rbp-98h] BYREF
...
LABEL_38:
    ...
    if ( v6 >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        if ( v6 >= 0 )
        {
          v14 = WdipSemQueryValueFromRegistry(Handle, &v23, (__int64)&ResultLength);
          v6 = v14;
          if ( v14 < 0 )
          {
            if ( v14 != -1073741772 )
...
LABEL_28:
            v18 = WdipSemQueryValueFromRegistry(Handle, &v22, (__int64)&ResultLength);
            v6 = v18;
            if ( v18 >= 0 )
            {
              *(_DWORD *)&Guid[2].Data2 = v22;
            }
