/*
 * XREFs of PnpDiagRundownForEachDevice @ 0x14067D6D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PnpDiagRundownForEachDevice(__int64 a1)
{
  _DWORD *v1; // rbx
  __int64 i; // rdi
  __int64 v4; // rsi
  ...
  _DWORD v10[2]; // [rsp+40h] [rbp-11h] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+48h] [rbp-9h] BYREF
  _DWORD *v12; // [rsp+58h] [rbp+7h]
