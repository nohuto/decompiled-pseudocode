/*
 * XREFs of HvpFindNextDirtyBlockAndCreateTemporary @ 0x1401E04C0
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  if ( HvpFindNextDirtyRun(a2, a3, &v27, &v26, &v28) )
  {
    ...
    if ( !HvpGetCellMap(BugCheckParameter2, v27 << 9) )
      KeBugCheckEx(0x51u, 1uLL, BugCheckParameter2, v7, 0x11CFuLL);
    ...
    if ( v12 < v26 )
    {
      while ( 1 )
      {
        ...
        v17 = CellMap;
        if ( !CellMap )
          KeBugCheckEx(0x51u, 1uLL, BugCheckParameter2, v14, 0x11E7uLL);
