/*
 * XREFs of IoRegisterDeviceInterface @ 0x14057EEA0
 * Callers:
 *     PiSwCompleteCreate @ 0x14045B4C4 (PiSwCompleteCreate.c)
 *     VerifierIoRegisterDeviceInterface @ 0x140741FD8 (VerifierIoRegisterDeviceInterface.c)
 * Callees:
 *     RtlInitUnicodeStringEx @ 0x140015260 (RtlInitUnicodeStringEx.c)
 *     wcspbrk @ 0x1401744B8 (wcspbrk.c)
...
LABEL_13:
  ...
  v10 = (const wchar_t *)*((_QWORD *)DeviceNode + 6);
  LODWORD(Str) = 0;
  v11 = IopRegisterDeviceInterface(v10, (int *)v19, v5, 0, (PVOID *)&SourceString, &Str);
