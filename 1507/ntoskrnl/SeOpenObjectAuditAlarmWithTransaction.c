/*
 * XREFs of SeOpenObjectAuditAlarmWithTransaction @ 0x1404D3F80
 * Callers:
        ...
        PBOOLEAN GenerateOnClose)
{
  ...
  if ( !dword_14032BC68 )
    goto LABEL_14;
  if ( (dword_14032BC68 & (unsigned int)v14) != 0 )
  {
LABEL_65:
...
LABEL_18:
  ...
  v25 = SepAdtAuditThisEventWithContext(129LL, v23, v22, (__int64)v21);
  v10 = v65;
  SecurityDescriptor = v78;
LABEL_24:
  AuxData = v72;
...
LABEL_26:
  if ( v18 )
  {
    v26 = *(unsigned int **)AuxData;
    if ( *(_QWORD *)AuxData )
    {
      if ( *v26 )
      {
        v28 = SepAdtAuditPrivilegeUseWithContext(v26, v18, 0, (__int64)p_SubjectSecurityContext, &v67);
        v10 = v67;
        SecurityDescriptor = v78;
        v65 = v67;
        if ( v28 )
