/*
 * XREFs of PopPepCancelActivityRange @ 0x140028508
 * Callers:
 *     PopPepCancelActivities @ 0x140027C68 (PopPepCancelActivities.c)
...
int *__fastcall PopPepCancelActivityRange(__int64 a1, int a2, int a3, int a4, volatile signed __int32 *a5)
{
  ...
  {
    v5 = (int **)(a1 + 8LL * a3);
    result = (int *)&unk_1402907F8;
    v7 = (_DWORD *)((char *)&unk_1402907F8 + 136 * a2 + 4 * a3);
