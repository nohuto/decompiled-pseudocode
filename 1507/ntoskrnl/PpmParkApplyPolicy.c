/*
 * XREFs of PpmParkApplyPolicy @ 0x140167A20
 * Callers:
...
void __fastcall PpmParkApplyPolicy(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  ...
  if ( PpmParkNodes )
  {
    ...
    if ( (((unsigned __int64)qword_1403208E8[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6] >> (KiProcessorIndexToNumberMappingTable[0] & 0x3F)) & 1) == 0 )
    {
