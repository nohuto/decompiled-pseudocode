/*
 * XREFs of PopVerifySystemPowerPolicy @ 0x140599A44
 * Callers:
...
__int64 __fastcall PopVerifySystemPowerPolicy(_OWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 224) = *((_QWORD *)v4 + 12);
  ...
  else if ( (_BYTE)word_14032E524 )
  {
    *(_DWORD *)(a2 + 72) = 3;
  }
  else if ( byte_14032E523 )
  {
    *(_DWORD *)(a2 + 72) = 2;
  }
  v5 = (int *)(a2 + 68);
  ...
  if ( *(_DWORD *)(a2 + 212) < (unsigned int)qword_14032E430 )
    *(_DWORD *)(a2 + 212) = qword_14032E430;
  if ( *(_DWORD *)(a2 + 212) > HIDWORD(qword_14032E430) )
    *(_DWORD *)(a2 + 212) = HIDWORD(qword_14032E430);
  ...
  if ( !*(_DWORD *)(a2 + 92) )
    *(_DWORD *)(a2 + 92) = 1;
  if ( *(_DWORD *)(a2 + 88) && !byte_14032E527 )
    *(_DWORD *)(a2 + 88) = 0;
