/*
 * XREFs of HvApplyLogFile @ 0x140665D50
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  while ( 1 )
  {
    Routine = HvpRecoverDataReadRoutine(v11, v9, v12, 0x28u, &v29);
    if ( Routine < 0 )
      break;
    v15 = *((_OWORD *)v29 + 1);
    v31 = *(_OWORD *)v29;
    ...
    if ( v16 > 0xFFFFFFFF || DWORD1(v31) < v16 || !HvpLogEntryCheckHeaderChecksum((__int64)&v31) || HIDWORD(v31) != a2 )
      goto LABEL_25;
    v17 = DWORD1(v31);
    Routine = HvpRecoverDataReadRoutine(v11, v9, v12, DWORD1(v31), (char **)v27);
    if ( Routine < 0 )
      break;
    v18 = DWORD1(v32);
