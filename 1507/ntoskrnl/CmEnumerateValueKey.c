/*
 * XREFs of CmEnumerateValueKey @ 0x1404277E0
 * Callers:
...
__int64 __fastcall CmEnumerateValueKey(__int64 a1, unsigned int a2, int a3, void *a4, int a5, __int64 a6)
{
  ...
  {
    if ( (unsigned __int8)CmRmIsKCBDeleted(*(_QWORD *)(a1 + 8), 0LL) == 1 )
    {
      v19 = -1073741444;
      if ( (*(_BYTE *)(a1 + 48) & 1) != 0 )
        v19 = -1073740763;
    ...
    {
      v19 = CmpSearchAddTrans(a1, 0, 0, *(_QWORD *)(a1 + 56), *(_QWORD *)(a1 + 64), 0, (__int64)v26);
      if ( v19 >= 0 )
      {
        v8 = v26[0];
        goto LABEL_3;
...
LABEL_3:
  ...
  while ( 1 )
  {
    if ( (unsigned __int8)CmRmIsKCBDeleted(v11, v8) == 1 )
    {
      v22 = -1073741444;
      if ( (*(_BYTE *)(a1 + 48) & 1) != 0 )
        v22 = -1073740763;
    ...
    if ( v8 && *(_QWORD *)(v11 + 280) == v8 )
    {
      ...
      if ( (unsigned int)v7 < *(_DWORD *)(v11 + 272) )
      {
        ...
        {
LABEL_11:
          KeyValueData = CmpQueryKeyValueData(v11, v6, v16, v28, a4, a5, a6);
...
LABEL_15:
    ...
    if ( *(struct _KTHREAD **)(v11 + 56) == KeGetCurrentThread()
      || (unsigned __int8)CmpTryConvertKcbLockSharedToExclusive(v11) )
    {
      break;
    }
    (*(void (__fastcall **)(__int64, int *))(v12 + 16))(v12, &v27);
