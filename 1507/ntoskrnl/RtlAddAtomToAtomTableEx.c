/*
 * XREFs of RtlAddAtomToAtomTableEx @ 0x14000FC20
 * Callers:
 *     NtAddAtomEx @ 0x14053A594 (NtAddAtomEx.c)
 *     RtlAddAtomToAtomTable @ 0x14055A07C (RtlAddAtomToAtomTable.c)
 * Callees:
 *     RtlpAllocateAtomTableEntry @ 0x140008590 (RtlpAllocateAtomTableEntry.c)
 *     RtlpReferenceAtom @ 0x14000FBD0 (RtlpReferenceAtom.c)
