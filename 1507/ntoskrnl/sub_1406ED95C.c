/*
 * XREFs of sub_1406ED95C @ 0x1406ED95C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1406ED95C(_DWORD *a1, _DWORD *a2, __int64 a3, _DWORD *a4, _BYTE *a5)
{
  unsigned int v6; // edi
  int v9; // eax
  int v10; // eax
...
LABEL_22:
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_1406ECC3C(a1, a2, v6, a4, 4);
  }
  else
  {
    v22 = -1073741772;
