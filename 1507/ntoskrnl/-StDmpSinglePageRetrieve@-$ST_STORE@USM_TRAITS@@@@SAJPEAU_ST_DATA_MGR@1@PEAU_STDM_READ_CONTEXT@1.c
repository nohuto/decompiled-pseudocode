/*
 * XREFs of ?StDmpSinglePageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAXPEAU_ST_PAGE_LOCATION@1@@Z @ 0x140140D78
 * Callers:
 ...
 *     ?StDmLazyRemoveStateUpdate@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAT_SM_PAGE_KEY@@K@Z @ 0x140254EF0 (-StDmLazyRemoveStateUpdate@-$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAT_SM_PAGE_KEY@@K@Z.c)
 ...
 *     ?StStagingRegionFind@?$ST_STORE@USM_TRAITS@@@@SAPEAU_ST_STAGING_REGION@1@PEAU_ST_DATA_MGR@1@K@Z @ 0x14025651C (-StStagingRegionFind@-$ST_STORE@USM_TRAITS@@@@SAPEAU_ST_STAGING_REGION@1@PEAU_ST_DATA_MGR@1@K@Z.c)
 */
      ...
      if ( v5 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v35 + 8 * v16) = v37;
          if ( (v37 & 3) == 0 )
            SmFpFree(v28 + 5048, 4LL, (__int64)KeGetCurrentThread(), v38);
        }
      }
      goto LABEL_28;
    }
...
LABEL_23:
    v11 = ST_STORE<SM_TRAITS>::StDmSinglePageTransfer(
            a1,
            *(_QWORD *)(a2 + 16),
            (unsigned int)v27 | 1,
            a4,
