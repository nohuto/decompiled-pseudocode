/*
 * XREFs of EtwpPoolRunDown @ 0x1406E8CE0
 * Callers:
...
void __fastcall EtwpPoolRunDown(unsigned int a1, char a2)
{
  ...
  _BYTE v41[48]; // [rsp+50h] [rbp-31h] BYREF
      ...
      if ( PoolTagInfo >= 0 )
      {
        ...
        if ( *v2 )
        {
          do
          {
            ...
            v37 = v11;
            v46 = 40 * v11;
            EtwpLogKernelEvent((__int64)&v42, a1, 2u, v5, 4200450);
            v10 += 10 * v37;
            v9 -= v37;
          }
          while ( v9 );
      ...
      if ( BigPoolInfo >= 0 )
      {
        ...
        if ( *v2 )
        {
          do
          {
            ...
            v37 = v18;
            v46 = 24 * v18;
            EtwpLogKernelEvent((__int64)&v42, a1, 2u, v12, 4200450);
            v17 += 6 * v37;
            v16 -= v37;
          }
          while ( v16 );
  ...
  for ( j = 0LL; ; j = v35 )
  {
    ...
    if ( !NextSession )
      break;
    if ( (int)MmAttachSession(NextSession, (__int64)v41) >= 0 )
    {
          ...
          if ( SessionPoolTagInfo >= 0 )
          {
            ...
            if ( v37 )
            {
              do
              {
                ...
                v37 = v26;
                v49 = 40 * v26;
                EtwpLogKernelEvent((__int64)&v42, a1, 3u, v20, 4200450);
                v25 += 10 * v37;
                v24 -= v37;
              }
              while ( v24 );
          ...
          if ( v30 >= 0 )
          {
            ...
            if ( v32 )
            {
              do
              {
                ...
                v37 = v33;
                v49 = 24 * v33;
                EtwpLogKernelEvent((__int64)&v42, a1, 3u, v27, 4200450);
                v31 += 6 * v37;
                v32 -= v37;
              }
              while ( v32 );
      ...
      MmDetachSession((__int64)v35, (struct _KTHREAD *)v41);
    }
  }
  if ( v2 )
    ExFreePoolWithTag(v2, 0);
