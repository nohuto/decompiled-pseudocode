/*
 * XREFs of PiDevCfgEnforceDevicePolicy @ 0x1406858BC
 * Callers:
...
__int64 __fastcall PiDevCfgEnforceDevicePolicy(__int64 a1, __int64 a2, const wchar_t *a3)
{
  ...
  const wchar_t *v35; // [rsp+38h] [rbp-41h]
  __int64 v36; // [rsp+40h] [rbp-39h] BYREF
  HANDLE KeyHandle; // [rsp+48h] [rbp-31h] BYREF
  const wchar_t **v38; // [rsp+50h] [rbp-29h] BYREF
  ...
  v34 = 8913030;
  Handle = 0LL;
  v35 = L"\\Registry\\Machine\\Software\\Policies\\Microsoft\\Windows\\DeviceInstall";
  v39 = 0LL;
  v40 = 0LL;
  v36 = 0LL;
  v38 = 0LL;
...
LABEL_5:
    ...
    v34 = 6422624;
    v35 = L"\\Registry\\Machine\\System\\DriverDatabase\\Policies";
    KeyHandle = 0LL;
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&v34;
    ObjectAttributes.Length = 48;
    ObjectAttributes.RootDirectory = 0LL;
...
LABEL_33:
  v17 = PiDevCfgQueryPolicyStringList(Handle, L"AllowDeviceIDs", &v36);
  v18 = (wchar_t *)v36;
  if ( v17 < 0 )
    v18 = 0LL;
  v19 = PiDevCfgQueryPolicyStringList(Handle, L"DenyDeviceIDs", &v38);
  v20 = (wchar_t *)v38;
  if ( v19 < 0 )
    v20 = 0LL;
  if ( v18 || v20 )
