/*
 * XREFs of ?StDmUpdateRegionLazyCleanup@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KK@Z @ 0x140255B88
 * Callers:
...
void __fastcall ST_STORE<SM_TRAITS>::StDmUpdateRegionLazyCleanup(__int64 a1, unsigned int a2, int a3)
{
  ...
  if ( a3 )
  {
    v5 = *(const signed __int64 **)(a1 + 200);
    if ( _bittest64(v5, v3) )
    {
      v6 = v3 & 0x1F;
      LOBYTE(v7) = 1;
...
LABEL_10:
  ...
  {
    _bittestandset(*(signed __int32 **)(a1 + 200), a2);
  }
}
