/*
 * XREFs of ExpInitSystemPhase0 @ 0x1407DF914
 * Callers:
...
char ExpInitSystemPhase0()
{
  ...
  LODWORD(ExpEnvironmentLock) = 1;
  qword_1403252D8 = (__int64)&ExpSystemResourcesList;
  ExpSystemResourcesList = (__int64)&ExpSystemResourcesList;
  qword_140325248 = (__int64)&qword_140325240;
  qword_140325240 = (__int64)&qword_140325240;
  qword_140325268 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_140325278 = (__int64)&ExPagedLookasideListHead;
  ExPagedLookasideListHead = (__int64)&ExPagedLookasideListHead;
  qword_140325498 = (__int64)&ExpFirmwareTableProviderListHead;
