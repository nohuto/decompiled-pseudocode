/*
 * XREFs of FsRtlIsHpfsDbcsLegal @ 0x14066E134
 * Callers:
 *     FsRtlIsHpfsDbcsLegal @ 0x14066E134 (FsRtlIsHpfsDbcsLegal.c)
 * Callees:
          ...
          do
          {
            ...
            if ( v15 >= 0x80u && (_BYTE)NlsMbOemCodePageTag && NlsOemLeadByteInfoTable[v15] )
            {
              ...
              ++v13;
                   ...
                   && (((WildCardsPermissible != 0 ? 8 : 0) | 2) & byte_140295380[(unsigned __int8)v14[v13]]) == 0 )
            {
              return 0;
            }
            ++v13;
