/*
 * XREFs of PfpFlushBuffers @ 0x1404F7BD0
 * Callers:
 ...
 *     PfTAcquireLogEntry @ 0x140564988 (PfTAcquireLogEntry.c)
 */
...
char PfpFlushBuffers()
{
  ...
  if ( v3 < 0 )
    return 0;
  v4 = RtlpInterlockedFlushSList(&stru_140367DC0);
  if ( !v4 )
    goto LABEL_16;
  do
  {
  ...
  while ( 1 )
  {
    ...
    HIDWORD(v22) = dword_1403534CC + (v7 >> 10);
    LODWORD(v21) = v22;
    Src = 163851LL;
    PfpCopyEvent(&Src);
    if ( *(int *)(v6 + 8) > 1
      || (v24 = 0LL, v23 = 94215LL, LODWORD(v24) = *(_DWORD *)(v6 + 12), PfpCopyEvent(&v23), *(int *)(v6 + 8) > 1) )
    {
      ...
      if ( (unsigned __int64)v12 <= *(_QWORD *)(v6 + 40) )
      {
        ...
        {
          v13 = *v12;
          v14 = PfTAcquireLogEntry(&unk_140350218, &v18, 1LL);
          if ( !v14 )
            break;
