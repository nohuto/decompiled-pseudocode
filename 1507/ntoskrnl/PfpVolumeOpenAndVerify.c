/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x140456460
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x140455A8C (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x140025FB4 (PfVolumeSupportedForPrefetch.c)
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x12FDuLL, 0LL, 0LL, 0LL);
...
LABEL_6:
        NtClose(v8);
        v8 = 0LL;
        DevicePowerState = PfpOpenHandleCreate((__int64)v19, a1, (__int64)v17, 0LL, 1048960, 0x20u, 0, 0LL);
        if ( DevicePowerState < 0 )
          goto LABEL_15;
