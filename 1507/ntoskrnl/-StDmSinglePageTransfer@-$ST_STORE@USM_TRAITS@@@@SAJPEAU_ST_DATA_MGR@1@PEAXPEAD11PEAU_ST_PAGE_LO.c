/*
 * XREFs of ?StDmSinglePageTransfer@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAXPEAD11PEAU_ST_PAGE_LOCATION@1@PEAU_STDM_READ_CONTEXT@1@@Z @ 0x14014109C
 * Callers:
...
LABEL_5:
  ...
  if ( v15 )
  {
    v16 = v15 + (*(unsigned __int16 *)(a6 + 6) << 12);
    if ( v14 )
      v16 |= 1uLL;
