/*
 * XREFs of ?BTreeInsertEx@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@@@SAJPEAU1@PEAUSEARCH_RESULT@1@PEAK@Z @ 0x14014220C
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( (unsigned __int16)*(_DWORD *)*v10 >= v12 )
  {
    ...
    {
      v18 = B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeRedistribute(a1);
      v19 = *(v10 - 1);
      v20 = v18;
      if ( (v18 & 1) != 0 )
        v21 = v19 - 16;
