/*
 * XREFs of DrvDbGetDriverDatabaseMappedPropertyKeys @ 0x14071ADA0
 * Callers:
...
LABEL_20:
      ...
      if ( !a3 )
      {
        CompositeMappedPropertyKeys = DrvDbOpenDriverDatabaseRegKey(a1, a2, 1u, 0, &Handle, 0LL);
        if ( CompositeMappedPropertyKeys < 0 )
          goto LABEL_20;
