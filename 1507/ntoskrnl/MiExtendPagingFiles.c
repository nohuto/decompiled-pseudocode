/*
 * XREFs of MiExtendPagingFiles @ 0x1406A50F4
 * Callers:
...
void __fastcall MiExtendPagingFiles(__int64 a1)
{
  ...
  {
    _mm_lfence();
    v6 = *(_QWORD *)(v1 + 8 * v4 + 5344);
    if ( *(_QWORD *)(v6 + 8) - *(_QWORD *)v6 < v3 )
      return;
    v7 = MiAttemptPageFileExtension(*(_QWORD *)(v1 + 8 * v4 + 5344), v3);
    v8 = v7;
    if ( v7 && (*(_BYTE *)(a1 + 79) & 2) != 0 )
      MiUpdatePagingFileMinimum(v6, v7);
    v9 = (*(_BYTE *)(v6 + 164) & 0x50) == 0;
    goto LABEL_24;
  }
  v9 = 1;
  if ( (*(_BYTE *)(a1 + 79) & 1) == 0 )
  ...
  v13 = 0LL;
  v14 = v1 + 5344;
  v15 = *(unsigned int *)(v1 + 5336);
  do
  {
    if ( (*(_BYTE *)(*(_QWORD *)v14 + 164LL) & 0x50) == 0 )
