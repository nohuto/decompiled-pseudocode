/*
 * XREFs of BcpGetMaxResourceProfile @ 0x140166638
 * Callers:
 *     BgpBcInitializeCriticalMode @ 0x1407FD8F0 (BgpBcInitializeCriticalMode.c)
 * Callees:
 *     BcpGetCharacterMaxResourceProfile @ 0x1401666F4 (BcpGetCharacterMaxResourceProfile.c)
 */
...
__int64 __fastcall BcpGetMaxResourceProfile(__int64 a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  for ( i = 0; i < 0x12; ++i )
  {
    ...
    if ( v7 != (unsigned __int16 *)&unk_140293388 || (dword_140323CF0 & 0x20000) == 0 )
    {
      CharacterMaxResourceProfile = 0;
      v8 = *v7 >> 1;
      v9 = 0;
