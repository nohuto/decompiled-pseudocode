/*
 * XREFs of VfSuspectDriversLoadCallback @ 0x14074A174
 * Callers:
...
LONG __fastcall VfSuspectDriversLoadCallback(__int64 a1, __int64 Entry, int a3, unsigned int a4)
{
  ...
  if ( !Entry )
  {
    ...
    else
    {
      ...
      {
        if ( _bittest((const signed __int32 *)qword_140763248, ++ViLoadedDriversCount) )
        {
