/*
 * XREFs of PnpIsChainDereferenced @ 0x14011C010
 * Callers:
 *     PnpProcessQueryRemoveAndEject @ 0x1405361F8 (PnpProcessQueryRemoveAndEject.c)
 * Callees:
 *     KeAcquireQueuedSpinLock @ 0x140041D50 (KeAcquireQueuedSpinLock.c)
 *     KeReleaseQueuedSpinLock @ 0x140041DC0 (KeReleaseQueuedSpinLock.c)
 *     PnpUpdateExtensionFlags @ 0x14011C130 (PnpUpdateExtensionFlags.c)
 *     PnpIsAnyDeviceInUse @ 0x14011C158 (PnpIsAnyDeviceInUse.c)
