/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x140286ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(unsigned __int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 1384) )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(CompleteDev + 560))(CompleteDev + 1384, 0LL);
  v2 = (__int64 (__fastcall *)())CompleteDev;
  v3 = *(_QWORD *)(CompleteDev + 1328);
  v4 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, unsigned __int64))(CompleteDev + 240);
  v5 = *(unsigned int *)(CompleteDev + 1356);
  v6 = *(_QWORD *)(CompleteDev + 1336);
  ...
  v9 = (unsigned __int64 *)&loc_140286F56;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
