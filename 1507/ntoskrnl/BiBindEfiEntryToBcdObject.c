/*
 * XREFs of BiBindEfiEntryToBcdObject @ 0x14070EC6C
 * Callers:
...
__int64 __fastcall BiBindEfiEntryToBcdObject(void *a1, GUID *a2)
{
  ...
  else
  {
    v8[1] = 270532607;
    v8[0] = 1;
    KeyName = BiCreateObject(a1, 0LL, (__int64)v8, 1u, &KeyHandle);
    if ( KeyName >= 0 )
    {
      KeyName = BiGetKeyName(KeyHandle, &SourceString);
      if ( KeyName >= 0 )
      {
