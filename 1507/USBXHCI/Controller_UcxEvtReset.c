/*
 * XREFs of Controller_UcxEvtReset @ 0x1C0016200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_UcxEvtReset(__int64 a1)
{
  ...
  if ( Controller_IsControllerAccessible(v2) )
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(v2 + 64), 2u, 3u, 0xB0u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
  v7 = 1;
  v6 = 12LL;
  return ((__int64 (__fastcall *)(__int64, __int64, __int64 *))qword_1C0041518)(UcxGlobals, a1, &v6);
}
