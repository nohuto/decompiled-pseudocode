/*
 * XREFs of WPP_RECORDER_SF_dddqLddx @ 0x1C002E560
 * Callers:
...
__int64 WPP_RECORDER_SF_dddqLddx(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    (*(void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
      ...
      0LL);
  LOWORD(v7) = 50;
  return WppAutoLogTrace(a1, 4LL, 13LL, &WPP_3b622249e4c15df141300e65bf8740b4_Traceguids, v7, (__int64 *)va);
}
