/*
 * XREFs of Bulk_PrepareStage @ 0x1C002A83C
 * Callers:
 *     Bulk_MappingLoop @ 0x1C002A758 (Bulk_MappingLoop.c)
 * Callees:
 *     TR_AcquireSegments @ 0x1C001FFE0 (TR_AcquireSegments.c)
 *     Bulk_Stage_AcquireMdl @ 0x1C002BA30 (Bulk_Stage_AcquireMdl.c)
 *     Bulk_Stage_DetermineSize @ 0x1C002BBB4 (Bulk_Stage_DetermineSize.c)
 *     Bulk_Stage_EstimateRequiredSegments @ 0x1C002BC60 (Bulk_Stage_EstimateRequiredSegments.c)
...
__int64 __fastcall Bulk_PrepareStage(__int64 a1)
{
  ...
  Bulk_Stage_EstimateRequiredSegments(v1, &v9);
  if ( !v9 )
    return v3;
  v6 = TR_AcquireSegments(a1, v9, v1 + 1);
  if ( v6 == 259 )
  {
...
LABEL_5:
  *(_BYTE *)(a1 + 96) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 88));
  ...
  if ( *(_DWORD *)(v4 + 104) == *(_DWORD *)(v4 + 100) )
  {
    v3 = 1;
    LOBYTE(v5) = 1;
    Bulk_Transfer_CompleteCancelable(a1, v4, 3221229568LL, v5);
  }
  else
  {
    v3 = 4;
