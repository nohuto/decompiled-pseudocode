/*
 * XREFs of Interrupter_CmResList_GetInterrupterCountAndType @ 0x1C00496E4
 * Callers:
...
__int64 __fastcall Interrupter_CmResList_GetInterrupterCountAndType(__int64 a1, __int64 a2, _DWORD *a3, int *a4)
{
  ...
  for ( i = 0; ; ++i )
  {
    result = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 2432))(
               WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
               a2);
    if ( i >= (unsigned int)result )
      break;
    v10 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD))(WdfFunctions_01015 + 2440))(
            WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
            a2,
            i);
    v11 = v10;
