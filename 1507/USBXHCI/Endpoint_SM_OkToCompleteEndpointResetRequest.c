/*
 * XREFs of Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x1C0019D4C
 * Callers:
 ...
 *     ESM_WaitingForControllerResetCompletion @ 0x1C0039AC0 (ESM_WaitingForControllerResetCompletion.c)
 * Callees:
