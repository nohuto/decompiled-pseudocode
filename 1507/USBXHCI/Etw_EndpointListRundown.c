/*
 * XREFs of Etw_EndpointListRundown @ 0x1C0032CB0
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)v5 >= v7 )
      {
        ...
        if ( v11 != (_QWORD *)*v11 )
        {
          do
          {
            (*(void (__fastcall **)(_LIST_ENTRY *, _QWORD, __int64 (__fastcall *)(_QWORD, _QWORD), __int64, const char *))(WdfFunctions_01015 + 1640))(
        ...
        if ( (_DWORD)v5 )
        {
          ...
          do
          {
            ...
            (*(void (__fastcall **)(_LIST_ENTRY *, _QWORD, __int64 (__fastcall *)(_QWORD, _QWORD), __int64, const char *))(WdfFunctions_01015 + 1648))(
              WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
              *(_QWORD *)(v17 + 24),
              Etw_EndpointListRundown,
              582LL,
