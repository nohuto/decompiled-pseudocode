/*
 * XREFs of Controller_ExecuteDSM @ 0x1C004E268
 * Callers:
...
void __fastcall Controller_ExecuteDSM(__int64 *a1, int a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *(_QWORD *)&v6[v7 + 36] = 0x40000LL;
    ...
    v15[0] = 1114596673LL;
    v12[2] = 20LL;
    v8 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 336))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           v2);
    v9 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD, __int64, _QWORD *, _QWORD *, _QWORD, char *))(WdfFunctions_01015 + 1488))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           v8,
           0LL,
           3325956LL,
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( LODWORD(v15[0]) == 1114596673 )
        v10 = 233;
      WPP_RECORDER_SF_q(a1[8], 4u, 3u, v10, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v2);
    }
    else
    {
      LODWORD(v11) = v9;
      WPP_RECORDER_SF_qd(a1[8], 4u, 3u, 0xE7u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v2, v11);
    }
    ExFreePoolWithTag(v6, 0x49434858u);
  }
  else
  {
    WPP_RECORDER_SF_d(a1[8], 2u, 3u, 0xE6u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, -1073741670);
  }
}
