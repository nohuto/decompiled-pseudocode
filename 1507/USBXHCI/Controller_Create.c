/*
 * XREFs of Controller_Create @ 0x1C004A8A0
 * Callers:
 ...
 *     RtlStringCchCopyA @ 0x1C00130C8 (RtlStringCchCopyA.c)
...
LABEL_20:
      LODWORD(v25) = PciData;
      WPP_RECORDER_SF_d(a2, 2u, 3u, v23, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v25);
      return v14;
    }
    goto LABEL_8;
  }
  if ( DeviceEnumerator == 1 )
  {
    ...
    if ( AcpiData < 0 )
    {
      WPP_RECORDER_SF_d(a2, 2u, 3u, 0x5Fu, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, AcpiData);
      return v14;
    }
  }
  else
...
LABEL_9:
  PciData = ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, _QWORD *, __int64 *))qword_1C0041508)(
              UcxGlobals,
              a1,
              v35,
              v32,
  ...
  *a4 = v16;
  ...
  LODWORD(v32[0]) = 56;
  v32[3] = 0x100000001LL;
  PciData = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD *, _QWORD *, __int64))(WdfFunctions_01015 + 2544))(
              WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
              v34,
              v32,
              v16 + 248);
  ...
  v32[3] = 0x100000001LL;
  v27 = 24LL;
  PciData = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64 *, _QWORD *, __int64))(WdfFunctions_01015 + 3032))(
              WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
              &v27,
              v32,
              v16 + 376);
  ...
  v19 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, void *))(WdfFunctions_01015 + 1616))(
          WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
          *(_QWORD *)(v16 + 256),
          off_1C0040298);
  ...
  *(_QWORD *)v19 = v19;
  ...
  {
    v14 = -1073741637;
    WPP_RECORDER_SF_(a2, 2u, 3u, 0x65u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
  }
  else
  {
