/*
 * XREFs of Endpoint_UcxEvtEndpointStart @ 0x1C001B530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointStart(__int64 a1, __int64 a2)
{
  ...
  v3 = result;
  if ( !*(_BYTE *)(result + 37) )
    return (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD))(WdfFunctions_01015 + 1232))(
             WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
             *(_QWORD *)(*(_QWORD *)(result + 88) + 72LL));
  v4 = *(_QWORD *)(result + 136);
  for ( i = 1; i <= *(_DWORD *)(v4 + 8); ++i )
    result = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD))(WdfFunctions_01015 + 1232))(
               WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
