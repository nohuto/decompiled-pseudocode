/*
 * XREFs of Controller_DriverInstalledDueToCompatibleIdMatch @ 0x1C0047FF4
 * Callers:
...
char __fastcall Controller_DriverInstalledDueToCompatibleIdMatch(_QWORD *a1)
{
  ...
  v3 = (struct _DEVICE_OBJECT *)(*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD))(WdfFunctions_01015 + 264))(
  ...
  if ( DevicePropertyData < 0 )
  {
    ...
    WPP_RECORDER_SF_d(a1[8], 3u, 3u, 0x8Cu, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, Data);
  }
  else
  {
    v5 = 0;
