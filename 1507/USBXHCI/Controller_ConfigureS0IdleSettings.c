/*
 * XREFs of Controller_ConfigureS0IdleSettings @ 0x1C00474D0
 * Callers:
...
__int64 __fastcall Controller_ConfigureS0IdleSettings(__int64 *a1)
{
  ...
  {
    *((_DWORD *)a1 + 86) = 1;
    WPP_RECORDER_SF_(a1[8], 3u, 3u, 0x14u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
  }
  else
  {
    ...
    v11 = 1;
    v9 = 72;
    v3 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, GUID *, _QWORD *, __int16, __int16, _QWORD))(WdfFunctions_01015 + 1048))(
    ...
    if ( v3 >= 0 )
    {
      ...
      if ( v14[5] )
      {
        ...
        {
          LODWORD(v12) = v4;
          WPP_RECORDER_SF_d(a1[8], 3u, 3u, 0x16u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v12);
        }
      }
      ...
      if ( v16 > 1 )
      {
        *((_DWORD *)a1 + 86) = 0;
        ...
        LODWORD(v12) = 5000;
        WPP_RECORDER_SF_d(a1[8], 4u, 3u, 0x18u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v12);
        memset(v15, 0, 0x48uLL);
        v6 = *a1;
        v15[1] = Controller_EvtPostPoFxRegisterDevice;
        v15[2] = Controller_EvtPrePoFxUnregisterDevice;
        LODWORD(v15[0]) = 72;
        v7 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD *))(WdfFunctions_01015 + 3400))(
               WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
               v6,
               v15);
        if ( v7 < 0 )
        {
          LODWORD(v10) = v7;
          WPP_RECORDER_SF_d(a1[8], 2u, 3u, 0x19u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v10);
        }
      }
      else
      {
        *((_DWORD *)a1 + 86) = 2;
        LODWORD(v13) = 1;
        LODWORD(v12) = v5;
        WPP_RECORDER_SF_dd(a1[8], 4u, 3u, 0x17u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v12, v13);
      }
    }
    else
    {
      LODWORD(v12) = v3;
      WPP_RECORDER_SF_d(a1[8], 4u, 3u, 0x15u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v12);
      *((_DWORD *)a1 + 86) = 2;
    }
  }
  LODWORD(v10) = *((_DWORD *)a1 + 86);
  return WPP_RECORDER_SF_L(a1[8], 4u, 3u, 0x1Au, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v10);
}
