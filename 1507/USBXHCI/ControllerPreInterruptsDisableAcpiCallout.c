/*
 * XREFs of ControllerPreInterruptsDisableAcpiCallout @ 0x1C0002280
 * Callers:
...
__int64 __fastcall ControllerPreInterruptsDisableAcpiCallout(__int64 a1)
{
  ...
  {
    LOBYTE(v3) = 4;
    WPP_RECORDER_SF_q(*(_QWORD *)(v4 + 64), v3, 3, 78, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, a1);
    v9[0] = 1114203457;
    v9[1] = 1229804112;
    v10[2] = 8LL;
    v10[0] = 1LL;
    ...
    v13[0] = 1114596673LL;
    v11[2] = 20LL;
    v5 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 336))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           a1);
    v6 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD, __int64, _QWORD *, _QWORD *, _QWORD, _BYTE *))(WdfFunctions_01015 + 1488))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           v5,
           0LL,
           3325956LL,
