/*
 * XREFs of Controller_TelemetryReport @ 0x1C0015B70
 * Callers:
 ...
 *     TelemetryData_InsertTriageDataBlock @ 0x1C0039E30 (TelemetryData_InsertTriageDataBlock.c)
...
void __fastcall Controller_TelemetryReport(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, unsigned int a5)
{
  ...
  *(_QWORD *)&pszDest[32] = a1;
  ...
  if ( !Report )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0xD0u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
    return;
  }
