/*
 * XREFs of Endpoint_Enable @ 0x1C0017910
 * Callers:
...
__int64 __fastcall Endpoint_Enable(_QWORD *a1)
{
  ...
  WPP_RECORDER_SF_DDX(
    ...
    *((_DWORD *)a1 + 36),
    a1[3]);
  v3 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 (__fastcall *)()))qword_1C0041558)(
         UcxGlobals,
         a1[3],
         Endpoint_Enable);
  v4 = v3;
...
LABEL_26:
  if ( v4 )
    (*(void (__fastcall **)(_LIST_ENTRY *, __int64, __int64 (__fastcall *)(), __int64, const char *))(WdfFunctions_01015 + 1648))(
      WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
      v4,
      Endpoint_Enable,
      927LL,
