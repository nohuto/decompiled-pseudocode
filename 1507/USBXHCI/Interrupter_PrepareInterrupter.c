/*
 * XREFs of Interrupter_PrepareInterrupter @ 0x1C00484F0
 * Callers:
 ...
 *     RtlStringCchPrintfA @ 0x1C00052B0 (RtlStringCchPrintfA.c)
 ...
 *     Interrupter_DetermineSegmentSizeAndCount @ 0x1C00480DC (Interrupter_DetermineSegmentSizeAndCount.c)
 */
...
__int64 __fastcall Interrupter_PrepareInterrupter(__int64 a1, unsigned __int8 a2)
{
  ...
  *(_DWORD *)(a1 + 104) ^= (*(_DWORD *)(a1 + 104) ^ a2) & 1;
  Interrupter_DetermineSegmentSizeAndCount(a1);
  v8 = CommonBuffer_AcquireBuffer(v6, 16 * *(_DWORD *)(v7 + 116), v7, 0x31746E49u);
  *(_QWORD *)(a1 + 160) = v8;
  if ( v8 )
  {
    v9 = CommonBuffer_AcquireBuffers(v6, *(_DWORD *)(a1 + 116), *(_DWORD *)(a1 + 112), (int)v3, a1, 846491209, 0LL);
    v10 = v9;
    if ( v9 >= 0 )
    {
      ...
      *(_DWORD *)(v11 + 8) = 0;
      ...
      for ( i = (_QWORD *)*v3; v3 != i; i = (_QWORD *)*i )
      {
        ...
        *(_WORD *)(v13 + 8 * v15 + 8) = *(_WORD *)(a1 + 124);
      }
      if ( WPP_MAIN_CB.Queue.Wcb.CurrentIrp )
      {
        v16 = (struct _DEVICE_OBJECT *)(*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, __int64, __int64))(WdfFunctions_01015 + 248))(
                                         WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
                                         **(_QWORD **)(a1 + 8),
                                         v12,
                                         v13);
        *(_QWORD *)(a1 + 208) = IoAllocateWorkItem(v16);
        KeInitializeEvent((PRKEVENT)(a1 + 184), NotificationEvent, 1u);
      }
      else
      {
        *(_QWORD *)(a1 + 208) = 0LL;
