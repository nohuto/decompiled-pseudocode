/*
 * XREFs of Counter_CreateCommonBufferInstance @ 0x1C0049428
 * Callers:
...
NTSTATUS __fastcall Counter_CreateCommonBufferInstance(__int64 a1)
{
  ...
  v3 = *(_QWORD *)(a1 + 8);
  if ( *(_BYTE *)(WPP_MAIN_CB.Dpc.ProcessorHistory + 28) && !*(_QWORD *)(a1 + 32) )
  {
    Data = *(_DWORD *)(v3 + 144);
    if ( *(_DWORD *)(v3 + 148) == 1 )
    ...
    return PcwCreateInstance(
             (PPCW_INSTANCE *)(a1 + 32),
             (PPCW_REGISTRATION)WPP_MAIN_CB.SecurityDescriptor,
             &DestinationString,
             1u,
             &v5);
  }
