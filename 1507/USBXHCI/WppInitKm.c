/*
 * XREFs of WppInitKm @ 0x1C004BA30
 * Callers:
...
void __fastcall WppInitKm(__int64 a1, __int64 a2)
{
  ...
  void (__fastcall *Lock)(_DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, _VPB **); // rax
  ...
  if ( WPP_GLOBAL_Control != &WPP_MAIN_CB )
  {
    ...
    if ( LODWORD(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Flink) == 4 )
    {
      do
      {
        Lock = (void (__fastcall *)(_DRIVER_OBJECT *, _QWORD, void (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, _VPB **))WPP_MAIN_CB.DeviceQueue.Lock;
        v2->Vpb = 0LL;
        Lock(v2->DriverObject, 0LL, WppClassicProviderCallback, v2, &v2->Vpb);
        v2 = v2->NextDevice;
      }
      while ( v2 );
    }
