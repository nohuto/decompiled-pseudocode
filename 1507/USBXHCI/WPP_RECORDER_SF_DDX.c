/*
 * XREFs of WPP_RECORDER_SF_DDx @ 0x1C0024058
 * Callers:
...
__int64 WPP_RECORDER_SF_DDx(__int64 a1, unsigned __int8 a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= a2 )
    (*(void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
      ...
      0LL);
  LOWORD(v9) = a4;
  return WppAutoLogTrace(a1, a2, 13LL, &WPP_ee7759932d876114f80ff23edcd4b288_Traceguids, v9, (__int64 *)va);
}
