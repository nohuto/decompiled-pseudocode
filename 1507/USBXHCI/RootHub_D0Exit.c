/*
 * XREFs of RootHub_D0Exit @ 0x1C0001A90
 * Callers:
...
LABEL_11:
    ...
    if ( v11 < 0 && a3 == 7 )
      ((void (__fastcall *)(__int64, _QWORD))qword_1C0041530)(UcxGlobals, *(_QWORD *)a1);
...
LABEL_24:
  ...
  if ( v37 )
  {
    v39 = PoFxPowerControl(v37, &GUID_XHCI_SUB_DX_STATE, &v42, 4LL, 0LL, 0LL, 0LL);
    if ( v39 < 0 )
    {
      LOBYTE(v40) = 4;
      WPP_RECORDER_SF_d(
