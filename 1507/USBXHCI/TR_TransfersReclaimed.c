/*
 * XREFs of TR_TransfersReclaimed @ 0x1C0020AE8
 * Callers:
...
__int64 __fastcall TR_TransfersReclaimed(__int64 a1)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD))(WdfFunctions_01015 + 1632))(
         WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
         *(_QWORD *)(a1 + 56));
  return (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, const char *, __int64, const char *))(WdfFunctions_01015
                                                                                                + 1648))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           v4,
           "Transfer Ring Tag",
