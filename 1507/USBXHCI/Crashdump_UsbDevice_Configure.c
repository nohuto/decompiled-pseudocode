/*
 * XREFs of Crashdump_UsbDevice_Configure @ 0x1C0036FB4
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C0037ABC (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C0037BF4 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 * Callees:
 *     Crashdump_Endpoint_SendControlTransfer @ 0x1C003691C (Crashdump_Endpoint_SendControlTransfer.c)
