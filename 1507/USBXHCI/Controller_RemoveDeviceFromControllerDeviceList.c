/*
 * XREFs of Controller_RemoveDeviceFromControllerDeviceList @ 0x1C0015880
 * Callers:
...
__int64 __fastcall Controller_RemoveDeviceFromControllerDeviceList(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *(_QWORD *)(v7 + 8) = v8;
  ...
  (*(void (__fastcall **)(_LIST_ENTRY *, __int64, void (__fastcall *)(__int64, __int64, _QWORD *), __int64, const char *))(WdfFunctions_01015 + 1648))(
    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
    a2,
    Controller_AddDeviceToControllerDeviceList,
    6392LL,
    "drivers\\wdm\\usb\\usb3\\usbxhci\\sys\\controller.c");
  return (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, void (__fastcall *)(__int64, __int64, _QWORD *), __int64, const char *))(WdfFunctions_01015 + 1648))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           *(_QWORD *)(a1 + 8),
           Controller_AddDeviceToControllerDeviceList,
           6399LL,
