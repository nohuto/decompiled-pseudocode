/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromS0 @ 0x1C0016340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromS0(__int64 a1)
{
  ...
  v2 = *(_QWORD *)((*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *))(WdfFunctions_01015 + 1616))(
                 ...
                 + 8);
  v3 = *(_QWORD *)(v2 + 120);
  WPP_RECORDER_SF_q(*(_QWORD *)(v2 + 64), 4u, 3u, 0x57u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, a1);
  v4 = 0;
  for ( *(_BYTE *)(v2 + 348) = 1; v4 < *(_DWORD *)(v3 + 16); ++v4 )
  {
    v5 = 56LL * v4;
