/*
 * XREFs of RootHub_UcxEvtClearPortFeature @ 0x1C0002CD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RootHub_WaitForPendingU3TransitionCompletion @ 0x1C001F3AC (RootHub_WaitForPendingU3TransitionCompletion.c)
...
__int64 __fastcall RootHub_UcxEvtClearPortFeature(__int64 a1, __int64 a2)
{
  ...
  _QWORD v149[5]; // [rsp+78h] [rbp-70h] BYREF
  ...
  if ( !v6 || *(_BYTE *)(v4 + 285) )
  {
    ...
    LODWORD(v141) = v137;
    LODWORD(v140) = v6;
    WPP_RECORDER_SF_dd(v138, 2u, 3u, 0xD7u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v140, v141);
    WPP_RECORDER_SF_(
...
LABEL_66:
  ...
  {
    v27 = 39;
    v28 = *(unsigned __int8 *)(v149[1] + 134LL);
    v29 = *(unsigned __int8 *)(v149[1] + 131LL);
    v35 = *(unsigned __int8 *)(v149[1] + 130LL);
    v36 = *(unsigned __int8 *)(v149[1] + 129LL);
    v147 = *(unsigned __int8 *)(v149[1] + 135LL);
    v146 = v28;
    v145 = v11;
    v144 = v10;
    v143 = v29;
  ...
  if ( v14 != 3 )
  {
    v38 = *(unsigned __int8 *)(v149[1] + 134LL);
    v27 = 101;
    v28 = *(unsigned __int8 *)(v149[1] + 131LL);
    v39 = *(_QWORD *)(v3 + 8);
    v29 = *(unsigned __int8 *)(v149[1] + 130LL);
    v147 = *(unsigned __int8 *)(v149[1] + 135LL);
    v146 = v38;
    v37 = *(_QWORD *)(v39 + 64);
    v145 = v11;
