/*
 * XREFs of Endpoint_UcxEvtEndpointStaticStreamsEnable @ 0x1C001BC30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointStaticStreamsEnable(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  WPP_RECORDER_SF_ddd(
    ...
    *(_DWORD *)(v6 + 8));
  (*(void (__fastcall **)(_LIST_ENTRY *, _QWORD, _QWORD, _QWORD))(WdfFunctions_01015 + 1304))(
    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
    *(_QWORD *)(*(_QWORD *)(v7 + 88) + 72LL),
    0LL,
    0LL);
  (*(void (__fastcall **)(_LIST_ENTRY *, _QWORD, int *, int *))(WdfFunctions_01015 + 1224))(
    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
    *(_QWORD *)(*(_QWORD *)(v7 + 88) + 72LL),
    &v26,
    &v27);
  ...
  else
  {
    ...
    {
      *(_QWORD *)(*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *))(WdfFunctions_01015 + 1616))(
                   WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
                   a3,
                   off_1C0040068) = v6;
