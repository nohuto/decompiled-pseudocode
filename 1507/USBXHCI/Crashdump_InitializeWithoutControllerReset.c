/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C003420C
 * Callers:
 *     Crashdump_Initialize @ 0x1C0033B90 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C0035E10 (Crashdump_EventRing_PrepareForHibernate.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 76), 0x190uLL, 0x43434858u);
