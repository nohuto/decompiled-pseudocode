/*
 * XREFs of Controller_PopulateHardwareVerifierFlags @ 0x1C004A3DC
 * Callers:
...
__int64 __fastcall Controller_PopulateHardwareVerifierFlags(__int64 a1)
{
  ...
  *(_DWORD *)&DestinationString.Length = 3407872;
  ...
  v5 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, void *, __int64, _QWORD, __int64 *))(WdfFunctions_01015 + 1832))(
  ...
  else
  {
    if ( v7 != 2 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0xC5u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
      goto LABEL_7;
    }
...
LABEL_25:
    LODWORD(v15) = v5;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 64), 2u, 3u, v9, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v15);
    goto LABEL_7;
  }
  v5 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, struct _UNICODE_STRING *, __int64, _QWORD, __int64 *))(WdfFunctions_01015 + 1832))(
         WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
         v18,
         &DestinationString,
         131097LL,
  ...
  if ( v5 >= 0 )
  {
    v5 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *, __int64, _QWORD, __int64 *))(WdfFunctions_01015
                                                                                               + 1832))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           v17,
           v4,
    ...
    v5 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *, __int64, __int64 *, _QWORD, _QWORD))(WdfFunctions_01015 + 1880))(
           WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
           v16,
...
LABEL_48:
    if ( v5 == -1073741772 )
    {
      ...
      if ( v5 >= 0 )
      {
        v5 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *, __int64, _QWORD, __int64 *))(WdfFunctions_01015 + 1832))(
               WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
               v17,
               v4,
               131097LL,
...
LABEL_60:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0xC7u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
LABEL_8:
  *(_QWORD *)(a1 + 328) = 0LL;
  if ( v5 != -1073741772 )
  {
