/*
 * XREFs of IntelPptFilter_FilterCommand @ 0x1C00530C0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_ @ 0x1C0001300 (WPP_RECORDER_SF_.c)
 *     IntelPptFilter_CheckAndIncreaseEndpointCount @ 0x1C0053008 (IntelPptFilter_CheckAndIncreaseEndpointCount.c)
