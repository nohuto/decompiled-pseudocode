/*
 * XREFs of Interrupter_IoResList_GetMessageCountAndType @ 0x1C0048EA0
 * Callers:
...
char *__fastcall Interrupter_IoResList_GetMessageCountAndType(__int64 a1, unsigned int *a2, unsigned int *a3, char *a4)
{
  ...
  v7 = a1;
  for ( i = 0;
        i < (*(unsigned int (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 2320))(
              WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
              v7);
        ++i )
  {
    v9 = 0;
    v10 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD))(WdfFunctions_01015 + 2328))(
            WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
            v7,
            i);
    v11 = 0;
    v12 = 0;
    while ( v11 < (*(unsigned int (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 2384))(
                    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
                    v10) )
    {
