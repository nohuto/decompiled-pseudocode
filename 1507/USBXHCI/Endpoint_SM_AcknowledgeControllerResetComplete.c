/*
 * XREFs of Endpoint_SM_AcknowledgeControllerResetComplete @ 0x1C0019C8C
 * Callers:
 *     ESM_AcknowledgingControllerResetCompleteInDisabled @ 0x1C0039100 (ESM_AcknowledgingControllerResetCompleteInDisabled.c)
 * Callees:
 *     <none>
 */
