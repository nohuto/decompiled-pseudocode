/*
 * XREFs of Controller_D0ExitSaveState @ 0x1C0014A64
 * Callers:
...
__int64 __fastcall Controller_D0ExitSaveState(_QWORD *a1)
{
  ...
  WPP_RECORDER_SF_(a1[8], 4u, 3u, 0x78u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
  ...
  if ( (v5 & 0x200) != 0 )
  {
    v6 = 123;
LABEL_5:
    WPP_RECORDER_SF_(a1[8], 2u, 3u, v6, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
LABEL_16:
    v9 = -1073741630;
    goto LABEL_17;
  }
  WPP_RECORDER_SF_(a1[8], 4u, 3u, 0x7Cu, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
  ...
  *v4 |= 0x100u;
  ...
  for ( i = 20; ; --i )
  {
    ...
    if ( (v11 & 0x400) != 0 )
    {
      ...
      WPP_RECORDER_SF_I(v13, 2u, v14, 0x7Du, v23);
      v4[1] = 1024;
      _InterlockedOr(v22, 0);
      goto LABEL_16;
    }
    ...
    if ( !i )
    {
      ...
      WPP_RECORDER_SF_I(v17, 2u, v18, 0x7Fu, v23);
      goto LABEL_16;
    }
  ...
  WPP_RECORDER_SF_I(v20, 4u, v21, 0x7Eu, v23);
LABEL_17:
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DeviceObject & 8) != 0 )
    Template_pq(
