/*
 * XREFs of Endpoint_UcxEvtDefaultEndpointUpdate @ 0x1C001ACF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Endpoint_UcxEvtDefaultEndpointUpdate(__int64 a1, __int64 a2)
{
  ...
  (*(void (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD *))(WdfFunctions_01015 + 2128))(
    ...
    v22);
  v3 = v22[1];
  v4 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, void *))(WdfFunctions_01015 + 1616))(
         WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
         *(_QWORD *)(v22[1] + 24LL),
         off_1C0040108);
  WPP_RECORDER_SF_ddd(
  ...
  *((_DWORD *)v8 + 4) = *(_DWORD *)(v3 + 32);
  ...
  if ( (*(_DWORD *)(v5 + 104) & 4) == 0 )
    v10 = 1056;
  v11 = CommonBuffer_AcquireBuffer(v6, v10, v4, 0x31747045u);
  v8[1] = (__int64)v11;
  if ( v11 )
  {
    v13 = v11[2];
    ...
    *(_BYTE *)(v14 + 5) = 0;
    ...
    if ( v16 != 1 )
    {
      if ( (*(_QWORD *)(*(_QWORD *)v4 + 232LL) & 0x10000000000000LL) == 0
        || v16 != 3
        || *(char *)(v4 + 98) >= 0
