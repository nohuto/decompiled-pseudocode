/*
 * XREFs of Controller_WdfEvtDeviceD0EntryPostInterruptsEnabled @ 0x1C0003DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceD0EntryPostInterruptsEnabled(__int64 a1, unsigned int a2)
{
  ...
  if ( v10 < 0 )
  {
    v23 = *(_QWORD *)(v4 + 64);
    LODWORD(v35) = v10;
    WPP_RECORDER_SF_d(v23, 2u, 3u, 0x4Au, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v35);
    goto LABEL_14;
  }
  v12 = 1;
  v13 = *(_QWORD *)(v4 + 120);
...
LABEL_10:
  ...
  if ( v19 < 0 )
  {
    v33 = *(_QWORD *)(v4 + 64);
    LODWORD(v35) = v19;
    WPP_RECORDER_SF_d(v33, 2u, 3u, 0x4Cu, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v35);
  }
  else if ( (*(_BYTE *)(v4 + 232) & 0x10) != 0 )
  {
    v11 = -1073741637;
    WPP_RECORDER_SF_(*(_QWORD *)(v4 + 64), 2u, 3u, 0x4Du, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids);
  }
  else
  {
