/*
 * XREFs of Bulk_Stage_AcquireMdl @ 0x1C002BA30
 * Callers:
...
__int64 __fastcall Bulk_Stage_AcquireMdl(__int64 a1)
{
  ...
  v4 = *(struct _MDL **)(*(_QWORD *)a1 + 64LL);
  for ( i = *(_DWORD *)(*(_QWORD *)a1 + 96LL); ; i -= ByteCount )
  {
  ...
  if ( i )
  {
    ...
    *(_QWORD *)(a1 + 48) = Mdl;
    ...
    else
    {
      ...
      LOBYTE(v11) = 2;
      WPP_RECORDER_SF_DDDqq(*(_QWORD *)(*(_QWORD *)(v3 + 56) + 80LL), v11, v10, 27);
