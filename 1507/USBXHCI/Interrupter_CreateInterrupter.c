/*
 * XREFs of Interrupter_CreateInterrupter @ 0x1C0047A80
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  v12 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD *, _QWORD *, __int64 *))(WdfFunctions_01015 + 1128))(
  ...
  *a6 = v16;
  ...
  if ( a7 )
  {
    ...
    v21[6] = off_1C00401A8;
    LODWORD(v21[0]) = 56;
    v12 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, _QWORD *, _QWORD **))(WdfFunctions_01015 + 1624))(
            WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
            a5,
            v21,
            &v23);
...
LABEL_10:
    LODWORD(v20) = v12;
    WPP_RECORDER_SF_d(*(_QWORD *)(a2 + 64), 2u, 8u, v19, (__int64)&WPP_b5cbcd348d84cc97a8629183b7c53e9f_Traceguids, v20);
  }
  return v13;
}
