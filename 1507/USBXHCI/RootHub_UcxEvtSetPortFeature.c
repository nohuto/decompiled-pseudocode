/*
 * XREFs of RootHub_UcxEvtSetPortFeature @ 0x1C0002F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RootHub_UcxEvtSetPortFeature(__int64 a1, __int64 a2)
{
  ...
  if ( !v6 || *(_BYTE *)(v4 + 285) )
  {
    ...
    LODWORD(v120) = v116;
    LODWORD(v119) = v6;
    WPP_RECORDER_SF_dd(v117, 2u, 3u, 0xD7u, (__int64)&WPP_71d031db04c83962e2b4b0195700cb23_Traceguids, v119, v120);
    WPP_RECORDER_SF_(
