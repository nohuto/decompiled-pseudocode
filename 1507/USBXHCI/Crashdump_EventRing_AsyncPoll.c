/*
 * XREFs of Crashdump_EventRing_AsyncPoll @ 0x1C00356FC
 * Callers:
 *     Crashdump_PollForCompletion @ 0x1C0034430 (Crashdump_PollForCompletion.c)
 * Callees:
...
__int64 __fastcall Crashdump_EventRing_AsyncPoll(__int64 a1, __int64 *a2)
{
  ...
  v11 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 568LL)
