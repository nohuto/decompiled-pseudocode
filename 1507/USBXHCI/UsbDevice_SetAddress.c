/*
 * XREFs of UsbDevice_SetAddress @ 0x1C002FEE4
 * Callers:
...
__int64 __fastcall UsbDevice_SetAddress(__int64 a1, char a2)
{
  ...
  *(_BYTE *)(v9 + 6) = *(_BYTE *)(a1 + 44);
  ...
  if ( v22 )
  {
    v23 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *))(WdfFunctions_01015 + 1616))(
  ...
  *(_QWORD *)(v10 + 8) = Endpoint_GetDequeuePointer(*(_QWORD *)(a1 + 176), 0);
