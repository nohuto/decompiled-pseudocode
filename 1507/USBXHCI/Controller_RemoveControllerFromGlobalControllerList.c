/*
 * XREFs of Controller_RemoveControllerFromGlobalControllerList @ 0x1C00157EC
 * Callers:
...
__int64 __fastcall Controller_RemoveControllerFromGlobalControllerList(_QWORD *a1)
{
  ...
  *(_QWORD *)(v3 + 8) = v4;
  ...
  return (*(__int64 (__fastcall **)(_LIST_ENTRY *, _QWORD, void (__fastcall *)(__int64), __int64, const char *))(WdfFunctions_01015 + 1648))(
