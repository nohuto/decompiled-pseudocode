/*
 * XREFs of Crashdump_EventRing_PrepareForDump @ 0x1C0035CF8
 * Callers:
 *     Crashdump_InitializeWithControllerReset @ 0x1C0033FF0 (Crashdump_InitializeWithControllerReset.c)
 * Callees:
 *     memset @ 0x1C0007F80 (memset.c)
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1C0035EEC (Crashdump_EventRing_UpdateDequeuePointer.c)
 */
