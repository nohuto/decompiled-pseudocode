/*
 * XREFs of IoControl_WdfEvtIoDeviceControl @ 0x1C001DEF0
 * Callers:
 *     <none>
 * Callees:
...
PDEVICE_OBJECT __fastcall IoControl_WdfEvtIoDeviceControl(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  v9 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, void *))(WdfFunctions_01015 + 1616))(
         ...
         a1,
         off_1C0040180);
  v10 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 1256))(
          WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
          a1);
  if ( (unsigned __int8)((__int64 (__fastcall *)(__int64, __int64, __int64, __int64, __int64, int))UcxClassFunctions)(
                          UcxGlobals,
                          v10,
                          a2,
                          a3,
  ...
  else
  {
    WPP_RECORDER_SF_qD(
      *(_QWORD *)(*(_QWORD *)(v9 + 8) + 64LL),
      ...
      a2,
      a5);
    v13 = (*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64))(WdfFunctions_01015 + 2240))(
            WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
            a2);
    if ( v13 == 1 )
    {
    ...
    return (PDEVICE_OBJECT)(*(__int64 (__fastcall **)(_LIST_ENTRY *, __int64, __int64))(WdfFunctions_01015 + 2104))(
                             WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink,
                             a2,
                             v14);
  }
