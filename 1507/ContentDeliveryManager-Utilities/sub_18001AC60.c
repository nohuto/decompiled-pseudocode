/*
 * XREFs of sub_18001AC60 @ 0x18001AC60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18001AC60(__int64 a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  else
  {
    ...
    if ( (int)v6 > 0 )
    {
      do
      {
        if ( (_DWORD)v6 == _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 128), v6 + 1, v6) )
          break;
        v6 = *(unsigned int *)(a1 + 128);
      }
      while ( (int)v6 > 0 );
