/*
 * XREFs of sub_180003BF0 @ 0x180003BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180003BF0(__int64 a1, _QWORD *a2)
{
  _QWORD *v3; // rax
  _QWORD *v4; // rbx
  int v5; // esi
...
LABEL_14:
  ...
  *v8 = off_18002C3E0;
  v18 = v4;
  v17 = 0LL;
  v9 = sub_180002F48(v8, (int)off_18002BCF0);
  v5 = v9;
  if ( v9 >= 0 )
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD *, void *, _QWORD))*v4)(v4, &unk_18002C4F8, &v16);
  }
  else
  {
    sub_180002568(retaddr, 53, (__int64)"shell\\contentdeliverymanager\\utils\\dll\\contentmanagementbroker.cpp", v9);
    if ( !v4 )
      goto LABEL_10;
  }
