 ...
 * Callers:
 *     sub_180006790 @ 0x180006790 (sub_180006790.c)
...
__int64 __fastcall sub_180006F00(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  unsigned int v3; // edi
  int v5; // esi
  __int64 v6; // rcx
...
LABEL_19:
      ...
      if ( *a2 != -678814224 || a2[1] != 1128368901 || a2[2] != 1153698491 || a2[3] != 313066362 )
      {
        v5 = -2147467262;
LABEL_36:
        if ( v5 < 0 )
