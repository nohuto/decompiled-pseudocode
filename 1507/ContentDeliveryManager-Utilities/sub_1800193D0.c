/*
 * XREFs of sub_1800193D0 @ 0x1800193D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800193D0(__int64 a1, int a2, int a3)
{
  __int64 v3; // rax
  int v4; // eax
  unsigned int v5; // ebx
  ...
  if ( a2 == 1 && a3 >= 0 )
  {
    ...
    while ( v3 );
    v4 = sub_18000F804(*(_QWORD *)(a1 + 8), 5 - (unsigned int)(*(_BYTE *)(a1 + 16) != 0), (__int64)v7);
    v5 = v4;
    if ( v4 >= 0 )
      return 0;
    else
