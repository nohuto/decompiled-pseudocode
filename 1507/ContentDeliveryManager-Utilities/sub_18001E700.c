/*
 * XREFs of sub_18001E700 @ 0x18001E700
 * Callers:
...
__int64 __fastcall sub_18001E700(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  __int64 v4; // rsi
  _QWORD *v6; // rbx
  bool v10; // zf
