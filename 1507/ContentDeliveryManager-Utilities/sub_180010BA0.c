/*
 * XREFs of sub_180010BA0 @ 0x180010BA0
 * Callers:
...
__int64 __fastcall sub_180010BA0(__int64 (__fastcall ***a1)(_QWORD, void *, __int64 *), __int64 a2, __int64 a3)
{
  ...
  if ( v7 < 0 )
  {
    sub_1800025D0(retaddr, 549, (__int64)"shell\\contentdeliverymanager\\utils\\dll\\contentmanagementservice.cpp", v7);
    goto LABEL_17;
  }
  v20 = 0LL;
  ...
  {
    v22[0] = 0LL;
    v10 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD *))(*(_QWORD *)v20 + 144LL))(v20, a3, v22);
    v8 = v10;
    if ( v10 >= 0 )
    {
      v12 = v21;
