/*
 * XREFs of sub_180009C28 @ 0x180009C28
 * Callers:
...
__int64 __fastcall sub_180009C28(__int64 a1, int a2, unsigned int a3, int a4, __int64 a5, _QWORD *a6, __int64 *a7)
{
  ...
  LPVOID lpParameter; // [rsp+68h] [rbp-A0h] BYREF
  ...
  *a7 = 0LL;
  ...
  if ( (a3 & 2) != 0 )
  {
    for ( i = qword_18003AC18; i; i = *(_QWORD *)(i + 16) )
    {
      if ( *(_DWORD *)(i + 136) == a4
        && *(_QWORD *)(i + 144)
        && (a2 == *(_DWORD *)(i + 80) || a2 == 3)
        ...
        && (*(_BYTE *)(i + 132) & 2) != 0 )
      {
        ...
        v42 = 0LL;
        v12 = sub_180008D00((_QWORD *)(i + 24), v40);
        if ( v41 )
        ...
        && *(int *)(v22 + 48) >= 0 )
      {
        if ( *(_QWORD *)(v22 + 144) || *(_BYTE *)(v22 + 96) )
        {
          ...
          if ( *(_DWORD *)(v22 + 136) == a4 )
          {
            if ( byte_18003A096 )
            {
              if ( dword_18003AC28 == *(_DWORD *)(v22 + 88) )
              {
                dword_18003AC28 = 0;
                if ( !*(_QWORD *)(v22 + 24) && !v10 && *(int *)(v22 + 92) <= 1 )
                {
                  ...
                  v48 = 0LL;
                  v12 = sub_180008D00((_QWORD *)(v22 + 24), v46);
                  if ( v47 )
                  ...
                  if ( v12 >= 0 )
                  {
                    *(_BYTE *)(v22 + 97) = 1;
                    if ( !*(_QWORD *)(v22 + 104) )
                      *(_QWORD *)(v22 + 104) = CreateThreadpoolTimer((PTP_TIMER_CALLBACK)pfnti, (PVOID)v22, 0LL);
              ...
              if ( v20 >= 0x64 || v24 >= 8 )
              {
                ...
                if ( a5 )
                  (*(void (__fastcall **)(__int64, __int64, unsigned __int64, _QWORD))(*(_QWORD *)a5 + 8LL))(
                    ...
                    pftDueTime.dwLowDateTime);
                v45 = 0LL;
                v12 = sub_180008D00(&qword_18003AD68, v43);
                v26 = v44;
                goto LABEL_96;
              }
            }
  ...
  {
LABEL_77:
    sub_180018228(&lpParameter, &v57, &v58, dwLowDateTime);
    v27 = lpParameter;
    v12 = lpParameter == 0LL ? 0x8007000E : 0;
    if ( lpParameter )
    {
      v52[0] = v9;
      v52[1] = v8;
      ...
      if ( a5 )
        (*(void (__fastcall **)(__int64))(*(_QWORD *)a5 + 8LL))(a5);
      v54 = 0LL;
      sub_180008D9C((__int64)v27, (__int64)v52, v33, a1, 0LL);
      if ( v53 )
        (*(void (__fastcall **)(__int64))(*(_QWORD *)v53 + 16LL))(v53);
      if ( v30 && !(_DWORD)v35 )
      {
        v12 = sub_180008F20((__int64)v27);
        goto LABEL_87;
      }
      v12 = sub_18000909C((__int64)v27);
      if ( v12 >= 0 )
      {
        *a7 = (__int64)v27;
...
LABEL_87:
  ...
  v51 = 0LL;
  sub_180008D9C(v22, (__int64)v49, v33, v10, 0LL);
  v26 = v50;
LABEL_96:
  if ( v26 )
