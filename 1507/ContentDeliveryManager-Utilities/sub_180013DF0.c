/*
 * XREFs of sub_180013DF0 @ 0x180013DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180013DF0(__int64 a1, unsigned __int16 a2)
{
  __int64 result; // rax
...
LABEL_15:
    ...
    if ( v13 + v12 )
    {
      if ( v14 > 0x7FFFFFFFFFFFFFFFLL || (v15 = sub_180021148(2 * v14)) == 0 )
