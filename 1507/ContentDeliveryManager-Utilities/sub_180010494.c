/*
 * XREFs of sub_180010494 @ 0x180010494
 * Callers:
...
__int64 __fastcall sub_180010494(__int64 (__fastcall ***a1)(_QWORD, void *, __int64 *), __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 < 0 )
  {
    sub_1800025D0(retaddr, 488, (__int64)"shell\\contentdeliverymanager\\utils\\dll\\contentmanagementservice.cpp", v7);
    goto LABEL_15;
  }
  v19 = 0LL;
  v9 = v18;
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( v12 >= 0 )
    {
      v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)v20[0] + 112LL))(v20[0], a3);
      v8 = v12;
      if ( v12 >= 0 )
      {
        v8 = 0;
LABEL_11:
  ...
  sub_1800025D0(retaddr, 491, (__int64)"shell\\contentdeliverymanager\\utils\\dll\\contentmanagementservice.cpp", v11);
LABEL_13:
  v15 = v19;
  if ( v19 )
  {
