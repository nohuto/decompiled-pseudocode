/*
 * XREFs of sub_18000F470 @ 0x18000F470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18000F470(__int64 a1, char a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v8 )
  {
    ((void (__fastcall *)(__int64 *, _DWORD *, const wchar_t **, int *, __int64))sub_18001E004)(
      &v17,
      v13,
      &v19,
      &v18,
...
LABEL_20:
  ...
  if ( v9 < 0 )
    sub_1800025D0(retaddr, 338, (__int64)"shell\\contentdeliverymanager\\utils\\dll\\contentmanagementservice.cpp", v9);
  if ( v5 )
    sub_180007270(v5, v6, v7);
