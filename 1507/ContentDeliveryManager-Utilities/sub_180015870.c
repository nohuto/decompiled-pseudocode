/*
 * XREFs of sub_180015870 @ 0x180015870
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_180015870(int a1, _OWORD *a2, __int64 a3, __int64 a4, __int64 a5, _DWORD *a6, double *a7)
{
  ...
  v11 = unknown_libname_8(v17, &v16, v10, &v14);
  v12 = v11;
  if ( v15 )
    v12 = ldexp(v11, 4 * v15);
  if ( !*(_BYTE *)(a3 + 8) )
