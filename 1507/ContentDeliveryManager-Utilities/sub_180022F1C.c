...
__int64 __fastcall sub_180022F1C(char *a1, char *a2, char **a3, _DWORD *a4, int a5)
{
  int v5; // ebp
  char *v7; // rbx
  char *v8; // r13
  ...
  *a4 = 0;
  ...
  if ( v11 )
  {
    ...
    do
    {
      ...
      {
        ++v10;
        v28[v12++] = byte_18002B508[v11 - "0123456789abcdefABCDEF"];
      }
      v11 = memchr("0123456789abcdefABCDEF", *++v7, 0x16uLL);
    }
    while ( v11 );
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      {
        ++v10;
        v28[v14++] = byte_18002B508[v13 - "0123456789abcdefABCDEF"];
        --*a4;
      }
      v13 = memchr("0123456789abcdefABCDEF", *++v7, 0x16uLL);
    }
