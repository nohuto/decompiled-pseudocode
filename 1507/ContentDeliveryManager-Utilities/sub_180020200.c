/*
 * XREFs of sub_180020200 @ 0x180020200
 * Callers:
...
__int64 __fastcall sub_180020200(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5, _QWORD *a6)
{
  ...
  if ( a4 + 1 >= a4 && (*a6 = 0LL, is_mul_ok(v6, 2uLL)) )
  {
    ...
    *a6 = v9;
    ...
    if ( v9 )
    {
      ...
      {
        v11 = v6;
        v12 = (char *)(&unk_18002B65C - (_UNKNOWN *)v9);
        v13 = v9;
        v14 = 0;
        v15 = 0LL;
        do
