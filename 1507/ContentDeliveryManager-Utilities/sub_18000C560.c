/*
 * XREFs of sub_18000C560 @ 0x18000C560
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18000C560(__int64 a1)
{
  int *v1; // rbx
  int v3; // eax
  int *v4; // rbx
  ...
  **(_DWORD **)(a1 + 48) = 2;
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      v72 = 2 * v10 + 2;
      v73 = 0;
      sub_1800011FC(v7, byte_180033643, (const GUID *)(v6 + 8), 0LL, 0x10u, &v37);
    }
  }
  else
  {
      ...
      && (*(_QWORD *)(v26 + 24) & 0x200000000000LL) == *(_QWORD *)(v26 + 24) )
    {
      ...
      v77 = &v32;
      v78 = 4LL;
      sub_1800011FC(v26, byte_1800330E2, (const GUID *)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &v74);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
  {
