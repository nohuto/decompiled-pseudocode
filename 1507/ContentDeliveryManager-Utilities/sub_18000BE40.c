/*
 * XREFs of sub_18000BE40 @ 0x18000BE40
 * Callers:
...
void __fastcall sub_18000BE40(__int64 a1)
{
  int *v1; // rbx
  int v3; // eax
  int *v4; // rbx
  ...
  **(_DWORD **)(a1 + 48) = 2;
  if ( v4 )
  {
    ...
    v7 = *(_QWORD *)(v6 + 40);
    if ( *(_DWORD *)v7 > 5u
      && (*(_QWORD *)(v7 + 16) & 0x800000000000LL) != 0
      && (*(_QWORD *)(v7 + 24) & 0x800000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      v8 = &unk_18002B658;
      v9 = (void *)*((_QWORD *)v4 + 6);
      v34 = v4[1];
      ...
      v72 = 2 * v10 + 2;
      v73 = 0;
      sub_1800011FC(v7, byte_1800333EB, (const GUID *)(v6 + 8), 0LL, 0x10u, &v37);
    }
  }
  else
  {
    ...
    v26 = *(_QWORD *)(v25 + 40);
    if ( *(_DWORD *)v26 > 5u
      && (*(_QWORD *)(v26 + 16) & 0x800000000000LL) != 0
      && (*(_QWORD *)(v26 + 24) & 0x800000000000LL) == *(_QWORD *)(v26 + 24) )
    {
      ...
      v77 = &v32;
      v78 = 4LL;
      sub_1800011FC(v26, byte_1800334F8, (const GUID *)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &v74);
    }
  }
  if ( *(_DWORD *)(a1 + 32) )
  {
