...
_UNKNOWN **__fastcall sub_18001C03C(__int64 a1)
{
  _UNKNOWN **result; // rax
  __int64 v3; // rsi
  __int64 v4; // rsi

  result = &off_18002CEE0;
  *(_QWORD *)a1 = &off_18002CEE0;
  if ( !*(_DWORD *)(a1 + 8) )
