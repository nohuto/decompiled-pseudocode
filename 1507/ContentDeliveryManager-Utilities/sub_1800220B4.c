/*
 * XREFs of sub_1800220B4 @ 0x1800220B4
 * Callers:
 *     sub_1800154D0 @ 0x1800154D0 (sub_1800154D0.c)
 *     sub_180015980 @ 0x180015980 (sub_180015980.c)
 *     sub_180021CAC @ 0x180021CAC (sub_180021CAC.c)
 * Callees:
 *     <none>
 */

unsigned __int64 __fastcall sub_1800220B4(char *a1, char **a2, int a3, _DWORD *a4)
{
  char *v7; // rbp
  char *v8; // rbx
  int i; // ecx
