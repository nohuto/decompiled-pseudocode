/*
 * XREFs of sub_180012910 @ 0x180012910
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180012910(__int64 a1, __int64 a2)
{
  bool v4; // zf
  __int64 v5; // rdi
  __int64 v6; // r10
  ...
  v4 = dword_18003A0E4 == *(_DWORD *)(a2 + 8);
  ...
  {
    if ( *(_DWORD *)v6 > 5u
      && (*(_QWORD *)(v6 + 16) & 0x800000000000LL) != 0
      && (*(_QWORD *)(v6 + 24) & 0x800000000000LL) == *(_QWORD *)(v6 + 24) )
    {
      v24 = &unk_18002B658;
      v25 = *(void **)(a2 + 48);
      v26 = &unk_18002B658;
      ...
      v101 = v27 + 1;
      v102 = 0;
      sub_1800011FC(v6, byte_18003374C, (const GUID *)(v5 + 8), 0LL, 0x13u, &v59);
    }
  }
  else if ( *(_DWORD *)v6 > 5u
         && (*(_QWORD *)(v6 + 16) & 0xA00000000000LL) != 0
         && (*(_QWORD *)(v6 + 24) & 0xA00000000000LL) == *(_QWORD *)(v6 + 24) )
  {
    v7 = &unk_18002B658;
    v8 = *(void **)(a2 + 48);
    v9 = &unk_18002B658;
    ...
    v138 = 2 * v10 + 2;
    v139 = 0;
    sub_1800011FC(v6, byte_1800338DD, (const GUID *)(v5 + 8), 0LL, 0x10u, &v103);
  }
