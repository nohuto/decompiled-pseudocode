/*
 * XREFs of sub_180012308 @ 0x180012308
 * Callers:
...
__int64 __fastcall sub_180012308(__int64 a1, __int64 a2, unsigned int a3)
{
  int v4; // edi
  int v5; // eax
  __int64 v6; // rsi
  ...
  v16 = 0LL;
  v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64 *))(**(_QWORD **)(a1 + 8) + 88LL))(
         *(_QWORD *)(a1 + 8),
         a3,
         &v16);
  v4 = v5;
