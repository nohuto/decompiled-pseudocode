/*
 * XREFs of sub_180015080 @ 0x180015080
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_180015080(int a1, _OWORD *a2, __int64 a3, __int64 a4, __int64 a5, _DWORD *a6, _DWORD *a7)
{
  _QWORD *v11; // rdx
  ...
  v13 = sub_1800212B8(v19, &v17, v12, &v16);
  if ( v18[0] )
  {
