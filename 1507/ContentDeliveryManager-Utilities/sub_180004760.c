/*
 * XREFs of sub_180004760 @ 0x180004760
 * Callers:
 *     sub_180003B90 @ 0x180003B90 (sub_180003B90.c)
 *     sub_180006180 @ 0x180006180 (sub_180006180.c)
 *     sub_1800061B0 @ 0x1800061B0 (sub_1800061B0.c)
 *     sub_180006380 @ 0x180006380 (sub_180006380.c)
 * Callees:
 *     _guard_check_icall_nop @ 0x18000B5A0 (_guard_check_icall_nop.c)
 */

__int64 __fastcall sub_180004760(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  unsigned int v3; // edi
  int v5; // esi
  __int64 v6; // rcx
...
LABEL_19:
      ...
      if ( *a2 != -1251307887 || a2[1] != 1205598164 || a2[2] != -163572311 || a2[3] != -701601038 )
      {
        v5 = -2147467262;
LABEL_36:
        if ( v5 < 0 )
