/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C00192DC
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, _QWORD *a2)
{
  ...
  v2 = (unsigned int)dword_1C0009868;
  v4 = (unsigned int)(16 * dword_1C0009868 + 4);
  v5 = 0LL;
  v6 = 0LL;
  ...
  if ( PoolWithTag )
  {
    ...
    *P = v2;
    v8 = PoFxProcessorNotification(*(_QWORD *)(a1 + 1056), 29LL, P);
    if ( v8 >= 0 )
    {
      v9 = 0;
      v10 = 0;
        ...
        if ( (_DWORD)v2 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( *v29 )
              break;
LABEL_27:
            KeCopyAffinityEx(v48, &unk_1C0009628);
            v35 = 0;
            if ( !*v29 )
              goto LABEL_50;
            v36 = *v29;
...
LABEL_50:
            ...
            if ( (unsigned int)KeIsEqualAffinityEx(v29 - 49, &unk_1C0009628) )
              *((_BYTE *)v29 + 4) = 1;
            ++v28;
            v29 += 54;
          ...
          while ( 1 )
          {
            ...
            *v6 = v28;
            v6[1] = v30;
            v6[2] = *(v29 - 1);
            v8 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C0009618)(*(_QWORD *)(a1 + 1056), v6);
            if ( v8 < 0 )
              break;
