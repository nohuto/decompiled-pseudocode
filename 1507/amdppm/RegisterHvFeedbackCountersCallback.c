/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x1C001B110
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0005F40 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C00062C0 (memset.c)
 *     DecodeGenAddressToHvPerfReg @ 0x1C001B430 (DecodeGenAddressToHvPerfReg.c)
 */
...
__int64 __fastcall RegisterHvFeedbackCountersCallback(__int64 a1)
{
  ...
  v3 = *(_DWORD *)(a1 + 32);
  if ( !v3 )
    return (unsigned int)((__int64 (__fastcall *)(__int64))qword_1C0009578)(a1);
  v4 = v3;
