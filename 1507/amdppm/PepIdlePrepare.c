/*
 * XREFs of PepIdlePrepare @ 0x1C0003B50
 * Callers:
 *     <none>
 * Callees:
 *     AcpiCStateIdlePrepare @ 0x1C00024D0 (AcpiCStateIdlePrepare.c)
 *     PepIdleCancel @ 0x1C0003F50 (PepIdleCancel.c)
...
__int64 __fastcall PepIdlePrepare(__int64 a1)
{
  ...
  if ( dword_1C0009860 >= (unsigned int)dword_1C0009394 )
  {
    ...
    v18 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C0009608)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C0009868 )
