/*
 * XREFs of UpdateKernelIdleDomains @ 0x1C0016BA0
 * Callers:
...
__int64 __fastcall UpdateKernelIdleDomains(__int64 a1)
{
  ...
  v2 = *(unsigned int *)(*(_QWORD *)(a1 + 648) + 56LL);
    ...
    *((_DWORD *)PoolWithTag + 1) = v2;
    ...
    if ( (_DWORD)v2 )
    {
      ...
      do
      {
        ...
        v8 = *(_QWORD *)(v6 + *(_QWORD *)(a1 + 648) + 120);
        if ( v8 )
        {
          v9 = *(_QWORD *)(v8 + 8);
          if ( v9 )
    ...
    v5 = ((__int64 (__fastcall *)(char *))qword_1C0009598)(v4);
