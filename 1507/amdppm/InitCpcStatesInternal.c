/*
 * XREFs of InitCpcStatesInternal @ 0x1C00178AC
 * Callers:
 *     RegisterKernelCpc @ 0x1C00178A0 (RegisterKernelCpc.c)
 *     RegisterHvCpcCounters @ 0x1C001B100 (RegisterHvCpcCounters.c)
 * Callees:
 *     CpcRegisterIsSupported @ 0x1C0002E00 (CpcRegisterIsSupported.c)
...
__int64 __fastcall InitCpcStatesInternal(__int64 a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  __int16 v92; // [rsp+88h] [rbp-1h] BYREF
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C0009398,
    0LL);
  PerfDomain = GetPerfDomain(v3, v90, &v92);
...
LABEL_4:
  ...
  do
  {
    ...
    *v12 = IsSupported;
    ...
    if ( v14[152] == 127 )
      v11 = 0;
    if ( !qword_1C0009518 || !(unsigned __int8)qword_1C0009518(v14) )
      v79 = 0;
    v17 = 0;
    memset(v87, 0, 12);
    while ( 1 )
...
LABEL_46:
  ...
  if ( (_BYTE)v2 )
  {
    v9 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, __int64))(qword_1C0009838 + 88))(
    ...
    if ( !(unsigned int)EnumerateNextDevice((__int64)v90, &DeferredContext) )
    {
      ...
      {
        if ( *(v35 - 16) )
          WriteGenAddr((_BYTE *)(*(_QWORD *)v35 + 176LL), 1uLL);
        v35 += 312;
      }
      while ( !(unsigned int)EnumerateNextDevice((__int64)v90, &DeferredContext) );
      v5 = 0LL;
    }
    v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(qword_1C0009838 + 104))(*(_QWORD *)(qword_1C0009838 + 56), 0LL);
    if ( v9 < 0 )
      goto LABEL_155;
  }
  v4 = Size;
