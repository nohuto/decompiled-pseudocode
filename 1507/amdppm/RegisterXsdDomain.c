/*
 * XREFs of RegisterXsdDomain @ 0x1C0018F5C
 * Callers:
...
bool __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    0LL);
  v4 = qword_1C00093B8;
  if ( (__int64 *)qword_1C00093B8 == &qword_1C00093B8 )
    goto LABEL_5;
  do
  {
    v5 = v4;
  ...
  while ( (__int64 *)v4 != &qword_1C00093B8 );
  if ( !v5 )
  {
LABEL_5:
    ...
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v7 = (__int64 **)qword_1C00093C0;
    *(_QWORD *)v5 = &qword_1C00093B8;
    *(_QWORD *)(v5 + 8) = v7;
    if ( *v7 != &qword_1C00093B8 )
      __fastfail(3u);
    *v7 = (__int64 *)v5;
    qword_1C00093C0 = v5;
    *(_DWORD *)(v5 + 36) = v2[3];
