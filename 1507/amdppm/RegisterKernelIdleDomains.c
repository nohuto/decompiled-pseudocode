/*
 * XREFs of RegisterKernelIdleDomains @ 0x1C0016618
 * Callers:
  ...
  *v5 = *v1;
  ...
  if ( *v15 )
  {
    while ( 1 )
    {
      ...
      while ( (__int64 *)v17 != &qword_1C00093D8 );
      if ( !v20 )
      {
LABEL_20:
        ...
        *(_QWORD *)(v20 + 16) = v20 + 16;
        v22 = (__int64 **)qword_1C00093E0;
        *(_QWORD *)v20 = &qword_1C00093D8;
        *(_QWORD *)(v20 + 8) = v22;
        if ( *v22 != &qword_1C00093D8 )
          __fastfail(3u);
        *v22 = (__int64 *)v20;
        qword_1C00093E0 = v20;
      ...
      *(_QWORD *)(v20 + 24) = v25;
      ...
      if ( *(_DWORD *)(v20 + 32) != *(_DWORD *)(v20 + 44) )
        goto LABEL_29;
      v27 = i;
      v28 = *(_DWORD *)(*(_QWORD *)(a1 + 480) + 24 * (i + 1LL));
      if ( v28 < *v5 )
        break;
LABEL_30:
      v29 = *(_DWORD **)(a1 + 480);
    ...
    KeOrAffinityEx(*(_QWORD *)(32LL * v28 + *(_QWORD *)(a1 + 664) + 16) + 48LL, v35, v35);
LABEL_29:
    v27 = i;
    goto LABEL_30;
  }
