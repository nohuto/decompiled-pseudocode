/*
 * XREFs of InitAcpiCpc @ 0x1C001552C
 * Callers:
...
__int64 __fastcall InitAcpiCpc(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    *(_QWORD *)(a1 + 192),
    0LL);
  v2 = AcpiEval_CPC(a1, (_QWORD *)(a1 + 528));
  if ( v2 >= 0 )
  {
    v3 = *(_QWORD *)(a1 + 528);
      ...
      if ( dword_1C000974C != 1 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v7 >= v5 )
          {
            ...
            if ( !v6
              || (v2 = (*(__int64 (__fastcall **)(_QWORD))(qword_1C0009838 + 88))(*(_QWORD *)(qword_1C0009838 + 56)),
                  v2 >= 0) )
            {
              ...
              if ( !v6 )
                goto LABEL_24;
              v2 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(qword_1C0009838 + 104))(
              ...
              {
LABEL_24:
                *(_QWORD *)(a1 + 336) = ReadGenAddr(v3 + 8);
                *(_QWORD *)(a1 + 344) = ReadGenAddr(v3 + 20);
                *(_QWORD *)(a1 + 352) = ReadGenAddr(v3 + 32);
                *(_QWORD *)(a1 + 360) = ReadGenAddr(v3 + 44);
              }
            }
            break;
          }
