/*
 * XREFs of ProcLibTracePccSummary @ 0x1C0013700
 * Callers:
...
BOOLEAN ProcLibTracePccSummary()
{
  ...
  if ( result )
  {
    if ( qword_1C0009800 )
    {
      v3 = (unsigned int)(100 * *(_DWORD *)(qword_1C0009800 + 36)) / *(_DWORD *)(qword_1C0009800 + 28);
      v1 = (unsigned int)(100 * *(_DWORD *)(qword_1C0009800 + 32)) / *(_DWORD *)(qword_1C0009800 + 28);
      *(_QWORD *)&UserData.Size = 1LL;
      v2 = v1;
      UserData.Ptr = qword_1C0009800 + 6;
      v5 = qword_1C0009800 + 7;
      v7 = &v3;
      v9 = &v2;
      v6 = 1LL;
      v8 = 1LL;
