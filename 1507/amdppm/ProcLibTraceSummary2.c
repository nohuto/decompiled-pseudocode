/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C0012B54
 * Callers:
    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      else
      {
        if ( (v5 & 0x8000000) == 0 )
        {
          ...
          {
            v21 = 2;
            v10 = *(_DWORD *)(qword_1C0009800 + 28);
            v18 = v10;
            v20 = 100 * *(_DWORD *)(qword_1C0009800 + 36) / v10;
            v19 = 100 * *(_DWORD *)(qword_1C0009800 + 32) / v10;
          }
          else
          {
            if ( (v5 & 0x73300000) == 0 )
        ...
        if ( !v13 )
        {
          ...
          GetRegistryDwordValue(
            ...
            &v18);
          v14 = *(_QWORD *)(a1 + 344);
          v23 = 100LL * *(_QWORD *)(a1 + 336) / v14;
          v15 = 100LL * *(_QWORD *)(a1 + 352) / v14;
          v16 = 100LL * *(_QWORD *)(a1 + 360) / v14;
          if ( !(_DWORD)v16 )
            LODWORD(v16) = 1;
          v19 = v16;
          if ( !(_DWORD)v15 )
...
LABEL_35:
      GetRegistryDwordValue(L"\\Registry\\Machine\\Hardware\\Description\\System\\CentralProcessor\\0", L"~MHz", &v18);
      goto LABEL_36;
    }
  }
  return ProcessorNumber;
