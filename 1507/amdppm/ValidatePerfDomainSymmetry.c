/*
 * XREFs of ValidatePerfDomainSymmetry @ 0x1C001CA54
 * Callers:
 ...
 *     ValidatePctPtcSymmetry @ 0x1C001CED0 (ValidatePctPtcSymmetry.c)
 */
...
LABEL_57:
      ...
      if ( (v9 & 0x70000000) == 0 )
        goto LABEL_29;
      if ( (int)ValidatePctPtcSymmetry(v8, v1 + 46, v5, v1 + 46) < 0 )
      {
        v3 |= 0x70000000uLL;
        v42 = v3;
      }
...
LABEL_29:
      if ( (v9 & 0x3300000) != 0 )
      {
        if ( (int)ValidatePctPtcSymmetry(v8, v1 + 53, v5, v1 + 53) < 0 )
        {
          v3 |= 0x3300000uLL;
          v42 = v3;
        }
