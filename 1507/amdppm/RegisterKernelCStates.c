/*
 * XREFs of RegisterKernelCStates @ 0x1C0015998
 * Callers:
    ...
    *(_DWORD *)(a3 + 56) = 0;
    ...
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v11 == v8 )
      {
        ...
        *v21 = v3 + 4 * (i + 4LL * i + 1);
        v24 = (__int64 *)(v3 + 4 * (i + 4LL * i + 1));
        if ( (int)DecodeAcpi2CState(v7, v24, 0LL, v22, (__int64)v21) < 0 )
        {
          _InterlockedOr((volatile signed __int32 *)(v7 + 1048), 8u);
        }
        else
        {
          v15 = v23;
