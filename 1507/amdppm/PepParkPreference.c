/*
 * XREFs of PepParkPreference @ 0x1C0004F90
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  result = (unsigned int)dword_1C0009860;
        ...
        if ( !(_DWORD)result )
        {
          ...
          if ( v13 )
          {
            if ( v12 )
            {
              ...
              v20[1] = v13;
              v21 = PepParkLists;
              result = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C00095F8)(*(_QWORD *)(v12 + 1056), v20);
              if ( (int)result >= 0 )
              {
                v16 = 0;
                KeInitializeEnumerationContext(v19, a4);
