/*
 * XREFs of ValidateCoordinatedDependencyOptions @ 0x1C001CFF8
 * Callers:
 ...
 *     ValidateCoordinatedDependencyOptionsPlatform @ 0x1C001D1B0 (ValidateCoordinatedDependencyOptionsPlatform.c)
 */
