/*
 * XREFs of ValidateAcpiCStates @ 0x1C001C7F0
 * Callers:
...
LABEL_8:
  ...
  if ( v2 )
  {
    for ( i = a1 + 4;
       ...
       && *i != 1
       && (*i == 2
        || IsValidAcpiGenericAddress((char *)&dword_1C0009904) && IsValidAcpiGenericAddress((char *)&dword_1C00098D4))
       && IsValidAcpiGenericAddress((char *)&dword_1C00098EC);
          i += 20 )
    {
      if ( ++v5 >= v2 )
        return v1;
