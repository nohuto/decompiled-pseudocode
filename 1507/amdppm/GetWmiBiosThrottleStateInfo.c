/*
 * XREFs of GetWmiBiosThrottleStateInfo @ 0x1C0001FA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  *(_BYTE *)a3 = byte_1C0009916;
  *(_BYTE *)(a3 + 1) = byte_1C0009917;
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v10 + 56);
  *(_DWORD *)(a3 + 8) = *(_DWORD *)(v10 + 456);
  v12 = *(_QWORD *)(v10 + 248);
  if ( (v12 & 0x3000000) != 0 )
    v13 = 3;
  else
  ...
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v11 + 56);
  do
  {
    v16 = *(unsigned __int8 *)(v11 + v15++ + 424);
    *v14++ = v16;
  }
  while ( v15 < 4 );
  v17 = (_DWORD *)(a3 + 56);
  *(_QWORD *)(a3 + 48) = *(_QWORD *)(v11 + 428);
  for ( i = 0LL; i < 4; ++i )
  {
    v19 = *(unsigned __int8 *)(v11 + i + 436);
    *v17++ = v19;
  }
  *(_QWORD *)(a3 + 72) = *(_QWORD *)(v11 + 440);
  v20 = *(unsigned int **)(v11 + 448);
  if ( !v20 )
  {
