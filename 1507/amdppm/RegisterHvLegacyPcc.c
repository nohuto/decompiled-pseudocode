/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C001A980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterHvLegacyPcc(_QWORD *a1)
{
  ...
  v9 = 0LL;
  v10 = -1073741823;
  v18[0] = qword_1C00097A0;
  if ( (unsigned __int8)qword_1C00097A0 <= 1u )
  {
    v3 = qword_1C0009798;
    v5 = qword_1C0009790;
    if ( (_BYTE)qword_1C00097A0 == 1 )
    {
      v11 = v18[0];
      v6 = v18[0] >> 8;
      if ( BYTE1(v18[0]) )
  ...
  {
    v12 = dword_1C0009750;
    v21[2] = qword_1C0009780;
    LODWORD(v21[3]) = dword_1C0009788;
    v21[6] = v5 << v4;
    v21[5] = v3 << v4;
    LODWORD(v21[0]) = 0;
    HIDWORD(v21[0]) = dword_1C0009750;
    ...
    v14 = (__int64 (__fastcall *)(_QWORD *))qword_1C00095D0;
    if ( !Device )
    {
      do
      {
        v21[8] = **(_QWORD **)(v18[0] + 520LL);
