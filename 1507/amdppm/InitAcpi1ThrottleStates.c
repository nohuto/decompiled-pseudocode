/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C001B8FC
 * Callers:
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = 0;
  if ( ((unsigned int)dword_1C0009394 <= 1 || (*(_DWORD *)(a1 + 248) & 0x200000) != 0)
    && (*(_DWORD *)(a1 + 248) & 0x100000) != 0
    && (v6 = a1 + 168, (unsigned __int8)IsValidAcpiGenericAddress(a1 + 168, a2, a3, a4))
    && (unsigned __int8)(byte_1C0009916 - 1) <= 3u
    && (unsigned __int8)byte_1C0009916 + (unsigned __int8)byte_1C0009917 <= 32 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1040), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1044), 4u);
    v7 = 1 << byte_1C0009916;
    v8 = (unsigned int)(20 * ((1 << byte_1C0009916) - 1) + 24);
      ...
      **(_DWORD **)(a1 + 448) = v7;
      if ( v7 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v12 + v11 - 4) = (v13 << byte_1C0009917) | 0x10;
        }
        while ( v10 < v7 );
      }
