/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C00173FC
 * Callers:
 *     RegisterKernelPerfFeedback @ 0x1C0017750 (RegisterKernelPerfFeedback.c)
 *     RegisterHvPerfFeedbackCounters @ 0x1C001B0E0 (RegisterHvPerfFeedbackCounters.c)
 * Callees:
