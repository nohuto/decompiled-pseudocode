/*
 * XREFs of RegisterKernelLegacyPcc @ 0x1C0003600
 * Callers:
 *     RegisterHvLegacyPccCounters @ 0x1C001B0F0 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C0009858 )
  {
          ...
          (v2 = v11) != 0LL) )
    {
      ...
      *((_DWORD *)v2 + 7) = v15;
      ...
      v2[33] = *(_QWORD *)(a1 + 304);
      if ( dword_1C00097FC )
        *((_DWORD *)v2 + 9) = 0x989680 / ((unsigned int)dword_1C00097FC >> 1);
      *((_QWORD *)v12 + 1) = 100LL;
      ...
      *((_DWORD *)v2 + 8) = 1;
      ...
      v4 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0009578)(v2);
      if ( v4 >= 0 )
      {
        ...
        if ( !(unsigned int)EnumerateNextDevice(&v27, &Size) )
        {
          ...
          {
            *(_QWORD *)(Size + 216) = v8;
            v25 = (__int64 **)qword_1C00093F0;
            *v8 = v24;
            v8[1] = (__int64 *)v25;
            if ( *v25 != v24 )
              __fastfail(3u);
            *v25 = (__int64 *)v8;
            qword_1C00093F0 = (__int64)v8;
            v8 += 7;
          }
          while ( !(unsigned int)EnumerateNextDevice(&v27, &Size) );
        }
