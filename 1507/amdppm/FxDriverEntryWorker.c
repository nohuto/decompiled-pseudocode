/*
 * XREFs of FxDriverEntryWorker @ 0x1C0001248
 * Callers:
 *     FxDriverEntry @ 0x1C0001230 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  qword_1C0009158 = (__int64)DriverObject;
  DestinationString.Buffer = (unsigned __int16 *)&unk_1C0009170;
  *(_DWORD *)&DestinationString.Length = 34078720;
  RtlCopyUnicodeString(&DestinationString, RegistryPath);
  result = WdfVersionBind(DriverObject, &DestinationString, &unk_1C0009038, &WdfDriverGlobals);
  if ( result >= 0 )
  {
    v5 = 0;
    ...
    for ( i = &__KMDF_CLASS_BIND_END; i < &__KMDF_CLASS_BIND_END; i += 10 )
    {
      ...
      off_1C0009108 = i;
      v5 = v8
         ? v8(WdfVersionBindClass, &unk_1C0009038, WdfDriverGlobals, i)
         : WdfVersionBindClass(&unk_1C0009038, WdfDriverGlobals, i);
      if ( v5 < 0 )
        break;
    }
    v6 = v5;
...
LABEL_5:
    ...
    else
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        {
          DriverUnload = qword_1C0009140;
          if ( DriverObject->DriverUnload )
            DriverUnload = (__int64 (*)(void))DriverObject->DriverUnload;
          qword_1C0009140 = DriverUnload;
