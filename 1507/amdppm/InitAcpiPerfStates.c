/*
 * XREFs of InitAcpiPerfStates @ 0x1C001B4C0
 * Callers:
 ...
 *     ValidatePssCore @ 0x1C001C8C0 (ValidatePssCore.c)
 */
...
__int64 __fastcall InitAcpiPerfStates(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    *(_QWORD *)(a1 + 192),
    0LL);
  v2 = (_BYTE *)(a1 + 368);
  v3 = AcpiEval_PCT_PTC(a1, 1413697631, (_BYTE *)(a1 + 368));
  v4 = 0;
  if ( v3 < 0 )
    v4 = v3;
  v5 = v3;
  ...
  {
    v5 = AcpiEval_XPSS(a1, (_QWORD *)(a1 + 400));
    if ( v5 < 0 )
      *(_QWORD *)(a1 + 248) &= ~0x40000000uLL;
  }
  if ( (*(_DWORD *)(a1 + 248) & 0x30000000) != 0 )
  {
    v5 = AcpiEval_PSS(a1, (_QWORD *)(a1 + 392));
    if ( v5 < 0 )
    {
...
LABEL_18:
      ...
      if ( v5 < 0 )
        goto LABEL_18;
      if ( *v2 == 127 && *(_BYTE *)(a1 + 369) == 64 && !*(_BYTE *)(a1 + 370) && *(_BYTE *)(a1 + 371) == 64 )
      {
        if ( !*(_QWORD *)(a1 + 372) )
        {
          v5 = -1073741811;
...
LABEL_34:
          v11 = v7;
          _InterlockedOr((volatile signed __int32 *)(a1 + 1048), v7);
          *(_QWORD *)(a1 + 248) &= ~0x40000000uLL;
LABEL_36:
          if ( (*(_DWORD *)(a1 + 248) & 0x30000000) == 0 )
          {
...
LABEL_40:
          ...
          if ( v5 < 0 )
            goto LABEL_40;
          v5 = -1073741637;
          if ( !*(_QWORD *)(a1 + 384) || *v2 == *(_BYTE *)(a1 + 380) )
          {
            if ( *v2 == 1 )
            {
              v5 = 0;
...
LABEL_48:
            if ( v5 < 0 )
            {
              _InterlockedOr((volatile signed __int32 *)(a1 + 1048), v11);
              *(_QWORD *)(a1 + 248) &= 0xFFFFFFFFCFFFFFFFuLL;
            }
            goto LABEL_50;
          }
LABEL_45:
          if ( !qword_1C00094E0 || (v5 = qword_1C00094E0(a1 + 368, v8, &v11), v5 >= 0) )
            v5 = 0;
          goto LABEL_48;
        }
        if ( !*(_QWORD *)(a1 + 384) )
...
LABEL_32:
        ...
        if ( *(_BYTE *)(a1 + 380) == 127 && *(_BYTE *)(a1 + 381) == 64 && !*(_BYTE *)(a1 + 382) )
        {
          v5 = -1073741811;
          if ( *(_BYTE *)(a1 + 383) != 64 )
            goto LABEL_32;
