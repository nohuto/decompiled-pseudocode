/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C00162BC
 * Callers:
 ...
 *     ValidatePlatformIdleState @ 0x1C001CF58 (ValidatePlatformIdleState.c)
 */
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C0009868;
  v2 = dword_1C0009394;
  if ( dword_1C0009868 )
  {
    v4 = (48 * dword_1C0009868 + 59) & 0xFFFFFFFC;
    PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C0009394 * dword_1C0009868, 0x72637250u);
    v6 = PoolWithTag;
    if ( PoolWithTag )
    {
      ...
      if ( v8 )
      {
        ...
        if ( (_DWORD)v1 )
        {
          ...
          while ( 1 )
          {
            ...
            *v8 = v9;
            v8[8] = v2;
            ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C0009610)(
                                         *(_QWORD *)(a1 + 1056),
                                         v8,
                                         0LL);
...
LABEL_16:
          *(_DWORD *)v6 = 42;
          *((_DWORD *)v6 + 1) = dword_1C0009868;
          *((_DWORD *)v6 + 2) = dword_1C0009868;
          ...
          *((_QWORD *)v6 + 4) = PepIdleComplete;
          ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C00095A0)(v6);
          if ( ProcessorNumberFromIndex >= 0 )
          {
            Src = v6;
            v6 = 0LL;
