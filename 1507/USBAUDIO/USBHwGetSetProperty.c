/*
 * XREFs of USBHwGetSetProperty @ 0x1C001C5B8
 * Callers:
 *     USBHwGetSetByte @ 0x1C001C700 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C001C7C0 (USBHwGetSetShort.c)
 ...
 *     USBCntrlMuxSource @ 0x1C0020ED0 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C0020F80 (USBCntrlGetSetMixerLevels.c)
