/*
 * XREFs of WPP_RECORDER_SF_did @ 0x1C000261C
 * Callers:
...
__int64 WPP_RECORDER_SF_did(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_865e070e72e7fd42199127aff7914646_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 5LL, 3LL, &WPP_865e070e72e7fd42199127aff7914646_Traceguids, v8, (__int64 *)va);
}
