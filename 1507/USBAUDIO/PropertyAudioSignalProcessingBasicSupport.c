/*
 * XREFs of PropertyAudioSignalProcessingBasicSupport @ 0x1C0018EF0
 * Callers:
 *     <none>
 * Callees:
 *     PropertyAudioSignalProcessingPinValidation @ 0x1C0018E58 (PropertyAudioSignalProcessingPinValidation.c)
 */
