/*
 * XREFs of USBDeviceStop @ 0x1C001C2E0
 * Callers:
 *     USBDeviceSurpriseRemove @ 0x1C001C3A0 (USBDeviceSurpriseRemove.c)
 * Callees:
 ...
 *     USBHwStopAllMIDIPipes @ 0x1C001D1D8 (USBHwStopAllMIDIPipes.c)
 */
