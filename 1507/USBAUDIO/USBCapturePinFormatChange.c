/*
 * XREFs of USBCapturePinFormatChange @ 0x1C0022020
 * Callers:
 *     USBCaptureCreatePin @ 0x1C0022100 (USBCaptureCreatePin.c)
 * Callees:
 *     <none>
 */
  ...
  *(_DWORD *)(v4 + 8) = *((unsigned __int16 *)v1 + 33) * (*((unsigned __int16 *)v1 + 39) >> 3);
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v6[23] = *(_DWORD *)(v4 + 8) * (*((_DWORD *)v3 + 22) / 0x64u);
      v6[24] = *(_DWORD *)(v4 + 8) * (*((_DWORD *)v3 + 22) / 0x64u);
      v6[25] = *(_DWORD *)(v4 + 8);
    }
  }
