/*
 * XREFs of memset @ 0x1C0008240
 * Callers:
 *     McGenControlCallbackV2 @ 0x1C00015E0 (McGenControlCallbackV2.c)
 ...
 *     USBType1AsyncEndpointPoll @ 0x1C00036C0 (USBType1AsyncEndpointPoll.c)
 ...
 *     USBDeviceCreate @ 0x1C001BAB0 (USBDeviceCreate.c)
 ...
 *     USBMidiInInitializeUrbAndIrp @ 0x1C002266C (USBMidiInInitializeUrbAndIrp.c)
...
mset20:
  ...
  *(_QWORD *)&Val = 0x101010101010101LL * (unsigned __int8)Val;
  ...
  v8 = Size >> 6;
  if ( ((Size >> 3) & 7) != 0 )
    return (void *)((__int64 (__fastcall *)(_QWORD *, _QWORD))((char *)&loc_1C00082FD + 4 * (8 - ((Size >> 3) & 7)) + 2))(
                     &v7[((Size >> 3) & 7) - 8],
                     *(_QWORD *)&Val);
  do
  {
