/*
 * XREFs of USBType1PinFormatChange @ 0x1C00217E0
 * Callers:
...
__int64 __fastcall USBType1PinFormatChange(PVOID *PointerToPointerToItem)
{
  ...
  *(_DWORD *)(v4 + 100) = *((_DWORD *)v3 + 22) / 0x3E8u;
  v5 = *(_BYTE *)(v4 + 80) == 0;
  *(_DWORD *)(v4 + 104) = (*((_DWORD *)v3 + 22) % 0x3E8u) << 14;
  if ( !v5 )
    *(_DWORD *)(v4 + 840) = v1[17];
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v8[23] = *(_DWORD *)(v4 + 8) * (*((_DWORD *)v3 + 22) / 0x64u);
      v8[24] = *(_DWORD *)(v4 + 8) * (*((_DWORD *)v3 + 22) / 0x64u);
      v8[25] = *(_DWORD *)(v4 + 8);
      if ( *((int *)PointerToPointerToItem + 30) >= 2 )
        return (unsigned int)(*(__int64 (__fastcall **)(PVOID *, _QWORD, _QWORD))(*(_QWORD *)(v3[16] + 128LL) + 64LL))(
