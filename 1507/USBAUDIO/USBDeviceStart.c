/*
 * XREFs of USBDeviceStart @ 0x1C001BB70
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00072E0 (_guard_dispatch_icall_nop.c)
 *     RegistryReadPnPKeyValue @ 0x1C001B12C (RegistryReadPnPKeyValue.c)
 *     USBHwGetDescriptor @ 0x1C001C8E8 (USBHwGetDescriptor.c)
 *     USBHwGetAudioConfigurationDescriptor @ 0x1C001C968 (USBHwGetAudioConfigurationDescriptor.c)
 ...
 *     USBHwLogStartFailure @ 0x1C001D648 (USBHwLogStartFailure.c)
