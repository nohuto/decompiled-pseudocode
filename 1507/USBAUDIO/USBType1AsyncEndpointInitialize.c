/*
 * XREFs of USBType1AsyncEndpointInitialize @ 0x1C00213F0
 * Callers:
 *     USBType1RenderCreatePin @ 0x1C0021B40 (USBType1RenderCreatePin.c)
 * Callees:
...
__int64 __fastcall USBType1AsyncEndpointInitialize(__int64 a1)
{
  ...
  v3 = *(void **)(a1 + 8);
  v4 = v1[17];
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, 0xA4uLL, 0x41627845u);
  v5 = PoolWithTag;
  if ( PoolWithTag )
