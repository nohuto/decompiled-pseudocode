/*
 * XREFs of _std::_Uninit_move_Microsoft::WRL::ComPtr_IStreamGroupProxy______ptr64_Microsoft::WRL::ComPtr_IStreamGroupProxy______ptr64_std::allocator_Microsoft::WRL::ComPtr_IStreamGroupProxy____Microsoft::WRL::ComPtr_IStreamGroupProxy____::_1_::catch$0 @ 0x1800906C8
 * Callers:
 *     <none>
 * Callees:
