/*
 * XREFs of ??1?$CAutoPtrList@UDeviceStateChangedContext@CMonitorManager@@@ATL@@QEAA@XZ @ 0x180093FD0
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$5 @ 0x1800482DF (_CMonitorManager--CMonitorManager_--_1_--dtor$5.c)
 * Callees:
 *     <none>
 */
