/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@M@Z @ 0x18001EA40
 * Callers:
 ...
 * Callees:
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x180037CE8 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
