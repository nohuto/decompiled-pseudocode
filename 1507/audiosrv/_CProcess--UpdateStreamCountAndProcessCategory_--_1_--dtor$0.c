/*
 * XREFs of _CProcess::UpdateStreamCountAndProcessCategory_::_1_::dtor$0 @ 0x18004633C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CProcess::UpdateStreamCountAndProcessCategory_::_1_::dtor_0(__int64 a1, __int64 a2)
{
