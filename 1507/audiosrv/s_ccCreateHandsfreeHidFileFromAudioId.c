/*
 * XREFs of s_ccCreateHandsfreeHidFileFromAudioId @ 0x18006C180
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindSupportedHidCollection@@YAJPEAV?$CAtlList@PEAGV?$CElementTraits@PEAG@ATL@@@ATL@@PEAPEAXPEAU_HIDP_CAPS@@PEAPEAU_HIDP_PREPARSED_DATA@@@Z @ 0x18006BE30 (-FindSupportedHidCollection@@YAJPEAV-$CAtlList@PEAGV-$CElementTraits@PEAG@ATL@@@ATL@@PEAPEAXPEAU.c)
        ...
        _DWORD *a3)
{
  ...
  *a3 = 0;
  ...
  if ( ContainerId >= 0 )
  {
    ...
    if ( ContainerId >= 0 )
    {
      ContainerId = FindSupportedHidCollection(&v18, &hSourceHandle, v22, &PreparsedData);
      if ( ContainerId >= 0 )
      {
