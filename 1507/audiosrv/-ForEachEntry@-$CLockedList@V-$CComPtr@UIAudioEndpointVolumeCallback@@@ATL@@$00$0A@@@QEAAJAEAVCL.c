/*
 * XREFs of ?ForEachEntry@?$CLockedList@V?$CComPtr@UIAudioEndpointVolumeCallback@@@ATL@@$00$0A@@@QEAAJAEAVCListWorker@1@@Z @ 0x180071C74
 * Callers:
        ...
        void (__fastcall ***a2)(_QWORD, __int64 *))
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    try
    {
      v6 = (__int64 *)ATL::CAtlArray<CAudioSessionNotificationProcess,ATL::CElementTraits<CAudioSessionNotificationProcess>>::operator[](
                        &v3[1].DebugInfo,
                        i);
  ...
  while ( v4 < v12 )
  {
    try
    {
      v7 = (__int64 *)ATL::CAtlArray<CAudioSessionNotificationProcess,ATL::CElementTraits<CAudioSessionNotificationProcess>>::operator[](
                        &v11,
                        v4);
      ATL::CComPtrBase<CMonitorManager::CaptureMonitor>::CComPtrBase<CMonitorManager::CaptureMonitor>(&v20, *v7);
      (**v2)(v2, &v20);
    }
