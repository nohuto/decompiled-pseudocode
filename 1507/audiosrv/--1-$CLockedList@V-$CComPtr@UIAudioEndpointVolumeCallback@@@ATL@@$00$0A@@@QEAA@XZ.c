/*
 * XREFs of ??1?$CLockedList@V?$CComPtr@UIAudioEndpointVolumeCallback@@@ATL@@$00$0A@@@QEAA@XZ @ 0x1800714A4
 * Callers:
 *     _CVolumeStrip::_CVolumeStrip_::_1_::dtor$1 @ 0x1800718CB (_CVolumeStrip--_CVolumeStrip_--_1_--dtor$1.c)
 * Callees:
        ...
        LPCRITICAL_SECTION lpCriticalSection)
{
  ...
  ATL::CAtlArray<CAudioStream *,ATL::CElementTraits<CAudioStream *>>::~CAtlArray<CAudioStream *,ATL::CElementTraits<CAudioStream *>>((void **)&lpCriticalSection[1].SpinCount);
  ATL::CAtlArray<ATL::CComPtr<IAudioEndpointVolumeCallback>,ATL::CElementTraits<ATL::CComPtr<IAudioEndpointVolumeCallback>>>::~CAtlArray<ATL::CComPtr<IAudioEndpointVolumeCallback>,ATL::CElementTraits<ATL::CComPtr<IAudioEndpointVolumeCallback>>>(&lpCriticalSection[1]);
