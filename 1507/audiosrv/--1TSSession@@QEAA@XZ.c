/*
 * XREFs of ??1TSSession@@QEAA@XZ @ 0x18009EAD4
 * Callers:
...
LABEL_8:
  ...
  while ( *((int *)this + 42) > 0 )
  {
    v10 = *(CStreamClassPolicyGainsWrapper **)ATL::CSimpleMap<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,CEndpointSaDeviceLists *,ATL::CSimpleMapEqualHelper<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,CEndpointSaDeviceLists *>>::GetValueAt(
                                                (__int64)this + 152,
                                                0);
