/*
 * XREFs of ?GetVpoContext@CBaseStreamGroupProxy@@UEAAJPEAPEAUIVpoContext@@@Z @ 0x180004C40
 * Callers:
...
__int64 __fastcall CBaseStreamGroupProxy::GetVpoContext(CBaseStreamGroupProxy *this, struct IVpoContext **a2)
{
  ...
  if ( v4 >= 0 )
  {
    v6 = *(__int64 (__fastcall **)(CSaDeviceProxy *__hidden, struct IAudioDeviceGraph **))(**((_QWORD **)this + 10)
                                                                                         + 56LL);
    if ( v6 == CSaDeviceProxy::GetDeviceGraph )
      DeviceGraph = CSaDeviceProxy::GetDeviceGraph(*((CSaDeviceProxy **)this + 10), &v12);
    else
      DeviceGraph = v6(*((CSaDeviceProxy **)this + 10), &v12);
    v5 = DeviceGraph;
    if ( DeviceGraph < 0
