/*
 * XREFs of ?LoadPropertyStore@CAudioSessionStore@@AEAAJXZ @ 0x180035788
 * Callers:
...
__int64 __fastcall CAudioSessionStore::LoadPropertyStore(CAudioSessionStore *this)
{
  ...
  if ( v3 < 0 )
  {
    ...
    v8 = 110;
LABEL_16:
    WPP_SF_D(*(_QWORD *)(v7 + 16), v8, (__int64)&WPP_6e00fd835f7d6636badfe8f1a08ae6f4_Traceguids, v3);
    return v4;
  }
...
LABEL_96:
        ...
        case 0x1E:
          ...
          break;
        case 0x1F:
          v30 = (unsigned __int16 *)&v13[v17[4]];
          v5 = StringCbLengthW(v30, 0x7FFFFFFFuLL, &cb);
          if ( v5 )
            goto LABEL_60;
          v31 = (char *)CoTaskMemAlloc(cb);
          if ( !v31 )
          {
LABEL_86:
            v5 = -2147024882;
          ...
          v32 = cb;
          v17[4] = v31;
          v5 = StringCbCopyW(v31, v32, (char *)v30);
          if ( v5 )
            goto LABEL_96;
          break;
        case 0x41:
        ...
        case 0x2004:
          ...
          if ( (struct _GUID *)v19 != &WPP_GLOBAL_Control
            ...
            && *(_BYTE *)(v19 + 25) >= 4u )
          {
            WPP_SF_q(*(_QWORD *)(v19 + 16), 112LL, &WPP_6e00fd835f7d6636badfe8f1a08ae6f4_Traceguids, cbData - 24LL);
            v19 = *(_QWORD *)&WPP_GLOBAL_Control.Data1;
          }
          if ( (v20 & 3) != 0 )
          {
            if ( (struct _GUID *)v19 != &WPP_GLOBAL_Control
              ...
              && *(_BYTE *)(v19 + 25) >= 4u )
            {
              WPP_SF_(*(_QWORD *)(v19 + 16), 0x71u, (__int64)&WPP_6e00fd835f7d6636badfe8f1a08ae6f4_Traceguids);
            }
          }
          else
          {
...
LABEL_67:
            ...
            if ( v21 )
            {
              ...
              if ( *(struct _GUID **)&WPP_GLOBAL_Control.Data1 != &WPP_GLOBAL_Control )
              {
                ...
                if ( (struct _GUID *)v27 != &WPP_GLOBAL_Control
                  && (*(_BYTE *)(v27 + 28) & 8) != 0
                  && *(_BYTE *)(v27 + 25) >= 4u )
                {
                  WPP_SF_D(*(_QWORD *)(v27 + 16), 0x75u, (__int64)&WPP_6e00fd835f7d6636badfe8f1a08ae6f4_Traceguids, v5);
                }
              }
              goto LABEL_67;
            }
