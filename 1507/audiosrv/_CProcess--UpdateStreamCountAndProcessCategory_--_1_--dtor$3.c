/*
 * XREFs of _CProcess::UpdateStreamCountAndProcessCategory_::_1_::dtor$3 @ 0x180046330
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CProcess::UpdateStreamCountAndProcessCategory_::_1_::dtor_3(__int64 a1, __int64 a2)
{
