/*
 * XREFs of ?Initialize@CApplication@@IEAAJPEBG@Z @ 0x180012B98
 * Callers:
...
__int64 __fastcall CApplication::Initialize(CApplication *this, const unsigned __int16 *a2)
{
  ...
  int v7; // ebx
  BOOL v8; // eax
  PTP_TIMER (__fastcall *v9)(CAudioThreadPool *, void (*)(struct _TP_CALLBACK_INSTANCE *, void *, struct _TP_TIMER *), void *); // rsi
  PTP_TIMER Timer; // rax
  ...
  *((_QWORD *)this + 2) = 0LL;
  ...
  if ( v7 >= 0 )
  {
    ...
    *((_DWORD *)this + 124) = v8;
    ...
    v9 = *(PTP_TIMER (__fastcall **)(CAudioThreadPool *, void (*)(struct _TP_CALLBACK_INSTANCE *, void *, struct _TP_TIMER *), void *))(*(_QWORD *)ThreadPool + 8LL);
