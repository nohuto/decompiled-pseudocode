/*
 * XREFs of ?QueueStreamStartedWorkItem@CPlaybackManager@@IEAAJPEAUIAudioStreamInfo@@@Z @ 0x18002BE74
 * Callers:
...
__int64 __fastcall CPlaybackManager::QueueStreamStartedWorkItem(CPlaybackManager *this, struct IAudioStreamInfo *a2)
{
  ...
  dwCompletionKey = 0LL;
  Instance = CStreamStartedWorkItem::CreateInstance(a2, (struct IPBMWorkItem **)&dwCompletionKey);
  v3 = dwCompletionKey;
  v4 = Instance;
  if ( Instance >= 0 )
  {
