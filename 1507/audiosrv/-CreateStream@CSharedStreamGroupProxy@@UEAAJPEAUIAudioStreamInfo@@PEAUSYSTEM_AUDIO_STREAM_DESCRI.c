/*
 * XREFs of ?CreateStream@CSharedStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x180029B60
 * Callers:
...
{
  bool (__fastcall *v9)(CAudioStream *); // rbx
  bool IsFormatSensitiveClient; // al
  signed int v11; // ebx
  bool (__fastcall *v12)(CAudioStream *); // rdi
  bool IsPeriodicitySensitiveClient; // al
  bool v14; // r8
  bool (__fastcall *v15)(CAudioStream *); // rdi
  bool v16; // al
  bool v17; // r8
  __int64 v19; // rdi
  __int64 v20; // rdi
  ...
  v9 = *(bool (__fastcall **)(CAudioStream *))(*(_QWORD *)a2 + 120LL);
  ...
  if ( *((_DWORD *)this + 33) )
    goto LABEL_4;
  v19 = *((_QWORD *)this + 10);
  if ( !v19 || !(*(unsigned __int8 (__fastcall **)(_QWORD))(*(_QWORD *)v19 + 136LL))(*((_QWORD *)this + 10)) )
    goto LABEL_4;
  v20 = *((_QWORD *)this + 10);
  v22 = 0LL;
  ...
  {
LABEL_4:
    v11 = (*(__int64 (__fastcall **)(_QWORD, struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *, struct IAudioGraphCallback *, struct SYSTEM_AUDIO_STREAM *))(**((_QWORD **)this + 9) + 32LL))(
            *((_QWORD *)this + 9),
            a3,
            a4,
            a5);
    if ( v11 >= 0 )
    {
      v12 = *(bool (__fastcall **)(CAudioStream *))(*(_QWORD *)a2 + 112LL);
      ...
      v15 = *(bool (__fastcall **)(CAudioStream *))(*(_QWORD *)a2 + 120LL);
