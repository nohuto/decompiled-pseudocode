/*
 * XREFs of AudioSessionManagerAddVolumeDuckNotification @ 0x1800323A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionManagerAddVolumeDuckNotification(__int64 a1, __int64 a2, const unsigned __int16 *a3)
{
  unsigned int v5; // ebx
  int v6; // eax
  __int64 (__fastcall *v7)(struct _RTL_CRITICAL_SECTION *, const unsigned __int16 *, int, __int64); // rbx
  ...
  else
  {
    if ( !g_DuckingManager )
      return v5;
    v7 = *(__int64 (__fastcall **)(struct _RTL_CRITICAL_SECTION *, const unsigned __int16 *, int, __int64))(*(_QWORD *)g_DuckingManager + 32LL);
