/*
 * XREFs of ?NewNode@?$CAtlList@PEAVCSaDeviceInstance@@V?$CElementTraits@PEAVCSaDeviceInstance@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVCSaDeviceInstance@@PEAV312@1@Z @ 0x180074F88
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<CSaDeviceInstance *,ATL::CElementTraits<CSaDeviceInstance *>>::NewNode(
        __int64 a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
