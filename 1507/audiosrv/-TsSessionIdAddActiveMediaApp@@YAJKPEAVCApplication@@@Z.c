/*
 * XREFs of ?TsSessionIdAddActiveMediaApp@@YAJKPEAVCApplication@@@Z @ 0x180003E38
 * Callers:
...
__int64 __fastcall TsSessionIdAddActiveMediaApp(unsigned int a1, struct CApplication *a2)
{
  unsigned int v3; // edi
  int v4; // eax
  ...
  else
  {
    ...
    if ( !ATL::CAtlList<CApplication *,ATL::CElementTraits<CApplication *>>::Find((char *)v11 + 104, &v10) )
    {
      v7 = ATL::CAtlList<CApplication *,ATL::CElementTraits<CApplication *>>::NewNode(v6, &v10, v6[1], 0LL);
      v8 = (__int64 *)v6[1];
      if ( v8 )
        *v8 = v7;
      else
