/*
 * XREFs of ?OnPropertyValueChanged@AudioEffectsWatcher@@UEAAJPEBGU_tagpropertykey@@@Z @ 0x180076480
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _tagpropertykey *a3)
{
  ...
  if ( CompareStringOrdinal(a2, -1, this[1], -1, 1) == 2 )
  {
    ...
    if ( v5 )
    {
      if ( CPolicyConfig::GetPropertyStoreProperty(this[1], 1, v6, &pvar) >= 0 && pvar.vt == 19 )
        lVal = pvar.lVal;
