/*
 * XREFs of ?RecalculateVolume@CProcess@@QEAAJW4AudioVolumeChangeType@@@Z @ 0x180011344
 * Callers:
 ...
 *     ?GetState@CAudioSession@@UEAA?AW4_AudioSessionState@@XZ @ 0x180010D50 (-GetState@CAudioSession@@UEAA-AW4_AudioSessionState@@XZ.c)
