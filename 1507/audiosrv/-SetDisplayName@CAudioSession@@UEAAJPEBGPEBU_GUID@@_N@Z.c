/*
 * XREFs of ?SetDisplayName@CAudioSession@@UEAAJPEBGPEBU_GUID@@_N@Z @ 0x18007B9E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::SetDisplayName(CAudioSession *this, char *a2, const struct _GUID *a3, char a4)
{
  ...
  if ( (unsigned int)ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::Compare(
    ...
    && (a4 || !*((_BYTE *)v7 + 224)) )
  {
    EnterCriticalSection((LPCRITICAL_SECTION)((char *)v7 + 272));
    try
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString(v9, a2, v10, v11, -2LL);
    }
    ...
    LeaveCriticalSection((LPCRITICAL_SECTION)((char *)v7 + 272));
    if ( v8 < 0 )
    {
    ...
    else
    {
      ...
      v15[2] = *((void (__fastcall ***)(_QWORD, volatile signed __int32 **))v7 + 30);
      v15[3] = (void (__fastcall **)(_QWORD, volatile signed __int32 **))v5;
      CLockedList<ATL::CComPtr<ISessionInternalEvents>,0,0>::ForEachEntry((LPCRITICAL_SECTION)((char *)v7 + 472), v15);
