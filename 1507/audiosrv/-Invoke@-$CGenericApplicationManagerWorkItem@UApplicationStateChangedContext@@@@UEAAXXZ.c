/*
 * XREFs of ?Invoke@?$CGenericApplicationManagerWorkItem@UApplicationStateChangedContext@@@@UEAAXXZ @ 0x180001F70
 * Callers:
...
{
  __int64 (__fastcall *v1)(CApplicationManager *__hidden, struct ApplicationStateChangedContext *); // rdi
  struct ApplicationStateChangedContext *v2; // rsi
  int result; // eax
  LPVOID *v5; // rbx
  HANDLE ProcessHeap; // rax

  v1 = *(__int64 (__fastcall **)(CApplicationManager *__hidden, struct ApplicationStateChangedContext *))(a1 + 8);
