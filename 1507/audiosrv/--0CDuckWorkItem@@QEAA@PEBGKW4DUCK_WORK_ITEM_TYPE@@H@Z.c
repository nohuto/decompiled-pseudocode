/*
 * XREFs of ??0CDuckWorkItem@@QEAA@PEBGKW4DUCK_WORK_ITEM_TYPE@@H@Z @ 0x1800A410C
 * Callers:
...
_QWORD *__fastcall CDuckWorkItem::CDuckWorkItem(_QWORD *a1, char *a2, int a3, int a4, int a5)
{
  int v5; // esi
  _QWORD *v8; // rdi
  __int64 v9; // r8
  ...
  *((_DWORD *)v8 + 4) = a5;
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::SetString((int **)v8, a2, v9, v10, -2LL);
  }
