/*
 * XREFs of ?GetSystemEffect@CEndpointCharacteristics@@QEAAJU_tagpropertykey@@U_GUID@@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAU3@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x1800A9364
 * Callers:
        ...
        struct _GUID *a3)
{
  ...
  {
    v13 = v3;
    return CEndpointCharacteristics::GetModeEffect(v9, &v13, 1, eHostProcessConnector, 0LL, 0LL, v10);
  }
