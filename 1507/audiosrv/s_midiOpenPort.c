/*
 * XREFs of s_midiOpenPort @ 0x18008E630
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FilterInstantiate2@@YAJPEBGKPEAPEAX@Z @ 0x1800A7030 (-FilterInstantiate2@@YAJPEBGKPEAPEAX@Z.c)
 */
...
__int64 __fastcall s_midiOpenPort(RPC_BINDING_HANDLE BindingHandle, unsigned __int16 *a2, HANDLE *a3)
{
  ...
  if ( v7 < 0
    ...
    && (*(_DWORD *)(*(_QWORD *)&WPP_GLOBAL_Control.Data1 + 28LL) & 0x8000) != 0
