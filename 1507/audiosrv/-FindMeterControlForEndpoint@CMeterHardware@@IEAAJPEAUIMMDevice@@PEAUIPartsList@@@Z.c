/*
 * XREFs of ?FindMeterControlForEndpoint@CMeterHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18003DDCC
 * Callers:
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( *(struct _GUID **)&WPP_GLOBAL_Control.Data1 != &WPP_GLOBAL_Control )
        {
          ...
          if ( (struct _GUID *)v8 != &WPP_GLOBAL_Control
            ...
            && *(_BYTE *)(v8 + 25) >= 4u )
          {
            WPP_SF_q(*(_QWORD *)(v8 + 16), 19LL, &WPP_c4b6e3fb0b78b7ef89729a36f54e7633_Traceguids, this);
          }
        }
        v9 = v17;
        if ( v17 != a2 )
