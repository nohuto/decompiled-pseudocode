/*
 * XREFs of ??1?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800714F8
 * Callers:
 *     _CVolumeStrip::CVolumeStrip_::_1_::dtor$0 @ 0x180047CC3 (_CVolumeStrip--CVolumeStrip_--_1_--dtor$0.c)
 *     _CVolumeStrip::_CVolumeStrip_::_1_::dtor$0 @ 0x1800718BB (_CVolumeStrip--_CVolumeStrip_--_1_--dtor$0.c)
 * Callees:
