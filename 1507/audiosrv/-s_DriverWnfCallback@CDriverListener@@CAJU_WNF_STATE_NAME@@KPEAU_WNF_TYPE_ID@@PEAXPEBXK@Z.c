/*
 * XREFs of ?s_DriverWnfCallback@CDriverListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x1800AB380
 * Callers:
 *     <none>
 * Callees:
 *     ?HandleDriverNotification@CDriverListener@@AEAAXPEBXK@Z @ 0x1800AAF50 (-HandleDriverNotification@CDriverListener@@AEAAXPEBXK@Z.c)
 */
