/*
 * XREFs of ?UnescapeIdentifierString@CAudioIdentifier@@SAXAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x1800845D8
 * Callers:
 ...
 *     ??A?$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z @ 0x1800831A0 (--A-$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z.c)
...
LABEL_10:
        ...
        if ( (_WORD)result == 98 )
        {
          ...
          *(_WORD *)(ATL::CSimpleStringT<unsigned short,0>::GetBuffer((unsigned __int64)a1, v10, v11, v12) + v5) = 124;
