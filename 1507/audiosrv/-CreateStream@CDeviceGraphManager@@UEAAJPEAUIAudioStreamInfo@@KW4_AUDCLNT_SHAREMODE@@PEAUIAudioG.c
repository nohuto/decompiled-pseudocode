/*
 * XREFs of ?CreateStream@CDeviceGraphManager@@UEAAJPEAUIAudioStreamInfo@@KW4_AUDCLNT_SHAREMODE@@PEAUIAudioGraphCallback@@KPEAUAUDIO_DEVICE_MODE_DESCRIPTOR@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUStreamGroupParams@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800293B0
 * Callers:
        ...
        struct SYSTEM_AUDIO_STREAM *a10)
{
  ...
  signed int StreamGroup; // edi
  CSharedStreamGroupProxy *v14; // rbx
  __int64 (__usercall *v15)@<rax>(CSharedStreamGroupProxy *__hidden@<rcx>, struct IAudioStreamInfo *@<rdx>, struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *@<r8>, struct IAudioGraphCallback *@<r9>, struct SYSTEM_AUDIO_STREAM *); // rsi
  int Stream; // eax
  CSharedStreamGroupProxy *v17; // rsi
    ...
    if ( StreamGroup >= 0 )
    {
      ...
      if ( StreamGroup < 0
        || ((v14 = v19,
          ...
          ? (Stream = ((__int64 (__fastcall *)(CSharedStreamGroupProxy *, struct IAudioStreamInfo *, struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *, struct IAudioGraphCallback *, struct SYSTEM_AUDIO_STREAM *))v15)(
                        v14,
                        a2,
                        a8,
                        a5,
