/*
 * XREFs of ?ProcessInteractivityNotification@CApplicationManager@@QEAAJPEBGW4__MIDL___MIDL_itf_playbackmanagerrpc_0000_0000_0001@@K@Z @ 0x180002150
 * Callers:
        ...
        unsigned int a4)
{
  ...
  CApplication *v35[2]; // [rsp+30h] [rbp-58h] BYREF
  LPCRITICAL_SECTION lpCriticalSection; // [rsp+40h] [rbp-48h] BYREF
  char v37; // [rsp+48h] [rbp-40h]
  LPCRITICAL_SECTION v38; // [rsp+50h] [rbp-38h] BYREF
  char v39; // [rsp+58h] [rbp-30h]
  _QWORD *v40; // [rsp+90h] [rbp+8h] BYREF

  v35[1] = (CApplication *)-2LL;
  v8 = (struct _RTL_CRITICAL_SECTION *)(a1 + 24);
  v38 = (LPCRITICAL_SECTION)(a1 + 24);
  v39 = 0;
    ...
    && *(_BYTE *)(*(_QWORD *)&WPP_GLOBAL_Control.Data1 + 25LL) >= 4u )
  {
    ...
    WPP_SF_Ss(*(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control.Data1 + 16LL), (__int64)v32);
  }
  Application = CApplicationManager::GetApplication((CApplicationManager *)a1, a2, a4, v35, 1, (int *)&v40);
  if ( Application >= 0 )
  {
    ...
    if ( a3 == 2
      && (v33 = v35[0], *((_DWORD *)v35[0] + 28))
      && !CApplication::GetTotalActiveRenderStreamCount(v35[0])
      ...
      if ( v17 )
      {
        ...
        else
        {
          if ( v15 < 0x7FFFFFFF )
          {
            if ( !a2 )
            {
              a2 = (const unsigned __int16 *)&word_1800B1B90;
              v15 = 0LL;
            }
            if ( v16 )
            {
...
LABEL_34:
      if ( Application < 0 )
      {
        if ( (struct _GUID *)v28 != &WPP_GLOBAL_Control
          && (*(_DWORD *)(v28 + 28) & 0x40000000) != 0
          && *(_BYTE *)(v28 + 25) >= 2u )
        {
          WPP_SF_D(
            *(_QWORD *)(v28 + 16),
      ...
      else
      {
        if ( v11 )
        {
          Application = CApplication::PostDelayedInteractivityNotification(v35[0], v9);
          if ( Application >= 0 )
            goto LABEL_40;
        }
        else
        {
          Application = CApplication::CleanupDelayedInteractivityNotification(v35[0]);
          if ( Application >= 0 )
          {
