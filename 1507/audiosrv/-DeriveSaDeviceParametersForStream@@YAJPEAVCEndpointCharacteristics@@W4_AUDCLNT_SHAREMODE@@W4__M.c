/*
 * XREFs of ?DeriveSaDeviceParametersForStream@@YAJPEAVCEndpointCharacteristics@@W4_AUDCLNT_SHAREMODE@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@3PEAUtWAVEFORMATEX@@4_JPEAPEAUSaDeviceParams@@@Z @ 0x18002AF40
 * Callers:
        ...
        struct SaDeviceParams **a9)
{
  ...
  v26 = 0LL;
  v24 = 0LL;
  if ( a2 == AUDCLNT_SHAREMODE_EXCLUSIVE || a3 == eOffloadConnector )
  {
    v13 = &a8;
  }
  else
  ...
  v28 = *a4;
  DeviceDefaults = CSaProvider::GetDeviceDefaults(a1, a3, &v28, 0LL, 0LL, v13, &v24);
  if ( DeviceDefaults < 0 )
    goto LABEL_15;
