/*
 * XREFs of ??0CActiveAudioSession@@QEAA@PEBGH@Z @ 0x18003053C
 * Callers:
  ...
  try
  {
    ...
    if ( (_DWORD)v10 )
    {
      ...
      if ( ((1 - *(_DWORD *)(*(_QWORD *)v5 - 8LL)) | (*(_DWORD *)(*(_QWORD *)v5 - 12LL) - (int)v10)) < 0 )
        ATL::CSimpleStringT<unsigned short,0>::PrepareWrite2((int **)v5, v10, v8, v9);
      v13 = *(int **)v5;
      v14 = 2LL * (int)v10;
      if ( v12 <= v11 )
        memmove_s(v13, v14, (char *)v13 + 2 * v12, v14);
      else
