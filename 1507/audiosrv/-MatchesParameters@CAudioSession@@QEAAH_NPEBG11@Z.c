/*
 * XREFs of ?MatchesParameters@CAudioSession@@QEAAH_NPEBG11@Z @ 0x180079D2C
 * Callers:
        ...
        const unsigned __int16 *lpsz)
{
  ...
  if ( !(*(unsigned int (__fastcall **)(_QWORD))(**((_QWORD **)this + 89) + 104LL))(*((_QWORD *)this + 89)) )
    return 0LL;
  if ( a3 )
  {
    v9 = (const WCHAR *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 89) + 64LL))(*((_QWORD *)this + 89));
    if ( !v9 || CompareStringOrdinal(a3, -1, v9, -1, 1) != 2 )
      return 0LL;
  }
  if ( a4 )
  {
    v10 = (const WCHAR *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 89) + 56LL))(*((_QWORD *)this + 89));
