/*
 * XREFs of ?GetWeakReference@?$RuntimeClass@U?$InterfaceList@VCBaseStreamGroupProxy@@U?$InterfaceList@UIInspectable@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$02@34@$00$00$0A@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x180029F70
 * Callers:
        ...
        __int64 *a2)
{
  ...
  Microsoft::WRL::Details::WeakReferenceImpl *v15; // [rsp+40h] [rbp+8h] BYREF
  ...
  *a2 = 0LL;
  ...
  {
    v17 = a1 - 144;
    v7 = Microsoft::WRL::Details::Make<Microsoft::WRL::Details::WeakReferenceImpl,IUnknown * &>(&v15, &v17);
    v8 = (__int64)*v7;
    *v7 = 0LL;
    v9 = v15;
    if ( v15 )
    ...
    for ( i = v5 == v13; ; i = v13 == v14 )
    {
      ...
      if ( v13 < 0 )
      {
        Microsoft::WRL::Details::WeakReferenceImpl::`vector deleting destructor'(
          ...
          1u);
        v8 = 2 * v14;
        Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<IUnknown,Microsoft::WRL::Details::Nil>,Microsoft::WRL::RuntimeClassFlags<2>,1,0,0>::AddRef(2 * v14);
        break;
      }
      *(_DWORD *)(v8 + 16) = v13;
