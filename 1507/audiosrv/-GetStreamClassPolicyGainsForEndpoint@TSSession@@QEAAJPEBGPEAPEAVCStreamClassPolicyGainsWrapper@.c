/*
 * XREFs of ?GetStreamClassPolicyGainsForEndpoint@TSSession@@QEAAJPEBGPEAPEAVCStreamClassPolicyGainsWrapper@@@Z @ 0x18002FAC0
 * Callers:
        ...
        struct CStreamClassPolicyGainsWrapper **a3)
{
  ...
  char *v30; // [rsp+20h] [rbp-58h] BYREF
  ...
  v11 = (int *)((char *)NilString + 24);
  v34 = (int *)((char *)NilString + 24);
  if ( !a2 )
  {
LABEL_40:
  ...
  if ( (a2 & 0xFFFFFFFFFFFF0000uLL) != 0 )
  {
    ...
    if ( (_DWORD)v12 )
    {
      v13 = *((unsigned int *)NilString + 2);
      v14 = (a2 - (__int64)v11) >> 1;
      if ( ((1 - *((_DWORD *)NilString + 4)) | (*((_DWORD *)NilString + 3) - (int)v12)) < 0 )
      {
        ATL::CSimpleStringT<unsigned short,0>::PrepareWrite2(&v34, v12, v9, v10);
        v11 = v34;
      }
      v15 = 2LL * (int)v12;
      if ( v14 <= v13 )
