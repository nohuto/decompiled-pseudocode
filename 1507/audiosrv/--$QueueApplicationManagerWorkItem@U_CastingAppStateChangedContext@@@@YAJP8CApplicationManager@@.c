/*
 * XREFs of ??$QueueApplicationManagerWorkItem@U_CastingAppStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAU_CastingAppStateChangedContext@@@Z0@Z @ 0x1800A0C80
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<_CastingAppStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  {
    v4[2] = a2;
    v4[1] = CApplicationManager::OnCastingAppStateChanged;
