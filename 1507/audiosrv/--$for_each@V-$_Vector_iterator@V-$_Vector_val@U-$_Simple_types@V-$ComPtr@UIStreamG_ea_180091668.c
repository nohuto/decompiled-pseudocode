...
__int64 *__fastcall std::for_each<std::_Vector_iterator<std::_Vector_val<std::_Simple_types<Microsoft::WRL::ComPtr<IStreamGroupProxy>>>>,_lambda_1493bc94177afcc1968c335a030ba490_>(
        __int64 *a1,
        __int64 a2,
        __int64 a3,
        __int64 *a4)
{
  ...
  for ( i = a2; i != a3; i += 8LL )
    lambda_1493bc94177afcc1968c335a030ba490_::operator()(a4, i);
  *a1 = *a4;
