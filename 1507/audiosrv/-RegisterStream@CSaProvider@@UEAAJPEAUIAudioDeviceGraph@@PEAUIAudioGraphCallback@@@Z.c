/*
 * XREFs of ?RegisterStream@CSaProvider@@UEAAJPEAUIAudioDeviceGraph@@PEAUIAudioGraphCallback@@@Z @ 0x180075040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSaProvider::RegisterStream(
        CSaProvider *this,
        ...
        struct IAudioGraphCallback *a3)
{
  ...
  v12 = 0LL;
  v6 = (**(__int64 (__fastcall ***)(struct IAudioGraphCallback *, GUID *, struct IAudioStreamInfo **))a3)(
         a3,
  ...
  if ( v6 >= 0 )
  {
    ...
    v6 = CSaDeviceInstance::AddStream(SaDeviceForAudioDeviceGraph, v12);
  }
  if ( v12 )
