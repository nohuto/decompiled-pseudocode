/*
 * XREFs of ??1?$CInterfaceList@VCaptureMonitor@CMonitorManager@@$1?IID_IUnknown@@3U_GUID@@B@ATL@@QEAA@XZ @ 0x18006847C
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$3 @ 0x1800482BC (_CMonitorManager--CMonitorManager_--_1_--dtor$3.c)
 *     _CMonitorManager::Initialize_::_1_::dtor$1 @ 0x180048304 (_CMonitorManager--Initialize_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
