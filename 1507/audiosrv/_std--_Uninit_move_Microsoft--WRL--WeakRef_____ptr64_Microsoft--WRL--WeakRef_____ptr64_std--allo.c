/*
 * XREFs of _std::_Uninit_move_Microsoft::WRL::WeakRef_____ptr64_Microsoft::WRL::WeakRef_____ptr64_std::allocator_Microsoft::WRL::WeakRef__Microsoft::WRL::WeakRef__::_1_::catch$0 @ 0x18004797D
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  for ( i = *(Microsoft::WRL::Details::WeakReferenceImpl ***)(a2 + 88);
