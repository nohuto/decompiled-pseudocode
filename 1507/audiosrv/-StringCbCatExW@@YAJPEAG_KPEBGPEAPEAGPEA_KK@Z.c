/*
 * XREFs of ?StringCbCatExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x18000609C
 * Callers:
 *     ?LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z @ 0x180006690 (-LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z.c)
 * Callees:
 *     StringCopyWorkerW @ 0x180006158 (StringCopyWorkerW.c)
 *     StringLengthWorkerW @ 0x1800061CC (StringLengthWorkerW.c)
 */
