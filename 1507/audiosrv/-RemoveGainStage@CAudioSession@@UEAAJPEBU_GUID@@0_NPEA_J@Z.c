/*
 * XREFs of ?RemoveGainStage@CAudioSession@@UEAAJPEBU_GUID@@0_NPEA_J@Z @ 0x18007B300
 * Callers:
 *     <none>
 * Callees:
        ...
        CGainStage *a5)
{
  ...
  {
    WPP_SF_S_guid_(*(_QWORD *)(*(_QWORD *)&WPP_GLOBAL_Control.Data1 + 16LL), 145, v11, this[17].DebugInfo, (__int64)a2);
  }
  v12 = this + 9;
