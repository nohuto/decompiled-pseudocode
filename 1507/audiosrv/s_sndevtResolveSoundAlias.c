/*
 * XREFs of s_sndevtResolveSoundAlias @ 0x18006C6B0
 * Callers:
 *     <none>
 * Callees:
    ...
    *lpTargetHandle = (HANDLE)-1LL;
    ...
    if ( !RpcImpersonateClient(a1) )
    {
      while ( 1 )
      {
        ...
        if ( !v9 )
          v11 = v22;
        SoundAlias = _GetSoundAlias(v11, FileName, v10, &v20, dwCreationDisposition, phkResult, v23);
        ...
        && (CurrentProcess = GetCurrentProcess(), DuplicateHandle(CurrentProcess, FileW, v8, lpTargetHandle, 0, 0, 2u)) )
      {
        if ( a6 )
        {
          if ( _wsplitpath_s(FileName, 0LL, 0LL, 0LL, 0LL, Filename, 0x100uLL, Ext, 0x100uLL) )
            goto LABEL_35;
          FileName[0] = 0;
          if ( _wmakepath_s(FileName, 0x104uLL, 0LL, 0LL, Filename, Ext) )
            goto LABEL_35;
          v14 = -1LL;
          do
            ++v14;
