/*
 * XREFs of ?RegisterStreamVolumeNotifications@CAudioStream@@UEAAJPEAUIAudioStreamVolumeCallback@@@Z @ 0x1800825B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioStreamVolumeCallback *a2)
{
  ...
  v13 = a2;
  v2 = a2;
  ATL::CCritSecLock::CCritSecLock((ATL::CCritSecLock *)&v11, (struct _RTL_CRITICAL_SECTION *)((char *)this + 192));
  v4 = 0;
  if ( v2 )
  {
    v5 = (__int64 **)((char *)this + 232);
