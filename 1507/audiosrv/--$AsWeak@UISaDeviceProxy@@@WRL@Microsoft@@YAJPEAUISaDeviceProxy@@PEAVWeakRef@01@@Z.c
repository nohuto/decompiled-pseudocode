/*
 * XREFs of ??$AsWeak@UISaDeviceProxy@@@WRL@Microsoft@@YAJPEAUISaDeviceProxy@@PEAVWeakRef@01@@Z @ 0x18002A868
 * Callers:
        ...
        Microsoft::WRL::Details::WeakReferenceImpl **a2)
{
  ...
  int v4; // edi
  __int64 (__fastcall *v5)(__int64, Microsoft::WRL::Details::WeakReferenceImpl **); // rdi
  ...
  {
    v14 = 0LL;
    v5 = *(__int64 (__fastcall **)(__int64, Microsoft::WRL::Details::WeakReferenceImpl **))(*(_QWORD *)v15 + 24LL);
    if ( (char *)v5 == (char *)Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<ISaDeviceProxy,Microsoft::WRL::Details::InterfaceList<IInspectable,Microsoft::WRL::Details::Nil>>,Microsoft::WRL::RuntimeClassFlags<3>,1,1,0>::GetWeakReference )
