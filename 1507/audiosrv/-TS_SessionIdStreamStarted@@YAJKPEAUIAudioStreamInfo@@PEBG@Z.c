/*
 * XREFs of ?TS_SessionIdStreamStarted@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x180030720
 * Callers:
...
LABEL_8:
    v8 = *((_QWORD *)v7 + 39);
    if ( v8 )
      v9 = (*(__int64 (__fastcall **)(_QWORD, struct IAudioStreamInfo *, const unsigned __int16 *))(*(_QWORD *)v8 + 24LL))(
             *((_QWORD *)v7 + 39),
             a2,
             a3);
    else
