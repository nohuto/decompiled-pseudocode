/*
 * XREFs of ?KsNotifications_AudioInterfaceArrival@@YAXPEBG@Z @ 0x18009E5A4
 * Callers:
...
void __fastcall KsNotifications_AudioInterfaceArrival(char *a1)
{
  ...
  if ( !v7 )
    goto LABEL_12;
  if ( (*(int (__fastcall **)(__int64, char *, struct IUnknown **))(*(_QWORD *)v7 + 40LL))(v7, a1, v5) >= 0 )
  {
    v2 = v6;
    if ( v6 != v5[0] )
    {
