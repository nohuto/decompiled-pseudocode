/*
 * XREFs of ?UnregisterStream@CAudioStream@@QEAAJXZ @ 0x180082C18
 * Callers:
...
__int64 __fastcall CAudioStream::UnregisterStream(CAudioStream *this)
{
  int SAProvider; // edi
  volatile int *v3; // rdx
  ...
  if ( *((_QWORD *)this + 6) )
  {
    ...
    if ( SAProvider >= 0 )
      SAProvider = (*(__int64 (__fastcall **)(__int64, _QWORD, CAudioStream *))(*(_QWORD *)v6 + 64LL))(
                     v6,
                     *((_QWORD *)this + 6),
                     this);
    if ( v6 )
