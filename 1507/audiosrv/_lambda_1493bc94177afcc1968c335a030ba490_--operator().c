/*
 * XREFs of _lambda_1493bc94177afcc1968c335a030ba490_::operator() @ 0x180091A74
 * Callers:
...
__int64 __fastcall lambda_1493bc94177afcc1968c335a030ba490_::operator()(_QWORD *a1, _QWORD *a2)
{
  char v4; // al
  __int64 result; // rax
