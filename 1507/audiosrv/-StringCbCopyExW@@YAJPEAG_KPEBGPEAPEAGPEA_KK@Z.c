/*
 * XREFs of ?StringCbCopyExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x18006C388
 * Callers:
 ...
 *     StringCopyWorkerW_1 @ 0x18006C56C (StringCopyWorkerW_1.c)
        ...
        DWORD a6)
{
  ...
  else
  {
    ...
    if ( (a6 & 0x100) != 0 )
    {
      v13 = (const wchar_t *)&word_1800B1B90;
      if ( pszSrc )
        v13 = pszSrc;
      pszSrc = v13;
    }
