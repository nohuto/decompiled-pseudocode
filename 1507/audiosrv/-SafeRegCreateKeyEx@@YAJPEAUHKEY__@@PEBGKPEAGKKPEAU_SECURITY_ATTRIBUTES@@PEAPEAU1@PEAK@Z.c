/*
 * XREFs of ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x1800362A4
 * Callers:
 ...
 *     atexit @ 0x1800436E4 (atexit.c)
 *     ?OnTaskInstanceCompleted@CBackgroundSessionCallbacks@@UEAAXU_GUID@@@Z @ 0x180043A70 (-OnTaskInstanceCompleted@CBackgroundSessionCallbacks@@UEAAXU_GUID@@@Z.c)
 *     ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x180087A28 (-Init@CNtDeleteKey@@QEAA_NXZ.c)
 */
...
LABEL_9:
  ...
  if ( !v16 )
  {
    if ( CNtDeleteKey::Init(v14) && !(qword_1800E8BA8 ? ((__int64 (__fastcall *)(HKEY))qword_1800E8BA8)(hKey) : 87) )
    {
      RegCloseKey(hKey);
      hKey = 0LL;
      dwDisposition = 0;
