/*
 * XREFs of ?FinalConstruct@CAudioSessionManagerProvider@@QEAAJXZ @ 0x180041FF0
 * Callers:
...
__int64 __fastcall CAudioSessionManagerProvider::FinalConstruct(CAudioSessionManagerProvider *this)
{
  ...
  int v3; // esi
  __int64 (__fastcall *v4)(CWindowsPolicyManager *, const struct _GUID *, void **); // rbx
  int v5; // eax
  __int64 (__fastcall *v6)(CWindowsPolicyManager *, struct IAudioSessionManagerProviderInfo *, struct IAudioDuckingManager **); // rbx
  ...
  if ( v3 < 0
    || ((v4 = **(__int64 (__fastcall ***)(CWindowsPolicyManager *, const struct _GUID *, void **))v1,
      ...
      : (v5 = CWindowsPolicyManager::QueryInterface(v1, &GUID_a68ab569_b923_4330_a258_1735412d392e, &v11)),
        (v3 = v5, v5 < 0)
     || ((v6 = *(__int64 (__fastcall **)(CWindowsPolicyManager *, struct IAudioSessionManagerProviderInfo *, struct IAudioDuckingManager **))(*(_QWORD *)v1 + 24LL),
          v6 != CWindowsPolicyManager::GetDuckingManager)
       ? (DuckingManager = v6(v1, this, &v12))
