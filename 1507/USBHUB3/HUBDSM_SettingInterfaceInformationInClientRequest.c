/*
 * XREFs of HUBDSM_SettingInterfaceInformationInClientRequest @ 0x1C0017380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_SettingInterfaceInformationInClientRequest(__int64 a1)
{
  ...
  if ( v5 != (_QWORD *)*v5 )
  {
    ...
    for ( i = 0LL; (unsigned int)i < *(_DWORD *)(v6 + 24); i = (unsigned int)(i + 1) )
    {
      ...
      v10 = (*(__int64 (__fastcall **)(_QWORD))(v2 + 432))(*(_QWORD *)(v9 + v6 + 40));
      if ( !v10 )
        WPP_RECORDER_SF_(
          *(_QWORD *)(v1[1] + 1432),
          2u,
      ...
      *(_QWORD *)(v4 + 24 * i + 64) = v10;
      (*(void (__fastcall **)(_QWORD))(v2 + 424))(*(_QWORD *)(v9 + v6 + 40));
    }
  }
  return 4077LL;
}
