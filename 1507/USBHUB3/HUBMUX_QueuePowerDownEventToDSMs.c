/*
 * XREFs of HUBMUX_QueuePowerDownEventToDSMs @ 0x1C000C9D4
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevices @ 0x1C0006F80 (HUBHSM_NotifyingHubStopToDevices.c)
 *     HUBHSM_WaitingForDevicesToReleaseReferenceOnD0ExitFinalFromReset @ 0x1C00076C0 (HUBHSM_WaitingForDevicesToReleaseReferenceOnD0ExitFinalFromReset.c)
 *     HUBHSM_WaitingForDevicesToReleaseReferenceOnSuspend @ 0x1C00076F0 (HUBHSM_WaitingForDevicesToReleaseReferenceOnSuspend.c)
 * Callees:
...
void __fastcall HUBMUX_QueuePowerDownEventToDSMs(__int64 a1, unsigned int a2)
{
  ...
  v4 = 0;
  v18 = &v18;
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 2240));
