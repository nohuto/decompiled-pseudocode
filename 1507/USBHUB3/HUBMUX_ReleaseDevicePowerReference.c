/*
 * XREFs of HUBMUX_ReleaseDevicePowerReference @ 0x1C000D250
 * Callers:
 *     HUBDSM_FlushingHubPowerDownEventsForFailedDevice @ 0x1C00165C0 (HUBDSM_FlushingHubPowerDownEventsForFailedDevice.c)
 *     HUBDSM_FailedDeviceHubSuspended @ 0x1C0016660 (HUBDSM_FailedDeviceHubSuspended.c)
 * Callees:
