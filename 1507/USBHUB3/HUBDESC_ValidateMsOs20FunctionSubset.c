/*
 * XREFs of HUBDESC_ValidateMsOs20FunctionSubset @ 0x1C002E520
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Du, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Eu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  return v8;
}
