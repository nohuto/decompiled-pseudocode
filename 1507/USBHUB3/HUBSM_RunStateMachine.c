/*
 * XREFs of HUBSM_RunStateMachine @ 0x1C00095D0
 * Callers:
  ...
  while ( 1 )
  {
    if ( a2 == 1000 )
    {
      ...
      if ( v13 == 1000 )
      {
        v37 = *(_QWORD *)(a1 + 960);
        *(_BYTE *)(a1 + 848) = 0;
        v38 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 1632))(
                WdfDriverGlobals,
                v37,
                v15);
...
LABEL_72:
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4
                                + 8LL * (unsigned int)(*(_DWORD *)(a1 + 4LL * *(unsigned int *)(a1 + 880) + 852) - v40))
                    + 16LL) & 0x10) != 0
      && KeGetCurrentIrql()
      || !v6 && v5 > 0x64 )
    {
...
LABEL_83:
  ...
  (*(void (__fastcall **)(_QWORD, void (__fastcall *)(__int64, __int64), __int64, _QWORD))(*(_QWORD *)(a1 + 1000) + 472LL))(
    *(_QWORD *)(a1 + 992),
    HUBSM_EvtSmWorkItem,
    a1,
