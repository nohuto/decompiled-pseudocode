/*
 * XREFs of HUBUCX_CreateDeviceInUCX @ 0x1C001CCE4
 * Callers:
 *     HUBDSM_CreatingUCXDevice30 @ 0x1C0017B20 (HUBDSM_CreatingUCXDevice30.c)
 * Callees:
...
LABEL_9:
  *((_DWORD *)a1 + 40) = *(unsigned __int16 *)(v4 + 200);
  a1[21] = (__int64)a1;
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64 *, __int64 *))(v2 + 360))(*(_QWORD *)(v2 + 208), a1 + 19, a1 + 3);
  v6 = v5;
  if ( v5 >= 0 )
  {
    a1[190] = a1[3];
