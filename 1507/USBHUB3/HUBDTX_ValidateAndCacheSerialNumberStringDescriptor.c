/*
 * XREFs of HUBDTX_ValidateAndCacheSerialNumberStringDescriptor @ 0x1C002199C
 * Callers:
 *     HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice @ 0x1C0018C20 (HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice.c)
 * Callees:
  ...
  if ( v26 >> 1 )
  {
    ...
    do
    {
      ...
      if ( v15 < 0x20u || v15 > 0x7Fu || v15 == 44 )
      {
        v12 = 0;
        LODWORD(v22) = v15;
        WPP_RECORDER_SF_d(v23, 2u, 5u, 0x113u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v22);
...
LABEL_21:
    WPP_RECORDER_SF_(v23, 2u, 5u, 0x114u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  if ( v12 )
  {
    v18 = *(void **)(v1 + 2136);
    if ( v18 )
