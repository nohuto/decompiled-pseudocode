/*
 * XREFs of HUBFDO_EvtDeviceD0Entry @ 0x1C000A110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtDeviceD0Entry(__int64 a1)
{
  ...
  *(_DWORD *)(v2 + 2520) = 1;
  ...
  v4 = (PVOID *)(v2 + 2480);
  if ( !*(_QWORD *)(v2 + 2480) && (*(_DWORD *)(v2 + 40) & 0x4000000) != 0 )
  {
  ...
  {
    v7 = EtwActivityIdControl(3u, (LPGUID)(v3 + 2196));
    if ( v7 >= 0 )
    {
