/*
 * XREFs of HUBHTX_GetPortStatusUsingControlTransfer @ 0x1C000368C
 * Callers:
 *     HUBPSM20_GettingPortStatusInWaitingForStopSuspend @ 0x1C000D900 (HUBPSM20_GettingPortStatusInWaitingForStopSuspend.c)
 * Callees:
