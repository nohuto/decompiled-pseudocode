/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInfo @ 0x1C000AEA0
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionInfo(__int64 a1, __int64 a2, size_t a3, int a4, char a5)
{
  ...
  void *v47; // [rsp+30h] [rbp-38h] BYREF
  KIRQL v48; // [rsp+38h] [rbp-30h]
  ...
  if ( (v12 & 0x80000000) == 0 )
  {
    ...
    v13 = v10 + 2280;
    v14 = 248LL;
    for ( i = *(_QWORD *)(v10 + 2280); ; i = *(_QWORD *)(v16 + 248) )
    {
      v16 = i - 248;
      if ( v13 == v16 + 248 )
        goto LABEL_8;
...
LABEL_39:
  if ( a5 == 1 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) == 0 )
      return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
               ...
               v12);
    v40 = v39 < 0;
    v41 = (const EVENT_DESCRIPTOR *)&USBHUB3_ETW_EVENT_HUB_IOCTL_USB_GET_NODE_CONNECTION_INFORMATION_EX_COMPLETE;
  }
  else
  {
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) == 0 )
      return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
               ...
               v12);
    v38 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2280))(WdfDriverGlobals, v5);
    v42 = WPP_MAIN_CB.Queue.Wcb.DeviceObject
        ? ((__int64 (__fastcall *)(__int64, PKSPIN_LOCK *))WPP_MAIN_CB.Queue.Wcb.DeviceObject)(v38, SpinLock)
        : -1073741275;
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) == 0 )
      return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
               ...
               v12);
    v40 = v42 < 0;
    v41 = (const EVENT_DESCRIPTOR *)&USBHUB3_ETW_EVENT_HUB_IOCTL_USB_GET_NODE_CONNECTION_INFORMATION_COMPLETE;
  }
  v43 = SpinLock;
  if ( v40 )
    v43 = 0LL;
  LODWORD(v46) = v12;
  LODWORD(v45) = v8;
  Template_pqq(v38, v41, (const GUID *)v43, *(_QWORD *)(v10 + 208), v45, v46);
  return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
           WdfDriverGlobals,
           v5,
           v12);
