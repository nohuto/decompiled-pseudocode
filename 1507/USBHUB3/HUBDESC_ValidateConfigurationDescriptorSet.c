/*
 * XREFs of HUBDESC_ValidateConfigurationDescriptorSet @ 0x1C002A83C
 * Callers:
        ...
        _BYTE *a5)
{
  ...
  *(_QWORD *)&v24[3] = v10;
  if ( !a1 )
  {
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x7Du, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
    v12 = 60LL;
LABEL_5:
...
LABEL_6:
  ...
  {
    WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x7Eu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v5, 9);
    v12 = 56LL;
    goto LABEL_5;
  }
  v22 = 0;
...
LABEL_31:
  ...
  if ( !v13 )
LABEL_41:
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x7Fu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  return v13;
}
