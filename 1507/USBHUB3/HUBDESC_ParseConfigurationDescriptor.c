/*
 * XREFs of HUBDESC_ParseConfigurationDescriptor @ 0x1C0027D24
 * Callers:
...
LABEL_11:
        if ( v17 )
        {
          ...
          {
            v17 = 0LL;
            WPP_RECORDER_SF_(a9, 2u, 5u, 0xCu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
            a4 = v21;
          }
          if ( v17 )
          {
      ...
      else
      {
        ...
        v19 = 10;
LABEL_21:
        WPP_RECORDER_SF_(a9, 2u, 5u, v19, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
      }
      if ( v13 )
        break;
      if ( v12 )
