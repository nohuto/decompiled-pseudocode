/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSContainerIdDescriptorHeader @ 0x1C00212A4
 * Callers:
 *     HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor @ 0x1C0018980 (HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheMSOSContainerIdDescriptorHeader(__int64 a1)
{
  ...
  {
    v9 = *(_DWORD *)(a1 + 240);
    WPP_RECORDER_SF_d(v3, 2u, 5u, 0x100u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v9);
    HUBMISC_LogDescriptorValidationErrorForDevice(a1, 117LL);
LABEL_10:
    WPP_RECORDER_SF_(v3, 2u, 5u, 0x104u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  ...
  if ( v5 != 256 )
  {
    v12 = 256;
    v10 = v5;
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0x101u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v10, v12);
  ...
  if ( v6 != 6 )
  {
    LODWORD(v11) = 6;
    LODWORD(v8) = v6;
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0x102u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v8, v11);
  ...
  if ( *(_DWORD *)(a1 + 1716) != 24 )
  {
    ...
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0x103u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v8, v11);
