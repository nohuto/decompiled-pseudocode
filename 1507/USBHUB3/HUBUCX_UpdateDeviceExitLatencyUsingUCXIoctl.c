/*
 * XREFs of HUBUCX_UpdateDeviceExitLatencyUsingUCXIoctl @ 0x1C001CB40
 * Callers:
 *     HUBDSM_UpdatingDeviceExitLatencyInTheControllerAfterIncreasingExitLatency @ 0x1C001B690 (HUBDSM_UpdatingDeviceExitLatencyInTheControllerAfterIncreasingExitLatency.c)
 * Callees:
...
void __fastcall HUBUCX_UpdateDeviceExitLatencyUsingUCXIoctl(__int64 a1)
{
  ...
  else
  {
    ...
    v3[6] |= 4u;
    *v3 = 72;
    *((_QWORD *)v3 + 1) = *(_QWORD *)(*(_QWORD *)a1 + 208LL);
