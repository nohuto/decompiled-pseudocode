/*
 * XREFs of HUBDESC_ValidateMsOs20CompatibleId @ 0x1C002E7A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20CompatibleId(__int64 a1, __int64 a2, _WORD *a3)
{
  ...
  if ( (*(_BYTE *)a2 & 0x20) != 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Fu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  ...
  do
  {
    ...
    if ( *v12 )
    {
      if ( v11 == 1 )
      {
        v20 = 321;
LABEL_26:
        WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, v20, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
        v9 = 168LL;
        goto LABEL_6;
      }
