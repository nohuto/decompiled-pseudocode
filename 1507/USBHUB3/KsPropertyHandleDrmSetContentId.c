/*
 * XREFs of KsPropertyHandleDrmSetContentId @ 0x1C006FA40
 * Callers:
 *     HUBPDO_EvtIoDeviceControl @ 0x1C0010030 (HUBPDO_EvtIoDeviceControl.c)
 * Callees:
 *     HUBPDO_DrmSetContentId @ 0x1C0010028 (HUBPDO_DrmSetContentId.c)
...
__int64 __fastcall KsPropertyHandleDrmSetContentId(__int64 a1)
{
  ...
  if ( !v7 )
  {
    if ( v4 < 0x18 || (unsigned int)v6 < (unsigned int)v5 || (unsigned int)v6 + v4 < (unsigned int)v6 )
      return 3221225990LL;
    v8 = *(_DWORD *)(*(_QWORD *)(v3 + 32) + 20LL);
    PoolWithQuotaTag = (char *)ExAllocatePoolWithQuotaTag(NonPagedPool, (unsigned int)v6 + v4, 0x7070534Bu);
    ...
    if ( PoolWithQuotaTag )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(a1 + 24) + v6 + 20) = v8;
      if ( v8 == 2 )
      {
        ...
        {
          if ( *(_BYTE *)(a1 + 64) )
            ProbeForRead(*(volatile void **)(a1 + 112), (unsigned int)v5, 1u);
  ...
  if ( *(_DWORD *)(v10 + 20) != 2 )
    return 3221225474LL;
  if ( v4 < 0x58 || (unsigned int)v5 < 0x10 )
    return 3221225507LL;
