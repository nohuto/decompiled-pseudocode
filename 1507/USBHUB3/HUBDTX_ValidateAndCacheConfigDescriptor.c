/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C0020884
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C0018120 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
...
LABEL_48:
  ...
  *(_QWORD *)(a1 + 1992) = v18;
  if ( v18 )
  {
    ...
    {
      if ( (v19 = *(_DWORD *)(a1 + 156), v19 == 3) && (*(_DWORD *)(*(_QWORD *)a1 + 696LL) & 1) != 0 || v19 == 2 )
      {
