/*
 * XREFs of HUBUCX_CreateEndpointsInUCX @ 0x1C001CE08
 * Callers:
 *     HUBDSM_CreatingNewEndpoints @ 0x1C001A1C0 (HUBDSM_CreatingNewEndpoints.c)
 * Callees:
    ...
    for ( i = *v4; ; i = *(_QWORD *)(v6 + 8) )
    {
      ...
      for ( j = 0; j < *(_DWORD *)(v6 + 24); ++j )
      {
        ...
        if ( *(_DWORD *)(v8 + 8) == 1 )
        {
          ...
          v11 = *(_QWORD *)(v8 + 32);
          *(_DWORD *)(v8 + 8) = 2;
          v12 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, __int64, __int64, unsigned __int64))(v1 + 408))(
                  *(_QWORD *)(v1 + 208),
                  a1[3],
                  v11,
                  v10,
      ...
      for ( m = 0; m < *(_DWORD *)(v18 + 24); ++m )
      {
        ...
        if ( *(_DWORD *)(v16 + v18 + 48) == 2 )
        {
          ...
          else
          {
            ...
            *(_DWORD *)(v16 + v18 + 48) = 1;
            (*(void (__fastcall **)(_QWORD, __int64, __int64))(v1 + 416))(*(_QWORD *)(v1 + 208), a1[3], v17);
          }
        }
      }
    }
