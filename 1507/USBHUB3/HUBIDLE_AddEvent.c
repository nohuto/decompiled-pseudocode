/*
 * XREFs of HUBIDLE_AddEvent @ 0x1C002F1B8
 * Callers:
 ...
 *     HUBIDLE_CancelIdle @ 0x1C002F680 (HUBIDLE_CancelIdle.c)
...
__int64 __fastcall HUBIDLE_AddEvent(__int64 a1, int a2, IRP *a3)
{
  ...
  KIRQL v35; // [rsp+51h] [rbp-57h]
  int v37; // [rsp+58h] [rbp-50h]
  __int64 v39; // [rsp+70h] [rbp-38h]
  GUID v40; // [rsp+78h] [rbp-30h] BYREF

  v39 = *(_QWORD *)(a1 + 152);
  v4 = 0LL;
  v6 = 259;
  v37 = *(_DWORD *)(a1 + 160);
  v35 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 136));
  v7 = v35;
  if ( a2 != 1000 )
  {
    v8 = a2;
    while ( 1 )
    {
      v9 = 1001;
      v10 = 0LL;
      v11 = *(_QWORD *)(v39 + 8LL * (unsigned int)(*(_DWORD *)(a1 + 144) - v37));
        ...
        case 1001:
          ...
          WPP_RECORDER_SF_d(
            *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 - 48) + 8LL) + 1432LL),
            ...
            5u,
            0xBu,
            (__int64)&WPP_a0a238cc757609055621713ff4f812aa_Traceguids,
            v30);
          ...
          if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x800) != 0 )
          {
            ...
            Template_ppqqqq(v15, &USBHUB3_ETW_EVENT_UNHANDLED_STATE_MACHINE_EVENT, 0LL, 0LL, 0LL, v31, v32, v33, v34);
          }
          goto LABEL_27;
        case 1002:
          v6 = -2147483631;
...
LABEL_21:
      ...
      *(_BYTE *)(a1 + 128) = (*(_BYTE *)(a1 + 128) + 1) & 0xF;
      if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x1000) != 0 )
      {
        ...
        LODWORD(v33) = v8;
        LODWORD(v32) = **(_DWORD **)(*(_QWORD *)(a1 + 152) + 8 * v13);
        LODWORD(v30) = *(_DWORD *)(a1 + 160);
        Template_ppqqqq(
          v13,
      ...
      *(_DWORD *)(a1 + 144) = v9;
      v14 = *(__int64 (__fastcall **)(__int64, IRP *))(*(_QWORD *)(v39 + 8LL * (unsigned int)(v9 - v37)) + 8LL);
      if ( v14 )
        v8 = v14(a1, a3);
      else
        v8 = 1000;
        ...
        if ( v21 )
        {
          ...
          else
          {
            ...
            *(_QWORD *)v40.Data4 = 0LL;
            if ( a3 && WPP_MAIN_CB.Queue.Wcb.DeviceObject )
              ((void (__fastcall *)(IRP *, GUID *))WPP_MAIN_CB.Queue.Wcb.DeviceObject)(a3, &v40);
            if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
              Template_p(v26, &USBHUB3_ETW_EVENT_DEVICE_IDLE_CALLBACK, &v40, *(_QWORD *)(*(_QWORD *)(a1 - 48) + 24LL));
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v40.Data4 = 0LL;
    if ( WPP_MAIN_CB.Queue.Wcb.DeviceObject )
      ((void (__fastcall *)(IRP *, GUID *))WPP_MAIN_CB.Queue.Wcb.DeviceObject)(v4, &v40);
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
    {
      LODWORD(v29) = v6;
      Template_pq(v17, (const EVENT_DESCRIPTOR *)"a", &v40, *(_QWORD *)(*(_QWORD *)(a1 - 48) + 24LL), v29);
    }
