/*
 * XREFs of HUBFDO_IoctlResetHub @ 0x1C0065794
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlResetHub(__int64 a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
         ...
         v4,
         off_1C0057140);
  IsAdmin = HUBMISC_VerifyCallerIsAdmin(*(_QWORD *)(v5 + 2440));
  if ( IsAdmin >= 0 )
  {
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
    {
      ...
      if ( ActivityIdIrp < 0 )
        v11 = 0LL;
      Template_pqq(v10, &USBHUB3_ETW_EVENT_HUB_IOCTL_USB_RESET_HUB_COMPLETE, v11, *(_QWORD *)(v5 + 208), 0, IsAdmin);
    }
  }
