/*
 * XREFs of HUBUCX_DeleteEndpointsAndFreeResourcesForInterface @ 0x1C001DCEC
 * Callers:
 *     HUBDSM_DeletingEndpointsForNewInterfaceOnFailure @ 0x1C001A740 (HUBDSM_DeletingEndpointsForNewInterfaceOnFailure.c)
 *     HUBDSM_DeletingEndpointsForOldInterface @ 0x1C001A7A0 (HUBDSM_DeletingEndpointsForOldInterface.c)
...
__int64 __fastcall HUBUCX_DeleteEndpointsAndFreeResourcesForInterface(__int64 *a1, __int64 a2)
{
  ...
  for ( i = 0; i < *(_DWORD *)(a2 + 24); ++i )
  {
    ...
    {
      (*(void (__fastcall **)(_QWORD, __int64, _QWORD))(v2 + 416))(
        *(_QWORD *)(v2 + 208),
        a1[3],
        *(_QWORD *)(v6 + a2 + 40));
      *(_DWORD *)(v6 + a2 + 48) = 7;
