/*
 * XREFs of USBD_CreateHandle @ 0x1C00313D4
 * Callers:
 *     HUBFDO_EvtDeviceAdd @ 0x1C0061E20 (HUBFDO_EvtDeviceAdd.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C0030D3C (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
