/*
 * XREFs of HUBHSM_ValidatingAndParsingHubDescriptor @ 0x1C0007DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_ValidatingAndParsingHubDescriptor(__int64 a1)
{
  ...
  if ( v3 > 2 )
  {
    if ( v3 == 3 && (unsigned __int8)HUBDESC_Validate30HubDescriptor(v1 + 1100, v2, v9, *(_QWORD *)(v1 + 2440)) )
    {
      v4 = *(unsigned __int8 *)(v1 + 1102);
      v5 = 2053;
      *(_WORD *)(v1 + 44) = v4;
      *(_WORD *)(v1 + 158) = v4;
      if ( (*(_BYTE *)(v1 + 1103) & 1) != 0 )
        _InterlockedOr((volatile signed __int32 *)(v1 + 40), 4u);
      v6 = (*(_WORD *)(v1 + 1103) >> 3) & 3;
...
LABEL_16:
    v5 = 2045;
    WPP_RECORDER_SF_(*(_QWORD *)(v1 + 2440), 2u, 3u, 0x21u, (__int64)&WPP_08e7bf601c3e12d09f184cac358a51ee_Traceguids);
    return v5;
  }
  if ( !(unsigned __int8)HUBDESC_Validate20HubDescriptor(v1 + 1100, v2, v9, *(_QWORD *)(v1 + 2440)) )
    goto LABEL_16;
  v7 = *(unsigned __int8 *)(v1 + 1102);
  v5 = 2053;
  *(_WORD *)(v1 + 44) = v7;
  *(_WORD *)(v1 + 152) = v7;
  if ( (*(_BYTE *)(v1 + 1103) & 1) != 0 )
    _InterlockedOr((volatile signed __int32 *)(v1 + 40), 4u);
  if ( (*(_BYTE *)(v1 + 1103) & 8) != 0 )
LABEL_9:
