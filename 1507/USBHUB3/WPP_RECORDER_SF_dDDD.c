/*
 * XREFs of WPP_RECORDER_SF_Dddd @ 0x1C0027A30
 * Callers:
...
__int64 WPP_RECORDER_SF_Dddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_2371d6fec51640206d5aea3557771e4a_Traceguids,
      104LL,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 104;
  return WppAutoLogTrace(a1, 2LL, 5LL, &WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v7, (__int64 *)va);
}
