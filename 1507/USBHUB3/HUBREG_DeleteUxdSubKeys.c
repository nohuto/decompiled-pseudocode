/*
 * XREFs of HUBREG_DeleteUxdSubKeys @ 0x1C006CAD0
 * Callers:
...
__int64 __fastcall HUBREG_DeleteUxdSubKeys(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _DWORD v12[20]; // [rsp+60h] [rbp-88h] BYREF
    ...
    while ( 1 )
    {
      ...
      if ( *((_DWORD *)PoolWithTag + 1) == 3 )
      {
        ...
        if ( (*(int (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, struct _UNICODE_STRING *, __int64, _DWORD *, _QWORD, _QWORD))(WdfFunctions_01015 + 1880))(
               ...
               0LL) < 0 )
          break;
        if ( v12[9] == 1 || (*(_DWORD *)(a2 + 4) & 0x100) != 0 )
        {
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2440), 2u, 3u, 0x54u, (__int64)&WPP_f82bbd93e8fe66f2423ffa453a54785f_Traceguids);
  }
  return 0LL;
}
