/*
 * XREFs of HUBHTX_ClearTtBufferControlTransferComplete @ 0x1C00054C0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 < 0 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x4000) != 0 )
    {
      ...
      Template_pqqq(
        ...
        0LL,
        *(_QWORD *)(*(_QWORD *)(a4 + 168) + 208LL),
        v9,
        v10,
        v11);
    }
  }
  (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(a4 + 168) + 488LL))(
    *(_QWORD *)(*(_QWORD *)(a4 + 168) + 336LL),
    *(_QWORD *)(a4 + 176));
