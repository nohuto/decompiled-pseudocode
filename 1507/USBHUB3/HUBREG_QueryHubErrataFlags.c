/*
 * XREFs of HUBREG_QueryHubErrataFlags @ 0x1C006A900
 * Callers:
...
LABEL_26:
  ...
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 2416), 1u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 40), 0x8000u);
  }
  if ( !*(_BYTE *)(a1 + 200) && ((v20 & 0x10000) != 0 || (v21 & 0x10000) != 0) )
    *(_DWORD *)(a1 + 2416) |= 1u;
  ...
  if ( *(_WORD *)(a1 + 2384) == 8457 && *(_WORD *)(a1 + 2386) == 2064 && (unsigned __int8)*(_WORD *)(a1 + 2388) < 0x89u )
    _InterlockedOr((volatile signed __int32 *)(a1 + 40), 0x800000u);
  if ( (*(_DWORD *)(a1 + 40) & 0x800000) != 0 )
  {
    WER_CreateReport(a1, 0x800000000LL, 0x800000LL, 0x3002u);
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2440), 4u, 3u, 0x26u, (__int64)&WPP_f82bbd93e8fe66f2423ffa453a54785f_Traceguids);
  }
  v8 = 0;
LABEL_75:
  if ( v22 )
