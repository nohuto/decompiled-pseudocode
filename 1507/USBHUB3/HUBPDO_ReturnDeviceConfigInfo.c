/*
 * XREFs of HUBPDO_ReturnDeviceConfigInfo @ 0x1C0010730
 * Callers:
...
LABEL_3:
  ...
  *(_DWORD *)(v4 + 4) = 204;
  v7 = *(_DWORD *)(v4 + 8);
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 16) + 2416LL) & 2) != 0 )
    v7 = 1;
  *(_DWORD *)(v4 + 8) = v7;
  if ( *(_WORD *)(*(_QWORD *)(a1 + 16) + 2378LL) >= 0x200u )
    *(_DWORD *)(v4 + 8) |= 1u;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 16) + 40LL) & 2) != 0 )
    *(_DWORD *)(v4 + 8) |= 8u;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 16) + 40LL) & 2) != 0 )
    *(_DWORD *)(v4 + 8) |= 4u;
  if ( *(_DWORD *)(*(_QWORD *)(a1 + 16) + 216LL) == 2 )
    *(_DWORD *)(v4 + 8) |= 2u;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 16) + 40LL) & 0x100) != 0 )
    *(_DWORD *)(v4 + 8) |= 0x20u;
  if ( !*(_BYTE *)(*(_QWORD *)(a1 + 16) + 200LL) )
    *(_DWORD *)(v4 + 8) |= 0x10u;
      ...
      *(_QWORD *)(v4 + 52) = 0LL;
      if ( *(_QWORD *)(v13 + 8) && *(_DWORD *)(v13 + 4) )
      {
        ...
        *(_OWORD *)(v4 + 44) = *(_OWORD *)v13;
        PoolWithTag = ExAllocatePoolWithTag(v14, *(unsigned int *)(v13 + 4), 0x64334855u);
