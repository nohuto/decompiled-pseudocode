/*
 * XREFs of WPP_RECORDER_SF_cccccccc @ 0x1C0001EB4
 * Callers:
...
__int64 WPP_RECORDER_SF_cccccccc(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_08e7bf601c3e12d09f184cac358a51ee_Traceguids,
      37LL,
      (__int64 *)va,
      1LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 37;
  return WppAutoLogTrace(a1, 4LL, 4LL, &WPP_08e7bf601c3e12d09f184cac358a51ee_Traceguids, v7, (__int64 *)va);
}
