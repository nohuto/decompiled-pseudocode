/*
 * XREFs of HUBHTX_CheckAndSelectIfAny30PortChangeSet @ 0x1C00040EC
 * Callers:
 *     HUBPSM30_CheckIfThereIsAPortChangeOnStartResumeOnGetPortStatus @ 0x1C000EB30 (HUBPSM30_CheckIfThereIsAPortChangeOnStartResumeOnGetPortStatus.c)
 * Callees:
