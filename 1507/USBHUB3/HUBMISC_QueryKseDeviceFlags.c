/*
 * XREFs of HUBMISC_QueryKseDeviceFlags @ 0x1C0026A84
 * Callers:
...
LABEL_7:
    LODWORD(v16) = v12;
    return WPP_RECORDER_SF_d(a7, 2u, 5u, v13, (__int64)&WPP_869fbaf8a3d1cd509c2dba31f5510baf_Traceguids, v16);
  }
  ((void (__fastcall *)(wchar_t *, const wchar_t *, _QWORD *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
    pszDest,
    L"USB",
    a4);
  ...
  return ((__int64 (__fastcall *)(wchar_t *, const wchar_t *, _QWORD *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
           pszDest,
           L"USB",
           a5);
}
