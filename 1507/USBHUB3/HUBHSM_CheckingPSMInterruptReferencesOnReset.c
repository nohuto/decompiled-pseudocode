/*
 * XREFs of HUBHSM_CheckingPSMInterruptReferencesOnReset @ 0x1C0006BF0
 * Callers:
 *     <none>
 * Callees:
 *     HUBMUX_QueueSurpriseRemovalToAllPSMs @ 0x1C000C6AC (HUBMUX_QueueSurpriseRemovalToAllPSMs.c)
 *     HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased @ 0x1C000C7BC (HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased.c)
 */
