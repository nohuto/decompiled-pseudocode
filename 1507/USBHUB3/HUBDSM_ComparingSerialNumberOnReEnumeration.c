/*
 * XREFs of HUBDSM_ComparingSerialNumberOnReEnumeration @ 0x1C0019E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ComparingSerialNumberOnReEnumeration(__int64 a1)
{
  ...
  if ( v2 )
  {
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x20000) != 0 )
      Template_psqzq(v9, v8, v1 + 1500, *(_QWORD *)(*(_QWORD *)v1 + 208LL), v5, v6, v2 + 2, v7);
  }
  else if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x20000) != 0 )
  {
    Template_psqzq(v9, v8, v1 + 1500, *(_QWORD *)(*(_QWORD *)v1 + 208LL), v5, v6, 0LL, 0);
  }
  return v3;
}
