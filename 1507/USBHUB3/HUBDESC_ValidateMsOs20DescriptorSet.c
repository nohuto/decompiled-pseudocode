/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x1C002EF0C
 * Callers:
...
LABEL_23:
    *(_DWORD *)a2 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x161u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
    return v5;
  }
  if ( v7 < 0xA )
  {
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x160u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
