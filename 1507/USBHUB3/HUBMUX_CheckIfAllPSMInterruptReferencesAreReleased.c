/*
 * XREFs of HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased @ 0x1C000C7BC
 * Callers:
 ...
 *     HUBHSM_CheckingPSMInterruptReferencesOnStop @ 0x1C0006C50 (HUBHSM_CheckingPSMInterruptReferencesOnStop.c)
 * Callees:
 *     <none>
 */
