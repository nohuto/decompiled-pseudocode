/*
 * XREFs of HUBMISC_SetExtPropDescSemaphoreInRegistry @ 0x1C00691F4
 * Callers:
 *     HUBDSM_SettingExtPropDescSemaphoreForMsOs2 @ 0x1C001AE30 (HUBDSM_SettingExtPropDescSemaphoreForMsOs2.c)
 * Callees:
