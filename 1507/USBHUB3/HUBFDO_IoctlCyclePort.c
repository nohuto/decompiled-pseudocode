/*
 * XREFs of HUBFDO_IoctlCyclePort @ 0x1C00652D0
 * Callers:
...
LABEL_3:
    LODWORD(v25) = v11;
    WPP_RECORDER_SF_d(v8[305], 2u, 3u, v13, (__int64)&WPP_d42eb740404c6b27f086534fc2613da4_Traceguids, v25);
    goto LABEL_22;
  }
  ...
  if ( IsAdmin >= 0 )
  {
          ...
          (v19 = *(_QWORD *)(v17 + 24)) != 0) )
    {
      ...
      IsAdmin = HUBMISC_VerifyCallerIsAdmin(v8[305]);
