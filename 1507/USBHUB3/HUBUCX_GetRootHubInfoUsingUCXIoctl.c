/*
 * XREFs of HUBUCX_GetRootHubInfoUsingUCXIoctl @ 0x1C001D160
 * Callers:
 *     HUBHSM_GettingRootHubInfo @ 0x1C0007FD0 (HUBHSM_GettingRootHubInfo.c)
 * Callees:
...
void __fastcall HUBUCX_GetRootHubInfoUsingUCXIoctl(__int64 a1)
{
  ...
  WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2440), 2u, 3u, v5, (__int64)&WPP_72e76ab2a811890e773caa2aa06155f7_Traceguids, v3);
LABEL_6:
  if ( v4 < 0 )
  {
    if ( v6 )
