/*
 * XREFs of HUBPDO_EvtDeviceReleaseHardware @ 0x1C0066600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     UsbSleepStudy_UnregisterPdo @ 0x1C0032A94 (UsbSleepStudy_UnregisterPdo.c)
...
__int64 __fastcall HUBPDO_EvtDeviceReleaseHardware(__int64 a1)
{
  ...
  *(_BYTE *)v6 = 1;
  ...
  else
  {
    ...
    {
      HUBWNF_PublishUsbPartnerDualRoleFeatures(*(_QWORD *)(*(_QWORD *)(v4 + 8) + 1416LL), 0, 0);
