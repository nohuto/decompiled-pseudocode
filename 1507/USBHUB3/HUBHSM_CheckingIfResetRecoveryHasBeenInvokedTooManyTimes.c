/*
 * XREFs of HUBHSM_CheckingIfResetRecoveryHasBeenInvokedTooManyTimes @ 0x1C0006B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_CheckingIfResetRecoveryHasBeenInvokedTooManyTimes(__int64 a1)
{
  ...
  if ( (__int64)(MEMORY[0xFFFFF78000000014] - *(_QWORD *)(v1 + 56)) <= 600000000 )
  {
    if ( ++*(_WORD *)(v1 + 50) >= 0xAu )
    {
      v5 = *(_DWORD *)(v1 + 2512);
      v2 = 2057;
      *(_DWORD *)(v1 + 2516) = 1073872899;
      if ( (v5 & 1) != 0 )
        HUBMISC_VerifierDbgBreak("HubHwVerifierTooManyResets", v1 + 1184);
      if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x20000) != 0 )
        Template_p(v4, &USBHUB3_ETW_EVENT_HUB_TOO_MANY_RESETS, (const GUID *)(v1 + 2332), *(_QWORD *)(v1 + 208));
    }
  }
  else
  {
