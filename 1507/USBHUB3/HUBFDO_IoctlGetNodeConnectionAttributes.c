/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionAttributes @ 0x1C00639F4
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      *(_DWORD *)v20 = v7;
      *((_DWORD *)v20 + 2) = 0;
      for ( i = v9[285]; ; i = *(_QWORD *)(v13 + 248) )
      {
        v13 = i - 248;
        if ( v9 + 285 == (_QWORD *)(v13 + 248) )
          goto LABEL_8;
...
LABEL_8:
  ...
  {
    WPP_RECORDER_SF_d(v9[305], 2u, 3u, 0x2Au, (__int64)&WPP_d42eb740404c6b27f086534fc2613da4_Traceguids, v10);
  }
LABEL_9:
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
    {
      ...
      if ( ActivityIdIrp < 0 )
        v16 = 0LL;
      Template_pqq(v15, &USBHUB3_ETW_EVENT_HUB_IOCTL_USB_GET_NODE_CONNECTION_ATTRIBUTES_COMPLETE, v16, v9[26], v18, v19);
    }
  }
