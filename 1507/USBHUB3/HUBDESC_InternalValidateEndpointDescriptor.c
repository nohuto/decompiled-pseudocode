/*
 * XREFs of HUBDESC_InternalValidateEndpointDescriptor @ 0x1C0028658
 * Callers:
  ...
  *a3 = *a1;
  ...
  if ( *v5 != 1 )
  {
    if ( *a1 < 7u )
    {
      ...
      WPP_RECORDER_SF_DDDD(v10, v14, v15, 0x20u, v46);
    }
    if ( *a1 > 7u )
    {
      WPP_RECORDER_SF_DDD(v10, 3u, v12, 0x21u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, *a1, v9, 7);
    ...
    if ( *a3 > v11 )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
        *v5 = 2;
      LODWORD(v47) = v9;
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x22u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47);
      v16 = 83LL;
LABEL_22:
    ...
    if ( (*(_DWORD *)(a2 + 256) & 1) == 0 )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) )
        *v5 = 2;
      LODWORD(v47) = v9;
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x23u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47);
      v16 = 85LL;
      goto LABEL_22;
    }
    if ( (a1[2] & 0xF) == 0 )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
        *v5 = 2;
      LODWORD(v47) = v9;
      WPP_RECORDER_SF_d(v10, 2u, 5u, 0x24u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47);
    ...
    if ( (a1[2] & 0x70) != 0 )
    {
      ...
      LODWORD(v48) = a1[2];
      LODWORD(v47) = v9;
      WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x25u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
    ...
    if ( (a1[3] & 0xC0) != 0 )
    {
      ...
      LODWORD(v48) = v9;
      LODWORD(v47) = a1[3];
      WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x26u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
      ...
      if ( (a1[3] & 3) != 1 )
      {
        if ( (a1[3] & 3) != 2 )
        {
          if ( (a1[3] & 3) == 3 )
          {
            ...
            LODWORD(v48) = v9;
            LODWORD(v47) = a1[6];
            WPP_RECORDER_SF_dD(v10, 2u, 5u, v23, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
            v22 = 109LL;
LABEL_187:
...
LABEL_188:
          if ( _bittest64(*(const signed __int64 **)(a2 + 144), v49) )
          {
            if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) || *(_BYTE *)(a2 + 13) != v43 )
              *v5 = 2;
            WPP_RECORDER_SF_DDDD(v10, v49, v42, 0x47u, v46);
        ...
        if ( (v17 & 0xFFFFFFFC) != 0 )
        {
          ...
          LODWORD(v48) = v9;
          LODWORD(v47) = a1[3];
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x38u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
        ...
        if ( !v24 )
        {
          *v5 = 2;
          LODWORD(v47) = v9;
          WPP_RECORDER_SF_d(v10, 2u, 5u, 0x39u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47);
          v22 = 30LL;
          goto LABEL_187;
        }
        v25 = v24 - 1;
        ...
        LODWORD(v48) = v9;
        LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
        WPP_RECORDER_SF_dD(v10, 2u, 5u, v27, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
        v22 = 32LL;
        goto LABEL_187;
      }
      if ( !*(_BYTE *)(a2 + 81) && v18 )
      {
        LODWORD(v48) = v18;
        LODWORD(v47) = v9;
        WPP_RECORDER_SF_dD(v10, 3u, 5u, 0x3Du, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
      ...
      if ( !v31 )
      {
        *v5 = 2;
        LODWORD(v47) = v9;
        WPP_RECORDER_SF_d(v10, 2u, 5u, 0x3Eu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47);
        v22 = 111LL;
        goto LABEL_187;
      }
      v32 = v31 - 1;
      if ( v32 )
      {
        ...
        if ( !v33 )
        {
          if ( (v18 & 0x7FFu) > 0x400 )
          {
            ...
            LODWORD(v48) = v9;
            LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x41u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
          ...
          if ( (v18 & 0xE000) != 0 )
          {
            ...
            LODWORD(v48) = v9;
            LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x42u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
            (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 113LL);
          }
          if ( (v18 & 0x1800) == 0x1800 )
          {
            ...
            LODWORD(v48) = v9;
            LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
            WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x43u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
            (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 113LL);
          }
          ...
          LODWORD(v48) = v9;
          LODWORD(v47) = a1[6];
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x44u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
          goto LABEL_132;
        }
        if ( v33 != 1 )
          goto LABEL_188;
        if ( *((_WORD *)a1 + 2) > 0x400u )
        {
          ...
          LODWORD(v48) = v9;
          LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x45u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
          (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 113LL);
        }
        if ( (unsigned __int8)(a1[6] - 1) <= 0xFu )
          goto LABEL_188;
      ...
      else
      {
        if ( *((_WORD *)a1 + 2) > 0x3FFu )
        {
          *v5 = 2;
          LODWORD(v48) = v9;
          LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
          WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x3Fu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
          (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 113LL);
        }
        if ( (unsigned __int8)(a1[6] - 1) <= 0xFu )
          goto LABEL_188;
      ...
      LODWORD(v48) = v9;
      LODWORD(v47) = a1[6];
      WPP_RECORDER_SF_dD(v10, 2u, 5u, v34, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
LABEL_132:
      v22 = 112LL;
      goto LABEL_187;
    }
    if ( (v17 & 0xFFFFFFFC) != 0 )
    {
      ...
      LODWORD(v48) = v9;
      LODWORD(v47) = a1[3];
      WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x27u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
    ...
    if ( v35 )
    {
      ...
      if ( !v36 )
      {
        ...
        LODWORD(v48) = v9;
        LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
        WPP_RECORDER_SF_dD(v10, 2u, 5u, 0x29u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
        goto LABEL_186;
      }
      v37 = v36 - 1;
      if ( v37 )
    ...
    LODWORD(v48) = v9;
    LODWORD(v47) = *((unsigned __int16 *)a1 + 2);
    WPP_RECORDER_SF_dD(v10, 2u, 5u, v38, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v47, v48);
LABEL_186:
    v22 = 68LL;
    goto LABEL_187;
  }
LABEL_194:
  ...
  {
    v13 = 0;
    WPP_RECORDER_SF_(v10, 2u, 5u, 0x48u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  }
  return v13;
}
