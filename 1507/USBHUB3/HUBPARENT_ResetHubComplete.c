/*
 * XREFs of HUBPARENT_ResetHubComplete @ 0x1C00062B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPARENT_ResetHubComplete(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x400) != 0 )
    Template_pq(v7, &USBHUB3_ETW_EVENT_HUB_RESET_REQUEST_COMPLETE, 0LL, *(_QWORD *)(v6 + 208), v9);
  if ( v9 >= 0 )
  {
    if ( (*(_DWORD *)(v8 + 2328) & 1) != 0 )
  ...
  return HUBSM_AddEvent(v8 + 1184, v10);
}
