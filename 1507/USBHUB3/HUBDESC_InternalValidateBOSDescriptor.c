/*
 * XREFs of HUBDESC_InternalValidateBOSDescriptor @ 0x1C002CB64
 * Callers:
...
char __fastcall HUBDESC_InternalValidateBOSDescriptor(unsigned __int8 *a1, __int64 a2, _DWORD *a3, int *a4, __int64 a5)
{
  ...
  if ( !a1 )
  {
    *v5 = 1;
    v10 = a5;
    WPP_RECORDER_SF_(a5, 2u, 5u, 0xDAu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
    v11 = 27LL;
LABEL_28:
  ...
  if ( a1[1] != 15 )
  {
    *v5 = 2;
    LODWORD(v19) = 15;
    LODWORD(v18) = a1[1];
    WPP_RECORDER_SF_dD(v10, 2u, 5u, 0xDCu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v18, v19);
  ...
  *(_QWORD *)(a2 + 64) = *(_QWORD *)(a2 + 56) + *((unsigned __int16 *)a1 + 1);
  ...
  {
    LODWORD(v18) = v12;
    WPP_RECORDER_SF_d(v10, 2u, 5u, 0xDFu, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids, v18);
  ...
  if ( !a1[4] )
  {
    WPP_RECORDER_SF_(v10, 2u, 5u, 0xE1u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
      *v5 = 2;
...
LABEL_29:
  ...
  {
    v9 = 0;
    WPP_RECORDER_SF_(v10, 2u, 5u, 0xE3u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  }
  return v9;
}
