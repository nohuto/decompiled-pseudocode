/*
 * XREFs of HUBDTX_SetDeviceNullConfigurationUsingControlTransfer @ 0x1C00207D4
 * Callers:
 *     HUBDSM_DeConfiguringDeviceOnClientRequest @ 0x1C00166E0 (HUBDSM_DeConfiguringDeviceOnClientRequest.c)
 * Callees:
