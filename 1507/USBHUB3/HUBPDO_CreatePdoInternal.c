/*
 * XREFs of HUBPDO_CreatePdoInternal @ 0x1C0066BA4
 * Callers:
 *     HUBPDO_CreatePdo @ 0x1C0067C50 (HUBPDO_CreatePdo.c)
 *     HUBPDO_CreateUnknownPdo @ 0x1C0067D10 (HUBPDO_CreateUnknownPdo.c)
 * Callees:
...
LABEL_69:
  ...
  *(_DWORD *)(v32 + 384) = 5;
  if ( a2 )
    *(_QWORD *)(v32 + 8) = *(_QWORD *)(*(_QWORD *)a1 + 2368LL);
  else
    *(_BYTE *)v32 = 1;
  *(_QWORD *)(a1 + 16) = v32;
...
LABEL_40:
  ...
  v50 = *(_QWORD *)(v32 + 16);
  v51 = &v80;
  v52 = (unsigned __int16 *)(v50 + 282);
  v79 = *(unsigned __int16 *)(v50 + 280);
  do
  {
    v53 = *v52++;
    *v51++ = v53;
