/*
 * XREFs of HUBPARENT_SetHubConfiguration @ 0x1C0005CD8
 * Callers:
 *     HUBHSM_SettingHubConfiguration @ 0x1C0007D60 (HUBHSM_SettingHubConfiguration.c)
 * Callees:
...
__int64 __fastcall HUBPARENT_SetHubConfiguration(__int64 a1)
{
  ...
  v1 = *(struct _USB_CONFIGURATION_DESCRIPTOR **)(a1 + 1176);
  v2 = 0LL;
  v13 = 0LL;
  v4 = *(_DWORD *)(a1 + 216) - 1;
  if ( !v4 )
...
LABEL_9:
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2440), 2u, 3u, 0xCu, (__int64)&WPP_2b51b137d13ebbaf9b46485eeab58040_Traceguids);
LABEL_20:
  if ( v13 )
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1664))(WdfDriverGlobals);
  if ( v2 )
    ExFreePoolWithTag(v2, 0);
  return HUBSM_AddEvent(a1 + 1184, 2006LL);
}
