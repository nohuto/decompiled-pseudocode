/*
 * XREFs of HUBMUX_ReleasePortPowerReference @ 0x1C000C5E0
 * Callers:
 *     HUBPSM20_PoweredOffSuspended @ 0x1C000D8E0 (HUBPSM20_PoweredOffSuspended.c)
 *     HUBPSM30_ReleasingPowerReferenceOnHubS0IdleInD3Cold @ 0x1C000DB30 (HUBPSM30_ReleasingPowerReferenceOnHubS0IdleInD3Cold.c)
 * Callees:
...
__int64 __fastcall HUBMUX_ReleasePortPowerReference(volatile signed __int32 *a1)
{
  ...
  _InterlockedDecrement((volatile signed __int32 *)(v2 + 2264));
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v2 + 2252), 0xFFFFFFFF) == 1 )
    HUBSM_AddEvent(v2 + 1184, 0x80Au);
