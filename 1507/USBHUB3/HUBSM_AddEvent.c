/*
 * XREFs of HUBSM_AddEvent @ 0x1C00091B0
 * Callers:
 ...
 *     HUBSM_AddPsm20Event @ 0x1C00083E0 (HUBSM_AddPsm20Event.c)
 ...
 *     HUBPDO_NoPingResponse @ 0x1C0014F40 (HUBPDO_NoPingResponse.c)
 ...
 *     HUBMISC_HubEventTimer @ 0x1C0023060 (HUBMISC_HubEventTimer.c)
 *     HUBMISC_DsmEventTimer @ 0x1C0023080 (HUBMISC_DsmEventTimer.c)
 *     HUBMISC_AttachDevice @ 0x1C0025144 (HUBMISC_AttachDevice.c)
...
void __fastcall HUBSM_AddEvent(__int64 a1, unsigned int a2)
{
  ...
  __int64 v21; // rdx
  __int64 v22; // rax
  KIRQL v23; // [rsp+50h] [rbp+8h] BYREF
  ...
  LOBYTE(v6) = v4;
  v23 = v4;
  *(_DWORD *)(a1 + 4 * v5 + 768) = v24;
  *(_BYTE *)(a1 + 833) = (*(_BYTE *)(a1 + 833) + 1) & 0xF;
  v7 = v24;
  if ( v24 == 3039 || v24 == 3043 || v24 == 4055 || v24 == 4059 )
  {
    v8 = *(_BYTE *)(a1 + 948);
    v9 = 0;
    ...
    *(_BYTE *)(a1 + 949) = v8;
    if ( v9 )
    {
      ...
      if ( v24 > 0xFC7 )
      {
        if ( v24 != 4043 && v24 != 4047 )
        {
          if ( v24 == 4067 || v24 == 4071 || v24 == 4075 )
          {
            v14 = *(_QWORD *)(a1 + 960);
...
LABEL_26:
      ...
      else if ( v24 != 4039 )
      {
        ...
        if ( v24 != 4023 && v24 != 4027 && v24 != 4031 && v24 != 4035 )
          goto LABEL_26;
      }
      v14 = *(_QWORD *)(a1 + 960);
...
LABEL_46:
      HUBSM_RunStateMachine(a1, v17, &v23, 0LL);
      LOBYTE(v6) = v23;
      goto LABEL_47;
    }
  ...
  else
  {
    ...
    *(_BYTE *)(a1 + 949) = (*(_BYTE *)(a1 + 949) + 1) & 0xF;
    if ( !*(_BYTE *)(a1 + 848) )
    {
      v21 = *(_QWORD *)(a1 + 960);
      *(_BYTE *)(a1 + 848) = 1;
      v22 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, __int64))(WdfFunctions_01015 + 1632))(
              WdfDriverGlobals,
              v21,
              v5,
              v6);
