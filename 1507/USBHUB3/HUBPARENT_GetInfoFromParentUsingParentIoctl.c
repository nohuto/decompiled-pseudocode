/*
 * XREFs of HUBPARENT_GetInfoFromParentUsingParentIoctl @ 0x1C0006780
 * Callers:
 *     HUBHSM_GettingAdditionalInfoFromParent @ 0x1C0007FF0 (HUBHSM_GettingAdditionalInfoFromParent.c)
 * Callees:
...
LABEL_6:
  if ( v4 < 0 )
  {
    ...
    return HUBSM_AddEvent(a1 + 1184, 2038LL);
  }
  return result;
}
