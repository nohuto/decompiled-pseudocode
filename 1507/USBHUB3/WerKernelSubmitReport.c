/*
 * XREFs of WerKernelSubmitReport @ 0x1C0033B80
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C00702B0 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpGetRegistryKey @ 0x1C003339C (WerpGetRegistryKey.c)
 *     WerpAllocateAndInitializeSid @ 0x1C0033450 (WerpAllocateAndInitializeSid.c)
 *     WerpParseKeyName @ 0x1C0033530 (WerpParseKeyName.c)
 *     WerStartSystemErrorHandler @ 0x1C00339C8 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C0033AD0 (WerWaitForSystemErrorHandler.c)
