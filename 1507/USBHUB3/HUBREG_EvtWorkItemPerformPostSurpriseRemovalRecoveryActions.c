/*
 * XREFs of HUBREG_EvtWorkItemPerformPostSurpriseRemovalRecoveryActions @ 0x1C006CED0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  LODWORD(v12) = v6;
  WPP_RECORDER_SF_d(*(_QWORD *)(v7 + 64), 2u, 2u, v8, (__int64)&WPP_f82bbd93e8fe66f2423ffa453a54785f_Traceguids, v12);
LABEL_14:
  if ( v16 )
