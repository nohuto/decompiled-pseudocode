/*
 * XREFs of HUBFDO_EvtIoInternalDeviceControlFromPDO @ 0x1C000AB00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HUBFDO_EvtIoInternalDeviceControlFromPDO(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( a5 == 2228243 )
  {
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *))(WdfFunctions_01015 + 2128))(
      ...
      a2,
      v9);
    v7[313] = *(_QWORD *)(*(_QWORD *)(v9[2] + 24LL) + 8LL);
    v7[306] = a2;
    HUBSM_AddEvent((__int64)(v7 + 148), 0x7F7u);
  }
  else
  {
    WPP_RECORDER_SF_d(v7[305], 2u, 3u, 0x21u, (__int64)&WPP_d42eb740404c6b27f086534fc2613da4_Traceguids, a5);
