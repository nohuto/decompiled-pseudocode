/*
 * XREFs of HUBDTX_SetSelUsingControlTransfer @ 0x1C0022134
 * Callers:
 *     HUBDSM_SettingSEL @ 0x1C001AF70 (HUBDSM_SettingSEL.c)
 * Callees:
...
void __fastcall HUBDTX_SetSelUsingControlTransfer(unsigned __int16 *a1)
{
  ...
  v1 = *(_QWORD *)a1;
  v3 = *(_WORD *)(*(_QWORD *)a1 + 2394LL);
  v4 = *(unsigned __int8 *)(*(_QWORD *)a1 + 200LL);
  if ( a1[1088] > v3 )
    v3 = a1[1088];
  v5 = *(_WORD *)(v1 + 2398) + (1000 * (v4 - *(unsigned __int8 *)(v1 + 2400)) + 500) / 1000;
  if ( v3 <= v5 )
  {
    *((_BYTE *)a1 + 2181) = v5;
  }
  ...
  v6 = a1[1089];
  a1[1093] = v3 + *(_WORD *)(v1 + 2406) + (*(unsigned __int8 *)(*(_QWORD *)a1 + 1107LL) + 5) / 10;
  v7 = *(_WORD *)(v1 + 2396);
  if ( v6 > v7 )
    v7 = v6;
  v8 = *(_WORD *)(v1 + 2402) + (1000 * (v4 - *(unsigned __int8 *)(v1 + 2404)) + 500) / 1000;
  if ( v7 <= v8 )
  {
    a1[1092] = v8;
  }
  ...
  a1[1094] = v7 + *(_WORD *)(v1 + 2408) + (*(unsigned __int8 *)(*(_QWORD *)a1 + 1107LL) + 5) / 10;
  if ( (_BYTE)v4 )
