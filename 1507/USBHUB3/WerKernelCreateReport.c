/*
 * XREFs of WerKernelCreateReport @ 0x1C0033764
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C00702B0 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpCreateRegistryKey @ 0x1C003328C (WerpCreateRegistryKey.c)
 *     CheckSpaceAvailable @ 0x1C0033644 (CheckSpaceAvailable.c)
 */
