/*
 * XREFs of UsbSleepStudy_RegisterPdo @ 0x1C00328D0
 * Callers:
...
__int64 __fastcall UsbSleepStudy_RegisterPdo(PDEVICE_OBJECT DeviceObject, const void *a2, __int64 a3, _QWORD *a4)
{
  ...
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, 0x58uLL, 0x53535554u);
  v8 = PoolWithTag;
  if ( !PoolWithTag )
  {
...
LABEL_7:
  ...
  *a4 = v8;
  ...
  v15 = (__int64 **)qword_1C005A908;
  *v8 = &gDevicesListHead;
  v8[1] = v15;
  if ( *v15 != &gDevicesListHead )
    __fastfail(3u);
  *v15 = v8;
  qword_1C005A908 = (__int64)v8;
