/*
 * XREFs of HUBDESC_ValidateMsOs20MimimumRecoveryTime @ 0x1C002EBA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20MimimumRecoveryTime(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( *(char *)a2 < 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Du, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x151u, (__int64)&WPP_2371d6fec51640206d5aea3557771e4a_Traceguids);
  return v6;
}
