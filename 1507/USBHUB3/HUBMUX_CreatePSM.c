/*
 * XREFs of HUBMUX_CreatePSM @ 0x1C000BA18
 * Callers:
...
__int64 __fastcall HUBMUX_CreatePSM(__int64 a1, unsigned __int16 *a2)
{
  ...
  if ( v5 < 0 )
  {
    WPP_RECORDER_SF_d(
      *(_QWORD *)(a1 + 2440),
      ...
      4u,
      0xAu,
      (__int64)&WPP_be32aff92db2d8ba6a94dba8682f4b77_Traceguids,
      v5);
    v22 = 0LL;
    goto LABEL_15;
  }
  ...
  *(_QWORD *)(v4 + 232) = *((_QWORD *)a2 + 4);
  ...
  if ( v13 < 0 )
  {
    v14 = 11;
LABEL_7:
    WPP_RECORDER_SF_d(*v10, 2u, 4u, v14, (__int64)&WPP_be32aff92db2d8ba6a94dba8682f4b77_Traceguids, v13);
    goto LABEL_15;
  }
  ...
  *(_QWORD *)(v4 + 1312) = Timer;
  if ( Timer )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(v18 + 456))(*(_QWORD *)(v18 + 208), v19, 1LL);
    *(_QWORD *)(v4 + 1264) = v20;
    if ( !v20 )
    {
      WPP_RECORDER_SF_(*v10, 2u, 4u, 0xEu, (__int64)&WPP_be32aff92db2d8ba6a94dba8682f4b77_Traceguids);
      v6 = -1073741670;
    }
  }
  else
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2440), 2u, 3u, 0xCu, (__int64)&WPP_be32aff92db2d8ba6a94dba8682f4b77_Traceguids);
  }
LABEL_15:
  if ( v6 >= 0 )
  {
