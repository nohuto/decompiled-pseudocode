/*
 * XREFs of HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor @ 0x1C0026608
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedPropertyDescriptor @ 0x1C001AE40 (HUBDSM_ValidatingMSOSExtendedPropertyDescriptor.c)
 * Callees:
...
LABEL_23:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(v6 + 1432), 2u, 5u, v7, (__int64)&WPP_869fbaf8a3d1cd509c2dba31f5510baf_Traceguids);
