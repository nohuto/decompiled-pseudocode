/*
 * XREFs of ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x1400155C0
 * Callers:
 *     <none>
 * Callees:
...
{
  BOOL v6; // r10d
  _EVENT_TRACE_HEADER EventTrace; // [rsp+20h] [rbp-78h] BYREF
