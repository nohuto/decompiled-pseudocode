/*
 * XREFs of ?GetStreamingResourceManager@CSystemAudioDeviceSharedNew@@UEAAJPEAPEAUIAudioStreamingResourceRegistration@@@Z @ 0x14000DE50
 * Callers:
...
__int64 __fastcall CSystemAudioDeviceSharedNew::GetStreamingResourceManager(
        ...
        struct IAudioStreamingResourceRegistration **a2)
{
  ...
  v2 = 0LL;
  *a2 = 0LL;
  v4 = (void (__fastcall ***)(_QWORD, GUID *, CAudioDeviceGraph **))*((_QWORD *)this + 10);
  v10 = 0LL;
  if ( v4 )
  {
    v5 = **v4;
