/*
 * XREFs of ?RemoveAt@?$CAtlList@PEAVCStreamGroup@@V?$CElementTraits@PEAVCStreamGroup@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x140012EAC
 * Callers:
...
void __fastcall ATL::CAtlList<CStreamGroup *,ATL::CElementTraits<CStreamGroup *>>::RemoveAt(__int64 a1, __int64 *a2)
{
  ...
  if ( a2 == (__int64 *)StreamGroupList )
    ...
    *(_QWORD *)a2[1] = *a2;
  if ( a2 == (__int64 *)qword_140055468 )
    qword_140055468 = a2[1];
  else
    *(_QWORD *)(*a2 + 8) = a2[1];
  *a2 = qword_140055480;
  v2 = qword_140055470-- == 1;
  qword_140055480 = (__int64)a2;
  if ( v2 )
