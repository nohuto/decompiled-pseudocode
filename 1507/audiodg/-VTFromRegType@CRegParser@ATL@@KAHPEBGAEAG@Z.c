/*
 * XREFs of ?VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z @ 0x1400393F4
 * Callers:
...
__int64 __fastcall ATL::CRegParser::VTFromRegType(LPCWSTR lpString1, unsigned __int16 *a2)
{
  ...
  if ( (`ATL::CRegParser::VTFromRegType'::`2'::`local static guard' & 1) == 0 )
  {
    ...
    word_140055E78 = 8;
    qword_140055E80 = (__int64)L"M";
    word_140055E88 = 16392;
    qword_140055E90 = (__int64)L"D";
    word_140055E98 = 19;
    qword_140055EA0 = (__int64)L"B";
    word_140055EA8 = 17;
  }
  v4 = 0;
