/*
 * XREFs of ?CreateConnectionBuffer@CConnectionInstance@@QEAAJPEA_K0@Z @ 0x140009B20
 * Callers:
...
{
  CProcessNode *v5; // rbx
  __int64 (__fastcall *v7)(CProcessNode *, struct IAudioMediaType **); // rsi
  int RightFormat; // eax
  int v9; // ebx
  bool v10; // sf
  ...
  if ( v5 )
  {
    v7 = *(__int64 (__fastcall **)(CProcessNode *, struct IAudioMediaType **))(*(_QWORD *)v5 + 16LL);
