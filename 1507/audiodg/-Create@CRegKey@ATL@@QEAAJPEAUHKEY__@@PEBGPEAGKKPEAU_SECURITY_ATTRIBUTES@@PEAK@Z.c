/*
 * XREFs of ?Create@CRegKey@ATL@@QEAAJPEAUHKEY__@@PEBGPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAK@Z @ 0x140036C80
 * Callers:
 ...
 * Callees:
 *     ?Close@CRegKey@ATL@@QEAAJXZ @ 0x140036C54 (-Close@CRegKey@ATL@@QEAAJXZ.c)
 */
