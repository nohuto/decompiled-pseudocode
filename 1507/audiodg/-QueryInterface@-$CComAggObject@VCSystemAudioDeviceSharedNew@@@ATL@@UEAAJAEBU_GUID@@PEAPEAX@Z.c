/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCSystemAudioDeviceSharedNew@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14002E310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComAggObject<CSystemAudioDeviceSharedNew>::QueryInterface(
        char *a1,
