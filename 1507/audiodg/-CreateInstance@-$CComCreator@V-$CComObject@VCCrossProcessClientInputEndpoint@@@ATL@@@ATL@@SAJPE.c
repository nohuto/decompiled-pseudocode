/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140037274
 * Callers:
 *     ?CreateInstance@?$CComCreator2@V?$CComCreator@V?$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@@ATL@@V?$CComCreator@V?$CComAggObject@VCCrossProcessClientInputEndpoint@@@ATL@@@2@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140036D00 (-CreateInstance@-$CComCreator2@V-$CComCreator@V-$CComObject@VCCrossProcessClientInputEndpoint@@@.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  volatile int *v9; // rdx
  CCrossProcessClientInputEndpoint *v10; // rsi
  _QWORD v11[13]; // [rsp+0h] [rbp-68h] BYREF
  CCrossProcessClientInputEndpoint *v14; // [rsp+88h] [rbp+20h]
  ...
  *a3 = 0LL;
  ...
  try
  {
    ...
    v8 = (CCrossProcessClientInputEndpoint *)AERTAllocate(0x200uLL, v7);
    v11[5] = v8;
    if ( v8 )
  ...
  if ( v10 )
  {
    Microsoft::WRL::Details::SafeUnknownIncrementReference((CCrossProcessClientInputEndpoint *)((char *)v10 + 456), v9);
    v6 = ATL::CComSafeDeleteCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)((char *)v10 + 464));
    if ( v6 >= 0 )
      v6 = 0;
