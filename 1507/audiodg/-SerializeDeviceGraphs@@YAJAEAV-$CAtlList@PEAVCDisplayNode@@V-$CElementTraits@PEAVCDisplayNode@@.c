/*
 * XREFs of ?SerializeDeviceGraphs@@YAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@PEAPEAEPEAI@Z @ 0x140034188
 * Callers:
  ...
  if ( v6 )
  {
    ...
    else
    {
      ...
      if ( v14 )
      {
        while ( 1 )
        {
          Next = ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::GetNext(v8, &v14);
