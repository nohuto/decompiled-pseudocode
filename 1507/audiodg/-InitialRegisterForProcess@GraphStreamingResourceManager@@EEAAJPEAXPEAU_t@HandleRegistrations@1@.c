/*
 * XREFs of ?InitialRegisterForProcess@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@@Z @ 0x14000C9E0
 * Callers:
        ...
        struct GraphStreamingResourceManager::HandleRegistrations::_t *a3)
{
  ...
  if ( DuplicateHandle(v7, a2, CurrentProcess, &TargetHandle, 0x2000u, 0, 0) )
  {
    v8 = *((_QWORD *)this + 35);
    if ( !v8
      || (v11 = (*(__int64 (__fastcall **)(_QWORD, HANDLE, _QWORD *))(*(_QWORD *)v8 + 32LL))(
                  *((_QWORD *)this + 35),
                  TargetHandle,
                  v14),
          v11 >= 0) )
