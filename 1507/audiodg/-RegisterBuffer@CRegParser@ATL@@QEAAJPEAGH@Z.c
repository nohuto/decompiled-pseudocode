/*
 * XREFs of ?RegisterBuffer@CRegParser@ATL@@QEAAJPEAGH@Z @ 0x1400382B8
 * Callers:
 ...
 *     _alloca_probe @ 0x140019C50 (_alloca_probe.c)
 ...
 *     ?SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ @ 0x140038FA4 (-SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ.c)
 */
