/*
 * XREFs of ?Initialize@CSystemAudioDeviceOffload@@UEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@PEAUIAudioGraphCallback@@K@Z @ 0x140001C10
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v8 >= 0 )
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          *((_DWORD *)this + 95) = v9;
          ...
          v8 = -2147024882;
LABEL_13:
          (*(void (__fastcall **)(CSystemAudioDeviceOffload *))(*(_QWORD *)this + 184LL))(this);
        }
      }
    }
  }
