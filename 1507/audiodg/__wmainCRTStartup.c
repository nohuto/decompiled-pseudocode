/*
 * XREFs of __wmainCRTStartup @ 0x140018C50
 * Callers:
 *     wWinMainCRTStartup @ 0x140018ED0 (wWinMainCRTStartup.c)
 * Callees:
 *     wWinMain @ 0x1400177C0 (wWinMain.c)
 *     _XcptFilter_0 @ 0x14001915E (_XcptFilter_0.c)
 *     _amsg_exit_0 @ 0x140019214 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x140019270 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1400193EA (_initterm_0.c)
...
LABEL_18:
    ...
    dword_1400554E0 = result;
    if ( !dword_140055500 )
      exit(result);
    if ( !dword_1400554E4 )
    {
      _cexit();
      return dword_1400554E0;
    }
    return result;
  }
