/*
 * XREFs of ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x140033970
 * Callers:
...
const char *__fastcall CDisplayNode::GetDisplayName(CDisplayNode *this)
{
  ...
  if ( !v12 )
    return "Copy";
  v13 = *(_QWORD *)(v3 + 8) - *(_QWORD *)&GUID_3fd7f233_a716_472e_8f2f_c25954f34e96.Data1;
  if ( !v13 )
    v13 = *(_QWORD *)(v3 + 16) - *(_QWORD *)GUID_3fd7f233_a716_472e_8f2f_c25954f34e96.Data4;
