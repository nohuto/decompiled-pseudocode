/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x1400373C4
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  volatile int *v9; // rdx
  CCrossProcessClientOutputEndpoint *v10; // rsi
  _QWORD v11[13]; // [rsp+0h] [rbp-68h] BYREF
  CCrossProcessClientOutputEndpoint *v14; // [rsp+88h] [rbp+20h]
  ...
  *a3 = 0LL;
  ...
  if ( v10 )
  {
    Microsoft::WRL::Details::SafeUnknownIncrementReference((CCrossProcessClientOutputEndpoint *)((char *)v10 + 456), v9);
