/*
 * XREFs of ?QueryInterface@CVirtualProtectedOutput@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1400311B0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  unsigned int v4; // esi
  __int64 v5; // rax
  void (__fastcall *v6)(CVirtualProtectedOutput *); // rbx
  __int64 v7; // rax
  ...
  *a3 = 0LL;
  ...
  if ( v5 )
  {
    ...
    if ( v7 )
      return v4;
    *a3 = this;
    v6 = *(void (__fastcall **)(CVirtualProtectedOutput *))(*(_QWORD *)this + 8LL);
  }
  else
  {
    *a3 = this;
