/*
 * XREFs of ?RemoveAt@?$CAtlList@PEAVCStreamInstanceNew@@V?$CElementTraits@PEAVCStreamInstanceNew@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x140012E04
 * Callers:
...
void __fastcall ATL::CAtlList<CStreamInstanceNew *,ATL::CElementTraits<CStreamInstanceNew *>>::RemoveAt(
        _QWORD *a1,
        _QWORD *a2)
{
  _QWORD *v2; // r8
  ...
  *a2 = v2[4];
  ...
  v2[4] = a2;
  if ( v4 )
    ATL::CAtlList<CPipeInstance *,ATL::CElementTraits<CPipeInstance *>>::RemoveAll((__int64)v2);
}
