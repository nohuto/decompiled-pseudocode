/*
 * XREFs of ?FillAPOInitSystemEffectsStructure@@YAJPEAUIMMDevice@@PEAU_GUID@@U2@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@AEAUAPOInitSystemEffects2@@@Z @ 0x140002C30
 * Callers:
        ...
        struct APOInitSystemEffects2 *a6)
{
  ...
  IPropertyStore *v17; // [rsp+48h] [rbp-89h] BYREF
  struct KSDATAFORMAT_WAVEFORMATEX *v18; // [rsp+50h] [rbp-81h] BYREF
  IMMDeviceCollection *v19; // [rsp+58h] [rbp-79h] BYREF
  IPropertyStore *v20; // [rsp+60h] [rbp-71h] BYREF
  struct IUnknown *v21; // [rsp+68h] [rbp-69h] BYREF
  ...
  v10 = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD, IPropertyStore **))a1->lpVtbl[1].AddRef)(a1, 0LL, &v17);
  if ( v10 >= 0 )
  {
    v11 = v21;
    if ( v21 != a1 )
    ...
    v10 = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD, IPropertyStore **))v11->lpVtbl[1].Release)(v11, 0LL, &v20);
    if ( v10 >= 0 )
    {
      v35 = PKEY_AudioEngine_DeviceFormat;
      if ( ((int (__fastcall *)(IPropertyStore *, PROPERTYKEY *, PROPVARIANT *))v17->lpVtbl->GetValue)(v17, &v35, &pvar) >= 0
        && (_WORD)pvar == 65 )
      {
        ...
        v10 = CreateKSFormatFromWFXFormat(Src, &v18);
        if ( v10 < 0 )
          goto LABEL_34;
      }
      else
      {
        ...
        if ( v10 < 0 )
          goto LABEL_14;
        v10 = ((__int64 (__fastcall *)(struct IUnknown *, LPVOID *))a1->lpVtbl[1].Release)(a1, &v22);
        if ( v10 < 0 )
          goto LABEL_14;
        v10 = (*(__int64 (__fastcall **)(LPVOID, LPVOID, _QWORD, LPVOID *))(*(_QWORD *)v25 + 32LL))(v25, v22, 0LL, &pv);
        if ( v10 < 0 )
          goto LABEL_14;
        v10 = CreateKSFormatFromWFXFormat((const struct tWAVEFORMATEX *)pv, &v18);
        if ( v10 < 0 )
          goto LABEL_34;
      }
      ppv = (LPVOID *)&v27;
      v10 = ((__int64 (__fastcall *)(struct IUnknown *, GUID *, __int64))a1->lpVtbl[1].QueryInterface)(
              a1,
...
LABEL_14:
  ...
  v29 = 0LL;
  if ( v19 )
    ((void (__fastcall *)(IMMDeviceCollection *))v19->lpVtbl->Release)(v19);
  if ( v25 )
  ...
  if ( v17 )
    ((void (__fastcall *)(IPropertyStore *))v17->lpVtbl->Release)(v17);
