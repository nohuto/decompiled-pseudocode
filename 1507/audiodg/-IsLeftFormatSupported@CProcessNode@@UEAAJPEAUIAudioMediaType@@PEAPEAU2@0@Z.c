/*
 * XREFs of ?IsLeftFormatSupported@CProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x140008EE0
 * Callers:
        ...
        struct IAudioMediaType *a4)
{
  ...
  __int64 (__fastcall *v8)(CAudioMediaType *, struct _UNCOMPRESSEDAUDIOFORMAT *); // rsi
  ...
  *a3 = (struct IAudioMediaType *)*((_QWORD *)this + 1);
  ...
  if ( v14 )
  {
    ...
    if ( v15 == CAudioMediaType::AddRef )
      CAudioMediaType::AddRef(*((CAudioMediaType **)this + 1));
    else
      v15(*((CAudioMediaType **)this + 1));
  }
  return 1LL;
}
