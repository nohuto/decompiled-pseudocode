/*
 * XREFs of ?Initialize@CFormatConverterPipe@@QEAAJPEAUIDeviceGraphObjectCache@@PEBUtWAVEFORMATEX@@PEBUFORMAT_CONVERTER_PIPE_DESCRIPTOR@@@Z @ 0x140034414
 * Callers:
        ...
        const struct tWAVEFORMATEX **a4)
{
  ...
  CoTaskMemFree(v10);
  ATL::CAutoPtr<CPipeInstance>::Free(&v13);
