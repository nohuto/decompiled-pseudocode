/*
 * XREFs of ?AddPipe@CSystemAudioDeviceSharedNew@@UEAAJPEAVCPipeInstance@@@Z @ 0x14002DC20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceSharedNew::AddPipe(
        ...
        struct CPipeInstance *a2)
{
  ...
  if ( v5 )
  {
    v3 = (*(__int64 (__fastcall **)(void *, struct CPipeInstance *))(*(_QWORD *)v5 + 40LL))(v5, a2);
    if ( v5 )
