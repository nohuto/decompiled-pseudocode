/*
 * XREFs of ?UpdateRegistryFromResourceS@CAtlModule@ATL@@QEAAJIHPEAU_ATL_REGMAP_ENTRY@2@@Z @ 0x140039144
 * Callers:
 *     ?UpdateRegistry@CCrossProcessClientInputEndpoint@@SAJH@Z @ 0x1400390D0 (-UpdateRegistry@CCrossProcessClientInputEndpoint@@SAJH@Z.c)
 *     ?UpdateRegistry@CCrossProcessClientOutputEndpoint@@SAJH@Z @ 0x1400390F0 (-UpdateRegistry@CCrossProcessClientOutputEndpoint@@SAJH@Z.c)
 *     ?UpdateRegistry@CCrossProcessServerInputEndpoint@@SAJH@Z @ 0x140039110 (-UpdateRegistry@CCrossProcessServerInputEndpoint@@SAJH@Z.c)
 *     ?UpdateRegistry@CCrossProcessServerOutputEndpoint@@SAJH@Z @ 0x140039130 (-UpdateRegistry@CCrossProcessServerOutputEndpoint@@SAJH@Z.c)
 * Callees:
 ...
 *     __report_rangecheckfailure @ 0x1400195B8 (__report_rangecheckfailure.c)
 ...
 *     ?ocslen@@YAHPEBG@Z @ 0x1400394F4 (-ocslen@@YAHPEBG@Z.c)
 */
