/*
 * XREFs of pre_c_init @ 0x140018B20
 * Callers:
 *     <none>
 * Callees:
 *     _get_image_app_type @ 0x1400191C8 (_get_image_app_type.c)
 *     ?Resume@CSystemAudioDeviceBase@@UEAAJXZ @ 0x1400193E0 (-Resume@CSystemAudioDeviceBase@@UEAAJXZ.c)
 */
...
LABEL_11:
  ...
  _fmode = fmode;
  _commode = commode;
  CSystemAudioDeviceBase::Resume(*(struct _exception **)&_commode);
  if ( !_defaultmatherr )
    __setusermatherr(CSystemAudioDeviceBase::Resume);
  return 0LL;
}
