/*
 * XREFs of ?TrackSystemEffectBehavior@@YAJPEBG_N1AEBU_GUID@@@Z @ 0x140002FAC
 * Callers:
...
__int64 __fastcall TrackSystemEffectBehavior(const unsigned __int16 *a1, char a2, char a3, struct _GUID *a4)
{
  int Instance; // esi
  struct IMMDevice *v10; // [rsp+30h] [rbp-38h] BYREF
  LPVOID v11[3]; // [rsp+38h] [rbp-30h] BYREF
