/*
 * XREFs of ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x140011B80
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v7 )
    {
      ...
      if ( v16 )
      {
        if ( !*((_DWORD *)this + 36) )
        {
          ...
          v11 = *(__int64 (__fastcall **)(CSystemAudioDeviceSharedNew *, struct IStreamGroupInternal *))(*(_QWORD *)v16 + 80LL);
          if ( v11 == CSystemAudioDeviceSharedNew::StopStreamGroup )
            v12 = CSystemAudioDeviceSharedNew::StopStreamGroup(v16, v10);
          else
            v12 = v11(v16, v10);
          v9 = v16;
          v6 = v12;
