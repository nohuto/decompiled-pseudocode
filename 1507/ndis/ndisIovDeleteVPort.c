/*
 * XREFs of ndisIovDeleteVPort @ 0x1C0065320
 * Callers:
 *     ndisOidPostIovDeleteVPort @ 0x1C0065CA0 (ndisOidPostIovDeleteVPort.c)
...
__int64 __fastcall ndisIovDeleteVPort(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x2Eu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, 0LL, 0LL);
  v3 = P[9];
  v4 = P[10];
  v5 = P[11];
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v3 + 96));
  *(_QWORD *)(v3 + 520) = KeGetCurrentThread();
  *(_DWORD *)(v3 + 1856) = 2887278;
  v7 = (_QWORD *)*P;
  v8 = (PVOID *)P[1];
  ...
  *(_BYTE *)((*((_DWORD *)P + 31) >> 3) + *(_QWORD *)(v3 + 4824)) &= ~(1 << (*((_BYTE *)P + 124) & 7));
  ExFreePoolWithTag(P, 0);
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
  {
    v19 = 0;
    WPP_SF_qqd(0x2Fu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v2, v19);
  }
  return 0LL;
}
