/*
 * XREFs of ndisQueryStatisticsOids @ 0x1C0096198
 * Callers:
 ...
 *     ndisIsSatisfiedByOidGenStatistics @ 0x1C00203A0 (ndisIsSatisfiedByOidGenStatistics.c)
        ...
        _BYTE *a9)
{
  ...
  _BYTE v61[160]; // [rsp+A0h] [rbp-60h] BYREF
  _DWORD v62[64]; // [rsp+140h] [rbp+40h] BYREF
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(0x1Eu, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, a1);
  v13 = 0;
  *a7 = 0;
  if ( a8 )
  {
      ...
      if ( v19 - 131603 > 5 || (v25 = 55, !_bittest(&v25, v19 - 131603)) )
      {
        if ( v19 != 0xFFFFFF && v19 != 65796 && v19 != -50265850 )
        {
          ...
          if ( *(_BYTE *)(a1 + 32) < 6u
            ...
            && v19 != 131334 )
          {
            DeviceOid = ndisQueryDeviceOid(v26, v62, v19, (__int64)p_Src, v12 - v27);
            v29 = 0LL;
            v13 = DeviceOid;
            v18 = 0;
            if ( !DeviceOid )
...
LABEL_55:
          ...
          if ( v46 == (_BYTE)v29 )
          {
            ...
            v32 = ndisQueryDeviceOid(v59, v62, 131334, (__int64)v61, 152);
            v29 = 0LL;
            v13 = v32;
            if ( !v32 )
            {
...
LABEL_111:
      ...
      case 0xFFFFFFu:
        ...
        v54 = MEMORY[0xFFFFF78000000320] - *(_QWORD *)(a1 + 1592);
        p_Src = &v54;
        v54 = v54 * KeQueryTimeIncrement() / 10000000;
LABEL_16:
        v18 = 4;
LABEL_17:
        if ( v18 > v12 - v47 )
...
LABEL_24:
  *v60 = v48;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0x1Fu, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, a1, v13);
  return v13;
}
