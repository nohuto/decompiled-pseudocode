/*
 * XREFs of ndisSplitStatisticsOids @ 0x1C00AB57C
 * Callers:
...
__int64 __fastcall ndisSplitStatisticsOids(__int64 a1, int *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(0x15u, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, v3);
  ...
  *(_QWORD *)(a1 + 16) = PoolWithTag;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0x16u, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, v3, v7);
  return v7;
}
