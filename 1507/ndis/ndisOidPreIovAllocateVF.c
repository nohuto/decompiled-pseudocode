/*
 * XREFs of ndisOidPreIovAllocateVF @ 0x1C00D9F70
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovAllocateVF(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qqq(0x1Au, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, *a1, a1[3], v1);
  if ( v1[1] == 12 )
  {
    VF = 0;
    *((_DWORD *)a1 + 10) = 0;
...
LABEL_16:
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
  {
    v8 = *((_DWORD *)a1 + 10);
    LODWORD(v7) = VF;
    WPP_SF_qqDD(0x1Bu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, *a1, a1[3], v7, v8);
  }
  return VF;
}
