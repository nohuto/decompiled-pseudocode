/*
 * XREFs of ndisPreSetPMParameters @ 0x1C00AC91C
 * Callers:
...
unsigned __int8 __fastcall ndisPreSetPMParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x34u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, MiniportFromReqTracker, v1);
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_19:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qdD(0x35u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v7, *(_DWORD *)(a1 + 40), v2);
  return v2;
}
