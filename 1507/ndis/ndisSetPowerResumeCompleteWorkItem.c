/*
 * XREFs of ndisSetPowerResumeCompleteWorkItem @ 0x1C0068E90
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)((char *)v10 + 4) = 1LL;
  ...
  if ( v6 )
  {
    ...
    if ( (unsigned __int8)byte_1C0085316 >= 2u )
      WPP_SF_dq(0x1Eu, &WPP_a612080d527c97bcc88e648492c760b7_Traceguids, v6, v1);
  }
  else
  {
    ndisSelectiveSuspendResumeOperations(v1, 1);
    if ( (unsigned __int8)byte_1C0085310 >= 4u )
      WPP_SF_qZ(0x1Fu, &WPP_a612080d527c97bcc88e648492c760b7_Traceguids, v1, *(__int64 **)(v1 + 3912));
  }
