/*
 * XREFs of ndisQueueRestoreRequestsOnTop @ 0x1C00435B8
 * Callers:
 ...
 *     ndisFQueueOidRequest @ 0x1C0040270 (ndisFQueueOidRequest.c)
...
__int64 __fastcall ndisQueueRestoreRequestsOnTop(__int64 a1, __int64 **a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0x3Bu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a3);
...
LABEL_11:
  ...
  {
    v15 = ndisReferenceMiniport(a1, 0x45u);
  }
  if ( v15 )
  {
    v17 = (_LIST_ENTRY *)v14;
...
LABEL_49:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqd(60LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v9, a2, v10);
  return v10;
}
