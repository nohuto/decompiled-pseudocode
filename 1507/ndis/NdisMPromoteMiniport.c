/*
 * XREFs of NdisMPromoteMiniport @ 0x1C00586F0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMPromoteMiniport(NDIS_HANDLE MiniportHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x61u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, (__int64)MiniportHandle);
  ...
  *((_DWORD *)MiniportHandle + 464) = 727423;
  if ( v4
...
LABEL_16:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x62u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, (__int64)MiniportHandle);
