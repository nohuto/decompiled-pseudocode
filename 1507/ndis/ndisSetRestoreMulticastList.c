/*
 * XREFs of ndisSetRestoreMulticastList @ 0x1C00C869C
 * Callers:
...
void __fastcall ndisSetRestoreMulticastList(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x78u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2);
  v5 = v2;
  v6 = *v2;
...
LABEL_18:
  ...
  *(_DWORD *)(a2 + 48) = 6 * *((_DWORD *)v2 + 92);
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x79u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2);
}
