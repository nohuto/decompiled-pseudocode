/*
 * XREFs of ndisSriovInterfaceReadVfConfigBlock @ 0x1C00DC2B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVfConfigBlock(void *a1, __int16 a2, int a3, void *a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x58u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x59u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
