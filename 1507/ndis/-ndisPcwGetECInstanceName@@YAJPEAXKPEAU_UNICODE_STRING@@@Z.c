/*
 * XREFs of ?ndisPcwGetECInstanceName@@YAJPEAXKPEAU_UNICODE_STRING@@@Z @ 0x1C00E107C
 * Callers:
...
__int64 __fastcall ndisPcwGetECInstanceName(char *a1, unsigned int a2, struct _UNICODE_STRING *a3)
{
  char *v4; // rax
  __int64 result; // rax
  unsigned int v6; // ebx
  ...
  result = RtlStringCbPrintfW((wchar_t *)SourceString, 0x202uLL, L"PD EC %u - %wZ", a2, v4);
  v6 = result;
  if ( (int)result >= 0 )
  {
