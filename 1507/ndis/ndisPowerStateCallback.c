/*
 * XREFs of ndisPowerStateCallback @ 0x1C00B1F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPowerStateCallback(LPCGUID SettingGuid, int *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( Value && ValueLength >= 4 )
  {
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_d(0x3Du, &WPP_83ec3feda1c7d74e49c0301905f57f77_Traceguids, *Value);
    ...
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_d(0x3Eu, &WPP_83ec3feda1c7d74e49c0301905f57f77_Traceguids, *Value);
  }
  return 0LL;
}
