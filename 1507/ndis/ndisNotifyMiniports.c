/*
 * XREFs of ndisNotifyMiniports @ 0x1C00EAC48
 * Callers:
...
void __fastcall ndisNotifyMiniports(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, void *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qLq(0x3Fu, &WPP_83ec3feda1c7d74e49c0301905f57f77_Traceguids, (__int64)a1, 5);
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_q(0x40u, &WPP_83ec3feda1c7d74e49c0301905f57f77_Traceguids, (__int64)a1);
}
