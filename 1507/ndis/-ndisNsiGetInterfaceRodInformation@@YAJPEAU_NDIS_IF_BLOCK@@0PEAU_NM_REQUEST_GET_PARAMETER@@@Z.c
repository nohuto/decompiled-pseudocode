/*
 * XREFs of ?ndisNsiGetInterfaceRodInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0097EB0
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0x4Cu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, v5);
    v4 = v24;
    v7 = a2;
    v6 = a1;
  }
        ...
        if ( v9 || (unsigned int)v8 < 0xD8 || v7 )
        {
          switch ( v9 )
          {
            ...
            case 56:
              ...
              goto LABEL_12;
            case 64:
              if ( (unsigned __int64)v11 >= 0x90 && v6->bNdisIsProvider )
              {
                v15 = 144;
                v13 = 131334;
                v16 = 208;
...
LABEL_18:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqqL(0x4Du, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, v6, v7, v5, v3);
  return v3;
}
