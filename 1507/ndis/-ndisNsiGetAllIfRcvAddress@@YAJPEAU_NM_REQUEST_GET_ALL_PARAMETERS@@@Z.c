/*
 * XREFs of ?ndisNsiGetAllIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C003C4D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetAllIfRcvAddress(struct _NM_REQUEST_GET_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(0x5Eu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1);
...
LABEL_41:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(95LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, (unsigned int)IfRcvAddressRodInformation);
