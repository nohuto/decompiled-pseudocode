/*
 * XREFs of ndisOidPostIovCreateVPort @ 0x1C0065A80
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qq @ 0x1C0022860 (WPP_SF_qq.c)
 *     ndisIovAddVPortToPFList @ 0x1C00651D0 (ndisIovAddVPortToPFList.c)
 *     ndisIovAddVPortToVFList @ 0x1C006521C (ndisIovAddVPortToVFList.c)
 */
...
void __fastcall ndisOidPostIovCreateVPort(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x2Cu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 152);
    if ( *((_DWORD *)a1 + 10) )
...
LABEL_13:
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x2Du, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
}
