/*
 * XREFs of ndisOidPreIovReadVFConfigSpace @ 0x1C00DAEB0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovReadVFConfigSpace(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x38u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
    v4 = byte_1C0085321;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
...
LABEL_22:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x39u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v5, v11);
  }
  return v5;
}
