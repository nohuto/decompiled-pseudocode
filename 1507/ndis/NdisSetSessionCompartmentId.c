/*
 * XREFs of NdisSetSessionCompartmentId @ 0x1C00616A0
 * Callers:
 *     ndisNsiSetAllSessionInformation @ 0x1C00D8390 (ndisNsiSetAllSessionInformation.c)
 * Callees:
 ...
 *     ?ndisCmLazyInitializeCleanup@@YAXXZ @ 0x1C0061628 (-ndisCmLazyInitializeCleanup@@YAXXZ.c)
 */
...
__int64 __fastcall NdisSetSessionCompartmentId(unsigned int a1, unsigned int a2)
{
  ...
  PVOID v11; // r15
  struct _NDIS_IF_COMPARTMENT_BLOCK *v12; // [rsp+70h] [rbp+18h] BYREF
  ...
  {
    v12 = 0LL;
    ndisIfReferenceCompartmentForUser(0LL, a2, &v12);
    v5 = (unsigned int *)v12;
    if ( !v12 )
      return 3221225485LL;
  }
