/*
 * XREFs of ?ndisIfSetFilterIfInfoInRegistry@@YAHPEAU_NDIS_FILTER_BLOCK@@U_GUID@@@Z @ 0x1C00C5E48
 * Callers:
...
__int64 __fastcall ndisIfSetFilterIfInfoInRegistry(struct _NDIS_FILTER_BLOCK *a1, wchar_t *a2)
{
  ...
  *(_DWORD *)&Keyword.Length = 1835034;
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(0xC5u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(0xC6u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1, v5);
  return v5;
}
