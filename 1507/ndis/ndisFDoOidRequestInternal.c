/*
 * XREFs of ndisFDoOidRequestInternal @ 0x1C0006A40
 * Callers:
...
void __fastcall ndisFDoOidRequestInternal(KSPIN_LOCK *Parameter)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(47LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, Parameter);
  while ( 1 )
  {
    v2 = -1073741823;
    v3 = 0LL;
      ...
      *((_DWORD *)Parameter + 40) = 0;
      ...
      else
      {
        ...
        *((_DWORD *)Parameter + 40) = 0;
        ...
        v28 = 0LL;
        if ( (unsigned __int8)byte_1C0085312 >= 4u )
          WPP_SF_qLq(120LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Parameter, v17, v9);
        LOBYTE(v15) = 1;
        ...
        if ( !v18 )
        {
          ...
          {
            if ( (unsigned __int8)byte_1C0085312 >= 4u )
              WPP_SF_qqd(121LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, v9, v28, *((_DWORD *)v28 + 8));
            v22 = v20;
          }
          else
          {
        ...
        if ( (unsigned __int8)byte_1C0085312 >= 4u )
        {
          WPP_SF_qLqL(122LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Parameter, v17, v9, v21);
          v23 = byte_1C0085312;
        }
        if ( v21 != 259 )
        {
          ...
          if ( (unsigned __int8)v23 >= 4u )
          {
            ...
            WPP_SF_qqDD(49LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, Parameter, v9, v24, v21);
          }
          v26[4] = v9;
          v26[2] = Parameter;
          LODWORD(v26[5]) = v21;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(50LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, Parameter);
}
