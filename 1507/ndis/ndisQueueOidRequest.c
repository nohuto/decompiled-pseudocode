/*
 * XREFs of ndisQueueOidRequest @ 0x1C0005360
 * Callers:
...
__int64 __fastcall ndisQueueOidRequest(__int64 a1, unsigned __int8 *a2, __int64 a3, unsigned __int8 *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqqq(55LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2, a3, a4);
  v9 = 0;
  memset(v77, 0, sizeof(v77));
  v76[0] = 0;
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(228LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v7);
  v10 = *(_DWORD *)(v7 + 32);
...
LABEL_7:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(229LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v7);
  if ( v9 )
  {
    v14 = a2;
  }
...
LABEL_53:
    if ( (unsigned __int8)byte_1C008531B >= 4u )
      WPP_SF_qD(12LL, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, a2, *((unsigned int *)a2 + 1126));
    ...
    *((_DWORD *)a2 + 464) = 2297739;
    ...
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
    {
      WPP_SF_qq(21LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a2, a1);
      v40 = byte_1C0085312;
    }
    *(_QWORD *)v11 = 0LL;
    *((_QWORD *)v11 + 1) = 0LL;
...
LABEL_60:
    ...
    if ( (unsigned __int8)v40 >= 4u )
      WPP_SF_qqd(22LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a2, a1, v22);
    *((_QWORD *)a2 + 65) = 0LL;
    *((_DWORD *)a2 + 464) = 0;
...
LABEL_74:
    ...
    if ( v33 )
      v44 = 1;
    if ( (unsigned __int8)byte_1C008531B >= 4u )
      WPP_SF_qD(14LL, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, a2, *((unsigned int *)a2 + 1126));
...
LABEL_27:
  ...
  *((_DWORD *)a2 + 464) = 0;
  ...
  if ( !v22 )
  {
    if ( KeExpandKernelStackAndCalloutEx(ndisFDoOidRequestInternal, v8, 0x2000uLL, 0, 0LL) < 0 )
    {
...
LABEL_46:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqd(56LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v7, a2, v22);
  return v22;
}
