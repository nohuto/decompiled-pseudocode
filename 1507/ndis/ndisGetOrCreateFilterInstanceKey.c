/*
 * XREFs of ndisGetOrCreateFilterInstanceKey @ 0x1C00CF3E0
 * Callers:
        ...
        PUNICODE_STRING Destination)
{
  ...
  *(_DWORD *)&Sourcea.Length = 262146;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x61u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Source, a3, a2);
  if ( !*(_QWORD *)(v7 + 16) )
  {
    v8 = -1073741811;
    goto LABEL_20;
...
LABEL_40:
  ...
  for ( i = 0; i <= 0x270F; ++i )
  {
    ...
    v22 = RegistryValues;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_dd(0x62u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, RegistryValues, v32);
    if ( v22 )
      goto LABEL_61;
...
LABEL_24:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqqL(0x63u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, v6, v7, v41, ResultLength);
  }
  return v8;
}
