/*
 * XREFs of ndisGetMiniportInfo @ 0x1C00D1DE8
 * Callers:
...
__int64 __fastcall ndisGetMiniportInfo(__int64 a1, __int64 a2, _DWORD *a3, char *a4, _DWORD *a5)
{
  ...
  *(_DWORD *)&Keyword.Length = 1048590;
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_q(0x91u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
  *a5 = 1;
...
LABEL_28:
    ...
    if ( v22 )
    {
      if ( *(int *)(a1 + 464) < 20 )
      {
        if ( (unsigned __int8)byte_1C0085314 >= 3u )
          WPP_SF_(0x92u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids);
  ...
  if ( (unsigned int)v23 <= 0x13 && ndisMediaTypeCl[v23] || (_DWORD)v23 == 3 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0085314 >= 3u )
        WPP_SF_q(0x93u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        Template_jqxqqq(
          v24,
          &OidQueryFailed,
  ...
  if ( (*(_BYTE *)(a1 + 928) & 1) != 0 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0085314 >= 3u )
        WPP_SF_q(0x94u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        Template_jqxqqq(
          v26,
          &OidQueryFailed,
  ...
  if ( !v30 )
  {
    ...
    if ( v22 )
    {
      v5 = 1;
      if ( (unsigned __int8)byte_1C0085314 >= 3u )
        WPP_SF_q(0x95u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        Template_jqxqqq(
          v32,
          &OidQueryFailed,
    ...
    else
    {
      *(_WORD *)(a2 + 92) = 6;
      ...
      {
        if ( (unsigned __int8)byte_1C0085314 >= 3u )
          WPP_SF_q(0x96u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
          Template_jqxqqq(
            v34,
            &OidQueryFailed,
...
LABEL_77:
      ...
      {
        if ( (unsigned __int8)byte_1C0085314 >= 3u )
          WPP_SF_q(0x98u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
          Template_jqxqqq(
            v35,
            &OidQueryFailed,
...
LABEL_92:
  ...
  if ( v30 == 3 )
  {
    *(_WORD *)(a2 + 92) = 6;
    ...
    if ( (unsigned __int8)byte_1C0085314 >= 3u )
      WPP_SF_q(0x99u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
    if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
      Template_jqxqqq(
        v31,
        &OidQueryFailed,
...
LABEL_109:
  ...
  *v58 = v5;
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qD(0x9Au, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, v8);
  return v8;
}
