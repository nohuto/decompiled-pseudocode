/*
 * XREFs of ndisQueryWakeUpPatternList @ 0x1C0045580
 * Callers:
...
__int64 __fastcall ndisQueryWakeUpPatternList(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqq(0x2Eu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, a2, a1, a3);
  if ( !v5 )
    v5 = *(_QWORD *)(v6 + 16);
  ...
  *(_DWORD *)(v5 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqqL(0x2Fu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v5, v6, a3, v12);
  return v12;
}
