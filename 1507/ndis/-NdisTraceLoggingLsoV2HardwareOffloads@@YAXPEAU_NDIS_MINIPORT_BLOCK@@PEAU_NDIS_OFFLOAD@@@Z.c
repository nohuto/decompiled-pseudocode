/*
 * XREFs of ?NdisTraceLoggingLsoV2HardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0013120
 * Callers:
...
void __fastcall NdisTraceLoggingLsoV2HardwareOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v31 = 1LL;
      v33 = 1LL;
      TlgWrite(v2, &unk_1C007494E, v3, (LPCGUID)v4, 0xBu, &pData);
    }
  }
}
