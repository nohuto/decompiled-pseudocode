/*
 * XREFs of ?ndisNsiSetInterfaceInformation@@YAJPEAU_NM_REQUEST_SET_PARAMETER@@@Z @ 0x1C0010AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetInterfaceInformation(struct _NM_REQUEST_SET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(82LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1);
...
LABEL_12:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(83LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, v8);
  return v8;
}
