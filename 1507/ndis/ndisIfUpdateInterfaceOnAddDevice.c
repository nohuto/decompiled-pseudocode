/*
 * XREFs of ndisIfUpdateInterfaceOnAddDevice @ 0x1C001ACF0
 * Callers:
...
__int64 __fastcall ndisIfUpdateInterfaceOnAddDevice(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qq(178LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2);
  v6 = (_WORD *)(v5 + 8);
  if ( !*(_WORD *)(v5 + 8)
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqd(179LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, v5, v2, v3);
  return v3;
}
