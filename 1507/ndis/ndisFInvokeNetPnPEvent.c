/*
 * XREFs of ndisFInvokeNetPnPEvent @ 0x1C009B5DC
 * Callers:
...
__int64 __fastcall ndisFInvokeNetPnPEvent(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qD(0x81u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1, v4);
  v6 = (*(__int64 (__fastcall **)(_QWORD, __int64))(v2 + 280))(*(_QWORD *)(a1 + 24), a2);
  v7 = v6;
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
  {
    v9 = v6;
    WPP_SF_qdD(0x82u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1, v4, v9);
  }
  return v7;
}
