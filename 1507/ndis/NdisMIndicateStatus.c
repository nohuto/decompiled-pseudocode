/*
 * XREFs of NdisMIndicateStatus @ 0x1C0058440
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT StatusBufferSize)
{
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qD(0xA1u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, (__int64)MiniportHandle, GeneralStatus);
  ...
  if ( !*((_QWORD *)MiniportHandle + 3) )
  {
    ...
    *((_DWORD *)MiniportHandle + 464) = 732664;
...
LABEL_12:
  ...
  NewIrql[0] = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)MiniportHandle + 12);
  *((_QWORD *)MiniportHandle + 65) = KeGetCurrentThread();
  *((_DWORD *)MiniportHandle + 464) = 732738;
  if ( GeneralStatus == 1073807371 )
  {
...
LABEL_25:
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qD(0xA2u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, (__int64)MiniportHandle, GeneralStatus);
}
