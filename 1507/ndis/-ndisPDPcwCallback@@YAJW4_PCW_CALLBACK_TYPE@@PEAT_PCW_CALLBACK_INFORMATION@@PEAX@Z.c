/*
 * XREFs of ?ndisPDPcwCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C006CA70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPDPcwCallback(unsigned int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  KLockThisExclusive::KLockThisExclusive(
    (KLockThisExclusive *)&v18,
    (struct KPushLockBase *)(*(_QWORD *)&qword_1C0085808 + 8LL));
  v5 = *(_QWORD *)&qword_1C0085808;
  v6 = *(_QWORD *)&qword_1C0085808 + 16LL;
  v7 = *(_QWORD **)(*(_QWORD *)&qword_1C0085808 + 16LL);
  while ( 1 )
  {
    v16 = v7;
    if ( v7 == (_QWORD *)v6 )
