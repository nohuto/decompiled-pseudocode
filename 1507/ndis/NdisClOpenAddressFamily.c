/*
 * XREFs of NdisClOpenAddressFamily @ 0x1C00F2770
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    ...
    else
    {
      ...
      ndisReferenceMiniportNoCheck(v10, 0x4Fu);
      v31 = 1;
    }
    ...
    *(_QWORD *)(a1 + 1032) = *(_QWORD *)(a4 + 8);
    *(_QWORD *)(a1 + 1040) = *(_QWORD *)(a4 + 16);
    *(_QWORD *)(a1 + 1064) = *(_QWORD *)(a4 + 32);
    *(_QWORD *)(a1 + 1136) = ndisCoCompleteOidRequestToRequest;
...
LABEL_38:
  ...
  if ( v8 )
  {
    ...
    *(_QWORD *)(v10 + 520) = 0LL;
    *(_DWORD *)(v10 + 1856) = 0;
    KeReleaseSpinLock((PKSPIN_LOCK)(v10 + 96), v26);
  }
  if ( v7 && v30 )
  {
    ...
    *(_QWORD *)(v10 + 520) = 0LL;
    *(_DWORD *)(v10 + 1856) = 0;
    KeReleaseSpinLock((PKSPIN_LOCK)(v10 + 96), v28);
  }
  if ( v9 )
    ndisDereferenceMiniport(v10, 0x4Fu);
  NdisTraceLoggingDeprecationCandidate((const struct _TlgProvider_t *)6, v10, (const GUID *)v14, v24);
  return v14;
}
