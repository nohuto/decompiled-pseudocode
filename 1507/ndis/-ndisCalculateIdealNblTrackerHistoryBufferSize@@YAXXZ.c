/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C00D6DF0
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C0102140 (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0022840 (__security_check_cookie.c)
 *     memset @ 0x1C0023A40 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C010672C (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
