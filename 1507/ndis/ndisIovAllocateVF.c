/*
 * XREFs of ndisIovAllocateVF @ 0x1C00D9538
 * Callers:
...
char __fastcall ndisIovAllocateVF(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x1Cu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3);
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 32) + 60LL) = 0;
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x1Du, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, *(_DWORD *)(a1 + 40));
  return v4;
}
