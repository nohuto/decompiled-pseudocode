/*
 * XREFs of ?ReadNetworkInterfaceV2@BindRegistry@Ndis@@YAJAEBU_GUID@@AEAVKRegKey@@PEAT_NET_LUID_LH@@PEAU_NDIS_NSI_INTERFACE_PERSIST_RW@@@Z @ 0x1C009C998
 * Callers:
...
LABEL_19:
  ...
  *((_DWORD *)&a4[134].Info + 1) = v12;
  ...
  if ( (int)KRegKey::QueryValueUlong(a2, L"Characteristics", &v23) >= 0 && (v23 & 4) != 0 )
