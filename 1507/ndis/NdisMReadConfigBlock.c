/*
 * XREFs of NdisMReadConfigBlock @ 0x1C00D93C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMReadConfigBlock(_QWORD *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x7Au, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1);
  ...
  if ( v8 && (v9 = a1[616]) != 0 && (v10 = a1[584]) != 0 && (*(_BYTE *)(v10 + 8) & 5) == 5 )
    ...
    v11 = -1073741637;
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x7Bu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1);
  return v11;
}
