/*
 * XREFs of ndisMValidatePMWakeReason @ 0x1C0044AA8
 * Callers:
...
char __fastcall ndisMValidatePMWakeReason(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 4528) = *(_DWORD *)(v5 + 8);
  ...
  if ( (unsigned __int8)byte_1C0085310 >= 4u )
    WPP_SF_LqZ(0x82u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, *(_DWORD *)(v5 + 8), a1, *(_QWORD *)(a1 + 3912));
  if ( *(_BYTE *)v5 != 0x80
    || *(_BYTE *)(v5 + 1) != 1
    ...
    || v10 + (int)v9 > (unsigned int)v8 )
  {
    ...
    v13 = 132;
LABEL_33:
    WPP_SF_q(v13, &WPP_fbb1998797815902974a7c4233493709_Traceguids, a1);
    return 0;
  }
  v11 = *(_DWORD *)(v5 + 8);
  if ( v11 == 1 )
