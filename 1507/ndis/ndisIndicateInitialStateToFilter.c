/*
 * XREFs of ndisIndicateInitialStateToFilter @ 0x1C0016828
 * Callers:
...
void __fastcall ndisIndicateInitialStateToFilter(__int64 a1)
{
  ...
  __int128 v11; // xmm1
  _OWORD *v12; // rcx
  void (__fastcall *v13)(__int64, struct _NET_BUFFER_LIST *, int, unsigned int, int); // rax
  ...
  KIRQL v21; // dl
  KSPIN_LOCK *v22; // rcx
  void (__fastcall *v23)(__int64, struct _NET_BUFFER_LIST *, int, unsigned int, int); // rax
  KIRQL v24; // dl
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(73LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
  ...
  *(_DWORD *)(a1 + 56) |= 0x2000u;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(v4 + 152) = KeGetCurrentThread();
    for ( *(_DWORD *)(v4 + 160) = 2102866; (*(_DWORD *)(v4 + 56) & 0x2000) != 0; *(_DWORD *)(v4 + 160) = 2102866 )
    {
      v15 = NewIrql[0];
      *(_QWORD *)(v4 + 152) = 0LL;
      *(_DWORD *)(v4 + 160) = 0;
    ...
    *(_DWORD *)(v4 + 160) = 0;
    ...
    v23 = (void (__fastcall *)(__int64, struct _NET_BUFFER_LIST *, int, unsigned int, int))&ndisFakeFilterReceiveHandler;
    if ( *(_DWORD *)(v4 + 344) == 1 )
  ...
  else
  {
    ...
    v28[2] = *(_QWORD *)(v2 + 792);
    v28[3] = *(_QWORD *)(v2 + 800);
    v13 = (void (__fastcall *)(__int64, struct _NET_BUFFER_LIST *, int, unsigned int, int))&ndisFakeFilterReceiveHandler;
    if ( *(_DWORD *)(v2 + 480) == 1 )
  ...
  *(_DWORD *)(a1 + 160) = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(74LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
}
