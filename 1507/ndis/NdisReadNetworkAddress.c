/*
 * XREFs of NdisReadNetworkAddress @ 0x1C00AA630
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_HANDLE ConfigurationHandle)
{
  ...
  if ( (unsigned __int8)byte_1C008530F >= 4u )
    WPP_SF_q(0x19u, &WPP_b8a967438bdde46f34f27b2375f98c29_Traceguids, (__int64)ConfigurationHandle);
  *Status = -1073741823;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C008530F >= 4u )
    WPP_SF_q(0x1Au, &WPP_b8a967438bdde46f34f27b2375f98c29_Traceguids, (__int64)ConfigurationHandle);
}
