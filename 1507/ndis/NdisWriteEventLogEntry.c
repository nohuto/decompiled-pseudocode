/*
 * XREFs of NdisWriteEventLogEntry @ 0x1C0056300
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Data)
{
  ...
  {
    WPP_SF_qdD(0x2Eu, &WPP_0009299248ba37495192320194ebfcad_Traceguids, (__int64)LogHandle, EventCode, UniqueEventValue);
    v12 = LogHandle;
  }
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_(0x2Fu, &WPP_0009299248ba37495192320194ebfcad_Traceguids);
  return v7;
}
