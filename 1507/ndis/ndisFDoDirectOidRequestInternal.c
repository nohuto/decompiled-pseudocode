/*
 * XREFs of ndisFDoDirectOidRequestInternal @ 0x1C0040150
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisFDoDirectOidRequestInternal(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x33u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v3);
...
LABEL_8:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x34u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v3);
  *(_DWORD *)a1 = v7;
}
