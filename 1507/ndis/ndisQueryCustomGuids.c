/*
 * XREFs of ndisQueryCustomGuids @ 0x1C00AB38C
 * Callers:
...
__int64 __fastcall ndisQueryCustomGuids(__int64 a1, struct _NDIS_OID_REQUEST *a2, _QWORD *a3, unsigned __int16 *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085319 >= 4u )
    WPP_SF_q(0xDu, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
  *v5 = 0LL;
  *a4 = 0;
  memset(a2, 0, 0xF8uLL);
      ...
      if ( MethodId / 0x1Cu )
      {
        ...
        if ( !PoolWithTag )
        {
          if ( (unsigned __int8)byte_1C0085319 >= 2u )
            WPP_SF_q(0xFu, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
          v10 = -1073741670;
          goto LABEL_7;
        }
        ...
        {
          if ( (unsigned __int8)byte_1C0085319 >= 2u )
            WPP_SF_q(0x10u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
        }
        else
        {
...
LABEL_25:
  ...
  if ( (unsigned __int8)byte_1C0085319 >= 4u )
    WPP_SF_q(0xEu, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
  v10 = -1073741637;
LABEL_7:
  if ( (unsigned __int8)byte_1C0085319 >= 4u )
    WPP_SF_qD(0x11u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1, v10);
