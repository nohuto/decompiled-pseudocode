/*
 * XREFs of ndisOidPreSetPortAuthentication @ 0x1C0042B00
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreSetPortAuthentication(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0xB9u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, *(_DWORD *)(v2 + 8));
  if ( *(_QWORD *)a1 )
  {
    if ( (*(_DWORD *)(v2 + 4) & 0xFFFFFFFD) != 0 )
    {
      if ( *(_DWORD *)(v2 + 48) >= 0x14u )
      {
        ...
        *(_DWORD *)(v1 + 3380) = v5[4];
        ...
        v15 = *(_QWORD *)(v1 + 792);
        v16 = *(_QWORD *)(v1 + 800);
        v17 = *(_DWORD *)(*(_QWORD *)(v1 + 4096) + 532LL);
        v18 = *(_DWORD *)(v1 + 3368);
        v19 = *(_DWORD *)(v1 + 3372);
        v20 = *(_DWORD *)(v1 + 3376);
        v21 = *(_DWORD *)(v1 + 3380);
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0xBAu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, *(_DWORD *)(v2 + 8));
  return v3;
}
