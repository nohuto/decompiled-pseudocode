/*
 * XREFs of ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C0054DF4
 * Callers:
 *     NdisReleaseReadWriteLock @ 0x1C000D6B0 (NdisReleaseReadWriteLock.c)
 *     ndisReleaseReadWriteLockX @ 0x1C0055ABC (ndisReleaseReadWriteLockX.c)
 * Callees:
 *     <none>
 */
