/*
 * XREFs of ?ndisNsiGetIfRcvAddressRodInformation@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_IF_RCV_ADDRESS@@PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00C610C
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0xA5u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, a3);
    v7 = byte_1C008531D;
  }
  v8 = *((_DWORD *)v3 + 13);
  v9 = *((_DWORD *)v3 + 12);
...
LABEL_21:
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qqqL(0xA6u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, v5, a2, v3, v6);
  return v6;
}
