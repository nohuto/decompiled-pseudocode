/*
 * XREFs of ndisVerifierAllocateMemoryWithTag @ 0x1C00600C0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00236D0 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0023A40 (memset.c)
 *     ndisVerifierInjectResourceFailure @ 0x1C0060388 (ndisVerifierInjectResourceFailure.c)
 */
  ...
  if ( v10 && (ndisFlags & 0x400) != 0 )
  {
    *a1 = (_LIST_ENTRY *)((char *)v10 + 40);
    ...
    if ( ndisMiniportTrackAlloc )
    {
      ...
      if ( Flink->Blink != &ndisMiniportTrackAllocList )
        __fastfail(3u);
      Flink->Blink = v10;
    ...
    else
    {
      ...
      if ( v13->Blink != &ndisDriverTrackAllocList )
        __fastfail(3u);
      v13->Blink = v10;
