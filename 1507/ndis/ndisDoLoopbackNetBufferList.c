/*
 * XREFs of ndisDoLoopbackNetBufferList @ 0x1C004EAB0
 * Callers:
...
void __fastcall ndisDoLoopbackNetBufferList(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqq(0x40u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2, a3);
...
LABEL_37:
      ...
      NetBufferAndNetBufferList = NdisAllocateNetBufferAndNetBufferList(ndisNetBufferListPool, 0, 0, v13, 0, DataLength);
      ...
      if ( NetBufferAndNetBufferList )
      {
        ...
        if ( v19 )
        {
          ...
          if ( v21 )
          {
            ...
            v17->NetBufferListInfo[5] = *(void **)(a3 + 120);
            if ( (a5 & 2) != 0 )
              v17->Flags |= 0x200u;
...
LABEL_38:
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqq(0x41u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2, v5);
}
