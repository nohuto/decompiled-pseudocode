/*
 * XREFs of ?ndisPcwAddCounter@@YAJW4_NDIS_COUNTER_SET_ID@@PEAU_PCW_COUNTER_INFORMATION@@@Z @ 0x1C00D8478
 * Callers:
...
__int64 __fastcall ndisPcwAddCounter(unsigned int a1, __int64 a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    else
    {
      ...
      *((_DWORD *)v6 + 2) = a1;
      v6[2] = *(_QWORD *)a2;
      KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v9, (struct KPushLockBase *)&ndisPcwMutex);
