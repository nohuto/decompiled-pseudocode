/*
 * XREFs of ndisIovFreeVF @ 0x1C006556C
 * Callers:
 *     ndisOidPostIovFreeVF @ 0x1C0065CE0 (ndisOidPostIovFreeVF.c)
 * Callees:
...
__int64 __fastcall ndisIovFreeVF(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x22u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, 0LL, P);
  if ( *((_DWORD *)v2 + 19) )
  {
    v1 = -1073741811;
  }
  ...
  {
    v14 = v1;
    WPP_SF_qqd(0x23u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v2, v14);
  }
  return v1;
}
