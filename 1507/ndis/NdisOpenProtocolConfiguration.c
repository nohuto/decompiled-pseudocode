/*
 * XREFs of NdisOpenProtocolConfiguration @ 0x1C00A5040
 * Callers:
...
void __fastcall NdisOpenProtocolConfiguration(NTSTATUS *a1, _QWORD *a2, unsigned __int16 *a3)
{
  SIZE_T v6; // rbx
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_Z(0x28u, &WPP_0009299248ba37495192320194ebfcad_Traceguids, (__int64 *)a3);
  v6 = (unsigned int)a3[1] + 178;
  ...
  *a1 = PoolWithTag == 0LL ? 0xC000009A : 0;
  ...
  else
  {
    ...
    memmove(v8 + 176, *((const void **)a3 + 1), *a3);
    *((_QWORD *)v8 + 3) = 0LL;
    *((_QWORD *)v8 + 2) = v8 + 40;
    v8[40] = 10;
    ...
    *a1 = v9;
    if ( v9 >= 0 )
    {
      ...
      ObjectAttributes.Attributes = 576;
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ObjectAttributes.ObjectName = (PUNICODE_STRING)a3;
  ...
  if ( KeyHandle )
    ZwClose(KeyHandle);
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_(0x29u, &WPP_0009299248ba37495192320194ebfcad_Traceguids);
}
