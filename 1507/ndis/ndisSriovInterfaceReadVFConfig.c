/*
 * XREFs of ndisSriovInterfaceReadVFConfig @ 0x1C00DC110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVFConfig(void *a1, void *a2, __int16 a3, int a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x54u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x55u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
