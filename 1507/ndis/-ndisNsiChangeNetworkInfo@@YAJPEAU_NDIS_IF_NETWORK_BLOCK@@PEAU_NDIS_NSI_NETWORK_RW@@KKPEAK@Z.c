/*
 * XREFs of ?ndisNsiChangeNetworkInfo@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@PEAU_NDIS_NSI_NETWORK_RW@@KKPEAK@Z @ 0x1C003BAD8
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qq(0x74u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2);
  v10 = a3;
  v33 = a3;
  v11 = a4;
  v12 = -1073741811;
...
LABEL_11:
  ...
  *a5 = v16;
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqd(117LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, v9);
  return v9;
}
