/*
 * XREFs of ndisOidPostRcvFilterAllocateQueue @ 0x1C00382B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostRcvFilterAllocateQueue(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x10u, &WPP_63298f27d84d406e2a9901f9d2228ddf_Traceguids, v3, v1);
  if ( v3 )
  {
    if ( *(_DWORD *)(a1 + 40) )
    {
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(17LL, &WPP_63298f27d84d406e2a9901f9d2228ddf_Traceguids, v3, *(unsigned int *)(a1 + 40));
}
