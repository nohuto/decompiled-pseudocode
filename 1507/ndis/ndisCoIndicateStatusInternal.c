/*
 * XREFs of ndisCoIndicateStatusInternal @ 0x1C00F97F0
 * Callers:
...
void __fastcall ndisCoIndicateStatusInternal(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C008531A >= 4u )
    WPP_SF_(0x3Cu, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids);
  v9 = a2 + 296;
  if ( !a2 )
    v9 = *(_QWORD *)(a1 + 3912);
  if ( v9 )
...
LABEL_12:
          ...
          if ( *(_BYTE *)(v21 + 56) >= 6u && *(_QWORD *)(v21 + 192) )
            ...
            (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, int *, int))(v21 + 192))(
              *(_QWORD *)(i + 32),
              ...
              Src,
              v7);
          ndisMDereferenceOpenUnlocked(i);
        }
      }
  ...
  if ( (unsigned __int8)byte_1C008531A >= 4u )
    WPP_SF_(0x3Du, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids);
}
