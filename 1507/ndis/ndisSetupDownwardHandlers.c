/*
 * XREFs of ndisSetupDownwardHandlers @ 0x1C0017EA8
 * Callers:
        ...
        __int64 a1))(NDIS_HANDLE NdisAdapterHandle, ULONG Length, PVOID VirtualAddress, NDIS_PHYSICAL_ADDRESS PhysicalAddress)
{
  ...
  {
    WPP_SF_q(67LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
    v3 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  if ( *(_BYTE *)(a1 + 32) < 6u )
  {
  ...
  v4 = (_QWORD *)v1[15];
  v1[70] = *(_QWORD *)(a1 + 2432);
  v1[71] = *(_QWORD *)(a1 + 2312);
  v1[54] = *(_QWORD *)(a1 + 2472);
  v1[55] = *(_QWORD *)(a1 + 2376);
  v1[56] = *(_QWORD *)(a1 + 4136);
  v1[57] = a1;
  v1[66] = *(_QWORD *)(a1 + 2464);
  v1[67] = *(_QWORD *)(a1 + 2352);
  v1[68] = *(_QWORD *)(a1 + 2360);
  v1[69] = *(_QWORD *)(a1 + 2368);
  v1[52] = *(_QWORD *)(a1 + 2424);
  v1[105] = *(_QWORD *)(a1 + 2480);
  while ( v4 )
  {
    v5 = (_QWORD *)v4[14];
    v6 = v5[75];
  ...
  *(_QWORD *)(a1 + 2496) = v12;
  ...
  if ( v13 )
  {
    ...
    *(_QWORD *)(a1 + 2568) = v10[99];
    *(_QWORD *)(a1 + 2576) = v10;
  }
  else
  {
    *(_QWORD *)(a1 + 2656) = v10[54];
    *(_QWORD *)(a1 + 2560) = v10[55];
    *(_QWORD *)(a1 + 2568) = v10[56];
    *(_QWORD *)(a1 + 2576) = v10[57];
  }
  v14 = v10[77];
  if ( v14 )
  {
    ...
    *(_QWORD *)(a1 + 2544) = v10[99];
    *(_QWORD *)(a1 + 2552) = v10;
  }
  else
  {
    *(_QWORD *)(a1 + 2648) = v10[66];
    *(_QWORD *)(a1 + 2536) = v10[67];
    *(_QWORD *)(a1 + 2544) = v10[68];
    *(_QWORD *)(a1 + 2552) = v10[69];
  }
  if ( *(_QWORD *)(v10[2] + 248LL) )
    *(_QWORD *)(a1 + 2608) = v10;
  else
    *(_QWORD *)(a1 + 2608) = v10[52];
  if ( *(_QWORD *)(v10[2] + 296LL) )
    *(_QWORD *)(a1 + 2664) = v10;
  else
    *(_QWORD *)(a1 + 2664) = v10[105];
