/*
 * XREFs of ?NdisTraceLoggingMiniportWakeBufferTooLarge@@YAXPEAU_NDIS_MINIPORT_BLOCK@@K@Z @ 0x1C006E6A4
 * Callers:
...
void __fastcall NdisTraceLoggingMiniportWakeBufferTooLarge(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v4 = (int)v3;
      v10 = 4;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C0074851, v2, v3, 4u, &pData);
    }
  }
}
