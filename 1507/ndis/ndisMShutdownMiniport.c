/*
 * XREFs of ndisMShutdownMiniport @ 0x1C00F4FCC
 * Callers:
...
__int64 __fastcall ndisMShutdownMiniport(__int64 a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x70u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a1);
  ...
  if ( (*(_DWORD *)(a1 + 124) & 0x4004) == 0 && (unsigned int)(*(_DWORD *)(a1 + 3924) - 2) > 2 )
  {
    ...
    *(_DWORD *)(a1 + 124) |= 0x800000u;
    if ( (unsigned __int8)byte_1C0085310 >= 4u )
      WPP_SF_qZ(0x71u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a1, *(__int64 **)(a1 + 3912));
  }
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x72u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a1);
  return 0LL;
}
