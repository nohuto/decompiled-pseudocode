/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C006EF38
 * Callers:
  ...
  if ( v4 == 1 )
  {
    ...
    if ( a4 )
    {
      if ( (unsigned int)dword_1C0084040 > 5 )
      {
        ...
        v20 = 2LL;
        v22[1] = 0;
        TlgWrite(v12, &unk_1C0074EC0, (LPCGUID)a3, (LPCGUID)a4, 8u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAny);
      }
    }
