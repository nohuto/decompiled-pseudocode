/*
 * XREFs of ?NdisPDPIAllocateQueue@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@@Z @ 0x1C00DF010
 * Callers:
 *     <none>
 * Callees:
...
{
  struct NDIS_PD_QUEUE_TRACKER *v6; // r14
  ...
  *a3 = 0LL;
    ...
    && (*((_DWORD *)a2 + 1) & 0xFFFFFFFE) == 0 )
  {
    ...
    if ( v9 == 1 )
    {
      ...
      {
LABEL_20:
        PoolWithTag = (NDIS_PD_QUEUE_TRACKER *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x100uLL, 0x7441444Eu);
        if ( PoolWithTag )
...
LABEL_33:
  ...
  {
    LODWORD(v15) = v8;
    WPP_SF_qqd(0x23u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, *a3, v15);
  }
