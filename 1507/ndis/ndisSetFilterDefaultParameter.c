/*
 * XREFs of ndisSetFilterDefaultParameter @ 0x1C00CFDE8
 * Callers:
...
__int64 __fastcall ndisSetFilterDefaultParameter(__int64 a1, const WCHAR *a2, __int64 a3, unsigned __int8 a4)
{
  ...
  *(_DWORD *)&String2.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x5Eu, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1, a2, a3);
  if ( a4 )
  {
    v8 = 256;
    v7 = 0x1000000;
  ...
  v13 = RegistryValues;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_dd(0x5Fu, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, RegistryValues, a4);
  if ( v13 )
  {
    v6 = -1073741823;
  }
    ...
    if ( !Value )
    {
      ...
      if ( !DestinationString.Buffer )
      {
        if ( !String2.Buffer )
          goto LABEL_19;
        v15 = 0;
        while ( RtlCompareUnicodeString((PCUNICODE_STRING)((char *)&unk_1C00763A0 + 24 * v15), &String2, 1u) )
        {
          if ( ++v15 >= 6 )
            goto LABEL_19;
        }
        v16 = (const WCHAR *)qword_1C00B4E40;
        if ( (unsigned int)(*((_DWORD *)&unk_1C00763A0 + 6 * v15 + 4) - 4) > 1 )
LABEL_19:
          v16 = L"0";
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqqL(0x60u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1, v11, a3, ValueLength);
  }
  return v6;
}
