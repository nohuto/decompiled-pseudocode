/*
 * XREFs of ndisOidPreIovWriteVFConfigBlock @ 0x1C00DB850
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovWriteVFConfigBlock(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x3Eu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
    v4 = byte_1C0085321;
  }
  v5 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
...
LABEL_16:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x3Fu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v5, v11);
  }
  return v5;
}
