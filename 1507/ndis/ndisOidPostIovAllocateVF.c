/*
 * XREFs of ndisOidPostIovAllocateVF @ 0x1C0065860
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovAllocateVF(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x1Eu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 144);
    if ( *((_DWORD *)a1 + 10) )
...
LABEL_14:
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
}
