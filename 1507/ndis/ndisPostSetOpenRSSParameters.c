/*
 * XREFs of ndisPostSetOpenRSSParameters @ 0x1C001FBE4
 * Callers:
...
void __fastcall ndisPostSetOpenRSSParameters(_QWORD *a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_qqd(156LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2, a3);
    a3 = v20;
  }
  v6 = 0;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqqL(157LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v3, a1, a2, a3);
}
