/*
 * XREFs of ndisRegisterMiniportDriver @ 0x1C00F4828
 * Callers:
...
__int64 __fastcall ndisRegisterMiniportDriver(struct _DRIVER_OBJECT **a1, _QWORD *a2, unsigned int a3, PVOID *a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xEu, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)a1);
  if ( !a1 )
  {
    v4 = -1073741823;
    goto LABEL_36;
...
LABEL_15:
  ...
  else if ( IoAllocateDriverObjectExtension(*a1, (PVOID)0x4E4D4944, 0x4E8u, &DriverObjectExtension) >= 0 )
  {
    memset(DriverObjectExtension, 0, 0x4E8uLL);
    ...
    *((_WORD *)DriverObjectExtension + 1) = 1256;
...
LABEL_36:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xFu, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)DriverObjectExtension);
  return v4;
}
