/*
 * XREFs of ?ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C00E0FE4
 * Callers:
...
__int64 __fastcall ndisPDSetBufferManagerHandlers(_QWORD *a1, const struct _NDIS_DRIVER_OPTIONAL_HANDLERS *a2)
{
  ...
  if ( *(_BYTE *)a1 == 2 )
  {
    ...
    {
      a1[151] = v3;
      a1[152] = *(_QWORD *)&a2[4].Header.Type;
      a1[153] = *(_QWORD *)&a2[6].Header.Type;
      a1[154] = *(_QWORD *)&a2[8].Header.Type;
      a1[155] = *(_QWORD *)&a2[10].Header.Type;
      a1[156] = *(_QWORD *)&a2[12].Header.Type;
    }
    else
    {
