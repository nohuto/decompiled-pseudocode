/*
 * XREFs of NdisImmediateWritePciSlotInformation @ 0x1C00F4DD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisImmediateWritePciSlotInformation(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, int a5)
{
  ...
  if ( (unsigned __int8)byte_1C008530E >= 4u )
    WPP_SF_q(0x10u, &WPP_6d008e340352ce512a7732a5bb09c858_Traceguids, v5);
  SetBusConfigSpace = ndisGetSetBusConfigSpace(v5, a3, a4, a5, 0, 0);
  if ( (unsigned __int8)byte_1C008530E >= 4u )
    WPP_SF_q(0x11u, &WPP_6d008e340352ce512a7732a5bb09c858_Traceguids, v5);
