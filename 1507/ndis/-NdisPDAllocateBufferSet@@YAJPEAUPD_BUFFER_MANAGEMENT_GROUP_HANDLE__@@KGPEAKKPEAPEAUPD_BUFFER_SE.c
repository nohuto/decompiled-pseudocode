/*
 * XREFs of ?NdisPDAllocateBufferSet@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KGPEAKKPEAPEAUPD_BUFFER_SET_HANDLE__@@@Z @ 0x1C00DE1D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z @ 0x1C00E0F28 (-ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z.c)
 */
        ...
        struct PD_BUFFER_SET_HANDLE__ **a6)
{
  ...
  KLockHolder v36; // [rsp+58h] [rbp-60h] BYREF
...
LABEL_5:
  ...
  v41 = *(struct PD_BUFFER_SET_HANDLE__ ***)(*(_QWORD *)(v10 + 5504) + 72LL);
...
LABEL_24:
    ...
    *v34 = v21;
    ...
    {
      v32[0] = v33;
      WPP_SF_qqqL(0x50u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, v35, v21, *(_QWORD *)v32);
    }
  }
  while ( v26 < v6 );
  v17 = 0;
  v18 = (int *)a4;
  v29 = (struct KPushLockBase *)(*(_QWORD *)&qword_1C0085808 + 8LL);
  *a4 = v26;
  *a6 = (struct PD_BUFFER_SET_HANDLE__ *)v11;
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v36, v29);
