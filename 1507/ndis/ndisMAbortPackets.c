/*
 * XREFs of ndisMAbortPackets @ 0x1C000F564
 * Callers:
...
__int64 **__fastcall ndisMAbortPackets(__int64 a1, __int64 a2, struct _NDIS_STACK_RESERVED *a3)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qq(64LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, 0LL);
  v4 = *(_QWORD **)(a1 + 832);
  if ( v4 )
  {
    *(_QWORD *)(a1 + 832) = *v4;
  ...
  *(_QWORD *)(a1 + 144) = 0LL;
  while ( 1 )
  {
    ...
    *(_DWORD *)(a1 + 1856) = 726010;
  }
  *(_DWORD *)(a1 + 120) |= 0x400000u;
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    return (__int64 **)WPP_SF_qq(65LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, 0LL);
  return result;
}
