/*
 * XREFs of ndisMPowerPolicy @ 0x1C00E6244
 * Callers:
 ...
 *     ndisGetTimeInterval @ 0x1C000F35C (ndisGetTimeInterval.c)
...
__int64 __fastcall ndisMPowerPolicy(__int64 a1, int a2, int a3, int *a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_qD(0x73u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a1, a2);
  if ( (_DWORD)v7 == 6 )
  {
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_q(0x74u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
  ...
  {
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_q(0x76u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
    if ( (int)Microsoft_Windows_NDISEnableBits < 0 )
      Template_jqxq(
        a1,
        &PowerWakeUpDevice,
  ...
  {
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_q(0x78u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
    ...
    if ( a3 == 6 )
    {
      if ( (_DWORD)v7 == 5 )
      {
        ...
        *a4 = 4;
        ...
        v13 = 123;
LABEL_135:
        WPP_SF_q(v13, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
        return 0LL;
      }
    }
    ...
    {
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_qD(0x7Du, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, 0);
      if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
        Template_jqxq(
          a1,
          &PowerWakeNotEnabled,
    ...
    {
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_q(0x7Eu, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
      if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
        Template_jqxq(
          a1,
    ...
    {
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_q(0x7Fu, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
      if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
        Template_jqxq(
          a1,
    ...
    if ( (int)v7 > *(_DWORD *)(v10 + 1268) || v14 > v5 || !v14 )
    {
      if ( (unsigned __int8)byte_1C0085315 >= 2u )
        WPP_SF_q(0x80u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
...
LABEL_118:
        *a4 = 4;
        ...
        {
          LODWORD(v22) = 4;
          WPP_SF_qdD(0x87u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, v7, v22);
        }
        if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
          Template_jqxqq(
            a1,
        ...
        v20 = 136;
LABEL_103:
        WPP_SF_q(v20, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
        return v6;
      }
LABEL_111:
      v21 = *(_DWORD *)(v10 + 124);
      if ( (v21 & 1) != 0 && (v21 & 0x40) == 0 )
      {
        ...
        if ( (unsigned __int8)byte_1C0085315 >= 4u )
          WPP_SF_q(0x86u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
        if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
          Template_jqxq(
            a1,
            &PowerDisableWakeup,
...
LABEL_80:
      if ( v14 > v9 )
      {
        v6 = -1073741823;
        if ( (unsigned __int8)byte_1C0085315 >= 2u )
          WPP_SF_qD(0x82u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, v7);
        if ( (Microsoft_Windows_NDISEnableBits & 0x400000) != 0 )
          Template_jqxq(
            a1,
            &PowerPolicyError,
...
LABEL_85:
    v6 = -1073741823;
    if ( (unsigned __int8)byte_1C0085315 >= 2u )
      WPP_SF_qD(0x81u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, v7);
    if ( (Microsoft_Windows_NDISEnableBits & 0x400000) != 0 )
      Template_jqxq(
        a1,
        &PowerPolicyError,
...
LABEL_89:
    if ( !a5 )
    {
      ...
      *(_QWORD *)&v25[4] = 1LL;
      ...
      {
        if ( (unsigned __int8)byte_1C0085315 >= 2u )
          WPP_SF_qD(0x83u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, *(int *)&v26[4]);
        if ( (Microsoft_Windows_NDISEnableBits & 0x400000) != 0 )
          Template_jqxq(
            a1,
            &PowerPolicyError,
    ...
    *a4 = v9;
    ...
    {
      LODWORD(v22) = v9;
      WPP_SF_qdD(0x84u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, v7, v22);
    }
    if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
      Template_jqxqq(
        a1,
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_q(0x7Au, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10);
  return 2147483663LL;
}
