/*
 * XREFs of ndisRejectUnsupportedPMOffloads @ 0x1C00CB25C
 * Callers:
...
LABEL_2:
  ...
  for ( i = *((_QWORD *)MiniportAdapterHandle + 122); i; i = *v3 )
  {
    if ( !ndisIsPMProtocolOffloadSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      v6 = *((_DWORD *)v3 + 11);
      if ( !v5 )
        return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 4008), 0, 1, 0);
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0085315 >= 2u )
          WPP_SF_d(0x7Au, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0085315 >= 2u )
          WPP_SF_d(0x7Bu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 4008), 0, 1, 0);
    }
  }
