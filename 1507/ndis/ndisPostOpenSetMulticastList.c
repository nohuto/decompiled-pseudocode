/*
 * XREFs of ndisPostOpenSetMulticastList @ 0x1C001B3D8
 * Callers:
...
__int64 __fastcall ndisPostOpenSetMulticastList(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_qqqL(124LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v3, a1, a2, a3);
    v8 = byte_1C0085312;
  }
  if ( *(_DWORD *)(a2 + 160) )
  {
  ...
  if ( (unsigned __int8)v8 >= 4u )
    return WPP_SF_qqqL(125LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v3, a1, a2, a3);
  return result;
}
