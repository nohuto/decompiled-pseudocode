/*
 * XREFs of ?ndisIfCreateNetworkBlock@@YAJPEAU_NDIS_IF_COMPARTMENT_BLOCK@@PEAU_GUID@@PEAU_NDIS_NSI_NETWORK_RW@@PEAPEAU_NDIS_IF_NETWORK_BLOCK@@@Z @ 0x1C001287C
 * Callers:
        ...
        _LIST_ENTRY ***a4)
{
  ...
  int v25; // eax
  _LIST_ENTRY *j; // rcx
  $013671E5920392F7B68C675C97F9F7D8 v27; // eax

  v8 = 0;
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qq(124LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2);
...
LABEL_40:
  ...
  if ( (*(_DWORD *)&v17 & 0xFFFFFFF) != 0xFFFFFFE )
  {
    while ( 2 )
    {
      for ( j = ndisIfNetworkList.Flink; ; j = j->Flink )
      {
        ...
        {
          v27 = ($013671E5920392F7B68C675C97F9F7D8)((v19 ^ *(_DWORD *)&v17) & 0xFFFFFFF ^ *(_DWORD *)&v17);
          goto LABEL_37;
        }
  ...
  v19 = 0xFFFFFFF;
  v27 = ($013671E5920392F7B68C675C97F9F7D8)(*(_DWORD *)&v17 & 0xF0000000 | 0xFFFFFFE);
LABEL_37:
  ndisIfSiteScopeId.0 = v27;
LABEL_14:
  *((_DWORD *)v10 + 22) = v19;
  if ( v19 == 0xFFFFFFF )
  {
...
LABEL_15:
  ...
  *v10 = Blink->Flink;
  ...
  v22 = (_LIST_ENTRY *)(v10 + 2);
  v23 = a1->NetworkLink.Flink;
  v10[2] = v23;
  v10[3] = &a1->NetworkLink;
  if ( v23->Blink != &a1->NetworkLink )
    __fastfail(3u);
  v23->Blink = v22;
  a1->NetworkLink.Flink = v22;
  _InterlockedIncrement(&a1->Ref);
  *a4 = v10;
LABEL_18:
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqqL(125LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, *a4, v8);
  return v8;
}
