/*
 * XREFs of NdisOffloadTcpSend @ 0x1C0060F90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNumDataBytesInNblChain@@YA_KPEAU_NET_BUFFER_LIST@@@Z @ 0x1C0060CE8 (-ndisNumDataBytesInNblChain@@YA_KPEAU_NET_BUFFER_LIST@@@Z.c)
