/*
 * XREFs of ?ndisNsiGetCompartmentInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0012A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetCompartmentInfo(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(132LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1);
...
LABEL_32:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(133LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, (unsigned int)v3);
