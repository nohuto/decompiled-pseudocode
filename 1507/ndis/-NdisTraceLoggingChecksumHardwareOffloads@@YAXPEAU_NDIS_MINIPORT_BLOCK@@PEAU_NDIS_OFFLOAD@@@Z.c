/*
 * XREFs of ?NdisTraceLoggingChecksumHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C00135B0
 * Callers:
...
void __fastcall NdisTraceLoggingChecksumHardwareOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  __int64 v2; // rcx
  const GUID *v3; // r8
  __int64 v4; // r9
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v27 = (char)v14;
      v83 = 1LL;
      TlgWrite(v14, &unk_1C0074F6A, v3, (LPCGUID)v4, 0x19u, &pData);
    }
  }
}
