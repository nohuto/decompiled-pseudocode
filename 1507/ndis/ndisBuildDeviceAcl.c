/*
 * XREFs of ndisBuildDeviceAcl @ 0x1C009E9FC
 * Callers:
...
__int64 __fastcall ndisBuildDeviceAcl(ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v15 = RtlLengthSid(&unk_1C0071110);
    v16 = RtlLengthSid(&unk_1C00710F0) + v15;
    v17 = RtlLengthSid(&unk_1C00710D0) + v16;
    v6 += v17 + RtlLengthSid(&unk_1C00710B0) + 32;
  }
  v21 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
...
LABEL_14:
    v10 = a2 & 0x80;
    if ( v10 )
      v6 += RtlLengthSid(&unk_1C0071090) + 8;
    ...
    if ( v11 )
    {
      ...
      else
      {
        ...
        if ( v25 )
        {
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00710B0);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00710D0);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00710F0);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0071110);
        }
        if ( v21 )
        ...
        if ( v10 )
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0071090);
        *v26 = v12;
      }
      goto LABEL_33;
    }
