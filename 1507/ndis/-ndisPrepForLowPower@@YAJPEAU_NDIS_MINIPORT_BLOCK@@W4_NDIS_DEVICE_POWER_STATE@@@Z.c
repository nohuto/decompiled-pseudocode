/*
 * XREFs of ?ndisPrepForLowPower@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_DEVICE_POWER_STATE@@@Z @ 0x1C000EB4C
 * Callers:
...
__int64 __fastcall ndisPrepForLowPower(struct _NDIS_MINIPORT_BLOCK *Context, enum _NDIS_DEVICE_POWER_STATE a2)
{
  ...
  if ( (FilterPnPFlags & 0x80u) == 0 || (Context->PnPFlags & 0x20) == 0 )
  {
      ...
      && (unsigned __int8)byte_1C0085323 >= 4u )
    {
      ...
      WPP_SF_Zq(87LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10[1], v10[0]);
    }
  ...
  if ( (Context->PnPFlags & 0x20) != 0 )
  {
    ...
    if ( (PnPFlags & 0x400) != 0 && (Context->Flags & 0x80u) == 0 )
    {
      ...
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_q(88LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, Context);
      v3 = ndisRequestWaitWake(Context, ndisGenericWaitWakeCallback);
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_qq(89LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, Context, Context->WaitWakeIrp);
    }
  }
  return v3;
}
