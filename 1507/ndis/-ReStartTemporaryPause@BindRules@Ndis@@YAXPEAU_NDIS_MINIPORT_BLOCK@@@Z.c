        ...
        struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  __int64 v18; // [rsp+20h] [rbp-C8h] BYREF
  ...
  for ( i = 0LL; (_DWORD)i != m_numElements; i = (unsigned int)(i + 1) )
  {
    ...
    if ( v7->BindState.m_actualPauseState == DatapathPaused )
    {
      ...
      else
      {
        ...
        if ( !v7->BindState.Miniport->BindEngine.m_isBeingDestroyed )
          v7->BindState.Miniport->BindEngine.m_isDirty = 1;
        v9 = 1;
      }
      if ( v9 && (unsigned __int8)v4 >= 4u )
      {
        ndisGetBindLinkNameForTracing(p[i]._p, (struct NDIS_PNPTRACE_LOCALS *)&v18);
        v4 = byte_1C0085323;
        if ( (unsigned __int8)byte_1C0085323 >= 4u )
        {
          WPP_SF_Zq(0xCu, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v19, v18);
          v4 = byte_1C0085323;
        }
      }
    }
  ...
  for ( j = 0LL; (_DWORD)j != v10; j = (unsigned int)(j + 1) )
  {
    ...
    if ( v13->BindState.m_actualPauseState == DatapathPaused )
    {
      ...
      else
      {
        ...
        if ( !v13->BindState.Miniport->BindEngine.m_isBeingDestroyed )
          v13->BindState.Miniport->BindEngine.m_isDirty = 1;
        v15 = 1;
      }
      if ( v15 && (unsigned __int8)v4 >= 4u )
      {
        ndisGetBindLinkNameForTracing(v12[j]._p, (struct NDIS_PNPTRACE_LOCALS *)&v18);
        WPP_SF_Zq(0xDu, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v19, v18);
        v4 = byte_1C0085323;
      }
    }
  }
  if ( this->Bindings.Miniport.m_actualPauseState == DatapathPaused )
  {
    ...
    if ( (v16 != 0) != ((v16 & 0xFFFFFFDF) != 0) || !this->Bindings.Miniport.Miniport )
    {
      ...
      Miniport = this->Bindings.Miniport.Miniport;
      ...
      if ( (unsigned __int8)v4 >= 4u )
      {
        ...
        WPP_SF_Zq(0xEu, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v19, v18);
      }
    }
  }
}
