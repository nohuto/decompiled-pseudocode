/*
 * XREFs of ?NdisPDPostItems@@YAXPEAUPD_QUEUE_HANDLE__@@PEAPEAU_SINGLE_LIST_ENTRY@@@Z @ 0x1C006C680
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a1 + 16) = v2;
  if ( *((_QWORD *)a1 + 5) && _InterlockedCompareExchange((volatile signed __int32 *)a1 + 14, 0, 1) == 1 )
  {
    if ( (unsigned __int8)byte_1C0085324 >= 5u )
      WPP_SF_q(0x62u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)a1);
