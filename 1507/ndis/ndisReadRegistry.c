/*
 * XREFs of ndisReadRegistry @ 0x1C01046C8
 * Callers:
...
__int64 ndisReadRegistry()
{
  ...
  _SINGLE_LIST_ENTRY *p_DpcListEntry; // [rsp+7D0h] [rbp+6C8h]
  ...
  __int64 v199; // [rsp+828h] [rbp+720h]
  _BYTE v200[48]; // [rsp+830h] [rbp+728h] BYREF
  ...
  p_DpcListEntry = &WPP_MAIN_CB.Dpc.DpcListEntry;
  ...
  *(_DWORD *)VersionInformation = 284;
  ...
  if ( !(_BYTE)KdDebuggerEnabled )
    LODWORD(WPP_MAIN_CB.Dpc.DpcListEntry.Next) = 1;
  QueryTable.QueryRoutine = 0LL;
  ...
  result = (unsigned int)(dword_1C0084D48 - 1);
