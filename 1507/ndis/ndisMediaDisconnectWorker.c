/*
 * XREFs of ndisMediaDisconnectWorker @ 0x1C00D5010
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMediaDisconnectWorker(PVOID P, struct _TlgProvider_t *Context)
{
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_q(0x15u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)Context);
  ...
  ndisDereferenceMiniport((__int64)Context, 0xBu);
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_q(0x16u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)Context);
}
