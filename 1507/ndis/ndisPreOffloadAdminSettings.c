/*
 * XREFs of ndisPreOffloadAdminSettings @ 0x1C00C7F90
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisPreOffloadAdminSettings(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0xD6u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v3);
  v4 = 1;
  if ( *(_DWORD *)(v3 + 4) != 1 )
    goto LABEL_4;
  if ( !*(_QWORD *)a1 )
...
LABEL_61:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qdD(0xD7u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, *(_DWORD *)(a1 + 40), v4);
  return v4;
}
