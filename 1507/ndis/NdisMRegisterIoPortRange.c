/*
 * XREFs of NdisMRegisterIoPortRange @ 0x1C00D3220
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT NumberOfPorts)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x14u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)MiniportAdapterHandle);
...
LABEL_4:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x15u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)MiniportAdapterHandle, v4);
  return v4;
}
