/*
 * XREFs of ?NdisPDPIClearReceiveFilter@@YAXPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C00DF1F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDPIClearReceiveFilter(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_q(0x32u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)P);
  KLockThisExclusive::KLockThisExclusive(
    (KLockThisExclusive *)&v14,
  ...
  *v8 = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_q(0x33u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)P);
}
