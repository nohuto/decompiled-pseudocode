/*
 * XREFs of ?ndisNsiSetAllNetworkInfo@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C003CE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetAllNetworkInfo(struct _NM_REQUEST_SET_ALL_PARAMETERS *a1)
{
  ...
  *(_DWORD *)&NewIrql[4] = 0;
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(0x72u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1);
...
LABEL_43:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(115LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, (unsigned int)v4);
