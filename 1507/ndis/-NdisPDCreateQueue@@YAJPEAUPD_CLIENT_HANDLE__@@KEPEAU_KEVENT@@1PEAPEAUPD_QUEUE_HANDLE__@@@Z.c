/*
 * XREFs of ?NdisPDCreateQueue@@YAJPEAUPD_CLIENT_HANDLE__@@KEPEAU_KEVENT@@1PEAPEAUPD_QUEUE_HANDLE__@@@Z @ 0x1C00DEA40
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *Size)
{
  ...
  *Size = 0LL;
  ...
  else
  {
    ...
    else
    {
      ...
      if ( PoolWithTag )
      {
        ...
        v17 = (struct KPushLockBase *)(*(_QWORD *)&qword_1C0085808 + 8LL);
        v16[13] = v8;
        *((_BYTE *)v16 + 24) = a3;
        *((_QWORD *)v16 + 4) = a5;
        *((_QWORD *)v16 + 5) = a4;
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_qqd(0x5Fu, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, *Size, v11);
  return v11;
}
