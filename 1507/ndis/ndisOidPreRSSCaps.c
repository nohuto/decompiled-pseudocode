/*
 * XREFs of ndisOidPreRSSCaps @ 0x1C00B1140
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreRSSCaps(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0x98u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v5, v3);
    v6 = byte_1C0085312;
  }
...
LABEL_8:
  ...
  {
    LODWORD(v11) = v4;
    WPP_SF_qqDD(0x99u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v5, v11, *((_DWORD *)a1 + 10));
  }
  return v4;
}
