/*
 * XREFs of ndisPmInitializeMiniport @ 0x1C00F5230
 * Callers:
...
__int64 __fastcall ndisPmInitializeMiniport(struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_q(0x2Eu, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)a1);
  ...
  *(_QWORD *)&a1[2].LevelPlus1 = a1 + 2;
  ...
  if ( (unsigned __int8)byte_1C0085310 >= 4u )
  {
    ...
    WPP_SF_qZD(v11, v10, (__int64)a1, (__int64 *)a1[61].ProviderMetadataPtr, BugCheckParameter4);
  }
  if ( v13 )
  {
    LODWORD(a1[35].KeywordAny) = 1;
    if ( (unsigned __int8)byte_1C0085315 >= 2u )
      WPP_SF_qD(0x30u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)a1, v13);
  ...
  else
  {
    ...
    v25 = (unsigned __int8)ndisIfSetInterfaceState((struct _NDIS_MINIPORT_BLOCK *)a1, 0, v16);
    if ( ((__int64)a1[1].AnnotationFunc & 0x20000000) != 0 )
      ndisMSetIndicatePacketHandler((__int64)a1);
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_q(0x31u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)a1);
    ...
    {
      WPP_SF_q(0x32u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)a1);
    }
...
LABEL_57:
    ...
    ndisLastFailedInitErrorCode = v13;
...
LABEL_68:
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_qD(0x33u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, (__int64)a1, v13);
  return v13;
}
