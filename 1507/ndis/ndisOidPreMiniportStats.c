/*
 * XREFs of ndisOidPreMiniportStats @ 0x1C00C7590
 * Callers:
 *     <none>
 * Callees:
 *     memset @ 0x1C0023A40 (memset.c)
 *     ndisOidGetStatisticAllProcessors @ 0x1C00C6CD8 (ndisOidGetStatisticAllProcessors.c)
 */
...
char __fastcall ndisOidPreMiniportStats(__int64 *a1)
{
  ...
  if ( !v4 && *(_BYTE *)(v5 + 32) < 6u )
  {
    if ( !*a1 )
      return v2;
    if ( ndisOidGetStatisticAllProcessors(*(_QWORD *)(v5 + 3192), v6, &v15) != 1 )
    {
      v9 = v15;
LABEL_16:
      v10 = *(_DWORD *)(v1 + 48);
