/*
 * XREFs of ?NdisPDAllocateMemory@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KPEAKPEAT_LARGE_INTEGER@@PEAPEAXPEAPEAUPD_MEMORY_HANDLE__@@@Z @ 0x1C00DE530
 * Callers:
 *     <none>
 * Callees:
        ...
        struct PD_MEMORY_HANDLE__ **a6)
{
  ...
  {
    WPP_SF_qdD(0x56u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)a1, *a3, a2);
    v8 = 0LL;
  }
  *a6 = 0LL;
  if ( a5 )
  ...
  {
    v15 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v13 + 32LL) + 5504LL) + 72LL);
