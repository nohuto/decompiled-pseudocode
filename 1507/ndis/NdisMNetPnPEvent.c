/*
 * XREFs of NdisMNetPnPEvent @ 0x1C00D4680
 * Callers:
 ...
 *     ?ndisMBindRequest@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEBU_NET_PNP_EVENT_NOTIFICATION@@@Z @ 0x1C005EBE4 (-ndisMBindRequest@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEBU_NET_PNP_EVENT_NOTIFICATION@@@Z.c)
        ...
        PNET_PNP_EVENT_NOTIFICATION NetPnPEventNotification)
{
  ...
  NDIS_STATUS v6; // eax
  __int64 v7; // rdx
  _QWORD v9[22]; // [rsp+30h] [rbp-D8h] BYREF

  NetEvent = NetPnPEventNotification->NetPnPEvent.NetEvent;
  v5 = 0;
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qD(0x3Du, &WPP_8f6d621b9670942a7823ab6ddc5f2e50_Traceguids, (__int64)MiniportAdapterHandle, NetEvent);
...
LABEL_16:
      ...
      ndisShallowCopyNetPnPEvent((__int64)v9, (__int64)NetPnPEventNotification);
...
LABEL_18:
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qdD(0x3Eu, &WPP_8f6d621b9670942a7823ab6ddc5f2e50_Traceguids, (__int64)MiniportAdapterHandle, NetEvent, v5);
  return v5;
}
