/*
 * XREFs of NdisMRegisterInterruptEx @ 0x1C00EAD70
 * Callers:
 *     <none>
 * Callees:
 *     ?GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z @ 0x1C000DD08 (-GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z.c)
        ...
        PNDIS_HANDLE NdisInterruptHandle)
{
  ...
  $72808CF3B6E4301EEB174F858D601307 *v32; // r15
  bool v33; // zf
  ...
  {
    WPP_SF_q(0x12u, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, (__int64)MiniportAdapterHandle);
    v12 = v50;
  }
    ...
    *(_WORD *)&Parameters.MessageBased.SynchronizeIrql = 0;
    ...
    if ( v35 < 0 )
    {
      ...
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_qD(0x13u, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, (__int64)MiniportAdapterHandle, v35);
      v32->Generic = 0LL;
    }
    else
    {
...
LABEL_40:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x14u, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, (__int64)MiniportAdapterHandle, v8);
  return v8;
}
