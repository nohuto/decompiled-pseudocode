/*
 * XREFs of ndisOidFreeInternalCloneRequest @ 0x1C0007DAC
 * Callers:
...
void __fastcall ndisOidFreeInternalCloneRequest(KSPIN_LOCK *a1, __int64 a2, char a3, KSPIN_LOCK *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqd(40LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a2, v9, *(_DWORD *)(a2 + 32));
  if ( v9 )
  {
    *(_QWORD *)(a2 + 96) = 0LL;
    if ( *(_DWORD *)(a2 + 4) == 12 )
    ...
    v13 = *(_QWORD *)(a2 + 96);
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
      WPP_SF_qq(173LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, *(_QWORD *)(a2 + 24), a2);
    if ( v13 )
    {
    ...
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
      WPP_SF_qq(174LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v12, 0LL);
  }
