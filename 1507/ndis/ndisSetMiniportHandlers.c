/*
 * XREFs of ndisSetMiniportHandlers @ 0x1C00E80B8
 * Callers:
...
void __fastcall ndisSetMiniportHandlers(__int64 a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x8Bu, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
  v2 = *(_BYTE *)(a1 + 32) < 6u;
  ...
  *(_QWORD *)(a1 + 2336) = a1;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x8Cu, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
}
