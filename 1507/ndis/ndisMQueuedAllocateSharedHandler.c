/*
 * XREFs of ndisMQueuedAllocateSharedHandler @ 0x1C005BDF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMQueuedAllocateSharedHandler(__int64 a1)
{
  ...
  if ( *(_BYTE *)v1 == 17 )
  {
    ...
    if ( *(_BYTE *)(v1 + 32) < 6u )
    {
      v6 = *(void (__fastcall **)(_QWORD, _QWORD, __int64, _QWORD, _QWORD))(*(_QWORD *)(v1 + 3816) + 240LL);
      goto LABEL_7;
    }
    v1 = *(_QWORD *)(v1 + 504);
  }
...
LABEL_7:
  ...
  ndisDereferenceMiniport(v5, 0x3Fu);
