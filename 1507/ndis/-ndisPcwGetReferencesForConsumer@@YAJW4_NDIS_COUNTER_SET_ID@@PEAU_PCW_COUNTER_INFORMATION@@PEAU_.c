/*
 * XREFs of ?ndisPcwGetReferencesForConsumer@@YAJW4_NDIS_COUNTER_SET_ID@@PEAU_PCW_COUNTER_INFORMATION@@PEAU_NDIS_PCW_CONSUMER_BLOCK@@@Z @ 0x1C0064C3C
 * Callers:
 ...
 *     ?ndisPcwReferenceMiniportDataBlock@@YAXPEAU_NDIS_PCW_DATA_BLOCK@@W4_NDIS_COUNTER_SET_ID@@_K@Z @ 0x1C00D8DE8 (-ndisPcwReferenceMiniportDataBlock@@YAXPEAU_NDIS_PCW_DATA_BLOCK@@W4_NDIS_COUNTER_SET_ID@@_K@Z.c)
 */
...
__int64 __fastcall ndisPcwGetReferencesForConsumer(unsigned int a1, __int64 a2, __int64 a3)
{
  ...
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v20, (struct KPushLockBase *)&ndisPcwMutex);
  ...
  if ( ndisMiniportList )
  {
    while ( 1 )
    {
      if ( !v7 )
        goto LABEL_22;
      if ( v10->PnPDeviceState != NdisPnPDeviceStarted || !ndisReferenceMiniport((__int64)v10, 0x57u) )
        goto LABEL_21;
