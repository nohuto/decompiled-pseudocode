/*
 * XREFs of ndisGetHardwareInfo @ 0x1C00D0F10
 * Callers:
...
__int64 __fastcall ndisGetHardwareInfo(char *NdisHandle, _QWORD *a2, _DWORD *a3)
{
  ...
  *((_WORD *)v10 + 8) = *(_WORD *)(*((_QWORD *)NdisHandle + 477) + 480LL);
  ...
  if ( v12 )
  {
    if ( *(_BYTE *)(v12 + 192) )
    {
      v11 = 8 * *(_DWORD *)(*(_QWORD *)(v12 + 120) + 4LL) + 1312;
      if ( v8 >= v11 )
      {
        v6 = v10 + 328;
        v10[17] = 1312;
...
LABEL_24:
  ...
  *(_OWORD *)(v10 + 38) = *(_OWORD *)(NdisHandle + 3416);
  ...
  v10[58] = *((_DWORD *)NdisHandle + 930);
  *((_BYTE *)v10 + 236) = NdisHandle[1288];
  ...
  *(_OWORD *)(v10 + 43) = *(_OWORD *)(NdisHandle + 2728);
  ...
  if ( PoolWithTagPriority )
  {
    ...
    if ( RssProcessorInformation >= 0 )
    {
      v10[28] = 240;
      v10[29] = 40;
      *((_OWORD *)v10 + 15) = *(_OWORD *)&v22->Header.Type;
      *((_OWORD *)v10 + 16) = *(_OWORD *)&v22->PreferredNumaNode;
      *((_QWORD *)v10 + 34) = *(_QWORD *)&v22[1].Header.Type;
