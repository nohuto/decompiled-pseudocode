/*
 * XREFs of ?NdisTraceLoggingDeviceStarted@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@J@Z @ 0x1C0014200
 * Callers:
...
void __fastcall NdisTraceLoggingDeviceStarted(const struct _TlgProvider_t *a1, __int64 a2, int a3)
{
  ...
  if ( a3 < 0 )
  {
    if ( (unsigned int)dword_1C0084040 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v18 = 4;
      v21 = 16;
      TlgWrite(v6, &unk_1C0074324, v7, v8, 5u, &pData);
    }
  }
  else if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v21 = 1;
      v24 = 16;
      TlgWrite((TraceLoggingHProvider)1, &unk_1C00742B9, v5, v4, 6u, &pData);
    }
  }
}
