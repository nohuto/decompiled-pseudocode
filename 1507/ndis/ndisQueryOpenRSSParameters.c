/*
 * XREFs of ndisQueryOpenRSSParameters @ 0x1C0043360
 * Callers:
...
__int64 __fastcall ndisQueryOpenRSSParameters(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x86u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v2, a2);
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 96));
  *(_QWORD *)(v2 + 520) = KeGetCurrentThread();
  *(_DWORD *)(v2 + 1856) = 2304710;
  if ( *(_WORD *)(v2 + 2730) )
  {
    v7 = *(_QWORD *)(a1 + 488);
    if ( v7 )
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0x87u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v2, v3);
  return v3;
}
