/*
 * XREFs of ndisPopulateRssProcessorSet @ 0x1C001D1B8
 * Callers:
...
__int64 __fastcall ndisPopulateRssProcessorSet(__int64 a1, __int64 a2)
{
  ...
  if ( HIDWORD(WPP_MAIN_CB.Dpc.DpcListEntry.Next) )
  {
    ...
    do
    {
      ...
      {
        v11 = *(_DWORD *)(a2 + 8);
        v12 = *(_PROCESSOR_NUMBER *)(*(_QWORD *)&v10 + 4LL * v9);
        if ( v12.Group >= (unsigned __int16)v11 && (v12.Group > (unsigned __int16)v11 || v12.Number >= BYTE2(v11)) )
        {
          ...
          {
            if ( !v5 || !v12.Group && *(_BYTE *)(*(_QWORD *)&v10 + 4LL * v9 + 2) < 0x20u )
            {
