/*
 * XREFs of NdisIMRegisterLayeredMiniport @ 0x1C00D2E50
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE DriverHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xCu, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)NdisWrapperHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xDu, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)*DriverHandle, v8);
  return v8;
}
