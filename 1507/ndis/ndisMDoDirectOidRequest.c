/*
 * XREFs of ndisMDoDirectOidRequest @ 0x1C0040BF8
 * Callers:
...
__int64 __fastcall ndisMDoDirectOidRequest(__int64 a1, _DWORD *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2);
  if ( *(_QWORD *)(a1 + 4512) && !ndisSetBusyAsync(a1, 1, 0x32u, (__int64)a2, 0) )
  {
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
      WPP_SF_q(0x20u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, (__int64)a2);
    v5 = 259;
    goto LABEL_36;
  }
...
LABEL_36:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqd(33LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2, v5);
  return v5;
}
