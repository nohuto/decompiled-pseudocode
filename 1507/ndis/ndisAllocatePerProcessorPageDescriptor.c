/*
 * XREFs of ndisAllocatePerProcessorPageDescriptor @ 0x1C001143C
 * Callers:
 *     ndisAllocatePerProcessorSlot @ 0x1C000DBCC (ndisAllocatePerProcessorSlot.c)
 *     ndisInitializePerProcessorSlotAllocator @ 0x1C01020E4 (ndisInitializePerProcessorSlotAllocator.c)
 * Callees:
 *     <none>
 */
