/*
 * XREFs of NdisFRestartFilter @ 0x1C0053080
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisFRestartFilter(NDIS_HANDLE NdisFilterHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x27u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, (__int64)NdisFilterHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x28u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, (__int64)NdisFilterHandle, v2);
  return v2;
}
