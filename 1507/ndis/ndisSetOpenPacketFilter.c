/*
 * XREFs of ndisSetOpenPacketFilter @ 0x1C0018A64
 * Callers:
...
char __fastcall ndisSetOpenPacketFilter(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  {
    WPP_SF_qq(89LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2);
    v7 = byte_1C0085312;
  }
  v8 = 0;
  if ( *(_DWORD *)(a2 + 48) >= 4u )
...
LABEL_11:
  ...
  *(_DWORD *)(a2 + 56) = 4;
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qqd(90LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2, -1073676268);
  *a3 = -1073676268;
  return 1;
}
