/*
 * XREFs of NdisMQueryInformationComplete @ 0x1C003EEF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMQueryInformationComplete(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(69LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, BugCheckParameter2, a2);
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(0x46u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, BugCheckParameter2);
}
