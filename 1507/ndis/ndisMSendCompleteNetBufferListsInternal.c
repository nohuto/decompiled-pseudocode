/*
 * XREFs of ndisMSendCompleteNetBufferListsInternal @ 0x1C0001DF0
 * Callers:
...
void __fastcall ndisMSendCompleteNetBufferListsInternal(__int64 a1, struct _NET_BUFFER_LIST *a2, unsigned int a3)
{
  ...
  _QWORD *v31; // rcx
  KIRQL v32; // al
  $C499D399BBA72F2528A00A318724AE5E *FirstNetBuffer; // rax
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      {
        FirstNetBuffer = ($C499D399BBA72F2528A00A318724AE5E *)v11->FirstNetBuffer;
        v34 = 0;
        v40 = 0;
        if ( FirstNetBuffer )
        {
