/*
 * XREFs of ndisHandleOrphanDevice @ 0x1C00F21DC
 * Callers:
...
__int64 __fastcall ndisHandleOrphanDevice(PCUNICODE_STRING SourceString)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0x24u, &WPP_83ec3feda1c7d74e49c0301905f57f77_Traceguids);
...
LABEL_14:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0x25u, &WPP_83ec3feda1c7d74e49c0301905f57f77_Traceguids);
  return 0LL;
}
