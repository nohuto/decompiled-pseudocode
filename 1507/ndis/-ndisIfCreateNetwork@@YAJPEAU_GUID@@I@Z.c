/*
 * XREFs of ?ndisIfCreateNetwork@@YAJPEAU_GUID@@I@Z @ 0x1C00C5B44
 * Callers:
...
__int64 __fastcall ndisIfCreateNetwork(struct _GUID *a1, int a2)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(0x80u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1, a2);
  memset(v7, 0, 0x48uLL);
  ...
  v5 = v4;
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qdD(0x81u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1, a2, v4);
  return v5;
}
