/*
 * XREFs of ?NdisTraceLoggingNDKCapabilities@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAT_NDIS_MINIPORT_ADAPTER_ATTRIBUTES@@@Z @ 0x1C006E7E4
 * Callers:
        ...
        union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES *a2)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v43 = 4LL;
      v45 = 8LL;
      TlgWrite(v8, &unk_1C0073CC6, v9, v10, 0xDu, &pData);
    }
  }
}
