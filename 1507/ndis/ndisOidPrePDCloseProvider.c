/*
 * XREFs of ndisOidPrePDCloseProvider @ 0x1C00E1670
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_ASSOCIATION@@QEAAPEAXI@Z @ 0x1C00DDE6C (--_GNDIS_PD_ASSOCIATION@@QEAAPEAXI@Z.c)
 ...
 *     ?ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z @ 0x1C00E084C (-ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z.c)
 */
        ...
        && *(_DWORD *)(v10 + 72) == *(_DWORD *)(v3 + 240) )
      {
        ...
        *(_QWORD *)(v5 + 8) = v10;
        if ( !*(_DWORD *)(a1 + 40) )
        {
          ...
          v13 = (struct KPushLockBase *)(*(_QWORD *)&qword_1C0085808 + 8LL);
          *(_QWORD *)(v10 + 80) = 0LL;
          *(_QWORD *)(v10 + 64) = 0LL;
