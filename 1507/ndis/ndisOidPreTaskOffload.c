/*
 * XREFs of ndisOidPreTaskOffload @ 0x1C00C7BA0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreTaskOffload(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqq(0xC7u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v4, v3);
...
LABEL_14:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
  {
    v12 = *(_DWORD *)(a1 + 40);
    LODWORD(v11) = v5;
    WPP_SF_qqDD(0xC8u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v4, v11, v12);
  }
  return v5;
}
