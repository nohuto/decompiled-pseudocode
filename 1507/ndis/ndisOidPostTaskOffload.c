/*
 * XREFs of ndisOidPostTaskOffload @ 0x1C0041FB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostTaskOffload(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqq(0xD1u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v4, v3);
  if ( *(_DWORD *)(v3 + 4) == 1 )
  {
    v5 = *(_QWORD *)(v4 + 792);
    if ( v5 )
  ...
  {
    v6 = *((_DWORD *)a1 + 10);
    WPP_SF_qqqL(0xD2u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v4, v3, v6);
  }
}
