/*
 * XREFs of ndisInvokeStatus @ 0x1C0017930
 * Callers:
...
__int64 __fastcall ndisInvokeStatus(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C008531F >= 4u )
    WPP_SF_qD(103LL, &WPP_0009299248ba37495192320194ebfcad_Traceguids, a1, v2);
  result = (*(__int64 (__fastcall **)(_QWORD, __int64))(a1 + 208))(*(_QWORD *)(a1 + 32), a2);
  if ( (unsigned __int8)byte_1C008531F >= 4u )
    return WPP_SF_qD(104LL, &WPP_0009299248ba37495192320194ebfcad_Traceguids, a1, v2);
  return result;
}
