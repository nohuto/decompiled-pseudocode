/*
 * XREFs of ndisInvokeNextReceiveCompleteHandler @ 0x1C0010F78
 * Callers:
 *     NdisFReturnNetBufferLists @ 0x1C000C160 (NdisFReturnNetBufferLists.c)
 *     ndisFakeFilterReceiveHandler @ 0x1C0053F70 (ndisFakeFilterReceiveHandler.c)
        ...
        *v10 = 0LL;
        if ( v16 )
        {
          do
          {
            ...
            v16->ChildRefCount = 0;
            ndisCallReceiveCompleteHandler(v6, v12, v23, v16, 0, 0, ChildRefCount);
            v16 = Scratch;
          }
          while ( Scratch );
          v13 = v6;
