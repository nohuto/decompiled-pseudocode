/*
 * XREFs of ndisOidPreLinkState @ 0x1C009A5C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreLinkState(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0xA4u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v4);
    v5 = byte_1C0085312;
  }
  ...
  {
    v12 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0xA5u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, 1, v12);
  }
  return 1;
}
