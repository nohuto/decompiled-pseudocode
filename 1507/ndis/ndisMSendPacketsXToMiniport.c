/*
 * XREFs of ndisMSendPacketsXToMiniport @ 0x1C0051630
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsXToMiniport(struct _NDIS_MINIPORT_BLOCK *a1, _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqd(0xEu, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2, a3);
  v6 = 0;
  v7 = a2;
  v8 = a2;
  if ( (_DWORD)v3 )
  ...
  {
    LODWORD(v17) = v6;
    WPP_SF_qqd(0xFu, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2, v17);
  }
}
