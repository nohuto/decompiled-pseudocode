/*
 * XREFs of NdisIfDeregisterProvider @ 0x1C003D670
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisIfDeregisterProvider(NDIS_HANDLE NdisProviderHandle)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(0x15u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)NdisProviderHandle);
  ...
  *v4 = v3;
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(0x16u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)NdisProviderHandle);
}
