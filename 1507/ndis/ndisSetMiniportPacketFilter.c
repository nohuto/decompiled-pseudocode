/*
 * XREFs of ndisSetMiniportPacketFilter @ 0x1C00184A8
 * Callers:
...
unsigned __int8 __fastcall ndisSetMiniportPacketFilter(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  {
    WPP_SF_qq(94LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2);
    v7 = byte_1C0085312;
  }
  *a3 = 0;
  v8 = 1;
...
LABEL_10:
    ...
    *(_DWORD *)(a1 + 1856) = 0;
    ...
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
      WPP_SF_qdD(96LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, v8, *a3);
    return v8;
  }
  *(_DWORD *)(a2 + 56) = 4;
  *a3 = -1073676268;
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_d(95LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, 3221291028LL);
  return v8;
}
