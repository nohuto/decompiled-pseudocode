/*
 * XREFs of NdisMAllocateNetBufferSGList @ 0x1C000A470
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ScatterGatherListBufferSize)
{
  ...
  char *ListEntrya; // [rsp+C0h] [rbp+8h]
  ...
  v33.CurrentCpu = -1;
  if ( (v11 & 0x400) != 0 )
    ndisPcwAddEvent(&v33, 0xAuLL, 1uLL);
  ...
  {
    v27 = 0LL;
    PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, v16, 0x6773444Eu);
    ...
    if ( PoolWithTag )
    {
      ...
      if ( Mdl )
      {
        ...
        if ( !v10 || (v18 = RtlCopyMdlToBuffer(MdlChain, 0LL, ListEntrya, v16, &v32), v18 >= 0) )
        {
          ...
          LOBYTE(v31) = v10;
          v18 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, struct _MDL *, char *, ULONG, _QWORD, PVOID, int))(*(_QWORD *)(*((_QWORD *)NdisMiniportDmaHandle + 3) + 8LL) + 88LL))(
                  *((_QWORD *)NdisMiniportDmaHandle + 3),
                  *(_QWORD *)(v6 + 3880),
                  v27,
                  ListEntrya,
    ...
    {
      WPP_SF_d(20LL, &WPP_e661d27027f753e153c509da19b80f2a_Traceguids, (unsigned int)v18);
      PoolWithTag = ListEntrya;
    }
    if ( v27 )
    {
