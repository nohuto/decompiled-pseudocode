/*
 * XREFs of ndisSriovInterfaceQueryProbedBars @ 0x1C00DBF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceQueryProbedBars(void *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x5Cu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x5Du, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
