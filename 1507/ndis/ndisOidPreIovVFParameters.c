/*
 * XREFs of ndisOidPreIovVFParameters @ 0x1C00DB200
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVFParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x24u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
    v4 = byte_1C0085321;
  }
  v5 = 12LL;
  if ( *(_DWORD *)(v1 + 4) != 12 )
...
LABEL_20:
  if ( (unsigned __int8)v4 >= 4u )
    WPP_SF_qdD(0x25u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v6, *(_DWORD *)(a1 + 40));
  return v6;
}
