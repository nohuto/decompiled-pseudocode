/*
 * XREFs of ndisPreRemoveOpenWakeUpPattern @ 0x1C00CADCC
 * Callers:
...
unsigned __int8 __fastcall ndisPreRemoveOpenWakeUpPattern(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(0x21u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, a1, a2);
    v5 = byte_1C0085312;
  }
...
LABEL_12:
  if ( (unsigned __int8)v5 >= 4u )
    WPP_SF_qqd(0x22u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, a1, a2, v4);
  return v4;
}
