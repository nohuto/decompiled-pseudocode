/*
 * XREFs of ?ndisNsiGetInterfaceRwInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00977B0
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0x4Au, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, v5, v3);
    v7 = v37;
    v5 = v38;
  }
  v8 = (char *)*((_QWORD *)v3 + 5);
...
LABEL_33:
              ...
              v39 = Miniport;
              if ( (unsigned __int8)byte_1C008531D >= 4u )
                WPP_SF_qq(0xC9u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, Miniport, v41);
              ...
              v24 = (char *)&v41[1] + v23;
              v33 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)&Miniport->Reserved4.Length + 4096LL) + 596LL);
              ...
              if ( (unsigned __int8)byte_1C008531D >= 4u )
                WPP_SF_qq(0xCAu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, Miniport, v41);
              p_Length = v41;
              v32 = 536;
              break;
            case 536:
...
LABEL_22:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqqL(0x4Bu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, v7, v5, v3, v4);
  return v4;
}
