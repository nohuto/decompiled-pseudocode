/*
 * XREFs of ndisOidPreAddPMProtocolOffload @ 0x1C0099E60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisIsValidPmCountedString @ 0x1C009A260 (ndisIsValidPmCountedString.c)
    ...
    && *(_DWORD *)(v6 + 4) == 1 )
  {
    ...
    *(_DWORD *)(a1 + 40) = 0;
    ...
    if ( !*(_DWORD *)(a1 + 40) )
    {
      ...
      if ( !*(_QWORD *)(a1 + 24)
        || (v17 = ndisSourcePreAddProtocolOffload(v12, 0LL, (_QWORD *)v6, &v22),
            v5 = v22,
            *(_DWORD *)(a1 + 40) = v17,
            !v5) )
      {
        ...
        if ( !v13
          || (*(_DWORD *)(v6 + 88) & 0x4000) != 0
          || (v21 = ndisSourcePreAddProtocolOffload(0LL, v13, (_QWORD *)v6, &v22),
              v5 = v22,
              *(_DWORD *)(a1 + 40) = v21,
              !v5) )
        {
