/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C00648A8
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0064934 (RtlWideCharArrayCopyStringWorker.c)
 */
