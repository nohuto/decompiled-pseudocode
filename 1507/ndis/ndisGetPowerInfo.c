/*
 * XREFs of ndisGetPowerInfo @ 0x1C0057830
 * Callers:
 *     ndisDeviceControlHandler @ 0x1C009652C (ndisDeviceControlHandler.c)
 * Callees:
 *     memmove @ 0x1C0023700 (memmove.c)
 *     memset @ 0x1C0023A40 (memset.c)
 *     ?ndisXlateSSResume@@YA?AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z @ 0x1C0057208 (-ndisXlateSSResume@@YA-AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z.c)
 *     ndisGetListEntriesCount @ 0x1C00C9C14 (ndisGetListEntriesCount.c)
 *     ndisXlateMiniportFlags @ 0x1C00D176C (ndisXlateMiniportFlags.c)
 *     ndisXlatePnPFlags @ 0x1C00D17B0 (ndisXlatePnPFlags.c)
 */
