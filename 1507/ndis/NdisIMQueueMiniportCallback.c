/*
 * XREFs of NdisIMQueueMiniportCallback @ 0x1C0058150
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( KeGetCurrentThread() == (struct _KTHREAD *)MiniportAdapterHandle[65] )
  {
    ...
    *((_DWORD *)MiniportAdapterHandle + 464) = 723892;
LABEL_5:
    ...
    *((_DWORD *)MiniportAdapterHandle + 464) = 0;
    ...
    MiniportAdapterHandle[65] = KeGetCurrentThread();
    *((_DWORD *)MiniportAdapterHandle + 464) = 723910;
  ...
  KeAcquireSpinLockAtDpcLevel(v6);
  MiniportAdapterHandle[65] = KeGetCurrentThread();
  *((_DWORD *)MiniportAdapterHandle + 464) = 723897;
  if ( !*((_BYTE *)MiniportAdapterHandle + 89) )
  {
    *((_BYTE *)MiniportAdapterHandle + 89) = 1;
    *((_DWORD *)MiniportAdapterHandle + 465) = 723898;
