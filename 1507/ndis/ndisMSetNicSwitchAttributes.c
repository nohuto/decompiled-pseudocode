/*
 * XREFs of ndisMSetNicSwitchAttributes @ 0x1C00B2D2C
 * Callers:
...
__int64 __fastcall ndisMSetNicSwitchAttributes(void **a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qq(0x79u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 32);
  v6 = *(_BYTE *)(v5 + 1);
  if ( v6
    ...
    && (v10 = *(_WORD *)(v8 + 2), v10 >= 0x20u) )
  {
    ...
    {
      PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, 0x74uLL, 0x666F444Eu);
      a1[452] = PoolWithTag;
      if ( PoolWithTag )
      {
        v13 = ExAllocatePoolWithTag(NonPagedPoolNx, 0x74uLL, 0x666F444Eu);
        a1[453] = v13;
        if ( v13 )
        {
          v14 = ExAllocatePoolWithTag(NonPagedPoolNx, 0x74uLL, 0x666F444Eu);
          a1[451] = v14;
          if ( v14 )
          {
            memset(a1[453], 0, 0x74uLL);
            memset(a1[452], 0, 0x74uLL);
            memset(a1[451], 0, 0x74uLL);
            v15 = *(unsigned __int16 **)(a2 + 32);
            v16 = v15[1];
            if ( (unsigned __int16)v16 >= 0x74u )
              v16 = 116;
...
LABEL_27:
  ...
  {
    v23 = v4;
    WPP_SF_qqd(0x7Au, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, a2, v23);
  }
  return v4;
}
