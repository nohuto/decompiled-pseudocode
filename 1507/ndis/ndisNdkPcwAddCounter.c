/*
 * XREFs of ndisNdkPcwAddCounter @ 0x1C00612EC
 * Callers:
 ...
 *     NDIS_NDK_PCW_NUM_COUNTERS_SET_IN_MASK @ 0x1C00D7630 (NDIS_NDK_PCW_NUM_COUNTERS_SET_IN_MASK.c)
...
__int64 __fastcall ndisNdkPcwAddCounter(__int64 a1)
{
  ...
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v12, (struct KPushLockBase *)&ndisPcwMutex);
  v2 = KeAcquireSpinLockRaiseToDpc(&ndisMiniportListLock);
  v3 = ndisMiniportList;
  v4 = v2;
  while ( v3 )
  {
    if ( v3->NDKBlock && ndisReferenceMiniport((__int64)v3, 0x59u) )
    {
      ...
      if ( ndisWildCardStringMatch(*(const struct _UNICODE_STRING **)(a1 + 8), MiniportName, v6) )
      {
        ...
        if ( v7 )
        {
          ...
          else if ( ndisReferenceMiniport((__int64)v3, 0x5Au) )
          {
