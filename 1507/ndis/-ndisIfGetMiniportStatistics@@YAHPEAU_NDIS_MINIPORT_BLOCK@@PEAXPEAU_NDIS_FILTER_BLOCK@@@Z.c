/*
 * XREFs of ?ndisIfGetMiniportStatistics@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAXPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C009756C
 * Callers:
        ...
        struct _NDIS_FILTER_BLOCK *a3)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqq(0x3Cu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, a3);
  memset(a2, 0, 0x90uLL);
...
LABEL_10:
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqqL(0x3Du, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, a3, SetMiniport);
  return 0LL;
}
