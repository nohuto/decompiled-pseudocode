/*
 * XREFs of ndisOidPreRcvFilterEnumQueues @ 0x1C0038C20
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumQueues(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085320 >= 4u )
    WPP_SF_q(0x1Cu, &WPP_63298f27d84d406e2a9901f9d2228ddf_Traceguids, a1);
...
LABEL_32:
  if ( (unsigned __int8)byte_1C0085320 >= 4u )
    WPP_SF_qD(29LL, &WPP_63298f27d84d406e2a9901f9d2228ddf_Traceguids, v1, *(unsigned int *)(a1 + 40));
  return v5;
}
