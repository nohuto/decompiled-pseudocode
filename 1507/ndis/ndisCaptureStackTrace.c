/*
 * XREFs of ndisCaptureStackTrace @ 0x1C0066A98
 * Callers:
...
LABEL_6:
    ...
    v7 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WPP_MAIN_CB.Dpc.DeferredRoutine);
    v8 = RtlLookupEntryHashTable((PRTL_DYNAMIC_HASH_TABLE)&WPP_MAIN_CB.Dpc.SystemArgument1, v6, &Context);
...
LABEL_23:
        KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.Dpc.DeferredRoutine, v7);
        return v3;
      }
      v9 = v13;
    }
