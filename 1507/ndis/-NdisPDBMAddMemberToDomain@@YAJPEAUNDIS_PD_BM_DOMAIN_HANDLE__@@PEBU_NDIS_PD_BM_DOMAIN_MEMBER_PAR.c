/*
 * XREFs of ?NdisPDBMAddMemberToDomain@@YAJPEAUNDIS_PD_BM_DOMAIN_HANDLE__@@PEBU_NDIS_PD_BM_DOMAIN_MEMBER_PARAMETERS@@PEAPEAUNDIS_PD_BM_DOMAIN_MEMBER_HANDLE__@@@Z @ 0x1C00E1F20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ **a3)
{
  ...
  *a3 = 0LL;
  ...
  v9 = *((_QWORD *)MiniportAdapterContext + 688);
