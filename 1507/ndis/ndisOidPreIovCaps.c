/*
 * XREFs of ndisOidPreIovCaps @ 0x1C00DA1B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovCaps(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x14u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v1, v3);
    v5 = byte_1C0085321;
  }
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_14:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x15u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v1, v4, v9);
  }
  return v4;
}
