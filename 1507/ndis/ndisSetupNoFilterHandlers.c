/*
 * XREFs of ndisSetupNoFilterHandlers @ 0x1C00182C4
 * Callers:
...
__int64 __fastcall ndisSetupNoFilterHandlers(__int64 a1)
{
  ...
  {
    WPP_SF_q(65LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
    v2 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  ...
  *(_QWORD *)(a1 + 2528) = v8;
  if ( v2 >= 4u )
    return WPP_SF_q(66LL, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
  return result;
}
