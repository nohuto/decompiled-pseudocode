/*
 * XREFs of NdisMFreePort @ 0x1C0039FB0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMFreePort(NDIS_HANDLE NdisMiniportHandle, NDIS_PORT_NUMBER PortNumber)
{
  ...
  if ( (unsigned __int8)byte_1C008531E >= 4u )
    WPP_SF_qD(12LL, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, NdisMiniportHandle, PortNumber);
  ...
  *((_DWORD *)NdisMiniportHandle + 464) = 2359598;
  ...
  if ( PortByPortNumber )
  {
    ...
    {
      v9 = *((_QWORD *)NdisMiniportHandle + 347);
      v10 = v7 >> 3;
      if ( v9
        && *((_DWORD *)NdisMiniportHandle + 696) >= (unsigned int)(v10 + 1)
  ...
  *((_DWORD *)NdisMiniportHandle + 464) = 0;
  ...
  if ( (unsigned __int8)byte_1C008531E >= 4u )
    WPP_SF_qdD(13LL, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, NdisMiniportHandle, PortNumber, v4);
  return v4;
}
