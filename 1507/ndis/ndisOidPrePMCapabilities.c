/*
 * XREFs of ndisOidPrePMCapabilities @ 0x1C00C9F70
 * Callers:
 *     ndisOidPrePMCurrentCapabilities @ 0x1C00CA100 (ndisOidPrePMCurrentCapabilities.c)
 *     ndisOidPrePMHardwareCapabilities @ 0x1C00CA110 (ndisOidPrePMHardwareCapabilities.c)
 * Callees:
...
unsigned __int8 __fastcall ndisOidPrePMCapabilities(__int64 a1, char a2)
{
  ...
  {
    WPP_SF_qq(0x30u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v2, v4);
    v7 = byte_1C0085312;
  }
  v8 = *(_QWORD *)(a1 + 24);
  if ( v8
  ...
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qdD(0x31u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v2, *(_DWORD *)(a1 + 40), v6);
  return v6;
}
