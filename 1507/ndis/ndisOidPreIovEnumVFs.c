/*
 * XREFs of ndisOidPreIovEnumVFs @ 0x1C00662B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumVFs(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x26u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, a1, v1);
  *(_DWORD *)(v2 + 60) = 0;
...
LABEL_48:
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x27u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v1, v6[10]);
  return v7;
}
