/*
 * XREFs of ?ndisNicQuietRequestComplete@@YAXPEAU_DEVICE_OBJECT@@ET_POWER_STATE@@PEAXPEAU_IO_STATUS_BLOCK@@@Z @ 0x1C006A9F0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(v5 + 368) = v8;
  ...
  if ( IoStatus->Status >= 0 )
  {
    if ( (unsigned __int8)byte_1C0085310 >= 4u )
      WPP_SF_qZ(0x1Fu, &WPP_393fd4d13135329a14ebf0b5e6137528_Traceguids, (__int64)Context, *((__int64 **)Context + 489));
  }
  else
  {
    NdisUnexpectedAoAcError((struct _NDIS_MINIPORT_BLOCK *)Context, 0x6B4u);
    if ( (unsigned __int8)byte_1C0085315 >= 2u )
      WPP_SF_dq(0x1Eu, &WPP_393fd4d13135329a14ebf0b5e6137528_Traceguids, IoStatus->Status, Context);
  }
}
