/*
 * XREFs of ndisFIsLoopbackNetBuffer @ 0x1C0053BA4
 * Callers:
        ...
        unsigned __int8 *LockStatea)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqq(0x68u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, LockState, a2, a3);
  v11 = *(_QWORD *)(a2 + 8);
  if ( (*(_BYTE *)(v11 + 10) & 5) != 0 )
    v12 = *(char **)(v11 + 24);
  else
...
LABEL_38:
      ...
      *v13 = v6;
      ...
      {
        LODWORD(v19) = v6;
        WPP_SF_qqd(0x69u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, LockState, a4, v19);
      }
      return;
    }
