/*
 * XREFs of ?NdisTraceLoggingQosOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C006EC4C
 * Callers:
...
void __fastcall NdisTraceLoggingQosOperationalStatus(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v24 = 8LL;
      v26 = 8LL;
      TlgWrite((TraceLoggingHProvider)v5, &unk_1C007436D, v2, v3, 0xAu, &pData);
    }
  }
}
