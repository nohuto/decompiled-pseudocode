/*
 * XREFs of ndisUpdateOffloadKeywords @ 0x1C00C8EF8
 * Callers:
 ...
 *     ndisConvertOffloadValueToString @ 0x1C00C6C90 (ndisConvertOffloadValueToString.c)
...
__int64 __fastcall ndisUpdateOffloadKeywords(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_q(0xD5u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1);
    LOBYTE(a2) = v52;
    LOBYTE(a3) = v53;
    v5 = 0;
    v9 = 0;
