/*
 * XREFs of ndisFNetPnPEventInternal @ 0x1C009B450
 * Callers:
 ...
 *     ?ndisFBindRequest@@YAHPEAU_NDIS_FILTER_BLOCK@@PEBU_NET_PNP_EVENT_NOTIFICATION@@@Z @ 0x1C00522A0 (-ndisFBindRequest@@YAHPEAU_NDIS_FILTER_BLOCK@@PEBU_NET_PNP_EVENT_NOTIFICATION@@@Z.c)
...
void __fastcall ndisFNetPnPEventInternal(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qqd(0x3Du, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Miniport, v1, *(_DWORD *)(v3 + 8));
  v6 = *(_DWORD *)(v3 + 8);
  if ( v6 != 15 )
  {
    if ( v6 <= 17 || v6 > 21 )
...
LABEL_7:
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_qq(0x3Eu, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Miniport, v1);
  *(_DWORD *)a1 = v4;
}
