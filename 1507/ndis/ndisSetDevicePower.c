/*
 * XREFs of ndisSetDevicePower @ 0x1C000F10C
 * Callers:
 ...
 *     ndisSetPowerResume @ 0x1C00DCEFC (ndisSetPowerResume.c)
...
__int64 __fastcall ndisSetDevicePower(PIRP Irp, __int64 a2, enum _NDIS_DEVICE_POWER_STATE a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085310 >= 4u )
    WPP_SF_LqZ(95LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids);
      ...
      if ( (*(_DWORD *)(a4 + 120) & 0x80u) == 0 )
      {
        ...
        *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetLock + 24) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetLock
        ...
        if ( (unsigned __int8)byte_1C0085315 >= 4u )
          WPP_SF_q(96LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a4);
        goto LABEL_28;
      }
...
LABEL_31:
  ...
  if ( (*(_DWORD *)(a4 + 124) & 0x800) == 0 )
  {
    ...
    ndisPrepForLowPower((struct _NDIS_MINIPORT_BLOCK *)a4, a3);
  }
  if ( (*(_DWORD *)(a4 + 124) & 0x20) == 0 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_q(99LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a4);
      ...
      {
        Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER>::Release(a4 + 5344);
        ndisPmHaltMiniport((struct _NDIS_MINIPORT_BLOCK *)a4);
        Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER>::Acquire(a4 + 5344, 1LL);
      }
    }
    goto LABEL_19;
  }
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 4u )
    WPP_SF_qdD(97LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a4, (unsigned int)a3, SetMiniportDeviceState);
  if ( !v12 )
  {
LABEL_19:
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_q(100LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a4);
    if ( (*(_DWORD *)(a4 + 120) & 0x80u) == 0 )
    {
...
LABEL_28:
  ...
  if ( (unsigned __int8)byte_1C0085315 >= 2u )
    WPP_SF_q(98LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a4);
