/*
 * XREFs of ndisIfCreateFilterInterface @ 0x1C001A7E0
 * Callers:
...
__int64 __fastcall ndisIfCreateFilterInterface(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(193LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1);
...
LABEL_8:
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(194LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, v5);
  return v5;
}
