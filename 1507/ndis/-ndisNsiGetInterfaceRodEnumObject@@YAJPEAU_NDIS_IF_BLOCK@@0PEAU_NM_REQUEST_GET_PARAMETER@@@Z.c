/*
 * XREFs of ?ndisNsiGetInterfaceRodEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0098630
 * Callers:
 ...
 *     ?ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z @ 0x1C0098C80 (-ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z.c)
 */
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x56u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a3);
    v4 = v32;
    v7 = v33;
    v6 = v34;
  }
...
LABEL_51:
          ...
          if ( v7->IsNdisFilter )
          {
            ...
            v35 = Miniport;
            if ( (unsigned __int8)byte_1C008531D >= 4u )
              WPP_SF_qq(0xC9u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, Miniport, v37);
            ...
            if ( (unsigned __int8)byte_1C008531D >= 4u )
              WPP_SF_qq(0xCAu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, Miniport, v37);
            v8 = v31;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqd(0x57u, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, v7, v5, v3);
  return v3;
}
