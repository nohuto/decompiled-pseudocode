/*
 * XREFs of ?NdisPDCreateBMGroup@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@@Z @ 0x1C00DE920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDCreateBMGroup(struct PD_CLIENT_HANDLE__ *a1, struct PD_BUFFER_MANAGEMENT_GROUP_HANDLE__ **a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_q(0x46u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)a1);
  v4 = 0;
  *a2 = 0LL;
  ...
  if ( v6 )
  {
    v8 = (struct KPushLockBase *)(*(_QWORD *)&qword_1C0085808 + 8LL);
    v6[3] = a1;
    KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v12, v8);
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_qqd(0x47u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, *a2, v4);
  return v4;
}
