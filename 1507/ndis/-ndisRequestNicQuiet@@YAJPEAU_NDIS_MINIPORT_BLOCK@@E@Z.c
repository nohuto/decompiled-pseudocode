/*
 * XREFs of ?ndisRequestNicQuiet@@YAJPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C00DD5D8
 * Callers:
...
__int64 __fastcall ndisRequestNicQuiet(struct _TlgProvider_t *MiniportAdapterHandle, char a2)
{
        ...
        *(_DWORD *)&v15[48] = 20;
        ...
        if ( SetMiniport )
        {
          ...
          if ( (unsigned __int8)byte_1C0085315 >= 2u )
            WPP_SF_dq(0x18u, &WPP_393fd4d13135329a14ebf0b5e6137528_Traceguids, SetMiniport, MiniportAdapterHandle);
        }
        ...
        if ( v12 != 259 )
        {
          ...
          if ( (unsigned __int8)byte_1C0085315 >= 2u )
            WPP_SF_dq(0x19u, &WPP_393fd4d13135329a14ebf0b5e6137528_Traceguids, v12, MiniportAdapterHandle);
        }
      }
    }
  }
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C0085315 >= 2u )
      WPP_SF_dq(0x1Au, &WPP_393fd4d13135329a14ebf0b5e6137528_Traceguids, v13, MiniportAdapterHandle);
  }
  return v13;
}
