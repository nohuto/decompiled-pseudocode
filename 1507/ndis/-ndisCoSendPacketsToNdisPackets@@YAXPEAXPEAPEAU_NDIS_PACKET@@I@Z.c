/*
 * XREFs of ?ndisCoSendPacketsToNdisPackets@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C004D110
 * Callers:
...
void __fastcall ndisCoSendPacketsToNdisPackets(_QWORD *a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqd(0xBu, &WPP_8f35a3663126a6381ade30b0d8399dbd_Traceguids, a1, *a2, a3);
  EthDB = v3->EthDB;
...
LABEL_25:
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_q(0xCu, &WPP_8f35a3663126a6381ade30b0d8399dbd_Traceguids, (__int64)a1);
}
