/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C00DFE60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_FILTER@@QEAAPEAXI@Z @ 0x1C00DDF24 (--_GNDIS_PD_FILTER@@QEAAPEAXI@Z.c)
 */
        ...
        struct NDIS_PD_FILTER_HANDLE__ **a3)
{
  ...
  KLockHolder v28; // [rsp+40h] [rbp-48h] BYREF
...
LABEL_44:
  ...
  if ( v17 < 0 )
    goto LABEL_44;
  v18 = *(struct KPushLockBase **)&qword_1C0085808;
  v4[3] = a1;
  *((_DWORD *)v4 + 24) = *((_DWORD *)a2 + 2);
  *((_DWORD *)v4 + 25) = *((_DWORD *)a2 + 3);
  v4[13] = *((_QWORD *)a2 + 4);
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v28, v18 + 1);
...
LABEL_46:
  ...
  {
    LODWORD(v27) = v8;
    WPP_SF_qqd(0x31u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, *a3, v27);
  }
