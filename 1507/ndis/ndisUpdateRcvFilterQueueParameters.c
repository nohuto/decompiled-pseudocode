/*
 * XREFs of ndisUpdateRcvFilterQueueParameters @ 0x1C0039B70
 * Callers:
 ...
 *     ndisOidPostRcvFilterQueueParameters @ 0x1C00386D0 (ndisOidPostRcvFilterQueueParameters.c)
 * Callees:
...
char __fastcall ndisUpdateRcvFilterQueueParameters(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 1856) = 2688412;
  ...
  if ( v5 )
    ...
    ReceiveQueueByQueueId = *(__int64 **)(a1 + 4432);
