/*
 * XREFs of ndisMInitializeScatterGatherDma @ 0x1C00AF6B0
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C00AF5E0 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C00CCFA0 (NdisMInitializeScatterGatherDma_ea_1C00CCFA0.c)
 * Callees:
 *     ndisAssignSGListLookasideList @ 0x1C001D718 (ndisAssignSGListLookasideList.c)
        ...
        int a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qdD(0xAu, &WPP_e661d27027f753e153c509da19b80f2a_Traceguids, (__int64)NdisAdapterHandle, a2, a4);
  v10 = *((_QWORD *)NdisAdapterHandle + 477);
  v11 = *(_BYTE *)(v10 + 24);
...
LABEL_24:
  ...
  if ( (*((_DWORD *)NdisAdapterHandle + 934) & 0x100) != 0
  ...
  *(_DWORD *)(v4 + 52) = a4;
  ...
  v14 = *((_DWORD *)NdisAdapterHandle + 943);
  ...
  *(_DWORD *)DeviceDescription = a3;
        ...
        (*(_QWORD *)(v4 + 24) = DmaAdapter) != 0LL) )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_qD(
        0xCu,
        &WPP_e661d27027f753e153c509da19b80f2a_Traceguids,
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
    WPP_SF_q(0xBu, &WPP_e661d27027f753e153c509da19b80f2a_Traceguids, (__int64)NdisAdapterHandle);
  v22 = -1073741670;
  ExFreePoolWithTag((PVOID)v4, 0);
  *((_QWORD *)NdisAdapterHandle + 63) = 0LL;
LABEL_27:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xDu, &WPP_e661d27027f753e153c509da19b80f2a_Traceguids, (__int64)NdisAdapterHandle, v22);
  return v22;
}
