/*
 * XREFs of ?ndisCmGetThreadNetworkNamespace@@YAXPEAU_ETHREAD@@PEAI1@Z @ 0x1C000D27C
 * Callers:
 *     ndisNsiGetAllThreadInformation @ 0x1C00994D0 (ndisNsiGetAllThreadInformation.c)
 * Callees:
