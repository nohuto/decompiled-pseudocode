/*
 * XREFs of NdisMQueryProbedBars @ 0x1C00D9330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMQueryProbedBars(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x74u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, a1);
  ...
  if ( v4 && (v5 = *(_QWORD *)(a1 + 4880)) != 0 )
    ...
    v6 = -1073741637;
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x75u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, a1, v6);
  return v6;
}
