/*
 * XREFs of ndisOidPrePortState @ 0x1C00424D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePortState(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0xB7u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, *(_DWORD *)(v3 + 8));
  if ( *(_QWORD *)a1 )
  {
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0xB8u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, *(_DWORD *)(v3 + 8));
  return v4;
}
