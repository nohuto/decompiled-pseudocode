/*
 * XREFs of ndisReadBindPaths @ 0x1C00AA808
 * Callers:
...
__int64 __fastcall ndisReadBindPaths(__int64 a1, _RTL_QUERY_REGISTRY_TABLE *a2, const WCHAR *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_q(0xCu, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a1);
  a2->QueryRoutine = 0LL;
  Context = 0LL;
  a2[1].Flags = 20;
  a2[1].DefaultType = 0;
  ...
  *(_QWORD *)(a1 + 3824) = PoolWithTag;
  if ( PoolWithTag )
  {
    ...
    **(_DWORD **)(a1 + 3824) = v11;
    ...
    v14 = v11 - 1;
    v9 = (WCHAR *)SourceString;
    v15 = 16LL * v11 + *(_QWORD *)(a1 + 3824) + 24LL;
    if ( !*SourceString )
      goto LABEL_20;
    while ( 1 )
    {
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C0085314 >= 4u )
    WPP_SF_q(0xDu, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a1);
  return v8;
}
