/*
 * XREFs of ndisOidPreRcvFilterEnumFilters @ 0x1C0038910
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumFilters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085320 >= 4u )
    WPP_SF_q(0x1Eu, &WPP_63298f27d84d406e2a9901f9d2228ddf_Traceguids, a1);
  v6 = *(_DWORD **)(a1 + 32);
  v7 = 20;
  if ( v6[1] == 12 )
  {
...
LABEL_43:
  if ( (unsigned __int8)byte_1C0085320 >= 4u )
    WPP_SF_qD(31LL, &WPP_63298f27d84d406e2a9901f9d2228ddf_Traceguids, v1, *(unsigned int *)(a1 + 40));
  return v5;
}
