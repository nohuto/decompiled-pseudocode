/*
 * XREFs of ndisMSetGeneralAttributes @ 0x1C0013AA0
 * Callers:
...
__int64 __fastcall ndisMSetGeneralAttributes(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(111LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1);
  v4 = 0LL;
...
LABEL_37:
  ...
  *(_DWORD *)&a1->TopRecvScaleCapabilities.NumberOfIndirectionTableEntries = v19;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(112LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, 0LL);
  return 0LL;
}
