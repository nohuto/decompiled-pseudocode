/*
 * XREFs of ndisIMCheckDeviceInstance @ 0x1C00CE160
 * Callers:
...
char __fastcall ndisIMCheckDeviceInstance(__int64 a1, __int64 *a2, wchar_t **a3)
{
  char v6; // r12
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x28u, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a1, a2);
  ...
  *(_QWORD *)(a1 + 472) = KeGetCurrentThread();
  ...
  {
    if ( RtlEqualUnicodeString(i + 1, (PCUNICODE_STRING)a2, 1u) )
    {
      if ( a3 )
        *a3 = i->Buffer;
...
LABEL_24:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x2Au, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a1, a2);
  return v6;
}
