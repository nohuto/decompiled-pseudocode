/*
 * XREFs of ndisCreateFilterDriverRegistry @ 0x1C00AE670
 * Callers:
...
__int64 __fastcall ndisCreateFilterDriverRegistry(PCUNICODE_STRING Source, unsigned __int8 a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x55u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, (__int64)Source);
  ...
  v9 = RegistryValues;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_dd(0x56u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, RegistryValues, a2);
  if ( !v9 )
    goto LABEL_10;
  if ( v9 != -1073741772 )
  {
...
LABEL_12:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x57u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, (__int64)Source, v3);
  return v3;
}
