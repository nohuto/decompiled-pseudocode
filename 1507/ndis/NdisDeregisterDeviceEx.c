/*
 * XREFs of NdisDeregisterDeviceEx @ 0x1C005B4C0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisDeregisterDeviceEx(NDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x68u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)NdisDeviceHandle);
...
LABEL_23:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x69u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)NdisDeviceHandle);
}
