/*
 * XREFs of ndisOidPostPMParameters @ 0x1C001F3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisOidPostPMParameters(_QWORD *a1)
{
  ...
  {
    result = WPP_SF_qq(54LL, &WPP_fbb1998797815902974a7c4233493709_Traceguids, *a1, v1);
    v3 = byte_1C0085312;
  }
...
LABEL_10:
  if ( (unsigned __int8)v3 >= 4u )
    return WPP_SF_qq(55LL, &WPP_fbb1998797815902974a7c4233493709_Traceguids, *a1, v1);
  return result;
}
