/*
 * XREFs of ndisFInvokeSetFilterModuleOptions @ 0x1C00A081C
 * Callers:
...
__int64 __fastcall ndisFInvokeSetFilterModuleOptions(__int64 a1)
{
  ...
  if ( *(_QWORD *)(v1 + 168) )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_q(0x6Du, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
    v4 = (*(__int64 (__fastcall **)(_QWORD))(v1 + 168))(*(_QWORD *)(a1 + 24));
    v2 = v4;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_qD(0x6Eu, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1, v4);
  }
  else if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    WPP_SF_q(0x6Fu, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, a1);
  }
  return v2;
}
