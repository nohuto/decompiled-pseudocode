/*
 * XREFs of ndisPreTaskOffloadSet @ 0x1C00C827C
 * Callers:
 *     ndisOidPreTaskOffload @ 0x1C00C7BA0 (ndisOidPreTaskOffload.c)
 * Callees:
 *     ?ndisOidPreMiniportSetEncapsulation@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C001DE68 (-ndisOidPreMiniportSetEncapsulation@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z.c)
 *     ndisOidPreOpenSetEncapsulation @ 0x1C001E044 (ndisOidPreOpenSetEncapsulation.c)
 *     WPP_SF_qq @ 0x1C0022860 (WPP_SF_qq.c)
 *     WPP_SF_qdD @ 0x1C003F248 (WPP_SF_qdD.c)
 *     ndisSetTaskOffloadValidate @ 0x1C00C88B0 (ndisSetTaskOffloadValidate.c)
 */
...
unsigned __int8 __fastcall ndisPreTaskOffloadSet(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0xCFu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v3);
...
LABEL_20:
  ...
  {
    v13 = v11;
    WPP_SF_qdD(0xD0u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, (__int64)v1, *v5, v13);
  }
  return v11;
}
