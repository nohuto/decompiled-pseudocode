/*
 * XREFs of NdisRegisterDeviceEx @ 0x1C001E5C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(102LL, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, NdisHandle);
  *pDeviceObject = 0LL;
...
LABEL_17:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(103LL, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, NdisHandle, (unsigned int)SymbolicLink);
  return SymbolicLink;
}
