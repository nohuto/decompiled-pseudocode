/*
 * XREFs of ndisNotifyBindFailure @ 0x1C00B3554
 * Callers:
...
void __fastcall ndisNotifyBindFailure(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C008530D >= 3u )
    WPP_SF_qq(0x54u, &WPP_0009299248ba37495192320194ebfcad_Traceguids, a1, a2);
  v4 = *(_BYTE *)(a2 + 56);
  if ( v4 > 6u || v4 == 6 && *(_BYTE *)(a2 + 57) >= 0x1Eu )
  {
    ...
    *(_DWORD *)(a2 + 428) = 0;
    ...
    if ( (unsigned __int8)byte_1C008530D >= 3u )
      WPP_SF_qq(0x55u, &WPP_0009299248ba37495192320194ebfcad_Traceguids, a1, a2);
  }
}
