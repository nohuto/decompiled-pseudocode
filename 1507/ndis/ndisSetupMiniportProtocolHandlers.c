/*
 * XREFs of ndisSetupMiniportProtocolHandlers @ 0x1C0018EE4
 * Callers:
...
_UNKNOWN **__fastcall ndisSetupMiniportProtocolHandlers(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  {
    result = (_UNKNOWN **)WPP_SF_qqq(133LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a2, a3, a1);
    v9 = byte_1C008530D;
  }
  if ( !v7 )
    goto LABEL_14;
...
LABEL_14:
  ...
  if ( (unsigned __int8)v9 >= 4u )
    return (_UNKNOWN **)WPP_SF_qqq(134LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a2, a3, a1);
  return result;
}
