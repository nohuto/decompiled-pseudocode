/*
 * XREFs of ndisMOpenAdapter @ 0x1C00E8200
 * Callers:
 ...
 *     ethAllocateOpenMulticastBuffer @ 0x1C0017A9C (ethAllocateOpenMulticastBuffer.c)
...
void __fastcall ndisMOpenAdapter(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C008530D >= 4u )
    WPP_SF_qqq(0x22u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, v3, a3, a2);
  if ( !ndisReferenceMiniport(a3, 0x2Cu) )
  {
    *a1 = -1073676286;
    goto LABEL_41;
  }
  if ( *(_BYTE *)(v3 + 56) < 6u )
  {
    ...
    if ( !v5 )
    {
      ...
      if ( !PoolWithTag )
      {
        *a1 = -1073741670;
LABEL_83:
        ndisDereferenceMiniport(a3, 0x2Cu);
        goto LABEL_41;
      }
...
LABEL_54:
  ...
  if ( *(_BYTE *)(a3 + 32) >= 6u )
  {
    *(_QWORD *)(a2 + 1128) = *(_QWORD *)(v19 + 552);
    *(_QWORD *)(a2 + 1016) = *(_QWORD *)(*(_QWORD *)(a3 + 3816) + 504LL);
    v20 = *(_QWORD *)(*(_QWORD *)(a3 + 3816) + 200LL);
  }
  else
  {
    *(_QWORD *)(a2 + 1024) = *(_QWORD *)(v19 + 288);
    *(_QWORD *)(a2 + 1016) = *(_QWORD *)(*(_QWORD *)(a3 + 3816) + 248LL);
    v20 = *(_QWORD *)(*(_QWORD *)(a3 + 3816) + 296LL);
  }
  *(_QWORD *)(a2 + 296) = v20;
  *(_QWORD *)(a2 + 1088) = a2 + 1080;
  *(_QWORD *)(a2 + 1080) = a2 + 1080;
  *(_QWORD *)(a2 + 1104) = a2 + 1096;
  *(_QWORD *)(a2 + 1096) = a2 + 1096;
...
LABEL_13:
  ...
  *(_QWORD *)(a2 + 568) = *(_QWORD *)(a2 + 296);
  if ( (unsigned __int8)byte_1C008530D >= 4u )
    WPP_SF_qq(0x65u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a3, a2);
  v14 = *(unsigned int *)(a3 + 1520);
  if ( (((_DWORD)v14 - 1) & 0xFFFFFFFC) != 0 || (_DWORD)v14 == 3 )
  {
    if ( (unsigned __int8)byte_1C008530D >= 4u )
      WPP_SF_qq(0x66u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a3, a2);
  ...
  if ( (unsigned __int8)byte_1C008530D >= 4u )
  {
    ...
    WPP_SF_qqd(0x67u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a3, a2, v22);
  }
  if ( !(_BYTE)v6 )
  {
    *a1 = -1073676281;
  ...
  v7 = 1;
  if ( (unsigned __int8)byte_1C008530D >= 4u )
    WPP_SF_qq(0x2Au, &WPP_0009299248ba37495192320194ebfcad_Traceguids, a2, v3);
  ...
  {
    LODWORD(v22) = v16;
    WPP_SF_qqd(0x2Bu, &WPP_0009299248ba37495192320194ebfcad_Traceguids, a2, v3, v22);
  }
  if ( !v16 )
  {
    v4 = 0;
...
LABEL_41:
  ...
  {
    LODWORD(v23) = *a1;
    WPP_SF_qqqL(0x24u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, v3, a3, a2, v23);
  }
}
