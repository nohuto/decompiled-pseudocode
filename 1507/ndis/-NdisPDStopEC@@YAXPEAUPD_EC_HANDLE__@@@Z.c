/*
 * XREFs of ?NdisPDStopEC@@YAXPEAUPD_EC_HANDLE__@@@Z @ 0x1C00E0410
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDStopEC(_UNICODE_STRING *P)
{
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_qqq(0x5Cu, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, P, *(_QWORD *)&P[2].Length, CurrentThread);
  ...
  *(_QWORD *)&P[2].Length = 0LL;
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_q(0x5Du, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)P);
