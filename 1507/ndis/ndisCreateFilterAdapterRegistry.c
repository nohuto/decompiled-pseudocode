/*
 * XREFs of ndisCreateFilterAdapterRegistry @ 0x1C00B06E0
 * Callers:
...
__int64 __fastcall ndisCreateFilterAdapterRegistry(PCUNICODE_STRING Source, __int64 a2)
{
  ...
  *(_DWORD *)&Destination.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x58u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Source, a2);
  v5 = *(const GUID **)(a2 + 16);
  if ( v5 )
  {
...
LABEL_10:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqd(0x59u, &WPP_df3618ada41cd72bb8b0447b4c1fb5c5_Traceguids, Source, a2, v2);
  return v2;
}
