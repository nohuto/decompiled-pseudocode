/*
 * XREFs of ndisSourcePreAddProtocolOffload @ 0x1C00999F0
 * Callers:
...
__int64 __fastcall ndisSourcePreAddProtocolOffload(__int64 a1, __int64 a2, _QWORD *a3, _BYTE *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x5Bu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, a1, a3);
...
LABEL_9:
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qdD(0x5Cu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, a1, (unsigned __int8)*a4, v8);
  return v8;
}
