/*
 * XREFs of NdisAllocateNetBufferAndNetBufferList @ 0x1C000B7E0
 * Callers:
        ...
        if ( ndisMaxNumberOfProcessors != 1 )
        {
          ...
          if ( !v14 )
          {
            if ( ExQueryDepthSList(*((PSLIST_HEADER *)v12 + 25)) < 0xAu
              || (v25 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)v12 + 26),
                  v26 = *((_QWORD *)v12 + 24),
                  *((_QWORD *)v12 + 24) = *((_QWORD *)v12 + 25),
                  *((_QWORD *)v12 + 25) = v26,
                  KeReleaseSpinLock((PKSPIN_LOCK)v12 + 26, v25),
...
LABEL_14:
            ...
            if ( v14 )
            {
              ...
              *((_DWORD *)&v14[24].Next + 2) = DataLength;
              ...
              for ( *((_QWORD *)&v14[26].Next + 1) = PoolHandle; MdlChain; v17 -= ByteCount )
              {
