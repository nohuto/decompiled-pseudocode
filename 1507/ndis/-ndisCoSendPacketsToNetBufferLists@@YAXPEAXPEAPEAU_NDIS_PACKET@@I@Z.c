/*
 * XREFs of ?ndisCoSendPacketsToNetBufferLists@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C004D360
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisCoSendPacketsToNetBufferLists(_QWORD *a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqd(0xDu, &WPP_8f35a3663126a6381ade30b0d8399dbd_Traceguids, a1, *a2, a3);
  v31 = *(_QWORD *)(v4 + 400);
  ...
  if ( !v12 )
  {
    if ( (unsigned __int8)byte_1C008530A >= 2u )
      WPP_SF_(0xEu, &WPP_8f35a3663126a6381ade30b0d8399dbd_Traceguids);
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_q(0xFu, &WPP_8f35a3663126a6381ade30b0d8399dbd_Traceguids, (__int64)a1);
}
