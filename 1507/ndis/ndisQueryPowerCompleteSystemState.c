/*
 * XREFs of ndisQueryPowerCompleteSystemState @ 0x1C0010D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisQueryPowerCompleteSystemState(int a1, unsigned int *a2, __int64 a3)
{
  ...
  {
    WPP_SF_qD(34LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a3, a2[12]);
    v5 = byte_1C0085315;
  }
  v6 = a2[12];
  if ( (int)v6 < 0 )
  {
    if ( (unsigned __int8)v5 >= 4u )
      WPP_SF_qD(35LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a3, v6);
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0085315 >= 4u )
        WPP_SF_qD(36LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a3, (unsigned int)v7);
      if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
        Template_jqxq(
          v8,
    ...
    if ( (unsigned __int8)byte_1C0085315 >= 4u )
      WPP_SF_q(37LL, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, a3);
