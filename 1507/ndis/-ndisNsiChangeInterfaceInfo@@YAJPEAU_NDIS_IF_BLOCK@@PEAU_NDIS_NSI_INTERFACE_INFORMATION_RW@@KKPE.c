/*
 * XREFs of ?ndisNsiChangeInterfaceInfo@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_NSI_INTERFACE_INFORMATION_RW@@KKPEAK@Z @ 0x1C001A27C
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qq(118LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2);
...
LABEL_12:
    ...
    v14 = 16;
    updated = ndisIfUpdateInterfaceIsolationNetworkIdLocked(a1, (const struct _GUID *)a2);
    if ( updated >= 0 )
    {
      v13 = 16;
      goto LABEL_8;
...
LABEL_14:
  ...
  *(_DWORD *)&ifL2NetworkInfo->Length = v16;
  if ( !v16 )
    v9 = -1073741811;
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqd(119LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a2, v9);
  return v9;
}
