/*
 * XREFs of ?NdisTraceLoggingRareFeaturePath@@YAXW4NdisTLRareFeature@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C006EDDC
 * Callers:
...
TLG_STATUS __fastcall NdisTraceLoggingRareFeaturePath(__int64 a1, __int64 a2, __int64 a3, const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    ...
    v13 = 2LL;
    v15[1] = 0;
    return TlgWrite(0LL, &unk_1C0074C86, (LPCGUID)a3, a4, 6u, &pData);
  }
  return result;
}
