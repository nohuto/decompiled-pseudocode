/*
 * XREFs of ndisIfUpdateFilterIfStack @ 0x1C001A154
 * Callers:
...
void __fastcall ndisIfUpdateFilterIfStack(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(199LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1);
...
LABEL_4:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(200LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1);
}
