/*
 * XREFs of ?ndisNsiGetIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C003C830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetIfRcvAddress(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_q(0x5Cu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, (__int64)a1);
...
LABEL_42:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qD(93LL, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, (unsigned int)IfRcvAddressRodInformation);
