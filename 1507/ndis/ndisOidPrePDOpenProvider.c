/*
 * XREFs of ndisOidPrePDOpenProvider @ 0x1C00E19B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPrePDOpenProvider(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 40) = 0;
  ...
  {
    v6 = *(_QWORD *)(v2 + 40);
    if ( *(_BYTE *)v6 != 0x80 || *(_BYTE *)(v6 + 1) != 1 || *(_WORD *)(v6 + 2) < 0x18u || *(_DWORD *)(v6 + 4) )
      goto LABEL_10;
...
LABEL_6:
    ...
    if ( !ndisReferenceMiniport(v1, 0x62u) )
    {
...
LABEL_56:
    ...
    v19 = *(struct KPushLockBase **)&qword_1C0085808;
    ...
    *((_QWORD *)v11 + 4) = v21;
    v22 = v3 + 40;
    v23 = *(_QWORD *)(v1 + 5504) + 40LL;
    v24 = *(char ***)(*(_QWORD *)(v1 + 5504) + 48LL);
    *((_QWORD *)v3 + 5) = v23;
    *((_QWORD *)v3 + 6) = v24;
    if ( *v24 != (char *)v23 )
      __fastfail(3u);
    ...
    *(_QWORD *)(v23 + 8) = v22;
    ...
    if ( *((_UNKNOWN **)v3 + 11) == &unk_1C0075E80 )
      v3[96] = 1;
    if ( (unsigned __int8)byte_1C0085324 >= 4u )
    {
      v26 = L"PASS_THROUGH";
