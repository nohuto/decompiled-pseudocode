/*
 * XREFs of ndisXlateWolPatternListToWakeUpPatternList @ 0x1C00CCD80
 * Callers:
 *     ndisOidPostWakeUpPatternList @ 0x1C0044F50 (ndisOidPostWakeUpPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWolPatternListToWakeUpPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v4 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C0085312 >= 2u )
      WPP_SF_(0x73u, &WPP_fbb1998797815902974a7c4233493709_Traceguids);
    return;
  }
  if ( !(_DWORD)v4 )
    return;
