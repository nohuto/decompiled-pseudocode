/*
 * XREFs of ?ndisNsiGetInterfaceRosInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0097BF0
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x4Eu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, a1, a3);
    v6 = a1;
  }
  v7 = (char *)*((_QWORD *)a3 + 5);
  v8 = *((_DWORD *)a3 + 13);
...
LABEL_16:
  ...
  if ( (unsigned __int8)byte_1C008531D >= 4u )
    WPP_SF_qqd(0x4Fu, &WPP_56ef47bcd2b9f0689e12eeceae5d2bd7_Traceguids, v6, a3, v3);
  return v3;
}
