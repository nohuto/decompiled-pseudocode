/*
 * XREFs of ?NdisPDGetBuffersFromBufferSet@@YAXPEAUPD_BUFFER_SET_HANDLE__@@PEAKPEAPEAU_PD_BUFFER@@@Z @ 0x1C006C3F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _PD_BUFFER **a3)
{
  ...
  *a3 = v10;
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_qD(0x52u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, (__int64)a1, *a2);
}
