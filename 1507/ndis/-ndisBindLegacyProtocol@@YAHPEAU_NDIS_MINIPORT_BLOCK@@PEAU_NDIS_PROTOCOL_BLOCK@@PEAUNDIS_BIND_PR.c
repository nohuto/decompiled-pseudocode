/*
 * XREFs of ?ndisBindLegacyProtocol@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@@Z @ 0x1C00DD908
 * Callers:
        ...
        struct NDIS_BIND_PROTOCOL_LINK *a3)
{
  ...
  {
    if ( (unsigned __int8)byte_1C008530D >= 3u )
