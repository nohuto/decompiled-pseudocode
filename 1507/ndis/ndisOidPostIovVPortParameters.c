/*
 * XREFs of ndisOidPostIovVPortParameters @ 0x1C0065F10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovVPortParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qq(0x37u, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v3, v1);
}
