/*
 * XREFs of ndisMSendPacketsToNetBufferLists @ 0x1C00514E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToNetBufferLists(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qqd(0x36u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2, a3);
    ...
    if ( v12 )
    {
      if ( ndisNblTrackerMode )
        ndisNblTrackerTransferOwnershipInternal(
          ...
          *(struct NDIS_NBL_TRACKER_HANDLE__ **)(a1 + 2568),
          0x8Fu,
          v14 & 1);
  ...
  if ( (unsigned __int8)byte_1C008530A >= 4u )
    WPP_SF_qq(0x37u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2);
}
