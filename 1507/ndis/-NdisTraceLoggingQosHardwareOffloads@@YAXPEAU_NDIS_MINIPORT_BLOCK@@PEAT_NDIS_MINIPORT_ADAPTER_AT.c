/*
 * XREFs of ?NdisTraceLoggingQosHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAT_NDIS_MINIPORT_ADAPTER_ATTRIBUTES@@@Z @ 0x1C006EB68
 * Callers:
        ...
        union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES *a2)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v20 = &v9;
      v21 = 4LL;
      TlgWrite((TraceLoggingHProvider)v6, &unk_1C007404E, v3, (LPCGUID)v4, 7u, &pData);
    }
  }
}
