/*
 * XREFs of ndisQueryOidList @ 0x1C00AB464
 * Callers:
...
__int64 __fastcall ndisQueryOidList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(0x11u, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, a1);
  ...
  *(_DWORD *)&v12[4] = 2;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0x12u, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, a1, v5);
  return v5;
}
