/*
 * XREFs of ndisOidPreRemoveWakeUpPattern @ 0x1C00CA700
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRemoveWakeUpPattern(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v4, v1);
  v5 = *(_QWORD *)(a1 + 24);
...
LABEL_21:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qD(0x20u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v8;
}
