/*
 * XREFs of ndisMReset @ 0x1C005A680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisMReset(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085318 >= 4u )
    WPP_SF_qq(0x43u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, v1);
  v3 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v1 + 96));
  v7 = (*(_DWORD *)(v1 + 124) & 0x80000) == 0;
  v4 = v3;
  *(_QWORD *)(v1 + 520) = KeGetCurrentThread();
  *(_DWORD *)(v1 + 1856) = 726136;
  if ( !v7 )
  {
    v5 = -2147418111;
LABEL_31:
  ...
  *(_DWORD *)(v1 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0085313 >= 4u )
    WPP_SF_q(0x44u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, v1);
...
LABEL_32:
  if ( (unsigned __int8)byte_1C0085318 >= 4u )
    WPP_SF_qq(0x45u, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, v1);
  return v5;
}
