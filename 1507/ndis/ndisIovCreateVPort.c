/*
 * XREFs of ndisIovCreateVPort @ 0x1C00D9748
 * Callers:
...
char __fastcall ndisIovCreateVPort(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_q(0x2Au, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v4);
...
LABEL_33:
  ...
  if ( *(_DWORD *)(v9 + 536) <= (unsigned int)(v11[13] - *((_DWORD *)SwitchBySwitchId + 24) - 1) )
    goto LABEL_21;
LABEL_6:
...
LABEL_45:
  ...
  if ( (unsigned __int8)byte_1C0085321 >= 4u )
    WPP_SF_qD(0x2Bu, &WPP_6c8db4fe7eb94b473a3ef095da1bfaf8_Traceguids, v4, *(_DWORD *)(a1 + 40));
  return v7;
}
