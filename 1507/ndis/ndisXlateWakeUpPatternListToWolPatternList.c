/*
 * XREFs of ndisXlateWakeUpPatternListToWolPatternList @ 0x1C00CCB18
 * Callers:
 *     ndisOidPostWolPatternList @ 0x1C0044F80 (ndisOidPostWolPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWakeUpPatternListToWolPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v5 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C0085312 >= 2u )
      WPP_SF_(0x74u, &WPP_fbb1998797815902974a7c4233493709_Traceguids);
    return;
  }
  if ( !(_DWORD)v5 )
    return;
