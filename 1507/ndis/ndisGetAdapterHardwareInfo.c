/*
 * XREFs of ndisGetAdapterHardwareInfo @ 0x1C00D0AB4
 * Callers:
  ...
  *a3 = -1073741823;
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v6 + 48) + 24LL) + 24LL) )
  {
    ...
    *((_BYTE *)v10 + 13) = *(_BYTE *)(a1 + 33);
    ...
    if ( v12 )
    {
      *(_OWORD *)(v10 + 6) = *(_OWORD *)(a1 + 3672);
      *((_QWORD *)v10 + 5) = *(_QWORD *)(a1 + 3688);
      *((_QWORD *)v10 + 6) = *(_QWORD *)(a1 + 3696);
      v10[14] = *(_DWORD *)(a1 + 3704);
      if ( *(_BYTE *)(v12 + 192) )
      {
        v13 = v10[1] | 4;
        v10[1] = v13;
        if ( *(_BYTE *)(v12 + 193) )
        {
          ...
          if ( *(_BYTE *)(a1 + 3696) == 17 )
          {
            v16 = v10[1] | 0x10;
            v10[1] = v16;
            v10[4] = (*(_WORD *)(a1 + 3698) & 0x7FF) + 1;
            if ( *(__int16 *)(a1 + 3698) < 0 )
              v10[1] = v16 | 0x20;
          }
        }
        else
