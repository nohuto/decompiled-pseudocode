/*
 * XREFs of ndisPnPIrpQueryRemove @ 0x1C00D4C18
 * Callers:
...
__int64 __fastcall ndisPnPIrpQueryRemove(__int64 a1, __int64 a2, __int64 a3, __int64 a4, bool *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0085310 >= 4u )
    WPP_SF_qZ(0x23u, &WPP_8f6d621b9670942a7823ab6ddc5f2e50_Traceguids, a2, *(__int64 **)(a2 + 3912));
  ndisLogMiniportEvent(a2, 0x21u);
  if ( !*(_DWORD *)(a2 + 3504) )
  {
    ndisPowerSaveStop((struct _NDIS_MINIPORT_BLOCK *)a2, 1);
    KeWaitForSingleObject((PVOID)(a2 + 4280), Executive, 0, 0, 0LL);
