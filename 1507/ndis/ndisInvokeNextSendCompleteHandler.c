/*
 * XREFs of ndisInvokeNextSendCompleteHandler @ 0x1C0054578
 * Callers:
 ...
 *     ndisFakeFilterSendHandler @ 0x1C0053FF0 (ndisFakeFilterSendHandler.c)
 * Callees:
        ...
        void (*a6)(void))
{
  ...
  if ( ndisIterativeDataPathDisabled || (a2 & 1) == 0 && KeGetCurrentIrql() != 2 )
  {
    if ( a3->Header.Type == 5 )
    {
      ...
      v31 = 1LL;
      v30 = 0;
      if ( ndisExpandStack((void (*)(void *))ndisDataPathExpandStackCallback, v25) < 0 )
