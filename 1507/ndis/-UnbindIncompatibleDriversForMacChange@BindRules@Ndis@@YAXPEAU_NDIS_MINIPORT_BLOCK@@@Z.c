/*
 * XREFs of ?UnbindIncompatibleDriversForMacChange@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00A4708
 * Callers:
      ...
      if ( (v20 & 0x40) == 0 || (*(_DWORD *)(v17 + 64) & 4) != 0 )
      {
        ...
        *(_DWORD *)(v22 + 48) = v23 & 0xFFBFFFFF;
        ...
        else
        {
          ...
          if ( !*(_BYTE *)(*(_QWORD *)(v22 + 16) + 5313LL) )
            *(_BYTE *)(*(_QWORD *)(v22 + 16) + 5312LL) = 1;
          v24 = 1;
        }
        if ( v24 && (unsigned __int8)byte_1C0085323 >= 4u )
        {
          ndisGetBindLinkNameForTracing(
