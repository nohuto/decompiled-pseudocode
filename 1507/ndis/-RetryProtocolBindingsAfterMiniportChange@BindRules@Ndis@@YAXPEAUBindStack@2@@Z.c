/*
 * XREFs of ?RetryProtocolBindingsAfterMiniportChange@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00A44A8
 * Callers:
  ...
  if ( *((_DWORD *)this + 24) )
  {
      ...
      *(_DWORD *)(v6 + 48) = v7 & 0xFFFBFFE3;
      ...
      else
      {
        if ( (unsigned __int8)byte_1C0085323 >= 5u )
          WPP_SF_dd(0xEu, &WPP_eaee9154efd950f31d396ed7715513d8_Traceguids, v7, v7 & 0xFFFBFFE3);
      ...
      if ( v8 && (unsigned __int8)byte_1C0085323 >= 4u )
      {
        ...
        if ( (unsigned __int8)byte_1C0085323 >= 4u )
          WPP_SF_Zq(0x19u, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v16, v15);
      }
    }
    v9 = *((_DWORD *)this + 4);
    for ( j = 0LL; (_DWORD)j != v9; j = (unsigned int)(j + 1) )
    {
      ...
      *(_DWORD *)(v12 + 48) = v13 & 0xFFFBFFE3;
      ...
      {
        if ( (unsigned __int8)byte_1C0085323 >= 5u )
          WPP_SF_dd(0xEu, &WPP_eaee9154efd950f31d396ed7715513d8_Traceguids, v13, v13 & 0xFFFBFFE3);
      ...
      if ( v14 && (unsigned __int8)byte_1C0085323 >= 4u )
      {
        ndisGetBindLinkNameForTracing(
          *(struct NDIS_BIND_PROTOCOL_LINK **)(v11 + 8 * j),
          (struct NDIS_PNPTRACE_LOCALS *)&v15);
        WPP_SF_Zq(0x1Au, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v16, v15);
      }
    }
  }
}
