/*
 * XREFs of ndisOidTranslateBetweenOids @ 0x1C0007CFC
 * Callers:
...
__int64 __fastcall ndisOidTranslateBetweenOids(_BYTE *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(230LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a3);
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    return WPP_SF_q(231LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a3);
  return result;
}
