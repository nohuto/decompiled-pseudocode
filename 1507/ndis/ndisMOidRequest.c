/*
 * XREFs of ndisMOidRequest @ 0x1C0007ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisMOidRequest(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqd(14LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, a2, v2);
  v8 = 0;
  if ( (unsigned __int8)byte_1C008531B >= 4u )
    WPP_SF_qD(104LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, a1, 6LL);
...
LABEL_38:
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqqDD(15LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, v4, a2, v20, v3);
  return v3;
}
