/*
 * XREFs of NdisMSetAttributesEx @ 0x1C00E7E60
 * Callers:
        ...
        NDIS_INTERFACE_TYPE AdapterType)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x5Bu, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 727126;
  ...
  *((_QWORD *)MiniportAdapterHandle + 65) = KeGetCurrentThread();
  v15 = v14;
  *((_DWORD *)MiniportAdapterHandle + 464) = 727289;
  ndisSetMiniportHandlers(MiniportAdapterHandle);
  *((_QWORD *)MiniportAdapterHandle + 65) = 0LL;
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  KeReleaseSpinLock((PKSPIN_LOCK)MiniportAdapterHandle + 12, v15);
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x5Cu, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, (__int64)MiniportAdapterHandle);
}
