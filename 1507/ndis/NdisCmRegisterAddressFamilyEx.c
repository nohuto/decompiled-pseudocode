/*
 * XREFs of NdisCmRegisterAddressFamilyEx @ 0x1C004C300
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisCmRegisterAddressFamilyEx(NDIS_HANDLE NdisBindingHandle, PCO_ADDRESS_FAMILY AddressFamily)
{
  ...
  if ( (unsigned __int8)byte_1C008531A >= 4u )
    WPP_SF_qqq(0x45u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, v3, v5, NdisBindingHandle);
        ...
        if ( *(_BYTE *)(v5 + 56) >= 5u )
        {
          ...
          if ( PoolWithTag )
          {
            ...
            else
            {
              ...
              *((_QWORD *)NdisBindingHandle + 129) = *(_QWORD *)(v5 + 640);
              *((_QWORD *)NdisBindingHandle + 130) = *(_QWORD *)(v5 + 648);
              *((_QWORD *)NdisBindingHandle + 131) = *(_QWORD *)(v5 + 728);
              *((_QWORD *)NdisBindingHandle + 132) = *(_QWORD *)(v5 + 736);
              *((_QWORD *)NdisBindingHandle + 142) = *(_QWORD *)(v5 + 760);
              *((_QWORD *)NdisBindingHandle + 143) = *(_QWORD *)(v5 + 752);
              if ( v13 )
...
LABEL_26:
  ...
  *(_DWORD *)(v3 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C008531A >= 4u )
    WPP_SF_qqqL(0x46u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, v3, v5, NdisBindingHandle, v8);
  return v8;
}
