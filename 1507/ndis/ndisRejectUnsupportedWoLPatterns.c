/*
 * XREFs of ndisRejectUnsupportedWoLPatterns @ 0x1C00CB45C
 * Callers:
    ...
    if ( !ndisIsWoLPacketTypeSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0085315 >= 2u )
          WPP_SF_d(0x7Cu, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0085315 >= 2u )
          WPP_SF_d(0x7Du, &WPP_fbb1998797815902974a7c4233493709_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3976), 0, 1, 0);
    }
  }
