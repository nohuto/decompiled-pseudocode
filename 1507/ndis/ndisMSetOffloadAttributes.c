/*
 * XREFs of ndisMSetOffloadAttributes @ 0x1C009F4EC
 * Callers:
 ...
 *     ndisValidateOffloadCapability @ 0x1C009F84C (ndisValidateOffloadCapability.c)
 *     ndisValidateConnectionOffload @ 0x1C00D7618 (ndisValidateConnectionOffload.c)
 */
