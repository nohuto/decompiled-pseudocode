/*
 * XREFs of ndisPreTaskOffloadQuery @ 0x1C0042E14
 * Callers:
...
char __fastcall ndisPreTaskOffloadQuery(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqDD(0xC9u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v6, a1, 1, *(_DWORD *)(a2 + 40));
  if ( !*(_QWORD *)(v6 + 4152) )
    goto LABEL_16;
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
  {
    ...
    LODWORD(v13) = 1;
    WPP_SF_qqDD(0xCAu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v6, a1, v13, v14);
  }
  return 1;
}
