/*
 * XREFs of NdisMRegisterDmaChannel @ 0x1C00F4210
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG MaximumLength)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x24u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  *(_DWORD *)&DeviceDescription[20] = v9;
    ...
    && (v18 = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x38uLL, 0x6264444Eu), (v19 = v18) != 0LL) )
  {
    ...
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x25u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, v22);
...
LABEL_21:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x26u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)MiniportAdapterHandle, v12);
  return v12;
}
