/*
 * XREFs of ndisOidPreTcpConnectionOffloadParameters @ 0x1C00C7EA0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreTcpConnectionOffloadParameters(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(0xDEu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v2, v4);
    v7 = byte_1C0085312;
  }
  ...
  {
    v10 = v3;
    WPP_SF_qdD(0xDFu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v2, *(_DWORD *)(a1 + 40), v10);
  }
  return v3;
}
