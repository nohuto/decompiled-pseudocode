/*
 * XREFs of ?NdisTraceLoggingUnexpectedSelectiveSuspendError@@YAXPEAU_NDIS_MINIPORT_BLOCK@@G@Z @ 0x1C006F1C8
 * Callers:
...
void __fastcall NdisTraceLoggingUnexpectedSelectiveSuspendError(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0084040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v7 = 16;
      v10 = 4;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C0074ADE, v2, v3, 4u, &pData);
    }
  }
}
