/*
 * XREFs of ?NdisPDPIQueueControl@@YAJPEAU_NDIS_PD_QUEUE@@W4NDIS_PD_CONTROL_TYPE@@W4NDIS_PD_QUEUE_CONTROL_CODE@@PEAXK3KPEAK@Z @ 0x1C00DFB50
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
    WPP_SF_qdD(0x34u, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, a2, a3);
  if ( a3 != 1 )
  {
    if ( a3 <= 1 )
      goto LABEL_35;
...
LABEL_26:
  ...
  if ( (v15 & 0x80000000) == 0 )
  {
    ...
    WPP_SF_qD(v18, &WPP_907f2c296662aafae9742c49c7fcbed7_Traceguids, a1, v17);
  }
LABEL_12:
  if ( (unsigned __int8)byte_1C0085324 >= 4u )
  {
