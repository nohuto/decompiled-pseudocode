/*
 * XREFs of ndisOidPreSupportedList @ 0x1C001DA20
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreSupportedList(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(79LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1);
...
LABEL_14:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(80LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1);
  return v4;
}
