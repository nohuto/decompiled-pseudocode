/*
 * XREFs of ?ndisBindReadFilterDriverFromV1Registry@@YA_NPEAUNDIS_BIND_FILTER_DRIVER@@@Z @ 0x1C00B2FF8
 * Callers:
  ...
  if ( v2 < 0 )
  {
    if ( v2 == -1073741772 )
    {
      if ( (unsigned __int8)byte_1C0085311 >= 2u )
        WPP_SF_S(0x12u, &WPP_10e48bb64bbb401b7e1b3e1f08acf4e0_Traceguids, Dest);
    }
    else if ( (unsigned __int8)byte_1C0085311 >= 2u )
    {
      WPP_SF_Sd(0x13u, &WPP_10e48bb64bbb401b7e1b3e1f08acf4e0_Traceguids, Dest, v2);
    }
