/*
 * XREFs of ?ndisIfQuerySetMiniport@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C00C5DDC
 * Callers:
        ...
        struct _NDIS_FILTER_BLOCK *a3)
{
  ...
  if ( (unsigned __int8)ndisReferenceMiniportByHandleForNsi((__int64)a1) )
  {
    ...
    ndisDereferenceMiniportForNsi((__int64)a1, 4u, 0x3Bu);
  }
  return SetMiniport;
}
