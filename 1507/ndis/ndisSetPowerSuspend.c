/*
 * XREFs of ndisSetPowerSuspend @ 0x1C00DCF6C
 * Callers:
...
__int64 __fastcall ndisSetPowerSuspend(PIRP Irp, POWER_STATE *a2, struct _NDIS_MINIPORT_BLOCK *a3)
{
  ...
  *(_DWORD *)&v11[48] = 20;
  ...
  if ( v6 )
  {
    NdisUnexpectedSsError(a3, 0x34Cu);
    if ( (unsigned __int8)byte_1C0085316 >= 2u )
    {
      v7 = 19;
LABEL_11:
      WPP_SF_dq(v7, &WPP_a612080d527c97bcc88e648492c760b7_Traceguids, v6, a3);
    }
  }
  else
  {
    ...
    *(_DWORD *)&v11[48] = 4;
    ...
    NdisUnexpectedSsError(a3, 0x36Eu);
    if ( (unsigned __int8)byte_1C0085316 >= 2u )
    {
      v7 = 20;
      goto LABEL_11;
