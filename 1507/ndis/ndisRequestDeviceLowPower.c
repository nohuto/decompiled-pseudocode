/*
 * XREFs of ndisRequestDeviceLowPower @ 0x1C009BD90
 * Callers:
        ...
        enum _NDIS_MINIPORT_EVENT a5)
{
  ...
  else
  {
    v10 = PoRequestPowerIrp(
            ...
            0LL);
    v11 = v10;
    if ( v10 != 259 && (unsigned __int8)byte_1C0085315 >= 2u )
      WPP_SF_dq(0x92u, &WPP_c4e795ca9bdbbe3c2f2c5e0647b399a0_Traceguids, v10, a1);
  }
