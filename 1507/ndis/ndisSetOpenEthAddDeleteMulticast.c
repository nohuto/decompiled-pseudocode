/*
 * XREFs of ndisSetOpenEthAddDeleteMulticast @ 0x1C009E144
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenEthAddDeleteMulticast(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqq(0x68u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v3, a1, a2);
  IsValidMulticastFilter = ndisIsValidMulticastFilter(*(_QWORD *)(a1 + 16), a1, a2);
  if ( IsValidMulticastFilter )
  {
    if ( (unsigned __int8)byte_1C0085312 < 4u )
      goto LABEL_35;
    WPP_SF_(0x69u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids);
LABEL_33:
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
      WPP_SF_qqqDD(0x6Bu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v3, a1, a2, IsValidMulticastFilter, v4);
LABEL_35:
    if ( !IsValidMulticastFilter )
      goto LABEL_36;
    goto LABEL_54;
...
LABEL_32:
  ...
  *(_DWORD *)(a2 + 56) = 0;
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
  {
    WPP_SF_qqq(0x6Au, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v3, a1, a2);
    goto LABEL_33;
  }
LABEL_54:
