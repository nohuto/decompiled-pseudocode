/*
 * XREFs of ndisIMQueueDeviceInstance @ 0x1C00CE588
 * Callers:
...
__int64 __fastcall ndisIMQueueDeviceInstance(__int64 a1, const UNICODE_STRING *a2, wchar_t *a3)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x26u, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a1, a2, a3);
...
LABEL_11:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqqL(0x27u, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a1, a2, a3, v6);
  return v6;
}
