/*
 * XREFs of ?ndisCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C0069F50
 * Callers:
 *     ndisWnfPdcCallback @ 0x1C004A9B0 (ndisWnfPdcCallback.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0022840 (__security_check_cookie.c)
 *     memset @ 0x1C0023A40 (memset.c)
 *     ?ndisAoAcWriteRefcountRundown@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@@Z @ 0x1C0069D90 (-ndisAoAcWriteRefcountRundown@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@@Z.c)
    ...
    if ( TotalCsResiliencyTime )
    {
      ...
      for ( i = 0; i < 0xF; ++i )
      {
        ...
        if ( TotalRefTime )
        {
          ...
          v33.Data4[0] = i;
          v23 = (&off_1C0076AE0)[2 * (int)i];
          v24 = *((_DWORD *)&off_1C0076AE0 + 4 * (int)i + 2);
