/*
 * XREFs of NdisMRestartComplete @ 0x1C0017830
 * Callers:
...
void __stdcall NdisMRestartComplete(NDIS_HANDLE MiniportAdapterHandle, NDIS_STATUS Status)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(143LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, MiniportAdapterHandle);
  ...
  *((_QWORD *)MiniportAdapterHandle + 283) = 0LL;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(144LL, &WPP_9f38f38531f8ddee2755f96b3c07d5ed_Traceguids, MiniportAdapterHandle);
}
