/*
 * XREFs of ndisCompleteLegacyRequest @ 0x1C003FB50
 * Callers:
...
void __fastcall ndisCompleteLegacyRequest(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqqL(0x49u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, v8, v7, a2);
  if ( v7 )
  {
    v9 = v7[8];
    ...
    if ( (unsigned __int8)byte_1C0085312 >= 4u )
      WPP_SF_qqd(74LL, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1, v8, a2);
  }
}
