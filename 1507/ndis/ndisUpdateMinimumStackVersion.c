/*
 * XREFs of ndisUpdateMinimumStackVersion @ 0x1C00A4F1C
 * Callers:
 ...
 * Callees:
 *     ?ndisFindMinimumVersionDrivers@@YAXPEAU_NDIS_MINIPORT_BLOCK@@KK@Z @ 0x1C00A4F64 (-ndisFindMinimumVersionDrivers@@YAXPEAU_NDIS_MINIPORT_BLOCK@@KK@Z.c)
