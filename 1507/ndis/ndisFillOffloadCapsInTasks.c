/*
 * XREFs of ndisFillOffloadCapsInTasks @ 0x1C00402D0
 * Callers:
...
void __fastcall ndisFillOffloadCapsInTasks(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_q(0xCDu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1);
    v8 = byte_1C0085312;
  }
  v9 = *(_QWORD *)(a2 + 40);
  v10 = 28;
  ...
  *(_DWORD *)(a2 + 52) = v10;
  if ( (unsigned __int8)v8 >= 4u )
    WPP_SF_q(0xCEu, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, a1);
}
