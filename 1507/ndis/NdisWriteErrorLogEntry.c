/*
 * XREFs of NdisWriteErrorLogEntry @ 0x1C0022190
 * Callers:
...
void NdisWriteErrorLogEntry(NDIS_HANDLE NdisAdapterHandle, ULONG ErrorCode, ULONG NumberOfErrorValues, ...)
{
  ...
  {
    WPP_SF_qD(10LL, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, NdisAdapterHandle, ErrorCode);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(11LL, &WPP_99d55c594fb658073ac0709936c97fa5_Traceguids, NdisAdapterHandle, ErrorCode);
}
