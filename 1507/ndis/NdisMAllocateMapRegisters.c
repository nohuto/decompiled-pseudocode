/*
 * XREFs of NdisMAllocateMapRegisters @ 0x1C00F3800
 * Callers:
 *     <none>
 * Callees:
...
LABEL_53:
  ...
  *((_QWORD *)v11 + 63) = v6;
  ...
  if ( v6[77] )
  {
    ...
    {
      WPP_SF_d(0x2Bu, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, v24);
      v25 = v32;
    }
...
LABEL_54:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x2Cu, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, (__int64)v11, v7);
  return v7;
}
