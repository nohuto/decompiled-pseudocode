/*
 * XREFs of ethDeleteOneOpenMulticastAddress @ 0x1C00D440C
 * Callers:
...
__int64 __fastcall ethDeleteOneOpenMulticastAddress(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_q(0xBu, &WPP_950a21ee35671e8e318a63209c7fb87a_Traceguids, a1);
...
LABEL_8:
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_dd(0xCu, &WPP_950a21ee35671e8e318a63209c7fb87a_Traceguids, (unsigned __int8)*a3, 0);
  return 0LL;
}
