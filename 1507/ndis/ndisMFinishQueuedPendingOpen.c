/*
 * XREFs of ndisMFinishQueuedPendingOpen @ 0x1C00F4650
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMFinishQueuedPendingOpen(__int64 *P)
{
  ...
  if ( (unsigned __int8)byte_1C008530D >= 4u )
    WPP_SF_q(0x12u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, v1);
  ...
  *(_DWORD *)(v3 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C008530D >= 4u )
    WPP_SF_q(0x13u, &WPP_816ff7a89d638f3657e368d6b001fcf6_Traceguids, v1);
}
