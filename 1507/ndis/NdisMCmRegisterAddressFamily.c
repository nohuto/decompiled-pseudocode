/*
 * XREFs of NdisMCmRegisterAddressFamily @ 0x1C00F2FD0
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT SizeOfCmCharacteristics)
{
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 1573202;
  ...
  else
  {
    ...
    if ( ndisReferenceMiniport((__int64)MiniportAdapterHandle, 0x4Du) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        *((_QWORD *)MiniportAdapterHandle + 64) = v14;
        ndisDereferenceMiniport((__int64)MiniportAdapterHandle, 0x4Du);
        v8 = 0;
      }
      else
      {
