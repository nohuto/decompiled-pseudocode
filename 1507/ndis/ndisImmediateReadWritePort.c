/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00CEC24
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00CE730 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00CE750 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00CE770 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00CE7B0 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00CE7E0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00CE810 (NdisImmediateWritePortUshort.c)
 * Callees:
