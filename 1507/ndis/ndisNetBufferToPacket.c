/*
 * XREFs of ndisNetBufferToPacket @ 0x1C0048048
 * Callers:
...
__int64 __fastcall ndisNetBufferToPacket(__int64 a1, char a2, PNDIS_PACKET *a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rdx
  $A0E05FEAC3FD075848533B542F2EA8C0 *ProtocolReserved; // r9
  _MDL *v10; // rcx
  __int64 v11; // r8
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($A0E05FEAC3FD075848533B542F2EA8C0 *)v8->ProtocolReserved;
    if ( !a2 )
