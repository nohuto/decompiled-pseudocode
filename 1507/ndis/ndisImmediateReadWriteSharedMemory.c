/*
 * XREFs of ndisImmediateReadWriteSharedMemory @ 0x1C00CED78
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00CE790 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00CE840 (NdisImmediateWriteSharedMemory.c)
 * Callees:
 *     ndisTranslateResources @ 0x1C00B1008 (ndisTranslateResources.c)
 *     ndisEndMapping @ 0x1C00CEC0C (ndisEndMapping.c)
 *     ndisStartMapping @ 0x1C00CEE4C (ndisStartMapping.c)
 */
