/*
 * XREFs of ndisOidPreMacAddress @ 0x1C00C71F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreMacAddress(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0xA2u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, v3);
    v5 = byte_1C0085312;
  }
...
LABEL_11:
  if ( (unsigned __int8)v5 >= 4u )
    WPP_SF_qD(0xA3u, &WPP_72ef677eb8bc3e91e72369ca310d6849_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v4;
}
