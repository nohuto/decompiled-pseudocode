/*
 * XREFs of ?QueryValueString@KRegKey@@QEAAJPEBU_UNICODE_STRING@@AEAV?$KPtr@UKString@Rtl@@U?$KDeletePtr@UKString@Rtl@@@@@@@Z @ 0x1C00A51F0
 * Callers:
...
__int64 __fastcall KRegKey::QueryValueString(HANDLE *a1, _UNICODE_STRING *a2, void **a3)
{
  ...
  *(_QWORD *)&v20.Length = 0LL;
  ...
  KPtr<unsigned char,KDeleteArray<unsigned char>>::reset(&v20, PoolWithTag);
  v6 = *(_BYTE **)&v20.Length;
  ...
  v10 = ZwQueryValueKey(*a1, a2, KeyValuePartialInformation, *(PVOID *)&v20.Length, ResultLength, &ResultLength);
  if ( v10 >= 0 )
  {
    v8 = v6;
LABEL_3:
    if ( *((_DWORD *)v8 + 1) == 1 )
    {
      ...
      else
      {
        ...
        v14 = Rtl::KString::Initialize(&v20);
        v15 = *a3;
        v16 = v14;
        if ( v14 != *a3 )
        {
