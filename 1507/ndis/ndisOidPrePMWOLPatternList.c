/*
 * XREFs of ndisOidPrePMWOLPatternList @ 0x1C00CA530
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMWOLPatternList(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqq(0x59u, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v4, v6, v8);
  v9 = *(_QWORD *)(a1 + 24);
  LOBYTE(a4) = 6;
  if ( v9
...
LABEL_31:
  if ( (unsigned __int8)byte_1C0085312 >= 4u )
    WPP_SF_qqqL(0x5Au, &WPP_fbb1998797815902974a7c4233493709_Traceguids, v4, v6, v8, *(_DWORD *)(a1 + 40));
  return v7;
}
