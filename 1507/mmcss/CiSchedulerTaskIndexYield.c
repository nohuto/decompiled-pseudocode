/*
 * XREFs of CiSchedulerTaskIndexYield @ 0x1C0001FA0
 * Callers:
...
void __fastcall CiSchedulerTaskIndexYield(__int64 a1, ULONG a2)
{
  ...
  *(_QWORD *)(a1 + 80) = v4;
  ...
  if ( CiSchedulerTimerResolutionState != 3 )
  {
    v13 = CiTransitionTimerResolutionState(2, CiSchedulerTimerResolutionState);
    CiSchedulerTimerResolutionState = v13;
    if ( v14 != 1 && v13 == 1 )
      CiSchedulerPoke(0LL);
  }
