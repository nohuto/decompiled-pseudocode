/*
 * XREFs of ?CheckRequiredRealizationBounds@CHwBitmapColorSource@@QEAA_NAEAV?$CDelayComputedBounds@URealizationSampling@CoordinateSpace@@@@W4Enum@MilBitmapInterpolationMode@@W43MilBitmapWrapMode@@W43RequiredBoundsCheck@1@@Z @ 0x18001D3B8
 * Callers:
...
char __fastcall CHwBitmapColorSource::CheckRequiredRealizationBounds(_DWORD *a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  *(_QWORD *)&v10 = 0LL;
  ...
  if ( (unsigned __int8)CHwBitmapColorSource::ComputeMinimumRealizationBounds(a2, v11, &v10) )
  {
    ...
    if ( TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::DoesContain(v9, (unsigned int *)&v10) )
    {
      v5 = 1;
      if ( a5 == 2 )
        *(_OWORD *)(a1 + 47) = v10;
