/*
 * XREFs of ?ConstructLocalToGlobalTransform@CInteractionProcessor@@AEAA?AUD2DMatrix@@PEAV?$DynArray@UD2DVector3@@$0A@@@@Z @ 0x18012DDD4
 * Callers:
...
__int64 __fastcall CInteractionProcessor::ConstructLocalToGlobalTransform(__int64 *a1, __int64 a2, __int64 *a3)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    do
    {
      ...
      v18 = *(_QWORD *)(v9 + *a3);
      v19 = v11;
      if ( CanAddThisColumnVectorToMatrix((__int64)v22, v6, (const struct D2DVector3 *)&v18) )
      {
        v12 = v6++;
        v13 = 3 * v12;
  ...
  ConvertVectorArrayToMatrix(a2, (int *)v22);
  if ( (unsigned int)pRelatedActivityId > 4 && (qword_180190AC0 & 2) != 0 && (qword_180190AC8 & 2) == qword_180190AC8 )
  {
    ...
    v49 = a2 + 40;
    v50 = 4LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_18016F66D, v14, v15, 0xFu, &pData);
  }
  return a2;
}
