/*
 * XREFs of ?EnsureMetadataBuffer@CIndirectSwapchainRenderTarget@@AEAAJXZ @ 0x1800EE234
 * Callers:
...
__int64 __fastcall CIndirectSwapchainRenderTarget::EnsureMetadataBuffer(CIndirectSwapchainRenderTarget *this)
{
  ...
  v1 = (char *)this + 384;
  *((_DWORD *)this + 102) = 0;
  DynArrayImpl<0>::ShrinkToSize((_QWORD *)this + 48, 1u);
  v3 = *((_QWORD *)this + 2);
  v30 = 4;
...
LABEL_10:
  ...
  if ( v5 > *((_DWORD *)v1 + 5) )
  {
    v11 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v1, 1u, 4, &v30);
    v6 = v11;
    if ( v11 < 0 )
...
LABEL_19:
  ...
  if ( v9 > *((_DWORD *)v1 + 5) )
  {
    v15 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v1, 1u, 16, &v31);
    v10 = v15;
    if ( v15 < 0 )
...
LABEL_29:
    ...
    if ( v13 > *((_DWORD *)v1 + 5) )
    {
      v21 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v1, 1u, 4, &v30);
      v14 = v21;
      if ( v21 < 0 )
...
LABEL_32:
    ...
    v25 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v1, 1u, 4, &v30);
    v20 = v25;
    if ( v25 < 0 )
  ...
  v27 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v1, 1u, 4, &v30);
  v26 = v27;
  if ( v27 < 0 )
...
LABEL_33:
  ...
  v28 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v1, 1u, 4, &v30);
  v24 = v28;
  if ( v28 < 0 )
