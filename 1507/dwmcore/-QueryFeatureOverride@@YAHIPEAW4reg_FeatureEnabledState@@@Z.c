/*
 * XREFs of ?QueryFeatureOverride@@YAHIPEAW4reg_FeatureEnabledState@@@Z @ 0x18010FED4
 * Callers:
 *     ?EvaluateCurrentStateFromRegistry@@YAHIW4reg_FeatureStage@@PECJ@Z @ 0x18010F2F0 (-EvaluateCurrentStateFromRegistry@@YAHIW4reg_FeatureStage@@PECJ@Z.c)
 * Callees:
...
__int64 __fastcall QueryFeatureOverride(unsigned int a1, enum reg_FeatureEnabledState *a2)
{
  ...
  StringCchPrintfW(&ValueName, 16LL, L"%lu", a1);
