/*
 * XREFs of ?RegisterForSignaling@CGdiSpriteBitmap@@UEAAJXZ @ 0x18007ED00
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::RegisterForSignaling(CGdiSpriteBitmap *this)
{
  ...
  if ( *((char *)this + 372) >= 0 )
  {
    ...
    if ( v4 == 1 )
    {
      v9 = CRedirectedGDISurface::SetInformation(v3 + 16, 1, 4u, &v14);
      v13 = v9;
      v1 = v9;
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_18016AB2C, 1u, v9, 0x6EBu);
        goto LABEL_9;
      }
    }
    else if ( v4 == 2 )
      ...
      if ( *((_DWORD *)this + 92) )
      {
        while ( 1 )
        {
          ...
          *(_QWORD *)&v12[12] = *((_QWORD *)this + v5 + 14);
          v7 = CRedirectedGDISurface::SetInformation(v6 + 16, 4, 0x20u, &v10);
          v13 = v7;
          v1 = v7;
          if ( v7 < 0 )
            break;
        ...
        MilInstrumentationCheckHR(0x14u, &dword_18016AB2C, 1u, v7, 0x6F9u);
        goto LABEL_9;
      }
    }
LABEL_8:
