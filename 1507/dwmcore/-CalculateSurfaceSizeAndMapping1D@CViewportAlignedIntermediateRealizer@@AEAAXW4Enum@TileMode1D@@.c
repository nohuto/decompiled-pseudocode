/*
 * XREFs of ?CalculateSurfaceSizeAndMapping1D@CViewportAlignedIntermediateRealizer@@AEAAXW4Enum@TileMode1D@@MMMMPEAHPEAIPEAM33@Z @ 0x1801227B8
 * Callers:
        ...
        _DWORD *a11)
{
  ...
  *a8 = v13;
  *a9 = (float)v13 / v11;
  *(_DWORD *)a10 = COERCE_UNSIGNED_INT((float)((float)v13 / v11) * a3) ^ _xmm;
  *a11 = 0;
  v14 = *a10;
  v15 = (float)(*a9 * a5) + *a10;
  v16 = (float)(*a9 * a6) + *a10;
