/*
 * XREFs of ?HasPrefilterScale@CSecondaryD2DBitmap@@IEBA_NXZ @ 0x180150FC4
 * Callers:
 *     ?GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z @ 0x180150F20 (-GetSize@CSecondaryD2DBitmap@@UEBAXPEAI0@Z.c)
