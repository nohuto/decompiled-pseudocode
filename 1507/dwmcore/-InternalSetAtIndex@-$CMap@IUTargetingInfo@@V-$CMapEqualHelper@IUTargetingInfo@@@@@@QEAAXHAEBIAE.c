/*
 * XREFs of ?InternalSetAtIndex@?$CMap@IUTargetingInfo@@V?$CMapEqualHelper@IUTargetingInfo@@@@@@QEAAXHAEBIAEBUTargetingInfo@@@Z @ 0x1801303FC
 * Callers:
 ...
 * Callees:
 *     ??0TargetingInfo@@QEAA@AEBU0@@Z @ 0x18012F7B8 (--0TargetingInfo@@QEAA@AEBU0@@Z.c)
 */
