/*
 * XREFs of ?RecordDisplayDriverName@CDwmCoreWinSqm@@SAXXZ @ 0x180124BF0
 * Callers:
 ...
 *     ??1CDisplayRegKey@@QEAA@XZ @ 0x180125B78 (--1CDisplayRegKey@@QEAA@XZ.c)
 *     ?ReadString@CDisplayRegKey@@QEAA_NPEBGKPEAG@Z @ 0x180125BA0 (-ReadString@CDisplayRegKey@@QEAA_NPEBGKPEAG@Z.c)
 */
