/*
 * XREFs of ?SaveRestoreWorker@CDxHandleAdvancedDirectFlipBitmapRealization@@QEAAJAEBVCRegion@@_N@Z @ 0x18014F498
 * Callers:
        ...
        char a3)
{
  ...
  ++*((_DWORD *)v31 + 128);
  v31 = v8;
  *((_DWORD *)v8 + 129) = GetCurrentThreadId();
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        if ( v13 >= 0 )
        {
          ...
          if ( a3 )
            (*(void (__fastcall **)(_QWORD))(**((_QWORD **)v8 + 69) + 888LL))(*((_QWORD *)v8 + 69));
          goto LABEL_21;
        }
