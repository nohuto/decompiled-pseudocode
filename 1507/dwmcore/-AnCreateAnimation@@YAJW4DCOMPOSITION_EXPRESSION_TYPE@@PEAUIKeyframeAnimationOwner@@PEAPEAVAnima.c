/*
 * XREFs of ?AnCreateAnimation@@YAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUIKeyframeAnimationOwner@@PEAPEAVAnimation@Animations@Components@@@Z @ 0x180153A60
 * Callers:
...
__int64 __fastcall AnCreateAnimation(int a1, __int64 a2, struct Components::Animations::Animation **a3)
{
  ...
  {
    v10 = 17LL;
    if ( a1 == 17 || (v10 = 34LL, a1 == 34) || (v10 = 51LL, a1 == 51) || (v10 = 68LL, a1 == 68) )
    {
      v8 = Components::Animations::Animation::ApiCreate(v7, a2, v10, &v11);
      if ( v8 >= 0 )
      {
        *a3 = v7;
        return 0;
