/*
 * XREFs of ?CreateAdapterDevicePair@CD3DDeviceTable@@AEAAJPEAVCDXGIAdapterLimited@@PEAI@Z @ 0x1800918B4
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  v22 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 16, 0x130u, 1, v9);
  v23 = v22;
  if ( v22 < 0 )
...
LABEL_7:
  ...
  {
    v24 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 48, 8u, 1, &v28);
    v23 = v24;
    if ( v24 < 0 )
...
LABEL_16:
        ...
        v26 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 112, 4u, 1, &v29);
        v23 = v26;
        if ( v26 < 0 )
    ...
    v25 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 80, 8u, 1, &v30);
    v23 = v25;
    if ( v25 < 0 )
