/*
 * XREFs of ?SetFlipExBitmap@CWindowNode@@AEAAJPEAVCCompositionSurfaceBitmap@@@Z @ 0x1801067A4
 * Callers:
...
__int64 __fastcall CWindowNode::SetFlipExBitmap(CWindowNode *this, struct CCompositionSurfaceBitmap *a2)
{
  ...
  v13 = a2;
  v2 = 0;
  if ( a2 && a2 != *((struct CCompositionSurfaceBitmap **)this + 150) )
  {
    v4 = (char *)this + 1208;
    v5 = 0;
    for ( i = (struct CCompositionSurfaceBitmap **)*((_QWORD *)this + 151); v5 < *((_DWORD *)v4 + 6); ++i )
    {
      if ( a2 == *i )
        break;
      ++v5;
    }
    if ( v5 >= *((_DWORD *)this + 308) )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0xA5Du);
        return v2;
      }
      v8 = *((_DWORD *)v4 + 6);
      v9 = v8 + 1;
      ...
      v11 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v4, 8u, 1, &v13);
      v10 = v11;
      if ( v11 < 0 )
      ...
      if ( v10 < 0 )
LABEL_16:
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0xA5Eu);
    }
  }
  return v2;
}
