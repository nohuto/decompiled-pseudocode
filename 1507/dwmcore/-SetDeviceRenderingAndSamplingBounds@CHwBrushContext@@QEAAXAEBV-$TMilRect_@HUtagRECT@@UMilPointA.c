/*
 * XREFs of ?SetDeviceRenderingAndSamplingBounds@CHwBrushContext@@QEAAXAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@@@@Z @ 0x1800833D8
 * Callers:
 ...
 *     ?SetDeviceSamplingBounds@CHwBrushContext@@QEAAXAEBV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x18009B0FC (-SetDeviceSamplingBounds@CHwBrushContext@@QEAAXAEBV-$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z.c)
 */
