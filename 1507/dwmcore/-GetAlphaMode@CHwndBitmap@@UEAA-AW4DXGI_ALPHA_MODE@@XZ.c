/*
 * XREFs of ?GetAlphaMode@CHwndBitmap@@UEAA?AW4DXGI_ALPHA_MODE@@XZ @ 0x18010AAB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwndBitmap::GetAlphaMode(CHwndBitmap *this)
{
  ...
  if ( v1 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)v1 + 48LL))(*((_QWORD *)this + 56), 32LL) )
    {
      v4 = (CWindowNode *)*((_QWORD *)this + 56);
      if ( (*((_BYTE *)v4 + 1144) & 1) != 0
