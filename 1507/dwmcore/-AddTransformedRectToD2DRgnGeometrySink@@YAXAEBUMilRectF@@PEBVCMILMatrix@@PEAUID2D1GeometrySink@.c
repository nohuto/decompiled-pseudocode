/*
 * XREFs of ?AddTransformedRectToD2DRgnGeometrySink@@YAXAEBUMilRectF@@PEBVCMILMatrix@@PEAUID2D1GeometrySink@@@Z @ 0x18005BBFC
 * Callers:
        ...
        struct ID2D1GeometrySink *a3)
{
  ...
  if ( a2 )
  {
    CBaseMatrix::Transform(a2, (const struct MilPoint2F *)&v7, (struct MilPoint2F *)v15, 4u);
    v6 = (unsigned int *)v15;
  }
  else
  {
