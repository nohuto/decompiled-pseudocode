/*
 * XREFs of ?IsDirectRenderingToDisplayRenderTarget@CDrawingContext@@QEAA_NXZ @ 0x1800296F4
 * Callers:
...
__int64 __fastcall CDrawingContext::IsDirectRenderingToDisplayRenderTarget(CDrawingContext *this)
{
  __int64 result; // rax
