/*
 * XREFs of ?GetD2DContext@CHwDisplayRenderTarget@@UEAAJPEAPEAVID2DContext@@@Z @ 0x1800445A0
 * Callers:
 *     ?GetD2DContext@CHwDisplayRenderTarget@@WLA@EAAJPEAPEAVID2DContext@@@Z @ 0x18009AC70 (-GetD2DContext@CHwDisplayRenderTarget@@WLA@EAAJPEAPEAVID2DContext@@@Z.c)
 * Callees:
 *     ?AddRef@CD3DDeviceLevel1@@UEAAKXZ @ 0x180019280 (-AddRef@CD3DDeviceLevel1@@UEAAKXZ.c)
