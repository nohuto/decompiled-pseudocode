/*
 * XREFs of ?CopyFromTexture@CDWMOffScreenSwapChain@@QEAAJPEBUtagRECT@@@Z @ 0x18008C72C
 * Callers:
...
__int64 __fastcall CDWMOffScreenSwapChain::CopyFromTexture(CDWMOffScreenSwapChain *this, const struct tagRECT *a2)
{
  ...
  if ( *((_QWORD *)this + 48) )
  {
    ...
    *(_QWORD *)&v16 = "DWM Offscreen SwapChain Readback";
    ...
    {
LABEL_4:
      (*(void (__fastcall **)(_QWORD, struct ID3D11Texture2D *, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 37) + 552LL)
                                                                       + 376LL))(
        *(_QWORD *)(*((_QWORD *)this + 37) + 552LL),
        *v5,
        *((_QWORD *)this + 36));
      v11 = (*(__int64 (__fastcall **)(_QWORD, struct ID3D11Texture2D *, _QWORD, __int64, _DWORD, unsigned __int8 **))(**(_QWORD **)(*((_QWORD *)this + 37) + 552LL) + 112LL))(
              *(_QWORD *)(*((_QWORD *)this + 37) + 552LL),
              *v5,
              0LL,
              1LL,
