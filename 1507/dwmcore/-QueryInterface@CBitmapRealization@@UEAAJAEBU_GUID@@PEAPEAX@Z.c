/*
 * XREFs of ?QueryInterface@CBitmapRealization@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180046670
 * Callers:
 ...
 *     ?QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009BF10 (-QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009BF20 (-QueryInterface@CBitmapRealization@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009BF30 (-QueryInterface@CBitmapRealization@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
{
  __int64 v4; // rax
  __int64 (__fastcall *v5)(CBitmapRealization *__hidden, const struct _GUID *, void **); // rsi
  __int64 v6; // rax
  __int64 v7; // rax
  __int64 v8; // rax
  int v9; // esi
