/*
 * XREFs of ?OpenIndirectSwapchain@CD3DDeviceLevel1@@QEAAJPEAPEAXPEAPEAUIDXGIIndirectSwapChain@@PEAI2PEAW4DXGI_FORMAT@@@Z @ 0x1801343C0
 * Callers:
        ...
        enum DXGI_FORMAT *a6)
{
  ...
  v6 = (__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))*((_QWORD *)this + 65);
  v24 = a6;
  v22 = 0LL;
  v20 = 0LL;
  v19 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x7E7u);
LABEL_9:
    v16 = v19;
    goto LABEL_13;
  }
  v13 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, int, int, struct IDXGIIndirectSwapChain **))(**(_QWORD **)(*((_QWORD *)this + 70) + 40LL) + 32LL))(
          *(_QWORD *)(*((_QWORD *)this + 70) + 40LL),
          v22,
          *a2,
          0LL,
          5,
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x7F3u);
    goto LABEL_9;
  }
  *a2 = 0LL;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x7FAu);
    goto LABEL_9;
  }
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x7FBu);
    goto LABEL_9;
  }
