/*
 * XREFs of ?Calculate@Sequence@Animations@Components@@QEAAXXZ @ 0x180156314
 * Callers:
...
LABEL_15:
  ...
  else
  {
    ...
    (*(void (__fastcall **)(_QWORD, __int64, _QWORD, __int128 *, __int128 *, __int128 *))(**(_QWORD **)(v12 + 8 * v15 + 16)
                                                                                        + 8LL))(
      *(_QWORD *)(v12 + 8 * v15 + 16),
      v16,
