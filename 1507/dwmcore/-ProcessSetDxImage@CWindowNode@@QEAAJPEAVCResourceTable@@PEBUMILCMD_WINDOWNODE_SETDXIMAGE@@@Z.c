/*
 * XREFs of ?ProcessSetDxImage@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUMILCMD_WINDOWNODE_SETDXIMAGE@@@Z @ 0x18007943C
 * Callers:
        ...
        const struct MILCMD_WINDOWNODE_SETDXIMAGE *a3)
{
  ...
  v5 = 0LL;
  if ( !v3
    || ((Resource = CResourceTable::GetResource((__int64)a2, v3, 78LL)) == 0
      ? (v5 = 0LL)
        ...
        v5) )
  {
    ...
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x80Eu);
  }
  else
  {
    v8 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x80Au);
  }
  return v8;
}
