/*
 * XREFs of ?RealizeBitmapSource@@YAJQEAUHMONITOR__@@AEBU_GUID@@PEAVIBitmapSource@@PEBUPixelFormatInfo@@@Z @ 0x180125678
 * Callers:
  ...
  if ( CurrentDisplaySet >= 0 )
  {
    if ( a1 )
    {
      ...
      if ( DisplayByHMonitor )
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x3EDu);
    }
    else
    {
      v12 = *((_DWORD *)v16 + 18);
