/*
 * XREFs of ?SetMultiplaneOverlayPresentInfo@CHwFullScreenRenderTarget@@UEAAJ_NIPEAU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@@Z @ 0x1801405D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *a4)
{
  ...
  if ( v4 )
  {
    ...
    {
      LOBYTE(v10) = a2;
      v11 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *))(**((_QWORD **)this + 4) + 176LL))(
              *((_QWORD *)this + 4),
              v10,
              a3,
              a4);
