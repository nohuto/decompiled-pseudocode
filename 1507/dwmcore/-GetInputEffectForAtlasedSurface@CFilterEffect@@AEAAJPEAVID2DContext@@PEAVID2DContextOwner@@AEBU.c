/*
 * XREFs of ?GetInputEffectForAtlasedSurface@CFilterEffect@@AEAAJPEAVID2DContext@@PEAVID2DContextOwner@@AEBUtagRECT@@PEAVCCompositionSurfaceBitmap@@PEAPEAUID2D1Effect@@@Z @ 0x180111B20
 * Callers:
        ...
        struct ID2D1Effect **a6)
{
  ...
  D2DBitmapRealizationForContextOwner = CCompositionSurfaceBitmap::GetD2DBitmapRealizationForContextOwner(
                                          (struct CCompositionSurfaceBitmap *)((char *)a5 + 64),
                                          a3,
                                          &v23);
  ...
  if ( D2DBitmapRealizationForContextOwner >= 0 )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v13 >= 0 )
      {
        ...
        if ( v16 >= 0 )
        {
          ...
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0x31Fu);
          }
        }
        else
        {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x30Eu);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealizationForContextOwner, 0x30Cu);
  }
  if ( v23 )
