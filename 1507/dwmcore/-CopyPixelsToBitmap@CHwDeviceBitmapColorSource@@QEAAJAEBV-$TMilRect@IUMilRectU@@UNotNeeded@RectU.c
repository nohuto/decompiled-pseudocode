/*
 * XREFs of ?CopyPixelsToBitmap@CHwDeviceBitmapColorSource@@QEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IPEBV2@PEAVIBitmapDest@@HH@Z @ 0x18013EB1C
 * Callers:
        ...
        __int64 a5)
{
  ...
  ++*(_DWORD *)(v5 + 512);
  v54 = 0LL;
  *(_DWORD *)(v5 + 516) = GetCurrentThreadId();
  v71 = *a2;
  ...
  if ( *(_DWORD *)(a1 + 152) == DisplayId::None )
  {
    ...
    if ( D3DSurfaceLevel < 0 )
    {
      ...
      v21 = *(__int64 **)(v19 + 984);
      v22 = (__int64 *)(v19 + 976);
      while ( v21 != v22 && *((_DWORD *)v21 + 8) == *(_DWORD *)(v19 + 904) )
      {
        *((_DWORD *)v21 + 8) = 0;
        v21 = (__int64 *)v21[1];
      }
    ...
    if ( v28 >= 0 )
    {
      v29 = *(__int64 **)(v19 + 984);
      v30 = (__int64 *)(v19 + 976);
      while ( v29 != v30 && *((_DWORD *)v29 + 8) == *(_DWORD *)(v19 + 904) )
      {
        *((_DWORD *)v29 + 8) = 0;
        v29 = (__int64 *)v29[1];
      }
