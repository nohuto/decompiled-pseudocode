/*
 * XREFs of ?AddOrArrangeChild@CCoRenderVisualProxy@@UEAAJPEAUIDWMCoRenderVisualProxy@@0_N@Z @ 0x1800F5270
 * Callers:
 *     <none>
 * Callees:
...
LABEL_38:
    ...
    {
LABEL_36:
      inserted = CVisual::InsertChildAt(*((CVisual **)this + 3), *((struct CVisual **)a2 + 3), v11, 0);
      v5 = inserted;
      if ( inserted < 0 )
      {
        v23 = 261;
