/*
 * XREFs of ??0?$TValueResource@U_MilMatrix3x2D@@UMILCMD_MATRIXRESOURCE@@$0CP@@@IEAA@PEAVCComposition@@@Z @ 0x1800F8588
 * Callers:
...
__int64 __fastcall TValueResource<_MilMatrix3x2D,MILCMD_MATRIXRESOURCE,47>::TValueResource<_MilMatrix3x2D,MILCMD_MATRIXRESOURCE,47>(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
