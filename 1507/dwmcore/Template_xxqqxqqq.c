/*
 * XREFs of Template_xxqqxqqq @ 0x18010A36C
 * Callers:
 *     ?TraceBuffer@CFlipChain@@AEAAXI@Z @ 0x180109D64 (-TraceBuffer@CFlipChain@@AEAAXI@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x180097C20 (__security_check_cookie.c)
 */

ULONG Template_xxqqxqqq(__int64 a1, __int64 a2, ...)
{
  ...
  va_list v16; // [rsp+90h] [rbp+7h]
  __int64 v17; // [rsp+98h] [rbp+Fh]
  __int64 v18; // [rsp+D0h] [rbp+47h] BYREF
  ...
  __int64 v24; // [rsp+E8h] [rbp+5Fh] BYREF
  ...
  va_list va7; // [rsp+108h] [rbp+7Fh] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v15 = 4LL;
  v17 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_ETWGUID_FLIPCHAIN_BUFFER, 8u, &UserData);
}
