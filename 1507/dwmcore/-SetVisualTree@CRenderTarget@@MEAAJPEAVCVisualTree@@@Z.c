/*
 * XREFs of ?SetVisualTree@CRenderTarget@@MEAAJPEAVCVisualTree@@@Z @ 0x1800585D0
 * Callers:
  ...
  if ( a2 != v4 )
  {
    ...
    if ( a2 )
    {
      ...
      else
      {
        if ( v7 <= *((_DWORD *)a2 + 181) )
        {
          *(_QWORD *)(*((_QWORD *)a2 + 88) + 8LL * v6) = v11;
          *((_DWORD *)a2 + 182) = v7;
LABEL_7:
          *((_BYTE *)this + 64) = 1;
          *((_QWORD *)this + 7) = a2;
        ...
        v10 = DynArrayImpl<0>::AddMultipleAndSet((__int64)a2 + 704, 8u, 1, &v11);
        v3 = v10;
        if ( v10 >= 0 )
        {
LABEL_17:
