/*
 * XREFs of ?Create@CBoundsBitmap@@SAJPEAVCImageSource@@PEAPEAV1@@Z @ 0x18005F1C4
 * Callers:
...
__int64 __fastcall CBoundsBitmap::Create(struct CImageSource *a1, struct CBoundsBitmap **a2)
{
  ...
  *a2 = 0LL;
  v2 = (char *)a1 + 8;
  v4 = (*(__int64 (__fastcall **)(char *, _QWORD, _QWORD, float *))(*((_QWORD *)a1 + 1) + 184LL))(
         (char *)a1 + 8,
         0LL,
         0LL,
         v18);
...
LABEL_13:
  ...
  v4 = (*(__int64 (__fastcall **)(char *, unsigned __int64 *, _BYTE *))(*(_QWORD *)v2 + 192LL))(v2, &v16, v17);
  v5 = v4;
  if ( v4 < 0 )
  {
    v13 = 36;
