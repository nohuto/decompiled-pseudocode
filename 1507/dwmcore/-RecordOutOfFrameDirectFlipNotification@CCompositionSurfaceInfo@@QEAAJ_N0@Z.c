/*
 * XREFs of ?RecordOutOfFrameDirectFlipNotification@CCompositionSurfaceInfo@@QEAAJ_N0@Z @ 0x1800076CC
 * Callers:
        ...
        unsigned __int8 a3)
{
  ...
  {
    v3 = v4 | 0x10000000;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4 | 0x10000000, 0xD5u);
  }
  return v3;
}
