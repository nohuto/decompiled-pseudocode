/*
 * XREFs of ?RemoveAt@?$ArrayListS@PEAUDwm__IListener@Animations@Components@@@Animations@Components@@QEAAXH@Z @ 0x1801555AC
 * Callers:
 *     ?RemoveListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z @ 0x180155660 (-RemoveListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z.c)
 * Callees:
