/*
 * XREFs of ?CreateSysMemSurface@CD3DDeviceLevel1@@QEAAJAEBVCResourceTag@@IIW4DXGI_FORMAT@@PEAXPEAPEAVCD3DSurface@@@Z @ 0x180134238
 * Callers:
        ...
        struct CD3DSurface **a7)
{
  ...
  *a7 = 0LL;
  ...
  v9 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x927u);
  return v9;
}
