/*
 * XREFs of ?Create@CD2DCommandList@@SAJPEAVCD2DResourceManager@@PEAUID2D1PrivateCompositorCommandList@@PEAPEAV1@@Z @ 0x18001554C
 * Callers:
        ...
        struct CD2DCommandList **a3)
{
  ...
  unsigned int (__fastcall *v9)(CBoundsBitmap *__hidden); // rbx
  ...
  *a3 = 0LL;
  ...
  if ( v8 )
  {
    v9 = *(unsigned int (__fastcall **)(CBoundsBitmap *__hidden))(*(_QWORD *)v8 + 8LL);
    ...
    if ( v8 )
      (*(void (__fastcall **)(CBoundsBitmap *))(*(_QWORD *)v8 + 16LL))(v8);
  }
  else
  {
    v10 = -2147024882;
