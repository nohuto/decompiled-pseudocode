/*
 * XREFs of ?AddResourceNotifier@CBitmapOfDeviceBitmaps@@UEAAJPEAVIDeviceResourceNotify@@@Z @ 0x180049030
 * Callers:
        ...
        struct IDeviceResourceNotify *a2)
{
  ...
  else
  {
    ...
    {
      v6 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 264, 8u, 1, &v7);
      v4 = v6;
      if ( v6 < 0 )
