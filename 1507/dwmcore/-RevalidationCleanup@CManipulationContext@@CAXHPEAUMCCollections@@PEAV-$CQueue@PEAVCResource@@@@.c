/*
 * XREFs of ?RevalidationCleanup@CManipulationContext@@CAXHPEAUMCCollections@@PEAV?$CQueue@PEAVCResource@@@@@Z @ 0x18013197C
 * Callers:
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(v8 + 28) & 4) != 0 )
      {
        ...
        else
        {
          ...
          {
            Microsoft::WRL::ComPtr<CManipulationContext>::`scalar deleting destructor'(v15 + 8LL * v3);
            v16 = *(_DWORD *)(v4 + 32);
            if ( v7 != v16 )
            {
