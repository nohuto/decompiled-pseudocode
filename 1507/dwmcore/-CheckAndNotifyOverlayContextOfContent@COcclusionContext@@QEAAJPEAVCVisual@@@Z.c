/*
 * XREFs of ?CheckAndNotifyOverlayContextOfContent@COcclusionContext@@QEAAJPEAVCVisual@@@Z @ 0x1800DF624
 * Callers:
        ...
        struct CVisual *a2)
{
  ...
  v82[0] = (__int64)a2;
  v3 = 0;
  if ( TMil3DRect<float,TMilRect_<float,MilRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)a2 + 39) )
    return v3;
  CBaseClipStack::Top((__int64)this + 56, &v82[1]);
  if ( *((_BYTE *)this + 520) )
  {
...
LABEL_68:
          ...
          {
            v47 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v10[5]) & _xmm);
            if ( v47 < 0.00012207031 )
            {
              v48 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v10[4]) & _xmm);
...
LABEL_133:
                ...
                if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)&v82[1]) )
                {
                  ...
                  v3 = v77;
                  if ( v77 < 0 )
                    MilInstrumentationCheckHR(0x14u, 0LL, 0, v77, 0x8D0u);
                }
                return v3;
              }
            }
...
LABEL_102:
            ...
            {
              CBaseMatrix::Transform3DRectToPerspective(&v86, v10, (float *)v102);
              v58 = *((float *)&v82[2] + 1);
              v64 = (__int64 *)v102;
              v57 = *(float *)&v82[2];
              v68 = 0;
...
LABEL_101:
  ...
  LODWORD(v79) = 0;
  CVisual::GetComplex2DBounds(v11, &v85, &v79);
  v15 = 0;
  if ( (_DWORD)v79 )
  {
    ...
    do
    {
      ...
      if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)&v82[1]) )
      {
        ...
        if ( v30 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v30, 0x8BAu);
          return v3;
        }
        v17 = *((float *)&v82[2] + 1);
        v18 = *(float *)&v82[2];
