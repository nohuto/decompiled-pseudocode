/*
 * XREFs of ?SetSourceModifications@CMILBrushBitmap@@QEAAJU?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@PEBU_D3DCOLORVALUE@@1@Z @ 0x180080F54
 * Callers:
 ...
 * Callees:
 *     ?IsNonEmpty@CColorKey@@QEBA_NXZ @ 0x1800163F4 (-IsNonEmpty@CColorKey@@QEBA_NXZ.c)
 */
