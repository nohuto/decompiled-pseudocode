/*
 * XREFs of ??0?$TValueResource@UMilColorTransform@@UMILCMD_COLORTRANSFORMRESOURCE@@$0DA@@@IEAA@PEAVCComposition@@@Z @ 0x1800F84F0
 * Callers:
...
__int64 __fastcall TValueResource<MilColorTransform,MILCMD_COLORTRANSFORMRESOURCE,48>::TValueResource<MilColorTransform,MILCMD_COLORTRANSFORMRESOURCE,48>(
        __int64 a1,
        __int64 a2)
{
  __int128 v3; // xmm1
