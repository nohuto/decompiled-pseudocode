/*
 * XREFs of ?GetNext@PolygonPathIterator@Mesh@@QEAAPEAUMeshVertex@2@XZ @ 0x180074008
 * Callers:
 *     ?GenerateTriangles@Mesh@@AEBAJPEAGHPEAH@Z @ 0x180074BA8 (-GenerateTriangles@Mesh@@AEBAJPEAGHPEAH@Z.c)
 * Callees:
 *     ?IsCycle@PolygonPathIterator@Mesh@@CAHPEBUMeshEdge@2@0@Z @ 0x180073438 (-IsCycle@PolygonPathIterator@Mesh@@CAHPEBUMeshEdge@2@0@Z.c)
 */
  ...
  if ( v1 )
  {
    ...
    if ( *(_QWORD *)v1 != v4 )
    {
      if ( *(_QWORD *)(v1 + 64) )
      {
        ...
        if ( *(_DWORD *)this )
        {
          if ( v4 || !*((_QWORD *)k + 10) )
          {
            for ( k = *(const struct Mesh::MeshEdge **)(v8 + 32);
                  k != *(const struct Mesh::MeshEdge **)(v1 + 64)
               && Mesh::PolygonPathIterator::IsCycle(k, (const struct Mesh::MeshEdge *)v1);
        ...
        {
          for ( k = *(const struct Mesh::MeshEdge **)(v8 + 40);
                k != *(const struct Mesh::MeshEdge **)(v1 + 64)
             && Mesh::PolygonPathIterator::IsCycle((const struct Mesh::MeshEdge *)v1, k);
