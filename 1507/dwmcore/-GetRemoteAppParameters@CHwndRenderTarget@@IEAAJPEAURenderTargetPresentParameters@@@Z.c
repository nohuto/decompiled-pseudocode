/*
 * XREFs of ?GetRemoteAppParameters@CHwndRenderTarget@@IEAAJPEAURenderTargetPresentParameters@@@Z @ 0x1800E9FB0
 * Callers:
        ...
        double a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(CHwndRenderTarget *))(*(_QWORD *)this + 200LL))(this);
  ...
  {
    v11 = (*(__int64 (__fastcall **)(CHwndRenderTarget *, char *))(*(_QWORD *)this + 192LL))(this, (char *)a2 + 8);
    v10 = v11;
    if ( v11 >= 0 )
    {
      do
      ...
      CBaseMatrix::Transform2DBounds(
        ...
        (struct MilRectF *)v24);
      v12 = (*(__int64 (__fastcall **)(CHwndRenderTarget *))(*(_QWORD *)this + 200LL))(this);
      v13 = *(float *)v24;
      *(_QWORD *)a2 = v12;
      *(float *)&v22 = v13;
      ...
      *((_DWORD *)a2 + 5) = v20;
      *((_QWORD *)a2 + 3) = (*(__int64 (__fastcall **)(CHwndRenderTarget *))(*(_QWORD *)this + 208LL))(this);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x655u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, TopLevelVisualFromHwnd, 0x652u);
  }
  return v10;
}
