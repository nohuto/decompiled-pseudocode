/*
 * XREFs of ?ProcessFrameInputPostTargeting@CManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x18012AFD4
 * Callers:
    ...
    if ( (*(_DWORD *)((_BYTE *)a2 + v6 + 44) & 0x40000) != 0 )
    {
      ...
      if ( v12 )
      {
        v9 = (struct CInteraction *)(*(__int64 (__fastcall **)(struct CManipulationContext *, _QWORD))(*(_QWORD *)v12 + 24LL))(
                                      v12,
                                      (unsigned int)v7[9]);
        CManipulationManager::OnUp((struct CComposition **)this, v9, v7[9], *((_DWORD *)a2 + 8), v8, 0, 0);
      }
      Microsoft::WRL::ComPtr<CManipulationFrame>::InternalRelease((__int64 *)&v12);
    }
    else if ( (*((_BYTE *)a2 + v6 + 44) & 2) == 0 )
    {
      v10 = (CManipulationContext *)*((_QWORD *)this + 34);
      if ( v10 )
