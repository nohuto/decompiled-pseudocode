/*
 * XREFs of ?ProcessSetScalarProperty@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETSCALARPROPERTY@@@Z @ 0x1801162A0
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETSCALARPROPERTY *a3)
{
  ...
  v4 = v3;
  if ( v3 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, 0x4Au);
  return v4;
}
