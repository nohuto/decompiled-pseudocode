/*
 * XREFs of ?Transport_RoundTripRequest@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_TRANSPORT_ROUNDTRIPREQUEST@@@Z @ 0x180068EB4
 * Callers:
        ...
        const struct MILCMD_TRANSPORT_ROUNDTRIPREQUEST *a4)
{
  ...
  v9 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v4, 0x10u, 1, &v10);
  v7 = v9;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xC0u);
LABEL_10:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x9A2u);
    return v7;
  }
LABEL_4:
