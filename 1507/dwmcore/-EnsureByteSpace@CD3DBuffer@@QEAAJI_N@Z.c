/*
 * XREFs of ?EnsureByteSpace@CD3DBuffer@@QEAAJI_N@Z @ 0x180091FAC
 * Callers:
...
__int64 __fastcall CD3DBuffer::EnsureByteSpace(CD3DBuffer *this, unsigned int a2, char a3)
{
  ...
  if ( a2 > v5 )
  {
    ...
    v17[1] = v8;
    v17[3] = v10;
    v12 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *, _QWORD, __int64 *))(**(_QWORD **)(*((_QWORD *)this + 3) + 544LL)
                                                                         + 24LL))(
            *(_QWORD *)(*((_QWORD *)this + 3) + 544LL),
            v17,
            0LL,
            &v16);
    v6 = v12;
