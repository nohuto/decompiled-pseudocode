/*
 * XREFs of ?GetD2DBitmapRealization@CCommandListBitmapRepresentation@@AEAAJPEAVID2DContextOwner@@PEAPEAUID2D1Bitmap@@@Z @ 0x1800117A0
 * Callers:
...
{
  __int64 v4; // rax
  __int64 (__fastcall *v5)(CCompositionSurfaceBitmap *, struct ID2DContextOwner *, struct ID2D1Bitmap1 **); // rdi
  ...
  *a3 = 0LL;
  v4 = *(_QWORD *)this;
  v9 = 0LL;
  v5 = *(__int64 (__fastcall **)(CCompositionSurfaceBitmap *, struct ID2DContextOwner *, struct ID2D1Bitmap1 **))(v4 + 88);
  if ( v5 == CCompositionSurfaceBitmap::GetD2DBitmapRealizationForContextOwner )
    ...
    D2DBitmapRealizationForContextOwner = v5(this, a2, &v9);
  v7 = D2DBitmapRealizationForContextOwner;
  if ( D2DBitmapRealizationForContextOwner < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealizationForContextOwner, 0xE7u);
  }
  else
  {
    if ( !v9 )
