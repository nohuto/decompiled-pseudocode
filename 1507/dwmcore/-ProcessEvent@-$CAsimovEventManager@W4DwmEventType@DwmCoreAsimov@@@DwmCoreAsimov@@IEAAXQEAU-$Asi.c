/*
 * XREFs of ?ProcessEvent@?$CAsimovEventManager@W4DwmEventType@DwmCoreAsimov@@@DwmCoreAsimov@@IEAAXQEAU?$AsimovEvent@W4DwmEventType@DwmCoreAsimov@@@2@IIIII@Z @ 0x18005FEA0
 * Callers:
        ...
        __int64 (__fastcall ***a2)(_QWORD, _QWORD))
{
  ...
  __int64 result; // rax
  __int64 (__fastcall ***v12)(_QWORD, _QWORD); // rdi
  ...
  {
    v13 = _mm_cvtsi128_si32(v16);
    v14 = _mm_cvtsi128_si32(_mm_srli_si128(v16, 4));
    v17.m128i_i64[0] = __PAIR64__(v14, v13);
