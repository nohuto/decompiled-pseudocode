/*
 * XREFs of ?CopyPixels@CSecondarySysmemBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x180152BC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  v15 = *(_OWORD *)a2;
  if ( !CSecondaryBitmap::RectInBounds((CSecondaryBitmap *)(a1 - 80), (unsigned int *)&v15)
