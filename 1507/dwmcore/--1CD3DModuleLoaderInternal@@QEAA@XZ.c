/*
 * XREFs of ??1CD3DModuleLoaderInternal@@QEAA@XZ @ 0x1800979B8
 * Callers:
 *     _dynamic_atexit_destructor_for__g_D3DModuleLoader__ @ 0x18009C6F0 (_dynamic_atexit_destructor_for__g_D3DModuleLoader__.c)
 * Callees:
...
void __fastcall CD3DModuleLoaderInternal::~CD3DModuleLoaderInternal(CD3DModuleLoaderInternal *this)
{
  ...
  CCriticalSection::DeInit(&stru_180195AC0);
  CCriticalSection::DeInit(&stru_180195AC0);
}
