/*
 * XREFs of ?SetD2DEffectProperties@CAffineTransform2DEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x18011E370
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      *(float *)&v18[1] = v9;
      v20 = v10;
      v14 = *((float *)this + 54);
      v21 = (float)((float)((float)(v11 * v19) + (float)(v7 * v8)) + *((float *)this + 50)) - v7;
      v22 = (float)((float)((float)(v14 * v10) + (float)(v7 * v9)) + *((float *)this + 51)) - *((float *)this + 54);
