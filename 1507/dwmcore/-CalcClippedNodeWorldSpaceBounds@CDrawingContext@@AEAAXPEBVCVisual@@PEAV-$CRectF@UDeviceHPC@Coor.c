/*
 * XREFs of ?CalcClippedNodeWorldSpaceBounds@CDrawingContext@@AEAAXPEBVCVisual@@PEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x18002A1D4
 * Callers:
...
LABEL_4:
    ...
    if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)((float)(v9 + v10) - 1.0)) & _xmm) < 0.00012207031
      && (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v5[44]) & _xmm) < 0.00012207031
      && (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v5[43]) & _xmm) < 0.00012207031 )
    {
      v11 = 8LL;
      v12 = *v6;
      v13 = v6[2];
...
LABEL_26:
  ...
  {
    v26 = &v53;
    *(float *)&v27 = v58[0] + v5[41];
    v28 = 6;
    *(float *)&v29 = v58[1] + v5[40];
    v30 = v58[1] + v5[42];
    *(float *)&v53 = v58[0] + *v6;
    *(float *)&v31 = v58[2] + v5[43];
    *(float *)&v32 = v58[2] + v5[44];
...
LABEL_24:
  CScopedClipStack::GetTopClipBoundsInScope(a1 + 680, &v49);
