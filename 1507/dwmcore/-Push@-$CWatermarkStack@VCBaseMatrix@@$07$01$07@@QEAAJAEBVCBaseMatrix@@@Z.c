/*
 * XREFs of ?Push@?$CWatermarkStack@VCBaseMatrix@@$07$01$07@@QEAAJAEBVCBaseMatrix@@@Z @ 0x180019EFC
 * Callers:
...
__int64 __fastcall CWatermarkStack<CBaseMatrix,8,2,8>::Push(const void **a1, _OWORD *a2)
{
  ...
  unsigned int v9; // eax
  void (*v10)(WPF::ProcessHeapImpl *__hidden, void *); // rdi
...
LABEL_5:
  ...
  if ( v10 == WPF::ProcessHeapImpl::Free )
    ...
    ((void (__fastcall *)(WPF::ProcessHeapImpl *, void *))v10)(WPF::g_pProcessHeap, v2);
  return v6;
}
