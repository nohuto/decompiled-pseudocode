/*
 * XREFs of ?CalcEntireInputBoundsFromInputResources@CFilterEffect@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBUMilPoint2F@@@Z @ 0x180002840
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  while ( 1 )
  {
    v22 = *(_QWORD *)(*(_QWORD *)(a1 + 128) + 8 * v21);
    v42 = *(_DWORD *)(*(_QWORD *)(a1 + 120) + 4 * v21);
...
LABEL_28:
    ...
    v24 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)v23 + 48LL))(*(_QWORD *)(v22 + 48), 9LL);
    v25 = *(_OWORD **)(v22 + 48);
    v26 = v24 == 0;
    v27 = *(_QWORD *)v25;
    if ( v26 )
    {
      if ( !(*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(v27 + 48))(*(_QWORD *)(v22 + 48), 79LL) )
      {
        v6 = -2147467263;
        v41 = 553;
        goto LABEL_15;
    ...
    v6 = (*(__int64 (__fastcall **)(_QWORD, __int128 *, float *))(v27 + 136))(*(_QWORD *)(v22 + 48), v46, v47);
    if ( v6 < 0 )
    {
      v41 = 531;
      goto LABEL_15;
    ...
    *(_OWORD *)&v54[4] = v29;
    ...
    (*(void (__fastcall **)(_OWORD *, unsigned __int64 *, __int128 *))(*(_QWORD *)v25 + 104LL))(
      v25,
      &v48.m256i_u64[1],
      &v50);
    DynArrayImpl<1>::~DynArrayImpl<1>(&v48.m256i_u64[1]);
