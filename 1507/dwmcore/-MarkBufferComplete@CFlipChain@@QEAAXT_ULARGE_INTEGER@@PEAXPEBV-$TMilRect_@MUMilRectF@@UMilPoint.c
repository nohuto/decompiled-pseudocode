/*
 * XREFs of ?MarkBufferComplete@CFlipChain@@QEAAXT_ULARGE_INTEGER@@PEAXPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4BufferState@1@@Z @ 0x180109514
 * Callers:
...
void __fastcall CFlipChain::MarkBufferComplete(__int64 a1, unsigned int a2, int a3, float *a4, unsigned int a5)
{
  __int64 v6; // rdx
  ...
  if ( *(_DWORD *)(a1 + 152) && *(_DWORD *)(a1 + 104) )
  {
    ...
    if ( a2 <= *(_DWORD *)(a1 + 176) )
      ...
      CFlipChain::UpdateBufferState(a1, v6, a5);
  }
}
