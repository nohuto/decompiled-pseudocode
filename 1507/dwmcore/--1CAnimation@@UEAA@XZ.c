/*
 * XREFs of ??1CAnimation@@UEAA@XZ @ 0x180047C94
 * Callers:
...
void __fastcall CAnimation::~CAnimation(CAnimation *this)
{
  ...
  bool v3; // zf
  __int64 v4; // rbx
  __int64 (__fastcall *v5)(CMILRefCountBase *); // rdi
  __int64 v6; // rdi
  __int64 v7; // r8
  __int64 v8; // rdx
  __int64 v9; // rcx
  ...
  *((_QWORD *)this + 11) = &CAnimation::`vftable';
  ...
  if ( v4 )
  {
    ...
    if ( v5 == CVisualTree::Release )
      CVisualTree::Release(*((CMILRefCountBase **)this + 13));
    else
      v5(*((CMILRefCountBase **)this + 13));
  }
  v6 = *((_QWORD *)this + 27);
  if ( v6 )
