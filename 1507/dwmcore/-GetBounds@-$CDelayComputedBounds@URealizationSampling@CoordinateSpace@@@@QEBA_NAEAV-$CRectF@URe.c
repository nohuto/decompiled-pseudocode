/*
 * XREFs of ?GetBounds@?$CDelayComputedBounds@URealizationSampling@CoordinateSpace@@@@QEBA_NAEAV?$CRectF@URealizationSampling@CoordinateSpace@@@@@Z @ 0x1800E0B70
 * Callers:
 ...
 *     ?SetInverse@MILMatrix3x2@@QEAA_NMMMMMM@Z @ 0x1800DE0CC (-SetInverse@MILMatrix3x2@@QEAA_NMMMMMM@Z.c)
 */
