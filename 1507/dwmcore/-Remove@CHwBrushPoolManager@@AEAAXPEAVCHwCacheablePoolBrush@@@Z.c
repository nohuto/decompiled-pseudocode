/*
 * XREFs of ?Remove@CHwBrushPoolManager@@AEAAXPEAVCHwCacheablePoolBrush@@@Z @ 0x1801423E0
 * Callers:
 ...
 *     ?UnusableNotification@CHwBrushPoolManager@@UEAAXPEAVCMILPoolResource@@@Z @ 0x180142430 (-UnusableNotification@CHwBrushPoolManager@@UEAAXPEAVCMILPoolResource@@@Z.c)
 * Callees:
 *     <none>
 */
