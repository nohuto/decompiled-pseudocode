/*
 * XREFs of ?ProcessToken@CLegacySurfaceManager@@IEAAJPEBU_D3DKMT_PRESENTHISTORYTOKEN@@PEAIPEA_N@Z @ 0x180062648
 * Callers:
 ...
 *     ?FindBitmapNoRef@CLogicalSurfaceHandleMap@@QEAAJPEAXPEAPEAVCGdiSpriteBitmap@@@Z @ 0x1800629A4 (-FindBitmapNoRef@CLogicalSurfaceHandleMap@@QEAAJPEAXPEAPEAVCGdiSpriteBitmap@@@Z.c)
 ...
 *     ?FindGdiSpriteBitmapFromDxShared@CLogicalSurfaceHandleMap@@QEAAX_KPEAPEAVCGdiSpriteBitmap@@@Z @ 0x1800F0FA4 (-FindGdiSpriteBitmapFromDxShared@CLogicalSurfaceHandleMap@@QEAAX_KPEAPEAVCGdiSpriteBitmap@@@Z.c)
 */
