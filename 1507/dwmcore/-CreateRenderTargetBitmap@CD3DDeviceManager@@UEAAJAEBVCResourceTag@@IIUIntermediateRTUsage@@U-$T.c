/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDeviceManager@@UEAAJAEBVCResourceTag@@IIUIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@_NAEBU_GUID@@U_LUID@@VDisplayId@@4PEAPEAVIRenderTargetBitmap@@@Z @ 0x1800558C0
 * Callers:
        ...
        struct CD3DDeviceLevel1 *a13)
{
  ...
  *(_QWORD *)a13 = 0LL;
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_1801663C8, 1u, v19, 0x770u);
    return v20;
  }
  ...
  if ( D3DDevice >= 0 )
  {
    ...
    v24 = v33;
    *((_DWORD *)v22 + 129) = CurrentThreadId;
    v29 = a12;
    v25 = CHwTextureRenderTarget::Create(v24, a3, a4, v22, a11, v15, v29, &v31, v30);
    v20 = v25;
    if ( v25 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1801663C8, 1u, v25, 0x781u);
    ...
    else
    {
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_1801663C8, 1u, v27, 0x784u);
        CGuard<CD3DDeviceLevel1>::~CGuard<CD3DDeviceLevel1>(&a13);
        goto LABEL_6;
      }
      CGuard<CD3DDeviceLevel1>::~CGuard<CD3DDeviceLevel1>(&a13);
...
LABEL_6:
  ...
  MilInstrumentationCheckHR(0x14u, &dword_1801663C8, 1u, D3DDevice, 0x772u);
  v22 = v32;
LABEL_8:
  if ( v22 )
    CMILPoolResource::Release((struct CD3DDeviceLevel1 *)((char *)v22 + 392));
  return v20;
}
