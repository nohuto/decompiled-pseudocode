/*
 * XREFs of ??_GCInteractionContextWrapper@@UEAAPEAXI@Z @ 0x18005AA80
 * Callers:
 *     ??_ECInteractionContextWrapper@@W7EAAPEAXI@Z @ 0x18009AE10 (--_ECInteractionContextWrapper@@W7EAAPEAXI@Z.c)
 * Callees:
