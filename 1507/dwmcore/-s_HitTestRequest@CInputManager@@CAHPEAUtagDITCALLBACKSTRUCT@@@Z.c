/*
 * XREFs of ?s_HitTestRequest@CInputManager@@CAHPEAUtagDITCALLBACKSTRUCT@@@Z @ 0x18000A1B0
 * Callers:
 *     ?HitTestRequest@CInputProxy@@UEAA_NPEAUtagDITCALLBACKSTRUCT@@@Z @ 0x18012F740 (-HitTestRequest@CInputProxy@@UEAA_NPEAUtagDITCALLBACKSTRUCT@@@Z.c)
 * Callees:
 ...
 *     ?CopyTransform@CInputManager@@SAXAEBVCMILMatrix@@PEAUtagINPUT_TRANSFORM@@@Z @ 0x18000A67C (-CopyTransform@CInputManager@@SAXAEBVCMILMatrix@@PEAUtagINPUT_TRANSFORM@@@Z.c)
...
__int64 __fastcall CInputManager::s_HitTestRequest(struct tagDITCALLBACKSTRUCT *a1, int a2)
{
  ...
  if ( v2 )
  {
    ...
    v12 = (struct CInputManager *)((char *)v2 + 144);
    v13 = *((_QWORD *)v2 + 2);
    v30 = v12;
    v23 = 0LL;
    v26 = 0LL;
    ...
    if ( TreeNoLock < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_18016B85C, 1u, TreeNoLock, 0x58u);
      goto LABEL_27;
    }
    v16 = v26;
    if ( (*(_BYTE *)(*((_QWORD *)v26 + 3) + 88LL) & 0xF) != 0 )
    {
      ...
      if ( TreeNoLock < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_18016B85C, 1u, TreeNoLock, 0x68u);
        goto LABEL_27;
      }
    }
    ...
    if ( v15 )
    {
      ...
      TreeNoLock = v18;
      if ( v18 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_18016B85C, 1u, v18, 0x7Cu);
    }
    else if ( (unsigned int)CInputManager::UseDesktopInputStack(v17) )
    {
    ...
    if ( v23 )
    {
      ...
      TreeNoLock = v19;
      if ( v19 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_18016B85C, 1u, v19, 0x9Eu);
    }
    else
    {
      *((_DWORD *)a1 + 12) = 0;
