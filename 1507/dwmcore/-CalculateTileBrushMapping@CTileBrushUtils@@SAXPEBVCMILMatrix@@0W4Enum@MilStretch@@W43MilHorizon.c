/*
 * XREFs of ?CalculateTileBrushMapping@CTileBrushUtils@@SAXPEBVCMILMatrix@@0W4Enum@MilStretch@@W43MilHorizontalAlignment@@W43MilVerticalAlignment@@W43MilBrushMappingMode@@4PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@5MMPEAV8@6PEAV2@77PEAH@Z @ 0x180013D30
 * Callers:
 ...
 * Callees:
 *     ?GetAbsoluteViewRectangles@CTileBrushUtils@@CAXW4Enum@MilBrushMappingMode@@0PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@1PEAV4@2PEAH@Z @ 0x180013BFC (-GetAbsoluteViewRectangles@CTileBrushUtils@@CAXW4Enum@MilBrushMappingMode@@0PEBV-$TMilRect_@MUMi.c)
...
struct D2DMatrix *__fastcall CTileBrushUtils::CalculateTileBrushMapping(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        _DWORD *a17)
{
  ...
  *a17 = 0;
  result = (struct D2DMatrix *)CTileBrushUtils::GetAbsoluteViewRectangles(a6, a7, a8, a9, a12, a13, a17);
  if ( !*a17 )
  {
    ...
    *((_QWORD *)&v30 + 1) = 1065353216LL;
    ...
    CTileBrushUtils::CalculateViewboxToViewportMapping(a12, a13, a3, a4, a5, (__int64)v32);
    ...
    result = D2DMatrixMultiply(a16, (const struct D2DMatrix *)&v28, (const struct D2DMatrix *)v32);
    if ( a14 )
    {
      v19 = v29;
      *a14 = v28;
