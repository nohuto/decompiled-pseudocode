/*
 * XREFs of ?PushConstant@CExpressionValueStack@@QEAAJAEBUD2DVector4@@@Z @ 0x180101B88
 * Callers:
 ...
 *     ?SetVector4Value@CKeyframeAnimation@@UEAAJMMMM@Z @ 0x180111650 (-SetVector4Value@CKeyframeAnimation@@UEAAJMMMM@Z.c)
 * Callees:
...
__int64 __fastcall CExpressionValueStack::PushConstant(CExpressionValueStack *this, const struct D2DVector4 *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x35Bu);
  }
  return v5;
}
