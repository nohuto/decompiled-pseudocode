/*
 * XREFs of ?Resize@?$ArrayListS@PEAUDwm__IListener@Animations@Components@@@Animations@Components@@IEAAJH@Z @ 0x1801556C4
 * Callers:
 *     ?AddListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z @ 0x180153CD0 (-AddListener@Animation@Animations@Components@@UEAAJPEAUDwm__IListener@23@@Z.c)
 * Callees:
