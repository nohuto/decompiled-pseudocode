/*
 * XREFs of ?OnAnimationEvent@CKeyframeAnimation@@UEAAJW4AnimationEventType@@@Z @ 0x180110AE0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_BYTE *)(a1 + 124) &= ~2u;
  ...
  if ( v3 )
  {
    ...
    if ( v4 )
    {
      ...
      {
        v5 = -2147024809;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x3F8u);
        ...
        if ( *(_BYTE *)(v7 + 100) )
        {
          *(_DWORD *)(v7 + 128) = 2;
          if ( (unsigned __int8)CNotificationResource::ShouldNotify((CNotificationResource *)(a1 - 136)) )
          {
            ...
            v5 = v9;
            if ( v9 < 0 )
              MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x319u);
          }
        }
      }
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x3EFu);
        return (unsigned int)v5;
      }
    }
  }
  else
  {
    ...
    if ( (unsigned __int8)CNotificationResource::ShouldNotify((CNotificationResource *)(a1 - 136)) )
    {
      ...
      v5 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x2F6u);
    }
    *(_DWORD *)(v10 + 128) = 1;
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x3EBu);
      return (unsigned int)v5;
    }
  }
  return 0;
