/*
 * XREFs of ?ProcessRenderingStatus@CComposition@@QEAAXW4RENDERING_STATUS@1@@Z @ 0x180068248
 * Callers:
  ...
  if ( a2 >= 0 )
  {
    if ( a2 <= 1 )
    {
      ...
      if ( v3 == 2 )
      {
        ...
        if ( v8 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xEE8u);
    ...
    else if ( a2 == 3 )
    {
      ...
      if ( v3 == 2 )
      {
        ...
        if ( v12 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0xED0u);
        CComposition::UpdateMmcssPartners((CComposition *)a1);
      }
      if ( v3 == 1 )
      {
        ...
        if ( v13 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0xEDAu);
      }
    }
  }
  *(_DWORD *)(a1 + 336) = v2;
