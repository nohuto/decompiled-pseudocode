/*
 * XREFs of ?GetColorContextNoRef@CD2DContext@@QEAAJW4D2D1_COLOR_SPACE@@PEAPEAUID2D1ColorContext@@@Z @ 0x180136720
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v10 + 1 < v10 )
    {
      ...
      v8 = -2147024362;
LABEL_19:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x829u);
      goto LABEL_20;
    }
    v8 = 0;
    if ( v11 > *((_DWORD *)this + 35) )
    {
      v15 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 120, 8u, 1, &v17);
      v12 = v15;
      if ( v15 < 0 )
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x827u);
LABEL_20:
  v13 = v17;
LABEL_13:
  if ( v13 )
