/*
 * XREFs of ?DrawYCbCrBitmap@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap1@@1W4D2D1_YCBCR_CHROMA_SUBSAMPLING@@PEBUD2D_RECT_F@@MW4D2D1_INTERPOLATION_MODE@@W4D2D1_COMPOSITE_MODE@@@Z @ 0x1801360B0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_COMPOSITE_MODE a9)
{
  ...
  (*(void (__fastcall **)(ID2D1DeviceContext *, _BYTE *))(*(_QWORD *)this[5] + 240LL))(this[5], v31);
  v14 = (*((__int64 (__fastcall **)(ID2D1DeviceContext **, __int64, struct ID2D1Effect **))*this + 29))(this, 7LL, &v21);
  v15 = v14;
  if ( v14 >= 0 )
  {
    ...
    if ( v16 >= 0 )
    {
      ...
      else
      {
        ...
        *(_OWORD *)&v24[4] = _xmm;
        ...
        v25 = *(_OWORD *)v24;
        v26 = *(_QWORD *)&v24[16];
        v19 = (*(__int64 (__fastcall **)(ID2D1DeviceContext *, __int64, __m128i *, __int128 *, __int64 *))(*(_QWORD *)v18 + 520LL))(
                v18,
                v23,
                &v28,
                &v25,
        ...
        v15 = v19;
        if ( v19 >= 0 )
          (*(void (__fastcall **)(ID2D1DeviceContext *, const struct D2D_RECT_F *, __int64))(*(_QWORD *)this[5] + 136LL))(
            this[5],
            v9,
            v22);
        else
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v19, 0x431u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x41Bu);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x417u);
  }
  if ( v21 )
  {
