/*
 * XREFs of ?InitializeForFormatConversion@CScanPipeline@@QEAAJPEBUPixelFormatInfo@@0IE@Z @ 0x180146D00
 * Callers:
 ...
 *     ?ResetPipeline@CScanPipeline@@MEAAXXZ @ 0x180146CB0 (-ResetPipeline@CScanPipeline@@MEAAXXZ.c)
