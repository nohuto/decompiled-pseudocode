/*
 * XREFs of ?PresentInternal@CDWMSwapChain@@MEAAJPEAUHRGN__@@IIPEAURenderTargetPresentParameters@@@Z @ 0x180042840
 * Callers:
        ...
        struct RenderTargetPresentParameters *a5)
{
  ...
  *((_QWORD *)v5 + 3) = 0LL;
  ...
  if ( !v13 )
  {
    ...
    if ( v41 >= 0 )
      goto LABEL_23;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v41, 0x136u);
LABEL_22:
    if ( v22 < 0 )
      goto LABEL_24;
    goto LABEL_23;
  ...
  if ( *((_BYTE *)v10 + 398) )
  {
    ...
    {
      Template_q(this, &EVTDESC_OVERLAY_PRESENT_Start, *((unsigned int *)v10 + 100));
      ...
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
      {
        if ( *((_DWORD *)v10 + 100) )
        {
          do
          {
            if ( (v45 & 0x20) != 0 )
            {
              v46 = *((_QWORD *)v10 + 51) + ((unsigned __int64)v7 << 7);
    ...
    v47 = CD2DContext::D2DPresentMultiplaneOverlay(
            ...
            *((struct IDXGISwapChainDWM1 **)v10 + 37),
            ...
            a4,
            *((_DWORD *)v10 + 100),
            *((const struct _DXGI_PRESENT_MULTIPLANE_OVERLAY **)v10 + 51));
    v22 = v47;
    if ( v47 >= 0 )
    {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v47, 0x161u);
      v50 = DwmCoreAsimov::CDwmEventManager::GetManager(v49);
      *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x58) = 3;
      *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x60) = v22;
      *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = &DwmCoreAsimov::OveralyFailedEventData::`vftable';
      DwmCoreAsimov::CAsimovEventManager<enum DwmCoreAsimov::DwmEventType>::ProcessEvent(*(_QWORD *)v50, v5 + 20);
  ...
  v14 = (struct IDXGIResource *)*((_QWORD *)v10 + 46);
  if ( v14 )
  {
    ...
    if ( v36 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v36, 0x17Fu);
      v54 = DwmCoreAsimov::CDwmEventManager::GetManager(v53);
      *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x58) = 1;
      *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x60) = v22;
      *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = &DwmCoreAsimov::DFlipFailedEventData::`vftable';
      DwmCoreAsimov::CAsimovEventManager<enum DwmCoreAsimov::DwmEventType>::ProcessEvent(*(_QWORD *)v54, v5 + 20);
      DwmCoreAsimov::CDwmEventManager::RecordErrorForAggregation(v54);
    }
    else
    {
      v38 = DwmCoreAsimov::CDwmEventManager::GetManager(v37);
      DwmCoreAsimov::CDwmEventManager::SetFlipState(v38, v10, 0LL);
    }
    if ( (a4 & 1) == 0 && (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
      Template_x(v39, &EVTDESC_ETWGUID_DIRECTFLIP_PRESENTEVENT, *((_QWORD *)v10 + 43));
    goto LABEL_22;
  }
  v15 = dword_180193150;
  ...
  *v5 = 0;
  ...
  if ( GetCurrentThreadId() == dword_180195EF8 )
  {
    v16 = (unsigned int *)qword_180195EF0;
    dword_180195F00 = 0;
    v17 = *((_QWORD *)qword_180195EF0 + 12);
    if ( v17 )
    {
      v32 = *(_QWORD *)(v17 + 8LL * ((unsigned int)v10 % *((_DWORD *)qword_180195EF0 + 28)));
      if ( v32 )
      {
        ...
        if ( *(_DWORD *)ATL::CAtlMap<unsigned __int64,enum DwmCoreAsimov::HwFlipState,ATL::CElementTraits<unsigned __int64>,ATL::CElementTraits<enum DwmCoreAsimov::HwFlipState>>::operator[](
                          (char *)qword_180195EF0 + 96,
                          v10) != 2 )
        {
          v33 = qword_180195EF0;
          *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = &DwmCoreAsimov::UsageEventData::`vftable';
          *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = 0LL;
          *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = &unk_180167798;
          *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = 0LL;
                                  ...
                                  v5 + 8) )
          {
            v34 = time(0LL);
            v35 = qword_180195EF0;
            *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = v34;
            DwmCoreAsimov::CAsimovEventManager<enum DwmCoreAsimov::DwmEventType>::ProcessEvent(v35, v5 + 8);
          }
...
LABEL_9:
  ...
  if ( v18 )
  {
    HrgnToRgnData(v18, (struct _RGNDATA **)v5 + 3, v16);
    v11 = *(struct _RGNDATA **)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18);
    goto LABEL_40;
  }
  if ( !a2 )
    goto LABEL_11;
  ...
  *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = RegionData;
  if ( !RegionData )
  {
  ...
  v26 = WPF::g_pProcessHeap;
  v27 = RegionData;
  *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x48) = RegionData;
  v28 = *(LPVOID (__fastcall **)(WPF::ProcessHeapImpl *, SIZE_T))(*(_QWORD *)v26 + 8LL);
  *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = v28;
  if ( v28 == WPF::ProcessHeapImpl::Alloc )
    v29 = (struct _RGNDATA *)WPF::ProcessHeapImpl::Alloc(v26, v27);
  else
    v29 = (struct _RGNDATA *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, _QWORD))(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL)
                                                                                       + 0x50))(
                               v26,
                               *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x48));
  v11 = v29;
  if ( !v29 )
  {
  ...
  SetLastError(0);
  if ( !GetRegionData(a2, *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18), v11) )
  {
    v57 = GetLastError();
    v56 = v57;
    if ( v57 > 0 )
...
LABEL_12:
  if ( *((_BYTE *)v10 + 362) && (a4 & 1) == 0 )
  {
    ...
    if ( *((_BYTE *)v10 + 363) )
    {
      ...
      if ( v59 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v59, 0x1B5u);
        goto LABEL_24;
      }
    }
    else
    {
      ...
      if ( v60 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v60, 0x1B9u);
        goto LABEL_24;
      }
    }
    LODWORD(v20) = *v5;
  ...
  if ( !v12 )
  {
    if ( a5 )
    {
      if ( *((_BYTE *)a5 + 34) && !Buffer )
      {
        ...
        *(_OWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = 0LL;
        ...
        v22 = v66;
        if ( v66 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v66, 0x1DCu);
        goto LABEL_21;
      }
    ...
    v22 = v21;
    if ( v21 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x1EAu);
LABEL_21:
    if ( v22 != 142213167 )
      goto LABEL_22;
    *((_BYTE *)v10 + 362) = 1;
LABEL_23:
  ...
  *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = 0LL;
  ...
  v68 = 0;
  v69 = 0;
  *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = 0;
  *(_OWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = 0LL;
  if ( !*((_DWORD *)v10 + 62) )
  {
LABEL_121:
    v79 = CD2DContext::D2DPresentDWM(
            ...
            *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 8),
            ...
            Buffer,
            v68,
            *(const struct DXGI_SCROLL_RECT **)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20),
            0LL,
            0);
    v22 = v79;
    if ( v79 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v79, 0x210u);
    DynArrayImpl<1>::~DynArrayImpl<1>((void **)v5 + 4);
    goto LABEL_22;
  }
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(v70 + 48LL * v69) != 1 )
      goto LABEL_119;
    *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = *(_QWORD *)(v70 + 48LL * v69 + 32);
    v71 = *(_OWORD *)(v70 + 48LL * v69 + 16);
    v72 = v68 + 1;
    *(_OWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x58) = v71;
    if ( v68 + 1 < v68 )
      break;
    if ( v72 > v67 )
    {
      v77 = DynArrayImpl<0>::AddMultipleAndSet((__int64)(v5 + 8), 0x18u, 1, v5 + 20);
      v78 = v77;
      if ( v77 < 0 )
      ...
      if ( v78 < 0 )
        goto LABEL_125;
      v68 = *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38);
      v67 = *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x34);
    }
    else
    {
      v73 = *(_OWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50);
      v74 = v68++;
      *(_DWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = v72;
      v75 = 3 * v74;
      v76 = *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20);
      *(_OWORD *)(v76 + 8 * v75) = v73;
      *(_QWORD *)(v76 + 8 * v75 + 16) = *(_QWORD *)(((unsigned __int64)&v82 & 0xFFFFFFFFFFFFFFC0uLL) + 0x60);
    }
LABEL_119:
  ...
  v22 = -2147024362;
LABEL_125:
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v78, 0x202u);
  DynArrayImpl<1>::~DynArrayImpl<1>((void **)v5 + 4);
LABEL_24:
  if ( v11 )
  {
