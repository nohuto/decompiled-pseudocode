/*
 * XREFs of ?Create@CDXGIEnumeration@@SAJPEAPEAV1@@Z @ 0x1800966F4
 * Callers:
 ...
 *     ??0CDXGIEnumeration@@AEAA@XZ @ 0x180096248 (--0CDXGIEnumeration@@AEAA@XZ.c)
...
__int64 __fastcall CDXGIEnumeration::Create(struct CDXGIEnumeration **a1)
{
  ...
  if ( v3 )
  {
    ...
    if ( inited < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_18016AE4C, 1u, inited, 0x3Cu);
    }
    else
    {
      *a1 = v3;
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_18016AE4C, 1u, -2147024882, 0x38u);
  }
  return v5;
}
