/*
 * XREFs of ?Present@CComposition@@QEAAJPEAUFRAME_TIME_INFO@@@Z @ 0x18006C51C
 * Callers:
...
__int64 __fastcall CComposition::Present(CComposition *this, struct FRAME_TIME_INFO *a2)
{
  ...
  *((_QWORD *)this + 43) = a2;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x6A4u);
    goto LABEL_10;
  }
  if ( v6 )
  {
...
LABEL_10:
  ...
  v11 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x6BEu);
  if ( !v8 )
    goto LABEL_13;
  if ( v8 < 0 )
    goto LABEL_19;
