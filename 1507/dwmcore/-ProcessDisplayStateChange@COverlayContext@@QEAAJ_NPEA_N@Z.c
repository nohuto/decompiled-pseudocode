/*
 * XREFs of ?ProcessDisplayStateChange@COverlayContext@@QEAAJ_NPEA_N@Z @ 0x180012D20
 * Callers:
...
__int64 __fastcall COverlayContext::ProcessDisplayStateChange(COverlayContext *this, char a2, bool *a3)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, MultiplaneOverlayCaps, 0x688u);
  }
  else
  {
    if ( a2 || memcmp_0(Buf1, (char *)this + 92, 0x2CuLL) )
    {
      ...
      *((_DWORD *)this + 33) = v13;
      if ( !v12 || *((_BYTE *)this + 825) )
      {
        *((_BYTE *)this + 830) = 1;
        v6 = 1;
      }
    }
    for ( i = 0; i < *((_DWORD *)this + 56); *(_DWORD *)(*((_QWORD *)this + 25) + v17 + 200) = 0 )
    {
      v16 = i++;
      v17 = 240 * v16;
      *(_DWORD *)(*((_QWORD *)this + 25) + v17 + 196) = 0;
    }
    v10 = *((_QWORD *)this + 78);
    if ( v10 )
    {
