/*
 * XREFs of ?GetLastKnownGoodDxClipShape@CWindowNode@@AEAAJPEAPEAVCShape@@@Z @ 0x180105158
 * Callers:
 ...
 *     ?GetBounds@CFlipChain@@UEAAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801091E0 (-GetBounds@CFlipChain@@UEAAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV-$TMilRect_@MUMilRectF@@UMi.c)
...
__int64 __fastcall CWindowNode::GetLastKnownGoodDxClipShape(CWindowNode *this, struct CShape **a2)
{
  ...
  if ( Bounds >= 0 )
  {
    ...
    v6 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xD9Bu);
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, Bounds, 0xD8Bu);
  }
  return v6;
}
