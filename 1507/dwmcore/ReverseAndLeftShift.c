/*
 * XREFs of ReverseAndLeftShift @ 0x18012E7FC
 * Callers:
 ...
 * Callees:
 *     ConvertVectorArrayToMatrix @ 0x18009ADA4 (ConvertVectorArrayToMatrix.c)
 *     ?D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z @ 0x180149A70 (-D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z.c)
 */

__int64 __fastcall ReverseAndLeftShift(__int64 a1, int *a2)
{
  int v2; // xmm1_4
  int v3; // xmm0_4
  int v4; // xmm1_4
  ...
  while ( v13 );
  ConvertVectorArrayToMatrix(v12, (int *)&v17);
  return v15;
}
