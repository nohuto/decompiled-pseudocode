/*
 * XREFs of ?GetHandoffData@CAnimation@@UEAA_NPEAW4Enum@DwmAnimationHandoffType@@PEAMPEA_K@Z @ 0x180046E40
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall CAnimation::GetHandoffData(
        CAnimation *this,
        ...
        unsigned __int64 *a4)
{
  ...
  v6 = *((_QWORD *)this + 16);
  AnimationValue = 1;
  if ( !v6 || (v14 = *((_QWORD *)this + 4), *(_QWORD *)(v6 + 120) > v14) )
  {
LABEL_2:
    ...
    if ( (*((_BYTE *)this + 8) & 0x40) == 0 )
    {
      if ( *((_DWORD *)this + 49) )
      {
        ...
        if ( v11 )
        {
          ...
          v13 = *((_QWORD *)this - 9);
          v18 = v11;
          CoreUICallSend(*(_QWORD *)(*(_QWORD *)(v13 + 1160) + 56LL), &v17, 1LL, 1LL, &unk_180162B46, v12);
          *((_BYTE *)this + 8) |= 0x40u;
        }
      }
    }
