/*
 * XREFs of ?EnsureDeviceBitmapTextures@CGdiSpriteBitmap@@QEAAJXZ @ 0x18007DE44
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::EnsureDeviceBitmapTextures(CGdiSpriteBitmap *this)
{
  ...
  if ( *((_QWORD *)this + 21) && !*((_BYTE *)this + 176) )
  {
    ...
    if ( *((_DWORD *)this + 110) )
    {
      ...
      MilInstrumentationCheckHR(0x14u, &dword_18016AB40, 6u, v5, 0x335u);
    }
    else
    {
LABEL_7:
