/*
 * XREFs of Template_ppffffdd @ 0x18010BB20
 * Callers:
...
ULONG Template_ppffffdd(__int64 a1, __int64 a2, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v15 = 4LL;
  v17 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_ETWGUID_CVI_UPDATE, 8u, &UserData);
}
