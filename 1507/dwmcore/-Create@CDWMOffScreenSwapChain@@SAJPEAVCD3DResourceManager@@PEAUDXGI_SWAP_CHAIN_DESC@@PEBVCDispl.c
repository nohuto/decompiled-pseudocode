/*
 * XREFs of ?Create@CDWMOffScreenSwapChain@@SAJPEAVCD3DResourceManager@@PEAUDXGI_SWAP_CHAIN_DESC@@PEBVCDisplay@@PEAPEAV1@@Z @ 0x18008CC24
 * Callers:
 ...
 *     ?StringCbPrintfW@@YAJPEAG_KPEBGZZ @ 0x180063624 (-StringCbPrintfW@@YAJPEAG_KPEBGZZ.c)
        ...
        struct CDWMOffScreenSwapChain **a4)
{
  ...
  *(_QWORD *)&v26 = v11;
  ...
  if ( (*(_BYTE *)(*((_QWORD *)v6 + 15) + 536LL) & 4) != 0 )
  {
    v21 = *v11;
    v31 = 0LL;
    v30 = 2;
...
LABEL_8:
  ...
  *((_OWORD *)v19 + 22) = *(_OWORD *)&a2->OutputWindow;
  ...
  v12 = (*(__int64 (__fastcall **)(_QWORD, struct CD3DResourceManager *))(*(_QWORD *)*a4 + 232LL))(*a4, v18);
  v14 = v12;
  if ( v12 < 0 )
  {
    v24 = 199;
