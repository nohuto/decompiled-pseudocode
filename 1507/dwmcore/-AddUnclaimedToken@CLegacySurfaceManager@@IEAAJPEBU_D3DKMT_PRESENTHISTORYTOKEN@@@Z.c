/*
 * XREFs of ?AddUnclaimedToken@CLegacySurfaceManager@@IEAAJPEBU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1800EFCD4
 * Callers:
        ...
        void **a4)
{
  ...
  *((_QWORD *)&v15 + 1) = v8;
  ...
  if ( (int)v10 + 1 >= (unsigned int)v10 )
  {
    ...
    {
      v14 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v9, 0x10u, 1, &v15);
      v12 = v14;
      if ( v14 < 0 )
