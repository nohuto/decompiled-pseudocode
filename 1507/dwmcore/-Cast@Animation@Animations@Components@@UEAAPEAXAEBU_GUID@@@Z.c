/*
 * XREFs of ?Cast@Animation@Animations@Components@@UEAAPEAXAEBU_GUID@@@Z @ 0x1801549F0
 * Callers:
 *     ?Cast@Animation@Animations@Components@@W7EAAPEAXAEBU_GUID@@@Z @ 0x18009C170 (-Cast@Animation@Animations@Components@@W7EAAPEAXAEBU_GUID@@@Z.c)
 *     ?Cast@Animation@Animations@Components@@WBA@EAAPEAXAEBU_GUID@@@Z @ 0x18009C180 (-Cast@Animation@Animations@Components@@WBA@EAAPEAXAEBU_GUID@@@Z.c)
 * Callees:
 *     ?Cast@Object@Animations@Components@@UEAAPEAXAEBU_GUID@@@Z @ 0x180155A90 (-Cast@Object@Animations@Components@@UEAAPEAXAEBU_GUID@@@Z.c)
 */
