/*
 * XREFs of ?Create@COverlayContext@@SAJPEAVIRenderTargetDisplay@@PEAVCDisplay@@PEAVCComposition@@PEAPEAV1@@Z @ 0x180012278
 * Callers:
        ...
        struct COverlayContext **a4)
{
  ...
  if ( v9 )
  {
    ...
    v11 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0xABu);
    else
      *a4 = v9;
    if ( v11 < 0 )
  ...
  {
    v11 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0xA7u);
  }
