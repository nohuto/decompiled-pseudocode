/*
 * XREFs of ?Init@CHwFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAUHWND__@@PEBVCDisplay@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@@Z @ 0x18008E790
 * Callers:
...
LABEL_13:
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
    Template_qz(v14, v13, *((unsigned int *)this + 64), (char *)a4 + 160);
  v16 = (char *)this + 168;
