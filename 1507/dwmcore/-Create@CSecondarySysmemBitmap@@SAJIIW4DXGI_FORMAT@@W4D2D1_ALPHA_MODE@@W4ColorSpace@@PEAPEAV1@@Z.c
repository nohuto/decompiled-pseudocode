/*
 * XREFs of ?Create@CSecondarySysmemBitmap@@SAJIIW4DXGI_FORMAT@@W4D2D1_ALPHA_MODE@@W4ColorSpace@@PEAPEAV1@@Z @ 0x180152CC4
 * Callers:
...
{
  __int64 v10; // rax
  CSecondarySysmemBitmap *v11; // rdi
  ...
  *a6 = 0LL;
  ...
  if ( v11 )
  {
    ...
    v13 = CSecondarySysmemBitmap::Initialize(v11);
    v12 = v13;
    if ( v13 >= 0 )
    {
      *a6 = v11;
