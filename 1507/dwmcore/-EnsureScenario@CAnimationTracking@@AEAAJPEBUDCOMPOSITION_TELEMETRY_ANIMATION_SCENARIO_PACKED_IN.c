/*
 * XREFs of ?EnsureScenario@CAnimationTracking@@AEAAJPEBUDCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@PEBGIPEBU_GUID@@AEBUTelFrameInfo@1@PEAPEAUAnimationScenarioRunningStatistics@1@@Z @ 0x18006488C
 * Callers:
...
LABEL_6:
  ...
  *((_QWORD *)v29[0] + 13) = TickCount64;
  ...
  {
    v25 = (CAnimationTracking *)(*((_QWORD *)v29[0] + 13) + 500LL + *((unsigned int *)a2 + 6));
    *((_QWORD *)v29[0] + 15) = v25;
  }
  else
  {
    v25 = v29[0];
    *((_QWORD *)v29[0] + 15) = *((_QWORD *)v29[0] + 13) + 5000LL;
  }
  if ( a2 )
  {
    v11 = CAnimationTracking::CopyScenarioInfo(v25, v29[0], a2);
    if ( v11 < 0 )
    {
      if ( v29[0] )
