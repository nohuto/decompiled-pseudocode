/*
 * XREFs of ?GetGeometryCount@Mesh@@QEAAJHHPEAH0@Z @ 0x180075D08
 * Callers:
...
__int64 __fastcall Mesh::GetGeometryCount(Mesh *this, int a2, int a3, int *a4, int *a5)
{
  ...
  if ( (v5 & 1) != 0 )
  {
    ...
    if ( !v12 || (v5 & 0x10) != 0 || (v5 & 8) != 0 )
    {
      ...
      if ( inited < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, inited, 0x1276u);
        return v13;
      }
      if ( a2 )
        v11 = 3
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x124Du);
  }
  return v13;
}
