/*
 * XREFs of ?PushD2DLayer@CDrawingContext@@AEAAJPEBVCVisual@@PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUID2D1Geometry@@PEBUD2D_MATRIX_3X2_F@@M@Z @ 0x1800281B8
 * Callers:
        ...
        float a6)
{
  ...
  if ( !v18 )
  {
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x17B0u);
    goto LABEL_25;
  }
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
  {
    Template_q(v17, &EVTDESC_ETWGUID_D2DLAYERCREATEREASON, *((unsigned int *)this + 1486));
    v18 = v29;
  }
  if ( a4 )
  {
...
LABEL_22:
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v26, 0x17BCu);
      goto LABEL_25;
    }
  }
  v23 = 1;
LABEL_23:
  ...
  v7 = v24;
  if ( v24 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v24, 0x17C7u);
  else
    v29 = 0LL;
LABEL_25:
  if ( v7 < 0 )
  {
    if ( v28 )
      --*((_DWORD *)this + 152);
    if ( v29 )
      CD2DLayer::`scalar deleting destructor'(v29, 1u);
  }
