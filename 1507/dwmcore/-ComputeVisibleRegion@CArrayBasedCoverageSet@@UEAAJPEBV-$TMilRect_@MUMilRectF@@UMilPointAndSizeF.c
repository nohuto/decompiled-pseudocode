/*
 * XREFs of ?ComputeVisibleRegion@CArrayBasedCoverageSet@@UEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@H_NPEA_NPEAPEAV2@PEAI@Z @ 0x18004D720
 * Callers:
 ...
 *     ?CalculateSubtractionRectangles@?$TMilRect@MUMilRectF@@UNotNeeded@RectUniqueness@@@@QEBAIAEBV1@_NPEAV1@IPEAK@Z @ 0x18004E174 (-CalculateSubtractionRectangles@-$TMilRect@MUMilRectF@@UNotNeeded@RectUniqueness@@@@QEBAIAEBV1@_.c)
 *     ?IntersectAndOptimize@@YA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0AEBV1@PEA_N2@Z @ 0x180050790 (-IntersectAndOptimize@@YA_NPEAV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniquen.c)
        ...
        unsigned int *a7)
{
  ...
  _OWORD v64[4]; // [rsp+70h] [rbp-90h] BYREF
  _BYTE v65[64]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  *a7 = 0;
  ...
  v23 = (v11 != *(float *)&v62
     ...
     && (!(unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsInfinite(v54)
  ...
  else if ( v19 > (float)(v20 * 0.1) )
  {
    ...
    *((float *)&v63 + 3) = v31;
    ...
    {
      LOBYTE(v35) = v7;
      v36 = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::CalculateSubtractionRectangles(&v62, &v63, v35, v65);
          ...
          if ( !(unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty(&v63) )
          {
            ...
            if ( *(_DWORD *)(a1 + 48) )
            {
              ...
              do
              {
                ...
                {
                  v52 = *(float *)(v45 + 20 * v43 + 4);
                  v53 = *(float *)(v45 + 20 * v43 + 12);
                  if ( v42 < v52 )
                  {
                    if ( v53 >= v44 && v44 > v52 )
