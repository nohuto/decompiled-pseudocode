/*
 * XREFs of ?CreateNewD2DCommandList@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@PEAPEAVCD2DCommandList@@@Z @ 0x18000C9BC
 * Callers:
        ...
        struct CD2DCommandList **a4)
{
  ...
  struct ID2D1Bitmap **v42; // rbx
  struct ID2DContext *v43; // r8
  int v44; // eax
  __int64 v45; // rsi
  struct ID2D1PrivateCompositorPrimitiveProperties **v46; // rax
  struct ID2DContextOwner *v47; // rdx
  int v48; // r9d
  int v49; // ebx
  int v50; // eax
  __int64 j; // rdi
  struct ID2D1Bitmap *v52; // r15
  __int64 k; // rdi
  struct ID2D1PrivateCompositorPrimitiveProperties *v54; // r15
...
LABEL_49:
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x2B6u);
LABEL_57:
      v6 = 0;
      goto LABEL_27;
    }
  ...
  *((_DWORD *)this + 73) = v23;
  if ( (_DWORD)v23 )
  {
    ...
    if ( !is_mul_ok(v23, 8uLL) )
      v40 = -1LL;
    v41 = (struct ID2D1Bitmap **)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                   WPF::g_pProcessHeap,
                                   v40,
                                   -1LL);
    v58 = v41;
    ...
    memset_0(v41, 0, 8LL * *((unsigned int *)this + 73));
    v44 = CPrimitiveGroup::BuildD2DBitmapList(this, a2, v43, *((_DWORD *)this + 72), *((_DWORD *)this + 73), v42);
    v12 = v44;
    if ( v44 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v44, 0x2C5u);
      goto LABEL_57;
    }
  }
  v24 = *((_DWORD *)this + 74);
  ...
  *((_DWORD *)this + 74) = v25;
  ...
  if ( !is_mul_ok(v25, 8uLL) )
    v45 = -1LL;
  v46 = (struct ID2D1PrivateCompositorPrimitiveProperties **)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                               WPF::g_pProcessHeap,
                                                               v45,
                                                               v16);
  v10 = v46;
  ...
  memset_0(v46, 0, 8LL * *((unsigned int *)this + 74));
  v31 = CPrimitiveGroup::BuildD2DColorPropertiesList(this, v47, a3, *((_DWORD *)this + 74), v10);
  v12 = v31;
  if ( v31 < 0 )
  {
    v56 = 723;
LABEL_66:
    v48 = v31;
LABEL_69:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v48, v56);
    goto LABEL_70;
  }
LABEL_19:
  ...
  if ( v30 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v30, 0x2E0u);
LABEL_70:
    v6 = v61;
    goto LABEL_27;
  }
...
LABEL_68:
  ...
  {
    v50 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 88, 8LL, 1LL, &v57);
    v49 = v50;
    if ( v50 < 0 )
...
LABEL_28:
  ...
  if ( v58 )
  {
    for ( j = 0LL; (unsigned int)j < *((_DWORD *)this + 73); j = (unsigned int)(j + 1) )
    {
      v52 = v38[j];
      if ( v52 )
        (*(void (__fastcall **)(struct ID2D1Bitmap *))(*(_QWORD *)v52 + 16LL))(v38[j]);
    }
  ...
  if ( v10 )
  {
    for ( k = 0LL; (unsigned int)k < *((_DWORD *)this + 74); k = (unsigned int)(k + 1) )
    {
      v54 = v10[k];
      if ( v54 )
        (*(void (__fastcall **)(struct ID2D1PrivateCompositorPrimitiveProperties *))(*(_QWORD *)v54 + 16LL))(v10[k]);
    }
