/*
 * XREFs of ?CreateD2DInk@CD2DContext@@UEAAJAEBUD2D1_INK_POINT@@AEBUD2D1_INK_STYLE_PROPERTIES@@PEAPEAVCD2DInk@@@Z @ 0x180135130
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD2DInk **a4)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      v9 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x125u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x123u);
    }
  }
  else
  {
