/*
 * XREFs of ?Draw@CYCbCrSurface@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18010CB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CYCbCrSurface::Draw(__int64 a1, CDrawingContext *a2, __int64 a3, bool *a4)
{
  ...
  v4 = 0;
  v6 = *(struct CResource **)(a1 + 40);
  result = 0LL;
  if ( v6 )
  {
    v10 = *(struct CResource **)(a1 + 48);
    if ( v10 )
      result = CDrawingContext::DrawYCbCrBitmap(a2, v6, v10, (enum D2D1_YCBCR_CHROMA_SUBSAMPLING)*(_DWORD *)(a1 + 56));
  }
  if ( *(_QWORD *)(a1 + 40) )
    v4 = *(_QWORD *)(a1 + 48) != 0LL;
  *a4 = v4;
