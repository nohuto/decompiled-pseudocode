/*
 * XREFs of ?CheckD3D11Caps@CD3DDeviceLevel1@@AEAAJPEAUID3D11Device1@@@Z @ 0x18008FA98
 * Callers:
...
__int64 __fastcall CD3DDeviceLevel1::CheckD3D11Caps(CD3DDeviceLevel1 *this, struct ID3D11Device1 *a2)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x374u);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x377u);
    }
    else
    {
      if ( v14 )
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x37Eu);
      }
      else if ( v12 )
      {
        v10 = v11;
