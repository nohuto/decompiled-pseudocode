/*
 * XREFs of ?GetSecondaryCloneDisplaysNoRef@CDisplaySet@@QEBAJPEAVCDisplay@@PEAV?$DynArray@PEAVCDisplay@@$0A@@@@Z @ 0x180054D5C
 * Callers:
...
LABEL_4:
  ...
  v3 = -2147024362;
LABEL_15:
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x41Du);
  return v3;
}
