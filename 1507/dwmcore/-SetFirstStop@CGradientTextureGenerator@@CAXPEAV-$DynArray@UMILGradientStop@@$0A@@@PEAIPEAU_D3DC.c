/*
 * XREFs of ?SetFirstStop@CGradientTextureGenerator@@CAXPEAV?$DynArray@UMILGradientStop@@$0A@@@PEAIPEAU_D3DCOLORVALUE@@@Z @ 0x18015A76C
 * Callers:
 ...
 *     ?IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z @ 0x18015A3E4 (-IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z.c)
