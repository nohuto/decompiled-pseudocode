/*
 * XREFs of ?RenderLayer@CColorTransformLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x1800FBB60
 * Callers:
...
LABEL_3:
  ...
  {
    v28 = 2;
    v21 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, int *))(*(_QWORD *)v27 + 72LL))(v27, 1LL, 0LL, &v28);
    v10 = v21;
    if ( v21 >= 0 )
    {
      ...
      v23 = CDrawingContext::FillEffect(a2, v27, (__int64)v33, (__int64)v30, 4, 0LL);
      v10 = v23;
      if ( v23 >= 0 )
      {
