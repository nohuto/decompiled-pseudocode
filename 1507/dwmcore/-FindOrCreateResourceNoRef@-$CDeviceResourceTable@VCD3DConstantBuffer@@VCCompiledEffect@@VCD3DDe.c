/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD3DConstantBuffer@@VCCompiledEffect@@VCD3DDeviceLevel1@@@@QEAAJPEAVCD3DDeviceLevel1@@PEAPEAVCD3DConstantBuffer@@@Z @ 0x180112670
 * Callers:
...
__int64 __fastcall CDeviceResourceTable<CD3DConstantBuffer,CCompiledEffect,CD3DDeviceLevel1>::FindOrCreateResourceNoRef(
...
LABEL_7:
  ...
  {
LABEL_11:
    v12 = CCompiledEffect::CreateResource(*((CCompiledEffect **)a1 + 1), a2, &v20);
    v3 = v12;
    if ( v12 < 0 )
    {
      v19 = 90;
