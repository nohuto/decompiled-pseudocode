/*
 * XREFs of ?Vector2@CExpressionValueStack@@QEAAJXZ @ 0x180102DA4
 * Callers:
...
LABEL_7:
  ...
  if ( *(_DWORD *)v3 != 17 || *(_DWORD *)v4 != 17 )
  {
    v8 = 2236;
    goto LABEL_7;
  }
  v5 = (__m128)*((unsigned int *)v3 + 2);
  v6 = (__m128)*((unsigned int *)v4 + 2);
  CExpressionValue::SetDataType(v3);
  *((_BYTE *)v3 + 4) = 1;
  *((_QWORD *)v3 + 1) = _mm_unpacklo_ps(v5, v6).m128_u64[0];
  --*((_DWORD *)this + 4);
  return v1;
}
