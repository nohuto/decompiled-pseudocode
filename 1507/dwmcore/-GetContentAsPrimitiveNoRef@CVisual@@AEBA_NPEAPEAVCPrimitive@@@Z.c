/*
 * XREFs of ?GetContentAsPrimitiveNoRef@CVisual@@AEBA_NPEAPEAVCPrimitive@@@Z @ 0x180035E10
 * Callers:
...
char __fastcall CVisual::GetContentAsPrimitiveNoRef(CVisual *this, struct CPrimitive **a2)
{
  __int64 v2; // rdi
  char v3; // bl
  ...
  if ( v2 )
  {
    ...
    if ( v6 == CRenderData::IsOfType )
      v7 = CRenderData::IsOfType(v2, 100LL);
    else
      v7 = v6(v2, 100LL);
    if ( v7 )
    {
      v3 = 1;
      *a2 = (struct CPrimitive *)*((_QWORD *)this + 47);
    }
  }
  return v3;
}
