/*
 * XREFs of ?ProcessUpdate@CTurbulenceEffect@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TURBULENCEEFFECT@@@Z @ 0x180118BC4
 * Callers:
        ...
        const struct MILCMD_TURBULENCEEFFECT *a3)
{
  ...
  *((_QWORD *)this + 23) = *(_QWORD *)&v5.m128d_f64[0];
  ...
  *((_QWORD *)this + 24) = *(_OWORD *)&_mm_unpackhi_pd(v5, v5);
