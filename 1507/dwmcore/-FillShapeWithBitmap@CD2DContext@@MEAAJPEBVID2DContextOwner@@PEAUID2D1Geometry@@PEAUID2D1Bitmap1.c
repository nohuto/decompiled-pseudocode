/*
 * XREFs of ?FillShapeWithBitmap@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Geometry@@PEAUID2D1Bitmap1@@AEBUD2D_MATRIX_3X2_F@@MW4D2D1_INTERPOLATION_MODE@@W4D2D1_EXTEND_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x180136400
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_PRIMITIVE_BLEND a9)
{
  ...
  *(_QWORD *)&v22.transform.m[2][0] = v13;
  ...
  (*(void (__fastcall **)(CD2DBitmapBrushWrapper *, struct ID2D1Geometry *, _QWORD, _QWORD))(*(_QWORD *)this[5] + 184LL))(
    this[5],
    a3,
    *((_QWORD *)this[19] + 2),
    0LL);
