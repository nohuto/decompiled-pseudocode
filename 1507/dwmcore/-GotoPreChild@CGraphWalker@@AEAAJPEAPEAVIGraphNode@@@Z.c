/*
 * XREFs of ?GotoPreChild@CGraphWalker@@AEAAJPEAPEAVIGraphNode@@@Z @ 0x1800FAA7C
 * Callers:
...
__int64 __fastcall CGraphWalker::GotoPreChild(CGraphWalker *this, struct IGraphNode **a2)
{
  __int64 v2; // rdi
  unsigned int v3; // ebp
