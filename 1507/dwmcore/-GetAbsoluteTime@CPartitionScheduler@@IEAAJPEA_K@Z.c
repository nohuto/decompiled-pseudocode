/*
 * XREFs of ?GetAbsoluteTime@CPartitionScheduler@@IEAAJPEA_K@Z @ 0x180096E80
 * Callers:
...
__int64 __fastcall CPartitionScheduler::GetAbsoluteTime(LARGE_INTEGER *this, unsigned __int64 *a2)
{
  ...
  else
  {
    ...
    if ( v4 >= 0 )
      v4 = -2003304445;
    MilInstrumentationCheckHR(0x14u, &dword_18016A93C, 1u, v4, 0xA6u);
  }
  if ( v4 < 0 )
LABEL_12:
    MilInstrumentationCheckHR(0x14u, &dword_18016A93C, 1u, v4, 0x59u);
  v7 = (this[7].QuadPart - this[6].QuadPart) / (unsigned __int64)this[9].QuadPart;
  v8 = 10000000 * (this[7].QuadPart - this[6].QuadPart - this[9].QuadPart * v7) / this[9].QuadPart + 10000000 * v7;
  result = (unsigned int)v4;
  *a2 = v8;
  *a2 = this[2].QuadPart + v8;
  return result;
}
