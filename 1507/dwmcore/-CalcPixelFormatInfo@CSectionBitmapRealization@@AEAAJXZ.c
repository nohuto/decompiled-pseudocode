/*
 * XREFs of ?CalcPixelFormatInfo@CSectionBitmapRealization@@AEAAJXZ @ 0x18014D898
 * Callers:
 ...
 *     ?GetTextureFormat@CSectionBitmapRealization@@UEAA?AW4DXGI_FORMAT@@XZ @ 0x18014DCF0 (-GetTextureFormat@CSectionBitmapRealization@@UEAA-AW4DXGI_FORMAT@@XZ.c)
 * Callees:
