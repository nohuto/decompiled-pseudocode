/*
 * XREFs of ?Display@CDisplayDebugFrameCounter@@QEAAJIIPEAVCDrawingContext@@PEAV?$CMatrix@UPageInPixels@CoordinateSpace@@UDeviceHPC@2@@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4DebugFrameCounterPosition@1@PEAV4@@Z @ 0x1800E7248
 * Callers:
  ...
  *(_OWORD *)v40 = *v12;
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( v16 >= 0 )
    {
      ...
      if ( v17 >= 0 )
      {
        v18 = CDisplayDebugFrameCounter::DisplayText(this, a2, a3, a4, (__int64)v40, a7, (__int64)v23);
        v15 = v18;
        if ( v18 >= 0 )
        {
          if ( v8 )
