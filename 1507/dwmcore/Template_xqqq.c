/*
 * XREFs of Template_xqqq @ 0x1800E2040
 * Callers:
...
ULONG __fastcall Template_xqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = &a6;
  v13 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_SCHEDULE_RENDERTIME, 4u, &UserData);
}
