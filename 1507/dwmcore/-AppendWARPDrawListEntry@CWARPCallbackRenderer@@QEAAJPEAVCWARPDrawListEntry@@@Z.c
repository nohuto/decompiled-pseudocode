/*
 * XREFs of ?AppendWARPDrawListEntry@CWARPCallbackRenderer@@QEAAJPEAVCWARPDrawListEntry@@@Z @ 0x1801588AC
 * Callers:
...
LABEL_9:
  ...
  {
    v6 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 64, 8u, 1, &v7);
    v4 = v6;
    if ( v6 < 0 )
    {
