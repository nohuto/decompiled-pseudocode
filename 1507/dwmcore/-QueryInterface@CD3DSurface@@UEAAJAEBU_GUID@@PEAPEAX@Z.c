/*
 * XREFs of ?QueryInterface@CD3DSurface@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013B9C0
 * Callers:
 *     ?QueryInterface@CD3DSurface@@WGI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009B460 (-QueryInterface@CD3DSurface@@WGI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?OnAnimationStop@ConstantInput@Animations@Components@@UEAAXXZ @ 0x180097F10 (-OnAnimationStop@ConstantInput@Animations@Components@@UEAAXXZ.c)
 *     ?QueryInterface@CD3DResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180128820 (-QueryInterface@CD3DResource@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
