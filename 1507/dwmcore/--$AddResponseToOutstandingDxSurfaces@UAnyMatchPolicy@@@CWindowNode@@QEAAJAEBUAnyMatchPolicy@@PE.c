/*
 * XREFs of ??$AddResponseToOutstandingDxSurfaces@UAnyMatchPolicy@@@CWindowNode@@QEAAJAEBUAnyMatchPolicy@@PEAVCResponseItem@@@Z @ 0x1800EF948
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( v5 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v10 > *(_DWORD *)(v8 + 76) )
        {
          v11 = DynArrayImpl<0>::AddMultipleAndSet(v8 + 56, 8u, 1, &v18);
          v12 = v11;
          if ( v11 < 0 )
