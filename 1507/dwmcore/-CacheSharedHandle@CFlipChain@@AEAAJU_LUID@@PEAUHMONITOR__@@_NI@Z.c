/*
 * XREFs of ?CacheSharedHandle@CFlipChain@@AEAAJU_LUID@@PEAUHMONITOR__@@_NI@Z @ 0x180108A1C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  *(_QWORD *)&v29[4] = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_180175480, 4u, v9, 0x356u);
    goto LABEL_17;
  }
  if ( !*((_DWORD *)this + 38) )
  {
    ...
    if ( v10 < 0 )
    {
      ...
      v12 = v10;
LABEL_10:
      MilInstrumentationCheckHR(0x14u, &dword_180175480, 4u, v12, v27);
      goto LABEL_17;
    }
...
LABEL_16:
  ...
  if ( a3 )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, &dword_180175480, 4u, CurrentDisplaySet, 0x373u);
    ...
    {
      MilInstrumentationCheckHR(0x14u, &dword_180175480, 4u, DisplayIdFromMonitor, 0x376u);
      goto LABEL_16;
    }
    v20 = *(_DWORD *)v29;
    v15 = a5;
  ...
  *(_QWORD *)v29 = v22;
  ...
  {
    MilInstrumentationCheckHR(0x14u, &dword_180175480, 4u, SharedHandleBitmap, 0x39Cu);
    goto LABEL_16;
  }
