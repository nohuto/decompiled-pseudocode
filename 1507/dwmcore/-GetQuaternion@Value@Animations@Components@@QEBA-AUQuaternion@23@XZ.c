/*
 * XREFs of ?GetQuaternion@Value@Animations@Components@@QEBA?AUQuaternion@23@XZ @ 0x180154F24
 * Callers:
 *     ?QueryQuaternion@Animation@Animations@Components@@UEAAJIPEAUQuaternion@23@@Z @ 0x180155400 (-QueryQuaternion@Animation@Animations@Components@@UEAAJIPEAUQuaternion@23@@Z.c)
