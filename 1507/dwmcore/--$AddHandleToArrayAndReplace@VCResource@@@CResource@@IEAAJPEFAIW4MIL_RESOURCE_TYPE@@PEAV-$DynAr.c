/*
 * XREFs of ??$AddHandleToArrayAndReplace@VCResource@@@CResource@@IEAAJPEFAIW4MIL_RESOURCE_TYPE@@PEAV?$DynArray@PEAVCResource@@$00@@PEAVCResourceTable@@@Z @ 0x1800485EC
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( (_DWORD)v7 )
  {
    ...
    {
      v6 = -2147024890;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024890, 0x13Bu);
      return v6;
    }
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x13Fu);
      return v6;
    }
    v13 = *(_DWORD *)(a4 + 24);
    v14 = v13 + 1;
