/*
 * XREFs of ?ProcessUpdate@CCachedVisualImage@@QEAAJPEAVCResourceTable@@PEBUMILCMD_CACHEDVISUALIMAGE@@@Z @ 0x180053B0C
 * Callers:
        ...
        const struct MILCMD_CACHEDVISUALIMAGE *a3)
{
  ...
  *((_OWORD *)this + 4) = *(_OWORD *)((char *)a3 + 8);
  ...
  if ( (_DWORD)v7 )
  {
    Resource = CResourceTable::GetResource(a2, v7, 45LL);
...
LABEL_26:
  ...
  *(_OWORD *)((char *)this + 88) = *(_OWORD *)((char *)a3 + 24);
  ...
  v18 = CResourceTable::GetResource(a2, v8, 46LL);
  *((_QWORD *)this + 13) = v18;
  if ( !v18 )
  {
    v13 = -2003303421;
...
LABEL_11:
  ...
  *((_DWORD *)this + 33) = *((_DWORD *)a3 + 16);
  ...
  {
    v14 = CResource::RegisterNotifier((CResource *)v3, *((struct CResource **)this + 10));
    v13 = v14;
    if ( v14 < 0 )
    {
    ...
    {
      v15 = CResource::RegisterNotifier((CResource *)v3, *((struct CResource **)this + 13));
      v13 = v15;
      if ( v15 < 0 )
