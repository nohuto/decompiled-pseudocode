/*
 * XREFs of ?PresentInternalExport@CDWMOffScreenSwapChain@@QEAAJPEAUHRGN__@@_N1@Z @ 0x18008C2F4
 * Callers:
...
LABEL_10:
          ...
          if ( v30 )
          {
            ...
            *(_OWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x68) = v31;
            if ( v6 + 1 >= v6 )
            {
              if ( v32 > v28 )
              {
                v35 = DynArrayImpl<0>::AddMultipleAndSet(v4 + 16, 0x20u, 1, v4 + 104);
                if ( v35 < 0 )
      ...
      if ( v12 )
      {
        ...
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x2AAu);
LABEL_17:
          if ( v6 )
          {
          ...
          *(_DWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 8) = v36;
          if ( v36 )
          {
            if ( *(_BYTE *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 1) )
            {
              ...
              if ( v10 < 0 )
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x2C2u);
LABEL_16:
                v6 = *(_DWORD *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28);
                goto LABEL_17;
              }
