/*
 * XREFs of ?SetIndependentFlipNotifyMode@COverlayContext@@QEAAJU_LUID@@@Z @ 0x1800F7838
 * Callers:
...
__int64 __fastcall COverlayContext::SetIndependentFlipNotifyMode(COverlayContext *this, struct _LUID a2)
{
  ...
  if ( !v2 )
    goto LABEL_5;
  v5 = *((_QWORD *)this + 25);
  while ( *(_QWORD *)(*(_QWORD *)(240LL * v4 + v5 + 16) + 40LL) != a2 )
  {
    if ( ++v4 >= v2 )
      goto LABEL_5;
  }
  ...
  {
LABEL_5:
    v6 = (CDirectFlipInfo *)*((_QWORD *)this + 78);
    if ( v6 )
    {
      if ( *(_QWORD *)(*((_QWORD *)v6 + 4) + 40LL) == a2 )
      {
        ...
        v3 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x66Bu);
      }
    }
  }
  else
  {
    ...
    v3 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x665u);
  }
  return v3;
}
