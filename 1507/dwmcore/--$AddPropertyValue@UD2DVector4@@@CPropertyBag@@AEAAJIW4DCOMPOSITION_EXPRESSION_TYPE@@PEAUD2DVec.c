/*
 * XREFs of ??$AddPropertyValue@UD2DVector4@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DVector4@@@Z @ 0x180120500
 * Callers:
...
__int64 __fastcall CPropertyBag::AddPropertyValue<D2DVector4>(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  if ( a4 )
  {
    v9 = (struct _RTL_GENERIC_TABLE *)(a1 + 56);
    if ( CGenericTableMap<unsigned int,PropertyMapEntry>::FindElement(a1 + 56) )
    {
      v8 = -2147418113;
      v19 = 297;
      goto LABEL_4;
