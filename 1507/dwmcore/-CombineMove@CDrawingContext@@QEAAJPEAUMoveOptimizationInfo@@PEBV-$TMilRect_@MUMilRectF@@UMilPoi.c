/*
 * XREFs of ?CombineMove@CDrawingContext@@QEAAJPEAUMoveOptimizationInfo@@PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800F15D4
 * Callers:
...
__int64 __fastcall CDrawingContext::CombineMove(__int64 a1, __int64 a2, __int128 *a3)
{
  ...
  v5 = *(_QWORD *)(a2 + 48) == 0LL;
  v25 = v3;
  if ( v5 || (v6 = *(_DWORD *)(a1 + 5640), v7 = 0LL, !v6) )
  {
LABEL_7:
    v9 = *(_DWORD *)(a1 + 5640);
    v10 = v9 + 1;
    if ( v9 + 1 < v9 )
    {
      ...
      v12 = -2147024362;
LABEL_29:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x1DABu);
      return v12;
    }
    v12 = 0;
    if ( v10 > *(_DWORD *)(a1 + 5636) )
    {
      v23 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 5616, 8u, 1, &v24);
      v11 = v23;
      if ( v23 < 0 )
    ...
    {
      *(_QWORD *)(*(_QWORD *)(a1 + 5616) + 8LL * *(unsigned int *)(a1 + 5640)) = v24;
      *(_DWORD *)(a1 + 5640) = v10;
    }
  ...
  if ( v14 >= 0 )
  {
    ...
    v19 = *((float *)&v25 + 2) + v15;
    v20 = *((float *)&v25 + 3) + v16;
    *(_OWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 5616) + 8 * v13) + 32LL) = v26;
    v21 = *(float **)(*(_QWORD *)(a1 + 5616) + 8 * v13);
    if ( v17 > v21[8] )
      v21[8] = v17;
    if ( v18 > v21[9] )
      v21[9] = v18;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x1D98u);
  }
  return v12;
}
