/*
 * XREFs of ??0CInteraction@@IEAA@PEAVCComposition@@@Z @ 0x18005A074
 * Callers:
...
CInteraction *__fastcall CInteraction::CInteraction(CInteraction *this, struct CComposition *a2)
{
  ...
  *((_DWORD *)this + 152) = 0;
  ...
  if ( (int)HANDLE_TABLE::GetNewEntry(
              ...
              88,
              (unsigned int *)this + 152) >= 0 )
    *((_QWORD *)CInteraction::GetEntry(*((_DWORD *)this + 152)) + 1) = this;
  ReleaseSRWLockExclusive(&CInteraction::s_InteractionHandleTableLock);
  QueryPerformanceCounter(&PerformanceCount);
  *((LARGE_INTEGER *)this + 77) = PerformanceCount;
