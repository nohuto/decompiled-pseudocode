/*
 * XREFs of ?SetLastLocalToWorldTransform@CMoveRenderPassInfo@@QEAAJPEAV?$CMatrix@ULocalRenderingHPC@CoordinateSpace@@UDeviceHPC@2@@@00PEA_N@Z @ 0x1800FCD1C
 * Callers:
 ...
 *     ?IsPureTranslate@CBaseMatrix@@QEBAHXZ @ 0x1801238D8 (-IsPureTranslate@CBaseMatrix@@QEBAHXZ.c)
 */
...
LABEL_33:
    ...
    *(_QWORD *)(a1 + 32) = *(_QWORD *)(*(_QWORD *)(a1 + 64) + 352LL);
    (*(void (__fastcall **)(struct IRenderTargetDesktop *, _QWORD))(*(_QWORD *)PrimaryDesktopRenderTargetNoRef + 248LL))(
