/*
 * XREFs of ?CreateNewGenerator@CPrimitiveGroup@@AEAAJPEAPEAVCPrimitiveGroupDrawListGenerator@@@Z @ 0x18006E850
 * Callers:
        ...
        struct CPrimitiveGroupDrawListGenerator **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x21Du);
    goto LABEL_28;
  }
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x223u);
    v6 = v42;
    goto LABEL_28;
  }
  v14 = *((_DWORD *)this + 72);
...
LABEL_16:
    ...
    *((_DWORD *)this + 74) = v24;
    ...
    if ( v28 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v28, 0x260u);
      v4 = v43;
    }
    else
    {
