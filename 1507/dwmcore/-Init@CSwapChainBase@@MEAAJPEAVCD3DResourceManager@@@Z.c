/*
 * XREFs of ?Init@CSwapChainBase@@MEAAJPEAVCD3DResourceManager@@@Z @ 0x18008EC70
 * Callers:
...
__int64 __fastcall CSwapChainBase::Init(CSwapChainBase *this, struct CD3DResourceManager *a2)
{
  ...
  *((_QWORD *)this + 2) = a2;
  if ( *((_DWORD *)this + 42) )
  {
    while ( 1 )
    {
      v11 = (*(__int64 (__fastcall **)(CSwapChainBase *, _QWORD, unsigned int *, struct ID3D11Texture2D **))(*(_QWORD *)this + 240LL))(
              this,
              v10,
              &v24,
              &v25);
      ...
      if ( v11 < 0 )
        break;
      v11 = CD3DSurface::CreateViewOfTexture(a2, v25, &v24, 0, &v26);
      v12 = v11;
      if ( v11 < 0 )
      {
        v23 = 99;
...
LABEL_33:
      ...
      {
        v16 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 256, 8u, 1, &v26);
        v17 = v16;
        if ( v16 < 0 )
