/*
 * XREFs of ?Create@CSecondaryD2DBitmap@@SAJAEBU_GUID@@U_LUID@@IIW4DXGI_FORMAT@@W4D2D1_ALPHA_MODE@@PEAPEAV1@@Z @ 0x180150380
 * Callers:
        ...
        struct CSecondaryD2DBitmap **a7)
{
  ...
  struct D3D11_TEXTURE2D_DESC v12; // [rsp+50h] [rbp-21h] BYREF
  __int128 v13; // [rsp+80h] [rbp+Fh]

  v12.SampleDesc.Quality = 0;
  ...
  v12.MipLevels = 1;
  v12.ArraySize = 1;
  v12.SampleDesc.Count = 1;
  v12.Height = a4;
  v13 = v7;
  v12.BindFlags = 8;
  v11.dpiX = 96.0;
  v11.dpiY = 96.0;
  v8 = CD3DDeviceManager::CreateSecondaryD2DBitmap((CD3DDeviceManager *)&g_D3DDeviceManager, a1, a2, &v12, &v11, a7);
  v9 = v8;
  if ( v8 < 0 )
