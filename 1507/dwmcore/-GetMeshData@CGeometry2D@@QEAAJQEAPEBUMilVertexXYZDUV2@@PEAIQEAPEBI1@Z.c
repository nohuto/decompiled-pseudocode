/*
 * XREFs of ?GetMeshData@CGeometry2D@@QEAAJQEAPEBUMilVertexXYZDUV2@@PEAIQEAPEBI1@Z @ 0x18011C864
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( *((_QWORD *)this + 5) )
    goto LABEL_17;
  v10 = (*(unsigned int (__fastcall **)(CGeometry2D *))(*(_QWORD *)this + 96LL))(this);
...
LABEL_6:
  ...
  v13 = (*(__int64 (__fastcall **)(CGeometry2D *, __int64, _QWORD))(*(_QWORD *)this + 136LL))(
          this,
          v12,
          (unsigned int)v10);
  v5 = v13;
  ...
  v14 = (*(unsigned int (__fastcall **)(CGeometry2D *))(*(_QWORD *)this + 104LL))(this);
  ...
  *((_QWORD *)this + 6) = v15;
  ...
  v16 = (*(__int64 (__fastcall **)(CGeometry2D *, _QWORD, __int64, _QWORD))(*(_QWORD *)this + 128LL))(
          this,
          0LL,
          v15,
          (unsigned int)v14);
...
LABEL_17:
    ...
    *a3 = (*(__int64 (__fastcall **)(CGeometry2D *))(*(_QWORD *)this + 96LL))(this);
    *a4 = (const unsigned int *)*((_QWORD *)this + 6);
    *a5 = (*(__int64 (__fastcall **)(CGeometry2D *))(*(_QWORD *)this + 104LL))(this);
  }
  else
  {
