/*
 * XREFs of ?AddToCurrentFrameInvalidRegion@CHwDisplayRenderTarget@@IEAAJPEAUHRGN__@@@Z @ 0x180044208
 * Callers:
...
__int64 __fastcall CHwDisplayRenderTarget::AddToCurrentFrameInvalidRegion(HRGN *this, HRGN a2)
{
  ...
  if ( this[40] || (SetLastError(0), RectRgn = CreateRectRgn(0, 0, 0, 0), (this[40] = RectRgn) != 0LL) )
  {
    ...
    if ( !CombineRgn(this[40], this[40], a2, 2) )
    {
      ...
      if ( v2 >= 0 )
        v2 = -2003304445;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x639u);
    }
  }
  else
  {
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x633u);
  }
