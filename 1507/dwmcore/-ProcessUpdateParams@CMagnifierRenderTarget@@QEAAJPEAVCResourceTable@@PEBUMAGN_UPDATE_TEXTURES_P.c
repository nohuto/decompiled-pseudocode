/*
 * XREFs of ?ProcessUpdateParams@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMAGN_UPDATE_TEXTURES_PARAM@@@Z @ 0x1800ED010
 * Callers:
 ...
 * Callees:
 *     ?ProcessUpdate@CMatrixTransform@@QEAAJPEAVCResourceTable@@PEBUMILCMD_MATRIXTRANSFORM@@@Z @ 0x180017DDC (-ProcessUpdate@CMatrixTransform@@QEAAJPEAVCResourceTable@@PEBUMILCMD_MATRIXTRANSFORM@@@Z.c)
        ...
        const struct MAGN_UPDATE_TEXTURES_PARAM *a3)
{
  ...
  v4 = (char *)this + 560;
  v6 = 0;
  if ( memcmp_0((char *)this + 560, a3, 0x28uLL) )
  {
    v7 = *((_QWORD *)this + 12);
    *(_OWORD *)v4 = *(_OWORD *)a3;
    ...
    *((float *)this + 27) = (float)*((int *)a3 + 1);
    if ( v7 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v7 + 48LL))(v7, 59LL) )
      {
        v13 = 243;
        ...
        v6 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x339u);
      }
      else
      {
        v6 = -2003303421;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x32Fu);
      }
    }
  }
  return v6;
