/*
 * XREFs of ?PushColorTransformLayer@CDrawingContext@@AEAAJPEBVCVisual@@PEAV?$TValueResource@UMilColorTransform@@UMILCMD_COLORTRANSFORMRESOURCE@@$0DA@@@@Z @ 0x1800F3FA4
 * Callers:
...
__int64 __fastcall CDrawingContext::PushColorTransformLayer(CDrawingContext *this, struct CVisual *a2, __int64 a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( v10 >= 0 )
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x16C1u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x16B8u);
      v9 = v13;
    }
    if ( v9 )
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x16B2u);
  }
  return v7;
}
