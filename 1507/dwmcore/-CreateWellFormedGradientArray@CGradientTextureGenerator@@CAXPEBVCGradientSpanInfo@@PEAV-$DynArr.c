/*
 * XREFs of ?CreateWellFormedGradientArray@CGradientTextureGenerator@@CAXPEBVCGradientSpanInfo@@PEAV?$DynArray@UMILGradientStop@@$0A@@@W4Enum@MilColorInterpolationMode@@_NPEAU_D3DCOLORVALUE@@4@Z @ 0x18015A220
 * Callers:
 ...
 * Callees:
 *     ??$ArrayInsertionSort@UMILGradientStop@@@@YAXPEAUMILGradientStop@@I@Z @ 0x180159288 (--$ArrayInsertionSort@UMILGradientStop@@@@YAXPEAUMILGradientStop@@I@Z.c)
 ...
 *     ?SetMiddleStops@CGradientTextureGenerator@@CAXPEAV?$DynArray@UMILGradientStop@@$0A@@@PEAI1@Z @ 0x18015AA60 (-SetMiddleStops@CGradientTextureGenerator@@CAXPEAV-$DynArray@UMILGradientStop@@$0A@@@PEAI1@Z.c)
 */
