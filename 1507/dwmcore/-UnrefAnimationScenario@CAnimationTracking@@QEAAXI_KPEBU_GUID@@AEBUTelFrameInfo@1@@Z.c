/*
 * XREFs of ?UnrefAnimationScenario@CAnimationTracking@@QEAAXI_KPEBU_GUID@@AEBUTelFrameInfo@1@@Z @ 0x180065048
 * Callers:
 ...
 *     ?FindScenario@CAnimationTracking@@AEAAIIPEBU_GUID@@PEAPEAUAnimationScenarioRunningStatistics@1@@Z @ 0x180064C24 (-FindScenario@CAnimationTracking@@AEAAIIPEBU_GUID@@PEAPEAUAnimationScenarioRunningStatistics@1@@.c)
        ...
        const struct CAnimationTracking::TelFrameInfo *a5)
{
  ...
  if ( (unsigned int)CAnimationTracking::FindScenario(this, a2, v5, &v17) != *((_DWORD *)this + 6) )
  {
    v9 = v17;
    v10 = 0LL;
    v11 = (CAnimationTracking *)*((unsigned int *)v17 + 44);
    v12 = (_QWORD *)*((_QWORD *)v17 + 19);
    if ( (_DWORD)v11 )
    {
      do
      {
    ...
    if ( v13 )
    {
      ...
      else
      {
        ...
        if ( (unsigned int)v10 < (unsigned int)v16 )
          *(_QWORD *)(*((_QWORD *)v9 + 19) + 8 * v10) = *(_QWORD *)(*((_QWORD *)v9 + 19) + 8 * v16);
        --*((_DWORD *)v9 + 44);
      }
      if ( !*((_DWORD *)v9 + 44) )
