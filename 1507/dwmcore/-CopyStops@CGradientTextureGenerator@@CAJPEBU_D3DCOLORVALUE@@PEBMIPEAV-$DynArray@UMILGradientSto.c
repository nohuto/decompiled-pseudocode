/*
 * XREFs of ?CopyStops@CGradientTextureGenerator@@CAJPEBU_D3DCOLORVALUE@@PEBMIPEAV?$DynArray@UMILGradientStop@@$0A@@@@Z @ 0x18015A0C8
 * Callers:
    ...
    if ( a3 )
    {
      while ( 1 )
      {
        ...
        *(_OWORD *)&v19[4] = v12;
        ...
        if ( v13 > *(_DWORD *)(a4 + 20) )
        {
          v16 = DynArrayImpl<0>::AddMultipleAndSet(a4, 0x14u, 1, v19);
          v17 = v16;
          if ( v16 < 0 )
