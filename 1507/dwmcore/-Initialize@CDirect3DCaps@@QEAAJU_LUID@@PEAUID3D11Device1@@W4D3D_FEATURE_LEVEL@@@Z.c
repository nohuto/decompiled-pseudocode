/*
 * XREFs of ?Initialize@CDirect3DCaps@@QEAAJU_LUID@@PEAUID3D11Device1@@W4D3D_FEATURE_LEVEL@@@Z @ 0x1800586E0
 * Callers:
...
__int64 __fastcall CDirect3DCaps::Initialize(CDirect3DCaps *this, struct _LUID a2, struct ID3D11Device1 *a3, int a4)
{
  ...
  _DWORD v13[12]; // [rsp+30h] [rbp-40h] BYREF

  *(struct _LUID *)this = a2;
  if ( a4 >= 37120 )
  {
    *((_QWORD *)this + 7) = 0xFFFFLL;
    *((_DWORD *)this + 2) = 2;
    *((_DWORD *)this + 3) = 2;
    *((_DWORD *)this + 11) = 2048;
    *((_DWORD *)this + 12) = 2048;
  ...
  if ( a4 >= 37632 )
  {
    *((_DWORD *)this + 11) = 4096;
    *((_DWORD *)this + 12) = 4096;
    *((_QWORD *)this + 7) = 0xFFFFFLL;
  }
  if ( a4 >= 40960 )
  {
    *((_QWORD *)this + 7) = 1431655765LL;
    *((_DWORD *)this + 2) = 4;
    *((_DWORD *)this + 3) = 4;
    *((_DWORD *)this + 11) = 0x2000;
    *((_DWORD *)this + 12) = 0x2000;
  }
  if ( a4 >= 45056 )
  {
    *((_DWORD *)this + 11) = 0x4000;
    *((_DWORD *)this + 12) = 0x4000;
  }
  if ( *((_DWORD *)this + 11) < 0x1000u )
  {
    lpVtbl = a3->lpVtbl;
    v11 = 0LL;
    v13[6] = 0;
  ...
  {
    v10 = v12;
    *((_DWORD *)this + 11) = 0x800000;
    *((_DWORD *)this + 12) = 0x800000;
