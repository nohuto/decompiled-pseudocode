/*
 * XREFs of Template_xdddddddqqddddddddddddqqq @ 0x1800F7AA4
 * Callers:
...
ULONG __fastcall Template_xdddddddqqddddddddddddqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a27)
{
  ...
  __int64 v77; // [rsp+1E0h] [rbp+E0h] BYREF
  int v78; // [rsp+1E8h] [rbp+E8h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v74 = 4LL;
  v76 = 4LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_DISPLAYSURFACE_CANDIDATEATTRIBUTES, 0x19u, &UserData);
}
