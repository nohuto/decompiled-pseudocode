/*
 * XREFs of ?MetaBitmapRenderTarget_Create@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_METABITMAPRENDERTARGET_CREATE@@@Z @ 0x1800E2E2C
 * Callers:
        ...
        const struct MILCMD_METABITMAPRENDERTARGET_CREATE *a4)
{
  ...
  Resource = (CMagnifierRenderTarget *)CResourceTable::GetResource((__int64)a3, *((_DWORD *)a4 + 1), 49LL);
  v8 = Resource;
  if ( Resource )
  {
  ...
  v9 = -2003303421;
  MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0xC16u);
  return v9;
}
