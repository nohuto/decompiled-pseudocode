/*
 * XREFs of ?AppendDrawListPrimitive@CHWCallbackRenderer@@QEAAJPEAVCHWDrawListEntry@@@Z @ 0x1800DD4A0
 * Callers:
...
LABEL_9:
  ...
  {
    v6 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 32, 8u, 1, &v7);
    v4 = v6;
    if ( v6 < 0 )
    {
