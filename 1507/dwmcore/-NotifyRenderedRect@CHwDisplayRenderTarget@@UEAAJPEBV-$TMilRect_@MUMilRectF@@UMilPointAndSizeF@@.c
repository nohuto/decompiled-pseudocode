/*
 * XREFs of ?NotifyRenderedRect@CHwDisplayRenderTarget@@UEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180139310
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(a1 + 8) )
  {
    ...
    if ( CHwDisplayRenderTarget::RectToSurfaceRect(a1 - 176, a2, (__int64)&rect) )
    {
      ...
      if ( v4 )
      {
        ...
        v2 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x3C9u);
        DeleteObject(v5);
      }
      else
      {
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x3C4u);
      }
    }
  }
