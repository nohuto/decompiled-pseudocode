/*
 * XREFs of ?CheckForApertureGuardPageCorruption@VIDMM_APERTURE_SEGMENT@@QEAAJPEAPEAKE@Z @ 0x1C0010CA0
 * Callers:
...
LABEL_18:
  ...
  if ( !v11 )
    v11 = *((_QWORD *)v10 + 1) - qword_1C00270B0;
  if ( v11 )
  {
