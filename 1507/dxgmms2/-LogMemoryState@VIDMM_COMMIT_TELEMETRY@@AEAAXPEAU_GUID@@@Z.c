/*
 * XREFs of ?LogMemoryState@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAU_GUID@@@Z @ 0x1C00730D8
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogMemoryState(const struct _TlgProvider_t **this, struct _GUID *a2)
{
  ...
  {
    v4 = *this;
    if ( (unsigned int)dword_1C0027010 > 5 && TlgKeywordOn(v4, (ULONGLONG)"Integrated") )
    {
      v7 = *(unsigned __int16 **)(*(_QWORD *)(v5 + 24) + 976LL);
      v33 = &v36;
      v34 = 2LL;
      v8 = *v7;
      v9 = *((_QWORD *)v7 + 1);
      ...
      TlgWrite(v10, &unk_1C0020A0A, a2, v11, 5u, &pData);
    }
    for ( i = 0; i < *((_DWORD *)*this + 1604); ++i )
    {
      v13 = 264LL * i;
      v14 = *((_QWORD *)*this + 5104);
      v15 = *(const struct _TlgProvider_t **)(v14 + v13 + 16);
      v28 = v15;
      v29 = *(_QWORD *)(v14 + v13 + 232);
      if ( (unsigned int)dword_1C0027010 > 5 && TlgKeywordOn(v15, 100 * v29 % (unsigned __int64)v15) )
      {
        v17 = *(unsigned __int16 **)(*(_QWORD *)(v16 + 24) + 976LL);
        v33 = &v36;
        v34 = 2LL;
        v18 = *v17;
        v19 = *((_QWORD *)v17 + 1);
        ...
        v30 = v20;
        v44 = 8LL;
        TlgWrite((TraceLoggingHProvider)&v28, &unk_1C002098B, a2, v20, 8u, &pData);
      }
      v21 = *((_QWORD *)*this + 5104);
      ...
      if ( v22 )
      {
        ...
        {
          if ( TlgKeywordOn(v22, 100 * v29 % (unsigned __int64)v22) )
          {
            v24 = *(unsigned __int16 **)(*(_QWORD *)(v23 + 24) + 976LL);
            v33 = &v36;
            v34 = 2LL;
            v25 = *v24;
            v26 = *((_QWORD *)v24 + 1);
            ...
            v31 = v27;
            v44 = 8LL;
            TlgWrite((TraceLoggingHProvider)&v28, &unk_1C002098B, a2, v27, 8u, &pData);
          }
        }
      }
    }
