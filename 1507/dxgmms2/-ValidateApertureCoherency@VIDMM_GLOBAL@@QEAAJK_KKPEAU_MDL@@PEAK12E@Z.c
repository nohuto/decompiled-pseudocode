/*
 * XREFs of ?ValidateApertureCoherency@VIDMM_GLOBAL@@QEAAJK_KKPEAU_MDL@@PEAK12E@Z @ 0x1C0071C78
 * Callers:
    ...
    if ( v17 >= 0 )
    {
      ...
      do
      {
        ...
        while ( 1 )
        {
          ...
          v44 = v19 + 868941431;
          v43 = &a6[v22];
          VIDMM_GLOBAL::FlushPagingBuffer(
            this,
            0,
            (void (__fastcall *)(void *))VIDMM_SYSMEM_SEGMENT::UnmapTemporaryResource,
            &v43);
