/*
 * XREFs of Template_txqqqtxt @ 0x1C001C0B8
 * Callers:
 *     VidSchEnterIndependentFlip @ 0x1C001C530 (VidSchEnterIndependentFlip.c)
 *     VidSchExitIndependentFlipInternal @ 0x1C001C7D4 (VidSchExitIndependentFlipInternal.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0006E70 (__security_check_cookie.c)
 */

NTSTATUS __fastcall Template_txqqqtxt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v24 = 8LL;
  v26 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndependentFlipTransition, 0LL, 8u, &UserData);
}
