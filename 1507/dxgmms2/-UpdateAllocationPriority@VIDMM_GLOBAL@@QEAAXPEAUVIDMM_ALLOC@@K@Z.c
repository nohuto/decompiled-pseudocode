/*
 * XREFs of ?UpdateAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@K@Z @ 0x1C0054290
 * Callers:
...
void __fastcall VIDMM_GLOBAL::UpdateAllocationPriority(VIDMM_GLOBAL *this, __int64 **a2, int a3)
{
  ...
  *(_DWORD *)(v4 + 376) = a3;
  if ( v5 && (*(_DWORD *)(*(_QWORD *)(v4 + 128) + 56LL) & 0x1001) != 0 && (*(_DWORD *)(v4 + 76) & 0x400) == 0 )
  {
    ...
    v9 = VIDMM_SEGMENT::GetPriorityClass(v7);
    v10 = v9;
    if ( (_DWORD)PriorityClass != v9 )
    {
      ...
      DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v4 + 312), v11, v12, v13);
