/*
 * XREFs of ?EvictResource@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@EEEPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C006BDF0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _VIDMM_LOCAL_ALLOC *a6)
{
  ...
  if ( *(_DWORD *)(*((_QWORD *)this + 1) + 39944LL) )
  {
    ...
    if ( a4 )
    {
      DXGFASTMUTEX::Release(*((struct _KTHREAD ***)a2 + 39), v14, v15, v16);
      return;
    }
  }
  else
  ...
  *((_DWORD *)a2 + 19) &= ~0x400000u;
  ...
  DXGFASTMUTEX::Release(*((struct _KTHREAD ***)a2 + 39), (__int64)v30, v28, v29);
  v31 = *((_QWORD *)this + 1);
