/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C00703C0
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_QWORD *)this + 27) -= *((_QWORD *)a2 + 2);
    ...
    if ( *((_DWORD *)this + 90) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
    {
      ...
      *((_QWORD *)this + 28) -= *((_QWORD *)a2 + 2);
      if ( v8 > qword_1C00273B8 && *((_QWORD *)this + 28) <= (unsigned __int64)qword_1C00273B8 )
        (*(void (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)this + 1) + 39896LL))(
          *(_QWORD *)(*((_QWORD *)this + 1) + 39928LL),
