/*
 * XREFs of ?RecordVaPagingHistoryEvictCommitAlloc@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C003D168
 * Callers:
        ...
        char a3)
{
  ...
  if ( *((_QWORD *)this + 5075) )
  {
    ...
    if ( v6 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5075) + 24LL * (unsigned int)(*((_DWORD *)this + 10152))++ + 8) = 13;
