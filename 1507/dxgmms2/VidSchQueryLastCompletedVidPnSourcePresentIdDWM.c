/*
 * XREFs of VidSchQueryLastCompletedVidPnSourcePresentIdDWM @ 0x1C001CE20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v11 = *(struct _VIDSCH_DEVICE **)(*((_QWORD *)a1 + v5 + 330) + 8LL);
  if ( v11 )
    VidSchQueryLastCompletedPresentIdDWMInternal((KSPIN_LOCK *)a1, v11, v5, v7, a4);
  else
    v4 = -1073741811;
