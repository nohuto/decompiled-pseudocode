/*
 * XREFs of ?MemoryTransferInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@_K1PEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@PEAU_MDL@@234KU_DXGK_TRANSFERFLAGS@@@Z @ 0x1C004F940
 * Callers:
        ...
        DXGK_TRANSFERFLAGS a13)
{
  ...
  v14 = a2;
  v41 = a2;
  if ( (*(_BYTE *)(456LL * a2 + *((_QWORD *)this + 4999) + 420) & 4) == 0 )
  {
