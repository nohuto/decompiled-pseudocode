/*
 * XREFs of ?FindResourcesForOneAllocation@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@_N@Z @ 0x1C003AA74
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::FindResourcesForOneAllocation(__int64 a1, __int64 **a2, unsigned int a3, char a4)
{
  __int64 v6; // rbx
  int v7; // eax
  int v8; // eax
  ...
  if ( !v7 )
    goto LABEL_7;
  if ( a4 && ((v7 & 0x1F) != 0 || (v7 & 0x7C0) != 0) )
  {
    v8 = VIDMM_GLOBAL::AcquireGPUResourcesFromPreferredSegmentSet(a1, **a2);
LABEL_8:
    v11 = v8;
    goto LABEL_9;
  }
  ...
  if ( (*(_BYTE *)(v6 + 79) & 1) != 0 && v11 >= 0 )
  {
           ...
           v13 != (_DWORD)v9)) )
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x80u) != 0 )
        Template_pq(v9, &EventCompleteAllocationMigration, v10, v6, -1073741823);
      v14 = *(_QWORD *)(v6 + 16);
      ++*(_DWORD *)(a1 + 7672);
      *(_QWORD *)(a1 + 7680) += v14;
    }
    ...
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x80u) != 0 )
        Template_pq(v9, &EventCompleteAllocationMigration, v10, v6, 0);
      *(_QWORD *)(a1 + 7664) += *(_QWORD *)(v6 + 16);
      ++*(_DWORD *)(a1 + 7656);
      ++*(_DWORD *)(a1 + 41260);
    }
    *(_DWORD *)(v6 + 76) &= 0xFE7FFFFF;
  }
