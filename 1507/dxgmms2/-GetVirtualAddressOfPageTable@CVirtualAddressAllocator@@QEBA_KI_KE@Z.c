/*
 * XREFs of ?GetVirtualAddressOfPageTable@CVirtualAddressAllocator@@QEBA_KI_KE@Z @ 0x1C0060554
 * Callers:
        ...
        char a4)
{
  ...
  v6 = *(_QWORD *)(*((_QWORD *)this + 8) + 39992LL) + 456LL * a2;
  v7 = a3 >> 12;
