/*
 * XREFs of ?QueryVideoMemoryInfo@VIDMM_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@KKW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEA_K222@Z @ 0x1C0058404
 * Callers:
        ...
        unsigned __int64 *a9)
{
  ...
  if ( v12 )
  {
    ...
    *a8 = *(_QWORD *)(*(_QWORD *)(*v12 + 40832LL) + 8 * v15 + 64);
    *a9 = *(_QWORD *)(v17 + 8 * v9 + 56);
    DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v20, (struct DXGPUSHLOCK *const)(v12 + 38));
  ...
  else
  {
    ...
    *a6 = *(_QWORD *)(*((_QWORD *)a2 + 5104) + 8 * (v19 + 3 * ((int)a5 + 11 * v11 + 3 * v13)) + 80);
    *a8 = *(_QWORD *)(*((_QWORD *)a2 + 5104) + 8 * (v13 + 33 * v11) + 64);
    *a9 &= v14;
    *a7 &= v14;
  }
  return 0LL;
