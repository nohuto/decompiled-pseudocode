/*
 * XREFs of ?RecordVaPagingHistoryVirtualFill@VIDMM_GLOBAL@@QEAAXPEAU_DXGKARG_BUILDPAGINGBUFFER@@KPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0062AE0
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a4)
{
  ...
  if ( *((_QWORD *)this + 5075) )
  {
    ...
    if ( v8 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5075) + 24LL * (unsigned int)(*((_DWORD *)this + 10152))++ + 8) = 6;
