/*
 * XREFs of ?ApertureCorruptionCheck@VIDMM_GLOBAL@@QEAAJE@Z @ 0x1C000EB0C
 * Callers:
 ...
 * Callees:
 *     ?CheckForApertureGuardPageCorruption@VIDMM_APERTURE_SEGMENT@@QEAAJPEAPEAKE@Z @ 0x1C0010CA0 (-CheckForApertureGuardPageCorruption@VIDMM_APERTURE_SEGMENT@@QEAAJPEAPEAKE@Z.c)
 */
...
__int64 __fastcall VIDMM_GLOBAL::ApertureCorruptionCheck(VIDMM_GLOBAL *this, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    v6 = (*((_DWORD *)v5 + 14) & 1) != 0 ? VIDMM_APERTURE_SEGMENT::CheckForApertureGuardPageCorruption(v5, &v10, v3) : 0;
    if ( v6 < 0 )
      break;
