/*
 * XREFs of ?PurgeAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@U_VIDMM_PURGE_FLAGS@@@Z @ 0x1C0051450
 * Callers:
...
void __fastcall VIDMM_GLOBAL::PurgeAllocation(VIDMM_GLOBAL *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !*(_DWORD *)(a2 + 152) )
  {
    ...
    {
      if ( v4 == 1 )
        VIDMM_GLOBAL::FlushPagingBufferInternal(a1, *(_DWORD *)(a2 + 76) & 0x3F, 0, 0LL, 0LL, 0);
      v8 = (_QWORD *)(a2 + 224);
      v9 = *(_QWORD *)(a2 + 224);
      v10 = *(_QWORD **)(a2 + 232);
