/*
 * XREFs of VidSchiCompletePendingCommandInNodeHwQueue @ 0x1C001DC94
 * Callers:
...
void __fastcall VidSchiCompletePendingCommandInNodeHwQueue(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( *(_DWORD *)(a1 + 2848) )
  {
    if ( a3 && *(_DWORD *)(a1 + 2848) > 1u )
    {
      ...
      v20[12] = v5;
      v20[5] = 1;
      *(_QWORD *)(a1 + 208) = MEMORY[0xFFFFF78000000320];
      KeResetEvent((PRKEVENT)(a1 + 168));
      while ( *(_DWORD *)(a1 + 2848) > 1u )
      {
    ...
    if ( *(_DWORD *)(a1 + 2848) )
    {
      ...
      if ( *(_DWORD *)(a1 + 2856) )
      {
        ...
        v17[2] = *(_DWORD *)(a1 + 128);
        v17[0] = 2;
        v17[4] = *(unsigned __int16 *)(*(_QWORD *)(v9 + 8 * v8 + 368) + 8LL);
        v10 = *(_QWORD *)(v9 + 8 * v8 + 368);
      ...
      else
      {
        v17[0] = 1;
        v17[2] = v22;
        v17[3] = *(unsigned __int16 *)(*(_QWORD *)(v9 + 8 * v8 + 368) + 8LL);
        v13 = *(_QWORD *)(v9 + 8 * v8 + 368);
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v4 + 1896), &LockHandle);
