/*
 * XREFs of ?RecordVaPagingHistoryNotifyResidency@VIDMM_GLOBAL@@QEAAXPEAU_DXGKARG_BUILDPAGINGBUFFER@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0061FE0
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  if ( *((_QWORD *)this + 5075) )
  {
    ...
    if ( v6 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5075) + 24LL * (unsigned int)(*((_DWORD *)this + 10152))++ + 8) = 10;
