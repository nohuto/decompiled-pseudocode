/*
 * XREFs of Template_pptpxxqqx @ 0x1C0007C80
 * Callers:
...
NTSTATUS Template_pptpxxqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 4LL;
  v20 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpVirtualFill, 0LL, 9u, &UserData);
}
