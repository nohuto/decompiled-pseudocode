/*
 * XREFs of ?Initialize@VIDMM_DEVICE_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IW4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C0032DE8
 * Callers:
...
LABEL_7:
  ...
  *(_QWORD *)&v21[2] = 4294962295LL;
  SyncObject = VidSchCreateSyncObject(*(_QWORD *)(v13 + 384), 0, (int)v21, 0, (__int64)a1, a1 + 18, 0LL);
  v11 = SyncObject;
  if ( SyncObject < 0 )
  {
