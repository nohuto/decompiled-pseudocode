/*
 * XREFs of ?UnlockAllocationRange@VIDMM_SYSMEM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C006BC50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_SYSMEM_SEGMENT::UnlockAllocationRange(const void **this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  int v4; // esi
  __int64 v5; // rcx
  char *v6; // rax
