/*
 * XREFs of ?VidMmEvictAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C0055290
 * Callers:
 *     ?VidMmEvictAllocation@@YAXPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C000E250 (-VidMmEvictAllocation@@YAXPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLO.c)
 * Callees:
 ...
 *     ?VidMmiAllocationMeetsCriteria@@YA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C0056B48 (-VidMmiAllocationMeetsCriteria@@YA_NPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z.c)
 */
        ...
        struct _D3DKMT_EVICTION_CRITERIA *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( VidMmiAllocationMeetsCriteria(v7, a4) && *((int *)a2 + 38) > 0 )
    {
      ...
      v9 = *(_QWORD *)(*((_QWORD *)a2 + 1) + 72LL) + 152LL * (*((_DWORD *)v7 + 19) & 0x3F);
      v18 = *(struct _VIDSCH_SYNC_OBJECT **)(v9 + 88);
      v26 = *(_QWORD *)(v9 + 96);
      VIDMM_GLOBAL::WaitForFences(this, &v18, (char *)&v26, 1u, 0LL);
    }
  }
  else if ( a3 )
  {
          ...
          if ( v13 != (int *)(v12 - 16) )
          {
            do
            {
              ...
              if ( v13[28] > 0 )
              {
                ...
                v16 = *(_QWORD *)(*((_QWORD *)v14 + 1) + 72LL) + 152LL * (*((_DWORD *)a3 + 19) & 0x3F);
  ...
  {
    v17 = WdLogNewEntry5_WdWarning(this, 0LL, 0LL);
