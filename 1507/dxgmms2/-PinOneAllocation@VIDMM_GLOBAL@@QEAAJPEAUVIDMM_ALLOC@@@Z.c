/*
 * XREFs of ?PinOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@@Z @ 0x1C00510D0
 * Callers:
 ...
 *     ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAKPEAT_LARGE_INTEGER@@@Z @ 0x1C00510B8 (-PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAKPEAT_LARGE_INTEGER@@@Z.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::PinOneAllocation(VIDMM_GLOBAL *this, VIDMM_DEVICE **a2)
{
  ...
  bool v14; // [rsp+98h] [rbp+10h] BYREF

  result = VIDMM_DEVICE::ReferencePinnedAllocation(a2[1], (struct VIDMM_ALLOC *)a2, &v14);
  if ( (int)result >= 0 && !v14 )
  {
    ...
    v9 = VIDMM_GLOBAL::QueueDeferredCommand(
           this,
           (struct VIDMM_PAGING_QUEUE *)(*((_QWORD *)a2[1] + 8) + 152LL * (*(_DWORD *)(v6 + 76) & 0x3F)),
