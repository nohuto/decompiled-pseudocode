/*
 * XREFs of ?ReleaseResource@VIDMM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAX_K@Z @ 0x1C0070D60
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 )
  {
    ...
    if ( *((_DWORD *)this + 90) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
    {
      ...
      if ( v13 < v13 - a4 )
      {
        ...
        *(_QWORD *)(v14 + 24) = 1223LL;
        WdLogEvent5_WdAssertion(v14);
      }
      this[28] = (VIDMM_GLOBAL *)((char *)this[28] - a4);
      if ( v13 > qword_1C00273B8 && (unsigned __int64)this[28] <= qword_1C00273B8 )
        (*((void (__fastcall **)(_QWORD, _QWORD))this[1] + 4987))(
          *((_QWORD *)this[1] + 4991),
    ...
    if ( ((_DWORD)this[7] & 0x1001) != 0 )
    {
      ...
      if ( v15 < a4 )
      {
        ...
        *(_QWORD *)(v16 + 24) = 1246LL;
        WdLogEvent5_WdAssertion(v16);
      }
      *((_QWORD *)this[1] + 4997) -= a4;
    }
  }
}
