/*
 * XREFs of Template_ppqxqpq @ 0x1C00140B8
 * Callers:
...
NTSTATUS Template_ppqxqpq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 8LL;
  v16 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventDmaSubmit, 0LL, 7u, &UserData);
}
