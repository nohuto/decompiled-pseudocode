/*
 * XREFs of VidSchTerminateAdapter @ 0x1C0079880
 * Callers:
...
__int64 __fastcall VidSchTerminateAdapter(struct _VIDSCH_GLOBAL *a1)
{
  ...
  if ( a1 )
  {
    if ( (unsigned int)VidSchiGetSchedulerStatus((__int64)a1) == 1 )
    {
      ...
      {
        VidSchFlushAdapter(a1, 13LL, v7, v8);
    ...
    if ( *((_QWORD *)a1 + 24) )
    {
      ...
      {
        v12 = *(struct _VIDSCH_CONTEXT **)(*((_QWORD *)a1 + 24) + 8LL * i);
        if ( v12 )
    ...
    for ( k = 0; k < *((_DWORD *)a1 + 14); *((_QWORD *)a1 + v20 + 46) = 0LL )
    {
      v20 = k;
      v21 = (_QWORD *)*((_QWORD *)a1 + k + 46);
      v22 = (struct _VIDSCH_CONTEXT *)v21[19];
      if ( v22 )
      {
    ...
    v23 = 0;
    for ( *((_DWORD *)a1 + 54) = 2; v23 < *((_DWORD *)a1 + 10); ++v23 )
    {
      v24 = (void *)*((_QWORD *)a1 + v23 + 330);
      if ( v24 )
      {
        ExFreePoolWithTag(v24, 0);
        *((_QWORD *)a1 + v23 + 330) = 0LL;
      }
      v25 = (void *)*((_QWORD *)a1 + v23 + 647);
      if ( v25 )
      {
        ExFreePoolWithTag(v25, 0);
        *((_QWORD *)a1 + v23 + 647) = 0LL;
      }
    }
    ExDeleteResourceLite((PERESOURCE)((char *)a1 + 2352));
    ExDeleteResourceLite((PERESOURCE)((char *)a1 + 224));
    ExDeleteResourceLite((PERESOURCE)((char *)a1 + 1192));
