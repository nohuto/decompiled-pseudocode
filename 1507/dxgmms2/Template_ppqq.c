/*
 * XREFs of Template_ppqq @ 0x1C000F77C
 * Callers:
...
NTSTATUS Template_ppqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v9, va3);
  v10 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventLock, 0LL, 4u, &UserData);
}
