/*
 * XREFs of ?CheckBudgetRefreshConditionOnProcessMemoryChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C0058058
 * Callers:
        ...
        VIDMM_PROCESS_ADAPTER_INFO *this)
{
  ...
  if ( *(_DWORD *)(*(_QWORD *)this + 6416LL) )
  {
    do
    {
      v4 = (VIDMM_PROCESS_BUDGET_STATE *)(*((_QWORD *)this + 6) + 240LL * v2);
      DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED(
        (DXGAUTOPUSHLOCKSHARED *)v12,
        (VIDMM_PROCESS_ADAPTER_INFO *)((char *)this + 304));
      v5 = (_QWORD *)((char *)v4 + 160);
      v6 = 0;
      v7 = (unsigned int *)(264LL * v2 + *(_QWORD *)(*(_QWORD *)this + 40832LL) + 224LL);
      while ( 1 )
      {
        v8 = *(v5 - 3);
        if ( v6 == 1 )
