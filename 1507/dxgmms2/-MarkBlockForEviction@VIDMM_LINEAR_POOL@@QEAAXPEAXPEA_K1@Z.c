/*
 * XREFs of ?MarkBlockForEviction@VIDMM_LINEAR_POOL@@QEAAXPEAXPEA_K1@Z @ 0x1C0076198
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  *(_DWORD *)a2 = 4;
  ...
  if ( *(struct _VIDMM_POOL_BLOCK **)(v10 + 8) != (struct _VIDMM_POOL_BLOCK *)((char *)a2 + 32) || *v11 != v9 )
    __fastfail(3u);
  *v11 = (char **)v10;
  *(_QWORD *)(v10 + 8) = v11;
  *v9 = 0LL;
