/*
 * XREFs of VidSchSetNodePowerState @ 0x1C001CF50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchSetNodePowerState(__int64 a1, unsigned int a2, int a3, char a4)
{
  ...
  v5 = *(_QWORD *)(a1 + 8LL * (a3 + (unsigned int)*(unsigned __int8 *)(a2 + a1 + 60)) + 368);
  if ( a4 )
  {
    ...
    *(_BYTE *)(v5 + 3084) = 1;
    ...
    while ( (__int64 *)*v8 != v8 )
    {
      ...
      *(_DWORD *)(*v8 + 168) &= ~0x80u;
      v7 = 1;
      VidSchiUpdateContextStatus(v9 - 8, (_QWORD *)5, (__int64 *)0x2662);
    }
    if ( !v6 )
    ...
    if ( v7 )
    {
      *(_QWORD *)(a1 + 1328) = MEMORY[0xFFFFF78000000320];
      KeSetEvent((PRKEVENT)(a1 + 1296), 0, 0);
    }
  }
  else
  {
