/*
 * XREFs of ?CreateReservedVaRange@CVirtualAddressAllocator@@AEAAPEAUVIDMM_MAPPED_VA_RANGE@@PEAUVIDMM_VAD@@I_K1U_D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE@@1@Z @ 0x1C005E910
 * Callers:
        ...
        UINT64 a7)
{
  ...
  if ( v11 )
  {
    ...
    v11[7].Value = 0LL;
    v11[9].Value = 0LL;
    *(_DWORD *)&v11[8].0 = ((*(_BYTE *)&a6.0 & 4) != 0 ? 6 : 0) | v12 & 0xFFFFE800;
    v10 = a4 + a5;
    v11[10].Value = a7;
    v11[11].0 = a6.0;
    v11[12].Value = a4;
  ...
  if ( !v11 )
  {
    ...
    *(_QWORD *)(v13 + 24) = 1742LL;
    WdLogEvent5_WdLowResource(v13);
    return 0LL;
  }
  if ( (int)CVirtualAddressAllocator::AddVaRangeToVadRangeList(this, a2, 0, 0LL, (struct VIDMM_MAPPED_VA_RANGE *)v11) < 0 )
  {
