/*
 * XREFs of ?VidSchiRemoveContextFromSyncPoints@@YAXPEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00034FC
 * Callers:
...
void __fastcall VidSchiRemoveContextFromSyncPoints(struct _VIDSCH_CONTEXT *a1)
{
  ...
  v1 = *((_QWORD *)a1 + 13);
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(v1 + 32) + 1872LL), &LockHandle);
  v3 = (__int64 **)(v1 + 1040);
