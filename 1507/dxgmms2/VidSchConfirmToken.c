/*
 * XREFs of VidSchConfirmToken @ 0x1C001C3C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a2 != -1 )
  {
    ...
    v10 = *(_QWORD *)(a1 + 8 * v8 + 2640);
    v11 = 280 * v9;
    if ( *(_DWORD *)(v10 + 280 * v9 + 148) == 1
      && *(_BYTE *)(v10 + v11 + 145)
      && *(_OWORD *)(v10 + v11 + 120) == __PAIR128__(a5, __PAIR64__(HIDWORD(v12), v6))
      && *(_QWORD *)(v10 + v11 + 136) == a6 )
    {
      *(_BYTE *)(v10 + v11 + 146) = 1;
