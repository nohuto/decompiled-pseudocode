/*
 * XREFs of Template_pqqpqqqxxq @ 0x1C001442C
 * Callers:
...
NTSTATUS Template_pqqpqqqxxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v20 = 8LL;
  v22 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndependentFlip, 0LL, 0xAu, &UserData);
}
