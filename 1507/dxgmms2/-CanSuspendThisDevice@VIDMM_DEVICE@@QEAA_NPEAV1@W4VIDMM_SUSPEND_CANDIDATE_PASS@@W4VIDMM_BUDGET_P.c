/*
 * XREFs of ?CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_PRIORITY_BAND@@@Z @ 0x1C0057074
 * Callers:
...
bool __fastcall VIDMM_DEVICE::CanSuspendThisDevice(VIDMM_DEVICE *a1, VIDMM_DEVICE *a2, int a3, int a4)
{
  ...
  if ( a1 == a2
    || !*((_QWORD *)a1 + 3)
    || a1 == *(VIDMM_DEVICE **)(*(_QWORD *)a1 + 40008LL)
