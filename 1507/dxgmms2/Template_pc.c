/*
 * XREFs of Template_pc @ 0x1C000F374
 * Callers:
...
NTSTATUS Template_pc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v7 = 0;
  v6 = 1;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventOfferAllocation, 0LL, 2u, &v4);
}
