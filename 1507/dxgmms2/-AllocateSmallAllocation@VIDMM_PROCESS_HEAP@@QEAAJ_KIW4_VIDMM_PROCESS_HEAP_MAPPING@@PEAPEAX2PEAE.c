/*
 * XREFs of ?AllocateSmallAllocation@VIDMM_PROCESS_HEAP@@QEAAJ_KIW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAX2PEAEE@Z @ 0x1C0074548
 * Callers:
...
LABEL_19:
    ...
    v34 = v41;
    if ( v41 && v24 )
      VIDMM_LINEAR_POOL::Free(*((VIDMM_LINEAR_POOL **)v24 + 9), v41);
    if ( v43 == 1 )
      VIDMM_PROCESS_HEAP::FreeBlock((VIDMM_PROCESS_HEAP *)a1, v24);
    if ( v16 )
      ExFreeToPagedLookasideList((PPAGED_LOOKASIDE_LIST)(a1 + 64), v16);
    if ( v12 )
      DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(a1 + 16), (__int64)v34, v20, v19);
...
LABEL_17:
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 8) + 64LL) += RegionSize;
  ...
  v16[4].QuadPart = 0LL;
  ++*((_DWORD *)v24 + 6);
  DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(a1 + 16), v26, 0LL, v19);
  *a5 = v16;
  if ( a4 - 3 > 1 )
