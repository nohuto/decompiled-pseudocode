/*
 * XREFs of ?BuildVaRangeList@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_VAD@@0IPEAU_LIST_ENTRY@@_K22@Z @ 0x1C005CD40
 * Callers:
  ...
  for ( i = *v11; i != (__int64 *)v11; i = (__int64 *)*i )
  {
    ...
    if ( a6 < v14 )
    {
      ...
      if ( v15 )
      {
        ...
        *((_QWORD *)v15 + 9) = v18;
        *((_QWORD *)v15 + 10) = v20;
        *((_DWORD *)v15 + 16) = (v19 << 28 >> 28) & 0xF | v16 & 0xFFFFE800 | (16 * (v26 & 0x3F));
