/*
 * XREFs of ?DemoteAllocationsToFitGlobalAlloc@VIDMM_WORKER_THREAD@@AEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_DEVICE@@AEBUVIDMM_PAGE_IN_POLICY_PER_COMBINATION@@W4VIDMM_BUDGET_PRIORITY_BAND@@PEA_N@Z @ 0x1C00570E8
 * Callers:
 ...
 *     ?GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C006FE4C (-GetLargestGap@VIDMM_SEGMENT@@QEAA_KPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z.c)
 */
...
LABEL_8:
  v46 &= ~(1 << v12);
  v49 = v12 + *(_DWORD *)(456LL * (*(_DWORD *)(a2 + 76) & 0x3F) + *(_QWORD *)(*(_QWORD *)v3 + 39992LL) + 4);
...
LABEL_52:
  ...
  while ( 1 )
  {
    ...
    if ( v27 == v24
      && ((dword_1C00270E4 & 0x40) == 0 || *(_DWORD *)(a2 + 376) < 0xA0000000 && (*(_DWORD *)(a2 + 76) & 0x40) != 0) )
    {
      goto LABEL_23;
    }
    LOBYTE(v60) = 0;
