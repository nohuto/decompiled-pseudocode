/*
 * XREFs of ?Lock@VIDMM_MDL_RANGE@@QEAAJPEAXW4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0067348
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a5)
{
  ...
  *(_QWORD *)this = Mdl;
  if ( Mdl )
  {
    ...
    v13[2] = 0LL;
    v13[1] = *(_QWORD *)this;
    if ( VIDMM_SEGMENT::TrackAndValidatePagesOnLock(a4, (struct _VIDMM_MDL *)v13, v11, a5) )
      return 0LL;
  }
  else
  {
