/*
 * XREFs of ?ReadUnusedAllocationConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C0043FBC
 * Callers:
...
void VIDMM_GLOBAL::ReadUnusedAllocationConfiguration(void)
{
  ...
  xmmword_1C00271C0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C00271E0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C0027200 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v9 = 1;
  v1 = 1;
  xmmword_1C00271D0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v13 = 15;
  v7 = 1000000;
  v6 = 1000000;
  v8 = 15;
  v10 = 15;
  qword_1C0027210 = 1000000LL;
  qword_1C00272A8 = 15LL;
  xmmword_1C00272B0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v3 = 0;
  v5 = 45;
  v11 = 120;
  v15 = 0;
  ...
  v12 = 30;
  v14 = 30;
  xmmword_1C00271F0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  qword_1C00272C0 = 30LL;
  ...
  LODWORD(v16[6]) = 4;
  v16[3] = &xmmword_1C00271C0;
  v16[5] = &v9;
  v16[9] = L"Unused.MinimumThreshold";
  v16[10] = (char *)&xmmword_1C00271C0 + 8;
  v16[12] = &v3;
  v16[16] = L"Unused.LowThreshold";
  v16[17] = &xmmword_1C00271D0;
  v16[19] = &v13;
  v16[23] = L"Unused.NormalThreshold";
  v16[24] = (char *)&xmmword_1C00271D0 + 8;
  v16[26] = &v5;
  v16[7] = 0LL;
  LODWORD(v16[8]) = 288;
  ...
  *(_QWORD *)&xmmword_1C00271C0 = 10000000 * xmmword_1C00271C0;
  *((_QWORD *)&xmmword_1C00271C0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00271D0 = 10000000 * xmmword_1C00271D0;
  *((_QWORD *)&xmmword_1C00271D0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00271E0 = 10000000 * xmmword_1C00271E0;
  *((_QWORD *)&xmmword_1C00271E0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00271F0 = 10000000 * xmmword_1C00271F0;
  *((_QWORD *)&xmmword_1C00271F0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0027200 = 10000000 * xmmword_1C0027200;
  *((_QWORD *)&xmmword_1C0027200 + 1) *= 10000000LL;
  qword_1C0027210 *= 10000000LL;
  do
    *v0++ *= 10000000LL;
  while ( (__int64)v0 < (__int64)&qword_1C00272C8 );
}
