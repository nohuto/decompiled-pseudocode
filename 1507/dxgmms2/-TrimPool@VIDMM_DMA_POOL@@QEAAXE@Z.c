/*
 * XREFs of ?TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z @ 0x1C005A640
 * Callers:
 *     VidMmTrimDmaPoolToMinimum @ 0x1C000E8B0 (VidMmTrimDmaPoolToMinimum.c)
 *     ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C0059B78 (-GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z.c)
 * Callees:
...
void __fastcall VIDMM_DMA_POOL::TrimPool(VIDMM_DMA_POOL **this, __int64 a2)
{
  ...
  *(_QWORD *)(v5 + 24) = this[2];
       ...
       && v8 != (VIDMM_DMA_POOL *)(this + 12) )
  {
    ...
    {
      v13 = 0;
      VIDMM_DMA_POOL::WaitDmaBufferNotBusy((VIDMM_DMA_POOL *)this, v9, 1u, &v13);
      if ( v13 )
      {
