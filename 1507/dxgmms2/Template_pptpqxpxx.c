/*
 * XREFs of Template_pptpqxpxx @ 0x1C0007380
 * Callers:
...
NTSTATUS Template_pptpqxpxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 8LL;
  v20 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpFlushTlb, 0LL, 9u, &UserData);
}
