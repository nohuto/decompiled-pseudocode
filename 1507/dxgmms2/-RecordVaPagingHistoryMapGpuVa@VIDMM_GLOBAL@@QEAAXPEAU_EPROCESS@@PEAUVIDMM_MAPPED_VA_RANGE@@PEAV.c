/*
 * XREFs of ?RecordVaPagingHistoryMapGpuVa@VIDMM_GLOBAL@@QEAAXPEAU_EPROCESS@@PEAUVIDMM_MAPPED_VA_RANGE@@PEAVVIDMM_PAGING_QUEUE@@_K@Z @ 0x1C0061E50
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( *((_QWORD *)this + 5075) )
  {
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5075) + 24LL * (unsigned int)(*((_DWORD *)this + 10152))++ + 8) = 14;
