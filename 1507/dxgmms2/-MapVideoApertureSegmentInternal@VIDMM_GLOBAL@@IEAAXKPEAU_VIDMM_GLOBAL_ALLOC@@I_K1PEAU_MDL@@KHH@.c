/*
 * XREFs of ?MapVideoApertureSegmentInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@I_K1PEAU_MDL@@KHH@Z @ 0x1C004F634
 * Callers:
        ...
        int a10)
{
  ...
  do
  {
    ...
    if ( a3 && a3[12] && (*(_DWORD *)a3[59] & 0x10000000) == 0 && (*((_DWORD *)a3 + 21) & 4) == 0 )
    {
      ...
      v16 = (struct _KTHREAD **)a3[39];
      v21.UpdateContextAllocation.ContextAllocation = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3[12] + 5) - 32LL)
                                                                            + 24LL)
                                                                + 360LL);
