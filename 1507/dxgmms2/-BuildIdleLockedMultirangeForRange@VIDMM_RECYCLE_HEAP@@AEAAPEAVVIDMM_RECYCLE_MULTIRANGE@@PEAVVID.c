/*
 * XREFs of ?BuildIdleLockedMultirangeForRange@VIDMM_RECYCLE_HEAP@@AEAAPEAVVIDMM_RECYCLE_MULTIRANGE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C006596C
 * Callers:
        ...
        struct VIDMM_RECYCLE_RANGE *a2)
{
  ...
  if ( v6 && *(_DWORD *)(v6 + 64) == 4 )
    Multirange = *(struct VIDMM_RECYCLE_MULTIRANGE **)(v6 + 152);
  if ( NextRange && *((_DWORD *)NextRange + 16) == 4 )
    v8 = (struct VIDMM_RECYCLE_MULTIRANGE *)*((_QWORD *)NextRange + 19);
  if ( Multirange )
  {
    if ( v8 )
    {
      ...
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(this, 0LL, Multirange);
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(this, 0LL, v8);
