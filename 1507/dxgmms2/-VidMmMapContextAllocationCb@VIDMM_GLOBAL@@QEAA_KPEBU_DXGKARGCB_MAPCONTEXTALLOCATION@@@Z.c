/*
 * XREFs of ?VidMmMapContextAllocationCb@VIDMM_GLOBAL@@QEAA_KPEBU_DXGKARGCB_MAPCONTEXTALLOCATION@@@Z @ 0x1C0055668
 * Callers:
 *     ?VidMmMapContextAllocationCb@@YA_KPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_MAPCONTEXTALLOCATION@@@Z @ 0x1C000E2C0 (-VidMmMapContextAllocationCb@@YA_KPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_MAPCONTEXTALLOCATION@@@Z.c)
 * Callees:
        ...
        const struct _DXGKARGCB_MAPCONTEXTALLOCATION *a2)
{
  ...
  v6 = VIDMM_GLOBAL::VidMmMapGpuVirtualAddress(this, 0LL, v5, &v14, 0, *(_DWORD *)(**(_QWORD **)v5 + 76LL) & 0x3F);
  v11 = v6;
  if ( v6 >= 0 )
