/*
 * XREFs of ?Init@VIDMM_FENCE_STORAGE_PAGE@@QEAAJXZ @ 0x1C0037B84
 * Callers:
 ...
 * Callees:
 *     ?FreeStorage@VIDMM_FENCE_STORAGE_PAGE@@AEAAXXZ @ 0x1C00318DC (-FreeStorage@VIDMM_FENCE_STORAGE_PAGE@@AEAAXXZ.c)
