/*
 * XREFs of Template_piiqq @ 0x1C0013D70
 * Callers:
 ...
 *     VidSchiStartContextRunningTimeAtISR @ 0x1C00049A0 (VidSchiStartContextRunningTimeAtISR.c)
 *     VidSchiResetContextQuantumAtISR @ 0x1C0019690 (VidSchiResetContextQuantumAtISR.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0006E70 (__security_check_cookie.c)
 */

NTSTATUS Template_piiqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 4LL;
  v12 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventUpdateContextRunningTime, 0LL, 5u, &UserData);
}
