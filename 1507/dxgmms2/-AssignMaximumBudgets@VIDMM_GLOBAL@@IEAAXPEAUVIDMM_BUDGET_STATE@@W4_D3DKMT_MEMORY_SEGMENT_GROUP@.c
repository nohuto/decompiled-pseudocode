/*
 * XREFs of ?AssignMaximumBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1C00725B4
 * Callers:
...
void __fastcall VIDMM_GLOBAL::AssignMaximumBudgets(VIDMM_GLOBAL *this, struct VIDMM_BUDGET_STATE *a2, int a3)
{
  ...
  v6 = *((_QWORD *)this + 5104) + 264LL * *((unsigned int *)a2 + 69);
  v8 = 0;
  v22 = a3;
  v9 = this;
  v10 = a3;
  for ( i = 3LL * a3; ; i = 3 * v10 )
  {
    ...
    if ( *v5 )
    {
      ...
      if ( v14 != v15 )
      {
        do
        {
          v16 = (struct VIDMM_PROCESS_ADAPTER_INFO *)(v14 - 336);
          v14 = *(char **)v14;
