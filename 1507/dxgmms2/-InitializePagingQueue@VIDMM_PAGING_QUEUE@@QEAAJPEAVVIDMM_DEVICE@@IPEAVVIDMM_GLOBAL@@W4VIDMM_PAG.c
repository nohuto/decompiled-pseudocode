/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C00361B4
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::InitializePagingQueue(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  *(_QWORD *)(a1 + 128) = a2;
  *(_BYTE *)(a1 + 122) = *(_BYTE *)(a4 + 4616);
  *(_DWORD *)(a1 + 124) = dword_1C0027354;
  *(_DWORD *)(a1 + 108) = a5;
  v6 = *(_QWORD *)(a4 + 24);
  if ( *(int *)(v6 + 1648) < 0x2000 )
    v7 = 1;
  else
    v7 = *(_DWORD *)(v6 + 232);
  if ( v7 > 1 )
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(a1 + 24) = v12;
      if ( v10 >= 2 )
      {
        ...
        *(_QWORD *)(v14 + 96) = v15;
        if ( *(_BYTE *)(v14 + 49) )
          VIDMM_PAGING_QUEUE::SetStatus(a1, 2LL);
        *(_QWORD *)(v14 + 112) = 0LL;
