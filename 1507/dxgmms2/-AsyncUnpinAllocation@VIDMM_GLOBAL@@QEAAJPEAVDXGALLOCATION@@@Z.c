/*
 * XREFs of ?AsyncUnpinAllocation@VIDMM_GLOBAL@@QEAAJPEAVDXGALLOCATION@@@Z @ 0x1C004B904
 * Callers:
 *     VidMmAsyncUnpinAllocation @ 0x1C000E510 (VidMmAsyncUnpinAllocation.c)
 * Callees:
        ...
        __int64 a4)
{
  ...
  v4 = *((_QWORD *)a2 + 3);
  v7 = 0;
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v13, (struct _KTHREAD **)this + 5159, 0LL, a4);
  ...
  else
  {
    ...
    if ( (unsigned int)VidMmQueueAsyncOperation((struct _VIDMM_ASYNC_OPERATION *)v16) )
    {
      ...
      *(_BYTE *)(v4 + 25) = *(_BYTE *)(v4 + 25) & 0xF9 | 2;
      _InterlockedIncrement((volatile signed __int32 *)this + 9987);
    }
    else
    {
      v7 = -1073741801;
