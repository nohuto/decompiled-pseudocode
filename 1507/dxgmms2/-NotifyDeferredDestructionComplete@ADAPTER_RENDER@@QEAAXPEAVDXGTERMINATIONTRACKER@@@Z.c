/*
 * XREFs of ?NotifyDeferredDestructionComplete@ADAPTER_RENDER@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C00041A8
 * Callers:
...
{
  ((__int64 (__fastcall **)(ADAPTER_RENDER *, struct DXGTERMINATIONTRACKER *))DxgCoreInterface)[43](this, a2);
}
