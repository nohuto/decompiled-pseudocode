/*
 * XREFs of ?RecordRotation@VIDMM_GLOBAL@@SAXPEAU_EPROCESS@@PEAX_KPEAU_MDL@@W4_MM_ROTATE_DIRECTION@@J@Z @ 0x1C0064898
 * Callers:
        ...
        int a6)
{
  ...
  {
    v7 = 6LL * (_InterlockedExchangeAdd((_DWORD *)&qword_1C00273D8 + 1, 1u) % (unsigned int)qword_1C00273D8);
