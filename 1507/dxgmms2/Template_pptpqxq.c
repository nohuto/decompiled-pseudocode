/*
 * XREFs of Template_pptpqxq @ 0x1C0007470
 * Callers:
...
NTSTATUS Template_pptpqxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 8LL;
  v16 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpNotifyResidency, 0LL, 7u, &UserData);
}
