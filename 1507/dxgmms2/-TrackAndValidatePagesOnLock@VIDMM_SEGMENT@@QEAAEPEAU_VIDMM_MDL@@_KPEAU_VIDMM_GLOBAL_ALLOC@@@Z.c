/*
 * XREFs of ?TrackAndValidatePagesOnLock@VIDMM_SEGMENT@@QEAAEPEAU_VIDMM_MDL@@_KPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00715CC
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      *(_QWORD *)(v8 + 16LL * *((unsigned int *)v6 + 59)) = *(_QWORD *)&v4[2 * v5 + 12];
      this = (VIDMM_SEGMENT *)(2LL * *((unsigned int *)v6 + 59));
      *(_QWORD *)(*((_QWORD *)v6 + 30) + 16LL * (unsigned int)(*((_DWORD *)v6 + 59))++ + 8) = a4;
      *((_DWORD *)v6 + 59) &= -(*((_DWORD *)v6 + 59) < *((_DWORD *)v6 + 58));
    }
    if ( *(_QWORD *)&v4[2 * v5 + 12] << 12 > *((_QWORD *)v6 + 14) )
      break;
    if ( ++v5 >= v7 )
      return 1;
  }
  v10 = WdLogNewEntry5_WdAssertion(this, v8, v6, a4);
  *(_QWORD *)(v10 + 24) = v5;
