/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1C00734F8
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( *((_DWORD *)v6 + 1604) )
      {
        do
        {
          ...
          if ( (unsigned int)dword_1C0027010 > 5 && TlgKeywordOn(v6, (ULONGLONG)a2) )
          {
            v10 = *(unsigned __int16 **)(*(_QWORD *)(v9 + 24) + 976LL);
            v25 = v28;
            v26 = 2LL;
            v11 = *v10;
            v27 = *((_QWORD *)v10 + 1);
            ...
            v50 = 8LL;
            v52 = 8LL;
            TlgWrite((TraceLoggingHProvider)!v19, &unk_1C0020A50, a3, v20, 0x11u, &pData);
          }
          v6 = *this;
          ++v7;
        }
