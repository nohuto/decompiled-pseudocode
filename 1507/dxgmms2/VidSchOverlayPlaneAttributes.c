/*
 * XREFs of VidSchOverlayPlaneAttributes @ 0x1C001CAF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchOverlayPlaneAttributes(__int64 a1, unsigned int a2, char *a3, __int64 a4, _DWORD *a5, int *a6)
{
  ...
  *a5 = 0;
  ...
  if ( *(_DWORD *)(a1 + 124) )
  {
    do
    {
      v14 = *(_QWORD *)(a1 + 8 * v9 + 2640);
      v15 = 280LL * (unsigned int)v13;
      if ( *(_WORD *)(v15 + v14 + 82) > (unsigned __int16)*(_DWORD *)(v15 + v14 + 80) )
      {
        v16 = 1536 * v13;
        if ( *(_QWORD *)(1536 * v13 + v14 + 2344) )
        {
          v17 = *(_QWORD *)(v16 + v14 + 2352);
          *(_OWORD *)((char *)v27 + 24 * v8) = *(_OWORD *)(v16 + v14 + 2336);
          v18 = *(_OWORD *)(v15 + v14 + 80);
          if ( (_DWORD)v13 == v12 )
            v12 = v8;
