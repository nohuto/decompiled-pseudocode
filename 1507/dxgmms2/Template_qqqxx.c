/*
 * XREFs of Template_qqqxx @ 0x1C0010F34
 * Callers:
...
NTSTATUS __fastcall Template_qqqxx(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v15 = 8LL;
  v17 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventUpdateVPR, 0LL, 5u, &UserData);
}
