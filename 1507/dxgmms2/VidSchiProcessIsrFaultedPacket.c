/*
 * XREFs of VidSchiProcessIsrFaultedPacket @ 0x1C00189B0
 * Callers:
...
PSLIST_ENTRY __fastcall VidSchiProcessIsrFaultedPacket(__int64 a1, unsigned int a2, int a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)(a1 + 64) != a2 )
  {
    v8 = *(unsigned int *)(a1 + 1332);
    v9 = *(_QWORD *)(a1 + 8 * v8 + 1344);
    v10 = *(_QWORD *)(v9 + 48);
    if ( *(_QWORD *)(v10 + 104) == v4[11].Alignment )
    {
      v11 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v8, v10);
      v11[3] = 281LL;
      v11[4] = 5LL;
      v11[5] = v4;
    ...
    _InterlockedExchange((volatile __int32 *)(a1 + 1332), ((_BYTE)v8 + 1) & 0xF);
    v12 = *(unsigned int *)(a1 + 1476);
    *(_DWORD *)(a1 + 420) = ((unsigned __int8)*(_DWORD *)(a1 + 420) + 1) & 0xF;
    v13 = *(_QWORD *)(a1 + 8 * v12 + 1488);
    v14 = ((_BYTE)v12 + 1) & 0xF;
    _InterlockedExchange((volatile __int32 *)(a1 + 1476), ((_BYTE)v12 + 1) & 0xF);
    ...
    *(_DWORD *)(v9 + 92) ^= (*(_DWORD *)(v9 + 92) ^ (a3 << 6)) & 0x40;
    ...
    *(_DWORD *)(*(_QWORD *)(v13 + 104) + 196LL) = *(_DWORD *)(a4 + 60);
    ...
    return ExpInterlockedPushEntrySList(v4 + 120, (PSLIST_ENTRY)(v9 + 32));
  }
  return result;
}
