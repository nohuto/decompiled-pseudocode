/*
 * XREFs of ??1VIDMM_PROCESS@@QEAA@XZ @ 0x1C00369F0
 * Callers:
 *     VidMmTerminateProcess @ 0x1C0005EB0 (VidMmTerminateProcess.c)
  ...
  if ( *((_QWORD *)this + 2) )
  {
    ...
    if ( (unsigned int)DXGGLOBAL::GetMaximumAdapterCount(Global) )
    {
      do
      {
        ...
        if ( v5 )
        {
          DXGPUSHLOCK::AcquireExclusive((VIDMM_GLOBAL *)((char *)*v5 + 40648));
          v6 = v5[3];
