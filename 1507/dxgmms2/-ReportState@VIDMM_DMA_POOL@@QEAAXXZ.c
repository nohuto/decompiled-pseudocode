/*
 * XREFs of ?ReportState@VIDMM_DMA_POOL@@QEAAXXZ @ 0x1C005A0E0
 * Callers:
 *     VidMmReportDmaPoolState @ 0x1C000E7B0 (VidMmReportDmaPoolState.c)
...
void __fastcall VIDMM_DMA_POOL::ReportState(VIDMM_DMA_POOL *this, __int64 a2, __int64 a3)
{
  ...
  __int64 v19; // [rsp+48h] [rbp-120h]
  int v20; // [rsp+60h] [rbp-108h]
  char v21; // [rsp+A8h] [rbp-C0h]
  int v22; // [rsp+F0h] [rbp-78h]
  int v23; // [rsp+F4h] [rbp-74h]
  int v24; // [rsp+170h] [rbp+8h]
  int v25; // [rsp+178h] [rbp+10h]
  int v26; // [rsp+180h] [rbp+18h]
  int v27; // [rsp+188h] [rbp+20h]
...
LABEL_26:
    ...
    if ( v16 && (Microsoft_Windows_DxgKrnlEnableBits & 0x80u) != 0 )
    {
      ...
      LODWORD(v18) = v17;
      Template_pqx(v17, &EventReportCommittedGlobalAllocation, a3, v7, v18, *(_QWORD *)(v7 + 136));
    }
    goto LABEL_26;
  }
}
