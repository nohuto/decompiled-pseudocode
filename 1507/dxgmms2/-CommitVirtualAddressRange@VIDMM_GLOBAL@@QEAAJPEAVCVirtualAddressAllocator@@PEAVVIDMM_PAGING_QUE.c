/*
 * XREFs of ?CommitVirtualAddressRange@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@PEAVVIDMM_PAGING_QUEUE@@PEAUVIDMM_MAPPED_VA_RANGE@@EPEAU_MDL@@PEA_KPEAUVIDMM_VAD_PENDING_OPERATION@@@Z @ 0x1C004BFD8
 * Callers:
        ...
        struct VIDMM_VAD_PENDING_OPERATION *a8)
{
  ...
  int v14; // edi
  bool v15; // bl
  _QWORD v17[10]; // [rsp+38h] [rbp-79h] BYREF
  _OWORD v18[5]; // [rsp+88h] [rbp-29h] BYREF
