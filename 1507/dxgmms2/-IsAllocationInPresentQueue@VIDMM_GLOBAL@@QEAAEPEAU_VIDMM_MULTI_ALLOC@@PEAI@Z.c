/*
 * XREFs of ?IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@PEAI@Z @ 0x1C004E7DC
 * Callers:
 *     VidMmIsAllocationInPresentQueue @ 0x1C000E6E0 (VidMmIsAllocationInPresentQueue.c)
