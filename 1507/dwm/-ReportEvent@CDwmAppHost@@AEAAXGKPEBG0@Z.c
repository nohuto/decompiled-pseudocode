/*
 * XREFs of ?ReportEvent@CDwmAppHost@@AEAAXGKPEBG0@Z @ 0x140004778
 * Callers:
 ...
 * Callees:
 *     ?Report@CEventLogHandle@@QEAAJGKGPEAPEBG@Z @ 0x140005828 (-Report@CEventLogHandle@@QEAAJGKGPEAPEBG@Z.c)
 */
