/*
 * XREFs of ?RefreshPreferencesAndPolicies@CSettingsManager@@QEAAXXZ @ 0x140002880
 * Callers:
 *     ?Initialize@CDwmAppHost@@QEAAJPEAUHINSTANCE__@@@Z @ 0x1400022B0 (-Initialize@CDwmAppHost@@QEAAJPEAUHINSTANCE__@@@Z.c)
 *     ?PropagateUserLogon@CSettingsManager@@QEAAXPEAUHKEY__@@0_N@Z @ 0x140002A20 (-PropagateUserLogon@CSettingsManager@@QEAAXPEAUHKEY__@@0_N@Z.c)
 * Callees:
 *     ?ReadRegistryBitfields@CSettingsManager@@AEAAXW4DwmSettingType@@PEAUBitfieldRegistrySetting@@IPEAK@Z @ 0x140002580 (-ReadRegistryBitfields@CSettingsManager@@AEAAXW4DwmSettingType@@PEAUBitfieldRegistrySetting@@IPE.c)
...
void __fastcall CSettingsManager::RefreshPreferencesAndPolicies(CSettingsManager *this)
{
  ...
  v9[9] = 16LL;
  v9[11] = 32LL;
  CSettingsManager::ReadRegistryBitfields((__int64)this, 0, (__int64)&v2, 3u, (_DWORD *)this + 14);
  CSettingsManager::ReadRegistryBitfields((__int64)this, 1, (__int64)v9, 6u, (_DWORD *)this + 15);
}
