/*
 * XREFs of ?GetFloat@CSettingsManager@@AEAAJPEBGPEAM@Z @ 0x140002610
 * Callers:
 *     ?GetPreferenceFloat@CSettingsManager@@UEAAJPEBGPEAM@Z @ 0x140002870 (-GetPreferenceFloat@CSettingsManager@@UEAAJPEBGPEAM@Z.c)
 * Callees:
