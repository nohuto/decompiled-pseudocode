/*
 * XREFs of UsbhFdoReturnDeviceConfigInfo @ 0x1C0025E3C
 * Callers:
...
__int64 __fastcall UsbhFdoReturnDeviceConfigInfo(__int64 a1, ULONG_PTR a2, IRP *a3, __int64 a4)
{
  ...
  if ( (*((_BYTE *)v7 + 1414) & 1) != 0 )
  {
    ...
    *(_OWORD *)&SecurityContext[5].DesiredAccess = *(_OWORD *)(v7 + 642);
    *(_OWORD *)&SecurityContext[6].AccessState = *(_OWORD *)(v7 + 646);
    *(_OWORD *)&SecurityContext[7].SecurityQos = *(_OWORD *)(v7 + 650);
    *(_OWORD *)&SecurityContext[7].DesiredAccess = *(_OWORD *)(v7 + 654);
    LODWORD(SecurityContext[8].AccessState) = v7[658];
  }
