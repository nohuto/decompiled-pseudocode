/*
 * XREFs of Usbh_PnpRemove @ 0x1C004BDB0
 * Callers:
...
__int64 __fastcall Usbh_PnpRemove(__int64 a1, unsigned int a2)
{
  __int64 v4; // r9
  __int64 v5; // r8
  __int64 v6; // r9
  ...
  GET_FDO_PNPSTATE(a1);
  UsbhSetFdoPnpState(*(_QWORD *)(a1 + 8), 3LL, a2, v4);
  UsbhReleaseFdoPnpLock(*(_QWORD *)(a1 + 8), a1, v5, v6);
  UsbhDispatch_BusEvent(*(struct _DEVICE_OBJECT **)(a1 + 8), a1, 12LL, v7);
  UsbhReferenceListClose(*(_QWORD *)(a1 + 8));
  UsbhModuleDispatch(0, v8, *(_LIST_ENTRY **)(a1 + 8), 2, 0LL, a1);
  return 0LL;
}
