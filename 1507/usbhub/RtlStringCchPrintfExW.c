/*
 * XREFs of RtlStringCchPrintfExW @ 0x1C0024440
 * Callers:
 *     UsbhBusIfLocationGetLocationStrings @ 0x1C00243B0 (UsbhBusIfLocationGetLocationStrings.c)
 * Callees:
...
LABEL_3:
  if ( v9 >= 0 )
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (NTSTRSAFE_PCWSTR)qword_1C002AAD0;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
