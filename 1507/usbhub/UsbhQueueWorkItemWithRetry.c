/*
 * XREFs of UsbhQueueWorkItemWithRetry @ 0x1C00230C0
 * Callers:
 ...
 *     UsbhIsrRetryTimer @ 0x1C0043DA0 (UsbhIsrRetryTimer.c)
 *     UsbhResetIrqPipeRetryTimer @ 0x1C0044200 (UsbhResetIrqPipeRetryTimer.c)
 *     UsbHubhInitTimeoutTimer @ 0x1C004AB20 (UsbHubhInitTimeoutTimer.c)
 *     UsbhInitRetryTimer @ 0x1C004B650 (UsbhInitRetryTimer.c)
 *     UsbhIdleIrpRetryTimer @ 0x1C00550D0 (UsbhIdleIrpRetryTimer.c)
 *     UsbhIdleIrp_NoIrp @ 0x1C0055600 (UsbhIdleIrp_NoIrp.c)
 *     UsbhSS_WakeIrpRetryTimer @ 0x1C0055EB0 (UsbhSS_WakeIrpRetryTimer.c)
 * Callees:
        ...
        unsigned int a7)
{
  ...
  {
    WPP_RECORDER_SF_d(v12->DeviceExtension, 0, 1, 46, (__int64)&WPP_7089f250826f62cd62a41d7a765d92e3_Traceguids, a6);
    v12 = WPP_GLOBAL_Control;
  }
  ...
  if ( LOWORD(v12->DeviceType) )
    WPP_RECORDER_SF_d(v12->DeviceExtension, 0, 1, 45, (__int64)&WPP_7089f250826f62cd62a41d7a765d92e3_Traceguids, a6);
