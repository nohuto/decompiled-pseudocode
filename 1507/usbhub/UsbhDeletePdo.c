/*
 * XREFs of UsbhDeletePdo @ 0x1C0053984
 * Callers:
...
void __fastcall UsbhDeletePdo(struct _DEVICE_OBJECT *a1, ULONG_PTR a2, int a3, unsigned int a4, __int64 a5)
{
  __int64 v9; // r15
  char v10; // r12
  __int64 v11; // rdx
  ...
  v9 = 0LL;
  v10 = 0;
  Log((__int64)a1, 256, 1682981967, a2, a3);
  ...
  {
    UsbhDeleteOrphanPdo(a2, v15, v17, v18);
  }
  if ( a3 == 6 )
  {
    *(_DWORD *)(a5 + 136) = 0;
  ...
  else
  {
    ...
    SET_PDO_HWPNPSTATE(a2, 6LL, a4, v19);
    *(_DWORD *)(a5 + 136) = 0;
    WPP_MAIN_CB.Dpc.DeferredRoutine = 0LL;
    *(_DWORD *)(a5 + 88) = 1734964085;
    KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels, *(_BYTE *)(a5 + 132));
    ...
    v25 = (void *)*((_QWORD *)v16 + 142);
    if ( v25 )
    {
      ExFreePoolWithTag(v25, 0);
      *((_QWORD *)v16 + 142) = 0LL;
    }
    v26 = (void *)*((_QWORD *)v16 + 279);
    if ( v26 )
    {
      ExFreePoolWithTag(v26, 0);
      *((_QWORD *)v16 + 279) = 0LL;
    }
    v27 = (void *)*((_QWORD *)v16 + 351);
    if ( v27 )
    {
      ExFreePoolWithTag(v27, 0);
      *((_QWORD *)v16 + 351) = 0LL;
    }
    v28 = (void *)*((_QWORD *)v16 + 298);
    if ( v28 )
    {
      ExFreePoolWithTag(v28, 0);
      *((_QWORD *)v16 + 298) = 0LL;
    }
    v29 = (void *)*((_QWORD *)v16 + 299);
    if ( v29 )
    {
      ExFreePoolWithTag(v29, 0);
      *((_QWORD *)v16 + 299) = 0LL;
    }
    v30 = (void *)*((_QWORD *)v16 + 312);
    if ( v30 )
    {
      ExFreePoolWithTag(v30, 0);
      *((_QWORD *)v16 + 312) = 0LL;
    }
    v31 = (void *)*((_QWORD *)v16 + 106);
    if ( v31 )
    {
      ExFreePoolWithTag(v31, 0);
      *((_QWORD *)v16 + 106) = 0LL;
    }
    UsbhUnlinkPdoDeviceHandle((__int64)a1, a2, 2017740855, 1);
    Log((__int64)a1, 256, 1682457649, a2, 0LL);
    v34 = (unsigned int)v16[354];
    if ( (v34 & 1) != 0 )
    {
      UsbhDecPdoIoCount(a2, a2, v34, v33);
      KeWaitForSingleObject(v16 + 308, Executive, 0, 0, 0LL);
    }
    v35 = (_QWORD *)*((_QWORD *)v16 + 107);
    if ( v35 )
    {
      UsbhDecHubBusy((__int64)a1, v32, v35, v33);
      *((_QWORD *)v16 + 107) = 0LL;
    }
    if ( (v16[354] & 2) != 0 )
      UsbhDisconnectPdoFromHub(a2, v32, (__int64)v35, v33);
    v16[354] = 16;
