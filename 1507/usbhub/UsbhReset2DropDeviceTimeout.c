/*
 * XREFs of UsbhReset2DropDeviceTimeout @ 0x1C00515E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhReset2DropDeviceTimeout(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rdx
  __int64 v7; // r8
  __int64 v8; // r9
  ...
  Log((__int64)a1, 1024, 1884447794, a2, 0LL);
