/*
 * XREFs of UsbhHubRunPortChangeQueue @ 0x1C00104E0
 * Callers:
...
__int64 __fastcall UsbhHubRunPortChangeQueue(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v10 = (char *)&WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids;
  ...
  *(_DWORD *)(a2 + 8) = 1;
  while ( 1 )
  {
    ...
    v46 = 0LL;
    if ( !v11 )
      UsbhTrapFatal_Dbg(a1, 0LL, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, a4);
    if ( *v11 != 541218120 )
      UsbhTrapFatal_Dbg(a1, v11, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, a4);
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_dq(
        WPP_GLOBAL_Control->DeviceExtension,
        (_DWORD)v11,
