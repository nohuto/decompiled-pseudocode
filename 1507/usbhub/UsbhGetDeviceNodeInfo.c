/*
 * XREFs of UsbhGetDeviceNodeInfo @ 0x1C004DAB0
 * Callers:
...
__int64 __fastcall UsbhGetDeviceNodeInfo(__int64 a1, _DWORD *a2, __int64 a3, unsigned int *a4, __int64 a5)
{
  ...
  if ( v23 >= 0 )
  {
    ...
    *a2 = 1431519822;
    a2[1] = v14;
    *(_OWORD *)(a2 + 2) = *(_OWORD *)((char *)v9 + 2410);
    *(_OWORD *)(a2 + 6) = *(_OWORD *)((char *)v9 + 2426);
    *(_OWORD *)(a2 + 10) = *(_OWORD *)((char *)v9 + 2442);
    *(_OWORD *)(a2 + 14) = *(_OWORD *)((char *)v9 + 2458);
    *(_OWORD *)(a2 + 18) = *(_OWORD *)((char *)v9 + 2474);
    a2[22] = 0;
