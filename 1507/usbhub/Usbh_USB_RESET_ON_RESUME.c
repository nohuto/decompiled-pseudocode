/*
 * XREFs of Usbh_USB_RESET_ON_RESUME @ 0x1C004CF90
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_USB_RESET_ON_RESUME(__int64 a1, const wchar_t *a2, _BYTE *a3, __int64 a4)
{
  _UNKNOWN **result; // rax
  int v5; // esi
