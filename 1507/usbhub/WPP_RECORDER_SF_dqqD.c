/*
 * XREFs of WPP_RECORDER_SF_dqqD @ 0x1C0055EE0
 * Callers:
...
__int64 WPP_RECORDER_SF_dqqD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_1436580ac7c1e6e547d4e2396d01fda1_Traceguids,
      13LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_1436580ac7c1e6e547d4e2396d01fda1_Traceguids, v7, (__int64 *)va);
}
