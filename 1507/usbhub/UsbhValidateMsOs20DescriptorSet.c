/*
 * XREFs of UsbhValidateMsOs20DescriptorSet @ 0x1C00530A0
 * Callers:
 ...
 *     UsbhGetNextMsOs20Descriptor @ 0x1C004008C (UsbhGetNextMsOs20Descriptor.c)
 */
...
char __fastcall UsbhValidateMsOs20DescriptorSet(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4)
{
  ...
  v9 = 1;
  v10 = *((_WORD *)v6 + 1398);
  v11 = (unsigned __int16 *)*((_QWORD *)v6 + 351);
  if ( v10 != v7 )
  {
    v12 = 1447907120;
    v18 = v7;
