/*
 * XREFs of UsbhCreateDevice @ 0x1C000A574
 * Callers:
...
__int64 __fastcall UsbhCreateDevice(__int64 a1, __int64 a2, unsigned __int16 a3, unsigned __int16 a4)
{
  ...
  if ( (*(_DWORD *)(v8 + 2560) & 0x40) != 0 )
  {
    ...
    if ( !DeviceHandle )
    {
      LOBYTE(v21) = 0;
      v16 = -1073741823;
      UsbhException(a1, (unsigned __int16)v5, 5, 0, 0, -1073741823, -1, usbfile_bus_c, 6211, v21);
...
LABEL_3:
    if ( *(_QWORD *)(v8 + 4256) )
    {
      ...
      {
        LOWORD(v20) = v5;
        v15 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int64 *, __int64, _QWORD, int, int *, unsigned __int16))(v8 + 4256))(
                *(_QWORD *)(v8 + 4232),
                &v25,
                v11,
                v4,
      ...
      {
        v12 = (_DWORD *)(v9 + 2656);
        *(_DWORD *)(v9 + 2660) = *(unsigned __int16 *)(v8 + 5208);
        v13 = (_DWORD *)(v9 + 2664);
        *(_QWORD *)(v9 + 2664) = 0LL;
        *(_QWORD *)(v9 + 2672) = 0LL;
        *(_DWORD *)(v9 + 2680) = 0;
        ...
        *v12 = i + 1;
        ...
        v15 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int64 *, __int64, _QWORD, __int64, int *, unsigned __int16, __int64, __int64))(v8 + 4488))(
                *(_QWORD *)(v8 + 4232),
                &v25,
                DeviceHandle,
                v4,
      ...
      {
        if ( v28[1] == 5 )
          *(_DWORD *)(v9 + 2788) = v28[2] != 0 ? 1073807365 : 1073807360;
        Log(a1, 4, 1667524129, v27, v5);
        LOBYTE(v21) = 0;
        UsbhException(a1, (unsigned __int16)v5, 4, (int)v28, 84, v16, -1, usbfile_bus_c, 6331, v21);
      ...
      if ( v16 >= 0 )
      {
        v16 = UsbhLinkPdoDeviceHandle(a1, v26, v10);
        if ( (v16 & 0xC0000000) == 0xC0000000 )
        {
    ...
    else
    {
      v16 = -1073741822;
      if ( v11 )
        Usbh_HubDerefDeviceHandle(a1, v11, a1, 0x48447472u);
    }
    return (unsigned int)v16;
  }
  Log(a1, 4, 1668441139, v27, v5);
  ...
  LOBYTE(v21) = 0;
  UsbhException(a1, (unsigned __int16)v5, 104, 0, 0, TtDeviceHandle, -1, usbfile_bus_c, 6230, v21);
