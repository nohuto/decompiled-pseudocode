/*
 * XREFs of UsbhPCE_ResumeDone @ 0x1C0041008
 * Callers:
...
int *__fastcall UsbhPCE_ResumeDone(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  Log((__int64)a1, 512, 1346712113, 0LL, v4);
  result = (int *)UsbhGetPortData((__int64)a1, v4);
  if ( result )
  {
    LODWORD(v9) = 0;
    return UsbhDispatch_PortChangeQueueEventEx(a1, (__int64)result, 21LL, a2, v9, 0, 0LL, 0LL);
  }
  return result;
}
