/*
 * XREFs of UsbhFdoReturnPortStatus @ 0x1C0013B10
 * Callers:
...
__int64 __fastcall UsbhFdoReturnPortStatus(__int64 a1, ULONG_PTR a2, IRP *a3, __int64 a4)
{
  ...
  __int64 v66; // r8
  __int64 v67; // r9
  unsigned __int16 v69; // [rsp+98h] [rbp+20h]
  char v70; // [rsp+9Ah] [rbp+22h]
  ...
  if ( KeGetCurrentIrql() )
  {
    ...
    UsbhDecPdoIoCount(a2, (ULONG_PTR)a3, v59, v60);
    return 3221225485LL;
  }
  ...
  if ( !SecurityContext )
  {
    a3->IoStatus.Status = -1073741811;
    IofCompleteRequest(a3, 0);
    UsbhDecPdoIoCount(a2, (ULONG_PTR)a3, v61, v62);
...
LABEL_133:
    ...
    IofCompleteRequest(a3, 0);
    UsbhDecPdoIoCount(a2, (ULONG_PTR)a3, v66, v67);
    return 3221225486LL;
  }
  v19 = *(_QWORD *)(a1 + 64);
  if ( !v19 )
  ...
  *((_QWORD *)v13 + 3) = KeGetCurrentThread();
  ...
  if ( !v24 )
  {
    ...
    a3->IoStatus.Status = -1073741810;
    IofCompleteRequest(a3, 0);
    UsbhDecPdoIoCount(a2, (ULONG_PTR)a3, v63, v64);
    Log(a1, 8, 1196446584, (_DWORD)a3, 0LL);
    return 3221225486LL;
  }
  KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels, v25);
  v28 = (struct _DEVICE_OBJECT *)*((_QWORD *)v13 + 1);
  ...
  *((_QWORD *)v13 + 3) = KeGetCurrentThread();
  ...
  switch ( (_DWORD)v35 )
  {
    case 1:
      ...
      DeviceExtension = v28->DeviceExtension;
      if ( !DeviceExtension )
        UsbhTrapFatal_Dbg(v28, 0LL, v31, v32);
      if ( *DeviceExtension != 541218120 )
        UsbhTrapFatal_Dbg(v28, DeviceExtension, v31, v32);
      v37 = *((_QWORD *)v13 + 1);
      if ( !v37 )
        UsbhTrapFatal_Dbg(0LL, 0LL, v31, v32);
      v38 = *(_QWORD *)(v37 + 64);
    ...
    case 2:
      ...
      goto LABEL_83;
    case 3:
      v40 = Usbh_SSH_HubPendingResumeAfterSuspend(v28);
      goto LABEL_44;
    case 4:
      if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
        WPP_RECORDER_SF_(
...
LABEL_83:
  ...
  v40 = Usbh_SSH_HubPendingResume(v28);
LABEL_44:
