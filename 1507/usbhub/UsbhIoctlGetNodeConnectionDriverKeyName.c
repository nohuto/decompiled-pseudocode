/*
 * XREFs of UsbhIoctlGetNodeConnectionDriverKeyName @ 0x1C0048BB4
 * Callers:
...
__int64 __fastcall UsbhIoctlGetNodeConnectionDriverKeyName(struct _DEVICE_OBJECT *a1, PIRP Irp, __int64 a3)
{
  ...
  v32 = 264;
  Log((__int64)a1, 32, 1768898101, (__int64)Irp, (__int64)MasterIrp);
  v12 = FdoExt((__int64)a1, v9, v10, v11);
  v13 = (_QWORD *)UsbhIncHubBusy(a1, (__int64)(v12 + 434), (__int64)Irp, 1430414185LL, 1);
  if ( v13 )
  {
    LODWORD(DeviceProperty) = UsbhAcquireApiLock((__int64)a1, 0xF00D0005, &v30);
    if ( (DeviceProperty & 0xC0000000) != 0xC0000000 )
    {
      LODWORD(DeviceProperty) = UsbhIoctlValidateParameters((_DWORD)a1, 4, 10);
      if ( (DeviceProperty & 0xC0000000) != 0xC0000000 )
      {
        Type = MasterIrp->Type;
        v15 = UsbhLatchPdo((__int64)a1, MasterIrp->Type, (__int64)Irp, 0x496C3035u);
          ...
          if ( (v20[353] & 0x400) != 0 )
          {
            ...
            *(_DWORD *)&MasterIrp->Type = *((unsigned __int16 *)v20 + 710);
            ...
            DeviceProperty = IoGetDeviceProperty(
                               ...
                               &ResultLength);
            Log((__int64)a1, 32, 1768383600, (__int64)Irp, DeviceProperty);
            ...
            UsbhUnlatchPdo((__int64)a1, (__int64)v19, (__int64)Irp, 0x496C3035u);
          }
          else
          {
  ...
  Log((__int64)a1, 32, 1768897589, (__int64)Irp, (int)DeviceProperty);
  if ( (unsigned int)DeviceProperty >> 30 == 3 && !Usb_Disconnected(DeviceProperty) )
  {
    LOBYTE(v29) = 0;
    UsbhException((int)a1, Type, 91, (int)&v32, 4, DeviceProperty, 0, usbfile_ioctl_c, 2581, v29);
  }
  ...
  FdoExt((__int64)a1, v22, v23, v24);
  UsbhDecHubBusy((__int64)a1, v25, v13, v26);
