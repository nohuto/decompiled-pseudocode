/*
 * XREFs of UsbhEnumerate2 @ 0x1C004FF08
 * Callers:
...
__int64 __fastcall UsbhEnumerate2(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  switch ( a2 )
  {
    case 1u:
      ...
      v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D6A8[2 * v24];
LABEL_19:
      if ( v20 )
        return v20(a1, a4, a5);
      return v5;
    case 2u:
      ...
      v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D8A8[2 * v23];
      goto LABEL_19;
    case 4u:
      Log(a1, v9, 1162752627, v8, 0LL);
      v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005EE48[2 * v22];
      goto LABEL_19;
  }
  v10 = a2 - 4 - v9;
  if ( !v10 )
  ...
  if ( !v11 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005DAA8[2 * v21];
    goto LABEL_19;
  }
  v12 = v11 - 65520;
  if ( !v12 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D4A8[2 * v19];
    goto LABEL_19;
  }
  v13 = v12 - 0x10000;
  if ( !v13 )
