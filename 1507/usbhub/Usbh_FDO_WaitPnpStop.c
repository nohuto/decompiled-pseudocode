/*
 * XREFs of Usbh_FDO_WaitPnpStop @ 0x1C004BC50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Usbh_FDO_WaitPnpStop(ULONG_PTR a1, unsigned int a2)
{
  __int64 v4; // rdx
  __int64 v5; // r8
  __int64 v6; // r9
  ...
  v16 = 0;
  Log(*(_QWORD *)(a1 + 8), 2, 2001949776, a1, (int)a2);
  if ( a2 == 2 )
  {
  ...
  else
  {
    if ( a2 == 3 )
    {
      v11 = UsbhFdoCheckUpstreamConnectionState(*(_QWORD *)(a1 + 8), &v16, v5, v6);
      if ( v11 >= 0 )
        Usbh_SSH_Event(*(PDEVICE_OBJECT *)(a1 + 8), 6u, a1, v12);
    ...
    else
    {
      ...
      Usbh_SSH_Event(*(PDEVICE_OBJECT *)(a1 + 8), 6u, a1, v8);
      UsbhSshDisabled(*(_QWORD *)(a1 + 8), a1);
      UsbhSyncBusPause(*(_QWORD *)(a1 + 8), a1, 4);
      Usbh_BusPnpFreeResources_PdoEvent(*(_QWORD *)(a1 + 8), a1);
      v9 = 7;
    }
    UsbhSetFdoPnpState(*(_QWORD *)(a1 + 8), v9, a2, v6);
    UsbhReleaseFdoPnpLock(*(_QWORD *)(a1 + 8), a1, v13, v14);
    return 0LL;
  }
}
