/*
 * XREFs of UsbhCreatePdo @ 0x1C0007C50
 * Callers:
...
LABEL_14:
  ...
  *((struct _UNICODE_STRING *)DeviceExtension + 165) = v13;
  ...
  *((_DWORD *)DeviceExtension + 732) = 1000;
  ...
  *((_QWORD *)DeviceExtension + 120) = DeviceObject;
  *((_QWORD *)DeviceExtension + 313) = MEMORY[0xFFFFF78000000014];
  KeInitializeEvent((PRKEVENT)DeviceExtension + 98, NotificationEvent, 1u);
  KeInitializeEvent((PRKEVENT)DeviceExtension + 120, NotificationEvent, 1u);
  ...
  *((_QWORD *)DeviceExtension + 158) = DeviceExtension + 1264;
  ...
  KeInitializeEvent((PRKEVENT)DeviceExtension + 121, SynchronizationEvent, 1u);
  KeInitializeEvent((PRKEVENT)DeviceExtension + 119, SynchronizationEvent, 1u);
  KeInitializeSpinLock((PKSPIN_LOCK)DeviceExtension + 347);
  KeInitializeEvent((PRKEVENT)(DeviceExtension + 2728), SynchronizationEvent, 0);
...
LABEL_28:
  ...
  v23 = UsbhConnectPdoToHub((__int64)DeviceObject, a1);
  v10 = v23;
  ...
  *(_DWORD *)(v27 + 72) = 1144018785;
  KeInitializeSemaphore((PRKSEMAPHORE)(DeviceExtension + 2536), 1, 1);
  *((_QWORD *)DeviceExtension + 114) = -1LL;
  *((_QWORD *)DeviceExtension + 115) = -1LL;
  *(_QWORD *)(DeviceExtension + 892) = -1LL;
  *(_QWORD *)(DeviceExtension + 900) = -1LL;
  v29 = UsbhIncPdoIoCount((__int64)DeviceObject, (__int64)DeviceObject, 1162637161LL, 0LL);
  v10 = v29;
  if ( (v29 & 0xC0000000) != 0xC0000000 )
  {
    ...
    *((_QWORD *)DeviceExtension + 377) = *(_QWORD *)(a2 + 2920);
    ...
    *((_DWORD *)DeviceExtension + 676) = 0;
    DeviceExtension[2708] = 0;
    DWORD1(v35) = 0;
