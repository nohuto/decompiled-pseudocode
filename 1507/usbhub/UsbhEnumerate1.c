/*
 * XREFs of UsbhEnumerate1 @ 0x1C0027540
 * Callers:
...
__int64 __fastcall UsbhEnumerate1(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  switch ( a2 )
  {
    case 1u:
      ...
      v13 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005CCA8[2 * v22];
LABEL_7:
      if ( v13 )
        return v13(a1, a4, a5);
      return v5;
    case 2u:
      ...
      v13 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D2A8[2 * v21];
      goto LABEL_7;
    case 4u:
      Log(a1, v9, 1162752371, v8, 0LL);
      v13 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005CEA8[2 * v20];
      goto LABEL_7;
  }
  v10 = a2 - 4 - v9;
  if ( !v10 )
  ...
  if ( !v11 )
  {
    ...
    v13 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005B198[2 * v12];
    goto LABEL_7;
  }
  v16 = v11 - 65520;
  if ( !v16 )
  {
    ...
    v13 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D0A8[2 * v19];
    goto LABEL_7;
  }
  v17 = v16 - 0x10000;
  if ( !v17 )
