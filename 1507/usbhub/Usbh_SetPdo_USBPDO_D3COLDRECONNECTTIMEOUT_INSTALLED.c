/*
 * XREFs of Usbh_SetPdo_USBPDO_D3COLDRECONNECTTIMEOUT_INSTALLED @ 0x1C004CA60
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( v5 == 4 )
  {
    ...
    if ( (_DWORD)result )
    {
      PdoExt(a1, (__int64)a2, (__int64)a3, a4)[732] = 1000 * result;
      result = (__int64)PdoExt(a1, v8, v9, v10);
      if ( *(int *)(result + 2928) > 30000 )
      {
        result = (__int64)PdoExt(a1, v11, v12, v13);
        *(_DWORD *)(result + 2928) = 30000;
      }
    }
  }
  return result;
