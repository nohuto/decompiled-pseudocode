/*
 * XREFs of Usbh_SetHUB_OVERCURRENT_DETECTED @ 0x1C004C6E0
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_SetHUB_OVERCURRENT_DETECTED(__int64 a1, const wchar_t *a2, _DWORD *a3, __int64 a4)
{
  _UNKNOWN **result; // rax
  int v5; // ebx
