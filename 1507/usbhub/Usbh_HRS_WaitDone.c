/*
 * XREFs of Usbh_HRS_WaitDone @ 0x1C0047288
 * Callers:
...
__int64 __fastcall Usbh_HRS_WaitDone(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rdi
  _DWORD *v6; // rbp
  __int64 v7; // rdx
  ...
  {
    v11 = UsbhReleaseResetLock(*(_QWORD *)(a1 + 8), a1, 1u);
