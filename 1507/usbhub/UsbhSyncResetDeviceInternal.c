...
__int64 __fastcall UsbhSyncResetDeviceInternal(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3)
{
  ...
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    ...
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_dq(
        WPP_GLOBAL_Control->DeviceExtension,
        (unsigned int)&WPP_0fac597d3f0b5fd77bcb4f18b65857f6_Traceguids,
        v21,
        72,
        (__int64)&WPP_0fac597d3f0b5fd77bcb4f18b65857f6_Traceguids,
        *(_WORD *)(v6 + 1420),
  ...
  else
  {
    ...
    *(_DWORD *)(v6 + 1412) &= ~0x8000u;
    ...
    if ( (v15 & 0xC0000000) == 0xC0000000 )
    {
      ...
      {
        LOBYTE(v26) = 0;
        UsbhException((int)DeviceObject, *(unsigned __int16 *)(v6 + 1420), 67, 0, 0, v15, -1, usbfile_bus_c, 6723, v26);
      }
      if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
        WPP_RECORDER_SF_qd(
          WPP_GLOBAL_Control->DeviceExtension,
    ...
    *(_QWORD *)(v6 + 864) = 0LL;
    ...
    if ( LOWORD(v19->DeviceType) )
      WPP_RECORDER_SF_d(v19->DeviceExtension, 0, 1, 78, (__int64)&WPP_0fac597d3f0b5fd77bcb4f18b65857f6_Traceguids, v15);
