/*
 * XREFs of UsbhBuildClassCompatibleID @ 0x1C0008844
 * Callers:
...
__int64 __fastcall UsbhBuildClassCompatibleID(int a1, __int64 a2, __int64 a3)
{
  ...
  v6 = PdoExt(a2);
  v58 = 0;
  v7 = *(unsigned __int8 *)(v6 + 2405);
  v8 = *(unsigned __int8 *)(v6 + 2406);
  v9 = *(unsigned __int8 *)(v6 + 2407);
  Log(a1, 4096, 1684228420, *(unsigned __int8 *)(v6 + 2405), *(unsigned __int8 *)(v6 + 2406));
  v11 = v10 + 1;
  v12 = v10 + 2;
  if ( (*(_BYTE *)(v6 + 2792) & 0x20) != 0 )
  {
    v27 = *(_QWORD *)(v6 + 2816);
    if ( *(_BYTE *)(v27 + 12) )
    {
      ...
      if ( *v28 )
      {
        ...
        LOWORD(v48) = 1;
        LOWORD(v40) = 1;
        v10 = UsbhMakeId(2LL, L"&MS_SUBCOMP_n", Id, &v58, v40, v48, v56, *(_QWORD *)(v6 + 2816) + 12LL);
        if ( !v10 )
          goto LABEL_27;
        v11 = 1;
        v12 = 2;
  ...
  else
  {
    ...
    if ( *(_BYTE *)(v13 + 26) )
    {
      ...
      LOWORD(v49) = 1;
      LOWORD(v41) = 1;
      v10 = UsbhMakeId(2LL, L"&MS_SUBCOMP_n", v33, &v58, v41, v49, v57, *(_QWORD *)(v6 + 2496) + 26LL);
      if ( !v10 )
        goto LABEL_27;
      v11 = 1;
      v12 = 2;
    }
    v30 = (_BYTE *)(*(_QWORD *)(v6 + 2496) + 18LL);
  }
  if ( *v30 )
  {
    LOWORD(v50) = 0;
