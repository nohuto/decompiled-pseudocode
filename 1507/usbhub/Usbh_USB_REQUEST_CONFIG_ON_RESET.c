/*
 * XREFs of Usbh_USB_REQUEST_CONFIG_ON_RESET @ 0x1C004CEE0
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_USB_REQUEST_CONFIG_ON_RESET(__int64 a1, const wchar_t *a2, _BYTE *a3, __int64 a4)
{
  _UNKNOWN **result; // rax
  int v5; // esi
