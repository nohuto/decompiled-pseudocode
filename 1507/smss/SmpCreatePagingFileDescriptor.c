/*
 * XREFs of SmpCreatePagingFileDescriptor @ 0x140002610
 * Callers:
...
__int64 __fastcall SmpCreatePagingFileDescriptor(_OWORD *a1)
{
  int v2; // ecx
  char v3; // r14
  int v4; // ebx
  ...
  if ( v2 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v11) = 840;
  ...
  if ( v4 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v12) = 878;
  ...
  *(_WORD *)(v6[3] + 8LL) = v8;
  ...
  if ( (*((_BYTE *)v6 + 92) & 2) != 0 && (v8 == 63 || v8 == SmpOsVolumeLetter) )
  {
    ...
    *v6 = SmpPagingFileDescriptorList;
    ...
    if ( v13[1] != &SmpPagingFileDescriptorList )
      __fastfail(3u);
    v13[1] = (PVOID *)v6;
  ...
  {
    v9 = (PVOID **)qword_140023CB8;
    *v6 = &SmpPagingFileDescriptorList;
    v6[1] = v9;
    if ( *v9 != &SmpPagingFileDescriptorList )
      __fastfail(3u);
    *v9 = (PVOID *)v6;
    qword_140023CB8 = (__int64)v6;
  }
