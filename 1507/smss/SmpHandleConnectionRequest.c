/*
 * XREFs of SmpHandleConnectionRequest @ 0x140006620
 * Callers:
 ...
 *     SmpGetProcessMuSessionId @ 0x1400076C4 (SmpGetProcessMuSessionId.c)
...
char __fastcall SmpHandleConnectionRequest(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  else
  {
    ...
    if ( v13 )
    {
      ...
      v32 = v37;
      SmpWaitForSubSysStartup(v12, 1u, 0LL, (__int64)v37);
