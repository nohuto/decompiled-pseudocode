/*
 * XREFs of SmpEventWriteULONGString @ 0x140003EF8
 * Callers:
...
void __fastcall SmpEventWriteULONGString(__int64 a1, int a2, unsigned __int16 *a3)
{
  int v4; // ecx
  __int64 v5; // rax
  ...
  if ( SmpTraceHandle )
  {
    if ( EtwEventEnabled(SmpTraceHandle, &SmssEvt_ExecuteImage_Start) )
    {
      v4 = *a3;
      v9 = 0;
      v12 = 0;
