/*
 * XREFs of SmpComputeDesiredPfSizeBasedOnHistory @ 0x14000F69C
 * Callers:
 *     SmpInitializeManagedPagefileSupport @ 0x14000FD94 (SmpInitializeManagedPagefileSupport.c)
 * Callees:
...
__int64 SmpComputeDesiredPfSizeBasedOnHistory()
{
  ...
  const wchar_t *v23; // [rsp+48h] [rbp-B8h]
  ...
  v23 = L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";
  v22 = 8257660;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  if ( NtOpenKey(&KeyHandle, 0x20019u, &ObjectAttributes) >= 0 )
  {
    ...
    if ( v15 >= 0 && KeyValueInformation[0] == 4 )
    {
      ...
      if ( (v16 - Time.QuadPart) / 0xC92A69C000uLL > 7 )
        v14 = 8;
    }
  }
  ...
  if ( (unsigned int)Data < 0xF0 )
    v18 = Data;
  if ( v18 )
    memcpy_0(Base, &unk_140023D34, 4LL * v18);
  qsort(Base, v18, 4uLL, SmpPagefileUsageSampleCompare);
  v19 = (unsigned int)dword_1400239E8 * (unsigned __int64)(unsigned int)Base[9 * v18 / 0xA];
  return v19 + (v19 >> 4);
}
