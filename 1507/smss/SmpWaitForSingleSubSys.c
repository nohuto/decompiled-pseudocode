/*
 * XREFs of SmpWaitForSingleSubSys @ 0x140007BA8
 * Callers:
 ...
 *     SmpLockKnownSubSysList @ 0x140006B80 (SmpLockKnownSubSysList.c)
 *     SmpCheckSubSysStatus @ 0x140007BE8 (SmpCheckSubSysStatus.c)
...
__int64 __fastcall SmpWaitForSingleSubSys(__int64 a1)
{
  ...
  if ( !(unsigned int)SmpCheckSubSysStatus(a1) )
    v2 = SmpWaitForStatusChange(v5, (*(_BYTE *)(a1 + 8) & 1) == 0, v6);
