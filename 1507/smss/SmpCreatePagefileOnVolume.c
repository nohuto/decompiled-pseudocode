/*
 * XREFs of SmpCreatePagefileOnVolume @ 0x14000ABEC
 * Callers:
...
__int64 __fastcall SmpCreatePagefileOnVolume(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v8 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v18) = 1949;
    *((_DWORD *)&SmpPagefileLog + 2 * v18 + 1) = v8;
    *((_QWORD *)&SmpPagefileLog + v18 + 1) = v7;
  }
  else
  {
    PagingFileSize = SmpGetPagingFileSize(FileHandle, v7, &v31);
    v10 = v31;
    if ( PagingFileSize >= 0 )
      v3 = v31 != 0;
...
LABEL_14:
  ...
  *(_DWORD *)(a1 + 88) = v16;
  if ( (*(_BYTE *)(a2 + 16) & 8) != 0
    && SmpCheckHybridPriority(*(_DWORD *)(a2 + 20), &v29, 0LL) >= 0
    && (v29 & 0xFFFFFFF0) == 0 )
  {
