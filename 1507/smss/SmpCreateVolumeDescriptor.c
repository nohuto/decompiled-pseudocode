/*
 * XREFs of SmpCreateVolumeDescriptor @ 0x140007160
 * Callers:
 ...
 *     SmpIsVhdVolume @ 0x14000779C (SmpIsVhdVolume.c)
...
int __fastcall SmpCreateVolumeDescriptor(unsigned __int16 a1, struct _UNICODE_STRING *a2, struct _UNICODE_STRING *a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v5 < 0 )
  {
    ...
    v14 = 2LL * v13;
    *((_DWORD *)&SmpPagefileLog + 4 * v13) = 1142;
LABEL_30:
    LODWORD(Heap) = a1;
  ...
  if ( (int)Heap < 0 )
  {
    ...
    v14 = 2LL * v16;
    *((_DWORD *)&SmpPagefileLog + 4 * v16) = 1164;
    goto LABEL_30;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v5 < 0 )
  {
    ...
    v14 = 2LL * v17;
    *((_DWORD *)&SmpPagefileLog + 4 * v17) = 1210;
    goto LABEL_30;
  }
  ...
  if ( v5 < 0 )
  {
    ...
    v14 = 2LL * v15;
    *((_DWORD *)&SmpPagefileLog + 4 * v15) = 1232;
    goto LABEL_30;
  }
  ...
  if ( Heap )
  {
    ...
    *((_WORD *)Heap + 12) = a1;
    ...
    if ( (int)RtlQueryVolumeDiskSpeedPolicy(FileHandle, &v22) >= 0 && v22 >= 20 )
      *(_DWORD *)(v7 + 16) |= 4u;
    ...
    *(_QWORD *)(v7 + 40) = v26[0] * v27 * (unsigned __int64)v28;
    ...
    if ( (*(_BYTE *)(v7 + 16) & 1) != 0 )
    {
      ...
      *(_QWORD *)(v7 + 8) = &SmpVolumeDescriptorList;
      if ( *(__int64 **)(v12 + 8) != &SmpVolumeDescriptorList )
        __fastfail(3u);
      *(_QWORD *)(v12 + 8) = v7;
    ...
    {
      v11 = (__int64 **)qword_140023C98;
      *(_QWORD *)v7 = &SmpVolumeDescriptorList;
      *(_QWORD *)(v7 + 8) = v11;
      if ( *v11 != &SmpVolumeDescriptorList )
        __fastfail(3u);
      *v11 = (__int64 *)v7;
      qword_140023C98 = v7;
    }
