/*
 * XREFs of SmscpParseArgs @ 0x140004180
 * Callers:
 *     SmscMain @ 0x140002F70 (SmscMain.c)
 * Callees:
 *     SmpGetFirstSessionId @ 0x140004D28 (SmpGetFirstSessionId.c)
 *     SmscpSetupSharedSpace @ 0x140004D94 (SmscpSetupSharedSpace.c)
 *     SmscpIsDebuggerPresent @ 0x140013630 (SmscpIsDebuggerPresent.c)
 */
...
LABEL_14:
            ...
            {
              RtlAppendUnicodeStringToString(a4, &stru_14001E0F8);
              v29 = SystemInformation[0];
              if ( (SystemInformation[0] & 0x20000) != 0 )
              {
                RtlAppendUnicodeStringToString(a4, &stru_14001E0E8);
                v29 = SystemInformation[0];
              }
              if ( (v29 & 0x4000000) != 0 )
                RtlAppendUnicodeStringToString(a4, &stru_14001E0D8);
            }
LABEL_17:
            v18 = v4;
            v19 = a4;
