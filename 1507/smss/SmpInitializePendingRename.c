/*
 * XREFs of SmpInitializePendingRename @ 0x140001D48
 * Callers:
...
__int64 SmpInitializePendingRename()
{
  ...
  _OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+80h] [rbp-21h] BYREF
  _UNICODE_STRING DestinationString; // [rsp+B0h] [rbp+Fh] BYREF
