/*
 * XREFs of SmpSendPlatformBinaryStatus @ 0x140012AA8
 * Callers:
...
char __fastcall SmpSendPlatformBinaryStatus(int a1, __int64 a2)
{
  bool v3; // zf
  __int64 v4; // rcx
  char *Heap; // rax
  ...
  if ( SmpTraceHandle )
  {
    if ( v17 )
    {
      ...
      v7 = v16;
      v9 = 1LL;
      v8 = &SmssEvt_PlatformBinaryExecutionFailed;
    }
    else
    {
      v7 = 0LL;
      v8 = &SmssEvt_PlatformBinaryExecuted;
      v9 = 0LL;
    }
    LOBYTE(Heap) = EtwEventWrite(SmpTraceHandle, v8, v9, v7, ShareAccess, *(_QWORD *)OpenOptions);
  }
  return (char)Heap;
}
