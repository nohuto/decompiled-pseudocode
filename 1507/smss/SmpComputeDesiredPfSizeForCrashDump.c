/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x14000F99C
 * Callers:
...
LABEL_18:
      ...
      else
      {
        ...
        if ( SmpMemorySize
           + 0x10000000
           + ((unsigned int)~(dword_1400239E8 - 1) & ((unsigned int)(dword_1400239E8 - 1)
                                                    + 8256LL
                                                    + ((unsigned __int64)(unsigned int)(dword_1400239F4 + 7) >> 3))) > 0x40000000 )
          v0 = SmpMemorySize
             + 0x10000000
             + ((unsigned int)~(dword_1400239E8 - 1) & ((unsigned int)(dword_1400239E8 - 1)
                                                      + 8256LL
                                                      + ((unsigned __int64)(unsigned int)(dword_1400239F4 + 7) >> 3)));
      }
