/*
 * XREFs of SmpParseCommandLine @ 0x140003620
 * Callers:
 ...
 *     SmpExpandEnvironmentString @ 0x140003BCC (SmpExpandEnvironmentString.c)
 *     SmpQueryEnvVariable @ 0x140003F58 (SmpQueryEnvVariable.c)
