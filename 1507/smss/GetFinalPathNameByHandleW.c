/*
 * XREFs of GetFinalPathNameByHandleW @ 0x140013D5C
 * Callers:
 ...
 *     StringCchCatW @ 0x1400140EC (StringCchCatW.c)
 *     StringCchCopyW @ 0x14001416C (StringCchCopyW.c)
 *     GetLongPathNameW @ 0x140014B34 (GetLongPathNameW.c)
 */

__int64 __fastcall GetFinalPathNameByHandleW(HANDLE FileHandle, wchar_t *a2, unsigned int a3)
{
  size_t v3; // r13
  __int64 v4; // rbx
  STRSAFE_LPWSTR v5; // r14
  unsigned int v7; // edi
  ULONG v8; // ecx
  ...
  STRSAFE_LPWSTR pszDest; // [rsp+88h] [rbp+48h]
        ...
        *((_WORD *)Src + v13) = 0;
        ...
        else
        {
          ...
          do
            ++v16;
          while ( v33[v16] );
          v17 = (unsigned int)(2 * (v3 + v15 + v16) + 2);
          ...
          do
            ++v24;
          while ( v19[v24] );
          memmove(v19, &v19[(unsigned int)v23], 2 * (1LL - (unsigned int)v23 + v24));
          RtlFreeHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), 0, (PVOID)v33);
          v5 = pszDest;
        }
        ...
        if ( v27 <= (unsigned int)v3 )
        {
          ...
          *v5 = 0;
          if ( v28 )
            StringCchCopyW(v5, v3, v28);
          StringCchCatW(v5, v3, v25);
          goto LABEL_50;
        }
        v7 = v27;
        v8 = 8;
