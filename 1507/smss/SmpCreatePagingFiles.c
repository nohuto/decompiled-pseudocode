/*
 * XREFs of SmpCreatePagingFiles @ 0x14000AF10
 * Callers:
 ...
 *     SmpEnableSwapOnPagingFiles @ 0x14000AB6C (SmpEnableSwapOnPagingFiles.c)
 *     SmpProcessPagefileDescriptor @ 0x14000AE90 (SmpProcessPagefileDescriptor.c)
 *     SmpRecordCreatedPageFiles @ 0x14000B094 (SmpRecordCreatedPageFiles.c)
...
char SmpCreatePagingFiles()
{
  ...
  if ( v0 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v11) = 2462;
    goto LABEL_25;
  }
  ...
  v3 = SmpPagingFileList;
  while ( (__int64 *)v3 != &SmpPagingFileList )
  {
    v12 = (_QWORD *)v3;
    SmpCreatePagingFileDescriptor((_OWORD *)(v3 + 16));
    v3 = *(_QWORD *)v3;
...
LABEL_18:
    ...
    v11 = 2LL * (_InterlockedIncrement(&SmpPagefileLogIndex) % 32);
    *((_DWORD *)&SmpPagefileLog + 2 * v11) = 2544;
LABEL_25:
