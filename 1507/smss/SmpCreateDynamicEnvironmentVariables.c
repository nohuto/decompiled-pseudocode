/*
 * XREFs of SmpCreateDynamicEnvironmentVariables @ 0x140008070
 * Callers:
...
NTSTATUS __fastcall SmpCreateDynamicEnvironmentVariables(HANDLE KeyHandle)
{
  ...
  struct _UNICODE_STRING v17; // [rsp+78h] [rbp-90h] BYREF
  int v18; // [rsp+88h] [rbp-80h] BYREF
  const wchar_t *v19; // [rsp+90h] [rbp-78h]
  ...
  struct _UNICODE_STRING v24; // [rsp+C8h] [rbp-40h] BYREF
  struct _UNICODE_STRING v25; // [rsp+D8h] [rbp-30h] BYREF
  ...
  __int64 v36; // [rsp+160h] [rbp+58h] BYREF
  int v37; // [rsp+168h] [rbp+60h]
  __int64 v38; // [rsp+170h] [rbp+68h] BYREF
  ...
  v14[1] = L"\\Registry\\Machine\\Hardware\\Description\\System\\CentralProcessor\\0";
  v25.Buffer = L"PROCESSOR_ARCHITECTURE";
  v17.Buffer = L"PROCESSOR_LEVEL";
  v31 = *(_QWORD *)L"IA64";
  v21.Buffer = L"PROCESSOR_IDENTIFIER";
  v34 = *(_QWORD *)L"AMD64";
  v24.Buffer = L"PROCESSOR_REVISION";
  v36 = *(_QWORD *)L"ARM64";
  v16.Buffer = L"Identifier";
  v15.Buffer = L"VendorIdentifier";
  v42 = *(_OWORD *)L"Unknown";
  *(_DWORD *)&ValueName.Length = 393220;
  LODWORD(v14[0]) = 8519808;
  *(_DWORD *)&v25.Length = 3014700;
  *(_DWORD *)&v17.Length = 2097182;
  *(_DWORD *)&v21.Length = 2752552;
  *(_DWORD *)&v24.Length = 2490404;
  *(_DWORD *)&v16.Length = 1441812;
  *(_DWORD *)&v15.Length = 2228256;
...
LABEL_9:
        ...
        v3 = NtSetValueKey(KeyHandle, &v25, 0, 1u, v4, DataSize);
        if ( v3 >= 0 )
        {
          ...
          do
            ++v7;
          while ( pszDest[v7] );
          v3 = NtSetValueKey(KeyHandle, &v17, 0, 1u, pszDest, 2 * v7 + 2);
          if ( v3 >= 0 )
          {
            ...
            *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
            ...
            if ( v3 >= 0 )
            {
              v3 = NtQueryValueKey(KeyHandlea, &v16, KeyValuePartialInformation, pszDest, 0x200u, ResultLength);
              if ( v3 < 0 )
              {
                NtClose(KeyHandlea);
              }
...
LABEL_54:
                  ...
                  do
                    ++v10;
                  while ( v44[v10] );
                  v3 = NtSetValueKey(KeyHandle, &v21, 0, 1u, v44, 2 * v10 + 2);
                  if ( v3 >= 0 )
                  {
                    if ( SystemInformation[0] )
                    {
...
LABEL_26:
                        ++v6;
                      while ( pszDest[v6] );
                      v3 = NtSetValueKey(KeyHandle, &v24, 0, 1u, pszDest, 2 * v6 + 2);
                      if ( v3 >= 0 )
                      {
                        ...
                        if ( SmpSafeBootOption == 2 )
                          ...
                          v11 = SmpSafeBootOption == 3 ? &v22 : &v26;
                        v3 = NtSetValueKey(
                               KeyHandle,
