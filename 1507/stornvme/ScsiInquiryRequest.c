/*
 * XREFs of ScsiInquiryRequest @ 0x1C0006D50
 * Callers:
 *     ScsiToNVMe @ 0x1C00087C0 (ScsiToNVMe.c)
 * Callees:
 *     FormInquiryStandardData @ 0x1C000658C (FormInquiryStandardData.c)
 *     FormInquirySerialNumberData @ 0x1C0006770 (FormInquirySerialNumberData.c)
 *     FormInquiryDeviceIdentifiersData @ 0x1C00068F4 (FormInquiryDeviceIdentifiersData.c)
 *     FormInquiryBlockLimitsData @ 0x1C0006B6C (FormInquiryBlockLimitsData.c)
 *     FormInquiryBlockProvisioningData @ 0x1C0006C58 (FormInquiryBlockProvisioningData.c)
...
__int64 __fastcall ScsiInquiryRequest(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (*(_BYTE *)(a3 + 1) & 1) != 0 )
  {
    ...
    if ( *(_BYTE *)(a3 + 2) )
    {
      ...
      {
        case 0x80u:
          return (unsigned int)FormInquirySerialNumberData(a1, v5, a3, a4);
        case 0x83u:
          return (unsigned int)FormInquiryDeviceIdentifiersData(a1, v5, a3, a4);
        case 0xB0u:
