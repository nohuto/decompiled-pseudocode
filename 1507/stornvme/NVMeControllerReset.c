/*
 * XREFs of NVMeControllerReset @ 0x1C0004E88
 * Callers:
 *     NVMeHwResetBus @ 0x1C0001E40 (NVMeHwResetBus.c)
 *     NVMeFirmwareActivateCompletion @ 0x1C00091C0 (NVMeFirmwareActivateCompletion.c)
