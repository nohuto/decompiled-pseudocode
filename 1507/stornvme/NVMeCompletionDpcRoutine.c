...
__int64 __fastcall NVMeCompletionDpcRoutine(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  while ( (*(_WORD *)(v3 + 14) & 1) != *(_WORD *)(a3 + 100) )
  {
    ...
    *(_WORD *)(v13 + 4184) = v15;
    ...
    {
      NVMeMapError(v12);
      if ( *(_DWORD *)(a2 + 140) > (unsigned int)v14 )
      {
        v17 = *(_QWORD *)(a2 + 8 * v14 + 1168);
        if ( v17 )
          ++*(_DWORD *)(v17 + 32);
      }
    }
  ...
  *(_OWORD *)(a3 + 152) = v24;
  ...
  if ( *(_BYTE *)(a2 + 17) )
  {
    StorPortExtendedFunction(47LL, a2, 0LL, &v32);
    v26 = 0LL;
    if ( v29 )
      v26 = 10000 * (1000 * ((v32 - v31) % v29) % v29) / v29
          + 10000 * (1000 * ((v32 - v31) % v29) / v29 + 1000 * ((v32 - v31) / v29));
    *(_QWORD *)(a2 + 8LL * (unsigned int)(*(_DWORD *)(a2 + 3224))++ + 3232) = v26;
    result = (unsigned int)-(*(_DWORD *)(a2 + 3224) < 0x400u);
    *(_DWORD *)(a2 + 3224) &= result;
  }
LABEL_51:
  if ( *(_BYTE *)(a2 + 18) == 1 )
  {
