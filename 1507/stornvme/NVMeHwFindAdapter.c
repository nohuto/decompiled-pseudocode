...
__int64 __fastcall NVMeHwFindAdapter(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  _QWORD v51[8]; // [rsp+30h] [rbp-78h] BYREF
  ...
  *(_BYTE *)(a1 + 16) = v9;
  ...
  else
  {
    ...
    if ( (unsigned int)StorPortGetBusData(a1, 4LL, *(unsigned int *)(a5 + 4), *(unsigned int *)(a5 + 100), v51, 64) != 64 )
    {
      v22 = 3;
      *(_DWORD *)(a1 + 24) = 3;
      goto LABEL_87;
    ...
    *(_WORD *)(a1 + 6) = v14;
    ...
    {
      v15 = v51[3] & 0xFFFFF000;
      v16 = HIDWORD(v51[3]);
    }
    else
    {
      v15 = v51[2] & 0xFFFFC000;
      v16 = HIDWORD(v51[2]);
    }
  ...
  if ( (_DWORD)v17 )
  {
    ...
    LOBYTE(v50) = *(_BYTE *)(v20 + 16LL * v21 + 12) == 0;
    DeviceBase = (_QWORD *)StorPortGetDeviceBase(
                             a1,
                             *(unsigned int *)(a5 + 8),
                             *(unsigned int *)(a5 + 4),
                             *(_QWORD *)(v20 + 16LL * v21),
                             *(_DWORD *)(v20 + 16LL * v21 + 8),
                             v50);
  }
LABEL_19:
...
LABEL_61:
    ...
    if ( !*(_BYTE *)(a1 + 16) )
    {
      ...
      {
        v33 = (void **)(a1 + 11432);
        if ( !(unsigned int)StorPortExtendedFunction(0LL, a1, v32, 1701672526LL, a1 + 11432) )
        {
          v34 = *v33;
          if ( *v33 )
          {
