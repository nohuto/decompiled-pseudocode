/*
 * XREFs of QueryTemperatureInfoHealthLogCompletion @ 0x1C0009C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall QueryTemperatureInfoHealthLogCompletion(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(a2 + 3) == 1 )
  {
    ...
    *(_WORD *)(v7 + 40) = v14;
    ...
    BYTE2(v20) = 0;
    LOWORD(v20) = (unsigned __int8)(i - 1);
    *(_WORD *)(v5 + 4166) = 1;
  ...
  v19 = *(_QWORD *)(v5 + 4192);
  if ( v19 )
    result = StorPortExtendedFunction(25LL, a1, v19, *(unsigned int *)(v5 + 4200));
  *(_QWORD *)(v5 + 4192) = 0LL;
  *(_DWORD *)(v5 + 4200) = 0;
  return result;
}
