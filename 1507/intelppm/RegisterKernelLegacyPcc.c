/*
 * XREFs of RegisterKernelLegacyPcc @ 0x1C0005080
 * Callers:
 *     RegisterHvLegacyPccCounters @ 0x1C001C770 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C000DE88 )
  {
          ...
          (v3 = v11) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 7) = v15;
      ...
      v3[33] = *(_QWORD *)(a1 + 304);
      if ( dword_1C000DE2C )
        *((_DWORD *)v3 + 9) = 0x989680 / ((unsigned int)dword_1C000DE2C >> 1);
      *((_QWORD *)v12 + 1) = 100LL;
      ...
      *((_DWORD *)v3 + 8) = 1;
      ...
      v4 = ((__int64 (__fastcall *)(_QWORD *))qword_1C000DBA8)(v3);
      if ( v4 >= 0 )
      {
        ...
        {
          *(_QWORD *)(v28 + 216) = v8;
          v25 = (_QWORD *)qword_1C000DA20;
          *v8 = v24;
          v8[1] = v25;
          if ( *v25 != v24 )
            __fastfail(3u);
          *v25 = v8;
          qword_1C000DA20 = (__int64)v8;
          v8 += 7;
        }
