/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C001C4B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C001CEE0 (DecodeDoorbellAddressIo.c)
 */
...
__int64 __fastcall RegisterHvLegacyPcc(_QWORD *a1)
{
  ...
  v21 = qword_1C000DDD0;
  v22 = dword_1C000DDD8;
  if ( (unsigned __int8)qword_1C000DDD0 <= 1u )
  {
    v4 = qword_1C000DDC8;
    v5 = qword_1C000DDC0;
    v19 = 0LL;
    if ( (_BYTE)qword_1C000DDD0 == 1 )
    {
  ...
  if ( v9 >= 0 )
  {
    v11 = dword_1C000DD80;
    LODWORD(v25[0]) = 0;
    v25[2] = qword_1C000DDB0;
    LODWORD(v25[3]) = dword_1C000DDB8;
    v25[1] = __PAIR64__(v7, PerfDomain);
    v25[6] = v5 << v3;
    v25[5] = v4 << v3;
    HIDWORD(v25[0]) = dword_1C000DD80;
    v25[4] = v8;
    v25[7] = v1;
    ...
    v13 = (__int64 (__fastcall *)(_QWORD *))qword_1C000DC00;
    if ( !v12 )
    {
      do
      {
        v25[8] = **(_QWORD **)(v17 + 520);
