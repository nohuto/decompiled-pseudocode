/*
 * XREFs of PccInitiateExecuteCallback @ 0x1C0006EC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2528))(
      ...
      qword_1C000DE80);
    v3 = qword_1C000DA18;
    for ( i = 0; (__int64 *)v3 != &qword_1C000DA18; v3 = *(_QWORD *)v3 )
    {
    ...
    if ( i )
    {
      LOBYTE(word_1C000DE94) = 1;
      if ( !HIBYTE(word_1C000DE94) )
      {
        HIBYTE(word_1C000DE94) = 1;
        v8 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C000DE80);
    if ( v8 )
      IoQueueWorkItem(qword_1C000DE88, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
