/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x1C001C160
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0002260 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C00025C0 (memset.c)
 *     DecodeGenAddressToHvPerfReg @ 0x1C001BB48 (DecodeGenAddressToHvPerfReg.c)
 */
...
__int64 __fastcall RegisterHvFeedbackCountersCallback(__int64 a1)
{
  ...
  v3 = *(_DWORD *)(a1 + 32);
  if ( !v3 )
    return (unsigned int)((__int64 (__fastcall *)(__int64))qword_1C000DBA8)(a1);
  v4 = v3;
          ...
          *v14 = 0;
          ...
          for ( j = 0; (unsigned int)v16 < *(_DWORD *)(a1 + 32); v27 = v13 )
          {
            ...
            if ( *(_BYTE *)(v17 + 24 * v16 + 17) && *(_BYTE *)(v17 + 24 * v16 + 16) )
            {
              ...
              {
                v35 = *(_QWORD *)(*v13 + 56);
                v9 = DecodeGenAddressToHvPerfReg((unsigned __int8 *)(v35 + 152), (__int64)(v18 + 4));
                if ( v9 < 0 )
                  goto LABEL_34;
                v9 = DecodeGenAddressToHvPerfReg((unsigned __int8 *)(v35 + 140), v19 + 8);
                if ( v9 < 0 )
                  goto LABEL_34;
                LODWORD(v16) = j;
                *(_BYTE *)(v20 + 24) = 0;
