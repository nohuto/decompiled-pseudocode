/*
 * XREFs of RegisterKernelIdleStates @ 0x1C0001750
 * Callers:
 *     <none>
 * Callees:
      ...
      *(_QWORD *)v3 = *(_QWORD *)(a1 + 1056);
      ...
      if ( *((_BYTE *)v3 + 20) )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
          ...
          qword_1C000D9C8,
          0LL);
        if ( (*(_QWORD *)(a1 + 248) & 0x300000300LL) != 0 && *(_QWORD *)(a1 + 648) )
          HIBYTE(v2[4].Group) = 1;
        ProcessorNumberFromIndex = ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1C000DBC0)(v2);
        if ( ProcessorNumberFromIndex < 0 )
        {
