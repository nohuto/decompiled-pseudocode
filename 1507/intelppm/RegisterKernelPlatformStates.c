/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C002034C
 * Callers:
 ...
 *     ValidatePlatformIdleState @ 0x1C001B7A8 (ValidatePlatformIdleState.c)
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C000DE98;
  v2 = dword_1C000D9C4;
  if ( dword_1C000DE98 )
  {
    v4 = (48 * dword_1C000DE98 + 59) & 0xFFFFFFFC;
    PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C000D9C4 * dword_1C000DE98, 0x72637250u);
    v6 = PoolWithTag;
    if ( PoolWithTag )
    {
      ...
      if ( v8 )
      {
        ...
        if ( (_DWORD)v1 )
        {
          ...
          while ( 1 )
          {
            ...
            *v8 = v9;
            v8[8] = v2;
            ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C000DC40)(
                                         *(_QWORD *)(a1 + 1056),
                                         v8,
                                         0LL);
...
LABEL_16:
          *(_DWORD *)v6 = 42;
          *((_DWORD *)v6 + 1) = dword_1C000DE98;
          *((_DWORD *)v6 + 2) = dword_1C000DE98;
          ...
          *((_QWORD *)v6 + 4) = PepIdleComplete;
          ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C000DBD0)(v6);
          if ( ProcessorNumberFromIndex >= 0 )
          {
            Src = v6;
            v6 = 0LL;
