/*
 * XREFs of PepProcessorIdleVeto @ 0x1C0005EDC
 * Callers:
 *     PepDevicePowerControlCallback @ 0x1C0006550 (PepDevicePowerControlCallback.c)
 * Callees:
...
NTSTATUS __fastcall PepProcessorIdleVeto(__int64 a1, __int64 *a2)
{
  ...
  if ( result >= 0 )
  {
    ...
    return ((__int64 (__fastcall *)(int *))qword_1C000DBF0)(&v5);
  }
  return result;
}
