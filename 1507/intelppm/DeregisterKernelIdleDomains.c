/*
 * XREFs of DeregisterKernelIdleDomains @ 0x1C0015E04
 * Callers:
 ...
 *     DeregisterIdleDomain @ 0x1C001E2A0 (DeregisterIdleDomain.c)
...
__int64 __fastcall DeregisterKernelIdleDomains(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    v11 = *(_DWORD *)(*(_QWORD *)(a1 + 648) + 56LL);
    v12 = 0LL;
    for ( i = 0; (unsigned int)v12 < v11; i = v12 )
    {
      *(_QWORD *)(*(_QWORD *)(a1 + 648) + 72 * v12 + 120) = 0LL;
      v12 = i + 1;
    }
