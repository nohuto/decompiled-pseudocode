/*
 * XREFs of DriverEntry @ 0x1C0022000
 * Callers:
 ...
 *     EvtDriverUnload @ 0x1C001AE80 (EvtDriverUnload.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  if ( v4 >= 0 )
  {
    dword_1C000D9C4 = KeQueryActiveProcessorAffinity(&unk_1C000DA28);
    KeInitializeAffinityEx(&unk_1C000DC58);
