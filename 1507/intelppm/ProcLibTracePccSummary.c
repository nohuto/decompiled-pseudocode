/*
 * XREFs of ProcLibTracePccSummary @ 0x1C0019FB0
 * Callers:
...
BOOLEAN ProcLibTracePccSummary()
{
  ...
  if ( result )
  {
    if ( qword_1C000DE30 )
    {
      v3 = (unsigned int)(100 * *(_DWORD *)(qword_1C000DE30 + 36)) / *(_DWORD *)(qword_1C000DE30 + 28);
      v1 = (unsigned int)(100 * *(_DWORD *)(qword_1C000DE30 + 32)) / *(_DWORD *)(qword_1C000DE30 + 28);
      *(_QWORD *)&UserData.Size = 1LL;
      v2 = v1;
      UserData.Ptr = qword_1C000DE30 + 6;
      v5 = qword_1C000DE30 + 7;
      v7 = &v3;
      v9 = &v2;
      v6 = 1LL;
      v8 = 1LL;
