/*
 * XREFs of PepQueryVetoList @ 0x1C0014FE8
 * Callers:
...
__int64 __fastcall PepQueryVetoList(__int64 a1)
{
  ...
  v11 = 0;
  if ( (int)PoFxProcessorNotification(*(_QWORD *)(a1 + 1056), 24LL, &v11) >= 0 && v11 )
  {
    v4 = 16 * v11 + 8;
    ...
    if ( PoolWithTag )
    {
      ...
      *v6 = v11;
      ...
      {
LABEL_10:
        Name = ((__int64 (__fastcall *)(unsigned int *))qword_1C000DBE0)(v6);
        if ( !Name )
        {
          qword_1C000DEB0 = (__int64)v6;
          v6 = 0LL;
        }
      }
      if ( v6 )
