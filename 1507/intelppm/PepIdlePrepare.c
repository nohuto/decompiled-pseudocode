/*
 * XREFs of PepIdlePrepare @ 0x1C0005AB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepIdleCancel @ 0x1C00058C0 (PepIdleCancel.c)
 */
...
__int64 __fastcall PepIdlePrepare(_QWORD **a1)
{
  ...
  _QWORD *v16; // [rsp+58h] [rbp-18h] BYREF
  ...
  if ( dword_1C000DE90 >= (unsigned int)dword_1C000D9C4 )
  {
    ...
    v18 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C000DC38)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C000DE98 )
    ...
    if ( LODWORD(BugCheckParameter3[2]) )
    {
      do
      {
        ...
        if ( (_DWORD)v11 != 255 && ((unsigned int)v11 >= *(_DWORD *)(v12 + 1068) || v8) )
          KeBugCheckEx(0x143u, 2uLL, 1uLL, v11, *(_QWORD *)(v12 + 648));
        BYTE4(v2[v10]) = v11;
