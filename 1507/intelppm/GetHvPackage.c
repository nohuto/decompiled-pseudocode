/*
 * XREFs of GetHvPackage @ 0x1C001BBD8
 * Callers:
...
_DWORD *__fastcall GetHvPackage(int a1)
{
  ...
  v2 = 0LL;
  v8 = 0;
  if ( (int)HvlQueryActiveProcessors(&v8, 0LL) >= 0 )
  {
    PoolWithTag = (unsigned int *)ExAllocatePoolWithTag(PagedPool, 4LL * v8, 0x72637250u);
    v4 = PoolWithTag;
    if ( PoolWithTag )
    {
      if ( (int)HvlQueryActiveProcessors(&v8, PoolWithTag) >= 0 )
      {
        v5 = ExAllocatePoolWithTag(PagedPool, 0xD0uLL, 0x72637250u);
        v2 = v5;
        if ( v5 )
        {
          memset(v5, 0, 0xD0uLL);
