/*
 * XREFs of RegisterVmIdleStates @ 0x1C001CD8C
 * Callers:
 *     RegisterGuestIdleStates @ 0x1C001BE80 (RegisterGuestIdleStates.c)
...
__int64 __fastcall RegisterVmIdleStates(__int64 a1)
{
  ...
  if ( v2 && (v3 = *v2) != 0 )
  {
    ...
    if ( ProcessorNumberFromIndex >= 0 )
    {
      ...
      BYTE2(v8[2]) = 1;
      HIDWORD(v8[13]) = 1;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD *))qword_1C000DBC0)(v8);
      if ( ProcessorNumberFromIndex >= 0 )
      {
        if ( !*(_BYTE *)(a1 + 656) )
        {
