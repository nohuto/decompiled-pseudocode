/*
 * XREFs of RegisterHvPerfStates @ 0x1C001C910
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeAcpiPStates @ 0x1C001DF14 (DecodeAcpiPStates.c)
 *     DecodeAcpiTStates @ 0x1C001E0B8 (DecodeAcpiTStates.c)
 */
...
LABEL_18:
    ...
    if ( v3 )
      v3[770] = dword_1C000DD80;
    if ( v5 )
      v5[802] = dword_1C000DD80;
    ++dword_1C000DD80;
    v8 = 0;
