/*
 * XREFs of AcpiEval_CPC @ 0x1C0014148
 * Callers:
...
__int64 __fastcall AcpiEval_CPC(__int64 a1, _QWORD *a2)
{
  ...
  P = 0LL;
  _InterlockedOr((volatile signed __int32 *)(a1 + 1044), 0x40000u);
  v4 = AcpiEvaluateMethod(a1, 1129333599, 0, (unsigned int)&P, (__int64)&v17);
  if ( v4 < 0 )
    goto LABEL_2;
  *(_QWORD *)(a1 + 240) |= *(_DWORD *)(a1 + 248) & 0x8000000;
  ...
  if ( v8 )
  {
    ...
    if ( v9 )
    {
      v10 = 27;
      v11 = v9 != 1;
      v12 = (const char *)&Cpc2RegisterTable;
    }
    else
    {
      v10 = 21;
    ...
    do
    {
      AcpiTranslateAccessSize((char *)v3 + *(unsigned int *)v12);
      v12 += 24;
    }
    while ( v13 != 1 );
    *v18 = v3;
