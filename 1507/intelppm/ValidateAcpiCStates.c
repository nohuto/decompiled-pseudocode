...
LABEL_8:
  ...
  if ( v2 )
  {
    for ( i = a1 + 4;
       ...
       && *i != 1
       && (*i == 2
        || IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C000DF54)
        && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C000DF24))
       && IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C000DF3C);
          i += 20 )
    {
      if ( ++v5 >= v2 )
        return v1;
