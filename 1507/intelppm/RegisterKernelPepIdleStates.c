/*
 * XREFs of RegisterKernelPepIdleStates @ 0x1C001F898
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C000D9C8,
    0LL);
  if ( !dword_1C000DE98 || PlatformStatesRegistered )
  {
    v7 = 0;
  }
  else
  {
    ...
    HIDWORD(v30[0]) = dword_1C000DE98;
    v7 = ((__int64 (__fastcall *)(_QWORD *))qword_1C000DBD0)(v30);
    if ( v7 >= 0 )
    {
