/*
 * XREFs of RegisterIdleDomain @ 0x1C001F42C
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  v5 = 3LL * a2;
  v6 = qword_1C000DA08;
  if ( (__int64 *)qword_1C000DA08 == &qword_1C000DA08 )
    goto LABEL_5;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C000DA08 );
  if ( !v7 )
  {
LABEL_5:
    ...
    *(_QWORD *)(v7 + 24) = v7 + 16;
    *(_QWORD *)(v7 + 16) = v7 + 16;
    v9 = (__int64 **)qword_1C000DA10;
    *(_QWORD *)v7 = &qword_1C000DA08;
    *(_QWORD *)(v7 + 8) = v9;
    if ( *v9 != &qword_1C000DA08 )
      __fastfail(3u);
    *v9 = (__int64 *)v7;
    qword_1C000DA10 = v7;
