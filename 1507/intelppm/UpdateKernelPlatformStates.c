/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C00054A8
 * Callers:
...
LABEL_26:
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C000D9C8,
      0LL);
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_BYTE *))qword_1C000DBD0)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v21;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C000DC40)(*(_QWORD *)(a1 + 1056), v4, v23) >= 0 )
        {
