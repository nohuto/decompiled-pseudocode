/*
 * XREFs of PepNotifyReportCStates @ 0x1C0020F6C
 * Callers:
 ...
 *     PepTranslateCstState @ 0x1C00211D4 (PepTranslateCstState.c)
 */
...
__int64 __fastcall PepNotifyReportCStates(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    v12 = P;
    v8 = PoFxProcessorNotification(*(_QWORD *)(a1 + 1056), 15LL, &v14);
    if ( v12 )
