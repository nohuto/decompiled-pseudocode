/*
 * XREFs of ACPIAcquireHardwareGlobalLock @ 0x1C001B224
 * Callers:
 *     ACPIAsyncAcquireGlobalLock @ 0x1C001B0A0 (ACPIAsyncAcquireGlobalLock.c)
 *     ACPIReleaseGlobalLock @ 0x1C001B190 (ACPIReleaseGlobalLock.c)
