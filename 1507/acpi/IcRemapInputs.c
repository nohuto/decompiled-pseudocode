/*
 * XREFs of IcRemapInputs @ 0x1C006D098
 * Callers:
    ...
    for ( j = IcListHead; &IcListHead != (__int64 *)j; j = *(_QWORD *)j )
    {
      if ( (*(_DWORD *)(j + 28) & 0x80000004) == 0 )
      {
        ...
        if ( *(_DWORD *)(j + 20) - *(_DWORD *)(j + 16) != -1 )
        {
          ...
          {
            v2 = *(_DWORD *)(v4 - 96);
            if ( !v2 && !*(_DWORD *)(v4 - 100) || *(_BYTE *)(v4 + 77) )
              goto LABEL_5;
            v6 = *(_DWORD *)(v4 - 80) != *(_DWORD *)v4
              || *(_DWORD *)(v4 - 72) != *(_DWORD *)(v4 + 8)
              || *(_DWORD *)(v4 - 68) != *(_DWORD *)(v4 + 12)
              || *(_WORD *)(v4 - 52) != *(_WORD *)(v4 + 28)
              || *(_QWORD *)(v4 - 60) != *(_QWORD *)(v4 + 20);
            v7 = *(_DWORD *)(v4 - 100) - *(_DWORD *)(v4 - 92);
            v8 = v2 - *(_DWORD *)(v4 - 88);
            if ( !i )
            {
              if ( v8 )
