/*
 * XREFs of DebugInPort @ 0x1C0043B40
 * Callers:
 *     DebugI @ 0x1C0043B10 (DebugI.c)
 *     DebugID @ 0x1C0043B20 (DebugID.c)
 *     DebugIW @ 0x1C0043B30 (DebugIW.c)
 * Callees:
...
LABEL_13:
  ...
  if ( byte_1C005AD88 || !(unsigned __int8)IsNumber(a1, 16LL) )
    goto LABEL_13;
