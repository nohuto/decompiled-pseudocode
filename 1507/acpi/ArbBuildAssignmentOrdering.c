/*
 * XREFs of ArbBuildAssignmentOrdering @ 0x1C00704B8
 * Callers:
 *     ArbInitializeArbiterInstance @ 0x1C007025C (ArbInitializeArbiterInstance.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00235E0 (__security_check_cookie.c)
 *     ZwClose_0 @ 0x1C0023628 (ZwClose_0.c)
 *     ZwCreateKey_0 @ 0x1C0023646 (ZwCreateKey_0.c)
 ...
 *     ArbInitializeOrderingList @ 0x1C0070A28 (ArbInitializeOrderingList.c)
 *     ArbFreeOrderingList @ 0x1C0070A6C (ArbFreeOrderingList.c)
...
__int64 __fastcall ArbBuildAssignmentOrdering(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  for ( i = v8 + 8; i < &v8[32 * *((unsigned int *)v8 + 1) + 8]; i += 32 )
  {
    ...
    {
      v6 = (*(__int64 (__fastcall **)(__int128 *, __int64 *, __int64 *, char *, char *))(a1 + 120))(
             &v28,
             &v23,
             &v24,
             v25,
      ...
      if ( v6 < 0 )
        goto LABEL_39;
      v6 = ArbAddOrdering(a1 + 56, v23, v24);
      if ( v6 < 0 )
        goto LABEL_39;
    }
  }
...
LABEL_19:
  ...
  for ( j = v12 + 8; j < &v12[32 * *((unsigned int *)v12 + 1) + 8]; j += 32 )
  {
    ...
    if ( BYTE1(v28) == v14 || BYTE1(v28) == 7 && v14 == 3 )
    {
      ...
      if ( v6 < 0 )
        goto LABEL_39;
      v6 = ArbAddOrdering(a1 + 72, v23, v24);
      if ( v6 < 0 )
        goto LABEL_39;
      v6 = ArbPruneOrdering(a1 + 56, v23, v24);
      if ( v6 < 0 )
        goto LABEL_39;
    }
  }
