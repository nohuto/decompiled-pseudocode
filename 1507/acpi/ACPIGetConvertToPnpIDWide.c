/*
 * XREFs of ACPIGetConvertToPnpIDWide @ 0x1C001D568
 * Callers:
...
__int64 __fastcall ACPIGetConvertToPnpIDWide(_QWORD *a1, int a2, __int64 a3, int a4, char **a5, int *a6)
{
  int v8; // ebp
  char *v9; // rdi
  __int64 v10; // r8
