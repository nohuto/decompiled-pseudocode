/*
 * XREFs of AcpiPccRingDoorbell @ 0x1C003EDD0
 * Callers:
 *     AcpiPccExecuteCommandAsync @ 0x1C003E990 (AcpiPccExecuteCommandAsync.c)
 * Callees:
 *     ReadIoMemRaw @ 0x1C003EFAC (ReadIoMemRaw.c)
 *     WriteIoMemRaw @ 0x1C003F008 (WriteIoMemRaw.c)
 */
  ...
  *((_DWORD *)DeferredContext + 128) = 0;
  ...
  if ( v14 <= 1u )
  {
    if ( DeferredContext[82] )
    {
      ...
      v19 = (__int64)((1 << DeferredContext[81]) - 1) << v17;
      v15 = v16 & ~v19 | v19 & (v18 << v17);
    }
    WriteIoMemRaw(
