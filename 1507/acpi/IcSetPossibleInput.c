/*
 * XREFs of IcSetPossibleInput @ 0x1C006DC58
 * Callers:
...
__int64 __fastcall IcSetPossibleInput(unsigned int a1, __int64 a2, char a3, char a4)
{
  ...
  v9 = 184LL * v6;
  *(_DWORD *)(v9 + i + 140) = v8;
  *(_DWORD *)(v9 + i + 144) = (a3 & 1) == 0;
  if ( a4 && *(_DWORD *)(v9 + i + 36) == *(_DWORD *)(v9 + i + 44) )
    *(_BYTE *)(v9 + i + 209) = a4;
  else
    *(_BYTE *)(v9 + i + 209) = 0;
  *(_DWORD *)(v9 + i + 132) = *(_DWORD *)(a2 + 20);
  *(_OWORD *)(v9 + i + 152) = *(_OWORD *)a2;
  return IrqArbGetDeviceIrql((_DWORD *)(i + v9 + 128), (_BYTE *)(v9 + i + 136));
}
