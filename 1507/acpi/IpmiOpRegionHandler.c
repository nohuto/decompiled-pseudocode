/*
 * XREFs of IpmiOpRegionHandler @ 0x1C003DAD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IpmiOpRegionHandler(__int64 a1, _BYTE *a2, _DWORD *a3)
{
  ...
  *((_DWORD *)InOutBuffer + 1) = v12;
  ...
  if ( *(_BYTE *)(a1 + 8) == 1 )
  {
    ...
    if ( v13 )
    {
      ...
      InstanceName.Buffer = (unsigned __int16 *)((char *)v8 + v14 + 2);
