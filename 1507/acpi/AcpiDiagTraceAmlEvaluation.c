/*
 * XREFs of AcpiDiagTraceAmlEvaluation @ 0x1C003311C
 * Callers:
 ...
 *     RtlStringCchLengthA @ 0x1C0034074 (RtlStringCchLengthA.c)
 */
...
void __fastcall AcpiDiagTraceAmlEvaluation(STRSAFE_PCNZCH psz, unsigned __int8 a2)
{
  ...
  unsigned __int16 *v15; // [rsp+60h] [rbp+17h]
  ...
  if ( (unsigned __int8)AcpiDiagTraceIsAmlTracingEnabled() && psz && *psz )
  {
    ...
    v10 = v5;
    DestinationString.Buffer = (unsigned __int16 *)ExAllocatePoolWithTag(v4, 2LL * (v5 + 1), 0x53706341u);
