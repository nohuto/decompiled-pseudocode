/*
 * XREFs of ACPIAssociateWakeInterrupt @ 0x1C004197C
 * Callers:
 ...
 *     OSPowerTryAcquireWakeInterruptChangeStateLock @ 0x1C0042534 (OSPowerTryAcquireWakeInterruptChangeStateLock.c)
