/*
 * XREFs of ACPIDeviceIrpDelayedDeviceOffRequest @ 0x1C0037BB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LONG __fastcall ACPIDeviceIrpDelayedDeviceOffRequest(__int64 a1, IRP *a2, int a3)
{
  ...
  if ( a3 >= 0 )
  {
    ...
    *(_OWORD *)(&CurrentStackLocation[-1].Parameters.QueryDeviceRelations + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.QueryDeviceRelations
    ...
    v5[-1].CompletionRoutine = (int (__fastcall *)(_DEVICE_OBJECT *, _IRP *, void *))ACPIDeviceIrpDeviceFilterRequest;
