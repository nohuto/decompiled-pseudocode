/*
 * XREFs of AcpiTranslatePepDeviceControlResourcesInternal @ 0x1C007C09C
 * Callers:
 *     AcpiTranslatePepDeviceControlResources @ 0x1C007C060 (AcpiTranslatePepDeviceControlResources.c)
 * Callees:
