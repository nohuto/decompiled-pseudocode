/*
 * XREFs of PnpiBiosAddressQuadToIoDescriptor @ 0x1C007DB40
 * Callers:
 ...
 *     PnpiBiosAddressHandleMemoryFlags @ 0x1C0068334 (PnpiBiosAddressHandleMemoryFlags.c)
  ...
  if ( result >= 0 )
  {
    ...
    if ( BugCheckParameter2[3] )
    {
      ...
      else if ( BugCheckParameter2[3] == 2 )
      {
        v13->Type = 6;
        v13->u.Port.Length = BugCheckParameter4;
        v13->u.Port.Alignment = *(_DWORD *)(BugCheckParameter2 + 14);
        v13->u.Port.MinimumAddress.LowPart = *(_DWORD *)(BugCheckParameter2 + 22);
      }
    }
    else
    {
