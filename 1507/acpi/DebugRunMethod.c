/*
 * XREFs of DebugRunMethod @ 0x1C0043EF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
  ...
  if ( a2 )
  {
    if ( dword_1C0058E30 != -1 )
    {
      if ( dword_1C0058E30 >= 7 )
      {
        PrintDebugMessage(236, 0, 0, 0, 0LL);
      }
      else
      {
        memset((char *)&unk_1C005AC50 + 40 * dword_1C0058E30, 0, 0x28uLL);
        if ( (unsigned __int8)IsNumber(a2, 0LL) )
        {
          v5 = 5LL * dword_1C0058E30;
          *((_QWORD *)&unk_1C005AC50 + v5 + 2) = strtoui64_0(a2, 0LL, 16);
          ++dword_1C0058E30;
          *((_WORD *)&unk_1C005AC50 + 4 * v5 + 1) = 1;
          return v2;
        }
    ...
    qword_1C005AD68 = GetBaseObject(v13);
    DereferenceObjectEx(v4);
    dword_1C0058E30 = 0;
  }
  else
  {
    if ( dword_1C0058E30 < 0 )
    {
    ...
    {
      memset(&unk_1C005ADC0, 0, 0x28uLL);
      fRunningMethod = 1;
      v6 = AsyncEvalObject(
             qword_1C005AD68,
             (_SLIST_ENTRY *)&unk_1C005ADC0,
             dword_1C0058E30,
             (__int64)&unk_1C005AC50,
      ...
      if ( v6 == 32772 )
      {
        ObjectPath = GetObjectPath(qword_1C005AD68);
        v9 = qword_1C0023E70;
        v10 = (void *)ObjectPath;
        if ( ObjectPath )
      ...
      {
        RunMethodCallBack(qword_1C005AD68 + 112, v6, &unk_1C005ADC0, 0LL);
        if ( v7 )
          v2 = -4;
      }
      DereferenceObjectEx(qword_1C005AD68);
      qword_1C005AD68 = 0LL;
      dword_1C0058E30 = -1;
    }
    if ( v2 )
