/*
 * XREFs of ACPIThermalQueryCoolingInterfaces @ 0x1C0004FC8
 * Callers:
 ...
 * Callees:
 *     ACPIGetRootDeviceObject @ 0x1C00051C4 (ACPIGetRootDeviceObject.c)
...
__int64 __fastcall ACPIThermalQueryCoolingInterfaces(__int64 a1)
{
  ...
  if ( v3 == 259 )
  {
    AttachedDeviceReference = IoGetAttachedDeviceReference(*(PDEVICE_OBJECT *)(a1 + 728));
    if ( !AttachedDeviceReference )
      return (unsigned int)-1073741810;
    v12[0] = 0;
    v12[1] = 1;
    RtlInitUnicodeString(&DestinationString, L"ACPI Thermal Zones");
    v5 = ACPIGetRootDeviceObject();
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)v7 + 2) = v7 + 16;
      v7[42] = 100;
      *((_QWORD *)v7 + 4) = a1;
      WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(a1 + 712));
      *((_QWORD *)v7 + 6) = WorkItem;
      if ( WorkItem )
      {
        *((_QWORD *)v7 + 8) = v14;
        ...
        if ( *(_BYTE *)(a1 + 608) && !*(_QWORD *)(a1 + 600) )
        {
          *(_QWORD *)(a1 + 600) = v7;
          v10 = (__int64 **)qword_1C0059518;
          *(_QWORD *)v7 = &AcpiThermalClientList;
          *((_QWORD *)v7 + 1) = v10;
          if ( *v10 != &AcpiThermalClientList )
            __fastfail(3u);
          *v10 = (__int64 *)v7;
          qword_1C0059518 = (__int64)v7;
          v7 = 0LL;
        }
        v3 = *(_QWORD *)(a1 + 600) == 0LL ? 0xC00000BB : 0;
