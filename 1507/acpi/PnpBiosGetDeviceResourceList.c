/*
 * XREFs of PnpBiosGetDeviceResourceList @ 0x1C0067894
 * Callers:
...
__int64 __fastcall PnpBiosGetDeviceResourceList(ULONG_PTR a1, char a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  v8 = ACPIGet(DeviceExtension, 1397900127, 268501000, 0LL, 0, 0LL, 0LL, (__int64)&P, (__int64)&v14);
  if ( a2 )
    v9 = ACPIGet(DeviceExtension, 1397903455, 268501000, 0LL, 0, 0LL, 0LL, (__int64)&v16, (__int64)&v15);
  else
    v9 = -1073741772;
  if ( v8 >= 0 )
  {
...
LABEL_20:
    if ( v16 )
    {
      v6 = PnpDeviceBiosResourcesToNtResources(DeviceExtension, (__int64)v16, 0LL, (__int64)&v12);
