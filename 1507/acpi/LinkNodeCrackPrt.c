/*
 * XREFs of LinkNodeCrackPrt @ 0x1C00163F8
 * Callers:
 ...
 *     LinkNodeFindByNsObj @ 0x1C007FFA0 (LinkNodeFindByNsObj.c)
 *     LinkNodepAddAttachedDevice @ 0x1C0080148 (LinkNodepAddAttachedDevice.c)
 */
