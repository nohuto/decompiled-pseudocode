/*
 * XREFs of ACPIPccProcessSci @ 0x1C003E4C0
 * Callers:
 *     ACPIInterruptServiceRoutineDPC @ 0x1C003D1A0 (ACPIInterruptServiceRoutineDPC.c)
 * Callees:
 *     AcpiPccCommandComplete @ 0x1C003E844 (AcpiPccCommandComplete.c)
 *     AcpiPccPlatformNotification @ 0x1C003EC58 (AcpiPccPlatformNotification.c)
 */
