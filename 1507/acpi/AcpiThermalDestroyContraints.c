/*
 * XREFs of AcpiThermalDestroyContraints @ 0x1C00412A8
 * Callers:
 *     ACPIThermalStopZoneWorker @ 0x1C0041100 (ACPIThermalStopZoneWorker.c)
 * Callees:
 *     ACPIThermalReevaluateConstraints @ 0x1C0021108 (ACPIThermalReevaluateConstraints.c)
...
void __fastcall AcpiThermalDestroyContraints(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v8 + 8) = v9;
    v10 = v4[5];
    if ( v10 )
      ACPIThermalReevaluateConstraints(*(PVOID *)(v10 + 600));
