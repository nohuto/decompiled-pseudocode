/*
 * XREFs of AcpiIrqLibInitializeGlobalState @ 0x1C0086DB8
 * Callers:
 *     ACPIInitialize @ 0x1C0086558 (ACPIInitialize.c)
 * Callees:
 *     LinkNodeInitGlobalState @ 0x1C0065ACC (LinkNodeInitGlobalState.c)
 *     IcInitGlobalState @ 0x1C0065AE4 (IcInitGlobalState.c)
