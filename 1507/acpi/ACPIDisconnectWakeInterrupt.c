/*
 * XREFs of ACPIDisconnectWakeInterrupt @ 0x1C0041DD0
 * Callers:
 *     ACPIWakeEmulationDisable @ 0x1C0042298 (ACPIWakeEmulationDisable.c)
 * Callees:
 *     ACPIDereferenceWakeInterrupt @ 0x1C0041D58 (ACPIDereferenceWakeInterrupt.c)
 *     ACPIFindWakeInterruptForVector @ 0x1C0041E68 (ACPIFindWakeInterruptForVector.c)
 */
