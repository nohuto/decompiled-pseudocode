/*
 * XREFs of ACPIGetConvertToClassCode @ 0x1C003B950
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  if ( a2 >= 0 )
  {
    if ( a5 )
    {
      ...
      {
        if ( *(_WORD *)(a3 + 2) != 4 )
          KeBugCheckEx(0xA3u, 1uLL, 0x60246uLL, 0LL, 0LL);
        v7 = *(_DWORD **)(a3 + 32);
        if ( *v7 != 3 )
          KeBugCheckEx(0xA3u, 1uLL, 0x6022BuLL, 0LL, 0LL);
        v8 = 0;
        v9 = v12;
        v10 = v7 + 6;
        do
        {
          if ( *(v10 - 7) != 1 )
            KeBugCheckEx(0xA3u, 1uLL, 0x6023AuLL, 0LL, 0LL);
          ++v8;
          *v9 = *v10;
          v10 += 20;
          ++v9;
