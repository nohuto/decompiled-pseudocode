/*
 * XREFs of ?RegisterSharedVirtualDesktopVisual@CWindowList@@UEAAJPEAUHWND__@@T_LARGE_INTEGER@@PEAX@Z @ 0x1800794D0
 * Callers:
...
LABEL_32:
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024882, 0xD26u);
    goto LABEL_33;
  }
  ...
  *((_DWORD *)v13 + 28) = 2;
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v15, 0xD34u);
    v7 = v27;
    goto LABEL_33;
  }
  v7 = v27;
...
LABEL_30:
  ...
  v9 = 0;
  if ( v21 <= *((_DWORD *)v11 + 115) )
  {
    *(_QWORD *)(*((_QWORD *)v11 + 55) + 8LL * *((unsigned int *)v11 + 116)) = v28;
    *((_DWORD *)v11 + 116) = v21;
    goto LABEL_33;
  }
  v23 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v11 + 440, 8u, 1, &v28);
  v19 = v23;
  if ( v23 < 0 )
