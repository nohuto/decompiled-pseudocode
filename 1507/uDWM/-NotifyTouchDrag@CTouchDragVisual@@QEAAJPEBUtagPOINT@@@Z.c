/*
 * XREFs of ?NotifyTouchDrag@CTouchDragVisual@@QEAAJPEBUtagPOINT@@@Z @ 0x180085BA4
 * Callers:
...
__int64 __fastcall CTouchDragVisual::NotifyTouchDrag(CTouchDragVisual *this, const struct tagPOINT *a2)
{
  ...
  {
    TemplateEventDescriptor(v6, (__int64)&UdwmTouchDragVisual_BeginDraw_Info);
  }
  if ( v10 )
  {
    ...
    *((float *)&v41 + 3) = FLOAT_0_5;
    ...
    {
      v17 = (_DWORD *)((char *)this + 304);
      DynArray<TOUCH_DRAG_POINT,0>::InsertAt((__int64)this + 304, (unsigned __int64)&v41);
      ++v7;
    }
    *((_BYTE *)this + 424) = 0;
    if ( v7 > 1 )
...
LABEL_29:
        ...
        if ( v30 >= 0 )
        {
          ...
          while ( v31 < 2 );
          CTouchDragVisualHelper::SmoothTouchDragPath(v17, (__int64)this + 336);
        }
        else
        {
