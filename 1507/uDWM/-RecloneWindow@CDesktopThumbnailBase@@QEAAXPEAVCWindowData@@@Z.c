/*
 * XREFs of ?RecloneWindow@CDesktopThumbnailBase@@QEAAXPEAVCWindowData@@@Z @ 0x180099070
 * Callers:
...
void __fastcall CDesktopThumbnailBase::RecloneWindow(CDesktopThumbnailBase *this, struct CWindowData *a2)
{
  ...
  v14 = 0LL;
  v3 = (const struct CTopLevelWindow *)*((_QWORD *)a2 + 46);
  if ( v3 )
  {
    ...
    if ( Index >= 0 )
    {
      ...
      v9 = CTopLevelWindow::CloneVisualTreeForLivePreview(*((CTopLevelWindow **)a2 + 46), 0, 0, v8, &v14);
      if ( v9 >= 0 )
      {
        v11 = v7;
        v12 = v14;
