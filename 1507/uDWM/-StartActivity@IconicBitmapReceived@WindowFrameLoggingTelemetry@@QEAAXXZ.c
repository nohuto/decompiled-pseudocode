/*
 * XREFs of ?StartActivity@IconicBitmapReceived@WindowFrameLoggingTelemetry@@QEAAXXZ @ 0x18006FB84
 * Callers:
        ...
        WindowFrameLoggingTelemetry::IconicBitmapReceived *this)
{
    ...
    && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    TlgWrite(v5, &unk_1800A6EC1, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v6, 3u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
