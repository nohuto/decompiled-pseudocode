/*
 * XREFs of ?RequestBitmap@CIconicBitmapRegistry@@AEAAJPEAVCWindowData@@_N@Z @ 0x180030C0C
 * Callers:
...
LABEL_22:
  ...
  if ( a2 != (struct CWindowData *)-1LL )
  {
    ...
    if ( v10 )
      goto LABEL_28;
    IdealIconicThumbnailSize = DwmGetIdealIconicThumbnailSize(*((_DWORD *)a2 + 72) != 0, &v29);
    v19 = (HWND)*((_QWORD *)a2 + 5);
    if ( !IdealIconicThumbnailSize || !v19 )
      goto LABEL_28;
    IsImmersiveWindow = CWindowData::IsImmersiveWindow(a2);
    v21 = 803;
    v22 = (unsigned __int64)v19 & -(__int64)IsImmersiveWindow;
