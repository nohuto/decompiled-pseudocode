/*
 * XREFs of ?CreateRectangleGeometry@ResourceHelper@@SAJHHHHPEAPEAVCResource@@@Z @ 0x180010AD0
 * Callers:
...
__int64 __fastcall ResourceHelper::CreateRectangleGeometry(int a1, int a2, int a3, int a4, struct CResource **a5)
{
  ...
  if ( !*a5 )
  {
    v13 = CResource::Create(63LL, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4));
    v11 = v13;
    if ( v13 < 0 )
    {
