/*
 * XREFs of ?CreateDesktopAnimationComponent@CTransitionVisualController@@QEAAJPEAVCWindowData@@HAEBUtagRECT@@_N2PEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x18008C038
 * Callers:
...
LABEL_5:
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v20, 0x539u);
    return v19;
  }
...
LABEL_30:
    ...
    if ( v29 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v29, 0x548u);
      v14 = v51;
LABEL_33:
      v15 = v52;
      goto LABEL_78;
    ...
    if ( !a6 || CDesktopThumbnail::IsDesktopThumbnailInSnapshot() )
    {
      ...
      if ( v31 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v31, 0x555u);
        goto LABEL_33;
      }
      v15 = v52;
      ...
      if ( v32 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v32, 0x556u);
        goto LABEL_78;
      }
    }
    else
    {
      ...
      if ( v30 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v30, 0x551u);
        goto LABEL_30;
      }
    }
    ...
    *(_QWORD *)(v23 + 48) = v14;
    ...
    if ( (*((_DWORD *)a2 + 142) & 0x1000000) != 0 && EqualRect((const RECT *)((char *)a2 + 572), &rc2)
      || (*((_DWORD *)a2 + 142) & 0x800000) != 0 && EqualRect((const RECT *)((char *)a2 + 604), &rc2) )
    {
      v33 = rc2;
      v56 = rc2;
    }
    ...
    *((_QWORD *)v15 + 117) = v50;
    if ( (_BYTE)v60 )
    {
      *(_OWORD *)((char *)v15 + 872) = *(_OWORD *)((char *)a2 + 572);
      *(_OWORD *)((char *)v15 + 808) = *(_OWORD *)((char *)a2 + 572);
      CVisual::SetDirtyFlags((struct CAnimatedTransitionVisual *)((char *)v15 + 8), 4096);
      *(_OWORD *)((char *)v15 + 888) = *(_OWORD *)((char *)a2 + 604);
      CVisual::SetDirtyFlags((struct CAnimatedTransitionVisual *)((char *)v15 + 8), 4096);
      *((_BYTE *)v15 + 970) = 1;
    }
    if ( !IsRectEmpty((const RECT *)((char *)a2 + 636)) )
    {
      v46 = *(_OWORD *)((char *)a2 + 636);
      *(_DWORD *)(v23 + 68) = 2;
      *(_OWORD *)(v23 + 104) = v46;
    }
  ...
  MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, updated, 0x545u);
LABEL_78:
