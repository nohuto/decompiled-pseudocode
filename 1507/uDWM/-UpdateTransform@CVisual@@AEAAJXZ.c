/*
 * XREFs of ?UpdateTransform@CVisual@@AEAAJXZ @ 0x180076BEC
 * Callers:
...
__int64 __fastcall CVisual::UpdateTransform(CVisual *this)
{
  ...
  if ( !*((_QWORD *)this + 12) )
  {
    v3 = CResource::Create(0x3Bu, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)this + 12);
    v4 = v3;
    if ( v3 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x44Au);
      return v4;
    }
    v10 = 43;
    v11 = 0LL;
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x44Fu);
      return v4;
    }
  }
  ...
  *((_BYTE *)this + 84) |= 2 * (CurrentTransform & 1);
  ...
  v4 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x45Eu);
  return v4;
}
