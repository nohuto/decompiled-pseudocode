/*
 * XREFs of ?OnEligibleOwnedWindowAddedOrRemoved@CSecondaryWindowRepresentation@@QEAAJPEAVCWindowData@@_N@Z @ 0x18003401C
 * Callers:
        ...
        char a3)
{
  ...
  inserted = CSecondaryWindowRepresentation::Create(1LL, (char *)this + 16, a2, 0LL, 100, &v15);
  v3 = inserted;
  if ( inserted >= 0 )
  {
    v10 = *((_DWORD *)this + 38);
    ...
    else
    {
      ...
      v12 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 128, 8u, 1, &v15);
      v13 = v12;
      if ( v12 < 0 )
