/*
 * XREFs of ?IconChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYICONCHANGE@@@Z @ 0x18002C3D0
 * Callers:
...
__int64 __fastcall CWindowList::IconChange(CWindowList *this, const struct MILCMD_DWM_REDIRECTION_NOTIFYICONCHANGE *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowDataByHwnd, 0xC1Du);
  }
  else
  {
    v7 = v15;
    if ( v15 )
    {
      ...
      if ( v9 )
      {
        v12 = (CVisual *)*((_QWORD *)v7 + 46);
        if ( v12 )
          CVisual::SetDirtyFlags(v12, 0x20000);
        v13 = (CWindowIconic *)*((_QWORD *)v7 + 49);
        if ( v13 )
        {
          v14 = CWindowIconic::OnIconUpdated(v13, 1);
          v6 = v14;
          if ( v14 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0xC38u);
        }
      }
    }
  }
