/*
 * XREFs of ?UpdateProperties@CThumbnailData@@QEAAJPEBU_DWM_THUMBNAIL_PROPERTIES@@@Z @ 0x180012090
 * Callers:
...
__int64 __fastcall CThumbnailData::UpdateProperties(CThumbnailData *this, const struct _DWM_THUMBNAIL_PROPERTIES *a2)
{
  ...
  v11 = (CThumbnailVisual *)*((_QWORD *)this + 11);
  if ( v11 )
  {
    updated = CThumbnailVisual::UpdateProperties(v11, v6);
    v2 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x20D4u);
  }
  return v2;
}
