/*
 * XREFs of ?ValidateVisual@CIconicAnimatedVisual@@UEAAJXZ @ 0x18009BF10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CIconicAnimatedVisual::ValidateVisual(CSecondaryWindowRepresentation **this)
{
  ...
  if ( *((char *)this + 80) < 0 )
  {
    ...
    if ( v2 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v2, 0xE3u);
      return v3;
    }
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0xE4u);
      return v3;
    }
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0xE6u);
      return v3;
    }
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0xE7u);
      return v3;
    }
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0xE8u);
      return v3;
    }
  ...
  v3 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0xECu);
  return v3;
}
