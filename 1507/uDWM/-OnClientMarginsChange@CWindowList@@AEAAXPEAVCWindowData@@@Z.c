/*
 * XREFs of ?OnClientMarginsChange@CWindowList@@AEAAXPEAVCWindowData@@@Z @ 0x180067BA4
 * Callers:
...
void __fastcall CWindowList::OnClientMarginsChange(CWindowList *this, struct CWindowData *a2)
{
  ...
  if ( operator!=((_DWORD *)a2 + 16, &v21) || *((_DWORD *)a2 + 24) != v12 )
  {
    ...
    *v11 = v13;
    ...
    for ( j = 0LL; (unsigned int)j < *((_DWORD *)a2 + 116); j = (unsigned int)(j + 1) )
    {
      v20 = *(CThumbnailVisual **)(*(_QWORD *)(*((_QWORD *)a2 + 55) + 8 * j) + 88LL);
      if ( v20 )
