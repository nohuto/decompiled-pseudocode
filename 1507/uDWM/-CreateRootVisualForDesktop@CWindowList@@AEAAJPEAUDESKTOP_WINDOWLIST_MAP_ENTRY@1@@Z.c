/*
 * XREFs of ?CreateRootVisualForDesktop@CWindowList@@AEAAJPEAUDESKTOP_WINDOWLIST_MAP_ENTRY@1@@Z @ 0x1800466E4
 * Callers:
        ...
        struct CWindowList::DESKTOP_WINDOWLIST_MAP_ENTRY *a2)
{
  ...
  v19 = 0LL;
  v18 = 0LL;
  v6 = CVisual::Create(v5, (CBaseObject ***)&v20);
  v7 = v6;
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x481u);
LABEL_15:
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x48Cu);
LABEL_28:
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x491u);
    goto LABEL_28;
  }
  v3 = (volatile signed __int32 *)v18;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x49Au);
  ...
  else
  {
    ...
    if ( inserted < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x4A1u);
    }
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x4A6u);
      }
      else
      {
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x4A8u);
      }
    }
  }
LABEL_16:
