/*
 * XREFs of ?GetStartTilesScaleFactor@@YAXAEBU_DPI_INFORMATION@@PEAI@Z @ 0x180007DF8
 * Callers:
 ...
 *     _AreStartTilesTooBigAtScaleFactor @ 0x180007FA4 (_AreStartTilesTooBigAtScaleFactor.c)
