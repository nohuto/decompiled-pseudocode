/*
 * XREFs of ?OnCreateAnimationClock@CAnimationClockCoordinator@@QEAAJU_GUID@@K@Z @ 0x18000B414
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAVCBitmapSource@@$0A@@@QEAAHAEBQEAVCBitmapSource@@@Z @ 0x18009C894 (-Remove@-$DynArray@PEAVCBitmapSource@@$0A@@@QEAAHAEBQEAVCBitmapSource@@@Z.c)
        ...
        unsigned int a3)
{
  ...
  __int64 v16; // rdx
  __int64 v17; // rcx
  CAnimationClock *v18; // [rsp+30h] [rbp-49h] BYREF
  char *v19; // [rsp+38h] [rbp-41h] BYREF
  ...
  if ( v5 )
  {
    ...
    {
      v24 = *a2;
      AnimationClock = CAnimationClockCoordinator::GetAnimationClock(this, &v24, &v18);
    }
    else
    {
      ...
      if ( AnimationClock < 0 )
        goto LABEL_14;
      v22 = *a2;
      AnimationClock = CAnimationClockFactory::Create(&v22, &v18);
      if ( AnimationClock < 0 )
        goto LABEL_14;
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
        Template_jq(v10, v9, a2, a3);
...
LABEL_14:
    ...
    if ( AnimationClock >= 0 )
    {
      ...
      {
        v23 = *a2;
        AnimationClock = CAnimationClock::Initialize(v18, &v23, a3);
        if ( AnimationClock < 0 )
        {
          v20 = v8;
