/*
 * XREFs of ?CreateOrUpdateImageBrush@CBitmapSource@@QEAAJPEAPEAVCResource@@00W4Enum@MilStretch@@@Z @ 0x18006BCCC
 * Callers:
        ...
        int a5)
{
  ...
  if ( !v30 )
  {
    v12 = CResource::Create(0x47u, *(_QWORD *)(*((_QWORD *)a1 + 2) + 16LL), &v30);
    v13 = v12;
    if ( v12 < 0 )
    {
  ...
  if ( a3 )
  {
    ...
    {
      v15 = CResource::Create(0x2Du, *(_QWORD *)(*((_QWORD *)a1 + 2) + 16LL), &v29);
      v13 = v15;
      if ( v15 < 0 )
      {
...
LABEL_45:
  ...
  if ( a4 )
  {
    ...
    {
      v17 = CResource::Create(0x29u, *(_QWORD *)(*((_QWORD *)a1 + 2) + 16LL), &v28);
      v13 = v17;
      if ( v17 < 0 )
      {
