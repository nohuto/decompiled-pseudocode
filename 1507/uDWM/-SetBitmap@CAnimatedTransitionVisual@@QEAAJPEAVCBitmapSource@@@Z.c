/*
 * XREFs of ?SetBitmap@CAnimatedTransitionVisual@@QEAAJPEAVCBitmapSource@@@Z @ 0x18008969C
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::SetBitmap(CBaseObject **this, struct CResource **a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x328u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0x327u);
  }
  return v5;
}
