/*
 * XREFs of ?_SetupWindowPreview@CLivePreview@@AEAAJPEAVCWindowData@@PEAUHWND__@@_NW4Enum@LivePreviewWindowState@@PEAVCVisual@@2@Z @ 0x18006A2D8
 * Callers:
        ...
        char a7)
{
  ...
  struct CVisual *v24; // [rsp+30h] [rbp-40h] BYREF
  ...
  if ( a4 )
  {
    LivePreviewWindow = (volatile signed __int32 *)CLivePreview::_FindLivePreviewWindow(
                                                     (CLivePreview *)a1,
                                                     *(HWND *)(a2 + 40));
    v24 = (struct CVisual *)LivePreviewWindow;
