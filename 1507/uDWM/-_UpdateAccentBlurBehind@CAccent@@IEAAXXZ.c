/*
 * XREFs of ?_UpdateAccentBlurBehind@CAccent@@IEAAXXZ @ 0x180035600
 * Callers:
 ...
 * Callees:
 *     ?_HasBlurBehind@CAccent@@IEAA_NXZ @ 0x18000233C (-_HasBlurBehind@CAccent@@IEAA_NXZ.c)
  ...
  if ( *((_QWORD *)this + 40) && *((_BYTE *)this + 350) )
  {
    ...
    *(float *)&v11[2] = (float)v3 + 0.0;
    if ( CAccent::_HasBlurBehind(this) )
    {
      ...
      if ( inserted < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x65Cu);
        return;
      }
    }
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x664u);
      return;
    }
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x665u);
    }
    else
    {
LABEL_11:
      ...
      if ( v5 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x668u);
    }
  }
}
