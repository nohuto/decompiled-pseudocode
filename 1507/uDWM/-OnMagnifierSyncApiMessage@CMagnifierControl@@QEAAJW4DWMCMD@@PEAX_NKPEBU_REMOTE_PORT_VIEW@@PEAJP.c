/*
 * XREFs of ?OnMagnifierSyncApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEAX_NKPEBU_REMOTE_PORT_VIEW@@PEAJPEAI@Z @ 0x18007341C
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  v8 = 0;
  v13 = -2147023728;
  if ( (dword_1800BD404 & 1) == 0 )
  {
    dword_1800BD348 = -2147023728;
    dword_1800BD404 |= 1u;
  }
  ...
  if ( a2 == 1073741923 && a4 )
  {
    ...
    *a8 = 44;
    ...
    if ( v14 < 0 )
    {
      if ( v14 != -2147023728 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_1800BD348, 1LL, v14, 0x16Cu);
        goto LABEL_13;
      }
      v8 = 0;
    }
