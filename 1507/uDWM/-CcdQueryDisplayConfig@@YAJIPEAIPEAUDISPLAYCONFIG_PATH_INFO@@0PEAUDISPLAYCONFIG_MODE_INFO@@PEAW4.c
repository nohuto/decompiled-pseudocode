/*
 * XREFs of ?CcdQueryDisplayConfig@@YAJIPEAIPEAUDISPLAYCONFIG_PATH_INFO@@0PEAUDISPLAYCONFIG_MODE_INFO@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x18009ECEC
 * Callers:
 ...
 * Callees:
 *     ?CcdEmulateOldQDC@@YAKXZ @ 0x18009EC5C (-CcdEmulateOldQDC@@YAKXZ.c)
 */
