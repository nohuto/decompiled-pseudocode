/*
 * XREFs of ?MonitorEnumProc@CDesktopManager@@CAHPEAUHMONITOR__@@PEAUHDC__@@PEAUtagRECT@@_J@Z @ 0x180008E60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x30Du);
    goto LABEL_4;
  }
  v9 = 0;
  if ( v8 <= *(_DWORD *)(v4 + 140) )
  ...
  v10 = DynArrayImpl<0>::AddMultipleAndSet(v4 + 120, 8LL, 1LL, &v12);
  v9 = v10;
  if ( v10 < 0 )
  {
