/*
 * XREFs of ?OnMagnifierDestroy@CMagnifierControl@@AEAAJPEAUHWND__@@@Z @ 0x18007337C
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierDestroy(CMagnifierControl *this, __int64 a2)
{
  ...
  v2 = 0;
  if ( (dword_1800BD410 & 1) == 0 )
  {
    dword_1800BD33C = -2147023728;
    dword_1800BD410 |= 1u;
  }
  ...
  {
    v2 = -2147023728;
    MilInstrumentationCheckHR(0x14u, &dword_1800BD33C, 1LL, -2147023728, 0x227u);
  }
  return v2;
}
