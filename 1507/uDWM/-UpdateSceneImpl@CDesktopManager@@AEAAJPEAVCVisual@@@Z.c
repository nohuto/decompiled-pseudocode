/*
 * XREFs of ?UpdateSceneImpl@CDesktopManager@@AEAAJPEAVCVisual@@@Z @ 0x18001C2A0
 * Callers:
...
LABEL_4:
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x42Au);
  }
  else
  {
    for ( i = *((_QWORD *)v2 + 167);
      ...
      if ( *((_DWORD *)v2 + 362) )
      {
        if ( !*((_BYTE *)v2 + 18) )
        {
          *((_BYTE *)v2 + 18) = 1;
          ...
          v3 = v10;
          if ( v10 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x43Bu);
        }
      }
    }
  }
