/*
 * XREFs of ?CalculateOutsideMargins@CTopLevelWindow@@SAXPEAVCWindowData@@IPEAU_MARGINS@@@Z @ 0x180075740
 * Callers:
...
void __fastcall CTopLevelWindow::CalculateOutsideMargins(struct CWindowData *this, char a2, struct _MARGINS *a3)
{
  ...
  *(_QWORD *)&a3->cyTopHeight = 0LL;
  if ( CTopLevelWindow::HasRenderedBorder(a2)
    ...
    && *((_DWORD *)this + 17) >= dword_1800BC52C
    && *((_DWORD *)this + 18) >= dword_1800BC530
    && *((_DWORD *)this + 19) >= dword_1800BC534
