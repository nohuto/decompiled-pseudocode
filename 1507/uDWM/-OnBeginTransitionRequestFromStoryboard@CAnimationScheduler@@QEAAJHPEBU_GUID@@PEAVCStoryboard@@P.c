/*
 * XREFs of ?OnBeginTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAVCStoryboard@@PEAU2@@Z @ 0x18000C1BC
 * Callers:
...
LABEL_41:
      v25 = v13;
LABEL_44:
      MilInstrumentationCheckHR(0x14u, &dword_1800AAB08, 1LL, v25, v26);
      goto LABEL_20;
    }
    if ( a3 )
