/*
 * XREFs of ?Initialize@CDrawNineGridInstruction@@AEAAJPEAVCBitmapSource@@@Z @ 0x180011C30
 * Callers:
 ...
 *     ?GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLayout@@@Z @ 0x180011EA0 (-GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLay.c)
 *     ?HasSourceClip@CBitmapSource@@QEBA_NXZ @ 0x1800174D8 (-HasSourceClip@CBitmapSource@@QEBA_NXZ.c)
...
__int64 __fastcall CDrawNineGridInstruction::Initialize(CDrawNineGridInstruction *this, struct CBitmapSource *a2)
{
  ...
  *((_DWORD *)this + 30) = 0;
  while ( 1 )
  {
    ...
    ++*((_DWORD *)this + 30);
    v14 = CResource::Create(71LL, *(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL));
    v6 = v14;
    if ( v14 < 0 )
      break;
    v24 = 250;
