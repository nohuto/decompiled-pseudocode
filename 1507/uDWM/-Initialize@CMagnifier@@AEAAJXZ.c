/*
 * XREFs of ?Initialize@CMagnifier@@AEAAJXZ @ 0x180071F40
 * Callers:
...
__int64 __fastcall CMagnifier::Initialize(CMagnifier *this)
{
  ...
  v3 = CResource::Create(0x31u, *((_QWORD *)this + 2), (CBaseObject **)this + 4);
  v4 = v3;
  if ( v3 >= 0 )
  {
    v16 = 100;
    ...
    if ( v8 >= 0 )
    {
      v9 = (char *)this + 40;
      if ( *((_QWORD *)this + 5)
        || (v10 = CResource::Create(0x3Bu, *((_QWORD *)this + 2), (CBaseObject **)this + 5), v4 = v10, v10 >= 0) )
      {
        v18 = 243;
