/*
 * XREFs of ?GetBrush@CSecondaryWindowRepresentation@@QEAAJW4Enum@MilStretch@@PEAPEAVCResource@@11111@Z @ 0x18003370C
 * Callers:
        ...
        CBaseObject **a8)
{
  ...
  CBaseObject *v41; // [rsp+38h] [rbp-81h] BYREF
  CBaseObject *v42; // [rsp+40h] [rbp-79h] BYREF
  CBaseObject *v43; // [rsp+48h] [rbp-71h] BYREF
  ...
  if ( a3 )
  {
    ...
    if ( !v43 )
    {
      v12 = CResource::Create(0x2Du, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v43);
      v13 = v12;
      if ( v12 < 0 )
      {
  ...
  if ( a4 )
  {
    ...
    if ( !v41 )
    {
      v15 = CResource::Create(0x2Du, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v41);
      v13 = v15;
      if ( v15 < 0 )
      {
  ...
  if ( a6 )
  {
    ...
    if ( !v42 )
    {
      v17 = CResource::Create(0x2Eu, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v42);
      v13 = v17;
      if ( v17 < 0 )
      {
  ...
  if ( !v18 )
  {
    ...
    {
      v20 = CResource::Create(0x34u, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v40);
      v13 = v20;
      if ( v20 < 0 )
      {
    ...
    if ( *(_DWORD *)(a1 + 72) != 1 )
    {
      if ( *(_DWORD *)(a1 + 72) == 2 )
      {
        v22 = *(CWindowData **)(*((_QWORD *)v23 + 48) + 32LL);
        goto LABEL_26;
      }
      if ( *(_DWORD *)(a1 + 72) != 3 )
        goto LABEL_26;
      ...
      {
        v22 = *(CWindowData **)(*((_QWORD *)v23 + 49) + 80LL);
        goto LABEL_26;
      }
    }
    v22 = v23;
...
LABEL_34:
    ...
    if ( *(_DWORD *)(a1 + 72) != 1 )
    {
      if ( *(_DWORD *)(a1 + 72) == 2 )
      {
        v26 = *(CWindowData **)(*((_QWORD *)v25 + 48) + 32LL);
        goto LABEL_30;
      }
      if ( *(_DWORD *)(a1 + 72) != 3 )
        goto LABEL_30;
      ...
      {
        v26 = *(CWindowData **)(*((_QWORD *)v25 + 49) + 80LL);
        goto LABEL_30;
      }
    }
    v26 = v25;
