/*
 * XREFs of ?CreateRenderTargets@CDesktopManager@@AEAAJXZ @ 0x18001C3FC
 * Callers:
...
__int64 __fastcall CDesktopManager::CreateRenderTargets(CDesktopManager *this)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x33Du);
    goto LABEL_18;
  }
  ...
  *((_DWORD *)this + 36) = 0;
  ...
  SetLastError(0);
  if ( !EnumDisplayMonitors(0LL, 0LL, (MONITORENUMPROC)CDesktopManager::MonitorEnumProc, (LPARAM)dwData) )
  {
    ...
    if ( v1 >= 0 )
      v1 = -2003304445;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v1, 0x322u);
    goto LABEL_29;
  }
  v1 = dwData[0];
  if ( SLODWORD(dwData[0]) < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, dwData[0], 0x326u);
LABEL_29:
    v15 = 832;
    v14 = v1;
LABEL_39:
