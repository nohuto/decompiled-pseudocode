/*
 * XREFs of ?TransitionsForceDisabledChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18007A160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::TransitionsForceDisabledChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( SyncedWindowData >= 0 )
  {
    ...
    if ( v9 )
    {
      ...
      *((_BYTE *)v6 + 552) &= ~0x10u;
      *((_BYTE *)v6 + 552) |= 16 * (v7 & 1);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x1440u);
  }
