/*
 * XREFs of ?InvalidateBitmaps@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@K@Z @ 0x180030C8C
 * Callers:
...
__int64 __fastcall CIconicBitmapRegistry::InvalidateBitmaps(CIconicBitmapRegistry *this, HWND *a2, int a3)
{
  ...
  if ( a2[45] && CIconicBitmapRegistry::CanAcceptBitmap(this, (struct CWindowData *)a2) )
  {
    *((_BYTE *)a2 + 554) &= 0xF5u;
    if ( a2[49] )
    {
...
LABEL_10:
        v12 = v11;
LABEL_17:
        MilInstrumentationCheckHR(0x14u, &dword_1800A32EC, 1LL, v12, v13);
        return v6;
      }
    }
    else
