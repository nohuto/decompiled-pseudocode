/*
 * XREFs of ?_UpdateResources@CAccent@@IEAAJXZ @ 0x180002424
 * Callers:
...
__int64 __fastcall CAccent::_UpdateResources(struct CVisual **this)
{
  ...
  if ( (unsigned int)(*((_DWORD *)this + 66) - 2) > 1 )
  {
    if ( (*(_DWORD *)v1 & 0xFFFFFFFB) != 0 )
    {
      ...
      if ( v4 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x32Cu);
        goto LABEL_11;
      }
    }
    if ( *((_BYTE *)this + 296) )
    {
      ...
      *((_DWORD *)this + 86) = 0;
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x337u);
LABEL_11:
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x339u);
      goto LABEL_11;
    }
  }
  return v2;
