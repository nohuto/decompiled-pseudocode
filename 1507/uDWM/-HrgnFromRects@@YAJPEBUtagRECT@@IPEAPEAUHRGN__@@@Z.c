/*
 * XREFs of ?HrgnFromRects@@YAJPEBUtagRECT@@IPEAPEAUHRGN__@@@Z @ 0x180006480
 * Callers:
...
__int64 __fastcall HrgnFromRects(const struct tagRECT *Src, unsigned int a2, HRGN *a3)
{
  ...
  HRGN Region; // rax
  signed int v19; // ebp
  void (__fastcall *v20)(WPF::ProcessHeapImpl *__hidden, void *); // rsi
  ...
  else
  {
    ...
    {
      v8 = *(void *(__fastcall **)(WPF::ProcessHeapImpl *__hidden, unsigned __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                    + 8LL);
