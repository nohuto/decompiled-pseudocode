/*
 * XREFs of ?OnTransitionWindow@CAppArrangementDelayed@@UEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@@Z @ 0x180091D60
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (a3 & 0x20000000) != 0 && (a3 & 0xFFFu) - 38 <= 1 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      *(struct tagRECT *)(v8 + 856) = *v7;
      ...
      {
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, DesktopThumbnail, 0xFF8u);
      }
      if ( v11 )
    ...
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v5, 0xFF5u);
      v6 = v12;
    }
    if ( v6 )
