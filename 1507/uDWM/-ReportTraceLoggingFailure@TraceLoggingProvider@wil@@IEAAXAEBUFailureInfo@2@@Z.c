/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18006F61C
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x18006F0C0 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  if ( **((_DWORD **)this + 1) > 5u )
  {
    ...
    v62 = 4;
    TlgCreateSz(&v64, v22);
    TlgWrite(v23, &unk_1800A7000, 0LL, 0LL, 0x13u, &pData);
  }
}
