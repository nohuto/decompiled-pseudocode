/*
 * XREFs of ?_CreateGuttersForApp@CGroupingStoryboard@@IEAAJPEAVCWindowData@@PEBUtagRECT@@1W4DWMTRANSITION_TARGET@@PEAPEAVCAnimationComponent@@3@Z @ 0x180092D7C
 * Callers:
        ...
        CBaseObject **a7)
{
  ...
  *a6 = 0LL;
  *a7 = 0LL;
  v11 = (struct CAnimationComponent *)((unsigned __int64)&v25 & -(__int64)((*(_DWORD *)(a2 + 568) & 0x8000) != 0));
  v12 = (struct CAnimationComponent *)((unsigned __int64)&v24 & -(__int64)((*(_DWORD *)(a2 + 568) & 0x10000) != 0));
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x80Bu);
LABEL_7:
    v19 = v25;
    v16 = v24;
    goto LABEL_8;
