/*
 * XREFs of ?_AddImmersiveBackground@CLivePreview@@AEAAJAEAV?$DynArray@UtagRECT@@$0A@@@@Z @ 0x180068604
 * Callers:
 ...
 *     ?_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ @ 0x18006A4E8 (-_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ.c)
 *     ?s_GetCoverageStateOfTwoRects@CLivePreview@@CA?AW4COVERAGESTATE@@PEBUtagRECT@@0PEAU3@@Z @ 0x18006B660 (-s_GetCoverageStateOfTwoRects@CLivePreview@@CA-AW4COVERAGESTATE@@PEBUtagRECT@@0PEAU3@@Z.c)
...
LABEL_8:
    if ( v8 )
      goto LABEL_20;
    v12 = CAccent::Create(*((struct MIL_CHANNEL__ *const *)CDesktopManager::s_pDesktopManagerInstance + 4), &v24);
    v5 = v12;
    if ( v12 < 0 )
      break;
    v2 = v24;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x442u);
      goto LABEL_28;
    }
    v14 = CVisual::Create(*(struct MIL_CHANNEL__ *const *)(*(_QWORD *)(a1 + 16) + 16LL), (CBaseObject ***)&v23);
    v5 = v14;
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x444u);
      v3 = v23;
      goto LABEL_28;
    }
    v3 = v23;
    ...
    if ( inserted < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x44Au);
      goto LABEL_28;
    }
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x44Cu);
      goto LABEL_28;
    }
...
LABEL_20:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x43Eu);
  v2 = v24;
LABEL_28:
  if ( (v5 & 0x80000000) == 0 )
  {
