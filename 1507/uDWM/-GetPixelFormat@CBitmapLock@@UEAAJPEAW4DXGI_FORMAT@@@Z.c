/*
 * XREFs of ?GetPixelFormat@CBitmapLock@@UEAAJPEAW4DXGI_FORMAT@@@Z @ 0x18003DC50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBitmapLock::GetPixelFormat(enum DXGI_FORMAT *this, enum DXGI_FORMAT *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      v2 = -2003292412;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2003292412, 0xD5u);
    }
  }
  else
  {
    v2 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0xD3u);
  }
