/*
 * XREFs of ?_CollectExcludedImmersiveWindows@CLivePreview@@AEAAJAEAV?$DynArray@PEAVCWindowData@@$0A@@@@Z @ 0x180068E6C
 * Callers:
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      if ( v11 == *v9 )
      {
        ...
        {
          if ( (BYTE4(v18[34].Blink) & 1) == 0 && ((__int64)v18[34].Blink & 1) != 0 )
            break;
        }
      }
      ++v10;
    ...
    {
LABEL_19:
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x2C7u);
      return v5;
    }
LABEL_16:
    Flink = Flink->Flink;
