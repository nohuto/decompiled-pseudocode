/*
 * XREFs of ?OnTextTether@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_TETHERTEXTCONTACT@@@Z @ 0x180080170
 * Callers:
  ...
  if ( v16 )
  {
    ...
    *(_BYTE *)(v9 + *((_QWORD *)this + 7) + 104) = 0;
    if ( *((_BYTE *)this + 324) || *(_DWORD *)(v9 + *((_QWORD *)this + 7) + 40) )
    {
      ...
      if ( *((_BYTE *)this + 324) )
        v21 = (unsigned int)CContactManager::DWMSC_PRESENTATIONMODE;
      else
        v21 = *(unsigned int *)(v9 + *((_QWORD *)this + 7) + 40);
