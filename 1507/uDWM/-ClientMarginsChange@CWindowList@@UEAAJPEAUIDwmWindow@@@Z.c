/*
 * XREFs of ?ClientMarginsChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18002D8E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v26, 0x607u);
  if ( v6 < 0 )
  {
LABEL_34:
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x94Fu);
    goto LABEL_10;
  }
  if ( v5 )
  {
    ...
    *((_DWORD *)v5 + 67) = v8;
    ...
    if ( *((_DWORD *)v5 + 16) != (_DWORD)v27
      ...
      || *((_DWORD *)v5 + 24) != v16 )
    {
      v18 = (CVisual *)*((_QWORD *)v5 + 46);
      *((_DWORD *)v5 + 24) = v16;
      *((_OWORD *)v5 + 4) = v27;
      if ( v18 )
        CVisual::SetDirtyFlags(v18, 0x2000);
      v19 = (CWindowIconic *)*((_QWORD *)v5 + 49);
      if ( v19 )
        CWindowIconic::UpdateSizeOrMargins(v19, 0);
      for ( i = 0; i < *((_DWORD *)v5 + 124); ++i )
      {
        v22 = *(CThumbnailVisual **)(*(_QWORD *)(*((_QWORD *)v5 + 59) + 8LL * i) + 88LL);
        if ( v22 )
        {
          v23 = *((_QWORD *)v22 + 44);
          if ( v23 )
      ...
      if ( *((_DWORD *)v5 + 116) )
      {
        do
        {
          v21 = *(CThumbnailVisual **)(*(_QWORD *)(*((_QWORD *)v5 + 55) + 8LL * v4) + 88LL);
          if ( v21 )
            CThumbnailVisual::SetDirtyFlags(v21, 4096);
          ++v4;
        }
        while ( v4 < *((_DWORD *)v5 + 116) );
      }
    }
  }
LABEL_10:
