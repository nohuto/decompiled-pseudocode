/*
 * XREFs of ?StopActivity@CloneWindow@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x180007270
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::CloneWindow::StopActivity(WindowFrameLoggingTelemetry::CloneWindow *this)
{
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v5 + 40) > 5u )
    {
      ...
      v61 = 4;
      TlgCreateSz(&v63, v21);
      TlgWrite(v22, &unk_1800A78D5, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &v30);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v69 = 4;
      v68 = &v24;
      TlgWrite(v6, &unk_1800A79FB, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
