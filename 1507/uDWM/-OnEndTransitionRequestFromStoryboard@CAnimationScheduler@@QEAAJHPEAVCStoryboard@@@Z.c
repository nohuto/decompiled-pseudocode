/*
 * XREFs of ?OnEndTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEAVCStoryboard@@@Z @ 0x18000C080
 * Callers:
        ...
        struct CStoryboard *a3)
{
  ...
  if ( (int)v9 >= 0 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800AAB08, 1LL, v11, 0x130u);
    }
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, &dword_1800AAB08, 1LL, v13, 0x133u);
    }
LABEL_21:
