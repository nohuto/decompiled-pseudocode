/*
 * XREFs of ?_RemoveBorderShadowAtlas@CAccent@@IEAAJXZ @ 0x180035748
 * Callers:
...
__int64 __fastcall CAccent::_RemoveBorderShadowAtlas(CAccent *this)
{
  ...
  if ( v1 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x433u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x432u);
    }
  }
  return v2;
}
