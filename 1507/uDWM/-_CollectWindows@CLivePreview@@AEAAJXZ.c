/*
 * XREFs of ?_CollectWindows@CLivePreview@@AEAAJXZ @ 0x180068FE4
 * Callers:
...
LABEL_14:
    ...
    {
      v14 = (const wchar_t **)off_1800AA560;
      while ( 1 )
      {
...
LABEL_29:
      v16 = v12;
    *(_BYTE *)(Blink + 554) = v17 ^ (v17 ^ (v16 << 6)) & 0x40;
LABEL_31:
    v19 = *(_BYTE *)(Blink + 554);
    if ( v19 < 0 && (v19 & 0x40) != 0 )
    {
      ...
      if ( v21 < 0xA )
      {
        ...
        *((_DWORD *)this + 139) = v21 + 1;
        ...
        while ( 1 )
        {
          ...
          if ( *(char *)(v23 + 554) >= 0 && *(_DWORD *)(v23 + 112) == v12 )
          {
...
LABEL_68:
  ...
  v3 = -2147024362;
LABEL_71:
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v33, 0x154u);
LABEL_72:
