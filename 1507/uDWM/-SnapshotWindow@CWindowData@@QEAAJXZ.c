/*
 * XREFs of ?SnapshotWindow@CWindowData@@QEAAJXZ @ 0x180018458
 * Callers:
...
__int64 __fastcall CWindowData::SnapshotWindow(CWindowData *this)
{
  ...
  {
    if ( IdealWindowRepresentationType || (*((_BYTE *)this + 556) & 0x20) != 0 || !*((_DWORD *)this + 134) )
      goto LABEL_12;
    while ( 1 )
    {
      v15 = *(CWindowData **)(*((_QWORD *)this + 64) + 8LL * v1);
      if ( (unsigned int)CWindowData::GetIdealWindowRepresentationType(v15) == 1 )
        break;
      if ( ++v1 >= *((_DWORD *)this + 134) )
        goto LABEL_12;
    }
    v4 = v15;
  }
  if ( v4 )
  {
    ...
    if ( v4 )
    {
      v6 = (struct CTopLevelWindow *)*((_QWORD *)v4 + 46);
      if ( v6 )
      {
        v7 = CWindowSnapshot::Create(v6, (struct CWindowSnapshot **)this + 48);
        v3 = v7;
        if ( v7 < 0 )
        {
          v14 = 7931;
...
LABEL_12:
  ...
  if ( (v8 & 0x20) != 0 )
  {
    v12 = (CWindowSnapshot *)*((_QWORD *)this + 48);
    if ( !v12 || (*((_DWORD *)v4 + 38) & 0xFFFFFFFB) != 0 || (*((_DWORD *)v4 + 39) & 0x400) != 0 )
    {
      *((_BYTE *)this + 556) = v8 | 0x40;
      return v3;
    }
...
LABEL_34:
  ...
  if ( *((_DWORD *)this + 134) )
  {
    while ( 1 )
    {
      v10 = *(CWindowData **)(*((_QWORD *)this + 64) + 8LL * v9);
