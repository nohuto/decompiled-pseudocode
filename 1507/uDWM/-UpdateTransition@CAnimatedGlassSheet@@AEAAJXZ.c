/*
 * XREFs of ?UpdateTransition@CAnimatedGlassSheet@@AEAAJXZ @ 0x18007C094
 * Callers:
 ...
 *     ?InterpolateValueLinear@CAnimatedGlassSheet@@AEAAJJJM@Z @ 0x18007BADC (-InterpolateValueLinear@CAnimatedGlassSheet@@AEAAJJJM@Z.c)
