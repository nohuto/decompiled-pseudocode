/*
 * XREFs of ?AddToStoryboard@CAnimationEngine@@AEAAJPEAUIUIAnimationStoryboard2@@IIW4TransformAttribute@1@NNPEAN2IPEAUTA_TIMINGFUNCTION@@W4TransformMode@@22I@Z @ 0x180031840
 * Callers:
        ...
        unsigned int a15)
{
  ...
  int v32; // eax
  int v33; // eax
  struct __MIDL___MIDL_itf_UIAnimation_0000_0002_0003 *v34; // [rsp+80h] [rbp-41h]
  char v35; // [rsp+88h] [rbp-39h]
  __int64 v36; // [rsp+90h] [rbp-31h] BYREF
  __int64 v37; // [rsp+98h] [rbp-29h] BYREF
  struct IUIAnimationTransition2 *v38; // [rsp+A0h] [rbp-21h] BYREF
  ...
  else
  {
    ...
    if ( !*(_QWORD *)v19 )
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v21, 0x4BBu);
        goto LABEL_14;
      }
      v35 = 1;
      if ( a13 && a15 < a10 )
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v23, 0x4C5u);
      goto LABEL_14;
    }
    if ( a6 > v19[1] )
    {
      ...
      if ( v29 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v29, 0x4CAu);
        goto LABEL_14;
      }
      ...
      if ( v30 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v30, 0x4CBu);
        goto LABEL_14;
      }
      v19[1] = a6;
    }
    if ( !v35 )
    {
      ...
      if ( v31 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v31, 0x4D3u);
        goto LABEL_14;
      }
      ...
      if ( v32 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v32, 0x4D4u);
        goto LABEL_14;
      }
    }
    if ( (a13 || a14) && *(_DWORD *)a11 == 1 )
    {
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v33, 0x4F1u);
        goto LABEL_14;
      }
LABEL_13:
      v19[1] = v25 + v19[1];
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v26, 0x4DAu);
    }
    else
    {
      ...
      if ( v27 >= 0 )
        goto LABEL_13;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v27, 0x4DDu);
    }
  }
LABEL_14:
  if ( v36 )
