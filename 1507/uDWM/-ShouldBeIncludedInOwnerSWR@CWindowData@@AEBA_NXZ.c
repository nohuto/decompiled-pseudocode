/*
 * XREFs of ?ShouldBeIncludedInOwnerSWR@CWindowData@@AEBA_NXZ @ 0x180018A14
 * Callers:
...
char __fastcall CWindowData::ShouldBeIncludedInOwnerSWR(CWindowData *this)
{
  ...
  if ( (*((_BYTE *)this + 552) & 1) != 0
    ...
    && (*((char *)this + 104) >= 0 || (*((_DWORD *)this + 142) & 0xFFF) == 0x11) )
  {
    if ( *((_QWORD *)this + 4) )
    {
      v4 = (CWindowData *)*((_QWORD *)this + 63);
      if ( v4 )
      {
        v5 = CWindowData::WillEndAnimationCloaked(v4);
        if ( CWindowData::WillEndAnimationCloaked(this) == v5
          && ContainsRect((const struct tagRECT *)(*((_QWORD *)this + 63) + 48LL), (const struct tagRECT *)this + 3) )
        {
