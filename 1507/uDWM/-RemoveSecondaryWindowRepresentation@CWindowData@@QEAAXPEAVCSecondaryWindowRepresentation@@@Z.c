/*
 * XREFs of ?RemoveSecondaryWindowRepresentation@CWindowData@@QEAAXPEAVCSecondaryWindowRepresentation@@@Z @ 0x180017AFC
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (CWindowData *)v6 != this )
  {
    ...
    DynArray<CSecondaryWindowRepresentation *,0>::Remove((char *)this + 400, &v7);
  }
  LOBYTE(a4) = 1;
