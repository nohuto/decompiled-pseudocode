/*
 * XREFs of ?_FadeWindow@CFade@@IEAAJPEAVCWindowData@@_N@Z @ 0x1800012D4
 * Callers:
...
__int64 __fastcall CFade::_FadeWindow(CFade *this, struct CWindowData *a2, char a3)
{
  ...
  if ( v4 )
    ...
    IsWindowTrackedAndCloakChanged = (*((_BYTE *)a2 + 556) & 1) == 0
                                  && a3 == CTransitionVisualController::HasVisibleStyle(*((HWND *)a2 + 5));
  v8 = CImmersiveState::Create(&v28, *((_QWORD *)a2 + 15));
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v8, 0x1E6u);
    goto LABEL_20;
  }
...
LABEL_10:
  ...
  if ( (v13 & 0x20000) != 0 )
  {
    ...
    v16 = (*(__int64 (__fastcall **)(CFade *, _QWORD))(*(_QWORD *)this + 88LL))(this, *((unsigned int *)a2 + 142));
...
LABEL_13:
      v19 = *((_DWORD *)a2 + 142);
      if ( (v19 & 0x1000000) != 0 )
        v29 = *(struct tagRECT *)((char *)a2 + 588);
      if ( (v19 & 0x800000) != 0 )
        v20 = (struct tagRECT *)((char *)a2 + 588);
      else
        v20 = &v29;
      v21 = *v20;
    ...
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v17, 0x205u);
  }
  else
  {
    ...
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v26, 0x209u);
  }
  v18 = (CAnimatedTransitionVisual **)v27;
LABEL_18:
  if ( v18 )
