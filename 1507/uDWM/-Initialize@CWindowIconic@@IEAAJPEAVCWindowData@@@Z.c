/*
 * XREFs of ?Initialize@CWindowIconic@@IEAAJPEAVCWindowData@@@Z @ 0x18003A7BC
 * Callers:
...
LABEL_45:
  ...
  *(_BYTE *)(*((_QWORD *)this + 10) + 553LL) |= 0x10u;
  ...
  *(_DWORD *)(*((_QWORD *)this + 10) + 128LL) = v9;
  ...
  if ( !*((_BYTE *)this + 20) )
  {
    inserted = CWindowIconic::SetBitmap(
                 this,
                 *(struct CBitmapSource **)(*((_QWORD *)this + 9) + 360LL),
                 (*(_BYTE *)(*((_QWORD *)this + 9) + 554LL) & 2) != 0,
                 0);
    v6 = inserted;
    if ( inserted < 0 )
    {
