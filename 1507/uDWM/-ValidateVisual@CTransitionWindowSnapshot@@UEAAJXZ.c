/*
 * XREFs of ?ValidateVisual@CTransitionWindowSnapshot@@UEAAJXZ @ 0x1800115D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    v10 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0xABu);
    goto LABEL_12;
  }
  if ( *((_DWORD *)this + 64) )
  {
LABEL_10:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0xA4u);
    v3 = v15;
  }
  else
  {
    ...
    if ( v12 >= 0 )
      goto LABEL_10;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0xA5u);
  }
LABEL_12:
  if ( v3 )
