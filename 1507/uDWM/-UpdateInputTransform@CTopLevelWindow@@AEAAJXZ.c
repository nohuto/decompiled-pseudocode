/*
 * XREFs of ?UpdateInputTransform@CTopLevelWindow@@AEAAJXZ @ 0x18001F3FC
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateInputTransform(CTopLevelWindow *this)
{
  ...
  if ( *(_QWORD *)(v1 + 40) )
  {
    ...
    if ( (*((_BYTE *)this + 264) & 1) == 0 || !v4 )
    {
      ...
      v11 = *((_QWORD *)this + 93);
      v12 = *(_DWORD *)(v11 + 304);
      if ( v12 || *(_DWORD *)(v11 + 308) )
      {
        v13 = _mm_cvtsi32_si128(*(_DWORD *)(v11 + 308));
        v26 = 0;
        v24 = 0;
        v23 = 0;
        v22 = 0;
      ...
      if ( (dword_1800BD414 & 1) == 0 )
      {
        dword_1800BD360 = -2147024891;
        dword_1800BD414 |= 1u;
        dword_1800BD364 = -2147023496;
        dword_1800BD368 = -2147024809;
      }
      SetLastError(0);
      ...
      else
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, &dword_1800BD360, 3LL, v2, 0x14B2u);
      }
