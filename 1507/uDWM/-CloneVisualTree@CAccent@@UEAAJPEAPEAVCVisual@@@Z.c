/*
 * XREFs of ?CloneVisualTree@CAccent@@UEAAJPEAPEAVCVisual@@@Z @ 0x180035CA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAccent::CloneVisualTree(CAccent *this, struct CVisual **a2)
{
  ...
  CAccent *v15; // [rsp+50h] [rbp+8h] BYREF
...
LABEL_9:
    ...
    *((_BYTE *)v7 + 351) = 1;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x25Du);
    }
    else
    {
      ...
      *((_DWORD *)v7 + 67) = *((_DWORD *)this + 67);
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x260u);
      }
      else
      {
        ...
        if ( updated < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x261u);
        }
        else
        {
          ...
          if ( v12 >= 0 )
            goto LABEL_9;
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x262u);
        }
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x255u);
  }
LABEL_12:
  if ( v7 )
