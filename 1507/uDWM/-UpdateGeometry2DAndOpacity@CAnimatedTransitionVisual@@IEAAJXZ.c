/*
 * XREFs of ?UpdateGeometry2DAndOpacity@CAnimatedTransitionVisual@@IEAAJXZ @ 0x180037E34
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::UpdateGeometry2DAndOpacity(CAnimatedTransitionVisual *this)
{
  ...
  *(float *)&v77[1] = v21;
  ...
  if ( v45 >= 0.0000011920929
    || (v63 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 185)) & _xmm), v63 >= 0.0000011920929)
    || (v64 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v37) & _xmm), v64 >= 0.0000011920929)
    || (v65 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(v38) & _xmm), v65 >= 0.0000011920929) )
  {
    v46 = *((float *)this + 185) - v38;
    v8 = 1;
    v78[0] = v44 - v37;
    v78[1] = v46;
  }
  ...
  *(double *)&v85 = v101;
  v86 = v102;
  v51 = CResource::Send(v50, &v79, 0x38u);
  v52 = v51;
  if ( v51 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v51, 0x56Bu);
    return v52;
  }
  v53 = CPushTransformInstruction::Create(*((struct CResource **)this + 39), &v72);
  v52 = v53;
  if ( v53 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v53, 0x56Du);
    v9 = v72;
  }
  else
  {
    v9 = v72;
    v54 = CVisual::AddInstruction(v1, v72);
    v52 = v54;
    if ( v54 >= 0 )
    {
LABEL_29:
      v55 = (struct CResource *)*((_QWORD *)this + 73);
      if ( !v55 )
        v55 = (struct CResource *)*((_QWORD *)this + 71);
      v56 = CDrawTileImageInstruction::Create(
              v55,
              &v76,
      ...
      if ( v56 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v56, 0x578u);
      }
      else
      {
        v58 = CVisual::AddInstruction(v1, v75);
        v52 = v58;
        if ( v58 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v58, 0x579u);
        }
        else
        {
          v59 = CAnimatedTransitionVisual::_AddOcclusionInstruction(this, &v76);
          v52 = v59;
          if ( v59 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v59, 0x57Au);
          }
          else if ( v9 )
          {
            v60 = CPopInstruction::Create(&v73);
            v52 = v60;
            if ( v60 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v60, 0x57Eu);
              v10 = v73;
            }
            else
            {
              v10 = v73;
              v61 = CVisual::AddInstruction(v1, v73);
              v52 = v61;
              if ( v61 < 0 )
                MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v61, 0x57Fu);
            }
          }
        }
      }
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v54, 0x56Eu);
  }
LABEL_40:
  if ( v9 )
