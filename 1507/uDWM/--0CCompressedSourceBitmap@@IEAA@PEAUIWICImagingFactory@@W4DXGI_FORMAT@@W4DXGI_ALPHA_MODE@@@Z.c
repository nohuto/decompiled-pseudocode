/*
 * XREFs of ??0CCompressedSourceBitmap@@IEAA@PEAUIWICImagingFactory@@W4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@@Z @ 0x18003E7E4
 * Callers:
 ...
 * Callees:
 *     ??0CBitmap@@QEAA@XZ @ 0x18003EB0C (--0CBitmap@@QEAA@XZ.c)
