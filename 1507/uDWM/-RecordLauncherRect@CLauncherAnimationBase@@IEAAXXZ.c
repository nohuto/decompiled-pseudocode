/*
 * XREFs of ?RecordLauncherRect@CLauncherAnimationBase@@IEAAXXZ @ 0x1800047C8
 * Callers:
...
void __fastcall CLauncherAnimationBase::RecordLauncherRect(CLauncherAnimationBase *this)
{
  ...
  {
    v2 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 25);
