/*
 * XREFs of ?EnsureThumbnailVisual@CThumbnailData@@UEAAJXZ @ 0x180012000
 * Callers:
...
__int64 __fastcall CThumbnailData::EnsureThumbnailVisual(CThumbnailData *this)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x20EFu);
    goto LABEL_5;
  }
...
LABEL_5:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x20F1u);
LABEL_6:
  if ( v4 )
