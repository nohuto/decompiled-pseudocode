/*
 * XREFs of ??$ForEachOwnedWindow@V_lambda_bd0cd9c08f34eb6c962feef2ce577fa6_@@@CTransitionVisualController@@KAJPEBVCWindowData@@AEBV_lambda_bd0cd9c08f34eb6c962feef2ce577fa6_@@_N@Z @ 0x180001928
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 568) & 0x10000000) != 0 )
  {
    ...
    if ( !v5 || (*(_BYTE *)(v5 + 264) & 0x18) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 536); i = (unsigned int)(i + 1) )
      {
        if ( v3 < 0 )
          break;
        v7 = *(_QWORD *)(*(_QWORD *)(a1 + 512) + 8 * i);
        if ( (*(_DWORD *)(v7 + 568) & 0xFFF) == 0xFFF )
        {
          v3 = 0;
          if ( *(_QWORD *)(v7 + 368) )
          {
            if ( CTransitionVisualController::ShouldCloneWindow(*(HWND *)(v7 + 40)) )
              v3 = CVisual::RenderRecursive(*(CVisual **)(v7 + 368));
            a2 = v9;
          }
          if ( v3 >= 0 )
