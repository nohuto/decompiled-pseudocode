/*
 * XREFs of ?_WindowEnumCallback@CAppSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180095DE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x180090B70 (-GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
char __fastcall CAppSwitch::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, _DWORD *a4)
{
  ...
  switch ( v8 )
  {
    case 2u:
      ...
      if ( v11 )
        v9 = (struct tagRECT *)(a2 + 572);
      PVLTarget = CAppSwitch::GetPVLTarget(a1, *(_DWORD *)(a2 + 568));
    ...
    case 3u:
      ...
      if ( *(_BYTE *)(a1 + 168) )
        ...
        v17 = CAppSwitch::GetPVLTarget(a1, *(_DWORD *)(a2 + 568));
      if ( v11 )
      {
        v14 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(
                (CStoryboard *)a1,
    ...
    case 0x16u:
      ...
      if ( *(_BYTE *)(a1 + 168) )
        ...
        v16 = CAppSwitch::GetPVLTarget(a1, *(_DWORD *)(a2 + 568));
      v14 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(
              (CStoryboard *)a1,
              (struct CWindowData *)a2,
              0,
    ...
    case 0x1Cu:
      if ( *(_BYTE *)(a1 + 168) )
        ...
        v15 = CAppSwitch::GetPVLTarget(a1, *(_DWORD *)(a2 + 568));
      if ( v11 )
      {
        v14 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(
                (CStoryboard *)a1,
      ...
      if ( v8 <= 0x1C )
      {
        ...
        if ( _bittest(&v23, v8) )
        {
          ...
          *(struct tagRECT *)(v25 + 856) = rc;
          ...
          if ( v8 - 2 <= 1 )
            lambda_c5b80c29b716117d9c8fc9ac03427231_::operator()((__int64)&v33, (CAnimatedTransitionVisual **)v22);
          if ( (*(_DWORD *)(a2 + 568) & 0x18000) != 0 )
          {
            CGroupingStoryboard::_CreateGuttersForApp((CStoryboard *)a1, a2, &v35, &rc.left, v8, &v31, &v29);
            v10 = (CAnimatedTransitionVisual **)v31;
            if ( v31 )
              lambda_c5b80c29b716117d9c8fc9ac03427231_::operator()((__int64)&v33, (CAnimatedTransitionVisual **)v31);
            v26 = v29;
            if ( v29 )
              lambda_c5b80c29b716117d9c8fc9ac03427231_::operator()((__int64)&v33, v10);
            goto LABEL_80;
          }
        }
      }
...
LABEL_80:
      ...
      goto LABEL_85;
    case 0x2Bu:
      v13 = CAppSwitch::GetPVLTarget(a1, *(_DWORD *)(a2 + 568));
