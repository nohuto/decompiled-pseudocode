/*
 * XREFs of ?OnModifyWindowFilterList@CMagnifier@@QEAAJPEBUMAGN_FILTERLIST@@@Z @ 0x1800722C4
 * Callers:
...
__int64 __fastcall CMagnifier::OnModifyWindowFilterList(CMagnifier *this, const struct MAGN_FILTERLIST *a2)
{
  ...
  if ( (dword_1800BD3FC & 1) == 0 )
  {
    dword_1800BD338 = -2147023728;
    dword_1800BD3FC |= 1u;
  }
  if ( *((_QWORD *)this + 7)
    || (v6 = CResource::Create(0x48u, *((_QWORD *)this + 2), (CBaseObject **)this + 7), v7 = v6, v6 >= 0) )
  {
    if ( !v3 || *(_DWORD *)a2 == 1 && *((_QWORD *)this + 8) == *((_QWORD *)a2 + 1) )
    {
      ...
      v7 = v24;
      if ( v24 < 0 )
        MilInstrumentationCheckHR(0x14u, &dword_1800BD338, 1LL, v24, 0x10Bu);
    }
    else
    {
      memset_0(&i, 0, 0x74uLL);
      v8 = 0LL;
      for ( i = 90; (unsigned int)v8 < *(_DWORD *)a2; v8 = (unsigned int)(v8 + 1) )
      {
      ...
      if ( (unsigned int)v8 < v3 )
      {
        ...
        while ( (unsigned int)v8 < 0x19 )
        {
          if ( *((_QWORD *)this + 8) != *v13 )
          {
            ...
            {
              v7 = -2147023728;
              MilInstrumentationCheckHR(0x14u, &dword_1800BD338, 1LL, -2147023728, 0x144u);
              return v7;
            }
      ...
      if ( v19 >= 0 )
      {
        ...
        v7 = v22;
        if ( v22 < 0 )
          MilInstrumentationCheckHR(0x14u, &dword_1800BD338, 1LL, v22, 0x160u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, &dword_1800BD338, 1LL, v19, 0x15Bu);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, &dword_1800BD338, 1LL, v6, 0x101u);
  }
  return v7;
}
