/*
 * XREFs of ?SettingsChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYSETTINGSCHANGE@@@Z @ 0x18002A30C
 * Callers:
        ...
        const struct MILCMD_DWM_REDIRECTION_NOTIFYSETTINGSCHANGE *a2)
{
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x1683u);
  }
  else
  {
    v6 = (struct _RTL_GENERIC_TABLE *)((char *)this + 8);
    v7 = (__int64 *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 29);
    while ( 1 )
    {
      ...
      for ( i = (char *)v8[8]; i != v10; i = *(char **)i )
      {
        ...
        v12 = (CTopLevelWindow *)*((_QWORD *)i + 46);
        if ( v12 )
