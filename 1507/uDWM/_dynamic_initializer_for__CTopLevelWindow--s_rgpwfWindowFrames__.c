/*
 * XREFs of _dynamic_initializer_for__CTopLevelWindow::s_rgpwfWindowFrames__ @ 0x180001090
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$DynArray@PEAUWindowFrame@CTopLevelWindow@@$0A@@@QEAA@XZ @ 0x180045ADC (--0-$DynArray@PEAUWindowFrame@CTopLevelWindow@@$0A@@@QEAA@XZ.c)
 */
