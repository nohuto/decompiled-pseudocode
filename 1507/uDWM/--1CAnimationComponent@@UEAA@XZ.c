/*
 * XREFs of ??1CAnimationComponent@@UEAA@XZ @ 0x1800106CC
 * Callers:
  ...
  if ( v2 )
  {
    ...
    if ( !CAnimationScheduler::IsWindowCurrentlyAnimating(
            *((CAnimationScheduler **)CDesktopManager::s_pDesktopManagerInstance + 24),
            ...
            0) )
    {
      v5 = (CTransitionVisualController *)*((_QWORD *)v3 + 25);
      WindowDataByHwnd = CWindowList::FindWindowDataByHwnd(*((CWindowList **)v3 + 167), v4);
      if ( WindowDataByHwnd )
