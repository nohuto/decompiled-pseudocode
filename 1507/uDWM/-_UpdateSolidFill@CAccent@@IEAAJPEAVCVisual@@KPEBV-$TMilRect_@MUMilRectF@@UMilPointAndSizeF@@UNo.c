/*
 * XREFs of ?_UpdateSolidFill@CAccent@@IEAAJPEAVCVisual@@KPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@M@Z @ 0x180035990
 * Callers:
...
__int64 __fastcall CAccent::_UpdateSolidFill(_DWORD *a1, CVisual *a2, int a3, struct tagRECT *a4, int a5)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x3C9u);
  }
  else
  {
    ...
    *((float *)&v27 + 2) = GammaLUT_sRGB_to_scRGB[BYTE2(a3)] / 255.0;
      ...
      while ( CDesktopManager::GetMonitorRectAtIndex(v17, &v26) )
      {
        if ( v26.left || v26.top || (a1[67] & 8) == 0 )
        {
          ...
          if ( v26.right - v26.left < 0 )
            v19 = 0;
          v20 = _mm_cvtsi32_si128(v26.top - a1[143]);
          ...
          *((float *)&v27 + 3) = _mm_cvtepi32_ps(v21).m128_f32[0] + *((float *)&v27 + 1);
          ...
          if ( v23 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v23, 0x3ECu);
            goto LABEL_27;
          }
          v8 = v25;
          ...
          *((_OWORD *)v8 + 1) = v16;
          ...
          if ( v24 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v24, 0x3EFu);
            break;
          }
        }
        ++v17;
    ...
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x3F4u);
LABEL_27:
        v8 = v25;
      }
      else
      {
        ...
        *((_OWORD *)v8 + 1) = v27;
        ...
        v10 = v14;
        if ( v14 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x3F7u);
      }
    }
    if ( v8 )
