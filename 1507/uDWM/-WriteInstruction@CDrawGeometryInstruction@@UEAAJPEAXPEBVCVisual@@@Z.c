/*
 * XREFs of ?WriteInstruction@CDrawGeometryInstruction@@UEAAJPEAXPEBVCVisual@@@Z @ 0x180014B70
 * Callers:
        ...
        const struct CVisual *a3)
{
  ...
  v3 = *(_QWORD *)this;
  v7 = 0;
  (*(void (__fastcall **)(CDrawGeometryInstruction *, int *, const struct CVisual *))(v3 + 8))(this, &v7, a3);
  *a2 = v7 + 4;
  a2[1] = 209;
