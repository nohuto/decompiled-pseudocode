/*
 * XREFs of ?_Ensure3DRenderData@CAnimatedTransitionVisual@@IEAAJXZ @ 0x180089BB8
 * Callers:
  ...
  if ( !*((_DWORD *)this + 66) )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( v10 >= 0 )
      {
          ...
          if ( v14 >= 0 )
          {
            ...
            if ( v16 >= 0 )
            {
              ...
              if ( v17 >= 0 )
              {
                ...
                v1 = v18;
                if ( v18 < 0 )
                  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v18, 0x668u);
              }
              else
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v17, 0x667u);
                v2 = v21;
              }
            }
            else
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x664u);
            }
          }
          else
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x663u);
          }
          if ( v15 )
        ...
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x661u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x660u);
      }
      if ( v20 )
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x65Fu);
    }
  }
  return v1;
}
