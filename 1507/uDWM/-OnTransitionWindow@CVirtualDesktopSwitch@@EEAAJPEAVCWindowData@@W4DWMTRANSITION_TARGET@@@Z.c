/*
 * XREFs of ?OnTransitionWindow@CVirtualDesktopSwitch@@EEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@@Z @ 0x180091EC0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( *(_DWORD *)(a1 + 176) )
      {
        while ( 1 )
        {
          ...
          if ( v9 + 1 < v9 )
          {
            ...
            v3 = -2147024362;
LABEL_30:
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v12, 0x1341u);
            goto LABEL_22;
          }
      ...
      {
LABEL_19:
        DesktopThumbnail = MilChannel_CommitChannel(*((struct MIL_CHANNEL__ **)CDesktopManager::s_pDesktopManagerInstance
                                                    + 4));
        v3 = DesktopThumbnail;
        if ( DesktopThumbnail >= 0 )
          goto LABEL_22;
...
LABEL_22:
  ...
  if ( v3 >= 0 )
    v3 = -2003304445;
  MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v3, 0x1338u);
LABEL_24:
  if ( v17 )
