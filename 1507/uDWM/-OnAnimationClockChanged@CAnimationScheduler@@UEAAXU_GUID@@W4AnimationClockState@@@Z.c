/*
 * XREFs of ?OnAnimationClockChanged@CAnimationScheduler@@UEAAXU_GUID@@W4AnimationClockState@@@Z @ 0x18000BB40
 * Callers:
        ...
        if ( v10 )
        {
          ...
          else
          {
            for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 32); i = (unsigned int)(i + 1) )
            {
              ...
              v27 = *(_OWORD *)(v14 + 48);
              v15 = v27 - *(_QWORD *)&a2->Data1;
              if ( (_QWORD)v27 == *(_QWORD *)&a2->Data1 )
                v15 = *((_QWORD *)&v27 + 1) - *(_QWORD *)a2->Data4;
              if ( !v15 )
