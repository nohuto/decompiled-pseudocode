/*
 * XREFs of ?SendSwitchModeCommand@CDesktopManager@@SAJ_K@Z @ 0x180008C3C
 * Callers:
...
__int64 __fastcall CDesktopManager::SendSwitchModeCommand(unsigned __int64 a1)
{
  ...
  *((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 26) = 0;
  if ( GetSystemMetrics(4096) )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0xBAu);
      return v3;
    }
    v7 = (**v5)(v5, 2LL, &v8);
    v3 = v7;
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0xBBu);
      return v3;
    }
    if ( v9[0] )
    {
  ...
  v3 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v2, 0xCEu);
  return v3;
}
