/*
 * XREFs of ?_UpdateAnimated3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008A29C
 * Callers:
 ...
 *     ?D2DMatrixRotationYawPitchRoll@@YAPEAUD2DMatrix@@PEAU1@MMM@Z @ 0x18009D774 (-D2DMatrixRotationYawPitchRoll@@YAPEAUD2DMatrix@@PEAU1@MMM@Z.c)
 *     ?D3DXVec3TransformCoord@@YAPEAUD2DVector3@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z @ 0x18009D82C (-D3DXVec3TransformCoord@@YAPEAUD2DVector3@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z.c)
 */
      ...
      *(double *)((char *)&v73 + 4) = v51;
      ...
      if ( v53 >= 0 )
        *((_DWORD *)this + 183) = *((_DWORD *)this + 182);
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v53, 0x713u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v49, 0x70Au);
  }
  return v50;
}
