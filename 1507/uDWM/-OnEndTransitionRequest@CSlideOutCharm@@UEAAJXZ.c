/*
 * XREFs of ?OnEndTransitionRequest@CSlideOutCharm@@UEAAJXZ @ 0x18000FF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSlideOutCharm::OnEndTransitionRequest(CSlideOutCharm *this)
{
  ...
  if ( *(_DWORD *)(v4 + 40) )
  {
    do
    {
      ...
      if ( *(_DWORD *)(v5 + 24) != 4 && *(_DWORD *)(v5 + 72) == 73 )
      {
        v11 = *(_DWORD *)(v5 + 112);
        v12 = 0LL;
        if ( v11 )
...
LABEL_4:
  ...
  *((_QWORD *)this + 16) = v1;
  ...
  CAnimationScheduler::AbandonTransition(*((CAnimationScheduler **)CDesktopManager::s_pDesktopManagerInstance + 24), 5);
  v7 = 0LL;
  ...
  if ( *(_DWORD *)(v8 + 40) )
  {
    do
    {
      ...
      if ( *(_DWORD *)(v9 + 24) == 3 && *(_DWORD *)(v9 + 72) == 72 )
      {
