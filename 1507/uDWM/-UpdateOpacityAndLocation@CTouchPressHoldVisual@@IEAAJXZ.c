/*
 * XREFs of ?UpdateOpacityAndLocation@CTouchPressHoldVisual@@IEAAJXZ @ 0x18009ACDC
 * Callers:
 ...
 *     ?UpdateTransition@CTouchPressHoldVisual@@MEAAJXZ @ 0x18009B360 (-UpdateTransition@CTouchPressHoldVisual@@MEAAJXZ.c)
 * Callees:
