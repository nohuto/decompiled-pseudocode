/*
 * XREFs of ?InsertAt@?$DynArray@PEAVCAtlasedImage@@$0A@@@QEAAJAEBQEAVCAtlasedImage@@I@Z @ 0x18003713C
 * Callers:
...
__int64 __fastcall DynArray<CAtlasedImage *,0>::InsertAt(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      v9 = v13;
      v10 = (_QWORD *)(v7 + 8 * v4);
      if ( v13 >= v10 && (unsigned __int64)v13 < v7 + 8 * ((unsigned __int64)*(unsigned int *)(a1 + 24) - 1) )
        v9 = v13 + 1;
      *v10 = *v9;
    }
  }
