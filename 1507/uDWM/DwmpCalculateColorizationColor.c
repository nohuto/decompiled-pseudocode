/*
 * XREFs of DwmpCalculateColorizationColor @ 0x180041068
 * Callers:
 *     ?ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z @ 0x18003F900 (-ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z.c)
 * Callees:
...
__int64 __fastcall DwmpCalculateColorizationColor(int *a1, int *a2)
{
  ...
  if ( v10 <= 0.0 )
    v10 = 0.0;
  v14 = FloatColorChannelToByte(v10) << 8;
  v15 = (FloatColorChannelToByte(v11) | v14) << 8;
  v16 = (FloatColorChannelToByte(v12) | v15) << 8;
  *a2 = FloatColorChannelToByte(v13) | v16;
  return 0LL;
}
