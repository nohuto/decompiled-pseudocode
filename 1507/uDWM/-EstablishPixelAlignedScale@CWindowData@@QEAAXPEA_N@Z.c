/*
 * XREFs of ?EstablishPixelAlignedScale@CWindowData@@QEAAXPEA_N@Z @ 0x180018DF0
 * Callers:
 ...
 *     PixelAligningFactor @ 0x180079114 (PixelAligningFactor.c)
 */
...
void __fastcall CWindowData::EstablishPixelAlignedScale(CWindowData *this, bool *a2)
{
  ...
  v8 = v5;
  v9 = v7;
  if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(*((float *)v3 + 43) - v8)) & _xmm) > 0.0000011920929
    || (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(*((float *)v3 + 44) - v9)) & _xmm) > 0.0000011920929 )
  {
    *((float *)v3 + 43) = v8;
    v4 = 1;
    *((float *)v3 + 44) = v9;
