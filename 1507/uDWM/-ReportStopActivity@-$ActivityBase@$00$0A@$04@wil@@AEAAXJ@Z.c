/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@$00$0A@$04@wil@@AEAAXJ@Z @ 0x180006FA8
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v6 )
    {
        ...
        && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        TlgWrite(v26, &unk_1800A7A63, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
      }
    }
    else
    {
        ...
        && (*((_QWORD *)v27 + 3) & 0x200000000000LL) == *((_QWORD *)v27 + 3) )
      {
        ...
        TlgWrite(v27, &unk_1800A7B6A, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 6u, &v62);
      }
    }
  }
