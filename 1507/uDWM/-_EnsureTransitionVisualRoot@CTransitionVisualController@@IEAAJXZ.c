/*
 * XREFs of ?_EnsureTransitionVisualRoot@CTransitionVisualController@@IEAAJXZ @ 0x18000E93C
 * Callers:
...
__int64 __fastcall CTransitionVisualController::_EnsureTransitionVisualRoot(CTransitionVisualController *this)
{
  ...
  if ( v4 )
  {
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v15, 0x274u);
      goto LABEL_4;
    }
  }
  if ( !*((_QWORD *)this + 1) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v7, 0x279u);
      goto LABEL_19;
    }
    ...
    else
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v17, 0x281u);
        goto LABEL_4;
      }
    }
    *((_QWORD *)this + 1) = v1;
  ...
  if ( !*((_QWORD *)this + 2) )
  {
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v13, 0x288u);
      v2 = (volatile signed __int32 *)v24;
      goto LABEL_4;
    }
    v2 = (volatile signed __int32 *)v24;
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v14, 0x289u);
      goto LABEL_4;
    }
    *((_QWORD *)this + 2) = v2;
    if ( v2 )
