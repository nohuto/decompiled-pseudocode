/*
 * XREFs of ?GetWindowBeginSize@CWindowPropertyTracker@@QEAAJPEAUHWND__@@PEAUtagSIZE@@@Z @ 0x1800978E0
 * Callers:
...
__int64 __fastcall CWindowPropertyTracker::GetWindowBeginSize(
