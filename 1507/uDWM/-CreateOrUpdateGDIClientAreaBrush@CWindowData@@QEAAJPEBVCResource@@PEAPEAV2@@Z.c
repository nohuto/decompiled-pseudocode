/*
 * XREFs of ?CreateOrUpdateGDIClientAreaBrush@CWindowData@@QEAAJPEBVCResource@@PEAPEAV2@@Z @ 0x180077884
 * Callers:
        ...
        struct CResource **a3)
{
  ...
  if ( *((_QWORD *)this + 44) )
  {
    ...
    {
      v31 = CResource::Create(0x47u, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v37);
      v6 = v31;
      if ( v31 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v31, 0x1B46u);
LABEL_40:
        v4 = (volatile signed __int32 *)v37;
LABEL_41:
        if ( v4 )
    ...
    if ( v32 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v32, 0x1B49u);
      goto LABEL_41;
    }
    v33 = *((_DWORD *)this + 86);
    v38 = 37LL;
    ...
    if ( v35 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v35, 0x1B5Fu);
      goto LABEL_41;
    }
  }
  if ( *a3 )
