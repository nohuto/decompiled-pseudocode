/*
 * XREFs of ?SetFont@CTextCache@@QEAAJAEBUtagLOGFONTW@@@Z @ 0x180014928
 * Callers:
 *     ?ValidateResources@CText@@AEAAJXZ @ 0x180016150 (-ValidateResources@CText@@AEAAJXZ.c)
 * Callees:
 *     ?MilInstrumentationCheckHR@@YAXKQEBJIJI@Z @ 0x180004308 (-MilInstrumentationCheckHR@@YAXKQEBJIJI@Z.c)
 *     ?ReleaseFont@CTextCache@@AEAAXXZ @ 0x1800149F8 (-ReleaseFont@CTextCache@@AEAAXXZ.c)
...
__int64 __fastcall CTextCache::SetFont(CTextCache *this, const struct tagLOGFONTW *a2)
{
  ...
  *((_QWORD *)this + 14) = FontIndirectW;
  ...
  else
  {
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v2, 0x4Fu);
  }
  return v2;
}
