/*
 * XREFs of ?StartAnimations@CAnimationEngine@@AEAAJXZ @ 0x18003312C
 * Callers:
...
__int64 __fastcall CAnimationEngine::StartAnimations(CAnimationEngine *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0xD9u);
      goto LABEL_4;
    }
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0xDCu);
      goto LABEL_4;
    }
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0xDDu);
      goto LABEL_4;
    }
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0xE0u);
      goto LABEL_4;
    }
LABEL_3:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0xD6u);
LABEL_4:
  if ( v1 < 0 )
  {
