/*
 * XREFs of ?RegisterIconicRepresentation@CIconicBitmapRegistry@@QEAAJPEAVCWindowIconic@@PEAW4IconicRepresentationType@@@Z @ 0x180030E60
 * Callers:
        ...
        enum IconicRepresentationType *a3)
{
  ...
  if ( *((_BYTE *)a2 + 20) )
  {
    ...
    v10 = *((_BYTE *)this + 90);
    CanAcceptBitmap = *(_BYTE *)(v4 + 554) & 1;
    v11 = *((_BYTE *)this + 88);
    v4 = -1LL;
    v12 = *((_BYTE *)this + 89);
  }
  else
  {
    ...
    v10 = (*(_BYTE *)(v4 + 554) & 8) != 0;
    v11 = *(_QWORD *)(v4 + 360) != 0LL;
    v12 = (*(_BYTE *)(v4 + 554) & 4) != 0;
  }
