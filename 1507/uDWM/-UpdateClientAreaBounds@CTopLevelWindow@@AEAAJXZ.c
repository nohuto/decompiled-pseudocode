/*
 * XREFs of ?UpdateClientAreaBounds@CTopLevelWindow@@AEAAJXZ @ 0x18001F120
 * Callers:
...
LABEL_2:
  if ( v1 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v1, 0x1509u);
  }
  else if ( *v2 )
  {
    v52 = 70;
    ...
    if ( v1 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v1, 0x1521u);
    }
    else
    {
      v21 = *((_QWORD *)this + 93);
      ...
      if ( v1 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v1, 0x1526u);
      }
      else
      {
        ...
        if ( v1 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v1, 0x152Du);
        }
        else
        {
          v30 = *((_QWORD *)this + 100);
          ...
          if ( v30 )
          {
            ...
            *(_QWORD *)&v45.cyTopHeight = 0LL;
            ...
            v1 = v42;
            if ( v42 < 0 )
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v42, 0x17B5u);
          }
          if ( v1 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v1, 0x1530u);
        }
      }
    }
  }
