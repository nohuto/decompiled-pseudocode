/*
 * XREFs of ?StartAnimation@CTopLevelWindow3D@@AEAAJW4WindowAnimationType@1@@Z @ 0x180025A60
 * Callers:
 ...
 *     ?GetFinalMinRect@CTopLevelWindow3D@@SAXPEAUtagRECT@@MPEAUMilPointAndSizeF@@@Z @ 0x180008A64 (-GetFinalMinRect@CTopLevelWindow3D@@SAXPEAUtagRECT@@MPEAUMilPointAndSizeF@@@Z.c)
 ...
 *     ?ConvertTimingFunctionToInterpolationMode@CTopLevelWindow3D@@AEAA?AW4InterpolationMode@@PEAUTA_TIMINGFUNCTION@@@Z @ 0x1800265DC (-ConvertTimingFunctionToInterpolationMode@CTopLevelWindow3D@@AEAA-AW4InterpolationMode@@PEAUTA_T.c)
...
__int64 __fastcall CTopLevelWindow3D::StartAnimation(__int64 a1, unsigned int a2)
{
  ...
  void *(__fastcall *v43)(WPF::ProcessHeapImpl *__hidden, unsigned __int64); // rsi
  float *v44; // rax
  float *v45; // r14
  __int64 v46; // rax
  ...
  void *(__fastcall *v51)(WPF::ProcessHeapImpl *__hidden, unsigned __int64); // rsi
  void *v52; // rax
  __int64 v53; // rax
  int ThemeTimingFunction; // eax
  __int64 v55; // rcx
  void *v56; // rdx
  void (__fastcall *v57)(WPF::ProcessHeapImpl *__hidden, void *); // rsi
  ...
  int v63; // eax
  int v64; // eax
  void (__fastcall *v65)(WPF::ProcessHeapImpl *__hidden, void *); // rsi
  __int64 v66; // rcx
  void *(*v67)(WPF::ProcessHeapImpl *__hidden, unsigned __int64); // rsi
  void *v68; // rax
  _QWORD *v69; // rax
  int v71; // eax
  float v72; // xmm3_4
  ...
  *(_BYTE *)(*(_QWORD *)(a1 + 312) + 555LL) &= ~0x10u;
  *(_DWORD *)(a1 + 352) = a2;
  *(_QWORD *)(a1 + 276) = 0LL;
  *(_QWORD *)(a1 + 284) = 0LL;
...
LABEL_60:
    ...
    {
      v67 = *(void *(**)(WPF::ProcessHeapImpl *__hidden, unsigned __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL);
      if ( v67 == WPF::ProcessHeapImpl::AllocClear )
        v68 = WPF::ProcessHeapImpl::AllocClear(WPF::g_pProcessHeap, 0x50uLL);
      else
        v68 = (void *)((__int64 (__fastcall *)(WPF::ProcessHeapImpl *, __int64))v67)(WPF::g_pProcessHeap, 80LL);
      if ( v68 )
      ...
      *(_QWORD *)(a1 + 344) = v69;
      ...
      {
        v11 = -2147024882;
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024882, 0x54Bu);
        return v11;
      }
  ...
  while ( 1 )
  {
    v40 = CDesktopManager::GetTheme(3);
    if ( (unsigned int)GetThemeAnimationTransform(v40, v91, v94, v41, 0LL, 0, &v88) != -2147024662 )
      goto LABEL_59;
    v42 = v88;
    v43 = *(void *(__fastcall **)(WPF::ProcessHeapImpl *__hidden, unsigned __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL);
    ...
    if ( (unsigned int)(*(_DWORD *)v45 - 1) <= 1 )
    {
      ...
      {
        v50 = v88;
        v51 = *(void *(__fastcall **)(WPF::ProcessHeapImpl *__hidden, unsigned __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                       + 8LL);
        ...
        v5 = v52;
        v53 = CDesktopManager::GetTheme(4);
        ...
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, ThemeTimingFunction, 0x4ACu);
          goto LABEL_134;
        }
        CTopLevelWindow3D::ConvertTimingFunctionToInterpolationMode(v55, v5);
        v57 = *(void (__fastcall **)(WPF::ProcessHeapImpl *__hidden, void *))(*(_QWORD *)WPF::g_pProcessHeap + 32LL);
      ...
      if ( *(_DWORD *)v45 == 1 )
      {
        ...
        if ( (v58 & 1) != 0 )
        {
          ...
          {
            v11 = -2147024809;
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x4D9u);
            goto LABEL_134;
          }
          v72 = v45[7];
          v73 = v45[8];
          ...
          if ( v74 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v74, 0x4CDu);
            goto LABEL_134;
          }
          ...
          if ( v75 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v75, 0x4CEu);
            goto LABEL_134;
          }
          ...
          if ( v76 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v76, 0x4D3u);
            goto LABEL_134;
          }
          ...
          if ( v77 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v77, 0x4D4u);
            goto LABEL_134;
          }
        }
        else
          ...
          if ( v35 > 0.0 && v34 > 0.0 )
          {
            ...
            else
            {
              ...
              if ( v80 <= v79 )
                ...
                v86 = v79;
              v48 = (float)((float)(v86 - v45[5]) * v48) / (float)(v85 - v45[5]);
              if ( v48 < 0.0 )
                v48 = 0.0;
              v82 = v80 <= v79;
            }
...
LABEL_45:
          if ( (v58 & 4) != 0 )
          {
            ...
            if ( v60 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v60, 0x514u);
              goto LABEL_134;
            }
            ...
            if ( v61 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v61, 0x515u);
              goto LABEL_134;
            }
          ...
          if ( v62 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v62, 0x518u);
            goto LABEL_134;
          }
          ...
          if ( v63 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v63, 0x519u);
            goto LABEL_134;
          }
        }
      }
      else if ( *(_DWORD *)v45 == 2 )
      {
        if ( ((_BYTE)v45[4] & 1) != 0 )
        {
          ...
          {
            v11 = -2147024809;
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x52Cu);
            goto LABEL_134;
          }
          ...
          if ( v84 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v84, 0x527u);
            goto LABEL_134;
          }
        }
        else
        {
          ...
          if ( v64 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v64, 0x533u);
            goto LABEL_134;
          }
        }
      }
    ...
    v65 = *(void (__fastcall **)(WPF::ProcessHeapImpl *__hidden, void *))(*(_QWORD *)WPF::g_pProcessHeap + 32LL);
...
LABEL_59:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, ThemeAnimationTransform, 0x499u);
LABEL_134:
  if ( v45 )
