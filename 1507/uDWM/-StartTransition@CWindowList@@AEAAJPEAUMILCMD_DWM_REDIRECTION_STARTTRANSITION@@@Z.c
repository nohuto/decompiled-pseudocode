/*
 * XREFs of ?StartTransition@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_STARTTRANSITION@@@Z @ 0x18002BD48
 * Callers:
...
__int64 __fastcall CWindowList::StartTransition(CWindowList *this, struct MILCMD_DWM_REDIRECTION_STARTTRANSITION *a2)
{
  ...
  v7 = (CAnimationScheduler *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 24);
  EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
  v8 = CAnimationScheduler::OnBeginTransitionRequestFromStoryboard(v7, v6, v4, 0LL, (struct _GUID *)((char *)a2 + 24));
  CGuard<CDwmCS>::~CGuard<CDwmCS>(&v10);
  if ( v8 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0xF5Au);
