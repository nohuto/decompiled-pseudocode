/*
 * XREFs of ?Create@CDrawAtlasedRectsInstruction@@SAJPEAVCResource@@0PEAPEAV1@@Z @ 0x1800054E4
 * Callers:
...
__int64 __fastcall CDrawAtlasedRectsInstruction::Create(
        struct CResource *a1,
        struct CResource *a2,
        struct CDrawAtlasedRectsInstruction **a3)
{
  __int64 v6; // rax
  struct CDrawAtlasedRectsInstruction *v7; // rdi
  unsigned int v8; // ebx
  CBaseObject *v9; // rcx
  CBaseObject *v10; // rcx
  ...
  v6 = (*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
         WPF::g_pProcessHeap,
         32LL);
  v7 = (struct CDrawAtlasedRectsInstruction *)v6;
  v8 = 0;
  if ( v6 )
  {
    *(_DWORD *)(v6 + 8) = 1;
    *(_QWORD *)v6 = &CDrawAtlasedRectsInstruction::`vftable';
  }
  else
  {
    v7 = 0LL;
