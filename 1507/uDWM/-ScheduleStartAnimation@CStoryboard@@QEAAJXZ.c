/*
 * XREFs of ?ScheduleStartAnimation@CStoryboard@@QEAAJXZ @ 0x18000FCE4
 * Callers:
...
__int64 __fastcall CStoryboard::ScheduleStartAnimation(CStoryboard *this)
{
  ...
  if ( *((_DWORD *)this + 28) )
  {
    ...
    v4 = -2147024362;
LABEL_26:
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v12, 0x15E8u);
    goto LABEL_15;
  }
LABEL_13:
  ...
  MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, started, v17);
LABEL_15:
