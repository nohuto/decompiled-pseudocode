/*
 * XREFs of __tailMerge_api_ms_win_service_management_l2_1_0_dll @ 0x180048A50
 * Callers:
 *     __imp_load_NotifyServiceStatusChangeW @ 0x180048A30 (__imp_load_NotifyServiceStatusChangeW.c)
 * Callees:
