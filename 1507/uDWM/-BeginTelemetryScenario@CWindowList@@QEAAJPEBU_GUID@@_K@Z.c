/*
 * XREFs of ?BeginTelemetryScenario@CWindowList@@QEAAJPEBU_GUID@@_K@Z @ 0x180030140
 * Callers:
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( appended >= 0 )
      {
        ...
        if ( v10 >= 0 )
        {
          ...
          v3 = v11;
          if ( v11 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0xF21u);
        }
        else
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0xF20u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, appended, 0xF1Fu);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0xF1Eu);
    }
  }
  return v3;
}
