/*
 * XREFs of ?UpdateAccent@CTopLevelWindow@@QEAAJ_N@Z @ 0x180021860
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateAccent(CTopLevelWindow *this, char a2)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)this + 93) + 152LL) & 0xFFFFFFFB) != 0 )
  {
    ...
    if ( !*((_QWORD *)this + 36) )
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0xD9Du);
        return v2;
      }
      *((_BYTE *)*v5 + 584) = (*(_DWORD *)(*((_QWORD *)this + 93) + 104LL) & 0x400000) != 0;
      ...
      if ( inserted < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0xD9Fu);
        return v2;
      }
    }
    v8 = *((_QWORD *)this + 93);
    ...
    *((_QWORD *)v9 + 45) = v10;
    ...
    else
    {
      ...
      DynArray<CWindowData *,0>::Remove(
        (__int64 *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 167) + 544LL),
        &v17);
    }
    v12 = *v5;
    if ( a2 != *((_BYTE *)*v5 + 350) )
    ...
    v2 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0xDB8u);
  }
  else if ( *((_QWORD *)this + 36) )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0xDBFu);
    }
  }
  return v2;
}
