/*
 * XREFs of ?LoadCentralImage@CWindowIconic@@AEAAJXZ @ 0x18003A6A4
 * Callers:
...
__int64 __fastcall CWindowIconic::LoadCentralImage(CWindowIconic *this)
{
  ...
  struct CBitmapSource *v16; // [rsp+50h] [rbp+20h] BYREF
  ...
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0xCDu);
      v8 = v16;
LABEL_10:
      if ( v8 )
  ...
  if ( v16 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0xE5u);
    }
    else
    {
      ...
      v1 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0xE6u);
    }
    goto LABEL_10;
  }
LABEL_12:
