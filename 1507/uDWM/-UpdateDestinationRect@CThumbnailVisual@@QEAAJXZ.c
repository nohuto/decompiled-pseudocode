/*
 * XREFs of ?UpdateDestinationRect@CThumbnailVisual@@QEAAJXZ @ 0x180013B64
 * Callers:
  ...
  if ( *((_QWORD *)this + 48) && *((_QWORD *)this + 49) )
  {
    ...
    *(_QWORD *)&v55 = 0LL;
    ...
    if ( IsImmersiveIconic )
    {
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v33, 0x247u);
        return v2;
      }
      v34 = (float)(v9 / 2
      ...
      *((float *)&v60 + 1) = (float)(int)CSecondaryWindowRepresentation::GetIconicWidth(v39) + v34;
      ...
      if ( v44 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v44, 0x24Du);
        return v2;
      }
    }
    else
    {
      ...
      *((float *)&v60 + 1) = (float)v9 + 0.0;
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x257u);
        return v2;
      }
    }
    v13 = *((_QWORD *)this + 56);
...
LABEL_17:
        ...
        *(double *)&v57[1] = v19;
          ...
          && (*(_DWORD *)(*((_QWORD *)this + 44) + 36LL) & 0x100000) == 0 )
        {
          ...
          if ( v20 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v20, 0x278u);
            return v2;
          }
...
LABEL_23:
        ...
        if ( (unsigned __int8)CThumbnailVisual::_HasBorder(this) && *((_QWORD *)this + 51) )
        {
          ...
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, RectangleGeometry, 0x28Eu);
            return v2;
          }
          v52 = *((_DWORD *)this + 28);
          v53 = *((_DWORD *)this + 29);
        ...
        *(__m128i *)((char *)this + 516) = v6;
        ...
        if ( *v22 )
        {
          ...
          v2 = v23;
          if ( v23 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v23, 0x2A7u);
        }
        return v2;
      }
