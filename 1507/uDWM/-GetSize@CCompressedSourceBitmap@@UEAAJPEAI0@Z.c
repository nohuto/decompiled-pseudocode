/*
 * XREFs of ?GetSize@CCompressedSourceBitmap@@UEAAJPEAI0@Z @ 0x18000A260
 * Callers:
 *     ?GetSize@CCompressedSourceBitmap@@WBI@EAAJPEAI0@Z @ 0x18004A6D0 (-GetSize@CCompressedSourceBitmap@@WBI@EAAJPEAI0@Z.c)
 * Callees:
...
__int64 __fastcall CCompressedSourceBitmap::GetSize(CCompressedSourceBitmap *this, unsigned int *a2, unsigned int *a3)
{
        ...
        v9 >= 0) )
  {
    ...
    else
    {
      ...
      v6 = -2147024809;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x64u);
    }
    return v6;
  }
  else
