/*
 * XREFs of ?_UpdateResourcesForMonitor@CLivePreview@@AEAAJPEAULivePreviewResource@@@Z @ 0x18006AEA0
 * Callers:
...
LABEL_5:
    ...
    *((_BYTE *)a2 + 129) = !IsRectEmpty((const RECT *)((char *)a2 + 40));
    if ( *((_BYTE *)a2 + 128) )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, RectangleGeometry, 0x50Du);
        return v3;
      }
      v13 = (CResource **)((char *)a2 + 24);
      if ( !*((_QWORD *)a2 + 3) )
      {
        v14 = CResource::Create(0x34u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)a2 + 3);
        v3 = v14;
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x511u);
          return v3;
        }
      }
      v53 = 152;
      ...
      if ( v20 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v20, 0x51Cu);
        return v3;
      }
      v21 = *v13;
      v52[0] = 153LL;
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0x521u);
        return v3;
      }
      if ( !*((_QWORD *)a2 + 4) )
      {
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v24, 0x526u);
          return v3;
        }
      }
      v57 = 250;
      ...
      if ( v29 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v29, 0x536u);
        return v3;
      }
    }
    if ( *((_BYTE *)a2 + 129) )
    {
      ...
      if ( v32 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v32, 0x541u);
        return v3;
      }
      v33 = (CResource **)((char *)a2 + 64);
      if ( !*((_QWORD *)a2 + 8) )
      {
        v34 = CResource::Create(0x34u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)a2 + 8);
        v3 = v34;
        if ( v34 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v34, 0x545u);
          return v3;
        }
      }
      v53 = 152;
      ...
      if ( v40 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v40, 0x54Eu);
        return v3;
      }
      v41 = *v33;
      v52[0] = 153LL;
      ...
      if ( v42 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v42, 0x553u);
        return v3;
      }
      if ( !*((_QWORD *)a2 + 9) )
      {
        ...
        if ( v44 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v44, 0x558u);
          return v3;
        }
      }
      v57 = 250;
      ...
      if ( v49 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v49, 0x568u);
        return v3;
      }
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, GeometryFromHRGN, 0x56Au);
        return v3;
      }
    }
  ...
  while ( 1 )
  {
    ...
    v8 = (const struct CTopLevelWindow *)*((_QWORD *)v7 + 46);
    if ( v8 )
    {
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x4FDu);
  return v3;
}
