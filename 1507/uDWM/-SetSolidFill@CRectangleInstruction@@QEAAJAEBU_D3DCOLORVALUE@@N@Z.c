/*
 * XREFs of ?SetSolidFill@CRectangleInstruction@@QEAAJAEBU_D3DCOLORVALUE@@N@Z @ 0x180039C94
 * Callers:
        ...
        double a3)
{
  ...
  if ( *((_QWORD *)this + 2)
    || (v6 = CResource::Create(0x43u, *((_QWORD *)this + 5), (CBaseObject **)this + 2), v7 = v6, v6 >= 0) )
  {
    v8 = *(_OWORD *)&a2->r;
    v9 = *v5;
    v16 = 0;
