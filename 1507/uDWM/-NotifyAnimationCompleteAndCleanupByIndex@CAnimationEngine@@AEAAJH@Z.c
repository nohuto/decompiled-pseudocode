/*
 * XREFs of ?NotifyAnimationCompleteAndCleanupByIndex@CAnimationEngine@@AEAAJH@Z @ 0x18003160C
 * Callers:
...
__int64 __fastcall CAnimationEngine::NotifyAnimationCompleteAndCleanupByIndex(CAnimationEngine *this, unsigned int a2)
{
  __int64 v3; // r12
  int v4; // ecx
  CAnimationEngine::CTransitionVisualSet *v5; // r14
  unsigned int v6; // esi
  unsigned int i; // ebp
  void (__fastcall ***v8)(_QWORD, _QWORD); // r13
  unsigned int v9; // edx
  __int64 v10; // rax
  ...
  *((_BYTE *)this + 112) = 1;
  ...
  {
    v6 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x218u);
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x597u);
  }
  else
  {
    v13 = v12 - 1;
