/*
 * XREFs of ?RemoveSwapchainTargetFromWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180079800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::RemoveSwapchainTargetFromWindow(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( SyncedWindowData >= 0 )
  {
    ...
    {
      v5 = -2147024890;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024890, 0x13CEu);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x13CBu);
  }
