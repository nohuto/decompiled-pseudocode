/*
 * XREFs of ?_CreateAndAddNullComponentWithWindow@CStoryboard@@IEAAJPEAVCWindowData@@HPEAPEAVCAnimationComponent@@@Z @ 0x180092CA0
 * Callers:
        ...
        struct CAnimationComponent **a4)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v9, 0x15A8u);
      goto LABEL_8;
    }
  ...
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v6, 0x15A7u);
  }
  v8 = (volatile signed __int32 *)v11;
LABEL_8:
  if ( v8 )
