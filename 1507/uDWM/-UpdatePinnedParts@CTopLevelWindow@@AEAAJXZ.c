/*
 * XREFs of ?UpdatePinnedParts@CTopLevelWindow@@AEAAJXZ @ 0x180021AD0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdatePinnedParts(CTopLevelWindow *this)
{
  ...
  __int64 v40; // rcx
  CVisual *v41; // r14
  void (__fastcall *v42)(CVisual *, int); // r15
  int v43; // eax
  CVisual *i; // r14
  int v45; // ecx
  __int64 v46; // rcx
  CVisual *v47; // r14
  void (__fastcall *v48)(CVisual *, int); // r15
  int v49; // eax
  CVisual *j; // r14
  int v51; // ecx
  void (__fastcall *v52)(CVisual *, int); // rdi
  __int128 v54; // xmm0
  CVisual *v55; // r14
  void (__fastcall *v56)(CVisual *, int); // r15
  void (__fastcall *v57)(CVisual *); // r15
  void (__fastcall *v58)(CVisual *); // r15
  ...
  if ( v7 )
  {
    v10 = *((double *)CDesktopManager::s_pDesktopManagerInstance + 165);
    v8 = (int)((double)(*(_DWORD *)(*((_QWORD *)v7 + 98) + 24LL) - 1) * v10);
    v9 = (int)((double)(*(_DWORD *)(*((_QWORD *)v7 + 116) + 24LL) - 1) * v10);
  }
  ...
  *(_OWORD *)((char *)this + 676) = v67;
          ...
          *(_QWORD *)(v40 + 24) = v66;
          if ( v41 )
          {
            ...
            if ( v42 == CVisual::SetDirtyFlags )
            {
              ...
              if ( (v43 & 0x2000) == 0 )
              {
                *((_DWORD *)v41 + 20) = v43 | 0x2000;
                for ( i = (CVisual *)*((_QWORD *)v41 + 3); i; i = (CVisual *)*((_QWORD *)i + 3) )
                {
                  v45 = *((_DWORD *)i + 20);
                  if ( (v45 & 1) != 0 )
                    break;
                  v58 = *(void (__fastcall **)(CVisual *))(*(_QWORD *)i + 32LL);
          ...
          *(_QWORD *)(v46 + 24) = v64;
          if ( v47 )
          {
            ...
            if ( v48 == CVisual::SetDirtyFlags )
            {
              ...
              if ( (v49 & 0x2000) == 0 )
              {
                *((_DWORD *)v47 + 20) = v49 | 0x2000;
                for ( j = (CVisual *)*((_QWORD *)v47 + 3); j; j = (CVisual *)*((_QWORD *)j + 3) )
                {
                  v51 = *((_DWORD *)j + 20);
                  if ( (v51 & 1) != 0 )
                    break;
                  v57 = *(void (__fastcall **)(CVisual *))(*(_QWORD *)j + 32LL);
  ...
  while ( v36 );
  v52 = *(void (__fastcall **)(CVisual *, int))(**((_QWORD **)this + 37) + 24LL);
  if ( v52 == CVisual::SetDirtyFlags )
    CVisual::SetDirtyFlags(*((CVisual **)this + 37), 4096);
  else
    v52(*((CVisual **)this + 37), 4096);
  return 0LL;
}
