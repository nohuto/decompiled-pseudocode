/*
 * XREFs of ?_CleanupClonedVisualTree@CLivePreview@@AEAAJXZ @ 0x180068BB4
 * Callers:
    ...
    if ( v4 >= 0 )
    {
      *((_DWORD *)this + 102) = 0;
      ...
      if ( v5 >= 0 )
      {
        ...
        v3 = v6;
        if ( v6 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x6D3u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x6D2u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0x6D0u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v2, 0x6CFu);
  }
  return v3;
}
