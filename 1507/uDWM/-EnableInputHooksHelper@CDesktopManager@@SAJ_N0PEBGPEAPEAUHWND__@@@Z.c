/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x18006CA70
 * Callers:
...
LABEL_18:
  ...
  if ( WindowInBand )
  {
    ...
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 192) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800AA720, 2LL, v13, 0x8E0u);
    }
    goto LABEL_18;
  }
  v4 = -2147024890;
  MilInstrumentationCheckHR(0x14u, &dword_1800AA720, 2LL, -2147024890, 0x8CFu);
LABEL_19:
  if ( a1 )
