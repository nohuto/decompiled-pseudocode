/*
 * XREFs of ?PowerUp@FxDmaEnabler@@QEAAJXZ @ 0x1C00091E0
 * Callers:
...
__int64 __fastcall FxDmaEnabler::PowerUp(FxDmaEnabler *this, unsigned __int8 a2, unsigned int a3)
{
  ...
  if ( m_Globals->FxVerboseOn )
  {
    if ( m_ObjectSize )
      ...
      _a1 = 0LL;
    WPP_IFR_SF_q(m_Globals, 5u, 0xFu, 0x16u, WPP_FxDmaEnabler_cpp_Traceguids, _a1);
  }
  ...
  if ( level < 0 )
  {
    if ( this->m_ObjectSize )
      ...
      v14 = 0LL;
    WPP_IFR_SF_qld(m_Globals, a2, a3, 0x17u, WPP_FxDmaEnabler_cpp_Traceguids, v14, globals, level);
  }
  return (unsigned int)level;
}
