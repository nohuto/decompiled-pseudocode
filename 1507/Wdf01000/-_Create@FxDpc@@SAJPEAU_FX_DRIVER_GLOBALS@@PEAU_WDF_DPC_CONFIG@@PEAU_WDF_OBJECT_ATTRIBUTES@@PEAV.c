/*
 * XREFs of ?_Create@FxDpc@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_DPC_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxObject@@PEAPEAUWDFDPC__@@@Z @ 0x1C0068574
 * Callers:
        ...
        WDFDPC__ **Dpc)
{
  ...
  if ( !v11 )
    return 3221225626LL;
  v13 = FxDpc::Initialize(v11, Attributes, Config, ParentObject, Dpc);
  if ( v13 < 0 )
