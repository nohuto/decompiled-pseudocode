/*
 * XREFs of ??0FxUsbPipe@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxUsbDevice@@@Z @ 0x1C00900DC
 * Callers:
...
void __fastcall FxUsbPipe::FxUsbPipe(FxUsbPipe *this, _FX_DRIVER_GLOBALS *FxDriverGlobals, FxUsbDevice *UsbDevice)
{
  ...
  *(_QWORD *)&this->m_PipeInformation.MaximumPacketSize = 0LL;
  this->m_PipeInformation.PipeHandle = 0LL;
