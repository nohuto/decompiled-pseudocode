/*
 * XREFs of imp_WdfRequestIsReserved @ 0x1C006EC00
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall imp_WdfRequestIsReserved(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Request)
{
  __int64 Offset; // r8
  FxRequest *v3; // rcx
