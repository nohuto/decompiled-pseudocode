/*
 * XREFs of ?SelectSettingByDescriptor@FxUsbInterface@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_USB_INTERFACE_DESCRIPTOR@@@Z @ 0x1C008FCEC
 * Callers:
        ...
        _USB_INTERFACE_DESCRIPTOR *InterfaceDescriptor)
{
  ...
  if ( bInterfaceNumber == m_InterfaceNumber )
  {
    v10 = (_URB *)FxPoolAllocator(
                    ...
                    (unsigned __int16)(24 * InterfaceDescriptor->bNumEndpoints + 56),
                    this->m_Globals->Tag,
                    retaddr);
    v11 = v10;
    if ( v10 )
