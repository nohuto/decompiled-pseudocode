/*
 * XREFs of imp_WdfRequestIsFrom32BitProcess @ 0x1C006EB80
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall imp_WdfRequestIsFrom32BitProcess(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Request)
{
  __int64 Offset; // r8
  FxRequest *v3; // rcx
  ...
  return IoIs32bitProcess(v3->m_Irp.m_Irp);
}
