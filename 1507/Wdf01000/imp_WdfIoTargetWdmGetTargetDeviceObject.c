/*
 * XREFs of imp_WdfIoTargetWdmGetTargetDeviceObject @ 0x1C002F960
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 IoTarget)
{
  ...
  _DEVICE_OBJECT *m_TargetDevice; // rsi
  ...
  {
    WPP_IFR_SF_q(m_Globals, 5u, 0xEu, 0xAu, WPP_FxIoTargetAPIKm_cpp_Traceguids, _a1);
    v3 = pTarget;
  }
  m_TargetDevice = v3->m_TargetDevice;
  if ( m_Globals->FxVerboseOn )
    WPP_IFR_SF_qq(m_Globals, 5u, 0xEu, 0xBu, WPP_FxIoTargetAPIKm_cpp_Traceguids, _a1, v3->m_TargetDevice);
