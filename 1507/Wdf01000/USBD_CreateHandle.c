/*
 * XREFs of USBD_CreateHandle @ 0x1C00A5684
 * Callers:
 ...
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C00A50B8 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
