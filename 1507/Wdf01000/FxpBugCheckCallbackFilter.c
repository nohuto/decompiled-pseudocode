/*
 * XREFs of FxpBugCheckCallbackFilter @ 0x1C00A6224
 * Callers:
 *     FxpBugCheckCallback @ 0x1C00A6170 (FxpBugCheckCallback.c)
 * Callees:
 *     FxpIsAddressKnownToWdf @ 0x1C00A62A4 (FxpIsAddressKnownToWdf.c)
 */
