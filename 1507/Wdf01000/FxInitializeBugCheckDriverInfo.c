/*
 * XREFs of FxInitializeBugCheckDriverInfo @ 0x1C002ACD4
 * Callers:
 *     FxLibraryGlobalsCommission @ 0x1C002A918 (FxLibraryGlobalsCommission.c)
 * Callees:
 *     RtlStringCopyWorkerA @ 0x1C002ADEC (RtlStringCopyWorkerA.c)
  ...
  if ( !FxLibraryGlobals.StaticallyLinked )
  {
    ...
    if ( result )
    {
      ...
      if ( result )
      {
        ...
        FxLibraryGlobals.BugCheckDriverInfo->Version.Minor = 15;
