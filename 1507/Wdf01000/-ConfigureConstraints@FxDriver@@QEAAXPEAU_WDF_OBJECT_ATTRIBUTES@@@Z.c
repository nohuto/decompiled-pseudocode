/*
 * XREFs of ?ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C0010A84
 * Callers:
...
void __fastcall FxDriver::ConfigureConstraints(FxDriver *this, _WDF_OBJECT_ATTRIBUTES *DriverAttributes)
{
  ...
  if ( (unsigned int)(this->m_SynchronizationScope - 2) <= 1 )
    v5 = p_m_CallbackMutexLock;
  this->m_DriverDeviceAdd.m_CallbackLock = v5;
}
