/*
 * XREFs of imp_VfWdfRequestCompleteWithPriorityBoost @ 0x1C00CC950
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 PriorityBoost)
{
  ...
  *(_DWORD *)&ActivityId.Data4[4] = 0;
  ActivityId.Data1 = 0;
  v6 = (FxObject *)(~(unsigned __int64)Request & 0xFFFFFFFFFFFFFFF8uLL);
  v7 = (unsigned __int8)Request & 7;
  v9 = PriorityBoost;
  v10 = v6;
  if ( (v7 & 1) != 0 )
    v10 = (FxObject *)((char *)v6 - LOWORD(v6->__vftable));
  ...
  if ( (m_Globals->FxEnhancedVerifierOptions & 0xF00000) != 0 )
  {
    ...
    {
      FxObjectHandleGetPtrQI(v6, &PPObject, Request, 0x1008u, Offset);
      v6 = (FxObject *)PPObject;
    }
    if ( (unsigned int)IoGetActivityIdIrp(*(_QWORD *)&v6[1].m_SpinLock.m_DbgFlagIsInitialized, &ActivityId) == -1073741275 )
    {
