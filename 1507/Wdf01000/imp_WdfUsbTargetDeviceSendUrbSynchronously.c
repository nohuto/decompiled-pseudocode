/*
 * XREFs of imp_WdfUsbTargetDeviceSendUrbSynchronously @ 0x1C0089670
 * Callers:
 *     <none>
 * Callees:
        ...
        IFxMemory *Urb)
{
  ...
  if ( m_Globals->FxVerboseOn )
    WPP_IFR_SF_qq(m_Globals, 5u, 0xEu, 0xBu, WPP_FxUsbDeviceApiKm_cpp_Traceguids, _a1, Urb);
  if ( !Urb )
...
LABEL_24:
  ...
  if ( _a3 >= 0 )
  {
    if ( m_Globals->FxVerboseOn )
    {
      ...
      WPP_IFR_SF_qq(m_Globals, 5u, 0xEu, 0xCu, WPP_FxUsbDeviceApiKm_cpp_Traceguids, _a1, _a2);
    }
    _a3 = FxIoTarget::SubmitSync(pUsbDevice, v19.m_TrueRequest, RequestOptions, 0LL);
  }
  if ( m_Globals->FxVerboseOn )
    WPP_IFR_SF_qid(m_Globals, 5u, 0xEu, 0xDu, WPP_FxUsbDeviceApiKm_cpp_Traceguids, _a1, (__int64)Urb, _a3);
  FxSyncRequest::~FxSyncRequest(&v19);
