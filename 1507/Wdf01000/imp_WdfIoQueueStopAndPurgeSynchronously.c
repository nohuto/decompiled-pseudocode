/*
 * XREFs of imp_WdfIoQueueStopAndPurgeSynchronously @ 0x1C00944F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall imp_WdfIoQueueStopAndPurgeSynchronously(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Queue)
{
  FxIoQueue *v2; // rcx
  __int64 Offset; // r8
  ...
  {
    FxObjectHandleGetPtrQI(v2, &PPObject, (void *)Queue, 0x1003u, Offset);
    v2 = (FxIoQueue *)PPObject;
  }
  ...
  {
    v6 = FxIoQueue::QueueIdleSynchronously(v2, 1u);
    if ( v6 < 0 )
