/*
 * XREFs of ?AddChildList@FxDevice@@UEAAXPEAVFxChildList@@@Z @ 0x1C000E880
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxDevice::AddChildList(FxDevice *this, unsigned __int64 List)
{
  ...
  if ( m_PkgPnp )
  {
    ...
    (**(void (__fastcall ***)(__int64, _FX_DRIVER_GLOBALS *, char *))p_m_ChildListList)(p_m_ChildListList, v5, &v13);
           ...
           v7) >= 0 )
    {
      if ( *(_DWORD *)(p_m_ChildListList + 48) )
      {
        ...
        v11 = *(_LIST_ENTRY **)(p_m_ChildListList + 32);
        p_m_TransactionLink = &v7->m_TransactionLink;
        p_m_TransactionLink->Flink = (_LIST_ENTRY *)(p_m_ChildListList + 24);
        p_m_TransactionLink->Blink = v11;
        if ( v11->Flink != (_LIST_ENTRY *)(p_m_ChildListList + 24) )
          __fastfail(3u);
        v11->Flink = p_m_TransactionLink;
