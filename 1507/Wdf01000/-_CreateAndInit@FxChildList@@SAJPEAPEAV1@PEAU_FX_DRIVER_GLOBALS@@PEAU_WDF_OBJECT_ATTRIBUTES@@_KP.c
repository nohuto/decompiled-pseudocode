/*
 * XREFs of ?_CreateAndInit@FxChildList@@SAJPEAPEAV1@PEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@_KPEAVFxDevice@@PEAU_WDF_CHILD_LIST_CONFIG@@E@Z @ 0x1C0012320
 * Callers:
 ...
 *     ?Initialize@FxChildList@@IEAAXPEAU_WDF_CHILD_LIST_CONFIG@@@Z @ 0x1C001D0F8 (-Initialize@FxChildList@@IEAAXPEAU_WDF_CHILD_LIST_CONFIG@@@Z.c)
        ...
        unsigned __int8 Static)
{
  ...
  *ChildList = 0LL;
  ...
  if ( FxCalculateObjectTotalSize2(FxDriverGlobals, 0x168u, 0, ContextSizeOverride, &Size) < 0 )
    goto LABEL_21;
  if ( FxDriverGlobals->FxPoolTrackingOn )
    Caller = retaddr;
  else
    Caller = 0LL;
  v15 = (FxChildList *)FxPoolAllocator(
                         FxDriverGlobals,
