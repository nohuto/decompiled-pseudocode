/*
 * XREFs of ??0FxChildList@@IEAA@PEAU_FX_DRIVER_GLOBALS@@_KPEAVFxDevice@@E@Z @ 0x1C001D9A0
 * Callers:
        ...
        unsigned __int8 Static)
{
  ...
  *(_DWORD *)&this->m_ObjectFlags = 0x10000;
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 )
  {
    ...
    {
      v10 = 0LL;
      v11 = (FxVerifierLock *)FxPoolAllocator(
                                v9,
                                ...
                                v9->Tag,
                                Caller);
      if ( v11 && (FxVerifierLock::FxVerifierLock(v11, v9, this), (v13 = v12) != 0) )
      {
        if ( *(_BYTE *)(v12 + 122) )
        {
          *(_DWORD *)(v12 + 48) = 1;
          *(_QWORD *)(v12 + 56) = 0LL;
          *(_DWORD *)(v12 + 64) = 0;
          KeInitializeEvent((PRKEVENT)(v12 + 72), SynchronizationEvent, 0);
          *(_BYTE *)(v13 + 40) = 1;
        }
        v10 = (_LIST_ENTRY *)v13;
      }
      ...
      {
        WPP_IFR_SF_d(v9, 2u, 0x12u, 0xCu, WPP_FxVerifierLock_hpp_Traceguids, -1073741670);
      }
      this[-1].m_ScanEvent.m_Event.Header.WaitListHead.Flink = v10;
    }
  }
