/*
 * XREFs of ?GetString@FxUsbDevice@@QEAAJPEAG0EGPEAUWDFREQUEST__@@PEAU_WDF_REQUEST_SEND_OPTIONS@@@Z @ 0x1C008DF8C
 * Callers:
        ...
        _WDF_REQUEST_SEND_OPTIONS *Options)
{
  ...
  _LIST_ENTRY *Caller; // [rsp+258h] [rbp+158h]

  p_options = Options;
  FxSyncRequest::FxSyncRequest(&request, this->m_Globals, 0LL, (unsigned __int64)Request);
  v11 = 0LL;
  ...
  if ( v12 >= 0 )
  {
    ...
    *(_DWORD *)&urb.Hdr.Length = 721032;
    ...
    FxFormatUsbRequest(request.m_TrueRequest, (_URB *)&urb, FxUrbTypeLegacy, 0LL);
