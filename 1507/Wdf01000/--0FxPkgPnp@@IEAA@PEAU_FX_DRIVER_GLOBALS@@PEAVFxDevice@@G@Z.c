/*
 * XREFs of ??0FxPkgPnp@@IEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxDevice@@G@Z @ 0x1C001C620
 * Callers:
        ...
        unsigned __int16 Type)
{
  ...
  int (__fastcall *v11)(WDFDEVICE__ *); // r14
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 )
  {
    ...
    if ( v10->FxVerifierLock )
    {
      ...
      v12 = (FxVerifierLock *)FxPoolAllocator(
                                ...
                                v10->Tag,
                                Caller);
      if ( v12 && (FxVerifierLock::FxVerifierLock(v12, v10, this), (v14 = v13) != 0) )
      {
        if ( *(_BYTE *)(v13 + 122) )
        {
          *(_DWORD *)(v13 + 48) = 1;
          *(_QWORD *)(v13 + 56) = 0LL;
          *(_DWORD *)(v13 + 64) = 0;
          KeInitializeEvent((PRKEVENT)(v13 + 72), SynchronizationEvent, 0);
          *(_BYTE *)(v14 + 40) = 1;
        }
        v11 = (int (__fastcall *)(WDFDEVICE__ *))v14;
      }
      else
      {
        WPP_IFR_SF_d(v10, 2u, 0x12u, 0xCu, WPP_FxVerifierLock_hpp_Traceguids, -1073741670);
      }
      this[-1].m_DeviceQueryStop.m_Method = v11;
    }
  }
