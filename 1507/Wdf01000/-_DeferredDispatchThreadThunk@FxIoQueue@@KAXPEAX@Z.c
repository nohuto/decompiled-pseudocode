/*
 * XREFs of ?_DeferredDispatchThreadThunk@FxIoQueue@@KAXPEAX@Z @ 0x1C0026B80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxIoQueue::_DeferredDispatchThreadThunk(char *Parameter, __int64 a2, unsigned __int8 a3)
{
  ...
  if ( v4->FxVerboseOn )
    WPP_IFR_SF_(v4, 5u, 0xDu, 0x66u, (const _GUID *)&FxObject::`vftable'.FxPoolFrameworks.NonPagedHead.Blink);
