/*
 * XREFs of imp_WdfDeviceGetSystemPowerAction @ 0x1C002E7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall imp_WdfDeviceGetSystemPowerAction(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Device)
{
  __int64 Offset; // r8
  FxDevice *v3; // rcx
  ...
  return v3->m_PkgPnp->m_SystemPowerAction;
}
