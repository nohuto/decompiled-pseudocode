/*
 * XREFs of FxpBugCheckCallback @ 0x1C00A6170
 * Callers:
 *     <none>
 * Callees:
 *     FxpBugCheckCallbackFilter @ 0x1C00A6224 (FxpBugCheckCallbackFilter.c)
 */
...
LABEL_9:
        ...
        if ( !FxLibraryGlobals.BestDriverForDumpLog
          ...
          && *(_FX_DRIVER_GLOBALS **)((char *)&FxLibraryGlobals.DriverTracker.m_DriverUsage->FxDriverGlobals
                                    + PfnKeGetCurrentProcessorNumberEx(0LL) * FxLibraryGlobals.DriverTracker.m_EntrySize) == p_Reason )
        {
          goto LABEL_9;
        }
      }
