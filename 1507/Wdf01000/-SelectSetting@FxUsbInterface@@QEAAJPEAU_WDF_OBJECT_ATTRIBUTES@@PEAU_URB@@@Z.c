/*
 * XREFs of ?SelectSetting@FxUsbInterface@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_URB@@@Z @ 0x1C008F984
 * Callers:
        ...
        _URB *Urb)
{
  ...
  _LIST_ENTRY *retaddr; // [rsp+1D0h] [rbp+C8h]
...
LABEL_20:
          ...
          FxFormatUsbRequest(*(FxRequestBase **)&request.m_ClearContextOnDestroy, v3, FxUrbTypeLegacy, 0LL);
