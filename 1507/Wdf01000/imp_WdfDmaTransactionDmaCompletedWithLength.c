/*
 * XREFs of imp_WdfDmaTransactionDmaCompletedWithLength @ 0x1C005E5B0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *pStatus)
{
  ...
  return FxDmaTransactionBase::DmaCompleted(v6, TransferredLength, pStatus, FxDmaCompletionTypePartial);
}
