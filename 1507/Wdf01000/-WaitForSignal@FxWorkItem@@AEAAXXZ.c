/*
 * XREFs of ?WaitForSignal@FxWorkItem@@AEAAXXZ @ 0x1C000768C
 * Callers:
 ...
 * Callees:
 *     ?EnterCRAndWaitAndLeave@FxCREvent@@QEAAJPEA_J@Z @ 0x1C00076CC (-EnterCRAndWaitAndLeave@FxCREvent@@QEAAJPEA_J@Z.c)
