/*
 * XREFs of ??1FxPowerPolicyOwnerSettings@@QEAA@XZ @ 0x1C009FD64
 * Callers:
 ...
 *     ?CleanupPowerCallback@FxPowerPolicyOwnerSettings@@QEAAXXZ @ 0x1C009FE48 (-CleanupPowerCallback@FxPowerPolicyOwnerSettings@@QEAAXXZ.c)
...
void __fastcall FxPowerPolicyOwnerSettings::~FxPowerPolicyOwnerSettings(FxPowerPolicyOwnerSettings *this)
{
  ...
  if ( this->m_PowerIdleMachine.m_PowerTimeoutTimer.m_Timer.m_IsExtTimer )
  {
    m_KernelExTimer = this->m_PowerIdleMachine.m_PowerTimeoutTimer.m_Timer.m_KernelExTimer;
    if ( m_KernelExTimer )
    {
      LOBYTE(v2) = 1;
      ExDeleteTimer(m_KernelExTimer, v2, 0LL, 0LL);
