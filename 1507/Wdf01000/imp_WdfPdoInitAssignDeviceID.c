/*
 * XREFs of imp_WdfPdoInitAssignDeviceID @ 0x1C002D330
 * Callers:
 *     <none>
 * Callees:
        ...
        const _UNICODE_STRING *DeviceID)
{
  ...
  if ( (DeviceID->Length & 1) != 0 )
  {
    v7 = Length;
    v12 = 13;
LABEL_25:
    WPP_IFR_SF_qdd(v5, 2u, 6u, v12, WPP_FxValidateFunctions_hpp_Traceguids_0, DeviceID, v7, -1073741811);
    return 3221225485LL;
  }
  LOWORD(v7) = DeviceID->MaximumLength;
  if ( (v7 & 1) != 0 )
  {
  ...
  {
    WPP_IFR_SF_d(v5, 2u, 0x12u, 0x37u, WPP_FxDeviceInitApi_cpp_Traceguids, -1073741808);
    return 3221225488LL;
  }
  ...
  if ( v9 )
    return FxDuplicateUnicodeString(
             ...
             DeviceID,
             &DeviceInit->Pdo.DeviceID->m_UnicodeString);
  WPP_IFR_SF_d(v5, 2u, 0x12u, 0x38u, WPP_FxDeviceInitApi_cpp_Traceguids, -1073741670);
  return 3221225626LL;
}
