/*
 * XREFs of imp_WdfInterruptEnable @ 0x1C00983A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall imp_WdfInterruptEnable(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Interrupt)
{
  FxInterrupt *v2; // rcx
  __int64 Offset; // r8
