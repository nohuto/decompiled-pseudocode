/*
 * XREFs of ?Initialize@FxDriver@@QEAAJPEBU_UNICODE_STRING@@PEAU_WDF_DRIVER_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C00106A0
 * Callers:
 ...
 *     ?ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C0010A84 (-ConfigureConstraints@FxDriver@@QEAAXPEAU_WDF_OBJECT_ATTRIBUTES@@@Z.c)
 *     memmove @ 0x1C0033080 (memmove.c)
 *     WPP_IFR_SF_qZ @ 0x1C0077588 (WPP_IFR_SF_qZ.c)
 */

int __fastcall FxDriver::Initialize(
        FxDriver *this,
    ...
    if ( result >= 0 )
    {
      ...
      *(_QWORD *)DriverObjectExtension = this;
      ...
      if ( ArgRegistryPath )
      {
        ...
        v18 = (unsigned __int16 *)FxPoolAllocator(v16, (_LIST_ENTRY *)&v16->FxPoolFrameworks, 1u, v17, v16->Tag, Caller);
