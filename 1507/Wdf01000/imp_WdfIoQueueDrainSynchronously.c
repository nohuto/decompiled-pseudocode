/*
 * XREFs of imp_WdfIoQueueDrainSynchronously @ 0x1C00938F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall imp_WdfIoQueueDrainSynchronously(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Queue)
{
  FxIoQueue *v2; // rcx
  __int64 Offset; // r8
  ...
  {
    v6 = FxIoQueue::QueueDrainSynchronously(v2);
    if ( v6 < 0 )
