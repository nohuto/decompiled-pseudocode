/*
 * XREFs of ?CleanupStateMachines@FxPkgPnp@@QEAAXE@Z @ 0x1C009D394
 * Callers:
 ...
 *     ?SetFinished@FxEventQueue@@QEAAEPEAUFxCREvent@@@Z @ 0x1C00A3088 (-SetFinished@FxEventQueue@@QEAAEPEAUFxCREvent@@@Z.c)
 */
