/*
 * XREFs of ?_InterruptEnableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1C00299D0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxInterrupt::_InterruptEnableThunk(_DWORD *SyncContext)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)SyncContext + 258LL) )
  {
    ...
    v6 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v1 + 312))(v2, v9);
  ...
  else
  {
    ...
    if ( *(_WORD *)(v1 + 10) )
      v2 = v1 ^ 0xFFFFFFFFFFFFFFF8uLL;
    v6 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v1 + 312))(v2, v5);
  }
  SyncContext[2] = v6;
  return 1;
}
