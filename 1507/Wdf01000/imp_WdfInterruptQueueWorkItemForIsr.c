/*
 * XREFs of imp_WdfInterruptQueueWorkItemForIsr @ 0x1C0098720
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall imp_WdfInterruptQueueWorkItemForIsr(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Interrupt)
{
  __int64 Offset; // r8
  FxInterrupt *v3; // r10
  ...
  if ( KeGetCurrentIrql() <= 2u )
    return FxSystemWorkItem::EnqueueWorker(v3->m_SystemWorkItem, FxInterrupt::_InterruptWorkItemCallback, v3, 0);
  else
    return KeInsertQueueDpc(&v3->m_Dpc, v3, 0LL);
}
