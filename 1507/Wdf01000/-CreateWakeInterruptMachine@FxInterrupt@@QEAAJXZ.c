/*
 * XREFs of ?CreateWakeInterruptMachine@FxInterrupt@@QEAAJXZ @ 0x1C00A1C18
 * Callers:
...
__int64 __fastcall FxInterrupt::CreateWakeInterruptMachine(FxInterrupt *this)
{
  ...
  v2 = *(_QWORD *)(*(_QWORD *)&this->m_DeviceBase[3].m_SpinLock.m_DbgFlagIsInitialized + 16LL);
  v3 = (FxWakeInterruptMachine *)FxPoolAllocator(
                                   (_FX_DRIVER_GLOBALS *)v2,
                                   (_LIST_ENTRY *)(v2 + 104),
  ...
  if ( v6 )
  {
    ...
    if ( _a2 >= 0 )
    {
      ...
      {
        WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0xEu, WPP_InterruptObject_cpp_Traceguids, this->m_DeviceBase, v9);
      }
    }
    else
    {
