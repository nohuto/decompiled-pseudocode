/*
 * XREFs of USBDInternal_QueryUsbVerifierSettings @ 0x1C00A5464
 * Callers:
        ...
        ULONG PoolTag)
{
  ...
  _QWORD *v11; // rbx
  __int64 (__fastcall *SystemRoutineAddress)(__int64, unsigned __int16 *, _QWORD *); // rax
  int v13; // eax
  ...
  *p_UsbVerifierEnabled = IsDriverVerifying;
  PoolWithTag = ExAllocatePoolWithTag(v9, 0x188uLL, PoolTag);
  v11 = PoolWithTag;
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)v11 + 82) = 4;
    ...
    SystemRoutineAddress = (__int64 (__fastcall *)(__int64, unsigned __int16 *, _QWORD *))MmGetSystemRoutineAddress(&DestinationString);
    if ( !SystemRoutineAddress )
      SystemRoutineAddress = (__int64 (__fastcall *)(__int64, unsigned __int16 *, _QWORD *))RtlQueryRegistryValues;
    v13 = SystemRoutineAddress(1LL, RelativeServicePath, v11);
    if ( v13 < 0 && LOBYTE(WPP_GLOBAL_WDF_Control.Queue.Wcb.DeviceObject) )
