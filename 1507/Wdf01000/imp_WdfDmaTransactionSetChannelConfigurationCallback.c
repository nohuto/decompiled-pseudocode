/*
 * XREFs of imp_WdfDmaTransactionSetChannelConfigurationCallback @ 0x1C005F2A0
 * Callers:
 *     <none>
 * Callees:
        ...
        FxObject *ConfigureContext)
{
  ...
  {
    v7[1].m_SpinLock.m_Lock = (unsigned __int64)ConfigureRoutine;
    v7[1].m_ParentObject = ConfigureContext;
  }
  else
  {
    WPP_IFR_SF_ql(m_Globals, 2u, 0xFu, 0x19u, WPP_FxDmaTransactionAPI_cpp_Traceguids, _a1, v7->m_DmaEnabler->m_Profile);
    Mx::MxDbgPrint(
