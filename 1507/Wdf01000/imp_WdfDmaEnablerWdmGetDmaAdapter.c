/*
 * XREFs of imp_WdfDmaEnablerWdmGetDmaAdapter @ 0x1C0030100
 * Callers:
 *     <none>
 * Callees:
        ...
        int DmaDirection)
{
  ...
  if ( !DmaDirection )
    return v6->m_SimplexAdapterInfo.AdapterObject;
  if ( DmaDirection == 1 )
  {
    v9 = (unsigned __int16 *)&v6->m_DuplexAdapterInfo[1];
    if ( (*((_BYTE *)v6 + 380) & 0x10) == 0 )
      v9 = (unsigned __int16 *)&v6->184;
    return (_DMA_ADAPTER *)*((_QWORD *)v9 + 8);
  }
  else
  {
    WPP_IFR_SF_dq(m_Globals, 2u, 0xFu, 0x13u, WPP_FxDmaEnablerAPI_cpp_Traceguids, DmaDirection, _a2);
    v10 = 7567731;
    Mx::MxDbgPrint(
