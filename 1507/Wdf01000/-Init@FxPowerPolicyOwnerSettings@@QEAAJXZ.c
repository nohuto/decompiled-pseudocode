/*
 * XREFs of ?Init@FxPowerPolicyOwnerSettings@@QEAAJXZ @ 0x1C0027B60
 * Callers:
...
__int64 __fastcall FxPowerPolicyOwnerSettings::Init(FxPowerPolicyOwnerSettings *this)
{
  ...
  *(_OWORD *)&oa.SecurityDescriptor = 0LL;
  ...
  this->m_PowerIdleMachine.m_PowerTimeoutTimer.m_Timer.m_TimerCallback = FxPowerIdleMachine::_PowerTimeoutDpcRoutine;
