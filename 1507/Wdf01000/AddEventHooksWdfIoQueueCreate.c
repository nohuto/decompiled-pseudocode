/*
 * XREFs of AddEventHooksWdfIoQueueCreate @ 0x1C00CD960
 * Callers:
 *     imp_VfWdfIoQueueCreate @ 0x1C00CB3B0 (imp_VfWdfIoQueueCreate.c)
 * Callees:
        ...
        WDFQUEUE__ **Queue)
{
  ...
  _WDF_OBJECT_ATTRIBUTES attributes; // [rsp+90h] [rbp-19h] BYREF
  WDFQUEUE__ *queue; // [rsp+C8h] [rbp+1Fh] BYREF
