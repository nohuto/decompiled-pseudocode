/*
 * XREFs of DriverEntry @ 0x1C002BF00
 * Callers:
 *     GsDriverEntry @ 0x1C00D6000 (GsDriverEntry.c)
 * Callees:
 *     ?WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1C002C080 (-WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
 *     ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C002C28C (-FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z.c)
 *     __security_check_cookie @ 0x1C0030D80 (__security_check_cookie.c)
 *     memset @ 0x1C00333C0 (memset.c)
 *     ?FxLibraryCleanup@@YAXXZ @ 0x1C005D4A4 (-FxLibraryCleanup@@YAXXZ.c)
 */
