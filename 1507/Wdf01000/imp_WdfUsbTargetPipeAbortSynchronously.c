/*
 * XREFs of imp_WdfUsbTargetPipeAbortSynchronously @ 0x1C0089A00
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDF_REQUEST_SEND_OPTIONS *RequestOptions)
{
  ...
  FxSyncRequest::FxSyncRequest(&v16, m_Globals, &context, (unsigned __int64)Request);
  if ( m_Globals->FxVerboseOn )
    WPP_IFR_SF_q(m_Globals, 5u, 0xEu, 0x18u, WPP_FxUsbPipeAPI_cpp_Traceguids, _a1);
...
LABEL_22:
  ...
  v10 = FxUsbPipe::FormatAbortRequest(pUsbPipe, v16.m_TrueRequest);
  if ( v10 >= 0 )
  {
    if ( m_Globals->FxVerboseOn )
    {
      ...
      WPP_IFR_SF_qq(m_Globals, 5u, 0xEu, 0x1Au, WPP_FxUsbPipeAPI_cpp_Traceguids, _a1, _a2);
    }
    v10 = FxIoTarget::SubmitSync(pUsbPipe, v16.m_TrueRequest, RequestOptions, 0LL);
  }
  if ( m_Globals->FxVerboseOn )
    WPP_IFR_SF_qd(m_Globals, 5u, 0xEu, 0x1Bu, WPP_FxUsbPipeAPI_cpp_Traceguids, _a1, v10);
LABEL_35:
