/*
 * XREFs of imp_WdfDmaTransactionDmaCompleted @ 0x1C005E440
 * Callers:
 *     <none>
 * Callees:
        ...
        int *pStatus)
{
  ...
  if ( !DmaTransaction )
    FxVerifierBugCheckWorker(
      ...
      0LL,
      0x1401uLL);
  v4 = (FxDmaTransactionBase *)(~DmaTransaction & 0xFFFFFFFFFFFFFFF8uLL);
  LOWORD(Offset) = 0;
  if ( (DmaTransaction & 1) != 0 )
  {
    Offset = LOWORD(v4->__vftable);
    v4 = (FxDmaTransactionBase *)((char *)v4 - Offset);
  }
  if ( v4->m_Type == 5121 )
  {
    pDmaTrans = v4;
  ...
  {
    FxObjectHandleGetPtrQI(v4, (void **)&pDmaTrans, (void *)DmaTransaction, 0x1401u, Offset);
    v4 = pDmaTrans;
  }
  if ( !pStatus )
    FxVerifierNullBugCheck(v4->m_Globals, retaddr);
  return FxDmaTransactionBase::DmaCompleted(v4, 0LL, pStatus, FxDmaCompletionTypeFull);
}
