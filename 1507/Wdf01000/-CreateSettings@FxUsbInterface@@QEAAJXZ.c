/*
 * XREFs of ?CreateSettings@FxUsbInterface@@QEAAJXZ @ 0x1C008F40C
 * Callers:
 ...
 *     ?FxUsbValidateDescriptorType@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAU_USB_CONFIGURATION_DESCRIPTOR@@PEAX2J_KW4FxUsbValidateDescriptorOp@@K@Z @ 0x1C0092C34 (-FxUsbValidateDescriptorType@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAU_USB_CONFIGURATION_DESCRIPTOR@@PEAX.c)
 */
...
__int64 __fastcall FxUsbInterface::CreateSettings(FxUsbInterface *this)
{
  ...
  _USB_CONFIGURATION_DESCRIPTOR *v9; // r8
  ...
  if ( v6 )
  {
    ...
    v9 = m_ConfigDescriptor;
    while ( 1 )
    {
      v11 = FxUsbFindDescriptorType(m_ConfigDescriptor, m_ConfigDescriptor->wTotalLength, v9, 4);
      ...
      v9 = (_USB_CONFIGURATION_DESCRIPTOR *)(&v12->bLength + v12->bLength);
      m_ConfigDescriptor = this->m_UsbDevice->m_ConfigDescriptor;
    }
    v13 = 0;
    ...
    while ( 1 )
    {
      ...
      if ( bNumEndpoints )
      {
        ...
        v18 = FxUsbFindDescriptorType(v16, v16->wTotalLength, InterfaceDescriptor, 4);
        if ( !v18 )
