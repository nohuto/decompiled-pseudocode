/*
 * XREFs of ??0FxResourceCollection@@IEAA@PEAU_FX_DRIVER_GLOBALS@@GGE@Z @ 0x1C001EB08
 * Callers:
        ...
        unsigned __int8 AccessFlags)
{
  ...
  this->__vftable = (FxResourceCollection_vtbl *)&FxObject::`vftable'.WdfVerifierAllocateFailCount;
