/*
 * XREFs of ?Reset@FxUsbDevice@@QEAAJXZ @ 0x1C008E8F0
 * Callers:
...
__int64 __fastcall FxUsbDevice::Reset(FxUsbDevice *this)
{
  ...
  FxIoTarget *v8; // [rsp+38h] [rbp-D0h]
  FxRequestBuffer emptyBuffer; // [rsp+40h] [rbp-C8h] BYREF
  FxIoContext context; // [rsp+60h] [rbp-A8h] BYREF
  FxSyncRequest request; // [rsp+110h] [rbp+8h] BYREF
  ...
  *(_QWORD *)&context.m_CompletionParams.Size = &FxIoContext::`vftable';
  ...
  FxSyncRequest::FxSyncRequest(
    ...
    0LL);
  *(_OWORD *)&emptyBuffer.u.RefMdl.Offsets = 0uLL;
  context.__vftable = 0LL;
  LODWORD(emptyBuffer.u.Memory.Memory) = 0;
  v4 = FxIoTarget::FormatIoctlRequest(
         this,
         *(FxRequestBase **)&request.m_ClearContextOnDestroy,
         0x220007u,
         1u,
         (FxRequestBuffer *)&emptyBuffer.u,
         (FxRequestBuffer *)&emptyBuffer.u,
         v8);
  if ( v4 >= 0 )
  {
