/*
 * XREFs of ?GetDeviceControlOutputMemoryObject@FxRequest@@QEAAJPEAPEAVIFxMemory@@PEAPEAXPEA_K@Z @ 0x1C0004350
 * Callers:
...
$Done:
  if ( (this->m_RequestBaseStaticFlags & 2) == 0 )
  {
    ...
    {
      FxVerifierLock::Unlock(m_ForwardProgressQueue, v4, MajorFunction);
    }
    else
    {
