/*
 * XREFs of RtlUnicodeStringCopy @ 0x1C0005B88
 * Callers:
 *     GetImageName @ 0x1C00059B4 (GetImageName.c)
 * Callees:
 *     RtlWideCharArrayCopyWorker @ 0x1C0005C2C (RtlWideCharArrayCopyWorker.c)
 *     RtlUnicodeStringValidateWorker @ 0x1C002C400 (RtlUnicodeStringValidateWorker.c)
 */
