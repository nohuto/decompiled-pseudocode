/*
 * XREFs of RegistryReadLastLoggedTime @ 0x1C0006C04
 * Callers:
 *     IsLoggingEnabledAndNeeded @ 0x1C0028D50 (IsLoggingEnabledAndNeeded.c)
 * Callees:
...
void __fastcall RegistryReadLastLoggedTime(_FX_DRIVER_GLOBALS *DriverGlobals, _LARGE_INTEGER *LastLoggedTime)
{
  ...
  FxAutoRegKey hKey; // [rsp+30h] [rbp-69h] BYREF
  FxAutoRegKey hWdf; // [rsp+38h] [rbp-61h] BYREF
  _LARGE_INTEGER value; // [rsp+40h] [rbp-59h] BYREF
  _UNICODE_STRING parametersPath; // [rsp+48h] [rbp-51h] BYREF
  _OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+58h] [rbp-41h] BYREF
