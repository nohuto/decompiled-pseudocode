/*
 * XREFs of VfEvtIoInternalDeviceControl @ 0x1C00CF630
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int IoControlCode)
{
  ...
  v11 = (void (__fastcall *)(WDFQUEUE__ *, unsigned __int64, unsigned __int64, void *, unsigned int))*((_QWORD *)TypedContext + 7);
  if ( v11 )
  {
    ActivityId.Data1 = 0;
