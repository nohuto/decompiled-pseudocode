/*
 * XREFs of ?QueryForD3ColdInterface@FxPkgPnp@@QEAAXXZ @ 0x1C0018E00
 * Callers:
...
void __fastcall FxPkgPnp::QueryForD3ColdInterface(FxPkgPnp *this)
{
  ...
  FxCREvent Event; // [rsp+30h] [rbp-38h] BYREF
    ...
    && !this->m_D3ColdInterface.SetD3ColdSupport )
  {
    ...
    if ( _a1 )
    {
      ...
      if ( AttachedDeviceReference )
      {
        ...
        if ( Irp )
        {
          v8 = Irp->Tail.Overlay.CurrentStackLocation - 1;
          ...
          v10 = (__int64)&v1->Tail.Overlay.CurrentStackLocation[-1];
          Event.m_Event.m_DbgFlagIsInitialized = 1;
          *(_QWORD *)(v10 + 56) = FxIrp::_IrpSynchronousCompletion;
          *(_QWORD *)(v10 + 64) = &Event;
          *(_BYTE *)(v10 + 3) = -32;
