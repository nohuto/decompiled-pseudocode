/*
 * XREFs of ?Connect@FxInterrupt@@QEAAJK@Z @ 0x1C0029F58
 * Callers:
    ...
    || !m_WakeInterruptMachine->m_ActiveForWake )
  {
          ...
          _a4 < 0) )
    {
      ...
      if ( m_DeviceBase->m_ObjectSize )
        ...
        v11 = 0LL;
      WPP_IFR_SF_qqqd(m_Globals, 2u, 0xCu, 0x19u, WPP_InterruptObject_cpp_Traceguids, v11, v9, this->m_Interrupt, _a4);
    }
    else
    {
      this->m_Enabled = 1;
