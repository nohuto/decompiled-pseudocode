/*
 * XREFs of ?_Create@FxMemoryBuffer@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@K_KW4_POOL_TYPE@@PEAPEAVFxMemoryObject@@@Z @ 0x1C0025E34
 * Callers:
        ...
        FxMemoryObject **Object)
{
  ...
  if ( v8 )
  {
    ...
    v8->IFxMemory::__vftable = (IFxMemory_vtbl *)&FxMemoryBuffer::`vftable'{for `IFxMemory'};
  }
  else
  {
    v8 = 0LL;
