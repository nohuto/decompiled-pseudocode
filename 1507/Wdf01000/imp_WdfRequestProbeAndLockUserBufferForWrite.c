/*
 * XREFs of imp_WdfRequestProbeAndLockUserBufferForWrite @ 0x1C006EEC0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFMEMORY__ **MemoryObject)
{
  ...
  {
    if ( m_Globals->FxVerifierOn
      && (_FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(v7->m_Globals, Request, 9u) || m_Globals->FxVerifyDownlevel) )
    {
      FxNonPagedObject::Lock(v7, (unsigned __int8 *)&irql, v13);
      if ( m_Globals->FxVerifierOn )
...
LABEL_29:
    _a1 = FxRequest::ProbeAndLockForWrite(v7, Buffer, v5, (FxRequestMemory **)&irql);
    IsDriverOwned = _a1;
    if ( _a1 >= 0 )
    {
      if ( *(_WORD *)(irql + 10) )
