/*
 * XREFs of imp_WdfRequestRetrieveUnsafeUserInputBuffer @ 0x1C006F6C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
    ...
    if ( CurrentStackLocation->MajorFunction == 3 )
    {
      ...
      v19 = 29;
LABEL_30:
      WPP_IFR_SF_qd(m_Globals, 5u, 0x10u, v19, WPP_FxRequestApi_cpp_Traceguids, (const void *)Request, -1073741808);
      return 3221225488LL;
    }
    if ( MajorFunction == 15 )
    {
...
LABEL_39:
        ...
        *InputBuffer = CurrentStackLocation->Parameters.CreatePipe.Parameters;
        if ( v11 )
        {
          v22 = v8->m_Irp.m_Irp->Tail.Overlay.CurrentStackLocation->Parameters.Create.Options;
LABEL_43:
          *v11 = v22;
          return 0LL;
        }
    ...
    else if ( MajorFunction == 4 && *(_DWORD *)(v18 + 212) == 1 )
    {
      ...
      *InputBuffer = v8->m_Irp.m_Irp->UserBuffer;
      if ( v11 )
      {
        v22 = v8->m_Irp.m_Irp->Tail.Overlay.CurrentStackLocation->Parameters.Read.Length;
        goto LABEL_43;
      }
      return 0LL;
    }
    WPP_IFR_SF_qd(m_Globals, 2u, 0x10u, 0x21u, WPP_FxRequestApi_cpp_Traceguids, (const void *)Request, -1073741808);
    irql = 7567731;
    Mx::MxDbgPrint(
