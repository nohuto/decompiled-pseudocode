/*
 * XREFs of imp_WdfChildListEndScan @ 0x1C002F190
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall imp_WdfChildListEndScan(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 DeviceList)
{
  FxChildList *v3; // rcx
  ...
  {
    WPP_IFR_SF_q(m_Globals, 5u, 0xCu, 0x14u, WPP_FxChildListAPI_cpp_Traceguids, (const void *)DeviceList);
    v3 = pList;
  }
  FxChildList::EndScan(v3, Offset);
}
