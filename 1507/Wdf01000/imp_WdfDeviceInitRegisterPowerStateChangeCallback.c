/*
 * XREFs of imp_WdfDeviceInitRegisterPowerStateChangeCallback @ 0x1C006B6E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int CallbackTypes)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
LABEL_19:
        v14 = (char *)&DeviceInit->PnpPower.PowerStateCallbacks[-8] + 16 * v8 - 384;
        result = 0LL;
