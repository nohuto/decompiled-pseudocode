/*
 * XREFs of ??0FxInterrupt@@QEAA@PEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0029D94
 * Callers:
...
{
  FxNonPagedObject::FxNonPagedObject(this, (_FX_DRIVER_GLOBALS *)0x1027, 0x1C8u, Globals);
  ...
  *(_WORD *)&this->m_UseSoftDisconnect = 0;
  ...
  KeInitializeDpc(&this->m_Dpc, FxInterrupt::_InterruptDpcThunk, this);
  this->m_Active = 0;
  ...
  *(_QWORD *)&this->m_Policy = 2LL;
  this->m_Processors.Mask = 0LL;
  *(_QWORD *)&this->m_Processors.Group = 0LL;
  this->m_SetPolicy = 0;
