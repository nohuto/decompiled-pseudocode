/*
 * XREFs of imp_WdfRequestAllocateTimer @ 0x1C006E150
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall imp_WdfRequestAllocateTimer(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Request)
{
  __int64 Offset; // r8
  FxRequest *v3; // rcx
  ...
  return FxRequestBase::CreateTimer(v3);
}
