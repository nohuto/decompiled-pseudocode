/*
 * XREFs of imp_WdfIoQueueStopSynchronously @ 0x1C0094610
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall imp_WdfIoQueueStopSynchronously(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Queue)
{
  FxIoQueue *v2; // rcx
  __int64 Offset; // r8
  ...
  {
    v6 = FxIoQueue::QueueIdleSynchronously(v2, 0);
    if ( v6 < 0 )
