/*
 * XREFs of ?ConfigureConstraints@FxPkgGeneral@@AEAAJPEAU_LIST_ENTRY@@@Z @ 0x1C000F578
 * Callers:
...
__int64 __fastcall FxPkgGeneral::ConfigureConstraints(FxPkgGeneral *this, _LIST_ENTRY *FileObjInfoList)
{
  ...
  _WDF_EXECUTION_LEVEL parentExecLevel; // [rsp+78h] [rbp+10h] BYREF
  _WDF_SYNCHRONIZATION_SCOPE parentSynchScope; // [rsp+80h] [rbp+18h] BYREF
  ...
  v8 = v7 - 9;
  this->m_ExecutionLevel = 3 - (IsVersionGreaterThanOrEqualTo != 0);
