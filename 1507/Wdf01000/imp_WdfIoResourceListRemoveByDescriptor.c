/*
 * XREFs of imp_WdfIoResourceListRemoveByDescriptor @ 0x1C007EA40
 * Callers:
 *     <none>
 * Callees:
        ...
        _IO_RESOURCE_DESCRIPTOR *Descriptor)
{
  ...
  FxIoResList *pList; // [rsp+78h] [rbp+48h] BYREF
...
LABEL_18:
    ...
    if ( SLOBYTE(v8->m_ObjectFlags) < 0 && v8[-1].m_ListHead.Blink )
      FxVerifierLock::Unlock((FxVerifierLock *)v8[-1].m_ListHead.Blink, irql, v7);
    else
  ...
  {
    WPP_IFR_SF_q(m_Globals, 2u, 0xCu, 0xFu, WPP_FxResourceAPI_cpp_Traceguids, _a1);
    irql = 7567731;
    Mx::MxDbgPrint(
