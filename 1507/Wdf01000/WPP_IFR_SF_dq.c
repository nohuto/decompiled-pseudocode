/*
 * XREFs of WPP_IFR_SF_dq @ 0x1C005FB50
 * Callers:
 ...
 *     ?FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ @ 0x1C0061190 (-FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ.c)
