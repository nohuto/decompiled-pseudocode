/*
 * XREFs of imp_WdfDeviceGetCharacteristics @ 0x1C0070FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall imp_WdfDeviceGetCharacteristics(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 Device)
{
  __int64 Offset; // r8
  FxDevice *v3; // rcx
  ...
  return v3->m_DeviceObject.m_DeviceObject->Characteristics;
}
