/*
 * XREFs of VfEvtIoDefault @ 0x1C00CF1B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VfEvtIoDefault(WDFQUEUE__ *Queue, unsigned __int64 Request)
{
  ...
  void (__fastcall *v6)(WDFQUEUE__ *, unsigned __int64); // r15
  FxObject *v7; // rcx
  FxObject *v8; // r10
  ...
  if ( v6 )
  {
    ...
    *(_DWORD *)&ActivityId.Data4[4] = 0;
    ...
    if ( (m_Globals->FxEnhancedVerifierOptions & 0xF00000) != 0 )
    {
      ...
      {
        FxObjectHandleGetPtrQI(v7, &PPObject, (void *)Request, 0x1008u, Offset);
    ...
    else
    {
      ...
      if ( CurrentIrql != v16 )
        FxVerifierBugCheckWorker(
          ...
          CurrentIrql,
          v16);
      v17 = *(_QWORD *)TypedContext;
      if ( KeGetCurrentIrql() <= 1u && v4 != KeAreApcsDisabled() )
        FxVerifierBugCheckWorker(
          (_FX_DRIVER_GLOBALS *)(v17 - 416),
