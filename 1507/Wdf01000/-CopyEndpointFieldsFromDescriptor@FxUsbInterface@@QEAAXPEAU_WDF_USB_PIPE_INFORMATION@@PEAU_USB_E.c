/*
 * XREFs of ?CopyEndpointFieldsFromDescriptor@FxUsbInterface@@QEAAXPEAU_WDF_USB_PIPE_INFORMATION@@PEAU_USB_ENDPOINT_DESCRIPTOR@@E@Z @ 0x1C008F3A8
 * Callers:
        ...
        unsigned __int8 SettingIndex)
{
  ...
  v4 = FxUsbPipe::_UsbdPipeTypeToWdf((_USBD_PIPE_TYPE)(EndpointDesc->bmAttributes & 3));
  *(_DWORD *)(v5 + 12) = v4;
  if ( v4 == WdfUsbPipeTypeControl )
    *(_DWORD *)(v5 + 16) = 4096;
  else
    *(_DWORD *)(v5 + 16) = (*(_BYTE *)(*(_QWORD *)(v7 + 120) + 484LL) & 4) != 0 ? 0x200000 : 0x40000;
  *(_BYTE *)(v5 + 10) = v6;
}
