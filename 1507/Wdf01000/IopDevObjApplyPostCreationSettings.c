/*
 * XREFs of IopDevObjApplyPostCreationSettings @ 0x1C00D3534
 * Callers:
 *     IoDevObjCreateDeviceSecure @ 0x1C00D33E0 (IoDevObjCreateDeviceSecure.c)
 * Callees:
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00D35EC (SeUtilSecurityInfoFromSecurityDescriptor.c)
 */
