/*
 * XREFs of ?SelectConfigSingle@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_WDF_USB_DEVICE_SELECT_CONFIG_PARAMS@@@Z @ 0x1C008EDA0
 * Callers:
        ...
        _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS *Params)
{
  ...
  ConfigRequest = FxUsbCreateConfigRequest(this->m_Globals, this->m_ConfigDescriptor, listEntry, 0xFFFFFFFF);
  v13 = ConfigRequest;
  if ( ConfigRequest )
  {
