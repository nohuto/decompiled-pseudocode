/*
 * XREFs of FxLibraryGlobalsVerifyVersion @ 0x1C002AE28
 * Callers:
...
__int64 (__fastcall *FxLibraryGlobalsVerifyVersion())(_OSVERSIONINFOEXW *, __int64, __int64)
{
  ...
  __int64 v5; // r8
  __int64 v6; // rax
  _UNICODE_STRING SystemRoutineName; // [rsp+20h] [rbp-158h] BYREF
  _UNICODE_STRING DestinationString; // [rsp+30h] [rbp-148h] BYREF
