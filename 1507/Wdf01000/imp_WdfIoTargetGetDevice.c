/*
 * XREFs of imp_WdfIoTargetGetDevice @ 0x1C002F6B0
 * Callers:
 *     <none>
 * Callees:
...
WDFDEVICE__ *__fastcall imp_WdfIoTargetGetDevice(_WDF_DRIVER_GLOBALS *DriverGlobals, unsigned __int64 IoTarget)
{
  ...
  {
    WPP_IFR_SF_q(m_Globals, 5u, 0xEu, 0x19u, WPP_FxIoTargetAPI_cpp_Traceguids, _a1);
    v3 = pTarget;
  }
  ...
  if ( m_DeviceBase->m_ObjectSize )
    ...
    _a2 = 0LL;
  if ( m_Globals->FxVerboseOn )
    WPP_IFR_SF_qq(m_Globals, 5u, 0xEu, 0x1Au, WPP_FxIoTargetAPI_cpp_Traceguids, _a1, _a2);
