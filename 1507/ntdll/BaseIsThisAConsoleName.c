/*
 * XREFs of BaseIsThisAConsoleName @ 0x1800F8DC0
 * Callers:
  ...
  if ( *a1 )
  {
      ...
      || (_WORD)v5 == 110 )
    {
      ...
      *(_QWORD *)&String1.Length = *(_QWORD *)a1;
      ...
      v3 = 0LL;
      if ( RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_18011DB68, 1u) )
        return &stru_18011DB68;
      v13 = &stru_18011DB58;
      if ( !RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_18011DB58, 1u) )
      {
        if ( !RtlEqualUnicodeString(&String1, (PUNICODE_STRING)&stru_18011DB48, 1u) )
