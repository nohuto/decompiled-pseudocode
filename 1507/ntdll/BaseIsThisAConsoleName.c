...
unsigned __int16 *__fastcall BaseIsThisAConsoleName(unsigned __int16 *a1, int a2)
{
  ...
  if ( *a1 )
  {
      ...
      || (_WORD)v5 == 110 )
    {
      ...
      v3 = 0LL;
      if ( RtlEqualUnicodeString((unsigned __int16 *)&v16, word_18011DB68, 1) )
        return word_18011DB68;
      v13 = word_18011DB58;
      if ( !RtlEqualUnicodeString((unsigned __int16 *)&v16, word_18011DB58, 1) )
      {
        if ( !RtlEqualUnicodeString((unsigned __int16 *)&v16, word_18011DB48, 1) )
