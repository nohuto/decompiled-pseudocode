/*
 * XREFs of RtlpCreateLowFragHeap @ 0x180004D48
 * Callers:
 *     RtlpActivateLowFragmentationHeap @ 0x180004B5C (RtlpActivateLowFragmentationHeap.c)
 * Callees:
 *     RtlpInitializeLowFragHeap @ 0x180004F28 (RtlpInitializeLowFragHeap.c)
...
PVOID __fastcall RtlpCreateLowFragHeap(_DWORD *BaseAddress)
{
  ...
  {
    RegionSize = 0LL;
    RtlpSecMemFreeVirtualMemory(v10, &BaseAddressa, &RegionSize, 0x8000LL);
    return 0LL;
  }
