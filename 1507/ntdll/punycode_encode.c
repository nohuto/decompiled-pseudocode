/*
 * XREFs of punycode_encode @ 0x18005D63C
 * Callers:
 *     RtlpNameprepAsciiWorker @ 0x18005E190 (RtlpNameprepAsciiWorker.c)
 * Callees:
 *     RtlStringCopyWorkerW @ 0x1800023AC (RtlStringCopyWorkerW.c)
 *     adapt @ 0x180002BAC (adapt.c)
 *     FindLabelEnd @ 0x18005F028 (FindLabelEnd.c)
 *     ValidateStd3Range @ 0x18007ECE4 (ValidateStd3Range.c)
 *     _wcsnicmp @ 0x180085900 (_wcsnicmp.c)
 *     GetUTF32 @ 0x1800E2280 (GetUTF32.c)
 */
