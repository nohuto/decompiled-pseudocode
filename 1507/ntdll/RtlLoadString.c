/*
 * XREFs of RtlLoadString @ 0x180066530
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( v11 )
    {
      v12 = LdrResSearchResource(a1, v21, 4u, 1u, (__int64)&v18, (__int64 *)&v17, a7, a8);
      if ( v12 >= 0 && v17 > 0xFFFF )
        v12 = -1073741701;
    }
    else
    {
      v12 = LdrpSearchResourceSection_U(a1, (__int64)v21, 4u, 1u, (unsigned __int64 *)&v19);
      if ( v12 < 0 )
        return (unsigned int)v12;
      v12 = LdrpAccessResourceData(a1, v19, &v18, 0LL);
    }
    if ( v12 >= 0 && v18 )
    {
      v13 = 0;
