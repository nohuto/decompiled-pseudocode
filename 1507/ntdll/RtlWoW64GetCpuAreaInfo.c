/*
 * XREFs of RtlWoW64GetCpuAreaInfo @ 0x1800675D0
 * Callers:
 *     RtlWoW64GetCurrentCpuArea @ 0x180067550 (RtlWoW64GetCurrentCpuArea.c)
 * Callees:
 *     RtlpGetContextFlagsLocation @ 0x180067664 (RtlpGetContextFlagsLocation.c)
 *     RtlpGetLegacyContextLength @ 0x18006767C (RtlpGetLegacyContextLength.c)
 */
