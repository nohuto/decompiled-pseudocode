/*
 * XREFs of RtlActivateActivationContextEx @ 0x1800535B0
 * Callers:
 *     RtlActivateActivationContext @ 0x180053560 (RtlActivateActivationContext.c)
 * Callees:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( a4 )
    *a4 = 0LL;
  v6 = (volatile signed __int32 *)&unk_1801021A8;
