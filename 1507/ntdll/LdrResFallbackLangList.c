/*
 * XREFs of LdrResFallbackLangList @ 0x18001BC14
 * Callers:
...
__int64 __fastcall LdrResFallbackLangList(__int64 a1, __int64 a2, __int64 a3, int a4, unsigned __int16 *a5)
{
  __int64 v6; // r10
  int v7; // esi
  ...
  unsigned __int16 v31; // [rsp+3Ch] [rbp-44h] BYREF
  int v32; // [rsp+40h] [rbp-40h] BYREF
  char v33; // [rsp+44h] [rbp-3Ch] BYREF
...
LABEL_27:
    ...
    if ( (_DWORD)v15 )
    {
      ...
      if ( !v16 )
      {
        if ( !v6 )
          goto LABEL_35;
        if ( (int)RtlpResUltimateFallbackInfo(v6, a2, (unsigned int)&SourceString, (unsigned int)&v33, a4) < 0 )
          goto LABEL_34;
...
LABEL_35:
      ...
      if ( v17 )
      {
        ...
        if ( (_DWORD)v18 )
        {
          ...
          CurrentLocale = -4370;
          v25 = NtQueryDefaultLocale(0LL, &v32, a3);
          a3 = v42;
          v6 = a1;
          v11 = v25;
          a2 = v41;
        ...
        else
        {
          LODWORD(v18) = 1;
          CurrentLocale = -4370;
          v26 = NtQueryDefaultLocale(v18, &v30, a3);
          a3 = v42;
          v6 = a1;
          v11 = v26;
          a2 = v41;
    ...
    {
      v28[0] = 0;
      if ( (unsigned __int8)LdrpSetThreadPreferredLangList(v15, a2, a3)
  ...
  if ( (a4 & 4) == 0 )
  {
    ...
    {
      *((_BYTE *)v8 + 516) = 1;
      if ( (int)LdrpGetParentLangId(CurrentLocale, &v29, a3) < 0 )
        goto LABEL_29;
      CurrentLocale = v29;
      if ( v29 )
        --v9;
