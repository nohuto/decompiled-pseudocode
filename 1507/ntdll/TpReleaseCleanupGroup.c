/*
 * XREFs of TpReleaseCleanupGroup @ 0x180075E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TpReleaseCleanupGroup(volatile signed __int32 *a1, __int64 a2)
{
  __int64 result; // rax

  if ( !a1 )
    return TppRaiseInvalidParameter(a1, a2, a1);
