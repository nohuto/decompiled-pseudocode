/*
 * XREFs of RtlCheckTokenCapability @ 0x18004AAA0
 * Callers:
 ...
 *     RtlIsCapabilitySid @ 0x18004E940 (RtlIsCapabilitySid.c)
...
NTSTATUS __cdecl RtlCheckTokenCapability(HANDLE TokenHandle, PSID CapabilitySidToCheck, PBOOLEAN HasCapability)
{
  ...
  NTSTATUS AccessStatus; // [rsp+48h] [rbp-B8h] BYREF
  ACCESS_MASK GrantedAccess; // [rsp+4Ch] [rbp-B4h] BYREF
  ULONG ReturnLength; // [rsp+50h] [rbp-B0h] BYREF
  ULONG PrivilegeSetLength; // [rsp+54h] [rbp-ACh] BYREF
