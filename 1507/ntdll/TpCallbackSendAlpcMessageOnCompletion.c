/*
 * XREFs of TpCallbackSendAlpcMessageOnCompletion @ 0x180061F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TpCallbackSendAlpcMessageOnCompletion(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  v5 = a3;
  if ( a1 && (v8 = *(_QWORD *)(a1 + 136)) != 0 && *(_QWORD *)(v8 + 264) == a2 && (*(_BYTE *)(a1 + 228) & 1) == 0 )
  {
    v9 = a4[1];
    ...
    *(_QWORD *)(a1 + 208) = Heap;
    if ( Heap )
    {
      memmove(Heap, a4, v9);
      *(_QWORD *)(a1 + 216) = a2;
      _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(a1 + 136) + 272LL));
      *(_DWORD *)(a1 + 228) |= 1u;
