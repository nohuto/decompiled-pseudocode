...
__int64 __fastcall LdrpAppCompatRedirect(__int64 a1, _OWORD *a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  unsigned int v6; // esi
  _OWORD *v12; // rbx
  void (__fastcall *v13)(__int128 *, _BYTE *, _OWORD *); // rdi
  _WORD *v14; // rax
  ...
  if ( g_ShimsEnabled )
  {
    v15[0] = 0;
    v12 = (_OWORD *)a1;
    v13 = (void (__fastcall *)(__int128 *, _BYTE *, _OWORD *))(MEMORY[0x7FFE0330] ^ __ROR8__(
    ...
    if ( v15[0] )
    {
      ...
      *(_WORD *)a4 = 0;
      *v14 = 0;
      return (unsigned int)LdrpResolveDllName(&v16, (__int128 *)a4, a3, a2, a5, *(_DWORD *)(a1 + 24));
    }
  }
  return v6;
}
