/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x1800736B0
 * Callers:
 *     LdrRelocateImage @ 0x1800735D8 (LdrRelocateImage.c)
 *     LdrProcessRelocationBlock @ 0x1800CBEE0 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800CBF10 (LdrProcessRelocationBlockEx.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1800CBF1C (LdrpArmProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x1800CBFEC (LdrpThumbProcessRelocation.c)
 */
