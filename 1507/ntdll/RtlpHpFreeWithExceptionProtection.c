...
__int64 __fastcall RtlpHpFreeWithExceptionProtection(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  int v3; // ebx
  ...
  if ( (RtlpHpHeapFeatures & 2) == 0 )
  {
    ...
    if ( *(_DWORD *)(a1 + 16) == -571548178 )
    {
      ...
      v8 = *(_DWORD *)(a1 + 20) & 0x11000001 | v7 & 0x11000001;
        ...
        if ( *(_DWORD *)(a1 + 32) )
        {
          ...
          if ( v10 )
          {
            if ( (*(_BYTE *)(v10 + 2) & 0xF) != 0 )
            {
              ...
              if ( (int)RtlpCallInterceptRoutine(*(_BYTE *)(v11 + 2) & 0xF, a1, v12, 3, v11 + 16) < 0 )
                goto LABEL_24;
            }
          }
        }
      }
      if ( (*(_DWORD *)(a1 + 20) & 0x10000000) != 0 && RtlpHpSizeHeap(a1, v4, v8) == -1 )
      {
      ...
      {
        v6 = RtlpHpSegFree(a1, v4, v8);
        goto LABEL_24;
      }
      if ( RtlpHpLargeFree(a1, v4, v8) )
        v6 = 1;
...
LABEL_24:
      ...
      if ( v6 )
      {
        RtlpLogHeapFreeEvent(a1, v4, 3LL);
        goto LABEL_24;
      }
LABEL_52:
    ...
    if ( (*(_DWORD *)(a1 + 116) & 0x1000000) != 0 )
      return (unsigned __int8)RtlpFreeHeap(a1, v3 | 2u, v7, v4);
    if ( (*(_BYTE *)(a1 + 120) & 1) != 0 )
    {
...
LABEL_97:
    ...
    {
      v15 = RtlpValidateLFHBlock(a1, v7);
      if ( !v15 )
      {
LABEL_90:
        if ( !v15 )
...
LABEL_91:
        ...
        if ( (v3 & 0x3C000102) == 0 )
        {
          ...
          if ( (int)RtlpCallInterceptRoutine(*(_DWORD *)(v4 - 8), a1, v4, 3, v23) < 0 )
            goto LABEL_52;
        }
        goto LABEL_97;
      }
    ...
    {
      if ( (unsigned __int16)RtlpLFHKey ^ (unsigned __int16)(*(_WORD *)(v7 + 8) ^ a1 ^ (v7 >> 4)) )
        v16 = 0LL;
      else
        v16 = *(_QWORD *)(v7
                        - (((unsigned int)RtlpLFHKey ^ *(_DWORD *)(v7 + 8) ^ (unsigned int)a1 ^ (unsigned int)(v7 >> 4)) >> 12));
  ...
  return (unsigned int)RtlpHpVirtFreeHeap(a1, a2, a3);
}
