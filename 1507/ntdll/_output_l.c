/*
 * XREFs of _output_l @ 0x18008A538
 * Callers:
 ...
 *     write_multi_char @ 0x18008ADD4 (write_multi_char.c)
...
LABEL_120:
                          ...
                          {
                            LOBYTE(v18) = 32;
                            write_multi_char(v18, v34, v52, &v43);
                          }
                          write_string(v45, v33, v52, &v43);
                          v36 = v52;
                          if ( (v6 & 0xC) == 8 )
                          {
                            LOBYTE(v35) = 48;
                            write_multi_char(v35, v34, v52, &v43);
                          }
                          v37 = SizeConverted;
                          if ( v48 && SizeConverted > 0 )
                          {
                            ...
                            while ( 1 )
                            {
                              ...
                              if ( wctomb_s(&v54, v58, 6uLL, v39) || !v54 )
                                break;
                              write_string(v58, (unsigned int)v54, v52, &v43);
                              if ( !v37 )
                                goto LABEL_134;
                            }
                            v12 = -1;
                          ...
                          {
                            write_string(v14, (unsigned int)SizeConverted, v36, &v43);
LABEL_134:
                            v12 = v43;
                          }
                          if ( v12 >= 0 && (v6 & 4) != 0 )
                          {
                            LOBYTE(v40) = 32;
                            write_multi_char(v40, v34, v52, &v43);
                            v5 = v53;
                            v7 = v47;
                            goto LABEL_158;
                          }
