...
__int64 __fastcall RtlpExtendHeap(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  __int64 v107; // [rsp+40h] [rbp-69h] BYREF
  __int64 v108; // [rsp+48h] [rbp-61h]
  unsigned __int64 v109; // [rsp+50h] [rbp-59h] BYREF
  unsigned __int64 v110; // [rsp+58h] [rbp-51h]
  __int64 *v111; // [rsp+60h] [rbp-49h]
  unsigned __int64 v112; // [rsp+68h] [rbp-41h] BYREF
  unsigned __int64 v113; // [rsp+70h] [rbp-39h]
  ...
  unsigned __int64 v126; // [rsp+128h] [rbp+7Fh] BYREF

  v126 = ((_DWORD)a2 + 4095) & 0xFFFFF000;
  v4 = 0LL;
  v5 = RtlpFindAndCommitPages(a1, &v126);
  v116 = v5;
  v6 = v5;
  if ( !v5 )
  {
    if ( (*(_BYTE *)(a1 + 112) & 2) != 0 )
    {
      ...
      if ( a2 + 0x2000 > v83 )
        v83 = a2 + 0x2000;
      if ( (*(_BYTE *)(a1 + 378) != 2 || !*(_QWORD *)(a1 + 368)) && v83 >= 0x3F4000 )
        *(_DWORD *)(a1 + 120) |= 0x20000000u;
      v109 = (v83 + 0xFFFF) & 0xFFFFFFFFFFFF0000uLL;
      if ( v109 >= 0xFD0000 )
        v109 = 16580608LL;
      HeapProtection = RtlpGetHeapProtection(a1, 1LL);
      if ( (int)ZwAllocateVirtualMemory(-1LL, &v107, 0LL, &v109, 0x2000, HeapProtection) < 0 )
      {
        while ( v109 != v84 )
        {
          v106 = v109 >> 1;
...
LABEL_145:
        *(_QWORD *)(a1 + 160) += v109;
        ...
        if ( (int)ZwAllocateVirtualMemory(-1LL, &v107, 0LL, &v112, 4096, HeapProtection) >= 0
          && RtlpInitializeHeapSegment(a1, v107, 112LL, v88, 2, v107, v107 + v112, v107 + v109 - 4096) )
        {
          if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
          {
            RtlpLogHeapCommit(a1, v107, v112, 4LL);
            RtlpLogHeapExtendEvent(a1, *(_QWORD *)(v107 + 64), v112, 16 * *(_QWORD *)(a1 + 192), MEMORY[0x7FFE0380]);
          }
          if ( MEMORY[0x7FFE038A] )
            RtlpLogHeapExtendEvent(a1, *(_QWORD *)(v107 + 64), v112, 16 * *(_QWORD *)(a1 + 192), MEMORY[0x7FFE038A]);
          if ( MEMORY[0x7FFE0388] )
            RtlpHeapLogRangeReserve(a1, v107, v109);
          v89 = *(_QWORD *)(v107 + 64);
          if ( *(_DWORD *)(a1 + 124) )
          {
            *(_DWORD *)(v89 + 8) ^= *(_DWORD *)(a1 + 136);
            if ( *(_BYTE *)(v89 + 11) != (*(_BYTE *)(v89 + 8) ^ (unsigned __int8)(*(_BYTE *)(v89 + 9) ^ *(_BYTE *)(v89 + 10))) )
              RtlpAnalyzeHeapFailure(a1, v89);
          }
          return *(_QWORD *)(v107 + 64);
        }
        RtlpSecMemFreeVirtualMemory(v87, &v107, &v109, 0x8000LL);
      }
    }
    if ( *(char *)(a1 + 112) >= 0
...
LABEL_25:
      ...
      *(_QWORD *)(v8 + 8) = v10;
      if ( (*(_BYTE *)(v7 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v7) )
      {
        ...
        if ( (v25 & 4) != 0 )
        {
          ...
          v101 = RtlCompareMemoryUlong(v7 + 32, v100, 4277075694LL);
          if ( v101 != v100 )
          {
            if ( NtCurrentPeb()->Ldr )
        ...
        *(_BYTE *)(v7 + 15) = 0;
        ...
        v126 += v26;
        *(_WORD *)(v7 + 8) = v126;
        *(_WORD *)(v7 + 16 * v126 + 12) = v126 ^ *(_WORD *)(a1 + 140);
      }
      else
      {
  ...
  if ( *(_DWORD *)(a1 + 124) )
  {
    v114 = *(_DWORD *)(a1 + 136) ^ *(_DWORD *)(v27 + 8);
    if ( HIBYTE(v114) != (BYTE2(v114) ^ (unsigned __int8)(BYTE1(v114) ^ v114)) )
      RtlpLogHeapFailure(3, a1, v6 + 16 * v126, 0, 0LL, 0LL);
  }
      ...
      *(_QWORD *)(v63 + 8) = v79;
      if ( (*(_BYTE *)(v27 + 10) & 8) == 0 || (unsigned __int8)RtlpCommitBlock(a1, v27) )
      {
        ...
        if ( (v80 & 4) != 0 )
        {
          ...
          v103 = RtlCompareMemoryUlong(v27 + 32, v102, 4277075694LL);
          if ( v103 != v102 )
          {
            if ( NtCurrentPeb()->Ldr )
              DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
        ...
        *(_WORD *)(v6 + 8) = v126;
        *(_WORD *)(16 * v126 + v6 + 12) = v126 ^ *(_WORD *)(a1 + 140);
        break;
      }
      RtlpDeCommitFreeBlock(a1, v27, *(unsigned __int16 *)(v27 + 8), 1);
    }
    else
    {
...
LABEL_123:
      ...
      while ( 2 )
      {
        ...
        if ( (int)(v110 - (unsigned __int16)v118) > 0 )
          goto LABEL_49;
        v60 = RtlpHeapListCompare(a1, *v44, v110, 1);
        v42 = v108;
        if ( v60 <= 0 )
        {
          v44 = (__int64 *)*v44;
...
LABEL_175:
        ...
        else
        {
          ...
          if ( v44 != v61 )
          {
            while ( (int)RtlpHeapListCompare(a1, (__int64)v61, v110, 1) > 0 )
            {
              v61 = (__int64 *)*v61;
              if ( v44 == v61 )
              {
...
LABEL_125:
      ...
      if ( v52 == (_DWORD)v56 )
        ++*((_DWORD *)v49 + 5);
      if ( !v57 || (v82 = RtlpHeapListCompare(a1, v57, v50, 1), v57 = v108, v82 <= 0) )
  ...
  *(_WORD *)(v29 + 12) = *(_WORD *)(a1 + 140) ^ v124;
