/*
 * XREFs of RtlIsUntrustedObject @ 0x1800CE890
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NtQuerySecurityObject @ 0x180094D20 (NtQuerySecurityObject.c)
 */
...
NTSTATUS __cdecl RtlIsUntrustedObject(HANDLE Handle, PVOID Object, PBOOLEAN IsUntrustedObject)
{
  ...
  ACL *v9; // rdi
  _BYTE *AceByType; // rax
  ULONG LengthNeeded; // [rsp+30h] [rbp-B8h] BYREF
  ULONG Index[3]; // [rsp+34h] [rbp-B4h] BYREF
  _BYTE SecurityDescriptor[128]; // [rsp+40h] [rbp-A8h] BYREF
