...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(*(_WORD *)(v17 + 92) - 2) > 1u )
    return 0LL;
  if ( (int)NtOpenKey(&v15, 3LL, &unk_180102888) < 0
    || (ValueKey = NtQueryValueKey(v15, &unk_18010D6A0, 2LL, v30, 80, v18), NtClose(v15), ValueKey < 0)
    || v31 != 4
    || v32 != 4
    || !v33 )
  {
    v10 = 0LL;
    v1 = 0;
    if ( (int)NtOpenKey(&v10, 131097LL, &unk_1801430E8) >= 0 )
    {
    ...
    if ( (int)NtOpenKey(&Handle, 1LL, &unk_180102858) >= 0 )
    {
    ...
    if ( (int)RtlFormatCurrentUserKeyPath(&UnicodeString) >= 0 )
    {
      ...
      {
LABEL_27:
        if ( (int)LdrLoadDll(0LL, 0LL, (__int64)&unk_18010D670, &v14) >= 0 )
        {
          v7 = v14;
          if ( (int)LdrGetProcedureAddressEx(v14, (unsigned int)&unk_18010D690, 0, (unsigned int)&v11, 0) >= 0 && v11 )
          {
