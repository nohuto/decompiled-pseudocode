/*
 * XREFs of LdrpGetMUILangConfigNode @ 0x1800D43FC
 * Callers:
 *     RtlpTraverseParents @ 0x18005548C (RtlpTraverseParents.c)
 * Callees:
 *     RtlpCompareConfigNodeWithSpec @ 0x1800D58F0 (RtlpCompareConfigNodeWithSpec.c)
 *     RtlpMuiRegGetLanginfoTypeNSpec @ 0x1800D6648 (RtlpMuiRegGetLanginfoTypeNSpec.c)
 */
