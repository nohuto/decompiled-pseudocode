...
__int64 __fastcall RtlGetUILanguageInfo(int a1, WCHAR *a2, _WORD *a3, unsigned int *a4, int *a5)
{
  ...
  unsigned __int16 *v34; // [rsp+58h] [rbp-39h]
...
LABEL_32:
      ...
      *(_DWORD *)&v35.Length = 11141120;
      ...
      if ( (int)RtlUnicodeStringToLcid(&DestinationString, &v30) < 0 || !RtlLCIDToCultureName(v30, (__int64)&v35) )
      {
        v13 = v31;
      ...
      v13 = v31;
      InstalledLanguageIndexByLangId = RtlpMuiRegGetInstalledLanguageIndexByLangId(v31, v30, 1, v27);
    }
    else
    {
      v26 = 0;
      RtlInitUnicodeString(&v35, v8);
      if ( !RtlCultureNameToLCID(&v35.Length, &v30) )
      {
        FallbackLanguagesAsMultiSZ = -1073741811;
        goto LABEL_32;
      }
