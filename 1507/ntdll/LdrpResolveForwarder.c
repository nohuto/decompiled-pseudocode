...
LABEL_27:
  ...
  if ( ProcedureAddress >= 0 )
  {
    ...
    if ( qword_1801572F0 )
    {
      if ( (unsigned __int64)v13 < *((_QWORD *)&xmmword_180157330 + 1)
        || (unsigned __int64)v13 >= *((_QWORD *)&xmmword_180157330 + 1)
                                  + (unsigned __int64)(unsigned int)qword_180157340 )
      {
        RtlpxLookupFunctionTable(*(_QWORD *)(v10 + 48), (__int64 *)&SourceString);
      }
      else
      {
        SourceString = (STRING)xmmword_180157330;
      }
