/*
 * XREFs of RtlUnicodeStringCopy @ 0x18006056C
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyWorker @ 0x1800605F4 (RtlWideCharArrayCopyWorker.c)
 *     RtlUnicodeStringValidateSrcWorker @ 0x180060658 (RtlUnicodeStringValidateSrcWorker.c)
 *     RtlUnicodeStringValidateDestWorker @ 0x180060694 (RtlUnicodeStringValidateDestWorker.c)
 */
