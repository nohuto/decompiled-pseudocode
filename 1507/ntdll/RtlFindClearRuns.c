/*
 * XREFs of RtlFindClearRuns @ 0x1800D29D0
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800D2C90 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
        ...
        BOOLEAN LocateLongestRuns)
{
  ...
  while ( 1 )
  {
    v19 = *(_BYTE *)Buffer;
    if ( v16 == v18 && v5 )
      v19 |= RtlBaseAceType[(SizeOfBitMap & 7) + 32];
    if ( !v19 )
    {
      LODWORD(v14) = v14 + 8;
      goto LABEL_39;
...
LABEL_20:
    ...
    v15 = v17 - v14 + 8;
    v37 = v15;
    v25 = RtlBaseAceType[v20 + 16] | *((_BYTE *)&unk_180108AD8 - v14) | v19;
    if ( v25 != 0xFF )
    {
      do
      {
