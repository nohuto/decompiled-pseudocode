/*
 * XREFs of RtlIdnToUnicode @ 0x18005E8F0
 * Callers:
...
__int64 __fastcall RtlIdnToUnicode(int a1, wchar_t *a2, int a3, void *a4, int *a5)
{
  ...
  *(_DWORD *)&v25[3] = 511;
  ...
  v17 = *(_QWORD *)&v25[7];
  if ( (v8 & 4) != 0
    && ((int)RtlIsNormalizedString(1LL, Src, (__int64)(*(_QWORD *)&v25[7] - (_QWORD)Src) >> 1, &v24) < 0 || !v24) )
  {
    return 3221227286LL;
  }
  ...
  {
    v19 = v15 - ((v9 != 0) + 1) - v18;
    Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, (int)v19);
    if ( !Heap )
      return 3221225495LL;
    for ( i = 0LL; i < (int)v19; ++i )
    {
      v22 = *(_WORD *)(v17 + 2 * i + 2);
    ...
    if ( (int)RtlIsNormalizedString((((v8 & 1) == 0) << 8) | 0xDu, v17 + 2, v19, &v24) >= 0 && v24 )
    {
      for ( j = 0LL; j < (int)v19; ++j )
      {
        if ( *(_BYTE *)(j + Heap) == 1 )
          *(_WORD *)(v17 + 2 * j + 2) -= 32;
      }
