/*
 * XREFs of RtlUnwindEx @ 0x180014200
 * Callers:
 ...
 *     __longjmp_internal @ 0x180098080 (__longjmp_internal.c)
 ...
 *     RtlpExecuteHandlerForUnwind @ 0x180096780 (RtlpExecuteHandlerForUnwind.c)
 */
...
LABEL_11:
    ...
    else
    {
      ...
      if ( *(_BYTE *)(v18 + 2) )
      {
        do
        {
          v84 = *(unsigned __int16 *)(v18 + 2 * v83 + 4);
          if ( (BYTE1(v84) & 0xF) == 3 )
            break;
          v83 = (unsigned int)RtlpUnwindOpSlots(v84) + (unsigned int)v83;
        }
        while ( (unsigned int)v83 < *(unsigned __int8 *)(v18 + 2) );
        v17 = ImageBase;
        v16 = v90;
      }
      if ( v19 < *(unsigned __int8 *)(v18 + 2 * v83 + 4) )
        goto LABEL_11;
    ...
    if ( v21 >= 2 )
    {
      ...
      if ( v64 )
      {
        ...
        if ( (HIBYTE(v65) & 0xF) == 6 )
        {
          ...
          if ( (v65 & 0x1000) != 0 )
          {
            v69 = v89->EndAddress - (unsigned __int8)v65;
            if ( v67 - v69 < (unsigned int)(unsigned __int8)v65 )
            {
LABEL_176:
              v38 = v89;
              RtlpUnwindEpilogue(v17, v66, v67 - v69, (_DWORD)v89, (__int64)v10, 0LL, 0LL, 0LL);
              v17 = ImageBase;
              v16 = v90;
              goto LABEL_44;
            }
          ...
          for ( i = 1; i < v64; ++i )
          {
            v71 = *(_WORD *)(v18 + 2LL * i + 4);
            if ( (HIBYTE(v71) & 0xF) != 6 )
              break;
            v66 = (unsigned __int8)v71 + (HIBYTE(v71) >> 4 << 8);
            if ( !v66 )
              break;
            v69 = v89->EndAddress - v66;
            if ( v67 - v69 < v68 )
            {
                ...
                else
                {
                  switch ( v29[2 * v30 + 5] & 0xF )
                  {
                    ...
                    case 2:
                      ...
                      break;
                    case 3:
                      v63 = *(&v10->Rax + (v29[3] & 0xF));
                      v10->Rsp = v63;
                      v10->Rsp = v63 - (v29[3] & 0xF0);
                      break;
                    case 5:
                    ...
                    case 8:
                      v30 = (unsigned int)(v30 + 1);
                      v72 = 16 * (unsigned int)*(unsigned __int16 *)&v29[2 * v30 + 4];
                      goto LABEL_121;
                    case 9:
                      v30 = (unsigned int)(v30 + 2);
                      v72 = *(unsigned __int16 *)&v29[2 * (unsigned int)(v30 - 1) + 4]
                          + (*(unsigned __int16 *)&v29[2 * v30 + 4] << 16);
LABEL_121:
                      v73 = (unsigned int)v34;
                      v10->FltSave.XmmRegisters[v73].Low = *(_QWORD *)(v72 + v11);
                      v10->FltSave.XmmRegisters[v73].High = *(_QWORD *)(v72 + v11 + 8);
                      break;
                    case 0xA:
                      v76 = (DWORD64 *)v10->Rsp;
                      v31 = 1;
    ...
    {
      v58 = *(_BYTE *)(v13 + 1);
      if ( v58 == -125 && *(_BYTE *)(v13 + 2) == 0xC4 )
      {
        j = (_BYTE *)(v13 + 4);
        goto LABEL_15;
      }
      if ( v58 == -127 && *(_BYTE *)(v13 + 2) == 0xC4 )
        goto LABEL_101;
    }
    if ( (v22 & 0xFE) != 0x48 )
      goto LABEL_15;
    ...
    v56 = *(_BYTE *)(v13 + 2) & 7;
    v23 = v56 | (8 * (v22 & 1u));
    if ( !(v56 | (8 * (v22 & 1))) || (_DWORD)v23 != (*(_BYTE *)(v18 + 3) & 0xF) )
      goto LABEL_15;
    v57 = *(_BYTE *)(v13 + 2) & 0xF8;
    if ( v57 != 96 )
    {
      if ( v57 != -96 )
        goto LABEL_15;
...
LABEL_15:
    ...
    else
    {
      if ( v25 == -21 )
        ...
        v59 = *(_DWORD *)(j + 1) + 5;
      v60 = (unsigned __int64)&j[v59 - v17];
      v61 = (__int64)v89;
      BeginAddress = v89->BeginAddress;
      if ( v60 >= BeginAddress )
      {
        if ( v60 < v89->EndAddress )
        {
          if ( v60 != BeginAddress || (*(_BYTE *)v18 & 0x20) != 0 )
            goto LABEL_24;
          goto LABEL_86;
        }
        v61 = (__int64)v89;
...
LABEL_89:
      ...
      if ( (v79 & 0xF8) != 0x58 )
        break;
      *(&v10->Rax + (v79 & 7 | (unsigned __int64)(8 * (v54 & 1u)))) = *(_QWORD *)v10->Rsp;
      v10->Rsp += 8LL;
      v52 += 2;
    }
    v55 = *(_QWORD *)v10->Rsp;
    ...
    if ( v16 )
    {
      ...
      do
      {
        ...
        if ( v44 )
        {
          ...
          v9 = v80;
          v10 = &v118;
          RtlpCopyContext(&v118, v80);
          RtlVirtualUnwind(0, v81, v13, v38, &v118, &HandlerData, &EstablisherFrame, 0LL);
          v11 = v106;
          v16 = v109;
          v40 = v112;
          HandlerData = v110;
