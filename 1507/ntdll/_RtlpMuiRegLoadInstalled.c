/*
 * XREFs of _RtlpMuiRegLoadInstalled @ 0x1800E9138
 * Callers:
 ...
 *     ValidateRegistrLangType @ 0x1800E8838 (ValidateRegistrLangType.c)
        ...
        if ( v10 + 24 <= 0x200 )
        {
          ...
          *(_OWORD *)(((unsigned __int64)&v17 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58) = 0LL;
          if ( (int)NtOpenKey() >= 0 )
          {
            ...
            v11 = *(_QWORD *)(((unsigned __int64)&v17 & 0xFFFFFFFFFFFFFFE0uLL) + 0x10);
