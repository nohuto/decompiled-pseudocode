/*
 * XREFs of RtlGetProductInfo @ 0x180072DB0
 * Callers:
 *     <none>
 * Callees:
 *     CompareVersions @ 0x180072EF0 (CompareVersions.c)
 *     __security_check_cookie @ 0x180084090 (__security_check_cookie.c)
 *     ZwQueryLicenseValue @ 0x180094CA0 (ZwQueryLicenseValue.c)
 */
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = *(_OWORD *)Type_8;
  v17 = xmmword_180106BA0;
  if ( (int)CompareVersions(Type_8, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801029A0, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_180102990, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
