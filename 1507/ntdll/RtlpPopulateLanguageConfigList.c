/*
 * XREFs of RtlpPopulateLanguageConfigList @ 0x180049D70
 * Callers:
 ...
 *     RtlpMuiRegValidateConfigNode @ 0x1800E8588 (RtlpMuiRegValidateConfigNode.c)
 */
        ...
        *(_WORD *)(((unsigned __int64)v23 & 0xFFFFFFFFFFFFFFE0uLL) + 0x54 + 2 * v15) = 0;
        ...
        if ( LanguageSpec >= 0 )
        {
          ...
          *(_WORD *)(((unsigned __int64)v23 & 0xFFFFFFFFFFFFFFE0uLL) + 0x22) = v18;
          ...
          if ( LanguageSpec >= 0 )
          {
            LanguageSpec = RtlpMuiRegValidateConfigNode(a3, v3 + 32);
            if ( LanguageSpec >= 0 )
            {
              if ( !v7 )
              {
