/*
 * XREFs of RtlpWnfWalkUserSubscriptionList @ 0x18000B74C
 * Callers:
...
__int64 __fastcall RtlpWnfWalkUserSubscriptionList(unsigned int *a1, _RTL_SRWLOCK *a2, int a3)
{
  ...
  unsigned int v6; // edi
  _RTL_SRWLOCK *v7; // rax
  volatile signed __int32 *Value; // rbx
  ...
  LARGE_INTEGER SystemTime; // [rsp+50h] [rbp-78h] BYREF
  PRTL_SRWLOCK SRWLock; // [rsp+58h] [rbp-70h]
  PVOID SubProcessTag; // [rsp+60h] [rbp-68h]
  __int64 v27; // [rsp+68h] [rbp-60h]
  __int64 v28; // [rsp+70h] [rbp-58h]
  volatile signed __int32 *v29; // [rsp+78h] [rbp-50h]
  ...
  while ( Value != (volatile signed __int32 *)v7 )
  {
    ...
    if ( !*((_DWORD *)Value + 22)
      ...
      && ((v10 & 1) != 0 && (!*((_DWORD *)v9 + 14) || (int)(a1[4] - *((_DWORD *)v9 + 14)) > 0)
       ...
       || (v10 & 0x10) != 0)
      && (!*((_DWORD *)v9 + 30) || SystemTime.QuadPart >= *((_QWORD *)v9 + 16) || *((_DWORD *)v9 + 37) < a1[4])
      && (!v3 || *((_DWORD *)v9 + 36)) )
    {
      v21 = 0;
      v23 = 0;
...
LABEL_10:
    Value = *(volatile signed __int32 **)Value;
    v29 = Value;
