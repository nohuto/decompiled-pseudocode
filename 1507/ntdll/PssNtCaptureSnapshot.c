  ...
  *((_DWORD *)BaseAddress + 2) = CaptureFlags;
  ...
  if ( (CaptureFlags & 2) != 0 )
  {
    ...
    if ( v9 )
    {
      ...
      *((_QWORD *)BaseAddress + 128) = v20 - v21;
      *((_QWORD *)BaseAddress + 129) = 1000000 * (v19 - v22) / v8;
    }
  }
  if ( (CaptureFlags & 0x800) != 0 )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      {
        PsspSampleCounters(&v19, &v20);
        *((_QWORD *)BaseAddress + 126) = v20 - v21;
        *((_QWORD *)BaseAddress + 127) = 1000000 * (v19 - v22) / v8;
      }
      goto LABEL_21;
    }
LABEL_31:
...
LABEL_34:
  ...
  *((_QWORD *)BaseAddress + 103) = MEMORY[0x7FFE0014];
  *((_QWORD *)BaseAddress + 102) = ProcessHandlea;
  if ( v9 )
  {
    PsspSampleCounters(&v19, &v20);
    v8 = v23;
    *((_QWORD *)BaseAddress + 124) = v20 - v21;
    *((_QWORD *)BaseAddress + 125) = 1000000 * (v19 - v22) / v8;
  }
  else
  {
    v8 = v23;
...
LABEL_44:
    if ( (CaptureFlags & 0x80u) != 0 )
    {
      ...
      if ( !v9 )
        return 0;
      PsspSampleCounters(&v19, &v20);
      *((_QWORD *)BaseAddress + 132) = v20 - v21;
      *((_QWORD *)BaseAddress + 133) = 1000000 * (v19 - v22) / v8;
    }
    if ( v9 )
    {
      PsspSampleCounters(&v19, &v20);
      *((_QWORD *)BaseAddress + 122) = v20 - v24;
      *((_QWORD *)BaseAddress + 123) = 1000000 * (v19 - v25) / v8;
    }
    return 0;
  }
  if ( v9 )
  ...
  if ( v16 >= 0 )
  {
    ...
    {
      PsspSampleCounters(&v19, &v20);
      *((_QWORD *)BaseAddress + 130) = v20 - v21;
      *((_QWORD *)BaseAddress + 131) = 1000000 * (v19 - v22) / v8;
    }
    goto LABEL_44;
  }
  PssNtFreeSnapshot(BaseAddress);
