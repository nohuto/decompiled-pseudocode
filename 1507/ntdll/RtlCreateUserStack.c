/*
 * XREFs of RtlCreateUserStack @ 0x180001780
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *a6 = 0LL;
    ...
    v21 = v18 - v16 >= v9;
    v24 = v16;
    v22 = ((__int64 (__fastcall *)(__int64, unsigned __int64 *, _QWORD, unsigned __int64 *, int, int))ZwAllocateVirtualMemory)(
            -1LL,
            &v34,
            0LL,
            &v24,
    ...
    if ( v22 < 0
      ...
      && (v34 = v23 - v9, v25 = v9, v22 = ZwAllocateVirtualMemory(-1LL, &v34, 0LL, &v25, 4096, 260, v24), v22 < 0) )
    {
