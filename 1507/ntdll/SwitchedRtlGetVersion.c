...
__int64 __fastcall SwitchedRtlGetVersion(int *a1)
{
  ...
  v1 = NtCurrentPeb();
  v2 = (__int64 (__fastcall *)(_QWORD))qword_180146EF8;
  v4 = 0;
  ...
  if ( v2
    || (qword_180146EF8 = SbSelectProcedure(2880154539LL, 0, (__int64)"kLsE", 0),
        (v2 = (__int64 (__fastcall *)(_QWORD))qword_180146EF8) != 0LL) )
  {
    v4 = v2(v2);
  }
  v5 = v4 - 1;
