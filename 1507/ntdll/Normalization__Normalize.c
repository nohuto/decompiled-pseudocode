/*
 * XREFs of Normalization__Normalize @ 0x18005F2DC
 * Callers:
 *     RtlpNormalizeStringWorker @ 0x18005F0E0 (RtlpNormalizeStringWorker.c)
 * Callees:
 *     Normalization__GuessCharCountBySize @ 0x180002FC8 (Normalization__GuessCharCountBySize.c)
