/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x18000CFA0
 * Callers:
 *     EtwpGetTimeZoneInformation @ 0x18000CB94 (EtwpGetTimeZoneInformation.c)
 *     RtlQueryTimeZoneInformation @ 0x18000CF90 (RtlQueryTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1800D4030 (RtlQueryDynamicTimeZoneInformation.c)
 * Callees:
...
__int64 __fastcall RtlpQueryTimeZoneInformationWorker(char *a1, size_t Size)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_DWORD *)a1 + 38) = -16;
    ...
    RegistryValues = RtlpQueryRegistryValues(0x40000000, (_DWORD)Handle, (unsigned int)v14, 0, 0LL, 1);
