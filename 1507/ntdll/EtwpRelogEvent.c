/*
 * XREFs of EtwpRelogEvent @ 0x1800F447C
 * Callers:
...
__int64 __fastcall EtwpRelogEvent(__int64 a1, __int64 a2)
{
  ...
  if ( *(_WORD *)a2 < 0x58u )
    return 87;
  if ( (*(_DWORD *)(a1 + 332) & 0x1000) != 0 )
    v5 = *(unsigned __int16 *)(a2 + 86);
  v6 = *(unsigned int *)(a2 + 80);
  if ( !(_DWORD)v6 )
  {
    ++*(_DWORD *)(a1 + 392);
    ++*(_DWORD *)(*(_QWORD *)(a1 + 520) + 12LL * v5 + 4);
    return 87;
  }
  v7 = *(_WORD *)(a2 + 84) & 0x7FF;
  if ( (*(_DWORD *)(a1 + 332) & 0x1000) != 0 )
    LODWORD(v7) = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(a1 + 512) + 8LL * v5) + 2 * v7);
  v8 = (void *)EtwpReserveTraceBuffer(a1, v6, v7, 0LL, &v11);
  if ( v8 )
  {
