...
unsigned __int64 __fastcall RtlpHpAllocateHeap(__int64 a1, unsigned __int64 a2, int a3)
{
  unsigned int v3; // eax
  int v4; // edi
  unsigned int v5; // edi
  ...
  if ( (v5 & 0x1000000) == 0 )
  {
    ...
    {
      v5 |= 8u;
      if ( (int)RtlpCallInterceptRoutine(v6, a1, 0, 1, (__int64)&v20) < 0 )
      {
        v9 = 0LL;
LABEL_9:
        v12 = 0LL;
  ...
  if ( v9 < a2 || a2 > 0x7FFFFFFFFFFFFFFFLL )
    goto LABEL_9;
  v10 = RtlpHpAllocateHeapInternal(a1, a2, v9, v5 & 0x13000003, &v19);
  v12 = v10;
  if ( v10 )
  {
    if ( (v5 & 0x30000F08) != 0 )
    {
      v14 = RtlpHpExtrasAppend(a1, v10, a2, v11, v20, v5);
      v16 = v14;
      if ( v6 )
      {
        *(_BYTE *)(v14 + 2) &= 0xF0u;
        *(_BYTE *)(v14 + 2) |= v6 & 0xF;
        ...
        if ( (int)RtlpCallInterceptRoutine(v6, a1, v17, 2, v16 + 16) < 0 )
        {
...
LABEL_7:
  if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
    RtlpLogHeapAllocateEvent(a1, v12, v9, v19);
  return v12;
}
