/*
 * XREFs of RtlpQueryMemoryUsageHeap @ 0x1800DA458
 * Callers:
 *     RtlpHeapQueryTotalReserveSize @ 0x1800D94C0 (RtlpHeapQueryTotalReserveSize.c)
 *     RtlpQueryExtendedInformationHeap @ 0x1800D9C20 (RtlpQueryExtendedInformationHeap.c)
 * Callees:
 *     RtlpGetLowFragHeapMetadataSize @ 0x1800F0728 (RtlpGetLowFragHeapMetadataSize.c)
 */
