/*
 * XREFs of RtlpLookupDynamicFunctionEntry @ 0x180011654
 * Callers:
 *     RtlLookupFunctionEntry @ 0x180014E40 (RtlLookupFunctionEntry.c)
 * Callees:
 *     RtlpSearchFunctionTable @ 0x1800114D0 (RtlpSearchFunctionTable.c)
...
__int64 __fastcall RtlpLookupDynamicFunctionEntry(unsigned __int64 a1, _QWORD *a2)
{
  ...
  {
    v5 = RtlpSearchFunctionTable(*(_QWORD *)(i + 16), *(_DWORD *)(i + 84), a1, *(_QWORD *)(i + 48));
