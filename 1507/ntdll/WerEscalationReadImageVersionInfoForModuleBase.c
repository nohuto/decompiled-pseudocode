/*
 * XREFs of WerEscalationReadImageVersionInfoForModuleBase @ 0x180043B40
 * Callers:
 ...
 *     GetResourceDirectoryEntry @ 0x180043AFC (GetResourceDirectoryEntry.c)
 *     ValidatePointer @ 0x180043DD0 (ValidatePointer.c)
