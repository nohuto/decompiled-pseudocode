/*
 * XREFs of RtlpRemoveUCRBlock @ 0x18000423C
 * Callers:
 *     RtlpDeCommitFreeBlock @ 0x180029048 (RtlpDeCommitFreeBlock.c)
 * Callees:
 *     RtlpUpdateUCRIndexRemove @ 0x1800042C0 (RtlpUpdateUCRIndexRemove.c)
...
__int64 __fastcall RtlpRemoveUCRBlock(__int64 a1, __int64 *a2)
{
  ...
  {
    result = RtlpLogHeapFailure(12, 0, (_DWORD)v2, *(_QWORD *)(result + 8), v7, 0LL);
  }
  if ( a2[5] )
  {
    ...
    {
      return RtlpLogHeapFailure(12, 0, (_DWORD)a2, v9, v10, 0LL);
    }
  }
  return result;
}
