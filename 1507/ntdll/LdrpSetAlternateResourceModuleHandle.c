/*
 * XREFs of LdrpSetAlternateResourceModuleHandle @ 0x180057378
 * Callers:
 ...
 *     LdrSetMUICacheType @ 0x180081B80 (LdrSetMUICacheType.c)
 * Callees:
        ...
        __int64 a9)
{
  ...
  if ( !a1 || (a7 & 0xFFFFFFC8) != 0 || (a7 & 3) == 3 || (a7 & 1) != 0 && !a2 || (a7 & 4) != 0 && a5 == -1 )
    return 0;
  RtlAcquireSRWLockExclusive(&MuiCacheSWRLock, a2, (__int64)a3, a4);
  v12 = 0LL;
  for ( i = 0; ; ++i )
  {
  ...
  {
LABEL_59:
    v29 = AlternateResourceModules;
    *(_QWORD *)a2 = *(_QWORD *)(AlternateResourceModules + 72LL * i + 32);
    if ( a3 )
      *a3 = *(HANDLE *)(v29 + 72LL * i + 40);
    goto LABEL_94;
  }
  if ( (a7 & 0x20) == 0 )
  {
