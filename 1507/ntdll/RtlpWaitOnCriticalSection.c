/*
 * XREFs of RtlpWaitOnCriticalSection @ 0x180035D54
 * Callers:
...
int __fastcall RtlpWaitOnCriticalSection(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  _BYTE v19[6]; // [rsp+48h] [rbp-80h] BYREF
  ...
  while ( 1 )
  {
    if ( MEMORY[0x7FFE0382] && (NtCurrentPeb()->TracingFlags & 2) != 0 )
    {
      ...
      v21 = *(_DWORD *)(a1 + 8);
      v23 = *(_QWORD *)(a1 + 16);
      NtTraceEvent(MEMORY[0x7FFE0382], 132098LL, 24LL, v19);
    }
    if ( v9 == (void *)-1LL )
    {
      while ( 1 )
...
LABEL_28:
    ...
    if ( v6 > 2 && (_UNKNOWN **)a1 != &LdrpLoaderLock && v14 == v8 )
  ...
  if ( v16 )
  {
    ...
    if ( MEMORY[0x7FFE0384] )
    {
      ...
      if ( (v10->TracingFlags & 4) != 0 && (MEMORY[0x7FFE0385] & 0x20) != 0 )
      {
        LOBYTE(v12) = -1;
        LOBYTE(v11) = -1;
        LODWORD(v10) = LdrpLogEtwEvent(5251, -1, v11, v12, 0LL);
      }
    }
  }
  return (int)v10;
