...
__int64 __fastcall RtlpNameprepAsciiWorker(int a1, WCHAR *a2, __int64 a3, void *a4, int *a5, char a6)
{
  ...
  wchar_t DestinationString[512]; // [rsp+40h] [rbp-C0h] BYREF
...
LABEL_54:
        ...
        if ( v20 <= 0
          || ((v26 = DestinationString[v20 - 1], v26 != 46)
           || (v30 = a2[v8 - 1], v30 == 46)
           || v30 == 12290
           || v30 == 0xFF0E
           || v30 == 0xFF61)
          && v26 )
        {
          ...
          result = punycode_encode(DestinationString, v20, v42, &DestinationStringLength, v37, v14);
