/*
 * XREFs of RtlNumberOfSetBits @ 0x1800D3190
 * Callers:
 *     RtlNumberOfClearBits @ 0x1800D3140 (RtlNumberOfClearBits.c)
 * Callees:
 *     <none>
 */
...
ULONG __cdecl RtlNumberOfSetBits(PRTL_BITMAP BitMapHeader)
{
  ...
  for ( i = 0; v8; --v8 )
  {
    ...
    if ( i == v7 - 1 && v2 )
      v12 &= RtlBaseAceType[(SizeOfBitMap & 7) + 16];
    ++i;
  ...
  if ( v9 )
  {
    ...
    do
    {
      ...
      Buffer = (unsigned int *)((char *)Buffer + 1);
      if ( i == v17 && v2 )
        v18 &= RtlBaseAceType[(SizeOfBitMap & 7) + 16];
      ++i;
