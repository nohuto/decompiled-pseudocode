...
char __fastcall RtlpDeCommitFreeBlock(unsigned __int64 a1, unsigned __int64 a2, unsigned __int64 a3, char a4)
{
  char v4; // r11
  __int64 v5; // rdi
  ...
  unsigned __int64 v92; // [rsp+48h] [rbp-69h] BYREF
  unsigned __int64 v93; // [rsp+50h] [rbp-61h] BYREF
  __int64 *v94; // [rsp+58h] [rbp-59h]
  char *v95; // [rsp+60h] [rbp-51h]
  char *v96; // [rsp+68h] [rbp-49h]
  ...
  if ( a4 )
  {
    ...
    {
      --*(_DWORD *)(a1 + 620);
      if ( (unsigned __int8)RtlpGetFreeBlockInsidePageBoundaries(a1, a2, v110, &v102) )
        *(_QWORD *)(v7 + 624) -= v102;
    }
    v95 = (char *)a2;
    goto LABEL_45;
  ...
  {
LABEL_18:
    LOBYTE(v14) = RtlpInsertFreeBlock(a1, a2, a3);
    return v14;
  }
  v8 = a3 + *(_QWORD *)(a1 + 192);
...
LABEL_17:
  ...
  v69 = (__int64 *)(v11 + 16);
  v70 = *((_QWORD *)v11 + 2);
  v100 = (__int64 *)*((_QWORD *)v11 + 3);
  v103 = v70;
  v71 = *v100;
  if ( *v100 != *(_QWORD *)(v70 + 8) || (__int64 *)v71 != v69 )
  {
    RtlpLogHeapFailure(12, v7, (_DWORD)v69, *(_QWORD *)(v70 + 8), v71, 0LL);
    goto LABEL_164;
  }
  v72 = *(_QWORD *)(v7 + 312);
    ...
    if ( v101 == v69 )
    {
      ...
      else
      {
        ...
        if ( v79 != *(__int64 **)(v72 + 32) )
        {
          ...
          if ( *(_DWORD *)(v7 + 124) )
          {
            v107 = *(_DWORD *)(v7 + 136) ^ v80;
            if ( HIBYTE(v107) != (BYTE2(v107) ^ (unsigned __int8)(BYTE1(v107) ^ v107)) )
            {
              RtlpLogHeapFailure(3, v7, (_DWORD)v79 - 16, 0, 0LL, 0LL);
              v11 = v96;
              v72 = v98;
              v75 = v99;
              v79 = v101;
...
LABEL_130:
    if ( (v11[10] & 4) != 0 )
    {
      v89 = 16LL * *((unsigned __int16 *)v11 + 4) - 32;
      v23 = (v11[10] & 2) == 0;
      v94 = (__int64 *)v89;
      if ( !v23 && v89 > 4 )
      {
      ...
      v100 = (__int64 *)RtlCompareMemoryUlong(v11 + 32, v89, 4277075694LL);
      if ( v100 == v94 )
      {
        v11 = v96;
      }
  ...
  if ( (unsigned __int8)RtlpCommitBlock(v7, v11) )
  {
    v11 = v96;
    goto LABEL_130;
  }
  RtlpDeCommitFreeBlock(v7, v96, *((unsigned __int16 *)v96 + 4), 1LL);
LABEL_164:
  v9 = (char *)v6;
LABEL_8:
  v12 = &v9[16 * v5];
  if ( *(_DWORD *)(v7 + 124) )
  {
    v106 = *(_DWORD *)(v7 + 136) ^ *((_DWORD *)v12 + 2);
    if ( HIBYTE(v106) != (BYTE2(v106) ^ (unsigned __int8)(BYTE1(v106) ^ v106)) )
      RtlpLogHeapFailure(3, v7, (_DWORD)v12, 0, 0LL, 0LL);
  }
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v15 = (__int64 **)(v12 + 16);
      v16 = *((_QWORD *)v12 + 2);
      v101 = (__int64 *)*((_QWORD *)v12 + 3);
      v104 = v16;
      v17 = *v101;
      v18 = *(_QWORD *)(v16 + 8);
      if ( *v101 == v18 && (__int64 **)v17 == v15 )
        break;
      RtlpLogHeapFailure(12, v7, (_DWORD)v15, v18, v17, 0LL);
    }
    v19 = *(_QWORD *)(v7 + 312);
...
LABEL_141:
    ...
    *v101 = v104;
    *(_QWORD *)(v87 + 8) = v86;
    if ( (v12[10] & 8) == 0 || (unsigned __int8)RtlpCommitBlock(v7, v12) )
      break;
    RtlpDeCommitFreeBlock(v7, v12, *((unsigned __int16 *)v12 + 4), 1LL);
  }
  if ( (v12[10] & 4) != 0 )
  {
    v90 = 16LL * *((unsigned __int16 *)v12 + 4) - 32;
    v23 = (v12[10] & 2) == 0;
    v94 = (__int64 *)v90;
    if ( !v23 && v90 > 4 )
    {
    ...
    v100 = (__int64 *)RtlCompareMemoryUlong(v12 + 32, v90, 4277075694LL);
    if ( v100 != v94 )
    {
      if ( NtCurrentPeb()->Ldr )
        DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
  ...
  v95[10] = 0;
  *(_BYTE *)(a2 + 15) = 0;
  v5 = *((unsigned __int16 *)v12 + 4) + v114;
  *(_WORD *)(a2 + 8) = v5;
  v88 = v5 ^ *(_WORD *)(v7 + 140);
  v114 = v5;
...
LABEL_13:
  if ( (unsigned __int64)(v5 - 257) <= 0xFDFF )
  {
    ...
    v13 = *(_QWORD *)(v7 + 536) - 16LL * *(_QWORD *)(v7 + 192);
    v14 = *(_QWORD *)(v7 + 632) >> 4;
    if ( v13 < *(_QWORD *)(v7 + 632) - v14 )
    {
      v14 = *(_QWORD *)(v7 + 640) >> 2;
      if ( v13 > *(_QWORD *)(v7 + 640) - v14 )
      {
        LOBYTE(v14) = RtlpCollectFreeBlocks(v7);
        *(_QWORD *)(v7 + 640) = v13;
        *(_QWORD *)(v7 + 632) = v13;
      }
    }
...
LABEL_45:
  ...
  {
    v112 = v33 + 16;
    RtlpRemoveUCRBlock(v7, (__int64 *)(v33 + 16));
    v34 = v112;
    v35 = *(_QWORD *)(v112 + 32);
    v36 = *(char **)(v112 + 40);
    --*(_DWORD *)(v32 + 84);
...
LABEL_81:
    ...
    v92 = (v57 & 0xFFFFFFFFFFFFF000uLL) - v51;
    if ( v92 )
    {
      if ( (int)RtlpSecMemFreeVirtualMemory(v52, &v93, &v92, 0x4000LL) < 0 )
        goto LABEL_190;
      if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        RtlpLogHeapDecommit(v7, v93, v92, 5LL);
      v58 = v94;
      ++*(_DWORD *)(v7 + 572);
      v59 = v58[5];
      if ( v59 >= 0xFF000 )
        *(_QWORD *)(v7 + 544) -= v59;
      RtlpRemoveUCRBlock(v7, v58);
      v58[5] += v92;
      RtlpInsertUCRBlock(v7, v58);
      *(_DWORD *)(v32 + 80) += v92 >> 12;
      *(_QWORD *)(v7 + 536) -= v92;
      v60 = v58[5];
      if ( v60 >= 0xFF000 )
        *(_QWORD *)(v7 + 544) += v60;
      ...
      {
        v62 = (_BYTE *)(v93 + v92);
        *(_WORD *)(v93 + v92 + 12) = *(_WORD *)(v7 + 140);
        if ( v98 == v92 + v93 )
        {
          if ( *(_DWORD *)(v7 + 124) )
          {
            v62[11] = v62[8] ^ v62[9] ^ v62[10];
            *((_DWORD *)v62 + 2) ^= *(_DWORD *)(v7 + 136);
          }
        }
        else
        {
      ...
      v68 = (__int64)v96;
      if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        RtlpLogHeapContractEvent(v7, v93, v92, 16 * *(_QWORD *)(v7 + 192), v61, (__int64)v96, MEMORY[0x7FFE0380]);
...
LABEL_70:
  ...
  v41 = v40 - v38;
  v92 = v41;
  if ( !v115 && *(_BYTE *)(v33 + 15) != 3 && (!v41 || v41 < *(_QWORD *)(v7 + 176)) )
    goto LABEL_70;
  if ( v41 )
  {
    ++*(_DWORD *)(v7 + 572);
    ...
    {
      if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        RtlpLogHeapDecommit(v7, v93, v92, 6LL);
      v4 = v111;
      a2 = (unsigned __int64)v95;
      v41 = v92;
      v38 = v93;
...
LABEL_190:
    ...
    if ( v111 )
    {
      RtlpCreateUCREntry(v7, v32, v105 - 48, (__int64)v96, (unsigned __int64)v95, &v114);
      goto LABEL_221;
    }
    goto LABEL_222;
  }
LABEL_63:
  ...
  {
    v43 = (_BYTE *)(v41 + v38);
    *(_WORD *)(v41 + v38 + 12) = *(_WORD *)(v7 + 140);
    v41 = v92;
    v38 = v93;
    if ( v94 == (__int64 *)(v92 + v93) )
    {
      if ( !*(_DWORD *)(v7 + 124) )
        goto LABEL_64;
      v43[11] = v43[8] ^ v43[9] ^ v43[10];
      *((_DWORD *)v43 + 2) ^= *(_DWORD *)(v7 + 136);
    }
    else
    {
      v44 = v98;
...
LABEL_64:
  v42 = (unsigned __int64)v95;
  RtlpCreateUCREntry(v7, v32, v38 - 48, v41, (unsigned __int64)v95, &v109);
  RtlpInsertFreeBlock(v7, v42, v109);
  if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
    RtlpLogHeapContractEvent(v7, v93, v92, 16 * *(_QWORD *)(v7 + 192), 0, 0LL, MEMORY[0x7FFE0380]);
  LOBYTE(v14) = MEMORY[0x7FFE038A];
  if ( MEMORY[0x7FFE038A] )
    LOBYTE(v14) = RtlpLogHeapContractEvent(
                    v7,
