/*
 * XREFs of ResCRuntimeGetResourceDataEx @ 0x1800F74FC
 * Callers:
...
__int64 __fastcall ResCRuntimeGetResourceDataEx(__int64 a1, _OWORD *a2, int a3, int a4, int a5, _DWORD *a6, _DWORD *a7)
{
  _QWORD *v7; // rsi
  __int64 v10; // rbp
  _DWORD *v11; // rbp
  ...
  _OWORD *v26; // [rsp+38h] [rbp-90h]
  __int128 v27; // [rsp+40h] [rbp-88h] BYREF
  _BYTE v28[48]; // [rsp+50h] [rbp-78h] BYREF
