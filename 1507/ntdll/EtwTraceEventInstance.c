/*
 * XREFs of EtwTraceEventInstance @ 0x1800F3EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwTraceEventInstance(__int64 a1, __m128i *a2, __int64 *a3, __int64 *a4)
{
  unsigned int v4; // ebx
  unsigned int v6; // edi
  __m128i v7; // xmm1
...
LABEL_16:
    if ( (a1 & 0x1000000) != 0 )
    {
      return (unsigned int)EtwpTraceUmEvent(a1, &Fields, 72LL, 3222601728LL);
    }
    else
    {
