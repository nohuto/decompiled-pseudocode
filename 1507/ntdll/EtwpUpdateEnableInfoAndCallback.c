/*
 * XREFs of EtwpUpdateEnableInfoAndCallback @ 0x180038EA8
 * Callers:
 ...
 *     EtwpUpdatePrivateEnableInfo @ 0x180077B30 (EtwpUpdatePrivateEnableInfo.c)
 *     EtwpIsPrivateLoggerOn @ 0x180078268 (EtwpIsPrivateLoggerOn.c)
 */
