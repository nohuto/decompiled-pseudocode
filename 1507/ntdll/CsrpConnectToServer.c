/*
 * XREFs of CsrpConnectToServer @ 0x1800044D4
 * Callers:
 ...
 *     ZwConnectPort @ 0x180094290 (ZwConnectPort.c)
...
__int64 __fastcall CsrpConnectToServer(_WORD *Src, int a2, __int64 *a3, int a4, _DWORD *a5)
{
  ...
  *((_QWORD *)v15 + 2) = *(_QWORD *)L"ction";
  ...
  v36 = 48;
  CsrPortName = (_WORD)v15 - qword_1801469A8 + 26;
  v38 = &CsrPortName;
  v37 = 0LL;
  v39 = 64;
  v40 = 0LL;
  ...
  if ( v16 >= 0 )
  {
    ...
    *((_DWORD *)v15 + 2) = *(_DWORD *)L"ort";
    v15[6] = aApiport[6];
    CsrPortName = (_WORD)v15 - qword_1801469A8 + 14;
    v46 = 2;
    v47 = 257;
    v22 = 0x10000LL;
    v16 = NtCreateSection(&Handle, 983071LL, 0LL, &v22, 4, 0x8000000, 0LL);
    if ( v16 < 0 )
      goto LABEL_22;
    v29 = Handle;
...
LABEL_18:
    ...
    v16 = ZwConnectPort(&CsrPortHandle, &CsrPortName, v45, &v28, &v33, v27, v41, &v23);
    NtClose(Handle);
    if ( v16 < 0 )
    {
LABEL_22:
    ...
    else
    {
      ...
      *a5 = HIDWORD(v42);
      v24 = 0LL;
      v25 = 0LL;
      v16 = ZwMapViewOfSection(v17, -1LL, &v24, 0LL, 0LL, 0LL, &v25, 2, 5242880, 2);
      NtClose(v21);
      v21 = 0LL;
      if ( v16 >= 0 )
      {
        ...
        CsrReadOnlySharedMemorySize = v25;
        CsrProcessId = v41[2];
...
LABEL_24:
  RtlFreeHeap(CsrHeap, 0LL, qword_1801469A8);
