...
struct _PEB *__fastcall RtlpFreeUserBlock(__int64 a1, __int64 a2)
{
  ...
  if ( v8 <= *((_DWORD *)v7 + 5) || v8 <= *((_DWORD *)v7 + 4) >> *((_DWORD *)v7 + 6) )
  {
    ...
    result = (struct _PEB *)RtlpInterlockedPushEntrySList(v7, a2);
    ++*((_WORD *)v7 + 15);
  }
  else
  {
    ...
    if ( v12 > 0xF0000 )
      v12 = 983040LL;
    v13 = v12 + *(unsigned __int16 *)(a2 + 18);
    result = (struct _PEB *)RtlpFreeUserBlockToHeap(*(_QWORD *)(a1 + 24), a2, v6);
    if ( MEMORY[0x7FFE0380] )
    {
      result = NtCurrentPeb();
    ...
    if ( v8 )
    {
      result = (struct _PEB *)RtlpInterlockedPopEntrySList((PSLIST_HEADER)v7);
      v15 = result;
      if ( result )
      {
        ...
        result = (struct _PEB *)RtlpFreeUserBlockToHeap(*(_QWORD *)(a1 + 24), (__int64)result, v14);
        if ( MEMORY[0x7FFE0380] )
        {
          result = NtCurrentPeb();
          if ( (result->TracingFlags & 1) != 0 )
