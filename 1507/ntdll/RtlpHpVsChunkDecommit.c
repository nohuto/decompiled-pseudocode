...
__int64 __fastcall RtlpHpVsChunkDecommit(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  if ( (v12 & 0xFFFFF000) != 0 && v13 )
  {
    ...
    if ( v15 <= 8 )
      v15 = 8LL;
    if ( *(_QWORD *)(a1 + 48) + (unsigned __int64)(unsigned int)v16 > v15 )
    {
      v7 = 1;
      ...
      *(_DWORD *)(a3 + 8) = v17;
      ...
      RtlpHpVsSubsegmentCommitPages(a1, v6, v13, v16, 0);
      if ( !v18 )
