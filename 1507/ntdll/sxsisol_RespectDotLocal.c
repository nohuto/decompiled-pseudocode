/*
 * XREFs of sxsisol_RespectDotLocal @ 0x1800C99DC
 * Callers:
...
__int64 __fastcall sxsisol_RespectDotLocal(__int16 *a1, unsigned __int16 *a2, _DWORD *a3)
{
  ...
  *(_DWORD *)((char *)&v16.Buffer + 2) = 0;
  ...
  if ( a2 )
  {
    ...
    if ( v5 < 0 )
      goto LABEL_19;
    if ( v16.Buffer && RtlDoesFileExists_UstrEx((__int128 *)&v16, 1) )
    {
      p_UnicodeString = &v16;
    }
    else
    {
      if ( !UnicodeString.Buffer || !RtlDoesFileExists_UstrEx((__int128 *)&UnicodeString, 1) )
        goto LABEL_18;
