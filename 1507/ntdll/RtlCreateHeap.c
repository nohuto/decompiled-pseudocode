        ...
        __int64 a6)
{
  ...
  v46 = 0;
  v43 = 0LL;
  if ( dword_180143C88 && !a2 && !a5 )
  {
    v38 = (__int64 (__fastcall *)(_QWORD, _QWORD, unsigned __int64, __int64, _QWORD, __int64))qword_180143CB8;
...
LABEL_50:
  if ( a2 )
  {
    ...
    {
      if ( (int)ZwQueryVirtualMemory(-1LL, a2, 0LL, &v53, 48LL, 0LL) < 0 )
        goto LABEL_149;
      v24 = (char *)v53;
      ...
      if ( v55 == 4096 )
      {
        ...
        if ( (int)ZwQueryVirtualMemory(-1LL, a2, 3LL, v57, 32LL, 0LL) < 0 )
          goto LABEL_149;
        v45 = v58;
        v47 = v54;
        v23 = v48;
...
LABEL_62:
      ...
      {
        v40 = (unsigned __int64)(v25 + 7) & 0xFFFFFFFFFFFFFFF8uLL;
        v43[41] = v40;
        v19 += 2064;
        v25 = (char *)(v40 + 2064);
        v13 |= 0x4000000u;
      ...
      *((_DWORD *)v28 + 29) = v13 & 0x6001007D;
      *((_WORD *)v43 + 105) = (_WORD)v25 - (_WORD)v43;
      v43[27] = 0LL;
      v29 = v43 + 42;
      v43[43] = v43 + 42;
      *v29 = v29;
                                ...
                                (__int64)&v48[v45 - v50]) )
        {
          ...
          *((_BYTE *)v43 + 379) = 0;
          ...
          if ( (v13 & 3) != 2 || (RtlpDisableHeapLookaside & 1) != 0 )
            goto LABEL_80;
          v43[48] = RtlAllocateHeap(v43, 8388618LL, 256LL);
          v16 = v43[48];
          if ( v16 )
          {
            *(_BYTE *)(v16 - 1) = 1;
...
LABEL_80:
      ...
      v21 = v25;
      if ( (int)RtlInitializeCriticalSectionEx(v25, 0LL, 0x10000000LL) >= 0 )
      {
        v25 += 40;
        goto LABEL_70;
      }
