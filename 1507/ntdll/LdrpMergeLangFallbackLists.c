/*
 * XREFs of LdrpMergeLangFallbackLists @ 0x18001E368
 * Callers:
        ...
        char a9)
{
  ...
  unsigned __int16 v48; // [rsp+54h] [rbp-4Dh] BYREF
  ...
  if ( (a1 & 0x10000) == 0 && (v15 & 6) != 0 )
  {
    ...
    v43 = 1;
    v49 = &v55;
    appended = LdrpCreateLangFallbackList(&v55, (__int64)a2, 0x19u, 0);
    if ( appended < 0 )
      goto LABEL_52;
    v16 = &v55;
  }
  ...
  *((_QWORD *)&v56 + 1) = Heap + 170;
  appended = RtlpGetSystemDefaultUILanguage(&v48, a2);
  if ( appended < 0 )
    goto LABEL_52;
  if ( !(unsigned __int8)RtlLCIDToCultureName(v48, &v56) )
  {
    appended = -1073741823;
    goto LABEL_52;
  }
  LOBYTE(v27) = 1;
  appended = RtlpMuiRegGetInstalledLanguageIndexByLangId(a2, v48, v27, &v45);
  if ( appended >= 0 )
  {
    v28 = *((_QWORD *)&v56 + 1);
    ...
    {
      v29 = v49;
      appended = LdrpLangFallbackListAppendNode((_DWORD)v49, (_DWORD)a2, 0, (unsigned int)v47, *((__int64 *)&v56 + 1));
      if ( appended >= 0 )
      {
        if ( v57 )
        {
    ...
    if ( v43 )
    {
      if ( v29 )
      {
        ...
        {
          appended = LdrpLangFallbackListAppendNode(a3, (_DWORD)a2, 0, (unsigned int)v47, v28);
          if ( appended >= 0 )
          {
