  ...
  if ( LangFallbackList >= 0 )
  {
    ...
    if ( v43 )
    {
      if ( v29 )
      {
        ...
        {
          LangFallbackList = LdrpLangFallbackListAppendNode(a3, a2, 0, (unsigned int)v47, (__int64)Buffer);
          if ( LangFallbackList >= 0 )
          {
            ...
            if ( (*v31 & 6) != 0 )
            {
              if ( !v18 || !v12 )
                v12 = *(_QWORD *)(a2 + 40);
              LangFallbackList = LdrpMergeParentBaseLanguagesToList(a3, (_DWORD)v31, a2, v12, v42);
            }
          }
        }
      }
