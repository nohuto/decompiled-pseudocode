/*
 * XREFs of RtlpSetPreferredUILanguages @ 0x1800D6DF0
 * Callers:
 ...
 *     RtlpGetMultiStringLength @ 0x1800D6140 (RtlpGetMultiStringLength.c)
 *     RtlpSetInstallLanguage @ 0x1800D66B0 (RtlpSetInstallLanguage.c)
 *     RtlpSetMachineUILanguagesImmediate @ 0x1800D6C0C (RtlpSetMachineUILanguagesImmediate.c)
 *     RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId @ 0x1800E7008 (RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId.c)
 */
...
__int64 __fastcall RtlpSetPreferredUILanguages(int a1, WCHAR *a2, _DWORD *a3)
{
  ...
  _WORD v48[2]; // [rsp+54h] [rbp-ACh] BYREF
  UNICODE_STRING v49; // [rsp+58h] [rbp-A8h] BYREF
  __int128 v50; // [rsp+70h] [rbp-90h] BYREF
  unsigned int v51; // [rsp+80h] [rbp-80h]
  unsigned __int16 v52; // [rsp+84h] [rbp-7Ch]
  unsigned int v53; // [rsp+88h] [rbp-78h] BYREF
  ...
  char *v64; // [rsp+D8h] [rbp-28h] BYREF
  unsigned __int16 *v65; // [rsp+E0h] [rbp-20h]
...
LABEL_98:
          ...
          if ( v64 )
          {
            CloseGlobalizationUserSettingsKey(v64);
            v64 = 0LL;
          }
          if ( v8 )
        ...
        Heap = (unsigned __int16 *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 522LL);
        v67 = Heap;
        v15 = Heap;
        if ( !Heap )
        {
        ...
        *(_DWORD *)&v49.Length = 11141120;
        if ( !RtlLCIDToCultureName(v52, (__int64)&v49) )
        {
          InstallUILanguage = -1073741811;
LABEL_93:
          if ( v15 )
          ...
          if ( v65 )
            RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int64)v65);
          v5 = v54;
          goto LABEL_98;
        }
      ...
      *((_QWORD *)&v50 + 1) = v4;
      ...
      v18 = v4;
      v65 = (unsigned __int16 *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 170LL);
      if ( !v65 )
      {
        InstallUILanguage = -1073741801;
        goto LABEL_90;
...
LABEL_115:
          ...
          {
            v27 = v56;
            if ( (int)RtlpMuiRegGetInstalledLanguageIndexByName(v56, Buffer, 1, v48) < 0 )
              goto LABEL_88;
            v24 = v46;
            v57 = (__int16 *)(*(_QWORD *)(*(_QWORD *)(v27 + 24) + 16LL) + 28LL * v48[0]);
          }
LABEL_80:
          if ( v18 )
          {
        ...
        if ( v45 )
        {
          while ( 1 )
          {
            ...
            *(_DWORD *)&DestinationString.Length = 11141120;
            if ( !RtlLCIDToCultureName(v53, (__int64)&DestinationString) )
              break;
            if ( (int)RtlStringCchCatW(v32, v47, (__int64)DestinationString.Buffer) < 0 )
            {
              InstallUILanguage = -1073741670;
              goto LABEL_90;
            }
...
LABEL_136:
    ...
    if ( (v3 & 0x4000) != 0 )
    {
      InstallUILanguage = OpenGlobalizationUserSettingsKey(0x2000000u, 0, v11, v12, (__int64)&v64);
      if ( InstallUILanguage < 0 )
        goto LABEL_89;
