/*
 * XREFs of RtlpAssemblyStorageMapResolutionDefaultCallback @ 0x180053C60
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall RtlpAssemblyStorageMapResolutionDefaultCallback(int a1, __int64 a2, _DWORD *a3)
{
  ...
  if ( !v5 )
  {
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&unk_180105580;
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v7 + 32) + 8LL) & 0x8000) != 0 )
    {
      ...
      if ( v8 + 16 <= 0xFFFE )
      {
        ...
        if ( v8 + 16 <= v7 )
        {
          ...
          *(_OWORD *)&v10[v8] = xmmword_180108680;
