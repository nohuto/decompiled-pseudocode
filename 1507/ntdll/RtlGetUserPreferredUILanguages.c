/*
 * XREFs of RtlGetUserPreferredUILanguages @ 0x18006CFE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_42:
  ...
  if ( v10 != 128 && v10 != 2048 && v10 != 4096 && v10 != 0x8000 || !v5 || *v5 && !v8 )
    return 3221225485LL;
  result = RtlpCreateProcessRegistryInfo((__int64 *)&v37);
  if ( (int)result >= 0 )
  {
...
LABEL_38:
    ...
    v15 = LdrpCreateLangFallbackList(&v35, (__int64)v37, 0x19u, 0);
        ...
        if ( SystemPreferredUILanguages >= 0 )
        {
          ...
          *v5 = v33;
          ...
          if ( v18 >= 0 && *(_WORD *)(v17 + 4) || v18 == -1073741789 )
            goto LABEL_27;
          *v5 = v33;
          v29 = RtlGetSystemPreferredUILanguages(((v6 & 8) != 0 ? 8 : 4) | 0x8000u, a2, &v32, (__int64)v8, v5);
          goto LABEL_92;
        }
      }
LABEL_93:
    ...
    if ( !v35 )
      goto LABEL_31;
    SystemPreferredUILanguages = LdrpMergeLangFallbackLists(v6 | 0x20u, v13, (__int64)&v35, 0LL, 0LL, v12, 0LL, v38, 0);
    if ( SystemPreferredUILanguages < 0 )
      goto LABEL_93;
    SystemPreferredUILanguages = LdrpCreateLangFallbackList(&v36, (__int64)v13, 0x19u, 0);
    if ( SystemPreferredUILanguages < 0 )
      goto LABEL_93;
    v17 = v35;
    if ( !v36 )
