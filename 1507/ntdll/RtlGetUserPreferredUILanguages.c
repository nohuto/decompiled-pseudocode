...
LABEL_38:
    ...
    LangFallbackList = LdrpCreateLangFallbackList((__int64 *)&BaseAddress, (__int64)v37, 0x19u, 0);
...
LABEL_93:
    ...
    if ( SystemPreferredUILanguages < 0 )
      goto LABEL_93;
    SystemPreferredUILanguages = LdrpCreateLangFallbackList((__int64 *)&v36, (__int64)v13, 0x19u, 0);
    if ( SystemPreferredUILanguages < 0 )
      goto LABEL_93;
    v17 = BaseAddress;
    if ( !v36 )
