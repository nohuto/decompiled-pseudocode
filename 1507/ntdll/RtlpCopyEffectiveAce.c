/*
 * XREFs of RtlpCopyEffectiveAce @ 0x18004D298
 * Callers:
        ...
        _BYTE *a16)
{
  ...
  unsigned __int8 *v64; // [rsp+68h] [rbp-71h]
  void *v65; // [rsp+70h] [rbp-69h]
  __int64 v66; // [rsp+78h] [rbp-61h]
