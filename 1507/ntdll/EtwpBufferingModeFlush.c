/*
 * XREFs of EtwpBufferingModeFlush @ 0x1800F4044
 * Callers:
 ...
 *     EtwpFindAndLockBufferForFlushing @ 0x1800F4354 (EtwpFindAndLockBufferForFlushing.c)
 */
...
__int64 __fastcall EtwpBufferingModeFlush(__int64 a1)
{
  ...
  {
    v6 = *(_QWORD *)(a1 + 8 * i + 536);
    if ( v6 )
    {
      *(_QWORD *)(a1 + 8 * i + 536) = 0LL;
      v7 = _InterlockedExchangeAdd((volatile signed __int32 *)(v6 + 8), v1);
      if ( v7 <= v1 )
        *(_DWORD *)(v6 + 4) = v7;
      *(_DWORD *)(v6 + 44) = 0;
      *(_QWORD *)(v6 + 32) = 0LL;
      *(_QWORD *)(v6 + 24) = _InterlockedIncrement64((volatile signed __int64 *)(a1 + 424));
      **(_QWORD **)(a1 + 264) = v6 + 32;
      *(_QWORD *)(a1 + 264) = v6 + 32;
