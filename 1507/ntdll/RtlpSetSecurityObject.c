/*
 * XREFs of RtlpSetSecurityObject @ 0x180047EB8
 * Callers:
 *     RtlSetSecurityObjectEx @ 0x180047790 (RtlSetSecurityObjectEx.c)
 *     RtlSetSecurityObject @ 0x180047E40 (RtlSetSecurityObject.c)
 * Callees:
        ...
        void *a8)
{
  ...
  _QWORD *v118; // [rsp+118h] [rbp+18h] BYREF
...
LABEL_172:
      ...
      if ( !(unsigned __int8)RtlpValidTrustSubjectContext(*v64, v65 + 8, v66, &InformationToken) )
        goto LABEL_169;
    }
    ++v87;
  }
