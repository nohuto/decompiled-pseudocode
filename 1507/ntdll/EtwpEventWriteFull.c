/*
 * XREFs of EtwpEventWriteFull @ 0x18000F734
 * Callers:
 *     EtwEventWriteFull @ 0x18000F610 (EtwEventWriteFull.c)
 *     EtwEventWriteEx @ 0x18000F660 (EtwEventWriteEx.c)
 *     EtwEventWrite @ 0x18000F6B0 (EtwEventWrite.c)
 *     EtwEventWriteTransfer @ 0x18000F6F0 (EtwEventWriteTransfer.c)
 * Callees:
        ...
        __int64 a9)
{
  ...
  {
    v23 = *(_BYTE *)((a1 & 0xFFFFFFFFFFFFLL) + 0xF5);
    if ( (BYTE4(v29) <= v23 || !v23)
