/*
 * XREFs of ?UpdateGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@IEAAJPEAUVIDSCH_DEVICE_COMMAND_UPDATEGPUVA@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00E8C04
 * Callers:
 ...
 *     VidSchGetPagingContext @ 0x1C003FFA8 (VidSchGetPagingContext.c)
