/*
 * XREFs of McTemplateK0pqxqqqxqp_EtwWriteTransfer @ 0x1C0039528
 * Callers:
...
NTSTATUS McTemplateK0pqxqqqxqp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventDmaIsrComplete, a3, 0xAu, &v4);
}
