/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C001A174
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C001A2C8 (wil_details_GetCurrentFeatureEnabledState.c)
