/*
 * XREFs of McTemplateK0ppqxqpq_EtwWriteTransfer @ 0x1C0038108
 * Callers:
...
NTSTATUS McTemplateK0ppqxqpq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventDmaSubmit, a3, 8u, &v4);
}
