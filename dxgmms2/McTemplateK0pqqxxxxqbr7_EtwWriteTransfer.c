/*
 * XREFs of McTemplateK0pqqxxxxqbr7_EtwWriteTransfer @ 0x1C0043DB8
 * Callers:
...
NTSTATUS McTemplateK0pqqxxxxqbr7_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v23 = 0;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventSchedulingLog, 0LL, 0xAu, &v4);
}
