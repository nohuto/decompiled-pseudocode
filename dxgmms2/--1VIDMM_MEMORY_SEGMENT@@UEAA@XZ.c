/*
 * XREFs of ??1VIDMM_MEMORY_SEGMENT@@UEAA@XZ @ 0x1C00F8FA8
 * Callers:
 *     ??_EVIDMM_MEMORY_SEGMENT@@UEAAPEAXI@Z @ 0x1C0032780 (--_EVIDMM_MEMORY_SEGMENT@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1VIDMM_CPU_HOST_APERTURE@@QEAA@XZ @ 0x1C0032FCC (--1VIDMM_CPU_HOST_APERTURE@@QEAA@XZ.c)
