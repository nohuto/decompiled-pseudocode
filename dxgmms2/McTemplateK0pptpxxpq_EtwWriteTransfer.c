/*
 * XREFs of McTemplateK0pptpxxpq_EtwWriteTransfer @ 0x1C0031C4C
 * Callers:
...
NTSTATUS McTemplateK0pptpxxpq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 8LL;
  v20 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpUpdateContextAllocation, a3, 9u, &v4);
}
