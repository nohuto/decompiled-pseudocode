/*
 * XREFs of McTemplateK0qqqqqqqqq_EtwWriteTransfer @ 0x1C004B584
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &PendingFlipsForThisEntry, a3, 0xAu, &v13);
}
