/*
 * XREFs of McTemplateK0pxqqpqx_EtwWriteTransfer @ 0x1C003978C
 * Callers:
...
NTSTATUS McTemplateK0pxqqpqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventCancelFlip, a3, 8u, &v4);
}
