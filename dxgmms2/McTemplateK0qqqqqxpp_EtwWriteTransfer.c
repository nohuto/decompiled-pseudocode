/*
 * XREFs of McTemplateK0qqqqqxpp_EtwWriteTransfer @ 0x1C002F3D8
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqxpp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 8LL;
  v28 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &UpdateGpuVirtualAddress, a3, 9u, &v12);
}
