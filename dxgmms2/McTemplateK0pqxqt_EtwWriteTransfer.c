/*
 * XREFs of McTemplateK0pqxqt_EtwWriteTransfer @ 0x1C003961C
 * Callers:
...
NTSTATUS McTemplateK0pqxqt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventDmaDpcComplete, a3, 6u, &v4);
}
