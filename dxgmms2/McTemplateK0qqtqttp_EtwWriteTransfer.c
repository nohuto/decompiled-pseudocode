/*
 * XREFs of McTemplateK0qqtqttp_EtwWriteTransfer @ 0x1C002F7AC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqtqttp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventVidMmTryOperation, a3, 8u, &v11);
}
